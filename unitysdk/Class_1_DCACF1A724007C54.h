...
#define CLASS_1_DCACF1A724007C54_CLEAR_OFFSET UNITYSDK_OFFSET(0xB975C90)
#define CLASS_1_DCACF1A724007C54_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB975BA0)
#define CLASS_1_DCACF1A724007C54_ONCANCELSPAWN_OFFSET UNITYSDK_OFFSET(0xB975C10)
#define CLASS_1_DCACF1A724007C54_ONSPAWNASYNC_OFFSET UNITYSDK_OFFSET(0xB975BB0)
#define CLASS_1_DCACF1A724007C54_USELIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0xB975C50)
#define CLASS_1_DCACF1A724007C54__CTOR_OFFSET UNITYSDK_OFFSET(0xB975CE0)
