...
#define AKINITIALIZER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D1C8150)
#define AKINITIALIZER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1D1C8140)
#define AKINITIALIZER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1D1C8740)
#define AKINITIALIZER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x1D1C8600)
#define AKINITIALIZER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1D1C84E0)
#define AKINITIALIZER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1D1C8650)
#define AKINITIALIZER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D1C8450)
#define AKINITIALIZER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D1C8350)
#define AKINITIALIZER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D1C8250)
#define AKINITIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C8830)
...
public:
	...
	{
		return (::AkInitializer**)Il2CppClass::FromTypeDefinitionIndex(AkInitializer_TypeDefinitionIndex)->GetStaticField(0x516C0);
	}
