...
#define CLASS_1_4796C2DE3B2D6C2A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14769310)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_00DF89AF1D11BD2E_OFFSET UNITYSDK_OFFSET(0x1476A5B0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_145A8D9201423FC6_OFFSET UNITYSDK_OFFSET(0x1476BF70)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_1EB273CD688D06ED_OFFSET UNITYSDK_OFFSET(0x1476B320)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_2D312A3A46C6FB2F_OFFSET UNITYSDK_OFFSET(0x1476A080)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_43B0FFFD1A1BF974_OFFSET UNITYSDK_OFFSET(0x1476CB20)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_466FDCDCBC13D73A_OFFSET UNITYSDK_OFFSET(0x1476BEB0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_52DD47985B15034A_OFFSET UNITYSDK_OFFSET(0x1476C500)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_60882208D099D33E_OFFSET UNITYSDK_OFFSET(0x1476ACF0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x14769B10)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_6B4A3A1B5816B81E_OFFSET UNITYSDK_OFFSET(0x14769230)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_71137C197370ED55_OFFSET UNITYSDK_OFFSET(0x1476AF70)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_8F6A1B72899F4EA4_OFFSET UNITYSDK_OFFSET(0x14769570)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_9152E9750C76708B_OFFSET UNITYSDK_OFFSET(0x1476A630)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_928B00241CFBD033_OFFSET UNITYSDK_OFFSET(0x1476AB30)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_97D89346F5076D01_OFFSET UNITYSDK_OFFSET(0x1476A270)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_A7FF6AA8FA2F7FEB_OFFSET UNITYSDK_OFFSET(0x14769370)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_A8624219B56B77C4_OFFSET UNITYSDK_OFFSET(0x1476BC60)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_ABD781CAE1D41BD7_OFFSET UNITYSDK_OFFSET(0x1476B760)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_AF7C96CACF497A85_OFFSET UNITYSDK_OFFSET(0x1476C910)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_BA7B415A985A3C25_OFFSET UNITYSDK_OFFSET(0x1476AEB0)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x14769650)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_ECF16165D5B625B4_OFFSET UNITYSDK_OFFSET(0x1476C250)
#define CLASS_1_4796C2DE3B2D6C2A_METHOD_1_F476304D68944B28_OFFSET UNITYSDK_OFFSET(0x1476B820)
#define CLASS_1_4796C2DE3B2D6C2A__CTOR_OFFSET UNITYSDK_OFFSET(0x147690E0)
...
{
public:
	::RPG::Client::TwoKeyDictionary_3<::System::UInt32, ::System::UInt32, ::Class_1_4796C2DE3B2D6C2A_Class_1_7A8BA05CC3614C46*>* Field_1_0; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::UInt32, ::System::String*>, ::System::Collections::Generic::List_1<::RPG::GameCore::LevelLittleGameInfo*>*>* Field_1_1; // 0x18
	...
	::RPG::Client::MapDef* Field_1_5; // 0x38
