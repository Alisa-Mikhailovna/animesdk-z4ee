...
#define CLASS_1_AE784B0D4E05F70E_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C064E00)
#define CLASS_1_AE784B0D4E05F70E_CLONE_OFFSET UNITYSDK_OFFSET(0x1C0649D0)
#define CLASS_1_AE784B0D4E05F70E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C064B90)
#define CLASS_1_AE784B0D4E05F70E_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C064A80)
#define CLASS_1_AE784B0D4E05F70E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C064C60)
#define CLASS_1_AE784B0D4E05F70E_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C065000)
#define CLASS_1_AE784B0D4E05F70E_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C064FC0)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C064920)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_4C4B9DFE092840D4_1_OFFSET UNITYSDK_OFFSET(0x1C064A70)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1C064A50)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_7ADD5F1F5E247E3B_1_OFFSET UNITYSDK_OFFSET(0x1C064A60)
#define CLASS_1_AE784B0D4E05F70E_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1C064A40)
#define CLASS_1_AE784B0D4E05F70E_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C064980)
#define CLASS_1_AE784B0D4E05F70E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C064CC0)
#define CLASS_1_AE784B0D4E05F70E_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C064D20)
#define CLASS_1_AE784B0D4E05F70E__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C065180)
#define CLASS_1_AE784B0D4E05F70E__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0649A0)
#define CLASS_1_AE784B0D4E05F70E__CTOR_OFFSET UNITYSDK_OFFSET(0x1C064990)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_AE784B0D4E05F70E*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AE784B0D4E05F70E_TypeDefinitionIndex)->GetStaticField(0x22950);
	}
