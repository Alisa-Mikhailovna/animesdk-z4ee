...
#define CLASS_1_5B567C8A01BAEDFE_131_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C0B3A30)
#define CLASS_1_5B567C8A01BAEDFE_131_CLONE_OFFSET UNITYSDK_OFFSET(0x1C0B36D0)
#define CLASS_1_5B567C8A01BAEDFE_131_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C0B3830)
#define CLASS_1_5B567C8A01BAEDFE_131_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C0B3740)
#define CLASS_1_5B567C8A01BAEDFE_131_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C0B3990)
#define CLASS_1_5B567C8A01BAEDFE_131_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C0B3A80)
#define CLASS_1_5B567C8A01BAEDFE_131_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C0B3A50)
#define CLASS_1_5B567C8A01BAEDFE_131_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C0B3620)
#define CLASS_1_5B567C8A01BAEDFE_131_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C0B3680)
#define CLASS_1_5B567C8A01BAEDFE_131_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C0B39C0)
#define CLASS_1_5B567C8A01BAEDFE_131_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C0B3A20)
#define CLASS_1_5B567C8A01BAEDFE_131__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C0B3AD0)
#define CLASS_1_5B567C8A01BAEDFE_131__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0B36A0)
#define CLASS_1_5B567C8A01BAEDFE_131__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0B3690)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_131*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_131_TypeDefinitionIndex)->GetStaticField(0x6830);
	}
