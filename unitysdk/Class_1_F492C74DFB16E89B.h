...
#define CLASS_1_F492C74DFB16E89B_METHOD_1_01ACC9B513C5E7F7_OFFSET UNITYSDK_OFFSET(0xB1D71B0)
#define CLASS_1_F492C74DFB16E89B_METHOD_1_28141171CE1C76E0_OFFSET UNITYSDK_OFFSET(0xB1D75A0)
#define CLASS_1_F492C74DFB16E89B_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xB1D74D0)
#define CLASS_1_F492C74DFB16E89B_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0xB1D7630)
#define CLASS_1_F492C74DFB16E89B_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xB1D7390)
#define CLASS_1_F492C74DFB16E89B__CTOR_OFFSET UNITYSDK_OFFSET(0xB1D76E0)

inline static constexpr unsigned int Class_1_F492C74DFB16E89B_TypeDefinitionIndex = 75739;

class Class_1_F492C74DFB16E89B : public ::System::Object
{
public:
	// static const ::System::Int32 Field_1_0 = 0x14; // 0x0
	::RPG::Client::FateRin::Battle::FateRinBattleHudFreeCardMoveHandler* Field_1_1; // 0x10
	::Class_0_16E4307DCC419505_1276* Field_1_2; // 0x18
