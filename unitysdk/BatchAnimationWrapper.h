...
#define BATCHANIMATIONWRAPPER_APPLYCUSTOMCOLOR_OFFSET UNITYSDK_OFFSET(0x1AA31290)
#define BATCHANIMATIONWRAPPER_CREATE_OFFSET UNITYSDK_OFFSET(0x1AA303B0)
#define BATCHANIMATIONWRAPPER_GETORCREATORBATCHANIMROOT_OFFSET UNITYSDK_OFFSET(0x1AA2F960)
#define BATCHANIMATIONWRAPPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AA32440)
#define BATCHANIMATIONWRAPPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA303A0)
#define BATCHANIMATIONWRAPPER_PLAY_OFFSET UNITYSDK_OFFSET(0x1AA30F20)
#define BATCHANIMATIONWRAPPER_RESETPART_1_OFFSET UNITYSDK_OFFSET(0x1AA324E0)
#define BATCHANIMATIONWRAPPER_RESETPART_OFFSET UNITYSDK_OFFSET(0x1AA32470)
#define BATCHANIMATIONWRAPPER_RESET_OFFSET UNITYSDK_OFFSET(0x1AA31DF0)
#define BATCHANIMATIONWRAPPER_SETUPRANDOMPART_OFFSET UNITYSDK_OFFSET(0x1AA30D20)
#define BATCHANIMATIONWRAPPER_SETUPSHADOW_OFFSET UNITYSDK_OFFSET(0x1AA30C80)
#define BATCHANIMATIONWRAPPER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA32430)
#define BATCHANIMATIONWRAPPER__BUILDPOINTSEDGE_OFFSET UNITYSDK_OFFSET(0x1AA2FFB0)
#define BATCHANIMATIONWRAPPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA32850)
#define BATCHANIMATIONWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA325F0)
#define BATCHANIMATIONWRAPPER__GETSTARTPOS_1_OFFSET UNITYSDK_OFFSET(0x1AA2FD60)
#define BATCHANIMATIONWRAPPER__GETSTARTPOS_OFFSET UNITYSDK_OFFSET(0x1AA2FB10)
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Quaternion>**)Il2CppClass::FromTypeDefinitionIndex(BatchAnimationWrapper_TypeDefinitionIndex)->GetStaticField(0x614A0);
	}
	static ::UnityEngine::Transform** StaticGet_s_BatchAnimationRootCache()
	{
		return (::UnityEngine::Transform**)Il2CppClass::FromTypeDefinitionIndex(BatchAnimationWrapper_TypeDefinitionIndex)->GetStaticField(0x614A8);
	}
	static ::Il2CppArray<::UnityEngine::Vector3>** StaticGet__posArray()
	{
		return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(BatchAnimationWrapper_TypeDefinitionIndex)->GetStaticField(0x614B0);
	}
