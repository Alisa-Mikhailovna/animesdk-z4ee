...
#define CARFLOWROAD_ADDCAR_OFFSET UNITYSDK_OFFSET(0xD3402D0)
#define CARFLOWROAD_GETCARLIMIT_OFFSET UNITYSDK_OFFSET(0xD340440)
#define CARFLOWROAD_GET_CARS_OFFSET UNITYSDK_OFFSET(0xD340290)
#define CARFLOWROAD_GET_CURVE_OFFSET UNITYSDK_OFFSET(0xD3402B0)
#define CARFLOWROAD_GET_MATH_OFFSET UNITYSDK_OFFSET(0xD340270)
#define CARFLOWROAD_INIT_OFFSET UNITYSDK_OFFSET(0xD340520)
#define CARFLOWROAD_REMOVECAR_OFFSET UNITYSDK_OFFSET(0xD3403B0)
#define CARFLOWROAD_SET_CARS_OFFSET UNITYSDK_OFFSET(0xD3402A0)
#define CARFLOWROAD_SET_CURVE_OFFSET UNITYSDK_OFFSET(0xD3402C0)
#define CARFLOWROAD_SET_MATH_OFFSET UNITYSDK_OFFSET(0xD340280)
#define CARFLOWROAD__CTOR_OFFSET UNITYSDK_OFFSET(0xD340770)
