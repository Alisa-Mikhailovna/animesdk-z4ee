...
public:
	...
	{
		return (::RPG::Client::OnAssetOperationDelegate**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1F539D99D6C56687___O_TypeDefinitionIndex)->GetStaticField(0x68E40);
	}
};
