...
#define CLASS_2_EC6ECCFDD930C7AB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14781390)
#define CLASS_2_EC6ECCFDD930C7AB_GET_CELLENTITYDICT_OFFSET UNITYSDK_OFFSET(0x14787FF0)
#define CLASS_2_EC6ECCFDD930C7AB_GET_ENDCELLENTITY_OFFSET UNITYSDK_OFFSET(0x14788030)
#define CLASS_2_EC6ECCFDD930C7AB_GET_ITEMENTITYLIST_OFFSET UNITYSDK_OFFSET(0x14788050)
#define CLASS_2_EC6ECCFDD930C7AB_GET_RENDERINGPANEL_OFFSET UNITYSDK_OFFSET(0x14787FD0)
#define CLASS_2_EC6ECCFDD930C7AB_GET_STARTCELLENTITY_OFFSET UNITYSDK_OFFSET(0x14788010)
#define CLASS_2_EC6ECCFDD930C7AB_GET_VIEWROOT_OFFSET UNITYSDK_OFFSET(0x14787FB0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_00A91948BD71EE07_OFFSET UNITYSDK_OFFSET(0x147846B0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_01CD0285FA7728E3_OFFSET UNITYSDK_OFFSET(0x147879A0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_063A2C2CE28CAFB4_OFFSET UNITYSDK_OFFSET(0x14787F50)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_0C1D1D0673982C1F_OFFSET UNITYSDK_OFFSET(0x147869F0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_13063627F44993AC_OFFSET UNITYSDK_OFFSET(0x14784AD0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_156C651C1FD79089_OFFSET UNITYSDK_OFFSET(0x14783820)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_17FAF5C4AA33E8F3_OFFSET UNITYSDK_OFFSET(0x14781700)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_23B7C160CB6CEA95_OFFSET UNITYSDK_OFFSET(0x14781010)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_26C17A2A2B6CC431_OFFSET UNITYSDK_OFFSET(0x14787A90)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_2E6AA7D83B08AD49_OFFSET UNITYSDK_OFFSET(0x14787BA0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_32D25B2FC4891550_OFFSET UNITYSDK_OFFSET(0x14785910)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_4C186E13AD1370B5_OFFSET UNITYSDK_OFFSET(0x147842F0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_5FE86C798385BF43_OFFSET UNITYSDK_OFFSET(0x14787ED0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_6358EE553589AE52_OFFSET UNITYSDK_OFFSET(0x14781940)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_71E47D15E046BA7E_OFFSET UNITYSDK_OFFSET(0x147864A0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_73A12C1FFADBD599_OFFSET UNITYSDK_OFFSET(0x14781B90)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_76CBA6C87EEF6B2C_OFFSET UNITYSDK_OFFSET(0x14784950)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_7DF2FCAF96511C41_OFFSET UNITYSDK_OFFSET(0x14780BF0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_7E994266A0D07648_OFFSET UNITYSDK_OFFSET(0x14781C10)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_80BE86FE0D61F02D_OFFSET UNITYSDK_OFFSET(0x14786C20)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_8A5842774092E518_OFFSET UNITYSDK_OFFSET(0x14783FB0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_8FC1D4BD7D97F403_OFFSET UNITYSDK_OFFSET(0x14780650)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x14780FA0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_96E4C6963BABD9F4_OFFSET UNITYSDK_OFFSET(0x14782E40)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_97889423B3D78768_OFFSET UNITYSDK_OFFSET(0x14780E40)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_A3620B2E7B0E7092_OFFSET UNITYSDK_OFFSET(0x147870A0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_AE2FB102C212B1FC_OFFSET UNITYSDK_OFFSET(0x147806F0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_BEF20BDEEDEDBC80_OFFSET UNITYSDK_OFFSET(0x14787E30)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_C9754B0131863FDD_OFFSET UNITYSDK_OFFSET(0x147834A0)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_D155561E3AB9CD04_OFFSET UNITYSDK_OFFSET(0x14782100)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_DE2BC44ACB86CE8C_OFFSET UNITYSDK_OFFSET(0x14781630)
#define CLASS_2_EC6ECCFDD930C7AB_METHOD_2_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x14780F20)
#define CLASS_2_EC6ECCFDD930C7AB_SET_CELLENTITYDICT_OFFSET UNITYSDK_OFFSET(0x14788000)
#define CLASS_2_EC6ECCFDD930C7AB_SET_ENDCELLENTITY_OFFSET UNITYSDK_OFFSET(0x14788040)
#define CLASS_2_EC6ECCFDD930C7AB_SET_ITEMENTITYLIST_OFFSET UNITYSDK_OFFSET(0x14788060)
#define CLASS_2_EC6ECCFDD930C7AB_SET_RENDERINGPANEL_OFFSET UNITYSDK_OFFSET(0x14787FE0)
#define CLASS_2_EC6ECCFDD930C7AB_SET_STARTCELLENTITY_OFFSET UNITYSDK_OFFSET(0x14788020)
#define CLASS_2_EC6ECCFDD930C7AB_SET_VIEWROOT_OFFSET UNITYSDK_OFFSET(0x14787FC0)
#define CLASS_2_EC6ECCFDD930C7AB__CTOR_OFFSET UNITYSDK_OFFSET(0x14781070)
#define CLASS_2_EC6ECCFDD930C7AB__ONRELEASEVIEW_OFFSET UNITYSDK_OFFSET(0x14781550)

inline static constexpr unsigned int Class_2_EC6ECCFDD930C7AB_TypeDefinitionIndex = 73809;
...
public:
	...
	::Class_3_97041AE90E3B2214* Field_2_2; // 0x38
	::RPG::Client::LittleGame::ChenLingFes::ChenLingFesRouteRendererView* Field_2_3; // 0x40
	::System::Collections::Generic::List_1<::Class_2_5436AF4270279182*>* _ItemEntityList_k__BackingField; // 0x48
	::FiveDimRenderingPanel* _RenderingPanel_k__BackingField; // 0x50
	::Class_2_5436AF4270279182* _EndCellEntity_k__BackingField; // 0x58
	::Class_2_5436AF4270279182* _StartCellEntity_k__BackingField; // 0x60
	::Class_0_16E4307DCC419505_703* Field_2_8; // 0x68
	...
	::Class_2_360C00D6092F4D31* Field_2_10; // 0x78
	::RPG::Client::MonoEffectManager* Field_2_11; // 0x80
	::UnityEngine::Transform* _ViewRoot_k__BackingField; // 0x88
