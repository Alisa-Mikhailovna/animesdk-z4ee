...
#define ZXING_QRCODE_INTERNAL_ENCODER_APPEND8BITBYTES_OFFSET UNITYSDK_OFFSET(0x1D302810)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDALPHANUMERICBYTES_OFFSET UNITYSDK_OFFSET(0x1D302580)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDBYTES_OFFSET UNITYSDK_OFFSET(0x1D300320)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDECI_OFFSET UNITYSDK_OFFSET(0x1D300230)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDKANJIBYTES_OFFSET UNITYSDK_OFFSET(0x1D302A30)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDLENGTHINFO_OFFSET UNITYSDK_OFFSET(0x1D3008B0)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDMODEINFO_OFFSET UNITYSDK_OFFSET(0x1D3002F0)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDNUMERICBYTES_OFFSET UNITYSDK_OFFSET(0x1D302390)
#define ZXING_QRCODE_INTERNAL_ENCODER_CALCULATEBITSNEEDED_OFFSET UNITYSDK_OFFSET(0x1D300610)
#define ZXING_QRCODE_INTERNAL_ENCODER_CALCULATEMASKPENALTY_OFFSET UNITYSDK_OFFSET(0x1D2FE6C0)
#define ZXING_QRCODE_INTERNAL_ENCODER_CHOOSEMASKPATTERN_OFFSET UNITYSDK_OFFSET(0x1D3019D0)
#define ZXING_QRCODE_INTERNAL_ENCODER_CHOOSEMODE_OFFSET UNITYSDK_OFFSET(0x1D300050)
#define ZXING_QRCODE_INTERNAL_ENCODER_CHOOSEVERSION_OFFSET UNITYSDK_OFFSET(0x1D301C50)
#define ZXING_QRCODE_INTERNAL_ENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1D2FF0A0)
#define ZXING_QRCODE_INTERNAL_ENCODER_GENERATEECBYTES_OFFSET UNITYSDK_OFFSET(0x1D302200)
#define ZXING_QRCODE_INTERNAL_ENCODER_GETALPHANUMERICCODE_OFFSET UNITYSDK_OFFSET(0x1D301DC0)
#define ZXING_QRCODE_INTERNAL_ENCODER_GETNUMDATABYTESANDNUMECBYTESFORBLOCKID_OFFSET UNITYSDK_OFFSET(0x1D302080)
#define ZXING_QRCODE_INTERNAL_ENCODER_INTERLEAVEWITHECBYTES_OFFSET UNITYSDK_OFFSET(0x1D300D00)
#define ZXING_QRCODE_INTERNAL_ENCODER_ISONLYDOUBLEBYTEKANJI_OFFSET UNITYSDK_OFFSET(0x1D301E90)
#define ZXING_QRCODE_INTERNAL_ENCODER_RECOMMENDVERSION_OFFSET UNITYSDK_OFFSET(0x1D300710)
#define ZXING_QRCODE_INTERNAL_ENCODER_TERMINATEBITS_OFFSET UNITYSDK_OFFSET(0x1D300A40)
#define ZXING_QRCODE_INTERNAL_ENCODER_WILLFIT_OFFSET UNITYSDK_OFFSET(0x1D300650)
#define ZXING_QRCODE_INTERNAL_ENCODER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D302D80)
...
namespace ZXing::QrCode::Internal
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Encoder_TypeDefinitionIndex)->GetStaticField(0x25C0);
		}
		static ::System::String** StaticGet_DEFAULT_BYTE_MODE_ENCODING()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Encoder_TypeDefinitionIndex)->GetStaticField(0x25C8);
		}
