...
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D2FE270)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_GET_ARRAY_OFFSET UNITYSDK_OFFSET(0x1D2FE260)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1D2FE1F0)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D2D8910)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1D2FE200)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1D2FE210)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_SET_OFFSET UNITYSDK_OFFSET(0x1D2D86C0)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D2FE310)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D85C0)
