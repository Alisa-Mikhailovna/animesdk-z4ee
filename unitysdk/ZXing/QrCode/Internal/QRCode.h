...
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_ECLEVEL_OFFSET UNITYSDK_OFFSET(0x1D308B40)
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_MASKPATTERN_OFFSET UNITYSDK_OFFSET(0x1D308B80)
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1D308BA0)
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1D308B20)
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1D308B60)
#define ZXING_QRCODE_INTERNAL_QRCODE_ISVALIDMASKPATTERN_OFFSET UNITYSDK_OFFSET(0x1D305040)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_ECLEVEL_OFFSET UNITYSDK_OFFSET(0x1D308B50)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_MASKPATTERN_OFFSET UNITYSDK_OFFSET(0x1D308B90)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1D308BB0)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1D308B30)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1D308B70)
#define ZXING_QRCODE_INTERNAL_QRCODE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D308BC0)
#define ZXING_QRCODE_INTERNAL_QRCODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D308EE0)
#define ZXING_QRCODE_INTERNAL_QRCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3019B0)
...
namespace ZXing::QrCode::Internal
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(QRCode_TypeDefinitionIndex)->GetStaticField(0xEF0);
		}
