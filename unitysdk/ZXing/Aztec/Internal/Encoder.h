...
#define ZXING_AZTEC_INTERNAL_ENCODER_BITSTOWORDS_OFFSET UNITYSDK_OFFSET(0x1D2CA880)
#define ZXING_AZTEC_INTERNAL_ENCODER_DRAWBULLSEYE_OFFSET UNITYSDK_OFFSET(0x1D2CA320)
#define ZXING_AZTEC_INTERNAL_ENCODER_DRAWMODEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1D2C9ED0)
#define ZXING_AZTEC_INTERNAL_ENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1D2C75F0)
#define ZXING_AZTEC_INTERNAL_ENCODER_GENERATECHECKWORDS_OFFSET UNITYSDK_OFFSET(0x1D2C9AF0)
#define ZXING_AZTEC_INTERNAL_ENCODER_GENERATEMODEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1D2C9C90)
#define ZXING_AZTEC_INTERNAL_ENCODER_GETGF_OFFSET UNITYSDK_OFFSET(0x1D2CA5A0)
#define ZXING_AZTEC_INTERNAL_ENCODER_STUFFBITS_OFFSET UNITYSDK_OFFSET(0x1D2C9940)
#define ZXING_AZTEC_INTERNAL_ENCODER_TOTALBITSINLAYER_OFFSET UNITYSDK_OFFSET(0x1D2C9920)
#define ZXING_AZTEC_INTERNAL_ENCODER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D2CAC70)
...
namespace ZXing::Aztec::Internal
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Encoder_TypeDefinitionIndex)->GetStaticField(0x1910);
		}
