...
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER_APPENDPATTERN_OFFSET UNITYSDK_OFFSET(0x1D2E9FE0)
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1D2E9060)
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER_GET_DEFAULTMARGIN_OFFSET UNITYSDK_OFFSET(0x1D2F14A0)
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER_RENDERRESULT_OFFSET UNITYSDK_OFFSET(0x1D2F1330)
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2E44F0)
