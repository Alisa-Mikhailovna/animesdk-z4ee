...
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_CORNER1_OFFSET UNITYSDK_OFFSET(0x1D2DB920)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_CORNER2_OFFSET UNITYSDK_OFFSET(0x1D2DBE40)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_CORNER3_OFFSET UNITYSDK_OFFSET(0x1D2DC3B0)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_CORNER4_OFFSET UNITYSDK_OFFSET(0x1D2DC920)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_GETBIT_OFFSET UNITYSDK_OFFSET(0x1D2D8710)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_HASBIT_OFFSET UNITYSDK_OFFSET(0x1D2DB8E0)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_MODULE_OFFSET UNITYSDK_OFFSET(0x1D2DD550)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_PLACE_OFFSET UNITYSDK_OFFSET(0x1D2D7870)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_SETBIT_OFFSET UNITYSDK_OFFSET(0x1D2DB8A0)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT_UTAH_OFFSET UNITYSDK_OFFSET(0x1D2DCE80)
#define ZXING_DATAMATRIX_ENCODER_DEFAULTPLACEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D7810)
