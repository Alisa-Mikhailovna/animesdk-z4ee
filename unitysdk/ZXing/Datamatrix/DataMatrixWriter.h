...
#define ZXING_DATAMATRIX_DATAMATRIXWRITER_CONVERTBYTEMATRIXTOBITMATRIX_OFFSET UNITYSDK_OFFSET(0x1D2D8750)
#define ZXING_DATAMATRIX_DATAMATRIXWRITER_ENCODELOWLEVEL_OFFSET UNITYSDK_OFFSET(0x1D2D7B50)
#define ZXING_DATAMATRIX_DATAMATRIXWRITER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1D2D4CA0)
#define ZXING_DATAMATRIX_DATAMATRIXWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D8960)
