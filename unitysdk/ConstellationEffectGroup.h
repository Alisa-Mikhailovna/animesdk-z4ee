...
#define CONSTELLATIONEFFECTGROUP_ADDALLCHILD_OFFSET UNITYSDK_OFFSET(0xD35A9A0)
#define CONSTELLATIONEFFECTGROUP_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0xD35A150)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_2BC1A70133D64A3E_OFFSET UNITYSDK_OFFSET(0xD35B1F0)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_AB0E32D900C7A89E_OFFSET UNITYSDK_OFFSET(0xD35AC00)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_CD054ADA8D27B4D4_OFFSET UNITYSDK_OFFSET(0xD35A1A0)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_E38DBF86ED41255C_OFFSET UNITYSDK_OFFSET(0xD35B510)
#define CONSTELLATIONEFFECTGROUP_METHOD_5_EA3063A5CDD6F164_OFFSET UNITYSDK_OFFSET(0xD35A3C0)
#define CONSTELLATIONEFFECTGROUP_UPDATE_OFFSET UNITYSDK_OFFSET(0xD35BC10)
#define CONSTELLATIONEFFECTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xD35BC60)
