...
#define CLASS_1_7D6A9EF535595749_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C20A850)
#define CLASS_1_7D6A9EF535595749_CLONE_OFFSET UNITYSDK_OFFSET(0x1C20A3D0)
#define CLASS_1_7D6A9EF535595749_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C20A5B0)
#define CLASS_1_7D6A9EF535595749_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C20A430)
#define CLASS_1_7D6A9EF535595749_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C20A6D0)
#define CLASS_1_7D6A9EF535595749_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C20A990)
#define CLASS_1_7D6A9EF535595749_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C20A8F0)
#define CLASS_1_7D6A9EF535595749_METHOD_1_2E179BEDD6B3AA06_OFFSET UNITYSDK_OFFSET(0x1C20A420)
#define CLASS_1_7D6A9EF535595749_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C20A260)
#define CLASS_1_7D6A9EF535595749_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C20A2C0)
#define CLASS_1_7D6A9EF535595749_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C20A740)
#define CLASS_1_7D6A9EF535595749_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C20A7A0)
#define CLASS_1_7D6A9EF535595749__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C20AB60)
#define CLASS_1_7D6A9EF535595749__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C20A320)
#define CLASS_1_7D6A9EF535595749__CTOR_OFFSET UNITYSDK_OFFSET(0x1C20A2D0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Enum_3_DFCB42601400F441>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7D6A9EF535595749_TypeDefinitionIndex)->GetStaticField(0x28830);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_7D6A9EF535595749*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_7D6A9EF535595749*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7D6A9EF535595749_TypeDefinitionIndex)->GetStaticField(0x28838);
	}
