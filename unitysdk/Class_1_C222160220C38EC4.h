...
#define CLASS_1_C222160220C38EC4_GET_ASSISTSCORE_OFFSET UNITYSDK_OFFSET(0x153C06D0)
#define CLASS_1_C222160220C38EC4_GET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0x153C06B0)
#define CLASS_1_C222160220C38EC4_GET_BATTLEREPLAYKEY_OFFSET UNITYSDK_OFFSET(0x153C0690)
#define CLASS_1_C222160220C38EC4_GET_DAMAGEHP_OFFSET UNITYSDK_OFFSET(0x153C0630)
#define CLASS_1_C222160220C38EC4_GET_DAMAGESCORE_OFFSET UNITYSDK_OFFSET(0x153C06F0)
#define CLASS_1_C222160220C38EC4_GET_FINALHITSCORE_OFFSET UNITYSDK_OFFSET(0x153C0710)
#define CLASS_1_C222160220C38EC4_GET_ISFINALHIT_OFFSET UNITYSDK_OFFSET(0x153C0650)
#define CLASS_1_C222160220C38EC4_GET_OVERKILLDAMAGEHP_OFFSET UNITYSDK_OFFSET(0x153C0670)
#define CLASS_1_C222160220C38EC4_GET_UID_OFFSET UNITYSDK_OFFSET(0x153C0610)
#define CLASS_1_C222160220C38EC4_METHOD_1_A85A5A4F484E8E77_OFFSET UNITYSDK_OFFSET(0x153C0520)
#define CLASS_1_C222160220C38EC4_METHOD_1_C37EE151D005EDA7_OFFSET UNITYSDK_OFFSET(0x153BFFB0)
#define CLASS_1_C222160220C38EC4_SET_ASSISTSCORE_OFFSET UNITYSDK_OFFSET(0x153C06E0)
#define CLASS_1_C222160220C38EC4_SET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0x153C06C0)
#define CLASS_1_C222160220C38EC4_SET_BATTLEREPLAYKEY_OFFSET UNITYSDK_OFFSET(0x153C06A0)
#define CLASS_1_C222160220C38EC4_SET_DAMAGEHP_OFFSET UNITYSDK_OFFSET(0x153C0640)
#define CLASS_1_C222160220C38EC4_SET_DAMAGESCORE_OFFSET UNITYSDK_OFFSET(0x153C0700)
#define CLASS_1_C222160220C38EC4_SET_FINALHITSCORE_OFFSET UNITYSDK_OFFSET(0x153C0720)
#define CLASS_1_C222160220C38EC4_SET_ISFINALHIT_OFFSET UNITYSDK_OFFSET(0x153C0660)
#define CLASS_1_C222160220C38EC4_SET_OVERKILLDAMAGEHP_OFFSET UNITYSDK_OFFSET(0x153C0680)
#define CLASS_1_C222160220C38EC4_SET_UID_OFFSET UNITYSDK_OFFSET(0x153C0620)
#define CLASS_1_C222160220C38EC4__CTOR_OFFSET UNITYSDK_OFFSET(0x153C0600)
