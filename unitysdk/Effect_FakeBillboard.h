...
#define EFFECT_FAKEBILLBOARD_ONENABLE_OFFSET UNITYSDK_OFFSET(0x144C1110)
#define EFFECT_FAKEBILLBOARD_RESET_OFFSET UNITYSDK_OFFSET(0x144C0D60)
#define EFFECT_FAKEBILLBOARD_START_OFFSET UNITYSDK_OFFSET(0x144C1160)
#define EFFECT_FAKEBILLBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0x144C11B0)
#define EFFECT_FAKEBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x144C1750)
