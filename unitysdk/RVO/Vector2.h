...
#define RVO_VECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xABA50C0)
#define RVO_VECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0xABA5090)
#define RVO_VECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0xABA4F20)
#define RVO_VECTOR2_OP_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0xABA8820)
#define RVO_VECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0xABA4FC0)
#define RVO_VECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0xABA4EF0)
#define RVO_VECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0xABA4FA0)
#define RVO_VECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2D5D0)
#define RVO_VECTOR2_X_OFFSET UNITYSDK_OFFSET(0xD4D0)
#define RVO_VECTOR2_Y_OFFSET UNITYSDK_OFFSET(0xD4F0)
#define RVO_VECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x2D5A0)
