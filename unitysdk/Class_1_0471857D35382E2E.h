...
#define CLASS_1_0471857D35382E2E_GET_BATTLEEVENTMODIFIERHINTLIST_OFFSET UNITYSDK_OFFSET(0x11995E00)
#define CLASS_1_0471857D35382E2E_GET_CURHP_OFFSET UNITYSDK_OFFSET(0x11995C70)
#define CLASS_1_0471857D35382E2E_GET_CURPHASE_OFFSET UNITYSDK_OFFSET(0x11995D50)
#define CLASS_1_0471857D35382E2E_GET_CURSHIELD_OFFSET UNITYSDK_OFFSET(0x11995CD0)
#define CLASS_1_0471857D35382E2E_GET_ENERGEBARSTATE_OFFSET UNITYSDK_OFFSET(0x11995DD0)
#define CLASS_1_0471857D35382E2E_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x11995B20)
#define CLASS_1_0471857D35382E2E_GET_HEADROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x11995DB0)
#define CLASS_1_0471857D35382E2E_GET_INTENTTYPELIST_OFFSET UNITYSDK_OFFSET(0x11995B40)
#define CLASS_1_0471857D35382E2E_GET_INTENTTYPEUISTATELIST_OFFSET UNITYSDK_OFFSET(0x11995B60)
#define CLASS_1_0471857D35382E2E_GET_ISBOSS_OFFSET UNITYSDK_OFFSET(0x11995B80)
#define CLASS_1_0471857D35382E2E_GET_ISHAVINGSUPERSHIELD_OFFSET UNITYSDK_OFFSET(0x11995D10)
#define CLASS_1_0471857D35382E2E_GET_ISSHORTHPBAR_OFFSET UNITYSDK_OFFSET(0x11995E70)
#define CLASS_1_0471857D35382E2E_GET_ISSHOWSTATUSDETAIL_OFFSET UNITYSDK_OFFSET(0x11995E50)
#define CLASS_1_0471857D35382E2E_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0x11995C90)
#define CLASS_1_0471857D35382E2E_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0x11995D70)
#define CLASS_1_0471857D35382E2E_GET_NAME_OFFSET UNITYSDK_OFFSET(0x11995D90)
#define CLASS_1_0471857D35382E2E_GET_PREVIEWHP_OFFSET UNITYSDK_OFFSET(0x11995CB0)
#define CLASS_1_0471857D35382E2E_GET_PREVIEWSHIELD_OFFSET UNITYSDK_OFFSET(0x11995CF0)
#define CLASS_1_0471857D35382E2E_GET_RANK_OFFSET UNITYSDK_OFFSET(0x11995D30)
#define CLASS_1_0471857D35382E2E_GET_SPECIALMARKSTATE_OFFSET UNITYSDK_OFFSET(0x11995DE0)
#define CLASS_1_0471857D35382E2E_GET_STATUSLIST_OFFSET UNITYSDK_OFFSET(0x11995DF0)
#define CLASS_1_0471857D35382E2E_GET_SUMMONEDENEMYLIST_OFFSET UNITYSDK_OFFSET(0x11995E30)
#define CLASS_1_0471857D35382E2E_GET_SUMMONERENEMY_OFFSET UNITYSDK_OFFSET(0x11995E10)
#define CLASS_1_0471857D35382E2E_METHOD_1_0111646D03725A22_OFFSET UNITYSDK_OFFSET(0x11995700)
#define CLASS_1_0471857D35382E2E_METHOD_1_213EB2BE094A913C_OFFSET UNITYSDK_OFFSET(0x11995370)
#define CLASS_1_0471857D35382E2E_METHOD_1_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x119953C0)
#define CLASS_1_0471857D35382E2E_METHOD_1_3845AD389B8E1E47_OFFSET UNITYSDK_OFFSET(0x11995BA0)
#define CLASS_1_0471857D35382E2E_METHOD_1_6916CB2AB9451DD7_OFFSET UNITYSDK_OFFSET(0x11995760)
#define CLASS_1_0471857D35382E2E_METHOD_1_8E119BCE0EDEB783_OFFSET UNITYSDK_OFFSET(0x11995430)
#define CLASS_1_0471857D35382E2E_METHOD_1_9BF4011ADBFBC88B_OFFSET UNITYSDK_OFFSET(0x11995C10)
#define CLASS_1_0471857D35382E2E_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x11995AD0)
#define CLASS_1_0471857D35382E2E_METHOD_1_AC9D28A922B0CD10_OFFSET UNITYSDK_OFFSET(0x11994DB0)
#define CLASS_1_0471857D35382E2E_SET_CURHP_OFFSET UNITYSDK_OFFSET(0x11995C80)
#define CLASS_1_0471857D35382E2E_SET_CURPHASE_OFFSET UNITYSDK_OFFSET(0x11995D60)
#define CLASS_1_0471857D35382E2E_SET_CURSHIELD_OFFSET UNITYSDK_OFFSET(0x11995CE0)
#define CLASS_1_0471857D35382E2E_SET_ENTITY_OFFSET UNITYSDK_OFFSET(0x11995B30)
#define CLASS_1_0471857D35382E2E_SET_HEADROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x11995DC0)
#define CLASS_1_0471857D35382E2E_SET_INTENTTYPELIST_OFFSET UNITYSDK_OFFSET(0x11995B50)
#define CLASS_1_0471857D35382E2E_SET_INTENTTYPEUISTATELIST_OFFSET UNITYSDK_OFFSET(0x11995B70)
#define CLASS_1_0471857D35382E2E_SET_ISBOSS_OFFSET UNITYSDK_OFFSET(0x11995B90)
#define CLASS_1_0471857D35382E2E_SET_ISHAVINGSUPERSHIELD_OFFSET UNITYSDK_OFFSET(0x11995D20)
#define CLASS_1_0471857D35382E2E_SET_ISSHORTHPBAR_OFFSET UNITYSDK_OFFSET(0x11995E80)
#define CLASS_1_0471857D35382E2E_SET_ISSHOWSTATUSDETAIL_OFFSET UNITYSDK_OFFSET(0x11995E60)
#define CLASS_1_0471857D35382E2E_SET_MAXHP_OFFSET UNITYSDK_OFFSET(0x11995CA0)
#define CLASS_1_0471857D35382E2E_SET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0x11995D80)
#define CLASS_1_0471857D35382E2E_SET_NAME_OFFSET UNITYSDK_OFFSET(0x11995DA0)
#define CLASS_1_0471857D35382E2E_SET_PREVIEWHP_OFFSET UNITYSDK_OFFSET(0x11995CC0)
#define CLASS_1_0471857D35382E2E_SET_PREVIEWSHIELD_OFFSET UNITYSDK_OFFSET(0x11995D00)
#define CLASS_1_0471857D35382E2E_SET_RANK_OFFSET UNITYSDK_OFFSET(0x11995D40)
#define CLASS_1_0471857D35382E2E_SET_SUMMONEDENEMYLIST_OFFSET UNITYSDK_OFFSET(0x11995E40)
#define CLASS_1_0471857D35382E2E_SET_SUMMONERENEMY_OFFSET UNITYSDK_OFFSET(0x11995E20)
#define CLASS_1_0471857D35382E2E__CTOR_OFFSET UNITYSDK_OFFSET(0x11994C90)

inline static constexpr unsigned int Class_1_0471857D35382E2E_TypeDefinitionIndex = 76050;

class Class_1_0471857D35382E2E : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::System::String*>* _IntentTypeUIStateList_k__BackingField; // 0x10
	::Class_1_F917B69C2E81F61E_1* _SpecialMarkState_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::RPG::GameCore::FateRinActionIntentType>* _IntentTypeList_k__BackingField; // 0x20
	::Class_1_0471857D35382E2E* _SummonerEnemy_k__BackingField; // 0x28
	::System::Collections::Generic::List_1<::Class_1_0471857D35382E2E*>* _SummonedEnemyList_k__BackingField; // 0x30
	::System::String* _HeadRoundIconPath_k__BackingField; // 0x38
	::RPG::GameCore::GameEntity* _Entity_k__BackingField; // 0x40
	::System::Collections::Generic::List_1<::Class_1_D126770E0092C973*>* _BattleEventModifierHintList_k__BackingField; // 0x48
	::Class_1_26B93FFBE9FAEBB7* _EnergeBarState_k__BackingField; // 0x50
	::System::Collections::Generic::List_1<::Class_1_42D96751C1376DDB*>* _StatusList_k__BackingField; // 0x58
	::RPG::GameCore::FixPoint _PreviewShield_k__BackingField; // 0x60
	::RPG::GameCore::FixPoint _CurShield_k__BackingField; // 0x68
	::System::Boolean _IsShortHPBar_k__BackingField; // 0x70
	::System::Boolean _IsBoss_k__BackingField; // 0x71
	::System::Boolean _IsHavingSuperShield_k__BackingField; // 0x72
	::System::Boolean _IsShowStatusDetail_k__BackingField; // 0x73
	::System::UInt32 _CurPhase_k__BackingField; // 0x74
	::RPG::GameCore::FixPoint _MaxHP_k__BackingField; // 0x78
	::RPG::GameCore::FixPoint _PreviewHP_k__BackingField; // 0x80
	::RPG::Client::TextID _Name_k__BackingField; // 0x88
	::RPG::GameCore::FixPoint _CurHP_k__BackingField; // 0x98
	::System::UInt32 _MaxPhase_k__BackingField; // 0xA0
	::RPG::GameCore::MonsterRank _Rank_k__BackingField; // 0xA4
