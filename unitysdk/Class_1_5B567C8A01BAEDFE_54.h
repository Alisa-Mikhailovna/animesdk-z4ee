...
#define CLASS_1_5B567C8A01BAEDFE_54_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C67B010)
#define CLASS_1_5B567C8A01BAEDFE_54_CLONE_OFFSET UNITYSDK_OFFSET(0x1C67AD00)
#define CLASS_1_5B567C8A01BAEDFE_54_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C67AE10)
#define CLASS_1_5B567C8A01BAEDFE_54_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C67AD40)
#define CLASS_1_5B567C8A01BAEDFE_54_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C67AF70)
#define CLASS_1_5B567C8A01BAEDFE_54_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C67B060)
#define CLASS_1_5B567C8A01BAEDFE_54_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C67B030)
#define CLASS_1_5B567C8A01BAEDFE_54_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C67AC80)
#define CLASS_1_5B567C8A01BAEDFE_54_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C67ACB0)
#define CLASS_1_5B567C8A01BAEDFE_54_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C67AFA0)
#define CLASS_1_5B567C8A01BAEDFE_54_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C67B000)
#define CLASS_1_5B567C8A01BAEDFE_54__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C67B0B0)
#define CLASS_1_5B567C8A01BAEDFE_54__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C67ACD0)
#define CLASS_1_5B567C8A01BAEDFE_54__CTOR_OFFSET UNITYSDK_OFFSET(0x1C67ACC0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_54*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_54_TypeDefinitionIndex)->GetStaticField(0x66F10);
	}
