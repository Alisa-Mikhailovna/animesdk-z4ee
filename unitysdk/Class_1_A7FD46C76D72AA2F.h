...
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0xE4F55C0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_07E567B3C6C3D7D7_OFFSET UNITYSDK_OFFSET(0xE4F54C0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_0C777326728A36C7_OFFSET UNITYSDK_OFFSET(0xE4F5F90)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_125D1D788056F439_OFFSET UNITYSDK_OFFSET(0xE4FAD30)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_14D2AA1A43D6F8FB_OFFSET UNITYSDK_OFFSET(0xE4F8680)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_15D44EBC368C10BE_OFFSET UNITYSDK_OFFSET(0xE4F7DF0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_16B2E34B9F95EA16_OFFSET UNITYSDK_OFFSET(0xE4F8A60)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_1A0A56C2B619FF51_OFFSET UNITYSDK_OFFSET(0xE4FC670)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0xE4FA850)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_1C38695375052765_OFFSET UNITYSDK_OFFSET(0xE4FF7D0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xE4F8320)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_1D61B10247A1F114_OFFSET UNITYSDK_OFFSET(0xE4F4FF0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0xE4FB860)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_248B4C1FDB4A64C9_OFFSET UNITYSDK_OFFSET(0xE4FB410)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_24EF0ABC5DDA50E1_OFFSET UNITYSDK_OFFSET(0xE4FDD50)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_28A4CAF0E0F00E26_OFFSET UNITYSDK_OFFSET(0xE4F5F00)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_2DE98C8482BC8A62_OFFSET UNITYSDK_OFFSET(0xE4FA6A0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_2FE8818B0EBEE5E2_OFFSET UNITYSDK_OFFSET(0xE4FBA60)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_303D3AEC876F84B2_OFFSET UNITYSDK_OFFSET(0xE4F8400)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_333D814AA137C1D3_OFFSET UNITYSDK_OFFSET(0xE4FD160)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_336E6EC0A7BD5248_OFFSET UNITYSDK_OFFSET(0xE4F8850)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_415CDC0125472EBC_OFFSET UNITYSDK_OFFSET(0xE4F9ED0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_4314FE42BBEBFFB4_OFFSET UNITYSDK_OFFSET(0xE4F8380)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xE4FA630)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_4F548348F29E93D9_OFFSET UNITYSDK_OFFSET(0xE4F9AB0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_50B46F68CE4982FA_OFFSET UNITYSDK_OFFSET(0xE4F8470)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_50B7E6E92894BE2B_OFFSET UNITYSDK_OFFSET(0xE4F7B70)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xE4F51E0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_54CB10256069F15D_OFFSET UNITYSDK_OFFSET(0xE4FA8B0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_5545B1147CDCF515_OFFSET UNITYSDK_OFFSET(0xE4FCA30)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_554C34E265254C5D_OFFSET UNITYSDK_OFFSET(0xE4FA1E0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_64501B5CB67A94C3_OFFSET UNITYSDK_OFFSET(0xE4FB710)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_6DA9299447BB1B40_OFFSET UNITYSDK_OFFSET(0xE4FD9F0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_6E204D82E0C968BF_OFFSET UNITYSDK_OFFSET(0xE4F8E40)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_841D90BDB3E94FF6_OFFSET UNITYSDK_OFFSET(0xE4F95B0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_85B3161A8A652439_OFFSET UNITYSDK_OFFSET(0xE4F85D0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0xE4F71F0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_96E4C6963BABD9F4_OFFSET UNITYSDK_OFFSET(0xE4FAB90)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_A367EE0F970DCB81_OFFSET UNITYSDK_OFFSET(0xE4F87E0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_B8861AEBFFFB25CA_OFFSET UNITYSDK_OFFSET(0xE4FA3B0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_C11E3340663BA3CE_OFFSET UNITYSDK_OFFSET(0xE4F94A0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE4F5440)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_DFBA82AE79076F25_OFFSET UNITYSDK_OFFSET(0xE4F76B0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_E41D77109E4F38E6_OFFSET UNITYSDK_OFFSET(0xE5006C0)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_E59B0636DF9608FF_OFFSET UNITYSDK_OFFSET(0xE4F9850)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_EC86032BD7B258D7_OFFSET UNITYSDK_OFFSET(0xE4F6270)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_F7A9367BB79090D6_OFFSET UNITYSDK_OFFSET(0xE4F9020)
#define CLASS_1_A7FD46C76D72AA2F_METHOD_1_FC643861C42BA698_OFFSET UNITYSDK_OFFSET(0xE4F6100)
#define CLASS_1_A7FD46C76D72AA2F__CCTOR_OFFSET UNITYSDK_OFFSET(0xE500DB0)
#define CLASS_1_A7FD46C76D72AA2F__CTOR_OFFSET UNITYSDK_OFFSET(0xE4F4FD0)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A7FD46C76D72AA2F_TypeDefinitionIndex)->GetStaticField(0x67F50);
	}
	static ::System::String** StaticGet_Field_1_1()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A7FD46C76D72AA2F_TypeDefinitionIndex)->GetStaticField(0x67F58);
	}
	static ::System::String** StaticGet_Field_1_2()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A7FD46C76D72AA2F_TypeDefinitionIndex)->GetStaticField(0x67F60);
	}
	::System::Collections::Generic::List_1<::Class_1_6B6A4C789452DEC6*>* Field_1_3; // 0x10
	::Class_1_D27BF54F25500E5F* Field_1_4; // 0x18
	::System::Collections::Generic::List_1<::Class_1_6B6A4C789452DEC6*>* Field_1_5; // 0x20
	::RPG::CustomRP::RPGGaussianBlur* Field_1_6; // 0x28
	::RPG::CustomRP::RPGLensGlitch2* Field_1_7; // 0x30
	::RPG::CustomRP::RPGRadialBlur* Field_1_8; // 0x38
	::RPG::CustomRP::RPGVignette* Field_1_9; // 0x40
	::RPG::CustomRP::RPGBlink* Field_1_10; // 0x48
	::Class_2_74361E0442AB1DB0* Field_1_11; // 0x50
	::System::Collections::Generic::List_1<::Class_1_6B6A4C789452DEC6*>* Field_1_12; // 0x58
	::RPG::CustomRP::RPGAdditionalColorGrading* Field_1_13; // 0x60
	::Class_2_1FB66008306098B0* Field_1_14; // 0x68
	::RPG::CustomRP::RPGChromaticAberration* Field_1_15; // 0x70
	::System::Collections::Generic::List_1<::Class_1_6B6A4C789452DEC6*>* Field_1_16; // 0x78
	::RPG::CustomRP::RPGPPPattern* Field_1_17; // 0x80
	::RPG::CustomRP::RPGColorGrading* Field_1_18; // 0x88
	::RPG::CustomRP::PPFilterStack* Field_1_19; // 0x90
	::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::CustomRP::PPFilterStack*>* Field_1_20; // 0x98
	::Class_1_D27BF54F25500E5F* Field_1_21; // 0xA0
	::System::Collections::Generic::List_1<::Class_1_6B6A4C789452DEC6*>* Field_1_22; // 0xA8
	::Class_2_F9868A24C60208C0* Field_1_23; // 0xB0
	::System::Boolean Field_1_24; // 0xB8
	::System::Boolean Field_1_25; // 0xB9
	::System::Boolean Field_1_26; // 0xBA
	::UnityEngine::Rendering::VolumeProxy_Priority Field_1_27; // 0xBC
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_A7FD46C76D72AA2F_METHOD_1_8CA88D55ECEFAD59_OFFSET))(this);
	}
