...
#define CLASS_2_523C55AEA55804D8_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11FAFCC0)
#define CLASS_2_523C55AEA55804D8_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x11FB13C0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x11FB2CB0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_1FFE4260A7179061_OFFSET UNITYSDK_OFFSET(0x11FB2E00)
#define CLASS_2_523C55AEA55804D8_METHOD_2_25C863F1B6DFA9F4_OFFSET UNITYSDK_OFFSET(0x11FAFDA0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_2A2B4A2E0BDAAF15_OFFSET UNITYSDK_OFFSET(0x11FB0D70)
#define CLASS_2_523C55AEA55804D8_METHOD_2_3CAC93BF77250DAD_OFFSET UNITYSDK_OFFSET(0x11FB2DE0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_4538E9501054E688_OFFSET UNITYSDK_OFFSET(0x11FB1440)
#define CLASS_2_523C55AEA55804D8_METHOD_2_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0x11FB2B10)
#define CLASS_2_523C55AEA55804D8_METHOD_2_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x11FB1360)
#define CLASS_2_523C55AEA55804D8_METHOD_2_57D80B372834C5D1_OFFSET UNITYSDK_OFFSET(0x11FB1730)
#define CLASS_2_523C55AEA55804D8_METHOD_2_595E641DF1B4387D_OFFSET UNITYSDK_OFFSET(0x11FB0E00)
#define CLASS_2_523C55AEA55804D8_METHOD_2_6516DD2B8C441001_OFFSET UNITYSDK_OFFSET(0x11FB0A90)
#define CLASS_2_523C55AEA55804D8_METHOD_2_68A2CA32DC720C44_OFFSET UNITYSDK_OFFSET(0x11FB2BC0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_7F4EBEC55EBE2D81_OFFSET UNITYSDK_OFFSET(0x11FB2070)
#define CLASS_2_523C55AEA55804D8_METHOD_2_7F5959D5B740D04C_OFFSET UNITYSDK_OFFSET(0x11FB0CE0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_7FCED9DBE84C0CF1_OFFSET UNITYSDK_OFFSET(0x11FB1940)
#define CLASS_2_523C55AEA55804D8_METHOD_2_8493EBF84986D042_OFFSET UNITYSDK_OFFSET(0x11FB1540)
#define CLASS_2_523C55AEA55804D8_METHOD_2_A944F7B3B6322143_OFFSET UNITYSDK_OFFSET(0x11FB0F50)
#define CLASS_2_523C55AEA55804D8_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x11FB2DF0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_BA0C5F78E9FFA006_OFFSET UNITYSDK_OFFSET(0x11FB2170)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C0A2DE8417347362_OFFSET UNITYSDK_OFFSET(0x11FB0460)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x11FB2E40)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x11FB2EC0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x11FB2E30)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x11FB1900)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x11FB18C0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0x11FB2E60)
#define CLASS_2_523C55AEA55804D8_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x11FB1790)
#define CLASS_2_523C55AEA55804D8_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x11FAFBD0)
#define CLASS_2_523C55AEA55804D8_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x11FB2E50)
#define CLASS_2_523C55AEA55804D8_ONMODELROOTLOADED_OFFSET UNITYSDK_OFFSET(0x11FB0800)
#define CLASS_2_523C55AEA55804D8_ONMODELROOTUNLOADED_OFFSET UNITYSDK_OFFSET(0x11FB0C70)
#define CLASS_2_523C55AEA55804D8__CCTOR_OFFSET UNITYSDK_OFFSET(0x11FB2ED0)
#define CLASS_2_523C55AEA55804D8__CTOR_OFFSET UNITYSDK_OFFSET(0x11FAFB10)
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_523C55AEA55804D8_TypeDefinitionIndex)->GetStaticField(0xC6E0);
	}
	static ::System::Boolean* StaticGet_Field_2_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_523C55AEA55804D8_TypeDefinitionIndex)->GetStaticField(0x4970);
	}
	// static const ::System::Single Field_2_2; // 0x0
	::Class_3_2B2F6402EA3EAA0F* Field_2_3; // 0x18
	::System::Action* Field_2_4; // 0x20
	::RPG::GameCore::GameEntity* Field_2_5; // 0x28
	::Class_1_51EED7CD291B614D* Field_2_6; // 0x30
	::System::Action_1<::RPG::GameCore::GameEntity*>* Field_2_7; // 0x38
	::Class_1_D70A30D666F20D90* Field_2_8; // 0x40
	::RPG::GameCore::TransformComponent* Field_2_9; // 0x48
	::Class_0_16E4307DCC419505_566* Field_2_10; // 0x50
	::System::Action* Field_2_11; // 0x58
	::UnityEngine::Collider* Field_2_12; // 0x60
	::UnityEngine::Collider* Field_2_13; // 0x68
	...
	::System::Boolean Field_2_19; // 0x7F
	::System::Boolean Field_2_20; // 0x80
	::System::Int32 Field_2_21; // 0x84
	::System::Int32 Field_2_22; // 0x88
	::UnityEngine::Vector3 Field_2_23; // 0x8C
	::UnityEngine::RaycastHit Field_2_24; // 0x98
	::UnityEngine::Vector3 Field_2_25; // 0xC8
