...
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_CREATEFEATURE_OFFSET UNITYSDK_OFFSET(0x1D0A0A90)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_CREATEGRAPHICSDEVICE_OFFSET UNITYSDK_OFFSET(0x1D0A07D0)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_CREATESETTEXTUREUSERDATA_OFFSET UNITYSDK_OFFSET(0x1D0A05F0)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_DESTROYFEATURE_OFFSET UNITYSDK_OFFSET(0x1D0A0E40)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_EXECUTEDLSS_OFFSET UNITYSDK_OFFSET(0x1D0A0F00)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D0A0080)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_GETOPTIMALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D0A1050)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1D0A0820)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1D0A0850)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1D09FD30)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_INSERTEVENTCALL_OFFSET UNITYSDK_OFFSET(0x1D0A0150)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_INTERNALCREATE_OFFSET UNITYSDK_OFFSET(0x1D0A03F0)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_ISFEATUREAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1D0A0970)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_NVUP_CREATEFEATURESLOT_OFFSET UNITYSDK_OFFSET(0x1D0A0DC0)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_NVUP_GETBASEEVENTID_OFFSET UNITYSDK_OFFSET(0x1D0A0370)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_NVUP_GETDEVICEVERSION_OFFSET UNITYSDK_OFFSET(0x1D0A08F0)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_NVUP_GETOPTIMALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D0A1120)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_NVUP_GETRENDEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D0A02F0)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_NVUP_GETSETTEXTUREEVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1D0A0750)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_NVUP_INITAPI_OFFSET UNITYSDK_OFFSET(0x1D09FEE0)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_NVUP_ISFEATUREAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1D0A0A10)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_NVUP_SHUTDOWNAPI_OFFSET UNITYSDK_OFFSET(0x1D0A0000)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D0A0610)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE_SHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1D09FF60)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D0A11B0)
#define UNITYENGINE_NVIDIA_GRAPHICSDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09FAA0)
