...
#define UNITYENGINE_NVIDIA_OPTIMALDLSSSETTINGSDATA_GET_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x6E20)
#define UNITYENGINE_NVIDIA_OPTIMALDLSSSETTINGSDATA_GET_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0x14EDE0)
#define UNITYENGINE_NVIDIA_OPTIMALDLSSSETTINGSDATA_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x6320)
#define UNITYENGINE_NVIDIA_OPTIMALDLSSSETTINGSDATA_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x6E30)
#define UNITYENGINE_NVIDIA_OPTIMALDLSSSETTINGSDATA_GET_OUTRENDERHEIGHT_OFFSET UNITYSDK_OFFSET(0x1E130)
#define UNITYENGINE_NVIDIA_OPTIMALDLSSSETTINGSDATA_GET_OUTRENDERWIDTH_OFFSET UNITYSDK_OFFSET(0x5EF0)
