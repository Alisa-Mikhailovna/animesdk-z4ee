...
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D14D100)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D14D240)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D14D2A0)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D14D250)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D14D0F0)
#define UNITYENGINE_UI_INPUTFIELD__CARETBLINK_D__166__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13FA50)
