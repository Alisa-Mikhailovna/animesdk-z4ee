...
#define UNITYENGINE_UI_GRAPHICMATERIALINSTANCE_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x1D126E80)
#define UNITYENGINE_UI_GRAPHICMATERIALINSTANCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D127130)
#define UNITYENGINE_UI_GRAPHICMATERIALINSTANCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D126F00)
#define UNITYENGINE_UI_GRAPHICMATERIALINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1272C0)
