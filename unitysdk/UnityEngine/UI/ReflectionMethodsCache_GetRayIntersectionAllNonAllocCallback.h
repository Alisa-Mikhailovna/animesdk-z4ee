...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLNONALLOCCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D165EA0)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLNONALLOCCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D165F60)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLNONALLOCCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D165E60)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLNONALLOCCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165DF0)
