...
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D120DD0)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D120E50)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D120EB0)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D120E60)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D120DC0)
#define UNITYENGINE_UI_DROPDOWN__DELAYEDDESTROYDROPDOWNLIST_D__92__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1209F0)
