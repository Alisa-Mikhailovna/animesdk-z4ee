...
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_PACKEDATLAS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1D16A800)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_PACKEDATLAS_ERASE_OFFSET UNITYSDK_OFFSET(0x1D16AAA0)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_PACKEDATLAS_TRYGET_OFFSET UNITYSDK_OFFSET(0x1D16AA70)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_PACKEDATLAS_UPDATEAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1D16A690)
#define UNITYENGINE_UI_RUNTIMEATLASMANAGER_PACKEDATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1685F0)
