...
#define UNITYENGINE_UI_RECTANGULARVERTEXCLIPPER_GETCANVASRECT_OFFSET UNITYSDK_OFFSET(0x1D160FE0)
#define UNITYENGINE_UI_RECTANGULARVERTEXCLIPPER_GETWORLDCORNERSWITHOUTROTATIONZ_OFFSET UNITYSDK_OFFSET(0x1D164680)
#define UNITYENGINE_UI_RECTANGULARVERTEXCLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D161830)
