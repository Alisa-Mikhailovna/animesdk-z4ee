...
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_GET_DISABLEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AEB0)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_GET_HIGHLIGHTEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AE50)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_GET_NORMALTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AE30)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_GET_PRESSEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AE70)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_GET_SELECTEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AE90)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D10AEE0)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D10AED0)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_SET_DISABLEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AEC0)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_SET_HIGHLIGHTEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AE60)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_SET_NORMALTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AE40)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_SET_PRESSEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AE80)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS_SET_SELECTEDTRIGGER_OFFSET UNITYSDK_OFFSET(0x1D10AEA0)
#define UNITYENGINE_UI_ANIMATIONTRIGGERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D10B000)
