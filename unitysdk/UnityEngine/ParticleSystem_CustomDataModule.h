...
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A3B70)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETCOLOR_OFFSET UNITYSDK_OFFSET(0x3A35A60)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETMODE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A3A10)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETMODE_OFFSET UNITYSDK_OFFSET(0x3A35970)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETVECTORCOMPONENTCOUNT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A3A50)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETVECTORCOMPONENTCOUNT_OFFSET UNITYSDK_OFFSET(0x3A35990)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETVECTOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A3AD0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GETVECTOR_OFFSET UNITYSDK_OFFSET(0x3A359D0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A39B0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x3A35940)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A3AF0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x3A35A20)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETMODE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A39F0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETMODE_OFFSET UNITYSDK_OFFSET(0x3A35960)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETVECTORCOMPONENTCOUNT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A3A30)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETVECTORCOMPONENTCOUNT_OFFSET UNITYSDK_OFFSET(0x3A35980)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETVECTOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A3A70)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x3A359A0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D0A39D0)
#define UNITYENGINE_PARTICLESYSTEM_CUSTOMDATAMODULE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x3A35950)
