...
#define UNITYENGINE_AI_NAVMESH_ONNAVMESHPREUPDATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CFDA610)
#define UNITYENGINE_AI_NAVMESH_ONNAVMESHPREUPDATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CFDA640)
#define UNITYENGINE_AI_NAVMESH_ONNAVMESHPREUPDATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CFDA090)
#define UNITYENGINE_AI_NAVMESH_ONNAVMESHPREUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFDA5A0)
