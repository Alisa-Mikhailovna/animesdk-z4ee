...
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x3A22310)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x2E0C5D0)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x3A222D0)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_SOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0x3A22300)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x2D0B980)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_INTERNALGETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1CFDB210)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_INTERNALGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1CFDB1F0)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_SET_AREA_OFFSET UNITYSDK_OFFSET(0xBF00)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_SET_SHAPE_OFFSET UNITYSDK_OFFSET(0x2E0C5E0)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x3A222F0)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x2D0B9B0)
