...
#define UNITYENGINE_AI_NAVMESHBUILDSETTINGS_GET_AGENTTYPEID_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define UNITYENGINE_AI_NAVMESHBUILDSETTINGS_SET_AGENTTYPEID_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define UNITYENGINE_AI_NAVMESHBUILDSETTINGS_SET_OVERRIDETILESIZE_OFFSET UNITYSDK_OFFSET(0x3A222B0)
#define UNITYENGINE_AI_NAVMESHBUILDSETTINGS_SET_OVERRIDEVOXELSIZE_OFFSET UNITYSDK_OFFSET(0x3A222A0)
#define UNITYENGINE_AI_NAVMESHBUILDSETTINGS_SET_TILESIZE_OFFSET UNITYSDK_OFFSET(0x3A222C0)
#define UNITYENGINE_AI_NAVMESHBUILDSETTINGS_SET_VOXELSIZE_OFFSET UNITYSDK_OFFSET(0xC250)
