...
#define UNITYENGINE_AI_NAVMESHLINKDATA_GET_ENDPOSITION_OFFSET UNITYSDK_OFFSET(0x25510)
#define UNITYENGINE_AI_NAVMESHLINKDATA_GET_STARTPOSITION_OFFSET UNITYSDK_OFFSET(0x254F0)
#define UNITYENGINE_AI_NAVMESHLINKDATA_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x39EC540)
#define UNITYENGINE_AI_NAVMESHLINKDATA_SET_AGENTTYPEID_OFFSET UNITYSDK_OFFSET(0xC260)
#define UNITYENGINE_AI_NAVMESHLINKDATA_SET_AREA_OFFSET UNITYSDK_OFFSET(0x2E0C0A0)
#define UNITYENGINE_AI_NAVMESHLINKDATA_SET_BIDIRECTIONAL_OFFSET UNITYSDK_OFFSET(0x3A22430)
#define UNITYENGINE_AI_NAVMESHLINKDATA_SET_COSTMODIFIER_OFFSET UNITYSDK_OFFSET(0x758B0)
#define UNITYENGINE_AI_NAVMESHLINKDATA_SET_ENDPOSITION_OFFSET UNITYSDK_OFFSET(0x14C490)
#define UNITYENGINE_AI_NAVMESHLINKDATA_SET_STARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1CE8A90)
#define UNITYENGINE_AI_NAVMESHLINKDATA_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x3A22440)
