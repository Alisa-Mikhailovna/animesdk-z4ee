...
#define UNITYENGINE_AI_NAVMESHBUILDER_BUILDNAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x1CFDB5C0)
#define UNITYENGINE_AI_NAVMESHBUILDER_COLLECTSOURCESINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CFDB5B0)
#define UNITYENGINE_AI_NAVMESHBUILDER_COLLECTSOURCESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CFDB410)
#define UNITYENGINE_AI_NAVMESHBUILDER_COLLECTSOURCES_1_OFFSET UNITYSDK_OFFSET(0x1CFDB420)
#define UNITYENGINE_AI_NAVMESHBUILDER_COLLECTSOURCES_OFFSET UNITYSDK_OFFSET(0x1CFDB220)
#define UNITYENGINE_AI_NAVMESHBUILDER_UPDATENAVMESHDATAASYNCLISTINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CFDB870)
#define UNITYENGINE_AI_NAVMESHBUILDER_UPDATENAVMESHDATAASYNCLISTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CFDB860)
#define UNITYENGINE_AI_NAVMESHBUILDER_UPDATENAVMESHDATAASYNC_OFFSET UNITYSDK_OFFSET(0x1CFDB760)
#define UNITYENGINE_AI_NAVMESHBUILDER_UPDATENAVMESHDATALISTINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1CFDB750)
#define UNITYENGINE_AI_NAVMESHBUILDER_UPDATENAVMESHDATALISTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CFDB740)
