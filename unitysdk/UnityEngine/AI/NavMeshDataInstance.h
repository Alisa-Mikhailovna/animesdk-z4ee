...
#define UNITYENGINE_AI_NAVMESHDATAINSTANCE_GET_ID_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define UNITYENGINE_AI_NAVMESHDATAINSTANCE_GET_VALID_OFFSET UNITYSDK_OFFSET(0x3A22320)
#define UNITYENGINE_AI_NAVMESHDATAINSTANCE_REMOVE_OFFSET UNITYSDK_OFFSET(0x3A22340)
#define UNITYENGINE_AI_NAVMESHDATAINSTANCE_SET_ID_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define UNITYENGINE_AI_NAVMESHDATAINSTANCE_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x3A22350)
