...
#define UNITYENGINE_AI_RVOSIMULATOR_ADDOBSTACLE_OFFSET UNITYSDK_OFFSET(0x1CFDC2D0)
#define UNITYENGINE_AI_RVOSIMULATOR_ASYNCSIMULATE_OFFSET UNITYSDK_OFFSET(0x1CFDC300)
#define UNITYENGINE_AI_RVOSIMULATOR_FETCHRESULT_OFFSET UNITYSDK_OFFSET(0x1CFDC310)
#define UNITYENGINE_AI_RVOSIMULATOR_INTERNAL_CREATERVOSIMULATOR_OFFSET UNITYSDK_OFFSET(0x1CFDC250)
#define UNITYENGINE_AI_RVOSIMULATOR_PROCESSOBSTACLES_OFFSET UNITYSDK_OFFSET(0x1CFDC2E0)
#define UNITYENGINE_AI_RVOSIMULATOR_REGISTERAGENT_OFFSET UNITYSDK_OFFSET(0x1CFDC2B0)
#define UNITYENGINE_AI_RVOSIMULATOR_REMOVE_OFFSET UNITYSDK_OFFSET(0x1CFDC290)
#define UNITYENGINE_AI_RVOSIMULATOR_SET_ENABLEPOSTPROCESS_OFFSET UNITYSDK_OFFSET(0x1CFDC280)
#define UNITYENGINE_AI_RVOSIMULATOR_SET_NEIGHBORHEIGHTLIMIT_OFFSET UNITYSDK_OFFSET(0x1CFDC270)
#define UNITYENGINE_AI_RVOSIMULATOR_SET_TIMESTEP_OFFSET UNITYSDK_OFFSET(0x1CFDC260)
#define UNITYENGINE_AI_RVOSIMULATOR_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1CFDC2F0)
#define UNITYENGINE_AI_RVOSIMULATOR_UNREGISTERAGENT_OFFSET UNITYSDK_OFFSET(0x1CFDC2C0)
#define UNITYENGINE_AI_RVOSIMULATOR_UNREGISTERALLTYPEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CFDC2A0)
#define UNITYENGINE_AI_RVOSIMULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFDC240)
