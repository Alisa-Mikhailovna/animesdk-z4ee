...
#define UNITYENGINE_AI_NAVMESHHIT_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x2D37410)
#define UNITYENGINE_AI_NAVMESHHIT_GET_HIT_OFFSET UNITYSDK_OFFSET(0x3A22420)
#define UNITYENGINE_AI_NAVMESHHIT_GET_MASK_OFFSET UNITYSDK_OFFSET(0x1E7F0)
#define UNITYENGINE_AI_NAVMESHHIT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x254F0)
