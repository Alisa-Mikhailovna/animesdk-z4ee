...
#define UNITYENGINE_BINDINGS_NATIVEPROPERTYATTRIBUTE_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1D0C9C90)
#define UNITYENGINE_BINDINGS_NATIVEPROPERTYATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D0C9CB0)
#define UNITYENGINE_BINDINGS_NATIVEPROPERTYATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D0C9CC0)
#define UNITYENGINE_BINDINGS_NATIVEPROPERTYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C9CA0)
