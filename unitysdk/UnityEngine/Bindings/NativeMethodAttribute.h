...
#define UNITYENGINE_BINDINGS_NATIVEMETHODATTRIBUTE_SET_HASEXPLICITTHIS_OFFSET UNITYSDK_OFFSET(0x1D0C9AD0)
#define UNITYENGINE_BINDINGS_NATIVEMETHODATTRIBUTE_SET_ISFREEFUNCTION_OFFSET UNITYSDK_OFFSET(0x1D0C9AB0)
#define UNITYENGINE_BINDINGS_NATIVEMETHODATTRIBUTE_SET_ISTHREADSAFE_OFFSET UNITYSDK_OFFSET(0x1D0C9AA0)
#define UNITYENGINE_BINDINGS_NATIVEMETHODATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1D0C9A90)
#define UNITYENGINE_BINDINGS_NATIVEMETHODATTRIBUTE_SET_THROWSEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1D0C9AC0)
#define UNITYENGINE_BINDINGS_NATIVEMETHODATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D0C9AE0)
#define UNITYENGINE_BINDINGS_NATIVEMETHODATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D0C9900)
#define UNITYENGINE_BINDINGS_NATIVEMETHODATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D0C9940)
#define UNITYENGINE_BINDINGS_NATIVEMETHODATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C98D0)
