...
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x3A288A0)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_EFFECTIVEPARENTSPEED_OFFSET UNITYSDK_OFFSET(0x39EC540)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_EFFECTIVEPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x3A288F0)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_EFFECTIVESPEED_OFFSET UNITYSDK_OFFSET(0x2D35940)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_EFFECTIVEWEIGHT_OFFSET UNITYSDK_OFFSET(0x2E537E0)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_EVALUATIONTYPE_OFFSET UNITYSDK_OFFSET(0x3A288B0)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x2E45F60)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_SEEKOCCURRED_OFFSET UNITYSDK_OFFSET(0x3A288C0)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_TIMEHELD_OFFSET UNITYSDK_OFFSET(0x3A288E0)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_TIMELOOPED_OFFSET UNITYSDK_OFFSET(0x3A288D0)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x7B430)
#define UNITYENGINE_PLAYABLES_FRAMEDATA_HASFLAGS_OFFSET UNITYSDK_OFFSET(0x3A28890)
