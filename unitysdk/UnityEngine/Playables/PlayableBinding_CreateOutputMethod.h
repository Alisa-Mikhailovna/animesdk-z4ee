...
#define UNITYENGINE_PLAYABLES_PLAYABLEBINDING_CREATEOUTPUTMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D03C3B0)
#define UNITYENGINE_PLAYABLES_PLAYABLEBINDING_CREATEOUTPUTMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D03C410)
#define UNITYENGINE_PLAYABLES_PLAYABLEBINDING_CREATEOUTPUTMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D03C260)
#define UNITYENGINE_PLAYABLES_PLAYABLEBINDING_CREATEOUTPUTMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D03C340)
