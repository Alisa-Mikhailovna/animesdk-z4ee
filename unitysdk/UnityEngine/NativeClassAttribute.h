...
#define UNITYENGINE_NATIVECLASSATTRIBUTE_SET_DECLARATION_OFFSET UNITYSDK_OFFSET(0x1D0C9F00)
#define UNITYENGINE_NATIVECLASSATTRIBUTE_SET_QUALIFIEDNATIVENAME_OFFSET UNITYSDK_OFFSET(0x1D0C9EF0)
#define UNITYENGINE_NATIVECLASSATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D0C9F40)
#define UNITYENGINE_NATIVECLASSATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C9F10)
