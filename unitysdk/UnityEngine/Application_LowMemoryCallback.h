...
#define UNITYENGINE_APPLICATION_LOWMEMORYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D002A00)
#define UNITYENGINE_APPLICATION_LOWMEMORYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D002A30)
#define UNITYENGINE_APPLICATION_LOWMEMORYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D0001A0)
#define UNITYENGINE_APPLICATION_LOWMEMORYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D002990)
