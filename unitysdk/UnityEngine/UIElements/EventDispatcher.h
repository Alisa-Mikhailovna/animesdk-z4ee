...
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER_APPLYDISPATCHINGSTRATEGIES_OFFSET UNITYSDK_OFFSET(0x1D0E0850)
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER_CLOSEGATE_OFFSET UNITYSDK_OFFSET(0x1D0E0350)
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER_DISPATCH_OFFSET UNITYSDK_OFFSET(0x1D0D7040)
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER_GET_DISPATCHIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x1D0DFD00)
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER_GET_POINTERSTATE_OFFSET UNITYSDK_OFFSET(0x1D0DF6D0)
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER_OPENGATE_OFFSET UNITYSDK_OFFSET(0x1D0E0360)
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER_PROCESSEVENTQUEUE_OFFSET UNITYSDK_OFFSET(0x1D0E0410)
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER_PROCESSEVENT_OFFSET UNITYSDK_OFFSET(0x1D0DFD20)
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D0E0C50)
#define UNITYENGINE_UIELEMENTS_EVENTDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0DF6E0)
...
namespace UnityEngine::UIElements
{
	...
	public:
		...
		{
			return (::UnityEngine::UIElements::ObjectPool_1<::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::EventDispatcher_EventRecord>*>**)Il2CppClass::FromTypeDefinitionIndex(EventDispatcher_TypeDefinitionIndex)->GetStaticField(0x4B3C0);
		}
