...
#define UNITYENGINE_UIELEMENTS_KEYBOARDEVENTDISPATCHINGSTRATEGY_CANDISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x1D0E5870)
#define UNITYENGINE_UIELEMENTS_KEYBOARDEVENTDISPATCHINGSTRATEGY_DISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x1D0E58D0)
#define UNITYENGINE_UIELEMENTS_KEYBOARDEVENTDISPATCHINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0DFCC0)
