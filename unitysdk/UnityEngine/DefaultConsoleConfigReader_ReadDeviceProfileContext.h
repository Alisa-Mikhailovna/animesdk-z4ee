...
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT_GET_GLOBALAPPLYOPTIONS_OFFSET UNITYSDK_OFFSET(0x1D018200)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT_GET_INIFILE_OFFSET UNITYSDK_OFFSET(0x1D0181E0)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT_GET_SECTIONCACHES_OFFSET UNITYSDK_OFFSET(0x1D0181F0)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_READDEVICEPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D017B00)
