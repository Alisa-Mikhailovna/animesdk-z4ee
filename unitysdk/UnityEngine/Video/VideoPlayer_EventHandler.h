...
#define UNITYENGINE_VIDEO_VIDEOPLAYER_EVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D199200)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_EVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D199230)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_EVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D198EB0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_EVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D199190)
