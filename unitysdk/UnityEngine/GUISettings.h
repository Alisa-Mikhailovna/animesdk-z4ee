...
#define UNITYENGINE_GUISETTINGS_GET_CURSORCOLOR_OFFSET UNITYSDK_OFFSET(0x1D08B2A0)
#define UNITYENGINE_GUISETTINGS_GET_CURSORFLASHSPEED_OFFSET UNITYSDK_OFFSET(0x1D08B2B0)
#define UNITYENGINE_GUISETTINGS_GET_DOUBLECLICKSELECTSWORD_OFFSET UNITYSDK_OFFSET(0x1D0788C0)
#define UNITYENGINE_GUISETTINGS_GET_SELECTIONCOLOR_OFFSET UNITYSDK_OFFSET(0x1D08B2D0)
#define UNITYENGINE_GUISETTINGS_GET_TRIPLECLICKSELECTSLINE_OFFSET UNITYSDK_OFFSET(0x1D078B00)
#define UNITYENGINE_GUISETTINGS_INTERNAL_GETCURSORFLASHSPEED_OFFSET UNITYSDK_OFFSET(0x1D08B290)
#define UNITYENGINE_GUISETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D08B2E0)
