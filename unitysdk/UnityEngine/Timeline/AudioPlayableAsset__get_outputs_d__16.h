...
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CFB3430)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFB35F0)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFB3550)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFB3670)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFB35C0)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CFB3570)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CFB3420)
#define UNITYENGINE_TIMELINE_AUDIOPLAYABLEASSET__GET_OUTPUTS_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB3210)
