...
#define UNITYENGINE_TIMELINE_MARKER_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1CFBD1A0)
#define UNITYENGINE_TIMELINE_MARKER_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1CFBD1C0)
#define UNITYENGINE_TIMELINE_MARKER_ONDRAGGING_OFFSET UNITYSDK_OFFSET(0x1CFBD360)
#define UNITYENGINE_TIMELINE_MARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1CFBD340)
#define UNITYENGINE_TIMELINE_MARKER_ONSTOPDRAG_OFFSET UNITYSDK_OFFSET(0x1CFBD350)
#define UNITYENGINE_TIMELINE_MARKER_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1CFBD1B0)
#define UNITYENGINE_TIMELINE_MARKER_SET_TIME_OFFSET UNITYSDK_OFFSET(0x1CFBD1D0)
#define UNITYENGINE_TIMELINE_MARKER_UNITYENGINE_TIMELINE_IMARKER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1CFBD220)
#define UNITYENGINE_TIMELINE_MARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBD370)
