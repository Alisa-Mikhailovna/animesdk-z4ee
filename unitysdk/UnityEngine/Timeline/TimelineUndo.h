...
#define UNITYENGINE_TIMELINE_TIMELINEUNDO_PUSHDESTROYUNDO_OFFSET UNITYSDK_OFFSET(0x1CFBD980)
#define UNITYENGINE_TIMELINE_TIMELINEUNDO_PUSHUNDO_OFFSET UNITYSDK_OFFSET(0x1CFD16D0)
#define UNITYENGINE_TIMELINE_TIMELINEUNDO_REGISTERCREATEDOBJECTUNDO_OFFSET UNITYSDK_OFFSET(0x1CFD16E0)
