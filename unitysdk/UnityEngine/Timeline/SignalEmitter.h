...
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1CFC2330)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_GET_EMITONCE_OFFSET UNITYSDK_OFFSET(0x1CFC2310)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_GET_RETROACTIVE_OFFSET UNITYSDK_OFFSET(0x1CFC22F0)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_SET_ASSET_OFFSET UNITYSDK_OFFSET(0x1CFC2340)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_SET_EMITONCE_OFFSET UNITYSDK_OFFSET(0x1CFC2320)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_SET_RETROACTIVE_OFFSET UNITYSDK_OFFSET(0x1CFC2300)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_UNITYENGINE_PLAYABLES_INOTIFICATION_GET_ID_OFFSET UNITYSDK_OFFSET(0x1CFC2350)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_UNITYENGINE_TIMELINE_INOTIFICATIONOPTIONPROVIDER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1CFBF350)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC23B0)
