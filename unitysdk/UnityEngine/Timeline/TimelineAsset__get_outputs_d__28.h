...
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CFCAF20)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFCB7B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFCB710)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFCB810)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFCB780)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CFCB730)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CFCAC60)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC69B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1CFCAE20)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__28___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1CFCAD20)
