...
#define UNITYENGINE_PARTICLESYSTEM_ONPARTICLEEMISSIONBEGINEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D0A6F60)
#define UNITYENGINE_PARTICLESYSTEM_ONPARTICLEEMISSIONBEGINEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D0A6F90)
#define UNITYENGINE_PARTICLESYSTEM_ONPARTICLEEMISSIONBEGINEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D0A2730)
#define UNITYENGINE_PARTICLESYSTEM_ONPARTICLEEMISSIONBEGINEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A6EF0)
