...
#define UNITYENGINE_LIGHT_ONPARTICLELIGHTEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D025250)
#define UNITYENGINE_LIGHT_ONPARTICLELIGHTEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D0252D0)
#define UNITYENGINE_LIGHT_ONPARTICLELIGHTEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D0251B0)
#define UNITYENGINE_LIGHT_ONPARTICLELIGHTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0251D0)
