...
#define UNITYENGINE_ANIMATOR_THREADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CFF0060)
#define UNITYENGINE_ANIMATOR_THREADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CFF0140)
#define UNITYENGINE_ANIMATOR_THREADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CFEFA20)
#define UNITYENGINE_ANIMATOR_THREADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFEFFF0)
