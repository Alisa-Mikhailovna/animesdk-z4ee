...
#define UNITYENGINE_CACHE_CACHE_GETPATH_OFFSET UNITYSDK_OFFSET(0x1D006570)
#define UNITYENGINE_CACHE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2CAD0)
#define UNITYENGINE_CACHE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A25E40)
#define UNITYENGINE_CACHE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define UNITYENGINE_CACHE_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define UNITYENGINE_CACHE_GET_PATH_OFFSET UNITYSDK_OFFSET(0x3A25EA0)
