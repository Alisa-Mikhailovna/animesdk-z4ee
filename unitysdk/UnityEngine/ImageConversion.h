...
#define UNITYENGINE_IMAGECONVERSION_ENCODEARRAYTOJPG_OFFSET UNITYSDK_OFFSET(0x1D0707B0)
#define UNITYENGINE_IMAGECONVERSION_ENCODEARRAYTOPNG_OFFSET UNITYSDK_OFFSET(0x1D0707A0)
#define UNITYENGINE_IMAGECONVERSION_ENCODEARRAYTOTGA_OFFSET UNITYSDK_OFFSET(0x1D070790)
#define UNITYENGINE_IMAGECONVERSION_ENCODETOEXR_1_OFFSET UNITYSDK_OFFSET(0x1D070760)
#define UNITYENGINE_IMAGECONVERSION_ENCODETOEXR_OFFSET UNITYSDK_OFFSET(0x1D070750)
#define UNITYENGINE_IMAGECONVERSION_ENCODETOJPG_1_OFFSET UNITYSDK_OFFSET(0x1D070740)
#define UNITYENGINE_IMAGECONVERSION_ENCODETOJPG_OFFSET UNITYSDK_OFFSET(0x1D070730)
#define UNITYENGINE_IMAGECONVERSION_ENCODETOPNG_OFFSET UNITYSDK_OFFSET(0x1D070720)
#define UNITYENGINE_IMAGECONVERSION_ENCODETOTGA_OFFSET UNITYSDK_OFFSET(0x1D070710)
#define UNITYENGINE_IMAGECONVERSION_LOADIMAGE_1_OFFSET UNITYSDK_OFFSET(0x1D070780)
#define UNITYENGINE_IMAGECONVERSION_LOADIMAGE_OFFSET UNITYSDK_OFFSET(0x1D070770)
#define UNITYENGINE_IMAGECONVERSION_UNSAFEENCODENATIVEARRAYTOJPG_OFFSET UNITYSDK_OFFSET(0x1D0707E0)
#define UNITYENGINE_IMAGECONVERSION_UNSAFEENCODENATIVEARRAYTOPNG_OFFSET UNITYSDK_OFFSET(0x1D0707D0)
#define UNITYENGINE_IMAGECONVERSION_UNSAFEENCODENATIVEARRAYTOTGA_OFFSET UNITYSDK_OFFSET(0x1D0707C0)
