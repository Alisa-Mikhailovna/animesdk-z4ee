...
#define UNITYENGINE_EVENTS_BASEINVOKABLECALL_ALLOWINVOKE_OFFSET UNITYSDK_OFFSET(0x1D018C00)
#define UNITYENGINE_EVENTS_BASEINVOKABLECALL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D018B60)
#define UNITYENGINE_EVENTS_BASEINVOKABLECALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D018B50)
