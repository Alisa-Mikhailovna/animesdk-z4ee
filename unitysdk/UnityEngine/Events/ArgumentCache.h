...
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_BOOLARGUMENT_OFFSET UNITYSDK_OFFSET(0x1D0189A0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_FLOATARGUMENT_OFFSET UNITYSDK_OFFSET(0x1D018980)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_INTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1D018970)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_STRINGARGUMENT_OFFSET UNITYSDK_OFFSET(0x1D018990)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_UNITYOBJECTARGUMENTASSEMBLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x1D018960)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_UNITYOBJECTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1D018950)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D018B30)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D018B20)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_TIDYASSEMBLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x1D0189B0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D018B40)
