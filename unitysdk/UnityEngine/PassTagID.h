...
#define UNITYENGINE_PASSTAGID_INITPASSTAG_1_OFFSET UNITYSDK_OFFSET(0x1D03B380)
#define UNITYENGINE_PASSTAGID_INITPASSTAG_OFFSET UNITYSDK_OFFSET(0x3A285B0)
#define UNITYENGINE_PASSTAGID__CTOR_OFFSET UNITYSDK_OFFSET(0x2D11FD0)
