...
#define UNITYENGINE_RENDERING_PERFORMDYNAMICRES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEF7600)
#define UNITYENGINE_RENDERING_PERFORMDYNAMICRES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEF7630)
#define UNITYENGINE_RENDERING_PERFORMDYNAMICRES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEF2820)
#define UNITYENGINE_RENDERING_PERFORMDYNAMICRES__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF7590)
