...
#define UNITYENGINE_RENDERING_TILELAYOUTUTILS_TRYLAYOUTBYCOL_OFFSET UNITYSDK_OFFSET(0x1CEFDA20)
#define UNITYENGINE_RENDERING_TILELAYOUTUTILS_TRYLAYOUTBYROW_OFFSET UNITYSDK_OFFSET(0x1CEFD9B0)
#define UNITYENGINE_RENDERING_TILELAYOUTUTILS_TRYLAYOUTBYTILES_OFFSET UNITYSDK_OFFSET(0x1CEFD8F0)
