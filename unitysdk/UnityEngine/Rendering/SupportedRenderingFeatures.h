...
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_FALLBACKLIGHTMAPPERBYREF_OFFSET UNITYSDK_OFFSET(0x1D057450)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_FALLBACKMIXEDLIGHTINGMODEBYREF_OFFSET UNITYSDK_OFFSET(0x1D056E30)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1D056CD0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_AUTOAMBIENTPROBEBAKING_OFFSET UNITYSDK_OFFSET(0x1D056E10)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_AUTODEFAULTREFLECTIONPROBEBAKING_OFFSET UNITYSDK_OFFSET(0x1D056E20)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_DEFAULTMIXEDLIGHTINGMODES_OFFSET UNITYSDK_OFFSET(0x1D056DC0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_ENLIGHTEN_OFFSET UNITYSDK_OFFSET(0x1D056E00)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_LIGHTMAPBAKETYPES_OFFSET UNITYSDK_OFFSET(0x1D056DE0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_LIGHTMAPSMODES_OFFSET UNITYSDK_OFFSET(0x1D056DF0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_GET_MIXEDLIGHTINGMODES_OFFSET UNITYSDK_OFFSET(0x1D056DD0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISAUTOAMBIENTPROBEBAKINGSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1D0573B0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISAUTODEFAULTREFLECTIONPROBEBAKINGSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1D057400)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISLIGHTMAPBAKETYPESUPPORTEDBYREF_OFFSET UNITYSDK_OFFSET(0x1D0571C0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISLIGHTMAPBAKETYPESUPPORTED_OFFSET UNITYSDK_OFFSET(0x1D057180)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISLIGHTMAPPERSUPPORTEDBYREF_OFFSET UNITYSDK_OFFSET(0x1D057350)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISLIGHTMAPSMODESUPPORTEDBYREF_OFFSET UNITYSDK_OFFSET(0x1D057300)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISMIXEDLIGHTINGMODESUPPORTEDBYREF_OFFSET UNITYSDK_OFFSET(0x1D057040)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_ISMIXEDLIGHTINGMODESUPPORTED_OFFSET UNITYSDK_OFFSET(0x1D057000)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1D053CB0)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D057460)
#define UNITYENGINE_RENDERING_SUPPORTEDRENDERINGFEATURES__CTOR_OFFSET UNITYSDK_OFFSET(0x1D053C70)
...
namespace UnityEngine::Rendering
{
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::SupportedRenderingFeatures**)Il2CppClass::FromTypeDefinitionIndex(SupportedRenderingFeatures_TypeDefinitionIndex)->GetStaticField(0x39840);
		}
