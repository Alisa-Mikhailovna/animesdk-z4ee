...
#define UNITYENGINE_RENDERING_DEBUGUI_VALUE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1CEF1720)
#define UNITYENGINE_RENDERING_DEBUGUI_VALUE_GET_GETTER_OFFSET UNITYSDK_OFFSET(0x1CEF1700)
#define UNITYENGINE_RENDERING_DEBUGUI_VALUE_SET_GETTER_OFFSET UNITYSDK_OFFSET(0x1CEF1710)
#define UNITYENGINE_RENDERING_DEBUGUI_VALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF1750)
