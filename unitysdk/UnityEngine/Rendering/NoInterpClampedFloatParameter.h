...
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEF59C0)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEF59D0)
#define UNITYENGINE_RENDERING_NOINTERPCLAMPEDFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF59F0)
