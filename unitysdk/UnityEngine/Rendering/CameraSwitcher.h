...
#define UNITYENGINE_RENDERING_CAMERASWITCHER_GETCAMERACOUNT_OFFSET UNITYSDK_OFFSET(0x1CEDAED0)
#define UNITYENGINE_RENDERING_CAMERASWITCHER_GETNEXTCAMERA_OFFSET UNITYSDK_OFFSET(0x1CEDAF80)
#define UNITYENGINE_RENDERING_CAMERASWITCHER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CEDAF10)
#define UNITYENGINE_RENDERING_CAMERASWITCHER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CEDA930)
#define UNITYENGINE_RENDERING_CAMERASWITCHER_SETCAMERAINDEX_OFFSET UNITYSDK_OFFSET(0x1CEDAFD0)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDB2D0)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__ONENABLE_B__10_0_OFFSET UNITYSDK_OFFSET(0x1CEDB2E0)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__ONENABLE_B__10_1_OFFSET UNITYSDK_OFFSET(0x1CEDB2F0)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__ONENABLE_B__10_2_OFFSET UNITYSDK_OFFSET(0x1CEDB300)
#define UNITYENGINE_RENDERING_CAMERASWITCHER__ONENABLE_B__10_3_OFFSET UNITYSDK_OFFSET(0x1CEDB310)
