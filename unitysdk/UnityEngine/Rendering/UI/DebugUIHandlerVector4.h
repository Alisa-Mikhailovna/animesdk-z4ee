...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_NEXT_OFFSET UNITYSDK_OFFSET(0x1CF0C2D0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONACTION_OFFSET UNITYSDK_OFFSET(0x1CF0C2A0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONDECREMENT_OFFSET UNITYSDK_OFFSET(0x1CF0C270)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x1CF0C160)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONINCREMENT_OFFSET UNITYSDK_OFFSET(0x1CF0C240)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x1CF0BF10)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_SETUPSETTINGS_OFFSET UNITYSDK_OFFSET(0x1CF0BD20)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1CF0BE40)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4_SETWIDGET_OFFSET UNITYSDK_OFFSET(0x1CF0B8E0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF0C430)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETUPSETTINGS_B__10_0_OFFSET UNITYSDK_OFFSET(0x1CF0C790)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETUPSETTINGS_B__10_1_OFFSET UNITYSDK_OFFSET(0x1CF0C7B0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETUPSETTINGS_B__10_2_OFFSET UNITYSDK_OFFSET(0x1CF0C7D0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_0_OFFSET UNITYSDK_OFFSET(0x1CF0C450)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_1_OFFSET UNITYSDK_OFFSET(0x1CF0C490)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_2_OFFSET UNITYSDK_OFFSET(0x1CF0C520)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_3_OFFSET UNITYSDK_OFFSET(0x1CF0C560)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_4_OFFSET UNITYSDK_OFFSET(0x1CF0C5F0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_5_OFFSET UNITYSDK_OFFSET(0x1CF0C630)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_6_OFFSET UNITYSDK_OFFSET(0x1CF0C6C0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR4__SETWIDGET_B__8_7_OFFSET UNITYSDK_OFFSET(0x1CF0C700)
