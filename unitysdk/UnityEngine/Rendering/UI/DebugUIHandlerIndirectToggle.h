...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_INIT_OFFSET UNITYSDK_OFFSET(0x1CEFDF70)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_ONACTION_OFFSET UNITYSDK_OFFSET(0x1CF06EA0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x1CF06CF0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x1CF06B40)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE_UPDATEVALUELABEL_OFFSET UNITYSDK_OFFSET(0x1CEFE2A0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTTOGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF06F40)
