...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERGROUP_NEXT_OFFSET UNITYSDK_OFFSET(0x1CF06100)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERGROUP_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x1CF05FC0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERGROUP_SETWIDGET_OFFSET UNITYSDK_OFFSET(0x1CF05E20)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF06230)
