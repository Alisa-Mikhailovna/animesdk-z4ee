...
#define UNITYENGINE_RENDERING_UI_UIFOLDOUT_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1CF0C9C0)
#define UNITYENGINE_RENDERING_UI_UIFOLDOUT_SETSTATE_1_OFFSET UNITYSDK_OFFSET(0x1CF0C9D0)
#define UNITYENGINE_RENDERING_UI_UIFOLDOUT_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1CF0C9B0)
#define UNITYENGINE_RENDERING_UI_UIFOLDOUT_START_OFFSET UNITYSDK_OFFSET(0x1CF0C910)
#define UNITYENGINE_RENDERING_UI_UIFOLDOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF0CB40)
