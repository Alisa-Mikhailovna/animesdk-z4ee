...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1CF06A40)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_INIT_OFFSET UNITYSDK_OFFSET(0x1CF02A20)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_ONDECREMENT_OFFSET UNITYSDK_OFFSET(0x1CF06B10)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x1CF06880)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_ONINCREMENT_OFFSET UNITYSDK_OFFSET(0x1CF06A30)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x1CF066D0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD_UPDATEVALUELABEL_OFFSET UNITYSDK_OFFSET(0x1CF06580)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERINDIRECTFLOATFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF06B20)
