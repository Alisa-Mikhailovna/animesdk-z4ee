...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3_NEXT_OFFSET UNITYSDK_OFFSET(0x1CF0B4B0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3_ONACTION_OFFSET UNITYSDK_OFFSET(0x1CF0B480)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3_ONDECREMENT_OFFSET UNITYSDK_OFFSET(0x1CF0B450)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3_ONDESELECTION_OFFSET UNITYSDK_OFFSET(0x1CF0B340)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3_ONINCREMENT_OFFSET UNITYSDK_OFFSET(0x1CF0B420)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3_ONSELECTION_OFFSET UNITYSDK_OFFSET(0x1CF0B0F0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3_SETUPSETTINGS_OFFSET UNITYSDK_OFFSET(0x1CF0AF00)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1CF0B020)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3_SETWIDGET_OFFSET UNITYSDK_OFFSET(0x1CF0AB80)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF0B610)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__SETUPSETTINGS_B__9_0_OFFSET UNITYSDK_OFFSET(0x1CF0B880)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__SETUPSETTINGS_B__9_1_OFFSET UNITYSDK_OFFSET(0x1CF0B8A0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__SETUPSETTINGS_B__9_2_OFFSET UNITYSDK_OFFSET(0x1CF0B8C0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__SETWIDGET_B__7_0_OFFSET UNITYSDK_OFFSET(0x1CF0B630)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__SETWIDGET_B__7_1_OFFSET UNITYSDK_OFFSET(0x1CF0B670)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__SETWIDGET_B__7_2_OFFSET UNITYSDK_OFFSET(0x1CF0B6F0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__SETWIDGET_B__7_3_OFFSET UNITYSDK_OFFSET(0x1CF0B730)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__SETWIDGET_B__7_4_OFFSET UNITYSDK_OFFSET(0x1CF0B7C0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERVECTOR3__SETWIDGET_B__7_5_OFFSET UNITYSDK_OFFSET(0x1CF0B800)
