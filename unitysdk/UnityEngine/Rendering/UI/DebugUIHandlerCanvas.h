...
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_ACTIVATEPANEL_OFFSET UNITYSDK_OFFSET(0x1CF011F0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_ACTIVATESELECTION_OFFSET UNITYSDK_OFFSET(0x1CF01E30)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_CHANGESELECTIONVALUE_OFFSET UNITYSDK_OFFSET(0x1CF01C50)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_CHANGESELECTION_OFFSET UNITYSDK_OFFSET(0x1CF01870)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_GETWIDGETFROMPATH_OFFSET UNITYSDK_OFFSET(0x1CF015B0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_HANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x1CEFF460)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CEFED70)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_REBUILD_OFFSET UNITYSDK_OFFSET(0x1CEFFE50)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_RESETALLHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1CEFF000)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_SELECTNEXTITEM_OFFSET UNITYSDK_OFFSET(0x1CF01AF0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_SELECTPREVIOUSITEM_OFFSET UNITYSDK_OFFSET(0x1CF01BA0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_TRAVERSE_OFFSET UNITYSDK_OFFSET(0x1CF00960)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CEFEF10)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS__ACTIVATEPANEL_B__14_1_OFFSET UNITYSDK_OFFSET(0x1CF01EE0)
#define UNITYENGINE_RENDERING_UI_DEBUGUIHANDLERCANVAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF01ED0)
