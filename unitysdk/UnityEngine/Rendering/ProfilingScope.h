...
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_BEGINPROFILE_1_OFFSET UNITYSDK_OFFSET(0x1CEF7810)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_BEGINPROFILE_OFFSET UNITYSDK_OFFSET(0x1CEF7800)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1020)
#define UNITYENGINE_RENDERING_PROFILINGSCOPE_ENDPROFILE_OFFSET UNITYSDK_OFFSET(0x1CEF7820)
