...
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_BEGINSAMPLE_OFFSET UNITYSDK_OFFSET(0x1CEDEF70)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1CEDEB00)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1CEDCBA0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_COPYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1CEDEB70)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_DISABLESHADERKEYWORD_OFFSET UNITYSDK_OFFSET(0x1CEDEF50)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CEDC7B0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x1CEDEC50)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_DRAWRENDERERS_OFFSET UNITYSDK_OFFSET(0x1CEDEEC0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_ENABLESHADERKEYWORD_OFFSET UNITYSDK_OFFSET(0x1CEDEF30)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_ENDSAMPLE_OFFSET UNITYSDK_OFFSET(0x1CEDEF90)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1CEDCC30)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1CEDC790)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GETRAWBUFFER_OFFSET UNITYSDK_OFFSET(0x1CEDCCE0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GETTEMPORARYRT_1_OFFSET UNITYSDK_OFFSET(0x1CEDDC50)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GETTEMPORARYRT_OFFSET UNITYSDK_OFFSET(0x1CEDD850)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GET_CMDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CEDEFC0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GET_ISSYSTEMCMDVALID_OFFSET UNITYSDK_OFFSET(0x1CEDCC00)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GET_SIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1CEDEFD0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_GET_USECUSTOMCMD_OFFSET UNITYSDK_OFFSET(0x1CEDF010)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_PREPAREDRAWRENDERERS_OFFSET UNITYSDK_OFFSET(0x1CEDED40)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1CEDCB90)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALCOLOR_OFFSET UNITYSDK_OFFSET(0x1CEDCF90)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALFLOAT_OFFSET UNITYSDK_OFFSET(0x1CEDCD00)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALMATRIX_OFFSET UNITYSDK_OFFSET(0x1CEDD0F0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1CEDD6A0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALTEXTURE_OFFSET UNITYSDK_OFFSET(0x1CEDD5B0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1CEDD550)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETGLOBALVECTOR_OFFSET UNITYSDK_OFFSET(0x1CEDCE30)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_1_OFFSET UNITYSDK_OFFSET(0x1CEDE0D0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_2_OFFSET UNITYSDK_OFFSET(0x1CEDE0F0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_3_OFFSET UNITYSDK_OFFSET(0x1CEDE100)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_4_OFFSET UNITYSDK_OFFSET(0x1CEDE640)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1CEDDDD0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SET_CMDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CEDEFB0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT_SET_USECUSTOMCMD_OFFSET UNITYSDK_OFFSET(0x1CEDF030)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__ADDSETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1CEDE8A0)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDC540)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__DEPTHBUFFERFORMATFROMBITS_OFFSET UNITYSDK_OFFSET(0x1CEDDB10)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__GETTEMPORARYRT_OFFSET UNITYSDK_OFFSET(0x1CEDDB50)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__GETTEXTYPE_OFFSET UNITYSDK_OFFSET(0x1CEDF090)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__PUTRT_1_OFFSET UNITYSDK_OFFSET(0x1CEDF040)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__PUTRT_OFFSET UNITYSDK_OFFSET(0x1CEDD800)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__SETORCLEARFLAGS_OFFSET UNITYSDK_OFFSET(0x1CEDDB30)
#define UNITYENGINE_RENDERING_COMMANDBUFFEREXT__SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1CEDDE00)
...
namespace UnityEngine::Rendering
{
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::CommandBufferExt_RenderCommandSetRTBuffers*)Il2CppClass::FromTypeDefinitionIndex(CommandBufferExt_TypeDefinitionIndex)->GetStaticField(0x47CD0);
		}
		static ::UnityEngine::Rendering::CommandBufferExt_RenderTextureDesc* StaticGet__TmpRTDesc()
		{
			return (::UnityEngine::Rendering::CommandBufferExt_RenderTextureDesc*)Il2CppClass::FromTypeDefinitionIndex(CommandBufferExt_TypeDefinitionIndex)->GetStaticField(0xBF20);
		}
