...
#define UNITYENGINE_RENDERING_SCALEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEFB2E0)
#define UNITYENGINE_RENDERING_SCALEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEFB330)
#define UNITYENGINE_RENDERING_SCALEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEF8080)
#define UNITYENGINE_RENDERING_SCALEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEFB270)
