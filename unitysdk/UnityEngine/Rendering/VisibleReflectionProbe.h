...
#define UNITYENGINE_RENDERING_VISIBLEREFLECTIONPROBE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3A31A10)
#define UNITYENGINE_RENDERING_VISIBLEREFLECTIONPROBE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A319D0)
#define UNITYENGINE_RENDERING_VISIBLEREFLECTIONPROBE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A31A90)
