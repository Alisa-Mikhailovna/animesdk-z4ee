...
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_GET_CPUELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x1CEF77A0)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_GET_CPUSAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x1CEF77B0)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_GET_GPUELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x1CEF7780)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_GET_GPUSAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x1CEF7790)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_GET_INLINECPUELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x1CEF77C0)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_GET_INLINECPUSAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x1CEF77D0)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_GET_INLINESAMPLER_OFFSET UNITYSDK_OFFSET(0x1CEF7730)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CEF7750)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_GET_SAMPLER_OFFSET UNITYSDK_OFFSET(0x1CEF7710)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1CEF76F0)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_SET_ENABLERECORDING_OFFSET UNITYSDK_OFFSET(0x1CEF7770)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_SET_INLINESAMPLER_OFFSET UNITYSDK_OFFSET(0x1CEF7740)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1CEF7760)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER_SET_SAMPLER_OFFSET UNITYSDK_OFFSET(0x1CEF7720)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CEF77E0)
#define UNITYENGINE_RENDERING_PROFILINGSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF7660)
