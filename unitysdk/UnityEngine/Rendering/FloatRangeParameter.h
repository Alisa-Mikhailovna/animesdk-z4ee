...
#define UNITYENGINE_RENDERING_FLOATRANGEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEF2B20)
#define UNITYENGINE_RENDERING_FLOATRANGEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1CEF2CD0)
#define UNITYENGINE_RENDERING_FLOATRANGEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEF2B30)
#define UNITYENGINE_RENDERING_FLOATRANGEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF2B60)
