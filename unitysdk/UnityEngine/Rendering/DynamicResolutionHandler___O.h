...
namespace UnityEngine::Rendering
{
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::PerformDynamicRes**)Il2CppClass::FromTypeDefinitionIndex(DynamicResolutionHandler___O_TypeDefinitionIndex)->GetStaticField(0x48740);
		}
	};
}
