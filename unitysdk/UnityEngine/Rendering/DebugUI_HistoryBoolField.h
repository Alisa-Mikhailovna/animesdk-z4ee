...
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYBOOLFIELD_GETHISTORYVALUE_OFFSET UNITYSDK_OFFSET(0x1CEF1140)
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYBOOLFIELD_GET_HISTORYDEPTH_OFFSET UNITYSDK_OFFSET(0x1CEF1130)
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYBOOLFIELD_GET_HISTORYGETTER_OFFSET UNITYSDK_OFFSET(0x1CEF1110)
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYBOOLFIELD_SET_HISTORYGETTER_OFFSET UNITYSDK_OFFSET(0x1CEF1120)
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYBOOLFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF1190)
