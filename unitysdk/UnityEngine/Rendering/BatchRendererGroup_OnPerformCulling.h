...
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_ONPERFORMCULLING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D04BC20)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_ONPERFORMCULLING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D04BCA0)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_ONPERFORMCULLING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D04BAC0)
#define UNITYENGINE_RENDERING_BATCHRENDERERGROUP_ONPERFORMCULLING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D04BB30)
