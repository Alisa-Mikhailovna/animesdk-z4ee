...
#define UNITYENGINE_RENDERING_CLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEDB610)
#define UNITYENGINE_RENDERING_CLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEDB620)
#define UNITYENGINE_RENDERING_CLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDB640)
