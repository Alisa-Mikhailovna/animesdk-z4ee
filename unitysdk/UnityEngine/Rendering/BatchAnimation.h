...
#define UNITYENGINE_RENDERING_BATCHANIMATION_ADDINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D04B670)
#define UNITYENGINE_RENDERING_BATCHANIMATION_ALLOCANIMINSTANCEGROUP_OFFSET UNITYSDK_OFFSET(0x1D04B770)
#define UNITYENGINE_RENDERING_BATCHANIMATION_DESTORYINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D04B690)
#define UNITYENGINE_RENDERING_BATCHANIMATION_ENABLEINSTANCELAYER_OFFSET UNITYSDK_OFFSET(0x1D04B7E0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_FINDVARIANTINDEX_OFFSET UNITYSDK_OFFSET(0x1D04B700)
#define UNITYENGINE_RENDERING_BATCHANIMATION_GETINSTANCECOUNT_OFFSET UNITYSDK_OFFSET(0x1D04B6B0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1D04B6A0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_GETLODPARTCOUNT_OFFSET UNITYSDK_OFFSET(0x1D04B6F0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_GET_EVENTEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D04B530)
#define UNITYENGINE_RENDERING_BATCHANIMATION_INTERNALUPDATEINSTANCESHAREDMAT_OFFSET UNITYSDK_OFFSET(0x1D04B710)
#define UNITYENGINE_RENDERING_BATCHANIMATION_ISENABLEGRAPH_OFFSET UNITYSDK_OFFSET(0x1D04B7D0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0x1D04B7A0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_RESETANIMATION_OFFSET UNITYSDK_OFFSET(0x1D04B7B0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_RESETANIMINSTANCEGROUP_OFFSET UNITYSDK_OFFSET(0x1D04B780)
#define UNITYENGINE_RENDERING_BATCHANIMATION_RESETRESREF_OFFSET UNITYSDK_OFFSET(0x1D04B790)
#define UNITYENGINE_RENDERING_BATCHANIMATION_SETINSTANCESHADERMATPROP_OFFSET UNITYSDK_OFFSET(0x1D04B760)
#define UNITYENGINE_RENDERING_BATCHANIMATION_SETPOSROT_OFFSET UNITYSDK_OFFSET(0x1D04B680)
#define UNITYENGINE_RENDERING_BATCHANIMATION_SET_EVENTEXECUTE_OFFSET UNITYSDK_OFFSET(0x1D04B7C0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_SET_LODSIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D04B6E0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_SET_LODSIZE_OFFSET UNITYSDK_OFFSET(0x1D04B6C0)
#define UNITYENGINE_RENDERING_BATCHANIMATION_UPDATEINSTANCESHAREDMAT_1_OFFSET UNITYSDK_OFFSET(0x1D04B750)
#define UNITYENGINE_RENDERING_BATCHANIMATION_UPDATEINSTANCESHAREDMAT_OFFSET UNITYSDK_OFFSET(0x1D04B720)
#define UNITYENGINE_RENDERING_BATCHANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D04B7F0)
