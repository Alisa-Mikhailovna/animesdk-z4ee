...
#define UNITYENGINE_RENDERING_NOINTERPFLOATRANGEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEF6250)
#define UNITYENGINE_RENDERING_NOINTERPFLOATRANGEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEF6260)
#define UNITYENGINE_RENDERING_NOINTERPFLOATRANGEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF6290)
