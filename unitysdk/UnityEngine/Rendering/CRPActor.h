...
#define UNITYENGINE_RENDERING_CRPACTOR_ADDACTOR_OFFSET UNITYSDK_OFFSET(0x1D04C470)
#define UNITYENGINE_RENDERING_CRPACTOR_ADDFLAG_OFFSET UNITYSDK_OFFSET(0x1D04C4D0)
#define UNITYENGINE_RENDERING_CRPACTOR_ATTACHRENDERS_OFFSET UNITYSDK_OFFSET(0x1D04C4B0)
#define UNITYENGINE_RENDERING_CRPACTOR_QUERYACTOR_OFFSET UNITYSDK_OFFSET(0x1D04C520)
#define UNITYENGINE_RENDERING_CRPACTOR_REFRESHACTORRENDER_OFFSET UNITYSDK_OFFSET(0x1D04C4A0)
#define UNITYENGINE_RENDERING_CRPACTOR_REFRESHACTOR_OFFSET UNITYSDK_OFFSET(0x1D04C490)
#define UNITYENGINE_RENDERING_CRPACTOR_REMOVEACTOR_OFFSET UNITYSDK_OFFSET(0x1D04C480)
#define UNITYENGINE_RENDERING_CRPACTOR_REMOVEFLAG_OFFSET UNITYSDK_OFFSET(0x1D04C4E0)
#define UNITYENGINE_RENDERING_CRPACTOR_SETABOVEOFFSET_OFFSET UNITYSDK_OFFSET(0x1D04C4C0)
#define UNITYENGINE_RENDERING_CRPACTOR_SETOBJLOCALLIGHT_OFFSET UNITYSDK_OFFSET(0x1D04C510)
#define UNITYENGINE_RENDERING_CRPACTOR_SETOVERRIDECACHEPOS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D04C500)
#define UNITYENGINE_RENDERING_CRPACTOR_SETOVERRIDECACHEPOS_OFFSET UNITYSDK_OFFSET(0x1D04C4F0)
