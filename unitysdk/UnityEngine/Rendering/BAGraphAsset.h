...
#define UNITYENGINE_RENDERING_BAGRAPHASSET_ADDINPUT_OFFSET UNITYSDK_OFFSET(0x1D04B250)
#define UNITYENGINE_RENDERING_BAGRAPHASSET_ADDNODE_OFFSET UNITYSDK_OFFSET(0x1D04B240)
#define UNITYENGINE_RENDERING_BAGRAPHASSET_ADDOUTPUT_OFFSET UNITYSDK_OFFSET(0x1D04B260)
#define UNITYENGINE_RENDERING_BAGRAPHASSET_ALLOCNODE_OFFSET UNITYSDK_OFFSET(0x1D04B230)
#define UNITYENGINE_RENDERING_BAGRAPHASSET_CALCNODEHASH_OFFSET UNITYSDK_OFFSET(0x1D04B280)
#define UNITYENGINE_RENDERING_BAGRAPHASSET_CREATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D04B210)
#define UNITYENGINE_RENDERING_BAGRAPHASSET_ENABLENODE_OFFSET UNITYSDK_OFFSET(0x1D04B290)
#define UNITYENGINE_RENDERING_BAGRAPHASSET_ENDALLOC_OFFSET UNITYSDK_OFFSET(0x1D04B270)
#define UNITYENGINE_RENDERING_BAGRAPHASSET_PLAYERLAYER_OFFSET UNITYSDK_OFFSET(0x1D04B2A0)
#define UNITYENGINE_RENDERING_BAGRAPHASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D04B220)
