...
#define UNITYENGINE_RENDERING_NOINTERPMAXFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEF6550)
#define UNITYENGINE_RENDERING_NOINTERPMAXFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CEF6560)
#define UNITYENGINE_RENDERING_NOINTERPMAXFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF6570)
