...
#define UNITYENGINE_RENDERING_VECTOR4PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1CF0CFD0)
#define UNITYENGINE_RENDERING_VECTOR4PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF0CE80)
