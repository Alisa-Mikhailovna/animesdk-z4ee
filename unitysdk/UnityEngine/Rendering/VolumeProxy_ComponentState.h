...
#define UNITYENGINE_RENDERING_VOLUMEPROXY_COMPONENTSTATE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1CF15030)
#define UNITYENGINE_RENDERING_VOLUMEPROXY_COMPONENTSTATE_REQUIRE_OFFSET UNITYSDK_OFFSET(0x1CF149E0)
#define UNITYENGINE_RENDERING_VOLUMEPROXY_COMPONENTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF14590)
