...
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_GET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x1CF13BB0)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_ISOBJECTPARAMETER_OFFSET UNITYSDK_OFFSET(0x1CF10030)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CF13BE0)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CF13BD0)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1CF13BF0)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER_SET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x1CF13BC0)
#define UNITYENGINE_RENDERING_VOLUMEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF13C00)
