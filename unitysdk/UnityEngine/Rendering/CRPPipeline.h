...
#define UNITYENGINE_RENDERING_CRPPIPELINE_ADDORUPDATEVOLUMETRICCLOUDLAYER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D04C6E0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_ADDORUPDATEVOLUMETRICCLOUDLAYER_OFFSET UNITYSDK_OFFSET(0x1D04C6D0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_CAPTUREPARAM_OFFSET UNITYSDK_OFFSET(0x1D04C680)
#define UNITYENGINE_RENDERING_CRPPIPELINE_CLEANUPPIPELINE_OFFSET UNITYSDK_OFFSET(0x1D04C560)
#define UNITYENGINE_RENDERING_CRPPIPELINE_CREATEPIPELINERENDER_OFFSET UNITYSDK_OFFSET(0x1D04C550)
#define UNITYENGINE_RENDERING_CRPPIPELINE_DIRTYUISCENECACHE_OFFSET UNITYSDK_OFFSET(0x1D04C670)
#define UNITYENGINE_RENDERING_CRPPIPELINE_ENDCAPTURE_OFFSET UNITYSDK_OFFSET(0x1D04C620)
#define UNITYENGINE_RENDERING_CRPPIPELINE_ENDUIPP_OFFSET UNITYSDK_OFFSET(0x1D04C660)
#define UNITYENGINE_RENDERING_CRPPIPELINE_FINDRTID_OFFSET UNITYSDK_OFFSET(0x1D04C5E0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_FORCEUPDATEOCCLUSIONQUERY_OFFSET UNITYSDK_OFFSET(0x1D04C600)
#define UNITYENGINE_RENDERING_CRPPIPELINE_GETBLENDINGWEIGHT_OFFSET UNITYSDK_OFFSET(0x1D04C640)
#define UNITYENGINE_RENDERING_CRPPIPELINE_GETRECORDEDRESULTS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D04C6C0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_GETRECORDEDRESULTS_OFFSET UNITYSDK_OFFSET(0x1D04C690)
#define UNITYENGINE_RENDERING_CRPPIPELINE_ONCHANGEENVBLOCK_OFFSET UNITYSDK_OFFSET(0x1D04C5C0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_REMOVEVOLUMETRICCLOUDLAYER_OFFSET UNITYSDK_OFFSET(0x1D04C6F0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_RESETVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1D04C700)
#define UNITYENGINE_RENDERING_CRPPIPELINE_SETCMD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1D04C5A0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_SETCMD_OFFSET UNITYSDK_OFFSET(0x1D04C590)
#define UNITYENGINE_RENDERING_CRPPIPELINE_SETENABLEMATERIALPROXY_OFFSET UNITYSDK_OFFSET(0x1D04C5F0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_SETPREPARECMD_OFFSET UNITYSDK_OFFSET(0x1D04C5B0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_STARTBLENDING_OFFSET UNITYSDK_OFFSET(0x1D04C630)
#define UNITYENGINE_RENDERING_CRPPIPELINE_STARTCAPTURE_OFFSET UNITYSDK_OFFSET(0x1D04C610)
#define UNITYENGINE_RENDERING_CRPPIPELINE_STARTUIPP_OFFSET UNITYSDK_OFFSET(0x1D04C650)
#define UNITYENGINE_RENDERING_CRPPIPELINE_UNLOADPIPELINERES_OFFSET UNITYSDK_OFFSET(0x1D04C5D0)
#define UNITYENGINE_RENDERING_CRPPIPELINE_UPDATEASSET_OFFSET UNITYSDK_OFFSET(0x1D04C570)
#define UNITYENGINE_RENDERING_CRPPIPELINE_UPDATETESTCONFIG_OFFSET UNITYSDK_OFFSET(0x1D04C580)
