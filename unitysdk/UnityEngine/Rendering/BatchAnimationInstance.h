...
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_GETBYPTR_OFFSET UNITYSDK_OFFSET(0x1D04B3C0)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_GETLOD_OFFSET UNITYSDK_OFFSET(0x1D04B870)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_GET_BATCHANIMATION_OFFSET UNITYSDK_OFFSET(0x1D04B820)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_PLAY_OFFSET UNITYSDK_OFFSET(0x1D04B840)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SETBONEATTACH_OFFSET UNITYSDK_OFFSET(0x1D04B860)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SETCUSTOMMATINDEX_OFFSET UNITYSDK_OFFSET(0x1D04B8D0)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SETGRAPHPARAMBOOL_OFFSET UNITYSDK_OFFSET(0x1D04B850)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SETMATKEYWORD_OFFSET UNITYSDK_OFFSET(0x1D04B8E0)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SETOVERRIDEFRAME_OFFSET UNITYSDK_OFFSET(0x1D04B830)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SETPARTMAT_OFFSET UNITYSDK_OFFSET(0x1D04B8C0)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SETPARTVARIANTEX_OFFSET UNITYSDK_OFFSET(0x1D04B8A0)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SETPARTVARIANT_1_OFFSET UNITYSDK_OFFSET(0x1D04B8B0)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SETPARTVARIANT_OFFSET UNITYSDK_OFFSET(0x1D04B890)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_SET_CUSTOMMATINDEX_OFFSET UNITYSDK_OFFSET(0x1D04B8F0)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE_UPDATELOD_OFFSET UNITYSDK_OFFSET(0x1D04B880)
#define UNITYENGINE_RENDERING_BATCHANIMATIONINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D04B900)
