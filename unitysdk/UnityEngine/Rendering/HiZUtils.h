...
#define UNITYENGINE_RENDERING_HIZUTILS_SETOCBUFFERCOUNT_OFFSET UNITYSDK_OFFSET(0x1D052B20)
#define UNITYENGINE_RENDERING_HIZUTILS_SETOCBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1D052B30)
#define UNITYENGINE_RENDERING_HIZUTILS_SETPARTIALREADBACK_OFFSET UNITYSDK_OFFSET(0x1D052B40)
