...
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_ADDGRAPHBONEMASK_OFFSET UNITYSDK_OFFSET(0x1D04B2E0)
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_ADDGRAPHCLIP_OFFSET UNITYSDK_OFFSET(0x1D04B2B0)
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_GETGRAPHCLIPCOUNT_OFFSET UNITYSDK_OFFSET(0x1D04B2D0)
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_RESETGRAPH_OFFSET UNITYSDK_OFFSET(0x1D04B2F0)
#define UNITYENGINE_RENDERING_BAGRAPHINSTANCE_SETCLIPFADEIN_OFFSET UNITYSDK_OFFSET(0x1D04B2C0)
