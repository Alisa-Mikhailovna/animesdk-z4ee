...
#define UNITYENGINE_RENDERING_DISPOSEUNMANAGERRESCB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEF22B0)
#define UNITYENGINE_RENDERING_DISPOSEUNMANAGERRESCB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEF22E0)
#define UNITYENGINE_RENDERING_DISPOSEUNMANAGERRESCB_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEF22A0)
#define UNITYENGINE_RENDERING_DISPOSEUNMANAGERRESCB__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF2230)
