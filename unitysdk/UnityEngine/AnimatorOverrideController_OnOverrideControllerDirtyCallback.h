...
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CFF0A60)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CFF0A90)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CFF09E0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONOVERRIDECONTROLLERDIRTYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF09F0)
