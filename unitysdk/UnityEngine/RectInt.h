...
#define UNITYENGINE_RECTINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A2AA80)
#define UNITYENGINE_RECTINT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x14EDE0)
#define UNITYENGINE_RECTINT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define UNITYENGINE_RECTINT_GET_X_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define UNITYENGINE_RECTINT_GET_Y_OFFSET UNITYSDK_OFFSET(0x1E130)
#define UNITYENGINE_RECTINT_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x14EDF0)
#define UNITYENGINE_RECTINT_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0xDAE0)
#define UNITYENGINE_RECTINT_SET_X_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define UNITYENGINE_RECTINT_SET_Y_OFFSET UNITYSDK_OFFSET(0x21F0)
#define UNITYENGINE_RECTINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A2AA70)
#define UNITYENGINE_RECTINT__CTOR_OFFSET UNITYSDK_OFFSET(0x86CE0)
