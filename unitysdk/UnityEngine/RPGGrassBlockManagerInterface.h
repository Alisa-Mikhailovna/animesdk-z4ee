...
#define UNITYENGINE_RPGGRASSBLOCKMANAGERINTERFACE_ACTIVATEBEFORECULLCOMPUTEFORTHISFRAME_OFFSET UNITYSDK_OFFSET(0x1D041DF0)
#define UNITYENGINE_RPGGRASSBLOCKMANAGERINTERFACE_SETCOUNTINITVOLUMEJOBSPERFRAME_OFFSET UNITYSDK_OFFSET(0x1D041DE0)
#define UNITYENGINE_RPGGRASSBLOCKMANAGERINTERFACE_SETGRASSCURRENTQUALITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1D041E00)
