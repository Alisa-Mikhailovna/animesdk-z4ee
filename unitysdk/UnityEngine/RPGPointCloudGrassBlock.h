...
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_CHANGETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1D042220)
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_GRASSVOLUMEHASINIT_OFFSET UNITYSDK_OFFSET(0x1D042210)
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_REMOVEGRASSVOLUMEUSEVOLUMEKEY_OFFSET UNITYSDK_OFFSET(0x1D042200)
#define UNITYENGINE_RPGPOINTCLOUDGRASSBLOCK_SETGRASSBLOCKDATA_OFFSET UNITYSDK_OFFSET(0x1D0421F0)
