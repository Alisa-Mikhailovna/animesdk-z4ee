...
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_SETSHAREDVERTEXPOSITION_OFFSET UNITYSDK_OFFSET(0x1CEC9DA0)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_SETSHAREDVERTEXVALUES_OFFSET UNITYSDK_OFFSET(0x1CECA360)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CEC98F0)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICESINWORLDSPACE_1_OFFSET UNITYSDK_OFFSET(0x1CEC8DD0)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICESINWORLDSPACE_OFFSET UNITYSDK_OFFSET(0x1CEAA1D0)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICES_1_OFFSET UNITYSDK_OFFSET(0x1CEC9C00)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICES_2_OFFSET UNITYSDK_OFFSET(0x1CEC9CD0)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_TRANSLATEVERTICES_OFFSET UNITYSDK_OFFSET(0x1CEC9820)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING_VERTICESINWORLDSPACE_OFFSET UNITYSDK_OFFSET(0x1CEC8BC0)
#define UNITYENGINE_PROBUILDER_VERTEXPOSITIONING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CECA770)
...
namespace UnityEngine::ProBuilder
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(VertexPositioning_TypeDefinitionIndex)->GetStaticField(0x52420);
		}
