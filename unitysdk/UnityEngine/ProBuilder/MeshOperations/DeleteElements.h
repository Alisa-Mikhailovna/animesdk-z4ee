...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_DELETEFACES_1_OFFSET UNITYSDK_OFFSET(0x1CE49B70)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_DELETEFACES_OFFSET UNITYSDK_OFFSET(0x1CE3BC10)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_DELETEFACE_OFFSET UNITYSDK_OFFSET(0x1CE2F320)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_DELETEVERTICES_OFFSET UNITYSDK_OFFSET(0x1CE32660)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_REMOVEDEGENERATETRIANGLES_OFFSET UNITYSDK_OFFSET(0x1CE4A650)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_DELETEELEMENTS_REMOVEUNUSEDVERTICES_OFFSET UNITYSDK_OFFSET(0x1CE4B5E0)
