...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_VERTEXEDITING_ALIGNEDGEWITHDIRECTION_OFFSET UNITYSDK_OFFSET(0x1CE74DD0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_VERTEXEDITING_EXPLODEVERTEX_OFFSET UNITYSDK_OFFSET(0x1CE3A950)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_VERTEXEDITING_MERGEVERTICES_OFFSET UNITYSDK_OFFSET(0x1CE73720)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_VERTEXEDITING_SPLITVERTICES_1_OFFSET UNITYSDK_OFFSET(0x1CE73B20)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_VERTEXEDITING_SPLITVERTICES_OFFSET UNITYSDK_OFFSET(0x1CE73AC0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_VERTEXEDITING_WELDVERTICES_OFFSET UNITYSDK_OFFSET(0x1CE74100)
