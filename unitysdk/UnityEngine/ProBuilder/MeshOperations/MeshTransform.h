...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHTRANSFORM_CENTERPIVOT_OFFSET UNITYSDK_OFFSET(0x1CE5F090)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHTRANSFORM_FREEZESCALETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1CE65800)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHTRANSFORM_SETPIVOT_1_OFFSET UNITYSDK_OFFSET(0x1CE419E0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_MESHTRANSFORM_SETPIVOT_OFFSET UNITYSDK_OFFSET(0x1CE65420)
