...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECTEDGESINFACE_1_OFFSET UNITYSDK_OFFSET(0x1CE48040)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECTEDGESINFACE_OFFSET UNITYSDK_OFFSET(0x1CE48D60)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECTINDEXESPERFACE_1_OFFSET UNITYSDK_OFFSET(0x1CE45FC0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECTINDEXESPERFACE_OFFSET UNITYSDK_OFFSET(0x1CE46E80)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECT_1_OFFSET UNITYSDK_OFFSET(0x1CE44DD0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECT_2_OFFSET UNITYSDK_OFFSET(0x1CE44E30)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECT_3_OFFSET UNITYSDK_OFFSET(0x1CE42FF0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_CONNECT_OFFSET UNITYSDK_OFFSET(0x1CE420F0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_CONNECTELEMENTS_INSERTVERTICES_OFFSET UNITYSDK_OFFSET(0x1CE479B0)
