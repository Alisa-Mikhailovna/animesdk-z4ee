...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_DETACHFACES_1_OFFSET UNITYSDK_OFFSET(0x1CE5B9D0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_DETACHFACES_OFFSET UNITYSDK_OFFSET(0x1CE5B9C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_EXTRUDEASGROUPS_OFFSET UNITYSDK_OFFSET(0x1CE55D70)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_EXTRUDEPERFACE_OFFSET UNITYSDK_OFFSET(0x1CE54580)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_EXTRUDE_1_OFFSET UNITYSDK_OFFSET(0x1CE5A1A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_EXTRUDE_OFFSET UNITYSDK_OFFSET(0x1CE2B980)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_GETFACEGROUPS_OFFSET UNITYSDK_OFFSET(0x1CE5C610)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_EXTRUDEELEMENTS_GETPERIMETEREDGES_OFFSET UNITYSDK_OFFSET(0x1CE5CB70)
