...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION_GET_TRIANGULATIONCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CE6ADD0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION_SORTANDTRIANGULATE_OFFSET UNITYSDK_OFFSET(0x1CE6AE50)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION_TRIANGULATEVERTICES_1_OFFSET UNITYSDK_OFFSET(0x1CE2AD40)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION_TRIANGULATEVERTICES_2_OFFSET UNITYSDK_OFFSET(0x1CE6C590)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION_TRIANGULATEVERTICES_OFFSET UNITYSDK_OFFSET(0x1CE2B9A0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION_TRIANGULATE_1_OFFSET UNITYSDK_OFFSET(0x1CE6C730)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_TRIANGULATION_TRIANGULATE_OFFSET UNITYSDK_OFFSET(0x1CE6B360)
...
namespace UnityEngine::ProBuilder::MeshOperations
{
	...
	public:
		...
		{
			return (::UnityEngine::ProBuilder::Poly2Tri::TriangulationContext**)Il2CppClass::FromTypeDefinitionIndex(Triangulation_TypeDefinitionIndex)->GetStaticField(0x4F9A0);
		}
