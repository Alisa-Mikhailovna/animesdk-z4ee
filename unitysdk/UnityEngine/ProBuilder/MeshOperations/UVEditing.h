...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_ALIGNEDGES_OFFSET UNITYSDK_OFFSET(0x1CE6DE50)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_APPLYUVS_OFFSET UNITYSDK_OFFSET(0x1CE6F640)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_AUTOSTITCH_OFFSET UNITYSDK_OFFSET(0x1CE6DBE0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_COLLAPSEUVS_OFFSET UNITYSDK_OFFSET(0x1CE70A70)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_FINDMINIMALUV_OFFSET UNITYSDK_OFFSET(0x1CE72200)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_FITUVS_OFFSET UNITYSDK_OFFSET(0x1CE73010)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_GETUVS_OFFSET UNITYSDK_OFFSET(0x1CE6EDA0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESAUTO_OFFSET UNITYSDK_OFFSET(0x1CE71310)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESBOX_1_OFFSET UNITYSDK_OFFSET(0x1CE72370)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESBOX_OFFSET UNITYSDK_OFFSET(0x1CE719F0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_PROJECTFACESSPHERE_OFFSET UNITYSDK_OFFSET(0x1CE72C20)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_SEWUVS_OFFSET UNITYSDK_OFFSET(0x1CE70410)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_SPLITUVS_1_OFFSET UNITYSDK_OFFSET(0x1CE70B30)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_UVEDITING_SPLITUVS_OFFSET UNITYSDK_OFFSET(0x1CE6F0B0)
