...
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_EDGERINGNEXT_OFFSET UNITYSDK_OFFSET(0x1CE4F570)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FINDHOLES_1_OFFSET UNITYSDK_OFFSET(0x1CE53830)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FINDHOLES_OFFSET UNITYSDK_OFFSET(0x1CE534C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FINDNEXTEDGEINHOLE_OFFSET UNITYSDK_OFFSET(0x1CE541F0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FLOODSELECTION_OFFSET UNITYSDK_OFFSET(0x1CE52890)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FLOOD_1_OFFSET UNITYSDK_OFFSET(0x1CE52490)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_FLOOD_OFFSET UNITYSDK_OFFSET(0x1CE52400)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETCONNECTEDEDGES_OFFSET UNITYSDK_OFFSET(0x1CE4C910)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGELOOPINTERNALITERATIVE_OFFSET UNITYSDK_OFFSET(0x1CE514C0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGELOOPINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CE50DD0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGELOOPITERATIVE_OFFSET UNITYSDK_OFFSET(0x1CE51010)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGELOOP_OFFSET UNITYSDK_OFFSET(0x1CE507D0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGERINGITERATIVE_OFFSET UNITYSDK_OFFSET(0x1CE4FF10)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETEDGERING_OFFSET UNITYSDK_OFFSET(0x1CE4F5F0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETFACELOOP_1_OFFSET UNITYSDK_OFFSET(0x1CE52F90)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETFACELOOP_OFFSET UNITYSDK_OFFSET(0x1CE52D60)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETFACERINGANDLOOP_OFFSET UNITYSDK_OFFSET(0x1CE53260)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETNEIGHBORFACES_1_OFFSET UNITYSDK_OFFSET(0x1CE2DC10)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETNEIGHBORFACES_2_OFFSET UNITYSDK_OFFSET(0x1CE4C0E0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETNEIGHBORFACES_OFFSET UNITYSDK_OFFSET(0x1CE4BCE0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETPERIMETEREDGES_1_OFFSET UNITYSDK_OFFSET(0x1CE4DC60)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETPERIMETEREDGES_OFFSET UNITYSDK_OFFSET(0x1CE4D3B0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETPERIMETERFACES_OFFSET UNITYSDK_OFFSET(0x1CE4E380)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETPERIMETERVERTICES_OFFSET UNITYSDK_OFFSET(0x1CE4EF20)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GETSPOKES_OFFSET UNITYSDK_OFFSET(0x1CE51890)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_GROWSELECTION_OFFSET UNITYSDK_OFFSET(0x1CE51D70)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION_NEXTSPOKE_OFFSET UNITYSDK_OFFSET(0x1CE51CF0)
#define UNITYENGINE_PROBUILDER_MESHOPERATIONS_ELEMENTSELECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CE542C0)
...
namespace UnityEngine::ProBuilder::MeshOperations
{
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(ElementSelection_TypeDefinitionIndex)->GetStaticField(0xDD00);
		}
