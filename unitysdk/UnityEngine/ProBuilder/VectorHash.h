...
#define UNITYENGINE_PROBUILDER_VECTORHASH_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x1CE99060)
#define UNITYENGINE_PROBUILDER_VECTORHASH_GETHASHCODE_2_OFFSET UNITYSDK_OFFSET(0x1CEC37A0)
#define UNITYENGINE_PROBUILDER_VECTORHASH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CEC3710)
#define UNITYENGINE_PROBUILDER_VECTORHASH_HASHFLOAT_OFFSET UNITYSDK_OFFSET(0x1CEC36D0)
