...
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3A1C380)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A1C350)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_GETEDGELOOKUPHASHSET_OFFSET UNITYSDK_OFFSET(0x1CE074F0)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_GETEDGELOOKUP_OFFSET UNITYSDK_OFFSET(0x1CE07430)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A1C450)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_GET_COMMON_OFFSET UNITYSDK_OFFSET(0x6010)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_GET_LOCAL_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1CE06FA0)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1CE070B0)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_SET_COMMON_OFFSET UNITYSDK_OFFSET(0x94F0)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_SET_LOCAL_OFFSET UNITYSDK_OFFSET(0xC630)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A1C480)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A1C330)
#define UNITYENGINE_PROBUILDER_EDGELOOKUP__CTOR_OFFSET UNITYSDK_OFFSET(0x2E03520)
