...
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_BUILDEDGEMESH_OFFSET UNITYSDK_OFFSET(0x1CE9BD40)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_BUILDVERTEXMESH_OFFSET UNITYSDK_OFFSET(0x1CE9B170)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_DECODERGBA_OFFSET UNITYSDK_OFFSET(0x1CE98BC0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_ENCODERGBA_OFFSET UNITYSDK_OFFSET(0x1CE9B100)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GENERATEEDGEPICKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1CE9A9A0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GENERATEFACEPICKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1CE99580)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GENERATEVERTEXPICKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1CE9A240)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GET_PICKERRENDERER_OFFSET UNITYSDK_OFFSET(0x1CE986D0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GET_RENDERTEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x1CE984F0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_GET_TEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x1CE986C0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_PICKEDGESINRECT_OFFSET UNITYSDK_OFFSET(0x1CE97DB0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_PICKFACESINRECT_OFFSET UNITYSDK_OFFSET(0x1CE96AF0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_PICKVERTICESINRECT_OFFSET UNITYSDK_OFFSET(0x1CE94850)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_RENDERSELECTIONPICKERTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1CE98C00)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_RENDERSELECTIONPICKERTEXTURE_2_OFFSET UNITYSDK_OFFSET(0x1CE99130)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_RENDERSELECTIONPICKERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1CE98800)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER_SHOULDUSEHDRP_OFFSET UNITYSDK_OFFSET(0x1CE987D0)
#define UNITYENGINE_PROBUILDER_SELECTIONPICKERRENDERER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CE9C500)
...
namespace UnityEngine::ProBuilder
{
	...
	public:
		...
		{
			return (::UnityEngine::ProBuilder::SelectionPickerRenderer_ISelectionPickerRenderer**)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0x512C0);
		}
		static ::Il2CppArray<::UnityEngine::RenderTextureFormat>** StaticGet_s_PreferredFormats()
		{
			return (::Il2CppArray<::UnityEngine::RenderTextureFormat>**)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0x512C8);
		}
		static ::UnityEngine::RenderTextureFormat* StaticGet_s_RenderTextureFormat()
		{
			return (::UnityEngine::RenderTextureFormat*)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0xE480);
		}
		static ::UnityEngine::Color* StaticGet_k_Whitef()
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0xE484);
		}
		static ::System::Boolean* StaticGet_s_Initialized()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0xE494);
		}
		static ::UnityEngine::Color* StaticGet_k_Blackf()
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(SelectionPickerRenderer_TypeDefinitionIndex)->GetStaticField(0xE498);
		}
