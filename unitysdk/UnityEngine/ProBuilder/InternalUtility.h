...
#define UNITYENGINE_PROBUILDER_INTERNALUTILITY_CONTROLKEYSTRING_OFFSET UNITYSDK_OFFSET(0x1CE19140)
#define UNITYENGINE_PROBUILDER_INTERNALUTILITY_EMPTYGAMEOBJECTWITHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1CE18FC0)
#define UNITYENGINE_PROBUILDER_INTERNALUTILITY_STRINGTOVECTOR3ARRAY_OFFSET UNITYSDK_OFFSET(0x1CE19520)
#define UNITYENGINE_PROBUILDER_INTERNALUTILITY_TRYPARSECOLOR_OFFSET UNITYSDK_OFFSET(0x1CE191F0)
