...
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_GET_ANGLEERROR_OFFSET UNITYSDK_OFFSET(0x1CEBF800)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_GET_AREAERROR_OFFSET UNITYSDK_OFFSET(0x1CEBF820)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_GET_HARDANGLE_OFFSET UNITYSDK_OFFSET(0x1CEBF7C0)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_GET_PACKMARGIN_OFFSET UNITYSDK_OFFSET(0x1CEBF7E0)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_RESET_OFFSET UNITYSDK_OFFSET(0x1CEBF840)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_SET_ANGLEERROR_OFFSET UNITYSDK_OFFSET(0x1CEBF810)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_SET_AREAERROR_OFFSET UNITYSDK_OFFSET(0x1CEBF830)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_SET_HARDANGLE_OFFSET UNITYSDK_OFFSET(0x1CEBF7D0)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_SET_PACKMARGIN_OFFSET UNITYSDK_OFFSET(0x1CEBF7F0)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CEBF850)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CE85D80)
#define UNITYENGINE_PROBUILDER_UNWRAPPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEA7EC0)
