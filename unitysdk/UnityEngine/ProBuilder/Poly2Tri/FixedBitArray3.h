...
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_CLEAR_OFFSET UNITYSDK_OFFSET(0x3A1BCC0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_ENUMERATE_OFFSET UNITYSDK_OFFSET(0x3A1BCD0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x3A1BD30)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3A1BBC0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x3A1BC40)
#define UNITYENGINE_PROBUILDER_POLY2TRI_FIXEDBITARRAY3_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x3A1BD30)
