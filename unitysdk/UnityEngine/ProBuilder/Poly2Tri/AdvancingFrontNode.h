...
#define UNITYENGINE_PROBUILDER_POLY2TRI_ADVANCINGFRONTNODE_GET_HASNEXT_OFFSET UNITYSDK_OFFSET(0x1CDB7D80)
#define UNITYENGINE_PROBUILDER_POLY2TRI_ADVANCINGFRONTNODE_GET_HASPREV_OFFSET UNITYSDK_OFFSET(0x1CDB7D90)
#define UNITYENGINE_PROBUILDER_POLY2TRI_ADVANCINGFRONTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB7D50)
