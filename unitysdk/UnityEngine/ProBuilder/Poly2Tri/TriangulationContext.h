...
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1CDBFE70)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_DONE_OFFSET UNITYSDK_OFFSET(0x1CDB8C40)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_DEBUGCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CDC2A70)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_DTDEBUGCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CDB8EC0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_ISDEBUGENABLED_OFFSET UNITYSDK_OFFSET(0x1CDC2AE0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_STEPCOUNT_OFFSET UNITYSDK_OFFSET(0x1CDC2AC0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_TRIANGULATABLE_OFFSET UNITYSDK_OFFSET(0x1CDC2AA0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_GET_TRIANGULATIONMODE_OFFSET UNITYSDK_OFFSET(0x1CDC2A80)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_PREPARETRIANGULATION_OFFSET UNITYSDK_OFFSET(0x1CDC01F0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_SET_STEPCOUNT_OFFSET UNITYSDK_OFFSET(0x1CDC2AD0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_SET_TRIANGULATABLE_OFFSET UNITYSDK_OFFSET(0x1CDC2AB0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_SET_TRIANGULATIONMODE_OFFSET UNITYSDK_OFFSET(0x1CDC2A90)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CDB91B0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDBFAC0)
