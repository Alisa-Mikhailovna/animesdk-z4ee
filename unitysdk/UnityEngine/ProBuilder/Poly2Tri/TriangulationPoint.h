...
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONPOINT_ADDEDGE_OFFSET UNITYSDK_OFFSET(0x1CDBF8A0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONPOINT_GET_EDGES_OFFSET UNITYSDK_OFFSET(0x1CDC2AF0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONPOINT_GET_HASEDGES_OFFSET UNITYSDK_OFFSET(0x1CDB8EA0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONPOINT_SET_EDGES_OFFSET UNITYSDK_OFFSET(0x1CDC2B00)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONPOINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CDC0AF0)
#define UNITYENGINE_PROBUILDER_POLY2TRI_TRIANGULATIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC0400)
