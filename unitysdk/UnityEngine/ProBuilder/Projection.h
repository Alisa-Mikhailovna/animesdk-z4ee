...
#define UNITYENGINE_PROBUILDER_PROJECTION_FINDBESTPLANE_1_OFFSET UNITYSDK_OFFSET(0x1CE910F0)
#define UNITYENGINE_PROBUILDER_PROJECTION_FINDBESTPLANE_OFFSET UNITYSDK_OFFSET(0x1CE8D350)
#define UNITYENGINE_PROBUILDER_PROJECTION_GETTANGENTTOAXIS_OFFSET UNITYSDK_OFFSET(0x1CE8F2C0)
#define UNITYENGINE_PROBUILDER_PROJECTION_PLANARPROJECT_1_OFFSET UNITYSDK_OFFSET(0x1CE8E1E0)
#define UNITYENGINE_PROBUILDER_PROJECTION_PLANARPROJECT_2_OFFSET UNITYSDK_OFFSET(0x1CE8E500)
#define UNITYENGINE_PROBUILDER_PROJECTION_PLANARPROJECT_3_OFFSET UNITYSDK_OFFSET(0x1CE8F320)
#define UNITYENGINE_PROBUILDER_PROJECTION_PLANARPROJECT_4_OFFSET UNITYSDK_OFFSET(0x1CE8FB50)
#define UNITYENGINE_PROBUILDER_PROJECTION_PLANARPROJECT_OFFSET UNITYSDK_OFFSET(0x1CE8D300)
#define UNITYENGINE_PROBUILDER_PROJECTION_PROJECTIONAXISTOVECTOR_OFFSET UNITYSDK_OFFSET(0x1CE90FF0)
#define UNITYENGINE_PROBUILDER_PROJECTION_SORT_OFFSET UNITYSDK_OFFSET(0x1CE90770)
#define UNITYENGINE_PROBUILDER_PROJECTION_SPHERICALPROJECT_OFFSET UNITYSDK_OFFSET(0x1CE90160)
#define UNITYENGINE_PROBUILDER_PROJECTION_VECTORTOPROJECTIONAXIS_OFFSET UNITYSDK_OFFSET(0x1CE8F1E0)
