...
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_CONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1CE7CD70)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_EXTRUDE_OFFSET UNITYSDK_OFFSET(0x1CE7CE50)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1CE7CE90)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_MESH_OFFSET UNITYSDK_OFFSET(0x1CE29630)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_GET_POLYEDITMODE_OFFSET UNITYSDK_OFFSET(0x1CE7CE70)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_ISSNAPENABLED_OFFSET UNITYSDK_OFFSET(0x1CE7CEC0)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SETCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1CE7CDD0)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SET_EXTRUDE_OFFSET UNITYSDK_OFFSET(0x1CE7CE60)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1CE7CEA0)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SET_MESH_OFFSET UNITYSDK_OFFSET(0x1CE7CEB0)
#define UNITYENGINE_PROBUILDER_POLYSHAPE_SET_POLYEDITMODE_OFFSET UNITYSDK_OFFSET(0x1CE7CE80)
#define UNITYENGINE_PROBUILDER_POLYSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7CED0)
