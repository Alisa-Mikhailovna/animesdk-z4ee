...
#define UNITYENGINE_PROBUILDER_SPLINE_EXTRUDE_1_OFFSET UNITYSDK_OFFSET(0x1CEBB800)
#define UNITYENGINE_PROBUILDER_SPLINE_EXTRUDE_2_OFFSET UNITYSDK_OFFSET(0x1CEBC230)
#define UNITYENGINE_PROBUILDER_SPLINE_EXTRUDE_OFFSET UNITYSDK_OFFSET(0x1CEBB730)
#define UNITYENGINE_PROBUILDER_SPLINE_GETCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1CEBB8D0)
#define UNITYENGINE_PROBUILDER_SPLINE_GETRINGROTATION_OFFSET UNITYSDK_OFFSET(0x1CEBD0C0)
#define UNITYENGINE_PROBUILDER_SPLINE_VERTEXRING_OFFSET UNITYSDK_OFFSET(0x1CEBDCD0)
