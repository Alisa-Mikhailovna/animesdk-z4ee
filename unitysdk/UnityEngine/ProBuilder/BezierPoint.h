...
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_CUBICPOSITION_OFFSET UNITYSDK_OFFSET(0x1CDC3850)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_ENFORCETANGENTMODE_OFFSET UNITYSDK_OFFSET(0x3A1BEF0)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_GETLOOKDIRECTION_OFFSET UNITYSDK_OFFSET(0x1CDC3920)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_QUADRATICPOSITION_OFFSET UNITYSDK_OFFSET(0x1CDC37D0)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x3A1BF00)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_SETTANGENTIN_OFFSET UNITYSDK_OFFSET(0x3A1BF50)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT_SETTANGENTOUT_OFFSET UNITYSDK_OFFSET(0x3A1BF70)
#define UNITYENGINE_PROBUILDER_BEZIERPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x3A1BE80)
