...
#define UNITYENGINE_PROBUILDER_COLORPALETTE_GET_COLORS_OFFSET UNITYSDK_OFFSET(0x1CDCB400)
#define UNITYENGINE_PROBUILDER_COLORPALETTE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1CDCBB10)
#define UNITYENGINE_PROBUILDER_COLORPALETTE_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CDCB3E0)
#define UNITYENGINE_PROBUILDER_COLORPALETTE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CDCBA70)
#define UNITYENGINE_PROBUILDER_COLORPALETTE_SETCOLORS_OFFSET UNITYSDK_OFFSET(0x1CDCB460)
#define UNITYENGINE_PROBUILDER_COLORPALETTE_SETDEFAULTVALUES_OFFSET UNITYSDK_OFFSET(0x1CDCB510)
#define UNITYENGINE_PROBUILDER_COLORPALETTE_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CDCB3F0)
#define UNITYENGINE_PROBUILDER_COLORPALETTE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CDCBAC0)
#define UNITYENGINE_PROBUILDER_COLORPALETTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCBB30)
