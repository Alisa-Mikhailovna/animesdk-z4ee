...
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_GETSNAPPINGMASKBASEDONNORMALVECTOR_OFFSET UNITYSDK_OFFSET(0x1CE8C860)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_ISCARDINALDIRECTION_OFFSET UNITYSDK_OFFSET(0x1CE8BDA0)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAPVALUEONRAY_OFFSET UNITYSDK_OFFSET(0x1CE8C8F0)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAPVERTICES_OFFSET UNITYSDK_OFFSET(0x1CE8C2D0)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAP_1_OFFSET UNITYSDK_OFFSET(0x1CE8C000)
#define UNITYENGINE_PROBUILDER_PROBUILDERSNAPPING_SNAP_OFFSET UNITYSDK_OFFSET(0x1CE8BF20)
