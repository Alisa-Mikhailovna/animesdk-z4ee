...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAMERACAPTURER_CAPTURE_1_OFFSET UNITYSDK_OFFSET(0x1CDB1FF0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAMERACAPTURER_CAPTURE_OFFSET UNITYSDK_OFFSET(0x1CDB1F30)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAMERACAPTURER_SETUP_OFFSET UNITYSDK_OFFSET(0x1CDB1DC0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CAMERACAPTURER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB2130)
