...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_BEGINRECORDING_OFFSET UNITYSDK_OFFSET(0x1CD94D60)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CONSTRUCTTREE_OFFSET UNITYSDK_OFFSET(0x1CDB0670)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD962A0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_ENDRECORDING_OFFSET UNITYSDK_OFFSET(0x1CD95620)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GETCURRENTTIMESAMPLINGINDEX_OFFSET UNITYSDK_OFFSET(0x1CDB05C0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GETTARGETS_OFFSET UNITYSDK_OFFSET(0x1CDB0390)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1CDB0370)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_RECORDING_OFFSET UNITYSDK_OFFSET(0x1CDB0360)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1CDB0280)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_GET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x1CDB02A0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_PROCESSRECORDING_OFFSET UNITYSDK_OFFSET(0x1CD957D0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SETUPCAPTURERTABLE_OFFSET UNITYSDK_OFFSET(0x1CDB0880)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SETUPCOMPONENTCAPTURER_OFFSET UNITYSDK_OFFSET(0x1CDB1040)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1CDB0380)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1CDB0290)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_SET_TARGETBRANCH_OFFSET UNITYSDK_OFFSET(0x1CDB0300)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_UPDATECAPTURENODES_OFFSET UNITYSDK_OFFSET(0x1CDB1730)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD96380)
