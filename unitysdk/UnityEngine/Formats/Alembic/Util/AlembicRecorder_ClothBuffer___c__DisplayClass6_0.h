...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CLOTHBUFFER___C__DISPLAYCLASS6_0__CAPTURE_B__0_OFFSET UNITYSDK_OFFSET(0x1CDB4180)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CLOTHBUFFER___C__DISPLAYCLASS6_0__CAPTURE_B__1_OFFSET UNITYSDK_OFFSET(0x1CDB41C0)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CLOTHBUFFER___C__DISPLAYCLASS6_0__CAPTURE_B__2_OFFSET UNITYSDK_OFFSET(0x1CDB4200)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDER_CLOTHBUFFER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB3E90)
