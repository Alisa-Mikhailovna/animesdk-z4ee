...
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SETTARGETBRANCH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CDB6E50)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SETTARGETBRANCH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CDB6E80)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SETTARGETBRANCH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CDB6E40)
#define UNITYENGINE_FORMATS_ALEMBIC_UTIL_ALEMBICRECORDERSETTINGS_SETTARGETBRANCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB6DD0)
