...
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1CDAFE30)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CDAFFA0)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1CDAFF70)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_GET_STREAMPLAYER_OFFSET UNITYSDK_OFFSET(0x1CDAFE10)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_SET_STREAMPLAYER_OFFSET UNITYSDK_OFFSET(0x1CDAFE20)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1CDAFE00)
#define UNITYENGINE_FORMATS_ALEMBIC_TIMELINE_ALEMBICSHOTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB0030)
