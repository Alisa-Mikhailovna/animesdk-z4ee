...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_ASCAMERA_OFFSET UNITYSDK_OFFSET(0x3A1AF50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_ASCURVES_OFFSET UNITYSDK_OFFSET(0x3A1B050)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_ASPOINTS_OFFSET UNITYSDK_OFFSET(0x3A1AFD0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_ASPOLYMESH_OFFSET UNITYSDK_OFFSET(0x3A1B0D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_ASSUBD_OFFSET UNITYSDK_OFFSET(0x3A1B150)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_ASXFORM_OFFSET UNITYSDK_OFFSET(0x3A1AED0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_EACHCHILD_OFFSET UNITYSDK_OFFSET(0x3A1B1D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_GETCHILD_OFFSET UNITYSDK_OFFSET(0x3A1AE40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_GET_CHILDCOUNT_OFFSET UNITYSDK_OFFSET(0x3A1ADC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x3A1AAE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x3A1AC10)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x3A1AB60)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x3A1ACC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CDA46D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIOBJECT_SETENABLED_OFFSET UNITYSDK_OFFSET(0x3A1AD40)
