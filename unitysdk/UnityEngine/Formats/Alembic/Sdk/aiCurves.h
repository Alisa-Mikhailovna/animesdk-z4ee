...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x3A1A7E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x3A1A640)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CDAF190)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CDA6250)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_SET_SORTBASEPOSITION_OFFSET UNITYSDK_OFFSET(0x3A1A740)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVES_SET_SORT_OFFSET UNITYSDK_OFFSET(0x3A1A6C0)
