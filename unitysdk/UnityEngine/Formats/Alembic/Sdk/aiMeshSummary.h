...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTNORMALS_OFFSET UNITYSDK_OFFSET(0x2D4DE60)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTPOINTS_OFFSET UNITYSDK_OFFSET(0x3A1AA20)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTRGBA_OFFSET UNITYSDK_OFFSET(0x2CFC940)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTRGB_OFFSET UNITYSDK_OFFSET(0x3A1AAC0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTTANGENTS_OFFSET UNITYSDK_OFFSET(0x3A1AA60)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTUV0_OFFSET UNITYSDK_OFFSET(0x3A1AA80)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTUV1_OFFSET UNITYSDK_OFFSET(0x3A1AAA0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_CONSTANTVELOCITIES_OFFSET UNITYSDK_OFFSET(0x3A1AA40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASCOUNTS_OFFSET UNITYSDK_OFFSET(0x149140)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASINDSICES_OFFSET UNITYSDK_OFFSET(0x39DACE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASNORMALS_OFFSET UNITYSDK_OFFSET(0x84FE0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASPOINTS_OFFSET UNITYSDK_OFFSET(0x39DEF10)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASRGBA_OFFSET UNITYSDK_OFFSET(0x153C00)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASRGB_OFFSET UNITYSDK_OFFSET(0x2D07E40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASTANGENTS_OFFSET UNITYSDK_OFFSET(0x39D4B40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASUV0_OFFSET UNITYSDK_OFFSET(0x39D4B50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASUV1_OFFSET UNITYSDK_OFFSET(0x3A12640)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_HASVELOCITIES_OFFSET UNITYSDK_OFFSET(0x3A1A9C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_GET_TOPOLOGYVARIANCE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTNORMALS_OFFSET UNITYSDK_OFFSET(0x2DFCDB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTPOINTS_OFFSET UNITYSDK_OFFSET(0x3A1AA30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTRGBA_OFFSET UNITYSDK_OFFSET(0x2CFC950)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTRGB_OFFSET UNITYSDK_OFFSET(0x3A1AAD0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTTANGENTS_OFFSET UNITYSDK_OFFSET(0x3A1AA70)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTUV0_OFFSET UNITYSDK_OFFSET(0x3A1AA90)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTUV1_OFFSET UNITYSDK_OFFSET(0x3A1AAB0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_CONSTANTVELOCITIES_OFFSET UNITYSDK_OFFSET(0x3A1AA50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASCOUNTS_OFFSET UNITYSDK_OFFSET(0x149150)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASINDSICES_OFFSET UNITYSDK_OFFSET(0x3A1A9A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASNORMALS_OFFSET UNITYSDK_OFFSET(0x3A1A9E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASPOINTS_OFFSET UNITYSDK_OFFSET(0x3A1A9B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASRGBA_OFFSET UNITYSDK_OFFSET(0x2D07E30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASRGB_OFFSET UNITYSDK_OFFSET(0x2D07E50)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASTANGENTS_OFFSET UNITYSDK_OFFSET(0x3A1A9F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASUV0_OFFSET UNITYSDK_OFFSET(0x3A1AA00)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASUV1_OFFSET UNITYSDK_OFFSET(0x3A1AA10)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_HASVELOCITIES_OFFSET UNITYSDK_OFFSET(0x3A1A9D0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIMESHSUMMARY_SET_TOPOLOGYVARIANCE_OFFSET UNITYSDK_OFFSET(0x2CAC0)
