...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_GET_NUMVERTICESCOUNT_OFFSET UNITYSDK_OFFSET(0x1E130)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_GET_POSITIONCOUNT_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_SET_NUMVERTICESCOUNT_OFFSET UNITYSDK_OFFSET(0x21F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AICURVESSAMPLESUMMARY_SET_POSITIONCOUNT_OFFSET UNITYSDK_OFFSET(0x2CAC0)
