...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESHSAMPLE_FILLVERTEXBUFFER_OFFSET UNITYSDK_OFFSET(0x3A1B6B0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESHSAMPLE_GETSPLITSUMMARIES_OFFSET UNITYSDK_OFFSET(0x3A1B5A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESHSAMPLE_GETSUBMESHSUMMARIES_OFFSET UNITYSDK_OFFSET(0x3A1B630)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESHSAMPLE_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x3A1B520)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESHSAMPLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CDAFA30)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOLYMESHSAMPLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CDAFA20)
