...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_ADDFACESET_OFFSET UNITYSDK_OFFSET(0x3A19B70)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_MARKFORCEINVISIBLE_OFFSET UNITYSDK_OFFSET(0x3A19D40)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_NEWCAMERA_OFFSET UNITYSDK_OFFSET(0x3A197E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_NEWPOINTS_OFFSET UNITYSDK_OFFSET(0x3A19890)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_NEWPOLYMESH_OFFSET UNITYSDK_OFFSET(0x3A19940)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_NEWPROPERTY_OFFSET UNITYSDK_OFFSET(0x3A19C90)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_NEWXFORM_OFFSET UNITYSDK_OFFSET(0x3A19730)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_SANITIZENAME_OFFSET UNITYSDK_OFFSET(0x1CDAE2A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_WRITESAMPLE_1_OFFSET UNITYSDK_OFFSET(0x3A19A70)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_WRITESAMPLE_2_OFFSET UNITYSDK_OFFSET(0x3A19AF0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_WRITESAMPLE_3_OFFSET UNITYSDK_OFFSET(0x3A19C10)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEOBJECT_WRITESAMPLE_OFFSET UNITYSDK_OFFSET(0x3A199F0)
