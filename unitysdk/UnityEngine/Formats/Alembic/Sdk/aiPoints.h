...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOINTS_GETSUMMARY_OFFSET UNITYSDK_OFFSET(0x3A1B260)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOINTS_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x3A1B1E0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOINTS_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1CDAF920)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOINTS_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1CDA6240)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOINTS_SET_SORTBASEPOSITION_OFFSET UNITYSDK_OFFSET(0x3A1A740)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AIPOINTS_SET_SORT_OFFSET UNITYSDK_OFFSET(0x3A1A6C0)
