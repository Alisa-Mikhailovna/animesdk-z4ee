...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_GET_REQUESTEDINDEX_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_GET_REQUESTEDTIMEINDEXTYPE_OFFSET UNITYSDK_OFFSET(0x6E20)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_GET_REQUESTEDTIME_OFFSET UNITYSDK_OFFSET(0x2D395D0)
...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AISAMPLESELECTOR_SET_REQUESTEDTIME_OFFSET UNITYSDK_OFFSET(0x3A1B740)
