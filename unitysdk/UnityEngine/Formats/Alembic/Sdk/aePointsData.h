...
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1D2A0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_IDS_OFFSET UNITYSDK_OFFSET(0x2B150)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0x6010)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_VELOCITIES_OFFSET UNITYSDK_OFFSET(0x14430)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x2DD70)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_COUNT_OFFSET UNITYSDK_OFFSET(0xB440)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_IDS_OFFSET UNITYSDK_OFFSET(0x2B160)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_POSITIONS_OFFSET UNITYSDK_OFFSET(0x94F0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_VELOCITIES_OFFSET UNITYSDK_OFFSET(0xB7C0)
#define UNITYENGINE_FORMATS_ALEMBIC_SDK_AEPOINTSDATA_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x1490D0)
