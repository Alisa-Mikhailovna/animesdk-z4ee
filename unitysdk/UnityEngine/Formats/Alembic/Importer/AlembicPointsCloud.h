...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_BOUNDSCENTER_OFFSET UNITYSDK_OFFSET(0x1CD9F6C0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_BOUNDSEXTENTS_OFFSET UNITYSDK_OFFSET(0x1CD9F6F0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_IDSLIST_OFFSET UNITYSDK_OFFSET(0x1CD9F650)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_IDS_OFFSET UNITYSDK_OFFSET(0x1CD9F6A0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_POINTSLIST_OFFSET UNITYSDK_OFFSET(0x1CD9F630)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0x1CD9F660)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_VELOCITIESLIST_OFFSET UNITYSDK_OFFSET(0x1CD9F640)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_GET_VELOCITIES_OFFSET UNITYSDK_OFFSET(0x1CD9F680)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1CD9F7B0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_RESET_OFFSET UNITYSDK_OFFSET(0x1CD9F720)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_SET_BOUNDSCENTER_OFFSET UNITYSDK_OFFSET(0x1CD9F6E0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD_SET_BOUNDSEXTENTS_OFFSET UNITYSDK_OFFSET(0x1CD9F710)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSCLOUD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD9F800)
