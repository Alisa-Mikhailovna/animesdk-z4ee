...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CD972B0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CD972E0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CD97080)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVES_ONUPDATEDATAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD971C0)
