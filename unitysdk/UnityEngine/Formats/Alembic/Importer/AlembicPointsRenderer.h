...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_FLUSHMOTIONVECTOR_OFFSET UNITYSDK_OFFSET(0x1CDA09D0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1CD9F9C0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_INSTANCEDMESH_OFFSET UNITYSDK_OFFSET(0x1CD9F890)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1CD9F8B0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_GET_MOTIONVECTORMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CD9F9A0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1CDA19A0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1CDA1CA0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CDA1990)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_ONRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1CDA1B30)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1CDA15D0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_INSTANCEDMESH_OFFSET UNITYSDK_OFFSET(0x1CD9F8A0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1CD9F970)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_SET_MOTIONVECTORMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CD9F9B0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER_START_OFFSET UNITYSDK_OFFSET(0x1CDA1B40)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICPOINTSRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDA2060)
