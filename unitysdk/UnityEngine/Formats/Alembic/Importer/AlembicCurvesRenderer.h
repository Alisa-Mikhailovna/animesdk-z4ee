...
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESRENDERER_GENERATELINEMESH_OFFSET UNITYSDK_OFFSET(0x1CD98480)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESRENDERER_GENERATEPLANEMESH_OFFSET UNITYSDK_OFFSET(0x1CD99140)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESRENDERER_GETDEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1CD982A0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1CD990D0)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1CD99130)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CD98040)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESRENDERER_UPDATEMESH_OFFSET UNITYSDK_OFFSET(0x1CD98420)
#define UNITYENGINE_FORMATS_ALEMBIC_IMPORTER_ALEMBICCURVESRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD99EB0)
