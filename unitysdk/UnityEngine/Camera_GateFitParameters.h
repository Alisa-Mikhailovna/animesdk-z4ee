...
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_GET_MODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_SET_ASPECT_OFFSET UNITYSDK_OFFSET(0xD500)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_SET_MODE_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x7E750)
