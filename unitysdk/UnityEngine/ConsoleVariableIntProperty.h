...
#define UNITYENGINE_CONSOLEVARIABLEINTPROPERTY_GET_INTVALUE_OFFSET UNITYSDK_OFFSET(0x3A268E0)
#define UNITYENGINE_CONSOLEVARIABLEINTPROPERTY_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1D00D810)
#define UNITYENGINE_CONSOLEVARIABLEINTPROPERTY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D00D800)
#define UNITYENGINE_CONSOLEVARIABLEINTPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x3A268A0)
