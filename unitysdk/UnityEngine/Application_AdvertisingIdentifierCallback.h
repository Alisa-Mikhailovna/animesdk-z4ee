...
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D002810)
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D002880)
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D0003D0)
#define UNITYENGINE_APPLICATION_ADVERTISINGIDENTIFIERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D002790)
