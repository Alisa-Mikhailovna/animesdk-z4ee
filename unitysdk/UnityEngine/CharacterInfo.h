...
#define UNITYENGINE_CHARACTERINFO_GET_ADVANCE_OFFSET UNITYSDK_OFFSET(0x3A3E880)
#define UNITYENGINE_CHARACTERINFO_GET_UVBOTTOMLEFTUNFLIPPED_OFFSET UNITYSDK_OFFSET(0x14C470)
#define UNITYENGINE_CHARACTERINFO_GET_UVBOTTOMLEFT_OFFSET UNITYSDK_OFFSET(0x14C470)
#define UNITYENGINE_CHARACTERINFO_GET_UVBOTTOMRIGHTUNFLIPPED_OFFSET UNITYSDK_OFFSET(0x3A3E8D0)
#define UNITYENGINE_CHARACTERINFO_GET_UVBOTTOMRIGHT_OFFSET UNITYSDK_OFFSET(0x3A3E940)
#define UNITYENGINE_CHARACTERINFO_GET_UVTOPLEFTUNFLIPPED_OFFSET UNITYSDK_OFFSET(0x3A3E920)
#define UNITYENGINE_CHARACTERINFO_GET_UVTOPLEFT_OFFSET UNITYSDK_OFFSET(0x3A3E980)
#define UNITYENGINE_CHARACTERINFO_GET_UVTOPRIGHTUNFLIPPED_OFFSET UNITYSDK_OFFSET(0x3A3E8F0)
#define UNITYENGINE_CHARACTERINFO_GET_UVTOPRIGHT_OFFSET UNITYSDK_OFFSET(0x3A3E8F0)
