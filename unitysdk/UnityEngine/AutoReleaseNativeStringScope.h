...
#define UNITYENGINE_AUTORELEASENATIVESTRINGSCOPE_CREATE_OFFSET UNITYSDK_OFFSET(0x1D004B70)
#define UNITYENGINE_AUTORELEASENATIVESTRINGSCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3A24A30)
#define UNITYENGINE_AUTORELEASENATIVESTRINGSCOPE_POP_OFFSET UNITYSDK_OFFSET(0x1D004BB0)
#define UNITYENGINE_AUTORELEASENATIVESTRINGSCOPE_PUSH_OFFSET UNITYSDK_OFFSET(0x1D004B90)
