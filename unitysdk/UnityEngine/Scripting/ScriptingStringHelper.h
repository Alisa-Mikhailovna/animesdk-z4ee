...
#define UNITYENGINE_SCRIPTING_SCRIPTINGSTRINGHELPER_MODIFYSTRINGBYNATIVESTRING_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D05A150)
#define UNITYENGINE_SCRIPTING_SCRIPTINGSTRINGHELPER_MODIFYSTRINGBYNATIVESTRING_OFFSET UNITYSDK_OFFSET(0x1D05A130)
#define UNITYENGINE_SCRIPTING_SCRIPTINGSTRINGHELPER_MODIFYSTRING_OFFSET UNITYSDK_OFFSET(0x1D05A0C0)
