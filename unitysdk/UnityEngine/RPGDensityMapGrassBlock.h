...
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_CHANGETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1D041DB0)
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_GRASSVOLUMEHASINIT_OFFSET UNITYSDK_OFFSET(0x1D041DA0)
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_REMOVEGRASSVOLUMEUSEVOLUMEKEY_OFFSET UNITYSDK_OFFSET(0x1D041D90)
#define UNITYENGINE_RPGDENSITYMAPGRASSBLOCK_SETGRASSBLOCKDATA_OFFSET UNITYSDK_OFFSET(0x1D041D80)
