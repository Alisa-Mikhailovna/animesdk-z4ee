...
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xC4B0)
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_IMAGEFORMAT_OFFSET UNITYSDK_OFFSET(0x2A90)
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_RAWIMAGEDATAREFERENCE_OFFSET UNITYSDK_OFFSET(0x2DA1F50)
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x6E40)
