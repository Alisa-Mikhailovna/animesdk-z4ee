...
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_SECTIONCACHE_GET_SECTION_OFFSET UNITYSDK_OFFSET(0x1D018250)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_SECTIONCACHE_GET_SHOULDUSE_OFFSET UNITYSDK_OFFSET(0x1D018210)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_SECTIONCACHE_GET_TOPSECT_OFFSET UNITYSDK_OFFSET(0x1D018230)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_SECTIONCACHE_SET_SECTION_OFFSET UNITYSDK_OFFSET(0x1D018260)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_SECTIONCACHE_SET_SHOULDUSE_OFFSET UNITYSDK_OFFSET(0x1D018220)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_SECTIONCACHE_SET_TOPSECT_OFFSET UNITYSDK_OFFSET(0x1D018240)
#define UNITYENGINE_DEFAULTCONSOLECONFIGREADER_SECTIONCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D014450)
