...
#define UNITYENGINE_SLIDERHANDLER_CLAMPEDCURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x3A34F20)
#define UNITYENGINE_SLIDERHANDLER_CLAMP_OFFSET UNITYSDK_OFFSET(0x3A34D70)
#define UNITYENGINE_SLIDERHANDLER_CURRENTEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x3A34BF0)
#define UNITYENGINE_SLIDERHANDLER_CURRENTEVENT_OFFSET UNITYSDK_OFFSET(0x3A34D50)
#define UNITYENGINE_SLIDERHANDLER_CURRENTSCROLLTROUGHSIDE_OFFSET UNITYSDK_OFFSET(0x3A34C30)
#define UNITYENGINE_SLIDERHANDLER_HANDLE_OFFSET UNITYSDK_OFFSET(0x3A34B60)
#define UNITYENGINE_SLIDERHANDLER_HORIZONTALTHUMBRECT_OFFSET UNITYSDK_OFFSET(0x3A34F00)
#define UNITYENGINE_SLIDERHANDLER_ISEMPTYSLIDER_OFFSET UNITYSDK_OFFSET(0x3A34C40)
#define UNITYENGINE_SLIDERHANDLER_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x3A34FF0)
#define UNITYENGINE_SLIDERHANDLER_MINVALUE_OFFSET UNITYSDK_OFFSET(0x3A35000)
#define UNITYENGINE_SLIDERHANDLER_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x3A34F50)
#define UNITYENGINE_SLIDERHANDLER_ONMOUSEDOWN_OFFSET UNITYSDK_OFFSET(0x3A34B70)
#define UNITYENGINE_SLIDERHANDLER_ONMOUSEDRAG_OFFSET UNITYSDK_OFFSET(0x3A34B80)
#define UNITYENGINE_SLIDERHANDLER_ONMOUSEUP_OFFSET UNITYSDK_OFFSET(0x3A34B90)
#define UNITYENGINE_SLIDERHANDLER_ONREPAINT_OFFSET UNITYSDK_OFFSET(0x3A34BE0)
#define UNITYENGINE_SLIDERHANDLER_PAGEMOVEMENTVALUE_OFFSET UNITYSDK_OFFSET(0x3A34CD0)
#define UNITYENGINE_SLIDERHANDLER_PAGEUPMOVEMENTBOUND_OFFSET UNITYSDK_OFFSET(0x3A34CE0)
#define UNITYENGINE_SLIDERHANDLER_SLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x3A34EB0)
#define UNITYENGINE_SLIDERHANDLER_STARTDRAGGINGWITHVALUE_OFFSET UNITYSDK_OFFSET(0x3A34DF0)
#define UNITYENGINE_SLIDERHANDLER_SUPPORTSPAGEMOVEMENTS_OFFSET UNITYSDK_OFFSET(0x3A34C60)
#define UNITYENGINE_SLIDERHANDLER_THUMBEXTRECT_OFFSET UNITYSDK_OFFSET(0x3A34EC0)
#define UNITYENGINE_SLIDERHANDLER_THUMBRECT_OFFSET UNITYSDK_OFFSET(0x3A34DA0)
#define UNITYENGINE_SLIDERHANDLER_THUMBSELECTIONRECT_OFFSET UNITYSDK_OFFSET(0x3A34DA0)
#define UNITYENGINE_SLIDERHANDLER_THUMBSIZE_OFFSET UNITYSDK_OFFSET(0x3A34FE0)
#define UNITYENGINE_SLIDERHANDLER_VALUEFORCURRENTMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x3A34D60)
#define UNITYENGINE_SLIDERHANDLER_VALUESPERPIXEL_OFFSET UNITYSDK_OFFSET(0x3A34FD0)
#define UNITYENGINE_SLIDERHANDLER_VERTICALTHUMBRECT_OFFSET UNITYSDK_OFFSET(0x3A34EE0)
#define UNITYENGINE_SLIDERHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x3A34B10)
