...
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x2D37550)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_CYCLECOUNT_OFFSET UNITYSDK_OFFSET(0x3A35290)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x3A35270)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_MINCOUNT_OFFSET UNITYSDK_OFFSET(0x3A35250)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_PROBABILITY_OFFSET UNITYSDK_OFFSET(0x3A352C0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_REPEATINTERVAL_OFFSET UNITYSDK_OFFSET(0x39EC560)
#define UNITYENGINE_PARTICLESYSTEM_BURST_GET_TIME_OFFSET UNITYSDK_OFFSET(0xD4D0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x39C9890)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_CYCLECOUNT_OFFSET UNITYSDK_OFFSET(0x3A352A0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x3A35280)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_MINCOUNT_OFFSET UNITYSDK_OFFSET(0x3A35260)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_PROBABILITY_OFFSET UNITYSDK_OFFSET(0x3A352D0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_REPEATINTERVAL_OFFSET UNITYSDK_OFFSET(0x3A352B0)
#define UNITYENGINE_PARTICLESYSTEM_BURST_SET_TIME_OFFSET UNITYSDK_OFFSET(0xD4E0)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A35110)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3A35160)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_3_OFFSET UNITYSDK_OFFSET(0x3A351C0)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_4_OFFSET UNITYSDK_OFFSET(0x3A35200)
#define UNITYENGINE_PARTICLESYSTEM_BURST__CTOR_OFFSET UNITYSDK_OFFSET(0x3A350E0)
