...
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CFF0230)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CFF0300)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_DEFAULTBOOL_OFFSET UNITYSDK_OFFSET(0x1CFF0210)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_DEFAULTFLOAT_OFFSET UNITYSDK_OFFSET(0x1CFF01D0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_DEFAULTINT_OFFSET UNITYSDK_OFFSET(0x1CFF01F0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_NAMEHASH_OFFSET UNITYSDK_OFFSET(0x1CFF0190)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CFF0180)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1CFF01C0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_SET_DEFAULTBOOL_OFFSET UNITYSDK_OFFSET(0x1CFF0220)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_SET_DEFAULTFLOAT_OFFSET UNITYSDK_OFFSET(0x1CFF01E0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_SET_DEFAULTINT_OFFSET UNITYSDK_OFFSET(0x1CFF0200)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF0390)
