...
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GETBOOLFORMANAGED_OFFSET UNITYSDK_OFFSET(0x1D00DA10)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GETFLOATFORMANAGED_OFFSET UNITYSDK_OFFSET(0x1D00DA40)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GETINTFORMANAGED_OFFSET UNITYSDK_OFFSET(0x1D00DA30)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GETSTRINGFORMANAGED_OFFSET UNITYSDK_OFFSET(0x1D00DA60)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1D00D820)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x3A26830)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GET_FLOATVALUE_OFFSET UNITYSDK_OFFSET(0x3A26890)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GET_INTVALUE_OFFSET UNITYSDK_OFFSET(0x3A268E0)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x2D0A560)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_GET_STRINGVALUE_OFFSET UNITYSDK_OFFSET(0x3A26940)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1D00D340)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1D00D360)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1D00D380)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D00D320)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_SETBOOLFORMANAGED_OFFSET UNITYSDK_OFFSET(0x1D00DA20)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY_SET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x3A26840)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A26900)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3A26910)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x3A26920)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x3A26930)
#define UNITYENGINE_CONSOLEVARIABLEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x3A268F0)
