...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHOBJECTPOOL_GETTEMPMATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1CED3300)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHOBJECTPOOL_RELEASEALLTEMPALLOC_OFFSET UNITYSDK_OFFSET(0x1CED0730)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHOBJECTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CECC9D0)
