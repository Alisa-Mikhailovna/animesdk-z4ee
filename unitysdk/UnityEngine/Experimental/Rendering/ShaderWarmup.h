...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_BEGINPSOWARMUPQUALITYSET_OFFSET UNITYSDK_OFFSET(0x1D01C2E0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_BEGINPSOWARMUP_OFFSET UNITYSDK_OFFSET(0x1D01C2C0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_ENDPSOWARMUPQUALITYSET_OFFSET UNITYSDK_OFFSET(0x1D01C2F0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_ENDPSOWARMUP_OFFSET UNITYSDK_OFFSET(0x1D01C2D0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_GETPSOCACHEFILESIZE_OFFSET UNITYSDK_OFFSET(0x1D01C310)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_PSOWARMUPASYNCSAVERUNNING_OFFSET UNITYSDK_OFFSET(0x1D01C300)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_WARMUPPSO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D01C2B0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_WARMUPPSO_OFFSET UNITYSDK_OFFSET(0x1D01C2A0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_WARMUPSHADERPASS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1D01C290)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_SHADERWARMUP_WARMUPSHADERPASS_OFFSET UNITYSDK_OFFSET(0x1D01C270)
