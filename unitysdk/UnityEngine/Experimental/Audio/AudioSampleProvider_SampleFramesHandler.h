...
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_SAMPLEFRAMESHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CFF43B0)
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_SAMPLEFRAMESHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CFF4410)
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_SAMPLEFRAMESHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CFF4290)
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_SAMPLEFRAMESHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF42C0)
