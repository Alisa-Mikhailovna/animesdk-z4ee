...
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_INVOKESAMPLEFRAMESAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1CFF4270)
#define UNITYENGINE_EXPERIMENTAL_AUDIO_AUDIOSAMPLEPROVIDER_INVOKESAMPLEFRAMESOVERFLOW_OFFSET UNITYSDK_OFFSET(0x1CFF42A0)
