...
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TERRAINFILTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D0CE100)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TERRAINFILTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D0CE130)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TERRAINFILTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D0CD1F0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TERRAINFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0CE090)
