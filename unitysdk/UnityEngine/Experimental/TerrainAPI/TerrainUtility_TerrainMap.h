...
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_ADDTERRAININTERNAL_OFFSET UNITYSDK_OFFSET(0x1D0CD490)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_CREATEFROMPLACEMENT_1_OFFSET UNITYSDK_OFFSET(0x1D0CCAE0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_CREATEFROMPLACEMENT_OFFSET UNITYSDK_OFFSET(0x1D0CBFC0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_GETTERRAIN_OFFSET UNITYSDK_OFFSET(0x1D0CC960)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TRYTOADDTERRAIN_OFFSET UNITYSDK_OFFSET(0x1D0CD200)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_VALIDATETERRAIN_OFFSET UNITYSDK_OFFSET(0x1D0CD640)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1D0CD2D0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0CD150)
