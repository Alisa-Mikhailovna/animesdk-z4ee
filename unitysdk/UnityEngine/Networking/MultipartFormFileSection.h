...
#define UNITYENGINE_NETWORKING_MULTIPARTFORMFILESECTION_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1D18F6F0)
#define UNITYENGINE_NETWORKING_MULTIPARTFORMFILESECTION_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1D18F6E0)
#define UNITYENGINE_NETWORKING_MULTIPARTFORMFILESECTION_GET_SECTIONDATA_OFFSET UNITYSDK_OFFSET(0x1D18F6D0)
#define UNITYENGINE_NETWORKING_MULTIPARTFORMFILESECTION_GET_SECTIONNAME_OFFSET UNITYSDK_OFFSET(0x1D18F6C0)
#define UNITYENGINE_NETWORKING_MULTIPARTFORMFILESECTION_INIT_OFFSET UNITYSDK_OFFSET(0x1D18F5E0)
#define UNITYENGINE_NETWORKING_MULTIPARTFORMFILESECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18F600)
