...
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_CREATE_OFFSET UNITYSDK_OFFSET(0x1D197030)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1D197090)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1D1970A0)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_INTERNALCREATETEXTURE_OFFSET UNITYSDK_OFFSET(0x1D197040)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_INTERNALGETTEXTURENATIVE_OFFSET UNITYSDK_OFFSET(0x1D1971C0)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE_INTERNALGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1D197130)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D197060)
