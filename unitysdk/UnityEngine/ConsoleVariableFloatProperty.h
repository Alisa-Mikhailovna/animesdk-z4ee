...
#define UNITYENGINE_CONSOLEVARIABLEFLOATPROPERTY_GET_FLOATVALUE_OFFSET UNITYSDK_OFFSET(0x3A26890)
#define UNITYENGINE_CONSOLEVARIABLEFLOATPROPERTY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D00D5C0)
#define UNITYENGINE_CONSOLEVARIABLEFLOATPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x3A26850)
