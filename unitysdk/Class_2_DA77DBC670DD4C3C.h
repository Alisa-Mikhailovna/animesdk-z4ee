...
#define CLASS_2_DA77DBC670DD4C3C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB0DCF50)
#define CLASS_2_DA77DBC670DD4C3C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB0DCF90)
#define CLASS_2_DA77DBC670DD4C3C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB0DD200)
#define CLASS_2_DA77DBC670DD4C3C_TICK_OFFSET UNITYSDK_OFFSET(0xB0DD250)
#define CLASS_2_DA77DBC670DD4C3C__CTOR_OFFSET UNITYSDK_OFFSET(0xB0DCF40)
...
{
public:
	::RPG::GameCore::BeginUseSharedSummonUnit* Field_2_0; // 0x18
