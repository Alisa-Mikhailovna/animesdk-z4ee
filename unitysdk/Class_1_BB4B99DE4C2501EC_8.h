...
#define CLASS_1_BB4B99DE4C2501EC_8_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C49CA70)
#define CLASS_1_BB4B99DE4C2501EC_8_CLONE_OFFSET UNITYSDK_OFFSET(0x1C49C3E0)
#define CLASS_1_BB4B99DE4C2501EC_8_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C49C5B0)
#define CLASS_1_BB4B99DE4C2501EC_8_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C49C4E0)
#define CLASS_1_BB4B99DE4C2501EC_8_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C49C640)
#define CLASS_1_BB4B99DE4C2501EC_8_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C49CDD0)
#define CLASS_1_BB4B99DE4C2501EC_8_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C49CD50)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C49C470)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1C49C490)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C49C450)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1C49C440)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C49C270)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C49C4D0)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C49C480)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1C49C4A0)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C49C460)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1C49C4C0)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1C49C430)
#define CLASS_1_BB4B99DE4C2501EC_8_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1C49C4B0)
#define CLASS_1_BB4B99DE4C2501EC_8_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C49C2D0)
#define CLASS_1_BB4B99DE4C2501EC_8_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C49C770)
#define CLASS_1_BB4B99DE4C2501EC_8_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C49C7D0)
#define CLASS_1_BB4B99DE4C2501EC_8__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C49CF10)
#define CLASS_1_BB4B99DE4C2501EC_8__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C49C330)
#define CLASS_1_BB4B99DE4C2501EC_8__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49C2E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_BB4B99DE4C2501EC_8*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BB4B99DE4C2501EC_8_TypeDefinitionIndex)->GetStaticField(0x50FC0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_BB4B99DE4C2501EC_8_TypeDefinitionIndex)->GetStaticField(0x50FC8);
	}
