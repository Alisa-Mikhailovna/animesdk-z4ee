...
#define AKCALLBACKMANAGER_MONITORINGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1AE850)
#define AKCALLBACKMANAGER_MONITORINGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1AE930)
#define AKCALLBACKMANAGER_MONITORINGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1AD5C0)
#define AKCALLBACKMANAGER_MONITORINGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AE7E0)
