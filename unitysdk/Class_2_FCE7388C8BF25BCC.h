...
#define CLASS_2_FCE7388C8BF25BCC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14B28F40)
#define CLASS_2_FCE7388C8BF25BCC_METHOD_2_7B0A407379BA27E7_OFFSET UNITYSDK_OFFSET(0x14B29070)
#define CLASS_2_FCE7388C8BF25BCC_METHOD_2_CC2FBC3BD9171E9F_1_OFFSET UNITYSDK_OFFSET(0x14B297E0)
#define CLASS_2_FCE7388C8BF25BCC_METHOD_2_CC2FBC3BD9171E9F_OFFSET UNITYSDK_OFFSET(0x14B295B0)
#define CLASS_2_FCE7388C8BF25BCC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14B28F90)
#define CLASS_2_FCE7388C8BF25BCC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14B294F0)
#define CLASS_2_FCE7388C8BF25BCC_TICK_OFFSET UNITYSDK_OFFSET(0x14B29550)
#define CLASS_2_FCE7388C8BF25BCC__CTOR_OFFSET UNITYSDK_OFFSET(0x14B28D20)
...
public:
	...
	::RPG::GameCore::AdvNPCUseMazeSkill* Field_2_3; // 0x30
	::RPG::GameCore::AdventureSkillCharacterComponent* Field_2_4; // 0x38
