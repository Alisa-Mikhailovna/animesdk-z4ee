...
#define NEWTONSOFT_JSON_BSON_BSONOBJECT_ADD_OFFSET UNITYSDK_OFFSET(0x1A262BF0)
#define NEWTONSOFT_JSON_BSON_BSONOBJECT_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A262D10)
#define NEWTONSOFT_JSON_BSON_BSONOBJECT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A262D00)
#define NEWTONSOFT_JSON_BSON_BSONOBJECT_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A262D80)
#define NEWTONSOFT_JSON_BSON_BSONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A262DF0)
