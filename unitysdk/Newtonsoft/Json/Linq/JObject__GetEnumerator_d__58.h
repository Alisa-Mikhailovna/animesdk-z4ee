...
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A2AB750)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_NEWTONSOFT_JSON_LINQ_JTOKEN___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A2ABAC0)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A2ABB20)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A2ABAD0)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__58_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A2AB630)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__58__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2AB410)
#define NEWTONSOFT_JSON_LINQ_JOBJECT__GETENUMERATOR_D__58___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A2AB650)
