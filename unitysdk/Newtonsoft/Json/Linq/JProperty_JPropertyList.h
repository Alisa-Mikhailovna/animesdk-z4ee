...
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_ADD_OFFSET UNITYSDK_OFFSET(0x1A2ACAF0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A2ACB00)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A2ACB10)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A2ACB20)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A2ACA40)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A2ACBC0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1A2ACBD0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A2ACC00)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A2AC1A0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1A2ACBE0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1A2ACBF0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A2ACBA0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A2ACC10)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A2ACAA0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTY_JPROPERTYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2ABFD0)
