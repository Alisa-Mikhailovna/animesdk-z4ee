...
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_ADDPARENT_OFFSET UNITYSDK_OFFSET(0x1A2B7A80)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_ADDVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A2B7E70)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_ADDVALUE_OFFSET UNITYSDK_OFFSET(0x1A2B7DF0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A2B7890)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x1A2B3CB0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_REMOVEPARENT_OFFSET UNITYSDK_OFFSET(0x1A2B7AC0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITECOMMENT_OFFSET UNITYSDK_OFFSET(0x1A2B8100)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEEND_OFFSET UNITYSDK_OFFSET(0x1A2B7D10)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x1A2B8050)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A2B7D20)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITERAW_OFFSET UNITYSDK_OFFSET(0x1A2B80B0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITESTARTARRAY_OFFSET UNITYSDK_OFFSET(0x1A2B7B80)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITESTARTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A2B7C70)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITESTARTOBJECT_OFFSET UNITYSDK_OFFSET(0x1A2B79F0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITETOKEN_OFFSET UNITYSDK_OFFSET(0x1A2B92A0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEUNDEFINED_OFFSET UNITYSDK_OFFSET(0x1A2B8080)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_10_OFFSET UNITYSDK_OFFSET(0x1A2B8790)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_11_OFFSET UNITYSDK_OFFSET(0x1A2B8840)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_12_OFFSET UNITYSDK_OFFSET(0x1A2B8930)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_13_OFFSET UNITYSDK_OFFSET(0x1A2B89E0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_14_OFFSET UNITYSDK_OFFSET(0x1A2B8A90)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_15_OFFSET UNITYSDK_OFFSET(0x1A2B8B40)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_16_OFFSET UNITYSDK_OFFSET(0x1A2B8F00)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_17_OFFSET UNITYSDK_OFFSET(0x1A2B8FB0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_18_OFFSET UNITYSDK_OFFSET(0x1A2B90C0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_19_OFFSET UNITYSDK_OFFSET(0x1A2B9170)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A2B8180)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_20_OFFSET UNITYSDK_OFFSET(0x1A2B9220)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_2_OFFSET UNITYSDK_OFFSET(0x1A2B8210)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_3_OFFSET UNITYSDK_OFFSET(0x1A2B82C0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_4_OFFSET UNITYSDK_OFFSET(0x1A2B8370)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_5_OFFSET UNITYSDK_OFFSET(0x1A2B8420)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_6_OFFSET UNITYSDK_OFFSET(0x1A2B84D0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_7_OFFSET UNITYSDK_OFFSET(0x1A2B8580)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_8_OFFSET UNITYSDK_OFFSET(0x1A2B8630)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_9_OFFSET UNITYSDK_OFFSET(0x1A2B86E0)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER_WRITEVALUE_OFFSET UNITYSDK_OFFSET(0x1A2B8040)
#define NEWTONSOFT_JSON_LINQ_JTOKENWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2B3C70)
