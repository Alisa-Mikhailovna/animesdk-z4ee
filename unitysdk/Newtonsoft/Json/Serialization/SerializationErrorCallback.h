...
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONERRORCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A2EE040)
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONERRORCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A2EE0D0)
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONERRORCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2CDF60)
#define NEWTONSOFT_JSON_SERIALIZATION_SERIALIZATIONERRORCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2EDF50)
