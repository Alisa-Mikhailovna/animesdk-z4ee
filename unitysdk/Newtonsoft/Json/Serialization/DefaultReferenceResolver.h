...
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_ADDREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A2CA0D0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_GETMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1A2C9D40)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_GETREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A2CA010)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_ISREFERENCED_OFFSET UNITYSDK_OFFSET(0x1A2CA140)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER_RESOLVEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A2C9FA0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTREFERENCERESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2CA1B0)
