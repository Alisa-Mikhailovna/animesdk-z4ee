...
#define NEWTONSOFT_JSON_SERIALIZATION_REFLECTIONVALUEPROVIDER_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A2DD2B0)
#define NEWTONSOFT_JSON_SERIALIZATION_REFLECTIONVALUEPROVIDER_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A2DD4C0)
#define NEWTONSOFT_JSON_SERIALIZATION_REFLECTIONVALUEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2C7C40)
