...
#define NEWTONSOFT_JSON_CONVERTERS_BSONOBJECTIDCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A266FB0)
#define NEWTONSOFT_JSON_CONVERTERS_BSONOBJECTIDCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A266DB0)
#define NEWTONSOFT_JSON_CONVERTERS_BSONOBJECTIDCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A266C60)
#define NEWTONSOFT_JSON_CONVERTERS_BSONOBJECTIDCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A266FF0)
