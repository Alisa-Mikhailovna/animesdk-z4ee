...
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A26D430)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_GET_ENABLEVECTOR2_OFFSET UNITYSDK_OFFSET(0x1A26C630)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_GET_ENABLEVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A26C650)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_GET_ENABLEVECTOR4_OFFSET UNITYSDK_OFFSET(0x1A26C670)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_POPULATEVECTOR2_OFFSET UNITYSDK_OFFSET(0x1A26D0A0)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_POPULATEVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A26D1A0)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_POPULATEVECTOR4_OFFSET UNITYSDK_OFFSET(0x1A26D2D0)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A26CF80)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_SET_ENABLEVECTOR2_OFFSET UNITYSDK_OFFSET(0x1A26C640)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_SET_ENABLEVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A26C660)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_SET_ENABLEVECTOR4_OFFSET UNITYSDK_OFFSET(0x1A26C680)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A26C6A0)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER_WRITEVECTOR_OFFSET UNITYSDK_OFFSET(0x1A26CA30)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A26D640)
#define NEWTONSOFT_JSON_CONVERTERS_VECTORCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26C690)
...
namespace Newtonsoft::Json::Converters
{
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(VectorConverter_TypeDefinitionIndex)->GetStaticField(0x34F50);
		}
		static ::System::Type** StaticGet_V4()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(VectorConverter_TypeDefinitionIndex)->GetStaticField(0x34F58);
		}
		static ::System::Type** StaticGet_V2()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(VectorConverter_TypeDefinitionIndex)->GetStaticField(0x34F60);
		}
