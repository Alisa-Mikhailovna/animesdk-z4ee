...
#define NEWTONSOFT_JSON_CONVERTERS_XDOCUMENTTYPEWRAPPER_GET_INTERNALSUBSET_OFFSET UNITYSDK_OFFSET(0x1A26F5B0)
#define NEWTONSOFT_JSON_CONVERTERS_XDOCUMENTTYPEWRAPPER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1A26F5D0)
#define NEWTONSOFT_JSON_CONVERTERS_XDOCUMENTTYPEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A26F550)
#define NEWTONSOFT_JSON_CONVERTERS_XDOCUMENTTYPEWRAPPER_GET_PUBLIC_OFFSET UNITYSDK_OFFSET(0x1A26F590)
#define NEWTONSOFT_JSON_CONVERTERS_XDOCUMENTTYPEWRAPPER_GET_SYSTEM_OFFSET UNITYSDK_OFFSET(0x1A26F570)
#define NEWTONSOFT_JSON_CONVERTERS_XDOCUMENTTYPEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26F240)
