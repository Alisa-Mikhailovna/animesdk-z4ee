...
#define NEWTONSOFT_JSON_CONVERTERS_XTEXTWRAPPER_GET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x1A271CA0)
#define NEWTONSOFT_JSON_CONVERTERS_XTEXTWRAPPER_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1A271BB0)
#define NEWTONSOFT_JSON_CONVERTERS_XTEXTWRAPPER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A271C20)
#define NEWTONSOFT_JSON_CONVERTERS_XTEXTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26F1E0)
