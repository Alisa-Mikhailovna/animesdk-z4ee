...
#define NEWTONSOFT_JSON_CONVERTERS_JAVASCRIPTDATETIMECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A268C30)
#define NEWTONSOFT_JSON_CONVERTERS_JAVASCRIPTDATETIMECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A268800)
#define NEWTONSOFT_JSON_CONVERTERS_JAVASCRIPTDATETIMECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A269470)
