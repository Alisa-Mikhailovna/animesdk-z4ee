...
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_APPENDCHILD_OFFSET UNITYSDK_OFFSET(0x1A271980)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A271950)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_CHILDNODES_OFFSET UNITYSDK_OFFSET(0x1A2718F0)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1A2718E0)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1A2719D0)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A271850)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x1A271960)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A271970)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER_GET_WRAPPEDNODE_OFFSET UNITYSDK_OFFSET(0x1A271840)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2719E0)
#define NEWTONSOFT_JSON_CONVERTERS_XOBJECTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26DD50)
...
namespace Newtonsoft::Json::Converters
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>**)Il2CppClass::FromTypeDefinitionIndex(XObjectWrapper_TypeDefinitionIndex)->GetStaticField(0x35090);
		}
