...
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_APPENDCHILD_OFFSET UNITYSDK_OFFSET(0x1A2824D0)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A281BD0)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_GET_CHILDNODES_OFFSET UNITYSDK_OFFSET(0x1A2815C0)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1A281530)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1A2825F0)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A2814A0)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_GET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x1A282310)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A282440)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_GET_WRAPPEDNODE_OFFSET UNITYSDK_OFFSET(0x1A281490)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A272890)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER_WRAPNODE_OFFSET UNITYSDK_OFFSET(0x1A276EB0)
#define NEWTONSOFT_JSON_CONVERTERS_XMLNODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A271E90)
