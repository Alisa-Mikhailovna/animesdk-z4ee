...
#define NEWTONSOFT_JSON_CONVERTERS_VERSIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A26DC30)
#define NEWTONSOFT_JSON_CONVERTERS_VERSIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A26D8F0)
#define NEWTONSOFT_JSON_CONVERTERS_VERSIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A26D6E0)
#define NEWTONSOFT_JSON_CONVERTERS_VERSIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26DC70)
