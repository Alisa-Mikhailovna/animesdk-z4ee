...
#define NEWTONSOFT_JSON_CONVERTERS_XDECLARATIONWRAPPER_GET_DECLARATION_OFFSET UNITYSDK_OFFSET(0x1A26F460)
#define NEWTONSOFT_JSON_CONVERTERS_XDECLARATIONWRAPPER_GET_ENCODING_OFFSET UNITYSDK_OFFSET(0x1A26F510)
#define NEWTONSOFT_JSON_CONVERTERS_XDECLARATIONWRAPPER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A26F4E0)
#define NEWTONSOFT_JSON_CONVERTERS_XDECLARATIONWRAPPER_GET_STANDALONE_OFFSET UNITYSDK_OFFSET(0x1A26F530)
#define NEWTONSOFT_JSON_CONVERTERS_XDECLARATIONWRAPPER_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A26F4F0)
#define NEWTONSOFT_JSON_CONVERTERS_XDECLARATIONWRAPPER_SET_DECLARATION_OFFSET UNITYSDK_OFFSET(0x1A26F470)
#define NEWTONSOFT_JSON_CONVERTERS_XDECLARATIONWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26F480)
