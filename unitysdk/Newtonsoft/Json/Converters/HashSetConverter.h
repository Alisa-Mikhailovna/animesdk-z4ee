...
#define NEWTONSOFT_JSON_CONVERTERS_HASHSETCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A267790)
#define NEWTONSOFT_JSON_CONVERTERS_HASHSETCONVERTER_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1A2678C0)
#define NEWTONSOFT_JSON_CONVERTERS_HASHSETCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A2670D0)
#define NEWTONSOFT_JSON_CONVERTERS_HASHSETCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A2670C0)
#define NEWTONSOFT_JSON_CONVERTERS_HASHSETCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2678D0)
