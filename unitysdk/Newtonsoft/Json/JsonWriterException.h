...
#define NEWTONSOFT_JSON_JSONWRITEREXCEPTION_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1A29F810)
#define NEWTONSOFT_JSON_JSONWRITEREXCEPTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1A2659B0)
#define NEWTONSOFT_JSON_JSONWRITEREXCEPTION_SET_PATH_OFFSET UNITYSDK_OFFSET(0x1A29F6D0)
#define NEWTONSOFT_JSON_JSONWRITEREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A29F740)
#define NEWTONSOFT_JSON_JSONWRITEREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A29F790)
#define NEWTONSOFT_JSON_JSONWRITEREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A29F6E0)
