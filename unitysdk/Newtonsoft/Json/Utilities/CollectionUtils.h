...
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_COPYFROMJAGGEDTOMULTIDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1A2F21E0)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_GETDIMENSIONS_OFFSET UNITYSDK_OFFSET(0x1A2F1C10)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_ISDICTIONARYTYPE_OFFSET UNITYSDK_OFFSET(0x1A2C69E0)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_JAGGEDARRAYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1A2F2580)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_RESOLVEENUMERABLECOLLECTIONCONSTRUCTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2CE480)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_RESOLVEENUMERABLECOLLECTIONCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A2CBC30)
#define NEWTONSOFT_JSON_UTILITIES_COLLECTIONUTILS_TOMULTIDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1A2DC100)
