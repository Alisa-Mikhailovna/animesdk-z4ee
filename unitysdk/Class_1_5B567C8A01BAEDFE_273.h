...
#define CLASS_1_5B567C8A01BAEDFE_273_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BFE7E90)
#define CLASS_1_5B567C8A01BAEDFE_273_CLONE_OFFSET UNITYSDK_OFFSET(0x1BFE7B80)
#define CLASS_1_5B567C8A01BAEDFE_273_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BFE7C90)
#define CLASS_1_5B567C8A01BAEDFE_273_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BFE7BC0)
#define CLASS_1_5B567C8A01BAEDFE_273_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BFE7DF0)
#define CLASS_1_5B567C8A01BAEDFE_273_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BFE7EE0)
#define CLASS_1_5B567C8A01BAEDFE_273_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BFE7EB0)
#define CLASS_1_5B567C8A01BAEDFE_273_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BFE7B00)
#define CLASS_1_5B567C8A01BAEDFE_273_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BFE7B30)
#define CLASS_1_5B567C8A01BAEDFE_273_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BFE7E20)
#define CLASS_1_5B567C8A01BAEDFE_273_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BFE7E80)
#define CLASS_1_5B567C8A01BAEDFE_273__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFE7F30)
#define CLASS_1_5B567C8A01BAEDFE_273__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BFE7B50)
#define CLASS_1_5B567C8A01BAEDFE_273__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFE7B40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_273*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_273_TypeDefinitionIndex)->GetStaticField(0x65330);
	}
