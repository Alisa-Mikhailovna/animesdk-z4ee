...
#define CLASS_1_B343FAFD80A8B29B_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB710E30)
#define CLASS_1_B343FAFD80A8B29B_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0xB72E260)
#define CLASS_1_B343FAFD80A8B29B_GET_AIMIDENTIFYTYPE_OFFSET UNITYSDK_OFFSET(0xB72E280)
#define CLASS_1_B343FAFD80A8B29B_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB72E1E0)
#define CLASS_1_B343FAFD80A8B29B_GET_CURRENTSHOWTIPPRIORITY_OFFSET UNITYSDK_OFFSET(0xB72E2C0)
#define CLASS_1_B343FAFD80A8B29B_GET_CURRENTSHOWTIP_OFFSET UNITYSDK_OFFSET(0xB72E2A0)
#define CLASS_1_B343FAFD80A8B29B_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xB72E220)
#define CLASS_1_B343FAFD80A8B29B_GET_OWNERPROP_OFFSET UNITYSDK_OFFSET(0xB72E200)
#define CLASS_1_B343FAFD80A8B29B_GET_TRIGGERINRANGECOUNT_OFFSET UNITYSDK_OFFSET(0xB72E240)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0xB72C8F0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_02BE02AD3B7ABEC5_OFFSET UNITYSDK_OFFSET(0xB713410)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_0749CA3EDD9F2FCF_OFFSET UNITYSDK_OFFSET(0xB72E300)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_0BADA5371EFDD926_OFFSET UNITYSDK_OFFSET(0xB72D1E0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_1AD3CAF2B0982C3F_OFFSET UNITYSDK_OFFSET(0xB711A60)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0xB72B670)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xB72B610)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0xB72C870)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_30D1209326FA87FC_1_OFFSET UNITYSDK_OFFSET(0xB72C630)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xB7129E0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_373DDB49638AF10B_OFFSET UNITYSDK_OFFSET(0xB72C310)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_38E8C87591F8D4AA_OFFSET UNITYSDK_OFFSET(0xB7147E0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_3BB27E09543D8ACB_OFFSET UNITYSDK_OFFSET(0xB72B7E0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_40104F54A27D0FFA_OFFSET UNITYSDK_OFFSET(0xB72C040)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB72B450)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_4406EE3EAE9FBD6F_OFFSET UNITYSDK_OFFSET(0xB72B540)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_467DE64208B0A974_OFFSET UNITYSDK_OFFSET(0xB715380)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_496B9E6FB3AA58C4_OFFSET UNITYSDK_OFFSET(0xB72C460)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_49765F1E3835BA67_OFFSET UNITYSDK_OFFSET(0xB72CBE0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_51FF09EBE6593DAC_OFFSET UNITYSDK_OFFSET(0xB72BB70)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_5F08B426ADF31FF5_OFFSET UNITYSDK_OFFSET(0xB72A8A0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_73D4532F584D7FC2_OFFSET UNITYSDK_OFFSET(0xB72C3C0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_75A528A09123ED2F_OFFSET UNITYSDK_OFFSET(0xB7125C0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_7646FFE662147970_1_OFFSET UNITYSDK_OFFSET(0xB72E190)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xB72ADB0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_795059A0162B7B8D_OFFSET UNITYSDK_OFFSET(0xB72CD40)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xB72CF50)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_7FF1F5DCD746CB3B_OFFSET UNITYSDK_OFFSET(0xB72AE50)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xB72DC10)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0xB72B1A0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_8C0D3F14EE7D5F69_OFFSET UNITYSDK_OFFSET(0xB72DE30)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_8F2240B3DCAE3C2C_OFFSET UNITYSDK_OFFSET(0xB72B360)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xB72D160)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_A08F498172E0B379_OFFSET UNITYSDK_OFFSET(0xB72E2F0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_AB0E32D900C7A89E_OFFSET UNITYSDK_OFFSET(0xB72A170)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_AB1A8DFD378DB0BE_OFFSET UNITYSDK_OFFSET(0xB72C720)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_AF8EA4CBC3E2C963_OFFSET UNITYSDK_OFFSET(0xB72B4A0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xB72E0D0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_B493AAE223D9B30F_OFFSET UNITYSDK_OFFSET(0xB714D00)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_C348049DE90BD88C_OFFSET UNITYSDK_OFFSET(0xB72C4C0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0xB72E2E0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_C98BEB16ED641BC0_OFFSET UNITYSDK_OFFSET(0xB72B6D0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB714310)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_E631B63295647DB5_OFFSET UNITYSDK_OFFSET(0xB714490)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_E8A165BEBD75409B_OFFSET UNITYSDK_OFFSET(0xB72D4B0)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_EAC2737A96E071C9_OFFSET UNITYSDK_OFFSET(0xB72B750)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_F620DD2FD48DDF53_OFFSET UNITYSDK_OFFSET(0xB72CB40)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_FC1860485A3F1976_OFFSET UNITYSDK_OFFSET(0xB714610)
#define CLASS_1_B343FAFD80A8B29B_METHOD_1_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0xB72CAB0)
#define CLASS_1_B343FAFD80A8B29B_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0xB72E270)
#define CLASS_1_B343FAFD80A8B29B_SET_AIMIDENTIFYTYPE_OFFSET UNITYSDK_OFFSET(0xB72E290)
#define CLASS_1_B343FAFD80A8B29B_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB72E1F0)
#define CLASS_1_B343FAFD80A8B29B_SET_CURRENTSHOWTIPPRIORITY_OFFSET UNITYSDK_OFFSET(0xB72E2D0)
#define CLASS_1_B343FAFD80A8B29B_SET_CURRENTSHOWTIP_OFFSET UNITYSDK_OFFSET(0xB72E2B0)
#define CLASS_1_B343FAFD80A8B29B_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xB72E230)
#define CLASS_1_B343FAFD80A8B29B_SET_OWNERPROP_OFFSET UNITYSDK_OFFSET(0xB72E210)
#define CLASS_1_B343FAFD80A8B29B_SET_TRIGGERINRANGECOUNT_OFFSET UNITYSDK_OFFSET(0xB72E250)
#define CLASS_1_B343FAFD80A8B29B_TICK_OFFSET UNITYSDK_OFFSET(0xB711340)
#define CLASS_1_B343FAFD80A8B29B__CCTOR_OFFSET UNITYSDK_OFFSET(0xB72E350)
#define CLASS_1_B343FAFD80A8B29B__CTOR_OFFSET UNITYSDK_OFFSET(0xB714D50)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B343FAFD80A8B29B_TypeDefinitionIndex)->GetStaticField(0x9AD0);
	}
	static ::System::Int32* StaticGet_Field_1_1()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B343FAFD80A8B29B_TypeDefinitionIndex)->GetStaticField(0x3B70);
	}
	// static const ::System::Single Field_1_2; // 0x0
	// static const ::System::String* Field_1_3; // 0x0
	::RPG::GameCore::BindSwitchPhotoGraphFuncBtn* _Config_k__BackingField; // 0x10
	::RPG::GameCore::ShowMainPageHint* Field_1_5; // 0x18
	::RPG::GameCore::PhotoGraphOverrideModeConfig* Field_1_6; // 0x20
	::Class_2_6C1010345A89A766* Field_1_7; // 0x28
	::Il2CppArray<::Class_1_2A2B2DC1DA1205FE*>* Field_1_8; // 0x30
	::Il2CppArray<::System::String*>* Field_1_9; // 0x38
	::System::Collections::Generic::List_1<::RPG::GameCore::PhotoGraphFindNpc*>* Field_1_10; // 0x40
	::RPG::GameCore::PropComponent* _OwnerProp_k__BackingField; // 0x48
	::Class_1_BCD7402D15D7184C* Field_1_12; // 0x50
	::Class_3_07C3C4D2990C49EE* Field_1_13; // 0x58
	::RPG::Client::PhotoGraphResultConditionPack* Field_1_14; // 0x60
	::UnityEngine::Coroutine* Field_1_15; // 0x68
	::Class_1_F3391C70DC37088D* Field_1_16; // 0x70
	::System::String* Field_1_17; // 0x78
	::Class_1_D50913C0AC7A262A* Field_1_18; // 0x80
	::Class_1_F3391C70DC37088D* Field_1_19; // 0x88
	::UnityEngine::Coroutine* Field_1_20; // 0x90
	::RPG::GameCore::TaskContext* Field_1_21; // 0x98
	::Class_3_07C3C4D2990C49EE* Field_1_22; // 0xA0
	::RPG::GameCore::GameEntity* _OwnerEntity_k__BackingField; // 0xA8
	::Class_1_F3391C70DC37088D* Field_1_24; // 0xB0
	::RPG::GameCore::PhotoGraphModeExtraConfigSetting* Field_1_25; // 0xB8
	...
	::RPG::Client::TextID Field_1_29; // 0xD0
	::System::Single Field_1_30; // 0xE0
	::RPG::GameCore::PhotoGraphFovLevel Field_1_31; // 0xE4
	::RPG::GameCore::PhotoGraphFuncBtnType Field_1_32; // 0xE8
	::System::Single Field_1_33; // 0xEC
	::RPG::Client::TextID Field_1_34; // 0xF0
	::System::Int32 _TriggerInRangeCount_k__BackingField; // 0x100
	::System::Int32 _CurrentShowTipPriority_k__BackingField; // 0x104
	::System::Int32 Field_1_37; // 0x108
	::System::Single Field_1_38; // 0x10C
	::RPG::Client::TextID _CurrentShowTip_k__BackingField; // 0x110
	::System::Boolean Field_1_40; // 0x120
	::System::Boolean Field_1_41; // 0x121
	::System::Boolean _Active_k__BackingField; // 0x122
	::System::Boolean Field_1_43; // 0x123
	::System::Boolean Field_1_44; // 0x124
	::System::Boolean Field_1_45; // 0x125
	::System::Boolean Field_1_46; // 0x126
	::System::Boolean Field_1_47; // 0x127
	::System::Boolean Field_1_48; // 0x128
	::System::Boolean Field_1_49; // 0x129
	::System::Boolean Field_1_50; // 0x12A
	::System::Boolean Field_1_51; // 0x12B
	::System::Int32 Field_1_52; // 0x12C
	::System::Single Field_1_53; // 0x130
	::System::Single Field_1_54; // 0x134
