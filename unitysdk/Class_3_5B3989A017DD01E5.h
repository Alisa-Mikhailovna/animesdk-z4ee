...
#define CLASS_3_5B3989A017DD01E5__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4213B0)
...
{
public:
	::Class_1_47EB23CB5C4B2615_2* Field_3_0; // 0x28
	::Class_1_877AA22B04AFB81F_1* Field_3_1; // 0x30
	::System::UInt32 Field_3_2; // 0x38
	::System::Boolean Field_3_3; // 0x3C
	::RPG::LittleGameShare::DiceCombatCore::GameMode::DiceCombatGameMode Field_3_4; // 0x3D
