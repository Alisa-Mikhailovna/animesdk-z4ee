...
#define CLASS_2_F7B4A5A8B2B0CB0D_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A78BAE0)
#define CLASS_2_F7B4A5A8B2B0CB0D_FILTER_OFFSET UNITYSDK_OFFSET(0x1A78B9E0)
#define CLASS_2_F7B4A5A8B2B0CB0D_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A78B8C0)
#define CLASS_2_F7B4A5A8B2B0CB0D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A78B840)
