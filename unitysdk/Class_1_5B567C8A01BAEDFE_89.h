...
#define CLASS_1_5B567C8A01BAEDFE_89_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C76EAE0)
#define CLASS_1_5B567C8A01BAEDFE_89_CLONE_OFFSET UNITYSDK_OFFSET(0x1C76E780)
#define CLASS_1_5B567C8A01BAEDFE_89_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C76E8E0)
#define CLASS_1_5B567C8A01BAEDFE_89_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C76E7F0)
#define CLASS_1_5B567C8A01BAEDFE_89_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C76EA40)
#define CLASS_1_5B567C8A01BAEDFE_89_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C76EB30)
#define CLASS_1_5B567C8A01BAEDFE_89_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C76EB00)
#define CLASS_1_5B567C8A01BAEDFE_89_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C76E6D0)
#define CLASS_1_5B567C8A01BAEDFE_89_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C76E730)
#define CLASS_1_5B567C8A01BAEDFE_89_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C76EA70)
#define CLASS_1_5B567C8A01BAEDFE_89_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C76EAD0)
#define CLASS_1_5B567C8A01BAEDFE_89__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C76EB80)
#define CLASS_1_5B567C8A01BAEDFE_89__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C76E750)
#define CLASS_1_5B567C8A01BAEDFE_89__CTOR_OFFSET UNITYSDK_OFFSET(0x1C76E740)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_89*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_89_TypeDefinitionIndex)->GetStaticField(0x10600);
	}
