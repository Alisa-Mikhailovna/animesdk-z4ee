...
#define AKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x1D1BCB80)
#define AKEVENT_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x1D1BCE10)
#define AKEVENT_GET_M_CALLBACKDATA_OFFSET UNITYSDK_OFFSET(0x1D1BCFB0)
#define AKEVENT_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1D1BCE70)
#define AKEVENT_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1D1BCB30)
#define AKEVENT_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1D19E640)
#define AKEVENT_START_OFFSET UNITYSDK_OFFSET(0x1D19DC20)
#define AKEVENT_STOP_1_OFFSET UNITYSDK_OFFSET(0x1D1BCDA0)
#define AKEVENT_STOP_OFFSET UNITYSDK_OFFSET(0x1D1BCCF0)
#define AKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19EE00)
