...
#define CLASS_1_C67F599303150E7F_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x14B6C380)
#define CLASS_1_C67F599303150E7F_GET_HASKEYDOWN_OFFSET UNITYSDK_OFFSET(0x14B6C2C0)
#define CLASS_1_C67F599303150E7F_GET_HASKEYUP_OFFSET UNITYSDK_OFFSET(0x14B6C2E0)
#define CLASS_1_C67F599303150E7F_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x14B6C280)
#define CLASS_1_C67F599303150E7F_GET_INPUTTYPE_OFFSET UNITYSDK_OFFSET(0x14B6C3C0)
#define CLASS_1_C67F599303150E7F_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x14B6C2A0)
#define CLASS_1_C67F599303150E7F_GET_KEYDOWNRESULT_OFFSET UNITYSDK_OFFSET(0x14B6C300)
#define CLASS_1_C67F599303150E7F_GET_KEYUPRESULT_OFFSET UNITYSDK_OFFSET(0x14B6C320)
#define CLASS_1_C67F599303150E7F_GET_NOTETYPE_OFFSET UNITYSDK_OFFSET(0x14B6C3A0)
#define CLASS_1_C67F599303150E7F_GET_OWNERGROUP_OFFSET UNITYSDK_OFFSET(0x14B6C340)
#define CLASS_1_C67F599303150E7F_GET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x14B6C3E0)
#define CLASS_1_C67F599303150E7F_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x14B6C360)
#define CLASS_1_C67F599303150E7F_METHOD_1_4DF98D928623DEE3_OFFSET UNITYSDK_OFFSET(0x14B6AB70)
#define CLASS_1_C67F599303150E7F_METHOD_1_4E140453C4B32F06_OFFSET UNITYSDK_OFFSET(0x14B6BB00)
#define CLASS_1_C67F599303150E7F_METHOD_1_A9E21AEFB7D4CB48_1_OFFSET UNITYSDK_OFFSET(0x14B6C020)
#define CLASS_1_C67F599303150E7F_METHOD_1_A9E21AEFB7D4CB48_OFFSET UNITYSDK_OFFSET(0x14B6BA50)
#define CLASS_1_C67F599303150E7F_METHOD_1_AAFE8DC44E675A0C_OFFSET UNITYSDK_OFFSET(0x14B6BBE0)
#define CLASS_1_C67F599303150E7F_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x14B6BBA0)
#define CLASS_1_C67F599303150E7F_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14B6BB60)
#define CLASS_1_C67F599303150E7F_METHOD_1_EBB9073DE8DED836_OFFSET UNITYSDK_OFFSET(0x14B6BDF0)
#define CLASS_1_C67F599303150E7F_METHOD_1_F0283A02CC8B6229_OFFSET UNITYSDK_OFFSET(0x14B6B050)
#define CLASS_1_C67F599303150E7F_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x14B6C200)
#define CLASS_1_C67F599303150E7F_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x14B6C390)
#define CLASS_1_C67F599303150E7F_SET_HASKEYDOWN_OFFSET UNITYSDK_OFFSET(0x14B6C2D0)
#define CLASS_1_C67F599303150E7F_SET_HASKEYUP_OFFSET UNITYSDK_OFFSET(0x14B6C2F0)
#define CLASS_1_C67F599303150E7F_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x14B6C290)
#define CLASS_1_C67F599303150E7F_SET_INPUTTYPE_OFFSET UNITYSDK_OFFSET(0x14B6C3D0)
#define CLASS_1_C67F599303150E7F_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x14B6C2B0)
#define CLASS_1_C67F599303150E7F_SET_KEYDOWNRESULT_OFFSET UNITYSDK_OFFSET(0x14B6C310)
#define CLASS_1_C67F599303150E7F_SET_KEYUPRESULT_OFFSET UNITYSDK_OFFSET(0x14B6C330)
#define CLASS_1_C67F599303150E7F_SET_NOTETYPE_OFFSET UNITYSDK_OFFSET(0x14B6C3B0)
#define CLASS_1_C67F599303150E7F_SET_OWNERGROUP_OFFSET UNITYSDK_OFFSET(0x14B6C350)
#define CLASS_1_C67F599303150E7F_SET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x14B6C3F0)
#define CLASS_1_C67F599303150E7F_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x14B6C370)
#define CLASS_1_C67F599303150E7F__CTOR_OFFSET UNITYSDK_OFFSET(0x14B69D80)
...
public:
	...
	::Class_1_3F51724BA2A18D7F* _OwnerGroup_k__BackingField; // 0x48
	...
	::System::Boolean _HasKeyUp_k__BackingField; // 0x60
	::System::Boolean Field_1_11; // 0x61
	::System::Boolean _HasKeyDown_k__BackingField; // 0x62
	::System::Boolean _IsActive_k__BackingField; // 0x63
	::System::Single _EndTime_k__BackingField; // 0x64
	::System::Single _PressTime_k__BackingField; // 0x68
	...
	::RPG::GameCore::InputNoteType _InputType_k__BackingField; // 0x78
