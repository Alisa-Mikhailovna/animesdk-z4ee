...
#define MARBLESUBSEALROTATOR_CLEAR_OFFSET UNITYSDK_OFFSET(0xB1E8930)
#define MARBLESUBSEALROTATOR_INIT_OFFSET UNITYSDK_OFFSET(0xB1E8180)
#define MARBLESUBSEALROTATOR_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0xB1E8320)
#define MARBLESUBSEALROTATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB1E8A50)
#define MARBLESUBSEALROTATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB1E8A00)
#define MARBLESUBSEALROTATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xB1E8980)
#define MARBLESUBSEALROTATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB1E8AA0)
