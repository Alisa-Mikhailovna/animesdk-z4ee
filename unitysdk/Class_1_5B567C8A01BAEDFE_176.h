...
#define CLASS_1_5B567C8A01BAEDFE_176_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C1A2F10)
#define CLASS_1_5B567C8A01BAEDFE_176_CLONE_OFFSET UNITYSDK_OFFSET(0x1C1A2C00)
#define CLASS_1_5B567C8A01BAEDFE_176_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C1A2D10)
#define CLASS_1_5B567C8A01BAEDFE_176_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C1A2C40)
#define CLASS_1_5B567C8A01BAEDFE_176_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C1A2E70)
#define CLASS_1_5B567C8A01BAEDFE_176_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C1A2F60)
#define CLASS_1_5B567C8A01BAEDFE_176_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C1A2F30)
#define CLASS_1_5B567C8A01BAEDFE_176_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C1A2B80)
#define CLASS_1_5B567C8A01BAEDFE_176_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C1A2BB0)
#define CLASS_1_5B567C8A01BAEDFE_176_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C1A2EA0)
#define CLASS_1_5B567C8A01BAEDFE_176_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C1A2F00)
#define CLASS_1_5B567C8A01BAEDFE_176__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1A2FB0)
#define CLASS_1_5B567C8A01BAEDFE_176__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C1A2BD0)
#define CLASS_1_5B567C8A01BAEDFE_176__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1A2BC0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_176*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_176_TypeDefinitionIndex)->GetStaticField(0x24BF0);
	}
