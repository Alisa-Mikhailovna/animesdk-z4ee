...
#define CLASS_2_5C5883DEEE5E96DD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB0D5A60)
#define CLASS_2_5C5883DEEE5E96DD_METHOD_2_50DAA2D68A6C09FD_OFFSET UNITYSDK_OFFSET(0xB0D66A0)
#define CLASS_2_5C5883DEEE5E96DD_METHOD_2_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xB0D6180)
#define CLASS_2_5C5883DEEE5E96DD_METHOD_2_CA44EFE57CEE5AB8_OFFSET UNITYSDK_OFFSET(0xB0D6360)
#define CLASS_2_5C5883DEEE5E96DD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB0D5C00)
#define CLASS_2_5C5883DEEE5E96DD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB0D6860)
#define CLASS_2_5C5883DEEE5E96DD_TICK_OFFSET UNITYSDK_OFFSET(0xB0D6790)
#define CLASS_2_5C5883DEEE5E96DD__CTOR_OFFSET UNITYSDK_OFFSET(0xB0D5A50)
