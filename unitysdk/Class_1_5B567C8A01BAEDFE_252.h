...
#define CLASS_1_5B567C8A01BAEDFE_252_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C12CB40)
#define CLASS_1_5B567C8A01BAEDFE_252_CLONE_OFFSET UNITYSDK_OFFSET(0x1C12C7E0)
#define CLASS_1_5B567C8A01BAEDFE_252_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C12C940)
#define CLASS_1_5B567C8A01BAEDFE_252_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C12C850)
#define CLASS_1_5B567C8A01BAEDFE_252_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C12CAA0)
#define CLASS_1_5B567C8A01BAEDFE_252_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C12CB90)
#define CLASS_1_5B567C8A01BAEDFE_252_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C12CB60)
#define CLASS_1_5B567C8A01BAEDFE_252_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C12C730)
#define CLASS_1_5B567C8A01BAEDFE_252_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C12C790)
#define CLASS_1_5B567C8A01BAEDFE_252_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C12CAD0)
#define CLASS_1_5B567C8A01BAEDFE_252_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C12CB30)
#define CLASS_1_5B567C8A01BAEDFE_252__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C12CBE0)
#define CLASS_1_5B567C8A01BAEDFE_252__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C12C7B0)
#define CLASS_1_5B567C8A01BAEDFE_252__CTOR_OFFSET UNITYSDK_OFFSET(0x1C12C7A0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_252*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_252_TypeDefinitionIndex)->GetStaticField(0x1B120);
	}
