...
#define CLASS_1_F1011C1DB6F9F51A_GET_FILLEDCOUNT_OFFSET UNITYSDK_OFFSET(0x143E89D0)
#define CLASS_1_F1011C1DB6F9F51A_GET_MAXCASTCOUNT_OFFSET UNITYSDK_OFFSET(0x143E89B0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_0DF420E95D6252BE_OFFSET UNITYSDK_OFFSET(0x143E7500)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x143E77A0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x143E8AB0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0x143E84E0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_37011B6DDBE4CF26_OFFSET UNITYSDK_OFFSET(0x143E7670)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x143E89F0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_3B7145E79424FB75_OFFSET UNITYSDK_OFFSET(0x143E7100)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_420F5543CED5025E_OFFSET UNITYSDK_OFFSET(0x143E7FE0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x143E7080)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x143E81B0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_4F8C91A8E36C9915_OFFSET UNITYSDK_OFFSET(0x143E8240)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_565211B377738E7A_OFFSET UNITYSDK_OFFSET(0x143E6D90)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_648916894895FB4D_OFFSET UNITYSDK_OFFSET(0x143E8120)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_6A99795238E657E2_OFFSET UNITYSDK_OFFSET(0x143E7A10)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_945C71A133E8FA09_OFFSET UNITYSDK_OFFSET(0x143E7810)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_95BFADB170F8A42D_OFFSET UNITYSDK_OFFSET(0x143E8400)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x143E8A40)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_A8C8FFA164F2128F_OFFSET UNITYSDK_OFFSET(0x143E7620)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_AFA2B05CEDE590D4_OFFSET UNITYSDK_OFFSET(0x143E7BF0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_CDB67F8643E189E2_OFFSET UNITYSDK_OFFSET(0x143E7E60)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_CE025011FFADCC65_OFFSET UNITYSDK_OFFSET(0x143E8540)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_DF051B4CCEC70F95_OFFSET UNITYSDK_OFFSET(0x143E6E40)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x143E74B0)
#define CLASS_1_F1011C1DB6F9F51A_SET_FILLEDCOUNT_OFFSET UNITYSDK_OFFSET(0x143E89E0)
#define CLASS_1_F1011C1DB6F9F51A_SET_MAXCASTCOUNT_OFFSET UNITYSDK_OFFSET(0x143E89C0)
#define CLASS_1_F1011C1DB6F9F51A__CTOR_OFFSET UNITYSDK_OFFSET(0x143E6E30)

inline static constexpr unsigned int Class_1_F1011C1DB6F9F51A_TypeDefinitionIndex = 68606;
...
public:
	...
	::RPG::GameCore::BattleInstance* Field_1_2; // 0x18
	::Class_1_B803CA670C4DC569* Field_1_3; // 0x20
	::RPG::GameCore::SkillData* Field_1_4; // 0x28
	::RPG::GameCore::GameEntity* Field_1_5; // 0x30
	::System::Boolean Field_1_6; // 0x38
	::System::Int32 _FilledCount_k__BackingField; // 0x3C
	::RPG::Client::TextID Field_1_8; // 0x40
	::System::Int32 _MaxCastCount_k__BackingField; // 0x50
	::RPG::Client::UISkillIndex Field_1_10; // 0x54
	::System::Nullable_1<::System::Int32> Field_1_11; // 0x58
