...
#define CLASS_1_38EDFE5CA7B8A5B6_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C5ECE80)
#define CLASS_1_38EDFE5CA7B8A5B6_CLONE_OFFSET UNITYSDK_OFFSET(0x1C5EC980)
#define CLASS_1_38EDFE5CA7B8A5B6_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C5ECB10)
#define CLASS_1_38EDFE5CA7B8A5B6_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C5ECA80)
#define CLASS_1_38EDFE5CA7B8A5B6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C5ECC00)
#define CLASS_1_38EDFE5CA7B8A5B6_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C5ED0C0)
#define CLASS_1_38EDFE5CA7B8A5B6_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C5ED070)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C5ECA40)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C5ECA00)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1C5ECA30)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C5EC8B0)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C5ECA50)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C5ECA10)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1C5ECA70)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1C5ECA20)
#define CLASS_1_38EDFE5CA7B8A5B6_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1C5ECA60)
#define CLASS_1_38EDFE5CA7B8A5B6_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C5EC910)
#define CLASS_1_38EDFE5CA7B8A5B6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C5ECC50)
#define CLASS_1_38EDFE5CA7B8A5B6_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C5ECCB0)
#define CLASS_1_38EDFE5CA7B8A5B6__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5ED170)
#define CLASS_1_38EDFE5CA7B8A5B6__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C5EC930)
#define CLASS_1_38EDFE5CA7B8A5B6__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5EC920)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_38EDFE5CA7B8A5B6*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_38EDFE5CA7B8A5B6_TypeDefinitionIndex)->GetStaticField(0x62340);
	}
