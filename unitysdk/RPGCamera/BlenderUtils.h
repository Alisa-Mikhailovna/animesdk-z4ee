...
#define RPGCAMERA_BLENDERUTILS_LERPPOS_OFFSET UNITYSDK_OFFSET(0xAB94ED0)
#define RPGCAMERA_BLENDERUTILS_LERPRADIUS_OFFSET UNITYSDK_OFFSET(0xAB94490)
#define RPGCAMERA_BLENDERUTILS_LERPSPHERICAL_OFFSET UNITYSDK_OFFSET(0xAB94570)
#define RPGCAMERA_BLENDERUTILS_LERPSPH_OFFSET UNITYSDK_OFFSET(0xAB946A0)
#define RPGCAMERA_BLENDERUTILS_LERPVECTOR3_OFFSET UNITYSDK_OFFSET(0xAB943C0)
