...
#define ENTITAS_ENTITYCOMPONENTREPLACED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x157AAE80)
#define ENTITAS_ENTITYCOMPONENTREPLACED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x157AAF00)
#define ENTITAS_ENTITYCOMPONENTREPLACED_INVOKE_OFFSET UNITYSDK_OFFSET(0x157A9CA0)
#define ENTITAS_ENTITYCOMPONENTREPLACED__CTOR_OFFSET UNITYSDK_OFFSET(0x157AAD90)
