...
#define ENTITAS_VISUALDEBUGGING_UNITY_DEBUGSYSTEMSBEHAVIOUR_GET_SYSTEMS_OFFSET UNITYSDK_OFFSET(0x157B1050)
#define ENTITAS_VISUALDEBUGGING_UNITY_DEBUGSYSTEMSBEHAVIOUR_INIT_OFFSET UNITYSDK_OFFSET(0x157B1060)
#define ENTITAS_VISUALDEBUGGING_UNITY_DEBUGSYSTEMSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x157B1070)
