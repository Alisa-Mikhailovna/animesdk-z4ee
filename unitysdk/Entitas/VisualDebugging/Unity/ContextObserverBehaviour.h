...
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR_GET_CONTEXTOBSERVER_OFFSET UNITYSDK_OFFSET(0x157AE900)
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR_INIT_OFFSET UNITYSDK_OFFSET(0x157AD940)
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x157AE9E0)
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x157AE910)
#define ENTITAS_VISUALDEBUGGING_UNITY_CONTEXTOBSERVERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x157AEA70)
