...
#define ENTITAS_ENTITYCOMPONENTCHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x157AAD10)
#define ENTITAS_ENTITYCOMPONENTCHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x157AAD80)
#define ENTITAS_ENTITYCOMPONENTCHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x157A9590)
#define ENTITAS_ENTITYCOMPONENTCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x157AAC20)
