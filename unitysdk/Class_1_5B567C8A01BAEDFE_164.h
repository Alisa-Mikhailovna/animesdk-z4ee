...
#define CLASS_1_5B567C8A01BAEDFE_164_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C64FCC0)
#define CLASS_1_5B567C8A01BAEDFE_164_CLONE_OFFSET UNITYSDK_OFFSET(0x1C64F960)
#define CLASS_1_5B567C8A01BAEDFE_164_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C64FAC0)
#define CLASS_1_5B567C8A01BAEDFE_164_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C64F9D0)
#define CLASS_1_5B567C8A01BAEDFE_164_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C64FC20)
#define CLASS_1_5B567C8A01BAEDFE_164_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C64FD10)
#define CLASS_1_5B567C8A01BAEDFE_164_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C64FCE0)
#define CLASS_1_5B567C8A01BAEDFE_164_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C64F8B0)
#define CLASS_1_5B567C8A01BAEDFE_164_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C64F910)
#define CLASS_1_5B567C8A01BAEDFE_164_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C64FC50)
#define CLASS_1_5B567C8A01BAEDFE_164_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C64FCB0)
#define CLASS_1_5B567C8A01BAEDFE_164__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C64FD60)
#define CLASS_1_5B567C8A01BAEDFE_164__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C64F930)
#define CLASS_1_5B567C8A01BAEDFE_164__CTOR_OFFSET UNITYSDK_OFFSET(0x1C64F920)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_164*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_164_TypeDefinitionIndex)->GetStaticField(0x65630);
	}
