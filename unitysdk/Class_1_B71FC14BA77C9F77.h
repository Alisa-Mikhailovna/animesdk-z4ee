...
#define CLASS_1_B71FC14BA77C9F77_GET_CARDCONFIG_OFFSET UNITYSDK_OFFSET(0xD04A700)
#define CLASS_1_B71FC14BA77C9F77_GET_CASTER_OFFSET UNITYSDK_OFFSET(0xD04A600)
#define CLASS_1_B71FC14BA77C9F77_GET_COPIEDSOURCECARD_OFFSET UNITYSDK_OFFSET(0xD04A720)
#define CLASS_1_B71FC14BA77C9F77_GET_FINALAMPLIFICATION_OFFSET UNITYSDK_OFFSET(0xD04A5A0)
#define CLASS_1_B71FC14BA77C9F77_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0xD04A580)
#define CLASS_1_B71FC14BA77C9F77_GET_ID_OFFSET UNITYSDK_OFFSET(0xD04A570)
#define CLASS_1_B71FC14BA77C9F77_GET_MANACOSTRAW_OFFSET UNITYSDK_OFFSET(0xD04A5E0)
#define CLASS_1_B71FC14BA77C9F77_GET_MANACOST_OFFSET UNITYSDK_OFFSET(0xD04A5C0)
#define CLASS_1_B71FC14BA77C9F77_GET_NEEDRELEASETARGET_OFFSET UNITYSDK_OFFSET(0xD04A640)
#define CLASS_1_B71FC14BA77C9F77_GET_RAWCASTER_OFFSET UNITYSDK_OFFSET(0xD04A620)
#define CLASS_1_B71FC14BA77C9F77_GET_UID_OFFSET UNITYSDK_OFFSET(0xD04A590)
#define CLASS_1_B71FC14BA77C9F77_METHOD_1_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xD04A6B0)
#define CLASS_1_B71FC14BA77C9F77_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD04A660)
#define CLASS_1_B71FC14BA77C9F77_SET_CARDCONFIG_OFFSET UNITYSDK_OFFSET(0xD04A710)
#define CLASS_1_B71FC14BA77C9F77_SET_CASTER_OFFSET UNITYSDK_OFFSET(0xD04A610)
#define CLASS_1_B71FC14BA77C9F77_SET_COPIEDSOURCECARD_OFFSET UNITYSDK_OFFSET(0xD04A730)
#define CLASS_1_B71FC14BA77C9F77_SET_FINALAMPLIFICATION_OFFSET UNITYSDK_OFFSET(0xD04A5B0)
#define CLASS_1_B71FC14BA77C9F77_SET_MANACOSTRAW_OFFSET UNITYSDK_OFFSET(0xD04A5F0)
#define CLASS_1_B71FC14BA77C9F77_SET_MANACOST_OFFSET UNITYSDK_OFFSET(0xD04A5D0)
#define CLASS_1_B71FC14BA77C9F77_SET_NEEDRELEASETARGET_OFFSET UNITYSDK_OFFSET(0xD04A650)
#define CLASS_1_B71FC14BA77C9F77_SET_RAWCASTER_OFFSET UNITYSDK_OFFSET(0xD04A630)
#define CLASS_1_B71FC14BA77C9F77__CTOR_OFFSET UNITYSDK_OFFSET(0xD04A500)

inline static constexpr unsigned int Class_1_B71FC14BA77C9F77_TypeDefinitionIndex = 76142;
...
public:
	...
	::RPG::Client::FateRin::Card::FateRinBattleCardIdentifier _Identifier_k__BackingField; // 0x28
	::System::Int32 _ManaCost_k__BackingField; // 0x2C
	::System::Boolean _NeedReleaseTarget_k__BackingField; // 0x30
	::RPG::GameCore::FateRinCardCasterSource _RawCaster_k__BackingField; // 0x34
	::System::UInt32 _UID_k__BackingField; // 0x38
	::System::Int32 _ManaCostRaw_k__BackingField; // 0x3C
	::RPG::GameCore::FateRinCardCasterSource _Caster_k__BackingField; // 0x40
