...
#define CLASS_1_366F8A32A4F9B4A1__FILL_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB2AA4E0)
#define CLASS_1_366F8A32A4F9B4A1__FILL_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_PEDESTRIANV2NPCEMITTER_EMITRUNTIMEINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xB2AA830)
#define CLASS_1_366F8A32A4F9B4A1__FILL_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_PEDESTRIANV2NPCEMITTER_EMITRUNTIMEINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB2AA760)
#define CLASS_1_366F8A32A4F9B4A1__FILL_D__6_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xB2AA8C0)
#define CLASS_1_366F8A32A4F9B4A1__FILL_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB2AA7D0)
#define CLASS_1_366F8A32A4F9B4A1__FILL_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB2AA780)
#define CLASS_1_366F8A32A4F9B4A1__FILL_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2AA4D0)
#define CLASS_1_366F8A32A4F9B4A1__FILL_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0xB2A8270)
...
public:
	...
	::System::Single _timePass_5__2; // 0x44
