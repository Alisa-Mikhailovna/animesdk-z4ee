...
#define CLASS_1_8911A6DB4DFF0DFE_GET_MOVEDIRECTION_OFFSET UNITYSDK_OFFSET(0xB1D0190)
#define CLASS_1_8911A6DB4DFF0DFE_SET_MOVEDIRECTION_OFFSET UNITYSDK_OFFSET(0xB1D01A0)
#define CLASS_1_8911A6DB4DFF0DFE__CTOR_OFFSET UNITYSDK_OFFSET(0xB1D01B0)
