...
#define CLASS_1_677A4866BC7A24DA_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x11FB7CC0)
#define CLASS_1_677A4866BC7A24DA_METHOD_1_9C06C768B25E4E13_OFFSET UNITYSDK_OFFSET(0x11FB7FC0)
#define CLASS_1_677A4866BC7A24DA_METHOD_1_BAD4FD950C310B05_OFFSET UNITYSDK_OFFSET(0x11FB7F60)
...
public:
	...
	{
		return (::Class_1_E012177D06C0B2FD**)Il2CppClass::FromTypeDefinitionIndex(Class_1_677A4866BC7A24DA_TypeDefinitionIndex)->GetStaticField(0xCB50);
	}
	static ::RPG::GameCore::DeviceSettingConfig** StaticGet_Field_1_1()
	{
		return (::RPG::GameCore::DeviceSettingConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_677A4866BC7A24DA_TypeDefinitionIndex)->GetStaticField(0xCB58);
	}
