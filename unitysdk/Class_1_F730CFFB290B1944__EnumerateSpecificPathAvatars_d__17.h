...
#define CLASS_1_F730CFFB290B1944__ENUMERATESPECIFICPATHAVATARS_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x14AB3AC0)
#define CLASS_1_F730CFFB290B1944__ENUMERATESPECIFICPATHAVATARS_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_AVATARSYSTEM_IAVATAR__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x14AB3CA0)
#define CLASS_1_F730CFFB290B1944__ENUMERATESPECIFICPATHAVATARS_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_AVATARSYSTEM_IAVATAR__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x14AB3C30)
#define CLASS_1_F730CFFB290B1944__ENUMERATESPECIFICPATHAVATARS_D__17_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x14AB3D00)
#define CLASS_1_F730CFFB290B1944__ENUMERATESPECIFICPATHAVATARS_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x14AB3C90)
#define CLASS_1_F730CFFB290B1944__ENUMERATESPECIFICPATHAVATARS_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x14AB3C40)
#define CLASS_1_F730CFFB290B1944__ENUMERATESPECIFICPATHAVATARS_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14AB3AA0)
#define CLASS_1_F730CFFB290B1944__ENUMERATESPECIFICPATHAVATARS_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x14AB2D00)
#define CLASS_1_F730CFFB290B1944__ENUMERATESPECIFICPATHAVATARS_D__17___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x14AB3AB0)
...
{
public:
	::System::Collections::Generic::Dictionary_2_Enumerator<::Struct_2_D645B4E0B73852B6_1, ::RPG::Client::AvatarProxy*> __7__wrap1; // 0x10
	::RPG::AvatarSystem::IAvatar* __2__current; // 0x38
	::System::Predicate_1<::RPG::AvatarSystem::IAvatar*>* predicate; // 0x40
	::System::Predicate_1<::RPG::AvatarSystem::IAvatar*>* __3__predicate; // 0x48
