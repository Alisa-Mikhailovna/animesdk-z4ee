...
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_ENUMERATETRACEGUIDSEX_OFFSET UNITYSDK_OFFSET(0x19F44D00)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTACTIVITYIDCONTROL_OFFSET UNITYSDK_OFFSET(0x19F44BD0)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTREGISTER_OFFSET UNITYSDK_OFFSET(0x19F44890)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTSETINFORMATION_OFFSET UNITYSDK_OFFSET(0x19F44C60)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTUNREGISTER_OFFSET UNITYSDK_OFFSET(0x19F44930)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTWRITETRANSFERWRAPPER_OFFSET UNITYSDK_OFFSET(0x19F449B0)
#define MICROSOFT_WIN32_UNSAFENATIVEMETHODS_MANIFESTETW_EVENTWRITETRANSFER_OFFSET UNITYSDK_OFFSET(0x19F44B10)
