...
#define CLASS_2_DBE71F2615A8B33A_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB035470)
#define CLASS_2_DBE71F2615A8B33A_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xB035C80)
#define CLASS_2_DBE71F2615A8B33A_METHOD_2_825CC99DD653DEE0_OFFSET UNITYSDK_OFFSET(0xB0357C0)
#define CLASS_2_DBE71F2615A8B33A_METHOD_2_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0xB035F10)
#define CLASS_2_DBE71F2615A8B33A_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB0354C0)
#define CLASS_2_DBE71F2615A8B33A_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB035E20)
#define CLASS_2_DBE71F2615A8B33A_TICK_OFFSET UNITYSDK_OFFSET(0xB035E80)
#define CLASS_2_DBE71F2615A8B33A__CCTOR_OFFSET UNITYSDK_OFFSET(0xB036180)
#define CLASS_2_DBE71F2615A8B33A__CTOR_OFFSET UNITYSDK_OFFSET(0xB035460)
...
public:
	...
	{
		return (::Class_1_08ACCB48C394B420**)Il2CppClass::FromTypeDefinitionIndex(Class_2_DBE71F2615A8B33A_TypeDefinitionIndex)->GetStaticField(0x645B0);
	}
	// static const ::System::Single Field_2_1; // 0x0
	::System::String* Field_2_2; // 0x18
	::RPG::Client::FiveDimGameInstance* Field_2_3; // 0x20
	::Class_3_B942B51FF20C85B4* Field_2_4; // 0x28
