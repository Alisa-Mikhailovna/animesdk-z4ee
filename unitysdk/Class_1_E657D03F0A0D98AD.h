...
#define CLASS_1_E657D03F0A0D98AD_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x1447EF20)
#define CLASS_1_E657D03F0A0D98AD_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1447EEF0)
#define CLASS_1_E657D03F0A0D98AD_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x1447EF00)
#define CLASS_1_E657D03F0A0D98AD_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1447EF10)
#define CLASS_1_E657D03F0A0D98AD_GET_TOP_OFFSET UNITYSDK_OFFSET(0x1447EF30)
#define CLASS_1_E657D03F0A0D98AD_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1447EEE0)
#define CLASS_1_E657D03F0A0D98AD__CTOR_OFFSET UNITYSDK_OFFSET(0x1447EF40)
