...
#define LOCALAMBIENTVOLUME_CONTAINS_OFFSET UNITYSDK_OFFSET(0xAFC79C0)
#define LOCALAMBIENTVOLUME_CULL_OFFSET UNITYSDK_OFFSET(0xAFC7680)
#define LOCALAMBIENTVOLUME_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xAFC7BC0)
#define LOCALAMBIENTVOLUME_GETDATA_OFFSET UNITYSDK_OFFSET(0xAFC7880)
#define LOCALAMBIENTVOLUME_GETID_OFFSET UNITYSDK_OFFSET(0xAFC7810)
#define LOCALAMBIENTVOLUME_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0xAFC6180)
#define LOCALAMBIENTVOLUME_GETTYPEID_OFFSET UNITYSDK_OFFSET(0xAFC6200)
#define LOCALAMBIENTVOLUME_GET_ISINVERSE_OFFSET UNITYSDK_OFFSET(0xAFC7660)
#define LOCALAMBIENTVOLUME_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xAFC7640)
#define LOCALAMBIENTVOLUME_GET_VOLUMN_OFFSET UNITYSDK_OFFSET(0xAFC7670)
#define LOCALAMBIENTVOLUME_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xAFC6DC0)
#define LOCALAMBIENTVOLUME_METHOD_6_2A06FF69BDFDBD4F_OFFSET UNITYSDK_OFFSET(0xAFC6B80)
#define LOCALAMBIENTVOLUME_METHOD_6_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0xAFC6640)
#define LOCALAMBIENTVOLUME_METHOD_6_6345BF557E4E4E6A_OFFSET UNITYSDK_OFFSET(0xAFC6A30)
#define LOCALAMBIENTVOLUME_METHOD_6_8714CF4AE9195CA2_OFFSET UNITYSDK_OFFSET(0xAFC7260)
#define LOCALAMBIENTVOLUME_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xAFC6520)
#define LOCALAMBIENTVOLUME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAFC6D70)
#define LOCALAMBIENTVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAFC6B30)
#define LOCALAMBIENTVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAFC6AE0)
#define LOCALAMBIENTVOLUME_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xAFC6570)
#define LOCALAMBIENTVOLUME_ONGETFROMPOOLASYNC_OFFSET UNITYSDK_OFFSET(0xAFC6060)
#define LOCALAMBIENTVOLUME_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xAFC7C20)
#define LOCALAMBIENTVOLUME_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0xAFC7C90)
#define LOCALAMBIENTVOLUME_ONOBJECTCREATEDASYNC_OFFSET UNITYSDK_OFFSET(0xAFC5F60)
#define LOCALAMBIENTVOLUME_ONOBJECTDESTROY_OFFSET UNITYSDK_OFFSET(0xAFC6140)
#define LOCALAMBIENTVOLUME_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0xAFC61C0)
#define LOCALAMBIENTVOLUME_ONPREUNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xAFC60F0)
#define LOCALAMBIENTVOLUME_ONPUTTOPOOL_OFFSET UNITYSDK_OFFSET(0xAFC6020)
#define LOCALAMBIENTVOLUME_ONRELEASE_OFFSET UNITYSDK_OFFSET(0xAFC60B0)
#define LOCALAMBIENTVOLUME_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xAFC6250)
#define LOCALAMBIENTVOLUME_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0xAFC5F20)
#define LOCALAMBIENTVOLUME_RPG_CUSTOMRP_IAMBIENTVOLUMNE_CONTAINS_OFFSET UNITYSDK_OFFSET(0xAFC7E30)
#define LOCALAMBIENTVOLUME_SETFORCELERP_OFFSET UNITYSDK_OFFSET(0xAFC6450)
#define LOCALAMBIENTVOLUME_SETHOSTMANAGEDLIGHT_OFFSET UNITYSDK_OFFSET(0xAFC5FD0)
#define LOCALAMBIENTVOLUME_SETTSCENABLED_OFFSET UNITYSDK_OFFSET(0xAFC7A70)
#define LOCALAMBIENTVOLUME_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xAFC7650)
#define LOCALAMBIENTVOLUME_SPAWNED_OFFSET UNITYSDK_OFFSET(0xAFC7B50)
#define LOCALAMBIENTVOLUME_START_OFFSET UNITYSDK_OFFSET(0xAFC65C0)
#define LOCALAMBIENTVOLUME_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xAFC5C60)
#define LOCALAMBIENTVOLUME__CCTOR_OFFSET UNITYSDK_OFFSET(0xAFC7DA0)
#define LOCALAMBIENTVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xAFC7CF0)
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(LocalAmbientVolume_TypeDefinitionIndex)->GetStaticField(0x62B70);
	}
	static ::System::Int32* StaticGet__ES_LevelHighLight()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LocalAmbientVolume_TypeDefinitionIndex)->GetStaticField(0x11BB0);
	}
	static ::System::Int32* StaticGet__ES_LevelShadow()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LocalAmbientVolume_TypeDefinitionIndex)->GetStaticField(0x11BB4);
	}
	static ::System::Int32* StaticGet__ES_LevelSkinLightColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LocalAmbientVolume_TypeDefinitionIndex)->GetStaticField(0x11BB8);
	}
	static ::System::Int32* StaticGet__ES_LevelMid()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LocalAmbientVolume_TypeDefinitionIndex)->GetStaticField(0x11BBC);
	}
	static ::System::Int32* StaticGet__ES_LevelShadowColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LocalAmbientVolume_TypeDefinitionIndex)->GetStaticField(0x11BC0);
	}
	static ::System::Int32* StaticGet__ES_LevelHighLightColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LocalAmbientVolume_TypeDefinitionIndex)->GetStaticField(0x11BC4);
	}
	static ::System::Int32* StaticGet__ES_LevelSkinShadowColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LocalAmbientVolume_TypeDefinitionIndex)->GetStaticField(0x11BC8);
	}
