...
#define CLASS_2_54CCD44980580DB7___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x155DAC70)
#define CLASS_2_54CCD44980580DB7___C__DISPLAYCLASS28_0___ONITEMFAILEDBYTHREAD_B__0_OFFSET UNITYSDK_OFFSET(0x155DF280)
...
{
public:
	::Class_2_BF47C01E9CFEA39C* ex; // 0x10
	::Class_2_54CCD44980580DB7* __4__this; // 0x18
	::Class_1_E40337C55D87F197* item; // 0x20
