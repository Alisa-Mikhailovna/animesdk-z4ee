...
#define INCONTROL_INCONTROLMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x19960620)
#define INCONTROL_INCONTROLMANAGER_LOGMESSAGE_OFFSET UNITYSDK_OFFSET(0x19960900)
#define INCONTROL_INCONTROLMANAGER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x19960680)
#define INCONTROL_INCONTROLMANAGER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x19960770)
#define INCONTROL_INCONTROLMANAGER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x199607C0)
#define INCONTROL_INCONTROLMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1995FB40)
#define INCONTROL_INCONTROLMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1995EC20)
#define INCONTROL_INCONTROLMANAGER_ONSCENEWASLOADED_OFFSET UNITYSDK_OFFSET(0x19960850)
#define INCONTROL_INCONTROLMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1995FEE0)
#define INCONTROL_INCONTROLMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19960AC0)
#define INCONTROL_INCONTROLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19960A90)
...
namespace InControl
{
	...
	public:
		...
		{
			return (::Unity::Profiling::ProfilerMarker*)Il2CppClass::FromTypeDefinitionIndex(InControlManager_TypeDefinitionIndex)->GetStaticField(0x6270);
		}
