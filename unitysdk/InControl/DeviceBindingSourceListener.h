...
#define INCONTROL_DEVICEBINDINGSOURCELISTENER_ISCONTROLTYPEINARRAY_OFFSET UNITYSDK_OFFSET(0x1995AB20)
#define INCONTROL_DEVICEBINDINGSOURCELISTENER_ISPRESSED_1_OFFSET UNITYSDK_OFFSET(0x1995AA40)
#define INCONTROL_DEVICEBINDINGSOURCELISTENER_ISPRESSED_2_OFFSET UNITYSDK_OFFSET(0x1995A490)
#define INCONTROL_DEVICEBINDINGSOURCELISTENER_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x1995A9F0)
#define INCONTROL_DEVICEBINDINGSOURCELISTENER_LISTENFORCONTROL_OFFSET UNITYSDK_OFFSET(0x1995A500)
#define INCONTROL_DEVICEBINDINGSOURCELISTENER_LISTEN_OFFSET UNITYSDK_OFFSET(0x1995A1D0)
#define INCONTROL_DEVICEBINDINGSOURCELISTENER_RESET_OFFSET UNITYSDK_OFFSET(0x1995A1C0)
#define INCONTROL_DEVICEBINDINGSOURCELISTENER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1995AB70)
#define INCONTROL_DEVICEBINDINGSOURCELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1995AB60)
...
namespace InControl
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DeviceBindingSourceListener_TypeDefinitionIndex)->GetStaticField(0x61D0);
		}
