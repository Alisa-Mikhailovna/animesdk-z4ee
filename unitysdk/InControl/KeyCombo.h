...
#define INCONTROL_KEYCOMBO_ADDEXCLUDEINT_OFFSET UNITYSDK_OFFSET(0x39C83A0)
#define INCONTROL_KEYCOMBO_ADDEXCLUDE_OFFSET UNITYSDK_OFFSET(0x39C83A0)
#define INCONTROL_KEYCOMBO_ADDINCLUDEINT_OFFSET UNITYSDK_OFFSET(0x39C8340)
#define INCONTROL_KEYCOMBO_ADDINCLUDE_OFFSET UNITYSDK_OFFSET(0x39C8340)
#define INCONTROL_KEYCOMBO_ADD_OFFSET UNITYSDK_OFFSET(0x39C8340)
#define INCONTROL_KEYCOMBO_ANDNOT_OFFSET UNITYSDK_OFFSET(0x39C8400)
#define INCONTROL_KEYCOMBO_CLEAR_OFFSET UNITYSDK_OFFSET(0x39C8480)
#define INCONTROL_KEYCOMBO_DETECT_OFFSET UNITYSDK_OFFSET(0x1996F710)
#define INCONTROL_KEYCOMBO_EQUALS_OFFSET UNITYSDK_OFFSET(0x39C84C0)
#define INCONTROL_KEYCOMBO_GETEXCLUDEINT_OFFSET UNITYSDK_OFFSET(0x39C83D0)
#define INCONTROL_KEYCOMBO_GETEXCLUDE_OFFSET UNITYSDK_OFFSET(0x39C83F0)
#define INCONTROL_KEYCOMBO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x39C84F0)
#define INCONTROL_KEYCOMBO_GETINCLUDEINT_OFFSET UNITYSDK_OFFSET(0x39C8370)
#define INCONTROL_KEYCOMBO_GETINCLUDE_OFFSET UNITYSDK_OFFSET(0x39C8390)
#define INCONTROL_KEYCOMBO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define INCONTROL_KEYCOMBO_GET_EXCLUDECOUNT_OFFSET UNITYSDK_OFFSET(0x6E20)
#define INCONTROL_KEYCOMBO_GET_INCLUDECOUNT_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define INCONTROL_KEYCOMBO_GET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x39C84A0)
#define INCONTROL_KEYCOMBO_GET_OFFSET UNITYSDK_OFFSET(0x39C8390)
#define INCONTROL_KEYCOMBO_LOAD_OFFSET UNITYSDK_OFFSET(0x39C8520)
#define INCONTROL_KEYCOMBO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19971D40)
#define INCONTROL_KEYCOMBO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19972A10)
#define INCONTROL_KEYCOMBO_SAVE_OFFSET UNITYSDK_OFFSET(0x39C8530)
#define INCONTROL_KEYCOMBO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39C84B0)
#define INCONTROL_KEYCOMBO_WITH_OFFSET UNITYSDK_OFFSET(0x19972860)
#define INCONTROL_KEYCOMBO__CCTOR_OFFSET UNITYSDK_OFFSET(0x19972A60)
#define INCONTROL_KEYCOMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x39C8230)
...
namespace InControl
{
	...
	struct alignas(8) KeyCombo
	{
		...
		{
			return (::System::Text::StringBuilder**)Il2CppClass::FromTypeDefinitionIndex(KeyCombo_TypeDefinitionIndex)->GetStaticField(0x1BA80);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::UInt64, ::System::String*>** StaticGet_cachedStrings()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt64, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(KeyCombo_TypeDefinitionIndex)->GetStaticField(0x1BA88);
		}
		static ::InControl::KeyCombo* StaticGet_Empty()
		{
			return (::InControl::KeyCombo*)Il2CppClass::FromTypeDefinitionIndex(KeyCombo_TypeDefinitionIndex)->GetStaticField(0x63D0);
		}
