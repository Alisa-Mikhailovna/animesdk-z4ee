...
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x39C8F90)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_NAME_OFFSET UNITYSDK_OFFSET(0x39C8FD0)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_UNITYKEY_OFFSET UNITYSDK_OFFSET(0x1E130)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING_GET_WASPRESSED_OFFSET UNITYSDK_OFFSET(0x39C8F50)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x39C8EF0)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_2_OFFSET UNITYSDK_OFFSET(0x39C8F10)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_3_OFFSET UNITYSDK_OFFSET(0x39C8F30)
#define INCONTROL_UNITYKEYBOARDPROVIDER_KEYMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x39C8ED0)
