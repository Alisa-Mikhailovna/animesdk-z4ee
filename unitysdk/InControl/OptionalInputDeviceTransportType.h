...
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_CLEAR_OFFSET UNITYSDK_OFFSET(0x39C8850)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x199E1320)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x39C8890)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x39C88B0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_EQUALS_OFFSET UNITYSDK_OFFSET(0x39C8970)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x39C88D0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GETVALUEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x39C8860)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GETVALUEORZERO_OFFSET UNITYSDK_OFFSET(0x39C8870)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GET_HASNOVALUE_OFFSET UNITYSDK_OFFSET(0x39C8550)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x2DD70)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x39C8900)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x199E12F0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199E12B0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x199E1430)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x199A7450)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x199E1300)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199E12D0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x39C87D0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x39C87D0)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39C8980)
#define INCONTROL_OPTIONALINPUTDEVICETRANSPORTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x39C87D0)
