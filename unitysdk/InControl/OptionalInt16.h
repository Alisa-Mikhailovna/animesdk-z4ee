...
#define INCONTROL_OPTIONALINT16_CLEAR_OFFSET UNITYSDK_OFFSET(0x39C8850)
#define INCONTROL_OPTIONALINT16_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x199E1660)
#define INCONTROL_OPTIONALINT16_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x39C8A30)
#define INCONTROL_OPTIONALINT16_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x39C88B0)
#define INCONTROL_OPTIONALINT16_EQUALS_OFFSET UNITYSDK_OFFSET(0x39C8A00)
#define INCONTROL_OPTIONALINT16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x39C8A50)
#define INCONTROL_OPTIONALINT16_GETVALUEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x39C8860)
#define INCONTROL_OPTIONALINT16_GETVALUEORZERO_OFFSET UNITYSDK_OFFSET(0x39C8870)
#define INCONTROL_OPTIONALINT16_GET_HASNOVALUE_OFFSET UNITYSDK_OFFSET(0x39C8550)
#define INCONTROL_OPTIONALINT16_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x2DD70)
#define INCONTROL_OPTIONALINT16_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x39C8990)
#define INCONTROL_OPTIONALINT16_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x199E1630)
#define INCONTROL_OPTIONALINT16_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199E15F0)
#define INCONTROL_OPTIONALINT16_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x199E16F0)
#define INCONTROL_OPTIONALINT16_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x199E16E0)
#define INCONTROL_OPTIONALINT16_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x199E1640)
#define INCONTROL_OPTIONALINT16_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199E1610)
#define INCONTROL_OPTIONALINT16_SETVALUE_OFFSET UNITYSDK_OFFSET(0x39C87D0)
#define INCONTROL_OPTIONALINT16_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x39C87D0)
#define INCONTROL_OPTIONALINT16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39C8A70)
#define INCONTROL_OPTIONALINT16__CTOR_OFFSET UNITYSDK_OFFSET(0x39C87D0)
