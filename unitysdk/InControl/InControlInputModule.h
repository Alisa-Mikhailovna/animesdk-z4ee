...
#define INCONTROL_INCONTROLINPUTMODULE_ACTIVATEMODULE_OFFSET UNITYSDK_OFFSET(0x1995B640)
#define INCONTROL_INCONTROLINPUTMODULE_ADDINPUTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1995E5B0)
#define INCONTROL_INCONTROLINPUTMODULE_FORCERELEASEDRAG_OFFSET UNITYSDK_OFFSET(0x1995C100)
#define INCONTROL_INCONTROLINPUTMODULE_GET_CANCELACTION_OFFSET UNITYSDK_OFFSET(0x1995ADA0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_CANCELBUTTON_OFFSET UNITYSDK_OFFSET(0x1995E400)
#define INCONTROL_INCONTROLINPUTMODULE_GET_CANCELWASPRESSED_OFFSET UNITYSDK_OFFSET(0x1995B4A0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1995E1B0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_ISSHOWSDKUI_OFFSET UNITYSDK_OFFSET(0x1995E700)
#define INCONTROL_INCONTROLINPUTMODULE_GET_MOUSEBUTTONWASPRESSED_OFFSET UNITYSDK_OFFSET(0x1995B5A0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_MOUSEHASMOVED_OFFSET UNITYSDK_OFFSET(0x1995B540)
#define INCONTROL_INCONTROLINPUTMODULE_GET_MOVEACTION_OFFSET UNITYSDK_OFFSET(0x1995ADC0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_SUBMITACTION_OFFSET UNITYSDK_OFFSET(0x1995AD80)
#define INCONTROL_INCONTROLINPUTMODULE_GET_SUBMITBUTTON_OFFSET UNITYSDK_OFFSET(0x1995E300)
#define INCONTROL_INCONTROLINPUTMODULE_GET_SUBMITWASPRESSED_OFFSET UNITYSDK_OFFSET(0x1995B480)
#define INCONTROL_INCONTROLINPUTMODULE_GET_SUBMITWASRELEASED_OFFSET UNITYSDK_OFFSET(0x1995DDC0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_VECTORHASCHANGED_OFFSET UNITYSDK_OFFSET(0x1995E6B0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_VECTORISPRESSED_OFFSET UNITYSDK_OFFSET(0x1995E2C0)
#define INCONTROL_INCONTROLINPUTMODULE_GET_VECTORISRELEASED_OFFSET UNITYSDK_OFFSET(0x1995E280)
#define INCONTROL_INCONTROLINPUTMODULE_GET_VECTORWASPRESSED_OFFSET UNITYSDK_OFFSET(0x1995B4C0)
#define INCONTROL_INCONTROLINPUTMODULE_ISMODULESUPPORTED_OFFSET UNITYSDK_OFFSET(0x1995AF70)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSMOUSEEVENT_1_OFFSET UNITYSDK_OFFSET(0x1995E710)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSMOUSEEVENT_OFFSET UNITYSDK_OFFSET(0x1995C0F0)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSMOUSEPRESS_OFFSET UNITYSDK_OFFSET(0x1995CFB0)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSMOVE_OFFSET UNITYSDK_OFFSET(0x1995DC10)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSTOUCHEVENTS_OFFSET UNITYSDK_OFFSET(0x1995BF50)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESSTOUCHPRESS_OFFSET UNITYSDK_OFFSET(0x1995C360)
#define INCONTROL_INCONTROLINPUTMODULE_PROCESS_OFFSET UNITYSDK_OFFSET(0x1995B730)
#define INCONTROL_INCONTROLINPUTMODULE_REMOVEINPUTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1995E650)
#define INCONTROL_INCONTROLINPUTMODULE_SENDBUTTONEVENTTOSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1995BDA0)
#define INCONTROL_INCONTROLINPUTMODULE_SENDUPDATEEVENTTOSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1995B940)
#define INCONTROL_INCONTROLINPUTMODULE_SENDVECTOREVENTTOSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1995BA60)
#define INCONTROL_INCONTROLINPUTMODULE_SETVECTORREPEATTIMER_OFFSET UNITYSDK_OFFSET(0x1995DDE0)
#define INCONTROL_INCONTROLINPUTMODULE_SET_CANCELACTION_OFFSET UNITYSDK_OFFSET(0x1995ADB0)
#define INCONTROL_INCONTROLINPUTMODULE_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1995E500)
#define INCONTROL_INCONTROLINPUTMODULE_SET_ISSHOWSDKUI_OFFSET UNITYSDK_OFFSET(0x1995E6F0)
#define INCONTROL_INCONTROLINPUTMODULE_SET_MOVEACTION_OFFSET UNITYSDK_OFFSET(0x1995ADD0)
#define INCONTROL_INCONTROLINPUTMODULE_SET_SUBMITACTION_OFFSET UNITYSDK_OFFSET(0x1995AD90)
#define INCONTROL_INCONTROLINPUTMODULE_SHOULDACTIVATEMODULE_OFFSET UNITYSDK_OFFSET(0x1995AFE0)
#define INCONTROL_INCONTROLINPUTMODULE_SIMULATEMOUSEEVENT_OFFSET UNITYSDK_OFFSET(0x1995DBF0)
#define INCONTROL_INCONTROLINPUTMODULE_SWITCHSUBMITANDCANCELBUTTON_OFFSET UNITYSDK_OFFSET(0x1995E590)
#define INCONTROL_INCONTROLINPUTMODULE_UPDATEINPUTSTATE_OFFSET UNITYSDK_OFFSET(0x1995B280)
#define INCONTROL_INCONTROLINPUTMODULE_UPDATEMODULE_OFFSET UNITYSDK_OFFSET(0x1995AEE0)
#define INCONTROL_INCONTROLINPUTMODULE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1995DE20)
#define INCONTROL_INCONTROLINPUTMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1995EC00)
#define INCONTROL_INCONTROLINPUTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1995ADE0)
...
namespace InControl
{
	...
	public:
		...
		{
			return (::Unity::Profiling::ProfilerMarker*)Il2CppClass::FromTypeDefinitionIndex(InControlInputModule_TypeDefinitionIndex)->GetStaticField(0x6200);
		}
