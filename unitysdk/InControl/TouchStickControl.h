...
#define INCONTROL_TOUCHSTICKCONTROL_COMMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0x199F3F50)
#define INCONTROL_TOUCHSTICKCONTROL_CONFIGURECONTROL_OFFSET UNITYSDK_OFFSET(0x199F3150)
#define INCONTROL_TOUCHSTICKCONTROL_CREATECONTROL_OFFSET UNITYSDK_OFFSET(0x199F2E10)
#define INCONTROL_TOUCHSTICKCONTROL_DESTROYCONTROL_OFFSET UNITYSDK_OFFSET(0x199F2F00)
#define INCONTROL_TOUCHSTICKCONTROL_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x199F3280)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0x199F4D80)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x199F49D0)
#define INCONTROL_TOUCHSTICKCONTROL_GET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0x199F4DC0)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x199F4350)
#define INCONTROL_TOUCHSTICKCONTROL_GET_ISNOTACTIVE_OFFSET UNITYSDK_OFFSET(0x199F3E20)
#define INCONTROL_TOUCHSTICKCONTROL_GET_KNOBPOSITION_OFFSET UNITYSDK_OFFSET(0x199F3810)
#define INCONTROL_TOUCHSTICKCONTROL_GET_OFFSETUNITTYPE_OFFSET UNITYSDK_OFFSET(0x199F4A50)
#define INCONTROL_TOUCHSTICKCONTROL_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x199F49F0)
#define INCONTROL_TOUCHSTICKCONTROL_GET_RINGPOSITION_OFFSET UNITYSDK_OFFSET(0x199F3720)
#define INCONTROL_TOUCHSTICKCONTROL_SET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0x199F4D90)
#define INCONTROL_TOUCHSTICKCONTROL_SET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x199F49E0)
#define INCONTROL_TOUCHSTICKCONTROL_SET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0x199F4DD0)
#define INCONTROL_TOUCHSTICKCONTROL_SET_KNOBPOSITION_OFFSET UNITYSDK_OFFSET(0x199F3EA0)
#define INCONTROL_TOUCHSTICKCONTROL_SET_OFFSETUNITTYPE_OFFSET UNITYSDK_OFFSET(0x199F4A60)
#define INCONTROL_TOUCHSTICKCONTROL_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x199F4A00)
#define INCONTROL_TOUCHSTICKCONTROL_SET_RINGPOSITION_OFFSET UNITYSDK_OFFSET(0x199F3E30)
#define INCONTROL_TOUCHSTICKCONTROL_SUBMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0x199F3F10)
#define INCONTROL_TOUCHSTICKCONTROL_TOUCHBEGAN_OFFSET UNITYSDK_OFFSET(0x199F3F60)
#define INCONTROL_TOUCHSTICKCONTROL_TOUCHENDED_OFFSET UNITYSDK_OFFSET(0x199F2F70)
#define INCONTROL_TOUCHSTICKCONTROL_TOUCHMOVED_OFFSET UNITYSDK_OFFSET(0x199F4360)
#define INCONTROL_TOUCHSTICKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x199F3900)
#define INCONTROL_TOUCHSTICKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x199F4DE0)
