...
#define INCONTROL_NATIVEDEVICEPROFILES_SAITEKXBOX360CONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x199C2E00)
#define INCONTROL_NATIVEDEVICEPROFILES_SAITEKXBOX360CONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x199C2E80)
