...
#define INCONTROL_NATIVEDEVICEPROFILES_ELECOMCONTROLLERMACNATIVEPROFILE_DEFINE_OFFSET UNITYSDK_OFFSET(0x19984A10)
#define INCONTROL_NATIVEDEVICEPROFILES_ELECOMCONTROLLERMACNATIVEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x19984A90)
