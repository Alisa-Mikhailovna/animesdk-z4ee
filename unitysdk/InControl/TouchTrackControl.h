...
#define INCONTROL_TOUCHTRACKCONTROL_COMMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0x199F5FA0)
#define INCONTROL_TOUCHTRACKCONTROL_CONFIGURECONTROL_OFFSET UNITYSDK_OFFSET(0x199F5A80)
#define INCONTROL_TOUCHTRACKCONTROL_CREATECONTROL_OFFSET UNITYSDK_OFFSET(0x199F5A20)
#define INCONTROL_TOUCHTRACKCONTROL_DESTROYCONTROL_OFFSET UNITYSDK_OFFSET(0x199F5AE0)
#define INCONTROL_TOUCHTRACKCONTROL_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x199F5D30)
#define INCONTROL_TOUCHTRACKCONTROL_GET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0x199F6120)
#define INCONTROL_TOUCHTRACKCONTROL_GET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0x199F6160)
#define INCONTROL_TOUCHTRACKCONTROL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x199F5E80)
#define INCONTROL_TOUCHTRACKCONTROL_SET_ACTIVEAREA_OFFSET UNITYSDK_OFFSET(0x199F6130)
#define INCONTROL_TOUCHTRACKCONTROL_SET_AREAUNITTYPE_OFFSET UNITYSDK_OFFSET(0x199F6170)
#define INCONTROL_TOUCHTRACKCONTROL_SUBMITCONTROLSTATE_OFFSET UNITYSDK_OFFSET(0x199F5F10)
#define INCONTROL_TOUCHTRACKCONTROL_TOUCHBEGAN_OFFSET UNITYSDK_OFFSET(0x199F5FC0)
#define INCONTROL_TOUCHTRACKCONTROL_TOUCHENDED_OFFSET UNITYSDK_OFFSET(0x199F5C00)
#define INCONTROL_TOUCHTRACKCONTROL_TOUCHMOVED_OFFSET UNITYSDK_OFFSET(0x199F60B0)
#define INCONTROL_TOUCHTRACKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x199F5EA0)
#define INCONTROL_TOUCHTRACKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x199F6180)
