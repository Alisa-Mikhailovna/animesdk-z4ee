...
#define CLASS_1_9FD96102A7B034C5_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C0E5C20)
#define CLASS_1_9FD96102A7B034C5_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1C0E5760)
#define CLASS_1_9FD96102A7B034C5_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C0E5910)
#define CLASS_1_9FD96102A7B034C5_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C0E57C0)
#define CLASS_1_9FD96102A7B034C5_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C0E5A40)
#define CLASS_1_9FD96102A7B034C5_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C0E5DD0)
#define CLASS_1_9FD96102A7B034C5_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C0E5D30)
#define CLASS_1_9FD96102A7B034C5_2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C0E5790)
#define CLASS_1_9FD96102A7B034C5_2_METHOD_1_4C96E9A31DDA1BDD_OFFSET UNITYSDK_OFFSET(0x1C0E57B0)
#define CLASS_1_9FD96102A7B034C5_2_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C0E5650)
#define CLASS_1_9FD96102A7B034C5_2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C0E57A0)
#define CLASS_1_9FD96102A7B034C5_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C0E5680)
#define CLASS_1_9FD96102A7B034C5_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C0E5AB0)
#define CLASS_1_9FD96102A7B034C5_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C0E5B10)
#define CLASS_1_9FD96102A7B034C5_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C0E5F90)
#define CLASS_1_9FD96102A7B034C5_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0E56D0)
#define CLASS_1_9FD96102A7B034C5_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0E5690)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_2_TypeDefinitionIndex)->GetStaticField(0xE090);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_9FD96102A7B034C5_2*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9FD96102A7B034C5_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_2_TypeDefinitionIndex)->GetStaticField(0xE098);
	}
