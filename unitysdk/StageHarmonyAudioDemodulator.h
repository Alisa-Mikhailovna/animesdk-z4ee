...
#define STAGEHARMONYAUDIODEMODULATOR_METHOD_3_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xDD5D7B0)
#define STAGEHARMONYAUDIODEMODULATOR_METHOD_3_E1105A7D5DEEC97F_OFFSET UNITYSDK_OFFSET(0xDD5D6B0)
#define STAGEHARMONYAUDIODEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xDD5D660)
#define STAGEHARMONYAUDIODEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xDD5D7F0)
