...
#define CLASS_2_0107C8345F1C32B7_GET_CURRENTACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0xBD38510)
#define CLASS_2_0107C8345F1C32B7_METHOD_2_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0xBD38480)
#define CLASS_2_0107C8345F1C32B7_METHOD_2_B4A91A4ACDF9D75F_OFFSET UNITYSDK_OFFSET(0xBD38400)
#define CLASS_2_0107C8345F1C32B7_SET_CURRENTACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0xBD38520)
#define CLASS_2_0107C8345F1C32B7__CTOR_OFFSET UNITYSDK_OFFSET(0xBD38530)

inline static constexpr unsigned int Class_2_0107C8345F1C32B7_TypeDefinitionIndex = 70992;
