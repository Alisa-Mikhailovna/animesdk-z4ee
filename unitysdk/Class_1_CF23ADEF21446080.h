...
#define CLASS_1_CF23ADEF21446080_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C7037E0)
#define CLASS_1_CF23ADEF21446080_CLONE_OFFSET UNITYSDK_OFFSET(0x1C7030E0)
#define CLASS_1_CF23ADEF21446080_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C7032B0)
#define CLASS_1_CF23ADEF21446080_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C703180)
#define CLASS_1_CF23ADEF21446080_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C703470)
#define CLASS_1_CF23ADEF21446080_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C703AA0)
#define CLASS_1_CF23ADEF21446080_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C7039E0)
#define CLASS_1_CF23ADEF21446080_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C703160)
#define CLASS_1_CF23ADEF21446080_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1C703150)
#define CLASS_1_CF23ADEF21446080_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C703130)
#define CLASS_1_CF23ADEF21446080_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C702F80)
#define CLASS_1_CF23ADEF21446080_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1C703120)
#define CLASS_1_CF23ADEF21446080_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1C703110)
#define CLASS_1_CF23ADEF21446080_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C703170)
#define CLASS_1_CF23ADEF21446080_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1C703140)
#define CLASS_1_CF23ADEF21446080_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C702FB0)
#define CLASS_1_CF23ADEF21446080_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C7035E0)
#define CLASS_1_CF23ADEF21446080_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C703640)
#define CLASS_1_CF23ADEF21446080__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C703BD0)
#define CLASS_1_CF23ADEF21446080__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C703010)
#define CLASS_1_CF23ADEF21446080__CTOR_OFFSET UNITYSDK_OFFSET(0x1C702FC0)
...
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_CF23ADEF21446080*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_CF23ADEF21446080*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CF23ADEF21446080_TypeDefinitionIndex)->GetStaticField(0x68D0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CF23ADEF21446080_TypeDefinitionIndex)->GetStaticField(0x68D8);
	}
