...
#define CLASS_1_6EA5A4B6BD5D6920_CLEAR_OFFSET UNITYSDK_OFFSET(0x147639F0)
#define CLASS_1_6EA5A4B6BD5D6920_GETALLSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0x14763710)
#define CLASS_1_6EA5A4B6BD5D6920_GETLOCKEDUNITS_OFFSET UNITYSDK_OFFSET(0x147636B0)
#define CLASS_1_6EA5A4B6BD5D6920_GETSLOTUNITDATAITEM_OFFSET UNITYSDK_OFFSET(0x14763770)
#define CLASS_1_6EA5A4B6BD5D6920_GETSLOTUNITUID_OFFSET UNITYSDK_OFFSET(0x147638A0)
#define CLASS_1_6EA5A4B6BD5D6920_GET_BASICPOWER_OFFSET UNITYSDK_OFFSET(0x14763530)
#define CLASS_1_6EA5A4B6BD5D6920_GET_EFFECTTYPES_OFFSET UNITYSDK_OFFSET(0x14763650)
#define CLASS_1_6EA5A4B6BD5D6920_GET_FUNCTYPE_OFFSET UNITYSDK_OFFSET(0x147634D0)
#define CLASS_1_6EA5A4B6BD5D6920_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x14763480)
#define CLASS_1_6EA5A4B6BD5D6920_GET_LIMITRANGETYPE_OFFSET UNITYSDK_OFFSET(0x147635F0)
#define CLASS_1_6EA5A4B6BD5D6920_GET_SCEPTERID_OFFSET UNITYSDK_OFFSET(0x14763430)
#define CLASS_1_6EA5A4B6BD5D6920_GET_STYLETYPE_OFFSET UNITYSDK_OFFSET(0x14763590)
#define CLASS_1_6EA5A4B6BD5D6920_METHOD_1_7569C64E71BFAC8F_OFFSET UNITYSDK_OFFSET(0x14763B30)
#define CLASS_1_6EA5A4B6BD5D6920_METHOD_1_B279EAC5AEAF0B47_OFFSET UNITYSDK_OFFSET(0x14763A90)
#define CLASS_1_6EA5A4B6BD5D6920__CTOR_OFFSET UNITYSDK_OFFSET(0x14763C10)
...
{
public:
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::RPG::GameCore::RogueMagicMountType, ::System::UInt32>, ::RPG::Client::RogueMagicUnitDataItem*>* Field_1_0; // 0x10
