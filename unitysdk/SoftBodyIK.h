...
#define SOFTBODYIK_ADDFORCE_1_OFFSET UNITYSDK_OFFSET(0xDD59B10)
#define SOFTBODYIK_ADDFORCE_OFFSET UNITYSDK_OFFSET(0xDD597B0)
#define SOFTBODYIK_CHECKCURRENTOFFSET_OFFSET UNITYSDK_OFFSET(0xDD5A690)
#define SOFTBODYIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xDD56630)
#define SOFTBODYIK_METHOD_5_15EF20217BD059DF_OFFSET UNITYSDK_OFFSET(0xDD56D90)
#define SOFTBODYIK_METHOD_5_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xDD557C0)
#define SOFTBODYIK_METHOD_5_3FD6E53B47B68444_OFFSET UNITYSDK_OFFSET(0xDD59BA0)
#define SOFTBODYIK_METHOD_5_5362541F0053C52B_OFFSET UNITYSDK_OFFSET(0xDD56AE0)
#define SOFTBODYIK_METHOD_5_97E6634148C1D535_OFFSET UNITYSDK_OFFSET(0xDD58690)
#define SOFTBODYIK_METHOD_5_A9B660A656DA65E2_OFFSET UNITYSDK_OFFSET(0xDD57220)
#define SOFTBODYIK_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xDD56810)
#define SOFTBODYIK_METHOD_5_B80705A944339AA3_1_OFFSET UNITYSDK_OFFSET(0xDD57DF0)
#define SOFTBODYIK_METHOD_5_B80705A944339AA3_OFFSET UNITYSDK_OFFSET(0xDD58F70)
#define SOFTBODYIK_METHOD_5_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0xDD595B0)
#define SOFTBODYIK_METHOD_5_D3A7E03DEF3D4859_OFFSET UNITYSDK_OFFSET(0xDD57430)
#define SOFTBODYIK_METHOD_5_EB49B73DCCB74433_OFFSET UNITYSDK_OFFSET(0xDD57BA0)
#define SOFTBODYIK_REINITIALIZE_OFFSET UNITYSDK_OFFSET(0xDD5A4A0)
#define SOFTBODYIK_RESETTOORIGINALSTATE_OFFSET UNITYSDK_OFFSET(0xDD59FF0)
#define SOFTBODYIK_START_OFFSET UNITYSDK_OFFSET(0xDD55770)
#define SOFTBODYIK_TESTFORCE_OFFSET UNITYSDK_OFFSET(0xDD5A4F0)
#define SOFTBODYIK__CTOR_OFFSET UNITYSDK_OFFSET(0xDD5B500)
