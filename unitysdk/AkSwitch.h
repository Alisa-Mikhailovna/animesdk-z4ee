...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1D23BC30)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1D23BAD0)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1D23BB50)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1D23BA70)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1D23B9B0)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1D23B9F0)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D23BD10)
