...
#define CLASS_3_BF30DCF14906C0B9_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xB192C10)
#define CLASS_3_BF30DCF14906C0B9_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xB192C90)
#define CLASS_3_BF30DCF14906C0B9_INVOKE_OFFSET UNITYSDK_OFFSET(0xB192C00)
#define CLASS_3_BF30DCF14906C0B9__CTOR_OFFSET UNITYSDK_OFFSET(0xB192B90)

inline static constexpr unsigned int Class_3_BF30DCF14906C0B9_TypeDefinitionIndex = 70079;
