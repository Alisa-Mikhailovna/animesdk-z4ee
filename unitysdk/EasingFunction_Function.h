...
#define EASINGFUNCTION_FUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA9EDFF0)
#define EASINGFUNCTION_FUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA9EE090)
#define EASINGFUNCTION_FUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0xA9EDFD0)
#define EASINGFUNCTION_FUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA9EDF60)
