...
#define FIELDAOVOLUME_METHOD_5_07FE6948AE52EE96_OFFSET UNITYSDK_OFFSET(0x14792FC0)
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0x14792AC0)
#define FIELDAOVOLUME_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x14792520)
#define FIELDAOVOLUME_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0x14792690)
#define FIELDAOVOLUME_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x14792410)
#define FIELDAOVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x14792EE0)
#define FIELDAOVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14792BD0)
#define FIELDAOVOLUME_START_OFFSET UNITYSDK_OFFSET(0x14792610)
#define FIELDAOVOLUME_UPDATEMATRIX_OFFSET UNITYSDK_OFFSET(0x14792CB0)
#define FIELDAOVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x14793440)
...
public:
	...
	{
		return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(FieldAOVolume_TypeDefinitionIndex)->GetStaticField(0x571E0);
	}
