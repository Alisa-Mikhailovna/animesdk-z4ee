...
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCEBEHAVIOUR_GET_GROUPIDSET_OFFSET UNITYSDK_OFFSET(0xDCB93A0)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDCB93D0)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCEBEHAVIOUR_SET_GROUPIDSET_OFFSET UNITYSDK_OFFSET(0xDCB93C0)
#define RPGTOOLS_TIMELINE_DANMUADDSEQUENCEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDCB94B0)
