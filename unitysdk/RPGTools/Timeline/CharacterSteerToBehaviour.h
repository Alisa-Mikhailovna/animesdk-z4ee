...
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_GET_EDITORFINALROTATION_OFFSET UNITYSDK_OFFSET(0xDCAD9E0)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_METHOD_2_050D955490C4C3D0_OFFSET UNITYSDK_OFFSET(0xDCADA40)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xDCADED0)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDCADE40)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xDCADF50)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xDCADFA0)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xDCADFF0)
#define RPGTOOLS_TIMELINE_CHARACTERSTEERTOBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDCAE130)
