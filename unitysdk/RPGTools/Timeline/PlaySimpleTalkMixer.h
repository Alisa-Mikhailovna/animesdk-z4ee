...
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_METHOD_2_2C6BB5BD685E1939_OFFSET UNITYSDK_OFFSET(0xDCF85B0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_METHOD_2_BE1FA6C0D940BC7C_OFFSET UNITYSDK_OFFSET(0xDCF7CC0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_METHOD_2_C7B58231E4F61838_OFFSET UNITYSDK_OFFSET(0xDCF8190)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xDCF7F90)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xDCF80E0)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xDCF7C10)
#define RPGTOOLS_TIMELINE_PLAYSIMPLETALKMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0xDCF8600)
