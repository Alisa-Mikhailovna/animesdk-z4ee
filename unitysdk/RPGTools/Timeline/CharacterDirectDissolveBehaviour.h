...
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVEBEHAVIOUR_METHOD_2_C8EED11299FD17DB_OFFSET UNITYSDK_OFFSET(0xDCA8510)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDCA8480)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xDCA8940)
#define RPGTOOLS_TIMELINE_CHARACTERDIRECTDISSOLVEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDCA8BD0)
