...
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR_METHOD_2_44D54B0829C8FEF6_OFFSET UNITYSDK_OFFSET(0xDCDB230)
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR_METHOD_2_FF05AC0AB0D75A04_OFFSET UNITYSDK_OFFSET(0xDCDB680)
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR_METHOD_2_FFBC3E5986CAC663_OFFSET UNITYSDK_OFFSET(0xDCDB460)
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDCDB160)
#define RPGTOOLS_TIMELINE_EVENTTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDCDB810)
