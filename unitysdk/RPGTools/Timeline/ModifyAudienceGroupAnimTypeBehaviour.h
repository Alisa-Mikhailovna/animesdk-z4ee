...
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPEBEHAVIOUR_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xDCEF690)
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPEBEHAVIOUR_METHOD_2_6BE484E5F636032A_OFFSET UNITYSDK_OFFSET(0xDCEF840)
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPEBEHAVIOUR_METHOD_2_939B0A8FB671683E_OFFSET UNITYSDK_OFFSET(0xDCEF980)
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDCEF6B0)
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPEBEHAVIOUR_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xDCEF6A0)
#define RPGTOOLS_TIMELINE_MODIFYAUDIENCEGROUPANIMTYPEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDCEFB00)
