...
#define RPGTOOLS_TIMELINE_TALKIMAGEEVTBEHAVIOUR_METHOD_3_69D3760F65546E50_OFFSET UNITYSDK_OFFSET(0xDD292F0)
#define RPGTOOLS_TIMELINE_TALKIMAGEEVTBEHAVIOUR_METHOD_3_6AA4C5D006C4446D_OFFSET UNITYSDK_OFFSET(0xDD29550)
#define RPGTOOLS_TIMELINE_TALKIMAGEEVTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDD295C0)
