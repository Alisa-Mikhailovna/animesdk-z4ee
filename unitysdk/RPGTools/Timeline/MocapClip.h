...
#define RPGTOOLS_TIMELINE_MOCAPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDCEF220)
#define RPGTOOLS_TIMELINE_MOCAPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xDCEF210)
#define RPGTOOLS_TIMELINE_MOCAPCLIP_GET_OFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0xDCEF1E0)
#define RPGTOOLS_TIMELINE_MOCAPCLIP_SET_OFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0xDCEF200)
#define RPGTOOLS_TIMELINE_MOCAPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xDCEF3B0)
