...
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_0545A2E78AEF671D_OFFSET UNITYSDK_OFFSET(0xDCC0B50)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_06C6B0B16AF9B0B4_OFFSET UNITYSDK_OFFSET(0xDCC09B0)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xDCC1140)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_741732AF4195334C_OFFSET UNITYSDK_OFFSET(0xDCC0A40)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_865DD755B8787C08_OFFSET UNITYSDK_OFFSET(0xDCC0CE0)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xDCDBB10)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA_METHOD_1_DCE8D7B2E8135673_OFFSET UNITYSDK_OFFSET(0xDCDBB80)
#define RPGTOOLS_TIMELINE_EYEBLOOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDCC09A0)
