...
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR_METHOD_3_41E028BA4D0D3010_OFFSET UNITYSDK_OFFSET(0xDD28CD0)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR_METHOD_3_C6159FCF4A6D407A_OFFSET UNITYSDK_OFFSET(0xDD28C60)
#define RPGTOOLS_TIMELINE_TALKFIGUREEVTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDD28E70)
