...
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDD05FA0)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP_GET_AUTORESET_OFFSET UNITYSDK_OFFSET(0xDD05F70)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xDD05F90)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP_SET_AUTORESET_OFFSET UNITYSDK_OFFSET(0xDD05F80)
#define RPGTOOLS_TIMELINE_POSTPROCESSING_LIPLINEFIXSCALETIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xDD06140)
