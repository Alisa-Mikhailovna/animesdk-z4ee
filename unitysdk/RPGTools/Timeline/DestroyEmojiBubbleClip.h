...
#define RPGTOOLS_TIMELINE_DESTROYEMOJIBUBBLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDCBACF0)
#define RPGTOOLS_TIMELINE_DESTROYEMOJIBUBBLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xDCBACE0)
#define RPGTOOLS_TIMELINE_DESTROYEMOJIBUBBLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xDCBAE50)
