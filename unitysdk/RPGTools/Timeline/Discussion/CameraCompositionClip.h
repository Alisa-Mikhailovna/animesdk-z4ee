...
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDCBCFD0)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xDCBCFC0)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_GET_ENABLEEDIT_OFFSET UNITYSDK_OFFSET(0xDCBCFB0)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_GET_ISBLENDANCHOREMPTY_OFFSET UNITYSDK_OFFSET(0xDCBCF20)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_GET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xDCBCF90)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP_SET_STREAMINGSOURCEINDEX_OFFSET UNITYSDK_OFFSET(0xDCBCFA0)
#define RPGTOOLS_TIMELINE_DISCUSSION_CAMERACOMPOSITIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xDCBD130)
