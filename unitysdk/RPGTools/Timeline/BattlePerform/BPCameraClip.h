...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDC9A5E0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xDC9A5D0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_GET_END_OFFSET UNITYSDK_OFFSET(0xDC9A5B0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_GET_START_OFFSET UNITYSDK_OFFSET(0xDC9A590)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_SET_END_OFFSET UNITYSDK_OFFSET(0xDC9A5C0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP_SET_START_OFFSET UNITYSDK_OFFSET(0xDC9A5A0)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERACLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xDC9A750)
