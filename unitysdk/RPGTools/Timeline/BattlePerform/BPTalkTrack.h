...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xDC9D090)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK_METHOD_5_773B93AEBF7E2DDA_OFFSET UNITYSDK_OFFSET(0xDC9D240)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPTALKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xDC9D590)
