...
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xDC99D00)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_METHOD_3_106289055FB804CE_OFFSET UNITYSDK_OFFSET(0xDC99D20)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_METHOD_3_41B039A4E2A7F091_OFFSET UNITYSDK_OFFSET(0xDC9A460)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_METHOD_3_434DDC23F222168D_OFFSET UNITYSDK_OFFSET(0xDC9A240)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xDC99D10)
#define RPGTOOLS_TIMELINE_BATTLEPERFORM_BPCAMERABEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDC9A570)
