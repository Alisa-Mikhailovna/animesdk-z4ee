...
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYECTRLTIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xDCD05F0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYECTRLTIMELINETRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xDCD0F10)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYECTRLTIMELINETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xDCD0D10)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYECTRLTIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xDCD0F20)
