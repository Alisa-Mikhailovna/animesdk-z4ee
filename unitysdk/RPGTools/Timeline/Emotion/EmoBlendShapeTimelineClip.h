...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDCCD4F0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xDCCD880)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP_METHOD_4_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xDCCD450)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xDCCD890)
