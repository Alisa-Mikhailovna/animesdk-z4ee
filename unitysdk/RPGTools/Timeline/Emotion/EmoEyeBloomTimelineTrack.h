...
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xDCD02C0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xDCD02B0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xDCD0410)
#define RPGTOOLS_TIMELINE_EMOTION_EMOEYEBLOOMTIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xDCD0510)
