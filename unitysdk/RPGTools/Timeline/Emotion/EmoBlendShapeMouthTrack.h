...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xDCCC680)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDCCC9C0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xDCCCAD0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0xDCCC590)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xDCCC580)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK_METHOD_7_1D3E0D19D91C431C_OFFSET UNITYSDK_OFFSET(0xDCCC780)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEMOUTHTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xDCCCC50)
