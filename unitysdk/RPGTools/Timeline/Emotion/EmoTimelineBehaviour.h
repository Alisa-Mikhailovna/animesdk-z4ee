...
#define RPGTOOLS_TIMELINE_EMOTION_EMOTIMELINEBEHAVIOUR_METHOD_2_512BAEC7C92D0DBB_OFFSET UNITYSDK_OFFSET(0xDCD1E20)
#define RPGTOOLS_TIMELINE_EMOTION_EMOTIMELINEBEHAVIOUR_METHOD_2_7B7BD71833BFC44B_OFFSET UNITYSDK_OFFSET(0xDCD2260)
#define RPGTOOLS_TIMELINE_EMOTION_EMOTIMELINEBEHAVIOUR_METHOD_2_B7B6BCFF308E3412_OFFSET UNITYSDK_OFFSET(0xDCD2370)
#define RPGTOOLS_TIMELINE_EMOTION_EMOTIMELINEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xDCD1D30)
#define RPGTOOLS_TIMELINE_EMOTION_EMOTIMELINEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xDCD1D90)
#define RPGTOOLS_TIMELINE_EMOTION_EMOTIMELINEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDCD2870)
