...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBROWTIMELINETRACKV2_GET_DEFAULTCLIP_OFFSET UNITYSDK_OFFSET(0xDCCE1C0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBROWTIMELINETRACKV2_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0xDCCE2A0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBROWTIMELINETRACKV2_GET_TRACKTYPE_OFFSET UNITYSDK_OFFSET(0xDCCE1B0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBROWTIMELINETRACKV2_METHOD_8_2EF969CA271C0A1B_OFFSET UNITYSDK_OFFSET(0xDCCE220)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBROWTIMELINETRACKV2_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xDCCE330)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBROWTIMELINETRACKV2__CCTOR_OFFSET UNITYSDK_OFFSET(0xDCCE5F0)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBROWTIMELINETRACKV2__CTOR_OFFSET UNITYSDK_OFFSET(0xDCCE500)
...
namespace RPGTools::Timeline::Emotion
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(EmoBrowTimelineTrackV2_TypeDefinitionIndex)->GetStaticField(0x6B690);
		}
