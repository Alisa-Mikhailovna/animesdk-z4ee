...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCONFIG_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0xDCCB750)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCONFIG_METHOD_1_17B613590C092C58_OFFSET UNITYSDK_OFFSET(0xDCCBD80)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPEAUTOMOUTHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xDCCBD70)
