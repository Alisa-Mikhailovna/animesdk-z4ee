...
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_COMPILETRACKS_OFFSET UNITYSDK_OFFSET(0xDCCDA30)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDCCDE30)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xDCCDF50)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0xDCCD940)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_GET_USEUNIQUECHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xDCCD930)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK_METHOD_7_2776DE49AA80CEE7_OFFSET UNITYSDK_OFFSET(0xDCCDB30)
#define RPGTOOLS_TIMELINE_EMOTION_EMOBLENDSHAPETIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xDCCE0D0)
