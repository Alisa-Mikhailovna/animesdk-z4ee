...
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_EXECUTEFOLLOW_OFFSET UNITYSDK_OFFSET(0xDCF01C0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xDCEFFA0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xDCF0170)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0xDCEFFB0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_SETFOLLOWTRAGET_OFFSET UNITYSDK_OFFSET(0xDCEFFF0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_SETOFFSET_OFFSET UNITYSDK_OFFSET(0xDCF0050)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN_SETSCALE_OFFSET UNITYSDK_OFFSET(0xDCF00F0)
#define RPGTOOLS_TIMELINE_MONOEFFECTFOLLOWTIMELINEPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xDCF07E0)
