...
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_GET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xDC964C0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xDC964E0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_METHOD_2_57463EAF62638A1C_OFFSET UNITYSDK_OFFSET(0xDC965A0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDC96500)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_SET_CHARACTERUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xDC964D0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xDC964F0)
#define RPGTOOLS_TIMELINE_ATLASFACEEMOTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDC96680)
