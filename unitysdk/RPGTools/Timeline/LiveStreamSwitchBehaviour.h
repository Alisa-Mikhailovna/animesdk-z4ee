...
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHBEHAVIOUR_GET_LIVESTREAMSWITCHCLIP_OFFSET UNITYSDK_OFFSET(0xDCEC860)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDCEC880)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHBEHAVIOUR_SET_LIVESTREAMSWITCHCLIP_OFFSET UNITYSDK_OFFSET(0xDCEC870)
#define RPGTOOLS_TIMELINE_LIVESTREAMSWITCHBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDCEC920)
