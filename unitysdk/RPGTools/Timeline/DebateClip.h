...
#define RPGTOOLS_TIMELINE_DEBATECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDCBA020)
#define RPGTOOLS_TIMELINE_DEBATECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xDCB9FD0)
#define RPGTOOLS_TIMELINE_DEBATECLIP_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xDCB9F90)
#define RPGTOOLS_TIMELINE_DEBATECLIP_METHOD_4_FCE3E84D14491ED7_OFFSET UNITYSDK_OFFSET(0xDCB9FE0)
#define RPGTOOLS_TIMELINE_DEBATECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xDCBA1B0)
