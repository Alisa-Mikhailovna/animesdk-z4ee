...
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xDCE0680)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xDCE0670)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_GET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0xDCE0560)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_GET_RESULTLOCALEULERANGLES_OFFSET UNITYSDK_OFFSET(0xDCE0160)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP_GET_WWISEEVENT_OFFSET UNITYSDK_OFFSET(0xDCE05E0)
#define RPGTOOLS_TIMELINE_GUIJIDICEROLLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xDCE07E0)
