...
#define RPGTOOLS_TIMELINE_ARCHIVEASSET_GET_BASETARGET_OFFSET UNITYSDK_OFFSET(0xDC96090)
#define RPGTOOLS_TIMELINE_ARCHIVEASSET_METHOD_3_EE73EC1D0D6BA806_OFFSET UNITYSDK_OFFSET(0xDC960B0)
#define RPGTOOLS_TIMELINE_ARCHIVEASSET_SET_BASETARGET_OFFSET UNITYSDK_OFFSET(0xDC960A0)
#define RPGTOOLS_TIMELINE_ARCHIVEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xDC96130)
