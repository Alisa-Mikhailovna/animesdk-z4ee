...
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xDCA45D0)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK_METHOD_5_DB6F9C3D439B5DF2_OFFSET UNITYSDK_OFFSET(0xDCA47B0)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0xDCA4EA0)
#define RPGTOOLS_TIMELINE_CRPCAMERATEMPLATETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xDCA4F10)
