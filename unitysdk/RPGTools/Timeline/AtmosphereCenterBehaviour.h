...
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_GET_CLIP_OFFSET UNITYSDK_OFFSET(0xDC96920)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_METHOD_2_A5EAA5E1A08BAC94_OFFSET UNITYSDK_OFFSET(0xDC96A30)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_METHOD_2_E9D6A791F654E920_OFFSET UNITYSDK_OFFSET(0xDC96C40)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xDC96940)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR_SET_CLIP_OFFSET UNITYSDK_OFFSET(0xDC96930)
#define RPGTOOLS_TIMELINE_ATMOSPHERECENTERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDC96F60)
