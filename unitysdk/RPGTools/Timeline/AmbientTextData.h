...
#define RPGTOOLS_TIMELINE_AMBIENTTEXTDATA_SYNCTEXTIDSFROMCONFIGS_OFFSET UNITYSDK_OFFSET(0xDC91940)
#define RPGTOOLS_TIMELINE_AMBIENTTEXTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDC91C20)
