...
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xDCDA8B0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_3D6722B9F8F20694_OFFSET UNITYSDK_OFFSET(0xDCD9E00)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_60C07F80F75AC78A_OFFSET UNITYSDK_OFFSET(0xDCDA2F0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xDCD9B90)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xDCD9AD0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0xDCD9C20)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0xDCDAC10)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_METHOD_3_ED29F23CD1CAE89E_OFFSET UNITYSDK_OFFSET(0xDCDA6C0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xDCD98C0)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xDCD9C90)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xDCD9D00)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xDCDAD10)
#define RPGTOOLS_TIMELINE_ENVIRONMENTSYETEM_ENVIROSYSTRANSITIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xDCDACF0)
...
namespace RPGTools::Timeline::EnvironmentSyetem
{
	...
	public:
		...
		{
			return (::RPGTools::Timeline::EnvironmentSyetem::EnviroSysTransitionBehaviour**)Il2CppClass::FromTypeDefinitionIndex(EnviroSysTransitionBehaviour_TypeDefinitionIndex)->GetStaticField(0x6B720);
		}
		static ::System::Int32* StaticGet__LastEnvTransitionHandle()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviroSysTransitionBehaviour_TypeDefinitionIndex)->GetStaticField(0x14810);
		}
