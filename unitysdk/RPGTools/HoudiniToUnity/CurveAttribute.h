...
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_ENSURECONSISTENCY_OFFSET UNITYSDK_OFFSET(0xABA1530)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_EVALUATEASSTRING_OFFSET UNITYSDK_OFFSET(0xABA1BD0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETHUECOLOR_OFFSET UNITYSDK_OFFSET(0xABA19A0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTCOLOR_OFFSET UNITYSDK_OFFSET(0xABA17A0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0xABA12D0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTRANGE_OFFSET UNITYSDK_OFFSET(0xABA1B00)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GETSEGMENTVALUE_OFFSET UNITYSDK_OFFSET(0xABA1660)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GET_SEGMENTCOUNT_OFFSET UNITYSDK_OFFSET(0xABA0FA0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GET_SEGMENTVALUES_OFFSET UNITYSDK_OFFSET(0xABA10E0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_GET_SPLITPOINTS_OFFSET UNITYSDK_OFFSET(0xABA10D0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_INSERTSPLITPOINT_OFFSET UNITYSDK_OFFSET(0xABA10F0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xABA21F0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xABA21E0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_REMOVESPLITPOINT_OFFSET UNITYSDK_OFFSET(0xABA1360)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_SETSEGMENTCOLOR_OFFSET UNITYSDK_OFFSET(0xABA16D0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_SETSEGMENTVALUE_OFFSET UNITYSDK_OFFSET(0xABA14C0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_SORTSPLITPOINTS_OFFSET UNITYSDK_OFFSET(0xABA1CB0)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0xABA2110)
#define RPGTOOLS_HOUDINITOUNITY_CURVEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xABA2340)
