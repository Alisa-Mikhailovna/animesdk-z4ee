...
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT_COMPARETO_OFFSET UNITYSDK_OFFSET(0xABA2590)
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xABA1340)
#define RPGTOOLS_HOUDINITOUNITY_CURVESPLITPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xABA2580)
