...
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_CLEARRECORD_OFFSET UNITYSDK_OFFSET(0xAB9EBD0)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_FPSBTNCLICK_OFFSET UNITYSDK_OFFSET(0xAB9DE80)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_GETCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0xAB9E600)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_MEMBTNCLICK_OFFSET UNITYSDK_OFFSET(0xAB9D780)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_ONDETAILBTNCLICK_OFFSET UNITYSDK_OFFSET(0xAB9D740)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAB9E150)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_ONLOWMEMORY_OFFSET UNITYSDK_OFFSET(0xAB9ED20)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_RECORDREALTIMEMEM_OFFSET UNITYSDK_OFFSET(0xAB9DA20)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_SETUPUI_OFFSET UNITYSDK_OFFSET(0xAB9BC80)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_START_OFFSET UNITYSDK_OFFSET(0xAB9BC60)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_TRACKCURMEM_OFFSET UNITYSDK_OFFSET(0xAB9ECD0)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_UPDATEFPS_OFFSET UNITYSDK_OFFSET(0xAB9D500)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_UPDATEMEM_OFFSET UNITYSDK_OFFSET(0xAB9CF10)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xAB9CA70)
#define RPGTOOLS_APPDEVICEPERFORMANCEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB9ED30)
