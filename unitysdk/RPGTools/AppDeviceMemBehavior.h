...
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_GETCURRENTCOLOR_OFFSET UNITYSDK_OFFSET(0xAB9B6F0)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_GETCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0xAB9B6B0)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAB9B770)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_RESETTAG_OFFSET UNITYSDK_OFFSET(0xAB9BA70)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_SETUPUI_OFFSET UNITYSDK_OFFSET(0xAB9A770)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_START_OFFSET UNITYSDK_OFFSET(0xAB9A760)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_SWITHBTNCLICK_OFFSET UNITYSDK_OFFSET(0xAB9BB50)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_TAGBTNCLICK_OFFSET UNITYSDK_OFFSET(0xAB9BA00)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_UPDATECRITICALIMAGESTATE_OFFSET UNITYSDK_OFFSET(0xAB9B730)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xAB9AF50)
#define RPGTOOLS_APPDEVICEMEMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB9BBC0)
