...
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xDC87390)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_JUNCTIONID_OFFSET UNITYSDK_OFFSET(0xDC87310)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_JUNCTIONNAME_OFFSET UNITYSDK_OFFSET(0xDC87370)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_JUNCTIONTYPE_OFFSET UNITYSDK_OFFSET(0xDC87330)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_OWNERREGION_OFFSET UNITYSDK_OFFSET(0xDC87420)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_QUALIFIEDID_OFFSET UNITYSDK_OFFSET(0xDC873B0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0xDC87350)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_METHOD_5_57D95388FFE72045_OFFSET UNITYSDK_OFFSET(0xDC878C0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDC87650)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xDC876D0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDC875D0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xDC873A0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_JUNCTIONID_OFFSET UNITYSDK_OFFSET(0xDC87320)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_JUNCTIONNAME_OFFSET UNITYSDK_OFFSET(0xDC87380)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_JUNCTIONTYPE_OFFSET UNITYSDK_OFFSET(0xDC87340)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0xDC87360)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXJUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0xDC87990)
