...
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xDC88760)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_GET_OWNERREGION_OFFSET UNITYSDK_OFFSET(0xDC88780)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_READLAYER_OFFSET UNITYSDK_OFFSET(0xDC88980)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_SET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xDC88770)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER_STORELAYER_OFFSET UNITYSDK_OFFSET(0xDC888C0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXPOLISHLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC88AB0)
