...
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0xDC88D70)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xDC88B00)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_DIRECTCHILDREGIONS_OFFSET UNITYSDK_OFFSET(0xDC88F30)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_HASCHILDREGIONS_OFFSET UNITYSDK_OFFSET(0xDC88DB0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_REGIONID_OFFSET UNITYSDK_OFFSET(0xDC88AC0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_REGIONNAME_OFFSET UNITYSDK_OFFSET(0xDC88AE0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0xDC88B20)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_SIZE_OFFSET UNITYSDK_OFFSET(0xDC88CE0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_GET_VIEWMODE_OFFSET UNITYSDK_OFFSET(0xDC88D90)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDC891D0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDC89100)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDC88FE0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xDC89180)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_REBUILDMESH_OFFSET UNITYSDK_OFFSET(0xDC88B80)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_DEPTH_OFFSET UNITYSDK_OFFSET(0xDC88D80)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xDC88B10)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_REGIONID_OFFSET UNITYSDK_OFFSET(0xDC88AD0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_REGIONNAME_OFFSET UNITYSDK_OFFSET(0xDC88AF0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_SHAPE_OFFSET UNITYSDK_OFFSET(0xDC88B30)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_SIZE_OFFSET UNITYSDK_OFFSET(0xDC88D00)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION_SET_VIEWMODE_OFFSET UNITYSDK_OFFSET(0xDC88DA0)
#define RPGTOOLS_LDWHITEBOX_WHITEBOXREGION__CTOR_OFFSET UNITYSDK_OFFSET(0xDC89230)
