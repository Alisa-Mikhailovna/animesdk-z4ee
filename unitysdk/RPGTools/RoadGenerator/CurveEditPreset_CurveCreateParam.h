...
#define RPGTOOLS_ROADGENERATOR_CURVEEDITPRESET_CURVECREATEPARAM__CCTOR_OFFSET UNITYSDK_OFFSET(0xDC8E340)
...
namespace RPGTools::RoadGenerator
{
	...
	struct alignas(4) CurveEditPreset_CurveCreateParam
	{
		...
		{
			return (::RPGTools::RoadGenerator::CurveEditPreset_CurveCreateParam*)Il2CppClass::FromTypeDefinitionIndex(CurveEditPreset_CurveCreateParam_TypeDefinitionIndex)->GetStaticField(0x146E0);
		}
