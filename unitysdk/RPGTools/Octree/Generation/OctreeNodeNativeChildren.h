...
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x156B70)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x156B80)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_METHOD_2_206F77E5E3F223C5_OFFSET UNITYSDK_OFFSET(0x156BB0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_METHOD_2_276E1CDD7DFA6E40_OFFSET UNITYSDK_OFFSET(0x156BA0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREENODENATIVECHILDREN_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x156B90)
