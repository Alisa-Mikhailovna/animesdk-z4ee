...
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_BUILDNAVIGATIONPATH_OFFSET UNITYSDK_OFFSET(0xDC8C9F0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_BUILDOCTREE_OFFSET UNITYSDK_OFFSET(0xDC8C020)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_DISPOSETREE_OFFSET UNITYSDK_OFFSET(0xDC8BFC0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_GET_TREE_OFFSET UNITYSDK_OFFSET(0xDC8C9E0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDC8BF40)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xDC8BDF0)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER__BUILDOCTREE_B__11_0_OFFSET UNITYSDK_OFFSET(0xDC8CC90)
#define RPGTOOLS_OCTREE_GENERATION_OCTREEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC8CC30)
