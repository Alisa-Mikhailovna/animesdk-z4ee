...
#define CLASS_1_5B567C8A01BAEDFE_253_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BDA2FA0)
#define CLASS_1_5B567C8A01BAEDFE_253_CLONE_OFFSET UNITYSDK_OFFSET(0x1BDA2C90)
#define CLASS_1_5B567C8A01BAEDFE_253_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BDA2DA0)
#define CLASS_1_5B567C8A01BAEDFE_253_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BDA2CD0)
#define CLASS_1_5B567C8A01BAEDFE_253_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BDA2F00)
#define CLASS_1_5B567C8A01BAEDFE_253_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BDA2FF0)
#define CLASS_1_5B567C8A01BAEDFE_253_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BDA2FC0)
#define CLASS_1_5B567C8A01BAEDFE_253_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BDA2C10)
#define CLASS_1_5B567C8A01BAEDFE_253_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BDA2C40)
#define CLASS_1_5B567C8A01BAEDFE_253_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BDA2F30)
#define CLASS_1_5B567C8A01BAEDFE_253_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BDA2F90)
#define CLASS_1_5B567C8A01BAEDFE_253__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BDA3040)
#define CLASS_1_5B567C8A01BAEDFE_253__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BDA2C60)
#define CLASS_1_5B567C8A01BAEDFE_253__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDA2C50)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_253*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_253_TypeDefinitionIndex)->GetStaticField(0x46C20);
	}
