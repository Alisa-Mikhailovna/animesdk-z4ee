...
#define CLASS_1_D126770E0092C973_GET_DESC_OFFSET UNITYSDK_OFFSET(0xAFDFD20)
#define CLASS_1_D126770E0092C973_GET_HINTTYPE_OFFSET UNITYSDK_OFFSET(0xAFDFD00)
#define CLASS_1_D126770E0092C973_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xAFDFD40)
#define CLASS_1_D126770E0092C973_GET_UIINDEX_OFFSET UNITYSDK_OFFSET(0xAFDFD60)
#define CLASS_1_D126770E0092C973_SET_DESC_OFFSET UNITYSDK_OFFSET(0xAFDFD30)
#define CLASS_1_D126770E0092C973_SET_HINTTYPE_OFFSET UNITYSDK_OFFSET(0xAFDFD10)
#define CLASS_1_D126770E0092C973_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xAFDFD50)
#define CLASS_1_D126770E0092C973_SET_UIINDEX_OFFSET UNITYSDK_OFFSET(0xAFDFD70)
#define CLASS_1_D126770E0092C973__CTOR_OFFSET UNITYSDK_OFFSET(0xAFDFD80)

inline static constexpr unsigned int Class_1_D126770E0092C973_TypeDefinitionIndex = 75867;
