...
#define CLASS_1_5B567C8A01BAEDFE_93_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C0C0090)
#define CLASS_1_5B567C8A01BAEDFE_93_CLONE_OFFSET UNITYSDK_OFFSET(0x1C0BFD80)
#define CLASS_1_5B567C8A01BAEDFE_93_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C0BFE90)
#define CLASS_1_5B567C8A01BAEDFE_93_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C0BFDC0)
#define CLASS_1_5B567C8A01BAEDFE_93_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C0BFFF0)
#define CLASS_1_5B567C8A01BAEDFE_93_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C0C00E0)
#define CLASS_1_5B567C8A01BAEDFE_93_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C0C00B0)
#define CLASS_1_5B567C8A01BAEDFE_93_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C0BFD00)
#define CLASS_1_5B567C8A01BAEDFE_93_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C0BFD30)
#define CLASS_1_5B567C8A01BAEDFE_93_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C0C0020)
#define CLASS_1_5B567C8A01BAEDFE_93_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C0C0080)
#define CLASS_1_5B567C8A01BAEDFE_93__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C0C0130)
#define CLASS_1_5B567C8A01BAEDFE_93__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C0BFD50)
#define CLASS_1_5B567C8A01BAEDFE_93__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0BFD40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_93*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_93_TypeDefinitionIndex)->GetStaticField(0xB210);
	}
