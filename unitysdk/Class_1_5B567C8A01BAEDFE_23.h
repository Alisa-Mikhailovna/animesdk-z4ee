...
#define CLASS_1_5B567C8A01BAEDFE_23_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C026B50)
#define CLASS_1_5B567C8A01BAEDFE_23_CLONE_OFFSET UNITYSDK_OFFSET(0x1C026840)
#define CLASS_1_5B567C8A01BAEDFE_23_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C026950)
#define CLASS_1_5B567C8A01BAEDFE_23_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C026880)
#define CLASS_1_5B567C8A01BAEDFE_23_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C026AB0)
#define CLASS_1_5B567C8A01BAEDFE_23_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C026BA0)
#define CLASS_1_5B567C8A01BAEDFE_23_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C026B70)
#define CLASS_1_5B567C8A01BAEDFE_23_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C0267C0)
#define CLASS_1_5B567C8A01BAEDFE_23_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C0267F0)
#define CLASS_1_5B567C8A01BAEDFE_23_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C026AE0)
#define CLASS_1_5B567C8A01BAEDFE_23_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C026B40)
#define CLASS_1_5B567C8A01BAEDFE_23__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C026BF0)
#define CLASS_1_5B567C8A01BAEDFE_23__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C026810)
#define CLASS_1_5B567C8A01BAEDFE_23__CTOR_OFFSET UNITYSDK_OFFSET(0x1C026800)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_23*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_23_TypeDefinitionIndex)->GetStaticField(0x67070);
	}
