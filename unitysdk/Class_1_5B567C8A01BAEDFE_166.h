...
#define CLASS_1_5B567C8A01BAEDFE_166_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C4C93F0)
#define CLASS_1_5B567C8A01BAEDFE_166_CLONE_OFFSET UNITYSDK_OFFSET(0x1C4C9090)
#define CLASS_1_5B567C8A01BAEDFE_166_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C4C91F0)
#define CLASS_1_5B567C8A01BAEDFE_166_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C4C9100)
#define CLASS_1_5B567C8A01BAEDFE_166_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C4C9350)
#define CLASS_1_5B567C8A01BAEDFE_166_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C4C9440)
#define CLASS_1_5B567C8A01BAEDFE_166_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C4C9410)
#define CLASS_1_5B567C8A01BAEDFE_166_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C4C8FE0)
#define CLASS_1_5B567C8A01BAEDFE_166_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C4C9040)
#define CLASS_1_5B567C8A01BAEDFE_166_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C4C9380)
#define CLASS_1_5B567C8A01BAEDFE_166_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C4C93E0)
#define CLASS_1_5B567C8A01BAEDFE_166__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4C9490)
#define CLASS_1_5B567C8A01BAEDFE_166__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4C9060)
#define CLASS_1_5B567C8A01BAEDFE_166__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C9050)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_166*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_166_TypeDefinitionIndex)->GetStaticField(0x522A0);
	}
