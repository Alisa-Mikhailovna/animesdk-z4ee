...
#define JESSESTILLER_TERRAINFORMEREXTENSION_TERRAINSETNEIGHBOURS_AWAKE_OFFSET UNITYSDK_OFFSET(0xAA81650)
#define JESSESTILLER_TERRAINFORMEREXTENSION_TERRAINSETNEIGHBOURS_SETNEIGHBOURS_OFFSET UNITYSDK_OFFSET(0xAA81720)
#define JESSESTILLER_TERRAINFORMEREXTENSION_TERRAINSETNEIGHBOURS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA81740)
