...
#define CLASS_1_E5F5F7699081F347__CTOR_OFFSET UNITYSDK_OFFSET(0x1A75AC10)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_E5F5F7699081F347_TypeDefinitionIndex)->GetStaticField(0xE080);
	}
