...
#define CLASS_1_A561DBBEB8754F4D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xAFE5970)
#define CLASS_1_A561DBBEB8754F4D_EQUALS_OFFSET UNITYSDK_OFFSET(0xAFE58E0)
#define CLASS_1_A561DBBEB8754F4D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xAFE5A60)
#define CLASS_1_A561DBBEB8754F4D_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xAFE58C0)
#define CLASS_1_A561DBBEB8754F4D_GET_ISBATTLEDISPLAY_OFFSET UNITYSDK_OFFSET(0xAFE5880)
#define CLASS_1_A561DBBEB8754F4D_GET_ISDISPLAY_OFFSET UNITYSDK_OFFSET(0xAFE5860)
#define CLASS_1_A561DBBEB8754F4D_GET_MAINRELICFILTER_OFFSET UNITYSDK_OFFSET(0xAFE57E0)
#define CLASS_1_A561DBBEB8754F4D_GET_ORDER_OFFSET UNITYSDK_OFFSET(0xAFE58A0)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYCLASSIFY_OFFSET UNITYSDK_OFFSET(0xAFE5840)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYINSTRUCTIONID_OFFSET UNITYSDK_OFFSET(0xAFE5820)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYNAMEFILTER_OFFSET UNITYSDK_OFFSET(0xAFE57C0)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYNAMERELIC_OFFSET UNITYSDK_OFFSET(0xAFE57A0)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYNAMESKILLTREE_OFFSET UNITYSDK_OFFSET(0xAFE5780)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0xAFE5760)
#define CLASS_1_A561DBBEB8754F4D_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0xAFE5740)
#define CLASS_1_A561DBBEB8754F4D_GET_SUBRELICFILTER_OFFSET UNITYSDK_OFFSET(0xAFE5800)
#define CLASS_1_A561DBBEB8754F4D_METHOD_1_148214CEA2F00B70_OFFSET UNITYSDK_OFFSET(0xAFE5B80)
#define CLASS_1_A561DBBEB8754F4D_METHOD_1_6062BB7D9634C869_OFFSET UNITYSDK_OFFSET(0xAFE5AA0)
#define CLASS_1_A561DBBEB8754F4D_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xAFE58D0)
#define CLASS_1_A561DBBEB8754F4D_SET_ISBATTLEDISPLAY_OFFSET UNITYSDK_OFFSET(0xAFE5890)
#define CLASS_1_A561DBBEB8754F4D_SET_ISDISPLAY_OFFSET UNITYSDK_OFFSET(0xAFE5870)
#define CLASS_1_A561DBBEB8754F4D_SET_MAINRELICFILTER_OFFSET UNITYSDK_OFFSET(0xAFE57F0)
#define CLASS_1_A561DBBEB8754F4D_SET_ORDER_OFFSET UNITYSDK_OFFSET(0xAFE58B0)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYCLASSIFY_OFFSET UNITYSDK_OFFSET(0xAFE5850)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYINSTRUCTIONID_OFFSET UNITYSDK_OFFSET(0xAFE5830)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYNAMEFILTER_OFFSET UNITYSDK_OFFSET(0xAFE57D0)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYNAMERELIC_OFFSET UNITYSDK_OFFSET(0xAFE57B0)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYNAMESKILLTREE_OFFSET UNITYSDK_OFFSET(0xAFE5790)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0xAFE5770)
#define CLASS_1_A561DBBEB8754F4D_SET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0xAFE5750)
#define CLASS_1_A561DBBEB8754F4D_SET_SUBRELICFILTER_OFFSET UNITYSDK_OFFSET(0xAFE5810)
#define CLASS_1_A561DBBEB8754F4D__CTOR_OFFSET UNITYSDK_OFFSET(0xAFE5C60)
...
public:
	...
	::RPG::Client::TextID _PropertyName_k__BackingField; // 0x50
	::System::UInt32 _PropertyInstructionID_k__BackingField; // 0x60
	::System::UInt32 _Order_k__BackingField; // 0x64
	::RPG::GameCore::AvatarPropertyType _PropertyType_k__BackingField; // 0x68
	::System::UInt32 _MainRelicFilter_k__BackingField; // 0x6C
