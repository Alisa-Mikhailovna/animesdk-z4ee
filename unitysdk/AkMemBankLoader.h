...
#define AKMEMBANKLOADER_ALLOCATEALIGNEDBUFFER_OFFSET UNITYSDK_OFFSET(0x1D1D2880)
#define AKMEMBANKLOADER_DOLOADBANK_OFFSET UNITYSDK_OFFSET(0x1D1D27C0)
#define AKMEMBANKLOADER_LOADFILE_OFFSET UNITYSDK_OFFSET(0x1D1D2A80)
#define AKMEMBANKLOADER_LOADLOCALIZEDBANK_OFFSET UNITYSDK_OFFSET(0x1D1D2500)
#define AKMEMBANKLOADER_LOADNONLOCALIZEDBANK_OFFSET UNITYSDK_OFFSET(0x1D1D2680)
#define AKMEMBANKLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D1D2B10)
#define AKMEMBANKLOADER_START_OFFSET UNITYSDK_OFFSET(0x1D1D24A0)
#define AKMEMBANKLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D2D40)
