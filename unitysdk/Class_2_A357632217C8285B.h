...
#define CLASS_2_A357632217C8285B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1479FF60)
#define CLASS_2_A357632217C8285B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1479FFA0)
#define CLASS_2_A357632217C8285B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x147A0160)
#define CLASS_2_A357632217C8285B_TICK_OFFSET UNITYSDK_OFFSET(0x147A01B0)
#define CLASS_2_A357632217C8285B__CTOR_OFFSET UNITYSDK_OFFSET(0x1479FF50)
