...
#define CLASS_1_9998C0EE7B9FC41A_EXECUTE_OFFSET UNITYSDK_OFFSET(0xE51F950)
#define CLASS_1_9998C0EE7B9FC41A_METHOD_1_51AC7912135C5E23_OFFSET UNITYSDK_OFFSET(0xE51FE30)
#define CLASS_1_9998C0EE7B9FC41A_METHOD_1_8B4B3FEAD1B0C4A6_OFFSET UNITYSDK_OFFSET(0xE51FB40)
#define CLASS_1_9998C0EE7B9FC41A_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xE51FDF0)
#define CLASS_1_9998C0EE7B9FC41A_TICK_OFFSET UNITYSDK_OFFSET(0xE51FD80)
#define CLASS_1_9998C0EE7B9FC41A__CCTOR_OFFSET UNITYSDK_OFFSET(0xE520010)
#define CLASS_1_9998C0EE7B9FC41A__CTOR_OFFSET UNITYSDK_OFFSET(0xE51F940)

inline static constexpr unsigned int Class_1_9998C0EE7B9FC41A_TypeDefinitionIndex = 73699;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGame::ChimeraDuel::ChimeraDuelMasterShowType, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9998C0EE7B9FC41A_TypeDefinitionIndex)->GetStaticField(0x68500);
	}
	::Class_2_B66C1067C0468FBB* Field_1_1; // 0x10
	::Class_1_E518B582305CCAFF* Field_1_2; // 0x18
	::System::Collections::Generic::List_1<::Class_1_43BD383C98B4C0C5_199*>* Field_1_3; // 0x20
	::Class_1_A92BC063ED2379EB* Field_1_4; // 0x28
