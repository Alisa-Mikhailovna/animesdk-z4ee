...
#define STRUCT_2_F9D0A54883B760B5_GET_AGGRO_OFFSET UNITYSDK_OFFSET(0x25EA0)
#define STRUCT_2_F9D0A54883B760B5_GET_HPBASE_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define STRUCT_2_F9D0A54883B760B5_GET_HPINHERIT_OFFSET UNITYSDK_OFFSET(0x6010)
#define STRUCT_2_F9D0A54883B760B5_GET_HPSKILL_OFFSET UNITYSDK_OFFSET(0x6E20)
#define STRUCT_2_F9D0A54883B760B5_GET_SPEEDBASE_OFFSET UNITYSDK_OFFSET(0x2B150)
#define STRUCT_2_F9D0A54883B760B5_GET_SPEEDINHERIT_OFFSET UNITYSDK_OFFSET(0x112B0)
#define STRUCT_2_F9D0A54883B760B5_GET_SPEEDSKILL_OFFSET UNITYSDK_OFFSET(0x112C0)
#define STRUCT_2_F9D0A54883B760B5_SET_AGGRO_OFFSET UNITYSDK_OFFSET(0x2C8C0)
#define STRUCT_2_F9D0A54883B760B5_SET_HPBASE_OFFSET UNITYSDK_OFFSET(0xC630)
#define STRUCT_2_F9D0A54883B760B5_SET_HPINHERIT_OFFSET UNITYSDK_OFFSET(0x94F0)
#define STRUCT_2_F9D0A54883B760B5_SET_HPSKILL_OFFSET UNITYSDK_OFFSET(0x2A90)
#define STRUCT_2_F9D0A54883B760B5_SET_SPEEDBASE_OFFSET UNITYSDK_OFFSET(0x2B160)
#define STRUCT_2_F9D0A54883B760B5_SET_SPEEDINHERIT_OFFSET UNITYSDK_OFFSET(0xBBD0)
#define STRUCT_2_F9D0A54883B760B5_SET_SPEEDSKILL_OFFSET UNITYSDK_OFFSET(0xC260)
