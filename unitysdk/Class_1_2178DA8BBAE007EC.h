...
#define CLASS_1_2178DA8BBAE007EC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1517CDD0)
#define CLASS_1_2178DA8BBAE007EC_GET_CURRENTATTACKER_OFFSET UNITYSDK_OFFSET(0x15180E50)
#define CLASS_1_2178DA8BBAE007EC_GET_CURRENTDEFENDER_OFFSET UNITYSDK_OFFSET(0x15180E70)
#define CLASS_1_2178DA8BBAE007EC_GET_ISMAZETOBATTLETRANSITIONSHOWSTARTED_OFFSET UNITYSDK_OFFSET(0x15180E30)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_09D92EE02A83C51D_OFFSET UNITYSDK_OFFSET(0x1517E9D0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x1517F290)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_1808E1CF7A125519_2_OFFSET UNITYSDK_OFFSET(0x15180B20)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1517F060)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1517E650)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_1_OFFSET UNITYSDK_OFFSET(0x1517DE60)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_2_OFFSET UNITYSDK_OFFSET(0x1517E100)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_3_OFFSET UNITYSDK_OFFSET(0x1517E3E0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_4_OFFSET UNITYSDK_OFFSET(0x1517E720)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_276036CDF4BFF5A6_OFFSET UNITYSDK_OFFSET(0x1517D590)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x1517D360)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1517F240)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_3BF9B67F74EEB9FA_OFFSET UNITYSDK_OFFSET(0x1517D860)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_43D99DDD80B1E30C_OFFSET UNITYSDK_OFFSET(0x151809B0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_57D7671870F3331B_OFFSET UNITYSDK_OFFSET(0x1517EF10)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_5AD211D08ADF3F6E_OFFSET UNITYSDK_OFFSET(0x15180E00)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_5CC589A90C8895C1_OFFSET UNITYSDK_OFFSET(0x15180C50)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_6B4A3A1B5816B81E_OFFSET UNITYSDK_OFFSET(0x1517BEB0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_721C8F8A1B12BAFC_OFFSET UNITYSDK_OFFSET(0x1517FC10)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_74DC427A9191C639_OFFSET UNITYSDK_OFFSET(0x1517F320)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x15180C00)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_88A5355116A88152_1_OFFSET UNITYSDK_OFFSET(0x1517E390)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_88A5355116A88152_OFFSET UNITYSDK_OFFSET(0x1517E0B0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_8C1DD01C5F096716_OFFSET UNITYSDK_OFFSET(0x1517F900)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_8DFE27A803774727_OFFSET UNITYSDK_OFFSET(0x1517D140)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_8F6A1B72899F4EA4_OFFSET UNITYSDK_OFFSET(0x1517D060)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_934A67A86EB996AE_OFFSET UNITYSDK_OFFSET(0x1517DB50)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_A41E5E09290EF5A0_OFFSET UNITYSDK_OFFSET(0x1517BF90)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_A693F2E8D4F4A766_OFFSET UNITYSDK_OFFSET(0x1517E6B0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_A8272415FB0F8D75_OFFSET UNITYSDK_OFFSET(0x15180790)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_B4FEB1F5D516A801_OFFSET UNITYSDK_OFFSET(0x1517CE70)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1517E600)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x151807F0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_DE1755B73A3E9F2E_OFFSET UNITYSDK_OFFSET(0x1517F490)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_DE28E5797D5F3B4F_1_OFFSET UNITYSDK_OFFSET(0x151803F0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_DE28E5797D5F3B4F_OFFSET UNITYSDK_OFFSET(0x15180050)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_EA1355C3DBBA00B4_OFFSET UNITYSDK_OFFSET(0x15180BB0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_EC2956354B919FE0_OFFSET UNITYSDK_OFFSET(0x1517F0F0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_F05F95789250CAA6_OFFSET UNITYSDK_OFFSET(0x1517F9B0)
#define CLASS_1_2178DA8BBAE007EC_METHOD_1_F755ED20B18F4BDE_OFFSET UNITYSDK_OFFSET(0x1517ECA0)
#define CLASS_1_2178DA8BBAE007EC_SET_CURRENTATTACKER_OFFSET UNITYSDK_OFFSET(0x15180E60)
#define CLASS_1_2178DA8BBAE007EC_SET_CURRENTDEFENDER_OFFSET UNITYSDK_OFFSET(0x15180E80)
#define CLASS_1_2178DA8BBAE007EC_SET_ISMAZETOBATTLETRANSITIONSHOWSTARTED_OFFSET UNITYSDK_OFFSET(0x15180E40)
#define CLASS_1_2178DA8BBAE007EC__CCTOR_OFFSET UNITYSDK_OFFSET(0x15180E90)
#define CLASS_1_2178DA8BBAE007EC__CTOR_OFFSET UNITYSDK_OFFSET(0x1517BE10)
...
public:
	...
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2178DA8BBAE007EC_TypeDefinitionIndex)->GetStaticField(0x3360);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_Field_1_1()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2178DA8BBAE007EC_TypeDefinitionIndex)->GetStaticField(0x3368);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_Field_1_2()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2178DA8BBAE007EC_TypeDefinitionIndex)->GetStaticField(0x3370);
	}
	static ::RPG::Client::RPGProfilerMarker** StaticGet_Field_1_3()
	{
		return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2178DA8BBAE007EC_TypeDefinitionIndex)->GetStaticField(0x3378);
	}
	...
	::RPG::GameCore::GameEntity* _CurrentDefender_k__BackingField; // 0x60
	::RPG::GameCore::TransitionPerformConfig* Field_1_15; // 0x68
	::System::Action* Field_1_16; // 0x70
	::Class_3_07C3C4D2990C49EE* Field_1_17; // 0x78
	::System::Action* Field_1_18; // 0x80
	::Class_3_07C3C4D2990C49EE* Field_1_19; // 0x88
	::System::Action* Field_1_20; // 0x90
	...
	::RPG::Client::TransitionMode Field_1_25; // 0xB8
