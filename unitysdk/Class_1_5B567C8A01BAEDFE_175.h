...
#define CLASS_1_5B567C8A01BAEDFE_175_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C46CD20)
#define CLASS_1_5B567C8A01BAEDFE_175_CLONE_OFFSET UNITYSDK_OFFSET(0x1C46C9C0)
#define CLASS_1_5B567C8A01BAEDFE_175_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C46CB20)
#define CLASS_1_5B567C8A01BAEDFE_175_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C46CA30)
#define CLASS_1_5B567C8A01BAEDFE_175_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C46CC80)
#define CLASS_1_5B567C8A01BAEDFE_175_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C46CD70)
#define CLASS_1_5B567C8A01BAEDFE_175_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C46CD40)
#define CLASS_1_5B567C8A01BAEDFE_175_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C46C910)
#define CLASS_1_5B567C8A01BAEDFE_175_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C46C970)
#define CLASS_1_5B567C8A01BAEDFE_175_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C46CCB0)
#define CLASS_1_5B567C8A01BAEDFE_175_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C46CD10)
#define CLASS_1_5B567C8A01BAEDFE_175__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C46CDC0)
#define CLASS_1_5B567C8A01BAEDFE_175__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C46C990)
#define CLASS_1_5B567C8A01BAEDFE_175__CTOR_OFFSET UNITYSDK_OFFSET(0x1C46C980)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_175*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_175_TypeDefinitionIndex)->GetStaticField(0x27D40);
	}
