...
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_APPLY_OFFSET UNITYSDK_OFFSET(0x14512940)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x14512E10)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x145128A0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_METHOD_6_3D4699CA181772DC_OFFSET UNITYSDK_OFFSET(0x145123D0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_METHOD_6_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x14512C20)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_REFRESHCELESTIAL_OFFSET UNITYSDK_OFFSET(0x14512100)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_SETOBSERVER_OFFSET UNITYSDK_OFFSET(0x145125C0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_TICK_OFFSET UNITYSDK_OFFSET(0x145128B0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL_UPDATEFROMDATA_OFFSET UNITYSDK_OFFSET(0x145121F0)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x14512E80)
#define ENVIROMENTSYSTEMV2SPACE_ATMOSPHERECELESTIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x14512E60)
...
namespace EnviromentSystemV2Space
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AtmosphereCelestial_TypeDefinitionIndex)->GetStaticField(0x9110);
		}
