...
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYCOMPONENT_APPLY_OFFSET UNITYSDK_OFFSET(0x14535300)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYCOMPONENT_INIT_OFFSET UNITYSDK_OFFSET(0x14535390)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYCOMPONENT_ONENVOBJENABLE_OFFSET UNITYSDK_OFFSET(0x145353E0)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYCOMPONENT_ONFADINGBEGIN_OFFSET UNITYSDK_OFFSET(0x14535200)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYCOMPONENT_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0x14535250)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYCOMPONENT_ONFADING_OFFSET UNITYSDK_OFFSET(0x145351A0)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYCOMPONENT_RELEASE_OFFSET UNITYSDK_OFFSET(0x14535350)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYCOMPONENT_TICK_OFFSET UNITYSDK_OFFSET(0x145352A0)
#define ENVIROMENTSYSTEMV2SPACE_PREFABPROPERTYCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x14535430)
