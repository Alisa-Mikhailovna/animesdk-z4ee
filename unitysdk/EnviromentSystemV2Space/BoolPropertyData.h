...
#define ENVIROMENTSYSTEMV2SPACE_BOOLPROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0x14513130)
#define ENVIROMENTSYSTEMV2SPACE_BOOLPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x145131C0)
