...
#define ENVIROMENTSYSTEMV2SPACE_FLOATPROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0x145318A0)
#define ENVIROMENTSYSTEMV2SPACE_FLOATPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14531930)
