...
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT_INIT_OFFSET UNITYSDK_OFFSET(0x14535AC0)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT_ONFADINGEND_OFFSET UNITYSDK_OFFSET(0x14535A20)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT_ONFADING_OFFSET UNITYSDK_OFFSET(0x14535970)
#define ENVIROMENTSYSTEMV2SPACE_TESTPREFABPROPERTYCOMPOENT__CTOR_OFFSET UNITYSDK_OFFSET(0x14535B50)
