...
#define ENVIROMENTSYSTEMV2SPACE_INTPROPERTYDATA_METHOD_3_82ABFE24D5168B0C_OFFSET UNITYSDK_OFFSET(0x14531F20)
#define ENVIROMENTSYSTEMV2SPACE_INTPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14531FB0)
