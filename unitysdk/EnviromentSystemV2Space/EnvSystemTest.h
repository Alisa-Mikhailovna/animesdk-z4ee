...
#define ENVIROMENTSYSTEMV2SPACE_ENVSYSTEMTEST_AWAKE_OFFSET UNITYSDK_OFFSET(0x1451DD90)
#define ENVIROMENTSYSTEMV2SPACE_ENVSYSTEMTEST_GETDATA_OFFSET UNITYSDK_OFFSET(0x1451DD40)
#define ENVIROMENTSYSTEMV2SPACE_ENVSYSTEMTEST_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1451DEC0)
#define ENVIROMENTSYSTEMV2SPACE_ENVSYSTEMTEST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1451DF60)
#define ENVIROMENTSYSTEMV2SPACE_ENVSYSTEMTEST_RENDER_OFFSET UNITYSDK_OFFSET(0x1451DCE0)
#define ENVIROMENTSYSTEMV2SPACE_ENVSYSTEMTEST_SET_OFFSET UNITYSDK_OFFSET(0x1451DC90)
#define ENVIROMENTSYSTEMV2SPACE_ENVSYSTEMTEST_TESTUPDATESIMPLEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1451DFC0)
#define ENVIROMENTSYSTEMV2SPACE_ENVSYSTEMTEST_UPDATE_OFFSET UNITYSDK_OFFSET(0x1451DE50)
#define ENVIROMENTSYSTEMV2SPACE_ENVSYSTEMTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1451E000)
