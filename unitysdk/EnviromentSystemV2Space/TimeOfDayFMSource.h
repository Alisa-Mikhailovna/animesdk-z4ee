...
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x14536510)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_AUTOACTIVE_OFFSET UNITYSDK_OFFSET(0x145365F0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_CHANNELNAME_OFFSET UNITYSDK_OFFSET(0x14536630)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x14536570)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_GET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x145365D0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_METHOD_5_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0x14536420)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONCHANNELACTIVE_OFFSET UNITYSDK_OFFSET(0x14536670)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONCHANNELDEACTIVE_OFFSET UNITYSDK_OFFSET(0x145366C0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONCHANNELUPDATE_OFFSET UNITYSDK_OFFSET(0x14536700)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x14536280)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x145360F0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_REGISTERSOURCE_OFFSET UNITYSDK_OFFSET(0x14536140)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_SAMPLE_OFFSET UNITYSDK_OFFSET(0x14536760)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_SET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x145365E0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_UNREGISTERSOURCE_OFFSET UNITYSDK_OFFSET(0x145362D0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE_UPDATE_OFFSET UNITYSDK_OFFSET(0x145363C0)
#define ENVIROMENTSYSTEMV2SPACE_TIMEOFDAYFMSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x14536850)
