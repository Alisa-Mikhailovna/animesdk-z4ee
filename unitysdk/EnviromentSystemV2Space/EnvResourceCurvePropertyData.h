...
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_1A1283E6D869BB8A_OFFSET UNITYSDK_OFFSET(0x1451D860)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA_METHOD_3_A034FB093FB7C7DD_OFFSET UNITYSDK_OFFSET(0x1451D970)
#define ENVIROMENTSYSTEMV2SPACE_ENVRESOURCECURVEPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1451DA90)
