...
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x14534D70)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTDISTANCE_OFFSET UNITYSDK_OFFSET(0x14534CE0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x14534C90)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_GETCURRENTSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x14534D30)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_2747B6E1C570CBE2_OFFSET UNITYSDK_OFFSET(0x14534510)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_4415A966EAD05399_OFFSET UNITYSDK_OFFSET(0x14534A80)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_64193BDBED1866DF_OFFSET UNITYSDK_OFFSET(0x145347D0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_705FFC79B57F4953_OFFSET UNITYSDK_OFFSET(0x14534190)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_7E832D0C2C340C33_OFFSET UNITYSDK_OFFSET(0x14534430)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_METHOD_5_FD6692A5F6B0AC0C_OFFSET UNITYSDK_OFFSET(0x14533FE0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x14534350)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x14534140)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x14533DD0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_REMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x14534E50)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x14533F90)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x145343A0)
#define ENVIROMENTSYSTEMV2SPACE_PATHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14534EF0)
