...
#define CLASS_1_5B567C8A01BAEDFE_207_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C3D2DF0)
#define CLASS_1_5B567C8A01BAEDFE_207_CLONE_OFFSET UNITYSDK_OFFSET(0x1C3D2AE0)
#define CLASS_1_5B567C8A01BAEDFE_207_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C3D2BF0)
#define CLASS_1_5B567C8A01BAEDFE_207_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C3D2B20)
#define CLASS_1_5B567C8A01BAEDFE_207_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C3D2D50)
#define CLASS_1_5B567C8A01BAEDFE_207_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C3D2E40)
#define CLASS_1_5B567C8A01BAEDFE_207_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C3D2E10)
#define CLASS_1_5B567C8A01BAEDFE_207_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C3D2A60)
#define CLASS_1_5B567C8A01BAEDFE_207_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C3D2A90)
#define CLASS_1_5B567C8A01BAEDFE_207_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C3D2D80)
#define CLASS_1_5B567C8A01BAEDFE_207_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C3D2DE0)
#define CLASS_1_5B567C8A01BAEDFE_207__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C3D2E90)
#define CLASS_1_5B567C8A01BAEDFE_207__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3D2AB0)
#define CLASS_1_5B567C8A01BAEDFE_207__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3D2AA0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_207*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_207_TypeDefinitionIndex)->GetStaticField(0x49C00);
	}
