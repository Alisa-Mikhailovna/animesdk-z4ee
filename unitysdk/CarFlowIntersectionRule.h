...
#define CARFLOWINTERSECTIONRULE_ADDCAR_OFFSET UNITYSDK_OFFSET(0xD0604C0)
#define CARFLOWINTERSECTIONRULE_GETCARLIMIT_OFFSET UNITYSDK_OFFSET(0xD060630)
#define CARFLOWINTERSECTIONRULE_GET_CARS_OFFSET UNITYSDK_OFFSET(0xD060480)
#define CARFLOWINTERSECTIONRULE_GET_CURVE_OFFSET UNITYSDK_OFFSET(0xD0604A0)
#define CARFLOWINTERSECTIONRULE_GET_MATH_OFFSET UNITYSDK_OFFSET(0xD060460)
#define CARFLOWINTERSECTIONRULE_REMOVECAR_OFFSET UNITYSDK_OFFSET(0xD0605A0)
#define CARFLOWINTERSECTIONRULE_SET_CARS_OFFSET UNITYSDK_OFFSET(0xD060490)
#define CARFLOWINTERSECTIONRULE_SET_CURVE_OFFSET UNITYSDK_OFFSET(0xD0604B0)
#define CARFLOWINTERSECTIONRULE_SET_MATH_OFFSET UNITYSDK_OFFSET(0xD060470)
#define CARFLOWINTERSECTIONRULE__CTOR_OFFSET UNITYSDK_OFFSET(0xD060710)
