...
#define GOOGLE_PROTOBUF_MESSAGEPARSER_CHECKMERGEDREQUIREDFIELDS_OFFSET UNITYSDK_OFFSET(0x197D5BA0)
#define GOOGLE_PROTOBUF_MESSAGEPARSER_GET_DISCARDUNKNOWNFIELDS_OFFSET UNITYSDK_OFFSET(0x197D5B70)
#define GOOGLE_PROTOBUF_MESSAGEPARSER_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x197D5B80)
#define GOOGLE_PROTOBUF_MESSAGEPARSER_PARSEFROM_OFFSET UNITYSDK_OFFSET(0x197D2970)
#define GOOGLE_PROTOBUF_MESSAGEPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x197D5B90)
