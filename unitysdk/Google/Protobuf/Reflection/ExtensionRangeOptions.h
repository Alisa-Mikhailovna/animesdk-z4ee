...
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x197EA760)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_CLONE_OFFSET UNITYSDK_OFFSET(0x197DB340)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x197EA460)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_EQUALS_OFFSET UNITYSDK_OFFSET(0x197EA230)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x197DBA30)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x197E9F20)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x197E9EC0)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x197EA810)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x197DC260)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x197EA100)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x197EA630)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS_WRITETO_OFFSET UNITYSDK_OFFSET(0x197EA690)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x197EA9F0)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197EA160)
#define GOOGLE_PROTOBUF_REFLECTION_EXTENSIONRANGEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x197DC210)
...
namespace Google::Protobuf::Reflection
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Google::Protobuf::Reflection::ExtensionRangeOptions*>**)Il2CppClass::FromTypeDefinitionIndex(ExtensionRangeOptions_TypeDefinitionIndex)->GetStaticField(0x42E70);
		}
		...
		{
			return (::Google::Protobuf::FieldCodec_1<::Google::Protobuf::Reflection::UninterpretedOption*>**)Il2CppClass::FromTypeDefinitionIndex(ExtensionRangeOptions_TypeDefinitionIndex)->GetStaticField(0x42E78);
		}
