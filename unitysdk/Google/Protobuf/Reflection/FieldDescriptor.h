...
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_COMPARETO_OFFSET UNITYSDK_OFFSET(0x197EB190)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_CREATEACCESSOR_OFFSET UNITYSDK_OFFSET(0x197EB3D0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_CROSSLINK_OFFSET UNITYSDK_OFFSET(0x197E8F70)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GETFIELDTYPEFROMPROTOTYPE_OFFSET UNITYSDK_OFFSET(0x197EAEF0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ACCESSOR_OFFSET UNITYSDK_OFFSET(0x197EB0B0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_CONTAININGONEOF_OFFSET UNITYSDK_OFFSET(0x197EADE0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_CONTAININGTYPE_OFFSET UNITYSDK_OFFSET(0x197EADD0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_EXTENDEETYPE_OFFSET UNITYSDK_OFFSET(0x197D85F0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_EXTENSION_OFFSET UNITYSDK_OFFSET(0x197EAE10)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_FIELDNUMBER_OFFSET UNITYSDK_OFFSET(0x197D2A20)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_FIELDTYPE_OFFSET UNITYSDK_OFFSET(0x197EB120)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISMAP_OFFSET UNITYSDK_OFFSET(0x197CDC80)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISREPEATED_OFFSET UNITYSDK_OFFSET(0x197CDD10)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISREQUIRED_OFFSET UNITYSDK_OFFSET(0x197D5B00)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x197EADF0)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x197D8670)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_PROTO_OFFSET UNITYSDK_OFFSET(0x197EAE00)
#define GOOGLE_PROTOBUF_REFLECTION_FIELDDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x197E9760)
...
namespace Google::Protobuf::Reflection
{
	...
	public:
		...
		::Google::Protobuf::Reflection::EnumDescriptor* enumType; // 0x40
		::Google::Protobuf::Reflection::OneofDescriptor* _ContainingOneof_k__BackingField; // 0x48
		...
		::Google::Protobuf::Reflection::FieldDescriptorProto* _Proto_k__BackingField; // 0x70
