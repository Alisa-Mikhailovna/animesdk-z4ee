...
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x197D4CE0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x197D3DD0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_2_OFFSET UNITYSDK_OFFSET(0x197D3FD0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_3_OFFSET UNITYSDK_OFFSET(0x197D3C00)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_4_OFFSET UNITYSDK_OFFSET(0x197D3DF0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_5_OFFSET UNITYSDK_OFFSET(0x197D3FE0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x197D3BF0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_TOBYTEARRAYFROMPOOL_OFFSET UNITYSDK_OFFSET(0x197D4570)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x197D41C0)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_TOBYTESTRING_OFFSET UNITYSDK_OFFSET(0x197D4C30)
#define GOOGLE_PROTOBUF_MESSAGEEXTENSIONS_WRITETO_OFFSET UNITYSDK_OFFSET(0x197D4950)
