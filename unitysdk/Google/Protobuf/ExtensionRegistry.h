...
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_ADD_1_OFFSET UNITYSDK_OFFSET(0x197C70F0)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_ADD_2_OFFSET UNITYSDK_OFFSET(0x197C7170)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_ADD_OFFSET UNITYSDK_OFFSET(0x197C6EE0)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_CLEAR_OFFSET UNITYSDK_OFFSET(0x197C7620)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_CLONE_OFFSET UNITYSDK_OFFSET(0x197C80B0)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_CONTAINSINPUTFIELD_OFFSET UNITYSDK_OFFSET(0x197C6D70)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x197C7750)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x197C7C60)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x197C6C30)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_REMOVE_OFFSET UNITYSDK_OFFSET(0x197C7EA0)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_GOOGLE_PROTOBUF_EXTENSION__COPYTO_OFFSET UNITYSDK_OFFSET(0x197C7950)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_GOOGLE_PROTOBUF_EXTENSION__GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x197C6D60)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x197C80A0)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197C6A00)
#define GOOGLE_PROTOBUF_EXTENSIONREGISTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x197C6970)
