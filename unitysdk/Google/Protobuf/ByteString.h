...
#define GOOGLE_PROTOBUF_BYTESTRING_ATTACHBYTES_OFFSET UNITYSDK_OFFSET(0x197C0200)
#define GOOGLE_PROTOBUF_BYTESTRING_COPYFROMUTF8_OFFSET UNITYSDK_OFFSET(0x197C0800)
#define GOOGLE_PROTOBUF_BYTESTRING_COPYFROM_1_OFFSET UNITYSDK_OFFSET(0x197C05A0)
#define GOOGLE_PROTOBUF_BYTESTRING_COPYFROM_2_OFFSET UNITYSDK_OFFSET(0x197C0630)
#define GOOGLE_PROTOBUF_BYTESTRING_COPYFROM_3_OFFSET UNITYSDK_OFFSET(0x197C0750)
#define GOOGLE_PROTOBUF_BYTESTRING_COPYFROM_OFFSET UNITYSDK_OFFSET(0x197C04B0)
#define GOOGLE_PROTOBUF_BYTESTRING_COPYTO_OFFSET UNITYSDK_OFFSET(0x197C1210)
#define GOOGLE_PROTOBUF_BYTESTRING_CREATECODEDINPUT_OFFSET UNITYSDK_OFFSET(0x197C0AD0)
#define GOOGLE_PROTOBUF_BYTESTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x197C0FC0)
#define GOOGLE_PROTOBUF_BYTESTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x197C0DC0)
#define GOOGLE_PROTOBUF_BYTESTRING_FINALIZE_OFFSET UNITYSDK_OFFSET(0x197C0280)
#define GOOGLE_PROTOBUF_BYTESTRING_FROMBASE64_OFFSET UNITYSDK_OFFSET(0x197C03D0)
#define GOOGLE_PROTOBUF_BYTESTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x197C0990)
#define GOOGLE_PROTOBUF_BYTESTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x197C0ED0)
#define GOOGLE_PROTOBUF_BYTESTRING_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x197C0300)
#define GOOGLE_PROTOBUF_BYTESTRING_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x197C0330)
#define GOOGLE_PROTOBUF_BYTESTRING_GET_MEMORY_OFFSET UNITYSDK_OFFSET(0x197C0340)
#define GOOGLE_PROTOBUF_BYTESTRING_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x197C0C10)
#define GOOGLE_PROTOBUF_BYTESTRING_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x197C0CE0)
#define GOOGLE_PROTOBUF_BYTESTRING_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x197C0AC0)
#define GOOGLE_PROTOBUF_BYTESTRING_TOBASE64_OFFSET UNITYSDK_OFFSET(0x197C03B0)
#define GOOGLE_PROTOBUF_BYTESTRING_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x197C0370)
#define GOOGLE_PROTOBUF_BYTESTRING_TOSTRINGUTF8_OFFSET UNITYSDK_OFFSET(0x197C08E0)
#define GOOGLE_PROTOBUF_BYTESTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x197C0840)
#define GOOGLE_PROTOBUF_BYTESTRING_WRITERAWBYTESTO_OFFSET UNITYSDK_OFFSET(0x197C10C0)
#define GOOGLE_PROTOBUF_BYTESTRING__CCTOR_OFFSET UNITYSDK_OFFSET(0x197C12A0)
#define GOOGLE_PROTOBUF_BYTESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x197C0250)
...
namespace Google::Protobuf
{
	...
	public:
		...
		{
			return (::Google::Protobuf::ByteString**)Il2CppClass::FromTypeDefinitionIndex(ByteString_TypeDefinitionIndex)->GetStaticField(0x1DD50);
		}
