...
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1981EC70)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_CLONE_OFFSET UNITYSDK_OFFSET(0x1981E0B0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1981E380)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_EQUALS_OFFSET UNITYSDK_OFFSET(0x1981E320)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1981E4E0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_CARDINALITY_OFFSET UNITYSDK_OFFSET(0x1981E120)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1981E2C0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1981DC10)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1981E260)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_KIND_OFFSET UNITYSDK_OFFSET(0x1981E100)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1981E160)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_NUMBER_OFFSET UNITYSDK_OFFSET(0x1981E140)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_ONEOFINDEX_OFFSET UNITYSDK_OFFSET(0x1981E220)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_PACKED_OFFSET UNITYSDK_OFFSET(0x1981E240)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1981DBB0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_GET_TYPEURL_OFFSET UNITYSDK_OFFSET(0x1981E1C0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1981F2E0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1981F0D0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1981DDF0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_CARDINALITY_OFFSET UNITYSDK_OFFSET(0x1981E130)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1981E2D0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1981E270)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_KIND_OFFSET UNITYSDK_OFFSET(0x1981E110)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1981E170)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_NUMBER_OFFSET UNITYSDK_OFFSET(0x1981E150)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_ONEOFINDEX_OFFSET UNITYSDK_OFFSET(0x1981E230)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_PACKED_OFFSET UNITYSDK_OFFSET(0x1981E250)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_SET_TYPEURL_OFFSET UNITYSDK_OFFSET(0x1981E1D0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1981E760)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD_WRITETO_OFFSET UNITYSDK_OFFSET(0x1981E7C0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD__CCTOR_OFFSET UNITYSDK_OFFSET(0x1981F590)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1981DED0)
#define GOOGLE_PROTOBUF_WELLKNOWNTYPES_FIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1981DE50)
...
namespace Google::Protobuf::WellKnownTypes
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Google::Protobuf::WellKnownTypes::Field*>**)Il2CppClass::FromTypeDefinitionIndex(Field_TypeDefinitionIndex)->GetStaticField(0x44780);
		}
		static ::Google::Protobuf::FieldCodec_1<::Google::Protobuf::WellKnownTypes::Option*>** StaticGet__repeated_options_codec()
		{
			return (::Google::Protobuf::FieldCodec_1<::Google::Protobuf::WellKnownTypes::Option*>**)Il2CppClass::FromTypeDefinitionIndex(Field_TypeDefinitionIndex)->GetStaticField(0x44788);
		}
		...
		::Google::Protobuf::WellKnownTypes::Field_Types_Cardinality cardinality_; // 0x4C
