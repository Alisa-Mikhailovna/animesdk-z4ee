...
#define SRDEBUGGER_OPTIONDEFINITION_CREATE_OFFSET UNITYSDK_OFFSET(0x1C9C9BF0)
#define SRDEBUGGER_OPTIONDEFINITION_FROMMETHOD_1_OFFSET UNITYSDK_OFFSET(0x1C9C9C00)
#define SRDEBUGGER_OPTIONDEFINITION_FROMMETHOD_OFFSET UNITYSDK_OFFSET(0x1C9C9AD0)
#define SRDEBUGGER_OPTIONDEFINITION_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1C9C99E0)
#define SRDEBUGGER_OPTIONDEFINITION_GET_ISMETHOD_OFFSET UNITYSDK_OFFSET(0x1C9C9A40)
#define SRDEBUGGER_OPTIONDEFINITION_GET_ISPROPERTY_OFFSET UNITYSDK_OFFSET(0x1C9C9A50)
#define SRDEBUGGER_OPTIONDEFINITION_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1C9C9A60)
#define SRDEBUGGER_OPTIONDEFINITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C9C99C0)
#define SRDEBUGGER_OPTIONDEFINITION_GET_PROPERTY_OFFSET UNITYSDK_OFFSET(0x1C9C9A80)
#define SRDEBUGGER_OPTIONDEFINITION_GET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1C9C9A00)
#define SRDEBUGGER_OPTIONDEFINITION_GET_TARGETTAB_OFFSET UNITYSDK_OFFSET(0x1C9C9A20)
#define SRDEBUGGER_OPTIONDEFINITION_SET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1C9C99F0)
#define SRDEBUGGER_OPTIONDEFINITION_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x1C9C9A70)
#define SRDEBUGGER_OPTIONDEFINITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1C9C99D0)
#define SRDEBUGGER_OPTIONDEFINITION_SET_PROPERTY_OFFSET UNITYSDK_OFFSET(0x1C9C9A90)
#define SRDEBUGGER_OPTIONDEFINITION_SET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1C9C9A10)
#define SRDEBUGGER_OPTIONDEFINITION_SET_TARGETTAB_OFFSET UNITYSDK_OFFSET(0x1C9C9A30)
#define SRDEBUGGER_OPTIONDEFINITION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C9C96E0)
#define SRDEBUGGER_OPTIONDEFINITION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C9C9500)
#define SRDEBUGGER_OPTIONDEFINITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9C9AA0)
