...
#define SRDEBUGGER_SETTINGS_ADD_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C9E0D60)
#define SRDEBUGGER_SETTINGS_CLEARCACHE_OFFSET UNITYSDK_OFFSET(0x1C9E1470)
#define SRDEBUGGER_SETTINGS_GETDEFAULTKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1C9E09B0)
#define SRDEBUGGER_SETTINGS_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C9E1660)
#define SRDEBUGGER_SETTINGS_GETORCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C9E08E0)
#define SRDEBUGGER_SETTINGS_GET_APIKEY_OFFSET UNITYSDK_OFFSET(0x1C9E1240)
#define SRDEBUGGER_SETTINGS_GET_AUTOMATICALLYSHOWCURSOR_OFFSET UNITYSDK_OFFSET(0x1C9E1310)
#define SRDEBUGGER_SETTINGS_GET_COLLAPSEDUPLICATELOGENTRIES_OFFSET UNITYSDK_OFFSET(0x1C9E1220)
#define SRDEBUGGER_SETTINGS_GET_CONSOLEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C9E12B0)
#define SRDEBUGGER_SETTINGS_GET_DEBUGCAMERADEPTH_OFFSET UNITYSDK_OFFSET(0x1C9E1210)
#define SRDEBUGGER_SETTINGS_GET_DEBUGLAYER_OFFSET UNITYSDK_OFFSET(0x1C9E1200)
#define SRDEBUGGER_SETTINGS_GET_DEFAULTTAB_OFFSET UNITYSDK_OFFSET(0x1C9E0E40)
#define SRDEBUGGER_SETTINGS_GET_DISABLEDTABS_OFFSET UNITYSDK_OFFSET(0x1C9E1270)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBACKGROUNDTRANSPARENCY_OFFSET UNITYSDK_OFFSET(0x1C9E0EB0)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBUGREPORTER_OFFSET UNITYSDK_OFFSET(0x1C9E1250)
#define SRDEBUGGER_SETTINGS_GET_ENABLEBUGREPORTSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1C9E1260)
#define SRDEBUGGER_SETTINGS_GET_ENABLEEVENTSYSTEMGENERATION_OFFSET UNITYSDK_OFFSET(0x1C9E12F0)
#define SRDEBUGGER_SETTINGS_GET_ENABLEKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1C9E0E80)
#define SRDEBUGGER_SETTINGS_GET_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x1C9E0E50)
#define SRDEBUGGER_SETTINGS_GET_ENTRYCODE_OFFSET UNITYSDK_OFFSET(0x1C9D8D00)
#define SRDEBUGGER_SETTINGS_GET_ERRORNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1C9E0E70)
#define SRDEBUGGER_SETTINGS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1C9C8590)
#define SRDEBUGGER_SETTINGS_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1C9E0E20)
#define SRDEBUGGER_SETTINGS_GET_KEYBOARDESCAPECLOSE_OFFSET UNITYSDK_OFFSET(0x1C9E0EA0)
#define SRDEBUGGER_SETTINGS_GET_KEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1C9E0E90)
#define SRDEBUGGER_SETTINGS_GET_MAXIMUMCONSOLEENTRIES_OFFSET UNITYSDK_OFFSET(0x1C9E12D0)
#define SRDEBUGGER_SETTINGS_GET_OPTIONSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C9E12A0)
#define SRDEBUGGER_SETTINGS_GET_PROFILERALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C9E1290)
#define SRDEBUGGER_SETTINGS_GET_REQUIRECODE_OFFSET UNITYSDK_OFFSET(0x1C9E0EC0)
#define SRDEBUGGER_SETTINGS_GET_REQUIREENTRYCODEEVERYTIME_OFFSET UNITYSDK_OFFSET(0x1C9E0ED0)
#define SRDEBUGGER_SETTINGS_GET_RICHTEXTINCONSOLE_OFFSET UNITYSDK_OFFSET(0x1C9E1230)
#define SRDEBUGGER_SETTINGS_GET_TRIGGERBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1C9E0E60)
#define SRDEBUGGER_SETTINGS_GET_TRIGGERPOSITION_OFFSET UNITYSDK_OFFSET(0x1C9E1280)
#define SRDEBUGGER_SETTINGS_GET_UIINPUTMODE_OFFSET UNITYSDK_OFFSET(0x1C9E0E30)
#define SRDEBUGGER_SETTINGS_GET_UISCALE_OFFSET UNITYSDK_OFFSET(0x1C9E1320)
#define SRDEBUGGER_SETTINGS_GET_UNLOADONCLOSE_OFFSET UNITYSDK_OFFSET(0x1C9E1460)
#define SRDEBUGGER_SETTINGS_GET_USEDEBUGCAMERA_OFFSET UNITYSDK_OFFSET(0x1C9E11F0)
#define SRDEBUGGER_SETTINGS_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C9E13F0)
#define SRDEBUGGER_SETTINGS_REMOVE_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C9E0DC0)
#define SRDEBUGGER_SETTINGS_SET_CONSOLEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C9E12C0)
#define SRDEBUGGER_SETTINGS_SET_ENABLEEVENTSYSTEMGENERATION_OFFSET UNITYSDK_OFFSET(0x1C9E1300)
#define SRDEBUGGER_SETTINGS_SET_ENTRYCODE_OFFSET UNITYSDK_OFFSET(0x1C9E0EE0)
#define SRDEBUGGER_SETTINGS_SET_MAXIMUMCONSOLEENTRIES_OFFSET UNITYSDK_OFFSET(0x1C9E12E0)
#define SRDEBUGGER_SETTINGS_SET_UISCALE_OFFSET UNITYSDK_OFFSET(0x1C9E1330)
#define SRDEBUGGER_SETTINGS_UPGRADEKEYBOARDSHORTCUTS_OFFSET UNITYSDK_OFFSET(0x1C9E0AE0)
#define SRDEBUGGER_SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E1710)
...
namespace SRDebugger
{
	...
	public:
		...
		{
			return (::SRDebugger::Settings**)Il2CppClass::FromTypeDefinitionIndex(Settings_TypeDefinitionIndex)->GetStaticField(0x63CB0);
		}
