...
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER_ADDOPTION_OFFSET UNITYSDK_OFFSET(0x1C9C4220)
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER_ADD_OPTIONADDED_OFFSET UNITYSDK_OFFSET(0x1C9C4370)
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER_ADD_OPTIONREMOVED_OFFSET UNITYSDK_OFFSET(0x1C9C4430)
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1C9C4360)
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1C9C4150)
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER_REMOVEOPTION_OFFSET UNITYSDK_OFFSET(0x1C9C42D0)
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER_REMOVE_OPTIONADDED_OFFSET UNITYSDK_OFFSET(0x1C9C43D0)
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER_REMOVE_OPTIONREMOVED_OFFSET UNITYSDK_OFFSET(0x1C9C4490)
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER_SRDEBUGGER_IOPTIONCONTAINER_GETOPTIONS_OFFSET UNITYSDK_OFFSET(0x1C9C4350)
#define SRDEBUGGER_DYNAMICOPTIONCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9C4160)
