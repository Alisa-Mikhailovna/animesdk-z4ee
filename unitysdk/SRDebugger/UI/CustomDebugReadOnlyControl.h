...
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_CANBIND_OFFSET UNITYSDK_OFFSET(0xDD3DE90)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_ONBIND_OFFSET UNITYSDK_OFFSET(0xDD3DE70)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_ONVALUEUPDATED_OFFSET UNITYSDK_OFFSET(0xDD3DE80)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL_START_OFFSET UNITYSDK_OFFSET(0xDD3DE60)
#define SRDEBUGGER_UI_CUSTOMDEBUGREADONLYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xDD3DEA0)
