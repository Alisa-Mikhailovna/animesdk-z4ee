...
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_ACTIVATEREFRESHEVERYFRAME_OFFSET UNITYSDK_OFFSET(0x1C9F5CC0)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_CREATEBLOCK_OFFSET UNITYSDK_OFFSET(0x1C9F5CF0)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_FILLINFOBLOCK_OFFSET UNITYSDK_OFFSET(0x1C9F5E50)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_INTERNALREFRESH_OFFSET UNITYSDK_OFFSET(0x1C9F54C0)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C9F5480)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1C9F5C80)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9F5CB0)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9F7090)
#define SRDEBUGGER_UI_TABS_INFOTABCONTROLLER__GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1C9F6E40)
