...
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C9FD6A0)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_PINTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1C9FD620)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1C9FD4F0)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1C9FD320)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9FD6B0)
#define SRDEBUGGER_UI_TABS_PROFILERTABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9FD7F0)
