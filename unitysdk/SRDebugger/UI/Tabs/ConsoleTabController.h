...
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C9F4FE0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CONSOLELOGSELECTEDITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x1C9F4B20)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_CONSOLEONUPDATED_OFFSET UNITYSDK_OFFSET(0x1C9F4FD0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_COPYTOCLIPBOARD_OFFSET UNITYSDK_OFFSET(0x1C9F4E20)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FADECOPYBUTTON_OFFSET UNITYSDK_OFFSET(0x1C9F4F70)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FILTERTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1C9F44B0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_FILTERVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1C9F4590)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGGINGDISABLECLOSEANDIGNOREPRESSED_OFFSET UNITYSDK_OFFSET(0x1C9F5080)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGGINGDISABLEREENABLEPRESSED_OFFSET UNITYSDK_OFFSET(0x1C9F50B0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_LOGHANDLERHASBEENOVERRIDENOKAYBUTTONPRESS_OFFSET UNITYSDK_OFFSET(0x1C9F5050)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C9F48C0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C9F4A90)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C9F4A80)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_PANELONVISIBILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C9F4650)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_PINTOGGLEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1C9F47A0)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_POPULATESTACKTRACEAREA_OFFSET UNITYSDK_OFFSET(0x1C9F3B10)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1C9F3E60)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_SETCOPYTOCLIPBOARDBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x1C9F4B80)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1C9F3500)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_STOPANIMATIONS_OFFSET UNITYSDK_OFFSET(0x1C9F4710)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9F4B70)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9F5250)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_0_OFFSET UNITYSDK_OFFSET(0x1C9F5260)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_1_OFFSET UNITYSDK_OFFSET(0x1C9F5270)
#define SRDEBUGGER_UI_TABS_CONSOLETABCONTROLLER__START_B__26_2_OFFSET UNITYSDK_OFFSET(0x1C9F5280)
...
namespace SRDebugger::UI::Tabs
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ConsoleTabController_TypeDefinitionIndex)->GetStaticField(0x13F50);
		}
		static ::System::Boolean* StaticGet__hasWarnedAboutLogHandler()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ConsoleTabController_TypeDefinitionIndex)->GetStaticField(0x13F51);
		}
