...
#define SRDEBUGGER_UI_TABS_OPTIONSTABCONTROLLER_CATEGORYINSTANCE_GET_CATEGORYGROUP_OFFSET UNITYSDK_OFFSET(0x1C9FD300)
#define SRDEBUGGER_UI_TABS_OPTIONSTABCONTROLLER_CATEGORYINSTANCE_SET_CATEGORYGROUP_OFFSET UNITYSDK_OFFSET(0x1C9FD310)
#define SRDEBUGGER_UI_TABS_OPTIONSTABCONTROLLER_CATEGORYINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9FB980)
