...
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1C9EBA70)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C9EB5C0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK_TRIGGERCLEANUP_OFFSET UNITYSDK_OFFSET(0x1C9EBA20)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK_TRIGGERREFRESH_OFFSET UNITYSDK_OFFSET(0x1C9EB5D0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9EB960)
#define SRDEBUGGER_UI_CONTROLS_PROFILERMEMORYBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9EBAD0)
