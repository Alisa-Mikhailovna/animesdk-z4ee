...
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C9E2060)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_CONSOLEONUPDATED_OFFSET UNITYSDK_OFFSET(0x1C9E2910)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_GET_ENABLESELECTION_OFFSET UNITYSDK_OFFSET(0x1C9E1FC0)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_GET_FILTER_OFFSET UNITYSDK_OFFSET(0x1C9E2000)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_GET_SHOWERRORS_OFFSET UNITYSDK_OFFSET(0x1C9E1F50)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_GET_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x1C9E1FA0)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_GET_SHOWWARNINGS_OFFSET UNITYSDK_OFFSET(0x1C9E1F80)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C9E22F0)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_ONMOVE_OFFSET UNITYSDK_OFFSET(0x1C9E2A00)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_ONNAVIENTER_OFFSET UNITYSDK_OFFSET(0x1C9E2920)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_ONSELECTEDITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x1C9E2450)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_OPTIONCONTROL_OFFSET UNITYSDK_OFFSET(0x1C9E29F0)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_REFRESH_OFFSET UNITYSDK_OFFSET(0x1C9E2520)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_SCROLLTOBOTTOM_OFFSET UNITYSDK_OFFSET(0x1C9E2290)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_SETISDIRTY_OFFSET UNITYSDK_OFFSET(0x1C9E1F70)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_SET_ENABLESELECTION_OFFSET UNITYSDK_OFFSET(0x1C9E1FE0)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_SET_FILTER_OFFSET UNITYSDK_OFFSET(0x1C9E2010)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_SET_SHOWERRORS_OFFSET UNITYSDK_OFFSET(0x1C9E1F60)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_SET_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x1C9E1FB0)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_SET_SHOWWARNINGS_OFFSET UNITYSDK_OFFSET(0x1C9E1F90)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_START_OFFSET UNITYSDK_OFFSET(0x1C9E2240)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9E24C0)
#define SRDEBUGGER_UI_CONTROLS_CONSOLELOGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E2B00)
