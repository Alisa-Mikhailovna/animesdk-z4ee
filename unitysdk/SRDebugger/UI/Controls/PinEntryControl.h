...
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ADD_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9D5AE0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C9E7FD0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_CANCELBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1C9E8700)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C9D5920)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_HANDLECHARACTER_OFFSET UNITYSDK_OFFSET(0x1C9E8450)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_HIDE_OFFSET UNITYSDK_OFFSET(0x1C9D5A90)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONCANCEL_OFFSET UNITYSDK_OFFSET(0x1C9E86C0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9E8640)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C9E8300)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C9E82F0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_PLAYINVALIDCODEANIMATION_OFFSET UNITYSDK_OFFSET(0x1C9D5CA0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_PUSHNUMBER_OFFSET UNITYSDK_OFFSET(0x1C9E84C0)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x1C9E8180)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_REMOVE_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9E7F50)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_SHOW_OFFSET UNITYSDK_OFFSET(0x1C9D5950)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9E8310)
#define SRDEBUGGER_UI_CONTROLS_PINENTRYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E8760)
