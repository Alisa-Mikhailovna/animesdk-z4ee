...
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHAXISLABEL_SETVALUEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C9E8F90)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHAXISLABEL_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1C9E92C0)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHAXISLABEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9E8F60)
#define SRDEBUGGER_UI_CONTROLS_PROFILERGRAPHAXISLABEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E9300)
