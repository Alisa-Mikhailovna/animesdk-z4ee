...
#define SRDEBUGGER_UI_CONTROLS_SRTABBUTTON_GET_CACHERECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C9ECD70)
#define SRDEBUGGER_UI_CONTROLS_SRTABBUTTON_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1C9ECD20)
#define SRDEBUGGER_UI_CONTROLS_SRTABBUTTON_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1C9ECD40)
#define SRDEBUGGER_UI_CONTROLS_SRTABBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9ECE40)
