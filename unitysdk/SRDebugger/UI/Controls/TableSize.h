...
#define SRDEBUGGER_UI_CONTROLS_TABLESIZE_SYSTEM_ICOMPARABLE_SRDEBUGGER_UI_CONTROLS_TABLESIZE__COMPARETO_OFFSET UNITYSDK_OFFSET(0x1C9ECE50)
#define SRDEBUGGER_UI_CONTROLS_TABLESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9ECE80)
