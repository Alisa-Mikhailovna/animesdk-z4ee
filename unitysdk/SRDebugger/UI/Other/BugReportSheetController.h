...
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_CANCEL_OFFSET UNITYSDK_OFFSET(0x1C9EEBB0)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_CLEARERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C9EE6F0)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_CLEARFORM_OFFSET UNITYSDK_OFFSET(0x1C9EE7C0)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_GETDEFAULTEMAILFIELDCONTENTS_OFFSET UNITYSDK_OFFSET(0x1C9EEF70)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_GET_ISCANCELBUTTONENABLED_OFFSET UNITYSDK_OFFSET(0x1C9EE540)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_ONBUGREPORTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9EEC80)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_ONBUGREPORTPROGRESS_OFFSET UNITYSDK_OFFSET(0x1C9EEBE0)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_SETDEFAULTEMAILFIELDCONTENTS_OFFSET UNITYSDK_OFFSET(0x1C9EEAE0)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_SETFORMENABLED_OFFSET UNITYSDK_OFFSET(0x1C9EEA70)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_SETLOADINGSPINNERVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C9EE690)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_SET_ISCANCELBUTTONENABLED_OFFSET UNITYSDK_OFFSET(0x1C9EE580)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_SHOWERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C9EEDD0)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1C9EE5C0)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_SUBMITCO_OFFSET UNITYSDK_OFFSET(0x1C9EEB60)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1C9EE840)
#define SRDEBUGGER_UI_OTHER_BUGREPORTSHEETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9EEFB0)
