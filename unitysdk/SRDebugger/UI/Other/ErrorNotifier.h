...
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C9F0C30)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C9F0C20)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_SHOWERRORWARNING_OFFSET UNITYSDK_OFFSET(0x1C9D0CC0)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9F0C70)
#define SRDEBUGGER_UI_OTHER_ERRORNOTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9F0CF0)
