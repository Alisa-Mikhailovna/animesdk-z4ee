...
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C9F0020)
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9F00D0)
#define SRDEBUGGER_UI_OTHER_DEBUGPANELBACKGROUNDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9F01B0)
