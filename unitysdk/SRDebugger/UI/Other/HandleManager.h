...
#define SRDEBUGGER_UI_OTHER_HANDLEMANAGER_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1C9F13D0)
#define SRDEBUGGER_UI_OTHER_HANDLEMANAGER_SETALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C9D78A0)
#define SRDEBUGGER_UI_OTHER_HANDLEMANAGER_START_OFFSET UNITYSDK_OFFSET(0x1C9F13C0)
#define SRDEBUGGER_UI_OTHER_HANDLEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9F13F0)
