...
#define SRDEBUGGER_UI_OTHER_FLOATOVERELEMENT_COPY_OFFSET UNITYSDK_OFFSET(0x1C9F0D00)
#define SRDEBUGGER_UI_OTHER_FLOATOVERELEMENT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1C9F1390)
#define SRDEBUGGER_UI_OTHER_FLOATOVERELEMENT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1C9F13A0)
#define SRDEBUGGER_UI_OTHER_FLOATOVERELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9F13B0)
