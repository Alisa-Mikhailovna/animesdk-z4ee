...
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C9CA490)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1C9CA8D0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_ENDOFFRAMECOROUTINE_OFFSET UNITYSDK_OFFSET(0x1C9CA6B0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_GET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1C9CA440)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_GET_FRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1C9CA480)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_GET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1C9CA460)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C9CAA40)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_PUSHFRAME_OFFSET UNITYSDK_OFFSET(0x1C9CA9F0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_RENDERPIPELINEONBEGINFRAMERENDERING_OFFSET UNITYSDK_OFFSET(0x1C9CAA80)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_SET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1C9CA450)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_SET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1C9CA470)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9CA6E0)
#define SRDEBUGGER_PROFILER_SRPPROFILERSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CAAC0)
