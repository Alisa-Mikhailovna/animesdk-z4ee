...
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C9C9D50)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x1C9CA1B0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1C9C9D00)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_FRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1C9C9D40)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_GET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1C9C9D20)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONCAMERAPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x1C9CA3A0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONCAMERAPRERENDER_OFFSET UNITYSDK_OFFSET(0x1C9CA350)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C9CA310)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_PUSHFRAME_OFFSET UNITYSDK_OFFSET(0x1C9CA2C0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_SET_AVERAGEFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1C9C9D10)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_SET_LASTFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1C9C9D30)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9C9FB0)
#define SRDEBUGGER_PROFILER_PROFILERSERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CA3E0)
