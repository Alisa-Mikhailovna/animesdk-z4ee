...
#define SRDEBUGGER_ACTIONCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C9C4040)
#define SRDEBUGGER_ACTIONCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9C4090)
#define SRDEBUGGER_ACTIONCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9C4030)
#define SRDEBUGGER_ACTIONCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9C3FC0)
