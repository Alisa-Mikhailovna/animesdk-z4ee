...
#define SRDEBUGGER_SERVICES_PINENTRYCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C9E0810)
#define SRDEBUGGER_SERVICES_PINENTRYCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9E0860)
#define SRDEBUGGER_SERVICES_PINENTRYCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9D5910)
#define SRDEBUGGER_SERVICES_PINENTRYCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E07A0)
