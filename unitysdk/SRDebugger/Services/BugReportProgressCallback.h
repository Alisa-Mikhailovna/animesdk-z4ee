...
#define SRDEBUGGER_SERVICES_BUGREPORTPROGRESSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C9CD680)
#define SRDEBUGGER_SERVICES_BUGREPORTPROGRESSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9CD6D0)
#define SRDEBUGGER_SERVICES_BUGREPORTPROGRESSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9CD670)
#define SRDEBUGGER_SERVICES_BUGREPORTPROGRESSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CD600)
