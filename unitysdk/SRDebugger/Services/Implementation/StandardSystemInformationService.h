...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_STANDARDSYSTEMINFORMATIONSERVICE_ADD_OFFSET UNITYSDK_OFFSET(0x1C9D8E60)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_STANDARDSYSTEMINFORMATIONSERVICE_CREATEDEFAULTSET_OFFSET UNITYSDK_OFFSET(0x1C9DBCD0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_STANDARDSYSTEMINFORMATIONSERVICE_CREATEREPORT_OFFSET UNITYSDK_OFFSET(0x1C9DF720)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_STANDARDSYSTEMINFORMATIONSERVICE_GETCATEGORIES_OFFSET UNITYSDK_OFFSET(0x1C9DF470)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_STANDARDSYSTEMINFORMATIONSERVICE_GETCLOUDMANIFESTPRETTYNAME_OFFSET UNITYSDK_OFFSET(0x1C9E01C0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_STANDARDSYSTEMINFORMATIONSERVICE_GETINFO_OFFSET UNITYSDK_OFFSET(0x1C9DF540)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_STANDARDSYSTEMINFORMATIONSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9DBC50)
