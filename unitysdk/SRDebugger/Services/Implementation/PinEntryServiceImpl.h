...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C9D59D0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_GET_ISSHOWINGKEYPAD_OFFSET UNITYSDK_OFFSET(0x1C9D4C90)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_LOAD_OFFSET UNITYSDK_OFFSET(0x1C9D5440)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_PINCONTROLONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9D5B60)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_SHOWPINENTRY_1_OFFSET UNITYSDK_OFFSET(0x1C9D59B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_SHOWPINENTRY_OFFSET UNITYSDK_OFFSET(0x1C9D4CA0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL_VERIFYPIN_OFFSET UNITYSDK_OFFSET(0x1C9D4F80)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_PINENTRYSERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9D5CD0)
