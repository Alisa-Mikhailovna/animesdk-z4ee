...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_ADD_VISIBILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C9CF630)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C9CFE60)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ACTIVETAB_OFFSET UNITYSDK_OFFSET(0x1C9CFCB0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ISINCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x1C9D0030)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ISLOADED_OFFSET UNITYSDK_OFFSET(0x1C9CF700)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C9CF720)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_GET_ROOTOBJECT_OFFSET UNITYSDK_OFFSET(0x1C9CF6F0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_LOAD_OFFSET UNITYSDK_OFFSET(0x1C9CF8A0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_MOVESCROLLCONTENT_OFFSET UNITYSDK_OFFSET(0x1C9CFEA0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_OPENTAB_OFFSET UNITYSDK_OFFSET(0x1C9CFCF0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_OPTIONCONTROL_OFFSET UNITYSDK_OFFSET(0x1C9CFFA0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_REMOVE_VISIBILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C9CF690)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SELECTNEXTTAB_OFFSET UNITYSDK_OFFSET(0x1C9CFF40)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SELECTPRETAB_OFFSET UNITYSDK_OFFSET(0x1C9CFF70)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SET_ISINCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x1C9D0040)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C9CF740)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_SRDEBUGGER_SERVICES_IDEBUGPANELSERVICE_ISTABSHOW_OFFSET UNITYSDK_OFFSET(0x1C9CFFF0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1C9CFDB0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGPANELSERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9D0050)
