...
namespace SRDebugger::Services::Implementation
{
	...
	public:
		...
		{
			return (::UnityEngine::Events::UnityAction_2<::UnityEngine::SceneManagement::Scene, ::UnityEngine::SceneManagement::Scene>**)Il2CppClass::FromTypeDefinitionIndex(DebugTriggerImpl___O_TypeDefinitionIndex)->GetStaticField(0x63B10);
		}
	};
}
