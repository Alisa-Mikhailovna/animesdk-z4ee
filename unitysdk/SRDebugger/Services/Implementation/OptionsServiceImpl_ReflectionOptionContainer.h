...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_ADD_OPTIONADDED_OFFSET UNITYSDK_OFFSET(0x1C9D4960)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_ADD_OPTIONREMOVED_OFFSET UNITYSDK_OFFSET(0x1C9D4980)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C9D4AD0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C9D4A10)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C9D4BF0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_GETOPTIONS_OFFSET UNITYSDK_OFFSET(0x1C9D49E0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1C9D49A0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1C9D49B0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_REMOVE_OPTIONADDED_OFFSET UNITYSDK_OFFSET(0x1C9D4970)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER_REMOVE_OPTIONREMOVED_OFFSET UNITYSDK_OFFSET(0x1C9D4990)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_OPTIONSSERVICEIMPL_REFLECTIONOPTIONCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9D3C90)
