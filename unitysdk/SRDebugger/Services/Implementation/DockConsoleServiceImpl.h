...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DOCKCONSOLESERVICEIMPL_CHECKTRIGGER_OFFSET UNITYSDK_OFFSET(0x1C9D1590)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DOCKCONSOLESERVICEIMPL_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C9D1A10)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DOCKCONSOLESERVICEIMPL_GET_ISEXPANDED_OFFSET UNITYSDK_OFFSET(0x1C9D1890)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DOCKCONSOLESERVICEIMPL_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C9D1270)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DOCKCONSOLESERVICEIMPL_LOAD_OFFSET UNITYSDK_OFFSET(0x1C9D1310)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DOCKCONSOLESERVICEIMPL_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C9D1A20)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DOCKCONSOLESERVICEIMPL_SET_ISEXPANDED_OFFSET UNITYSDK_OFFSET(0x1C9D18A0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DOCKCONSOLESERVICEIMPL_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1C9D1280)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DOCKCONSOLESERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9D1210)
...
namespace SRDebugger::Services::Implementation
{
	...
	public:
		...
		::System::Boolean _isExpanded; // 0x1A
