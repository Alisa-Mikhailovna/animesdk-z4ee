...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C9CF0F0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_CANCELPRESSED_OFFSET UNITYSDK_OFFSET(0x1C9CEEF0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_GET_ISSHOWINGPOPOVER_OFFSET UNITYSDK_OFFSET(0x1C9CE2F0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_LOAD_OFFSET UNITYSDK_OFFSET(0x1C9CE4C0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9CED70)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_OPENCO_OFFSET UNITYSDK_OFFSET(0x1C9CECF0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_SCREENSHOTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9CF010)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_SHOWBUGREPORTER_OFFSET UNITYSDK_OFFSET(0x1C9CE300)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_SUBMITCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9CED60)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE_TAKINGSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1C9CEF30)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTPOPOVERSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CF1B0)
