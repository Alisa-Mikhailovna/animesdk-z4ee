...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGCAMERASERVICEIMPL_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0x1C9CF620)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_DEBUGCAMERASERVICEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CF400)
