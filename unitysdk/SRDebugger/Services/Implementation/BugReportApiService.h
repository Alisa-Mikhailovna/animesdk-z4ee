...
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C9CDF80)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9CE060)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1C9CE040)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_SENDBUGREPORT_OFFSET UNITYSDK_OFFSET(0x1C9CDDD0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9CE0D0)
#define SRDEBUGGER_SERVICES_IMPLEMENTATION_BUGREPORTAPISERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CE2D0)
