...
#define SRDEBUGGER_SERVICES_CONSOLEUPDATEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C9CDD90)
#define SRDEBUGGER_SERVICES_CONSOLEUPDATEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9CDDC0)
#define SRDEBUGGER_SERVICES_CONSOLEUPDATEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9CDD80)
#define SRDEBUGGER_SERVICES_CONSOLEUPDATEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9CDC90)
