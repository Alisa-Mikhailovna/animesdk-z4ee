...
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_BUILDJSONREQUEST_OFFSET UNITYSDK_OFFSET(0x1C9C4980)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_CREATECONSOLEDUMP_OFFSET UNITYSDK_OFFSET(0x1C9C4CE0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_GET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C9C47B0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9C4770)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x1C9C47D0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_GET_WASSUCCESSFUL_OFFSET UNITYSDK_OFFSET(0x1C9C4790)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SETCOMPLETIONSTATE_OFFSET UNITYSDK_OFFSET(0x1C9C48A0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C9C47C0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1C9C4780)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SET_WASSUCCESSFUL_OFFSET UNITYSDK_OFFSET(0x1C9C47A0)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1C9C4840)
#define SRDEBUGGER_INTERNAL_BUGREPORTAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9C4760)
