...
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_ADDLEGACYINPUTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1C9C8660)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_CONFIGURECANVAS_OFFSET UNITYSDK_OFFSET(0x1C9C9060)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_CREATEDEFAULTEVENTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1C9C85D0)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_ENSUREEVENTSYSTEMEXISTS_OFFSET UNITYSDK_OFFSET(0x1C9C8400)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_GETMETHODOPTIONDEFINITION_OFFSET UNITYSDK_OFFSET(0x1C9C9530)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_GETNUMBERSTRING_OFFSET UNITYSDK_OFFSET(0x1C9C9030)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_GETPROPERTYOPTIONDEFINITION_OFFSET UNITYSDK_OFFSET(0x1C9C91E0)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_GET_ISMOBILEPLATFORM_OFFSET UNITYSDK_OFFSET(0x1C9C83B0)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL_SCANFOROPTIONS_OFFSET UNITYSDK_OFFSET(0x1C9C86B0)
#define SRDEBUGGER_INTERNAL_SRDEBUGGERUTIL__GENERATEOPTIONDEFINITIONINITPARAM_OFFSET UNITYSDK_OFFSET(0x1C9C92A0)
