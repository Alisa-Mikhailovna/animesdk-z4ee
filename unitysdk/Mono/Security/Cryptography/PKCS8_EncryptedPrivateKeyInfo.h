...
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_DECODE_OFFSET UNITYSDK_OFFSET(0x19F1F920)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_GET_ALGORITHM_OFFSET UNITYSDK_OFFSET(0x19F1FC60)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_GET_ENCRYPTEDDATA_OFFSET UNITYSDK_OFFSET(0x19F1FC70)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_GET_ITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19F1FE80)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO_GET_SALT_OFFSET UNITYSDK_OFFSET(0x19F1FD50)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19F1F910)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS8_ENCRYPTEDPRIVATEKEYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19F1F900)
