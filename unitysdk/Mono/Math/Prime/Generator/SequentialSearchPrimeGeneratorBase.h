...
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE_GENERATENEWPRIME_1_OFFSET UNITYSDK_OFFSET(0x19F17780)
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE_GENERATENEWPRIME_OFFSET UNITYSDK_OFFSET(0x19F15E90)
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE_GENERATESEARCHBASE_OFFSET UNITYSDK_OFFSET(0x19F176A0)
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE_ISPRIMEACCEPTABLE_OFFSET UNITYSDK_OFFSET(0x19F17DD0)
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F15E80)
