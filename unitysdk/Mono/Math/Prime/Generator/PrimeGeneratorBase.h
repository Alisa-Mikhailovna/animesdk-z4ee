...
#define MONO_MATH_PRIME_GENERATOR_PRIMEGENERATORBASE_GET_CONFIDENCE_OFFSET UNITYSDK_OFFSET(0x19F17600)
#define MONO_MATH_PRIME_GENERATOR_PRIMEGENERATORBASE_GET_PRIMALITYTEST_OFFSET UNITYSDK_OFFSET(0x19F17610)
#define MONO_MATH_PRIME_GENERATOR_PRIMEGENERATORBASE_GET_TRIALDIVISIONBOUNDS_OFFSET UNITYSDK_OFFSET(0x19F17680)
#define MONO_MATH_PRIME_GENERATOR_PRIMEGENERATORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F17690)
