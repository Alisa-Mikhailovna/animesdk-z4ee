...
#define MONO_MATH_BIGINTEGER_KERNEL_COMPARE_OFFSET UNITYSDK_OFFSET(0x19F129A0)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDDIVMOD_OFFSET UNITYSDK_OFFSET(0x19F16390)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDMOD_OFFSET UNITYSDK_OFFSET(0x19F12E60)
#define MONO_MATH_BIGINTEGER_KERNEL_LEFTSHIFT_OFFSET UNITYSDK_OFFSET(0x19F13C70)
#define MONO_MATH_BIGINTEGER_KERNEL_MINUSEQ_OFFSET UNITYSDK_OFFSET(0x19F16020)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_1_OFFSET UNITYSDK_OFFSET(0x19F15430)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_OFFSET UNITYSDK_OFFSET(0x19F16760)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIBYTEDIVIDE_OFFSET UNITYSDK_OFFSET(0x19F12F20)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLYMOD2P32PMOD_OFFSET UNITYSDK_OFFSET(0x19F16660)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x19F13B70)
#define MONO_MATH_BIGINTEGER_KERNEL_PLUSEQ_OFFSET UNITYSDK_OFFSET(0x19F16170)
#define MONO_MATH_BIGINTEGER_KERNEL_RIGHTSHIFT_OFFSET UNITYSDK_OFFSET(0x19F13F00)
#define MONO_MATH_BIGINTEGER_KERNEL_SINGLEBYTEDIVIDEINPLACE_OFFSET UNITYSDK_OFFSET(0x19F15020)
#define MONO_MATH_BIGINTEGER_KERNEL_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x19F12B10)
