...
#define MONO_NET_SECURITY_BUFFEROFFSETSIZE2_APPENDDATA_OFFSET UNITYSDK_OFFSET(0x1CC509D0)
#define MONO_NET_SECURITY_BUFFEROFFSETSIZE2_MAKEROOM_OFFSET UNITYSDK_OFFSET(0x1CC50940)
#define MONO_NET_SECURITY_BUFFEROFFSETSIZE2_RESET_OFFSET UNITYSDK_OFFSET(0x1CC508E0)
#define MONO_NET_SECURITY_BUFFEROFFSETSIZE2__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC508A0)
