...
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_ADD_OFFSET UNITYSDK_OFFSET(0x19F8B870)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_CLEAR_OFFSET UNITYSDK_OFFSET(0x19F8A750)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GETNAME_OFFSET UNITYSDK_OFFSET(0x19F87120)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GETVALUE_1_OFFSET UNITYSDK_OFFSET(0x19F8B970)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GETVALUE_OFFSET UNITYSDK_OFFSET(0x19F87170)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x19F87100)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x19F8BAA0)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x19F8BAD0)
#define MONO_XML_SMALLXMLPARSER_ATTRLISTIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19F87330)
