...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_PROCESS_HANDSHAKE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5BE60)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_PROCESS_HANDSHAKE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5BEA0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_PROCESS_HANDSHAKE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5BE50)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_PROCESS_HANDSHAKE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC5BDD0)
