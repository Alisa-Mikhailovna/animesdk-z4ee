...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_ERRORSTATE_RAISE_ERROR_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5B0D0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_ERRORSTATE_RAISE_ERROR_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5B130)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_ERRORSTATE_RAISE_ERROR_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5B0C0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_ERRORSTATE_RAISE_ERROR_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC5B040)
