...
#define MONO_UNITY_UNITYTLSPROVIDER_CREATESSLSTREAMINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CC60250)
#define MONO_UNITY_UNITYTLSPROVIDER_CREATESSLSTREAM_OFFSET UNITYSDK_OFFSET(0x1CC59980)
#define MONO_UNITY_UNITYTLSPROVIDER_GET_ID_OFFSET UNITYSDK_OFFSET(0x1CC601C0)
#define MONO_UNITY_UNITYTLSPROVIDER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CC601B0)
#define MONO_UNITY_UNITYTLSPROVIDER_GET_SUPPORTEDPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x1CC60240)
#define MONO_UNITY_UNITYTLSPROVIDER_GET_SUPPORTSCLEANSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1CC60230)
#define MONO_UNITY_UNITYTLSPROVIDER_GET_SUPPORTSCONNECTIONINFO_OFFSET UNITYSDK_OFFSET(0x1CC60220)
#define MONO_UNITY_UNITYTLSPROVIDER_GET_SUPPORTSMONOEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1CC60210)
#define MONO_UNITY_UNITYTLSPROVIDER_GET_SUPPORTSSSLSTREAM_OFFSET UNITYSDK_OFFSET(0x1CC60200)
#define MONO_UNITY_UNITYTLSPROVIDER_VALIDATECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1CC51C20)
#define MONO_UNITY_UNITYTLSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC60320)
