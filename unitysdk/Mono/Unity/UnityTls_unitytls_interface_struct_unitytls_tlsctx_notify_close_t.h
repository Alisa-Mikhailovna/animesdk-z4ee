...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_NOTIFY_CLOSE_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5BD80)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_NOTIFY_CLOSE_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5BDC0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_NOTIFY_CLOSE_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5BD70)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_NOTIFY_CLOSE_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC5BCF0)
