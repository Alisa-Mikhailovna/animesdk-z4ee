...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_TRACE_CALLBACK_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5C470)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_TRACE_CALLBACK_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5C4C0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_TRACE_CALLBACK_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5C440)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_TRACE_CALLBACK_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC5C3C0)
