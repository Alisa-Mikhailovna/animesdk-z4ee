...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_READ_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5BF80)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_READ_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5C000)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_READ_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5BF50)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_READ_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC5BED0)
