...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_SUPPORTED_CIPHERSUITES_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5C330)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_SUPPORTED_CIPHERSUITES_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5C3B0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_SUPPORTED_CIPHERSUITES_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5C300)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_SET_SUPPORTED_CIPHERSUITES_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC5C280)
