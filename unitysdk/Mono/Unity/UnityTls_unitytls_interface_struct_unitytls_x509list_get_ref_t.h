...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_GET_REF_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5CCF0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_GET_REF_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5CD30)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_GET_REF_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CC5CCE0)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_GET_REF_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC5CC60)
