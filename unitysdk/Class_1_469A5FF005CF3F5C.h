...
#define CLASS_1_469A5FF005CF3F5C_GET_ISUSEFULLPERIOD_OFFSET UNITYSDK_OFFSET(0x155C9F70)
#define CLASS_1_469A5FF005CF3F5C_GET_OVERRIDESHAKECONFIG_OFFSET UNITYSDK_OFFSET(0x155C9F30)
#define CLASS_1_469A5FF005CF3F5C_GET_OVERRIDESHAKESCALE_OFFSET UNITYSDK_OFFSET(0x155C9F10)
#define CLASS_1_469A5FF005CF3F5C_GET_SHAKECONFIG_OFFSET UNITYSDK_OFFSET(0x155C9EB0)
#define CLASS_1_469A5FF005CF3F5C_GET_SHAKEMAXRANGE_OFFSET UNITYSDK_OFFSET(0x155C9EF0)
#define CLASS_1_469A5FF005CF3F5C_GET_SHAKESOURCESCALE_OFFSET UNITYSDK_OFFSET(0x155C9F50)
#define CLASS_1_469A5FF005CF3F5C_GET_TOBEREMOVE_OFFSET UNITYSDK_OFFSET(0x155C9ED0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_0250CE86089C8A72_OFFSET UNITYSDK_OFFSET(0x155C99B0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_0767ADDAA8C5C79F_OFFSET UNITYSDK_OFFSET(0x155C9F90)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x155C98F0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_104669F3B9019C27_OFFSET UNITYSDK_OFFSET(0x155C9600)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x155C9520)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x155C94C0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_288F74D11BE167E0_OFFSET UNITYSDK_OFFSET(0x155C82C0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x155C7BF0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_326A28A5AE4DF4B2_OFFSET UNITYSDK_OFFSET(0x155C77D0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_3422201382CE593B_1_OFFSET UNITYSDK_OFFSET(0x155C8190)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0x155C8100)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x155C9580)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x155C7A10)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_5E5FAAAE21B44BAE_OFFSET UNITYSDK_OFFSET(0x155C7A80)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0x155C9A50)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x155C8220)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_8C4AEC0BC1CA0CB4_OFFSET UNITYSDK_OFFSET(0x155C7CC0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_A1C464B05BB7A5C1_1_OFFSET UNITYSDK_OFFSET(0x155C9390)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0x155C9130)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_B0C9E67798485BC6_OFFSET UNITYSDK_OFFSET(0x155C8500)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_BA9C9FDB9BD04A4F_OFFSET UNITYSDK_OFFSET(0x155C9B70)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_C6441B5A0FAE0587_OFFSET UNITYSDK_OFFSET(0x155C8D50)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_F38398C364AE5340_OFFSET UNITYSDK_OFFSET(0x155C89E0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_F95CD767D6B25CA4_OFFSET UNITYSDK_OFFSET(0x155C9260)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_FA2C1734FD4CF3EF_OFFSET UNITYSDK_OFFSET(0x155C8FB0)
#define CLASS_1_469A5FF005CF3F5C_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x155C9B10)
#define CLASS_1_469A5FF005CF3F5C_SET_ISUSEFULLPERIOD_OFFSET UNITYSDK_OFFSET(0x155C9F80)
#define CLASS_1_469A5FF005CF3F5C_SET_OVERRIDESHAKECONFIG_OFFSET UNITYSDK_OFFSET(0x155C9F40)
#define CLASS_1_469A5FF005CF3F5C_SET_OVERRIDESHAKESCALE_OFFSET UNITYSDK_OFFSET(0x155C9F20)
#define CLASS_1_469A5FF005CF3F5C_SET_SHAKECONFIG_OFFSET UNITYSDK_OFFSET(0x155C9EC0)
#define CLASS_1_469A5FF005CF3F5C_SET_SHAKEMAXRANGE_OFFSET UNITYSDK_OFFSET(0x155C9F00)
#define CLASS_1_469A5FF005CF3F5C_SET_SHAKESOURCESCALE_OFFSET UNITYSDK_OFFSET(0x155C9F60)
#define CLASS_1_469A5FF005CF3F5C_SET_TOBEREMOVE_OFFSET UNITYSDK_OFFSET(0x155C9EE0)
#define CLASS_1_469A5FF005CF3F5C__CTOR_OFFSET UNITYSDK_OFFSET(0x155C75D0)
...
public:
	...
	::RPG::GameCore::ShakeDistanceAttenuation* Field_1_2; // 0x18
	::RPG::Client::CameraBlendCurve* Field_1_3; // 0x20
	::RPG::GameCore::VCameraShakeV2* _ShakeConfig_k__BackingField; // 0x28
	...
	::RPG::Client::CameraBlendCurve* Field_1_7; // 0x40
	::Il2CppArray<::Class_1_4194FD1D0EB8BE87*>* Field_1_8; // 0x48
	::RPG::Client::CameraBlendCurve* Field_1_9; // 0x50
	::System::Boolean _TobeRemove_k__BackingField; // 0x58
	::System::Boolean _IsUseFullPeriod_k__BackingField; // 0x59
	...
	::UnityEngine::Vector3 Field_1_19; // 0x74
	::System::Single Field_1_20; // 0x80
	::System::Single Field_1_21; // 0x84
	::System::Single _OverrideShakeScale_k__BackingField; // 0x88
	::System::Single _ShakeSourceScale_k__BackingField; // 0x8C
	::UnityEngine::Vector3 Field_1_24; // 0x90
	::System::Single Field_1_25; // 0x9C
	::System::Single Field_1_26; // 0xA0
	::System::Single _ShakeMaxRange_k__BackingField; // 0xA4
	::UnityEngine::Vector3 Field_1_28; // 0xA8
	::UnityEngine::Vector3 Field_1_29; // 0xB4
