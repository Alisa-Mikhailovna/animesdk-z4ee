...
#define CLASS_2_8960A5CCCDD23CD3_GET_CONTAINERINFO_OFFSET UNITYSDK_OFFSET(0xB9A6A50)
#define CLASS_2_8960A5CCCDD23CD3_GET_LEVELVARBINDINGMAP_OFFSET UNITYSDK_OFFSET(0xB9A6A30)
#define CLASS_2_8960A5CCCDD23CD3_SET_CONTAINERINFO_OFFSET UNITYSDK_OFFSET(0xB9A6A60)
#define CLASS_2_8960A5CCCDD23CD3_SET_LEVELVARBINDINGMAP_OFFSET UNITYSDK_OFFSET(0xB9A6A40)
#define CLASS_2_8960A5CCCDD23CD3__CCTOR_OFFSET UNITYSDK_OFFSET(0xB9A6A80)
#define CLASS_2_8960A5CCCDD23CD3__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A6A70)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_8960A5CCCDD23CD3_TypeDefinitionIndex)->GetStaticField(0x7A70);
	}
