...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_CREATEORNULL_OFFSET UNITYSDK_OFFSET(0x19B03E80)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x19B1BB70)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19B1BB10)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x19B1AA50)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19B1AA60)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x19B1AA20)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISINTKEY_OFFSET UNITYSDK_OFFSET(0x19B1AA10)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISSTRINGKEY_OFFSET UNITYSDK_OFFSET(0x19B08C20)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISSTRUCT_OFFSET UNITYSDK_OFFSET(0x19B122D0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x19B1AA70)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_SHOULDUSEFORMATTERRESOLVER_OFFSET UNITYSDK_OFFSET(0x19B1AA30)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19B1AA00)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_ISCLASSRECORD_OFFSET UNITYSDK_OFFSET(0x19B1B070)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_ISOPTIMIZETARGETTYPE_OFFSET UNITYSDK_OFFSET(0x19B0E090)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_SHOULDUSEFORMATTERRESOLVER_OFFSET UNITYSDK_OFFSET(0x19B1AA40)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_TRYGETNEXTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x19B1BBE0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1AA80)
