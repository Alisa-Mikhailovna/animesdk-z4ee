...
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF9510)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS16_0__EMITSEARCHNEXTCORE_B__2_OFFSET UNITYSDK_OFFSET(0x19AF9750)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS16_0__EMITSEARCHNEXTCORE_B__3_OFFSET UNITYSDK_OFFSET(0x19AF96C0)
