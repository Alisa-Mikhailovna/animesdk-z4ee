...
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_MESSAGEPACKREADERDESERIALIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19B3D480)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_MESSAGEPACKREADERDESERIALIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19B3D500)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_MESSAGEPACKREADERDESERIALIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B3D470)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_COMPILEDMETHODS_MESSAGEPACKREADERDESERIALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B3D3F0)
