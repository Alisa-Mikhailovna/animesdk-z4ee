...
#define MESSAGEPACK_UNITY_LAYERMASKFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19AD7FE0)
#define MESSAGEPACK_UNITY_LAYERMASKFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19AD7F90)
#define MESSAGEPACK_UNITY_LAYERMASKFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD81D0)
