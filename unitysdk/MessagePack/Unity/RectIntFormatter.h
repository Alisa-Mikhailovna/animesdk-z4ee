...
#define MESSAGEPACK_UNITY_RECTINTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19AD9D50)
#define MESSAGEPACK_UNITY_RECTINTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19AD9CE0)
#define MESSAGEPACK_UNITY_RECTINTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADA1B0)
