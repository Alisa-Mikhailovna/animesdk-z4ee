...
#define MESSAGEPACK_UNITY_BOUNDSINTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19AD4C50)
#define MESSAGEPACK_UNITY_BOUNDSINTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19AD4950)
#define MESSAGEPACK_UNITY_BOUNDSINTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD5120)
