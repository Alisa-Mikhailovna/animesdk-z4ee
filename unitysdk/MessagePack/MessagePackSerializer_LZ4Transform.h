...
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_LZ4TRANSFORM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19B3D6E0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_LZ4TRANSFORM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19B3D770)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_LZ4TRANSFORM_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B35C10)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_LZ4TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x19B3D670)
