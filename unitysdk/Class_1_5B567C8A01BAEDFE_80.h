...
#define CLASS_1_5B567C8A01BAEDFE_80_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C3A3600)
#define CLASS_1_5B567C8A01BAEDFE_80_CLONE_OFFSET UNITYSDK_OFFSET(0x1C3A32A0)
#define CLASS_1_5B567C8A01BAEDFE_80_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C3A3400)
#define CLASS_1_5B567C8A01BAEDFE_80_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C3A3310)
#define CLASS_1_5B567C8A01BAEDFE_80_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C3A3560)
#define CLASS_1_5B567C8A01BAEDFE_80_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C3A3650)
#define CLASS_1_5B567C8A01BAEDFE_80_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C3A3620)
#define CLASS_1_5B567C8A01BAEDFE_80_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C3A31F0)
#define CLASS_1_5B567C8A01BAEDFE_80_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C3A3250)
#define CLASS_1_5B567C8A01BAEDFE_80_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C3A3590)
#define CLASS_1_5B567C8A01BAEDFE_80_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C3A35F0)
#define CLASS_1_5B567C8A01BAEDFE_80__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C3A36A0)
#define CLASS_1_5B567C8A01BAEDFE_80__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3A3270)
#define CLASS_1_5B567C8A01BAEDFE_80__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3A3260)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_80_TypeDefinitionIndex)->GetStaticField(0x45A20);
	}
