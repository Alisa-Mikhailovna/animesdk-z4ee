...
#define AKDIFFRACTIONPATHINFOARRAY_CLONEINTOREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1D1BA510)
#define AKDIFFRACTIONPATHINFOARRAY_CREATENEWREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1D1BA490)
#define AKDIFFRACTIONPATHINFOARRAY_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0x1D1BA3E0)
#define AKDIFFRACTIONPATHINFOARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BA3A0)
