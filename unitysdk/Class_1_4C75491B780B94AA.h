...
#define CLASS_1_4C75491B780B94AA_GET_ISPVP1V1NETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x14B11BE0)
#define CLASS_1_4C75491B780B94AA_GET_ISPVPNETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x14B11BC0)
#define CLASS_1_4C75491B780B94AA_GET_ISPVPROYALENETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x14B11C00)
#define CLASS_1_4C75491B780B94AA_METHOD_1_012CEDC0727C8D27_OFFSET UNITYSDK_OFFSET(0x14B11960)
#define CLASS_1_4C75491B780B94AA_METHOD_1_0BDAEE707043B6C9_OFFSET UNITYSDK_OFFSET(0x14B0C700)
#define CLASS_1_4C75491B780B94AA_METHOD_1_0C88AB06D46E777A_OFFSET UNITYSDK_OFFSET(0x14B0F840)
#define CLASS_1_4C75491B780B94AA_METHOD_1_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x14B0BE60)
#define CLASS_1_4C75491B780B94AA_METHOD_1_102BA849186931FD_OFFSET UNITYSDK_OFFSET(0x14B0B640)
#define CLASS_1_4C75491B780B94AA_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x14B10B30)
#define CLASS_1_4C75491B780B94AA_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x14B0CF10)
#define CLASS_1_4C75491B780B94AA_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x14B0C950)
#define CLASS_1_4C75491B780B94AA_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x14B0ED80)
#define CLASS_1_4C75491B780B94AA_METHOD_1_1CDA0051FD244886_OFFSET UNITYSDK_OFFSET(0x14B0F350)
#define CLASS_1_4C75491B780B94AA_METHOD_1_2045BA2947DBDBCE_OFFSET UNITYSDK_OFFSET(0x14B0B330)
#define CLASS_1_4C75491B780B94AA_METHOD_1_2340068C22DFE332_1_OFFSET UNITYSDK_OFFSET(0x14B0C400)
#define CLASS_1_4C75491B780B94AA_METHOD_1_2340068C22DFE332_2_OFFSET UNITYSDK_OFFSET(0x14B0C580)
#define CLASS_1_4C75491B780B94AA_METHOD_1_2340068C22DFE332_OFFSET UNITYSDK_OFFSET(0x14B0C280)
#define CLASS_1_4C75491B780B94AA_METHOD_1_344DB1721ADD2658_1_OFFSET UNITYSDK_OFFSET(0x14B0DD20)
#define CLASS_1_4C75491B780B94AA_METHOD_1_344DB1721ADD2658_2_OFFSET UNITYSDK_OFFSET(0x14B0E660)
#define CLASS_1_4C75491B780B94AA_METHOD_1_344DB1721ADD2658_OFFSET UNITYSDK_OFFSET(0x14B0D090)
#define CLASS_1_4C75491B780B94AA_METHOD_1_40A10C74E0EFD4AD_OFFSET UNITYSDK_OFFSET(0x14B0CE20)
#define CLASS_1_4C75491B780B94AA_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x14B107F0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0x14B0CFD0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x14B0F040)
#define CLASS_1_4C75491B780B94AA_METHOD_1_78A816EDF045E4C8_OFFSET UNITYSDK_OFFSET(0x14B0DAB0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_7F4EBEC55EBE2D81_OFFSET UNITYSDK_OFFSET(0x14B10DA0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_7FBA19736CF767B2_OFFSET UNITYSDK_OFFSET(0x14B0C1A0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_80520F976E9CE8B4_OFFSET UNITYSDK_OFFSET(0x14B0B520)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8BB948EFB8DB02D1_OFFSET UNITYSDK_OFFSET(0x14B0C7B0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8CA05BCD86E125DF_OFFSET UNITYSDK_OFFSET(0x14B10C50)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0x14B0BA40)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8CBF5028E5DA8254_1_OFFSET UNITYSDK_OFFSET(0x14B111D0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_8CBF5028E5DA8254_OFFSET UNITYSDK_OFFSET(0x14B10EF0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_915FBC3734874058_OFFSET UNITYSDK_OFFSET(0x14B0D850)
#define CLASS_1_4C75491B780B94AA_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x14B0F7A0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_9681042564541CD6_2_OFFSET UNITYSDK_OFFSET(0x14B10A80)
#define CLASS_1_4C75491B780B94AA_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x14B0B710)
#define CLASS_1_4C75491B780B94AA_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x14B109A0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_A51891BFB0ABDB68_OFFSET UNITYSDK_OFFSET(0x14B114B0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_B6BB704B01BCC35B_OFFSET UNITYSDK_OFFSET(0x14B0B690)
#define CLASS_1_4C75491B780B94AA_METHOD_1_BDE3028FCE2D9EC3_OFFSET UNITYSDK_OFFSET(0x14B0CB80)
#define CLASS_1_4C75491B780B94AA_METHOD_1_C07F2657F47AFF02_OFFSET UNITYSDK_OFFSET(0x14B0CF80)
#define CLASS_1_4C75491B780B94AA_METHOD_1_C8E2469222842786_OFFSET UNITYSDK_OFFSET(0x14B0C010)
#define CLASS_1_4C75491B780B94AA_METHOD_1_CB145AC06225B366_OFFSET UNITYSDK_OFFSET(0x14B10E40)
#define CLASS_1_4C75491B780B94AA_METHOD_1_CBDC22058B67F0FE_OFFSET UNITYSDK_OFFSET(0x14B0AFB0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x14B0B240)
#define CLASS_1_4C75491B780B94AA_METHOD_1_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0x14B0D860)
#define CLASS_1_4C75491B780B94AA_METHOD_1_D588C897704F5375_OFFSET UNITYSDK_OFFSET(0x14B11750)
#define CLASS_1_4C75491B780B94AA_METHOD_1_DE1C1F4DF5D06882_1_OFFSET UNITYSDK_OFFSET(0x14B0E4E0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_DE1C1F4DF5D06882_2_OFFSET UNITYSDK_OFFSET(0x14B0EB80)
#define CLASS_1_4C75491B780B94AA_METHOD_1_DE1C1F4DF5D06882_OFFSET UNITYSDK_OFFSET(0x14B0DBA0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_DFF98536D8B4074F_OFFSET UNITYSDK_OFFSET(0x14B0C860)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E11A60CCAF1D8111_1_OFFSET UNITYSDK_OFFSET(0x14B0CAA0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E11A60CCAF1D8111_2_OFFSET UNITYSDK_OFFSET(0x14B0CC60)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E11A60CCAF1D8111_3_OFFSET UNITYSDK_OFFSET(0x14B0CD40)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E11A60CCAF1D8111_OFFSET UNITYSDK_OFFSET(0x14B0C9C0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E21AC6EE08DC160A_OFFSET UNITYSDK_OFFSET(0x14B0EDF0)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x14B0F710)
#define CLASS_1_4C75491B780B94AA_METHOD_1_E439D9572D6A45FA_OFFSET UNITYSDK_OFFSET(0x14B0C210)
#define CLASS_1_4C75491B780B94AA_METHOD_1_EC5C1AC08DA276C7_OFFSET UNITYSDK_OFFSET(0x14B10590)
#define CLASS_1_4C75491B780B94AA_METHOD_1_EC83FF7769033850_OFFSET UNITYSDK_OFFSET(0x14B0ED00)
#define CLASS_1_4C75491B780B94AA_METHOD_1_FE09F91DC8303B4D_OFFSET UNITYSDK_OFFSET(0x14B0C130)
#define CLASS_1_4C75491B780B94AA_SET_ISPVP1V1NETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x14B11BF0)
#define CLASS_1_4C75491B780B94AA_SET_ISPVPNETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x14B11BD0)
#define CLASS_1_4C75491B780B94AA_SET_ISPVPROYALENETWORKDATAREADY_OFFSET UNITYSDK_OFFSET(0x14B11C10)
#define CLASS_1_4C75491B780B94AA__CTOR_OFFSET UNITYSDK_OFFSET(0x14B11C20)

inline static constexpr unsigned int Class_1_4C75491B780B94AA_TypeDefinitionIndex = 72645;
...
public:
	...
	::RPG::GameCore::Match3::Match3BirdSkillConfig* Field_1_3; // 0x18
	::System::Action* Field_1_4; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::Match3::PieceConfig*>* Field_1_5; // 0x28
	::System::Collections::Generic::List_1<::RPG::Client::MatchThreeGameProp*>* Field_1_6; // 0x30
	::System::Action* Field_1_7; // 0x38
	::RPG::GameCore::GameEntity* Field_1_8; // 0x40
	::System::Collections::Generic::List_1<::RPG::GameCore::Match3::BombCreateConfig*>* Field_1_9; // 0x48
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::Match3::PieceConfig*>* Field_1_10; // 0x50
	::System::Collections::Generic::List_1<::RPG::Client::MatchThreeGameProp*>* Field_1_11; // 0x58
	::System::String* Field_1_12; // 0x60
	::RPG::Client::MatchThreeBoard* Field_1_13; // 0x68
	::System::Action_1<::RPG::Client::LittleGame::Match3::Match3GameState>* Field_1_14; // 0x70
	::System::Collections::Generic::List_1<::RPG::GameCore::Match3::PieceConfig*>* Field_1_15; // 0x78
	::RPG::Client::LittleGame::MatchThreeTimelineBattleField* Field_1_16; // 0x80
	::Class_1_D33B7D6901AE39E9* Field_1_17; // 0x88
	::Class_3_83FD4418E6E9E045* Field_1_18; // 0x90
	::RPG::GameCore::Match3::Match3BirdSkillConfig* Field_1_19; // 0x98
	::System::UInt32 Field_1_20; // 0xA0
	::RPG::Client::LittleGame::Match3::MatchThreeGameMode Field_1_21; // 0xA4
	::System::UInt32 Field_1_22; // 0xA8
	::System::UInt32 Field_1_23; // 0xAC
	::System::Boolean _IsPvp1v1NetworkDataReady_k__BackingField; // 0xB0
	::System::Boolean _IsPvpNetworkDataReady_k__BackingField; // 0xB1
	::System::Boolean Field_1_26; // 0xB2
	::System::Boolean _IsPvpRoyaleNetworkDataReady_k__BackingField; // 0xB3
