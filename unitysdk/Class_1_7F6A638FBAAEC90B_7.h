...
#define CLASS_1_7F6A638FBAAEC90B_7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C59ED40)
#define CLASS_1_7F6A638FBAAEC90B_7_CLONE_OFFSET UNITYSDK_OFFSET(0x1C59E920)
#define CLASS_1_7F6A638FBAAEC90B_7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C59E9C0)
#define CLASS_1_7F6A638FBAAEC90B_7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C59E990)
#define CLASS_1_7F6A638FBAAEC90B_7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C59EB10)
#define CLASS_1_7F6A638FBAAEC90B_7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C59EF80)
#define CLASS_1_7F6A638FBAAEC90B_7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C59EE80)
#define CLASS_1_7F6A638FBAAEC90B_7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C59E950)
#define CLASS_1_7F6A638FBAAEC90B_7_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C59E7A0)
#define CLASS_1_7F6A638FBAAEC90B_7_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x1C59E980)
#define CLASS_1_7F6A638FBAAEC90B_7_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1C59E970)
#define CLASS_1_7F6A638FBAAEC90B_7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C59E960)
#define CLASS_1_7F6A638FBAAEC90B_7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C59E7D0)
#define CLASS_1_7F6A638FBAAEC90B_7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C59EBA0)
#define CLASS_1_7F6A638FBAAEC90B_7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C59EC00)
#define CLASS_1_7F6A638FBAAEC90B_7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C59F190)
#define CLASS_1_7F6A638FBAAEC90B_7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C59E840)
#define CLASS_1_7F6A638FBAAEC90B_7__CTOR_OFFSET UNITYSDK_OFFSET(0x1C59E7E0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_1CBA230307F9C289_20*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7F6A638FBAAEC90B_7_TypeDefinitionIndex)->GetStaticField(0x60420);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_235*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_235*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7F6A638FBAAEC90B_7_TypeDefinitionIndex)->GetStaticField(0x60428);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_7F6A638FBAAEC90B_7*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_7F6A638FBAAEC90B_7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7F6A638FBAAEC90B_7_TypeDefinitionIndex)->GetStaticField(0x60430);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_235*>* Field_1_7; // 0x18
