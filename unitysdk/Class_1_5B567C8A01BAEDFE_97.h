...
#define CLASS_1_5B567C8A01BAEDFE_97_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C35E180)
#define CLASS_1_5B567C8A01BAEDFE_97_CLONE_OFFSET UNITYSDK_OFFSET(0x1C35DE20)
#define CLASS_1_5B567C8A01BAEDFE_97_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C35DF80)
#define CLASS_1_5B567C8A01BAEDFE_97_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C35DE90)
#define CLASS_1_5B567C8A01BAEDFE_97_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C35E0E0)
#define CLASS_1_5B567C8A01BAEDFE_97_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C35E1D0)
#define CLASS_1_5B567C8A01BAEDFE_97_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C35E1A0)
#define CLASS_1_5B567C8A01BAEDFE_97_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C35DD70)
#define CLASS_1_5B567C8A01BAEDFE_97_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C35DDD0)
#define CLASS_1_5B567C8A01BAEDFE_97_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C35E110)
#define CLASS_1_5B567C8A01BAEDFE_97_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C35E170)
#define CLASS_1_5B567C8A01BAEDFE_97__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C35E220)
#define CLASS_1_5B567C8A01BAEDFE_97__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C35DDF0)
#define CLASS_1_5B567C8A01BAEDFE_97__CTOR_OFFSET UNITYSDK_OFFSET(0x1C35DDE0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_97*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_97_TypeDefinitionIndex)->GetStaticField(0x3C170);
	}
