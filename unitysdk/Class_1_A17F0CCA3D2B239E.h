...
#define CLASS_1_A17F0CCA3D2B239E_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0xB1DEDE0)
#define CLASS_1_A17F0CCA3D2B239E_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xB1DE000)
#define CLASS_1_A17F0CCA3D2B239E_EQUALS_OFFSET UNITYSDK_OFFSET(0xB1DECB0)
#define CLASS_1_A17F0CCA3D2B239E_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xB1DE4C0)
#define CLASS_1_A17F0CCA3D2B239E_GET_BATTLEICONPATH_OFFSET UNITYSDK_OFFSET(0xB1DD750)
#define CLASS_1_A17F0CCA3D2B239E_GET_CARDOWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0xB1DD460)
#define CLASS_1_A17F0CCA3D2B239E_GET_EQUALITYCONTRACT_OFFSET UNITYSDK_OFFSET(0xB1DD3D0)
#define CLASS_1_A17F0CCA3D2B239E_GET_HANDBOOKCARDTABICONPATH_OFFSET UNITYSDK_OFFSET(0xB1DD480)
#define CLASS_1_A17F0CCA3D2B239E_GET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0xB1DD400)
#define CLASS_1_A17F0CCA3D2B239E_GET_SOURCEAVATARID_OFFSET UNITYSDK_OFFSET(0xB1DD420)
#define CLASS_1_A17F0CCA3D2B239E_GET_SWITCHDAYTALKICONPATH_OFFSET UNITYSDK_OFFSET(0xB1DD770)
#define CLASS_1_A17F0CCA3D2B239E_GET_SYSTEMFIGUREPATH_OFFSET UNITYSDK_OFFSET(0xB1DD440)
#define CLASS_1_A17F0CCA3D2B239E_GET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0xB1DD790)
#define CLASS_1_A17F0CCA3D2B239E_GET_ULTRABTNEFFECTPREFABPATH_OFFSET UNITYSDK_OFFSET(0xB1DD7B0)
#define CLASS_1_A17F0CCA3D2B239E_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xB1DDFE0)
#define CLASS_1_A17F0CCA3D2B239E_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xB1DDFB0)
#define CLASS_1_A17F0CCA3D2B239E_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0xB1DD990)
#define CLASS_1_A17F0CCA3D2B239E_SET_BATTLEICONPATH_OFFSET UNITYSDK_OFFSET(0xB1DD760)
#define CLASS_1_A17F0CCA3D2B239E_SET_CARDOWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0xB1DD470)
#define CLASS_1_A17F0CCA3D2B239E_SET_HANDBOOKCARDTABICONPATH_OFFSET UNITYSDK_OFFSET(0xB1DD490)
#define CLASS_1_A17F0CCA3D2B239E_SET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0xB1DD410)
#define CLASS_1_A17F0CCA3D2B239E_SET_SOURCEAVATARID_OFFSET UNITYSDK_OFFSET(0xB1DD430)
#define CLASS_1_A17F0CCA3D2B239E_SET_SWITCHDAYTALKICONPATH_OFFSET UNITYSDK_OFFSET(0xB1DD780)
#define CLASS_1_A17F0CCA3D2B239E_SET_SYSTEMFIGUREPATH_OFFSET UNITYSDK_OFFSET(0xB1DD450)
#define CLASS_1_A17F0CCA3D2B239E_SET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0xB1DD7A0)
#define CLASS_1_A17F0CCA3D2B239E_SET_ULTRABTNEFFECTPREFABPATH_OFFSET UNITYSDK_OFFSET(0xB1DD7C0)
#define CLASS_1_A17F0CCA3D2B239E_TOSTRING_OFFSET UNITYSDK_OFFSET(0xB1DD7D0)
#define CLASS_1_A17F0CCA3D2B239E__CLONE___OFFSET UNITYSDK_OFFSET(0xB1DED10)
#define CLASS_1_A17F0CCA3D2B239E__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB1DED90)
#define CLASS_1_A17F0CCA3D2B239E__CTOR_OFFSET UNITYSDK_OFFSET(0xB1DD380)

inline static constexpr unsigned int Class_1_A17F0CCA3D2B239E_TypeDefinitionIndex = 76248;

class Class_1_A17F0CCA3D2B239E : public ::System::Object
{
public:
	::System::String* _CardOwnerMarkerIconPath_k__BackingField; // 0x10
	::System::String* _UIColorState_k__BackingField; // 0x18
	::System::String* _HandbookCardTabIconPath_k__BackingField; // 0x20
	::System::String* _UltraBtnEffectPrefabPath_k__BackingField; // 0x28
	::System::String* _SwitchDayTalkIconPath_k__BackingField; // 0x30
	::System::String* _SystemFigurePath_k__BackingField; // 0x38
	::System::String* _BattleIconPath_k__BackingField; // 0x40
