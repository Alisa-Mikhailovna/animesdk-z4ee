...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__SETDEFAULTAPPLICATIONFORMIMETYPE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A6AD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__SETDEFAULTAPPLICATIONFORMIMETYPE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A6B10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__SETDEFAULTAPPLICATIONFORMIMETYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D29F3B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__SETDEFAULTAPPLICATIONFORMIMETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A6A50)
