...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__RELOADFROMDISK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A8040)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__RELOADFROMDISK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A80B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__RELOADFROMDISK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D29FF30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__RELOADFROMDISK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A7FD0)
