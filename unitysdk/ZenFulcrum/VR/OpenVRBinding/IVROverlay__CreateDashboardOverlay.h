...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CREATEDASHBOARDOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AC110)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CREATEDASHBOARDOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AC190)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CREATEDASHBOARDOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AC0E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CREATEDASHBOARDOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AC060)
