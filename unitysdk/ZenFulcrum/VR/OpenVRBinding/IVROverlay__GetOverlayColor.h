...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYCOLOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ACC20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYCOLOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ACCD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ACBF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2ACB80)
