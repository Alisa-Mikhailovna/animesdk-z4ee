...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__SETWORKINGCOLLISIONBOUNDSTAGSINFO_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A82E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__SETWORKINGCOLLISIONBOUNDSTAGSINFO_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A8340)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__SETWORKINGCOLLISIONBOUNDSTAGSINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D29FFC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__SETWORKINGCOLLISIONBOUNDSTAGSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A8260)
