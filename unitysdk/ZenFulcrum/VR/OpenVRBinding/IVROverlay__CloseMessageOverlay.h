...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLOSEMESSAGEOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ABEB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLOSEMESSAGEOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ABEE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLOSEMESSAGEOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ABEA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLOSEMESSAGEOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2ABE30)
