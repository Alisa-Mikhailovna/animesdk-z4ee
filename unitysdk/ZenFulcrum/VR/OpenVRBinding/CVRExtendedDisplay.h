...
#define ZENFULCRUM_VR_OPENVRBINDING_CVREXTENDEDDISPLAY_GETDXGIOUTPUTINFO_OFFSET UNITYSDK_OFFSET(0x1D2A0E40)
#define ZENFULCRUM_VR_OPENVRBINDING_CVREXTENDEDDISPLAY_GETEYEOUTPUTVIEWPORT_OFFSET UNITYSDK_OFFSET(0x1D2A0DE0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVREXTENDEDDISPLAY_GETWINDOWBOUNDS_OFFSET UNITYSDK_OFFSET(0x1D2A0D90)
#define ZENFULCRUM_VR_OPENVRBINDING_CVREXTENDEDDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A0CB0)
