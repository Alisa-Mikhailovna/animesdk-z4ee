...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCERECONNECTPROCESS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9120)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCERECONNECTPROCESS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9150)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCERECONNECTPROCESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9110)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCERECONNECTPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A90A0)
