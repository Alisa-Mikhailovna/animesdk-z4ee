...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A2BC0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A2C90)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A2A10)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A2B40)
