...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINTERSECTIONMASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B06A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINTERSECTIONMASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B0770)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINTERSECTIONMASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B0670)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINTERSECTIONMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B0600)
