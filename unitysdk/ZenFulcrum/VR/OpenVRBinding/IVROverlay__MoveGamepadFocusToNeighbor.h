...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__MOVEGAMEPADFOCUSTONEIGHBOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AF540)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__MOVEGAMEPADFOCUSTONEIGHBOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AF5D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__MOVEGAMEPADFOCUSTONEIGHBOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AF530)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__MOVEGAMEPADFOCUSTONEIGHBOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AF4C0)
