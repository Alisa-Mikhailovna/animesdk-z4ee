...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__DESTROYOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AC370)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__DESTROYOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AC3C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__DESTROYOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AC360)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__DESTROYOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AC2F0)
