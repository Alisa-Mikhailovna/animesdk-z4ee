...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B8000)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B8070)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B7FF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B7F80)
