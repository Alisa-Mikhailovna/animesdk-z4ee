...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVESECTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B4D80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVESECTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B4E00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVESECTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B4D70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVESECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B4CF0)
