...
#define ZENFULCRUM_VR_OPENVRBINDING_CVROVERLAY__POLLNEXTOVERLAYEVENTPACKED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A2450)
#define ZENFULCRUM_VR_OPENVRBINDING_CVROVERLAY__POLLNEXTOVERLAYEVENTPACKED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A2500)
#define ZENFULCRUM_VR_OPENVRBINDING_CVROVERLAY__POLLNEXTOVERLAYEVENTPACKED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A1B90)
#define ZENFULCRUM_VR_OPENVRBINDING_CVROVERLAY__POLLNEXTOVERLAYEVENTPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A23E0)
