...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCURRENTFADECOLOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9330)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCURRENTFADECOLOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9380)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCURRENTFADECOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9310)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCURRENTFADECOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A92A0)
