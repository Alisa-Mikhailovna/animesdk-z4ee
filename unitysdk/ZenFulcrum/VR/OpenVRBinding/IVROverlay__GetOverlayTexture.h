...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ADDC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ADF30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ADD70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2ADD00)
