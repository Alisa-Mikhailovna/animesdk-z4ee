...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__ISMIRRORWINDOWVISIBLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA4F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__ISMIRRORWINDOWVISIBLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA520)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__ISMIRRORWINDOWVISIBLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA4E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__ISMIRRORWINDOWVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AA470)
