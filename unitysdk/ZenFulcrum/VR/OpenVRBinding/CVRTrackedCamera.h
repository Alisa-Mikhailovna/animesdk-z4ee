...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_ACQUIREVIDEOSTREAMINGSERVICE_OFFSET UNITYSDK_OFFSET(0x1D2A4A70)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETCAMERAERRORNAMEFROMENUM_OFFSET UNITYSDK_OFFSET(0x1D2A4910)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETCAMERAFRAMESIZE_OFFSET UNITYSDK_OFFSET(0x1D2A4990)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETCAMERAINTRINSICS_OFFSET UNITYSDK_OFFSET(0x1D2A49F0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETCAMERAPROJECTION_OFFSET UNITYSDK_OFFSET(0x1D2A4A30)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETVIDEOSTREAMFRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1D2A4AD0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETVIDEOSTREAMTEXTURED3D11_OFFSET UNITYSDK_OFFSET(0x1D2A4B80)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETVIDEOSTREAMTEXTUREGL_OFFSET UNITYSDK_OFFSET(0x1D2A4BE0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETVIDEOSTREAMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0x1D2A4B30)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_HASCAMERA_OFFSET UNITYSDK_OFFSET(0x1D2A4960)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_RELEASEVIDEOSTREAMINGSERVICE_OFFSET UNITYSDK_OFFSET(0x1D2A4AA0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_RELEASEVIDEOSTREAMTEXTUREGL_OFFSET UNITYSDK_OFFSET(0x1D2A4C30)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A4810)
