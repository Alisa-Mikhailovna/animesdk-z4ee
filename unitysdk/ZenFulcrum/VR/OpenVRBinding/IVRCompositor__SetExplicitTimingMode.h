...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SETEXPLICITTIMINGMODE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA970)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SETEXPLICITTIMINGMODE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA9C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SETEXPLICITTIMINGMODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA960)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SETEXPLICITTIMINGMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AA8F0)
