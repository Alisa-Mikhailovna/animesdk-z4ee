...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A5290)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A5310)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D29F4E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A5220)
