...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B7E00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B7E50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B7DF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B7D80)
