...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B3BE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B3CC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B3BA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B3B30)
