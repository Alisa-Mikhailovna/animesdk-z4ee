...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETTRANSITIONSTATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A6000)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETTRANSITIONSTATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A6030)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETTRANSITIONSTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D29F570)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETTRANSITIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A5F90)
