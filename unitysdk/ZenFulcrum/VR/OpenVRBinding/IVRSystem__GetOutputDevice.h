...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETOUTPUTDEVICE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B7050)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETOUTPUTDEVICE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B7100)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETOUTPUTDEVICE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B7030)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETOUTPUTDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B6FB0)
