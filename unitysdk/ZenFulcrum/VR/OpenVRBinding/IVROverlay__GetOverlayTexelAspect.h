...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXELASPECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ADC60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXELASPECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ADCD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXELASPECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2ADC50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXELASPECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2ADBE0)
