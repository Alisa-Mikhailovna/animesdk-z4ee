...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETUINT64TRACKEDDEVICEPROPERTY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B8130)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETUINT64TRACKEDDEVICEPROPERTY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B81E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETUINT64TRACKEDDEVICEPROPERTY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B8110)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETUINT64TRACKEDDEVICEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B80A0)
