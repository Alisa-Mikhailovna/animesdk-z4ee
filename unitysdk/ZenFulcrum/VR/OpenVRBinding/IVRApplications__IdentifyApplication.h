...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__IDENTIFYAPPLICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A60D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__IDENTIFYAPPLICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A6130)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__IDENTIFYAPPLICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D29F120)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__IDENTIFYAPPLICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A6060)
