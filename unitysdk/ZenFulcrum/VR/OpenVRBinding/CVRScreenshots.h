...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSCREENSHOTS_GETSCREENSHOTPROPERTYFILENAME_OFFSET UNITYSDK_OFFSET(0x1D2A2FB0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSCREENSHOTS_GETSCREENSHOTPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1D2A2F80)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSCREENSHOTS_HOOKSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1D2A2F40)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSCREENSHOTS_REQUESTSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1D2A2F00)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSCREENSHOTS_SUBMITSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1D2A3050)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSCREENSHOTS_TAKESTEREOSCREENSHOT_OFFSET UNITYSDK_OFFSET(0x1D2A3020)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSCREENSHOTS_UPDATESCREENSHOTPROGRESS_OFFSET UNITYSDK_OFFSET(0x1D2A2FF0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSCREENSHOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A2E10)
