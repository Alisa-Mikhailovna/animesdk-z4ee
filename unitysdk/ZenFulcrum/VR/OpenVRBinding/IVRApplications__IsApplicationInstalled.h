...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ISAPPLICATIONINSTALLED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A61D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ISAPPLICATIONINSTALLED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A6200)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ISAPPLICATIONINSTALLED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D29EE90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ISAPPLICATIONINSTALLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A6160)
