...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B4000)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B40B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B3FD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B3F50)
