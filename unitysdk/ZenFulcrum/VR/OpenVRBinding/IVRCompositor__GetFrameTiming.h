...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A96E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9770)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A96D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A9650)
