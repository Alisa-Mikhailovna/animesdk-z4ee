...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISACTIVEDASHBOARDOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AF160)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISACTIVEDASHBOARDOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AF1B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISACTIVEDASHBOARDOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AF150)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISACTIVEDASHBOARDOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AF0E0)
