...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__LOCKGLSHAREDTEXTUREFORACCESS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA5D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__LOCKGLSHAREDTEXTUREFORACCESS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA620)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__LOCKGLSHAREDTEXTUREFORACCESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA5C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__LOCKGLSHAREDTEXTUREFORACCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AA550)
