...
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GETGENERICINTERFACE_OFFSET UNITYSDK_OFFSET(0x1D2BA440)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GETINITTOKEN_OFFSET UNITYSDK_OFFSET(0x1D2BA6C0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GETSTRINGFORHMDERROR_OFFSET UNITYSDK_OFFSET(0x1D2BA310)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_APPLICATIONS_OFFSET UNITYSDK_OFFSET(0x1D2BBF90)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_CHAPERONESETUP_OFFSET UNITYSDK_OFFSET(0x1D2BAE50)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_CHAPERONE_OFFSET UNITYSDK_OFFSET(0x1D2BAB70)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_COMPOSITOR_OFFSET UNITYSDK_OFFSET(0x1D2BB130)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_EXTENDEDDISPLAY_OFFSET UNITYSDK_OFFSET(0x1D2BB9D0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_OPENVRINTERNAL_MODULECONTEXT_OFFSET UNITYSDK_OFFSET(0x1D2BA7E0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_OVERLAY_OFFSET UNITYSDK_OFFSET(0x1D2BB410)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_RENDERMODELS_OFFSET UNITYSDK_OFFSET(0x1D2BB6F0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_SCREENSHOTS_OFFSET UNITYSDK_OFFSET(0x1D2BC270)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1D2BBCB0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_SYSTEM_OFFSET UNITYSDK_OFFSET(0x1D2BA890)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_TRACKEDCAMERA_OFFSET UNITYSDK_OFFSET(0x1D2BC550)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_VRTOKEN_OFFSET UNITYSDK_OFFSET(0x1D2BA7C0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_INITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D2B9EF0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_INIT_OFFSET UNITYSDK_OFFSET(0x1D2BC830)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_ISHMDPRESENT_OFFSET UNITYSDK_OFFSET(0x1D2BA110)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_ISINTERFACEVERSIONVALID_OFFSET UNITYSDK_OFFSET(0x1D2BA580)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_ISRUNTIMEINSTALLED_OFFSET UNITYSDK_OFFSET(0x1D2BA210)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_SET_VRTOKEN_OFFSET UNITYSDK_OFFSET(0x1D2BA7D0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_SHUTDOWNINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D2BA010)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_SHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1D2BCB50)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2BCBD0)
