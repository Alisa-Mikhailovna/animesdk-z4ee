...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANINSTANCEEXTENSIONSREQUIRED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA240)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANINSTANCEEXTENSIONSREQUIRED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA2A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANINSTANCEEXTENSIONSREQUIRED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA230)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANINSTANCEEXTENSIONSREQUIRED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AA1B0)
