...
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_CHECKCLEAR_OFFSET UNITYSDK_OFFSET(0x1D2BCBE0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D2BCB30)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRAPPLICATIONS_OFFSET UNITYSDK_OFFSET(0x1D2BC030)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRCHAPERONESETUP_OFFSET UNITYSDK_OFFSET(0x1D2BAEF0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRCHAPERONE_OFFSET UNITYSDK_OFFSET(0x1D2BAC10)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRCOMPOSITOR_OFFSET UNITYSDK_OFFSET(0x1D2BB1D0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VREXTENDEDDISPLAY_OFFSET UNITYSDK_OFFSET(0x1D2BBA70)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VROVERLAY_OFFSET UNITYSDK_OFFSET(0x1D2BB4B0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRRENDERMODELS_OFFSET UNITYSDK_OFFSET(0x1D2BB790)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRSCREENSHOTS_OFFSET UNITYSDK_OFFSET(0x1D2BC310)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D2BBD50)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRSYSTEM_OFFSET UNITYSDK_OFFSET(0x1D2BA930)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRTRACKEDCAMERA_OFFSET UNITYSDK_OFFSET(0x1D2BC5F0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2BA870)
