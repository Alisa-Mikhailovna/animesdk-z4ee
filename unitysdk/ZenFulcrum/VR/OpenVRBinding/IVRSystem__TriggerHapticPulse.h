...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__TRIGGERHAPTICPULSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B8BD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__TRIGGERHAPTICPULSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B8C60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__TRIGGERHAPTICPULSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2B8BB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__TRIGGERHAPTICPULSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B8B40)
