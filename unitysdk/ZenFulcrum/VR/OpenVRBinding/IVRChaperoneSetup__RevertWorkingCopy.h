...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__REVERTWORKINGCOPY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A8130)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__REVERTWORKINGCOPY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A8160)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__REVERTWORKINGCOPY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D29FBA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__REVERTWORKINGCOPY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A80C0)
