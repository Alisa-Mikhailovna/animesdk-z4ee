...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETTRACKINGSPACE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA010)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETTRACKINGSPACE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA040)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETTRACKINGSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2AA000)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETTRACKINGSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A9F90)
