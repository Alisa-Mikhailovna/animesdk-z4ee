...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__SETSCENECOLOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A7280)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__SETSCENECOLOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A72F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__SETSCENECOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D29F930)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__SETSCENECOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A7210)
