...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCEINTERLEAVEDREPROJECTIONON_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9040)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCEINTERLEAVEDREPROJECTIONON_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9090)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCEINTERLEAVEDREPROJECTIONON_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2A9030)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCEINTERLEAVEDREPROJECTIONON__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A8FC0)
