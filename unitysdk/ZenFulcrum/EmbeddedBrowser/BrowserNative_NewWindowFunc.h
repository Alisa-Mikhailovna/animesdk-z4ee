...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWWINDOWFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D280990)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWWINDOWFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D280A20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWWINDOWFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D280970)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWWINDOWFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D280900)
