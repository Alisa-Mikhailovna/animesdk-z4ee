...
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_ADD_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1D293040)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_ADD_ONHANDLEPOINTERS_OFFSET UNITYSDK_OFFSET(0x1D292F80)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D293100)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_CALCULATEPOINTER_OFFSET UNITYSDK_OFFSET(0x1D293A90)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_CURSORUPDATED_OFFSET UNITYSDK_OFFSET(0x1D2943A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_FEEDFPS_OFFSET UNITYSDK_OFFSET(0x1D294C90)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_FEEDMOUSEPOINTER_OFFSET UNITYSDK_OFFSET(0x1D294A20)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_FEEDPOINTERSTATE_OFFSET UNITYSDK_OFFSET(0x1D2936D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_FEEDTOUCHPOINTERS_OFFSET UNITYSDK_OFFSET(0x1D2947C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_FEEDVRPOINTERS_OFFSET UNITYSDK_OFFSET(0x1D295150)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_FORCEKEYBOARDHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1D2943B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_GET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x1D295220)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_GET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D295240)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_GET_KEYBOARDHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1D2951E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_GET_KEYEVENTS_OFFSET UNITYSDK_OFFSET(0x1D295200)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_GET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x1D2951A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_GET_MOUSEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1D295160)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_GET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D295180)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_GET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1D2951C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_INPUTUPDATE_OFFSET UNITYSDK_OFFSET(0x1D2935F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_MOUSEISOFF_OFFSET UNITYSDK_OFFSET(0x1D293FF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_MOUSEISOVER_OFFSET UNITYSDK_OFFSET(0x1D2941F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x1D2936C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_ONGUI_OFFSET UNITYSDK_OFFSET(0x1D294350)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_ONHANDLEPOINTERS_OFFSET UNITYSDK_OFFSET(0x1D2944C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_REMOVE_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1D2930A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_REMOVE_ONHANDLEPOINTERS_OFFSET UNITYSDK_OFFSET(0x1D292FE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_SET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x1D295230)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_SET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D295250)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_SET_KEYBOARDHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1D2951F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_SET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x1D2951B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_SET_MOUSEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1D295170)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_SET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D295190)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE_SET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1D2951D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_POINTERUIBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D295260)
