...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D27DFE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D27E070)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D27DFC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27DF50)
