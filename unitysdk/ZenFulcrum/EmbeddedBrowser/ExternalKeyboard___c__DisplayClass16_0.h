...
#define ZENFULCRUM_EMBEDDEDBROWSER_EXTERNALKEYBOARD___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D288370)
#define ZENFULCRUM_EMBEDDEDBROWSER_EXTERNALKEYBOARD___C__DISPLAYCLASS16_0__OBSERVEBROWSER_B__0_OFFSET UNITYSDK_OFFSET(0x1D289260)
#define ZENFULCRUM_EMBEDDEDBROWSER_EXTERNALKEYBOARD___C__DISPLAYCLASS16_0__OBSERVEBROWSER_B__1_OFFSET UNITYSDK_OFFSET(0x1D2892B0)
