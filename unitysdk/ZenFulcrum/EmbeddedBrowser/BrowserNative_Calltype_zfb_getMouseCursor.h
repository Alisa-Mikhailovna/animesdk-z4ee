...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECURSOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D27D720)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECURSOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D27D7B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECURSOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D271370)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECURSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27D6B0)
