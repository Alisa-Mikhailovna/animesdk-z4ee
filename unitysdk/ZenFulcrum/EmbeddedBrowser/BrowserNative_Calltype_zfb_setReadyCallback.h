...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETREADYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D27FA80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETREADYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D27FAE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETREADYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D269CA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETREADYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27FA10)
