...
#define ZENFULCRUM_EMBEDDEDBROWSER_PROMISE_ENUMERATED_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D299BB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_PROMISE_ENUMERATED_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D299B20)
#define ZENFULCRUM_EMBEDDEDBROWSER_PROMISE_ENUMERATED_RESET_OFFSET UNITYSDK_OFFSET(0x1D299BA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_PROMISE_ENUMERATED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D298DB0)
