...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_INIT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D27DD80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_INIT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D27DDF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_INIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D279DD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_INIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27DD10)
