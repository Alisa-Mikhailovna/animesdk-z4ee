...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_ADDURLFOLDERMAPPING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D27C3A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_ADDURLFOLDERMAPPING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D27C3E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_ADDURLFOLDERMAPPING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D279E20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_ADDURLFOLDERMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27C320)
