...
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_AWAKE_OFFSET UNITYSDK_OFFSET(0x1D281050)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_CREATE_OFFSET UNITYSDK_OFFSET(0x1D280FE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_CURSORUPDATED_OFFSET UNITYSDK_OFFSET(0x1D281EA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x1D2821B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D2821D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_KEYBOARDHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1D282180)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_KEYEVENTS_OFFSET UNITYSDK_OFFSET(0x1D2821A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_LOOKRAY_OFFSET UNITYSDK_OFFSET(0x1D281160)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x1D282140)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_MOUSEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1D282100)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D282120)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1D282160)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_INPUTUPDATE_OFFSET UNITYSDK_OFFSET(0x1D281210)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_LOOKOFF_OFFSET UNITYSDK_OFFSET(0x1D281C40)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_LOOKON_OFFSET UNITYSDK_OFFSET(0x1D281CD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_ONGUI_OFFSET UNITYSDK_OFFSET(0x1D281D60)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SETCURSOR_OFFSET UNITYSDK_OFFSET(0x1D281F30)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x1D2821C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D2821E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_KEYBOARDHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1D282190)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x1D282150)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_MOUSEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1D282110)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1D282130)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1D282170)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D282270)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2821F0)
...
namespace ZenFulcrum::EmbeddedBrowser
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::KeyCode>**)Il2CppClass::FromTypeDefinitionIndex(ClickMeshBrowserUI_TypeDefinitionIndex)->GetStaticField(0x654C0);
		}
