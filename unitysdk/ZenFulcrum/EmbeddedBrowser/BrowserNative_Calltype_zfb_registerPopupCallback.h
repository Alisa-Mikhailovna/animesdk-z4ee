...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERPOPUPCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D27EB50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERPOPUPCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D27EC10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERPOPUPCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D26C4C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERPOPUPCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27EAE0)
