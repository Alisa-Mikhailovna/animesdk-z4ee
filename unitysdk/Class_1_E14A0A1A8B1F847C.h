...
#define CLASS_1_E14A0A1A8B1F847C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C177D70)
#define CLASS_1_E14A0A1A8B1F847C_CLONE_OFFSET UNITYSDK_OFFSET(0x1C177180)
#define CLASS_1_E14A0A1A8B1F847C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C177300)
#define CLASS_1_E14A0A1A8B1F847C_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C1772D0)
#define CLASS_1_E14A0A1A8B1F847C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C177550)
#define CLASS_1_E14A0A1A8B1F847C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C178250)
#define CLASS_1_E14A0A1A8B1F847C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C178180)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C1771E0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1C177270)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x1C177290)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_4_OFFSET UNITYSDK_OFFSET(0x1C1772B0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C1771B0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x1C177220)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C1771D0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C176F80)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C1771F0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1C177280)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x1C1772A0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_4_OFFSET UNITYSDK_OFFSET(0x1C1772C0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C1771C0)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_8633AE51B23EBDFD_1_OFFSET UNITYSDK_OFFSET(0x1C177260)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1C177210)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x1C177240)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C229FF62B898C0B2_1_OFFSET UNITYSDK_OFFSET(0x1C177250)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1C177200)
#define CLASS_1_E14A0A1A8B1F847C_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x1C177230)
#define CLASS_1_E14A0A1A8B1F847C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C176FB0)
#define CLASS_1_E14A0A1A8B1F847C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C177910)
#define CLASS_1_E14A0A1A8B1F847C_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C177970)
#define CLASS_1_E14A0A1A8B1F847C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C178450)
#define CLASS_1_E14A0A1A8B1F847C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C177050)
#define CLASS_1_E14A0A1A8B1F847C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C176FC0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex)->GetStaticField(0x22210);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex)->GetStaticField(0x22218);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_E14A0A1A8B1F847C*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_E14A0A1A8B1F847C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E14A0A1A8B1F847C_TypeDefinitionIndex)->GetStaticField(0x22220);
	}
