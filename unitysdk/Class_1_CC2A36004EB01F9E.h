...
#define CLASS_1_CC2A36004EB01F9E_GET_ASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xBAC69E0)
#define CLASS_1_CC2A36004EB01F9E_GET_AVGLIFETIMEMS_OFFSET UNITYSDK_OFFSET(0xBAC6AE0)
#define CLASS_1_CC2A36004EB01F9E_GET_BLOCKEDBYMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6A60)
#define CLASS_1_CC2A36004EB01F9E_GET_CREATES_OFFSET UNITYSDK_OFFSET(0xBAC6A00)
#define CLASS_1_CC2A36004EB01F9E_GET_CURRENTACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6A80)
#define CLASS_1_CC2A36004EB01F9E_GET_CURRENTPOOLCACHEDCOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6AC0)
#define CLASS_1_CC2A36004EB01F9E_GET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0xBAC69A0)
#define CLASS_1_CC2A36004EB01F9E_GET_LIFETIMESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6B00)
#define CLASS_1_CC2A36004EB01F9E_GET_PEAKACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6AA0)
#define CLASS_1_CC2A36004EB01F9E_GET_REMOVES_OFFSET UNITYSDK_OFFSET(0xBAC6A40)
#define CLASS_1_CC2A36004EB01F9E_GET_REUSES_OFFSET UNITYSDK_OFFSET(0xBAC6A20)
#define CLASS_1_CC2A36004EB01F9E_GET_SYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xBAC69C0)
#define CLASS_1_CC2A36004EB01F9E_METHOD_1_85C746F74910D9C1_OFFSET UNITYSDK_OFFSET(0xBAC6B70)
#define CLASS_1_CC2A36004EB01F9E_METHOD_1_D66F211912D83957_OFFSET UNITYSDK_OFFSET(0xBAC6B20)
#define CLASS_1_CC2A36004EB01F9E_SET_ASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xBAC69F0)
#define CLASS_1_CC2A36004EB01F9E_SET_AVGLIFETIMEMS_OFFSET UNITYSDK_OFFSET(0xBAC6AF0)
#define CLASS_1_CC2A36004EB01F9E_SET_BLOCKEDBYMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6A70)
#define CLASS_1_CC2A36004EB01F9E_SET_CREATES_OFFSET UNITYSDK_OFFSET(0xBAC6A10)
#define CLASS_1_CC2A36004EB01F9E_SET_CURRENTACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6A90)
#define CLASS_1_CC2A36004EB01F9E_SET_CURRENTPOOLCACHEDCOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6AD0)
#define CLASS_1_CC2A36004EB01F9E_SET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0xBAC69B0)
#define CLASS_1_CC2A36004EB01F9E_SET_LIFETIMESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6B10)
#define CLASS_1_CC2A36004EB01F9E_SET_PEAKACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xBAC6AB0)
#define CLASS_1_CC2A36004EB01F9E_SET_REMOVES_OFFSET UNITYSDK_OFFSET(0xBAC6A50)
#define CLASS_1_CC2A36004EB01F9E_SET_REUSES_OFFSET UNITYSDK_OFFSET(0xBAC6A30)
#define CLASS_1_CC2A36004EB01F9E_SET_SYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xBAC69D0)
#define CLASS_1_CC2A36004EB01F9E__CTOR_OFFSET UNITYSDK_OFFSET(0xBAC6BD0)

inline static constexpr unsigned int Class_1_CC2A36004EB01F9E_TypeDefinitionIndex = 73891;

class Class_1_CC2A36004EB01F9E : public ::System::Object
{
public:
	::System::String* _EffectPath_k__BackingField; // 0x10
	::System::Double _AvgLifetimeMs_k__BackingField; // 0x18
	::System::Int64 _Creates_k__BackingField; // 0x20
	::System::Int64 _LifetimeSampleCount_k__BackingField; // 0x28
	::System::Int64 _Removes_k__BackingField; // 0x30
	::System::Int32 _CurrentPoolCachedCount_k__BackingField; // 0x38
	::System::Int64 _BlockedByMaxCount_k__BackingField; // 0x40
	::System::Int64 _AsyncRequests_k__BackingField; // 0x48
	::System::Int32 _CurrentActiveCount_k__BackingField; // 0x50
	::System::Int32 _PeakActiveCount_k__BackingField; // 0x54
	::System::Int64 _Reuses_k__BackingField; // 0x58
