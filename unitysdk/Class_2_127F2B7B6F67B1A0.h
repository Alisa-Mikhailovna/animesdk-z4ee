...
#define CLASS_2_127F2B7B6F67B1A0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x151C7A00)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x151C7D70)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_42AC18B59FD1BBF7_OFFSET UNITYSDK_OFFSET(0x151C86B0)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_42D74E8C949A6883_OFFSET UNITYSDK_OFFSET(0x151C93B0)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_4FF5C46BD9B0A201_OFFSET UNITYSDK_OFFSET(0x151C81A0)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_595E641DF1B4387D_OFFSET UNITYSDK_OFFSET(0x151CB600)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_77214A3B97B43618_OFFSET UNITYSDK_OFFSET(0x151CA730)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_7F96D036B1631510_OFFSET UNITYSDK_OFFSET(0x151C9000)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_80A1D4EEAE413441_OFFSET UNITYSDK_OFFSET(0x151C8860)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_88E73C0ABCC4541C_OFFSET UNITYSDK_OFFSET(0x151CB3D0)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_9CD607631367DD7F_OFFSET UNITYSDK_OFFSET(0x151CB570)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_AB97216C395056F6_OFFSET UNITYSDK_OFFSET(0x151C8740)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_C1A54F04AE7B39A9_OFFSET UNITYSDK_OFFSET(0x151C9FD0)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0x151CB500)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_D09831639F615812_OFFSET UNITYSDK_OFFSET(0x151CA6B0)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_DA4377709D1B2DE3_OFFSET UNITYSDK_OFFSET(0x151C7FF0)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0x151C8220)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_F0F3151B754D3D59_OFFSET UNITYSDK_OFFSET(0x151C9F30)
#define CLASS_2_127F2B7B6F67B1A0_METHOD_2_F4A21CEE51B916EB_OFFSET UNITYSDK_OFFSET(0x151C87F0)
#define CLASS_2_127F2B7B6F67B1A0__CTOR_OFFSET UNITYSDK_OFFSET(0x151CB720)
...
{
public:
	::System::Collections::Generic::List_1<::Class_2_127F2B7B6F67B1A0_Class_1_D2A5FF10ABB22F68*>* Field_2_0; // 0x10
	::Class_2_127F2B7B6F67B1A0_Class_1_911D66F07223209A* Field_2_1; // 0x18
	::Class_2_127F2B7B6F67B1A0_Class_1_911D66F07223209A* Field_2_2; // 0x20
	::RPG::Client::AdventurePhase* Field_2_3; // 0x28
	::System::Collections::Generic::List_1<::Class_2_127F2B7B6F67B1A0_Class_1_D2A5FF10ABB22F68*>* Field_2_4; // 0x30
	::RPG::Client::MapRotationInfo* Field_2_5; // 0x38
	::UnityEngine::GameObject* Field_2_6; // 0x40
	::Class_2_36C95D73718D07B1* Field_2_7; // 0x48
	::Class_1_64D890C466F37235* Field_2_8; // 0x50
