...
#define CLASS_2_7AC5CDC6676C412B_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x154C0B60)
#define CLASS_2_7AC5CDC6676C412B_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x154C10D0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x154C0570)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_21EA93B9163957EE_OFFSET UNITYSDK_OFFSET(0x154BE570)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x154BD7C0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_609FA3D38FA252B6_OFFSET UNITYSDK_OFFSET(0x154BE080)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_67622E8270A5AACD_OFFSET UNITYSDK_OFFSET(0x154C04C0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_87A84693C939DE46_OFFSET UNITYSDK_OFFSET(0x154BF9A0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_974A70E8019154E7_OFFSET UNITYSDK_OFFSET(0x154C09D0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x154BE6B0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_A4F8E611A5D950A3_OFFSET UNITYSDK_OFFSET(0x154BED80)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_AB5700066D170323_OFFSET UNITYSDK_OFFSET(0x154BE5E0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0x154BF920)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DC7F1ABAE2B942B0_OFFSET UNITYSDK_OFFSET(0x154BE8E0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DD152A1A30757DCD_OFFSET UNITYSDK_OFFSET(0x154BDA00)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_DFEC27F1F6CA5A80_OFFSET UNITYSDK_OFFSET(0x154BEE00)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_E0E8085812DD34DC_OFFSET UNITYSDK_OFFSET(0x154BE840)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_EBAA2610320ABA27_OFFSET UNITYSDK_OFFSET(0x154BE740)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0x154BDA70)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x154C06D0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0x154C0790)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F37CDBD6D46274D2_3_OFFSET UNITYSDK_OFFSET(0x154C0850)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F37CDBD6D46274D2_4_OFFSET UNITYSDK_OFFSET(0x154C0910)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F37CDBD6D46274D2_5_OFFSET UNITYSDK_OFFSET(0x154C0AD0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x154C05D0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F3896F8909B8FA57_OFFSET UNITYSDK_OFFSET(0x154BF470)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_F5D0DE62B372C4C0_OFFSET UNITYSDK_OFFSET(0x154BF4F0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_FA2D80D2EE1C4874_OFFSET UNITYSDK_OFFSET(0x154BF3F0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_FD3B916300F77FDA_1_OFFSET UNITYSDK_OFFSET(0x154BD9B0)
#define CLASS_2_7AC5CDC6676C412B_METHOD_2_FD3B916300F77FDA_OFFSET UNITYSDK_OFFSET(0x154BD950)
#define CLASS_2_7AC5CDC6676C412B__CTOR_OFFSET UNITYSDK_OFFSET(0x154C1600)
#define CLASS_2_7AC5CDC6676C412B__ONBIND_OFFSET UNITYSDK_OFFSET(0x154BD740)
#define CLASS_2_7AC5CDC6676C412B__ONTICK_OFFSET UNITYSDK_OFFSET(0x154BD8E0)
#define CLASS_2_7AC5CDC6676C412B__PLAYFADE_B__8_0_OFFSET UNITYSDK_OFFSET(0x154C1710)

inline static constexpr unsigned int Class_2_7AC5CDC6676C412B_TypeDefinitionIndex = 68396;
