...
#define CLASS_1_6DED08B7C7C749EF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BBC1C30)
#define CLASS_1_6DED08B7C7C749EF_CLONE_OFFSET UNITYSDK_OFFSET(0x1BBC1600)
#define CLASS_1_6DED08B7C7C749EF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BBC1810)
#define CLASS_1_6DED08B7C7C749EF_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BBC16C0)
#define CLASS_1_6DED08B7C7C749EF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BBC1930)
#define CLASS_1_6DED08B7C7C749EF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BBC1D80)
#define CLASS_1_6DED08B7C7C749EF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BBC1D20)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1BBC1670)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1BBC1660)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1BBC1490)
#define CLASS_1_6DED08B7C7C749EF_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1BBC1650)
#define CLASS_1_6DED08B7C7C749EF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BBC14F0)
#define CLASS_1_6DED08B7C7C749EF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BBC1AB0)
#define CLASS_1_6DED08B7C7C749EF_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BBC1B10)
#define CLASS_1_6DED08B7C7C749EF__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BBC1F80)
#define CLASS_1_6DED08B7C7C749EF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BBC1560)
#define CLASS_1_6DED08B7C7C749EF__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBC1500)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_TypeDefinitionIndex)->GetStaticField(0x317B0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_TypeDefinitionIndex)->GetStaticField(0x317B8);
	}
