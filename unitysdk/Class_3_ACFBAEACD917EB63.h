...
#define CLASS_3_ACFBAEACD917EB63_METHOD_3_8B5E3014AFF7F8EA_OFFSET UNITYSDK_OFFSET(0x1A4A2CA0)
#define CLASS_3_ACFBAEACD917EB63_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A4A2BA0)
#define CLASS_3_ACFBAEACD917EB63_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A4A3280)
#define CLASS_3_ACFBAEACD917EB63__CTOR_OFFSET UNITYSDK_OFFSET(0x1A48EC50)
