...
#define CLASS_2_98CF7261B6FD45E3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x153DC940)
#define CLASS_2_98CF7261B6FD45E3_METHOD_2_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x153DD440)
#define CLASS_2_98CF7261B6FD45E3_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x153DD290)
#define CLASS_2_98CF7261B6FD45E3_METHOD_2_9D0688AE2E08E349_OFFSET UNITYSDK_OFFSET(0x153DCC20)
#define CLASS_2_98CF7261B6FD45E3_METHOD_2_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x153DCEF0)
#define CLASS_2_98CF7261B6FD45E3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x153DCB30)
#define CLASS_2_98CF7261B6FD45E3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x153DD070)
#define CLASS_2_98CF7261B6FD45E3_TICK_OFFSET UNITYSDK_OFFSET(0x153DD150)
#define CLASS_2_98CF7261B6FD45E3__CTOR_OFFSET UNITYSDK_OFFSET(0x153DC850)
...
public:
	...
	::RPG::GameCore::ConsumeMissionItemPerformance* Field_2_4; // 0x20
	::Class_3_07C3C4D2990C49EE* Field_2_5; // 0x28
	::RPG::GameCore::SubMissionRow* Field_2_6; // 0x30
	::Class_3_07C3C4D2990C49EE* Field_2_7; // 0x38
	::RPG::GameCore::TaskContext* Field_2_8; // 0x40
