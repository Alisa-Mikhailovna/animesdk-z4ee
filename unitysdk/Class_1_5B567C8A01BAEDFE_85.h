...
#define CLASS_1_5B567C8A01BAEDFE_85_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C6AB2A0)
#define CLASS_1_5B567C8A01BAEDFE_85_CLONE_OFFSET UNITYSDK_OFFSET(0x1C6AAF90)
#define CLASS_1_5B567C8A01BAEDFE_85_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C6AB0A0)
#define CLASS_1_5B567C8A01BAEDFE_85_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C6AAFD0)
#define CLASS_1_5B567C8A01BAEDFE_85_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C6AB200)
#define CLASS_1_5B567C8A01BAEDFE_85_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C6AB2F0)
#define CLASS_1_5B567C8A01BAEDFE_85_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C6AB2C0)
#define CLASS_1_5B567C8A01BAEDFE_85_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C6AAF10)
#define CLASS_1_5B567C8A01BAEDFE_85_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C6AAF40)
#define CLASS_1_5B567C8A01BAEDFE_85_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C6AB230)
#define CLASS_1_5B567C8A01BAEDFE_85_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C6AB290)
#define CLASS_1_5B567C8A01BAEDFE_85__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6AB340)
#define CLASS_1_5B567C8A01BAEDFE_85__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6AAF60)
#define CLASS_1_5B567C8A01BAEDFE_85__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6AAF50)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_85*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_85_TypeDefinitionIndex)->GetStaticField(0x68510);
	}
