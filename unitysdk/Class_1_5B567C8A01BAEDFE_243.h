...
#define CLASS_1_5B567C8A01BAEDFE_243_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C6A0810)
#define CLASS_1_5B567C8A01BAEDFE_243_CLONE_OFFSET UNITYSDK_OFFSET(0x1C6A04B0)
#define CLASS_1_5B567C8A01BAEDFE_243_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C6A0610)
#define CLASS_1_5B567C8A01BAEDFE_243_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C6A0520)
#define CLASS_1_5B567C8A01BAEDFE_243_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C6A0770)
#define CLASS_1_5B567C8A01BAEDFE_243_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C6A0860)
#define CLASS_1_5B567C8A01BAEDFE_243_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C6A0830)
#define CLASS_1_5B567C8A01BAEDFE_243_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C6A0400)
#define CLASS_1_5B567C8A01BAEDFE_243_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C6A0460)
#define CLASS_1_5B567C8A01BAEDFE_243_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C6A07A0)
#define CLASS_1_5B567C8A01BAEDFE_243_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C6A0800)
#define CLASS_1_5B567C8A01BAEDFE_243__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6A08B0)
#define CLASS_1_5B567C8A01BAEDFE_243__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6A0480)
#define CLASS_1_5B567C8A01BAEDFE_243__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6A0470)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_243*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_243_TypeDefinitionIndex)->GetStaticField(0x68000);
	}
