...
#define CARFLOWMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD060820)
#define CARFLOWMANAGER_GETNEXTROUTE_OFFSET UNITYSDK_OFFSET(0xD33FB70)
#define CARFLOWMANAGER_METHOD_5_118F52D5C8BFF4E4_OFFSET UNITYSDK_OFFSET(0xD33FE10)
#define CARFLOWMANAGER_METHOD_5_13552F67455E3764_OFFSET UNITYSDK_OFFSET(0xD340000)
#define CARFLOWMANAGER_METHOD_5_1953F86B3BCC0E34_OFFSET UNITYSDK_OFFSET(0xD062D80)
#define CARFLOWMANAGER_METHOD_5_2DF1E18DDFFAC256_OFFSET UNITYSDK_OFFSET(0xD062210)
#define CARFLOWMANAGER_METHOD_5_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0xD33FF80)
#define CARFLOWMANAGER_METHOD_5_45872D1C931761E1_OFFSET UNITYSDK_OFFSET(0xD0622A0)
#define CARFLOWMANAGER_METHOD_5_6415A809F05B92A2_OFFSET UNITYSDK_OFFSET(0xD0624C0)
#define CARFLOWMANAGER_METHOD_5_6CB03087A432B09A_OFFSET UNITYSDK_OFFSET(0xD33FB00)
#define CARFLOWMANAGER_METHOD_5_71B4B8707E3FB1F0_OFFSET UNITYSDK_OFFSET(0xD062920)
#define CARFLOWMANAGER_METHOD_5_821464E984634C6E_OFFSET UNITYSDK_OFFSET(0xD0619E0)
#define CARFLOWMANAGER_METHOD_5_858C0EE85497EE5C_OFFSET UNITYSDK_OFFSET(0xD062340)
#define CARFLOWMANAGER_METHOD_5_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0xD060870)
#define CARFLOWMANAGER_METHOD_5_BC2B5197E2682305_OFFSET UNITYSDK_OFFSET(0xD062690)
#define CARFLOWMANAGER_SPAWNCAR_OFFSET UNITYSDK_OFFSET(0xD0615B0)
#define CARFLOWMANAGER_START_OFFSET UNITYSDK_OFFSET(0xD060DC0)
#define CARFLOWMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD060E00)
#define CARFLOWMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD3401D0)
#define CARFLOWMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3401B0)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CarFlowManager_TypeDefinitionIndex)->GetStaticField(0x10BE0);
	}
	static ::System::Single* StaticGet_DefaultStaticCarMinDistance()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CarFlowManager_TypeDefinitionIndex)->GetStaticField(0x10BE4);
	}
