...
#define HIPPLENBUILDERUIMAN_CLOSEBEHAVIORPANEL_OFFSET UNITYSDK_OFFSET(0x14BE0CA0)
#define HIPPLENBUILDERUIMAN_CLOSEBUFFSELECTIONPANEL_OFFSET UNITYSDK_OFFSET(0x14BDFA00)
#define HIPPLENBUILDERUIMAN_CLOSEENDDAYPANEL_OFFSET UNITYSDK_OFFSET(0x14BDF1E0)
#define HIPPLENBUILDERUIMAN_CLOSETAKETESTPANEL_OFFSET UNITYSDK_OFFSET(0x14BDF990)
#define HIPPLENBUILDERUIMAN_CLOSETRANINGBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0x14BD6C60)
#define HIPPLENBUILDERUIMAN_CREATESTATUSITEMS_OFFSET UNITYSDK_OFFSET(0x14BD0450)
#define HIPPLENBUILDERUIMAN_DISPLAYACTIVITIES_OFFSET UNITYSDK_OFFSET(0x14BD5FC0)
#define HIPPLENBUILDERUIMAN_DISPLAYBEHAVIORMSG_OFFSET UNITYSDK_OFFSET(0x14BDB860)
#define HIPPLENBUILDERUIMAN_HIDETESTPANEL_OFFSET UNITYSDK_OFFSET(0x14BDFA70)
#define HIPPLENBUILDERUIMAN_INIT_OFFSET UNITYSDK_OFFSET(0x14BCFE60)
#define HIPPLENBUILDERUIMAN_METHOD_5_039D2AB733A05336_OFFSET UNITYSDK_OFFSET(0x14BE0910)
#define HIPPLENBUILDERUIMAN_METHOD_5_E915B76EB62656B0_OFFSET UNITYSDK_OFFSET(0x14BDEE80)
#define HIPPLENBUILDERUIMAN_METHOD_5_F5FA636E6C5F7D3F_OFFSET UNITYSDK_OFFSET(0x14BE0180)
#define HIPPLENBUILDERUIMAN_METHOD_5_FA2A5D054A26EC88_OFFSET UNITYSDK_OFFSET(0x14BDF240)
#define HIPPLENBUILDERUIMAN_ONTESTLINECLICK_OFFSET UNITYSDK_OFFSET(0x14BDFAD0)
#define HIPPLENBUILDERUIMAN_OPENBUFFSELECTIONPANEL_OFFSET UNITYSDK_OFFSET(0x14BD1EE0)
#define HIPPLENBUILDERUIMAN_OPENENDDAYPANEL_OFFSET UNITYSDK_OFFSET(0x14BD3360)
#define HIPPLENBUILDERUIMAN_OPENTAKETESTPANEL_OFFSET UNITYSDK_OFFSET(0x14BD7550)
#define HIPPLENBUILDERUIMAN_OPENTESTPANEL_OFFSET UNITYSDK_OFFSET(0x14BD1B20)
#define HIPPLENBUILDERUIMAN_OPENTRAININGBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0x14BD6930)
#define HIPPLENBUILDERUIMAN_PINTESTLINE_OFFSET UNITYSDK_OFFSET(0x14BDE640)
#define HIPPLENBUILDERUIMAN_REFRESHBUFFDISPLAY_OFFSET UNITYSDK_OFFSET(0x14BD5780)
#define HIPPLENBUILDERUIMAN_REFRESHSTATUSITEMS_OFFSET UNITYSDK_OFFSET(0x14BD41E0)
#define HIPPLENBUILDERUIMAN_REFRESHTESTLINEPANEL_OFFSET UNITYSDK_OFFSET(0x14BD38B0)
#define HIPPLENBUILDERUIMAN_REFRESHTIMEDISPLAY_OFFSET UNITYSDK_OFFSET(0x14BD55B0)
#define HIPPLENBUILDERUIMAN_REFRESHTODOLIST_OFFSET UNITYSDK_OFFSET(0x14BD3CE0)
#define HIPPLENBUILDERUIMAN_SETACTIVITYMODE_OFFSET UNITYSDK_OFFSET(0x14BD68A0)
#define HIPPLENBUILDERUIMAN_SHOWTESTLINEPANEL_OFFSET UNITYSDK_OFFSET(0x14BDFB60)
#define HIPPLENBUILDERUIMAN_TRYDISPLAYBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x14BD2DD0)
#define HIPPLENBUILDERUIMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x14BE0D60)
