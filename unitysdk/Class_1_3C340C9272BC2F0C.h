...
#define CLASS_1_3C340C9272BC2F0C_GET_RECOMMENDMAINAFFIXBONUS_OFFSET UNITYSDK_OFFSET(0xAF9A8C0)
#define CLASS_1_3C340C9272BC2F0C_GET_RELICSCORERESULTINFO_OFFSET UNITYSDK_OFFSET(0xAF9A8A0)
#define CLASS_1_3C340C9272BC2F0C_METHOD_1_319FFA9E947BAB13_OFFSET UNITYSDK_OFFSET(0xAF9A970)
#define CLASS_1_3C340C9272BC2F0C_METHOD_1_FF5188F77C143723_OFFSET UNITYSDK_OFFSET(0xAF9A8E0)
#define CLASS_1_3C340C9272BC2F0C_SET_RECOMMENDMAINAFFIXBONUS_OFFSET UNITYSDK_OFFSET(0xAF9A8D0)
#define CLASS_1_3C340C9272BC2F0C_SET_RELICSCORERESULTINFO_OFFSET UNITYSDK_OFFSET(0xAF9A8B0)
#define CLASS_1_3C340C9272BC2F0C__CTOR_OFFSET UNITYSDK_OFFSET(0xAF9AAF0)

inline static constexpr unsigned int Class_1_3C340C9272BC2F0C_TypeDefinitionIndex = 71036;
