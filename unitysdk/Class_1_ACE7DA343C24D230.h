...
#define CLASS_1_ACE7DA343C24D230_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C627180)
#define CLASS_1_ACE7DA343C24D230_CLONE_OFFSET UNITYSDK_OFFSET(0x1C626C40)
#define CLASS_1_ACE7DA343C24D230_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C626E20)
#define CLASS_1_ACE7DA343C24D230_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C626CC0)
#define CLASS_1_ACE7DA343C24D230_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C626F50)
#define CLASS_1_ACE7DA343C24D230_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C6273C0)
#define CLASS_1_ACE7DA343C24D230_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C627310)
#define CLASS_1_ACE7DA343C24D230_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C626CA0)
#define CLASS_1_ACE7DA343C24D230_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C626C70)
#define CLASS_1_ACE7DA343C24D230_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C626AF0)
#define CLASS_1_ACE7DA343C24D230_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C626CB0)
#define CLASS_1_ACE7DA343C24D230_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C626C80)
#define CLASS_1_ACE7DA343C24D230_METHOD_1_AD515D31D5C81878_OFFSET UNITYSDK_OFFSET(0x1C626C90)
#define CLASS_1_ACE7DA343C24D230_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C626B20)
#define CLASS_1_ACE7DA343C24D230_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C626FC0)
#define CLASS_1_ACE7DA343C24D230_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C627020)
#define CLASS_1_ACE7DA343C24D230__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C627650)
#define CLASS_1_ACE7DA343C24D230__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C626B80)
#define CLASS_1_ACE7DA343C24D230__CTOR_OFFSET UNITYSDK_OFFSET(0x1C626B30)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PlayerAssistInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_ACE7DA343C24D230_TypeDefinitionIndex)->GetStaticField(0x64020);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_ACE7DA343C24D230*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_ACE7DA343C24D230*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_ACE7DA343C24D230_TypeDefinitionIndex)->GetStaticField(0x64028);
	}
