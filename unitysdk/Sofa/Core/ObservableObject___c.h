...
#define SOFA_CORE_OBSERVABLEOBJECT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C91EC60)
#define SOFA_CORE_OBSERVABLEOBJECT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C91ECA0)
#define SOFA_CORE_OBSERVABLEOBJECT___C___GETPROPERTYCHANGEDEVENTARGS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1C91ECB0)
...
namespace Sofa::Core
{
	...
	public:
		...
		{
			return (::System::Func_2<::System::String*, ::System::ComponentModel::PropertyChangedEventArgs*>**)Il2CppClass::FromTypeDefinitionIndex(ObservableObject___c_TypeDefinitionIndex)->GetStaticField(0x4C3D0);
		}
		static ::Sofa::Core::ObservableObject___c** StaticGet___9()
		{
			return (::Sofa::Core::ObservableObject___c**)Il2CppClass::FromTypeDefinitionIndex(ObservableObject___c_TypeDefinitionIndex)->GetStaticField(0x4C3D8);
		}
