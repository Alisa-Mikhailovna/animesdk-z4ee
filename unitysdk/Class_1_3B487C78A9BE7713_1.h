...
#define CLASS_1_3B487C78A9BE7713_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BF0B8C0)
#define CLASS_1_3B487C78A9BE7713_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1BF0B4A0)
#define CLASS_1_3B487C78A9BE7713_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BF0B620)
#define CLASS_1_3B487C78A9BE7713_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BF0B4E0)
#define CLASS_1_3B487C78A9BE7713_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BF0B740)
#define CLASS_1_3B487C78A9BE7713_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BF0BA00)
#define CLASS_1_3B487C78A9BE7713_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BF0B960)
#define CLASS_1_3B487C78A9BE7713_1_METHOD_1_2E179BEDD6B3AA06_OFFSET UNITYSDK_OFFSET(0x1BF0B4D0)
#define CLASS_1_3B487C78A9BE7713_1_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BF0B390)
#define CLASS_1_3B487C78A9BE7713_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BF0B3C0)
#define CLASS_1_3B487C78A9BE7713_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BF0B7B0)
#define CLASS_1_3B487C78A9BE7713_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BF0B810)
#define CLASS_1_3B487C78A9BE7713_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BF0BBB0)
#define CLASS_1_3B487C78A9BE7713_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BF0B410)
#define CLASS_1_3B487C78A9BE7713_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF0B3D0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Enum_3_96F6662CA3713095_24>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3B487C78A9BE7713_1_TypeDefinitionIndex)->GetStaticField(0x20A80);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_3B487C78A9BE7713_1*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_3B487C78A9BE7713_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3B487C78A9BE7713_1_TypeDefinitionIndex)->GetStaticField(0x20A88);
	}
