...
#define SWRT_AABB_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x39F0820)
#define SWRT_AABB_GET_EXTENDS_OFFSET UNITYSDK_OFFSET(0x39F0860)
#define SWRT_AABB_GET_MAX_OFFSET UNITYSDK_OFFSET(0x25510)
#define SWRT_AABB_GET_MIN_OFFSET UNITYSDK_OFFSET(0x254F0)
#define SWRT_AABB_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x39EE9A0)
#define SWRT_AABB_SET_MAX_OFFSET UNITYSDK_OFFSET(0x14C490)
#define SWRT_AABB_SET_MIN_OFFSET UNITYSDK_OFFSET(0x1CE8A90)
#define SWRT_AABB_SURFACEAREA_OFFSET UNITYSDK_OFFSET(0x39F0A70)
#define SWRT_AABB_UNION_1_OFFSET UNITYSDK_OFFSET(0x1AAC7C00)
#define SWRT_AABB_UNION_OFFSET UNITYSDK_OFFSET(0x39F0A20)
#define SWRT_AABB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x39F0940)
#define SWRT_AABB__CTOR_OFFSET UNITYSDK_OFFSET(0x39F08A0)
