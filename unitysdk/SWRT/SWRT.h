...
#define SWRT_SWRT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AACBB50)
#define SWRT_SWRT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AACB9B0)
#define SWRT_SWRT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACBC50)
