...
#define CODABLE_JSONBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0xA9E3660)
#define CODABLE_JSONBOOL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA9E3510)
#define CODABLE_JSONBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA9E3680)
#define CODABLE_JSONBOOL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0xA9E35A0)
#define CODABLE_JSONBOOL_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0xA9E3500)
#define CODABLE_JSONBOOL_GET_TAG_OFFSET UNITYSDK_OFFSET(0xA9E34F0)
#define CODABLE_JSONBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA9E3530)
#define CODABLE_JSONBOOL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0xA9E35B0)
#define CODABLE_JSONBOOL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA9E3550)
#define CODABLE_JSONBOOL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0xA9E3620)
#define CODABLE_JSONBOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA9E35D0)
#define CODABLE_JSONBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0xA9E35C0)
