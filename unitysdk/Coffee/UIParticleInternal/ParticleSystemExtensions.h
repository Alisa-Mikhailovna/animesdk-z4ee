...
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_CANBAKEMESH_OFFSET UNITYSDK_OFFSET(0x15710020)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_EXEC_OFFSET UNITYSDK_OFFSET(0x15706310)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_GETACTUALSIMULATIONSPACE_OFFSET UNITYSDK_OFFSET(0x15711420)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_GETINDEX_OFFSET UNITYSDK_OFFSET(0x157141E0)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_GETMAINEMITTER_OFFSET UNITYSDK_OFFSET(0x15708A80)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_GETPARTICLEARRAY_OFFSET UNITYSDK_OFFSET(0x1570D260)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_GETTEXTUREFORSPRITE_OFFSET UNITYSDK_OFFSET(0x1570DD10)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_ISLOCALSPACE_OFFSET UNITYSDK_OFFSET(0x1570DB10)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_ISSUBEMITTEROF_OFFSET UNITYSDK_OFFSET(0x157144F0)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_ISWORLDSPACE_OFFSET UNITYSDK_OFFSET(0x15711470)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_SORTFORRENDERING_OFFSET UNITYSDK_OFFSET(0x157140C0)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS_VALIDATESHAPE_OFFSET UNITYSDK_OFFSET(0x15710070)
#define COFFEE_UIPARTICLEINTERNAL_PARTICLESYSTEMEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x15714580)
