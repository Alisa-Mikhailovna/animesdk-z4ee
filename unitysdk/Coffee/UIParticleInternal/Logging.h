...
#define COFFEE_UIPARTICLEINTERNAL_LOGGING_APPENDREADABLECODE_OFFSET UNITYSDK_OFFSET(0x15713A90)
#define COFFEE_UIPARTICLEINTERNAL_LOGGING_APPENDTAG_OFFSET UNITYSDK_OFFSET(0x15713A70)
#define COFFEE_UIPARTICLEINTERNAL_LOGGING_APPENDTYPE_OFFSET UNITYSDK_OFFSET(0x15713A80)
#define COFFEE_UIPARTICLEINTERNAL_LOGGING_LOGERROR_OFFSET UNITYSDK_OFFSET(0x157139E0)
#define COFFEE_UIPARTICLEINTERNAL_LOGGING_LOGIF_OFFSET UNITYSDK_OFFSET(0x157139B0)
#define COFFEE_UIPARTICLEINTERNAL_LOGGING_LOGMULTICAST_OFFSET UNITYSDK_OFFSET(0x15713A60)
#define COFFEE_UIPARTICLEINTERNAL_LOGGING_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x157139D0)
#define COFFEE_UIPARTICLEINTERNAL_LOGGING_LOG_INTERNAL_OFFSET UNITYSDK_OFFSET(0x157139A0)
#define COFFEE_UIPARTICLEINTERNAL_LOGGING_LOG_OFFSET UNITYSDK_OFFSET(0x157139C0)
