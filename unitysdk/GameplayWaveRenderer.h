...
#define GAMEPLAYWAVERENDERER_DISTANCETOCURVE_OFFSET UNITYSDK_OFFSET(0x149DF890)
#define GAMEPLAYWAVERENDERER_ISONCURVE_OFFSET UNITYSDK_OFFSET(0x149DF3F0)
#define GAMEPLAYWAVERENDERER_METHOD_5_0A0D9CF4F55A5F8A_OFFSET UNITYSDK_OFFSET(0x149E0650)
#define GAMEPLAYWAVERENDERER_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x149DE8C0)
#define GAMEPLAYWAVERENDERER_METHOD_5_22D0ADB352880F38_OFFSET UNITYSDK_OFFSET(0x149E02C0)
#define GAMEPLAYWAVERENDERER_METHOD_5_23EC84018340F48F_OFFSET UNITYSDK_OFFSET(0x149DFCC0)
#define GAMEPLAYWAVERENDERER_METHOD_5_2F1BBD8275DBBFC1_OFFSET UNITYSDK_OFFSET(0x149DF900)
#define GAMEPLAYWAVERENDERER_METHOD_5_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0x149DF7F0)
#define GAMEPLAYWAVERENDERER_METHOD_5_53D756D4922CDE85_OFFSET UNITYSDK_OFFSET(0x149DF2E0)
#define GAMEPLAYWAVERENDERER_METHOD_5_6E10DBA521A04356_OFFSET UNITYSDK_OFFSET(0x149DEAE0)
#define GAMEPLAYWAVERENDERER_METHOD_5_7331A1455F3F12A1_OFFSET UNITYSDK_OFFSET(0x149E08C0)
#define GAMEPLAYWAVERENDERER_METHOD_5_756EBA0001D7C7DB_OFFSET UNITYSDK_OFFSET(0x149E04D0)
#define GAMEPLAYWAVERENDERER_METHOD_5_85E657E328490B3B_OFFSET UNITYSDK_OFFSET(0x149DF780)
#define GAMEPLAYWAVERENDERER_METHOD_5_87CBD6057B3B766D_OFFSET UNITYSDK_OFFSET(0x149E0190)
#define GAMEPLAYWAVERENDERER_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x149DE380)
#define GAMEPLAYWAVERENDERER_METHOD_5_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x149DF2A0)
#define GAMEPLAYWAVERENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x149DE570)
#define GAMEPLAYWAVERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x149DE330)
#define GAMEPLAYWAVERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x149DE140)
#define GAMEPLAYWAVERENDERER_PLACEATWAVECOORD_OFFSET UNITYSDK_OFFSET(0x149DFA30)
#define GAMEPLAYWAVERENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0x149DE5C0)
#define GAMEPLAYWAVERENDERER_WORLDTOWAVESPACE_OFFSET UNITYSDK_OFFSET(0x149DF350)
#define GAMEPLAYWAVERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x149E0990)
