...
#define CLASS_2_CD958893D2F7EAE2_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xAD99150)
#define CLASS_2_CD958893D2F7EAE2_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xAD99360)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0xAD95840)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xAD955B0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_0F19DE6762E7B887_OFFSET UNITYSDK_OFFSET(0xAD95C80)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xAD950A0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_18A7BF8B592973BC_OFFSET UNITYSDK_OFFSET(0xAD97AD0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_2AED1A1868B40387_OFFSET UNITYSDK_OFFSET(0xAD959D0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_2E07D057E72DE76A_OFFSET UNITYSDK_OFFSET(0xAD978B0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_3A1D2B4F74743724_OFFSET UNITYSDK_OFFSET(0xAD98950)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_40E64ED64652D825_OFFSET UNITYSDK_OFFSET(0xAD98BE0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xAD953E0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0xAD97380)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_4857357D5C1BFCE8_OFFSET UNITYSDK_OFFSET(0xAD96290)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_676CD2ECA00B10AF_OFFSET UNITYSDK_OFFSET(0xAD96D70)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0xAD988F0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0xAD98890)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_9D6C586EC30ADBDA_OFFSET UNITYSDK_OFFSET(0xAD987A0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0xAD97CB0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xAD97670)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_AC1BFDB3D2FC0C79_OFFSET UNITYSDK_OFFSET(0xAD95260)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xAD97C10)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_B37C805F1A4DBCFB_OFFSET UNITYSDK_OFFSET(0xAD95930)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_C9F59B9D8CCA4DFF_OFFSET UNITYSDK_OFFSET(0xAD96F00)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAD95510)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_D3E970D78BB8886D_OFFSET UNITYSDK_OFFSET(0xAD97450)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_D77F7476BCD66744_OFFSET UNITYSDK_OFFSET(0xAD95170)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_E5D1955A389D1F9C_OFFSET UNITYSDK_OFFSET(0xAD98AC0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_E95A4606AAD9C63C_OFFSET UNITYSDK_OFFSET(0xAD97F70)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_EEEA24B88E52471C_OFFSET UNITYSDK_OFFSET(0xAD95FF0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F25D2DE7181D2805_1_OFFSET UNITYSDK_OFFSET(0xAD98720)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F25D2DE7181D2805_OFFSET UNITYSDK_OFFSET(0xAD97EF0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0xAD98E50)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0xAD98F10)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F37CDBD6D46274D2_3_OFFSET UNITYSDK_OFFSET(0xAD98FD0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F37CDBD6D46274D2_4_OFFSET UNITYSDK_OFFSET(0xAD99090)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xAD98D90)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xAD953A0)
#define CLASS_2_CD958893D2F7EAE2_METHOD_2_FD45AB35B857FF73_OFFSET UNITYSDK_OFFSET(0xAD98320)
#define CLASS_2_CD958893D2F7EAE2__CTOR_OFFSET UNITYSDK_OFFSET(0xAD99540)
#define CLASS_2_CD958893D2F7EAE2__ONBIND_OFFSET UNITYSDK_OFFSET(0xAD94DB0)
#define CLASS_2_CD958893D2F7EAE2__ONTICK_OFFSET UNITYSDK_OFFSET(0xAD95550)

inline static constexpr unsigned int Class_2_CD958893D2F7EAE2_TypeDefinitionIndex = 69037;
...
public:
	...
	::UnityEngine::ParticleSystem* Field_2_12; // 0x98
	::RPG::Client::LongPressEvent* Field_2_13; // 0xA0
	::UnityEngine::UI::Text* Field_2_14; // 0xA8
	::Class_2_1A0F91E4CE01E769* Field_2_15; // 0xB0
	::Class_2_8C1FCFCB12DA9945* Field_2_16; // 0xB8
	::Class_1_274386B6ECA5E606* Field_2_17; // 0xC0
	::RPG::GameCore::CharacterDataComponent* Field_2_18; // 0xC8
	::UnityEngine::Transform* Field_2_19; // 0xD0
	::UnityEngine::Animation* Field_2_20; // 0xD8
	::RPG::Client::PrefabLoadMeta* Field_2_21; // 0xE0
	::UnityEngine::UI::Text* Field_2_22; // 0xE8
	::Class_2_40491F513F4A6F01* Field_2_23; // 0xF0
	::RPG::GameCore::TurnBasedAbilityComponent* Field_2_24; // 0xF8
	::RPG::GameCore::BattleInstance* Field_2_25; // 0x100
	::UnityEngine::Animation* Field_2_26; // 0x108
	::UnityEngine::Transform* Field_2_27; // 0x110
	::UnityEngine::Transform* Field_2_28; // 0x118
	::Class_2_D650D0F10A391A4C* Field_2_29; // 0x120
	::UnityEngine::UI::Image* Field_2_30; // 0x128
	::RPG::GameCore::SkillData* Field_2_31; // 0x130
	::UnityEngine::Transform* Field_2_32; // 0x138
	::RPG::GameCore::SkillData* Field_2_33; // 0x140
	::RPG::GameCore::FixPoint Field_2_34; // 0x148
	::System::UInt32 Field_2_35; // 0x150
	::RPG::GameCore::SkillSPProgressType Field_2_36; // 0x154
