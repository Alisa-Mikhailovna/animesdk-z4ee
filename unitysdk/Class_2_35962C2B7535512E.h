...
#define CLASS_2_35962C2B7535512E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A695240)
#define CLASS_2_35962C2B7535512E_GET_AISERVICE_OFFSET UNITYSDK_OFFSET(0x1A6953C0)
#define CLASS_2_35962C2B7535512E_GET_INPUTSERVICE_OFFSET UNITYSDK_OFFSET(0x1A6953A0)
#define CLASS_2_35962C2B7535512E_GET_INSTANCECLIENT_OFFSET UNITYSDK_OFFSET(0x1A6953F0)
#define CLASS_2_35962C2B7535512E_GET_PHYSICS2DSERVICE_OFFSET UNITYSDK_OFFSET(0x1A695380)
#define CLASS_2_35962C2B7535512E_GET_RANDSERVICE_OFFSET UNITYSDK_OFFSET(0x1A695360)
#define CLASS_2_35962C2B7535512E_METHOD_2_43A46E5F9FAC62B8_OFFSET UNITYSDK_OFFSET(0x1A6953E0)
#define CLASS_2_35962C2B7535512E_SET_AISERVICE_OFFSET UNITYSDK_OFFSET(0x1A6953D0)
#define CLASS_2_35962C2B7535512E_SET_INPUTSERVICE_OFFSET UNITYSDK_OFFSET(0x1A6953B0)
#define CLASS_2_35962C2B7535512E_SET_INSTANCECLIENT_OFFSET UNITYSDK_OFFSET(0x1A695400)
#define CLASS_2_35962C2B7535512E_SET_PHYSICS2DSERVICE_OFFSET UNITYSDK_OFFSET(0x1A695390)
#define CLASS_2_35962C2B7535512E_SET_RANDSERVICE_OFFSET UNITYSDK_OFFSET(0x1A695370)
#define CLASS_2_35962C2B7535512E__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6950D0)
...
public:
	...
	::RPG::Client::LittleGameShare::HoyoPhysics::Physics2DService_1<::Class_2_465A9E6CC2B0EF21*>* _Physics2DService_k__BackingField; // 0x18
	::Class_1_3659AE0E8250857A* _RandService_k__BackingField; // 0x20
	::Class_4_2281AFAA5CEEDF24* _InstanceClient_k__BackingField; // 0x28
	::Class_1_BD10A3BCF7C68615* _AIService_k__BackingField; // 0x30
	::Class_1_0AE74383D8A43588* _InputService_k__BackingField; // 0x38
