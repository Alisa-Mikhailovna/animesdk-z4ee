...
#define CLASS_2_D9455851245C4EB7_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB407F00)
#define CLASS_2_D9455851245C4EB7_METHOD_2_AA0EFBB13088BA5E_OFFSET UNITYSDK_OFFSET(0xB408D10)
#define CLASS_2_D9455851245C4EB7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB407F50)
#define CLASS_2_D9455851245C4EB7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB409000)
#define CLASS_2_D9455851245C4EB7_TICK_OFFSET UNITYSDK_OFFSET(0xB409050)
#define CLASS_2_D9455851245C4EB7__CTOR_OFFSET UNITYSDK_OFFSET(0xB407E60)
...
{
public:
	::RPG::GameCore::CreateBattleCharacter* Field_2_0; // 0x18
