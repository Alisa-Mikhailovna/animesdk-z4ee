...
#define CLASS_1_5B567C8A01BAEDFE_160_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C62FB30)
#define CLASS_1_5B567C8A01BAEDFE_160_CLONE_OFFSET UNITYSDK_OFFSET(0x1C62F7D0)
#define CLASS_1_5B567C8A01BAEDFE_160_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C62F930)
#define CLASS_1_5B567C8A01BAEDFE_160_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C62F840)
#define CLASS_1_5B567C8A01BAEDFE_160_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C62FA90)
#define CLASS_1_5B567C8A01BAEDFE_160_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C62FB80)
#define CLASS_1_5B567C8A01BAEDFE_160_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C62FB50)
#define CLASS_1_5B567C8A01BAEDFE_160_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C62F720)
#define CLASS_1_5B567C8A01BAEDFE_160_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C62F780)
#define CLASS_1_5B567C8A01BAEDFE_160_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C62FAC0)
#define CLASS_1_5B567C8A01BAEDFE_160_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C62FB20)
#define CLASS_1_5B567C8A01BAEDFE_160__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C62FBD0)
#define CLASS_1_5B567C8A01BAEDFE_160__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C62F7A0)
#define CLASS_1_5B567C8A01BAEDFE_160__CTOR_OFFSET UNITYSDK_OFFSET(0x1C62F790)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_160*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_160_TypeDefinitionIndex)->GetStaticField(0x64550);
	}
