...
#define CLASS_1_7508481856B4C95F_METHOD_1_5EA1EEB830143C1B_OFFSET UNITYSDK_OFFSET(0x15532220)
#define CLASS_1_7508481856B4C95F_METHOD_1_63E67BE8FEFC1706_OFFSET UNITYSDK_OFFSET(0x155323C0)
#define CLASS_1_7508481856B4C95F_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x15532350)
#define CLASS_1_7508481856B4C95F__CTOR_OFFSET UNITYSDK_OFFSET(0x15532BD0)

inline static constexpr unsigned int Class_1_7508481856B4C95F_TypeDefinitionIndex = 70473;

class Class_1_7508481856B4C95F : public ::System::Object
{
public:
	::System::Collections::Generic::HashSet_1<::Struct_2_BD1A98EFEDD35816>* Field_1_0; // 0x10
	::RPG::GameCore::BlockNodeConfig* Field_1_1; // 0x18
	::System::Collections::Generic::HashSet_1<::Struct_2_BD1A98EFEDD35816>* Field_1_2; // 0x20
