...
#define CLASS_2_CB0DCC657B5A8074_DISPOSE_OFFSET UNITYSDK_OFFSET(0x146B8310)
#define CLASS_2_CB0DCC657B5A8074_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x146B8680)
#define CLASS_2_CB0DCC657B5A8074_METHOD_2_F55160DB3394C58D_OFFSET UNITYSDK_OFFSET(0x146B8920)
#define CLASS_2_CB0DCC657B5A8074_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x146B8760)
#define CLASS_2_CB0DCC657B5A8074_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x146B8810)
#define CLASS_2_CB0DCC657B5A8074_TICK_OFFSET UNITYSDK_OFFSET(0x146B8500)
#define CLASS_2_CB0DCC657B5A8074__CTOR_OFFSET UNITYSDK_OFFSET(0x146B8220)
...
public:
	...
	::RPG::GameCore::WaitPhotoGraphConditionResult* Field_2_2; // 0x28
