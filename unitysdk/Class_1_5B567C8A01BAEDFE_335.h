...
#define CLASS_1_5B567C8A01BAEDFE_335_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C57FD30)
#define CLASS_1_5B567C8A01BAEDFE_335_CLONE_OFFSET UNITYSDK_OFFSET(0x1C57F9D0)
#define CLASS_1_5B567C8A01BAEDFE_335_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C57FB30)
#define CLASS_1_5B567C8A01BAEDFE_335_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C57FA40)
#define CLASS_1_5B567C8A01BAEDFE_335_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C57FC90)
#define CLASS_1_5B567C8A01BAEDFE_335_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C57FD80)
#define CLASS_1_5B567C8A01BAEDFE_335_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C57FD50)
#define CLASS_1_5B567C8A01BAEDFE_335_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C57F920)
#define CLASS_1_5B567C8A01BAEDFE_335_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C57F980)
#define CLASS_1_5B567C8A01BAEDFE_335_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C57FCC0)
#define CLASS_1_5B567C8A01BAEDFE_335_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C57FD20)
#define CLASS_1_5B567C8A01BAEDFE_335__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C57FDD0)
#define CLASS_1_5B567C8A01BAEDFE_335__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C57F9A0)
#define CLASS_1_5B567C8A01BAEDFE_335__CTOR_OFFSET UNITYSDK_OFFSET(0x1C57F990)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_335*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_335_TypeDefinitionIndex)->GetStaticField(0x5F5D0);
	}
