...
#define CLASS_1_5B567C8A01BAEDFE_227_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C00A9B0)
#define CLASS_1_5B567C8A01BAEDFE_227_CLONE_OFFSET UNITYSDK_OFFSET(0x1C00A6A0)
#define CLASS_1_5B567C8A01BAEDFE_227_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C00A7B0)
#define CLASS_1_5B567C8A01BAEDFE_227_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C00A6E0)
#define CLASS_1_5B567C8A01BAEDFE_227_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C00A910)
#define CLASS_1_5B567C8A01BAEDFE_227_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C00AA00)
#define CLASS_1_5B567C8A01BAEDFE_227_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C00A9D0)
#define CLASS_1_5B567C8A01BAEDFE_227_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C00A620)
#define CLASS_1_5B567C8A01BAEDFE_227_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C00A650)
#define CLASS_1_5B567C8A01BAEDFE_227_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C00A940)
#define CLASS_1_5B567C8A01BAEDFE_227_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C00A9A0)
#define CLASS_1_5B567C8A01BAEDFE_227__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C00AA50)
#define CLASS_1_5B567C8A01BAEDFE_227__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C00A670)
#define CLASS_1_5B567C8A01BAEDFE_227__CTOR_OFFSET UNITYSDK_OFFSET(0x1C00A660)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_227*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_227_TypeDefinitionIndex)->GetStaticField(0x66590);
	}
