...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_CENTER_OFFSET UNITYSDK_OFFSET(0x1A6EA430)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A6EA3F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_EXTENTS_OFFSET UNITYSDK_OFFSET(0x1A6EA470)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_OVERLAPS_OFFSET UNITYSDK_OFFSET(0x1A6EA560)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_UNION_OFFSET UNITYSDK_OFFSET(0x1A6EA4B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ABSFLOAT_OFFSET UNITYSDK_OFFSET(0x1A6E8C20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ABSINT_OFFSET UNITYSDK_OFFSET(0x1A6E8BE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ABS_OFFSET UNITYSDK_OFFSET(0x1A6E8F00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ADD_OFFSET UNITYSDK_OFFSET(0x1A6E8D50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ATAN2_OFFSET UNITYSDK_OFFSET(0x1A6E9AC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CLAMPFLOAT_OFFSET UNITYSDK_OFFSET(0x1A6E8C40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CLAMPINT_OFFSET UNITYSDK_OFFSET(0x1A6E8BF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CLAMP_OFFSET UNITYSDK_OFFSET(0x1A6E90B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2COMPUTEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1A6E98A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2COMPUTECOSSIN_OFFSET UNITYSDK_OFFSET(0x1A6E95C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2COMPUTEROTATIONBETWEENUNITVECTORS_OFFSET UNITYSDK_OFFSET(0x1A6EAF60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CROSSSV_OFFSET UNITYSDK_OFFSET(0x1A6E8CF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CROSSVS_OFFSET UNITYSDK_OFFSET(0x1A6E8CC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CROSS_OFFSET UNITYSDK_OFFSET(0x1A6E8C90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2DISTANCESQUARED_OFFSET UNITYSDK_OFFSET(0x1A6E9530)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2DISTANCE_OFFSET UNITYSDK_OFFSET(0x1A6E91B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2DOT_OFFSET UNITYSDK_OFFSET(0x1A6E8C60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2GETINVERSE22_OFFSET UNITYSDK_OFFSET(0x1A6EA310)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2GETLENGTHANDNORMALIZE_OFFSET UNITYSDK_OFFSET(0x1A6E9320)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INTEGRATEROTATION_OFFSET UNITYSDK_OFFSET(0x1A6E9460)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INVMULROT_OFFSET UNITYSDK_OFFSET(0x1A6E9CE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INVMULTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A6EA1C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INVROTATEVECTOR_OFFSET UNITYSDK_OFFSET(0x1A6E9FD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INVTRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1A6EA070)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISNORMALIZEDROT_OFFSET UNITYSDK_OFFSET(0x1A6E9790)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1A6E9290)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDAABB_OFFSET UNITYSDK_OFFSET(0x1A6EACA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDFLOAT_OFFSET UNITYSDK_OFFSET(0x1A6EA9F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDPLANE_OFFSET UNITYSDK_OFFSET(0x1A6EADD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDROTATION_OFFSET UNITYSDK_OFFSET(0x1A6EAA30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A6EAB00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDVEC2_OFFSET UNITYSDK_OFFSET(0x1A6EAA00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2LEFTPERP_OFFSET UNITYSDK_OFFSET(0x1A6E8D20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2LENGTHSQUARED_OFFSET UNITYSDK_OFFSET(0x1A6E9510)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2LENGTH_OFFSET UNITYSDK_OFFSET(0x1A6E9180)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2LERP_OFFSET UNITYSDK_OFFSET(0x1A6E8DD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAKEAABB_OFFSET UNITYSDK_OFFSET(0x1A6EA5A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAKEROTFROMUNITVECTOR_OFFSET UNITYSDK_OFFSET(0x1A6E9780)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAKEROT_OFFSET UNITYSDK_OFFSET(0x1A6E9560)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAXFLOAT_OFFSET UNITYSDK_OFFSET(0x1A6E8C10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAXINT_OFFSET UNITYSDK_OFFSET(0x1A6E8BD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAX_OFFSET UNITYSDK_OFFSET(0x1A6E9020)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MINFLOAT_OFFSET UNITYSDK_OFFSET(0x1A6E8C00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MININT_OFFSET UNITYSDK_OFFSET(0x1A6E8BC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MIN_OFFSET UNITYSDK_OFFSET(0x1A6E8F90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULADD_OFFSET UNITYSDK_OFFSET(0x1A6E8E80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULMV_OFFSET UNITYSDK_OFFSET(0x1A6EA2D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULROT_OFFSET UNITYSDK_OFFSET(0x1A6E9C90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULSUB_OFFSET UNITYSDK_OFFSET(0x1A6E8EC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULSV_OFFSET UNITYSDK_OFFSET(0x1A6E8E50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A6EA0B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MUL_OFFSET UNITYSDK_OFFSET(0x1A6E8E20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2NEG_OFFSET UNITYSDK_OFFSET(0x1A6E8DB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2NLERP_OFFSET UNITYSDK_OFFSET(0x1A6E97D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2NORMALIZEROT_OFFSET UNITYSDK_OFFSET(0x1A6E93D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1A6E91F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2PLANESEPARATION_OFFSET UNITYSDK_OFFSET(0x1A6EA920)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2RELATIVEANGLE_OFFSET UNITYSDK_OFFSET(0x1A6E9D30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2RIGHTPERP_OFFSET UNITYSDK_OFFSET(0x1A6E8D40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ROTATEVECTOR_OFFSET UNITYSDK_OFFSET(0x1A6E9F80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ROT_GETANGLE_OFFSET UNITYSDK_OFFSET(0x1A6E98D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ROT_GETXAXIS_OFFSET UNITYSDK_OFFSET(0x1A6E9C60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ROT_GETYAXIS_OFFSET UNITYSDK_OFFSET(0x1A6E9C70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2SOLVE22_OFFSET UNITYSDK_OFFSET(0x1A6EA360)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2SPRINGDAMPER_OFFSET UNITYSDK_OFFSET(0x1A6EA9B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2SUB_OFFSET UNITYSDK_OFFSET(0x1A6E8D80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1A6EA020)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2UNWINDANGLE_OFFSET UNITYSDK_OFFSET(0x1A6E9F60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6EB080)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Transform*)Il2CppClass::FromTypeDefinitionIndex(B2MathFunction_TypeDefinitionIndex)->GetStaticField(0x10850);
		}
		static ::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Mat22* StaticGet_b2Mat22_zero()
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Mat22*)Il2CppClass::FromTypeDefinitionIndex(B2MathFunction_TypeDefinitionIndex)->GetStaticField(0x10860);
		}
		static ::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Rot* StaticGet_b2Rot_identity()
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Rot*)Il2CppClass::FromTypeDefinitionIndex(B2MathFunction_TypeDefinitionIndex)->GetStaticField(0x10870);
		}
		static ::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Vec2* StaticGet_b2Vec2_zero()
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Vec2*)Il2CppClass::FromTypeDefinitionIndex(B2MathFunction_TypeDefinitionIndex)->GetStaticField(0x10878);
		}
