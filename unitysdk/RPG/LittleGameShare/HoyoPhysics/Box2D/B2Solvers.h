...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2BULLETBODYTASK_OFFSET UNITYSDK_OFFSET(0x1A700830)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2CONTINUOUSQUERYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A6FCB60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2EXECUTEBLOCK_OFFSET UNITYSDK_OFFSET(0x1A6FEF70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2EXECUTEMAINSTAGE_OFFSET UNITYSDK_OFFSET(0x1A6FF5A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2EXECUTESTAGE_OFFSET UNITYSDK_OFFSET(0x1A6FF310)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2FINALIZEBODIESTASK_OFFSET UNITYSDK_OFFSET(0x1A6FE2D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2INTEGRATEPOSITIONSTASK_OFFSET UNITYSDK_OFFSET(0x1A6FC930)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2INTEGRATEVELOCITIESTASK_OFFSET UNITYSDK_OFFSET(0x1A6FC0E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2MAKESOFT_OFFSET UNITYSDK_OFFSET(0x1A6FC050)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2PAUSE_OFFSET UNITYSDK_OFFSET(0x1A6FC0C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2PREPAREJOINTSTASK_OFFSET UNITYSDK_OFFSET(0x1A6FC5E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SIMDSHIFT_OFFSET UNITYSDK_OFFSET(0x1A6FC040)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SOLVECONTINUOUS_OFFSET UNITYSDK_OFFSET(0x1A6FD510)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SOLVEJOINTSTASK_OFFSET UNITYSDK_OFFSET(0x1A6FC6E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SOLVERTASK_OFFSET UNITYSDK_OFFSET(0x1A6FF710)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SOLVE_OFFSET UNITYSDK_OFFSET(0x1A700940)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2WARMSTARTJOINTSTASK_OFFSET UNITYSDK_OFFSET(0x1A6FC640)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_GETWORKERSTARTINDEX_OFFSET UNITYSDK_OFFSET(0x1A6FF2A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A704E20)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(B2Solvers_TypeDefinitionIndex)->GetStaticField(0x10C60);
		}
