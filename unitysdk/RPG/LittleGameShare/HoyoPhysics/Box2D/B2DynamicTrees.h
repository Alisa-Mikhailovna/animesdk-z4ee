...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2ALLOCATENODE_OFFSET UNITYSDK_OFFSET(0x1A6CDE90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2BUILDTREE_OFFSET UNITYSDK_OFFSET(0x1A6D2290)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_CREATEPROXY_OFFSET UNITYSDK_OFFSET(0x1A69C5D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A69BDF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_DESTROYPROXY_OFFSET UNITYSDK_OFFSET(0x1A69C7B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A69C1C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_ENLARGEPROXY_OFFSET UNITYSDK_OFFSET(0x1A69CB70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETAABB_OFFSET UNITYSDK_OFFSET(0x1A6D08E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETAREARATIO_OFFSET UNITYSDK_OFFSET(0x1A6D0640)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x1A6D0890)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETCATEGORYBITS_OFFSET UNITYSDK_OFFSET(0x1A6D05B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A6D05F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETPROXYCOUNT_OFFSET UNITYSDK_OFFSET(0x1A6D04F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETROOTBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A6D07E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETUSERDATA_OFFSET UNITYSDK_OFFSET(0x1A6D08A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_MOVEPROXY_OFFSET UNITYSDK_OFFSET(0x1A69C9A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_REBUILD_OFFSET UNITYSDK_OFFSET(0x1A69EAD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_SETCATEGORYBITS_OFFSET UNITYSDK_OFFSET(0x1A6D0510)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_VALIDATENOENLARGED_OFFSET UNITYSDK_OFFSET(0x1A6D0880)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A69F0B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2FINDBESTSIBLING_OFFSET UNITYSDK_OFFSET(0x1A6CE0B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2FREENODE_OFFSET UNITYSDK_OFFSET(0x1A6CE050)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2INSERTLEAF_OFFSET UNITYSDK_OFFSET(0x1A6CFC40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2ISALLOCATED_OFFSET UNITYSDK_OFFSET(0x1A6CDE70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2ISLEAF_OFFSET UNITYSDK_OFFSET(0x1A6CDE60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2MAXUINT16_OFFSET UNITYSDK_OFFSET(0x1A6CDE80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2PARTITIONMID_OFFSET UNITYSDK_OFFSET(0x1A6D0920)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2PARTITIONSAH_OFFSET UNITYSDK_OFFSET(0x1A6D1090)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2REMOVELEAF_OFFSET UNITYSDK_OFFSET(0x1A6D0180)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2ROTATENODES_OFFSET UNITYSDK_OFFSET(0x1A6CE930)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6D32A0)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2TreeNode*)Il2CppClass::FromTypeDefinitionIndex(B2DynamicTrees_TypeDefinitionIndex)->GetStaticField(0x109D0);
		}
