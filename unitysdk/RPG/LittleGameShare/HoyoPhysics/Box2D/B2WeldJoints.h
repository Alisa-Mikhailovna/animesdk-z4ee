...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2GETWELDJOINTFORCE_OFFSET UNITYSDK_OFFSET(0x1A705F40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2GETWELDJOINTTORQUE_OFFSET UNITYSDK_OFFSET(0x1A705FE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2PREPAREWELDJOINT_OFFSET UNITYSDK_OFFSET(0x1A706010)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2SOLVEWELDJOINT_OFFSET UNITYSDK_OFFSET(0x1A7068B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WARMSTARTWELDJOINT_OFFSET UNITYSDK_OFFSET(0x1A706520)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_GETANGULARDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1A705EF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_GETANGULARHERTZ_OFFSET UNITYSDK_OFFSET(0x1A705E40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_GETLINEARDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1A705D90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_GETLINEARHERTZ_OFFSET UNITYSDK_OFFSET(0x1A705CE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_SETANGULARDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1A705E90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_SETANGULARHERTZ_OFFSET UNITYSDK_OFFSET(0x1A705DE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_SETLINEARDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1A705D30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_SETLINEARHERTZ_OFFSET UNITYSDK_OFFSET(0x1A705C80)
