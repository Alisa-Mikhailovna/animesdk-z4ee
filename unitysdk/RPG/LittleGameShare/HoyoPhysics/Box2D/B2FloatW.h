...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FLOATW_ASSPAN_OFFSET UNITYSDK_OFFSET(0x39E7C30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FLOATW_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x39E7BB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FLOATW__CTOR_OFFSET UNITYSDK_OFFSET(0x25B50)
