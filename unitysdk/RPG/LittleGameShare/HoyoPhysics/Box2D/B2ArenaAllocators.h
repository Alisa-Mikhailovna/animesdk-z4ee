...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2CREATEARENAALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1A699C70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2DESTROYARENAALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1A699CE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2GETARENAALLOCATION_OFFSET UNITYSDK_OFFSET(0x1A69A520)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2GETARENACAPACITY_OFFSET UNITYSDK_OFFSET(0x1A69A260)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2GETMAXARENAALLOCATION_OFFSET UNITYSDK_OFFSET(0x1A69A7E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2GROWARENA_OFFSET UNITYSDK_OFFSET(0x1A699FA0)
