...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CHAINSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6AACF0)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		::System::Int32 nextChainId; // 0x24
		::System::Int32 bodyId; // 0x28
