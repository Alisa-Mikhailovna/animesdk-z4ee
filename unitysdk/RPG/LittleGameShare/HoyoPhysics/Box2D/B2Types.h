...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTBODYDEF_OFFSET UNITYSDK_OFFSET(0x1A705820)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTCHAINDEF_OFFSET UNITYSDK_OFFSET(0x1A7059D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTFILTER_OFFSET UNITYSDK_OFFSET(0x1A705920)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTQUERYFILTER_OFFSET UNITYSDK_OFFSET(0x1A705940)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTSHAPEDEF_OFFSET UNITYSDK_OFFSET(0x1A705950)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTSURFACEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A7059B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTWORLDDEF_OFFSET UNITYSDK_OFFSET(0x1A705750)
