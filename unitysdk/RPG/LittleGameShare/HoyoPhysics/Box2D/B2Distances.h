...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2COMPUTESIMPLEXWITNESSPOINTS_OFFSET UNITYSDK_OFFSET(0x1A6C8F10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2EVALUATESEPARATION_OFFSET UNITYSDK_OFFSET(0x1A6CCAF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2FINDMINSEPARATION_OFFSET UNITYSDK_OFFSET(0x1A6CC390)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2FINDSUPPORT_OFFSET UNITYSDK_OFFSET(0x1A6C8310)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2GETSWEEPTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A6C71A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEOFFSETPROXY_OFFSET UNITYSDK_OFFSET(0x1A6C7B50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEPROXY_1_OFFSET UNITYSDK_OFFSET(0x1A6C7E30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEPROXY_2_OFFSET UNITYSDK_OFFSET(0x1A6C8030)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEPROXY_OFFSET UNITYSDK_OFFSET(0x1A6C7790)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKESEPARATIONFUNCTION_OFFSET UNITYSDK_OFFSET(0x1A6CB690)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKESIMPLEXCACHE_OFFSET UNITYSDK_OFFSET(0x1A6C8C20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKESIMPLEXFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1A6C86D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SEGMENTDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A6C7320)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SHAPECAST_OFFSET UNITYSDK_OFFSET(0x1A6CB150)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SHAPEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A6C9940)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SOLVESIMPLEX2_OFFSET UNITYSDK_OFFSET(0x1A6C9070)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SOLVESIMPLEX3_OFFSET UNITYSDK_OFFSET(0x1A6C9300)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2TIMEOFIMPACT_OFFSET UNITYSDK_OFFSET(0x1A6CD110)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2TRANSFORMPROXY_OFFSET UNITYSDK_OFFSET(0x1A6C7970)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2WEIGHT2_OFFSET UNITYSDK_OFFSET(0x1A6C8240)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2WEIGHT3_OFFSET UNITYSDK_OFFSET(0x1A6C8290)
