...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2CLASSIFYNORMAL_OFFSET UNITYSDK_OFFSET(0x1A6E89F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2CLIPPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1A6E7070)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2CLIPSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1A6E83B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECAPSULEANDCIRCLE_OFFSET UNITYSDK_OFFSET(0x1A6B8720)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECAPSULES_OFFSET UNITYSDK_OFFSET(0x1A6B8DB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECHAINSEGMENTANDCAPSULE_OFFSET UNITYSDK_OFFSET(0x1A6BFBF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECHAINSEGMENTANDCIRCLE_OFFSET UNITYSDK_OFFSET(0x1A6BF3A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECHAINSEGMENTANDPOLYGON_OFFSET UNITYSDK_OFFSET(0x1A6BFDF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECIRCLES_OFFSET UNITYSDK_OFFSET(0x1A6B8180)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDEPOLYGONANDCAPSULE_OFFSET UNITYSDK_OFFSET(0x1A6BC440)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDEPOLYGONANDCIRCLE_OFFSET UNITYSDK_OFFSET(0x1A6BB280)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDEPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1A6BC620)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDESEGMENTANDCAPSULE_OFFSET UNITYSDK_OFFSET(0x1A6BEFC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDESEGMENTANDCIRCLE_OFFSET UNITYSDK_OFFSET(0x1A6BEE40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDESEGMENTANDPOLYGON_OFFSET UNITYSDK_OFFSET(0x1A6BF1C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2FINDMAXSEPARATION_OFFSET UNITYSDK_OFFSET(0x1A6E7D70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2MAKECAPSULE_OFFSET UNITYSDK_OFFSET(0x1A6E6CC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2_MAKE_ID_OFFSET UNITYSDK_OFFSET(0x1A6E6CB0)
