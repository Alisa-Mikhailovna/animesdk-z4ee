...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATOR_ASSPAN_OFFSET UNITYSDK_OFFSET(0x1A699C00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATOR_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A699B20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATOR_RESIZE_OFFSET UNITYSDK_OFFSET(0x1A699B80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A699B40)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		::Il2CppArray<::RPG::LittleGameShare::HoyoPhysics::Box2D::IB2ArenaAllocatable*>* _lookup; // 0x18
		::System::Object* _lock; // 0x20
