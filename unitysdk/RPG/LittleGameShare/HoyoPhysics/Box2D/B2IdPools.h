...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2ALLOCID_OFFSET UNITYSDK_OFFSET(0x1A6A0DE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2CREATEIDPOOL_OFFSET UNITYSDK_OFFSET(0x1A6DCA80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2DESTROYIDPOOL_OFFSET UNITYSDK_OFFSET(0x1A6DCDC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2FREEID_OFFSET UNITYSDK_OFFSET(0x1A6A2000)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2GETIDBYTES_OFFSET UNITYSDK_OFFSET(0x1A6DC980)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2GETIDCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A6DC960)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2GETIDCOUNT_OFFSET UNITYSDK_OFFSET(0x1A6DC940)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2VALIDATEFREEID_OFFSET UNITYSDK_OFFSET(0x1A6DCE50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2VALIDATEUSEDID_OFFSET UNITYSDK_OFFSET(0x1A6DCE60)
