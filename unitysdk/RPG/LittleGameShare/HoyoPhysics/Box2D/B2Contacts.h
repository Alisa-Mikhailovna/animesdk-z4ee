...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2ADDTYPE_OFFSET UNITYSDK_OFFSET(0x1A6C33C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CAPSULEANDCIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6B8660)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CAPSULEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6B8CF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CHAINSEGMENTANDCAPSULEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6BFA90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CHAINSEGMENTANDCIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6BF2E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CHAINSEGMENTANDPOLYGONMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6BFD20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6B80C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2COMPUTEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6C4560)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CONTACT_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A6C4740)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CREATECONTACT_OFFSET UNITYSDK_OFFSET(0x1A69DD20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2DESTROYCONTACT_OFFSET UNITYSDK_OFFSET(0x1A69FBD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2GETCONTACTFULLID_OFFSET UNITYSDK_OFFSET(0x1A6C4710)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2GETCONTACTSIM_OFFSET UNITYSDK_OFFSET(0x1A6A26B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2INITIALIZECONTACTREGISTERS_OFFSET UNITYSDK_OFFSET(0x1A6B7960)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2POLYGONANDCAPSULEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6BC2F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2POLYGONANDCIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6BB1C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2POLYGONMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6BC560)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2SEGMENTANDCAPSULEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6BEEF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2SEGMENTANDCIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6BED70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2SEGMENTANDPOLYGONMANIFOLD_OFFSET UNITYSDK_OFFSET(0x1A6BF070)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2UPDATECONTACT_OFFSET UNITYSDK_OFFSET(0x1A6C3670)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6B7900)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::Il2CppArray<::RPG::LittleGameShare::HoyoPhysics::Box2D::B2ContactRegister>**)Il2CppClass::FromTypeDefinitionIndex(B2Contacts_TypeDefinitionIndex)->GetStaticField(0x5F0E0);
		}
		static ::System::Boolean* StaticGet_s_initialized()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(B2Contacts_TypeDefinitionIndex)->GetStaticField(0x10980);
		}
