...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::b2TaskCallback**)Il2CppClass::FromTypeDefinitionIndex(B2BoardPhases___O_TypeDefinitionIndex)->GetStaticField(0x5E9A0);
		}
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::b2TreeQueryCallbackFcn_1<::RPG::LittleGameShare::HoyoPhysics::Box2D::B2QueryPairContext>**)Il2CppClass::FromTypeDefinitionIndex(B2BoardPhases___O_TypeDefinitionIndex)->GetStaticField(0x5E9A8);
		}
	};
}
