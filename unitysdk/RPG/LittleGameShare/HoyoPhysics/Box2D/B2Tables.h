...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2ADDKEYHAVECAPACITY_OFFSET UNITYSDK_OFFSET(0x1A705090)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2ADDKEY_OFFSET UNITYSDK_OFFSET(0x1A705380)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2CLEARSET_OFFSET UNITYSDK_OFFSET(0x1A704F80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1A7052D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2CREATESET_OFFSET UNITYSDK_OFFSET(0x1A704E80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2DESTROYSET_OFFSET UNITYSDK_OFFSET(0x1A704F30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2FINDSLOT_OFFSET UNITYSDK_OFFSET(0x1A705020)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2GETHASHSETBYTES_OFFSET UNITYSDK_OFFSET(0x1A7054C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2GETSETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A705510)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2GETSETCOUNT_OFFSET UNITYSDK_OFFSET(0x1A705500)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2GROWTABLE_OFFSET UNITYSDK_OFFSET(0x1A705110)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2KEYHASH_OFFSET UNITYSDK_OFFSET(0x1A704FE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2REMOVEKEY_OFFSET UNITYSDK_OFFSET(0x1A705520)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TABLES_B2_SHAPE_PAIR_KEY_OFFSET UNITYSDK_OFFSET(0x1A704E60)
