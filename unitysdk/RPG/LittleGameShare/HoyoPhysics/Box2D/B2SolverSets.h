...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2CREATESOLVERSET_OFFSET UNITYSDK_OFFSET(0x1A6F8650)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2DESTROYSOLVERSET_OFFSET UNITYSDK_OFFSET(0x1A6F86C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2MERGESOLVERSETS_OFFSET UNITYSDK_OFFSET(0x1A6FADA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2TRANSFERBODY_OFFSET UNITYSDK_OFFSET(0x1A6FB650)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2TRANSFERJOINT_OFFSET UNITYSDK_OFFSET(0x1A6FBA80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2TRYSLEEPISLAND_OFFSET UNITYSDK_OFFSET(0x1A6F9720)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2WAKESOLVERSET_OFFSET UNITYSDK_OFFSET(0x1A6F8970)
