...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ENABLELIMIT_OFFSET UNITYSDK_OFFSET(0x1A6C4D80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ENABLEMOTOR_OFFSET UNITYSDK_OFFSET(0x1A6C5600)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ENABLESPRING_OFFSET UNITYSDK_OFFSET(0x1A6C53F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETCURRENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A6C51F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A6C4D30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1A6C51A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMAXMOTORFORCE_OFFSET UNITYSDK_OFFSET(0x1A6C5830)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMINLENGTH_OFFSET UNITYSDK_OFFSET(0x1A6C5150)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMOTORFORCE_OFFSET UNITYSDK_OFFSET(0x1A6C5770)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMOTORSPEED_OFFSET UNITYSDK_OFFSET(0x1A6C5720)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETSPRINGDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1A6C55B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETSPRINGHERTZ_OFFSET UNITYSDK_OFFSET(0x1A6C5560)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ISLIMITENABLED_OFFSET UNITYSDK_OFFSET(0x1A6C4DE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ISMOTORENABLED_OFFSET UNITYSDK_OFFSET(0x1A6C5670)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ISSPRINGENABLED_OFFSET UNITYSDK_OFFSET(0x1A6C5450)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETLENGTHRANGE_OFFSET UNITYSDK_OFFSET(0x1A6C4E30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A6C4AD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETMAXMOTORFORCE_OFFSET UNITYSDK_OFFSET(0x1A6C57D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETMOTORSPEED_OFFSET UNITYSDK_OFFSET(0x1A6C56C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETSPRINGDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1A6C5500)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETSPRINGHERTZ_OFFSET UNITYSDK_OFFSET(0x1A6C54A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2GETDISTANCEJOINTFORCE_OFFSET UNITYSDK_OFFSET(0x1A6C5880)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2PREPAREDISTANCEJOINT_OFFSET UNITYSDK_OFFSET(0x1A6C5AA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2SOLVEDISTANCEJOINT_OFFSET UNITYSDK_OFFSET(0x1A6C6410)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2WARMSTARTDISTANCEJOINT_OFFSET UNITYSDK_OFFSET(0x1A6C5F80)
