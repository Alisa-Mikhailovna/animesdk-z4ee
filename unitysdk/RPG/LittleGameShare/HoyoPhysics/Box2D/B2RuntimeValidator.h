...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_CHECKB2FLOATW_OFFSET UNITYSDK_OFFSET(0x1A6EE4E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_CHECKB2SIMPLEX_OFFSET UNITYSDK_OFFSET(0x1A6EE9B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_CHECKFIXEDARRAYSERIES_OFFSET UNITYSDK_OFFSET(0x1A6ED8F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_CHECKSIZESERIES_OFFSET UNITYSDK_OFFSET(0x1A6ED8A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_CHECKUNIONSERIES_OFFSET UNITYSDK_OFFSET(0x1A6EE490)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_TESTFLOAT_OFFSET UNITYSDK_OFFSET(0x1A6EEFA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_TESTVEC2_OFFSET UNITYSDK_OFFSET(0x1A6EF010)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_THROWIFINVALIDB2SIMPLEXVERTEX_OFFSET UNITYSDK_OFFSET(0x1A6EF0F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_THROWIFSAFERUNTIMEPLATFORM_OFFSET UNITYSDK_OFFSET(0x1A6ED7F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR_THROWIF_OFFSET UNITYSDK_OFFSET(0x1A6EF090)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6EF420)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RUNTIMEVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6ED7E0)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2RuntimeValidator**)Il2CppClass::FromTypeDefinitionIndex(B2RuntimeValidator_TypeDefinitionIndex)->GetStaticField(0x5FCD0);
		}
