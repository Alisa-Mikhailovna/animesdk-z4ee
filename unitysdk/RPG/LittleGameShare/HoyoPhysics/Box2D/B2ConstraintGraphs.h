...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2ADDCONTACTTOGRAPH_OFFSET UNITYSDK_OFFSET(0x1A6AB0E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2ADDJOINTTOGRAPH_OFFSET UNITYSDK_OFFSET(0x1A6AC230)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2ASSIGNJOINTCOLOR_OFFSET UNITYSDK_OFFSET(0x1A6ABBA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x1A6AAE30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2CREATEJOINTINGRAPH_OFFSET UNITYSDK_OFFSET(0x1A6ABE70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2DESTROYGRAPH_OFFSET UNITYSDK_OFFSET(0x1A6AAF70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2REMOVECONTACTFROMGRAPH_OFFSET UNITYSDK_OFFSET(0x1A6ABA20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2REMOVEJOINTFROMGRAPH_OFFSET UNITYSDK_OFFSET(0x1A6AC450)
