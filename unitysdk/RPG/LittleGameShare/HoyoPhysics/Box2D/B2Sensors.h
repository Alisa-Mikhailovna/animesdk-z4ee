...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2COMPAREVISITORS_OFFSET UNITYSDK_OFFSET(0x1A6EF9F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2DESTROYSENSOR_OFFSET UNITYSDK_OFFSET(0x1A6A1C10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2OVERLAPSENSORS_OFFSET UNITYSDK_OFFSET(0x1A6F0380)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2SENSORQUERYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A6EF4D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2SENSORTASK_OFFSET UNITYSDK_OFFSET(0x1A6EFA00)
