...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICCOMPAREEXCHANGEINT_OFFSET UNITYSDK_OFFSET(0x1A69AAD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICFETCHADDINT_OFFSET UNITYSDK_OFFSET(0x1A69AAC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICLOADINT_OFFSET UNITYSDK_OFFSET(0x1A69AAB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICLOADU32_OFFSET UNITYSDK_OFFSET(0x1A69AAF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICSTOREINT_OFFSET UNITYSDK_OFFSET(0x1A69AAA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICSTOREU32_OFFSET UNITYSDK_OFFSET(0x1A69AAE0)
