...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2AABBS_B2AABB_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1A6996B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2AABBS_B2ENLARGEAABB_OFFSET UNITYSDK_OFFSET(0x1A699630)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2AABBS_B2PERIMETER_OFFSET UNITYSDK_OFFSET(0x1A699610)
