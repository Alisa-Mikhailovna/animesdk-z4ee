...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PROFILING_B2TRACYCZONEC_OFFSET UNITYSDK_OFFSET(0x1A6ECE40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PROFILING_B2TRACYCZONEEND_OFFSET UNITYSDK_OFFSET(0x1A6ECE60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PROFILING_B2TRACYCZONENC_OFFSET UNITYSDK_OFFSET(0x1A6ECE50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PROFILING_TRACYCFRAMEMARK_OFFSET UNITYSDK_OFFSET(0x1A6ECE70)
