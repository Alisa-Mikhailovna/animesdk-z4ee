...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2HULLS_B2COMPUTEHULL_OFFSET UNITYSDK_OFFSET(0x1A6DA690)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2HULLS_B2RECURSEHULL_OFFSET UNITYSDK_OFFSET(0x1A6D9A80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2HULLS_B2VALIDATEHULL_OFFSET UNITYSDK_OFFSET(0x1A6DC190)
