...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2GETLENGTHUNITSPERMETER_OFFSET UNITYSDK_OFFSET(0x1A6C4990)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2GETVERSION_OFFSET UNITYSDK_OFFSET(0x1A6C4910)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2SETLENGTHUNITSPERMETER_OFFSET UNITYSDK_OFFSET(0x1A6C4930)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_10_OFFSET UNITYSDK_OFFSET(0x1A6C4A90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_11_OFFSET UNITYSDK_OFFSET(0x1A6C4AA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_1_OFFSET UNITYSDK_OFFSET(0x1A6C4A00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_2_OFFSET UNITYSDK_OFFSET(0x1A6C4A10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_3_OFFSET UNITYSDK_OFFSET(0x1A6C4A20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_4_OFFSET UNITYSDK_OFFSET(0x1A6C4A30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_5_OFFSET UNITYSDK_OFFSET(0x1A6C4A40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_6_OFFSET UNITYSDK_OFFSET(0x1A6C4A50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_7_OFFSET UNITYSDK_OFFSET(0x1A6C4A60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_8_OFFSET UNITYSDK_OFFSET(0x1A6C4A70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_9_OFFSET UNITYSDK_OFFSET(0x1A6C4A80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_OFFSET UNITYSDK_OFFSET(0x1A6C49F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6C4AB0)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(B2Cores_TypeDefinitionIndex)->GetStaticField(0x10910);
		}
