...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2ADDCONTACTTOISLAND_OFFSET UNITYSDK_OFFSET(0x1A6DD030)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2ADDJOINTTOISLAND_OFFSET UNITYSDK_OFFSET(0x1A6DD460)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2CREATEISLAND_OFFSET UNITYSDK_OFFSET(0x1A69F510)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2DESTROYISLAND_OFFSET UNITYSDK_OFFSET(0x1A69F8D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2LINKCONTACT_OFFSET UNITYSDK_OFFSET(0x1A6DD0E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2LINKJOINT_OFFSET UNITYSDK_OFFSET(0x1A6A6E50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2MERGEAWAKEISLANDS_OFFSET UNITYSDK_OFFSET(0x1A6A7280)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2MERGEISLAND_OFFSET UNITYSDK_OFFSET(0x1A6DD510)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2SPLITISLANDTASK_OFFSET UNITYSDK_OFFSET(0x1A6DD7A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2SPLITISLAND_OFFSET UNITYSDK_OFFSET(0x1A6A8440)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2UNLINKCONTACT_OFFSET UNITYSDK_OFFSET(0x1A6C3590)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2UNLINKJOINT_OFFSET UNITYSDK_OFFSET(0x1A6A6D00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2VALIDATEISLAND_OFFSET UNITYSDK_OFFSET(0x1A6DD850)
