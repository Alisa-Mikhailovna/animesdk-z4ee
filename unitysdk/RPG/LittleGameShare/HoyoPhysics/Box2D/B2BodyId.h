...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A6AA8C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A6AA850)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A6AA930)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A6AA7E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID__CTOR_OFFSET UNITYSDK_OFFSET(0x39E7400)
