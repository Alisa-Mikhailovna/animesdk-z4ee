...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TIMERS_B2GETMILLISECONDSANDRESET_OFFSET UNITYSDK_OFFSET(0x1A700810)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TIMERS_B2GETMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1A704DC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TIMERS_B2GETTICKS_OFFSET UNITYSDK_OFFSET(0x1A700800)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TIMERS_B2HASH_OFFSET UNITYSDK_OFFSET(0x1A7056A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TIMERS_B2YIELD_OFFSET UNITYSDK_OFFSET(0x1A700820)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TIMERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A705710)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(B2Timers_TypeDefinitionIndex)->GetStaticField(0x10D30);
		}
