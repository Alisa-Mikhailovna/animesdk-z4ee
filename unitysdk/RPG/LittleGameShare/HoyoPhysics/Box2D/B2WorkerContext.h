...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORKERCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A704E10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORKERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7092E0)
