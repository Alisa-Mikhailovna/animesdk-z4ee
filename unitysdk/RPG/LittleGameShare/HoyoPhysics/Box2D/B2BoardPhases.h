...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_CREATEPROXY_OFFSET UNITYSDK_OFFSET(0x1A69C480)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_DESTROYPROXY_OFFSET UNITYSDK_OFFSET(0x1A69C6B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_ENLARGEPROXY_OFFSET UNITYSDK_OFFSET(0x1A69CA40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_GETSHAPEINDEX_OFFSET UNITYSDK_OFFSET(0x1A69EF70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_MOVEPROXY_OFFSET UNITYSDK_OFFSET(0x1A69C870)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_REBUILDTREES_OFFSET UNITYSDK_OFFSET(0x1A69EA30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_TESTOVERLAP_OFFSET UNITYSDK_OFFSET(0x1A69E880)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BUFFERMOVE_OFFSET UNITYSDK_OFFSET(0x1A69B2A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2CREATEBROADPHASE_OFFSET UNITYSDK_OFFSET(0x1A69B330)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2DESTROYBROADPHASE_OFFSET UNITYSDK_OFFSET(0x1A69BF10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2FINDPAIRSTASK_OFFSET UNITYSDK_OFFSET(0x1A69D3A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2PAIRQUERYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A69CCD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2UNBUFFERMOVE_OFFSET UNITYSDK_OFFSET(0x1A69C400)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2UPDATEBROADPHASEPAIRS_OFFSET UNITYSDK_OFFSET(0x1A69D840)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2VALIDATEBROADPHASE_OFFSET UNITYSDK_OFFSET(0x1A69F020)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2VALIDATENOENLARGED_OFFSET UNITYSDK_OFFSET(0x1A69F0C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2_PROXY_ID_OFFSET UNITYSDK_OFFSET(0x1A69B280)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2_PROXY_KEY_OFFSET UNITYSDK_OFFSET(0x1A69B290)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2_PROXY_TYPE_OFFSET UNITYSDK_OFFSET(0x1A69B270)
