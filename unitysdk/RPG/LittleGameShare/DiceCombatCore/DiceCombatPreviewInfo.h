...
#define RPG_LITTLEGAMESHARE_DICECOMBATCORE_DICECOMBATPREVIEWINFO_GETRECOMMENDDICEICONPATH_OFFSET UNITYSDK_OFFSET(0x1A698D20)
#define RPG_LITTLEGAMESHARE_DICECOMBATCORE_DICECOMBATPREVIEWINFO_GETRECOMMENDEDDICELIST_OFFSET UNITYSDK_OFFSET(0x1A698F50)
#define RPG_LITTLEGAMESHARE_DICECOMBATCORE_DICECOMBATPREVIEWINFO_GETSHOWEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x1A6993F0)
#define RPG_LITTLEGAMESHARE_DICECOMBATCORE_DICECOMBATPREVIEWINFO_GETTOPHINTICONTYPE_OFFSET UNITYSDK_OFFSET(0x1A6991F0)
#define RPG_LITTLEGAMESHARE_DICECOMBATCORE_DICECOMBATPREVIEWINFO_ISINRECOMMENDEDDICELIST_OFFSET UNITYSDK_OFFSET(0x1A698BC0)
#define RPG_LITTLEGAMESHARE_DICECOMBATCORE_DICECOMBATPREVIEWINFO_ISINSKILLDICELIST_OFFSET UNITYSDK_OFFSET(0x1A698A80)
#define RPG_LITTLEGAMESHARE_DICECOMBATCORE_DICECOMBATPREVIEWINFO_SETSHOWEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x1A6994A0)
#define RPG_LITTLEGAMESHARE_DICECOMBATCORE_DICECOMBATPREVIEWINFO_SETTOPHINTICONTYPE_OFFSET UNITYSDK_OFFSET(0x1A6992A0)
#define RPG_LITTLEGAMESHARE_DICECOMBATCORE_DICECOMBATPREVIEWINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6995F0)
...
namespace RPG::LittleGameShare::DiceCombatCore
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_0E117AC86D8E5BCA*>* ShowEffectDiceList; // 0x20
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::LittleGameShare::DiceCombatCore::DiceCombatDiceEffectType>* _DiceEffectTypeMap; // 0x30
		::System::Int32 AdditivePoint; // 0x38
		::System::Int32 BasePoint; // 0x3C
