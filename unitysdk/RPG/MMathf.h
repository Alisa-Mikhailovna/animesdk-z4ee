...
#define RPG_MMATHF_ABS_1_OFFSET UNITYSDK_OFFSET(0x1BAF9C80)
#define RPG_MMATHF_ABS_OFFSET UNITYSDK_OFFSET(0x1BAC9730)
#define RPG_MMATHF_ACOS_OFFSET UNITYSDK_OFFSET(0x1BAC9A10)
#define RPG_MMATHF_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1BAFD760)
#define RPG_MMATHF_ASIN_OFFSET UNITYSDK_OFFSET(0x1BAFCB00)
#define RPG_MMATHF_ATAN2_OFFSET UNITYSDK_OFFSET(0x1BAFCB20)
#define RPG_MMATHF_ATAN_OFFSET UNITYSDK_OFFSET(0x1BAD6560)
#define RPG_MMATHF_CEILTOINT_OFFSET UNITYSDK_OFFSET(0x1BAFD270)
#define RPG_MMATHF_CEIL_OFFSET UNITYSDK_OFFSET(0x1BAFD1A0)
#define RPG_MMATHF_CLAMP01_OFFSET UNITYSDK_OFFSET(0x1BAFCAA0)
#define RPG_MMATHF_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1BAFD380)
#define RPG_MMATHF_CLAMP_OFFSET UNITYSDK_OFFSET(0x1BAFD360)
#define RPG_MMATHF_COS_OFFSET UNITYSDK_OFFSET(0x1BAD5800)
#define RPG_MMATHF_DELTAANGLE_OFFSET UNITYSDK_OFFSET(0x1BAFD620)
#define RPG_MMATHF_EXP_OFFSET UNITYSDK_OFFSET(0x1BAD6090)
#define RPG_MMATHF_FLOORTOINT_OFFSET UNITYSDK_OFFSET(0x1BAFD290)
#define RPG_MMATHF_FLOOR_OFFSET UNITYSDK_OFFSET(0x1BAFD1B0)
#define RPG_MMATHF_GAMMA_OFFSET UNITYSDK_OFFSET(0x1BAFD6E0)
#define RPG_MMATHF_INVERSELERP_OFFSET UNITYSDK_OFFSET(0x1BAFD810)
#define RPG_MMATHF_LERPANGLE_OFFSET UNITYSDK_OFFSET(0x1BAFD3D0)
#define RPG_MMATHF_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1BAFD3C0)
#define RPG_MMATHF_LERP_OFFSET UNITYSDK_OFFSET(0x1BAFD390)
#define RPG_MMATHF_LINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1BAFD850)
#define RPG_MMATHF_LINESEGMENTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1BAFD940)
#define RPG_MMATHF_LOG10_OFFSET UNITYSDK_OFFSET(0x1BAFD180)
#define RPG_MMATHF_LOG_1_OFFSET UNITYSDK_OFFSET(0x1BAFD160)
#define RPG_MMATHF_LOG_OFFSET UNITYSDK_OFFSET(0x1BAFD0B0)
#define RPG_MMATHF_MAX_1_OFFSET UNITYSDK_OFFSET(0x1BAFCE10)
#define RPG_MMATHF_MAX_2_OFFSET UNITYSDK_OFFSET(0x1BAF9C50)
#define RPG_MMATHF_MAX_3_OFFSET UNITYSDK_OFFSET(0x1BAFCEE0)
#define RPG_MMATHF_MAX_OFFSET UNITYSDK_OFFSET(0x1BAFCE00)
#define RPG_MMATHF_MIN_1_OFFSET UNITYSDK_OFFSET(0x1BAFCB50)
#define RPG_MMATHF_MIN_2_OFFSET UNITYSDK_OFFSET(0x1BAF9C10)
#define RPG_MMATHF_MIN_3_OFFSET UNITYSDK_OFFSET(0x1BAFCC20)
#define RPG_MMATHF_MIN_4_OFFSET UNITYSDK_OFFSET(0x1BAFCC30)
#define RPG_MMATHF_MIN_OFFSET UNITYSDK_OFFSET(0x1BAFCB40)
#define RPG_MMATHF_MOVETOWARDSANGLE_OFFSET UNITYSDK_OFFSET(0x1BAFD520)
#define RPG_MMATHF_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x1BAFD4D0)
#define RPG_MMATHF_PINGPONG_OFFSET UNITYSDK_OFFSET(0x1BAFD7A0)
#define RPG_MMATHF_POW_OFFSET UNITYSDK_OFFSET(0x1BAD5F20)
#define RPG_MMATHF_RANDOMTOLONG_OFFSET UNITYSDK_OFFSET(0x1BAFDA50)
#define RPG_MMATHF_REPEAT_OFFSET UNITYSDK_OFFSET(0x1BAFD480)
#define RPG_MMATHF_ROUNDTOINT_OFFSET UNITYSDK_OFFSET(0x1BAFD2B0)
#define RPG_MMATHF_ROUND_OFFSET UNITYSDK_OFFSET(0x1BAFD1C0)
#define RPG_MMATHF_SIGN_OFFSET UNITYSDK_OFFSET(0x1BAC9710)
#define RPG_MMATHF_SIN_OFFSET UNITYSDK_OFFSET(0x1BAD5820)
#define RPG_MMATHF_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x1BAFD690)
#define RPG_MMATHF_SQRT_OFFSET UNITYSDK_OFFSET(0x1BAC9770)
#define RPG_MMATHF_TAN_OFFSET UNITYSDK_OFFSET(0x1BAFCAE0)
#define RPG_MMATHF__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BAFDB50)
