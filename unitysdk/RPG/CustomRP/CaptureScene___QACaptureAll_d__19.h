...
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AA5AB00)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AA5B4A0)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AA5B500)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AA5B4B0)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AA5AAF0)
#define RPG_CUSTOMRP_CAPTURESCENE___QACAPTUREALL_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA589F0)
