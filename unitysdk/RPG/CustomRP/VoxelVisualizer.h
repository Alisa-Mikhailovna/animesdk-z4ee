...
#define RPG_CUSTOMRP_VOXELVISUALIZER_LIGHTCANBEBAKED_OFFSET UNITYSDK_OFFSET(0xD8CD0C0)
#define RPG_CUSTOMRP_VOXELVISUALIZER_METHOD_5_B37B206BF73A85B5_OFFSET UNITYSDK_OFFSET(0xD8D45A0)
#define RPG_CUSTOMRP_VOXELVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0xD8D4660)
