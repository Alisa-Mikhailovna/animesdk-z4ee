...
#define RPG_CUSTOMRP_FOGVOLUMEVISUALIZER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1AA78D10)
#define RPG_CUSTOMRP_FOGVOLUMEVISUALIZER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA78C90)
#define RPG_CUSTOMRP_FOGVOLUMEVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA79060)
