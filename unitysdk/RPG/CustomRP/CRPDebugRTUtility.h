...
#define RPG_CUSTOMRP_CRPDEBUGRTUTILITY_GETDEBUGINFO_1_OFFSET UNITYSDK_OFFSET(0x1AA4A3D0)
#define RPG_CUSTOMRP_CRPDEBUGRTUTILITY_GETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x1AA4A3C0)
#define RPG_CUSTOMRP_CRPDEBUGRTUTILITY_GETDEBUGSUBINFO_OFFSET UNITYSDK_OFFSET(0x1AA4A3E0)
#define RPG_CUSTOMRP_CRPDEBUGRTUTILITY_INITDEBUGRT_OFFSET UNITYSDK_OFFSET(0x1AA4A3A0)
#define RPG_CUSTOMRP_CRPDEBUGRTUTILITY_SETDEBUG_OFFSET UNITYSDK_OFFSET(0x1AA4A3B0)
