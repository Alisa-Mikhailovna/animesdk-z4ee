...
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_BUILDEVENTMAP_OFFSET UNITYSDK_OFFSET(0x1AA3A8E0)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_EXECUTEEVENT_OFFSET UNITYSDK_OFFSET(0x1AA3A6C0)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_GETEVENTEXECUTORFUN_OFFSET UNITYSDK_OFFSET(0x1AA3A820)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AA3AC20)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA3A830)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA3A370)
