...
#define RPG_CUSTOMRP_MATERIALLIBRARY_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1AA7FCC0)
#define RPG_CUSTOMRP_MATERIALLIBRARY_LOAD_OFFSET UNITYSDK_OFFSET(0x1AA7FBA0)
#define RPG_CUSTOMRP_MATERIALLIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA7FA90)
...
namespace RPG::CustomRP
{
	...
	{
	public:
		::UnityEngine::Material* PPLensGlitch2; // 0x10
		::UnityEngine::Material* smaa; // 0x18
		::UnityEngine::Material* fxaa; // 0x20
		::UnityEngine::Material* motionBlur; // 0x28
		::UnityEngine::Material* lensFlare; // 0x30
		::UnityEngine::Material* PPPatern; // 0x38
		::UnityEngine::Material* PPLensGlitch; // 0x40
		::UnityEngine::Material* uber; // 0x48
		::UnityEngine::Material* lut2DBaker; // 0x50
