...
#define RPG_CUSTOMRP_CAMERAHELPER_HASDEBUGFLAG_1_OFFSET UNITYSDK_OFFSET(0x1AA551A0)
#define RPG_CUSTOMRP_CAMERAHELPER_HASDEBUGFLAG_OFFSET UNITYSDK_OFFSET(0x1AA55180)
#define RPG_CUSTOMRP_CAMERAHELPER_HASFLAG_OFFSET UNITYSDK_OFFSET(0x1AA55110)
#define RPG_CUSTOMRP_CAMERAHELPER_SETDEBUGFLAG_1_OFFSET UNITYSDK_OFFSET(0x1AA55160)
#define RPG_CUSTOMRP_CAMERAHELPER_SETDEBUGFLAG_OFFSET UNITYSDK_OFFSET(0x1AA55130)
#define RPG_CUSTOMRP_CAMERAHELPER_SETFLAG_1_OFFSET UNITYSDK_OFFSET(0x1AA550F0)
#define RPG_CUSTOMRP_CAMERAHELPER_SETFLAG_OFFSET UNITYSDK_OFFSET(0x1AA550C0)
