...
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR_START_OFFSET UNITYSDK_OFFSET(0x1AAC2EB0)
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR_SYNCCLOUDTRANSITIONPARAMS_OFFSET UNITYSDK_OFFSET(0x1AAC3780)
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR_UPDATESHADERPARAMS_OFFSET UNITYSDK_OFFSET(0x1AAC3010)
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAC37D0)
