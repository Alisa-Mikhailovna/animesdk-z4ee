...
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG_START_OFFSET UNITYSDK_OFFSET(0x1AA64650)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA64700)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA64C50)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__DOCLEAR_OFFSET UNITYSDK_OFFSET(0x1AA64B30)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__RECOVER_OFFSET UNITYSDK_OFFSET(0x1AA64A30)
