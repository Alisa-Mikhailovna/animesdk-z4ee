...
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA54FF0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA550A0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA54C20)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA54F70)
