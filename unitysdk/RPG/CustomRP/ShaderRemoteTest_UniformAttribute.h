...
#define RPG_CUSTOMRP_SHADERREMOTETEST_UNIFORMATTRIBUTE_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1AABFAB0)
#define RPG_CUSTOMRP_SHADERREMOTETEST_UNIFORMATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AABFAC0)
