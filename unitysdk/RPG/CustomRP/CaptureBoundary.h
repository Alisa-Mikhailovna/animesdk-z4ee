...
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_BACKUPCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA55710)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_CAPTUREEX_OFFSET UNITYSDK_OFFSET(0x1AA556F0)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_CAPTUREIMPL_OFFSET UNITYSDK_OFFSET(0x1AA55540)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_CAPTURE_1_OFFSET UNITYSDK_OFFSET(0x1AA556E0)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_CAPTURE_OFFSET UNITYSDK_OFFSET(0x1AA55530)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1AA55F10)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_GET_OUTPUTPATH_OFFSET UNITYSDK_OFFSET(0x1AA55520)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_RECOVERCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA56070)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_SETFORMAT_OFFSET UNITYSDK_OFFSET(0x1AA55500)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_SETOUTPUTPATH_OFFSET UNITYSDK_OFFSET(0x1AA55510)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_SETOUTPUTRTSIZE_OFFSET UNITYSDK_OFFSET(0x1AA554F0)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1AA554E0)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_SETUPCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA55F60)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_UPDATECAMERA_OFFSET UNITYSDK_OFFSET(0x1AA55810)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA56140)
