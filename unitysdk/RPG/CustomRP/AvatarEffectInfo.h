...
#define RPG_CUSTOMRP_AVATAREFFECTINFO_ADD_1_OFFSET UNITYSDK_OFFSET(0x1AA37950)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_ADD_2_OFFSET UNITYSDK_OFFSET(0x1AA37E00)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_ADD_3_OFFSET UNITYSDK_OFFSET(0x1AA38120)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_ADD_OFFSET UNITYSDK_OFFSET(0x1AA373B0)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AA38860)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_COLLECTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1AA38A80)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x1AA38600)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_REMOVE_2_OFFSET UNITYSDK_OFFSET(0x1AA38670)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_REMOVE_OFFSET UNITYSDK_OFFSET(0x1AA38410)
#define RPG_CUSTOMRP_AVATAREFFECTINFO__ADDMATEFFECT_1_OFFSET UNITYSDK_OFFSET(0x1AA37430)
#define RPG_CUSTOMRP_AVATAREFFECTINFO__ADDMATEFFECT_OFFSET UNITYSDK_OFFSET(0x1AA379A0)
#define RPG_CUSTOMRP_AVATAREFFECTINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA392F0)
#define RPG_CUSTOMRP_AVATAREFFECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA39270)
#define RPG_CUSTOMRP_AVATAREFFECTINFO__REMOVE_OFFSET UNITYSDK_OFFSET(0x1AA38480)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarEffectInfo_TypeDefinitionIndex)->GetStaticField(0x61810);
		}
