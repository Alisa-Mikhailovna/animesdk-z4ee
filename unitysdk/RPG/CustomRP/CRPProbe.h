...
#define RPG_CUSTOMRP_CRPPROBE_GETGLOBALROTATIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1AA4EF80)
#define RPG_CUSTOMRP_CRPPROBE_GETPROBEDELEGATEMESHANDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AA4F1E0)
#define RPG_CUSTOMRP_CRPPROBE_GET_ISGLOBALPROBE_OFFSET UNITYSDK_OFFSET(0x1AA4E4F0)
#define RPG_CUSTOMRP_CRPPROBE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AA4E4A0)
#define RPG_CUSTOMRP_CRPPROBE_GET_NEEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA4E500)
#define RPG_CUSTOMRP_CRPPROBE_GET_OVERRIDESTENCIL_OFFSET UNITYSDK_OFFSET(0x1AA4E510)
#define RPG_CUSTOMRP_CRPPROBE_GET_PROBE_OFFSET UNITYSDK_OFFSET(0x1AA4E4E0)
#define RPG_CUSTOMRP_CRPPROBE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AA4F830)
#define RPG_CUSTOMRP_CRPPROBE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AA4F780)
#define RPG_CUSTOMRP_CRPPROBE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA4F6D0)
#define RPG_CUSTOMRP_CRPPROBE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA4E530)
#define RPG_CUSTOMRP_CRPPROBE_RESETUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA4EF70)
#define RPG_CUSTOMRP_CRPPROBE_START_OFFSET UNITYSDK_OFFSET(0x1AA4F620)
#define RPG_CUSTOMRP_CRPPROBE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4F8E0)
#define RPG_CUSTOMRP_CRPPROBE__FLUSHDATA_OFFSET UNITYSDK_OFFSET(0x1AA4F450)
#define RPG_CUSTOMRP_CRPPROBE__PREPARE_OFFSET UNITYSDK_OFFSET(0x1AA4F2A0)
#define RPG_CUSTOMRP_CRPPROBE__UPDATEFILTER_OFFSET UNITYSDK_OFFSET(0x1AA4F350)
#define RPG_CUSTOMRP_CRPPROBE__UPDATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1AA4E610)
