...
#define RPG_CUSTOMRP_BATCHANIMATIONATTACH_ATTACHTRANS_OFFSET UNITYSDK_OFFSET(0x1AA3A380)
#define RPG_CUSTOMRP_BATCHANIMATIONATTACH_DETACHTRANS_OFFSET UNITYSDK_OFFSET(0x1AA3A4C0)
#define RPG_CUSTOMRP_BATCHANIMATIONATTACH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AA3A6A0)
#define RPG_CUSTOMRP_BATCHANIMATIONATTACH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA3A600)
#define RPG_CUSTOMRP_BATCHANIMATIONATTACH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA3A6B0)
