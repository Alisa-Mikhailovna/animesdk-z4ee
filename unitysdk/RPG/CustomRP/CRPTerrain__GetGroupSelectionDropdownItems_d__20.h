...
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AA51BD0)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AA51DD0)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AA51D60)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AA51E50)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AA51DC0)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AA51D70)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AA51BC0)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA50700)
