...
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_BASECAMERA_OFFSET UNITYSDK_OFFSET(0x1AA68E20)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_CAMERAREF_OFFSET UNITYSDK_OFFSET(0x1AA68D20)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_CAMERASTACK_OFFSET UNITYSDK_OFFSET(0x1AA68C30)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_DISABLEMAINCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA49400)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_ENABLEBLURFULL_OFFSET UNITYSDK_OFFSET(0x1AA49410)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_ENABLEDEBUGOC_OFFSET UNITYSDK_OFFSET(0x1AA68D80)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_ENABLEDEFORMATION_OFFSET UNITYSDK_OFFSET(0x1AA68DD0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_ENABLEHIZOC_OFFSET UNITYSDK_OFFSET(0x1AA68D30)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_MAINCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1AA68E40)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_MAINCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA68E30)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_NEEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA68C00)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_OVERLAYTYPE_OFFSET UNITYSDK_OFFSET(0x1AA68C10)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_VOLUMELAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AA68CE0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_VOLUMETRIGGER_OFFSET UNITYSDK_OFFSET(0x1AA68D00)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA68220)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AA69360)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AA691D0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA690E0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA681A0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_REFRESHALLCOLLIDER_1_OFFSET UNITYSDK_OFFSET(0x1AA681C0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_REFRESHALLCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1AA681B0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_ENABLEDEBUGOC_OFFSET UNITYSDK_OFFSET(0x1AA68DA0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_ENABLEDEFORMATION_OFFSET UNITYSDK_OFFSET(0x1AA68DF0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_ENABLEHIZOC_OFFSET UNITYSDK_OFFSET(0x1AA68D50)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_OVERLAYTYPE_OFFSET UNITYSDK_OFFSET(0x1AA68C20)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_VOLUMELAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AA68CF0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_VOLUMETRIGGER_OFFSET UNITYSDK_OFFSET(0x1AA68D10)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_START_OFFSET UNITYSDK_OFFSET(0x1AA68E50)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA681D0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA6A360)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__DISABLEHIZOCFORVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA69640)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__PREPARE_OFFSET UNITYSDK_OFFSET(0x1AA68FE0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEBASECAMERA_OFFSET UNITYSDK_OFFSET(0x1AA694B0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEDYNAMICDATA_OFFSET UNITYSDK_OFFSET(0x1AA682B0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEONSTART_OFFSET UNITYSDK_OFFSET(0x1AA69080)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEPRECONFIG_OFFSET UNITYSDK_OFFSET(0x1AA69710)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATESTATICDATA_OFFSET UNITYSDK_OFFSET(0x1AA69370)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA6A1E0)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::UnityEngine::Camera**)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalCameraData_TypeDefinitionIndex)->GetStaticField(0x229B0);
		}
		static ::RPG::CustomRP::CustomAdditionalCameraData** StaticGet_s_MainCameraData()
		{
			return (::RPG::CustomRP::CustomAdditionalCameraData**)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalCameraData_TypeDefinitionIndex)->GetStaticField(0x229B8);
		}
