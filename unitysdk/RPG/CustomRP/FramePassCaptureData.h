...
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_DIFF_OFFSET UNITYSDK_OFFSET(0x39EF5E0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x39EF5C0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_LOADIMAGE_OFFSET UNITYSDK_OFFSET(0x39EF570)
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x39EF5F0)
