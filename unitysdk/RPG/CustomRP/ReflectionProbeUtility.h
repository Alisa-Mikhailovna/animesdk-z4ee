...
#define RPG_CUSTOMRP_REFLECTIONPROBEUTILITY_SETGLOBALPROBE_OFFSET UNITYSDK_OFFSET(0x1AAB4E80)
#define RPG_CUSTOMRP_REFLECTIONPROBEUTILITY_SETNULLGLOBALPROBE_OFFSET UNITYSDK_OFFSET(0x1AAB4EE0)
#define RPG_CUSTOMRP_REFLECTIONPROBEUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAB4F10)
