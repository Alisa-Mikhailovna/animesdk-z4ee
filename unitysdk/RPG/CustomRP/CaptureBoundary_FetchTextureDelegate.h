...
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_FETCHTEXTUREDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA563B0)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_FETCHTEXTUREDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA563E0)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_FETCHTEXTUREDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA56330)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_FETCHTEXTUREDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA56340)
