...
#define RPG_CUSTOMRP_REFLECTIONSETTING_SSGISETTINGDATA_BOOLFIELD_OFFSET UNITYSDK_OFFSET(0x1AAB5450)
#define RPG_CUSTOMRP_REFLECTIONSETTING_SSGISETTINGDATA_FLOATFIELD_OFFSET UNITYSDK_OFFSET(0x1AAB51C0)
#define RPG_CUSTOMRP_REFLECTIONSETTING_SSGISETTINGDATA_INTFIELD_OFFSET UNITYSDK_OFFSET(0x1AAB5320)
#define RPG_CUSTOMRP_REFLECTIONSETTING_SSGISETTINGDATA_ONGUI_OFFSET UNITYSDK_OFFSET(0x1AAB5470)
#define RPG_CUSTOMRP_REFLECTIONSETTING_SSGISETTINGDATA_TOENGINE_OFFSET UNITYSDK_OFFSET(0x1AAB5120)
#define RPG_CUSTOMRP_REFLECTIONSETTING_SSGISETTINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAB50B0)
