...
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_ENABLEVSM_OFFSET UNITYSDK_OFFSET(0x1AA4AD10)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_GET_AUDIENCEDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA4ADC0)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_GET_CROWDDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA4AD40)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_GET_CURRENTPLATFORMCONFIG_OFFSET UNITYSDK_OFFSET(0x1AA4AE00)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_GET_PEDESTRIANDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA4AD80)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_SET_AUDIENCEDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA4ADD0)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_SET_CROWDDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA4AD50)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_SET_PEDESTRIANDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA4AD90)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4AED0)
