...
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_GET_DISCARD_OFFSET UNITYSDK_OFFSET(0x1AA4B1C0)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1AA43C20)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_SET_DISCARD_OFFSET UNITYSDK_OFFSET(0x1AA4B1D0)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4B1E0)
