...
#define RPG_CUSTOMRP_MATERIALPARAMS_CLEAR_OFFSET UNITYSDK_OFFSET(0x39EFD50)
#define RPG_CUSTOMRP_MATERIALPARAMS_DIFF_OFFSET UNITYSDK_OFFSET(0x39EFE50)
#define RPG_CUSTOMRP_MATERIALPARAMS_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x39EFE10)
#define RPG_CUSTOMRP_MATERIALPARAMS_NEW_OFFSET UNITYSDK_OFFSET(0x1AA7FDD0)
#define RPG_CUSTOMRP_MATERIALPARAMS_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x39EFEA0)
