...
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_0E3D8071A5930FA8_1_OFFSET UNITYSDK_OFFSET(0xD8D75D0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_0E3D8071A5930FA8_OFFSET UNITYSDK_OFFSET(0xD8D4880)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_6FE6E0587E8D1F5C_OFFSET UNITYSDK_OFFSET(0xD8D7200)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_7B411317D337F87A_1_OFFSET UNITYSDK_OFFSET(0xD8D5F60)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_7B411317D337F87A_2_OFFSET UNITYSDK_OFFSET(0xD8DA2C0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_7B411317D337F87A_3_OFFSET UNITYSDK_OFFSET(0xD8D9A80)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_7B411317D337F87A_OFFSET UNITYSDK_OFFSET(0xD8D67D0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0xD8D5B60)
#define RPG_CUSTOMRP_PREVIEWPPFS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD8DB230)
#define RPG_CUSTOMRP_PREVIEWPPFS_START_OFFSET UNITYSDK_OFFSET(0xD8D4670)
#define RPG_CUSTOMRP_PREVIEWPPFS_UPDATE_OFFSET UNITYSDK_OFFSET(0xD8D46F0)
#define RPG_CUSTOMRP_PREVIEWPPFS__CTOR_OFFSET UNITYSDK_OFFSET(0xD8DBAC0)
