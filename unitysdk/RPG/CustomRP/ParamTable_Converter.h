...
#define RPG_CUSTOMRP_PARAMTABLE_CONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1AA83290)
#define RPG_CUSTOMRP_PARAMTABLE_CONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1AA832D0)
#define RPG_CUSTOMRP_PARAMTABLE_CONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1AA833A0)
#define RPG_CUSTOMRP_PARAMTABLE_CONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA83470)
