...
#define RPG_CUSTOMRP_SHADERREMOTETEST_ACTIONATTRIBUTE_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1AABFA90)
#define RPG_CUSTOMRP_SHADERREMOTETEST_ACTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AABFAA0)
