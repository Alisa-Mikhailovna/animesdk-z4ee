...
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT_RESET_OFFSET UNITYSDK_OFFSET(0x1AA39C10)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT_SETSUBMESHINDEX_OFFSET UNITYSDK_OFFSET(0x1AA39C40)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT_UNSETSUBMESHINDEX_OFFSET UNITYSDK_OFFSET(0x1AA39CA0)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA39D00)
