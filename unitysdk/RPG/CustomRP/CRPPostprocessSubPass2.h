...
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_BEGINSAMPLE_OFFSET UNITYSDK_OFFSET(0x1AA4E470)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_ENDSAMPLE_OFFSET UNITYSDK_OFFSET(0x1AA4E480)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AA4E190)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1AA4E170)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_INNEREXECUTE_OFFSET UNITYSDK_OFFSET(0x1AA4E490)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_ISPPCOMPENABLE_OFFSET UNITYSDK_OFFSET(0x1AA4E030)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_ONCHANGEENV_OFFSET UNITYSDK_OFFSET(0x1AA4E180)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_SETUPCOMP_OFFSET UNITYSDK_OFFSET(0x1AA4DEB0)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_SETUPOUTPUTRT_OFFSET UNITYSDK_OFFSET(0x1AA4DEE0)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_SETUPSETTING_OFFSET UNITYSDK_OFFSET(0x1AA4DEC0)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_SETUP_OFFSET UNITYSDK_OFFSET(0x1AA4DED0)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA4DEF0)
#define RPG_CUSTOMRP_CRPPOSTPROCESSSUBPASS2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4DEA0)
