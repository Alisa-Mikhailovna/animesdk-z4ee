...
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA7BAC0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA7BB30)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA7BAB0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA7BA40)
