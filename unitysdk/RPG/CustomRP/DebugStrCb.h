...
#define RPG_CUSTOMRP_DEBUGSTRCB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA73ED0)
#define RPG_CUSTOMRP_DEBUGSTRCB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA73F00)
#define RPG_CUSTOMRP_DEBUGSTRCB_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA73EC0)
#define RPG_CUSTOMRP_DEBUGSTRCB__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA73E50)
