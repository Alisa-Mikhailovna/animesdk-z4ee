...
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD8CBC00)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_DRAWWIRECAPSULE_OFFSET UNITYSDK_OFFSET(0xD8CCA60)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_FORCESETLOCALLIGHTDIR_OFFSET UNITYSDK_OFFSET(0xD8CBEE0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xD8CBF30)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0xD8CC120)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_81324F8D98C88EDA_OFFSET UNITYSDK_OFFSET(0xD8CB550)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD8CBCD0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD8CBBC0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_DE41669E7C7D4E6C_OFFSET UNITYSDK_OFFSET(0xD8CC550)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD8CBC40)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD8CC790)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_SETCAPSULELIGHTDIR_OFFSET UNITYSDK_OFFSET(0xD8CBE60)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_SETDEFAULTBONES_OFFSET UNITYSDK_OFFSET(0xD8CB8D0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD8CBB60)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_TESTCAPSULEDIR_OFFSET UNITYSDK_OFFSET(0xD8CBDA0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_UPDATE_OFFSET UNITYSDK_OFFSET(0xD8CC8A0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION__CCTOR_OFFSET UNITYSDK_OFFSET(0xD8CCB40)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0xD8CCAE0)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CapsuleOcclusion_TypeDefinitionIndex)->GetStaticField(0x56730);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_Field_5_1()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CapsuleOcclusion_TypeDefinitionIndex)->GetStaticField(0x56738);
		}
