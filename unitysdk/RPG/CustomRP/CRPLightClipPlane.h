...
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE_GET_LIGHT_OFFSET UNITYSDK_OFFSET(0x1AA4BAC0)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA4B3A0)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE_SET_LIGHT_OFFSET UNITYSDK_OFFSET(0x1AA4BAD0)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE_UPDATELIGHTCLIPPLANES_OFFSET UNITYSDK_OFFSET(0x1AA4B3B0)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4BAE0)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE__SETCLIPPLANELOCALDATA_OFFSET UNITYSDK_OFFSET(0x1AA4B660)
