...
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_BEGINCAPTURE_OFFSET UNITYSDK_OFFSET(0xD8D0E30)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_EXECUTE_OFFSET UNITYSDK_OFFSET(0xD8D1390)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_GET_DUMPPATHS_OFFSET UNITYSDK_OFFSET(0xD8D0DA0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_GET_KEY_OFFSET UNITYSDK_OFFSET(0xD8D0D90)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xD8D1430)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_50CDA0D6D52C2BA3_OFFSET UNITYSDK_OFFSET(0xD8D0ED0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0xD8D0FF0)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD8D1690)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD8D1510)
#define RPG_CUSTOMRP_PATHTRACINGDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xD8D17C0)
