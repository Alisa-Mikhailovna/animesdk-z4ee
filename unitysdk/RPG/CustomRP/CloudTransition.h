...
#define RPG_CUSTOMRP_CLOUDTRANSITION_ADDKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1AA652B0)
#define RPG_CUSTOMRP_CLOUDTRANSITION_CREATEKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1AA64E70)
#define RPG_CUSTOMRP_CLOUDTRANSITION_FINDPREVANDNEXTKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1AA64DE0)
#define RPG_CUSTOMRP_CLOUDTRANSITION_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1AA66030)
#define RPG_CUSTOMRP_CLOUDTRANSITION_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AA64C80)
#define RPG_CUSTOMRP_CLOUDTRANSITION_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AA66010)
#define RPG_CUSTOMRP_CLOUDTRANSITION_REMOVEKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1AA65190)
#define RPG_CUSTOMRP_CLOUDTRANSITION_SETKEYFRAMETIME_OFFSET UNITYSDK_OFFSET(0x1AA64FB0)
#define RPG_CUSTOMRP_CLOUDTRANSITION_SET_TIME_OFFSET UNITYSDK_OFFSET(0x1AA66040)
#define RPG_CUSTOMRP_CLOUDTRANSITION_START_OFFSET UNITYSDK_OFFSET(0x1AA64C70)
#define RPG_CUSTOMRP_CLOUDTRANSITION_UPDATESHADERPARAMS_1_OFFSET UNITYSDK_OFFSET(0x1AA65FF0)
#define RPG_CUSTOMRP_CLOUDTRANSITION_UPDATESHADERPARAMS_OFFSET UNITYSDK_OFFSET(0x1AA654D0)
#define RPG_CUSTOMRP_CLOUDTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA66070)
#define RPG_CUSTOMRP_CLOUDTRANSITION__GETNEXTKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1AA65120)
#define RPG_CUSTOMRP_CLOUDTRANSITION__GETPREVKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1AA650C0)
#define RPG_CUSTOMRP_CLOUDTRANSITION__KEYFRAMEINDEXVALID_OFFSET UNITYSDK_OFFSET(0x1AA65FC0)
