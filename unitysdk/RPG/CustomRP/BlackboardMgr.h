...
#define RPG_CUSTOMRP_BLACKBOARDMGR_CREATECPP_OFFSET UNITYSDK_OFFSET(0x1AA3AC80)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLEDIRBLUR_OFFSET UNITYSDK_OFFSET(0x1AA3AD60)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLEDOF_OFFSET UNITYSDK_OFFSET(0x1AA3AD40)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLEGAUSSBLUR_OFFSET UNITYSDK_OFFSET(0x1AA3AD80)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLEMOTIONBLUR_OFFSET UNITYSDK_OFFSET(0x1AA3ADA0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLERADIALBLUR_OFFSET UNITYSDK_OFFSET(0x1AA3ADC0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AA3AD30)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLEDIRBLUR_OFFSET UNITYSDK_OFFSET(0x1AA3AD70)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLEDOF_OFFSET UNITYSDK_OFFSET(0x1AA3AD50)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLEGAUSSBLUR_OFFSET UNITYSDK_OFFSET(0x1AA3AD90)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLEMOTIONBLUR_OFFSET UNITYSDK_OFFSET(0x1AA3ADB0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLERADIALBLUR_OFFSET UNITYSDK_OFFSET(0x1AA3ADD0)
#define RPG_CUSTOMRP_BLACKBOARDMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA3AD10)
#define RPG_CUSTOMRP_BLACKBOARDMGR__INITCPP_OFFSET UNITYSDK_OFFSET(0x1AA3AD20)
#define RPG_CUSTOMRP_BLACKBOARDMGR__INITPROFILE_OFFSET UNITYSDK_OFFSET(0x1AA3ADE0)
...
namespace RPG::CustomRP
{
	...
	{
	public:
		::System::Boolean _GlobalEnableDOF_k__BackingField; // 0x10
