...
#define RPG_CUSTOMRP_QACAPTUREDATA_DIFF_OFFSET UNITYSDK_OFFSET(0x39F0300)
#define RPG_CUSTOMRP_QACAPTUREDATA_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x39F02B0)
#define RPG_CUSTOMRP_QACAPTUREDATA_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x39F0360)
#define RPG_CUSTOMRP_QACAPTUREDATA_UNSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AA84C90)
