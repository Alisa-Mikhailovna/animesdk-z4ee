...
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AA67600)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1AA675F0)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB_RELEASEMASKRT_OFFSET UNITYSDK_OFFSET(0x1AA67520)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA68160)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA675E0)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB__ENSUREMASKRT_OFFSET UNITYSDK_OFFSET(0x1AA67F80)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ColorGradingMaskManager_MaskCb_TypeDefinitionIndex)->GetStaticField(0x11740);
		}
