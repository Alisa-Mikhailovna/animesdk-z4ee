...
#define RPG_CUSTOMRP_BATHROWEVENT_ATTACHTRANS_OFFSET UNITYSDK_OFFSET(0x1AA3A040)
#define RPG_CUSTOMRP_BATHROWEVENT_BEGIN_OFFSET UNITYSDK_OFFSET(0x1AA3A300)
#define RPG_CUSTOMRP_BATHROWEVENT_END_OFFSET UNITYSDK_OFFSET(0x1AA3A310)
#define RPG_CUSTOMRP_BATHROWEVENT_EVENT_THROW_OFFSET UNITYSDK_OFFSET(0x1AA39DE0)
#define RPG_CUSTOMRP_BATHROWEVENT_GETEVENTEXECUTORFUN_OFFSET UNITYSDK_OFFSET(0x1AA39D20)
#define RPG_CUSTOMRP_BATHROWEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA3A0A0)
#define RPG_CUSTOMRP_BATHROWEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA3A360)
