...
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTUREAMBIENTTEX_OFFSET UNITYSDK_OFFSET(0x1AA588E0)
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTUREPROBEOUTPUT_OFFSET UNITYSDK_OFFSET(0x1AA58830)
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTURESCENEOUTPUT_OFFSET UNITYSDK_OFFSET(0x1AA587E0)
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTURE_OFFSET UNITYSDK_OFFSET(0x1AA57C70)
#define RPG_CUSTOMRP_CAPTURESCENE_QACAPTUREALL_OFFSET UNITYSDK_OFFSET(0x1AA58940)
#define RPG_CUSTOMRP_CAPTURESCENE__CAPTURECOROUTINE_OFFSET UNITYSDK_OFFSET(0x1AA58890)
#define RPG_CUSTOMRP_CAPTURESCENE__CAPTURESCENEOUTPUTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1AA58780)
#define RPG_CUSTOMRP_CAPTURESCENE__CBSCENE_OFFSET UNITYSDK_OFFSET(0x1AA57FD0)
#define RPG_CUSTOMRP_CAPTURESCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA58A00)
#define RPG_CUSTOMRP_CAPTURESCENE__DUMPPARAMS_OFFSET UNITYSDK_OFFSET(0x1AA57E60)
#define RPG_CUSTOMRP_CAPTURESCENE__QACAPTUREALL_OFFSET UNITYSDK_OFFSET(0x1AA58990)
