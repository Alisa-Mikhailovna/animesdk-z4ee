...
#define RPG_CUSTOMRP_SWRTPASS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AABBCB0)
#define RPG_CUSTOMRP_SWRTPASS_INNEREXCUTE_OFFSET UNITYSDK_OFFSET(0x1AABA410)
#define RPG_CUSTOMRP_SWRTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AABA3D0)
...
namespace RPG::CustomRP
{
	...
	{
	public:
		::UnityEngine::RenderTexture* _AtlasNormal; // 0x10
		::UnityEngine::ComputeBuffer* _TriangleIndex8; // 0x18
		::UnityEngine::ComputeBuffer* _UVs; // 0x20
		::SWRT::SWRT* _CurSWRT; // 0x28
		::UnityEngine::ComputeBuffer* _Tangents; // 0x30
		::UnityEngine::RenderTexture* _AtlasAlbedo; // 0x38
		::UnityEngine::ComputeBuffer* _LocalToWorlds; // 0x40
		::UnityEngine::ComputeBuffer* _Materials; // 0x48
		::UnityEngine::ComputeBuffer* _Indices; // 0x50
		::UnityEngine::Material* _BlitMaterial; // 0x58
		::UnityEngine::ComputeBuffer* _RendererIndex8; // 0x60
		::UnityEngine::ComputeBuffer* _BlasOffsets8; // 0x68
