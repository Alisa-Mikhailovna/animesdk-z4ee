...
#define RPG_CUSTOMRP_CRPPROBEBLENDGROUP_GETPROBE_OFFSET UNITYSDK_OFFSET(0x1AA4F940)
#define RPG_CUSTOMRP_CRPPROBEBLENDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4FB70)
#define RPG_CUSTOMRP_CRPPROBEBLENDGROUP__GETPROBECOUNT_OFFSET UNITYSDK_OFFSET(0x1AA4F9E0)
