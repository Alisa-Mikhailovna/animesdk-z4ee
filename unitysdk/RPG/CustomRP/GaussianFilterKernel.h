...
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_COMPUTE1DGAUSSIANBLURPARAMCROSSCENTER_OFFSET UNITYSDK_OFFSET(0x1AA7BF20)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_COMPUTE1DGAUSSIANBLURPARAM_OFFSET UNITYSDK_OFFSET(0x1AA7BBB0)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_COMPUTE1DGAUSSIANFILTERKERNEL_OFFSET UNITYSDK_OFFSET(0x1AA7C100)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_SIGNWITHZERO_OFFSET UNITYSDK_OFFSET(0x1AA7BB90)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_SQUARE_OFFSET UNITYSDK_OFFSET(0x1AA7BBA0)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA7C3A0)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL__GAUSSIAN_OFFSET UNITYSDK_OFFSET(0x1AA7BF00)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL__RESET_OFFSET UNITYSDK_OFFSET(0x1AA7C330)
