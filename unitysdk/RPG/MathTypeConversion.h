...
#define RPG_MATHTYPECONVERSION_GAMECOREQUATERNIONTOUNITY_OFFSET UNITYSDK_OFFSET(0x1BB02140)
#define RPG_MATHTYPECONVERSION_GAMECOREVECTOR2TOUNITY_OFFSET UNITYSDK_OFFSET(0x1BB01F70)
#define RPG_MATHTYPECONVERSION_GAMECOREVECTOR3TOUNITY_OFFSET UNITYSDK_OFFSET(0x1BB01FA0)
#define RPG_MATHTYPECONVERSION_GAMECOREVECTOR4TOUNITY_OFFSET UNITYSDK_OFFSET(0x1BB02120)
#define RPG_MATHTYPECONVERSION_TO0Y0_OFFSET UNITYSDK_OFFSET(0x1BB02080)
#define RPG_MATHTYPECONVERSION_TOGAMECOREREF_OFFSET UNITYSDK_OFFSET(0x1BB021C0)
#define RPG_MATHTYPECONVERSION_TOGAMECOREV2X0Z_OFFSET UNITYSDK_OFFSET(0x1BB02240)
#define RPG_MATHTYPECONVERSION_TOGAMECORE_1_OFFSET UNITYSDK_OFFSET(0x1BB02180)
#define RPG_MATHTYPECONVERSION_TOGAMECORE_2_OFFSET UNITYSDK_OFFSET(0x1BB021E0)
#define RPG_MATHTYPECONVERSION_TOGAMECORE_3_OFFSET UNITYSDK_OFFSET(0x1BB02210)
#define RPG_MATHTYPECONVERSION_TOGAMECORE_OFFSET UNITYSDK_OFFSET(0x1BB02160)
#define RPG_MATHTYPECONVERSION_TOUNITYX0Z_OFFSET UNITYSDK_OFFSET(0x1BB02220)
#define RPG_MATHTYPECONVERSION_TOUNITY_1_OFFSET UNITYSDK_OFFSET(0x1BB01F60)
#define RPG_MATHTYPECONVERSION_TOUNITY_2_OFFSET UNITYSDK_OFFSET(0x1BB01F80)
#define RPG_MATHTYPECONVERSION_TOUNITY_3_OFFSET UNITYSDK_OFFSET(0x1BB02110)
#define RPG_MATHTYPECONVERSION_TOUNITY_4_OFFSET UNITYSDK_OFFSET(0x1BB02130)
#define RPG_MATHTYPECONVERSION_TOUNITY_5_OFFSET UNITYSDK_OFFSET(0x1BB02150)
#define RPG_MATHTYPECONVERSION_TOUNITY_OFFSET UNITYSDK_OFFSET(0x1BB01F50)
#define RPG_MATHTYPECONVERSION_TOX0ZNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1BB01FE0)
#define RPG_MATHTYPECONVERSION_TOX0Z_OFFSET UNITYSDK_OFFSET(0x1BB01FC0)
#define RPG_MATHTYPECONVERSION_TOXY0_OFFSET UNITYSDK_OFFSET(0x1BB020A0)
#define RPG_MATHTYPECONVERSION_UNITYQUATERNIONTOGAMECORE_OFFSET UNITYSDK_OFFSET(0x1BB021F0)
#define RPG_MATHTYPECONVERSION_UNITYVECTOR2TOGAMECORE_OFFSET UNITYSDK_OFFSET(0x1BB02170)
#define RPG_MATHTYPECONVERSION_UNITYVECTOR3TOGAMECORE_OFFSET UNITYSDK_OFFSET(0x1BB021A0)
#define RPG_MATHTYPECONVERSION_UNITYVECTOR4TOGAMECORE_OFFSET UNITYSDK_OFFSET(0x1BB02200)
#define RPG_MATHTYPECONVERSION_XZMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1BB020E0)
#define RPG_MATHTYPECONVERSION_XZSQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1BB020C0)
