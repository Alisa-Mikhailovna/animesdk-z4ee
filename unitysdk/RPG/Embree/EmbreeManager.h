...
#define RPG_EMBREE_EMBREEMANAGER_ADDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xAB8F2F0)
#define RPG_EMBREE_EMBREEMANAGER_ADDMESH_OFFSET UNITYSDK_OFFSET(0xAB8F540)
#define RPG_EMBREE_EMBREEMANAGER_ADDSTATICGEOMETRY_OFFSET UNITYSDK_OFFSET(0xAB8FEF0)
#define RPG_EMBREE_EMBREEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xAB8EA40)
#define RPG_EMBREE_EMBREEMANAGER_CLEANUP_OFFSET UNITYSDK_OFFSET(0xAB90CA0)
#define RPG_EMBREE_EMBREEMANAGER_COMMITSCENE_OFFSET UNITYSDK_OFFSET(0xAB901B0)
#define RPG_EMBREE_EMBREEMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAB8E960)
#define RPG_EMBREE_EMBREEMANAGER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0xAB8EA30)
#define RPG_EMBREE_EMBREEMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xAB8EA90)
#define RPG_EMBREE_EMBREEMANAGER_ISOCCLUDED_OFFSET UNITYSDK_OFFSET(0xAB909C0)
#define RPG_EMBREE_EMBREEMANAGER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0xAB910D0)
#define RPG_EMBREE_EMBREEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAB91050)
#define RPG_EMBREE_EMBREEMANAGER_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0xAB908A0)
#define RPG_EMBREE_EMBREEMANAGER_RAYCAST_OFFSET UNITYSDK_OFFSET(0xAB90420)
#define RPG_EMBREE_EMBREEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB91150)
...
namespace RPG::Embree
{
	...
	public:
		...
		{
			return (::RPG::Embree::EmbreeManager**)Il2CppClass::FromTypeDefinitionIndex(EmbreeManager_TypeDefinitionIndex)->GetStaticField(0x1D450);
		}
