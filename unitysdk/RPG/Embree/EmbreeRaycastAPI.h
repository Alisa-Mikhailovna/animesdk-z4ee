...
#define RPG_EMBREE_EMBREERAYCASTAPI_ADDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xAB915E0)
#define RPG_EMBREE_EMBREERAYCASTAPI_ADDMESH_OFFSET UNITYSDK_OFFSET(0xAB914E0)
#define RPG_EMBREE_EMBREERAYCASTAPI_CALCULATEFRONTFACE_OFFSET UNITYSDK_OFFSET(0xAB925B0)
#define RPG_EMBREE_EMBREERAYCASTAPI_COMMITSCENE_OFFSET UNITYSDK_OFFSET(0xAB918A0)
#define RPG_EMBREE_EMBREERAYCASTAPI_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAB92E10)
#define RPG_EMBREE_EMBREERAYCASTAPI_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xAB911E0)
#define RPG_EMBREE_EMBREERAYCASTAPI_RAYCASTBATCHALL_OFFSET UNITYSDK_OFFSET(0xAB925E0)
#define RPG_EMBREE_EMBREERAYCASTAPI_RAYCASTBATCH_OFFSET UNITYSDK_OFFSET(0xAB91B10)
#define RPG_EMBREE_EMBREERAYCASTAPI_RAYCAST_OFFSET UNITYSDK_OFFSET(0xAB919F0)
#define RPG_EMBREE_EMBREERAYCASTAPI__CTOR_OFFSET UNITYSDK_OFFSET(0xAB92E40)
