...
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIG_METHOD_2_DCEAD06FA1C5B149_OFFSET UNITYSDK_OFFSET(0x1B4537F0)
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B453830)
