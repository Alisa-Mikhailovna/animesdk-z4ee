...
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN_CLEAR_OFFSET UNITYSDK_OFFSET(0xD9330B0)
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xD933150)
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD933100)
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN_INIT_OFFSET UNITYSDK_OFFSET(0xD906E50)
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0xD9331A0)
