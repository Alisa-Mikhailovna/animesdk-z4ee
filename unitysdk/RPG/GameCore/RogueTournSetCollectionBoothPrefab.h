...
#define RPG_GAMECORE_ROGUETOURNSETCOLLECTIONBOOTHPREFAB_METHOD_3_90DBC0FAC77137CE_OFFSET UNITYSDK_OFFSET(0x1B7A0040)
#define RPG_GAMECORE_ROGUETOURNSETCOLLECTIONBOOTHPREFAB_METHOD_3_DECA6AA79939952D_OFFSET UNITYSDK_OFFSET(0x1B7A0080)
#define RPG_GAMECORE_ROGUETOURNSETCOLLECTIONBOOTHPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A0070)
