...
#define RPG_GAMECORE_FIVEDIMSTOPSPLINEMOVEACTION_METHOD_3_2C8ED0E9B9E359FB_OFFSET UNITYSDK_OFFSET(0x1B44C0D0)
#define RPG_GAMECORE_FIVEDIMSTOPSPLINEMOVEACTION_METHOD_3_CD6DF8C18994B7DA_OFFSET UNITYSDK_OFFSET(0x1B44C150)
#define RPG_GAMECORE_FIVEDIMSTOPSPLINEMOVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44C140)
