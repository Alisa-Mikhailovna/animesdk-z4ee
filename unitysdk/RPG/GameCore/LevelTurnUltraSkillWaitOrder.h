...
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xDADE120)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETDISABLEREADYCAMERA_OFFSET UNITYSDK_OFFSET(0xDADE1F0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADE090)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xDADE0E0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADE040)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xDADE170)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETTURNSTATE_OFFSET UNITYSDK_OFFSET(0xDADE1B0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GET_ACTIONTYPE_OFFSET UNITYSDK_OFFSET(0xDADE230)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_INIT_OFFSET UNITYSDK_OFFSET(0xDADDFC0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER__CTOR_OFFSET UNITYSDK_OFFSET(0xDADE250)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean _DisableReadyCamera; // 0x28
