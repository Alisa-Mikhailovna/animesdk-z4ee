...
#define RPG_GAMECORE_PHOTOGRAPHTIPRANGECONFIG_METHOD_2_845A88146AA11D6A_OFFSET UNITYSDK_OFFSET(0x1B6ACB50)
#define RPG_GAMECORE_PHOTOGRAPHTIPRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6ACD10)
