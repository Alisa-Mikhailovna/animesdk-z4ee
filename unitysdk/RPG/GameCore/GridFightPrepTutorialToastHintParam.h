...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOASTHINTPARAM_METHOD_2_9289CB7DB2498F62_OFFSET UNITYSDK_OFFSET(0x1B4E6130)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOASTHINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E6B40)
