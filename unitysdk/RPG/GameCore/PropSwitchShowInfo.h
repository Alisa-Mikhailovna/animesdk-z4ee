...
#define RPG_GAMECORE_PROPSWITCHSHOWINFO_METHOD_3_0AFEBB23048C9096_OFFSET UNITYSDK_OFFSET(0x1B6F1C00)
#define RPG_GAMECORE_PROPSWITCHSHOWINFO_METHOD_3_8C2125DA46A8A7C6_OFFSET UNITYSDK_OFFSET(0x1B6F1C70)
#define RPG_GAMECORE_PROPSWITCHSHOWINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F1C50)
