...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG_METHOD_3_4CBCB7328FCF5568_OFFSET UNITYSDK_OFFSET(0x1B7A4F10)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG_METHOD_3_550A227A67DA24EC_OFFSET UNITYSDK_OFFSET(0x1B7A5210)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4F00)
