...
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_GET_PUZZLEITEMRESULT_OFFSET UNITYSDK_OFFSET(0x1B8CA2A0)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_METHOD_3_4D2EA0A1DE8C9502_OFFSET UNITYSDK_OFFSET(0x1B8CA0C0)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_METHOD_3_83AF0C06493B76DF_OFFSET UNITYSDK_OFFSET(0x1B8CA080)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_SET_PUZZLEITEMRESULT_OFFSET UNITYSDK_OFFSET(0x1B8CA2B0)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8CA0B0)
