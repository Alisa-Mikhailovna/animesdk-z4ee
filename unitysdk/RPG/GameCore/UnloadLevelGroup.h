...
#define RPG_GAMECORE_UNLOADLEVELGROUP_METHOD_3_B09BA640822CFE60_OFFSET UNITYSDK_OFFSET(0x1B9C6790)
#define RPG_GAMECORE_UNLOADLEVELGROUP_METHOD_3_E0BD81BF395B3123_OFFSET UNITYSDK_OFFSET(0x1B9C6750)
#define RPG_GAMECORE_UNLOADLEVELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C6780)
