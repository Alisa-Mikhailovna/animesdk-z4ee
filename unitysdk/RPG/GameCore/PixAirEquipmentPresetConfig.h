...
#define RPG_GAMECORE_PIXAIREQUIPMENTPRESETCONFIG_METHOD_2_98920AA644FA7849_OFFSET UNITYSDK_OFFSET(0x1B6B48D0)
#define RPG_GAMECORE_PIXAIREQUIPMENTPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B4A50)
