...
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_USESKILLERRORINFO_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0x156070)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_USESKILLERRORINFO_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0xDB432E0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_USESKILLERRORINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xDB44DB0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_USESKILLERRORINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1560A0)
#define RPG_GAMECORE_SKILLCHARACTERCOMPONENT_USESKILLERRORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x156080)
