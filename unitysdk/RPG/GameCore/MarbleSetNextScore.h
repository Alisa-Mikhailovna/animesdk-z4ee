...
#define RPG_GAMECORE_MARBLESETNEXTSCORE_METHOD_3_4A6E79A774318A5D_OFFSET UNITYSDK_OFFSET(0x1B5C14D0)
#define RPG_GAMECORE_MARBLESETNEXTSCORE_METHOD_3_91C543712B5A9531_OFFSET UNITYSDK_OFFSET(0x1B5C1400)
#define RPG_GAMECORE_MARBLESETNEXTSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C14C0)
