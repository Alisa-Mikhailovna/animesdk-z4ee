...
#define RPG_GAMECORE_MAP3DICONCONFIG_METHOD_2_0D9E6A2D6F64F87B_OFFSET UNITYSDK_OFFSET(0x1B5A4190)
#define RPG_GAMECORE_MAP3DICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A4320)
