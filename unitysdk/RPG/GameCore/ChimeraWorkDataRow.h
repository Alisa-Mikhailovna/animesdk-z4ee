...
#define RPG_GAMECORE_CHIMERAWORKDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B358D70)
#define RPG_GAMECORE_CHIMERAWORKDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B359050)
