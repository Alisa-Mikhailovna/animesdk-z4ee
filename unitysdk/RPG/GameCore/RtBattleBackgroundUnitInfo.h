...
#define RPG_GAMECORE_RTBATTLEBACKGROUNDUNITINFO_METHOD_2_ECA9BA2E3541CBB1_OFFSET UNITYSDK_OFFSET(0x1B7A9620)
#define RPG_GAMECORE_RTBATTLEBACKGROUNDUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A9890)
