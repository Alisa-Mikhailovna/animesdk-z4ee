...
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT_METHOD_3_79D01DAAE32C5863_OFFSET UNITYSDK_OFFSET(0x1B9A5740)
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT_METHOD_3_BB21DF926805CCB7_OFFSET UNITYSDK_OFFSET(0x1B9A5820)
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A57C0)
