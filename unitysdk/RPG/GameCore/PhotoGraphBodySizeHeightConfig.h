...
#define RPG_GAMECORE_PHOTOGRAPHBODYSIZEHEIGHTCONFIG_METHOD_2_BFEF9988F62FE8D1_OFFSET UNITYSDK_OFFSET(0x1B6A7E50)
#define RPG_GAMECORE_PHOTOGRAPHBODYSIZEHEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A7F60)
