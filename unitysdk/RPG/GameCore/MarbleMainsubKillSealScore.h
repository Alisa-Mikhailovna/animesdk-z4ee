...
#define RPG_GAMECORE_MARBLEMAINSUBKILLSEALSCORE_METHOD_2_98590959E007FD03_OFFSET UNITYSDK_OFFSET(0x1B5B9330)
#define RPG_GAMECORE_MARBLEMAINSUBKILLSEALSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B9490)
