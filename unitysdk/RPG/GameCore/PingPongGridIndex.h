...
#define RPG_GAMECORE_PINGPONGGRIDINDEX_METHOD_2_5323F2DF46A044DA_1_OFFSET UNITYSDK_OFFSET(0x1B6B0E10)
#define RPG_GAMECORE_PINGPONGGRIDINDEX_METHOD_2_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x1B6B0E00)
#define RPG_GAMECORE_PINGPONGGRIDINDEX_METHOD_2_DBC7377967355536_OFFSET UNITYSDK_OFFSET(0x1B6B0C80)
#define RPG_GAMECORE_PINGPONGGRIDINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B0DF0)
