...
#define RPG_GAMECORE_STAGEPVSOFFLINEVOLUMEINFO_METHOD_2_FD7E5B02D054F4F8_OFFSET UNITYSDK_OFFSET(0x1B8FF7E0)
#define RPG_GAMECORE_STAGEPVSOFFLINEVOLUMEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8FF9E0)
