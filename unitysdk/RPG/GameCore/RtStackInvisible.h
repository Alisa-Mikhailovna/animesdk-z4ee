...
#define RPG_GAMECORE_RTSTACKINVISIBLE_METHOD_3_80E1F9A3A7ACE356_OFFSET UNITYSDK_OFFSET(0x1B7C3190)
#define RPG_GAMECORE_RTSTACKINVISIBLE_METHOD_3_81AEC934980BC093_OFFSET UNITYSDK_OFFSET(0x1B7C30C0)
#define RPG_GAMECORE_RTSTACKINVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C3180)
