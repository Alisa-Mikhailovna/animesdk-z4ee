...
#define RPG_GAMECORE_ABILITYLINEARPROPERTYWITHOVERRIDE_GET_EXTRARATIO_OFFSET UNITYSDK_OFFSET(0x155820)
#define RPG_GAMECORE_ABILITYLINEARPROPERTYWITHOVERRIDE_GET_ISOVERRIDE_OFFSET UNITYSDK_OFFSET(0x155830)
#define RPG_GAMECORE_ABILITYLINEARPROPERTYWITHOVERRIDE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x155900)
#define RPG_GAMECORE_ABILITYLINEARPROPERTYWITHOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1557F0)
