...
#define RPG_GAMECORE_BATTLEAREAREFERENCEINFO_METHOD_2_D32310353F5C8363_OFFSET UNITYSDK_OFFSET(0x1B1EF7C0)
#define RPG_GAMECORE_BATTLEAREAREFERENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EF900)
