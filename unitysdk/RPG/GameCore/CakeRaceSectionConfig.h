...
#define RPG_GAMECORE_CAKERACESECTIONCONFIG_METHOD_2_5BA59EAA4EC8185A_OFFSET UNITYSDK_OFFSET(0x1B2FCE20)
#define RPG_GAMECORE_CAKERACESECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FCF10)
