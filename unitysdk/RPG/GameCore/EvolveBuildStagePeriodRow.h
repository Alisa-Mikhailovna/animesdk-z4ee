...
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B3FBC40)
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3FC5E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 WaveCount; // 0x48
		::System::UInt32 StageID; // 0x4C
		::System::UInt32 PeriodScore; // 0x50
