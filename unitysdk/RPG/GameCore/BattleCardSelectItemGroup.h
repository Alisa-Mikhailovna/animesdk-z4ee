...
#define RPG_GAMECORE_BATTLECARDSELECTITEMGROUP_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1F0730)
#define RPG_GAMECORE_BATTLECARDSELECTITEMGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F08D0)
