...
#define RPG_GAMECORE_TREASUREDUNGEONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B98E700)
#define RPG_GAMECORE_TREASUREDUNGEONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B98ECC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 GridPrefabType; // 0x48
		::System::UInt32 GroupID; // 0x4C
		::RPG::Client::TextID Name; // 0x50
		::System::UInt32 MaxExplore; // 0x60
		::System::UInt32 DungeonID; // 0x64
		::System::UInt32 DisplayEventID; // 0x68
		::System::UInt32 GridExploreCost; // 0x6C
		::System::UInt32 UnlockID; // 0x70
		::System::UInt32 PreDungeonID; // 0x74
		::System::UInt32 InitialExplore; // 0x78
		::System::UInt32 ExploreSubHpRatio; // 0x7C
