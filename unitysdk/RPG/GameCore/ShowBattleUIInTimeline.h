...
#define RPG_GAMECORE_SHOWBATTLEUIINTIMELINE_METHOD_3_B07F39A943139095_OFFSET UNITYSDK_OFFSET(0x1B8C86C0)
#define RPG_GAMECORE_SHOWBATTLEUIINTIMELINE_METHOD_3_E87C21688CCBF7B8_OFFSET UNITYSDK_OFFSET(0x1B8C8700)
#define RPG_GAMECORE_SHOWBATTLEUIINTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C86F0)
