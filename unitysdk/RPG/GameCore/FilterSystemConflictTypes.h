...
#define RPG_GAMECORE_FILTERSYSTEMCONFLICTTYPES_METHOD_2_80C909D005B52E27_OFFSET UNITYSDK_OFFSET(0x1B417B80)
#define RPG_GAMECORE_FILTERSYSTEMCONFLICTTYPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B417C40)
