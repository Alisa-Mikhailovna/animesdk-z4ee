...
#define RPG_GAMECORE_MAZEMONSTERALERTCONFIG_METHOD_2_B875C83290658C47_OFFSET UNITYSDK_OFFSET(0x1B5E0710)
#define RPG_GAMECORE_MAZEMONSTERALERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E0A40)
