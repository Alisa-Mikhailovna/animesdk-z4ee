...
#define RPG_GAMECORE_PREFABCACHECONFIG_METHOD_2_105FC9DAB7076BB2_OFFSET UNITYSDK_OFFSET(0x1B6D81D0)
#define RPG_GAMECORE_PREFABCACHECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D82B0)
