...
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B308460)
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B308DB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ChallengeGroupType ChallengeGroupType; // 0x4C
