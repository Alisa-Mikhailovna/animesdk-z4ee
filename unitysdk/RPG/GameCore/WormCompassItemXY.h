...
#define RPG_GAMECORE_WORMCOMPASSITEMXY_METHOD_2_127EA6CDB6955818_OFFSET UNITYSDK_OFFSET(0x1B9FADB0)
#define RPG_GAMECORE_WORMCOMPASSITEMXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9FAF70)
