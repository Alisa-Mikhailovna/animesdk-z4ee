...
#define RPG_GAMECORE_FIXMATRIX3X2_EQUALS_OFFSET UNITYSDK_OFFSET(0x39FB5D0)
#define RPG_GAMECORE_FIXMATRIX3X2_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1BA68410)
#define RPG_GAMECORE_FIXMATRIX3X2_GET_ISIDENTITY_OFFSET UNITYSDK_OFFSET(0x39FB610)
#define RPG_GAMECORE_FIXMATRIX3X2_METHOD_2_A95AF245556BB0A6_OFFSET UNITYSDK_OFFSET(0x1BA68870)
#define RPG_GAMECORE_FIXMATRIX3X2_METHOD_2_E712529611B9063F_OFFSET UNITYSDK_OFFSET(0x1BA68D80)
#define RPG_GAMECORE_FIXMATRIX3X2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BA69880)
#define RPG_GAMECORE_FIXMATRIX3X2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x39FBA10)
#define RPG_GAMECORE_FIXMATRIX3X2__CTOR_OFFSET UNITYSDK_OFFSET(0x2D7D940)
...
namespace RPG::GameCore
{
	...
	struct alignas(8) FixMatrix3x2
	{
		...
		{
			return (::RPG::GameCore::FixMatrix3x2*)Il2CppClass::FromTypeDefinitionIndex(FixMatrix3x2_TypeDefinitionIndex)->GetStaticField(0x8F70);
		}
