...
#define RPG_GAMECORE_WAITFIVEDIMPLAYERENTEROREXIT_METHOD_3_893BF504B2C9D2F8_OFFSET UNITYSDK_OFFSET(0x1B9E5BD0)
#define RPG_GAMECORE_WAITFIVEDIMPLAYERENTEROREXIT_METHOD_3_E46A570BE1C25B86_OFFSET UNITYSDK_OFFSET(0x1B9E5C10)
#define RPG_GAMECORE_WAITFIVEDIMPLAYERENTEROREXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E5C00)
