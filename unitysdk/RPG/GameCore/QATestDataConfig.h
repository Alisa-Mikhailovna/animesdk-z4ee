...
#define RPG_GAMECORE_QATESTDATACONFIG_METHOD_2_577CD6D05F5A8AD8_OFFSET UNITYSDK_OFFSET(0x1B6F6410)
#define RPG_GAMECORE_QATESTDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F6500)
