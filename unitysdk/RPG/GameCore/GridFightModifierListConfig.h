...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLISTCONFIG_METHOD_2_662FE606DEDB3D05_OFFSET UNITYSDK_OFFSET(0x1B4E0650)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0690)
