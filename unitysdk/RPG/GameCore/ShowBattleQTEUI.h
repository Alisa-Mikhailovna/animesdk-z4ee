...
#define RPG_GAMECORE_SHOWBATTLEQTEUI_METHOD_3_8FCEA4907556CB0A_OFFSET UNITYSDK_OFFSET(0x1B8C7C50)
#define RPG_GAMECORE_SHOWBATTLEQTEUI_METHOD_3_D2E6C1926BC054B1_OFFSET UNITYSDK_OFFSET(0x1B8C7C90)
#define RPG_GAMECORE_SHOWBATTLEQTEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C7C80)
