...
#define RPG_GAMECORE_TRIGGERENTERSAFEUI_METHOD_3_6598FE21E0756C17_OFFSET UNITYSDK_OFFSET(0x1B9A2420)
#define RPG_GAMECORE_TRIGGERENTERSAFEUI_METHOD_3_D9C80BF7D247935C_OFFSET UNITYSDK_OFFSET(0x1B9A23D0)
#define RPG_GAMECORE_TRIGGERENTERSAFEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A2410)
