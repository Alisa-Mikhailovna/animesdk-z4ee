...
#define RPG_GAMECORE_MIDDLEMISSIONPACKCONFIG_METHOD_2_8753D99AD8D9AB2B_OFFSET UNITYSDK_OFFSET(0x1B5F8440)
#define RPG_GAMECORE_MIDDLEMISSIONPACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F8560)
