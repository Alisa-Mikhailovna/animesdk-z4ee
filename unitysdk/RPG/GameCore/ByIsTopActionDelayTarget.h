...
#define RPG_GAMECORE_BYISTOPACTIONDELAYTARGET_METHOD_4_54BA36E229EA614B_OFFSET UNITYSDK_OFFSET(0x1B2D2940)
#define RPG_GAMECORE_BYISTOPACTIONDELAYTARGET_METHOD_4_99438FB4E5160C76_OFFSET UNITYSDK_OFFSET(0x1B2D2B70)
#define RPG_GAMECORE_BYISTOPACTIONDELAYTARGET_METHOD_4_D22AD126FEEC1D38_OFFSET UNITYSDK_OFFSET(0x1B2D2B40)
#define RPG_GAMECORE_BYISTOPACTIONDELAYTARGET_METHOD_4_ED16785772BD463A_OFFSET UNITYSDK_OFFSET(0x1B2D2900)
#define RPG_GAMECORE_BYISTOPACTIONDELAYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D2930)
