...
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_336EDAEE54CA4B36_OFFSET UNITYSDK_OFFSET(0x1B7C6C80)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_9B3CAA5943E71BA7_OFFSET UNITYSDK_OFFSET(0x1B7C6BE0)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_EFF85AAD8B422C1C_OFFSET UNITYSDK_OFFSET(0x1B7C6CE0)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_FC24B8A231AA7B58_OFFSET UNITYSDK_OFFSET(0x1B7C6D20)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C6C70)
