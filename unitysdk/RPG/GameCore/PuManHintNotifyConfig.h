...
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG_METHOD_2_73BF97487F0A95BE_OFFSET UNITYSDK_OFFSET(0x1B6F4CC0)
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F4DC0)
