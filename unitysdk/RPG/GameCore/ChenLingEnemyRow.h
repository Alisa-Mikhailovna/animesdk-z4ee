...
#define RPG_GAMECORE_CHENLINGENEMYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B334AD0)
#define RPG_GAMECORE_CHENLINGENEMYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B334FC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint CrtDMGRatio; // 0x20
		...
		::System::Boolean IsPromotion; // 0x50
		::System::UInt32 GridIndex; // 0x54
