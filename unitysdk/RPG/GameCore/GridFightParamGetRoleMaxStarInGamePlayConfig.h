...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLEMAXSTARINGAMEPLAYCONFIG_METHOD_6_5CB323BA1C3DF6B0_OFFSET UNITYSDK_OFFSET(0x1B4E4230)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLEMAXSTARINGAMEPLAYCONFIG_METHOD_6_EBC4CB53C91C1CAC_OFFSET UNITYSDK_OFFSET(0x1B4E4280)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLEMAXSTARINGAMEPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E4270)
