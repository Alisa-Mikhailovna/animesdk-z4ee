...
#define RPG_GAMECORE_LITTLEGAMELEVELVARBINDING_METHOD_2_2493C1A1E7D3293D_OFFSET UNITYSDK_OFFSET(0x1B5882F0)
#define RPG_GAMECORE_LITTLEGAMELEVELVARBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B588520)
