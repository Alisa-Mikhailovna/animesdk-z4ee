...
#define RPG_GAMECORE_GAMEOBJECTPOOLCONFIG_METHOD_2_0D832C8EAE5623F5_OFFSET UNITYSDK_OFFSET(0x1B4C32F0)
#define RPG_GAMECORE_GAMEOBJECTPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C33D0)
