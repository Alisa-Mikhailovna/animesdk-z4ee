...
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_1C5B1D6DE6B6E526_OFFSET UNITYSDK_OFFSET(0x1B8A8700)
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_A0E2B63F93AFBC23_OFFSET UNITYSDK_OFFSET(0x1B8A8630)
#define RPG_GAMECORE_SETLOCALWINFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A86F0)
