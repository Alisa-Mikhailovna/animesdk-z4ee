...
#define RPG_GAMECORE_PROPSPECIALVISIONCONFIG_METHOD_2_8EB957D2710286C8_OFFSET UNITYSDK_OFFSET(0x1B6EFDC0)
#define RPG_GAMECORE_PROPSPECIALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F0010)
