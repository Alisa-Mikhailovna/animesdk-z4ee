...
#define RPG_GAMECORE_DICECOMBATABILITYCONFIG_METHOD_2_68F6CB83963FE692_OFFSET UNITYSDK_OFFSET(0x1B3AAE30)
#define RPG_GAMECORE_DICECOMBATABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3AAF90)
