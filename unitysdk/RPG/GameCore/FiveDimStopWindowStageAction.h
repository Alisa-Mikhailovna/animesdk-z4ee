...
#define RPG_GAMECORE_FIVEDIMSTOPWINDOWSTAGEACTION_METHOD_3_371B0AC2A1C5E5C5_OFFSET UNITYSDK_OFFSET(0x1B44C1B0)
#define RPG_GAMECORE_FIVEDIMSTOPWINDOWSTAGEACTION_METHOD_3_C8C2A75393B0DE00_OFFSET UNITYSDK_OFFSET(0x1B44C230)
#define RPG_GAMECORE_FIVEDIMSTOPWINDOWSTAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44C220)
