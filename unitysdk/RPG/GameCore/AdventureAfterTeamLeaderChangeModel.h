...
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL_CLEAR_OFFSET UNITYSDK_OFFSET(0xD93FE70)
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xD93FEB0)
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD93FF00)
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL_INIT_OFFSET UNITYSDK_OFFSET(0xD93FE30)
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD93FF50)
