...
#define RPG_GAMECORE_AVATARINDEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x39F0F50)
#define RPG_GAMECORE_AVATARINDEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x39C9180)
#define RPG_GAMECORE_AVATARINDEX_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x2D6C700)
#define RPG_GAMECORE_AVATARINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39F93B0)
#define RPG_GAMECORE_AVATARINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x7BDC0)
