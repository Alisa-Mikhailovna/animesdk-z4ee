...
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY_METHOD_3_BAFF0C84B85A6977_OFFSET UNITYSDK_OFFSET(0x1B6DDAF0)
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY_METHOD_3_E0EE6D9C72FA515F_OFFSET UNITYSDK_OFFSET(0x1B6DDB70)
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6DDB40)
