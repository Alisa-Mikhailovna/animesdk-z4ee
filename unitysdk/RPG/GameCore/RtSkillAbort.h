...
#define RPG_GAMECORE_RTSKILLABORT_METHOD_3_F5464CA47C0C26F1_OFFSET UNITYSDK_OFFSET(0x1B7C16B0)
#define RPG_GAMECORE_RTSKILLABORT_METHOD_3_F83638D41561432D_OFFSET UNITYSDK_OFFSET(0x1B7C1750)
#define RPG_GAMECORE_RTSKILLABORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C1710)
