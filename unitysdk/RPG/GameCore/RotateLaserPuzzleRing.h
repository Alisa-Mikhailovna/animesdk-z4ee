...
#define RPG_GAMECORE_ROTATELASERPUZZLERING_METHOD_3_C5DFAD580894F6A9_OFFSET UNITYSDK_OFFSET(0x1B7A6300)
#define RPG_GAMECORE_ROTATELASERPUZZLERING_METHOD_3_E48A1B7F47877FB0_OFFSET UNITYSDK_OFFSET(0x1B7A62C0)
#define RPG_GAMECORE_ROTATELASERPUZZLERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A62F0)
