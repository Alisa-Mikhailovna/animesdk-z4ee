...
#define RPG_GAMECORE_LEVELCURVEINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B5524C0)
#define RPG_GAMECORE_LEVELCURVEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B552480)
#define RPG_GAMECORE_LEVELCURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5524B0)
