...
#define RPG_GAMECORE_RTABILITYCONFIGLIST_METHOD_2_854486A7FE18E820_OFFSET UNITYSDK_OFFSET(0x1B7A6CD0)
#define RPG_GAMECORE_RTABILITYCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A6E80)
