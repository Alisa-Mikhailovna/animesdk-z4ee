...
#define RPG_GAMECORE_GRIDFIGHTORBEXTRABONUSCONFIG_METHOD_2_034344149C20E4F0_OFFSET UNITYSDK_OFFSET(0x1B4E3440)
#define RPG_GAMECORE_GRIDFIGHTORBEXTRABONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E3480)
