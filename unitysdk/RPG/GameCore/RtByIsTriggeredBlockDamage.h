...
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE_METHOD_4_018D60C88AC1DF44_OFFSET UNITYSDK_OFFSET(0x1B7B3430)
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE_METHOD_4_1B0C78932702C627_OFFSET UNITYSDK_OFFSET(0x1B7B32C0)
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE_METHOD_4_99FF7D8DDA83262D_OFFSET UNITYSDK_OFFSET(0x1B7B3400)
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE_METHOD_4_F8383DC8D947B5EC_OFFSET UNITYSDK_OFFSET(0x1B7B3280)
#define RPG_GAMECORE_RTBYISTRIGGEREDBLOCKDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B32B0)
