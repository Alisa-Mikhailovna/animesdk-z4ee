...
#define RPG_GAMECORE_DEVICESETTINGGROUP_METHOD_2_ED1C112F1A61C362_OFFSET UNITYSDK_OFFSET(0x1B3A5D50)
#define RPG_GAMECORE_DEVICESETTINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A5F90)
