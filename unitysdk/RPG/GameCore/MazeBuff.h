...
#define RPG_GAMECORE_MAZEBUFF_METHOD_2_F258D0F13080EFDC_OFFSET UNITYSDK_OFFSET(0x1B5D8E20)
#define RPG_GAMECORE_MAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D8F50)
