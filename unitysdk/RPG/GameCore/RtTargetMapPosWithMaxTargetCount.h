...
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_72128C761A899A2D_OFFSET UNITYSDK_OFFSET(0x1B7C8FD0)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_7DA0426B6A44D003_OFFSET UNITYSDK_OFFSET(0x1B7C9070)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_D24A7A1962274922_OFFSET UNITYSDK_OFFSET(0x1B7C8D20)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_DCB7AEC85F78771A_OFFSET UNITYSDK_OFFSET(0x1B7C8E20)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C8DC0)
