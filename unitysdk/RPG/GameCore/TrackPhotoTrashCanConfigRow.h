...
#define RPG_GAMECORE_TRACKPHOTOTRASHCANCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B97B700)
#define RPG_GAMECORE_TRACKPHOTOTRASHCANCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97BE20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::TrackPhotoCanType CanTypeID; // 0x24
