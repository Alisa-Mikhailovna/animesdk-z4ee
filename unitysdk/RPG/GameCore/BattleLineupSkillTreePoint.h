...
#define RPG_GAMECORE_BATTLELINEUPSKILLTREEPOINT_METHOD_2_848EE3494CD469C0_OFFSET UNITYSDK_OFFSET(0x1B1FD220)
#define RPG_GAMECORE_BATTLELINEUPSKILLTREEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1FD370)
