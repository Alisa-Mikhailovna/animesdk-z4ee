...
#define RPG_GAMECORE_FREESTYLESTATE_METHOD_2_79D5B2EA7C583413_OFFSET UNITYSDK_OFFSET(0x1B4A19C0)
#define RPG_GAMECORE_FREESTYLESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A1BD0)
