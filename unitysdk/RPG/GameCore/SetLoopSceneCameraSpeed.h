...
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED_METHOD_3_0E897A5C1585F0D9_OFFSET UNITYSDK_OFFSET(0x1B8A8C30)
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED_METHOD_3_C671CCD5A698A68E_OFFSET UNITYSDK_OFFSET(0x1B8A8C70)
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A8C60)
