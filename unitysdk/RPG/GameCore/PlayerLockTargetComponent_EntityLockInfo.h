...
#define RPG_GAMECORE_PLAYERLOCKTARGETCOMPONENT_ENTITYLOCKINFO_INIT_OFFSET UNITYSDK_OFFSET(0x155D10)
#define RPG_GAMECORE_PLAYERLOCKTARGETCOMPONENT_ENTITYLOCKINFO_SETSCORE_OFFSET UNITYSDK_OFFSET(0x155DD0)
#define RPG_GAMECORE_PLAYERLOCKTARGETCOMPONENT_ENTITYLOCKINFO_UNIONSTATE_OFFSET UNITYSDK_OFFSET(0x155E30)
