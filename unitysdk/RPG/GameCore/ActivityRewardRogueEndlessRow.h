...
#define RPG_GAMECORE_ACTIVITYREWARDROGUEENDLESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B131F30)
#define RPG_GAMECORE_ACTIVITYREWARDROGUEENDLESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B132570)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RewardLevel; // 0x2C
