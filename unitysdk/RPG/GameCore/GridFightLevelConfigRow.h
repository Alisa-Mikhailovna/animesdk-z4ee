...
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_CLEARWEIGHTLIST_OFFSET UNITYSDK_OFFSET(0x1B4DDE60)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4DD940)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_GETLOTTERYRARITYWEIGHTLIST_OFFSET UNITYSDK_OFFSET(0x1B4DDCE0)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DDC80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 GridFightLevel; // 0x28
		::System::UInt32 LevelUpExp; // 0x2C
		::System::UInt32 AvatarMaxNumber; // 0x30
		::System::UInt32 Rarity5Weight; // 0x34
