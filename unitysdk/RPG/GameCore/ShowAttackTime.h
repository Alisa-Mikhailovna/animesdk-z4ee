...
#define RPG_GAMECORE_SHOWATTACKTIME_METHOD_3_0D55A05F6FF14F27_OFFSET UNITYSDK_OFFSET(0x1B8C6500)
#define RPG_GAMECORE_SHOWATTACKTIME_METHOD_3_CC98F3A758BFD9D7_OFFSET UNITYSDK_OFFSET(0x1B8C6540)
#define RPG_GAMECORE_SHOWATTACKTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C6530)
