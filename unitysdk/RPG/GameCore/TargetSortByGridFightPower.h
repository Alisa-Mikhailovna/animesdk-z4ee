...
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTPOWER_METHOD_3_5C01214E3FBE39E0_OFFSET UNITYSDK_OFFSET(0x1B95C460)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTPOWER_METHOD_3_9E0586056D3A677C_OFFSET UNITYSDK_OFFSET(0x1B95C350)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTPOWER_METHOD_3_9E4B091EE7B7F8B0_OFFSET UNITYSDK_OFFSET(0x1B95C240)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTPOWER_METHOD_3_CF6C3B0C17636C00_OFFSET UNITYSDK_OFFSET(0x1B95C410)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTPOWER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B95C340)
