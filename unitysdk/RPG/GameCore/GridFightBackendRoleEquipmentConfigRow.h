...
#define RPG_GAMECORE_GRIDFIGHTBACKENDROLEEQUIPMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4D26F0)
#define RPG_GAMECORE_GRIDFIGHTBACKENDROLEEQUIPMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D2A30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 EquipmentID; // 0x34
