...
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL_CLEAR_OFFSET UNITYSDK_OFFSET(0xD940330)
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xD940370)
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD9403C0)
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL_INIT_OFFSET UNITYSDK_OFFSET(0xD9402F0)
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD940410)
