...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSUBTOASTHINTPARAM_METHOD_2_DF41C104E8E458E4_OFFSET UNITYSDK_OFFSET(0x1B4E6260)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSUBTOASTHINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E6B30)
