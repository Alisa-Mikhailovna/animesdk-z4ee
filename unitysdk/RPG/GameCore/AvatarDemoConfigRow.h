...
#define RPG_GAMECORE_AVATARDEMOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1C0C40)
#define RPG_GAMECORE_AVATARDEMOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C1870)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* SPList; // 0x30
		::Il2CppArray<::System::UInt32>* EventIDList1; // 0x38
		::Il2CppArray<::System::String*>* OverrideDisplaySkillTriggerKeyList; // 0x40
		::RPG::Client::TextID AvatarDemoTitle; // 0x48
		::System::UInt32 ScoringGroupID; // 0x58
		::System::UInt32 MazeGroupID1; // 0x5C
		...
		::RPG::GameCore::AvatarDemoStageType StageType; // 0x80
		::System::UInt32 GuideGroupID; // 0x84
		::System::UInt32 StageID; // 0x88
		::System::UInt32 MapEntranceID; // 0x8C
		::System::Boolean EnableSwitchAvatar; // 0x90
		::System::Boolean EnableMazeSkillEffect; // 0x91
		::System::Boolean NormalWaveNotShowDetail; // 0x92
