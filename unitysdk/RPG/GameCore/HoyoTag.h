...
#define RPG_GAMECORE_HOYOTAG_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B51C400)
#define RPG_GAMECORE_HOYOTAG_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B51C3A0)
#define RPG_GAMECORE_HOYOTAG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B51C4B0)
#define RPG_GAMECORE_HOYOTAG_METHOD_2_6A562E01650ACF04_OFFSET UNITYSDK_OFFSET(0x1B51BFC0)
#define RPG_GAMECORE_HOYOTAG_METHOD_2_9483972E6B019F86_OFFSET UNITYSDK_OFFSET(0x1B51C0F0)
#define RPG_GAMECORE_HOYOTAG_METHOD_2_A41B39264FED25E2_OFFSET UNITYSDK_OFFSET(0x1B51C4C0)
#define RPG_GAMECORE_HOYOTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51C0E0)
