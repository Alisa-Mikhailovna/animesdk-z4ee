...
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_CLEAR_OFFSET UNITYSDK_OFFSET(0xD93FD10)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xD93FD60)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD93FDB0)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_GET_LEADERENTITY_OFFSET UNITYSDK_OFFSET(0xD93FE00)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_INIT_OFFSET UNITYSDK_OFFSET(0xD93FCC0)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_SET_LEADERENTITY_OFFSET UNITYSDK_OFFSET(0xD93FE10)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xD93FE20)
