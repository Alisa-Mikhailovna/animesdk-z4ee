...
#define RPG_GAMECORE_FIVEDIMTELEPORTACTION_METHOD_3_2D8E1775A12540C8_OFFSET UNITYSDK_OFFSET(0x1B44DA20)
#define RPG_GAMECORE_FIVEDIMTELEPORTACTION_METHOD_3_D3E5C2A0F623BEB3_OFFSET UNITYSDK_OFFSET(0x1B44DA60)
#define RPG_GAMECORE_FIVEDIMTELEPORTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44DA50)
