...
#define RPG_GAMECORE_FIVEDIMCAMERALENSCONFIG_METHOD_2_F35648C0B8A6D68A_OFFSET UNITYSDK_OFFSET(0x1B422240)
#define RPG_GAMECORE_FIVEDIMCAMERALENSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4241B0)
