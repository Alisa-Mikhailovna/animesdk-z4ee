...
#define RPG_GAMECORE_CHANGEMONSTERUIDISPLAY_METHOD_4_68AD134DF2A6BC52_OFFSET UNITYSDK_OFFSET(0x1B3107A0)
#define RPG_GAMECORE_CHANGEMONSTERUIDISPLAY_METHOD_4_F61B8E1C405AFC2E_OFFSET UNITYSDK_OFFSET(0x1B311C90)
#define RPG_GAMECORE_CHANGEMONSTERUIDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B310760)
