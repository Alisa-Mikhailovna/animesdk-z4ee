...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONBUYEXPCONFIG_METHOD_3_02BE446FEB437B6E_OFFSET UNITYSDK_OFFSET(0x1B4DFCF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONBUYEXPCONFIG_METHOD_3_070A6C5B98A09B2A_OFFSET UNITYSDK_OFFSET(0x1B4DFD40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONBUYEXPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DFD30)
