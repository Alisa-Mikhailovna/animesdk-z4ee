...
#define RPG_GAMECORE_ROGUEMANAGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B76F950)
#define RPG_GAMECORE_ROGUEMANAGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B770050)
