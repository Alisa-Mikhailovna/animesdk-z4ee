...
#define RPG_GAMECORE_BATTLEPLAYTALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B2023E0)
#define RPG_GAMECORE_BATTLEPLAYTALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2023A0)
#define RPG_GAMECORE_BATTLEPLAYTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2023D0)
