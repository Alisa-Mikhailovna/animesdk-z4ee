...
#define RPG_GAMECORE_SETLUAACTIONQUEUEPAUSE_METHOD_3_84638D22C4268AC6_OFFSET UNITYSDK_OFFSET(0x1B8A8DD0)
#define RPG_GAMECORE_SETLUAACTIONQUEUEPAUSE_METHOD_3_9A4F4D5EEC078F85_OFFSET UNITYSDK_OFFSET(0x1B8A8E20)
#define RPG_GAMECORE_SETLUAACTIONQUEUEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A8E10)
