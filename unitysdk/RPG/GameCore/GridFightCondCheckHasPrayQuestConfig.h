...
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASPRAYQUESTCONFIG_METHOD_6_D81EC5DBFC13886A_OFFSET UNITYSDK_OFFSET(0x1B4D3A10)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASPRAYQUESTCONFIG_METHOD_6_E4D7030791B2E2C6_OFFSET UNITYSDK_OFFSET(0x1B4D3A60)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASPRAYQUESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D3A50)
