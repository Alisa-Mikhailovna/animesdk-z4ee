...
#define RPG_GAMECORE_DEPLOYPUZZLEFINISHED_METHOD_3_0D0F76003D3EF667_OFFSET UNITYSDK_OFFSET(0x1B3A1A50)
#define RPG_GAMECORE_DEPLOYPUZZLEFINISHED_METHOD_3_6BBF26340C6C5E9F_OFFSET UNITYSDK_OFFSET(0x1B3A19D0)
#define RPG_GAMECORE_DEPLOYPUZZLEFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A1A20)
