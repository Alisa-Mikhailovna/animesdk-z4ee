...
#define RPG_GAMECORE_ADVENTURENPCMONSTERWEAKNESSHELP_ADDGLOBALWEAKNESS_1_OFFSET UNITYSDK_OFFSET(0xD96F3A0)
#define RPG_GAMECORE_ADVENTURENPCMONSTERWEAKNESSHELP_ADDGLOBALWEAKNESS_OFFSET UNITYSDK_OFFSET(0xD96F250)
#define RPG_GAMECORE_ADVENTURENPCMONSTERWEAKNESSHELP_CHECKHASGLOBALWEAKNESS_1_OFFSET UNITYSDK_OFFSET(0xD96F620)
#define RPG_GAMECORE_ADVENTURENPCMONSTERWEAKNESSHELP_CHECKHASGLOBALWEAKNESS_OFFSET UNITYSDK_OFFSET(0xD96F5C0)
#define RPG_GAMECORE_ADVENTURENPCMONSTERWEAKNESSHELP_GETGLOBALWEAKNESSLIST_OFFSET UNITYSDK_OFFSET(0xD96F2B0)
#define RPG_GAMECORE_ADVENTURENPCMONSTERWEAKNESSHELP_GETWEAKNESSFORBATTLEMONSTER_OFFSET UNITYSDK_OFFSET(0xD96F140)
