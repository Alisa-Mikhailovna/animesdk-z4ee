...
#define RPG_GAMECORE_TRAINPARTYAREACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B97D2C0)
#define RPG_GAMECORE_TRAINPARTYAREACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97D690)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RequireAreaID; // 0x3C
