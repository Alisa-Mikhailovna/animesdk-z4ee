...
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO_METHOD_3_99F28BDF3260B2A3_OFFSET UNITYSDK_OFFSET(0x1B6E0BA0)
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO_METHOD_3_AEAC275D27100814_OFFSET UNITYSDK_OFFSET(0x1B6E0C60)
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E0C10)
