...
#define RPG_GAMECORE_PERFORMANCERECALLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B699340)
#define RPG_GAMECORE_PERFORMANCERECALLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B69AC60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean isVideo; // 0x38
		::System::Boolean ShowInPlayerRoom; // 0x39
		...
		::System::UInt32 ImgHeightSize; // 0x60
