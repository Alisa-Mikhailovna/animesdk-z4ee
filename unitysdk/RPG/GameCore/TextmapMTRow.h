...
#define RPG_GAMECORE_TEXTMAPMTROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B96F510)
#define RPG_GAMECORE_TEXTMAPMTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B96F6D0)
#define RPG_GAMECORE_TEXTMAPMTROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B96F8D0)
#define RPG_GAMECORE_TEXTMAPMTROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B96F930)
#define RPG_GAMECORE_TEXTMAPMTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B96F8C0)
