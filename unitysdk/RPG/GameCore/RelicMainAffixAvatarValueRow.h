...
#define RPG_GAMECORE_RELICMAINAFFIXAVATARVALUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B7158A0)
#define RPG_GAMECORE_RELICMAINAFFIXAVATARVALUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B716140)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single DamageAddedRatio; // 0x30
		::System::Single Attack; // 0x34
