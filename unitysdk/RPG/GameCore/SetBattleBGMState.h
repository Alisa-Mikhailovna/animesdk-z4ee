...
#define RPG_GAMECORE_SETBATTLEBGMSTATE_METHOD_3_0AEDD7381191F0A9_OFFSET UNITYSDK_OFFSET(0x1B886C70)
#define RPG_GAMECORE_SETBATTLEBGMSTATE_METHOD_3_5DC462D52124F97C_OFFSET UNITYSDK_OFFSET(0x1B886C30)
#define RPG_GAMECORE_SETBATTLEBGMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B886C60)
