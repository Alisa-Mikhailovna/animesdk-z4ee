...
#define RPG_GAMECORE_STAGEPVSOFFLINELIGHTINFO_METHOD_2_9FF3D63697DFE5CA_OFFSET UNITYSDK_OFFSET(0x1B8FECB0)
#define RPG_GAMECORE_STAGEPVSOFFLINELIGHTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8FEE10)
