...
#define RPG_GAMECORE_ROGUECHESTMAPCONFIG_METHOD_2_857192509F1C804E_OFFSET UNITYSDK_OFFSET(0x1B747150)
#define RPG_GAMECORE_ROGUECHESTMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B747480)
