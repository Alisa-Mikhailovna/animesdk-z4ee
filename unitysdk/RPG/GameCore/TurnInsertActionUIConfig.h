...
#define RPG_GAMECORE_TURNINSERTACTIONUICONFIG_METHOD_2_4A5664FDA4CBB716_OFFSET UNITYSDK_OFFSET(0x1B9B4120)
#define RPG_GAMECORE_TURNINSERTACTIONUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B4240)
