...
#define RPG_GAMECORE_CHARACTEROUTFITPENDANTCONFIG_METHOD_2_0F5BF20D7D4ECDED_OFFSET UNITYSDK_OFFSET(0x1B31DD10)
#define RPG_GAMECORE_CHARACTEROUTFITPENDANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B31DDD0)
