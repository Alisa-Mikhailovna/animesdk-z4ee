...
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_2559A1CB8765FAE0_OFFSET UNITYSDK_OFFSET(0x1B8A84D0)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_B1762C3CECB85ECF_OFFSET UNITYSDK_OFFSET(0x1B8A8490)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A84C0)
