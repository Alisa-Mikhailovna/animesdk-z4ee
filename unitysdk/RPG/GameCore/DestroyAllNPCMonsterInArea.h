...
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA_METHOD_3_19FF8E10A67F34F9_OFFSET UNITYSDK_OFFSET(0x1B3A1E50)
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA_METHOD_3_5F2353BA163B9002_OFFSET UNITYSDK_OFFSET(0x1B3A1E90)
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A1E80)
