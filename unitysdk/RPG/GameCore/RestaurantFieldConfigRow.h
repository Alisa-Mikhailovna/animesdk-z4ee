...
#define RPG_GAMECORE_RESTAURANTFIELDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B729080)
#define RPG_GAMECORE_RESTAURANTFIELDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B729360)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* PropGroupIDList; // 0x30
