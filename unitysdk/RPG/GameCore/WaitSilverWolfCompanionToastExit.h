...
#define RPG_GAMECORE_WAITSILVERWOLFCOMPANIONTOASTEXIT_METHOD_3_60F98438159B785E_OFFSET UNITYSDK_OFFSET(0x1B9EFA10)
#define RPG_GAMECORE_WAITSILVERWOLFCOMPANIONTOASTEXIT_METHOD_3_9C4ED2C36C9BD2A3_OFFSET UNITYSDK_OFFSET(0x1B9EF9D0)
#define RPG_GAMECORE_WAITSILVERWOLFCOMPANIONTOASTEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EFA00)
