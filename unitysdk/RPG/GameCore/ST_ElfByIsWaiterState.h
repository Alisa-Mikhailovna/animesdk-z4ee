...
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_0F3778604904073B_OFFSET UNITYSDK_OFFSET(0x1B7D93E0)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_2C61F44F427D0A8D_OFFSET UNITYSDK_OFFSET(0x1B7D91F0)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_7F3F10AFFD20B294_OFFSET UNITYSDK_OFFSET(0x1B7D9410)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_D24C3C4AB5A0C4D8_OFFSET UNITYSDK_OFFSET(0x1B7D9230)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D9220)
