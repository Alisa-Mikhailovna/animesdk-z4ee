...
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTCLEARLEVELATTRIBUTEANDGETCOINCONFIG_METHOD_7_9B79C5FD52A101C2_OFFSET UNITYSDK_OFFSET(0x1B735780)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTCLEARLEVELATTRIBUTEANDGETCOINCONFIG_METHOD_7_BDC3EB5B8ED80ADE_OFFSET UNITYSDK_OFFSET(0x1B7357D0)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTCLEARLEVELATTRIBUTEANDGETCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7357C0)
