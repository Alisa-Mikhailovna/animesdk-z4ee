...
#define RPG_GAMECORE_SHOWTUTORIALGUIDE_METHOD_3_A788721232A8A5EE_OFFSET UNITYSDK_OFFSET(0x1B8D5E00)
#define RPG_GAMECORE_SHOWTUTORIALGUIDE_METHOD_3_E971ED3AAF37953F_OFFSET UNITYSDK_OFFSET(0x1B8D5E40)
#define RPG_GAMECORE_SHOWTUTORIALGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D5E30)
