...
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY_METHOD_3_1B3D6813F610FBEC_OFFSET UNITYSDK_OFFSET(0x1B7C6E80)
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY_METHOD_3_8F7983D1B8F6AC95_OFFSET UNITYSDK_OFFSET(0x1B7C72D0)
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY_METHOD_3_AFBF36ED30D88222_OFFSET UNITYSDK_OFFSET(0x1B7C6FC0)
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY_METHOD_3_B58D08B8E1F9A5FE_OFFSET UNITYSDK_OFFSET(0x1B7C7220)
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C6F30)
