...
#define RPG_GAMECORE_PHOTOGRAPHSTEALCONFIG_METHOD_2_4F6517BBFF4D83D1_OFFSET UNITYSDK_OFFSET(0x1B6ABB20)
#define RPG_GAMECORE_PHOTOGRAPHSTEALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AC6D0)
