...
#define RPG_GAMECORE_GRIDFIGHTACTIONREMOVEROLECONFIG_METHOD_6_4FF21F4FF0228716_OFFSET UNITYSDK_OFFSET(0x1B4D0480)
#define RPG_GAMECORE_GRIDFIGHTACTIONREMOVEROLECONFIG_METHOD_6_BB2905FE449FD0BA_OFFSET UNITYSDK_OFFSET(0x1B4D0840)
#define RPG_GAMECORE_GRIDFIGHTACTIONREMOVEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D0470)
