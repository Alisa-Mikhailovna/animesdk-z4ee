...
#define RPG_GAMECORE_ANIMATORSTATEZONEDESCCONFIG_METHOD_2_F98115BD32FC648F_OFFSET UNITYSDK_OFFSET(0x1B1A7600)
#define RPG_GAMECORE_ANIMATORSTATEZONEDESCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A7770)
