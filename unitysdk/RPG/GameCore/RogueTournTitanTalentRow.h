...
#define RPG_GAMECORE_ROGUETOURNTITANTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B7A0660)
#define RPG_GAMECORE_ROGUETOURNTITANTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A0AE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID ActTitle; // 0x38
		::RPG::Client::TextID TalentDesc; // 0x48
