...
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_4FF1D693A26A4C37_OFFSET UNITYSDK_OFFSET(0x1B2C4B10)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_9E98F447CC501E98_OFFSET UNITYSDK_OFFSET(0x1B2C4950)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_B79555B827DA387D_OFFSET UNITYSDK_OFFSET(0x1B2C4990)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_F3A3FF2FEF194640_OFFSET UNITYSDK_OFFSET(0x1B2C4B40)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C4980)
