...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ATTACKERCOMPAREDEFENDER_METHOD_4_31ABDD56A5992356_OFFSET UNITYSDK_OFFSET(0x1B3B0F70)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ATTACKERCOMPAREDEFENDER_METHOD_4_CA2213C8D799751F_OFFSET UNITYSDK_OFFSET(0x1B3B4AA0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ATTACKERCOMPAREDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B0F60)
