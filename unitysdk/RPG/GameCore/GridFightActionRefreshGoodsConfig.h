...
#define RPG_GAMECORE_GRIDFIGHTACTIONREFRESHGOODSCONFIG_METHOD_6_B5B19DD046443715_OFFSET UNITYSDK_OFFSET(0x1B4D0440)
#define RPG_GAMECORE_GRIDFIGHTACTIONREFRESHGOODSCONFIG_METHOD_6_D25E25F7EA5C3CF1_OFFSET UNITYSDK_OFFSET(0x1B4D07C0)
#define RPG_GAMECORE_GRIDFIGHTACTIONREFRESHGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D0430)
