...
#define RPG_GAMECORE_DICECOMBATSKILLCONFIG_METHOD_2_F08447824247E7E9_OFFSET UNITYSDK_OFFSET(0x1B3B5BF0)
#define RPG_GAMECORE_DICECOMBATSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B5E00)
