...
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_2948C2F0CE2F8118_OFFSET UNITYSDK_OFFSET(0x1B2D87F0)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_A929381BFF99FAAB_OFFSET UNITYSDK_OFFSET(0x1B2D8830)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_CEB0421A8D563B88_OFFSET UNITYSDK_OFFSET(0x1B2D89A0)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_EBC748AEE7E52451_OFFSET UNITYSDK_OFFSET(0x1B2D8970)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D8820)
