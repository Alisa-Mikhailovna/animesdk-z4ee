...
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDAD7A70)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_ENDLEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xDAD8050)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_FINISHIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xDAD7F80)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_GET_DEFAULTAREANAME_OFFSET UNITYSDK_OFFSET(0xDAD80F0)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_GET_LEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xDAD80E0)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_INITCOMPONENT_1_OFFSET UNITYSDK_OFFSET(0xDAD77A0)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0xDAD7580)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_ISBELONGTOSTANDALONEPERFORMANCEENV_OFFSET UNITYSDK_OFFSET(0xDAD7900)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_ISLEVELGRAPHEXECUTING_OFFSET UNITYSDK_OFFSET(0xDAD7E80)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_ISLEVELGRAPHFINISH_OFFSET UNITYSDK_OFFSET(0xDAD7F00)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_ISPERFORMANCELEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xDAD78A0)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_MARKLEVELGRAPHFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xDAD7FD0)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_ONMODELROOTLOADED_OFFSET UNITYSDK_OFFSET(0xDAD79E0)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_ONMODELROOTUNLOADED_OFFSET UNITYSDK_OFFSET(0xDAD7A30)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_ONWILLBEDESTROY_OFFSET UNITYSDK_OFFSET(0xDAD7C30)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0xDAD8110)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_RESTARTLEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xDAD7CC0)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_SETGRAPHENDCALLBACK_OFFSET UNITYSDK_OFFSET(0xDAD7D70)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_SET_DEFAULTAREANAME_OFFSET UNITYSDK_OFFSET(0xDAD8100)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_SHOULDBLOCKTASKBYSTANDALONEPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xDAD76F0)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_STARTLEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xDAD7C70)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_STARTSUBLEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xDAD5F30)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_STOPSUBLEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xDAD6E10)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT_TICK_OFFSET UNITYSDK_OFFSET(0xDAD7E10)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xDAD8230)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT__DISPOSESUBGRAPHS_OFFSET UNITYSDK_OFFSET(0xDAD7010)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT__INITSUBGRAPHS_OFFSET UNITYSDK_OFFSET(0xDAD7220)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT__ONSUBLEVELGRAPHEND_OFFSET UNITYSDK_OFFSET(0xDAD6F80)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT__REMOVEFINISHEDSUBGRAPHS_OFFSET UNITYSDK_OFFSET(0xDAD7370)
#define RPG_GAMECORE_LEVELGRAPHCOMPONENT__RESETSUBGRAPHS_OFFSET UNITYSDK_OFFSET(0xDAD7060)
