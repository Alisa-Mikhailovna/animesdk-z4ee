...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETITEMNUMCONFIG_METHOD_6_113EAC5353D28D44_OFFSET UNITYSDK_OFFSET(0x1B4E3C20)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETITEMNUMCONFIG_METHOD_6_D3485D00FA7DB988_OFFSET UNITYSDK_OFFSET(0x1B4E3BD0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETITEMNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E3C10)
