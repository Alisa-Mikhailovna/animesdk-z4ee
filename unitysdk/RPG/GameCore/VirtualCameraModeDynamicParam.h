...
#define RPG_GAMECORE_VIRTUALCAMERAMODEDYNAMICPARAM_METHOD_2_FA4D32DA7B0108D7_OFFSET UNITYSDK_OFFSET(0x1B9DE5C0)
#define RPG_GAMECORE_VIRTUALCAMERAMODEDYNAMICPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9DE6D0)
