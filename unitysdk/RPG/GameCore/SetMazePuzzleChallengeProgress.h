...
#define RPG_GAMECORE_SETMAZEPUZZLECHALLENGEPROGRESS_METHOD_3_6270F8A0D8B29C30_OFFSET UNITYSDK_OFFSET(0x1B8A92E0)
#define RPG_GAMECORE_SETMAZEPUZZLECHALLENGEPROGRESS_METHOD_3_B91866F18E913CC9_OFFSET UNITYSDK_OFFSET(0x1B8A9340)
#define RPG_GAMECORE_SETMAZEPUZZLECHALLENGEPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A9320)
