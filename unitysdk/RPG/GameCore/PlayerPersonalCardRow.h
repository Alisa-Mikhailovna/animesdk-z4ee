...
#define RPG_GAMECORE_PLAYERPERSONALCARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6CFA30)
#define RPG_GAMECORE_PLAYERPERSONALCARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CFCF0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* ReplaceIconPath; // 0x10
