...
#define RPG_GAMECORE_RTBEHAVIORFLAGLIST_METHOD_2_5BCE7C12CA2A7F73_OFFSET UNITYSDK_OFFSET(0x1B7ADF00)
#define RPG_GAMECORE_RTBEHAVIORFLAGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7ADFC0)
