...
#define RPG_GAMECORE_SETTIMELINEENTITYSTATE_METHOD_3_887DD9289E15961D_OFFSET UNITYSDK_OFFSET(0x1B8B7DF0)
#define RPG_GAMECORE_SETTIMELINEENTITYSTATE_METHOD_3_9C2D3C534837FEDC_OFFSET UNITYSDK_OFFSET(0x1B8B7E40)
#define RPG_GAMECORE_SETTIMELINEENTITYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B7E30)
