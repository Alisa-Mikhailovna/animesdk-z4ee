...
#define RPG_GAMECORE_RTDEFENCESTAGEBORNPOINTINFO_METHOD_2_07EDF8A6223F5A95_OFFSET UNITYSDK_OFFSET(0x1B7B9B20)
#define RPG_GAMECORE_RTDEFENCESTAGEBORNPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B9C70)
