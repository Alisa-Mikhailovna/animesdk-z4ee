...
#define RPG_GAMECORE_ITEMCOMEFROMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B539980)
#define RPG_GAMECORE_ITEMCOMEFROMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B53B8C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ComefromID; // 0x30
		::System::Boolean EnableMissionTrack; // 0x34
