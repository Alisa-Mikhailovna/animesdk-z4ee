...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUNLOCKROLECONFIG_METHOD_3_B1119BFE93F5FE72_OFFSET UNITYSDK_OFFSET(0x1B4E1A10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUNLOCKROLECONFIG_METHOD_3_CB94255503E58896_OFFSET UNITYSDK_OFFSET(0x1B4E19C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUNLOCKROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E1A00)
