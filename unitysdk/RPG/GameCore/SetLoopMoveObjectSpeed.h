...
#define RPG_GAMECORE_SETLOOPMOVEOBJECTSPEED_METHOD_3_4EFFADDB8C10EA08_OFFSET UNITYSDK_OFFSET(0x1B8A87C0)
#define RPG_GAMECORE_SETLOOPMOVEOBJECTSPEED_METHOD_3_D8BAC9E2F2A2E73D_OFFSET UNITYSDK_OFFSET(0x1B8A8800)
#define RPG_GAMECORE_SETLOOPMOVEOBJECTSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A87F0)
