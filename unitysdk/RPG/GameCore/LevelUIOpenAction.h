...
#define RPG_GAMECORE_LEVELUIOPENACTION_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDAE5370)
#define RPG_GAMECORE_LEVELUIOPENACTION_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDAE53C0)
#define RPG_GAMECORE_LEVELUIOPENACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xDAE5410)
