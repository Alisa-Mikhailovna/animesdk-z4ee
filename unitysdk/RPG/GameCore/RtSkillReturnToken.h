...
#define RPG_GAMECORE_RTSKILLRETURNTOKEN_METHOD_3_482FD4EAD1B2CB0F_OFFSET UNITYSDK_OFFSET(0x1B7C2A50)
#define RPG_GAMECORE_RTSKILLRETURNTOKEN_METHOD_3_A47A0D2F14D26934_OFFSET UNITYSDK_OFFSET(0x1B7C2A10)
#define RPG_GAMECORE_RTSKILLRETURNTOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C2A40)
