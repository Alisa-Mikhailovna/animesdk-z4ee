...
#define RPG_GAMECORE_BYISINELATIONTIME_METHOD_4_1C96D6F3A6211299_OFFSET UNITYSDK_OFFSET(0x1B2C4490)
#define RPG_GAMECORE_BYISINELATIONTIME_METHOD_4_721BF12B1EA14222_OFFSET UNITYSDK_OFFSET(0x1B2C44D0)
#define RPG_GAMECORE_BYISINELATIONTIME_METHOD_4_89A4DB90A0A4155C_OFFSET UNITYSDK_OFFSET(0x1B2C4610)
#define RPG_GAMECORE_BYISINELATIONTIME_METHOD_4_C9C8DD9CA405651D_OFFSET UNITYSDK_OFFSET(0x1B2C4640)
#define RPG_GAMECORE_BYISINELATIONTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C44C0)
