...
#define RPG_GAMECORE_TRACKNPCZONECONFIG_METHOD_2_30D414AA1C03A2B1_OFFSET UNITYSDK_OFFSET(0x1B97A360)
#define RPG_GAMECORE_TRACKNPCZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97A4C0)
