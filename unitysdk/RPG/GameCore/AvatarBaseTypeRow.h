...
#define RPG_GAMECORE_AVATARBASETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1BF070)
#define RPG_GAMECORE_AVATARBASETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1BF950)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* LightConeCardBackImagePath; // 0x40
