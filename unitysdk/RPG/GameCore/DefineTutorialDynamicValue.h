...
#define RPG_GAMECORE_DEFINETUTORIALDYNAMICVALUE_METHOD_3_2AB18711B8063E72_OFFSET UNITYSDK_OFFSET(0x1B3A0A10)
#define RPG_GAMECORE_DEFINETUTORIALDYNAMICVALUE_METHOD_3_F830846EFD84CC25_OFFSET UNITYSDK_OFFSET(0x1B3A0A50)
#define RPG_GAMECORE_DEFINETUTORIALDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A0A40)
