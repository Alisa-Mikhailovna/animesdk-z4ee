...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLASTNODETYPECONFIG_METHOD_6_196DFB9C4DCD293F_OFFSET UNITYSDK_OFFSET(0x1B4E3C90)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLASTNODETYPECONFIG_METHOD_6_7A91878186EE9543_OFFSET UNITYSDK_OFFSET(0x1B4E3CE0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLASTNODETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E3CD0)
