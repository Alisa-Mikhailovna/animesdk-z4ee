...
#define RPG_GAMECORE_LEVELENTITYTEAMLISTSTATECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDAD3A00)
#define RPG_GAMECORE_LEVELENTITYTEAMLISTSTATECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDAD39B0)
#define RPG_GAMECORE_LEVELENTITYTEAMLISTSTATECHANGE_GET_ISINTEAM_OFFSET UNITYSDK_OFFSET(0xDAD3A70)
#define RPG_GAMECORE_LEVELENTITYTEAMLISTSTATECHANGE_GET_SOURCEENTITY_OFFSET UNITYSDK_OFFSET(0xDAD3A50)
#define RPG_GAMECORE_LEVELENTITYTEAMLISTSTATECHANGE_GET_TEAM_OFFSET UNITYSDK_OFFSET(0xDAD3A60)
#define RPG_GAMECORE_LEVELENTITYTEAMLISTSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xDAD39A0)
