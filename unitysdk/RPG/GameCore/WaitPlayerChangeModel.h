...
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL_METHOD_3_4DEF5312DED279DC_OFFSET UNITYSDK_OFFSET(0x1B9EBE80)
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL_METHOD_3_D9C0453CED005297_OFFSET UNITYSDK_OFFSET(0x1B9EBEC0)
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EBEB0)
