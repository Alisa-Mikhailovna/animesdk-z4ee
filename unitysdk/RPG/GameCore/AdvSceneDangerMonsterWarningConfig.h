...
#define RPG_GAMECORE_ADVSCENEDANGERMONSTERWARNINGCONFIG_METHOD_2_F8B0C6D9183201D4_OFFSET UNITYSDK_OFFSET(0x1B1601D0)
#define RPG_GAMECORE_ADVSCENEDANGERMONSTERWARNINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1603D0)
