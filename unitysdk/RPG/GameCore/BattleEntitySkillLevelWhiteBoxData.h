...
#define RPG_GAMECORE_BATTLEENTITYSKILLLEVELWHITEBOXDATA_METHOD_2_6625D0844F1997B9_OFFSET UNITYSDK_OFFSET(0x1B1F4120)
#define RPG_GAMECORE_BATTLEENTITYSKILLLEVELWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F4280)
