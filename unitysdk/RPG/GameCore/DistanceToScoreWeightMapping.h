...
#define RPG_GAMECORE_DISTANCETOSCOREWEIGHTMAPPING_METHOD_2_56E783EDC45E71CF_OFFSET UNITYSDK_OFFSET(0x1B3BD880)
#define RPG_GAMECORE_DISTANCETOSCOREWEIGHTMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3BD940)
