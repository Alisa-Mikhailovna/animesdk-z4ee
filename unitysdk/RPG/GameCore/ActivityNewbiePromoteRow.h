...
#define RPG_GAMECORE_ACTIVITYNEWBIEPROMOTEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B121D20)
#define RPG_GAMECORE_ACTIVITYNEWBIEPROMOTEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1223B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DisplayItem; // 0x2C
