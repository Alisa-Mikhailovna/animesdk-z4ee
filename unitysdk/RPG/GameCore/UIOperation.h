...
#define RPG_GAMECORE_UIOPERATION_METHOD_2_99E37070C2F40B32_OFFSET UNITYSDK_OFFSET(0x1B9BE680)
#define RPG_GAMECORE_UIOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BE950)
