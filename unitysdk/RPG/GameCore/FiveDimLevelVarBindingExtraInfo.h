...
#define RPG_GAMECORE_FIVEDIMLEVELVARBINDINGEXTRAINFO_METHOD_3_04A8A7469D7CEAAF_OFFSET UNITYSDK_OFFSET(0x1B435C50)
#define RPG_GAMECORE_FIVEDIMLEVELVARBINDINGEXTRAINFO_METHOD_3_3AEA9B4E821CDA9C_OFFSET UNITYSDK_OFFSET(0x1B435C90)
#define RPG_GAMECORE_FIVEDIMLEVELVARBINDINGEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B435C80)
