...
#define RPG_GAMECORE_CHIMERADUELSTATUSEFFECTPARAM_METHOD_3_1B9DED232613887E_OFFSET UNITYSDK_OFFSET(0x1B352C50)
#define RPG_GAMECORE_CHIMERADUELSTATUSEFFECTPARAM_METHOD_3_BD65E4F31A9D2E06_OFFSET UNITYSDK_OFFSET(0x1B352BF0)
#define RPG_GAMECORE_CHIMERADUELSTATUSEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B352C40)
