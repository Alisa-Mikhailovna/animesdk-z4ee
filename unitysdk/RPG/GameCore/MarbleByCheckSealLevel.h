...
#define RPG_GAMECORE_MARBLEBYCHECKSEALLEVEL_METHOD_4_9AACDC1FB46922D1_OFFSET UNITYSDK_OFFSET(0x1B5B2CD0)
#define RPG_GAMECORE_MARBLEBYCHECKSEALLEVEL_METHOD_4_D6FCACBD5F36A079_OFFSET UNITYSDK_OFFSET(0x1B5B2C70)
#define RPG_GAMECORE_MARBLEBYCHECKSEALLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B2CC0)
