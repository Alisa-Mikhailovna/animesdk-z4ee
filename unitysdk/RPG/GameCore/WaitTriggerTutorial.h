...
#define RPG_GAMECORE_WAITTRIGGERTUTORIAL_METHOD_3_508835BA9D876EA6_OFFSET UNITYSDK_OFFSET(0x1B9F1C80)
#define RPG_GAMECORE_WAITTRIGGERTUTORIAL_METHOD_3_5A18D5C3A60BD9A7_OFFSET UNITYSDK_OFFSET(0x1B9F1C40)
#define RPG_GAMECORE_WAITTRIGGERTUTORIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F1C70)
