...
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_80C14D1DD0884A29_OFFSET UNITYSDK_OFFSET(0x1B8D4C80)
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_B29674835E98906C_OFFSET UNITYSDK_OFFSET(0x1B8D4D50)
#define RPG_GAMECORE_SHOWSUBPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D4D40)
