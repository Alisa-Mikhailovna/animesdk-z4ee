...
#define RPG_GAMECORE_CYCLEQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B391850)
#define RPG_GAMECORE_CYCLEQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B392650)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Cycledays; // 0x2C
		::System::Boolean IsNonPeriodic; // 0x30
