...
#define RPG_GAMECORE_TUTORIALCLOSE_METHOD_3_231A7C29C6D62B00_OFFSET UNITYSDK_OFFSET(0x1B9B53E0)
#define RPG_GAMECORE_TUTORIALCLOSE_METHOD_3_CA858500375C01BD_OFFSET UNITYSDK_OFFSET(0x1B9B54B0)
#define RPG_GAMECORE_TUTORIALCLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B54A0)
