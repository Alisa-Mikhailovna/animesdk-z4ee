...
#define RPG_GAMECORE_COCOONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B370660)
#define RPG_GAMECORE_COCOONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B371090)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FarmTypeConfig FarmType; // 0x5C
		::System::UInt32 PropID; // 0x60
