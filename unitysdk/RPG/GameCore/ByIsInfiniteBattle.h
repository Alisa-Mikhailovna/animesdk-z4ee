...
#define RPG_GAMECORE_BYISINFINITEBATTLE_METHOD_4_3C1059E63E961827_OFFSET UNITYSDK_OFFSET(0x1B2C6D80)
#define RPG_GAMECORE_BYISINFINITEBATTLE_METHOD_4_56B86E0C8FD46412_OFFSET UNITYSDK_OFFSET(0x1B2C6D50)
#define RPG_GAMECORE_BYISINFINITEBATTLE_METHOD_4_B544E3689D95B9AC_OFFSET UNITYSDK_OFFSET(0x1B2C6C10)
#define RPG_GAMECORE_BYISINFINITEBATTLE_METHOD_4_F839344E1BDE1567_OFFSET UNITYSDK_OFFSET(0x1B2C6BD0)
#define RPG_GAMECORE_BYISINFINITEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C6C00)
