...
#define RPG_GAMECORE_JUKEBOXMUSICTIMESCONFIG_METHOD_2_C24CDEEE4C2B3D6F_OFFSET UNITYSDK_OFFSET(0x1B54DAF0)
#define RPG_GAMECORE_JUKEBOXMUSICTIMESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54DBD0)
