...
#define RPG_GAMECORE_RUNTIMESTAGECAPTUREALIASDATA_METHOD_2_459FA1A5F4C842C1_OFFSET UNITYSDK_OFFSET(0x1B7CB710)
#define RPG_GAMECORE_RUNTIMESTAGECAPTUREALIASDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7CB910)
