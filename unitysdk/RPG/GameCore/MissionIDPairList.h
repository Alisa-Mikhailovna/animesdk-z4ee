...
#define RPG_GAMECORE_MISSIONIDPAIRLIST_METHOD_2_A20ADB627B2B206E_OFFSET UNITYSDK_OFFSET(0x1B5FFE30)
#define RPG_GAMECORE_MISSIONIDPAIRLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5FFEF0)
