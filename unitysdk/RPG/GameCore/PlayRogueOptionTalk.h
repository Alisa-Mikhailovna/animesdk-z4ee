...
#define RPG_GAMECORE_PLAYROGUEOPTIONTALK_METHOD_3_B8ED5A6A1724E7C6_OFFSET UNITYSDK_OFFSET(0x1B6C97F0)
#define RPG_GAMECORE_PLAYROGUEOPTIONTALK_METHOD_3_CED91AA63F05EC85_OFFSET UNITYSDK_OFFSET(0x1B6C9830)
#define RPG_GAMECORE_PLAYROGUEOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C9820)
