...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_B3480FF1D721225E_OFFSET UNITYSDK_OFFSET(0x1B7E2240)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_D2708D7AB957F3EB_OFFSET UNITYSDK_OFFSET(0x1B7E21F0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E2230)
