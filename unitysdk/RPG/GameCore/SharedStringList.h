...
#define RPG_GAMECORE_SHAREDSTRINGLIST_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B8C0A60)
#define RPG_GAMECORE_SHAREDSTRINGLIST_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B8C0B50)
#define RPG_GAMECORE_SHAREDSTRINGLIST_METHOD_3_65B45DD5E2F906F9_OFFSET UNITYSDK_OFFSET(0x1B8C0900)
#define RPG_GAMECORE_SHAREDSTRINGLIST_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1B8C0A50)
#define RPG_GAMECORE_SHAREDSTRINGLIST_METHOD_3_C64B875B0C0F570E_OFFSET UNITYSDK_OFFSET(0x1B8C0940)
#define RPG_GAMECORE_SHAREDSTRINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C0930)
