...
#define RPG_GAMECORE_TESTHOTUPDATEJSON_METHOD_2_D387A9E786BE18AB_OFFSET UNITYSDK_OFFSET(0x1B96C4B0)
#define RPG_GAMECORE_TESTHOTUPDATEJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B96C610)
