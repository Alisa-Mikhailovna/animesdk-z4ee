...
#define RPG_GAMECORE_MULTIPLEPATHAVATARCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B637480)
#define RPG_GAMECORE_MULTIPLEPATHAVATARCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B637870)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean AllowRepeatUnlockReward; // 0x4C
		::System::Boolean IsEarlyUnlock; // 0x4D
