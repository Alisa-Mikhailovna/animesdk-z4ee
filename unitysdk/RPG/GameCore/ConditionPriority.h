...
#define RPG_GAMECORE_CONDITIONPRIORITY_METHOD_2_AC98736F767718EC_OFFSET UNITYSDK_OFFSET(0x1B37B7D0)
#define RPG_GAMECORE_CONDITIONPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B37B8E0)
