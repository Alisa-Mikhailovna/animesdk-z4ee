...
#define RPG_GAMECORE_ACTIVEFMCHANNELSOURCE_METHOD_3_301A9C8C8C6504F3_OFFSET UNITYSDK_OFFSET(0x1B0FF100)
#define RPG_GAMECORE_ACTIVEFMCHANNELSOURCE_METHOD_3_EB4134B82669FF08_OFFSET UNITYSDK_OFFSET(0x1B0FF0C0)
#define RPG_GAMECORE_ACTIVEFMCHANNELSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FF0F0)
