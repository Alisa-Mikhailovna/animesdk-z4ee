...
#define RPG_GAMECORE_FREESTYLEANIMZONECONFIG_METHOD_2_935ED42C4AB1D762_OFFSET UNITYSDK_OFFSET(0x1B4A09A0)
#define RPG_GAMECORE_FREESTYLEANIMZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A0AD0)
