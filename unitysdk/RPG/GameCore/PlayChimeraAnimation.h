...
#define RPG_GAMECORE_PLAYCHIMERAANIMATION_METHOD_3_0517CDC2790729BA_OFFSET UNITYSDK_OFFSET(0x1B6C59E0)
#define RPG_GAMECORE_PLAYCHIMERAANIMATION_METHOD_3_44D7A2E9C5BFCCE4_OFFSET UNITYSDK_OFFSET(0x1B6C5A40)
#define RPG_GAMECORE_PLAYCHIMERAANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C5A30)
