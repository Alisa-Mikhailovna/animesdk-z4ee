...
#define RPG_GAMECORE_STRINGHASH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2CAD0)
#define RPG_GAMECORE_STRINGHASH_EQUALS_OFFSET UNITYSDK_OFFSET(0x39FAFD0)
#define RPG_GAMECORE_STRINGHASH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define RPG_GAMECORE_STRINGHASH_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x156070)
#define RPG_GAMECORE_STRINGHASH_METHOD_2_1771EAEBC674C3A5_1_OFFSET UNITYSDK_OFFSET(0x1B9180D0)
#define RPG_GAMECORE_STRINGHASH_METHOD_2_1771EAEBC674C3A5_OFFSET UNITYSDK_OFFSET(0x1B9180B0)
#define RPG_GAMECORE_STRINGHASH_METHOD_2_843EF63EFF0E9907_OFFSET UNITYSDK_OFFSET(0x39DDC40)
#define RPG_GAMECORE_STRINGHASH_METHOD_2_FD3549386282C22D_OFFSET UNITYSDK_OFFSET(0x1B9180A0)
#define RPG_GAMECORE_STRINGHASH_METHOD_2_FE052DFCB6080B60_OFFSET UNITYSDK_OFFSET(0x1B917FE0)
#define RPG_GAMECORE_STRINGHASH__CTOR_OFFSET UNITYSDK_OFFSET(0x39FAF10)
