...
#define RPG_GAMECORE_MAPROTATIONPERFORMANCECONFIG_METHOD_2_D0DC1FCFB433B2C1_OFFSET UNITYSDK_OFFSET(0x1B5AA930)
#define RPG_GAMECORE_MAPROTATIONPERFORMANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5AA9F0)
