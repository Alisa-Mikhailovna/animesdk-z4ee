...
#define RPG_GAMECORE_BATTLEBGMCONFIG_METHOD_2_0897CE4BC43755F7_OFFSET UNITYSDK_OFFSET(0x1B1F0080)
#define RPG_GAMECORE_BATTLEBGMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F0140)
