...
#define RPG_GAMECORE_FREESTYLEANIMGROUPEVENTCONFIG_METHOD_2_AE60E12A19BC3D0B_OFFSET UNITYSDK_OFFSET(0x1B4A0750)
#define RPG_GAMECORE_FREESTYLEANIMGROUPEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A0990)
