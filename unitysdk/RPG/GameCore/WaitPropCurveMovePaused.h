...
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED_METHOD_3_9666F3C84197FCE8_OFFSET UNITYSDK_OFFSET(0x1B9ECC20)
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED_METHOD_3_E8A947B543BDC4EA_OFFSET UNITYSDK_OFFSET(0x1B9ECCC0)
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9ECC80)
