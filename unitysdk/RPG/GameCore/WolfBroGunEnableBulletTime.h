...
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME_METHOD_3_1A423A188092E256_OFFSET UNITYSDK_OFFSET(0x1B9F5D90)
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME_METHOD_3_6B9CF24547911C07_OFFSET UNITYSDK_OFFSET(0x1B9F5D40)
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F5D80)
