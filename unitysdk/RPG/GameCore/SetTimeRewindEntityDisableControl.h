...
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL_METHOD_3_0358D498DC4F8515_OFFSET UNITYSDK_OFFSET(0x1B8B7A70)
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL_METHOD_3_B0F3C7F5C56B3DDA_OFFSET UNITYSDK_OFFSET(0x1B8B7AB0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B7AA0)
