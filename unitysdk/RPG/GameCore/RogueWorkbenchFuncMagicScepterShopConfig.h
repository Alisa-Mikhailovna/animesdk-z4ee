...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICSCEPTERSHOPCONFIG_METHOD_3_07885B1F7B6F446B_OFFSET UNITYSDK_OFFSET(0x1B7A4E70)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICSCEPTERSHOPCONFIG_METHOD_3_B5065799C68CDBC7_OFFSET UNITYSDK_OFFSET(0x1B7A50D0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICSCEPTERSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4E60)
