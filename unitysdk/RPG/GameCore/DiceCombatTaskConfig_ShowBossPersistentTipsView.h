...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SHOWBOSSPERSISTENTTIPSVIEW_METHOD_3_75C8E7FD74013926_OFFSET UNITYSDK_OFFSET(0x1B3B8BE0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SHOWBOSSPERSISTENTTIPSVIEW_METHOD_3_F41EB76F7B68400F_OFFSET UNITYSDK_OFFSET(0x1B3B8D20)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SHOWBOSSPERSISTENTTIPSVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B8D10)
