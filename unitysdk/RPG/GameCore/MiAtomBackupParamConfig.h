...
#define RPG_GAMECORE_MIATOMBACKUPPARAMCONFIG_METHOD_2_DA49EC08056FED98_OFFSET UNITYSDK_OFFSET(0x1B5F7D40)
#define RPG_GAMECORE_MIATOMBACKUPPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F7D80)
