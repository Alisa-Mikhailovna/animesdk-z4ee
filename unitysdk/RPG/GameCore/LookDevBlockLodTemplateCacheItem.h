...
#define RPG_GAMECORE_LOOKDEVBLOCKLODTEMPLATECACHEITEM_METHOD_2_D1633386120149C7_OFFSET UNITYSDK_OFFSET(0x1B5984C0)
#define RPG_GAMECORE_LOOKDEVBLOCKLODTEMPLATECACHEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5985B0)
