...
#define RPG_GAMECORE_FIVEDIMONEWAYENTRYCONFIG_METHOD_2_1871AA394CE67DFE_OFFSET UNITYSDK_OFFSET(0x1B43D7A0)
#define RPG_GAMECORE_FIVEDIMONEWAYENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43D8E0)
