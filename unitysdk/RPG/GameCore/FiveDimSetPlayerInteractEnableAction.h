...
#define RPG_GAMECORE_FIVEDIMSETPLAYERINTERACTENABLEACTION_METHOD_3_B97AE86A62C32C7F_OFFSET UNITYSDK_OFFSET(0x1B447560)
#define RPG_GAMECORE_FIVEDIMSETPLAYERINTERACTENABLEACTION_METHOD_3_DF4434DE9A3CF742_OFFSET UNITYSDK_OFFSET(0x1B447480)
#define RPG_GAMECORE_FIVEDIMSETPLAYERINTERACTENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B447550)
