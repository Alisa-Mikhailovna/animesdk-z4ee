...
#define RPG_GAMECORE_PHOTOGRAPHSETUNIQUENAMECONFIG_METHOD_2_2E3515EEAB576122_OFFSET UNITYSDK_OFFSET(0x1B6AA960)
#define RPG_GAMECORE_PHOTOGRAPHSETUNIQUENAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AB6B0)
