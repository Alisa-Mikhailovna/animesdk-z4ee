...
#define RPG_GAMECORE_PINGPONGFLOATPOS_METHOD_2_4F899698942D93A0_OFFSET UNITYSDK_OFFSET(0x1B6B0350)
#define RPG_GAMECORE_PINGPONGFLOATPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B0480)
