...
#define RPG_GAMECORE_RTBATTLECHARACTERCONFIG_METHOD_3_53E70177D1609FB4_OFFSET UNITYSDK_OFFSET(0x1B7A9B70)
#define RPG_GAMECORE_RTBATTLECHARACTERCONFIG_METHOD_3_9FFE49F6BD516DAB_OFFSET UNITYSDK_OFFSET(0x1B7A9A50)
#define RPG_GAMECORE_RTBATTLECHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A9AF0)
