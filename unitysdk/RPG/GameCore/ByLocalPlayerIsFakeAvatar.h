...
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_18B9B03C65D0FD31_OFFSET UNITYSDK_OFFSET(0x1B2D5F40)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_3FCDE4EB9CCA8204_OFFSET UNITYSDK_OFFSET(0x1B2D60C0)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_72D1198EC2C9203A_OFFSET UNITYSDK_OFFSET(0x1B2D5F80)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_FFDEC79F3D2E5F85_OFFSET UNITYSDK_OFFSET(0x1B2D60F0)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D5F70)
