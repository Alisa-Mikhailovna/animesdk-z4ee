...
#define RPG_GAMECORE_SETTVNOTIFYCONFIG_METHOD_2_E82129229BEB09AE_OFFSET UNITYSDK_OFFSET(0x1B8B3EE0)
#define RPG_GAMECORE_SETTVNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B3FC0)
