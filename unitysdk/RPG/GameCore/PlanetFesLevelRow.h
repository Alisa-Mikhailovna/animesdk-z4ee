...
#define RPG_GAMECORE_PLANETFESLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6C19A0)
#define RPG_GAMECORE_PLANETFESLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C2140)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::PlanetFesBigInt* GrantGold; // 0x10
		::Il2CppArray<::System::UInt32>* BuffIDList; // 0x18
		::Il2CppArray<::RPG::GameCore::ItemConfig*>* GrantItemList; // 0x20
