...
#define RPG_GAMECORE_PRELOADITEMSCORERECORDCHILDTASK_METHOD_2_BFE1D6F30F26580A_OFFSET UNITYSDK_OFFSET(0x1B6D8AD0)
#define RPG_GAMECORE_PRELOADITEMSCORERECORDCHILDTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D8C20)
