...
#define RPG_GAMECORE_STANDALONECOMPLEXSKILLAICONFIG_METHOD_2_CCE81DC164485C57_OFFSET UNITYSDK_OFFSET(0x1B9076B0)
#define RPG_GAMECORE_STANDALONECOMPLEXSKILLAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B907800)
