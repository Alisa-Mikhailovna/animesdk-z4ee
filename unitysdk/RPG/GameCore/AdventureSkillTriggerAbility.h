...
#define RPG_GAMECORE_ADVENTURESKILLTRIGGERABILITY_METHOD_3_0A3C2CE0B882C601_OFFSET UNITYSDK_OFFSET(0x1B1804D0)
#define RPG_GAMECORE_ADVENTURESKILLTRIGGERABILITY_METHOD_3_CF2D85AE6E09261A_OFFSET UNITYSDK_OFFSET(0x1B180490)
#define RPG_GAMECORE_ADVENTURESKILLTRIGGERABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1804C0)
