...
#define RPG_GAMECORE_ROGUEAEONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B73C6F0)
#define RPG_GAMECORE_ROGUEAEONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73E300)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BattleEventEnhanceBuffGroup; // 0x14
