...
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE_METHOD_2_11983C0DBACCDDAF_OFFSET UNITYSDK_OFFSET(0x1B96CB80)
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE_METHOD_2_4253B2C90426BB3C_OFFSET UNITYSDK_OFFSET(0x1B96C7C0)
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B96CB70)
