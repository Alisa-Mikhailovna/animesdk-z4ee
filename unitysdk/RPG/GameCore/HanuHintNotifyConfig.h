...
#define RPG_GAMECORE_HANUHINTNOTIFYCONFIG_METHOD_2_D4476574C1A5D8C5_OFFSET UNITYSDK_OFFSET(0x1B4FFAF0)
#define RPG_GAMECORE_HANUHINTNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4FFBC0)
