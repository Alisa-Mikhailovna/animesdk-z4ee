...
#define RPG_GAMECORE_VP_MIN_METHOD_3_354EE36AC864B94F_OFFSET UNITYSDK_OFFSET(0x1B9D8AE0)
#define RPG_GAMECORE_VP_MIN_METHOD_3_430DF9969363B87E_OFFSET UNITYSDK_OFFSET(0x1B9D8C40)
#define RPG_GAMECORE_VP_MIN_METHOD_3_54992364255A3AD2_OFFSET UNITYSDK_OFFSET(0x1B9D8B90)
#define RPG_GAMECORE_VP_MIN_METHOD_3_BAFB2269FBAD5E02_OFFSET UNITYSDK_OFFSET(0x1B9D8C10)
#define RPG_GAMECORE_VP_MIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D8B80)
