...
#define RPG_GAMECORE_ANCHORCONFIG_METHOD_2_8E79BBCF1255750F_OFFSET UNITYSDK_OFFSET(0x1B1A4B40)
#define RPG_GAMECORE_ANCHORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A4B80)
