...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCOMPOSEMIRACLECONFIG_METHOD_3_713C3A8875F61877_OFFSET UNITYSDK_OFFSET(0x1B7A4DF0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCOMPOSEMIRACLECONFIG_METHOD_3_F254292ED92FB633_OFFSET UNITYSDK_OFFSET(0x1B7A4F80)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCOMPOSEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4DE0)
