...
#define RPG_GAMECORE_VCAMERABLENDCONFIG_METHOD_3_0CEA981044B2AAAB_OFFSET UNITYSDK_OFFSET(0x1B9C8620)
#define RPG_GAMECORE_VCAMERABLENDCONFIG_METHOD_3_6051098174EA81C8_OFFSET UNITYSDK_OFFSET(0x1B9C8660)
#define RPG_GAMECORE_VCAMERABLENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C8650)
