...
#define RPG_GAMECORE_MONSTERTEMPLATEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B632290)
#define RPG_GAMECORE_MONSTERTEMPLATEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B633480)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ManikinImagePath; // 0x38
		::System::String* RoundIconPath; // 0x40
		::System::String* ManikinConfigPath; // 0x48
		...
		::RPG::GameCore::FixPoint InitialDelayRatio; // 0x90
		::System::Int32 StanceCount; // 0x98
		::System::UInt32 MonsterCampID; // 0x9C
		::RPG::GameCore::FixPoint DefenceBase; // 0xA0
		::RPG::GameCore::FixPoint MinimumFatigueRatio; // 0xA8
		::System::UInt32 TemplateGroupID; // 0xB0
		::RPG::GameCore::AttackDamageType StanceType; // 0xB4
		::RPG::GameCore::FixPoint StanceModifyValue; // 0xB8
		::RPG::GameCore::FixPoint HPBase; // 0xC0
		::RPG::Client::TextID MonsterName; // 0xC8
		::RPG::GameCore::FixPoint CriticalChanceBase; // 0xD8
		::System::UInt32 MonsterTemplateID; // 0xE0
		::System::Int32 AtlasSortID; // 0xE4
		::RPG::GameCore::FixPoint CriticalDamageBase; // 0xE8
		::RPG::GameCore::FixPoint StatusResistanceBase; // 0xF0
		::RPG::GameCore::MonsterRank Rank; // 0xF8
		::System::UInt32 NatureID; // 0xFC
