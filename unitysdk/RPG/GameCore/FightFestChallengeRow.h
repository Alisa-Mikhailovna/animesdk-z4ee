...
#define RPG_GAMECORE_FIGHTFESTCHALLENGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B411820)
#define RPG_GAMECORE_FIGHTFESTCHALLENGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B412010)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockSubMussionID; // 0x60
		::System::UInt32 EnvironmentBuffID; // 0x64
		::System::UInt32 AvatarInfoID; // 0x68
		::RPG::Client::TextID StoryDesc; // 0x70
		::RPG::Client::TextID ChallengeName; // 0x80
		::System::UInt32 TutorialID; // 0x90
