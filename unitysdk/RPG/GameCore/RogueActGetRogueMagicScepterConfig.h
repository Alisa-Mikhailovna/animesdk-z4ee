...
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICSCEPTERCONFIG_METHOD_6_384CE4FDEED3EDAD_OFFSET UNITYSDK_OFFSET(0x1B734C50)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICSCEPTERCONFIG_METHOD_6_76E0EC4BB035A829_OFFSET UNITYSDK_OFFSET(0x1B734C00)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICSCEPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B734C40)
