...
#define RPG_GAMECORE_MATERIALSUBMITTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5D8280)
#define RPG_GAMECORE_MATERIALSUBMITTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D84D0)
