...
#define RPG_GAMECORE_TRYSTARTCONNECTULTRASKILLFRAMECAPTURE_METHOD_3_1C1D393EAC6E143B_OFFSET UNITYSDK_OFFSET(0x1B9AFE80)
#define RPG_GAMECORE_TRYSTARTCONNECTULTRASKILLFRAMECAPTURE_METHOD_3_47E34213435AAA3E_OFFSET UNITYSDK_OFFSET(0x1B9AFF50)
#define RPG_GAMECORE_TRYSTARTCONNECTULTRASKILLFRAMECAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9AFF40)
