...
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_831087C3869D39C8_OFFSET UNITYSDK_OFFSET(0x1B6D7A10)
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_A0726820766CD54D_OFFSET UNITYSDK_OFFSET(0x1B6D7E20)
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_EA6739731D6A904C_OFFSET UNITYSDK_OFFSET(0x1B6D7A50)
#define RPG_GAMECORE_PREDICATETASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D7A40)
