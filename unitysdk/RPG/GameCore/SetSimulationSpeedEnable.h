...
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE_METHOD_3_6B6F573ACD2E80E7_OFFSET UNITYSDK_OFFSET(0x1B8B1080)
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE_METHOD_3_EE1E97E903545FAC_OFFSET UNITYSDK_OFFSET(0x1B8B1040)
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B1070)
