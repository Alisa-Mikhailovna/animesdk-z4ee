...
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B3C1220)
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C15C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OneMoreDrinkPerformanceID; // 0x40
		::System::UInt32 DrinkID; // 0x44
