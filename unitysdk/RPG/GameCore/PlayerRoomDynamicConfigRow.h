...
#define RPG_GAMECORE_PLAYERROOMDYNAMICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6D45B0)
#define RPG_GAMECORE_PLAYERROOMDYNAMICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D4850)
