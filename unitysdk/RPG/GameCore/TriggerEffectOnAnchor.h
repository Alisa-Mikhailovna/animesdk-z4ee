...
#define RPG_GAMECORE_TRIGGEREFFECTONANCHOR_METHOD_3_054809949042609C_OFFSET UNITYSDK_OFFSET(0x1B9A1D90)
#define RPG_GAMECORE_TRIGGEREFFECTONANCHOR_METHOD_3_E82C17AB612A99DD_OFFSET UNITYSDK_OFFSET(0x1B9A1D50)
#define RPG_GAMECORE_TRIGGEREFFECTONANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A1D80)
