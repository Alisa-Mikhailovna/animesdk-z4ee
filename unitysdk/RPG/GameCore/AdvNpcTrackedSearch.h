...
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_832AEB49D8923C53_OFFSET UNITYSDK_OFFSET(0x1B15C5A0)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_F5C303B4C58A9890_OFFSET UNITYSDK_OFFSET(0x1B15C5E0)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B15C5D0)
