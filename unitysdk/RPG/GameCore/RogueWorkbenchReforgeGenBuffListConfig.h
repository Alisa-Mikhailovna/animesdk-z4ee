...
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFLISTCONFIG_METHOD_2_EC1C91CBC43797E6_OFFSET UNITYSDK_OFFSET(0x1B7A5330)
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A5370)
