...
#define RPG_GAMECORE_ACTIONDELAYLINKEXTRABEHAVIORGROUP_METHOD_2_C90B3E94773F5B57_OFFSET UNITYSDK_OFFSET(0x1B0F9630)
#define RPG_GAMECORE_ACTIONDELAYLINKEXTRABEHAVIORGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F9710)
