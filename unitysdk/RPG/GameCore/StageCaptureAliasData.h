...
#define RPG_GAMECORE_STAGECAPTUREALIASDATA_METHOD_2_A05096C1207BCD7E_OFFSET UNITYSDK_OFFSET(0x1B8F76A0)
#define RPG_GAMECORE_STAGECAPTUREALIASDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8F7840)
