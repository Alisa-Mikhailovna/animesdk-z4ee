...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTRESETCONFIG_METHOD_7_1A47D04FD1A24C37_OFFSET UNITYSDK_OFFSET(0x1B735FE0)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTRESETCONFIG_METHOD_7_600C4C5465A547F3_OFFSET UNITYSDK_OFFSET(0x1B736140)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B735FD0)
