...
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_E9EC84C6626E664C_OFFSET UNITYSDK_OFFSET(0x1B9E3510)
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_EF88A1D09BD35B1E_OFFSET UNITYSDK_OFFSET(0x1B9E3670)
#define RPG_GAMECORE_WAITCONDITIONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E3660)
