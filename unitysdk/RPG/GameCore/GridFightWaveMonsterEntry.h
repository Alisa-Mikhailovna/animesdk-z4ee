...
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERENTRY_METHOD_2_F4061F3ABC0F36D1_OFFSET UNITYSDK_OFFSET(0x1B4F58D0)
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F59F0)
