...
#define RPG_GAMECORE_GAMEOBJECTPOOLGROUPSETTING_METHOD_2_F71A2711C8F52DFC_OFFSET UNITYSDK_OFFSET(0x1B4C37A0)
#define RPG_GAMECORE_GAMEOBJECTPOOLGROUPSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C3B70)
