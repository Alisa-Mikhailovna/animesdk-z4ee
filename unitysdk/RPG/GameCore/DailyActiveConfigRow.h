...
#define RPG_GAMECORE_DAILYACTIVECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B3935A0)
#define RPG_GAMECORE_DAILYACTIVECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B393BD0)
