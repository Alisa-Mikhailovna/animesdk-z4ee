...
#define RPG_GAMECORE_USESEQUENCEDSKILL_METHOD_3_6B76359F7C4F6A4C_OFFSET UNITYSDK_OFFSET(0x1B9C7A40)
#define RPG_GAMECORE_USESEQUENCEDSKILL_METHOD_3_8A2DF3D4EEF1CF89_OFFSET UNITYSDK_OFFSET(0x1B9C7970)
#define RPG_GAMECORE_USESEQUENCEDSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C7A30)
