...
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1B89DEA0)
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM_METHOD_4_1D607E84D7477DFB_OFFSET UNITYSDK_OFFSET(0x1B89DD30)
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM_METHOD_4_C8A5E51EF86162F4_OFFSET UNITYSDK_OFFSET(0x1B89DCF0)
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B89DD20)
