...
#define RPG_GAMECORE_UIMONOPOLYWAITMAINPAGE_METHOD_3_A164BE515FB353D3_OFFSET UNITYSDK_OFFSET(0x1B9BE2A0)
#define RPG_GAMECORE_UIMONOPOLYWAITMAINPAGE_METHOD_3_D9EF25BAD2A46C96_OFFSET UNITYSDK_OFFSET(0x1B9BE1D0)
#define RPG_GAMECORE_UIMONOPOLYWAITMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BE290)
