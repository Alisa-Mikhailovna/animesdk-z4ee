...
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_2594D75DC6293C3C_OFFSET UNITYSDK_OFFSET(0x1B2CEF10)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_971BF76B4BA70A59_OFFSET UNITYSDK_OFFSET(0x1B2CF0C0)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_9FCFB3B4CBD95376_OFFSET UNITYSDK_OFFSET(0x1B2CF0F0)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN_METHOD_4_F98B182E430A7E75_OFFSET UNITYSDK_OFFSET(0x1B2CEF50)
#define RPG_GAMECORE_BYISSWORDTRAININGSKILLCANLEARN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CEF40)
