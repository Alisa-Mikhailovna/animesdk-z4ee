...
#define RPG_GAMECORE_ROGUECURSECHESTEVENTCONFIG_METHOD_2_861C15C9D7CF85E9_OFFSET UNITYSDK_OFFSET(0x1B748EC0)
#define RPG_GAMECORE_ROGUECURSECHESTEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B748F00)
