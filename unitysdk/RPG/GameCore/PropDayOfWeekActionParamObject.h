...
#define RPG_GAMECORE_PROPDAYOFWEEKACTIONPARAMOBJECT_METHOD_2_5F955E3522F9B32A_OFFSET UNITYSDK_OFFSET(0x1B6E1570)
#define RPG_GAMECORE_PROPDAYOFWEEKACTIONPARAMOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E17A0)
