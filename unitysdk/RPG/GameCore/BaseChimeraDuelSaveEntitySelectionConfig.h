...
#define RPG_GAMECORE_BASECHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_2_C486126AFC9A2677_OFFSET UNITYSDK_OFFSET(0x1B1EC0C0)
#define RPG_GAMECORE_BASECHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_2_F76E5798A1C5AD31_OFFSET UNITYSDK_OFFSET(0x1B1EC250)
#define RPG_GAMECORE_BASECHIMERADUELSAVEENTITYSELECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EC2B0)
