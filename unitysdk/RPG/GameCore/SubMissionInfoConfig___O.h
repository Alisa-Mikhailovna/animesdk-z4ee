...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::MissionVerseParam>**)Il2CppClass::FromTypeDefinitionIndex(SubMissionInfoConfig___O_TypeDefinitionIndex)->GetStaticField(0x45F0);
		}
	};
}
