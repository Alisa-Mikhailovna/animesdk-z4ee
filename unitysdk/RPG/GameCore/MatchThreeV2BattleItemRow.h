...
#define RPG_GAMECORE_MATCHTHREEV2BATTLEITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5D4480)
#define RPG_GAMECORE_MATCHTHREEV2BATTLEITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D4AB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MatchThreePropType PropType; // 0x68
		::System::UInt32 ItemLevel; // 0x6C
		::System::UInt32 BattleItemID; // 0x70
		::System::UInt32 LevelUpCost; // 0x74
		::RPG::Client::TextID ItemName; // 0x78
		::System::UInt32 ItemUseCount; // 0x88
