...
#define RPG_GAMECORE_CAKERACEFIELDSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2F9650)
#define RPG_GAMECORE_CAKERACEFIELDSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F98D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TotalScoreMaxLimit; // 0x14
		...
		::System::UInt32 TotalScoreRate; // 0x2C
