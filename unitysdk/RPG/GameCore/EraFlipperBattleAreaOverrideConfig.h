...
#define RPG_GAMECORE_ERAFLIPPERBATTLEAREAOVERRIDECONFIG_METHOD_2_610744A499980B69_OFFSET UNITYSDK_OFFSET(0x1B3F4950)
#define RPG_GAMECORE_ERAFLIPPERBATTLEAREAOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3F4AC0)
