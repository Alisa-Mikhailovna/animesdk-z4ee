...
#define RPG_GAMECORE_ACTIVITYDICECOMBATRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B107980)
#define RPG_GAMECORE_ACTIVITYDICECOMBATRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B108120)
