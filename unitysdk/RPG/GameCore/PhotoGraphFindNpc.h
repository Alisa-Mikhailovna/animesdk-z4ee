...
#define RPG_GAMECORE_PHOTOGRAPHFINDNPC_METHOD_2_86E7073ACFC65BF6_OFFSET UNITYSDK_OFFSET(0x1B6A97D0)
#define RPG_GAMECORE_PHOTOGRAPHFINDNPC_METHOD_2_F266A0247ABE2FDC_OFFSET UNITYSDK_OFFSET(0x1B6A9940)
#define RPG_GAMECORE_PHOTOGRAPHFINDNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A9930)
