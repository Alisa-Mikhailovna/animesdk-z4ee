...
#define RPG_GAMECORE_LEVELAIDREADYSTART_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDAC0CE0)
#define RPG_GAMECORE_LEVELAIDREADYSTART_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDAC0C90)
#define RPG_GAMECORE_LEVELAIDREADYSTART__CTOR_OFFSET UNITYSDK_OFFSET(0xDAC0C80)
