...
#define RPG_GAMECORE_HIPPLENREQUIRESTATGRADE_METHOD_2_E0425783447AA390_OFFSET UNITYSDK_OFFSET(0x1B517CD0)
#define RPG_GAMECORE_HIPPLENREQUIRESTATGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51ABD0)
