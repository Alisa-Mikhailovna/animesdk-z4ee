...
#define RPG_GAMECORE_ROGUECONDPERSONAROOMISSUPERCONFIG_METHOD_6_1D7DD82EB111B90A_OFFSET UNITYSDK_OFFSET(0x1B748C10)
#define RPG_GAMECORE_ROGUECONDPERSONAROOMISSUPERCONFIG_METHOD_6_83F3A7F3DFED8F66_OFFSET UNITYSDK_OFFSET(0x1B748C60)
#define RPG_GAMECORE_ROGUECONDPERSONAROOMISSUPERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B748C50)
