...
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBRO_METHOD_3_A284FA7BB4771C82_OFFSET UNITYSDK_OFFSET(0x1B8D2410)
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBRO_METHOD_3_DF69C2D5FCEE4409_OFFSET UNITYSDK_OFFSET(0x1B8D2450)
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBRO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D2440)
