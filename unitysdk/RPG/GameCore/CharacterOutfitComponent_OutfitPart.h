...
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD9F7410)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_GET_CONFIGPATH_OFFSET UNITYSDK_OFFSET(0xD9F7400)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_GET_ID_OFFSET UNITYSDK_OFFSET(0xD9F73F0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_RESETCONFIG_1_OFFSET UNITYSDK_OFFSET(0xD9F76A0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_RESETCONFIG_OFFSET UNITYSDK_OFFSET(0xD9F7540)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_SETUPCONFIG_1_OFFSET UNITYSDK_OFFSET(0xD9F75D0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_SETUPCONFIG_OFFSET UNITYSDK_OFFSET(0xD9F7470)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART__CTOR_OFFSET UNITYSDK_OFFSET(0xD9F7460)
