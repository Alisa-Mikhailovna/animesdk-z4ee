...
#define RPG_GAMECORE_BYISCHARACTERWEAKNESSACTIVATED_METHOD_4_78A94CB7A15C9022_OFFSET UNITYSDK_OFFSET(0x1B2A6F40)
#define RPG_GAMECORE_BYISCHARACTERWEAKNESSACTIVATED_METHOD_4_7A90B4CD151B2E74_OFFSET UNITYSDK_OFFSET(0x1B2A6D70)
#define RPG_GAMECORE_BYISCHARACTERWEAKNESSACTIVATED_METHOD_4_A6EE59165468C071_OFFSET UNITYSDK_OFFSET(0x1B2A6D30)
#define RPG_GAMECORE_BYISCHARACTERWEAKNESSACTIVATED_METHOD_4_B694EC0BFE2C0A2C_OFFSET UNITYSDK_OFFSET(0x1B2A6F70)
#define RPG_GAMECORE_BYISCHARACTERWEAKNESSACTIVATED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A6D60)
