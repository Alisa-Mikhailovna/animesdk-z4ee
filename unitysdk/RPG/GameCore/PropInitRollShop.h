...
#define RPG_GAMECORE_PROPINITROLLSHOP_METHOD_3_4E49A34B87E196FB_OFFSET UNITYSDK_OFFSET(0x1B6E6C90)
#define RPG_GAMECORE_PROPINITROLLSHOP_METHOD_3_975B9B7FDCBC2C17_OFFSET UNITYSDK_OFFSET(0x1B6E6C40)
#define RPG_GAMECORE_PROPINITROLLSHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E6C80)
