...
#define RPG_GAMECORE_CEBATTLEAREAINFO_METHOD_2_4A955310D4F05E36_OFFSET UNITYSDK_OFFSET(0x1B2EE8B0)
#define RPG_GAMECORE_CEBATTLEAREAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EEA60)
