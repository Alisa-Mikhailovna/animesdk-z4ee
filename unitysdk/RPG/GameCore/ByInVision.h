...
#define RPG_GAMECORE_BYINVISION_METHOD_4_6656D0A4635241BA_OFFSET UNITYSDK_OFFSET(0x1B2A1000)
#define RPG_GAMECORE_BYINVISION_METHOD_4_6DCF8345B55F05FF_OFFSET UNITYSDK_OFFSET(0x1B2A1180)
#define RPG_GAMECORE_BYINVISION_METHOD_4_A3C5FE9A5FA99F73_OFFSET UNITYSDK_OFFSET(0x1B2A0FB0)
#define RPG_GAMECORE_BYINVISION_METHOD_4_EA5BCB09E90AA309_OFFSET UNITYSDK_OFFSET(0x1B2A11C0)
#define RPG_GAMECORE_BYINVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A0FF0)
