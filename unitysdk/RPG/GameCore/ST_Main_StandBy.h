...
#define RPG_GAMECORE_ST_MAIN_STANDBY_METHOD_4_AA5DD8C57035D86A_OFFSET UNITYSDK_OFFSET(0x1B7DF3E0)
#define RPG_GAMECORE_ST_MAIN_STANDBY_METHOD_4_DC8D2AEC89B3FCDC_OFFSET UNITYSDK_OFFSET(0x1B7DF3A0)
#define RPG_GAMECORE_ST_MAIN_STANDBY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7DF3D0)
