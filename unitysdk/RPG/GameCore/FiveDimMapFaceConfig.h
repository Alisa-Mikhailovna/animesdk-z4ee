...
#define RPG_GAMECORE_FIVEDIMMAPFACECONFIG_METHOD_2_232299F1C454B31A_OFFSET UNITYSDK_OFFSET(0x1B436B90)
#define RPG_GAMECORE_FIVEDIMMAPFACECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B436EA0)
