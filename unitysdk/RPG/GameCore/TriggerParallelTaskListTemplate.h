...
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE_METHOD_3_028648D9E6964C35_OFFSET UNITYSDK_OFFSET(0x1B9A6E20)
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE_METHOD_3_E1AF5C322BDD12B2_OFFSET UNITYSDK_OFFSET(0x1B9A6DE0)
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A6E10)
