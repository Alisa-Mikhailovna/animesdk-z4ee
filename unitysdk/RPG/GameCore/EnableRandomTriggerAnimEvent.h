...
#define RPG_GAMECORE_ENABLERANDOMTRIGGERANIMEVENT_METHOD_3_8A991D283B281E60_OFFSET UNITYSDK_OFFSET(0x1B3E5320)
#define RPG_GAMECORE_ENABLERANDOMTRIGGERANIMEVENT_METHOD_3_BE2FACD3BF7A212E_OFFSET UNITYSDK_OFFSET(0x1B3E5360)
#define RPG_GAMECORE_ENABLERANDOMTRIGGERANIMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E5350)
