...
#define RPG_GAMECORE_CAMERABATTLETRANSITIONBEHITCONFIG_METHOD_2_348B3D7C6AC05BAC_OFFSET UNITYSDK_OFFSET(0x1B2FF7B0)
#define RPG_GAMECORE_CAMERABATTLETRANSITIONBEHITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FF9D0)
