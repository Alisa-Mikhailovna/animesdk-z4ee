...
#define RPG_GAMECORE_MECHANISMBAREFFECTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5EA9B0)
#define RPG_GAMECORE_MECHANISMBAREFFECTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5EAC60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::String*>* BattlePlayerAbilityList; // 0x18
