...
#define RPG_GAMECORE_QUESTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6F80F0)
#define RPG_GAMECORE_QUESTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F8930)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::QuestUnlockType UnlockType; // 0x20
		::System::UInt32 FinishWayID; // 0x24
		::System::UInt32 GotoID; // 0x28
		::System::UInt32 QuestType; // 0x2C
