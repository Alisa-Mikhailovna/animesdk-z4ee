...
#define RPG_GAMECORE_BYISCHARACTERCHANGETARGET_METHOD_4_043F09540D67F2E4_OFFSET UNITYSDK_OFFSET(0x1B2A65F0)
#define RPG_GAMECORE_BYISCHARACTERCHANGETARGET_METHOD_4_1824FE5BEBD1D479_OFFSET UNITYSDK_OFFSET(0x1B2A6810)
#define RPG_GAMECORE_BYISCHARACTERCHANGETARGET_METHOD_4_4BEDB502B11B00FF_OFFSET UNITYSDK_OFFSET(0x1B2A6850)
#define RPG_GAMECORE_BYISCHARACTERCHANGETARGET_METHOD_4_BB10006205F57ED9_OFFSET UNITYSDK_OFFSET(0x1B2A6640)
#define RPG_GAMECORE_BYISCHARACTERCHANGETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A6630)
