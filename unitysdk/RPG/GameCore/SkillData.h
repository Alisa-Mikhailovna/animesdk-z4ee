...
#define RPG_GAMECORE_SKILLDATA_ADDTAGS_OFFSET UNITYSDK_OFFSET(0xDB4A080)
#define RPG_GAMECORE_SKILLDATA_GETAUTOSELECTPRIORITY_OFFSET UNITYSDK_OFFSET(0xDB4A1A0)
#define RPG_GAMECORE_SKILLDATA_GETCUSTOMREADYCONFIG_OFFSET UNITYSDK_OFFSET(0xDB4A2D0)
#define RPG_GAMECORE_SKILLDATA_GETPROPERTYVALUEIGNORESLOT_OFFSET UNITYSDK_OFFSET(0xDB49FD0)
#define RPG_GAMECORE_SKILLDATA_GETPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0xDB3F800)
#define RPG_GAMECORE_SKILLDATA_GETREADCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xDB4A470)
#define RPG_GAMECORE_SKILLDATA_GETREADYANIMSTATE_OFFSET UNITYSDK_OFFSET(0xDB499E0)
#define RPG_GAMECORE_SKILLDATA_GETREADYCUSTOMFORMATIONCONFIG_OFFSET UNITYSDK_OFFSET(0xDB4A400)
#define RPG_GAMECORE_SKILLDATA_GETUNUSABLECONDITIONRESULT_OFFSET UNITYSDK_OFFSET(0xDB436F0)
#define RPG_GAMECORE_SKILLDATA_GET_ASSISTSKILLUICONFIG_OFFSET UNITYSDK_OFFSET(0xDB49C90)
#define RPG_GAMECORE_SKILLDATA_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xDB497D0)
#define RPG_GAMECORE_SKILLDATA_GET_BPADD_OFFSET UNITYSDK_OFFSET(0xDB48F40)
#define RPG_GAMECORE_SKILLDATA_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0xDB45220)
#define RPG_GAMECORE_SKILLDATA_GET_CANTRAVERSALBYCOMPLEXSKILLAI_OFFSET UNITYSDK_OFFSET(0xDB49E80)
#define RPG_GAMECORE_SKILLDATA_GET_CHILDSKILLCOUNT_OFFSET UNITYSDK_OFFSET(0xDB44040)
#define RPG_GAMECORE_SKILLDATA_GET_CURRENTCTRLTYPE_OFFSET UNITYSDK_OFFSET(0xDB3AC10)
#define RPG_GAMECORE_SKILLDATA_GET_CUSTOMSKILLBUTTONPREFABPATH_OFFSET UNITYSDK_OFFSET(0xDB49B60)
#define RPG_GAMECORE_SKILLDATA_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0xDB496C0)
#define RPG_GAMECORE_SKILLDATA_GET_FINALAIULTRASKILLPRIORITY_OFFSET UNITYSDK_OFFSET(0xDB49EF0)
#define RPG_GAMECORE_SKILLDATA_GET_FORBIDENHANCEEFFECT_OFFSET UNITYSDK_OFFSET(0xDB49C00)
#define RPG_GAMECORE_SKILLDATA_GET_ISINSERTCONDTIONMEET_OFFSET UNITYSDK_OFFSET(0xDB43A10)
#define RPG_GAMECORE_SKILLDATA_GET_ISUSABLECONDITIONMEET_OFFSET UNITYSDK_OFFSET(0xDB435B0)
#define RPG_GAMECORE_SKILLDATA_GET_ISVISABLECONDTIONMEET_OFFSET UNITYSDK_OFFSET(0xDB49DA0)
#define RPG_GAMECORE_SKILLDATA_GET_LAYERTYPE_OFFSET UNITYSDK_OFFSET(0xDB41780)
#define RPG_GAMECORE_SKILLDATA_GET_READYANIMSTATE_OFFSET UNITYSDK_OFFSET(0xDB499D0)
#define RPG_GAMECORE_SKILLDATA_GET_ROOTSKILLDATA_OFFSET UNITYSDK_OFFSET(0xDB49E20)
#define RPG_GAMECORE_SKILLDATA_GET_SHOWASMENU_OFFSET UNITYSDK_OFFSET(0xDB49470)
#define RPG_GAMECORE_SKILLDATA_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0xDB498D0)
#define RPG_GAMECORE_SKILLDATA_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xDB38340)
#define RPG_GAMECORE_SKILLDATA_GET_SKILLLAYOUTKEY_OFFSET UNITYSDK_OFFSET(0xDB49550)
#define RPG_GAMECORE_SKILLDATA_GET_SLOT_OFFSET UNITYSDK_OFFSET(0xDB49D20)
#define RPG_GAMECORE_SKILLDATA_GET_SPADD_OFFSET UNITYSDK_OFFSET(0xDB48EF0)
#define RPG_GAMECORE_SKILLDATA_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0xDB49670)
#define RPG_GAMECORE_SKILLDATA_GET_SPECIALBUTTONTYPE_OFFSET UNITYSDK_OFFSET(0xDB49A70)
#define RPG_GAMECORE_SKILLDATA_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0xDB49620)
#define RPG_GAMECORE_SKILLDATA_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xDB495D0)
#define RPG_GAMECORE_SKILLDATA_GET_TARGETINFO_OFFSET UNITYSDK_OFFSET(0xDB382E0)
#define RPG_GAMECORE_SKILLDATA_GET_TARGETTEAMTYPE_OFFSET UNITYSDK_OFFSET(0xDB49710)
#define RPG_GAMECORE_SKILLDATA_GET_UISKILLINDEX_OFFSET UNITYSDK_OFFSET(0xDB493D0)
#define RPG_GAMECORE_SKILLDATA_GET__UICONFIG_OFFSET UNITYSDK_OFFSET(0xDB49B00)
#define RPG_GAMECORE_SKILLDATA_HASMULTITARGETGROUP_OFFSET UNITYSDK_OFFSET(0xDB4A5E0)
#define RPG_GAMECORE_SKILLDATA_MODIFYPROPERTY_OFFSET UNITYSDK_OFFSET(0xDB42730)
#define RPG_GAMECORE_SKILLDATA_REMOVETAGS_OFFSET UNITYSDK_OFFSET(0xDB4A110)
#define RPG_GAMECORE_SKILLDATA_SETDEFAULTPROPERTY_OFFSET UNITYSDK_OFFSET(0xDB3E300)
#define RPG_GAMECORE_SKILLDATA_SETOVERRIDEPROPERTY_OFFSET UNITYSDK_OFFSET(0xDB49F50)
#define RPG_GAMECORE_SKILLDATA_SET_SLOT_OFFSET UNITYSDK_OFFSET(0xDB49D90)
#define RPG_GAMECORE_SKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDB3E230)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ICharacterSkillRowData* RowData; // 0x40
		::Il2CppArray<::Struct_2_1DBF01015A93DAF5>* _SkillProperties; // 0x48
		::System::String* OverrideAnimState; // 0x50
		::System::String* SkillTriggerKey; // 0x58
		::RPG::GameCore::VCameraConfig* OverrideCameraConfig; // 0x60
		::Class_1_5F51D4049EA87B7B* InsertCondTask; // 0x68
		::RPG::GameCore::SkillCharacterComponent* SkillCom; // 0x70
		::Class_1_5F51D4049EA87B7B* VisibleCondTask; // 0x78
		::RPG::GameCore::SkillData* ParentSkillData; // 0x80
		::RPG::GameCore::SkillData* AssitLinkSourceSkill; // 0x88
		::System::Collections::Generic::List_1<::Class_1_0BF70B7AEC57376C*>* UsableConditionDatas; // 0x90
		::RPG::GameCore::SkillConfig* Config; // 0x98
		::System::Collections::Generic::List_1<::RPG::GameCore::SkillData*>* AllChildSkillDatas; // 0xA0
		::RPG::GameCore::SkillTargetConfig* DefaultTargetInfo; // 0xA8
		::System::Collections::Generic::HashSet_1<::RPG::GameCore::JsonEnum*>* Tags; // 0xB0
		::Il2CppArray<::Class_1_5F51D4049EA87B7B*>* CustomReadyConfigConditions; // 0xB8
		::RPG::GameCore::VCameraConfig* OverrideCameraConfigAdded; // 0xC0
		::Il2CppArray<::Class_1_5F51D4049EA87B7B*>* PreshowConditions; // 0xC8
		::Class_1_DD56E792A2635894* SkillTypeOverride; // 0xD0
		::Class_1_BCDC191CF05491FA* _Slot; // 0xD8
		::System::Int32 CurrentCoolDown; // 0xE0
		::System::UInt32 CommonActiveSkillID; // 0xE4
		::System::Int32 DefaultCoolDown; // 0xE8
		::System::Nullable_1<::System::Int32> OverrideAIUltraSkillPriority; // 0xEC
		::System::Boolean IgnoreDisableAction; // 0xF4
		::System::Int32 ChildIndex; // 0xF8
		::RPG::GameCore::AttackDamageType AttackDamageTypePreshowAttach; // 0xFC
		::System::Int32 LeftCastTimes; // 0x100
		::System::Int32 MaxCastTimes; // 0x104
		::System::Int32 SkillIndex; // 0x108
		::System::UInt32 SkillConfigID; // 0x10C
