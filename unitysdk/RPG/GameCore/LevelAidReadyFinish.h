...
#define RPG_GAMECORE_LEVELAIDREADYFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDAC0C20)
#define RPG_GAMECORE_LEVELAIDREADYFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDAC0BD0)
#define RPG_GAMECORE_LEVELAIDREADYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xDAC0C70)
