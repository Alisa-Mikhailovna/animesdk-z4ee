...
#define RPG_GAMECORE_FIVEDIMGRENADIERBAKEDMOVECONFIG_METHOD_3_C377C589DB3527E4_OFFSET UNITYSDK_OFFSET(0x1B431E30)
#define RPG_GAMECORE_FIVEDIMGRENADIERBAKEDMOVECONFIG_METHOD_3_C92A9C822C9A7F41_OFFSET UNITYSDK_OFFSET(0x1B431E70)
#define RPG_GAMECORE_FIVEDIMGRENADIERBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B431E60)
