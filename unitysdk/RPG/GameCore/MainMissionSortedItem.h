...
#define RPG_GAMECORE_MAINMISSIONSORTEDITEM_METHOD_2_3401DC3DD6D8C54F_OFFSET UNITYSDK_OFFSET(0x1B5A02D0)
#define RPG_GAMECORE_MAINMISSIONSORTEDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A03C0)
