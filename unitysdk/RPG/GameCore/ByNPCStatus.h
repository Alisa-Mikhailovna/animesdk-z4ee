...
#define RPG_GAMECORE_BYNPCSTATUS_METHOD_4_238357E57DFDB2BA_OFFSET UNITYSDK_OFFSET(0x1B2D7A60)
#define RPG_GAMECORE_BYNPCSTATUS_METHOD_4_2933C4A8C00EC582_OFFSET UNITYSDK_OFFSET(0x1B2D7CA0)
#define RPG_GAMECORE_BYNPCSTATUS_METHOD_4_A2031675BF4F6A77_OFFSET UNITYSDK_OFFSET(0x1B2D7AA0)
#define RPG_GAMECORE_BYNPCSTATUS_METHOD_4_BBA89CB53E45618C_OFFSET UNITYSDK_OFFSET(0x1B2D7CD0)
#define RPG_GAMECORE_BYNPCSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D7A90)
