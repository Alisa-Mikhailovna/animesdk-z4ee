...
#define RPG_GAMECORE_PLAYORIGAMITRACETALK_METHOD_3_6B33563FF74DE26A_OFFSET UNITYSDK_OFFSET(0x1B6C8820)
#define RPG_GAMECORE_PLAYORIGAMITRACETALK_METHOD_3_AC3213DE03C86F03_OFFSET UNITYSDK_OFFSET(0x1B6C8860)
#define RPG_GAMECORE_PLAYORIGAMITRACETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C8850)
