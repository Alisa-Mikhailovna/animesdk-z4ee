...
#define RPG_GAMECORE_VCAMERANOISECHANGE_METHOD_3_E814C3E1C32FD187_OFFSET UNITYSDK_OFFSET(0x1B9CD590)
#define RPG_GAMECORE_VCAMERANOISECHANGE_METHOD_3_F8AF5BF58C03A2A8_OFFSET UNITYSDK_OFFSET(0x1B9CC090)
#define RPG_GAMECORE_VCAMERANOISECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CD580)
