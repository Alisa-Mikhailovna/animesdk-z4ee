...
#define RPG_GAMECORE_RTLEVELDIMENSIONINFO_METHOD_2_7159EDB58142B4CA_OFFSET UNITYSDK_OFFSET(0x1B7BC350)
#define RPG_GAMECORE_RTLEVELDIMENSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7BC8C0)
