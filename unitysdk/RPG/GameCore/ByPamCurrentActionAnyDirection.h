...
#define RPG_GAMECORE_BYPAMCURRENTACTIONANYDIRECTION_METHOD_4_115123DCCE47D363_OFFSET UNITYSDK_OFFSET(0x1B2D9170)
#define RPG_GAMECORE_BYPAMCURRENTACTIONANYDIRECTION_METHOD_4_5BE3974A6D64A76B_OFFSET UNITYSDK_OFFSET(0x1B2D9320)
#define RPG_GAMECORE_BYPAMCURRENTACTIONANYDIRECTION_METHOD_4_8FA2E9E56FF4D4A0_OFFSET UNITYSDK_OFFSET(0x1B2D91B0)
#define RPG_GAMECORE_BYPAMCURRENTACTIONANYDIRECTION_METHOD_4_BF303AD8AE0CA1F6_OFFSET UNITYSDK_OFFSET(0x1B2D92F0)
#define RPG_GAMECORE_BYPAMCURRENTACTIONANYDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D91A0)
