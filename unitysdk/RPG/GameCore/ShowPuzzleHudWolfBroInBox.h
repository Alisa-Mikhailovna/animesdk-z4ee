...
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBROINBOX_METHOD_3_388C9D23147CECDB_OFFSET UNITYSDK_OFFSET(0x1B8D25D0)
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBROINBOX_METHOD_3_F037C5D90A51A308_OFFSET UNITYSDK_OFFSET(0x1B8D2590)
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBROINBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D25C0)
