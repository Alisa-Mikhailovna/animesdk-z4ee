...
#define RPG_GAMECORE_LEVELGROUPSPATIALINFO_METHOD_2_B7CE00FCB99BC24F_OFFSET UNITYSDK_OFFSET(0x1B55BAE0)
#define RPG_GAMECORE_LEVELGROUPSPATIALINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B55BB20)
