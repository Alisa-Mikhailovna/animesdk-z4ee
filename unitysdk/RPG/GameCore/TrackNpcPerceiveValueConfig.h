...
#define RPG_GAMECORE_TRACKNPCPERCEIVEVALUECONFIG_METHOD_2_654B493F1648967E_OFFSET UNITYSDK_OFFSET(0x1B979C40)
#define RPG_GAMECORE_TRACKNPCPERCEIVEVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B979E40)
