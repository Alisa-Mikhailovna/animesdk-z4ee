...
#define RPG_GAMECORE_FREESTYLEMOTIONINFOCONFIG_METHOD_2_A28C629BC37FEBB7_OFFSET UNITYSDK_OFFSET(0x1B4A17C0)
#define RPG_GAMECORE_FREESTYLEMOTIONINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A1910)
