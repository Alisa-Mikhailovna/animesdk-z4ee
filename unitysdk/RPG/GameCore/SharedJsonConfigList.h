...
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST_METHOD_3_139A26E62378A0B7_OFFSET UNITYSDK_OFFSET(0x1B8C05B0)
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1B8C06C0)
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST_METHOD_3_A99C79153FAE2D80_OFFSET UNITYSDK_OFFSET(0x1B8C0570)
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C05A0)
