...
#define RPG_GAMECORE_SHOWPLAYGOSUBPACKAGEDIALOG_METHOD_3_1BCBFEAABDDED5A4_OFFSET UNITYSDK_OFFSET(0x1B8D2150)
#define RPG_GAMECORE_SHOWPLAYGOSUBPACKAGEDIALOG_METHOD_3_BC9476EEB5BABF21_OFFSET UNITYSDK_OFFSET(0x1B8D2080)
#define RPG_GAMECORE_SHOWPLAYGOSUBPACKAGEDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D2140)
