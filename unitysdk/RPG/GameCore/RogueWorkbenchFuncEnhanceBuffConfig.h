...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCENHANCEBUFFCONFIG_METHOD_3_C2036D6AE1F3CC95_OFFSET UNITYSDK_OFFSET(0x1B7A4E10)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCENHANCEBUFFCONFIG_METHOD_3_DEAFF592860BD271_OFFSET UNITYSDK_OFFSET(0x1B7A5010)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCENHANCEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4E00)
