...
#define RPG_GAMECORE_STROYLINETRIALAVATARDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B91A710)
#define RPG_GAMECORE_STROYLINETRIALAVATARDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B91A920)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CaptainAvatarID; // 0x28
