...
#define RPG_GAMECORE_CHRONICLENODECONFIG_METHOD_2_93143C5D14A4B476_OFFSET UNITYSDK_OFFSET(0x1B35A8C0)
#define RPG_GAMECORE_CHRONICLENODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35AEE0)
