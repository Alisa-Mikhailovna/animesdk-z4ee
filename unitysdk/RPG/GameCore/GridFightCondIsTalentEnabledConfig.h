...
#define RPG_GAMECORE_GRIDFIGHTCONDISTALENTENABLEDCONFIG_METHOD_6_283874A4F172C7B3_OFFSET UNITYSDK_OFFSET(0x1B4D3CA0)
#define RPG_GAMECORE_GRIDFIGHTCONDISTALENTENABLEDCONFIG_METHOD_6_DE9A4F5F317960EF_OFFSET UNITYSDK_OFFSET(0x1B4D3C50)
#define RPG_GAMECORE_GRIDFIGHTCONDISTALENTENABLEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D3C90)
