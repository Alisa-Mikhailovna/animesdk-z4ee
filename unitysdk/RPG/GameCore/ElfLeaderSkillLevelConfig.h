...
#define RPG_GAMECORE_ELFLEADERSKILLLEVELCONFIG_METHOD_2_164F0CB4CFB31A99_OFFSET UNITYSDK_OFFSET(0x1B3DB710)
#define RPG_GAMECORE_ELFLEADERSKILLLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DB900)
