...
#define RPG_GAMECORE_ABILITYCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B0F4E60)
#define RPG_GAMECORE_ABILITYCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B0F4C30)
#define RPG_GAMECORE_ABILITYCONFIG_GETTASKLISTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1B0F5120)
#define RPG_GAMECORE_ABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F4E50)
