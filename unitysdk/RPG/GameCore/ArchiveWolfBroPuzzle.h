...
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE_METHOD_3_0FEF0F36814C832D_OFFSET UNITYSDK_OFFSET(0x1B1A8EE0)
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE_METHOD_3_D5C9B8912E863B6E_OFFSET UNITYSDK_OFFSET(0x1B1A8EA0)
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A8ED0)
