...
#define RPG_GAMECORE_DEFINEHPSHAREDGROUP_METHOD_3_2A4ACF4D434BB00C_OFFSET UNITYSDK_OFFSET(0x1B3A0790)
#define RPG_GAMECORE_DEFINEHPSHAREDGROUP_METHOD_3_5D767CC31CB9806D_OFFSET UNITYSDK_OFFSET(0x1B3A0740)
#define RPG_GAMECORE_DEFINEHPSHAREDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A0780)
