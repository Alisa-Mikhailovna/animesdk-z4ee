...
#define RPG_GAMECORE_PLAYERRETURNRECOMMENDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6D4090)
#define RPG_GAMECORE_PLAYERRETURNRECOMMENDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D43D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RecommendID; // 0x20
