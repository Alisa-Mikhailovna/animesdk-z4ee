...
#define RPG_GAMECORE_PRELOADITEMSILENCE_METHOD_2_598C07C9A42FA419_OFFSET UNITYSDK_OFFSET(0x1B6D8DB0)
#define RPG_GAMECORE_PRELOADITEMSILENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D8F30)
