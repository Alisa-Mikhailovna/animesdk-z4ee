...
#define RPG_GAMECORE_ENABLEFREELOOKCAMERADRAGMODE_METHOD_3_284B52517C6DE48F_OFFSET UNITYSDK_OFFSET(0x1B3E4120)
#define RPG_GAMECORE_ENABLEFREELOOKCAMERADRAGMODE_METHOD_3_4C8CDD76ED0D6A0A_OFFSET UNITYSDK_OFFSET(0x1B3E4160)
#define RPG_GAMECORE_ENABLEFREELOOKCAMERADRAGMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E4150)
