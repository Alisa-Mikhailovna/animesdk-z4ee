...
#define RPG_GAMECORE_EXITGAMEFLOW_METHOD_3_40F4CD8C7BBFBB95_OFFSET UNITYSDK_OFFSET(0x1B3FF9F0)
#define RPG_GAMECORE_EXITGAMEFLOW_METHOD_3_5A8006FACB5410FE_OFFSET UNITYSDK_OFFSET(0x1B3FF9B0)
#define RPG_GAMECORE_EXITGAMEFLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3FF9E0)
