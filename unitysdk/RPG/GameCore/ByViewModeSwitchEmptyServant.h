...
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT_METHOD_4_6F16FADC165AB03E_OFFSET UNITYSDK_OFFSET(0x1B2EDEC0)
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT_METHOD_4_8E5405B7E73B7FE2_OFFSET UNITYSDK_OFFSET(0x1B2EDCD0)
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT_METHOD_4_900B5B20E4D94A5B_OFFSET UNITYSDK_OFFSET(0x1B2EDD10)
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT_METHOD_4_D9D2D4B1067C6871_OFFSET UNITYSDK_OFFSET(0x1B2EDE90)
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EDD00)
