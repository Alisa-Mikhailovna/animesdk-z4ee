...
#define RPG_GAMECORE_VERIFYINTERACTINGENTITY_METHOD_3_BD178069C3DAAAC0_OFFSET UNITYSDK_OFFSET(0x1B9DBD50)
#define RPG_GAMECORE_VERIFYINTERACTINGENTITY_METHOD_3_D2D32DB3E3878CA5_OFFSET UNITYSDK_OFFSET(0x1B9DBD10)
#define RPG_GAMECORE_VERIFYINTERACTINGENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9DBD40)
