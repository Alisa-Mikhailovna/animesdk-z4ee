...
#define RPG_GAMECORE_POINTEVALUATORCONSTVALUE_METHOD_2_E2AB6B457551DEDF_OFFSET UNITYSDK_OFFSET(0x1B6D63E0)
#define RPG_GAMECORE_POINTEVALUATORCONSTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D64C0)
