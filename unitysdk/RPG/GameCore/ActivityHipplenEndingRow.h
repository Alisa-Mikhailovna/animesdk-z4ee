...
#define RPG_GAMECORE_ACTIVITYHIPPLENENDINGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B11B660)
#define RPG_GAMECORE_ACTIVITYHIPPLENENDINGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B11BA40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::HipplenStatType StatType; // 0x3C
		::RPG::Client::TextID Name; // 0x40
		::System::UInt32 RewardID; // 0x50
		::System::Boolean IsShowInGuidePage; // 0x54
