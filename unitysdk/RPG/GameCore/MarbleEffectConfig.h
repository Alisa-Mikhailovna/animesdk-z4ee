...
#define RPG_GAMECORE_MARBLEEFFECTCONFIG_METHOD_2_9AA5B4BDBCAE9945_OFFSET UNITYSDK_OFFSET(0x1B5B6380)
#define RPG_GAMECORE_MARBLEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B64F0)
