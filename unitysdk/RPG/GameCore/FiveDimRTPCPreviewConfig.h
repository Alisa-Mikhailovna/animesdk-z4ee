...
#define RPG_GAMECORE_FIVEDIMRTPCPREVIEWCONFIG_METHOD_2_104D3A4A256B4E4D_OFFSET UNITYSDK_OFFSET(0x1B4444C0)
#define RPG_GAMECORE_FIVEDIMRTPCPREVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B444500)
