...
#define RPG_GAMECORE_FIVEDIMMUSICEVENTINFO_METHOD_2_F26BB78BDB83EDAE_OFFSET UNITYSDK_OFFSET(0x1B43C8B0)
#define RPG_GAMECORE_FIVEDIMMUSICEVENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43C9D0)
