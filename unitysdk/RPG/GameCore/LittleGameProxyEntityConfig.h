...
#define RPG_GAMECORE_LITTLEGAMEPROXYENTITYCONFIG_METHOD_2_C198C91929929322_OFFSET UNITYSDK_OFFSET(0x1B589F40)
#define RPG_GAMECORE_LITTLEGAMEPROXYENTITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B58A0A0)
