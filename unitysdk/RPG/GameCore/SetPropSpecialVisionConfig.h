...
#define RPG_GAMECORE_SETPROPSPECIALVISIONCONFIG_METHOD_3_0240071B9C7AC37F_OFFSET UNITYSDK_OFFSET(0x1B8AFD90)
#define RPG_GAMECORE_SETPROPSPECIALVISIONCONFIG_METHOD_3_E142C5397B5070CA_OFFSET UNITYSDK_OFFSET(0x1B8AFD40)
#define RPG_GAMECORE_SETPROPSPECIALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8AFD80)
