...
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR_GETLEFTADJOINENTITY_OFFSET UNITYSDK_OFFSET(0xDBD2860)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR_GETRIGHTADJOINENTITY_OFFSET UNITYSDK_OFFSET(0xDBD28C0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR_PREPARE_OFFSET UNITYSDK_OFFSET(0xDBB7240)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR_RELEASE_OFFSET UNITYSDK_OFFSET(0xDBD2AD0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xDBBA0E0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR__INTERNALGETLEFTADJOINENTITY_OFFSET UNITYSDK_OFFSET(0xDBD2920)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR__INTERNALGETRIGHTADJOINENTITY_OFFSET UNITYSDK_OFFSET(0xDBD29F0)
