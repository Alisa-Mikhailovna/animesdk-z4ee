...
#define RPG_GAMECORE_UNDEFINEDYNAMICSTRING_METHOD_3_5DBC4BA19B252986_OFFSET UNITYSDK_OFFSET(0x1B9C0D30)
#define RPG_GAMECORE_UNDEFINEDYNAMICSTRING_METHOD_3_E295063720D08005_OFFSET UNITYSDK_OFFSET(0x1B9C0CF0)
#define RPG_GAMECORE_UNDEFINEDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C0D20)
