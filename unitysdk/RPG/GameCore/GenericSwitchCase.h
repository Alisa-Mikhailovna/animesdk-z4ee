...
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_21ABD1DF4508A05B_OFFSET UNITYSDK_OFFSET(0x1B4C9740)
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_2D3130CBABD03FE6_OFFSET UNITYSDK_OFFSET(0x1B4C9700)
#define RPG_GAMECORE_GENERICSWITCHCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C9730)
