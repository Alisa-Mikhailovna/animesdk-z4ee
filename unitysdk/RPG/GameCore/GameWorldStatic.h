...
#define RPG_GAMECORE_GAMEWORLDSTATIC_ISALLTEAMLIGHTENTITYDIED_OFFSET UNITYSDK_OFFSET(0xDAAE260)
#define RPG_GAMECORE_GAMEWORLDSTATIC_TRIGGERADVENTUREENTITYCUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xDAAE4E0)
#define RPG_GAMECORE_GAMEWORLDSTATIC_TRIGGERADVENTUREGROUPCUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xDAAE450)
#define RPG_GAMECORE_GAMEWORLDSTATIC_TRIGGERCUSTOMSTRINGEVENT_OFFSET UNITYSDK_OFFSET(0xDAAE3C0)
#define RPG_GAMECORE_GAMEWORLDSTATIC__CTOR_OFFSET UNITYSDK_OFFSET(0xDAAE660)
