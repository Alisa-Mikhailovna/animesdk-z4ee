...
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER_METHOD_3_2EF7F0CDED577361_OFFSET UNITYSDK_OFFSET(0x1B6E5840)
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER_METHOD_3_732E49F1C267C9A2_OFFSET UNITYSDK_OFFSET(0x1B6E57C0)
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E5810)
