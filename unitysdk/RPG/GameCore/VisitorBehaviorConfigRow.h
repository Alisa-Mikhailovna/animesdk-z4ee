...
#define RPG_GAMECORE_VISITORBEHAVIORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9DEEB0)
#define RPG_GAMECORE_VISITORBEHAVIORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9DF200)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DefaultPerformanceID; // 0x30
