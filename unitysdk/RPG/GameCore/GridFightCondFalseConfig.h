...
#define RPG_GAMECORE_GRIDFIGHTCONDFALSECONFIG_METHOD_6_0A4BE02C6DF4BA57_OFFSET UNITYSDK_OFFSET(0x1B4D3AD0)
#define RPG_GAMECORE_GRIDFIGHTCONDFALSECONFIG_METHOD_6_AEBA1E32B940FF3B_OFFSET UNITYSDK_OFFSET(0x1B4D3B20)
#define RPG_GAMECORE_GRIDFIGHTCONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D3B10)
