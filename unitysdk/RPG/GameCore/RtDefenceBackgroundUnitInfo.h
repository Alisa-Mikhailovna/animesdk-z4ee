...
#define RPG_GAMECORE_RTDEFENCEBACKGROUNDUNITINFO_METHOD_2_37F1BB344FD337CB_OFFSET UNITYSDK_OFFSET(0x1B7B7CD0)
#define RPG_GAMECORE_RTDEFENCEBACKGROUNDUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B7ED0)
