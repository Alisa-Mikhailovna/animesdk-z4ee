...
#define RPG_GAMECORE_VCAMERAFREELOOK3RDCONFIG_METHOD_2_816E4EA6E8E89FEF_OFFSET UNITYSDK_OFFSET(0x1B9CA4B0)
#define RPG_GAMECORE_VCAMERAFREELOOK3RDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CCBF0)
