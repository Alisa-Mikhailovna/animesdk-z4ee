...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::AdventureCharacterUnitState>**)Il2CppClass::FromTypeDefinitionIndex(ST_ByContainAbnormalState___O_TypeDefinitionIndex)->GetStaticField(0x57B50);
		}
	};
}
