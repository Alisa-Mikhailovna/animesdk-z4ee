...
#define RPG_GAMECORE_AUTOFIGHTVOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1BC4D0)
#define RPG_GAMECORE_AUTOFIGHTVOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1BCFD0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 ActionBeginAdvantage; // 0x10
