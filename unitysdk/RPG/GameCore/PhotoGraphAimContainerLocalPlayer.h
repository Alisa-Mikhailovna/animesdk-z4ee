...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERLOCALPLAYER_METHOD_3_2C4872823B9F4B73_OFFSET UNITYSDK_OFFSET(0x1B6A7220)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERLOCALPLAYER_METHOD_3_DC230AB034BE7E12_OFFSET UNITYSDK_OFFSET(0x1B6A72E0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERLOCALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A72A0)
