...
#define RPG_GAMECORE_FIVEDIMSUBMISSIONCONDITION_METHOD_2_2CA39FE4B3B9F556_OFFSET UNITYSDK_OFFSET(0x1B44C290)
#define RPG_GAMECORE_FIVEDIMSUBMISSIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44C3B0)
