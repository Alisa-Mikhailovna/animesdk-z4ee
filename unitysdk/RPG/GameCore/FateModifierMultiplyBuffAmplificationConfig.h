...
#define RPG_GAMECORE_FATEMODIFIERMULTIPLYBUFFAMPLIFICATIONCONFIG_METHOD_3_3E3A2EC5C2F3335D_OFFSET UNITYSDK_OFFSET(0x1B40C0C0)
#define RPG_GAMECORE_FATEMODIFIERMULTIPLYBUFFAMPLIFICATIONCONFIG_METHOD_3_D76632C6C9424399_OFFSET UNITYSDK_OFFSET(0x1B40C070)
#define RPG_GAMECORE_FATEMODIFIERMULTIPLYBUFFAMPLIFICATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40C0B0)
