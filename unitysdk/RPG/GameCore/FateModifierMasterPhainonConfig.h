...
#define RPG_GAMECORE_FATEMODIFIERMASTERPHAINONCONFIG_METHOD_3_3AC1D093159C6BDB_OFFSET UNITYSDK_OFFSET(0x1B40BE80)
#define RPG_GAMECORE_FATEMODIFIERMASTERPHAINONCONFIG_METHOD_3_59D8A9D28081F777_OFFSET UNITYSDK_OFFSET(0x1B40BE30)
#define RPG_GAMECORE_FATEMODIFIERMASTERPHAINONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40BE70)
