...
#define RPG_GAMECORE_WAITDYNAMICSKILLBUTTONINPUT_METHOD_3_7055AEF32CDA9B26_OFFSET UNITYSDK_OFFSET(0x1B9E4AC0)
#define RPG_GAMECORE_WAITDYNAMICSKILLBUTTONINPUT_METHOD_3_9925B0EB9A1D7609_OFFSET UNITYSDK_OFFSET(0x1B9E49C0)
#define RPG_GAMECORE_WAITDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E4A50)
