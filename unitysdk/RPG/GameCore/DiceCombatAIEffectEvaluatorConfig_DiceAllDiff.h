...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLDIFF_METHOD_3_2A7CDBA981A333B4_OFFSET UNITYSDK_OFFSET(0x1B3AA5B0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLDIFF_METHOD_3_3A3ECA25A12F6E09_OFFSET UNITYSDK_OFFSET(0x1B3A9B50)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLDIFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A9B40)
