...
#define RPG_GAMECORE_RTPROJECTILEDATALIST_METHOD_2_ADD06C4806FAE74D_OFFSET UNITYSDK_OFFSET(0x1B7C0880)
#define RPG_GAMECORE_RTPROJECTILEDATALIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C0A40)
