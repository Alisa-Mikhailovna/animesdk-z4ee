...
#define RPG_GAMECORE_SHAREREWARDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B8BFC10)
#define RPG_GAMECORE_SHAREREWARDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8BFD80)
