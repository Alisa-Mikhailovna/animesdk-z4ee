...
#define RPG_GAMECORE_SUMMONPARTNER_METHOD_3_87CAE12C7A4A24FA_OFFSET UNITYSDK_OFFSET(0x1B926A80)
#define RPG_GAMECORE_SUMMONPARTNER_METHOD_3_D0A3A446E2B1AEDB_OFFSET UNITYSDK_OFFSET(0x1B926A30)
#define RPG_GAMECORE_SUMMONPARTNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B926A70)
