...
#define RPG_GAMECORE_VP_INVERT_METHOD_3_6970F6AB54966964_OFFSET UNITYSDK_OFFSET(0x1B9D8470)
#define RPG_GAMECORE_VP_INVERT_METHOD_3_80255ECECD0A9FC7_OFFSET UNITYSDK_OFFSET(0x1B9D8410)
#define RPG_GAMECORE_VP_INVERT_METHOD_3_9C348CBA0CA77D51_OFFSET UNITYSDK_OFFSET(0x1B9D8490)
#define RPG_GAMECORE_VP_INVERT_METHOD_3_E1A8E2A685C74E56_OFFSET UNITYSDK_OFFSET(0x1B9D8390)
#define RPG_GAMECORE_VP_INVERT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D8400)
