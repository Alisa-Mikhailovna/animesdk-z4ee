...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRECYCLEROLECONFIG_METHOD_3_1FD5DF28DB93975D_OFFSET UNITYSDK_OFFSET(0x1B4E0C90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRECYCLEROLECONFIG_METHOD_3_B901E329E1E2A799_OFFSET UNITYSDK_OFFSET(0x1B4E0C40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRECYCLEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0C80)
