...
#define RPG_GAMECORE_FIVEDIMMOVETOSPECIFICSPLINEPOINTACTION_METHOD_3_AEA52F86B0C2914E_OFFSET UNITYSDK_OFFSET(0x1B43BE50)
#define RPG_GAMECORE_FIVEDIMMOVETOSPECIFICSPLINEPOINTACTION_METHOD_3_F422889C2474014B_OFFSET UNITYSDK_OFFSET(0x1B43BD90)
#define RPG_GAMECORE_FIVEDIMMOVETOSPECIFICSPLINEPOINTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43BE40)
