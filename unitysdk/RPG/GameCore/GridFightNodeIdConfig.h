...
#define RPG_GAMECORE_GRIDFIGHTNODEIDCONFIG_METHOD_2_5706BE90DA924E09_OFFSET UNITYSDK_OFFSET(0x1B4E2700)
#define RPG_GAMECORE_GRIDFIGHTNODEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E2820)
