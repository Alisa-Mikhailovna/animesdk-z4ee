...
#define RPG_GAMECORE_FIVEDIMSKILLPANELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B449900)
#define RPG_GAMECORE_FIVEDIMSKILLPANELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B449E90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID IpDesc2; // 0x30
		::RPG::Client::TextID Name; // 0x40
		::System::UInt32 ID; // 0x50
		::RPG::Client::TextID IpDesc; // 0x58
		::RPG::Client::TextID Desc1; // 0x68
		::RPG::Client::TextID SkillName; // 0x78
		::RPG::Client::TextID Desc2; // 0x88
