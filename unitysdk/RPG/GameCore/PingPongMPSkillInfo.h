...
#define RPG_GAMECORE_PINGPONGMPSKILLINFO_METHOD_2_3CBD7B338255B0B6_OFFSET UNITYSDK_OFFSET(0x1B6B1130)
#define RPG_GAMECORE_PINGPONGMPSKILLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B1260)
