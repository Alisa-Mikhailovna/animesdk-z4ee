...
#define RPG_GAMECORE_STAGEPVSOFFLINESCENEITEMINFO_METHOD_2_072711BD8F16EBED_OFFSET UNITYSDK_OFFSET(0x1B8FF560)
#define RPG_GAMECORE_STAGEPVSOFFLINESCENEITEMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8FF7C0)
