...
#define RPG_GAMECORE_FIVEDIMSPLINEMOVECOMPONENTCONFIG_METHOD_3_D3DB2208746763C6_OFFSET UNITYSDK_OFFSET(0x1B44A6C0)
#define RPG_GAMECORE_FIVEDIMSPLINEMOVECOMPONENTCONFIG_METHOD_3_E9C6E2449C486885_OFFSET UNITYSDK_OFFSET(0x1B44A700)
#define RPG_GAMECORE_FIVEDIMSPLINEMOVECOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44A6F0)
