...
#define RPG_GAMECORE_GROUPMEMBERENTITYANIMATORPARAMCONFIG_METHOD_2_10FA7D19B6D28272_OFFSET UNITYSDK_OFFSET(0x1B4F7260)
#define RPG_GAMECORE_GROUPMEMBERENTITYANIMATORPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F7470)
