...
#define RPG_GAMECORE_ELFHEADWAITERTALKCONFIG_METHOD_2_50BC829834E3C8D3_OFFSET UNITYSDK_OFFSET(0x1B3DB350)
#define RPG_GAMECORE_ELFHEADWAITERTALKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DB4A0)
