...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSAME_METHOD_3_4FF9A94A9C94541D_OFFSET UNITYSDK_OFFSET(0x1B3A9C90)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSAME_METHOD_3_A01E45598B6DB4F1_OFFSET UNITYSDK_OFFSET(0x1B3AA740)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A9C80)
