...
#define RPG_GAMECORE_VE_RTBATTLEGRIDORDER_METHOD_3_1F98DA12DEAB312A_OFFSET UNITYSDK_OFFSET(0x1B9D1A10)
#define RPG_GAMECORE_VE_RTBATTLEGRIDORDER_METHOD_3_4FEAAC22578428B3_OFFSET UNITYSDK_OFFSET(0x1B9D1C00)
#define RPG_GAMECORE_VE_RTBATTLEGRIDORDER_METHOD_3_57A78D7058BEAF9D_OFFSET UNITYSDK_OFFSET(0x1B9D1A50)
#define RPG_GAMECORE_VE_RTBATTLEGRIDORDER_METHOD_3_5BB1B665EA74DBD4_OFFSET UNITYSDK_OFFSET(0x1B9D1BD0)
#define RPG_GAMECORE_VE_RTBATTLEGRIDORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D1A40)
