...
#define RPG_GAMECORE_SHOWTUTORIALMASK_METHOD_3_3A76149DE1254C16_OFFSET UNITYSDK_OFFSET(0x1B8D6640)
#define RPG_GAMECORE_SHOWTUTORIALMASK_METHOD_3_B1A94EBA28683ED8_OFFSET UNITYSDK_OFFSET(0x1B8D65F0)
#define RPG_GAMECORE_SHOWTUTORIALMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D6630)
