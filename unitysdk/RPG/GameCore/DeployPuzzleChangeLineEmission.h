...
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEEMISSION_METHOD_3_58C9D1D425396900_OFFSET UNITYSDK_OFFSET(0x1B3A1290)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEEMISSION_METHOD_3_BD4D9294E10E0706_OFFSET UNITYSDK_OFFSET(0x1B3A1310)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A12E0)
