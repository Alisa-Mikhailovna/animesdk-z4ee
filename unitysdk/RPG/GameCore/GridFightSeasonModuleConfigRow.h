...
#define RPG_GAMECORE_GRIDFIGHTSEASONMODULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4EC2E0)
#define RPG_GAMECORE_GRIDFIGHTSEASONMODULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EC520)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 GirlHeroSpecialAvatarId; // 0x28
