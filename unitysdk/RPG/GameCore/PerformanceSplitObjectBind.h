...
#define RPG_GAMECORE_PERFORMANCESPLITOBJECTBIND_METHOD_2_B3205576D09D2D8C_OFFSET UNITYSDK_OFFSET(0x1B6A08F0)
#define RPG_GAMECORE_PERFORMANCESPLITOBJECTBIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A0A40)
