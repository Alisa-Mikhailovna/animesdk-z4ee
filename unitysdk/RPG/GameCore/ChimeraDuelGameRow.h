...
#define RPG_GAMECORE_CHIMERADUELGAMEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B34A690)
#define RPG_GAMECORE_CHIMERADUELGAMEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B34ADA0)
