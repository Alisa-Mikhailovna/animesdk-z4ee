...
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B91D6A0)
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1B91EC30)
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG_IFIGNOREVERSEPARAM_OFFSET UNITYSDK_OFFSET(0x1B91D640)
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B91EC20)
