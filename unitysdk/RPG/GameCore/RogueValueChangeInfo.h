...
#define RPG_GAMECORE_ROGUEVALUECHANGEINFO_METHOD_2_C62EBC2D96118321_OFFSET UNITYSDK_OFFSET(0x1B7A44D0)
#define RPG_GAMECORE_ROGUEVALUECHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4610)
