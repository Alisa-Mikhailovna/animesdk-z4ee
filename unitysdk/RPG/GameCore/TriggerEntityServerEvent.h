...
#define RPG_GAMECORE_TRIGGERENTITYSERVEREVENT_METHOD_3_6958616EC6997E13_OFFSET UNITYSDK_OFFSET(0x1B9A2A50)
#define RPG_GAMECORE_TRIGGERENTITYSERVEREVENT_METHOD_3_F88724E729D74966_OFFSET UNITYSDK_OFFSET(0x1B9A2A10)
#define RPG_GAMECORE_TRIGGERENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A2A40)
