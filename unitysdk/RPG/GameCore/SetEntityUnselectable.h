...
#define RPG_GAMECORE_SETENTITYUNSELECTABLE_METHOD_3_0C8A65CC46CCB8D6_OFFSET UNITYSDK_OFFSET(0x1B8A1AD0)
#define RPG_GAMECORE_SETENTITYUNSELECTABLE_METHOD_3_7AA843D33BD997C1_OFFSET UNITYSDK_OFFSET(0x1B8A1A90)
#define RPG_GAMECORE_SETENTITYUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A1AC0)
