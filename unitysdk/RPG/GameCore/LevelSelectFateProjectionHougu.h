...
#define RPG_GAMECORE_LEVELSELECTFATEPROJECTIONHOUGU_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADB2B0)
#define RPG_GAMECORE_LEVELSELECTFATEPROJECTIONHOUGU_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADB260)
#define RPG_GAMECORE_LEVELSELECTFATEPROJECTIONHOUGU_INIT_OFFSET UNITYSDK_OFFSET(0xDADB210)
#define RPG_GAMECORE_LEVELSELECTFATEPROJECTIONHOUGU__CTOR_OFFSET UNITYSDK_OFFSET(0xDADB300)
