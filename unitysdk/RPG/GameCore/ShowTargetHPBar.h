...
#define RPG_GAMECORE_SHOWTARGETHPBAR_METHOD_3_B384933BED98FE67_OFFSET UNITYSDK_OFFSET(0x1B8D56C0)
#define RPG_GAMECORE_SHOWTARGETHPBAR_METHOD_3_C3C3AABF0CC8C6D0_OFFSET UNITYSDK_OFFSET(0x1B8D5680)
#define RPG_GAMECORE_SHOWTARGETHPBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D56B0)
