...
#define RPG_GAMECORE_STAGEEXPORTGLOBALDATA_METHOD_2_71CD38E1E561950B_OFFSET UNITYSDK_OFFSET(0x1B8FBA40)
#define RPG_GAMECORE_STAGEEXPORTGLOBALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8FBA80)
