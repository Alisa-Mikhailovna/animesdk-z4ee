...
#define RPG_GAMECORE_PLAYERLOCKRANGECONFIG_METHOD_2_193F85E115477945_OFFSET UNITYSDK_OFFSET(0x1B6CED10)
#define RPG_GAMECORE_PLAYERLOCKRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CF280)
