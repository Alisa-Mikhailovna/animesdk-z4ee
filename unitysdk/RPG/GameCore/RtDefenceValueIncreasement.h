...
#define RPG_GAMECORE_RTDEFENCEVALUEINCREASEMENT_METHOD_2_C29214F3D1761D4E_OFFSET UNITYSDK_OFFSET(0x1B7B91B0)
#define RPG_GAMECORE_RTDEFENCEVALUEINCREASEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7BABE0)
