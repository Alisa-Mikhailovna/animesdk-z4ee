...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREVISUALEFFECT_METHOD_3_E0D3226175C0EFD6_OFFSET UNITYSDK_OFFSET(0x1B329A00)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREVISUALEFFECT_METHOD_3_F6332C8A489CCB0C_OFFSET UNITYSDK_OFFSET(0x1B3299A0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREVISUALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3299F0)
