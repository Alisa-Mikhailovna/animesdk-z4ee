...
#define RPG_GAMECORE_PRELOADGROUPSCORECONFIG_METHOD_2_6250FF2B6678082F_OFFSET UNITYSDK_OFFSET(0x1B6D86C0)
#define RPG_GAMECORE_PRELOADGROUPSCORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D87F0)
