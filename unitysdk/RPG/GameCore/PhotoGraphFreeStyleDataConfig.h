...
#define RPG_GAMECORE_PHOTOGRAPHFREESTYLEDATACONFIG_METHOD_2_1974A498E241626C_OFFSET UNITYSDK_OFFSET(0x1B6A9DD0)
#define RPG_GAMECORE_PHOTOGRAPHFREESTYLEDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A9F80)
