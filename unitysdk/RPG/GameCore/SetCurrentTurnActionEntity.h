...
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY_METHOD_3_0B6BDA2DC7B96C6D_OFFSET UNITYSDK_OFFSET(0x1B88DDF0)
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY_METHOD_3_C09D1AEAF3BBC4DC_OFFSET UNITYSDK_OFFSET(0x1B88DD50)
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88DDB0)
