...
#define RPG_GAMECORE_CHENLINGSOLDIERUNITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B33CCD0)
#define RPG_GAMECORE_CHENLINGSOLDIERUNITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B33D250)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint CrtDMG; // 0x20
		::RPG::GameCore::FixPoint Range; // 0x28
		::RPG::GameCore::FixPoint Crt; // 0x30
		::System::UInt32 UnitLevel; // 0x38
		::System::UInt32 UnitID; // 0x3C
		::RPG::GameCore::FixPoint MoveSpd; // 0x40
		::System::Single ReadyScale; // 0x48
