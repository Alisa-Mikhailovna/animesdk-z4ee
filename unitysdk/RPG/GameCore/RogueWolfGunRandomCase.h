...
#define RPG_GAMECORE_ROGUEWOLFGUNRANDOMCASE_METHOD_3_4233021C414BD2D9_OFFSET UNITYSDK_OFFSET(0x1B7A4700)
#define RPG_GAMECORE_ROGUEWOLFGUNRANDOMCASE_METHOD_3_43AC646C4EFB20D2_OFFSET UNITYSDK_OFFSET(0x1B7A46C0)
#define RPG_GAMECORE_ROGUEWOLFGUNRANDOMCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A46F0)
