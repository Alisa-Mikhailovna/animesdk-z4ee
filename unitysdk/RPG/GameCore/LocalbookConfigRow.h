...
#define RPG_GAMECORE_LOCALBOOKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5926D0)
#define RPG_GAMECORE_LOCALBOOKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B592E50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BookSeriesInsideID; // 0x1C
