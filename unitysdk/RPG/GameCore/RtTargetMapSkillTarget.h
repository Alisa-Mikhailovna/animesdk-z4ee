...
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET_METHOD_3_1D1DA2F919F64148_OFFSET UNITYSDK_OFFSET(0x1B7C9C90)
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET_METHOD_3_57E463234AA0370F_OFFSET UNITYSDK_OFFSET(0x1B7C9DD0)
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET_METHOD_3_ABCB5707B0D72F0B_OFFSET UNITYSDK_OFFSET(0x1B7C9D90)
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET_METHOD_3_B19FAAE7BA59BF2D_OFFSET UNITYSDK_OFFSET(0x1B7C9D30)
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C9D20)
