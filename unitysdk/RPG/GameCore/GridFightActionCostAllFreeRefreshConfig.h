...
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTALLFREEREFRESHCONFIG_METHOD_6_A8A6B2692107C8B7_OFFSET UNITYSDK_OFFSET(0x1B4D03C0)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTALLFREEREFRESHCONFIG_METHOD_6_EE6B2E6DB50AC473_OFFSET UNITYSDK_OFFSET(0x1B4D0670)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTALLFREEREFRESHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D03B0)
