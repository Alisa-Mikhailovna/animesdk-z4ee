...
#define RPG_GAMECORE_DEPLOYMAPPOSESWITCHER_METHOD_3_89BC49258C2DCC17_OFFSET UNITYSDK_OFFSET(0x1B3A0D40)
#define RPG_GAMECORE_DEPLOYMAPPOSESWITCHER_METHOD_3_FDEB56FB7DFFF35C_OFFSET UNITYSDK_OFFSET(0x1B3A0D00)
#define RPG_GAMECORE_DEPLOYMAPPOSESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A0D30)
