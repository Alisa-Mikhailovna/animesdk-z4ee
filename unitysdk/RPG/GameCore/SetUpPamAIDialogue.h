...
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE_METHOD_3_14421D5CABE283AA_OFFSET UNITYSDK_OFFSET(0x1B8B8E60)
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE_METHOD_3_2266F0BC0893EE47_OFFSET UNITYSDK_OFFSET(0x1B8B8D90)
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B8E50)
