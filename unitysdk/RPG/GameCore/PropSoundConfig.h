...
#define RPG_GAMECORE_PROPSOUNDCONFIG_METHOD_2_9444E3FB98087576_OFFSET UNITYSDK_OFFSET(0x1B6EF820)
#define RPG_GAMECORE_PROPSOUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EFBA0)
