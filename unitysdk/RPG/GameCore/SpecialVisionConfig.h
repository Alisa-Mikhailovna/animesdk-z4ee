...
#define RPG_GAMECORE_SPECIALVISIONCONFIG_METHOD_2_76CE8F4FC219CD39_OFFSET UNITYSDK_OFFSET(0x1B8EFD60)
#define RPG_GAMECORE_SPECIALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8F00B0)
