...
#define RPG_GAMECORE_SETFLOORCUSTOMFLOATV2_METHOD_3_0C129CD1F9DF8C63_OFFSET UNITYSDK_OFFSET(0x1B8A3E40)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOATV2_METHOD_3_BC4EB378196F434E_OFFSET UNITYSDK_OFFSET(0x1B8A3E80)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOATV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A3E70)
