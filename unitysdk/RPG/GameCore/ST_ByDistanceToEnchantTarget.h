...
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_267176B2C57D7B50_OFFSET UNITYSDK_OFFSET(0x1B7D2830)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_3040DEED8A11D295_OFFSET UNITYSDK_OFFSET(0x1B7D2A40)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_7F2682E52F72FA12_OFFSET UNITYSDK_OFFSET(0x1B7D2A70)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_DE5314C02C73D0E5_OFFSET UNITYSDK_OFFSET(0x1B7D27F0)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D2820)
