...
#define RPG_GAMECORE_TURNBASEDABILITYCONFIGLIST_METHOD_2_75B90BAB1ED990B8_OFFSET UNITYSDK_OFFSET(0x1B9B08A0)
#define RPG_GAMECORE_TURNBASEDABILITYCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B0B80)
