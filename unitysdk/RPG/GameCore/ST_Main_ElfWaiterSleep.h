...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSLEEP_METHOD_4_3740BC2DAD52ADBF_OFFSET UNITYSDK_OFFSET(0x1B7DBA80)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSLEEP_METHOD_4_6FBBDCB71BE51BA4_OFFSET UNITYSDK_OFFSET(0x1B7DBA40)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSLEEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7DBA70)
