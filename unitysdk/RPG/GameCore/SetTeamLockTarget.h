...
#define RPG_GAMECORE_SETTEAMLOCKTARGET_METHOD_3_287B754919770E7D_OFFSET UNITYSDK_OFFSET(0x1B8B6B80)
#define RPG_GAMECORE_SETTEAMLOCKTARGET_METHOD_3_7563BADB5738F40A_OFFSET UNITYSDK_OFFSET(0x1B8B6B40)
#define RPG_GAMECORE_SETTEAMLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B6B70)
