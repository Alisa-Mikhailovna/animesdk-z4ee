...
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_C968D56833687429_OFFSET UNITYSDK_OFFSET(0x1B2A2AF0)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_D4A76DECA8716838_OFFSET UNITYSDK_OFFSET(0x1B2A28A0)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_E8D7EBDEC2FE1141_OFFSET UNITYSDK_OFFSET(0x1B2A2860)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_FE4D109738BADBB6_OFFSET UNITYSDK_OFFSET(0x1B2A2AC0)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A2890)
