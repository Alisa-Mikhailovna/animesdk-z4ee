...
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET_METHOD_4_3BF9131457BBBA6B_OFFSET UNITYSDK_OFFSET(0x1B947400)
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET_METHOD_4_3FDCF70080D9C1D3_OFFSET UNITYSDK_OFFSET(0x1B947360)
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET_METHOD_4_AED67D417B9291D2_OFFSET UNITYSDK_OFFSET(0x1B9472C0)
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET_METHOD_4_E9770F8EA2D951C7_OFFSET UNITYSDK_OFFSET(0x1B9473C0)
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B947350)
