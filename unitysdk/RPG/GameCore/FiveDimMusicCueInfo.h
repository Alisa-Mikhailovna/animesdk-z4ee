...
#define RPG_GAMECORE_FIVEDIMMUSICCUEINFO_METHOD_2_8F05E86F238B0D95_OFFSET UNITYSDK_OFFSET(0x1B43C2D0)
#define RPG_GAMECORE_FIVEDIMMUSICCUEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43C480)
