...
#define RPG_GAMECORE_ST_MAIN_DOSKILL_METHOD_4_5B9CC7A7863849BD_OFFSET UNITYSDK_OFFSET(0x1B7D9860)
#define RPG_GAMECORE_ST_MAIN_DOSKILL_METHOD_4_D401253E8AA997FC_OFFSET UNITYSDK_OFFSET(0x1B7D9820)
#define RPG_GAMECORE_ST_MAIN_DOSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D9850)
