...
#define RPG_GAMECORE_CAKERACEMOVECONFIG_METHOD_2_122FA0AB612CB667_OFFSET UNITYSDK_OFFSET(0x1B2FAE40)
#define RPG_GAMECORE_CAKERACEMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FAFA0)
