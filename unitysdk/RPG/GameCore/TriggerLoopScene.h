...
#define RPG_GAMECORE_TRIGGERLOOPSCENE_METHOD_3_6FEA6A8D8BE40FBC_OFFSET UNITYSDK_OFFSET(0x1B9A44E0)
#define RPG_GAMECORE_TRIGGERLOOPSCENE_METHOD_3_B62884CBC2E98788_OFFSET UNITYSDK_OFFSET(0x1B9A4460)
#define RPG_GAMECORE_TRIGGERLOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A44B0)
