...
#define RPG_GAMECORE_ROLLSHOWREWARDCASECONTAINER_METHOD_3_52FB1D9A7A652577_OFFSET UNITYSDK_OFFSET(0x1B7A59A0)
#define RPG_GAMECORE_ROLLSHOWREWARDCASECONTAINER_METHOD_3_F0D40FCA4FC60460_OFFSET UNITYSDK_OFFSET(0x1B7A59E0)
#define RPG_GAMECORE_ROLLSHOWREWARDCASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A59D0)
