...
#define RPG_GAMECORE_ROGUEBONUSEVENTEFFECTCONFIG_METHOD_2_404883545EFC4BD4_OFFSET UNITYSDK_OFFSET(0x1B741C50)
#define RPG_GAMECORE_ROGUEBONUSEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B741C90)
