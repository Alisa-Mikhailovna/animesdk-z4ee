...
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_6E15D35AC5BF59F4_OFFSET UNITYSDK_OFFSET(0x1B3FFC10)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_ED7C0D849DC4D031_OFFSET UNITYSDK_OFFSET(0x1B3FFB40)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3FFC00)
