...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHALLENGERREVIVAL_METHOD_3_1B2D014C54A8A14B_OFFSET UNITYSDK_OFFSET(0x1B3B6DE0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHALLENGERREVIVAL_METHOD_3_B0D7C25E6A8EE06A_OFFSET UNITYSDK_OFFSET(0x1B3B6D40)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHALLENGERREVIVAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B6DD0)
