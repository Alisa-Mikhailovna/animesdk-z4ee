...
#define RPG_GAMECORE_GACHATYPEBASICINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4AAD60)
#define RPG_GAMECORE_GACHATYPEBASICINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AAFA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GachaType GachaTypeID; // 0x28
