...
#define RPG_GAMECORE_ROGUEDLCAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B750110)
#define RPG_GAMECORE_ROGUEDLCAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B750BB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* DifficultyID; // 0x28
		...
		::System::UInt32 MonsterEliteDropDisplayID; // 0x64
		::RPG::GameCore::ChessRogueDifficultyType Difficulty; // 0x68
		::RPG::GameCore::ChessRogueAreaGroupID AreaGroupID; // 0x6C
		::System::UInt32 UnlockID; // 0x70
		::System::UInt32 RecommendLevel; // 0x74
		::System::UInt32 FirstReward; // 0x78
