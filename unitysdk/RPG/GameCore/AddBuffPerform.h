...
#define RPG_GAMECORE_ADDBUFFPERFORM_METHOD_3_BB3A687FA067993D_OFFSET UNITYSDK_OFFSET(0x1B139D60)
#define RPG_GAMECORE_ADDBUFFPERFORM_METHOD_3_C40441C0B0DEFCCA_OFFSET UNITYSDK_OFFSET(0x1B139C60)
#define RPG_GAMECORE_ADDBUFFPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B139CF0)
