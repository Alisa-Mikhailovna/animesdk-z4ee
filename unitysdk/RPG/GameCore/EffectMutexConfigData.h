...
#define RPG_GAMECORE_EFFECTMUTEXCONFIGDATA_METHOD_2_1B76CF12BE3EEDF1_OFFSET UNITYSDK_OFFSET(0x1B3D6010)
#define RPG_GAMECORE_EFFECTMUTEXCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D6160)
