...
#define RPG_GAMECORE_RTTARGETMAPGRIDOWNER_METHOD_3_5EC4CE779EB196B2_OFFSET UNITYSDK_OFFSET(0x1B7C8A70)
#define RPG_GAMECORE_RTTARGETMAPGRIDOWNER_METHOD_3_899EF891AAFA61E5_OFFSET UNITYSDK_OFFSET(0x1B7C8930)
#define RPG_GAMECORE_RTTARGETMAPGRIDOWNER_METHOD_3_A60A4D91141B3820_OFFSET UNITYSDK_OFFSET(0x1B7C89D0)
#define RPG_GAMECORE_RTTARGETMAPGRIDOWNER_METHOD_3_C4E4CF1571A0E5D6_OFFSET UNITYSDK_OFFSET(0x1B7C8A30)
#define RPG_GAMECORE_RTTARGETMAPGRIDOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C89C0)
