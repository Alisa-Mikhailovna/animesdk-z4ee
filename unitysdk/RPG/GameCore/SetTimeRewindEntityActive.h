...
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_1975C5DAE9BE3B75_OFFSET UNITYSDK_OFFSET(0x1B8B7710)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_FC308DDFCB99CE42_OFFSET UNITYSDK_OFFSET(0x1B8B76D0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B7700)
