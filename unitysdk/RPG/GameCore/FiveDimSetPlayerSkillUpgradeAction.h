...
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLUPGRADEACTION_METHOD_3_A437919812A0D8A8_OFFSET UNITYSDK_OFFSET(0x1B447BB0)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLUPGRADEACTION_METHOD_3_E5E40830D9662125_OFFSET UNITYSDK_OFFSET(0x1B447C90)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLUPGRADEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B447C80)
