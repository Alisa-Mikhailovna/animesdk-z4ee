...
#define RPG_GAMECORE_UNLOADBACKGROUNDPLAYER_METHOD_3_2800F9CD013DB176_OFFSET UNITYSDK_OFFSET(0x1B9C64D0)
#define RPG_GAMECORE_UNLOADBACKGROUNDPLAYER_METHOD_3_D7C7B488384FD88D_OFFSET UNITYSDK_OFFSET(0x1B9C6480)
#define RPG_GAMECORE_UNLOADBACKGROUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C64C0)
