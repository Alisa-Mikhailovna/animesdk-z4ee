...
#define RPG_GAMECORE_MUSEUMTARGETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6421E0)
#define RPG_GAMECORE_MUSEUMTARGETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B642920)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TriggerTurns; // 0x18
		::RPG::GameCore::MuseumTargetRewardType RewardType; // 0x1C
		::System::UInt32 TriggerPhase; // 0x20
