...
#define RPG_GAMECORE_AVATARSKILLTREEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B1E02F0)
#define RPG_GAMECORE_AVATARSKILLTREEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1E0A30)
#define RPG_GAMECORE_AVATARSKILLTREEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B1E0250)
#define RPG_GAMECORE_AVATARSKILLTREEROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B1E02B0)
#define RPG_GAMECORE_AVATARSKILLTREEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1E11C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* SimplePointDesc; // 0x18
		::Il2CppArray<::RPG::GameCore::ItemConfig*>* MaterialList; // 0x20
		...
		::System::String* PointDesc; // 0x40
		::Il2CppArray<::RPG::GameCore::AvatarPropertyValue*>* StatusAddList; // 0x48
		::Il2CppArray<::System::UInt32>* PrePoint; // 0x50
		...
		::System::Boolean DefaultUnlock; // 0x70
		::System::UInt32 EnhancedID; // 0x74
		::RPG::GameCore::AvatarSkillTreeAnchorType AnchorType; // 0x78
		::System::UInt32 AvatarPromotionLimit; // 0x7C
		::System::UInt32 RecommendPriority; // 0x80
		::System::UInt32 MaxLevel; // 0x84
		::System::UInt32 Level; // 0x88
		::System::UInt32 PointID; // 0x8C
		::System::UInt32 PointType; // 0x90
		::RPG::GameCore::AvatarSkillTreePointTriggerKey PointTriggerKey; // 0x94
