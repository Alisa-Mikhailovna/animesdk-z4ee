...
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE_METHOD_4_5576D8B107C1464B_OFFSET UNITYSDK_OFFSET(0x1B5B52E0)
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE_METHOD_4_D1053C173B1BCC39_OFFSET UNITYSDK_OFFSET(0x1B5B5280)
#define RPG_GAMECORE_MARBLEBYTRIGGERFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B52D0)
