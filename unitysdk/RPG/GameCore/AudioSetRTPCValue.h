...
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_C68FCD99CEC4658B_OFFSET UNITYSDK_OFFSET(0x1B1BB8B0)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_DAD22F0FB571C142_OFFSET UNITYSDK_OFFSET(0x1B1BB870)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1BB8A0)
