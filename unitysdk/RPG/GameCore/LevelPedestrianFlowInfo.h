...
#define RPG_GAMECORE_LEVELPEDESTRIANFLOWINFO_METHOD_2_73447E5E24EAEC41_OFFSET UNITYSDK_OFFSET(0x1B56C1A0)
#define RPG_GAMECORE_LEVELPEDESTRIANFLOWINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B56C430)
