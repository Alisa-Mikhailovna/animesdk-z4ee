...
#define RPG_GAMECORE_CAKERACECATAICONFIG_METHOD_2_5A3152F0034737CB_OFFSET UNITYSDK_OFFSET(0x1B2F6F80)
#define RPG_GAMECORE_CAKERACECATAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F7340)
