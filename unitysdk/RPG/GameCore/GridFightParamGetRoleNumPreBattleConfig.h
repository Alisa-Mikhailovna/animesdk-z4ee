...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMPREBATTLECONFIG_METHOD_6_6B8B6AA7E6B4914C_OFFSET UNITYSDK_OFFSET(0x1B4E43A0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMPREBATTLECONFIG_METHOD_6_E53AF3874EE0B4D0_OFFSET UNITYSDK_OFFSET(0x1B4E4350)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMPREBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E4390)
