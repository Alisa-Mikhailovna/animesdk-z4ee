...
#define RPG_GAMECORE_SETNAVMESHSTATE_METHOD_3_7B920410862438EF_OFFSET UNITYSDK_OFFSET(0x1B8ADC70)
#define RPG_GAMECORE_SETNAVMESHSTATE_METHOD_3_A29C5F37C9C9B3B8_OFFSET UNITYSDK_OFFSET(0x1B8ADC30)
#define RPG_GAMECORE_SETNAVMESHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8ADC60)
