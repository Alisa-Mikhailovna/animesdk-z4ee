...
#define RPG_GAMECORE_DISTRICTAREASOUNDTRANSFORM_METHOD_2_C657B8AD93CF3436_OFFSET UNITYSDK_OFFSET(0x1B3BDB50)
#define RPG_GAMECORE_DISTRICTAREASOUNDTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3BDCA0)
