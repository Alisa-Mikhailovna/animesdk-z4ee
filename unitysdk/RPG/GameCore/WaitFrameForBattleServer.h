...
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER_METHOD_3_BCF9AB2A0F1C68B4_OFFSET UNITYSDK_OFFSET(0x1B9E77D0)
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER_METHOD_3_F0602D528E7B9CE7_OFFSET UNITYSDK_OFFSET(0x1B9E7780)
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E77C0)
