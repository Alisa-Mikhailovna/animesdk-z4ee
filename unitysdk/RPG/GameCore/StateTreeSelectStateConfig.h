...
#define RPG_GAMECORE_STATETREESELECTSTATECONFIG_METHOD_2_07D210A084BDAD88_OFFSET UNITYSDK_OFFSET(0x1B90C390)
#define RPG_GAMECORE_STATETREESELECTSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B90C4C0)
