...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMPREBATTLEBYEQUIPNUMCONFIG_METHOD_6_B4A1796EA773DBB9_OFFSET UNITYSDK_OFFSET(0x1B4E42F0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMPREBATTLEBYEQUIPNUMCONFIG_METHOD_6_CFB870E375B556FD_OFFSET UNITYSDK_OFFSET(0x1B4E4340)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMPREBATTLEBYEQUIPNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E4330)
