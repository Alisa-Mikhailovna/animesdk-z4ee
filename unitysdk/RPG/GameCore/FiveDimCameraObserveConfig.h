...
#define RPG_GAMECORE_FIVEDIMCAMERAOBSERVECONFIG_METHOD_2_FD7B29C8EF191907_OFFSET UNITYSDK_OFFSET(0x1B422C80)
#define RPG_GAMECORE_FIVEDIMCAMERAOBSERVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4241D0)
