...
#define RPG_GAMECORE_GIFTDANMUSENDERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4CA1D0)
#define RPG_GAMECORE_GIFTDANMUSENDERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CA3A0)
