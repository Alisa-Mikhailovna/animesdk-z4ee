...
#define RPG_GAMECORE_TRIGGERROGUEDIALOGUE_METHOD_3_0316CD0EC67B6802_OFFSET UNITYSDK_OFFSET(0x1B9A8360)
#define RPG_GAMECORE_TRIGGERROGUEDIALOGUE_METHOD_3_BDF3076556BF0CF9_OFFSET UNITYSDK_OFFSET(0x1B9A8320)
#define RPG_GAMECORE_TRIGGERROGUEDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A8350)
