...
#define RPG_GAMECORE_SETGRAPHDYNAMICFLOAT_METHOD_3_DA7D9B4F9F375F67_OFFSET UNITYSDK_OFFSET(0x1B8A4CE0)
#define RPG_GAMECORE_SETGRAPHDYNAMICFLOAT_METHOD_3_FBA12263B9F9FB3E_OFFSET UNITYSDK_OFFSET(0x1B8A4D30)
#define RPG_GAMECORE_SETGRAPHDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A4D20)
