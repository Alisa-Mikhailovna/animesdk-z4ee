...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRABINARYNODERULECONFIG_METHOD_3_59C90B4912C1160D_OFFSET UNITYSDK_OFFSET(0x1B4DFF90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRABINARYNODERULECONFIG_METHOD_3_B82BC2A65E9C22F1_OFFSET UNITYSDK_OFFSET(0x1B4DFFE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRABINARYNODERULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DFFD0)
