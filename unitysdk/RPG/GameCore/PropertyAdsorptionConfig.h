...
#define RPG_GAMECORE_PROPERTYADSORPTIONCONFIG_METHOD_2_E35973DF0AD0AA2F_OFFSET UNITYSDK_OFFSET(0x1B6F4560)
#define RPG_GAMECORE_PROPERTYADSORPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F46D0)
