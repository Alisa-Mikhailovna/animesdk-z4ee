...
#define RPG_GAMECORE_DAMAGETEXTTEAMPOOLCONFIG_METHOD_2_1267694444390973_OFFSET UNITYSDK_OFFSET(0x1B397F40)
#define RPG_GAMECORE_DAMAGETEXTTEAMPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B398140)
