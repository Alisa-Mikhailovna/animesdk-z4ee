...
#define RPG_GAMECORE_SPRITEPRESETSINFOLDER_METHOD_2_A2251CD588FEE1C9_OFFSET UNITYSDK_OFFSET(0x1B8F0E30)
#define RPG_GAMECORE_SPRITEPRESETSINFOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8F0F30)
