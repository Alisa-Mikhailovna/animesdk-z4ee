...
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEINTENSITY_METHOD_3_7297CD96B64313A5_OFFSET UNITYSDK_OFFSET(0x1B3A1590)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEINTENSITY_METHOD_3_DCBEDDEB5C78BDDB_OFFSET UNITYSDK_OFFSET(0x1B3A1500)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEINTENSITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A1560)
