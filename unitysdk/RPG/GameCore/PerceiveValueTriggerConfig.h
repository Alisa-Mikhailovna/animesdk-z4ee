...
#define RPG_GAMECORE_PERCEIVEVALUETRIGGERCONFIG_METHOD_2_74F8118125EBCC2F_OFFSET UNITYSDK_OFFSET(0x1B68F450)
#define RPG_GAMECORE_PERCEIVEVALUETRIGGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68F5B0)
