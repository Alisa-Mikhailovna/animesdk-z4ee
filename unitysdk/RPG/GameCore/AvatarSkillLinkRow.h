...
#define RPG_GAMECORE_AVATARSKILLLINKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1DCEB0)
#define RPG_GAMECORE_AVATARSKILLLINKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1DD050)
