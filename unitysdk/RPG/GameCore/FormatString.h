...
#define RPG_GAMECORE_FORMATSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x39E1050)
#define RPG_GAMECORE_FORMATSTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x39F9550)
#define RPG_GAMECORE_FORMATSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x39E1050)
#define RPG_GAMECORE_FORMATSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x39F95D0)
#define RPG_GAMECORE_FORMATSTRING_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x39F9510)
#define RPG_GAMECORE_FORMATSTRING_GET_RAWSTRING_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_188EEAAB5C523CC8_OFFSET UNITYSDK_OFFSET(0x1B456830)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_2ED2786CBF32344F_OFFSET UNITYSDK_OFFSET(0x1B4568A0)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_553F65DA53A86C11_OFFSET UNITYSDK_OFFSET(0x1B456910)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_737FB5FD0C118D8F_OFFSET UNITYSDK_OFFSET(0x1B456940)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_D964DB46312B7B08_OFFSET UNITYSDK_OFFSET(0x1B456860)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_E6ABB66B71544341_OFFSET UNITYSDK_OFFSET(0x1B4568D0)
#define RPG_GAMECORE_FORMATSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define RPG_GAMECORE_FORMATSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x39F9530)
