...
#define RPG_GAMECORE_STAGEAUTOGENCONFIG_METHOD_2_3278101654E30287_OFFSET UNITYSDK_OFFSET(0x1B8F3D50)
#define RPG_GAMECORE_STAGEAUTOGENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8F3FF0)
