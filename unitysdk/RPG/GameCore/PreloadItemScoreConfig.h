...
#define RPG_GAMECORE_PRELOADITEMSCORECONFIG_METHOD_2_365B32DD689A96D6_OFFSET UNITYSDK_OFFSET(0x1B6D89E0)
#define RPG_GAMECORE_PRELOADITEMSCORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D8AC0)
