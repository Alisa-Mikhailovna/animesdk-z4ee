...
#define RPG_GAMECORE_CONFIGBAKELAYOUTINFOLIST_METHOD_2_00736BBB01AACE78_OFFSET UNITYSDK_OFFSET(0x1B37BAD0)
#define RPG_GAMECORE_CONFIGBAKELAYOUTINFOLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B37BB90)
