...
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDCARDREROLL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADADA0)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDCARDREROLL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADAD50)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDCARDREROLL_INIT_OFFSET UNITYSDK_OFFSET(0xDADAD00)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDCARDREROLL__CTOR_OFFSET UNITYSDK_OFFSET(0xDADADF0)
