...
#define RPG_GAMECORE_ELFWAVECONFIG_METHOD_2_0680375E610F94B8_OFFSET UNITYSDK_OFFSET(0x1B3DEA00)
#define RPG_GAMECORE_ELFWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DEC10)
