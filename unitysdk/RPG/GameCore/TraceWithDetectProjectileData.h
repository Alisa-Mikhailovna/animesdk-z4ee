...
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA_METHOD_3_2A6A1E8CF9DAAD82_OFFSET UNITYSDK_OFFSET(0x1B978790)
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA_METHOD_3_6A1F709BBE7A8581_OFFSET UNITYSDK_OFFSET(0x1B9788B0)
#define RPG_GAMECORE_TRACEWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B978830)
