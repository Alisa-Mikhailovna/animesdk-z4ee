...
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_2D6B44385D8B2DC4_OFFSET UNITYSDK_OFFSET(0x1B2A9070)
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_66B8DAF8943AF645_OFFSET UNITYSDK_OFFSET(0x1B2A90A0)
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_7A69B11D65C9CB7A_OFFSET UNITYSDK_OFFSET(0x1B2A8F30)
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_93BFABDCEBBB7A71_OFFSET UNITYSDK_OFFSET(0x1B2A8EF0)
#define RPG_GAMECORE_BYISCONVERTDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A8F20)
