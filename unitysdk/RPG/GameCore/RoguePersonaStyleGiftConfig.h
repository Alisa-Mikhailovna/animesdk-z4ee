...
#define RPG_GAMECORE_ROGUEPERSONASTYLEGIFTCONFIG_METHOD_2_77313293B8640703_OFFSET UNITYSDK_OFFSET(0x1B78AF60)
#define RPG_GAMECORE_ROGUEPERSONASTYLEGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B78AFA0)
