...
#define RPG_GAMECORE_ENABLESPECIFICMODIFIERSPECIALMARK_METHOD_3_23CCFDA1CCB7EA2F_OFFSET UNITYSDK_OFFSET(0x1B3E5D40)
#define RPG_GAMECORE_ENABLESPECIFICMODIFIERSPECIALMARK_METHOD_3_EE1B305C57C43DF8_OFFSET UNITYSDK_OFFSET(0x1B3E5D00)
#define RPG_GAMECORE_ENABLESPECIFICMODIFIERSPECIALMARK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E5D30)
