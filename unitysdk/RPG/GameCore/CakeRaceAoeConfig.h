...
#define RPG_GAMECORE_CAKERACEAOECONFIG_METHOD_2_7EB775C43C5E7AD7_OFFSET UNITYSDK_OFFSET(0x1B2F4A90)
#define RPG_GAMECORE_CAKERACEAOECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F5490)
