...
#define RPG_GAMECORE_AVATARTRANSITIONCONFIG_METHOD_2_7069306F6B71ADD0_OFFSET UNITYSDK_OFFSET(0x1B1E3B70)
#define RPG_GAMECORE_AVATARTRANSITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1E3C60)
