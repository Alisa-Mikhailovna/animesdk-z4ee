...
#define RPG_GAMECORE_CAKERACEEVENTHANDLER_METHOD_2_68B37272104A6A35_OFFSET UNITYSDK_OFFSET(0x1B2F8DC0)
#define RPG_GAMECORE_CAKERACEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F8F80)
