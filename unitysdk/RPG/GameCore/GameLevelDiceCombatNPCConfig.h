...
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG_METHOD_2_61A84F0DEABDCC3F_OFFSET UNITYSDK_OFFSET(0x1B4C27A0)
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C28E0)
