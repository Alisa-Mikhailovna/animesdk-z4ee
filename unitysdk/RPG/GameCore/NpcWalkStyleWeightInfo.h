...
#define RPG_GAMECORE_NPCWALKSTYLEWEIGHTINFO_METHOD_2_D1A8F1370253D8F3_OFFSET UNITYSDK_OFFSET(0x1B6786E0)
#define RPG_GAMECORE_NPCWALKSTYLEWEIGHTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B678880)
