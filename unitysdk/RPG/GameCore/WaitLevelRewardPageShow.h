...
#define RPG_GAMECORE_WAITLEVELREWARDPAGESHOW_METHOD_3_2B608EAF98213575_OFFSET UNITYSDK_OFFSET(0x1B9E9100)
#define RPG_GAMECORE_WAITLEVELREWARDPAGESHOW_METHOD_3_A5C5993090FE2276_OFFSET UNITYSDK_OFFSET(0x1B9E9140)
#define RPG_GAMECORE_WAITLEVELREWARDPAGESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E9130)
