...
#define RPG_GAMECORE_TURNINSERTABILITYCONDITIONGROUP_METHOD_3_B0736C7AC55E0F5E_OFFSET UNITYSDK_OFFSET(0x1B9B3370)
#define RPG_GAMECORE_TURNINSERTABILITYCONDITIONGROUP_METHOD_3_D4253C52C3A5DD89_OFFSET UNITYSDK_OFFSET(0x1B9B3220)
#define RPG_GAMECORE_TURNINSERTABILITYCONDITIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B3210)
