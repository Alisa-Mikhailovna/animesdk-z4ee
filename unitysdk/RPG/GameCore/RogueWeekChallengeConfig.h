...
#define RPG_GAMECORE_ROGUEWEEKCHALLENGECONFIG_METHOD_2_5B7EEFF88A395C7D_OFFSET UNITYSDK_OFFSET(0x1B7A4670)
#define RPG_GAMECORE_ROGUEWEEKCHALLENGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A46B0)
