...
#define RPG_GAMECORE_SHOWSWIPEGUIDE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B8D4E70)
#define RPG_GAMECORE_SHOWSWIPEGUIDE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B8D4E10)
#define RPG_GAMECORE_SHOWSWIPEGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D4E50)
