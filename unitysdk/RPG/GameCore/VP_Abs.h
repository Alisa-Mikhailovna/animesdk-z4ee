...
#define RPG_GAMECORE_VP_ABS_METHOD_3_0856BE86AB8B1C5E_OFFSET UNITYSDK_OFFSET(0x1B9D76D0)
#define RPG_GAMECORE_VP_ABS_METHOD_3_4C424A12BB0190C1_OFFSET UNITYSDK_OFFSET(0x1B9D7670)
#define RPG_GAMECORE_VP_ABS_METHOD_3_916BD9CB1FA7290B_OFFSET UNITYSDK_OFFSET(0x1B9D76F0)
#define RPG_GAMECORE_VP_ABS_METHOD_3_E8F401B3C9B986AC_OFFSET UNITYSDK_OFFSET(0x1B9D75F0)
#define RPG_GAMECORE_VP_ABS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D7660)
