...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::AttackType>**)Il2CppClass::FromTypeDefinitionIndex(ByAttackType___O_TypeDefinitionIndex)->GetStaticField(0x28E70);
		}
	};
}
