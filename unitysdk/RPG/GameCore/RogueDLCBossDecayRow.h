...
#define RPG_GAMECORE_ROGUEDLCBOSSDECAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B753620)
#define RPG_GAMECORE_ROGUEDLCBOSSDECAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B753FB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BossDecayID; // 0x4C
		::System::Boolean IsBuff; // 0x50
		::RPG::Client::TextID BossDecayName; // 0x58
