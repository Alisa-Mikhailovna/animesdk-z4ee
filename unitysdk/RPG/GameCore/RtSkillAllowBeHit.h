...
#define RPG_GAMECORE_RTSKILLALLOWBEHIT_METHOD_3_82FFA4FBB28A09CC_OFFSET UNITYSDK_OFFSET(0x1B7C18B0)
#define RPG_GAMECORE_RTSKILLALLOWBEHIT_METHOD_3_A1B76331252C6F09_OFFSET UNITYSDK_OFFSET(0x1B7C1980)
#define RPG_GAMECORE_RTSKILLALLOWBEHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C1970)
