...
#define RPG_GAMECORE_WAITRANDOMSECOND_METHOD_3_6750BA2B7AAE6633_OFFSET UNITYSDK_OFFSET(0x1B9EDD50)
#define RPG_GAMECORE_WAITRANDOMSECOND_METHOD_3_DEC8E5E47DCFFBB4_OFFSET UNITYSDK_OFFSET(0x1B9EDD90)
#define RPG_GAMECORE_WAITRANDOMSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EDD80)
