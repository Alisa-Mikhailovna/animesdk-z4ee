...
#define RPG_GAMECORE_RTBEHAVIORFLAGLISTPAIR_METHOD_2_941353DBFAB69BBB_OFFSET UNITYSDK_OFFSET(0x1B7ADFD0)
#define RPG_GAMECORE_RTBEHAVIORFLAGLISTPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7AE0F0)
