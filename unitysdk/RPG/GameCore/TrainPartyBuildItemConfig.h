...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMCONFIG_METHOD_2_B9F2FDA3756AE097_OFFSET UNITYSDK_OFFSET(0x1B97D9D0)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97DAC0)
