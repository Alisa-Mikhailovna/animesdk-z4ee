...
#define RPG_GAMECORE_DYNAMICTOASTCONFIG_METHOD_2_125697B156F1C21A_OFFSET UNITYSDK_OFFSET(0x1B3CF550)
#define RPG_GAMECORE_DYNAMICTOASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3CF6C0)
