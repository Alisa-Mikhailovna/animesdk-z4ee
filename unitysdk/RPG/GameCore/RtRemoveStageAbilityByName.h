...
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME_METHOD_3_A43DEE9BFA5ACB9E_OFFSET UNITYSDK_OFFSET(0x1B7C0EF0)
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME_METHOD_3_CA6C7B32A3F8645D_OFFSET UNITYSDK_OFFSET(0x1B7C0EB0)
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C0EE0)
