...
#define RPG_GAMECORE_ATTACHMENTVISIBILITYNODE_METHOD_2_C33412427F5539BF_OFFSET UNITYSDK_OFFSET(0x1B1B5050)
#define RPG_GAMECORE_ATTACHMENTVISIBILITYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B5290)
