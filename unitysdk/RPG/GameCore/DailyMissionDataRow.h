...
#define RPG_GAMECORE_DAILYMISSIONDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B394830)
#define RPG_GAMECORE_DAILYMISSIONDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B394F20)
