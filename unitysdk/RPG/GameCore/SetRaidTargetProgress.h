...
#define RPG_GAMECORE_SETRAIDTARGETPROGRESS_METHOD_3_C5E406D3A022C9B5_OFFSET UNITYSDK_OFFSET(0x1B8AFFB0)
#define RPG_GAMECORE_SETRAIDTARGETPROGRESS_METHOD_3_E55AA99159641310_OFFSET UNITYSDK_OFFSET(0x1B8AFF60)
#define RPG_GAMECORE_SETRAIDTARGETPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8AFFA0)
