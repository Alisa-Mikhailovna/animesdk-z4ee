...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLESTARNUMCONFIG_METHOD_6_C2185BC870967F01_OFFSET UNITYSDK_OFFSET(0x1B4E4400)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLESTARNUMCONFIG_METHOD_6_E1B9B0B29DAEBADD_OFFSET UNITYSDK_OFFSET(0x1B4E43B0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLESTARNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E43F0)
