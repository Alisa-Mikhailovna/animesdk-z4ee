...
#define RPG_GAMECORE_GRIDFIGHTROLECONFIG_METHOD_2_022F94E94F2B1ED8_OFFSET UNITYSDK_OFFSET(0x1B4E8C50)
#define RPG_GAMECORE_GRIDFIGHTROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E8D70)
