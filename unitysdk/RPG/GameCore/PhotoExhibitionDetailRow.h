...
#define RPG_GAMECORE_PHOTOEXHIBITIONDETAILROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6A4BB0)
#define RPG_GAMECORE_PHOTOEXHIBITIONDETAILROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A5190)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::String*>* FemalePicPath; // 0x18
		::Il2CppArray<::System::String*>* MalePicPath; // 0x20
		::Il2CppArray<::System::UInt32>* TaskOption; // 0x28
		::System::UInt32 MissionID; // 0x30
		::System::Boolean ShowRuikeName; // 0x34
		::RPG::Client::TextID AuthorName; // 0x38
		::RPG::Client::TextID Name; // 0x48
		::RPG::Client::TextID Unlock; // 0x58
		::System::UInt32 ID; // 0x68
		::System::UInt32 FinishSubMissionID; // 0x6C
		::RPG::Client::TextID GroupphotoDesc; // 0x70
