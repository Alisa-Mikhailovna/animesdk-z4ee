...
#define RPG_GAMECORE_ELATIONCONFIG_METHOD_2_C843BFB2FC9891A4_OFFSET UNITYSDK_OFFSET(0x1B3D7140)
#define RPG_GAMECORE_ELATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D7430)
