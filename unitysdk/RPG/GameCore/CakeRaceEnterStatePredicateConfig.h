...
#define RPG_GAMECORE_CAKERACEENTERSTATEPREDICATECONFIG_METHOD_3_1FAC102E67F7E1B1_OFFSET UNITYSDK_OFFSET(0x1B2F8D70)
#define RPG_GAMECORE_CAKERACEENTERSTATEPREDICATECONFIG_METHOD_3_EAFE51C5D70E8619_OFFSET UNITYSDK_OFFSET(0x1B2F5B30)
#define RPG_GAMECORE_CAKERACEENTERSTATEPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F5B20)
