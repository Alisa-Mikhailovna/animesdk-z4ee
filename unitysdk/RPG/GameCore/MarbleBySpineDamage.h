...
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE_METHOD_4_A554974748D22719_OFFSET UNITYSDK_OFFSET(0x1B5B4E40)
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE_METHOD_4_CC8C8E74434C2EE0_OFFSET UNITYSDK_OFFSET(0x1B5B4EA0)
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B4E90)
