...
#define RPG_GAMECORE_ENABLEROGUEENTER_METHOD_3_51C5B50AFD95C399_OFFSET UNITYSDK_OFFSET(0x1B3E5640)
#define RPG_GAMECORE_ENABLEROGUEENTER_METHOD_3_DD4D63303B5AA3CC_OFFSET UNITYSDK_OFFSET(0x1B3E5680)
#define RPG_GAMECORE_ENABLEROGUEENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E5670)
