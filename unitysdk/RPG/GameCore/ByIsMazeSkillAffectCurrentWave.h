...
#define RPG_GAMECORE_BYISMAZESKILLAFFECTCURRENTWAVE_METHOD_4_05FCA94E95966EC2_OFFSET UNITYSDK_OFFSET(0x1B2C8210)
#define RPG_GAMECORE_BYISMAZESKILLAFFECTCURRENTWAVE_METHOD_4_37D3FB7E69E32A49_OFFSET UNITYSDK_OFFSET(0x1B2C8250)
#define RPG_GAMECORE_BYISMAZESKILLAFFECTCURRENTWAVE_METHOD_4_66AB750877ACA4A6_OFFSET UNITYSDK_OFFSET(0x1B2C83C0)
#define RPG_GAMECORE_BYISMAZESKILLAFFECTCURRENTWAVE_METHOD_4_8AAA7911EBCA99F3_OFFSET UNITYSDK_OFFSET(0x1B2C8390)
#define RPG_GAMECORE_BYISMAZESKILLAFFECTCURRENTWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C8240)
