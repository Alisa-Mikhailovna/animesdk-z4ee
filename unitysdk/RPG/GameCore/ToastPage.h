...
#define RPG_GAMECORE_TOASTPAGE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B9768A0)
#define RPG_GAMECORE_TOASTPAGE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B976860)
#define RPG_GAMECORE_TOASTPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B976890)
