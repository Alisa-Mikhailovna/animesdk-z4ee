...
#define RPG_GAMECORE_RTDYNAMICVALUERANGEGROUP_METHOD_2_98B4151F08788791_OFFSET UNITYSDK_OFFSET(0x1B7BB490)
#define RPG_GAMECORE_RTDYNAMICVALUERANGEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7BB6A0)
