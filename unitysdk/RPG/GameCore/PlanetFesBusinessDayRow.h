...
#define RPG_GAMECORE_PLANETFESBUSINESSDAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6BD600)
#define RPG_GAMECORE_PLANETFESBUSINESSDAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BDE00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 AvatarEventNum; // 0x14
		...
		::System::UInt32 LittleBonusNum; // 0x38
		::System::UInt32 GameNum; // 0x3C
