...
#define RPG_GAMECORE_SETGAMEPLAYBGMEMOTIONSTATE_METHOD_3_2C3648438F53B8C5_OFFSET UNITYSDK_OFFSET(0x1B8A4980)
#define RPG_GAMECORE_SETGAMEPLAYBGMEMOTIONSTATE_METHOD_3_5A9CAB8EC608D54A_OFFSET UNITYSDK_OFFSET(0x1B8A49C0)
#define RPG_GAMECORE_SETGAMEPLAYBGMEMOTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A49B0)
