...
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1B8C0560)
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_BC3909DB1B22D7E8_OFFSET UNITYSDK_OFFSET(0x1B8C0450)
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_EBFA7384E69D815F_OFFSET UNITYSDK_OFFSET(0x1B8C0490)
#define RPG_GAMECORE_SHAREDJSONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C0480)
