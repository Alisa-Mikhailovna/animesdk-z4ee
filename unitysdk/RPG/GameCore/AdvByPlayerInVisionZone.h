...
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_70DD4C1A4C0E3B65_OFFSET UNITYSDK_OFFSET(0x1B14B4E0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_B8DDFD4FFD3A70D0_OFFSET UNITYSDK_OFFSET(0x1B14B4A0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_CFFEA4F393B5B1F3_OFFSET UNITYSDK_OFFSET(0x1B14B6D0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_D61F51641F02515C_OFFSET UNITYSDK_OFFSET(0x1B14B6A0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14B4D0)
