...
#define RPG_GAMECORE_ELFNORMALEVENTCHANCECONFIG_METHOD_2_1FB6778FA88C16A1_OFFSET UNITYSDK_OFFSET(0x1B3DBAA0)
#define RPG_GAMECORE_ELFNORMALEVENTCHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DBC70)
