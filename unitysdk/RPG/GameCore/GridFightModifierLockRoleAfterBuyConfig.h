...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKROLEAFTERBUYCONFIG_METHOD_3_BBE80D2BAAEE3E23_OFFSET UNITYSDK_OFFSET(0x1B4E0700)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKROLEAFTERBUYCONFIG_METHOD_3_E128F1C8106534A7_OFFSET UNITYSDK_OFFSET(0x1B4E0750)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKROLEAFTERBUYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0740)
