...
#define RPG_GAMECORE_ALLEYPACKANCHORSCONFIG_METHOD_2_2BFF5B9A530EC02F_OFFSET UNITYSDK_OFFSET(0x1B19C000)
#define RPG_GAMECORE_ALLEYPACKANCHORSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19C1C0)
