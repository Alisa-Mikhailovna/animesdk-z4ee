...
#define RPG_GAMECORE_ELFCUSTOMERCONFIG_METHOD_2_03E1DAFBE690FD08_OFFSET UNITYSDK_OFFSET(0x1B3D9760)
#define RPG_GAMECORE_ELFCUSTOMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D9AC0)
