...
#define RPG_GAMECORE_ELFPHASEITEM_METHOD_2_13EF1093A478A747_OFFSET UNITYSDK_OFFSET(0x1B3DC2A0)
#define RPG_GAMECORE_ELFPHASEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DC3C0)
