...
#define RPG_GAMECORE_ITEMCONSUMETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B53F340)
#define RPG_GAMECORE_ITEMCONSUMETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B53F9D0)
