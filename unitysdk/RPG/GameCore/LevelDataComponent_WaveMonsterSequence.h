...
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0xDAD11E0)
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE_GET_PASSCOUNT_OFFSET UNITYSDK_OFFSET(0xDAD16D0)
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE_GET_SUMMONEDCOUNT_OFFSET UNITYSDK_OFFSET(0xDAD13D0)
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xDACBFD0)
