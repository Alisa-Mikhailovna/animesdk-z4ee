...
#define RPG_GAMECORE_CHRONICLEMIDDLEMISSIONPACKCONFIG_METHOD_2_E9FD1BB0073C5D68_OFFSET UNITYSDK_OFFSET(0x1B35A7F0)
#define RPG_GAMECORE_CHRONICLEMIDDLEMISSIONPACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35A8B0)
