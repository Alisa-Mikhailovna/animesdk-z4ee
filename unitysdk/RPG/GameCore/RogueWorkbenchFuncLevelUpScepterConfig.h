...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCLEVELUPSCEPTERCONFIG_METHOD_3_7F8A81E32D42FAA3_OFFSET UNITYSDK_OFFSET(0x1B7A5090)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCLEVELUPSCEPTERCONFIG_METHOD_3_A4CB667F92B9F127_OFFSET UNITYSDK_OFFSET(0x1B7A4E50)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCLEVELUPSCEPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4E40)
