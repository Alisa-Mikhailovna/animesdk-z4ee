...
#define RPG_GAMECORE_PIXAIREVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6B4D20)
#define RPG_GAMECORE_PIXAIREVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B4EA0)
