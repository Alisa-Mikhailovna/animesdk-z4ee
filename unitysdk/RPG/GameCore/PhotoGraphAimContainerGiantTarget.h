...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERGIANTTARGET_METHOD_3_683AF9015B51F909_OFFSET UNITYSDK_OFFSET(0x1B6A6D80)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERGIANTTARGET_METHOD_3_7811DCE9F74636A4_OFFSET UNITYSDK_OFFSET(0x1B6A6E40)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERGIANTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A6E00)
