...
#define RPG_GAMECORE_TRIGGERROGUEMIRACLESELECT_METHOD_3_13161B47DB2DD922_OFFSET UNITYSDK_OFFSET(0x1B9A8600)
#define RPG_GAMECORE_TRIGGERROGUEMIRACLESELECT_METHOD_3_965F4C180C72103E_OFFSET UNITYSDK_OFFSET(0x1B9A8650)
#define RPG_GAMECORE_TRIGGERROGUEMIRACLESELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A8640)
