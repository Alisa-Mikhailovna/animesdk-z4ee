...
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_2687DC00D5DCBC0C_OFFSET UNITYSDK_OFFSET(0x1B3E67A0)
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_BB4711C081826949_OFFSET UNITYSDK_OFFSET(0x1B3E6870)
#define RPG_GAMECORE_ENDPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E6860)
