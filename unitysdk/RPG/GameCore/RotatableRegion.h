...
#define RPG_GAMECORE_ROTATABLEREGION_METHOD_2_4FAD0C96DF78CBE8_OFFSET UNITYSDK_OFFSET(0x1B7A5B30)
#define RPG_GAMECORE_ROTATABLEREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A6010)
