...
#define RPG_GAMECORE_GRIDFIGHTROLEGENDEROVERRIDECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4E94F0)
#define RPG_GAMECORE_GRIDFIGHTROLEGENDEROVERRIDECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E96A0)
