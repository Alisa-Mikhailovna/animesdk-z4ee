...
#define RPG_GAMECORE_SETTIMEREWINDENTITYMINRATIO_METHOD_3_0D01B4FB9A2EE992_OFFSET UNITYSDK_OFFSET(0x1B8B7C70)
#define RPG_GAMECORE_SETTIMEREWINDENTITYMINRATIO_METHOD_3_C5FB0EF95EDC415B_OFFSET UNITYSDK_OFFSET(0x1B8B7C30)
#define RPG_GAMECORE_SETTIMEREWINDENTITYMINRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B7C60)
