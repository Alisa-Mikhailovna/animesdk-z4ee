...
#define RPG_GAMECORE_CHOOSEDELIVERYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B359F20)
#define RPG_GAMECORE_CHOOSEDELIVERYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35A0C0)
