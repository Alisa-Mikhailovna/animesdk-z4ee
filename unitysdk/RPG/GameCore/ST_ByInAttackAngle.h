...
#define RPG_GAMECORE_ST_BYINATTACKANGLE_METHOD_4_8C3A557952A85091_OFFSET UNITYSDK_OFFSET(0x1B7D7300)
#define RPG_GAMECORE_ST_BYINATTACKANGLE_METHOD_4_A8DE72BDFEE68B70_OFFSET UNITYSDK_OFFSET(0x1B7D72D0)
#define RPG_GAMECORE_ST_BYINATTACKANGLE_METHOD_4_BD8C3D5EAABA0365_OFFSET UNITYSDK_OFFSET(0x1B7D7150)
#define RPG_GAMECORE_ST_BYINATTACKANGLE_METHOD_4_FEE07A009578FB66_OFFSET UNITYSDK_OFFSET(0x1B7D7190)
#define RPG_GAMECORE_ST_BYINATTACKANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D7180)
