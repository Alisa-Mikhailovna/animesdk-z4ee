...
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE_METHOD_3_7E2C7D5E215819FA_OFFSET UNITYSDK_OFFSET(0x1B8D0C50)
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE_METHOD_3_BBB7EEE4764B83AD_OFFSET UNITYSDK_OFFSET(0x1B8D0C90)
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D0C80)
