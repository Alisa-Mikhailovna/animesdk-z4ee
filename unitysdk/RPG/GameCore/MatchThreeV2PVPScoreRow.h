...
#define RPG_GAMECORE_MATCHTHREEV2PVPSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5D5B00)
#define RPG_GAMECORE_MATCHTHREEV2PVPSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D6020)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MatchThreeScoreFinishType FinishType; // 0x40
