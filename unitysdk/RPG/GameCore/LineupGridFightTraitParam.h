...
#define RPG_GAMECORE_LINEUPGRIDFIGHTTRAITPARAM_METHOD_2_17EECF92366FA05B_OFFSET UNITYSDK_OFFSET(0x1B57C010)
#define RPG_GAMECORE_LINEUPGRIDFIGHTTRAITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B57C190)
