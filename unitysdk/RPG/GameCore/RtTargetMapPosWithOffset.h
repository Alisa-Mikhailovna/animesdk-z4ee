...
#define RPG_GAMECORE_RTTARGETMAPPOSWITHOFFSET_METHOD_3_4FC77738C1BD7082_OFFSET UNITYSDK_OFFSET(0x1B7C9610)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHOFFSET_METHOD_3_50E28D82BA6C60EE_OFFSET UNITYSDK_OFFSET(0x1B7C94D0)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHOFFSET_METHOD_3_C126CF27354DE1FB_OFFSET UNITYSDK_OFFSET(0x1B7C9490)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHOFFSET_METHOD_3_E6D6C6F21611EEE4_OFFSET UNITYSDK_OFFSET(0x1B7C9640)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C94C0)
