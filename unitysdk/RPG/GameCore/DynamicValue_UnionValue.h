...
#define RPG_GAMECORE_DYNAMICVALUE_UNIONVALUE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3D1BA0)
...
namespace RPG::GameCore
{
	...
	struct alignas(8) DynamicValue_UnionValue
	{
		...
		{
			return (::RPG::GameCore::DynamicValue_UnionValue*)Il2CppClass::FromTypeDefinitionIndex(DynamicValue_UnionValue_TypeDefinitionIndex)->GetStaticField(0x88C0);
		}
