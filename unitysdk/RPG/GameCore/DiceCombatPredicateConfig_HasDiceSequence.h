...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICESEQUENCE_METHOD_4_71502020D7C6C022_OFFSET UNITYSDK_OFFSET(0x1B3B3130)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICESEQUENCE_METHOD_4_D7B4C12A46668EDC_OFFSET UNITYSDK_OFFSET(0x1B3B4FF0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B30D0)
