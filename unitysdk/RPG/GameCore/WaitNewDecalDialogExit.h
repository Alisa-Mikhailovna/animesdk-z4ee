...
#define RPG_GAMECORE_WAITNEWDECALDIALOGEXIT_METHOD_3_74D7EC9C22E3FC5F_OFFSET UNITYSDK_OFFSET(0x1B9EAC00)
#define RPG_GAMECORE_WAITNEWDECALDIALOGEXIT_METHOD_3_C7EC7BCBF98C7184_OFFSET UNITYSDK_OFFSET(0x1B9EAC40)
#define RPG_GAMECORE_WAITNEWDECALDIALOGEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EAC30)
