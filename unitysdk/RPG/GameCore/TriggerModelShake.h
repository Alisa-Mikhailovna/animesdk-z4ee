...
#define RPG_GAMECORE_TRIGGERMODELSHAKE_METHOD_3_4E8CBE6D378E8143_OFFSET UNITYSDK_OFFSET(0x1B9A5460)
#define RPG_GAMECORE_TRIGGERMODELSHAKE_METHOD_3_517FE5AA8A675291_OFFSET UNITYSDK_OFFSET(0x1B9A5520)
#define RPG_GAMECORE_TRIGGERMODELSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A54D0)
