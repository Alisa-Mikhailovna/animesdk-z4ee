...
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6DD9E87A8E7E4302_OFFSET UNITYSDK_OFFSET(0x1B9469B0)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6E9C21F5D38540BA_OFFSET UNITYSDK_OFFSET(0x1B946A30)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_8C91E0B0A9270987_OFFSET UNITYSDK_OFFSET(0x1B946A10)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_C36E6E6ACEC61F83_OFFSET UNITYSDK_OFFSET(0x1B946940)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B946A40)
