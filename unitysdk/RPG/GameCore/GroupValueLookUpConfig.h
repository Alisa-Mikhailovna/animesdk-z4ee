...
#define RPG_GAMECORE_GROUPVALUELOOKUPCONFIG_METHOD_2_67B54FBE4200AF31_OFFSET UNITYSDK_OFFSET(0x1B4F8640)
#define RPG_GAMECORE_GROUPVALUELOOKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F87D0)
