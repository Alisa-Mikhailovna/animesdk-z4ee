...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSUPPLYCONFIG_METHOD_3_ABB3452B6B6E7639_OFFSET UNITYSDK_OFFSET(0x1B4E1480)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSUPPLYCONFIG_METHOD_3_C6CA3CA039AFF17D_OFFSET UNITYSDK_OFFSET(0x1B4E14D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSUPPLYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E14C0)
