...
#define RPG_GAMECORE_BUBBLENOTIFYCONFIG_METHOD_2_98F26E0D22E2C9BE_OFFSET UNITYSDK_OFFSET(0x1B21C2D0)
#define RPG_GAMECORE_BUBBLENOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21C490)
