...
#define RPG_GAMECORE_SMELLPROPCONFIG_METHOD_2_FB7ED5B86124F5DB_OFFSET UNITYSDK_OFFSET(0x1B8E0060)
#define RPG_GAMECORE_SMELLPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E01F0)
