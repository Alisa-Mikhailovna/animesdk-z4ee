...
#define RPG_GAMECORE_AVATARENERGYBARSTATE_COPYDATAFROM_OFFSET UNITYSDK_OFFSET(0xD99C080)
#define RPG_GAMECORE_AVATARENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xD994FB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean ShowEnhancedTextColor; // 0x40
		::System::Boolean IsActive; // 0x41
		::RPG::GameCore::EnergyBarState CurrentStatus; // 0x44
		::System::Int32 CurrCount; // 0x48
