...
#define RPG_GAMECORE_LEVELNPCSTILLCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B562310)
#define RPG_GAMECORE_LEVELNPCSTILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5623F0)
