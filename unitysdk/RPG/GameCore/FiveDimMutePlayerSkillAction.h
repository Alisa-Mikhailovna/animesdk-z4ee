...
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERSKILLACTION_METHOD_3_9E89A4A5C8890B9E_OFFSET UNITYSDK_OFFSET(0x1B43CF30)
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERSKILLACTION_METHOD_3_D97C02CFADC79E9B_OFFSET UNITYSDK_OFFSET(0x1B43CE50)
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERSKILLACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43CF20)
