...
#define RPG_GAMECORE_GRIDFIGHTPARAMTOTALEQUIPCNTCONFIG_METHOD_6_085C62BC458ADDC6_OFFSET UNITYSDK_OFFSET(0x1B4E4760)
#define RPG_GAMECORE_GRIDFIGHTPARAMTOTALEQUIPCNTCONFIG_METHOD_6_FBA42590AFEB836A_OFFSET UNITYSDK_OFFSET(0x1B4E4710)
#define RPG_GAMECORE_GRIDFIGHTPARAMTOTALEQUIPCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E4750)
