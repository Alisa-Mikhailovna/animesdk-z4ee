...
#define RPG_GAMECORE_ROGUEIMMERSELEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B767FC0)
#define RPG_GAMECORE_ROGUEIMMERSELEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7689B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID EffectTitle1; // 0x30
