...
#define RPG_GAMECORE_PLAYERSPACECONFIG_METHOD_2_901B6599D95E06FD_OFFSET UNITYSDK_OFFSET(0x1B6D51A0)
#define RPG_GAMECORE_PLAYERSPACECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D54D0)
