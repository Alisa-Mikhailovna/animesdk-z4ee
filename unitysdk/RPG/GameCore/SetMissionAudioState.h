...
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_2A623ED5ADA240B7_OFFSET UNITYSDK_OFFSET(0x1B8A9970)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_3A2EA40A28025401_OFFSET UNITYSDK_OFFSET(0x1B8A9930)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A9960)
