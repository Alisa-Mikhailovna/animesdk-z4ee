...
#define RPG_GAMECORE_BYISCURRENTSKILLACTIVE_METHOD_4_27639A1F8E3F9D3F_OFFSET UNITYSDK_OFFSET(0x1B2A98B0)
#define RPG_GAMECORE_BYISCURRENTSKILLACTIVE_METHOD_4_2B48C3199773E95E_OFFSET UNITYSDK_OFFSET(0x1B2A9870)
#define RPG_GAMECORE_BYISCURRENTSKILLACTIVE_METHOD_4_3647AC3A1EBF4E95_OFFSET UNITYSDK_OFFSET(0x1B2A9A30)
#define RPG_GAMECORE_BYISCURRENTSKILLACTIVE_METHOD_4_7FF6592D1E2FDF1B_OFFSET UNITYSDK_OFFSET(0x1B2A9A60)
#define RPG_GAMECORE_BYISCURRENTSKILLACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A98A0)
