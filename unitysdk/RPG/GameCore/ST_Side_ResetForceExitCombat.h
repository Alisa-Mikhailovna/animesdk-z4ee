...
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT_METHOD_4_39A7256930C0979C_OFFSET UNITYSDK_OFFSET(0x1B877C90)
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT_METHOD_4_5B19805068C66599_OFFSET UNITYSDK_OFFSET(0x1B877BC0)
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B877C80)
