...
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_217730BDDA66FFFE_OFFSET UNITYSDK_OFFSET(0x1B2D7590)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_25B874263C7A1DAC_OFFSET UNITYSDK_OFFSET(0x1B2D73B0)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_C4927A9BE1AE9AF0_OFFSET UNITYSDK_OFFSET(0x1B2D7560)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_C8E7C089C86DD9ED_OFFSET UNITYSDK_OFFSET(0x1B2D7370)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D73A0)
