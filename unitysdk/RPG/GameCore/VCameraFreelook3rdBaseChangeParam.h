...
#define RPG_GAMECORE_VCAMERAFREELOOK3RDBASECHANGEPARAM_METHOD_2_E76FD3A954783DC1_OFFSET UNITYSDK_OFFSET(0x1B9CC8B0)
#define RPG_GAMECORE_VCAMERAFREELOOK3RDBASECHANGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CCBD0)
