...
#define RPG_GAMECORE_FREESTYLEMOTIONIDTOLAYERLISTCONFIG_METHOD_2_53A603F8AA8661FC_OFFSET UNITYSDK_OFFSET(0x1B4A1770)
#define RPG_GAMECORE_FREESTYLEMOTIONIDTOLAYERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A17B0)
