...
#define RPG_GAMECORE_MANIKINPETCONFIG_METHOD_2_E9363F42FE7A03EE_OFFSET UNITYSDK_OFFSET(0x1B5A3380)
#define RPG_GAMECORE_MANIKINPETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A3650)
