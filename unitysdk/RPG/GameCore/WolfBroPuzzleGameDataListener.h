...
#define RPG_GAMECORE_WOLFBROPUZZLEGAMEDATALISTENER_METHOD_3_2B10276F44B290CC_OFFSET UNITYSDK_OFFSET(0x1B9F6C80)
#define RPG_GAMECORE_WOLFBROPUZZLEGAMEDATALISTENER_METHOD_3_4925AFD58A8CE1AB_OFFSET UNITYSDK_OFFSET(0x1B9F6C40)
#define RPG_GAMECORE_WOLFBROPUZZLEGAMEDATALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F6C70)
