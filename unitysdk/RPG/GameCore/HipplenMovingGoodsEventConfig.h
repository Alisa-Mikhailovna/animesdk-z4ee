...
#define RPG_GAMECORE_HIPPLENMOVINGGOODSEVENTCONFIG_METHOD_2_3F05A9D1F5F4D0B8_OFFSET UNITYSDK_OFFSET(0x1B519CC0)
#define RPG_GAMECORE_HIPPLENMOVINGGOODSEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B519F50)
