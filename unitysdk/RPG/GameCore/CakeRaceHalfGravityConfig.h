...
#define RPG_GAMECORE_CAKERACEHALFGRAVITYCONFIG_METHOD_2_FBE18B5D84CABBC3_OFFSET UNITYSDK_OFFSET(0x1B2FA320)
#define RPG_GAMECORE_CAKERACEHALFGRAVITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FA5B0)
