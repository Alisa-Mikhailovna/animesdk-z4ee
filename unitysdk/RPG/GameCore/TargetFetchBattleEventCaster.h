...
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_2EE6A407800CC36C_OFFSET UNITYSDK_OFFSET(0x1B94C6D0)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_334CFFAA2E26C839_OFFSET UNITYSDK_OFFSET(0x1B94C6B0)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_7E7992C0C1CCC1FC_OFFSET UNITYSDK_OFFSET(0x1B94C650)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_DDDF0CBA17DFD4D1_OFFSET UNITYSDK_OFFSET(0x1B94C5D0)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B94C640)
