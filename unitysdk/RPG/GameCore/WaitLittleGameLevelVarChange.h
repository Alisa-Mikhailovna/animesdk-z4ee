...
#define RPG_GAMECORE_WAITLITTLEGAMELEVELVARCHANGE_METHOD_4_DD30E7BBCC83D1C6_OFFSET UNITYSDK_OFFSET(0x1B9E9500)
#define RPG_GAMECORE_WAITLITTLEGAMELEVELVARCHANGE_METHOD_4_E3D262EAF63B58B3_OFFSET UNITYSDK_OFFSET(0x1B9E9550)
#define RPG_GAMECORE_WAITLITTLEGAMELEVELVARCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E9540)
