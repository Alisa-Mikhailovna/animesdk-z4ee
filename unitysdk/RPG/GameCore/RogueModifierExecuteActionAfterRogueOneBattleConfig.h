...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERROGUEONEBATTLECONFIG_METHOD_3_9E0419140C5B9F4B_OFFSET UNITYSDK_OFFSET(0x1B7746B0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERROGUEONEBATTLECONFIG_METHOD_3_F276C2F7E5084B4F_OFFSET UNITYSDK_OFFSET(0x1B774700)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERROGUEONEBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7746F0)
