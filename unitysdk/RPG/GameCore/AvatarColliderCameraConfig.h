...
#define RPG_GAMECORE_AVATARCOLLIDERCAMERACONFIG_METHOD_2_BF5D8A35B0952A41_OFFSET UNITYSDK_OFFSET(0x1B1C0000)
#define RPG_GAMECORE_AVATARCOLLIDERCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C0110)
