...
#define RPG_GAMECORE_GRIDFIGHTWAVEINFO_METHOD_2_3E304D6651B070EB_OFFSET UNITYSDK_OFFSET(0x1B4F57A0)
#define RPG_GAMECORE_GRIDFIGHTWAVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F58C0)
