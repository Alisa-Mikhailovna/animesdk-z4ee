...
#define RPG_GAMECORE_CHIMERAEVENTHANDLERS_METHOD_2_4B4A4E35DEF82F6A_OFFSET UNITYSDK_OFFSET(0x1B3551D0)
#define RPG_GAMECORE_CHIMERAEVENTHANDLERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3552C0)
