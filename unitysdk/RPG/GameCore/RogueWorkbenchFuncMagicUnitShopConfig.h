...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICUNITSHOPCONFIG_METHOD_3_4A5551F42FDBA9E3_OFFSET UNITYSDK_OFFSET(0x1B7A5110)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICUNITSHOPCONFIG_METHOD_3_C6A9DF1246A6B967_OFFSET UNITYSDK_OFFSET(0x1B7A4E90)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICUNITSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4E80)
