...
#define RPG_GAMECORE_RTATTACHTRIGGER_METHOD_3_6BFFC3498DFFAA0F_OFFSET UNITYSDK_OFFSET(0x1B7A7A70)
#define RPG_GAMECORE_RTATTACHTRIGGER_METHOD_3_D608554727096ABA_OFFSET UNITYSDK_OFFSET(0x1B7A7B70)
#define RPG_GAMECORE_RTATTACHTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A7AB0)
