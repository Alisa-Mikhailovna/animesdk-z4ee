...
#define RPG_GAMECORE_LOGICANIMEVENTENTRY_METHOD_2_DA40BC04FAA6F4D6_OFFSET UNITYSDK_OFFSET(0x1B597B30)
#define RPG_GAMECORE_LOGICANIMEVENTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B597CB0)
