...
#define RPG_GAMECORE_FIVEDIMSURFACEBAKEDINFO_METHOD_2_05B7F0AE8D82505D_OFFSET UNITYSDK_OFFSET(0x1B44C560)
#define RPG_GAMECORE_FIVEDIMSURFACEBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44C940)
