...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURSECTIONCONFIG_METHOD_6_E98D60DE952FCC7E_OFFSET UNITYSDK_OFFSET(0x1B4E38D0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURSECTIONCONFIG_METHOD_6_F09536C93376603A_OFFSET UNITYSDK_OFFSET(0x1B4E3920)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E3910)
