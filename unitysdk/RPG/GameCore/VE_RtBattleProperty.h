...
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_553F367656B943EE_OFFSET UNITYSDK_OFFSET(0x1B9D2690)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_DEEDFCB2D02F8B73_OFFSET UNITYSDK_OFFSET(0x1B9D2450)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_F0D60687BED61AE9_OFFSET UNITYSDK_OFFSET(0x1B9D2660)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_FFFD9742EE3B720A_OFFSET UNITYSDK_OFFSET(0x1B9D2490)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D2480)
