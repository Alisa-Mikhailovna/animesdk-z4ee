...
#define RPG_GAMECORE_SHOWCURRENTMAPPAGE_METHOD_3_0D2C4A147BAB1985_OFFSET UNITYSDK_OFFSET(0x1B8C9AB0)
#define RPG_GAMECORE_SHOWCURRENTMAPPAGE_METHOD_3_1CF08E110A81B708_OFFSET UNITYSDK_OFFSET(0x1B8C9B80)
#define RPG_GAMECORE_SHOWCURRENTMAPPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C9B70)
