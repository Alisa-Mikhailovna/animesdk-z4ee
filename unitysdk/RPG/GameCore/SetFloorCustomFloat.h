...
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_B98A6F11CE70042F_OFFSET UNITYSDK_OFFSET(0x1B8A3C10)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_D7FDC0C14521E232_OFFSET UNITYSDK_OFFSET(0x1B8A3C50)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A3C40)
