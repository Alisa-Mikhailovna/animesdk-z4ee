...
#define RPG_GAMECORE_SETFLOORCUSTOMVALUEEXTRAINFO_METHOD_2_8552AABC54F650A7_OFFSET UNITYSDK_OFFSET(0x1B8A3870)
#define RPG_GAMECORE_SETFLOORCUSTOMVALUEEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A4430)
