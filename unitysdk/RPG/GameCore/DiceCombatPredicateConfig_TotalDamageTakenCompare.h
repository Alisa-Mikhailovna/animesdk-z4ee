...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_TOTALDAMAGETAKENCOMPARE_METHOD_4_BAFAFE0E4B5AE26E_OFFSET UNITYSDK_OFFSET(0x1B3B4690)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_TOTALDAMAGETAKENCOMPARE_METHOD_4_C6AFC4E730034EF2_OFFSET UNITYSDK_OFFSET(0x1B3B53B0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_TOTALDAMAGETAKENCOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B4680)
