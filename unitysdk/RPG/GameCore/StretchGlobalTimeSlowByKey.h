...
#define RPG_GAMECORE_STRETCHGLOBALTIMESLOWBYKEY_METHOD_3_020FF5E78704E6CC_OFFSET UNITYSDK_OFFSET(0x1B917C90)
#define RPG_GAMECORE_STRETCHGLOBALTIMESLOWBYKEY_METHOD_3_20257E4DCCDF37AB_OFFSET UNITYSDK_OFFSET(0x1B917C50)
#define RPG_GAMECORE_STRETCHGLOBALTIMESLOWBYKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B917C80)
