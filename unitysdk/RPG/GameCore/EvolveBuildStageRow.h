...
#define RPG_GAMECORE_EVOLVEBUILDSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B3FA530)
#define RPG_GAMECORE_EVOLVEBUILDSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3FC5F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* FirstWinQuest; // 0x18
		::System::String* TeamBonusIconPath; // 0x20
		...
		::Il2CppArray<::System::UInt32>* StagePeriod2; // 0x50
		::Il2CppArray<::System::UInt32>* StagePeriod3; // 0x58
		::Il2CppArray<::System::UInt32>* StagePeriod1; // 0x60
		::System::UInt32 StageMergedID; // 0x68
		::System::UInt32 IntroID; // 0x6C
		::RPG::Client::TextID DevilDesc; // 0x70
		::RPG::Client::TextID BuffTextFormat; // 0x80
		::RPG::Client::TextID Name; // 0x90
		::RPG::Client::TextID TeamBonusShortDesc; // 0xA0
		::System::Int32 Difficulty; // 0xB0
		::System::UInt32 UnlockQuest; // 0xB4
		::RPG::Client::TextID Desc; // 0xB8
		::System::Boolean WeaponSelectable; // 0xC8
		::System::UInt32 TeamBonusMazeBuffID; // 0xCC
		::RPG::GameCore::EvolveBuildSeason Season; // 0xD0
		::RPG::Client::TextID PreName; // 0xD8
