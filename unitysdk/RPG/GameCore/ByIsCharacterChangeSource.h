...
#define RPG_GAMECORE_BYISCHARACTERCHANGESOURCE_METHOD_4_82E7F2FA2D5D0D9D_OFFSET UNITYSDK_OFFSET(0x1B2A60D0)
#define RPG_GAMECORE_BYISCHARACTERCHANGESOURCE_METHOD_4_8F118E6C7E849780_OFFSET UNITYSDK_OFFSET(0x1B2A5EB0)
#define RPG_GAMECORE_BYISCHARACTERCHANGESOURCE_METHOD_4_D4A514876B75BC73_OFFSET UNITYSDK_OFFSET(0x1B2A6110)
#define RPG_GAMECORE_BYISCHARACTERCHANGESOURCE_METHOD_4_D8F011662CED1885_OFFSET UNITYSDK_OFFSET(0x1B2A5F00)
#define RPG_GAMECORE_BYISCHARACTERCHANGESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A5EF0)
