...
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_1F12B8DFABA1E8DA_OFFSET UNITYSDK_OFFSET(0x1B2C8E90)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_59977953AECFA14E_OFFSET UNITYSDK_OFFSET(0x1B2C8D10)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_961072AEF6F1F6B4_OFFSET UNITYSDK_OFFSET(0x1B2C8EC0)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_D094DD9884C557DF_OFFSET UNITYSDK_OFFSET(0x1B2C8CD0)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C8D00)
