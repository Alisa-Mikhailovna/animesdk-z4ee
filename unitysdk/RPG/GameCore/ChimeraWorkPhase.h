...
#define RPG_GAMECORE_CHIMERAWORKPHASE_METHOD_2_76BB5948732C447D_OFFSET UNITYSDK_OFFSET(0x1B3597D0)
#define RPG_GAMECORE_CHIMERAWORKPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3598B0)
