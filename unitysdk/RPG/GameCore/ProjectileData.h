...
#define RPG_GAMECORE_PROJECTILEDATA_METHOD_2_82619479C17B3462_OFFSET UNITYSDK_OFFSET(0x1B6DBC80)
#define RPG_GAMECORE_PROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6DCE50)
