...
#define RPG_GAMECORE_PROPOVERRIDECOLLIDERCONFIG_METHOD_2_03DAEB89B05256C9_OFFSET UNITYSDK_OFFSET(0x1B6E2940)
#define RPG_GAMECORE_PROPOVERRIDECOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E8DB0)
