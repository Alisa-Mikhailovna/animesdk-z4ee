...
#define RPG_GAMECORE_MUSEUMAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B63AFF0)
#define RPG_GAMECORE_MUSEUMAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B63C6D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RequireStatsA; // 0x28
