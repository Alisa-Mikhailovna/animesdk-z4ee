...
#define RPG_GAMECORE_RTDAMAGECONSTCONFIG_METHOD_2_20DF1D782C684035_OFFSET UNITYSDK_OFFSET(0x1B7B71A0)
#define RPG_GAMECORE_RTDAMAGECONSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B7840)
