...
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG_METHOD_3_7EF64F285278CE18_OFFSET UNITYSDK_OFFSET(0x1B3A4D10)
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG_METHOD_3_A53B056F29AF13CE_OFFSET UNITYSDK_OFFSET(0x1B3A5350)
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A4D00)
