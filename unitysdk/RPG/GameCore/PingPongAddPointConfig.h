...
#define RPG_GAMECORE_PINGPONGADDPOINTCONFIG_METHOD_2_1804AFE00E906986_OFFSET UNITYSDK_OFFSET(0x1B6ADBB0)
#define RPG_GAMECORE_PINGPONGADDPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6ADD40)
