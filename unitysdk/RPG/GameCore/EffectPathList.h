...
#define RPG_GAMECORE_EFFECTPATHLIST_METHOD_2_B574A2CCF3B1730A_OFFSET UNITYSDK_OFFSET(0x1B3D6310)
#define RPG_GAMECORE_EFFECTPATHLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D6400)
