...
#define RPG_GAMECORE_SHOWGUIDETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B8CEC50)
#define RPG_GAMECORE_SHOWGUIDETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B8CEC00)
#define RPG_GAMECORE_SHOWGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8CEC40)
