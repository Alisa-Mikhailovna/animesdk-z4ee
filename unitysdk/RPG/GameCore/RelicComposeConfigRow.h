...
#define RPG_GAMECORE_RELICCOMPOSECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B710620)
#define RPG_GAMECORE_RELICCOMPOSECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7108A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 WorldLevelRequire; // 0x2C
