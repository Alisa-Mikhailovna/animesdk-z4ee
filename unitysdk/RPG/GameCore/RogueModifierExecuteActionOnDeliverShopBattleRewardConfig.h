...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELIVERSHOPBATTLEREWARDCONFIG_METHOD_3_4CE8E75077B3279A_OFFSET UNITYSDK_OFFSET(0x1B774C40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELIVERSHOPBATTLEREWARDCONFIG_METHOD_3_F24C9063029F3A5E_OFFSET UNITYSDK_OFFSET(0x1B774BF0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELIVERSHOPBATTLEREWARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B774C30)
