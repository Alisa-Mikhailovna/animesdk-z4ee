...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDNPCEQUIP_METHOD_2_424E4F064B9B7856_OFFSET UNITYSDK_OFFSET(0x1B4CFC30)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDNPCEQUIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CFC70)
