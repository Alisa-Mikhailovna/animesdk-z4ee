...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEPERFECTCLEARCONFIG_METHOD_3_84A9160FB188C1C1_OFFSET UNITYSDK_OFFSET(0x1B4E01D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEPERFECTCLEARCONFIG_METHOD_3_B06667034137DE25_OFFSET UNITYSDK_OFFSET(0x1B4E0220)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEPERFECTCLEARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0210)
