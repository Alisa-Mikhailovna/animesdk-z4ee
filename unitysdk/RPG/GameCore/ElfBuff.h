...
#define RPG_GAMECORE_ELFBUFF_METHOD_2_D89B9C7FB3EC4A2C_OFFSET UNITYSDK_OFFSET(0x1B3D91D0)
#define RPG_GAMECORE_ELFBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D9460)
