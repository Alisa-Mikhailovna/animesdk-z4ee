...
#define RPG_GAMECORE_SYNCANIMWITHBGMPHASECONFIG_METHOD_2_0295ED74B723F060_OFFSET UNITYSDK_OFFSET(0x1B93BF30)
#define RPG_GAMECORE_SYNCANIMWITHBGMPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B93C0B0)
