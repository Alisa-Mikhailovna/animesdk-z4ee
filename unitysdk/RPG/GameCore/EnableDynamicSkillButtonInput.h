...
#define RPG_GAMECORE_ENABLEDYNAMICSKILLBUTTONINPUT_METHOD_3_02AD2F0C74C528EB_OFFSET UNITYSDK_OFFSET(0x1B3E35B0)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLBUTTONINPUT_METHOD_3_AEAC7B91C4D22932_OFFSET UNITYSDK_OFFSET(0x1B3E35F0)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E35E0)
