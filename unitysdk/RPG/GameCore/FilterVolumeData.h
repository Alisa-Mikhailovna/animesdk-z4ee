...
#define RPG_GAMECORE_FILTERVOLUMEDATA_METHOD_2_0B9391D86D5D7D04_OFFSET UNITYSDK_OFFSET(0x1B417C50)
#define RPG_GAMECORE_FILTERVOLUMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B417E40)
