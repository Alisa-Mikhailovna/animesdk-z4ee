...
#define RPG_GAMECORE_SETFLOORCUSTOMBOOLV2_METHOD_3_5DC8ED7F7A9D7300_OFFSET UNITYSDK_OFFSET(0x1B8A3A70)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOLV2_METHOD_3_F87A057A4F4E42E5_OFFSET UNITYSDK_OFFSET(0x1B8A3A30)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOLV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A3A60)
