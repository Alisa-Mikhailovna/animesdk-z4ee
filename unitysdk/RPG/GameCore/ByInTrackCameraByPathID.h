...
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_050A727B77F7B9F1_OFFSET UNITYSDK_OFFSET(0x1B2A00A0)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_4E4A5FEE2634ECCB_OFFSET UNITYSDK_OFFSET(0x1B29FD60)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_5FF96188692D40F6_OFFSET UNITYSDK_OFFSET(0x1B29FD20)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_9A4E98A687D601BE_OFFSET UNITYSDK_OFFSET(0x1B2A00D0)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29FD50)
