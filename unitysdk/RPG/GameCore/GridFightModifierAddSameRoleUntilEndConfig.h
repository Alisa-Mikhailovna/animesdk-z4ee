...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSAMEROLEUNTILENDCONFIG_METHOD_3_CD0D7726B2D89FA0_OFFSET UNITYSDK_OFFSET(0x1B4DEB40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSAMEROLEUNTILENDCONFIG_METHOD_3_FDD8474B97688A64_OFFSET UNITYSDK_OFFSET(0x1B4DEAF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSAMEROLEUNTILENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DEB30)
