...
#define RPG_GAMECORE_DEVICEMODELINFO_METHOD_2_469FB1A23A043F37_OFFSET UNITYSDK_OFFSET(0x1B3A3DF0)
#define RPG_GAMECORE_DEVICEMODELINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A3F40)
