...
#define RPG_GAMECORE_TUTORIALSAVE_METHOD_3_8B934656C01E0507_OFFSET UNITYSDK_OFFSET(0x1B9BCC70)
#define RPG_GAMECORE_TUTORIALSAVE_METHOD_3_D4C0AF6063442714_OFFSET UNITYSDK_OFFSET(0x1B9BCC30)
#define RPG_GAMECORE_TUTORIALSAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BCC60)
