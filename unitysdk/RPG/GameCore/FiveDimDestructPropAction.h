...
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_B1678C0D06541207_OFFSET UNITYSDK_OFFSET(0x1B428C70)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_FFF7CF5398B47A96_OFFSET UNITYSDK_OFFSET(0x1B428BF0)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B428C60)
