...
#define RPG_GAMECORE_MANIKINCUSTOMCONFIG_METHOD_2_86FB05DBD7BDCC5D_OFFSET UNITYSDK_OFFSET(0x1B5A2C20)
#define RPG_GAMECORE_MANIKINCUSTOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A2DD0)
