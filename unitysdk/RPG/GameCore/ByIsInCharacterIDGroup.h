...
#define RPG_GAMECORE_BYISINCHARACTERIDGROUP_METHOD_4_279830467368037B_OFFSET UNITYSDK_OFFSET(0x1B2C2B80)
#define RPG_GAMECORE_BYISINCHARACTERIDGROUP_METHOD_4_2B6AABEE98D63BAE_OFFSET UNITYSDK_OFFSET(0x1B2C2980)
#define RPG_GAMECORE_BYISINCHARACTERIDGROUP_METHOD_4_3A93C01E5CCC3DDD_OFFSET UNITYSDK_OFFSET(0x1B2C2BB0)
#define RPG_GAMECORE_BYISINCHARACTERIDGROUP_METHOD_4_F15D30BEF0753F17_OFFSET UNITYSDK_OFFSET(0x1B2C29C0)
#define RPG_GAMECORE_BYISINCHARACTERIDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C29B0)
