...
#define RPG_GAMECORE_ANIMATORSTATEZONENEWCONFIG_METHOD_2_BE32964B682C3139_OFFSET UNITYSDK_OFFSET(0x1B1A7780)
#define RPG_GAMECORE_ANIMATORSTATEZONENEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A7840)
