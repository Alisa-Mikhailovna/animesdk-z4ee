...
#define RPG_GAMECORE_STAGEPVSOFFLINEVISIBLITYINFO_METHOD_2_CAE35A46A25C51B5_OFFSET UNITYSDK_OFFSET(0x1B8FF370)
#define RPG_GAMECORE_STAGEPVSOFFLINEVISIBLITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8FF7D0)
