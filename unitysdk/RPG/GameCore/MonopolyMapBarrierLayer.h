...
#define RPG_GAMECORE_MONOPOLYMAPBARRIERLAYER_METHOD_3_CC7B17EEC39912A0_OFFSET UNITYSDK_OFFSET(0x1B61AB90)
#define RPG_GAMECORE_MONOPOLYMAPBARRIERLAYER_METHOD_3_E103A8A2F0FB2A12_OFFSET UNITYSDK_OFFSET(0x1B61ABF0)
#define RPG_GAMECORE_MONOPOLYMAPBARRIERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B61ABE0)
