...
#define RPG_GAMECORE_CAKERACECELLCOMMONCONFIG_METHOD_2_B9113636119A6DB2_OFFSET UNITYSDK_OFFSET(0x1B2F8170)
#define RPG_GAMECORE_CAKERACECELLCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F8290)
