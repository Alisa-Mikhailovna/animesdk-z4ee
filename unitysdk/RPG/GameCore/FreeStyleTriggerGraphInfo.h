...
#define RPG_GAMECORE_FREESTYLETRIGGERGRAPHINFO_METHOD_2_2F85C2D8E143917E_OFFSET UNITYSDK_OFFSET(0x1B4A2300)
#define RPG_GAMECORE_FREESTYLETRIGGERGRAPHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A23E0)
