...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASCUSTOMVALUE_METHOD_4_03119D01ACEE7A79_OFFSET UNITYSDK_OFFSET(0x1B3B4F00)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASCUSTOMVALUE_METHOD_4_ACC500152EF0A365_OFFSET UNITYSDK_OFFSET(0x1B3B2C90)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B2C80)
