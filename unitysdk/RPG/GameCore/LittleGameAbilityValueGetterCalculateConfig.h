...
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCALCULATECONFIG_METHOD_3_026937E415C6AE31_OFFSET UNITYSDK_OFFSET(0x1B582BE0)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCALCULATECONFIG_METHOD_3_597B4E5A08A8C8EF_OFFSET UNITYSDK_OFFSET(0x1B582C40)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCALCULATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B582C30)
