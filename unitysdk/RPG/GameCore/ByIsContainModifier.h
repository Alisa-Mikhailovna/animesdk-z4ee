...
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_176198D9B99BE32A_OFFSET UNITYSDK_OFFSET(0x1B2A7EA0)
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_598DE36A0B3A8CB2_OFFSET UNITYSDK_OFFSET(0x1B2A7BC0)
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_876565C00FF0E944_OFFSET UNITYSDK_OFFSET(0x1B2A7ED0)
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_E35774B88C3C05C8_OFFSET UNITYSDK_OFFSET(0x1B2A7C00)
#define RPG_GAMECORE_BYISCONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A7BF0)
