...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5E6590)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E6950)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MirrorMainPropID; // 0x28
