...
#define RPG_GAMECORE_MISSIONIDPAIR_METHOD_2_F04CD62693931396_OFFSET UNITYSDK_OFFSET(0x1B5FFD10)
#define RPG_GAMECORE_MISSIONIDPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5FFE20)
