...
#define RPG_GAMECORE_ROGUETOURNHANDBOOKEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B79A880)
#define RPG_GAMECORE_ROGUETOURNHANDBOOKEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79AB90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID EventTitle; // 0x18
		::System::UInt32 ImageID; // 0x28
		::System::UInt32 EventHandbookID; // 0x2C
		::System::UInt32 UnlockDisplayID; // 0x30
		::System::UInt32 TypeDisplayID; // 0x34
