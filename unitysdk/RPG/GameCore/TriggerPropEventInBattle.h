...
#define RPG_GAMECORE_TRIGGERPROPEVENTINBATTLE_METHOD_3_8691D61D7079393C_OFFSET UNITYSDK_OFFSET(0x1B9A7D90)
#define RPG_GAMECORE_TRIGGERPROPEVENTINBATTLE_METHOD_3_A2D28BC1335A8B57_OFFSET UNITYSDK_OFFSET(0x1B9A7DD0)
#define RPG_GAMECORE_TRIGGERPROPEVENTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A7DC0)
