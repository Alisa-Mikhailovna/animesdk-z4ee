...
#define RPG_GAMECORE_PHOTOGRAPHTRIPODMODECONFIG_METHOD_2_60349FCC21256537_OFFSET UNITYSDK_OFFSET(0x1B6ACD20)
#define RPG_GAMECORE_PHOTOGRAPHTRIPODMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6ACE80)
