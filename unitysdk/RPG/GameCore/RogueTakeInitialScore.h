...
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE_METHOD_3_C2AC8B3BB5B44EF8_OFFSET UNITYSDK_OFFSET(0x1B78DB50)
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE_METHOD_3_DAFAC9E8BDB9E335_OFFSET UNITYSDK_OFFSET(0x1B78DA80)
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B78DB40)
