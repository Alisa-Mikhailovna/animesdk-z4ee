...
#define RPG_GAMECORE_CHALLENGETARGETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B30DBA0)
#define RPG_GAMECORE_CHALLENGETARGETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30DE40)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 ChallengeTargetParam1; // 0x10
		::RPG::GameCore::ChallengeType ChallengeTargetType; // 0x14
		::System::UInt32 ID; // 0x18
		::System::UInt32 ChallengeTargetParam2; // 0x1C
