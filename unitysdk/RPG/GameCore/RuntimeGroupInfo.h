...
#define RPG_GAMECORE_RUNTIMEGROUPINFO_CALCULATECONFLICTIDS_OFFSET UNITYSDK_OFFSET(0xDB29D90)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_COLLECTALLREQUIRESUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xDB2B010)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GETGROUPRANDOMINITCONTROL_OFFSET UNITYSDK_OFFSET(0xDB25E80)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_AIRLINEINITPREFABPATHS_OFFSET UNITYSDK_OFFSET(0xDB29110)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ANCHORINFOS_OFFSET UNITYSDK_OFFSET(0xDB28DB0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_AREAANCHORNAME_OFFSET UNITYSDK_OFFSET(0xDB28C00)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ATMOSPHERECONDITION_OFFSET UNITYSDK_OFFSET(0xDB29800)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_AUDIENCELIST_OFFSET UNITYSDK_OFFSET(0xDB294B0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_BATTLEAREAINFOS_OFFSET UNITYSDK_OFFSET(0xDB28D50)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0xDB291C0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_CONFIGPREFABPATH_OFFSET UNITYSDK_OFFSET(0xDB28C50)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_CONFLICTIDLIST_OFFSET UNITYSDK_OFFSET(0xDB29450)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_CONFLICTWHITELIST_OFFSET UNITYSDK_OFFSET(0xDB272F0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_CROWDLIST_OFFSET UNITYSDK_OFFSET(0xDB29570)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_CURVEINFOS_OFFSET UNITYSDK_OFFSET(0xDB290B0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_DISTRICTINFOS_OFFSET UNITYSDK_OFFSET(0xDB28E10)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ENABLEGROUPAI_OFFSET UNITYSDK_OFFSET(0xDB28CF0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ENABLESTREAMING_OFFSET UNITYSDK_OFFSET(0xDB29A90)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_FORCEUNLOADCONDITION_OFFSET UNITYSDK_OFFSET(0xDB28BB0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_GROUPBAKEDINFO_OFFSET UNITYSDK_OFFSET(0xDB2B150)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_GROUPCOMMONINFO_OFFSET UNITYSDK_OFFSET(0xDB29A10)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_GROUPINFO_OFFSET UNITYSDK_OFFSET(0xDB29A50)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_GROUPPROPERTYMAP_OFFSET UNITYSDK_OFFSET(0xDB29950)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_GROUPSTATELIST_OFFSET UNITYSDK_OFFSET(0xDB298F0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xDB29210)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_HASFIVEDIMINSTANCE_OFFSET UNITYSDK_OFFSET(0xDB2A6E0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_HASLEVELLITTLEGAME_OFFSET UNITYSDK_OFFSET(0xDB2A110)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_HASRANDOMINITCONTROL_OFFSET UNITYSDK_OFFSET(0xDB26250)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_HOYOTAGCONTAINER_OFFSET UNITYSDK_OFFSET(0xDB299B0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0xDB28850)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ISDEAFULTGROUP_OFFSET UNITYSDK_OFFSET(0xDB28A70)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ISDELETE_OFFSET UNITYSDK_OFFSET(0xDB28A20)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ISHOYOGROUP_OFFSET UNITYSDK_OFFSET(0xDB29260)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ISINROTATABLEREGION_OFFSET UNITYSDK_OFFSET(0xDB29D40)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ISPENDEDLOAD_OFFSET UNITYSDK_OFFSET(0xDB29710)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ISPENDEDUNLOAD_OFFSET UNITYSDK_OFFSET(0xDB29760)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_LEVELGRAPHPATH_OFFSET UNITYSDK_OFFSET(0xDB28CA0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_LEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xDB292B0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_LITTLEGAMELIST_OFFSET UNITYSDK_OFFSET(0xDB285E0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_LOADCONDITION_OFFSET UNITYSDK_OFFSET(0xDB28B10)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_LOADONINITIAL_OFFSET UNITYSDK_OFFSET(0xDB28AC0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_LOADSIDE_OFFSET UNITYSDK_OFFSET(0xDB29300)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_MAPROTATIONPOSE_OFFSET UNITYSDK_OFFSET(0xDB2A0F0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_MONSTERINFOS_OFFSET UNITYSDK_OFFSET(0xDB29050)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0xDB289D0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_NPCINFOS_OFFSET UNITYSDK_OFFSET(0xDB28F90)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_OWNERMAINMISSIONID_OFFSET UNITYSDK_OFFSET(0xDB29350)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_PATHWAYINFOS_OFFSET UNITYSDK_OFFSET(0xDB28E70)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_PEDESTRIANLIST_OFFSET UNITYSDK_OFFSET(0xDB295D0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_PEDESTRIANV2BAKEDLIST_OFFSET UNITYSDK_OFFSET(0xDB29690)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_PEDESTRIANV2LIST_OFFSET UNITYSDK_OFFSET(0xDB29630)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xDB288A0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_PROPINFOS_OFFSET UNITYSDK_OFFSET(0xDB28FF0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_RANDOMINITRESULTS_OFFSET UNITYSDK_OFFSET(0xDB26210)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_RANDOMINIT_OFFSET UNITYSDK_OFFSET(0xDB293A0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_REFRESHID_OFFSET UNITYSDK_OFFSET(0xDB29170)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ROTATABLEREGIONINDEX_OFFSET UNITYSDK_OFFSET(0xDB2A080)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0xDB28920)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_SAVEDVALUECONDITION_OFFSET UNITYSDK_OFFSET(0xDB297B0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_SHOULDUNLOADONENTERFIVEDIM_OFFSET UNITYSDK_OFFSET(0xDB2A700)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_SMARTOBJECTINFOS_OFFSET UNITYSDK_OFFSET(0xDB28ED0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_SPATIALCONFLICTWHITELIST_OFFSET UNITYSDK_OFFSET(0xDB2B260)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_STREAMINGSPATIALINFO_OFFSET UNITYSDK_OFFSET(0xDB29D00)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_STREAMINGTEMPLATETYPE_OFFSET UNITYSDK_OFFSET(0xDB29850)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_SYSTEMUNLOCKCONDITION_OFFSET UNITYSDK_OFFSET(0xDB298A0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_UNLOADCONDITION_OFFSET UNITYSDK_OFFSET(0xDB28B60)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_USECUSTOMSAVEDATA_OFFSET UNITYSDK_OFFSET(0xDB29400)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_VALUESOURCE_OFFSET UNITYSDK_OFFSET(0xDB29510)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_GET_WAYPOINTINFOS_OFFSET UNITYSDK_OFFSET(0xDB28F30)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_INITFIVEDIMINFO_OFFSET UNITYSDK_OFFSET(0xDB2A720)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_INITLEVELLITTLEGAMEINFO_OFFSET UNITYSDK_OFFSET(0xDB2A130)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_INITMAPROTATIONPOSE_OFFSET UNITYSDK_OFFSET(0xDB2A0A0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_INITROTATABLEREGIONINDEX_OFFSET UNITYSDK_OFFSET(0xDB2A030)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_ISRANDOMINITCONTROLLEDCROWD_OFFSET UNITYSDK_OFFSET(0xDB260F0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_ISRANDOMINITCONTROLLEDNPC_OFFSET UNITYSDK_OFFSET(0xDB26010)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_ISRANDOMINITCONTROLLEDPROP_OFFSET UNITYSDK_OFFSET(0xDB26080)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_ISRANDOMINITRESULTSCONTAINSCROWD_OFFSET UNITYSDK_OFFSET(0xDB26160)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_POSTINITFIVDIMINFO_OFFSET UNITYSDK_OFFSET(0xDB2AEA0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_SET_GROUPBAKEDINFO_OFFSET UNITYSDK_OFFSET(0xDB2B1B0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_SET_HASFIVEDIMINSTANCE_OFFSET UNITYSDK_OFFSET(0xDB2A6F0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_SET_HASLEVELLITTLEGAME_OFFSET UNITYSDK_OFFSET(0xDB2A120)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_SET_MAPROTATIONPOSE_OFFSET UNITYSDK_OFFSET(0xDB2A100)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_SET_ROTATABLEREGIONINDEX_OFFSET UNITYSDK_OFFSET(0xDB2A090)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_SET_SHOULDUNLOADONENTERFIVEDIM_OFFSET UNITYSDK_OFFSET(0xDB2A710)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETENTITYBAKEDINFORAWDATA_FORDISTRICTONLY_OFFSET UNITYSDK_OFFSET(0xDB27E40)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETENTITYBAKEDINFORAWDATA_OFFSET UNITYSDK_OFFSET(0xDB27D30)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETFIRSTLEVELMONSTERINFO_OFFSET UNITYSDK_OFFSET(0xDB278E0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETFIVEDIMBAKEDLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0xDB286F0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETFIVEDIMLEVELCHEATSHEET_OFFSET UNITYSDK_OFFSET(0xDB287A0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETLEVELDISTRICTINFO_OFFSET UNITYSDK_OFFSET(0xDB27B50)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETLEVELMONSTERINFO_OFFSET UNITYSDK_OFFSET(0xDB27830)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETLEVELNPCINFO_OFFSET UNITYSDK_OFFSET(0xDB27350)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETLEVELPROPINFOBYMAPPINGINFOID_OFFSET UNITYSDK_OFFSET(0xDB27A30)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETLEVELPROPINFO_OFFSET UNITYSDK_OFFSET(0xDB27990)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETLITTLEGAMEINFO_OFFSET UNITYSDK_OFFSET(0xDB282E0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETLITTLEGAMELEVELCONFIG_OFFSET UNITYSDK_OFFSET(0xDB28640)
#define RPG_GAMECORE_RUNTIMEGROUPINFO_TRYGETNPCCONNECTSUBMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xDB27F30)
#define RPG_GAMECORE_RUNTIMEGROUPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xDB262C0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO__DORANDOMINIT_OFFSET UNITYSDK_OFFSET(0xDB25810)
#define RPG_GAMECORE_RUNTIMEGROUPINFO__INITMONSTERDICT_OFFSET UNITYSDK_OFFSET(0xDB27530)
#define RPG_GAMECORE_RUNTIMEGROUPINFO__INITPROPDICT_OFFSET UNITYSDK_OFFSET(0xDB276B0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO__INITSPATIALCONFLICTWHITELIST_OFFSET UNITYSDK_OFFSET(0xDB271A0)
#define RPG_GAMECORE_RUNTIMEGROUPINFO__PROCESSDELETEDDATA_OFFSET UNITYSDK_OFFSET(0xDB26330)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::FiveDimBakedLevelConfig*>* _BakedLevelConfigDict; // 0x10
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _SpatialConflictWhitelist; // 0x18
		::Il2CppArray<::System::UInt32>* _RandomInitControlCrowdIDs; // 0x20
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LevelPropInfo*>* _PropDict; // 0x38
		::Il2CppArray<::RPG::GameCore::LevelGroupRandomInitControl*>* _RandomInitResults; // 0x40
		::Struct_2_CC45B4503679E14E_47 _GroupBakedInfo; // 0x48
		...
		::RPG::GameCore::RtLevelGroupInfo* _RawGroupInfo; // 0x68
		::Class_1_5226E24814FA0066* _StreamingSpatialInfo; // 0x70
		::RPG::GameCore::RtLevelGroupInstanceInfo* _RawGroupInstanceInfo; // 0x78
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LevelMonsterInfo*>* _MonsterDict; // 0x80
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_EBB880A8D2C9B0D4*>* _FiveDimLevelCheatSheetDict; // 0x88
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LevelNPCInfo*>* _NPCDict; // 0x90
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameLevelConfig*>* _LittleGameLevelConfigDict; // 0x98
		::System::UInt32 _MapRotationPose_k__BackingField; // 0xA0
		::System::Boolean _HasFiveDimInstance_k__BackingField; // 0xA4
		::System::Boolean _ShouldUnloadOnEnterFiveDim_k__BackingField; // 0xA5
		::System::Boolean _HasLevelLittleGame_k__BackingField; // 0xA6
		::System::Int32 _RotatableRegionIndex_k__BackingField; // 0xA8
