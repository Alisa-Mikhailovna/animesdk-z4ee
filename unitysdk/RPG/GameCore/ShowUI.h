...
#define RPG_GAMECORE_SHOWUI_METHOD_3_4FD773016802648E_OFFSET UNITYSDK_OFFSET(0x1B8D6EE0)
#define RPG_GAMECORE_SHOWUI_METHOD_3_9E2AECFBF40F6AA0_OFFSET UNITYSDK_OFFSET(0x1B8D6EA0)
#define RPG_GAMECORE_SHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D6ED0)
