...
#define RPG_GAMECORE_EDITORREPLACEMATERIALSCHEME_METHOD_2_789D1A072D331B8C_OFFSET UNITYSDK_OFFSET(0x1B3D3B20)
#define RPG_GAMECORE_EDITORREPLACEMATERIALSCHEME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D3CA0)
