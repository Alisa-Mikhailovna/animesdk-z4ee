...
#define RPG_GAMECORE_PROPLODDETAIL_METHOD_3_68EAC2B0C6D4B98D_OFFSET UNITYSDK_OFFSET(0x1B6E70C0)
#define RPG_GAMECORE_PROPLODDETAIL_METHOD_3_D39EE853BCC53661_OFFSET UNITYSDK_OFFSET(0x1B6E7120)
#define RPG_GAMECORE_PROPLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E7100)
