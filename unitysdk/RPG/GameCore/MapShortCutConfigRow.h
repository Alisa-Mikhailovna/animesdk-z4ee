...
#define RPG_GAMECORE_MAPSHORTCUTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5AC0B0)
#define RPG_GAMECORE_MAPSHORTCUTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5AC890)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MapShortCutType Type; // 0x20
