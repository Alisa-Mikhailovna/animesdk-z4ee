...
#define RPG_GAMECORE_PROJECTILEBEZIERCONTROLPOINT_METHOD_2_F9D70BCC0146532B_OFFSET UNITYSDK_OFFSET(0x1B6DBB40)
#define RPG_GAMECORE_PROJECTILEBEZIERCONTROLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6DBC70)
