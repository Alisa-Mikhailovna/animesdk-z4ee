...
#define RPG_GAMECORE_SHOWBATTLESCREENEFFECT_METHOD_3_2093EEECD5D7D591_OFFSET UNITYSDK_OFFSET(0x1B8C7DD0)
#define RPG_GAMECORE_SHOWBATTLESCREENEFFECT_METHOD_3_EA785034FACB0F08_OFFSET UNITYSDK_OFFSET(0x1B8C7D90)
#define RPG_GAMECORE_SHOWBATTLESCREENEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C7DC0)
