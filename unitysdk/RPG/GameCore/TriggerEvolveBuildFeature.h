...
#define RPG_GAMECORE_TRIGGEREVOLVEBUILDFEATURE_METHOD_3_07252C0DD45CC917_OFFSET UNITYSDK_OFFSET(0x1B9A2C40)
#define RPG_GAMECORE_TRIGGEREVOLVEBUILDFEATURE_METHOD_3_BF588B0F6A6CE522_OFFSET UNITYSDK_OFFSET(0x1B9A2C00)
#define RPG_GAMECORE_TRIGGEREVOLVEBUILDFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A2C30)
