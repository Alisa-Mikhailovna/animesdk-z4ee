...
#define RPG_GAMECORE_SHOWROGUELOADINGPAGE_METHOD_3_7C9B6B2E5E4D6A8B_OFFSET UNITYSDK_OFFSET(0x1B8D2EF0)
#define RPG_GAMECORE_SHOWROGUELOADINGPAGE_METHOD_3_927BA36A6FFCBC8E_OFFSET UNITYSDK_OFFSET(0x1B8D2E20)
#define RPG_GAMECORE_SHOWROGUELOADINGPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D2EE0)
