...
#define RPG_GAMECORE_ANIMATORCLIPZONEDESCCONFIG_METHOD_2_5BAEB39FB4ED61CC_OFFSET UNITYSDK_OFFSET(0x1B1A6FE0)
#define RPG_GAMECORE_ANIMATORCLIPZONEDESCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A7130)
