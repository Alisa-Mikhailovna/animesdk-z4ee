...
#define RPG_GAMECORE_HOYOTAGINFO_METHOD_2_26DB6C9FD960C0CE_OFFSET UNITYSDK_OFFSET(0x1B51DEE0)
#define RPG_GAMECORE_HOYOTAGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51DFA0)
