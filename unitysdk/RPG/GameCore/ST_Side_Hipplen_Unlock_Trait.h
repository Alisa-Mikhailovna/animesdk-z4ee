...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_UNLOCK_TRAIT_METHOD_4_D61C1F1240B1577C_OFFSET UNITYSDK_OFFSET(0x1B7E2BE0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_UNLOCK_TRAIT_METHOD_4_F7EF4B3DAFD18CB7_OFFSET UNITYSDK_OFFSET(0x1B7E2C20)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_UNLOCK_TRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E2C10)
