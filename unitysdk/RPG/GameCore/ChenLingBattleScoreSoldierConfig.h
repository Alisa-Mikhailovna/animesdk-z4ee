...
#define RPG_GAMECORE_CHENLINGBATTLESCORESOLDIERCONFIG_METHOD_2_02A4002F7EFD4AFC_OFFSET UNITYSDK_OFFSET(0x1B32E2D0)
#define RPG_GAMECORE_CHENLINGBATTLESCORESOLDIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B330580)
