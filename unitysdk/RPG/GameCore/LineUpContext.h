...
#define RPG_GAMECORE_LINEUPCONTEXT_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0xDAE6E20)
#define RPG_GAMECORE_LINEUPCONTEXT_GETBATTLEACHIEVEMENTDATA_OFFSET UNITYSDK_OFFSET(0xDAE6760)
#define RPG_GAMECORE_LINEUPCONTEXT_GETBATTLERAIDTARGETDATA_OFFSET UNITYSDK_OFFSET(0xDAE6940)
#define RPG_GAMECORE_LINEUPCONTEXT_GETMONSTERWAVELIST_OFFSET UNITYSDK_OFFSET(0xDAE65D0)
#define RPG_GAMECORE_LINEUPCONTEXT_GETMONSTERWAVESTAGECOUNT_OFFSET UNITYSDK_OFFSET(0xDAE6610)
#define RPG_GAMECORE_LINEUPCONTEXT_GETROGUEGOALDATA_OFFSET UNITYSDK_OFFSET(0xDAE6B40)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_MAXWAVEOVERRIDE_OFFSET UNITYSDK_OFFSET(0xDAE7E40)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_STAGEBINDINGMAZEBUFFDATALIST_OFFSET UNITYSDK_OFFSET(0xDAE7DD0)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_STAGECONFIG_OFFSET UNITYSDK_OFFSET(0xDAE7A30)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xDAE7770)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_STAGETYPE_OFFSET UNITYSDK_OFFSET(0xDAE7A10)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_TREATWAVESASINFINITE_OFFSET UNITYSDK_OFFSET(0xDAE7E50)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xDAE7750)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0xDAE7DE0)
#define RPG_GAMECORE_LINEUPCONTEXT_HASMAZEBUFFDATA_OFFSET UNITYSDK_OFFSET(0xDAE7D40)
#define RPG_GAMECORE_LINEUPCONTEXT_RESET_OFFSET UNITYSDK_OFFSET(0xDAE64A0)
#define RPG_GAMECORE_LINEUPCONTEXT_SETWAVESBYOVERRIDE_OFFSET UNITYSDK_OFFSET(0xDAE6D40)
#define RPG_GAMECORE_LINEUPCONTEXT_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xDAE6570)
#define RPG_GAMECORE_LINEUPCONTEXT_SET_STAGETYPE_OFFSET UNITYSDK_OFFSET(0xDAE7A20)
#define RPG_GAMECORE_LINEUPCONTEXT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xDAE7760)
#define RPG_GAMECORE_LINEUPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDAE7710)
#define RPG_GAMECORE_LINEUPCONTEXT__ONSTAGEIDCHANGED_OFFSET UNITYSDK_OFFSET(0xDAE7780)
#define RPG_GAMECORE_LINEUPCONTEXT__SETUPSTAGEBINDINGMAZEBUFFDATA_OFFSET UNITYSDK_OFFSET(0xDAE7A90)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::String*>* AdditionBattleWinConditions; // 0x10
		::System::Collections::Generic::List_1<::Class_1_3F916053B9BB8D97*>* _MonsterWaves; // 0x18
		::Il2CppArray<::Class_1_7AB88D713F5121B3_46*>* BattleRougeGoalList; // 0x20
		::Il2CppArray<::Class_1_07A210D994F284D8_5*>* BattleAchievementList; // 0x28
		::Il2CppArray<::System::String*>* AdditionBattleLoseConditions; // 0x30
		::RPG::GameCore::BattleRogueData* BattleRogueData; // 0x38
		::Il2CppArray<::Class_1_60D44DC008A2AE94*>* MonsterRewardList; // 0x40
		::Il2CppArray<::Class_1_7AB88D713F5121B3_47*>* BattleRaidTargetList; // 0x48
		::System::Collections::Generic::List_1<::RPG::GameCore::MazeBuffData*>* GeneratedBindingBuffList; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_7AB88D713F5121B3_46*>* _BattleChallengeScoreDataMap; // 0x58
		::Class_1_B66FD2332404CEBB* BattleEvolveBuildData; // 0x60
		::Il2CppArray<::Class_1_7AB88D713F5121B3_45*>* BattleTargetList; // 0x68
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_07A210D994F284D8_5*>* _BattleAchievementDataMap; // 0x70
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_7AB88D713F5121B3_47*>* _BattleRaidTargetDataMap; // 0x78
		::Il2CppArray<::Class_1_5F0CB4974A75F258*>* AvatarExtraAbilityList; // 0x80
		::Class_1_22B8FDC4E33ACC56* BattleGridFightData; // 0x88
		::Class_1_CC0B29182510F813* BattleFateRinData; // 0x90
		::Il2CppArray<::RPG::GameCore::MazeBuffData*>* MazeBuffDataList; // 0x98
		::Il2CppArray<::Class_1_7AB88D713F5121B3_45*>* BattleScoreList; // 0xA0
		::Il2CppArray<::RPG::GameCore::MazeBuffData*>* _StageBindingMazeBuffDataList; // 0xA8
		::Class_1_9F8A90B6D6D276E5* BattleFateData; // 0xB0
		::Class_1_08B5ACC5F83BB932* BattleSwordTrainingData; // 0xB8
		::System::UInt32 BattleActionEventId; // 0xC0
		::System::UInt32 _MaxWaveOverride; // 0xC4
		::System::UInt32 _StageID; // 0xC8
		::RPG::GameCore::RogueMode BattleRogueMode; // 0xCC
		::Enum_3_71AA90D596A09AC8_2 _Type_k__BackingField; // 0xD0
		::RPG::GameCore::StageType _StageType_k__BackingField; // 0xD4
		::System::Boolean _GetOverrideWaveFlag; // 0xD8
