...
#define RPG_GAMECORE_SHOWHINTNOTIFYCONFIG_METHOD_2_81296F3272A5F40A_OFFSET UNITYSDK_OFFSET(0x1B8D04E0)
#define RPG_GAMECORE_SHOWHINTNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D05E0)
