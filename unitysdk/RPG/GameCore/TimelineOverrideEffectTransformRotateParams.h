...
#define RPG_GAMECORE_TIMELINEOVERRIDEEFFECTTRANSFORMROTATEPARAMS_METHOD_1_9E3F716220C7A711_OFFSET UNITYSDK_OFFSET(0xDBD7B10)
#define RPG_GAMECORE_TIMELINEOVERRIDEEFFECTTRANSFORMROTATEPARAMS_METHOD_1_FF12EDFB6B41BDC9_OFFSET UNITYSDK_OFFSET(0xDBD7A10)
#define RPG_GAMECORE_TIMELINEOVERRIDEEFFECTTRANSFORMROTATEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xDBD7AE0)
