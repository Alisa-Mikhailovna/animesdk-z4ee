...
#define RPG_GAMECORE_LEVELTURNLIMITCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADCBD0)
#define RPG_GAMECORE_LEVELTURNLIMITCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADCB80)
#define RPG_GAMECORE_LEVELTURNLIMITCHANGE_GET_FROMLIMIT_OFFSET UNITYSDK_OFFSET(0xDADCC40)
#define RPG_GAMECORE_LEVELTURNLIMITCHANGE_GET_LIMITTYPE_OFFSET UNITYSDK_OFFSET(0xDADCC20)
#define RPG_GAMECORE_LEVELTURNLIMITCHANGE_GET_TOLIMIT_OFFSET UNITYSDK_OFFSET(0xDADCC60)
#define RPG_GAMECORE_LEVELTURNLIMITCHANGE_SET_FROMLIMIT_OFFSET UNITYSDK_OFFSET(0xDADCC50)
#define RPG_GAMECORE_LEVELTURNLIMITCHANGE_SET_LIMITTYPE_OFFSET UNITYSDK_OFFSET(0xDADCC30)
#define RPG_GAMECORE_LEVELTURNLIMITCHANGE_SET_TOLIMIT_OFFSET UNITYSDK_OFFSET(0xDADCC70)
#define RPG_GAMECORE_LEVELTURNLIMITCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xDADCB70)
