...
#define RPG_GAMECORE_FIXROT2_EQUALS_OFFSET UNITYSDK_OFFSET(0x39FBFD0)
#define RPG_GAMECORE_FIXROT2_GET_DEGREES_OFFSET UNITYSDK_OFFSET(0x39FC2E0)
#define RPG_GAMECORE_FIXROT2_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1BA71A50)
#define RPG_GAMECORE_FIXROT2_GET_RADIANS_OFFSET UNITYSDK_OFFSET(0x39FC2D0)
#define RPG_GAMECORE_FIXROT2_METHOD_2_00D89123D6756C9E_OFFSET UNITYSDK_OFFSET(0x39FC1B0)
#define RPG_GAMECORE_FIXROT2_METHOD_2_1490F64A9B863CBE_1_OFFSET UNITYSDK_OFFSET(0x1BA71550)
#define RPG_GAMECORE_FIXROT2_METHOD_2_1490F64A9B863CBE_OFFSET UNITYSDK_OFFSET(0x1BA714F0)
#define RPG_GAMECORE_FIXROT2_METHOD_2_C3CAED94F815F028_1_OFFSET UNITYSDK_OFFSET(0x1BA71980)
#define RPG_GAMECORE_FIXROT2_METHOD_2_C3CAED94F815F028_OFFSET UNITYSDK_OFFSET(0x1BA718F0)
#define RPG_GAMECORE_FIXROT2_METHOD_2_C55DB3D9B4439C33_OFFSET UNITYSDK_OFFSET(0x39FC120)
#define RPG_GAMECORE_FIXROT2_METHOD_2_F73ABB3E14131F9A_OFFSET UNITYSDK_OFFSET(0x80E20)
#define RPG_GAMECORE_FIXROT2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39FC310)
#define RPG_GAMECORE_FIXROT2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BA71AF0)
#define RPG_GAMECORE_FIXROT2__CTOR_OFFSET UNITYSDK_OFFSET(0x80E20)
...
namespace RPG::GameCore
{
	...
	struct alignas(8) FixRot2
	{
		...
		{
			return (::RPG::GameCore::FixRot2*)Il2CppClass::FromTypeDefinitionIndex(FixRot2_TypeDefinitionIndex)->GetStaticField(0x9040);
		}
