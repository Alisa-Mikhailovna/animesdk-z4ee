...
#define RPG_GAMECORE_RTSKILLPROPERTYCONFIG_METHOD_3_3B17BC4F83EB7980_OFFSET UNITYSDK_OFFSET(0x1B7C29C0)
#define RPG_GAMECORE_RTSKILLPROPERTYCONFIG_METHOD_3_DB3E9E46882A0D7C_OFFSET UNITYSDK_OFFSET(0x1B7C2520)
#define RPG_GAMECORE_RTSKILLPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C2510)
