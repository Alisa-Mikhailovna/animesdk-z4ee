...
#define RPG_GAMECORE_ADDBYMAXSTANCECONFIG_METHOD_2_169CCB0447BEE926_OFFSET UNITYSDK_OFFSET(0x1B139F40)
#define RPG_GAMECORE_ADDBYMAXSTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B13A350)
