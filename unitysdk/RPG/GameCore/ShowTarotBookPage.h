...
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE_METHOD_3_CF90E17893922B9F_OFFSET UNITYSDK_OFFSET(0x1B8D5840)
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE_METHOD_3_DD85DD0C99BEA7FE_OFFSET UNITYSDK_OFFSET(0x1B8D5880)
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D5870)
