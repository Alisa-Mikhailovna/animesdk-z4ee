...
#define RPG_GAMECORE_VE_RTMODIFIERPROPERTY_METHOD_3_0A7A9C07107D227D_OFFSET UNITYSDK_OFFSET(0x1B9D5490)
#define RPG_GAMECORE_VE_RTMODIFIERPROPERTY_METHOD_3_5B4DA16DD6217905_OFFSET UNITYSDK_OFFSET(0x1B9D54F0)
#define RPG_GAMECORE_VE_RTMODIFIERPROPERTY_METHOD_3_92F60AC2321159B0_OFFSET UNITYSDK_OFFSET(0x1B9D51A0)
#define RPG_GAMECORE_VE_RTMODIFIERPROPERTY_METHOD_3_ED7A0950C7C936B9_OFFSET UNITYSDK_OFFSET(0x1B9D5240)
#define RPG_GAMECORE_VE_RTMODIFIERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D5200)
