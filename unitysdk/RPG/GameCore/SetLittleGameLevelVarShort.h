...
#define RPG_GAMECORE_SETLITTLEGAMELEVELVARSHORT_METHOD_3_8A534834B69B54D5_OFFSET UNITYSDK_OFFSET(0x1B8A7F50)
#define RPG_GAMECORE_SETLITTLEGAMELEVELVARSHORT_METHOD_3_A6275B8A80C7ABC0_OFFSET UNITYSDK_OFFSET(0x1B8A7F10)
#define RPG_GAMECORE_SETLITTLEGAMELEVELVARSHORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A7F40)
