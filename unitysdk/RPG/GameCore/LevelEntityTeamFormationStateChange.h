...
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDAD3910)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDAD38C0)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_ISFOLLOWER_OFFSET UNITYSDK_OFFSET(0xDAD3990)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_ISINTEAM_OFFSET UNITYSDK_OFFSET(0xDAD3980)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_SOURCEENTITY_OFFSET UNITYSDK_OFFSET(0xDAD3960)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_TEAM_OFFSET UNITYSDK_OFFSET(0xDAD3970)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xDAD38A0)
