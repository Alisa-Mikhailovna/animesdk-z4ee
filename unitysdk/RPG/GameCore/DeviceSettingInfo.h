...
#define RPG_GAMECORE_DEVICESETTINGINFO_METHOD_2_BB2755C35E17CDD0_OFFSET UNITYSDK_OFFSET(0x1B3A5FA0)
#define RPG_GAMECORE_DEVICESETTINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A61A0)
