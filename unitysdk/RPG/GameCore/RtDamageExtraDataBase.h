...
#define RPG_GAMECORE_RTDAMAGEEXTRADATABASE_METHOD_2_7472E53B74CDDBC5_OFFSET UNITYSDK_OFFSET(0x1B7B7B50)
#define RPG_GAMECORE_RTDAMAGEEXTRADATABASE_METHOD_2_EE74DBF244932ED3_OFFSET UNITYSDK_OFFSET(0x1B7B7930)
#define RPG_GAMECORE_RTDAMAGEEXTRADATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B7B40)
