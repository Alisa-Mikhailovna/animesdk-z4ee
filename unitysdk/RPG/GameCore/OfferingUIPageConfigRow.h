...
#define RPG_GAMECORE_OFFERINGUIPAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B679580)
#define RPG_GAMECORE_OFFERINGUIPAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B679A60)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::Client::TextID CostTitle; // 0x10
		::RPG::Client::TextID LevelTitle; // 0x20
		::RPG::Client::TextID LongTailTitle; // 0x30
		::System::UInt32 ID; // 0x40
		::RPG::Client::TextID SubmitBtnName; // 0x48
		::RPG::Client::TextID MaxTip; // 0x58
