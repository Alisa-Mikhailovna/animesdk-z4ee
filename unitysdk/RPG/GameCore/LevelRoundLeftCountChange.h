...
#define RPG_GAMECORE_LEVELROUNDLEFTCOUNTCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADAAA0)
#define RPG_GAMECORE_LEVELROUNDLEFTCOUNTCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADAA50)
#define RPG_GAMECORE_LEVELROUNDLEFTCOUNTCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xDADA9F0)
#define RPG_GAMECORE_LEVELROUNDLEFTCOUNTCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xDADAAF0)
