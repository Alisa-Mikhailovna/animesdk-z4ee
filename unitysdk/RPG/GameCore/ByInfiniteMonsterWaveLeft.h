...
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_32C8BD2F7A4A9D61_OFFSET UNITYSDK_OFFSET(0x1B2A17B0)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_58AF3567F4A899AE_OFFSET UNITYSDK_OFFSET(0x1B2A17F0)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_7D8344CAE46B1B04_OFFSET UNITYSDK_OFFSET(0x1B2A15D0)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_C4EB45136157ADBD_OFFSET UNITYSDK_OFFSET(0x1B2A1620)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A1610)
