...
#define RPG_GAMECORE_ELFSELECTEVENTTALK_METHOD_2_3F94B5673198D43B_OFFSET UNITYSDK_OFFSET(0x1B3DD390)
#define RPG_GAMECORE_ELFSELECTEVENTTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DD4F0)
