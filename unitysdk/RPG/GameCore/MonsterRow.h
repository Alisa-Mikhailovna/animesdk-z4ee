...
#define RPG_GAMECORE_MONSTERROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B62A120)
#define RPG_GAMECORE_MONSTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B62AEB0)
#define RPG_GAMECORE_MONSTERROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B62EDA0)
#define RPG_GAMECORE_MONSTERROW_GETMONSTERRANK_OFFSET UNITYSDK_OFFSET(0x1B62C250)
#define RPG_GAMECORE_MONSTERROW_GET_AETHERDIVIDETYPE_OFFSET UNITYSDK_OFFSET(0x1B62EE80)
#define RPG_GAMECORE_MONSTERROW_GET_MONSTERUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1B62EF30)
#define RPG_GAMECORE_MONSTERROW_GET__EXPANDEDDATAROW_OFFSET UNITYSDK_OFFSET(0x1B62EEE0)
#define RPG_GAMECORE_MONSTERROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B62EE00)
#define RPG_GAMECORE_MONSTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B62EE70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_B7B6A11029867830*>* OverrideSkillParams; // 0x18
		::RPG::GameCore::AetherDivideMonsterRow* _ExpandedDataRowCache; // 0x20
		::Il2CppArray<::RPG::GameCore::ElementResistanceConfig*>* DamageTypeResistance; // 0x28
		::Il2CppArray<::Class_1_2EC0EF10CE4B8713*>* OverrideAISkillSequence; // 0x30
		...
		::Il2CppArray<::Class_1_EDD10E908F1C4623*>* CustomValues; // 0x50
		::Il2CppArray<::Class_1_B34BC0DFAA62C487*>* DynamicValues; // 0x58
		::Il2CppArray<::System::String*>* AbilityNameList; // 0x60
		::Il2CppArray<::System::UInt32>* SummonIDList; // 0x68
		::System::String* OverrideAIPath; // 0x70
		::Il2CppArray<::RPG::GameCore::MonsterResistEntry*>* DebuffResist; // 0x78
		::RPG::Client::TextID MonsterBattleIntroduction; // 0x80
		::RPG::GameCore::FixPoint HPModifyValue; // 0x90
		::System::UInt32 MonsterType; // 0x98
		::System::UInt32 MonsterTemplateID; // 0x9C
		::RPG::GameCore::FixPoint StanceModifyValue; // 0xA0
		::RPG::Client::TextID MonsterIntroduction; // 0xA8
		::RPG::GameCore::FixPoint AttackModifyRatio; // 0xB8
		::RPG::GameCore::FixPoint AttackModifyValue; // 0xC0
		::System::UInt32 MonsterID; // 0xC8
		::System::UInt32 Level; // 0xCC
		::RPG::GameCore::FixPoint DefenceModifyRatio; // 0xD0
		::System::Boolean _IsCached; // 0xD8
		::System::Int32 StanceCountDelta; // 0xDC
		::RPG::Client::TextID MonsterName; // 0xE0
		::RPG::GameCore::FixPoint HPModifyRatio; // 0xF0
		::System::UInt32 HardLevelGroup; // 0xF8
		::System::UInt32 EliteGroup; // 0xFC
		::RPG::GameCore::FixPoint DefenceModifyValue; // 0x100
		::RPG::GameCore::FixPoint SpeedModifyValue; // 0x108
		::RPG::GameCore::FixPoint SpeedModifyRatio; // 0x110
		::RPG::GameCore::FixPoint StanceModifyRatio; // 0x118
