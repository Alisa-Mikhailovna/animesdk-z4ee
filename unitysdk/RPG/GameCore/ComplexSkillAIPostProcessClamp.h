...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSCLAMP_METHOD_3_34DCE66C636C1B89_OFFSET UNITYSDK_OFFSET(0x1B3767B0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSCLAMP_METHOD_3_AC880BC480729C4A_OFFSET UNITYSDK_OFFSET(0x1B3762C0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSCLAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3762B0)
