...
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK_METHOD_3_725079C75BFC73B3_OFFSET UNITYSDK_OFFSET(0x1B8D05F0)
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK_METHOD_3_BBADCB6F8B8BACC4_OFFSET UNITYSDK_OFFSET(0x1B8D0640)
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D0630)
