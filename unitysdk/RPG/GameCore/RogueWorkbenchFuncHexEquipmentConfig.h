...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCHEXEQUIPMENTCONFIG_METHOD_3_A0E5AE9E8E07BC43_OFFSET UNITYSDK_OFFSET(0x1B7A5050)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCHEXEQUIPMENTCONFIG_METHOD_3_DD1B748DBAA0AFC7_OFFSET UNITYSDK_OFFSET(0x1B7A4E30)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCHEXEQUIPMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4E20)
