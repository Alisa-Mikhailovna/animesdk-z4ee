...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_MODIFIERSTACKCOUNT_METHOD_3_CDB4C8FFB185E50A_OFFSET UNITYSDK_OFFSET(0x1B3BAB00)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_MODIFIERSTACKCOUNT_METHOD_3_DF5FA45AA09D9B61_OFFSET UNITYSDK_OFFSET(0x1B3BAB60)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_MODIFIERSTACKCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3BAB50)
