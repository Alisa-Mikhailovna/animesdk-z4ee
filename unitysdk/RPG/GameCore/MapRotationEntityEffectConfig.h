...
#define RPG_GAMECORE_MAPROTATIONENTITYEFFECTCONFIG_METHOD_2_237C6CD412A34839_OFFSET UNITYSDK_OFFSET(0x1B5A9F60)
#define RPG_GAMECORE_MAPROTATIONENTITYEFFECTCONFIG_METHOD_2_B28EAC3C4A8DDF34_OFFSET UNITYSDK_OFFSET(0x1B5A9DD0)
#define RPG_GAMECORE_MAPROTATIONENTITYEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A9F50)
