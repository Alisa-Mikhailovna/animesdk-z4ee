...
#define RPG_GAMECORE_SETCHARACTERSHADOWFACTOR_METHOD_3_2C705EFE023C67FF_OFFSET UNITYSDK_OFFSET(0x1B88BC00)
#define RPG_GAMECORE_SETCHARACTERSHADOWFACTOR_METHOD_3_C5350054DAFB1B1E_OFFSET UNITYSDK_OFFSET(0x1B88BBC0)
#define RPG_GAMECORE_SETCHARACTERSHADOWFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88BBF0)
