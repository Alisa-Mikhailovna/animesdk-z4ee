...
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_A34C2405751BD2E0_OFFSET UNITYSDK_OFFSET(0x1B2B0DB0)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_AAC00323463F8DA0_OFFSET UNITYSDK_OFFSET(0x1B2B0C10)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_BBB14A4284876633_OFFSET UNITYSDK_OFFSET(0x1B2B0C40)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_C55DD720A5241369_OFFSET UNITYSDK_OFFSET(0x1B2B0D80)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C1D90)
