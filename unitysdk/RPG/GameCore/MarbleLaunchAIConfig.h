...
#define RPG_GAMECORE_MARBLELAUNCHAICONFIG_METHOD_2_3D2FC51262288A18_OFFSET UNITYSDK_OFFSET(0x1B5B8CB0)
#define RPG_GAMECORE_MARBLELAUNCHAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B8F00)
