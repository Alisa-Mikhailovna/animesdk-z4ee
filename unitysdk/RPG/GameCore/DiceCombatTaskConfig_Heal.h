...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_HEAL_METHOD_3_52D9612A5B56A95D_OFFSET UNITYSDK_OFFSET(0x1B3B7510)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_HEAL_METHOD_3_BB1E4A3EA7CB8BFE_OFFSET UNITYSDK_OFFSET(0x1B3B74B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_HEAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B7500)
