...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPROLESELECTOR_METHOD_3_0D6A0AAD6F56CFD2_OFFSET UNITYSDK_OFFSET(0x1B4D70B0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPROLESELECTOR_METHOD_3_527A6A0DCA80CC38_OFFSET UNITYSDK_OFFSET(0x1B4D6E70)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPROLESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D6E60)
