...
#define RPG_GAMECORE_FREESTYLECHARACTEREXTENDLAYERCONFIG_METHOD_2_4E6E24A4293DC7C4_OFFSET UNITYSDK_OFFSET(0x1B4A0D90)
#define RPG_GAMECORE_FREESTYLECHARACTEREXTENDLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A0E90)
