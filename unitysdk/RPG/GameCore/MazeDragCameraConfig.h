...
#define RPG_GAMECORE_MAZEDRAGCAMERACONFIG_METHOD_2_BE472612B613C70B_OFFSET UNITYSDK_OFFSET(0x1B5DDDF0)
#define RPG_GAMECORE_MAZEDRAGCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DE3A0)
