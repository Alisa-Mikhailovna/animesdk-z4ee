...
#define RPG_GAMECORE_PROPRESETGACHAMACHINE_METHOD_3_E45A08411B9B6711_OFFSET UNITYSDK_OFFSET(0x1B6EB060)
#define RPG_GAMECORE_PROPRESETGACHAMACHINE_METHOD_3_F3621C456C2A6141_OFFSET UNITYSDK_OFFSET(0x1B6EB0E0)
#define RPG_GAMECORE_PROPRESETGACHAMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EB0B0)
