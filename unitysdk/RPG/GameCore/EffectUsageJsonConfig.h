...
#define RPG_GAMECORE_EFFECTUSAGEJSONCONFIG_METHOD_2_C307653B38E0D62C_OFFSET UNITYSDK_OFFSET(0x1B3D67B0)
#define RPG_GAMECORE_EFFECTUSAGEJSONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D68A0)
