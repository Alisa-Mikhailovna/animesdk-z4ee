...
#define RPG_GAMECORE_CAKERACEPROPERTYMODIFIER_METHOD_2_E72DEFCEA3501C78_OFFSET UNITYSDK_OFFSET(0x1B2FC5E0)
#define RPG_GAMECORE_CAKERACEPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FC760)
