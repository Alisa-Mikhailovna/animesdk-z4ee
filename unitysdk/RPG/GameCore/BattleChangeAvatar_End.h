...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END_METHOD_3_9F8AF0482866F9DB_OFFSET UNITYSDK_OFFSET(0x1B1F0B60)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END_METHOD_3_BECEB47B6BA86EDE_OFFSET UNITYSDK_OFFSET(0x1B1F0C30)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F0C20)
