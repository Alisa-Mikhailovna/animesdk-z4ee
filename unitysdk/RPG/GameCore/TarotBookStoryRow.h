...
#define RPG_GAMECORE_TAROTBOOKSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B962FC0)
#define RPG_GAMECORE_TAROTBOOKSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9631A0)
