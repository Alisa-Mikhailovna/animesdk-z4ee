...
#define RPG_GAMECORE_SHOWRAIDFINISHUI_METHOD_3_7557ED6E6DD8DC1B_OFFSET UNITYSDK_OFFSET(0x1B8D2710)
#define RPG_GAMECORE_SHOWRAIDFINISHUI_METHOD_3_AFB78C2AF410F0A0_OFFSET UNITYSDK_OFFSET(0x1B8D2750)
#define RPG_GAMECORE_SHOWRAIDFINISHUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D2740)
