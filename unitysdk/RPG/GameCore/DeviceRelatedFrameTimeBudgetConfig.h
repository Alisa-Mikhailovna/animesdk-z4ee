...
#define RPG_GAMECORE_DEVICERELATEDFRAMETIMEBUDGETCONFIG_METHOD_3_79D13B37C1CF0A00_OFFSET UNITYSDK_OFFSET(0x1B3A4B10)
#define RPG_GAMECORE_DEVICERELATEDFRAMETIMEBUDGETCONFIG_METHOD_3_DCCC537F302CBEF6_OFFSET UNITYSDK_OFFSET(0x1B3A5300)
#define RPG_GAMECORE_DEVICERELATEDFRAMETIMEBUDGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A4B00)
