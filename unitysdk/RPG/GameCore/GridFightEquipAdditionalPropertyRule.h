...
#define RPG_GAMECORE_GRIDFIGHTEQUIPADDITIONALPROPERTYRULE_METHOD_2_91A150FAD420B5D4_OFFSET UNITYSDK_OFFSET(0x1B4D7CD0)
#define RPG_GAMECORE_GRIDFIGHTEQUIPADDITIONALPROPERTYRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D7D10)
