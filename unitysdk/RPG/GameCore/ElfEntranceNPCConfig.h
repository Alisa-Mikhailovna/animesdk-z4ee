...
#define RPG_GAMECORE_ELFENTRANCENPCCONFIG_METHOD_2_118409708306B4F4_OFFSET UNITYSDK_OFFSET(0x1B3DA630)
#define RPG_GAMECORE_ELFENTRANCENPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DA750)
