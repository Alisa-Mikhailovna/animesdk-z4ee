...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOREFRESHGOODSCONFIG_METHOD_3_B27EBDCF3F3799EE_OFFSET UNITYSDK_OFFSET(0x1B4DEE40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOREFRESHGOODSCONFIG_METHOD_3_B6CAE5BAEC94B9AA_OFFSET UNITYSDK_OFFSET(0x1B4DEE90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOREFRESHGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DEE80)
