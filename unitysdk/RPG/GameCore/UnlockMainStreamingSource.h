...
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_40D043E41A473AD4_OFFSET UNITYSDK_OFFSET(0x1B9C6A40)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_481CBBA5183EB411_OFFSET UNITYSDK_OFFSET(0x1B9C6B10)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C6B00)
