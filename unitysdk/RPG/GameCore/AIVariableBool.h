...
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B0F2EA0)
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x1B0F2E10)
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B0F2D50)
#define RPG_GAMECORE_AIVARIABLEBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B0F2FD0)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_3B0FEA62A777480E_OFFSET UNITYSDK_OFFSET(0x1B0F31D0)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_56950E5F6703F137_OFFSET UNITYSDK_OFFSET(0x1B0F2D20)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_AAB430F0C614C608_OFFSET UNITYSDK_OFFSET(0x1B0F1F40)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_C620B405B25D520F_OFFSET UNITYSDK_OFFSET(0x1B0F3080)
#define RPG_GAMECORE_AIVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F1F30)
