...
#define RPG_GAMECORE_ACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_0C8C831A5DB27871_OFFSET UNITYSDK_OFFSET(0x1B0FEBD0)
#define RPG_GAMECORE_ACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_EFDFFAF2B99A7295_OFFSET UNITYSDK_OFFSET(0x1B0FEC20)
#define RPG_GAMECORE_ACTIVATESERVERGAMEPLAYCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FEC10)
