...
#define RPG_GAMECORE_GRIDFIGHTACTIONCONFIGBASE_METHOD_5_8C0DDF8D4A3F0FA3_OFFSET UNITYSDK_OFFSET(0x1B4CFDA0)
#define RPG_GAMECORE_GRIDFIGHTACTIONCONFIGBASE_METHOD_5_DFE0497514CB1D5A_OFFSET UNITYSDK_OFFSET(0x1B4D0340)
#define RPG_GAMECORE_GRIDFIGHTACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CF9E0)
