...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CLEARCUSTOMVALUE_METHOD_3_C0AFC7B146B5F61B_OFFSET UNITYSDK_OFFSET(0x1B3B7060)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CLEARCUSTOMVALUE_METHOD_3_FFD97C1D3E63E545_OFFSET UNITYSDK_OFFSET(0x1B3B7000)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CLEARCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B7050)
