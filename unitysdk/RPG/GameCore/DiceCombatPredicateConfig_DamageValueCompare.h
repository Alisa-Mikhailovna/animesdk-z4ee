...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DAMAGEVALUECOMPARE_METHOD_4_2C58F60EFBF0CDAF_OFFSET UNITYSDK_OFFSET(0x1B3B4C80)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DAMAGEVALUECOMPARE_METHOD_4_837F687D89576C51_OFFSET UNITYSDK_OFFSET(0x1B3B1C90)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DAMAGEVALUECOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B1C80)
