...
#define RPG_GAMECORE_RTCHARACTERVISUAL_METHOD_2_DD7184153E7829CA_OFFSET UNITYSDK_OFFSET(0x1B7B4D60)
#define RPG_GAMECORE_RTCHARACTERVISUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B56C0)
