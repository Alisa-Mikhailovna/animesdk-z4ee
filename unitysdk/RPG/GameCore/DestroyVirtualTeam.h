...
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_9A562443D4D971C3_OFFSET UNITYSDK_OFFSET(0x1B3A3240)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_D68BEA3301726547_OFFSET UNITYSDK_OFFSET(0x1B3A3290)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A3280)
