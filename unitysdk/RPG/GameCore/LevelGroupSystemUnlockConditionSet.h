...
#define RPG_GAMECORE_LEVELGROUPSYSTEMUNLOCKCONDITIONSET_METHOD_2_502C92A4B7CCBBDF_OFFSET UNITYSDK_OFFSET(0x1B55BCC0)
#define RPG_GAMECORE_LEVELGROUPSYSTEMUNLOCKCONDITIONSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B55BDF0)
