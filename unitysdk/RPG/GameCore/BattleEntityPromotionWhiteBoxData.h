...
#define RPG_GAMECORE_BATTLEENTITYPROMOTIONWHITEBOXDATA_METHOD_2_285D300A878863CE_OFFSET UNITYSDK_OFFSET(0x1B1F34C0)
#define RPG_GAMECORE_BATTLEENTITYPROMOTIONWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F4110)
