...
#define RPG_GAMECORE_CHARACTERMODELCOMPONENTCONFIG_METHOD_3_528C95A8C2B5314E_OFFSET UNITYSDK_OFFSET(0x1B31BF00)
#define RPG_GAMECORE_CHARACTERMODELCOMPONENTCONFIG_METHOD_3_FD1C89410267177A_OFFSET UNITYSDK_OFFSET(0x1B31BFD0)
#define RPG_GAMECORE_CHARACTERMODELCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B31BFC0)
