...
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA_METHOD_4_352EF45F01E406B8_OFFSET UNITYSDK_OFFSET(0x1B7C5720)
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA_METHOD_4_B7A3FBC3AA2B5F25_OFFSET UNITYSDK_OFFSET(0x1B7C5640)
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA_METHOD_4_CD8444DCF48CFF0F_OFFSET UNITYSDK_OFFSET(0x1B7C5A40)
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA_METHOD_4_F94401C46D72CD21_OFFSET UNITYSDK_OFFSET(0x1B7C5AC0)
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C56C0)
