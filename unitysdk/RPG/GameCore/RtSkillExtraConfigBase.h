...
#define RPG_GAMECORE_RTSKILLEXTRACONFIGBASE_METHOD_2_1DA63BBD2128607B_OFFSET UNITYSDK_OFFSET(0x1B7C2290)
#define RPG_GAMECORE_RTSKILLEXTRACONFIGBASE_METHOD_2_F11E3F9E62820973_OFFSET UNITYSDK_OFFSET(0x1B7C24B0)
#define RPG_GAMECORE_RTSKILLEXTRACONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C24A0)
