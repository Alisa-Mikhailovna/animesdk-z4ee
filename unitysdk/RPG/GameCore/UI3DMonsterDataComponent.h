...
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDC5AB20)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_ENABLEABILITY_OFFSET UNITYSDK_OFFSET(0xDC5A9D0)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_ENABLEALLABLITY_OFFSET UNITYSDK_OFFSET(0xDC5AA50)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_FIREEFFECTBYPATH_OFFSET UNITYSDK_OFFSET(0xDC5A850)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_GETALLRENDERERS_OFFSET UNITYSDK_OFFSET(0xDC5A650)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_GET_JSONCONFIGREF_OFFSET UNITYSDK_OFFSET(0xDC5AB60)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0xDC5A500)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_REMOVEEFFECTBYPATH_OFFSET UNITYSDK_OFFSET(0xDC5A930)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_SETOUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0xDC5A6E0)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_SET_JSONCONFIGREF_OFFSET UNITYSDK_OFFSET(0xDC5AB70)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xDC5AB80)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0xDC5A490)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT__TRYENABLEABILITY_OFFSET UNITYSDK_OFFSET(0xDC5A550)
