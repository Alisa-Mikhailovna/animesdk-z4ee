...
#define RPG_GAMECORE_SETROGUETOURNFLOORTYPE_METHOD_3_4EEE72772E67CC17_OFFSET UNITYSDK_OFFSET(0x1B8B0B30)
#define RPG_GAMECORE_SETROGUETOURNFLOORTYPE_METHOD_3_F669A8C8A73EBA44_OFFSET UNITYSDK_OFFSET(0x1B8B0AF0)
#define RPG_GAMECORE_SETROGUETOURNFLOORTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B0B20)
