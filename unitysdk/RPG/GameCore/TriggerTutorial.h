...
#define RPG_GAMECORE_TRIGGERTUTORIAL_METHOD_3_1756F172989623EF_OFFSET UNITYSDK_OFFSET(0x1B9ADBE0)
#define RPG_GAMECORE_TRIGGERTUTORIAL_METHOD_3_FBE2B30AD3C9E1F6_OFFSET UNITYSDK_OFFSET(0x1B9ADC30)
#define RPG_GAMECORE_TRIGGERTUTORIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9ADC20)
