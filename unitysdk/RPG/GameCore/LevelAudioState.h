...
#define RPG_GAMECORE_LEVELAUDIOSTATE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B550620)
#define RPG_GAMECORE_LEVELAUDIOSTATE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5505E0)
#define RPG_GAMECORE_LEVELAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B550610)
