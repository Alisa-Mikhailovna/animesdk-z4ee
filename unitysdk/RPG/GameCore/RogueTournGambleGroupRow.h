...
#define RPG_GAMECORE_ROGUETOURNGAMBLEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B79A410)
#define RPG_GAMECORE_ROGUETOURNGAMBLEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79A670)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 GambleGroupID; // 0x28
		::RPG::GameCore::RogueGambleMachineType GambleGroupType; // 0x2C
		::RPG::GameCore::RogueGambleGroupLevelType GambleGroupLevel; // 0x30
