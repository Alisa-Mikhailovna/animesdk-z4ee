...
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORROLLCONFIG_METHOD_2_09A1C656CB4B0B13_OFFSET UNITYSDK_OFFSET(0x1B3B58D0)
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORROLLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B59C0)
