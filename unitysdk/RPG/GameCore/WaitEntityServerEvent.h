...
#define RPG_GAMECORE_WAITENTITYSERVEREVENT_METHOD_3_6E4E4EA1CD2B3AAC_OFFSET UNITYSDK_OFFSET(0x1B9E57D0)
#define RPG_GAMECORE_WAITENTITYSERVEREVENT_METHOD_3_DF3CA708204D14B0_OFFSET UNITYSDK_OFFSET(0x1B9E5780)
#define RPG_GAMECORE_WAITENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E57C0)
