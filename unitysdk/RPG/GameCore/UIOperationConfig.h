...
#define RPG_GAMECORE_UIOPERATIONCONFIG_METHOD_2_AB912C6706A1CFBD_OFFSET UNITYSDK_OFFSET(0x1B9BD900)
#define RPG_GAMECORE_UIOPERATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BE960)
