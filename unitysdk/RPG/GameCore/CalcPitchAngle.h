...
#define RPG_GAMECORE_CALCPITCHANGLE_METHOD_3_35B9D3D4278759CA_OFFSET UNITYSDK_OFFSET(0x1B2FEE60)
#define RPG_GAMECORE_CALCPITCHANGLE_METHOD_3_D18007096DDFE63B_OFFSET UNITYSDK_OFFSET(0x1B2FEEA0)
#define RPG_GAMECORE_CALCPITCHANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FEE90)
