...
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER_METHOD_4_35B2372ACE0BFE56_OFFSET UNITYSDK_OFFSET(0x1B2A7500)
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER_METHOD_4_855D921EFE247BE0_OFFSET UNITYSDK_OFFSET(0x1B2A76C0)
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER_METHOD_4_90EFD448D1FEA257_OFFSET UNITYSDK_OFFSET(0x1B2A74C0)
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER_METHOD_4_B8F421CA82767EAE_OFFSET UNITYSDK_OFFSET(0x1B2A76F0)
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A74F0)
