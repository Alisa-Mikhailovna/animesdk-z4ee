...
#define RPG_GAMECORE_LEVELTURNULTRASKILLEXECUTINGBEGIN_CLEAR_OFFSET UNITYSDK_OFFSET(0xDADD820)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEXECUTINGBEGIN_GETCASTENTITY_OFFSET UNITYSDK_OFFSET(0xDADD910)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEXECUTINGBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADD8C0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEXECUTINGBEGIN_GETSKILLINDEX_OFFSET UNITYSDK_OFFSET(0xDADD950)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEXECUTINGBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADD870)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEXECUTINGBEGIN_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xDADD990)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEXECUTINGBEGIN_INIT_OFFSET UNITYSDK_OFFSET(0xDADD7C0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEXECUTINGBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xDADD9D0)
