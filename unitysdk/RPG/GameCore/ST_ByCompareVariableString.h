...
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_4451AD2F76E73CD4_OFFSET UNITYSDK_OFFSET(0x1B7D0FF0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_8EFF4D2D25B7A2E9_OFFSET UNITYSDK_OFFSET(0x1B7D0FB0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_BC4AAB076CE81499_OFFSET UNITYSDK_OFFSET(0x1B7D11F0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_D7FDE9861AA1FCB6_OFFSET UNITYSDK_OFFSET(0x1B7D1220)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D0FE0)
