...
#define RPG_GAMECORE_PINGPONGDROPITEMCONFIG_METHOD_2_BFE7295BA77FC4D6_OFFSET UNITYSDK_OFFSET(0x1B6AE260)
#define RPG_GAMECORE_PINGPONGDROPITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AE410)
