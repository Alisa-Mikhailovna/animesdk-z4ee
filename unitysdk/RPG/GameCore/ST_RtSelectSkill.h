...
#define RPG_GAMECORE_ST_RTSELECTSKILL_METHOD_4_BCEE1A788CBBD882_OFFSET UNITYSDK_OFFSET(0x1B7E00C0)
#define RPG_GAMECORE_ST_RTSELECTSKILL_METHOD_4_DA46DC125CCE8F11_OFFSET UNITYSDK_OFFSET(0x1B7E0110)
#define RPG_GAMECORE_ST_RTSELECTSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E0100)
