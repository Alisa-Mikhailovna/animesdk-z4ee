...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEHASNOFAKIND_METHOD_3_856B498FDBF1BAC8_OFFSET UNITYSDK_OFFSET(0x1B3A9E10)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEHASNOFAKIND_METHOD_3_F39D86E4542A59F4_OFFSET UNITYSDK_OFFSET(0x1B3AA920)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEHASNOFAKIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A9E00)
