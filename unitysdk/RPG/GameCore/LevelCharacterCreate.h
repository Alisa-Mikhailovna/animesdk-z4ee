...
#define RPG_GAMECORE_LEVELCHARACTERCREATE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDAC8590)
#define RPG_GAMECORE_LEVELCHARACTERCREATE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDAC8540)
#define RPG_GAMECORE_LEVELCHARACTERCREATE_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xDAC85E0)
#define RPG_GAMECORE_LEVELCHARACTERCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0xDAC8530)
