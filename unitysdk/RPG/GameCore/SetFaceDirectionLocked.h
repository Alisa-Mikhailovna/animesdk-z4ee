...
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED_METHOD_3_65565061BF5D6C0C_OFFSET UNITYSDK_OFFSET(0x1B8A2460)
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED_METHOD_3_A6DE2B1D9A690559_OFFSET UNITYSDK_OFFSET(0x1B8A2410)
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A2450)
