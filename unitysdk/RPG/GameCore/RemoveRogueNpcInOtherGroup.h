...
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_4C0017D8827AB24C_OFFSET UNITYSDK_OFFSET(0x1B71DB70)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_C5AFA0B7EAA6D5D0_OFFSET UNITYSDK_OFFSET(0x1B71DB20)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71DB60)
