...
#define RPG_GAMECORE_WAITGETLEVELREWARD_METHOD_3_60831042F2ED0202_OFFSET UNITYSDK_OFFSET(0x1B9E7900)
#define RPG_GAMECORE_WAITGETLEVELREWARD_METHOD_3_AAFFE0A2DD6BDB3F_OFFSET UNITYSDK_OFFSET(0x1B9E79D0)
#define RPG_GAMECORE_WAITGETLEVELREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E79C0)
