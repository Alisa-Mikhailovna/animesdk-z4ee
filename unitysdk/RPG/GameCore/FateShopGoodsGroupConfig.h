...
#define RPG_GAMECORE_FATESHOPGOODSGROUPCONFIG_METHOD_2_003AB6C9919F2EA1_OFFSET UNITYSDK_OFFSET(0x1B40F3B0)
#define RPG_GAMECORE_FATESHOPGOODSGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40F3F0)
