...
#define RPG_GAMECORE_TRIGGERHITPROP_METHOD_3_092DCF539CFE2A15_OFFSET UNITYSDK_OFFSET(0x1B9A3AE0)
#define RPG_GAMECORE_TRIGGERHITPROP_METHOD_3_412AB712E6B69138_OFFSET UNITYSDK_OFFSET(0x1B9A3B20)
#define RPG_GAMECORE_TRIGGERHITPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A3B10)
