...
#define RPG_GAMECORE_FIVEDIMLEVELAUDIOCONFIG_METHOD_2_3350751716BE7DAB_OFFSET UNITYSDK_OFFSET(0x1B434BE0)
#define RPG_GAMECORE_FIVEDIMLEVELAUDIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B434DC0)
