...
#define RPG_GAMECORE_IDLELIVEQUESTIONMESSAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B528E20)
#define RPG_GAMECORE_IDLELIVEQUESTIONMESSAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B528F40)
