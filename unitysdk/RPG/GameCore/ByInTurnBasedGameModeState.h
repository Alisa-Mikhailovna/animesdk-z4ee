...
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_0AA49AE794563DC2_OFFSET UNITYSDK_OFFSET(0x1B2A0B70)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_1A7B8403EF127C96_OFFSET UNITYSDK_OFFSET(0x1B2A09F0)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_2486542621D8AE95_OFFSET UNITYSDK_OFFSET(0x1B2A0BA0)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_637B1BF72A350E47_OFFSET UNITYSDK_OFFSET(0x1B2A09B0)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A09E0)
