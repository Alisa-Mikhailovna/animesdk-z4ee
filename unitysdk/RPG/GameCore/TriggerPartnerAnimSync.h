...
#define RPG_GAMECORE_TRIGGERPARTNERANIMSYNC_METHOD_3_8D643D1D3720164D_OFFSET UNITYSDK_OFFSET(0x1B9A7380)
#define RPG_GAMECORE_TRIGGERPARTNERANIMSYNC_METHOD_3_9358CD7A822E0E0E_OFFSET UNITYSDK_OFFSET(0x1B9A73C0)
#define RPG_GAMECORE_TRIGGERPARTNERANIMSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A73B0)
