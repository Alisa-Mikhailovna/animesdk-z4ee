...
#define RPG_GAMECORE_WAITMATCHTHREEBIRDLOCATIONCHANGE_METHOD_4_79C23954B52C2212_OFFSET UNITYSDK_OFFSET(0x1B9E9C60)
#define RPG_GAMECORE_WAITMATCHTHREEBIRDLOCATIONCHANGE_METHOD_4_F85C79CEA2C06003_OFFSET UNITYSDK_OFFSET(0x1B9E9C10)
#define RPG_GAMECORE_WAITMATCHTHREEBIRDLOCATIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E9C50)
