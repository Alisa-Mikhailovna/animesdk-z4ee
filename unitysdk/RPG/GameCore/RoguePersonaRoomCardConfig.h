...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDCONFIG_METHOD_2_6083BBBDCD60BAB1_OFFSET UNITYSDK_OFFSET(0x1B78A6C0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B78A700)
