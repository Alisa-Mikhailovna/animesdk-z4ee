...
#define RPG_GAMECORE_SHADERPROPERTYCONFIG_METHOD_2_E7BC312AD1AC9CBB_OFFSET UNITYSDK_OFFSET(0x1B8BE040)
#define RPG_GAMECORE_SHADERPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8BE2B0)
