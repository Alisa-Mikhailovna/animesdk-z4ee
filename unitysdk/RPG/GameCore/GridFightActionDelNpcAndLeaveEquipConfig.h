...
#define RPG_GAMECORE_GRIDFIGHTACTIONDELNPCANDLEAVEEQUIPCONFIG_METHOD_6_4D84F746ECC9758E_OFFSET UNITYSDK_OFFSET(0x1B4D0420)
#define RPG_GAMECORE_GRIDFIGHTACTIONDELNPCANDLEAVEEQUIPCONFIG_METHOD_6_AE32001AE9EF2C72_OFFSET UNITYSDK_OFFSET(0x1B4D0730)
#define RPG_GAMECORE_GRIDFIGHTACTIONDELNPCANDLEAVEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D0410)
