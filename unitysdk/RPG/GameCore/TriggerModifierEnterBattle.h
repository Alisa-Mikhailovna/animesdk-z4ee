...
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE_METHOD_3_C4B5768F03E5ABBE_OFFSET UNITYSDK_OFFSET(0x1B9A5B90)
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE_METHOD_3_EEE94AF87AEB983D_OFFSET UNITYSDK_OFFSET(0x1B9A5BD0)
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A5BC0)
