...
#define RPG_GAMECORE_TAROTMAILGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9637C0)
#define RPG_GAMECORE_TAROTMAILGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B963940)
