...
#define RPG_GAMECORE_ROGUEVALUECHANGEBYPARAMINFO_METHOD_2_47776F64FA72684B_OFFSET UNITYSDK_OFFSET(0x1B7A4480)
#define RPG_GAMECORE_ROGUEVALUECHANGEBYPARAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A44C0)
