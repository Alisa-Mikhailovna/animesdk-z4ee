...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICSCEPTERSHOPCONFIG_METHOD_3_7BEC950BFA48B828_OFFSET UNITYSDK_OFFSET(0x1B777C80)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICSCEPTERSHOPCONFIG_METHOD_3_B2E3343B2760B4AC_OFFSET UNITYSDK_OFFSET(0x1B777C30)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICSCEPTERSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B777C70)
