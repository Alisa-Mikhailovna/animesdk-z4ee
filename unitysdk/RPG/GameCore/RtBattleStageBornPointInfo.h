...
#define RPG_GAMECORE_RTBATTLESTAGEBORNPOINTINFO_METHOD_2_5A1C92B128FEEB3F_OFFSET UNITYSDK_OFFSET(0x1B7AC060)
#define RPG_GAMECORE_RTBATTLESTAGEBORNPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7AC1A0)
