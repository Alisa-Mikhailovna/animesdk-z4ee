...
#define RPG_GAMECORE_CHENLINGDEATHEFFECTCONFIG_METHOD_2_3141CE82353F699B_OFFSET UNITYSDK_OFFSET(0x1B32DDE0)
#define RPG_GAMECORE_CHENLINGDEATHEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B333B50)
