...
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG_METHOD_3_273F6D7E08EAD58F_OFFSET UNITYSDK_OFFSET(0x1B8CCF20)
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG_METHOD_3_8389A5C24C0A73B4_OFFSET UNITYSDK_OFFSET(0x1B8CCED0)
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8CCF10)
