...
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG_METHOD_3_5410C84A0150FA56_OFFSET UNITYSDK_OFFSET(0x1B2FB5A0)
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG_METHOD_3_E4AE0B99A9C6B1AD_OFFSET UNITYSDK_OFFSET(0x1B2FB560)
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FB590)
