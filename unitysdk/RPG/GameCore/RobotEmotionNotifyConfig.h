...
#define RPG_GAMECORE_ROBOTEMOTIONNOTIFYCONFIG_METHOD_2_278ECB742C8D1295_OFFSET UNITYSDK_OFFSET(0x1B7338B0)
#define RPG_GAMECORE_ROBOTEMOTIONNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B733990)
