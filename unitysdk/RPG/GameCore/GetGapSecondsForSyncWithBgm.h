...
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM_METHOD_3_761FA8CC22AD826B_OFFSET UNITYSDK_OFFSET(0x1B4C9930)
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM_METHOD_3_F7A1D71D3B452B01_OFFSET UNITYSDK_OFFSET(0x1B4C98F0)
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C9920)
