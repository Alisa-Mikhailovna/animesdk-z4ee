...
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_290ED19C23A9B4F4_OFFSET UNITYSDK_OFFSET(0x1B9D3680)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_3A1314EB0129375C_OFFSET UNITYSDK_OFFSET(0x1B9D3820)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_556C75E562F746F1_OFFSET UNITYSDK_OFFSET(0x1B9D3640)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_91C524E174C80F2B_OFFSET UNITYSDK_OFFSET(0x1B9D3850)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D3670)
