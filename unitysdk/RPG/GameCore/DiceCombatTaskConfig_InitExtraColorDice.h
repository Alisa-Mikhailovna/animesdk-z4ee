...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITEXTRACOLORDICE_METHOD_3_A0C11C1732EA7698_OFFSET UNITYSDK_OFFSET(0x1B3B78B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITEXTRACOLORDICE_METHOD_3_AF8F5068FF3E16FD_OFFSET UNITYSDK_OFFSET(0x1B3B7950)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITEXTRACOLORDICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B7940)
