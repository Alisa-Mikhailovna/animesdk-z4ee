...
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_4DA864CECA5CFE07_OFFSET UNITYSDK_OFFSET(0x1B94DCD0)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_63BAC2F92B942293_OFFSET UNITYSDK_OFFSET(0x1B94DD30)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_9C38A8155CBD6696_OFFSET UNITYSDK_OFFSET(0x1B94DC30)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_A73C4D5BF540DAD7_OFFSET UNITYSDK_OFFSET(0x1B94DD70)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B94DCC0)
