...
#define RPG_GAMECORE_LEVELWAVEMONSTER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDAE59D0)
#define RPG_GAMECORE_LEVELWAVEMONSTER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDAE5A20)
#define RPG_GAMECORE_LEVELWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xDAE5A70)
