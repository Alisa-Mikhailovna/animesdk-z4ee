...
#define RPG_GAMECORE_TRIGGEREFFECTLIST_METHOD_3_2BE45E4CA1100E05_OFFSET UNITYSDK_OFFSET(0x1B9A1140)
#define RPG_GAMECORE_TRIGGEREFFECTLIST_METHOD_3_ABDC0589660D8BCB_OFFSET UNITYSDK_OFFSET(0x1B9A0E50)
#define RPG_GAMECORE_TRIGGEREFFECTLIST_METHOD_3_C034ADA0E1ED7580_OFFSET UNITYSDK_OFFSET(0x1B9A1420)
#define RPG_GAMECORE_TRIGGEREFFECTLIST_METHOD_3_C2336D024CB6C763_OFFSET UNITYSDK_OFFSET(0x1B9A0CF0)
#define RPG_GAMECORE_TRIGGEREFFECTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A0E40)
