...
#define RPG_GAMECORE_TRIGGERMAZEMAPUI_METHOD_3_7C4EBFFC8011BE2B_OFFSET UNITYSDK_OFFSET(0x1B9A4E90)
#define RPG_GAMECORE_TRIGGERMAZEMAPUI_METHOD_3_8AD7E358FC0F78AE_OFFSET UNITYSDK_OFFSET(0x1B9A4F60)
#define RPG_GAMECORE_TRIGGERMAZEMAPUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A4F50)
