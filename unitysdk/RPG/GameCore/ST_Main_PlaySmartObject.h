...
#define RPG_GAMECORE_ST_MAIN_PLAYSMARTOBJECT_METHOD_4_72F79F72D9800C2E_OFFSET UNITYSDK_OFFSET(0x1B7DEF10)
#define RPG_GAMECORE_ST_MAIN_PLAYSMARTOBJECT_METHOD_4_8F1EF31CD6C33B83_OFFSET UNITYSDK_OFFSET(0x1B7DEF50)
#define RPG_GAMECORE_ST_MAIN_PLAYSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7DEF40)
