...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRAVICTORYBONUSCONFIG_METHOD_3_A7E937C222D522C3_OFFSET UNITYSDK_OFFSET(0x1B4DFFF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRAVICTORYBONUSCONFIG_METHOD_3_E41EFDB14F6E1647_OFFSET UNITYSDK_OFFSET(0x1B4E0040)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRAVICTORYBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0030)
