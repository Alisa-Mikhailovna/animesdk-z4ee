...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONFIRMDICECOUNTTOMODIFIERMAP_METHOD_3_77E76224515F95EF_OFFSET UNITYSDK_OFFSET(0x1B3B8A20)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONFIRMDICECOUNTTOMODIFIERMAP_METHOD_3_FC2F814D0928CA11_OFFSET UNITYSDK_OFFSET(0x1B3B8A80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONFIRMDICECOUNTTOMODIFIERMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B8A70)
