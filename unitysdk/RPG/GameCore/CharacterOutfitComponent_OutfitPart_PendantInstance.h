...
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_APPLY_OFFSET UNITYSDK_OFFSET(0xD9F7C20)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD9F7870)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_GET_ISEFFECT_OFFSET UNITYSDK_OFFSET(0xD9F4AF0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_LOAD_OFFSET UNITYSDK_OFFSET(0xD9F7AB0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_POSTAPPLY_OFFSET UNITYSDK_OFFSET(0xD9F5010)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_REMOVE_OFFSET UNITYSDK_OFFSET(0xD9F8330)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_RESETSPRINGBONE_OFFSET UNITYSDK_OFFSET(0xD9F86E0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_SETANIMATORSPEED_OFFSET UNITYSDK_OFFSET(0xD9F88F0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xD9F7750)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE__POSTAPPLY_B__12_0_OFFSET UNITYSDK_OFFSET(0xD9F8970)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::CharacterOutfitComponent_OutfitPartAsset_2<::UnityEngine::GameObject*, ::RPG::GameCore::CharacterOutfitPendant*>* PrefabAsset; // 0x18
		::RPG::GameCore::CharacterOutfitPendant* Config; // 0x20
		::UnityEngine::Animator* Animator; // 0x28
		::RPG::Client::MonoEffectPluginFollow* EffectFollow; // 0x30
		::RPG::Client::TriggerEffectParamsRef EffectParams; // 0x38
