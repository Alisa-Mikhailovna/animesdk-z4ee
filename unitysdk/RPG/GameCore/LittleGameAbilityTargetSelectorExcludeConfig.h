...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTOREXCLUDECONFIG_METHOD_3_5D5B0C415C8A3D84_OFFSET UNITYSDK_OFFSET(0x1B580320)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTOREXCLUDECONFIG_METHOD_3_5ECA827ECCC7395E_OFFSET UNITYSDK_OFFSET(0x1B5802C0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTOREXCLUDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B580310)
