...
#define RPG_GAMECORE_MARBLESEALPLAYANIM_METHOD_3_4FCA15F982F026CF_OFFSET UNITYSDK_OFFSET(0x1B5C0220)
#define RPG_GAMECORE_MARBLESEALPLAYANIM_METHOD_3_7A90D78D9B1D07FC_OFFSET UNITYSDK_OFFSET(0x1B5C01E0)
#define RPG_GAMECORE_MARBLESEALPLAYANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C0210)
