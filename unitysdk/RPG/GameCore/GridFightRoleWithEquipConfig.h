...
#define RPG_GAMECORE_GRIDFIGHTROLEWITHEQUIPCONFIG_METHOD_2_AA0A0BB00168C8DC_OFFSET UNITYSDK_OFFSET(0x1B4EBB10)
#define RPG_GAMECORE_GRIDFIGHTROLEWITHEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EBB50)
