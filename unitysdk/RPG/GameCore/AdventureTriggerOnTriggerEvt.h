...
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xD991E80)
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD991ED0)
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT_GET_TRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xD991F20)
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT_SET_TRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xD991F30)
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT__CTOR_OFFSET UNITYSDK_OFFSET(0xD991E70)
