...
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_27C0A1ACF2AD2246_OFFSET UNITYSDK_OFFSET(0x1B7D4C50)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_30846F98C39F0090_OFFSET UNITYSDK_OFFSET(0x1B7D4B10)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_5C7477FE122D64BB_OFFSET UNITYSDK_OFFSET(0x1B7D4C80)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_BDEC572DD6A6A453_OFFSET UNITYSDK_OFFSET(0x1B7D4AD0)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D4B00)
