...
#define RPG_GAMECORE_ROGUEMAGICAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B769490)
#define RPG_GAMECORE_ROGUEMAGICAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B769E40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_9*>* WorldLevel2DisplayMonster; // 0x20
		...
		::System::UInt32 AreaIndex; // 0x3C
		::RPG::Client::TextID AreaNameID; // 0x40
		::RPG::GameCore::RogueMagicAreaGroupID AreaGroupID; // 0x50
		::System::UInt32 ExtraLayerID; // 0x54
		::System::Boolean IsHard; // 0x58
		::RPG::GameCore::RogueMagicStyleType DefaultStyle; // 0x5C
