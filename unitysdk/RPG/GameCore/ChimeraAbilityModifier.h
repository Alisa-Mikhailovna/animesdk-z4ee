...
#define RPG_GAMECORE_CHIMERAABILITYMODIFIER_METHOD_2_94595847773890A9_OFFSET UNITYSDK_OFFSET(0x1B33FE10)
#define RPG_GAMECORE_CHIMERAABILITYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B33FFF0)
