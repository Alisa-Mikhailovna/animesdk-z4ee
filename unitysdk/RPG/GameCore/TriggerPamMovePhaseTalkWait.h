...
#define RPG_GAMECORE_TRIGGERPAMMOVEPHASETALKWAIT_METHOD_3_D2E349BD7DD31F5A_OFFSET UNITYSDK_OFFSET(0x1B9A6A30)
#define RPG_GAMECORE_TRIGGERPAMMOVEPHASETALKWAIT_METHOD_3_D67D8C7E405863B7_OFFSET UNITYSDK_OFFSET(0x1B9A6960)
#define RPG_GAMECORE_TRIGGERPAMMOVEPHASETALKWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A6A20)
