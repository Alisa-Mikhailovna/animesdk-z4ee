...
#define RPG_GAMECORE_ERAREGION_METHOD_2_31CD7C9F7ED2B7BE_OFFSET UNITYSDK_OFFSET(0x1B3F4CA0)
#define RPG_GAMECORE_ERAREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3F5000)
