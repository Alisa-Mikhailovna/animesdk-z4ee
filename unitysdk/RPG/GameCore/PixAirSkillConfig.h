...
#define RPG_GAMECORE_PIXAIRSKILLCONFIG_METHOD_2_C05AFE965700612A_OFFSET UNITYSDK_OFFSET(0x1B6B6630)
#define RPG_GAMECORE_PIXAIRSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B6780)
