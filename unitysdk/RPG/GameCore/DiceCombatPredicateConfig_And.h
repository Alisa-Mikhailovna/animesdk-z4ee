...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_AND_METHOD_4_78AE4A61D66FD727_OFFSET UNITYSDK_OFFSET(0x1B3B0DC0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_AND_METHOD_4_CA666D858B783BFD_OFFSET UNITYSDK_OFFSET(0x1B3B4A50)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_AND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B0DB0)
