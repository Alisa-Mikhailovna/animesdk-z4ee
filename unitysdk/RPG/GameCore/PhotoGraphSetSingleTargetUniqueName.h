...
#define RPG_GAMECORE_PHOTOGRAPHSETSINGLETARGETUNIQUENAME_METHOD_3_02650869D9FACF30_OFFSET UNITYSDK_OFFSET(0x1B6A9A90)
#define RPG_GAMECORE_PHOTOGRAPHSETSINGLETARGETUNIQUENAME_METHOD_3_4924C21275E5CE7C_OFFSET UNITYSDK_OFFSET(0x1B6AB660)
#define RPG_GAMECORE_PHOTOGRAPHSETSINGLETARGETUNIQUENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A9A80)
