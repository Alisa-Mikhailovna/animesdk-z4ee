...
#define RPG_GAMECORE_ANIMATORSTATEGROUPZONEDESCCONFIG_METHOD_2_A6A3E902FFDEB851_OFFSET UNITYSDK_OFFSET(0x1B1A7390)
#define RPG_GAMECORE_ANIMATORSTATEGROUPZONEDESCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A7510)
