...
#define RPG_GAMECORE_ACTIVITYDICECOMBATAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B106360)
#define RPG_GAMECORE_ACTIVITYDICECOMBATAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B106AC0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* ImgPathUI3D; // 0x10
		::Il2CppArray<::System::UInt32>* RecommendDiceIDList; // 0x18
		::System::String* ShopIcon; // 0x20
		::System::String* AttackJson; // 0x28
		::System::String* AttackAnimation; // 0x30
		::Il2CppArray<::System::UInt32>* DiceIDPerRare; // 0x38
		::System::String* HighLevelBGImgPathUI3D; // 0x40
		::System::String* AttackEffectPath; // 0x48
		::System::String* AttackEffectEnemyPath; // 0x50
		::System::String* ImgPathHeadIcon; // 0x58
		::System::String* ImgPath; // 0x60
		::System::String* FinalAttackVoice; // 0x68
		::System::String* HighLevelBGImgPath; // 0x70
