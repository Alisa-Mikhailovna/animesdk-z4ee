...
#define RPG_GAMECORE_CAKERACEGAMEPROPERTYCOMPAREPREDICATECONFIG_METHOD_3_9CB0381583C17FE9_OFFSET UNITYSDK_OFFSET(0x1B2FA4D0)
#define RPG_GAMECORE_CAKERACEGAMEPROPERTYCOMPAREPREDICATECONFIG_METHOD_3_CB6490639DDC108B_OFFSET UNITYSDK_OFFSET(0x1B2F5E70)
#define RPG_GAMECORE_CAKERACEGAMEPROPERTYCOMPAREPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F5E60)
