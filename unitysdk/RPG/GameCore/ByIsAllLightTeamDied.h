...
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_257288C8C01C3283_OFFSET UNITYSDK_OFFSET(0x1B2A2420)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_37ADD0F81AC6D74C_OFFSET UNITYSDK_OFFSET(0x1B2A2450)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_698BC807EEFA6A89_OFFSET UNITYSDK_OFFSET(0x1B2A22A0)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_ED0CA8D325D622CC_OFFSET UNITYSDK_OFFSET(0x1B2A2260)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A2290)
