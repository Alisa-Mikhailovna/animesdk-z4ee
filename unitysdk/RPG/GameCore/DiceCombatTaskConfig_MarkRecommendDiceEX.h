...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX_METHOD_3_D9E99C112AAF73A3_OFFSET UNITYSDK_OFFSET(0x1B3B7F10)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX_METHOD_3_DC4E4C8219B8C893_OFFSET UNITYSDK_OFFSET(0x1B3B7F70)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B7F60)
