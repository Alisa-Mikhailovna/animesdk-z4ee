...
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH_METHOD_3_5DEE8A5C0BD1D577_OFFSET UNITYSDK_OFFSET(0x1B9E16F0)
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH_METHOD_3_F0455338C7EBBF1A_OFFSET UNITYSDK_OFFSET(0x1B9E1620)
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E16E0)
