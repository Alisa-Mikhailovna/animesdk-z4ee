...
#define RPG_GAMECORE_MISSIONCHRONICLECONFIG_METHOD_2_2636A5C6923DDDA0_OFFSET UNITYSDK_OFFSET(0x1B5FCE30)
#define RPG_GAMECORE_MISSIONCHRONICLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5FCFF0)
