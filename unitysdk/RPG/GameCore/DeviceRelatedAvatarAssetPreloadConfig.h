...
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG_METHOD_3_2814C3349C740B13_OFFSET UNITYSDK_OFFSET(0x1B3A3F50)
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG_METHOD_3_F7D6345E5FDDBAC5_OFFSET UNITYSDK_OFFSET(0x1B3A3FB0)
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A3FA0)
