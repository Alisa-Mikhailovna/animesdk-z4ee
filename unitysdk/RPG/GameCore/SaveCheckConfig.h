...
#define RPG_GAMECORE_SAVECHECKCONFIG_METHOD_2_26B894EAF3325B5D_OFFSET UNITYSDK_OFFSET(0x1B878E80)
#define RPG_GAMECORE_SAVECHECKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B878EC0)
