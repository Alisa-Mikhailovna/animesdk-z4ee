...
#define RPG_GAMECORE_GLOBALMARBLESKILLCONFIG_METHOD_2_C60FB29768ACD3CC_OFFSET UNITYSDK_OFFSET(0x1B4CAC20)
#define RPG_GAMECORE_GLOBALMARBLESKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CAD20)
