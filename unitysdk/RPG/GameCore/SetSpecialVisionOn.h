...
#define RPG_GAMECORE_SETSPECIALVISIONON_METHOD_3_02EB6BBE542C65F8_OFFSET UNITYSDK_OFFSET(0x1B8B23F0)
#define RPG_GAMECORE_SETSPECIALVISIONON_METHOD_3_7678B50099C2FF21_OFFSET UNITYSDK_OFFSET(0x1B8B2370)
#define RPG_GAMECORE_SETSPECIALVISIONON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B23C0)
