...
#define RPG_GAMECORE_MAZEITEMUSEBUFFGAMEMODEDROPCONFIG_METHOD_2_EA66BE8F8B96B8E4_OFFSET UNITYSDK_OFFSET(0x1B5E06C0)
#define RPG_GAMECORE_MAZEITEMUSEBUFFGAMEMODEDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E0700)
