...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_CURRENTTURNCOMPARE_METHOD_4_B2A09D3D33264781_OFFSET UNITYSDK_OFFSET(0x1B3B14F0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_CURRENTTURNCOMPARE_METHOD_4_CE76F667AF190BDF_OFFSET UNITYSDK_OFFSET(0x1B3B4B90)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_CURRENTTURNCOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B14E0)
