...
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_APPLY_OFFSET UNITYSDK_OFFSET(0xD9EF110)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_CONTAINSPART_OFFSET UNITYSDK_OFFSET(0xD9F3DA0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_CREATEPENDANTOUTFITPART_OFFSET UNITYSDK_OFFSET(0xD9F67D0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_CREATERENDEREROUTFITPART_OFFSET UNITYSDK_OFFSET(0xD9F6650)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD9EF080)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_GETATTACHPOINTINST_OFFSET UNITYSDK_OFFSET(0xD9F6940)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_GETMONOEFFECTMANAGER_OFFSET UNITYSDK_OFFSET(0xD9F6B30)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_GETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0xD9F7390)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_GETSHADERPROPERTYTRANSITION_OFFSET UNITYSDK_OFFSET(0xD9F6A70)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_GET_CURRENTOUTFITPARTS_OFFSET UNITYSDK_OFFSET(0xD9F6F20)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_LOADPENDANTPART_OFFSET UNITYSDK_OFFSET(0xD9F62D0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_LOADRENDERERPART_OFFSET UNITYSDK_OFFSET(0xD9F5D30)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_LOAD_OFFSET UNITYSDK_OFFSET(0xD9EFB10)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_OVERRIDEREPLACEMATERIALKEY_OFFSET UNITYSDK_OFFSET(0xD9F6F30)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_POSTAPPLY_OFFSET UNITYSDK_OFFSET(0xD9EF350)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_REMOVEOVERRIDEREPLACEMATERIALKEY_OFFSET UNITYSDK_OFFSET(0xD9F7130)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_REMOVE_OFFSET UNITYSDK_OFFSET(0xD9EF5E0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_RESETSPRINGBONE_OFFSET UNITYSDK_OFFSET(0xD9F2EB0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_SETANIMATORSPEED_OFFSET UNITYSDK_OFFSET(0xD9F3090)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE_UNLOAD_OFFSET UNITYSDK_OFFSET(0xD9EF8D0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD9F5B60)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_CHARACTEROUTFITINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xD9EED00)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::Client::AttachPointMapping* _AttachPointMapping; // 0x10
		...
		::RPG::GameCore::CharacterOutfitComponent* _Component; // 0x38
