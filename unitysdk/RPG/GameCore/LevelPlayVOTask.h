...
#define RPG_GAMECORE_LEVELPLAYVOTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDAD9C90)
#define RPG_GAMECORE_LEVELPLAYVOTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xDAD9CD0)
#define RPG_GAMECORE_LEVELPLAYVOTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xDAD9E80)
#define RPG_GAMECORE_LEVELPLAYVOTASK_TICK_OFFSET UNITYSDK_OFFSET(0xDAD9ED0)
#define RPG_GAMECORE_LEVELPLAYVOTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xDAD9C80)
