...
#define RPG_GAMECORE_FIVEDIMMUSICCUEDESIGNCLIPINFO_METHOD_2_90136D0DFDA1B2CA_OFFSET UNITYSDK_OFFSET(0x1B43C0A0)
#define RPG_GAMECORE_FIVEDIMMUSICCUEDESIGNCLIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43C2C0)
