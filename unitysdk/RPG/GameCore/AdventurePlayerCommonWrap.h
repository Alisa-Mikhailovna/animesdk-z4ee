...
#define RPG_GAMECORE_ADVENTUREPLAYERCOMMONWRAP_GETADVENTUREPLAYERDEVSKINNAME_OFFSET UNITYSDK_OFFSET(0xD970E90)
#define RPG_GAMECORE_ADVENTUREPLAYERCOMMONWRAP_GETADVENTUREPLAYERINDEXNAME_OFFSET UNITYSDK_OFFSET(0xD970C80)
#define RPG_GAMECORE_ADVENTUREPLAYERCOMMONWRAP_GETALLWRAPDATAFORDEVROUTE_OFFSET UNITYSDK_OFFSET(0xD970A10)
#define RPG_GAMECORE_ADVENTUREPLAYERCOMMONWRAP_GETALLWRAPDATA_OFFSET UNITYSDK_OFFSET(0xD970570)
#define RPG_GAMECORE_ADVENTUREPLAYERCOMMONWRAP_GETWRAPDATA_OFFSET UNITYSDK_OFFSET(0xD964BC0)
#define RPG_GAMECORE_ADVENTUREPLAYERCOMMONWRAP__ADDTOLISTWITHSKIN_OFFSET UNITYSDK_OFFSET(0xD9707E0)
