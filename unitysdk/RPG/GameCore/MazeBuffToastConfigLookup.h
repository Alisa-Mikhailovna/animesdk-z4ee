...
#define RPG_GAMECORE_MAZEBUFFTOASTCONFIGLOOKUP_METHOD_2_9D8F1DBCD45673B0_OFFSET UNITYSDK_OFFSET(0x1B5DBA40)
#define RPG_GAMECORE_MAZEBUFFTOASTCONFIGLOOKUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DBB00)
