...
#define RPG_GAMECORE_PLAYCHALLENGETARGETANIMATION_METHOD_3_000725440F672C6F_OFFSET UNITYSDK_OFFSET(0x1B6C5920)
#define RPG_GAMECORE_PLAYCHALLENGETARGETANIMATION_METHOD_3_F5836DC97638DAF2_OFFSET UNITYSDK_OFFSET(0x1B6C5850)
#define RPG_GAMECORE_PLAYCHALLENGETARGETANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C5910)
