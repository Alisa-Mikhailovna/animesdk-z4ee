...
#define RPG_GAMECORE_AVATARCHANGETEMPLATE_METHOD_2_7BFFAC22DB9C4479_OFFSET UNITYSDK_OFFSET(0x1B1BFAB0)
#define RPG_GAMECORE_AVATARCHANGETEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1BFE00)
