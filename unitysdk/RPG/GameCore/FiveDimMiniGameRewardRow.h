...
#define RPG_GAMECORE_FIVEDIMMINIGAMEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B437830)
#define RPG_GAMECORE_FIVEDIMMINIGAMEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4379E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RepeatableRewardID; // 0x14
