...
#define RPG_GAMECORE_SHIELDMODIFIERCONSTKEYS_METHOD_2_03659F9A5627B045_OFFSET UNITYSDK_OFFSET(0x1B8C12B0)
#define RPG_GAMECORE_SHIELDMODIFIERCONSTKEYS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C1820)
