...
#define RPG_GAMECORE_DEPLOYPUZZLEGIVEBACKSTONE_METHOD_3_7C24D3B6D6AAC57C_OFFSET UNITYSDK_OFFSET(0x1B3A1B60)
#define RPG_GAMECORE_DEPLOYPUZZLEGIVEBACKSTONE_METHOD_3_8EF48CC08B7B8A94_OFFSET UNITYSDK_OFFSET(0x1B3A1BE0)
#define RPG_GAMECORE_DEPLOYPUZZLEGIVEBACKSTONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A1BB0)
