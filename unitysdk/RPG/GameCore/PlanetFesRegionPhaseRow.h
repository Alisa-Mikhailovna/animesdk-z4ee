...
#define RPG_GAMECORE_PLANETFESREGIONPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6C3C70)
#define RPG_GAMECORE_PLANETFESREGIONPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C3FF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ProgressValue; // 0x20
