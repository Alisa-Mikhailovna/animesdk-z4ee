...
#define RPG_GAMECORE_EFFECTMODIFYDATA_METHOD_2_556C152397FF3202_OFFSET UNITYSDK_OFFSET(0x1B3D5B70)
#define RPG_GAMECORE_EFFECTMODIFYDATA_METHOD_2_5D3E56C701A1EA19_OFFSET UNITYSDK_OFFSET(0x1B3D5D00)
#define RPG_GAMECORE_EFFECTMODIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D5CF0)
