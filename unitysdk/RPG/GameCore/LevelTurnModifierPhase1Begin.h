...
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xDADCD30)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADCCE0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADCC90)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xDADCD70)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xDADCC80)
