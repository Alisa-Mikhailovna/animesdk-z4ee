...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTAPPENDATTRIBUTECONFIG_METHOD_7_2774D179C5DD0DC4_OFFSET UNITYSDK_OFFSET(0x1B735C20)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTAPPENDATTRIBUTECONFIG_METHOD_7_E97E82276C883A08_OFFSET UNITYSDK_OFFSET(0x1B735BD0)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTAPPENDATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B735C10)
