...
#define RPG_GAMECORE_REDMODESTANCEBARSETTING_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B70CD70)
#define RPG_GAMECORE_REDMODESTANCEBARSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B70CE80)
