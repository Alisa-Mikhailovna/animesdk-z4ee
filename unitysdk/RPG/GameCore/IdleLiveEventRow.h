...
#define RPG_GAMECORE_IDLELIVEEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B525D00)
#define RPG_GAMECORE_IDLELIVEEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B525F70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean ChangeTeam; // 0x20
		::System::UInt32 ID; // 0x24
		::System::UInt32 InitialAvatarLevel; // 0x28
