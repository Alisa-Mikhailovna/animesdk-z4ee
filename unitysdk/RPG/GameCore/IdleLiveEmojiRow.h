...
#define RPG_GAMECORE_IDLELIVEEMOJIROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B524BD0)
#define RPG_GAMECORE_IDLELIVEEMOJIROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B524D00)
