...
#define RPG_GAMECORE_MARBLESETDEAD_METHOD_3_6B2A874D916EF730_OFFSET UNITYSDK_OFFSET(0x1B5C1200)
#define RPG_GAMECORE_MARBLESETDEAD_METHOD_3_B395FF5B78AC85B5_OFFSET UNITYSDK_OFFSET(0x1B5C12A0)
#define RPG_GAMECORE_MARBLESETDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C1290)
