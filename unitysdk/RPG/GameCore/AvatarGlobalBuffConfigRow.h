...
#define RPG_GAMECORE_AVATARGLOBALBUFFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1C9100)
#define RPG_GAMECORE_AVATARGLOBALBUFFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CA280)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* TrialBagStageTypeWhiteList; // 0x38
