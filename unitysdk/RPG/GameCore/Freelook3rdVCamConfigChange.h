...
#define RPG_GAMECORE_FREELOOK3RDVCAMCONFIGCHANGE_METHOD_3_27B2A221A7C7EA30_OFFSET UNITYSDK_OFFSET(0x1B4A2DC0)
#define RPG_GAMECORE_FREELOOK3RDVCAMCONFIGCHANGE_METHOD_3_D288F80CB14D73FB_OFFSET UNITYSDK_OFFSET(0x1B4A2D80)
#define RPG_GAMECORE_FREELOOK3RDVCAMCONFIGCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A2DB0)
