...
#define RPG_GAMECORE_BYISLASTBATTLEWIN_METHOD_4_94D7C9FBE1676C2D_OFFSET UNITYSDK_OFFSET(0x1B2C78D0)
#define RPG_GAMECORE_BYISLASTBATTLEWIN_METHOD_4_AA4081DA0FBE46E0_OFFSET UNITYSDK_OFFSET(0x1B2C7890)
#define RPG_GAMECORE_BYISLASTBATTLEWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C78C0)
