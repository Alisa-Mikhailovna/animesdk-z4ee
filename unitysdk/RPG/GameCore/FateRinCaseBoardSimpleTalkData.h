...
#define RPG_GAMECORE_FATERINCASEBOARDSIMPLETALKDATA_METHOD_2_92BEBE2D40199FBB_OFFSET UNITYSDK_OFFSET(0x1B40EBD0)
#define RPG_GAMECORE_FATERINCASEBOARDSIMPLETALKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40ED00)
