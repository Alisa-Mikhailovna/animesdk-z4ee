...
#define RPG_GAMECORE_WAITDIALOGUEBEGIN_METHOD_3_5B63E07ADE96C14B_OFFSET UNITYSDK_OFFSET(0x1B9E4140)
#define RPG_GAMECORE_WAITDIALOGUEBEGIN_METHOD_3_9663DB9837CFFBD2_OFFSET UNITYSDK_OFFSET(0x1B9E40F0)
#define RPG_GAMECORE_WAITDIALOGUEBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E4130)
