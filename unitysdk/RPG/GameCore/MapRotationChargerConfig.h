...
#define RPG_GAMECORE_MAPROTATIONCHARGERCONFIG_METHOD_2_51032131C38E02EA_OFFSET UNITYSDK_OFFSET(0x1B5A98A0)
#define RPG_GAMECORE_MAPROTATIONCHARGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A9A10)
