...
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION_METHOD_3_1F434A0C0ACE8A81_OFFSET UNITYSDK_OFFSET(0x1B1AEAC0)
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION_METHOD_3_7C28C445A8417C7F_OFFSET UNITYSDK_OFFSET(0x1B1B2750)
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION_METHOD_3_C5E536C486A9FAD5_OFFSET UNITYSDK_OFFSET(0x1B1B2720)
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION_METHOD_3_DFAFD709052B7B08_OFFSET UNITYSDK_OFFSET(0x1B1ADC60)
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1ADC50)
