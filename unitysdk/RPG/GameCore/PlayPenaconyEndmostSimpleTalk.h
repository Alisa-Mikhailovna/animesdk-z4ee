...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSIMPLETALK_METHOD_3_09F201307237FC54_OFFSET UNITYSDK_OFFSET(0x1B6C94E0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSIMPLETALK_METHOD_3_D89A2F6C61552967_OFFSET UNITYSDK_OFFSET(0x1B6C94A0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C94D0)
