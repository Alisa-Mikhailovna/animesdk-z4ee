...
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK_METHOD_3_C60EFD1E9410B8FA_OFFSET UNITYSDK_OFFSET(0x1B6C7F70)
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK_METHOD_3_FF3195682057F645_OFFSET UNITYSDK_OFFSET(0x1B6C8090)
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C8010)
