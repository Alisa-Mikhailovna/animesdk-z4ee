...
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_FINDFORMATIONWITHFILTER_OFFSET UNITYSDK_OFFSET(0xDBD2D20)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_GETFORMATIONLIST_OFFSET UNITYSDK_OFFSET(0xDBD27E0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_GETINDEX_OFFSET UNITYSDK_OFFSET(0xDBD2F50)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xDBD2480)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_GET_REALLENGTH_OFFSET UNITYSDK_OFFSET(0xDBD2D00)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_INIT_OFFSET UNITYSDK_OFFSET(0xDBD21D0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_RESET_OFFSET UNITYSDK_OFFSET(0xDBD22E0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_SET_REALLENGTH_OFFSET UNITYSDK_OFFSET(0xDBD2D10)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP__ADDFORMATION_OFFSET UNITYSDK_OFFSET(0xDBD2DC0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xDBD2820)
