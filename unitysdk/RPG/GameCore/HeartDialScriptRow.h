...
#define RPG_GAMECORE_HEARTDIALSCRIPTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B504200)
#define RPG_GAMECORE_HEARTDIALSCRIPTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B504590)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MissingDialogueID; // 0x28
		::System::UInt32 ControlDialogueID; // 0x2C
		::System::UInt32 RaidID; // 0x30
		::System::UInt32 FullDialogueID; // 0x34
