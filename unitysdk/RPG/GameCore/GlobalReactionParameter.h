...
#define RPG_GAMECORE_GLOBALREACTIONPARAMETER_METHOD_2_21DACADD96880816_OFFSET UNITYSDK_OFFSET(0x1B4CB1A0)
#define RPG_GAMECORE_GLOBALREACTIONPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CB2F0)
