...
#define RPG_GAMECORE_SETENTITYVISIBLE_METHOD_3_2DBE902FF95F5FDB_OFFSET UNITYSDK_OFFSET(0x1B8A1C50)
#define RPG_GAMECORE_SETENTITYVISIBLE_METHOD_3_E4E5CD1590F7D5FA_OFFSET UNITYSDK_OFFSET(0x1B8A1CA0)
#define RPG_GAMECORE_SETENTITYVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A1C90)
