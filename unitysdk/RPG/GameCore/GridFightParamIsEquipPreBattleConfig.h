...
#define RPG_GAMECORE_GRIDFIGHTPARAMISEQUIPPREBATTLECONFIG_METHOD_6_2A66BE7F8B196C22_OFFSET UNITYSDK_OFFSET(0x1B4E4640)
#define RPG_GAMECORE_GRIDFIGHTPARAMISEQUIPPREBATTLECONFIG_METHOD_6_F217FDAE60E0FF86_OFFSET UNITYSDK_OFFSET(0x1B4E45F0)
#define RPG_GAMECORE_GRIDFIGHTPARAMISEQUIPPREBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E4630)
