...
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_2A01848665E3CBF1_OFFSET UNITYSDK_OFFSET(0x1B7C9C80)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_8F6E66689235D067_OFFSET UNITYSDK_OFFSET(0x1B7C9BE0)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_CB9ECD291A08BF0D_OFFSET UNITYSDK_OFFSET(0x1B7C9C40)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_F9CC8743A04445F6_OFFSET UNITYSDK_OFFSET(0x1B7C9B40)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C9BD0)
