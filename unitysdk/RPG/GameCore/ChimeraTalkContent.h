...
#define RPG_GAMECORE_CHIMERATALKCONTENT_METHOD_2_DDF2E390B9F0C76C_OFFSET UNITYSDK_OFFSET(0x1B357110)
#define RPG_GAMECORE_CHIMERATALKCONTENT_METHOD_2_EBCF9465C5DDE5CA_OFFSET UNITYSDK_OFFSET(0x1B355EB0)
#define RPG_GAMECORE_CHIMERATALKCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B357100)
