...
#define RPG_GAMECORE_CHIMERABATTLEEXTRACONDITIONEVALUATOR_METHOD_2_EB41C6758B65C8FF_OFFSET UNITYSDK_OFFSET(0x1B33E7F0)
#define RPG_GAMECORE_CHIMERABATTLEEXTRACONDITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B341F00)
