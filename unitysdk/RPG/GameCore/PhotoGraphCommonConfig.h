...
#define RPG_GAMECORE_PHOTOGRAPHCOMMONCONFIG_METHOD_2_100CE94BB5D81A94_OFFSET UNITYSDK_OFFSET(0x1B6A7F70)
#define RPG_GAMECORE_PHOTOGRAPHCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A8300)
