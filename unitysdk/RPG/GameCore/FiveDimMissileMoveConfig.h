...
#define RPG_GAMECORE_FIVEDIMMISSILEMOVECONFIG_METHOD_3_DA0725CE043BF55E_OFFSET UNITYSDK_OFFSET(0x1B438410)
#define RPG_GAMECORE_FIVEDIMMISSILEMOVECONFIG_METHOD_3_EEC50B0364AA3A37_OFFSET UNITYSDK_OFFSET(0x1B4383C0)
#define RPG_GAMECORE_FIVEDIMMISSILEMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B438400)
