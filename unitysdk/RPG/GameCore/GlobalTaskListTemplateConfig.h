...
#define RPG_GAMECORE_GLOBALTASKLISTTEMPLATECONFIG_METHOD_2_29B6AF7529D336B2_OFFSET UNITYSDK_OFFSET(0x1B4CB7D0)
#define RPG_GAMECORE_GLOBALTASKLISTTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CB8C0)
