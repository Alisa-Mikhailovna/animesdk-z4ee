...
#define RPG_GAMECORE_PERFORMANCECAPTURENPC_METHOD_2_89452837824197B0_OFFSET UNITYSDK_OFFSET(0x1B6925B0)
#define RPG_GAMECORE_PERFORMANCECAPTURENPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6927F0)
