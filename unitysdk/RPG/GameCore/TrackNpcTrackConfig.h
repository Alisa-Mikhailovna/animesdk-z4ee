...
#define RPG_GAMECORE_TRACKNPCTRACKCONFIG_METHOD_2_1475B64C80A48835_OFFSET UNITYSDK_OFFSET(0x1B979E50)
#define RPG_GAMECORE_TRACKNPCTRACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B979F80)
