...
#define RPG_GAMECORE_PIXAIRBATTLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6B2020)
#define RPG_GAMECORE_PIXAIRBATTLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B22A0)
