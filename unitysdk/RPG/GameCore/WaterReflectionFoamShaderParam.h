...
#define RPG_GAMECORE_WATERREFLECTIONFOAMSHADERPARAM_METHOD_2_5F4CD61893A3A957_OFFSET UNITYSDK_OFFSET(0x1B9F3420)
#define RPG_GAMECORE_WATERREFLECTIONFOAMSHADERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F35C0)
