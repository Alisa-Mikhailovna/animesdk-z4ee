...
#define RPG_GAMECORE_MAKESUCCESS_METHOD_3_3F5313BCF2B1A69B_OFFSET UNITYSDK_OFFSET(0x1B5A1D20)
#define RPG_GAMECORE_MAKESUCCESS_METHOD_3_B08F6817697E40C8_OFFSET UNITYSDK_OFFSET(0x1B5A1CE0)
#define RPG_GAMECORE_MAKESUCCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A1D10)
