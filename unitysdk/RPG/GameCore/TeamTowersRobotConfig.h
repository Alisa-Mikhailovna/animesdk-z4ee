...
#define RPG_GAMECORE_TEAMTOWERSROBOTCONFIG_METHOD_2_090B6B8A25740C79_OFFSET UNITYSDK_OFFSET(0x1B968600)
#define RPG_GAMECORE_TEAMTOWERSROBOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9697A0)
