...
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAUGMENTCONFIG_METHOD_6_D28B78D76521C04B_OFFSET UNITYSDK_OFFSET(0x1B4D39A0)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAUGMENTCONFIG_METHOD_6_DA9B56298FBB81A7_OFFSET UNITYSDK_OFFSET(0x1B4D3950)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAUGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D3990)
