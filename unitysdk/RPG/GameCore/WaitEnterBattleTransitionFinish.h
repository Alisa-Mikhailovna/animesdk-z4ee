...
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_3649F7D868A38CEB_OFFSET UNITYSDK_OFFSET(0x1B9E4D20)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_E249445DB8B08D32_OFFSET UNITYSDK_OFFSET(0x1B9E4D70)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E4D60)
