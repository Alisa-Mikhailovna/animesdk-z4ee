...
#define RPG_GAMECORE_VCAMERADOFFOCUSENTITY_METHOD_2_D7061E4723EC8564_OFFSET UNITYSDK_OFFSET(0x1B9CBDA0)
#define RPG_GAMECORE_VCAMERADOFFOCUSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CC590)
