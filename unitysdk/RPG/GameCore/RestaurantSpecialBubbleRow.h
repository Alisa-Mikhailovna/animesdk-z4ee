...
#define RPG_GAMECORE_RESTAURANTSPECIALBUBBLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B72DAA0)
#define RPG_GAMECORE_RESTAURANTSPECIALBUBBLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72DD70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DynamicValue; // 0x1C
