...
#define RPG_GAMECORE_UNLOCKTARGETSHIELD_METHOD_3_9A0F52599F32AD45_OFFSET UNITYSDK_OFFSET(0x1B9C6F00)
#define RPG_GAMECORE_UNLOCKTARGETSHIELD_METHOD_3_C875B5A4D5E7C9CA_OFFSET UNITYSDK_OFFSET(0x1B9C6F40)
#define RPG_GAMECORE_UNLOCKTARGETSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C6F30)
