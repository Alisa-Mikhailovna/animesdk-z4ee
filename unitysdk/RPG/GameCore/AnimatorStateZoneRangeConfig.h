...
#define RPG_GAMECORE_ANIMATORSTATEZONERANGECONFIG_METHOD_2_DADA70613716CE1B_OFFSET UNITYSDK_OFFSET(0x1B1A7850)
#define RPG_GAMECORE_ANIMATORSTATEZONERANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A7A70)
