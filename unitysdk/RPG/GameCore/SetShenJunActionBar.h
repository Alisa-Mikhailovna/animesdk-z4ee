...
#define RPG_GAMECORE_SETSHENJUNACTIONBAR_METHOD_3_11D527C72B71757F_OFFSET UNITYSDK_OFFSET(0x1B8B0CD0)
#define RPG_GAMECORE_SETSHENJUNACTIONBAR_METHOD_3_46393CC2A5BF6A2E_OFFSET UNITYSDK_OFFSET(0x1B8B0D10)
#define RPG_GAMECORE_SETSHENJUNACTIONBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B0D00)
