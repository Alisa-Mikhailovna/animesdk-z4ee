...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTCLOSEPAGE_METHOD_3_89FB40F6B6B8E849_OFFSET UNITYSDK_OFFSET(0x1B6C8CF0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTCLOSEPAGE_METHOD_3_F53C0B370B133B0C_OFFSET UNITYSDK_OFFSET(0x1B6C8C20)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTCLOSEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C8CE0)
