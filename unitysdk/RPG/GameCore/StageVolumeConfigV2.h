...
#define RPG_GAMECORE_STAGEVOLUMECONFIGV2_METHOD_2_DBFBCD73AC83A9EB_OFFSET UNITYSDK_OFFSET(0x1B903C10)
#define RPG_GAMECORE_STAGEVOLUMECONFIGV2_METHOD_2_ECD5F8AFC5543385_OFFSET UNITYSDK_OFFSET(0x1B903A90)
#define RPG_GAMECORE_STAGEVOLUMECONFIGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B903C00)
