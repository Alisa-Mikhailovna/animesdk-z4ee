...
#define RPG_GAMECORE_SETTRASHSUMMONHUDSTATE_METHOD_3_A2FE12F554B878C3_OFFSET UNITYSDK_OFFSET(0x1B8B84D0)
#define RPG_GAMECORE_SETTRASHSUMMONHUDSTATE_METHOD_3_B93844927BAC2D9E_OFFSET UNITYSDK_OFFSET(0x1B8B8490)
#define RPG_GAMECORE_SETTRASHSUMMONHUDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B84C0)
