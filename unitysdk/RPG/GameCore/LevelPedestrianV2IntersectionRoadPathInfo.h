...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONROADPATHINFO_METHOD_2_103C81DA41C639C6_OFFSET UNITYSDK_OFFSET(0x1B56FD10)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONROADPATHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B56FE20)
