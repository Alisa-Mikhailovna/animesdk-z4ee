...
#define RPG_GAMECORE_FATEVALUECHANGEINFO_METHOD_2_129F7217A30C0E13_OFFSET UNITYSDK_OFFSET(0x1B40FC50)
#define RPG_GAMECORE_FATEVALUECHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40FC90)
