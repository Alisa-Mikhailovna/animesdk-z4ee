...
#define RPG_GAMECORE_CHARACTEREMOCONTEXTCONFIG_METHOD_2_C05C7A5A72AE568F_OFFSET UNITYSDK_OFFSET(0x1B318C40)
#define RPG_GAMECORE_CHARACTEREMOCONTEXTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B319AE0)
