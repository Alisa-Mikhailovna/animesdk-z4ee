...
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC_METHOD_3_2F6479E143C790AD_OFFSET UNITYSDK_OFFSET(0x1B8AEEF0)
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC_METHOD_3_C3C2AB6B7407C3EE_OFFSET UNITYSDK_OFFSET(0x1B8AEF30)
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8AEF20)
