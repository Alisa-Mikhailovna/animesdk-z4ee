...
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_86B195EFDBF8B54F_OFFSET UNITYSDK_OFFSET(0x1B94C160)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_BD3CF71317217CDE_OFFSET UNITYSDK_OFFSET(0x1B94C0E0)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_CC5A87492E1407AF_OFFSET UNITYSDK_OFFSET(0x1B94C1E0)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_FA1EC9772A305762_OFFSET UNITYSDK_OFFSET(0x1B94C1C0)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B94C150)
