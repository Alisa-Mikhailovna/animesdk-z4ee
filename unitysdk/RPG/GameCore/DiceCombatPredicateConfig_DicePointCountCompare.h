...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEPOINTCOUNTCOMPARE_METHOD_4_776FA4060043F42D_OFFSET UNITYSDK_OFFSET(0x1B3B2820)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEPOINTCOUNTCOMPARE_METHOD_4_E7D7385B7B02E04E_OFFSET UNITYSDK_OFFSET(0x1B3B4E60)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEPOINTCOUNTCOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B2810)
