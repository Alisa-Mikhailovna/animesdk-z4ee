...
#define RPG_GAMECORE_SHAREDENTITYEVENT_METHOD_2_02556C8237EF2802_OFFSET UNITYSDK_OFFSET(0x1B8BFF00)
#define RPG_GAMECORE_SHAREDENTITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C00E0)
