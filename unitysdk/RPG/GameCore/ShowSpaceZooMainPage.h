...
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_5C0A91E4DA33C894_OFFSET UNITYSDK_OFFSET(0x1B8D49F0)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_D0960E2CF7C7FDF1_OFFSET UNITYSDK_OFFSET(0x1B8D4A30)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D4A20)
