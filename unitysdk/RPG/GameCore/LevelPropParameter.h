...
#define RPG_GAMECORE_LEVELPROPPARAMETER_METHOD_2_7316772C7CE8A717_OFFSET UNITYSDK_OFFSET(0x1B571C00)
#define RPG_GAMECORE_LEVELPROPPARAMETER_METHOD_2_BCDD42E36CBCCDA5_OFFSET UNITYSDK_OFFSET(0x1B572050)
#define RPG_GAMECORE_LEVELPROPPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B571B00)
