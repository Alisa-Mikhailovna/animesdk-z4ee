...
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICSTRING_METHOD_3_DB8429442197E274_OFFSET UNITYSDK_OFFSET(0x1B932B90)
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICSTRING_METHOD_3_E969C6D2344C5CBB_OFFSET UNITYSDK_OFFSET(0x1B932410)
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B932400)
