...
#define RPG_GAMECORE_ROGUETOURNBUILDREFSORTCONFIG_METHOD_2_36BF0A513C5A1059_OFFSET UNITYSDK_OFFSET(0x1B793D50)
#define RPG_GAMECORE_ROGUETOURNBUILDREFSORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B793F50)
