...
#define RPG_GAMECORE_LEVELFLOORBAKEDSUBMAPINFO_METHOD_2_92F1B9CCEAD59391_OFFSET UNITYSDK_OFFSET(0x1B5569F0)
#define RPG_GAMECORE_LEVELFLOORBAKEDSUBMAPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B556C40)
