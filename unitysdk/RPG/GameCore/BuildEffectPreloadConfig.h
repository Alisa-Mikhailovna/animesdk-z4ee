...
#define RPG_GAMECORE_BUILDEFFECTPRELOADCONFIG_METHOD_2_FCC5DFFDAE3B699E_OFFSET UNITYSDK_OFFSET(0x1B21C930)
#define RPG_GAMECORE_BUILDEFFECTPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21CAB0)
