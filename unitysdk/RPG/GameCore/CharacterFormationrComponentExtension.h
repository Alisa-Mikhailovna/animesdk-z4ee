...
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETFORMATIONENTITY_OFFSET UNITYSDK_OFFSET(0xD9CB1A0)
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETFORMATIONWORLDPOS_1_OFFSET UNITYSDK_OFFSET(0xD9CB340)
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETFORMATIONWORLDPOS_OFFSET UNITYSDK_OFFSET(0xD9CB210)
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETTARGETSELECTGROUP_OFFSET UNITYSDK_OFFSET(0xD9CB460)
