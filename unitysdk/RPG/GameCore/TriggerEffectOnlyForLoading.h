...
#define RPG_GAMECORE_TRIGGEREFFECTONLYFORLOADING_METHOD_3_284E8C94A9B6064F_OFFSET UNITYSDK_OFFSET(0x1B9A1F70)
#define RPG_GAMECORE_TRIGGEREFFECTONLYFORLOADING_METHOD_3_BB28D394FFC6CFE6_OFFSET UNITYSDK_OFFSET(0x1B9A1FB0)
#define RPG_GAMECORE_TRIGGEREFFECTONLYFORLOADING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A1FA0)
