...
#define RPG_GAMECORE_SAVECHARACTERSTATE_METHOD_3_1A94BCC578F59C90_OFFSET UNITYSDK_OFFSET(0x1B878B80)
#define RPG_GAMECORE_SAVECHARACTERSTATE_METHOD_3_300B3941BA02CE6B_OFFSET UNITYSDK_OFFSET(0x1B878C60)
#define RPG_GAMECORE_SAVECHARACTERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B878C00)
