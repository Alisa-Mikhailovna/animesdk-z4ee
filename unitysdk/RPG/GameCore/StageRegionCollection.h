...
#define RPG_GAMECORE_STAGEREGIONCOLLECTION_METHOD_2_25DD8A078B7F0A7D_OFFSET UNITYSDK_OFFSET(0x1B900180)
#define RPG_GAMECORE_STAGEREGIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9002D0)
