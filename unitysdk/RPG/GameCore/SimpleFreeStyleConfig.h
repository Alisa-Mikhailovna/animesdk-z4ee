...
#define RPG_GAMECORE_SIMPLEFREESTYLECONFIG_METHOD_2_E86703846AF790DF_OFFSET UNITYSDK_OFFSET(0x1B8D9070)
#define RPG_GAMECORE_SIMPLEFREESTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D9240)
