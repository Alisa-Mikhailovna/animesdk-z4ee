...
#define RPG_GAMECORE_AISWITCHCASEDECISION_METHOD_2_CCB36E1C71671757_OFFSET UNITYSDK_OFFSET(0x1B0F1620)
#define RPG_GAMECORE_AISWITCHCASEDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F1760)
