...
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_C32A6210AA1A9142_OFFSET UNITYSDK_OFFSET(0x1B233080)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_C9C7F6F8193444C9_OFFSET UNITYSDK_OFFSET(0x1B232ED0)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_D2DC705C7257DFD8_OFFSET UNITYSDK_OFFSET(0x1B232F10)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_DD0C1B4F379D0215_OFFSET UNITYSDK_OFFSET(0x1B2330B0)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B232F00)
