...
#define RPG_GAMECORE_MARBLESETNEXTSCOREDELTA_METHOD_3_08EE47FF281E430F_OFFSET UNITYSDK_OFFSET(0x1B5C1660)
#define RPG_GAMECORE_MARBLESETNEXTSCOREDELTA_METHOD_3_F3DDF13BA85DB6B3_OFFSET UNITYSDK_OFFSET(0x1B5C1560)
#define RPG_GAMECORE_MARBLESETNEXTSCOREDELTA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C1650)
