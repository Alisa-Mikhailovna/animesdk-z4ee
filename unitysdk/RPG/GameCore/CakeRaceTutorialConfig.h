...
#define RPG_GAMECORE_CAKERACETUTORIALCONFIG_METHOD_2_1039D7CBAA2B849E_OFFSET UNITYSDK_OFFSET(0x1B2FDF70)
#define RPG_GAMECORE_CAKERACETUTORIALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FE1D0)
