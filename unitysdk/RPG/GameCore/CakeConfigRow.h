...
#define RPG_GAMECORE_CAKECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2F0F10)
#define RPG_GAMECORE_CAKECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F13A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* CatCakeTailPath; // 0x18
		::Il2CppArray<::System::UInt32>* CatCaughtLines; // 0x20
		::System::String* CakeDarkMatPath; // 0x28
		::System::String* CatCakeHeadIcon; // 0x30
		::System::String* CatCakeMiniIcon; // 0x38
		::Il2CppArray<::System::UInt32>* CatMissedLines; // 0x40
		::System::UInt32 CatTailColour; // 0x48
