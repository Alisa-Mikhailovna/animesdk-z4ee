...
#define RPG_GAMECORE_VCAMERASHOTANIMMOVEMENTCONFIG_METHOD_2_2699366CB151397E_OFFSET UNITYSDK_OFFSET(0x1B9CA700)
#define RPG_GAMECORE_VCAMERASHOTANIMMOVEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CDBA0)
