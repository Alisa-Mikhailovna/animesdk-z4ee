...
#define RPG_GAMECORE_AVATARLINEUPKEYLEVELCONFIG_METHOD_2_BF3719D9D3DEB1B5_OFFSET UNITYSDK_OFFSET(0x1B1CA690)
#define RPG_GAMECORE_AVATARLINEUPKEYLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CAA90)
