...
#define RPG_GAMECORE_ELFFEVERSKILLLEVELCONFIG_METHOD_2_00CA52A8CE793C54_OFFSET UNITYSDK_OFFSET(0x1B3DAF00)
#define RPG_GAMECORE_ELFFEVERSKILLLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DB070)
