...
#define RPG_GAMECORE_SETTEAMFORMATION_METHOD_3_BC22AC9C3E41FEEC_OFFSET UNITYSDK_OFFSET(0x1B8B6590)
#define RPG_GAMECORE_SETTEAMFORMATION_METHOD_3_CEB77850EAD950FB_OFFSET UNITYSDK_OFFSET(0x1B8B6650)
#define RPG_GAMECORE_SETTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B6600)
