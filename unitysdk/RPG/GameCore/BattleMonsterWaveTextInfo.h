...
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_GET_CURRENTWAVECOUNT_OFFSET UNITYSDK_OFFSET(0xD9BC530)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_GET_MAXWAVECOUNT_OFFSET UNITYSDK_OFFSET(0xD9BC5E0)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_HASOVERRIDEINFO_OFFSET UNITYSDK_OFFSET(0xD9BC750)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_RESET_OFFSET UNITYSDK_OFFSET(0xD9BC700)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_SETOVERRIDEWAVETEXTINFO_OFFSET UNITYSDK_OFFSET(0xD9BC690)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD9BC520)
