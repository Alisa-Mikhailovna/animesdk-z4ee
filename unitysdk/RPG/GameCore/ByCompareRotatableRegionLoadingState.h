...
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE_METHOD_4_8A1789E91CA00C3B_OFFSET UNITYSDK_OFFSET(0x1B26BB90)
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE_METHOD_4_9C9A3D24403A53D5_OFFSET UNITYSDK_OFFSET(0x1B26BDF0)
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE_METHOD_4_B8BEA7E4BC5A0852_OFFSET UNITYSDK_OFFSET(0x1B26BE20)
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE_METHOD_4_CCB8B5B5406629EA_OFFSET UNITYSDK_OFFSET(0x1B26BBD0)
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B26BBC0)
