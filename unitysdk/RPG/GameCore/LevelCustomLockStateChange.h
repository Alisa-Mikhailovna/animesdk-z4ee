...
#define RPG_GAMECORE_LEVELCUSTOMLOCKSTATECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDACB590)
#define RPG_GAMECORE_LEVELCUSTOMLOCKSTATECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDACB540)
#define RPG_GAMECORE_LEVELCUSTOMLOCKSTATECHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xDACB4E0)
#define RPG_GAMECORE_LEVELCUSTOMLOCKSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xDACB5E0)
