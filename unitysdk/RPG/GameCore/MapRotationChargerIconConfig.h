...
#define RPG_GAMECORE_MAPROTATIONCHARGERICONCONFIG_METHOD_2_79BFD01625A3526D_OFFSET UNITYSDK_OFFSET(0x1B5A9A20)
#define RPG_GAMECORE_MAPROTATIONCHARGERICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A9B80)
