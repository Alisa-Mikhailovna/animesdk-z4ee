...
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS_METHOD_4_35E2458A4202DC4F_OFFSET UNITYSDK_OFFSET(0x1B950BF0)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS_METHOD_4_976A10E390C1EA5A_OFFSET UNITYSDK_OFFSET(0x1B950B90)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS_METHOD_4_E306282B4BDD7B82_OFFSET UNITYSDK_OFFSET(0x1B950C10)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS_METHOD_4_F68AE90BC1108C7B_OFFSET UNITYSDK_OFFSET(0x1B950B10)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B950B80)
