...
#define RPG_GAMECORE_LEVELPEDESTRIANNODEINFO_METHOD_2_7245DFC047598AC7_OFFSET UNITYSDK_OFFSET(0x1B56CA90)
#define RPG_GAMECORE_LEVELPEDESTRIANNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B56CBE0)
