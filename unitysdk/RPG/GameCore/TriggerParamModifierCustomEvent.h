...
#define RPG_GAMECORE_TRIGGERPARAMMODIFIERCUSTOMEVENT_METHOD_3_AD558FD3033603F8_OFFSET UNITYSDK_OFFSET(0x1B9A7110)
#define RPG_GAMECORE_TRIGGERPARAMMODIFIERCUSTOMEVENT_METHOD_3_C47B4AAA008C68E9_OFFSET UNITYSDK_OFFSET(0x1B9A70D0)
#define RPG_GAMECORE_TRIGGERPARAMMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A7100)
