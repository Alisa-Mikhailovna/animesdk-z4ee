...
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_37DF8488625024DA_OFFSET UNITYSDK_OFFSET(0x1B3E6C90)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_4F0D2BF91D249351_OFFSET UNITYSDK_OFFSET(0x1B3E6C50)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E6C80)
