...
#define RPG_GAMECORE_CHENLINGFESPROPERTYMODIFIER_METHOD_2_3432DB050A2EA3B4_OFFSET UNITYSDK_OFFSET(0x1B3386D0)
#define RPG_GAMECORE_CHENLINGFESPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3388D0)
