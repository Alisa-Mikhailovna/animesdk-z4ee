...
#define RPG_GAMECORE_PHOTOGRAPHFINDNPCCONFIG_METHOD_2_8AD5B652E60BE004_OFFSET UNITYSDK_OFFSET(0x1B6A9C00)
#define RPG_GAMECORE_PHOTOGRAPHFINDNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A9CF0)
