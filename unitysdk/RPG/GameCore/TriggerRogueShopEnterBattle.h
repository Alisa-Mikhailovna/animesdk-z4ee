...
#define RPG_GAMECORE_TRIGGERROGUESHOPENTERBATTLE_METHOD_3_5EACA8055EE13559_OFFSET UNITYSDK_OFFSET(0x1B9A8B20)
#define RPG_GAMECORE_TRIGGERROGUESHOPENTERBATTLE_METHOD_3_F2C1CDAD9F2A395C_OFFSET UNITYSDK_OFFSET(0x1B9A8A50)
#define RPG_GAMECORE_TRIGGERROGUESHOPENTERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A8B10)
