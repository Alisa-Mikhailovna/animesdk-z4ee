...
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_6BD09B641D617F95_OFFSET UNITYSDK_OFFSET(0x1B7D1800)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_9D31DC0DE1588100_OFFSET UNITYSDK_OFFSET(0x1B7D1840)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_B51D1BE0A5BAE730_OFFSET UNITYSDK_OFFSET(0x1B7D19D0)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE_METHOD_4_E5CCAE69EE03E0C7_OFFSET UNITYSDK_OFFSET(0x1B7D1A00)
#define RPG_GAMECORE_ST_BYCONTAINABNORMALSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D1830)
