...
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER_METHOD_2_D5B80FAB7297D182_OFFSET UNITYSDK_OFFSET(0x1B1EAE30)
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER_METHOD_2_D8F7CEB9B788FDE6_OFFSET UNITYSDK_OFFSET(0x1B1EB240)
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EB2A0)
