...
#define RPG_GAMECORE_SHAREDSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B8C0810)
#define RPG_GAMECORE_SHAREDSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B8C0870)
#define RPG_GAMECORE_SHAREDSTRING_METHOD_3_1313316A5B8C7FBD_OFFSET UNITYSDK_OFFSET(0x1B8C06D0)
#define RPG_GAMECORE_SHAREDSTRING_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1B8C0800)
#define RPG_GAMECORE_SHAREDSTRING_METHOD_3_CB9B8324D70328E2_OFFSET UNITYSDK_OFFSET(0x1B8C0710)
#define RPG_GAMECORE_SHAREDSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C0700)
