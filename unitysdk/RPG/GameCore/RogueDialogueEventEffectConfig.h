...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTEFFECTCONFIG_METHOD_2_48DB072B65CC9837_OFFSET UNITYSDK_OFFSET(0x1B75E6A0)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75E6E0)
