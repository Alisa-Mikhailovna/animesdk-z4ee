...
#define RPG_GAMECORE_MICONDITIONENTRYCONFIG_METHOD_2_301726C19AA96963_OFFSET UNITYSDK_OFFSET(0x1B5F7F80)
#define RPG_GAMECORE_MICONDITIONENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F7FC0)
