...
#define RPG_GAMECORE_RECHARGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B708B30)
#define RPG_GAMECORE_RECHARGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B708F60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 NormalCharge; // 0x5C
