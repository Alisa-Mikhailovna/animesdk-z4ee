...
#define RPG_GAMECORE_TRIGGERFIGHTFESTLINEUPINMISSION_METHOD_3_5FDD1F6FF2B51C3F_OFFSET UNITYSDK_OFFSET(0x1B9A3240)
#define RPG_GAMECORE_TRIGGERFIGHTFESTLINEUPINMISSION_METHOD_3_6BA54C838F32ED4A_OFFSET UNITYSDK_OFFSET(0x1B9A3280)
#define RPG_GAMECORE_TRIGGERFIGHTFESTLINEUPINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A3270)
