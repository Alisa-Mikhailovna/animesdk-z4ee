...
#define RPG_GAMECORE_ELATIONLEVELSETTING_METHOD_2_DBFB2CE49A1849FB_OFFSET UNITYSDK_OFFSET(0x1B3D76B0)
#define RPG_GAMECORE_ELATIONLEVELSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D7800)
