...
#define RPG_GAMECORE_BATTLEEVENTBUTTONTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1F5440)
#define RPG_GAMECORE_BATTLEEVENTBUTTONTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F5620)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ButtonReadyPath; // 0x28
