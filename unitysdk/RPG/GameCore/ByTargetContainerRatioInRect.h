...
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT_METHOD_4_09B1CA8BF3C28673_OFFSET UNITYSDK_OFFSET(0x1B2E39C0)
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT_METHOD_4_32207F2AC0855714_OFFSET UNITYSDK_OFFSET(0x1B2E3A70)
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT_METHOD_4_DD0FB4AD3E297A40_OFFSET UNITYSDK_OFFSET(0x1B2E3C90)
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT_METHOD_4_ECBACE56234333D8_OFFSET UNITYSDK_OFFSET(0x1B2E3D00)
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2E3A30)
