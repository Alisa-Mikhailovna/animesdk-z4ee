...
#define RPG_GAMECORE_DEVICERELATEDFLOAT_METHOD_3_B2C753CAD7FC4A97_OFFSET UNITYSDK_OFFSET(0x1B3A4920)
#define RPG_GAMECORE_DEVICERELATEDFLOAT_METHOD_3_ED35481A76A4682D_OFFSET UNITYSDK_OFFSET(0x1B3A52B0)
#define RPG_GAMECORE_DEVICERELATEDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A4910)
