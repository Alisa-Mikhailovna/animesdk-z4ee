...
#define RPG_GAMECORE_ADVSETNPCVISIONSCONFIG_METHOD_3_6840311B5A35FD89_OFFSET UNITYSDK_OFFSET(0x1B163C40)
#define RPG_GAMECORE_ADVSETNPCVISIONSCONFIG_METHOD_3_8A07A59B8B3EAABE_OFFSET UNITYSDK_OFFSET(0x1B163C80)
#define RPG_GAMECORE_ADVSETNPCVISIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B163C70)
