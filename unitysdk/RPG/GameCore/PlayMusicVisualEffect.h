...
#define RPG_GAMECORE_PLAYMUSICVISUALEFFECT_METHOD_3_B9304EAB23A1A936_OFFSET UNITYSDK_OFFSET(0x1B6C7A70)
#define RPG_GAMECORE_PLAYMUSICVISUALEFFECT_METHOD_3_D82B8FE6BE772E60_OFFSET UNITYSDK_OFFSET(0x1B6C79F0)
#define RPG_GAMECORE_PLAYMUSICVISUALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C7A40)
