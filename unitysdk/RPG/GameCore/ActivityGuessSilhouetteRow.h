...
#define RPG_GAMECORE_ACTIVITYGUESSSILHOUETTEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B11AFA0)
#define RPG_GAMECORE_ACTIVITYGUESSSILHOUETTEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B11B500)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* KeyIconPath2; // 0x20
		::System::String* Daily; // 0x28
		::System::String* Aim01; // 0x30
		::System::String* Aim02; // 0x38
		::System::String* KeyIconPath; // 0x40
		::System::String* Title; // 0x48
		::System::String* Tab; // 0x50
		::System::UInt32 MissionID; // 0x58
		::System::UInt32 SilhouetteID; // 0x5C
		::System::UInt32 BranchQuestID; // 0x60
		::System::UInt32 Day; // 0x64
