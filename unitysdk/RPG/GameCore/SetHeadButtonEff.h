...
#define RPG_GAMECORE_SETHEADBUTTONEFF_METHOD_3_10E55575C347375D_OFFSET UNITYSDK_OFFSET(0x1B8A5E60)
#define RPG_GAMECORE_SETHEADBUTTONEFF_METHOD_3_3FC2025C12863CA8_OFFSET UNITYSDK_OFFSET(0x1B8A5F00)
#define RPG_GAMECORE_SETHEADBUTTONEFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A5EC0)
