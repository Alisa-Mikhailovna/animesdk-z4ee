...
#define RPG_GAMECORE_BATTLEENTITYSKILLWHITEBOXDATA_METHOD_2_0B452163E3FA3877_OFFSET UNITYSDK_OFFSET(0x1B1F4290)
#define RPG_GAMECORE_BATTLEENTITYSKILLWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F4F20)
