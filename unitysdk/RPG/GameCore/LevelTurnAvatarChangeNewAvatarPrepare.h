...
#define RPG_GAMECORE_LEVELTURNAVATARCHANGENEWAVATARPREPARE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADC030)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGENEWAVATARPREPARE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADC080)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGENEWAVATARPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0xDADC0D0)
