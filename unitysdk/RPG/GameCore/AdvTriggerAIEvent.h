...
#define RPG_GAMECORE_ADVTRIGGERAIEVENT_METHOD_3_5EA6646A8C987F74_OFFSET UNITYSDK_OFFSET(0x1B166C10)
#define RPG_GAMECORE_ADVTRIGGERAIEVENT_METHOD_3_AA1268C0A3062A81_OFFSET UNITYSDK_OFFSET(0x1B166C50)
#define RPG_GAMECORE_ADVTRIGGERAIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B166C40)
