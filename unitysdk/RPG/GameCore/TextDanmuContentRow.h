...
#define RPG_GAMECORE_TEXTDANMUCONTENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B96C630)
#define RPG_GAMECORE_TEXTDANMUCONTENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B96C7B0)
