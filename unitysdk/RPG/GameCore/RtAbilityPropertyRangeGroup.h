...
#define RPG_GAMECORE_RTABILITYPROPERTYRANGEGROUP_METHOD_2_27BD2A9318FDE584_OFFSET UNITYSDK_OFFSET(0x1B7A6E90)
#define RPG_GAMECORE_RTABILITYPROPERTYRANGEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A7010)
