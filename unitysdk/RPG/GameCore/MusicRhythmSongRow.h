...
#define RPG_GAMECORE_MUSICRHYTHMSONGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B668EA0)
#define RPG_GAMECORE_MUSICRHYTHMSONGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B669470)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* MixingWaveMatPath; // 0x28
		...
		::System::UInt32 GridTransitionTime; // 0x64
		::System::UInt32 UnlockType; // 0x68
		::System::UInt32 GridNum; // 0x6C
		::System::Int32 PresetEndGrid; // 0x70
		::System::UInt32 ID; // 0x74
		::System::Int32 PresetStartGrid; // 0x78
