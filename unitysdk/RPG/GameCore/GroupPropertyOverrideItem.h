...
#define RPG_GAMECORE_GROUPPROPERTYOVERRIDEITEM_METHOD_2_DDF1CCCD4360C2B1_OFFSET UNITYSDK_OFFSET(0x1B4F7EF0)
#define RPG_GAMECORE_GROUPPROPERTYOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F8080)
