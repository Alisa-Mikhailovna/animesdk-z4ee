...
#define RPG_GAMECORE_TUTORIALGUIDETALKLISTADAPTCONFIG_METHOD_2_876419F9A078D635_OFFSET UNITYSDK_OFFSET(0x1B9BAAA0)
#define RPG_GAMECORE_TUTORIALGUIDETALKLISTADAPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BAC80)
