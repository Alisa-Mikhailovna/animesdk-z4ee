...
#define RPG_GAMECORE_HOYOTAGCONTAINER_ADDTAG_OFFSET UNITYSDK_OFFSET(0x1B51CA50)
#define RPG_GAMECORE_HOYOTAGCONTAINER_APPLYCONTAINEROVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x1B51DDB0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_CLONE_OFFSET UNITYSDK_OFFSET(0x1B51C740)
#define RPG_GAMECORE_HOYOTAGCONTAINER_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1B51C9D0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_FINDTAG_OFFSET UNITYSDK_OFFSET(0x1B51CB50)
#define RPG_GAMECORE_HOYOTAGCONTAINER_FIND_OFFSET UNITYSDK_OFFSET(0x1B51CC70)
#define RPG_GAMECORE_HOYOTAGCONTAINER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B51C500)
#define RPG_GAMECORE_HOYOTAGCONTAINER_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1B51C5D0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B51C850)
#define RPG_GAMECORE_HOYOTAGCONTAINER_GETHOYOTAGNODEINFO_OFFSET UNITYSDK_OFFSET(0x1B51CD90)
#define RPG_GAMECORE_HOYOTAGCONTAINER_GETHOYOTAGNODEINFO_RUNTIME_OFFSET UNITYSDK_OFFSET(0x1B51CE80)
#define RPG_GAMECORE_HOYOTAGCONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B51CA20)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASALLEXACT_OFFSET UNITYSDK_OFFSET(0x1B51DBA0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASALL_OFFSET UNITYSDK_OFFSET(0x1B51DAB0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASANYEXACT_OFFSET UNITYSDK_OFFSET(0x1B51D8B0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASANY_1_OFFSET UNITYSDK_OFFSET(0x1B51D360)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASANY_2_OFFSET UNITYSDK_OFFSET(0x1B51D830)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASANY_OFFSET UNITYSDK_OFFSET(0x1B51D280)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASTAGEXACT_OFFSET UNITYSDK_OFFSET(0x1B51D160)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASTAG_OFFSET UNITYSDK_OFFSET(0x1B51CF70)
#define RPG_GAMECORE_HOYOTAGCONTAINER_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1B51CA30)
#define RPG_GAMECORE_HOYOTAGCONTAINER_REMOVETAG_OFFSET UNITYSDK_OFFSET(0x1B51CBA0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B51C9C0)
#define RPG_GAMECORE_HOYOTAGCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51C5C0)
