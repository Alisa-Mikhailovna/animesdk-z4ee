...
#define RPG_GAMECORE_ROGUECHESTEFFECTLISTCONFIG_METHOD_2_380B69A1472C3BBC_OFFSET UNITYSDK_OFFSET(0x1B746F00)
#define RPG_GAMECORE_ROGUECHESTEFFECTLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B746F40)
