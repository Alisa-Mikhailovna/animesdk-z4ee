...
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xDADDE10)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETDISABLEREADYCAMERA_OFFSET UNITYSDK_OFFSET(0xDADDEF0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADDD80)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xDADDDD0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETSKILLINDEX_OFFSET UNITYSDK_OFFSET(0xDADDE60)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADDD30)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GET_ACTIONTYPE_OFFSET UNITYSDK_OFFSET(0xDADDF90)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_HASPREPAREABILITY_OFFSET UNITYSDK_OFFSET(0xDADDF30)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_INIT_OFFSET UNITYSDK_OFFSET(0xDADDCC0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0xDADDFB0)
