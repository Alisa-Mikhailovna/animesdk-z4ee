...
#define RPG_GAMECORE_UNIVERSALHOTFIXBASETASK_METHOD_3_61A7BDAF4C1DB6F7_OFFSET UNITYSDK_OFFSET(0x1B9C4C10)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASETASK_METHOD_3_E7DA718EE2E1E37D_OFFSET UNITYSDK_OFFSET(0x1B9C49E0)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C4C00)
