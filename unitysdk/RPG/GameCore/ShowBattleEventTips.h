...
#define RPG_GAMECORE_SHOWBATTLEEVENTTIPS_METHOD_3_40D29FF81360AF56_OFFSET UNITYSDK_OFFSET(0x1B8C75B0)
#define RPG_GAMECORE_SHOWBATTLEEVENTTIPS_METHOD_3_B5C79D1685159719_OFFSET UNITYSDK_OFFSET(0x1B8C75F0)
#define RPG_GAMECORE_SHOWBATTLEEVENTTIPS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C75E0)
