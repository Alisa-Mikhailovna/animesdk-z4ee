...
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4D32E0)
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D3720)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 InitialRandomCode; // 0x5C
