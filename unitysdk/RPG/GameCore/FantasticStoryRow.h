...
#define RPG_GAMECORE_FANTASTICSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B407470)
#define RPG_GAMECORE_FANTASTICSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4076C0)
