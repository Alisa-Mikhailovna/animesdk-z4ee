...
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_BUILDEFFECTIVELEVELABILITYPARAM_OFFSET UNITYSDK_OFFSET(0x1B4DAF80)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_COMPARETRAITSEARCHKEY_OFFSET UNITYSDK_OFFSET(0x1B4DBB50)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_CREATECOMMONCONSTDATA_OFFSET UNITYSDK_OFFSET(0x1B4D9560)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_FORCEGETTRAITSEARCHKEY_OFFSET UNITYSDK_OFFSET(0x1B4DBC40)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_FULLAFFIXMAZEBUFFS_OFFSET UNITYSDK_OFFSET(0x1B4DC140)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETACTIVETRAITINFOSTR_OFFSET UNITYSDK_OFFSET(0x1B4DBD00)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETAUGMENTKEY_OFFSET UNITYSDK_OFFSET(0x1B4DBAF0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETAVATARTRAITINFO_OFFSET UNITYSDK_OFFSET(0x1B4DBEE0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETEQUIPMERGEID_OFFSET UNITYSDK_OFFSET(0x1B4DAC60)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETHIGHESTTRAITLAYERCONFIG_OFFSET UNITYSDK_OFFSET(0x1B4DB640)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETHIGHESTTRAITLAYER_OFFSET UNITYSDK_OFFSET(0x1B4DB100)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETINTEGRATEDTRAITLAYERS_OFFSET UNITYSDK_OFFSET(0x1B4DB3E0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETLAYERTRAITMAZEBUFFENHANCELIST_OFFSET UNITYSDK_OFFSET(0x1B4DB760)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITBONUSLAYER_OFFSET UNITYSDK_OFFSET(0x1B4DB8B0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITBONUSSUBPARAMLIST_OFFSET UNITYSDK_OFFSET(0x1B4DB7C0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITEFFECTIDBYEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B4DB680)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITKEY_OFFSET UNITYSDK_OFFSET(0x1B4DBA50)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITLVBYACTIVELAYER_OFFSET UNITYSDK_OFFSET(0x1B4DB070)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETVALIDBACKENDAVATARSTARROW_OFFSET UNITYSDK_OFFSET(0x1B4DBCD0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_HASTRAITBINDING_OFFSET UNITYSDK_OFFSET(0x1B4DAFF0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B4DB030)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_TRYLEVELUP_OFFSET UNITYSDK_OFFSET(0x1B4DB050)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__CHECKLAYERACTVATION_OFFSET UNITYSDK_OFFSET(0x1B4DB320)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__CONSTMAPTOABILITYDATA_OFFSET UNITYSDK_OFFSET(0x1B4DA890)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTARRAY_OFFSET UNITYSDK_OFFSET(0x1B4DA6C0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTFIXPOINT_OFFSET UNITYSDK_OFFSET(0x1B4DA830)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTINT_OFFSET UNITYSDK_OFFSET(0x1B4DA7B0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTUINT_OFFSET UNITYSDK_OFFSET(0x1B4DA730)
