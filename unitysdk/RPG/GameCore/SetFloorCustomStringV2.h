...
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2_METHOD_3_04BB6D2A44F8D582_OFFSET UNITYSDK_OFFSET(0x1B8A4250)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2_METHOD_3_83E0998B92EA3D03_OFFSET UNITYSDK_OFFSET(0x1B8A4290)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A4280)
