...
#define RPG_GAMECORE_COMPLEXSKILLAILINEARITEM_METHOD_2_05405AD3DDA01CBF_OFFSET UNITYSDK_OFFSET(0x1B3756C0)
#define RPG_GAMECORE_COMPLEXSKILLAILINEARITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B375950)
