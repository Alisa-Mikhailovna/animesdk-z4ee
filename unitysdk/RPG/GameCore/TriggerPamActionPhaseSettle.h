...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_39E21FE64A37CDFF_OFFSET UNITYSDK_OFFSET(0x1B9A6580)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_5FAB6C5A81B198C2_OFFSET UNITYSDK_OFFSET(0x1B9A64B0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A6570)
