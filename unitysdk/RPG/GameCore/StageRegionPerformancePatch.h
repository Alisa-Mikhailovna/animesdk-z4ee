...
#define RPG_GAMECORE_STAGEREGIONPERFORMANCEPATCH_METHOD_2_872ACE8EFB2C3A0D_OFFSET UNITYSDK_OFFSET(0x1B9006E0)
#define RPG_GAMECORE_STAGEREGIONPERFORMANCEPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B900CD0)
