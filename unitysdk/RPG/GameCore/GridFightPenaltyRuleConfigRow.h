...
#define RPG_GAMECORE_GRIDFIGHTPENALTYRULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4E48A0)
#define RPG_GAMECORE_GRIDFIGHTPENALTYRULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E4C30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ThresholdPosition; // 0x2C
