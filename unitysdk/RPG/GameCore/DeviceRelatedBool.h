...
#define RPG_GAMECORE_DEVICERELATEDBOOL_METHOD_3_5082C8008E9769E7_OFFSET UNITYSDK_OFFSET(0x1B3A41F0)
#define RPG_GAMECORE_DEVICERELATEDBOOL_METHOD_3_F98AB2C4375257BD_OFFSET UNITYSDK_OFFSET(0x1B3A4190)
#define RPG_GAMECORE_DEVICERELATEDBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A41E0)
