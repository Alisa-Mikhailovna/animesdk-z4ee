...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMEND_METHOD_3_21CF7917C1386CD5_OFFSET UNITYSDK_OFFSET(0x1B212BA0)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMEND_METHOD_3_6C26EC058C697698_OFFSET UNITYSDK_OFFSET(0x1B212C70)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B212C60)
