...
#define RPG_GAMECORE_FREESTYLETRIGGERINFO_METHOD_2_10F1DFB757B4CD9D_OFFSET UNITYSDK_OFFSET(0x1B4A24F0)
#define RPG_GAMECORE_FREESTYLETRIGGERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A2700)
