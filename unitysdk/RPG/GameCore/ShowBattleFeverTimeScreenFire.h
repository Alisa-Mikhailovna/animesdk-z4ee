...
#define RPG_GAMECORE_SHOWBATTLEFEVERTIMESCREENFIRE_METHOD_3_B342A9EDA9511D87_OFFSET UNITYSDK_OFFSET(0x1B8C77A0)
#define RPG_GAMECORE_SHOWBATTLEFEVERTIMESCREENFIRE_METHOD_3_C9E7EB81913A8CCC_OFFSET UNITYSDK_OFFSET(0x1B8C77F0)
#define RPG_GAMECORE_SHOWBATTLEFEVERTIMESCREENFIRE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C77E0)
