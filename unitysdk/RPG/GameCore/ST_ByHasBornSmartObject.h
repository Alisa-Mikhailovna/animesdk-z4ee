...
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_43DAF783517768DF_OFFSET UNITYSDK_OFFSET(0x1B7D5E10)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_6C6FE28CF39804B2_OFFSET UNITYSDK_OFFSET(0x1B7D5E40)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_8AC1560785B44DF6_OFFSET UNITYSDK_OFFSET(0x1B7D5C90)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT_METHOD_4_F04A42BC3CAF86B5_OFFSET UNITYSDK_OFFSET(0x1B7D5CD0)
#define RPG_GAMECORE_ST_BYHASBORNSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D5CC0)
