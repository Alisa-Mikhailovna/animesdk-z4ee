...
#define RPG_GAMECORE_RENDERTESTITEMJSON_METHOD_2_57F8D7C286261357_OFFSET UNITYSDK_OFFSET(0x1B71EED0)
#define RPG_GAMECORE_RENDERTESTITEMJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71F010)
