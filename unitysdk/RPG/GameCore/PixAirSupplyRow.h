...
#define RPG_GAMECORE_PIXAIRSUPPLYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6B6DA0)
#define RPG_GAMECORE_PIXAIRSUPPLYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B6E60)
