...
#define RPG_GAMECORE_VCAMERASHOWTARGETENTITY_METHOD_2_BFA33D6F15CEB745_OFFSET UNITYSDK_OFFSET(0x1B9CB860)
#define RPG_GAMECORE_VCAMERASHOWTARGETENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CDBB0)
