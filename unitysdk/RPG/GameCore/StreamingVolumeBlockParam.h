...
#define RPG_GAMECORE_STREAMINGVOLUMEBLOCKPARAM_METHOD_2_5D5A3D691B308399_OFFSET UNITYSDK_OFFSET(0x1B917300)
#define RPG_GAMECORE_STREAMINGVOLUMEBLOCKPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B917540)
