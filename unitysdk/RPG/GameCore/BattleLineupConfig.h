...
#define RPG_GAMECORE_BATTLELINEUPCONFIG_METHOD_2_698D6E65616654F9_OFFSET UNITYSDK_OFFSET(0x1B1FCE50)
#define RPG_GAMECORE_BATTLELINEUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1FD090)
