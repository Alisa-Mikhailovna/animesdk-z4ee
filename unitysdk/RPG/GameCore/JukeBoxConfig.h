...
#define RPG_GAMECORE_JUKEBOXCONFIG_METHOD_2_507B219912A33C48_OFFSET UNITYSDK_OFFSET(0x1B54D990)
#define RPG_GAMECORE_JUKEBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54DAE0)
