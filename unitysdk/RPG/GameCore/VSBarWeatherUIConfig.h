...
#define RPG_GAMECORE_VSBARWEATHERUICONFIG_METHOD_3_4D1CC4C8A0253089_OFFSET UNITYSDK_OFFSET(0x1B9D9590)
#define RPG_GAMECORE_VSBARWEATHERUICONFIG_METHOD_3_56C36F8EEAAD3EE6_OFFSET UNITYSDK_OFFSET(0x1B9D9530)
#define RPG_GAMECORE_VSBARWEATHERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D9580)
