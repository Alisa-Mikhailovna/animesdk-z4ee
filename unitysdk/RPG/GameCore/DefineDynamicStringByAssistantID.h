...
#define RPG_GAMECORE_DEFINEDYNAMICSTRINGBYASSISTANTID_METHOD_3_49CF5D5453E630BE_OFFSET UNITYSDK_OFFSET(0x1B3A0230)
#define RPG_GAMECORE_DEFINEDYNAMICSTRINGBYASSISTANTID_METHOD_3_7CB3375162D174AF_OFFSET UNITYSDK_OFFSET(0x1B3A0270)
#define RPG_GAMECORE_DEFINEDYNAMICSTRINGBYASSISTANTID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A0260)
