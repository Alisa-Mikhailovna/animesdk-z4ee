...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1B895910)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER_METHOD_4_0D7D8EA3BC6CE9B2_OFFSET UNITYSDK_OFFSET(0x1B8956B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER_METHOD_4_5C99CC50DC151EAF_OFFSET UNITYSDK_OFFSET(0x1B895670)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8956A0)
