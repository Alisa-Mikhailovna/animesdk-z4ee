...
#define RPG_GAMECORE_ELFBEHAVIORSTATECONTENTITEM_METHOD_2_3C72CDA77989E100_OFFSET UNITYSDK_OFFSET(0x1B3D8A10)
#define RPG_GAMECORE_ELFBEHAVIORSTATECONTENTITEM_METHOD_2_ACBFF3E49E74258D_OFFSET UNITYSDK_OFFSET(0x1B3D8B90)
#define RPG_GAMECORE_ELFBEHAVIORSTATECONTENTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D8B80)
