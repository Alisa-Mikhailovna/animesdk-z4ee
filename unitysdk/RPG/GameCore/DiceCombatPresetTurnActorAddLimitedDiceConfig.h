...
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORADDLIMITEDDICECONFIG_METHOD_2_DBEAB8C8A0CF9DEE_OFFSET UNITYSDK_OFFSET(0x1B3B5500)
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORADDLIMITEDDICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B5670)
