...
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE_METHOD_4_8BE8FBB75BAA4A71_OFFSET UNITYSDK_OFFSET(0x1B9C3800)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE_METHOD_4_942F137C76A017E8_OFFSET UNITYSDK_OFFSET(0x1B9C2690)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE_METHOD_4_97D2EAC174F075A4_OFFSET UNITYSDK_OFFSET(0x1B9C28C0)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE_METHOD_4_C8EB6D7C270EB138_OFFSET UNITYSDK_OFFSET(0x1B9C3490)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C28B0)
