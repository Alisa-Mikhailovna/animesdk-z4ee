...
#define RPG_GAMECORE_MIACTIONCONFIGBASE_METHOD_3_25C4878AB9C73CDE_OFFSET UNITYSDK_OFFSET(0x1B5F7C20)
#define RPG_GAMECORE_MIACTIONCONFIGBASE_METHOD_3_6FB2DB6F1F02CC80_OFFSET UNITYSDK_OFFSET(0x1B5F7C80)
#define RPG_GAMECORE_MIACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F7D20)
