...
#define RPG_GAMECORE_STANCELEVELEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B906CA0)
#define RPG_GAMECORE_STANCELEVELEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9076A0)
