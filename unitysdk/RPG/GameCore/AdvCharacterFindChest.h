...
#define RPG_GAMECORE_ADVCHARACTERFINDCHEST_METHOD_3_78B9A389176C2CA7_OFFSET UNITYSDK_OFFSET(0x1B14CBE0)
#define RPG_GAMECORE_ADVCHARACTERFINDCHEST_METHOD_3_CA2B871BC6C32E74_OFFSET UNITYSDK_OFFSET(0x1B14CC20)
#define RPG_GAMECORE_ADVCHARACTERFINDCHEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14CC10)
