...
#define RPG_GAMECORE_SHOWMAINPAGEHINT_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B8D0A80)
#define RPG_GAMECORE_SHOWMAINPAGEHINT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B8D0A40)
#define RPG_GAMECORE_SHOWMAINPAGEHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D0A70)
