...
#define RPG_GAMECORE_ILBATTLESTAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5216A0)
#define RPG_GAMECORE_ILBATTLESTAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5219F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CombatAdvantageGroup; // 0x2C
