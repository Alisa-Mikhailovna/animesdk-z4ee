...
#define RPG_GAMECORE_CLOCKPARKCARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B361940)
#define RPG_GAMECORE_CLOCKPARKCARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B361E10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ClockParkCardTipsTypeEnum CardTips; // 0x48
		::System::UInt32 CardID; // 0x4C
		::RPG::GameCore::ClockParkCardType CardType; // 0x50
		::System::UInt32 CardTipsParam; // 0x54
