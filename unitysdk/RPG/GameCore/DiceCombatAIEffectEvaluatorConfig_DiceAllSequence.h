...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSEQUENCE_METHOD_3_4EEFAB28AD33A09E_OFFSET UNITYSDK_OFFSET(0x1B3AA800)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSEQUENCE_METHOD_3_80DC7BAA04457C0F_OFFSET UNITYSDK_OFFSET(0x1B3A9D30)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A9D20)
