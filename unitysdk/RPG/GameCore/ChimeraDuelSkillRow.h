...
#define RPG_GAMECORE_CHIMERADUELSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B3524C0)
#define RPG_GAMECORE_CHIMERADUELSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B352980)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean HasDisplay; // 0x30
		::System::Boolean IsImmediate; // 0x31
