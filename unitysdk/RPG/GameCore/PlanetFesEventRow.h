...
#define RPG_GAMECORE_PLANETFESEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6BE900)
#define RPG_GAMECORE_PLANETFESEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BEB80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RecurCD; // 0x20
		::RPG::GameCore::PlanetFesEventType ID; // 0x24
