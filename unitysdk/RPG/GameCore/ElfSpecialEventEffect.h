...
#define RPG_GAMECORE_ELFSPECIALEVENTEFFECT_METHOD_2_3380F9C49780A535_OFFSET UNITYSDK_OFFSET(0x1B3DDCD0)
#define RPG_GAMECORE_ELFSPECIALEVENTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DDEC0)
