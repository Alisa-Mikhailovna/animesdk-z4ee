...
#define RPG_GAMECORE_CHOOSEDELIVERYGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B359DD0)
#define RPG_GAMECORE_CHOOSEDELIVERYGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B359F10)
