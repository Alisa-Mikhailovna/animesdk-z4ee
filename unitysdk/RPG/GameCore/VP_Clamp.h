...
#define RPG_GAMECORE_VP_CLAMP_METHOD_3_0208A8C81B084F34_OFFSET UNITYSDK_OFFSET(0x1B9D7A50)
#define RPG_GAMECORE_VP_CLAMP_METHOD_3_0226964AFE0B4A82_OFFSET UNITYSDK_OFFSET(0x1B9D79A0)
#define RPG_GAMECORE_VP_CLAMP_METHOD_3_222C95AC95D2CE71_OFFSET UNITYSDK_OFFSET(0x1B9D7960)
#define RPG_GAMECORE_VP_CLAMP_METHOD_3_EC7BA50D23C64ACA_OFFSET UNITYSDK_OFFSET(0x1B9D7A80)
#define RPG_GAMECORE_VP_CLAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D7990)
