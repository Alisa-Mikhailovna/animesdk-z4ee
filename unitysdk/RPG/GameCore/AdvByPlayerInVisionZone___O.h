...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::VisionZoneTag>**)Il2CppClass::FromTypeDefinitionIndex(AdvByPlayerInVisionZone___O_TypeDefinitionIndex)->GetStaticField(0x213A0);
		}
	};
}
