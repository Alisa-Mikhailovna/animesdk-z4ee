...
#define RPG_GAMECORE_PIXAIRPLANEPRESETCONFIG_METHOD_2_8CB068B9A354A1A1_OFFSET UNITYSDK_OFFSET(0x1B6B4FE0)
#define RPG_GAMECORE_PIXAIRPLANEPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B5CC0)
