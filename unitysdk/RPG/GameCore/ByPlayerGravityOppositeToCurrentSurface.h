...
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_5790C917C115380D_OFFSET UNITYSDK_OFFSET(0x1B2DC660)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_E665CDA6C76A144E_OFFSET UNITYSDK_OFFSET(0x1B2DC620)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_F3BF1697B1C2867A_OFFSET UNITYSDK_OFFSET(0x1B2DC7D0)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_FE9715EEA9F30C67_OFFSET UNITYSDK_OFFSET(0x1B2DC7A0)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2DC650)
