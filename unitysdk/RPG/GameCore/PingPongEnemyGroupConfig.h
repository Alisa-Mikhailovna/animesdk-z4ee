...
#define RPG_GAMECORE_PINGPONGENEMYGROUPCONFIG_METHOD_2_D36C0767BFBE7FE7_OFFSET UNITYSDK_OFFSET(0x1B6AEB00)
#define RPG_GAMECORE_PINGPONGENEMYGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AECA0)
