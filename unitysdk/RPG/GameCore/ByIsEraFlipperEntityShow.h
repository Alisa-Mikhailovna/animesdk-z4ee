...
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW_METHOD_4_09539E47B7C01473_OFFSET UNITYSDK_OFFSET(0x1B2ADDF0)
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW_METHOD_4_0E47B3B5314C6E30_OFFSET UNITYSDK_OFFSET(0x1B2ADE30)
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW_METHOD_4_5A564F581C56BA66_OFFSET UNITYSDK_OFFSET(0x1B2ADF70)
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW_METHOD_4_AFC1E33811CA24DB_OFFSET UNITYSDK_OFFSET(0x1B2ADFA0)
#define RPG_GAMECORE_BYISERAFLIPPERENTITYSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2ADE20)
