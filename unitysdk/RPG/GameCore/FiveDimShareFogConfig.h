...
#define RPG_GAMECORE_FIVEDIMSHAREFOGCONFIG_METHOD_2_3132C228A53DDE85_OFFSET UNITYSDK_OFFSET(0x1B448C70)
#define RPG_GAMECORE_FIVEDIMSHAREFOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B448CB0)
