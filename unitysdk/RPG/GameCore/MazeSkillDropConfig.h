...
#define RPG_GAMECORE_MAZESKILLDROPCONFIG_METHOD_2_DB553DC456E7CFC7_OFFSET UNITYSDK_OFFSET(0x1B5E9680)
#define RPG_GAMECORE_MAZESKILLDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E96C0)
