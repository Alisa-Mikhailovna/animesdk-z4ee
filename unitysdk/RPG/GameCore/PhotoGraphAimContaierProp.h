...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERPROP_METHOD_3_36A6F02CD836E4DE_OFFSET UNITYSDK_OFFSET(0x1B6A5A80)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERPROP_METHOD_3_557B2C94F2DA5F13_OFFSET UNITYSDK_OFFSET(0x1B6A5B40)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A5B00)
