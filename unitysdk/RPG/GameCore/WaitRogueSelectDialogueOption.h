...
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION_METHOD_3_7BE676803410C2C1_OFFSET UNITYSDK_OFFSET(0x1B9EE3D0)
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION_METHOD_3_DF78D0BD58DE2C9D_OFFSET UNITYSDK_OFFSET(0x1B9EE380)
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EE3C0)
