...
#define RPG_GAMECORE_PINGPONGTRANSFORMCMPTCONFIG_METHOD_3_8D0B40C6CD967CC6_OFFSET UNITYSDK_OFFSET(0x1B6B1C50)
#define RPG_GAMECORE_PINGPONGTRANSFORMCMPTCONFIG_METHOD_3_D261B1130F33E1CC_OFFSET UNITYSDK_OFFSET(0x1B6B1CB0)
#define RPG_GAMECORE_PINGPONGTRANSFORMCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B1CA0)
