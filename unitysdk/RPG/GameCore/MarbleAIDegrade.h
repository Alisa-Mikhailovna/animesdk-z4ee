...
#define RPG_GAMECORE_MARBLEAIDEGRADE_METHOD_3_AEDED0533F5E0577_OFFSET UNITYSDK_OFFSET(0x1B5B0A40)
#define RPG_GAMECORE_MARBLEAIDEGRADE_METHOD_3_DA93A601FCC17B86_OFFSET UNITYSDK_OFFSET(0x1B5B09A0)
#define RPG_GAMECORE_MARBLEAIDEGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B0A30)
