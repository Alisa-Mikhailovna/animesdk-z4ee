...
#define RPG_GAMECORE_RTMODIFIERCALLBACKCONFIG_METHOD_2_DE2053214280CB82_OFFSET UNITYSDK_OFFSET(0x1B7BF9E0)
#define RPG_GAMECORE_RTMODIFIERCALLBACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7BFB70)
