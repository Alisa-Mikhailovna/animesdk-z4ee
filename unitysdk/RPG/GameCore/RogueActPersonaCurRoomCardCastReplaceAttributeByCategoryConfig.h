...
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG_METHOD_7_503BBEAF461C5A2E_OFFSET UNITYSDK_OFFSET(0x1B735A50)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG_METHOD_7_D032567539283992_OFFSET UNITYSDK_OFFSET(0x1B735B30)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B735A40)
