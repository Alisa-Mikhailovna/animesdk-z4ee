...
#define RPG_GAMECORE_CUTSCENESFXCONFIG_METHOD_2_FCA0C7F3FB3091C9_OFFSET UNITYSDK_OFFSET(0x1B390990)
#define RPG_GAMECORE_CUTSCENESFXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B390A80)
