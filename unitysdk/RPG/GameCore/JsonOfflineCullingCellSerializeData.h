...
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B54CD80)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B54CCB0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_METHOD_2_2FD3A9739073CBA2_OFFSET UNITYSDK_OFFSET(0x1B54D360)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_METHOD_2_D1A606803BE80A89_OFFSET UNITYSDK_OFFSET(0x1B54D200)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54D1F0)
