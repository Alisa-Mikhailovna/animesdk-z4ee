...
#define RPG_GAMECORE_MOVEUINODETOMASK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B635A50)
#define RPG_GAMECORE_MOVEUINODETOMASK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B635A10)
#define RPG_GAMECORE_MOVEUINODETOMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B635A40)
