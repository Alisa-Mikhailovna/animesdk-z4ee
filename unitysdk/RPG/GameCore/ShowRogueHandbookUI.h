...
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI_METHOD_3_09ED2C8504C2E4DD_OFFSET UNITYSDK_OFFSET(0x1B8D2C70)
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI_METHOD_3_146C90A561B4663E_OFFSET UNITYSDK_OFFSET(0x1B8D2CB0)
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D2CA0)
