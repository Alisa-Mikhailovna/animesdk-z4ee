...
#define RPG_GAMECORE_TRIGGERENTITYEVENT_METHOD_3_71FDD92D94D8B471_OFFSET UNITYSDK_OFFSET(0x1B9A2740)
#define RPG_GAMECORE_TRIGGERENTITYEVENT_METHOD_3_8D6410A492148874_OFFSET UNITYSDK_OFFSET(0x1B9A2700)
#define RPG_GAMECORE_TRIGGERENTITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A2730)
