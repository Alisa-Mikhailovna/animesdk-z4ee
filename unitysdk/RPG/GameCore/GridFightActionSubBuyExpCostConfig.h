...
#define RPG_GAMECORE_GRIDFIGHTACTIONSUBBUYEXPCOSTCONFIG_METHOD_6_62ED55FE6DCB3432_OFFSET UNITYSDK_OFFSET(0x1B4D0A00)
#define RPG_GAMECORE_GRIDFIGHTACTIONSUBBUYEXPCOSTCONFIG_METHOD_6_6B4516EAE87FF84E_OFFSET UNITYSDK_OFFSET(0x1B4D0560)
#define RPG_GAMECORE_GRIDFIGHTACTIONSUBBUYEXPCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D0550)
