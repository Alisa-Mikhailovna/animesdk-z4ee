...
#define RPG_GAMECORE_SINGLEANIMBEHAVIOUREVENT_METHOD_2_AD66AD3B7A3EE045_OFFSET UNITYSDK_OFFSET(0x1B8DA200)
#define RPG_GAMECORE_SINGLEANIMBEHAVIOUREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8DA320)
