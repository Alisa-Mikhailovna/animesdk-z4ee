...
#define RPG_GAMECORE_CHALLENGEPEAKGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B30BF70)
#define RPG_GAMECORE_CHALLENGEPEAKGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30C410)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BossLevelID; // 0x48
		::System::UInt32 HintGoodsID; // 0x4C
		::RPG::Client::TextID Title; // 0x50
		::System::UInt32 RecommendID; // 0x60
		::System::UInt32 ActivityModule; // 0x64
