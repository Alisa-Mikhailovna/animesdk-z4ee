...
#define RPG_GAMECORE_RTDAMAGETEXTCONFIGGROUP_METHOD_2_16A8D0100BE6A128_OFFSET UNITYSDK_OFFSET(0x1B7B7BB0)
#define RPG_GAMECORE_RTDAMAGETEXTCONFIGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B7CC0)
