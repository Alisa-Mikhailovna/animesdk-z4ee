...
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADA0B0)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADA060)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV_INIT_OFFSET UNITYSDK_OFFSET(0xDADA020)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV__CTOR_OFFSET UNITYSDK_OFFSET(0xDADA100)
