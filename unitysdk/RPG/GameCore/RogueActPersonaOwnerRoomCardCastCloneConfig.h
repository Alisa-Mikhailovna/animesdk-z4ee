...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTCLONECONFIG_METHOD_7_61FEA92A53290285_OFFSET UNITYSDK_OFFSET(0x1B735C40)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTCLONECONFIG_METHOD_7_FF54A611A0348C09_OFFSET UNITYSDK_OFFSET(0x1B735C90)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTCLONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B735C80)
