...
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_1832BEB7CA9060C0_OFFSET UNITYSDK_OFFSET(0x1B7D5650)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_5E3711823738BBF0_OFFSET UNITYSDK_OFFSET(0x1B7D57E0)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_9BA6BABE2C239055_OFFSET UNITYSDK_OFFSET(0x1B7D5610)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_E0195C49A3D97D87_OFFSET UNITYSDK_OFFSET(0x1B7D5810)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D5640)
