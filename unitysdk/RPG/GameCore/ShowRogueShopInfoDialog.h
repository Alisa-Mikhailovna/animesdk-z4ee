...
#define RPG_GAMECORE_SHOWROGUESHOPINFODIALOG_METHOD_3_677C6DF9D15A4DEA_OFFSET UNITYSDK_OFFSET(0x1B8D3150)
#define RPG_GAMECORE_SHOWROGUESHOPINFODIALOG_METHOD_3_D515C2A92B8F86E9_OFFSET UNITYSDK_OFFSET(0x1B8D3190)
#define RPG_GAMECORE_SHOWROGUESHOPINFODIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D3180)
