...
#define RPG_GAMECORE_ANNIVERSARYCOLLECTIONGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1A82A0)
#define RPG_GAMECORE_ANNIVERSARYCOLLECTIONGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A8430)
