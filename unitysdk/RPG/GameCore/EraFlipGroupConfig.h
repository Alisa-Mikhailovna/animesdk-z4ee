...
#define RPG_GAMECORE_ERAFLIPGROUPCONFIG_METHOD_2_780220646BAABBAD_OFFSET UNITYSDK_OFFSET(0x1B3F4720)
#define RPG_GAMECORE_ERAFLIPGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3F47E0)
