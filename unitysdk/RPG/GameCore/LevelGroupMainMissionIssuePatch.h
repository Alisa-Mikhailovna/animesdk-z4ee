...
#define RPG_GAMECORE_LEVELGROUPMAINMISSIONISSUEPATCH_METHOD_2_55D8A31A8598B6A5_OFFSET UNITYSDK_OFFSET(0x1B55ADF0)
#define RPG_GAMECORE_LEVELGROUPMAINMISSIONISSUEPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B55AF90)
