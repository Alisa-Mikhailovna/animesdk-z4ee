...
#define RPG_GAMECORE_GRIDFIGHTSTAGETEMPLATECONFIG_METHOD_2_85B51C159681AEAC_OFFSET UNITYSDK_OFFSET(0x1B4F0CF0)
#define RPG_GAMECORE_GRIDFIGHTSTAGETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F1020)
