...
#define RPG_GAMECORE_TEAMTOWERSSKILLCONFIG_METHOD_2_EBDFC10948CEFEC4_OFFSET UNITYSDK_OFFSET(0x1B9697C0)
#define RPG_GAMECORE_TEAMTOWERSSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9698A0)
