...
#define RPG_GAMECORE_ROGUETOURNKEYWORDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B79C1A0)
#define RPG_GAMECORE_ROGUETOURNKEYWORDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79C450)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* RogueFormulaList; // 0x18
