...
#define RPG_GAMECORE_LEVELAUDIENCEINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B54FD00)
#define RPG_GAMECORE_LEVELAUDIENCEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B54FCA0)
#define RPG_GAMECORE_LEVELAUDIENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54FCF0)
