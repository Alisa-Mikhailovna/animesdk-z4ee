...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPCONFIG_METHOD_3_B23A524C4A529342_OFFSET UNITYSDK_OFFSET(0x1B4E0D00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPCONFIG_METHOD_3_D48477AA86899C5E_OFFSET UNITYSDK_OFFSET(0x1B4E0D50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0D40)
