...
#define RPG_GAMECORE_ST_SIDE_ENABLEDIALOGUE_METHOD_4_A2B80F9F16B7FDCD_OFFSET UNITYSDK_OFFSET(0x1B7E1150)
#define RPG_GAMECORE_ST_SIDE_ENABLEDIALOGUE_METHOD_4_A8AC9FFC61C5F58E_OFFSET UNITYSDK_OFFSET(0x1B7E1190)
#define RPG_GAMECORE_ST_SIDE_ENABLEDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E1180)
