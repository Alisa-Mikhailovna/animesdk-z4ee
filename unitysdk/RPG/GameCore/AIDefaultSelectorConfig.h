...
#define RPG_GAMECORE_AIDEFAULTSELECTORCONFIG_METHOD_2_96C4BA5018255B8D_OFFSET UNITYSDK_OFFSET(0x1B0EF9C0)
#define RPG_GAMECORE_AIDEFAULTSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EFAB0)
