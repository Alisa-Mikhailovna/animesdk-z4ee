...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGRIDSELECTOR_METHOD_3_78444FBCC6C56E39_OFFSET UNITYSDK_OFFSET(0x1B4D6910)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGRIDSELECTOR_METHOD_3_9BC5B5D009AFC4D5_OFFSET UNITYSDK_OFFSET(0x1B4D6970)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGRIDSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D6960)
