...
#define RPG_GAMECORE_BYTARGETISSTANCEWEAK_METHOD_4_03D6026FFB27BE08_OFFSET UNITYSDK_OFFSET(0x1B2E6BE0)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAK_METHOD_4_0A6156F8F6D30EBF_OFFSET UNITYSDK_OFFSET(0x1B2E69E0)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAK_METHOD_4_0A7545CF49C7D846_OFFSET UNITYSDK_OFFSET(0x1B2E6C10)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAK_METHOD_4_7F73FCD9B91B0D1E_OFFSET UNITYSDK_OFFSET(0x1B2E6A20)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2E6A10)
