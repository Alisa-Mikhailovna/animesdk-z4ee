...
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFSELECTREDUCENUMBERCONFIG_METHOD_3_8EF4603CB117AF80_OFFSET UNITYSDK_OFFSET(0x1B775C10)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFSELECTREDUCENUMBERCONFIG_METHOD_3_FD0A07912EBC6E7C_OFFSET UNITYSDK_OFFSET(0x1B775C60)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFSELECTREDUCENUMBERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B775C50)
