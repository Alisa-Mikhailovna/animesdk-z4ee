...
#define RPG_GAMECORE_ENABLEDYNAMICSKILLTARGETSELECTION_METHOD_3_7ACBCB4E8A5B6C47_OFFSET UNITYSDK_OFFSET(0x1B3E3780)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLTARGETSELECTION_METHOD_3_9DDD37DC09AC858C_OFFSET UNITYSDK_OFFSET(0x1B3E37C0)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLTARGETSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E37B0)
