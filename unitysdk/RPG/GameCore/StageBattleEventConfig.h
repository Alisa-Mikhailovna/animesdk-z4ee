...
#define RPG_GAMECORE_STAGEBATTLEEVENTCONFIG_METHOD_2_8E2FC482D3B6D76A_OFFSET UNITYSDK_OFFSET(0x1B8F6E40)
#define RPG_GAMECORE_STAGEBATTLEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8F72A0)
