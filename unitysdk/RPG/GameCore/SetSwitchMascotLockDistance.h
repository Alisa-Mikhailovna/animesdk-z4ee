...
#define RPG_GAMECORE_SETSWITCHMASCOTLOCKDISTANCE_METHOD_3_2047B2CA654F55DD_OFFSET UNITYSDK_OFFSET(0x1B8B3CD0)
#define RPG_GAMECORE_SETSWITCHMASCOTLOCKDISTANCE_METHOD_3_787F2C324B5D9D3C_OFFSET UNITYSDK_OFFSET(0x1B8B3C90)
#define RPG_GAMECORE_SETSWITCHMASCOTLOCKDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B3CC0)
