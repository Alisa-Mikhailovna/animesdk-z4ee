...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEFORMULACONFIG_METHOD_3_4723B23C309C84D6_OFFSET UNITYSDK_OFFSET(0x1B7A5190)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEFORMULACONFIG_METHOD_3_E103B19E5DAD35B2_OFFSET UNITYSDK_OFFSET(0x1B7A4ED0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4EC0)
