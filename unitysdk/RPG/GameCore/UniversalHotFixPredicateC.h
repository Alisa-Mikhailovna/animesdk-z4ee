...
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_01782926F36D8F24_OFFSET UNITYSDK_OFFSET(0x1B9C3E50)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_710EC77505610642_OFFSET UNITYSDK_OFFSET(0x1B9C5DF0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_EF0D16657D89F9A6_OFFSET UNITYSDK_OFFSET(0x1B9C5DC0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_EFCB24E4A3C9E61B_OFFSET UNITYSDK_OFFSET(0x1B9C2F20)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C2F10)
