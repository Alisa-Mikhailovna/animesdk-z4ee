...
#define RPG_GAMECORE_MARBLEREMOVESKILL_METHOD_3_0261C3DE0E96E59B_OFFSET UNITYSDK_OFFSET(0x1B5BEBB0)
#define RPG_GAMECORE_MARBLEREMOVESKILL_METHOD_3_2553FE71EAEC6085_OFFSET UNITYSDK_OFFSET(0x1B5BEC10)
#define RPG_GAMECORE_MARBLEREMOVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5BEC00)
