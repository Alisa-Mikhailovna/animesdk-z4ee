...
#define RPG_GAMECORE_SETTARGETCUSTOMASSETPRELOADSTATE_METHOD_3_64BE99F0AF95A6B9_OFFSET UNITYSDK_OFFSET(0x1B8B4B20)
#define RPG_GAMECORE_SETTARGETCUSTOMASSETPRELOADSTATE_METHOD_3_D8867D1BDA29ABCE_OFFSET UNITYSDK_OFFSET(0x1B8B4BE0)
#define RPG_GAMECORE_SETTARGETCUSTOMASSETPRELOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B4B90)
