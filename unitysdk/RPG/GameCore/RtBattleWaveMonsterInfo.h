...
#define RPG_GAMECORE_RTBATTLEWAVEMONSTERINFO_METHOD_2_80F5D68A9B653765_OFFSET UNITYSDK_OFFSET(0x1B7ADE00)
#define RPG_GAMECORE_RTBATTLEWAVEMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7ADEF0)
