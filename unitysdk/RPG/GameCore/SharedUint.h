...
#define RPG_GAMECORE_SHAREDUINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B8C0D20)
#define RPG_GAMECORE_SHAREDUINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B8C0D60)
#define RPG_GAMECORE_SHAREDUINT_METHOD_3_3C21746C1F5C045E_OFFSET UNITYSDK_OFFSET(0x1B8C0BF0)
#define RPG_GAMECORE_SHAREDUINT_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1B8C0D10)
#define RPG_GAMECORE_SHAREDUINT_METHOD_3_85DECB076B86A2D9_OFFSET UNITYSDK_OFFSET(0x1B8C0C30)
#define RPG_GAMECORE_SHAREDUINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C0C20)
