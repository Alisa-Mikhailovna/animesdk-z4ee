...
#define RPG_GAMECORE_GETRUANMADECAKEPERFORMANCEID_METHOD_3_2A361B0DAED867B8_OFFSET UNITYSDK_OFFSET(0x1B4C9C50)
#define RPG_GAMECORE_GETRUANMADECAKEPERFORMANCEID_METHOD_3_C5D09739983A649B_OFFSET UNITYSDK_OFFSET(0x1B4C9C90)
#define RPG_GAMECORE_GETRUANMADECAKEPERFORMANCEID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C9C80)
