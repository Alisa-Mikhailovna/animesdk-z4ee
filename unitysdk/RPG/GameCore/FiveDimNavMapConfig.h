...
#define RPG_GAMECORE_FIVEDIMNAVMAPCONFIG_METHOD_2_D68AC7B0A176C3D4_OFFSET UNITYSDK_OFFSET(0x1B43D180)
#define RPG_GAMECORE_FIVEDIMNAVMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43D330)
