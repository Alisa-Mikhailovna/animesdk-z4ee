...
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_79F21717C46CAB7A_OFFSET UNITYSDK_OFFSET(0x1B8C8070)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_90BE7022014482EF_OFFSET UNITYSDK_OFFSET(0x1B8C8020)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C8060)
