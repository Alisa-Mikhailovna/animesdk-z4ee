...
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUECHEATDICECONFIG_METHOD_6_DD5EFF31FB87BAEA_OFFSET UNITYSDK_OFFSET(0x1B733BE0)
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUECHEATDICECONFIG_METHOD_6_EA173C5D91271546_OFFSET UNITYSDK_OFFSET(0x1B733C30)
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUECHEATDICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B733C20)
