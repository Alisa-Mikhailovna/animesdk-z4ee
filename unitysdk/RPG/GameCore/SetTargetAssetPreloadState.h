...
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_59E466552D15230E_OFFSET UNITYSDK_OFFSET(0x1B8B4350)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_748C7C2133C7497D_OFFSET UNITYSDK_OFFSET(0x1B8B4490)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B4400)
