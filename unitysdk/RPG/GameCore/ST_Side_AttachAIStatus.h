...
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_561B7EBCBC0C9E1E_OFFSET UNITYSDK_OFFSET(0x1B7E0430)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_7C4A0B5365AA36DD_OFFSET UNITYSDK_OFFSET(0x1B7E03F0)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E0420)
