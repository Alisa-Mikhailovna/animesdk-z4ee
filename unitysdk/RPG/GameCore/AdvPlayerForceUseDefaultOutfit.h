...
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT_METHOD_3_0EAC55B0C21CBABA_OFFSET UNITYSDK_OFFSET(0x1B15DF90)
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT_METHOD_3_B6CA1272C86EAAC3_OFFSET UNITYSDK_OFFSET(0x1B15E030)
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B15DFF0)
