...
#define RPG_GAMECORE_ELFGLOBALEFFECTCONFIG_METHOD_2_44ED9DD5C0C7B62B_OFFSET UNITYSDK_OFFSET(0x1B3DB210)
#define RPG_GAMECORE_ELFGLOBALEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DB340)
