...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEJOYVALUE_METHOD_3_7F100ED4CBBD02BA_OFFSET UNITYSDK_OFFSET(0x1B899C10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEJOYVALUE_METHOD_3_9D05CD8FA15ECB87_OFFSET UNITYSDK_OFFSET(0x1B899C50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEJOYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B899C40)
