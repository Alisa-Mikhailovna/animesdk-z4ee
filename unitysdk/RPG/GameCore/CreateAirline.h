...
#define RPG_GAMECORE_CREATEAIRLINE_METHOD_3_08D854CABE061C47_OFFSET UNITYSDK_OFFSET(0x1B387C10)
#define RPG_GAMECORE_CREATEAIRLINE_METHOD_3_8C0D7A5F9D8B0C6C_OFFSET UNITYSDK_OFFSET(0x1B387BD0)
#define RPG_GAMECORE_CREATEAIRLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B387C00)
