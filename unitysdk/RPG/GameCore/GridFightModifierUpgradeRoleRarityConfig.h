...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLERARITYCONFIG_METHOD_3_1C880226EFB34F27_OFFSET UNITYSDK_OFFSET(0x1B4E1C50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLERARITYCONFIG_METHOD_3_F7471D8A8A3C58A3_OFFSET UNITYSDK_OFFSET(0x1B4E1C00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLERARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E1C40)
