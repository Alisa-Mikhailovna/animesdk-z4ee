...
#define RPG_GAMECORE_ATTACHNISHASTAGAITEMTOSCENE_METHOD_3_45EC3D352790AA75_OFFSET UNITYSDK_OFFSET(0x1B1B4570)
#define RPG_GAMECORE_ATTACHNISHASTAGAITEMTOSCENE_METHOD_3_DFBE4C43E1AB49F6_OFFSET UNITYSDK_OFFSET(0x1B1B4530)
#define RPG_GAMECORE_ATTACHNISHASTAGAITEMTOSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B4560)
