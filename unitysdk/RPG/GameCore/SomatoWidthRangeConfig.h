...
#define RPG_GAMECORE_SOMATOWIDTHRANGECONFIG_METHOD_2_FF09348F965C465E_OFFSET UNITYSDK_OFFSET(0x1B8E0380)
#define RPG_GAMECORE_SOMATOWIDTHRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E04E0)
