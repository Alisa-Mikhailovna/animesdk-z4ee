...
#define RPG_GAMECORE_BASELITTLEGAMEABILITYEFFECTCONFIG_METHOD_2_47A2A1384DDA465A_OFFSET UNITYSDK_OFFSET(0x1B1ECA20)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYEFFECTCONFIG_METHOD_2_4C82FBED36025703_OFFSET UNITYSDK_OFFSET(0x1B1ECA80)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1ECAE0)
