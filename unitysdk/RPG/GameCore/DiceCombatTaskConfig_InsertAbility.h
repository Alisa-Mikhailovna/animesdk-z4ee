...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INSERTABILITY_METHOD_3_1B17AE8BA2C76C65_OFFSET UNITYSDK_OFFSET(0x1B3B7B70)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INSERTABILITY_METHOD_3_BBBE23B9D89CCC99_OFFSET UNITYSDK_OFFSET(0x1B3B7C50)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INSERTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B7C40)
