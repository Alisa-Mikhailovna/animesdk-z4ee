...
#define RPG_GAMECORE_VCAMERABLEND_METHOD_2_8D33CA9A5010063B_OFFSET UNITYSDK_OFFSET(0x1B9C8160)
#define RPG_GAMECORE_VCAMERABLEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C8600)
