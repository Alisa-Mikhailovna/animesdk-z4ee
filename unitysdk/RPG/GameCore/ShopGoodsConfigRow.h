...
#define RPG_GAMECORE_SHOPGOODSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B8C3320)
#define RPG_GAMECORE_SHOPGOODSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C4460)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsOnSale; // 0x4C
		::System::Boolean IsLimitedTimePurchase; // 0x4D
		::System::Boolean IsNew; // 0x4E
		::System::Int32 RefreshOffset; // 0x50
		...
		::RPG::GameCore::LimitType OnShelfType2; // 0x64
		::System::UInt32 LimitTimes; // 0x68
		::RPG::GameCore::LimitType LimitType2; // 0x6C
		::System::UInt32 GoodsSortID; // 0x70
		::System::UInt32 ItemCount; // 0x74
		::System::UInt32 ItemID; // 0x78
		::System::UInt32 GoodsID; // 0x7C
		::System::UInt32 TagParam; // 0x80
		::System::UInt32 ItemGroupID; // 0x84
		::System::UInt32 Level; // 0x88
		::RPG::GameCore::LimitType OnShelfType1; // 0x8C
		::System::UInt32 ScheduleDataID; // 0x90
