...
#define RPG_GAMECORE_SHOWACTIONBAREFFECT_METHOD_3_78D7ADE67CED0140_OFFSET UNITYSDK_OFFSET(0x1B8C5880)
#define RPG_GAMECORE_SHOWACTIONBAREFFECT_METHOD_3_AB89412CE31C30EA_OFFSET UNITYSDK_OFFSET(0x1B8C57C0)
#define RPG_GAMECORE_SHOWACTIONBAREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C5830)
