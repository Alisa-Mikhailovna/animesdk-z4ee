...
#define RPG_GAMECORE_ROGUEDLCBLOCKWEIGHT_METHOD_2_EB041128467ADAA0_OFFSET UNITYSDK_OFFSET(0x1B752C80)
#define RPG_GAMECORE_ROGUEDLCBLOCKWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B752DA0)
