...
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_1A5DE62F43868946_OFFSET UNITYSDK_OFFSET(0x1B7B9550)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_45583901427D1ACC_OFFSET UNITYSDK_OFFSET(0x1B7B8D10)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x1B7B9270)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1B7B92F0)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_A694B6A26398247A_OFFSET UNITYSDK_OFFSET(0x1B7B9720)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_A6A79CD8936F654D_OFFSET UNITYSDK_OFFSET(0x1B7B9380)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_ABE7CF9FA1B8CCA3_OFFSET UNITYSDK_OFFSET(0x1B7B9400)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_B74F0266CBEA732F_1_OFFSET UNITYSDK_OFFSET(0x1B7B96E0)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_B74F0266CBEA732F_OFFSET UNITYSDK_OFFSET(0x1B7B96A0)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_D83796106DF8E5C5_OFFSET UNITYSDK_OFFSET(0x1B7B9310)
#define RPG_GAMECORE_RTDEFENCECONST_METHOD_2_EC24AC00C231F088_OFFSET UNITYSDK_OFFSET(0x1B7B9670)
#define RPG_GAMECORE_RTDEFENCECONST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B91A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::RtDefenceConst**)Il2CppClass::FromTypeDefinitionIndex(RtDefenceConst_TypeDefinitionIndex)->GetStaticField(0xC940);
		}
