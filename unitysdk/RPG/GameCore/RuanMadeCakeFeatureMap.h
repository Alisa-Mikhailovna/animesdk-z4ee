...
#define RPG_GAMECORE_RUANMADECAKEFEATUREMAP_METHOD_2_979ED58C3E9AD8AB_OFFSET UNITYSDK_OFFSET(0x1B7CB350)
#define RPG_GAMECORE_RUANMADECAKEFEATUREMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7CB430)
