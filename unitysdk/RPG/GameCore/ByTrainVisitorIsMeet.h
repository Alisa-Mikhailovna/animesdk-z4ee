...
#define RPG_GAMECORE_BYTRAINVISITORISMEET_METHOD_4_0E02D54FC9FA56C8_OFFSET UNITYSDK_OFFSET(0x1B2ECAA0)
#define RPG_GAMECORE_BYTRAINVISITORISMEET_METHOD_4_1D0414B28B547B9A_OFFSET UNITYSDK_OFFSET(0x1B2EC850)
#define RPG_GAMECORE_BYTRAINVISITORISMEET_METHOD_4_46408169AA11FCC4_OFFSET UNITYSDK_OFFSET(0x1B2ECA50)
#define RPG_GAMECORE_BYTRAINVISITORISMEET_METHOD_4_C159910D9C7847B2_OFFSET UNITYSDK_OFFSET(0x1B2EC8D0)
#define RPG_GAMECORE_BYTRAINVISITORISMEET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EC8A0)
