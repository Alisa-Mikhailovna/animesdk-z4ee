...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG_METHOD_3_1BA607A2C06C7846_OFFSET UNITYSDK_OFFSET(0x1B4E07C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG_METHOD_3_1F31AE816BA500E2_OFFSET UNITYSDK_OFFSET(0x1B4E0810)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0800)
