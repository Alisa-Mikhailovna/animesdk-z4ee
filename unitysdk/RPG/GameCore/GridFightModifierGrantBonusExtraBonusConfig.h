...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGRANTBONUSEXTRABONUSCONFIG_METHOD_3_5D41807BED2E92EA_OFFSET UNITYSDK_OFFSET(0x1B4E04D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGRANTBONUSEXTRABONUSCONFIG_METHOD_3_69F9BDA782CDED46_OFFSET UNITYSDK_OFFSET(0x1B4E0520)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGRANTBONUSEXTRABONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0510)
