...
#define RPG_GAMECORE_ALLEYORDERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B19B8B0)
#define RPG_GAMECORE_ALLEYORDERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19BFF0)
