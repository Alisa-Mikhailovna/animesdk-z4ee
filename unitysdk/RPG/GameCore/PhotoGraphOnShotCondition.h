...
#define RPG_GAMECORE_PHOTOGRAPHONSHOTCONDITION_METHOD_2_EC49ABD0665ED4A0_OFFSET UNITYSDK_OFFSET(0x1B6AAA50)
#define RPG_GAMECORE_PHOTOGRAPHONSHOTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AAAE0)
