...
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_TARGETPOINT_METHOD_3_4B87BDBF1A8B9694_OFFSET UNITYSDK_OFFSET(0x1B6E08E0)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_TARGETPOINT_METHOD_3_F071B12625B78CD1_OFFSET UNITYSDK_OFFSET(0x1B6E0620)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_TARGETPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E0610)
