...
#define RPG_GAMECORE_FIXPOINTCONST_METHOD_2_CD062CAC029D740A_OFFSET UNITYSDK_OFFSET(0x1B44FBC0)
#define RPG_GAMECORE_FIXPOINTCONST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44FCF0)
