...
#define RPG_GAMECORE_DYNAMICVALUERANGEGROUP_METHOD_2_A6DD6CE5877AAB42_OFFSET UNITYSDK_OFFSET(0x1B3D21C0)
#define RPG_GAMECORE_DYNAMICVALUERANGEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D2370)
