...
#define RPG_GAMECORE_ENTITYMODELASSETINFO_METHOD_2_7B001AC17ECBAF98_OFFSET UNITYSDK_OFFSET(0x1B3ECCE0)
#define RPG_GAMECORE_ENTITYMODELASSETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3ECD20)
