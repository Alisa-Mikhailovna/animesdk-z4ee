...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEDIFFCOUNT_METHOD_3_5A1FF4057D9E81B7_OFFSET UNITYSDK_OFFSET(0x1B3A9DA0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEDIFFCOUNT_METHOD_3_DE7FE5750B59D4C6_OFFSET UNITYSDK_OFFSET(0x1B3AA890)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEDIFFCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A9D90)
