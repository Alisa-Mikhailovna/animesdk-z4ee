...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFORMULAACTIVESTATECHANGECONFIG_METHOD_3_0D73E180C0FBF9B5_OFFSET UNITYSDK_OFFSET(0x1B775070)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFORMULAACTIVESTATECHANGECONFIG_METHOD_3_67FF489FFE2C42B9_OFFSET UNITYSDK_OFFSET(0x1B7750C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFORMULAACTIVESTATECHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7750B0)
