...
#define RPG_GAMECORE_SETSKILLBUTTONADDITIONALSTATUS_METHOD_3_CEA490B1DD4C2143_OFFSET UNITYSDK_OFFSET(0x1B8B11C0)
#define RPG_GAMECORE_SETSKILLBUTTONADDITIONALSTATUS_METHOD_3_FB889FDC6EDEE219_OFFSET UNITYSDK_OFFSET(0x1B8B1260)
#define RPG_GAMECORE_SETSKILLBUTTONADDITIONALSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B1220)
