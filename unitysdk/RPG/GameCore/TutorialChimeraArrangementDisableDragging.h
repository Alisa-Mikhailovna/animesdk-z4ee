...
#define RPG_GAMECORE_TUTORIALCHIMERAARRANGEMENTDISABLEDRAGGING_METHOD_3_170561BABF8E5088_OFFSET UNITYSDK_OFFSET(0x1B9B4BA0)
#define RPG_GAMECORE_TUTORIALCHIMERAARRANGEMENTDISABLEDRAGGING_METHOD_3_E701BDBE178CF86B_OFFSET UNITYSDK_OFFSET(0x1B9B4B50)
#define RPG_GAMECORE_TUTORIALCHIMERAARRANGEMENTDISABLEDRAGGING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B4B90)
