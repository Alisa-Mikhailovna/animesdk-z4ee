...
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_091955F44F6A0038_OFFSET UNITYSDK_OFFSET(0x1B2D8CB0)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_B61411D24DA6E94B_OFFSET UNITYSDK_OFFSET(0x1B2D8CF0)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_CDCFCCC98E039071_OFFSET UNITYSDK_OFFSET(0x1B2D8E30)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_EF7941BB3124AEA8_OFFSET UNITYSDK_OFFSET(0x1B2D8E60)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D8CE0)
