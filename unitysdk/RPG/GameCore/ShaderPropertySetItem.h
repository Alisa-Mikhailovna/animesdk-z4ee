...
#define RPG_GAMECORE_SHADERPROPERTYSETITEM_METHOD_2_A6F6CFB03A0047CF_OFFSET UNITYSDK_OFFSET(0x1B8BE2C0)
#define RPG_GAMECORE_SHADERPROPERTYSETITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8BE4D0)
