...
#define RPG_GAMECORE_IDLELIVENODEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B527D30)
#define RPG_GAMECORE_IDLELIVENODEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5283B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint TimeLimitRankS; // 0x40
		::System::Boolean CanTriggerAmphoreusBuff; // 0x48
		::System::Boolean IsAutoNextNode; // 0x49
		::System::UInt32 ChapterIndex; // 0x4C
		::System::UInt32 CrystalPerHour; // 0x50
		::System::UInt32 Index; // 0x54
		::System::UInt32 ChestLevel; // 0x58
		::System::UInt32 BossID; // 0x5C
		::System::UInt32 TicketPerHour; // 0x60
		::System::UInt32 ChestPerHour; // 0x64
		::System::UInt32 EmojiPhaseID; // 0x68
		::System::UInt32 LiveRoomExpGainOnFinished; // 0x6C
