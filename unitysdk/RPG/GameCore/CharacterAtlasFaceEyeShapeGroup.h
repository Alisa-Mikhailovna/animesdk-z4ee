...
#define RPG_GAMECORE_CHARACTERATLASFACEEYESHAPEGROUP_METHOD_2_58785B5A8BFEE495_OFFSET UNITYSDK_OFFSET(0x1B313430)
#define RPG_GAMECORE_CHARACTERATLASFACEEYESHAPEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3134F0)
