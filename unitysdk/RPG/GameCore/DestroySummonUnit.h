...
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_AA2778B6E37F7884_OFFSET UNITYSDK_OFFSET(0x1B3A2DE0)
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_DDE39ACCC4274351_OFFSET UNITYSDK_OFFSET(0x1B3A2E20)
#define RPG_GAMECORE_DESTROYSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A2E10)
