...
#define RPG_GAMECORE_IVEC2_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A08A50)
#define RPG_GAMECORE_IVEC2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A08A40)
#define RPG_GAMECORE_IVEC2_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x1BAF9DE0)
#define RPG_GAMECORE_IVEC2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3A08800)
#define RPG_GAMECORE_IVEC2_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x1BAF9DF0)
#define RPG_GAMECORE_IVEC2_GET_ONE_OFFSET UNITYSDK_OFFSET(0x1BAF9DC0)
#define RPG_GAMECORE_IVEC2_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1BAF9E00)
#define RPG_GAMECORE_IVEC2_GET_UP_OFFSET UNITYSDK_OFFSET(0x1BAF9DD0)
#define RPG_GAMECORE_IVEC2_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1BAF9DB0)
#define RPG_GAMECORE_IVEC2_METHOD_2_024C03B35BA7E8CB_1_OFFSET UNITYSDK_OFFSET(0x1BAF9D70)
#define RPG_GAMECORE_IVEC2_METHOD_2_024C03B35BA7E8CB_OFFSET UNITYSDK_OFFSET(0x1BAF9D60)
#define RPG_GAMECORE_IVEC2_METHOD_2_11C163D56F5D9DA9_1_OFFSET UNITYSDK_OFFSET(0x1BAF9C20)
#define RPG_GAMECORE_IVEC2_METHOD_2_11C163D56F5D9DA9_2_OFFSET UNITYSDK_OFFSET(0x1BAF9C90)
#define RPG_GAMECORE_IVEC2_METHOD_2_11C163D56F5D9DA9_3_OFFSET UNITYSDK_OFFSET(0x1BAF9CB0)
#define RPG_GAMECORE_IVEC2_METHOD_2_11C163D56F5D9DA9_OFFSET UNITYSDK_OFFSET(0x1BAF9BE0)
#define RPG_GAMECORE_IVEC2_METHOD_2_3051A2902CE8D9BA_OFFSET UNITYSDK_OFFSET(0x1BAF9D80)
#define RPG_GAMECORE_IVEC2_METHOD_2_3F8D159D821A0AF1_1_OFFSET UNITYSDK_OFFSET(0x1BAF9D10)
#define RPG_GAMECORE_IVEC2_METHOD_2_3F8D159D821A0AF1_2_OFFSET UNITYSDK_OFFSET(0x1BAF9D30)
#define RPG_GAMECORE_IVEC2_METHOD_2_3F8D159D821A0AF1_OFFSET UNITYSDK_OFFSET(0x1BAF9CF0)
#define RPG_GAMECORE_IVEC2_METHOD_2_66B1445F39DF8265_1_OFFSET UNITYSDK_OFFSET(0x1BAF9CD0)
#define RPG_GAMECORE_IVEC2_METHOD_2_66B1445F39DF8265_OFFSET UNITYSDK_OFFSET(0x1BAF9C60)
#define RPG_GAMECORE_IVEC2_METHOD_2_970B895AF1841F3E_OFFSET UNITYSDK_OFFSET(0x7BDC0)
#define RPG_GAMECORE_IVEC2_METHOD_2_D0F004595ECA8F03_OFFSET UNITYSDK_OFFSET(0x1BAF9D90)
#define RPG_GAMECORE_IVEC2_METHOD_2_F12688DACEC2651B_OFFSET UNITYSDK_OFFSET(0x3A089A0)
#define RPG_GAMECORE_IVEC2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x3A08880)
#define RPG_GAMECORE_IVEC2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A08900)
#define RPG_GAMECORE_IVEC2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BAF9E10)
#define RPG_GAMECORE_IVEC2__CTOR_OFFSET UNITYSDK_OFFSET(0x7BDC0)
...
namespace RPG::GameCore
{
	...
	struct alignas(4) IVec2
	{
		...
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0x3BA0);
		}
		static ::RPG::GameCore::IVec2* StaticGet_rightVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0x3BA8);
		}
		static ::RPG::GameCore::IVec2* StaticGet_leftVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0x3BB0);
		}
		static ::RPG::GameCore::IVec2* StaticGet_upVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0x3BB8);
		}
		static ::RPG::GameCore::IVec2* StaticGet_zeroVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0x3BC0);
		}
		static ::RPG::GameCore::IVec2* StaticGet_downVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0x3BC8);
		}
		::System::Int32 x; // 0x10
		::System::Int32 y; // 0x14
