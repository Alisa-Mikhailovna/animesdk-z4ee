...
#define RPG_GAMECORE_IDLELIVETASKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B52B490)
#define RPG_GAMECORE_IDLELIVETASKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B52B690)
