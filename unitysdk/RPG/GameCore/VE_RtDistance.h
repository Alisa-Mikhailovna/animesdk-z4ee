...
#define RPG_GAMECORE_VE_RTDISTANCE_METHOD_3_4B3BC8ABF290F6B9_OFFSET UNITYSDK_OFFSET(0x1B9D4740)
#define RPG_GAMECORE_VE_RTDISTANCE_METHOD_3_E8355CC3AEC1C07A_OFFSET UNITYSDK_OFFSET(0x1B9D4580)
#define RPG_GAMECORE_VE_RTDISTANCE_METHOD_3_F07FDD403E6930A3_OFFSET UNITYSDK_OFFSET(0x1B9D4540)
#define RPG_GAMECORE_VE_RTDISTANCE_METHOD_3_FBCA8F805CAE44FE_OFFSET UNITYSDK_OFFSET(0x1B9D4770)
#define RPG_GAMECORE_VE_RTDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D4570)
