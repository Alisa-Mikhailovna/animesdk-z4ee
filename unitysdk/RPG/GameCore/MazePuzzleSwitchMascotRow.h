...
#define RPG_GAMECORE_MAZEPUZZLESWITCHMASCOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5E7DB0)
#define RPG_GAMECORE_MAZEPUZZLESWITCHMASCOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E8190)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_13*>* CoinPropID; // 0x28
		::Il2CppArray<::System::UInt32>* EntryBlackHoleID; // 0x30
		::Il2CppArray<::Class_1_ADE34076259CCCF7_2*>* Section2LoadEntityList; // 0x38
		::Il2CppArray<::Class_1_ADE34076259CCCF7_2*>* Section3LoadEntityList; // 0x40
