...
#define RPG_GAMECORE_HELIOBUSPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B50B2E0)
#define RPG_GAMECORE_HELIOBUSPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B50BBF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID PhaseTextID; // 0x28
		::System::UInt32 ReceiveMissionID; // 0x38
		::System::UInt32 PhaseFans; // 0x3C
		::RPG::Client::TextID Heliobus_ToDoListTitle_After; // 0x40
		::RPG::Client::TextID Heliobus_UpMissionDesc; // 0x50
		::RPG::Client::TextID Heliobus_ToDoListTitle_Before; // 0x60
