...
#define RPG_GAMECORE_SETTARGETTYPENOTIFYCONFIG_METHOD_2_F18C2B5E0F736C1D_OFFSET UNITYSDK_OFFSET(0x1B8B6280)
#define RPG_GAMECORE_SETTARGETTYPENOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B6340)
