...
#define RPG_GAMECORE_ROGUEBONUSEVENTCONFIG_METHOD_2_79ACCB5B16BFC955_OFFSET UNITYSDK_OFFSET(0x1B741C00)
#define RPG_GAMECORE_ROGUEBONUSEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B741C40)
