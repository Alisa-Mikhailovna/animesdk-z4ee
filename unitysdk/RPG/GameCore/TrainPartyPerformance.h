...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCE_METHOD_2_484F6C1C98F2D5BC_OFFSET UNITYSDK_OFFSET(0x1B982B80)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B982D20)
