...
#define RPG_GAMECORE_CLOCKPARKSTORYANIMSTATE_METHOD_2_695C3785DD7A4DD5_OFFSET UNITYSDK_OFFSET(0x1B36AFE0)
#define RPG_GAMECORE_CLOCKPARKSTORYANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B36B110)
