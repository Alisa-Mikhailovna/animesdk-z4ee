...
#define RPG_GAMECORE_WAITANDPROCESSBATTLERESULT_METHOD_3_0300DDA5851E8C07_OFFSET UNITYSDK_OFFSET(0x1B9E1880)
#define RPG_GAMECORE_WAITANDPROCESSBATTLERESULT_METHOD_3_E749A11885C0346A_OFFSET UNITYSDK_OFFSET(0x1B9E17B0)
#define RPG_GAMECORE_WAITANDPROCESSBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E1870)
