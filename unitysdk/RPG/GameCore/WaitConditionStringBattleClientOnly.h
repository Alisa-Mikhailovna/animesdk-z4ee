...
#define RPG_GAMECORE_WAITCONDITIONSTRINGBATTLECLIENTONLY_METHOD_4_81DEE13FFFCBF643_OFFSET UNITYSDK_OFFSET(0x1B9E3980)
#define RPG_GAMECORE_WAITCONDITIONSTRINGBATTLECLIENTONLY_METHOD_4_CB8A9BEA08F80DF0_OFFSET UNITYSDK_OFFSET(0x1B9E3800)
#define RPG_GAMECORE_WAITCONDITIONSTRINGBATTLECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E37F0)
