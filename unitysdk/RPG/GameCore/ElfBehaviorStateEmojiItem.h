...
#define RPG_GAMECORE_ELFBEHAVIORSTATEEMOJIITEM_METHOD_3_2361D5516A59DB31_OFFSET UNITYSDK_OFFSET(0x1B3D8D60)
#define RPG_GAMECORE_ELFBEHAVIORSTATEEMOJIITEM_METHOD_3_80A75FB46BDEA159_OFFSET UNITYSDK_OFFSET(0x1B3D8FA0)
#define RPG_GAMECORE_ELFBEHAVIORSTATEEMOJIITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D8D50)
