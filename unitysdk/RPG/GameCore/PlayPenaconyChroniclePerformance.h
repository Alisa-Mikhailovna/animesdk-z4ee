...
#define RPG_GAMECORE_PLAYPENACONYCHRONICLEPERFORMANCE_METHOD_3_28766F2E9949F0B4_OFFSET UNITYSDK_OFFSET(0x1B6C8A70)
#define RPG_GAMECORE_PLAYPENACONYCHRONICLEPERFORMANCE_METHOD_3_44DD3ADED33DD3BD_OFFSET UNITYSDK_OFFSET(0x1B6C8A30)
#define RPG_GAMECORE_PLAYPENACONYCHRONICLEPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C8A60)
