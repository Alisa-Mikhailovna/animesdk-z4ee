...
#define RPG_GAMECORE_ELFPROPERTYMODIFIER_METHOD_2_0693FB6B704123DC_OFFSET UNITYSDK_OFFSET(0x1B3DC560)
#define RPG_GAMECORE_ELFPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DC6F0)
