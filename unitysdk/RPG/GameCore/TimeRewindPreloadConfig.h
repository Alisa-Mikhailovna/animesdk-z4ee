...
#define RPG_GAMECORE_TIMEREWINDPRELOADCONFIG_METHOD_2_BBCF7B323B3A8579_OFFSET UNITYSDK_OFFSET(0x1B974160)
#define RPG_GAMECORE_TIMEREWINDPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9742B0)
