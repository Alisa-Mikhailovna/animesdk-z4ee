...
#define RPG_GAMECORE_WHITELISTINTERACTREPORTITEM_METHOD_2_5653EEC451F9F990_OFFSET UNITYSDK_OFFSET(0x1B9F5600)
#define RPG_GAMECORE_WHITELISTINTERACTREPORTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F5770)
