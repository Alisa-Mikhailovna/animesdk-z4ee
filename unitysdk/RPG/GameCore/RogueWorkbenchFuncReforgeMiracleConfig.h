...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMIRACLECONFIG_METHOD_3_25EC4DE6EFC8A90B_OFFSET UNITYSDK_OFFSET(0x1B7A5250)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMIRACLECONFIG_METHOD_3_D2055A028991B10F_OFFSET UNITYSDK_OFFSET(0x1B7A4F30)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4F20)
