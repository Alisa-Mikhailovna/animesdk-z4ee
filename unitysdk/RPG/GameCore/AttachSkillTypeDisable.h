...
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE_METHOD_3_BAEA28A9D337621A_OFFSET UNITYSDK_OFFSET(0x1B1B4D20)
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE_METHOD_3_F38301C9D9B7CF9A_OFFSET UNITYSDK_OFFSET(0x1B1B4CE0)
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B4D10)
