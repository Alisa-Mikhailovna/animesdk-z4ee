...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSETGOLDNUMPARAM_METHOD_2_95599F5F0732F94D_OFFSET UNITYSDK_OFFSET(0x1B4E6860)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSETGOLDNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E6B20)
