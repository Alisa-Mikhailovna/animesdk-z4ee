...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ADDPHYSICALFORCE_METHOD_3_5C57FB614F6FC6A6_OFFSET UNITYSDK_OFFSET(0x1B3281C0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ADDPHYSICALFORCE_METHOD_3_CDF3693EE0A0F9DC_OFFSET UNITYSDK_OFFSET(0x1B328160)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ADDPHYSICALFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3281B0)
