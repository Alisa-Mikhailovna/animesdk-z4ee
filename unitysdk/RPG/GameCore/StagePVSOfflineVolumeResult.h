...
#define RPG_GAMECORE_STAGEPVSOFFLINEVOLUMERESULT_METHOD_2_D632BA74E4200C03_OFFSET UNITYSDK_OFFSET(0x1B8FF9F0)
#define RPG_GAMECORE_STAGEPVSOFFLINEVOLUMERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8FFBF0)
