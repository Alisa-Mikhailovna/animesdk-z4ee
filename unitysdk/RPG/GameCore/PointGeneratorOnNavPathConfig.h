...
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_CD9A4F61F5B63703_OFFSET UNITYSDK_OFFSET(0x1B6D6A30)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_ECCBF057757545FD_OFFSET UNITYSDK_OFFSET(0x1B6D6880)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D6860)
