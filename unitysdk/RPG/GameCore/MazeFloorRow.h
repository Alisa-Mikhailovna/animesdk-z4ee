...
#define RPG_GAMECORE_MAZEFLOORROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5DFAE0)
#define RPG_GAMECORE_MAZEFLOORROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E0510)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::String*>* FloorTag; // 0x20
		::System::String* FloorDefaultEmotion; // 0x28
		::System::String* FloorBGMBusyStateName; // 0x30
		::System::String* OptionalLoadBlocksConfig; // 0x38
		...
		::System::String* CombatBGMLow; // 0x60
		::Il2CppArray<::System::String*>* ExitAudioEvent; // 0x68
