...
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_234F2B7F1D6579F9_OFFSET UNITYSDK_OFFSET(0x1B7C9AF0)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_4A23325FFE6775EA_OFFSET UNITYSDK_OFFSET(0x1B7C99F0)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_73A4C0EDB78FB43D_OFFSET UNITYSDK_OFFSET(0x1B7C9B30)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_B478714DE88136CB_OFFSET UNITYSDK_OFFSET(0x1B7C9A90)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C9A80)
