...
#define RPG_GAMECORE_PHOTOGRAPHFREESTYLECONFIG_METHOD_2_809EA9D54C0FF098_OFFSET UNITYSDK_OFFSET(0x1B6A9D00)
#define RPG_GAMECORE_PHOTOGRAPHFREESTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A9DC0)
