...
#define RPG_GAMECORE_FREESTYLEOBSOLETEMOTIONCONFIG_METHOD_2_BB0767FE64D78528_OFFSET UNITYSDK_OFFSET(0x1B4A1920)
#define RPG_GAMECORE_FREESTYLEOBSOLETEMOTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A1960)
