...
#define RPG_GAMECORE_MARKAWARDTARGETUSED_METHOD_3_908137597B01E721_OFFSET UNITYSDK_OFFSET(0x1B5C2790)
#define RPG_GAMECORE_MARKAWARDTARGETUSED_METHOD_3_EFB8BF158325FDA4_OFFSET UNITYSDK_OFFSET(0x1B5C26C0)
#define RPG_GAMECORE_MARKAWARDTARGETUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C2780)
