...
#define RPG_GAMECORE_SPRITEPRESETNAMELIST_METHOD_2_47D407819B81FB41_OFFSET UNITYSDK_OFFSET(0x1B8F0980)
#define RPG_GAMECORE_SPRITEPRESETNAMELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8F0A70)
