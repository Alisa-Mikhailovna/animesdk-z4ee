...
#define RPG_GAMECORE_PLAYSCREENDISSOLVE_METHOD_3_154FE77CFDE2D85C_OFFSET UNITYSDK_OFFSET(0x1B6C9E80)
#define RPG_GAMECORE_PLAYSCREENDISSOLVE_METHOD_3_EEBBF682BF692AC3_OFFSET UNITYSDK_OFFSET(0x1B6C9EC0)
#define RPG_GAMECORE_PLAYSCREENDISSOLVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C9EB0)
