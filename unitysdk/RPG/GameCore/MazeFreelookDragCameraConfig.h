...
#define RPG_GAMECORE_MAZEFREELOOKDRAGCAMERACONFIG_METHOD_2_CB2D905488FF5CFD_OFFSET UNITYSDK_OFFSET(0x1B5DDFE0)
#define RPG_GAMECORE_MAZEFREELOOKDRAGCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E0660)
