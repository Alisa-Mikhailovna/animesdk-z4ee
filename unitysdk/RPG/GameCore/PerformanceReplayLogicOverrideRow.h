...
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B69B2F0)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B69B910)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B69B260)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B69B2C0)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B69BF70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_927AEEA01B635CB6_2*>* OverridePropState; // 0x18
		...
		::System::UInt32 IsOverrideDeactiveGroupFlag; // 0x40
		::System::UInt32 IsOverridePropStateFlag; // 0x44
		::System::UInt32 OverrideIsBranch; // 0x48
		...
		::RPG::GameCore::ELevelPerformanceType PerformanceType; // 0x60
