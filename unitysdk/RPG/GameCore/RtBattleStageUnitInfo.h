...
#define RPG_GAMECORE_RTBATTLESTAGEUNITINFO_METHOD_2_C6589F5F0081613F_OFFSET UNITYSDK_OFFSET(0x1B7AC8C0)
#define RPG_GAMECORE_RTBATTLESTAGEUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7ACB70)
