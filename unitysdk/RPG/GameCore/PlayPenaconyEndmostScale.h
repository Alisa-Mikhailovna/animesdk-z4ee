...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSCALE_METHOD_3_61D147E37450769A_OFFSET UNITYSDK_OFFSET(0x1B6C9010)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSCALE_METHOD_3_C2024F7DAFA645CD_OFFSET UNITYSDK_OFFSET(0x1B6C9050)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C9040)
