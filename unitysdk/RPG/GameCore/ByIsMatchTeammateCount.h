...
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_361C9DF326070109_OFFSET UNITYSDK_OFFSET(0x1B2C7B60)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_5EE233099D404824_OFFSET UNITYSDK_OFFSET(0x1B2C7930)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_8A2E038ADEDEB1A6_OFFSET UNITYSDK_OFFSET(0x1B2C7BA0)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_D538136C86468979_OFFSET UNITYSDK_OFFSET(0x1B2C78E0)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C7920)
