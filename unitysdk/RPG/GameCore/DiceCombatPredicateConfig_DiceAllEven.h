...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEALLEVEN_METHOD_4_803C741CB95AEFC5_OFFSET UNITYSDK_OFFSET(0x1B3B1EA0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEALLEVEN_METHOD_4_ACE41D687D079C46_OFFSET UNITYSDK_OFFSET(0x1B3B4CD0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEALLEVEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B1E90)
