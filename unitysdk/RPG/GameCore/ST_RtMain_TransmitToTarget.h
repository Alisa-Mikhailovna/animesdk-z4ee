...
#define RPG_GAMECORE_ST_RTMAIN_TRANSMITTOTARGET_METHOD_4_B3EF8C2F846C181F_OFFSET UNITYSDK_OFFSET(0x1B7DFE60)
#define RPG_GAMECORE_ST_RTMAIN_TRANSMITTOTARGET_METHOD_4_EA322619610C8384_OFFSET UNITYSDK_OFFSET(0x1B7DFE20)
#define RPG_GAMECORE_ST_RTMAIN_TRANSMITTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7DFE50)
