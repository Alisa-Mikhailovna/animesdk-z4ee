...
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_CLEAR_OFFSET UNITYSDK_OFFSET(0xDADCE10)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xDADCF00)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADCEB0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADCE60)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xDADCF40)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_INIT_OFFSET UNITYSDK_OFFSET(0xDADCDB0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END__CTOR_OFFSET UNITYSDK_OFFSET(0xDADCF80)
