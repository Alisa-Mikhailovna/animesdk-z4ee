...
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xDADD170)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADD120)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADD0D0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xDADD1B0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END__CTOR_OFFSET UNITYSDK_OFFSET(0xDADD0C0)
