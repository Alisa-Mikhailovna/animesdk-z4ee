...
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_6FCCA23DB96CDE5E_OFFSET UNITYSDK_OFFSET(0x1B2A4C30)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_A00C8E5588B4B7A2_OFFSET UNITYSDK_OFFSET(0x1B2A54E0)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_A5BDB866A2649BAF_OFFSET UNITYSDK_OFFSET(0x1B2A54B0)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_AF1FDDE21D09BB84_OFFSET UNITYSDK_OFFSET(0x1B2A5480)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A4C20)
