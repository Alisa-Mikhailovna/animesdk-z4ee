...
#define RPG_GAMECORE_GAMELEVELHEARTDIALNPCCONFIG_METHOD_2_33BD625E2E822DB2_OFFSET UNITYSDK_OFFSET(0x1B4C2D60)
#define RPG_GAMECORE_GAMELEVELHEARTDIALNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C2EA0)
