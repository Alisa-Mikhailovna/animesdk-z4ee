...
#define RPG_GAMECORE_CAKERACEGAMESCENECONFIG_METHOD_2_2D2DAD87552E8596_OFFSET UNITYSDK_OFFSET(0x1B2F9F10)
#define RPG_GAMECORE_CAKERACEGAMESCENECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FA520)
