...
#define RPG_GAMECORE_INCLINATIONTEXTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B530750)
#define RPG_GAMECORE_INCLINATIONTEXTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B530900)
