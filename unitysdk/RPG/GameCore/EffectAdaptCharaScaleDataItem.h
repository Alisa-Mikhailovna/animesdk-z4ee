...
#define RPG_GAMECORE_EFFECTADAPTCHARASCALEDATAITEM_METHOD_2_F00076090E402343_OFFSET UNITYSDK_OFFSET(0x1B3D3CB0)
#define RPG_GAMECORE_EFFECTADAPTCHARASCALEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D3E10)
