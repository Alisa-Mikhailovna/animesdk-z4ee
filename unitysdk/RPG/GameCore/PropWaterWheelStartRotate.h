...
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE_METHOD_3_78259B6F756C5BFA_OFFSET UNITYSDK_OFFSET(0x1B6F3B80)
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE_METHOD_3_D7ECAC382C05D40C_OFFSET UNITYSDK_OFFSET(0x1B6F3C90)
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F3BC0)
