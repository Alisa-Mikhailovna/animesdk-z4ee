...
#define RPG_GAMECORE_MESSAGESECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5F5C90)
#define RPG_GAMECORE_MESSAGESECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F5E50)
