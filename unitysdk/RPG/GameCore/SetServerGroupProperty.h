...
#define RPG_GAMECORE_SETSERVERGROUPPROPERTY_METHOD_3_60F86F947DAC5D9D_OFFSET UNITYSDK_OFFSET(0x1B8B0C80)
#define RPG_GAMECORE_SETSERVERGROUPPROPERTY_METHOD_3_EC4C29FEE0022790_OFFSET UNITYSDK_OFFSET(0x1B8B0CC0)
#define RPG_GAMECORE_SETSERVERGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B0CB0)
