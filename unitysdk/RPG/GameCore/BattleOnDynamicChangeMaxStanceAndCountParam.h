...
#define RPG_GAMECORE_BATTLEONDYNAMICCHANGEMAXSTANCEANDCOUNTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD9BC7B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Int32 OldCount; // 0x28
		::System::Int32 NewCount; // 0x2C
