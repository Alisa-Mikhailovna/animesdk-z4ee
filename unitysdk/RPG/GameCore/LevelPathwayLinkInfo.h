...
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO_METHOD_2_1E24738387669A54_OFFSET UNITYSDK_OFFSET(0x1B56C0A0)
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B56C190)
