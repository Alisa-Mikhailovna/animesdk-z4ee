...
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEB_METHOD_5_1A4D173DE79DE4C7_OFFSET UNITYSDK_OFFSET(0x1B9C57A0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEB_METHOD_5_221F47270C0C12DA_OFFSET UNITYSDK_OFFSET(0x1B9C2D00)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEB_METHOD_5_48D53956F839A05B_OFFSET UNITYSDK_OFFSET(0x1B9C3E20)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEB_METHOD_5_9578176E03FDE13D_OFFSET UNITYSDK_OFFSET(0x1B9C57D0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEB__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C2CF0)
