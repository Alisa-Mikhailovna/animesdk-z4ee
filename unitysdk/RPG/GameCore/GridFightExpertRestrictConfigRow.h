...
#define RPG_GAMECORE_GRIDFIGHTEXPERTRESTRICTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4DC150)
#define RPG_GAMECORE_GRIDFIGHTEXPERTRESTRICTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DC340)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OCSection; // 0x14
		::System::UInt32 Chapter; // 0x18
		::System::UInt32 OCChapter; // 0x1C
