...
#define RPG_GAMECORE_PINGPONGPROJECTILEINFO_METHOD_2_03FE1EC9F9161203_OFFSET UNITYSDK_OFFSET(0x1B6B1760)
#define RPG_GAMECORE_PINGPONGPROJECTILEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B1A40)
