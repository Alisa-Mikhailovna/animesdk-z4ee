...
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER_METHOD_4_3824804D8057BDBB_OFFSET UNITYSDK_OFFSET(0x1B2E6340)
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER_METHOD_4_BBE564B0CDBAEBF2_OFFSET UNITYSDK_OFFSET(0x1B2E6300)
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER_METHOD_4_CE77DE8BE6C3F0D7_OFFSET UNITYSDK_OFFSET(0x1B2E6500)
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER_METHOD_4_F6B64CC094B21729_OFFSET UNITYSDK_OFFSET(0x1B2E6530)
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2E6330)
