...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGETRECOMMENDEQUIPTEMPBEFOREBATTLEBEGINCONFIG_METHOD_3_0A172C45C3C57940_OFFSET UNITYSDK_OFFSET(0x1B4E04C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGETRECOMMENDEQUIPTEMPBEFOREBATTLEBEGINCONFIG_METHOD_3_3FFC3CABC043CA84_OFFSET UNITYSDK_OFFSET(0x1B4E0470)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGETRECOMMENDEQUIPTEMPBEFOREBATTLEBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E04B0)
