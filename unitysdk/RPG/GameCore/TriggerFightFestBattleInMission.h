...
#define RPG_GAMECORE_TRIGGERFIGHTFESTBATTLEINMISSION_METHOD_3_743CFF82AA3A825F_OFFSET UNITYSDK_OFFSET(0x1B9A30B0)
#define RPG_GAMECORE_TRIGGERFIGHTFESTBATTLEINMISSION_METHOD_3_C6710AA0C49F25A2_OFFSET UNITYSDK_OFFSET(0x1B9A3180)
#define RPG_GAMECORE_TRIGGERFIGHTFESTBATTLEINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A3170)
