...
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_C0764E11C7AFAF25_OFFSET UNITYSDK_OFFSET(0x1B8C5AA0)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_DE2037151DF4A5EC_OFFSET UNITYSDK_OFFSET(0x1B8C5AE0)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C5AD0)
