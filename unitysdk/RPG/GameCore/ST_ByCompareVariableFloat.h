...
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEFLOAT_METHOD_4_2E68B4FB8D55B01B_OFFSET UNITYSDK_OFFSET(0x1B7D0590)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEFLOAT_METHOD_4_9BCC1CA0A340D91E_OFFSET UNITYSDK_OFFSET(0x1B7D05D0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEFLOAT_METHOD_4_C97A516F06CBE0A1_OFFSET UNITYSDK_OFFSET(0x1B7D0850)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEFLOAT_METHOD_4_DC6E9716B650C2DE_OFFSET UNITYSDK_OFFSET(0x1B7D0820)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D05C0)
