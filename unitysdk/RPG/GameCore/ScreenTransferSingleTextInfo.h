...
#define RPG_GAMECORE_SCREENTRANSFERSINGLETEXTINFO_METHOD_2_49887C9D43397F2E_OFFSET UNITYSDK_OFFSET(0x1B87C180)
#define RPG_GAMECORE_SCREENTRANSFERSINGLETEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B87C220)
