...
#define RPG_GAMECORE_ANIMATORSTATEZONECONFIG_METHOD_2_11610B9E46F2D0AE_OFFSET UNITYSDK_OFFSET(0x1B1A6050)
#define RPG_GAMECORE_ANIMATORSTATEZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A75F0)
