...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMROLEDELAYGRANTCONFIG_METHOD_3_2BAF99C68591B6DA_OFFSET UNITYSDK_OFFSET(0x1B4E0BE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMROLEDELAYGRANTCONFIG_METHOD_3_BC7A90225175AF36_OFFSET UNITYSDK_OFFSET(0x1B4E0C30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMROLEDELAYGRANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0C20)
