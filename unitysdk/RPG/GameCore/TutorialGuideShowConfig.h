...
#define RPG_GAMECORE_TUTORIALGUIDESHOWCONFIG_METHOD_2_66F0C317C5EE65D5_OFFSET UNITYSDK_OFFSET(0x1B9B9A40)
#define RPG_GAMECORE_TUTORIALGUIDESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B9C50)
