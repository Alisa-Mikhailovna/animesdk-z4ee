...
#define RPG_GAMECORE_WAITCUSTOMSTRING_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x1B9E3FC0)
#define RPG_GAMECORE_WAITCUSTOMSTRING_METHOD_3_566AB8B75D620003_OFFSET UNITYSDK_OFFSET(0x1B9E39B0)
#define RPG_GAMECORE_WAITCUSTOMSTRING_METHOD_3_CA89EF70B6C7BF4C_OFFSET UNITYSDK_OFFSET(0x1B9E3B70)
#define RPG_GAMECORE_WAITCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BD560)
