...
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_354CF2D574C870DD_OFFSET UNITYSDK_OFFSET(0x1B954A30)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_8BB250EA873004F8_OFFSET UNITYSDK_OFFSET(0x1B954AD0)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_F7264EC819675EFE_OFFSET UNITYSDK_OFFSET(0x1B954B30)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_FE2E24B2B7ADF2BA_OFFSET UNITYSDK_OFFSET(0x1B954B70)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B954AC0)
