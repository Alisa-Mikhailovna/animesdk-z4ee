...
#define RPG_GAMECORE_CHENLINGAISMOOTHCONFIG_METHOD_2_5397766EC142C9B4_OFFSET UNITYSDK_OFFSET(0x1B326B80)
#define RPG_GAMECORE_CHENLINGAISMOOTHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B326DF0)
