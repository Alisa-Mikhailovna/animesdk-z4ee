...
#define RPG_GAMECORE_ROGUETOURNHEXAVATARBASETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B79B5F0)
#define RPG_GAMECORE_ROGUETOURNHEXAVATARBASETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79BC50)
