...
#define RPG_GAMECORE_LEVELSELECTBUFFCONFIRM_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADABA0)
#define RPG_GAMECORE_LEVELSELECTBUFFCONFIRM_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADAB50)
#define RPG_GAMECORE_LEVELSELECTBUFFCONFIRM_INIT_OFFSET UNITYSDK_OFFSET(0xDADAB00)
#define RPG_GAMECORE_LEVELSELECTBUFFCONFIRM__CTOR_OFFSET UNITYSDK_OFFSET(0xDADABF0)
