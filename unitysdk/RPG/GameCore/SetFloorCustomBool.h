...
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_72CD4A82AB0E99A1_OFFSET UNITYSDK_OFFSET(0x1B8A3690)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_B6C414C0FA66B6B4_OFFSET UNITYSDK_OFFSET(0x1B8A36D0)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A36C0)
