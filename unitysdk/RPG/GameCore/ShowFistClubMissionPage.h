...
#define RPG_GAMECORE_SHOWFISTCLUBMISSIONPAGE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B8CC1B0)
#define RPG_GAMECORE_SHOWFISTCLUBMISSIONPAGE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B8CC160)
#define RPG_GAMECORE_SHOWFISTCLUBMISSIONPAGE_GET_FISTRESULT_OFFSET UNITYSDK_OFFSET(0x1B8CC340)
#define RPG_GAMECORE_SHOWFISTCLUBMISSIONPAGE_SET_FISTRESULT_OFFSET UNITYSDK_OFFSET(0x1B8CC350)
#define RPG_GAMECORE_SHOWFISTCLUBMISSIONPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8CC1A0)
