...
#define RPG_GAMECORE_SKILLCONDITIONPRESHOWCONFIG_METHOD_2_6DAB9C0C54804E22_OFFSET UNITYSDK_OFFSET(0x1B8DB9D0)
#define RPG_GAMECORE_SKILLCONDITIONPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8DBAE0)
