...
#define RPG_GAMECORE_BYLOCALWIN_METHOD_4_B2ABF4F80FFA92F6_OFFSET UNITYSDK_OFFSET(0x1B2D6A70)
#define RPG_GAMECORE_BYLOCALWIN_METHOD_4_BDF9891C50790BB9_OFFSET UNITYSDK_OFFSET(0x1B2D6900)
#define RPG_GAMECORE_BYLOCALWIN_METHOD_4_CD5E66F504817983_OFFSET UNITYSDK_OFFSET(0x1B2D6A40)
#define RPG_GAMECORE_BYLOCALWIN_METHOD_4_FEB97BD34FC9B932_OFFSET UNITYSDK_OFFSET(0x1B2D68C0)
#define RPG_GAMECORE_BYLOCALWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D68F0)
