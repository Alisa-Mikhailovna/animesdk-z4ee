...
#define RPG_GAMECORE_TRAVELSHIPRESETSTATE_METHOD_3_1A6F4C6FAAC2A2AD_OFFSET UNITYSDK_OFFSET(0x1B98BDA0)
#define RPG_GAMECORE_TRAVELSHIPRESETSTATE_METHOD_3_C7A767B6207627C8_OFFSET UNITYSDK_OFFSET(0x1B98BD50)
#define RPG_GAMECORE_TRAVELSHIPRESETSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B98BD90)
