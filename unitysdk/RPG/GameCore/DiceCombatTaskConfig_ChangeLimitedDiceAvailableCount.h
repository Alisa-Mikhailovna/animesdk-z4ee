...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHANGELIMITEDDICEAVAILABLECOUNT_METHOD_3_8983F3BEEE3F5F12_OFFSET UNITYSDK_OFFSET(0x1B3B6EA0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHANGELIMITEDDICEAVAILABLECOUNT_METHOD_3_C2BC869415281493_OFFSET UNITYSDK_OFFSET(0x1B3B6E40)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHANGELIMITEDDICEAVAILABLECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B6E90)
