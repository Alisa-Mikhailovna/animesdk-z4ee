...
#define RPG_GAMECORE_ACTIVITYTELEVISIONSEASONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B137590)
#define RPG_GAMECORE_ACTIVITYTELEVISIONSEASONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B137850)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 LevelMessageSubmission; // 0x34
