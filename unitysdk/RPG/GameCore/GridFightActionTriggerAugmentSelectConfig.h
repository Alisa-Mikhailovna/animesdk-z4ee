...
#define RPG_GAMECORE_GRIDFIGHTACTIONTRIGGERAUGMENTSELECTCONFIG_METHOD_6_2D678115EB2E4599_OFFSET UNITYSDK_OFFSET(0x1B4D0580)
#define RPG_GAMECORE_GRIDFIGHTACTIONTRIGGERAUGMENTSELECTCONFIG_METHOD_6_63C11F937D8D0495_OFFSET UNITYSDK_OFFSET(0x1B4D0A40)
#define RPG_GAMECORE_GRIDFIGHTACTIONTRIGGERAUGMENTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D0570)
