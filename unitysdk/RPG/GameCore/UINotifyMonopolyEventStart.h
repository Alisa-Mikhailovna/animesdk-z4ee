...
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART_METHOD_3_030ACF25DABD3330_OFFSET UNITYSDK_OFFSET(0x1B9BE4F0)
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART_METHOD_3_DFADBF672E579C6D_OFFSET UNITYSDK_OFFSET(0x1B9BE5C0)
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BE5B0)
