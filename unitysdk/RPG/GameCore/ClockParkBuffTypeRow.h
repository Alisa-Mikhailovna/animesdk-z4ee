...
#define RPG_GAMECORE_CLOCKPARKBUFFTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B3612E0)
#define RPG_GAMECORE_CLOCKPARKBUFFTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B361550)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean BuffDisplay; // 0x1A
