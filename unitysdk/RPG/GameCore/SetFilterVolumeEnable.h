...
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_2E5DB2CAF24C3A43_OFFSET UNITYSDK_OFFSET(0x1B8A2660)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_4C249B2E36FDD7D8_OFFSET UNITYSDK_OFFSET(0x1B8A2620)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A2650)
