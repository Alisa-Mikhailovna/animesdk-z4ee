...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOPHINTPARAM_METHOD_2_35AD31FDAA43A322_OFFSET UNITYSDK_OFFSET(0x1B4E6470)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOPHINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E6B50)
