...
#define RPG_GAMECORE_PHOTOGRAPHLONGRANGEMODECONFIG_METHOD_2_FED46C93F827DCD1_OFFSET UNITYSDK_OFFSET(0x1B6AA470)
#define RPG_GAMECORE_PHOTOGRAPHLONGRANGEMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AA5F0)
