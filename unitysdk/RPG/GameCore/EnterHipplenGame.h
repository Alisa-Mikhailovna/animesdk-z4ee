...
#define RPG_GAMECORE_ENTERHIPPLENGAME_METHOD_3_C42C1F351EB5B454_OFFSET UNITYSDK_OFFSET(0x1B3E9C80)
#define RPG_GAMECORE_ENTERHIPPLENGAME_METHOD_3_CB7896F61CAD2D91_OFFSET UNITYSDK_OFFSET(0x1B3E9D50)
#define RPG_GAMECORE_ENTERHIPPLENGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E9D40)
