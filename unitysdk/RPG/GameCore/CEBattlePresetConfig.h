...
#define RPG_GAMECORE_CEBATTLEPRESETCONFIG_METHOD_2_CE10F47310F041EF_OFFSET UNITYSDK_OFFSET(0x1B2EEA70)
#define RPG_GAMECORE_CEBATTLEPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EEDE0)
