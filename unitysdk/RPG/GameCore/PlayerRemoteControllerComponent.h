...
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDB01F30)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT_GET_CONTROLENTITY_OFFSET UNITYSDK_OFFSET(0xDB02B90)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT_GET_PLAYERSTUB_OFFSET UNITYSDK_OFFSET(0xDB02B80)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0xDB02550)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT_RELEASECONTROL_OFFSET UNITYSDK_OFFSET(0xDB02190)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT_SETPLAYERSTUB_OFFSET UNITYSDK_OFFSET(0xDB028D0)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT_TICK_OFFSET UNITYSDK_OFFSET(0xDB01FD0)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xDB01ED0)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT__DELAYCANCELCONTROL_OFFSET UNITYSDK_OFFSET(0xDB02AF0)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT__INHERITCONTROLENTITYMODIFIERS_OFFSET UNITYSDK_OFFSET(0xDB023B0)
#define RPG_GAMECORE_PLAYERREMOTECONTROLLERCOMPONENT__ONREMOTECONTROLRELEASE_OFFSET UNITYSDK_OFFSET(0xDB02920)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Class_2_21055A9FA74B791E* _AdvCharAICmpt; // 0x20
		::RPG::GameCore::ColliderTriggerComponent* _TriggerCmpt; // 0x28
		::RPG::GameCore::GameEntity* _ControlEntity; // 0x30
		::RPG::GameCore::LevelGraphComponent* _LevelGraphCmpt; // 0x38
		::Class_2_3F4D673D3F90D12C* _CharVisionCmpt; // 0x40
		::RPG::GameCore::NPCComponent* _NPCCmpt; // 0x48
		::RPG::GameCore::TransformComponent* _SelfTransformCmpt; // 0x50
		::RPG::GameCore::CharacterVisibleComponent* _VisibleCmpt; // 0x58
		::Class_2_F67FF7EB526BF85C* _TargetingCmpt; // 0x60
