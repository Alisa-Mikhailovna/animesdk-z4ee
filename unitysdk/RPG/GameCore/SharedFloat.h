...
#define RPG_GAMECORE_SHAREDFLOAT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B8C0230)
#define RPG_GAMECORE_SHAREDFLOAT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B8C0280)
#define RPG_GAMECORE_SHAREDFLOAT_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1B8C0220)
#define RPG_GAMECORE_SHAREDFLOAT_METHOD_3_CCD85D2FF35B1913_OFFSET UNITYSDK_OFFSET(0x1B8C0130)
#define RPG_GAMECORE_SHAREDFLOAT_METHOD_3_D87B231C96B37D4C_OFFSET UNITYSDK_OFFSET(0x1B8C00F0)
#define RPG_GAMECORE_SHAREDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C0120)
