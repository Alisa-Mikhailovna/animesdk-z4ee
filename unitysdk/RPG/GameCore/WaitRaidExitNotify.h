...
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY_METHOD_3_4B8C0EEF94234EC9_OFFSET UNITYSDK_OFFSET(0x1B9EDC10)
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY_METHOD_3_F8DC904A8602E752_OFFSET UNITYSDK_OFFSET(0x1B9EDC50)
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EDC40)
