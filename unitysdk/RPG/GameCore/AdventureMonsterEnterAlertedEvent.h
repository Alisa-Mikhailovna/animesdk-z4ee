...
#define RPG_GAMECORE_ADVENTUREMONSTERENTERALERTEDEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xD9696E0)
#define RPG_GAMECORE_ADVENTUREMONSTERENTERALERTEDEVENT_GETMONSTER_OFFSET UNITYSDK_OFFSET(0xD969730)
#define RPG_GAMECORE_ADVENTUREMONSTERENTERALERTEDEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD969690)
#define RPG_GAMECORE_ADVENTUREMONSTERENTERALERTEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD969680)
