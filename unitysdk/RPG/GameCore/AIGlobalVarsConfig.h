...
#define RPG_GAMECORE_AIGLOBALVARSCONFIG_METHOD_2_4E559344A7A4E7EC_OFFSET UNITYSDK_OFFSET(0x1B0F00A0)
#define RPG_GAMECORE_AIGLOBALVARSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F0210)
