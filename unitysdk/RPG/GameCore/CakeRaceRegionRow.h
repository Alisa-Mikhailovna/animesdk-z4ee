...
#define RPG_GAMECORE_CAKERACEREGIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2FCBE0)
#define RPG_GAMECORE_CAKERACEREGIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FCE10)
