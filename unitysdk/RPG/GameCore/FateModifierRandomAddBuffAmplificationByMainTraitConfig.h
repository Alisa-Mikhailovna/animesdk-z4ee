...
#define RPG_GAMECORE_FATEMODIFIERRANDOMADDBUFFAMPLIFICATIONBYMAINTRAITCONFIG_METHOD_3_209B1B1BFFB7539D_OFFSET UNITYSDK_OFFSET(0x1B40C120)
#define RPG_GAMECORE_FATEMODIFIERRANDOMADDBUFFAMPLIFICATIONBYMAINTRAITCONFIG_METHOD_3_5AEEC0A8D5C9EBD9_OFFSET UNITYSDK_OFFSET(0x1B40C0D0)
#define RPG_GAMECORE_FATEMODIFIERRANDOMADDBUFFAMPLIFICATIONBYMAINTRAITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40C110)
