...
#define RPG_GAMECORE_GROUPENTITYDESTROYCONFIG_METHOD_2_8EC6AA90B0232F57_OFFSET UNITYSDK_OFFSET(0x1B4F5FB0)
#define RPG_GAMECORE_GROUPENTITYDESTROYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F6150)
