...
#define RPG_GAMECORE_SKILLMAXHITCONFIGLIST_METHOD_2_3758E4AC207715D5_OFFSET UNITYSDK_OFFSET(0x1B8DED20)
#define RPG_GAMECORE_SKILLMAXHITCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8DEDE0)
