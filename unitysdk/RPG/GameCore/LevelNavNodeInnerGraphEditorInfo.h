...
#define RPG_GAMECORE_LEVELNAVNODEINNERGRAPHEDITORINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B564C90)
#define RPG_GAMECORE_LEVELNAVNODEINNERGRAPHEDITORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B564CD0)
