...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSPECIALHINT_METHOD_3_0488F5D6FCD2DA52_OFFSET UNITYSDK_OFFSET(0x1B3B9E30)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSPECIALHINT_METHOD_3_88DFFECF1381E3CE_OFFSET UNITYSDK_OFFSET(0x1B3B9D60)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSPECIALHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B9E20)
