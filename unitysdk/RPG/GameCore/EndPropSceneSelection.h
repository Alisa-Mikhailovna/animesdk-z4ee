...
#define RPG_GAMECORE_ENDPROPSCENESELECTION_METHOD_3_7C7A83640D1B0A64_OFFSET UNITYSDK_OFFSET(0x1B3E6930)
#define RPG_GAMECORE_ENDPROPSCENESELECTION_METHOD_3_E9876B6F86D65AE1_OFFSET UNITYSDK_OFFSET(0x1B3E6A00)
#define RPG_GAMECORE_ENDPROPSCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E69F0)
