...
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXTEXT_METHOD_3_78AA6785B62F53CD_OFFSET UNITYSDK_OFFSET(0x1B8C8C80)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXTEXT_METHOD_3_CA2FFA1A3B0BF7E8_OFFSET UNITYSDK_OFFSET(0x1B8C8C40)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C8C70)
