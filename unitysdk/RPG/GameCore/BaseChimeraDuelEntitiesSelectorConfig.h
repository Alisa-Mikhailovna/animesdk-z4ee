...
#define RPG_GAMECORE_BASECHIMERADUELENTITIESSELECTORCONFIG_METHOD_2_ABB06EDDA336ABAB_OFFSET UNITYSDK_OFFSET(0x1B1EBF80)
#define RPG_GAMECORE_BASECHIMERADUELENTITIESSELECTORCONFIG_METHOD_2_D7A8204B0BFAD56D_OFFSET UNITYSDK_OFFSET(0x1B1EB6A0)
#define RPG_GAMECORE_BASECHIMERADUELENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EBFE0)
