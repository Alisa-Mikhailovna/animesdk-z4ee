...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::SkillEffect>**)Il2CppClass::FromTypeDefinitionIndex(ByAttackSkillEffect___O_TypeDefinitionIndex)->GetStaticField(0x28E40);
		}
	};
}
