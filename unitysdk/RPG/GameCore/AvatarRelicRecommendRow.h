...
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1D3490)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_GETPROPERTYTYPEARRAY_OFFSET UNITYSDK_OFFSET(0x1B1D3DE0)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_GETPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1B1D3DA0)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D3D90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* PropertyList5; // 0x20
		...
		::Il2CppArray<::System::UInt32>* Set2IDList; // 0x38
