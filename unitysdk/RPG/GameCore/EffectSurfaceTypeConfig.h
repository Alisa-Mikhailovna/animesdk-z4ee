...
#define RPG_GAMECORE_EFFECTSURFACETYPECONFIG_METHOD_2_9D865A2EDEA39E2F_OFFSET UNITYSDK_OFFSET(0x1B3D6550)
#define RPG_GAMECORE_EFFECTSURFACETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D6610)
