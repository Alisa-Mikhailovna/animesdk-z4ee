...
#define RPG_GAMECORE_MARBLEBYOTHERFACTION_METHOD_4_660BD7690044EF45_OFFSET UNITYSDK_OFFSET(0x1B5B4BD0)
#define RPG_GAMECORE_MARBLEBYOTHERFACTION_METHOD_4_9F097322B7E777FF_OFFSET UNITYSDK_OFFSET(0x1B5B4C30)
#define RPG_GAMECORE_MARBLEBYOTHERFACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B4C20)
