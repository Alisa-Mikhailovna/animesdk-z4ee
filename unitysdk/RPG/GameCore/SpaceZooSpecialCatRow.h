...
#define RPG_GAMECORE_SPACEZOOSPECIALCATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B8E85E0)
#define RPG_GAMECORE_SPACEZOOSPECIALCATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E8EE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PhotoSubmissionID; // 0x40
