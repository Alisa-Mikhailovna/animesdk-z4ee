...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::AIStatus>**)Il2CppClass::FromTypeDefinitionIndex(RA_ByAIStatus___O_TypeDefinitionIndex)->GetStaticField(0x4F840);
		}
	};
}
