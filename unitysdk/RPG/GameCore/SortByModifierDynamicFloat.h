...
#define RPG_GAMECORE_SORTBYMODIFIERDYNAMICFLOAT_METHOD_3_A4A183812FCEAB30_OFFSET UNITYSDK_OFFSET(0x1B8E0550)
#define RPG_GAMECORE_SORTBYMODIFIERDYNAMICFLOAT_METHOD_3_EE157DAECBF6D6A6_OFFSET UNITYSDK_OFFSET(0x1B8E04F0)
#define RPG_GAMECORE_SORTBYMODIFIERDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E0540)
