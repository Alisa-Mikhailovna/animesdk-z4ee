...
#define RPG_GAMECORE_ASSISTWAYPOINTPROPERAFLIPSHOWCONDITION_METHOD_3_36F2B33413CF97C8_OFFSET UNITYSDK_OFFSET(0x1B1AD6F0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPERAFLIPSHOWCONDITION_METHOD_3_4B5AEDA150124F72_OFFSET UNITYSDK_OFFSET(0x1B1B15A0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPERAFLIPSHOWCONDITION_METHOD_3_8E2251DA07BECCFE_OFFSET UNITYSDK_OFFSET(0x1B1AEA60)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPERAFLIPSHOWCONDITION_METHOD_3_C1C0B574A95D2C90_OFFSET UNITYSDK_OFFSET(0x1B1B15D0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPERAFLIPSHOWCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1AD6E0)
