...
#define RPG_GAMECORE_SETLASTKILLFINISH_METHOD_3_5C60BB6944611378_OFFSET UNITYSDK_OFFSET(0x1B8A7580)
#define RPG_GAMECORE_SETLASTKILLFINISH_METHOD_3_74AEFA164C66A7B5_OFFSET UNITYSDK_OFFSET(0x1B8A74B0)
#define RPG_GAMECORE_SETLASTKILLFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A7570)
