...
#define RPG_GAMECORE_SKILLDATAPROPERTYMODIFYITEM_METHOD_2_D12DABBD4987F806_OFFSET UNITYSDK_OFFSET(0x1B8DE600)
#define RPG_GAMECORE_SKILLDATAPROPERTYMODIFYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8DE7F0)
