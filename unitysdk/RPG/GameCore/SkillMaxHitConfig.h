...
#define RPG_GAMECORE_SKILLMAXHITCONFIG_METHOD_2_E7ACBC7C313B3ADB_OFFSET UNITYSDK_OFFSET(0x1B8DEBF0)
#define RPG_GAMECORE_SKILLMAXHITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8DED10)
