...
#define RPG_GAMECORE_USESKILLBYCOMPLEXSKILLAI_METHOD_3_806169594FEA87E0_OFFSET UNITYSDK_OFFSET(0x1B9C7D70)
#define RPG_GAMECORE_USESKILLBYCOMPLEXSKILLAI_METHOD_3_B08344D80718BAA3_OFFSET UNITYSDK_OFFSET(0x1B9C7D20)
#define RPG_GAMECORE_USESKILLBYCOMPLEXSKILLAI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C7D60)
