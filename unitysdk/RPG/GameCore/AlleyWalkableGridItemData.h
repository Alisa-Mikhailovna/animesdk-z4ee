...
#define RPG_GAMECORE_ALLEYWALKABLEGRIDITEMDATA_METHOD_3_5006AB4F982808CF_OFFSET UNITYSDK_OFFSET(0x1B1A0730)
#define RPG_GAMECORE_ALLEYWALKABLEGRIDITEMDATA_METHOD_3_FE619C0DB0EFDB7E_OFFSET UNITYSDK_OFFSET(0x1B1A0770)
#define RPG_GAMECORE_ALLEYWALKABLEGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A0760)
