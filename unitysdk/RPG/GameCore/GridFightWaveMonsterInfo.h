...
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERINFO_METHOD_2_8F5B80DE79F17F9F_OFFSET UNITYSDK_OFFSET(0x1B4F5A00)
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F5C10)
