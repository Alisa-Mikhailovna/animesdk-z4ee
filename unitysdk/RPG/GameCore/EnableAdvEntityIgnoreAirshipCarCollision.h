...
#define RPG_GAMECORE_ENABLEADVENTITYIGNOREAIRSHIPCARCOLLISION_METHOD_3_EC0D9354F38E0731_OFFSET UNITYSDK_OFFSET(0x1B3E2CB0)
#define RPG_GAMECORE_ENABLEADVENTITYIGNOREAIRSHIPCARCOLLISION_METHOD_3_FCB50F090A9D605D_OFFSET UNITYSDK_OFFSET(0x1B3E2C10)
#define RPG_GAMECORE_ENABLEADVENTITYIGNOREAIRSHIPCARCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E2C70)
