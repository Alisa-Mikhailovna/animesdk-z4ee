...
#define RPG_GAMECORE_NEWFIREWAVEPROJECTILE_METHOD_4_BB1FA2A148A60C22_OFFSET UNITYSDK_OFFSET(0x1B671BF0)
#define RPG_GAMECORE_NEWFIREWAVEPROJECTILE_METHOD_4_F90B41F5A575862C_OFFSET UNITYSDK_OFFSET(0x1B671C40)
#define RPG_GAMECORE_NEWFIREWAVEPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B671C30)
