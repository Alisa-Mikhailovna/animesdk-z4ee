...
#define RPG_GAMECORE_LITTLEGAMEENTITYTEMPLATECONFIG_METHOD_2_73CC08FE7A770709_OFFSET UNITYSDK_OFFSET(0x1B586C90)
#define RPG_GAMECORE_LITTLEGAMEENTITYTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B586CD0)
