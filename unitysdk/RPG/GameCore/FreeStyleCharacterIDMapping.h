...
#define RPG_GAMECORE_FREESTYLECHARACTERIDMAPPING_METHOD_2_2D35DCC7DB947536_OFFSET UNITYSDK_OFFSET(0x1B4A0EA0)
#define RPG_GAMECORE_FREESTYLECHARACTERIDMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A0FC0)
