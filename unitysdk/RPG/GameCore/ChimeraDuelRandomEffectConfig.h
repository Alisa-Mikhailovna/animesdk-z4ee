...
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG_METHOD_3_6C48E30EA6978AAF_OFFSET UNITYSDK_OFFSET(0x1B34FCF0)
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG_METHOD_3_CB7095B9C6BCB8EB_OFFSET UNITYSDK_OFFSET(0x1B34FD50)
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B34FD40)
