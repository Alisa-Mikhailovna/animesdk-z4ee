...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCONFIG_METHOD_3_7726350A4C269BE1_OFFSET UNITYSDK_OFFSET(0x1B7A51D0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCONFIG_METHOD_3_D704AB33EECB9345_OFFSET UNITYSDK_OFFSET(0x1B7A4EF0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A4EE0)
