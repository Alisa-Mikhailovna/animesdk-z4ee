...
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID_METHOD_3_01BEB1066C64AAC3_OFFSET UNITYSDK_OFFSET(0x1B9D20E0)
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID_METHOD_3_2A3386FBC3E51575_OFFSET UNITYSDK_OFFSET(0x1B9D1F40)
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID_METHOD_3_37C5EBCDF9AC62BA_OFFSET UNITYSDK_OFFSET(0x1B9D1F80)
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID_METHOD_3_D62D8C7E9AC1EC54_OFFSET UNITYSDK_OFFSET(0x1B9D2110)
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D1F70)
