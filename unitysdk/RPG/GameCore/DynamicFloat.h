...
#define RPG_GAMECORE_DYNAMICFLOAT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B3CCFA0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_0854E9454645D1B7_OFFSET UNITYSDK_OFFSET(0x1B3CCF80)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_1DCC0C7F8AC23022_OFFSET UNITYSDK_OFFSET(0x1B3CD010)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_28C8D0626FC9B6CE_OFFSET UNITYSDK_OFFSET(0x1B3CD390)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_3067CA610DDF54A5_OFFSET UNITYSDK_OFFSET(0x1B3CCC60)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_489E71857D4AA76C_OFFSET UNITYSDK_OFFSET(0x1B3CCBA0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_5E7F0F255B1949DC_OFFSET UNITYSDK_OFFSET(0x1B3CCD90)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_681969B4CEFE2E05_OFFSET UNITYSDK_OFFSET(0x1B3CCCE0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_83E0EBB29FC64260_OFFSET UNITYSDK_OFFSET(0x1B3CCFB0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_85C6A441D4AD49B0_OFFSET UNITYSDK_OFFSET(0x1B3CCE30)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_A218C1184B27468C_OFFSET UNITYSDK_OFFSET(0x1B3CD0B0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_F7097473EC9DE578_OFFSET UNITYSDK_OFFSET(0x1B3CDB00)
#define RPG_GAMECORE_DYNAMICFLOAT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B3CDA20)
#define RPG_GAMECORE_DYNAMICFLOAT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3CDF40)
#define RPG_GAMECORE_DYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3CD000)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x32D00);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_ONEHUNDRED()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x32D08);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_ONE()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x32D10);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_ZERO()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x32D18);
		}
