...
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_GET_HASLOOPANIM_OFFSET UNITYSDK_OFFSET(0x1B605BF0)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_GET_HASOCCURANIM_OFFSET UNITYSDK_OFFSET(0x1B605C10)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_GET_HASRECOVERANIM_OFFSET UNITYSDK_OFFSET(0x1B605C30)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_METHOD_2_D45237155D85F493_OFFSET UNITYSDK_OFFSET(0x1B605340)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B605BC0)
