...
#define RPG_GAMECORE_TRAINPARTYMODIFIERLISTCONFIG_METHOD_2_E628521DD0260EED_OFFSET UNITYSDK_OFFSET(0x1B981BF0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B981C30)
