...
#define RPG_GAMECORE_UNLOCKCAMERA_METHOD_3_194CFD073DF8FF28_OFFSET UNITYSDK_OFFSET(0x1B9C0F10)
#define RPG_GAMECORE_UNLOCKCAMERA_METHOD_3_5AF973A004BE47A5_OFFSET UNITYSDK_OFFSET(0x1B9C0E40)
#define RPG_GAMECORE_UNLOCKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C0F00)
