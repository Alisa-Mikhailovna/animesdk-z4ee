...
#define RPG_GAMECORE_GRIDFIGHTCONDISLASTBATTLEPERFECTCONFIG_METHOD_6_38B65B0B04145377_OFFSET UNITYSDK_OFFSET(0x1B4D3C40)
#define RPG_GAMECORE_GRIDFIGHTCONDISLASTBATTLEPERFECTCONFIG_METHOD_6_B9CE49B1674DF133_OFFSET UNITYSDK_OFFSET(0x1B4D3BF0)
#define RPG_GAMECORE_GRIDFIGHTCONDISLASTBATTLEPERFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D3C30)
