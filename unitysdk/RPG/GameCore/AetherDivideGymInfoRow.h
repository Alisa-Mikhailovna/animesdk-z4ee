...
#define RPG_GAMECORE_AETHERDIVIDEGYMINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B187850)
#define RPG_GAMECORE_AETHERDIVIDEGYMINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B188240)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* ChallengeQuestList; // 0x20
		...
		::System::UInt32 SpiritQuest; // 0x4C
		::System::UInt32 ID; // 0x50
		::System::UInt32 BadgeUnlockID; // 0x54
		::System::UInt32 ActivityModuleID; // 0x58
		::RPG::Client::TextID Description; // 0x60
		::RPG::Client::TextID Name; // 0x70
		::System::UInt32 EntranceID; // 0x80
		::System::UInt32 TrainerQuest; // 0x84
