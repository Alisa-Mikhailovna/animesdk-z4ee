...
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT_METHOD_3_29981694393996A5_OFFSET UNITYSDK_OFFSET(0x1B8D2290)
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT_METHOD_3_F7D7484B55068C15_OFFSET UNITYSDK_OFFSET(0x1B8D2210)
#define RPG_GAMECORE_SHOWPROPSCENEOBJCLICKHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D2260)
