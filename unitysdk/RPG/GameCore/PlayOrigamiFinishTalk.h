...
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK_METHOD_3_86400D664FDD9A9A_OFFSET UNITYSDK_OFFSET(0x1B6C8760)
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK_METHOD_3_F3E9448993C3B0F7_OFFSET UNITYSDK_OFFSET(0x1B6C8690)
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C8750)
