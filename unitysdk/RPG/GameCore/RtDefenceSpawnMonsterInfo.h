...
#define RPG_GAMECORE_RTDEFENCESPAWNMONSTERINFO_METHOD_2_08C0001655AEB8C4_OFFSET UNITYSDK_OFFSET(0x1B7B9870)
#define RPG_GAMECORE_RTDEFENCESPAWNMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B9B00)
