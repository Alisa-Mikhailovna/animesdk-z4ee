...
#define RPG_GAMECORE_DIALOGUEEVENTINFO_METHOD_2_FFCA1C6E4ABE7127_OFFSET UNITYSDK_OFFSET(0x1B3A6510)
#define RPG_GAMECORE_DIALOGUEEVENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A6690)
