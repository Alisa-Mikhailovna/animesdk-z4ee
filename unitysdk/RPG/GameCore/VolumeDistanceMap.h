...
#define RPG_GAMECORE_VOLUMEDISTANCEMAP_METHOD_2_5A1D43DEA3B97CCB_OFFSET UNITYSDK_OFFSET(0x1B9E11F0)
#define RPG_GAMECORE_VOLUMEDISTANCEMAP_METHOD_2_E0E95C03951619C1_OFFSET UNITYSDK_OFFSET(0x1B9E1340)
#define RPG_GAMECORE_VOLUMEDISTANCEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E1330)
