...
#define RPG_GAMECORE_IDLELIVEEQUIPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B525900)
#define RPG_GAMECORE_IDLELIVEEQUIPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B525AC0)
