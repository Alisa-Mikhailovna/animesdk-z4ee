...
#define RPG_GAMECORE_SMELLPATHEDGE_METHOD_2_100550675FFBD6E9_OFFSET UNITYSDK_OFFSET(0x1B8DFEB0)
#define RPG_GAMECORE_SMELLPATHEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E0050)
