...
#define RPG_GAMECORE_RTBYHASSELECTSKILL_METHOD_4_62289F380C68360C_OFFSET UNITYSDK_OFFSET(0x1B7B0F30)
#define RPG_GAMECORE_RTBYHASSELECTSKILL_METHOD_4_AC8BEDD3D87A10D6_OFFSET UNITYSDK_OFFSET(0x1B7B0D80)
#define RPG_GAMECORE_RTBYHASSELECTSKILL_METHOD_4_CFB3C72B8E319A02_OFFSET UNITYSDK_OFFSET(0x1B7B0F00)
#define RPG_GAMECORE_RTBYHASSELECTSKILL_METHOD_4_FDE6A6009F784A87_OFFSET UNITYSDK_OFFSET(0x1B7B0D40)
#define RPG_GAMECORE_RTBYHASSELECTSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7B0D70)
