...
#define RPG_GAMECORE_ROGUEDLCAEONDICEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B74B640)
#define RPG_GAMECORE_ROGUEDLCAEONDICEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B74BFD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* SoundReRoll; // 0x40
		::System::String* SoundRoll; // 0x48
		::System::String* DiceIcon; // 0x50
