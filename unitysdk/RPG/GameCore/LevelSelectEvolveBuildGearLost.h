...
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADB1B0)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADB160)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST_INIT_OFFSET UNITYSDK_OFFSET(0xDADB110)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST__CTOR_OFFSET UNITYSDK_OFFSET(0xDADB200)
