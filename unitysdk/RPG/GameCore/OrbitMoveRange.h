...
#define RPG_GAMECORE_ORBITMOVERANGE_METHOD_2_F107058FBF2A185D_OFFSET UNITYSDK_OFFSET(0x1B6808C0)
#define RPG_GAMECORE_ORBITMOVERANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B680AE0)
