...
#define RPG_GAMECORE_PLANETFESSKILLTREEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6C41C0)
#define RPG_GAMECORE_PLANETFESSKILLTREEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C4590)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* LevelCostList; // 0x20
