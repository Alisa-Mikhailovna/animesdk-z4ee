...
#define RPG_GAMECORE_FATERINCASEBOARDMOVEBASEINFO_METHOD_2_0D5F69DADCDAF908_OFFSET UNITYSDK_OFFSET(0x1B40EA40)
#define RPG_GAMECORE_FATERINCASEBOARDMOVEBASEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40EBC0)
