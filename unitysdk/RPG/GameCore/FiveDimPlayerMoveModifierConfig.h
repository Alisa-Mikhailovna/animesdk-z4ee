...
#define RPG_GAMECORE_FIVEDIMPLAYERMOVEMODIFIERCONFIG_METHOD_3_23FC67182FF076BD_OFFSET UNITYSDK_OFFSET(0x1B43FF20)
#define RPG_GAMECORE_FIVEDIMPLAYERMOVEMODIFIERCONFIG_METHOD_3_DEBB82FD6CE9A288_OFFSET UNITYSDK_OFFSET(0x1B43FF60)
#define RPG_GAMECORE_FIVEDIMPLAYERMOVEMODIFIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43FF50)
