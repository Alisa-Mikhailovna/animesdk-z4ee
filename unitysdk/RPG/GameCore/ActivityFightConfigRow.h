...
#define RPG_GAMECORE_ACTIVITYFIGHTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B118230)
#define RPG_GAMECORE_ACTIVITYFIGHTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B118A50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TotalWave; // 0x14
		::System::UInt32 RewardID; // 0x18
		::System::UInt32 RewardWave; // 0x1C
		::RPG::GameCore::LevelDifficulty DifficultyLevel; // 0x20
		::System::UInt32 RoundsLimit; // 0x24
		::System::UInt32 OffsetLevel; // 0x28
		::System::UInt32 FightEventID; // 0x2C
		::System::UInt32 RewardWave2; // 0x30
		::System::UInt32 RewardQuest; // 0x34
