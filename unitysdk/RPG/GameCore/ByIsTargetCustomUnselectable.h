...
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE_METHOD_4_14AEFC38C84628CC_OFFSET UNITYSDK_OFFSET(0x1B2CFCE0)
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE_METHOD_4_16F6078E8A66EB2B_OFFSET UNITYSDK_OFFSET(0x1B2CFAE0)
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE_METHOD_4_9517F47C59AA5A5A_OFFSET UNITYSDK_OFFSET(0x1B2CFD10)
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE_METHOD_4_E4A60E91BAABD74A_OFFSET UNITYSDK_OFFSET(0x1B2CFB20)
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CFB10)
