...
#define RPG_GAMECORE_CHANGEINCOMINGACTIONCOUNTDOWN_METHOD_3_B1A14523FA38A19F_OFFSET UNITYSDK_OFFSET(0x1B311520)
#define RPG_GAMECORE_CHANGEINCOMINGACTIONCOUNTDOWN_METHOD_3_B5FEC447646C0C04_OFFSET UNITYSDK_OFFSET(0x1B311560)
#define RPG_GAMECORE_CHANGEINCOMINGACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B311550)
