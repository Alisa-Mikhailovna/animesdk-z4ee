...
#define RPG_GAMECORE_MAZECHARACTERTELEPORTCONFIG_METHOD_2_F1836C58FBCBBB24_OFFSET UNITYSDK_OFFSET(0x1B5DCEC0)
#define RPG_GAMECORE_MAZECHARACTERTELEPORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DD0B0)
