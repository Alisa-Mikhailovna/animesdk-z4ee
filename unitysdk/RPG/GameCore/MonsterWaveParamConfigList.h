...
#define RPG_GAMECORE_MONSTERWAVEPARAMCONFIGLIST_METHOD_2_63FC84F9770DDABE_OFFSET UNITYSDK_OFFSET(0x1B6345F0)
#define RPG_GAMECORE_MONSTERWAVEPARAMCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6346E0)
