...
#define RPG_GAMECORE_DESTRUCTIBLEBRIDGEBIND_METHOD_2_23F371C6BDB54CAC_OFFSET UNITYSDK_OFFSET(0x1B3A32A0)
#define RPG_GAMECORE_DESTRUCTIBLEBRIDGEBIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A33C0)
