...
#define RPG_GAMECORE_FLOORFSVSYNCTEMPLATECONFIG_METHOD_2_6E59DD0EA355FB4A_OFFSET UNITYSDK_OFFSET(0x1B4532A0)
#define RPG_GAMECORE_FLOORFSVSYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4532E0)
