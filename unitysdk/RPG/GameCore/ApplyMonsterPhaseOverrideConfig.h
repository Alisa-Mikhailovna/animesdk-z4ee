...
#define RPG_GAMECORE_APPLYMONSTERPHASEOVERRIDECONFIG_METHOD_3_23558CE3E3E2737D_OFFSET UNITYSDK_OFFSET(0x1B1A8A90)
#define RPG_GAMECORE_APPLYMONSTERPHASEOVERRIDECONFIG_METHOD_3_ECD6E998BE9262EC_OFFSET UNITYSDK_OFFSET(0x1B1A89F0)
#define RPG_GAMECORE_APPLYMONSTERPHASEOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A8A50)
