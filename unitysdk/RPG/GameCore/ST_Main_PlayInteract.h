...
#define RPG_GAMECORE_ST_MAIN_PLAYINTERACT_METHOD_4_A3474BC459BCCFDA_OFFSET UNITYSDK_OFFSET(0x1B7DECB0)
#define RPG_GAMECORE_ST_MAIN_PLAYINTERACT_METHOD_4_CC45DECAD2ACE8D7_OFFSET UNITYSDK_OFFSET(0x1B7DEC70)
#define RPG_GAMECORE_ST_MAIN_PLAYINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7DECA0)
