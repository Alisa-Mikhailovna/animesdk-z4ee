...
#define RPG_GAMECORE_TARGETALIASCONFIGLIST_METHOD_2_4B1D2C5449EDC655_OFFSET UNITYSDK_OFFSET(0x1B9454B0)
#define RPG_GAMECORE_TARGETALIASCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B945590)
