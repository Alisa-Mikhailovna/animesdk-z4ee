...
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE_METHOD_4_32A68D292907F51C_OFFSET UNITYSDK_OFFSET(0x1B2A9560)
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE_METHOD_4_6D8C9DAC9F80C40F_OFFSET UNITYSDK_OFFSET(0x1B2A93F0)
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE_METHOD_4_8CDDDC10D13EC1A5_OFFSET UNITYSDK_OFFSET(0x1B2A9530)
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE_METHOD_4_8D3D74FC74810EF4_OFFSET UNITYSDK_OFFSET(0x1B2A93B0)
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A93E0)
