...
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENFORMULACONFIG_METHOD_2_195FD691DF38272F_OFFSET UNITYSDK_OFFSET(0x1B7A5380)
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A53C0)
