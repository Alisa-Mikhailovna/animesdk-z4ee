...
#define RPG_GAMECORE_TRIGGERMAGICUNITONSCEPTER_METHOD_3_342BAF41E2C2C9AD_OFFSET UNITYSDK_OFFSET(0x1B9A4910)
#define RPG_GAMECORE_TRIGGERMAGICUNITONSCEPTER_METHOD_3_E163CA8858764EC8_OFFSET UNITYSDK_OFFSET(0x1B9A48D0)
#define RPG_GAMECORE_TRIGGERMAGICUNITONSCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A4900)
