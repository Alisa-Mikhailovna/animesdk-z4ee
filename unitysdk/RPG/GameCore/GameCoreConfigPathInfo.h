...
#define RPG_GAMECORE_GAMECORECONFIGPATHINFO_METHOD_2_B8A4B08001549670_OFFSET UNITYSDK_OFFSET(0x1B4B6BA0)
#define RPG_GAMECORE_GAMECORECONFIGPATHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C1200)
