...
#define RPG_GAMECORE_HIDEENTITYINACTIONBARBYDELAY_METHOD_3_89CF2336C66B7ECE_OFFSET UNITYSDK_OFFSET(0x1B513AD0)
#define RPG_GAMECORE_HIDEENTITYINACTIONBARBYDELAY_METHOD_3_DC9725C11B7BF93F_OFFSET UNITYSDK_OFFSET(0x1B513B10)
#define RPG_GAMECORE_HIDEENTITYINACTIONBARBYDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B513B00)
