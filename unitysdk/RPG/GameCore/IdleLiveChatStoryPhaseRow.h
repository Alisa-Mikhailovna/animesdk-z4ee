...
#define RPG_GAMECORE_IDLELIVECHATSTORYPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B523EA0)
#define RPG_GAMECORE_IDLELIVECHATSTORYPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B524070)
