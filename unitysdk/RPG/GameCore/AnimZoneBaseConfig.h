...
#define RPG_GAMECORE_ANIMZONEBASECONFIG_METHOD_2_11F3ADFC5CB57C83_OFFSET UNITYSDK_OFFSET(0x1B1A5C50)
#define RPG_GAMECORE_ANIMZONEBASECONFIG_METHOD_2_A3F66B40D05E28A4_OFFSET UNITYSDK_OFFSET(0x1B1A5DC0)
#define RPG_GAMECORE_ANIMZONEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A5DB0)
