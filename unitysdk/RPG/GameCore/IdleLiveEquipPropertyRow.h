...
#define RPG_GAMECORE_IDLELIVEEQUIPPROPERTYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B5250A0)
#define RPG_GAMECORE_IDLELIVEEQUIPPROPERTYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B525560)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint RarityPower; // 0x20
		::RPG::GameCore::IdleLiveAvatarPropertyType PropertyType; // 0x28
		::System::UInt32 OffsetQuantizeCount; // 0x2C
		::RPG::GameCore::FixPoint RarityParam; // 0x30
		::RPG::GameCore::FixPoint BasicParam; // 0x38
