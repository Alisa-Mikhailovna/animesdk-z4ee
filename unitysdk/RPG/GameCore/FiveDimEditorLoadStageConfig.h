...
#define RPG_GAMECORE_FIVEDIMEDITORLOADSTAGECONFIG_METHOD_2_2B6091C022170865_OFFSET UNITYSDK_OFFSET(0x1B42A9A0)
#define RPG_GAMECORE_FIVEDIMEDITORLOADSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B42A9E0)
