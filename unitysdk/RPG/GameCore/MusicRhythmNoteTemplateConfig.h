...
#define RPG_GAMECORE_MUSICRHYTHMNOTETEMPLATECONFIG_METHOD_2_96A905891A2253AF_OFFSET UNITYSDK_OFFSET(0x1B6686C0)
#define RPG_GAMECORE_MUSICRHYTHMNOTETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B668700)
