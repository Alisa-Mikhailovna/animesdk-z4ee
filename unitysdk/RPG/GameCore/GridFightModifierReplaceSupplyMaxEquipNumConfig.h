...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESUPPLYMAXEQUIPNUMCONFIG_METHOD_3_8209DA4C3636F179_OFFSET UNITYSDK_OFFSET(0x1B4E0E20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESUPPLYMAXEQUIPNUMCONFIG_METHOD_3_D25F6FBAD0612BBD_OFFSET UNITYSDK_OFFSET(0x1B4E0E70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESUPPLYMAXEQUIPNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0E60)
