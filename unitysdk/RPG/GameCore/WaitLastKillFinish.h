...
#define RPG_GAMECORE_WAITLASTKILLFINISH_METHOD_3_2A15689696DD1B3D_OFFSET UNITYSDK_OFFSET(0x1B9E8E50)
#define RPG_GAMECORE_WAITLASTKILLFINISH_METHOD_3_82AA5FC026574480_OFFSET UNITYSDK_OFFSET(0x1B9E8D80)
#define RPG_GAMECORE_WAITLASTKILLFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E8E40)
