...
#define RPG_GAMECORE_SIMPLETALKTARGETBEHAVIOR_METHOD_2_F2A4BF2EEBA41412_OFFSET UNITYSDK_OFFSET(0x1B8D9B20)
#define RPG_GAMECORE_SIMPLETALKTARGETBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D9C50)
