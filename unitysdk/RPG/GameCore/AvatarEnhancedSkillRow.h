...
#define RPG_GAMECORE_AVATARENHANCEDSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1C5370)
#define RPG_GAMECORE_AVATARENHANCEDSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C5880)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID SimpleDescAfter; // 0x58
