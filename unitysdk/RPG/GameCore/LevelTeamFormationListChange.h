...
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xDADB820)
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDADB870)
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE_GET_CHANGEDENTITY_OFFSET UNITYSDK_OFFSET(0xDADB8D0)
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE_GET_TEAMENTITY_OFFSET UNITYSDK_OFFSET(0xDADB8C0)
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xDADB810)
