...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT_METHOD_3_40430CE3115C3A81_OFFSET UNITYSDK_OFFSET(0x1B3B9780)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT_METHOD_3_BF4BA382483E67C7_OFFSET UNITYSDK_OFFSET(0x1B3B9720)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B9770)
