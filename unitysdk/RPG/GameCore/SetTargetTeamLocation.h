...
#define RPG_GAMECORE_SETTARGETTEAMLOCATION_METHOD_3_6EE614B4E40DB3FE_OFFSET UNITYSDK_OFFSET(0x1B8B5C60)
#define RPG_GAMECORE_SETTARGETTEAMLOCATION_METHOD_3_BA201870A6D662AE_OFFSET UNITYSDK_OFFSET(0x1B8B5C10)
#define RPG_GAMECORE_SETTARGETTEAMLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B5C50)
