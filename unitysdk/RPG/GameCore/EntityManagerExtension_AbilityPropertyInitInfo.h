...
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION_ABILITYPROPERTYINITINFO_ADDINHERITPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x155BC0)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION_ABILITYPROPERTYINITINFO_ADDINHERITPROPERTY_OFFSET UNITYSDK_OFFSET(0x155BB0)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION_ABILITYPROPERTYINITINFO_GETPROPERTYINERITTYPE_OFFSET UNITYSDK_OFFSET(0x155B20)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION_ABILITYPROPERTYINITINFO_HASINHERITPROPERTY_OFFSET UNITYSDK_OFFSET(0x155B30)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION_ABILITYPROPERTYINITINFO_INCLUDEINHERITPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x155BA0)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION_ABILITYPROPERTYINITINFO_REMOVEINHERITPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x155BE0)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION_ABILITYPROPERTYINITINFO_REMOVEINHERITPROPERTY_OFFSET UNITYSDK_OFFSET(0x155BD0)
