...
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_5A52FBF09A05CE58_OFFSET UNITYSDK_OFFSET(0x1B22C7E0)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_944B5EF023AAE43F_OFFSET UNITYSDK_OFFSET(0x1B22CAB0)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_AC3FEFFE7DDB0777_OFFSET UNITYSDK_OFFSET(0x1B22CB30)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_C7F6C39B9EBA6D73_OFFSET UNITYSDK_OFFSET(0x1B22C8C0)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22C860)
