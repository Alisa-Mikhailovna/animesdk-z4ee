...
#define RPG_GAMECORE_GRIDFIGHTCONDITIONLISTCONFIG_METHOD_2_EF36F5BCF7F6DB21_OFFSET UNITYSDK_OFFSET(0x1B4D40F0)
#define RPG_GAMECORE_GRIDFIGHTCONDITIONLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D4130)
