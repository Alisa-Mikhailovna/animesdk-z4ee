...
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST_METHOD_2_F0B7E641956ED287_OFFSET UNITYSDK_OFFSET(0x1B6A36B0)
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A3770)
