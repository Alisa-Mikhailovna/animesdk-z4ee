...
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x39E89D0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x39FA940)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x2D8F7B0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2D8F7D0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x2D8F5B0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GET_POOL_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GET_POSELIST_OFFSET UNITYSDK_OFFSET(0x39FA950)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_INIT_OFFSET UNITYSDK_OFFSET(0x8A130)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B573A90)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B573CD0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B573BA0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_OP_LOGICALNOT_OFFSET UNITYSDK_OFFSET(0x1B573D80)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_SET_POSELIST_OFFSET UNITYSDK_OFFSET(0x39FA970)
