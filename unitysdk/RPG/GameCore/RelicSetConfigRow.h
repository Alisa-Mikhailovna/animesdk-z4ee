...
#define RPG_GAMECORE_RELICSETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B717DB0)
#define RPG_GAMECORE_RELICSETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7185F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsPlanarSuit; // 0x44
		::System::Boolean Release; // 0x45
