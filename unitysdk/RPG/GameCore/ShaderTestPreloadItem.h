...
#define RPG_GAMECORE_SHADERTESTPRELOADITEM_METHOD_2_FEF873999D24BE9D_OFFSET UNITYSDK_OFFSET(0x1B8BE6D0)
#define RPG_GAMECORE_SHADERTESTPRELOADITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8BE7C0)
