...
#define RPG_GAMECORE_FIVEDIMMOVEPARAMMODIFIERFLOAT_METHOD_3_0C77DB5917BF430F_OFFSET UNITYSDK_OFFSET(0x1B43BAC0)
#define RPG_GAMECORE_FIVEDIMMOVEPARAMMODIFIERFLOAT_METHOD_3_2C28B2A8ECBF8DF4_OFFSET UNITYSDK_OFFSET(0x1B43BA80)
#define RPG_GAMECORE_FIVEDIMMOVEPARAMMODIFIERFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43BAB0)
