...
#define RPG_GAMECORE_MINIEMOEFFECTOVERRIDE_METHOD_2_FB806F778B6F99A4_OFFSET UNITYSDK_OFFSET(0x1B5F8810)
#define RPG_GAMECORE_MINIEMOEFFECTOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F8CE0)
