...
#define RPG_GAMECORE_CLEARRECORDENTITYFORMATION_METHOD_3_07959B6C750FE6DF_OFFSET UNITYSDK_OFFSET(0x1B35ECB0)
#define RPG_GAMECORE_CLEARRECORDENTITYFORMATION_METHOD_3_5AAA2A9C4BB85C04_OFFSET UNITYSDK_OFFSET(0x1B35ECF0)
#define RPG_GAMECORE_CLEARRECORDENTITYFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35ECE0)
