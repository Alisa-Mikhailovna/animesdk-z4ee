...
#define RPG_GAMECORE_DYNAMICVECTOR3_METHOD_2_FD2B7B6623952D19_OFFSET UNITYSDK_OFFSET(0x1B3D24D0)
#define RPG_GAMECORE_DYNAMICVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D26A0)
