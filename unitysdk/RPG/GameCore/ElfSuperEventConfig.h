...
#define RPG_GAMECORE_ELFSUPEREVENTCONFIG_METHOD_2_9A16F89FA5290BA2_OFFSET UNITYSDK_OFFSET(0x1B3DD120)
#define RPG_GAMECORE_ELFSUPEREVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3DE2F0)
