...
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST_METHOD_3_3461181C2DEBA8D6_OFFSET UNITYSDK_OFFSET(0x1B9A8660)
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST_METHOD_3_8FBE78EA1C620515_OFFSET UNITYSDK_OFFSET(0x1B9A86A0)
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A8690)
