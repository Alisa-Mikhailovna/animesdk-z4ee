...
#define RPG_GAMECORE_GRIDFIGHTPARAMETERCONFIGBASE_METHOD_5_6CA6FBB7BBEC63C7_OFFSET UNITYSDK_OFFSET(0x1B4E4890)
#define RPG_GAMECORE_GRIDFIGHTPARAMETERCONFIGBASE_METHOD_5_FD5829BFE436505B_OFFSET UNITYSDK_OFFSET(0x1B4E4830)
#define RPG_GAMECORE_GRIDFIGHTPARAMETERCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E3680)
