...
#define RPG_GAMECORE_SKILLABILITYCONFIG_METHOD_2_2D6E1F92B1FBF606_OFFSET UNITYSDK_OFFSET(0x1B8DB8A0)
#define RPG_GAMECORE_SKILLABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8DB9C0)
