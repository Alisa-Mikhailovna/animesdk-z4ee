...
#define RPG_GAMECORE_FANTASTICSTORYBATTLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B406520)
#define RPG_GAMECORE_FANTASTICSTORYBATTLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B406E10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* DisplayMonsterList; // 0x38
		...
		::System::UInt32 TurnLimit; // 0x5C
		::System::UInt32 PreBattleID; // 0x60
		::System::UInt32 BattleAreaID; // 0x64
		::RPG::Client::TextID BookContextChange; // 0x68
		::System::UInt32 PlaneID; // 0x78
		::System::UInt32 FloorID; // 0x7C
		::System::UInt32 BattleAreaGroupID; // 0x80
		::System::UInt32 UnlockChapterID; // 0x84
		::RPG::Client::TextID BookContext; // 0x88
