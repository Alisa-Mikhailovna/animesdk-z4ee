...
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR_METHOD_3_3331416DF5C4EDBB_OFFSET UNITYSDK_OFFSET(0x1B8C1870)
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR_METHOD_3_F4BAD15EC78F8B06_OFFSET UNITYSDK_OFFSET(0x1B8C1830)
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C1860)
