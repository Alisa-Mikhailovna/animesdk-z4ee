...
#define RPG_GAMECORE_GRAVITYBALLPUZZLECONTROLLERINIT_METHOD_3_43EFD85F0B9AE6FA_OFFSET UNITYSDK_OFFSET(0x1B4CEE30)
#define RPG_GAMECORE_GRAVITYBALLPUZZLECONTROLLERINIT_METHOD_3_BA0119C547A2AF99_OFFSET UNITYSDK_OFFSET(0x1B4CEF30)
#define RPG_GAMECORE_GRAVITYBALLPUZZLECONTROLLERINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CEEC0)
