...
#define RPG_GAMECORE_MARBLESIMULATELISTENER_METHOD_3_AEE7E88706006484_OFFSET UNITYSDK_OFFSET(0x1B5C1920)
#define RPG_GAMECORE_MARBLESIMULATELISTENER_METHOD_3_FC51694DAE0DE1AD_OFFSET UNITYSDK_OFFSET(0x1B5C18E0)
#define RPG_GAMECORE_MARBLESIMULATELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C1910)
