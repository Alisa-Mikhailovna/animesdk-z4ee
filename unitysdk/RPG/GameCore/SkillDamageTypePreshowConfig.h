...
#define RPG_GAMECORE_SKILLDAMAGETYPEPRESHOWCONFIG_METHOD_2_F1AA97BC5F2D9469_OFFSET UNITYSDK_OFFSET(0x1B8DE460)
#define RPG_GAMECORE_SKILLDAMAGETYPEPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8DE5F0)
