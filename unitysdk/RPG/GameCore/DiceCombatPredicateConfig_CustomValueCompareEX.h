...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_CUSTOMVALUECOMPAREEX_METHOD_4_04D4D83A2377F3BF_OFFSET UNITYSDK_OFFSET(0x1B3B1980)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_CUSTOMVALUECOMPAREEX_METHOD_4_C24DC972EB6FC809_OFFSET UNITYSDK_OFFSET(0x1B3B4C30)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_CUSTOMVALUECOMPAREEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B1970)
