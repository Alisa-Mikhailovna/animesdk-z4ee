...
#define RPG_GAMECORE_ANIMATORCLIPZONENEWCONFIG_METHOD_2_900EB439B8CF7903_OFFSET UNITYSDK_OFFSET(0x1B1A7140)
#define RPG_GAMECORE_ANIMATORCLIPZONENEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A7230)
