...
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG_METHOD_5_129C1C071DF9A7A2_OFFSET UNITYSDK_OFFSET(0x1B97CF40)
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG_METHOD_5_DA4D5B35F3C13B06_OFFSET UNITYSDK_OFFSET(0x1B97D070)
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97CF30)
