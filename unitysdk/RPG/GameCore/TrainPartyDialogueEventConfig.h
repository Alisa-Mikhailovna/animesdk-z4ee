...
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTCONFIG_METHOD_2_563C963C97290B8A_OFFSET UNITYSDK_OFFSET(0x1B97FD80)
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97FE70)
