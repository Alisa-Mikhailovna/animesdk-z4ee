...
#define RPG_GAMECORE_MARBLEBYDEFENDERFACTION_METHOD_4_AA609FA006972764_OFFSET UNITYSDK_OFFSET(0x1B5B3BE0)
#define RPG_GAMECORE_MARBLEBYDEFENDERFACTION_METHOD_4_EB90F0FD30C5C6C6_OFFSET UNITYSDK_OFFSET(0x1B5B3C40)
#define RPG_GAMECORE_MARBLEBYDEFENDERFACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B3C30)
