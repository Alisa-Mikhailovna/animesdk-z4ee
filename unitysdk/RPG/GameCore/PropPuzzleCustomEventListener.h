...
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTLISTENER_METHOD_3_C1C28E353C10839D_OFFSET UNITYSDK_OFFSET(0x1B6E9B60)
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTLISTENER_METHOD_3_F1BD924450A4351C_OFFSET UNITYSDK_OFFSET(0x1B6E9B10)
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E9B50)
