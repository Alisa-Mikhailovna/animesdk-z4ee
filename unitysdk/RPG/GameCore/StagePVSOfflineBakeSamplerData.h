...
#define RPG_GAMECORE_STAGEPVSOFFLINEBAKESAMPLERDATA_METHOD_2_E73237E37779ECDD_OFFSET UNITYSDK_OFFSET(0x1B8FEB30)
#define RPG_GAMECORE_STAGEPVSOFFLINEBAKESAMPLERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8FECA0)
