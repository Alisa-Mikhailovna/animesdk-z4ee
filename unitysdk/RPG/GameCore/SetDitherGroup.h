...
#define RPG_GAMECORE_SETDITHERGROUP_METHOD_3_2639B0D9B79BE1CA_OFFSET UNITYSDK_OFFSET(0x1B88EF30)
#define RPG_GAMECORE_SETDITHERGROUP_METHOD_3_A6B25F25C67E701F_OFFSET UNITYSDK_OFFSET(0x1B88EF70)
#define RPG_GAMECORE_SETDITHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88EF60)
