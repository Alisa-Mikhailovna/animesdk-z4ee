...
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_1E40B02EFE1CEA5B_OFFSET UNITYSDK_OFFSET(0x1B2C1F20)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_66B03D53B144D81A_OFFSET UNITYSDK_OFFSET(0x1B2C1DA0)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_7BDE0E64C039ABCE_OFFSET UNITYSDK_OFFSET(0x1B2C1F50)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_A1BEE485FBBE7801_OFFSET UNITYSDK_OFFSET(0x1B2C1DE0)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C1DD0)
