...
#define RPG_GAMECORE_RESTAURANTDAILYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B727330)
#define RPG_GAMECORE_RESTAURANTDAILYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B727880)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RandomEventNumber; // 0x34
		::System::UInt32 ProgressID; // 0x38
		::System::UInt32 StartMessageID; // 0x3C
		::System::UInt32 LockNextDayMission; // 0x40
		::System::UInt32 DayID; // 0x44
		::System::UInt32 BeginMainPageMission; // 0x48
		::System::UInt32 LockRestaurantMission; // 0x4C
		::System::UInt32 ShareCropsRewardID; // 0x50
		::System::Boolean IsLoop; // 0x54
