...
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT_METHOD_3_2D8A7A615C55EC61_OFFSET UNITYSDK_OFFSET(0x1B9E8AB0)
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT_METHOD_3_C07D9255E29A9BE4_OFFSET UNITYSDK_OFFSET(0x1B9E8B80)
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E8B70)
