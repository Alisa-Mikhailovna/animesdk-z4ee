...
#define RPG_GAMECORE_TRAINPARTYLOGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B980F70)
#define RPG_GAMECORE_TRAINPARTYLOGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B981140)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::TrainPartyGameRecordType LogType; // 0x14
