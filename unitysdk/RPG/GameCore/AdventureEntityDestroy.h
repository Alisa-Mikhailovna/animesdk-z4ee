...
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xD965890)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD9658E0)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xD965920)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_INIT_OFFSET UNITYSDK_OFFSET(0xD965840)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xD965930)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0xD965940)
