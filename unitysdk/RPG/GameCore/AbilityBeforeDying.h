...
#define RPG_GAMECORE_ABILITYBEFOREDYING_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xD8EC280)
#define RPG_GAMECORE_ABILITYBEFOREDYING_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD8EC240)
#define RPG_GAMECORE_ABILITYBEFOREDYING_INIT_OFFSET UNITYSDK_OFFSET(0xD8EC1F0)
#define RPG_GAMECORE_ABILITYBEFOREDYING__CTOR_OFFSET UNITYSDK_OFFSET(0xD8EC2D0)
