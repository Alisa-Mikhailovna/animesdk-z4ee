...
#define RPG_GAMECORE_SHAREDINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B8C0400)
#define RPG_GAMECORE_SHAREDINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B8C0440)
#define RPG_GAMECORE_SHAREDINT_METHOD_3_6298D73FAACC4622_OFFSET UNITYSDK_OFFSET(0x1B8C02E0)
#define RPG_GAMECORE_SHAREDINT_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1B8C03F0)
#define RPG_GAMECORE_SHAREDINT_METHOD_3_D606EE9005CB8215_OFFSET UNITYSDK_OFFSET(0x1B8C02A0)
#define RPG_GAMECORE_SHAREDINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C02D0)
