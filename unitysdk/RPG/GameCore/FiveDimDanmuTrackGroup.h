...
#define RPG_GAMECORE_FIVEDIMDANMUTRACKGROUP_METHOD_2_566617BADDF04B47_OFFSET UNITYSDK_OFFSET(0x1B427E70)
#define RPG_GAMECORE_FIVEDIMDANMUTRACKGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B427FB0)
