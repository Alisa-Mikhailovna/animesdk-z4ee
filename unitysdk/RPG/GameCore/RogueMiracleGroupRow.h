...
#define RPG_GAMECORE_ROGUEMIRACLEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B773740)
#define RPG_GAMECORE_ROGUEMIRACLEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B773890)
