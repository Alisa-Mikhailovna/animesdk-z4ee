...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKCONFIG_METHOD_2_B15DA7971D71BC9B_OFFSET UNITYSDK_OFFSET(0x1B9C3E80)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKCONFIG_METHOD_2_C219FA2796262EB7_OFFSET UNITYSDK_OFFSET(0x1B9C3130)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C6470)
