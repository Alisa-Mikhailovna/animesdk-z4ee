...
#define RPG_GAMECORE_AIAVATARBASETYPESELECTOR_METHOD_3_364B1D26533C5FED_OFFSET UNITYSDK_OFFSET(0x1B0EDBB0)
#define RPG_GAMECORE_AIAVATARBASETYPESELECTOR_METHOD_3_BBD009CB5B03889A_OFFSET UNITYSDK_OFFSET(0x1B0EDB60)
#define RPG_GAMECORE_AIAVATARBASETYPESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EDBA0)
