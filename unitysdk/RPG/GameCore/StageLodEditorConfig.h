...
#define RPG_GAMECORE_STAGELODEDITORCONFIG_METHOD_2_9EE9587EB386AF1F_OFFSET UNITYSDK_OFFSET(0x1B8FD860)
#define RPG_GAMECORE_STAGELODEDITORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8FD9D0)
