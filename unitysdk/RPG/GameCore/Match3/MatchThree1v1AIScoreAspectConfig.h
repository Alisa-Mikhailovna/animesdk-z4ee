...
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AISCOREASPECTCONFIG_METHOD_2_B3C2C61961A7052E_OFFSET UNITYSDK_OFFSET(0x1B5C8800)
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AISCOREASPECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C8980)
