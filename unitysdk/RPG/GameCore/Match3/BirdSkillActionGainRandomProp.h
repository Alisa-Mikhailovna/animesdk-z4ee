...
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGAINRANDOMPROP_METHOD_5_89BBF369C3E82F1E_OFFSET UNITYSDK_OFFSET(0x1B5C39E0)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGAINRANDOMPROP_METHOD_5_C4AE5193A926C21B_OFFSET UNITYSDK_OFFSET(0x1B5C3920)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGAINRANDOMPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C39D0)
