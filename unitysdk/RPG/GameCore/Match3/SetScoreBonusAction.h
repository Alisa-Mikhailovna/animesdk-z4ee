...
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION_METHOD_5_5D70322A3CACDCB8_OFFSET UNITYSDK_OFFSET(0x1B5C9F40)
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION_METHOD_5_B8FC9CD481543706_OFFSET UNITYSDK_OFFSET(0x1B5C9FA0)
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C9F90)
