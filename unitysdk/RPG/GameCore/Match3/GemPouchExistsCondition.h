...
#define RPG_GAMECORE_MATCH3_GEMPOUCHEXISTSCONDITION_METHOD_5_8E4CBE21998C37E2_OFFSET UNITYSDK_OFFSET(0x1B5C49B0)
#define RPG_GAMECORE_MATCH3_GEMPOUCHEXISTSCONDITION_METHOD_5_ADEA620B69BDEDB6_OFFSET UNITYSDK_OFFSET(0x1B5C48A0)
#define RPG_GAMECORE_MATCH3_GEMPOUCHEXISTSCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C49A0)
