...
#define RPG_GAMECORE_MATCH3_MATCHTHREEPROPCONFIG_METHOD_2_9A0ED06FBA2DC4CC_OFFSET UNITYSDK_OFFSET(0x1B5C8990)
#define RPG_GAMECORE_MATCH3_MATCHTHREEPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C8CB0)
