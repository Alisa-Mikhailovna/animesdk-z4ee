...
#define RPG_GAMECORE_MATCH3_BEFOREINPUTTRIGGER_METHOD_4_10B32EF2C26D4180_OFFSET UNITYSDK_OFFSET(0x1B5C35C0)
#define RPG_GAMECORE_MATCH3_BEFOREINPUTTRIGGER_METHOD_4_7F0B9261D0824945_OFFSET UNITYSDK_OFFSET(0x1B5C3520)
#define RPG_GAMECORE_MATCH3_BEFOREINPUTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C35B0)
