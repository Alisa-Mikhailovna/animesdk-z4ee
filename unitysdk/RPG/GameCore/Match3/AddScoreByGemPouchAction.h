...
#define RPG_GAMECORE_MATCH3_ADDSCOREBYGEMPOUCHACTION_METHOD_5_1B601DEFDBDB86C8_OFFSET UNITYSDK_OFFSET(0x1B5C2DF0)
#define RPG_GAMECORE_MATCH3_ADDSCOREBYGEMPOUCHACTION_METHOD_5_75D826E496F8D7D4_OFFSET UNITYSDK_OFFSET(0x1B5C2E50)
#define RPG_GAMECORE_MATCH3_ADDSCOREBYGEMPOUCHACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C2E40)
