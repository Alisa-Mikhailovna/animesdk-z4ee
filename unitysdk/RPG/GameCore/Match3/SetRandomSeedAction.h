...
#define RPG_GAMECORE_MATCH3_SETRANDOMSEEDACTION_METHOD_5_1551C07811D0AAA6_OFFSET UNITYSDK_OFFSET(0x1B5C9E60)
#define RPG_GAMECORE_MATCH3_SETRANDOMSEEDACTION_METHOD_5_42F8D5551BBC43AA_OFFSET UNITYSDK_OFFSET(0x1B5C9E00)
#define RPG_GAMECORE_MATCH3_SETRANDOMSEEDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C9E50)
