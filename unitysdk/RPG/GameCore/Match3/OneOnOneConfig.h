...
#define RPG_GAMECORE_MATCH3_ONEONONECONFIG_METHOD_2_631FD98FBF79071D_OFFSET UNITYSDK_OFFSET(0x1B5C70E0)
#define RPG_GAMECORE_MATCH3_ONEONONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C8CD0)
