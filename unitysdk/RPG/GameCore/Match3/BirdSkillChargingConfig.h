...
#define RPG_GAMECORE_MATCH3_BIRDSKILLCHARGINGCONFIG_METHOD_2_096D7C2B0D193E44_OFFSET UNITYSDK_OFFSET(0x1B5C3FC0)
#define RPG_GAMECORE_MATCH3_BIRDSKILLCHARGINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C4100)
