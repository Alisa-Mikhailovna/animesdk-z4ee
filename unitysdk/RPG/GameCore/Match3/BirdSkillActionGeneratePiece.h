...
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEPIECE_METHOD_5_D927DB1AF5D951D2_OFFSET UNITYSDK_OFFSET(0x1B5C3E20)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEPIECE_METHOD_5_ECFA267E5798C69F_OFFSET UNITYSDK_OFFSET(0x1B5C3DE0)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEPIECE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C3E10)
