...
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATEACTION_METHOD_5_3B8D71B1689B0B90_OFFSET UNITYSDK_OFFSET(0x1B5C31A0)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATEACTION_METHOD_5_419CA14AD008FA68_OFFSET UNITYSDK_OFFSET(0x1B5C3140)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C3190)
