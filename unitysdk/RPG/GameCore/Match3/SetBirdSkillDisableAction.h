...
#define RPG_GAMECORE_MATCH3_SETBIRDSKILLDISABLEACTION_METHOD_5_3B5BE9022E6A124E_OFFSET UNITYSDK_OFFSET(0x1B5C9B30)
#define RPG_GAMECORE_MATCH3_SETBIRDSKILLDISABLEACTION_METHOD_5_F41C94B33F52ECAE_OFFSET UNITYSDK_OFFSET(0x1B5C9AD0)
#define RPG_GAMECORE_MATCH3_SETBIRDSKILLDISABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C9B20)
