...
#define RPG_GAMECORE_MATCH3_CHESSBOARDCONFIG_METHOD_2_6A90AFB6B25939CA_OFFSET UNITYSDK_OFFSET(0x1B5C4420)
#define RPG_GAMECORE_MATCH3_CHESSBOARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C45C0)
