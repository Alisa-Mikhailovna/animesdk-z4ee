...
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEBOMBTOMULTISTYLEACTION_METHOD_5_1372DD688D0FBD28_OFFSET UNITYSDK_OFFSET(0x1B5C9010)
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEBOMBTOMULTISTYLEACTION_METHOD_5_D1E653485E1A3154_OFFSET UNITYSDK_OFFSET(0x1B5C8FB0)
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEBOMBTOMULTISTYLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C9000)
