...
#define RPG_GAMECORE_MATCH3_MATCH3CHESSBOARDGRIDINFO_METHOD_2_4911C675EA4D4ED1_OFFSET UNITYSDK_OFFSET(0x1B5C52C0)
#define RPG_GAMECORE_MATCH3_MATCH3CHESSBOARDGRIDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C5560)
