...
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AILEVELCONFIG_METHOD_2_872FC6E20B81FC73_OFFSET UNITYSDK_OFFSET(0x1B5C8250)
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AILEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C83F0)
