...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_D86C4F8B9D5BB5E6_OFFSET UNITYSDK_OFFSET(0x1B4EDE50)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_FDB9E6D07E118B25_OFFSET UNITYSDK_OFFSET(0x1B4EDE90)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EDE80)
