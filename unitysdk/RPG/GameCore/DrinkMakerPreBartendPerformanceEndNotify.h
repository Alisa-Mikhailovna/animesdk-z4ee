...
#define RPG_GAMECORE_DRINKMAKERPREBARTENDPERFORMANCEENDNOTIFY_METHOD_3_CF4E2E6529C5B6CC_OFFSET UNITYSDK_OFFSET(0x1B3C90D0)
#define RPG_GAMECORE_DRINKMAKERPREBARTENDPERFORMANCEENDNOTIFY_METHOD_3_EE05EC9A9C681C09_OFFSET UNITYSDK_OFFSET(0x1B3C9000)
#define RPG_GAMECORE_DRINKMAKERPREBARTENDPERFORMANCEENDNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C90C0)
