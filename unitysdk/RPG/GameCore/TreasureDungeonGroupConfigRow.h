...
#define RPG_GAMECORE_TREASUREDUNGEONGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B98F990)
#define RPG_GAMECORE_TREASUREDUNGEONGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B98FEB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 HpConversionRate; // 0x30
		::System::UInt32 ATKExchangeRatio; // 0x34
		::System::UInt32 ActivityModuleID; // 0x38
		::System::UInt32 MaxDEF; // 0x3C
		::RPG::Client::TextID ATKExchangeName; // 0x40
		::RPG::Client::TextID Name; // 0x50
		::System::UInt32 ATKMazeBuffID; // 0x60
		::System::UInt32 GroupID; // 0x64
		::System::UInt32 DEFExchangeRatio; // 0x68
		::System::UInt32 MaxATK; // 0x6C
