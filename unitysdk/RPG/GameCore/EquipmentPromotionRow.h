...
#define RPG_GAMECORE_EQUIPMENTPROMOTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B3F2CC0)
#define RPG_GAMECORE_EQUIPMENTPROMOTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3F36A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint BaseAttackAdd; // 0x38
		::RPG::GameCore::FixPoint BaseDefenceAdd; // 0x40
		::System::UInt32 Promotion; // 0x48
		::System::UInt32 MaxLevel; // 0x4C
		::System::UInt32 PlayerLevelRequire; // 0x50
