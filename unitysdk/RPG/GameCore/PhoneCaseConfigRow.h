...
#define RPG_GAMECORE_PHONECASECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6A3780)
#define RPG_GAMECORE_PHONECASECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A39E0)
