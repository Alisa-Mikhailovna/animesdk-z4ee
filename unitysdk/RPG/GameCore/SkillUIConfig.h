...
#define RPG_GAMECORE_SKILLUICONFIG_METHOD_2_22C6E7F91ABF035A_OFFSET UNITYSDK_OFFSET(0x1B8DDFA0)
#define RPG_GAMECORE_SKILLUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8DF7C0)
