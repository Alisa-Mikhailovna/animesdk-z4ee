...
#define RPG_GAMECORE_SETLEVELFINISH_METHOD_3_1D4D3C2D15F80A1E_OFFSET UNITYSDK_OFFSET(0x1B8A7E50)
#define RPG_GAMECORE_SETLEVELFINISH_METHOD_3_583F9A56FB369D1B_OFFSET UNITYSDK_OFFSET(0x1B8A7D80)
#define RPG_GAMECORE_SETLEVELFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A7E40)
