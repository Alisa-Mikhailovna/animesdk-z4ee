...
#define RPG_GAMECORE_ENTITYSPAWNCONFIG_METHOD_2_4804E50858EF8AB8_OFFSET UNITYSDK_OFFSET(0x1B3EC300)
#define RPG_GAMECORE_ENTITYSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3ED7F0)
