...
#define RPG_GAMECORE_TARGETFETCHCALLBACKMODIFIERCASTER_METHOD_4_2ADF4B0C9F36FB63_OFFSET UNITYSDK_OFFSET(0x1B94CEB0)
#define RPG_GAMECORE_TARGETFETCHCALLBACKMODIFIERCASTER_METHOD_4_6626940828AF1B9A_OFFSET UNITYSDK_OFFSET(0x1B94CFB0)
#define RPG_GAMECORE_TARGETFETCHCALLBACKMODIFIERCASTER_METHOD_4_8CEAF60DC65EB4E2_OFFSET UNITYSDK_OFFSET(0x1B94CF30)
#define RPG_GAMECORE_TARGETFETCHCALLBACKMODIFIERCASTER_METHOD_4_E113E2D629CB5E67_OFFSET UNITYSDK_OFFSET(0x1B94CF90)
#define RPG_GAMECORE_TARGETFETCHCALLBACKMODIFIERCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B94CF20)
