...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ALL_METHOD_3_08C9ADE3B4B31852_OFFSET UNITYSDK_OFFSET(0x1B3AE2A0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ALL_METHOD_3_99D027A2B9FA4853_OFFSET UNITYSDK_OFFSET(0x1B3AD3C0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3AD3B0)
