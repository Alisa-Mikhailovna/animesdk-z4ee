...
#define RPG_GAMECORE_PIXAIRENEMYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6B2DE0)
#define RPG_GAMECORE_PIXAIRENEMYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B3070)
