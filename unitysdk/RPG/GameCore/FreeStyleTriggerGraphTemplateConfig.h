...
#define RPG_GAMECORE_FREESTYLETRIGGERGRAPHTEMPLATECONFIG_METHOD_2_EE0CCF5F8CAFCD6F_OFFSET UNITYSDK_OFFSET(0x1B4A2400)
#define RPG_GAMECORE_FREESTYLETRIGGERGRAPHTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A24E0)
