...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERDRINK_METHOD_4_533361F3D420D974_OFFSET UNITYSDK_OFFSET(0x1B7D9A70)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERDRINK_METHOD_4_D2999C1DAC264FB1_OFFSET UNITYSDK_OFFSET(0x1B7D9B40)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERDRINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7D9B30)
