...
#define RPG_GAMECORE_GRIDFIGHTACTIONLIST_METHOD_2_0D9901B3119E3398_OFFSET UNITYSDK_OFFSET(0x1B4D0770)
#define RPG_GAMECORE_GRIDFIGHTACTIONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D07B0)
