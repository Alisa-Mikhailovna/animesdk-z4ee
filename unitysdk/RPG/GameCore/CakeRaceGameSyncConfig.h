...
#define RPG_GAMECORE_CAKERACEGAMESYNCCONFIG_METHOD_2_C0256E18DCD037AA_OFFSET UNITYSDK_OFFSET(0x1B2F9DF0)
#define RPG_GAMECORE_CAKERACEGAMESYNCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FA530)
