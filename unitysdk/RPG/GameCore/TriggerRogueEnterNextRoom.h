...
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM_METHOD_3_35DD831820197305_OFFSET UNITYSDK_OFFSET(0x1B9A8540)
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM_METHOD_3_45A1C714AEF01088_OFFSET UNITYSDK_OFFSET(0x1B9A8470)
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A8530)
