...
#define RPG_GAMECORE_REALTIMECONST_GET_REVERSEDMODIFIERSTATUSTYPEIMMUNEMAP_OFFSET UNITYSDK_OFFSET(0x1B707850)
#define RPG_GAMECORE_REALTIMECONST_GET_REVERSEMODIFIERBEHAVIORFLAGIMMUNEMAP_OFFSET UNITYSDK_OFFSET(0x1B707C70)
#define RPG_GAMECORE_REALTIMECONST_METHOD_2_3DA1C6D86A162460_OFFSET UNITYSDK_OFFSET(0x1B707370)
#define RPG_GAMECORE_REALTIMECONST_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x1B707700)
#define RPG_GAMECORE_REALTIMECONST_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1B707780)
#define RPG_GAMECORE_REALTIMECONST_METHOD_2_CF8DAE60A62181DC_OFFSET UNITYSDK_OFFSET(0x1B7077A0)
#define RPG_GAMECORE_REALTIMECONST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7076E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::RealtimeConst**)Il2CppClass::FromTypeDefinitionIndex(RealtimeConst_TypeDefinitionIndex)->GetStaticField(0x2C30);
		}
