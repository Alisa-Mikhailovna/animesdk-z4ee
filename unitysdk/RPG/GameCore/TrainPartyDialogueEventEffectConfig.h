...
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTEFFECTCONFIG_METHOD_2_49B4A0675CB2D02F_OFFSET UNITYSDK_OFFSET(0x1B97FE80)
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97FEC0)
