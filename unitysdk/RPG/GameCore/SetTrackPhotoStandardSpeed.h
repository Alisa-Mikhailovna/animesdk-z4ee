...
#define RPG_GAMECORE_SETTRACKPHOTOSTANDARDSPEED_METHOD_3_9A65B1F8FF91E5CE_OFFSET UNITYSDK_OFFSET(0x1B8B8210)
#define RPG_GAMECORE_SETTRACKPHOTOSTANDARDSPEED_METHOD_3_E3AE731B0EE47AED_OFFSET UNITYSDK_OFFSET(0x1B8B81D0)
#define RPG_GAMECORE_SETTRACKPHOTOSTANDARDSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B8200)
