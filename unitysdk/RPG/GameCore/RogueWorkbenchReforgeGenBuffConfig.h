...
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFCONFIG_METHOD_2_FDEB3DF4772B72BA_OFFSET UNITYSDK_OFFSET(0x1B7A52E0)
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A5320)
