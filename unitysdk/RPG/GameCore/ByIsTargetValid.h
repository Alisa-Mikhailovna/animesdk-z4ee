...
#define RPG_GAMECORE_BYISTARGETVALID_METHOD_4_5AE8CDE9A09C958A_OFFSET UNITYSDK_OFFSET(0x1B2D0B20)
#define RPG_GAMECORE_BYISTARGETVALID_METHOD_4_B135880BC1B0E8B8_OFFSET UNITYSDK_OFFSET(0x1B2D08E0)
#define RPG_GAMECORE_BYISTARGETVALID_METHOD_4_B48B75BE1E3C3624_OFFSET UNITYSDK_OFFSET(0x1B2D0B50)
#define RPG_GAMECORE_BYISTARGETVALID_METHOD_4_D0A4E98BFF6176DD_OFFSET UNITYSDK_OFFSET(0x1B2D08A0)
#define RPG_GAMECORE_BYISTARGETVALID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D08D0)
