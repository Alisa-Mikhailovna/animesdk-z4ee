...
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET_METHOD_4_191C2F1F7FBAA480_OFFSET UNITYSDK_OFFSET(0x1B2A9E90)
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET_METHOD_4_6FEE44EB054529B0_OFFSET UNITYSDK_OFFSET(0x1B2AA030)
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET_METHOD_4_A09DD7744D8E2347_OFFSET UNITYSDK_OFFSET(0x1B2AA060)
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET_METHOD_4_E7BAEE75BBC3A315_OFFSET UNITYSDK_OFFSET(0x1B2A9E50)
#define RPG_GAMECORE_BYISCURRENTSKILLALLOWMULTITARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A9E80)
