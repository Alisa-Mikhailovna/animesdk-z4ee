...
#define RPG_GAMECORE_UPDATEMONSTERFOOTIKMODE_METHOD_3_08A25BE316AA0B29_OFFSET UNITYSDK_OFFSET(0x1B9C7140)
#define RPG_GAMECORE_UPDATEMONSTERFOOTIKMODE_METHOD_3_C3E51B37E7CF5FEC_OFFSET UNITYSDK_OFFSET(0x1B9C7100)
#define RPG_GAMECORE_UPDATEMONSTERFOOTIKMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C7130)
