...
#define RPG_GAMECORE_SPECIALCHESTFINDDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B8EC960)
#define RPG_GAMECORE_SPECIALCHESTFINDDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8ECC80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ReplaceInstanceID; // 0x14
		::System::UInt32 InstanceID; // 0x18
		::System::UInt32 ReplaceLittleGameEntityID; // 0x1C
