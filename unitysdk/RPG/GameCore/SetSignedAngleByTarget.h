...
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET_METHOD_3_D41B5305ABACFA18_OFFSET UNITYSDK_OFFSET(0x1B8B0E50)
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET_METHOD_3_EDF7BF93CB62158D_OFFSET UNITYSDK_OFFSET(0x1B8B0E90)
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8B0E80)
