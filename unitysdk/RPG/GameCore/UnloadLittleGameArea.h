...
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA_METHOD_3_00C6D5159BDA3386_OFFSET UNITYSDK_OFFSET(0x1B9C68B0)
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA_METHOD_3_B624C2FE75A1A29E_OFFSET UNITYSDK_OFFSET(0x1B9C6930)
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C6900)
