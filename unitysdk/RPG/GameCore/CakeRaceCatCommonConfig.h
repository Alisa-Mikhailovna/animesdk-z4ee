...
#define RPG_GAMECORE_CAKERACECATCOMMONCONFIG_METHOD_2_922A6DA3585D6B6C_OFFSET UNITYSDK_OFFSET(0x1B2F7350)
#define RPG_GAMECORE_CAKERACECATCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F7930)
