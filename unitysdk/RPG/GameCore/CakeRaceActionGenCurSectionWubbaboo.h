...
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONWUBBABOO_METHOD_3_2E22473C0EF98D12_OFFSET UNITYSDK_OFFSET(0x1B2F3C20)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONWUBBABOO_METHOD_3_F73F9EFDE1373517_OFFSET UNITYSDK_OFFSET(0x1B2F3B70)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONWUBBABOO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F3C10)
