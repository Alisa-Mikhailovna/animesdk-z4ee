...
#define RPG_GAMECORE_VE_RTGRIDDISTANCE_METHOD_3_2FC0A58C508B2192_OFFSET UNITYSDK_OFFSET(0x1B9D4BB0)
#define RPG_GAMECORE_VE_RTGRIDDISTANCE_METHOD_3_35FC0FC06BD5D211_OFFSET UNITYSDK_OFFSET(0x1B9D4D70)
#define RPG_GAMECORE_VE_RTGRIDDISTANCE_METHOD_3_832E6B6F1A47B3A6_OFFSET UNITYSDK_OFFSET(0x1B9D4DA0)
#define RPG_GAMECORE_VE_RTGRIDDISTANCE_METHOD_3_E8B9FF8A1538795B_OFFSET UNITYSDK_OFFSET(0x1B9D4B70)
#define RPG_GAMECORE_VE_RTGRIDDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D4BA0)
