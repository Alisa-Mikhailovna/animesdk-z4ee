...
#define RPG_GAMECORE_TRIGGERHITTARGET_METHOD_3_1A419D080CA4B90F_OFFSET UNITYSDK_OFFSET(0x1B9A3D00)
#define RPG_GAMECORE_TRIGGERHITTARGET_METHOD_3_E839FF0A6286676A_OFFSET UNITYSDK_OFFSET(0x1B9A3CB0)
#define RPG_GAMECORE_TRIGGERHITTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A3CF0)
