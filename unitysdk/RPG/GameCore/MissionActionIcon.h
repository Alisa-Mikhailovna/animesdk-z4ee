...
#define RPG_GAMECORE_MISSIONACTIONICON_METHOD_2_5AD2C437A98BBBED_OFFSET UNITYSDK_OFFSET(0x1B5FBB80)
#define RPG_GAMECORE_MISSIONACTIONICON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5FBD40)
