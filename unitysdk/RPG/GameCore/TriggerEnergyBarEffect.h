...
#define RPG_GAMECORE_TRIGGERENERGYBAREFFECT_METHOD_3_1A85060C061433F0_OFFSET UNITYSDK_OFFSET(0x1B9A2210)
#define RPG_GAMECORE_TRIGGERENERGYBAREFFECT_METHOD_3_DAE9B80E8E12C6FF_OFFSET UNITYSDK_OFFSET(0x1B9A2170)
#define RPG_GAMECORE_TRIGGERENERGYBAREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A21D0)
