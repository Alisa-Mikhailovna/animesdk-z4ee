...
#define RPG_GAMECORE_MARBLEADDSKILLLOG_METHOD_3_35473BCC0A8C0EB4_OFFSET UNITYSDK_OFFSET(0x1B5B16B0)
#define RPG_GAMECORE_MARBLEADDSKILLLOG_METHOD_3_E2212AFEA6C50032_OFFSET UNITYSDK_OFFSET(0x1B5B1710)
#define RPG_GAMECORE_MARBLEADDSKILLLOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B1700)
