...
#define RPG_GAMECORE_SWORDTRAININGPROGRESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B938530)
#define RPG_GAMECORE_SWORDTRAININGPROGRESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B938970)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ExamID; // 0x28
		::System::UInt32 TurnID; // 0x2C
		::RPG::Client::TextID TurnName; // 0x30
		::RPG::Client::TextID PartnerAbilitySelectHint; // 0x40
		::RPG::Client::TextID SectionHint; // 0x50
