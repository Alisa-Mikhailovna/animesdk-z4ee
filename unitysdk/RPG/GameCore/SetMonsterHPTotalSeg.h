...
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG_METHOD_3_BA2C3602F97BFBDF_OFFSET UNITYSDK_OFFSET(0x1B8ABAE0)
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG_METHOD_3_D2EEDCF5ACE0519C_OFFSET UNITYSDK_OFFSET(0x1B8ABA40)
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8ABAA0)
