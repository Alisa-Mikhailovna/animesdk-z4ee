...
#define RPG_GAMECORE_ADVENTUREABILITYMOVESPEEDATTENUATIONRATIOCHANGE_GETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xD93FB70)
#define RPG_GAMECORE_ADVENTUREABILITYMOVESPEEDATTENUATIONRATIOCHANGE_GETCURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xD93FBB0)
#define RPG_GAMECORE_ADVENTUREABILITYMOVESPEEDATTENUATIONRATIOCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xD93FAE0)
#define RPG_GAMECORE_ADVENTUREABILITYMOVESPEEDATTENUATIONRATIOCHANGE_GETORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xD93FB30)
#define RPG_GAMECORE_ADVENTUREABILITYMOVESPEEDATTENUATIONRATIOCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD93FAA0)
#define RPG_GAMECORE_ADVENTUREABILITYMOVESPEEDATTENUATIONRATIOCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xD93C7E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint _CurrentValue; // 0x20
