...
#define RPG_GAMECORE_BATTLEENTITYWHITEBOXDATA_METHOD_2_CA9848C34BA53381_OFFSET UNITYSDK_OFFSET(0x1B1F4F40)
#define RPG_GAMECORE_BATTLEENTITYWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F5430)
