...
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_BEGINSTREAMING_OFFSET UNITYSDK_OFFSET(0xDC71CE0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_GET_ISSTREAMINGACTIVE_OFFSET UNITYSDK_OFFSET(0xDC71CD0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_GET_ROOT_OFFSET UNITYSDK_OFFSET(0xDC71CC0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_LOADALLBLOCKS_OFFSET UNITYSDK_OFFSET(0xDC6F7E0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_METHOD_5_063F564577189A4C_OFFSET UNITYSDK_OFFSET(0xDC71A40)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_METHOD_5_2747B6E1C570CBE2_OFFSET UNITYSDK_OFFSET(0xDC70540)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_METHOD_5_377D2CC1DEAB8813_OFFSET UNITYSDK_OFFSET(0xDC71BB0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_METHOD_5_686221D5DF498040_OFFSET UNITYSDK_OFFSET(0xDC70270)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_METHOD_5_92543571E195A33B_OFFSET UNITYSDK_OFFSET(0xDC71F10)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_METHOD_5_AD4F6DA9E13A593D_OFFSET UNITYSDK_OFFSET(0xDC70010)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDC6FFC0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDC6F780)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_STARTSTREAMINGFROMCONFIG_OFFSET UNITYSDK_OFFSET(0xDC71E10)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_STOPSTREAMING_OFFSET UNITYSDK_OFFSET(0xDC71EC0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDC703D0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC71FD0)
