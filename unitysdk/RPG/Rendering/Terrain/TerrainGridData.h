...
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_BLOCKCOUNT_OFFSET UNITYSDK_OFFSET(0xDC6F370)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_BLOCKSIZE_OFFSET UNITYSDK_OFFSET(0xDC6F630)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_CREATEORIGIN_OFFSET UNITYSDK_OFFSET(0xDC6F320)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDCOLMIN_OFFSET UNITYSDK_OFFSET(0xDC6F2F0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDCOLUMNS_OFFSET UNITYSDK_OFFSET(0xDC6F310)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDROWMIN_OFFSET UNITYSDK_OFFSET(0xDC6F2E0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_GRIDROWS_OFFSET UNITYSDK_OFFSET(0xDC6F300)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_ROOTNAME_OFFSET UNITYSDK_OFFSET(0xDC6F360)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_TERRAINHEIGHT_OFFSET UNITYSDK_OFFSET(0xDC6F350)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_GET_TERRAINLATERALSIZE_OFFSET UNITYSDK_OFFSET(0xDC6F340)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_METHOD_3_03E0F1DB854D5804_OFFSET UNITYSDK_OFFSET(0xDC6F590)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_METHOD_3_987AD1B6E19A63AC_OFFSET UNITYSDK_OFFSET(0xDC6F3C0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA_METHOD_3_B6B7014A78386E25_OFFSET UNITYSDK_OFFSET(0xDC6F4C0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDC6F6A0)
