...
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_GETMARKEDBLOCKSFOREDITOR_OFFSET UNITYSDK_OFFSET(0xDC72610)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xDC720D0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_SETBOXOFFSET_OFFSET UNITYSDK_OFFSET(0xDC721B0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_SETBOXSIZE_OFFSET UNITYSDK_OFFSET(0xDC72150)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_SETMARKEDBLOCKS_OFFSET UNITYSDK_OFFSET(0xDC72210)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER_SETSTAGENAME_OFFSET UNITYSDK_OFFSET(0xDC720E0)
#define RPG_RENDERING_TERRAIN_TERRAINGRIDROOTMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC726A0)
