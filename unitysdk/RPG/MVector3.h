...
#define RPG_MVECTOR3_ANGLEBETWEEN_OFFSET UNITYSDK_OFFSET(0x1BB01D90)
#define RPG_MVECTOR3_ANGLE_OFFSET UNITYSDK_OFFSET(0x1BB01450)
#define RPG_MVECTOR3_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1BB01840)
#define RPG_MVECTOR3_CLAMPMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1BB01890)
#define RPG_MVECTOR3_CROSS_OFFSET UNITYSDK_OFFSET(0x1BB00F00)
#define RPG_MVECTOR3_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1BB017B0)
#define RPG_MVECTOR3_DOT_OFFSET UNITYSDK_OFFSET(0x1BB010E0)
#define RPG_MVECTOR3_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A09F60)
#define RPG_MVECTOR3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A09F00)
#define RPG_MVECTOR3_GET_BACK_OFFSET UNITYSDK_OFFSET(0x1BB01A60)
#define RPG_MVECTOR3_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x1BB01AA0)
#define RPG_MVECTOR3_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x1BB01A40)
#define RPG_MVECTOR3_GET_FWD_OFFSET UNITYSDK_OFFSET(0x1BB01D70)
#define RPG_MVECTOR3_GET_ISINFINITY_OFFSET UNITYSDK_OFFSET(0x3A09D30)
#define RPG_MVECTOR3_GET_ISNAN_OFFSET UNITYSDK_OFFSET(0x3A09CF0)
#define RPG_MVECTOR3_GET_ISNEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x3A09D90)
#define RPG_MVECTOR3_GET_ISPOSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x3A09D70)
#define RPG_MVECTOR3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3A09DB0)
#define RPG_MVECTOR3_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x1BB01AC0)
#define RPG_MVECTOR3_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x3A0A140)
#define RPG_MVECTOR3_GET_NEGATIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1BB01B20)
#define RPG_MVECTOR3_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x3A0A0B0)
#define RPG_MVECTOR3_GET_ONE_OFFSET UNITYSDK_OFFSET(0x1BB01A20)
#define RPG_MVECTOR3_GET_POSITIVEINFINITY_OFFSET UNITYSDK_OFFSET(0x1BB01B00)
#define RPG_MVECTOR3_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1BB01AE0)
#define RPG_MVECTOR3_GET_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x3A0A170)
#define RPG_MVECTOR3_GET_UP_OFFSET UNITYSDK_OFFSET(0x1BB01A80)
#define RPG_MVECTOR3_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1BB01A00)
#define RPG_MVECTOR3_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1BB00B70)
#define RPG_MVECTOR3_LERP_OFFSET UNITYSDK_OFFSET(0x1BB00B20)
#define RPG_MVECTOR3_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1BB011C0)
#define RPG_MVECTOR3_MAX_OFFSET UNITYSDK_OFFSET(0x1BB019D0)
#define RPG_MVECTOR3_MIN_OFFSET UNITYSDK_OFFSET(0x1BB019A0)
#define RPG_MVECTOR3_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x1BB00BB0)
#define RPG_MVECTOR3_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x3A0A020)
#define RPG_MVECTOR3_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1BB01130)
#define RPG_MVECTOR3_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1BB00D30)
#define RPG_MVECTOR3_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1BB00CF0)
#define RPG_MVECTOR3_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1BB01B70)
#define RPG_MVECTOR3_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1BB01BC0)
#define RPG_MVECTOR3_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1BB01110)
#define RPG_MVECTOR3_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1BB00D10)
#define RPG_MVECTOR3_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1BB00C90)
#define RPG_MVECTOR3_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1BB01B40)
#define RPG_MVECTOR3_PROJECTONPLANE_OFFSET UNITYSDK_OFFSET(0x1BB013A0)
#define RPG_MVECTOR3_PROJECT_OFFSET UNITYSDK_OFFSET(0x1BB01310)
#define RPG_MVECTOR3_REFLECT_OFFSET UNITYSDK_OFFSET(0x1BB01070)
#define RPG_MVECTOR3_SCALE_1_OFFSET UNITYSDK_OFFSET(0x3A09EE0)
#define RPG_MVECTOR3_SCALE_OFFSET UNITYSDK_OFFSET(0x1BB00EA0)
#define RPG_MVECTOR3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x3A09E30)
#define RPG_MVECTOR3_SET_OFFSET UNITYSDK_OFFSET(0x144B90)
#define RPG_MVECTOR3_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x1BB015B0)
#define RPG_MVECTOR3_SQRDISTANCE_OFFSET UNITYSDK_OFFSET(0x1BB01800)
#define RPG_MVECTOR3_SQRMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1BB01980)
#define RPG_MVECTOR3_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3A0A240)
#define RPG_MVECTOR3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A0A190)
#define RPG_MVECTOR3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BB01EE0)
#define RPG_MVECTOR3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A09EC0)
#define RPG_MVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x144B90)
