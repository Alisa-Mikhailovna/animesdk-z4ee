...
#define RPG_HASHUTILS_THREADFILESTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1BAFBF50)
#define RPG_HASHUTILS_THREADFILESTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFAEA0)
