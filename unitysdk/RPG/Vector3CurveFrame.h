...
#define RPG_VECTOR3CURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3A0A320)
#define RPG_VECTOR3CURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0xD4D0)
#define RPG_VECTOR3CURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0x14B2C0)
#define RPG_VECTOR3CURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x3A0A300)
