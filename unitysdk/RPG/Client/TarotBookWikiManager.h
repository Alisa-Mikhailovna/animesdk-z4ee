...
#define RPG_CLIENT_TAROTBOOKWIKIMANAGER_GETALLDATA_OFFSET UNITYSDK_OFFSET(0xD62F630)
#define RPG_CLIENT_TAROTBOOKWIKIMANAGER_GET_FIRSTTIMEJUMPTOID_OFFSET UNITYSDK_OFFSET(0xD62F400)
#define RPG_CLIENT_TAROTBOOKWIKIMANAGER_GET_ISFIRSTTIME_OFFSET UNITYSDK_OFFSET(0xD62F350)
#define RPG_CLIENT_TAROTBOOKWIKIMANAGER_GET_WIKISCROLLTIME_OFFSET UNITYSDK_OFFSET(0xD62F510)
#define RPG_CLIENT_TAROTBOOKWIKIMANAGER_MARKALLDATASEEN_OFFSET UNITYSDK_OFFSET(0xD62F980)
#define RPG_CLIENT_TAROTBOOKWIKIMANAGER_MARKHASSEEN_OFFSET UNITYSDK_OFFSET(0xD62F880)
#define RPG_CLIENT_TAROTBOOKWIKIMANAGER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xD6271A0)
#define RPG_CLIENT_TAROTBOOKWIKIMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD627140)
