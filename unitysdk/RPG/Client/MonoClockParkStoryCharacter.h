...
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC3A290)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GETCURRENTANIMINFO_OFFSET UNITYSDK_OFFSET(0xCC3A5C0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_FLIPPED_OFFSET UNITYSDK_OFFSET(0xCC3A8C0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0xCC3A670)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xCC3A650)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0xCC3A630)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_INIT_OFFSET UNITYSDK_OFFSET(0xCC3A3B0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_PLAYANIMTOLOOP_OFFSET UNITYSDK_OFFSET(0xCC3A560)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xCC3A500)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0xCC3A680)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xCC3A660)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0xCC3A640)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC3A920)
