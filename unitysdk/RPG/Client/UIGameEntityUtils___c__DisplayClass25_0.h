...
#define RPG_CLIENT_UIGAMEENTITYUTILS___C__DISPLAYCLASS25_0__CACULATEFORCEKILLRATIO_B__0_OFFSET UNITYSDK_OFFSET(0xD7C3AD0)
#define RPG_CLIENT_UIGAMEENTITYUTILS___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD7C22E0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIGameEntityUtils___c__DisplayClass25_0_TypeDefinitionIndex = 69820;
