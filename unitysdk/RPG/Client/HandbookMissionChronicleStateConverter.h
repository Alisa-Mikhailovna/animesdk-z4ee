...
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLESTATECONVERTER_CONVERT_OFFSET UNITYSDK_OFFSET(0xC881B70)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLESTATECONVERTER_GETMAINPATHSTATE_OFFSET UNITYSDK_OFFSET(0xC8821B0)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLESTATECONVERTER_GETSUBITEMSTATE_OFFSET UNITYSDK_OFFSET(0xC8821F0)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLESTATECONVERTER_SETMAINPATH_OFFSET UNITYSDK_OFFSET(0xC8816B0)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLESTATECONVERTER__CONVERTMAINPATHSTATE_OFFSET UNITYSDK_OFFSET(0xC881BC0)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLESTATECONVERTER__CONVERTSUBDISPLAYDATASTATE_OFFSET UNITYSDK_OFFSET(0xC881ED0)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLESTATECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC881620)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLESTATECONVERTER__ISEARLYACCESSCANUNLOCK_OFFSET UNITYSDK_OFFSET(0xC8823A0)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLESTATECONVERTER___CONVERTMAINPATHSTATE_B__5_0_OFFSET UNITYSDK_OFFSET(0xC8825F0)
