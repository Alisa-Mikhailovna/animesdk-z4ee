...
#define RPG_CLIENT_MUSICALBUMGROUPDATA_ADDMUSICALBUM_OFFSET UNITYSDK_OFFSET(0xCE06230)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GETMUSICALBUMLIST_OFFSET UNITYSDK_OFFSET(0xCE06940)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GETMUSICALBUM_OFFSET UNITYSDK_OFFSET(0xCE068B0)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_GROUPICON_OFFSET UNITYSDK_OFFSET(0xCE06D30)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xCE06DF0)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0xCE06D80)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xCE06BF0)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCE06430)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_ISALLMUSICALBUMPLAYED_OFFSET UNITYSDK_OFFSET(0xCE06AA0)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_RESETSTATUS_OFFSET UNITYSDK_OFFSET(0xCE06580)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_SYNCMUSICALBUM_OFFSET UNITYSDK_OFFSET(0xCE06750)
#define RPG_CLIENT_MUSICALBUMGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE06190)
