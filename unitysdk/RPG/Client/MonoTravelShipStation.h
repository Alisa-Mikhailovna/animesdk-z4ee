...
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_GET_COLLIDERCENTER_OFFSET UNITYSDK_OFFSET(0xCD307A0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ISLOOKAT_OFFSET UNITYSDK_OFFSET(0xCD302E0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_0C65243341F1EFB1_OFFSET UNITYSDK_OFFSET(0xCD30A30)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0xCD30AE0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_5543817C5A5F79C6_OFFSET UNITYSDK_OFFSET(0xCD30B60)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_7933D8FAF1D97D04_OFFSET UNITYSDK_OFFSET(0xCD2FA20)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_86A88E9E65926C16_OFFSET UNITYSDK_OFFSET(0xCD2FD50)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_913947B6596EB50A_OFFSET UNITYSDK_OFFSET(0xCD300F0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xCD30070)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD2F830)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD2F680)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xCD2FBF0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0xCD2FF10)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0xCD30C60)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTravelShipStation_TypeDefinitionIndex)->GetStaticField(0x109C0);
		}
