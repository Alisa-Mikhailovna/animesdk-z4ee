...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC083A60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC083EC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC083920)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONFADEINFINISHED_OFFSET UNITYSDK_OFFSET(0xC083E10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONFADEOUTFINISHED_OFFSET UNITYSDK_OFFSET(0xC083E80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0836F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC083B40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0xC083C80)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesFeverToastControl_TypeDefinitionIndex = 76345;
