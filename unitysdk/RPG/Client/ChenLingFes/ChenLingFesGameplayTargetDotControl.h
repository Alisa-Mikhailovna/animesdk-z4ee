...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETDOTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0AB020)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETDOTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0AB100)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETDOTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0AAF30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETDOTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0AAEB0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayTargetDotControl_TypeDefinitionIndex = 76369;
