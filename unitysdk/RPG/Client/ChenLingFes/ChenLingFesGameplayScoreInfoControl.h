...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREINFOCONTROL_GETNODECURRENTSCORE_OFFSET UNITYSDK_OFFSET(0xC09E5B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREINFOCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC09FB30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREINFOCONTROL_SETENDPOSITION_OFFSET UNITYSDK_OFFSET(0xC09E5F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREINFOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0A00C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREINFOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC09EAF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREINFOCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC09FEC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREINFOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC09E7D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREINFOCONTROL__REFRESHENDLESSPROGRESSSTATE_OFFSET UNITYSDK_OFFSET(0xC09FD20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREINFOCONTROL__REFRESHMODE_OFFSET UNITYSDK_OFFSET(0xC09FC10)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayScoreInfoControl_TypeDefinitionIndex = 76361;
