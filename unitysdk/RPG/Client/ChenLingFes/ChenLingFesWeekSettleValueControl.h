...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESWEEKSETTLEVALUECONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C7970)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESWEEKSETTLEVALUECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C7A50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESWEEKSETTLEVALUECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C7790)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESWEEKSETTLEVALUECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0C7690)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesWeekSettleValueControl_TypeDefinitionIndex = 76390;
