...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0863F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC086A30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0862A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONFADEINEND_OFFSET UNITYSDK_OFFSET(0xC086910)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONFADEOUTEND_OFFSET UNITYSDK_OFFSET(0xC086980)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC086060)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC086710)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0xC0864D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0xC086580)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGamePhaseToastControl_TypeDefinitionIndex = 76403;
