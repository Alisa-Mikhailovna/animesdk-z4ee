...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTFEVERADDCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C4920)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTFEVERADDCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C4210)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTFEVERADDCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0C4170)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastFeverAddControl_TypeDefinitionIndex = 76395;
