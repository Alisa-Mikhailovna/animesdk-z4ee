...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_GET_ISFIRSTSHOW_OFFSET UNITYSDK_OFFSET(0xC09D6A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC09D9F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_RESETREFRESHANIMTOEND_OFFSET UNITYSDK_OFFSET(0xC09C8C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_SET_ISFIRSTSHOW_OFFSET UNITYSDK_OFFSET(0xC09D6B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC09E350)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__INITVIEW_OFFSET UNITYSDK_OFFSET(0xC09DAD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONANIMCALLBACK_OFFSET UNITYSDK_OFFSET(0xC09E070)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC09D830)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC09E240)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC09D6C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONITEMVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC09DE50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHICONPATH_OFFSET UNITYSDK_OFFSET(0xC09E100)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHITEM_OFFSET UNITYSDK_OFFSET(0xC09DDC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC09DBD0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayRankItemControl_TypeDefinitionIndex = 76358;
