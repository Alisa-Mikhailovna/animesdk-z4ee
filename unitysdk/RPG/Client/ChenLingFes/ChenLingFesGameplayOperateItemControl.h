...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL_GETNAVIGATIONZONE_OFFSET UNITYSDK_OFFSET(0xC096AB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC096BC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xC096B60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0980E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC096F70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC0978E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC096E70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL__REFRESHCONFIRMBTNSTATE_OFFSET UNITYSDK_OFFSET(0xC097E00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL__REFRESHPOSITION_OFFSET UNITYSDK_OFFSET(0xC097BF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL__REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0xC097AD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYOPERATEITEMCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0xC097840)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayOperateItemControl_TypeDefinitionIndex = 76354;
