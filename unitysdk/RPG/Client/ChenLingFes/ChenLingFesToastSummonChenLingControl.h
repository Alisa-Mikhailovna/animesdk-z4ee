...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSUMMONCHENLINGCONTROL_GETHEIGHT_OFFSET UNITYSDK_OFFSET(0xC0C5DB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSUMMONCHENLINGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C5E60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSUMMONCHENLINGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C5D20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSUMMONCHENLINGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0C5C80)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastSummonChenLingControl_TypeDefinitionIndex = 76402;
