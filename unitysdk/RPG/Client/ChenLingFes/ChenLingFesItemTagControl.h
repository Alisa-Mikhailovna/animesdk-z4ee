...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0BD800)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0BDAA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0BD6C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0BD600)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemTagControl_TypeDefinitionIndex = 76379;
