...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC091470)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_GET_ISFEVERACTIVE_OFFSET UNITYSDK_OFFSET(0xC0913A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_GET_PROGRESSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC091870)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_SET_ISFEVERACTIVE_OFFSET UNITYSDK_OFFSET(0xC0917E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_SET_PROGRESSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC091880)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC091530)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xC091550)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__ONFEVERSWITCH_OFFSET UNITYSDK_OFFSET(0xC091610)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayFeverViewModel_TypeDefinitionIndex = 76412;

	class ChenLingFesGameplayFeverViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Class_1_5F4D64A4B97E38F9* _Messenger; // 0x20
		::RPG::Client::ChenLingFes::ChenLingFesFeverProgressViewModel* _ProgressViewModel_k__BackingField; // 0x28
