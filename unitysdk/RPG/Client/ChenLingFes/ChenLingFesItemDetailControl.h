...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0BA6F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xC0B8C20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__CHECKANDPLAYVISIBLESWITCH_OFFSET UNITYSDK_OFFSET(0xC0BA580)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0BBC70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0BA7D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__ONCLICKOUTSIDE_OFFSET UNITYSDK_OFFSET(0xC0BA640)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC0BAB60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0BA350)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0xC0BAE80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0xC0BA970)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__SETUPGRIDS_OFFSET UNITYSDK_OFFSET(0xC0BB040)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__SETUPRARITY_OFFSET UNITYSDK_OFFSET(0xC0BBA30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILCONTROL__SETUPTAGS_OFFSET UNITYSDK_OFFSET(0xC0BB540)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemDetailControl_TypeDefinitionIndex = 76377;
