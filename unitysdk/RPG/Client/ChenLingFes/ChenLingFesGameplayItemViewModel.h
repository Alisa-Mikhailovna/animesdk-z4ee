...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_COUNTTEXT_OFFSET UNITYSDK_OFFSET(0xC096420)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xC096370)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0xC0964D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_ENABLERAYCAST_OFFSET UNITYSDK_OFFSET(0xC0958F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC094760)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_ISCHECKED_OFFSET UNITYSDK_OFFSET(0xC095990)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0xC0959D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xC095A10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0xC095000)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_NAMETEXT_OFFSET UNITYSDK_OFFSET(0xC095840)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_RARE_OFFSET UNITYSDK_OFFSET(0xC095930)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_GET_TAGVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xC096590)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_SET_ENABLERAYCAST_OFFSET UNITYSDK_OFFSET(0xC0965B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_SET_ISCHECKED_OFFSET UNITYSDK_OFFSET(0xC096300)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_SET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0xC096200)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xC096290)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL_SET_TAGVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xC0965A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC095EA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC095AE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xC095B60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMVIEWMODEL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC096640)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayItemViewModel_TypeDefinitionIndex = 76417;
	...
	public:
		...
		::System::Boolean _EnableRayCast; // 0x30
		::System::Boolean _IsDisable; // 0x31
