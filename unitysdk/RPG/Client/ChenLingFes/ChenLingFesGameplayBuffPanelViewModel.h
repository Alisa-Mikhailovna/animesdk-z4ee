...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC08D150)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_GET_BUFFICONS_OFFSET UNITYSDK_OFFSET(0xC08D8C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_GET_CLICKBUFFCOMMAND_OFFSET UNITYSDK_OFFSET(0xC08D8A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_GET_DETAILVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC08D8D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_REFRESHBUFFDATA_OFFSET UNITYSDK_OFFSET(0xC08D4C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_SET_CLICKBUFFCOMMAND_OFFSET UNITYSDK_OFFSET(0xC08D8B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_SET_DETAILVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC08D8E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC08D2C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xC08D380)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL__ONBUFFCHANGEMESSAGE_OFFSET UNITYSDK_OFFSET(0xC08D850)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL__ONCLICKBUFF_OFFSET UNITYSDK_OFFSET(0xC08D770)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayBuffPanelViewModel_TypeDefinitionIndex = 76410;
	...
	public:
		...
		::RPG::Client::ChenLingFes::ChenLingFesBuffDetailViewModel* _DetailViewModel_k__BackingField; // 0x40
