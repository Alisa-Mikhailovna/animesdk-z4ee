...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0A1D30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL_SETENDPOSITION_OFFSET UNITYSDK_OFFSET(0xC09E780)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ADJUSTNODEFLY_OFFSET UNITYSDK_OFFSET(0xC0A23F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0A26B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0A1BD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC0A21B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0A1A90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHCOMPLETESTATE_OFFSET UNITYSDK_OFFSET(0xC0A1F00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xC0A2080)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHTARGETSCORE_OFFSET UNITYSDK_OFFSET(0xC0A1E10)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayScoreItemControl_TypeDefinitionIndex = 76360;
