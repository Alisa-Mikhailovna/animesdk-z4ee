...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC08C820)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC08D0D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ENSUREDETAILCONTROL_OFFSET UNITYSDK_OFFSET(0xC08CAC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC08C2B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONBUFFICONSCHANGED_OFFSET UNITYSDK_OFFSET(0xC08CD30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONDETAILPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC08CD90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONGETBUFFICONITEM_OFFSET UNITYSDK_OFFSET(0xC08CDF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC08C0D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__REFRESHICONLIST_OFFSET UNITYSDK_OFFSET(0xC08C900)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayBuffPanelControl_TypeDefinitionIndex = 76341;
