...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC081650)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC081890)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC081390)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0812B0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffItemControl_TypeDefinitionIndex = 76340;
