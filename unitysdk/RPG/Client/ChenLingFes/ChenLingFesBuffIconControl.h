...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC081140)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC081260)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC081090)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC081010)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffIconControl_TypeDefinitionIndex = 76339;
