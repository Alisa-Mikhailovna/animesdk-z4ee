...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTRESIDENTHINTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C56F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTRESIDENTHINTCONTROL__FORMATDYNAMICVALUE_OFFSET UNITYSDK_OFFSET(0xC0C5670)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTRESIDENTHINTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C54D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTRESIDENTHINTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0C5450)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastResidentHintControl_TypeDefinitionIndex = 76399;
