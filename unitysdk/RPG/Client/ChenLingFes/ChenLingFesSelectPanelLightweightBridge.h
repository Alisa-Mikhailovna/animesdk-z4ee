...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC0BDDA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xC0BDE30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE_SETOWNER_OFFSET UNITYSDK_OFFSET(0xC0A2D80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC0BDEC0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesSelectPanelLightweightBridge_TypeDefinitionIndex = 76366;
