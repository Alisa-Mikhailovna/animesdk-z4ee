...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEWEEKVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC0935B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEWEEKVIEWMODEL_GET_GAMEDAYS_OFFSET UNITYSDK_OFFSET(0xC093A80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEWEEKVIEWMODEL_SET_GAMEDAYS_OFFSET UNITYSDK_OFFSET(0xC093A90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEWEEKVIEWMODEL_SYNC_OFFSET UNITYSDK_OFFSET(0xC093900)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEWEEKVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC093840)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayGameWeekViewModel_TypeDefinitionIndex = 76420;
