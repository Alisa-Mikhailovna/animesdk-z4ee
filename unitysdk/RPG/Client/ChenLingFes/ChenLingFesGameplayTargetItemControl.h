...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0AB4B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL_SHOWANIMREFRESH_OFFSET UNITYSDK_OFFSET(0xC0ABB70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0ABBE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0AB3F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0AB130)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__SETUPSTAR_OFFSET UNITYSDK_OFFSET(0xC0AB880)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__SETUPSTATE_OFFSET UNITYSDK_OFFSET(0xC0AB590)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__SETUPTARGETSCORE_OFFSET UNITYSDK_OFFSET(0xC0ABAF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__SETUPTITLE_OFFSET UNITYSDK_OFFSET(0xC0ABA80)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayTargetItemControl_TypeDefinitionIndex = 76368;
