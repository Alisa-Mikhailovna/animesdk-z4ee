...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSTARCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0AAD80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSTARCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0AAE60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSTARCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0AACE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSTARCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0AAC60)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayStarControl_TypeDefinitionIndex = 76367;
