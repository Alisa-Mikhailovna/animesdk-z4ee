...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSETTLESTARVIEWMODEL_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xC0BE120)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSETTLESTARVIEWMODEL_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xC0BE130)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSETTLESTARVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0BE140)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesSettleStarViewModel_TypeDefinitionIndex = 76444;
