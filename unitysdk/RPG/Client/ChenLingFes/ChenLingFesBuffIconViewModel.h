...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC081220)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONVIEWMODEL_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC080F50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC081290)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffIconViewModel_TypeDefinitionIndex = 76408;
