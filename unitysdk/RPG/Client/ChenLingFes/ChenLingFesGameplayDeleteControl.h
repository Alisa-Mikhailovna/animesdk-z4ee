...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYDELETECONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC08DDB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYDELETECONTROL_ISSCREENPOINTINDELETEAREA_OFFSET UNITYSDK_OFFSET(0xC08E1C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYDELETECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC08E3F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYDELETECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC08D990)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYDELETECONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC08E070)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYDELETECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC08D8F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYDELETECONTROL__REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0xC08E030)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYDELETECONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0xC08DE90)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayDeleteControl_TypeDefinitionIndex = 76347;
