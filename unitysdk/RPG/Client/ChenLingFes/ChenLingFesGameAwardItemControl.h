...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC084CE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC084EE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC084BE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC084B20)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameAwardItemControl_TypeDefinitionIndex = 76380;
