...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_CLEARALLPERSISTENTDIALOGSBYENTITY_OFFSET UNITYSDK_OFFSET(0xC0C11A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_COINENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC0C2480)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_FEVERENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC0C24A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_FEVERTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xC0C2500)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_OPENDAYSTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xC0C24E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_PREPARESTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xC0C24C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0BF290)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_INITPOSITION_OFFSET UNITYSDK_OFFSET(0xC0B6150)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_ONRELEASETOPOOL_OFFSET UNITYSDK_OFFSET(0xC0C0C30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xC0B8BC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_COINENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC0C2490)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_FEVERENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC0C24B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_FEVERTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xC0C2510)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_OPENDAYSTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xC0C24F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_PREPARESTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xC0C24D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__APPENDMOVEANIMATIONTOTARGET_OFFSET UNITYSDK_OFFSET(0xC0C1A30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__CREATECONTROLBYTYPE_OFFSET UNITYSDK_OFFSET(0xC0C16A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__CREATETOASTITEMCONTROL_OFFSET UNITYSDK_OFFSET(0xC0C0580)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C2520)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETORCREATEACTIVELIST_OFFSET UNITYSDK_OFFSET(0xC0C01B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETORCREATEPENDINGQUEUE_OFFSET UNITYSDK_OFFSET(0xC0BFA20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETPERSISTENTDIALOGKEY_OFFSET UNITYSDK_OFFSET(0xC0C0BD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETPILEKEY_OFFSET UNITYSDK_OFFSET(0xC0BF9C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETTOASTPARENTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC0C1500)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0BEDA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONCLEARPENDINGTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0xC0C1470)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC0C1CF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0BEC90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONTOASTREQUEST_OFFSET UNITYSDK_OFFSET(0xC0BF6F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__REFRESHPILEDTOASTLAYOUT_OFFSET UNITYSDK_OFFSET(0xC0C0810)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__SHOULDTRACKASPERSISTENTDIALOG_OFFSET UNITYSDK_OFFSET(0xC0C0B60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__SHOWREQUESTIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xC0BFCD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__TRYDISPATCHTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0xC0BFBA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__TRYHIDEPERSISTENTDIALOG_OFFSET UNITYSDK_OFFSET(0xC0BF830)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__TRYUPDATEPERSISTENTDIALOG_OFFSET UNITYSDK_OFFSET(0xC0C02F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__UPDATEPERSISTENTDIALOGPOSITIONS_OFFSET UNITYSDK_OFFSET(0xC0BE160)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__UPDATEPILEMOVEANIMATIONS_OFFSET UNITYSDK_OFFSET(0xC0BE3A0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastContainerControl_TypeDefinitionIndex = 76393;
