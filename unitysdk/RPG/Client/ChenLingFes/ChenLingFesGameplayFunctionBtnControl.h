...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFUNCTIONBTNCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC091FF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFUNCTIONBTNCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC092350)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFUNCTIONBTNCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC091970)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFUNCTIONBTNCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC091890)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFUNCTIONBTNCONTROL__ONVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC092270)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFUNCTIONBTNCONTROL__REFRESHBTNSTATE_OFFSET UNITYSDK_OFFSET(0xC0920D0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayFunctionBtnControl_TypeDefinitionIndex = 76351;
