...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL_GETNODEFEVERFLYANCHOR_OFFSET UNITYSDK_OFFSET(0xC090D40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0910E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xC090CC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC091440)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC090E70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC090DB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL__ONPROGRESSVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC0913E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL__ONVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC091240)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL__REFRESHFEVERANIM_OFFSET UNITYSDK_OFFSET(0xC0912A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERCONTROL__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xC0911C0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayFeverControl_TypeDefinitionIndex = 76346;
