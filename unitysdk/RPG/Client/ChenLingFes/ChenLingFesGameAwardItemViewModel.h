...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC084DC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC084F10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_GET_STATESTR_OFFSET UNITYSDK_OFFSET(0xC084F60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_SET_STATESTR_OFFSET UNITYSDK_OFFSET(0xC084F70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC084A30)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameAwardItemViewModel_TypeDefinitionIndex = 76437;
