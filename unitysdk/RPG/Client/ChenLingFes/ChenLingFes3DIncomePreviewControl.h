...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC07E620)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xC07C230)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC07EFC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC07E430)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC07EDD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC07E390)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__REFRESHINCOME_OFFSET UNITYSDK_OFFSET(0xC07E700)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__UPDATESTATE_OFFSET UNITYSDK_OFFSET(0xC07EC40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__UPDATEVISIBILITY_OFFSET UNITYSDK_OFFSET(0xC07EB60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__UPDATEWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xC07E7F0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFes3DIncomePreviewControl_TypeDefinitionIndex = 76337;
