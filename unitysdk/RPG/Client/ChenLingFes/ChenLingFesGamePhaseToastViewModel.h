...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC086A60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_GET_FINISHCOMMAND_OFFSET UNITYSDK_OFFSET(0xC086F30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xC086890)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_GET_TOASTSTRING_OFFSET UNITYSDK_OFFSET(0xC0868D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_SETFINISHEDPROMISE_OFFSET UNITYSDK_OFFSET(0xC086CF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_SET_FINISHCOMMAND_OFFSET UNITYSDK_OFFSET(0xC086F40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xC086EC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_SET_TOASTSTRING_OFFSET UNITYSDK_OFFSET(0xC086C60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC086C30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xC086D40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL__ONFINISH_OFFSET UNITYSDK_OFFSET(0xC086E10)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGamePhaseToastViewModel_TypeDefinitionIndex = 76447;
	...
	public:
		...
		::RPG::Client::Promises::Promise* _FinishPromise; // 0x30
