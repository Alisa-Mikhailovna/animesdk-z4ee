...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_ADD_ONCLEARPENDINGTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0xC0BF4D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_ADD_ONTOASTREQUEST_OFFSET UNITYSDK_OFFSET(0xC0BF3F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC0B0CF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_GET_FEVERTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C4150)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_GET_OPENDAYSTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C4130)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_GET_PREPARESTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C4110)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_REGISTERNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xC0BF530)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_REMOVE_ONCLEARPENDINGTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0xC0BF470)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_REMOVE_ONTOASTREQUEST_OFFSET UNITYSDK_OFFSET(0xC0BF370)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_SET_FEVERTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C4160)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_SET_OPENDAYSTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C4140)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_SET_PREPARESTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C4120)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_UNREGISTERNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xC0C22F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__CANEMITFLYTOAST_OFFSET UNITYSDK_OFFSET(0xC0C2F10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C2960)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__EMITUIDIALOGREQUEST_OFFSET UNITYSDK_OFFSET(0xC0C37F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__GETFLYTOASTMININTERVAL_OFFSET UNITYSDK_OFFSET(0xC0C32A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__GETSPECIALSHOWCOINNUM_OFFSET UNITYSDK_OFFSET(0xC0C3010)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xC0C2A10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONDAYEND_OFFSET UNITYSDK_OFFSET(0xC0C36F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONFEVERUPDATE_OFFSET UNITYSDK_OFFSET(0xC0C3130)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONHIDEUIDIALOG_OFFSET UNITYSDK_OFFSET(0xC0C3C20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSCOREUPDATE_OFFSET UNITYSDK_OFFSET(0xC0C2C20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSHOWTOAST_OFFSET UNITYSDK_OFFSET(0xC0C3340)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSHOWUIDIALOG_OFFSET UNITYSDK_OFFSET(0xC0C3760)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSHOWUITOAST_OFFSET UNITYSDK_OFFSET(0xC0C3DC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSWITCHDAY_OFFSET UNITYSDK_OFFSET(0xC0C3680)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONUPDATEUIDIALOG_OFFSET UNITYSDK_OFFSET(0xC0C3A30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__TRYGETDIALOGPREFABPATH_OFFSET UNITYSDK_OFFSET(0xC0C3AC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__TRYGETTOASTPREFABPATH_OFFSET UNITYSDK_OFFSET(0xC0C4060)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastContainerViewModel_TypeDefinitionIndex = 76449;

	class ChenLingFesToastContainerViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Class_1_5F4D64A4B97E38F9* _Messenger; // 0x20
		::RPG::Client::ChenLingFes::ChenLingFesGamePhaseToastViewModel* _OpenDayStartToastViewModel_k__BackingField; // 0x28
		::RPG::Client::ChenLingFes::ChenLingFesGameplayFeverViewModel* _FeverToastViewModel_k__BackingField; // 0x30
		...
		::System::Action* OnClearPendingToastQueue; // 0x48
