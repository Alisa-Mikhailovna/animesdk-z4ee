...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL_GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0xC0C1970)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C5C50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC0C5B60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0C5AE0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastScoreAddFlyControl_TypeDefinitionIndex = 76401;
