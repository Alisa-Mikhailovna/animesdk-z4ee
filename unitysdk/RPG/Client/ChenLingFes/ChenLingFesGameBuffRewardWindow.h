...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC085B10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0xC085250)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC085680)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONBUFFREWARDCLOSEMESSAGE_OFFSET UNITYSDK_OFFSET(0xC085F80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC085C90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC085350)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0xC085C40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__REFRESHICON_OFFSET UNITYSDK_OFFSET(0xC085EC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0xC085E30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC085BF0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameBuffRewardWindow_TypeDefinitionIndex = 76382;

	class ChenLingFesGameBuffRewardWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::UnityEngine::UI::Image* _ImageIcon; // 0x40
		::Class_1_6CC143B9599F1FCA* _AssetLoader; // 0x48
