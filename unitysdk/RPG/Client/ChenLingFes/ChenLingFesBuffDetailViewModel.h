...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC0800A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_GET_BUFFITEMS_OFFSET UNITYSDK_OFFSET(0xC081000)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_GET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0xC080FE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xC07FE10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_REFRESHBUFFDATA_OFFSET UNITYSDK_OFFSET(0xC080390)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_SET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0xC080FF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xC080900)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__CONVERTPARAMLIST_OFFSET UNITYSDK_OFFSET(0xC080C50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC080200)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xC0802C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__ONCLOSE_OFFSET UNITYSDK_OFFSET(0xC080870)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffDetailViewModel_TypeDefinitionIndex = 76407;
