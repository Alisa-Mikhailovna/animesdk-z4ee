...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC09BF10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC09C950)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC09BB80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC09BAE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__ONRANKITEMSCHANGED_OFFSET UNITYSDK_OFFSET(0xC09C860)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__ONVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC09C6F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0xC09BFF0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayRankInfoControl_TypeDefinitionIndex = 76359;
