...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL_GET_NODEANCHOR_OFFSET UNITYSDK_OFFSET(0xC081AB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC081DB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xC081FC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC082510)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC081AF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC0819D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__ONVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC0821E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__REFRESHANIMSTATE_OFFSET UNITYSDK_OFFSET(0xC081ED0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesFeverProgressControl_TypeDefinitionIndex = 76344;
