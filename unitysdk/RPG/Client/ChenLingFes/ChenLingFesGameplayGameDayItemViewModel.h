...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_GET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0xC093550)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_GET_DAYSTATE_OFFSET UNITYSDK_OFFSET(0xC0930F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_GET_ISCURDAY_OFFSET UNITYSDK_OFFSET(0xC093130)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0xC0933A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SET_DAYSTATE_OFFSET UNITYSDK_OFFSET(0xC093430)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SET_ISCURDAY_OFFSET UNITYSDK_OFFSET(0xC0934C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SYNC_OFFSET UNITYSDK_OFFSET(0xC0931A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC093590)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayGameDayItemViewModel_TypeDefinitionIndex = 76419;
