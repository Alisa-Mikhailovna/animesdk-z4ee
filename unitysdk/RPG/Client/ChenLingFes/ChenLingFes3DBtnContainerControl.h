...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC07C420)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xC07C130)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC07CE40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__GETORCREATEINCOMEPREVIEWCONTROL_OFFSET UNITYSDK_OFFSET(0xC07CC00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC07C2D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC07C5F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC07CDD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONINCOMEPREVIEWVISIBLECHANGED_OFFSET UNITYSDK_OFFSET(0xC07C500)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC07C290)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__RECYCLEALLACTIVEINCOMEPREVIEWCONTROLS_OFFSET UNITYSDK_OFFSET(0xC07CA30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__REFRESHINCOMEPREVIEWCONTROLS_OFFSET UNITYSDK_OFFSET(0xC07C7C0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFes3DBtnContainerControl_TypeDefinitionIndex = 76336;
