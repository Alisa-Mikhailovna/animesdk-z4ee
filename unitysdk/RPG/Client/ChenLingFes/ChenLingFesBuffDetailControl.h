...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC07F910)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC080070)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC07F6F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONBUFFITEMSCHANGED_OFFSET UNITYSDK_OFFSET(0xC07FCA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONCLICKOUTSIDE_OFFSET UNITYSDK_OFFSET(0xC07FBF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC07FD00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONGETITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0xC07FE50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC07F510)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__REFRESHLIST_OFFSET UNITYSDK_OFFSET(0xC07FAD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0xC07F9F0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffDetailControl_TypeDefinitionIndex = 76338;
