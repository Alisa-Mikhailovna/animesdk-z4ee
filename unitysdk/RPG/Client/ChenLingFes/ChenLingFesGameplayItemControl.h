...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_GETCENTERWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xC093D40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC094610)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0xC095A50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xC093AF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_SETMESSAGER_OFFSET UNITYSDK_OFFSET(0xC093AA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__CANINTERACT_OFFSET UNITYSDK_OFFSET(0xC0952E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC095AB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC094020)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONCLICKDETAIL_OFFSET UNITYSDK_OFFSET(0xC095480)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONCLICKROOT_OFFSET UNITYSDK_OFFSET(0xC095230)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xC0955B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC095050)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONENABLERAYCASTCHANGED_OFFSET UNITYSDK_OFFSET(0xC0957B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC093E70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONSELECTHANDLER_OFFSET UNITYSDK_OFFSET(0xC095540)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xC093C80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__REFRESHNAMETEXT_OFFSET UNITYSDK_OFFSET(0xC0946F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPRARITY_OFFSET UNITYSDK_OFFSET(0xC094D00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPSTATES_OFFSET UNITYSDK_OFFSET(0xC094E50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPTAGS_OFFSET UNITYSDK_OFFSET(0xC0947D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__TRYSHOWITEMDETAIL_OFFSET UNITYSDK_OFFSET(0xC095340)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayItemControl_TypeDefinitionIndex = 76353;
