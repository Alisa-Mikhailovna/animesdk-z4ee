...
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xC0EEDC0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_CREATE_2_OFFSET UNITYSDK_OFFSET(0xC0EEE50)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC0EEC20)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DESCPARAM_OFFSET UNITYSDK_OFFSET(0xC0EF100)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICEACTIVESTAGE_OFFSET UNITYSDK_OFFSET(0xC0EF300)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICEEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0xC0EF360)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICESURFACEDESC_OFFSET UNITYSDK_OFFSET(0xC0EF080)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICESURFACEICON_OFFSET UNITYSDK_OFFSET(0xC0EEF50)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICESURFACENAME_OFFSET UNITYSDK_OFFSET(0xC0EF000)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_EXTRAEFFECT_OFFSET UNITYSDK_OFFSET(0xC0EF1D0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_ICONNEEDSETCOLOR_OFFSET UNITYSDK_OFFSET(0xC0EEFB0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xC0EF170)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_SORT_OFFSET UNITYSDK_OFFSET(0xC0EF2A0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_SURFACEID_OFFSET UNITYSDK_OFFSET(0xC0EEEF0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_SURFACETAGS_OFFSET UNITYSDK_OFFSET(0xC0EF240)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC0EEEE0)
