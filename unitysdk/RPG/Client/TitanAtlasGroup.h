...
#define RPG_CLIENT_TITANATLASGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0xD6D81B0)
#define RPG_CLIENT_TITANATLASGROUP_GETALLBASEINFOS_OFFSET UNITYSDK_OFFSET(0xD6D8430)
#define RPG_CLIENT_TITANATLASGROUP_GETALLINFOS_OFFSET UNITYSDK_OFFSET(0xD6D8230)
#define RPG_CLIENT_TITANATLASGROUP_GETALLNUM_OFFSET UNITYSDK_OFFSET(0xD6D8BE0)
#define RPG_CLIENT_TITANATLASGROUP_GETALLUNLOCKNUM_OFFSET UNITYSDK_OFFSET(0xD6D89F0)
#define RPG_CLIENT_TITANATLASGROUP_GETRENEWABLEINFO_OFFSET UNITYSDK_OFFSET(0xD6D8800)
#define RPG_CLIENT_TITANATLASGROUP_GET_BGCOLOR_OFFSET UNITYSDK_OFFSET(0xD6D9020)
#define RPG_CLIENT_TITANATLASGROUP_GET_CHANGEINFOS_OFFSET UNITYSDK_OFFSET(0xD6D90E0)
#define RPG_CLIENT_TITANATLASGROUP_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD6D8F60)
#define RPG_CLIENT_TITANATLASGROUP_GET_ID_OFFSET UNITYSDK_OFFSET(0xD6D8E20)
#define RPG_CLIENT_TITANATLASGROUP_GET_INFOS_OFFSET UNITYSDK_OFFSET(0xD6D90C0)
#define RPG_CLIENT_TITANATLASGROUP_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD6D8EA0)
#define RPG_CLIENT_TITANATLASGROUP_GET_ROW_OFFSET UNITYSDK_OFFSET(0xD6D8E40)
#define RPG_CLIENT_TITANATLASGROUP_NEEDSHOWREDDOT_OFFSET UNITYSDK_OFFSET(0xD6D8C40)
#define RPG_CLIENT_TITANATLASGROUP_SET_CHANGEINFOS_OFFSET UNITYSDK_OFFSET(0xD6D90F0)
#define RPG_CLIENT_TITANATLASGROUP_SET_ID_OFFSET UNITYSDK_OFFSET(0xD6D8E30)
#define RPG_CLIENT_TITANATLASGROUP_SET_INFOS_OFFSET UNITYSDK_OFFSET(0xD6D90D0)
#define RPG_CLIENT_TITANATLASGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xD6D8220)
