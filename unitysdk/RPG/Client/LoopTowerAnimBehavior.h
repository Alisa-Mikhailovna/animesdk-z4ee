...
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xCA2BE80)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xCA2D410)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xCA2DA30)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xCA2DA90)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xCA2E4C0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xCA2E520)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCA2D9D0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_43690B86AECB092E_OFFSET UNITYSDK_OFFSET(0xCA2C8B0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_46D79C223C10A615_OFFSET UNITYSDK_OFFSET(0xCA2B090)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_49E81587B5BA7737_OFFSET UNITYSDK_OFFSET(0xCA2B880)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xCA2D5C0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_6011BBCAB21C4BB7_OFFSET UNITYSDK_OFFSET(0xCA2B300)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_6516B39957C2E680_OFFSET UNITYSDK_OFFSET(0xCA2B100)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xCA2DB00)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCA2E580)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(LoopTowerAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x8C30);
		}
