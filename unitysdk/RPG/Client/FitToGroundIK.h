...
#define RPG_CLIENT_FITTOGROUNDIK_GET_IKENABLED_OFFSET UNITYSDK_OFFSET(0xC5E6EE0)
#define RPG_CLIENT_FITTOGROUNDIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0xC5E55F0)
#define RPG_CLIENT_FITTOGROUNDIK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xC5E6F00)
#define RPG_CLIENT_FITTOGROUNDIK_METHOD_5_048B2CC98DBD1BD8_OFFSET UNITYSDK_OFFSET(0xC5E5BB0)
#define RPG_CLIENT_FITTOGROUNDIK_METHOD_5_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0xC5E6CD0)
#define RPG_CLIENT_FITTOGROUNDIK_METHOD_5_A63D06F4304A4527_OFFSET UNITYSDK_OFFSET(0xC5E6D90)
#define RPG_CLIENT_FITTOGROUNDIK_PREPROCESS_OFFSET UNITYSDK_OFFSET(0xC5E5650)
#define RPG_CLIENT_FITTOGROUNDIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xC5E5760)
#define RPG_CLIENT_FITTOGROUNDIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0xC5E55A0)
#define RPG_CLIENT_FITTOGROUNDIK_SET_IKENABLED_OFFSET UNITYSDK_OFFSET(0xC5E6EF0)
#define RPG_CLIENT_FITTOGROUNDIK__CTOR_OFFSET UNITYSDK_OFFSET(0xC5E6F10)
