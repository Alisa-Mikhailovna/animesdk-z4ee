...
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_CHECKISCANTAKEMISSION_OFFSET UNITYSDK_OFFSET(0xCBD12A0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_CHECKISMIDDLEMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0xCBD1E40)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_CHECKISPREDICTION_OFFSET UNITYSDK_OFFSET(0xCBD1A70)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCBCF710)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GETALLSUBGRAPHMISSIONID_OFFSET UNITYSDK_OFFSET(0xCBD08F0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GETCURPROCESSINGMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xCBD10F0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GETFINALMAINMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xCBD3070)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GETSTORYLINEID_OFFSET UNITYSDK_OFFSET(0xCBD1F90)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_CANTAKEMISSIONPATHIDLIST_OFFSET UNITYSDK_OFFSET(0xCBD1330)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_CHRONICLESUBPATHDICT_OFFSET UNITYSDK_OFFSET(0xCBD3B60)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_CONNECTIONLIST_OFFSET UNITYSDK_OFFSET(0xCBD3B00)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_CUSTOMUNLOCKCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0xCBD3DD0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_FINISHMISSIONID_OFFSET UNITYSDK_OFFSET(0xCBD3AA0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_FIRSTSUBPATHID_OFFSET UNITYSDK_OFFSET(0xCBD3AE0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_ISWORLDUNLOCKED_OFFSET UNITYSDK_OFFSET(0xCBD3E90)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_MAINMISSIONID_OFFSET UNITYSDK_OFFSET(0xCBD3B80)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_PARENTLINETYPEMAINPATHDATA_OFFSET UNITYSDK_OFFSET(0xCBD3B40)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_PARENTMAINPATHLIST_OFFSET UNITYSDK_OFFSET(0xCBD3B20)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_SUBGRAPHPATH_OFFSET UNITYSDK_OFFSET(0xCBD3AC0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_WORLDPATHDATA_OFFSET UNITYSDK_OFFSET(0xCBD2F70)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_INIT_OFFSET UNITYSDK_OFFSET(0xCBCF7F0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISANYPARENTPATHFINISH_OFFSET UNITYSDK_OFFSET(0xCBD1B50)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISANYPARENTPATHPROCESSINGFINISH_OFFSET UNITYSDK_OFFSET(0xCBD1CB0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISCANSTEPNEXTPATH_OFFSET UNITYSDK_OFFSET(0xCBD0630)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISCONNECTMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0xCBD1010)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISNEWLEGAL_OFFSET UNITYSDK_OFFSET(0xCBD1460)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISNEW_OFFSET UNITYSDK_OFFSET(0xCBD1380)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0xCBD2F10)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_REFRESHEARLYACCESSINFO_OFFSET UNITYSDK_OFFSET(0xCBD20F0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_REFRESHWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0xCBD3110)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0xCBCF830)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SETMOCKFINISHNODEDATA_OFFSET UNITYSDK_OFFSET(0xCBD0520)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SETSEEN_OFFSET UNITYSDK_OFFSET(0xCBD15B0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_CHRONICLESUBPATHDICT_OFFSET UNITYSDK_OFFSET(0xCBD3B70)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_CONNECTIONLIST_OFFSET UNITYSDK_OFFSET(0xCBD3B10)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_FINISHMISSIONID_OFFSET UNITYSDK_OFFSET(0xCBD3AB0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_FIRSTSUBPATHID_OFFSET UNITYSDK_OFFSET(0xCBD3AF0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_ISWORLDUNLOCKED_OFFSET UNITYSDK_OFFSET(0xCBD3EA0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_PARENTLINETYPEMAINPATHDATA_OFFSET UNITYSDK_OFFSET(0xCBD3B50)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_PARENTMAINPATHLIST_OFFSET UNITYSDK_OFFSET(0xCBD3B30)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_SUBGRAPHPATH_OFFSET UNITYSDK_OFFSET(0xCBD3AD0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__CHECKISWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0xCBD3170)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCBCF690)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__GENERATECHRONICLESUBPATH_OFFSET UNITYSDK_OFFSET(0xCBCFB00)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__GETCURCHRONICLESTATUSBYSELF_OFFSET UNITYSDK_OFFSET(0xCBD2C60)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__GETCURCHRONICLESTATUS_OFFSET UNITYSDK_OFFSET(0xCBD0730)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__GETSTORYLINEID_OFFSET UNITYSDK_OFFSET(0xCBD1FF0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__ISFORCENOTASPREDICTION_OFFSET UNITYSDK_OFFSET(0xCBD1AD0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__ISNOTHAVESUBPATHTYPE_OFFSET UNITYSDK_OFFSET(0xCBD2EC0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__ISSUBPATHACTIVE_OFFSET UNITYSDK_OFFSET(0xCBD2E10)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SEARCHEARLYACCESSEFFECTED_OFFSET UNITYSDK_OFFSET(0xCBD2A80)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETASSISTPATHDATALISTEAEFFECTED_OFFSET UNITYSDK_OFFSET(0xCBD3A00)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETCANTAKEMISSIONPATHIDLIST_OFFSET UNITYSDK_OFFSET(0xCBD3470)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETCONNECTIONWAYDATA_OFFSET UNITYSDK_OFFSET(0xCBD0070)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETSUBPATHCANTAKEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xCBD36A0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETUPCONNECTIONLIST_OFFSET UNITYSDK_OFFSET(0xCBCF920)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* _CanTakeMissionPathIDList; // 0xB8
		...
		::RPG::Client::MissionChronicleMainPathData* _ParentLineTypeMainPathData_k__BackingField; // 0xE0
