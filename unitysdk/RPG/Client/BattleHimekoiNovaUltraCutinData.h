...
#define RPG_CLIENT_BATTLEHIMEKOINOVAULTRACUTINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBE781C0)
#define RPG_CLIENT_BATTLEHIMEKOINOVAULTRACUTINDATA_GET_HEADICONLIST_OFFSET UNITYSDK_OFFSET(0xBE784E0)
#define RPG_CLIENT_BATTLEHIMEKOINOVAULTRACUTINDATA_SET_HEADICONLIST_OFFSET UNITYSDK_OFFSET(0xBE784F0)
#define RPG_CLIENT_BATTLEHIMEKOINOVAULTRACUTINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBE78250)
#define RPG_CLIENT_BATTLEHIMEKOINOVAULTRACUTINDATA__INITHEADICONLIST_OFFSET UNITYSDK_OFFSET(0xBE78290)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleHimekoiNovaUltraCutinData_TypeDefinitionIndex = 68241;
