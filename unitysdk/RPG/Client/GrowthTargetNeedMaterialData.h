...
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA_CHECKNEEDMATERIALWITHCOMPOSE_OFFSET UNITYSDK_OFFSET(0xC86CCF0)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC86C9B0)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC86CB90)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA_GETGROWTHTARGETMINIICONPATH_OFFSET UNITYSDK_OFFSET(0xC86CED0)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__ADDNOTIFYHANDLER_OFFSET UNITYSDK_OFFSET(0xC86CA80)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC86CA50)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__ENSURECOMPOSEMATERIALMAP_OFFSET UNITYSDK_OFFSET(0xC86D0B0)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__ENSUREDATA_OFFSET UNITYSDK_OFFSET(0xC86CD60)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__GETHASVALIDCACHE_OFFSET UNITYSDK_OFFSET(0xC86D030)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__REMOVENOTIFYHANDLER_OFFSET UNITYSDK_OFFSET(0xC86CBE0)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__RESETNEEDMATERIALLIST_OFFSET UNITYSDK_OFFSET(0xC86CF80)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__TRYADDNEEDMATERIALWITHCOMPOSESET_OFFSET UNITYSDK_OFFSET(0xC86DCB0)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__UPDATENEEDMATERIALLIST_OFFSET UNITYSDK_OFFSET(0xC86DA40)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA__UPDATENEEDMATERIALWITHCOMPOSESET_OFFSET UNITYSDK_OFFSET(0xC86DB10)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _NeedMaterialWithComposeSet; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::HashSet_1<::System::UInt32>*>* _ComposeMaterialMap; // 0x18
