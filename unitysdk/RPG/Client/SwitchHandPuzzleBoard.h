...
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD589FA0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD58A050)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_0584B4481E699952_OFFSET UNITYSDK_OFFSET(0xD58B4D0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_508D4DD02D3DB74E_1_OFFSET UNITYSDK_OFFSET(0xD589DD0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xD589B50)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_8C945585B4A8C17B_OFFSET UNITYSDK_OFFSET(0xD58B420)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONERAVISIBLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0xD58AC40)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONGAMERESET_OFFSET UNITYSDK_OFFSET(0xD58B310)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONGESTURETYPESWITCHFROM_OFFSET UNITYSDK_OFFSET(0xD58A090)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONGESTURETYPESWITCHTO_OFFSET UNITYSDK_OFFSET(0xD58A240)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONLIFTGESTUREEXIT_OFFSET UNITYSDK_OFFSET(0xD58AD70)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONPLAYERTELEPORT_OFFSET UNITYSDK_OFFSET(0xD58AF20)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONPLAYERTRIGGERPULLBACK_OFFSET UNITYSDK_OFFSET(0xD58B200)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTUREFIRE_OFFSET UNITYSDK_OFFSET(0xD58A5A0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTURELAUNCH_OFFSET UNITYSDK_OFFSET(0xD58A3F0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTUREPUNCHED_OFFSET UNITYSDK_OFFSET(0xD58A900)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTUREPUNCHHIT_OFFSET UNITYSDK_OFFSET(0xD58AAB0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTURESTOP_OFFSET UNITYSDK_OFFSET(0xD58A750)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETPUNCHHITSTUB_OFFSET UNITYSDK_OFFSET(0xD58B050)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD589D20)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD589A30)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD58B630)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD58B5B0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SwitchHandPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x37380);
		}
