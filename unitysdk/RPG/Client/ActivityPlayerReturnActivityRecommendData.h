...
#define RPG_CLIENT_ACTIVITYPLAYERRETURNACTIVITYRECOMMENDDATA_GET_ACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0xBC4A4B0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNACTIVITYRECOMMENDDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBC4A580)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNACTIVITYRECOMMENDDATA_GET_PANELDATA_OFFSET UNITYSDK_OFFSET(0xBC4A380)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNACTIVITYRECOMMENDDATA_GET_PANELID_OFFSET UNITYSDK_OFFSET(0xBC4A460)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNACTIVITYRECOMMENDDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xBC4A620)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNACTIVITYRECOMMENDDATA_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0xBC4A200)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNACTIVITYRECOMMENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBC4A180)
