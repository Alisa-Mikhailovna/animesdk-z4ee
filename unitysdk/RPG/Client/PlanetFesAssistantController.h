...
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCFF06D0)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_GETGLOBALCOOLDOWNSENDTIME_OFFSET UNITYSDK_OFFSET(0xCFF0750)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xCFF01F0)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCFF07A0)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCFF0810)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF1190)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__HIDEMESSAGE_OFFSET UNITYSDK_OFFSET(0xCFF0EA0)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__INITMESSAGES_OFFSET UNITYSDK_OFFSET(0xCFF0300)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__ONPLANETFESASSISTANTMESSAGE_OFFSET UNITYSDK_OFFSET(0xCFF1090)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__SHOWMESSAGE_OFFSET UNITYSDK_OFFSET(0xCFF0F50)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__TICKALLMESSAGES_OFFSET UNITYSDK_OFFSET(0xCFF09C0)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__TICKHIDE_OFFSET UNITYSDK_OFFSET(0xCFF0E30)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__TICKSHOWING_OFFSET UNITYSDK_OFFSET(0xCFF0DB0)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__TRYSENDMESSAGE_OFFSET UNITYSDK_OFFSET(0xCFF0AF0)
