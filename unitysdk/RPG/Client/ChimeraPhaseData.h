...
#define RPG_CLIENT_CHIMERAPHASEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC150DB0)
#define RPG_CLIENT_CHIMERAPHASEDATA_GETREMAININGROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xC150D30)
#define RPG_CLIENT_CHIMERAPHASEDATA_GET_LEADERCHARIOTSTATE_OFFSET UNITYSDK_OFFSET(0xC150C90)
#define RPG_CLIENT_CHIMERAPHASEDATA_GET_NEXTPHASE_OFFSET UNITYSDK_OFFSET(0xC1507E0)
#define RPG_CLIENT_CHIMERAPHASEDATA_GET_PHASEID_OFFSET UNITYSDK_OFFSET(0xC150770)
#define RPG_CLIENT_CHIMERAPHASEDATA_GET_ROUNDIDARR_OFFSET UNITYSDK_OFFSET(0xC150AB0)
#define RPG_CLIENT_CHIMERAPHASEDATA_GET_TARGETPARAMS_OFFSET UNITYSDK_OFFSET(0xC150BF0)
#define RPG_CLIENT_CHIMERAPHASEDATA_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0xC150B50)
#define RPG_CLIENT_CHIMERAPHASEDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC150780)
#define RPG_CLIENT_CHIMERAPHASEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC150E00)
