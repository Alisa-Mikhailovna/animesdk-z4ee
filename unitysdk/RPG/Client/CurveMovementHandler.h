...
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC1CD460)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ENTITYREF_OFFSET UNITYSDK_OFFSET(0xC1CCDA0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_FROMPOINT_OFFSET UNITYSDK_OFFSET(0xC1CCE50)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0xC1CCD60)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ISARRIVED_OFFSET UNITYSDK_OFFSET(0xC1CCE20)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ISBLOCKED_OFFSET UNITYSDK_OFFSET(0xC1CCDB0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ISMOVING_OFFSET UNITYSDK_OFFSET(0xC1CCE10)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_ISTRANSITION_OFFSET UNITYSDK_OFFSET(0xC1CCB60)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_LOCSTATUS_OFFSET UNITYSDK_OFFSET(0xC1CCE80)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0xC1CCD40)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_MOVABLEOBJECT_OFFSET UNITYSDK_OFFSET(0xC1CCD80)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_MOVEDIRECTION_OFFSET UNITYSDK_OFFSET(0xC1CCE70)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_PERCENT_OFFSET UNITYSDK_OFFSET(0xC1CCE40)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_SPEED_OFFSET UNITYSDK_OFFSET(0xC1CCE30)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_GET_TOPOINT_OFFSET UNITYSDK_OFFSET(0xC1CCE60)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0xC1C9E40)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_1749C9009A08FDA0_OFFSET UNITYSDK_OFFSET(0xC1C8B30)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_5411CE720923C7BC_OFFSET UNITYSDK_OFFSET(0xC1C93D0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_54619462A38E2DE3_OFFSET UNITYSDK_OFFSET(0xC1CB440)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_5E1F1C56DAD337FB_OFFSET UNITYSDK_OFFSET(0xC1CD830)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xC1C8A70)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_7D467EBFE5C652CF_OFFSET UNITYSDK_OFFSET(0xC1CA210)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_7EE62FB361B3512D_OFFSET UNITYSDK_OFFSET(0xC1CAE30)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_86ABD12CE7D706DB_OFFSET UNITYSDK_OFFSET(0xC1CBD60)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_8BD28CA07EC47CDB_OFFSET UNITYSDK_OFFSET(0xC1CD6C0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0xC1CC8D0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_946BB4FEA1D1E31E_OFFSET UNITYSDK_OFFSET(0xC1C9330)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC1CA640)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_99B422901E548512_OFFSET UNITYSDK_OFFSET(0xC1CA770)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_AB1A8DFD378DB0BE_OFFSET UNITYSDK_OFFSET(0xC1CAA90)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_C3DEB36A8C3E2BA5_OFFSET UNITYSDK_OFFSET(0xC1CA6C0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_C733F4B13025CACB_OFFSET UNITYSDK_OFFSET(0xC1CC970)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_CCBE8E3D38E773EF_OFFSET UNITYSDK_OFFSET(0xC1CA4C0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_DC4ED6DB5B93D711_OFFSET UNITYSDK_OFFSET(0xC1C8DF0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_DE3F7DF9E0B52E1C_OFFSET UNITYSDK_OFFSET(0xC1CCBB0)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_METHOD_1_F675341C48ED6437_OFFSET UNITYSDK_OFFSET(0xC1CAB90)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_SET_GRAPH_OFFSET UNITYSDK_OFFSET(0xC1CCD70)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0xC1CCD50)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER_SET_MOVABLEOBJECT_OFFSET UNITYSDK_OFFSET(0xC1CCD90)
#define RPG_CLIENT_CURVEMOVEMENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1CD020)
