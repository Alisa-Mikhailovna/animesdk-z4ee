...
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_AWAKE_OFFSET UNITYSDK_OFFSET(0xC356FC0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xC3574A0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_LINERENDERERS_OFFSET UNITYSDK_OFFSET(0xC357480)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_XOYRENDERER_OFFSET UNITYSDK_OFFSET(0xC357400)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_XOZRENDERER_OFFSET UNITYSDK_OFFSET(0xC3573E0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_XYZOFFSET_OFFSET UNITYSDK_OFFSET(0xC3571D0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_XYZROTATION_OFFSET UNITYSDK_OFFSET(0xC357270)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_YOZRENDERER_OFFSET UNITYSDK_OFFSET(0xC357420)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC3570F0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_SET_LINERENDERERS_OFFSET UNITYSDK_OFFSET(0xC357490)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_SET_XOYRENDERER_OFFSET UNITYSDK_OFFSET(0xC357410)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_SET_XOZRENDERER_OFFSET UNITYSDK_OFFSET(0xC3573F0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_SET_YOZRENDERER_OFFSET UNITYSDK_OFFSET(0xC357430)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_START_OFFSET UNITYSDK_OFFSET(0xC357090)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_UPDATE_OFFSET UNITYSDK_OFFSET(0xC357180)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0xC3574B0)
