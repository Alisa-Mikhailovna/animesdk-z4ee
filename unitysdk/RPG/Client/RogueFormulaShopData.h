...
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0xD39DDA0)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_GET_INSHOPITEMS_OFFSET UNITYSDK_OFFSET(0xD39E720)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_GET_REFRESHCOST_OFFSET UNITYSDK_OFFSET(0xD39E780)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_GET_REMAINREFRESHTIMES_OFFSET UNITYSDK_OFFSET(0xD39E740)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_GET_TOTALREFRESHTIMES_OFFSET UNITYSDK_OFFSET(0xD39E760)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SENDBUYROGUESHOPFORMULACSREQ_OFFSET UNITYSDK_OFFSET(0xD39DF40)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SENDGETROGUESHOPFORMULAINFOCSREQ_OFFSET UNITYSDK_OFFSET(0xD39DE40)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SENDREFRESHROGUESHOPFORMULACSREQ_OFFSET UNITYSDK_OFFSET(0xD39E620)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SET_INSHOPITEMS_OFFSET UNITYSDK_OFFSET(0xD39E730)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SET_REFRESHCOST_OFFSET UNITYSDK_OFFSET(0xD39E790)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SET_REMAINREFRESHTIMES_OFFSET UNITYSDK_OFFSET(0xD39E750)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SET_TOTALREFRESHTIMES_OFFSET UNITYSDK_OFFSET(0xD39E770)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SYNCCONFIG_OFFSET UNITYSDK_OFFSET(0xD39DC00)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SYNCITEM_OFFSET UNITYSDK_OFFSET(0xD39D3C0)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD39E7A0)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA__REPORTBUYFORMULA_OFFSET UNITYSDK_OFFSET(0xD39E070)
