...
#define RPG_CLIENT_AVATARSKINHELPER_ADDAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0xBE0F150)
#define RPG_CLIENT_AVATARSKINHELPER_CHECKSKINISNEW_OFFSET UNITYSDK_OFFSET(0xBE0FC20)
#define RPG_CLIENT_AVATARSKINHELPER_CHECKSKINISOWNED_OFFSET UNITYSDK_OFFSET(0xBE0FA80)
#define RPG_CLIENT_AVATARSKINHELPER_FILLNEWSKINIDSTO_OFFSET UNITYSDK_OFFSET(0xBE0FF70)
#define RPG_CLIENT_AVATARSKINHELPER_GETORIGINSKIN_OFFSET UNITYSDK_OFFSET(0xBE0F860)
#define RPG_CLIENT_AVATARSKINHELPER_GETOWNERAVATARPATHNAME_OFFSET UNITYSDK_OFFSET(0xBE0F8B0)
#define RPG_CLIENT_AVATARSKINHELPER_GETSKINBYSKINID_OFFSET UNITYSDK_OFFSET(0xBE0F620)
#define RPG_CLIENT_AVATARSKINHELPER_GETSKIN_OFFSET UNITYSDK_OFFSET(0xBE0F770)
#define RPG_CLIENT_AVATARSKINHELPER_MARKSKINHASSEEN_OFFSET UNITYSDK_OFFSET(0xBE0FDB0)
#define RPG_CLIENT_AVATARSKINHELPER_TRYGETAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0xBE0F020)
