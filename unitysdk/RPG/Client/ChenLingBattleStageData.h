...
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ALLYTEAMICONPATH_OFFSET UNITYSDK_OFFSET(0xC0785D0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ENEMYCOMMANDERNAME_OFFSET UNITYSDK_OFFSET(0xC078450)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ENEMYTEAMICONPATHINBATTLE_OFFSET UNITYSDK_OFFSET(0xC078850)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ENEMYTEAMICONPATH_OFFSET UNITYSDK_OFFSET(0xC0787B0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_FINISHUNLOCKDECKID_OFFSET UNITYSDK_OFFSET(0xC078200)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ISSEENUNLOK_OFFSET UNITYSDK_OFFSET(0xC0782E0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xC0782A0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_LOCKDECKID_OFFSET UNITYSDK_OFFSET(0xC078510)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC078190)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_NEXTID_OFFSET UNITYSDK_OFFSET(0xC078030)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_STAGESTATE_OFFSET UNITYSDK_OFFSET(0xC078410)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC077EF0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_WAVEDATAS_OFFSET UNITYSDK_OFFSET(0xC0785B0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET__NAME_OFFSET UNITYSDK_OFFSET(0xC0780D0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC077FD0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_SETUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0xC077C00)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_SET_WAVEDATAS_OFFSET UNITYSDK_OFFSET(0xC0785C0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_SYNCSTATE_OFFSET UNITYSDK_OFFSET(0xC077C50)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC077890)
