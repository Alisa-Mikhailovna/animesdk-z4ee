...
#define RPG_CLIENT_MONOBODYBLENDSHAPESCONTROLLER_ONIKWORKED_OFFSET UNITYSDK_OFFSET(0xCC32D10)
#define RPG_CLIENT_MONOBODYBLENDSHAPESCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xCC32B30)
#define RPG_CLIENT_MONOBODYBLENDSHAPESCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xCC32C60)
#define RPG_CLIENT_MONOBODYBLENDSHAPESCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC33030)
