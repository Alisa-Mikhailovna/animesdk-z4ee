...
#define RPG_CLIENT_DRINKMAKERCHEERSADDMATCHATDATA_GET_CHATTEXT_OFFSET UNITYSDK_OFFSET(0xC2BC560)
#define RPG_CLIENT_DRINKMAKERCHEERSADDMATCHATDATA_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xC2BC4F0)
#define RPG_CLIENT_DRINKMAKERCHEERSADDMATCHATDATA_GET_INGREDIENTID_OFFSET UNITYSDK_OFFSET(0xC2BC450)
#define RPG_CLIENT_DRINKMAKERCHEERSADDMATCHATDATA_GET_MATCHGROUPID_OFFSET UNITYSDK_OFFSET(0xC2BC4A0)
#define RPG_CLIENT_DRINKMAKERCHEERSADDMATCHATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC2BC440)
