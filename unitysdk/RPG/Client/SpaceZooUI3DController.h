...
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD52ACA0)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER_CREATERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0xD52A570)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER_GETTARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xD52A3D0)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xD52A1A0)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD52AD00)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER_SETBG_OFFSET UNITYSDK_OFFSET(0xD52A410)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER_SETUPCATMODEL_OFFSET UNITYSDK_OFFSET(0xD52A6F0)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD52AF30)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER__INIT_OFFSET UNITYSDK_OFFSET(0xD52A1F0)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER__RELEASEBGTEXTURE_OFFSET UNITYSDK_OFFSET(0xD52A4F0)
#define RPG_CLIENT_SPACEZOOUI3DCONTROLLER__RELEASERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0xD52A670)

namespace RPG::Client
{
	inline static constexpr unsigned int SpaceZooUI3DController_TypeDefinitionIndex = 69671;
