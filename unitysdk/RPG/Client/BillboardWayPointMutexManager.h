...
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBEBACC0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_GET_BOARDSHOWTYPE_OFFSET UNITYSDK_OFFSET(0xBEBB990)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_GET_GLOBALSHOW_OFFSET UNITYSDK_OFFSET(0xBEBB9A0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xBEBB9C0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_SETGLOBALBOARDSHOWTYPE_OFFSET UNITYSDK_OFFSET(0xBEBAE70)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_SET_GLOBALSHOW_OFFSET UNITYSDK_OFFSET(0xBEBB9B0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_SET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xBEBB9D0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0xBEBAD90)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__ADJUSTBILLBOARDINDEX_OFFSET UNITYSDK_OFFSET(0xBEBB690)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CANBILLBOARDSHOW_OFFSET UNITYSDK_OFFSET(0xBEBAEF0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CANWAYPOINTSHOW_OFFSET UNITYSDK_OFFSET(0xBEBAF80)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__COMPAREBILLBOARDSBYCAMERADISTANCE_OFFSET UNITYSDK_OFFSET(0xBEBB8C0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CREATEMUTEXCONFIG_OFFSET UNITYSDK_OFFSET(0xBEBB620)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEBAAE0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__GETENTITYBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xBEBB4A0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__GETENTITYMUTEXSTATUS_OFFSET UNITYSDK_OFFSET(0xBEBB020)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__NOTIFYMUTEXSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xBEBB310)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__ONBILLBOARDVISIBLECHANGE_OFFSET UNITYSDK_OFFSET(0xBEBB440)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__ONMUTEXSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xBEBB220)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__SORTBILLBOARDS_OFFSET UNITYSDK_OFFSET(0xBEBB7F0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__TICKBILLBOARD_OFFSET UNITYSDK_OFFSET(0xBEBAE10)
