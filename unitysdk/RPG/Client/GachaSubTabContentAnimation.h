...
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_FROMBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xC6779D0)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_FROMFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xC677970)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_TOBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xC677910)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_TOFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xC6778B0)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC677860)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xC677A30)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaSubTabContentAnimation_TypeDefinitionIndex = 69494;
