...
#define RPG_CLIENT_INVERSEMASK_ADDMASKRECT_OFFSET UNITYSDK_OFFSET(0xC8FA4E0)
#define RPG_CLIENT_INVERSEMASK_ADDMASKREGION_OFFSET UNITYSDK_OFFSET(0xC8F9CC0)
#define RPG_CLIENT_INVERSEMASK_ADDTRANS_OFFSET UNITYSDK_OFFSET(0xC8F94E0)
#define RPG_CLIENT_INVERSEMASK_AWAKE_OFFSET UNITYSDK_OFFSET(0xC8FB300)
#define RPG_CLIENT_INVERSEMASK_CLEAR_OFFSET UNITYSDK_OFFSET(0xC8FADB0)
#define RPG_CLIENT_INVERSEMASK_GET_MATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0xC8FAD50)
#define RPG_CLIENT_INVERSEMASK_GET_UICAM_OFFSET UNITYSDK_OFFSET(0xC8FB4E0)
#define RPG_CLIENT_INVERSEMASK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC8FB420)
#define RPG_CLIENT_INVERSEMASK_START_OFFSET UNITYSDK_OFFSET(0xC8FB350)
#define RPG_CLIENT_INVERSEMASK_UPDATEBLUR_OFFSET UNITYSDK_OFFSET(0xC8FAC90)
#define RPG_CLIENT_INVERSEMASK_UPDATEMASKRECT_OFFSET UNITYSDK_OFFSET(0xC8FA960)
#define RPG_CLIENT_INVERSEMASK_UPDATEMASKREGION_OFFSET UNITYSDK_OFFSET(0xC8FA350)
#define RPG_CLIENT_INVERSEMASK_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0xC8FAE60)
#define RPG_CLIENT_INVERSEMASK_UPDATETRANS_OFFSET UNITYSDK_OFFSET(0xC8F9B60)
#define RPG_CLIENT_INVERSEMASK__CTOR_OFFSET UNITYSDK_OFFSET(0xC8FB650)
#define RPG_CLIENT_INVERSEMASK__SCALEVECTOR_OFFSET UNITYSDK_OFFSET(0xC8FA840)
#define RPG_CLIENT_INVERSEMASK__SETPOSITIONBYBOUNDS_OFFSET UNITYSDK_OFFSET(0xC8F9EC0)
#define RPG_CLIENT_INVERSEMASK__SETPOSITIONBYRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC8F96B0)

namespace RPG::Client
{
	inline static constexpr unsigned int InverseMask_TypeDefinitionIndex = 69274;
	...
	public:
		...
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(InverseMask_TypeDefinitionIndex)->GetStaticField(0x34A90);
		}
		static ::System::Int32* StaticGet_m_Count()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InverseMask_TypeDefinitionIndex)->GetStaticField(0x8A50);
		}
