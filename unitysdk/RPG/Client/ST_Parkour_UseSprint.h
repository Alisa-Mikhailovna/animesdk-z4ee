...
#define RPG_CLIENT_ST_PARKOUR_USESPRINT_METHOD_4_D0C6D4B0CB443A76_OFFSET UNITYSDK_OFFSET(0x1B0ED000)
#define RPG_CLIENT_ST_PARKOUR_USESPRINT_METHOD_4_DCB9B1920AE554F7_OFFSET UNITYSDK_OFFSET(0x1B0ECFC0)
#define RPG_CLIENT_ST_PARKOUR_USESPRINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0ECFF0)
