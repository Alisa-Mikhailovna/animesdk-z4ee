...
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xC46C8E0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_EXTRAEFFECTARRAY_OFFSET UNITYSDK_OFFSET(0xC46D5E0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_RELATEDFATEBUFFIDLIST_OFFSET UNITYSDK_OFFSET(0xC46D370)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITBIGICONPATH_OFFSET UNITYSDK_OFFSET(0xC46CF60)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITBUFFITEMLIST_OFFSET UNITYSDK_OFFSET(0xC46D240)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITDESC_OFFSET UNITYSDK_OFFSET(0xC46CE20)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xC46CA10)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITID_OFFSET UNITYSDK_OFFSET(0xC46C9D0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITLEVEL_OFFSET UNITYSDK_OFFSET(0xC46C9F0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITNAME_OFFSET UNITYSDK_OFFSET(0xC46CAE0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITSMALLICONPATH_OFFSET UNITYSDK_OFFSET(0xC46D0B0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITSOURCELIST_OFFSET UNITYSDK_OFFSET(0xC46D4A0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITTYPE_OFFSET UNITYSDK_OFFSET(0xC46CCB0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_SET_TRAITID_OFFSET UNITYSDK_OFFSET(0xC46C9E0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_SET_TRAITLEVEL_OFFSET UNITYSDK_OFFSET(0xC46CA00)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC46C9C0)
