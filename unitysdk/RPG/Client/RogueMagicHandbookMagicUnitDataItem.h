...
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0xD3BCFE0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_DISPLAYDATAITEM_OFFSET UNITYSDK_OFFSET(0xD3BD880)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_EFFECT_OFFSET UNITYSDK_OFFSET(0xD3BD240)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_EXTRAEFFECTS_OFFSET UNITYSDK_OFFSET(0xD3BD440)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_FUNCTYPE_OFFSET UNITYSDK_OFFSET(0xD3BD790)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD3BD150)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xD3BD8C0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xD3BCE40)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_MAGICUNITID_OFFSET UNITYSDK_OFFSET(0xD3BCDF0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_MOUNTTYPE_OFFSET UNITYSDK_OFFSET(0xD3BD530)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD3BCE90)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_STYLETYPE_OFFSET UNITYSDK_OFFSET(0xD3BD6A0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xD3BD8D0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_SYNCISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xD3BC520)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD3BB9B0)
