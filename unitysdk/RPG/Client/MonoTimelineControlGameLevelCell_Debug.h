...
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_DEBUG_GET_ORTHODEPTH_OFFSET UNITYSDK_OFFSET(0xCD29840)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_DEBUG_GET_ORTHOPOSITION_OFFSET UNITYSDK_OFFSET(0xCD29860)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_DEBUG_SET_ORTHODEPTH_OFFSET UNITYSDK_OFFSET(0xCD29850)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_DEBUG_SET_ORTHOPOSITION_OFFSET UNITYSDK_OFFSET(0xCD29870)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_DEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xCD29830)
