...
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE_ENTER_OFFSET UNITYSDK_OFFSET(0xCD2F160)
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE_EXIT_OFFSET UNITYSDK_OFFSET(0xCD2F640)
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE_TICK_OFFSET UNITYSDK_OFFSET(0xCD2F240)
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE__CHECKINBOUNDRYVEC2_OFFSET UNITYSDK_OFFSET(0xCD2F460)
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD2F150)
