...
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_GETDISTANCE_OFFSET UNITYSDK_OFFSET(0xD79DC20)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD79C850)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_REFRESHWAYPOINTITEM_OFFSET UNITYSDK_OFFSET(0xD79CAB0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_START_OFFSET UNITYSDK_OFFSET(0xD79C6C0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_UPDATESAFEZONE_OFFSET UNITYSDK_OFFSET(0xD79C8F0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xD79DEE0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER__GETARROWROTATION_OFFSET UNITYSDK_OFFSET(0xD79D990)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER__ONSETWAYPOINTSAFEZONE_OFFSET UNITYSDK_OFFSET(0xD79DCE0)
