...
#define RPG_CLIENT_CONFIRMDIALOGUTIL___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC1B3FE0)
#define RPG_CLIENT_CONFIRMDIALOGUTIL___C__DISPLAYCLASS14_0__SHOWSERVERSTOPHINT_B__0_OFFSET UNITYSDK_OFFSET(0xC1B6B70)

namespace RPG::Client
{
	inline static constexpr unsigned int ConfirmDialogUtil___c__DisplayClass14_0_TypeDefinitionIndex = 69417;
