...
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_CLICK_OFFSET UNITYSDK_OFFSET(0xD783F30)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0xD783630)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_METHOD_7_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0xD783DB0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_METHOD_7_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0xD783B20)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_METHOD_7_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xD7839E0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_SETICON_OFFSET UNITYSDK_OFFSET(0xD783E60)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_SETMATERIALCOLOR_OFFSET UNITYSDK_OFFSET(0xD783920)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND__CTOR_OFFSET UNITYSDK_OFFSET(0xD784190)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyGround_TypeDefinitionIndex = 72090;
