...
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_DISPOSECAMERA_OFFSET UNITYSDK_OFFSET(0xD77A2E0)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_INITCAMERA_OFFSET UNITYSDK_OFFSET(0xD779B80)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD77A070)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD779D90)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_REFRESH_OFFSET UNITYSDK_OFFSET(0xD779F70)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD77A470)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int ChimeraBattleCameraView_TypeDefinitionIndex = 72049;
