...
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLENPCVIEW_CLASS_1_F16F4B18C8432A77_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xD77BBD0)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLENPCVIEW_CLASS_1_F16F4B18C8432A77_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD77BE30)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLENPCVIEW_CLASS_1_F16F4B18C8432A77__CCTOR_OFFSET UNITYSDK_OFFSET(0xD77BE80)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLENPCVIEW_CLASS_1_F16F4B18C8432A77__CTOR_OFFSET UNITYSDK_OFFSET(0xD77B860)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int ChimeraBattleNPCView_Class_1_F16F4B18C8432A77_TypeDefinitionIndex = 72052;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChimeraBattleNPCView_Class_1_F16F4B18C8432A77_TypeDefinitionIndex)->GetStaticField(0xD320);
		}
