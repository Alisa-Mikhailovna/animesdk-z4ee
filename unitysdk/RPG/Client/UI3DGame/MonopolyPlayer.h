...
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_GETWORLDPOS_OFFSET UNITYSDK_OFFSET(0xD784420)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD7843D0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD784380)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xD782E40)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMBOOLPARAM_OFFSET UNITYSDK_OFFSET(0xD784220)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMFLOATPARAM_OFFSET UNITYSDK_OFFSET(0xD784290)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0xD784310)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_START_OFFSET UNITYSDK_OFFSET(0xD7844C0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD784710)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xD784840)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyPlayer_TypeDefinitionIndex = 72092;
