...
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0xD77CF90)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_METHOD_7_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xD77D010)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_SETICON_OFFSET UNITYSDK_OFFSET(0xD77D150)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_SETMATERIALCOLOR_OFFSET UNITYSDK_OFFSET(0xD77D220)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER__CTOR_OFFSET UNITYSDK_OFFSET(0xD77D2E0)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyBarrier_TypeDefinitionIndex = 72088;
