...
#define RPG_CLIENT_CHIMERABATTLEPUZZLEAREA_GET_TEAMMEMBERANCHORS_OFFSET UNITYSDK_OFFSET(0xC10AA30)
#define RPG_CLIENT_CHIMERABATTLEPUZZLEAREA_METHOD_5_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0xC10A110)
#define RPG_CLIENT_CHIMERABATTLEPUZZLEAREA_START_OFFSET UNITYSDK_OFFSET(0xC109F50)
#define RPG_CLIENT_CHIMERABATTLEPUZZLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xC10AA90)
