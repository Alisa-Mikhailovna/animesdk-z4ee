...
#define RPG_CLIENT_ENABLEELFENVIRONMENT_METHOD_3_1B347327C9B4FD2A_OFFSET UNITYSDK_OFFSET(0x1B0E0520)
#define RPG_CLIENT_ENABLEELFENVIRONMENT_METHOD_3_E768B99BEA3AA751_OFFSET UNITYSDK_OFFSET(0x1B0E0560)
#define RPG_CLIENT_ENABLEELFENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E0550)
