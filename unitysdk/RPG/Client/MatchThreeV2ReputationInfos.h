...
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_CREATE_OFFSET UNITYSDK_OFFSET(0xCB819C0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_GETCHALLENGINGREPUTATIONDATALIST_OFFSET UNITYSDK_OFFSET(0xCB81D10)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_GETMAXREPUTATION_OFFSET UNITYSDK_OFFSET(0xCB81CD0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_GETREPUTATIONDATALIST_OFFSET UNITYSDK_OFFSET(0xCB7DA60)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_GETREPUTATIONDATA_OFFSET UNITYSDK_OFFSET(0xCB7AFC0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS__CTOR_OFFSET UNITYSDK_OFFSET(0xCB81A30)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS__INIT_OFFSET UNITYSDK_OFFSET(0xCB81A40)
