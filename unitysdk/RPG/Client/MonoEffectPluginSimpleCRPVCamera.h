...
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC8210)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC82D0)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_DISABLEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC83E0)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC8150)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_ENABLEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC8370)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xCCC84C0)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xCCC8560)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xCCC8030)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC8070)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA_TICK_OFFSET UNITYSDK_OFFSET(0xCCC8450)
#define RPG_CLIENT_MONOEFFECTPLUGINSIMPLECRPVCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC8570)
