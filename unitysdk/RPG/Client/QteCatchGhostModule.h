...
#define RPG_CLIENT_QTECATCHGHOSTMODULE_AUTOFINISH_OFFSET UNITYSDK_OFFSET(0xD277DD0)
#define RPG_CLIENT_QTECATCHGHOSTMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD277E20)
#define RPG_CLIENT_QTECATCHGHOSTMODULE_REGISTERINSTANCE_OFFSET UNITYSDK_OFFSET(0xD277C80)
#define RPG_CLIENT_QTECATCHGHOSTMODULE_UNREGISTERINSTANCE_OFFSET UNITYSDK_OFFSET(0xD277D40)
#define RPG_CLIENT_QTECATCHGHOSTMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xD277B40)
#define RPG_CLIENT_QTECATCHGHOSTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xD277E80)
#define RPG_CLIENT_QTECATCHGHOSTMODULE__ONADVENTUREPHASEEND_OFFSET UNITYSDK_OFFSET(0xD277BE0)
