...
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP_GET_BATTLEEVENTID_OFFSET UNITYSDK_OFFSET(0xBE44060)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP_GET_ISDYNAMICPRELOAD_OFFSET UNITYSDK_OFFSET(0xBE43FE0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP_JSONCONFIGPATHTOPRELOADNAME_OFFSET UNITYSDK_OFFSET(0xBE443E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP_REFRESHAFTERENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xBE44A00)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP_REFRESHBEFOREENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xBE44900)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP_REFRESHINADVENTURE_OFFSET UNITYSDK_OFFSET(0xBE44890)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP_UPDATEBATTLEMODEL_OFFSET UNITYSDK_OFFSET(0xBE44750)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP__COLLECTRESOURCEIMPL_OFFSET UNITYSDK_OFFSET(0xBE44520)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xBE44B90)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP__GETDEFAULTBATTLEMODELPATH_OFFSET UNITYSDK_OFFSET(0xBE44B00)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP__ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0xBE44070)
#define RPG_CLIENT_BATTLEASSETPRELOAD_BATTLEEVENTASSETPRELOADGROUP__UPDATEBATTLEMODELPRELOADTYPE_OFFSET UNITYSDK_OFFSET(0xBE447B0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(BattleAssetPreload_BattleEventAssetPreloadGroup_TypeDefinitionIndex)->GetStaticField(0x55DE0);
		}
