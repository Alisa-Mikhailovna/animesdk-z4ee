...
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_ARRANGEHINTIMAGE_OFFSET UNITYSDK_OFFSET(0xC1658A0)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_DISPLAYTEAMID_OFFSET UNITYSDK_OFFSET(0xC1659E0)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_ISSSR_OFFSET UNITYSDK_OFFSET(0xC165730)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_NEWCHIMERAIDARR_OFFSET UNITYSDK_OFFSET(0xC165690)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0xC1657D0)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_RECOMMENDEDARRANGEMENTPRESETIDARR_OFFSET UNITYSDK_OFFSET(0xC165940)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_ROUNDID_OFFSET UNITYSDK_OFFSET(0xC165580)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_WARNINGTEXT_OFFSET UNITYSDK_OFFSET(0xC1657E0)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_WORKIDARR_OFFSET UNITYSDK_OFFSET(0xC1655F0)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC165590)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_ISFINAL_OFFSET UNITYSDK_OFFSET(0xC165DB0)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_ISINTUTORIALONACCELERATION_OFFSET UNITYSDK_OFFSET(0xC165D50)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_ISINTUTORIALONARRANGE_OFFSET UNITYSDK_OFFSET(0xC165C90)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_ISINTUTORIALONMISSION_OFFSET UNITYSDK_OFFSET(0xC165CF0)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC165A80)
