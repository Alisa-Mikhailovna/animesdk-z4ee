...
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_CLEARLISTEDSIZE_OFFSET UNITYSDK_OFFSET(0xD68D4E0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_LANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0xD68D410)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD68D420)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_RAWSIZE_OFFSET UNITYSDK_OFFSET(0xD68D530)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_SIZE_OFFSET UNITYSDK_OFFSET(0xD68D4D0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_TEXTLANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0xD68D3F0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_SETSIZE_OFFSET UNITYSDK_OFFSET(0xD689BF0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_SET_TEXTLANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0xD68D400)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD689BE0)
