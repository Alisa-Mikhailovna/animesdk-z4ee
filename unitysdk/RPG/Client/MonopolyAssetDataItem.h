...
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_GET_ASSETDESC_OFFSET UNITYSDK_OFFSET(0xCD3DDD0)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_GET_ASSETNAME_OFFSET UNITYSDK_OFFSET(0xCD3DD20)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_GET_DISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xCD3DE80)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_GET_FIGUREPATH_OFFSET UNITYSDK_OFFSET(0xCD3DCA0)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_GET_HASNEXTLEVEL_OFFSET UNITYSDK_OFFSET(0xCD3DC30)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xCD3DBA0)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_GET_ISOWNEDBYPLAYER_OFFSET UNITYSDK_OFFSET(0xCD3DBE0)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCD3DBC0)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_GET_TOTALPROFIT_OFFSET UNITYSDK_OFFSET(0xCD3DF50)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_MODIFY_OFFSET UNITYSDK_OFFSET(0xCD3DB50)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0xCD3DBB0)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCD3DBD0)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_SET_TOTALPROFIT_OFFSET UNITYSDK_OFFSET(0xCD3DF60)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM_SYNC_OFFSET UNITYSDK_OFFSET(0xCD3DAB0)
#define RPG_CLIENT_MONOPOLYASSETDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3DAA0)
