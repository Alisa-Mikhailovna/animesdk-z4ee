...
#define RPG_CLIENT_MUSEUMAREADATA_ADDEXHIBITSTUFF_OFFSET UNITYSDK_OFFSET(0xCDEFBC0)
#define RPG_CLIENT_MUSEUMAREADATA_CALCULATEANDUPDATEDATA_OFFSET UNITYSDK_OFFSET(0xCDEF0B0)
#define RPG_CLIENT_MUSEUMAREADATA_CLEARPREVIEW_OFFSET UNITYSDK_OFFSET(0xCDF0180)
#define RPG_CLIENT_MUSEUMAREADATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCDEE9E0)
#define RPG_CLIENT_MUSEUMAREADATA_GETNEXTLEVELRENEWPOINTADDNUM_OFFSET UNITYSDK_OFFSET(0xCDEFED0)
#define RPG_CLIENT_MUSEUMAREADATA_GETNEXTLEVELSTATADDNUM_OFFSET UNITYSDK_OFFSET(0xCDEFE60)
#define RPG_CLIENT_MUSEUMAREADATA_GETPROPERTYDATA_1_OFFSET UNITYSDK_OFFSET(0xCDEF310)
#define RPG_CLIENT_MUSEUMAREADATA_GETPROPERTYDATA_OFFSET UNITYSDK_OFFSET(0xCDEEC60)
#define RPG_CLIENT_MUSEUMAREADATA_GETSTAFFNUM_OFFSET UNITYSDK_OFFSET(0xCDF03B0)
#define RPG_CLIENT_MUSEUMAREADATA_GET_AREARENEWPOINT_OFFSET UNITYSDK_OFFSET(0xCDF0BE0)
#define RPG_CLIENT_MUSEUMAREADATA_GET_EXHIBITSTUFFSCOUNT_OFFSET UNITYSDK_OFFSET(0xCDF0C60)
#define RPG_CLIENT_MUSEUMAREADATA_GET_EXHIBITSTUFFSMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xCDF0CB0)
#define RPG_CLIENT_MUSEUMAREADATA_GET_EXHIBITSTUFFS_OFFSET UNITYSDK_OFFSET(0xCDF0C40)
#define RPG_CLIENT_MUSEUMAREADATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xCDF0C00)
#define RPG_CLIENT_MUSEUMAREADATA_GET_ISLOCK_OFFSET UNITYSDK_OFFSET(0xCDF0CD0)
#define RPG_CLIENT_MUSEUMAREADATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCDF0990)
#define RPG_CLIENT_MUSEUMAREADATA_GET_MUSEUMAREANAME_OFFSET UNITYSDK_OFFSET(0xCDF0E00)
#define RPG_CLIENT_MUSEUMAREADATA_GET_MUSEUMAREATABICON_OFFSET UNITYSDK_OFFSET(0xCDF0E70)
#define RPG_CLIENT_MUSEUMAREADATA_GET_MUSEUMSTAFFDATAS_OFFSET UNITYSDK_OFFSET(0xCDF0BC0)
#define RPG_CLIENT_MUSEUMAREADATA_GET_OWNERMUSEUM_OFFSET UNITYSDK_OFFSET(0xCDEF380)
#define RPG_CLIENT_MUSEUMAREADATA_GET_PROPERTYDATAS_OFFSET UNITYSDK_OFFSET(0xCDF0C20)
#define RPG_CLIENT_MUSEUMAREADATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xCDF0CF0)
#define RPG_CLIENT_MUSEUMAREADATA_HAVESTAFF_OFFSET UNITYSDK_OFFSET(0xCDF0330)
#define RPG_CLIENT_MUSEUMAREADATA_INITEXHIBITMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xCDF04D0)
#define RPG_CLIENT_MUSEUMAREADATA_PREVIEWADDSTAFF_OFFSET UNITYSDK_OFFSET(0xCDF00F0)
#define RPG_CLIENT_MUSEUMAREADATA_PREVIEWNEXTLEVELAREA_OFFSET UNITYSDK_OFFSET(0xCDEFF30)
#define RPG_CLIENT_MUSEUMAREADATA_PREVIEWNEXTLEVELSTAT_OFFSET UNITYSDK_OFFSET(0xCDF0060)
#define RPG_CLIENT_MUSEUMAREADATA_SET_AREARENEWPOINT_OFFSET UNITYSDK_OFFSET(0xCDF0BF0)
#define RPG_CLIENT_MUSEUMAREADATA_SET_EXHIBITSTUFFSMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xCDF0CC0)
#define RPG_CLIENT_MUSEUMAREADATA_SET_EXHIBITSTUFFS_OFFSET UNITYSDK_OFFSET(0xCDF0C50)
#define RPG_CLIENT_MUSEUMAREADATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xCDF0C10)
#define RPG_CLIENT_MUSEUMAREADATA_SET_ISLOCK_OFFSET UNITYSDK_OFFSET(0xCDF0CE0)
#define RPG_CLIENT_MUSEUMAREADATA_SET_MUSEUMSTAFFDATAS_OFFSET UNITYSDK_OFFSET(0xCDF0BD0)
#define RPG_CLIENT_MUSEUMAREADATA_SET_PROPERTYDATAS_OFFSET UNITYSDK_OFFSET(0xCDF0C30)
#define RPG_CLIENT_MUSEUMAREADATA_SYNCMUSEUMAREADATA_OFFSET UNITYSDK_OFFSET(0xCDEEA60)
#define RPG_CLIENT_MUSEUMAREADATA_TRYADDSTAFF_OFFSET UNITYSDK_OFFSET(0xCDEFC70)
#define RPG_CLIENT_MUSEUMAREADATA_TRYREMOVESTAFF_OFFSET UNITYSDK_OFFSET(0xCDEFD70)
#define RPG_CLIENT_MUSEUMAREADATA_UPDATESTAFFDATA_OFFSET UNITYSDK_OFFSET(0xCDEF210)
#define RPG_CLIENT_MUSEUMAREADATA__CACHEPREDATA_OFFSET UNITYSDK_OFFSET(0xCDEF410)
#define RPG_CLIENT_MUSEUMAREADATA__CLEARCACHEDATA_OFFSET UNITYSDK_OFFSET(0xCDF09E0)
#define RPG_CLIENT_MUSEUMAREADATA__CLEARPREVIEWDATA_OFFSET UNITYSDK_OFFSET(0xCDF0210)
#define RPG_CLIENT_MUSEUMAREADATA__CLEARSTAFFLIST_OFFSET UNITYSDK_OFFSET(0xCDF0740)
#define RPG_CLIENT_MUSEUMAREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCDEE880)
#define RPG_CLIENT_MUSEUMAREADATA__REFRESHPROPERTYCACHEDATA_OFFSET UNITYSDK_OFFSET(0xCDEF7D0)
#define RPG_CLIENT_MUSEUMAREADATA__SYNCSTAFFLIST_OFFSET UNITYSDK_OFFSET(0xCDEEED0)
#define RPG_CLIENT_MUSEUMAREADATA__UPDATEEXHIBITSTUFFS_OFFSET UNITYSDK_OFFSET(0xCDEECD0)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::GameCore::MuseumAreaConfigRow* _Row; // 0x48
		::System::UInt32 _ID_k__BackingField; // 0x50
		::System::Int32 _ExhibitStuffsMaxCount_k__BackingField; // 0x54
		::System::Boolean _IsLock_k__BackingField; // 0x58
		::System::Nullable_1<::System::Boolean> _PreRenewPointMaxCache; // 0x59
