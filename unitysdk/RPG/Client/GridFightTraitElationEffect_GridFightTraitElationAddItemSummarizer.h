...
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0xC8469E0)
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_UPDATEADDITEM_OFFSET UNITYSDK_OFFSET(0xC846CD0)
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_UPDATEORB_OFFSET UNITYSDK_OFFSET(0xC846B40)
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER__CTOR_OFFSET UNITYSDK_OFFSET(0xC846710)
