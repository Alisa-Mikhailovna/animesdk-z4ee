...
#define RPG_CLIENT_VIRTUALCAMERAAUTOFITSCREEN_REINIT_OFFSET UNITYSDK_OFFSET(0xD896520)
#define RPG_CLIENT_VIRTUALCAMERAAUTOFITSCREEN_SETFITRATIOX_OFFSET UNITYSDK_OFFSET(0xD896570)
#define RPG_CLIENT_VIRTUALCAMERAAUTOFITSCREEN_STARTUPDATE_OFFSET UNITYSDK_OFFSET(0xD8964D0)
#define RPG_CLIENT_VIRTUALCAMERAAUTOFITSCREEN_STOPUPDATE_OFFSET UNITYSDK_OFFSET(0xD896400)
#define RPG_CLIENT_VIRTUALCAMERAAUTOFITSCREEN_UPDATETRACKOBJECTOFFSET_OFFSET UNITYSDK_OFFSET(0xD896450)
#define RPG_CLIENT_VIRTUALCAMERAAUTOFITSCREEN_UPDATE_OFFSET UNITYSDK_OFFSET(0xD895770)
#define RPG_CLIENT_VIRTUALCAMERAAUTOFITSCREEN__CTOR_OFFSET UNITYSDK_OFFSET(0xD8965D0)
