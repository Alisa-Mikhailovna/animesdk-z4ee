...
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL_GET_ONFOCUSED_OFFSET UNITYSDK_OFFSET(0xBF4AD90)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4B050)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF4ADA0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBF4AEB0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__ONUIFOCUSCONTROLLERCHANGED_OFFSET UNITYSDK_OFFSET(0xBF4AF30)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeFocusChangeDetectControl_TypeDefinitionIndex = 76456;
