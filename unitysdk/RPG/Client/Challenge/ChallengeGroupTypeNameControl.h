...
#define RPG_CLIENT_CHALLENGE_CHALLENGEGROUPTYPENAMECONTROL_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xBF4B8C0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEGROUPTYPENAMECONTROL_SET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xBF4B900)
#define RPG_CLIENT_CHALLENGE_CHALLENGEGROUPTYPENAMECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4BA60)
#define RPG_CLIENT_CHALLENGE_CHALLENGEGROUPTYPENAMECONTROL__REFRESH_OFFSET UNITYSDK_OFFSET(0xBF4B950)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeGroupTypeNameControl_TypeDefinitionIndex = 76457;
