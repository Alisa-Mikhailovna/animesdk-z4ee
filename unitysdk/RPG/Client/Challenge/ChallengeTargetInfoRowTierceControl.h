...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xBF4D870)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL_METHOD_5_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0xBF4D8B0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4D910)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetInfoRowTierceControl_TypeDefinitionIndex = 76462;
