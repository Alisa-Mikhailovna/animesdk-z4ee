...
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_GET_MONSTERGUIDE_OFFSET UNITYSDK_OFFSET(0xBF48E60)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0xBF49230)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_AEA49496C256D00F_OFFSET UNITYSDK_OFFSET(0xBF49780)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_DFFB81CA3843CA77_OFFSET UNITYSDK_OFFSET(0xBF49330)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0xBF492C0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0xBF48F40)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_SET_MONSTERGUIDE_OFFSET UNITYSDK_OFFSET(0xBF48EA0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF499A0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL___REFRESH_B__11_0_OFFSET UNITYSDK_OFFSET(0xBF499B0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL___REFRESH_B__11_1_OFFSET UNITYSDK_OFFSET(0xBF499C0)

namespace RPG::Client::Challenge::Boss
{
	inline static constexpr unsigned int ChallengeBossGuideTagListControl_TypeDefinitionIndex = 76677;
