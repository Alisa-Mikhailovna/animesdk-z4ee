...
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_GET_EXITCALLBACK_OFFSET UNITYSDK_OFFSET(0xBF49AC0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_GET_GUIDEDATA_OFFSET UNITYSDK_OFFSET(0xBF49A00)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_GET_ISSINGLELINE_OFFSET UNITYSDK_OFFSET(0xBF49A80)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_GET_NODEPOPUP_OFFSET UNITYSDK_OFFSET(0xBF49A40)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_GET_NODETAGLIST_OFFSET UNITYSDK_OFFSET(0xBF49A60)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_GET_SELECTEDTAG_OFFSET UNITYSDK_OFFSET(0xBF49A20)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_GET_SHOWFIRSTTAGLINE_OFFSET UNITYSDK_OFFSET(0xBF49AA0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_SET_EXITCALLBACK_OFFSET UNITYSDK_OFFSET(0xBF49AD0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_SET_GUIDEDATA_OFFSET UNITYSDK_OFFSET(0xBF49A10)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_SET_ISSINGLELINE_OFFSET UNITYSDK_OFFSET(0xBF49A90)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_SET_NODEPOPUP_OFFSET UNITYSDK_OFFSET(0xBF49A50)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_SET_NODETAGLIST_OFFSET UNITYSDK_OFFSET(0xBF49A70)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_SET_SELECTEDTAG_OFFSET UNITYSDK_OFFSET(0xBF49A30)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS_SET_SHOWFIRSTTAGLINE_OFFSET UNITYSDK_OFFSET(0xBF49AB0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSTAGDETAILWINDOWPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xBF49990)

namespace RPG::Client::Challenge::Boss
{
	inline static constexpr unsigned int ChallengeBossTagDetailWindowParams_TypeDefinitionIndex = 76679;

	class ChallengeBossTagDetailWindowParams : public ::System::Object
	{
	public:
		::RPG::GameCore::MonsterGuideTagConfigRow* _SelectedTag_k__BackingField; // 0x10
		::UnityEngine::RectTransform* _NodePopup_k__BackingField; // 0x18
		::RPG::Client::MonsterGuideData* _GuideData_k__BackingField; // 0x20
		::System::Action_1<::RPG::GameCore::MonsterGuideTagConfigRow*>* _ExitCallback_k__BackingField; // 0x28
