...
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_GET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xBF48CA0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_GET_ONCLICK_OFFSET UNITYSDK_OFFSET(0xBF48BD0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_GET_SHOULDSHOWRIGHTBAR_OFFSET UNITYSDK_OFFSET(0xBF48D80)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_SET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xBF48D20)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_SET_NAME_OFFSET UNITYSDK_OFFSET(0xBF48C30)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_SET_SHOULDSHOWRIGHTBAR_OFFSET UNITYSDK_OFFSET(0xBF48DF0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF48E50)

namespace RPG::Client::Challenge::Boss
{
	inline static constexpr unsigned int ChallengeBossGuideTagItemControl_TypeDefinitionIndex = 76676;
