...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_ISNEWFINISHED_OFFSET UNITYSDK_OFFSET(0xBF4DD70)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_NAMEPARAMS_OFFSET UNITYSDK_OFFSET(0xBF4D0E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBF4D000)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_PROGRESSCURRENT_OFFSET UNITYSDK_OFFSET(0xBF4DCD0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_PROGRESSTOTAL_OFFSET UNITYSDK_OFFSET(0xBF4DD20)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0xBF4DA60)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_SHOULDHIDEPROGRESS_OFFSET UNITYSDK_OFFSET(0xBF4DB50)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_STATE_OFFSET UNITYSDK_OFFSET(0xBF4D920)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET__MODELHASPROGRESSTOSHOW_OFFSET UNITYSDK_OFFSET(0xBF4D970)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_SET_ISNEWFINISHED_OFFSET UNITYSDK_OFFSET(0xBF4DD80)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_SET_SHOULDHIDEPROGRESS_OFFSET UNITYSDK_OFFSET(0xBF4DBA0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4DD90)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetViewModel_TypeDefinitionIndex = 76467;
