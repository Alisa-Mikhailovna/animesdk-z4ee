...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKCONTROL_METHOD_5_323E41095C5791AB_OFFSET UNITYSDK_OFFSET(0xBF512C0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKCONTROL_METHOD_5_6EF49126B84EB647_OFFSET UNITYSDK_OFFSET(0xBF51270)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKCONTROL_METHOD_5_A769C9FD65C21655_OFFSET UNITYSDK_OFFSET(0xBF51230)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF513D0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceEntranceUnlockControl_TypeDefinitionIndex = 76577;
