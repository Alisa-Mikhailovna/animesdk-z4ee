...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMEMORYENVIRONMENTHINTVIEWMODEL_GET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0xBF56540)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMEMORYENVIRONMENTHINTVIEWMODEL_SET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0xBF56550)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMEMORYENVIRONMENTHINTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF56560)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceMemoryEnvironmentHintViewModel_TypeDefinitionIndex = 76634;
