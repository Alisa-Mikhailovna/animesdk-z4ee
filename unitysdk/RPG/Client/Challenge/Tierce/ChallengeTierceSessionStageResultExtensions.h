...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTEXTENSIONS_OFBOSS_OFFSET UNITYSDK_OFFSET(0xBF5FAC0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTEXTENSIONS_OFMEMORY_OFFSET UNITYSDK_OFFSET(0xBF5F980)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTEXTENSIONS_OFSTORY_OFFSET UNITYSDK_OFFSET(0xBF5FA20)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceSessionStageResultExtensions_TypeDefinitionIndex = 76527;
