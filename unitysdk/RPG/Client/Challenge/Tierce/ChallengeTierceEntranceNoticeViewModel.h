...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xBF50D40)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_GET_INTRODUCE_OFFSET UNITYSDK_OFFSET(0xBF50D50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_SETSEEN_OFFSET UNITYSDK_OFFSET(0xBF50F60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xBF50E00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__CHECKSEEN_OFFSET UNITYSDK_OFFSET(0xBF50E80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF50F50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__GETBITSETMASK_OFFSET UNITYSDK_OFFSET(0xBF51170)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__SETSEEN_OFFSET UNITYSDK_OFFSET(0xBF50FB0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceEntranceNoticeViewModel_TypeDefinitionIndex = 76622;
