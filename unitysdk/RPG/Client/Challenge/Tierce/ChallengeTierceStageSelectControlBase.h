...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTCONTROLBASE_GET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xBF65460)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTCONTROLBASE_SET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xBF65540)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTCONTROLBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xBF65220)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageSelectControlBase_TypeDefinitionIndex = 76589;
