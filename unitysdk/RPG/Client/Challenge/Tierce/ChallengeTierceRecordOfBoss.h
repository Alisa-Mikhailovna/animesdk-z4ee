...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFBOSS_GET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xBF59EF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFBOSS_SET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xBF59F00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFBOSS__CTOR_OFFSET UNITYSDK_OFFSET(0xBF59F10)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceRecordOfBoss_TypeDefinitionIndex = 76509;
