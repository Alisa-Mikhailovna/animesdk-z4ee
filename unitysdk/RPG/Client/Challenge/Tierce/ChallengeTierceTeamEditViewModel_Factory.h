...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_FACTORY_CREATE_OFFSET UNITYSDK_OFFSET(0xBF79FB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_FACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0xBF79F80)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditViewModel_Factory_TypeDefinitionIndex = 76666;
	...
	public:
		...
		::RPG::Client::Challenge::Tierce::ChallengeTierceTeamEditTeamViewModel_Factory* _TeamFactory; // 0x38
