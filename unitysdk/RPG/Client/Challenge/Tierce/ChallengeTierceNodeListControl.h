...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_BINDVIEWMODEL_1_OFFSET UNITYSDK_OFFSET(0xBF568C0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_BINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF567C0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_GET_BINDITEM_OFFSET UNITYSDK_OFFSET(0xBF567A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_GET_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xBF56780)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0xBF56570)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_184A831148A944B5_OFFSET UNITYSDK_OFFSET(0xBF565B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_36EB20BAEC6C0B33_OFFSET UNITYSDK_OFFSET(0xBF569A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_AF8C0870C2DDC5FB_OFFSET UNITYSDK_OFFSET(0xBF56B10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_F37642F7827EADFF_OFFSET UNITYSDK_OFFSET(0xBF56F70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_SET_BINDITEM_OFFSET UNITYSDK_OFFSET(0xBF567B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_SET_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xBF56790)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_SET_ITEMS_OFFSET UNITYSDK_OFFSET(0xBF4A5F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF57070)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceNodeListControl_TypeDefinitionIndex = 76563;
