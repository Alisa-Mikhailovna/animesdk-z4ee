...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFMEMORY_GET_DEADMEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xBF5FC00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFMEMORY_GET_USEDROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xBF5FC10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFMEMORY_WITH_OFFSET UNITYSDK_OFFSET(0xBF5FCE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFMEMORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBF5FC30)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFMEMORY__CTOR_2_OFFSET UNITYSDK_OFFSET(0xBF5FC60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFMEMORY__CTOR_3_OFFSET UNITYSDK_OFFSET(0xBF5FCB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFMEMORY__CTOR_OFFSET UNITYSDK_OFFSET(0xBF5FC20)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceSessionStageResultOfMemory_TypeDefinitionIndex = 76530;
