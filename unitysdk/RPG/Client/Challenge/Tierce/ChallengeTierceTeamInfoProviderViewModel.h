...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_GET_FIRSTAVATAR_OFFSET UNITYSDK_OFFSET(0xBF7A120)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_GET_ISSHOWAVATARTEAMINDEX_OFFSET UNITYSDK_OFFSET(0xBF7B780)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_ISAVATARINTEAM_OFFSET UNITYSDK_OFFSET(0xBF7B5C0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_TRYGETAVATARTEAMINDEX_OFFSET UNITYSDK_OFFSET(0xBF7B670)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_VISITALLAVATARS_OFFSET UNITYSDK_OFFSET(0xBF7AEA0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_VISITAVATARSINTEAM_OFFSET UNITYSDK_OFFSET(0xBF7B3D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF7A130)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamInfoProviderViewModel_TypeDefinitionIndex = 76620;

	class ChallengeTierceTeamInfoProviderViewModel : public ::System::Object
	{
	public:
		::Class_1_DDF2C200AE487775* _AvatarQueryService; // 0x10
		::RPG::AvatarSystem::IAvatar* _FirstAvatar_k__BackingField; // 0x18
