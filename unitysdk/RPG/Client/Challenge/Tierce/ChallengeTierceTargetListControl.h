...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL_GETTARGETCONTROL_OFFSET UNITYSDK_OFFSET(0xBF5EB80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL_GET_TARGETS_OFFSET UNITYSDK_OFFSET(0xBF74770)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL_METHOD_5_65A711E80B8FA950_OFFSET UNITYSDK_OFFSET(0xBF747B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL_SET_TARGETS_OFFSET UNITYSDK_OFFSET(0xBF5DB40)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF748D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL___REFRESH_B__9_0_OFFSET UNITYSDK_OFFSET(0xBF748E0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTargetListControl_TypeDefinitionIndex = 76575;
