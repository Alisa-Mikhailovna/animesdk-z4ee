...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ADD_ONMODIFIEDBUFFIDCHANGED_OFFSET UNITYSDK_OFFSET(0xBF77270)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBF77A10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GETMODIFIEDAVATARBYSLOT_OFFSET UNITYSDK_OFFSET(0xBF77A60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_COUNTOFSLOT_OFFSET UNITYSDK_OFFSET(0xBF77140)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_ISNEEDFORCESAVE_OFFSET UNITYSDK_OFFSET(0xBF76E30)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_MODIFIEDBUFFID_OFFSET UNITYSDK_OFFSET(0xBF771A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_RELATEDSTAGE_OFFSET UNITYSDK_OFFSET(0xBF76E20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ITERATEMODIFIEDAVATARROLEIDS_OFFSET UNITYSDK_OFFSET(0xBF77AE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ITERATEMODIFIEDAVATARS_OFFSET UNITYSDK_OFFSET(0xBF77C30)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_REMOVE_ONMODIFIEDBUFFIDCHANGED_OFFSET UNITYSDK_OFFSET(0xBF772D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_SETMODIFIEDAVATARBYSLOT_OFFSET UNITYSDK_OFFSET(0xBF77D80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_SET_MODIFIEDBUFFID_OFFSET UNITYSDK_OFFSET(0xBF771E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL__CHECKISLINEUPCHANGED_OFFSET UNITYSDK_OFFSET(0xBF76EF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF77330)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditTeamViewModel_TypeDefinitionIndex = 76661;
	...
	public:
		...
		::System::Action* OnModifiedBuffIDChanged; // 0x20
