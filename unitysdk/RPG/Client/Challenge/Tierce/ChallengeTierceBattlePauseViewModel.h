...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GETSTAGERESULT_OFFSET UNITYSDK_OFFSET(0xBF4FD20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0xBF4FAF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_CURRENTSTAGEBUFFID_OFFSET UNITYSDK_OFFSET(0xBF4FB70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_CURRENTSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0xBF4FB50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_GROUPCONFIG_OFFSET UNITYSDK_OFFSET(0xBF4FAD0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_ISPASSED_OFFSET UNITYSDK_OFFSET(0xBF4FB30)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_STAGECOUNT_OFFSET UNITYSDK_OFFSET(0xBF4FBB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_STAGES_OFFSET UNITYSDK_OFFSET(0xBF4FB90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_GET_TARGETS_OFFSET UNITYSDK_OFFSET(0xBF4FB10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0xBF4FB00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_CURRENTSTAGEBUFFID_OFFSET UNITYSDK_OFFSET(0xBF4FB80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_CURRENTSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0xBF4FB60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_GROUPCONFIG_OFFSET UNITYSDK_OFFSET(0xBF4FAE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_ISPASSED_OFFSET UNITYSDK_OFFSET(0xBF4FB40)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_STAGES_OFFSET UNITYSDK_OFFSET(0xBF4FBA0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_SET_TARGETS_OFFSET UNITYSDK_OFFSET(0xBF4FB20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_TRYGETMEMORYCONFIGTOTALROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xBF4FE90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_TRYGETSTORYCONFIGCLEARSCORE_OFFSET UNITYSDK_OFFSET(0xBF4FF50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL_TRYGETSTORYCONFIGFEVERBUFFIDS_OFFSET UNITYSDK_OFFSET(0xBF50010)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBATTLEPAUSEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4FD10)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceBattlePauseViewModel_TypeDefinitionIndex = 76601;
