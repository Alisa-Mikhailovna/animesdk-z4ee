...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETBOSSMONSTERBYSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0xBF61480)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETCOVERBOSSMONSTER_OFFSET UNITYSDK_OFFSET(0xBF61630)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETMONSTERWAVESBYSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0xBF60D30)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETSTAGECOUNT_OFFSET UNITYSDK_OFFSET(0xBF60CE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF60CD0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageMonsterDataProvider_TypeDefinitionIndex = 76611;
