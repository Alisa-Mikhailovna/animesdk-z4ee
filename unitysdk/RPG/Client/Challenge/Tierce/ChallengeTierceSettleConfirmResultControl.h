...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMRESULTCONTROL_METHOD_5_45E10D749EF38FBE_OFFSET UNITYSDK_OFFSET(0xBF601E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMRESULTCONTROL_METHOD_5_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xBF60870)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMRESULTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF608B0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceSettleConfirmResultControl_TypeDefinitionIndex = 76586;
