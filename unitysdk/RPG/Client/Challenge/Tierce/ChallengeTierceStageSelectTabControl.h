...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTTABCONTROL_GET_PRIVATEBTNROOTCHECKED_OFFSET UNITYSDK_OFFSET(0xBF6BB70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTTABCONTROL_GET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xBF6BA20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTTABCONTROL_SET_PRIVATEBTNROOTCHECKED_OFFSET UNITYSDK_OFFSET(0xBF6BBB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTTABCONTROL_SET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xBF6BB00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTTABCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF6C700)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTTABCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF6BC60)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageSelectTabControl_TypeDefinitionIndex = 76595;
