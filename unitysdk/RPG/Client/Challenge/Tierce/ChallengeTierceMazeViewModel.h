...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_ADD_ONHINTENVIRONMENT_OFFSET UNITYSDK_OFFSET(0xBF55CB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_ADD_ONHINTPROGRESS_OFFSET UNITYSDK_OFFSET(0xBF55BF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBF55FD0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_GETENVIRONMENTHINT_OFFSET UNITYSDK_OFFSET(0xBF56260)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_GETLEAVECONFIRMTITLE_OFFSET UNITYSDK_OFFSET(0xBF56030)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xBF55E20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_GET_ISPASSED_OFFSET UNITYSDK_OFFSET(0xBF558F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_GET_JUSTFINISHEDTARGETIDS_OFFSET UNITYSDK_OFFSET(0xBF55E70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBF55D70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_GET_RECORD_OFFSET UNITYSDK_OFFSET(0xBF55B80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_GET_TARGETS_OFFSET UNITYSDK_OFFSET(0xBF55BE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_LEAVE_OFFSET UNITYSDK_OFFSET(0xBF56210)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_REMOVE_ONHINTENVIRONMENT_OFFSET UNITYSDK_OFFSET(0xBF55D10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_REMOVE_ONHINTPROGRESS_OFFSET UNITYSDK_OFFSET(0xBF55C50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL_TRYGETSTORYCONFIGCLEARSCORE_OFFSET UNITYSDK_OFFSET(0xBF56130)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF55EE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL__ONENVIRONMENTHINTMESSAGE_OFFSET UNITYSDK_OFFSET(0xBF562B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMAZEVIEWMODEL__ONPROGRESSHINTMESSAGE_OFFSET UNITYSDK_OFFSET(0xBF56360)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceMazeViewModel_TypeDefinitionIndex = 76627;

	class ChallengeTierceMazeViewModel : public ::System::Object
	{
	public:
		::Class_1_367B452FA4E5EC2C* _Engagement; // 0x10
		::System::Action_1<::RPG::Client::Challenge::IChallengeEnvironmentHintViewModel*>* OnHintEnvironment; // 0x18
		::System::Action_1<::RPG::Client::Challenge::Tierce::ChallengeTierceMazeProgressHintViewModel*>* OnHintProgress; // 0x20
