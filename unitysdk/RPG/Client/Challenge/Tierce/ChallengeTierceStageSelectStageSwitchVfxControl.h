...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTAGESWITCHVFXCONTROL_GET_SELECTEDSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0xBF68140)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTAGESWITCHVFXCONTROL_METHOD_5_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xBF68200)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTAGESWITCHVFXCONTROL_SET_SELECTEDSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0xBF68180)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTAGESWITCHVFXCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF68270)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageSelectStageSwitchVfxControl_TypeDefinitionIndex = 76592;
