...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBADGENOTICECONTROL_METHOD_5_088CB5C8A993BEE6_OFFSET UNITYSDK_OFFSET(0xBF4ED80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBADGENOTICECONTROL_METHOD_5_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xBF4ECE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBADGENOTICECONTROL_METHOD_5_F8D1399F1CCCBB77_OFFSET UNITYSDK_OFFSET(0xBF4ED20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBADGENOTICECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4F270)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceBadgeNoticeControl_TypeDefinitionIndex = 76558;
