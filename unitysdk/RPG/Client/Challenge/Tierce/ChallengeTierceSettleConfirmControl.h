...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xBF5FE90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xBF603D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL_SET_CONTENT_OFFSET UNITYSDK_OFFSET(0xBF5FED0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF60440)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL__REFRESH_OFFSET UNITYSDK_OFFSET(0xBF5FF30)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceSettleConfirmControl_TypeDefinitionIndex = 76584;
