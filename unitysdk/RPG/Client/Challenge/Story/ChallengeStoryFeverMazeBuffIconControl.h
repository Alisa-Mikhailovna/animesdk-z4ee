...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL_GET_FEVERMAZEBUFFID_OFFSET UNITYSDK_OFFSET(0xBF4DE50)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL_SET_FEVERMAZEBUFFID_OFFSET UNITYSDK_OFFSET(0xBF4DE90)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4E1D0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__ENSUREINITIALIZEINTERACTION_OFFSET UNITYSDK_OFFSET(0xBF4DEF0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__REFRESHCONTENT_OFFSET UNITYSDK_OFFSET(0xBF4E0D0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL___ENSUREINITIALIZEINTERACTION_B__10_0_OFFSET UNITYSDK_OFFSET(0xBF4E1E0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL___ENSUREINITIALIZEINTERACTION_B__10_1_OFFSET UNITYSDK_OFFSET(0xBF4E1F0)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryFeverMazeBuffIconControl_TypeDefinitionIndex = 76670;
