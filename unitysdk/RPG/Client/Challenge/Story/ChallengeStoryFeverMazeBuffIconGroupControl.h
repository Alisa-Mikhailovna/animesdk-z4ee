...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_GETFIRSTSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0xBF4E6C0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_GET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0xBF4E200)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0xBF4E760)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_SET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0xBF4E240)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4EAE0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__ENSUREINITIALIZEINTERACTION_OFFSET UNITYSDK_OFFSET(0xBF4E2E0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0xBF4E660)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__REFRESHCHECKSTATE_OFFSET UNITYSDK_OFFSET(0xBF4EA00)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__SHOWPOPUP_OFFSET UNITYSDK_OFFSET(0xBF4E7E0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL___ENSUREINITIALIZEINTERACTION_B__15_0_OFFSET UNITYSDK_OFFSET(0xBF4EB30)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL___ENSUREINITIALIZEINTERACTION_B__15_1_OFFSET UNITYSDK_OFFSET(0xBF4EBB0)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryFeverMazeBuffIconGroupControl_TypeDefinitionIndex = 76671;
