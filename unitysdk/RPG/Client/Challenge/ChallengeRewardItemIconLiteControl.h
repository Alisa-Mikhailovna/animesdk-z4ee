...
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_GET_ONCLICK_OFFSET UNITYSDK_OFFSET(0xBF4C3D0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_GET_REWARDITEM_OFFSET UNITYSDK_OFFSET(0xBF4C060)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_GET_SHOULDSHOWDETAILONCLICK_OFFSET UNITYSDK_OFFSET(0xBF4C3B0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_METHOD_5_6C21C51DA8DA31AC_OFFSET UNITYSDK_OFFSET(0xBF4C430)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_METHOD_5_A4987CAE5B99AEF9_OFFSET UNITYSDK_OFFSET(0xBF4C650)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_METHOD_5_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xBF4C0A0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_METHOD_5_D20F759FC2EC43FB_OFFSET UNITYSDK_OFFSET(0xBF4C710)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_METHOD_5_E2DC32521565C3B5_OFFSET UNITYSDK_OFFSET(0xBF4C5E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_SET_REWARDITEM_OFFSET UNITYSDK_OFFSET(0xBF4BFF0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL_SET_SHOULDSHOWDETAILONCLICK_OFFSET UNITYSDK_OFFSET(0xBF4C3C0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEREWARDITEMICONLITECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4C830)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeRewardItemIconLiteControl_TypeDefinitionIndex = 76459;
