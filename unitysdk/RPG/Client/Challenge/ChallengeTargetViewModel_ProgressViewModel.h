...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_PROGRESSVIEWMODEL_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBF4DDC0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_PROGRESSVIEWMODEL_GET_TOTAL_OFFSET UNITYSDK_OFFSET(0xBF4DDD0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_PROGRESSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4DB90)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetViewModel_ProgressViewModel_TypeDefinitionIndex = 76468;
