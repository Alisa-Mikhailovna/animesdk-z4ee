...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_GETSUCCESSHINTANIMLENGTH_OFFSET UNITYSDK_OFFSET(0xBF4D210)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_GET_PRIVATECOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0xBF4D3E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_GET_PRIVATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xBF4D660)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_GET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xBF4C860)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_PLAYSUCCESSHINTANIM_OFFSET UNITYSDK_OFFSET(0xBF4D260)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_REFRESHCOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0xBF4D4E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_REFRESHNAMEPARAMS_OFFSET UNITYSDK_OFFSET(0xBF4D360)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_REFRESHNAME_OFFSET UNITYSDK_OFFSET(0xBF4D1A0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_SET_PRIVATECOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0xBF4D460)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_SET_PRIVATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xBF4D6E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_SET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xBF4C940)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__CONVERTSTATETOTRIGGERNAME_OFFSET UNITYSDK_OFFSET(0xBF4D540)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4D7C0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF4C9B0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xBF4D730)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__SETTRIGGER_OFFSET UNITYSDK_OFFSET(0xBF4D2B0)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetInfoRowControl_TypeDefinitionIndex = 76460;
