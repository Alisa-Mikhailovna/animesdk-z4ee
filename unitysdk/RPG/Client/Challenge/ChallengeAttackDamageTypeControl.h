...
#define RPG_CLIENT_CHALLENGE_CHALLENGEATTACKDAMAGETYPECONTROL_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xBF49AE0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEATTACKDAMAGETYPECONTROL_METHOD_5_884D1F26F1876C89_OFFSET UNITYSDK_OFFSET(0xBF49B70)
#define RPG_CLIENT_CHALLENGE_CHALLENGEATTACKDAMAGETYPECONTROL_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xBF49B20)
#define RPG_CLIENT_CHALLENGE_CHALLENGEATTACKDAMAGETYPECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF49C00)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeAttackDamageTypeControl_TypeDefinitionIndex = 76450;
