...
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_GET_PREVIOUSSIGNAL_OFFSET UNITYSDK_OFFSET(0xD4F3740)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xD4F3D80)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_1524BBDF654AD3DF_OFFSET UNITYSDK_OFFSET(0xD4F3BF0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_35C4A143193C04DA_OFFSET UNITYSDK_OFFSET(0xD4F3CC0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xD4F3D20)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0xD4F3EA0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_5CA8D2096F7CF3F5_OFFSET UNITYSDK_OFFSET(0xD4F2F80)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_6D723F32667667A4_OFFSET UNITYSDK_OFFSET(0xD4F3760)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0xD4F37F0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_908CDC094010F209_OFFSET UNITYSDK_OFFSET(0xD4F38E0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD4F3E40)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_EBAF10BBA97B82DD_OFFSET UNITYSDK_OFFSET(0xD4F4300)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_SET_PREVIOUSSIGNAL_OFFSET UNITYSDK_OFFSET(0xD4F3750)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0xD4F4730)
