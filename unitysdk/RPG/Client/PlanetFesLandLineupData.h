...
#define RPG_CLIENT_PLANETFESLANDLINEUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD012EF0)
#define RPG_CLIENT_PLANETFESLANDLINEUPDATA_GET_LANDTYPE_OFFSET UNITYSDK_OFFSET(0xD012ED0)
#define RPG_CLIENT_PLANETFESLANDLINEUPDATA_SET_LANDTYPE_OFFSET UNITYSDK_OFFSET(0xD012EE0)
#define RPG_CLIENT_PLANETFESLANDLINEUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD013140)
