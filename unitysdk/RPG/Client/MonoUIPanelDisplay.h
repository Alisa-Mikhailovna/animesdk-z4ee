...
#define RPG_CLIENT_MONOUIPANELDISPLAY_ADDPANEL_OFFSET UNITYSDK_OFFSET(0xCD39EA0)
#define RPG_CLIENT_MONOUIPANELDISPLAY_GETPANELS_OFFSET UNITYSDK_OFFSET(0xCD39F90)
#define RPG_CLIENT_MONOUIPANELDISPLAY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD39FD0)
#define RPG_CLIENT_MONOUIPANELDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3A060)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIPanelDisplay_TypeDefinitionIndex = 69713;
