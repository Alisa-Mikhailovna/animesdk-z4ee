...
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xBA82430)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xBA82510)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_GET_VIEWINDEX_OFFSET UNITYSDK_OFFSET(0xBA824D0)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_SET_TITLE_OFFSET UNITYSDK_OFFSET(0xBA82520)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBA824C0)

namespace RPG::Client::Achievement
{
	inline static constexpr unsigned int AchievementSeriesTitleViewModel_TypeDefinitionIndex = 76695;
