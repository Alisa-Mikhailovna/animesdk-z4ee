...
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GETTARGETDESC_OFFSET UNITYSDK_OFFSET(0xD757730)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GET_CURPROGRESS_OFFSET UNITYSDK_OFFSET(0xD757920)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GET_GUIDEGROUPID_OFFSET UNITYSDK_OFFSET(0xD7578D0)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GET_ISFINISHALL_OFFSET UNITYSDK_OFFSET(0xD757940)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GET_OBJECTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xD757880)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_REFRESH_OFFSET UNITYSDK_OFFSET(0xD7577D0)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_SET_CURPROGRESS_OFFSET UNITYSDK_OFFSET(0xD757930)
#define RPG_CLIENT_TRIALOBJECTIVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD757510)
#define RPG_CLIENT_TRIALOBJECTIVEDATA__INITDATA_OFFSET UNITYSDK_OFFSET(0xD757560)

namespace RPG::Client
{
	inline static constexpr unsigned int TrialObjectiveData_TypeDefinitionIndex = 69088;
