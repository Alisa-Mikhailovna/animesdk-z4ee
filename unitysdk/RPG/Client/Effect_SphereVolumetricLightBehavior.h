...
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0xC347CE0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_GET_CURRENTRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0xC347860)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_GET_KEY_OFFSET UNITYSDK_OFFSET(0xC347CD0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_GET_VOLUMETRICLIGHTMATERIAL_OFFSET UNITYSDK_OFFSET(0xC347850)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xC347B00)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_071850D2764E9D4C_1_OFFSET UNITYSDK_OFFSET(0xC349D10)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0xC349460)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_0EFB186E18464702_OFFSET UNITYSDK_OFFSET(0xC347C30)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC34A8A0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xC34A910)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC34A840)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_8336E89DF737C001_OFFSET UNITYSDK_OFFSET(0xC347870)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC349C60)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xC347B80)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_FD647A48096EB173_OFFSET UNITYSDK_OFFSET(0xC34A440)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xC349BD0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xC34A990)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC34A980)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_SphereVolumetricLightBehavior_TypeDefinitionIndex)->GetStaticField(0x14610);
		}
