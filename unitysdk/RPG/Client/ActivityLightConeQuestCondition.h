...
#define RPG_CLIENT_ACTIVITYLIGHTCONEQUESTCONDITION_GETREWARDID_OFFSET UNITYSDK_OFFSET(0xBBF7880)
#define RPG_CLIENT_ACTIVITYLIGHTCONEQUESTCONDITION_GET_CONDITIONID_OFFSET UNITYSDK_OFFSET(0xBBF75F0)
#define RPG_CLIENT_ACTIVITYLIGHTCONEQUESTCONDITION_GET_ISCLOSE_OFFSET UNITYSDK_OFFSET(0xBBF7820)
#define RPG_CLIENT_ACTIVITYLIGHTCONEQUESTCONDITION_GET_ISFINISHORCLOSE_OFFSET UNITYSDK_OFFSET(0xBBF7700)
#define RPG_CLIENT_ACTIVITYLIGHTCONEQUESTCONDITION_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xBBF77C0)
#define RPG_CLIENT_ACTIVITYLIGHTCONEQUESTCONDITION_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xBBF7600)
#define RPG_CLIENT_ACTIVITYLIGHTCONEQUESTCONDITION_GET__QUESTDATA_OFFSET UNITYSDK_OFFSET(0xBBF7660)
#define RPG_CLIENT_ACTIVITYLIGHTCONEQUESTCONDITION_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0xBBF7920)
#define RPG_CLIENT_ACTIVITYLIGHTCONEQUESTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0xBBF75B0)
