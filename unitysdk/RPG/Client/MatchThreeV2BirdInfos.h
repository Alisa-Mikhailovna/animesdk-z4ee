...
#define RPG_CLIENT_MATCHTHREEV2BIRDINFOS_CREATE_OFFSET UNITYSDK_OFFSET(0xCB6C2A0)
#define RPG_CLIENT_MATCHTHREEV2BIRDINFOS_GETBIRDDATA_OFFSET UNITYSDK_OFFSET(0xCB5ABC0)
#define RPG_CLIENT_MATCHTHREEV2BIRDINFOS_GET_ALLBIRDDATAS_OFFSET UNITYSDK_OFFSET(0xCB6BFB0)
#define RPG_CLIENT_MATCHTHREEV2BIRDINFOS_GET_ALLSHOWBIRDDATALIST_OFFSET UNITYSDK_OFFSET(0xCB6C0A0)
#define RPG_CLIENT_MATCHTHREEV2BIRDINFOS_INIT_OFFSET UNITYSDK_OFFSET(0xCB6C410)
#define RPG_CLIENT_MATCHTHREEV2BIRDINFOS_MARKALLBIRDSEEN_OFFSET UNITYSDK_OFFSET(0xCB6C6E0)
#define RPG_CLIENT_MATCHTHREEV2BIRDINFOS__CTOR_OFFSET UNITYSDK_OFFSET(0xCB6C390)
#define RPG_CLIENT_MATCHTHREEV2BIRDINFOS__INITALLBIRDDATAS_OFFSET UNITYSDK_OFFSET(0xCB6C460)
