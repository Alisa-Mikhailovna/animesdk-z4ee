...
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xBE192F0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID___C__CTOR_OFFSET UNITYSDK_OFFSET(0xBE19330)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID___C___UPDATE_B__3_0_OFFSET UNITYSDK_OFFSET(0xBE19340)

namespace RPG::Client::BAT
{
	inline static constexpr unsigned int BATController_Grid___c_TypeDefinitionIndex = 70262;
	...
	public:
		...
		{
			return (::RPG::Client::BAT::BATController_Grid___c**)Il2CppClass::FromTypeDefinitionIndex(BATController_Grid___c_TypeDefinitionIndex)->GetStaticField(0x52780);
		}
		...
		{
			return (::System::Func_2<::System::Collections::Generic::List_1<::UnityEngine::Matrix4x4>*, ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Matrix4x4>*>**)Il2CppClass::FromTypeDefinitionIndex(BATController_Grid___c_TypeDefinitionIndex)->GetStaticField(0x52788);
		}
