...
#define RPG_CLIENT_BAT_BATCONTROLLER_TEMPLATE_GET_MODE_OFFSET UNITYSDK_OFFSET(0xBE19350)
#define RPG_CLIENT_BAT_BATCONTROLLER_TEMPLATE_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xBE193A0)
#define RPG_CLIENT_BAT_BATCONTROLLER_TEMPLATE_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xBE193E0)
#define RPG_CLIENT_BAT_BATCONTROLLER_TEMPLATE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBE19360)
#define RPG_CLIENT_BAT_BATCONTROLLER_TEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0xBE19420)

namespace RPG::Client::BAT
{
	inline static constexpr unsigned int BATController_Template_TypeDefinitionIndex = 70263;
