...
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_GPUDRIVEN_OFFSET UNITYSDK_OFFSET(0xBE17F20)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_MODE_OFFSET UNITYSDK_OFFSET(0xBE18430)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xBE18740)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_VALIDFORCULLING_OFFSET UNITYSDK_OFFSET(0xBE186C0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0xBE18500)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET__PROTOTYPECOUNT_OFFSET UNITYSDK_OFFSET(0xBE17EC0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_0C44FB644D25C1C2_OFFSET UNITYSDK_OFFSET(0xBE17550)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xBE18050)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_8BC85DADEC2C3862_OFFSET UNITYSDK_OFFSET(0xBE18100)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xBE18480)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xBE184C0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBE18440)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_DA40E2A231DA0583_OFFSET UNITYSDK_OFFSET(0xBE183E0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_SET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xBE18750)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0xBE18770)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xBE18760)

namespace RPG::Client::BAT
{
	inline static constexpr unsigned int BATControllerBase_TypeDefinitionIndex = 70259;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BATControllerBase_TypeDefinitionIndex)->GetStaticField(0xE9E0);
		}
		static ::System::Int32* StaticGet__InstanceDataOffsetShaderProperty()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BATControllerBase_TypeDefinitionIndex)->GetStaticField(0xE9E4);
		}
