...
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_GET_MODE_OFFSET UNITYSDK_OFFSET(0xBE187C0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_GET__GRIDCOUNT_OFFSET UNITYSDK_OFFSET(0xBE18840)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_1B3D8773D1869301_OFFSET UNITYSDK_OFFSET(0xBE18890)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_A2172401030892FD_OFFSET UNITYSDK_OFFSET(0xBE18A50)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBE191B0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID__CTOR_OFFSET UNITYSDK_OFFSET(0xBE19200)

namespace RPG::Client::BAT
{
	inline static constexpr unsigned int BATController_Grid_TypeDefinitionIndex = 70261;
