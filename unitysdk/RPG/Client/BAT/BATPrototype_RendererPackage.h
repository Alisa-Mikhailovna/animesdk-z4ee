...
#define RPG_CLIENT_BAT_BATPROTOTYPE_RENDERERPACKAGE_GET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0xBE19560)
#define RPG_CLIENT_BAT_BATPROTOTYPE_RENDERERPACKAGE_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0xBE19500)
#define RPG_CLIENT_BAT_BATPROTOTYPE_RENDERERPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xBE195E0)

namespace RPG::Client::BAT
{
	inline static constexpr unsigned int BATPrototype_RendererPackage_TypeDefinitionIndex = 70265;
