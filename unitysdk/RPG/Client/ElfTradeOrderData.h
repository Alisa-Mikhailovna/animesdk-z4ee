...
#define RPG_CLIENT_ELFTRADEORDERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC3C1800)
#define RPG_CLIENT_ELFTRADEORDERDATA_GETCOSTPRODUCTIDS_OFFSET UNITYSDK_OFFSET(0xC3C31D0)
#define RPG_CLIENT_ELFTRADEORDERDATA_GETREWARDPRODUCTIDS_OFFSET UNITYSDK_OFFSET(0xC3C3310)
#define RPG_CLIENT_ELFTRADEORDERDATA_GET_COSTS_OFFSET UNITYSDK_OFFSET(0xC3C37D0)
#define RPG_CLIENT_ELFTRADEORDERDATA_GET_CUSTOMERIMGPATH_OFFSET UNITYSDK_OFFSET(0xC3C38D0)
#define RPG_CLIENT_ELFTRADEORDERDATA_GET_DAYSREMAIN_OFFSET UNITYSDK_OFFSET(0xC3C37B0)
#define RPG_CLIENT_ELFTRADEORDERDATA_GET_HASSHOPONLYPRODUCT_OFFSET UNITYSDK_OFFSET(0xC3C22E0)
#define RPG_CLIENT_ELFTRADEORDERDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC3C3790)
#define RPG_CLIENT_ELFTRADEORDERDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC3C3810)
#define RPG_CLIENT_ELFTRADEORDERDATA_GET_REWARDS_OFFSET UNITYSDK_OFFSET(0xC3C37F0)
#define RPG_CLIENT_ELFTRADEORDERDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC3C3170)
#define RPG_CLIENT_ELFTRADEORDERDATA_ISSTRICTLYBENEFICIALTOCURRENTTARGET_OFFSET UNITYSDK_OFFSET(0xC3C3450)
#define RPG_CLIENT_ELFTRADEORDERDATA_SET_COSTS_OFFSET UNITYSDK_OFFSET(0xC3C37E0)
#define RPG_CLIENT_ELFTRADEORDERDATA_SET_DAYSREMAIN_OFFSET UNITYSDK_OFFSET(0xC3C37C0)
#define RPG_CLIENT_ELFTRADEORDERDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xC3C37A0)
#define RPG_CLIENT_ELFTRADEORDERDATA_SET_REWARDS_OFFSET UNITYSDK_OFFSET(0xC3C3800)
#define RPG_CLIENT_ELFTRADEORDERDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xC3C17B0)
#define RPG_CLIENT_ELFTRADEORDERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C3160)
