...
#define RPG_CLIENT_SPACEZOOCATDATA_CREATEDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xD51EFD0)
#define RPG_CLIENT_SPACEZOOCATDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD51ECC0)
#define RPG_CLIENT_SPACEZOOCATDATA_GETBREEDDISPLAYIMAGES_OFFSET UNITYSDK_OFFSET(0xD51FE30)
#define RPG_CLIENT_SPACEZOOCATDATA_GETCATNAME_OFFSET UNITYSDK_OFFSET(0xD5201E0)
#define RPG_CLIENT_SPACEZOOCATDATA_GETDEFAULTFEATUREID_OFFSET UNITYSDK_OFFSET(0xD520160)
#define RPG_CLIENT_SPACEZOOCATDATA_GETEXPCHANGECACHE_OFFSET UNITYSDK_OFFSET(0xD520650)
#define RPG_CLIENT_SPACEZOOCATDATA_GETFEATUREID_OFFSET UNITYSDK_OFFSET(0xD51FD00)
#define RPG_CLIENT_SPACEZOOCATDATA_GETFEATUREIMAGEPATHS_OFFSET UNITYSDK_OFFSET(0xD51FDB0)
#define RPG_CLIENT_SPACEZOOCATDATA_GETFEATURELARGEIMAGEPATHS_OFFSET UNITYSDK_OFFSET(0xD51FDF0)
#define RPG_CLIENT_SPACEZOOCATDATA_GETFEATUREROW_OFFSET UNITYSDK_OFFSET(0xD520020)
#define RPG_CLIENT_SPACEZOOCATDATA_GETTOTALEXPCHANGE_OFFSET UNITYSDK_OFFSET(0xD520730)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_CANDELETE_OFFSET UNITYSDK_OFFSET(0xD520BA0)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_EXPCACHE_OFFSET UNITYSDK_OFFSET(0xD520B40)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_EXPCHANGECACHE_OFFSET UNITYSDK_OFFSET(0xD520B20)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_FEATURES_OFFSET UNITYSDK_OFFSET(0xD520B00)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_HAVEMUTATEEVENT_OFFSET UNITYSDK_OFFSET(0xD520D30)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_HAVESPECIALMUTATEEVENT_OFFSET UNITYSDK_OFFSET(0xD520D90)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0xD520C40)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xD51FCB0)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_ISTEMPLATE_OFFSET UNITYSDK_OFFSET(0xD520BF0)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_MUTATEITEMS_OFFSET UNITYSDK_OFFSET(0xD520D10)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xD520B80)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_SPECIALCATID_OFFSET UNITYSDK_OFFSET(0xD520A80)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_SPECIALCATROW_OFFSET UNITYSDK_OFFSET(0xD520480)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_TEMPLATEID_OFFSET UNITYSDK_OFFSET(0xD520A60)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_TEMPLATEROW_OFFSET UNITYSDK_OFFSET(0xD520AA0)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xD520B60)
#define RPG_CLIENT_SPACEZOOCATDATA_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xD520A40)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_EXPCACHE_OFFSET UNITYSDK_OFFSET(0xD520B50)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_EXPCHANGECACHE_OFFSET UNITYSDK_OFFSET(0xD520B30)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_FEATURES_OFFSET UNITYSDK_OFFSET(0xD520B10)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_HAVESPECIALMUTATEEVENT_OFFSET UNITYSDK_OFFSET(0xD520DA0)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_MUTATEITEMS_OFFSET UNITYSDK_OFFSET(0xD520D20)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_RARITY_OFFSET UNITYSDK_OFFSET(0xD520B90)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_SPECIALCATID_OFFSET UNITYSDK_OFFSET(0xD520A90)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_TEMPLATEID_OFFSET UNITYSDK_OFFSET(0xD520A70)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xD520B70)
#define RPG_CLIENT_SPACEZOOCATDATA_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xD520A50)
#define RPG_CLIENT_SPACEZOOCATDATA_SYNCFEATURES_OFFSET UNITYSDK_OFFSET(0xD51F050)
#define RPG_CLIENT_SPACEZOOCATDATA_SYNCSPACEZOODATA_OFFSET UNITYSDK_OFFSET(0xD51EEF0)
#define RPG_CLIENT_SPACEZOOCATDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xD520DB0)
#define RPG_CLIENT_SPACEZOOCATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD51ED30)
#define RPG_CLIENT_SPACEZOOCATDATA__GETNAMECONTENTBYFEATURETYPE_OFFSET UNITYSDK_OFFSET(0xD5204E0)
#define RPG_CLIENT_SPACEZOOCATDATA__ISVERYRARITYCAT_OFFSET UNITYSDK_OFFSET(0xD520910)
#define RPG_CLIENT_SPACEZOOCATDATA__REFRESHCATRARITY_OFFSET UNITYSDK_OFFSET(0xD51F840)
#define RPG_CLIENT_SPACEZOOCATDATA__REFRESHCATTYPE_OFFSET UNITYSDK_OFFSET(0xD51F7D0)
#define RPG_CLIENT_SPACEZOOCATDATA__SYNCMUTATEITEMS_OFFSET UNITYSDK_OFFSET(0xD51F8E0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::GameCore::SpaceZooChannelType>**)Il2CppClass::FromTypeDefinitionIndex(SpaceZooCatData_TypeDefinitionIndex)->GetStaticField(0x33400);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet__SpecialNameOrderLanguageList()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SpaceZooCatData_TypeDefinitionIndex)->GetStaticField(0x33408);
		}
		...
		::System::UInt32 _EXPCache_k__BackingField; // 0x44
		::System::UInt32 _SpecialCatID_k__BackingField; // 0x48
		::RPG::GameCore::ItemRarity _Rarity_k__BackingField; // 0x4C
		::System::Boolean _HaveSpecialMutateEvent_k__BackingField; // 0x50
