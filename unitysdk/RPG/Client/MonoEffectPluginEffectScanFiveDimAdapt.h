...
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCANFIVEDIMADAPT_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCBA430)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCANFIVEDIMADAPT_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCBA270)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCANFIVEDIMADAPT_TICK_OFFSET UNITYSDK_OFFSET(0xCCBA390)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCANFIVEDIMADAPT__CTOR_OFFSET UNITYSDK_OFFSET(0xCCBA480)
