...
#define RPG_CLIENT_TREASUREDUNGEONEXITPARAM_SYNC_OFFSET UNITYSDK_OFFSET(0xD74A230)
#define RPG_CLIENT_TREASUREDUNGEONEXITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD74B440)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 TotalEnemyKilled; // 0x18
		::System::UInt32 TotalTrialAvatarFound; // 0x1C
		::System::UInt32 DefenceAdd; // 0x20
		::System::UInt32 GroupID; // 0x24
		::RPG::Client::TextID AttackExName; // 0x28
		::System::UInt32 AttackExAdd; // 0x38
		::System::Boolean IsFinish; // 0x3C
		::System::Boolean IsAllDead; // 0x3D
		::System::Boolean IsWin; // 0x3E
		::System::UInt32 TotalUltraItemFound; // 0x40
		::System::UInt32 TotalAttackItemFound; // 0x44
		::System::UInt32 AttackAdd; // 0x48
