...
#define RPG_CLIENT_ENTITYGAMEOBJECTCONNECTION_ADDLIFECIRCLECALLBACK_OFFSET UNITYSDK_OFFSET(0xC3D13C0)
#define RPG_CLIENT_ENTITYGAMEOBJECTCONNECTION_GETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0xC3CF8C0)
#define RPG_CLIENT_ENTITYGAMEOBJECTCONNECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC3D15F0)
#define RPG_CLIENT_ENTITYGAMEOBJECTCONNECTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC3D1590)
#define RPG_CLIENT_ENTITYGAMEOBJECTCONNECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC3D1530)
#define RPG_CLIENT_ENTITYGAMEOBJECTCONNECTION_REMOVELIFECIRCLECALLBACK_OFFSET UNITYSDK_OFFSET(0xC3D1480)
#define RPG_CLIENT_ENTITYGAMEOBJECTCONNECTION_SETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0xC3D1370)
#define RPG_CLIENT_ENTITYGAMEOBJECTCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC3D1640)
