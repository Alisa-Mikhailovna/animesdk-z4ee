...
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDTITLEROW_CREATE_OFFSET UNITYSDK_OFFSET(0xD470150)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDTITLEROW_GET_COLORSTATE_OFFSET UNITYSDK_OFFSET(0xD470130)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDTITLEROW_GET_ROWTYPE_OFFSET UNITYSDK_OFFSET(0xD4700C0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDTITLEROW_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xD470110)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDTITLEROW_SET_COLORSTATE_OFFSET UNITYSDK_OFFSET(0xD470140)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDTITLEROW_SET_TITLE_OFFSET UNITYSDK_OFFSET(0xD470120)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDTITLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4701E0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaLegendTitleRow_TypeDefinitionIndex = 69588;
