...
#define RPG_CLIENT_ANIMSTATEDEBUGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xBD89CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimStateDebugItem_TypeDefinitionIndex = 69431;
