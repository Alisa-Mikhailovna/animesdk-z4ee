...
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM_GET_SERVERTYPE_OFFSET UNITYSDK_OFFSET(0xD4E7F70)
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xD4E7D30)
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM_SET_SERVERTYPE_OFFSET UNITYSDK_OFFSET(0xD4E7F80)
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xD4E7D70)
#define RPG_CLIENT_SERVERPLAYERSETTINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD4E7D20)
