...
#define RPG_CLIENT_UIANIMATIONUTILS_CURRENTPLAYINGNAME_OFFSET UNITYSDK_OFFSET(0xD79E910)
#define RPG_CLIENT_UIANIMATIONUTILS_GETANIMATIONLENGTH_OFFSET UNITYSDK_OFFSET(0xD79EE80)
#define RPG_CLIENT_UIANIMATIONUTILS_GETANIMATIONPLAYINGNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0xD79EF80)
#define RPG_CLIENT_UIANIMATIONUTILS_GETANIMATIONPLAYINGTIME_OFFSET UNITYSDK_OFFSET(0xD79EFF0)
#define RPG_CLIENT_UIANIMATIONUTILS_GETANIMATIONSTATE_OFFSET UNITYSDK_OFFSET(0xD79E540)
#define RPG_CLIENT_UIANIMATIONUTILS_GETCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0xD79EDF0)
#define RPG_CLIENT_UIANIMATIONUTILS_PLAYFROMBEGIN_OFFSET UNITYSDK_OFFSET(0xD79E5A0)
#define RPG_CLIENT_UIANIMATIONUTILS_PLAYFROMEND_OFFSET UNITYSDK_OFFSET(0xD79E7D0)
#define RPG_CLIENT_UIANIMATIONUTILS_PLAYFROMTIME_OFFSET UNITYSDK_OFFSET(0xD79E860)
#define RPG_CLIENT_UIANIMATIONUTILS_PLAYTOBEGIN_OFFSET UNITYSDK_OFFSET(0xD79E680)
#define RPG_CLIENT_UIANIMATIONUTILS_PLAYTOEND_OFFSET UNITYSDK_OFFSET(0xD79E720)
#define RPG_CLIENT_UIANIMATIONUTILS_SETANIMATIONSPEED_OFFSET UNITYSDK_OFFSET(0xD79EEF0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAnimationUtils_TypeDefinitionIndex = 69814;
