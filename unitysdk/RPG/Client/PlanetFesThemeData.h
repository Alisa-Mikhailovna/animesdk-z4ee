...
#define RPG_CLIENT_PLANETFESTHEMEDATA_GETPIECELISTCANUNLOCKCARDCOUNT_OFFSET UNITYSDK_OFFSET(0xD087010)
#define RPG_CLIENT_PLANETFESTHEMEDATA_GETSORTEDCARDLIST_OFFSET UNITYSDK_OFFSET(0xD086AF0)
#define RPG_CLIENT_PLANETFESTHEMEDATA_GETUNLOCKBUFFLIST_OFFSET UNITYSDK_OFFSET(0xD086D00)
#define RPG_CLIENT_PLANETFESTHEMEDATA_GET_CARDLIST_OFFSET UNITYSDK_OFFSET(0xD086CB0)
#define RPG_CLIENT_PLANETFESTHEMEDATA_GET_CURRENTCOLLECTCOUNT_OFFSET UNITYSDK_OFFSET(0xD079C70)
#define RPG_CLIENT_PLANETFESTHEMEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD0875B0)
#define RPG_CLIENT_PLANETFESTHEMEDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xD087470)
#define RPG_CLIENT_PLANETFESTHEMEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD087540)
#define RPG_CLIENT_PLANETFESTHEMEDATA_GET_THEMEID_OFFSET UNITYSDK_OFFSET(0xD087600)
#define RPG_CLIENT_PLANETFESTHEMEDATA_GET_TOTALCOLLECTCOUNT_OFFSET UNITYSDK_OFFSET(0xD087410)
#define RPG_CLIENT_PLANETFESTHEMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD086AB0)
#define RPG_CLIENT_PLANETFESTHEMEDATA__GETCURRENTCOLLECTCOUNT_OFFSET UNITYSDK_OFFSET(0xD0871F0)
