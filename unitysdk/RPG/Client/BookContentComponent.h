...
#define RPG_CLIENT_BOOKCONTENTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xBEBD1D0)

namespace RPG::Client
{
	inline static constexpr unsigned int BookContentComponent_TypeDefinitionIndex = 69236;
