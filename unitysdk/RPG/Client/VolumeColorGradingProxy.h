...
#define RPG_CLIENT_VOLUMECOLORGRADINGPROXY_ENABLECOLORGRADING_OFFSET UNITYSDK_OFFSET(0xD8A02F0)
#define RPG_CLIENT_VOLUMECOLORGRADINGPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xD8A0100)
#define RPG_CLIENT_VOLUMECOLORGRADINGPROXY_RELEASE_OFFSET UNITYSDK_OFFSET(0xD8A0220)
#define RPG_CLIENT_VOLUMECOLORGRADINGPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xD8A0190)
#define RPG_CLIENT_VOLUMECOLORGRADINGPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xD8A0340)

namespace RPG::Client
{
	inline static constexpr unsigned int VolumeColorGradingProxy_TypeDefinitionIndex = 69681;
