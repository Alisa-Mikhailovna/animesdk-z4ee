...
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xD896CE0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xD8968D0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_19171609D4441C30_OFFSET UNITYSDK_OFFSET(0xD899400)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xD89A7A0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD896A30)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xD896910)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xD896970)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xD8969D0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xD896A70)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD8965E0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0xD898570)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_693C4912BF61F072_OFFSET UNITYSDK_OFFSET(0xD898630)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_7C2CABA4CB548A03_OFFSET UNITYSDK_OFFSET(0xD899860)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_843619D883256BB2_OFFSET UNITYSDK_OFFSET(0xD896AD0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0xD8966E0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD896640)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_BED9888991D99A89_OFFSET UNITYSDK_OFFSET(0xD899910)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_E34EC5C56715D759_OFFSET UNITYSDK_OFFSET(0xD899E20)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_E80720BBCF7832DF_OFFSET UNITYSDK_OFFSET(0xD898D20)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xD89A8F0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD89A8E0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x54320);
		}
		static ::Class_1_0A24888DF04C995E_3** StaticGet_VCRect1()
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x54328);
		}
		static ::Class_1_0A24888DF04C995E_3** StaticGet_VCRect3()
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x54330);
		}
		static ::Class_1_0A24888DF04C995E_3** StaticGet_VCRect0()
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x54338);
		}
