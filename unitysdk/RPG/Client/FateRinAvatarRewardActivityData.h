...
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_GETENTRY_OFFSET UNITYSDK_OFFSET(0xC5AE020)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_GETFATERINSUPPORTMODULE_OFFSET UNITYSDK_OFFSET(0xC5ADF90)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_HASPENDINGREWARD_OFFSET UNITYSDK_OFFSET(0xC5ADDF0)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_ISFINISHCONDITIONSCOMPLETED_OFFSET UNITYSDK_OFFSET(0xC5ADD80)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xC5AE0C0)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xC5AE110)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC5ADD70)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA__ISFEATURECLOSED_OFFSET UNITYSDK_OFFSET(0xC5ADEC0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(FateRinAvatarRewardActivityData_TypeDefinitionIndex)->GetStaticField(0x4960);
		}
