...
#define RPG_CLIENT_GRIDFIGHTTASKCONFIG_GET_LEVELGRAPHPATH_OFFSET UNITYSDK_OFFSET(0xC816650)
#define RPG_CLIENT_GRIDFIGHTTASKCONFIG_GET_TASKID_OFFSET UNITYSDK_OFFSET(0xC816640)
#define RPG_CLIENT_GRIDFIGHTTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC8165F0)
