...
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_GETFUNCID_OFFSET UNITYSDK_OFFSET(0xD4A94C0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0xD4A9470)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_GET_LEVELUPSCEPTERITEMLIST_OFFSET UNITYSDK_OFFSET(0xD4A92B0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0xD4A9500)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_REFRESH_OFFSET UNITYSDK_OFFSET(0xD4A91A0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD4A8FA0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER__GENERATELEVELUPINFODATA_OFFSET UNITYSDK_OFFSET(0xD4A8FB0)
