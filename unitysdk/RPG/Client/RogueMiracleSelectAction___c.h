...
#define RPG_CLIENT_ROGUEMIRACLESELECTACTION___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xD3DBE90)
#define RPG_CLIENT_ROGUEMIRACLESELECTACTION___C__CTOR_OFFSET UNITYSDK_OFFSET(0xD3DBEC0)
#define RPG_CLIENT_ROGUEMIRACLESELECTACTION___C___REPORTSELECTMIRACLE_B__30_0_OFFSET UNITYSDK_OFFSET(0xD3DBED0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::RogueTournMiracleData*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(RogueMiracleSelectAction___c_TypeDefinitionIndex)->GetStaticField(0x266B0);
		}
		static ::RPG::Client::RogueMiracleSelectAction___c** StaticGet___9()
		{
			return (::RPG::Client::RogueMiracleSelectAction___c**)Il2CppClass::FromTypeDefinitionIndex(RogueMiracleSelectAction___c_TypeDefinitionIndex)->GetStaticField(0x266B8);
		}
