...
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC96E0)
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC9820)
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL_GET_ENABLE_OFFSET UNITYSDK_OFFSET(0xCCC9670)
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0xCCC9680)
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL_GET_SOFTNESS_OFFSET UNITYSDK_OFFSET(0xCCC9690)
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL_GET_TARGETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCCC9660)
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xCCC96A0)
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC97D0)
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL_SETREVEALPROPERTIES_OFFSET UNITYSDK_OFFSET(0xCCC98B0)
#define RPG_CLIENT_MONOEFFECTPLUGINTARGETCENTRICREVEAL__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC9960)
