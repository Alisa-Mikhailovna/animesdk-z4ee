...
#define RPG_CLIENT_UIDRAGINPUTBYTRANSFORM_ATTACH_OFFSET UNITYSDK_OFFSET(0xD7B7590)
#define RPG_CLIENT_UIDRAGINPUTBYTRANSFORM_CREATE_OFFSET UNITYSDK_OFFSET(0xD7B72E0)
#define RPG_CLIENT_UIDRAGINPUTBYTRANSFORM_DETACH_OFFSET UNITYSDK_OFFSET(0xD7B76D0)
#define RPG_CLIENT_UIDRAGINPUTBYTRANSFORM_RPG_CLIENT_IUIDRAGINPUT_GETPOSITION_OFFSET UNITYSDK_OFFSET(0xD7B7760)
#define RPG_CLIENT_UIDRAGINPUTBYTRANSFORM_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0xD7B7540)
#define RPG_CLIENT_UIDRAGINPUTBYTRANSFORM_UPDATETRANSFORM_OFFSET UNITYSDK_OFFSET(0xD7B7350)
#define RPG_CLIENT_UIDRAGINPUTBYTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xD7B72D0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIDragInputByTransform_TypeDefinitionIndex = 69718;
