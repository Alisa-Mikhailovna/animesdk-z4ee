...
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GETSTATEDATABYSTATENAME_OFFSET UNITYSDK_OFFSET(0xD80B800)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_ASSETLOADER_OFFSET UNITYSDK_OFFSET(0xD80B8D0)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_STATEDATAS_OFFSET UNITYSDK_OFFSET(0xD80B8B0)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_PLAYASSUBSTATE_OFFSET UNITYSDK_OFFSET(0xD80B6E0)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_TRYUPDATESTATUSOFCURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xD80B860)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD80B670)
