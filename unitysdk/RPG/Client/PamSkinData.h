...
#define RPG_CLIENT_PAMSKINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCF26A20)
#define RPG_CLIENT_PAMSKINDATA_GET_CONFIGENTITYPATH_OFFSET UNITYSDK_OFFSET(0xCF26C20)
#define RPG_CLIENT_PAMSKINDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xCF26AE0)
#define RPG_CLIENT_PAMSKINDATA_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0xCF26CC0)
#define RPG_CLIENT_PAMSKINDATA_GET_MANIKINPREFABPATH_OFFSET UNITYSDK_OFFSET(0xCF26D60)
#define RPG_CLIENT_PAMSKINDATA_GET_SKINICON_OFFSET UNITYSDK_OFFSET(0xCF26B20)
#define RPG_CLIENT_PAMSKINDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCF26BC0)
#define RPG_CLIENT_PAMSKINDATA_SETUNLOCK_OFFSET UNITYSDK_OFFSET(0xCF26A90)
#define RPG_CLIENT_PAMSKINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCF26A80)
