...
#define RPG_CLIENT_SEALPOOLMANAGER_CLEARALLSEALS_OFFSET UNITYSDK_OFFSET(0xD4E0110)
#define RPG_CLIENT_SEALPOOLMANAGER_METHOD_5_1FD1221B75305432_OFFSET UNITYSDK_OFFSET(0xD4DFB40)
#define RPG_CLIENT_SEALPOOLMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD4E0A10)
#define RPG_CLIENT_SEALPOOLMANAGER_START_OFFSET UNITYSDK_OFFSET(0xD4DF9D0)
#define RPG_CLIENT_SEALPOOLMANAGER_TRYADDSEAL_OFFSET UNITYSDK_OFFSET(0xD4DFE00)
#define RPG_CLIENT_SEALPOOLMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD4E0260)
#define RPG_CLIENT_SEALPOOLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD4E0C20)
