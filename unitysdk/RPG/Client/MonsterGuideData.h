...
#define RPG_CLIENT_MONSTERGUIDEDATA_GETAVAILABLETAGLIST_OFFSET UNITYSDK_OFFSET(0xCD7A7C0)
#define RPG_CLIENT_MONSTERGUIDEDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xCD7A300)
#define RPG_CLIENT_MONSTERGUIDEDATA_GET_PHASELIST_OFFSET UNITYSDK_OFFSET(0xCD7A340)
#define RPG_CLIENT_MONSTERGUIDEDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xCD7A360)
#define RPG_CLIENT_MONSTERGUIDEDATA_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0xCD7A320)
#define RPG_CLIENT_MONSTERGUIDEDATA_INITPHASEDATA_OFFSET UNITYSDK_OFFSET(0xCD7A5D0)
#define RPG_CLIENT_MONSTERGUIDEDATA_INITTAGDATA_OFFSET UNITYSDK_OFFSET(0xCD7A3E0)
#define RPG_CLIENT_MONSTERGUIDEDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xCD7A310)
#define RPG_CLIENT_MONSTERGUIDEDATA_SET_PHASELIST_OFFSET UNITYSDK_OFFSET(0xCD7A350)
#define RPG_CLIENT_MONSTERGUIDEDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xCD7A370)
#define RPG_CLIENT_MONSTERGUIDEDATA_SET_TAGLIST_OFFSET UNITYSDK_OFFSET(0xCD7A330)
#define RPG_CLIENT_MONSTERGUIDEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD7A380)
