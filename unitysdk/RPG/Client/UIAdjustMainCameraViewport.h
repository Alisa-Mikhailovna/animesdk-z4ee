...
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT_METHOD_5_9AFCA18B112F248A_OFFSET UNITYSDK_OFFSET(0xD78AC30)
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD78ABC0)
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD78A640)
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT_REFRESHADJUSTMENT_OFFSET UNITYSDK_OFFSET(0xD78A710)
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT__CTOR_OFFSET UNITYSDK_OFFSET(0xD78AC80)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdjustMainCameraViewport_TypeDefinitionIndex = 69683;
