...
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GETDICECONTENTINFOS_OFFSET UNITYSDK_OFFSET(0xC295EB0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_CONDITIONDESC_OFFSET UNITYSDK_OFFSET(0xC296430)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_CONDITIONPARAMLIST_OFFSET UNITYSDK_OFFSET(0xC2964F0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_DICEBGPATH_OFFSET UNITYSDK_OFFSET(0xC296540)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_DICEFIGURESICONPATH_OFFSET UNITYSDK_OFFSET(0xC296750)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_DICEICONPATH_OFFSET UNITYSDK_OFFSET(0xC2965D0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_HASSKILLCONTENT_OFFSET UNITYSDK_OFFSET(0xC2960F0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC296050)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_ISCOLLECTION_OFFSET UNITYSDK_OFFSET(0xC2960A0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC296370)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xC2963E0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC2964A0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC295E70)
