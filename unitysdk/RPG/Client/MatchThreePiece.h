...
#define RPG_CLIENT_MATCHTHREEPIECE_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCB5DBA0)
#define RPG_CLIENT_MATCHTHREEPIECE_GET_PIECEDATA_OFFSET UNITYSDK_OFFSET(0xCB5B3A0)
#define RPG_CLIENT_MATCHTHREEPIECE_GET_POSINDEX_OFFSET UNITYSDK_OFFSET(0xCB5B1F0)
#define RPG_CLIENT_MATCHTHREEPIECE_INIT_OFFSET UNITYSDK_OFFSET(0xCB5B3C0)
#define RPG_CLIENT_MATCHTHREEPIECE_MATCHED_OFFSET UNITYSDK_OFFSET(0xCB5D330)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0xCB5D9C0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_1F3248035B8C5AF5_OFFSET UNITYSDK_OFFSET(0xCB5BCB0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xCB5B980)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xCB5D530)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCB5E550)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_4805283D59625FD9_OFFSET UNITYSDK_OFFSET(0xCB5BE50)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_4EF01F55C8320404_OFFSET UNITYSDK_OFFSET(0xCB5C4E0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_558C6AE12602A241_OFFSET UNITYSDK_OFFSET(0xCB5E4C0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_570C5557A774C69E_OFFSET UNITYSDK_OFFSET(0xCB5E420)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_592FC68A42F19409_1_OFFSET UNITYSDK_OFFSET(0xCB5CCA0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_592FC68A42F19409_OFFSET UNITYSDK_OFFSET(0xCB5D040)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_682FA2F0C959D8A1_OFFSET UNITYSDK_OFFSET(0xCB5D790)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_705AF43C01ED360A_OFFSET UNITYSDK_OFFSET(0xCB5D6E0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCB5C230)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_9FBCB7EE3738DEA4_OFFSET UNITYSDK_OFFSET(0xCB5CF90)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_A3AECC7AAA326A11_OFFSET UNITYSDK_OFFSET(0xCB5CC40)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_BCB087DFB7399B96_OFFSET UNITYSDK_OFFSET(0xCB5C2B0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_F1C2C3722C7B5E2C_OFFSET UNITYSDK_OFFSET(0xCB5E3C0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0xCB5E5A0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xCB5CBF0)
#define RPG_CLIENT_MATCHTHREEPIECE_MOVEIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xCB5C410)
#define RPG_CLIENT_MATCHTHREEPIECE_MOVEPATH_OFFSET UNITYSDK_OFFSET(0xCB5C540)
#define RPG_CLIENT_MATCHTHREEPIECE_ONCREATE_OFFSET UNITYSDK_OFFSET(0xCB5DE00)
#define RPG_CLIENT_MATCHTHREEPIECE_ONDRAG_OFFSET UNITYSDK_OFFSET(0xCB5DF80)
#define RPG_CLIENT_MATCHTHREEPIECE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xCB5DFE0)
#define RPG_CLIENT_MATCHTHREEPIECE_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xCB5E0A0)
#define RPG_CLIENT_MATCHTHREEPIECE_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0xCB5E160)
#define RPG_CLIENT_MATCHTHREEPIECE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xCB5E040)
#define RPG_CLIENT_MATCHTHREEPIECE_PLAYBOMBLOOPANIM_OFFSET UNITYSDK_OFFSET(0xCB5C3C0)
#define RPG_CLIENT_MATCHTHREEPIECE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0xCB5C180)
#define RPG_CLIENT_MATCHTHREEPIECE_SETBOARD_OFFSET UNITYSDK_OFFSET(0xCB5B7C0)
#define RPG_CLIENT_MATCHTHREEPIECE_SETHOVERED_OFFSET UNITYSDK_OFFSET(0xCB5B8F0)
#define RPG_CLIENT_MATCHTHREEPIECE_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xCB5B890)
#define RPG_CLIENT_MATCHTHREEPIECE_SETSELECTED_OFFSET UNITYSDK_OFFSET(0xCB5BAB0)
#define RPG_CLIENT_MATCHTHREEPIECE_SETSIZE_OFFSET UNITYSDK_OFFSET(0xCB5B810)
#define RPG_CLIENT_MATCHTHREEPIECE_SETUPPIECEDATA_OFFSET UNITYSDK_OFFSET(0xCB5C130)
#define RPG_CLIENT_MATCHTHREEPIECE_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xCB5BB70)
#define RPG_CLIENT_MATCHTHREEPIECE_SET_PIECEDATA_OFFSET UNITYSDK_OFFSET(0xCB5B3B0)
#define RPG_CLIENT_MATCHTHREEPIECE_SET_POSINDEX_OFFSET UNITYSDK_OFFSET(0xCB5B230)
#define RPG_CLIENT_MATCHTHREEPIECE_SHAKE_OFFSET UNITYSDK_OFFSET(0xCB5D890)
#define RPG_CLIENT_MATCHTHREEPIECE_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCB5DA30)
#define RPG_CLIENT_MATCHTHREEPIECE_STOPSHAKE_OFFSET UNITYSDK_OFFSET(0xCB5D910)
#define RPG_CLIENT_MATCHTHREEPIECE_SWITCHTO_OFFSET UNITYSDK_OFFSET(0xCB5E220)
#define RPG_CLIENT_MATCHTHREEPIECE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB5E5F0)
