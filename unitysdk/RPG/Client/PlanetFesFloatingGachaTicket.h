...
#define RPG_CLIENT_PLANETFESFLOATINGGACHATICKET_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD00D680)
#define RPG_CLIENT_PLANETFESFLOATINGGACHATICKET_ONCREATE_OFFSET UNITYSDK_OFFSET(0xD00D6C0)
#define RPG_CLIENT_PLANETFESFLOATINGGACHATICKET_PLAY_OFFSET UNITYSDK_OFFSET(0xD00D7B0)
#define RPG_CLIENT_PLANETFESFLOATINGGACHATICKET_SETNUMBER_OFFSET UNITYSDK_OFFSET(0xD00D750)
#define RPG_CLIENT_PLANETFESFLOATINGGACHATICKET_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD00D640)
#define RPG_CLIENT_PLANETFESFLOATINGGACHATICKET__CTOR_OFFSET UNITYSDK_OFFSET(0xD00D8A0)
