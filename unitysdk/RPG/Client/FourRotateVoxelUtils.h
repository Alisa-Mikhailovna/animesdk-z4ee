...
#define RPG_CLIENT_FOURROTATEVOXELUTILS_EVALUATEID_OFFSET UNITYSDK_OFFSET(0xC626330)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETFOURROTATEENTITYBYENTITYID_OFFSET UNITYSDK_OFFSET(0xC626730)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETFOURROTATEVOXELLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0xC6269B0)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETFOURROTATEVOXELLEVELUNITLENGTH_OFFSET UNITYSDK_OFFSET(0xC626CE0)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0xC626400)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETPLAYERGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xC626D50)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_ISFOURROTATEVOXELCONTAINER_OFFSET UNITYSDK_OFFSET(0xC626C40)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_TRYGETCONTAINERENTITY_OFFSET UNITYSDK_OFFSET(0xC626880)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_TRYGETENTITYWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xC626AD0)
