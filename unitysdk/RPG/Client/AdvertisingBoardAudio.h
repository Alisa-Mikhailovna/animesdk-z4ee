...
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0xBCE30B0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_33ACA6CB2ABC73F7_1_OFFSET UNITYSDK_OFFSET(0xBCE2E20)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xBCE2CD0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xBCE3020)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xBCE2F70)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_MUTEAUDIO_OFFSET UNITYSDK_OFFSET(0xBCE2B60)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBCE2F20)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBCE2DD0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0xBCE2C70)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xBCE3180)
