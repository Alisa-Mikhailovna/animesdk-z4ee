...
#define RPG_CLIENT_BEHAVIORBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBEA6460)
#define RPG_CLIENT_BEHAVIORBASE_METHOD_1_8583C5AC29198FC4_OFFSET UNITYSDK_OFFSET(0xBEA64B0)
#define RPG_CLIENT_BEHAVIORBASE_METHOD_1_BB7A80635436443C_OFFSET UNITYSDK_OFFSET(0xBEA6410)
#define RPG_CLIENT_BEHAVIORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xBEA6580)
