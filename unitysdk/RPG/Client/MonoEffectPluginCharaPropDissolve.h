...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_INIT_OFFSET UNITYSDK_OFFSET(0xCC9A800)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_01BD521BAA5B9BAA_OFFSET UNITYSDK_OFFSET(0xCC9EDF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_06A62CAD2678156D_OFFSET UNITYSDK_OFFSET(0xCC9AC10)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_1AE11C3424D3DD6A_OFFSET UNITYSDK_OFFSET(0xCC9F070)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_1D96A7003D9A3921_OFFSET UNITYSDK_OFFSET(0xCC9E730)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xCC9A8C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_44E448B8C77CD61E_OFFSET UNITYSDK_OFFSET(0xCC9E100)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_5C33009454F2E6D2_1_OFFSET UNITYSDK_OFFSET(0xCC9AF70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_5C33009454F2E6D2_OFFSET UNITYSDK_OFFSET(0xCC9ACD0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_636ED563D619D8B8_OFFSET UNITYSDK_OFFSET(0xCC9B640)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_796F456B27F8E2D1_OFFSET UNITYSDK_OFFSET(0xCC9C120)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_B071C231B08D6398_OFFSET UNITYSDK_OFFSET(0xCC9CFC0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_C0BC29194EEB7A9A_OFFSET UNITYSDK_OFFSET(0xCC9B4A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_C7F2412112EF7A26_OFFSET UNITYSDK_OFFSET(0xCC9A910)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_DA90718EF1B39B3F_OFFSET UNITYSDK_OFFSET(0xCC9BC50)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_E1E37B85422AF149_OFFSET UNITYSDK_OFFSET(0xCC9AB50)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_E4867BA7EA09293C_OFFSET UNITYSDK_OFFSET(0xCC9ED00)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_METHOD_6_F7488FD4C9CC18F9_OFFSET UNITYSDK_OFFSET(0xCC9EF70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_SETOUTLINEMATERIALLIST_OFFSET UNITYSDK_OFFSET(0xCC9A7B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_UNINIT_OFFSET UNITYSDK_OFFSET(0xCC9B210)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xCC9A9D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDISSOLVE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC9F110)
