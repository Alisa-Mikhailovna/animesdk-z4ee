...
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA_GET_LOCALIZEDTEXTID_OFFSET UNITYSDK_OFFSET(0xD581340)
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA_SET_LOCALIZEDTEXTID_OFFSET UNITYSDK_OFFSET(0xD581350)
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD581360)
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0xD5813B0)
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD580860)

namespace RPG::Client
{
	inline static constexpr unsigned int SuperDropDown_LocalizedOptionData_TypeDefinitionIndex = 69385;
