...
#define RPG_CLIENT_POPUPMENUPROXY_OPTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD0B9A50)

namespace RPG::Client
{
	inline static constexpr unsigned int PopupMenuProxy_Option_TypeDefinitionIndex = 69215;
