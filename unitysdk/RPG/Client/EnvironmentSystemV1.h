...
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_ADDDYNAMICBLOCKLIGHT_OFFSET UNITYSDK_OFFSET(0xC3DDF90)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_APPLYPATCHTOACTIVEPROFILE_OFFSET UNITYSDK_OFFSET(0xC3E2930)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_AWAKE_OFFSET UNITYSDK_OFFSET(0xC3E3B90)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_CANCELASYNCINIT_OFFSET UNITYSDK_OFFSET(0xC3E7320)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_CANCELTRANSITION_OFFSET UNITYSDK_OFFSET(0xC3E2830)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_CLEARENVIROPATCH_OFFSET UNITYSDK_OFFSET(0xC3E27A0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_CLEAR_OFFSET UNITYSDK_OFFSET(0xC3E74A0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_DISABLEENVGPUPARTICLE_OFFSET UNITYSDK_OFFSET(0xC3E7E70)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_DISABLEENVPARTICLE_OFFSET UNITYSDK_OFFSET(0xC3E7EE0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_EDITORUPDATE_OFFSET UNITYSDK_OFFSET(0xC3E3840)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_FINISHTRANSITION_OFFSET UNITYSDK_OFFSET(0xC3DE4F0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_FORCEINITPPEFFECTMANAGER_OFFSET UNITYSDK_OFFSET(0xC3E81C0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GETCAPSULEAOMANAGER_OFFSET UNITYSDK_OFFSET(0xC3E82D0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GETDATA_OFFSET UNITYSDK_OFFSET(0xC3E5EB0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GETENVTRANSITMANAGER_OFFSET UNITYSDK_OFFSET(0xC3E72D0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GETFRAMECAPTUREMANAGER_OFFSET UNITYSDK_OFFSET(0xC3E8120)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GETISCURSWITCHWORK_OFFSET UNITYSDK_OFFSET(0xC3E5A60)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GETISVALID_OFFSET UNITYSDK_OFFSET(0xC3E5F50)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GETMATERIALEFFECTMANAGER_OFFSET UNITYSDK_OFFSET(0xC3E8280)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GETPPEFFECTMANAGER_OFFSET UNITYSDK_OFFSET(0xC3E8170)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GETTODPROFILE_OFFSET UNITYSDK_OFFSET(0xC3E2AA0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GET_ACTIVEPROFILEV1_OFFSET UNITYSDK_OFFSET(0xC3ED360)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_GET_ACTIVEPROFILE_OFFSET UNITYSDK_OFFSET(0xC3ED350)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_HASPRIORITY_OFFSET UNITYSDK_OFFSET(0xC3DDE60)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_INITENVIRONMENTSYSTEMASYNC_OFFSET UNITYSDK_OFFSET(0xC3E6FA0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_INITENVIRONMENTSYSTEM_OFFSET UNITYSDK_OFFSET(0xC3E6DD0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_INITENVSYSTEMV2INEDITORMODE_OFFSET UNITYSDK_OFFSET(0xC3E38D0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_INITPROFILE_OFFSET UNITYSDK_OFFSET(0xC3E2B00)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_INITSTATICANDCLEARSCENE_OFFSET UNITYSDK_OFFSET(0xC3E2BA0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_INIT_OFFSET UNITYSDK_OFFSET(0xC3E4100)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_LATETICK_OFFSET UNITYSDK_OFFSET(0xC3E4F20)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC3E3F30)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC3E3CD0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_RECORDMAINLIGHTDIR_OFFSET UNITYSDK_OFFSET(0xC3E79E0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_RELEASEPRIORITY_OFFSET UNITYSDK_OFFSET(0xC3DCA80)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_REMOVEDYNAMICBLOCKLIGHT_OFFSET UNITYSDK_OFFSET(0xC3DE0D0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_RENDER_OFFSET UNITYSDK_OFFSET(0xC3E5D50)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_RESETACTIVEPROFILE_OFFSET UNITYSDK_OFFSET(0xC3DDEC0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_RESETLEVELMAINLIGHTROATATEOFFET_OFFSET UNITYSDK_OFFSET(0xC3E6CF0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_RESETMAINLIGHTROATATEOFFET_OFFSET UNITYSDK_OFFSET(0xC3E7AE0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_RESETMAINLIGHT_OFFSET UNITYSDK_OFFSET(0xC3E7BE0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_RESETPOSTPROCESS_OFFSET UNITYSDK_OFFSET(0xC3E7B80)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_RESTOREMAINLIGHTDIR_OFFSET UNITYSDK_OFFSET(0xC3E7A60)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETACTIVEPROFILEASYNC_OFFSET UNITYSDK_OFFSET(0xC3DD7A0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETACTIVEPROFILE_OFFSET UNITYSDK_OFFSET(0xC3DC5B0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETBOOLPATCH_OFFSET UNITYSDK_OFFSET(0xC3E22D0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETENABLECHARALIGHT_OFFSET UNITYSDK_OFFSET(0xC3E8020)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETENABLESCENELIGHT_OFFSET UNITYSDK_OFFSET(0xC3E80A0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETENABLESHADOWLIGHT_OFFSET UNITYSDK_OFFSET(0xC3E7FA0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETENABLESKYBOX_OFFSET UNITYSDK_OFFSET(0xC3DD720)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETENABLEUPDATE_OFFSET UNITYSDK_OFFSET(0xC3E7F50)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETENABLE_OFFSET UNITYSDK_OFFSET(0xC3E7970)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETFLOATPATCH_OFFSET UNITYSDK_OFFSET(0xC3E2610)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETMAINLIGHTSWITCH_OFFSET UNITYSDK_OFFSET(0xC3E7D00)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETMONSTERLIGHTBYCAMERADIR_OFFSET UNITYSDK_OFFSET(0xC3E8830)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETTRANSITIONRATE_OFFSET UNITYSDK_OFFSET(0xC3E29A0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETTRANSITIONTARGETPROFILE_OFFSET UNITYSDK_OFFSET(0xC3DE210)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SETVECTORPATCH_OFFSET UNITYSDK_OFFSET(0xC3E2470)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_SET_OFFSET UNITYSDK_OFFSET(0xC3E5C40)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_START_OFFSET UNITYSDK_OFFSET(0xC3E40A0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_TICK_OFFSET UNITYSDK_OFFSET(0xC3E4770)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_UNINIT_OFFSET UNITYSDK_OFFSET(0xC3E75F0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1_VERSION_OFFSET UNITYSDK_OFFSET(0xC3E3880)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__APPLYPIPELINEASSETSETTINGS_OFFSET UNITYSDK_OFFSET(0xC3E0130)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__APPLYPIPELINEQUALITYSETTINGS_OFFSET UNITYSDK_OFFSET(0xC3E1F10)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__APPLYPIPELINESHADOWSETTINGS_OFFSET UNITYSDK_OFFSET(0xC3DE6C0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__ATMOSPHERESCATTERINGCELESTIALCONTROL_OFFSET UNITYSDK_OFFSET(0xC3EA570)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__ATMOSPHERESCATTERPRECOMPUTE_OFFSET UNITYSDK_OFFSET(0xC3EB240)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__CHECKENVIROMENTCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xC3E5FA0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__CLEARALLCOMMAND_OFFSET UNITYSDK_OFFSET(0xC3DCC90)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__CLOSEFOG_OFFSET UNITYSDK_OFFSET(0xC3E7520)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__CTOR_OFFSET UNITYSDK_OFFSET(0xC3ED370)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__PUSHCOMMMANDQUEUE_OFFSET UNITYSDK_OFFSET(0xC3DCE00)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__REFPROBEGAMMATOLINEARSPACE_OFFSET UNITYSDK_OFFSET(0xC3E8320)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__REFRESHACTIVEPROFILEASYNC_OFFSET UNITYSDK_OFFSET(0xC3DDC10)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__REFRESHACTIVEPROFILE_OFFSET UNITYSDK_OFFSET(0xC3DD060)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__SETGLOBALREFLECTIONPROBE_OFFSET UNITYSDK_OFFSET(0xC3E83D0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__TIMEOFDAYTICK_OFFSET UNITYSDK_OFFSET(0xC3EA3E0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__UPDATECOMPONENTBYENVIROCLIPS_OFFSET UNITYSDK_OFFSET(0xC3E2220)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__UPDATEENVIROCLIPSBYCOMPONENT_OFFSET UNITYSDK_OFFSET(0xC3E6850)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__UPDATEENVIROLIGHT_OFFSET UNITYSDK_OFFSET(0xC3E8AE0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__UPDATENVIROPREFABS_OFFSET UNITYSDK_OFFSET(0xC3E4C10)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__UPDATEPIPELINEDATA_OFFSET UNITYSDK_OFFSET(0xC3E5AC0)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__UPDATESKYBOX_OFFSET UNITYSDK_OFFSET(0xC3E9470)
#define RPG_CLIENT_ENVIRONMENTSYSTEMV1__UPDATEVFCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC3EB2B0)
