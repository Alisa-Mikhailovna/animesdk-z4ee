...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYVECTOR_GET_RANDOMVALUE_OFFSET UNITYSDK_OFFSET(0xC31A3A0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYVECTOR_METHOD_1_E5F22A66D9BCBA01_OFFSET UNITYSDK_OFFSET(0xC319DE0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC31A440)
