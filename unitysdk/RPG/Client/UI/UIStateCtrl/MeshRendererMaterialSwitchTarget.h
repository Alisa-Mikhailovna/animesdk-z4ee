...
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_126AEE9DCE6A9399_OFFSET UNITYSDK_OFFSET(0xD771A00)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD771D20)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0xD771BB0)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_B7BFE5D35A542E8B_OFFSET UNITYSDK_OFFSET(0xD771D80)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_FEC28CECAEED4E11_OFFSET UNITYSDK_OFFSET(0xD771C10)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD7719F0)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xD7719E0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int MeshRendererMaterialSwitchTarget_TypeDefinitionIndex = 70677;
