...
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_GET_CURRENTCOSTTIME_OFFSET UNITYSDK_OFFSET(0xD76FCC0)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_16480B1867AF51ED_OFFSET UNITYSDK_OFFSET(0xD76F660)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xD76FA40)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD76FC80)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0xD76F890)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xD76F740)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_BA0DC2F7F154B425_OFFSET UNITYSDK_OFFSET(0xD76FB00)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_SET_CURRENTCOSTTIME_OFFSET UNITYSDK_OFFSET(0xD76FCD0)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD76FCE0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int AsyncAction_TypeDefinitionIndex = 70667;
