...
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_GET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0xD76FD60)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xD76FD40)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_METHOD_1_8A1C979A2319B852_OFFSET UNITYSDK_OFFSET(0xD76F6F0)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD76FD00)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_METHOD_1_FC25C1AE120A80A5_OFFSET UNITYSDK_OFFSET(0xD76F840)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_SET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0xD76FD70)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_SET_STATUS_OFFSET UNITYSDK_OFFSET(0xD76FD50)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD76FCF0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int BaseAction_TypeDefinitionIndex = 70668;
