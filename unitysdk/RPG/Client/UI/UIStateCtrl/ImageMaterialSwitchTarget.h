...
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD770750)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_1E1B584909E026DF_OFFSET UNITYSDK_OFFSET(0xD770200)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_2D99CA5EA537015F_OFFSET UNITYSDK_OFFSET(0xD76FFE0)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_3AFE2A3ED13F591D_OFFSET UNITYSDK_OFFSET(0xD7704C0)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0xD770130)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_AC3BD55C31CE6E12_OFFSET UNITYSDK_OFFSET(0xD770340)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_B4F2FE6610DD5A60_OFFSET UNITYSDK_OFFSET(0xD770190)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_B7BFE5D35A542E8B_OFFSET UNITYSDK_OFFSET(0xD7707B0)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_FBAC2F70799E5CFB_OFFSET UNITYSDK_OFFSET(0xD770610)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD76FFD0)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xD76FFB0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int ImageMaterialSwitchTarget_TypeDefinitionIndex = 70673;
