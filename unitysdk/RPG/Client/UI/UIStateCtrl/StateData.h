...
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_GET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0xD773030)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD772A80)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_2FDE146A62E65189_OFFSET UNITYSDK_OFFSET(0xD772630)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_30615810974CEB89_OFFSET UNITYSDK_OFFSET(0xD772F70)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_3FC863B885E15ED5_OFFSET UNITYSDK_OFFSET(0xD772CE0)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_6D22709430EDAB68_OFFSET UNITYSDK_OFFSET(0xD772AE0)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_METHOD_1_A07C2061B55C1547_OFFSET UNITYSDK_OFFSET(0xD772DD0)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA_SET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0xD773040)
#define RPG_CLIENT_UI_UISTATECTRL_STATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD773050)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int StateData_TypeDefinitionIndex = 70672;
