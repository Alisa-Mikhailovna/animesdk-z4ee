...
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD770E70)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0xD770D00)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_7D4A14E62F64E1E1_OFFSET UNITYSDK_OFFSET(0xD770B70)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_B7BFE5D35A542E8B_OFFSET UNITYSDK_OFFSET(0xD770ED0)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_FEC28CECAEED4E11_OFFSET UNITYSDK_OFFSET(0xD770D60)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD770B60)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xD770B50)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int LineRendererMaterialSwitchTarget_TypeDefinitionIndex = 70674;
