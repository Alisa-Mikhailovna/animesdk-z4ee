...
#define RPG_CLIENT_UI_UISTATECTRL_INSTANTACTION_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xD770900)
#define RPG_CLIENT_UI_UISTATECTRL_INSTANTACTION_METHOD_2_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xD770810)
#define RPG_CLIENT_UI_UISTATECTRL_INSTANTACTION_METHOD_2_BA0DC2F7F154B425_OFFSET UNITYSDK_OFFSET(0xD7709F0)
#define RPG_CLIENT_UI_UISTATECTRL_INSTANTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD76FFA0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int InstantAction_TypeDefinitionIndex = 70670;
