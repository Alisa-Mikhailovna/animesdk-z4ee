...
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALSWITCHTARGET_METHOD_1_29ED79A4693535A3_OFFSET UNITYSDK_OFFSET(0xD771870)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALSWITCHTARGET_METHOD_1_6424DA16BE1ACD1D_OFFSET UNITYSDK_OFFSET(0xD771990)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALSWITCHTARGET_METHOD_1_E78C6A7FA9F07F9A_OFFSET UNITYSDK_OFFSET(0xD771930)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALSWITCHTARGET_METHOD_1_EBCE0F8672AB6F83_OFFSET UNITYSDK_OFFSET(0xD7718D0)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALSWITCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xD76FFC0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int MaterialSwitchTarget_TypeDefinitionIndex = 70675;
