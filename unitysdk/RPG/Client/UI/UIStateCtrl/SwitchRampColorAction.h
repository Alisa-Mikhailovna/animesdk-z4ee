...
#define RPG_CLIENT_UI_UISTATECTRL_SWITCHRAMPCOLORACTION_METHOD_3_0F9501A1A0E8C6CD_OFFSET UNITYSDK_OFFSET(0xD775F40)
#define RPG_CLIENT_UI_UISTATECTRL_SWITCHRAMPCOLORACTION_METHOD_3_4D512A12A2845DB4_OFFSET UNITYSDK_OFFSET(0xD775D80)
#define RPG_CLIENT_UI_UISTATECTRL_SWITCHRAMPCOLORACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD776790)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int SwitchRampColorAction_TypeDefinitionIndex = 70663;
