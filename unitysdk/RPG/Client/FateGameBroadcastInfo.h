...
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET_AUDIOEVENT_OFFSET UNITYSDK_OFFSET(0xC4548D0)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET_BROADCASTCONTENT_OFFSET UNITYSDK_OFFSET(0xC454790)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET_BROADCASTID_OFFSET UNITYSDK_OFFSET(0xC454750)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET__BATTLEZONEROW_OFFSET UNITYSDK_OFFSET(0xC454330)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC454870)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC453E10)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_ONAFTERROUNDSETTLESYNC_OFFSET UNITYSDK_OFFSET(0xC454510)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_ONBEFOREROUNDSETTLESYNC_OFFSET UNITYSDK_OFFSET(0xC454420)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0xC454600)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_REFRESHCURBROADCAST_OFFSET UNITYSDK_OFFSET(0xC454040)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC453DD0)
