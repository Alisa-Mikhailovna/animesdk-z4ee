...
#define RPG_CLIENT_MONOSCROLLREDDOT_ADDREDDOTROOT_OFFSET UNITYSDK_OFFSET(0xCD1F5D0)
#define RPG_CLIENT_MONOSCROLLREDDOT_CLEARREDDOTROOTS_OFFSET UNITYSDK_OFFSET(0xCD1F540)
#define RPG_CLIENT_MONOSCROLLREDDOT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCD1FCF0)
#define RPG_CLIENT_MONOSCROLLREDDOT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD1FB90)
#define RPG_CLIENT_MONOSCROLLREDDOT_ONSCROLLRECTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xCD1FE80)
#define RPG_CLIENT_MONOSCROLLREDDOT_SETUPSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0xCD1F6C0)
#define RPG_CLIENT_MONOSCROLLREDDOT_START_OFFSET UNITYSDK_OFFSET(0xCD1FA20)
#define RPG_CLIENT_MONOSCROLLREDDOT__CHECKANDREFRESHUIDATAS_OFFSET UNITYSDK_OFFSET(0xCD1FD50)
#define RPG_CLIENT_MONOSCROLLREDDOT__CHECKSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0xCD1FED0)
#define RPG_CLIENT_MONOSCROLLREDDOT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD205B0)
#define RPG_CLIENT_MONOSCROLLREDDOT__ISSHOWINGREDDOT_OFFSET UNITYSDK_OFFSET(0xCD20480)
#define RPG_CLIENT_MONOSCROLLREDDOT__REFRESHREDDOTCHILDCOUNTLIST_OFFSET UNITYSDK_OFFSET(0xCD20300)
#define RPG_CLIENT_MONOSCROLLREDDOT__REFRESHSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0xCD1F990)
#define RPG_CLIENT_MONOSCROLLREDDOT__REFRESHUIDATAS_OFFSET UNITYSDK_OFFSET(0xCD1F750)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoScrollRedDot_TypeDefinitionIndex = 69321;
