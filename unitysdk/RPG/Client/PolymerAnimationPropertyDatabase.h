...
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GENPROPERTYNAMELIST_OFFSET UNITYSDK_OFFSET(0xD0B6C70)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETCOLOR_OFFSET UNITYSDK_OFFSET(0xD0B4DB0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETFLOAT_OFFSET UNITYSDK_OFFSET(0xD0B4890)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETSLOTID_OFFSET UNITYSDK_OFFSET(0xD0B5080)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETVECTOR_OFFSET UNITYSDK_OFFSET(0xD0B4AE0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD0B5630)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0xD0B5150)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0xD0B52E0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xD0B4F00)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETFLOAT_OFFSET UNITYSDK_OFFSET(0xD0B49B0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETVECTOR_OFFSET UNITYSDK_OFFSET(0xD0B4C30)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_TICK_OFFSET UNITYSDK_OFFSET(0xD0B5920)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0B58D0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0B6EE0)
