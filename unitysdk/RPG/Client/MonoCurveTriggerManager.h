...
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC471B0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCC440E0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0xCC41FB0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_GET_ENTITYREF_OFFSET UNITYSDK_OFFSET(0xCC47450)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_INITENTITY_OFFSET UNITYSDK_OFFSET(0xCC47010)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_ISALLOWSHOWTRIGGEROPTIONS_OFFSET UNITYSDK_OFFSET(0xCC45D30)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_28860F33089AB3D6_OFFSET UNITYSDK_OFFSET(0xCC46E80)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_33199F5C1EFD6BB6_OFFSET UNITYSDK_OFFSET(0xCC458F0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_3514B5B776663B67_OFFSET UNITYSDK_OFFSET(0xCC45B50)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_5D973F34E2DFFD37_OFFSET UNITYSDK_OFFSET(0xCC46BA0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_959CF5A4AD31A03C_OFFSET UNITYSDK_OFFSET(0xCC45FD0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCC46690)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_EBF44BC910948FDA_OFFSET UNITYSDK_OFFSET(0xCC46AF0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_ONMOVABLEOBJECTMOVEENDED_OFFSET UNITYSDK_OFFSET(0xCC41980)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_SETUPCURVEEDGECONNECTIONTRIGGER_OFFSET UNITYSDK_OFFSET(0xCC44650)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_SETUPMOVABLEOBJECTLOGICTRIGGER_OFFSET UNITYSDK_OFFSET(0xCC455D0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_SETUPMOVABLEOBJECTTRIGGER_OFFSET UNITYSDK_OFFSET(0xCC414C0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_SET_ENTITYREF_OFFSET UNITYSDK_OFFSET(0xCC47460)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_START_OFFSET UNITYSDK_OFFSET(0xCC473C0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_TRIGGERDETECTCOLLIDEREVENT_OFFSET UNITYSDK_OFFSET(0xCC3F8D0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_TRIGGERRELOADCURVEMOVEMENTEVENT_OFFSET UNITYSDK_OFFSET(0xCC41AB0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_TRIGGERTOUCHMOVABLEOBJECT_OFFSET UNITYSDK_OFFSET(0xCC3F4C0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_UPDATELOGICTRIGGERSTATE_OFFSET UNITYSDK_OFFSET(0xCC46580)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_UPDATELOGICTRIGGER_OFFSET UNITYSDK_OFFSET(0xCC45EB0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCC466E0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC47470)
