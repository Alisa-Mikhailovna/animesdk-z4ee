...
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD5A2A80)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_POWERREQUIRE_OFFSET UNITYSDK_OFFSET(0xD5A2E90)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKGROUPID_OFFSET UNITYSDK_OFFSET(0xD5A2B50)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKGROUPNAME_OFFSET UNITYSDK_OFFSET(0xD5A2D10)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKICON_OFFSET UNITYSDK_OFFSET(0xD5A2FD0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKPROGRESSNAME_OFFSET UNITYSDK_OFFSET(0xD5A2DD0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKSUBNAME_OFFSET UNITYSDK_OFFSET(0xD5A2C50)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0xD5A2B10)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_UNLOCKID_OFFSET UNITYSDK_OFFSET(0xD5A2F30)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xD5A2BF0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD5A2B00)
