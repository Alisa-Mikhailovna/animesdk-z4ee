...
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GETALLDISPLAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0xC0768B0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_ATKSPD_OFFSET UNITYSDK_OFFSET(0xC077020)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_ATK_OFFSET UNITYSDK_OFFSET(0xC076F60)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_BATTLESCOREFIX_OFFSET UNITYSDK_OFFSET(0xC068FE0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_CRTDMG_OFFSET UNITYSDK_OFFSET(0xC077140)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_CRT_OFFSET UNITYSDK_OFFSET(0xC0770E0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_FORMATIONTYPE_OFFSET UNITYSDK_OFFSET(0xC0696E0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_HP_OFFSET UNITYSDK_OFFSET(0xC076FC0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xC076720)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_MOVESPD_OFFSET UNITYSDK_OFFSET(0xC077080)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_NUM_OFFSET UNITYSDK_OFFSET(0xC0771A0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0xC076700)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_UNITIDLIST_OFFSET UNITYSDK_OFFSET(0xC0692F0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET__MAXLEVELUNITCONFIG_OFFSET UNITYSDK_OFFSET(0xC0767B0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC076740)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xC076730)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_SET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0xC076710)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC0766C0)
