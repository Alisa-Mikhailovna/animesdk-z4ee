...
#define RPG_CLIENT_HEADFRAMEUTILS_GETHEADFRAMEPREFABPATH_OFFSET UNITYSDK_OFFSET(0xC894EA0)
#define RPG_CLIENT_HEADFRAMEUTILS_GETPLAYERHEADFRAMEINFOIFDISPLAY_OFFSET UNITYSDK_OFFSET(0xC894D40)
#define RPG_CLIENT_HEADFRAMEUTILS_GET_HASHEADFRAME_OFFSET UNITYSDK_OFFSET(0xC894CA0)
#define RPG_CLIENT_HEADFRAMEUTILS_GET_ISDISPLAYHEADFRAME_OFFSET UNITYSDK_OFFSET(0xC894C00)
#define RPG_CLIENT_HEADFRAMEUTILS_SWITCHDISPLAYSTATE_OFFSET UNITYSDK_OFFSET(0xC894DF0)
