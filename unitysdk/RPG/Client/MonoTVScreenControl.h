...
#define RPG_CLIENT_MONOTVSCREENCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD25860)
#define RPG_CLIENT_MONOTVSCREENCONTROL_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCD25710)
#define RPG_CLIENT_MONOTVSCREENCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD259B0)
#define RPG_CLIENT_MONOTVSCREENCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD258C0)
#define RPG_CLIENT_MONOTVSCREENCONTROL_PLAYCUSTOMTEXTURE_OFFSET UNITYSDK_OFFSET(0xCD25620)
#define RPG_CLIENT_MONOTVSCREENCONTROL_STOPCUSTOMTEXTURE_OFFSET UNITYSDK_OFFSET(0xCD25780)
#define RPG_CLIENT_MONOTVSCREENCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD25930)
#define RPG_CLIENT_MONOTVSCREENCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCD25A40)
