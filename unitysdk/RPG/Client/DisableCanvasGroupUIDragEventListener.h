...
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_ADDDISABLECANVASGROUP_OFFSET UNITYSDK_OFFSET(0xC2AD410)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_REMOVEDISABLECANVASGROUP_OFFSET UNITYSDK_OFFSET(0xC2AD510)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_RPG_CLIENT_IUIDRAGEVENTLISTENER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xC2AD1D0)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_RPG_CLIENT_IUIDRAGEVENTLISTENER_ONSTARTDRAG_OFFSET UNITYSDK_OFFSET(0xC2AD2F0)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2AD5B0)

namespace RPG::Client
{
	inline static constexpr unsigned int DisableCanvasGroupUIDragEventListener_TypeDefinitionIndex = 69714;
