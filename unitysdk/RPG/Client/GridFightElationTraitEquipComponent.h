...
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_CANCRAFTTO_OFFSET UNITYSDK_OFFSET(0xC6DD500)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_CRAFTTO_OFFSET UNITYSDK_OFFSET(0xC6DE1A0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETCRAFTEDEQUIP_OFFSET UNITYSDK_OFFSET(0xC6DE110)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETCRAFTTOCOMBINATION_OFFSET UNITYSDK_OFFSET(0xC6DE4D0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETCURENABLERECIPE_OFFSET UNITYSDK_OFFSET(0xC6DEB30)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETEQUIPCONFIGS_OFFSET UNITYSDK_OFFSET(0xC6DF8F0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETRECOMMENDS_OFFSET UNITYSDK_OFFSET(0xC6DC9D0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETUNLOCKNEEDLAYER_OFFSET UNITYSDK_OFFSET(0xC6DD2C0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_BASICEQUIPCONFIGS_OFFSET UNITYSDK_OFFSET(0xC6DE9F0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_EQUIPCOUNT_OFFSET UNITYSDK_OFFSET(0xC6DCCA0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_HASOCCUPIED_OFFSET UNITYSDK_OFFSET(0xC6DCCF0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_ISFULL_OFFSET UNITYSDK_OFFSET(0xC6DCE00)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xC6DF120)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_PRIMARYRECOMMENDEQUIPS_OFFSET UNITYSDK_OFFSET(0xC6DCC00)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_SECONDARYRECOMMENDEQUIPS_OFFSET UNITYSDK_OFFSET(0xC6DCC50)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET__DATACONTEXT_OFFSET UNITYSDK_OFFSET(0xC6DFDF0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_HASCRAFTABLE_OFFSET UNITYSDK_OFFSET(0xC6DCFA0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_INITCONFIG_OFFSET UNITYSDK_OFFSET(0xC6DF370)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_ISCRAFTED_OFFSET UNITYSDK_OFFSET(0xC6DD230)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_ISOCCUPIED_OFFSET UNITYSDK_OFFSET(0xC6DCD60)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xC6DD060)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_SETUPTRAITEFFECT_OFFSET UNITYSDK_OFFSET(0xC6DF320)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0xC6DF520)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC6DFE70)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__GETEQUIPBYUID_OFFSET UNITYSDK_OFFSET(0xC6DFB10)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__GETNEEDEQUIPID_OFFSET UNITYSDK_OFFSET(0xC6DD8F0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__GETOCCUPYNEEDEQUIPID_OFFSET UNITYSDK_OFFSET(0xC6DDD30)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__GETRECOMMEND_OFFSET UNITYSDK_OFFSET(0xC6DC810)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__UPDATE_B__24_3_OFFSET UNITYSDK_OFFSET(0xC6DFF10)
