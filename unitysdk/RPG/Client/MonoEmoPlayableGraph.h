...
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_AUTOBLINKWITHEYESTATE_OFFSET UNITYSDK_OFFSET(0xCCDB970)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_CANBLINK_OFFSET UNITYSDK_OFFSET(0xCCDBCA0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_DESTROY_OFFSET UNITYSDK_OFFSET(0xCCDB330)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETAVATARMASK_OFFSET UNITYSDK_OFFSET(0xCCDF930)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETCLIP_OFFSET UNITYSDK_OFFSET(0xCCDB4B0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETDEFAULTCLIP_OFFSET UNITYSDK_OFFSET(0xCCE02D0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETOUTPUT_OFFSET UNITYSDK_OFFSET(0xCCDB5C0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0xCCDF480)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_ALWAYSEVALUATE_OFFSET UNITYSDK_OFFSET(0xCCDAF70)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_EMOTIONPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0xCCDAF20)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_FACERENDERER_OFFSET UNITYSDK_OFFSET(0xCCDAF90)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_FADEOUTAUTOBLINK_OFFSET UNITYSDK_OFFSET(0xCCDAF50)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xCCDAF30)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_PLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0xCCDAF40)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_0031B2A6B176A873_OFFSET UNITYSDK_OFFSET(0xCCDE520)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0xCCDB750)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_0E3D8071A5930FA8_OFFSET UNITYSDK_OFFSET(0xCCDBE00)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_104F651E1412A8CC_OFFSET UNITYSDK_OFFSET(0xCCDCCC0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0xCCE0010)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_151E25A63D14DDB0_2_OFFSET UNITYSDK_OFFSET(0xCCE0170)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xCCDFEB0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xCCDE760)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_277F8930086803D1_OFFSET UNITYSDK_OFFSET(0xCCDF7C0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_360914574A437C0A_OFFSET UNITYSDK_OFFSET(0xCCE03A0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCCDD680)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_515AB539783606E0_OFFSET UNITYSDK_OFFSET(0xCCDD9C0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_56C243520A6A6A4C_OFFSET UNITYSDK_OFFSET(0xCCDE420)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_5F9B14860EA6F2FD_OFFSET UNITYSDK_OFFSET(0xCCDD2C0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xCCDBD00)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_84FDC7D1E4092695_OFFSET UNITYSDK_OFFSET(0xCCDDF80)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_8C3F79E1E85EBE71_OFFSET UNITYSDK_OFFSET(0xCCDD740)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0xCCDD940)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xCCDE9B0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCCDD610)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_969EF16C38E0FD30_OFFSET UNITYSDK_OFFSET(0xCCDEBA0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_A9D0098EE09DF11B_OFFSET UNITYSDK_OFFSET(0xCCDBB80)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_B49D9DFCA7DAD6C6_OFFSET UNITYSDK_OFFSET(0xCCDF410)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCCDB8B0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E086BDB08435547E_1_OFFSET UNITYSDK_OFFSET(0xCCDFA30)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E086BDB08435547E_2_OFFSET UNITYSDK_OFFSET(0xCCDFAA0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E086BDB08435547E_OFFSET UNITYSDK_OFFSET(0xCCDF9C0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E0F023080DE42077_1_OFFSET UNITYSDK_OFFSET(0xCCDFC70)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E0F023080DE42077_2_OFFSET UNITYSDK_OFFSET(0xCCDFD20)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E0F023080DE42077_OFFSET UNITYSDK_OFFSET(0xCCDFBC0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xCCDEA10)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0xCCDB100)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_F07840BBC25636A7_OFFSET UNITYSDK_OFFSET(0xCCDF220)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0xCCDE800)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONAUDIOLANGUAGECHANGED_OFFSET UNITYSDK_OFFSET(0xCCDAFB0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCCDF5E0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCCDEE80)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCCDECD0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONOWNERRECYCLE_OFFSET UNITYSDK_OFFSET(0xCCDF770)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_RESETPERMANENTCLIP_OFFSET UNITYSDK_OFFSET(0xCCDD410)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETAUTOBLINKWITHCURREYESTATE_OFFSET UNITYSDK_OFFSET(0xCCDB910)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETENABLEAUTOBLICKWITHEYESTATE_OFFSET UNITYSDK_OFFSET(0xCCDBA40)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETENABLEAUTOBLINKSTATE_OFFSET UNITYSDK_OFFSET(0xCCDB660)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETEYEPERMANENTEYESTATE_OFFSET UNITYSDK_OFFSET(0xCCE0340)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETMASKRENDERER_OFFSET UNITYSDK_OFFSET(0xCCDBAE0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETMOUTHTALK_OFFSET UNITYSDK_OFFSET(0xCCE04B0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETTALKPERMANENT_OFFSET UNITYSDK_OFFSET(0xCCDFB10)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SET_ALWAYSEVALUATE_OFFSET UNITYSDK_OFFSET(0xCCDAF80)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SET_FACERENDERER_OFFSET UNITYSDK_OFFSET(0xCCDAFA0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SET_FADEOUTAUTOBLINK_OFFSET UNITYSDK_OFFSET(0xCCDAF60)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_START_OFFSET UNITYSDK_OFFSET(0xCCDEDE0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_STOPMOUTHTALK_OFFSET UNITYSDK_OFFSET(0xCCE06B0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_STOPTALKPERMANENT_OFFSET UNITYSDK_OFFSET(0xCCDFDD0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_TICKAFTEREVALUATE_OFFSET UNITYSDK_OFFSET(0xCCDF520)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_TICKBEFOREEVALUATE_OFFSET UNITYSDK_OFFSET(0xCCDF180)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_TRIGGERBLINKINGEYECLOSE_OFFSET UNITYSDK_OFFSET(0xCCDBB30)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_TRYINIT_OFFSET UNITYSDK_OFFSET(0xCCDB040)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_UPDATE_OFFSET UNITYSDK_OFFSET(0xCCDF010)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH__CCTOR_OFFSET UNITYSDK_OFFSET(0xCCE0750)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE0710)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(MonoEmoPlayableGraph_TypeDefinitionIndex)->GetStaticField(0xD260);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_Field_5_1()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MonoEmoPlayableGraph_TypeDefinitionIndex)->GetStaticField(0xD268);
		}
		static ::System::Boolean* StaticGet_USE_NEW_EMO()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MonoEmoPlayableGraph_TypeDefinitionIndex)->GetStaticField(0x4BB0);
		}
