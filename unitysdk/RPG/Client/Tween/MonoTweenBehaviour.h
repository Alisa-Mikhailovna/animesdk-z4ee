...
#define RPG_CLIENT_TWEEN_MONOTWEENBEHAVIOUR_GETCUSTOMANICURVE_1_OFFSET UNITYSDK_OFFSET(0xD76F5B0)
#define RPG_CLIENT_TWEEN_MONOTWEENBEHAVIOUR_GETCUSTOMANICURVE_OFFSET UNITYSDK_OFFSET(0xD76F410)
#define RPG_CLIENT_TWEEN_MONOTWEENBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD76F650)

namespace RPG::Client::Tween
{
	inline static constexpr unsigned int MonoTweenBehaviour_TypeDefinitionIndex = 70075;
