...
#define RPG_CLIENT_SCREENSPACEGPUPARTICLES_SCREENSPACEGPUPARTICLESEMITTER_GET_EMITTERMATRIX_OFFSET UNITYSDK_OFFSET(0xD4DF550)
#define RPG_CLIENT_SCREENSPACEGPUPARTICLES_SCREENSPACEGPUPARTICLESEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD4DF850)

namespace RPG::Client::ScreenSpaceGPUParticles
{
	inline static constexpr unsigned int ScreenSpaceGPUParticlesEmitter_TypeDefinitionIndex = 70300;
