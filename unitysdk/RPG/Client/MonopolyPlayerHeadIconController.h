...
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xCD6A600)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xCD697D0)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD69B60)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD6A650)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__GETHEADICONSCPOS_OFFSET UNITYSDK_OFFSET(0xCD6A160)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__GETSCREENCOORDINATEVALUE_OFFSET UNITYSDK_OFFSET(0xCD69940)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__ISPLAYERINSCREEN_OFFSET UNITYSDK_OFFSET(0xCD69D80)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__ROTATEICON_OFFSET UNITYSDK_OFFSET(0xCD6A280)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__UPDATEPLAYERICONPOS_OFFSET UNITYSDK_OFFSET(0xCD69E00)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyPlayerHeadIconController_TypeDefinitionIndex = 69534;
