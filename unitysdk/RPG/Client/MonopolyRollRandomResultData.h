...
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCD636F0)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_GET_EXTRAROLLRESULT_OFFSET UNITYSDK_OFFSET(0xCD6B010)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_GET_OPTIONID_OFFSET UNITYSDK_OFFSET(0xCD6AFD0)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_GET_ROLLRANDOMLIST_OFFSET UNITYSDK_OFFSET(0xCD6AFF0)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_SET_EXTRAROLLRESULT_OFFSET UNITYSDK_OFFSET(0xCD6B020)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_SET_OPTIONID_OFFSET UNITYSDK_OFFSET(0xCD6AFE0)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_SET_ROLLRANDOMLIST_OFFSET UNITYSDK_OFFSET(0xCD6B000)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD6AFC0)
