...
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xC328060)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_GETDERIVATIVEWEIGHT_OFFSET UNITYSDK_OFFSET(0xC328BC0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_02A2D800521F7143_OFFSET UNITYSDK_OFFSET(0xC3284B0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_0F30679B05E70FC1_OFFSET UNITYSDK_OFFSET(0xC329140)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xC327B50)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_218124418542E081_OFFSET UNITYSDK_OFFSET(0xC327BE0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xC327820)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_7432254BE2E104AA_OFFSET UNITYSDK_OFFSET(0xC3282E0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_1_OFFSET UNITYSDK_OFFSET(0xC328E30)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_2_OFFSET UNITYSDK_OFFSET(0xC328ED0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0xC328D90)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_8A2AC7CD7EA66CAC_OFFSET UNITYSDK_OFFSET(0xC328F90)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_DA5757BC97DEA931_OFFSET UNITYSDK_OFFSET(0xC328150)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_DAC9219D09D338F5_OFFSET UNITYSDK_OFFSET(0xC329450)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC327960)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC327780)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_UPDATE_OFFSET UNITYSDK_OFFSET(0xC327A80)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING__CCTOR_OFFSET UNITYSDK_OFFSET(0xC329670)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING__CTOR_OFFSET UNITYSDK_OFFSET(0xC3295C0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Plane>**)Il2CppClass::FromTypeDefinitionIndex(Effect_LineRendererSkinning_TypeDefinitionIndex)->GetStaticField(0x68640);
		}
