...
#define RPG_CLIENT_MONOUI3DTOUCH_FINGERUTIL_ADDFINGER_OFFSET UNITYSDK_OFFSET(0xCD33F70)
#define RPG_CLIENT_MONOUI3DTOUCH_FINGERUTIL_CLEAR_OFFSET UNITYSDK_OFFSET(0xCD364B0)
#define RPG_CLIENT_MONOUI3DTOUCH_FINGERUTIL_CONTAINFINGER_OFFSET UNITYSDK_OFFSET(0xCD344C0)
#define RPG_CLIENT_MONOUI3DTOUCH_FINGERUTIL_GETFINGERNUM_OFFSET UNITYSDK_OFFSET(0xCD34010)
#define RPG_CLIENT_MONOUI3DTOUCH_FINGERUTIL_REMOVEFINGER_OFFSET UNITYSDK_OFFSET(0xCD34270)
#define RPG_CLIENT_MONOUI3DTOUCH_FINGERUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0xCD36E10)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUI3DTouch_FingerUtil_TypeDefinitionIndex = 69668;
