...
#define RPG_CLIENT_CHARACTERTAILIK_CLEAR_OFFSET UNITYSDK_OFFSET(0xC028E10)
#define RPG_CLIENT_CHARACTERTAILIK_COMPARETO_OFFSET UNITYSDK_OFFSET(0xC0298B0)
#define RPG_CLIENT_CHARACTERTAILIK_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC0299E0)
#define RPG_CLIENT_CHARACTERTAILIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC028F10)
#define RPG_CLIENT_CHARACTERTAILIK_METHOD_5_6BF81B6CD305D3E3_OFFSET UNITYSDK_OFFSET(0xC0299F0)
#define RPG_CLIENT_CHARACTERTAILIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC028EB0)
#define RPG_CLIENT_CHARACTERTAILIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC028E50)
#define RPG_CLIENT_CHARACTERTAILIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xC028F60)
#define RPG_CLIENT_CHARACTERTAILIK__CTOR_OFFSET UNITYSDK_OFFSET(0xC029A70)
