...
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA_ADDMODIFIERSOURCE_OFFSET UNITYSDK_OFFSET(0xC7BF560)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0xC7BF660)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA_GET_CALCULATOR_OFFSET UNITYSDK_OFFSET(0xC7BFE40)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA_GET_CURRENTENERGYBAR_OFFSET UNITYSDK_OFFSET(0xC7BFAE0)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0xC7BF940)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA_GET_CURRENTSPECIALSP_OFFSET UNITYSDK_OFFSET(0xC7BF9E0)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA_GET_CURRENTSPEED_OFFSET UNITYSDK_OFFSET(0xC7BFA90)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA_GET_CURRENTSP_OFFSET UNITYSDK_OFFSET(0xC7BF990)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xC7BD420)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC7BF4B0)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA__GETAVATARRAWPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0xC7C0680)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA__GETBACKPROPERTYMODIFIER_OFFSET UNITYSDK_OFFSET(0xC7C04F0)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA__GETEXCELPROPERTY_OFFSET UNITYSDK_OFFSET(0xC7BFEA0)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA__GETFINALVALUE_OFFSET UNITYSDK_OFFSET(0xC7BF700)
#define RPG_CLIENT_GRIDFIGHTPROPERTYDATA__GETINITIALENERGYBAR_OFFSET UNITYSDK_OFFSET(0xC7BFB70)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Class_1_225D988EB7771D59**)Il2CppClass::FromTypeDefinitionIndex(GridFightPropertyData_TypeDefinitionIndex)->GetStaticField(0x2B0B0);
		}
		::RPG::Client::GridFightRole* _Role; // 0x10
		::Class_1_F4B3762E9E6279A5* _FormulaContext; // 0x18
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_723*>* _ModifierSources; // 0x20
