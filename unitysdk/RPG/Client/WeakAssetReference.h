...
#define RPG_CLIENT_WEAKASSETREFERENCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x39E3B20)
#define RPG_CLIENT_WEAKASSETREFERENCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x39E3B30)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x39E3990)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x39E39F0)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_374150148187FD76_OFFSET UNITYSDK_OFFSET(0x1A3C65D0)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x39E3A50)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_EDC938276DD38C8F_OFFSET UNITYSDK_OFFSET(0x1A3C6680)
#define RPG_CLIENT_WEAKASSETREFERENCE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x39E3AE0)
#define RPG_CLIENT_WEAKASSETREFERENCE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x39E3AA0)
#define RPG_CLIENT_WEAKASSETREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x39E3930)
