...
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_GET_RAIDCOLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0xD3307F0)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0xD3307A0)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_ISSHOWNOPASSNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xD3305E0)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_SET_RAIDCOLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0xD330800)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_SHOWCOLLECTIONNEW_OFFSET UNITYSDK_OFFSET(0xD330710)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD330540)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA__ONINIT_OFFSET UNITYSDK_OFFSET(0xD330550)
