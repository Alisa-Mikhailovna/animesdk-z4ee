...
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLWINDOWSERVICE_OPENDISPLAYWINDOW_1_OFFSET UNITYSDK_OFFSET(0xC8BE1C0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLWINDOWSERVICE_OPENDISPLAYWINDOW_OFFSET UNITYSDK_OFFSET(0xC8BDF80)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLWINDOWSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xC8BE240)

namespace RPG::Client::HimekoNovaSpecialSkill
{
	inline static constexpr unsigned int HimekoNovaSpecialSkillWindowService_TypeDefinitionIndex = 75552;
