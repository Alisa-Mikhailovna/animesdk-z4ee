...
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL_GET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xC8B4ED0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL_SET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xC8B4FB0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC8B51F0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC8B50C0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC8B5020)

namespace RPG::Client::HimekoNovaSpecialSkill
{
	inline static constexpr unsigned int HimekoNovaSpecialSkillDisplayIconControl_TypeDefinitionIndex = 75555;
