...
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GETDISPLAYSKILLNAME_OFFSET UNITYSDK_OFFSET(0xC8B4120)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GETMAINSKILLNAME_OFFSET UNITYSDK_OFFSET(0xC8B4440)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GETSKILLICON_OFFSET UNITYSDK_OFFSET(0xC8B42D0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GETSKILLROWDATA_OFFSET UNITYSDK_OFFSET(0xC8B40E0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_AVATARIDS_OFFSET UNITYSDK_OFFSET(0xC8B4070)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC8B4030)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xC8B4060)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_SIMPLIFIEDAVATARIDS_OFFSET UNITYSDK_OFFSET(0xC8B4080)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xC8B4040)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0xC8B4050)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_SKILLROWDATA_OFFSET UNITYSDK_OFFSET(0xC8B4090)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_LOADALL_OFFSET UNITYSDK_OFFSET(0xC8B45C0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC8B40A0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA__RESOLVEAVATARIDS_OFFSET UNITYSDK_OFFSET(0xC8B4CA0)

namespace RPG::Client::HimekoNovaSpecialSkill
{
	inline static constexpr unsigned int HimekoNovaSpecialSkillData_TypeDefinitionIndex = 75550;
