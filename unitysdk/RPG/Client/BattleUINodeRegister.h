...
#define RPG_CLIENT_BATTLEUINODEREGISTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xBE9CD50)
#define RPG_CLIENT_BATTLEUINODEREGISTER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBE9D190)
#define RPG_CLIENT_BATTLEUINODEREGISTER_METHOD_5_1F0134B562731ABF_OFFSET UNITYSDK_OFFSET(0xBE9D400)
#define RPG_CLIENT_BATTLEUINODEREGISTER_METHOD_5_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xBE9CE30)
#define RPG_CLIENT_BATTLEUINODEREGISTER_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xBE9D070)
#define RPG_CLIENT_BATTLEUINODEREGISTER_METHOD_5_F662791A0BE6B9AA_OFFSET UNITYSDK_OFFSET(0xBE9D280)
#define RPG_CLIENT_BATTLEUINODEREGISTER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBE9CEE0)
#define RPG_CLIENT_BATTLEUINODEREGISTER_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBE9D140)
#define RPG_CLIENT_BATTLEUINODEREGISTER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE9D450)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleUINodeRegister_TypeDefinitionIndex = 69032;
