...
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_GET_ISPLAYERENTERED_OFFSET UNITYSDK_OFFSET(0xCC3D860)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_METHOD_5_C117F1BAC122F4D0_OFFSET UNITYSDK_OFFSET(0xCC3DB30)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xCC3DA40)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xCC3DC20)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0xCC3DC90)
