...
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EFFECTDATA_OFFSET UNITYSDK_OFFSET(0xC1251A0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EFFECTID_OFFSET UNITYSDK_OFFSET(0xC130830)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EQUIPMENTATTACK_OFFSET UNITYSDK_OFFSET(0xC124300)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EQUIPMENTHEALTH_OFFSET UNITYSDK_OFFSET(0xC124530)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EQUIPMENTICON_OFFSET UNITYSDK_OFFSET(0xC130CF0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC130630)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_ISMULTITARGET_OFFSET UNITYSDK_OFFSET(0xC130880)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC130680)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_PRICE_OFFSET UNITYSDK_OFFSET(0xC128750)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xC130740)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_SHOPICON_OFFSET UNITYSDK_OFFSET(0xC130CA0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_SKILLDATA_OFFSET UNITYSDK_OFFSET(0xC130950)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0xC1307E0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC1306F0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_VENDOR_OFFSET UNITYSDK_OFFSET(0xC130790)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC130620)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xC130D40)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYGETBATTLESKILLDATA_OFFSET UNITYSDK_OFFSET(0xC131120)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYGETSHOPSKILLDATA_OFFSET UNITYSDK_OFFSET(0xC130FD0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYGETSKILLDATAFORDISPLAY_OFFSET UNITYSDK_OFFSET(0xC131270)
#define RPG_CLIENT_CHIMERADUELITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC130DC0)
#define RPG_CLIENT_CHIMERADUELITEMDATA__TRYGETFIRSTSKILLDATA_OFFSET UNITYSDK_OFFSET(0xC130E00)
