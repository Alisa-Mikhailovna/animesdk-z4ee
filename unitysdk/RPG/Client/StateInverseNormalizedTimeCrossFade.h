...
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD55CC90)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_METHOD_4_5D78D43F96BE4E52_OFFSET UNITYSDK_OFFSET(0xD55CDF0)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_METHOD_4_B9ACD9B7FC591188_OFFSET UNITYSDK_OFFSET(0xD55CEF0)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD55CD00)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE__CTOR_OFFSET UNITYSDK_OFFSET(0xD55D030)
