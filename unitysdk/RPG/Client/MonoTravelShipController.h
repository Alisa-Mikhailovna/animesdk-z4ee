...
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD2DCA0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xCD2DD50)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0xCD2E7F0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_DEFAULTROTATEROLLFLAG_OFFSET UNITYSDK_OFFSET(0xCD2E810)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0xCD2E730)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MAXRIGIDBODYROTPITCH_OFFSET UNITYSDK_OFFSET(0xCD2E700)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0xCD2E710)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MOVEPROXY_OFFSET UNITYSDK_OFFSET(0xCD2E770)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_PROXY_OFFSET UNITYSDK_OFFSET(0xCD2E750)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xCD2E650)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONBIND_OFFSET UNITYSDK_OFFSET(0xCD2E070)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONUNBIND_OFFSET UNITYSDK_OFFSET(0xCD2E1F0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xCD2E350)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0xCD2E800)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEROLLFLAG_OFFSET UNITYSDK_OFFSET(0xCD2E820)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0xCD2E740)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0xCD2E720)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_PROXY_OFFSET UNITYSDK_OFFSET(0xCD2E760)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD2E830)
