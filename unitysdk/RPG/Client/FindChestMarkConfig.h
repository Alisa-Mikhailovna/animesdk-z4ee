...
#define RPG_CLIENT_FINDCHESTMARKCONFIG_GETGOTOMAPPARAM_OFFSET UNITYSDK_OFFSET(0x149B90)
#define RPG_CLIENT_FINDCHESTMARKCONFIG_GETICONATTACHCONFIG_OFFSET UNITYSDK_OFFSET(0x149BA0)
#define RPG_CLIENT_FINDCHESTMARKCONFIG__CHECKNEEDREPLACE_OFFSET UNITYSDK_OFFSET(0x149BB0)
#define RPG_CLIENT_FINDCHESTMARKCONFIG__GETCHESTGROUPPROPERTYROW_OFFSET UNITYSDK_OFFSET(0x149BC0)
