...
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_FORMATDISPLAYDATABYTYPE_OFFSET UNITYSDK_OFFSET(0xBCF2CF0)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GETAETHERMONSTERAVATARBASEVALUE_OFFSET UNITYSDK_OFFSET(0xBCF2310)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GETBASEVALUE_OFFSET UNITYSDK_OFFSET(0xBCF23A0)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GETFINALVALUE_OFFSET UNITYSDK_OFFSET(0xBCF1A80)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GETPROPERTYADDVALUE_OFFSET UNITYSDK_OFFSET(0xBCF2BD0)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GET__AETHERMONSTERAVATARDATA_OFFSET UNITYSDK_OFFSET(0xBCF2F20)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_SETMODIFER_OFFSET UNITYSDK_OFFSET(0xBCF1A10)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_SET__AETHERMONSTERAVATARDATA_OFFSET UNITYSDK_OFFSET(0xBCF2F30)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBCEF7B0)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA__GETPROPERTYEXCELBASEDATA_OFFSET UNITYSDK_OFFSET(0xBCF29C0)
