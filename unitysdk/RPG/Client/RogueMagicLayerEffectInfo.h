...
#define RPG_CLIENT_ROGUEMAGICLAYEREFFECTINFO_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD3BEAC0)
#define RPG_CLIENT_ROGUEMAGICLAYEREFFECTINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0xD3BE850)
#define RPG_CLIENT_ROGUEMAGICLAYEREFFECTINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD3BEA20)
#define RPG_CLIENT_ROGUEMAGICLAYEREFFECTINFO_GET_NEEDCONSUMEROUND_OFFSET UNITYSDK_OFFSET(0xD3BEBA0)
#define RPG_CLIENT_ROGUEMAGICLAYEREFFECTINFO_GET_ROW_OFFSET UNITYSDK_OFFSET(0xD3BE870)
#define RPG_CLIENT_ROGUEMAGICLAYEREFFECTINFO_SET_ID_OFFSET UNITYSDK_OFFSET(0xD3BE860)
#define RPG_CLIENT_ROGUEMAGICLAYEREFFECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD3BABC0)
