...
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCCD2A10)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_GET_ANIMLAYERWEIGHT_OFFSET UNITYSDK_OFFSET(0xCCD2D80)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_GET_ANIMPARAMS_OFFSET UNITYSDK_OFFSET(0xCCD2DE0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ONAUDIOLANGUAGECHANGED_OFFSET UNITYSDK_OFFSET(0xCCD2AD0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCCD2A70)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0xCCD2B60)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_SETUPFRAMEDELTATIME_OFFSET UNITYSDK_OFFSET(0xCCD2C90)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_STOP_OFFSET UNITYSDK_OFFSET(0xCCD2BF0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xCCD2D10)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCCD2E50)
