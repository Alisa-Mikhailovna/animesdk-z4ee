...
#define RPG_CLIENT_UISETTMPATTRIBUTE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD806C70)
#define RPG_CLIENT_UISETTMPATTRIBUTE_GETCENTERPOS_OFFSET UNITYSDK_OFFSET(0xD8091F0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD807470)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_08DCF72FBE01FF99_OFFSET UNITYSDK_OFFSET(0xD808020)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_2C825E716CE9F2F9_OFFSET UNITYSDK_OFFSET(0xD807BF0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_2D1DFA4BDF5C46E6_OFFSET UNITYSDK_OFFSET(0xD808D00)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0xD808E60)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0xD807670)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xD809350)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD8078B0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0xD8079D0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xD8071A0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_F8E46181794760A4_OFFSET UNITYSDK_OFFSET(0xD808590)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_FE72BF2F281C4FA8_OFFSET UNITYSDK_OFFSET(0xD809070)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD806DB0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD807320)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD806FB0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0xD807930)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUITEXTCHANGEFONTFROMCONDENSETOCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD8090C0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUITEXTLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0xD809000)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUITEXTSWITCH_OFFSET UNITYSDK_OFFSET(0xD809100)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUIWORLDFONTCHANGE_OFFSET UNITYSDK_OFFSET(0xD809150)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0xD807810)
#define RPG_CLIENT_UISETTMPATTRIBUTE_RESETFONTSIZE_OFFSET UNITYSDK_OFFSET(0xD807ED0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETCONFIGSHOW_OFFSET UNITYSDK_OFFSET(0xD808220)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETCUSTOMGETSDFASSETPATHDELEGATE_OFFSET UNITYSDK_OFFSET(0xD8091A0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETFACETOCAMERA_OFFSET UNITYSDK_OFFSET(0xD8081D0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETFONTSIZE_OFFSET UNITYSDK_OFFSET(0xD807E60)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDEALIGNTYPE_OFFSET UNITYSDK_OFFSET(0xD8082E0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDEFONTASSET_OFFSET UNITYSDK_OFFSET(0xD808430)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDEISKAOMOJI_OFFSET UNITYSDK_OFFSET(0xD808510)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDESCALE_OFFSET UNITYSDK_OFFSET(0xD807F70)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETTEXTID_OFFSET UNITYSDK_OFFSET(0xD807B90)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETTEXT_OFFSET UNITYSDK_OFFSET(0xD807DF0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_START_OFFSET UNITYSDK_OFFSET(0xD807430)
#define RPG_CLIENT_UISETTMPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xD8094A0)
#define RPG_CLIENT_UISETTMPATTRIBUTE__SHUFFLE_OFFSET UNITYSDK_OFFSET(0xD808F00)
