...
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC469940)
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION_GET_MASTERITEMLIST_OFFSET UNITYSDK_OFFSET(0xC469FE0)
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC469C70)
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION__GENERATEMASTERHANDBOOKLIST_OFFSET UNITYSDK_OFFSET(0xC469C80)
