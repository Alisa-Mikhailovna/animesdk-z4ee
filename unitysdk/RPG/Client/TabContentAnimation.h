...
#define RPG_CLIENT_TABCONTENTANIMATION_GET_FROMBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xD608C50)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_FROMFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xD608B60)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_TOBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xD608A70)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_TOFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xD608980)
#define RPG_CLIENT_TABCONTENTANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD608930)
#define RPG_CLIENT_TABCONTENTANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xD608D40)

namespace RPG::Client
{
	inline static constexpr unsigned int TabContentAnimation_TypeDefinitionIndex = 69521;
