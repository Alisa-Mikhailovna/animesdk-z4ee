...
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEMODULE___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBC69B90)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEMODULE___C__DISPLAYCLASS8_0__RETURNTOMAZE_B__0_OFFSET UNITYSDK_OFFSET(0xBC6C890)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEMODULE___C__DISPLAYCLASS8_0__RETURNTOMAZE_B__1_OFFSET UNITYSDK_OFFSET(0xBC6C9B0)
