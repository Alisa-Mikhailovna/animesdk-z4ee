...
#define RPG_CLIENT_LOOPSCENE_ADDATTACHMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0xCA29A30)
#define RPG_CLIENT_LOOPSCENE_AWAKE_OFFSET UNITYSDK_OFFSET(0xCA2A060)
#define RPG_CLIENT_LOOPSCENE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCA29C60)
#define RPG_CLIENT_LOOPSCENE_FINDMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0xCA29B10)
#define RPG_CLIENT_LOOPSCENE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xCA2A190)
#define RPG_CLIENT_LOOPSCENE_INIT_OFFSET UNITYSDK_OFFSET(0xCA29390)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xCA2A8B0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_283DA224BE06DA9F_1_OFFSET UNITYSDK_OFFSET(0xCA2A290)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0xCA2A240)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_601EF3E7226D7DC2_OFFSET UNITYSDK_OFFSET(0xCA2A140)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xCA2A920)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0xCA2A2E0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0xCA2A970)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_CFF8C0A3594A8E50_OFFSET UNITYSDK_OFFSET(0xCA2A4C0)
#define RPG_CLIENT_LOOPSCENE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCA2A0D0)
#define RPG_CLIENT_LOOPSCENE_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0xCA298C0)
#define RPG_CLIENT_LOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0xCA2AE20)
