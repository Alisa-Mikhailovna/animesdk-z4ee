...
#define RPG_CLIENT_MESSAGECONTENTPLAINTEXTBLOCK_BYCONTENT_OFFSET UNITYSDK_OFFSET(0xCBAA650)
#define RPG_CLIENT_MESSAGECONTENTPLAINTEXTBLOCK_BYTEXTID_OFFSET UNITYSDK_OFFSET(0xCBAA6C0)
#define RPG_CLIENT_MESSAGECONTENTPLAINTEXTBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0xCBAA730)
#define RPG_CLIENT_MESSAGECONTENTPLAINTEXTBLOCK_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xCBAA7F0)
#define RPG_CLIENT_MESSAGECONTENTPLAINTEXTBLOCK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCBAA600)
#define RPG_CLIENT_MESSAGECONTENTPLAINTEXTBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xCBAA6B0)
