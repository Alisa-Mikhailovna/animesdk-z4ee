...
#define RPG_CLIENT_MESSAGECONTENTSUGGESTIONBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0xCBABF30)
#define RPG_CLIENT_MESSAGECONTENTSUGGESTIONBLOCK_GET_SUGGESTIONS_OFFSET UNITYSDK_OFFSET(0xCBAC0E0)
#define RPG_CLIENT_MESSAGECONTENTSUGGESTIONBLOCK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCBABED0)
#define RPG_CLIENT_MESSAGECONTENTSUGGESTIONBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xCBABF20)
