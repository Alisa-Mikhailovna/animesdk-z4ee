...
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP_REFRESHAFTERENTERBATTLENEW_OFFSET UNITYSDK_OFFSET(0xBE4C6E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP_REFRESHBEFOREENTERBATTLENEW_OFFSET UNITYSDK_OFFSET(0xBE4C570)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__COLLECTRESOURCEIMPL_OFFSET UNITYSDK_OFFSET(0xBE4BF50)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xBE4C850)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__GETDEFAULTBATTLEMODELPATH_OFFSET UNITYSDK_OFFSET(0xBE4C480)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xBE4BDC0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0xBE4BAE0)
