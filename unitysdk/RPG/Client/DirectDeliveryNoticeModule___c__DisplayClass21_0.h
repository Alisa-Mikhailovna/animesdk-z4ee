...
#define RPG_CLIENT_DIRECTDELIVERYNOTICEMODULE___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC2AC3F0)
#define RPG_CLIENT_DIRECTDELIVERYNOTICEMODULE___C__DISPLAYCLASS21_0___ONCANCELDIRECTDELIVERYNOTICESCRSP_B__0_OFFSET UNITYSDK_OFFSET(0xC2ACD70)
#define RPG_CLIENT_DIRECTDELIVERYNOTICEMODULE___C__DISPLAYCLASS21_0___ONCANCELDIRECTDELIVERYNOTICESCRSP_B__1_OFFSET UNITYSDK_OFFSET(0xC2ACDF0)
