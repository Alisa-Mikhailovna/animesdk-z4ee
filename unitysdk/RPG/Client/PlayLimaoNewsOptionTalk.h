...
#define RPG_CLIENT_PLAYLIMAONEWSOPTIONTALK_METHOD_3_936C50083A1FD7D4_OFFSET UNITYSDK_OFFSET(0x1B0E9C80)
#define RPG_CLIENT_PLAYLIMAONEWSOPTIONTALK_METHOD_3_FA1FA81F6F6DF62F_OFFSET UNITYSDK_OFFSET(0x1B0E9C40)
#define RPG_CLIENT_PLAYLIMAONEWSOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E9C70)
