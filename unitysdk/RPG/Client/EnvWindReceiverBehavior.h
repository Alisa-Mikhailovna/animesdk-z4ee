...
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_AABB_OFFSET UNITYSDK_OFFSET(0xC3D3260)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0xC3D32B0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_SELECTED_OFFSET UNITYSDK_OFFSET(0xC3D3240)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0xC3D3290)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xC3D5240)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0xC3D6320)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0xC3D7620)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_0C6D78F7FB2736C2_OFFSET UNITYSDK_OFFSET(0xC3D7A40)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xC3D6590)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2C9E083DC9C549F9_OFFSET UNITYSDK_OFFSET(0xC3D6A40)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_34AFF6E2F5322D1D_OFFSET UNITYSDK_OFFSET(0xC3D6AC0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC3D7B20)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC3D7AB0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0xC3D6C20)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_ACD91D865E237BC7_OFFSET UNITYSDK_OFFSET(0xC3D6970)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_B06F516E4459C742_1_OFFSET UNITYSDK_OFFSET(0xC3D7180)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_B06F516E4459C742_OFFSET UNITYSDK_OFFSET(0xC3D3320)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_BF622B900A7F3625_OFFSET UNITYSDK_OFFSET(0xC3D75A0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_C796A0B42720FBD3_OFFSET UNITYSDK_OFFSET(0xC3D73B0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E876C8B6D3B840A6_1_OFFSET UNITYSDK_OFFSET(0xC3D7980)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0xC3D3570)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_ED79705457B92B5C_OFFSET UNITYSDK_OFFSET(0xC3D32D0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_AABB_OFFSET UNITYSDK_OFFSET(0xC3D3280)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0xC3D32C0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_SELECTED_OFFSET UNITYSDK_OFFSET(0xC3D3250)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0xC3D32A0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xC3D6BC0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xC3D7BB0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC3D7B90)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x14760);
		}
		static ::System::Int32* StaticGet__AABBSizeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x14764);
		}
		static ::System::Int32* StaticGet__FlagWaveAmplitudeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x14768);
		}
		static ::System::Int32* StaticGet__WindVelocityID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x1476C);
		}
