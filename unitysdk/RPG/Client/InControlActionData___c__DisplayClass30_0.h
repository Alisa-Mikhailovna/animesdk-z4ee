...
#define RPG_CLIENT_INCONTROLACTIONDATA___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC8D0010)
#define RPG_CLIENT_INCONTROLACTIONDATA___C__DISPLAYCLASS30_0__SWITCHDEFAULTSUBMITANDCANCEL_B__0_OFFSET UNITYSDK_OFFSET(0xC8D1B20)
