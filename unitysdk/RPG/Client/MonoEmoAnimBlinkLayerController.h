...
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCCD2540)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_BEGINIDLE_OFFSET UNITYSDK_OFFSET(0xCCD2820)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ENABLEAUTOBLINK_OFFSET UNITYSDK_OFFSET(0xCCD2870)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_GETBLINKWEIGHT_OFFSET UNITYSDK_OFFSET(0xCCD2980)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCCD26C0)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCCD25E0)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xCCD2730)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0xCCD27B0)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xCCD28E0)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCCD29D0)
