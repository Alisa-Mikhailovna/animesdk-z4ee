...
#define RPG_CLIENT_MATCHTHREEBOARD_ADD_ONBOARDDESTROY_OFFSET UNITYSDK_OFFSET(0xCB3F630)
#define RPG_CLIENT_MATCHTHREEBOARD_ADD_ONPAUSE_OFFSET UNITYSDK_OFFSET(0xCB3F710)
#define RPG_CLIENT_MATCHTHREEBOARD_ADD_ONPROPINPUT_OFFSET UNITYSDK_OFFSET(0xCB3FFC0)
#define RPG_CLIENT_MATCHTHREEBOARD_ADD_ONSWITCH_OFFSET UNITYSDK_OFFSET(0xCB3F550)
#define RPG_CLIENT_MATCHTHREEBOARD_CREATEBOARD_OFFSET UNITYSDK_OFFSET(0xCB35FD0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOCREATEGRIDONBOARD_OFFSET UNITYSDK_OFFSET(0xCB389E0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOCREATEPIECEBYDROPPATH_OFFSET UNITYSDK_OFFSET(0xCB38670)
#define RPG_CLIENT_MATCHTHREEBOARD_DOCREATEPIECEONBOARD_OFFSET UNITYSDK_OFFSET(0xCB37ED0)
#define RPG_CLIENT_MATCHTHREEBOARD_DODROPPIECEPATH_OFFSET UNITYSDK_OFFSET(0xCB39370)
#define RPG_CLIENT_MATCHTHREEBOARD_DOENERGYFADEEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3D0D0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOFLYEFFECTFROMPIECETOPROP_OFFSET UNITYSDK_OFFSET(0xCB3B730)
#define RPG_CLIENT_MATCHTHREEBOARD_DOFLYEFFECTFROMPROPTOPIECE_OFFSET UNITYSDK_OFFSET(0xCB3B420)
#define RPG_CLIENT_MATCHTHREEBOARD_DOFLYEFFECTFROMSKILLTOPROP_OFFSET UNITYSDK_OFFSET(0xCB3AFD0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOFLYEFFECTFROMSKILL_OFFSET UNITYSDK_OFFSET(0xCB3AC20)
#define RPG_CLIENT_MATCHTHREEBOARD_DOFLYEFFECTTOSKILL_OFFSET UNITYSDK_OFFSET(0xCB3B960)
#define RPG_CLIENT_MATCHTHREEBOARD_DOFLYEFFECTTOSTEP_OFFSET UNITYSDK_OFFSET(0xCB3BD90)
#define RPG_CLIENT_MATCHTHREEBOARD_DOFLYEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3A950)
#define RPG_CLIENT_MATCHTHREEBOARD_DOMATCHPIECE_OFFSET UNITYSDK_OFFSET(0xCB39470)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPAUSE_OFFSET UNITYSDK_OFFSET(0xCB3F4C0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPLAYALLSCREENBOMBEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3C760)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPLAYBOMBEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3C3F0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPLAYCOPYPIECEEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3C050)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPLAYMULTISTYLEBOMBEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3C9A0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPLAYPOWERCOUNTER_OFFSET UNITYSDK_OFFSET(0xCB3CCB0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPLAYPROPBUBBLEEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3CB40)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPLAYREFRESHEFFECT_OFFSET UNITYSDK_OFFSET(0xCB39190)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPLAYSTEPBONUSTEXT_OFFSET UNITYSDK_OFFSET(0xCB3F320)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPROPCANCEL_OFFSET UNITYSDK_OFFSET(0xCB3FD70)
#define RPG_CLIENT_MATCHTHREEBOARD_DOPROPUSE_OFFSET UNITYSDK_OFFSET(0xCB3F9F0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOREFRESHGRID_OFFSET UNITYSDK_OFFSET(0xCB38B90)
#define RPG_CLIENT_MATCHTHREEBOARD_DOREFRESHPIECE_OFFSET UNITYSDK_OFFSET(0xCB38FC0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOREMOVEGRID_OFFSET UNITYSDK_OFFSET(0xCB3A840)
#define RPG_CLIENT_MATCHTHREEBOARD_DOREMOVEPIECE_OFFSET UNITYSDK_OFFSET(0xCB39CE0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOSETBOARDENVTAG_OFFSET UNITYSDK_OFFSET(0xCB3D5D0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOSHAKEPIECE_OFFSET UNITYSDK_OFFSET(0xCB39AC0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOSKILLTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0xCB3D3B0)
#define RPG_CLIENT_MATCHTHREEBOARD_DOSTOPSHAKEPIECE_OFFSET UNITYSDK_OFFSET(0xCB39C10)
#define RPG_CLIENT_MATCHTHREEBOARD_DOSWITCHPIECE_OFFSET UNITYSDK_OFFSET(0xCB39E50)
#define RPG_CLIENT_MATCHTHREEBOARD_GETEFFECTSCALE_OFFSET UNITYSDK_OFFSET(0xCB3E1E0)
#define RPG_CLIENT_MATCHTHREEBOARD_GETPIECESIZE_OFFSET UNITYSDK_OFFSET(0xCB3E190)
#define RPG_CLIENT_MATCHTHREEBOARD_GET_CURRENTACTIONROLE_OFFSET UNITYSDK_OFFSET(0xCB400A0)
#define RPG_CLIENT_MATCHTHREEBOARD_GET_EMPTYSKILLICONRECTTRANSFORMENEMY_OFFSET UNITYSDK_OFFSET(0xCB3F830)
#define RPG_CLIENT_MATCHTHREEBOARD_GET_EMPTYSKILLICONRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCB3F810)
#define RPG_CLIENT_MATCHTHREEBOARD_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xCB3F7F0)
#define RPG_CLIENT_MATCHTHREEBOARD_GET_SELECTIONPIECE_OFFSET UNITYSDK_OFFSET(0xCB3F530)
#define RPG_CLIENT_MATCHTHREEBOARD_GET__CANINPUT_OFFSET UNITYSDK_OFFSET(0xCB3FB30)
#define RPG_CLIENT_MATCHTHREEBOARD_INDEX2POSITION_1_OFFSET UNITYSDK_OFFSET(0xCB3DEE0)
#define RPG_CLIENT_MATCHTHREEBOARD_INDEX2POSITION_OFFSET UNITYSDK_OFFSET(0xCB3DDE0)
#define RPG_CLIENT_MATCHTHREEBOARD_INDEX2WORLDPOSITION_1_OFFSET UNITYSDK_OFFSET(0xCB3E010)
#define RPG_CLIENT_MATCHTHREEBOARD_INDEX2WORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xCB3DF80)
#define RPG_CLIENT_MATCHTHREEBOARD_INITBOARD_OFFSET UNITYSDK_OFFSET(0xCB33B00)
#define RPG_CLIENT_MATCHTHREEBOARD_ISPROPUSEORPROPSELECTION_OFFSET UNITYSDK_OFFSET(0xCB3DB60)
#define RPG_CLIENT_MATCHTHREEBOARD_ISSELECTIONSTATESELECTED_OFFSET UNITYSDK_OFFSET(0xCB3DAE0)
#define RPG_CLIENT_MATCHTHREEBOARD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCB33780)
#define RPG_CLIENT_MATCHTHREEBOARD_ONDRAG_OFFSET UNITYSDK_OFFSET(0xCB36010)
#define RPG_CLIENT_MATCHTHREEBOARD_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCB357F0)
#define RPG_CLIENT_MATCHTHREEBOARD_ONINPUTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xCB3DA40)
#define RPG_CLIENT_MATCHTHREEBOARD_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xCB36870)
#define RPG_CLIENT_MATCHTHREEBOARD_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xCB37210)
#define RPG_CLIENT_MATCHTHREEBOARD_PLAYENEMYSWITCHTIPEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3A1D0)
#define RPG_CLIENT_MATCHTHREEBOARD_REMOVE_ONBOARDDESTROY_OFFSET UNITYSDK_OFFSET(0xCB3F6A0)
#define RPG_CLIENT_MATCHTHREEBOARD_REMOVE_ONPAUSE_OFFSET UNITYSDK_OFFSET(0xCB3F780)
#define RPG_CLIENT_MATCHTHREEBOARD_REMOVE_ONPROPINPUT_OFFSET UNITYSDK_OFFSET(0xCB40030)
#define RPG_CLIENT_MATCHTHREEBOARD_REMOVE_ONSWITCH_OFFSET UNITYSDK_OFFSET(0xCB3F5C0)
#define RPG_CLIENT_MATCHTHREEBOARD_SETMOTIONTIMESCALE_OFFSET UNITYSDK_OFFSET(0xCB3DCB0)
#define RPG_CLIENT_MATCHTHREEBOARD_SETSELECTIONSTATESELECTED_OFFSET UNITYSDK_OFFSET(0xCB37B40)
#define RPG_CLIENT_MATCHTHREEBOARD_SETSELECTIONSTATEVISIBLE_OFFSET UNITYSDK_OFFSET(0xCB3D710)
#define RPG_CLIENT_MATCHTHREEBOARD_SET_CURRENTACTIONROLE_OFFSET UNITYSDK_OFFSET(0xCB400B0)
#define RPG_CLIENT_MATCHTHREEBOARD_SET_EMPTYSKILLICONRECTTRANSFORMENEMY_OFFSET UNITYSDK_OFFSET(0xCB3F840)
#define RPG_CLIENT_MATCHTHREEBOARD_SET_EMPTYSKILLICONRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCB3F820)
#define RPG_CLIENT_MATCHTHREEBOARD_SET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xCB3F800)
#define RPG_CLIENT_MATCHTHREEBOARD_SET_SELECTIONPIECE_OFFSET UNITYSDK_OFFSET(0xCB3F540)
#define RPG_CLIENT_MATCHTHREEBOARD__ASSERTEMPTYPIECE_OFFSET UNITYSDK_OFFSET(0xCB3E250)
#define RPG_CLIENT_MATCHTHREEBOARD__ASSETEMPTYGRID_OFFSET UNITYSDK_OFFSET(0xCB38B40)
#define RPG_CLIENT_MATCHTHREEBOARD__BEGINDRAGTUTORIAL_OFFSET UNITYSDK_OFFSET(0xCB3EAC0)
#define RPG_CLIENT_MATCHTHREEBOARD__CANMOVESELECTIONSTATE_OFFSET UNITYSDK_OFFSET(0xCB37940)
#define RPG_CLIENT_MATCHTHREEBOARD__CANSWITCH_OFFSET UNITYSDK_OFFSET(0xCB3EEF0)
#define RPG_CLIENT_MATCHTHREEBOARD__CHANGEPIECEPOSTO_OFFSET UNITYSDK_OFFSET(0xCB3E370)
#define RPG_CLIENT_MATCHTHREEBOARD__CLEARACTIVEPROP_OFFSET UNITYSDK_OFFSET(0xCB3FBC0)
#define RPG_CLIENT_MATCHTHREEBOARD__CLEARPROPINPUT_OFFSET UNITYSDK_OFFSET(0xCB3F8D0)
#define RPG_CLIENT_MATCHTHREEBOARD__CREATESELECTIONSTATE_OFFSET UNITYSDK_OFFSET(0xCB35510)
#define RPG_CLIENT_MATCHTHREEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xCB400C0)
#define RPG_CLIENT_MATCHTHREEBOARD__DESTROYPROPPANEL_OFFSET UNITYSDK_OFFSET(0xCB33940)
#define RPG_CLIENT_MATCHTHREEBOARD__DETERMINEDIR_OFFSET UNITYSDK_OFFSET(0xCB365A0)
#define RPG_CLIENT_MATCHTHREEBOARD__ENDDRAGTUTORIAL_OFFSET UNITYSDK_OFFSET(0xCB3EE60)
#define RPG_CLIENT_MATCHTHREEBOARD__GETBOMBCREATEEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3E7B0)
#define RPG_CLIENT_MATCHTHREEBOARD__GETBOMBEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3C8C0)
#define RPG_CLIENT_MATCHTHREEBOARD__GETENERGYFADEEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3D1F0)
#define RPG_CLIENT_MATCHTHREEBOARD__GETFLASHEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3BC20)
#define RPG_CLIENT_MATCHTHREEBOARD__GETGEMPOUCHFLYEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3AB40)
#define RPG_CLIENT_MATCHTHREEBOARD__GETGRIDBREAKEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3E650)
#define RPG_CLIENT_MATCHTHREEBOARD__GETGRIDBYINDEX_OFFSET UNITYSDK_OFFSET(0xCB38DC0)
#define RPG_CLIENT_MATCHTHREEBOARD__GETLOCALPOINT_OFFSET UNITYSDK_OFFSET(0xCB36450)
#define RPG_CLIENT_MATCHTHREEBOARD__GETLOOPEFFECTBYINDEX_OFFSET UNITYSDK_OFFSET(0xCB3E8D0)
#define RPG_CLIENT_MATCHTHREEBOARD__GETMATCHEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3E4D0)
#define RPG_CLIENT_MATCHTHREEBOARD__GETMULTISTYLEBOMBFLASHEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3BD00)
#define RPG_CLIENT_MATCHTHREEBOARD__GETPIECEBYINDEX_OFFSET UNITYSDK_OFFSET(0xCB35F20)
#define RPG_CLIENT_MATCHTHREEBOARD__GETPIECEBYLOCALPOINT_OFFSET UNITYSDK_OFFSET(0xCB36D40)
#define RPG_CLIENT_MATCHTHREEBOARD__GETPOWERCOUNTERSIZECONFIG_OFFSET UNITYSDK_OFFSET(0xCB3CF50)
#define RPG_CLIENT_MATCHTHREEBOARD__GETPOWERCOUNTER_OFFSET UNITYSDK_OFFSET(0xCB3D040)
#define RPG_CLIENT_MATCHTHREEBOARD__GETREFRESHEFFECT_OFFSET UNITYSDK_OFFSET(0xCB392E0)
#define RPG_CLIENT_MATCHTHREEBOARD__GETSKILLTRAILEFFECTBYSKILLID_OFFSET UNITYSDK_OFFSET(0xCB3AEF0)
#define RPG_CLIENT_MATCHTHREEBOARD__GETSKILLTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0xCB3D540)
#define RPG_CLIENT_MATCHTHREEBOARD__GETSTEPTRAILEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3BFC0)
#define RPG_CLIENT_MATCHTHREEBOARD__INITPROPPANEL_OFFSET UNITYSDK_OFFSET(0xCB35620)
#define RPG_CLIENT_MATCHTHREEBOARD__ISDRAGABLE_OFFSET UNITYSDK_OFFSET(0xCB3DBB0)
#define RPG_CLIENT_MATCHTHREEBOARD__ISNEIGHBORS_OFFSET UNITYSDK_OFFSET(0xCB3E980)
#define RPG_CLIENT_MATCHTHREEBOARD__ISPIECESELECTABLE_OFFSET UNITYSDK_OFFSET(0xCB383D0)
#define RPG_CLIENT_MATCHTHREEBOARD__LOCALPOINT2INDEX_OFFSET UNITYSDK_OFFSET(0xCB36E20)
#define RPG_CLIENT_MATCHTHREEBOARD__MOVEPIECEPATH_OFFSET UNITYSDK_OFFSET(0xCB387E0)
#define RPG_CLIENT_MATCHTHREEBOARD__MOVESELECTIONSTATE_OFFSET UNITYSDK_OFFSET(0xCB37A00)
#define RPG_CLIENT_MATCHTHREEBOARD__ONCHESSBOARDINPUTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xCB3FA60)
#define RPG_CLIENT_MATCHTHREEBOARD__ONDRAGTUTORIAL_OFFSET UNITYSDK_OFFSET(0xCB3EA00)
#define RPG_CLIENT_MATCHTHREEBOARD__ONGRIDBASEDMOVE_OFFSET UNITYSDK_OFFSET(0xCB37720)
#define RPG_CLIENT_MATCHTHREEBOARD__ONONEONONEDATACHANGE_OFFSET UNITYSDK_OFFSET(0xCB3F850)
#define RPG_CLIENT_MATCHTHREEBOARD__ONPROPBUTTONCANCEL_OFFSET UNITYSDK_OFFSET(0xCB3FDC0)
#define RPG_CLIENT_MATCHTHREEBOARD__ONPROPBUTTONOK_OFFSET UNITYSDK_OFFSET(0xCB3FC10)
#define RPG_CLIENT_MATCHTHREEBOARD__ONPROPINPUTCONSUMED_OFFSET UNITYSDK_OFFSET(0xCB3F9A0)
#define RPG_CLIENT_MATCHTHREEBOARD__ONPROPINPUTDISCARDED_OFFSET UNITYSDK_OFFSET(0xCB373D0)
#define RPG_CLIENT_MATCHTHREEBOARD__ONPROPUSE_OFFSET UNITYSDK_OFFSET(0xCB3FEB0)
#define RPG_CLIENT_MATCHTHREEBOARD__ONSCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xCB35ED0)
#define RPG_CLIENT_MATCHTHREEBOARD__PLAYBOARDSHAKEANIM_OFFSET UNITYSDK_OFFSET(0xCB3E710)
#define RPG_CLIENT_MATCHTHREEBOARD__PLAYBOMBCREATEEFFECT_OFFSET UNITYSDK_OFFSET(0xCB382A0)
#define RPG_CLIENT_MATCHTHREEBOARD__PLAYBOMBMATCHEDEFFECT_OFFSET UNITYSDK_OFFSET(0xCB3C460)
#define RPG_CLIENT_MATCHTHREEBOARD__PLAYGRIDBREAKEFFECT_OFFSET UNITYSDK_OFFSET(0xCB38E70)
#define RPG_CLIENT_MATCHTHREEBOARD__PLAYMATCHAUDIO_OFFSET UNITYSDK_OFFSET(0xCB397A0)
#define RPG_CLIENT_MATCHTHREEBOARD__PLAYMATCHEDEFFECT_OFFSET UNITYSDK_OFFSET(0xCB39940)
#define RPG_CLIENT_MATCHTHREEBOARD__REFRESHPIECEPOSITION_OFFSET UNITYSDK_OFFSET(0xCB35840)
#define RPG_CLIENT_MATCHTHREEBOARD__REGISTERSKILLTRAILEFFECT_OFFSET UNITYSDK_OFFSET(0xCB352A0)
#define RPG_CLIENT_MATCHTHREEBOARD__REMOVELOOPEFFECT_OFFSET UNITYSDK_OFFSET(0xCB396D0)
#define RPG_CLIENT_MATCHTHREEBOARD__RESETSELECTIONPIECESTATE_OFFSET UNITYSDK_OFFSET(0xCB376C0)
#define RPG_CLIENT_MATCHTHREEBOARD__RESETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xCB367A0)
#define RPG_CLIENT_MATCHTHREEBOARD__SELECTPIECE_OFFSET UNITYSDK_OFFSET(0xCB37130)
#define RPG_CLIENT_MATCHTHREEBOARD__SELECTPROPTARGET_1_OFFSET UNITYSDK_OFFSET(0xCB36EC0)
#define RPG_CLIENT_MATCHTHREEBOARD__SELECTPROPTARGET_2_OFFSET UNITYSDK_OFFSET(0xCB3F100)
#define RPG_CLIENT_MATCHTHREEBOARD__SELECTPROPTARGET_OFFSET UNITYSDK_OFFSET(0xCB37090)
#define RPG_CLIENT_MATCHTHREEBOARD__SETSELECTIONSTATEPIECEHOVER_OFFSET UNITYSDK_OFFSET(0xCB3D980)
#define RPG_CLIENT_MATCHTHREEBOARD__SETSTATE_OFFSET UNITYSDK_OFFSET(0xCB37380)
#define RPG_CLIENT_MATCHTHREEBOARD__SPAWNPIECELOOPEFFECT_OFFSET UNITYSDK_OFFSET(0xCB38160)
#define RPG_CLIENT_MATCHTHREEBOARD__SPAWNPIECE_OFFSET UNITYSDK_OFFSET(0xCB38020)
#define RPG_CLIENT_MATCHTHREEBOARD__SPAWNTEMPPIECE_OFFSET UNITYSDK_OFFSET(0xCB3E2A0)
#define RPG_CLIENT_MATCHTHREEBOARD__SWAPPIECEPOS_OFFSET UNITYSDK_OFFSET(0xCB39FD0)
#define RPG_CLIENT_MATCHTHREEBOARD__TRYNOTIFYRIGHTBUTTONDOWNONPROPUSE_OFFSET UNITYSDK_OFFSET(0xCB363D0)
#define RPG_CLIENT_MATCHTHREEBOARD__TRYSWITCH_OFFSET UNITYSDK_OFFSET(0xCB36690)
