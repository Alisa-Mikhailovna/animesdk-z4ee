...
#define RPG_CLIENT_MONODICECOMBATDICE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xCC50A80)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_063673DAD124345C_OFFSET UNITYSDK_OFFSET(0xCC50930)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_0706AD38EA2EAB79_OFFSET UNITYSDK_OFFSET(0xCC51780)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_0DA02645F51F0244_OFFSET UNITYSDK_OFFSET(0xCC51660)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_38BE73FE87B9CF1D_OFFSET UNITYSDK_OFFSET(0xCC51210)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xCC50FA0)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_8327FEEFBF3EC917_OFFSET UNITYSDK_OFFSET(0xCC50B80)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_EE6C603D16076D99_OFFSET UNITYSDK_OFFSET(0xCC50E00)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_EFF7FA8E1C5E8D3A_OFFSET UNITYSDK_OFFSET(0xCC50D50)
#define RPG_CLIENT_MONODICECOMBATDICE_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xCC508C0)
#define RPG_CLIENT_MONODICECOMBATDICE_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0xCC50A10)
#define RPG_CLIENT_MONODICECOMBATDICE_SETENABLE_OFFSET UNITYSDK_OFFSET(0xCC506C0)
#define RPG_CLIENT_MONODICECOMBATDICE_SETPERFORMANCECONFIGPROXY_OFFSET UNITYSDK_OFFSET(0xCC50870)
#define RPG_CLIENT_MONODICECOMBATDICE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC51910)
