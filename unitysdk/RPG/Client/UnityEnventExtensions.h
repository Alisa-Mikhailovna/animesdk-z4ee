...
#define RPG_CLIENT_UNITYENVENTEXTENSIONS_SAFEADDLISTENER_1_OFFSET UNITYSDK_OFFSET(0xD81CBF0)
#define RPG_CLIENT_UNITYENVENTEXTENSIONS_SAFEADDLISTENER_2_OFFSET UNITYSDK_OFFSET(0xD81CCA0)
#define RPG_CLIENT_UNITYENVENTEXTENSIONS_SAFEADDLISTENER_3_OFFSET UNITYSDK_OFFSET(0xD81CD50)
#define RPG_CLIENT_UNITYENVENTEXTENSIONS_SAFEADDLISTENER_4_OFFSET UNITYSDK_OFFSET(0xD81CE30)
#define RPG_CLIENT_UNITYENVENTEXTENSIONS_SAFEADDLISTENER_OFFSET UNITYSDK_OFFSET(0xD81CB50)

namespace RPG::Client
{
	inline static constexpr unsigned int UnityEnventExtensions_TypeDefinitionIndex = 69477;
