...
#define RPG_CLIENT_REGIONVOLUME_ADDEDGEWORLDPOS_OFFSET UNITYSDK_OFFSET(0xD2D9E60)
#define RPG_CLIENT_REGIONVOLUME_DELETEEDGE_OFFSET UNITYSDK_OFFSET(0xD2D9F10)
#define RPG_CLIENT_REGIONVOLUME_GETHEIGHT_OFFSET UNITYSDK_OFFSET(0xD2D85F0)
#define RPG_CLIENT_REGIONVOLUME_GETINSIDE_OFFSET UNITYSDK_OFFSET(0xD2D8CF0)
#define RPG_CLIENT_REGIONVOLUME_GETLOCALPOSITIONINSIDE_OFFSET UNITYSDK_OFFSET(0xD2D8E10)
#define RPG_CLIENT_REGIONVOLUME_GETLOCALSPACEBOTTOMFACE_1_OFFSET UNITYSDK_OFFSET(0xD2D9A00)
#define RPG_CLIENT_REGIONVOLUME_GETLOCALSPACEBOTTOMFACE_OFFSET UNITYSDK_OFFSET(0xD2D9960)
#define RPG_CLIENT_REGIONVOLUME_GETNAME_OFFSET UNITYSDK_OFFSET(0xD2D9FA0)
#define RPG_CLIENT_REGIONVOLUME_GETNORMAL_OFFSET UNITYSDK_OFFSET(0xD2D9430)
#define RPG_CLIENT_REGIONVOLUME_GETPIVOT_OFFSET UNITYSDK_OFFSET(0xD2D92B0)
#define RPG_CLIENT_REGIONVOLUME_GETROTATION_OFFSET UNITYSDK_OFFSET(0xD2D9370)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACEBOTTOMFACE_1_OFFSET UNITYSDK_OFFSET(0xD2D97D0)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACEBOTTOMFACE_OFFSET UNITYSDK_OFFSET(0xD2D9730)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACETOPFACE_1_OFFSET UNITYSDK_OFFSET(0xD2D9BC0)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACETOPFACE_OFFSET UNITYSDK_OFFSET(0xD2D9B20)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0xD2D8640)
#define RPG_CLIENT_REGIONVOLUME_GET_HIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xD2DA230)
#define RPG_CLIENT_REGIONVOLUME_LOAD_OFFSET UNITYSDK_OFFSET(0xD2D7D90)
#define RPG_CLIENT_REGIONVOLUME_LOCALTOWORLD_1_OFFSET UNITYSDK_OFFSET(0xD2D95D0)
#define RPG_CLIENT_REGIONVOLUME_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0xD2D8B60)
#define RPG_CLIENT_REGIONVOLUME_METHOD_5_27358BB662782B3E_OFFSET UNITYSDK_OFFSET(0xD2DA010)
#define RPG_CLIENT_REGIONVOLUME_METHOD_5_43D01116D59C5E43_OFFSET UNITYSDK_OFFSET(0xD2DA090)
#define RPG_CLIENT_REGIONVOLUME_METHOD_5_BBFF6C534C16DF1C_OFFSET UNITYSDK_OFFSET(0xD2DA110)
#define RPG_CLIENT_REGIONVOLUME_ONCHANGEMESH_OFFSET UNITYSDK_OFFSET(0xD2D82E0)
#define RPG_CLIENT_REGIONVOLUME_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xD2D77B0)
#define RPG_CLIENT_REGIONVOLUME_RANDOMHSV_OFFSET UNITYSDK_OFFSET(0xD2D7C30)
#define RPG_CLIENT_REGIONVOLUME_SETBOUNDS_OFFSET UNITYSDK_OFFSET(0xD2D88A0)
#define RPG_CLIENT_REGIONVOLUME_SETHEIGHT_OFFSET UNITYSDK_OFFSET(0xD2D8590)
#define RPG_CLIENT_REGIONVOLUME_SETLOCALSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0xD2D81C0)
#define RPG_CLIENT_REGIONVOLUME_SETWORLDSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0xD2D8950)
#define RPG_CLIENT_REGIONVOLUME_SET_HIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xD2DA240)
#define RPG_CLIENT_REGIONVOLUME_UPDATEEDGEWORLDPOS_OFFSET UNITYSDK_OFFSET(0xD2D9D90)
#define RPG_CLIENT_REGIONVOLUME_UPDATEVERTSWITHEXTEND_OFFSET UNITYSDK_OFFSET(0xD2D8000)
#define RPG_CLIENT_REGIONVOLUME_WORLDTOLOCAL_OFFSET UNITYSDK_OFFSET(0xD2D8AA0)
#define RPG_CLIENT_REGIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xD2DA250)
