...
#define RPG_CLIENT_VIRTUALCURSOR_VIRTUALCURSORMOVESTATE_ENTER_OFFSET UNITYSDK_OFFSET(0xD89E470)
#define RPG_CLIENT_VIRTUALCURSOR_VIRTUALCURSORMOVESTATE_EXIT_OFFSET UNITYSDK_OFFSET(0xD89E790)
#define RPG_CLIENT_VIRTUALCURSOR_VIRTUALCURSORMOVESTATE_TICK_OFFSET UNITYSDK_OFFSET(0xD89E4C0)
#define RPG_CLIENT_VIRTUALCURSOR_VIRTUALCURSORMOVESTATE__CALCULATESPEED_OFFSET UNITYSDK_OFFSET(0xD89E5E0)
#define RPG_CLIENT_VIRTUALCURSOR_VIRTUALCURSORMOVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xD89DF70)

namespace RPG::Client
{
	inline static constexpr unsigned int VirtualCursor_VirtualCursorMoveState_TypeDefinitionIndex = 69882;
