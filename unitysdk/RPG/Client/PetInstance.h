...
#define RPG_CLIENT_PETINSTANCE_CREATE_OFFSET UNITYSDK_OFFSET(0xCF64CF0)
#define RPG_CLIENT_PETINSTANCE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCF64D70)
#define RPG_CLIENT_PETINSTANCE_GET_ISPETENTITYALIVE_OFFSET UNITYSDK_OFFSET(0xCF65220)
#define RPG_CLIENT_PETINSTANCE_GET_PETENTITY_OFFSET UNITYSDK_OFFSET(0xCF65740)
#define RPG_CLIENT_PETINSTANCE_GET_PETID_OFFSET UNITYSDK_OFFSET(0xCF658C0)
#define RPG_CLIENT_PETINSTANCE_GET_PETITEMID_OFFSET UNITYSDK_OFFSET(0xCF659E0)
#define RPG_CLIENT_PETINSTANCE_GET_PETSUMMONID_OFFSET UNITYSDK_OFFSET(0xCF65940)
#define RPG_CLIENT_PETINSTANCE_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCF658E0)
#define RPG_CLIENT_PETINSTANCE_REGISTERPETUNIQUENAME_OFFSET UNITYSDK_OFFSET(0xCF64DB0)
#define RPG_CLIENT_PETINSTANCE_SETPETVISIBLE_OFFSET UNITYSDK_OFFSET(0xCF656A0)
#define RPG_CLIENT_PETINSTANCE_SET_PETID_OFFSET UNITYSDK_OFFSET(0xCF658D0)
#define RPG_CLIENT_PETINSTANCE_TRYCREATEPETENTITY_OFFSET UNITYSDK_OFFSET(0xCF65280)
#define RPG_CLIENT_PETINSTANCE_TRYDESTROYPETENTITY_OFFSET UNITYSDK_OFFSET(0xCF64E00)
#define RPG_CLIENT_PETINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCF64D50)
