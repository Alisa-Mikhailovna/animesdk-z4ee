...
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_CREATEGAMEWORLDLEVELGROUP_OFFSET UNITYSDK_OFFSET(0xCD27A30)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_GETCELLCENTER_OFFSET UNITYSDK_OFFSET(0xCD29FF0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_GETCELLCOUNT_OFFSET UNITYSDK_OFFSET(0xCD2AA30)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_GET_CELLLENGTH_OFFSET UNITYSDK_OFFSET(0xCD29FE0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_GET_VECTOR_OFFSET UNITYSDK_OFFSET(0xCD2A5C0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xCD298E0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_REFRESHPOSITION_OFFSET UNITYSDK_OFFSET(0xCD2AA80)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xCD2B040)
