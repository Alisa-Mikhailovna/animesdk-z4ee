...
#define RPG_CLIENT_TAROTBOOKCATALOGLUAPANELPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD61C070)

namespace RPG::Client
{
	inline static constexpr unsigned int TarotBookCatalogLuaPanelParam_TypeDefinitionIndex = 69190;
