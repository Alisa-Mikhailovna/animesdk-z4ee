...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_CREATE_1_OFFSET UNITYSDK_OFFSET(0xC11F450)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_CREATE_2_OFFSET UNITYSDK_OFFSET(0xC121ED0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_CREATE_OFFSET UNITYSDK_OFFSET(0xC11F270)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC11F660)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_EXPORTSETUP_OFFSET UNITYSDK_OFFSET(0xC122380)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_GET_ALLYCHIMERAS_OFFSET UNITYSDK_OFFSET(0xC1209A0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_GET_ALLYMASTERID_OFFSET UNITYSDK_OFFSET(0xC120A40)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_GET_ALLYMASTER_OFFSET UNITYSDK_OFFSET(0xC120AE0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_GET_ALLYTEAM_OFFSET UNITYSDK_OFFSET(0xC120C40)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_GET_ENEMYCHIMERAS_OFFSET UNITYSDK_OFFSET(0xC1209F0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_GET_ENEMYMASTERID_OFFSET UNITYSDK_OFFSET(0xC120A90)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_GET_ENEMYMASTER_OFFSET UNITYSDK_OFFSET(0xC120B90)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_GET_ENEMYTEAM_OFFSET UNITYSDK_OFFSET(0xC120C60)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_SET_ALLYTEAM_OFFSET UNITYSDK_OFFSET(0xC120C50)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE_SET_ENEMYTEAM_OFFSET UNITYSDK_OFFSET(0xC120C70)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE__CREATEALLYTEAM_OFFSET UNITYSDK_OFFSET(0xC120C90)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE__CREATEENEMYTEAM_OFFSET UNITYSDK_OFFSET(0xC121510)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0xC120C80)
