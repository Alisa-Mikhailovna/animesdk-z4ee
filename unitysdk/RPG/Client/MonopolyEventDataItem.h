...
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GETOPTIONDATAITEM_OFFSET UNITYSDK_OFFSET(0xCD45860)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_CANSKIP_OFFSET UNITYSDK_OFFSET(0xCD45A10)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xCD45C40)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_DICENUM_OFFSET UNITYSDK_OFFSET(0xCD45AC0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xCD45950)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISDATAREPORT_OFFSET UNITYSDK_OFFSET(0xCD45DD0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0xCD45F50)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xCD45E80)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISTRIGGERCOUNTED_OFFSET UNITYSDK_OFFSET(0xCD45F70)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xCD45F30)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0xCD45D20)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xCD45B60)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCD45970)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCD457B0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SETEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0xCD45810)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0xCD45960)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_ISEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0xCD45F60)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xCD45F40)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD45580)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM__INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xCD45590)
