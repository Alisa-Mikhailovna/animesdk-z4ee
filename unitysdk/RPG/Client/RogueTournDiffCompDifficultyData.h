...
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_COMPARETO_OFFSET UNITYSDK_OFFSET(0xD4302D0)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_CREATEDATA_OFFSET UNITYSDK_OFFSET(0xD427360)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_DIFFCOMPS_OFFSET UNITYSDK_OFFSET(0xD430420)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0xD430690)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_HASSUBLEVEL_OFFSET UNITYSDK_OFFSET(0xD4307D0)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_ISHARD_OFFSET UNITYSDK_OFFSET(0xD4306E0)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_ROMANNUMBER_OFFSET UNITYSDK_OFFSET(0xD430720)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_SUBLEVELNUMBER_OFFSET UNITYSDK_OFFSET(0xD430810)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD430360)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD430280)
