...
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_GET_OPTIONALBUFFLIST_OFFSET UNITYSDK_OFFSET(0xBFC5AF0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_GET_STORYGROUPEXTRAINFOROW_OFFSET UNITYSDK_OFFSET(0xBFC5A90)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_GET_STORYTHEMECONFIGROW_OFFSET UNITYSDK_OFFSET(0xBFC5AB0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_GET_THEMEID_OFFSET UNITYSDK_OFFSET(0xBFC5AD0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_SET_STORYGROUPEXTRAINFOROW_OFFSET UNITYSDK_OFFSET(0xBFC5AA0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_SET_STORYTHEMECONFIGROW_OFFSET UNITYSDK_OFFSET(0xBFC5AC0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_SET_THEMEID_OFFSET UNITYSDK_OFFSET(0xBFC5AE0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBFA31D0)
