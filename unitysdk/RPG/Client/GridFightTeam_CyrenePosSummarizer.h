...
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER_UPDATEDONE_OFFSET UNITYSDK_OFFSET(0xC826920)
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER_UPDATESTART_OFFSET UNITYSDK_OFFSET(0xC826760)
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER__CTOR_OFFSET UNITYSDK_OFFSET(0xC826B00)
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER__UPDATEDONE_B__3_0_OFFSET UNITYSDK_OFFSET(0xC826B70)
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER__UPDATESTART_B__2_0_OFFSET UNITYSDK_OFFSET(0xC826B10)
