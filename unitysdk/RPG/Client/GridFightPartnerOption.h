...
#define RPG_CLIENT_GRIDFIGHTPARTNEROPTION_GET_CHOOSEDESC_OFFSET UNITYSDK_OFFSET(0xC7A4CD0)
#define RPG_CLIENT_GRIDFIGHTPARTNEROPTION_GET_SHOWTRAITS_OFFSET UNITYSDK_OFFSET(0xC7A4D40)
#define RPG_CLIENT_GRIDFIGHTPARTNEROPTION_GET_SUBTRAITCONFIG_OFFSET UNITYSDK_OFFSET(0xC7A4CB0)
#define RPG_CLIENT_GRIDFIGHTPARTNEROPTION_SET_SUBTRAITCONFIG_OFFSET UNITYSDK_OFFSET(0xC7A4CC0)
#define RPG_CLIENT_GRIDFIGHTPARTNEROPTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC7A4F60)
#define RPG_CLIENT_GRIDFIGHTPARTNEROPTION__GETSHOWTRAITCONFIGS_OFFSET UNITYSDK_OFFSET(0xC7A4D90)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::GridFightRole* OptionRole; // 0x10
