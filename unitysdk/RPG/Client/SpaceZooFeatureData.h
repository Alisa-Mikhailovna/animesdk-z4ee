...
#define RPG_CLIENT_SPACEZOOFEATUREDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD525090)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_GET_FEATUREID_OFFSET UNITYSDK_OFFSET(0xD5253B0)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xD5253D0)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xD5249B0)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_SET_FEATUREID_OFFSET UNITYSDK_OFFSET(0xD5253C0)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xD5253E0)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_SYNCSTATE_OFFSET UNITYSDK_OFFSET(0xD524F60)
#define RPG_CLIENT_SPACEZOOFEATUREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD5253A0)
