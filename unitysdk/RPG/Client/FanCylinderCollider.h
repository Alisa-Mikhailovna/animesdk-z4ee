...
#define RPG_CLIENT_FANCYLINDERCOLLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC42F2C0)
#define RPG_CLIENT_FANCYLINDERCOLLIDER_METHOD_6_B8D84B51D5BA2413_OFFSET UNITYSDK_OFFSET(0xC42F4A0)
#define RPG_CLIENT_FANCYLINDERCOLLIDER_RECREATE_OFFSET UNITYSDK_OFFSET(0xC42F320)
#define RPG_CLIENT_FANCYLINDERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xC4306B0)
