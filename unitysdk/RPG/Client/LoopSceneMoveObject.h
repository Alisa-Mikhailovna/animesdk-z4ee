...
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCA2A020)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_INIT_OFFSET UNITYSDK_OFFSET(0xCA2AF30)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_MOVE_OFFSET UNITYSDK_OFFSET(0xCA2AC60)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_ROLLBACK_OFFSET UNITYSDK_OFFSET(0xCA2AD60)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_SETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0xCA2AFE0)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_SETOWNERLOOPSCENE_OFFSET UNITYSDK_OFFSET(0xCA2B030)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA2B080)
