...
#define RPG_CLIENT_MONOQUADEFFECT_DOTICK_OFFSET UNITYSDK_OFFSET(0xCD163C0)
#define RPG_CLIENT_MONOQUADEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xCD16540)
#define RPG_CLIENT_MONOQUADEFFECT_UPDATEPOS_OFFSET UNITYSDK_OFFSET(0xCD16470)
#define RPG_CLIENT_MONOQUADEFFECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD16360)
#define RPG_CLIENT_MONOQUADEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD165C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoQuadEffect_TypeDefinitionIndex = 69311;
