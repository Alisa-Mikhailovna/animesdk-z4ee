...
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCF4DF50)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCF4DFC0)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_GETSUBPATHDATA_OFFSET UNITYSDK_OFFSET(0xCF4D5F0)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_GET_ISMISSIONDATAREADY_OFFSET UNITYSDK_OFFSET(0xCF4F0B0)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0xCF4E060)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_REFRESHEARLYACCESSINFO_OFFSET UNITYSDK_OFFSET(0xCF4E0A0)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_REQUESTMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xCF4E6C0)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_SET_ISMISSIONDATAREADY_OFFSET UNITYSDK_OFFSET(0xCF4F0C0)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCF4DFB0)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA__GETDEPENDANTMAINMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xCF4E960)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA__GETDEPENDANTSUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xCF4EB80)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA__REQUESTMISSIONDATA_B__5_0_OFFSET UNITYSDK_OFFSET(0xCF4F0D0)
