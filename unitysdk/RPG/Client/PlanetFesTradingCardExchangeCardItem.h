...
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_CHECKISFINISH_OFFSET UNITYSDK_OFFSET(0xD0886C0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xD088410)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GETCARDITEMNUM_OFFSET UNITYSDK_OFFSET(0xD088680)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_BUFFIDLIST_OFFSET UNITYSDK_OFFSET(0xD088950)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_CARDBASEDATA_OFFSET UNITYSDK_OFFSET(0xD088A10)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_CARDID_OFFSET UNITYSDK_OFFSET(0xD088740)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_CARDPIECENUM_OFFSET UNITYSDK_OFFSET(0xD0888A0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xD0889A0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_EXCHANGEABLEPIECELIST_OFFSET UNITYSDK_OFFSET(0xD088700)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_IMGPATH_OFFSET UNITYSDK_OFFSET(0xD088790)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_ITEMLIST_OFFSET UNITYSDK_OFFSET(0xD088900)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD0887E0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xD088850)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET_TOTALPIECEDICT_OFFSET UNITYSDK_OFFSET(0xD088720)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_GET__CARDROW_OFFSET UNITYSDK_OFFSET(0xD088AF0)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_SET_EXCHANGEABLEPIECELIST_OFFSET UNITYSDK_OFFSET(0xD088710)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_SET_TOTALPIECEDICT_OFFSET UNITYSDK_OFFSET(0xD088730)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_SET__CARDROW_OFFSET UNITYSDK_OFFSET(0xD088B00)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM_TRYCREATEFESTRADINGCARDEXCHANGECARDITEM_OFFSET UNITYSDK_OFFSET(0xD088180)
#define RPG_CLIENT_PLANETFESTRADINGCARDEXCHANGECARDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD088400)
