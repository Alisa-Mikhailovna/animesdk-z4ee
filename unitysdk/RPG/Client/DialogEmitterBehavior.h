...
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET_IFINSTANCENEEDREFRESH_OFFSET UNITYSDK_OFFSET(0xC1E0E60)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET_IFUSESIMULATE_OFFSET UNITYSDK_OFFSET(0xC1E0DD0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xC1E0E20)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xC1E4380)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_00BC1D03A9F4D997_OFFSET UNITYSDK_OFFSET(0xC1E8670)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_0F2138E056F9294A_OFFSET UNITYSDK_OFFSET(0xC1E4280)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_14F193ED8E6A3459_OFFSET UNITYSDK_OFFSET(0xC1E8440)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0xC1E1770)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_270488173B023B4A_OFFSET UNITYSDK_OFFSET(0xC1E7E90)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0xC1E3FC0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_304A1E888A828F96_OFFSET UNITYSDK_OFFSET(0xC1E7F10)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xC1E4240)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC1E4160)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xC1E41D0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC1E3F60)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_634BCF4C65B50CBB_OFFSET UNITYSDK_OFFSET(0xC1E7600)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_821BBDC04720A2EB_OFFSET UNITYSDK_OFFSET(0xC1E18D0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0xC1E0F90)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_87D15601B8D27F72_OFFSET UNITYSDK_OFFSET(0xC1E4DA0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_9A4DCB2B4ADEB8A9_OFFSET UNITYSDK_OFFSET(0xC1E1260)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xC1E1160)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_AB7ED27CAB69BE58_OFFSET UNITYSDK_OFFSET(0xC1E69C0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0xC1E0E80)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_C2D2C3AC848DE1F1_OFFSET UNITYSDK_OFFSET(0xC1E8150)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_DBA8CB09BF007EAD_OFFSET UNITYSDK_OFFSET(0xC1E85E0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_E322D311AC7C7EE8_OFFSET UNITYSDK_OFFSET(0xC1E8CA0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_SET_IFINSTANCENEEDREFRESH_OFFSET UNITYSDK_OFFSET(0xC1E0E70)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xC1E8E70)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E8E60)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0x140A0);
		}
		static ::System::Int32* StaticGet_CustomDataID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0x140A4);
		}
