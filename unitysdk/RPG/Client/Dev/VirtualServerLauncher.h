...
#define RPG_CLIENT_DEV_VIRTUALSERVERLAUNCHER_CREATELAUNCHCONFIG_OFFSET UNITYSDK_OFFSET(0xC1E00F0)
#define RPG_CLIENT_DEV_VIRTUALSERVERLAUNCHER_LAUNCHWITHCONFIG_OFFSET UNITYSDK_OFFSET(0xC1DFE80)
#define RPG_CLIENT_DEV_VIRTUALSERVERLAUNCHER_STARTADVENTUREDEVSERVERS_OFFSET UNITYSDK_OFFSET(0xC1DFE10)
#define RPG_CLIENT_DEV_VIRTUALSERVERLAUNCHER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E0880)
#define RPG_CLIENT_DEV_VIRTUALSERVERLAUNCHER__GETPROMOTIONBYLEVEL_OFFSET UNITYSDK_OFFSET(0xC1E0810)

namespace RPG::Client::Dev
{
	inline static constexpr unsigned int VirtualServerLauncher_TypeDefinitionIndex = 76702;
