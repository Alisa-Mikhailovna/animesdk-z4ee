...
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0xD0B0550)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_GETTRIALAVATARLIST_OFFSET UNITYSDK_OFFSET(0xD0B0760)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_GETTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0xD0B08D0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_GET_GROUPDESC_OFFSET UNITYSDK_OFFSET(0xD0B0AA0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_INITCONFIG_OFFSET UNITYSDK_OFFSET(0xD0B0620)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_ISAVAILABLETRIALAVATARCONFIGID_OFFSET UNITYSDK_OFFSET(0xD0B09E0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0B04F0)
