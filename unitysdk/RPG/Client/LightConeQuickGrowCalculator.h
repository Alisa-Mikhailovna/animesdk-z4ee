...
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR_CLEARRULECONTEXT_OFFSET UNITYSDK_OFFSET(0xC9197E0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR_GET_RESULT_OFFSET UNITYSDK_OFFSET(0xC9195B0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0xC919710)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR_SETEQUIPMENT_OFFSET UNITYSDK_OFFSET(0xC919690)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR_SETRULECONTEXT_OFFSET UNITYSDK_OFFSET(0xC919750)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__APPENDPILEEQUIPMENTITEMCOSTS_OFFSET UNITYSDK_OFFSET(0xC91C240)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__BUILDEXPPLAN_OFFSET UNITYSDK_OFFSET(0xC91BDA0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__BUILDEXPSOURCEBYEQUIPMENT_OFFSET UNITYSDK_OFFSET(0xC91D270)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__BUILDEXPSOURCEBYEXPITEM_OFFSET UNITYSDK_OFFSET(0xC91D020)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__BUILDEXPSOURCES_OFFSET UNITYSDK_OFFSET(0xC919E00)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__BUILDLEVELUPCOSTSFORREQ_OFFSET UNITYSDK_OFFSET(0xC91BB70)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__BUILDPROMOTIONCOSTLIST_OFFSET UNITYSDK_OFFSET(0xC91BC80)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__CALCULATETOTALLIGHTCONECOUNT_OFFSET UNITYSDK_OFFSET(0xC91D920)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__CALCULATE_OFFSET UNITYSDK_OFFSET(0xC919850)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xC91DAE0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__CEILDIV_OFFSET UNITYSDK_OFFSET(0xC91C110)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__COLLECTPILEEQUIPMENTS_OFFSET UNITYSDK_OFFSET(0xC91D580)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__CREATEPILEITEMCOST_OFFSET UNITYSDK_OFFSET(0xC91C4B0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC919450)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__DETERMINELEVELTARGET_OFFSET UNITYSDK_OFFSET(0xC91C540)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__FILLEXPUSAGESUMMARY_OFFSET UNITYSDK_OFFSET(0xC91AEA0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__FILLPREVIEWCOSTS_OFFSET UNITYSDK_OFFSET(0xC91B0A0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__FILLREQCOSTLISTS_OFFSET UNITYSDK_OFFSET(0xC91A9A0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__FINDEXPSOURCE_OFFSET UNITYSDK_OFFSET(0xC91C170)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__GETAVAILABLEITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xC91C8C0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__GETEXPCOSTFORLEVELS_OFFSET UNITYSDK_OFFSET(0xC91C6D0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__GETLEVELMAXEXP_OFFSET UNITYSDK_OFFSET(0xC91CAA0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__GETPROMOTIONMAXLEVEL_OFFSET UNITYSDK_OFFSET(0xC91A1E0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__GETREMAININGEXPTOPROMOTIONCAP_OFFSET UNITYSDK_OFFSET(0xC91C080)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__GETTARGETPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xC91A120)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__GETTOTALAVAILABLEEXP_OFFSET UNITYSDK_OFFSET(0xC91A260)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__ISPILEENABLED_OFFSET UNITYSDK_OFFSET(0xC91D4E0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__RESOLVEFARMDEMAND_OFFSET UNITYSDK_OFFSET(0xC91B6C0)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__SIMULATEGROW_OFFSET UNITYSDK_OFFSET(0xC91A340)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__SUMMARIZEPILELIGHTCONES_OFFSET UNITYSDK_OFFSET(0xC91CB40)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__TRIMEXPOVERFLOW_OFFSET UNITYSDK_OFFSET(0xC91CD70)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__TRYPROMOTION_OFFSET UNITYSDK_OFFSET(0xC91C750)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR__TRYRECALCULATE_OFFSET UNITYSDK_OFFSET(0xC919630)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR___CALCULATE_B__21_0_OFFSET UNITYSDK_OFFSET(0xC91DAF0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(LightConeQuickGrowCalculator_TypeDefinitionIndex)->GetStaticField(0x8C70);
		}
		...
		::RPG::Client::LightConeGrowPlanResult* _Result; // 0x20
		::RPG::Client::EquipmentItemData* _Equipment; // 0x28
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _PileConfigIDs; // 0x30
		::System::UInt32 _HighestNonPileExpItemID; // 0x38
		::System::UInt32 _RuleWorldLevel; // 0x3C
		::System::UInt32 _HighestNonPileExpProvide; // 0x40
		::System::Int32 _LightConeCanConvertCount; // 0x44
		::System::UInt32 _RulePlayerLevel; // 0x48
