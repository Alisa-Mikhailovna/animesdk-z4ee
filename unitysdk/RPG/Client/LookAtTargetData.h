...
#define RPG_CLIENT_LOOKATTARGETDATA_CLEARDISABLED_OFFSET UNITYSDK_OFFSET(0x14B530)
#define RPG_CLIENT_LOOKATTARGETDATA_COPYFROM_1_OFFSET UNITYSDK_OFFSET(0x14B1E0)
#define RPG_CLIENT_LOOKATTARGETDATA_COPYFROM_OFFSET UNITYSDK_OFFSET(0x14B1D0)
#define RPG_CLIENT_LOOKATTARGETDATA_COPYTO_OFFSET UNITYSDK_OFFSET(0x14B1C0)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_DEFAULTLOOKATPOS_OFFSET UNITYSDK_OFFSET(0x14B830)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_DISABLEDCAUSE_OFFSET UNITYSDK_OFFSET(0x14B8C0)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x14B850)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_FORCECHANGETARGETTHISFRAME_OFFSET UNITYSDK_OFFSET(0x2DD70)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_LOOKATPOS_OFFSET UNITYSDK_OFFSET(0x14B770)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_TARGETDISTANCE_OFFSET UNITYSDK_OFFSET(0x14B2E0)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_TARGETPOS_OFFSET UNITYSDK_OFFSET(0x14B2C0)
#define RPG_CLIENT_LOOKATTARGETDATA_ISNEARLYLOOKAT_OFFSET UNITYSDK_OFFSET(0x14B8D0)
#define RPG_CLIENT_LOOKATTARGETDATA_LERPTARGET_OFFSET UNITYSDK_OFFSET(0x14B4C0)
#define RPG_CLIENT_LOOKATTARGETDATA_MOVETARGET_OFFSET UNITYSDK_OFFSET(0x14B440)
#define RPG_CLIENT_LOOKATTARGETDATA_SETDISABLED_OFFSET UNITYSDK_OFFSET(0x14B4E0)
#define RPG_CLIENT_LOOKATTARGETDATA_SETTARGET_OFFSET UNITYSDK_OFFSET(0x14B360)
#define RPG_CLIENT_LOOKATTARGETDATA_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x14B8B0)
#define RPG_CLIENT_LOOKATTARGETDATA_SET_FORCECHANGETARGETTHISFRAME_OFFSET UNITYSDK_OFFSET(0x1490D0)
#define RPG_CLIENT_LOOKATTARGETDATA_TICK_OFFSET UNITYSDK_OFFSET(0x14B4D0)
#define RPG_CLIENT_LOOKATTARGETDATA_UPDATETARGET_OFFSET UNITYSDK_OFFSET(0x14B390)
#define RPG_CLIENT_LOOKATTARGETDATA__ALPHAFROMSLERPSPEED_OFFSET UNITYSDK_OFFSET(0x14B580)
#define RPG_CLIENT_LOOKATTARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14B110)
#define RPG_CLIENT_LOOKATTARGETDATA__SETLOOKATPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x14B6A0)
