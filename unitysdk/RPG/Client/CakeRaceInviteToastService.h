...
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET_GAMEFLOW_OFFSET UNITYSDK_OFFSET(0xBF2C1D0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET_ISFORCEVALID_OFFSET UNITYSDK_OFFSET(0xBF2C1B0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET_UIMANAGER_OFFSET UNITYSDK_OFFSET(0xBF2C0D0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET__DISABLED_OFFSET UNITYSDK_OFFSET(0xBF2C280)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET__ISACTIVE_OFFSET UNITYSDK_OFFSET(0xBF2BDB0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET__ISRUNNING_OFFSET UNITYSDK_OFFSET(0xBF2C2C0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET__ISSHOWING_OFFSET UNITYSDK_OFFSET(0xBF2C080)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SETCANSHOW_OFFSET UNITYSDK_OFFSET(0xBF2B8C0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SETDISABLED_OFFSET UNITYSDK_OFFSET(0xBF2BC00)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SETRUNNING_OFFSET UNITYSDK_OFFSET(0xBF04A90)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SET_ISFORCEVALID_OFFSET UNITYSDK_OFFSET(0xBF2C1C0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SET__DISABLED_OFFSET UNITYSDK_OFFSET(0xBF2BC70)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SET__ISRUNNING_OFFSET UNITYSDK_OFFSET(0xBF2C2D0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xBF2B290)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__INIT_OFFSET UNITYSDK_OFFSET(0xBF2B6B0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__ISVALIDINVITATION_OFFSET UNITYSDK_OFFSET(0xBF2BE30)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0xBF2BFB0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__ONRECEIVECONTACT_OFFSET UNITYSDK_OFFSET(0xBF2BCC0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__ONTOASTDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0xBF2BF50)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__TRYPLAYNEXT_OFFSET UNITYSDK_OFFSET(0xBF2B970)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__TRYSTOPCURRENT_OFFSET UNITYSDK_OFFSET(0xBF2BBA0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE___TRYPLAYNEXT_B__8_0_OFFSET UNITYSDK_OFFSET(0xBF2C2E0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(CakeRaceInviteToastService_TypeDefinitionIndex)->GetStaticField(0x10830);
		}
