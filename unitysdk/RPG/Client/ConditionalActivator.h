...
#define RPG_CLIENT_CONDITIONALACTIVATOR_METHOD_5_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0xC1AD170)
#define RPG_CLIENT_CONDITIONALACTIVATOR_METHOD_5_36E51BE72B938C51_OFFSET UNITYSDK_OFFSET(0xC1AD200)
#define RPG_CLIENT_CONDITIONALACTIVATOR_METHOD_5_A73B8662804238D6_OFFSET UNITYSDK_OFFSET(0xC1AD350)
#define RPG_CLIENT_CONDITIONALACTIVATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC1AD6C0)
#define RPG_CLIENT_CONDITIONALACTIVATOR_START_OFFSET UNITYSDK_OFFSET(0xC1AD120)
#define RPG_CLIENT_CONDITIONALACTIVATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC1AD710)
#define RPG_CLIENT_CONDITIONALACTIVATOR___WAITSTATESWITCH_B__3_0_OFFSET UNITYSDK_OFFSET(0xC1AD770)

namespace RPG::Client
{
	inline static constexpr unsigned int ConditionalActivator_TypeDefinitionIndex = 69211;
