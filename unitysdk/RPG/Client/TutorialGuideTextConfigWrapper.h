...
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_CREATECUSTOMDIRECTIONGUIDETEXT_OFFSET UNITYSDK_OFFSET(0xD7614C0)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_CREATECUSTOMWEAKDIRECTIONGUIDETEXT_OFFSET UNITYSDK_OFFSET(0xD7618F0)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_CREATEGUIDETEXT_OFFSET UNITYSDK_OFFSET(0xD7610A0)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_CREATEWEAKGUIDETEXT_OFFSET UNITYSDK_OFFSET(0xD761680)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_GETACTIONNAME_OFFSET UNITYSDK_OFFSET(0xD761A80)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_GETCONTENTPATH_OFFSET UNITYSDK_OFFSET(0xD761CA0)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_GETGUIDETALKDATAROW_OFFSET UNITYSDK_OFFSET(0xD761AC0)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_GETKEYMAPPATH_OFFSET UNITYSDK_OFFSET(0xD761BD0)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_GETTEXTCONTENT_OFFSET UNITYSDK_OFFSET(0xD761A20)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_GETTEXTPATH_OFFSET UNITYSDK_OFFSET(0xD761B00)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_GET_CONFIGTYPE_OFFSET UNITYSDK_OFFSET(0xD762660)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_GET_ISSHOWKEYMAP_OFFSET UNITYSDK_OFFSET(0xD7626A0)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_GET__NEEDSYNC_OFFSET UNITYSDK_OFFSET(0xD762700)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_REFRESHADAPTION_1_OFFSET UNITYSDK_OFFSET(0xD761E90)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_REFRESHADAPTION_OFFSET UNITYSDK_OFFSET(0xD761D50)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_SETACTIONNAME_OFFSET UNITYSDK_OFFSET(0xD762280)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_SETGUIDETALKID_OFFSET UNITYSDK_OFFSET(0xD7622D0)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER_SETTEXT_OFFSET UNITYSDK_OFFSET(0xD761F20)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0xD761060)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER__GETADAPTIONCONFIG_OFFSET UNITYSDK_OFFSET(0xD761210)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER__GETPREFABPATH_1_OFFSET UNITYSDK_OFFSET(0xD761370)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER__GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0xD7615F0)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER__GETWEAKPREFABPATH_OFFSET UNITYSDK_OFFSET(0xD761820)
#define RPG_CLIENT_TUTORIALGUIDETEXTCONFIGWRAPPER__ONSETSHOWCONFIG_OFFSET UNITYSDK_OFFSET(0xD7624E0)
