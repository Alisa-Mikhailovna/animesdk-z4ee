...
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE_BUILDTITLECACHE_OFFSET UNITYSDK_OFFSET(0xBA8BF80)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE_CREATE_OFFSET UNITYSDK_OFFSET(0xBA8BE10)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBA8C880)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE_SEARCHBYNAME_OFFSET UNITYSDK_OFFSET(0xBA8C970)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0xBA8BE90)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE__ONTEXTLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0xBA8D2B0)
