...
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0xC111220)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP_GET_TABNAME_OFFSET UNITYSDK_OFFSET(0xC1120E0)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP_SET_TABNAME_OFFSET UNITYSDK_OFFSET(0xC1120F0)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP__ADDCHIMERAGROUPDATA_OFFSET UNITYSDK_OFFSET(0xC1117C0)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP__ADDGROUPITEM_OFFSET UNITYSDK_OFFSET(0xC111D60)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xC110950)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP__INITCHIMERALIST_OFFSET UNITYSDK_OFFSET(0xC111350)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP__INITITEMLIST_OFFSET UNITYSDK_OFFSET(0xC1116B0)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP__INIT_OFFSET UNITYSDK_OFFSET(0xC1112D0)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP__SORTCHIMERAGROUPDATALIST_OFFSET UNITYSDK_OFFSET(0xC111B00)
#define RPG_CLIENT_CHIMERADUELACHIEVEMENTDATAGROUP__SORTITEMGROUPDATALIST_OFFSET UNITYSDK_OFFSET(0xC111F30)
...
namespace RPG::Client
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* _ChimeraBattleGroupIDList; // 0x10
		::Il2CppArray<::RPG::Client::TextID>* _TextIDDict; // 0x18
		::Il2CppArray<::System::UInt32>* _ItemGroupIDDict; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::List_1<::System::UInt32>*>* _SpecialItemGroupIDDict; // 0x28
		::Il2CppArray<::System::UInt32>* _ChimeraGroupIDList; // 0x30
		::System::Collections::Generic::List_1<::RPG::Client::ChimeraDuelChimeraData*>* ChimeraList; // 0x38
		...
		::Il2CppArray<::System::UInt32>* _ItemBattleGroupIDDict; // 0x50
		::RPG::Client::TextID _TabName_k__BackingField; // 0x58
		::System::Int32 _TabIndex; // 0x68
