...
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_GETALLREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0xD2E33C0)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_GETRELICBOXREWARDDATALIST_OFFSET UNITYSDK_OFFSET(0xD2E3380)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_GETTAKENREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0xD2E3470)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_HASANYREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0xD2E32D0)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xD2DE190)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2E2410)

namespace RPG::Client::RelicBox
{
	inline static constexpr unsigned int RelicBoxRewardDataManager_TypeDefinitionIndex = 71055;
