...
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA_GET_FINISHCONDITIONS_OFFSET UNITYSDK_OFFSET(0xBD99150)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xBD98DD0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA_GET_ISEXPIRED_OFFSET UNITYSDK_OFFSET(0xBD98C90)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA_GET_PANELTYPE_OFFSET UNITYSDK_OFFSET(0xBD98F20)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA_GET_TABICON_OFFSET UNITYSDK_OFFSET(0xBD990A0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA_GET_TABNAME_OFFSET UNITYSDK_OFFSET(0xBD98FC0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xBD98C30)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA_ISFINISHCONDITIONCOMPLETE_OFFSET UNITYSDK_OFFSET(0xBD98A20)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA_SYNCSCHEDULE_OFFSET UNITYSDK_OFFSET(0xBD955D0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBD95220)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONPANELDATA__INITDATA_OFFSET UNITYSDK_OFFSET(0xBD98860)
