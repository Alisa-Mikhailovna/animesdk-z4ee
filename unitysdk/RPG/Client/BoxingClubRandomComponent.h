...
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ACTIVEFINISHNODE_OFFSET UNITYSDK_OFFSET(0xBED3CA0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_FORCERESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0xBED3810)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GENERATEPREFABRELATEDINFO_OFFSET UNITYSDK_OFFSET(0xBED2C60)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GENERATEREALRANDOMLIST_OFFSET UNITYSDK_OFFSET(0xBED3020)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETENEMYIMAGECOMPONENT_OFFSET UNITYSDK_OFFSET(0xBED3910)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETFINISHNODE_OFFSET UNITYSDK_OFFSET(0xBED3BB0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETHINTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xBED3AC0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETSHOWMONSTERICONINDEX_OFFSET UNITYSDK_OFFSET(0xBED3D50)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_INITICONS_OFFSET UNITYSDK_OFFSET(0xBED3350)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_INITRANDOMCOMPONENT_OFFSET UNITYSDK_OFFSET(0xBED2BB0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ISCURINDEXSELECTED_OFFSET UNITYSDK_OFFSET(0xBED3DD0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_LIGHTWEIGHTCLEAR_OFFSET UNITYSDK_OFFSET(0xBED37D0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ONSELECTNEXT_OFFSET UNITYSDK_OFFSET(0xBED3ED0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ONWAITEND_OFFSET UNITYSDK_OFFSET(0xBED2B10)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0xBED36C0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_TRYSELECTNEXT_OFFSET UNITYSDK_OFFSET(0xBED29C0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_UPDATESPEED_OFFSET UNITYSDK_OFFSET(0xBED2930)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0xBED27B0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xBED4010)

namespace RPG::Client
{
	inline static constexpr unsigned int BoxingClubRandomComponent_TypeDefinitionIndex = 69239;
