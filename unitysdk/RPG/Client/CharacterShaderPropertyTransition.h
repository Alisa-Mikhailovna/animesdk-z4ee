...
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC028290)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_DISSOLVETO_OFFSET UNITYSDK_OFFSET(0xC028390)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_GETCHARWPOS_OFFSET UNITYSDK_OFFSET(0xC0279F0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_GETCURRENTDISSOLVERATE_OFFSET UNITYSDK_OFFSET(0xC028B00)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_LATETICK_OFFSET UNITYSDK_OFFSET(0xC028980)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xC027DA0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_3363D89E03193669_OFFSET UNITYSDK_OFFSET(0xC028AA0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_442C4EFC0D686CFB_1_OFFSET UNITYSDK_OFFSET(0xC028A50)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_442C4EFC0D686CFB_OFFSET UNITYSDK_OFFSET(0xC028A00)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xC028030)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_A6CE5DAA2387E1E2_OFFSET UNITYSDK_OFFSET(0xC028150)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0xC027F30)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_D17B49CABC597E3E_OFFSET UNITYSDK_OFFSET(0xC028500)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC0287D0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0xC0288D0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0xC027AD0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARACTEROUTLINESCALE_OFFSET UNITYSDK_OFFSET(0xC028590)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARHEIGHT_OFFSET UNITYSDK_OFFSET(0xC0277F0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARWPOS_OFFSET UNITYSDK_OFFSET(0xC027890)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETSCENECONTRASTENABLE_OFFSET UNITYSDK_OFFSET(0xC027760)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETUPDATECHARWPOSBYSMRBOUNDS_OFFSET UNITYSDK_OFFSET(0xC027A70)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_START_OFFSET UNITYSDK_OFFSET(0xC0286A0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0xC028BA0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xC028B50)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0x103D0);
		}
		static ::System::Int32* StaticGet_PropertyIDCharaWorldSpaceOffset()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0x103D4);
		}
		static ::System::Int32* StaticGet_PropertyIDIsMonster()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0x103D8);
		}
