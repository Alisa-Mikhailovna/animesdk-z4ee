...
#define RPG_CLIENT_MONOESCALATORCONFIGURE_EVALUATEPOSITION_OFFSET UNITYSDK_OFFSET(0xCCE2FF0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xCCE2460)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_GET_INSTANCEMATRICES_OFFSET UNITYSDK_OFFSET(0xCCE24A0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_GET_ITEMSORTLENGTH_OFFSET UNITYSDK_OFFSET(0xCCE2480)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_METHOD_5_5FB0DC4E8DAA3EC5_OFFSET UNITYSDK_OFFSET(0xCCE2630)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_METHOD_5_7443AD94E7275ABA_OFFSET UNITYSDK_OFFSET(0xCCE2500)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0xCCE25C0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_REFRESHITEMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCCE2C30)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_REMOVEALLITEM_OFFSET UNITYSDK_OFFSET(0xCCE24B0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xCCE2470)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_SET_ITEMSORTLENGTH_OFFSET UNITYSDK_OFFSET(0xCCE2490)
#define RPG_CLIENT_MONOESCALATORCONFIGURE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE3120)
