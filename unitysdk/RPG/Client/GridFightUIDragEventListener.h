...
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER_ADDDISABLECANVASGROUP_OFFSET UNITYSDK_OFFSET(0xC8588F0)
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC858A60)
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER_REMOVEDISABLECANVASGROUP_OFFSET UNITYSDK_OFFSET(0xC8589D0)
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER_RPG_CLIENT_IUIDRAGEVENTLISTENER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xC858380)
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER_RPG_CLIENT_IUIDRAGEVENTLISTENER_ONSTARTDRAG_OFFSET UNITYSDK_OFFSET(0xC8585F0)
#define RPG_CLIENT_GRIDFIGHTUIDRAGEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0xC858B80)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightUIDragEventListener_TypeDefinitionIndex = 69715;
