...
#define RPG_CLIENT_NAVMAP_AREADATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCE2EC80)
#define RPG_CLIENT_NAVMAP_AREADATA_GETLIGHTENMAPFOGSECTIONLIST_OFFSET UNITYSDK_OFFSET(0xCE2F040)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_AREATYPE_OFFSET UNITYSDK_OFFSET(0xCE2F4A0)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_CARTOGRAPHY_OFFSET UNITYSDK_OFFSET(0xCE2F590)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xCE2F450)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_ISSHOWSUBMAPLINKICON_OFFSET UNITYSDK_OFFSET(0xCE2F400)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_MAPLAYERLIST_OFFSET UNITYSDK_OFFSET(0xCE2F5D0)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_MINIMAPVOLUME_OFFSET UNITYSDK_OFFSET(0xCE2EFF0)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_POSITIONINCANVAS_OFFSET UNITYSDK_OFFSET(0xCE2F620)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_REGIONIDLIST_OFFSET UNITYSDK_OFFSET(0xCE2F540)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_SCALEINCANVAS_OFFSET UNITYSDK_OFFSET(0xCE2F640)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_SORTINGID_OFFSET UNITYSDK_OFFSET(0xCE2F4F0)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_SUBMAPUIDEFAULTCENTER_OFFSET UNITYSDK_OFFSET(0xCE2F690)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_SUBMAPUISCALELOWERRATIO_OFFSET UNITYSDK_OFFSET(0xCE2F6E0)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_SUBMAPUISCALEUPPERRATIO_OFFSET UNITYSDK_OFFSET(0xCE2F730)
#define RPG_CLIENT_NAVMAP_AREADATA_GET_SUBNAVMAPDATA_OFFSET UNITYSDK_OFFSET(0xCE2F780)
#define RPG_CLIENT_NAVMAP_AREADATA_SET_POSITIONINCANVAS_OFFSET UNITYSDK_OFFSET(0xCE2F630)
#define RPG_CLIENT_NAVMAP_AREADATA_SET_SUBNAVMAPDATA_OFFSET UNITYSDK_OFFSET(0xCE2F790)
#define RPG_CLIENT_NAVMAP_AREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE2ED70)
#define RPG_CLIENT_NAVMAP_AREADATA__INITSECTIONS_OFFSET UNITYSDK_OFFSET(0xCE2EDC0)
#define RPG_CLIENT_NAVMAP_AREADATA__ISMAPSECTIONLIGHTEN_OFFSET UNITYSDK_OFFSET(0xCE2F2A0)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int AreaData_TypeDefinitionIndex = 71076;
