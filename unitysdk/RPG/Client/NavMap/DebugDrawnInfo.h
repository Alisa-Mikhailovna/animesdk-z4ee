...
#define RPG_CLIENT_NAVMAP_DEBUGDRAWNINFO_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xCE38A00)
#define RPG_CLIENT_NAVMAP_DEBUGDRAWNINFO_METHOD_5_ABFE6A357B89C69A_OFFSET UNITYSDK_OFFSET(0xCE387A0)
#define RPG_CLIENT_NAVMAP_DEBUGDRAWNINFO_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCE38900)
#define RPG_CLIENT_NAVMAP_DEBUGDRAWNINFO_RELEASE_OFFSET UNITYSDK_OFFSET(0xCE38990)
#define RPG_CLIENT_NAVMAP_DEBUGDRAWNINFO_SETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0xCE38290)
#define RPG_CLIENT_NAVMAP_DEBUGDRAWNINFO_SETINFOOFFSET_OFFSET UNITYSDK_OFFSET(0xCE38940)
#define RPG_CLIENT_NAVMAP_DEBUGDRAWNINFO_UPDATE_OFFSET UNITYSDK_OFFSET(0xCE38610)
#define RPG_CLIENT_NAVMAP_DEBUGDRAWNINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCE38600)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int DebugDrawnInfo_TypeDefinitionIndex = 71118;
