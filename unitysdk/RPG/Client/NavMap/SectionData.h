...
#define RPG_CLIENT_NAVMAP_SECTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCE6DEB0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_AREADATA_OFFSET UNITYSDK_OFFSET(0xCE6EBE0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_CENTER_OFFSET UNITYSDK_OFFSET(0xCE6E9C0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xCE6EA10)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xCE6DF50)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_INDICES_OFFSET UNITYSDK_OFFSET(0xCE6E880)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_INITIALHIDDEN_OFFSET UNITYSDK_OFFSET(0xCE6E920)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_ISRECT_OFFSET UNITYSDK_OFFSET(0xCE6E830)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_MAPLAYERID_OFFSET UNITYSDK_OFFSET(0xCE6DFA0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_PASSAGES_OFFSET UNITYSDK_OFFSET(0xCE6EB50)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0xCE6EB00)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_PROPID_OFFSET UNITYSDK_OFFSET(0xCE6EA60)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_REFERENCEPROPKEY_OFFSET UNITYSDK_OFFSET(0xCE6E7E0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0xCE6E290)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_SECTIONCONFIG_OFFSET UNITYSDK_OFFSET(0xCE6EBA0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_SPRITEPATH_OFFSET UNITYSDK_OFFSET(0xCE6DFF0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_TRIANGLES_OFFSET UNITYSDK_OFFSET(0xCE6EAB0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCE6E970)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_UIPOSITION_OFFSET UNITYSDK_OFFSET(0xCE6E8D0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_SET_AREADATA_OFFSET UNITYSDK_OFFSET(0xCE6EBF0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE6DF40)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int SectionData_TypeDefinitionIndex = 71106;
