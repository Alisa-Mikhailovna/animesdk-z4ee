...
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GETDEFAULTLAYER_OFFSET UNITYSDK_OFFSET(0xCE320F0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xCE316D0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_BACKGROUNDMAPSPRITEPATH_OFFSET UNITYSDK_OFFSET(0xCE32060)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_BACKGROUNDSIZE_OFFSET UNITYSDK_OFFSET(0xCE31B30)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_DEFAULTCENTERPOSINMAP_OFFSET UNITYSDK_OFFSET(0xCE31F50)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_INPUTSCALEMAX_OFFSET UNITYSDK_OFFSET(0xCE31E30)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_INPUTSCALEMIN_OFFSET UNITYSDK_OFFSET(0xCE31EC0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCE315E0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_LAYERLIST_OFFSET UNITYSDK_OFFSET(0xCE31640)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPMAPPINGINFODATALIST_OFFSET UNITYSDK_OFFSET(0xCE32240)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPMISSIONDATALIST_OFFSET UNITYSDK_OFFSET(0xCE321C0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPSCALE_OFFSET UNITYSDK_OFFSET(0xCE31DA0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPTELEPORTDATALIST_OFFSET UNITYSDK_OFFSET(0xCE32140)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPTRACKMONSTERDATALIST_OFFSET UNITYSDK_OFFSET(0xCE32340)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_OUTCONTROLTEAMLEADERICON_OFFSET UNITYSDK_OFFSET(0xCE32440)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_SUBNAVMAPLINKDATALIST_OFFSET UNITYSDK_OFFSET(0xCE323C0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_TEMPSHOWICONLIST_OFFSET UNITYSDK_OFFSET(0xCE322C0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0xCE31070)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCE30E40)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__INITAREA_1_OFFSET UNITYSDK_OFFSET(0xCE30E70)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__INITAREA_OFFSET UNITYSDK_OFFSET(0xCE310A0)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int Cartography2DFloor_TypeDefinitionIndex = 71078;
