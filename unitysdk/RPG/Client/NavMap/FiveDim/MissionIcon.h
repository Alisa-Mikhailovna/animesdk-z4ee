...
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_CARTOGRAPHY_OFFSET UNITYSDK_OFFSET(0xCE42540)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_CONTAINERGROUPID_OFFSET UNITYSDK_OFFSET(0xCE41E00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_CONTAINERINSTANCEID_OFFSET UNITYSDK_OFFSET(0xCE41E50)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0xCE42D60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_DESC_OFFSET UNITYSDK_OFFSET(0xCE42980)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xCE41D10)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ENTITYROTATION_OFFSET UNITYSDK_OFFSET(0xCE42260)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ENTITYSCALE_OFFSET UNITYSDK_OFFSET(0xCE42300)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0xCE42E60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_FACE_OFFSET UNITYSDK_OFFSET(0xCE41D90)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0xCE424B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ISCONNECTID_OFFSET UNITYSDK_OFFSET(0xCE426F0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ISONLINEPLAYROOM_OFFSET UNITYSDK_OFFSET(0xCE42E20)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ISTRACKING_OFFSET UNITYSDK_OFFSET(0xCE40F00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPICONCOLOR_OFFSET UNITYSDK_OFFSET(0xCE43070)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPICONTYPE_OFFSET UNITYSDK_OFFSET(0xCE42590)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPPINGINFOID_OFFSET UNITYSDK_OFFSET(0xCE42670)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPPINGINFOROW_OFFSET UNITYSDK_OFFSET(0xCE42730)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPPOSITION_OFFSET UNITYSDK_OFFSET(0xCE41EA0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCE42800)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_PATH_OFFSET UNITYSDK_OFFSET(0xCE423A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0xCE42CA0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_SUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xCE426D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET__ICONROW_OFFSET UNITYSDK_OFFSET(0xCE42440)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET__MAPTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCE42000)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_SET_SUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xCE426E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON__CTOR_OFFSET UNITYSDK_OFFSET(0xCE41D00)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int MissionIcon_TypeDefinitionIndex = 71241;
