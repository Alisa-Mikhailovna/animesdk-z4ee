...
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_CONNECTTARGETENTITYID_OFFSET UNITYSDK_OFFSET(0xCE47AF0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_CONNECTTARGETFACE_OFFSET UNITYSDK_OFFSET(0xCE47B40)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_CONNECTTARGETICON_OFFSET UNITYSDK_OFFSET(0xCE47C20)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0xCE47D10)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xCE47D30)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_MAPPOSITION_OFFSET UNITYSDK_OFFSET(0xCE47DB0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0xCE47D20)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON__CTOR_OFFSET UNITYSDK_OFFSET(0xCE47E30)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON__GET_CONNECTTARGETICON_B__6_0_OFFSET UNITYSDK_OFFSET(0xCE47E50)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int SurfaceConnectIcon_TypeDefinitionIndex = 71245;
