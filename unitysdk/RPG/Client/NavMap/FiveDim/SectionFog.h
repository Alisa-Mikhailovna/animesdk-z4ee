...
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONFOG_GET_DEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0xCE44A80)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONFOG_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0xCE44A00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONFOG_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0xCE44C30)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONFOG_SETCORNERS_OFFSET UNITYSDK_OFFSET(0xCE44AD0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONFOG__CTOR_OFFSET UNITYSDK_OFFSET(0xCE45240)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONFOG__GETSPRITESIZE_OFFSET UNITYSDK_OFFSET(0xCE45160)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int SectionFog_TypeDefinitionIndex = 71248;
