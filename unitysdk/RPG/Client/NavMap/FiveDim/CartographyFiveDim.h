...
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCE38F90)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETCHESTICONS_OFFSET UNITYSDK_OFFSET(0xCE3A4F0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETFACEPLAYERIN_OFFSET UNITYSDK_OFFSET(0xCE3B490)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETFACE_1_OFFSET UNITYSDK_OFFSET(0xCE3C050)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETFACE_OFFSET UNITYSDK_OFFSET(0xCE3BC50)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETICONS_OFFSET UNITYSDK_OFFSET(0xCE3A190)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETLEVELINSTANCE_OFFSET UNITYSDK_OFFSET(0xCE3AFF0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETMISSIONICONS_OFFSET UNITYSDK_OFFSET(0xCE3A770)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETSURFACEPLAYERIN_OFFSET UNITYSDK_OFFSET(0xCE3B530)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ALLFACES_OFFSET UNITYSDK_OFFSET(0xCE3A3B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ALWAYSSHOWENTRYONMAP_OFFSET UNITYSDK_OFFSET(0xCE3C8F0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_CARTOGRAPHER_OFFSET UNITYSDK_OFFSET(0xCE3CC60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0xCE3AAC0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_CURFACE_OFFSET UNITYSDK_OFFSET(0xCE3B510)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_DIFFICULTYLEVEL_OFFSET UNITYSDK_OFFSET(0xCE3C860)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ENTRYID_OFFSET UNITYSDK_OFFSET(0xCE3CCA0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_EXPLORATIONPROGRESS_OFFSET UNITYSDK_OFFSET(0xCE3C190)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0xCE3A910)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ISEXPLORATIONCOMPLETED_OFFSET UNITYSDK_OFFSET(0xCE3C0E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ISPLAYERHERE_OFFSET UNITYSDK_OFFSET(0xCE3B440)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_LEVELINSTANCES_OFFSET UNITYSDK_OFFSET(0xCE3D0B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_MAPAREALIST_OFFSET UNITYSDK_OFFSET(0xCE3CFB0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_MAPDATA_OFFSET UNITYSDK_OFFSET(0xCE3CA60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_NAVMAPCONFIG_OFFSET UNITYSDK_OFFSET(0xCE3CFA0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_PLANEID_OFFSET UNITYSDK_OFFSET(0xCE3CB00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0xCE3AA70)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_SUBMAPID_OFFSET UNITYSDK_OFFSET(0xCE3BD60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_SYNCEDWITHSERVER_OFFSET UNITYSDK_OFFSET(0xCE3CA00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_VERSEPARAM_OFFSET UNITYSDK_OFFSET(0xCE3CE00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_ONMAPDATADIRTY_OFFSET UNITYSDK_OFFSET(0xCE3D010)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_REPORTOPENEDDIALOG_OFFSET UNITYSDK_OFFSET(0xCE3BDB0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_RESETDEFAULTFACE_OFFSET UNITYSDK_OFFSET(0xCE3B300)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_RPG_CLIENT_NAVMAP_ICARTOGRAPHY_GET_MAPDATA_OFFSET UNITYSDK_OFFSET(0xCE3CFC0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_SETCURFACE_OFFSET UNITYSDK_OFFSET(0xCE3B7B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_SET_CURFACE_OFFSET UNITYSDK_OFFSET(0xCE3B520)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0xCE3D050)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__COLLECTMISSIONICON_OFFSET UNITYSDK_OFFSET(0xCE39950)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__COLLECTTRACKINGMISSIONICON_OFFSET UNITYSDK_OFFSET(0xCE3AB10)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__CTOR_OFFSET UNITYSDK_OFFSET(0xCE38B80)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__GETFACEBYID_OFFSET UNITYSDK_OFFSET(0xCE3B1D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITCURFACE_OFFSET UNITYSDK_OFFSET(0xCE39E30)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITEXPLORATIONPROGRESS_OFFSET UNITYSDK_OFFSET(0xCE38C60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITFACEINDEX_OFFSET UNITYSDK_OFFSET(0xCE39860)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITLEVELINSTANCES_OFFSET UNITYSDK_OFFSET(0xCE39180)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITMAP_OFFSET UNITYSDK_OFFSET(0xCE38BF0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__REFRESHEXPLORATIONPROGRESS_OFFSET UNITYSDK_OFFSET(0xCE39FC0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__TRYADDMISSIONGUIDEICON_OFFSET UNITYSDK_OFFSET(0xCE39A80)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int CartographyFiveDim_TypeDefinitionIndex = 71213;

	class CartographyFiveDim : public ::System::Object
	{
	public:
		// static const ::System::String* ExplorationCompletedSubMapIconPath; // 0x0
		::RPG::Client::NavMap::FiveDim::Face* _CurFace_k__BackingField; // 0x10
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1167*>* _ExplorationProgressList; // 0x30
