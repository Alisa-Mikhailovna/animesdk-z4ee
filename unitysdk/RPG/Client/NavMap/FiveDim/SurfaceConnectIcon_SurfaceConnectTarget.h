...
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_SURFACECONNECTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xCE47F30)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int SurfaceConnectIcon_SurfaceConnectTarget_TypeDefinitionIndex = 71246;
