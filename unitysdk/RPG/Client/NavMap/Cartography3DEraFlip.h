...
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_GETDEFAULTAREAERASTATE_OFFSET UNITYSDK_OFFSET(0xCE33B20)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_GETICONSHOWSTATE_1_OFFSET UNITYSDK_OFFSET(0xCE34480)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_GETICONSHOWSTATE_OFFSET UNITYSDK_OFFSET(0xCE34260)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_GETSCENECURRENTERASTATE_OFFSET UNITYSDK_OFFSET(0xCE33B80)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_GET_ISDEVICEFOLLOW_OFFSET UNITYSDK_OFFSET(0xCE35110)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_GET_MAP3DPREFABPATH_OFFSET UNITYSDK_OFFSET(0xCE34F80)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_GET_MODELSHOWSTATE_OFFSET UNITYSDK_OFFSET(0xCE35000)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_GET_STATE_OFFSET UNITYSDK_OFFSET(0xCE34FE0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_ICONSHOWINONEOFERASTATE_OFFSET UNITYSDK_OFFSET(0xCE34C50)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_ISENTITYSHOWINCURERAFLIPSTATE_OFFSET UNITYSDK_OFFSET(0xCE33D70)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_ISICON3DSHOW_OFFSET UNITYSDK_OFFSET(0xCE33C80)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP_SET_STATE_OFFSET UNITYSDK_OFFSET(0xCE34FF0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCE33540)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP__GETFLOORDEFAULTAREAERASTATE_OFFSET UNITYSDK_OFFSET(0xCE33C00)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP__GETICONCOLLECTOR_OFFSET UNITYSDK_OFFSET(0xCE33A40)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY3DERAFLIP__INITROW_OFFSET UNITYSDK_OFFSET(0xCE33560)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int Cartography3DEraFlip_TypeDefinitionIndex = 71081;
