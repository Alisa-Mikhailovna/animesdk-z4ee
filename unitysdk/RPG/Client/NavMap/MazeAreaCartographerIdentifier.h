...
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x14E6C0)
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x14E6D0)
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x14E5F0)
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x14E530)
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER_GET_AREAID_OFFSET UNITYSDK_OFFSET(0x1E130)
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER_GET_VERSEPARAM_OFFSET UNITYSDK_OFFSET(0x14E330)
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xCE5CBE0)
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xCE5CC50)
#define RPG_CLIENT_NAVMAP_MAZEAREACARTOGRAPHERIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x14E350)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int MazeAreaCartographerIdentifier_TypeDefinitionIndex = 71086;
