...
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x14E510)
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x14E520)
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x14E440)
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x14E380)
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER_GET_SUBMAPID_OFFSET UNITYSDK_OFFSET(0x1E130)
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER_GET_VERSEPARAM_OFFSET UNITYSDK_OFFSET(0x14E330)
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xCE46EB0)
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xCE57480)
#define RPG_CLIENT_NAVMAP_LITTLEGAMECARTOGRAPHERIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x14E350)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int LittleGameCartographerIdentifier_TypeDefinitionIndex = 71088;
