...
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GETDEFAULTLAYER_OFFSET UNITYSDK_OFFSET(0xCE30010)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xCE30600)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_BACKGROUNDMAPSPRITEPATH_OFFSET UNITYSDK_OFFSET(0xCE30D90)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_BACKGROUNDSIZE_OFFSET UNITYSDK_OFFSET(0xCE30370)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_DEFAULTCENTERPOSINMAP_OFFSET UNITYSDK_OFFSET(0xCE30260)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_INPUTSCALEMAX_OFFSET UNITYSDK_OFFSET(0xCE30140)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_INPUTSCALEMIN_OFFSET UNITYSDK_OFFSET(0xCE301D0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCE2FFB0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_LAYERLIST_OFFSET UNITYSDK_OFFSET(0xCE2FEB0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPMAPPINGINFODATALIST_OFFSET UNITYSDK_OFFSET(0xCE30B10)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPMISSIONDATALIST_OFFSET UNITYSDK_OFFSET(0xCE30A90)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPSCALE_OFFSET UNITYSDK_OFFSET(0xCE30080)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPTELEPORTDATALIST_OFFSET UNITYSDK_OFFSET(0xCE30900)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPTRACKMONSTERDATALIST_OFFSET UNITYSDK_OFFSET(0xCE30C10)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_OUTCONTROLTEAMLEADERICON_OFFSET UNITYSDK_OFFSET(0xCE30D10)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_SUBNAVMAPLINKDATALIST_OFFSET UNITYSDK_OFFSET(0xCE30C90)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_TEMPSHOWICONLIST_OFFSET UNITYSDK_OFFSET(0xCE30B90)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET__NAVMAPAREADATA_OFFSET UNITYSDK_OFFSET(0xCE2FF30)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE2F7A0)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int Cartography2DArea_TypeDefinitionIndex = 71077;
