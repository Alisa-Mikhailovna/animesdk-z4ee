...
#define RPG_CLIENT_FATEACTIVITYPANELDATA_GET_ISDISPLAY_OFFSET UNITYSDK_OFFSET(0xC442890)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_GET__GUIDEMISSIONGROUPEVENT_OFFSET UNITYSDK_OFFSET(0xC442810)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_GET__GUIDEMISSIONGROUPID_OFFSET UNITYSDK_OFFSET(0xC442700)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_HASREWARDTOTAKE_OFFSET UNITYSDK_OFFSET(0xC442C60)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_ISLOCKEDBYPRECONDITIONS_OFFSET UNITYSDK_OFFSET(0xC442A90)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xC4428D0)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_TRYTRIGGERGUIDEMISSIONINTERACT_OFFSET UNITYSDK_OFFSET(0xC443030)
#define RPG_CLIENT_FATEACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC442880)
#define RPG_CLIENT_FATEACTIVITYPANELDATA__HASRESIDENTREWARDTOTAKE_OFFSET UNITYSDK_OFFSET(0xC4429C0)
