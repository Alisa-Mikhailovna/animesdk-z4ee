...
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_AWAKE_OFFSET UNITYSDK_OFFSET(0xC1D0E80)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_2A4F3E470B1283DD_OFFSET UNITYSDK_OFFSET(0xC1D1150)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_40E03D354D1ACC85_OFFSET UNITYSDK_OFFSET(0xC1D1980)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_5B06CEE7A34B50AD_OFFSET UNITYSDK_OFFSET(0xC1D33C0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_96189EDEF38976A6_1_OFFSET UNITYSDK_OFFSET(0xC1D2790)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0xC1D1E70)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_B50CA01B5EDC1228_OFFSET UNITYSDK_OFFSET(0xC1D32E0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_F2BB8CA4A5596DD6_OFFSET UNITYSDK_OFFSET(0xC1D3020)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_REBUILDLINE_OFFSET UNITYSDK_OFFSET(0xC1D0F50)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_UPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0xC1D0FE0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL__CTOR_OFFSET UNITYSDK_OFFSET(0xC1D3700)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(CustomLineProcedural_TypeDefinitionIndex)->GetStaticField(0x648A0);
		}
