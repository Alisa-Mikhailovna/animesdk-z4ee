...
#define RPG_CLIENT_BILLBOARD_ONLINEPLAYERNAMEBILLBOARDDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xBEBA520)
#define RPG_CLIENT_BILLBOARD_ONLINEPLAYERNAMEBILLBOARDDATA_GET_ISSELF_OFFSET UNITYSDK_OFFSET(0xBEBA4A0)
#define RPG_CLIENT_BILLBOARD_ONLINEPLAYERNAMEBILLBOARDDATA_GET_PLAYERINDEX_OFFSET UNITYSDK_OFFSET(0xBEBA480)
#define RPG_CLIENT_BILLBOARD_ONLINEPLAYERNAMEBILLBOARDDATA_GET_PLAYERNAME_OFFSET UNITYSDK_OFFSET(0xBEBA460)
#define RPG_CLIENT_BILLBOARD_ONLINEPLAYERNAMEBILLBOARDDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0xBEBA4C0)
#define RPG_CLIENT_BILLBOARD_ONLINEPLAYERNAMEBILLBOARDDATA_SET_ISSELF_OFFSET UNITYSDK_OFFSET(0xBEBA4B0)
#define RPG_CLIENT_BILLBOARD_ONLINEPLAYERNAMEBILLBOARDDATA_SET_PLAYERINDEX_OFFSET UNITYSDK_OFFSET(0xBEBA490)
#define RPG_CLIENT_BILLBOARD_ONLINEPLAYERNAMEBILLBOARDDATA_SET_PLAYERNAME_OFFSET UNITYSDK_OFFSET(0xBEBA470)
#define RPG_CLIENT_BILLBOARD_ONLINEPLAYERNAMEBILLBOARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBEB60F0)

namespace RPG::Client::Billboard
{
	inline static constexpr unsigned int OnlinePlayerNameBillboardData_TypeDefinitionIndex = 71389;
