...
#define RPG_CLIENT_BILLBOARD_INWARDBUBBLETALKBILLBOARDDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xBEB8A80)
#define RPG_CLIENT_BILLBOARD_INWARDBUBBLETALKBILLBOARDDATA_GET_INWARDTYPE_OFFSET UNITYSDK_OFFSET(0xBEB8A10)
#define RPG_CLIENT_BILLBOARD_INWARDBUBBLETALKBILLBOARDDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0xBEB8A30)
#define RPG_CLIENT_BILLBOARD_INWARDBUBBLETALKBILLBOARDDATA_SET_INWARDTYPE_OFFSET UNITYSDK_OFFSET(0xBEB8A20)
#define RPG_CLIENT_BILLBOARD_INWARDBUBBLETALKBILLBOARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBEB59A0)

namespace RPG::Client::Billboard
{
	inline static constexpr unsigned int InwardBubbleTalkBillboardData_TypeDefinitionIndex = 71384;
