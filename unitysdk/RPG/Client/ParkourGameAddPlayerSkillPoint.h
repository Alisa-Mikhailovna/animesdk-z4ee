...
#define RPG_CLIENT_PARKOURGAMEADDPLAYERSKILLPOINT_METHOD_3_781077C79BB44444_OFFSET UNITYSDK_OFFSET(0x1B0E9120)
#define RPG_CLIENT_PARKOURGAMEADDPLAYERSKILLPOINT_METHOD_3_7B88FD6D309FE5C1_OFFSET UNITYSDK_OFFSET(0x1B0E9160)
#define RPG_CLIENT_PARKOURGAMEADDPLAYERSKILLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E9150)
