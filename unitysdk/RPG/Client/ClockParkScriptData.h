...
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC187570)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GETCHAPTERINDEX_OFFSET UNITYSDK_OFFSET(0xC187A00)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GETREACHEDENDCHAPTERCOUNT_OFFSET UNITYSDK_OFFSET(0xC187780)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_CHAPTERLIST_OFFSET UNITYSDK_OFFSET(0xC188220)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_HASSCRIPTCHARACTERISTIC_OFFSET UNITYSDK_OFFSET(0xC187EA0)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_HASSCRIPTGAMEPLAYDESC_OFFSET UNITYSDK_OFFSET(0xC188050)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC187D80)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_ISINFINITE_OFFSET UNITYSDK_OFFSET(0xC187FA0)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xC187E00)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xC187DA0)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_MAXCHAPTERCOUNT_OFFSET UNITYSDK_OFFSET(0xC188260)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_REACHEDCHAPTERLIST_OFFSET UNITYSDK_OFFSET(0xC188200)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xC187AC0)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_SCRIPTTYPE_OFFSET UNITYSDK_OFFSET(0xC188150)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_GET_TOTALENDCHAPTERCOUNT_OFFSET UNITYSDK_OFFSET(0xC188240)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_ISCHAPTERENDREACHED_OFFSET UNITYSDK_OFFSET(0xC187940)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_ISREACHEDFALSEENDING_OFFSET UNITYSDK_OFFSET(0xC187860)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_ISREACHEDTRUEENDING_OFFSET UNITYSDK_OFFSET(0xC183950)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_SET_CHAPTERLIST_OFFSET UNITYSDK_OFFSET(0xC188230)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xC187D90)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_SET_MAXCHAPTERCOUNT_OFFSET UNITYSDK_OFFSET(0xC188270)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_SET_REACHEDCHAPTERLIST_OFFSET UNITYSDK_OFFSET(0xC188210)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_SET_TOTALENDCHAPTERCOUNT_OFFSET UNITYSDK_OFFSET(0xC188250)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xC187670)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC187400)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA__GETCHAPTERDEPTH_OFFSET UNITYSDK_OFFSET(0xC187B30)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA__GETENDCHAPTERCOUNT_OFFSET UNITYSDK_OFFSET(0xC187C20)
#define RPG_CLIENT_CLOCKPARKSCRIPTDATA__INITCHAPTERSDATA_OFFSET UNITYSDK_OFFSET(0xC1874B0)
