...
#define RPG_CLIENT_NOTIFYSETBATTLEENTITYVIEWACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0xCEDC130)

namespace RPG::Client
{
	inline static constexpr unsigned int NotifySetBattleEntityViewActive_TypeDefinitionIndex = 68128;
