...
#define RPG_CLIENT_EFFECT_LINERENDERER_LATETICK_OFFSET UNITYSDK_OFFSET(0xC31FE70)
#define RPG_CLIENT_EFFECT_LINERENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC31FEE0)
#define RPG_CLIENT_EFFECT_LINERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC31FDE0)
#define RPG_CLIENT_EFFECT_LINERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC31FD10)
#define RPG_CLIENT_EFFECT_LINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xC31FF30)
