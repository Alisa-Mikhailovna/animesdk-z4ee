...
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_CREATEINBATTLE_OFFSET UNITYSDK_OFFSET(0xC3FE490)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_CREATEOUTSIDEBATTLE_OFFSET UNITYSDK_OFFSET(0xC3FE100)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_CREATE_OFFSET UNITYSDK_OFFSET(0xC3FE3F0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_DOSHOWUNLOCKCHIP_OFFSET UNITYSDK_OFFSET(0xC3FF0A0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GETCANSHOWUNLOCKCHIP_OFFSET UNITYSDK_OFFSET(0xC3FE8C0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GETTUTORIALANDTUTORIALUNLOCKID_OFFSET UNITYSDK_OFFSET(0xC3FEE70)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_CARDDATA_OFFSET UNITYSDK_OFFSET(0xC3FF460)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_ISFULLCARDUNLOCKED_OFFSET UNITYSDK_OFFSET(0xC3FF790)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC3FF820)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_STAGEMERGEDID_OFFSET UNITYSDK_OFFSET(0xC3FF440)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_UNLOCKCHIPINDEX_OFFSET UNITYSDK_OFFSET(0xC3FF040)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET__CARDID_OFFSET UNITYSDK_OFFSET(0xC3FF500)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET__MODULE_OFFSET UNITYSDK_OFFSET(0xC3FEB60)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_OPENRESULTPAGE_OFFSET UNITYSDK_OFFSET(0xC3FED40)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_SETSHOWNUNLOCKCHIP_OFFSET UNITYSDK_OFFSET(0xC3FF2F0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_SET_STAGEMERGEDID_OFFSET UNITYSDK_OFFSET(0xC3FF450)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_TRYSHOWUNLOCKCHIP_OFFSET UNITYSDK_OFFSET(0xC3FE9E0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC3FE620)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD__GETNEXTSTAGEUNLOCKQUESTSTATUS_OFFSET UNITYSDK_OFFSET(0xC3FE910)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD__ONQUESTUPDATED_OFFSET UNITYSDK_OFFSET(0xC3FF350)
