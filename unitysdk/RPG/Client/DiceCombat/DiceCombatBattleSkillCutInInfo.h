...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC20C330)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_ISLOCALPLAYER_OFFSET UNITYSDK_OFFSET(0xC20C2A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC20C380)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0xC20C2E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC20C260)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatBattleSkillCutInInfo_TypeDefinitionIndex = 72138;
