...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xC235970)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_GETTALK_OFFSET UNITYSDK_OFFSET(0xC235AF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_GET_SECONDSPERTALK_OFFSET UNITYSDK_OFFSET(0xC235940)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_GET_TALKCOUNT_OFFSET UNITYSDK_OFFSET(0xC235AA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_SET_SECONDSPERTALK_OFFSET UNITYSDK_OFFSET(0xC235950)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC235960)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BattleShowTalksParam_TypeDefinitionIndex = 72281;
