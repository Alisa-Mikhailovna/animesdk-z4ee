...
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC290B60)
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC290B90)
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC290B50)
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC290AE0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int OnServerConnectedDelegate_TypeDefinitionIndex = 72223;
