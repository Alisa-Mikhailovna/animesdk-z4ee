...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xC28ECE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_GET_CALLBACK_OFFSET UNITYSDK_OFFSET(0xC28ED90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0xC28ED70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_SET_CALLBACK_OFFSET UNITYSDK_OFFSET(0xC28EDA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0xC28ED80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC28ECD0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2UIExchangeDiceEventParam_TypeDefinitionIndex = 72287;
