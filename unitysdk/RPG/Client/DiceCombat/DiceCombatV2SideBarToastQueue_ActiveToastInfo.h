...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE_ACTIVETOASTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC28E360)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2SideBarToastQueue_ActiveToastInfo_TypeDefinitionIndex = 72301;
