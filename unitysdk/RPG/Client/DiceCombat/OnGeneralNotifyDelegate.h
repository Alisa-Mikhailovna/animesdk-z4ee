...
#define RPG_CLIENT_DICECOMBAT_ONGENERALNOTIFYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC290980)
#define RPG_CLIENT_DICECOMBAT_ONGENERALNOTIFYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC2909E0)
#define RPG_CLIENT_DICECOMBAT_ONGENERALNOTIFYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC290970)
#define RPG_CLIENT_DICECOMBAT_ONGENERALNOTIFYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC290900)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int OnGeneralNotifyDelegate_TypeDefinitionIndex = 72222;
