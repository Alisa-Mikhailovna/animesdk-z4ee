...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATNPCENTRANCEPAGEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xC215090)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATNPCENTRANCEPAGEPARAM_GET_NPCNAME_OFFSET UNITYSDK_OFFSET(0xC215070)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATNPCENTRANCEPAGEPARAM_GET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0xC215050)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATNPCENTRANCEPAGEPARAM_SET_NPCNAME_OFFSET UNITYSDK_OFFSET(0xC215080)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATNPCENTRANCEPAGEPARAM_SET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0xC215060)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATNPCENTRANCEPAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC215040)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatNPCEntrancePageParam_TypeDefinitionIndex = 72212;
