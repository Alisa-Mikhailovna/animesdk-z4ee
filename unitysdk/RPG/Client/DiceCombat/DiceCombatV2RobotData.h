...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC28BCC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_GET_DICEAVATARINFO_OFFSET UNITYSDK_OFFSET(0xC28BC10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_GET_HEADICONID_OFFSET UNITYSDK_OFFSET(0xC28BBD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_GET_HEADICON_OFFSET UNITYSDK_OFFSET(0xC28BC30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC28BBB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC28BBF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_SET_DICEAVATARINFO_OFFSET UNITYSDK_OFFSET(0xC28BC20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_SET_HEADICONID_OFFSET UNITYSDK_OFFSET(0xC28BBE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xC28BBC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xC28BC00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ROBOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC28BD90)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2RobotData_TypeDefinitionIndex = 72245;
