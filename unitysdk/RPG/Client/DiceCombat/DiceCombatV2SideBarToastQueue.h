...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE_AWAKE_OFFSET UNITYSDK_OFFSET(0xC28D190)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE_CLEARPENDING_OFFSET UNITYSDK_OFFSET(0xC28DAE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE_PUSH_OFFSET UNITYSDK_OFFSET(0xC28DA50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE_UPDATE_OFFSET UNITYSDK_OFFSET(0xC28DBB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0xC28E4E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__GETORCREATE_OFFSET UNITYSDK_OFFSET(0xC28E230)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__ONTOASTFADEOUTEND_OFFSET UNITYSDK_OFFSET(0xC28E370)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__SHOW_OFFSET UNITYSDK_OFFSET(0xC28DEA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__TRYSHOWNEXTMESSAGES_OFFSET UNITYSDK_OFFSET(0xC28DC00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__UPDATEFADEOUT_OFFSET UNITYSDK_OFFSET(0xC28DCB0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2SideBarToastQueue_TypeDefinitionIndex = 72300;
