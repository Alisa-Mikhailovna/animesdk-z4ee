...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_GET_PERCENT_OFFSET UNITYSDK_OFFSET(0xC2366F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_METHOD_5_13E8B1F3F0042AA5_OFFSET UNITYSDK_OFFSET(0xC236910)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_METHOD_5_226558B48AF9A6C1_OFFSET UNITYSDK_OFFSET(0xC236710)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_METHOD_5_70459B7C790C82DB_OFFSET UNITYSDK_OFFSET(0xC236C30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_METHOD_5_AC088C028EF9B921_OFFSET UNITYSDK_OFFSET(0xC236AF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_SET_PERCENT_OFFSET UNITYSDK_OFFSET(0xC236700)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xC236DC0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BrandRankingEntry_TypeDefinitionIndex = 72291;
