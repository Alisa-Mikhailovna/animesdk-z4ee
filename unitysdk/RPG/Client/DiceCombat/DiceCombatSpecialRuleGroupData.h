...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xC223E90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC21DCD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_GET_EFFECTIVEROUNDID_OFFSET UNITYSDK_OFFSET(0xC2242A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC2242E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_GET_RULELIST_OFFSET UNITYSDK_OFFSET(0xC224330)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_PINSPECIALRULEBYID_OFFSET UNITYSDK_OFFSET(0xC2240D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC223E80)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatSpecialRuleGroupData_TypeDefinitionIndex = 72175;
