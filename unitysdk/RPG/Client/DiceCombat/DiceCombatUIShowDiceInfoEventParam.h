...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM_GET_INFOS_OFFSET UNITYSDK_OFFSET(0xC225880)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM_GET_ISHOLD_OFFSET UNITYSDK_OFFSET(0xC225860)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM_SET_INFOS_OFFSET UNITYSDK_OFFSET(0xC225890)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM_SET_ISHOLD_OFFSET UNITYSDK_OFFSET(0xC225870)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC225850)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatUIShowDiceInfoEventParam_TypeDefinitionIndex = 72250;
