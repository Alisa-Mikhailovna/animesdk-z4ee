...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC214D50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC214F20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC214E60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC214E10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC214EB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC214E00)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatGlossaryTermData_TypeDefinitionIndex = 72162;
