...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC235DE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xC235D10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_HEADICON_OFFSET UNITYSDK_OFFSET(0xC235C70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_SIDE_OFFSET UNITYSDK_OFFSET(0xC235BD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC235B70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC235DD0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BattleTalkData_TypeDefinitionIndex = 72237;
