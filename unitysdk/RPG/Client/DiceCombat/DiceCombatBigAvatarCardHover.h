...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC20C3F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_BINDNODE_OFFSET UNITYSDK_OFFSET(0xC20C650)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC20C750)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONMOBILEUPDATE_OFFSET UNITYSDK_OFFSET(0xC20D1B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONPCUPDATE_OFFSET UNITYSDK_OFFSET(0xC20CD20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_SETHOVERACTIVE_OFFSET UNITYSDK_OFFSET(0xC20C880)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_START_OFFSET UNITYSDK_OFFSET(0xC20C4F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC20CBA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER__CTOR_OFFSET UNITYSDK_OFFSET(0xC20D450)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatBigAvatarCardHover_TypeDefinitionIndex = 72181;
