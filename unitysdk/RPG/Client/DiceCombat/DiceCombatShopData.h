...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_CONTAINSGOODID_OFFSET UNITYSDK_OFFSET(0xC221CA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC221130)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GETSHOPGOODSBYGOODTYPE_OFFSET UNITYSDK_OFFSET(0xC2223B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GETSHOPGOOD_OFFSET UNITYSDK_OFFSET(0xC222210)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GET_ALLSHOPGOODS_OFFSET UNITYSDK_OFFSET(0xC2224F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GET_AVATARGOODS_OFFSET UNITYSDK_OFFSET(0xC222510)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GET_CURRENCYID_OFFSET UNITYSDK_OFFSET(0xC222610)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GET_DICEGOODS_OFFSET UNITYSDK_OFFSET(0xC222530)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GET_SHOPICONPATH_OFFSET UNITYSDK_OFFSET(0xC222550)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GET_SHOPID_OFFSET UNITYSDK_OFFSET(0xC21E520)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GET_SHOPNAME_OFFSET UNITYSDK_OFFSET(0xC2225A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_GET_SORTWEIGHT_OFFSET UNITYSDK_OFFSET(0xC2224A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_SET_ALLSHOPGOODS_OFFSET UNITYSDK_OFFSET(0xC222500)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_SET_AVATARGOODS_OFFSET UNITYSDK_OFFSET(0xC222520)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_SET_DICEGOODS_OFFSET UNITYSDK_OFFSET(0xC222540)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA_SORTGOODLIST_OFFSET UNITYSDK_OFFSET(0xC221FF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC221120)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatShopData_TypeDefinitionIndex = 72170;
	...
	public:
		...
		::RPG::GameCore::ActivityDiceCombatShopRow* _ShopRow; // 0x20
