...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC2364D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC236250)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_MARKETSHARETREND_OFFSET UNITYSDK_OFFSET(0xC236420)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC2362C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_ROUNDICON_OFFSET UNITYSDK_OFFSET(0xC236380)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC236260)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_VISITIDS_OFFSET UNITYSDK_OFFSET(0xC236540)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC2364C0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BrandData_TypeDefinitionIndex = 72239;
