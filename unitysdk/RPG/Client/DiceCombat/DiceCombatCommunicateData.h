...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC20DB70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_CHATCONTENT_OFFSET UNITYSDK_OFFSET(0xC20DDA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_COMMUNICATEID_OFFSET UNITYSDK_OFFSET(0xC20DD50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_EMOJIID_OFFSET UNITYSDK_OFFSET(0xC20DCA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_EMOJIPATH_OFFSET UNITYSDK_OFFSET(0xC20DCF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC20DC50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC20DB60)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatCommunicateData_TypeDefinitionIndex = 72157;
