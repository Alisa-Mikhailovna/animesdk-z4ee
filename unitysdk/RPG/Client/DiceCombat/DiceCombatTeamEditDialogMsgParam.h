...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xC225760)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0xC2256A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_CONFIRMCALLBACK_OFFSET UNITYSDK_OFFSET(0xC225720)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_CURRENTCONFIRMEDAVATARID_OFFSET UNITYSDK_OFFSET(0xC225700)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_NEEDSELECTNUM_OFFSET UNITYSDK_OFFSET(0xC2256E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_SELECTEDAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0xC2256C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC225740)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0xC2256B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_CONFIRMCALLBACK_OFFSET UNITYSDK_OFFSET(0xC225730)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_CURRENTCONFIRMEDAVATARID_OFFSET UNITYSDK_OFFSET(0xC225710)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_NEEDSELECTNUM_OFFSET UNITYSDK_OFFSET(0xC2256F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_SELECTEDAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0xC2256D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC225750)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC225690)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatTeamEditDialogMsgParam_TypeDefinitionIndex = 72218;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::DiceCombat::IDiceCombatAvatarInfo*>* _AvatarList_k__BackingField; // 0x18
