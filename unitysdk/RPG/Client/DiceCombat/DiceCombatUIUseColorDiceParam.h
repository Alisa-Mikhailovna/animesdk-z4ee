...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUIUSECOLORDICEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC2258A0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatUIUseColorDiceParam_TypeDefinitionIndex = 72119;
