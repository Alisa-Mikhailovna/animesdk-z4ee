...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLEQUITINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xC235730)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLEQUITINFO_GET_ISPVE_OFFSET UNITYSDK_OFFSET(0xC2357D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLEQUITINFO_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC2357F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLEQUITINFO_SET_ISPVE_OFFSET UNITYSDK_OFFSET(0xC2357E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLEQUITINFO_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC235800)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLEQUITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC2357C0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BattleQuitInfo_TypeDefinitionIndex = 72235;
