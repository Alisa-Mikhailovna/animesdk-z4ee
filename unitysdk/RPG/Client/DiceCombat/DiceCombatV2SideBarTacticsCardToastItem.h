...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTACTICSCARDTOASTITEM_GETSUPPORTEDMESSAGETYPES_OFFSET UNITYSDK_OFFSET(0xC28C9A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTACTICSCARDTOASTITEM_METHOD_6_1DA7E1493C6ABDFF_OFFSET UNITYSDK_OFFSET(0xC28C740)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTACTICSCARDTOASTITEM_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC28CA20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTACTICSCARDTOASTITEM_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC28C520)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTACTICSCARDTOASTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC28CC60)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2SideBarTacticsCardToastItem_TypeDefinitionIndex = 72296;
