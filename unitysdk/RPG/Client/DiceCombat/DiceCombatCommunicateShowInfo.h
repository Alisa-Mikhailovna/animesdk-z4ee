...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATESHOWINFO_GET_COMMUNICATEID_OFFSET UNITYSDK_OFFSET(0xC20DE40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATESHOWINFO_GET_DATA_OFFSET UNITYSDK_OFFSET(0xC20DE60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATESHOWINFO_GET_PLAYERUID_OFFSET UNITYSDK_OFFSET(0xC20DE20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATESHOWINFO_SET_COMMUNICATEID_OFFSET UNITYSDK_OFFSET(0xC20DE50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATESHOWINFO_SET_PLAYERUID_OFFSET UNITYSDK_OFFSET(0xC20DE30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATESHOWINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC20DE10)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatCommunicateShowInfo_TypeDefinitionIndex = 72158;
