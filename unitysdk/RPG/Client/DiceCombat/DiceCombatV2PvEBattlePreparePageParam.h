...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xC288090)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_GET_LOCALPLAYERDATA_OFFSET UNITYSDK_OFFSET(0xC287FD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_GET_OPPONENTAVATARINFO_OFFSET UNITYSDK_OFFSET(0xC288050)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_GET_OPPONENTDATA_OFFSET UNITYSDK_OFFSET(0xC288030)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_GET_SHOWIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xC288070)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC287FB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_GET_TEAMMATEPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0xC288010)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_GET_TEAMMATEPLAYERDATA_OFFSET UNITYSDK_OFFSET(0xC287FF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_SET_LOCALPLAYERDATA_OFFSET UNITYSDK_OFFSET(0xC287FE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_SET_OPPONENTAVATARINFO_OFFSET UNITYSDK_OFFSET(0xC288060)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_SET_OPPONENTDATA_OFFSET UNITYSDK_OFFSET(0xC288040)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_SET_SHOWIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xC288080)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC287FC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_SET_TEAMMATEPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0xC288020)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM_SET_TEAMMATEPLAYERDATA_OFFSET UNITYSDK_OFFSET(0xC288000)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVEBATTLEPREPAREPAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC287FA0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2PvEBattlePreparePageParam_TypeDefinitionIndex = 72286;
	...
	public:
		...
		::RPG::Client::DiceCombat::IDiceCombatAvatarInfo* _OpponentAvatarInfo_k__BackingField; // 0x20
		::RPG::Client::DiceCombat::IDiceCombatAvatarInfo* _TeamMatePlayerAvatarInfo_k__BackingField; // 0x28
		::RPG::Client::DiceCombat::DiceCombatV2OpponentData* _OpponentData_k__BackingField; // 0x30
