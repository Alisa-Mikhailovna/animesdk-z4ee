...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVPSTARTMATCHPARAM_GET_ISDIRECTSTARTGAME_OFFSET UNITYSDK_OFFSET(0xC21B120)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVPSTARTMATCHPARAM_GET_PVPMODE_OFFSET UNITYSDK_OFFSET(0xC21B100)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVPSTARTMATCHPARAM_SET_ISDIRECTSTARTGAME_OFFSET UNITYSDK_OFFSET(0xC21B130)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVPSTARTMATCHPARAM_SET_PVPMODE_OFFSET UNITYSDK_OFFSET(0xC21B110)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVPSTARTMATCHPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC21B0F0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatPVPStartMatchParam_TypeDefinitionIndex = 72214;
