...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_CHATINVITEID_OFFSET UNITYSDK_OFFSET(0xC289F00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_HIGHESTSCOREINHISTORY_OFFSET UNITYSDK_OFFSET(0xC289F40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_INVITEROBOTIDLIST_OFFSET UNITYSDK_OFFSET(0xC289F20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_STATE_OFFSET UNITYSDK_OFFSET(0xC289F60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_SET_CHATINVITEID_OFFSET UNITYSDK_OFFSET(0xC289F10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_SET_HIGHESTSCOREINHISTORY_OFFSET UNITYSDK_OFFSET(0xC289F50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_SET_INVITEROBOTIDLIST_OFFSET UNITYSDK_OFFSET(0xC289F30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC28A0F0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2PvPStage_TypeDefinitionIndex = 72260;
