...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_CREATEROBOTPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xC290590)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_FETCHDEPENDANTSUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xC2903F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETAVAILABLECOMMUNICATEIDLIST_OFFSET UNITYSDK_OFFSET(0xC28F770)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETAVATARTARGETDICEFACEEFFECTCONFIG_OFFSET UNITYSDK_OFFSET(0xC28F2C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETBOSSDIALOGSHOWTIME_OFFSET UNITYSDK_OFFSET(0xC28F1C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETBRANDRANKINGTALKCONTENT_OFFSET UNITYSDK_OFFSET(0xC28F5E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETDICETYPETOASTICONPATHBYID_OFFSET UNITYSDK_OFFSET(0xC28C3C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETLATESTUNLOCKEDPVESTAGEIDINSTAGEPAGE_OFFSET UNITYSDK_OFFSET(0xC290000)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETOPPONENTATKUPPREVIEWVALUE_OFFSET UNITYSDK_OFFSET(0xC28FBB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETPLAYERCARDAVAILABLECOMMUNICATEIDLIST_OFFSET UNITYSDK_OFFSET(0xC28F990)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETPVESTAGESTATEBYSTAGEID_OFFSET UNITYSDK_OFFSET(0xC2884A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETPVPSTAGESTATEBYSTAGEID_OFFSET UNITYSDK_OFFSET(0xC289FB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETPVPUNLOCKSUBMISSIONID_OFFSET UNITYSDK_OFFSET(0xC28F0F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETRANKLEVELINFOBYSCORE_OFFSET UNITYSDK_OFFSET(0xC290200)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETSTARTBATTLECUSTOMSTRINGBYPVESTAGEID_OFFSET UNITYSDK_OFFSET(0xC28FE70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETTACTICSSHOPREFRESHCOST_OFFSET UNITYSDK_OFFSET(0xC28EEF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETTACTICSSHOPREFRESHMAXTIME_OFFSET UNITYSDK_OFFSET(0xC28EFF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GETTITLEFROMNOTIFYBYUID_OFFSET UNITYSDK_OFFSET(0xC2894B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GET_GAMEFLOW_OFFSET UNITYSDK_OFFSET(0xC285140)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GET_MODULE_OFFSET UNITYSDK_OFFSET(0xC28EDB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_GET_PVPLOBBY_OFFSET UNITYSDK_OFFSET(0xC28EE30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_ISPVPUNLOCK_OFFSET UNITYSDK_OFFSET(0xC28BA20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL_REGISTERCUSTOMPOSITIONSETTER_OFFSET UNITYSDK_OFFSET(0xC28FD80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UTIL__REGISTERCUSTOMPOSITIONSETTER_G__SETTER_15_0_OFFSET UNITYSDK_OFFSET(0xC290660)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2Util_TypeDefinitionIndex = 72264;
