...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0xC21C2A0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatProgress_TypeDefinitionIndex = 72168;
