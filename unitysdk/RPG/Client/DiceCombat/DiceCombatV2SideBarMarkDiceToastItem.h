...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARMARKDICETOASTITEM_GETSUPPORTEDMESSAGETYPES_OFFSET UNITYSDK_OFFSET(0xC28C490)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARMARKDICETOASTITEM_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC28C360)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARMARKDICETOASTITEM_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC28BDA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARMARKDICETOASTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC28C500)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2SideBarMarkDiceToastItem_TypeDefinitionIndex = 72295;
