...
#define RPG_CLIENT_DICECOMBAT_ONONGENERALRSPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC290A70)
#define RPG_CLIENT_DICECOMBAT_ONONGENERALRSPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC290AD0)
#define RPG_CLIENT_DICECOMBAT_ONONGENERALRSPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC290A60)
#define RPG_CLIENT_DICECOMBAT_ONONGENERALRSPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2909F0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int OnOnGeneralRspDelegate_TypeDefinitionIndex = 72221;
