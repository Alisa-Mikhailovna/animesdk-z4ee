...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_CREATEAVAILABLEDICELIST_OFFSET UNITYSDK_OFFSET(0xC200740)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_GET_AVAILABLECOUNT_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_GET_DICEID_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_GET_DICERARITY_OFFSET UNITYSDK_OFFSET(0x1E130)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE__CTOR_OFFSET UNITYSDK_OFFSET(0x82640)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatAvailableDice_TypeDefinitionIndex = 72153;
