...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTMESSAGE_CREATE_OFFSET UNITYSDK_OFFSET(0xC28D0B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTMESSAGE_GET_PARAM_OFFSET UNITYSDK_OFFSET(0xC28D170)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTMESSAGE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC28D150)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTMESSAGE_SET_PARAM_OFFSET UNITYSDK_OFFSET(0xC28D180)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTMESSAGE_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xC28D160)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC28D140)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2SideBarToastMessage_TypeDefinitionIndex = 72298;
