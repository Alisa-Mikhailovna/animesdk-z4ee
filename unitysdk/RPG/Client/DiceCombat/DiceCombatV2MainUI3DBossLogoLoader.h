...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_BIND_OFFSET UNITYSDK_OFFSET(0xC285390)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC285750)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_GET__MATERIAL_OFFSET UNITYSDK_OFFSET(0xC285690)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_SHOWBOSSLOGIBYSTAGEID_OFFSET UNITYSDK_OFFSET(0xC2853E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xC285AF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER__GETTEXTUREPATHBYSTAGEID_OFFSET UNITYSDK_OFFSET(0xC2855E0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2MainUI3DBossLogoLoader_TypeDefinitionIndex = 72294;
