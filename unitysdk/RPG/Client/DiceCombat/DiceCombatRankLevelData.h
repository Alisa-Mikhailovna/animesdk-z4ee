...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC21DA60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_DICERANKID_OFFSET UNITYSDK_OFFSET(0xC21DC80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_HASSPECIALRULE_OFFSET UNITYSDK_OFFSET(0xC21E0A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC21DFA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_ICONSMALLPATH_OFFSET UNITYSDK_OFFSET(0xC211920)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC21DFF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_RANKMAXSCORE_OFFSET UNITYSDK_OFFSET(0xC21DF10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_RANKMINSCORE_OFFSET UNITYSDK_OFFSET(0xC21DF60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_SPECIALRULEGROUPDATAS_OFFSET UNITYSDK_OFFSET(0xC21E060)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC21DA50)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatRankLevelData_TypeDefinitionIndex = 72169;
