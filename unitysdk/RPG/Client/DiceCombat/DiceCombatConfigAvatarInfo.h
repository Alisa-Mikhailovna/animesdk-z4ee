...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_CREATEBYAVATARID_OFFSET UNITYSDK_OFFSET(0xC20DF00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_CREATEBYBATTLEAVATARINFO_OFFSET UNITYSDK_OFFSET(0xC20E610)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_CREATEPRESETPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0xC20E450)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_CREATESTAGEENEMYAVATARINFO_OFFSET UNITYSDK_OFFSET(0xC20E200)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_ATTACKDICENUM_OFFSET UNITYSDK_OFFSET(0xC20EB40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_AVAILABLEDICE_OFFSET UNITYSDK_OFFSET(0xC210F00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_AVATARHIGHLEVELBGIMGPATHUI3D_OFFSET UNITYSDK_OFFSET(0xC20F960)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_AVATARHIGHLEVELBGIMGPATH_OFFSET UNITYSDK_OFFSET(0xC20F4E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xC20E800)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_AVATARIMGPATHUI3D_OFFSET UNITYSDK_OFFSET(0xC20F060)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_AVATARIMGPATH_OFFSET UNITYSDK_OFFSET(0xC20EBE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_AVATARLEVEL_OFFSET UNITYSDK_OFFSET(0xC20EAB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0xC20E850)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_AVATARRARITY_OFFSET UNITYSDK_OFFSET(0xC20EA60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_COLORFULDICEAVAILABLECOUNT_OFFSET UNITYSDK_OFFSET(0xC20E1B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_DEFENSEDICENUM_OFFSET UNITYSDK_OFFSET(0xC20EB90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_DICECOUNTPERRARE_OFFSET UNITYSDK_OFFSET(0xC210F20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_DICEIDPERRARE_OFFSET UNITYSDK_OFFSET(0xC210F40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_FINALATTACKVOICE_OFFSET UNITYSDK_OFFSET(0xC210980)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xC210080)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_ISCOLLECTION_OFFSET UNITYSDK_OFFSET(0xC210020)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_ISSHOWASPLAYERCARD_OFFSET UNITYSDK_OFFSET(0xC20FE30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xC20EAF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_PLAYERGENDER_OFFSET UNITYSDK_OFFSET(0xC20FF10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_RECOMMENDDICELIST_OFFSET UNITYSDK_OFFSET(0xC20FDE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_SHOPICONPATH_OFFSET UNITYSDK_OFFSET(0xC210500)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xC210E00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC20E7C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_SET_AVAILABLEDICE_OFFSET UNITYSDK_OFFSET(0xC210F10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_SET_DICECOUNTPERRARE_OFFSET UNITYSDK_OFFSET(0xC210F30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO_SET_DICEIDPERRARE_OFFSET UNITYSDK_OFFSET(0xC210F50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO__CREATE_OFFSET UNITYSDK_OFFSET(0xC20E090)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCONFIGAVATARINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC20E7B0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatConfigAvatarInfo_TypeDefinitionIndex = 72159;
	...
	public:
		...
		::System::Nullable_1<::RPG::GameCore::GenderType> _OverrideGenderType; // 0x40
		::System::UInt32 _AvatarLevel; // 0x48
