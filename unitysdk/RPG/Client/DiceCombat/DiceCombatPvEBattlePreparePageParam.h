...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEBATTLEPREPAREPAGEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xC21D9C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEBATTLEPREPAREPAGEPARAM_GET_SHOWIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xC21D9A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEBATTLEPREPAREPAGEPARAM_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC21D980)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEBATTLEPREPAREPAGEPARAM_SET_SHOWIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xC21D9B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEBATTLEPREPAREPAGEPARAM_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xC21D990)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEBATTLEPREPAREPAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC21D970)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatPvEBattlePreparePageParam_TypeDefinitionIndex = 72215;
