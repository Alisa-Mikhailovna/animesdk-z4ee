...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2REDDOT_GETNEWPVESTAGEIDSNOTSEEN_OFFSET UNITYSDK_OFFSET(0xC28B000)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2REDDOT_HASANYNEWPVESTAGENOTSEEN_OFFSET UNITYSDK_OFFSET(0xC28A9C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2REDDOT_HASANYSCOREREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0xC28A510)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2REDDOT_HASPVPSTAGENEWNOTSEEN_OFFSET UNITYSDK_OFFSET(0xC28B9B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2REDDOT_SETPVPSTAGEPAGESEEN_OFFSET UNITYSDK_OFFSET(0xC28BAC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2REDDOT_SETSEENALLUNLOCKEDPVESTAGES_OFFSET UNITYSDK_OFFSET(0xC28B6C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2REDDOT_SETSEENPVESTAGES_OFFSET UNITYSDK_OFFSET(0xC28B4B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2REDDOT_SETSEENPVESTAGE_OFFSET UNITYSDK_OFFSET(0xC28B360)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2REDDOT__CTOR_OFFSET UNITYSDK_OFFSET(0xC28BB50)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2RedDot_TypeDefinitionIndex = 72258;
