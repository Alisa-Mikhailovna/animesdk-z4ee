...
#define RPG_CLIENT_QUADRATICEQUATION_METHOD_2_89FADE33F34E4AE0_1_OFFSET UNITYSDK_OFFSET(0x150440)
#define RPG_CLIENT_QUADRATICEQUATION_METHOD_2_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0x1503C0)
#define RPG_CLIENT_QUADRATICEQUATION_METHOD_2_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x1504B0)
#define RPG_CLIENT_QUADRATICEQUATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x150500)
#define RPG_CLIENT_QUADRATICEQUATION__CTOR_OFFSET UNITYSDK_OFFSET(0x25B50)

namespace RPG::Client
{
	inline static constexpr unsigned int QuadraticEquation_TypeDefinitionIndex = 69904;
