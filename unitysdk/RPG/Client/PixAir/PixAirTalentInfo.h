...
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xCFE5810)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_GETALLTALENTDATA_OFFSET UNITYSDK_OFFSET(0xCFE58A0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_GETTALENTDATA_OFFSET UNITYSDK_OFFSET(0xCFE5690)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xCFE5640)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_INIT_OFFSET UNITYSDK_OFFSET(0xCFE59D0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_TRYGETTALENTDATA_OFFSET UNITYSDK_OFFSET(0xCFE5740)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE5AA0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTalentInfo_TypeDefinitionIndex = 75352;
