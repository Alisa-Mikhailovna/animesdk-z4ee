...
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_CLEAR_OFFSET UNITYSDK_OFFSET(0xCFE38D0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_GET_CONTAINERTYPE_OFFSET UNITYSDK_OFFSET(0xCFE3790)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_GET_ENDINDEX_OFFSET UNITYSDK_OFFSET(0xCFE37F0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_GET_EQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFE38B0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xCFE37D0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xCFE3840)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_GET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0xCFE3890)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_GET_SERVERSIDEINDEX_OFFSET UNITYSDK_OFFSET(0xCFE37B0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_GET_SIZE_OFFSET UNITYSDK_OFFSET(0xCFCB610)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_GET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0xCFCAA80)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_INIT_OFFSET UNITYSDK_OFFSET(0xCFE3940)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_SETLOCKED_OFFSET UNITYSDK_OFFSET(0xCFE39D0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_SET_CONTAINERTYPE_OFFSET UNITYSDK_OFFSET(0xCFE37A0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_SET_EQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFE38C0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xCFE37E0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_SET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0xCFE38A0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT_SET_SERVERSIDEINDEX_OFFSET UNITYSDK_OFFSET(0xCFE37C0)
#define RPG_CLIENT_PIXAIR_PIXAIRSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE3930)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirSlot_TypeDefinitionIndex = 75304;
