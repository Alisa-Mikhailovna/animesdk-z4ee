...
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCFD9080)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GETCONSTMAXSCORE_OFFSET UNITYSDK_OFFSET(0xCFD9690)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GETRESIDENTREWARDQUESTS_OFFSET UNITYSDK_OFFSET(0xCFD9200)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GETTIMELIMITREWARDID_OFFSET UNITYSDK_OFFSET(0xCFD90E0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GETTIMELIMITREWARDSCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0xCFD91A0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_AREAINFO_OFFSET UNITYSDK_OFFSET(0xCFD8690)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_EQUIPINFO_OFFSET UNITYSDK_OFFSET(0xCFD86D0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_EQUIPSHOPMANAGER_OFFSET UNITYSDK_OFFSET(0xCFD8710)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_GAMESESSION_OFFSET UNITYSDK_OFFSET(0xCFD8750)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_ISINGAME_OFFSET UNITYSDK_OFFSET(0xCFD8770)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_NODEINFO_OFFSET UNITYSDK_OFFSET(0xCFD86B0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0xCFD86F0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_PROMISENETSERVICE_OFFSET UNITYSDK_OFFSET(0xCFD1A80)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_SCORE_OFFSET UNITYSDK_OFFSET(0xCFD8730)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0xCFD8670)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_GET__NET_OFFSET UNITYSDK_OFFSET(0xCFD25F0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_HASRESIDENTREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0xCFD9510)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xCFD87C0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_ISSHOWTIMELIMITREWARDNEW_OFFSET UNITYSDK_OFFSET(0xCFD95B0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_REQUESTSELECTCONTENT_OFFSET UNITYSDK_OFFSET(0xCFD2200)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_REQUESTSELLEQUIP_OFFSET UNITYSDK_OFFSET(0xCFD38C0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_REQUESTSWAPEQUIP_OFFSET UNITYSDK_OFFSET(0xCFD2E80)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SENDPIXAIRBUYGOODSCSREQ_OFFSET UNITYSDK_OFFSET(0xCFD2930)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SENDPIXAIRREFRESHSHOPCSREQ_OFFSET UNITYSDK_OFFSET(0xCFD2680)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SETTIMELIMITREWARDNEWSEEN_OFFSET UNITYSDK_OFFSET(0xCFD9630)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SET_AREAINFO_OFFSET UNITYSDK_OFFSET(0xCFD86A0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SET_EQUIPINFO_OFFSET UNITYSDK_OFFSET(0xCFD86E0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SET_EQUIPSHOPMANAGER_OFFSET UNITYSDK_OFFSET(0xCFD8720)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SET_GAMESESSION_OFFSET UNITYSDK_OFFSET(0xCFD8760)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SET_NODEINFO_OFFSET UNITYSDK_OFFSET(0xCFD86C0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0xCFD8700)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SET_PROMISENETSERVICE_OFFSET UNITYSDK_OFFSET(0xCFD1A90)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SET_SCORE_OFFSET UNITYSDK_OFFSET(0xCFD8740)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE_SET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0xCFD8680)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0xCFD1AA0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0xCFD97C0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD9780)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLEBASICCHANGE_OFFSET UNITYSDK_OFFSET(0xCFD6AD0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLEBEFOREENTERGAMESETTLE_OFFSET UNITYSDK_OFFSET(0xCFD6E10)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLEENTERNEWNODE_OFFSET UNITYSDK_OFFSET(0xCFD69A0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLEEQUIPCHANGE_OFFSET UNITYSDK_OFFSET(0xCFD6B40)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLEEQUIPREMOVE_OFFSET UNITYSDK_OFFSET(0xCFD6BB0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLEPENDINGACTIONFINISH_OFFSET UNITYSDK_OFFSET(0xCFD6C80)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLEPENDINGACTION_OFFSET UNITYSDK_OFFSET(0xCFD6C10)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLEPIXAIRCHANGE_OFFSET UNITYSDK_OFFSET(0xCFD59E0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLESHOPUPDATE_OFFSET UNITYSDK_OFFSET(0xCFD6D40)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLESLOTNUMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFD6DA0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLESTAGESETTLE_OFFSET UNITYSDK_OFFSET(0xCFD6140)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__HANDLEUNLOCKEDPLANE_OFFSET UNITYSDK_OFFSET(0xCFD60A0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ISBUYBLOCKEDBYSLOTSFULL_OFFSET UNITYSDK_OFFSET(0xCFD2CC0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRBUYGOODSSCRSP_OFFSET UNITYSDK_OFFSET(0xCFD8400)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRCHANGEPOSSCRSP_OFFSET UNITYSDK_OFFSET(0xCFD7E90)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRGETDATASCRSP_OFFSET UNITYSDK_OFFSET(0xCFD3C90)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRHANDLEPENDINGACTIONSCRSP_OFFSET UNITYSDK_OFFSET(0xCFD7E20)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRQUITSTAGESCRSP_OFFSET UNITYSDK_OFFSET(0xCFD79D0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRREENTERSTAGESCRSP_OFFSET UNITYSDK_OFFSET(0xCFD7AE0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRREFRESHSHOPSCRSP_OFFSET UNITYSDK_OFFSET(0xCFD8450)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRSELLEQUIPSCRSP_OFFSET UNITYSDK_OFFSET(0xCFD8170)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRSTARTSTAGESCRSP_OFFSET UNITYSDK_OFFSET(0xCFD7730)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRSWAPEQUIPSCRSP_OFFSET UNITYSDK_OFFSET(0xCFD82D0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRSYNCCHANGESCNOTIFY_OFFSET UNITYSDK_OFFSET(0xCFD5080)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__ONPIXAIRUNLOCKPLANESCRSP_OFFSET UNITYSDK_OFFSET(0xCFD85A0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__PREPAREMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xCFD4E90)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__SHOULDSKIPPIXAIRLOADINGPAGE_OFFSET UNITYSDK_OFFSET(0xCFD78E0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__SHOWLOCKACTIONTOAST_OFFSET UNITYSDK_OFFSET(0xCFD2570)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__TRYCREATEENTERNEWAREAACTION_OFFSET UNITYSDK_OFFSET(0xCFD54A0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE__TRYMOVETOEMPTY_OFFSET UNITYSDK_OFFSET(0xCFD3450)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirModule_TypeDefinitionIndex = 75336;
	...
	public:
		...
		{
			return (::Class_1_A9D049FE853CBE53**)Il2CppClass::FromTypeDefinitionIndex(PixAirModule_TypeDefinitionIndex)->GetStaticField(0x68D80);
		}
		static ::Class_1_0C4B3F375A5A884B** StaticGet__crossContainerChecker()
		{
			return (::Class_1_0C4B3F375A5A884B**)Il2CppClass::FromTypeDefinitionIndex(PixAirModule_TypeDefinitionIndex)->GetStaticField(0x68D88);
		}
		static ::Class_1_61E0AF8862853482** StaticGet__crossContainerExecutor()
		{
			return (::Class_1_61E0AF8862853482**)Il2CppClass::FromTypeDefinitionIndex(PixAirModule_TypeDefinitionIndex)->GetStaticField(0x68D90);
		}
		static ::Class_1_EC26A837E803E0B5** StaticGet__sameContainerChecker()
		{
			return (::Class_1_EC26A837E803E0B5**)Il2CppClass::FromTypeDefinitionIndex(PixAirModule_TypeDefinitionIndex)->GetStaticField(0x68D98);
		}
		::RPG::Client::PixAir::PixAirStageInfo* _StageInfo_k__BackingField; // 0x10
		::RPG::Client::PixAir::PixAirPlaneInfo* _PlaneInfo_k__BackingField; // 0x18
		::RPG::Client::PixAir::PixAirAreaInfo* _AreaInfo_k__BackingField; // 0x20
		::RPG::Client::PixAir::PixAirEquipInfo* _EquipInfo_k__BackingField; // 0x28
		...
		::RPG::Client::PixAir::PixAirEquipShopManager* _EquipShopManager_k__BackingField; // 0x40
