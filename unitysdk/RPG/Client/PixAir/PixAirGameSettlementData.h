...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCFCD2F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_AREASCORE_OFFSET UNITYSDK_OFFSET(0xCFCD510)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0xCFCD5B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_FINALBATTLESCORE_OFFSET UNITYSDK_OFFSET(0xCFCD550)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0xCFCD4D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_LIFESCORE_OFFSET UNITYSDK_OFFSET(0xCFCD530)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_PLANEID_OFFSET UNITYSDK_OFFSET(0xCFCD590)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_REWARDS_OFFSET UNITYSDK_OFFSET(0xCFCD610)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xCFCD570)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_STOPPEDAREAINDEX_OFFSET UNITYSDK_OFFSET(0xCFCD5D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_TOTALAREACOUNT_OFFSET UNITYSDK_OFFSET(0xCFCD5F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0xCFCD4F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_AREASCORE_OFFSET UNITYSDK_OFFSET(0xCFCD520)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0xCFCD5C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_FINALBATTLESCORE_OFFSET UNITYSDK_OFFSET(0xCFCD560)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0xCFCD4E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_LIFESCORE_OFFSET UNITYSDK_OFFSET(0xCFCD540)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_PLANEID_OFFSET UNITYSDK_OFFSET(0xCFCD5A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_REWARDS_OFFSET UNITYSDK_OFFSET(0xCFCD620)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xCFCD580)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_STOPPEDAREAINDEX_OFFSET UNITYSDK_OFFSET(0xCFCD5E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_TOTALAREACOUNT_OFFSET UNITYSDK_OFFSET(0xCFCD600)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0xCFCD500)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SYNCAREAINFO_OFFSET UNITYSDK_OFFSET(0xCFCD3F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SYNCREWARDS_OFFSET UNITYSDK_OFFSET(0xCFCD450)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFCD3E0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSettlementData_TypeDefinitionIndex = 75332;
	...
	public:
		...
		::System::UInt32 _FinalBattleScore_k__BackingField; // 0x18
		::System::Int32 _TotalAreaCount_k__BackingField; // 0x1C
		::System::UInt32 _LifeScore_k__BackingField; // 0x20
		::System::Boolean _IsWin_k__BackingField; // 0x24
		::System::Int32 _StoppedAreaIndex_k__BackingField; // 0x28
		::System::UInt32 _StageID_k__BackingField; // 0x2C
		::System::UInt32 _AreaScore_k__BackingField; // 0x30
		::System::UInt32 _PlaneID_k__BackingField; // 0x34
		::System::UInt32 _CoreEquipID_k__BackingField; // 0x38
