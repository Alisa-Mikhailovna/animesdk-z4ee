...
#define RPG_CLIENT_PIXAIR_PIXAIREVENTSELECTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xCFC3620)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTSELECTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xCFC3880)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTSELECTACTION_GET_EVENTCONTENT_OFFSET UNITYSDK_OFFSET(0xCFC38F0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTSELECTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xCFC3900)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTSELECTACTION_SELECTOPTION_OFFSET UNITYSDK_OFFSET(0xCFC3690)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTSELECTACTION_START_OFFSET UNITYSDK_OFFSET(0xCFC35C0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC3590)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEventSelectAction_TypeDefinitionIndex = 75259;
