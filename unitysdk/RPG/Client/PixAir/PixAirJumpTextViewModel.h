...
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCFCFCA0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_GET_SIZE_OFFSET UNITYSDK_OFFSET(0xCFCFD90)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_GET_TEXTTYPE_OFFSET UNITYSDK_OFFSET(0xCFCFD70)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xCFCFDB0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_SET_SIZE_OFFSET UNITYSDK_OFFSET(0xCFCFDA0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_SET_TEXTTYPE_OFFSET UNITYSDK_OFFSET(0xCFCFD80)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xCFCFDC0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFCFD50)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirJumpTextViewModel_TypeDefinitionIndex = 75239;
