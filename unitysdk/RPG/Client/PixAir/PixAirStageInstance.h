...
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE_GETAREACOUNT_OFFSET UNITYSDK_OFFSET(0xCFC73A0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE_GETAREAINDEXBYID_OFFSET UNITYSDK_OFFSET(0xCFC72A0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE_GET_AREAINSTANCES_OFFSET UNITYSDK_OFFSET(0xCFE4C10)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE_GET_STAGEDATA_OFFSET UNITYSDK_OFFSET(0xCFE4BF0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xCFE4BD0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE_SET_AREAINSTANCES_OFFSET UNITYSDK_OFFSET(0xCFE4C20)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE_SET_STAGEDATA_OFFSET UNITYSDK_OFFSET(0xCFE4C00)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xCFE4BE0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xCFCB580)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE4C30)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirStageInstance_TypeDefinitionIndex = 75333;
