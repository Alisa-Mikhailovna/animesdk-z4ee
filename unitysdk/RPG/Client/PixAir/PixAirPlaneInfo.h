...
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xCFDC4B0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEINFO_GETALLPLANEDATA_OFFSET UNITYSDK_OFFSET(0xCFD74F0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEINFO_GETPLANEDATA_OFFSET UNITYSDK_OFFSET(0xCFD7630)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEINFO_GETSELECTABLEPLANEDATA_OFFSET UNITYSDK_OFFSET(0xCFD4BD0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xCFDC390)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEINFO_INIT_OFFSET UNITYSDK_OFFSET(0xCFD8E30)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEINFO_SYNCUNLOCKEDPLANES_OFFSET UNITYSDK_OFFSET(0xCFD47A0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEINFO_TRYGETPLANEDATA_OFFSET UNITYSDK_OFFSET(0xCFDC3E0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD8E20)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirPlaneInfo_TypeDefinitionIndex = 75343;
