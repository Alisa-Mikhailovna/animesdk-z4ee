...
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_CLEARCHANGE_OFFSET UNITYSDK_OFFSET(0xCFAF190)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCFAF050)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_GET_CHANGEAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAF030)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_GET_CURRENTAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAEFF0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_GET_FIXAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAF010)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SETFIXAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAF140)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SET_CHANGEAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAF040)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SET_CURRENTAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAF000)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SET_FIXAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAF020)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_UPDATEAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAF0F0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFAF0E0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirCurrencyData_TypeDefinitionIndex = 75287;
