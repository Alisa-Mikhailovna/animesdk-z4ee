...
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xCFAB5B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO_GET_CURRENTAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAB810)
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO_GET_FIXAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAB830)
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xCFAB7F0)
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO_ISEQUAL_OFFSET UNITYSDK_OFFSET(0xCFAB540)
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO_SET_CURRENTAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAB820)
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO_SET_FIXAMOUNT_OFFSET UNITYSDK_OFFSET(0xCFAB840)
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO_SET_MAXHP_OFFSET UNITYSDK_OFFSET(0xCFAB800)
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO_SYNCCURRENTINFO_OFFSET UNITYSDK_OFFSET(0xCFAB750)
#define RPG_CLIENT_PIXAIR_PIXAIRBASICINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCFAB740)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBasicInfo_TypeDefinitionIndex = 75286;
