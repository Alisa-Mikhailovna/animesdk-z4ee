...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xCFAD230)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xCFAD2C0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_GET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0xCFAD2A0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_SET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0xCFAD2B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_START_OFFSET UNITYSDK_OFFSET(0xCFACF80)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFACF70)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION__ONDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0xCFAD130)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleSettlementAction_TypeDefinitionIndex = 75255;
