...
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_GETTEXTHINT_OFFSET UNITYSDK_OFFSET(0xCFD0E80)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISBUYEQUIPALLOWED_OFFSET UNITYSDK_OFFSET(0xCFD0DC0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISCONTENTSELECTALLOWED_OFFSET UNITYSDK_OFFSET(0xCFD0BD0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISSELLEQUIPALLOWED_OFFSET UNITYSDK_OFFSET(0xCFD0E20)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__CHECKACTION_OFFSET UNITYSDK_OFFSET(0xCFD0C20)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC83D0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__GETCURRENTROWS_OFFSET UNITYSDK_OFFSET(0xCFD0FF0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLockActionChecker_TypeDefinitionIndex = 75317;
