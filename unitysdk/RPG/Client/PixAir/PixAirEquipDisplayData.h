...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCFA5980)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0xCFB7320)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xCFB7280)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0xCFB7340)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCFB72D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_SET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0xCFB7330)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_SET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0xCFB7350)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFB71D0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipDisplayData_TypeDefinitionIndex = 75274;
