...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_GET_ENCHANT_OFFSET UNITYSDK_OFFSET(0x6E30)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x6E20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0x6010)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_SET_ENCHANT_OFFSET UNITYSDK_OFFSET(0x6E40)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_SET_ID_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x2A90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_SET_TAGLIST_OFFSET UNITYSDK_OFFSET(0x94F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSession_PixAirEquipmentReportInfo_TypeDefinitionIndex = 75323;
