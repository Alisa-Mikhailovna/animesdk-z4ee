...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCFAD410)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_ENEMYEQUIPOVERVIEWVM_OFFSET UNITYSDK_OFFSET(0xCFAD910)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_ENEMYPLANESTATUSVM_OFFSET UNITYSDK_OFFSET(0xCFAD8D0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_EXITCOMMAND_OFFSET UNITYSDK_OFFSET(0xCFAD890)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_PLAYEREQUIPOVERVIEWVM_OFFSET UNITYSDK_OFFSET(0xCFAD8F0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_PLAYERPLANESTATUSVM_OFFSET UNITYSDK_OFFSET(0xCFAD8B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_ENEMYEQUIPOVERVIEWVM_OFFSET UNITYSDK_OFFSET(0xCFAD920)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_ENEMYPLANESTATUSVM_OFFSET UNITYSDK_OFFSET(0xCFAD8E0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_EXITCOMMAND_OFFSET UNITYSDK_OFFSET(0xCFAD8A0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_PLAYEREQUIPOVERVIEWVM_OFFSET UNITYSDK_OFFSET(0xCFAD900)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_PLAYERPLANESTATUSVM_OFFSET UNITYSDK_OFFSET(0xCFAD8C0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFAD4D0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xCFAD4F0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL__ONEXIT_OFFSET UNITYSDK_OFFSET(0xCFAD780)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleViewModel_TypeDefinitionIndex = 75232;

	class PixAirBattleViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::RPG::Client::PixAir::PixAirEquipOverviewViewModel* _EnemyEquipOverviewVM_k__BackingField; // 0x20
		::RPG::Client::PixAir::PixAirGhostManager* _GhostManager; // 0x28
		...
		::RPG::Client::PixAir::PixAirPlaneStatusViewModel* _EnemyPlaneStatusVM_k__BackingField; // 0x48
		::Sofa::Core::SimpleCommand* _ExitCommand_k__BackingField; // 0x50
