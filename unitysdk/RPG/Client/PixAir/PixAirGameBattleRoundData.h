...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCFC4500)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_BATTLEID_OFFSET UNITYSDK_OFFSET(0xCFC4A80)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_ENEMYDATA_OFFSET UNITYSDK_OFFSET(0xCFC4AA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_ENEMYHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xCFC4AC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_LOOTCOINICONPATH_OFFSET UNITYSDK_OFFSET(0xCFC4B20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_LOOTCOINNUM_OFFSET UNITYSDK_OFFSET(0xCFC4B00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_PLAYERHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xCFC4AE0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_BATTLEID_OFFSET UNITYSDK_OFFSET(0xCFC4A90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_ENEMYDATA_OFFSET UNITYSDK_OFFSET(0xCFC4AB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_ENEMYHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xCFC4AD0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_LOOTCOINICONPATH_OFFSET UNITYSDK_OFFSET(0xCFC4B30)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_LOOTCOINNUM_OFFSET UNITYSDK_OFFSET(0xCFC4B10)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_PLAYERHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xCFC4AF0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC45A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA__INIT_OFFSET UNITYSDK_OFFSET(0xCFC45C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA__NORMALIZEHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xCFC4980)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameBattleRoundData_TypeDefinitionIndex = 75290;
	...
	public:
		...
		::System::UInt32 _LootCoinNum_k__BackingField; // 0x30
		::System::UInt32 _BattleID_k__BackingField; // 0x34
