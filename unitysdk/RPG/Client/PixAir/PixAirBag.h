...
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_ADDNEWEQUIP_OFFSET UNITYSDK_OFFSET(0xCFA80F0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_CREATE_OFFSET UNITYSDK_OFFSET(0xCFA7940)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_FINDSLOTBYEQUIPUID_OFFSET UNITYSDK_OFFSET(0xCFA93B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_FINDSLOTBYPOSITION_OFFSET UNITYSDK_OFFSET(0xCFA8F20)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GETCAPACITY_OFFSET UNITYSDK_OFFSET(0xCFA78F0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GETEQUIPINSTANCEBYUID_OFFSET UNITYSDK_OFFSET(0xCFA7150)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GETEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFA7230)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET_COLUMNCOUNT_OFFSET UNITYSDK_OFFSET(0xCFA6DE0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET_OCCUPIEDSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0xCFA6EA0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0xCFA6C60)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET_TOTALSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0xCFA6E50)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET__CAPACITY_OFFSET UNITYSDK_OFFSET(0xCFA6C80)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET__COLUMNCOUNT_OFFSET UNITYSDK_OFFSET(0xCFA6D90)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_HASRECOMMENDEQUIP_OFFSET UNITYSDK_OFFSET(0xCFA7420)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_REPLACESLOTWITHEMPTY_OFFSET UNITYSDK_OFFSET(0xCFA9BD0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_REPLACESLOTWITHEQUIP_OFFSET UNITYSDK_OFFSET(0xCFA9730)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_SET_SLOTS_OFFSET UNITYSDK_OFFSET(0xCFA6C70)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_SYNC_OFFSET UNITYSDK_OFFSET(0xCFA84C0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG__CTOR_OFFSET UNITYSDK_OFFSET(0xCFA7140)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG__RELEASESLOTS_OFFSET UNITYSDK_OFFSET(0xCFA8750)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG__TRYGETEQUIPINFOBYSLOTINDEX_OFFSET UNITYSDK_OFFSET(0xCFA89E0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBag_TypeDefinitionIndex = 75294;
