...
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xCFA60B0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_GETALLAREADATA_OFFSET UNITYSDK_OFFSET(0xCFA6140)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_GETAREADATA_OFFSET UNITYSDK_OFFSET(0xCFA5F30)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xCFA5EE0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_INIT_OFFSET UNITYSDK_OFFSET(0xCFA6260)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_TRYGETAREADATA_OFFSET UNITYSDK_OFFSET(0xCFA5FE0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCFA64B0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirAreaInfo_TypeDefinitionIndex = 75272;
