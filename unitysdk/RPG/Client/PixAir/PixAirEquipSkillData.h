...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSKILLDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCFB9C20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSKILLDATA_GETDESC_OFFSET UNITYSDK_OFFSET(0xCFB9AE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSKILLDATA_GET_SKILLDESCTEXTID_OFFSET UNITYSDK_OFFSET(0xCFB9A70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSKILLDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xCFBE9B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSKILLDATA_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0xCFBE9C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFBE930)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSKILLDATA__INIT_OFFSET UNITYSDK_OFFSET(0xCFBE940)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipSkillData_TypeDefinitionIndex = 75277;
