...
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE_GETATTRIBUTEASINT_OFFSET UNITYSDK_OFFSET(0xCFCD670)
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCFCD630)
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCFCD640)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGhostBase_TypeDefinitionIndex = 75166;
