...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GETSKILLDESCLIST_OFFSET UNITYSDK_OFFSET(0xCFBC630)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GETSKILLDESC_OFFSET UNITYSDK_OFFSET(0xCFBC580)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA120)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_CHARGEPOWER_OFFSET UNITYSDK_OFFSET(0xCFBCEE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xCFBA240)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xCFB9DE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_DISPLAYTAGLIST_OFFSET UNITYSDK_OFFSET(0xCFBCC10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_EQUIPICON_OFFSET UNITYSDK_OFFSET(0xCFBCA30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xCFBC860)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_EQUIPLEVEL_OFFSET UNITYSDK_OFFSET(0xCFBC880)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_HASTEPOWER_OFFSET UNITYSDK_OFFSET(0xCFBCE40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_ISCORE_OFFSET UNITYSDK_OFFSET(0xCFBCAD0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_JAMPOWER_OFFSET UNITYSDK_OFFSET(0xCFBCF80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_MULTIPOWER_OFFSET UNITYSDK_OFFSET(0xCFBCDA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCFBC970)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xCFB9F80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0xCFBD020)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_SLOTTYPE_OFFSET UNITYSDK_OFFSET(0xCFB9350)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0xCFBCB70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET__EQUIPROW_OFFSET UNITYSDK_OFFSET(0xCFBC910)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCFBC8A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_SET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xCFBC870)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_SET_EQUIPLEVEL_OFFSET UNITYSDK_OFFSET(0xCFBC890)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xCFB71E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFBD0C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPLEVELDATA__INIT_OFFSET UNITYSDK_OFFSET(0xCFBC410)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipLevelData_TypeDefinitionIndex = 75276;
