...
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER_PLAY_OFFSET UNITYSDK_OFFSET(0xCFE60A0)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER_SETPOINTS_OFFSET UNITYSDK_OFFSET(0xCFE5AB0)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__ASSIGNBYSCREENPOS_OFFSET UNITYSDK_OFFSET(0xCFE5FE0)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__CALCULATERANDOMMIDDLESCREENPOS_OFFSET UNITYSDK_OFFSET(0xCFE5DA0)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE6420)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__GETPLANERECT_OFFSET UNITYSDK_OFFSET(0xCFE5D10)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__GETUICAMERA_OFFSET UNITYSDK_OFFSET(0xCFE5F60)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTrailPointPositioner_TypeDefinitionIndex = 75365;
