...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_CREATEENEMYPLANESNAPSHOTS_OFFSET UNITYSDK_OFFSET(0xCFAC520)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_CREATEPLAYERPLANESNAPSHOT_OFFSET UNITYSDK_OFFSET(0xCFAC050)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_ENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xCFAB9C0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xCFABD60)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xCFABCF0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_GET_BATTLEROUNDINFO_OFFSET UNITYSDK_OFFSET(0xCFAC760)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xCFAC770)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_RESOLVEBATTLE_1_OFFSET UNITYSDK_OFFSET(0xCFABE20)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_RESOLVEBATTLE_OFFSET UNITYSDK_OFFSET(0xCFABDD0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_START_OFFSET UNITYSDK_OFFSET(0xCFAB960)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFAB850)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__DOENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xCFABC00)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__REPORTPIXAIRWAVEBATTLESTART_OFFSET UNITYSDK_OFFSET(0xCFABA10)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleAction_TypeDefinitionIndex = 75254;
