...
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCFAF660)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_AREAID_OFFSET UNITYSDK_OFFSET(0xCFAFA50)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_ENEMYHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xCFAF8A0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_ENEMYNAME_OFFSET UNITYSDK_OFFSET(0xCFAF7C0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_ENEMYTALKCONTENT_OFFSET UNITYSDK_OFFSET(0xCFAF9C0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_PLAYERNAME_OFFSET UNITYSDK_OFFSET(0xCFAF750)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_PLAYERTALKCONTENT_OFFSET UNITYSDK_OFFSET(0xCFAF930)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET__ENEMYROUNDINFODATA_OFFSET UNITYSDK_OFFSET(0xCFAF850)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFAF720)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEnterBattleLoadingViewModel_TypeDefinitionIndex = 75233;
	...
	public:
		...
		::Class_1_68EB032547196D7A* _GameBattleRoundInfo; // 0x30
