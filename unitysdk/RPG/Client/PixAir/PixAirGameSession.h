...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDBAGEQUIPMENTINFOLIST_OFFSET UNITYSDK_OFFSET(0xCFC6A20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDBATTLEREPORTINFO_OFFSET UNITYSDK_OFFSET(0xCFC6970)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDEQUIPPEDEQUIPMENTINFOLIST_OFFSET UNITYSDK_OFFSET(0xCFC6F80)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDPLANEREPORTINFO_OFFSET UNITYSDK_OFFSET(0xCFC65E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDSTAGEREPORTINFO_OFFSET UNITYSDK_OFFSET(0xCFC6750)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CHECKBASICCOSTENOUGH_OFFSET UNITYSDK_OFFSET(0xCFC33C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CHECKEQUIPCANLEVELUP_OFFSET UNITYSDK_OFFSET(0xCFCAB20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CHECKPENDINGACTIONCANLEVELUP_OFFSET UNITYSDK_OFFSET(0xCFCACD0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CREATE_OFFSET UNITYSDK_OFFSET(0xCFC80F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_DEQUEUEACTION_OFFSET UNITYSDK_OFFSET(0xCFC7820)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCFCCD90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_ENQUEUEACTION_OFFSET UNITYSDK_OFFSET(0xCFC7690)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GENERATEBROADCASTTEXT_OFFSET UNITYSDK_OFFSET(0xCFCC0D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GETEQUIPINSTANCEBYUID_OFFSET UNITYSDK_OFFSET(0xCFC9600)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GETSLOTTYPEBYSERVERINDEX_OFFSET UNITYSDK_OFFSET(0xCFCAAC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_ALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCFC7440)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_AREACOUNT_OFFSET UNITYSDK_OFFSET(0xCFC7310)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_BAG_OFFSET UNITYSDK_OFFSET(0xCFC7580)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0xCFC75A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xCFC75C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENCY_OFFSET UNITYSDK_OFFSET(0xCFC7BA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTAREAINDEX_OFFSET UNITYSDK_OFFSET(0xCFC71E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTAREA_OFFSET UNITYSDK_OFFSET(0xCFC71C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTNODE_OFFSET UNITYSDK_OFFSET(0xCFC6870)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0xCFC71A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_EQUIPBAR_OFFSET UNITYSDK_OFFSET(0xCFC7560)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_LASTALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCFC7400)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_LIFE_OFFSET UNITYSDK_OFFSET(0xCFC7AB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_LOCKACTIONCHECKER_OFFSET UNITYSDK_OFFSET(0xCFC7C00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_MAXLIFE_OFFSET UNITYSDK_OFFSET(0xCFC7AD0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_OLDALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCFC7420)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PENDINGACTIONQUEUE_OFFSET UNITYSDK_OFFSET(0xCFC7670)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PENDINGACTION_OFFSET UNITYSDK_OFFSET(0xCFC75E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PLANE_OFFSET UNITYSDK_OFFSET(0xCFC7BC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_SEENEQUIPIDS_OFFSET UNITYSDK_OFFSET(0xCFC7C20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_SELLANDREFRESHLOCKER_OFFSET UNITYSDK_OFFSET(0xCFC7BE0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_TOTALPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCFC7460)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_TRANSNO_OFFSET UNITYSDK_OFFSET(0xCFC7180)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_MARKALLBAGEQUIPSEEN_OFFSET UNITYSDK_OFFSET(0xCFC7C90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_MARKEQUIPSEEN_OFFSET UNITYSDK_OFFSET(0xCFC7C30)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_ALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCFC7450)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_BAG_OFFSET UNITYSDK_OFFSET(0xCFC7590)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0xCFC75B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xCFC75D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRENCY_OFFSET UNITYSDK_OFFSET(0xCFC7BB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRENTAREA_OFFSET UNITYSDK_OFFSET(0xCFC71D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0xCFC71B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_EQUIPBAR_OFFSET UNITYSDK_OFFSET(0xCFC7570)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_LASTALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCFC7410)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_LIFE_OFFSET UNITYSDK_OFFSET(0xCFC7AC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_LOCKACTIONCHECKER_OFFSET UNITYSDK_OFFSET(0xCFC7C10)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_OLDALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCFC7430)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_PENDINGACTIONQUEUE_OFFSET UNITYSDK_OFFSET(0xCFC7680)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_PLANE_OFFSET UNITYSDK_OFFSET(0xCFC7BD0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_SELLANDREFRESHLOCKER_OFFSET UNITYSDK_OFFSET(0xCFC7BF0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_TRANSNO_OFFSET UNITYSDK_OFFSET(0xCFC7190)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xCFC88F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCBASICCHANGE_OFFSET UNITYSDK_OFFSET(0xCFCB780)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCENTERNEWNODE_OFFSET UNITYSDK_OFFSET(0xCFCB6C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCEQUIPCHANGE_OFFSET UNITYSDK_OFFSET(0xCFC9210)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCEQUIPREMOVE_OFFSET UNITYSDK_OFFSET(0xCFCA7B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCSWAPEQUIP_OFFSET UNITYSDK_OFFSET(0xCFC9AF0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNC_OFFSET UNITYSDK_OFFSET(0xCFC83E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__ADDNEWEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFC9680)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__BUILDEQUIPMENTREPORTINFO_OFFSET UNITYSDK_OFFSET(0xCFC6E00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CANLEVELUPFROMSHOPACTION_OFFSET UNITYSDK_OFFSET(0xCFCB090)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CHECKBASICINFO_OFFSET UNITYSDK_OFFSET(0xCFCB280)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CHECKPENDINGACTIONCANLEVELUP_G__MATCHLEVELUPSOURCE_111_0_OFFSET UNITYSDK_OFFSET(0xCFCB080)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CREATEEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFCB660)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC8270)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__GETMODULE_OFFSET UNITYSDK_OFFSET(0xCFCB1F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__INITBROADCASTCANDIDATES_OFFSET UNITYSDK_OFFSET(0xCFC85A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__INITSEENEQUIPIDS_OFFSET UNITYSDK_OFFSET(0xCFC7F30)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__LOGALLSLOTINDICES_OFFSET UNITYSDK_OFFSET(0xCFCA280)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__MARKALLEQUIPBAREQUIPSEEN_OFFSET UNITYSDK_OFFSET(0xCFC7F80)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__MARKAUTOEQUIPPEDASSEEN_OFFSET UNITYSDK_OFFSET(0xCFC9980)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__REPLACESLOTWITHEMPTYBYSERVERPOSITION_OFFSET UNITYSDK_OFFSET(0xCFCA150)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__REPLACESLOTWITHEQUIPBYSERVERPOSITION_OFFSET UNITYSDK_OFFSET(0xCFCA1E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCAREA_OFFSET UNITYSDK_OFFSET(0xCFC8B20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCBASICINFO_OFFSET UNITYSDK_OFFSET(0xCFCBBB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCBASIC_OFFSET UNITYSDK_OFFSET(0xCFC8CA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCCURRENCY_OFFSET UNITYSDK_OFFSET(0xCFCBDB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCEQUIPINFO_OFFSET UNITYSDK_OFFSET(0xCFC9780)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCEQUIPMGR_OFFSET UNITYSDK_OFFSET(0xCFC9090)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCINCOME_OFFSET UNITYSDK_OFFSET(0xCFCBF00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCNODE_OFFSET UNITYSDK_OFFSET(0xCFC8C40)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCPENDINGACTION_OFFSET UNITYSDK_OFFSET(0xCFC9170)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xCFC8870)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCSTAGE_OFFSET UNITYSDK_OFFSET(0xCFC8950)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSession_TypeDefinitionIndex = 75322;
	...
	public:
		...
		::System::Random* _BroadcastRandom; // 0x20
		::System::String* _TransNo_k__BackingField; // 0x28
		...
		::RPG::Client::PixAir::PixAirStageInstance* _CurrentStage_k__BackingField; // 0x40
		::System::Collections::Generic::List_1<::Class_1_7291C38274750BA2_5*>* _BroadcastCandidates; // 0x48
		::RPG::Client::PixAir::PixAirLockActionChecker* _LockActionChecker_k__BackingField; // 0x50
		::System::Collections::Generic::Queue_1<::Class_0_16E4307DCC419505_1257*>* _PendingActionQueue_k__BackingField; // 0x58
		::System::Collections::Generic::List_1<::Class_1_7291C38274750BA2_5*>* _BroadcastDeadCandidates; // 0x60
		::RPG::Client::PixAir::PixAirBag* _Bag_k__BackingField; // 0x68
		::Class_1_3F6BDFD89C2271F6* _previewService; // 0x70
		::RPG::Client::PixAir::PixAirSellAndRefreshLocker* _SellAndRefreshLocker_k__BackingField; // 0x78
		::RPG::Client::PixAir::PixAirCurrencyData* _Currency_k__BackingField; // 0x80
		::RPG::Client::PixAir::PixAirAreaInstance* _CurrentArea_k__BackingField; // 0x88
		...
		::System::UInt32 _AlivePlayerCount_k__BackingField; // 0x9C
