...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_GET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0x14ED60)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_GET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x14ED90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_SET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0x14ED80)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_SET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x14EDB0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSession_PixAirBattleReportInfo_TypeDefinitionIndex = 75326;
