...
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCFD0860)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_TRYSHOWHINT_OFFSET UNITYSDK_OFFSET(0xCFCFDD0)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xCFD0750)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD0A80)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW__GETSORTEDCOMMONSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xCFD00E0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLevelProgressView_TypeDefinitionIndex = 75360;
