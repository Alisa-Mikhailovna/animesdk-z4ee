...
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xCFD9EC0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTITEM__CREATEBATTLEITEM_OFFSET UNITYSDK_OFFSET(0xCFDA520)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTITEM__CREATEEVENTITEM_OFFSET UNITYSDK_OFFSET(0xCFDA410)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTITEM__CREATESHOPITEM_OFFSET UNITYSDK_OFFSET(0xCFDA1D0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTITEM__CREATESUPPLYITEM_OFFSET UNITYSDK_OFFSET(0xCFDA2F0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCFDA630)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTITEM__GENERATECONTENTDESC_OFFSET UNITYSDK_OFFSET(0xCFDA640)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeContentSelectItem_TypeDefinitionIndex = 75264;
	...
	public:
		...
		::RPG::GameCore::PixAirContentRarity Rarity; // 0x20
		::System::UInt32 ContentID; // 0x24
		::RPG::Client::TextID ContentName; // 0x28
		::RPG::GameCore::PixAirContentType ContentType; // 0x38
