...
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0xCFA5D00)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xCFA5E20)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET_NODEIDLIST_OFFSET UNITYSDK_OFFSET(0xCFA5D80)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCFA5D20)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_SET_AREAID_OFFSET UNITYSDK_OFFSET(0xCFA5D10)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xCFA5E30)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xCFA5E40)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFA5ED0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirAreaData_TypeDefinitionIndex = 75271;
