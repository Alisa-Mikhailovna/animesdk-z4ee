...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_CLONE_1_OFFSET UNITYSDK_OFFSET(0xCFBA9B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_CLONE_OFFSET UNITYSDK_OFFSET(0xCFBA960)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_CREATEUPGRADE_OFFSET UNITYSDK_OFFSET(0xCFAF4C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GETSKILLDESCLIST_OFFSET UNITYSDK_OFFSET(0xCFB9560)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GETSKILLDESC_OFFSET UNITYSDK_OFFSET(0xCFB94B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALBURNPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA320)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALDAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA2E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALJAMPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA380)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALMULTICASTPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA340)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALSHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA300)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BASECOOLDOWNREDUCTION_OFFSET UNITYSDK_OFFSET(0xCFBA360)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BURNBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA3E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BURNFROMDAMAGEPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA480)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BURNFROMSHIELDPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA4A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA020)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xCFBA1C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_DAMAGEBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA3A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_DAMAGEFROMBURNPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA420)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_DAMAGEFROMSHIELDPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA400)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xCFB9CE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0xCFB9200)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0xCFA55C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xCFB91C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_EQUIPLEVELDATA_OFFSET UNITYSDK_OFFSET(0xCFB9240)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_EQUIPLEVEL_OFFSET UNITYSDK_OFFSET(0xCFB91E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_FINALBURNPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA5C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_FINALDAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA4C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_FINALSHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA540)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_HASBURN_OFFSET UNITYSDK_OFFSET(0xCFBA7A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_HASCOOLDOWN_OFFSET UNITYSDK_OFFSET(0xCFBA850)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_HASDAMAGE_OFFSET UNITYSDK_OFFSET(0xCFBA640)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_HASSHIELD_OFFSET UNITYSDK_OFFSET(0xCFBA6F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xCFB9220)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SELLPRICE_OFFSET UNITYSDK_OFFSET(0xCFB93F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SHIELDBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA3C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SHIELDFROMBURNPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA460)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SHIELDFROMDAMAGEPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA440)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xCFB9E80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SIZE_OFFSET UNITYSDK_OFFSET(0xCFBA900)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SLOTTYPE_OFFSET UNITYSDK_OFFSET(0xCFB92F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xCFB91A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_HASPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0xCFBABE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_HASPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCFBAB70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_RESETADDITIONALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0xCFBAC40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALBURNPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA330)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALDAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA2F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALJAMPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA390)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALMULTICASTPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA350)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALSHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xCFBA310)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_BASECOOLDOWNREDUCTION_OFFSET UNITYSDK_OFFSET(0xCFBA370)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_BURNBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA3F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_BURNFROMDAMAGEPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA490)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_BURNFROMSHIELDPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA4B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_DAMAGEBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA3B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_DAMAGEFROMBURNPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA430)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_DAMAGEFROMSHIELDPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA410)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0xCFB9210)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xCFB91D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_EQUIPLEVEL_OFFSET UNITYSDK_OFFSET(0xCFB91F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_POSITION_OFFSET UNITYSDK_OFFSET(0xCFB9230)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_SHIELDBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA3D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_SHIELDFROMBURNPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA470)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_SHIELDFROMDAMAGEPERCENT_OFFSET UNITYSDK_OFFSET(0xCFBA450)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xCFB91B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SYNCPOSITION_OFFSET UNITYSDK_OFFSET(0xCFBAB20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SYNC_OFFSET UNITYSDK_OFFSET(0xCFBAAB0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xCFA8E70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCFBA950)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipInstance_TypeDefinitionIndex = 75301;
	...
	public:
		...
		::RPG::GameCore::FixPoint _DamageBoostPercent_k__BackingField; // 0x28
		...
		::RPG::GameCore::FixPoint _BurnFromShieldPercent_k__BackingField; // 0x40
		::System::Int32 _AdditionalShieldPower_k__BackingField; // 0x48
		::RPG::GameCore::PixAirEnchantmentType _EnchantType_k__BackingField; // 0x4C
		::RPG::GameCore::FixPoint _ShieldBoostPercent_k__BackingField; // 0x50
		::RPG::GameCore::FixPoint _DamageFromBurnPercent_k__BackingField; // 0x58
		::System::UInt32 _UniqueID_k__BackingField; // 0x60
		::System::Int32 _AdditionalJamPower_k__BackingField; // 0x64
		::RPG::GameCore::FixPoint _ShieldFromBurnPercent_k__BackingField; // 0x68
		::System::UInt32 _EquipLevel_k__BackingField; // 0x70
		::System::Int32 _AdditionalDamagePower_k__BackingField; // 0x74
		::System::UInt32 _EquipID_k__BackingField; // 0x78
		::System::UInt32 _Position_k__BackingField; // 0x7C
		::System::Int32 _AdditionalBurnPower_k__BackingField; // 0x80
