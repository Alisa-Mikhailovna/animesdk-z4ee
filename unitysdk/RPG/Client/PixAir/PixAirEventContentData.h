...
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCFC2BE0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0xCFC3270)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA_GET_EVENTDESC_OFFSET UNITYSDK_OFFSET(0xCFC32B0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA_GET_EVENTTITLE_OFFSET UNITYSDK_OFFSET(0xCFC3290)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0xCFC32D0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA_SET_CONTENTID_OFFSET UNITYSDK_OFFSET(0xCFC3280)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA_SET_EVENTDESC_OFFSET UNITYSDK_OFFSET(0xCFC32C0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA_SET_EVENTTITLE_OFFSET UNITYSDK_OFFSET(0xCFC32A0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0xCFC32E0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTCONTENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC3180)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEventContentData_TypeDefinitionIndex = 75315;
	...
	public:
		...
		::RPG::Client::TextID _EventTitle_k__BackingField; // 0x20
