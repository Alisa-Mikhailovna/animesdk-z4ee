...
#define RPG_CLIENT_PIXAIR_PIXAIRFAKEBATTLEACTION_CREATEENEMYPLANESNAPSHOTS_OFFSET UNITYSDK_OFFSET(0xCFC4150)
#define RPG_CLIENT_PIXAIR_PIXAIRFAKEBATTLEACTION_CREATEPLAYERPLANESNAPSHOT_OFFSET UNITYSDK_OFFSET(0xCFC3970)
#define RPG_CLIENT_PIXAIR_PIXAIRFAKEBATTLEACTION_GET_BATTLEROUNDINFO_OFFSET UNITYSDK_OFFSET(0xCFC3960)
#define RPG_CLIENT_PIXAIR_PIXAIRFAKEBATTLEACTION_RESOLVEBATTLE_OFFSET UNITYSDK_OFFSET(0xCFC43E0)
#define RPG_CLIENT_PIXAIR_PIXAIRFAKEBATTLEACTION__CREATEEQUIPMENTSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xCFC4450)
#define RPG_CLIENT_PIXAIR_PIXAIRFAKEBATTLEACTION__CREATEPLANESNAPSHOT_OFFSET UNITYSDK_OFFSET(0xCFC3A40)
#define RPG_CLIENT_PIXAIR_PIXAIRFAKEBATTLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC3950)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirFakeBattleAction_TypeDefinitionIndex = 75260;
