...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCFAD310)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_GET_ENEMYSTATISTICS_OFFSET UNITYSDK_OFFSET(0xCFAD3F0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0xCFAD3B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_GET_PLAYERSTATISTICS_OFFSET UNITYSDK_OFFSET(0xCFAD3D0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_SET_ENEMYSTATISTICS_OFFSET UNITYSDK_OFFSET(0xCFAD400)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0xCFAD3C0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_SET_PLAYERSTATISTICS_OFFSET UNITYSDK_OFFSET(0xCFAD3E0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFAD3A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleSettlementData_TypeDefinitionIndex = 75331;
