...
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCFDF190)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_BURNCOUNTTEXT_OFFSET UNITYSDK_OFFSET(0xCFDEED0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_BURNCOUNT_OFFSET UNITYSDK_OFFSET(0xCFDFAE0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_CURRENTHPTEXT_OFFSET UNITYSDK_OFFSET(0xCFDFC00)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0xCFDFA00)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_HPINFOTEXT_OFFSET UNITYSDK_OFFSET(0xCFDEC90)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_HPPERCENT_OFFSET UNITYSDK_OFFSET(0xCFDF090)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_MAXHPTEXT_OFFSET UNITYSDK_OFFSET(0xCFDFB50)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xCFDF990)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_SHIELDTEXT_OFFSET UNITYSDK_OFFSET(0xCFDEE20)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_SHIELD_OFFSET UNITYSDK_OFFSET(0xCFDFA70)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFDF240)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xCFDF260)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL__ONGHOSTPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCFDF360)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirPlaneStatusViewModel_TypeDefinitionIndex = 75240;
