...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCFBEA60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_GET_BEFOREINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFBEA20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_GET_CURRENTINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFBEA40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_SET_BEFOREINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFBEA30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_SET_CURRENTINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFBEA50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFBEB00)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipUpgradeViewModel_TypeDefinitionIndex = 75302;
