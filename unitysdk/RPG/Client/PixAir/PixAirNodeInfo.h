...
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xCFDAD70)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_GETALLNODEDATA_OFFSET UNITYSDK_OFFSET(0xCFDAE00)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_GETNODEDATA_OFFSET UNITYSDK_OFFSET(0xCFDABF0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xCFDABA0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_INIT_OFFSET UNITYSDK_OFFSET(0xCFD8BD0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_TRYGETNODEDATA_OFFSET UNITYSDK_OFFSET(0xCFDACA0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD8BC0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeInfo_TypeDefinitionIndex = 75335;
