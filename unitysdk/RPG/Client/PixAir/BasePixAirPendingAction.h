...
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xCFA5790)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_GETACTIONID_OFFSET UNITYSDK_OFFSET(0xCFA56D0)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xCFA57E0)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_GETISFINISHED_OFFSET UNITYSDK_OFFSET(0xCFA5710)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_START_OFFSET UNITYSDK_OFFSET(0xCFA5750)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFA56C0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int BasePixAirPendingAction_TypeDefinitionIndex = 75253;
