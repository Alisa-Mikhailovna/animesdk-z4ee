...
#define RPG_CLIENT_PIXAIR_PIXAIRBAGSLOTLISTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFAB100)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGSLOTLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFAB1E0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGSLOTLISTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFAAF30)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGSLOTLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCFAADD0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBagSlotListControl_TypeDefinitionIndex = 75199;
