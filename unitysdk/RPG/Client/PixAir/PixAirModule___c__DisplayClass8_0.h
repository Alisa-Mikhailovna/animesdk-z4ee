...
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD2E70)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE___C__DISPLAYCLASS8_0___ISBUYBLOCKEDBYSLOTSFULL_B__0_OFFSET UNITYSDK_OFFSET(0xCFD9A10)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE___C__DISPLAYCLASS8_0___ISBUYBLOCKEDBYSLOTSFULL_B__1_OFFSET UNITYSDK_OFFSET(0xCFD9A30)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirModule___c__DisplayClass8_0_TypeDefinitionIndex = 75338;
