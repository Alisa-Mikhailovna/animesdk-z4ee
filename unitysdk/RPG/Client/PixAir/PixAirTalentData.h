...
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xCFE52F0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCFE52D0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_GET_PARAMMAP_OFFSET UNITYSDK_OFFSET(0xCFE5370)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_GET_PRETALENTLIST_OFFSET UNITYSDK_OFFSET(0xCFE5310)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xCFE5350)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_GET_TALENTID_OFFSET UNITYSDK_OFFSET(0xCFE52B0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_GET_UNLOCKSCORE_OFFSET UNITYSDK_OFFSET(0xCFE5330)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_SETUNLOCKED_OFFSET UNITYSDK_OFFSET(0xCFE55F0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_SET_DESC_OFFSET UNITYSDK_OFFSET(0xCFE5300)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xCFE52E0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_SET_PARAMMAP_OFFSET UNITYSDK_OFFSET(0xCFE5380)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_SET_PRETALENTLIST_OFFSET UNITYSDK_OFFSET(0xCFE5320)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_SET_STATUS_OFFSET UNITYSDK_OFFSET(0xCFE5360)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_SET_TALENTID_OFFSET UNITYSDK_OFFSET(0xCFE52C0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_SET_UNLOCKSCORE_OFFSET UNITYSDK_OFFSET(0xCFE5340)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_SYNCCURRENTSCORE_OFFSET UNITYSDK_OFFSET(0xCFE55A0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xCFE5390)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE5560)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTalentData_TypeDefinitionIndex = 75351;
	...
	public:
		...
		::RPG::Client::PixAir::PixAirTalentStatus _Status_k__BackingField; // 0x50
