...
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER_ACQUIREJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xCFE27C0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIREJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xCFE29C0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIRELARGEJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xCFE2E00)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIRESMALLJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xCFE2D80)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE2FC0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xCFE2A40)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__GETRANDOMJUMPTEXTPOSITION_OFFSET UNITYSDK_OFFSET(0xCFE2BE0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__INSTANTIATEJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xCFE2F60)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirRectTransformBoundsLimiter_TypeDefinitionIndex = 75364;
