...
#define RPG_CLIENT_PIXAIR_PIXAIRUPGRADELEVELACTION_CREATEUPGRADEEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFE67A0)
#define RPG_CLIENT_PIXAIR_PIXAIRUPGRADELEVELACTION_FINISHUPGRADELEVEL_OFFSET UNITYSDK_OFFSET(0xCFE6750)
#define RPG_CLIENT_PIXAIR_PIXAIRUPGRADELEVELACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xCFE6800)
#define RPG_CLIENT_PIXAIR_PIXAIRUPGRADELEVELACTION_GET_MAXUPGRADELEVEL_OFFSET UNITYSDK_OFFSET(0xCFE6850)
#define RPG_CLIENT_PIXAIR_PIXAIRUPGRADELEVELACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xCFE6870)
#define RPG_CLIENT_PIXAIR_PIXAIRUPGRADELEVELACTION_SET_MAXUPGRADELEVEL_OFFSET UNITYSDK_OFFSET(0xCFE6860)
#define RPG_CLIENT_PIXAIR_PIXAIRUPGRADELEVELACTION_UPGRADELEVEL_OFFSET UNITYSDK_OFFSET(0xCFE6570)
#define RPG_CLIENT_PIXAIR_PIXAIRUPGRADELEVELACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE6540)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirUpgradeLevelAction_TypeDefinitionIndex = 75270;
