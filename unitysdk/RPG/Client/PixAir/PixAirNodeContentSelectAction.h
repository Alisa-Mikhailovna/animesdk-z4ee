...
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xCFDA0B0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xCFDA120)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_GET_CONTENTITEMS_OFFSET UNITYSDK_OFFSET(0xCFDA170)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xCFDA180)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_SELECTCONTENT_OFFSET UNITYSDK_OFFSET(0xCFD9FD0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_START_OFFSET UNITYSDK_OFFSET(0xCFD9F70)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD9A50)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeContentSelectAction_TypeDefinitionIndex = 75265;
