...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xCFBAD10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xCFBAEF0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_GET_NEWITEM_OFFSET UNITYSDK_OFFSET(0xCFBAF30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_GET_OLDITEM_OFFSET UNITYSDK_OFFSET(0xCFBAF10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_SET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xCFBAF00)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_SET_NEWITEM_OFFSET UNITYSDK_OFFSET(0xCFBAF40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_SET_OLDITEM_OFFSET UNITYSDK_OFFSET(0xCFBAF20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCFBADB0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO__GETCHANGETYPE_OFFSET UNITYSDK_OFFSET(0xCFBAE70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO__INIT_OFFSET UNITYSDK_OFFSET(0xCFBADC0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemChangeInfo_TypeDefinitionIndex = 75245;
