...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSVIEWMODEL_GET_NODEVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xCFC65C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSVIEWMODEL_SET_NODEVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xCFC65D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC51F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameProgressViewModel_TypeDefinitionIndex = 75230;

	class PixAirGameProgressViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Class_1_47EB23CB5C4B2615_34* _WindowService; // 0x20
		::Class_1_91C9195F7AC754D8* _GameFlowService; // 0x28
