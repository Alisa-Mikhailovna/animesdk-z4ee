...
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_LINEPROGRESSUPDATEVIEWER_FORCETOEND_OFFSET UNITYSDK_OFFSET(0xCFD0900)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_LINEPROGRESSUPDATEVIEWER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCFD07B0)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_LINEPROGRESSUPDATEVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD0720)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLevelProgressView_LineProgressUpdateViewer_TypeDefinitionIndex = 75361;
