...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_CREATE_OFFSET UNITYSDK_OFFSET(0xCFB2850)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_FINDEMPTYSLOTFORSIZE_OFFSET UNITYSDK_OFFSET(0xCFB3590)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_FINDSLOTBYEQUIPUID_OFFSET UNITYSDK_OFFSET(0xCFB3450)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_FINDSLOTBYPOSITION_OFFSET UNITYSDK_OFFSET(0xCFB3280)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GETEQUIPINSTANCEBYUID_OFFSET UNITYSDK_OFFSET(0xCFB2620)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GETEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFB2700)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GET_AVAILABLESLOTNUM_OFFSET UNITYSDK_OFFSET(0xCFB2600)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0xCFB2510)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0xCFB24F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_REPLACESLOTWITHEMPTY_OFFSET UNITYSDK_OFFSET(0xCFB3FD0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_REPLACESLOTWITHEQUIP_OFFSET UNITYSDK_OFFSET(0xCFB36C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_SET_AVAILABLESLOTNUM_OFFSET UNITYSDK_OFFSET(0xCFB2610)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_SET_SLOTS_OFFSET UNITYSDK_OFFSET(0xCFB2500)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_SYNC_OFFSET UNITYSDK_OFFSET(0xCFB2A70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_UPDATEAVAILABLESLOTNUM_OFFSET UNITYSDK_OFFSET(0xCFB4440)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR__CTOR_OFFSET UNITYSDK_OFFSET(0xCFB2A60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR__FILLMISSINGSLOTS_OFFSET UNITYSDK_OFFSET(0xCFB3B30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR__RELEASESLOTS_OFFSET UNITYSDK_OFFSET(0xCFB2CA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR__TRYGETEQUIPINFOBYSLOTINDEX_OFFSET UNITYSDK_OFFSET(0xCFB2DF0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipBar_TypeDefinitionIndex = 75298;
