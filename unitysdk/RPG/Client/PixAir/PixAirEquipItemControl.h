...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFBBE10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFBBF40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFBB420)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCFBAF50)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemControl_TypeDefinitionIndex = 75201;
