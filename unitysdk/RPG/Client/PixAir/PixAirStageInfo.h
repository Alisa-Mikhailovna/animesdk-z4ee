...
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_CLEARDOINGSTAGEID_OFFSET UNITYSDK_OFFSET(0xCFD74A0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xCFE4160)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETALLSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xCFD0960)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETMAXUNLOCKSTAGE_OFFSET UNITYSDK_OFFSET(0xCFE4990)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETSORTEDNORMALSTAGELIST_OFFSET UNITYSDK_OFFSET(0xCFE4600)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xCFCB4D0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETUNLOCKCHALLENGESTAGEDATA_OFFSET UNITYSDK_OFFSET(0xCFE4390)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xCFE4040)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGCOREEQUIPID_OFFSET UNITYSDK_OFFSET(0xCFE4020)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGPLANEID_OFFSET UNITYSDK_OFFSET(0xCFE4000)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGSTAGEAREA_OFFSET UNITYSDK_OFFSET(0xCFE3FA0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGSTAGECOIN_OFFSET UNITYSDK_OFFSET(0xCFE3FE0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGSTAGEID_OFFSET UNITYSDK_OFFSET(0xCFE3F80)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGSTAGELIFE_OFFSET UNITYSDK_OFFSET(0xCFE3FC0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_INIT_OFFSET UNITYSDK_OFFSET(0xCFD8970)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_ISCHALLENGESTAGEPREMISSIONUNLOCK_OFFSET UNITYSDK_OFFSET(0xCFE41F0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGCOREEQUIPID_OFFSET UNITYSDK_OFFSET(0xCFE4030)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGPLANEID_OFFSET UNITYSDK_OFFSET(0xCFE4010)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGSTAGEAREA_OFFSET UNITYSDK_OFFSET(0xCFE3FB0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGSTAGECOIN_OFFSET UNITYSDK_OFFSET(0xCFE3FF0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGSTAGEID_OFFSET UNITYSDK_OFFSET(0xCFE3F90)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGSTAGELIFE_OFFSET UNITYSDK_OFFSET(0xCFE3FD0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SYNCDOINGSTAGEID_OFFSET UNITYSDK_OFFSET(0xCFD7890)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SYNCFINISHEDSTAGEIDLIST_OFFSET UNITYSDK_OFFSET(0xCFD4340)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SYNCFINISHEDSTAGEID_OFFSET UNITYSDK_OFFSET(0xCFD7420)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SYNC_OFFSET UNITYSDK_OFFSET(0xCFD3EE0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_TRYGETSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xCFE4090)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD8960)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirStageInfo_TypeDefinitionIndex = 75348;
