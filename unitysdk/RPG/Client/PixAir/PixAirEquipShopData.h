...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xCFBD840)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCFBD790)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_BUYPRICE_OFFSET UNITYSDK_OFFSET(0xCFBDA90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0xCFBDB50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xCFBDA10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_GOODINDEX_OFFSET UNITYSDK_OFFSET(0xCFBDA50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0xCFBDB30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCFBDA70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_SELLPRICE_OFFSET UNITYSDK_OFFSET(0xCFBDAE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_SOLD_OFFSET UNITYSDK_OFFSET(0xCFBDA30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0xCFBDB60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xCFBDA20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_GOODINDEX_OFFSET UNITYSDK_OFFSET(0xCFBDA60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0xCFBDB40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCFBDA80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_SOLD_OFFSET UNITYSDK_OFFSET(0xCFBDA40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xCFBD8E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFBD940)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA__INIT_OFFSET UNITYSDK_OFFSET(0xCFBD950)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipShopData_TypeDefinitionIndex = 75344;
