...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFC5EC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSCONTROL__CREATENODEITEMCONTROLS_OFFSET UNITYSDK_OFFSET(0xCFC6110)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC6520)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSCONTROL__DESTROYNODEITEMCONTROLS_OFFSET UNITYSDK_OFFSET(0xCFC5FA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFC5D50)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPROGRESSCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCFC5C90)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameProgressControl_TypeDefinitionIndex = 75206;
