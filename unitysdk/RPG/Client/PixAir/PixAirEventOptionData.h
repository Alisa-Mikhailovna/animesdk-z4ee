...
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCFC3190)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_DESCRIBE_OFFSET UNITYSDK_OFFSET(0xCFC3550)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_EFFECTDESCRIBE_OFFSET UNITYSDK_OFFSET(0xCFC3570)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0xCFC34F0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_OPTIONID_OFFSET UNITYSDK_OFFSET(0xCFC3510)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_TRIGGERCONTENTID_OFFSET UNITYSDK_OFFSET(0xCFC3530)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_ISCOSTENOUGH_OFFSET UNITYSDK_OFFSET(0xCFC3300)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_DESCRIBE_OFFSET UNITYSDK_OFFSET(0xCFC3560)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_EFFECTDESCRIBE_OFFSET UNITYSDK_OFFSET(0xCFC3580)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0xCFC3500)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_OPTIONID_OFFSET UNITYSDK_OFFSET(0xCFC3520)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_TRIGGERCONTENTID_OFFSET UNITYSDK_OFFSET(0xCFC3540)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC32F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEventOptionData_TypeDefinitionIndex = 75316;
