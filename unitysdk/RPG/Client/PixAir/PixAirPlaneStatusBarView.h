...
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_COMPLETEALLANIMATIONS_OFFSET UNITYSDK_OFFSET(0xCFDDAB0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GETHPRATIO_OFFSET UNITYSDK_OFFSET(0xCFDDC90)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GETSHIELDRATIO_OFFSET UNITYSDK_OFFSET(0xCFDDCF0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0xCFDDD50)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_CURRENTSHIELD_OFFSET UNITYSDK_OFFSET(0xCFDDD70)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xCFDDD60)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xCFDC860)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_SETANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0xCFDDA60)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_SETANIMATIONDURATION_OFFSET UNITYSDK_OFFSET(0xCFDD9F0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATEHP_OFFSET UNITYSDK_OFFSET(0xCFDCD00)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATEMAXHP_OFFSET UNITYSDK_OFFSET(0xCFDD390)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATESHIELD_OFFSET UNITYSDK_OFFSET(0xCFDD0B0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xCFDD640)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xCFDDD80)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__PLAYERBURNDAMAGEHPEFFECT_OFFSET UNITYSDK_OFFSET(0xCFDCB40)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__STARTDAMAGEANIMATION_OFFSET UNITYSDK_OFFSET(0xCFDCF40)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__STARTSHIELDDAMAGEANIMATION_OFFSET UNITYSDK_OFFSET(0xCFDD300)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirPlaneStatusBarView_TypeDefinitionIndex = 75241;
