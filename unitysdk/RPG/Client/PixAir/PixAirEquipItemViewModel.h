...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BAGSLOTINDEX_OFFSET UNITYSDK_OFFSET(0xCFAA980)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BATTLESLOTINDEX_OFFSET UNITYSDK_OFFSET(0xCFACCA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0xCFBC360)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0xCFBC3B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xCFBC2C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_ISLARGESLOT_OFFSET UNITYSDK_OFFSET(0xCFBC280)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCFBBEF0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_POS_OFFSET UNITYSDK_OFFSET(0xCFBC230)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xCFBC310)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFAA660)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemViewModel_TypeDefinitionIndex = 75227;

	class PixAirEquipItemViewModel : public ::Sofa::BaseViewModel
	{
	public:
		// static const ::System::UInt32 PreSlotSize = 0xB; // 0x0
		::Class_0_16E4307DCC419505_1255* _EquipPropertyGetter; // 0x20
