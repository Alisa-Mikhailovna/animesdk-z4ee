...
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION_RECORDCHANGE_OFFSET UNITYSDK_OFFSET(0xCFB1260)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFB1D50)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION__RECORDBASICCHANGE_OFFSET UNITYSDK_OFFSET(0xCFB1850)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION__RECORDSLOTNUMCHANGE_OFFSET UNITYSDK_OFFSET(0xCFB1CF0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEnterNewAreaAction_TypeDefinitionIndex = 75250;
