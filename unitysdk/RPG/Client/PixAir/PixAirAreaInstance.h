...
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_GETNODEINSTANCEBYINDEX_OFFSET UNITYSDK_OFFSET(0xCFA6BA0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_GETNODEINSTANCE_OFFSET UNITYSDK_OFFSET(0xCFA6AA0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_GET_AREADATA_OFFSET UNITYSDK_OFFSET(0xCFA64E0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_GET_AREAID_OFFSET UNITYSDK_OFFSET(0xCFA64C0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_GET_CURRENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0xCFA6520)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_GET_CURRENTNODE_OFFSET UNITYSDK_OFFSET(0xCFA6590)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_GET_NODECOUNT_OFFSET UNITYSDK_OFFSET(0xCFA6540)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_GET_NODEINSTANCES_OFFSET UNITYSDK_OFFSET(0xCFA6500)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_SET_AREADATA_OFFSET UNITYSDK_OFFSET(0xCFA64F0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_SET_AREAID_OFFSET UNITYSDK_OFFSET(0xCFA64D0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_SET_CURRENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0xCFA6530)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_SET_NODEINSTANCES_OFFSET UNITYSDK_OFFSET(0xCFA6510)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_SYNCNODESTATE_OFFSET UNITYSDK_OFFSET(0xCFA6900)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xCFA6610)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE__CREATENODEINSTANCES_OFFSET UNITYSDK_OFFSET(0xCFA66C0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCFA66B0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirAreaInstance_TypeDefinitionIndex = 75283;
