...
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_FINISHSUPPLYSTAGE_OFFSET UNITYSDK_OFFSET(0xCFD1680)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xCFD1990)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xCFD1920)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_GET_ENEMYID_OFFSET UNITYSDK_OFFSET(0xCFD1A60)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xCFD1A10)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_SET_ENEMYID_OFFSET UNITYSDK_OFFSET(0xCFD1A70)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_START_OFFSET UNITYSDK_OFFSET(0xCFD18A0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0xCFD1460)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD12E0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLootSelectAction_TypeDefinitionIndex = 75263;
