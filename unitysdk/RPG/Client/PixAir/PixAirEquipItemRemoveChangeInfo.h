...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xCFBBFC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xCFBC070)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xCFBC050)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_SET_POSITION_OFFSET UNITYSDK_OFFSET(0xCFBC060)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCFBC040)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemRemoveChangeInfo_TypeDefinitionIndex = 75247;

	class PixAirEquipItemRemoveChangeInfo : public ::System::Object
	{
	public:
		::System::Int32 _Position_k__BackingField; // 0x10
		::RPG::Client::PixAir::PixAirEquipItemChangeType _ChangeType; // 0x14
