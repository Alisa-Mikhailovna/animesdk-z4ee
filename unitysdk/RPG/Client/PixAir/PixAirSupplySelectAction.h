...
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_FINISHSUPPLYSTAGE_OFFSET UNITYSDK_OFFSET(0xCFE4F70)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xCFE4CE0)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xCFE5190)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_GET_DISPLAYEQUIPITEM_OFFSET UNITYSDK_OFFSET(0xCFE5200)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xCFE5210)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_START_OFFSET UNITYSDK_OFFSET(0xCFE4C80)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0xCFE4D50)
#define RPG_CLIENT_PIXAIR_PIXAIRSUPPLYSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE4C40)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirSupplySelectAction_TypeDefinitionIndex = 75269;
