...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xCFCD170)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xCFCD2A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_GET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0xCFCD280)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_SET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0xCFCD290)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_START_OFFSET UNITYSDK_OFFSET(0xCFCD080)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFCD070)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSettlementAction_TypeDefinitionIndex = 75262;
