...
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC16D030)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC16CD70)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTBLOCKEVENT_OFFSET UNITYSDK_OFFSET(0xC16D5E0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTDETECTEVENT_OFFSET UNITYSDK_OFFSET(0xC16D6E0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTIDLEEVENT_OFFSET UNITYSDK_OFFSET(0xC16D8E0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTIDLESTOPEVENT_OFFSET UNITYSDK_OFFSET(0xC16D9E0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTROADRAGEEVENT_OFFSET UNITYSDK_OFFSET(0xC16DAE0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTSTARTEVENT_OFFSET UNITYSDK_OFFSET(0xC16D7E0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_SHUTDOWN_OFFSET UNITYSDK_OFFSET(0xC16D130)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_STARTUP_OFFSET UNITYSDK_OFFSET(0xC16CDD0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_UPDATEEVENT_OFFSET UNITYSDK_OFFSET(0xC16D240)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xC16DBE0)

namespace RPG::Client::CityCarFlow
{
	inline static constexpr unsigned int MonoCityCarAudio_TypeDefinitionIndex = 76800;
