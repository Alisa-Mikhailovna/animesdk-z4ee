...
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEMDEBUG_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD2C3F0)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEMDEBUG_RESET_OFFSET UNITYSDK_OFFSET(0xCD2C440)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEMDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xCD2C530)
