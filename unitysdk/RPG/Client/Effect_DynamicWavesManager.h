...
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_CLEARHITDATA_OFFSET UNITYSDK_OFFSET(0xC305300)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC304250)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_097889028E95301C_OFFSET UNITYSDK_OFFSET(0xC305010)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_0C83273C8E891A7D_OFFSET UNITYSDK_OFFSET(0xC305680)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xC303CE0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xC304130)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xC303BC0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_3A599F23178B2776_OFFSET UNITYSDK_OFFSET(0xC303EB0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_6735D87E90F99030_OFFSET UNITYSDK_OFFSET(0xC305490)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_78DE1569AE48596D_OFFSET UNITYSDK_OFFSET(0xC3058E0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_7AE1B3E28F328DA0_OFFSET UNITYSDK_OFFSET(0xC3057A0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_8347A1099A618012_OFFSET UNITYSDK_OFFSET(0xC305B50)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_8A76897D6A693475_OFFSET UNITYSDK_OFFSET(0xC3042E0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_98A399CC8B751747_OFFSET UNITYSDK_OFFSET(0xC305380)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0xC3043A0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_DF9C4DFC36CBDE06_OFFSET UNITYSDK_OFFSET(0xC304AB0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_METHOD_5_F24481701D40D533_OFFSET UNITYSDK_OFFSET(0xC304580)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC3040E0)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC303C90)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_SETHITPOINT_OFFSET UNITYSDK_OFFSET(0xC304D40)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER_START_OFFSET UNITYSDK_OFFSET(0xC303B70)
#define RPG_CLIENT_EFFECT_DYNAMICWAVESMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC305BE0)
