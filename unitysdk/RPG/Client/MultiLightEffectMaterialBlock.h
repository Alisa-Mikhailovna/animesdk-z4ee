...
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_GET_EMISSIONSTRENGTH3_OFFSET UNITYSDK_OFFSET(0xCDDA500)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_LATETICK_OFFSET UNITYSDK_OFFSET(0xCDD92B0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_METHOD_5_019EFE3898DA3E4C_OFFSET UNITYSDK_OFFSET(0xCDD9FD0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_METHOD_5_828DF204BF1C89BB_OFFSET UNITYSDK_OFFSET(0xCDD8B40)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_METHOD_5_ABB1ED6E5E3576C6_OFFSET UNITYSDK_OFFSET(0xCDD9570)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCDDA4B0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCDD9220)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCDD9190)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_SET_EMISSIONSTRENGTH3_OFFSET UNITYSDK_OFFSET(0xCDDA510)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_START_OFFSET UNITYSDK_OFFSET(0xCDD88C0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xCDDA520)
