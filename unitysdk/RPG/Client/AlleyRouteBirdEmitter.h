...
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xBD31B60)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_EMIT_OFFSET UNITYSDK_OFFSET(0xBD32470)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_GET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0xBD31A50)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_218124418542E081_OFFSET UNITYSDK_OFFSET(0xBD31F30)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_413756351A6E8A48_OFFSET UNITYSDK_OFFSET(0xBD326E0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_8BBAEEFBF2212B92_OFFSET UNITYSDK_OFFSET(0xBD327F0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_9B2C6D465D86BE6A_OFFSET UNITYSDK_OFFSET(0xBD32AA0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_B67DCF72B717FA9F_1_OFFSET UNITYSDK_OFFSET(0xBD31DE0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_B67DCF72B717FA9F_2_OFFSET UNITYSDK_OFFSET(0xBD32950)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_B67DCF72B717FA9F_OFFSET UNITYSDK_OFFSET(0xBD32140)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_C56DC3B2E26040B8_OFFSET UNITYSDK_OFFSET(0xBD322E0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xBD32100)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBD32290)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CFFF42C2DBAED4BB_OFFSET UNITYSDK_OFFSET(0xBD32C80)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCOLOR_OFFSET UNITYSDK_OFFSET(0xBD31B10)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCONFIG_OFFSET UNITYSDK_OFFSET(0xBD31AC0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDPOOL_OFFSET UNITYSDK_OFFSET(0xBD31A70)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0xBD31A60)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_STOP_OFFSET UNITYSDK_OFFSET(0xBD32550)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBD31CA0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD32D80)
