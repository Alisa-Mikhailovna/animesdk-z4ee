...
#define RPG_CLIENT_PLANETFESSKILLPHASE_ADDUNLOCKDATA_OFFSET UNITYSDK_OFFSET(0xD070DE0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_CREATE_OFFSET UNITYSDK_OFFSET(0xD083350)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETALLDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xD0835B0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETFINISHPROGRESS_OFFSET UNITYSDK_OFFSET(0xD083410)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETISFINISH_OFFSET UNITYSDK_OFFSET(0xD071930)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETISUNLOCK_OFFSET UNITYSDK_OFFSET(0xD081D10)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETLOCKREASON_OFFSET UNITYSDK_OFFSET(0xD081AE0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETSKILLCOUNT_OFFSET UNITYSDK_OFFSET(0xD083870)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_HASLOCKCONDITION_OFFSET UNITYSDK_OFFSET(0xD083AF0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_HASPASTPHASE_OFFSET UNITYSDK_OFFSET(0xD083960)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_ID_OFFSET UNITYSDK_OFFSET(0xD0839B0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD083A30)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_ROW_OFFSET UNITYSDK_OFFSET(0xD0839D0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_SHOWNUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0xD083B60)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_UNLOCKIDS_OFFSET UNITYSDK_OFFSET(0xD070B90)
#define RPG_CLIENT_PLANETFESSKILLPHASE_HASSKILL_OFFSET UNITYSDK_OFFSET(0xD071B60)
#define RPG_CLIENT_PLANETFESSKILLPHASE_PASTPHASEHASSKILL_OFFSET UNITYSDK_OFFSET(0xD0838C0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_SETPASTPHASE_OFFSET UNITYSDK_OFFSET(0xD0833C0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_SET_ID_OFFSET UNITYSDK_OFFSET(0xD0839C0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_SET_SHOWNUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0xD083C40)
#define RPG_CLIENT_PLANETFESSKILLPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0833B0)
