...
#define RPG_CLIENT_MANIKINCHARAHOLOMAT_AWAKE_OFFSET UNITYSDK_OFFSET(0xCA510B0)
#define RPG_CLIENT_MANIKINCHARAHOLOMAT_INITSETMAT_OFFSET UNITYSDK_OFFSET(0xCA51B00)
#define RPG_CLIENT_MANIKINCHARAHOLOMAT_UPDATEUIHOLOPROPERTY_OFFSET UNITYSDK_OFFSET(0xCA51B90)
#define RPG_CLIENT_MANIKINCHARAHOLOMAT_UPDATE_OFFSET UNITYSDK_OFFSET(0xCA51170)
#define RPG_CLIENT_MANIKINCHARAHOLOMAT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA52140)

namespace RPG::Client
{
	inline static constexpr unsigned int ManikinCharaHoloMat_TypeDefinitionIndex = 69501;
