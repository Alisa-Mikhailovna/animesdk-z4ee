...
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDATTRIBUTEROW_CREATE_OFFSET UNITYSDK_OFFSET(0xD46FEF0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDATTRIBUTEROW_GET_ATTRIBUTEDATA_OFFSET UNITYSDK_OFFSET(0xD46FE90)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDATTRIBUTEROW_GET_ROWTYPE_OFFSET UNITYSDK_OFFSET(0xD46FE40)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDATTRIBUTEROW__CTOR_OFFSET UNITYSDK_OFFSET(0xD46FF70)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaLegendAttributeRow_TypeDefinitionIndex = 69590;
