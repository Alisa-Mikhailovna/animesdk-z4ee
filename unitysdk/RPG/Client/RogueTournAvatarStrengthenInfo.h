...
#define RPG_CLIENT_ROGUETOURNAVATARSTRENGTHENINFO_CREATESTRENGTHENEDAVATARCOMPARER_OFFSET UNITYSDK_OFFSET(0xD411410)
#define RPG_CLIENT_ROGUETOURNAVATARSTRENGTHENINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD411380)
#define RPG_CLIENT_ROGUETOURNAVATARSTRENGTHENINFO_GETSTRENGTHENEDAVATARS_OFFSET UNITYSDK_OFFSET(0xD411770)
#define RPG_CLIENT_ROGUETOURNAVATARSTRENGTHENINFO_GETSTRENGTHENTEXTBYAVATARID_OFFSET UNITYSDK_OFFSET(0xD411C20)
#define RPG_CLIENT_ROGUETOURNAVATARSTRENGTHENINFO_INIT_OFFSET UNITYSDK_OFFSET(0xD411120)
#define RPG_CLIENT_ROGUETOURNAVATARSTRENGTHENINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD4110A0)
