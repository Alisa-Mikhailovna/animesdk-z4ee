...
#define RPG_CLIENT_ELECTRICCHAINV2_CURVE_METHOD_2_0A99B5F334D75624_OFFSET UNITYSDK_OFFSET(0xC35A3F0)
#define RPG_CLIENT_ELECTRICCHAINV2_CURVE_METHOD_2_124E7DAB85EAFECD_OFFSET UNITYSDK_OFFSET(0xC35A730)
#define RPG_CLIENT_ELECTRICCHAINV2_CURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC35A7B0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Curve_TypeDefinitionIndex = 70197;
