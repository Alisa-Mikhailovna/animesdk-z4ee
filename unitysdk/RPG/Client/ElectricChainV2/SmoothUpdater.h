...
#define RPG_CLIENT_ELECTRICCHAINV2_SMOOTHUPDATER_GET__WEIGHT_OFFSET UNITYSDK_OFFSET(0xC362330)
#define RPG_CLIENT_ELECTRICCHAINV2_SMOOTHUPDATER_METHOD_2_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xC361F00)
#define RPG_CLIENT_ELECTRICCHAINV2_SMOOTHUPDATER_METHOD_2_B840F7A094E17D8F_OFFSET UNITYSDK_OFFSET(0xC362000)
#define RPG_CLIENT_ELECTRICCHAINV2_SMOOTHUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0xC361E50)
#define RPG_CLIENT_ELECTRICCHAINV2_SMOOTHUPDATER___INITIALIZE_B__0_0_OFFSET UNITYSDK_OFFSET(0xC362380)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int SmoothUpdater_TypeDefinitionIndex = 70183;
