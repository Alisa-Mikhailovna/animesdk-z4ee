...
#define RPG_CLIENT_ELECTRICCHAINV2_SHAPE_METHOD_1_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xC361C70)
#define RPG_CLIENT_ELECTRICCHAINV2_SHAPE_METHOD_1_BF972395CC722BF9_OFFSET UNITYSDK_OFFSET(0xC361B90)
#define RPG_CLIENT_ELECTRICCHAINV2_SHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0xC35AA80)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Shape_TypeDefinitionIndex = 70188;
