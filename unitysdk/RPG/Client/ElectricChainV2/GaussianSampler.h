...
#define RPG_CLIENT_ELECTRICCHAINV2_GAUSSIANSAMPLER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xC3601C0)
#define RPG_CLIENT_ELECTRICCHAINV2_GAUSSIANSAMPLER_GET_VECTOR2VALUE_OFFSET UNITYSDK_OFFSET(0xC360330)
#define RPG_CLIENT_ELECTRICCHAINV2_GAUSSIANSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC35F6A0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int GaussianSampler_TypeDefinitionIndex = 70187;
