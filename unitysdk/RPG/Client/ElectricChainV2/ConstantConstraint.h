...
#define RPG_CLIENT_ELECTRICCHAINV2_CONSTANTCONSTRAINT_METHOD_2_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0xC35A380)
#define RPG_CLIENT_ELECTRICCHAINV2_CONSTANTCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0xC35A3E0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int ConstantConstraint_TypeDefinitionIndex = 70199;
