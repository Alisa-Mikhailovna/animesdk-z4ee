...
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xC35AD80)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xC35AC40)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2_RESTART_OFFSET UNITYSDK_OFFSET(0xC35AA90)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2__CTOR_OFFSET UNITYSDK_OFFSET(0xC35ADD0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Effect_ElectricChainV2_TypeDefinitionIndex = 70174;
