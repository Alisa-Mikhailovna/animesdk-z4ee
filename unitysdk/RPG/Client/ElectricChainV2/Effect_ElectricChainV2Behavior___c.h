...
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC360060)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC3600A0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR___C___INITIALIZESUBCHAINS_B__11_0_OFFSET UNITYSDK_OFFSET(0xC3600B0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Effect_ElectricChainV2Behavior___c_TypeDefinitionIndex = 70180;
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::ElectricChainV2::Effect_ElectricChainV2Behavior_SubChainCollection, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Effect_ElectricChainV2Behavior___c_TypeDefinitionIndex)->GetStaticField(0x68F50);
		}
		static ::RPG::Client::ElectricChainV2::Effect_ElectricChainV2Behavior___c** StaticGet___9()
		{
			return (::RPG::Client::ElectricChainV2::Effect_ElectricChainV2Behavior___c**)Il2CppClass::FromTypeDefinitionIndex(Effect_ElectricChainV2Behavior___c_TypeDefinitionIndex)->GetStaticField(0x68F58);
		}
