...
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_GET_LENGTHS_OFFSET UNITYSDK_OFFSET(0xC3613A0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_538FE3E275DA3359_OFFSET UNITYSDK_OFFSET(0xC360F90)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_653EEB7EF259681D_OFFSET UNITYSDK_OFFSET(0xC361840)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_762A9412773049BE_OFFSET UNITYSDK_OFFSET(0xC361910)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_SET_LENGTHS_OFFSET UNITYSDK_OFFSET(0xC361AE0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xC361AF0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int PolyLine_TypeDefinitionIndex = 70196;
