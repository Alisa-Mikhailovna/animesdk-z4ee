...
#define RPG_CLIENT_ELECTRICCHAINV2_UNIFORMSAMPLER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xC362C30)
#define RPG_CLIENT_ELECTRICCHAINV2_UNIFORMSAMPLER_GET_VECTOR2VALUE_OFFSET UNITYSDK_OFFSET(0xC362C40)
#define RPG_CLIENT_ELECTRICCHAINV2_UNIFORMSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC362CB0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int UniformSampler_TypeDefinitionIndex = 70186;
