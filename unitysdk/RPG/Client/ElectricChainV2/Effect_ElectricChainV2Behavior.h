...
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_GET__DISPLACEMENT_OFFSET UNITYSDK_OFFSET(0xC35F6C0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xC35BA30)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xC35BD00)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_0EF9CFCE4680A1C2_OFFSET UNITYSDK_OFFSET(0xC35CAE0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_1283EC0876EAAACF_OFFSET UNITYSDK_OFFSET(0xC35B1F0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_3413FD214B6828DF_OFFSET UNITYSDK_OFFSET(0xC35EF20)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xC35BC60)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC35B780)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xC35BCA0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC35B180)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_51EAF8DD9B9FF37C_OFFSET UNITYSDK_OFFSET(0xC35D000)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_55A68C4933FB4D7C_OFFSET UNITYSDK_OFFSET(0xC35BD60)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_5E8222CEAF419889_OFFSET UNITYSDK_OFFSET(0xC35F0A0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_8357650EFC6CB604_OFFSET UNITYSDK_OFFSET(0xC35F7A0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0xC35BAB0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_90A07D9BC1B409B9_1_OFFSET UNITYSDK_OFFSET(0xC35B730)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_90A07D9BC1B409B9_OFFSET UNITYSDK_OFFSET(0xC35ACD0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_9765352E01408D38_OFFSET UNITYSDK_OFFSET(0xC35B7E0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_A59AEBEBC3E811AB_OFFSET UNITYSDK_OFFSET(0xC35EAE0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_AFC8215C57A0845A_OFFSET UNITYSDK_OFFSET(0xC35AD30)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0xC35D120)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_E2BCD1B56132A826_OFFSET UNITYSDK_OFFSET(0xC35C7E0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_F2145E8FC54EF61C_OFFSET UNITYSDK_OFFSET(0xC35F9C0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR_METHOD_3_F5909B5FD6F94F42_OFFSET UNITYSDK_OFFSET(0xC35DD80)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2BEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC360050)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Effect_ElectricChainV2Behavior_TypeDefinitionIndex = 70175;
