...
#define RPG_CLIENT_ELECTRICCHAINV2_INTERRUPTEDUPDATER_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC3609D0)
#define RPG_CLIENT_ELECTRICCHAINV2_INTERRUPTEDUPDATER_METHOD_2_6AF6D72B43B02A63_OFFSET UNITYSDK_OFFSET(0xC360A30)
#define RPG_CLIENT_ELECTRICCHAINV2_INTERRUPTEDUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0xC360BA0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int InterruptedUpdater_TypeDefinitionIndex = 70182;
