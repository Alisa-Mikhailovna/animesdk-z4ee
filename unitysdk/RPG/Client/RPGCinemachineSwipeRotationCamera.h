...
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA_INITSWIPECAMERA_OFFSET UNITYSDK_OFFSET(0xD28C3F0)
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0xD28C580)
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xD28C700)
