...
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_GET_ACTIONID_OFFSET UNITYSDK_OFFSET(0xC174EE0)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_GET_EFFECTLIST_OFFSET UNITYSDK_OFFSET(0xC174F40)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_GET_OWNERCARDREF_OFFSET UNITYSDK_OFFSET(0xC174F20)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_GET_ROW_OFFSET UNITYSDK_OFFSET(0xC174F00)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_GET_SUCCESSEFFECTLIST_OFFSET UNITYSDK_OFFSET(0xC174F60)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_ONNEW_OFFSET UNITYSDK_OFFSET(0xC174D40)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0xC174A60)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_SETEFFECTDATAITEMPOOL_OFFSET UNITYSDK_OFFSET(0xC174A10)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_SET_ACTIONID_OFFSET UNITYSDK_OFFSET(0xC174EF0)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_SET_EFFECTLIST_OFFSET UNITYSDK_OFFSET(0xC174F50)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_SET_OWNERCARDREF_OFFSET UNITYSDK_OFFSET(0xC174F30)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_SET_ROW_OFFSET UNITYSDK_OFFSET(0xC174F10)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_SET_SUCCESSEFFECTLIST_OFFSET UNITYSDK_OFFSET(0xC174F70)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM_SYNC_OFFSET UNITYSDK_OFFSET(0xC174730)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM__CLEAREFFECTS_OFFSET UNITYSDK_OFFSET(0xC174AC0)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM__CREATEEFFECTITEM_OFFSET UNITYSDK_OFFSET(0xC174D80)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC174F80)
#define RPG_CLIENT_CLOCKPARKACTIONDATAITEM__SYNCEFFECTS_OFFSET UNITYSDK_OFFSET(0xC1747C0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Class_1_64C1E63642C4A2DF<::RPG::Client::ClockParkEffectDataItem*>**)Il2CppClass::FromTypeDefinitionIndex(ClockParkActionDataItem_TypeDefinitionIndex)->GetStaticField(0x631C0);
		}
		::System::Collections::Generic::List_1<::RPG::Client::ClockParkEffectDataItem*>* _SuccessEffectList_k__BackingField; // 0x10
