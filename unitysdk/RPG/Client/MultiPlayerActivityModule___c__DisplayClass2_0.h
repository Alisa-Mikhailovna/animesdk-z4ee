...
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCDDD580)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___C__DISPLAYCLASS2_0__TRANSFERTOMULTIPLAYERACTIVITYENTRANCEPAGE_B__0_OFFSET UNITYSDK_OFFSET(0xCDDDDA0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___C__DISPLAYCLASS2_0__TRANSFERTOMULTIPLAYERACTIVITYENTRANCEPAGE_B__1_OFFSET UNITYSDK_OFFSET(0xCDDDF60)
