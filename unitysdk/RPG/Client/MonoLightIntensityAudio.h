...
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_METHOD_5_0C44FB644D25C1C2_OFFSET UNITYSDK_OFFSET(0xCD01050)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_METHOD_5_899EC372DEC6EBDF_OFFSET UNITYSDK_OFFSET(0xCD00E40)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_METHOD_5_B7A43C06FD78D78B_OFFSET UNITYSDK_OFFSET(0xCD010D0)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_START_OFFSET UNITYSDK_OFFSET(0xCD00D00)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD00F10)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xCD01140)
