...
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS34_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC6D89D0)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS34_0__PLAYEQUIPEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0xC6DA020)
...
namespace RPG::Client
{
	...
	public:
		...
		::UnityEngine::Transform* effectAddTrans; // 0x18
