...
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0xD0B84C0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_2F29DB032BE8A9AF_OFFSET UNITYSDK_OFFSET(0xD0B55D0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0xD0B5770)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0xD0B59D0)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL_METHOD_2_E153E10891089910_OFFSET UNITYSDK_OFFSET(0xD0B5290)
#define RPG_CLIENT_POLYMERPROPERTYLINKMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0xD0B8460)
