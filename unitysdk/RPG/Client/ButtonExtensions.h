...
#define RPG_CLIENT_BUTTONEXTENSIONS_SAFESETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xBED9FB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ButtonExtensions_TypeDefinitionIndex = 69462;
