...
#define RPG_CLIENT_MONOPROPHIGHLIGHT_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD15C80)
#define RPG_CLIENT_MONOPROPHIGHLIGHT_METHOD_5_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0xCD16130)
#define RPG_CLIENT_MONOPROPHIGHLIGHT_METHOD_5_C495FC84AA2302E0_OFFSET UNITYSDK_OFFSET(0xCD15EE0)
#define RPG_CLIENT_MONOPROPHIGHLIGHT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD160E0)
#define RPG_CLIENT_MONOPROPHIGHLIGHT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD15E90)
#define RPG_CLIENT_MONOPROPHIGHLIGHT_SETHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xCD162E0)
#define RPG_CLIENT_MONOPROPHIGHLIGHT_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD15CE0)
#define RPG_CLIENT_MONOPROPHIGHLIGHT__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD16340)
#define RPG_CLIENT_MONOPROPHIGHLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD16330)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoPropHighLight_TypeDefinitionIndex)->GetStaticField(0x10880);
		}
