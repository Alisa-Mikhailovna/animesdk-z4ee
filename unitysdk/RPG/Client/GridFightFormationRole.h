...
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_ADDEQUIP_OFFSET UNITYSDK_OFFSET(0xC713C70)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_ADD_ONEQUIPCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0xC7134C0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_CLEAREQUIP_OFFSET UNITYSDK_OFFSET(0xC713D50)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0xC713800)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET_POSINDEX_OFFSET UNITYSDK_OFFSET(0xC713730)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET_ROLEID_OFFSET UNITYSDK_OFFSET(0xC713590)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET_STAR_OFFSET UNITYSDK_OFFSET(0xC713660)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET__EQUIPIDS_OFFSET UNITYSDK_OFFSET(0xC713580)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_HASEQUIP_OFFSET UNITYSDK_OFFSET(0xC713ED0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_REMOVEEQUIP_OFFSET UNITYSDK_OFFSET(0xC713DA0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_REMOVE_ONEQUIPCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0xC713520)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_REPLACEEQUIP_OFFSET UNITYSDK_OFFSET(0xC713E00)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_RPG_CLIENT_IGRIDFIGHTREFTRAITLAYERROLEINPUT_GET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0xC713890)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_SET_POSINDEX_OFFSET UNITYSDK_OFFSET(0xC713770)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_SET_ROLEID_OFFSET UNITYSDK_OFFSET(0xC7135D0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_SET_STAR_OFFSET UNITYSDK_OFFSET(0xC7136A0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE__CTOR_OFFSET UNITYSDK_OFFSET(0xC713930)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE__ONCOLLECTIONCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xC713F30)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _RoleID; // 0x28
		::System::UInt32 _Star; // 0x2C
