...
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD7E0B80)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD7E0960)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_RESET_OFFSET UNITYSDK_OFFSET(0xD7E09B0)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_SETMAPCUTSCENE_OFFSET UNITYSDK_OFFSET(0xD7E0BD0)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD7E0B40)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_UPDATECOLORGRADINGPARAMS_OFFSET UNITYSDK_OFFSET(0xD7E0FA0)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_UPDATERADIALBLURPARAMS_OFFSET UNITYSDK_OFFSET(0xD7E11A0)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7E1380)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0xD7E13D0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMapCutSceneTween_TypeDefinitionIndex = 69734;
