...
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GETGAMEPLAYACTIVITYPANELDATA_OFFSET UNITYSDK_OFFSET(0xC5B7870)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_COLLECTIONACTIVITYID_OFFSET UNITYSDK_OFFSET(0xC5B7490)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_GAMEPLAYACTIVITYID_OFFSET UNITYSDK_OFFSET(0xC5B7450)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_MISSIONCHRONICLEMAINPATHID_OFFSET UNITYSDK_OFFSET(0xC5B7690)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_MISSIONCONTENTID_OFFSET UNITYSDK_OFFSET(0xC5B74D0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET__GACHAREWARDQUESTID_OFFSET UNITYSDK_OFFSET(0xC5B7580)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_HASGACHAREWARD_OFFSET UNITYSDK_OFFSET(0xC5B7BC0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_ISMAINMISSIONFINISHED_OFFSET UNITYSDK_OFFSET(0xC5B7AD0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_ONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0xC5B7780)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART__CTOR_OFFSET UNITYSDK_OFFSET(0xC5B7DA0)
