...
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xCB88420)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xCB880A0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xCB87F20)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xCB87F80)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xCB87FE0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xCB88040)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0xCB880E0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCB87EC0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCB87E30)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_9D4AA0DDED7945FC_OFFSET UNITYSDK_OFFSET(0xCB884A0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xCB88140)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xCB88670)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCB88660)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::RPG::Client::MaterialPropertyAnimBehavior_MaterialProperty, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x4DA90);
		}
