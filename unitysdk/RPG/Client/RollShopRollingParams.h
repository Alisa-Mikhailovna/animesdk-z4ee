...
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS_GET_DISPLAYITEMS_OFFSET UNITYSDK_OFFSET(0xD4B1370)
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS_GET_REWARDGROUPTYPE_OFFSET UNITYSDK_OFFSET(0xD4B1360)
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS_GET_ROLLSHOPID_OFFSET UNITYSDK_OFFSET(0xD4B1340)
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS_GET_WALKNUM_OFFSET UNITYSDK_OFFSET(0xD4B1350)
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xD4B1380)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Int32 _WalkNum_k__BackingField; // 0x20
