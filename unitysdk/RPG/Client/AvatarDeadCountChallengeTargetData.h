...
#define RPG_CLIENT_AVATARDEADCOUNTCHALLENGETARGETDATA_CALCULATETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xBDD94E0)
#define RPG_CLIENT_AVATARDEADCOUNTCHALLENGETARGETDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBDD95E0)
#define RPG_CLIENT_AVATARDEADCOUNTCHALLENGETARGETDATA_SETCHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xBDD9550)
#define RPG_CLIENT_AVATARDEADCOUNTCHALLENGETARGETDATA_UPDATECHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xBDD9410)
#define RPG_CLIENT_AVATARDEADCOUNTCHALLENGETARGETDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xBDD96F0)
#define RPG_CLIENT_AVATARDEADCOUNTCHALLENGETARGETDATA__CONVERT_OFFSET UNITYSDK_OFFSET(0xBDD9280)
#define RPG_CLIENT_AVATARDEADCOUNTCHALLENGETARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD91F0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::TextID*)Il2CppClass::FromTypeDefinitionIndex(AvatarDeadCountChallengeTargetData_TypeDefinitionIndex)->GetStaticField(0xE250);
		}
