...
#define RPG_CLIENT_GRIDFIGHTENEMYDIFFICULTYMODIFIER_GET_ADDVALUE_OFFSET UNITYSDK_OFFSET(0xC6E2C90)
#define RPG_CLIENT_GRIDFIGHTENEMYDIFFICULTYMODIFIER_GET_MODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xC6E2DD0)
#define RPG_CLIENT_GRIDFIGHTENEMYDIFFICULTYMODIFIER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0xC6E2EC0)
#define RPG_CLIENT_GRIDFIGHTENEMYDIFFICULTYMODIFIER_GET_SUBVALUE_OFFSET UNITYSDK_OFFSET(0xC6E2D30)
#define RPG_CLIENT_GRIDFIGHTENEMYDIFFICULTYMODIFIER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC6E2C40)
#define RPG_CLIENT_GRIDFIGHTENEMYDIFFICULTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xC6E2C30)
