...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_ACCELERATIONTRIGGERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCF31F90)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourRoad_AccelerationTriggerInfo_TypeDefinitionIndex = 70761;
