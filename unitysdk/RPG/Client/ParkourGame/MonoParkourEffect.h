...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOUREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCF2ADF0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourEffect_TypeDefinitionIndex = 70740;
