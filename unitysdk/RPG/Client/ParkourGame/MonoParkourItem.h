...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEM_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xCF2B9E0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEM_ONCHARACTERTRIGGER_OFFSET UNITYSDK_OFFSET(0xCF2B7D0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCF2B780)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCF2B670)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEM_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xCF2B980)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEM_SETRENDERERVISIBLE_OFFSET UNITYSDK_OFFSET(0xCF2B8B0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEM_SET_ITEM_OFFSET UNITYSDK_OFFSET(0xCF2B9F0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCF2BA00)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItem_TypeDefinitionIndex = 70743;
