...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCF2A660)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCF2A730)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCF2A6E0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCF2A780)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourCharacter_TypeDefinitionIndex = 70735;
