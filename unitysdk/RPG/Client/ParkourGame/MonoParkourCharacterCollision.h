...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTERCOLLISION_ONCHARACTERCOLLISION_OFFSET UNITYSDK_OFFSET(0xCF2A7D0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTERCOLLISION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCF2A870)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTERCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0xCF2A8F0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourCharacterCollision_TypeDefinitionIndex = 70736;
