...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCF2A900)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVE_METHOD_5_5EA00B7C45AF82A4_OFFSET UNITYSDK_OFFSET(0xCF2A9A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0xCF2ADD0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourCurveMove_TypeDefinitionIndex = 70737;
