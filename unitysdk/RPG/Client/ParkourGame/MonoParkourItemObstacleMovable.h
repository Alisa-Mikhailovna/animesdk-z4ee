...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0xCF2BBC0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xCF2BB70)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xCF2BBD0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemObstacleMovable_TypeDefinitionIndex = 70746;
