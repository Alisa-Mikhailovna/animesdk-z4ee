...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURANIMATIONCHANGETEXTURE_CHANGELIGHTTEXTURE_OFFSET UNITYSDK_OFFSET(0xCF2A4B0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURANIMATIONCHANGETEXTURE_METHOD_5_9A5D3DBD0AFC14C3_OFFSET UNITYSDK_OFFSET(0xCF2A5A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURANIMATIONCHANGETEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0xCF2A650)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourAnimationChangeTexture_TypeDefinitionIndex = 70725;
