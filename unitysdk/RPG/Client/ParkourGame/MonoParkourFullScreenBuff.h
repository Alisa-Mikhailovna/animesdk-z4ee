...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_METHOD_5_3D6722B9F8F20694_OFFSET UNITYSDK_OFFSET(0xCF2B100)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_METHOD_5_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0xCF2B5D0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCF2AF20)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCF2AE00)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_SETUPDURATION_OFFSET UNITYSDK_OFFSET(0xCF2B050)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_UPDATE_OFFSET UNITYSDK_OFFSET(0xCF2B520)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xCF2B660)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourFullScreenBuff_TypeDefinitionIndex = 70741;
