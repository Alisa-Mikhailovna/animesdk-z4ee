...
#define RPG_CLIENT_HYPERTEXTLINK_HREFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C0D30)

namespace RPG::Client
{
	inline static constexpr unsigned int HyperTextLink_HrefInfo_TypeDefinitionIndex = 69267;
