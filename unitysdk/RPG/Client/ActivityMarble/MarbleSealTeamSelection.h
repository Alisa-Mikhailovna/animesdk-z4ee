...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_ADDMEMBER_OFFSET UNITYSDK_OFFSET(0xBC1C6E0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CLEARMEMBERS_OFFSET UNITYSDK_OFFSET(0xBC1C0A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEEMPTY_OFFSET UNITYSDK_OFFSET(0xBC138E0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEFULLTEAM_OFFSET UNITYSDK_OFFSET(0xBC137F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEWITHDEFAULTMEMBERS_1_OFFSET UNITYSDK_OFFSET(0xBC1BCF0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEWITHDEFAULTMEMBERS_OFFSET UNITYSDK_OFFSET(0xBC13410)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETFIRSTEMPTYINDEX_OFFSET UNITYSDK_OFFSET(0xBC1C4C0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMARBLESEALDATABYTEAMINDEX_OFFSET UNITYSDK_OFFSET(0xBC07130)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMARBLESUBSEALDATABYTEAMINDEX_OFFSET UNITYSDK_OFFSET(0xBC08470)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMEMBERIDS_OFFSET UNITYSDK_OFFSET(0xBC1C170)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMEMBERSCOUNT_OFFSET UNITYSDK_OFFSET(0xBC1C5C0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMEMBERS_OFFSET UNITYSDK_OFFSET(0xBC109C0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETONFIELDMARBLESEALDATABYTEAMINDEX_OFFSET UNITYSDK_OFFSET(0xBC08270)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETONFIELDMEMBERS_OFFSET UNITYSDK_OFFSET(0xBC1B2F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETTEAMINDEXBYMARBLESEALDATA_OFFSET UNITYSDK_OFFSET(0xBC1C540)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GET_MAXSELECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0xBC1C860)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GET__MGR_OFFSET UNITYSDK_OFFSET(0xBC1BC60)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xBC0B300)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_ISFULL_OFFSET UNITYSDK_OFFSET(0xBC1C2F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_ISSAMETEAM_OFFSET UNITYSDK_OFFSET(0xBC1C380)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_REMOVEMEMBER_OFFSET UNITYSDK_OFFSET(0xBC07340)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SETFULLTEAM_OFFSET UNITYSDK_OFFSET(0xBC1B940)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SETISINEDITMODE_OFFSET UNITYSDK_OFFSET(0xBC1C120)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SETMEMBER_OFFSET UNITYSDK_OFFSET(0xBC1C7A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SET_MAXSELECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0xBC1C870)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SYNCSERVERTEAM_OFFSET UNITYSDK_OFFSET(0xBC130D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xBC1B8F0)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleSealTeamSelection_TypeDefinitionIndex = 71272;
