...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_GENERATEBYTEAM_OFFSET UNITYSDK_OFFSET(0xBC1AB00)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_GETRANDOMTALKCONFIG_OFFSET UNITYSDK_OFFSET(0xBC1B4A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_GET_OFFSET UNITYSDK_OFFSET(0xBC1A9B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xBC1AAA0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xBC1B630)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xBC1A930)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleSealTalkGenerator_TypeDefinitionIndex = 71270;
