...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_CURRENTMATCHNUMBER_OFFSET UNITYSDK_OFFSET(0xBC06410)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xBC06070)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_PROGRESSID_OFFSET UNITYSDK_OFFSET(0xBC06490)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_PROGRESSNAME_OFFSET UNITYSDK_OFFSET(0xBC06450)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xBC064B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xBC06470)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_TOTALMATCHCOUNT_OFFSET UNITYSDK_OFFSET(0xBC06430)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_INIT_OFFSET UNITYSDK_OFFSET(0xBC05AC0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_OPENSETTLEPAGEVIEW_OFFSET UNITYSDK_OFFSET(0xBC062B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_OPENSTAGEINFOPAGEVIEW_OFFSET UNITYSDK_OFFSET(0xBC06150)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_CURRENTMATCHNUMBER_OFFSET UNITYSDK_OFFSET(0xBC06420)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_PROGRESSID_OFFSET UNITYSDK_OFFSET(0xBC064A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_PROGRESSNAME_OFFSET UNITYSDK_OFFSET(0xBC06460)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_REWARDID_OFFSET UNITYSDK_OFFSET(0xBC064C0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xBC06480)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_TOTALMATCHCOUNT_OFFSET UNITYSDK_OFFSET(0xBC06440)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SYNC_OFFSET UNITYSDK_OFFSET(0xBC060C0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xBC05AB0)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleKnockoutStage_TypeDefinitionIndex = 71280;
	...
	public:
		...
		::System::UInt32 _TotalMatchCount_k__BackingField; // 0x3C
