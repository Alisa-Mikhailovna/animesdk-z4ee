...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBC15BA0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO___C__DISPLAYCLASS6_0__STARTPVEMATCH_B__0_OFFSET UNITYSDK_OFFSET(0xBC16800)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEPLAYERPROGRESSINFO___C__DISPLAYCLASS6_0__STARTPVEMATCH_B__1_OFFSET UNITYSDK_OFFSET(0xBC16930)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarblePlayerProgressInfo___c__DisplayClass6_0_TypeDefinitionIndex = 71287;
