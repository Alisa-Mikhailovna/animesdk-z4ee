...
#define RPG_CLIENT_OPENWORLD_GRASSSTREAMINGITEMDEBUG_DRAWBOUNDSGIZMO_OFFSET UNITYSDK_OFFSET(0xCEF9650)
#define RPG_CLIENT_OPENWORLD_GRASSSTREAMINGITEMDEBUG_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xCEF9500)
#define RPG_CLIENT_OPENWORLD_GRASSSTREAMINGITEMDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xCEF9A80)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int GrassStreamingItemDebug_TypeDefinitionIndex = 70410;
