...
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_1_OFFSET UNITYSDK_OFFSET(0xCF0ACD0)
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_OFFSET UNITYSDK_OFFSET(0xCF09CD0)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0xCF0BBA0)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0xCF0BB80)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_OWNERSTAGE_OFFSET UNITYSDK_OFFSET(0xCF0BB60)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_3F16A63999F7FECF_OFFSET UNITYSDK_OFFSET(0xCF0A250)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0xCF0B300)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_919BC32C7F31A55F_OFFSET UNITYSDK_OFFSET(0xCF0A900)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_AC178E7C3533AC6E_OFFSET UNITYSDK_OFFSET(0xCF0A760)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCF0B1F0)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCF0B170)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCF0B0E0)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0xCF0BBB0)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0xCF0BB90)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_OWNERSTAGE_OFFSET UNITYSDK_OFFSET(0xCF0BB70)
#define RPG_CLIENT_OPENWORLD_VOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xCF0BBC0)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int Volume_TypeDefinitionIndex = 70585;
