...
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_CHECKBOUNDCONTAIN_1_OFFSET UNITYSDK_OFFSET(0xCF0CA80)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_CHECKBOUNDCONTAIN_2_OFFSET UNITYSDK_OFFSET(0xCF0CDB0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_CHECKBOUNDCONTAIN_OFFSET UNITYSDK_OFFSET(0xCF0CA00)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_16C90E0F008EA620_OFFSET UNITYSDK_OFFSET(0xCF0B620)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_40E03D354D1ACC85_OFFSET UNITYSDK_OFFSET(0xCF0BD80)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_7951E2DB4B5A91D5_OFFSET UNITYSDK_OFFSET(0xCF0BCE0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_C97E2C3DD6E5FF49_OFFSET UNITYSDK_OFFSET(0xCF0DB10)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_DF0DE2420FA94983_OFFSET UNITYSDK_OFFSET(0xCF0BB10)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xCF0D700)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_SETREGIONVOLUME_OFFSET UNITYSDK_OFFSET(0xCF0C8A0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_UPDATEVOLUME_1_OFFSET UNITYSDK_OFFSET(0xCF0AD60)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_UPDATEVOLUME_OFFSET UNITYSDK_OFFSET(0xCF09D60)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_WRITEREGIONTOSTAGEVOLUMECONFIGV2_OFFSET UNITYSDK_OFFSET(0xCF0C2A0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCF0BCD0)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int VolumeBase_TypeDefinitionIndex = 70583;
