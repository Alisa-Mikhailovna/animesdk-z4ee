...
#define RPG_CLIENT_OPENWORLD_PVSRUNTIMEREPLAYRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCF07260)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int PVSRuntimeReplayResultData_TypeDefinitionIndex = 70361;
