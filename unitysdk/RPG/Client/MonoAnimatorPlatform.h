...
#define RPG_CLIENT_MONOANIMATORPLATFORM_APPLYPLATFORMMOVEMENT_OFFSET UNITYSDK_OFFSET(0xCC30130)
#define RPG_CLIENT_MONOANIMATORPLATFORM_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC2FCA0)
#define RPG_CLIENT_MONOANIMATORPLATFORM_CALLPLATFORMMOVE_OFFSET UNITYSDK_OFFSET(0xCC301B0)
#define RPG_CLIENT_MONOANIMATORPLATFORM_GET_MOVEDDELEGATE_OFFSET UNITYSDK_OFFSET(0xCC2FC70)
#define RPG_CLIENT_MONOANIMATORPLATFORM_GET_NEEDREFRESHRAYCAST_OFFSET UNITYSDK_OFFSET(0xCC2FC90)
#define RPG_CLIENT_MONOANIMATORPLATFORM_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xCC2FC50)
#define RPG_CLIENT_MONOANIMATORPLATFORM_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xCC30270)
#define RPG_CLIENT_MONOANIMATORPLATFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCC300C0)
#define RPG_CLIENT_MONOANIMATORPLATFORM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCC2FD50)
#define RPG_CLIENT_MONOANIMATORPLATFORM_SET_MOVEDDELEGATE_OFFSET UNITYSDK_OFFSET(0xCC2FC80)
#define RPG_CLIENT_MONOANIMATORPLATFORM_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xCC2FC60)
#define RPG_CLIENT_MONOANIMATORPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xCC30520)
