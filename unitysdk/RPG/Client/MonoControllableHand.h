...
#define RPG_CLIENT_MONOCONTROLLABLEHAND_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC3A930)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xCC3A9D0)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_GET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0xCC3CAC0)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_GET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0xCC3CA80)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_GET_MAXRIGIDBODYROTPITCH_OFFSET UNITYSDK_OFFSET(0xCC3CA50)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_GET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0xCC3CA60)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_GET_PROXY_OFFSET UNITYSDK_OFFSET(0xCC3CAA0)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_METHOD_5_333EA71EB5698E72_OFFSET UNITYSDK_OFFSET(0xCC3AD80)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_METHOD_5_4F4018519B20BBDD_OFFSET UNITYSDK_OFFSET(0xCC3BEC0)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_METHOD_5_BC7ACE02BFE5C18D_OFFSET UNITYSDK_OFFSET(0xCC3B390)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xCC3C790)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_ONBIND_OFFSET UNITYSDK_OFFSET(0xCC3C030)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xCC3ACF0)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0xCC3BC60)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_ONSWITCHGESTURETYPE_OFFSET UNITYSDK_OFFSET(0xCC3BFB0)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xCC3BCF0)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_ONUNBIND_OFFSET UNITYSDK_OFFSET(0xCC3C210)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xCC3C390)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_SET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0xCC3CAD0)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_SET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0xCC3CA90)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_SET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0xCC3CA70)
#define RPG_CLIENT_MONOCONTROLLABLEHAND_SET_PROXY_OFFSET UNITYSDK_OFFSET(0xCC3CAB0)
#define RPG_CLIENT_MONOCONTROLLABLEHAND__CTOR_OFFSET UNITYSDK_OFFSET(0xCC3CAE0)
