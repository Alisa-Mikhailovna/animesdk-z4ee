...
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE_GET_FINISHTYPE_OFFSET UNITYSDK_OFFSET(0xC7B7C80)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE_GET_ISACTIVATED_OFFSET UNITYSDK_OFFSET(0xC7B7D20)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE_GET_PRAYQUESTID_OFFSET UNITYSDK_OFFSET(0xC7B7BE0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xC7B7BD0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE__INNODERANGE_OFFSET UNITYSDK_OFFSET(0xC7B7E40)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE__ISROUNDLEFT_OFFSET UNITYSDK_OFFSET(0xC7B8270)
