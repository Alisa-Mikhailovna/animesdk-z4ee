...
#define RPG_CLIENT_UIMAP3DCONTAINER_GETMAPBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0xD7D9EB0)
#define RPG_CLIENT_UIMAP3DCONTAINER_GETMAPBOUNDINGSPHERE_OFFSET UNITYSDK_OFFSET(0xD7DB290)
#define RPG_CLIENT_UIMAP3DCONTAINER_GETMAPROTATION_OFFSET UNITYSDK_OFFSET(0xD7D9D60)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET_VIEWMODELROTATION_OFFSET UNITYSDK_OFFSET(0xD7D9260)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET__CURRENTMODELUP_OFFSET UNITYSDK_OFFSET(0xD7DD050)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET__INITMODELUP_OFFSET UNITYSDK_OFFSET(0xD7DF8C0)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET__MAPMODELTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD7D9200)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET__POSETRANSFORMS_OFFSET UNITYSDK_OFFSET(0xD7DB140)
#define RPG_CLIENT_UIMAP3DCONTAINER_INIT_OFFSET UNITYSDK_OFFSET(0xD7D8CE0)
#define RPG_CLIENT_UIMAP3DCONTAINER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xD7DC360)
#define RPG_CLIENT_UIMAP3DCONTAINER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD7DCBB0)
#define RPG_CLIENT_UIMAP3DCONTAINER_RESET_OFFSET UNITYSDK_OFFSET(0xD7DC0F0)
#define RPG_CLIENT_UIMAP3DCONTAINER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7DC080)
#define RPG_CLIENT_UIMAP3DCONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD7DFBB0)
#define RPG_CLIENT_UIMAP3DCONTAINER__CLAMPPITCH_OFFSET UNITYSDK_OFFSET(0xD7DF120)
#define RPG_CLIENT_UIMAP3DCONTAINER__CLEARDAMPINGRECOVERSTATES_OFFSET UNITYSDK_OFFSET(0xD7DC170)
#define RPG_CLIENT_UIMAP3DCONTAINER__CLEARROTATELOCK_OFFSET UNITYSDK_OFFSET(0xD7DCEE0)
#define RPG_CLIENT_UIMAP3DCONTAINER__COMPUTEPITCHOUTRATIO_OFFSET UNITYSDK_OFFSET(0xD7DDC80)
#define RPG_CLIENT_UIMAP3DCONTAINER__COMPUTEROTATESPEEDDAMPING_OFFSET UNITYSDK_OFFSET(0xD7DCF30)
#define RPG_CLIENT_UIMAP3DCONTAINER__COMPUTEROTATESPEEDDEFAULT_OFFSET UNITYSDK_OFFSET(0xD7DCD90)
#define RPG_CLIENT_UIMAP3DCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7DFAA0)
#define RPG_CLIENT_UIMAP3DCONTAINER__FETCHROTATEINPUT_OFFSET UNITYSDK_OFFSET(0xD7DD940)
#define RPG_CLIENT_UIMAP3DCONTAINER__INITPOSETRANSPROVIDER_OFFSET UNITYSDK_OFFSET(0xD7D94C0)
#define RPG_CLIENT_UIMAP3DCONTAINER__INITUNWALKABLE_OFFSET UNITYSDK_OFFSET(0xD7D9AE0)
#define RPG_CLIENT_UIMAP3DCONTAINER__ONMAP3DTOUCHENABLED_OFFSET UNITYSDK_OFFSET(0xD7DF0C0)
#define RPG_CLIENT_UIMAP3DCONTAINER__RECOVERPITCH_OFFSET UNITYSDK_OFFSET(0xD7DD260)
#define RPG_CLIENT_UIMAP3DCONTAINER__ROTATEMODEL_OFFSET UNITYSDK_OFFSET(0xD7DC6B0)
#define RPG_CLIENT_UIMAP3DCONTAINER__SETLAYERRECURSIVELY_OFFSET UNITYSDK_OFFSET(0xD7D9840)
#define RPG_CLIENT_UIMAP3DCONTAINER__STARTRESETROTATION_OFFSET UNITYSDK_OFFSET(0xD7DC1C0)
#define RPG_CLIENT_UIMAP3DCONTAINER__SYNCMAPTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD7D9950)
#define RPG_CLIENT_UIMAP3DCONTAINER__UPDATEMAPTRANSPARENCY_OFFSET UNITYSDK_OFFSET(0xD7DE3E0)
#define RPG_CLIENT_UIMAP3DCONTAINER__UPDATERESET_OFFSET UNITYSDK_OFFSET(0xD7DC400)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMap3DContainer_TypeDefinitionIndex)->GetStaticField(0xE180);
		}
		static ::System::Int32* StaticGet_s_Color()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMap3DContainer_TypeDefinitionIndex)->GetStaticField(0xE184);
		}
