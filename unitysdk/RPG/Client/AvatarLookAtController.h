...
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xBDFE5D0)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_GET_ISLOOKATENABLED_OFFSET UNITYSDK_OFFSET(0xBDFE7A0)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xBDFDAA0)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_MAPTARGETFORWARD_OFFSET UNITYSDK_OFFSET(0xBDFDB40)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xBDFE630)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_METHOD_5_51BAC440AEEC47A9_OFFSET UNITYSDK_OFFSET(0xBDFE0A0)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_SETDISABLEWITHCAUSE_OFFSET UNITYSDK_OFFSET(0xBDFE510)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_SETUPCURVEBLENDER_OFFSET UNITYSDK_OFFSET(0xBDFDDE0)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_STOPLOOKAT_OFFSET UNITYSDK_OFFSET(0xBDFDA00)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_UPDATELOOKATSOLVE_OFFSET UNITYSDK_OFFSET(0xBDFDE50)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBDFE830)
