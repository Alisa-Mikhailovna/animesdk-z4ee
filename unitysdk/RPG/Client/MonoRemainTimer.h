...
#define RPG_CLIENT_MONOREMAINTIMER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD18E80)
#define RPG_CLIENT_MONOREMAINTIMER_CLEAR_OFFSET UNITYSDK_OFFSET(0xCD19830)
#define RPG_CLIENT_MONOREMAINTIMER_FORCEUPDATETIME_OFFSET UNITYSDK_OFFSET(0xCD18C60)
#define RPG_CLIENT_MONOREMAINTIMER_INITTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCD17930)
#define RPG_CLIENT_MONOREMAINTIMER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD197E0)
#define RPG_CLIENT_MONOREMAINTIMER_SETREAMINTIMEWITHTIMEMODE_OFFSET UNITYSDK_OFFSET(0xCD17DE0)
#define RPG_CLIENT_MONOREMAINTIMER_SETREMAINTIMEINSECONDSBYFORMAT_OFFSET UNITYSDK_OFFSET(0xCD181C0)
#define RPG_CLIENT_MONOREMAINTIMER_SETREMAINTIMEINSECONDS_OFFSET UNITYSDK_OFFSET(0xCD178A0)
#define RPG_CLIENT_MONOREMAINTIMER_SETREMAINTIME_OFFSET UNITYSDK_OFFSET(0xCD18F30)
#define RPG_CLIENT_MONOREMAINTIMER_SETTARGETTIMEBYTIMESTAMP_OFFSET UNITYSDK_OFFSET(0xCD18B70)
#define RPG_CLIENT_MONOREMAINTIMER_SETTARGETTIME_OFFSET UNITYSDK_OFFSET(0xCD18AD0)
#define RPG_CLIENT_MONOREMAINTIMER_SETTRANSFORMACTIVEBYTIMEMODE_OFFSET UNITYSDK_OFFSET(0xCD187B0)
#define RPG_CLIENT_MONOREMAINTIMER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD18EE0)
#define RPG_CLIENT_MONOREMAINTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD19880)
#define RPG_CLIENT_MONOREMAINTIMER__UPDATETIME_OFFSET UNITYSDK_OFFSET(0xCD18CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRemainTimer_TypeDefinitionIndex = 69313;
