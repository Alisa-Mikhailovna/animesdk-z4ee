...
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE_GET_RICHTEXTMESSAGENAME_OFFSET UNITYSDK_OFFSET(0xC858E60)
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE_GET_RICHTEXTVALUEMAP_OFFSET UNITYSDK_OFFSET(0xC858ED0)
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE_GET_ROLEUNIQUEID_OFFSET UNITYSDK_OFFSET(0xC858D70)
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE_UPDATE_OFFSET UNITYSDK_OFFSET(0xC858E10)
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE__CTOR_OFFSET UNITYSDK_OFFSET(0xC858D60)
