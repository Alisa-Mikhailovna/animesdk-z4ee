...
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_GET_ACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0xCB68B10)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xCB68820)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_GET_PVPMODULEID_OFFSET UNITYSDK_OFFSET(0xCB688A0)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_GET_PVPMODULESCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0xCB68B30)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_GET_PVPUNLOCKSUBMISSIONID_OFFSET UNITYSDK_OFFSET(0xCB68B50)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_GET__ENTRANCEUNLOCKSUBMISSIONID_OFFSET UNITYSDK_OFFSET(0xCB68A00)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_GET__PVPUNLOCKSUBMISSIONID_OFFSET UNITYSDK_OFFSET(0xCB68920)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_INITONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0xCB69150)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_INITONMODULEINITREQ_OFFSET UNITYSDK_OFFSET(0xCB68E90)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_ISENTRANCEUNLOCKED_OFFSET UNITYSDK_OFFSET(0xCB694F0)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_ISPVPINSCHEDULE_OFFSET UNITYSDK_OFFSET(0xCB69380)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_ISPVPUNLOCKED_OFFSET UNITYSDK_OFFSET(0xCB693E0)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_SET_ACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0xCB68B20)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO_SET_PVPMODULESCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0xCB68B40)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO__COLLECTREQUIREDSUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xCB68FD0)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCB68BA0)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO__GETSUBMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0xCB69440)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYINFO__INITONMODULEINITREQ_B__22_0_OFFSET UNITYSDK_OFFSET(0xCB69550)
