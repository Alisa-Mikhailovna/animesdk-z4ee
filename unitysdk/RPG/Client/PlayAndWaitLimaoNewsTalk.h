...
#define RPG_CLIENT_PLAYANDWAITLIMAONEWSTALK_METHOD_4_C055C8D412427A27_OFFSET UNITYSDK_OFFSET(0x1B0E9AE0)
#define RPG_CLIENT_PLAYANDWAITLIMAONEWSTALK_METHOD_4_FE169169B2FB666C_OFFSET UNITYSDK_OFFSET(0x1B0E9B20)
#define RPG_CLIENT_PLAYANDWAITLIMAONEWSTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E9B10)
