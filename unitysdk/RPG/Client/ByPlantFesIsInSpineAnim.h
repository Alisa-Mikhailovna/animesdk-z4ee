...
#define RPG_CLIENT_BYPLANTFESISINSPINEANIM_METHOD_4_1928C942BE7E5075_OFFSET UNITYSDK_OFFSET(0x1B0E00D0)
#define RPG_CLIENT_BYPLANTFESISINSPINEANIM_METHOD_4_5AD458A745B8CABE_OFFSET UNITYSDK_OFFSET(0x1B0DFF00)
#define RPG_CLIENT_BYPLANTFESISINSPINEANIM_METHOD_4_6D24379EB333B31F_OFFSET UNITYSDK_OFFSET(0x1B0DFF40)
#define RPG_CLIENT_BYPLANTFESISINSPINEANIM_METHOD_4_D1DD2C41DB6F3A72_OFFSET UNITYSDK_OFFSET(0x1B0E0100)
#define RPG_CLIENT_BYPLANTFESISINSPINEANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DFF30)
