...
#define RPG_CLIENT_NETWORKMANAGER___C__DISPLAYCLASS1321_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCED0300)
#define RPG_CLIENT_NETWORKMANAGER___C__DISPLAYCLASS1321_0__SENDENTERAETHERDIVIDESCENECSREQ_B__0_OFFSET UNITYSDK_OFFSET(0xCED4620)
#define RPG_CLIENT_NETWORKMANAGER___C__DISPLAYCLASS1321_0__SENDENTERAETHERDIVIDESCENECSREQ_B__1_OFFSET UNITYSDK_OFFSET(0xCED4720)
