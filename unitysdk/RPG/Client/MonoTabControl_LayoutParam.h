...
#define RPG_CLIENT_MONOTABCONTROL_LAYOUTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD27520)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTabControl_LayoutParam_TypeDefinitionIndex = 69327;
