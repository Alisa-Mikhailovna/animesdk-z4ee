...
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_CANEDITINPREPARATIONSTATE_OFFSET UNITYSDK_OFFSET(0xC705A20)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_CANEDIT_OFFSET UNITYSDK_OFFSET(0xC7059B0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GETEDITICON_OFFSET UNITYSDK_OFFSET(0xC705BF0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_ACTION_OFFSET UNITYSDK_OFFSET(0xC705CD0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_COMPLETEDQUESTCOUNT_OFFSET UNITYSDK_OFFSET(0xC705D00)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_INPENDING_OFFSET UNITYSDK_OFFSET(0xC705C70)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_SELECTEDQUESTS_OFFSET UNITYSDK_OFFSET(0xC705CF0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xC7051F0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_REGISTERACTION_OFFSET UNITYSDK_OFFSET(0xC705BA0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_SET_ACTION_OFFSET UNITYSDK_OFFSET(0xC705CE0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_STARTEDIT_OFFSET UNITYSDK_OFFSET(0xC705AB0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC705180)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT__ONQUESTPROPERTYCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xC7058B0)
