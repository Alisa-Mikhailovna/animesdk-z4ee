...
#define RPG_CLIENT_MONOANIMATORSTATESYNC_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC314D0)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCC31630)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_141D40B68A9E2D14_OFFSET UNITYSDK_OFFSET(0xCC31770)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_7E3758126DC70293_OFFSET UNITYSDK_OFFSET(0xCC31840)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0xCC31820)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xCC31830)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCC31710)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCC316A0)
#define RPG_CLIENT_MONOANIMATORSTATESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0xCC31A90)
