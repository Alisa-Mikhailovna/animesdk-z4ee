...
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xBF11B90)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_ANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0xBF11900)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_AUDIOTAG_OFFSET UNITYSDK_OFFSET(0xBF11AF0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_CD_OFFSET UNITYSDK_OFFSET(0xBF117C0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_DELAY_OFFSET UNITYSDK_OFFSET(0xBF11860)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0xBF11720)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xBF11670)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xBF11A50)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0xBF11990)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBF11680)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xBF11610)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xBF11BE0)

namespace RPG::Client::CakeRace
{
	inline static constexpr unsigned int CakeRacePerformanceDataItem_TypeDefinitionIndex = 72557;
