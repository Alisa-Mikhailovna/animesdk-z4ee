...
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBEFEA60)
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA_GET_CATANIMDELAY_OFFSET UNITYSDK_OFFSET(0xBEFEA20)
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA_GET_CATVIEW_OFFSET UNITYSDK_OFFSET(0xBEFE9E0)
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0xBEFEA40)
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA_GET_TALKBUBBLE_OFFSET UNITYSDK_OFFSET(0xBEFEA00)
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA_SET_CATANIMDELAY_OFFSET UNITYSDK_OFFSET(0xBEFEA30)
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA_SET_CATVIEW_OFFSET UNITYSDK_OFFSET(0xBEFE9F0)
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA_SET_RANK_OFFSET UNITYSDK_OFFSET(0xBEFEA50)
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA_SET_TALKBUBBLE_OFFSET UNITYSDK_OFFSET(0xBEFEA10)
#define RPG_CLIENT_CAKERACE_CAKERACECATUI3DPERFORMANCEPREPAREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBEFEB00)

namespace RPG::Client::CakeRace
{
	inline static constexpr unsigned int CakeRaceCatUI3DPerformancePrepareData_TypeDefinitionIndex = 72555;
