...
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xBF11BF0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO_GETOWLBERTANIMDATAITEM_OFFSET UNITYSDK_OFFSET(0xBF123F0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO_GETPERFORMANCEDATAITEM_OFFSET UNITYSDK_OFFSET(0xBF12360)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xBF11D70)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO__INITANIMCONFIG_OFFSET UNITYSDK_OFFSET(0xBF12120)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO__INITPERFORMANCEDATAITEMS_OFFSET UNITYSDK_OFFSET(0xBF11EA0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO__INIT_OFFSET UNITYSDK_OFFSET(0xBF11E50)

namespace RPG::Client::CakeRace
{
	inline static constexpr unsigned int CakeRacePerformanceInfo_TypeDefinitionIndex = 72558;
