...
#define RPG_CLIENT_ARTNPCPEDESTRIANENTITYCONFIG_METHOD_3_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0xBDA4A10)
#define RPG_CLIENT_ARTNPCPEDESTRIANENTITYCONFIG_METHOD_3_FFBBF9E1E02C75F2_OFFSET UNITYSDK_OFFSET(0xBDA45C0)
#define RPG_CLIENT_ARTNPCPEDESTRIANENTITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBDA5080)
