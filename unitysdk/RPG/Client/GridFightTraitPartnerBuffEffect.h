...
#define RPG_CLIENT_GRIDFIGHTTRAITPARTNERBUFFEFFECT_CANCAST_OFFSET UNITYSDK_OFFSET(0xC848F30)
#define RPG_CLIENT_GRIDFIGHTTRAITPARTNERBUFFEFFECT_GETEFFECTPATH_OFFSET UNITYSDK_OFFSET(0xC848A90)
#define RPG_CLIENT_GRIDFIGHTTRAITPARTNERBUFFEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0xC848FA0)
#define RPG_CLIENT_GRIDFIGHTTRAITPARTNERBUFFEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC848F90)
#define RPG_CLIENT_GRIDFIGHTTRAITPARTNERBUFFEFFECT__GETEFFECTPATH_OFFSET UNITYSDK_OFFSET(0xC848CC0)
#define RPG_CLIENT_GRIDFIGHTTRAITPARTNERBUFFEFFECT__TRYGETACTIVITEROLE_OFFSET UNITYSDK_OFFSET(0xC848B00)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightTraitPartnerBuffEffect_TypeDefinitionIndex)->GetStaticField(0x2E300);
		}
