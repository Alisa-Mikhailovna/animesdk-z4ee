...
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_GETBLACKCOUNT_OFFSET UNITYSDK_OFFSET(0xC704F00)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_GET_HASBLACKQUEST_OFFSET UNITYSDK_OFFSET(0xC704DB0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0xC704D90)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_SELECTMEMBER_OFFSET UNITYSDK_OFFSET(0xC704B20)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_SELECT_OFFSET UNITYSDK_OFFSET(0xC704CB0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0xC704DA0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_SYNC_OFFSET UNITYSDK_OFFSET(0xC704910)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC7048A0)
