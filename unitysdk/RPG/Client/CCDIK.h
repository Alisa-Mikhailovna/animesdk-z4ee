...
#define RPG_CLIENT_CCDIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0xBEDA020)
#define RPG_CLIENT_CCDIK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xBEDA0B0)
#define RPG_CLIENT_CCDIK_IKRESET_OFFSET UNITYSDK_OFFSET(0xBEDA210)
#define RPG_CLIENT_CCDIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xBEDA2A0)
#define RPG_CLIENT_CCDIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0xBEDA100)
#define RPG_CLIENT_CCDIK__CTOR_OFFSET UNITYSDK_OFFSET(0xBEDA570)
