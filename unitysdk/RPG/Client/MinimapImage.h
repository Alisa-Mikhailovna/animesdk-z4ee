...
#define RPG_CLIENT_MINIMAPIMAGE_GET__SECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0xCBCC8B0)
#define RPG_CLIENT_MINIMAPIMAGE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0xCBCB600)
#define RPG_CLIENT_MINIMAPIMAGE_SETFADEINFOS_OFFSET UNITYSDK_OFFSET(0xCBCAB60)
#define RPG_CLIENT_MINIMAPIMAGE_SETROTATIONANGLES_OFFSET UNITYSDK_OFFSET(0xCBCAAE0)
#define RPG_CLIENT_MINIMAPIMAGE_SETSPRITEVERTEXDATA_OFFSET UNITYSDK_OFFSET(0xCBCA8C0)
#define RPG_CLIENT_MINIMAPIMAGE_SETTARGETRECT_OFFSET UNITYSDK_OFFSET(0xCBCA970)
#define RPG_CLIENT_MINIMAPIMAGE_SETVISIBILITY_OFFSET UNITYSDK_OFFSET(0xCBCA9C0)
#define RPG_CLIENT_MINIMAPIMAGE_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0xCBCAF90)
#define RPG_CLIENT_MINIMAPIMAGE_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0xCBCABB0)
#define RPG_CLIENT_MINIMAPIMAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0xCBCCA00)
#define RPG_CLIENT_MINIMAPIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCBCC900)
#define RPG_CLIENT_MINIMAPIMAGE__GETTARGETCIRCLE_OFFSET UNITYSDK_OFFSET(0xCBCC190)
#define RPG_CLIENT_MINIMAPIMAGE__INITMESH_OFFSET UNITYSDK_OFFSET(0xCBCBDB0)
#define RPG_CLIENT_MINIMAPIMAGE__ONPOPULATEMESH_G____DISTPOINTTOLINE_8_1_OFFSET UNITYSDK_OFFSET(0xCBCCA70)
#define RPG_CLIENT_MINIMAPIMAGE__ONPOPULATEMESH_G____OVERLAPS_8_0_OFFSET UNITYSDK_OFFSET(0xCBCC510)
#define RPG_CLIENT_MINIMAPIMAGE__UPDATEFADING_OFFSET UNITYSDK_OFFSET(0xCBCAC10)

namespace RPG::Client
{
	inline static constexpr unsigned int MinimapImage_TypeDefinitionIndex = 69291;
	...
	public:
		...
		{
			return (::UnityEngine::UI::VertexHelper**)Il2CppClass::FromTypeDefinitionIndex(MinimapImage_TypeDefinitionIndex)->GetStaticField(0x51660);
		}
		static ::System::Int32* StaticGet__FadeParams1ID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MinimapImage_TypeDefinitionIndex)->GetStaticField(0xE530);
		}
		static ::System::Int32* StaticGet__FadeParams2ID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MinimapImage_TypeDefinitionIndex)->GetStaticField(0xE534);
		}
