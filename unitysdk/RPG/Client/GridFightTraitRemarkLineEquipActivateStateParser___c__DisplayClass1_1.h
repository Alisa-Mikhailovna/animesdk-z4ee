...
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEQUIPACTIVATESTATEPARSER___C__DISPLAYCLASS1_1__CTOR_OFFSET UNITYSDK_OFFSET(0xC84B1B0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEQUIPACTIVATESTATEPARSER___C__DISPLAYCLASS1_1___GETISACTIVE_B__3_OFFSET UNITYSDK_OFFSET(0xC84B1C0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEQUIPACTIVATESTATEPARSER___C__DISPLAYCLASS1_1___GETISACTIVE_B__4_OFFSET UNITYSDK_OFFSET(0xC84B1F0)
