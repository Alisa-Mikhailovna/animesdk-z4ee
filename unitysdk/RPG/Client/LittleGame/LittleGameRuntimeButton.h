...
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_CLEAR_OFFSET UNITYSDK_OFFSET(0xC9D3A80)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xC9D3A40)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_GET_ORIGINBUTTONNAME_OFFSET UNITYSDK_OFFSET(0xC9D3A60)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xC9D3A50)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_SET_ORIGINBUTTONNAME_OFFSET UNITYSDK_OFFSET(0xC9D3A70)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D3AE0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int LittleGameRuntimeButton_TypeDefinitionIndex = 72610;
