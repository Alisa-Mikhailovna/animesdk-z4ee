...
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0xC969AC0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC969B60)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xC969BB0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0xC969A40)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xC9699B0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC969CC0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int BaseMonoView_TypeDefinitionIndex = 72574;
