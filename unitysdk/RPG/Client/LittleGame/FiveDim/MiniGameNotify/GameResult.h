...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MINIGAMENOTIFY_GAMERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xC9BD5A0)

namespace RPG::Client::LittleGame::FiveDim::MiniGameNotify
{
	inline static constexpr unsigned int GameResult_TypeDefinitionIndex = 73297;
	...
	public:
		...
		::System::Boolean IsMaxScore; // 0x34
