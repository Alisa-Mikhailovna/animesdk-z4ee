...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEMATCHCALCULATOR_CREATE_OFFSET UNITYSDK_OFFSET(0xC9A33A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEMATCHCALCULATOR_GETMATCHCODE_OFFSET UNITYSDK_OFFSET(0xC9A5320)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEMATCHCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC9A4FB0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEMATCHCALCULATOR__INIT_OFFSET UNITYSDK_OFFSET(0xC9A5050)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEMATCHCALCULATOR__ISNEWGUIDEFLUTE_OFFSET UNITYSDK_OFFSET(0xC9A5430)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFluteMatchCalculator_TypeDefinitionIndex = 73267;
