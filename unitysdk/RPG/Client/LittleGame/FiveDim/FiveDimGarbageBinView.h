...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_GETVIEWBOUND_OFFSET UNITYSDK_OFFSET(0xC9A7700)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC9A7140)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_METHOD_8_175872DEECEEDC6A_OFFSET UNITYSDK_OFFSET(0xC9A7320)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_METHOD_8_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xC9A7840)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xC9A74F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9A7930)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimGarbageBinView_TypeDefinitionIndex = 73230;
