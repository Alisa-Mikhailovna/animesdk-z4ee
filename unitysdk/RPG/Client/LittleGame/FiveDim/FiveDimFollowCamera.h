...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_ENABLEFOLLOWDAMPENTITYMOVE_OFFSET UNITYSDK_OFFSET(0xC9A6140)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_GETDESIREDCAMERADISTANCE_OFFSET UNITYSDK_OFFSET(0xC9A5B50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_METHOD_8_9D9B7DF96DEBE5E9_OFFSET UNITYSDK_OFFSET(0xC9A5BB0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_RELEASE_OFFSET UNITYSDK_OFFSET(0xC9A56A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_SETBIASY_OFFSET UNITYSDK_OFFSET(0xC9A6090)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_SETDAMPINENTITYSPACE_OFFSET UNITYSDK_OFFSET(0xC9A5710)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_SETDAMPINGY_OFFSET UNITYSDK_OFFSET(0xC9A5CE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_SETDESIREDCAMERADISTANCE_OFFSET UNITYSDK_OFFSET(0xC9A5C70)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_SETFOLLOWCONFIG_OFFSET UNITYSDK_OFFSET(0xC9A5D50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_SETSCREENY_OFFSET UNITYSDK_OFFSET(0xC9A6020)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA_SETVIEWHEIGHT_OFFSET UNITYSDK_OFFSET(0xC9A6220)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFOLLOWCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xC9A63F0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFollowCamera_TypeDefinitionIndex = 72914;
