...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0xC9981B0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE_PREPIPELINEMUTATECAMERASTATECALLBACK_OFFSET UNITYSDK_OFFSET(0xC997C30)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE_SETDAMPTARGETSPACE_OFFSET UNITYSDK_OFFSET(0xC997AE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE_SETFOLLOWDAMPENTITYMOVE_OFFSET UNITYSDK_OFFSET(0xC997B90)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0xC998440)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimCinemachineMoveFollowTargetInSpecificSpace_TypeDefinitionIndex = 72912;
