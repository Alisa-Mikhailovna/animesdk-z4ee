...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCLEANERBOTVIEW_METHOD_7_3FFD0D3E22A538D6_OFFSET UNITYSDK_OFFSET(0xC999C70)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCLEANERBOTVIEW_METHOD_7_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0xC999B30)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCLEANERBOTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC999F80)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimCleanerBotView_TypeDefinitionIndex = 73225;
