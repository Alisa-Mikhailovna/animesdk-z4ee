...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_PHANTOMPLAYERRECORDFRAMES_METHOD_1_5A8144964C1A6642_OFFSET UNITYSDK_OFFSET(0x1A8668B0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_PHANTOMPLAYERRECORDFRAMES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A866C50)
