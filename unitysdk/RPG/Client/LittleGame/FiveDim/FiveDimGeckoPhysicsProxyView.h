...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGECKOPHYSICSPROXYVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC9A7B80)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGECKOPHYSICSPROXYVIEW_METHOD_8_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xC9A7CA0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGECKOPHYSICSPROXYVIEW_METHOD_8_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0xC9A7970)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGECKOPHYSICSPROXYVIEW_METHOD_8_BC7ACE02BFE5C18D_OFFSET UNITYSDK_OFFSET(0xC9A7DA0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGECKOPHYSICSPROXYVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xC9A7C00)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGECKOPHYSICSPROXYVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9A7ED0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimGeckoPhysicsProxyView_TypeDefinitionIndex = 73255;
