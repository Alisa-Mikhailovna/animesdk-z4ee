...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC9AEEE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_METHOD_8_45FED451D133E002_OFFSET UNITYSDK_OFFSET(0xC9AF1F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_METHOD_8_66F42CE2EDA79734_OFFSET UNITYSDK_OFFSET(0xC9AEC70)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_METHOD_8_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC9AF050)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_METHOD_8_F089878453670550_OFFSET UNITYSDK_OFFSET(0xC9AF0C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xC9AEF60)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9AF2A0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimMissilePhysicsProxyView_TypeDefinitionIndex = 73257;
