...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_ADDFLUTEDATA_OFFSET UNITYSDK_OFFSET(0xC9A2E60)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0xC9A2D50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_GETFLUTEDATALIST_OFFSET UNITYSDK_OFFSET(0xC9A3050)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0xC9A2F40)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_GET_FLORNAME_OFFSET UNITYSDK_OFFSET(0xC9A2F60)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0xC9A2F50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xC9A2E10)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFluteDataGroup_TypeDefinitionIndex = 73263;
