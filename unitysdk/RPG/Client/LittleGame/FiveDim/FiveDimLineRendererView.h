...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMLINERENDERERVIEW_SETLINERENDERERPOSITIONS_OFFSET UNITYSDK_OFFSET(0xC9AEB90)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMLINERENDERERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9AEC50)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimLineRendererView_TypeDefinitionIndex = 73239;
