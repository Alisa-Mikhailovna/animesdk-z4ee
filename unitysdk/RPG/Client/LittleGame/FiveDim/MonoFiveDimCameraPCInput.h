...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_METHOD_5_09FE42768C6D9433_OFFSET UNITYSDK_OFFSET(0xC9BFFF0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_METHOD_5_EAD49BE374ABF145_1_OFFSET UNITYSDK_OFFSET(0xC9C0090)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_METHOD_5_EAD49BE374ABF145_OFFSET UNITYSDK_OFFSET(0xC9BFF80)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC9C00F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_START_OFFSET UNITYSDK_OFFSET(0xC9BFCA0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C03D0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int MonoFiveDimCameraPCInput_TypeDefinitionIndex = 73285;
