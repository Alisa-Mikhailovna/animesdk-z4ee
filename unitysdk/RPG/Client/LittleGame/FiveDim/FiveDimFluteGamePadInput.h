...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT_ADDINPUTHANDLER_OFFSET UNITYSDK_OFFSET(0xC9A4110)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT_AWAKE_OFFSET UNITYSDK_OFFSET(0xC9A4160)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9A4320)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0xC9A4D20)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__GETINCONTROLLEFTSTICKINPUTDIRECTION_OFFSET UNITYSDK_OFFSET(0xC9A46D0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__GETINPUTINFO_1_OFFSET UNITYSDK_OFFSET(0xC9A4BA0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__GETINPUTINFO_OFFSET UNITYSDK_OFFSET(0xC9A4AE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__INITVIEW_OFFSET UNITYSDK_OFFSET(0xC9A41B0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__TRYINVOKERCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9A4A70)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__UPDATEGAMEPADINPUT_OFFSET UNITYSDK_OFFSET(0xC9A4390)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFluteGamePadInput_TypeDefinitionIndex = 73273;
