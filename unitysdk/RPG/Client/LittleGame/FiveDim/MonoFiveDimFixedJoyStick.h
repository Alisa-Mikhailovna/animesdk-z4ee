...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_ADDJOYSTICKDRAGEVENT_OFFSET UNITYSDK_OFFSET(0xC9A0C10)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_ADDJOYSTICKPOINTDOWNEVENT_OFFSET UNITYSDK_OFFSET(0xC9A0A00)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_ADDJOYSTICKPOINTUPEVENT_OFFSET UNITYSDK_OFFSET(0xC9A0B30)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_AWAKE_OFFSET UNITYSDK_OFFSET(0xC9C08D0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC9A0DE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_GETNORMALIZEDDISTANCE_OFFSET UNITYSDK_OFFSET(0xC9A0810)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_GETUIANGLE_OFFSET UNITYSDK_OFFSET(0xC9A0900)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_GET__CENTERPOS_OFFSET UNITYSDK_OFFSET(0xC9C1200)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_GET__INPUTRADIUSSCREEN_OFFSET UNITYSDK_OFFSET(0xC9C0F10)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_GET__UISIZE_OFFSET UNITYSDK_OFFSET(0xC9C0610)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC9C0980)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC9C0930)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_ONDRAG_OFFSET UNITYSDK_OFFSET(0xC9C04D0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xC9C0520)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xC9C03E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC9A0D10)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__CLEARALLEVENTS_OFFSET UNITYSDK_OFFSET(0xC9C0750)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__CLEARINFO_OFFSET UNITYSDK_OFFSET(0xC9C05C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__COMPUTEDRAGINFO_OFFSET UNITYSDK_OFFSET(0xC9C0A90)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C1350)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__INITVIEW_OFFSET UNITYSDK_OFFSET(0xC9C1000)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__INIT_OFFSET UNITYSDK_OFFSET(0xC9C0880)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__ISDISTANCEVALID_OFFSET UNITYSDK_OFFSET(0xC9C0B90)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__ONBEGININPUTVALID_OFFSET UNITYSDK_OFFSET(0xC9C0E00)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__ONDRAGINPUTVALID_OFFSET UNITYSDK_OFFSET(0xC9C0E50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMFIXEDJOYSTICK__ONENDINPUTVALID_OFFSET UNITYSDK_OFFSET(0xC9C0440)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int MonoFiveDimFixedJoyStick_TypeDefinitionIndex = 73286;
