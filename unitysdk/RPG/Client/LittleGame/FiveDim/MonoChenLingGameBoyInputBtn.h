...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN_ADDINPUTHANDLER_OFFSET UNITYSDK_OFFSET(0xC9BD630)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN_AWAKE_OFFSET UNITYSDK_OFFSET(0xC9BD680)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9BD6C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__CTOR_OFFSET UNITYSDK_OFFSET(0xC9BE060)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__GETINCONTROLLEFTSTICKINPUTDIRECTION_OFFSET UNITYSDK_OFFSET(0xC9BD9C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__GETINPUTINFO_1_OFFSET UNITYSDK_OFFSET(0xC9BDED0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__GETINPUTINFO_OFFSET UNITYSDK_OFFSET(0xC9BDDF0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__TRYINVOKERCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9BDD60)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__UPDATEGAMEPADINPUT_OFFSET UNITYSDK_OFFSET(0xC9BD730)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int MonoChenLingGameBoyInputBtn_TypeDefinitionIndex = 73281;
