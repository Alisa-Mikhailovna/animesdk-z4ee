...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFEATHERPHYSICSPROXYVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC9A0210)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFEATHERPHYSICSPROXYVIEW_METHOD_8_45FED451D133E002_OFFSET UNITYSDK_OFFSET(0xC9A0550)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFEATHERPHYSICSPROXYVIEW_METHOD_8_66F42CE2EDA79734_OFFSET UNITYSDK_OFFSET(0xC99FFA0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFEATHERPHYSICSPROXYVIEW_METHOD_8_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC9A0380)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFEATHERPHYSICSPROXYVIEW_METHOD_8_C6C00AC7D323B1B0_OFFSET UNITYSDK_OFFSET(0xC9A03F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFEATHERPHYSICSPROXYVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xC9A0290)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFEATHERPHYSICSPROXYVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9A0600)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFeatherPhysicsProxyView_TypeDefinitionIndex = 73252;
