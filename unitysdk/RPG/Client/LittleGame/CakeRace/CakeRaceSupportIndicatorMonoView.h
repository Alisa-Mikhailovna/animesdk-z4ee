...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xC96DE90)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC96DE70)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_SETSUPPORT_OFFSET UNITYSDK_OFFSET(0xC96DEF0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_SET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC96DE80)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC96DF50)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceSupportIndicatorMonoView_TypeDefinitionIndex = 74206;
