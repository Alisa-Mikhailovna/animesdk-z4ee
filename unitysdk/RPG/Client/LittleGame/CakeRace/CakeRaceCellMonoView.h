...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLMONOVIEW_GET_WRAPPER_OFFSET UNITYSDK_OFFSET(0xC96B860)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLMONOVIEW_SETWRAPPER_OFFSET UNITYSDK_OFFSET(0xC96B880)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLMONOVIEW_SET_WRAPPER_OFFSET UNITYSDK_OFFSET(0xC96B870)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC96B8D0)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceCellMonoView_TypeDefinitionIndex = 74196;
