...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_AWAKE_OFFSET UNITYSDK_OFFSET(0xC96E860)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_3D9D7F249A4577C0_OFFSET UNITYSDK_OFFSET(0xC96F1E0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_D0D3ED1387E89D3E_OFFSET UNITYSDK_OFFSET(0xC96F070)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_D1CE2F76A761AE12_OFFSET UNITYSDK_OFFSET(0xC96EC80)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_F54DE4640CE99063_OFFSET UNITYSDK_OFFSET(0xC96EC00)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_FB257962C61468C7_OFFSET UNITYSDK_OFFSET(0xC96EE00)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC96EF90)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0xC96E9E0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC96F250)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int MonoCakeRaceAudioPostEvent_TypeDefinitionIndex = 74027;
