...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTBUBBLEMONOVIEW_GETANCHORTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC96CCE0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTBUBBLEMONOVIEW_METHOD_6_EF185F49BB791B59_OFFSET UNITYSDK_OFFSET(0xC96DE10)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTBUBBLEMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC96DE60)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceSupportBubbleMonoView_TypeDefinitionIndex = 74188;
