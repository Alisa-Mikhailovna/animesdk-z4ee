...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEFOODBUBBLEMONOVIEW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC96C200)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEFOODBUBBLEMONOVIEW_METHOD_7_EF185F49BB791B59_OFFSET UNITYSDK_OFFSET(0xC96C210)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEFOODBUBBLEMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC96C260)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceFoodBubbleMonoView_TypeDefinitionIndex = 74183;
