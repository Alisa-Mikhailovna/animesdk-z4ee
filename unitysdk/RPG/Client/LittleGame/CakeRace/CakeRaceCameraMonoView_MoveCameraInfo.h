...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECAMERAMONOVIEW_MOVECAMERAINFO_FINISH_OFFSET UNITYSDK_OFFSET(0xC96ACD0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECAMERAMONOVIEW_MOVECAMERAINFO_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xC96AEC0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECAMERAMONOVIEW_MOVECAMERAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC96AED0)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceCameraMonoView_MoveCameraInfo_TypeDefinitionIndex = 74191;
