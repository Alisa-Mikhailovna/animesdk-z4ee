...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_GET_ANIMATION_OFFSET UNITYSDK_OFFSET(0xC96B8F0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_GET_CELLVIEW_OFFSET UNITYSDK_OFFSET(0xC96B950)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_LOADCELLVIEW_OFFSET UNITYSDK_OFFSET(0xC96BD90)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_PLAYAPPEARANIMATION_OFFSET UNITYSDK_OFFSET(0xC96B970)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_PLAYDISAPPEARANIMATION_OFFSET UNITYSDK_OFFSET(0xC96BAA0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_RELEASECELLVIEW_OFFSET UNITYSDK_OFFSET(0xC96C050)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xC96BFF0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_SET_CELLVIEW_OFFSET UNITYSDK_OFFSET(0xC96B960)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC96C1A0)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceCellWrapperMonoView_TypeDefinitionIndex = 74197;
