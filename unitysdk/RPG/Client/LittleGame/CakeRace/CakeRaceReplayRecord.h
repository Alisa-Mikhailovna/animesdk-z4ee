...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_GET_MESSAGEDATABASE64_OFFSET UNITYSDK_OFFSET(0xC96DB00)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_GET_MESSAGEDATA_OFFSET UNITYSDK_OFFSET(0xC96DB20)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_METHOD_1_87E1F65BD177CEC9_OFFSET UNITYSDK_OFFSET(0xC96DC70)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_SET_MESSAGEDATABASE64_OFFSET UNITYSDK_OFFSET(0xC96DB10)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_SET_MESSAGEDATA_OFFSET UNITYSDK_OFFSET(0xC96DB80)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC96DC60)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0xC96DBF0)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceReplayRecord_TypeDefinitionIndex = 74137;
