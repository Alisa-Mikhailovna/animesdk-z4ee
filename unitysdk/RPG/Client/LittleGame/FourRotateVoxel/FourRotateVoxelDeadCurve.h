...
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC9C5CC0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_479759059E440327_OFFSET UNITYSDK_OFFSET(0xC9C5D20)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_METHOD_6_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xC9C5C30)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE_STARTCURVE_OFFSET UNITYSDK_OFFSET(0xC9C5B20)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELDEADCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C5EA0)

namespace RPG::Client::LittleGame::FourRotateVoxel
{
	inline static constexpr unsigned int FourRotateVoxelDeadCurve_TypeDefinitionIndex = 72887;
