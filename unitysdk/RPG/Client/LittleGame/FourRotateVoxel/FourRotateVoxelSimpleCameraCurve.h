...
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELSIMPLECAMERACURVE_GET_CURRCAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xC9D1CC0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELSIMPLECAMERACURVE_METHOD_6_46DF29ACE60986D7_OFFSET UNITYSDK_OFFSET(0xC9D1DD0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELSIMPLECAMERACURVE_RESETBYINITIALCAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xC9D1B20)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELSIMPLECAMERACURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D2020)

namespace RPG::Client::LittleGame::FourRotateVoxel
{
	inline static constexpr unsigned int FourRotateVoxelSimpleCameraCurve_TypeDefinitionIndex = 72899;
