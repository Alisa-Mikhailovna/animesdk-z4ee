...
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEZOOMANDROTATECURVE_GET_CURRCAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xC9D0280)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEZOOMANDROTATECURVE_METHOD_6_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xC9CFE40)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEZOOMANDROTATECURVE_METHOD_6_103DE61A2E976998_OFFSET UNITYSDK_OFFSET(0xC9D0360)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEZOOMANDROTATECURVE_METHOD_6_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0xC9D0640)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEZOOMANDROTATECURVE_METHOD_6_5892D030B127E82F_OFFSET UNITYSDK_OFFSET(0xC9D0400)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEZOOMANDROTATECURVE_STARTCURVE_OFFSET UNITYSDK_OFFSET(0xC9CFA30)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEZOOMANDROTATECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D12D0)

namespace RPG::Client::LittleGame::FourRotateVoxel
{
	inline static constexpr unsigned int FourRotateVoxelGameZoomAndRotateCurve_TypeDefinitionIndex = 72897;
