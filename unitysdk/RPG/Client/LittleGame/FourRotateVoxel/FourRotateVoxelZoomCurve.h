...
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELZOOMCURVE_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC9D3960)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELZOOMCURVE_METHOD_6_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0xC9D38A0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELZOOMCURVE_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xC9D3790)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELZOOMCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D3A10)

namespace RPG::Client::LittleGame::FourRotateVoxel
{
	inline static constexpr unsigned int FourRotateVoxelZoomCurve_TypeDefinitionIndex = 72900;
