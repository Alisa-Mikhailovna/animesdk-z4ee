...
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELSTRUCTGAMEVIEW_COLLECTCHILDREN_OFFSET UNITYSDK_OFFSET(0xC9D2240)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELSTRUCTGAMEVIEW_ROTATEY_OFFSET UNITYSDK_OFFSET(0xC9D2640)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELSTRUCTGAMEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D18B0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELSTRUCTGAMEVIEW__REFRESHDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0xC9D2050)

namespace RPG::Client::LittleGame::FourRotateVoxel
{
	inline static constexpr unsigned int FourRotateVoxelStructGameView_TypeDefinitionIndex = 72910;
