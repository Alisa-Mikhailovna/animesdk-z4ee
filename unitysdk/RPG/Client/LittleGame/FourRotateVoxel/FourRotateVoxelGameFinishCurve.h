...
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEFINISHCURVE_GET_CURRCAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xC9C6E30)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEFINISHCURVE_METHOD_6_078D85152011B919_OFFSET UNITYSDK_OFFSET(0xC9C6180)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEFINISHCURVE_METHOD_6_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xC9C64E0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEFINISHCURVE_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC9C6480)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEFINISHCURVE_METHOD_6_626C719A884DEF9A_OFFSET UNITYSDK_OFFSET(0xC9C6D90)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEFINISHCURVE_METHOD_6_6F7271C62F1FE776_OFFSET UNITYSDK_OFFSET(0xC9C6620)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEFINISHCURVE_STARTCURVE_OFFSET UNITYSDK_OFFSET(0xC9C5EC0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEFINISHCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C6F10)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELGAMEFINISHCURVE___UPDATECAMERATRANSFORM_B__13_0_OFFSET UNITYSDK_OFFSET(0xC9C6F70)

namespace RPG::Client::LittleGame::FourRotateVoxel
{
	inline static constexpr unsigned int FourRotateVoxelGameFinishCurve_TypeDefinitionIndex = 72888;
