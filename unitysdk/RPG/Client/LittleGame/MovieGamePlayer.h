...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0xC9DDDD0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0xC9DD400)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC9DD510)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_METHOD_6_E0E1BDE3C92F9C86_OFFSET UNITYSDK_OFFSET(0xC9DD640)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_ONPLAYERHITSTATEREMOVED_OFFSET UNITYSDK_OFFSET(0xC9DDC20)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_ONPLAYERHITSTATE_OFFSET UNITYSDK_OFFSET(0xC9DDBC0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_REGISTERLISTENERS_OFFSET UNITYSDK_OFFSET(0xC9DD970)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_RELEASEVIEW_OFFSET UNITYSDK_OFFSET(0xC9DD790)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xC9DD920)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETANIMBOOLPARAM_OFFSET UNITYSDK_OFFSET(0xC9DDC70)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETANIMFLOATPARAM_OFFSET UNITYSDK_OFFSET(0xC9DDCE0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0xC9DDD60)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0xC9DDA70)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETMATFLOATPARAM_OFFSET UNITYSDK_OFFSET(0xC9DDB50)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETMATINTPARAM_OFFSET UNITYSDK_OFFSET(0xC9DDAF0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xC9DD9E0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC9DDE90)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DDE80)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGamePlayer_TypeDefinitionIndex = 72700;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MovieGamePlayer_TypeDefinitionIndex)->GetStaticField(0xA6E0);
		}
