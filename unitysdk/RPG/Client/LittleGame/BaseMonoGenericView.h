...
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xC9690F0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC968610)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW_GETUNITYOBJECT_OFFSET UNITYSDK_OFFSET(0xC968660)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW_INITATTACHPOINTS_OFFSET UNITYSDK_OFFSET(0xC9688D0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW_ISDYNAMICATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xC969520)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW_REMOVEATTACHPOINTS_OFFSET UNITYSDK_OFFSET(0xC968EC0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xC9687C0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW_SETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC9686B0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0xC969960)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW__CREATEDYNAMICATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xC969750)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW__CREATESTATICATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xC9695E0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOGENERICVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC968600)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int BaseMonoGenericView_TypeDefinitionIndex = 72596;
	...
	public:
		...
		{
			return (::RPG::GameCore::LittleGameAttachPointInfo**)Il2CppClass::FromTypeDefinitionIndex(BaseMonoGenericView_TypeDefinitionIndex)->GetStaticField(0x38DD0);
		}
