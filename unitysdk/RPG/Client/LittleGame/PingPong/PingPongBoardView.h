...
#define RPG_CLIENT_LITTLEGAME_PINGPONG_PINGPONGBOARDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DEE60)

namespace RPG::Client::LittleGame::PingPong
{
	inline static constexpr unsigned int PingPongBoardView_TypeDefinitionIndex = 72759;
