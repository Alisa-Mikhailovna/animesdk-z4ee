...
#define RPG_CLIENT_LITTLEGAME_PINGPONG_PINGPONGRACKETVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DEF90)

namespace RPG::Client::LittleGame::PingPong
{
	inline static constexpr unsigned int PingPongRacketView_TypeDefinitionIndex = 72769;
