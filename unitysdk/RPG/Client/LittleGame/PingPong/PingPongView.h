...
#define RPG_CLIENT_LITTLEGAME_PINGPONG_PINGPONGVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0xC9DF150)
#define RPG_CLIENT_LITTLEGAME_PINGPONG_PINGPONGVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC9DEFB0)
#define RPG_CLIENT_LITTLEGAME_PINGPONG_PINGPONGVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xC9DF0B0)
#define RPG_CLIENT_LITTLEGAME_PINGPONG_PINGPONGVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DEE90)

namespace RPG::Client::LittleGame::PingPong
{
	inline static constexpr unsigned int PingPongView_TypeDefinitionIndex = 72770;
