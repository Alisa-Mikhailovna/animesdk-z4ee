...
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_EVALUATE_OFFSET UNITYSDK_OFFSET(0xC9D8D20)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_GETDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0xC9D8E10)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_GETENTITY_OFFSET UNITYSDK_OFFSET(0xC9D8A20)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0xC9D8DB0)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC9D8A60)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_23562D36E99317B6_OFFSET UNITYSDK_OFFSET(0xC9D9430)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC9D8C90)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_C3CB9A8A42E31548_OFFSET UNITYSDK_OFFSET(0xC9D9010)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC9D9480)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xC9D8AD0)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_RECALCULATE_OFFSET UNITYSDK_OFFSET(0xC9D8F10)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_RELEASE_OFFSET UNITYSDK_OFFSET(0xC9D8BC0)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D94C0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MonoCurve_TypeDefinitionIndex = 72598;
