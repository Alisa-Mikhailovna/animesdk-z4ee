...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0xC9DC120)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0xC9DBEA0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_ONHIT_OFFSET UNITYSDK_OFFSET(0xC9DC2D0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_REGISTERLISTENERS_OFFSET UNITYSDK_OFFSET(0xC9DC0C0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_RELEASEVIEW_OFFSET UNITYSDK_OFFSET(0xC9DC000)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xC9DBFB0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_SETANIMBOOLPARAM_OFFSET UNITYSDK_OFFSET(0xC9DC440)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_SETANIMFLOATPARAM_OFFSET UNITYSDK_OFFSET(0xC9DC4B0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_SETANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0xC9DC530)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0xC9DC250)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xC9DC1C0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEENEMY__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DC5A0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGameEnemy_TypeDefinitionIndex = 72694;
