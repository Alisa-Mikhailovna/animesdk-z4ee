...
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEBIRDAUDIO_METHOD_5_B6BF2A1BCE9B9659_OFFSET UNITYSDK_OFFSET(0xC9D3C50)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEBIRDAUDIO_TRIGGERAPPEAREVENT_OFFSET UNITYSDK_OFFSET(0xC9D3C00)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEBIRDAUDIO_TRIGGERIDLESHOWEVENT_OFFSET UNITYSDK_OFFSET(0xC9D3D60)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEBIRDAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D3DB0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MatchThreeBirdAudio_TypeDefinitionIndex = 72639;
