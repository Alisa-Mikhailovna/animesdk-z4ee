...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESCELLVIEW_SETLOCKHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xC97E070)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESCELLVIEW_SETPLACEHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xC97E1D0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESCELLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC97E2D0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesCellView_TypeDefinitionIndex = 73832;
