...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xC980270)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_CREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC9800C0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0xC980840)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCCSPLITTERPOLYLINE_OFFSET UNITYSDK_OFFSET(0xC980860)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCURVE_OFFSET UNITYSDK_OFFSET(0xC9807E0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0xC980800)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_OUTLINERENDERER_OFFSET UNITYSDK_OFFSET(0xC980820)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_RECYCLE_OFFSET UNITYSDK_OFFSET(0xC980750)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0xC980850)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCCSPLITTERPOLYLINE_OFFSET UNITYSDK_OFFSET(0xC980870)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCURVE_OFFSET UNITYSDK_OFFSET(0xC9807F0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0xC980810)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_OUTLINERENDERER_OFFSET UNITYSDK_OFFSET(0xC980830)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC980880)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesRouteRendererView_TypeDefinitionIndex = 73835;
