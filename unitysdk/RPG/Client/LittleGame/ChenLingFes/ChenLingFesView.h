...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETDIALOGATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xC980B80)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETEFFECTROOT_OFFSET UNITYSDK_OFFSET(0xC980B20)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0xC980A80)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETROOT_OFFSET UNITYSDK_OFFSET(0xC980AC0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC980930)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xC9809E0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC97E050)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesView_TypeDefinitionIndex = 73837;
