...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_INIT_OFFSET UNITYSDK_OFFSET(0xC97DB90)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETBUILDVCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xC97DDA0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETGAMEVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0xC97DFC0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETGAMEVCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xC97DEB0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETVCAMERAENABLED_OFFSET UNITYSDK_OFFSET(0xC97DD00)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC97E030)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBoardView_TypeDefinitionIndex = 73831;
