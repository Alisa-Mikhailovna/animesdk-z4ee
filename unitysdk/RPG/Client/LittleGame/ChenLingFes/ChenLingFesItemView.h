...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_CLEARBREATHHOVERCOLOR_OFFSET UNITYSDK_OFFSET(0xC97F6A0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_CLEAREFFECT_OFFSET UNITYSDK_OFFSET(0xC97F940)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0xC97FA50)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_GET_OUTLINEPOSTFXMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xC97FA00)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_GET_PROPSELECTIONEFFECT_OFFSET UNITYSDK_OFFSET(0xC97F9B0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_METHOD_7_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xC97F390)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC97F890)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xC97F310)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_START_OFFSET UNITYSDK_OFFSET(0xC97F840)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_USEBREATHHOVERCOLOR_OFFSET UNITYSDK_OFFSET(0xC97F5F0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0xC97FAC0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC97FAA0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemView_TypeDefinitionIndex = 73833;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesItemView_TypeDefinitionIndex)->GetStaticField(0x9420);
		}
		static ::System::Int32* StaticGet_Field_7_1()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesItemView_TypeDefinitionIndex)->GetStaticField(0x9430);
		}
