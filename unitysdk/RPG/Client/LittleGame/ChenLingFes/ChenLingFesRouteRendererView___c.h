...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW___C__BINDCOMPONENTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xC9808E0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC980890)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC9808D0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesRouteRendererView___c_TypeDefinitionIndex = 73836;
	...
	public:
		...
		{
			return (::System::Func_2<::BansheeGz::BGSpline::Components::BGCcSplitterPolyline*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesRouteRendererView___c_TypeDefinitionIndex)->GetStaticField(0x39830);
		}
		static ::RPG::Client::LittleGame::ChenLingFes::ChenLingFesRouteRendererView___c** StaticGet___9()
		{
			return (::RPG::Client::LittleGame::ChenLingFes::ChenLingFesRouteRendererView___c**)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesRouteRendererView___c_TypeDefinitionIndex)->GetStaticField(0x39838);
		}
