...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEMODECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A869270)
...
namespace RPG::Client::LittleGame
{
	...
	public:
		...
		::RPG::Client::LittleGame::MovieLevelState LevelState; // 0x18
		::RPG::Client::LittleGame::MovieGameMode GameMode; // 0x1C
