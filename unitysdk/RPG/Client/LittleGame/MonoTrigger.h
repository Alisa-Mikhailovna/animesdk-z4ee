...
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GETCOLLIDER_OFFSET UNITYSDK_OFFSET(0xC9D95D0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GETENTITY_OFFSET UNITYSDK_OFFSET(0xC9D94E0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GET_ISACTIVEANDENABLED_OFFSET UNITYSDK_OFFSET(0xC9D9670)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC9D9520)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_INITTRIGGERRUNTIMEINFO_OFFSET UNITYSDK_OFFSET(0xC9D9580)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_34BE98EC430CA311_OFFSET UNITYSDK_OFFSET(0xC9D9AF0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_5757AFE81AE625CC_OFFSET UNITYSDK_OFFSET(0xC9D9DA0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_7F29568EA964E563_OFFSET UNITYSDK_OFFSET(0xC9D9770)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_FB988A230DFA3F4D_OFFSET UNITYSDK_OFFSET(0xC9DA070)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC9DA010)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xC9D9920)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xC9D9F70)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_RELEASE_OFFSET UNITYSDK_OFFSET(0xC9D9680)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DA0E0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MonoTrigger_TypeDefinitionIndex = 72599;
