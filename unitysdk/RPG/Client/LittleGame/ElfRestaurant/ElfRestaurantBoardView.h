...
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_GETCURRENTSUPEREVENTVCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0xC994320)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_SETBUILDVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0xC994380)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_SETRESTAURANTVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0xC994590)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_SETRESTAURANTVCAMERAPHASE2ACTIVE_OFFSET UNITYSDK_OFFSET(0xC9947A0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9949B0)

namespace RPG::Client::LittleGame::ElfRestaurant
{
	inline static constexpr unsigned int ElfRestaurantBoardView_TypeDefinitionIndex = 73326;
