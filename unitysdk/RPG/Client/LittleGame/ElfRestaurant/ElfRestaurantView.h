...
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTVIEW_GETDIALOGATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xC995E50)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTVIEW_GETEFFECTROOT_OFFSET UNITYSDK_OFFSET(0xC995D90)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0xC995CF0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTVIEW_GETROOT_OFFSET UNITYSDK_OFFSET(0xC995D30)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTVIEW_GETTIPATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xC995DF0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC995AB0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xC995C50)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9949D0)

namespace RPG::Client::LittleGame::ElfRestaurant
{
	inline static constexpr unsigned int ElfRestaurantView_TypeDefinitionIndex = 73333;
