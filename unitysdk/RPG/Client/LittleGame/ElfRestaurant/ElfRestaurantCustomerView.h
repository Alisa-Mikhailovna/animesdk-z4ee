...
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTCUSTOMERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC994A10)

namespace RPG::Client::LittleGame::ElfRestaurant
{
	inline static constexpr unsigned int ElfRestaurantCustomerView_TypeDefinitionIndex = 73328;
