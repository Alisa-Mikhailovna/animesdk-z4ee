...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLACEMENT_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0xC9DD280)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLACEMENT_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0xC9DD100)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLACEMENT_RELEASEVIEW_OFFSET UNITYSDK_OFFSET(0xC9DD160)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLACEMENT_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xC9DD3A0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLACEMENT_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0xC9DD320)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLACEMENT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xC9DD1F0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLACEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DD3F0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGamePlacement_TypeDefinitionIndex = 72699;
