...
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC9D4AF0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0xC9D46F0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xC9D43C0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0xC9D4310)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_653EEB7EF259681D_OFFSET UNITYSDK_OFFSET(0xC9D4E90)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0xC9D4840)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC9D4290)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xC9D4B40)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xC9D48D0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_RESET_OFFSET UNITYSDK_OFFSET(0xC9D4510)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETBODYMATERIAL_OFFSET UNITYSDK_OFFSET(0xC9D3E70)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETEMO_OFFSET UNITYSDK_OFFSET(0xC9D3DF0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETFACEMATERIAL_OFFSET UNITYSDK_OFFSET(0xC9D3F20)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETSCALE_OFFSET UNITYSDK_OFFSET(0xC9D3FD0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_STARTBATTLESHOW_OFFSET UNITYSDK_OFFSET(0xC9D4420)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_STARTLOOKAT_OFFSET UNITYSDK_OFFSET(0xC9D44C0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9D4780)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC9D4FF0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D4F70)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MatchThreeFighter_TypeDefinitionIndex = 72641;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MatchThreeFighter_TypeDefinitionIndex)->GetStaticField(0xA620);
		}
