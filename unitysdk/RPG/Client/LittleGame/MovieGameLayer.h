...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DD0F0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGameLayer_TypeDefinitionIndex = 72698;
