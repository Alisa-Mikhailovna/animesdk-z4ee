...
#define RPG_CLIENT_LITTLEGAME_CHIMERAWORKINJUREDCOMMAND_EXECUTE_OFFSET UNITYSDK_OFFSET(0xC98DDA0)
#define RPG_CLIENT_LITTLEGAME_CHIMERAWORKINJUREDCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0xC98DE00)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int ChimeraWorkInjuredCommand_TypeDefinitionIndex = 72720;
