...
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_ISALLY_OFFSET UNITYSDK_OFFSET(0xC97DB50)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xC97DB30)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC97DB70)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_UID_OFFSET UNITYSDK_OFFSET(0xC97DB10)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_ISALLY_OFFSET UNITYSDK_OFFSET(0xC97DB60)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_MAXHP_OFFSET UNITYSDK_OFFSET(0xC97DB40)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC97DB80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_UID_OFFSET UNITYSDK_OFFSET(0xC97DB20)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC97D2A0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int SoldierInitData_TypeDefinitionIndex = 73874;
