...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGEFFECTPROFILERDEBUGVIEW_METHOD_5_39D78A8EB32A5315_OFFSET UNITYSDK_OFFSET(0xC971AC0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGEFFECTPROFILERDEBUGVIEW_METHOD_5_5CCCEEABA4778486_OFFSET UNITYSDK_OFFSET(0xC971F30)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGEFFECTPROFILERDEBUGVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC971A70)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGEFFECTPROFILERDEBUGVIEW_REFRESHNOW_OFFSET UNITYSDK_OFFSET(0xC971C50)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGEFFECTPROFILERDEBUGVIEW_RESETPROFILERSESSION_OFFSET UNITYSDK_OFFSET(0xC973210)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGEFFECTPROFILERDEBUGVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xC971E90)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGEFFECTPROFILERDEBUGVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC973330)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingEffectProfilerDebugView_TypeDefinitionIndex = 73887;
