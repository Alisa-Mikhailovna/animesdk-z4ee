...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_GETSOLDIERINITDATA_OFFSET UNITYSDK_OFFSET(0xC97D3F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYARMYNUMBERCHANGE_OFFSET UNITYSDK_OFFSET(0xC97B9E0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYBATTLEFINISHED_OFFSET UNITYSDK_OFFSET(0xC97D390)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYBLOCKCHANGE_OFFSET UNITYSDK_OFFSET(0xC97C670)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYENTERRAGEMODE_OFFSET UNITYSDK_OFFSET(0xC97D2C0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYGAINCOINCHANGE_OFFSET UNITYSDK_OFFSET(0xC97CC90)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYHPCHANGE_OFFSET UNITYSDK_OFFSET(0xC97BDC0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYHPMEMORYCHANGE_OFFSET UNITYSDK_OFFSET(0xC97C280)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYIMMUNITYCHANGE_OFFSET UNITYSDK_OFFSET(0xC97C340)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYRTDAMAGECHANGE_OFFSET UNITYSDK_OFFSET(0xC97C9B0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYSHOWTALK_OFFSET UNITYSDK_OFFSET(0xC97D930)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYSHOWTOAST_OFFSET UNITYSDK_OFFSET(0xC97D320)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYSOLDIERDEAD_OFFSET UNITYSDK_OFFSET(0xC97CF60)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYSOLDIERSPAWNED_OFFSET UNITYSDK_OFFSET(0xC97D020)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xC97B940)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingUIService_TypeDefinitionIndex = 73868;
