...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_APPLYPERFORMANCEFORCE_OFFSET UNITYSDK_OFFSET(0xC9799D0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_GETANIMATIONCURVEBYNAME_OFFSET UNITYSDK_OFFSET(0xC979B30)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_GET_AIRMOTIONCURVE_OFFSET UNITYSDK_OFFSET(0xC979B10)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_GET_DEATHFLYCURVE_OFFSET UNITYSDK_OFFSET(0xC979B20)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2C95AFAD0256302F_1_OFFSET UNITYSDK_OFFSET(0xC979890)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0xC979560)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2D1F8ED8124956FF_OFFSET UNITYSDK_OFFSET(0xC979FF0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2D52D50D51494A66_OFFSET UNITYSDK_OFFSET(0xC97A5E0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_4A86D80F89BDABD3_OFFSET UNITYSDK_OFFSET(0xC97A720)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xC979840)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_5D85010F084295E6_OFFSET UNITYSDK_OFFSET(0xC97ABB0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_60451B2DE9D371C9_OFFSET UNITYSDK_OFFSET(0xC97B580)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_763B70E1B527E566_OFFSET UNITYSDK_OFFSET(0xC9795D0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_8F59470D29B43916_OFFSET UNITYSDK_OFFSET(0xC97A3B0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC97B690)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0xC97A270)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_F1BFC2CD2ECE3431_OFFSET UNITYSDK_OFFSET(0xC97B450)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_SETCHENLINGAUDIOGROUP_OFFSET UNITYSDK_OFFSET(0xC97B720)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_START_OFFSET UNITYSDK_OFFSET(0xC979900)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_TRIGGERDEATHEFFECT_OFFSET UNITYSDK_OFFSET(0xC979C40)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC97B880)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingSoldierView_TypeDefinitionIndex = 74022;
