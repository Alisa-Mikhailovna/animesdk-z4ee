...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGFIELDVIEW_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0xC9735D0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGFIELDVIEW_GETENDROTATION_OFFSET UNITYSDK_OFFSET(0xC973A20)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGFIELDVIEW_GETQUARD_OFFSET UNITYSDK_OFFSET(0xC973400)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGFIELDVIEW_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0xC9734A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGFIELDVIEW_GETSTARTROTATION_OFFSET UNITYSDK_OFFSET(0xC9739B0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGFIELDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC973E90)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingFieldView_TypeDefinitionIndex = 74016;
