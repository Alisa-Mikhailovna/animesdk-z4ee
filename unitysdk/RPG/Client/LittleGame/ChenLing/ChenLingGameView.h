...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0xC976FC0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC9768F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_LITTLEGAMETICK_OFFSET UNITYSDK_OFFSET(0xC977000)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xC977060)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xC977100)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xC977140)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC9770C0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_REGISTEREFFECTLIFETIME_OFFSET UNITYSDK_OFFSET(0xC977180)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_RELEASEEFFECTBYLIFETIME_OFFSET UNITYSDK_OFFSET(0xC976CC0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xC976AF0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC973EB0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingGameView_TypeDefinitionIndex = 74017;
