...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_CONFIGUREPHYSICS_OFFSET UNITYSDK_OFFSET(0xC9782D0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xC978F10)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xC978520)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_3845AD389B8E1E47_OFFSET UNITYSDK_OFFSET(0xC9792D0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC9791B0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_9D5BEBE295BE65D4_OFFSET UNITYSDK_OFFSET(0xC978AE0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xC979270)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xC978660)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_PLAY_OFFSET UNITYSDK_OFFSET(0xC978350)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_RECOVER_OFFSET UNITYSDK_OFFSET(0xC978C80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART__CTOR_OFFSET UNITYSDK_OFFSET(0xC979520)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingRagdollPart_TypeDefinitionIndex = 74021;
