...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETEQUIPVIEWPATH_OFFSET UNITYSDK_OFFSET(0xC9EEF40)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETEQUIPVIEW_OFFSET UNITYSDK_OFFSET(0xC9EEC30)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETPLANEVIEW_OFFSET UNITYSDK_OFFSET(0xC9EEB10)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETPLAYERICONPATH_OFFSET UNITYSDK_OFFSET(0xC9EED50)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_SETUI3DLAYERS_1_OFFSET UNITYSDK_OFFSET(0xC9E3ED0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_SETUI3DLAYERS_OFFSET UNITYSDK_OFFSET(0xC9EAA80)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirViewUtils_TypeDefinitionIndex = 73344;
