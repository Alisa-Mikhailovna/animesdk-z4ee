...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPLANESTATISTICS_GETEQUIPSTATSSORTEDBYUSECOUNT_OFFSET UNITYSDK_OFFSET(0x1A869860)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPLANESTATISTICS_GETORCREATEEQUIPSTATS_OFFSET UNITYSDK_OFFSET(0x1A8696F0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPLANESTATISTICS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A869AE0)
...
namespace RPG::Client::LittleGame::PixAir
{
	...
	public:
		...
		::RPG::GameCore::FixPoint FinalHp; // 0x28
		::RPG::GameCore::FixPoint InitialHp; // 0x30
		::RPG::GameCore::FixPoint FinalShield; // 0x38
