...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xC9E84E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_DAMAGEVALUE_OFFSET UNITYSDK_OFFSET(0xC9E8510)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xC9E8500)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_NEWHP_OFFSET UNITYSDK_OFFSET(0xC9E84F0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xC9E84D0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC9E8520)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirHPChangedNotifyData_TypeDefinitionIndex = 73357;

	class PixAirHPChangedNotifyData : public ::System::Object
	{
	public:
		::System::Int32 _DamageValue_k__BackingField; // 0x10
		::RPG::Client::LittleGame::PixAir::PixAirDamageType _DamageType_k__BackingField; // 0x14
