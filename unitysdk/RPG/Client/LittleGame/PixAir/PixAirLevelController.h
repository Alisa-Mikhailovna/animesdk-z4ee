...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_BINDENEMYPLANE_OFFSET UNITYSDK_OFFSET(0xC9E80F0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_BINDPLAYERPLANE_OFFSET UNITYSDK_OFFSET(0xC9E7BB0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_GET_ENEMYPLANEFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xC9EA980)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_INITFORLOADING_OFFSET UNITYSDK_OFFSET(0xC9E9460)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC9E9730)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_LOADBATTLEFIELD_OFFSET UNITYSDK_OFFSET(0xC9E99C0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_REBINDTRACK_OFFSET UNITYSDK_OFFSET(0xC9E9A10)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0xC9EA8B0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_SET_ENEMYPLANEFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xC9EA990)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERENDINGANIM_OFFSET UNITYSDK_OFFSET(0xC9EA530)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERLOADINGANIM_OFFSET UNITYSDK_OFFSET(0xC9E96B0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERRESULTANIM_OFFSET UNITYSDK_OFFSET(0xC9EA800)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERSLOWLOSEANIM_OFFSET UNITYSDK_OFFSET(0xC9EA480)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERSLOWWINANIM_OFFSET UNITYSDK_OFFSET(0xC9EA240)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9EA070)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC9EA9A0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirLevelController_TypeDefinitionIndex = 73373;
