...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xC9EEAD0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_ISADD_OFFSET UNITYSDK_OFFSET(0xC9EEAE0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xC9EEAC0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_NEWSHIELD_OFFSET UNITYSDK_OFFSET(0xC9EEAB0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xC9EEAA0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC9EEAF0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirShieldChangedNotifyData_TypeDefinitionIndex = 73358;
	...
	public:
		...
		::System::Int32 _NewShield_k__BackingField; // 0x1C
		::System::Boolean _IsAdd_k__BackingField; // 0x20
