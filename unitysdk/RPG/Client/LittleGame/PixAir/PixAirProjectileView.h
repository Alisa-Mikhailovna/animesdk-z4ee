...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_DESTROYVIEWONLY_OFFSET UNITYSDK_OFFSET(0xC9EDB60)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_GET_EFFECTID_OFFSET UNITYSDK_OFFSET(0xC9EE910)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_GET_EFFECTSCALE_OFFSET UNITYSDK_OFFSET(0xC9EE930)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_GET_LOCALRIGHT_OFFSET UNITYSDK_OFFSET(0xC9EE980)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_GET_NORMALIZEDCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0xC9EE950)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0xC9ED7A0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_2C1F0A815CE2FE02_OFFSET UNITYSDK_OFFSET(0xC9EDA40)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_525D46B30B659578_1_OFFSET UNITYSDK_OFFSET(0xC9ED610)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_525D46B30B659578_OFFSET UNITYSDK_OFFSET(0xC9ED4A0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0xC9EE4E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0xC9EC950)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xC9ECF90)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_AE0B725AB77F7E6F_OFFSET UNITYSDK_OFFSET(0xC9EE060)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_C5B3F4014B58D8C3_OFFSET UNITYSDK_OFFSET(0xC9EE6D0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_E6F489168983F864_OFFSET UNITYSDK_OFFSET(0xC9EDC90)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_METHOD_6_F9212750F754510F_OFFSET UNITYSDK_OFFSET(0xC9ED090)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_SETHITEFFECTPATH_OFFSET UNITYSDK_OFFSET(0xC9EDC40)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_SETTARGET_OFFSET UNITYSDK_OFFSET(0xC9EDBF0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_SET_EFFECTID_OFFSET UNITYSDK_OFFSET(0xC9EE920)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_SET_EFFECTSCALE_OFFSET UNITYSDK_OFFSET(0xC9EE940)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_SET_LOCALRIGHT_OFFSET UNITYSDK_OFFSET(0xC9EE9A0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_SET_NORMALIZEDCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0xC9EE970)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9EC8F0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0xC9EE9D0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPROJECTILEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9EE9B0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirProjectileView_TypeDefinitionIndex = 73376;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::LinkedListNode_1<::System::UInt32>*>**)Il2CppClass::FromTypeDefinitionIndex(PixAirProjectileView_TypeDefinitionIndex)->GetStaticField(0x42BC0);
		}
		static ::System::Collections::Generic::LinkedList_1<::System::UInt32>** StaticGet_Field_6_1()
		{
			return (::System::Collections::Generic::LinkedList_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(PixAirProjectileView_TypeDefinitionIndex)->GetStaticField(0x42BC8);
		}
		static ::RPG::Client::MonoEffectManager** StaticGet_Field_6_2()
		{
			return (::RPG::Client::MonoEffectManager**)Il2CppClass::FromTypeDefinitionIndex(PixAirProjectileView_TypeDefinitionIndex)->GetStaticField(0x42BD0);
		}
