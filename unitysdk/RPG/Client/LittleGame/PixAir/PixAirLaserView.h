...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_DESTROYVIEWONLY_OFFSET UNITYSDK_OFFSET(0xC9E9240)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_FIRE_OFFSET UNITYSDK_OFFSET(0xC9E8540)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_045F1AAB54606068_OFFSET UNITYSDK_OFFSET(0xC9E90E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_06010EBCDC42137E_OFFSET UNITYSDK_OFFSET(0xC9E8C00)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xC9E9020)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC9E8990)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_556718862C234099_1_OFFSET UNITYSDK_OFFSET(0xC9E8B90)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_556718862C234099_2_OFFSET UNITYSDK_OFFSET(0xC9E8D80)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_556718862C234099_OFFSET UNITYSDK_OFFSET(0xC9E8A40)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_7DEB74453EA11388_OFFSET UNITYSDK_OFFSET(0xC9E8700)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_B326214F403C3638_OFFSET UNITYSDK_OFFSET(0xC9E92E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_C43C36081A4D4A3D_OFFSET UNITYSDK_OFFSET(0xC9E8DE0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_D7CE655458A04FD8_OFFSET UNITYSDK_OFFSET(0xC9E8AA0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC9E8900)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9E9080)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9E9430)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirLaserView_TypeDefinitionIndex = 73371;
