...
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_ACTION_OFFSET UNITYSDK_OFFSET(0xCD3C060)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD3BFC0)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD3BF10)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD3BDF0)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_SETTIMEUPEVENT_OFFSET UNITYSDK_OFFSET(0xCD3C010)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_START_OFFSET UNITYSDK_OFFSET(0xCD3BBD0)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD3BC10)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3C0B0)
