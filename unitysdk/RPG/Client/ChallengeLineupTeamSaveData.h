...
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBF939B0)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_AVATARLIST1_OFFSET UNITYSDK_OFFSET(0xBF946F0)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_AVATARLIST2_OFFSET UNITYSDK_OFFSET(0xBF94770)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_BUFF1_OFFSET UNITYSDK_OFFSET(0xBF947F0)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_BUFF2_OFFSET UNITYSDK_OFFSET(0xBF94860)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_BUFFLIST_OFFSET UNITYSDK_OFFSET(0xBF946D0)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_SAVELINEUPDATA_OFFSET UNITYSDK_OFFSET(0xBF93A50)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_SET_BUFFLIST_OFFSET UNITYSDK_OFFSET(0xBF946E0)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_TRYGETSAVEDATA_OFFSET UNITYSDK_OFFSET(0xBF93730)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBF93FC0)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA__GETCHALLENGELINEUPAVATARSAVEDATALIST_OFFSET UNITYSDK_OFFSET(0xBF93D40)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA__INIT_OFFSET UNITYSDK_OFFSET(0xBF93FD0)
