...
#define RPG_CLIENT_MONOEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC55290)
#define RPG_CLIENT_MONOEFFECT_BEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xCC55F90)
#define RPG_CLIENT_MONOEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCC55EE0)
#define RPG_CLIENT_MONOEFFECT_GETATTACH_OFFSET UNITYSDK_OFFSET(0xCC56C60)
#define RPG_CLIENT_MONOEFFECT_GETCASTERENTITY_OFFSET UNITYSDK_OFFSET(0xCC56BA0)
#define RPG_CLIENT_MONOEFFECT_GETLOCALSCALE_OFFSET UNITYSDK_OFFSET(0xCC568D0)
#define RPG_CLIENT_MONOEFFECT_GETPATHINHIERARCHY_OFFSET UNITYSDK_OFFSET(0xCC57160)
#define RPG_CLIENT_MONOEFFECT_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xCC56AE0)
#define RPG_CLIENT_MONOEFFECT_GETTASKTIMESCALE_OFFSET UNITYSDK_OFFSET(0xCC56CB0)
#define RPG_CLIENT_MONOEFFECT_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xCC57020)
#define RPG_CLIENT_MONOEFFECT_GET_EFFECTNAME_OFFSET UNITYSDK_OFFSET(0xCC56EF0)
#define RPG_CLIENT_MONOEFFECT_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xCC57140)
#define RPG_CLIENT_MONOEFFECT_GET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xCC56870)
#define RPG_CLIENT_MONOEFFECT_GET_INSTANCEEFFECTID_OFFSET UNITYSDK_OFFSET(0xCC56ED0)
#define RPG_CLIENT_MONOEFFECT_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xCC56F50)
#define RPG_CLIENT_MONOEFFECT_GET_ISCRPEFFECT_OFFSET UNITYSDK_OFFSET(0xCC56FB0)
#define RPG_CLIENT_MONOEFFECT_GET_ISMANUALTICK_OFFSET UNITYSDK_OFFSET(0xCC56F30)
#define RPG_CLIENT_MONOEFFECT_GET_ISMAZESKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xCC56F70)
#define RPG_CLIENT_MONOEFFECT_GET_ISPRERESETFINISH_OFFSET UNITYSDK_OFFSET(0xCC564F0)
#define RPG_CLIENT_MONOEFFECT_GET_ISRESET_OFFSET UNITYSDK_OFFSET(0xCC570E0)
#define RPG_CLIENT_MONOEFFECT_GET_ISUIEFFECT_OFFSET UNITYSDK_OFFSET(0xCC56F90)
#define RPG_CLIENT_MONOEFFECT_GET_OVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xCC57080)
#define RPG_CLIENT_MONOEFFECT_GET_UNIQUEEFFECTID_OFFSET UNITYSDK_OFFSET(0xCC56EB0)
#define RPG_CLIENT_MONOEFFECT_GET_UNIQUEEFFECTNAME_OFFSET UNITYSDK_OFFSET(0xCC56F10)
#define RPG_CLIENT_MONOEFFECT_INIT_OFFSET UNITYSDK_OFFSET(0xCC552E0)
#define RPG_CLIENT_MONOEFFECT_ISAFTERFADE_OFFSET UNITYSDK_OFFSET(0xCC56D30)
#define RPG_CLIENT_MONOEFFECT_ISAFTERFINISH_OFFSET UNITYSDK_OFFSET(0xCC56D90)
#define RPG_CLIENT_MONOEFFECT_ISCANREVIVE_OFFSET UNITYSDK_OFFSET(0xCC56E50)
#define RPG_CLIENT_MONOEFFECT_ISREMOVED_OFFSET UNITYSDK_OFFSET(0xCC56DF0)
#define RPG_CLIENT_MONOEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCC55740)
#define RPG_CLIENT_MONOEFFECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCC55590)
#define RPG_CLIENT_MONOEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCC553E0)
#define RPG_CLIENT_MONOEFFECT_PRERESET_OFFSET UNITYSDK_OFFSET(0xCC560C0)
#define RPG_CLIENT_MONOEFFECT_SETLOCALSCALE_OFFSET UNITYSDK_OFFSET(0xCC566E0)
#define RPG_CLIENT_MONOEFFECT_SETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xCC56930)
#define RPG_CLIENT_MONOEFFECT_SET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xCC57030)
#define RPG_CLIENT_MONOEFFECT_SET_EFFECTNAME_OFFSET UNITYSDK_OFFSET(0xCC56F00)
#define RPG_CLIENT_MONOEFFECT_SET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xCC57150)
#define RPG_CLIENT_MONOEFFECT_SET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xCC56FD0)
#define RPG_CLIENT_MONOEFFECT_SET_INSTANCEEFFECTID_OFFSET UNITYSDK_OFFSET(0xCC56EE0)
#define RPG_CLIENT_MONOEFFECT_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xCC56F60)
#define RPG_CLIENT_MONOEFFECT_SET_ISCRPEFFECT_OFFSET UNITYSDK_OFFSET(0xCC56FC0)
#define RPG_CLIENT_MONOEFFECT_SET_ISMANUALTICK_OFFSET UNITYSDK_OFFSET(0xCC56F40)
#define RPG_CLIENT_MONOEFFECT_SET_ISMAZESKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xCC56F80)
#define RPG_CLIENT_MONOEFFECT_SET_ISPRERESETFINISH_OFFSET UNITYSDK_OFFSET(0xCC56500)
#define RPG_CLIENT_MONOEFFECT_SET_ISUIEFFECT_OFFSET UNITYSDK_OFFSET(0xCC56FA0)
#define RPG_CLIENT_MONOEFFECT_SET_UNIQUEEFFECTID_OFFSET UNITYSDK_OFFSET(0xCC56EC0)
#define RPG_CLIENT_MONOEFFECT_SET_UNIQUEEFFECTNAME_OFFSET UNITYSDK_OFFSET(0xCC56F20)
#define RPG_CLIENT_MONOEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCC55E30)
#define RPG_CLIENT_MONOEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC572A0)
