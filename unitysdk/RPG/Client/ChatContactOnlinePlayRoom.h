...
#define RPG_CLIENT_CHATCONTACTONLINEPLAYROOM_CREATE_OFFSET UNITYSDK_OFFSET(0xC02C490)
#define RPG_CLIENT_CHATCONTACTONLINEPLAYROOM_GET_HEADICON_OFFSET UNITYSDK_OFFSET(0xC02C720)
#define RPG_CLIENT_CHATCONTACTONLINEPLAYROOM_REQUESTHISTORY_OFFSET UNITYSDK_OFFSET(0xC02C6E0)
#define RPG_CLIENT_CHATCONTACTONLINEPLAYROOM_SENDMESSAGE__OFFSET UNITYSDK_OFFSET(0xC02C540)
#define RPG_CLIENT_CHATCONTACTONLINEPLAYROOM__CTOR_OFFSET UNITYSDK_OFFSET(0xC02C3F0)
