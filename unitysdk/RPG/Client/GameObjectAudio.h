...
#define RPG_CLIENT_GAMEOBJECTAUDIO_DODISABLE_OFFSET UNITYSDK_OFFSET(0xC67C1E0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_DOENABLE_OFFSET UNITYSDK_OFFSET(0xC67C0B0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_211942F2A3D74CCB_OFFSET UNITYSDK_OFFSET(0xC67C7D0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_2DCDFF29E7FDDAA8_OFFSET UNITYSDK_OFFSET(0xC67C230)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_64501B5CB67A94C3_OFFSET UNITYSDK_OFFSET(0xC67C100)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0xC67C8E0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_98060E4D16CBDFE4_OFFSET UNITYSDK_OFFSET(0xC67C9D0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xC67C980)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_BD658202BB4C4431_OFFSET UNITYSDK_OFFSET(0xC67CA20)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC67C4E0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC67C440)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xC67C730)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0xC67C780)
#define RPG_CLIENT_GAMEOBJECTAUDIO_UPDATE_OFFSET UNITYSDK_OFFSET(0xC67C570)
#define RPG_CLIENT_GAMEOBJECTAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xC67CA70)
