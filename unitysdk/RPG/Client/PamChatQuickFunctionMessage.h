...
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GETSENDTEXT_OFFSET UNITYSDK_OFFSET(0xCF25B40)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xCF26180)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GET_ISAVATARSELECTED_OFFSET UNITYSDK_OFFSET(0xCF25BD0)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCF26170)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCF25B30)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE__GETFUNCTIONNAME_OFFSET UNITYSDK_OFFSET(0xCF26060)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE__GETSELECTEDAVATARNAME_OFFSET UNITYSDK_OFFSET(0xCF25C20)
