...
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xCA279B0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCA27AE0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCA27B40)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xCA27AF0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCA279A0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0xCA24F00)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerator__CollectAllRefAssetPath_d__0_TypeDefinitionIndex = 69655;
