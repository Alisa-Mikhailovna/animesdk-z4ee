...
#define RPG_CLIENT_TITANATLASVOICEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xD6DB050)
#define RPG_CLIENT_TITANATLASVOICEINFO_GET_AUDIOEVENT_OFFSET UNITYSDK_OFFSET(0xD6DB1E0)
#define RPG_CLIENT_TITANATLASVOICEINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0xD6DB0C0)
#define RPG_CLIENT_TITANATLASVOICEINFO_GET_ROW_OFFSET UNITYSDK_OFFSET(0xD6DB0E0)
#define RPG_CLIENT_TITANATLASVOICEINFO_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xD6DB140)
#define RPG_CLIENT_TITANATLASVOICEINFO_SET_ID_OFFSET UNITYSDK_OFFSET(0xD6DB0D0)
#define RPG_CLIENT_TITANATLASVOICEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD6DB0B0)
