...
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC2FF0)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC30F0)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC3370)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_GETTARGETGO_OFFSET UNITYSDK_OFFSET(0xCCC33C0)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xCCC2FB0)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_ONPREREATTACH_OFFSET UNITYSDK_OFFSET(0xCCC3410)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_ONREATTACHED_OFFSET UNITYSDK_OFFSET(0xCCC3460)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC3180)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC34B0)
