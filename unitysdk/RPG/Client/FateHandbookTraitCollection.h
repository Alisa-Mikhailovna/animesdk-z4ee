...
#define RPG_CLIENT_FATEHANDBOOKTRAITCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC469800)
#define RPG_CLIENT_FATEHANDBOOKTRAITCOLLECTION_GET_TRAITITEMLIST_OFFSET UNITYSDK_OFFSET(0xC46C960)
#define RPG_CLIENT_FATEHANDBOOKTRAITCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC469AD0)
#define RPG_CLIENT_FATEHANDBOOKTRAITCOLLECTION__GENERATETRAITHANDBOOKLIST_OFFSET UNITYSDK_OFFSET(0xC46C5F0)
