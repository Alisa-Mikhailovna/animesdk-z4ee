...
#define RPG_CLIENT_BOXRAYCASTFILTER_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xBEC5E60)
#define RPG_CLIENT_BOXRAYCASTFILTER_DUMPTOLIST_OFFSET UNITYSDK_OFFSET(0xBEC5AE0)
#define RPG_CLIENT_BOXRAYCASTFILTER_FORCEREBUILDHULL_OFFSET UNITYSDK_OFFSET(0xBEC6320)
#define RPG_CLIENT_BOXRAYCASTFILTER_GETVECTOR3_OFFSET UNITYSDK_OFFSET(0xBEC6250)
#define RPG_CLIENT_BOXRAYCASTFILTER_GET_HULLVALID_OFFSET UNITYSDK_OFFSET(0xBEC57B0)
#define RPG_CLIENT_BOXRAYCASTFILTER_ISHIT_OFFSET UNITYSDK_OFFSET(0xBEC5DA0)
#define RPG_CLIENT_BOXRAYCASTFILTER_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0xBEC5BF0)
#define RPG_CLIENT_BOXRAYCASTFILTER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xBEC5FC0)
#define RPG_CLIENT_BOXRAYCASTFILTER_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xBEC5E10)
#define RPG_CLIENT_BOXRAYCASTFILTER_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0xBEC6370)
#define RPG_CLIENT_BOXRAYCASTFILTER_PREPARE_OFFSET UNITYSDK_OFFSET(0xBEC5830)
#define RPG_CLIENT_BOXRAYCASTFILTER_PRINT_OFFSET UNITYSDK_OFFSET(0xBEC6010)
#define RPG_CLIENT_BOXRAYCASTFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEC6480)

namespace RPG::Client
{
	inline static constexpr unsigned int BoxRayCastFilter_TypeDefinitionIndex = 69238;
