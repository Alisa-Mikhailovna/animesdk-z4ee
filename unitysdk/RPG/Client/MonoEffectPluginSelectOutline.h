...
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE_METHOD_8_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0xCCC6B50)
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE_SETSTENCIL_OFFSET UNITYSDK_OFFSET(0xCCC6D50)
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC6E60)
