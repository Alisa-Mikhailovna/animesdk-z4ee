...
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBC751C0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GETCOMMENTDATA_OFFSET UNITYSDK_OFFSET(0xBC75250)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_BATTLEAREAID_OFFSET UNITYSDK_OFFSET(0xBC75980)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_ENEMYIMAGE_OFFSET UNITYSDK_OFFSET(0xBC75AC0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_ENEMYNAME_OFFSET UNITYSDK_OFFSET(0xBC75B60)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_FAILPERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xBC75840)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_ISFINALEXAM_OFFSET UNITYSDK_OFFSET(0xBC75C20)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_POWERRANKID_OFFSET UNITYSDK_OFFSET(0xBC75A20)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_PREPERFORMID_OFFSET UNITYSDK_OFFSET(0xBC756B0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xBC758E0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_SUCCESSPERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xBC75750)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xBC75650)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBC75240)
