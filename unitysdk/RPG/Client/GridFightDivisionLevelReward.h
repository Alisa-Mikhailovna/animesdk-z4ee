...
#define RPG_CLIENT_GRIDFIGHTDIVISIONLEVELREWARD_GET_EXTRAQUEST_OFFSET UNITYSDK_OFFSET(0xC6D0550)
#define RPG_CLIENT_GRIDFIGHTDIVISIONLEVELREWARD_GET_LEVELCONFIG_OFFSET UNITYSDK_OFFSET(0xC6D0610)
#define RPG_CLIENT_GRIDFIGHTDIVISIONLEVELREWARD_GET_QUEST_OFFSET UNITYSDK_OFFSET(0xC6D04A0)
#define RPG_CLIENT_GRIDFIGHTDIVISIONLEVELREWARD_SET_LEVELCONFIG_OFFSET UNITYSDK_OFFSET(0xC6D0620)
#define RPG_CLIENT_GRIDFIGHTDIVISIONLEVELREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC6D0420)
