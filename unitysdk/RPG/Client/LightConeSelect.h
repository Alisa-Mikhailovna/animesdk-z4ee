...
#define RPG_CLIENT_LIGHTCONESELECT_ADD_ONHIGHLIGHTEDINDEXCHANGED_OFFSET UNITYSDK_OFFSET(0xC91EF80)
#define RPG_CLIENT_LIGHTCONESELECT_CHANGETONEXTCOROUTINE_OFFSET UNITYSDK_OFFSET(0xC921790)
#define RPG_CLIENT_LIGHTCONESELECT_FINDCAMERA3D_OFFSET UNITYSDK_OFFSET(0xC91F120)
#define RPG_CLIENT_LIGHTCONESELECT_GET_HIGHLIGHTEDINDEX_OFFSET UNITYSDK_OFFSET(0xC9221E0)
#define RPG_CLIENT_LIGHTCONESELECT_GET_INMANUALCONTROL_OFFSET UNITYSDK_OFFSET(0xC922240)
#define RPG_CLIENT_LIGHTCONESELECT_GET_INSNAP_OFFSET UNITYSDK_OFFSET(0xC922220)
#define RPG_CLIENT_LIGHTCONESELECT_GET_INTERVALDEGREE_OFFSET UNITYSDK_OFFSET(0xC921DF0)
#define RPG_CLIENT_LIGHTCONESELECT_GET_NUMBER_OFFSET UNITYSDK_OFFSET(0xC921740)
#define RPG_CLIENT_LIGHTCONESELECT_GET_ROTATEDEGREE_OFFSET UNITYSDK_OFFSET(0xC922200)
#define RPG_CLIENT_LIGHTCONESELECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC91FB70)
#define RPG_CLIENT_LIGHTCONESELECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC91F060)
#define RPG_CLIENT_LIGHTCONESELECT_PLAYGRADUALHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xC91FFA0)
#define RPG_CLIENT_LIGHTCONESELECT_REMOVE_ONHIGHLIGHTEDINDEXCHANGED_OFFSET UNITYSDK_OFFSET(0xC91EFF0)
#define RPG_CLIENT_LIGHTCONESELECT_RESETLIGHTCONES_OFFSET UNITYSDK_OFFSET(0xC91F1D0)
#define RPG_CLIENT_LIGHTCONESELECT_SET_HIGHLIGHTEDINDEX_OFFSET UNITYSDK_OFFSET(0xC9221F0)
#define RPG_CLIENT_LIGHTCONESELECT_SET_INMANUALCONTROL_OFFSET UNITYSDK_OFFSET(0xC922250)
#define RPG_CLIENT_LIGHTCONESELECT_SET_INSNAP_OFFSET UNITYSDK_OFFSET(0xC922230)
#define RPG_CLIENT_LIGHTCONESELECT_SET_ROTATEDEGREE_OFFSET UNITYSDK_OFFSET(0xC922210)
#define RPG_CLIENT_LIGHTCONESELECT_SHOULDSNAPTONEXT_OFFSET UNITYSDK_OFFSET(0xC921960)
#define RPG_CLIENT_LIGHTCONESELECT_SNAPTONEXT_OFFSET UNITYSDK_OFFSET(0xC921AD0)
#define RPG_CLIENT_LIGHTCONESELECT_SNAPTOSELF_OFFSET UNITYSDK_OFFSET(0xC921C60)
#define RPG_CLIENT_LIGHTCONESELECT_SNAP_OFFSET UNITYSDK_OFFSET(0xC9218F0)
#define RPG_CLIENT_LIGHTCONESELECT_UPDATELIGHTBEAMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC920010)
#define RPG_CLIENT_LIGHTCONESELECT_UPDATELIGHTCONESTATE_OFFSET UNITYSDK_OFFSET(0xC9205A0)
#define RPG_CLIENT_LIGHTCONESELECT__CCTOR_OFFSET UNITYSDK_OFFSET(0xC922470)
#define RPG_CLIENT_LIGHTCONESELECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC922340)
#define RPG_CLIENT_LIGHTCONESELECT__DOSNAP_OFFSET UNITYSDK_OFFSET(0xC921EE0)
#define RPG_CLIENT_LIGHTCONESELECT__GETCEILDEGREE_OFFSET UNITYSDK_OFFSET(0xC921D70)
#define RPG_CLIENT_LIGHTCONESELECT__GETFLOORDEGREE_OFFSET UNITYSDK_OFFSET(0xC9220B0)
#define RPG_CLIENT_LIGHTCONESELECT__STOPSNAP_OFFSET UNITYSDK_OFFSET(0xC922130)
#define RPG_CLIENT_LIGHTCONESELECT__UPDATEIDLETIMER_OFFSET UNITYSDK_OFFSET(0xC921840)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(LightConeSelect_TypeDefinitionIndex)->GetStaticField(0x8CD0);
		}
