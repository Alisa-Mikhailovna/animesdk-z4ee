...
#define RPG_CLIENT_FATERINTIMERACTIVITYPANELDATA_CHECKANDMARKMISSINGVIDEO_OFFSET UNITYSDK_OFFSET(0xC5AF8F0)
#define RPG_CLIENT_FATERINTIMERACTIVITYPANELDATA_GETVIDEOIDCURRENTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xC5AF4D0)
#define RPG_CLIENT_FATERINTIMERACTIVITYPANELDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xC5AF9D0)
#define RPG_CLIENT_FATERINTIMERACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC5AF4C0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(FateRinTimerActivityPanelData_TypeDefinitionIndex)->GetStaticField(0x4DF0);
		}
