...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_FORCEFOLLOW_OFFSET UNITYSDK_OFFSET(0xC056C40)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC055C20)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETDRAGREGION_OFFSET UNITYSDK_OFFSET(0xC056CD0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xC056D20)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETHIGHLIGHTED_OFFSET UNITYSDK_OFFSET(0xC056140)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETSOURCE_OFFSET UNITYSDK_OFFSET(0xC0561C0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETTARGET_OFFSET UNITYSDK_OFFSET(0xC055D60)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__CCTOR_OFFSET UNITYSDK_OFFSET(0xC056D90)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__CTOR_OFFSET UNITYSDK_OFFSET(0xC056D70)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__FOLLOW_OFFSET UNITYSDK_OFFSET(0xC055CD0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__REFRESHSTATEVIEWOFCOLOR_OFFSET UNITYSDK_OFFSET(0xC056050)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__REFRESHSTATEVIEW_OFFSET UNITYSDK_OFFSET(0xC056000)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__SETTARGETFORCURVE_OFFSET UNITYSDK_OFFSET(0xC0564C0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingDragTrajectory_TypeDefinitionIndex = 72487;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChenLingDragTrajectory_TypeDefinitionIndex)->GetStaticField(0x10670);
		}
