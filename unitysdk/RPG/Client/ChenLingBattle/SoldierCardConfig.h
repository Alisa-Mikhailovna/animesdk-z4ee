...
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG_GETDESC_OFFSET UNITYSDK_OFFSET(0xC06A390)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG_GETPROMOTIONSKILLDESC_OFFSET UNITYSDK_OFFSET(0xC06A4D0)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG_GET_ISPROMOTION_OFFSET UNITYSDK_OFFSET(0xC06A7A0)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xC06A730)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0xC06A6E0)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC06A670)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG_GET_PROMOTIONCONDITIONLIST_OFFSET UNITYSDK_OFFSET(0xC05B640)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG_GET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0xC06A480)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG_GET_TYPENAME_OFFSET UNITYSDK_OFFSET(0xC06A5C0)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC06A2D0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int SoldierCardConfig_TypeDefinitionIndex = 72306;
