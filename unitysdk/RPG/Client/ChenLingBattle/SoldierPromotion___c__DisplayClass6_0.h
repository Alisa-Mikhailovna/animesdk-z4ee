...
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC06B310)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS6_0__GETHANDCARDAFFECTCONDITION_B__0_OFFSET UNITYSDK_OFFSET(0xC06B9E0)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS6_0__GETHANDCARDAFFECTCONDITION_B__1_OFFSET UNITYSDK_OFFSET(0xC06BAE0)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS6_0__GETHANDCARDAFFECTCONDITION_B__2_OFFSET UNITYSDK_OFFSET(0xC06BBE0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int SoldierPromotion___c__DisplayClass6_0_TypeDefinitionIndex = 72463;
