...
#define RPG_CLIENT_CHENLINGBATTLE_ROUNDSETTLEPHASE_ONENTER_OFFSET UNITYSDK_OFFSET(0xC05F030)
#define RPG_CLIENT_CHENLINGBATTLE_ROUNDSETTLEPHASE_ONLEAVE_OFFSET UNITYSDK_OFFSET(0xC05F3B0)
#define RPG_CLIENT_CHENLINGBATTLE_ROUNDSETTLEPHASE_SWITCHTOPREPAREEDIT_OFFSET UNITYSDK_OFFSET(0xC05F5E0)
#define RPG_CLIENT_CHENLINGBATTLE_ROUNDSETTLEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC05F020)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int RoundSettlePhase_TypeDefinitionIndex = 72400;
