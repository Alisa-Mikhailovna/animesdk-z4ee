...
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDPREVIEWSNAPSHOT_CREATESELECTCARDSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xC062A20)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDPREVIEWSNAPSHOT_GET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0xC062AB0)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDPREVIEWSNAPSHOT_SET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0xC062AC0)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTCARDPREVIEWSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0xC062AA0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int SelectCardPreviewSnapshot_TypeDefinitionIndex = 72382;
