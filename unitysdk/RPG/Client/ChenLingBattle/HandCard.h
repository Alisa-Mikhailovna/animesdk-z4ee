...
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_CREATE_OFFSET UNITYSDK_OFFSET(0xC05B200)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GETDESC_OFFSET UNITYSDK_OFFSET(0xC05B890)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GETSOLDIERPROMOTIONCONDITIONLIST_OFFSET UNITYSDK_OFFSET(0xC05B350)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_CARDID_OFFSET UNITYSDK_OFFSET(0xC05B960)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xC05BD60)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_ICONOUTLINEPATH_OFFSET UNITYSDK_OFFSET(0xC05BBE0)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC05BB60)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC05BA80)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_TYPEID_OFFSET UNITYSDK_OFFSET(0xC05BC60)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_TYPENAME_OFFSET UNITYSDK_OFFSET(0xC05B9A0)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC05B5C0)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xC05B980)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xC05BCE0)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_GET__EFFECTGRIDPRESHOW_OFFSET UNITYSDK_OFFSET(0xC05B810)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_ISINEFFECTGRID_OFFSET UNITYSDK_OFFSET(0xC05B690)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_SET_CARDID_OFFSET UNITYSDK_OFFSET(0xC05B970)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xC05BD70)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xC05B990)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD_SYNC_OFFSET UNITYSDK_OFFSET(0xC05B2E0)
#define RPG_CLIENT_CHENLINGBATTLE_HANDCARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC05B2D0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int HandCard_TypeDefinitionIndex = 72451;
