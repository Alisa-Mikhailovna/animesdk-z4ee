...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC054D00)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xC054D70)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_PLAY_1_OFFSET UNITYSDK_OFFSET(0xC040BB0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xC055070)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_SETCAMERA_OFFSET UNITYSDK_OFFSET(0xC054F90)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC054CC0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC0551E0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleParticleEffect_TypeDefinitionIndex = 72492;
