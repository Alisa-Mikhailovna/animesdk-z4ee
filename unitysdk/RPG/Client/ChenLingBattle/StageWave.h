...
#define RPG_CLIENT_CHENLINGBATTLE_STAGEWAVE_GET_FINISHPREPAREHANDCARDMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xC06FF20)
#define RPG_CLIENT_CHENLINGBATTLE_STAGEWAVE_GET_PREPAREHANDCARDMINCOUNT_OFFSET UNITYSDK_OFFSET(0xC070070)
#define RPG_CLIENT_CHENLINGBATTLE_STAGEWAVE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC06FED0)
#define RPG_CLIENT_CHENLINGBATTLE_STAGEWAVE_GET_WAVEID_OFFSET UNITYSDK_OFFSET(0xC06FE80)
#define RPG_CLIENT_CHENLINGBATTLE_STAGEWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC06FE70)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int StageWave_TypeDefinitionIndex = 72432;
