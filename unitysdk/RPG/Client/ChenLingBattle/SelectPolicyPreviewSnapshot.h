...
#define RPG_CLIENT_CHENLINGBATTLE_SELECTPOLICYPREVIEWSNAPSHOT_CREATESELECTPOLICYSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xC064F60)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTPOLICYPREVIEWSNAPSHOT_GET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0xC064FF0)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTPOLICYPREVIEWSNAPSHOT_SET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0xC065000)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTPOLICYPREVIEWSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0xC064FE0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int SelectPolicyPreviewSnapshot_TypeDefinitionIndex = 72383;
