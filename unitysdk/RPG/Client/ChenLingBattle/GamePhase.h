...
#define RPG_CLIENT_CHENLINGBATTLE_GAMEPHASE_GET__GAMECONTEXT_OFFSET UNITYSDK_OFFSET(0xC05AB50)
#define RPG_CLIENT_CHENLINGBATTLE_GAMEPHASE_GET__NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0xC05AD00)
#define RPG_CLIENT_CHENLINGBATTLE_GAMEPHASE_SENDMESSAGE__OFFSET UNITYSDK_OFFSET(0xC05ABA0)
#define RPG_CLIENT_CHENLINGBATTLE_GAMEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC05AB40)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int GamePhase_TypeDefinitionIndex = 72380;
