...
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC06AFF0)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS5_0__ISNEEDCARDCONFIG_B__0_OFFSET UNITYSDK_OFFSET(0xC06B780)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS5_0__ISNEEDCARDCONFIG_B__1_OFFSET UNITYSDK_OFFSET(0xC06B850)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS5_0__ISNEEDCARDCONFIG_B__2_OFFSET UNITYSDK_OFFSET(0xC06B920)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int SoldierPromotion___c__DisplayClass5_0_TypeDefinitionIndex = 72462;
