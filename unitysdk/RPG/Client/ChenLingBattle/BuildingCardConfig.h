...
#define RPG_CLIENT_CHENLINGBATTLE_BUILDINGCARDCONFIG_GETDESC_OFFSET UNITYSDK_OFFSET(0xC03F4D0)
#define RPG_CLIENT_CHENLINGBATTLE_BUILDINGCARDCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC03F670)
#define RPG_CLIENT_CHENLINGBATTLE_BUILDINGCARDCONFIG_GET_TYPENAME_OFFSET UNITYSDK_OFFSET(0xC03F5C0)
#define RPG_CLIENT_CHENLINGBATTLE_BUILDINGCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC03F3F0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int BuildingCardConfig_TypeDefinitionIndex = 72307;
