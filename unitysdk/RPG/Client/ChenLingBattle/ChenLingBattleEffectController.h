...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC040620)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0408E0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER_GET_ROOT_OFFSET UNITYSDK_OFFSET(0xC0405D0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC0406B0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC040820)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER_PLAYLOOPPARTICLEEFFECTBYPATH_OFFSET UNITYSDK_OFFSET(0xC040DA0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER_PLAYPARTICLEEFFECTBYPATH_OFFSET UNITYSDK_OFFSET(0xC040930)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER_REMOVELOOPPARTICLEEFFECTBYPATH_OFFSET UNITYSDK_OFFSET(0xC041140)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC041290)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleEffectController_TypeDefinitionIndex = 72489;
	...
	public:
		...
		{
			return (::RPG::Client::ChenLingBattle::ChenLingBattleEffectController**)Il2CppClass::FromTypeDefinitionIndex(ChenLingBattleEffectController_TypeDefinitionIndex)->GetStaticField(0x221A0);
		}
