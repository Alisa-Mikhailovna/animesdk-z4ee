...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xC0553B0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC055410)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__CLEAR_OFFSET UNITYSDK_OFFSET(0xC0551F0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC055580)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__SETDOINGSTATE_OFFSET UNITYSDK_OFFSET(0xC055260)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__SETDONESTATE_OFFSET UNITYSDK_OFFSET(0xC055310)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleProgressNodeView_TypeDefinitionIndex = 72485;
