...
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPREVIEWSNAPSHOT_CREATEACTIONSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xC03CCB0)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPREVIEWSNAPSHOT_GET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0xC03CD40)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPREVIEWSNAPSHOT_SET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0xC03CD50)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPREVIEWSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0xC03CD30)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ActionPreviewSnapshot_TypeDefinitionIndex = 72384;
