...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONSHOPITEM_CHECKCANAPPLYTOANY_OFFSET UNITYSDK_OFFSET(0xC12B130)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONSHOPITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xC12AFD0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONSHOPITEM_GET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0xC12AFB0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONSHOPITEM_GET_ITEM__OFFSET UNITYSDK_OFFSET(0xC12AFA0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONSHOPITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xC126970)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONSHOPITEM_SET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0xC12AFC0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONSHOPITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC12B0E0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONSHOPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC12B0D0)
