...
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC6D7560)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS23_0__PLAYROLETRANSFEREFFECT_B__0_OFFSET UNITYSDK_OFFSET(0xC6D9C50)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::GridFightRoleChangeEffect* effect; // 0x10
