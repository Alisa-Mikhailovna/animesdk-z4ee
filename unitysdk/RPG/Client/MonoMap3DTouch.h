...
#define RPG_CLIENT_MONOMAP3DTOUCH_ISPAGENOTFOCUSED_OFFSET UNITYSDK_OFFSET(0xCD05300)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_0DC794B6E3A200E7_OFFSET UNITYSDK_OFFSET(0xCD05430)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_2958B160D1DF7640_OFFSET UNITYSDK_OFFSET(0xCD05790)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_3E06E2491B129B22_OFFSET UNITYSDK_OFFSET(0xCD04DE0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_42CE8882317DE3CD_1_OFFSET UNITYSDK_OFFSET(0xCD06570)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_42CE8882317DE3CD_OFFSET UNITYSDK_OFFSET(0xCD05F40)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xCD05010)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xCD082C0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCD075F0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_49A086C8E6F42C45_OFFSET UNITYSDK_OFFSET(0xCD077E0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_67E989182507B304_OFFSET UNITYSDK_OFFSET(0xCD05A00)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7A73F165001BC325_1_OFFSET UNITYSDK_OFFSET(0xCD07F30)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7A73F165001BC325_OFFSET UNITYSDK_OFFSET(0xCD07D20)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7FBD7054FC0495F3_1_OFFSET UNITYSDK_OFFSET(0xCD063D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7FBD7054FC0495F3_2_OFFSET UNITYSDK_OFFSET(0xCD064A0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_7FBD7054FC0495F3_OFFSET UNITYSDK_OFFSET(0xCD06300)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_842C2C83BCD87BDA_OFFSET UNITYSDK_OFFSET(0xCD05CC0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_94A2F63DE8B7DB51_OFFSET UNITYSDK_OFFSET(0xCD053E0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCD08140)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_C08EA6252F773E6C_1_OFFSET UNITYSDK_OFFSET(0xCD06190)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_C08EA6252F773E6C_OFFSET UNITYSDK_OFFSET(0xCD06020)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_C2DD07A758A476AF_OFFSET UNITYSDK_OFFSET(0xCD05EF0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0xCD081D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_F70DC5473DF715AD_OFFSET UNITYSDK_OFFSET(0xCD07A50)
#define RPG_CLIENT_MONOMAP3DTOUCH_METHOD_5_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0xCD051A0)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD07540)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD06DD0)
#define RPG_CLIENT_MONOMAP3DTOUCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD06650)
#define RPG_CLIENT_MONOMAP3DTOUCH_REFRESH_OFFSET UNITYSDK_OFFSET(0xCD04C00)
#define RPG_CLIENT_MONOMAP3DTOUCH_RESETTOUCH_OFFSET UNITYSDK_OFFSET(0xCD076E0)
#define RPG_CLIENT_MONOMAP3DTOUCH_SUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0xCD066D0)
#define RPG_CLIENT_MONOMAP3DTOUCH_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0xCD06E40)
#define RPG_CLIENT_MONOMAP3DTOUCH_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD04D80)
#define RPG_CLIENT_MONOMAP3DTOUCH__CTOR_OFFSET UNITYSDK_OFFSET(0xCD08320)
