...
#define RPG_CLIENT_UIDRAGGABLEMANAGER_ADDAREA_OFFSET UNITYSDK_OFFSET(0xD7B9B20)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_ADDDRAGONLYAREA_OFFSET UNITYSDK_OFFSET(0xD7B9FE0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_ADDHOVERONLYAREA_OFFSET UNITYSDK_OFFSET(0xD7B9E70)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_BINDDRAGENDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BA480)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_BINDDRAGENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BA520)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_BINDDRAGEXCEEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BA4D0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_BINDDRAGEXITCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BA570)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_BINDDRAGSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BA430)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_CLEARDRAGTARGET_OFFSET UNITYSDK_OFFSET(0xD7B9580)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_GETDRAGTARGETSCREENPOSITION_OFFSET UNITYSDK_OFFSET(0xD7BAC00)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_GET_ISDRAGGING_OFFSET UNITYSDK_OFFSET(0xD7BB630)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_LUABINDDRAGENDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BA6F0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_LUABINDDRAGENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BA950)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_LUABINDDRAGEXCEEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BA820)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_LUABINDDRAGEXITCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BAA80)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_LUABINDDRAGSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7BA5C0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_MANUALBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xD7B9760)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_MANUALENDDRAG_OFFSET UNITYSDK_OFFSET(0xD7B8D90)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_MANUALENTER_OFFSET UNITYSDK_OFFSET(0xD7B74E0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_MANUALEXIT_OFFSET UNITYSDK_OFFSET(0xD7B7480)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xD7B8ED0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD7B8C10)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD7B8D40)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_ONDROP_OFFSET UNITYSDK_OFFSET(0xD7B9A60)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xD7B9500)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_OVERRIDEDRAGINPUT_OFFSET UNITYSDK_OFFSET(0xD7B7680)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_RPG_CLIENT_IPOOLABLECOMPONENT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD7BAFC0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_RPG_CLIENT_IPOOLABLECOMPONENT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD7BAF80)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_RPG_CLIENT_IUIDRAGINPUT_GETPOSITION_OFFSET UNITYSDK_OFFSET(0xD7BB010)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_SETCONFINEDCURSORWHENDRAG_OFFSET UNITYSDK_OFFSET(0xD7BABB0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_SETCUSTOMPOSITIONSETTER_OFFSET UNITYSDK_OFFSET(0xD7BAD30)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_SETDRAGTARGET_OFFSET UNITYSDK_OFFSET(0xD7BA140)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_START_OFFSET UNITYSDK_OFFSET(0xD7B8B40)
#define RPG_CLIENT_UIDRAGGABLEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7B9150)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__ADDAREAINFO_OFFSET UNITYSDK_OFFSET(0xD7B9D20)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__CHANGEDRAGSTATE_OFFSET UNITYSDK_OFFSET(0xD7B8E50)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__CLEAR_OFFSET UNITYSDK_OFFSET(0xD7B8C60)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7BB640)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__DISPATCHENDDRAGEVENT_OFFSET UNITYSDK_OFFSET(0xD7BB2D0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__DISPATCHSTARTDRAGEVENT_OFFSET UNITYSDK_OFFSET(0xD7BB080)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__GETAREAINFO_OFFSET UNITYSDK_OFFSET(0xD7B8FD0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__ONENTER_OFFSET UNITYSDK_OFFSET(0xD7B97C0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__ONEXIT_OFFSET UNITYSDK_OFFSET(0xD7B9910)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__RESETAREAINFOLIST_OFFSET UNITYSDK_OFFSET(0xD7BB520)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__SHOULDCONFINEDCURSORWHENDRAG_OFFSET UNITYSDK_OFFSET(0xD7BA3C0)
#define RPG_CLIENT_UIDRAGGABLEMANAGER__TRIGGERALLENTEREVENT_OFFSET UNITYSDK_OFFSET(0xD7BADF0)
