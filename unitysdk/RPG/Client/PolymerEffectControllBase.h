...
#define RPG_CLIENT_POLYMEREFFECTCONTROLLBASE_GET_POLYMERADDCHILDOBJ_OFFSET UNITYSDK_OFFSET(0xD0B6F90)
#define RPG_CLIENT_POLYMEREFFECTCONTROLLBASE_GET_VISUALIZEDATA_OFFSET UNITYSDK_OFFSET(0xD0B7D00)
#define RPG_CLIENT_POLYMEREFFECTCONTROLLBASE_METHOD_5_E9A5554837CAC47B_OFFSET UNITYSDK_OFFSET(0xD0B70A0)
#define RPG_CLIENT_POLYMEREFFECTCONTROLLBASE_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0xD0B7C60)
#define RPG_CLIENT_POLYMEREFFECTCONTROLLBASE_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0xD0B7BB0)
#define RPG_CLIENT_POLYMEREFFECTCONTROLLBASE_SET_POLYMERADDCHILDOBJ_OFFSET UNITYSDK_OFFSET(0xD0B6FA0)
#define RPG_CLIENT_POLYMEREFFECTCONTROLLBASE_SET_VISUALIZEDATA_OFFSET UNITYSDK_OFFSET(0xD0B7D10)
#define RPG_CLIENT_POLYMEREFFECTCONTROLLBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0B6EF0)
