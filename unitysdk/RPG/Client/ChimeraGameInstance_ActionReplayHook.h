...
#define RPG_CLIENT_CHIMERAGAMEINSTANCE_ACTIONREPLAYHOOK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC14AEF0)
#define RPG_CLIENT_CHIMERAGAMEINSTANCE_ACTIONREPLAYHOOK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC14AF30)
#define RPG_CLIENT_CHIMERAGAMEINSTANCE_ACTIONREPLAYHOOK_INVOKE_OFFSET UNITYSDK_OFFSET(0xC149F00)
#define RPG_CLIENT_CHIMERAGAMEINSTANCE_ACTIONREPLAYHOOK__CTOR_OFFSET UNITYSDK_OFFSET(0xC14AE00)
