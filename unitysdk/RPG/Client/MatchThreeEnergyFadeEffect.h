...
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCB43FC0)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_METHOD_5_45145A6EAA55CDC0_OFFSET UNITYSDK_OFFSET(0xCB43B40)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_METHOD_5_5138086028772073_OFFSET UNITYSDK_OFFSET(0xCB43D70)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_METHOD_5_85ED5C675D497AF5_OFFSET UNITYSDK_OFFSET(0xCB43E20)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xCB44050)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCB44000)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xCB3D280)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCB43F80)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCB44130)
