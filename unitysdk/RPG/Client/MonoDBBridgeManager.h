...
#define RPG_CLIENT_MONODBBRIDGEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC48B70)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCC48CB0)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCC48BE0)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_UPDATEREFERENCEPOS_OFFSET UNITYSDK_OFFSET(0xCC489C0)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCC48C40)
#define RPG_CLIENT_MONODBBRIDGEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC48D70)
