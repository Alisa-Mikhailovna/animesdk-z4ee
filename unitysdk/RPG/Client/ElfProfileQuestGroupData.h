...
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC386450)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_GETQUESTDATALIST_OFFSET UNITYSDK_OFFSET(0xC386BA0)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_GET_CHARACTERIMGPATH_OFFSET UNITYSDK_OFFSET(0xC386FB0)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xC387050)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xC386EF0)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC386E10)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC386E30)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xC384D20)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_GET__QUESTIDLIST_OFFSET UNITYSDK_OFFSET(0xC3869A0)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC3867B0)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0xC386510)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_ITERATEQUESTID_OFFSET UNITYSDK_OFFSET(0xC386DC0)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xC386E20)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC386570)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA__ISGROUPCLOSED_OFFSET UNITYSDK_OFFSET(0xC386A40)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA__ISGROUPHASREWARD_OFFSET UNITYSDK_OFFSET(0xC386810)
#define RPG_CLIENT_ELFPROFILEQUESTGROUPDATA__ISGROUPLOCKED_OFFSET UNITYSDK_OFFSET(0xC386580)
