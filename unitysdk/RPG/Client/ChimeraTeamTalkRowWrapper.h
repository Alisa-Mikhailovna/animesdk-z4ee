...
#define RPG_CLIENT_CHIMERATEAMTALKROWWRAPPER_CREATE_OFFSET UNITYSDK_OFFSET(0xC162770)
#define RPG_CLIENT_CHIMERATEAMTALKROWWRAPPER_GET_EFFECTTYPE_OFFSET UNITYSDK_OFFSET(0xC163380)
#define RPG_CLIENT_CHIMERATEAMTALKROWWRAPPER_GET_TALKCONTENT_OFFSET UNITYSDK_OFFSET(0xC163260)
#define RPG_CLIENT_CHIMERATEAMTALKROWWRAPPER_GET_TALKID_OFFSET UNITYSDK_OFFSET(0xC163240)
#define RPG_CLIENT_CHIMERATEAMTALKROWWRAPPER_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC163320)
#define RPG_CLIENT_CHIMERATEAMTALKROWWRAPPER_SET_TALKID_OFFSET UNITYSDK_OFFSET(0xC163250)
#define RPG_CLIENT_CHIMERATEAMTALKROWWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0xC163230)
