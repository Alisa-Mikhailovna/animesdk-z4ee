...
#define RPG_CLIENT_MONOMASKSLIDER_GETBLINGANIMATIONNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0xCD08F40)
#define RPG_CLIENT_MONOMASKSLIDER_GETRATIO_OFFSET UNITYSDK_OFFSET(0xCD08BD0)
#define RPG_CLIENT_MONOMASKSLIDER_GET_LOOPANIMNAMESTR_OFFSET UNITYSDK_OFFSET(0xCD08660)
#define RPG_CLIENT_MONOMASKSLIDER_METHOD_5_7C2C2820B36B9508_OFFSET UNITYSDK_OFFSET(0xCD09300)
#define RPG_CLIENT_MONOMASKSLIDER_METHOD_5_C457B99D85451047_OFFSET UNITYSDK_OFFSET(0xCD09100)
#define RPG_CLIENT_MONOMASKSLIDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD09490)
#define RPG_CLIENT_MONOMASKSLIDER_SETREFSLIDER_OFFSET UNITYSDK_OFFSET(0xCD08C40)
#define RPG_CLIENT_MONOMASKSLIDER_STARTFLASHLOOP_OFFSET UNITYSDK_OFFSET(0xCD08E30)
#define RPG_CLIENT_MONOMASKSLIDER_STARTFLASHSPREAD_OFFSET UNITYSDK_OFFSET(0xCD08CA0)
#define RPG_CLIENT_MONOMASKSLIDER_STOPFLASHLOOPANIM_OFFSET UNITYSDK_OFFSET(0xCD091C0)
#define RPG_CLIENT_MONOMASKSLIDER_STOPFLASHSPREADANIM_OFFSET UNITYSDK_OFFSET(0xCD08FF0)
#define RPG_CLIENT_MONOMASKSLIDER_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0xCD08830)
#define RPG_CLIENT_MONOMASKSLIDER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD092B0)
#define RPG_CLIENT_MONOMASKSLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD094E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaskSlider_TypeDefinitionIndex = 69303;
