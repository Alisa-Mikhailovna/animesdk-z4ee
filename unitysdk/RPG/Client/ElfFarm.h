...
#define RPG_CLIENT_ELFFARM_GETCELL_OFFSET UNITYSDK_OFFSET(0xC36A4C0)
#define RPG_CLIENT_ELFFARM_GETVCAMERAGO_OFFSET UNITYSDK_OFFSET(0xC36A790)
#define RPG_CLIENT_ELFFARM_INIT_OFFSET UNITYSDK_OFFSET(0xC369EA0)
#define RPG_CLIENT_ELFFARM_SETVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0xC36A8E0)
#define RPG_CLIENT_ELFFARM_UNINIT_OFFSET UNITYSDK_OFFSET(0xC36A3B0)
#define RPG_CLIENT_ELFFARM_UPDATEFARM_OFFSET UNITYSDK_OFFSET(0xC36A130)
#define RPG_CLIENT_ELFFARM__CTOR_OFFSET UNITYSDK_OFFSET(0xC36AA90)
