...
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBD94EB0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GETPANELDATABYID_OFFSET UNITYSDK_OFFSET(0xBD957A0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_ACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0xBD956F0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xBD95BA0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xBD95B00)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xBD95AE0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_ISEXPIRED_OFFSET UNITYSDK_OFFSET(0xBD95CD0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0xBD95C40)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_PANELDATADICT_OFFSET UNITYSDK_OFFSET(0xBD95D30)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_TABIDLIST_OFFSET UNITYSDK_OFFSET(0xBD95180)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xBD95B40)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_SET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xBD95AF0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_SET_PANELDATADICT_OFFSET UNITYSDK_OFFSET(0xBD95D40)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_SYNCSCHEDULE_OFFSET UNITYSDK_OFFSET(0xBD95280)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBD94F40)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA__INITPLANEDATA_OFFSET UNITYSDK_OFFSET(0xBD94F50)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA__ONACTIVITYENDED_OFFSET UNITYSDK_OFFSET(0xBD95A80)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA__ONACTIVITYOPENED_OFFSET UNITYSDK_OFFSET(0xBD95A20)
