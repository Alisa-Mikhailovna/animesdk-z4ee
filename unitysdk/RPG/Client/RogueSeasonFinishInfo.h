...
#define RPG_CLIENT_ROGUESEASONFINISHINFO_QUITROGUEMAP_OFFSET UNITYSDK_OFFSET(0xD3FFF30)
#define RPG_CLIENT_ROGUESEASONFINISHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD3E8560)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_1_BB4B99DE4C2501EC_6* _SceneInfo; // 0x10
		::Class_1_21DCD4640D389503_16* _LineupInfo; // 0x18
