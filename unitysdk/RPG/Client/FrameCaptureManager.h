...
#define RPG_CLIENT_FRAMECAPTUREMANAGER_CAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0xC627590)
#define RPG_CLIENT_FRAMECAPTUREMANAGER_ISFRAMECAPTUREFULL_OFFSET UNITYSDK_OFFSET(0xC627500)
#define RPG_CLIENT_FRAMECAPTUREMANAGER_RELEASECAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0xC627690)
#define RPG_CLIENT_FRAMECAPTUREMANAGER_STARTFRAMEBLENDING_OFFSET UNITYSDK_OFFSET(0xC6277A0)
#define RPG_CLIENT_FRAMECAPTUREMANAGER__CLEARCAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0xC627740)
#define RPG_CLIENT_FRAMECAPTUREMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC6274A0)
