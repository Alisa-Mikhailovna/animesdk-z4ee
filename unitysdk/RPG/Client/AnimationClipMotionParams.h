...
#define RPG_CLIENT_ANIMATIONCLIPMOTIONPARAMS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x143B50)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimationClipMotionParams_TypeDefinitionIndex = 69901;
