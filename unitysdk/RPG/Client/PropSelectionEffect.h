...
#define RPG_CLIENT_PROPSELECTIONEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xD26ABD0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_ENDWORK_OFFSET UNITYSDK_OFFSET(0xD26B5D0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xD26C3D0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD26B030)
#define RPG_CLIENT_PROPSELECTIONEFFECT_METHOD_5_2F02286930EE8C35_OFFSET UNITYSDK_OFFSET(0xD26BC80)
#define RPG_CLIENT_PROPSELECTIONEFFECT_METHOD_5_95336F246B29BAF0_OFFSET UNITYSDK_OFFSET(0xD26B4D0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_METHOD_5_9849CBBA07F50D0D_OFFSET UNITYSDK_OFFSET(0xD26C2C0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xD26B420)
#define RPG_CLIENT_PROPSELECTIONEFFECT_METHOD_5_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xD26BBD0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_SETHOVERCOLOR_OFFSET UNITYSDK_OFFSET(0xD26C430)
#define RPG_CLIENT_PROPSELECTIONEFFECT_SETSTATE_OFFSET UNITYSDK_OFFSET(0xD26B9B0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_STARTWORK_1_OFFSET UNITYSDK_OFFSET(0xD26B540)
#define RPG_CLIENT_PROPSELECTIONEFFECT_STARTWORK_OFFSET UNITYSDK_OFFSET(0xD26B2E0)
#define RPG_CLIENT_PROPSELECTIONEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0xD26C640)
#define RPG_CLIENT_PROPSELECTIONEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xD26C5D0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(PropSelectionEffect_TypeDefinitionIndex)->GetStaticField(0xFBA0);
		}
		static ::System::Int32* StaticGet_Field_5_1()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PropSelectionEffect_TypeDefinitionIndex)->GetStaticField(0x54F0);
		}
