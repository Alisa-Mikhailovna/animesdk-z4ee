...
#define RPG_CLIENT_EVOLVEBUILDTYPEGEARSDETAIL_ADDMIXDETAIL_OFFSET UNITYSDK_OFFSET(0xC404830)
#define RPG_CLIENT_EVOLVEBUILDTYPEGEARSDETAIL_CREATE_OFFSET UNITYSDK_OFFSET(0xC4046E0)
#define RPG_CLIENT_EVOLVEBUILDTYPEGEARSDETAIL_GET_FORGETYPE_OFFSET UNITYSDK_OFFSET(0xC41BE60)
#define RPG_CLIENT_EVOLVEBUILDTYPEGEARSDETAIL_GET_MIXDETAILS_OFFSET UNITYSDK_OFFSET(0xC41BE40)
#define RPG_CLIENT_EVOLVEBUILDTYPEGEARSDETAIL_SET_FORGETYPE_OFFSET UNITYSDK_OFFSET(0xC41BE70)
#define RPG_CLIENT_EVOLVEBUILDTYPEGEARSDETAIL_SET_MIXDETAILS_OFFSET UNITYSDK_OFFSET(0xC41BE50)
#define RPG_CLIENT_EVOLVEBUILDTYPEGEARSDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0xC41BE30)
