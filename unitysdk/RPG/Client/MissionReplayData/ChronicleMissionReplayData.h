...
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCC0C870)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_GETCHAPTERICONPATH_OFFSET UNITYSDK_OFFSET(0xCC0D770)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_GETCHAPTERNAME_OFFSET UNITYSDK_OFFSET(0xCC0D3F0)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_GETMISSIONIDSET_OFFSET UNITYSDK_OFFSET(0xCC0D900)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_GETMISSIONNAME_OFFSET UNITYSDK_OFFSET(0xCC0D270)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_GETPERFORMANCEDATABYINDEX_OFFSET UNITYSDK_OFFSET(0xCC0DAD0)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_GETPERFORMANCEDATALIST_OFFSET UNITYSDK_OFFSET(0xCC0D230)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_GETRECORDPAGEID_OFFSET UNITYSDK_OFFSET(0xCC0DB60)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_GETSHOWIMGPATH_OFFSET UNITYSDK_OFFSET(0xCC0D8A0)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xCC0DC30)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_ISCANREPLAY_OFFSET UNITYSDK_OFFSET(0xCC0D150)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA_ISREPLAYFEATURECLOSED_OFFSET UNITYSDK_OFFSET(0xCC0D5F0)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCC0C910)
#define RPG_CLIENT_MISSIONREPLAYDATA_CHRONICLEMISSIONREPLAYDATA__INIT_OFFSET UNITYSDK_OFFSET(0xCC0C920)

namespace RPG::Client::MissionReplayData
{
	inline static constexpr unsigned int ChronicleMissionReplayData_TypeDefinitionIndex = 71250;
