...
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_AWARDLISTID_OFFSET UNITYSDK_OFFSET(0xC0D0A20)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_HASSERVERHISTORYDATA_OFFSET UNITYSDK_OFFSET(0xC0D06B0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0xC0CEFC0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISENDLESS_OFFSET UNITYSDK_OFFSET(0xC0CE240)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xC0D0710)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISINPROGRESS_OFFSET UNITYSDK_OFFSET(0xC0D0860)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISPREVSTAGEFINISH_OFFSET UNITYSDK_OFFSET(0xC0D0750)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0xC0CF050)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISSUBMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0xC0D07B0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ITEMRULEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0xC0D09A0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_LEVELDAYDURATIONLIST_OFFSET UNITYSDK_OFFSET(0xC0D09E0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0xC0D0920)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_LEVELNAME_OFFSET UNITYSDK_OFFSET(0xC0D0940)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_LEVELTYPE_OFFSET UNITYSDK_OFFSET(0xC0D0960)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_PREVSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xC0D0730)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_REQUIREDSCORELIST_OFFSET UNITYSDK_OFFSET(0xC0D0980)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_STARNUM_OFFSET UNITYSDK_OFFSET(0xC0D06D0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0xC0D06F0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_TOTALSTARNUM_OFFSET UNITYSDK_OFFSET(0xC0D0A60)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_UNLOCKSUBMISSION_OFFSET UNITYSDK_OFFSET(0xC0D0A40)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_VISITORRULEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0xC0D09C0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_VISITORTIMEINTERVALLIST_OFFSET UNITYSDK_OFFSET(0xC0D0A00)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_MARKSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0xC0CF160)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SETPREVSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xC0D0350)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_AWARDLISTID_OFFSET UNITYSDK_OFFSET(0xC0D0A30)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_HASSERVERHISTORYDATA_OFFSET UNITYSDK_OFFSET(0xC0D06C0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xC0D0720)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_ITEMRULEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0xC0D09B0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_LEVELDAYDURATIONLIST_OFFSET UNITYSDK_OFFSET(0xC0D09F0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0xC0D0930)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_LEVELNAME_OFFSET UNITYSDK_OFFSET(0xC0D0950)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_LEVELTYPE_OFFSET UNITYSDK_OFFSET(0xC0D0970)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_PREVSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xC0D0740)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_REQUIREDSCORELIST_OFFSET UNITYSDK_OFFSET(0xC0D0990)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_STARNUM_OFFSET UNITYSDK_OFFSET(0xC0D06E0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0xC0D0700)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_TOTALSTARNUM_OFFSET UNITYSDK_OFFSET(0xC0D0A70)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_UNLOCKSUBMISSION_OFFSET UNITYSDK_OFFSET(0xC0D0A50)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_VISITORRULEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0xC0D09D0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_VISITORTIMEINTERVALLIST_OFFSET UNITYSDK_OFFSET(0xC0D0A10)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xC0CD580)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC0D02B0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* _LevelDayDurationList_k__BackingField; // 0x20
		::Il2CppArray<::System::UInt32>* _AwardListID_k__BackingField; // 0x28
		::RPG::Client::ChenLingFesStageData* _PrevStageData_k__BackingField; // 0x30
		::Il2CppArray<::System::UInt32>* _VisitorRuleGroupIDList_k__BackingField; // 0x38
		...
		::System::UInt32 _UnlockSubMission_k__BackingField; // 0x50
		::System::UInt32 _TotalScore_k__BackingField; // 0x54
		::System::Boolean _HasSeenUnlock; // 0x58
		::System::Boolean _IsFinished_k__BackingField; // 0x59
		::System::Boolean _HasServerHistoryData_k__BackingField; // 0x5A
		...
		::System::Int32 _TotalStarNum_k__BackingField; // 0x68
