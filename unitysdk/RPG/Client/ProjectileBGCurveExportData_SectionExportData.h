...
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xD0C1850)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_GET_LASTESTPOINT_OFFSET UNITYSDK_OFFSET(0xD0C11B0)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_GET_STARTPOINT_OFFSET UNITYSDK_OFFSET(0xD0C1250)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_METHOD_1_808C6C68ABE77F5C_OFFSET UNITYSDK_OFFSET(0xD0C1440)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_METHOD_1_E95D3AD413F190D9_OFFSET UNITYSDK_OFFSET(0xD0C18A0)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C1A10)
