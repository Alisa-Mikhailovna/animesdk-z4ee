...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYFLOAT_GET_RANDOMVALUE_OFFSET UNITYSDK_OFFSET(0xC31A2B0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYFLOAT_METHOD_1_6CC538194602C49B_OFFSET UNITYSDK_OFFSET(0xC319D30)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xC31A340)
