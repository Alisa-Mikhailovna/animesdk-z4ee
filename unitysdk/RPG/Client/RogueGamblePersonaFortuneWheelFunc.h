...
#define RPG_CLIENT_ROGUEGAMBLEPERSONAFORTUNEWHEELFUNC_CREATE_OFFSET UNITYSDK_OFFSET(0xD3A0990)
#define RPG_CLIENT_ROGUEGAMBLEPERSONAFORTUNEWHEELFUNC_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0xD3A0AD0)
#define RPG_CLIENT_ROGUEGAMBLEPERSONAFORTUNEWHEELFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0xD3A0A30)
#define RPG_CLIENT_ROGUEGAMBLEPERSONAFORTUNEWHEELFUNC__SETMACHINETYPE_OFFSET UNITYSDK_OFFSET(0xD3A0C30)
#define RPG_CLIENT_ROGUEGAMBLEPERSONAFORTUNEWHEELFUNC__SETROLLRANGE_OFFSET UNITYSDK_OFFSET(0xD3A0A40)
