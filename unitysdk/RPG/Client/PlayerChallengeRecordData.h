...
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_BATTLECOUNT_OFFSET UNITYSDK_OFFSET(0xD09F920)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEBUFFID1_OFFSET UNITYSDK_OFFSET(0xD09FA30)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEBUFFID2_OFFSET UNITYSDK_OFFSET(0xD09FA50)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEID_OFFSET UNITYSDK_OFFSET(0xD09F610)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEMEMBERS1_OFFSET UNITYSDK_OFFSET(0xD09FA80)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEMEMBERS2_OFFSET UNITYSDK_OFFSET(0xD09FAA0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGENAME_OFFSET UNITYSDK_OFFSET(0xD09F770)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xD09F8A0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEROW_OFFSET UNITYSDK_OFFSET(0xD09F650)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGESCORE_OFFSET UNITYSDK_OFFSET(0xD09F9D0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGESTARCOUNT_OFFSET UNITYSDK_OFFSET(0xD09FA10)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGETURN_OFFSET UNITYSDK_OFFSET(0xD09F9F0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CURRENTPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xD09F8C0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CURRENTSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xD09F8E0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_DISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xD09FBB0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xD09F5F0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0xD09F6B0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_GROUPROW_OFFSET UNITYSDK_OFFSET(0xD09EF40)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xD09F630)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_HASRECORD_OFFSET UNITYSDK_OFFSET(0xD09F590)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_ISNEWUPDATE_OFFSET UNITYSDK_OFFSET(0xD09FAC0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_ISSHOWTIERCERECORD_OFFSET UNITYSDK_OFFSET(0xD09FC80)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_NORMALCHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xD09F900)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_TIERCERECORD_OFFSET UNITYSDK_OFFSET(0xD09FA70)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_TOTALPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xD09F830)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_TOTALSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xD09F850)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEBUFFID1_OFFSET UNITYSDK_OFFSET(0xD09FA40)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEBUFFID2_OFFSET UNITYSDK_OFFSET(0xD09FA60)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEID_OFFSET UNITYSDK_OFFSET(0xD09F620)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEMEMBERS1_OFFSET UNITYSDK_OFFSET(0xD09FA90)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEMEMBERS2_OFFSET UNITYSDK_OFFSET(0xD09FAB0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xD09F8B0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGESCORE_OFFSET UNITYSDK_OFFSET(0xD09F9E0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGESTARCOUNT_OFFSET UNITYSDK_OFFSET(0xD09FA20)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGETURN_OFFSET UNITYSDK_OFFSET(0xD09FA00)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CURRENTPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xD09F8D0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CURRENTSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xD09F8F0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xD09F600)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xD09F640)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_NORMALCHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xD09F910)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_TOTALPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xD09F840)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xD09DF10)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD09FD50)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__GETAVATAR_OFFSET UNITYSDK_OFFSET(0xD09EEC0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__GETCURRENTSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xD09E3B0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__SYNCLINEUP_OFFSET UNITYSDK_OFFSET(0xD09E520)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__SYNCTIERCE_OFFSET UNITYSDK_OFFSET(0xD09E090)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _ChallengeBuffID2_k__BackingField; // 0x28
		...
		::System::UInt32 _ChallengeID_k__BackingField; // 0x40
		::System::Int32 _ChallengeProgressCount_k__BackingField; // 0x44
		::System::UInt32 _ChallengeBuffID1_k__BackingField; // 0x48
		::System::Int32 _TotalProgressCount_k__BackingField; // 0x4C
		::System::UInt32 _ChallengeStarCount_k__BackingField; // 0x50
