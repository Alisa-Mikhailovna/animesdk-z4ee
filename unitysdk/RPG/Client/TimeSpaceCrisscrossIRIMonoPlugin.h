...
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIMONOPLUGIN_SETSTATEANDTYPE_OFFSET UNITYSDK_OFFSET(0xD6BC3E0)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xD6C7930)
