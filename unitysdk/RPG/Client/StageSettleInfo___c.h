...
#define RPG_CLIENT_STAGESETTLEINFO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xD554880)
#define RPG_CLIENT_STAGESETTLEINFO___C__CTOR_OFFSET UNITYSDK_OFFSET(0xD5548C0)
#define RPG_CLIENT_STAGESETTLEINFO___C___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xD5548D0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::Class_1_B9E3601D1336B415*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(StageSettleInfo___c_TypeDefinitionIndex)->GetStaticField(0x35420);
		}
		static ::RPG::Client::StageSettleInfo___c** StaticGet___9()
		{
			return (::RPG::Client::StageSettleInfo___c**)Il2CppClass::FromTypeDefinitionIndex(StageSettleInfo___c_TypeDefinitionIndex)->GetStaticField(0x35428);
		}
