...
#define RPG_CLIENT_SIGNALCURVEPOOL_GET_CURRENTSCENEPOOL_OFFSET UNITYSDK_OFFSET(0xD4F47E0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_2AB12BF7608A20EF_OFFSET UNITYSDK_OFFSET(0xD4F5120)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3129BDB20712C068_OFFSET UNITYSDK_OFFSET(0xD4F52E0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3A5CCD2FDB6F9738_OFFSET UNITYSDK_OFFSET(0xD4F4E40)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3F07804D8892197E_1_OFFSET UNITYSDK_OFFSET(0xD4F5240)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3F07804D8892197E_OFFSET UNITYSDK_OFFSET(0xD4F51B0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_69CEABFED67045C9_OFFSET UNITYSDK_OFFSET(0xD4F4FF0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0xD4F4860)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_B260AE72D1F1CB0C_OFFSET UNITYSDK_OFFSET(0xD4F54D0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0xD4F4800)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_F91B0AD50C072273_OFFSET UNITYSDK_OFFSET(0xD4F5090)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0xD4F4A70)
#define RPG_CLIENT_SIGNALCURVEPOOL_SET_CURRENTSCENEPOOL_OFFSET UNITYSDK_OFFSET(0xD4F47F0)
#define RPG_CLIENT_SIGNALCURVEPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0xD4F5570)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::SignalCurvePool**)Il2CppClass::FromTypeDefinitionIndex(SignalCurvePool_TypeDefinitionIndex)->GetStaticField(0x31D30);
		}
		static ::RPG::Client::SignalCurvePool** StaticGet__instance()
		{
			return (::RPG::Client::SignalCurvePool**)Il2CppClass::FromTypeDefinitionIndex(SignalCurvePool_TypeDefinitionIndex)->GetStaticField(0x31D38);
		}
