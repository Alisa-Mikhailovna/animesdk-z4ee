...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xC700EF0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_EQUALS_OFFSET UNITYSDK_OFFSET(0xC701DC0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_GET_COSTITEMUIDS_OFFSET UNITYSDK_OFFSET(0xC701FC0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_GET_CRAFTRECIPE_OFFSET UNITYSDK_OFFSET(0xC701FA0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0xC701FE0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_GET_REFTRACK_OFFSET UNITYSDK_OFFSET(0xC701F80)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_SET_COSTITEMUIDS_OFFSET UNITYSDK_OFFSET(0xC701FD0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_SET_CRAFTRECIPE_OFFSET UNITYSDK_OFFSET(0xC701FB0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_SET_MEMBER_OFFSET UNITYSDK_OFFSET(0xC701FF0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM_SET_REFTRACK_OFFSET UNITYSDK_OFFSET(0xC701F90)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKCRAFTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC701F70)
