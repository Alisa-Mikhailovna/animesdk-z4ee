...
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_APPLYTEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xD68B5F0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ASYNCAPPLYTEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xD68B9A0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ASYNCUPDATELANGSIZE_1_OFFSET UNITYSDK_OFFSET(0xD68A7A0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ASYNCUPDATELANGSIZE_OFFSET UNITYSDK_OFFSET(0xD68A6A0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_BEGINDOWNLOADSESSION_OFFSET UNITYSDK_OFFSET(0xD68B460)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_CANCELASYNCAPPLYTEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xD6893F0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_CANDELETE_OFFSET UNITYSDK_OFFSET(0xD68BEC0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_DELETETEXTMAPPACK_OFFSET UNITYSDK_OFFSET(0xD68A3D0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD6891C0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ENDDOWNLOADSESSION_OFFSET UNITYSDK_OFFSET(0xD68A330)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ENTERDOWNLOADING_OFFSET UNITYSDK_OFFSET(0xD68B4F0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ENTERIDLE_OFFSET UNITYSDK_OFFSET(0xD68B560)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETDOWNLOADEDTEXTMAPCOUNT_OFFSET UNITYSDK_OFFSET(0xD68BE70)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETDOWNLOADEDTEXTMAPITEMS_OFFSET UNITYSDK_OFFSET(0xD68C160)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETDOWNLOADSTAGE_OFFSET UNITYSDK_OFFSET(0xD689160)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETPARTIALDOWNLOADEDTEXTMAPITEMS_OFFSET UNITYSDK_OFFSET(0xD68C390)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETTEXTMAPITEMBYKEY_OFFSET UNITYSDK_OFFSET(0xD68C080)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETTEXTMAPSIZE_OFFSET UNITYSDK_OFFSET(0xD68AA80)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GET_ISSESSIONDOWNLOADING_OFFSET UNITYSDK_OFFSET(0xD6891B0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GET_ISSESSIONIDLE_OFFSET UNITYSDK_OFFSET(0xD6891A0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GET_ISVALIDATINGTEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xD68BBF0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ISTEXTMAPDOWNLOADED_OFFSET UNITYSDK_OFFSET(0xD68B3F0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ISTEXTMAPPARTIALDOWNLOADED_OFFSET UNITYSDK_OFFSET(0xD68BDD0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ONTEXTMAPSIZEFAIL_OFFSET UNITYSDK_OFFSET(0xD68AEA0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ONTEXTMAPSIZESUCCESS_OFFSET UNITYSDK_OFFSET(0xD68ABC0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_PAUSE_OFFSET UNITYSDK_OFFSET(0xD68A060)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_PLACEHOLDTEXTMAPPACK_OFFSET UNITYSDK_OFFSET(0xD68A5F0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_PREPAREDOWNLOAD_OFFSET UNITYSDK_OFFSET(0xD68A010)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_PREPARETEXTMAPDOWNLOADDATA_OFFSET UNITYSDK_OFFSET(0xD689490)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_RESUME_OFFSET UNITYSDK_OFFSET(0xD68A0B0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_SHOWSIZE_OFFSET UNITYSDK_OFFSET(0xD68BF00)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_STARTDOWNLOAD_OFFSET UNITYSDK_OFFSET(0xD68AFC0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_STOPDOWNLOAD_OFFSET UNITYSDK_OFFSET(0xD68A100)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_UPDATEPARTIALDOWNLOADTEXTMAPLANG_OFFSET UNITYSDK_OFFSET(0xD68C5C0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_UPDATETEXTMAPDOWNLOADSTATE_OFFSET UNITYSDK_OFFSET(0xD689C70)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__ASYNCUPDATELANGSIZE_B__31_0_OFFSET UNITYSDK_OFFSET(0xD68CDB0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__CLEARASYNCAPPLYCALLBACKS_OFFSET UNITYSDK_OFFSET(0xD689440)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD68CAC0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__DISPOSEUPDATEASSETCORE_OFFSET UNITYSDK_OFFSET(0xD68A2D0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__DISPOSEUPDATEASSET_OFFSET UNITYSDK_OFFSET(0xD689310)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__ONTEXTMAPPACKDOWNLOADFAILED_OFFSET UNITYSDK_OFFSET(0xD68C900)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__ONTEXTMAPPACKDOWNLOADSUCCEED_OFFSET UNITYSDK_OFFSET(0xD68C690)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__POSTTOMAINTHREAD_OFFSET UNITYSDK_OFFSET(0xD68BC40)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__STRICTVALIDATETEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xD68B8B0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Action_1<::RPG::Client::TextmapDownloadManager_TextmapApplyChangeErrorCode>* _applyCallback; // 0x10
		::Class_1_0AD1433F85E9FBFC* _langSizeLoader; // 0x18
		::System::Collections::Generic::List_1<::RPG::Client::TextmapLanguageItem*>* _itemListCache; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int64>* _textmapDict; // 0x28
		::System::Collections::Generic::HashSet_1<::System::String*>* _partialDownloadedLanguage; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::Client::TextmapLanguageItem*>* _languageItems; // 0x38
		::System::String* _activeDownloadLangKey; // 0x40
		::Class_1_B76B01F33EAE3251* _updateOneTextmapLangAsset; // 0x48
		::System::Action_1<::RPG::Client::TextmapDownloadManager_TextmapSizeErrorCode>* _sizeCb; // 0x50
		::System::Collections::Generic::HashSet_1<::System::String*>* _downloadedLanguage; // 0x58
