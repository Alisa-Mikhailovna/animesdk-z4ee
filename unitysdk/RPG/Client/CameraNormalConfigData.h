...
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_ADDFROMCONFIG_OFFSET UNITYSDK_OFFSET(0xBF3E2B0)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_ADDFROMDATA_OFFSET UNITYSDK_OFFSET(0xBF44F20)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_COPYFROMCONFIG_OFFSET UNITYSDK_OFFSET(0xBF3DA70)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_COPYFROMOTHEREXCLUDEINVALID_OFFSET UNITYSDK_OFFSET(0xBF3DBD0)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_GET_ISMELEEATTACK_OFFSET UNITYSDK_OFFSET(0xBF45090)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_RESETTARGETENTITIES_OFFSET UNITYSDK_OFFSET(0xBF3E420)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_SETFOLLOWANGLETOFOLLOWSPHERICALPOS_OFFSET UNITYSDK_OFFSET(0xBF45010)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBF3C190)
