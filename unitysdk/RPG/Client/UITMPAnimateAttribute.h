...
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_46EFC1EAB3056273_OFFSET UNITYSDK_OFFSET(0xD810780)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xD80FF70)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_66F42CE2EDA79734_OFFSET UNITYSDK_OFFSET(0xD80F900)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xD80FD60)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xD80FDD0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_B57BF96C08E92D3E_OFFSET UNITYSDK_OFFSET(0xD8102B0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0xD80FF00)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD80F6F0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_REFRESHFONTMATREF_OFFSET UNITYSDK_OFFSET(0xD80F7A0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_SETQUADSCALE_OFFSET UNITYSDK_OFFSET(0xD808E00)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_TMPMATPROPERTIESUPDATE_OFFSET UNITYSDK_OFFSET(0xD80FC20)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD80FBD0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xD8108A0)
