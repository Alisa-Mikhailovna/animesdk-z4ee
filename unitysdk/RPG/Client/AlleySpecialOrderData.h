...
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_GOODS_OFFSET UNITYSDK_OFFSET(0xBD349B0)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_ORDERID_OFFSET UNITYSDK_OFFSET(0xBD34960)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_ORDERPICPATH_OFFSET UNITYSDK_OFFSET(0xBD34BA0)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_ORDERTIPSPATH_OFFSET UNITYSDK_OFFSET(0xBD34AB0)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_ORDERTIPSTIME_OFFSET UNITYSDK_OFFSET(0xBD34B00)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_SPECIALORDERCONTENT_OFFSET UNITYSDK_OFFSET(0xBD348C0)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_SPECIALORDERGOODS_OFFSET UNITYSDK_OFFSET(0xBD34910)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_SPECIALORDERREWARD_OFFSET UNITYSDK_OFFSET(0xBD34A60)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_SPECIALORDERSHIP_OFFSET UNITYSDK_OFFSET(0xBD34A10)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_SPECIALORDERSHOPID_OFFSET UNITYSDK_OFFSET(0xBD34B50)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xBD34980)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_SUBTITLEID_OFFSET UNITYSDK_OFFSET(0xBD349C0)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_TARGETS_OFFSET UNITYSDK_OFFSET(0xBD349A0)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBD34970)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA_SET_STATUS_OFFSET UNITYSDK_OFFSET(0xBD34990)
#define RPG_CLIENT_ALLEYSPECIALORDERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBD34400)
