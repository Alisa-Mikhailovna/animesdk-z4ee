...
#define RPG_CLIENT_MONOPAMUFACEEFFECTPLUGIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCD11780)
#define RPG_CLIENT_MONOPAMUFACEEFFECTPLUGIN_START_OFFSET UNITYSDK_OFFSET(0xCD11740)
#define RPG_CLIENT_MONOPAMUFACEEFFECTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCD11E20)
