...
#define RPG_CLIENT_PAMCHATAVATARGROWTHUPLOADSERVICE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xCF22DB0)
#define RPG_CLIENT_PAMCHATAVATARGROWTHUPLOADSERVICE_START_OFFSET UNITYSDK_OFFSET(0xCF22E60)
#define RPG_CLIENT_PAMCHATAVATARGROWTHUPLOADSERVICE_STOP_OFFSET UNITYSDK_OFFSET(0xCF22F00)
#define RPG_CLIENT_PAMCHATAVATARGROWTHUPLOADSERVICE_UPLOADAVATARGROWTH_OFFSET UNITYSDK_OFFSET(0xCF22FF0)
#define RPG_CLIENT_PAMCHATAVATARGROWTHUPLOADSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xCF232C0)
#define RPG_CLIENT_PAMCHATAVATARGROWTHUPLOADSERVICE__DOUPLOADAVATARGROWTH_OFFSET UNITYSDK_OFFSET(0xCF23050)
#define RPG_CLIENT_PAMCHATAVATARGROWTHUPLOADSERVICE__ONAVATARSYNC_OFFSET UNITYSDK_OFFSET(0xCF22FA0)
