...
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xBFC9C30)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xBFC96E0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_9D1353263EAF48A2_OFFSET UNITYSDK_OFFSET(0xBFC9A20)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xBFC95E0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBFC9760)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xBFC9970)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0xBFC9630)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_FE327FD0760E1514_OFFSET UNITYSDK_OFFSET(0xBFC9B00)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_TICK_OFFSET UNITYSDK_OFFSET(0xBFC97B0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0xBFC9CB0)
