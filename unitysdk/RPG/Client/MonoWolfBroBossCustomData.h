...
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_GETHP_OFFSET UNITYSDK_OFFSET(0xCD3CDD0)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_LOSSHP_OFFSET UNITYSDK_OFFSET(0xCD3CE10)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_ONBEINVALIDHIT_OFFSET UNITYSDK_OFFSET(0xCD3CE90)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD3CD80)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3CF10)
