...
#define RPG_CLIENT_RPGANIMATIONEVENT_ANIMATIONEVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xD2865F0)
#define RPG_CLIENT_RPGANIMATIONEVENT_ANIMATIONEVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xD286620)
#define RPG_CLIENT_RPGANIMATIONEVENT_ANIMATIONEVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xD286260)
#define RPG_CLIENT_RPGANIMATIONEVENT_ANIMATIONEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xD286580)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGAnimationEvent_AnimationEventCallBack_TypeDefinitionIndex = 69548;
