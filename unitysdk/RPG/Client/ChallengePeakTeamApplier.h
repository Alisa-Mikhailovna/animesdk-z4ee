...
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_APPLY_OFFSET UNITYSDK_OFFSET(0xBFBFAF0)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_CREATE_OFFSET UNITYSDK_OFFSET(0xBFBF790)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_GET_BOSSAVATARIDS_OFFSET UNITYSDK_OFFSET(0xBFBF750)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_GET_BOSSBUFFID_OFFSET UNITYSDK_OFFSET(0xBFBF770)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xBFBF730)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_GET_RECOMMENDATION_OFFSET UNITYSDK_OFFSET(0xBFBF740)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_REPORT_OFFSET UNITYSDK_OFFSET(0xBFBFC50)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_SETBOSSTEAMINFO_OFFSET UNITYSDK_OFFSET(0xBFBFA90)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_SETNORMALTEAMINFO_OFFSET UNITYSDK_OFFSET(0xBFBF920)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_SET_BOSSAVATARIDS_OFFSET UNITYSDK_OFFSET(0xBFBF760)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_SET_BOSSBUFFID_OFFSET UNITYSDK_OFFSET(0xBFBF780)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER_TRYGETNORMALAVATARIDS_OFFSET UNITYSDK_OFFSET(0xBFBF9E0)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFBF890)
#define RPG_CLIENT_CHALLENGEPEAKTEAMAPPLIER__GETREPORTINFO_OFFSET UNITYSDK_OFFSET(0xBFBFD60)
