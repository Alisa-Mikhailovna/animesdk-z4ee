...
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xC32ACD0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xC32AA20)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0xC32B380)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_2E47F09A457E7E05_OFFSET UNITYSDK_OFFSET(0xC32B290)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC32A890)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xC32A8F0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xC32A960)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xC32A9C0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC32A830)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC32A7A0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xC32B310)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_B76CD5CB3E297DF3_OFFSET UNITYSDK_OFFSET(0xC32AD50)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xC32B490)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC32B480)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_OracleOutlineBehavior_TypeDefinitionIndex)->GetStaticField(0x14500);
		}
		static ::System::Int32* StaticGet__Dither_Alpha()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_OracleOutlineBehavior_TypeDefinitionIndex)->GetStaticField(0x14504);
		}
