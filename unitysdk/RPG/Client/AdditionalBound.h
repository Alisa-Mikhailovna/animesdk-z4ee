...
#define RPG_CLIENT_ADDITIONALBOUND_GET_ADDITIONALBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xBC8C0E0)
#define RPG_CLIENT_ADDITIONALBOUND_GET_ADDITIONALBOUNDSIZE_OFFSET UNITYSDK_OFFSET(0xBC8C0C0)
#define RPG_CLIENT_ADDITIONALBOUND_SET_ADDITIONALBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xBC8C100)
#define RPG_CLIENT_ADDITIONALBOUND_SET_ADDITIONALBOUNDSIZE_OFFSET UNITYSDK_OFFSET(0xBC8C0D0)
#define RPG_CLIENT_ADDITIONALBOUND__CTOR_OFFSET UNITYSDK_OFFSET(0xBC8C110)
