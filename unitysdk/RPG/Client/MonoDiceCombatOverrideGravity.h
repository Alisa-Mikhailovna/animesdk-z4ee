...
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xCC52710)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCC52B90)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCC52A10)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCC52900)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_OVERRIDEGRAVITY_OFFSET UNITYSDK_OFFSET(0xCC52820)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_RESETGRAVITY_OFFSET UNITYSDK_OFFSET(0xCC52AE0)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0xCC52C60)
