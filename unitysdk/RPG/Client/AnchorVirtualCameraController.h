...
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xBD85A60)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_1EC859072E470A1E_OFFSET UNITYSDK_OFFSET(0xBD87860)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0xBD86140)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0xBD872D0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xBD862C0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xBD859E0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_461F63418186686D_OFFSET UNITYSDK_OFFSET(0xBD876C0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_6CAB5262B05DECB0_OFFSET UNITYSDK_OFFSET(0xBD89150)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xBD87BB0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xBD88550)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xBD86090)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_C66E15B631BB1D0F_OFFSET UNITYSDK_OFFSET(0xBD89370)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xBD85A40)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0xBD85A50)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xBD85A30)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0xBD86310)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0xBD864C0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBD85F60)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_SETCENTERPOS_OFFSET UNITYSDK_OFFSET(0xBD87600)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_STARTUPDATE_OFFSET UNITYSDK_OFFSET(0xBD87C70)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_STOPUPDATE_OFFSET UNITYSDK_OFFSET(0xBD885D0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_UPDATELOOKATPHONECAMERAPOSITIONANDDIRECTION_OFFSET UNITYSDK_OFFSET(0xBD887C0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_UPDATELOOKATPROPCAMERAPOSITIONANDDIRECTION_OFFSET UNITYSDK_OFFSET(0xBD89560)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD89C50)
