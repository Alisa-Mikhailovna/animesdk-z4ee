...
#define RPG_CLIENT_RANDOMLOOPBYFRAME_DOTICK_OFFSET UNITYSDK_OFFSET(0xD2C5FF0)
#define RPG_CLIENT_RANDOMLOOPBYFRAME_INIT_OFFSET UNITYSDK_OFFSET(0xD2C5E70)
#define RPG_CLIENT_RANDOMLOOPBYFRAME_SETPLAYEDSTATUS_OFFSET UNITYSDK_OFFSET(0xD2C5FB0)
#define RPG_CLIENT_RANDOMLOOPBYFRAME_SETRANDOMTEXTIDLIST_OFFSET UNITYSDK_OFFSET(0xD2C5EC0)
#define RPG_CLIENT_RANDOMLOOPBYFRAME_TRYSTARTPERFORM_OFFSET UNITYSDK_OFFSET(0xD2C5D30)
#define RPG_CLIENT_RANDOMLOOPBYFRAME_UPDATE_OFFSET UNITYSDK_OFFSET(0xD2C6610)
#define RPG_CLIENT_RANDOMLOOPBYFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0xD2C6660)
#define RPG_CLIENT_RANDOMLOOPBYFRAME__GETCURTARGETTIME_OFFSET UNITYSDK_OFFSET(0xD2C6590)
#define RPG_CLIENT_RANDOMLOOPBYFRAME__PERFORMRANDOMLOOP_OFFSET UNITYSDK_OFFSET(0xD2C6280)

namespace RPG::Client
{
	inline static constexpr unsigned int RandomLoopByFrame_TypeDefinitionIndex = 69356;
