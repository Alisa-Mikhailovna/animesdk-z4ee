...
#define RPG_CLIENT_MUSICRHYTHMPRESET_CREATE_OFFSET UNITYSDK_OFFSET(0xCE13E80)
#define RPG_CLIENT_MUSICRHYTHMPRESET_GET_ID_OFFSET UNITYSDK_OFFSET(0xCE13EF0)
#define RPG_CLIENT_MUSICRHYTHMPRESET_GET_PRESETDESC_OFFSET UNITYSDK_OFFSET(0xCE14030)
#define RPG_CLIENT_MUSICRHYTHMPRESET_GET_PRESETGRIDCONFIG_OFFSET UNITYSDK_OFFSET(0xCE140F0)
#define RPG_CLIENT_MUSICRHYTHMPRESET_GET_PRESETNAME_OFFSET UNITYSDK_OFFSET(0xCE13F70)
#define RPG_CLIENT_MUSICRHYTHMPRESET_GET_ROW_OFFSET UNITYSDK_OFFSET(0xCE13F10)
#define RPG_CLIENT_MUSICRHYTHMPRESET_SET_ID_OFFSET UNITYSDK_OFFSET(0xCE13F00)
#define RPG_CLIENT_MUSICRHYTHMPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0xCE13EE0)
