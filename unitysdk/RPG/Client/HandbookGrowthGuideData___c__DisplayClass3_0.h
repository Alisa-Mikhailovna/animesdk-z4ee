...
#define RPG_CLIENT_HANDBOOKGROWTHGUIDEDATA___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC87A270)
#define RPG_CLIENT_HANDBOOKGROWTHGUIDEDATA___C__DISPLAYCLASS3_0__GETRECOMMENDPERCENTAGEBYGUIDEID_B__0_OFFSET UNITYSDK_OFFSET(0xC87C680)
#define RPG_CLIENT_HANDBOOKGROWTHGUIDEDATA___C__DISPLAYCLASS3_0__GETRECOMMENDPERCENTAGEBYGUIDEID_B__1_OFFSET UNITYSDK_OFFSET(0xC87C6A0)
