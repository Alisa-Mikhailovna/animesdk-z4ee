...
#define RPG_CLIENT_MONOEFFECTPLUGINBODYALCHEMIZE_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xCC84CE0)
#define RPG_CLIENT_MONOEFFECTPLUGINBODYALCHEMIZE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCC84C40)
#define RPG_CLIENT_MONOEFFECTPLUGINBODYALCHEMIZE_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xCC84D70)
#define RPG_CLIENT_MONOEFFECTPLUGINBODYALCHEMIZE_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xCC84B10)
#define RPG_CLIENT_MONOEFFECTPLUGINBODYALCHEMIZE_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0xCC84E30)
#define RPG_CLIENT_MONOEFFECTPLUGINBODYALCHEMIZE_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0xCC84DE0)
#define RPG_CLIENT_MONOEFFECTPLUGINBODYALCHEMIZE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCC84B50)
#define RPG_CLIENT_MONOEFFECTPLUGINBODYALCHEMIZE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC84E80)
