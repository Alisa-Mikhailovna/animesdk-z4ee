...
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHECKLOADFINISH_OFFSET UNITYSDK_OFFSET(0xBE37EC0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_CHECKREGISTERINPRELOAD_OFFSET UNITYSDK_OFFSET(0xBE39750)
#define RPG_CLIENT_BATTLEASSETPRELOAD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBE37880)
#define RPG_CLIENT_BATTLEASSETPRELOAD_FOREACHPRELOADGROUPS_OFFSET UNITYSDK_OFFSET(0xBE39670)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETAIDECISIONGROUP_OFFSET UNITYSDK_OFFSET(0xBE38060)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETAVATARASSETPRELOADENABLE_OFFSET UNITYSDK_OFFSET(0xBE38750)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETAVATARASSETPRELOADGROUP_OFFSET UNITYSDK_OFFSET(0xBE38B20)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETBATTLEEVENTASSETPRELOADGROUP_OFFSET UNITYSDK_OFFSET(0xBE38E60)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETENTITYASSETPRELOADGROUP_OFFSET UNITYSDK_OFFSET(0xBE389E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETENTITYPRELOADGROUPID_OFFSET UNITYSDK_OFFSET(0xBE39050)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETMONSTERASSETPRELOADGROUP_OFFSET UNITYSDK_OFFSET(0xBE38C30)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETPRELOADGROUPLIST_OFFSET UNITYSDK_OFFSET(0xBE38970)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETPRELOADGROUP_1_OFFSET UNITYSDK_OFFSET(0xBE39230)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETPRELOADGROUP_OFFSET UNITYSDK_OFFSET(0xBE39140)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETRTCHARACTERPRELOADGROUP_OFFSET UNITYSDK_OFFSET(0xBE38F50)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETRULE_OFFSET UNITYSDK_OFFSET(0xBE384A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GETSERVANTASSETPRELOADGROUP_OFFSET UNITYSDK_OFFSET(0xBE38D90)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_ADVENTUREPRELOADCONFIG_OFFSET UNITYSDK_OFFSET(0xBE39B80)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_ALLASSETPRELOADGROUPS_OFFSET UNITYSDK_OFFSET(0xBE39DA0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_BATTLEPRELOADCONFIG_OFFSET UNITYSDK_OFFSET(0xBE39B90)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_INBATTLEASSETGROUP_OFFSET UNITYSDK_OFFSET(0xBE39CB0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_ISBATTLENEWPRELOADPHASE_OFFSET UNITYSDK_OFFSET(0xBE3A1C0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_ISBATTLEPRELOADPHASE_OFFSET UNITYSDK_OFFSET(0xBE3A170)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_ISDISPOSING_OFFSET UNITYSDK_OFFSET(0xBE39B60)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_ISRECORDFINISHED_OFFSET UNITYSDK_OFFSET(0xBE3A360)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_ISSPAWNBENCHMARKFINISHED_OFFSET UNITYSDK_OFFSET(0xBE3A450)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_ISTARGETADVENTUREPHASE_OFFSET UNITYSDK_OFFSET(0xBE3A270)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_ISTARGETBATTLEPHASE_OFFSET UNITYSDK_OFFSET(0xBE3A220)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_LASTPRELOADPHASE_OFFSET UNITYSDK_OFFSET(0xBE3A210)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_LINEUPDATA_OFFSET UNITYSDK_OFFSET(0xBE39DB0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_MONSTERLODCONFIG_OFFSET UNITYSDK_OFFSET(0xBE39B70)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_PREBATTLEASSETGROUP_OFFSET UNITYSDK_OFFSET(0xBE38190)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_PRELOADPHASE_OFFSET UNITYSDK_OFFSET(0xBE39DC0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_GET_UIASSETGROUP_OFFSET UNITYSDK_OFFSET(0xBE39BA0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ISPRELOADTAGACTIVE_OFFSET UNITYSDK_OFFSET(0xBE39AE0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ISRULEFORBIDBYCONFICT_OFFSET UNITYSDK_OFFSET(0xBE385A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ONBEGINPLAYVIDEO_OFFSET UNITYSDK_OFFSET(0xBE38270)
#define RPG_CLIENT_BATTLEASSETPRELOAD_ONENDPLAYVIDEO_OFFSET UNITYSDK_OFFSET(0xBE382D0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RECORDONESTEP_OFFSET UNITYSDK_OFFSET(0xBE3A320)
#define RPG_CLIENT_BATTLEASSETPRELOAD_REFRESHPETPRELOAD_OFFSET UNITYSDK_OFFSET(0xBE38130)
#define RPG_CLIENT_BATTLEASSETPRELOAD_REMOVEGROUPBYID_OFFSET UNITYSDK_OFFSET(0xBE39440)
#define RPG_CLIENT_BATTLEASSETPRELOAD_REMOVEGROUPLIST_OFFSET UNITYSDK_OFFSET(0xBE39560)
#define RPG_CLIENT_BATTLEASSETPRELOAD_REMOVEGROUP_OFFSET UNITYSDK_OFFSET(0xBE37B40)
#define RPG_CLIENT_BATTLEASSETPRELOAD_SETAVATARASSETPRELOADENABLE_OFFSET UNITYSDK_OFFSET(0xBE38790)
#define RPG_CLIENT_BATTLEASSETPRELOAD_SETBATTLELINEUPDATA_OFFSET UNITYSDK_OFFSET(0xBE37E50)
#define RPG_CLIENT_BATTLEASSETPRELOAD_SETPRELOADTAGSTATE_OFFSET UNITYSDK_OFFSET(0xBE397C0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_SET_PRELOADPHASE_OFFSET UNITYSDK_OFFSET(0xBE39DD0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_STOPRECORD_OFFSET UNITYSDK_OFFSET(0xBE3A370)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UAUTOSTARTRECORD_OFFSET UNITYSDK_OFFSET(0xBE3A2C0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UAUTOSTARTSPAWNBENCHMARK_OFFSET UNITYSDK_OFFSET(0xBE3A3B0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UAUTOSTOPSPAWNBENCHMARK_OFFSET UNITYSDK_OFFSET(0xBE3A410)
#define RPG_CLIENT_BATTLEASSETPRELOAD_WAITLOADFINISH_OFFSET UNITYSDK_OFFSET(0xBE37F90)
#define RPG_CLIENT_BATTLEASSETPRELOAD__CLEARRULES_OFFSET UNITYSDK_OFFSET(0xBE37D20)
#define RPG_CLIENT_BATTLEASSETPRELOAD__CTOR_OFFSET UNITYSDK_OFFSET(0xBE37280)
#define RPG_CLIENT_BATTLEASSETPRELOAD__DELAYTRIGGERONENDPLAYVIDEO_OFFSET UNITYSDK_OFFSET(0xBE38370)
#define RPG_CLIENT_BATTLEASSETPRELOAD__REGISTERRULES_OFFSET UNITYSDK_OFFSET(0xBE37660)
#define RPG_CLIENT_BATTLEASSETPRELOAD__REIGSTERRULE_OFFSET UNITYSDK_OFFSET(0xBE383D0)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::GameCore::BattleLineupData* _LineupData; // 0x48
		::System::Collections::Generic::List_1<::RPG::Client::BattleAssetPreload_AssetPreloadGroup*>* _AllAssetPreloadGroups; // 0x50
		::Il2CppArray<::System::Collections::Generic::List_1<::RPG::Client::BattleAssetPreload_AssetPreloadGroup*>*>* _AssetGroupsByGroupType; // 0x58
