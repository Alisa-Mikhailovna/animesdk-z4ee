...
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_PHASEID_OFFSET UNITYSDK_OFFSET(0xC5CCDD0)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_RACEBGFIGUREPATH_OFFSET UNITYSDK_OFFSET(0xC5CCF70)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_RACEDATA_OFFSET UNITYSDK_OFFSET(0xC5CCD70)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_RACEID_OFFSET UNITYSDK_OFFSET(0xC5CCD50)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xC5CCE20)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_RIVALINFO_OFFSET UNITYSDK_OFFSET(0xC5CCDB0)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_SELFINFO_OFFSET UNITYSDK_OFFSET(0xC5CCD90)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_STAGEENDDESC_OFFSET UNITYSDK_OFFSET(0xC5CCEF0)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xC5CCE70)
#define RPG_CLIENT_FIGHTFESTMAINRACE_SET_RACEDATA_OFFSET UNITYSDK_OFFSET(0xC5CCD80)
#define RPG_CLIENT_FIGHTFESTMAINRACE_SET_RACEID_OFFSET UNITYSDK_OFFSET(0xC5CCD60)
#define RPG_CLIENT_FIGHTFESTMAINRACE_SET_RIVALINFO_OFFSET UNITYSDK_OFFSET(0xC5CCDC0)
#define RPG_CLIENT_FIGHTFESTMAINRACE_SET_SELFINFO_OFFSET UNITYSDK_OFFSET(0xC5CCDA0)
#define RPG_CLIENT_FIGHTFESTMAINRACE__CTOR_OFFSET UNITYSDK_OFFSET(0xC5CCC00)
