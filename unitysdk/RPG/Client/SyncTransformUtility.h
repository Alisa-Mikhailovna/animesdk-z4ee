...
#define RPG_CLIENT_SYNCTRANSFORMUTILITY_METHOD_6_E1579A152A3CF2C2_OFFSET UNITYSDK_OFFSET(0xD5F5A50)
#define RPG_CLIENT_SYNCTRANSFORMUTILITY_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD5F5BB0)
#define RPG_CLIENT_SYNCTRANSFORMUTILITY_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD5F5B00)
#define RPG_CLIENT_SYNCTRANSFORMUTILITY_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xD5F4FC0)
#define RPG_CLIENT_SYNCTRANSFORMUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0xD5F5C20)

namespace RPG::Client
{
	inline static constexpr unsigned int SyncTransformUtility_TypeDefinitionIndex = 69386;
