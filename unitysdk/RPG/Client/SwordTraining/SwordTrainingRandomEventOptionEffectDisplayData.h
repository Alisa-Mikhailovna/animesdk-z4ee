...
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTOPTIONEFFECTDISPLAYDATA_ADDMOOD_OFFSET UNITYSDK_OFFSET(0xD596300)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTOPTIONEFFECTDISPLAYDATA_ADDSKILLPOINT_OFFSET UNITYSDK_OFFSET(0xD596250)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTOPTIONEFFECTDISPLAYDATA_ADDSTATUS_OFFSET UNITYSDK_OFFSET(0xD596460)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTOPTIONEFFECTDISPLAYDATA_FETCHDISPLAYDATAITEMS_OFFSET UNITYSDK_OFFSET(0xD5965C0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTOPTIONEFFECTDISPLAYDATA_SUBMOOD_OFFSET UNITYSDK_OFFSET(0xD5963B0)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTOPTIONEFFECTDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD596120)

namespace RPG::Client::SwordTraining
{
	inline static constexpr unsigned int SwordTrainingRandomEventOptionEffectDisplayData_TypeDefinitionIndex = 71438;
