...
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC3A7290)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_COLORID_OFFSET UNITYSDK_OFFSET(0xC3BF6B0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_COLOR_OFFSET UNITYSDK_OFFSET(0xC3BF750)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC3BF590)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0xC3BF570)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC3BF650)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_SET_TAGID_OFFSET UNITYSDK_OFFSET(0xC3BF580)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC3BF560)
