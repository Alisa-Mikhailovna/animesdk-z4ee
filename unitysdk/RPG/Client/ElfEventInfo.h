...
#define RPG_CLIENT_ELFEVENTINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC3659F0)
#define RPG_CLIENT_ELFEVENTINFO_GETCONTACTSDATA_OFFSET UNITYSDK_OFFSET(0xC365C40)
#define RPG_CLIENT_ELFEVENTINFO_GETMESSAGEDATA_OFFSET UNITYSDK_OFFSET(0xC365B90)
#define RPG_CLIENT_ELFEVENTINFO_GETOPTIONEFFECTDATA_OFFSET UNITYSDK_OFFSET(0xC365CF0)
#define RPG_CLIENT_ELFEVENTINFO_GETSELECTEVENTDATA_OFFSET UNITYSDK_OFFSET(0xC365DA0)
#define RPG_CLIENT_ELFEVENTINFO_GETSELECTEVENTMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0xC365E50)
#define RPG_CLIENT_ELFEVENTINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC364F30)
#define RPG_CLIENT_ELFEVENTINFO__ASSERTLIMITMESSAGE_OFFSET UNITYSDK_OFFSET(0xC364E50)
#define RPG_CLIENT_ELFEVENTINFO__ASSERTSAMESPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0xC364D50)
#define RPG_CLIENT_ELFEVENTINFO__BUILDSELECTEVENTMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0xC365EA0)
#define RPG_CLIENT_ELFEVENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC3663C0)
#define RPG_CLIENT_ELFEVENTINFO__INITCONTACTDATA_OFFSET UNITYSDK_OFFSET(0xC364F90)
#define RPG_CLIENT_ELFEVENTINFO__INITEVENTDATA_OFFSET UNITYSDK_OFFSET(0xC3657A0)
#define RPG_CLIENT_ELFEVENTINFO__INITMESSAGEDATA_OFFSET UNITYSDK_OFFSET(0xC3654F0)
#define RPG_CLIENT_ELFEVENTINFO__INITOPTIONEFFECTDATA_OFFSET UNITYSDK_OFFSET(0xC365240)
