...
#define RPG_CLIENT_UISTATECTRL_COMPLETECURRENTSTATEIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xD80AD10)
#define RPG_CLIENT_UISTATECTRL_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xD80B5B0)
#define RPG_CLIENT_UISTATECTRL_GET_INTERNALACCESSOR_OFFSET UNITYSDK_OFFSET(0xD80B610)
#define RPG_CLIENT_UISTATECTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD80B2C0)
#define RPG_CLIENT_UISTATECTRL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD80B090)
#define RPG_CLIENT_UISTATECTRL_PLAYSTATE_OFFSET UNITYSDK_OFFSET(0xD80A9D0)
#define RPG_CLIENT_UISTATECTRL_UPDATE_OFFSET UNITYSDK_OFFSET(0xD80B270)
#define RPG_CLIENT_UISTATECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0xD80B680)
#define RPG_CLIENT_UISTATECTRL__FORCECOMPLETECURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xD80ADF0)
#define RPG_CLIENT_UISTATECTRL__GETCURRENTSTATEACTIONSSTATUS_OFFSET UNITYSDK_OFFSET(0xD80A8B0)
#define RPG_CLIENT_UISTATECTRL__GETSTATEDATABYSTATENAME_OFFSET UNITYSDK_OFFSET(0xD80B440)
#define RPG_CLIENT_UISTATECTRL__INITSTATEDATAS_OFFSET UNITYSDK_OFFSET(0xD80B170)
#define RPG_CLIENT_UISTATECTRL__PLAYSTATEINTERNAL_OFFSET UNITYSDK_OFFSET(0xD80AA90)
#define RPG_CLIENT_UISTATECTRL__SETPARENT_OFFSET UNITYSDK_OFFSET(0xD80B3C0)
#define RPG_CLIENT_UISTATECTRL__STARTSTATE_OFFSET UNITYSDK_OFFSET(0xD80A330)
#define RPG_CLIENT_UISTATECTRL__TICKSTATE_OFFSET UNITYSDK_OFFSET(0xD80A4E0)
#define RPG_CLIENT_UISTATECTRL__TICK_OFFSET UNITYSDK_OFFSET(0xD80A3D0)
#define RPG_CLIENT_UISTATECTRL__TRYUPDATESTATUSOFCURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xD80A830)
