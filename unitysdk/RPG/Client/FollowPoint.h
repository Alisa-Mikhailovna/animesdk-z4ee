...
#define RPG_CLIENT_FOLLOWPOINT_GET_ISFOLLOWDYNAMIC_OFFSET UNITYSDK_OFFSET(0xC624050)
#define RPG_CLIENT_FOLLOWPOINT_GET_ISPOINTDYNAMIC_OFFSET UNITYSDK_OFFSET(0xC623F80)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_18D9238B9C310BFF_OFFSET UNITYSDK_OFFSET(0xC623970)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xC623810)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_BF972395CC722BF9_OFFSET UNITYSDK_OFFSET(0xC623EB0)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_D83D54151A7C7525_OFFSET UNITYSDK_OFFSET(0xC623700)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xC623A90)
#define RPG_CLIENT_FOLLOWPOINT_SET_ISFOLLOWDYNAMIC_OFFSET UNITYSDK_OFFSET(0xC6240B0)
#define RPG_CLIENT_FOLLOWPOINT_SET_ISPOINTDYNAMIC_OFFSET UNITYSDK_OFFSET(0xC623FE0)
#define RPG_CLIENT_FOLLOWPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xC624120)
