...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONRARITYOPTION_GETICON_OFFSET UNITYSDK_OFFSET(0xC72DD10)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONRARITYOPTION_GETNAME_OFFSET UNITYSDK_OFFSET(0xC72DC60)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONRARITYOPTION_SATISFY_OFFSET UNITYSDK_OFFSET(0xC72DBC0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONRARITYOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC72D180)
