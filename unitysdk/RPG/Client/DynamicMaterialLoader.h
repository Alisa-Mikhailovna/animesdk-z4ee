...
#define RPG_CLIENT_DYNAMICMATERIALLOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC2DA4F0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0xC2DB100)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC2DA840)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_FORCELOAD_OFFSET UNITYSDK_OFFSET(0xC2DAA40)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_FORCEUNLOAD_OFFSET UNITYSDK_OFFSET(0xC2DAAA0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xC2DB190)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_METHOD_6_2805BA06C41CBB37_OFFSET UNITYSDK_OFFSET(0xC2DA580)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC2DA9F0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC2DA960)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC2DA8D0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_SETLOADSTATE_OFFSET UNITYSDK_OFFSET(0xC2DA5D0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC2DA7B0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2DB1F0)
