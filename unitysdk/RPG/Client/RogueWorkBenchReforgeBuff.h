...
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GETFUNCID_OFFSET UNITYSDK_OFFSET(0xD4AA9A0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0xD4AA950)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xD4AAB40)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0xD4AA9E0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_REFRESH_OFFSET UNITYSDK_OFFSET(0xD4AA800)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_REPORTBUFFSELECTION_OFFSET UNITYSDK_OFFSET(0xD4AA870)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_SET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xD4AAB50)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xD4AA720)
