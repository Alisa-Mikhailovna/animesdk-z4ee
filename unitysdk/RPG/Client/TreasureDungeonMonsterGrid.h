...
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID_CANKILL_OFFSET UNITYSDK_OFFSET(0xD7555E0)
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID_GET_ENEMYROW_OFFSET UNITYSDK_OFFSET(0xD755650)
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID_GET_ISELITE_OFFSET UNITYSDK_OFFSET(0xD755720)
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID_GET_MONSTERSTAGEROW_OFFSET UNITYSDK_OFFSET(0xD755780)
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID__CTOR_OFFSET UNITYSDK_OFFSET(0xD748960)
