...
#define RPG_CLIENT_UINUMTEXTINCANIMATION_ADDDIGIT_OFFSET UNITYSDK_OFFSET(0xD7EC120)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_CLEARDIGITS_OFFSET UNITYSDK_OFFSET(0xD7EC200)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_GET_CURVALUE_OFFSET UNITYSDK_OFFSET(0xD7EC2B0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xD7EC2A0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0xD7EC0C0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_SETFORMATTEXT_OFFSET UNITYSDK_OFFSET(0xD7EC070)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_START_OFFSET UNITYSDK_OFFSET(0xD7EBA00)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0xD7EC020)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7EBB00)
#define RPG_CLIENT_UINUMTEXTINCANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xD7EC2C0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION__UPDATEDIGITS_OFFSET UNITYSDK_OFFSET(0xD7EBDC0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION__UPDATENUMBER_OFFSET UNITYSDK_OFFSET(0xD7EBC00)
