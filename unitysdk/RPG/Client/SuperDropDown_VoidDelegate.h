...
#define RPG_CLIENT_SUPERDROPDOWN_VOIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xD581530)
#define RPG_CLIENT_SUPERDROPDOWN_VOIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xD581560)
#define RPG_CLIENT_SUPERDROPDOWN_VOIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xD580260)
#define RPG_CLIENT_SUPERDROPDOWN_VOIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xD5814C0)

namespace RPG::Client
{
	inline static constexpr unsigned int SuperDropDown_VoidDelegate_TypeDefinitionIndex = 69384;
