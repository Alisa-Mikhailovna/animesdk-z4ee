...
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_CLEARACTIONS_OFFSET UNITYSDK_OFFSET(0xC8C2AE0)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_CLEARALL_OFFSET UNITYSDK_OFFSET(0xC8C2BB0)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_CLEARFIELDS_OFFSET UNITYSDK_OFFSET(0xC8C2430)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC8C1B90)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_GETFIELD_OFFSET UNITYSDK_OFFSET(0xC8C1F40)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_GET__INSTANCE_OFFSET UNITYSDK_OFFSET(0xC8C2D60)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_HASACTION_OFFSET UNITYSDK_OFFSET(0xC8C2860)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_HASFIELD_OFFSET UNITYSDK_OFFSET(0xC8C2220)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xC8C1D10)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_INVOKEACTION_OFFSET UNITYSDK_OFFSET(0xC8C2660)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_REMOVEACTION_OFFSET UNITYSDK_OFFSET(0xC8C2A00)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_REMOVEFIELD_OFFSET UNITYSDK_OFFSET(0xC8C2350)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_SETACTION_OFFSET UNITYSDK_OFFSET(0xC8C2500)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_SETFIELD_OFFSET UNITYSDK_OFFSET(0xC8C1DB0)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER_TRYGETFIELD_OFFSET UNITYSDK_OFFSET(0xC8C20A0)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER__CLEARALLINTERNAL_OFFSET UNITYSDK_OFFSET(0xC8C1C20)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C2D90)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER__ISVALIDKEY_OFFSET UNITYSDK_OFFSET(0xC8C1EE0)
#define RPG_CLIENT_IFIXGLOBALEXTENDMEMBERMANAGER__ONIFIXPATCHAPPLIEDNOTIFY_OFFSET UNITYSDK_OFFSET(0xC8C2C30)
