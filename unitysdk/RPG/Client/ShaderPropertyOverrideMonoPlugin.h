...
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_DUMP_OFFSET UNITYSDK_OFFSET(0xD4EB8D0)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0xD4EB710)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_GET_ISLEAFPREFERRED_OFFSET UNITYSDK_OFFSET(0xD4EB720)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_LOAD_OFFSET UNITYSDK_OFFSET(0xD4EB920)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_00523BAC9115E920_1_OFFSET UNITYSDK_OFFSET(0xD4EB7F0)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_00523BAC9115E920_OFFSET UNITYSDK_OFFSET(0xD4EB730)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_3CDB16AF04E6187A_1_OFFSET UNITYSDK_OFFSET(0xD4EB860)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_3CDB16AF04E6187A_OFFSET UNITYSDK_OFFSET(0xD4EB790)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xD4EC1D0)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xD4EC240)
