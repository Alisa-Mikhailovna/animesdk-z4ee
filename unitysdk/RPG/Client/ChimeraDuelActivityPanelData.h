...
#define RPG_CLIENT_CHIMERADUELACTIVITYPANELDATA_CHECKHASREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0xC1129C0)
#define RPG_CLIENT_CHIMERADUELACTIVITYPANELDATA_ISSHOWGOTOBTNREDDOT_OFFSET UNITYSDK_OFFSET(0xC112760)
#define RPG_CLIENT_CHIMERADUELACTIVITYPANELDATA_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0xC112A80)
#define RPG_CLIENT_CHIMERADUELACTIVITYPANELDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xC112CA0)
#define RPG_CLIENT_CHIMERADUELACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xC112820)
#define RPG_CLIENT_CHIMERADUELACTIVITYPANELDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xC112D40)
#define RPG_CLIENT_CHIMERADUELACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC112750)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(ChimeraDuelActivityPanelData_TypeDefinitionIndex)->GetStaticField(0x3BD0);
		}
