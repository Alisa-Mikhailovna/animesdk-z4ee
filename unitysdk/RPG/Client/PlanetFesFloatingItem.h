...
#define RPG_CLIENT_PLANETFESFLOATINGITEM_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD00D940)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_METHOD_5_2EA3D2C84685E32A_OFFSET UNITYSDK_OFFSET(0xD00DB40)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_ONCREATE_OFFSET UNITYSDK_OFFSET(0xD00D980)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD00D8B0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_PLAY_OFFSET UNITYSDK_OFFSET(0xD00BF40)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SETICON_OFFSET UNITYSDK_OFFSET(0xD00BE30)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SETNUMBER_OFFSET UNITYSDK_OFFSET(0xD00BEE0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD00D900)
#define RPG_CLIENT_PLANETFESFLOATINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD00DDC0)
