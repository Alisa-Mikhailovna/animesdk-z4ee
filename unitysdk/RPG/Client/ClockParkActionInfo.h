...
#define RPG_CLIENT_CLOCKPARKACTIONINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC175170)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_GET_ONCARDACTION_OFFSET UNITYSDK_OFFSET(0xC175C20)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_GET_ONCARDEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0xC175C70)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_GET_ONCARDSUCCESSEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0xC175CC0)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC174FF0)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_REFRESHCARDEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0xC175600)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_SYNCACTION_OFFSET UNITYSDK_OFFSET(0xC1752C0)
#define RPG_CLIENT_CLOCKPARKACTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC175D10)
#define RPG_CLIENT_CLOCKPARKACTIONINFO__SYNCACTIONINTERNAL_OFFSET UNITYSDK_OFFSET(0xC175330)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_77A269AAA926CB22* OnCardActionContainer; // 0x20
		::RPG::Client::ClockParkInstance* _OwnerInstance; // 0x28
