...
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_CHANGEUIRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0xC2AD650)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_METHOD_5_4C088D38C1084C90_OFFSET UNITYSDK_OFFSET(0xC2ADE20)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC2ADA50)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC2AD5F0)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_REVERTUIRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0xC2ADAA0)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xC2AE100)

namespace RPG::Client
{
	inline static constexpr unsigned int DisableUIPostProcessBehaviour_TypeDefinitionIndex = 69455;
