...
#define RPG_CLIENT_BEZIERCURVE_ADDPOINTAT_OFFSET UNITYSDK_OFFSET(0x1A40CF40)
#define RPG_CLIENT_BEZIERCURVE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1A40CE60)
#define RPG_CLIENT_BEZIERCURVE_APPROXIMATELENGTH_OFFSET UNITYSDK_OFFSET(0x1A4109E0)
#define RPG_CLIENT_BEZIERCURVE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A410F70)
#define RPG_CLIENT_BEZIERCURVE_CREATECURVE_OFFSET UNITYSDK_OFFSET(0x1A410B70)
#define RPG_CLIENT_BEZIERCURVE_DRAWCURVE_OFFSET UNITYSDK_OFFSET(0x1A4107C0)
#define RPG_CLIENT_BEZIERCURVE_GETANCHORPOINTREF_OFFSET UNITYSDK_OFFSET(0x1A40D2B0)
#define RPG_CLIENT_BEZIERCURVE_GETANCHORPOINTSREF_OFFSET UNITYSDK_OFFSET(0x1A40D2A0)
#define RPG_CLIENT_BEZIERCURVE_GETANCHORPOINTS_OFFSET UNITYSDK_OFFSET(0x1A40D190)
#define RPG_CLIENT_BEZIERCURVE_GETDERIVATIVEATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A40F450)
#define RPG_CLIENT_BEZIERCURVE_GETDERIVATIVEAT_OFFSET UNITYSDK_OFFSET(0x1A40E6C0)
#define RPG_CLIENT_BEZIERCURVE_GETDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1A40EDD0)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTANDDERIVATIVEATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A4102C0)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTANDDERIVATIVEAT_OFFSET UNITYSDK_OFFSET(0x1A40F7F0)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A40E2D0)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTAT_OFFSET UNITYSDK_OFFSET(0x1A40D390)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x1A40D2E0)
#define RPG_CLIENT_BEZIERCURVE_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A40DBD0)
#define RPG_CLIENT_BEZIERCURVE_GET_BAKECURVERESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A40D750)
#define RPG_CLIENT_BEZIERCURVE_GET_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A411320)
#define RPG_CLIENT_BEZIERCURVE_GET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1A4114F0)
#define RPG_CLIENT_BEZIERCURVE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A411330)
#define RPG_CLIENT_BEZIERCURVE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A40DBA0)
#define RPG_CLIENT_BEZIERCURVE_GET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A40D090)
#define RPG_CLIENT_BEZIERCURVE_GET_SEGMENTLENGTHS_OFFSET UNITYSDK_OFFSET(0x1A40DB70)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_048F2526C99D6AFF_OFFSET UNITYSDK_OFFSET(0x1A40FD50)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_394F35BBA0EE596A_OFFSET UNITYSDK_OFFSET(0x1A411360)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_D37001935D58FD7A_1_OFFSET UNITYSDK_OFFSET(0x1A40EA20)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_D37001935D58FD7A_OFFSET UNITYSDK_OFFSET(0x1A40D780)
#define RPG_CLIENT_BEZIERCURVE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A410F80)
#define RPG_CLIENT_BEZIERCURVE_REMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1A40D100)
#define RPG_CLIENT_BEZIERCURVE_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1A4107B0)
#define RPG_CLIENT_BEZIERCURVE_SET_BAKECURVERESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A411510)
#define RPG_CLIENT_BEZIERCURVE_SET_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A410F60)
#define RPG_CLIENT_BEZIERCURVE_SET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1A411500)
#define RPG_CLIENT_BEZIERCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A411540)
