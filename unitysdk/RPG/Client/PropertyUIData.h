...
#define RPG_CLIENT_PROPERTYUIDATA_GETABILITYTYPE_OFFSET UNITYSDK_OFFSET(0xD26F510)
#define RPG_CLIENT_PROPERTYUIDATA_GET_BASENUM_OFFSET UNITYSDK_OFFSET(0xD26F700)
#define RPG_CLIENT_PROPERTYUIDATA_GET_CHANGENUMVALUE_OFFSET UNITYSDK_OFFSET(0xD26F760)
#define RPG_CLIENT_PROPERTYUIDATA_GET_CHANGENUM_OFFSET UNITYSDK_OFFSET(0xD26F720)
#define RPG_CLIENT_PROPERTYUIDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD26F780)
#define RPG_CLIENT_PROPERTYUIDATA_GET_ISOVERRIDE_OFFSET UNITYSDK_OFFSET(0xD26F7C0)
#define RPG_CLIENT_PROPERTYUIDATA_GET_NAMEID_OFFSET UNITYSDK_OFFSET(0xD26F7A0)
#define RPG_CLIENT_PROPERTYUIDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD26F6E0)
#define RPG_CLIENT_PROPERTYUIDATA_GET_TOTALNUM_OFFSET UNITYSDK_OFFSET(0xD26F740)
#define RPG_CLIENT_PROPERTYUIDATA_INIT_1_OFFSET UNITYSDK_OFFSET(0xD26E840)
#define RPG_CLIENT_PROPERTYUIDATA_INIT_OFFSET UNITYSDK_OFFSET(0xD26DD90)
#define RPG_CLIENT_PROPERTYUIDATA_SET_BASENUM_OFFSET UNITYSDK_OFFSET(0xD26F710)
#define RPG_CLIENT_PROPERTYUIDATA_SET_CHANGENUMVALUE_OFFSET UNITYSDK_OFFSET(0xD26F770)
#define RPG_CLIENT_PROPERTYUIDATA_SET_CHANGENUM_OFFSET UNITYSDK_OFFSET(0xD26F730)
#define RPG_CLIENT_PROPERTYUIDATA_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD26F790)
#define RPG_CLIENT_PROPERTYUIDATA_SET_ISOVERRIDE_OFFSET UNITYSDK_OFFSET(0xD26F7D0)
#define RPG_CLIENT_PROPERTYUIDATA_SET_NAMEID_OFFSET UNITYSDK_OFFSET(0xD26F7B0)
#define RPG_CLIENT_PROPERTYUIDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xD26F6F0)
#define RPG_CLIENT_PROPERTYUIDATA_SET_TOTALNUM_OFFSET UNITYSDK_OFFSET(0xD26F750)
#define RPG_CLIENT_PROPERTYUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD26F7E0)
#define RPG_CLIENT_PROPERTYUIDATA__GETNUMPERCENTSTRING_OFFSET UNITYSDK_OFFSET(0xD26E6A0)
#define RPG_CLIENT_PROPERTYUIDATA__SETCHANGENUM_OFFSET UNITYSDK_OFFSET(0xD26F580)

namespace RPG::Client
{
	inline static constexpr unsigned int PropertyUIData_TypeDefinitionIndex = 69708;
