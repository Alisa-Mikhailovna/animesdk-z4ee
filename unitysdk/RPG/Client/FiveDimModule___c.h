...
#define RPG_CLIENT_FIVEDIMMODULE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC6119A0)
#define RPG_CLIENT_FIVEDIMMODULE___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC6119D0)
#define RPG_CLIENT_FIVEDIMMODULE___C__ONENTERGAME_B__164_0_OFFSET UNITYSDK_OFFSET(0xC6119E0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::FiveDimModule___c**)Il2CppClass::FromTypeDefinitionIndex(FiveDimModule___c_TypeDefinitionIndex)->GetStaticField(0x18CC0);
		}
		static ::System::Action** StaticGet___9__164_0()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(FiveDimModule___c_TypeDefinitionIndex)->GetStaticField(0x18CC8);
		}
