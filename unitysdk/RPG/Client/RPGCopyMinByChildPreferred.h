...
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xD290110)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xD290150)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0xD28FFF0)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0xD290040)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0xD28FF00)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0xD290090)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0xD2900D0)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0xD28FE40)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0xD28FCB0)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0xD28FFA0)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0xD28FF50)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_METHOD_6_C88F24B4C4F38CAF_OFFSET UNITYSDK_OFFSET(0xD28FD70)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED__CTOR_OFFSET UNITYSDK_OFFSET(0xD290190)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGCopyMinByChildPreferred_TypeDefinitionIndex = 69355;
