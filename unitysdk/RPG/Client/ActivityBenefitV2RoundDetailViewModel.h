...
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_ADD_ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0xBAFB500)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_CLAIMREWARD_OFFSET UNITYSDK_OFFSET(0xBAFB2B0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xBAFACE0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBAFB130)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xBAFAB80)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xBAFAA00)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_ISREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0xBAFAC70)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0xBAFAC50)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xBAFAB00)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET__PRIZE_OFFSET UNITYSDK_OFFSET(0xBAFAA10)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_REMOVE_ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0xBAFB560)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_SET_ITEMS_OFFSET UNITYSDK_OFFSET(0xBAFAC60)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBAFAFA0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL__ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0xBAFB450)
