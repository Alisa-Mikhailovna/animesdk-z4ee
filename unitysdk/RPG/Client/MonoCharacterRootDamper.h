...
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_ADDHEIGHT_OFFSET UNITYSDK_OFFSET(0xCC35A50)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_CRITICALSPRINGDAMPERIMPLICIT_OFFSET UNITYSDK_OFFSET(0xCC35BB0)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_HALFLIFETODAMPING_OFFSET UNITYSDK_OFFSET(0xCC35D50)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_RESET_OFFSET UNITYSDK_OFFSET(0xCC35A00)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_UPDATEROOT_OFFSET UNITYSDK_OFFSET(0xCC35AB0)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC35DD0)
