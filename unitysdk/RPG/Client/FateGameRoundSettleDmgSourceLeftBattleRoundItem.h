...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTBATTLEROUNDITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC463BC0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTBATTLEROUNDITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xC463850)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTBATTLEROUNDITEM_GET__DMGFACTORBYLEFTBATTLEROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xC463A90)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTBATTLEROUNDITEM_GET__PHASEROW_OFFSET UNITYSDK_OFFSET(0xC4637F0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTBATTLEROUNDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC463380)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTBATTLEROUNDITEM__GETPHASEFIXEDDAMAGE_OFFSET UNITYSDK_OFFSET(0xC4633A0)
