...
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_GET_CALLBACK_OFFSET UNITYSDK_OFFSET(0xCEE9020)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xCEE9040)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_SET_CALLBACK_OFFSET UNITYSDK_OFFSET(0xCEE9030)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xCEE9050)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCEE8B10)

namespace RPG::Client
{
	inline static constexpr unsigned int OnBackPressedDispatcher_CallbackEntry_TypeDefinitionIndex = 68131;
