...
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_AWAKE_OFFSET UNITYSDK_OFFSET(0xCDC7580)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_1BEAB60076010082_OFFSET UNITYSDK_OFFSET(0xCDC7CE0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_75B0F17F1816A50B_OFFSET UNITYSDK_OFFSET(0xCDC7FE0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCDC78C0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_CF8BA38996D09531_OFFSET UNITYSDK_OFFSET(0xCDC7850)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xCDC79D0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_FAE9C4050544FE63_1_OFFSET UNITYSDK_OFFSET(0xCDC7C20)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_FAE9C4050544FE63_OFFSET UNITYSDK_OFFSET(0xCDC7B60)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_UPDATE_OFFSET UNITYSDK_OFFSET(0xCDC76E0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDC82B0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE___CREATECIRCLEMOTION_B__9_0_OFFSET UNITYSDK_OFFSET(0xCDC82C0)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoUIMarquee_TypeDefinitionIndex = 70139;
