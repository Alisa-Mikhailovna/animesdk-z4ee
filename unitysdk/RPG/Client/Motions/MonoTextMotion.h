...
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_APPLYSHADOWZEROALLOC_OFFSET UNITYSDK_OFFSET(0xCDC5980)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD7E3F0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCD7E370)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_FORCEREDRAW_OFFSET UNITYSDK_OFFSET(0xCD7DAE0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_HASMOTIONNOTFINISH_OFFSET UNITYSDK_OFFSET(0xCD7D840)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_IMMEDIATEFINISHALLMOTIONS_OFFSET UNITYSDK_OFFSET(0xCD7DA60)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_IMMEDIATEFINISHEXITINGMOTIONS_OFFSET UNITYSDK_OFFSET(0xCD7DB30)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xCD7D010)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD7E530)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD7E580)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_PAUSE_OFFSET UNITYSDK_OFFSET(0xCD7E2B0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_RESUME_OFFSET UNITYSDK_OFFSET(0xCD7E2F0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_SHOWTEXTIDWITHMOTIONWITHTYPERTYPE_OFFSET UNITYSDK_OFFSET(0xCD7E200)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_SHOWTEXTIDWITHMOTION_OFFSET UNITYSDK_OFFSET(0xCD7DCF0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_SHOWTEXTWITHMOTION_OFFSET UNITYSDK_OFFSET(0xCD7DB80)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCD7E330)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_UPDATEOUTLINE_OFFSET UNITYSDK_OFFSET(0xCDC55D0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD7E680)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CLEARMOTIONDATA_OFFSET UNITYSDK_OFFSET(0xCDC5570)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATECHARMOTIONINRANGE_OFFSET UNITYSDK_OFFSET(0xCDC3060)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATECHARMOTION_OFFSET UNITYSDK_OFFSET(0xCDC5260)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATENOUSCHARMOTIONINRANGE_OFFSET UNITYSDK_OFFSET(0xCDC6310)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATENOUSCHARMOTION_OFFSET UNITYSDK_OFFSET(0xCDC6DB0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATENOUSRUBYCHARMOTION_1_OFFSET UNITYSDK_OFFSET(0xCDC6FE0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATENOUSRUBYCHARMOTION_OFFSET UNITYSDK_OFFSET(0xCDC66A0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATENOUSTYPERMOTION_OFFSET UNITYSDK_OFFSET(0xCDC2790)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATERSE1CHARMOTIONINRANGE_OFFSET UNITYSDK_OFFSET(0xCDC37D0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATERSE1CHARMOTION_OFFSET UNITYSDK_OFFSET(0xCDC5C00)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATERUBYCHARMOTION_OFFSET UNITYSDK_OFFSET(0xCDC32F0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATETEXTEFFECTMOTION_OFFSET UNITYSDK_OFFSET(0xCDC23C0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATETEXTEXITINGMOTION_OFFSET UNITYSDK_OFFSET(0xCD7EFD0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATETYPERMOTION_OFFSET UNITYSDK_OFFSET(0xCDC2C70)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CREATEWRAPMOTION_OFFSET UNITYSDK_OFFSET(0xCDC3AE0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCDC7250)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__GETLASTLINEBOTTOMPOSY_OFFSET UNITYSDK_OFFSET(0xCDC4750)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__GETLINEBOTTOMPOSY_OFFSET UNITYSDK_OFFSET(0xCDC4C80)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__GETMASKCHARACTERINFO_OFFSET UNITYSDK_OFFSET(0xCDC6120)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__GETRECTBOTTOMPOSY_OFFSET UNITYSDK_OFFSET(0xCDC46E0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__GETSUBSTR_OFFSET UNITYSDK_OFFSET(0xCDC4B80)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__GETTOTALBOTTOMVISIBLECHARCOUNT_OFFSET UNITYSDK_OFFSET(0xCDC5EC0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__GETVISIBLECHARCOUNT_OFFSET UNITYSDK_OFFSET(0xCDC4C10)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__IMMEDIATELYSHOWNEXTSENTENCE_OFFSET UNITYSDK_OFFSET(0xCDC2090)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__MODIFYMESH_B__0_0_OFFSET UNITYSDK_OFFSET(0xCDC7300)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__PARSEVISIBLECHARINDEXTOLINEINDEX_OFFSET UNITYSDK_OFFSET(0xCDC5460)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__PROCESSLINEINFOFORRUBY_OFFSET UNITYSDK_OFFSET(0xCDC53B0)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__PROCESSLINEINFOS_OFFSET UNITYSDK_OFFSET(0xCD7E860)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__PROCESSONELINE_OFFSET UNITYSDK_OFFSET(0xCD7ED90)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__RESETTEXTMOVEMENT_OFFSET UNITYSDK_OFFSET(0xCDC2290)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__SHOWNEXTSENTENCE_OFFSET UNITYSDK_OFFSET(0xCDC2040)
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION__TRYFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xCD7E610)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoTextMotion_TypeDefinitionIndex = 70137;
