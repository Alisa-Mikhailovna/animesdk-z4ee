...
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDTABINFO_GET_QUESTDATALIST_OFFSET UNITYSDK_OFFSET(0xC19ABC0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDTABINFO_GET_TABID_OFFSET UNITYSDK_OFFSET(0xC19ABA0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDTABINFO_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xC19ABB0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDTABINFO_GET_UNLOCKQUEST_OFFSET UNITYSDK_OFFSET(0xC19ABD0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDTABINFO_GET_UNLOCKSCHEDULE_OFFSET UNITYSDK_OFFSET(0xC19ABF0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDTABINFO_REFRESHALLQUESTDATA_OFFSET UNITYSDK_OFFSET(0xC19A8D0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDTABINFO_SET_UNLOCKQUEST_OFFSET UNITYSDK_OFFSET(0xC19ABE0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDTABINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC19AAA0)
