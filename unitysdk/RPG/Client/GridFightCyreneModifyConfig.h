...
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_MODIFYOPS_OFFSET UNITYSDK_OFFSET(0xC6CDF70)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_MODIFYSKILLID_OFFSET UNITYSDK_OFFSET(0xC6CDED0)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_MODIFYSKILLINDEXS_OFFSET UNITYSDK_OFFSET(0xC6CDF20)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_MODIFYVALUES_OFFSET UNITYSDK_OFFSET(0xC6CDFC0)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xC6CE060)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_VALUEKEY_OFFSET UNITYSDK_OFFSET(0xC6CE010)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC6CDEC0)
