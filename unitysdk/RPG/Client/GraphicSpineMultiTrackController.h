...
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_GET_ACTIONLUT_OFFSET UNITYSDK_OFFSET(0xC699D10)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_GET_ANIMATIONSTATE_OFFSET UNITYSDK_OFFSET(0xC699BD0)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0xC699C30)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_GET_SKELETONDATAASSET_OFFSET UNITYSDK_OFFSET(0xC699CB0)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0xC699C50)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC6991C0)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC699740)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_PLAYACTION_OFFSET UNITYSDK_OFFSET(0xC699880)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_SET_ACTIONLUT_OFFSET UNITYSDK_OFFSET(0xC699D20)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER_SET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0xC699C40)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC699D30)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER__LOADACTIONLUT_OFFSET UNITYSDK_OFFSET(0xC6992D0)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER__SETTRACKSWITCHMIX_OFFSET UNITYSDK_OFFSET(0xC699440)
#define RPG_CLIENT_GRAPHICSPINEMULTITRACKCONTROLLER__UNLOADACTIONLUT_OFFSET UNITYSDK_OFFSET(0xC6997F0)
