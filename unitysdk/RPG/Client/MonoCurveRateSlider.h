...
#define RPG_CLIENT_MONOCURVERATESLIDER_PLAYSIMPLIFIED_OFFSET UNITYSDK_OFFSET(0xCC43530)
#define RPG_CLIENT_MONOCURVERATESLIDER_PLAY_OFFSET UNITYSDK_OFFSET(0xCC430E0)
#define RPG_CLIENT_MONOCURVERATESLIDER_REGISTERFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xCC43590)
#define RPG_CLIENT_MONOCURVERATESLIDER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCC435F0)
#define RPG_CLIENT_MONOCURVERATESLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC43860)
#define RPG_CLIENT_MONOCURVERATESLIDER__INIT_OFFSET UNITYSDK_OFFSET(0xCC43140)
#define RPG_CLIENT_MONOCURVERATESLIDER__UPDATECURPOSITION_OFFSET UNITYSDK_OFFSET(0xCC43650)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveRateSlider_TypeDefinitionIndex = 69295;
