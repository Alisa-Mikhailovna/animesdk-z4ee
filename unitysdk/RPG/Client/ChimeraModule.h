...
#define RPG_CLIENT_CHIMERAMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC14FB70)
#define RPG_CLIENT_CHIMERAMODULE_FINISHENDLESSGAME_OFFSET UNITYSDK_OFFSET(0xC14CCE0)
#define RPG_CLIENT_CHIMERAMODULE_FINISHFINALROUND_OFFSET UNITYSDK_OFFSET(0xC14CBB0)
#define RPG_CLIENT_CHIMERAMODULE_FINISHORDINARYROUND_OFFSET UNITYSDK_OFFSET(0xC14C940)
#define RPG_CLIENT_CHIMERAMODULE_GETCHIMERADATA_OFFSET UNITYSDK_OFFSET(0xC14C1F0)
#define RPG_CLIENT_CHIMERAMODULE_GETCURRENTROUNDID_OFFSET UNITYSDK_OFFSET(0xC14BF30)
#define RPG_CLIENT_CHIMERAMODULE_GETWORKIDARRAY_OFFSET UNITYSDK_OFFSET(0xC14BD40)
#define RPG_CLIENT_CHIMERAMODULE_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xC14F130)
#define RPG_CLIENT_CHIMERAMODULE_GET_ARRANGEMENTINFO_OFFSET UNITYSDK_OFFSET(0xC14F2A0)
#define RPG_CLIENT_CHIMERAMODULE_GET_AVATARSELECTQUESTID_OFFSET UNITYSDK_OFFSET(0xC14F1D0)
#define RPG_CLIENT_CHIMERAMODULE_GET_BATTLEVIEW_OFFSET UNITYSDK_OFFSET(0xC14F220)
#define RPG_CLIENT_CHIMERAMODULE_GET_CHIMERAINFO_OFFSET UNITYSDK_OFFSET(0xC14F240)
#define RPG_CLIENT_CHIMERAMODULE_GET_CURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0xC14D170)
#define RPG_CLIENT_CHIMERAMODULE_GET_DOINGROUND_OFFSET UNITYSDK_OFFSET(0xC14F380)
#define RPG_CLIENT_CHIMERAMODULE_GET_ENDLESSMANAGER_OFFSET UNITYSDK_OFFSET(0xC14F320)
#define RPG_CLIENT_CHIMERAMODULE_GET_GALLERYINFO_OFFSET UNITYSDK_OFFSET(0xC14F360)
#define RPG_CLIENT_CHIMERAMODULE_GET_ISINBATTLEEXITTRANSITION_OFFSET UNITYSDK_OFFSET(0xC14F3A0)
#define RPG_CLIENT_CHIMERAMODULE_GET_LIMITACTIVITYREWARDID_OFFSET UNITYSDK_OFFSET(0xC14F180)
#define RPG_CLIENT_CHIMERAMODULE_GET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0xC14F280)
#define RPG_CLIENT_CHIMERAMODULE_GET_RANKMANAGER_OFFSET UNITYSDK_OFFSET(0xC14F300)
#define RPG_CLIENT_CHIMERAMODULE_GET_SETTLEMANAGER_OFFSET UNITYSDK_OFFSET(0xC14F2E0)
#define RPG_CLIENT_CHIMERAMODULE_GET_TALKMANAGER_OFFSET UNITYSDK_OFFSET(0xC14F340)
#define RPG_CLIENT_CHIMERAMODULE_GET_WORKINFO_OFFSET UNITYSDK_OFFSET(0xC14F2C0)
#define RPG_CLIENT_CHIMERAMODULE_GET_WORKROUNDINFO_OFFSET UNITYSDK_OFFSET(0xC14F260)
#define RPG_CLIENT_CHIMERAMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xC14F460)
#define RPG_CLIENT_CHIMERAMODULE_ISENDLESSFAIL_OFFSET UNITYSDK_OFFSET(0xC14C380)
#define RPG_CLIENT_CHIMERAMODULE_ISENDLESSOVER_OFFSET UNITYSDK_OFFSET(0xC14C330)
#define RPG_CLIENT_CHIMERAMODULE_ISINENDLESSMODE_OFFSET UNITYSDK_OFFSET(0xC14C2E0)
#define RPG_CLIENT_CHIMERAMODULE_SENDCHIMERAQUITENDLESSBYPROMISE_OFFSET UNITYSDK_OFFSET(0xC14EF80)
#define RPG_CLIENT_CHIMERAMODULE_SET_ARRANGEMENTINFO_OFFSET UNITYSDK_OFFSET(0xC14F2B0)
#define RPG_CLIENT_CHIMERAMODULE_SET_BATTLEVIEW_OFFSET UNITYSDK_OFFSET(0xC14F230)
#define RPG_CLIENT_CHIMERAMODULE_SET_CHIMERAINFO_OFFSET UNITYSDK_OFFSET(0xC14F250)
#define RPG_CLIENT_CHIMERAMODULE_SET_CURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0xC14D180)
#define RPG_CLIENT_CHIMERAMODULE_SET_DOINGROUND_OFFSET UNITYSDK_OFFSET(0xC14F390)
#define RPG_CLIENT_CHIMERAMODULE_SET_ENDLESSMANAGER_OFFSET UNITYSDK_OFFSET(0xC14F330)
#define RPG_CLIENT_CHIMERAMODULE_SET_GALLERYINFO_OFFSET UNITYSDK_OFFSET(0xC14F370)
#define RPG_CLIENT_CHIMERAMODULE_SET_ISINBATTLEEXITTRANSITION_OFFSET UNITYSDK_OFFSET(0xC14F3F0)
#define RPG_CLIENT_CHIMERAMODULE_SET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0xC14F290)
#define RPG_CLIENT_CHIMERAMODULE_SET_RANKMANAGER_OFFSET UNITYSDK_OFFSET(0xC14F310)
#define RPG_CLIENT_CHIMERAMODULE_SET_SETTLEMANAGER_OFFSET UNITYSDK_OFFSET(0xC14F2F0)
#define RPG_CLIENT_CHIMERAMODULE_SET_TALKMANAGER_OFFSET UNITYSDK_OFFSET(0xC14F350)
#define RPG_CLIENT_CHIMERAMODULE_SET_WORKINFO_OFFSET UNITYSDK_OFFSET(0xC14F2D0)
#define RPG_CLIENT_CHIMERAMODULE_SET_WORKROUNDINFO_OFFSET UNITYSDK_OFFSET(0xC14F270)
#define RPG_CLIENT_CHIMERAMODULE_STARTENDLESSMODE_OFFSET UNITYSDK_OFFSET(0xC14CE20)
#define RPG_CLIENT_CHIMERAMODULE_STARTWORK_OFFSET UNITYSDK_OFFSET(0xC14C4A0)
#define RPG_CLIENT_CHIMERAMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0xC14D190)
#define RPG_CLIENT_CHIMERAMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC150120)
#define RPG_CLIENT_CHIMERAMODULE__GETENDLESSWORKROUNDID_OFFSET UNITYSDK_OFFSET(0xC14C0E0)
#define RPG_CLIENT_CHIMERAMODULE__GETWORKROUNDID_OFFSET UNITYSDK_OFFSET(0xC14BFE0)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERADOFINALROUNDSCRSP_OFFSET UNITYSDK_OFFSET(0xC14E9A0)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERAFINISHENDLESSROUNDSCRSP_OFFSET UNITYSDK_OFFSET(0xC14E370)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERAFINISHROUND_OFFSET UNITYSDK_OFFSET(0xC14DBF0)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERAQUITENDLESSSCRSP_OFFSET UNITYSDK_OFFSET(0xC14E6D0)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERASTARTENDLESSSCRSP_OFFSET UNITYSDK_OFFSET(0xC14E1F0)
#define RPG_CLIENT_CHIMERAMODULE__ONGETDATASCRSP_OFFSET UNITYSDK_OFFSET(0xC14D570)
#define RPG_CLIENT_CHIMERAMODULE__ONMODULEINITREQ_OFFSET UNITYSDK_OFFSET(0xC150010)
#define RPG_CLIENT_CHIMERAMODULE__STARTWORK_OFFSET UNITYSDK_OFFSET(0xC14C5E0)
#define RPG_CLIENT_CHIMERAMODULE__TRYRESOLVEPROMISE_OFFSET UNITYSDK_OFFSET(0xC14D110)
#define RPG_CLIENT_CHIMERAMODULE__UPDATECURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0xC14CFD0)
#define RPG_CLIENT_CHIMERAMODULE__UPDATECURRENTWORKREMAINHP_OFFSET UNITYSDK_OFFSET(0xC14D030)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::ChimeraTeamRankManager* _RankManager_k__BackingField; // 0x18
		::RPG::Client::Prop::ChimeraBattlePuzzleBoard* _BattleView_k__BackingField; // 0x20
		::RPG::Client::ChimeraGalleryInfo* _GalleryInfo_k__BackingField; // 0x28
		::RPG::Client::ChimeraSettleManager* _SettleManager_k__BackingField; // 0x30
		::RPG::Client::ChimeraWorkRoundInfo* _WorkRoundInfo_k__BackingField; // 0x38
		::RPG::Client::ChimeraInfo* _ChimeraInfo_k__BackingField; // 0x40
		::RPG::Client::Promises::Promise_1<::System::UInt32>* _StartEndlessPromise; // 0x48
		::RPG::Client::ChimeraPhaseInfo* _PhaseInfo_k__BackingField; // 0x50
		::RPG::Client::ChimeraWorkInfo* _WorkInfo_k__BackingField; // 0x58
		::RPG::Client::Promises::Promise* _QuitEndlessPromise; // 0x60
		::RPG::Client::Promises::Promise* _FinishFinalRoundPromise; // 0x68
		::RPG::Client::ChimeraTalkManager* _TalkManager_k__BackingField; // 0x70
		::RPG::Client::Promises::Promise* _FinishEndlessRoundPromise; // 0x78
		::RPG::Client::Promises::Promise* _FinishOrdinaryRoundPromise; // 0x80
		::RPG::Client::ChimeraEndlessManager* _EndlessManager_k__BackingField; // 0x88
		::RPG::Client::ChimeraArrangementInfo* _ArrangementInfo_k__BackingField; // 0x90
