...
#define RPG_CLIENT_MOVIEGAMECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCDCB220)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCDCA6E0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODEENTITY_OFFSET UNITYSDK_OFFSET(0xCDCA750)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODE_OFFSET UNITYSDK_OFFSET(0xCDCA330)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETOPERATIONCONFIG_OFFSET UNITYSDK_OFFSET(0xCDCA7B0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETPLAYERSPANCHORPOSITION_OFFSET UNITYSDK_OFFSET(0xCDCA3E0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETSTATISTICS_OFFSET UNITYSDK_OFFSET(0xCDCA670)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xCDC9620)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xCDCABB0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_0C490FF1F071E8D4_OFFSET UNITYSDK_OFFSET(0xCDCC6D0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xCDC9C60)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_361917FE49883C86_OFFSET UNITYSDK_OFFSET(0xCDCC860)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xCDCABF0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_7908E0A3A062534E_OFFSET UNITYSDK_OFFSET(0xCDCC120)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_94CBD0C21A609187_OFFSET UNITYSDK_OFFSET(0xCDCBFA0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xCDCAF80)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_A43D587A89E24E29_OFFSET UNITYSDK_OFFSET(0xCDCC300)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_1_OFFSET UNITYSDK_OFFSET(0xCDCBD20)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_2_OFFSET UNITYSDK_OFFSET(0xCDCBE60)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_OFFSET UNITYSDK_OFFSET(0xCDCBBE0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0xCDCB750)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0xCDCBA70)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xCDC9A20)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E88B764FDB27A464_OFFSET UNITYSDK_OFFSET(0xCDCC440)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_F1D0751A34EC3B37_OFFSET UNITYSDK_OFFSET(0xCDCDBD0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONANYTRIGGERSOUNDEVENT_OFFSET UNITYSDK_OFFSET(0xCDCDD50)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONPLAYERHITSTATE_OFFSET UNITYSDK_OFFSET(0xCDCDE60)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xCDC9DB0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xCDC9EA0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xCDCA810)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TRIGGERPUZZLECUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xCDCDF30)
#define RPG_CLIENT_MOVIEGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCDCDFF0)
