...
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_CONTAINS_OFFSET UNITYSDK_OFFSET(0xC134D10)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_EXPORTDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xC134E20)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_GET_SLOTCOUNT_OFFSET UNITYSDK_OFFSET(0xC134C20)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC134BC0)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA_SYSTEM_ICOMPARABLE_RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA__COMPARETO_OFFSET UNITYSDK_OFFSET(0xC134CE0)
#define RPG_CLIENT_CHIMERADUELMASTERRECOMMENDATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC134CD0)
