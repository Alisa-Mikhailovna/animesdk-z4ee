...
#define RPG_CLIENT_PUSHMESSAGESETTINGS_GET_ENABLEPUSHEXPEDITIONFINISH_OFFSET UNITYSDK_OFFSET(0xD2779C0)
#define RPG_CLIENT_PUSHMESSAGESETTINGS_GET_ENABLEPUSHSTAMINAFULL_OFFSET UNITYSDK_OFFSET(0xD2778A0)
#define RPG_CLIENT_PUSHMESSAGESETTINGS_SET_ENABLEPUSHEXPEDITIONFINISH_OFFSET UNITYSDK_OFFSET(0xD277A40)
#define RPG_CLIENT_PUSHMESSAGESETTINGS_SET_ENABLEPUSHSTAMINAFULL_OFFSET UNITYSDK_OFFSET(0xD277920)
#define RPG_CLIENT_PUSHMESSAGESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xD2777E0)
