...
#define RPG_CLIENT_PAGELISTVIEW_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCF22710)
#define RPG_CLIENT_PAGELISTVIEW_GET_CURRENTPAGEINDEX_OFFSET UNITYSDK_OFFSET(0xCF22CF0)
#define RPG_CLIENT_PAGELISTVIEW_GET_PAGENUM_OFFSET UNITYSDK_OFFSET(0xCF21CB0)
#define RPG_CLIENT_PAGELISTVIEW_MOVETOPAGEBYITEMCHILDNAME_OFFSET UNITYSDK_OFFSET(0xCF22330)
#define RPG_CLIENT_PAGELISTVIEW_MOVETOPAGE_OFFSET UNITYSDK_OFFSET(0xCF22260)
#define RPG_CLIENT_PAGELISTVIEW_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xCF22610)
#define RPG_CLIENT_PAGELISTVIEW_REFRESHALLPAGES_OFFSET UNITYSDK_OFFSET(0xCF22570)
#define RPG_CLIENT_PAGELISTVIEW_SAFEINIT_OFFSET UNITYSDK_OFFSET(0xCF21D00)
#define RPG_CLIENT_PAGELISTVIEW_SETNEARESTCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xCF225C0)
#define RPG_CLIENT_PAGELISTVIEW_SETPAGENUM_OFFSET UNITYSDK_OFFSET(0xCF21EB0)
#define RPG_CLIENT_PAGELISTVIEW__ADDDOTS_OFFSET UNITYSDK_OFFSET(0xCF22B40)
#define RPG_CLIENT_PAGELISTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xCF22D40)
#define RPG_CLIENT_PAGELISTVIEW__GETTARGETSCROLLINDEX_OFFSET UNITYSDK_OFFSET(0xCF229F0)
#define RPG_CLIENT_PAGELISTVIEW__ONDRAGEND_OFFSET UNITYSDK_OFFSET(0xCF227A0)
#define RPG_CLIENT_PAGELISTVIEW__ONSNAPNEARESTCHANGED_OFFSET UNITYSDK_OFFSET(0xCF22AC0)
#define RPG_CLIENT_PAGELISTVIEW__REFRESHDOTS_OFFSET UNITYSDK_OFFSET(0xCF22050)

namespace RPG::Client
{
	inline static constexpr unsigned int PageListView_TypeDefinitionIndex = 69340;
