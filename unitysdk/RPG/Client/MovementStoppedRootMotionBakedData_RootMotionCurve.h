...
#define RPG_CLIENT_MOVEMENTSTOPPEDROOTMOTIONBAKEDDATA_ROOTMOTIONCURVE_GET_PROTECTDISTANCE_OFFSET UNITYSDK_OFFSET(0x14DF30)
#define RPG_CLIENT_MOVEMENTSTOPPEDROOTMOTIONBAKEDDATA_ROOTMOTIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x14DF90)
