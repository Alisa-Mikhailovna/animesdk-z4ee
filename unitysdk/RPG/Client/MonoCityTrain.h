...
#define RPG_CLIENT_MONOCITYTRAIN_ALERT_OFFSET UNITYSDK_OFFSET(0xCC387A0)
#define RPG_CLIENT_MONOCITYTRAIN_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC35E90)
#define RPG_CLIENT_MONOCITYTRAIN_BOOST_OFFSET UNITYSDK_OFFSET(0xCC384B0)
#define RPG_CLIENT_MONOCITYTRAIN_BRAKE_OFFSET UNITYSDK_OFFSET(0xCC38650)
#define RPG_CLIENT_MONOCITYTRAIN_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCC37E30)
#define RPG_CLIENT_MONOCITYTRAIN_GETSLIDEMAXSPEED_OFFSET UNITYSDK_OFFSET(0xCC389F0)
#define RPG_CLIENT_MONOCITYTRAIN_GET_SPEED_OFFSET UNITYSDK_OFFSET(0xCC35E80)
#define RPG_CLIENT_MONOCITYTRAIN_HARDBRAKE_OFFSET UNITYSDK_OFFSET(0xCC386A0)
#define RPG_CLIENT_MONOCITYTRAIN_HIDEHARDBRAKEEFFECT_OFFSET UNITYSDK_OFFSET(0xCC38440)
#define RPG_CLIENT_MONOCITYTRAIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCC36C50)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_078D85152011B919_1_OFFSET UNITYSDK_OFFSET(0xCC361A0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_078D85152011B919_OFFSET UNITYSDK_OFFSET(0xCC36110)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_3B4FCCB1316C6ED8_OFFSET UNITYSDK_OFFSET(0xCC37010)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0xCC39220)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0xCC38F80)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xCC37F50)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_46DF29ACE60986D7_OFFSET UNITYSDK_OFFSET(0xCC38BE0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0xCC37290)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_6CAB718A3750A897_OFFSET UNITYSDK_OFFSET(0xCC38A60)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0xCC39500)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_9D8CB5E47C1952BD_OFFSET UNITYSDK_OFFSET(0xCC392C0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_A5CFA053D190B8E6_OFFSET UNITYSDK_OFFSET(0xCC38F10)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_BE68D528C0C9EE88_OFFSET UNITYSDK_OFFSET(0xCC38CA0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0xCC36780)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_C9F59B9D8CCA4DFF_OFFSET UNITYSDK_OFFSET(0xCC37780)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xCC36B20)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_CC61F5A692F0C75B_OFFSET UNITYSDK_OFFSET(0xCC38510)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xCC39440)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_EE7A41C190351096_OFFSET UNITYSDK_OFFSET(0xCC38E70)
#define RPG_CLIENT_MONOCITYTRAIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCC36380)
#define RPG_CLIENT_MONOCITYTRAIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCC36230)
#define RPG_CLIENT_MONOCITYTRAIN_PLAYCLOSEDOOR_OFFSET UNITYSDK_OFFSET(0xCC38900)
#define RPG_CLIENT_MONOCITYTRAIN_PLAYOPENDOOR_OFFSET UNITYSDK_OFFSET(0xCC387F0)
#define RPG_CLIENT_MONOCITYTRAIN_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xCC39600)
#define RPG_CLIENT_MONOCITYTRAIN_SETWHEELVIEWDISTANCE_OFFSET UNITYSDK_OFFSET(0xCC38110)
#define RPG_CLIENT_MONOCITYTRAIN_SET_SPEED_OFFSET UNITYSDK_OFFSET(0xCC35DE0)
#define RPG_CLIENT_MONOCITYTRAIN_SHOWHARDBRAKEEFFECT_OFFSET UNITYSDK_OFFSET(0xCC38170)
#define RPG_CLIENT_MONOCITYTRAIN_START_OFFSET UNITYSDK_OFFSET(0xCC36500)
#define RPG_CLIENT_MONOCITYTRAIN_STOPLOOPSOUND_OFFSET UNITYSDK_OFFSET(0xCC38750)
#define RPG_CLIENT_MONOCITYTRAIN_TRAVELTOSTATION_OFFSET UNITYSDK_OFFSET(0xCC38700)
#define RPG_CLIENT_MONOCITYTRAIN_UPDATE_OFFSET UNITYSDK_OFFSET(0xCC36A50)
#define RPG_CLIENT_MONOCITYTRAIN__CCTOR_OFFSET UNITYSDK_OFFSET(0xCC397D0)
#define RPG_CLIENT_MONOCITYTRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCC39670)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoCityTrain_TypeDefinitionIndex)->GetStaticField(0xF510);
		}
		static ::System::Int32* StaticGet_Field_5_1()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoCityTrain_TypeDefinitionIndex)->GetStaticField(0xF514);
		}
