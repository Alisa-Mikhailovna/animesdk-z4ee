...
#define RPG_CLIENT_PARTICLESYSTEMPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xCF46A50)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xCF46D00)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_PLAYONPARTICLEBEGIN_OFFSET UNITYSDK_OFFSET(0xCF46D60)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_PLAY_OFFSET UNITYSDK_OFFSET(0xCF46B10)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_SETAUTOPLAY_OFFSET UNITYSDK_OFFSET(0xCF46DB0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_STOP_OFFSET UNITYSDK_OFFSET(0xCF46C90)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xCF46E20)
#define RPG_CLIENT_PARTICLESYSTEMPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xCF46FD0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY__TRYPOSTAUDIO_OFFSET UNITYSDK_OFFSET(0xCF46B80)
