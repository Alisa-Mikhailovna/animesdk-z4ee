...
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_FIRE_OFFSET UNITYSDK_OFFSET(0xD8BD860)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xD8BEF10)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ISFIRED_OFFSET UNITYSDK_OFFSET(0xD8BEF20)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ISHITTED_OFFSET UNITYSDK_OFFSET(0xD8BEF30)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_MOVEFORWARD_OFFSET UNITYSDK_OFFSET(0xD8BD2C0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ONHITCALLBACK_OFFSET UNITYSDK_OFFSET(0xD8BEF60)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ROADMAP_OFFSET UNITYSDK_OFFSET(0xD8BEF40)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_00F6F37852467F62_OFFSET UNITYSDK_OFFSET(0xD8BE300)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_67E5DD3363DCC43E_OFFSET UNITYSDK_OFFSET(0xD8BE830)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_7D3AFE2824353718_OFFSET UNITYSDK_OFFSET(0xD8BEEC0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD8BEE80)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_E5CA75F65C17B667_OFFSET UNITYSDK_OFFSET(0xD8BCD10)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD8BD720)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD8BD6C0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_RAYCAST_OFFSET UNITYSDK_OFFSET(0xD8BDC80)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_RESET_OFFSET UNITYSDK_OFFSET(0xD8BD5B0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_SET_ONHITCALLBACK_OFFSET UNITYSDK_OFFSET(0xD8BEF70)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_SET_ROADMAP_OFFSET UNITYSDK_OFFSET(0xD8BEF50)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_TICK_OFFSET UNITYSDK_OFFSET(0xD8BDB40)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE__CCTOR_OFFSET UNITYSDK_OFFSET(0xD8BEF80)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0xD8BD590)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunProjectile_TypeDefinitionIndex)->GetStaticField(0x564A0);
		}
		static ::Il2CppArray<::UnityEngine::Collider*>** StaticGet_Field_5_1()
		{
			return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunProjectile_TypeDefinitionIndex)->GetStaticField(0x564A8);
		}
