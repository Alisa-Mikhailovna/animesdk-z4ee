...
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_ALIGNRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD5699D0)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_ANIMATION_OFFSET UNITYSDK_OFFSET(0xD56D120)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_BUTTONOBJECT_OFFSET UNITYSDK_OFFSET(0xD56D0C0)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_CACHEANIMATORBUTTON_OFFSET UNITYSDK_OFFSET(0xD569600)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_CACHEANIMATOR_OFFSET UNITYSDK_OFFSET(0xD56D370)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_CACHEDRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD5694C0)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_ITEMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD56D070)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_PREFABINDEX_OFFSET UNITYSDK_OFFSET(0xD568A50)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_USEROBJECTDATA_OFFSET UNITYSDK_OFFSET(0xD56D030)
#define RPG_CLIENT_STATICLISTVIEWITEM_ONNEW_OFFSET UNITYSDK_OFFSET(0xD5695C0)
#define RPG_CLIENT_STATICLISTVIEWITEM_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0xD569710)
#define RPG_CLIENT_STATICLISTVIEWITEM_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xD56C410)
#define RPG_CLIENT_STATICLISTVIEWITEM_SETALIGNRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD56D1D0)
#define RPG_CLIENT_STATICLISTVIEWITEM_SET_PREFABINDEX_OFFSET UNITYSDK_OFFSET(0xD568820)
#define RPG_CLIENT_STATICLISTVIEWITEM_SET_USEROBJECTDATA_OFFSET UNITYSDK_OFFSET(0xD565AA0)
#define RPG_CLIENT_STATICLISTVIEWITEM_START_OFFSET UNITYSDK_OFFSET(0xD56D220)
#define RPG_CLIENT_STATICLISTVIEWITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD56D4B0)
#define RPG_CLIENT_STATICLISTVIEWITEM_UPDATE_OFFSET UNITYSDK_OFFSET(0xD56D320)
#define RPG_CLIENT_STATICLISTVIEWITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD56D6E0)

namespace RPG::Client
{
	inline static constexpr unsigned int StaticListViewItem_TypeDefinitionIndex = 69376;
