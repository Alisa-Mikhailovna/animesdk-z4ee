...
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_MOODDATA_METHOD_1_594EB27689A9970A_OFFSET UNITYSDK_OFFSET(0xBDBD520)
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_MOODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBDBD5F0)
