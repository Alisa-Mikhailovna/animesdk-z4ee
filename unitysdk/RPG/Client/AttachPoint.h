...
#define RPG_CLIENT_ATTACHPOINT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0xBDB2890)
#define RPG_CLIENT_ATTACHPOINT_GET_LOCALSCALE_OFFSET UNITYSDK_OFFSET(0xBDB2940)
#define RPG_CLIENT_ATTACHPOINT_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xBDB2B10)
#define RPG_CLIENT_ATTACHPOINT_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xBDB2AD0)
#define RPG_CLIENT_ATTACHPOINT_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0xBDB28F0)
#define RPG_CLIENT_ATTACHPOINT_SET_LOCALSCALE_OFFSET UNITYSDK_OFFSET(0xBDB2A10)
#define RPG_CLIENT_ATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xBDB2BA0)
