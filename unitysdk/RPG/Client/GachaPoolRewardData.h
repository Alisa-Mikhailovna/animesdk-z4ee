...
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GETRELATEDACTIVITYPANELDATA_OFFSET UNITYSDK_OFFSET(0xC677630)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xC677330)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_ACTIVITYTITLE_OFFSET UNITYSDK_OFFSET(0xC6774D0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_GACHAID_OFFSET UNITYSDK_OFFSET(0xC6772E0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_QUESTDISPLAY_OFFSET UNITYSDK_OFFSET(0xC677260)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_RELATEDAVATARID_OFFSET UNITYSDK_OFFSET(0xC677380)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDBUBBLE_OFFSET UNITYSDK_OFFSET(0xC6771F0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDDESC_OFFSET UNITYSDK_OFFSET(0xC677110)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDQUEST_OFFSET UNITYSDK_OFFSET(0xC676F60)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDTIPS_OFFSET UNITYSDK_OFFSET(0xC677180)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDTITLE_OFFSET UNITYSDK_OFFSET(0xC6770A0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0xC677410)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_ISRELATEDACTIVITYSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0xC6733C0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_ISREWARDTAKEABLE_OFFSET UNITYSDK_OFFSET(0xC673290)
#define RPG_CLIENT_GACHAPOOLREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC676C80)
