...
#define RPG_CLIENT_EVENTTRIGGERLISTENER_VOIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC3F9DD0)
#define RPG_CLIENT_EVENTTRIGGERLISTENER_VOIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC3F9E10)
#define RPG_CLIENT_EVENTTRIGGERLISTENER_VOIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC3F9560)
#define RPG_CLIENT_EVENTTRIGGERLISTENER_VOIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC3F9D50)

namespace RPG::Client
{
	inline static constexpr unsigned int EventTriggerListener_VoidDelegate_TypeDefinitionIndex = 69255;
