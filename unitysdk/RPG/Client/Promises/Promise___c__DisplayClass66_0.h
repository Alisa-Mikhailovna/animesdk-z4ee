...
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS66_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2A1B0)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS66_0__THENRACE_B__0_OFFSET UNITYSDK_OFFSET(0x1AA2B8A0)
