...
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_96563D36EE253EE2_OFFSET UNITYSDK_OFFSET(0xCC66820)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_9A4DCB2B4ADEB8A9_OFFSET UNITYSDK_OFFSET(0xCC671F0)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xCC66EC0)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0xCC67240)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_F70DC5473DF715AD_OFFSET UNITYSDK_OFFSET(0xCC66900)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCC667D0)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCC66740)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xCC668B0)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_START_OFFSET UNITYSDK_OFFSET(0xCC665B0)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xCC66FF0)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCC675D0)
