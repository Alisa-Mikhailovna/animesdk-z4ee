...
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTMANAGER_DRAINPENDINGCOMPLETEEVENTS_OFFSET UNITYSDK_OFFSET(0xC7B87B0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTMANAGER_ENQUEUEPENDINGCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC7B8720)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTMANAGER_GETQUEST_OFFSET UNITYSDK_OFFSET(0xC7B88A0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTMANAGER_GET_HASPENDINGCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC7B8380)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTMANAGER_SETCOLLECTOR_OFFSET UNITYSDK_OFFSET(0xC7B83E0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTMANAGER_SYNC_OFFSET UNITYSDK_OFFSET(0xC7B8A70)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC7B9000)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTMANAGER__ADDORUPDATEPRAYQUEST_OFFSET UNITYSDK_OFFSET(0xC7B8E80)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC7B9160)
