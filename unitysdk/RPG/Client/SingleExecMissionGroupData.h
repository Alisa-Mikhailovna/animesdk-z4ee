...
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_ADDSUBMISSION_OFFSET UNITYSDK_OFFSET(0xD513570)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_DELETESUBMISSION_OFFSET UNITYSDK_OFFSET(0xD513910)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_CURRENTPROGRESS_OFFSET UNITYSDK_OFFSET(0xD513B30)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xD514540)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xD5139A0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_HINTMISSIONLOGICTYPE_OFFSET UNITYSDK_OFFSET(0xD5143A0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0xD5141A0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xD514740)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISSHOWFINISHEFFECT_OFFSET UNITYSDK_OFFSET(0xD513FF0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISSHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0xD513C90)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISUNKNOW_OFFSET UNITYSDK_OFFSET(0xD5147A0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_MINSUBMISSIONIDINPROGRESS_OFFSET UNITYSDK_OFFSET(0xD5148A0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_MISSIONPROGRESSTYPE_OFFSET UNITYSDK_OFFSET(0xD513E40)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_SORTID_OFFSET UNITYSDK_OFFSET(0xD514B60)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_SUBMISSIONSCOUNT_OFFSET UNITYSDK_OFFSET(0xD514CE0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_TOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0xD5139E0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD513530)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__GET_SORTID_B__28_0_OFFSET UNITYSDK_OFFSET(0xD514D30)
