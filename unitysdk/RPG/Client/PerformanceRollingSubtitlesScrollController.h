...
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER_STARTSCROLL_OFFSET UNITYSDK_OFFSET(0xCF5C750)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xCF5C3E0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCF5C490)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCF5C8B0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER__ONSCROLLFINISH_OFFSET UNITYSDK_OFFSET(0xCF5C5C0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER___ONSCROLLFINISH_B__3_0_OFFSET UNITYSDK_OFFSET(0xCF5C8C0)

namespace RPG::Client
{
	inline static constexpr unsigned int PerformanceRollingSubtitlesScrollController_TypeDefinitionIndex = 69543;
