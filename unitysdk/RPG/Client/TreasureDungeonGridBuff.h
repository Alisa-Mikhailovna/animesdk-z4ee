...
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0xD74B4E0)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFROW_OFFSET UNITYSDK_OFFSET(0xD74B450)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFTYPE_OFFSET UNITYSDK_OFFSET(0xD74B500)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFVALUE_OFFSET UNITYSDK_OFFSET(0xD74B4C0)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0xD74B4F0)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SET_BUFFVALUE_OFFSET UNITYSDK_OFFSET(0xD74B4D0)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SYNC_OFFSET UNITYSDK_OFFSET(0xD749540)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xD749530)
