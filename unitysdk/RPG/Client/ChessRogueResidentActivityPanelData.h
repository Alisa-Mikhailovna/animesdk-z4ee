...
#define RPG_CLIENT_CHESSROGUERESIDENTACTIVITYPANELDATA_CREATEBYROW_OFFSET UNITYSDK_OFFSET(0xC101E70)
#define RPG_CLIENT_CHESSROGUERESIDENTACTIVITYPANELDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC101F90)
#define RPG_CLIENT_CHESSROGUERESIDENTACTIVITYPANELDATA_GET_LOCKEDREASON_OFFSET UNITYSDK_OFFSET(0xC1021B0)
#define RPG_CLIENT_CHESSROGUERESIDENTACTIVITYPANELDATA_ISHIDEALLREDDOT_OFFSET UNITYSDK_OFFSET(0xC102170)
#define RPG_CLIENT_CHESSROGUERESIDENTACTIVITYPANELDATA_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0xC102130)
#define RPG_CLIENT_CHESSROGUERESIDENTACTIVITYPANELDATA_ISSHOWNOPASSNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xC1020F0)
#define RPG_CLIENT_CHESSROGUERESIDENTACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xC101FF0)
#define RPG_CLIENT_CHESSROGUERESIDENTACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC101E60)
#define RPG_CLIENT_CHESSROGUERESIDENTACTIVITYPANELDATA__SHOULDSHOWREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xC102050)
