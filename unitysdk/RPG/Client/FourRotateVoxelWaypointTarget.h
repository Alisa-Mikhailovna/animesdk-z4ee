...
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_CREATE_OFFSET UNITYSDK_OFFSET(0xC627130)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_GETBILLBOARDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0xC627040)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_GETTARGETENTITYPOS_OFFSET UNITYSDK_OFFSET(0xC626F30)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0xC626EA0)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0xC626E90)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xC627000)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xC6273E0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _LittleGameEntityID; // 0x28
