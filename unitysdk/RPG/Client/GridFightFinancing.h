...
#define RPG_CLIENT_GRIDFIGHTFINANCING_GET_COINNUM_OFFSET UNITYSDK_OFFSET(0xC705F70)
#define RPG_CLIENT_GRIDFIGHTFINANCING_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xC6ED8B0)
#define RPG_CLIENT_GRIDFIGHTFINANCING_UPDATE_OFFSET UNITYSDK_OFFSET(0xC705F20)
#define RPG_CLIENT_GRIDFIGHTFINANCING__CTOR_OFFSET UNITYSDK_OFFSET(0xC705F10)
