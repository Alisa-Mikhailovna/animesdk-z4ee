...
#define RPG_CLIENT_SCENETRANSFORMANIM_GET_ISUPATEINEDITORMODE_OFFSET UNITYSDK_OFFSET(0xD4D6080)
#define RPG_CLIENT_SCENETRANSFORMANIM_SET_ISUPATEINEDITORMODE_OFFSET UNITYSDK_OFFSET(0xD4D6090)
#define RPG_CLIENT_SCENETRANSFORMANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xD4D60A0)
