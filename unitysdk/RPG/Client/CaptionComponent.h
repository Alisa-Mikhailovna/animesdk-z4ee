...
#define RPG_CLIENT_CAPTIONCOMPONENT_BIND_OFFSET UNITYSDK_OFFSET(0xBF47390)
#define RPG_CLIENT_CAPTIONCOMPONENT_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xBF46EC0)
#define RPG_CLIENT_CAPTIONCOMPONENT_GET__MOVIECONTROLLERFORUI_OFFSET UNITYSDK_OFFSET(0xBF470B0)
#define RPG_CLIENT_CAPTIONCOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBF472A0)
#define RPG_CLIENT_CAPTIONCOMPONENT_REFRESHCAPTION_OFFSET UNITYSDK_OFFSET(0xBF47400)
#define RPG_CLIENT_CAPTIONCOMPONENT_SETCAPTIONCONFIG_OFFSET UNITYSDK_OFFSET(0xBF47340)
#define RPG_CLIENT_CAPTIONCOMPONENT_SETCAPTIONPARAM_OFFSET UNITYSDK_OFFSET(0xBF472F0)
#define RPG_CLIENT_CAPTIONCOMPONENT_TICKCAPTION_OFFSET UNITYSDK_OFFSET(0xBF46740)
#define RPG_CLIENT_CAPTIONCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0xBF466F0)
#define RPG_CLIENT_CAPTIONCOMPONENT__CLOSECAPTION_OFFSET UNITYSDK_OFFSET(0xBF471E0)
#define RPG_CLIENT_CAPTIONCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xBF47470)
#define RPG_CLIENT_CAPTIONCOMPONENT__SETCAPTIONALPHA_OFFSET UNITYSDK_OFFSET(0xBF47230)
#define RPG_CLIENT_CAPTIONCOMPONENT__SHOWCAPTION_OFFSET UNITYSDK_OFFSET(0xBF47130)

namespace RPG::Client
{
	inline static constexpr unsigned int CaptionComponent_TypeDefinitionIndex = 69240;
