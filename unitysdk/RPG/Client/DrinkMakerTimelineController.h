...
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC2DA2A0)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0xC2D9620)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2DA320)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__INITRANDOMSTARTTIME_OFFSET UNITYSDK_OFFSET(0xC2D96C0)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__STARTONRANDOMCLIP_OFFSET UNITYSDK_OFFSET(0xC2DA190)

namespace RPG::Client
{
	inline static constexpr unsigned int DrinkMakerTimelineController_TypeDefinitionIndex = 69457;
