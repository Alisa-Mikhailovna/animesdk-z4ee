...
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GETAUDIENCEMOODMAPCONFIGPATH_OFFSET UNITYSDK_OFFSET(0xBDB87E0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_ID_OFFSET UNITYSDK_OFFSET(0xBDBBF00)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_ISSTARTED_OFFSET UNITYSDK_OFFSET(0xBDBBEF0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_LAYOUTPATH_OFFSET UNITYSDK_OFFSET(0xBDB5CF0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_MEMBERINFO_OFFSET UNITYSDK_OFFSET(0xBDBBF20)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_RENDERERENABLE_OFFSET UNITYSDK_OFFSET(0xBDBBF60)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_STANCEPATH_OFFSET UNITYSDK_OFFSET(0xBDB5D10)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xBDBBF40)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_LOADSAVEDSTATE_OFFSET UNITYSDK_OFFSET(0xBDBBCC0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_1A50841E1CAE02B1_OFFSET UNITYSDK_OFFSET(0xBDB7C90)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_3E17618FA0E6F9B0_OFFSET UNITYSDK_OFFSET(0xBDB7BC0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_3EC6749BD0DFCDFF_OFFSET UNITYSDK_OFFSET(0xBDB5D80)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_3F20CF295C4129C4_OFFSET UNITYSDK_OFFSET(0xBDBADA0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_422C87C2B59A6581_OFFSET UNITYSDK_OFFSET(0xBDB5F20)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_583F22C05CEA8706_OFFSET UNITYSDK_OFFSET(0xBDB8420)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_66DFBEC278B2197F_OFFSET UNITYSDK_OFFSET(0xBDB7F10)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_6C17AD4DF6713163_OFFSET UNITYSDK_OFFSET(0xBDB8920)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_7C6115732D5E6CAB_OFFSET UNITYSDK_OFFSET(0xBDB7D00)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_7F72D3046872B8AC_OFFSET UNITYSDK_OFFSET(0xBDBAF80)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_81BFB84A5077EF23_OFFSET UNITYSDK_OFFSET(0xBDB86A0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_9B97A1AD8285B007_OFFSET UNITYSDK_OFFSET(0xBDBB1F0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_C73CBB2E1F3BBA7B_OFFSET UNITYSDK_OFFSET(0xBDBBE70)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_E5557A57B589524B_OFFSET UNITYSDK_OFFSET(0xBDB8280)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_FB8BD2D3A3A27E57_OFFSET UNITYSDK_OFFSET(0xBDB81D0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_NOTIFYANIMGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0xBDBBA70)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBDB5AD0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_ONLAYOUTLOADED_OFFSET UNITYSDK_OFFSET(0xBDB5D30)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_ONSTANCELOADED_OFFSET UNITYSDK_OFFSET(0xBDB5ED0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_RESTART_OFFSET UNITYSDK_OFFSET(0xBDBB4D0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SAVESTATE_OFFSET UNITYSDK_OFFSET(0xBDBBC70)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SETRENDERERENABLE_OFFSET UNITYSDK_OFFSET(0xBDBB8D0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SET_ID_OFFSET UNITYSDK_OFFSET(0xBDBBF10)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SET_MEMBERINFO_OFFSET UNITYSDK_OFFSET(0xBDBBF30)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xBDBBF50)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_STARTUP_OFFSET UNITYSDK_OFFSET(0xBDBB380)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_TICK_OFFSET UNITYSDK_OFFSET(0xBDBB740)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0xBDBBF80)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xBDBBF70)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(AudienceGroupInstance_TypeDefinitionIndex)->GetStaticField(0x4F650);
		}
