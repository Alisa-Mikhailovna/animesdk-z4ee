...
#define RPG_CLIENT_ASSISTANTTIPSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBDAC9D0)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xBDACC70)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBDACB50)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xBDACD30)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_TIPSRULE_OFFSET UNITYSDK_OFFSET(0xBDACB70)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xBDACC10)
#define RPG_CLIENT_ASSISTANTTIPSDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xBDACB60)
#define RPG_CLIENT_ASSISTANTTIPSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBDACB40)
