...
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC6DAC90)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC6DAAB0)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0xC6DAB00)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_SHORTDESC_OFFSET UNITYSDK_OFFSET(0xC6DABE0)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_SKILLTYPETEXTID_OFFSET UNITYSDK_OFFSET(0xC6DAB70)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC6DAA70)
