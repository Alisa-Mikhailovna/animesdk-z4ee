...
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCCA710)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_PAUSE_OFFSET UNITYSDK_OFFSET(0xCCCAA60)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xCCCA8E0)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xCCCA760)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCCA570)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_RESUMEPAUSE_OFFSET UNITYSDK_OFFSET(0xCCCAAF0)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_SETFORWARDANIMANDBACKWARDANIM_OFFSET UNITYSDK_OFFSET(0xCCCAB80)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND__CTOR_OFFSET UNITYSDK_OFFSET(0xCCCAC10)
