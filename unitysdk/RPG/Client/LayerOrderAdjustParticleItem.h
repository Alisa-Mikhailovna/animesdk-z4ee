...
#define RPG_CLIENT_LAYERORDERADJUSTPARTICLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC9127C0)

namespace RPG::Client
{
	inline static constexpr unsigned int LayerOrderAdjustParticleItem_TypeDefinitionIndex = 69726;
