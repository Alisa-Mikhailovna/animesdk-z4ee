...
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xD733B40)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xD7342A0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xD734A50)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_13D8773148BD1DCD_OFFSET UNITYSDK_OFFSET(0xD737310)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0xD734A90)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xD734AE0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD734780)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_48EE6F8CA58AC368_OFFSET UNITYSDK_OFFSET(0xD734C90)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5587AE4B03E68C58_OFFSET UNITYSDK_OFFSET(0xD7371A0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_62167C28EC14CC63_OFFSET UNITYSDK_OFFSET(0xD7347F0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_6A8EC1C1458586F1_1_OFFSET UNITYSDK_OFFSET(0xD736620)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_6A8EC1C1458586F1_OFFSET UNITYSDK_OFFSET(0xD735E80)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0xD735030)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_A9A50625EA2594BB_OFFSET UNITYSDK_OFFSET(0xD735210)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0xD7370C0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xD737130)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0xD736DC0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD734BB0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xD734BF0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0xD737080)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0xD737640)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD734B70)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xD734C30)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xD737700)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD737690)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0xC2B0);
		}
		static ::System::Int32* StaticGet__StayAnimatorHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0xC2B4);
		}
		static ::System::Int32* StaticGet__CurrentPatrolPointAnimatorHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0xC2B8);
		}
