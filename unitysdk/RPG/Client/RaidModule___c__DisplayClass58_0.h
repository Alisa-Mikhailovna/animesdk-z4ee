...
#define RPG_CLIENT_RAIDMODULE___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD2BE060)
#define RPG_CLIENT_RAIDMODULE___C__DISPLAYCLASS58_0__STARTRAID_B__0_OFFSET UNITYSDK_OFFSET(0xD2C2A40)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::GameCore::RaidConfigType raidType; // 0x2C
