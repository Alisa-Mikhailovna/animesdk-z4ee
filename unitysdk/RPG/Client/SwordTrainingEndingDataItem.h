...
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xD597C60)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xD597D30)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xD598470)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0xD598040)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_QUESTSTATUS_OFFSET UNITYSDK_OFFSET(0xD597F10)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_REWARDITEMS_OFFSET UNITYSDK_OFFSET(0xD5980E0)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_STORYID_OFFSET UNITYSDK_OFFSET(0xD597D50)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_STORYIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xD5981B0)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0xD5982F0)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_STORYUNLOCKDESC_OFFSET UNITYSDK_OFFSET(0xD5983B0)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET_STORYUNLOCKIMAGE_OFFSET UNITYSDK_OFFSET(0xD598250)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET__ENDINGROW_OFFSET UNITYSDK_OFFSET(0xD597DF0)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_GET__STORYROW_OFFSET UNITYSDK_OFFSET(0xD597E50)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0xD597D40)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xD598480)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM_SYNC_OFFSET UNITYSDK_OFFSET(0xD597CE0)
#define RPG_CLIENT_SWORDTRAININGENDINGDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD597CD0)
