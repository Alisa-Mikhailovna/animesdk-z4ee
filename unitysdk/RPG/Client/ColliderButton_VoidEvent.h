...
#define RPG_CLIENT_COLLIDERBUTTON_VOIDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC191CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ColliderButton_VoidEvent_TypeDefinitionIndex = 69244;
