...
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDROOMCOMPTYPEROW_CREATE_OFFSET UNITYSDK_OFFSET(0xD470030)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDROOMCOMPTYPEROW_GET_ROOMCOMPTYPEDATA_OFFSET UNITYSDK_OFFSET(0xD46FFD0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDROOMCOMPTYPEROW_GET_ROWTYPE_OFFSET UNITYSDK_OFFSET(0xD46FF80)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDROOMCOMPTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4700B0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaLegendRoomCompTypeRow_TypeDefinitionIndex = 69589;
