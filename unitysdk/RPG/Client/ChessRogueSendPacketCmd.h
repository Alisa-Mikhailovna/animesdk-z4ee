...
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD_SENDENHANCEROGUEBUFFCSREQ_OFFSET UNITYSDK_OFFSET(0xC102DF0)
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD_SENDGETROGUEBUFFENHANCEINFOSCREQ_OFFSET UNITYSDK_OFFSET(0xC102D30)
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD_SENDPICKROGUEAVATARCSREQ_OFFSET UNITYSDK_OFFSET(0xC102810)
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD_SENDREVIVEROGUEAVATARCSREQ_OFFSET UNITYSDK_OFFSET(0xC102970)
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD__CTOR_OFFSET UNITYSDK_OFFSET(0xC102ED0)
