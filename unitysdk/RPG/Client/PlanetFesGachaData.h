...
#define RPG_CLIENT_PLANETFESGACHADATA_GET_COSTGEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD00EBF0)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_COSTITEMID_OFFSET UNITYSDK_OFFSET(0xD00E0E0)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_CURRENTGEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD00E6D0)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_GACHAITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD00E060)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_GACHAITEMICONPATH_OFFSET UNITYSDK_OFFSET(0xD00E7A0)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_GACHAITEMID_OFFSET UNITYSDK_OFFSET(0xD00E2A0)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_GACHATYPE_OFFSET UNITYSDK_OFFSET(0xD00EC90)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_GEMICONPATH_OFFSET UNITYSDK_OFFSET(0xD00E970)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xD00EC40)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_ISMULTIGACHAUNLOCK_OFFSET UNITYSDK_OFFSET(0xD00E3B0)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xD00E2F0)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_MAXMULTIGACHACOUNT_OFFSET UNITYSDK_OFFSET(0xD00EBA0)
#define RPG_CLIENT_PLANETFESGACHADATA_GET_UNLOCKDESC_OFFSET UNITYSDK_OFFSET(0xD00E4A0)
#define RPG_CLIENT_PLANETFESGACHADATA__CHECKISUNLOCK_OFFSET UNITYSDK_OFFSET(0xD00E360)
#define RPG_CLIENT_PLANETFESGACHADATA__CHECKMULTIGACHAUNLOCK_OFFSET UNITYSDK_OFFSET(0xD00E400)
#define RPG_CLIENT_PLANETFESGACHADATA__CHECKUNLOCKLIST_OFFSET UNITYSDK_OFFSET(0xD00ECE0)
#define RPG_CLIENT_PLANETFESGACHADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD00E010)
#define RPG_CLIENT_PLANETFESGACHADATA__GETGEMICONPATH_OFFSET UNITYSDK_OFFSET(0xD00E9C0)
#define RPG_CLIENT_PLANETFESGACHADATA__GETICONPATH_OFFSET UNITYSDK_OFFSET(0xD00E7F0)
#define RPG_CLIENT_PLANETFESGACHADATA__GETUNLOCKDESC_OFFSET UNITYSDK_OFFSET(0xD00E510)
#define RPG_CLIENT_PLANETFESGACHADATA__SAFEGETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD00E130)
