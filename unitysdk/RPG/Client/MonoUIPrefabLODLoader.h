...
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ADD_ONLOADED_OFFSET UNITYSDK_OFFSET(0xCD3AD60)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ASYNCLOAD_OFFSET UNITYSDK_OFFSET(0xCD3A9F0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD3A850)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCD3ABC0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_GET_ISLOADED_OFFSET UNITYSDK_OFFSET(0xCD3ACF0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_GET_PREFABINSTANCE_OFFSET UNITYSDK_OFFSET(0xCD3AD50)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD3AB10)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_REMOVE_ONLOADED_OFFSET UNITYSDK_OFFSET(0xCD3ADC0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCD3AB70)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__ASYNCLOAD_B__5_0_OFFSET UNITYSDK_OFFSET(0xCD3AE30)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3AE20)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0xCD3AC50)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__GETQUALITYBYGRAPHICSQUALITY_OFFSET UNITYSDK_OFFSET(0xCD3A990)
