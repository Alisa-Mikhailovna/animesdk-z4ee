...
#define RPG_CLIENT_GRIDFIGHTTRAITEQUIPEFFECTUTILS_GETEQUIPSITEMCONFIGS_OFFSET UNITYSDK_OFFSET(0xC847E30)
#define RPG_CLIENT_GRIDFIGHTTRAITEQUIPEFFECTUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0xC848530)
#define RPG_CLIENT_GRIDFIGHTTRAITEQUIPEFFECTUTILS__FINDEFFECTID_OFFSET UNITYSDK_OFFSET(0xC8483E0)
#define RPG_CLIENT_GRIDFIGHTTRAITEQUIPEFFECTUTILS__FINDEFFECTLAYERCONFIG_OFFSET UNITYSDK_OFFSET(0xC848070)
#define RPG_CLIENT_GRIDFIGHTTRAITEQUIPEFFECTUTILS__FINDMAXLAYER_OFFSET UNITYSDK_OFFSET(0xC8480F0)
