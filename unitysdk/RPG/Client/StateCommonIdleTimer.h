...
#define RPG_CLIENT_STATECOMMONIDLETIMER_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD55A470)
#define RPG_CLIENT_STATECOMMONIDLETIMER_METHOD_4_46E2A9A897493A5F_OFFSET UNITYSDK_OFFSET(0xD55A000)
#define RPG_CLIENT_STATECOMMONIDLETIMER_METHOD_4_5A0484A55720CCC6_OFFSET UNITYSDK_OFFSET(0xD55A1C0)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xD55A340)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xD55A4D0)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEIK_OFFSET UNITYSDK_OFFSET(0xD55A710)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEMOVE_OFFSET UNITYSDK_OFFSET(0xD55A6A0)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD55A590)
#define RPG_CLIENT_STATECOMMONIDLETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0xD55A780)
