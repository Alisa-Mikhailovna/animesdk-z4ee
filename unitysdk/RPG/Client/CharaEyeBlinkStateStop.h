...
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xBFC9CF0)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xBFC9D80)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBFC9D40)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_TICK_OFFSET UNITYSDK_OFFSET(0xBFC9DC0)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP__CTOR_OFFSET UNITYSDK_OFFSET(0xBFC9E20)
