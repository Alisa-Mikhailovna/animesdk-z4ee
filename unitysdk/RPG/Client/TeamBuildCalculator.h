...
#define RPG_CLIENT_TEAMBUILDCALCULATOR_CHECKDATAISVALID_OFFSET UNITYSDK_OFFSET(0xD6354A0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR_GETTEAMBUILDASSOCIATION_OFFSET UNITYSDK_OFFSET(0xD6322E0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR_GETTEAMBUILDCANDIDATEPOOLASSOCIATION_OFFSET UNITYSDK_OFFSET(0xD633560)
#define RPG_CLIENT_TEAMBUILDCALCULATOR_GETTEAMBUILDPRIORITIZEDASSOCIATION_OFFSET UNITYSDK_OFFSET(0xD633160)
#define RPG_CLIENT_TEAMBUILDCALCULATOR_GETTEAMBUILDSYNOPSIS_OFFSET UNITYSDK_OFFSET(0xD634260)
#define RPG_CLIENT_TEAMBUILDCALCULATOR_GETTEAMBUILDS_OFFSET UNITYSDK_OFFSET(0xD631F30)
#define RPG_CLIENT_TEAMBUILDCALCULATOR_GET_MAXTEAMBUILDSYNOPSISCOUNT_OFFSET UNITYSDK_OFFSET(0xD631770)
#define RPG_CLIENT_TEAMBUILDCALCULATOR_REFRESH_OFFSET UNITYSDK_OFFSET(0xD6318C0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__ADDTEAMBUILDRECIPE_OFFSET UNITYSDK_OFFSET(0xD636960)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__BUILDTEAMBUILDCANDIDATEPOOLFROMCONFIG_OFFSET UNITYSDK_OFFSET(0xD635CA0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__BUILDTEAMBUILDRECIPEFROMBIGDATA_OFFSET UNITYSDK_OFFSET(0xD635F20)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__BUILDTEAMBUILDRECIPEFROMCONFIG_OFFSET UNITYSDK_OFFSET(0xD635A10)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__BUILDTEAMBUILDRECIPES_OFFSET UNITYSDK_OFFSET(0xD6357A0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__CHECKHASUNRELEASEDAVATARCHANGED_OFFSET UNITYSDK_OFFSET(0xD6358C0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__CLEARDATA_OFFSET UNITYSDK_OFFSET(0xD631AD0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD6374B0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__ENSURERESULTCOUNT_OFFSET UNITYSDK_OFFSET(0xD633090)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__FILLTEAMBUILDRESULTS_OFFSET UNITYSDK_OFFSET(0xD633850)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__FILLWITHALTERNATIVEAVATARS_OFFSET UNITYSDK_OFFSET(0xD633430)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__FILLWITHMAINAVATARS_OFFSET UNITYSDK_OFFSET(0xD633270)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__GETCANDIDATEPOOLS_OFFSET UNITYSDK_OFFSET(0xD632D10)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__GETTEAMBUILDCANDIDATEPOOLASSOCIATION_B__19_0_OFFSET UNITYSDK_OFFSET(0xD637750)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__GETTEAMBUILDSYNOPSIS_B__25_0_OFFSET UNITYSDK_OFFSET(0xD637780)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__GETUSINGTEAMBUILDRECIPE_OFFSET UNITYSDK_OFFSET(0xD632220)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__HASAVATARCHECKER_OFFSET UNITYSDK_OFFSET(0xD6373B0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__PREPARERECOMMENDLINEUPDATA_OFFSET UNITYSDK_OFFSET(0xD631BD0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__PREPARETEAMBUILDRECIPE_OFFSET UNITYSDK_OFFSET(0xD6355F0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__PREPAREUNRELEASEDAVATARDATA_OFFSET UNITYSDK_OFFSET(0xD631DB0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__TRUECHECKER_OFFSET UNITYSDK_OFFSET(0xD637470)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__TRYGETTEAMMATEAVATARID_OFFSET UNITYSDK_OFFSET(0xD6346C0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR__UPDATEUNRELEASEDAVATARIDS_OFFSET UNITYSDK_OFFSET(0xD635930)
#define RPG_CLIENT_TEAMBUILDCALCULATOR___PREPARERECOMMENDLINEUPDATA_B__27_0_OFFSET UNITYSDK_OFFSET(0xD637800)
#define RPG_CLIENT_TEAMBUILDCALCULATOR___PREPARERECOMMENDLINEUPDATA_B__27_1_OFFSET UNITYSDK_OFFSET(0xD637B40)
#define RPG_CLIENT_TEAMBUILDCALCULATOR___PREPARETEAMBUILDRECIPE_B__30_0_OFFSET UNITYSDK_OFFSET(0xD637BC0)
#define RPG_CLIENT_TEAMBUILDCALCULATOR___PREPAREUNRELEASEDAVATARDATA_B__28_0_OFFSET UNITYSDK_OFFSET(0xD637BB0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_185A388C9275732B* _TeamBuildSynopsisBuilder; // 0x10
		...
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _RecommendAvatarIDs; // 0x28
		...
		::Class_1_704E3DFA89A430C4* _TeamBuildBuilder; // 0x38
		...
		::System::Collections::Generic::List_1<::Class_1_10F56A639581CEB1*>* _RecommendLineups; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_93D6797E7CD6923E*>* _TeamBuildCandidatePoolDict; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::List_1<::RPG::Client::TeamBuildRecipe*>*>* _ConfigTeamBuildRecipeDict; // 0x58
