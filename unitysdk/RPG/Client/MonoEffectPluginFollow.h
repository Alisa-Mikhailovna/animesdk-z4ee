...
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCBC5E0)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCBC780)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCBC4D0)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xCCBC850)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xCCBCC40)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xCCBC3D0)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_METHOD_6_0DF420E95D6252BE_1_OFFSET UNITYSDK_OFFSET(0xCCBCBE0)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_METHOD_6_0DF420E95D6252BE_OFFSET UNITYSDK_OFFSET(0xCCBCB20)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_METHOD_6_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0xCCBC980)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_METHOD_6_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0xCCBC9E0)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_METHOD_6_1D4018D4200358D0_3_OFFSET UNITYSDK_OFFSET(0xCCBCA40)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_METHOD_6_1D4018D4200358D0_4_OFFSET UNITYSDK_OFFSET(0xCCBCB80)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_METHOD_6_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xCCBC930)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_METHOD_6_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xCCBCAA0)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCBC410)
#define RPG_CLIENT_MONOEFFECTPLUGINFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0xCCBCC50)
