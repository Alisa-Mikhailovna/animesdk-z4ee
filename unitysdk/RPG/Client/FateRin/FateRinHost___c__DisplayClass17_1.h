...
#define RPG_CLIENT_FATERIN_FATERINHOST___C__DISPLAYCLASS17_1__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D1BD0)
#define RPG_CLIENT_FATERIN_FATERINHOST___C__DISPLAYCLASS17_1__SHOWCARDREWARDREPLACEDIALOG_B__1_OFFSET UNITYSDK_OFFSET(0xC4D1BE0)
#define RPG_CLIENT_FATERIN_FATERINHOST___C__DISPLAYCLASS17_1__SHOWCARDREWARDREPLACEDIALOG_B__2_OFFSET UNITYSDK_OFFSET(0xC4D1C50)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int FateRinHost___c__DisplayClass17_1_TypeDefinitionIndex = 75570;
