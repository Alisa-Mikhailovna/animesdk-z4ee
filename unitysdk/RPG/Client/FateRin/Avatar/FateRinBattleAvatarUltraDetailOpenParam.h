...
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM_GET_BORDERTRANS_OFFSET UNITYSDK_OFFSET(0xC478190)
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xC478160)
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM_SET_BORDERTRANS_OFFSET UNITYSDK_OFFSET(0xC4781A0)
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0xC478180)
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC4781B0)

namespace RPG::Client::FateRin::Avatar
{
	inline static constexpr unsigned int FateRinBattleAvatarUltraDetailOpenParam_TypeDefinitionIndex = 76278;
