...
#define RPG_CLIENT_FATERIN_FATERINEXTRAEFFECTVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC4CDED0)
#define RPG_CLIENT_FATERIN_FATERINEXTRAEFFECTVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC4CDE70)
#define RPG_CLIENT_FATERIN_FATERINEXTRAEFFECTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4CDDF0)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int FateRinExtraEffectViewModel_TypeDefinitionIndex = 75670;
