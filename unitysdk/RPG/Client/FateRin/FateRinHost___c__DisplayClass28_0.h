...
#define RPG_CLIENT_FATERIN_FATERINHOST___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D09B0)
#define RPG_CLIENT_FATERIN_FATERINHOST___C__DISPLAYCLASS28_0__PLAYEASTEREGGPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0xC4D2040)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int FateRinHost___c__DisplayClass28_0_TypeDefinitionIndex = 75573;
