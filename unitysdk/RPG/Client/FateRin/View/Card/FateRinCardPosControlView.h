...
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GETCARDHEIGHT_OFFSET UNITYSDK_OFFSET(0xC5ADA50)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GET_EVENTTRIGGERNODE_OFFSET UNITYSDK_OFFSET(0xC5A35E0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GET_HANDCARDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC5A1BB0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GET_OFFSETNODE_OFFSET UNITYSDK_OFFSET(0xC5ACD70)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GET_ROOT_OFFSET UNITYSDK_OFFSET(0xC59C1F0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_PLAYFLYIN_OFFSET UNITYSDK_OFFSET(0xC5A12B0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_PLAYREFLOW_OFFSET UNITYSDK_OFFSET(0xC5AD180)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_PLAYRETURNFROMFREECARD_OFFSET UNITYSDK_OFFSET(0xC5AD610)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_RESETTOIDLE_OFFSET UNITYSDK_OFFSET(0xC5AD800)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_SETEVENTTRIGGEROFFSET_OFFSET UNITYSDK_OFFSET(0xC5AD950)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_SETHANDCARDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC5ACDB0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_SETOFFSETNODEWORLDPOSE_OFFSET UNITYSDK_OFFSET(0xC5ADAC0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_SETROOTLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC59BFF0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_WORLDTOOFFSETLOCAL_OFFSET UNITYSDK_OFFSET(0xC5A10F0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__CANCELCURRENTKEEPVISUALPOS_OFFSET UNITYSDK_OFFSET(0xC5AD100)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC5ADC70)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__ENTERMOTIONWITHSTRATEGY_OFFSET UNITYSDK_OFFSET(0xC5ACE50)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__ONMOTIONFINISHED_OFFSET UNITYSDK_OFFSET(0xC5ADC00)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__REBUILDCURRENTSTRATEGY_OFFSET UNITYSDK_OFFSET(0xC5AD310)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__WRITERETURNSTARTPOSE_OFFSET UNITYSDK_OFFSET(0xC5AD6E0)

namespace RPG::Client::FateRin::View::Card
{
	inline static constexpr unsigned int FateRinCardPosControlView_TypeDefinitionIndex = 75686;
