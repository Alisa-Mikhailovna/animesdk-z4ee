...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_GETCARDPOSCONTROL_OFFSET UNITYSDK_OFFSET(0xC4E7F90)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_INITLAYOUTPARAMS_OFFSET UNITYSDK_OFFSET(0xC4E7890)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_PLAYCARDUNSELECTANIMFROMPOS_OFFSET UNITYSDK_OFFSET(0xC4E80C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_REFLOWHANDCARDS_OFFSET UNITYSDK_OFFSET(0xC4E7DE0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_SETCARDS_OFFSET UNITYSDK_OFFSET(0xC4E7A90)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_SETINTERACTIONSTATE_OFFSET UNITYSDK_OFFSET(0xC4E7C10)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__BUILDANGLES_OFFSET UNITYSDK_OFFSET(0xC4E9040)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__BUILDFILTEREDLAYOUTENTRIES_OFFSET UNITYSDK_OFFSET(0xC4E92A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__BUILDREFLOWLAYOUTENTRIES_OFFSET UNITYSDK_OFFSET(0xC4E84E0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__CALCANGLESTEPFORCOUNT_OFFSET UNITYSDK_OFFSET(0xC4E95D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__COLLECTACTIVECARDS_OFFSET UNITYSDK_OFFSET(0xC4E8D10)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__COMPUTESPREADOFFSETBYSLOTDISTANCE_OFFSET UNITYSDK_OFFSET(0xC59C260)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0xC59C310)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__FINDCARDBYVM_OFFSET UNITYSDK_OFFSET(0xC4E8340)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__FINDCARDSLOT_OFFSET UNITYSDK_OFFSET(0xC4E91F0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__GETCARDTRANSFORMBYANGLE_OFFSET UNITYSDK_OFFSET(0xC59BD60)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__GETCURRENTCARDVM_OFFSET UNITYSDK_OFFSET(0xC4E7D70)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__HASEXCLUDEDCARD_OFFSET UNITYSDK_OFFSET(0xC4E8C50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISCARDINPRELAYOUT_OFFSET UNITYSDK_OFFSET(0xC4E9540)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISCARDSKIPLAYOUT_OFFSET UNITYSDK_OFFSET(0xC4E8A70)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISEXCLUDEDCARD_OFFSET UNITYSDK_OFFSET(0xC4E8B00)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISSAMEHANDVM_OFFSET UNITYSDK_OFFSET(0xC4E8BC0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISVALIDCARDINDEX_OFFSET UNITYSDK_OFFSET(0xC4E8060)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__REFRESHLAYERORDER_OFFSET UNITYSDK_OFFSET(0xC4E7AF0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__SETCARDPOSBYANGLE_OFFSET UNITYSDK_OFFSET(0xC59BC80)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleHudHandCardLayout_TypeDefinitionIndex = 75712;
