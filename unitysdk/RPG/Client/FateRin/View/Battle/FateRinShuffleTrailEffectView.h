...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINSHUFFLETRAILEFFECTVIEW_METHOD_5_078D85152011B919_1_OFFSET UNITYSDK_OFFSET(0xC5AA870)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINSHUFFLETRAILEFFECTVIEW_METHOD_5_078D85152011B919_OFFSET UNITYSDK_OFFSET(0xC5AA7E0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINSHUFFLETRAILEFFECTVIEW_METHOD_5_BF93C93F570E4D30_OFFSET UNITYSDK_OFFSET(0xC5AA6F0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINSHUFFLETRAILEFFECTVIEW_METHOD_5_D0F7E0CB5C46E8D1_OFFSET UNITYSDK_OFFSET(0xC5AA0C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINSHUFFLETRAILEFFECTVIEW_PLAYSHUFFLEFLOW_OFFSET UNITYSDK_OFFSET(0xC5A9AF0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINSHUFFLETRAILEFFECTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC5AA900)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinShuffleTrailEffectView_TypeDefinitionIndex = 75741;
