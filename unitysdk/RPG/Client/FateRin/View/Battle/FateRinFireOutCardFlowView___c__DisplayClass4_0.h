...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINFIREOUTCARDFLOWVIEW___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC5A98F0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINFIREOUTCARDFLOWVIEW___C__DISPLAYCLASS4_0___PLAYFIREOUTFLOW_B__0_OFFSET UNITYSDK_OFFSET(0xC5A9920)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinFireOutCardFlowView___c__DisplayClass4_0_TypeDefinitionIndex = 75737;
