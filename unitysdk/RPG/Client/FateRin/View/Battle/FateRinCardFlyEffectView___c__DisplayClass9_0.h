...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC5A16B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW___C__DISPLAYCLASS9_0__SCHEDULEAFTERDELAY_B__0_OFFSET UNITYSDK_OFFSET(0xC5A1770)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinCardFlyEffectView___c__DisplayClass9_0_TypeDefinitionIndex = 75718;
