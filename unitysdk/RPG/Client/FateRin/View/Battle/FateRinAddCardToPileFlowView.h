...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_2607E22D710FF025_OFFSET UNITYSDK_OFFSET(0xC4E30C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_341A3DF81C331CBB_OFFSET UNITYSDK_OFFSET(0xC4E2F70)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_52B6C8E3328F0DD1_OFFSET UNITYSDK_OFFSET(0xC4E0D00)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_64587FE21067DFC1_OFFSET UNITYSDK_OFFSET(0xC4E2350)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_73897A3F6F629112_OFFSET UNITYSDK_OFFSET(0xC4E3240)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_7FFA59D764841066_OFFSET UNITYSDK_OFFSET(0xC4E2200)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_864765D5C3A0F56E_OFFSET UNITYSDK_OFFSET(0xC4E2E00)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_8EC1D6F2D4E5DAC8_OFFSET UNITYSDK_OFFSET(0xC4E2590)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_9DF4AE18A27A14EC_OFFSET UNITYSDK_OFFSET(0xC4E24A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_9E990ADBDFDA373F_OFFSET UNITYSDK_OFFSET(0xC4E3860)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_B80FCB706F7045BB_OFFSET UNITYSDK_OFFSET(0xC4E3580)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_BE4C0A9B4FEBEC5B_OFFSET UNITYSDK_OFFSET(0xC4E3450)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_C7234EB4F5BB9CC8_OFFSET UNITYSDK_OFFSET(0xC4E2B00)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_E3C78D781491783F_OFFSET UNITYSDK_OFFSET(0xC4E3510)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_PLAYADDCARDTODISCARDPILEFLOW_OFFSET UNITYSDK_OFFSET(0xC4E1970)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_PLAYADDCARDTODRAWPILEFLOW_OFFSET UNITYSDK_OFFSET(0xC4E0C00)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_PLAYPROJECTIONREPLICATEFLOW_OFFSET UNITYSDK_OFFSET(0xC4E1A60)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC4E3B30)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinAddCardToPileFlowView_TypeDefinitionIndex = 75698;
