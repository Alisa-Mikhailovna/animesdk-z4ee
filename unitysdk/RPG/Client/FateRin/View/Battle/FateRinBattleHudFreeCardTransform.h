...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_GETCARDWORLDPOS_OFFSET UNITYSDK_OFFSET(0xC4E6AE0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_GETCARDWORLDROTATION_OFFSET UNITYSDK_OFFSET(0xC4E6B90)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_GETCARDWORLDWIDTH_OFFSET UNITYSDK_OFFSET(0xC4E6C80)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_INIT_OFFSET UNITYSDK_OFFSET(0xC4E6570)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC4E60B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_REFRESHSTATEANDPOS_OFFSET UNITYSDK_OFFSET(0xC4E6610)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_SETCARDINDECKPOS_OFFSET UNITYSDK_OFFSET(0xC4E6D50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_SETCARDSIZEREFNODE_OFFSET UNITYSDK_OFFSET(0xC4E6C30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__BEGINEASEWITHSOURCE_OFFSET UNITYSDK_OFFSET(0xC4E7290)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__BEGINEASE_OFFSET UNITYSDK_OFFSET(0xC4E7680)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__COMPUTELARGEWORLDHALFHEIGHT_OFFSET UNITYSDK_OFFSET(0xC4E74D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xC4E7880)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xC4E6730)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__EXITSTATE_OFFSET UNITYSDK_OFFSET(0xC4E66B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__GETCENTERANCHORSPACE_OFFSET UNITYSDK_OFFSET(0xC4E7060)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__GETCENTERANCHOR_OFFSET UNITYSDK_OFFSET(0xC4E70F0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__GETCURRENTCARDLOGICALWORLDPOS_OFFSET UNITYSDK_OFFSET(0xC4E7390)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__GETLARGESCALE_OFFSET UNITYSDK_OFFSET(0xC4E7210)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__REFRESHEASETARGETFORCURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xC4E6230)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__REFRESHTARGETINGCURVE_OFFSET UNITYSDK_OFFSET(0xC4E6400)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__SETCARDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC4E6300)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__UPDATESTATE_OFFSET UNITYSDK_OFFSET(0xC4E6A00)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleHudFreeCardTransform_TypeDefinitionIndex = 75711;
