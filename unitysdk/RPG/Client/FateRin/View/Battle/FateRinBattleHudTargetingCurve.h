...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDTARGETINGCURVE_METHOD_5_55157FBA4997D865_OFFSET UNITYSDK_OFFSET(0xC59FD80)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDTARGETINGCURVE_SETPOINTS_OFFSET UNITYSDK_OFFSET(0xC59F7E0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDTARGETINGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC5A05D0)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleHudTargetingCurve_TypeDefinitionIndex = 75715;
