...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4E3420)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW___C__DISPLAYCLASS15_0___CREATEADDCARDANIMATORPLAYACTIONCOMMAND_B__0_OFFSET UNITYSDK_OFFSET(0xC4E3D10)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinAddCardToPileFlowView___c__DisplayClass15_0_TypeDefinitionIndex = 75703;
	...
	public:
		...
		::System::Object* negativeEffectOwner; // 0x28
