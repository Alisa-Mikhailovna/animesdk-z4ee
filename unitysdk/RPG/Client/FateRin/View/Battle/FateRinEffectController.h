...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_CANCELALLFOR_OFFSET UNITYSDK_OFFSET(0xC5A7A00)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC5A7160)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC5A6F50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC5A8D50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYCARDFADEAWAYOUTTRAIL_OFFSET UNITYSDK_OFFSET(0xC5A7780)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYCOINEFFECT_OFFSET UNITYSDK_OFFSET(0xC5A7C90)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYNEGATIVEADDCARDSIDEEFFECTS_OFFSET UNITYSDK_OFFSET(0xC5A78F0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYTRAIL_OFFSET UNITYSDK_OFFSET(0xC5A73D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_SETCOINEFFECTPAUSEFOR_OFFSET UNITYSDK_OFFSET(0xC5A8470)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__ADDACTIVEEFFECT_OFFSET UNITYSDK_OFFSET(0xC5A7FA0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__ADDACTIVETRAIL_OFFSET UNITYSDK_OFFSET(0xC5A7720)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__CANCELALLINTERNAL_OFFSET UNITYSDK_OFFSET(0xC5A71D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC5A8DD0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__ONTRAILNATURALCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC5A8BC0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__PLAYCOINFADEIN_OFFSET UNITYSDK_OFFSET(0xC5A81A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__PLAYCOINFADEOUT_OFFSET UNITYSDK_OFFSET(0xC5A8940)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SETANIMATIONSTATESPEED_OFFSET UNITYSDK_OFFSET(0xC5A8B20)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SETCOINANIMATIONSPEED_OFFSET UNITYSDK_OFFSET(0xC5A8730)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SETFRONTCOINTIPS_OFFSET UNITYSDK_OFFSET(0xC5A7E30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SPAWNPOSITIONEFFECT_OFFSET UNITYSDK_OFFSET(0xC5A7BB0)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinEffectController_TypeDefinitionIndex = 75732;
