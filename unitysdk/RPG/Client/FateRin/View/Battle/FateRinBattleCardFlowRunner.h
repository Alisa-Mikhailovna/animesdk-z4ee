...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_CANCELALLFLOWS_OFFSET UNITYSDK_OFFSET(0xC4E4AE0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_CANCELPROJECTIONREPLICATEFLOW_OFFSET UNITYSDK_OFFSET(0xC4E53D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC4E4A90)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_GET_ADDCARDTOHANDSPAWNANCHOR_OFFSET UNITYSDK_OFFSET(0xC4E4D10)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_GET__AUDIOSERVICE_OFFSET UNITYSDK_OFFSET(0xC4E4E90)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_INIT_OFFSET UNITYSDK_OFFSET(0xC4E4A50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYADDCARDTODISCARDPILEFLOW_OFFSET UNITYSDK_OFFSET(0xC4E5740)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYADDCARDTODRAWPILEFLOW_OFFSET UNITYSDK_OFFSET(0xC4E5670)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYADDCARDTOHANDFLOW_OFFSET UNITYSDK_OFFSET(0xC4E50C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYDISCARDFLOWFROMWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xC4E59B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYDISCARDFLOW_OFFSET UNITYSDK_OFFSET(0xC4E5830)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYDRAWFLOW_OFFSET UNITYSDK_OFFSET(0xC4E4D80)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYFIREOUTFLOWFROMWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xC4E5D30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYFIREOUTFLOW_OFFSET UNITYSDK_OFFSET(0xC4E5C20)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYPROJECTIONREPLICATEFLOW_OFFSET UNITYSDK_OFFSET(0xC4E5280)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYSHUFFLEFLOW_OFFSET UNITYSDK_OFFSET(0xC4E5F20)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYSTACKABLEADDCARDTOHANDFLOW_OFFSET UNITYSDK_OFFSET(0xC4E51A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER__CTOR_OFFSET UNITYSDK_OFFSET(0xC4E5FF0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER__TRACK_OFFSET UNITYSDK_OFFSET(0xC4E4F20)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER__UNTRACK_OFFSET UNITYSDK_OFFSET(0xC4E5540)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleCardFlowRunner_TypeDefinitionIndex = 75708;
