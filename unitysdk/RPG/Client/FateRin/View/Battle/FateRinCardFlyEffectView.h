...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_CANCELALL_OFFSET UNITYSDK_OFFSET(0xC5A16C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0xC5A0EE0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_METHOD_5_D41F2EAAA87E2BFD_OFFSET UNITYSDK_OFFSET(0xC5A11D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_PLAYDRAWFLY_OFFSET UNITYSDK_OFFSET(0xC5A0F80)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_SCHEDULEAFTERDELAY_OFFSET UNITYSDK_OFFSET(0xC5A14D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC5A1710)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinCardFlyEffectView_TypeDefinitionIndex = 75717;
