...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4E53C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER___C__DISPLAYCLASS15_0__PLAYPROJECTIONREPLICATEFLOW_B__0_OFFSET UNITYSDK_OFFSET(0xC4E6040)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleCardFlowRunner___c__DisplayClass15_0_TypeDefinitionIndex = 75709;
