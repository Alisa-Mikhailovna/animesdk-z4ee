...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_CARDLAYOUTENTRY_GET_ANGLE_OFFSET UNITYSDK_OFFSET(0xD510)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_CARDLAYOUTENTRY_GET_CARD_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_CARDLAYOUTENTRY_GET_SPREADOFFSET_OFFSET UNITYSDK_OFFSET(0x263A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_CARDLAYOUTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x149AF0)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleHudHandCardLayout_CardLayoutEntry_TypeDefinitionIndex = 75713;
