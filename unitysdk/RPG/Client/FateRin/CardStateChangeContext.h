...
#define RPG_CLIENT_FATERIN_CARDSTATECHANGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC4BF9D0)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int CardStateChangeContext_TypeDefinitionIndex = 75643;

	class CardStateChangeContext : public ::System::Object
	{
	public:
		::System::Collections::Generic::IReadOnlyList_1<::Class_1_B71FC14BA77C9F77*>* AffectedCards; // 0x10
		::System::Collections::Generic::IReadOnlyList_1<::Class_1_B71FC14BA77C9F77*>* AddedCards; // 0x18
		::System::Collections::Generic::IReadOnlyList_1<::Class_1_B71FC14BA77C9F77*>* HandSnapshot; // 0x20
		::System::Int32 DiscardPileVisualOffset; // 0x28
		::RPG::Client::FateRin::CardStateChangeReason Reason; // 0x2C
		::RPG::Client::FateRin::BattleAddCardReason AddCardReason; // 0x30
		::System::Int32 DrawPileVisualOffset; // 0x34
		::RPG::GameCore::FateRinCardPileType FromPile; // 0x38
		::RPG::GameCore::FateRinCardPileType ToPile; // 0x3A
