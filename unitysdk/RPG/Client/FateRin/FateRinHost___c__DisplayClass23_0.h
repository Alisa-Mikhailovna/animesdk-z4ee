...
#define RPG_CLIENT_FATERIN_FATERINHOST___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D0370)
#define RPG_CLIENT_FATERIN_FATERINHOST___C__DISPLAYCLASS23_0__TRYBACKTOMAINPAGEANDPLAYEASTEREGGPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0xC4D1E90)
#define RPG_CLIENT_FATERIN_FATERINHOST___C__DISPLAYCLASS23_0__TRYBACKTOMAINPAGEANDPLAYEASTEREGGPERFORMANCE_B__1_OFFSET UNITYSDK_OFFSET(0xC4D2010)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int FateRinHost___c__DisplayClass23_0_TypeDefinitionIndex = 75572;
