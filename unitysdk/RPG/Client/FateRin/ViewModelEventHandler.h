...
#define RPG_CLIENT_FATERIN_VIEWMODELEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC5ADD30)
#define RPG_CLIENT_FATERIN_VIEWMODELEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC5ADD60)
#define RPG_CLIENT_FATERIN_VIEWMODELEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0xC5ADD20)
#define RPG_CLIENT_FATERIN_VIEWMODELEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC5ADCB0)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int ViewModelEventHandler_TypeDefinitionIndex = 75672;
