...
#define RPG_CLIENT_FATERIN_HOUGUMAP_HOUGUMAPFIGHTVIEWMODEL___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D65B0)
#define RPG_CLIENT_FATERIN_HOUGUMAP_HOUGUMAPFIGHTVIEWMODEL___C__DISPLAYCLASS2_0___DOTRACKFIGHT_B__0_OFFSET UNITYSDK_OFFSET(0xC4D6710)
#define RPG_CLIENT_FATERIN_HOUGUMAP_HOUGUMAPFIGHTVIEWMODEL___C__DISPLAYCLASS2_0___DOTRACKFIGHT_B__1_OFFSET UNITYSDK_OFFSET(0xC4D6910)

namespace RPG::Client::FateRin::HouguMap
{
	inline static constexpr unsigned int HouguMapFightViewModel___c__DisplayClass2_0_TypeDefinitionIndex = 75813;
