...
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODELFACTORY_CREATEBYDAY_OFFSET UNITYSDK_OFFSET(0xC4CC940)
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODELFACTORY_CREATE_OFFSET UNITYSDK_OFFSET(0xC4CCA80)
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODELFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0xC4CC930)

namespace RPG::Client::FateRin::Day
{
	inline static constexpr unsigned int SwitchDayTalkViewModelFactory_TypeDefinitionIndex = 76116;
