...
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKENTRYVIEWMODEL_GET_TALKERICONPATH_OFFSET UNITYSDK_OFFSET(0xC4CC260)
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKENTRYVIEWMODEL_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xC4CC2E0)
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKENTRYVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4CC210)

namespace RPG::Client::FateRin::Day
{
	inline static constexpr unsigned int SwitchDayTalkEntryViewModel_TypeDefinitionIndex = 76114;
