...
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODEL_GET_ENTRIES_OFFSET UNITYSDK_OFFSET(0xC4CC8F0)
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4CC340)

namespace RPG::Client::FateRin::Day
{
	inline static constexpr unsigned int SwitchDayTalkViewModel_TypeDefinitionIndex = 76115;

	class SwitchDayTalkViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::Class_1_AB4E0A41BB89929E* _Model; // 0x20
		::System::Collections::Generic::List_1<::RPG::Client::FateRin::Day::SwitchDayTalkEntryViewModel*>* _Entries; // 0x28
