...
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETAVATARIDBYCHOOSEDELIVERYGROUPID_OFFSET UNITYSDK_OFFSET(0xC4D4550)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETAVATARREWARDLIST_OFFSET UNITYSDK_OFFSET(0xC4D4660)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETFATERINCHOOSEDELIVERYENTRY_OFFSET UNITYSDK_OFFSET(0xC4D39B0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETFRIENDAVATARIDBYCHOOSEDELIVERYGROUPID_OFFSET UNITYSDK_OFFSET(0xC4D4830)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_DELIVERYENTRYID_OFFSET UNITYSDK_OFFSET(0xC4D2E30)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_REWARDAVATARFRIENDIDLIST_OFFSET UNITYSDK_OFFSET(0xC4D3380)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_REWARDAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0xC4D3100)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_VIDEOLIST_OFFSET UNITYSDK_OFFSET(0xC4D2E80)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xC4D3600)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xC4D3650)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__CHOOSEDELIVERYNOTICETOASTSHOWN_OFFSET UNITYSDK_OFFSET(0xC4D42D0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D48F0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__FATERINONCLOSEAVATARTOASTDIALOGNOTIFY_OFFSET UNITYSDK_OFFSET(0xC4D4090)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__GETINDEXBYGROUPID_OFFSET UNITYSDK_OFFSET(0xC4D4610)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ISFATERINCOLLECTIONACTIVITYISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0xC4D3C00)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONFINISHEDMAINMISSION_OFFSET UNITYSDK_OFFSET(0xC4D3B00)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONFINISHSUBMISSION_OFFSET UNITYSDK_OFFSET(0xC4D3D00)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONMAZEHUDFATERINICONTRANSFORMREFRESH_OFFSET UNITYSDK_OFFSET(0xC4D4010)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONSHOWMAZEMAINPAGE_OFFSET UNITYSDK_OFFSET(0xC4D4500)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__TRYSHOWFATERINACTIVITYGUIDETOAST_OFFSET UNITYSDK_OFFSET(0xC4D43C0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__TRYTRIGGERTUTORIAL_OFFSET UNITYSDK_OFFSET(0xC4D3E70)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int FateRinSupportModule_TypeDefinitionIndex = 75675;

	class FateRinSupportModule : public ::RPG::Client::BaseModule
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* _VideoList; // 0x10
		::System::Collections::Generic::List_1<::System::UInt32>* _RewardAvatarFriendIDList; // 0x18
		::System::Collections::Generic::List_1<::System::UInt32>* _RewardAvatarIDList; // 0x20
