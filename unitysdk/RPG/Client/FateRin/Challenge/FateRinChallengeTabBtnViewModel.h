...
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_BOSSICONPATH_OFFSET UNITYSDK_OFFSET(0xC4CBE50)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_FIGHTNAME_OFFSET UNITYSDK_OFFSET(0xC4CBE40)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_HAVEPASSED_OFFSET UNITYSDK_OFFSET(0xC4CBE70)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xC4CBE20)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_PASSEDLEVEL_OFFSET UNITYSDK_OFFSET(0xC4CBE60)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xC4CBE30)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C9390)

namespace RPG::Client::FateRin::Challenge
{
	inline static constexpr unsigned int FateRinChallengeTabBtnViewModel_TypeDefinitionIndex = 76076;
	...
	public:
		...
		::System::UInt32 _PassedLevel_k__BackingField; // 0x38
