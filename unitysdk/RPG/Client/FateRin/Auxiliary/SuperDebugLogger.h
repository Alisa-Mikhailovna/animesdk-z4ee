...
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_ASSERT_1_OFFSET UNITYSDK_OFFSET(0xC477B40)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_ASSERT_OFFSET UNITYSDK_OFFSET(0xC477AF0)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_LOGERROR_OFFSET UNITYSDK_OFFSET(0xC4779C0)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_LOGINFO_OFFSET UNITYSDK_OFFSET(0xC477920)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0xC477970)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER__BUILDLOGMESSAGE_OFFSET UNITYSDK_OFFSET(0xC477A70)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC477910)

namespace RPG::Client::FateRin::Auxiliary
{
	inline static constexpr unsigned int SuperDebugLogger_TypeDefinitionIndex = 76104;
