...
#define RPG_CLIENT_FATERIN_TUTORIAL_FATERINBATTLETUTORIALVIEWMODEL_ADD_ONTUTORIALSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xC4DE530)
#define RPG_CLIENT_FATERIN_TUTORIAL_FATERINBATTLETUTORIALVIEWMODEL_GETENEMYWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xC4DE400)
#define RPG_CLIENT_FATERIN_TUTORIAL_FATERINBATTLETUTORIALVIEWMODEL_GET_CARDINDEX_OFFSET UNITYSDK_OFFSET(0xC4DE320)
#define RPG_CLIENT_FATERIN_TUTORIAL_FATERINBATTLETUTORIALVIEWMODEL_GET_ENEMYINDEX_OFFSET UNITYSDK_OFFSET(0xC4DE390)
#define RPG_CLIENT_FATERIN_TUTORIAL_FATERINBATTLETUTORIALVIEWMODEL_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xC4DE2B0)
#define RPG_CLIENT_FATERIN_TUTORIAL_FATERINBATTLETUTORIALVIEWMODEL_REMOVE_ONTUTORIALSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xC4DE590)
#define RPG_CLIENT_FATERIN_TUTORIAL_FATERINBATTLETUTORIALVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4DE120)
#define RPG_CLIENT_FATERIN_TUTORIAL_FATERINBATTLETUTORIALVIEWMODEL__ONRULECHANGED_OFFSET UNITYSDK_OFFSET(0xC4DE5F0)

namespace RPG::Client::FateRin::Tutorial
{
	inline static constexpr unsigned int FateRinBattleTutorialViewModel_TypeDefinitionIndex = 75764;

	class FateRinBattleTutorialViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::Class_0_16E4307DCC419505_1267* _TutorialService; // 0x20
