...
#define RPG_CLIENT_FATERIN_LOGGING_ILOGGERFACTORYEXTENSIONS_GETCURRENTCLASSLOGGER_OFFSET UNITYSDK_OFFSET(0xC4D69B0)
#define RPG_CLIENT_FATERIN_LOGGING_ILOGGERFACTORYEXTENSIONS_GETLOGGERFOR_OFFSET UNITYSDK_OFFSET(0xC4D7090)
#define RPG_CLIENT_FATERIN_LOGGING_ILOGGERFACTORYEXTENSIONS__FINDCALLERTYPE_OFFSET UNITYSDK_OFFSET(0xC4D6BC0)

namespace RPG::Client::FateRin::Logging
{
	inline static constexpr unsigned int ILoggerFactoryExtensions_TypeDefinitionIndex = 76080;
