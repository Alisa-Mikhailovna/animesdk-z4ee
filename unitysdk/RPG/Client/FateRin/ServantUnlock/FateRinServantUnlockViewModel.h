...
#define RPG_CLIENT_FATERIN_SERVANTUNLOCK_FATERINSERVANTUNLOCKVIEWMODEL_ASYNCINITIALIZE_OFFSET UNITYSDK_OFFSET(0xC4DD460)
#define RPG_CLIENT_FATERIN_SERVANTUNLOCK_FATERINSERVANTUNLOCKVIEWMODEL_GET_CARDDECKDESC_OFFSET UNITYSDK_OFFSET(0xC4DD380)
#define RPG_CLIENT_FATERIN_SERVANTUNLOCK_FATERINSERVANTUNLOCKVIEWMODEL_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0xC4DD360)
#define RPG_CLIENT_FATERIN_SERVANTUNLOCK_FATERINSERVANTUNLOCKVIEWMODEL_SET_CARDDECKDESC_OFFSET UNITYSDK_OFFSET(0xC4DD390)
#define RPG_CLIENT_FATERIN_SERVANTUNLOCK_FATERINSERVANTUNLOCKVIEWMODEL_SET_SERVANT_OFFSET UNITYSDK_OFFSET(0xC4DD370)
#define RPG_CLIENT_FATERIN_SERVANTUNLOCK_FATERINSERVANTUNLOCKVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4DD3A0)
#define RPG_CLIENT_FATERIN_SERVANTUNLOCK_FATERINSERVANTUNLOCKVIEWMODEL__GETHOUGUOWNERTYPE_OFFSET UNITYSDK_OFFSET(0xC4DD740)

namespace RPG::Client::FateRin::ServantUnlock
{
	inline static constexpr unsigned int FateRinServantUnlockViewModel_TypeDefinitionIndex = 75677;
	...
	public:
		...
		::Class_0_16E4307DCC419505_1262* _CardDeckRepository; // 0x30
		::RPG::Client::TextID _CardDeckDesc_k__BackingField; // 0x38
		::RPG::GameCore::FateRinServantType _ServantType; // 0x48

		::System::Void _ctor(::Class_0_16E4307DCC419505_1272* a1, ::Class_0_16E4307DCC419505_1262* a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_1272*, ::Class_0_16E4307DCC419505_1262*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATERIN_SERVANTUNLOCK_FATERINSERVANTUNLOCKVIEWMODEL__CTOR_OFFSET))(this, a1, a2);
		}
