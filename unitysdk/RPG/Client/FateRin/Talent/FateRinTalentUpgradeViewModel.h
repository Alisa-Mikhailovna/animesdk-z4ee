...
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTUPGRADEVIEWMODEL_ASYNCINITIALIZE_OFFSET UNITYSDK_OFFSET(0xC4DD820)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTUPGRADEVIEWMODEL_GET_TALENT_OFFSET UNITYSDK_OFFSET(0xC4DDC10)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTUPGRADEVIEWMODEL_SET_TALENT_OFFSET UNITYSDK_OFFSET(0xC4DDC20)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTUPGRADEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4DD7A0)

namespace RPG::Client::FateRin::Talent
{
	inline static constexpr unsigned int FateRinTalentUpgradeViewModel_TypeDefinitionIndex = 75769;
