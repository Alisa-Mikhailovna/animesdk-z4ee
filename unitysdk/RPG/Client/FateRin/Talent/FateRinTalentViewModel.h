...
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC4DDCE0)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTVIEWMODEL_GET_ICONSTATE_OFFSET UNITYSDK_OFFSET(0xC4DDD40)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTVIEWMODEL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xC4DDC30)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC4DDC80)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTVIEWMODEL_SET_ICONSTATE_OFFSET UNITYSDK_OFFSET(0xC4DDD50)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4DDB30)

namespace RPG::Client::FateRin::Talent
{
	inline static constexpr unsigned int FateRinTalentViewModel_TypeDefinitionIndex = 75770;

	class FateRinTalentViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::System::String* _IconState_k__BackingField; // 0x20
		::Class_1_6770BC9DDC5C458C_1* _Model; // 0x28
