...
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0xC4C5FC0)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL_GET_TEAMSIZE_OFFSET UNITYSDK_OFFSET(0xC4C5F80)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL_SET_AVATAR_OFFSET UNITYSDK_OFFSET(0xC4C5FD0)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C5FE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL__ONUPDATE_OFFSET UNITYSDK_OFFSET(0xC4C6080)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int SingleTeamViewModel_TypeDefinitionIndex = 75856;
