...
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_COMPUTECATENARYPOINTS_OFFSET UNITYSDK_OFFSET(0xC4C6330)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_COMPUTECATENARYSHADOWPOINTS_OFFSET UNITYSDK_OFFSET(0xC4C6580)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_GET_FROMTEAM_OFFSET UNITYSDK_OFFSET(0xC4C61B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_GET_RELATIONTYPE_OFFSET UNITYSDK_OFFSET(0xC4C61F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_GET_TOTEAM_OFFSET UNITYSDK_OFFSET(0xC4C61D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_SET_FROMTEAM_OFFSET UNITYSDK_OFFSET(0xC4C61C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_SET_RELATIONTYPE_OFFSET UNITYSDK_OFFSET(0xC4C6200)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_SET_TOTEAM_OFFSET UNITYSDK_OFFSET(0xC4C61E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_UPDATE_OFFSET UNITYSDK_OFFSET(0xC4C62D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C6210)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int TeamRelationViewModel_TypeDefinitionIndex = 75857;
