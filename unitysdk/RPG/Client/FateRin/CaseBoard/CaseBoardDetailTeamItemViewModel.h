...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL_GET_TABMAINTITLE_OFFSET UNITYSDK_OFFSET(0xC4C09D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL_GET_TABSUBTITLE_OFFSET UNITYSDK_OFFSET(0xC4C0A80)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL_GET_TEAM_OFFSET UNITYSDK_OFFSET(0xC4C0AF0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC4C0990)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C0B00)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardDetailTeamItemViewModel_TypeDefinitionIndex = 75842;
