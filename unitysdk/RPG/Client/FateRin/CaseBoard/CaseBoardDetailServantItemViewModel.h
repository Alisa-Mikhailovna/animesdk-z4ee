...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_SERVANTCLASS_OFFSET UNITYSDK_OFFSET(0xC4C08A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0xC4C0890)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_TABMAINTITLE_OFFSET UNITYSDK_OFFSET(0xC4C0740)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_TABSUBTITLE_OFFSET UNITYSDK_OFFSET(0xC4C07A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC4C06F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C08B0)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardDetailServantItemViewModel_TypeDefinitionIndex = 75841;
