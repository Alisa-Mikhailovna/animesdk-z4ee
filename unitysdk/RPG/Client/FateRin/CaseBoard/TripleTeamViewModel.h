...
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_HOUGU1_OFFSET UNITYSDK_OFFSET(0xC4C6D90)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_HOUGU2_OFFSET UNITYSDK_OFFSET(0xC4C6DB0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_ISSHOWMASTER2TAG_OFFSET UNITYSDK_OFFSET(0xC4C6D70)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0xC4C6D10)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_MASTER2_OFFSET UNITYSDK_OFFSET(0xC4C6D50)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_MASTER_OFFSET UNITYSDK_OFFSET(0xC4C6CF0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0xC4C6D30)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_TEAMSIZE_OFFSET UNITYSDK_OFFSET(0xC4C6CA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_HOUGU1_OFFSET UNITYSDK_OFFSET(0xC4C6DA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_HOUGU2_OFFSET UNITYSDK_OFFSET(0xC4C6DC0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_ISSHOWMASTER2TAG_OFFSET UNITYSDK_OFFSET(0xC4C6D80)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0xC4C6D20)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_MASTER2_OFFSET UNITYSDK_OFFSET(0xC4C6D60)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_MASTER_OFFSET UNITYSDK_OFFSET(0xC4C6D00)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_SERVANT_OFFSET UNITYSDK_OFFSET(0xC4C6D40)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C6DD0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL__ONUPDATE_OFFSET UNITYSDK_OFFSET(0xC4C6FD0)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int TripleTeamViewModel_TypeDefinitionIndex = 75861;

	class TripleTeamViewModel : public ::RPG::Client::FateRin::CaseBoard::TeamViewModel
	{
	public:
		::RPG::Client::FateRin::CaseBoard::HouguViewModel* _Hougu1_k__BackingField; // 0x48
		...
		::RPG::Client::FateRin::CaseBoard::HouguViewModel* _Hougu2_k__BackingField; // 0x60
		::RPG::Client::FateRin::CaseBoard::CaseBoardAvatarViewModel* _Master2_k__BackingField; // 0x68
		::System::Boolean _IsShowMaster2Tag_k__BackingField; // 0x70
		::System::Boolean _IsShowMasterTag_k__BackingField; // 0x71
