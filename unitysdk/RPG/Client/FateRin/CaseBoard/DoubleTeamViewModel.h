...
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_HOUGU_OFFSET UNITYSDK_OFFSET(0xC4C51B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0xC4C5170)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_MASTER_OFFSET UNITYSDK_OFFSET(0xC4C5150)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0xC4C5190)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_TEAMSIZE_OFFSET UNITYSDK_OFFSET(0xC4C5100)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_HOUGU_OFFSET UNITYSDK_OFFSET(0xC4C51C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0xC4C5180)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_MASTER_OFFSET UNITYSDK_OFFSET(0xC4C5160)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_SERVANT_OFFSET UNITYSDK_OFFSET(0xC4C51A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C51D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL__ONUPDATE_OFFSET UNITYSDK_OFFSET(0xC4C5590)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int DoubleTeamViewModel_TypeDefinitionIndex = 75855;
