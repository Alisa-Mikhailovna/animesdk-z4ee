...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_CREATEWITHSERVANTTAB_OFFSET UNITYSDK_OFFSET(0xC4C05B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_MASTERCLASS_OFFSET UNITYSDK_OFFSET(0xC4C0370)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_MASTER_OFFSET UNITYSDK_OFFSET(0xC4C0360)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_TABMAINTITLE_OFFSET UNITYSDK_OFFSET(0xC4C0210)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_TABSUBTITLE_OFFSET UNITYSDK_OFFSET(0xC4C0270)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC4C01C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC4C0590)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C0380)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__GETDEFAULTMASTERCLASS_OFFSET UNITYSDK_OFFSET(0xC4C0510)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__GETDEFAULTMASTERTABMAINTITLE_OFFSET UNITYSDK_OFFSET(0xC4C0420)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardDetailMasterItemViewModel_TypeDefinitionIndex = 75840;
