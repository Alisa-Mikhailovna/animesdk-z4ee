...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONMOVETOGRAIL_OFFSET UNITYSDK_OFFSET(0xC4C1510)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONMOVETOTEAM_OFFSET UNITYSDK_OFFSET(0xC4C1450)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0xC4C12B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONPERFORMSTART_OFFSET UNITYSDK_OFFSET(0xC4C11F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSETUPSCALE_OFFSET UNITYSDK_OFFSET(0xC4C1390)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWGRAIL_OFFSET UNITYSDK_OFFSET(0xC4C1770)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWLINE_OFFSET UNITYSDK_OFFSET(0xC4C1830)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWREWARD_OFFSET UNITYSDK_OFFSET(0xC4C18F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWTEAM_OFFSET UNITYSDK_OFFSET(0xC4C15D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSIMPLETALK_OFFSET UNITYSDK_OFFSET(0xC4C19B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONTRACKTEAM_OFFSET UNITYSDK_OFFSET(0xC4C1690)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_APPLYSTATICSTATE_OFFSET UNITYSDK_OFFSET(0xC4C2000)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_CLEARPERFORM_OFFSET UNITYSDK_OFFSET(0xC4C1E10)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GETCURRENTFORTASK_OFFSET UNITYSDK_OFFSET(0xC4C1B70)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GETGRAILFORTASK_OFFSET UNITYSDK_OFFSET(0xC4C1BE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GET_ISPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0xC4C1B00)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GET_ISPERFORMING_OFFSET UNITYSDK_OFFSET(0xC4C1A90)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOGRAILCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC4C2540)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOGRAIL_OFFSET UNITYSDK_OFFSET(0xC4C2400)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOTEAMCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC4C23A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOTEAM_OFFSET UNITYSDK_OFFSET(0xC4C2260)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONMOVETOGRAIL_OFFSET UNITYSDK_OFFSET(0xC4C1570)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONMOVETOTEAM_OFFSET UNITYSDK_OFFSET(0xC4C14B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0xC4C1320)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONPERFORMSTART_OFFSET UNITYSDK_OFFSET(0xC4C1250)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSETUPSCALE_OFFSET UNITYSDK_OFFSET(0xC4C13F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWGRAIL_OFFSET UNITYSDK_OFFSET(0xC4C17D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWLINE_OFFSET UNITYSDK_OFFSET(0xC4C1890)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWREWARD_OFFSET UNITYSDK_OFFSET(0xC4C1950)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWTEAM_OFFSET UNITYSDK_OFFSET(0xC4C1630)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSIMPLETALK_OFFSET UNITYSDK_OFFSET(0xC4C1A20)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONTRACKTEAM_OFFSET UNITYSDK_OFFSET(0xC4C1700)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SETUPSCALECOMPLETE_OFFSET UNITYSDK_OFFSET(0xC4C2210)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SETUPSCALE_OFFSET UNITYSDK_OFFSET(0xC4C20E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWGRAILCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC4C2F20)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWGRAIL_OFFSET UNITYSDK_OFFSET(0xC4C2C10)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWLINECOMPLETE_OFFSET UNITYSDK_OFFSET(0xC4C3480)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWLINE_OFFSET UNITYSDK_OFFSET(0xC4C3090)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWREWARDCOMPLETE_1_OFFSET UNITYSDK_OFFSET(0xC4C37D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWREWARDCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC4C3730)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWREWARD_OFFSET UNITYSDK_OFFSET(0xC4C35F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWTEAMCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC4C2AD0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWTEAM_OFFSET UNITYSDK_OFFSET(0xC4C25A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SIMPLETALK_OFFSET UNITYSDK_OFFSET(0xC4C39E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_STARTPERFORM_OFFSET UNITYSDK_OFFSET(0xC4C1C40)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_TRACKTEAM_OFFSET UNITYSDK_OFFSET(0xC4C2F70)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__CLEARPENDINGPROMISES_OFFSET UNITYSDK_OFFSET(0xC4C3B60)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__CLEARPERFORM_OFFSET UNITYSDK_OFFSET(0xC4C1F20)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C1080)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__HASPENDINGPROMISE_OFFSET UNITYSDK_OFFSET(0xC4C3D10)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__HASWAITEFFECT_OFFSET UNITYSDK_OFFSET(0xC4C2A40)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__ISPENDING_OFFSET UNITYSDK_OFFSET(0xC4C42F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__NOTIFYPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0xC4C3C90)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__SIMPLETALK_B__60_0_OFFSET UNITYSDK_OFFSET(0xC4C4340)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardPerformViewModel_TypeDefinitionIndex = 75845;

	class CaseBoardPerformViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::RPG::Client::Promises::Promise* _SimpleTalkPromise; // 0x20
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowTeamParams*>* OnShowTeam; // 0x28
		::RPG::Client::Promises::Promise* _SetupScalePromise; // 0x30
		::RPG::Client::FateRin::ViewModelEventHandler* OnPerformStart; // 0x38
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardSetupScaleParams*>* OnSetupScale; // 0x40
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardMoveToTeamParams*>* OnMoveToTeam; // 0x48
		::RPG::Client::Promises::Promise* _ShowGrailPromise; // 0x50
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardMoveToGrailParams*>* OnMoveToGrail; // 0x58
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowRewardParams*>* OnShowReward; // 0x60
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowLineParams*>* OnShowLine; // 0x68
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowGrailParams*>* OnShowGrail; // 0x70
		::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::RPG::GameCore::FateRinCaseBoardTeamType, ::RPG::GameCore::FateRinCaseBoardTeamType>, ::RPG::Client::Promises::Promise*>* _ShowLinePromises; // 0x78
		::RPG::Client::Promises::Promise* _ShowRewardPromise; // 0x80
		::RPG::Client::Promises::Promise* _MoveToGrailPromise; // 0x88
		::RPG::Client::FateRin::ViewModelEventHandler* OnPerformFinished; // 0x90
		::RPG::GameCore::GameEntity* _LevelGraphEntity; // 0x98
		::RPG::Client::Promises::Promise* _MoveToTeamPromise; // 0xA0
		...
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardSimpleTalkParams*>* OnSimpleTalk; // 0xB0
		::Class_1_C28E571CD1C66CE4* _State; // 0xB8
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardTrackTeamParams*>* OnTrackTeam; // 0xC0
		::System::Boolean _HasPerformFinishedNotified; // 0xC8
		::System::Boolean _HasPerformStarted; // 0xC9
		::System::Boolean _IsStaticStateOnly; // 0xCA
