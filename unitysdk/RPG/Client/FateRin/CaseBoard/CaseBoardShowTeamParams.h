...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSHOWTEAMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C2A30)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardShowTeamParams_TypeDefinitionIndex = 75849;
