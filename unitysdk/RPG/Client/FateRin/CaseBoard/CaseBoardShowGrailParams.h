...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSHOWGRAILPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C2F10)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardShowGrailParams_TypeDefinitionIndex = 75848;
