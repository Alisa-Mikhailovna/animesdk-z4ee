...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_ASYNCINITIALIZE_OFFSET UNITYSDK_OFFSET(0xC4C4990)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETPAGEENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xC4C4B30)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETPAGEEXITCALLBACK_OFFSET UNITYSDK_OFFSET(0xC4C4C00)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETTEAMRELATIONS_OFFSET UNITYSDK_OFFSET(0xC4C4F60)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETTEAMS_OFFSET UNITYSDK_OFFSET(0xC4C4DF0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_GRAIL_OFFSET UNITYSDK_OFFSET(0xC4C4800)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xC4C47E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_PERFORM_OFFSET UNITYSDK_OFFSET(0xC4C4850)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_STATE_OFFSET UNITYSDK_OFFSET(0xC4C4DB0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xC4C47F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_SET_PERFORM_OFFSET UNITYSDK_OFFSET(0xC4C4860)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_TRYGETTEAMRELATION_OFFSET UNITYSDK_OFFSET(0xC4C4FB0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_TRYGETTEAM_OFFSET UNITYSDK_OFFSET(0xC4C4E40)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_UPDATETEAMRELATION_OFFSET UNITYSDK_OFFSET(0xC4C5020)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_UPDATETEAM_OFFSET UNITYSDK_OFFSET(0xC4C4EA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4C4870)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL__ONPAGEENTER_OFFSET UNITYSDK_OFFSET(0xC4C4CD0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL__ONPAGEEXIT_OFFSET UNITYSDK_OFFSET(0xC4C4D40)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardViewModel_TypeDefinitionIndex = 75833;
	...
	public:
		...
		{
			return (::RPG::Client::FateRin::CaseBoard::CaseBoardViewModel**)Il2CppClass::FromTypeDefinitionIndex(CaseBoardViewModel_TypeDefinitionIndex)->GetStaticField(0xBE10);
		}
