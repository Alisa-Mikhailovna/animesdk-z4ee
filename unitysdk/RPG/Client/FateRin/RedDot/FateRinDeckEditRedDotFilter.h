...
#define RPG_CLIENT_FATERIN_REDDOT_FATERINDECKEDITREDDOTFILTER_GETSUBKEYS_OFFSET UNITYSDK_OFFSET(0xC4D93D0)
#define RPG_CLIENT_FATERIN_REDDOT_FATERINDECKEDITREDDOTFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D9380)

namespace RPG::Client::FateRin::RedDot
{
	inline static constexpr unsigned int FateRinDeckEditRedDotFilter_TypeDefinitionIndex = 75781;
