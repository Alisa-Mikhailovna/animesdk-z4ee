...
#define RPG_CLIENT_FATERIN_REDDOT_FATERINCASEBOARDREDDOTFILTER_GETTEAMDETAILSUBKEYS_OFFSET UNITYSDK_OFFSET(0xC4D92E0)
#define RPG_CLIENT_FATERIN_REDDOT_FATERINCASEBOARDREDDOTFILTER_ISMAINPAGENEW_OFFSET UNITYSDK_OFFSET(0xC4D9330)
#define RPG_CLIENT_FATERIN_REDDOT_FATERINCASEBOARDREDDOTFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D9290)

namespace RPG::Client::FateRin::RedDot
{
	inline static constexpr unsigned int FateRinCaseBoardRedDotFilter_TypeDefinitionIndex = 75780;
