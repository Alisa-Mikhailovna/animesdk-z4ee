...
#define RPG_CLIENT_FATERIN_REDDOT_FATERINRESIDENTREWARDREDDOTFILTER_GETSUBKEYS_OFFSET UNITYSDK_OFFSET(0xC4DA2E0)
#define RPG_CLIENT_FATERIN_REDDOT_FATERINRESIDENTREWARDREDDOTFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC4DA260)

namespace RPG::Client::FateRin::RedDot
{
	inline static constexpr unsigned int FateRinResidentRewardRedDotFilter_TypeDefinitionIndex = 75784;

	class FateRinResidentRewardRedDotFilter : public ::System::Object
	{
	public:
		::Class_1_96586C089CD5CA69* _ChallengeService; // 0x10
		::Class_0_16E4307DCC419505_1273* _Repository; // 0x18
