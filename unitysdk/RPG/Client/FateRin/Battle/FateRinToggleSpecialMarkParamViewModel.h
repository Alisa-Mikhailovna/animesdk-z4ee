...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL_GET_TEXTNODELIST_OFFSET UNITYSDK_OFFSET(0xC4A5560)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL_GET_TRIGGERNAME_OFFSET UNITYSDK_OFFSET(0xC4A5540)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL_SET_TEXTNODELIST_OFFSET UNITYSDK_OFFSET(0xC4A5570)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL_SET_TRIGGERNAME_OFFSET UNITYSDK_OFFSET(0xC4A5550)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A5320)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinToggleSpecialMarkParamViewModel_TypeDefinitionIndex = 75914;
