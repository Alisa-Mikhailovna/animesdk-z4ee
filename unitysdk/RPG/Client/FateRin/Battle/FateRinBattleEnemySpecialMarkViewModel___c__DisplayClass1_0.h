...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYSPECIALMARKVIEWMODEL___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4800A0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYSPECIALMARKVIEWMODEL___C__DISPLAYCLASS1_0___ONBATTLEENEMYSPECIALMARKSTATEMODELCHANGEMESSAGE_B__0_OFFSET UNITYSDK_OFFSET(0xC4803D0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleEnemySpecialMarkViewModel___c__DisplayClass1_0_TypeDefinitionIndex = 75919;
