...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL_GET_PATH_OFFSET UNITYSDK_OFFSET(0xC4A52E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xC4A5300)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL_SET_PATH_OFFSET UNITYSDK_OFFSET(0xC4A52F0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL_SET_TEXT_OFFSET UNITYSDK_OFFSET(0xC4A5310)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A52B0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinSpecialMarkTextNodeViewModel_TypeDefinitionIndex = 75915;
