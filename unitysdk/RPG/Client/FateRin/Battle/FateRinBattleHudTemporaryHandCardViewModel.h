...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDTEMPORARYHANDCARDVIEWMODEL_GET_CARDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC49DCB0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDTEMPORARYHANDCARDVIEWMODEL_GET_ISSTACKABLE_OFFSET UNITYSDK_OFFSET(0xC49DCC0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDTEMPORARYHANDCARDVIEWMODEL_GET_STACKCOUNT_OFFSET UNITYSDK_OFFSET(0xC49DE10)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDTEMPORARYHANDCARDVIEWMODEL_GET_STACKUISTATE_OFFSET UNITYSDK_OFFSET(0xC49DE60)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDTEMPORARYHANDCARDVIEWMODEL_GET_VISUALSTACKCOUNT_OFFSET UNITYSDK_OFFSET(0xC49DE20)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDTEMPORARYHANDCARDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC49DC80)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudTemporaryHandCardViewModel_TypeDefinitionIndex = 75968;
