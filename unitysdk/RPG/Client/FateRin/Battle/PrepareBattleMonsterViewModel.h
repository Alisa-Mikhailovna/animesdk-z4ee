...
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_CHALLENGEBUFFDESCRIPTIONS_OFFSET UNITYSDK_OFFSET(0xC4A55E0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_FIGHTDESCRIPTION_OFFSET UNITYSDK_OFFSET(0xC4A55B0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_FIGHTNAME_OFFSET UNITYSDK_OFFSET(0xC4A55A0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_FIGUREPATH_OFFSET UNITYSDK_OFFSET(0xC4A5590)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_HASCARDREWARD_OFFSET UNITYSDK_OFFSET(0xC4A55C0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_ISHOUGUMAPFIGHT_OFFSET UNITYSDK_OFFSET(0xC4A5580)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_REWARDCARDICONPATH_OFFSET UNITYSDK_OFFSET(0xC4A55D0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC4A4870)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A43E0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int PrepareBattleMonsterViewModel_TypeDefinitionIndex = 76026;
	...
	public:
		...
		::System::Boolean _IsHouguMapFight_k__BackingField; // 0x48
		::System::Boolean _HasCardReward_k__BackingField; // 0x49
		::RPG::Client::TextID _FightName_k__BackingField; // 0x50
