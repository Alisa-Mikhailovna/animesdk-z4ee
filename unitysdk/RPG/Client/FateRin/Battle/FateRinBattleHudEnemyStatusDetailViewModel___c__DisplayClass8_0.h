...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDENEMYSTATUSDETAILVIEWMODEL___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC492EB0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDENEMYSTATUSDETAILVIEWMODEL___C__DISPLAYCLASS8_0___REFRESHSTATUSLIST_B__0_OFFSET UNITYSDK_OFFSET(0xC493A10)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudEnemyStatusDetailViewModel___c__DisplayClass8_0_TypeDefinitionIndex = 75954;
