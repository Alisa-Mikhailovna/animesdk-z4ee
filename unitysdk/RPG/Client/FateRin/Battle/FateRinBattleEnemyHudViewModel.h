...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL_ADDMESSAGEHANDLER_OFFSET UNITYSDK_OFFSET(0xC47E5E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC47E320)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC47DC10)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__GETEVENTMANAGER_OFFSET UNITYSDK_OFFSET(0xC47E6C0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__ONBATTLEENEMYSTATEMODELCHANGEMESSAGE_OFFSET UNITYSDK_OFFSET(0xC47E8E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__ONBATTLEONTURNSTATECHANGEMESSAGE_OFFSET UNITYSDK_OFFSET(0xC47E950)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__ONLEVELGAMEMODESTATECHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0xC47E7E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__REFRESHVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC47DD40)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xC47E230)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__SENDMESSAGE_OFFSET UNITYSDK_OFFSET(0xC47E640)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__SORTANDSETPOSINDEX_OFFSET UNITYSDK_OFFSET(0xC47E9C0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEENEMYHUDVIEWMODEL__UNREGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xC47E4F0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleEnemyHudViewModel_TypeDefinitionIndex = 75908;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::FateRin::Battle::FateRinBattleEnemyHudSingleViewModel*>* HudViewModelList; // 0x38
