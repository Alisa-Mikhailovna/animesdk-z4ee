...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL_ADD_ONENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xC480AC0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC4807A0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL_GET_PAUSEBUTTON_OFFSET UNITYSDK_OFFSET(0xC480AB0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL_GET_SPEEDUPBUTTON_OFFSET UNITYSDK_OFFSET(0xC480AA0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL_REMOVE_ONENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xC480B20)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC480470)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL__GETEVENTMANAGER_OFFSET UNITYSDK_OFFSET(0xC4808E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL__ONLEVELGAMEMODESTATECHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0xC480A00)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL__REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xC4806B0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEFUNCTIONAREAVIEWMODEL__UNREGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xC4807F0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleFunctionAreaViewModel_TypeDefinitionIndex = 75921;
