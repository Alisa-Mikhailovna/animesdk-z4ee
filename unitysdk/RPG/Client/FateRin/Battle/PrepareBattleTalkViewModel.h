...
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKVIEWMODEL_CREATEBYHOUGUMAPFIGHT_OFFSET UNITYSDK_OFFSET(0xC4A4440)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKVIEWMODEL_CREATEEMPTY_OFFSET UNITYSDK_OFFSET(0xC4A56B0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKVIEWMODEL_GETENTRIES_OFFSET UNITYSDK_OFFSET(0xC4A5780)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A5640)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int PrepareBattleTalkViewModel_TypeDefinitionIndex = 76028;
