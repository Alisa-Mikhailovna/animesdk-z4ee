...
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_GET_TALKER_OFFSET UNITYSDK_OFFSET(0xC4A5600)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xC4A5620)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_SET_TALKER_OFFSET UNITYSDK_OFFSET(0xC4A5610)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_SET_TEXT_OFFSET UNITYSDK_OFFSET(0xC4A5630)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A55F0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int PrepareBattleTalkEntryViewModel_TypeDefinitionIndex = 76027;
