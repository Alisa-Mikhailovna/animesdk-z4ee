...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xC4A0B00)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLEXTRAEFFECTLIST_OFFSET UNITYSDK_OFFSET(0xC4A0C70)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0xC4A0AA0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0xC4A0B50)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLTYPECOLOR_OFFSET UNITYSDK_OFFSET(0xC4A0C10)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xC4A0BB0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A0800)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleSkillDetailViewModel_TypeDefinitionIndex = 75993;
