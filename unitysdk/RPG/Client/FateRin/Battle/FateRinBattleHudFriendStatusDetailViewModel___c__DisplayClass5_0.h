...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFRIENDSTATUSDETAILVIEWMODEL___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4968A0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFRIENDSTATUSDETAILVIEWMODEL___C__DISPLAYCLASS5_0___REFRESHSTATUSLIST_B__0_OFFSET UNITYSDK_OFFSET(0xC4972C0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudFriendStatusDetailViewModel___c__DisplayClass5_0_TypeDefinitionIndex = 75963;
