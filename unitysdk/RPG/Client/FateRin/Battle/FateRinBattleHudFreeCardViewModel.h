...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_ADD_ONCARDCHANGED_OFFSET UNITYSDK_OFFSET(0xC4948F0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_ADD_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC494830)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_DRAGPOINTERPOS_OFFSET UNITYSDK_OFFSET(0xC4947D0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_HANDCARDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC4947B0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_ISSHOWTARGETINGCURVE_OFFSET UNITYSDK_OFFSET(0xC4947F0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_ISTARGETINGENEMY_OFFSET UNITYSDK_OFFSET(0xC494810)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_STATE_OFFSET UNITYSDK_OFFSET(0xC494790)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_REMOVE_ONCARDCHANGED_OFFSET UNITYSDK_OFFSET(0xC494950)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_REMOVE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC494890)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_DRAGPOINTERPOS_OFFSET UNITYSDK_OFFSET(0xC4947E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_HANDCARDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC4947C0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_ISSHOWTARGETINGCURVE_OFFSET UNITYSDK_OFFSET(0xC494800)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_ISTARGETINGENEMY_OFFSET UNITYSDK_OFFSET(0xC494820)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_STATE_OFFSET UNITYSDK_OFFSET(0xC4947A0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__APPLYCARDAREADISPLAYSTATE_OFFSET UNITYSDK_OFFSET(0xC494280)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC494160)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__MAPFINDINGTARGETTOCARDSTATE_OFFSET UNITYSDK_OFFSET(0xC494730)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__MAPPHASETOCARDSTATE_OFFSET UNITYSDK_OFFSET(0xC494690)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__ONINTERACTIONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xC494230)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__SYNCCARDFROMAREA_OFFSET UNITYSDK_OFFSET(0xC494570)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudFreeCardViewModel_TypeDefinitionIndex = 75957;

	class FateRinBattleHudFreeCardViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::RPG::Client::FateRin::ViewModelEventHandler* OnCardChanged; // 0x20
		::RPG::Client::FateRin::Battle::IFateRinBattleHudCardAreaViewModel* _CardArea; // 0x28
		::RPG::Client::FateRin::ViewModelEventHandler* OnStateUpdate; // 0x30
		...
		::RPG::Client::FateRin::Battle::IFateRinBattleHudFreeCardViewModel_CardState _State_k__BackingField; // 0x44
		::UnityEngine::Vector2 _DragPointerPos_k__BackingField; // 0x48
