...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDENDACTIONBUTTONVIEWMODEL___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC490380)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDENDACTIONBUTTONVIEWMODEL___C__DISPLAYCLASS5_0___ENDPLAYERACTION_B__0_OFFSET UNITYSDK_OFFSET(0xC4907E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDENDACTIONBUTTONVIEWMODEL___C__DISPLAYCLASS5_0___ENDPLAYERACTION_B__3_OFFSET UNITYSDK_OFFSET(0xC490840)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudEndActionButtonViewModel___c__DisplayClass5_0_TypeDefinitionIndex = 75948;
