...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDINPUTMODEROUTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC49AE10)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDINPUTMODEROUTER__ONINPUTDEVICECLASSSWITCH_OFFSET UNITYSDK_OFFSET(0xC49B170)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDINPUTMODEROUTER__SUBSCRIBEEVENTS_OFFSET UNITYSDK_OFFSET(0xC49AEB0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDINPUTMODEROUTER__SWITCHTOMODE_OFFSET UNITYSDK_OFFSET(0xC49AF10)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDINPUTMODEROUTER__UNSUBSCRIBEEVENTS_OFFSET UNITYSDK_OFFSET(0xC49B100)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudInputModeRouter_TypeDefinitionIndex = 75972;

	class FateRinBattleHudInputModeRouter : public ::RPG::Client::FateRin::Battle::FateRinBattleHudInputBrainBase
	{
	public:
		::RPG::Client::FateRin::Battle::IFateRinBattleHudInputSource* _Source; // 0x40
		::Class_0_16E4307DCC419505_1291* _InputBrainFactory; // 0x48
		::RPG::Client::FateRin::Battle::IFateRinBattleHudInputBrain* _ActiveBrain; // 0x50
