...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xC487380)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudCardAreaViewModel_CardPresentationTransition_TypeDefinitionIndex = 75931;
