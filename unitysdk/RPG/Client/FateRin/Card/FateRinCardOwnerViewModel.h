...
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0xC4AE310)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_DECKSIZELIMIT_OFFSET UNITYSDK_OFFSET(0xC4AE2C0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_ISNEUTRAL_OFFSET UNITYSDK_OFFSET(0xC4AE280)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC4AE220)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_OWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0xC4AE320)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_TYPENUMBER_OFFSET UNITYSDK_OFFSET(0xC4AE1A0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC4AE150)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0xC4AE470)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4AE0E0)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinCardOwnerViewModel_TypeDefinitionIndex = 76191;
