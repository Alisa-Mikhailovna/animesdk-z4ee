...
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDTAGVIEWMODEL_GET_ID_OFFSET UNITYSDK_OFFSET(0xC4AE4F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDTAGVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC4AE540)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDTAGVIEWMODEL_GET_UISTATE_OFFSET UNITYSDK_OFFSET(0xC4AE5A0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDTAGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4AB160)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinCardTagViewModel_TypeDefinitionIndex = 76196;
