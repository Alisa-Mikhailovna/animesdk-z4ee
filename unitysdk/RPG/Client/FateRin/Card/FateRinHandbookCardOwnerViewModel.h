...
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_GET_ACQUIREDCOUNT_OFFSET UNITYSDK_OFFSET(0xC4B4050)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_GET_ALLCOUNT_OFFSET UNITYSDK_OFFSET(0xC4B4070)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_GET_CARDVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0xC4B4210)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC4B40C0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC4B3D80)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_GET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0xC4B3D60)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_GET_SHOWDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0xC4B4250)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_GET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0xC4B3F00)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_REFRESHACQUIRE_OFFSET UNITYSDK_OFFSET(0xC4B39E0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_SET_ACQUIREDCOUNT_OFFSET UNITYSDK_OFFSET(0xC4B4060)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_SET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0xC4B3D70)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL_SET_SHOWDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0xC4B4260)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B3440)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL__ONSHOWDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0xC4B3C60)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xC4B4270)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinHandbookCardOwnerViewModel_TypeDefinitionIndex = 76222;
	...
	public:
		...
		::Class_0_16E4307DCC419505_313<::RPG::Client::FateRin::Card::IFateRinSystemCardViewModel*>* _ShowDetailDialog_k__BackingField; // 0x38
		::RPG::GameCore::FateRinHouguOwnerType _OwnerType_k__BackingField; // 0x40
		::System::Int32 _AcquiredCount_k__BackingField; // 0x44

		::System::Void _ctor(::RPG::GameCore::FateRinHouguOwnerType a1, ::Class_1_4557C77922A20D8C* a2, ::Class_0_16E4307DCC419505_1304* a3, ::Class_0_16E4307DCC419505_1289* a4)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::FateRinHouguOwnerType, ::Class_1_4557C77922A20D8C*, ::Class_0_16E4307DCC419505_1304*, ::Class_0_16E4307DCC419505_1289*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDOWNERVIEWMODEL__CTOR_OFFSET))(this, a1, a2, a3, a4);
		}
