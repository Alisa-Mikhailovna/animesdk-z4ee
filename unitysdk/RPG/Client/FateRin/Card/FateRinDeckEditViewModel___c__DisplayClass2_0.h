...
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITVIEWMODEL___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B2230)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITVIEWMODEL___C__DISPLAYCLASS2_0___DOSAVEDECKSANDEXIT_B__0_OFFSET UNITYSDK_OFFSET(0xC4B2490)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITVIEWMODEL___C__DISPLAYCLASS2_0___DOSAVEDECKSANDEXIT_B__1_OFFSET UNITYSDK_OFFSET(0xC4B2560)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinDeckEditViewModel___c__DisplayClass2_0_TypeDefinitionIndex = 76205;
