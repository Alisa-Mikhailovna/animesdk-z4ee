...
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDMANACOSTVIEWMODEL_GET_MANACOST_OFFSET UNITYSDK_OFFSET(0xC4A84A0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDMANACOSTVIEWMODEL_GET_UISTATE_OFFSET UNITYSDK_OFFSET(0xC4A84F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDMANACOSTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A83A0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDMANACOSTVIEWMODEL__ONBATTLECARDMODELCHANGEMESSAGE_OFFSET UNITYSDK_OFFSET(0xC4A8430)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinBattleCardManaCostViewModel_TypeDefinitionIndex = 76189;
