...
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDKEYWORDLISTVIEWMODEL_GET_HASKEYWORDS_OFFSET UNITYSDK_OFFSET(0xC4ADCB0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDKEYWORDLISTVIEWMODEL_GET_KEYWORDS_OFFSET UNITYSDK_OFFSET(0xC4ADC70)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDKEYWORDLISTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4AB1E0)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinCardKeywordListViewModel_TypeDefinitionIndex = 76183;
