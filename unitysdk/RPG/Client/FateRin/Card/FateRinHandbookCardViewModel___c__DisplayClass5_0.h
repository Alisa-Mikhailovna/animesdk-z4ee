...
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDVIEWMODEL___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B60A0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDVIEWMODEL___C__DISPLAYCLASS5_0___GETCARDVIEWMODELLISTBYTABOWNERTYPE_B__1_OFFSET UNITYSDK_OFFSET(0xC4B69B0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDVIEWMODEL___C__DISPLAYCLASS5_0___GETCARDVIEWMODELLISTBYTABOWNERTYPE_B__2_OFFSET UNITYSDK_OFFSET(0xC4B69E0)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinHandbookCardViewModel___c__DisplayClass5_0_TypeDefinitionIndex = 76234;
