...
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDDECKVIEWMODEL___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4ACD40)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDDECKVIEWMODEL___C__DISPLAYCLASS1_0___CTOR_B__0_OFFSET UNITYSDK_OFFSET(0xC4ADB20)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDDECKVIEWMODEL___C__DISPLAYCLASS1_0___CTOR_B__1_OFFSET UNITYSDK_OFFSET(0xC4ADB90)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDDECKVIEWMODEL___C__DISPLAYCLASS1_0___CTOR_B__2_OFFSET UNITYSDK_OFFSET(0xC4ADC00)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinCardDeckViewModel___c__DisplayClass1_0_TypeDefinitionIndex = 76178;
