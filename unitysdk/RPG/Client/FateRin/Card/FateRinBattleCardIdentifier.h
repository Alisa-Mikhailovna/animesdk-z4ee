...
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_COMPARETO_OFFSET UNITYSDK_OFFSET(0x149270)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x7A7C0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1493C0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x149360)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_FROMUID_OFFSET UNITYSDK_OFFSET(0xC4A7E20)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x149350)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xC497970)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xC498250)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x1492E0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1492D0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x2CAC0)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinBattleCardIdentifier_TypeDefinitionIndex = 76147;
