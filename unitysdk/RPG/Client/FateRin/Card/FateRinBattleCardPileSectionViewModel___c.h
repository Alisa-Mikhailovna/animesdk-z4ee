...
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILESECTIONVIEWMODEL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC4A9340)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILESECTIONVIEWMODEL___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A9380)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILESECTIONVIEWMODEL___C___CTOR_B__1_1_OFFSET UNITYSDK_OFFSET(0xC4A9390)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinBattleCardPileSectionViewModel___c_TypeDefinitionIndex = 76159;
	...
	public:
		...
		{
			return (::RPG::Client::FateRin::Card::FateRinBattleCardPileSectionViewModel___c**)Il2CppClass::FromTypeDefinitionIndex(FateRinBattleCardPileSectionViewModel___c_TypeDefinitionIndex)->GetStaticField(0x9A80);
		}
		static ::System::Comparison_1<::RPG::Client::FateRin::Card::IFateRinBattleCardViewModel*>** StaticGet___9__1_1()
		{
			return (::System::Comparison_1<::RPG::Client::FateRin::Card::IFateRinBattleCardViewModel*>**)Il2CppClass::FromTypeDefinitionIndex(FateRinBattleCardPileSectionViewModel___c_TypeDefinitionIndex)->GetStaticField(0x9A88);
		}
