...
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL_GET_ID_OFFSET UNITYSDK_OFFSET(0xC4B6EF0)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xC4B6E50)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC4B6F40)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL_GET_UISTATE_OFFSET UNITYSDK_OFFSET(0xC4B70C0)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B6E40)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinInvalidCardTagViewModel_TypeDefinitionIndex = 76207;
	...
	public:
		...
		{
			return (::RPG::Client::FateRin::Card::FateRinInvalidCardTagViewModel**)Il2CppClass::FromTypeDefinitionIndex(FateRinInvalidCardTagViewModel_TypeDefinitionIndex)->GetStaticField(0xA380);
		}
