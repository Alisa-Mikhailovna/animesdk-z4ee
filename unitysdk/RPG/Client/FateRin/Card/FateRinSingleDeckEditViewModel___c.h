...
#define RPG_CLIENT_FATERIN_CARD_FATERINSINGLEDECKEDITVIEWMODEL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC4BF1F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINSINGLEDECKEDITVIEWMODEL___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC4BF230)
#define RPG_CLIENT_FATERIN_CARD_FATERINSINGLEDECKEDITVIEWMODEL___C___CREATEACQUIREDLISTFROMOWNERTYPE_B__8_0_OFFSET UNITYSDK_OFFSET(0xC4BF240)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinSingleDeckEditViewModel___c_TypeDefinitionIndex = 76218;
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::FateRin::Card::IFateRinSystemCardViewModel*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(FateRinSingleDeckEditViewModel___c_TypeDefinitionIndex)->GetStaticField(0xBC40);
		}
		static ::RPG::Client::FateRin::Card::FateRinSingleDeckEditViewModel___c** StaticGet___9()
		{
			return (::RPG::Client::FateRin::Card::FateRinSingleDeckEditViewModel___c**)Il2CppClass::FromTypeDefinitionIndex(FateRinSingleDeckEditViewModel___c_TypeDefinitionIndex)->GetStaticField(0xBC48);
		}
