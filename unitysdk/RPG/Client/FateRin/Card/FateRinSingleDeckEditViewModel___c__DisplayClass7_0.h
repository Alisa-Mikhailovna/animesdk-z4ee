...
#define RPG_CLIENT_FATERIN_CARD_FATERINSINGLEDECKEDITVIEWMODEL___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC4BCC80)
#define RPG_CLIENT_FATERIN_CARD_FATERINSINGLEDECKEDITVIEWMODEL___C__DISPLAYCLASS7_0___SETCURRENTDECK_B__0_OFFSET UNITYSDK_OFFSET(0xC4BF350)
#define RPG_CLIENT_FATERIN_CARD_FATERINSINGLEDECKEDITVIEWMODEL___C__DISPLAYCLASS7_0___SETCURRENTDECK_B__1_OFFSET UNITYSDK_OFFSET(0xC4BF3C0)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinSingleDeckEditViewModel___c__DisplayClass7_0_TypeDefinitionIndex = 76219;
