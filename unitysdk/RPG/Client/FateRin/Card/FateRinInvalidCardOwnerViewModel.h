...
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0xC4B6D80)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL_GET_DECKSIZELIMIT_OFFSET UNITYSDK_OFFSET(0xC4B6D40)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xC4B6B40)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL_GET_ISNEUTRAL_OFFSET UNITYSDK_OFFSET(0xC4B6D00)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC4B6C90)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL_GET_OWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0xC4B6DC0)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL_GET_TYPENUMBER_OFFSET UNITYSDK_OFFSET(0xC4B6C20)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC4B6BE0)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL_GET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0xC4B6E00)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDOWNERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B6B30)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinInvalidCardOwnerViewModel_TypeDefinitionIndex = 76209;
	...
	public:
		...
		{
			return (::RPG::Client::FateRin::Card::FateRinInvalidCardOwnerViewModel**)Il2CppClass::FromTypeDefinitionIndex(FateRinInvalidCardOwnerViewModel_TypeDefinitionIndex)->GetStaticField(0xA2C0);
		}
