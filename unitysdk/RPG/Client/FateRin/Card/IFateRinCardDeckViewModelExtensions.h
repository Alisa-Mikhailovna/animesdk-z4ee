...
#define RPG_CLIENT_FATERIN_CARD_IFATERINCARDDECKVIEWMODELEXTENSIONS_CONTAINSCARD_OFFSET UNITYSDK_OFFSET(0xC4B8DC0)
#define RPG_CLIENT_FATERIN_CARD_IFATERINCARDDECKVIEWMODELEXTENSIONS_GETALLCARDSCOUNT_OFFSET UNITYSDK_OFFSET(0xC4BF620)
#define RPG_CLIENT_FATERIN_CARD_IFATERINCARDDECKVIEWMODELEXTENSIONS_GETALLCARDSLIST_OFFSET UNITYSDK_OFFSET(0xC4BF460)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int IFateRinCardDeckViewModelExtensions_TypeDefinitionIndex = 76179;
