...
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_ASYNCINITIALIZE_OFFSET UNITYSDK_OFFSET(0xC4AFC50)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_DECK_OFFSET UNITYSDK_OFFSET(0xC4B02F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_ISINDELETESTATE_OFFSET UNITYSDK_OFFSET(0xC4B0310)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_ONCARDCLICK_OFFSET UNITYSDK_OFFSET(0xC4B0340)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_SAVECHANGESTOUPPERPAGE_OFFSET UNITYSDK_OFFSET(0xC4B0350)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_SWITCHDELETESTATE_OFFSET UNITYSDK_OFFSET(0xC4B0330)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_SET_DECK_OFFSET UNITYSDK_OFFSET(0xC4B0300)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_SET_ISINDELETESTATE_OFFSET UNITYSDK_OFFSET(0xC4B0320)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4AFA50)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__ONCARDCLICK_OFFSET UNITYSDK_OFFSET(0xC4AFF30)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__SAVECHANGESTOUPPERPAGE_OFFSET UNITYSDK_OFFSET(0xC4B0210)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__SWITCHDELETESTATE_OFFSET UNITYSDK_OFFSET(0xC4AFE90)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinDeckEditPreviewViewModel_TypeDefinitionIndex = 76202;

	class FateRinDeckEditPreviewViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::Class_0_16E4307DCC419505_313<::RPG::Client::FateRin::Card::IFateRinSystemCardViewModel*>* _OnCardClick_k__BackingField; // 0x20
		...
		::RPG::Client::FateRin::Card::FateRinCardDeckViewModel* _Deck_k__BackingField; // 0x40
		::Class_0_16E4307DCC419505_311* _SaveChangesToUpperPage_k__BackingField; // 0x48
		::Class_0_16E4307DCC419505_311* _SwitchDeleteState_k__BackingField; // 0x50
		::Class_0_16E4307DCC419505_1289* _OwnerVmFactory; // 0x58
		::System::Boolean _DeckModified; // 0x60
		::System::Boolean _IsInDeleteState_k__BackingField; // 0x61

		::System::Void _ctor(::Class_1_4557C77922A20D8C* a1, ::Class_1_7B5BC5F7531D3B01* a2, ::Class_0_16E4307DCC419505_1289* a3, ::Class_1_5F4D64A4B97E38F9* a4)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_4557C77922A20D8C*, ::Class_1_7B5BC5F7531D3B01*, ::Class_0_16E4307DCC419505_1289*, ::Class_1_5F4D64A4B97E38F9*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__CTOR_OFFSET))(this, a1, a2, a3, a4);
		}
