...
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_ADD_ONSELECTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xC4B2A30)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_ISINSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xC4B2A10)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC4B28C0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0xC4B2880)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_TABICONPATH_OFFSET UNITYSDK_OFFSET(0xC4B2970)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_TABREPORTNAME_OFFSET UNITYSDK_OFFSET(0xC4B2AF0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_TABTYPE_OFFSET UNITYSDK_OFFSET(0xC4B27B0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_UISTATE_OFFSET UNITYSDK_OFFSET(0xC4B29C0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_REMOVE_ONSELECTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xC4B2A90)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xC4B2800)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_SET_ISINSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xC4B2A20)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_SET_TABREPORTNAME_OFFSET UNITYSDK_OFFSET(0xC4B2B00)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B26A0)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinHandbookCardAllTabViewModel_TypeDefinitionIndex = 76226;
