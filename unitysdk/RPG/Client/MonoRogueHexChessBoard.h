...
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_CLEARCELLGAMEOBJECTPOOL_OFFSET UNITYSDK_OFFSET(0xCD1CD60)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_GETMONOITEMLIST_OFFSET UNITYSDK_OFFSET(0xCD1DCE0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_INITCHESTBOARDITEM_OFFSET UNITYSDK_OFFSET(0xCD1CF70)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD1CA70)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xCD1DD20)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_REFRESHPOSITION_OFFSET UNITYSDK_OFFSET(0xCD1DEC0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD1C020)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__ADDSELECTABLEITEM_OFFSET UNITYSDK_OFFSET(0xCD1CDF0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__CHANGEGAMEOBJECTLAYER_OFFSET UNITYSDK_OFFSET(0xCD1DAB0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__CLEARSELECTABLEITEM_OFFSET UNITYSDK_OFFSET(0xCD1CCD0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xCD1E500)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__ENDGETCELLGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xCD1DBC0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__GETCELLGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xCD1D940)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__GETCELLPOSTION_1_OFFSET UNITYSDK_OFFSET(0xCD1DFF0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__GETCELLPOSTION_OFFSET UNITYSDK_OFFSET(0xCD1D9E0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__GETPREFABINDEX_OFFSET UNITYSDK_OFFSET(0xCD1D8A0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__ONCLICKEMPTY_OFFSET UNITYSDK_OFFSET(0xCD1CA20)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__STARTGETCELLGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xCD1D590)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__TICKFADEIN_OFFSET UNITYSDK_OFFSET(0xCD1C870)
