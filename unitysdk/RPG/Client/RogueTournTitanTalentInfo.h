...
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD48FDC0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO_GETNEXTUNLOCKTALENT_OFFSET UNITYSDK_OFFSET(0xD48FEC0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO_GETNODEDATABYTITANTYPE_OFFSET UNITYSDK_OFFSET(0xD48FFE0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO_GETTALENTUNLOCKEDPROGRESSINFO_OFFSET UNITYSDK_OFFSET(0xD490060)
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO_GET_TALENTCOINICONPATH_OFFSET UNITYSDK_OFFSET(0xD4903D0)
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO_GET__TALENTCOINITEMDATA_OFFSET UNITYSDK_OFFSET(0xD490340)
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO_GET__TALENTCOINITEMID_OFFSET UNITYSDK_OFFSET(0xD490250)
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO_INIT_OFFSET UNITYSDK_OFFSET(0xD48F380)
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD48F280)
#define RPG_CLIENT_ROGUETOURNTITANTALENTINFO__GENERATETALENTUNLOCKSEQUENCE_OFFSET UNITYSDK_OFFSET(0xD48FA10)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::RogueTournTitanTalentNodeData*>* _TalentID2Nodes; // 0x10
		...
		::System::Collections::Generic::List_1<::RPG::Client::RogueTournTitanTalentNodeData*>* _OrderedTalentNodes; // 0x20
