...
#define RPG_CLIENT_MONOPAMSKINPROCESSCONTROLLER_GET_PAMPOSITION_OFFSET UNITYSDK_OFFSET(0xCD115F0)
#define RPG_CLIENT_MONOPAMSKINPROCESSCONTROLLER_GET_PAMROTATION_OFFSET UNITYSDK_OFFSET(0xCD116D0)
#define RPG_CLIENT_MONOPAMSKINPROCESSCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD11730)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPamSkinProcessController_TypeDefinitionIndex = 69540;
