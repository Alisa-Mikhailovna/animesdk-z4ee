...
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0xD6F0650)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0xD6F06D0)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET_PHOTOTYPE_OFFSET UNITYSDK_OFFSET(0xD6F0850)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0xD6F07E0)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0xD6F0760)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0xD6F04A0)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_SETGENDER_OFFSET UNITYSDK_OFFSET(0xD6F0450)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD6F08A0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int MissionPhotoItem_TypeDefinitionIndex = 70887;
