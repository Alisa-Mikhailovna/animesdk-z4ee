...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLSETTLEDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0xD720EE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERSKILLSETTLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD71D7A0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerSkillSettleData_TypeDefinitionIndex = 70955;
