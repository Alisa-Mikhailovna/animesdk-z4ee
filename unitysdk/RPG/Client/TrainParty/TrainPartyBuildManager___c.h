...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDMANAGER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xD7092A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDMANAGER___C__CTOR_OFFSET UNITYSDK_OFFSET(0xD7092E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDMANAGER___C__GETSHOWINACTIVITYAREAINFOLIST_B__55_0_OFFSET UNITYSDK_OFFSET(0xD7092F0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildManager___c_TypeDefinitionIndex = 70902;
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::TrainParty::TrainPartyBuildAreaInfo*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(TrainPartyBuildManager___c_TypeDefinitionIndex)->GetStaticField(0x46DE0);
		}
		static ::RPG::Client::TrainParty::TrainPartyBuildManager___c** StaticGet___9()
		{
			return (::RPG::Client::TrainParty::TrainPartyBuildManager___c**)Il2CppClass::FromTypeDefinitionIndex(TrainPartyBuildManager___c_TypeDefinitionIndex)->GetStaticField(0x46DE8);
		}
