...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_MISSIONPHOTOCOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0xD6FC0E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_MISSIONPHOTOCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6FC1A0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildDisplayWallContext_MissionPhotoComparer_TypeDefinitionIndex = 70900;
