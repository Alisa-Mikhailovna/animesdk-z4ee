...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0xD6F9FE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_GET_CURRENTDIYITEMS_OFFSET UNITYSDK_OFFSET(0xD6FB230)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_GET_CURRENTSLOT_OFFSET UNITYSDK_OFFSET(0xD6FB210)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_GET_CURRENTSUBAREA_OFFSET UNITYSDK_OFFSET(0xD6FB1F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_GET_SUBAREALIST_OFFSET UNITYSDK_OFFSET(0xD6FB1D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_REFRESHCURRENTDIYITEMS_OFFSET UNITYSDK_OFFSET(0xD6FA5D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_SET_CURRENTDIYITEMS_OFFSET UNITYSDK_OFFSET(0xD6FB240)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_SET_CURRENTSLOT_OFFSET UNITYSDK_OFFSET(0xD6FB220)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_SET_CURRENTSUBAREA_OFFSET UNITYSDK_OFFSET(0xD6FB200)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_SET_SUBAREALIST_OFFSET UNITYSDK_OFFSET(0xD6FB1E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_SORTCURRENTDIYITEMS_OFFSET UNITYSDK_OFFSET(0xD6FA710)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_SYNCCURRENTDIYITEMREFS_OFFSET UNITYSDK_OFFSET(0xD6FA130)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT__CCTOR_OFFSET UNITYSDK_OFFSET(0xD6FB250)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT__CREATECOMPOSITECOMPARER_OFFSET UNITYSDK_OFFSET(0xD6FA7A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD6FA070)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT__FINDMATCHINGITEM_OFFSET UNITYSDK_OFFSET(0xD6FA410)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT__GETDEFAULTSUBAREA_OFFSET UNITYSDK_OFFSET(0xD6FAE70)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildDisplayWallContext_TypeDefinitionIndex = 70891;
	...
	public:
		...
		{
			return (::RPG::Client::TrainParty::TrainPartyBuildDisplayWallContext_SlotComparerSelector**)Il2CppClass::FromTypeDefinitionIndex(TrainPartyBuildDisplayWallContext_TypeDefinitionIndex)->GetStaticField(0x46910);
		}
		...
		::RPG::Client::TrainParty::TrainPartyBuildSlotInfo* _CurrentSlot_k__BackingField; // 0x18
		::System::Collections::Generic::List_1<::RPG::Client::TrainParty::TrainPartyBuildDIYItem*>* _CurrentDIYItems_k__BackingField; // 0x20
		::RPG::Client::TrainParty::TrainPartyBuildSubArea* _CurrentSubArea_k__BackingField; // 0x28
