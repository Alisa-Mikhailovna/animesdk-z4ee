...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xD725670)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartySimpleTalkInstance_TypeDefinitionIndex = 70925;
