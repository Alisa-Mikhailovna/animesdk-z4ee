...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO_GETDISPLAYITEMDATALIST_OFFSET UNITYSDK_OFFSET(0xD6FDB00)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO_GET_CANTAKEREWARD_OFFSET UNITYSDK_OFFSET(0xD6FE140)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO_GET_ISRARE_OFFSET UNITYSDK_OFFSET(0xD6FE270)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO_GET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0xD6FDED0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO_GET_LEVELTITLE_OFFSET UNITYSDK_OFFSET(0xD6FE200)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xD6FE0F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO_SYSTEM_ICOMPARABLE_RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO__COMPARETO_OFFSET UNITYSDK_OFFSET(0xD6FE040)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO_TRYTAKEREWARD_OFFSET UNITYSDK_OFFSET(0xD6FDC70)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD6FDAF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDLEVELREWARDINFO__ITEMSORT_OFFSET UNITYSDK_OFFSET(0xD6FDF70)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildLevelRewardInfo_TypeDefinitionIndex = 70914;
