...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_LIGHTCONEPHOTOCOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0xD6FBFC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_LIGHTCONEPHOTOCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6FC0D0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildDisplayWallContext_LightConePhotoComparer_TypeDefinitionIndex = 70899;
