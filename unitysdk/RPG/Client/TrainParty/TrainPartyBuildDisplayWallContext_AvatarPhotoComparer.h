...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_AVATARPHOTOCOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0xD6FB660)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_AVATARPHOTOCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6FBAB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_AVATARPHOTOCOMPARER__GETID_OFFSET UNITYSDK_OFFSET(0xD6FBA00)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDISPLAYWALLCONTEXT_AVATARPHOTOCOMPARER__GETRARITY_OFFSET UNITYSDK_OFFSET(0xD6FB950)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildDisplayWallContext_AvatarPhotoComparer_TypeDefinitionIndex = 70898;
