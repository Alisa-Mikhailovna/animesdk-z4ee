...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGPREVIEWINFO_MEETINGPREVIEWCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0xD718FD0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGPREVIEWINFO_MEETINGPREVIEWCONTEXT_GET_ISALLCARDUNIQUE_OFFSET UNITYSDK_OFFSET(0xD71A2C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGPREVIEWINFO_MEETINGPREVIEWCONTEXT_GET_ISFINALPLAY_OFFSET UNITYSDK_OFFSET(0xD71A260)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGPREVIEWINFO_MEETINGPREVIEWCONTEXT_GET_LEFTCARDNUM_OFFSET UNITYSDK_OFFSET(0xD71A320)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGPREVIEWINFO_MEETINGPREVIEWCONTEXT_GET_SELECTEDCARDCOUNT_OFFSET UNITYSDK_OFFSET(0xD71A210)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGPREVIEWINFO_MEETINGPREVIEWCONTEXT_ISPASSENGERSCORED_OFFSET UNITYSDK_OFFSET(0xD719BB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMEETINGPREVIEWINFO_MEETINGPREVIEWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD718ED0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyMeetingPreviewInfo_MeetingPreviewContext_TypeDefinitionIndex = 70938;

	class TrainPartyMeetingPreviewInfo_MeetingPreviewContext : public ::System::Object
	{
	public:
		::RPG::Client::TrainParty::TrainPartyMeetingCategoryInfo* MatchCategoryInfo; // 0x10
