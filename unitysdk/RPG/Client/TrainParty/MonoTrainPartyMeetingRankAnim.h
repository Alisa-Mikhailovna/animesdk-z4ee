...
#define RPG_CLIENT_TRAINPARTY_MONOTRAINPARTYMEETINGRANKANIM_PLAY_OFFSET UNITYSDK_OFFSET(0xD6F0D40)
#define RPG_CLIENT_TRAINPARTY_MONOTRAINPARTYMEETINGRANKANIM_SETFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD6F0C50)
#define RPG_CLIENT_TRAINPARTY_MONOTRAINPARTYMEETINGRANKANIM_SETRANKUPCALLBACK_OFFSET UNITYSDK_OFFSET(0xD6F0CA0)
#define RPG_CLIENT_TRAINPARTY_MONOTRAINPARTYMEETINGRANKANIM_SETRANKUPSLIDER_OFFSET UNITYSDK_OFFSET(0xD6F0CF0)
#define RPG_CLIENT_TRAINPARTY_MONOTRAINPARTYMEETINGRANKANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0xD6F08B0)
#define RPG_CLIENT_TRAINPARTY_MONOTRAINPARTYMEETINGRANKANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xD6F0F50)
#define RPG_CLIENT_TRAINPARTY_MONOTRAINPARTYMEETINGRANKANIM__ONPLAYINGFINISH_OFFSET UNITYSDK_OFFSET(0xD6F0BE0)
#define RPG_CLIENT_TRAINPARTY_MONOTRAINPARTYMEETINGRANKANIM__ONPROGRESS_OFFSET UNITYSDK_OFFSET(0xD6F09A0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int MonoTrainPartyMeetingRankAnim_TypeDefinitionIndex = 70879;
