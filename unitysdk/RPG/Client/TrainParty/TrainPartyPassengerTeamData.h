...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GETALLPASSENGERS_OFFSET UNITYSDK_OFFSET(0xD721B40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_DEFAULTSKILLINFO_OFFSET UNITYSDK_OFFSET(0xD721D10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_INITIALMEETINGSKILL_OFFSET UNITYSDK_OFFSET(0xD721CC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_LEADERPASSENGER_OFFSET UNITYSDK_OFFSET(0xD721BA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_LEADERWORKINGBUFFID_OFFSET UNITYSDK_OFFSET(0xD721C70)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_TEAMID_OFFSET UNITYSDK_OFFSET(0xD721B80)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_TEAMNAME_OFFSET UNITYSDK_OFFSET(0xD721C00)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_WORKINGBUFFROW_OFFSET UNITYSDK_OFFSET(0xD721E20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_SET_TEAMID_OFFSET UNITYSDK_OFFSET(0xD721B90)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD721920)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerTeamData_TypeDefinitionIndex = 70958;
