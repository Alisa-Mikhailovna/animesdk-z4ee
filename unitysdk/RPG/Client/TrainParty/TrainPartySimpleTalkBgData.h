...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_BGCONFIGJSONPATH_OFFSET UNITYSDK_OFFSET(0xD7252A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_BGIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xD7251A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_TRIGGERANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0xD725340)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xD725240)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD725190)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartySimpleTalkBgData_TypeDefinitionIndex = 70922;
