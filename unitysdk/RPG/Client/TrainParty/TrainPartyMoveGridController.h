...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_MOVE_OFFSET UNITYSDK_OFFSET(0xD71B420)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xD71B580)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_SETMOVEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD71B3D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xD71B190)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_TESTMOVE_OFFSET UNITYSDK_OFFSET(0xD71B5F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_TESTRESET_OFFSET UNITYSDK_OFFSET(0xD71B650)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD71B220)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD71B6E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER__FINISHMOVE_OFFSET UNITYSDK_OFFSET(0xD71B370)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyMoveGridController_TypeDefinitionIndex = 70882;
