...
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGESLOTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xD6EEDB0)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGESLOTVIEWMODEL_GET_BADGE_OFFSET UNITYSDK_OFFSET(0xD6EEE70)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGESLOTVIEWMODEL_GET_SLOTID_OFFSET UNITYSDK_OFFSET(0xD6EEE50)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGESLOTVIEWMODEL_SET_BADGE_OFFSET UNITYSDK_OFFSET(0xD6EEE80)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGESLOTVIEWMODEL_SET_SLOTID_OFFSET UNITYSDK_OFFSET(0xD6EEE60)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGESLOTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD6EEE40)

namespace RPG::Client::TrainParty::BadgeWall
{
	inline static constexpr unsigned int TrainPartyBuildBadgeSlotViewModel_TypeDefinitionIndex = 70981;
