...
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xD6EEE90)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_GET_DETAILVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6EF250)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_GET_SELECTEDSLOTID_OFFSET UNITYSDK_OFFSET(0xD6EF270)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_GET_SLOTSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6EF230)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_SET_DETAILVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6EF260)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_SET_SELECTEDSLOTID_OFFSET UNITYSDK_OFFSET(0xD6EF280)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_SET_SLOTSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6EF240)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD6EF220)

namespace RPG::Client::TrainParty::BadgeWall
{
	inline static constexpr unsigned int TrainPartyBuildBadgeWallViewModel_TypeDefinitionIndex = 70982;
