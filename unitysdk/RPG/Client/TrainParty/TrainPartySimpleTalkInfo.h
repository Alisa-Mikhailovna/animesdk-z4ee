...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xD725450)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_GET_BGDATA_OFFSET UNITYSDK_OFFSET(0xD7255D0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_GET_NEEDLOADAVATARPREFAB_OFFSET UNITYSDK_OFFSET(0xD725570)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_GET_REPLACEPARAMS_OFFSET UNITYSDK_OFFSET(0xD7255F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_GET_TALKCONTENT_OFFSET UNITYSDK_OFFSET(0xD725550)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_SET_BGDATA_OFFSET UNITYSDK_OFFSET(0xD7255E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_SET_REPLACEPARAMS_OFFSET UNITYSDK_OFFSET(0xD725600)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_SET_TALKCONTENT_OFFSET UNITYSDK_OFFSET(0xD725560)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD7253E0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartySimpleTalkInfo_TypeDefinitionIndex = 70923;
