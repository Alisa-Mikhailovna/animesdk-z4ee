...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_GET_LOGCONTENT_OFFSET UNITYSDK_OFFSET(0xD723B60)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xD723AB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_GET_RECORDTYPE_OFFSET UNITYSDK_OFFSET(0xD723B10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_GET_REPLACEPARAMS_OFFSET UNITYSDK_OFFSET(0xD723B80)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_RECORD_OFFSET UNITYSDK_OFFSET(0xD723950)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_SET_LOGCONTENT_OFFSET UNITYSDK_OFFSET(0xD723B70)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_SET_REPLACEPARAMS_OFFSET UNITYSDK_OFFSET(0xD723B90)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_SYSTEM_ICOMPARABLE_RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO__COMPARETO_OFFSET UNITYSDK_OFFSET(0xD723A00)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD723940)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyRecordInfo_TypeDefinitionIndex = 70961;
