...
#define RPG_CLIENT_ADVGMSUMMONMONSTERITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBC8C2A0)

namespace RPG::Client
{
	inline static constexpr unsigned int AdvGMSummonMonsterItemContext_TypeDefinitionIndex = 69427;
