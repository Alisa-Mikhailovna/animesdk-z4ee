...
#define RPG_CLIENT_CHENLINGPRIVILEGETREENODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0xC0D7880)
#define RPG_CLIENT_CHENLINGPRIVILEGETREENODE_ADDPARENT_OFFSET UNITYSDK_OFFSET(0xC0D7AE0)
#define RPG_CLIENT_CHENLINGPRIVILEGETREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC0D7800)
