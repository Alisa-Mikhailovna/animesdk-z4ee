...
#define RPG_CLIENT_AUTOSCROLLRECT_METHOD_7_5B1233DEA9A20CC7_OFFSET UNITYSDK_OFFSET(0xBDD18D0)
#define RPG_CLIENT_AUTOSCROLLRECT_METHOD_7_93190E731E31C79A_OFFSET UNITYSDK_OFFSET(0xBDD15C0)
#define RPG_CLIENT_AUTOSCROLLRECT_SETITEMSELECTCALLBACK_OFFSET UNITYSDK_OFFSET(0xBDD1610)
#define RPG_CLIENT_AUTOSCROLLRECT_SNAPTO_OFFSET UNITYSDK_OFFSET(0xBDD1940)
#define RPG_CLIENT_AUTOSCROLLRECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD1EF0)

namespace RPG::Client
{
	inline static constexpr unsigned int AutoScrollRect_TypeDefinitionIndex = 69232;
