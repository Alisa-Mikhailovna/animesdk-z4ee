...
#define RPG_CLIENT_PLANETFESSPINEUTILS_ADDEMOJIEFFECTCOMPONENT_OFFSET UNITYSDK_OFFSET(0xD0842C0)
#define RPG_CLIENT_PLANETFESSPINEUTILS_ADDMOVECOMPONENT_OFFSET UNITYSDK_OFFSET(0xD084130)
#define RPG_CLIENT_PLANETFESSPINEUTILS_ADDTALKCOMPONENT_OFFSET UNITYSDK_OFFSET(0xD084200)
#define RPG_CLIENT_PLANETFESSPINEUTILS_CREATEPLANETFESAVATARENTITY_OFFSET UNITYSDK_OFFSET(0xD083D70)
#define RPG_CLIENT_PLANETFESSPINEUTILS_ENABLEIDLESHOW_OFFSET UNITYSDK_OFFSET(0xD084500)
#define RPG_CLIENT_PLANETFESSPINEUTILS_RECORDAVATARTALK_OFFSET UNITYSDK_OFFSET(0xD084840)
#define RPG_CLIENT_PLANETFESSPINEUTILS_SETANIMSTATE_OFFSET UNITYSDK_OFFSET(0xD084670)
#define RPG_CLIENT_PLANETFESSPINEUTILS_STARTLEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xD084390)
#define RPG_CLIENT_PLANETFESSPINEUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0xD084BD0)
#define RPG_CLIENT_PLANETFESSPINEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0xD084BC0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(PlanetFesSpineUtils_TypeDefinitionIndex)->GetStaticField(0x692B0);
		}
