...
#define RPG_CLIENT_BASEMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBE2F0A0)
#define RPG_CLIENT_BASEMODULE_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBE2EC90)
#define RPG_CLIENT_BASEMODULE_GET__NET_OFFSET UNITYSDK_OFFSET(0xBE2F1C0)
#define RPG_CLIENT_BASEMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xBE2EE80)
#define RPG_CLIENT_BASEMODULE_ONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0xBE2EFE0)
#define RPG_CLIENT_BASEMODULE_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0xBE2EFA0)
#define RPG_CLIENT_BASEMODULE_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0xBE2F020)
#define RPG_CLIENT_BASEMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xBE2F140)
#define RPG_CLIENT_BASEMODULE__ADDNOTIFYHANDLER_OFFSET UNITYSDK_OFFSET(0xBE2EE20)
#define RPG_CLIENT_BASEMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0xBE2F180)
#define RPG_CLIENT_BASEMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0xBE2F250)
#define RPG_CLIENT_BASEMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xBE2EC80)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(BaseModule_TypeDefinitionIndex)->GetStaticField(0x531F0);
		}
