...
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xCEE92A0)
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xCEE92D0)
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xCEE9290)
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCEE91A0)
