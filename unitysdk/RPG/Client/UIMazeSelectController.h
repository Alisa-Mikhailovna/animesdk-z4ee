...
#define RPG_CLIENT_UIMAZESELECTCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD7E15F0)
#define RPG_CLIENT_UIMAZESELECTCONTROLLER_RESETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xD7E1510)
#define RPG_CLIENT_UIMAZESELECTCONTROLLER_SETSELECTWEAKBLOCK_OFFSET UNITYSDK_OFFSET(0xD7E1440)
#define RPG_CLIENT_UIMAZESELECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7E1770)
