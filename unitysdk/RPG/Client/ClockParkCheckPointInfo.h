...
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_GET_CHECKPOINTDESC_OFFSET UNITYSDK_OFFSET(0xC17D640)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_GET_CHECKPOINTID_OFFSET UNITYSDK_OFFSET(0xC17D600)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_GET_CHECKPOINTTYPE_OFFSET UNITYSDK_OFFSET(0xC17D330)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xC17D620)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_GET_HASCHECK_OFFSET UNITYSDK_OFFSET(0xC17D380)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_GET_HASMULTICHECKSINGLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC17D400)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_REFRESHCHECKPOINTSTATUS_OFFSET UNITYSDK_OFFSET(0xC17CEF0)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_SET_CHECKPOINTID_OFFSET UNITYSDK_OFFSET(0xC17D610)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xC17D630)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO_SYNC_OFFSET UNITYSDK_OFFSET(0xC17C8E0)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC17CC80)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO__FILLCHECKPOINTPARAM_OFFSET UNITYSDK_OFFSET(0xC17CF30)
#define RPG_CLIENT_CLOCKPARKCHECKPOINTINFO__ONCHECKPOINTIDCHANGED_OFFSET UNITYSDK_OFFSET(0xC17CE80)
