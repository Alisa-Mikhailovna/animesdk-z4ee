...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_INIT_OFFSET UNITYSDK_OFFSET(0xD8B9D00)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xD8B9F50)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xD8B9EA0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xD8B9DC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONHIT_OFFSET UNITYSDK_OFFSET(0xD8B9FE0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONLOSSHP_OFFSET UNITYSDK_OFFSET(0xD8BA3C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP__CTOR_OFFSET UNITYSDK_OFFSET(0xD8BA400)
