...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPAREHASEFFECT_METHOD_5_98FEC005A4F55264_OFFSET UNITYSDK_OFFSET(0x1B0E2A40)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPAREHASEFFECT_METHOD_5_9B11AF1FF72E254B_OFFSET UNITYSDK_OFFSET(0x1B0E5C90)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPAREHASEFFECT_METHOD_5_AB6EB0FE0A9F49E8_OFFSET UNITYSDK_OFFSET(0x1B0E5C40)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPAREHASEFFECT_METHOD_5_F4A01425AE24BD00_OFFSET UNITYSDK_OFFSET(0x1B0E1250)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPAREHASEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E1240)
