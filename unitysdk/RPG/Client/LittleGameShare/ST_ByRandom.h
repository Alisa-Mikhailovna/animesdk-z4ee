...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_BYRANDOM_METHOD_5_0BE47BDACEC751FC_OFFSET UNITYSDK_OFFSET(0x1B0E5030)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_BYRANDOM_METHOD_5_3DF17D840518F7BA_OFFSET UNITYSDK_OFFSET(0x1B0E29A0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_BYRANDOM_METHOD_5_926AD33C7D65209D_OFFSET UNITYSDK_OFFSET(0x1B0E5080)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_BYRANDOM_METHOD_5_DA5A30176234CCE9_OFFSET UNITYSDK_OFFSET(0x1B0E0E50)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_BYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E0E40)
