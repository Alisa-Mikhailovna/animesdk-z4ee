...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATRANK_METHOD_5_3F4A17829DCE591D_OFFSET UNITYSDK_OFFSET(0x1B0E6B90)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATRANK_METHOD_5_4032D5482C2B4B09_OFFSET UNITYSDK_OFFSET(0x1B0E6B40)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATRANK_METHOD_5_E9A375189441DF1F_OFFSET UNITYSDK_OFFSET(0x1B0E1770)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATRANK_METHOD_5_EAD0C1CA2582303A_OFFSET UNITYSDK_OFFSET(0x1B0E2B30)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E1760)
