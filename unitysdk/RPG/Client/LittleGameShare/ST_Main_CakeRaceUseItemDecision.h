...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEITEMDECISION_METHOD_5_A414EEC3193C9207_OFFSET UNITYSDK_OFFSET(0x1B0E4300)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEITEMDECISION_METHOD_5_B46C57ECA80FBF73_OFFSET UNITYSDK_OFFSET(0x1B0E8870)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E42F0)
