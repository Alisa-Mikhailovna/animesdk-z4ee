...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATBEHINDDISTANCE_METHOD_5_1D18276D7315E5FC_OFFSET UNITYSDK_OFFSET(0x1B0E13D0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATBEHINDDISTANCE_METHOD_5_8D8CD851B0985BE6_OFFSET UNITYSDK_OFFSET(0x1B0E60A0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATBEHINDDISTANCE_METHOD_5_A727B5C8E37FF09F_OFFSET UNITYSDK_OFFSET(0x1B0E2A90)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATBEHINDDISTANCE_METHOD_5_B2DAFFAFE4332498_OFFSET UNITYSDK_OFFSET(0x1B0E60F0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATBEHINDDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E13C0)
