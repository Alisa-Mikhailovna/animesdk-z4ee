...
#define RPG_CLIENT_MONOMAPPOSESWITCHER_FILLENTITYINFO_1_OFFSET UNITYSDK_OFFSET(0xCD084E0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_FILLENTITYINFO_OFFSET UNITYSDK_OFFSET(0xCD08410)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0xCD08610)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0xCD085F0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xCD08590)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_ISDYNAMICCREATED_OFFSET UNITYSDK_OFFSET(0xCD085D0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_PROPID_OFFSET UNITYSDK_OFFSET(0xCD085B0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_COLLIDER_OFFSET UNITYSDK_OFFSET(0xCD08620)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_ENTITY_OFFSET UNITYSDK_OFFSET(0xCD08600)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xCD085A0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_ISDYNAMICCREATED_OFFSET UNITYSDK_OFFSET(0xCD085E0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_PROPID_OFFSET UNITYSDK_OFFSET(0xCD085C0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD08630)
