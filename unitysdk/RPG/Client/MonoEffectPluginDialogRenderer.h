...
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_DISPOSEDIALOGRENDERER_OFFSET UNITYSDK_OFFSET(0xCCB38F0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0xCCB3E80)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_DIALOGCAMERA_OFFSET UNITYSDK_OFFSET(0xCCB3E10)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_DIALOGTARGETRENDERERS_OFFSET UNITYSDK_OFFSET(0xCCB3F10)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_DIALOGTARGET_OFFSET UNITYSDK_OFFSET(0xCCB3DB0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xCCB3E70)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_0C6D78F7FB2736C2_OFFSET UNITYSDK_OFFSET(0xCCB2CC0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_1092C5537716905B_OFFSET UNITYSDK_OFFSET(0xCCB2AF0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xCCB2DE0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xCCB2E30)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0xCCB2B40)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_B93DCFC57470A0D2_OFFSET UNITYSDK_OFFSET(0xCCB2EE0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_BD658202BB4C4431_OFFSET UNITYSDK_OFFSET(0xCCB2C40)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_F86BB4A64EB8E850_OFFSET UNITYSDK_OFFSET(0xCCB2F60)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_ONVIEWMODESTATECHANGED_OFFSET UNITYSDK_OFFSET(0xCCB3010)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_REFRESHDIALOGRENDERER_OFFSET UNITYSDK_OFFSET(0xCCB3D30)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_RESETDIALOGRENDERER_OFFSET UNITYSDK_OFFSET(0xCCB36C0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_SETOVERRIDEBOUNDS_OFFSET UNITYSDK_OFFSET(0xCCB40B0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xCCB4890)
