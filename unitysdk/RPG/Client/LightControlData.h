...
#define RPG_CLIENT_LIGHTCONTROLDATA_AWAKE_OFFSET UNITYSDK_OFFSET(0xC922970)
#define RPG_CLIENT_LIGHTCONTROLDATA_ISCHILDOFENVNODE_OFFSET UNITYSDK_OFFSET(0xC922880)
#define RPG_CLIENT_LIGHTCONTROLDATA_RESETTOINITIAL_OFFSET UNITYSDK_OFFSET(0xC922C00)
#define RPG_CLIENT_LIGHTCONTROLDATA_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xC922B80)
#define RPG_CLIENT_LIGHTCONTROLDATA_SETINTENSITY_OFFSET UNITYSDK_OFFSET(0xC922AE0)
#define RPG_CLIENT_LIGHTCONTROLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC922D50)
