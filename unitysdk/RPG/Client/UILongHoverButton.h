...
#define RPG_CLIENT_UILONGHOVERBUTTON_GET_ONLONGHOVEREXIT_OFFSET UNITYSDK_OFFSET(0xD7CE000)
#define RPG_CLIENT_UILONGHOVERBUTTON_GET_ONLONGHOVER_OFFSET UNITYSDK_OFFSET(0xD7CDF60)
#define RPG_CLIENT_UILONGHOVERBUTTON_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xD7CE150)
#define RPG_CLIENT_UILONGHOVERBUTTON_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0xD7CE0A0)
#define RPG_CLIENT_UILONGHOVERBUTTON_SET_ONLONGHOVEREXIT_OFFSET UNITYSDK_OFFSET(0xD7CE050)
#define RPG_CLIENT_UILONGHOVERBUTTON_SET_ONLONGHOVER_OFFSET UNITYSDK_OFFSET(0xD7CDFB0)
#define RPG_CLIENT_UILONGHOVERBUTTON_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7CE260)
#define RPG_CLIENT_UILONGHOVERBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0xD7CE5A0)

namespace RPG::Client
{
	inline static constexpr unsigned int UILongHoverButton_TypeDefinitionIndex = 69441;
