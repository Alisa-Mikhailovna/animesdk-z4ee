...
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0xCCC5C00)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCCC59F0)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0xCCC5A90)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC5CB0)
