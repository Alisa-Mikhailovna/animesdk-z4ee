...
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_CHECKSLOTISEFFECTED_OFFSET UNITYSDK_OFFSET(0xC84DE40)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_GETSPECIALSLOTLIST_OFFSET UNITYSDK_OFFSET(0xC84DD90)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_GET_EFFECTSLOTLIST_OFFSET UNITYSDK_OFFSET(0xC84DF60)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_GET__AREACONFIG_OFFSET UNITYSDK_OFFSET(0xC84DFB0)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_ONTRAITCHANGE_OFFSET UNITYSDK_OFFSET(0xC84DC40)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_SET__AREACONFIG_OFFSET UNITYSDK_OFFSET(0xC84DFC0)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC84DC30)
