...
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xCFFB5D0)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER_ISINMOVE_OFFSET UNITYSDK_OFFSET(0xCFFC290)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER_SHOULDFACERIGHT_OFFSET UNITYSDK_OFFSET(0xCFFC2D0)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER_STARTMOVE_OFFSET UNITYSDK_OFFSET(0xCFFB9F0)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER_STOPMOVE_OFFSET UNITYSDK_OFFSET(0xCFFC060)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCFFC360)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER__APPLYPOSITION_OFFSET UNITYSDK_OFFSET(0xCFFC110)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER__CALCULATETARGETPOSITION_OFFSET UNITYSDK_OFFSET(0xCFFBD90)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER__CHECKVALID_OFFSET UNITYSDK_OFFSET(0xCFFBD20)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFC510)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER__GETCURNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0xCFFBC60)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER__GETLOCALPOSITIONFROMWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xCFFB790)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER__STARTTIMER_OFFSET UNITYSDK_OFFSET(0xCFFBEF0)
#define RPG_CLIENT_PLANETFESAVATARMOVECONTROLLER__STOPTIMER_OFFSET UNITYSDK_OFFSET(0xCFFBE90)
