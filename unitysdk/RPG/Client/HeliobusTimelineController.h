...
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC8B21E0)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC8B2A60)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER_PAUSETIMELINE_OFFSET UNITYSDK_OFFSET(0xC8B2120)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0xC8B2180)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xC8B2450)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8B2FF0)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER__ONSCREENSIZECHANGE_OFFSET UNITYSDK_OFFSET(0xC8B2FA0)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER__SETTIMELINEANIMTRACK_OFFSET UNITYSDK_OFFSET(0xC8B2C80)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER__SETTIMELINECAMERATRACK_OFFSET UNITYSDK_OFFSET(0xC8B2B20)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER__SETTIMELINETRACK_OFFSET UNITYSDK_OFFSET(0xC8B2520)
#define RPG_CLIENT_HELIOBUSTIMELINECONTROLLER__TRYMUTETRACK_OFFSET UNITYSDK_OFFSET(0xC8B2E70)

namespace RPG::Client
{
	inline static constexpr unsigned int HeliobusTimelineController_TypeDefinitionIndex = 69498;
