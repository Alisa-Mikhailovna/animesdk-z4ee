...
#define RPG_CLIENT_MULTIPLEDROPUTILS_GETALLDATA_OFFSET UNITYSDK_OFFSET(0xCDEDCE0)
#define RPG_CLIENT_MULTIPLEDROPUTILS_GETBANNERTEXT_OFFSET UNITYSDK_OFFSET(0xCDEE1D0)
#define RPG_CLIENT_MULTIPLEDROPUTILS_GETGUIDETYPEBYMULTIPLEDROPTYPE_OFFSET UNITYSDK_OFFSET(0xCDEE480)
#define RPG_CLIENT_MULTIPLEDROPUTILS_GETMULTIPLEDROPTIMESDATA_OFFSET UNITYSDK_OFFSET(0xCDED350)
#define RPG_CLIENT_MULTIPLEDROPUTILS_GETMULTIPLEDROPTYPEBYFARMTYPE_OFFSET UNITYSDK_OFFSET(0xCDEE570)
#define RPG_CLIENT_MULTIPLEDROPUTILS_GETMULTIPLEDROPTYPEBYGUIDETYPE_OFFSET UNITYSDK_OFFSET(0xCDEE5C0)
#define RPG_CLIENT_MULTIPLEDROPUTILS_GETSIGNICONPATH_OFFSET UNITYSDK_OFFSET(0xCDEE150)
#define RPG_CLIENT_MULTIPLEDROPUTILS_GETTOPDATA_OFFSET UNITYSDK_OFFSET(0xCDEBAF0)
#define RPG_CLIENT_MULTIPLEDROPUTILS_ISINMULTIPLEDROP_1_OFFSET UNITYSDK_OFFSET(0xCDECA40)
#define RPG_CLIENT_MULTIPLEDROPUTILS_ISINMULTIPLEDROP_OFFSET UNITYSDK_OFFSET(0xCDEBAA0)
#define RPG_CLIENT_MULTIPLEDROPUTILS_ISINMULTISPECIFICMULTIPLEDROP_OFFSET UNITYSDK_OFFSET(0xCDED6D0)
#define RPG_CLIENT_MULTIPLEDROPUTILS_ISINSPECIFICMULTIPLEDROP_OFFSET UNITYSDK_OFFSET(0xCDED0A0)
#define RPG_CLIENT_MULTIPLEDROPUTILS_ISMULTIDROPTIMESREMAINING_OFFSET UNITYSDK_OFFSET(0xCDED2F0)
#define RPG_CLIENT_MULTIPLEDROPUTILS_ISMULTIPLEDROPTYPEGUIDEOPENINHANDBOOK_OFFSET UNITYSDK_OFFSET(0xCDEE2F0)
