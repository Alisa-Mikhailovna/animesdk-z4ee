...
#define RPG_CLIENT_MONOWOLFBROCUSTOMDATA_GET_GUNPLAYPUZZLEBOARD_OFFSET UNITYSDK_OFFSET(0xCD3D1C0)
#define RPG_CLIENT_MONOWOLFBROCUSTOMDATA_GET_ISBULLETCNTVALID_OFFSET UNITYSDK_OFFSET(0xCD3D160)
#define RPG_CLIENT_MONOWOLFBROCUSTOMDATA_SET_GUNPLAYPUZZLEBOARD_OFFSET UNITYSDK_OFFSET(0xCD3D1D0)
#define RPG_CLIENT_MONOWOLFBROCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3D1E0)
