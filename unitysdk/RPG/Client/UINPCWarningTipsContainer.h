...
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD7E6610)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD7E6210)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER_REFRESH_OFFSET UNITYSDK_OFFSET(0xD7E7B10)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER_SETCACHEANIMTIME_OFFSET UNITYSDK_OFFSET(0xD7E8C80)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER_SETCACHESTATUS_OFFSET UNITYSDK_OFFSET(0xD7E8BC0)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER_START_OFFSET UNITYSDK_OFFSET(0xD7E5FC0)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7E9260)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER__DESTORYWAYPOINT_OFFSET UNITYSDK_OFFSET(0xD7E72D0)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER__DOLOADWARINGPREFAB_OFFSET UNITYSDK_OFFSET(0xD7E8D50)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER__LOADWARINGPREFAB_OFFSET UNITYSDK_OFFSET(0xD7E6130)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER__ONALLINTERNALRESOURCEREADY_OFFSET UNITYSDK_OFFSET(0xD7E8EA0)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER__ONMAZEMONSTERATTACK_OFFSET UNITYSDK_OFFSET(0xD7E90B0)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER__SPAWNWAYPOINT_OFFSET UNITYSDK_OFFSET(0xD7E8590)
#define RPG_CLIENT_UINPCWARNINGTIPSCONTAINER___DOLOADWARINGPREFAB_B__7_0_OFFSET UNITYSDK_OFFSET(0xD7E9430)
