...
#define RPG_CLIENT_MULTIPATHHELPER_CHECKHARMONYHEROISUNLOCKEDBYREQUEST_OFFSET UNITYSDK_OFFSET(0xCDDB4C0)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKHASCACHEDTRANSFERITEMBYUNLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0xCDDB610)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKISMULTIPATHAVATAR_OFFSET UNITYSDK_OFFSET(0xCDDA780)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKISUNLOCKEDBYREQUEST_OFFSET UNITYSDK_OFFSET(0xCDDB520)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKSUPPORTSEARLYUNLOCK_OFFSET UNITYSDK_OFFSET(0xCDDB010)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKSUPPORTSREPEATUNLOCKREWARD_OFFSET UNITYSDK_OFFSET(0xCDDB0D0)
#define RPG_CLIENT_MULTIPATHHELPER_CLEARCACHEDTRANSFERITEMBYUNLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0xCDDB6E0)
#define RPG_CLIENT_MULTIPATHHELPER_GETALLMULTIPATHAVATARTYPES_OFFSET UNITYSDK_OFFSET(0xCDDB880)
#define RPG_CLIENT_MULTIPATHHELPER_GETCACHEDTRANSFERITEM_OFFSET UNITYSDK_OFFSET(0xCDDB7B0)
#define RPG_CLIENT_MULTIPATHHELPER_GETCHANGECONFIG_OFFSET UNITYSDK_OFFSET(0xCDDB190)
#define RPG_CLIENT_MULTIPATHHELPER_GETDESC_OFFSET UNITYSDK_OFFSET(0xCDDB2B0)
#define RPG_CLIENT_MULTIPATHHELPER_GETGENDERTYPE_OFFSET UNITYSDK_OFFSET(0xCDDA900)
#define RPG_CLIENT_MULTIPATHHELPER_GETMULTIPATHAVATARTYPESBYROLE_OFFSET UNITYSDK_OFFSET(0xCDDBE70)
#define RPG_CLIENT_MULTIPATHHELPER_GETUNLOCKTOAST_OFFSET UNITYSDK_OFFSET(0xCDDAF10)
#define RPG_CLIENT_MULTIPATHHELPER_UNLOCKAVATARPATH_OFFSET UNITYSDK_OFFSET(0xCDDB3B0)
