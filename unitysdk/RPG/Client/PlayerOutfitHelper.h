...
#define RPG_CLIENT_PLAYEROUTFITHELPER_CHECKSHOWPLAYEROUTFITINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xD0AEE30)
#define RPG_CLIENT_PLAYEROUTFITHELPER_GETPLAYEROUTFIT_OFFSET UNITYSDK_OFFSET(0xD0AED60)
#define RPG_CLIENT_PLAYEROUTFITHELPER_SETSHOWPLAYEROUTFITINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xD0AEFF0)
