...
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0xC153620)
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER_DEQUEUE_OFFSET UNITYSDK_OFFSET(0xC1539C0)
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC153580)
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER_ENQUEUE_OFFSET UNITYSDK_OFFSET(0xC1537C0)
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER_EXECUTEBYPROMISE_OFFSET UNITYSDK_OFFSET(0xC153B50)
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER_EXECUTE_OFFSET UNITYSDK_OFFSET(0xC153850)
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER_IMMEDIATELYEXECUTECOMMAND_OFFSET UNITYSDK_OFFSET(0xC1536A0)
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xC1534F0)
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER_PEEK_OFFSET UNITYSDK_OFFSET(0xC153940)
#define RPG_CLIENT_CHIMERASETTLECOMMANDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1534E0)
