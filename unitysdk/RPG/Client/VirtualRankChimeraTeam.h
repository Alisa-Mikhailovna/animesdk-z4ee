...
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_COMPARETO_OFFSET UNITYSDK_OFFSET(0xD89F620)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_GET_CURFINISHWORKCNT_OFFSET UNITYSDK_OFFSET(0xD89F710)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_GET_CURRANK_OFFSET UNITYSDK_OFFSET(0xD89F750)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_GET_ITEMINDEX_OFFSET UNITYSDK_OFFSET(0xD89F6D0)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_GET_MAXFINISHWORKCNT_OFFSET UNITYSDK_OFFSET(0xD89F730)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_GET_TARGETRANK_OFFSET UNITYSDK_OFFSET(0xD89F770)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_GET_TEAMID_OFFSET UNITYSDK_OFFSET(0xD89F6F0)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_SET_CURFINISHWORKCNT_OFFSET UNITYSDK_OFFSET(0xD89F720)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_SET_CURRANK_OFFSET UNITYSDK_OFFSET(0xD89F760)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_SET_ITEMINDEX_OFFSET UNITYSDK_OFFSET(0xD89F6E0)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_SET_MAXFINISHWORKCNT_OFFSET UNITYSDK_OFFSET(0xD89F740)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_SET_TARGETRANK_OFFSET UNITYSDK_OFFSET(0xD89F780)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM_SET_TEAMID_OFFSET UNITYSDK_OFFSET(0xD89F700)
#define RPG_CLIENT_VIRTUALRANKCHIMERATEAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD89F5F0)

namespace RPG::Client
{
	inline static constexpr unsigned int VirtualRankChimeraTeam_TypeDefinitionIndex = 69203;
	...
	public:
		...
		::System::UInt32 _TargetRank_k__BackingField; // 0x1C
