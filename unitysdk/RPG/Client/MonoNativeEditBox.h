...
#define RPG_CLIENT_MONONATIVEEDITBOX_ADD_RETURNPRESSED_OFFSET UNITYSDK_OFFSET(0xCD0C5B0)
#define RPG_CLIENT_MONONATIVEEDITBOX_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD0CD00)
#define RPG_CLIENT_MONONATIVEEDITBOX_CHECKERRORJSONRET_OFFSET UNITYSDK_OFFSET(0xCD0DF60)
#define RPG_CLIENT_MONONATIVEEDITBOX_CREATENATIVEEDIT_OFFSET UNITYSDK_OFFSET(0xCD0E050)
#define RPG_CLIENT_MONONATIVEEDITBOX_GETNATIVEFONTSIZE_OFFSET UNITYSDK_OFFSET(0xCD0DA00)
#define RPG_CLIENT_MONONATIVEEDITBOX_GETSCREENRECTFROMRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCD0CA60)
#define RPG_CLIENT_MONONATIVEEDITBOX_GET_INPUTFIELD_OFFSET UNITYSDK_OFFSET(0xCD0C670)
#define RPG_CLIENT_MONONATIVEEDITBOX_GET_KEYBOARDSHOWING_OFFSET UNITYSDK_OFFSET(0xCD0C6A0)
#define RPG_CLIENT_MONONATIVEEDITBOX_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xCD0C6C0)
#define RPG_CLIENT_MONONATIVEEDITBOX_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xCD0C680)
#define RPG_CLIENT_MONONATIVEEDITBOX_INITIALIZENATIVEEDIT_OFFSET UNITYSDK_OFFSET(0xCD0CA10)
#define RPG_CLIENT_MONONATIVEEDITBOX_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xCD0C980)
#define RPG_CLIENT_MONONATIVEEDITBOX_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0xCD0D3A0)
#define RPG_CLIENT_MONONATIVEEDITBOX_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD0D1C0)
#define RPG_CLIENT_MONONATIVEEDITBOX_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD0D160)
#define RPG_CLIENT_MONONATIVEEDITBOX_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD0CEF0)
#define RPG_CLIENT_MONONATIVEEDITBOX_ONPLUGINMSGDIRECT_OFFSET UNITYSDK_OFFSET(0xCD0DD30)
#define RPG_CLIENT_MONONATIVEEDITBOX_ONTEXTCHANGE_OFFSET UNITYSDK_OFFSET(0xCD0DBD0)
#define RPG_CLIENT_MONONATIVEEDITBOX_ONTEXTEDITEND_OFFSET UNITYSDK_OFFSET(0xCD0DCA0)
#define RPG_CLIENT_MONONATIVEEDITBOX_PLUGINSMESSAGEROUTINE_OFFSET UNITYSDK_OFFSET(0xCD0DEC0)
#define RPG_CLIENT_MONONATIVEEDITBOX_PREPARENATIVEEDIT_OFFSET UNITYSDK_OFFSET(0xCD0D4C0)
#define RPG_CLIENT_MONONATIVEEDITBOX_REMOVENATIVE_OFFSET UNITYSDK_OFFSET(0xCD0D230)
#define RPG_CLIENT_MONONATIVEEDITBOX_REMOVE_RETURNPRESSED_OFFSET UNITYSDK_OFFSET(0xCD0C610)
#define RPG_CLIENT_MONONATIVEEDITBOX_SETFOCUS_OFFSET UNITYSDK_OFFSET(0xCD0D420)
#define RPG_CLIENT_MONONATIVEEDITBOX_SETNATIVEEDITRECT_OFFSET UNITYSDK_OFFSET(0xCD0EF90)
#define RPG_CLIENT_MONONATIVEEDITBOX_SETTEXTNATIVE_OFFSET UNITYSDK_OFFSET(0xCD0C7A0)
#define RPG_CLIENT_MONONATIVEEDITBOX_SETVISIBLE_OFFSET UNITYSDK_OFFSET(0xCD0CF50)
#define RPG_CLIENT_MONONATIVEEDITBOX_SET_KEYBOARDSHOWING_OFFSET UNITYSDK_OFFSET(0xCD0C6B0)
#define RPG_CLIENT_MONONATIVEEDITBOX_SET_TEXT_OFFSET UNITYSDK_OFFSET(0xCD0C720)
#define RPG_CLIENT_MONONATIVEEDITBOX_SET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xCD0C690)
#define RPG_CLIENT_MONONATIVEEDITBOX_START_OFFSET UNITYSDK_OFFSET(0xCD0CEA0)
#define RPG_CLIENT_MONONATIVEEDITBOX__CTOR_OFFSET UNITYSDK_OFFSET(0xCD0F410)
