...
#define RPG_CLIENT_CHESSROGUEDICEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0ECD90)
#define RPG_CLIENT_CHESSROGUEDICEDATA_GETAEONDICEDATAITEM_OFFSET UNITYSDK_OFFSET(0xC0ECFC0)
#define RPG_CLIENT_CHESSROGUEDICEDATA_GET_CHESSROGUEAEONDICEDATADICT_OFFSET UNITYSDK_OFFSET(0xC0ED080)
#define RPG_CLIENT_CHESSROGUEDICEDATA_INIT_OFFSET UNITYSDK_OFFSET(0xC0ECB50)
#define RPG_CLIENT_CHESSROGUEDICEDATA_SET_CHESSROGUEAEONDICEDATADICT_OFFSET UNITYSDK_OFFSET(0xC0ED090)
#define RPG_CLIENT_CHESSROGUEDICEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC0ED0A0)
