...
#define RPG_CLIENT_BOOKLETDECORATIVECONTAINER_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xBEC19F0)
#define RPG_CLIENT_BOOKLETDECORATIVECONTAINER_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xBEC1B90)
#define RPG_CLIENT_BOOKLETDECORATIVECONTAINER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xBEC17B0)
#define RPG_CLIENT_BOOKLETDECORATIVECONTAINER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBEC1820)
#define RPG_CLIENT_BOOKLETDECORATIVECONTAINER_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xBEC1D10)
#define RPG_CLIENT_BOOKLETDECORATIVECONTAINER_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xBEC1DD0)
#define RPG_CLIENT_BOOKLETDECORATIVECONTAINER__BEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xBEC1990)
#define RPG_CLIENT_BOOKLETDECORATIVECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEC1EA0)

namespace RPG::Client
{
	inline static constexpr unsigned int BookletDecorativeContainer_TypeDefinitionIndex = 69114;
