...
#define RPG_CLIENT_GRIDFIGHTTRAITCOREROLECHOOSEACTION_SELECTMEMBER_OFFSET UNITYSDK_OFFSET(0xC841210)
#define RPG_CLIENT_GRIDFIGHTTRAITCOREROLECHOOSEACTION_SYNC_OFFSET UNITYSDK_OFFSET(0xC8411C0)
#define RPG_CLIENT_GRIDFIGHTTRAITCOREROLECHOOSEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC8411B0)
