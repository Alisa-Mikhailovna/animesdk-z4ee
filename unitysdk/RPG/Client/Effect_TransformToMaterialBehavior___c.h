...
#define RPG_CLIENT_EFFECT_TRANSFORMTOMATERIALBEHAVIOR___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC352FA0)
#define RPG_CLIENT_EFFECT_TRANSFORMTOMATERIALBEHAVIOR___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC352FE0)
#define RPG_CLIENT_EFFECT_TRANSFORMTOMATERIALBEHAVIOR___C__ONENABLE_B__7_0_OFFSET UNITYSDK_OFFSET(0xC352FF0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::Effect_TransformToMaterialBehavior___c**)Il2CppClass::FromTypeDefinitionIndex(Effect_TransformToMaterialBehavior___c_TypeDefinitionIndex)->GetStaticField(0x68CC0);
		}
		...
		{
			return (::System::Func_2<::RPG::Client::Effect_TransformToMaterialBehavior_TransformPropertyMapping*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(Effect_TransformToMaterialBehavior___c_TypeDefinitionIndex)->GetStaticField(0x68CC8);
		}
