...
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_ADD_ONISCONTAINEDCHANGED_OFFSET UNITYSDK_OFFSET(0xCD3A320)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_FORCEIMMEDIATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCD3A430)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_GET_AREA_OFFSET UNITYSDK_OFFSET(0xCD3A1E0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_GET_ISCONTAINED_OFFSET UNITYSDK_OFFSET(0xCD3A270)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0xCD3A0A0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_REMOVE_ONISCONTAINEDCHANGED_OFFSET UNITYSDK_OFFSET(0xCD3A380)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SET_AREA_OFFSET UNITYSDK_OFFSET(0xCD3A220)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SET_ISCONTAINED_OFFSET UNITYSDK_OFFSET(0xCD3A2B0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SET_PIVOT_OFFSET UNITYSDK_OFFSET(0xCD3A0E0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SUBSCRIBEISCONTAINEDCHANGED_OFFSET UNITYSDK_OFFSET(0xCD3A480)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD3A3E0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT__CHECKISCONTAINED_OFFSET UNITYSDK_OFFSET(0xCD3A5B0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3A7D0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT__UPDATEISCONTAINED_OFFSET UNITYSDK_OFFSET(0xCD3A130)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIPivotContainmentDetect_TypeDefinitionIndex = 69334;
