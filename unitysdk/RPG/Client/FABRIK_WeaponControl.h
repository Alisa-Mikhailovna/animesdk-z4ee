...
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_ATTACHANIMSTATE_OFFSET UNITYSDK_OFFSET(0xC428100)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_IKRESET_OFFSET UNITYSDK_OFFSET(0xC428610)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_ISATTACHANIMFIT_OFFSET UNITYSDK_OFFSET(0xC428050)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_LOCKWEAPONHAND_OFFSET UNITYSDK_OFFSET(0xC428160)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_PROTECTOTHERHANDS_OFFSET UNITYSDK_OFFSET(0xC4284C0)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_STOP_OFFSET UNITYSDK_OFFSET(0xC428550)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_TICK_OFFSET UNITYSDK_OFFSET(0xC4287F0)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC429960)
