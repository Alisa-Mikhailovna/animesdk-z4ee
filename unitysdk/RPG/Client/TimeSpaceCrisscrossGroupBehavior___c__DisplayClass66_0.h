...
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS66_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD6C26C0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS66_0__UPDATETSCSTATE_B__0_OFFSET UNITYSDK_OFFSET(0xD6C2F50)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS66_0__UPDATETSCSTATE_B__1_OFFSET UNITYSDK_OFFSET(0xD6C2F80)
