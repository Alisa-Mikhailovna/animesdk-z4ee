...
#define RPG_CLIENT_TUTORIALMASKFILTER_ADDFILTERAREA_OFFSET UNITYSDK_OFFSET(0xD7641A0)
#define RPG_CLIENT_TUTORIALMASKFILTER_CLEAR_OFFSET UNITYSDK_OFFSET(0xD764070)
#define RPG_CLIENT_TUTORIALMASKFILTER_ENABLEDEBUGDRAW_OFFSET UNITYSDK_OFFSET(0xD766DC0)
#define RPG_CLIENT_TUTORIALMASKFILTER_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0xD766C30)
#define RPG_CLIENT_TUTORIALMASKFILTER_REMOVEFILTERAREA_OFFSET UNITYSDK_OFFSET(0xD766D30)
#define RPG_CLIENT_TUTORIALMASKFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD766E10)
