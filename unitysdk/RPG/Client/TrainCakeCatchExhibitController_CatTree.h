...
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD6E2050)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_GETATTACHPOINTPOS_OFFSET UNITYSDK_OFFSET(0xD6E16C0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_GET__CATTREEENTITY_OFFSET UNITYSDK_OFFSET(0xD6E6750)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_SETCATTREETYPE_OFFSET UNITYSDK_OFFSET(0xD6E0E00)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_SETCAT_OFFSET UNITYSDK_OFFSET(0xD6E1090)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE__CTOR_OFFSET UNITYSDK_OFFSET(0xD6E1DD0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE__REFRESHLOCATIONONCATTREETYPECHANGED_OFFSET UNITYSDK_OFFSET(0xD6E67E0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE__SETPREFIX_OFFSET UNITYSDK_OFFSET(0xD6E65A0)
