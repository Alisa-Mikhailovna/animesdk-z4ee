...
#define RPG_CLIENT_MESSAGECONTENTEMOJIBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0xCBA8620)
#define RPG_CLIENT_MESSAGECONTENTEMOJIBLOCK_GET_EMOJIID_OFFSET UNITYSDK_OFFSET(0xCBA86C0)
#define RPG_CLIENT_MESSAGECONTENTEMOJIBLOCK_GET_EMOJIPATH_OFFSET UNITYSDK_OFFSET(0xCBA86A0)
#define RPG_CLIENT_MESSAGECONTENTEMOJIBLOCK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCBA8530)
#define RPG_CLIENT_MESSAGECONTENTEMOJIBLOCK_SET_EMOJIID_OFFSET UNITYSDK_OFFSET(0xCBA86D0)
#define RPG_CLIENT_MESSAGECONTENTEMOJIBLOCK_SET_EMOJIPATH_OFFSET UNITYSDK_OFFSET(0xCBA86B0)
#define RPG_CLIENT_MESSAGECONTENTEMOJIBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xCBA8580)
