...
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xD470300)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_GETCURLEGENDROWS_OFFSET UNITYSDK_OFFSET(0xD470B20)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_GETLEGENDROW_OFFSET UNITYSDK_OFFSET(0xD470BD0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_GETLISTVIEWITEMPREFABINDEX_OFFSET UNITYSDK_OFFSET(0xD470D40)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_GET_CURRENTTABINDEX_OFFSET UNITYSDK_OFFSET(0xD4701F0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_SELECTTAB_OFFSET UNITYSDK_OFFSET(0xD470A70)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_SET_CURRENTTABINDEX_OFFSET UNITYSDK_OFFSET(0xD470200)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_SHOWDIALOG_OFFSET UNITYSDK_OFFSET(0xD470210)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD470440)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INITATTRIBUTELISTROWS_OFFSET UNITYSDK_OFFSET(0xD471410)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INITATTRIBUTELIST_OFFSET UNITYSDK_OFFSET(0xD470620)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INITROOMCOMPTYPELISTROWS_OFFSET UNITYSDK_OFFSET(0xD470EA0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INITROOMCOMPTYPELIST_OFFSET UNITYSDK_OFFSET(0xD470520)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xD4704D0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaLegendViewModel_TypeDefinitionIndex = 69584;
