...
#define RPG_CLIENT_COMPONENTASSETSKINITEM_GET_CURRENTSKINNAME_OFFSET UNITYSDK_OFFSET(0xC1A4350)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_GET_CURRENTSKINPATH_OFFSET UNITYSDK_OFFSET(0xC1A4360)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_GET_SKINRESMAP_OFFSET UNITYSDK_OFFSET(0xC1A2FA0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_METHOD_1_4E6219BD0A8026FA_OFFSET UNITYSDK_OFFSET(0xC1A1400)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_METHOD_1_6929C20FCC70C1A3_OFFSET UNITYSDK_OFFSET(0xC1A3F60)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_METHOD_1_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0xC1A3FF0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_SET_CURRENTSKINNAME_OFFSET UNITYSDK_OFFSET(0xC1A12E0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC1A4440)
