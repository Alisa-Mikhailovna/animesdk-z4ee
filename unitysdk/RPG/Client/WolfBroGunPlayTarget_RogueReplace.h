...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD8BC5B0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE_GETREPLACEPREFAB_OFFSET UNITYSDK_OFFSET(0xD8BC600)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE_GET_ROGUEROADMAP_OFFSET UNITYSDK_OFFSET(0xD8BC880)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE_ONREPLACEPREFABINSTANCED_OFFSET UNITYSDK_OFFSET(0xD8BC790)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE__CTOR_OFFSET UNITYSDK_OFFSET(0xD8BC900)
