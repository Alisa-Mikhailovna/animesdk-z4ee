...
#define RPG_CLIENT_LOOPGENERATOR_AWAKE_OFFSET UNITYSDK_OFFSET(0xCA25100)
#define RPG_CLIENT_LOOPGENERATOR_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0xCA24E80)
#define RPG_CLIENT_LOOPGENERATOR_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0xCA24F10)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xCA26BE0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_44E2E78A5C2D0384_OFFSET UNITYSDK_OFFSET(0xCA26660)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_45FDB639B4E97210_OFFSET UNITYSDK_OFFSET(0xCA25610)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_77577333B4681208_OFFSET UNITYSDK_OFFSET(0xCA25060)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_879E4116B6BD3AF1_OFFSET UNITYSDK_OFFSET(0xCA26FF0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_9D81CE85FF63522D_OFFSET UNITYSDK_OFFSET(0xCA26C50)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_B357AE5DB3A8BC4F_OFFSET UNITYSDK_OFFSET(0xCA26D10)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_E10635F67939DD2E_OFFSET UNITYSDK_OFFSET(0xCA263B0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_E960A56BD2EFC162_OFFSET UNITYSDK_OFFSET(0xCA24F30)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xCA24FE0)
#define RPG_CLIENT_LOOPGENERATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCA261E0)
#define RPG_CLIENT_LOOPGENERATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCA25D60)
#define RPG_CLIENT_LOOPGENERATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCA25530)
#define RPG_CLIENT_LOOPGENERATOR_RELEASEALLSLIDERS_OFFSET UNITYSDK_OFFSET(0xCA25DB0)
#define RPG_CLIENT_LOOPGENERATOR_RESETSTATE_OFFSET UNITYSDK_OFFSET(0xCA25400)
#define RPG_CLIENT_LOOPGENERATOR_SETTEMPSPEED_OFFSET UNITYSDK_OFFSET(0xCA277A0)
#define RPG_CLIENT_LOOPGENERATOR_SET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0xCA24F20)
#define RPG_CLIENT_LOOPGENERATOR_SWITCHCONFIG_OFFSET UNITYSDK_OFFSET(0xCA27490)
#define RPG_CLIENT_LOOPGENERATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xCA255A0)
#define RPG_CLIENT_LOOPGENERATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xCA27990)
#define RPG_CLIENT_LOOPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCA27800)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerator_TypeDefinitionIndex = 69648;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LoopGenerator_TypeDefinitionIndex)->GetStaticField(0xADE0);
		}
