...
#define RPG_CLIENT_FANTASTICSTORYACTIVITYUTILS_GETBATTLESCORERANKTEXTID_OFFSET UNITYSDK_OFFSET(0xC43DB10)
#define RPG_CLIENT_FANTASTICSTORYACTIVITYUTILS_GETBUFFICONREDDOTSUBKEY_OFFSET UNITYSDK_OFFSET(0xC43DD80)
#define RPG_CLIENT_FANTASTICSTORYACTIVITYUTILS_GETFINALQUESTDATA_OFFSET UNITYSDK_OFFSET(0xC43ADB0)
#define RPG_CLIENT_FANTASTICSTORYACTIVITYUTILS_GETUNLOCKMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xC43D670)
#define RPG_CLIENT_FANTASTICSTORYACTIVITYUTILS_ISINFANTASTICSTORYACTIVITYBATTLE_OFFSET UNITYSDK_OFFSET(0xC43D8A0)
#define RPG_CLIENT_FANTASTICSTORYACTIVITYUTILS_TRYGETTRIALAVATARSBYPARAGRAPHID_OFFSET UNITYSDK_OFFSET(0xC438D40)
#define RPG_CLIENT_FANTASTICSTORYACTIVITYUTILS_TRYTRANSFERTOBATTLENPC_OFFSET UNITYSDK_OFFSET(0xC43D530)
