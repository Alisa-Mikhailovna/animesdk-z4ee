...
#define RPG_CLIENT_SCROLLRECTEXTENSIONS_FORCEUPDATECANSCROLL_OFFSET UNITYSDK_OFFSET(0xD4DF920)

namespace RPG::Client
{
	inline static constexpr unsigned int ScrollRectExtensions_TypeDefinitionIndex = 69475;
