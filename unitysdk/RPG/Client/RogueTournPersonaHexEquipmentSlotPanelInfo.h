...
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xD46CA90)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GETREMOVEEQUIPPEDHEXID_OFFSET UNITYSDK_OFFSET(0xD46D010)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_EQUIPPEDCOUNT_OFFSET UNITYSDK_OFFSET(0xD46C870)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_PRESLOTCNT_OFFSET UNITYSDK_OFFSET(0xD46C6D0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_SLOTCNT_OFFSET UNITYSDK_OFFSET(0xD46C5C0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_SLOTITEMS_OFFSET UNITYSDK_OFFSET(0xD46CA50)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_ISSLOTSFULL_OFFSET UNITYSDK_OFFSET(0xD46CF70)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_REFRESH_OFFSET UNITYSDK_OFFSET(0xD46D210)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_TRYUNEQUIPHEX_OFFSET UNITYSDK_OFFSET(0xD46D0B0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__ADDACHIVEDHEXES_OFFSET UNITYSDK_OFFSET(0xD46D530)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__ADDHEX_OFFSET UNITYSDK_OFFSET(0xD46DCC0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD46CB50)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__INIT_OFFSET UNITYSDK_OFFSET(0xD46CB90)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__REMOVEINVALIDHEXES_OFFSET UNITYSDK_OFFSET(0xD46D270)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__SHIFTHEXES_OFFSET UNITYSDK_OFFSET(0xD46DB40)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaHexEquipmentSlotPanelInfo_TypeDefinitionIndex = 69572;
