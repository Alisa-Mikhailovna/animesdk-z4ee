...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GETICON_OFFSET UNITYSDK_OFFSET(0xC72E330)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GETNAME_OFFSET UNITYSDK_OFFSET(0xC72E1A0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xC72E0B0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GET_ISTRAIT_OFFSET UNITYSDK_OFFSET(0xC72DFC0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_SATISFY_OFFSET UNITYSDK_OFFSET(0xC72E000)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC72D1F0)
