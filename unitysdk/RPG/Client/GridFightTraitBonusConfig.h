...
#define RPG_CLIENT_GRIDFIGHTTRAITBONUSCONFIG_GET_BONUSDESC_OFFSET UNITYSDK_OFFSET(0xC838280)
#define RPG_CLIENT_GRIDFIGHTTRAITBONUSCONFIG_GET_BONUSNAME_OFFSET UNITYSDK_OFFSET(0xC838590)
#define RPG_CLIENT_GRIDFIGHTTRAITBONUSCONFIG_GET_BONUSSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0xC838470)
#define RPG_CLIENT_GRIDFIGHTTRAITBONUSCONFIG_GET_BONUSTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xC8381C0)
#define RPG_CLIENT_GRIDFIGHTTRAITBONUSCONFIG_GET_BONUSTYPE_OFFSET UNITYSDK_OFFSET(0xC838170)
#define RPG_CLIENT_GRIDFIGHTTRAITBONUSCONFIG_GET_MAZEBUFFNAME_OFFSET UNITYSDK_OFFSET(0xC838680)
#define RPG_CLIENT_GRIDFIGHTTRAITBONUSCONFIG_GET_PARAM1_OFFSET UNITYSDK_OFFSET(0xC838210)
#define RPG_CLIENT_GRIDFIGHTTRAITBONUSCONFIG_GET__MAZEBUFFENHANCECONFIGROW_OFFSET UNITYSDK_OFFSET(0xC8383A0)
#define RPG_CLIENT_GRIDFIGHTTRAITBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC838160)
