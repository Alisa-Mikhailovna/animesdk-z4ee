...
#define RPG_CLIENT_UIMONOJOYSTICK_DRAGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1530B0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMonoJoyStick_DragInfo_TypeDefinitionIndex = 69526;
