...
#define RPG_CLIENT_EARLYACCESSUTILS_ISMISSIONINCANUNLOCKEARLYACCESSCONTENT_OFFSET UNITYSDK_OFFSET(0xC2EC240)
#define RPG_CLIENT_EARLYACCESSUTILS_ISNEEDSWITCHCONTENT_OFFSET UNITYSDK_OFFSET(0xC2EBFD0)
#define RPG_CLIENT_EARLYACCESSUTILS_REPORTSWITCHDIALOGBUTTON_OFFSET UNITYSDK_OFFSET(0xC2EC570)
#define RPG_CLIENT_EARLYACCESSUTILS_SHOWEARLYACCESSBLOCKERRORTIPS_OFFSET UNITYSDK_OFFSET(0xC2EC510)
#define RPG_CLIENT_EARLYACCESSUTILS_SHOWEARLYACCESSSWITCHDIALOG_OFFSET UNITYSDK_OFFSET(0xC2EBCA0)
