...
#define RPG_CLIENT_MUSICRHYTHMBOARD_ADDTUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0xCE0D550)
#define RPG_CLIENT_MUSICRHYTHMBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCE0B180)
#define RPG_CLIENT_MUSICRHYTHMBOARD_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xCE0C9C0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GETENTITY_OFFSET UNITYSDK_OFFSET(0xCE0D130)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GETPOINT_OFFSET UNITYSDK_OFFSET(0xCE0CA20)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_GROUPROW_OFFSET UNITYSDK_OFFSET(0xCE0D600)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0xCE0D5A0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0xCE0D5C0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_LEVELROW_OFFSET UNITYSDK_OFFSET(0xCE0D5E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_SKIPTUTORIAL_OFFSET UNITYSDK_OFFSET(0xCE0D640)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_TUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0xCE0D620)
#define RPG_CLIENT_MUSICRHYTHMBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xCE09770)
#define RPG_CLIENT_MUSICRHYTHMBOARD_ISTIMELINEFINISH_OFFSET UNITYSDK_OFFSET(0xCE0BA90)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0xCE0C0F0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0xCE09EC0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_5AAD8A621CCD075B_OFFSET UNITYSDK_OFFSET(0xCE0C5B0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_802D2A6E195347E8_OFFSET UNITYSDK_OFFSET(0xCE0AEF0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_1_OFFSET UNITYSDK_OFFSET(0xCE0BF00)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_2_OFFSET UNITYSDK_OFFSET(0xCE0C210)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_3_OFFSET UNITYSDK_OFFSET(0xCE0C310)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_4_OFFSET UNITYSDK_OFFSET(0xCE0C500)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_5_OFFSET UNITYSDK_OFFSET(0xCE0C700)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_6_OFFSET UNITYSDK_OFFSET(0xCE0C7E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xCE0BC80)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCE09DD0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_B484DF6A9226D45B_OFFSET UNITYSDK_OFFSET(0xCE0C8A0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_D2666B2B900DD38A_OFFSET UNITYSDK_OFFSET(0xCE0CB50)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_DFD7F5C5419FD422_OFFSET UNITYSDK_OFFSET(0xCE0C3C0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_F4702DCB1E895B7F_OFFSET UNITYSDK_OFFSET(0xCE0BFB0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_F69068FADEFBD596_OFFSET UNITYSDK_OFFSET(0xCE0BDA0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0xCE0AB80)
#define RPG_CLIENT_MUSICRHYTHMBOARD_RESETANIMATORS_OFFSET UNITYSDK_OFFSET(0xCE0D210)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SETADJUSTMODE_OFFSET UNITYSDK_OFFSET(0xCE0AF90)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_GROUPROW_OFFSET UNITYSDK_OFFSET(0xCE0D610)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0xCE0D5B0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0xCE0D5D0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_LEVELROW_OFFSET UNITYSDK_OFFSET(0xCE0D5F0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_SKIPTUTORIAL_OFFSET UNITYSDK_OFFSET(0xCE0D650)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_TUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0xCE0D630)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SHOWPLAYERHINT_OFFSET UNITYSDK_OFFSET(0xCE0BAF0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_STARTMUSICRHYTHM_OFFSET UNITYSDK_OFFSET(0xCE0AAD0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xCE0C960)
#define RPG_CLIENT_MUSICRHYTHMBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xCE0D660)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::GameCore::MusicRhythmLevelRow**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x2CD70);
		}
		static ::RPG::GameCore::MusicRhythmGroupRow** StaticGet__GroupRow_k__BackingField()
		{
			return (::RPG::GameCore::MusicRhythmGroupRow**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x2CD78);
		}
		static ::RPG::GameCore::MusicRhythmGameConfig** StaticGet_MusicRhythmConfig()
		{
			return (::RPG::GameCore::MusicRhythmGameConfig**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x2CD80);
		}
