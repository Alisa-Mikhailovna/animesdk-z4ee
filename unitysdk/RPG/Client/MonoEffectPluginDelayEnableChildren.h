...
#define RPG_CLIENT_MONOEFFECTPLUGINDELAYENABLECHILDREN_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCB2810)
#define RPG_CLIENT_MONOEFFECTPLUGINDELAYENABLECHILDREN_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCB28F0)
#define RPG_CLIENT_MONOEFFECTPLUGINDELAYENABLECHILDREN_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCB2A30)
#define RPG_CLIENT_MONOEFFECTPLUGINDELAYENABLECHILDREN_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xCCB27D0)
#define RPG_CLIENT_MONOEFFECTPLUGINDELAYENABLECHILDREN_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCB29D0)
#define RPG_CLIENT_MONOEFFECTPLUGINDELAYENABLECHILDREN_TICK_OFFSET UNITYSDK_OFFSET(0xCCB2A70)
#define RPG_CLIENT_MONOEFFECTPLUGINDELAYENABLECHILDREN__CTOR_OFFSET UNITYSDK_OFFSET(0xCCB2AE0)
