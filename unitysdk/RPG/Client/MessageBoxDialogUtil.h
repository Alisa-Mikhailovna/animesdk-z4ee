...
#define RPG_CLIENT_MESSAGEBOXDIALOGUTIL_SHOWABOVEDIALOGTEXTMODAL_OFFSET UNITYSDK_OFFSET(0xCBA6000)
#define RPG_CLIENT_MESSAGEBOXDIALOGUTIL_SHOWABOVEDIALOGTEXT_OFFSET UNITYSDK_OFFSET(0xCBA5F50)
#define RPG_CLIENT_MESSAGEBOXDIALOGUTIL_SHOWDIALOGTEXTANDRESTARTGAME_OFFSET UNITYSDK_OFFSET(0xCBA60B0)
#define RPG_CLIENT_MESSAGEBOXDIALOGUTIL_SHOWDIALOGTEXTMODAL_OFFSET UNITYSDK_OFFSET(0xCBA5E70)
#define RPG_CLIENT_MESSAGEBOXDIALOGUTIL_SHOWDIALOGTEXT_OFFSET UNITYSDK_OFFSET(0xCBA5DC0)
#define RPG_CLIENT_MESSAGEBOXDIALOGUTIL_SHOWMIHOYOSDKCODE_OFFSET UNITYSDK_OFFSET(0xCBA6220)

namespace RPG::Client
{
	inline static constexpr unsigned int MessageBoxDialogUtil_TypeDefinitionIndex = 69507;
