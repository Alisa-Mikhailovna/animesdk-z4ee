...
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0xD578F30)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_COMPARETO_OFFSET UNITYSDK_OFFSET(0xD578E00)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xD578D20)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_METHOD_5_0DD61B7EBFB9E6E3_OFFSET UNITYSDK_OFFSET(0xD5792E0)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_METHOD_5_F46E56E08575ED2C_OFFSET UNITYSDK_OFFSET(0xD579260)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_PROCESS_OFFSET UNITYSDK_OFFSET(0xD578D30)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER_SETSUBOBJECTROTATION_OFFSET UNITYSDK_OFFSET(0xD579030)
#define RPG_CLIENT_SUBOBJECTROTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD5794B0)
