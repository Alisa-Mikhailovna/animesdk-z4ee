...
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_GET_CURRENTFROMSTATE_OFFSET UNITYSDK_OFFSET(0xD54D3A0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_GET_CURRENTPROGRESS_OFFSET UNITYSDK_OFFSET(0xD54D560)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_GET_CURRENTTOSTATE_OFFSET UNITYSDK_OFFSET(0xD54D480)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_GET_STATES_OFFSET UNITYSDK_OFFSET(0xD54D2C0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xD54C040)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_0ACC9D57A6206C0A_OFFSET UNITYSDK_OFFSET(0xD54F930)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_12FE5A2FFAA2EECC_OFFSET UNITYSDK_OFFSET(0xD54E020)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_1BF801F323AEB07B_OFFSET UNITYSDK_OFFSET(0xD54EA50)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_36B3126FAEF06CA3_OFFSET UNITYSDK_OFFSET(0xD54C760)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD54C0C0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_4E12A3301519348B_OFFSET UNITYSDK_OFFSET(0xD54FC10)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_4EA089004CC069A2_OFFSET UNITYSDK_OFFSET(0xD54FDC0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_55D6CBA1A803E5A5_OFFSET UNITYSDK_OFFSET(0xD54EFA0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_5B0856136BC3DF08_OFFSET UNITYSDK_OFFSET(0xD54E6E0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_701B27667C4F39E6_OFFSET UNITYSDK_OFFSET(0xD54FD20)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0xD54D0E0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xD54DEC0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_A002848F130F70CA_OFFSET UNITYSDK_OFFSET(0xD54C120)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_A07C2061B55C1547_OFFSET UNITYSDK_OFFSET(0xD54DBA0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_A41DCE32DA5A80B1_OFFSET UNITYSDK_OFFSET(0xD54DD80)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_AB1A8DFD378DB0BE_OFFSET UNITYSDK_OFFSET(0xD54CD30)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xD54D210)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_B7D2C046C76F0D83_OFFSET UNITYSDK_OFFSET(0xD54D710)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_BB17F927D5B2EBAC_OFFSET UNITYSDK_OFFSET(0xD54D8B0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_D70C817A5656CDA9_OFFSET UNITYSDK_OFFSET(0xD54F650)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_D739676D3B797539_OFFSET UNITYSDK_OFFSET(0xD54D5C0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xD54FCB0)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_DE0AAC30985D011A_OFFSET UNITYSDK_OFFSET(0xD54F260)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_E6D3C4C666E119D9_OFFSET UNITYSDK_OFFSET(0xD54D860)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR_METHOD_3_ED3B2BFA369D514A_OFFSET UNITYSDK_OFFSET(0xD54ED10)
#define RPG_CLIENT_STAGEHARMONYWEATHERCONTROLLERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD550100)
