...
#define RPG_CLIENT_MONOTEXTDANMUVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD27530)
#define RPG_CLIENT_MONOTEXTDANMUVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xCD275E0)
#define RPG_CLIENT_MONOTEXTDANMUVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xCD276A0)
