...
#define RPG_CLIENT_PLANETFESRANKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD075840)
#define RPG_CLIENT_PLANETFESRANKDATA_GET_PERSONALRANK_OFFSET UNITYSDK_OFFSET(0xD07E2D0)
#define RPG_CLIENT_PLANETFESRANKDATA_GET_SORTEDRANK_OFFSET UNITYSDK_OFFSET(0xD07E280)
#define RPG_CLIENT_PLANETFESRANKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD07E270)
