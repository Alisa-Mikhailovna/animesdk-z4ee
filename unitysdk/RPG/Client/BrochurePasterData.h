...
#define RPG_CLIENT_BROCHUREPASTERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBED7B20)
#define RPG_CLIENT_BROCHUREPASTERDATA_GETPASTEDPOSITION_OFFSET UNITYSDK_OFFSET(0xBED73F0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GETPASTEDROTATION_OFFSET UNITYSDK_OFFSET(0xBED7430)
#define RPG_CLIENT_BROCHUREPASTERDATA_GETPASTEDSCALE_OFFSET UNITYSDK_OFFSET(0xBED7480)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBED8400)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBED8380)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ISPASTED_OFFSET UNITYSDK_OFFSET(0xBED8700)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xBED86B0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ITEMROW_OFFSET UNITYSDK_OFFSET(0xBED83E0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_PASTERIMAGE_OFFSET UNITYSDK_OFFSET(0xBED84C0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_PASTERTEXT_OFFSET UNITYSDK_OFFSET(0xBED8580)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_PROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xBED8660)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xBED83C0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBED80C0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xBED83A0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_UNLOCKHINT_OFFSET UNITYSDK_OFFSET(0xBED85F0)
#define RPG_CLIENT_BROCHUREPASTERDATA_ISLOCATIONSAME_OFFSET UNITYSDK_OFFSET(0xBED6FA0)
#define RPG_CLIENT_BROCHUREPASTERDATA_RESET_OFFSET UNITYSDK_OFFSET(0xBED6830)
#define RPG_CLIENT_BROCHUREPASTERDATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0xBED81B0)
#define RPG_CLIENT_BROCHUREPASTERDATA_SETPASTED_OFFSET UNITYSDK_OFFSET(0xBED6F50)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xBED8390)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_ISPASTED_OFFSET UNITYSDK_OFFSET(0xBED8710)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_ITEMROW_OFFSET UNITYSDK_OFFSET(0xBED83F0)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xBED83D0)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xBED83B0)
#define RPG_CLIENT_BROCHUREPASTERDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xBED7760)
#define RPG_CLIENT_BROCHUREPASTERDATA_UPDATEPASTED_OFFSET UNITYSDK_OFFSET(0xBED7270)
#define RPG_CLIENT_BROCHUREPASTERDATA_UPDATEUNIQUEID_OFFSET UNITYSDK_OFFSET(0xBED6410)
#define RPG_CLIENT_BROCHUREPASTERDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xBED8720)
#define RPG_CLIENT_BROCHUREPASTERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBED80A0)
#define RPG_CLIENT_BROCHUREPASTERDATA__GETSCALE_OFFSET UNITYSDK_OFFSET(0xBED8110)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(BrochurePasterData_TypeDefinitionIndex)->GetStaticField(0x10220);
		}
		static ::UnityEngine::Vector2* StaticGet__OriginSize()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(BrochurePasterData_TypeDefinitionIndex)->GetStaticField(0x10224);
		}
