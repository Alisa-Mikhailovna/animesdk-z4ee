...
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GETMONSTERLISTBYWAVE_OFFSET UNITYSDK_OFFSET(0xC797460)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_BOSSDATA_OFFSET UNITYSDK_OFFSET(0xC797A00)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_CAMPCONFIG_OFFSET UNITYSDK_OFFSET(0xC797A70)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_HIGHESTTIERMONSTER_OFFSET UNITYSDK_OFFSET(0xC797A20)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_MONSTERLISTDICT_OFFSET UNITYSDK_OFFSET(0xC797AB0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_MONSTERLIST_OFFSET UNITYSDK_OFFSET(0xC797520)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0xC797A90)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_SET_BOSSDATA_OFFSET UNITYSDK_OFFSET(0xC797A10)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_SET_CAMPCONFIG_OFFSET UNITYSDK_OFFSET(0xC797A80)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_SET_MONSTERLISTDICT_OFFSET UNITYSDK_OFFSET(0xC797AC0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_SET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0xC797AA0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC7955C0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA__GETGRIDFIGHTMONSTERWAVEDATA_OFFSET UNITYSDK_OFFSET(0xC797570)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA__GETHIGHESTTIERMONSTER_OFFSET UNITYSDK_OFFSET(0xC797700)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA___GETGRIDFIGHTMONSTERWAVEDATA_B__1_0_OFFSET UNITYSDK_OFFSET(0xC797AD0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA___GETGRIDFIGHTMONSTERWAVEDATA_B__1_1_OFFSET UNITYSDK_OFFSET(0xC797B20)
