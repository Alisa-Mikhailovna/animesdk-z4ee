...
#define RPG_CLIENT_GAMEPHASECONTEXT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC67F8A0)
#define RPG_CLIENT_GAMEPHASECONTEXT___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC67F8E0)
#define RPG_CLIENT_GAMEPHASECONTEXT___C___ONPSNLOGOUTHANDLER_B__10_0_OFFSET UNITYSDK_OFFSET(0xC67F8F0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Action_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(GamePhaseContext___c_TypeDefinitionIndex)->GetStaticField(0x1D1A0);
		}
		static ::RPG::Client::GamePhaseContext___c** StaticGet___9()
		{
			return (::RPG::Client::GamePhaseContext___c**)Il2CppClass::FromTypeDefinitionIndex(GamePhaseContext___c_TypeDefinitionIndex)->GetStaticField(0x1D1A8);
		}
