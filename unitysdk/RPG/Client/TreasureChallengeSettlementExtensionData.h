...
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENTEXTENSIONDATA_CREATEEXTENSION_OFFSET UNITYSDK_OFFSET(0xD7468B0)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENTEXTENSIONDATA_GET_ISCANGOTONEXT_OFFSET UNITYSDK_OFFSET(0xD746E90)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENTEXTENSIONDATA_GET_NEXTRAIDROW_OFFSET UNITYSDK_OFFSET(0xD746EB0)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENTEXTENSIONDATA_SET_ISCANGOTONEXT_OFFSET UNITYSDK_OFFSET(0xD746EA0)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENTEXTENSIONDATA_SET_NEXTRAIDROW_OFFSET UNITYSDK_OFFSET(0xD746EC0)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENTEXTENSIONDATA_TRYGETACTIVITYRAIDROWBYRAIDCOLLECTIONID_OFFSET UNITYSDK_OFFSET(0xD746B50)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENTEXTENSIONDATA_TRYGETACTIVITYRAIDROWBYRAIDID_OFFSET UNITYSDK_OFFSET(0xD746A10)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENTEXTENSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD746CA0)
#define RPG_CLIENT_TREASURECHALLENGESETTLEMENTEXTENSIONDATA__GETNEXTRAIDROW_OFFSET UNITYSDK_OFFSET(0xD746CB0)
