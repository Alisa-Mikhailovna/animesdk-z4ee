...
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0xD56E530)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0xD56EC90)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_485F3682F812D478_OFFSET UNITYSDK_OFFSET(0xD56E0D0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_4A111163FD8F1931_OFFSET UNITYSDK_OFFSET(0xD56E200)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xD56EA90)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_8A05DE1403363D53_OFFSET UNITYSDK_OFFSET(0xD56E2B0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_94E49D8C890638E5_OFFSET UNITYSDK_OFFSET(0xD56ECF0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_E29D671E35F6F43F_OFFSET UNITYSDK_OFFSET(0xD56E960)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xD56D7E0)
#define RPG_CLIENT_STORYFEVERPILETOAST_PILE_OFFSET UNITYSDK_OFFSET(0xD56D6F0)
#define RPG_CLIENT_STORYFEVERPILETOAST_START_OFFSET UNITYSDK_OFFSET(0xD56D920)
#define RPG_CLIENT_STORYFEVERPILETOAST_UPDATE_OFFSET UNITYSDK_OFFSET(0xD56DBF0)
#define RPG_CLIENT_STORYFEVERPILETOAST__CTOR_OFFSET UNITYSDK_OFFSET(0xD56F130)

namespace RPG::Client
{
	inline static constexpr unsigned int StoryFeverPileToast_TypeDefinitionIndex = 68842;
