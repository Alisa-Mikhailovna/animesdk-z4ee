...
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_ANIMATIONPLAY_OFFSET UNITYSDK_OFFSET(0xC2F8B20)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_GETCRYSTALANIFROMNODE_OFFSET UNITYSDK_OFFSET(0xC2F8330)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_GET_ISALTERNATEMODE_OFFSET UNITYSDK_OFFSET(0xC2F6BC0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_INITCRYSTALMAT_OFFSET UNITYSDK_OFFSET(0xC2F6C20)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_INITSETCRYSTALMAT_OFFSET UNITYSDK_OFFSET(0xC2F87F0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_INITSETCRYSTALSHINESCRIPT_OFFSET UNITYSDK_OFFSET(0xC2F89B0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC2F6EB0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC2F8BF0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_SETAUREOLEANI_OFFSET UNITYSDK_OFFSET(0xC2F7690)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_SETCRYSTALCENTERWEIGHT_OFFSET UNITYSDK_OFFSET(0xC2F6F00)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_START_OFFSET UNITYSDK_OFFSET(0xC2F6BD0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_SWITCHCRYSTALMODE_OFFSET UNITYSDK_OFFSET(0xC2F85D0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_UNLOCKCRYSTAL_OFFSET UNITYSDK_OFFSET(0xC2F84D0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2F8C60)
