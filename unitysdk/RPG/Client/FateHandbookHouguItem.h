...
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xC468590)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_EXTRAEFFECTARRAY_OFFSET UNITYSDK_OFFSET(0xC469310)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUDESC_OFFSET UNITYSDK_OFFSET(0xC468D40)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xC468690)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUEFFECT_OFFSET UNITYSDK_OFFSET(0xC468A00)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUICONPATH_OFFSET UNITYSDK_OFFSET(0xC469130)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUID_OFFSET UNITYSDK_OFFSET(0xC468670)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUNAME_OFFSET UNITYSDK_OFFSET(0xC4687D0)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUTYPE_OFFSET UNITYSDK_OFFSET(0xC468F70)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_SET_HOUGUID_OFFSET UNITYSDK_OFFSET(0xC468680)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC468660)
