...
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_GETCONFIG_OFFSET UNITYSDK_OFFSET(0xC797D10)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_GET_DESCTEXTID_OFFSET UNITYSDK_OFFSET(0xC799070)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_GET_FRONTBACKTYPE_OFFSET UNITYSDK_OFFSET(0xC799180)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC798F60)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0xC798F40)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_GET_ISEQUIPPABLE_OFFSET UNITYSDK_OFFSET(0xC799130)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0xC799000)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_GET_POSITIONREGION_OFFSET UNITYSDK_OFFSET(0xC7990E0)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xC798FB0)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0xC798F50)
#define RPG_CLIENT_GRIDFIGHTNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC7991E0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::System::UInt32, ::RPG::Client::GridFightNPCConfig*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightNPCConfig_TypeDefinitionIndex)->GetStaticField(0x29050);
		}
