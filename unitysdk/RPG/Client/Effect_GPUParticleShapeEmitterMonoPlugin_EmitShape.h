...
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_EMITSHAPE_GET_SHAPETOOBJSPACEM_OFFSET UNITYSDK_OFFSET(0xC30E410)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_EMITSHAPE_GET_SHAPETOOBJSPACENOSCALEM_OFFSET UNITYSDK_OFFSET(0xC312C80)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_EMITSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0xC30F1B0)
