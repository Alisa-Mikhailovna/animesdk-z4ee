...
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xCD1BD50)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xCD1BEB0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xCD1BC80)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD1BFC0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD1BF60)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_REFRESH_OFFSET UNITYSDK_OFFSET(0xCD1BC10)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_SETRENDERERLAYERMASKWITHPOSM_OFFSET UNITYSDK_OFFSET(0xCD1BAC0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCD1C010)
