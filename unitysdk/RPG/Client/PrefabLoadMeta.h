...
#define RPG_CLIENT_PREFABLOADMETA_GET_MULTIPREFABLIST_OFFSET UNITYSDK_OFFSET(0xD0BCA20)
#define RPG_CLIENT_PREFABLOADMETA_GET_PREFAB_OFFSET UNITYSDK_OFFSET(0xD0BC9B0)
#define RPG_CLIENT_PREFABLOADMETA_INSTANTIATE_1_OFFSET UNITYSDK_OFFSET(0xD0BCD60)
#define RPG_CLIENT_PREFABLOADMETA_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xD0BCC10)
#define RPG_CLIENT_PREFABLOADMETA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD0BD030)
#define RPG_CLIENT_PREFABLOADMETA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0BD1B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PrefabLoadMeta_TypeDefinitionIndex = 69544;
