...
#define RPG_CLIENT_VIDEOTEXTURE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD8943D0)
#define RPG_CLIENT_VIDEOTEXTURE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD8948F0)
#define RPG_CLIENT_VIDEOTEXTURE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD8947E0)
#define RPG_CLIENT_VIDEOTEXTURE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD8946D0)
#define RPG_CLIENT_VIDEOTEXTURE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD894550)
#define RPG_CLIENT_VIDEOTEXTURE_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xD894720)
#define RPG_CLIENT_VIDEOTEXTURE_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0xD894790)
#define RPG_CLIENT_VIDEOTEXTURE_PLAY_OFFSET UNITYSDK_OFFSET(0xD8949E0)
#define RPG_CLIENT_VIDEOTEXTURE_SETRENDERERENABLE_OFFSET UNITYSDK_OFFSET(0xD894A90)
#define RPG_CLIENT_VIDEOTEXTURE_SETVIDEOINFO_OFFSET UNITYSDK_OFFSET(0xD894960)
#define RPG_CLIENT_VIDEOTEXTURE_STOP_OFFSET UNITYSDK_OFFSET(0xD894A40)
#define RPG_CLIENT_VIDEOTEXTURE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD894870)
#define RPG_CLIENT_VIDEOTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0xD894B20)

namespace RPG::Client
{
	inline static constexpr unsigned int VideoTexture_TypeDefinitionIndex = 69868;
