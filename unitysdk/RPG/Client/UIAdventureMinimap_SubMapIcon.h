...
#define RPG_CLIENT_UIADVENTUREMINIMAP_SUBMAPICON__CTOR_OFFSET UNITYSDK_OFFSET(0xD79C6B0)
...
namespace RPG::Client
{
	...
	public:
		...
		::UnityEngine::GameObject* NodeTransportType; // 0x28
		::UnityEngine::UI::Image* MappingInfoIcon; // 0x30
		::UnityEngine::GameObject* NodeBgNormalType; // 0x38
		::UnityEngine::GameObject* NodePlayerIcon; // 0x40
		::UnityEngine::UI::Image* EntryIcon; // 0x48
		::UnityEngine::GameObject* NodeRoot; // 0x50
		::UnityEngine::GameObject* NodeNaviIcons; // 0x58
		::UnityEngine::GameObject* NodeTransportIcon; // 0x60
		::UnityEngine::UI::Image* TransportIcon; // 0x68
		::UnityEngine::UI::Image* MissionIcon; // 0x70
		::UnityEngine::GameObject* NodeNormalType; // 0x78
		::UnityEngine::UI::Image* ChestIcon; // 0x80
		::UnityEngine::GameObject* NodeBgTransportType; // 0x88
