...
#define RPG_CLIENT_AUTOPLAYABLE_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xBDD14D0)
#define RPG_CLIENT_AUTOPLAYABLE_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0xBDD1540)
#define RPG_CLIENT_AUTOPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD15B0)

namespace RPG::Client
{
	inline static constexpr unsigned int AutoPlayable_TypeDefinitionIndex = 69231;
