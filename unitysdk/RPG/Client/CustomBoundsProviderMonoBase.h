...
#define RPG_CLIENT_CUSTOMBOUNDSPROVIDERMONOBASE_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xC1CFEE0)
#define RPG_CLIENT_CUSTOMBOUNDSPROVIDERMONOBASE_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xC1CFE30)
#define RPG_CLIENT_CUSTOMBOUNDSPROVIDERMONOBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC1D0050)
