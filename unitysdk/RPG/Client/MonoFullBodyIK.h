...
#define RPG_CLIENT_MONOFULLBODYIK_AWAKE_OFFSET UNITYSDK_OFFSET(0xCCEECB0)
#define RPG_CLIENT_MONOFULLBODYIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0xCCEE080)
#define RPG_CLIENT_MONOFULLBODYIK_INIT_OFFSET UNITYSDK_OFFSET(0xCCEDDF0)
#define RPG_CLIENT_MONOFULLBODYIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCCEED00)
#define RPG_CLIENT_MONOFULLBODYIK_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xCCEF140)
#define RPG_CLIENT_MONOFULLBODYIK_METHOD_5_E6ACF41C29FA8932_OFFSET UNITYSDK_OFFSET(0xCCEEF70)
#define RPG_CLIENT_MONOFULLBODYIK_METHOD_5_E949A493D26573BF_OFFSET UNITYSDK_OFFSET(0xCCEEDE0)
#define RPG_CLIENT_MONOFULLBODYIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCCEED60)
#define RPG_CLIENT_MONOFULLBODYIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xCCEE090)
#define RPG_CLIENT_MONOFULLBODYIK_RESETLIMBCHAINEFFECTOR_OFFSET UNITYSDK_OFFSET(0xCCEE690)
#define RPG_CLIENT_MONOFULLBODYIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0xCCED6D0)
#define RPG_CLIENT_MONOFULLBODYIK_SETFORCEUSELIMBCHAINEFFECTOR_OFFSET UNITYSDK_OFFSET(0xCCEE160)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINBENDGOALWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0xCCEEB50)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINBENDGOAL_OFFSET UNITYSDK_OFFSET(0xCCEEC30)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINEFFECTORBLEND_OFFSET UNITYSDK_OFFSET(0xCCEE400)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINEFFECTOR_OFFSET UNITYSDK_OFFSET(0xCCEE250)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINMAPPINGWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0xCCEEA70)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINPOSITIONWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0xCCEE8A0)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINROTATIONWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0xCCEE980)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0xCCEE7E0)
#define RPG_CLIENT_MONOFULLBODYIK_UNINIT_OFFSET UNITYSDK_OFFSET(0xCCEDD90)
#define RPG_CLIENT_MONOFULLBODYIK__CTOR_OFFSET UNITYSDK_OFFSET(0xCCEF910)
