...
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_GET_ISEDITMODE_OFFSET UNITYSDK_OFFSET(0xD6CFFE0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_04E967564E8CD234_OFFSET UNITYSDK_OFFSET(0xD6D1FF0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_14E95960313F706C_OFFSET UNITYSDK_OFFSET(0xD6D0570)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_18378026938D76D0_OFFSET UNITYSDK_OFFSET(0xD6D0E70)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_501509B4B58077AF_OFFSET UNITYSDK_OFFSET(0xD6D0810)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xD6D2060)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_7BD95CCEB412D95C_1_OFFSET UNITYSDK_OFFSET(0xD6D0AD0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_7BD95CCEB412D95C_2_OFFSET UNITYSDK_OFFSET(0xD6D0B50)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_7BD95CCEB412D95C_3_OFFSET UNITYSDK_OFFSET(0xD6D0C10)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_7BD95CCEB412D95C_OFFSET UNITYSDK_OFFSET(0xD6D0A10)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_A323A7720C85F580_OFFSET UNITYSDK_OFFSET(0xD6CFFF0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xD6D09A0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_B7B52CA164574F49_OFFSET UNITYSDK_OFFSET(0xD6D02C0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_D0916E43A07A622E_OFFSET UNITYSDK_OFFSET(0xD6D0160)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_DD14DC5543DE974C_OFFSET UNITYSDK_OFFSET(0xD6D0D20)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xD6D21D0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD6D20F0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xD6D22B0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xD6D2340)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xD6D23D0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD6D2470)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD6D0FF0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xD6D2540)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD6D2510)

namespace RPG::Client::Timeline
{
	inline static constexpr unsigned int ManaVideoMixerBehaviour_TypeDefinitionIndex = 69996;
	...
	public:
		...
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(ManaVideoMixerBehaviour_TypeDefinitionIndex)->GetStaticField(0xAFF0);
		}
		static ::System::Int32* StaticGet_PROPERTY_TRANSPARENCY()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ManaVideoMixerBehaviour_TypeDefinitionIndex)->GetStaticField(0xAFF8);
		}
