...
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD6CF470)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD6CF460)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xD6CF560)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_GET_ISMOVIEINFOREADY_OFFSET UNITYSDK_OFFSET(0xD6CFCC0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_GET_M_MOVIEPATH_OFFSET UNITYSDK_OFFSET(0xD6CF1C0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_METHOD_4_1E5FDA0F83BB7E46_OFFSET UNITYSDK_OFFSET(0xD6CFB40)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_METHOD_4_343AEE905EA1B6E3_OFFSET UNITYSDK_OFFSET(0xD6CFD10)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_METHOD_4_3C5D39652970A749_OFFSET UNITYSDK_OFFSET(0xD6CF800)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_METHOD_4_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xD6CF220)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_METHOD_4_4F1F4CA10BA8F619_OFFSET UNITYSDK_OFFSET(0xD6CF5C0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_METHOD_4_B3D8593DFBC7CE8E_OFFSET UNITYSDK_OFFSET(0xD6CFA90)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP_SET_M_MOVIEPATH_OFFSET UNITYSDK_OFFSET(0xD6CF450)
#define RPG_CLIENT_TIMELINE_MANAVIDEOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD6CFE90)

namespace RPG::Client::Timeline
{
	inline static constexpr unsigned int ManaVideoClip_TypeDefinitionIndex = 69994;
