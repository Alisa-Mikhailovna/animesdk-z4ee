...
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCD77BD0)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xCD77FF0)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xCD77FD0)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCD77FB0)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xCD78000)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_SET_DESC_OFFSET UNITYSDK_OFFSET(0xCD77FE0)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCD77FC0)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD78010)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CREATEHIGHRESISTANCEDATA_OFFSET UNITYSDK_OFFSET(0xCD77E10)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CREATERESISTANCEDATA_OFFSET UNITYSDK_OFFSET(0xCD77D00)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CREATE_OFFSET UNITYSDK_OFFSET(0xCD77F20)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD77FA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterDamageTypeResistanceData_TypeDefinitionIndex = 68525;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonsterDamageTypeResistanceData_TypeDefinitionIndex)->GetStaticField(0x10B50);
		}
		static ::System::Single* StaticGet__HightResistanceThreshold()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonsterDamageTypeResistanceData_TypeDefinitionIndex)->GetStaticField(0x10B54);
		}
