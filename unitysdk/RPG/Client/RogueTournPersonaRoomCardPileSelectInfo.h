...
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xD4774A0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_GET_CARDINDEX_OFFSET UNITYSDK_OFFSET(0xD477290)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_GET_CARD_OFFSET UNITYSDK_OFFSET(0xD4772B0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_GET_PILECARDSCOUNT_OFFSET UNITYSDK_OFFSET(0xD4770D0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_GET_PILECARDS_OFFSET UNITYSDK_OFFSET(0xD476FC0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_GET_PILETYPE_OFFSET UNITYSDK_OFFSET(0xD476FA0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_SELECTCARDBYINDEX_OFFSET UNITYSDK_OFFSET(0xD477630)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_SELECTPILE_OFFSET UNITYSDK_OFFSET(0xD4775E0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_SET_CARDINDEX_OFFSET UNITYSDK_OFFSET(0xD4772A0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO_SET_PILETYPE_OFFSET UNITYSDK_OFFSET(0xD476FB0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD477570)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDPILESELECTINFO__INIT_OFFSET UNITYSDK_OFFSET(0xD477580)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaRoomCardPileSelectInfo_TypeDefinitionIndex = 69569;
