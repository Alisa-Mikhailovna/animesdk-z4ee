...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xBE942F0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBE94430)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBE94490)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xBE94440)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBE942E0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36__CTOR_OFFSET UNITYSDK_OFFSET(0xBE904A0)
