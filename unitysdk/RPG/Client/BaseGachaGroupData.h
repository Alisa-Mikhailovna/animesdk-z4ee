...
#define RPG_CLIENT_BASEGACHAGROUPDATA_ADDGACHAPOOLDATA_OFFSET UNITYSDK_OFFSET(0xBE25930)
#define RPG_CLIENT_BASEGACHAGROUPDATA_GACHAGROUPCOMPARISON_OFFSET UNITYSDK_OFFSET(0xBE25700)
#define RPG_CLIENT_BASEGACHAGROUPDATA_GETSORTEDGACHAPOOLDATA_OFFSET UNITYSDK_OFFSET(0xBE25BC0)
#define RPG_CLIENT_BASEGACHAGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xBE26050)
#define RPG_CLIENT_BASEGACHAGROUPDATA_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xBE26070)
#define RPG_CLIENT_BASEGACHAGROUPDATA_GET_POOLLABELICONSELECTED_OFFSET UNITYSDK_OFFSET(0xBE26120)
#define RPG_CLIENT_BASEGACHAGROUPDATA_GET_POOLLABELICON_OFFSET UNITYSDK_OFFSET(0xBE260C0)
#define RPG_CLIENT_BASEGACHAGROUPDATA_GET_SORTID_OFFSET UNITYSDK_OFFSET(0xBE258A0)
#define RPG_CLIENT_BASEGACHAGROUPDATA_HASGACHAPOOL_OFFSET UNITYSDK_OFFSET(0xBE25F60)
#define RPG_CLIENT_BASEGACHAGROUPDATA_ISFEATURECLOSED_OFFSET UNITYSDK_OFFSET(0xBE25E10)
#define RPG_CLIENT_BASEGACHAGROUPDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0xBE25CC0)
#define RPG_CLIENT_BASEGACHAGROUPDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xBE26060)
#define RPG_CLIENT_BASEGACHAGROUPDATA_SORT_OFFSET UNITYSDK_OFFSET(0xBE257B0)
#define RPG_CLIENT_BASEGACHAGROUPDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xBE26180)
#define RPG_CLIENT_BASEGACHAGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBE256A0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::BaseGachaPoolData*>**)Il2CppClass::FromTypeDefinitionIndex(BaseGachaGroupData_TypeDefinitionIndex)->GetStaticField(0x52F50);
		}
