...
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD249F0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_BREATHING_OFFSET UNITYSDK_OFFSET(0xCD249A0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ISHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xCD246A0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_5C549BF7442375BC_OFFSET UNITYSDK_OFFSET(0xCD25460)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0xCD252B0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_A8F8D4B2BD31D693_OFFSET UNITYSDK_OFFSET(0xCD24CF0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_C495FC84AA2302E0_OFFSET UNITYSDK_OFFSET(0xCD24FB0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xCD24E70)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCD24D90)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD251B0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD24EB0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xCD24C50)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xCD24DD0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_REPLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xCD24870)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD24A50)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD25510)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD25500)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoSwitchHandHighLightItem_TypeDefinitionIndex)->GetStaticField(0x10930);
		}
