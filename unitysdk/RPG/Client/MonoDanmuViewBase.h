...
#define RPG_CLIENT_MONODANMUVIEWBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC4C560)
#define RPG_CLIENT_MONODANMUVIEWBASE_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCC4C540)
#define RPG_CLIENT_MONODANMUVIEWBASE_SET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCC4C550)
#define RPG_CLIENT_MONODANMUVIEWBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC4C600)
