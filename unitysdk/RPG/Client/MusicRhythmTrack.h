...
#define RPG_CLIENT_MUSICRHYTHMTRACK_CREATE_OFFSET UNITYSDK_OFFSET(0xCE187A0)
#define RPG_CLIENT_MUSICRHYTHMTRACK_GET_EMPTYGRIDLIST_OFFSET UNITYSDK_OFFSET(0xCE18860)
#define RPG_CLIENT_MUSICRHYTHMTRACK_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xCE18990)
#define RPG_CLIENT_MUSICRHYTHMTRACK_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCE18A30)
#define RPG_CLIENT_MUSICRHYTHMTRACK_GET_ID_OFFSET UNITYSDK_OFFSET(0xCE18950)
#define RPG_CLIENT_MUSICRHYTHMTRACK_GET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0xCE18970)
#define RPG_CLIENT_MUSICRHYTHMTRACK_GET_PHASEID_OFFSET UNITYSDK_OFFSET(0xCE189B0)
#define RPG_CLIENT_MUSICRHYTHMTRACK_GET_ROW_OFFSET UNITYSDK_OFFSET(0xCE189D0)
#define RPG_CLIENT_MUSICRHYTHMTRACK_GET_TRACKNAME_OFFSET UNITYSDK_OFFSET(0xCE18B70)
#define RPG_CLIENT_MUSICRHYTHMTRACK_GET_UNLOCKSUBMISSIONID_OFFSET UNITYSDK_OFFSET(0xCE18AD0)
#define RPG_CLIENT_MUSICRHYTHMTRACK_ISGRIDEMPTY_OFFSET UNITYSDK_OFFSET(0xCE16A80)
#define RPG_CLIENT_MUSICRHYTHMTRACK_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xCE189A0)
#define RPG_CLIENT_MUSICRHYTHMTRACK_SET_ID_OFFSET UNITYSDK_OFFSET(0xCE18960)
#define RPG_CLIENT_MUSICRHYTHMTRACK_SET_ISLOCKED_OFFSET UNITYSDK_OFFSET(0xCE18980)
#define RPG_CLIENT_MUSICRHYTHMTRACK_SET_PHASEID_OFFSET UNITYSDK_OFFSET(0xCE189C0)
#define RPG_CLIENT_MUSICRHYTHMTRACK_UNLOCK_OFFSET UNITYSDK_OFFSET(0xCE18820)
#define RPG_CLIENT_MUSICRHYTHMTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xCE18810)
