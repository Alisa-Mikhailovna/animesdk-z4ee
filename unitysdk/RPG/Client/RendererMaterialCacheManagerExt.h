...
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_DESTROYMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0xD329140)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_DESTROYRENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xD329070)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_DISABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0xD3294B0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_ENABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0xD329390)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETCACHEDMATERIALSREADONLY_OFFSET UNITYSDK_OFFSET(0xD329260)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETCACHEDMATERIALS_OFFSET UNITYSDK_OFFSET(0xD3291A0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETCACHEDORIGINMATERIALS_OFFSET UNITYSDK_OFFSET(0xD329310)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0xD3290D0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETRENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xD329000)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0xD329660)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_ISEMPTYDEFAULT_OFFSET UNITYSDK_OFFSET(0xD327F10)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_REMOVEKEYWORDCACHE_OFFSET UNITYSDK_OFFSET(0xD329440)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_RETURNSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0xD3297A0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_SETMATKEYWORD_OFFSET UNITYSDK_OFFSET(0xD329560)
