...
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0722E0)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO_GETALLDECKS_OFFSET UNITYSDK_OFFSET(0xC072CB0)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO_GETUNLOCKEDDECKS_OFFSET UNITYSDK_OFFSET(0xC072DE0)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO_GET_DECKDATAS_OFFSET UNITYSDK_OFFSET(0xC073010)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC072010)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO_RECORDDECKSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0xC072530)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO_SETUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0xC072B50)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO_SYNCDECKSSTATE_OFFSET UNITYSDK_OFFSET(0xC072380)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO_TRYGETDECKDATA_OFFSET UNITYSDK_OFFSET(0xC072C20)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC073050)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO__LOADDECKDATAS_OFFSET UNITYSDK_OFFSET(0xC0720C0)
#define RPG_CLIENT_CHENLINGBATTLEDECKINFO__SYNCDECKDATAS_OFFSET UNITYSDK_OFFSET(0xC0727C0)
