...
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADITEM_GET_LOADERPROXY_OFFSET UNITYSDK_OFFSET(0xC1A2C80)
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADITEM_METHOD_1_95BB86D2BAE68F58_OFFSET UNITYSDK_OFFSET(0xC1A2D70)
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADITEM_METHOD_1_98B7D142FBED6D85_OFFSET UNITYSDK_OFFSET(0xC1A1CF0)
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADITEM_METHOD_1_E137A45E4E2C2065_OFFSET UNITYSDK_OFFSET(0xC1A1720)
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADITEM_METHOD_1_FE6CC0AE50391631_OFFSET UNITYSDK_OFFSET(0xC1A2640)
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC1A3040)
