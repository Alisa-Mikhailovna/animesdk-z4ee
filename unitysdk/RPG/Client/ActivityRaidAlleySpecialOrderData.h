...
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_GOODS_OFFSET UNITYSDK_OFFSET(0xBC62900)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_ORDERID_OFFSET UNITYSDK_OFFSET(0xBC628B0)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_ORDERTIPSPATH_OFFSET UNITYSDK_OFFSET(0xBC62A30)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_ORDERTIPSTIME_OFFSET UNITYSDK_OFFSET(0xBC62AE0)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xBC62910)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_SPECIALORDERCONTENT_OFFSET UNITYSDK_OFFSET(0xBC62750)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_SPECIALORDERGOODS_OFFSET UNITYSDK_OFFSET(0xBC62800)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_SPECIALORDERSHIP_OFFSET UNITYSDK_OFFSET(0xBC62980)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xBC628D0)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_TARGETS_OFFSET UNITYSDK_OFFSET(0xBC628F0)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBC628C0)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA_SET_STATUS_OFFSET UNITYSDK_OFFSET(0xBC628E0)
#define RPG_CLIENT_ACTIVITYRAIDALLEYSPECIALORDERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBC624B0)
