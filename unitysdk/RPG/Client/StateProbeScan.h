...
#define RPG_CLIENT_STATEPROBESCAN_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xD55E270)
#define RPG_CLIENT_STATEPROBESCAN_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xD55E320)
#define RPG_CLIENT_STATEPROBESCAN_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD55E3B0)
#define RPG_CLIENT_STATEPROBESCAN__CTOR_OFFSET UNITYSDK_OFFSET(0xD55E420)
