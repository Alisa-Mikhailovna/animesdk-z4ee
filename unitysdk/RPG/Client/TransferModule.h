...
#define RPG_CLIENT_TRANSFERMODULE_ADDTRANSFERFINISHEDEVENT_OFFSET UNITYSDK_OFFSET(0xD731D20)
#define RPG_CLIENT_TRANSFERMODULE_CANTRANSFER_OFFSET UNITYSDK_OFFSET(0xD731970)
#define RPG_CLIENT_TRANSFERMODULE_FETCHTELEPORTS_OFFSET UNITYSDK_OFFSET(0xD731660)
#define RPG_CLIENT_TRANSFERMODULE_GETMAPENTRYUNLOCKDATA_OFFSET UNITYSDK_OFFSET(0xD7313C0)
#define RPG_CLIENT_TRANSFERMODULE_GET_WAITINGPOSTTELEPORTUI_OFFSET UNITYSDK_OFFSET(0xD733180)
#define RPG_CLIENT_TRANSFERMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xD731130)
#define RPG_CLIENT_TRANSFERMODULE_ISENTRYUNLOCKED_OFFSET UNITYSDK_OFFSET(0xD731900)
#define RPG_CLIENT_TRANSFERMODULE_ISTELEPORTSHORTCUT_OFFSET UNITYSDK_OFFSET(0xD731BB0)
#define RPG_CLIENT_TRANSFERMODULE_ISTELEPORTUNLOCKED_OFFSET UNITYSDK_OFFSET(0xD731AE0)
#define RPG_CLIENT_TRANSFERMODULE_PREPAREENTRYMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xD731470)
#define RPG_CLIENT_TRANSFERMODULE_SETTRANSFERAUTOSHOW_OFFSET UNITYSDK_OFFSET(0xD72FD90)
#define RPG_CLIENT_TRANSFERMODULE_SETTRANSFERFINISHEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xD731E90)
#define RPG_CLIENT_TRANSFERMODULE_SET_WAITINGPOSTTELEPORTUI_OFFSET UNITYSDK_OFFSET(0xD733190)
#define RPG_CLIENT_TRANSFERMODULE_TRANSFER_OFFSET UNITYSDK_OFFSET(0xD72D660)
#define RPG_CLIENT_TRANSFERMODULE_TRYAUTOSHOW_OFFSET UNITYSDK_OFFSET(0xD731EE0)
#define RPG_CLIENT_TRANSFERMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xD732F80)
#define RPG_CLIENT_TRANSFERMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0xD732160)
#define RPG_CLIENT_TRANSFERMODULE__ADDTRANSFERFINISHEDEVENT_OFFSET UNITYSDK_OFFSET(0xD731D80)
#define RPG_CLIENT_TRANSFERMODULE__BUILDMAPENTRIES_OFFSET UNITYSDK_OFFSET(0xD731180)
#define RPG_CLIENT_TRANSFERMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xD7331A0)
#define RPG_CLIENT_TRANSFERMODULE__ONADVENTUREPHASEENTERED_OFFSET UNITYSDK_OFFSET(0xD7330E0)
#define RPG_CLIENT_TRANSFERMODULE__ONEMITTRANSFERFINISHEVENT_OFFSET UNITYSDK_OFFSET(0xD733130)
#define RPG_CLIENT_TRANSFERMODULE__ONENTERSCENESCRSP_OFFSET UNITYSDK_OFFSET(0xD732D70)
#define RPG_CLIENT_TRANSFERMODULE__ONGETSCENEMAPINFOSCRSP_OFFSET UNITYSDK_OFFSET(0xD7328D0)
#define RPG_CLIENT_TRANSFERMODULE__ONGETUNLOCKTELEPORTSCRSP_OFFSET UNITYSDK_OFFSET(0xD7325C0)
#define RPG_CLIENT_TRANSFERMODULE__ONUNLOCKTELEPORTNOTIFY_OFFSET UNITYSDK_OFFSET(0xD732420)
#define RPG_CLIENT_TRANSFERMODULE__TRYNOTIFYTRANSFERFINISHEDEVENT_OFFSET UNITYSDK_OFFSET(0xD731F40)
#define RPG_CLIENT_TRANSFERMODULE__UPDATETELEPORTS_1_OFFSET UNITYSDK_OFFSET(0xD7324B0)
#define RPG_CLIENT_TRANSFERMODULE__UPDATETELEPORTS_OFFSET UNITYSDK_OFFSET(0xD732690)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* _UnlockedTeleportIDs; // 0x38
