...
#define RPG_CLIENT_TUTORIALUIWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD76F3D0)
#define RPG_CLIENT_TUTORIALUIWRAPPER_GET_UILAYER_OFFSET UNITYSDK_OFFSET(0xD76F3F0)
#define RPG_CLIENT_TUTORIALUIWRAPPER_SET_NAME_OFFSET UNITYSDK_OFFSET(0xD76F3E0)
#define RPG_CLIENT_TUTORIALUIWRAPPER_SET_UILAYER_OFFSET UNITYSDK_OFFSET(0xD76F400)
#define RPG_CLIENT_TUTORIALUIWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0xD766150)
