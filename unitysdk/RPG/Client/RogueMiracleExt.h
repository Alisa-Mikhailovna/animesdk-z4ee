...
#define RPG_CLIENT_ROGUEMIRACLEEXT_ASINGAME_OFFSET UNITYSDK_OFFSET(0xD3D9790)
#define RPG_CLIENT_ROGUEMIRACLEEXT_ASTOURNINGAME_OFFSET UNITYSDK_OFFSET(0xD3D97F0)
#define RPG_CLIENT_ROGUEMIRACLEEXT_ASWITHCATEGORY_OFFSET UNITYSDK_OFFSET(0xD3D9730)
#define RPG_CLIENT_ROGUEMIRACLEEXT_GETALLHEXMIRACLES_OFFSET UNITYSDK_OFFSET(0xD3D9850)
#define RPG_CLIENT_ROGUEMIRACLEEXT_GETMIRACLESBYCATEGORY_OFFSET UNITYSDK_OFFSET(0xD3D98A0)
#define RPG_CLIENT_ROGUEMIRACLEEXT_ISMIRACLEACHIEVED_OFFSET UNITYSDK_OFFSET(0xD3D9AF0)
