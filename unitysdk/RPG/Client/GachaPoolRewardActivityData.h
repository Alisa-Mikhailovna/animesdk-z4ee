...
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_GET_QUESTDESC_OFFSET UNITYSDK_OFFSET(0xC677010)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_GET_REWARDDATA_OFFSET UNITYSDK_OFFSET(0xC676F40)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_GET_REWARDQUEST_OFFSET UNITYSDK_OFFSET(0xC676D20)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_ISSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0xC676DE0)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_ISSHOWEARLYACCESSREDDOT_OFFSET UNITYSDK_OFFSET(0xC676EE0)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0xC676D80)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xC676C90)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_SET_REWARDDATA_OFFSET UNITYSDK_OFFSET(0xC676F50)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC676AB0)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA__INITGACHAPOOLREWARDDATA_OFFSET UNITYSDK_OFFSET(0xC676B10)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA__ISNEEDSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0xC676E30)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA__ONINIT_OFFSET UNITYSDK_OFFSET(0xC676AC0)
