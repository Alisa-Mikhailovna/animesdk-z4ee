...
#define RPG_CLIENT_ENTERGAMEPHASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC3CB0A0)
#define RPG_CLIENT_ENTERGAMEPHASE_ENTERGAME_OFFSET UNITYSDK_OFFSET(0xC3CE850)
#define RPG_CLIENT_ENTERGAMEPHASE_ENTER_OFFSET UNITYSDK_OFFSET(0xC3CB3B0)
#define RPG_CLIENT_ENTERGAMEPHASE_FINISHLOGIN_OFFSET UNITYSDK_OFFSET(0xC3CE750)
#define RPG_CLIENT_ENTERGAMEPHASE_GETGAMEPHASETYPE_OFFSET UNITYSDK_OFFSET(0xC3CD670)
#define RPG_CLIENT_ENTERGAMEPHASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC3CB350)
#define RPG_CLIENT_ENTERGAMEPHASE_LEAVE_OFFSET UNITYSDK_OFFSET(0xC3CD590)
#define RPG_CLIENT_ENTERGAMEPHASE_PS_PSNCHECK_OFFSET UNITYSDK_OFFSET(0xC3CE5C0)
#define RPG_CLIENT_ENTERGAMEPHASE_RESETTIMEOUTTIME_OFFSET UNITYSDK_OFFSET(0xC3CD7F0)
#define RPG_CLIENT_ENTERGAMEPHASE_TICK_OFFSET UNITYSDK_OFFSET(0xC3CB120)
#define RPG_CLIENT_ENTERGAMEPHASE_TRYQUITBATTLEWHENLOGIN_OFFSET UNITYSDK_OFFSET(0xC3CE920)
#define RPG_CLIENT_ENTERGAMEPHASE__ADDHANDLERS_OFFSET UNITYSDK_OFFSET(0xC3CBB40)
#define RPG_CLIENT_ENTERGAMEPHASE__CHECKMISSIONRES_OFFSET UNITYSDK_OFFSET(0xC3CCF90)
#define RPG_CLIENT_ENTERGAMEPHASE__CHECKSERVERSTATE_OFFSET UNITYSDK_OFFSET(0xC3CC280)
#define RPG_CLIENT_ENTERGAMEPHASE__CMDIMPORTANTPACKETRECV_OFFSET UNITYSDK_OFFSET(0xC3CD6C0)
#define RPG_CLIENT_ENTERGAMEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC3CAEF0)
#define RPG_CLIENT_ENTERGAMEPHASE__ENABLELOGINBUTTON_OFFSET UNITYSDK_OFFSET(0xC3CBD30)
#define RPG_CLIENT_ENTERGAMEPHASE__FINISHENTERANIM_OFFSET UNITYSDK_OFFSET(0xC3CC1F0)
#define RPG_CLIENT_ENTERGAMEPHASE__LOGINEXCEPTIONHANDLER_OFFSET UNITYSDK_OFFSET(0xC3CEA40)
#define RPG_CLIENT_ENTERGAMEPHASE__LOGINREPORTMSG_OFFSET UNITYSDK_OFFSET(0xC3CDA50)
#define RPG_CLIENT_ENTERGAMEPHASE__ONCONFIRMENTER_OFFSET UNITYSDK_OFFSET(0xC3CD850)
#define RPG_CLIENT_ENTERGAMEPHASE__ONEXCEPTION_OFFSET UNITYSDK_OFFSET(0xC3CEC50)
#define RPG_CLIENT_ENTERGAMEPHASE__ONFINISHENTERANIM_OFFSET UNITYSDK_OFFSET(0xC3CC190)
#define RPG_CLIENT_ENTERGAMEPHASE__ONNETCONTINUE_OFFSET UNITYSDK_OFFSET(0xC3CDE40)
#define RPG_CLIENT_ENTERGAMEPHASE__RELOADASSETREFMANIFEST_OFFSET UNITYSDK_OFFSET(0xC3CE640)
#define RPG_CLIENT_ENTERGAMEPHASE__SETUPFUNCTIONBTN_OFFSET UNITYSDK_OFFSET(0xC3CBA70)
#define RPG_CLIENT_ENTERGAMEPHASE__STARTLOGIN_OFFSET UNITYSDK_OFFSET(0xC3CDEB0)
#define RPG_CLIENT_ENTERGAMEPHASE__SUBPACKAGECHECKED_OFFSET UNITYSDK_OFFSET(0xC3CCDD0)
#define RPG_CLIENT_ENTERGAMEPHASE__SUBPACKAGEMISSIONGOTTED_OFFSET UNITYSDK_OFFSET(0xC3CC880)
#define RPG_CLIENT_ENTERGAMEPHASE__TABLEINITED_OFFSET UNITYSDK_OFFSET(0xC3CC5C0)
#define RPG_CLIENT_ENTERGAMEPHASE__TRYSAVESELECTEDSERVER_OFFSET UNITYSDK_OFFSET(0xC3CDBF0)
#define RPG_CLIENT_ENTERGAMEPHASE___SUBPACKAGECHECKED_B__15_0_OFFSET UNITYSDK_OFFSET(0xC3CEF70)
...
namespace RPG::Client
{
	...
	public:
		...
		::UnityEngine::Coroutine* _AudioInitCoroutine; // 0x40
