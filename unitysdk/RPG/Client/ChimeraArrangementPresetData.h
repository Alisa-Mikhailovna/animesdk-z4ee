...
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC109A00)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_GET_ARRANGEDCOMMONS_OFFSET UNITYSDK_OFFSET(0xC109950)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC109890)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC109820)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC109830)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC1099F0)
