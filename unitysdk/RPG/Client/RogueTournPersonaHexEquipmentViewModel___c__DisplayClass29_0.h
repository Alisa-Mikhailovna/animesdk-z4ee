...
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTVIEWMODEL___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD46F100)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTVIEWMODEL___C__DISPLAYCLASS29_0__EQUIPHEX_B__1_OFFSET UNITYSDK_OFFSET(0xD46FD30)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTVIEWMODEL___C__DISPLAYCLASS29_0__EQUIPHEX_B__2_OFFSET UNITYSDK_OFFSET(0xD46FDE0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaHexEquipmentViewModel___c__DisplayClass29_0_TypeDefinitionIndex = 69580;
