...
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBC00FA0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDDATA_GET_REWARDGROUPLIST_OFFSET UNITYSDK_OFFSET(0xBC01040)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDDATA_HASUNTAKENREWARD_1_OFFSET UNITYSDK_OFFSET(0xBC006C0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDDATA_HASUNTAKENREWARD_OFFSET UNITYSDK_OFFSET(0xBC004D0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDDATA_SET_REWARDGROUPLIST_OFFSET UNITYSDK_OFFSET(0xBC01050)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBC01020)
