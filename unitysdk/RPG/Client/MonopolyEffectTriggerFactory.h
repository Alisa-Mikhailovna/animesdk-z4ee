...
#define RPG_CLIENT_MONOPOLYEFFECTTRIGGERFACTORY_CREATETRIGGER_1_OFFSET UNITYSDK_OFFSET(0xCD45500)
#define RPG_CLIENT_MONOPOLYEFFECTTRIGGERFACTORY_CREATETRIGGER_OFFSET UNITYSDK_OFFSET(0xCD44570)
#define RPG_CLIENT_MONOPOLYEFFECTTRIGGERFACTORY__CREATEADDITEMTRIGGER_OFFSET UNITYSDK_OFFSET(0xCD44940)
#define RPG_CLIENT_MONOPOLYEFFECTTRIGGERFACTORY__CREATESUBITEMTRIGGER_OFFSET UNITYSDK_OFFSET(0xCD44ED0)
#define RPG_CLIENT_MONOPOLYEFFECTTRIGGERFACTORY__FETCHTELEPORTTRIGGER_OFFSET UNITYSDK_OFFSET(0xCD452D0)
