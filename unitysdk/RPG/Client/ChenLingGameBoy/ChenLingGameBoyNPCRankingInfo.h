...
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xC0D1D70)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_FINISHEDTIME_OFFSET UNITYSDK_OFFSET(0xC0D2040)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0xC0D1E80)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xC0D1FF0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC0D1ED0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_PLAYERTYPE_OFFSET UNITYSDK_OFFSET(0xC0D2090)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0xC0D1F60)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC0D1E20)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO__INIT_OFFSET UNITYSDK_OFFSET(0xC0D1E30)

namespace RPG::Client::ChenLingGameBoy
{
	inline static constexpr unsigned int ChenLingGameBoyNPCRankingInfo_TypeDefinitionIndex = 71356;
