...
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_GET_SINGLETONINSTANCEOBJECT_OFFSET UNITYSDK_OFFSET(0xCA2E7D0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_GET_TOWERDIRECTIONTYPE_OFFSET UNITYSDK_OFFSET(0xCA2E7B0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_1FDE3BA9363A99B1_1_OFFSET UNITYSDK_OFFSET(0xCA2C840)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_1FDE3BA9363A99B1_OFFSET UNITYSDK_OFFSET(0xCA2C760)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCA2C7D0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_D324BB8C61889D31_OFFSET UNITYSDK_OFFSET(0xCA2BF00)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_SET_SINGLETONINSTANCEOBJECT_OFFSET UNITYSDK_OFFSET(0xCA2E7E0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_SET_TOWERDIRECTIONTYPE_OFFSET UNITYSDK_OFFSET(0xCA2E7C0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xCA2D400)
