...
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_GETTARGETAVATARID_OFFSET UNITYSDK_OFFSET(0xCFF99A0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_GET_PERCENTINCREASE_OFFSET UNITYSDK_OFFSET(0xCFF93A0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_ISAVATARBUFF_OFFSET UNITYSDK_OFFSET(0xCFF93E0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_ISEFFECTIVEONAVATAR_OFFSET UNITYSDK_OFFSET(0xCFF9590)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0xCFF95F0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF9BC0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__GETDESC_OFFSET UNITYSDK_OFFSET(0xCFF99E0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__GETICONPATH_OFFSET UNITYSDK_OFFSET(0xCFF9490)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__GETLARGEICONPATH_OFFSET UNITYSDK_OFFSET(0xCFF9510)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__ONINITPARAM_OFFSET UNITYSDK_OFFSET(0xCFF9420)
