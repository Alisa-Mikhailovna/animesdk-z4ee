...
#define RPG_CLIENT_MONOVIDEOALPHACONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD3C8D0)
#define RPG_CLIENT_MONOVIDEOALPHACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD3C970)
#define RPG_CLIENT_MONOVIDEOALPHACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3CA20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoVideoAlphaController_TypeDefinitionIndex = 69856;
