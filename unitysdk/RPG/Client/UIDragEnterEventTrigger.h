...
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_ADDAREA_OFFSET UNITYSDK_OFFSET(0xD7B6080)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_BINDDRAGENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7B6300)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD7B63A0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD7B6350)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7B64B0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__CANDRAG_OFFSET UNITYSDK_OFFSET(0xD7B63F0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7B7250)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__ENDDRAG_OFFSET UNITYSDK_OFFSET(0xD7B6690)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__ISLINESEGMENTSINTERSECT_OFFSET UNITYSDK_OFFSET(0xD7B7050)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__REACHTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xD7B66E0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__STARTDRAG_OFFSET UNITYSDK_OFFSET(0xD7B6770)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__TRIGGERDRAGENTER_OFFSET UNITYSDK_OFFSET(0xD7B6FE0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__UPDATEDRAG_OFFSET UNITYSDK_OFFSET(0xD7B6AB0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER___ISLINESEGMENTSINTERSECT_G__CROSSPRODUCT_11_0_OFFSET UNITYSDK_OFFSET(0xD7B7200)

namespace RPG::Client
{
	inline static constexpr unsigned int UIDragEnterEventTrigger_TypeDefinitionIndex = 69716;
