...
#define RPG_CLIENT_RTCHARACTERANIMINFOBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0xD4B28D0)

namespace RPG::Client
{
	inline static constexpr unsigned int RtCharacterAnimInfoBaker_TypeDefinitionIndex = 69900;
