...
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xC2FDA20)
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN_UPDATERENDERERPACKAGES_OFFSET UNITYSDK_OFFSET(0xC2FD730)
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xC2FDA70)
