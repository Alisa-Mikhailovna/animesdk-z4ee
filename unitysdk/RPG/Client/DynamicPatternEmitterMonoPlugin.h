...
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xC2DC620)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xC2E0650)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xC2E04E0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0xC2E0500)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0xC2E0700)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xC2DC220)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_METHOD_7_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xC2E04D0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC2E04C0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xC2E04F0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_SET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0xC2E0510)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_STARTPLAY_OFFSET UNITYSDK_OFFSET(0xC2E0520)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_STOPPLAY_OFFSET UNITYSDK_OFFSET(0xC2E05D0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0xC2E09C0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E08D0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DynamicPatternEmitterMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x678A0);
		}
