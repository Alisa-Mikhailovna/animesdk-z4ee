...
#define RPG_CLIENT_DEVACCOUNTMODEL_ISACCOUNTUIDVALID_OFFSET UNITYSDK_OFFSET(0xC1E0900)
#define RPG_CLIENT_DEVACCOUNTMODEL_ISUIDVALID_OFFSET UNITYSDK_OFFSET(0xC1E08B0)
#define RPG_CLIENT_DEVACCOUNTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E0890)
