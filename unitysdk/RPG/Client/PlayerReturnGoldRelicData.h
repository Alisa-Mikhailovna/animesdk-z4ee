...
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xD0AFEA0)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD0AFAC0)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_GET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0xD0AFF70)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_GET_INNERSETID_OFFSET UNITYSDK_OFFSET(0xD0AFF30)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_GET_OUTERSETID_OFFSET UNITYSDK_OFFSET(0xD0AFF50)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_GET_RELICITEMLIST_OFFSET UNITYSDK_OFFSET(0xD0AFF90)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_SET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0xD0AFF80)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_SET_INNERSETID_OFFSET UNITYSDK_OFFSET(0xD0AFF40)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_SET_OUTERSETID_OFFSET UNITYSDK_OFFSET(0xD0AFF60)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA_SET_RELICITEMLIST_OFFSET UNITYSDK_OFFSET(0xD0AFFA0)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0AFB60)
#define RPG_CLIENT_PLAYERRETURNGOLDRELICDATA__INIT_OFFSET UNITYSDK_OFFSET(0xD0AFB70)
