...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xC959BB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_LEVELOFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0xC959B60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_PREITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xC95A220)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_PRELEVELOFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0xC95A1D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_ISOFFERINGOVERFLOW_OFFSET UNITYSDK_OFFSET(0xC95A440)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_ISPREOFFERINGLIMIT_OFFSET UNITYSDK_OFFSET(0xC959A70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC95B240)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsSubmitLevelViewModel_TypeDefinitionIndex = 75541;
