...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xC947CC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC93A870)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0xC947BD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_OFFICESURVEYTYPE_OFFSET UNITYSDK_OFFSET(0xC947D90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPECOLORSTATE_OFFSET UNITYSDK_OFFSET(0xC947DF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPEICON_OFFSET UNITYSDK_OFFSET(0xC947DB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPEMASKCOLORSTATE_OFFSET UNITYSDK_OFFSET(0xC947E50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPETEXTID_OFFSET UNITYSDK_OFFSET(0xC947DD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_SET_OFFICESURVEYTYPE_OFFSET UNITYSDK_OFFSET(0xC947DA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_SET_SURVEYTYPEICON_OFFSET UNITYSDK_OFFSET(0xC947DC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_SET_SURVEYTYPETEXTID_OFFSET UNITYSDK_OFFSET(0xC947DE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC947C50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA__INITBYROW_OFFSET UNITYSDK_OFFSET(0xC947C60)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyTypeData_TypeDefinitionIndex = 75423;
