...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC939750)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0xC938B90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONANIMATIONTRIGGER_OFFSET UNITYSDK_OFFSET(0xC939920)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC939160)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0xC939830)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC938C60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONLIMAONEWSWEBSITESTATECHANGEMESSAGE_OFFSET UNITYSDK_OFFSET(0xC939880)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueSubmitWindow_TypeDefinitionIndex = 75478;
	...
	public:
		...
		::RPG::Client::MonoAnimationTrigger* _MonoAnimationTriggerRoot; // 0x68
