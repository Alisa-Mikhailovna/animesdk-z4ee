...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC9415C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0xC941B70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0xC941BD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0xC941C10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0xC941C90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0xC941B10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0xC941C30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0xC941BB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0xC941B90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0xC941BF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0xC941C70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0xC941C50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0xC941B50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0xC941B30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xC941130)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0xC941B80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0xC941BE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0xC941C20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0xC941CA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0xC941B20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0xC941C40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0xC941BC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0xC941BA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0xC941C00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0xC941C80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0xC941C60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0xC941B60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0xC941B40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC941CB0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsModule_TypeDefinitionIndex = 75418;
	...
	public:
		...
		::RPG::Client::LimaoNews::LimaoNewsOfferingService* _OfferingService_k__BackingField; // 0x18
		::RPG::Client::LimaoNews::LimaoNewsNetworkService* _NetworkService_k__BackingField; // 0x20
		::RPG::Client::LimaoNews::LimaoNewsMessageService* _MessageService_k__BackingField; // 0x28
		::RPG::Client::LimaoNews::LimaoNewsOfficeSurveyService* _OfficeSurveyService_k__BackingField; // 0x30
		::RPG::Client::LimaoNews::LimaoNewsTrackService* _TrackService_k__BackingField; // 0x38
		::RPG::Client::LimaoNews::LimaoNewsPostService* _PostService_k__BackingField; // 0x40
		::Class_1_4780C96744815F8D* _LimaoService_k__BackingField; // 0x48
		::Class_1_895FB63906FAA27E* _OfficeEventService_k__BackingField; // 0x50
		::Class_1_0BE9E9C1D5A3C687* _ConditionService_k__BackingField; // 0x58
		::Class_1_9917656EF7E54194* _SponsorService_k__BackingField; // 0x60
		::RPG::Client::LimaoNews::LimaoNewsWindowService* _WindowService_k__BackingField; // 0x68
