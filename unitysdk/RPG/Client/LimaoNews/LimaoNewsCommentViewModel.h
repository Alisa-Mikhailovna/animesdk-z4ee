...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_ADDSUBCOMMENT_OFFSET UNITYSDK_OFFSET(0xC925E30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_CREATEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xC925910)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC925100)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_ANIMATIONFLAG_OFFSET UNITYSDK_OFFSET(0xC9262B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_CANSHOWSUBCOMMENTS_OFFSET UNITYSDK_OFFSET(0xC9262D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_CANSHOW_OFFSET UNITYSDK_OFFSET(0xC9249C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_COMMENTDESC_OFFSET UNITYSDK_OFFSET(0xC923080)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_COMMENTICON_OFFSET UNITYSDK_OFFSET(0xC923040)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_COMMENTID_OFFSET UNITYSDK_OFFSET(0xC923650)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_COMMENTNAME_OFFSET UNITYSDK_OFFSET(0xC9261D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_ISBANNED_OFFSET UNITYSDK_OFFSET(0xC925C10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_ISOFFICIALUSER_OFFSET UNITYSDK_OFFSET(0xC926250)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_STATEID_OFFSET UNITYSDK_OFFSET(0xC926210)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_GET_SUBCOMMENTS_OFFSET UNITYSDK_OFFSET(0xC926290)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_REFRESHCANSHOWSUBCOMMENTS_OFFSET UNITYSDK_OFFSET(0xC925F50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_RESETANIMATIONFLAG_OFFSET UNITYSDK_OFFSET(0xC925DE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SETANIMATIONFLAGFADEIN_OFFSET UNITYSDK_OFFSET(0xC925070)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SETCOMMENTSTATE_OFFSET UNITYSDK_OFFSET(0xC925990)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_ANIMATIONFLAG_OFFSET UNITYSDK_OFFSET(0xC9262C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_CANSHOWSUBCOMMENTS_OFFSET UNITYSDK_OFFSET(0xC9262E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_CANSHOW_OFFSET UNITYSDK_OFFSET(0xC925D70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_COMMENTDESC_OFFSET UNITYSDK_OFFSET(0xC9257F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_COMMENTICON_OFFSET UNITYSDK_OFFSET(0xC9256D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_COMMENTID_OFFSET UNITYSDK_OFFSET(0xC925640)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_COMMENTNAME_OFFSET UNITYSDK_OFFSET(0xC925760)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_ISBANNED_OFFSET UNITYSDK_OFFSET(0xC925CE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_ISOFFICIALUSER_OFFSET UNITYSDK_OFFSET(0xC925880)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_STATEID_OFFSET UNITYSDK_OFFSET(0xC925C50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL_SET_SUBCOMMENTS_OFFSET UNITYSDK_OFFSET(0xC9262A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC925620)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsCommentViewModel_TypeDefinitionIndex = 75512;
	...
	public:
		...
		::System::Boolean _IsOfficialUser; // 0x4C
		::System::Boolean _CanShow; // 0x4D
		::System::Boolean _IsBanned; // 0x4E
