...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSTATETAGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC959160)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSTATETAGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC958D80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSTATETAGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC958C80)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsStateTagControl_TypeDefinitionIndex = 75461;
