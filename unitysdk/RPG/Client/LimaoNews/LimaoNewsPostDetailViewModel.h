...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_CLEARREDDOT_OFFSET UNITYSDK_OFFSET(0xC94A410)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_DEFAULTCOMMENTID_OFFSET UNITYSDK_OFFSET(0xC94AF40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_GUID_OFFSET UNITYSDK_OFFSET(0xC94AF60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xC94AEE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_ONBTNGO_OFFSET UNITYSDK_OFFSET(0xC94AEC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_ONBTNIMAGE_OFFSET UNITYSDK_OFFSET(0xC94AF00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_POSTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC94AF20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_TEXTBTNGO_OFFSET UNITYSDK_OFFSET(0xC94A4E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SETDEFAULTCOMMENTID_OFFSET UNITYSDK_OFFSET(0xC94A490)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_DEFAULTCOMMENTID_OFFSET UNITYSDK_OFFSET(0xC94AF50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_GUID_OFFSET UNITYSDK_OFFSET(0xC94AF70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xC94AEF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_ONBTNGO_OFFSET UNITYSDK_OFFSET(0xC94AED0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_ONBTNIMAGE_OFFSET UNITYSDK_OFFSET(0xC94AF10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_POSTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC94AF30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC94A2B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL__GOTO_OFFSET UNITYSDK_OFFSET(0xC94AB60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xC94AF80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0xC94B020)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0xC94B030)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPostDetailViewModel_TypeDefinitionIndex = 75545;
	...
	public:
		...
		::Sofa::Core::SimpleCommand* _OnBtnImage_k__BackingField; // 0x30
		::RPG::Client::LimaoNews::LimaoNewsPostViewModel* _PostViewModel_k__BackingField; // 0x38
