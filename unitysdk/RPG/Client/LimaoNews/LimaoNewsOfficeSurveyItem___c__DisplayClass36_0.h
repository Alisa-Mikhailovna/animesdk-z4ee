...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC946990)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM___C__DISPLAYCLASS36_0__FETCHFIRSTJUMPABLESUBMISSIONDATA_B__0_OFFSET UNITYSDK_OFFSET(0xC946DB0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyItem___c__DisplayClass36_0_TypeDefinitionIndex = 75422;
