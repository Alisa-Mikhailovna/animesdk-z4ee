...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_CANSHOWISSUETAB_OFFSET UNITYSDK_OFFSET(0xC95F510)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0xC95F620)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC95F660)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_GUID_OFFSET UNITYSDK_OFFSET(0xC95F7E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC95F640)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xC95F5C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xC95F600)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0xC95F5E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_PREFABSTATE_OFFSET UNITYSDK_OFFSET(0xC95F580)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_REPORTSTATE_OFFSET UNITYSDK_OFFSET(0xC95F6A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC95F680)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0xC95F630)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC95F670)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_GUID_OFFSET UNITYSDK_OFFSET(0xC95F7F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC95F650)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xC95F5D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xC95F610)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0xC95F5F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_PREFABSTATE_OFFSET UNITYSDK_OFFSET(0xC95F480)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC95F690)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC95EFC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xC95F800)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0xC95F920)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0xC95FA40)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWebsiteViewModel_TypeDefinitionIndex = 75542;
	...
	public:
		...
		::RPG::Client::LimaoNews::LimaoNewsWebsiteViewModelParam* _DefaultParam_k__BackingField; // 0x20
		...
		::RPG::Client::LimaoNews::LimaoNewsIssueViewModel* _IssueViewModel_k__BackingField; // 0x48
		::RPG::Client::LimaoNews::LimaoNewsIssueService* _IssueService; // 0x50
		::RPG::Client::LimaoNews::LimaoNewsNetworkService* _NetworkService; // 0x58
		::RPG::Client::LimaoNews::LimaoNewsForumViewModel* _ForumViewModel_k__BackingField; // 0x60
		::RPG::Client::LimaoNews::LimaoNewsPostService* _PostService; // 0x68
		::Sofa::Core::SimpleCommand* _OnBtnForm_k__BackingField; // 0x70
		::RPG::Client::LimaoNews::LimaoNewsSponsorViewModel* _SponsorViewModel_k__BackingField; // 0x78
		::RPG::Client::LimaoNews::LimaoNewsWindowService* _WindowService; // 0x80
