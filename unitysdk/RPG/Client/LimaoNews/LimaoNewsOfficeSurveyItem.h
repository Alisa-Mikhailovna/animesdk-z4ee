...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xC9453A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC9456A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_FETCHFIRSTJUMPABLESUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xC946720)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GETBIGMAPICON_OFFSET UNITYSDK_OFFSET(0xC9469A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GETLIMAODATA_OFFSET UNITYSDK_OFFSET(0xC945E80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GETLOACTIONDATA_OFFSET UNITYSDK_OFFSET(0xC946000)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GETSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0xC945EE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_CURCONTENTDATAS_OFFSET UNITYSDK_OFFSET(0xC9464A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_CURCONTENTID_OFFSET UNITYSDK_OFFSET(0xC946320)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC9461A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_DISPLAYREWARDID_OFFSET UNITYSDK_OFFSET(0xC945880)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_FINISHCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0xC945D30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_HIDEREWARDAFTERSTART_OFFSET UNITYSDK_OFFSET(0xC945980)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_ISMISSIONTARGET_OFFSET UNITYSDK_OFFSET(0xC946AC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_LIMAOID_OFFSET UNITYSDK_OFFSET(0xC945750)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0xC945770)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_SHOWCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0xC945A90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_STARTCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0xC945BE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_SURVEYID_OFFSET UNITYSDK_OFFSET(0xC945730)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_REFRESH_OFFSET UNITYSDK_OFFSET(0xC9456E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_SET_LIMAOID_OFFSET UNITYSDK_OFFSET(0xC945760)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_SET_SURVEYID_OFFSET UNITYSDK_OFFSET(0xC945740)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC945420)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__GETFIRSTJUMPABLESUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xC946B20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__GETFIRSTSTARTANDHASWAYPOINTSUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xC946C00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__GETSURVEYROW_OFFSET UNITYSDK_OFFSET(0xC945820)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__INITTRACKDATALIST_OFFSET UNITYSDK_OFFSET(0xC945460)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyItem_TypeDefinitionIndex = 75421;

	class LimaoNewsOfficeSurveyItem : public ::System::Object
	{
	public:
		::RPG::Client::LimaoNews::LimaoNewsLocationData* _LocationData; // 0x10
		...
		::System::Collections::Generic::List_1<::Class_1_F917B69C2E81F61E*>* TrackDataList; // 0x28
