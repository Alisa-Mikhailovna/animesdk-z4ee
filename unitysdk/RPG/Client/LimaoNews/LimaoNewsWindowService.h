...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_CREATEINTERVIEWDETAILPAGE_1_OFFSET UNITYSDK_OFFSET(0xC9635D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_CREATEINTERVIEWDETAILPAGE_OFFSET UNITYSDK_OFFSET(0xC963730)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_CREATEPOSTDETAILWINDOW_OFFSET UNITYSDK_OFFSET(0xC958610)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_CREATEWEBSITEPAGE_OFFSET UNITYSDK_OFFSET(0xC9632B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC962990)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_ENTERMAINENTRANCEPAGE_OFFSET UNITYSDK_OFFSET(0xC9629D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWINTERVIEWDETAILPAGE_OFFSET UNITYSDK_OFFSET(0xC963550)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWISSUESUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0xC963A00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWLIMAONEWSISSUEHINTPOPUPMESSAGE_OFFSET UNITYSDK_OFFSET(0xC963CA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWLIMAONEWSSPONSORINTRODUCTION_OFFSET UNITYSDK_OFFSET(0xC958A30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWMAINENTRANCEPAGE_OFFSET UNITYSDK_OFFSET(0xC962B40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWMAINENTRANCEWEBSITEPAGE_OFFSET UNITYSDK_OFFSET(0xC962CF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTDETAILWINDOWBYPOSTDATA_OFFSET UNITYSDK_OFFSET(0xC963990)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTDETAILWINDOW_OFFSET UNITYSDK_OFFSET(0xC953610)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTFULLSCREENCOMIC_OFFSET UNITYSDK_OFFSET(0xC953000)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTFULLSCREENVIDEO_OFFSET UNITYSDK_OFFSET(0xC953290)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTSUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0xC963B50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWWEBSITEPAGE_1_OFFSET UNITYSDK_OFFSET(0xC963110)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWWEBSITEPAGE_OFFSET UNITYSDK_OFFSET(0xC963180)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xC963E80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__ENTERMAINENTRANCEPAGE_B__1_0_OFFSET UNITYSDK_OFFSET(0xC963E90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__ENTERMAINENTRANCEPAGE_B__1_1_OFFSET UNITYSDK_OFFSET(0xC9641E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__ONTRIGGERENTRANCENEWGUIDE_OFFSET UNITYSDK_OFFSET(0xC963E00)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWindowService_TypeDefinitionIndex = 75450;
