...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_BTNLIKECOMMAND_OFFSET UNITYSDK_OFFSET(0xC92A980)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_COMMENTNUM_OFFSET UNITYSDK_OFFSET(0xC92A8F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_ISLIKE_OFFSET UNITYSDK_OFFSET(0xC92AA00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_LIKENUM_OFFSET UNITYSDK_OFFSET(0xC92B140)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_NEEDTRANSITION_OFFSET UNITYSDK_OFFSET(0xC92A9C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_SHOWLIKENUM_OFFSET UNITYSDK_OFFSET(0xC92A930)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_BTNLIKECOMMAND_OFFSET UNITYSDK_OFFSET(0xC92B0B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_COMMENTNUM_OFFSET UNITYSDK_OFFSET(0xC92AD20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_ISLIKE_OFFSET UNITYSDK_OFFSET(0xC92ADB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_LIKENUM_OFFSET UNITYSDK_OFFSET(0xC92AC90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_NEEDTRANSITION_OFFSET UNITYSDK_OFFSET(0xC92B180)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC92AE40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC92AAC0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsInteractionViewModel_TypeDefinitionIndex = 75513;
