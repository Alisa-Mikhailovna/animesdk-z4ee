...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC933310)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_ONLIMAONEWSSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0xC933FB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_REFRESHSUBMITNODE_OFFSET UNITYSDK_OFFSET(0xC933EF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_TRYSHOWSUBMITNODEWITHFADEIN_OFFSET UNITYSDK_OFFSET(0xC933C50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC934390)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__GETPAGENUMITEMCONTROL_OFFSET UNITYSDK_OFFSET(0xC9336B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__GETTABITEMCONTROL_OFFSET UNITYSDK_OFFSET(0xC9333F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC9325B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC9321E0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueControl_TypeDefinitionIndex = 75483;
