...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL_GET__ICONPATH_OFFSET UNITYSDK_OFFSET(0xC936CD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL_SETNUMBER_OFFSET UNITYSDK_OFFSET(0xC933970)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC936D80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC936C00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC936B20)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueNumberControl_TypeDefinitionIndex = 75487;
