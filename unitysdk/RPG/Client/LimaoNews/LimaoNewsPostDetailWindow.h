...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC94C670)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDBOTTOMVIEW_OFFSET UNITYSDK_OFFSET(0xC94D1D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDBTNSVIEW_OFFSET UNITYSDK_OFFSET(0xC94D380)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDPOSTBASICVIEW_OFFSET UNITYSDK_OFFSET(0xC94C750)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDRIGHTVIEW_OFFSET UNITYSDK_OFFSET(0xC94CF40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__CLEARREDDOT_OFFSET UNITYSDK_OFFSET(0xC94DE00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0xC94B120)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__MOVETOCOMMENT_OFFSET UNITYSDK_OFFSET(0xC94E6C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC94C470)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0xC94DE60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC94B200)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSCLOSEPOSTDETAIL_OFFSET UNITYSDK_OFFSET(0xC94E8A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSPOSTDETAILOPERATION_OFFSET UNITYSDK_OFFSET(0xC94E760)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSPOSTMESSAGE_OFFSET UNITYSDK_OFFSET(0xC94E050)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSREFRESHUPVOTE_OFFSET UNITYSDK_OFFSET(0xC94EA20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSREPLAYPOST_OFFSET UNITYSDK_OFFSET(0xC94E470)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSSUBMITPOST_OFFSET UNITYSDK_OFFSET(0xC94E0F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONNEWCOMMENTITEM_OFFSET UNITYSDK_OFFSET(0xC94F230)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__SUBSCRIBEMESSAGE_OFFSET UNITYSDK_OFFSET(0xC94C3B0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPostDetailWindow_TypeDefinitionIndex = 75503;

	class LimaoNewsPostDetailWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::UnityEngine::Transform* _NodeBannedMask; // 0x40
		...
		::UnityEngine::UI::Image* _PostImage; // 0x60
		::RPG::Client::AnimatorButton* _BtnClose; // 0x68
		::RPG::Client::AnimatorButton* _BtnImage; // 0x70
		::Class_1_5F4D64A4B97E38F9* _Messenger; // 0x78
		::UnityEngine::Transform* _UserOfficialTag; // 0x80
		::UnityEngine::UI::Text* _UserName; // 0x88
		::RPG::Client::LimaoNews::LimaoNewsStateTagControl* _StateTagControl; // 0x90
		::UnityEngine::UI::Text* _PostDesc; // 0x98
		::UnityEngine::UI::Text* _BtnGoText; // 0xA0
		::RPG::Client::LimaoNews::LimaoNewsInteractionControl* _InteractionControl; // 0xA8
		::UnityEngine::UI::Image* _UserImage; // 0xB0
		::UnityEngine::Transform* _NodeComicMask; // 0xB8
		::UnityEngine::UI::ScrollRect* _RightScrollRect; // 0xC0
		::UnityEngine::Transform* _NodeDivider; // 0xC8
		::RPG::Client::LimaoNews::LimaoNewsLocationControl* _LocationControl; // 0xD0
		::UnityEngine::Transform* _NodeComicLoadRoot; // 0xD8
		::RPG::Client::LimaoNews::LimaoNewsOfficeSurveyTypeControl* _SurveyTypeControl; // 0xE0
		::RPG::Client::StaticListView* _CommentListView; // 0xE8
		::UnityEngine::RectTransform* _NodeDescContent; // 0xF0
		::UnityEngine::Transform* _NodeImage; // 0xF8
		::UnityEngine::Transform* _NodeBottom; // 0x100
		::UnityEngine::Transform* _NodeComic; // 0x108
		::UnityEngine::Transform* _NodeVideoMask; // 0x110
		::UnityEngine::UI::Text* _PostTitle; // 0x118
