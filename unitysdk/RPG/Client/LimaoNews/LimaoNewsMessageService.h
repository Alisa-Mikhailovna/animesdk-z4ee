...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE_ADDPENDINGMESSAGE_OFFSET UNITYSDK_OFFSET(0xC940E90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC940270)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE_GETMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0xC9404E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE_GETSHOWMAINENTRANCEMESSAGE_OFFSET UNITYSDK_OFFSET(0xC940480)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE_HASMAINENTRANCEMESSAGE_OFFSET UNITYSDK_OFFSET(0xC940300)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE_REFRESHPENDINGMESSAGES_OFFSET UNITYSDK_OFFSET(0xC940A50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE_REMOVEPENDINGMESSAGE_OFFSET UNITYSDK_OFFSET(0xC940F10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE_SENDFINISHMESSAGE_OFFSET UNITYSDK_OFFSET(0xC940F70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE__BUILDMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0xC9405A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xC940260)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESERVICE__GETSHOWMAINENTRANCEMESSAGEID_OFFSET UNITYSDK_OFFSET(0xC940350)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsMessageService_TypeDefinitionIndex = 75432;
