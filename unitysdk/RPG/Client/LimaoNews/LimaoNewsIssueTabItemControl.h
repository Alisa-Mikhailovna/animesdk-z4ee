...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC939FD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC93A200)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC939AE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC939A20)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueTabItemControl_TypeDefinitionIndex = 75488;
