...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_CREATEITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC93FDB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_CREATEOPTIONSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC93FFA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GETOPTIONMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0xC93FD20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0xC940240)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0xC9401E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xC940200)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0xC940220)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SETMESSAGEID_OFFSET UNITYSDK_OFFSET(0xC940190)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0xC940250)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0xC9401F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xC940210)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0xC940230)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xC93FC80)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsMessageSequence_TypeDefinitionIndex = 75417;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_2023A453A03A22A2*>* _OptionList_k__BackingField; // 0x18
