...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTWITHREPLYCONTROL_SETSHOWLINENODE_OFFSET UNITYSDK_OFFSET(0xC9239E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTWITHREPLYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC926EC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTWITHREPLYCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC9264C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTWITHREPLYCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC9262F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTWITHREPLYCONTROL__ONNEWSUBCOMMENT_OFFSET UNITYSDK_OFFSET(0xC926AC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTWITHREPLYCONTROL__PLAYFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0xC926910)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsCommentWithReplyControl_TypeDefinitionIndex = 75453;
