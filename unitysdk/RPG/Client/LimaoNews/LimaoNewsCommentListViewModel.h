...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC923A70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_GETCANSHOWCOMMENTCOUNT_OFFSET UNITYSDK_OFFSET(0xC924600)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_GET_ALLCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xC9250C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_GET_SHOWCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xC9250E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_REFRESHVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC923BF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SETCOMMENTFADEIN_OFFSET UNITYSDK_OFFSET(0xC924FE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SETCOMMENTTONEXTSTATE_OFFSET UNITYSDK_OFFSET(0xC924340)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SET_ALLCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xC9250D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SET_SHOWCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xC9250F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC923B60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL__FINDCOMMENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC924A00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL__REFRESHSHOWCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xC9243C0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsCommentListViewModel_TypeDefinitionIndex = 75510;

	class LimaoNewsCommentListViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::RPG::Client::LimaoNews::LimaoNewsPostService* _PostService; // 0x20
		::System::Collections::Generic::List_1<::RPG::Client::LimaoNews::LimaoNewsCommentViewModel*>* _AllCommentViewModels_k__BackingField; // 0x28
