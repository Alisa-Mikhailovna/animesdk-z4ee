...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTCONTROL_MOVETOCOMMENT_OFFSET UNITYSDK_OFFSET(0xC9233E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC923A40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC923200)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC9230F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTCONTROL__ONNEWITEM_OFFSET UNITYSDK_OFFSET(0xC923690)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsCommentListControl_TypeDefinitionIndex = 75452;
