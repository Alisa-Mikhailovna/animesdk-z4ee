...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_GET_ISCANSUBMIT_OFFSET UNITYSDK_OFFSET(0xC93A1A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_GET_ISCURTABSELECTED_OFFSET UNITYSDK_OFFSET(0xC936A90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_GET_ONBTNTABCLICK_OFFSET UNITYSDK_OFFSET(0xC93A330)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_GET_TABTITLE_OFFSET UNITYSDK_OFFSET(0xC93A0B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_SET_ONBTNTABCLICK_OFFSET UNITYSDK_OFFSET(0xC93A340)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC93A280)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xC93A400)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueTabViewModel_TypeDefinitionIndex = 75532;
