...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_ADDNEEDPLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xC928D10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_CHANGEPOSTSTATE_OFFSET UNITYSDK_OFFSET(0xC928F20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_CLEARNEW_OFFSET UNITYSDK_OFFSET(0xC929BE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_BTNUPVOTECOMMAND_OFFSET UNITYSDK_OFFSET(0xC952D00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_CANGOTOSURVEY_OFFSET UNITYSDK_OFFSET(0xC94AAB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_CANREPLAY_OFFSET UNITYSDK_OFFSET(0xC94AA00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_CLICKCOMMAND_OFFSET UNITYSDK_OFFSET(0xC952CE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_COMICPREFABPATH_OFFSET UNITYSDK_OFFSET(0xC94EF10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_COMMENTLISTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC952D60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC94F150)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_DISPLAYSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0xC94F1C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_INTERACTIONVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC952D40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_ISCOMIC_OFFSET UNITYSDK_OFFSET(0xC94EEB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_ISSUBMITTED_OFFSET UNITYSDK_OFFSET(0xC92A0A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_ISTUTORIALNODE_OFFSET UNITYSDK_OFFSET(0xC94F830)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_ISVIDEO_OFFSET UNITYSDK_OFFSET(0xC94F010)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_LOCATIONDATA_OFFSET UNITYSDK_OFFSET(0xC952D20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0xC94EF60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_POSTID_OFFSET UNITYSDK_OFFSET(0xC927900)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_PREFABSTATE_OFFSET UNITYSDK_OFFSET(0xC950380)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_REPLYCOMMENTID_OFFSET UNITYSDK_OFFSET(0xC94AA60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xC952DA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_SHOWBANNEDTAG_OFFSET UNITYSDK_OFFSET(0xC94EFB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_SHOWRECOMMENDTAG_OFFSET UNITYSDK_OFFSET(0xC9503F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_STATETAGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC952D80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_SUBMITTEDSORTID_OFFSET UNITYSDK_OFFSET(0xC92A0F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_SUBMITTYPE_OFFSET UNITYSDK_OFFSET(0xC94AB10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xC94F070)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET_USERDATA_OFFSET UNITYSDK_OFFSET(0xC94F0E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GET__TUTORIALNODEID_OFFSET UNITYSDK_OFFSET(0xC953530)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_GOTOSURVEY_OFFSET UNITYSDK_OFFSET(0xC952E60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_HASANIMATIONFLAG_OFFSET UNITYSDK_OFFSET(0xC927FC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_ISCANSUBMIT_OFFSET UNITYSDK_OFFSET(0xC929850)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_ISNEWPOST_OFFSET UNITYSDK_OFFSET(0xC927950)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_OPENFULLSCREENVIDEOORCOMIC_OFFSET UNITYSDK_OFFSET(0xC952EC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_REFRESHINTERACTIONVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC94ED00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_REFRESHVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC929560)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_REPLAYPOST_OFFSET UNITYSDK_OFFSET(0xC952DF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_RESETPLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xC928130)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_SETCOMMENTTONEXTSTATE_OFFSET UNITYSDK_OFFSET(0xC94E840)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_SET_BTNUPVOTECOMMAND_OFFSET UNITYSDK_OFFSET(0xC952D10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_SET_CLICKCOMMAND_OFFSET UNITYSDK_OFFSET(0xC952CF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_SET_COMMENTLISTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC952D70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_SET_INTERACTIONVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC952D50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_SET_LOCATIONDATA_OFFSET UNITYSDK_OFFSET(0xC952D30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_SET_STATETAGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC952D90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_SHOWSUBMITTEDPOSTWINDOW_OFFSET UNITYSDK_OFFSET(0xC94E300)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL_SUBMITPOST_OFFSET UNITYSDK_OFFSET(0xC94AE40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC928900)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xC953590)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTVIEWMODEL___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0xC9537D0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPostViewModel_TypeDefinitionIndex = 75537;

	class LimaoNewsPostViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Sofa::Core::SimpleCommand* _ClickCommand_k__BackingField; // 0x20
		::RPG::Client::LimaoNews::LimaoNewsTutorialService* _TutorialService; // 0x28
		::RPG::Client::LimaoNews::LimaoNewsStateTagViewModel* _StateTagViewModel_k__BackingField; // 0x30
		::Sofa::Core::SimpleCommand* _BtnUpvoteCommand_k__BackingField; // 0x38
		...
		::RPG::Client::LimaoNews::LimaoNewsPostData* _PostData; // 0x50
		...
		::RPG::Client::LimaoNews::LimaoNewsLocationData* _LocationData_k__BackingField; // 0x70
