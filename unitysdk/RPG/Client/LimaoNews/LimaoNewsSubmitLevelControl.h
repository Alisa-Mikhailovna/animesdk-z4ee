...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC959990)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL_PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0xC9597D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC95AA80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC959E80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC9593F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__PLAYFIRECHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0xC959DF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0xC95A720)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETNODELISTVIEW_1_OFFSET UNITYSDK_OFFSET(0xC95A4C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETNODELISTVIEW_OFFSET UNITYSDK_OFFSET(0xC95A6A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETUPREWARDLIMITVIEW_OFFSET UNITYSDK_OFFSET(0xC959C00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC95A270)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsSubmitLevelControl_TypeDefinitionIndex = 75499;
