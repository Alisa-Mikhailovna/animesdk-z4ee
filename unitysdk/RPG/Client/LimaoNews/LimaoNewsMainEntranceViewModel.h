...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_EVENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC93E440)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_ISFIRSTIN_OFFSET UNITYSDK_OFFSET(0xC93E400)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_SCENEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC93E420)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SETISFIRSTIN_OFFSET UNITYSDK_OFFSET(0xC93E3B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_EVENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC93E450)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_ISFIRSTIN_OFFSET UNITYSDK_OFFSET(0xC93E410)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_SCENEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC93E430)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC93E2B0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsMainEntranceViewModel_TypeDefinitionIndex = 75517;

	class LimaoNewsMainEntranceViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::RPG::Client::LimaoNews::LimaoNewsMainEntranceSceneViewModel* _SceneViewModel_k__BackingField; // 0x20
		::RPG::Client::LimaoNews::LimaoNewsMainEntranceEventViewModel* _EventViewModel_k__BackingField; // 0x28
