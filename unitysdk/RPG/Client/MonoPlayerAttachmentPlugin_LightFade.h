...
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD144E0)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_GET_ISTICKABLE_OFFSET UNITYSDK_OFFSET(0xCD14190)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xCD14180)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xCD14350)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_ONALLOC_OFFSET UNITYSDK_OFFSET(0xCD141A0)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_ONRELEASE_OFFSET UNITYSDK_OFFSET(0xCD14250)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_ONTICK_OFFSET UNITYSDK_OFFSET(0xCD143D0)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD14550)
