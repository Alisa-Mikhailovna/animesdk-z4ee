...
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBEA5E10)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_GET_EXTRAEFFECTID_OFFSET UNITYSDK_OFFSET(0xBEA6260)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xBEA6210)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBEA6280)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_GET_PREFABLOADMETAINDEX_OFFSET UNITYSDK_OFFSET(0xBEA63C0)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_GET__EXTRAEFFECTROW_OFFSET UNITYSDK_OFFSET(0xBEA6360)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_REFRESHENTITY_OFFSET UNITYSDK_OFFSET(0xBEA5EB0)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_RESET_OFFSET UNITYSDK_OFFSET(0xBEA6000)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_SET_EXTRAEFFECTID_OFFSET UNITYSDK_OFFSET(0xBEA6270)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_TRYREFRESHCHARACTERCONFIG_OFFSET UNITYSDK_OFFSET(0xBEA6110)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA_TRYREFRESHTEAMLIGHTSUPPORT_OFFSET UNITYSDK_OFFSET(0xBEA6050)
#define RPG_CLIENT_BATTLEVIEWMODESTATUSTAGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBEA5EA0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleViewModeStatusTagData_TypeDefinitionIndex = 68823;
