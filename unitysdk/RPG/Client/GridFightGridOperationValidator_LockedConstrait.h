...
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_LOCKEDCONSTRAIT_VALIDATE_OFFSET UNITYSDK_OFFSET(0xC76B7B0)
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_LOCKEDCONSTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0xC76A990)
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_LOCKEDCONSTRAIT__ISLOCKED_OFFSET UNITYSDK_OFFSET(0xC76B8D0)
