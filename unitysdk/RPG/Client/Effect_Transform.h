...
#define RPG_CLIENT_EFFECT_TRANSFORM_AWAKE_OFFSET UNITYSDK_OFFSET(0xC34EC70)
#define RPG_CLIENT_EFFECT_TRANSFORM_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC34EDD0)
#define RPG_CLIENT_EFFECT_TRANSFORM_FORCEINITAXIS_OFFSET UNITYSDK_OFFSET(0xC34F730)
#define RPG_CLIENT_EFFECT_TRANSFORM_INITIAL_OFFSET UNITYSDK_OFFSET(0xC34ED10)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0xC350440)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_148427E1422FAA45_OFFSET UNITYSDK_OFFSET(0xC351000)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_1DDD10252C795DC3_OFFSET UNITYSDK_OFFSET(0xC34FDE0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_3F9269A3073770D4_OFFSET UNITYSDK_OFFSET(0xC34EE20)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC350100)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC34F430)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_4EEE40ADEE0A6577_OFFSET UNITYSDK_OFFSET(0xC34FAC0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_54757B8B62FBF467_OFFSET UNITYSDK_OFFSET(0xC350D20)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xC34FA10)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xC34FED0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC351050)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xC3501D0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_C12F95298348D268_OFFSET UNITYSDK_OFFSET(0xC350230)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0xC350A20)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC34FA00)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xC34FE60)
#define RPG_CLIENT_EFFECT_TRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC3510F0)
#define RPG_CLIENT_EFFECT_TRANSFORM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC34F510)
#define RPG_CLIENT_EFFECT_TRANSFORM_PAUSE_OFFSET UNITYSDK_OFFSET(0xC34F780)
#define RPG_CLIENT_EFFECT_TRANSFORM_SETCURRENTPOS_OFFSET UNITYSDK_OFFSET(0xC34F640)
#define RPG_CLIENT_EFFECT_TRANSFORM_SETINITIALPOS_OFFSET UNITYSDK_OFFSET(0xC34F5A0)
#define RPG_CLIENT_EFFECT_TRANSFORM_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC34ED90)
#define RPG_CLIENT_EFFECT_TRANSFORM_TICK_OFFSET UNITYSDK_OFFSET(0xC34F7F0)
#define RPG_CLIENT_EFFECT_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xC351180)
