...
#define RPG_CLIENT_FARMBATTLERESULTINFO_ADDBATTLEMULTIPLEDROP_OFFSET UNITYSDK_OFFSET(0xC43EE20)
#define RPG_CLIENT_FARMBATTLERESULTINFO_ADDBATTLERESULT_OFFSET UNITYSDK_OFFSET(0xC43ECE0)
#define RPG_CLIENT_FARMBATTLERESULTINFO_ADDBATTLETIME_OFFSET UNITYSDK_OFFSET(0xC43EDD0)
#define RPG_CLIENT_FARMBATTLERESULTINFO_GET_DECOMPOSEINFO_OFFSET UNITYSDK_OFFSET(0xC43F0C0)
#define RPG_CLIENT_FARMBATTLERESULTINFO_GET_LASTBATTLEMULTIPLEDROPUSEDDATALIST_OFFSET UNITYSDK_OFFSET(0xC43F0F0)
#define RPG_CLIENT_FARMBATTLERESULTINFO_GET_LASTBATTLETIME_OFFSET UNITYSDK_OFFSET(0xC43F0D0)
#define RPG_CLIENT_FARMBATTLERESULTINFO_GET_REWARDITEMS_OFFSET UNITYSDK_OFFSET(0xC43F0B0)
#define RPG_CLIENT_FARMBATTLERESULTINFO_SET_LASTBATTLETIME_OFFSET UNITYSDK_OFFSET(0xC43F0E0)
#define RPG_CLIENT_FARMBATTLERESULTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC43F100)
