...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_STATECONNECTION_GET_NEXTSTATENAME_OFFSET UNITYSDK_OFFSET(0xD545E50)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_STATECONNECTION_METHOD_1_A9E21AEFB7D4CB48_OFFSET UNITYSDK_OFFSET(0xD545B60)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_STATECONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD545E40)
