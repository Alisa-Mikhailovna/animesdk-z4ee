...
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xBF18460)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_GET_EMOJIID_OFFSET UNITYSDK_OFFSET(0xBF184C0)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBF185E0)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_GET_ISPLAYERUSE_OFFSET UNITYSDK_OFFSET(0xBF184D0)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xBF18580)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xBF184B0)
