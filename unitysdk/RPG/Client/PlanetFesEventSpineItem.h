...
#define RPG_CLIENT_PLANETFESEVENTSPINEITEM_ISFADEANIMPLAYING_OFFSET UNITYSDK_OFFSET(0xD007ED0)
#define RPG_CLIENT_PLANETFESEVENTSPINEITEM_SHOWFADEIN_OFFSET UNITYSDK_OFFSET(0xD0081A0)
#define RPG_CLIENT_PLANETFESEVENTSPINEITEM_SHOWFADEOUT_OFFSET UNITYSDK_OFFSET(0xD008580)
#define RPG_CLIENT_PLANETFESEVENTSPINEITEM_SHOWRANDOMSPINEANIM_OFFSET UNITYSDK_OFFSET(0xD007B80)
#define RPG_CLIENT_PLANETFESEVENTSPINEITEM_SHOWSPINEANIM_OFFSET UNITYSDK_OFFSET(0xD007E30)
#define RPG_CLIENT_PLANETFESEVENTSPINEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD0087D0)
#define RPG_CLIENT_PLANETFESEVENTSPINEITEM__ISTIMELINEPLAYING_OFFSET UNITYSDK_OFFSET(0xD008100)
#define RPG_CLIENT_PLANETFESEVENTSPINEITEM__STOPALLTIMELINE_OFFSET UNITYSDK_OFFSET(0xD0084A0)
