...
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_GET_OVERRIDECONSTRAINT_OFFSET UNITYSDK_OFFSET(0xCA210E0)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_RPG_CLIENT_ILOOKATCONSTRAINT_GET_PITCHDOWN_OFFSET UNITYSDK_OFFSET(0xCA21160)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_RPG_CLIENT_ILOOKATCONSTRAINT_GET_PITCHUP_OFFSET UNITYSDK_OFFSET(0xCA21100)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_RPG_CLIENT_ILOOKATCONSTRAINT_GET_YAWLEFT_OFFSET UNITYSDK_OFFSET(0xCA211C0)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_RPG_CLIENT_ILOOKATCONSTRAINT_GET_YAWRIGHT_OFFSET UNITYSDK_OFFSET(0xCA21220)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_SET_OVERRIDECONSTRAINT_OFFSET UNITYSDK_OFFSET(0xCA210F0)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA16B30)
