...
#define RPG_CLIENT_ASSEMNPC_METHOD_1_92D59DB27A2254BC_OFFSET UNITYSDK_OFFSET(0xBDA5B70)
#define RPG_CLIENT_ASSEMNPC_METHOD_1_9656213C005E9904_OFFSET UNITYSDK_OFFSET(0xBDA5800)
#define RPG_CLIENT_ASSEMNPC_METHOD_1_ABD5B53377E7C191_OFFSET UNITYSDK_OFFSET(0xBDA59D0)
#define RPG_CLIENT_ASSEMNPC_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xBDA5D60)
#define RPG_CLIENT_ASSEMNPC_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xBDA5D20)
#define RPG_CLIENT_ASSEMNPC_TOSTRING_OFFSET UNITYSDK_OFFSET(0xBDA5C50)
#define RPG_CLIENT_ASSEMNPC__CTOR_OFFSET UNITYSDK_OFFSET(0xBDA5C10)
