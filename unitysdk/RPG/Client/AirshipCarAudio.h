...
#define RPG_CLIENT_AIRSHIPCARAUDIO_GET_DISTANCETOPLAYER_OFFSET UNITYSDK_OFFSET(0xBD0AF30)
#define RPG_CLIENT_AIRSHIPCARAUDIO_GET_DISTANCETOTANGENT_OFFSET UNITYSDK_OFFSET(0xBD0AF70)
#define RPG_CLIENT_AIRSHIPCARAUDIO_GET_ENABLELISTENER_OFFSET UNITYSDK_OFFSET(0xBD0AF90)
#define RPG_CLIENT_AIRSHIPCARAUDIO_GET_SPEED_OFFSET UNITYSDK_OFFSET(0xBD0AF50)
#define RPG_CLIENT_AIRSHIPCARAUDIO_INIT_OFFSET UNITYSDK_OFFSET(0xBD0B000)
#define RPG_CLIENT_AIRSHIPCARAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBD0B270)
#define RPG_CLIENT_AIRSHIPCARAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0xBD0AFA0)
#define RPG_CLIENT_AIRSHIPCARAUDIO_SET_DISTANCETOPLAYER_OFFSET UNITYSDK_OFFSET(0xBD0AF40)
#define RPG_CLIENT_AIRSHIPCARAUDIO_SET_DISTANCETOTANGENT_OFFSET UNITYSDK_OFFSET(0xBD0AF80)
#define RPG_CLIENT_AIRSHIPCARAUDIO_SET_SPEED_OFFSET UNITYSDK_OFFSET(0xBD0AF60)
#define RPG_CLIENT_AIRSHIPCARAUDIO_TICK_OFFSET UNITYSDK_OFFSET(0xBD0B480)
#define RPG_CLIENT_AIRSHIPCARAUDIO_TRIGGERAVOID_OFFSET UNITYSDK_OFFSET(0xBD0B7F0)
#define RPG_CLIENT_AIRSHIPCARAUDIO_TRIGGERSHUTDOWN_OFFSET UNITYSDK_OFFSET(0xBD0BA10)
#define RPG_CLIENT_AIRSHIPCARAUDIO_TRIGGERSTARTUP_OFFSET UNITYSDK_OFFSET(0xBD0B900)
#define RPG_CLIENT_AIRSHIPCARAUDIO_UNINIT_OFFSET UNITYSDK_OFFSET(0xBD0B370)
#define RPG_CLIENT_AIRSHIPCARAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xBD0BB20)
