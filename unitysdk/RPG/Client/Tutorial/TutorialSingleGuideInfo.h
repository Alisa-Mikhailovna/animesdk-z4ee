...
#define RPG_CLIENT_TUTORIAL_TUTORIALSINGLEGUIDEINFO_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0xD75BEB0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSINGLEGUIDEINFO_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xD75BEA0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSINGLEGUIDEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD75A500)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialSingleGuideInfo_TypeDefinitionIndex = 75034;
