...
#define RPG_CLIENT_UIDRAGGABLE_ADDOBSTACLE_OFFSET UNITYSDK_OFFSET(0xD7B8450)
#define RPG_CLIENT_UIDRAGGABLE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD7B78C0)
#define RPG_CLIENT_UIDRAGGABLE_CLEAROBSTACLE_OFFSET UNITYSDK_OFFSET(0xD7B8540)
#define RPG_CLIENT_UIDRAGGABLE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xD7B7980)
#define RPG_CLIENT_UIDRAGGABLE_ONDRAG_OFFSET UNITYSDK_OFFSET(0xD7B7CB0)
#define RPG_CLIENT_UIDRAGGABLE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xD7B8120)
#define RPG_CLIENT_UIDRAGGABLE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xD7B81B0)
#define RPG_CLIENT_UIDRAGGABLE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xD7B8240)
#define RPG_CLIENT_UIDRAGGABLE_SETBEGINDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7B82D0)
#define RPG_CLIENT_UIDRAGGABLE_SETENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7B8330)
#define RPG_CLIENT_UIDRAGGABLE_SETPOINTERDOWNCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7B8390)
#define RPG_CLIENT_UIDRAGGABLE_SETPOINTERUPCALLBACK_OFFSET UNITYSDK_OFFSET(0xD7B83F0)
#define RPG_CLIENT_UIDRAGGABLE_SIMULATEDRAG_OFFSET UNITYSDK_OFFSET(0xD7B85B0)
#define RPG_CLIENT_UIDRAGGABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xD7B8B00)
#define RPG_CLIENT_UIDRAGGABLE__ISINOBSTACLERECTS_OFFSET UNITYSDK_OFFSET(0xD7B88B0)
#define RPG_CLIENT_UIDRAGGABLE__TRYSETPOSITION_OFFSET UNITYSDK_OFFSET(0xD7B7F00)
#define RPG_CLIENT_UIDRAGGABLE__UPDATELIMITATION_OFFSET UNITYSDK_OFFSET(0xD7B7C00)
