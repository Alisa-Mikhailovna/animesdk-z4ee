...
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYADVPLAYERID_OFFSET UNITYSDK_OFFSET(0xBE0F4F0)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYAVATARID_OFFSET UNITYSDK_OFFSET(0xBE0EEE0)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYAVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0xBE0EE60)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYAVATARSKINDATA_OFFSET UNITYSDK_OFFSET(0xBE0F380)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYAVATARSKINID_OFFSET UNITYSDK_OFFSET(0xBE0EF90)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYDISPLAYINFO_OFFSET UNITYSDK_OFFSET(0xBE0F280)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYSPECIALAVATARID_OFFSET UNITYSDK_OFFSET(0xBE0F2F0)
