...
#define RPG_CLIENT_MONOABOVESWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0xCC2F380)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAboveSwitch_TypeDefinitionIndex = 69755;
