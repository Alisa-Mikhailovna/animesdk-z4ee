...
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_CREATE_OFFSET UNITYSDK_OFFSET(0xD085AB0)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_GETDESC_OFFSET UNITYSDK_OFFSET(0xD086190)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_GETTITLE_OFFSET UNITYSDK_OFFSET(0xD086100)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_GET_NOMINATETYPE_OFFSET UNITYSDK_OFFSET(0xD086A90)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_ISSATISFY_OFFSET UNITYSDK_OFFSET(0xD085B40)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_SET_NOMINATETYPE_OFFSET UNITYSDK_OFFSET(0xD086AA0)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0860F0)
