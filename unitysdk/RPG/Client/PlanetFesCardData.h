...
#define RPG_CLIENT_PLANETFESCARDDATA_CHECKISFINISH_OFFSET UNITYSDK_OFFSET(0xD005740)
#define RPG_CLIENT_PLANETFESCARDDATA_CHECKISPIECELISTCANUNLOCKCARD_OFFSET UNITYSDK_OFFSET(0xD005590)
#define RPG_CLIENT_PLANETFESCARDDATA_GETCARDITEMNUM_OFFSET UNITYSDK_OFFSET(0xD005900)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_BUFFIDLIST_OFFSET UNITYSDK_OFFSET(0xD005F70)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_CARDID_OFFSET UNITYSDK_OFFSET(0xD005E80)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_CARDPIECECOLLECTNUM_OFFSET UNITYSDK_OFFSET(0xD005C70)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_CARDPIECENUMDICT_OFFSET UNITYSDK_OFFSET(0xD005B90)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_CARDPIECENUM_OFFSET UNITYSDK_OFFSET(0xD005BE0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xD006030)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xD005ED0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_IMGPATH_OFFSET UNITYSDK_OFFSET(0xD005F20)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xD005B40)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_ITEMLIST_OFFSET UNITYSDK_OFFSET(0xD0056F0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD005FC0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xD0060A0)
#define RPG_CLIENT_PLANETFESCARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD005550)
#define RPG_CLIENT_PLANETFESCARDDATA__GETCARDITEMCOLLECTNUM_OFFSET UNITYSDK_OFFSET(0xD005CC0)
