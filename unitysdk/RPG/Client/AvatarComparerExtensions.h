...
#define RPG_CLIENT_AVATARCOMPAREREXTENSIONS_SETLEVELRARITYISDESCENDING_OFFSET UNITYSDK_OFFSET(0xBDD8BB0)
#define RPG_CLIENT_AVATARCOMPAREREXTENSIONS_SETLEVELRARITYISLEVELFIRST_OFFSET UNITYSDK_OFFSET(0xBDD8AF0)
#define RPG_CLIENT_AVATARCOMPAREREXTENSIONS_SETPINNING_OFFSET UNITYSDK_OFFSET(0xBDD8A30)
