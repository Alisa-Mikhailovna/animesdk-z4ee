...
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCCFEF20)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCCFF820)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_DISABLEPRESSHINTIMAGE_OFFSET UNITYSDK_OFFSET(0xCCF2710)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCD00000)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_ENABLEPRESSHINTIMAGE_OFFSET UNITYSDK_OFFSET(0xCCF26B0)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_GET_ISDRAG_OFFSET UNITYSDK_OFFSET(0xCD00580)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_GET_PRESSHINTIMAGE_OFFSET UNITYSDK_OFFSET(0xCCF2660)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_GET_PRESSHINTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCCF2610)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_GET__ISSTICKDOINPUTCTRL_OFFSET UNITYSDK_OFFSET(0xCD005A0)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0xCCFF980)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCCFF930)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCCFF710)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xCCFFD00)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xCCFFB90)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xCCFFCB0)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_SET_ISDRAG_OFFSET UNITYSDK_OFFSET(0xCD00590)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_SET__ISSTICKDOINPUTCTRL_OFFSET UNITYSDK_OFFSET(0xCD005B0)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCCFF7D0)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_TICK_OFFSET UNITYSDK_OFFSET(0xCCFFD50)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xCD00040)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD005F0)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__COMPUTEDRAGINFO_OFFSET UNITYSDK_OFFSET(0xCD00220)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xCCF2800)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__INIT_OFFSET UNITYSDK_OFFSET(0xCCFEF70)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__ONADVENTUREPHASEENTERED_OFFSET UNITYSDK_OFFSET(0xCD00100)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__ONPOINTERUPCALLBACK_OFFSET UNITYSDK_OFFSET(0xCCFF9E0)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__REMOVENOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xCCFF870)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__TRIGGERSTICKEVENT_OFFSET UNITYSDK_OFFSET(0xCCFFBE0)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__UPDATEPRESSDRAGHINTVIEW_OFFSET UNITYSDK_OFFSET(0xCD004D0)
#define RPG_CLIENT_MONOJOYSTICKPROVIDER__UPDATEPRESSDRAGHINT_OFFSET UNITYSDK_OFFSET(0xCD003C0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoJoyStickProvider_TypeDefinitionIndex)->GetStaticField(0x10730);
		}
