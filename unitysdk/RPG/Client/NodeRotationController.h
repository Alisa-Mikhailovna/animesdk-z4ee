...
#define RPG_CLIENT_NODEROTATIONCONTROLLER_ENDCALCROTATION_OFFSET UNITYSDK_OFFSET(0xCED8860)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_GET_ADDOBJ_OFFSET UNITYSDK_OFFSET(0xCED82F0)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_METHOD_5_41081A5E55D64FFA_OFFSET UNITYSDK_OFFSET(0xCED8410)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_METHOD_5_5C45B76158F16B95_OFFSET UNITYSDK_OFFSET(0xCED83B0)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_SET_ADDOBJ_OFFSET UNITYSDK_OFFSET(0xCED8300)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_STARTCALCROTATION_OFFSET UNITYSDK_OFFSET(0xCED8760)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xCED84F0)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCED8540)
#define RPG_CLIENT_NODEROTATIONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCED88B0)
