...
#define RPG_CLIENT_CROWDANIMATOR_CROWDVARIANT__CTOR_OFFSET UNITYSDK_OFFSET(0xC1C59C0)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int CrowdVariant_TypeDefinitionIndex = 70334;
