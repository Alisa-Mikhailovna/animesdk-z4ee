...
#define RPG_CLIENT_CROWDANIMATOR_CROWDPROTOTYPE_GET_ISBAKEREQUIRED_OFFSET UNITYSDK_OFFSET(0xC1BCB60)
#define RPG_CLIENT_CROWDANIMATOR_CROWDPROTOTYPE_METHOD_3_3FA8F4962E04AA53_OFFSET UNITYSDK_OFFSET(0xC1BCCF0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDPROTOTYPE_METHOD_3_9679BF1F01124F44_OFFSET UNITYSDK_OFFSET(0xC1BCBC0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDPROTOTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xC1BCE00)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int CrowdPrototype_TypeDefinitionIndex = 70312;
