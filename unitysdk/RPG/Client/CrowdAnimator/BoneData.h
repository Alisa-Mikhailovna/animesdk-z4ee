...
#define RPG_CLIENT_CROWDANIMATOR_BONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC1BA7D0)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int BoneData_TypeDefinitionIndex = 70325;
