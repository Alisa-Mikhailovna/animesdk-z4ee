...
#define RPG_CLIENT_ELFRESTAURANTWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC3BFB50)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfRestaurantWhiteBoxData_TypeDefinitionIndex = 69442;
