...
#define RPG_CLIENT_LOOKATSOLVER_CLEAR_OFFSET UNITYSDK_OFFSET(0xCA174D0)
#define RPG_CLIENT_LOOKATSOLVER_GET_HEADIKROTATION_OFFSET UNITYSDK_OFFSET(0xCA20B50)
#define RPG_CLIENT_LOOKATSOLVER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xCA18560)
#define RPG_CLIENT_LOOKATSOLVER_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xCA20B70)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_176EDC9D2FA71031_OFFSET UNITYSDK_OFFSET(0xCA20200)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_218124418542E081_OFFSET UNITYSDK_OFFSET(0xCA1FA80)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_3BB91AA8A66C2378_OFFSET UNITYSDK_OFFSET(0xCA1AC10)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_486E5C360891CE3D_OFFSET UNITYSDK_OFFSET(0xCA20BB0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6409EF8034A68A6B_OFFSET UNITYSDK_OFFSET(0xCA1C150)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_834133B9DC560EF2_OFFSET UNITYSDK_OFFSET(0xCA1E5A0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0xCA21000)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_A116C8ED96BD8D99_OFFSET UNITYSDK_OFFSET(0xCA205E0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_B45333C63548FF10_OFFSET UNITYSDK_OFFSET(0xCA1E1F0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_C69123962DC01A7E_OFFSET UNITYSDK_OFFSET(0xCA1FCA0)
#define RPG_CLIENT_LOOKATSOLVER_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xCA20B90)
#define RPG_CLIENT_LOOKATSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA1F4C0)
