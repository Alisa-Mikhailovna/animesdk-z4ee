...
#define RPG_CLIENT_MESSAGECONTENTGOTOBLOCK_GAMETOOLGOTOCOMMAND_EXECUTE_OFFSET UNITYSDK_OFFSET(0xCBA8F50)
#define RPG_CLIENT_MESSAGECONTENTGOTOBLOCK_GAMETOOLGOTOCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0xCBA8A60)
#define RPG_CLIENT_MESSAGECONTENTGOTOBLOCK_GAMETOOLGOTOCOMMAND__ISAVATARRELEASED_OFFSET UNITYSDK_OFFSET(0xCBA9220)
