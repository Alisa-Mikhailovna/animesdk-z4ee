...
#define RPG_CLIENT_DATETIMEPRO_ADDDAYS_OFFSET UNITYSDK_OFFSET(0x3A0B990)
#define RPG_CLIENT_DATETIMEPRO_ADDHOURS_OFFSET UNITYSDK_OFFSET(0x3A0BA30)
#define RPG_CLIENT_DATETIMEPRO_ADDMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x3A0BC10)
#define RPG_CLIENT_DATETIMEPRO_ADDMINUTES_OFFSET UNITYSDK_OFFSET(0x3A0BAD0)
#define RPG_CLIENT_DATETIMEPRO_ADDMONTHSINBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x3A0BD90)
#define RPG_CLIENT_DATETIMEPRO_ADDMONTHSINSERVERTIME_OFFSET UNITYSDK_OFFSET(0x3A0BCB0)
#define RPG_CLIENT_DATETIMEPRO_ADDMONTHSINUTCTIME_OFFSET UNITYSDK_OFFSET(0x3A0BD00)
#define RPG_CLIENT_DATETIMEPRO_ADDSECONDS_OFFSET UNITYSDK_OFFSET(0x3A0BB70)
#define RPG_CLIENT_DATETIMEPRO_ADDTICKS_OFFSET UNITYSDK_OFFSET(0x3A0B8A0)
#define RPG_CLIENT_DATETIMEPRO_ADD_OFFSET UNITYSDK_OFFSET(0x3A0B8A0)
#define RPG_CLIENT_DATETIMEPRO_COMPARETO_OFFSET UNITYSDK_OFFSET(0x39D7890)
#define RPG_CLIENT_DATETIMEPRO_COMPARE_OFFSET UNITYSDK_OFFSET(0x1C8EA1E0)
#define RPG_CLIENT_DATETIMEPRO_CREATEBYBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x1C8E93D0)
#define RPG_CLIENT_DATETIMEPRO_CREATEBYSERVERTIME_OFFSET UNITYSDK_OFFSET(0x1C8E9320)
#define RPG_CLIENT_DATETIMEPRO_CREATEBYTIMESTAMPMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1C8E8D70)
#define RPG_CLIENT_DATETIMEPRO_CREATEBYTIMESTAMPSECONDS_OFFSET UNITYSDK_OFFSET(0x1C8E8B80)
#define RPG_CLIENT_DATETIMEPRO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x39D78F0)
#define RPG_CLIENT_DATETIMEPRO_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x3A0BE60)
#define RPG_CLIENT_DATETIMEPRO_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C8EA240)
#define RPG_CLIENT_DATETIMEPRO_GETBEIJINGLITERALDATE_OFFSET UNITYSDK_OFFSET(0x3A0B550)
#define RPG_CLIENT_DATETIMEPRO_GETBEIJINGSTARTOFDAY_OFFSET UNITYSDK_OFFSET(0x3A0B6C0)
#define RPG_CLIENT_DATETIMEPRO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x39D7BA0)
#define RPG_CLIENT_DATETIMEPRO_GETLOCALLITERALDATE_OFFSET UNITYSDK_OFFSET(0x3A0B4C0)
#define RPG_CLIENT_DATETIMEPRO_GETSERVERLITERALDATE_OFFSET UNITYSDK_OFFSET(0x3A0B520)
#define RPG_CLIENT_DATETIMEPRO_GETSERVERSTARTOFDAY_OFFSET UNITYSDK_OFFSET(0x3A0B650)
#define RPG_CLIENT_DATETIMEPRO_GETSERVERSTARTOFHOUR_OFFSET UNITYSDK_OFFSET(0x3A0B7A0)
#define RPG_CLIENT_DATETIMEPRO_GETSERVERSTARTOFMONTH_OFFSET UNITYSDK_OFFSET(0x3A0B890)
#define RPG_CLIENT_DATETIMEPRO_GETTIMESTAMPMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x3A0B460)
#define RPG_CLIENT_DATETIMEPRO_GETTIMESTAMPSECONDS_OFFSET UNITYSDK_OFFSET(0x3A0B3F0)
#define RPG_CLIENT_DATETIMEPRO_GETUTCLITERALDATE_OFFSET UNITYSDK_OFFSET(0x3A0B4F0)
#define RPG_CLIENT_DATETIMEPRO_GETUTCSTARTOFDAY_OFFSET UNITYSDK_OFFSET(0x3A0B580)
#define RPG_CLIENT_DATETIMEPRO_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x1C8EAF90)
#define RPG_CLIENT_DATETIMEPRO_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x1C8EB020)
#define RPG_CLIENT_DATETIMEPRO_GET__BEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x3A0C0C0)
#define RPG_CLIENT_DATETIMEPRO_GET__LOCALTIME_OFFSET UNITYSDK_OFFSET(0x3A0C0B0)
#define RPG_CLIENT_DATETIMEPRO_GET__SERVERTIME_OFFSET UNITYSDK_OFFSET(0x3A0BFF0)
#define RPG_CLIENT_DATETIMEPRO_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1C8EA350)
#define RPG_CLIENT_DATETIMEPRO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C8EA2B0)
#define RPG_CLIENT_DATETIMEPRO_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1C8EA330)
#define RPG_CLIENT_DATETIMEPRO_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1C8EA2F0)
#define RPG_CLIENT_DATETIMEPRO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C8EA2C0)
#define RPG_CLIENT_DATETIMEPRO_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1C8EA310)
#define RPG_CLIENT_DATETIMEPRO_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1C8EA2D0)
#define RPG_CLIENT_DATETIMEPRO_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0x1C8EA5D0)
#define RPG_CLIENT_DATETIMEPRO_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1C8EA4B0)
#define RPG_CLIENT_DATETIMEPRO_PARSEBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x1C8E9140)
#define RPG_CLIENT_DATETIMEPRO_PARSESERVERTIME_OFFSET UNITYSDK_OFFSET(0x1C8E8F60)
#define RPG_CLIENT_DATETIMEPRO_SUBTRACT_1_OFFSET UNITYSDK_OFFSET(0x3A0BE90)
#define RPG_CLIENT_DATETIMEPRO_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x39D7F60)
#define RPG_CLIENT_DATETIMEPRO_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3A0BFC0)
#define RPG_CLIENT_DATETIMEPRO_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x3A0BFD0)
#define RPG_CLIENT_DATETIMEPRO_TOSTRING_3_OFFSET UNITYSDK_OFFSET(0x3A0BFE0)
#define RPG_CLIENT_DATETIMEPRO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A0BFB0)
#define RPG_CLIENT_DATETIMEPRO_TRYPARSEBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x1C8E9180)
#define RPG_CLIENT_DATETIMEPRO_TRYPARSESERVERTIME_OFFSET UNITYSDK_OFFSET(0x1C8E8FA0)
#define RPG_CLIENT_DATETIMEPRO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C8EB0B0)
#define RPG_CLIENT_DATETIMEPRO__CREATEBYBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x1C8EAE40)
#define RPG_CLIENT_DATETIMEPRO__CREATEBYLOCALTIME_OFFSET UNITYSDK_OFFSET(0x1C8EAD30)
#define RPG_CLIENT_DATETIMEPRO__CREATEBYSERVERTIME_OFFSET UNITYSDK_OFFSET(0x1C8EAC50)
#define RPG_CLIENT_DATETIMEPRO__CREATEBYUTCTIME_OFFSET UNITYSDK_OFFSET(0x1C8EA440)
