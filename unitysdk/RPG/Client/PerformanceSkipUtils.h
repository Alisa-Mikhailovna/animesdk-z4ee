...
#define RPG_CLIENT_PERFORMANCESKIPUTILS_REPORTPERFORMANCESKIPDIALOG_OFFSET UNITYSDK_OFFSET(0xCF5D880)
#define RPG_CLIENT_PERFORMANCESKIPUTILS_SHOWOLDPERFORMANCESKIPDIALOG_OFFSET UNITYSDK_OFFSET(0xCF5CF30)
#define RPG_CLIENT_PERFORMANCESKIPUTILS_SHOWPERFORMANCESKIPDIALOG_OFFSET UNITYSDK_OFFSET(0xCF5C8E0)
#define RPG_CLIENT_PERFORMANCESKIPUTILS__CHECKOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xCF5D340)
#define RPG_CLIENT_PERFORMANCESKIPUTILS__GETACTORICONPATHLIST_OFFSET UNITYSDK_OFFSET(0xCF5D490)
#define RPG_CLIENT_PERFORMANCESKIPUTILS__ISCONTENTEXIST_OFFSET UNITYSDK_OFFSET(0xCF5D420)
