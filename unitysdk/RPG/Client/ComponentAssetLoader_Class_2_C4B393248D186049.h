...
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_C4B393248D186049_METHOD_2_3CD6E3B4A8AD91EF_OFFSET UNITYSDK_OFFSET(0xC1A2930)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_C4B393248D186049_METHOD_2_4BB7541873A6CE6B_OFFSET UNITYSDK_OFFSET(0xC1A2A90)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_C4B393248D186049_METHOD_2_4C1D0D51A45DF889_OFFSET UNITYSDK_OFFSET(0xC1A2830)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_C4B393248D186049_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC1A2B30)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_C4B393248D186049_METHOD_2_FCCA0C94BB179B19_OFFSET UNITYSDK_OFFSET(0xC1A1F90)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_C4B393248D186049__CTOR_OFFSET UNITYSDK_OFFSET(0xC1A2B40)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ComponentAssetLoader_Class_2_C4B393248D186049_TypeDefinitionIndex)->GetStaticField(0x63D50);
		}
