...
#define RPG_CLIENT_SMALLWINDOWVCCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0xD51CCB0)
#define RPG_CLIENT_SMALLWINDOWVCCONTROL_CREATEBEHAVIOR_OFFSET UNITYSDK_OFFSET(0xD51D020)
#define RPG_CLIENT_SMALLWINDOWVCCONTROL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD51D140)
#define RPG_CLIENT_SMALLWINDOWVCCONTROL_METHOD_5_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xD51CD00)
#define RPG_CLIENT_SMALLWINDOWVCCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD51CF60)
#define RPG_CLIENT_SMALLWINDOWVCCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD51CE40)
#define RPG_CLIENT_SMALLWINDOWVCCONTROL_REFRESH_OFFSET UNITYSDK_OFFSET(0xD51D070)
#define RPG_CLIENT_SMALLWINDOWVCCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xD51CE90)
#define RPG_CLIENT_SMALLWINDOWVCCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xD51D200)
