...
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0xBB05CE0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_BATTLEEVENTSKILLDESCSIMPLE_OFFSET UNITYSDK_OFFSET(0xBB06000)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_BATTLEEVENTSKILLDESC_OFFSET UNITYSDK_OFFSET(0xBB05F90)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_BATTLEEVENTSKILLPARAMLIST_OFFSET UNITYSDK_OFFSET(0xBB06070)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ENERGYCOLLECTIONDESCSIMPLE_OFFSET UNITYSDK_OFFSET(0xBB05ED0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ENERGYCOLLECTIONDESC_OFFSET UNITYSDK_OFFSET(0xBB05E60)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ENERGYCOLLECTIONPARAMLIST_OFFSET UNITYSDK_OFFSET(0xBB05F40)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_GIFTIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBB05E10)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_GIFTNAME_OFFSET UNITYSDK_OFFSET(0xBB05DA0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBB05D00)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_MODIFIEDSKILLDESCSIMPLE_OFFSET UNITYSDK_OFFSET(0xBB06130)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_MODIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0xBB060C0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_MODIFIEDSKILLPARAMLIST_OFFSET UNITYSDK_OFFSET(0xBB061A0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_SPECIALAVATARID_OFFSET UNITYSDK_OFFSET(0xBB05D50)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_TAG_OFFSET UNITYSDK_OFFSET(0xBB061F0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_SET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0xBB05CF0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB06260)
