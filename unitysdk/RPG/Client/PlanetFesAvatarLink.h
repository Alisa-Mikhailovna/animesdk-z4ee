...
#define RPG_CLIENT_PLANETFESAVATARLINK_GETSORTAVATAR_OFFSET UNITYSDK_OFFSET(0xCFFA1E0)
#define RPG_CLIENT_PLANETFESAVATARLINK_GETWORKINGLINKAVATARIDS_OFFSET UNITYSDK_OFFSET(0xCFF9CA0)
#define RPG_CLIENT_PLANETFESAVATARLINK_HASAVATARWORKING_OFFSET UNITYSDK_OFFSET(0xCFF9BF0)
#define RPG_CLIENT_PLANETFESAVATARLINK_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xCFFA4E0)
#define RPG_CLIENT_PLANETFESAVATARLINK__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFA670)
#define RPG_CLIENT_PLANETFESAVATARLINK__ISWORKING_OFFSET UNITYSDK_OFFSET(0xCFFA050)
