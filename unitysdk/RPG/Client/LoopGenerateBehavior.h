...
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET_CURRENTCONFIGINDEX_OFFSET UNITYSDK_OFFSET(0xCA21B20)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET_PREVIEWMODE_OFFSET UNITYSDK_OFFSET(0xCA218D0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET__CURRENTCONFIG_OFFSET UNITYSDK_OFFSET(0xCA218F0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET__CURRENTSPEED_OFFSET UNITYSDK_OFFSET(0xCA21AA0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET__ISFORWARD_OFFSET UNITYSDK_OFFSET(0xCA21B30)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xCA21A20)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_07470E244E8D2DC0_OFFSET UNITYSDK_OFFSET(0xCA23490)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_0DE0877707CBEC83_OFFSET UNITYSDK_OFFSET(0xCA23C90)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_14CC93EEBE7DC8CE_OFFSET UNITYSDK_OFFSET(0xCA22A70)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xCA22620)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xCA24300)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xCA228C0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xCA21BA0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xCA22800)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xCA22860)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xCA22900)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xCA22960)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCA22190)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4C288C0C3DC7B4CA_OFFSET UNITYSDK_OFFSET(0xCA22200)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_7014E71C60BDE051_OFFSET UNITYSDK_OFFSET(0xCA23B30)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xCA21FE0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_9CA35E5BF1A50E77_OFFSET UNITYSDK_OFFSET(0xCA23A50)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xCA21F70)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_B3A3DFDFFD8F3DB1_OFFSET UNITYSDK_OFFSET(0xCA23220)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_CA604B8DCE366A4E_OFFSET UNITYSDK_OFFSET(0xCA23F00)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_SET_PREVIEWMODE_OFFSET UNITYSDK_OFFSET(0xCA218E0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xCA229C0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xCA24400)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCA24360)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LoopGenerateBehavior_TypeDefinitionIndex)->GetStaticField(0xADC0);
		}
