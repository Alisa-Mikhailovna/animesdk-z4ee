...
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_CLEARSERVERSTATE_OFFSET UNITYSDK_OFFSET(0xD5F1460)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD5F13F0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_CONDITIONDESC_OFFSET UNITYSDK_OFFSET(0xD5F1C20)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_CONDITIONID_OFFSET UNITYSDK_OFFSET(0xD5F1570)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0xD5F1D00)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EFFECTIDARR_OFFSET UNITYSDK_OFFSET(0xD5F0BA0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EXAMID_OFFSET UNITYSDK_OFFSET(0xD5F1730)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISENDING_OFFSET UNITYSDK_OFFSET(0xD5F1FC0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xD5F1610)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISSTORY_OFFSET UNITYSDK_OFFSET(0xD5F1F60)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xD5F14F0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_MISSIONID_OFFSET UNITYSDK_OFFSET(0xD5F1870)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_PARTNERID_OFFSET UNITYSDK_OFFSET(0xD5F1EC0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_PERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xD5F17D0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_REPEATPERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xD5F1910)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYDESC_OFFSET UNITYSDK_OFFSET(0xD5F1B40)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYHINT_OFFSET UNITYSDK_OFFSET(0xD5F1DE0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYIMAGE_OFFSET UNITYSDK_OFFSET(0xD5F19B0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0xD5F1A60)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYTYPE_OFFSET UNITYSDK_OFFSET(0xD5F1630)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xD5F16D0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_SETSTORYFINISH_OFFSET UNITYSDK_OFFSET(0xD5F14A0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_SET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xD5F1620)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD5F1450)
