...
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_AWAKE_OFFSET UNITYSDK_OFFSET(0xCCE1D20)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_ISIGNOREENTITY_OFFSET UNITYSDK_OFFSET(0xCCE1050)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_METHOD_5_008AB2182F1ED765_OFFSET UNITYSDK_OFFSET(0xCCE1B90)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xCCE14C0)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_REGISTERIGNOREENTITY_OFFSET UNITYSDK_OFFSET(0xCCE0BE0)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_RESET_OFFSET UNITYSDK_OFFSET(0xCCE1D70)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_UNREGISTERIGNOREENTITY_OFFSET UNITYSDK_OFFSET(0xCCE0D70)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_UPDATE_OFFSET UNITYSDK_OFFSET(0xCCE0B70)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION__CCTOR_OFFSET UNITYSDK_OFFSET(0xCCE1EA0)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE1E90)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::WeakReference_1<::RPG::GameCore::GameEntity*>*>**)Il2CppClass::FromTypeDefinitionIndex(MonoEntityTriggerCollision_TypeDefinitionIndex)->GetStaticField(0x5D9F0);
		}
