...
#define RPG_CLIENT_ROGUETOURNPERSONABASEVIEWMODEL_ADDMESSAGEHANDLER_OFFSET UNITYSDK_OFFSET(0xD461AE0)
#define RPG_CLIENT_ROGUETOURNPERSONABASEVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD4619F0)
#define RPG_CLIENT_ROGUETOURNPERSONABASEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD461BC0)
#define RPG_CLIENT_ROGUETOURNPERSONABASEVIEWMODEL__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xD461AA0)
#define RPG_CLIENT_ROGUETOURNPERSONABASEVIEWMODEL__SENDMESSAGE_OFFSET UNITYSDK_OFFSET(0xD461B40)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaBaseViewModel_TypeDefinitionIndex = 69598;
