...
#define RPG_CLIENT_CHARACTERMONOAVATAR_AWAKE_OFFSET UNITYSDK_OFFSET(0xC022E60)
#define RPG_CLIENT_CHARACTERMONOAVATAR_COLLECTIKTHREADDATA_OFFSET UNITYSDK_OFFSET(0xC023BA0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_DISABLEFOOTIK_OFFSET UNITYSDK_OFFSET(0xC025ED0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_ENABLEATTACHMENTSOLVERPOINT_OFFSET UNITYSDK_OFFSET(0xC0264C0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_ENABLEFOOTIK_OFFSET UNITYSDK_OFFSET(0xC025DA0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_FINDATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xC0246D0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_FLUSHIKTHREADDATA_OFFSET UNITYSDK_OFFSET(0xC023F80)
#define RPG_CLIENT_CHARACTERMONOAVATAR_FORBIDFOOTIK_OFFSET UNITYSDK_OFFSET(0xC024D10)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GETIKREFERENCETRANSFORMS_OFFSET UNITYSDK_OFFSET(0xC023AC0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_AIMCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC026A80)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_BODYBLENDSHAPESCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC026BC0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_BODYCONTROLIK_OFFSET UNITYSDK_OFFSET(0xC026B20)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_EMOBLENDSHAPESCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC026BE0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_FITTOGROUNDIK_OFFSET UNITYSDK_OFFSET(0xC026B60)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_FOOTIKENABLED_OFFSET UNITYSDK_OFFSET(0xC0268D0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_FOOTIKSOLVEDPELVISOFFSET_OFFSET UNITYSDK_OFFSET(0xC026940)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_FOOTL_OFFSET UNITYSDK_OFFSET(0xC0267E0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_FOOTR_OFFSET UNITYSDK_OFFSET(0xC026830)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_FOURFEETSIMPLEIK_OFFSET UNITYSDK_OFFSET(0xC026AE0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_FULLBODYIK_OFFSET UNITYSDK_OFFSET(0xC026B40)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_GROUNDERIK_OFFSET UNITYSDK_OFFSET(0xC026930)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_GROUNDERQUADRUPED_OFFSET UNITYSDK_OFFSET(0xC026B00)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_HEAD_OFFSET UNITYSDK_OFFSET(0xC026880)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_ISFORBIDFOOTIK_OFFSET UNITYSDK_OFFSET(0xC026C00)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_ISIKLOD_OFFSET UNITYSDK_OFFSET(0xC026A00)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_ISIKLOWLOD_OFFSET UNITYSDK_OFFSET(0xC026A20)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_ISLOD0_OFFSET UNITYSDK_OFFSET(0xC026A40)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_ISMODELLOADED_OFFSET UNITYSDK_OFFSET(0xC022200)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_LOOKATIK_OFFSET UNITYSDK_OFFSET(0xC026A60)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xC026780)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xC022220)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_ROOTDAMPER_OFFSET UNITYSDK_OFFSET(0xC026B80)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_SKIRTIK_OFFSET UNITYSDK_OFFSET(0xC026AC0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_SPRINGMANAGER_OFFSET UNITYSDK_OFFSET(0xC026BA0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_TILTROOT_OFFSET UNITYSDK_OFFSET(0xC026790)
#define RPG_CLIENT_CHARACTERMONOAVATAR_GET_UPSTAIRFOOTIK_OFFSET UNITYSDK_OFFSET(0xC026AA0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_HEADLOOKAT_1_OFFSET UNITYSDK_OFFSET(0xC0248B0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_HEADLOOKAT_OFFSET UNITYSDK_OFFSET(0xC024820)
#define RPG_CLIENT_CHARACTERMONOAVATAR_HEADSTOPLOOKAT_OFFSET UNITYSDK_OFFSET(0xC0247B0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_INITFOOTIK_OFFSET UNITYSDK_OFFSET(0xC024F50)
#define RPG_CLIENT_CHARACTERMONOAVATAR_ISLOOKATACTIVE_OFFSET UNITYSDK_OFFSET(0xC024940)
#define RPG_CLIENT_CHARACTERMONOAVATAR_ISLOOKATFULLWEIGHT_OFFSET UNITYSDK_OFFSET(0xC0249A0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC022F10)
#define RPG_CLIENT_CHARACTERMONOAVATAR_MANUALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC023A40)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xC022730)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_2DFEE8820CF51969_OFFSET UNITYSDK_OFFSET(0xC025480)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_30699FBD73ED5A97_OFFSET UNITYSDK_OFFSET(0xC023810)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0xC023950)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_6286C6E6E1522088_OFFSET UNITYSDK_OFFSET(0xC024D70)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_8CB3ABD41F954D02_OFFSET UNITYSDK_OFFSET(0xC0230B0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_A7F5E6D57ED9E0FE_OFFSET UNITYSDK_OFFSET(0xC025A90)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC022A90)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xC022D50)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_D6F1CA1CE793B7CC_OFFSET UNITYSDK_OFFSET(0xC026640)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0xC0228E0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_METHOD_5_FE327FD0760E1514_OFFSET UNITYSDK_OFFSET(0xC022F70)
#define RPG_CLIENT_CHARACTERMONOAVATAR_ONMODELLOADED_OFFSET UNITYSDK_OFFSET(0xC022240)
#define RPG_CLIENT_CHARACTERMONOAVATAR_ONMODELUNLOAD_OFFSET UNITYSDK_OFFSET(0xC022AD0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_OVERRIDELOOKATFADEINTIME_OFFSET UNITYSDK_OFFSET(0xC024B50)
#define RPG_CLIENT_CHARACTERMONOAVATAR_OVERRIDELOOKATFADEOUTTIME_OFFSET UNITYSDK_OFFSET(0xC024AC0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_OVERRIDELOOKATSPEED_OFFSET UNITYSDK_OFFSET(0xC024A30)
#define RPG_CLIENT_CHARACTERMONOAVATAR_POSTPROCESSIK_OFFSET UNITYSDK_OFFSET(0xC024300)
#define RPG_CLIENT_CHARACTERMONOAVATAR_PREPROCESSIK_OFFSET UNITYSDK_OFFSET(0xC024130)
#define RPG_CLIENT_CHARACTERMONOAVATAR_RESETFOOTIKSOLVERPOSITIONONPLATFORMMOVED_OFFSET UNITYSDK_OFFSET(0xC026410)
#define RPG_CLIENT_CHARACTERMONOAVATAR_RESETFOOTIKSOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0xC026350)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SETFOOTIKLOCK_1_OFFSET UNITYSDK_OFFSET(0xC0260C0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SETFOOTIKLOCK_OFFSET UNITYSDK_OFFSET(0xC026040)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SETFOOTIKMODE_OFFSET UNITYSDK_OFFSET(0xC0261E0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SETFOOTIKPHYSICS_OFFSET UNITYSDK_OFFSET(0xC026150)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SETFOOTIKSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0xC0262D0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SETLOOKATDISABLEWITHCAUSE_OFFSET UNITYSDK_OFFSET(0xC024C90)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SETUPCURVEBLENDER_OFFSET UNITYSDK_OFFSET(0xC024BE0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SETUPMANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xC0239B0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_AIMCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC026A90)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_BODYBLENDSHAPESCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC026BD0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_BODYCONTROLIK_OFFSET UNITYSDK_OFFSET(0xC026B30)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_EMOBLENDSHAPESCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC026BF0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_FITTOGROUNDIK_OFFSET UNITYSDK_OFFSET(0xC026B70)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_FOURFEETSIMPLEIK_OFFSET UNITYSDK_OFFSET(0xC026AF0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_FULLBODYIK_OFFSET UNITYSDK_OFFSET(0xC026B50)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_GROUNDERQUADRUPED_OFFSET UNITYSDK_OFFSET(0xC026B10)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_ISIKLOD_OFFSET UNITYSDK_OFFSET(0xC026A10)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_ISIKLOWLOD_OFFSET UNITYSDK_OFFSET(0xC026A30)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_ISLOD0_OFFSET UNITYSDK_OFFSET(0xC026A50)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_ISMODELLOADED_OFFSET UNITYSDK_OFFSET(0xC022210)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_LOOKATIK_OFFSET UNITYSDK_OFFSET(0xC026A70)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_MODEL_OFFSET UNITYSDK_OFFSET(0xC022230)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_ROOTDAMPER_OFFSET UNITYSDK_OFFSET(0xC026B90)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_SKIRTIK_OFFSET UNITYSDK_OFFSET(0xC026AD0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_SPRINGMANAGER_OFFSET UNITYSDK_OFFSET(0xC026BB0)
#define RPG_CLIENT_CHARACTERMONOAVATAR_SET_UPSTAIRFOOTIK_OFFSET UNITYSDK_OFFSET(0xC026AB0)
#define RPG_CLIENT_CHARACTERMONOAVATAR__CCTOR_OFFSET UNITYSDK_OFFSET(0xC026D20)
#define RPG_CLIENT_CHARACTERMONOAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xC026C10)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RootMotion::FinalIK::LimbIK*>**)Il2CppClass::FromTypeDefinitionIndex(CharacterMonoAvatar_TypeDefinitionIndex)->GetStaticField(0x5CB50);
		}
