...
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0xD8A4200)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_BURSTCOUNT_OFFSET UNITYSDK_OFFSET(0xD8A4A10)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0xD8A24B0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_CIRCLEANGLE_OFFSET UNITYSDK_OFFSET(0xD8A4B00)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_CONEANGLE_OFFSET UNITYSDK_OFFSET(0xD8A4BA0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_CONERADIUS_OFFSET UNITYSDK_OFFSET(0xD8A4AB0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_CONETHICKNESS_OFFSET UNITYSDK_OFFSET(0xD8A4B50)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_DRAG_OFFSET UNITYSDK_OFFSET(0xD8A4E40)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_GRAVITY_OFFSET UNITYSDK_OFFSET(0xD8A4E90)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_LIFETIMEMINMAX_OFFSET UNITYSDK_OFFSET(0xD8A2D50)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_ORBITSPEEDMINMAX_OFFSET UNITYSDK_OFFSET(0xD8A4C90)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_ORBITSPEEDOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0xD8A49C0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_POSITIONRANDOMMAX_OFFSET UNITYSDK_OFFSET(0xD8A4D90)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_POSITIONRANDOMMIN_OFFSET UNITYSDK_OFFSET(0xD8A4D30)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_PREWARMDATACACHED_OFFSET UNITYSDK_OFFSET(0xD8A4EF0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_PREWARMDATA_OFFSET UNITYSDK_OFFSET(0xD8A4F40)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_PREWARMFRAMERATE_OFFSET UNITYSDK_OFFSET(0xD8A2D00)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_PREWARM_OFFSET UNITYSDK_OFFSET(0xD8A2CB0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_RANDOMSEED_OFFSET UNITYSDK_OFFSET(0xD8A4DF0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_RENDERMATERIAL_OFFSET UNITYSDK_OFFSET(0xD8A41B0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_RENDERMESH_OFFSET UNITYSDK_OFFSET(0xD8A4160)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_SELFROTSPEEDMINMAX_OFFSET UNITYSDK_OFFSET(0xD8A4CE0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_SIZEMINMAX_OFFSET UNITYSDK_OFFSET(0xD8A4BF0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_SIZEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0xD8A4920)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_SPAWNCS_OFFSET UNITYSDK_OFFSET(0xD8A2460)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_SPAWNRATE_OFFSET UNITYSDK_OFFSET(0xD8A4A60)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_VELOCITYMINMAX_OFFSET UNITYSDK_OFFSET(0xD8A4C40)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET_VELOCITYOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0xD8A4970)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xD8A2420)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_06A2B758FCB8A24E_OFFSET UNITYSDK_OFFSET(0xD8A2090)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0xD8A1C70)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0xD8A1980)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xD8A2340)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_36971FC3F16E2CEB_OFFSET UNITYSDK_OFFSET(0xD8A0E80)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xD8A1FD0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xD8A2030)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD8A1C10)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_492AD7A19DD3EA58_OFFSET UNITYSDK_OFFSET(0xD8A1760)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0xD8A1CC0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_516F895199CC4307_OFFSET UNITYSDK_OFFSET(0xD8A23C0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_53898BC8CD31F230_OFFSET UNITYSDK_OFFSET(0xD8A18E0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_8B1D1F4F3D0E01CB_OFFSET UNITYSDK_OFFSET(0xD8A2DA0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD8A1660)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_9765352E01408D38_OFFSET UNITYSDK_OFFSET(0xD8A2A60)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_A714DCC98F177E25_OFFSET UNITYSDK_OFFSET(0xD8A4420)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0xD8A0E30)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_D14D1C669EDC2D6B_OFFSET UNITYSDK_OFFSET(0xD8A2890)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_FAADEE08E4E52BA5_OFFSET UNITYSDK_OFFSET(0xD8A4520)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_METHOD_3_FDCB0CC2979DD765_OFFSET UNITYSDK_OFFSET(0xD8A2500)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xD8A16D0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xD8A4FA0)
#define RPG_CLIENT_VORTEXPARTICLESBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD8A4F90)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VortexParticlesBehavior_TypeDefinitionIndex)->GetStaticField(0xF260);
		}
		static ::System::Single* StaticGet_maxSpawnInterval()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VortexParticlesBehavior_TypeDefinitionIndex)->GetStaticField(0xF264);
		}
		static ::System::Int32* StaticGet_maxTextureSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VortexParticlesBehavior_TypeDefinitionIndex)->GetStaticField(0xF268);
		}
		static ::System::Single* StaticGet_kComputeShaderThreadCount()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VortexParticlesBehavior_TypeDefinitionIndex)->GetStaticField(0xF26C);
		}
