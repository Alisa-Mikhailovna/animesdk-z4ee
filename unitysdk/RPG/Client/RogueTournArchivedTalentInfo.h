...
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD40C890)
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO_GET_TITANTALENTINFO_OFFSET UNITYSDK_OFFSET(0xD40C8E0)
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO_INIT_OFFSET UNITYSDK_OFFSET(0xD40C840)
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD40C810)
