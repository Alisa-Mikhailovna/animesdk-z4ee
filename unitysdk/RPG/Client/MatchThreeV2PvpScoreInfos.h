...
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_CREATE_OFFSET UNITYSDK_OFFSET(0xCB7EEA0)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_GETSCOREDATALISTBYSCORETYPE_OFFSET UNITYSDK_OFFSET(0xCB7FA80)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_GETSCOREDATA_1_OFFSET UNITYSDK_OFFSET(0xCB7F310)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_GETSCOREDATA_2_OFFSET UNITYSDK_OFFSET(0xCB7F650)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_GETSCOREDATA_OFFSET UNITYSDK_OFFSET(0xCB7F200)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_INIT_OFFSET UNITYSDK_OFFSET(0xCB7EF80)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS__CTOR_OFFSET UNITYSDK_OFFSET(0xCB7EF40)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS__INITALLSCOREDATAS_OFFSET UNITYSDK_OFFSET(0xCB7EFD0)
