...
#define RPG_CLIENT_CHENLINGFESMODELVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC0CC780)
#define RPG_CLIENT_CHENLINGFESMODELVIEW_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xC0CC690)
#define RPG_CLIENT_CHENLINGFESMODELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC0CC7E0)
