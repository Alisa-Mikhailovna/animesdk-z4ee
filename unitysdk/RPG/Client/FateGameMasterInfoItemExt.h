...
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ASMIRROR_OFFSET UNITYSDK_OFFSET(0xC45ADE0)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ASPLAYER_OFFSET UNITYSDK_OFFSET(0xC45AC20)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ASREAL_OFFSET UNITYSDK_OFFSET(0xC45AD50)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ASRIVAL_OFFSET UNITYSDK_OFFSET(0xC45ACC0)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISDEAD_OFFSET UNITYSDK_OFFSET(0xC459A60)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISMIRROR_OFFSET UNITYSDK_OFFSET(0xC45AA70)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISPLAYER_OFFSET UNITYSDK_OFFSET(0xC459FC0)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISREAL_OFFSET UNITYSDK_OFFSET(0xC45AB90)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISRIVAL_OFFSET UNITYSDK_OFFSET(0xC45AB00)
