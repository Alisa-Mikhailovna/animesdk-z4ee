...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xCBD7970)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY_EQUALS_OFFSET UNITYSDK_OFFSET(0xCBD78C0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xCBD7AA0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0xCBD7AF0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY__CTOR_OFFSET UNITYSDK_OFFSET(0xCBD78B0)
