...
#define RPG_CLIENT_CONVINCEUIUTILS_GETCONVINCEGAMEPLAYNPCID_OFFSET UNITYSDK_OFFSET(0xC1B9830)
#define RPG_CLIENT_CONVINCEUIUTILS_GETCONVINCESPLITELINEPOS_OFFSET UNITYSDK_OFFSET(0xC1B9A00)
#define RPG_CLIENT_CONVINCEUIUTILS_GETHP_OFFSET UNITYSDK_OFFSET(0xC1B8FE0)
#define RPG_CLIENT_CONVINCEUIUTILS_GETNAMETEXTS_OFFSET UNITYSDK_OFFSET(0xC1B9320)
#define RPG_CLIENT_CONVINCEUIUTILS_GETSKILLINFO_OFFSET UNITYSDK_OFFSET(0xC1B9690)
#define RPG_CLIENT_CONVINCEUIUTILS_GETTALKINGSIDE_OFFSET UNITYSDK_OFFSET(0xC1B94C0)
#define RPG_CLIENT_CONVINCEUIUTILS_GETTURN_OFFSET UNITYSDK_OFFSET(0xC1B9180)
