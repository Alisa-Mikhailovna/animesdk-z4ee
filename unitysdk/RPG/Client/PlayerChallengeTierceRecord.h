...
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_BRIEFRECORD_OFFSET UNITYSDK_OFFSET(0xD0A0A10)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xD0A09B0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xD09E4D0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_STAGERECORDS_OFFSET UNITYSDK_OFFSET(0xD0A0A20)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0xD0A0990)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0xD0A09F0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_TOTALUSEROUNDS_OFFSET UNITYSDK_OFFSET(0xD0A09D0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_RESET_OFFSET UNITYSDK_OFFSET(0xD09EFA0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xD0A09C0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0xD0A09A0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0xD0A0A00)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_TOTALUSEROUNDS_OFFSET UNITYSDK_OFFSET(0xD0A09E0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SYNC_OFFSET UNITYSDK_OFFSET(0xD09F070)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0xD09FE40)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD__SYNCSTAGES_OFFSET UNITYSDK_OFFSET(0xD0A0A30)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _StarCount_k__BackingField; // 0x24
		::System::UInt32 _TotalUseRounds_k__BackingField; // 0x28
