...
#define RPG_CLIENT_CHIMERADUEL_CHIMERADUELBATTLEMASTERMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC10F770)

namespace RPG::Client::ChimeraDuel
{
	inline static constexpr unsigned int ChimeraDuelBattleMasterModel_TypeDefinitionIndex = 76288;
