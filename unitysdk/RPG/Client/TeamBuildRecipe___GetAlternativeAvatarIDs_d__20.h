...
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD639530)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_UINT32__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD6399B0)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_UINT32__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD639920)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD639A30)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD639980)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD639930)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD6393F0)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0xD639240)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xD639430)
...
namespace RPG::Client
{
	...
	{
	public:
		::Il2CppArray<::System::Collections::Generic::ICollection_1<::System::UInt32>*>* exclusiveIDGroups; // 0x10
