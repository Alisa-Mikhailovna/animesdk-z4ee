...
#define RPG_CLIENT_IKHITREACTION_METHOD_1_057988DB0B887860_OFFSET UNITYSDK_OFFSET(0xC8C4C00)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_146E6E50FAF07D8F_OFFSET UNITYSDK_OFFSET(0xC8C58D0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xC8C49E0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_3736E5E17FF77392_OFFSET UNITYSDK_OFFSET(0xC8C2E90)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_3CF2577546B46979_OFFSET UNITYSDK_OFFSET(0xC8C6750)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_3FCE23B5823919D5_OFFSET UNITYSDK_OFFSET(0xC8C3450)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_8C43E6E7E328B9EB_OFFSET UNITYSDK_OFFSET(0xC8C4430)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_91C638630F1EEE79_1_OFFSET UNITYSDK_OFFSET(0xC8C70E0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_91C638630F1EEE79_2_OFFSET UNITYSDK_OFFSET(0xC8C7170)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_91C638630F1EEE79_OFFSET UNITYSDK_OFFSET(0xC8C6350)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_9AB55F553C4AC6E8_OFFSET UNITYSDK_OFFSET(0xC8C31D0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_9B5A8342063042C5_OFFSET UNITYSDK_OFFSET(0xC8C46F0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_A61A196E6AD5766D_OFFSET UNITYSDK_OFFSET(0xC8C3090)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_B92E5DD9D403BB04_OFFSET UNITYSDK_OFFSET(0xC8C36D0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_C3B113AF6205EF51_OFFSET UNITYSDK_OFFSET(0xC8C6EB0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_C66E15B631BB1D0F_OFFSET UNITYSDK_OFFSET(0xC8C6660)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_D0ACB47B641DF879_OFFSET UNITYSDK_OFFSET(0xC8C5770)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_DC715239B8B98D9C_OFFSET UNITYSDK_OFFSET(0xC8C4A40)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_DEE0DF04D13E6331_OFFSET UNITYSDK_OFFSET(0xC8C60D0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_EC00644AF39B5DED_OFFSET UNITYSDK_OFFSET(0xC8C5FA0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_FA1B171818AF9953_OFFSET UNITYSDK_OFFSET(0xC8C63E0)
#define RPG_CLIENT_IKHITREACTION_METHOD_1_FD1EFD5A6E481F5B_OFFSET UNITYSDK_OFFSET(0xC8C7070)
#define RPG_CLIENT_IKHITREACTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xC8C7240)
#define RPG_CLIENT_IKHITREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C7200)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Class_1_53196D6FF2C19831*>**)Il2CppClass::FromTypeDefinitionIndex(IKHitReaction_TypeDefinitionIndex)->GetStaticField(0x32870);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Transform*, ::RPG::Client::IKHitReaction_Struct_2_CC346D804C45C8EA_1>**)Il2CppClass::FromTypeDefinitionIndex(IKHitReaction_TypeDefinitionIndex)->GetStaticField(0x32878);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Transform*>** StaticGet__ChainTargetCache()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(IKHitReaction_TypeDefinitionIndex)->GetStaticField(0x32880);
		}
