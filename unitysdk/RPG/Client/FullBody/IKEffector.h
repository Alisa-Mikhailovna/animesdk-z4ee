...
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_GET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0xC64D550)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_036297786760DCCD_OFFSET UNITYSDK_OFFSET(0xC64E8C0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_03A1AC84763ACA7B_OFFSET UNITYSDK_OFFSET(0xC64D570)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_3E66374F7EBEF0C3_OFFSET UNITYSDK_OFFSET(0xC64DF30)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_427DA2D5A5420560_OFFSET UNITYSDK_OFFSET(0xC64E100)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_4D9D8D32416652E5_OFFSET UNITYSDK_OFFSET(0xC64EAB0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_AC41839A69ACE562_OFFSET UNITYSDK_OFFSET(0xC64EE60)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xC64E050)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_B7420C119DD5CDA0_OFFSET UNITYSDK_OFFSET(0xC64D830)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC64E870)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_E7EA3C355E8D3AFF_OFFSET UNITYSDK_OFFSET(0xC64D4B0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_F488396416325F74_OFFSET UNITYSDK_OFFSET(0xC64DCA0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_SET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0xC64D560)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC64D760)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC64D6A0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKEffector_TypeDefinitionIndex = 70850;
