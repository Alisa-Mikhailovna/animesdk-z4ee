...
#define RPG_CLIENT_FULLBODY_GROUNDER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0xC6411C0)
#define RPG_CLIENT_FULLBODY_GROUNDER_GET_ISIKENABLED_OFFSET UNITYSDK_OFFSET(0xC6410C0)
#define RPG_CLIENT_FULLBODY_GROUNDER_GET_ISIKUPDATEENABLED_OFFSET UNITYSDK_OFFSET(0xC6411B0)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xC641710)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_135A6C290305C949_OFFSET UNITYSDK_OFFSET(0xC641760)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xC641D60)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_627C7524E98F4AC5_1_OFFSET UNITYSDK_OFFSET(0xC641CD0)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xC641C40)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_968FC12B18A43BC3_OFFSET UNITYSDK_OFFSET(0xC641300)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_E39C6E87494B02E3_OFFSET UNITYSDK_OFFSET(0xC6411E0)
#define RPG_CLIENT_FULLBODY_GROUNDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC641BF0)
#define RPG_CLIENT_FULLBODY_GROUNDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC641BA0)
#define RPG_CLIENT_FULLBODY_GROUNDER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0xC6411D0)
#define RPG_CLIENT_FULLBODY_GROUNDER_SET_ISIKENABLED_OFFSET UNITYSDK_OFFSET(0xC6410D0)
#define RPG_CLIENT_FULLBODY_GROUNDER__CTOR_OFFSET UNITYSDK_OFFSET(0xC641EE0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounder_TypeDefinitionIndex = 70832;
