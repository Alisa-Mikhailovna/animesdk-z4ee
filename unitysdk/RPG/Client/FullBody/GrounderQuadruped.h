...
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_FORCERESET_OFFSET UNITYSDK_OFFSET(0xC642A40)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_GET_FINALWEIGHT_OFFSET UNITYSDK_OFFSET(0xC6424D0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_GET_ISIKUPDATEENABLED_OFFSET UNITYSDK_OFFSET(0xC642480)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC643C10)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xC642520)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC643D60)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xC6454B0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_218124418542E081_OFFSET UNITYSDK_OFFSET(0xC6449C0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_2A74484E06FA28B1_OFFSET UNITYSDK_OFFSET(0xC642AD0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_2C4180681033D073_OFFSET UNITYSDK_OFFSET(0xC642BA0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC642410)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC6423A0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_5E6D8BB697956401_OFFSET UNITYSDK_OFFSET(0xC645C00)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_5EAB2C5E0D76A6B7_OFFSET UNITYSDK_OFFSET(0xC6425F0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_627C7524E98F4AC5_1_OFFSET UNITYSDK_OFFSET(0xC6466D0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xC646640)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_8F0FFD4F86CFEC1A_OFFSET UNITYSDK_OFFSET(0xC643370)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xC645E20)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_CA780F692BF1CA71_OFFSET UNITYSDK_OFFSET(0xC646370)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0xC642EF0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_F91F0A5E0D7E03BF_OFFSET UNITYSDK_OFFSET(0xC644790)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC646300)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC642CD0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC642C30)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_REFRESH_OFFSET UNITYSDK_OFFSET(0xC646760)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0xC6426A0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_UPDATE_OFFSET UNITYSDK_OFFSET(0xC642E00)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__CTOR_OFFSET UNITYSDK_OFFSET(0xC646940)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int GrounderQuadruped_TypeDefinitionIndex = 70836;
