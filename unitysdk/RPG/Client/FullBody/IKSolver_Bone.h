...
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_0EC9AEC5DC94C3DD_1_OFFSET UNITYSDK_OFFSET(0xC6570B0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_0EC9AEC5DC94C3DD_OFFSET UNITYSDK_OFFSET(0xC6567B0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC657450)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_F4F7B088C1B5D6D7_OFFSET UNITYSDK_OFFSET(0xC656C40)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC657520)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE__CTOR_2_OFFSET UNITYSDK_OFFSET(0xC657560)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0xC6574C0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_Bone_TypeDefinitionIndex = 70859;
