...
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_03100CB4894A3883_OFFSET UNITYSDK_OFFSET(0xC661470)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_0B46B29B42A81C6F_OFFSET UNITYSDK_OFFSET(0xC661610)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xC6626A0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_2E9EFD1763526B05_OFFSET UNITYSDK_OFFSET(0xC661860)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_33C4B285E4B1271C_OFFSET UNITYSDK_OFFSET(0xC663740)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_383F5EE18A2A3914_OFFSET UNITYSDK_OFFSET(0xC662310)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_412F2CEBDE691C81_OFFSET UNITYSDK_OFFSET(0xC6612E0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0xC661340)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_5A6EAD1FC0CCA71D_OFFSET UNITYSDK_OFFSET(0xC661B10)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_7970C5CAFFD9CDA1_OFFSET UNITYSDK_OFFSET(0xC660E10)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_A0C2164E6BC7E6E6_OFFSET UNITYSDK_OFFSET(0xC662A20)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_A1C7122184516C18_OFFSET UNITYSDK_OFFSET(0xC662B40)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xC661420)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_A742B18FC98A9593_OFFSET UNITYSDK_OFFSET(0xC661BD0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0xC661070)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_C34AC80B04BCFF1B_OFFSET UNITYSDK_OFFSET(0xC6613C0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xC663D50)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xC663D90)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC663D10)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0xC661750)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xC6617D0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xC662880)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC__CTOR_OFFSET UNITYSDK_OFFSET(0xC660AD0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolverTrigonometric_TypeDefinitionIndex = 70870;
