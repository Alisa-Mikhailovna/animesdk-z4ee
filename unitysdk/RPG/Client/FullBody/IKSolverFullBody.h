...
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_021031D9935F927E_OFFSET UNITYSDK_OFFSET(0xC640E60)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_0507EB8022711947_OFFSET UNITYSDK_OFFSET(0xC658050)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0xC659220)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_16975C26AC475304_OFFSET UNITYSDK_OFFSET(0xC64D410)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_26F5E793BB51FC71_OFFSET UNITYSDK_OFFSET(0xC657DC0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_370B283A2686728C_OFFSET UNITYSDK_OFFSET(0xC64C6B0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_388538BD99159606_OFFSET UNITYSDK_OFFSET(0xC657C30)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_3BFE3B9EF8374F61_OFFSET UNITYSDK_OFFSET(0xC658700)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_4805283D59625FD9_OFFSET UNITYSDK_OFFSET(0xC658530)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_7142D89B39D12AB7_OFFSET UNITYSDK_OFFSET(0xC657D40)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_79638E65BEE6EF1F_OFFSET UNITYSDK_OFFSET(0xC64C370)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0xC6583F0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0xC658270)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_9E610EF313D0CC32_OFFSET UNITYSDK_OFFSET(0xC658D10)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_A59F33F8CA7F3A80_OFFSET UNITYSDK_OFFSET(0xC658A30)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY_METHOD_2_D1305BC17A89C222_OFFSET UNITYSDK_OFFSET(0xC6591B0)
#define RPG_CLIENT_FULLBODY_IKSOLVERFULLBODY__CTOR_OFFSET UNITYSDK_OFFSET(0xC6593C0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolverFullBody_TypeDefinitionIndex = 70863;
