...
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_GET_ISNODEBONE_OFFSET UNITYSDK_OFFSET(0xC64FA40)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_GET_LASTANIMATEDTARGETROTATION_OFFSET UNITYSDK_OFFSET(0xC650560)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_GET_SWINGDIRECTION_OFFSET UNITYSDK_OFFSET(0xC64F730)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_036297786760DCCD_OFFSET UNITYSDK_OFFSET(0xC650D20)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_1A473A8AF62E993A_OFFSET UNITYSDK_OFFSET(0xC650F00)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_2A3A99221D05589B_OFFSET UNITYSDK_OFFSET(0xC650970)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC650890)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xC650900)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC650810)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_4A5B3C87906AE918_OFFSET UNITYSDK_OFFSET(0xC64FBF0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_5422D32F23CD1298_OFFSET UNITYSDK_OFFSET(0xC651AA0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_672E3DECEBB4A051_OFFSET UNITYSDK_OFFSET(0xC6501F0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_6A3DFC5A5BD896B1_OFFSET UNITYSDK_OFFSET(0xC650100)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_7A012523248AE06A_OFFSET UNITYSDK_OFFSET(0xC650F90)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_871AC6DBEB0AF4F3_OFFSET UNITYSDK_OFFSET(0xC64FF00)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_89CEA643C7DC0619_OFFSET UNITYSDK_OFFSET(0xC64F6B0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_8C4AEC0BC1CA0CB4_OFFSET UNITYSDK_OFFSET(0xC6519B0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC64F8E0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_9C550482A5467161_OFFSET UNITYSDK_OFFSET(0xC64FB90)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_A03C765EBC5D1677_OFFSET UNITYSDK_OFFSET(0xC651180)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_BF7FB88706E4AC65_OFFSET UNITYSDK_OFFSET(0xC650AE0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_CFACABBC63158155_1_OFFSET UNITYSDK_OFFSET(0xC651610)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_CFACABBC63158155_OFFSET UNITYSDK_OFFSET(0xC651270)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_F2FD171383AF1C78_OFFSET UNITYSDK_OFFSET(0xC64FA50)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0xC64F9A0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xC651C50)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMapping_BoneMap_TypeDefinitionIndex = 70852;
