...
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_GET_AXISDIRECTIONS_OFFSET UNITYSDK_OFFSET(0xC660CA0)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_06B2B8EE44199AB7_OFFSET UNITYSDK_OFFSET(0xC65F4E0)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_0E142E3463F30350_OFFSET UNITYSDK_OFFSET(0xC65F6A0)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_209AC60266898FC2_OFFSET UNITYSDK_OFFSET(0xC65F800)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xC660940)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xC65E780)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xC65E6F0)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0xC65F060)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC660C20)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0xC660A60)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolverLimb_TypeDefinitionIndex = 70867;
