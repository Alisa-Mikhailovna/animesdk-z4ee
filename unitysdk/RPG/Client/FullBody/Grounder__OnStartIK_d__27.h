...
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC6421B0)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC6421D0)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC642230)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC6421E0)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC6421A0)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27__CTOR_OFFSET UNITYSDK_OFFSET(0xC641CC0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounder__OnStartIK_d__27_TypeDefinitionIndex = 70834;
