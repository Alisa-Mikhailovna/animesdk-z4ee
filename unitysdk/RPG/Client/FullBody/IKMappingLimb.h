...
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xC652B60)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_0B2BD75AED41F026_OFFSET UNITYSDK_OFFSET(0xC652160)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_48E0E9D29DE90B49_OFFSET UNITYSDK_OFFSET(0xC652AE0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xC6532E0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0xC652C00)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_BA6EB7BC01785CBA_OFFSET UNITYSDK_OFFSET(0xC652E60)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_C2453B35E4DF9C3B_OFFSET UNITYSDK_OFFSET(0xC652090)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_C2496B2D8317AC26_OFFSET UNITYSDK_OFFSET(0xC6533E0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_F9AF6F889DC1CC07_OFFSET UNITYSDK_OFFSET(0xC6521D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC6529A0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0xC6528C0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingLimb_TypeDefinitionIndex = 70854;
