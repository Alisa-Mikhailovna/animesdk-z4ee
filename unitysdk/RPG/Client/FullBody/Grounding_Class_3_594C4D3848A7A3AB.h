...
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_594C4D3848A7A3AB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC64C0B0)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_594C4D3848A7A3AB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC64C200)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_594C4D3848A7A3AB_INVOKE_OFFSET UNITYSDK_OFFSET(0xC64BB50)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_594C4D3848A7A3AB__CTOR_OFFSET UNITYSDK_OFFSET(0xC64C040)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounding_Class_3_594C4D3848A7A3AB_TypeDefinitionIndex = 70843;
