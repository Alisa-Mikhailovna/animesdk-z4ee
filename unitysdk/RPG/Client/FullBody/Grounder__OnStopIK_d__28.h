...
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTOPIK_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC642250)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTOPIK_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC642270)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTOPIK_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC6422D0)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTOPIK_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC642280)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTOPIK_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC642240)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTOPIK_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0xC641D50)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounder__OnStopIK_d__28_TypeDefinitionIndex = 70835;
