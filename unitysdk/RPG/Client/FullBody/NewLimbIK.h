...
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0xC6643A0)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_METHOD_7_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC664250)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_METHOD_7_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xC6642C0)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_METHOD_7_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xC664330)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_METHOD_7_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC6641E0)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK__CTOR_OFFSET UNITYSDK_OFFSET(0xC6643E0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int NewLimbIK_TypeDefinitionIndex = 70875;
