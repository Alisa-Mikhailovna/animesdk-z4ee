...
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0xC64C610)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_2787325FBE894674_OFFSET UNITYSDK_OFFSET(0xC64C990)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_35EDB68198B7034F_OFFSET UNITYSDK_OFFSET(0xC63D350)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_6C6B39C825927D70_1_OFFSET UNITYSDK_OFFSET(0xC64C880)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_6C6B39C825927D70_OFFSET UNITYSDK_OFFSET(0xC64C760)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_CDB9356E62DEB3C0_OFFSET UNITYSDK_OFFSET(0xC64C230)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_D945CEAD343B5366_OFFSET UNITYSDK_OFFSET(0xC63D3C0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_E77295995B04931B_OFFSET UNITYSDK_OFFSET(0xC63ECD0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_F552CBD036D44B0E_OFFSET UNITYSDK_OFFSET(0xC64CC50)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0xC64C620)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC64C630)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND__CTOR_OFFSET UNITYSDK_OFFSET(0xC63C570)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKConstraintBend_TypeDefinitionIndex = 70849;
