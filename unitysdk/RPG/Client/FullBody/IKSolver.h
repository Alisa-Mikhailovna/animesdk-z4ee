...
#define RPG_CLIENT_FULLBODY_IKSOLVER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0xC6560A0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0xC656060)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xC6560C0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_081E84DBAB5CA72B_OFFSET UNITYSDK_OFFSET(0xC655AE0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC655DD0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0xC655F30)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0xC655FE0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_48312DE5F57AE9EE_OFFSET UNITYSDK_OFFSET(0xC656110)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_8D103DA3EDA22B8C_OFFSET UNITYSDK_OFFSET(0xC656230)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xC655F90)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_DE042ADF54338445_OFFSET UNITYSDK_OFFSET(0xC655BA0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0xC655ED0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0xC6560B0)
#define RPG_CLIENT_FULLBODY_IKSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0xC6567A0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_TypeDefinitionIndex = 70857;
