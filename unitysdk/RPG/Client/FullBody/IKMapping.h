...
#define RPG_CLIENT_FULLBODY_IKMAPPING_METHOD_1_1C648BC3BB33C550_OFFSET UNITYSDK_OFFSET(0xC64F380)
#define RPG_CLIENT_FULLBODY_IKMAPPING_METHOD_1_73264D810B7A8424_OFFSET UNITYSDK_OFFSET(0xC64F3D0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_METHOD_1_A980FB7965D4A13F_OFFSET UNITYSDK_OFFSET(0xC64F330)
#define RPG_CLIENT_FULLBODY_IKMAPPING_METHOD_1_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0xC64F500)
#define RPG_CLIENT_FULLBODY_IKMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0xC64F6A0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMapping_TypeDefinitionIndex = 70851;
