...
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0xC653BD0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC653B40)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xC654850)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_1CBC2A1E5F49E55B_OFFSET UNITYSDK_OFFSET(0xC653C70)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2157CED3CDDF8996_OFFSET UNITYSDK_OFFSET(0xC6548B0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2F0DC1CA1AADEABC_OFFSET UNITYSDK_OFFSET(0xC654D40)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_6821143A80BCED87_OFFSET UNITYSDK_OFFSET(0xC653AB0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_8F59263A7D1D04F6_OFFSET UNITYSDK_OFFSET(0xC655390)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_C1EA43680D03621C_OFFSET UNITYSDK_OFFSET(0xC653580)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_E789DC027CE67008_OFFSET UNITYSDK_OFFSET(0xC655500)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_FC1A6F0C23BBD83A_OFFSET UNITYSDK_OFFSET(0xC6551D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC653940)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0xC653850)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingSpine_TypeDefinitionIndex = 70856;
