...
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_GET_ISRIGID_OFFSET UNITYSDK_OFFSET(0xC640E20)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_GET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0xC640E00)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_METHOD_1_1F9A386CD1061734_OFFSET UNITYSDK_OFFSET(0xC640AE0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_METHOD_1_2B9F611A895AA45C_OFFSET UNITYSDK_OFFSET(0xC63D2D0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_METHOD_1_A24EF832801448FD_OFFSET UNITYSDK_OFFSET(0xC63DF60)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_SET_ISRIGID_OFFSET UNITYSDK_OFFSET(0xC640E30)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_SET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0xC640E10)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0xC640E40)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int FBIKChain_ChildConstraint_TypeDefinitionIndex = 70830;
