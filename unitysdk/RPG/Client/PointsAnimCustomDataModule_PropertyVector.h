...
#define RPG_CLIENT_POINTSANIMCUSTOMDATAMODULE_PROPERTYVECTOR_METHOD_1_12CEF1F3F4C83D6A_OFFSET UNITYSDK_OFFSET(0xD0B3B30)
#define RPG_CLIENT_POINTSANIMCUSTOMDATAMODULE_PROPERTYVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD0B4060)
