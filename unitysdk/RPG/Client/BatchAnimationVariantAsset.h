...
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBE35830)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_METHOD_5_0D9F178E48A8B2FD_OFFSET UNITYSDK_OFFSET(0xBE35F80)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_METHOD_5_0DF420E95D6252BE_OFFSET UNITYSDK_OFFSET(0xBE35E80)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_METHOD_5_69CB80662EDEA33A_OFFSET UNITYSDK_OFFSET(0xBE36200)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_METHOD_5_8E5C972B6A5AA5D5_OFFSET UNITYSDK_OFFSET(0xBE35270)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBE355D0)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_RELEASEVARIANTRES_OFFSET UNITYSDK_OFFSET(0xBE351E0)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_REQUESTVARIANTRES_OFFSET UNITYSDK_OFFSET(0xBE35080)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_SETPARTVARIANT_OFFSET UNITYSDK_OFFSET(0xBE16B00)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xBE36590)
