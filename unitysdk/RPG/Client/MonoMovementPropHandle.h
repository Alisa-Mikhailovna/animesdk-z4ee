...
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_AFTERPROPMOVED_OFFSET UNITYSDK_OFFSET(0xCD0AA30)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_BEFOREPROPMOVE_OFFSET UNITYSDK_OFFSET(0xCD0A960)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_GET_MOVEDDELEGATE_OFFSET UNITYSDK_OFFSET(0xCD0A7E0)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_GET_NEEDREFRESHRAYCAST_OFFSET UNITYSDK_OFFSET(0xCD0A800)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xCD0A7C0)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_INITPROPMOVEMENT_OFFSET UNITYSDK_OFFSET(0xCD0A880)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD0A820)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_SET_MOVEDDELEGATE_OFFSET UNITYSDK_OFFSET(0xCD0A7F0)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_SET_NEEDREFRESHRAYCAST_OFFSET UNITYSDK_OFFSET(0xCD0A810)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xCD0A7D0)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD0AC20)
