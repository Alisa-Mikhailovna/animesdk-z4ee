...
#define RPG_CLIENT_GRIDFIGHTROLESKILLCONFIG_GETDESCSKILLID_OFFSET UNITYSDK_OFFSET(0xC7DAA50)
#define RPG_CLIENT_GRIDFIGHTROLESKILLCONFIG_GETSKILLTAGTEXTIDS_OFFSET UNITYSDK_OFFSET(0xC7DAE30)
#define RPG_CLIENT_GRIDFIGHTROLESKILLCONFIG_GET_FRONTBACKTYPE_OFFSET UNITYSDK_OFFSET(0xC7DAB90)
#define RPG_CLIENT_GRIDFIGHTROLESKILLCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC7DAC40)
#define RPG_CLIENT_GRIDFIGHTROLESKILLCONFIG_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xC7DAB40)
#define RPG_CLIENT_GRIDFIGHTROLESKILLCONFIG_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0xC7DABA0)
#define RPG_CLIENT_GRIDFIGHTROLESKILLCONFIG_GET_SHORTDESC_OFFSET UNITYSDK_OFFSET(0xC7DACA0)
#define RPG_CLIENT_GRIDFIGHTROLESKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC7DA9F0)
