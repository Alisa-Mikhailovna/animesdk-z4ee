...
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_CREATEDISPLAYITEM_1_OFFSET UNITYSDK_OFFSET(0xD3D2C30)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_CREATEDISPLAYITEM_OFFSET UNITYSDK_OFFSET(0xD3BB950)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_CREATEFROMBATTLE_OFFSET UNITYSDK_OFFSET(0xD3CC330)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_CREATE_1_OFFSET UNITYSDK_OFFSET(0xD3D2BB0)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xD3CB050)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD3CB010)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_ATTACHRANGETYPES_OFFSET UNITYSDK_OFFSET(0xD3D2FC0)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_BASICPOWERORFACTOR_OFFSET UNITYSDK_OFFSET(0xD3D31A0)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_BUFFDESC_OFFSET UNITYSDK_OFFSET(0xD3BD290)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_BUFFSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0xD3C9990)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0xD3BD030)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_EFFECTTYPES_OFFSET UNITYSDK_OFFSET(0xD3D3060)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_EXTRAEFFECTS_OFFSET UNITYSDK_OFFSET(0xD3BD490)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_FUNCTYPE_OFFSET UNITYSDK_OFFSET(0xD3BD7E0)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_ISLOCK_OFFSET UNITYSDK_OFFSET(0xD3D2F00)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_LIMITRANGETYPE_OFFSET UNITYSDK_OFFSET(0xD3D2F20)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_MAGICUNITICON_OFFSET UNITYSDK_OFFSET(0xD3BD1A0)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_MAGICUNITID_OFFSET UNITYSDK_OFFSET(0xD3D2D40)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_MAGICUNITLEVEL_OFFSET UNITYSDK_OFFSET(0xD3D2D60)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_MAGICUNITNAME_OFFSET UNITYSDK_OFFSET(0xD3BCF00)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_MOUNTTYPE_OFFSET UNITYSDK_OFFSET(0xD3BD580)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_SPECIALTYPE_OFFSET UNITYSDK_OFFSET(0xD3D3100)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_STYLETYPE_OFFSET UNITYSDK_OFFSET(0xD3BD6F0)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET_UID_OFFSET UNITYSDK_OFFSET(0xD3D2D20)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET__DISPLAYROW_OFFSET UNITYSDK_OFFSET(0xD3D2DF0)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET__MAZEBUFFROW_OFFSET UNITYSDK_OFFSET(0xD3D2E50)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xD3D2D80)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_REFRESH_OFFSET UNITYSDK_OFFSET(0xD3CBA70)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_SETISLOCK_OFFSET UNITYSDK_OFFSET(0xD3D2CD0)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_SET_ISLOCK_OFFSET UNITYSDK_OFFSET(0xD3D2F10)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_SET_MAGICUNITID_OFFSET UNITYSDK_OFFSET(0xD3D2D50)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_SET_MAGICUNITLEVEL_OFFSET UNITYSDK_OFFSET(0xD3D2D70)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM_SET_UID_OFFSET UNITYSDK_OFFSET(0xD3D2D30)
#define RPG_CLIENT_ROGUEMAGICUNITDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD3D2C20)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _MagicUnitID_k__BackingField; // 0x18
