...
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xCF3AE30)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GETKEY_OFFSET UNITYSDK_OFFSET(0xCF3B3E0)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GETPARKOURTALKTYPE_OFFSET UNITYSDK_OFFSET(0xCF32C40)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GETTALKIMGPATH_OFFSET UNITYSDK_OFFSET(0xCF32CA0)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GETTALKTEXTID_OFFSET UNITYSDK_OFFSET(0xCF32D00)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GETTARGETICONPATH_OFFSET UNITYSDK_OFFSET(0xCF3B290)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GET_CREATETIME_OFFSET UNITYSDK_OFFSET(0xCF3AC30)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0xCF3ABB0)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GET_LIMITREPEATTIME_OFFSET UNITYSDK_OFFSET(0xCF3AC50)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GET_ORIGINID_OFFSET UNITYSDK_OFFSET(0xCF3ABD0)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GET_RANDOMINDEX_OFFSET UNITYSDK_OFFSET(0xCF3AC10)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GET_TARGETID_OFFSET UNITYSDK_OFFSET(0xCF3ABF0)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_GET__META_OFFSET UNITYSDK_OFFSET(0xCF3ADD0)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_SET_CREATETIME_OFFSET UNITYSDK_OFFSET(0xCF3AC40)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0xCF3ABC0)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_SET_ORIGINID_OFFSET UNITYSDK_OFFSET(0xCF3ABE0)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_SET_RANDOMINDEX_OFFSET UNITYSDK_OFFSET(0xCF3AC20)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO_SET_TARGETID_OFFSET UNITYSDK_OFFSET(0xCF3AC00)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCF3AF70)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO__GETPARKOURTRIGGEREVENTCONTENTROW_OFFSET UNITYSDK_OFFSET(0xCF3B430)
#define RPG_CLIENT_PARKOURGAMETALKEVENTINFO__INIT_OFFSET UNITYSDK_OFFSET(0xCF3AF80)
