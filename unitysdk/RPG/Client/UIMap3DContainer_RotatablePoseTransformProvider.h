...
#define RPG_CLIENT_UIMAP3DCONTAINER_ROTATABLEPOSETRANSFORMPROVIDER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD7E0900)
#define RPG_CLIENT_UIMAP3DCONTAINER_ROTATABLEPOSETRANSFORMPROVIDER_GET_POSETRANSFORMS_OFFSET UNITYSDK_OFFSET(0xD7E0940)
#define RPG_CLIENT_UIMAP3DCONTAINER_ROTATABLEPOSETRANSFORMPROVIDER_INIT_OFFSET UNITYSDK_OFFSET(0xD7E04E0)
#define RPG_CLIENT_UIMAP3DCONTAINER_ROTATABLEPOSETRANSFORMPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7DF0A0)
#define RPG_CLIENT_UIMAP3DCONTAINER_ROTATABLEPOSETRANSFORMPROVIDER__INITMODELPOSEINFO_OFFSET UNITYSDK_OFFSET(0xD7E0550)
