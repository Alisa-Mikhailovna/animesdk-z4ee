...
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC1F50)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC2520)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xCCC1F10)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_METHOD_6_08DCF72FBE01FF99_OFFSET UNITYSDK_OFFSET(0xCCC2410)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_METHOD_6_137034D6EE7EADFD_OFFSET UNITYSDK_OFFSET(0xCCC2A10)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_METHOD_6_6A0EBEECA245A27C_OFFSET UNITYSDK_OFFSET(0xCCC1FF0)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_METHOD_6_C72B925A491E9859_OFFSET UNITYSDK_OFFSET(0xCCC2B50)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC1F90)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_TICK_OFFSET UNITYSDK_OFFSET(0xCCC2560)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC2CC0)
