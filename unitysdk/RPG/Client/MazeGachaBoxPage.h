...
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_GACHAGROUPSFOCUS_OFFSET UNITYSDK_OFFSET(0xCB97D40)
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_GACHAGROUPSMASK1_OFFSET UNITYSDK_OFFSET(0xCB97D60)
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_GACHAGROUPSMASK2_OFFSET UNITYSDK_OFFSET(0xCB97D80)
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_ROLLSPEED_OFFSET UNITYSDK_OFFSET(0xCB97DA0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_WAITSECONDS_OFFSET UNITYSDK_OFFSET(0xCB97D20)
#define RPG_CLIENT_MAZEGACHABOXPAGE_ONFINISH_OFFSET UNITYSDK_OFFSET(0xCB981A0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_ONSTOPROLLING_OFFSET UNITYSDK_OFFSET(0xCB98150)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_GACHAGROUPSFOCUS_OFFSET UNITYSDK_OFFSET(0xCB97D50)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_GACHAGROUPSMASK1_OFFSET UNITYSDK_OFFSET(0xCB97D70)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_GACHAGROUPSMASK2_OFFSET UNITYSDK_OFFSET(0xCB97D90)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_ROLLSPEED_OFFSET UNITYSDK_OFFSET(0xCB97DB0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_WAITSECONDS_OFFSET UNITYSDK_OFFSET(0xCB97D30)
#define RPG_CLIENT_MAZEGACHABOXPAGE_STARTROLLING_OFFSET UNITYSDK_OFFSET(0xCB97DC0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_UPDATE_OFFSET UNITYSDK_OFFSET(0xCB981F0)
#define RPG_CLIENT_MAZEGACHABOXPAGE__CALCCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0xCB982B0)
#define RPG_CLIENT_MAZEGACHABOXPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB98990)
#define RPG_CLIENT_MAZEGACHABOXPAGE__POS2INDEX_OFFSET UNITYSDK_OFFSET(0xCB98650)
#define RPG_CLIENT_MAZEGACHABOXPAGE__REMOVEHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xCB97F20)
#define RPG_CLIENT_MAZEGACHABOXPAGE__SETHIGHLIGHTGACHAGROUP_OFFSET UNITYSDK_OFFSET(0xCB98450)
#define RPG_CLIENT_MAZEGACHABOXPAGE__SETHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xCB98760)

namespace RPG::Client
{
	inline static constexpr unsigned int MazeGachaBoxPage_TypeDefinitionIndex = 69600;
