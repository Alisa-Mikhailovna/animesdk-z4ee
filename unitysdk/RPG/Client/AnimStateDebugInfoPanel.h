...
#define RPG_CLIENT_ANIMSTATEDEBUGINFOPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBD89CE0)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimStateDebugInfoPanel_TypeDefinitionIndex = 69430;
