...
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_CREATE_OFFSET UNITYSDK_OFFSET(0xBF38880)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_GET_RESULTEFFECTDATA_OFFSET UNITYSDK_OFFSET(0xBF38FB0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_GET_RESULTEFFECTINDEX_OFFSET UNITYSDK_OFFSET(0xBF38FD0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_GET_SELECTEDINDEXINVOTESOFRESULTEFFECT_OFFSET UNITYSDK_OFFSET(0xBF38FF0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_SET_RESULTEFFECTDATA_OFFSET UNITYSDK_OFFSET(0xBF38FC0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_SET_RESULTEFFECTINDEX_OFFSET UNITYSDK_OFFSET(0xBF38FE0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_SET_SELECTEDINDEXINVOTESOFRESULTEFFECT_OFFSET UNITYSDK_OFFSET(0xBF39000)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xBF38FA0)
