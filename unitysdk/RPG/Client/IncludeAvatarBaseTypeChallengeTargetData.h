...
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_CALCULATETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xC8D8D90)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_GETNAMEPARAM_OFFSET UNITYSDK_OFFSET(0xC8D9140)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_SETCHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xC8D90B0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_UPDATECHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xC8D8BF0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA__CHECKINCLUDEBASICTYPE_OFFSET UNITYSDK_OFFSET(0xC8D8E50)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC8D8AF0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA__UPDATECHALLENGETARGETSTATE_B__1_0_OFFSET UNITYSDK_OFFSET(0xC8D9340)
