...
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD7FD490)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0xD7FECA0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xD7FF4C0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_422AB1A19F04E217_OFFSET UNITYSDK_OFFSET(0xD7FDC00)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_755870B55A8B3AFF_OFFSET UNITYSDK_OFFSET(0xD7FE2E0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_CCFFC97FF79A551F_OFFSET UNITYSDK_OFFSET(0xD7FD5F0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_RESET_OFFSET UNITYSDK_OFFSET(0xD7FF6E0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETDISABLEUIBLURTWEEN_OFFSET UNITYSDK_OFFSET(0xD7FF690)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETUIMETA_OFFSET UNITYSDK_OFFSET(0xD7FD850)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7FF930)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0xD7FFE60)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN__UPDATEBLURPARAMS_G__FILLPARTIALBLURAREA_25_0_OFFSET UNITYSDK_OFFSET(0xD7FF990)

namespace RPG::Client
{
	inline static constexpr unsigned int UIPostProcessTween_TypeDefinitionIndex = 69741;
	...
	public:
		...
		{
			return (::RPG::Client::UIPostProcessTween**)Il2CppClass::FromTypeDefinitionIndex(UIPostProcessTween_TypeDefinitionIndex)->GetStaticField(0x51240);
		}
