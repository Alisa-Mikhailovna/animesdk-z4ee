...
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_AWAKE_OFFSET UNITYSDK_OFFSET(0xC346E20)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_METHOD_5_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0xC347740)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_METHOD_5_9D4EC0959ED23C46_OFFSET UNITYSDK_OFFSET(0xC347260)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_METHOD_5_B469A1C3583AE516_OFFSET UNITYSDK_OFFSET(0xC347430)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC346EE0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xC346FA0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS__CTOR_OFFSET UNITYSDK_OFFSET(0xC347810)
