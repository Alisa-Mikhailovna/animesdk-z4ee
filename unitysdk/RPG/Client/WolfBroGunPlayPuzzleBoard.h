...
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ADDSCORE_OFFSET UNITYSDK_OFFSET(0xD8B0330)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_BUILDARRAYINFO_OFFSET UNITYSDK_OFFSET(0xD8B14B0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_BUILDGAMEPLAYINFO_OFFSET UNITYSDK_OFFSET(0xD8B1020)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_CONTROLWOLFBROPLAYER_OFFSET UNITYSDK_OFFSET(0xD8AA710)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_DELSCORE_OFFSET UNITYSDK_OFFSET(0xD8B0460)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_DISABLEBULLETTIME_OFFSET UNITYSDK_OFFSET(0xD8AEFC0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD8AEC20)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ENABLEBULLETTIME_OFFSET UNITYSDK_OFFSET(0xD8AF630)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_EVALUATECOUNTDOWNSCORE_OFFSET UNITYSDK_OFFSET(0xD8AD5A0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_EVALUATEDELSCORE_OFFSET UNITYSDK_OFFSET(0xD8AD2A0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_EVALUATESCORE_OFFSET UNITYSDK_OFFSET(0xD8ACA40)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GETTARGETSCORE_OFFSET UNITYSDK_OFFSET(0xD8B0E10)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD8A9E80)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_MAINROADMAPNAME_OFFSET UNITYSDK_OFFSET(0xD8B1720)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_PLAYERCONTROLLER_OFFSET UNITYSDK_OFFSET(0xD8B1730)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0xD8B1740)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_SCORE_OFFSET UNITYSDK_OFFSET(0xD8AC9F0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0xD8B17A0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET__REALSCORE_OFFSET UNITYSDK_OFFSET(0xD8B0640)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD8AA060)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ISSUCCESS_1_OFFSET UNITYSDK_OFFSET(0xD8AD7E0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0xD8B0DB0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_MODIFYENERGY_OFFSET UNITYSDK_OFFSET(0xD8AB0D0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD8A9EF0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xD8A9F80)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD8A9EA0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xD8AA4F0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REPORTGAMEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xD8AD9D0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REPORTGAMEPLAYSTARTUP_OFFSET UNITYSDK_OFFSET(0xD8AB260)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REPORTGAMEPLAYUSESKILL_OFFSET UNITYSDK_OFFSET(0xD8AF970)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_RESETSCORE_OFFSET UNITYSDK_OFFSET(0xD8B17C0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SETUPSTARTMODE_OFFSET UNITYSDK_OFFSET(0xD8B0590)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SETUPTIMELINEENABLE_OFFSET UNITYSDK_OFFSET(0xD8AF4F0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD8A9E90)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0xD8B17B0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SET__REALSCORE_OFFSET UNITYSDK_OFFSET(0xD8ABA50)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD8AAA90)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xD8ABAC0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TICK_OFFSET UNITYSDK_OFFSET(0xD8ABE90)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TRIGGERBULLETTIMEKILLQUEST_OFFSET UNITYSDK_OFFSET(0xD8B0170)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TRIGGERFINISHQUEST_OFFSET UNITYSDK_OFFSET(0xD8AD890)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_UNREGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xD8AF2D0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD8B18E0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONCLICKSHOOT_OFFSET UNITYSDK_OFFSET(0xD8B0690)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONCLICKSKILL_OFFSET UNITYSDK_OFFSET(0xD8B0760)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONEXITGAME_OFFSET UNITYSDK_OFFSET(0xD8B0B80)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONPAUSEGAME_OFFSET UNITYSDK_OFFSET(0xD8B07F0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONPLAYGAME_OFFSET UNITYSDK_OFFSET(0xD8B0910)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONREPLAYGAME_OFFSET UNITYSDK_OFFSET(0xD8B0A30)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::WolfBroGunPlayPuzzleBoard**)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x29BF0);
		}
		static ::System::UInt32* StaticGet__REPLAY_MODE()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7A90);
		}
		static ::RPG::Client::WolfBroGunPlayPuzzleBoard_ReplaySaveData* StaticGet__REPLAY_SAVE_DATA()
		{
			return (::RPG::Client::WolfBroGunPlayPuzzleBoard_ReplaySaveData*)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7A94);
		}
