...
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xBF190C0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_CATID_OFFSET UNITYSDK_OFFSET(0xBF19900)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_ISPLAYERUSE_OFFSET UNITYSDK_OFFSET(0xBF199A0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0xBF1A140)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xBF1A1B0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBF19110)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xBF1A150)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xBF1A0F0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xBF1A0E0)
