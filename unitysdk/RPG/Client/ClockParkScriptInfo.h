...
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_GET_CHAPTERINFO_OFFSET UNITYSDK_OFFSET(0xC188600)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_GET_CHAPTERPATHLIST_OFFSET UNITYSDK_OFFSET(0xC188800)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_GET_ENDLESSSCORE_OFFSET UNITYSDK_OFFSET(0xC1887E0)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_GET_ISINENDLESS_OFFSET UNITYSDK_OFFSET(0xC188780)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_GET_ISSHOWSCRIPTLOADINGPAGE_OFFSET UNITYSDK_OFFSET(0xC188620)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_GET_SCRIPTID_OFFSET UNITYSDK_OFFSET(0xC1885E0)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_ISCHAPTERPASSED_OFFSET UNITYSDK_OFFSET(0xC188280)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_SET_CHAPTERINFO_OFFSET UNITYSDK_OFFSET(0xC188610)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_SET_CHAPTERPATHLIST_OFFSET UNITYSDK_OFFSET(0xC188810)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_SET_ENDLESSSCORE_OFFSET UNITYSDK_OFFSET(0xC1887F0)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_SET_SCRIPTID_OFFSET UNITYSDK_OFFSET(0xC1885F0)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_SYNCCHAPTER_OFFSET UNITYSDK_OFFSET(0xC180C90)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO_SYNCENDLESSSCORE_OFFSET UNITYSDK_OFFSET(0xC180D50)
#define RPG_CLIENT_CLOCKPARKSCRIPTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC17FAC0)
