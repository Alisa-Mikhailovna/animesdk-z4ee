...
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETCHALLENGESTATUS_OFFSET UNITYSDK_OFFSET(0xD741F80)
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETISSAVE_OFFSET UNITYSDK_OFFSET(0xD742010)
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETRAIDID_OFFSET UNITYSDK_OFFSET(0xD741F00)
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETWORLDLV_OFFSET UNITYSDK_OFFSET(0xD741F40)
#define RPG_CLIENT_TREASURECHALLENGEDATA_SETCHALLENGESTATUS_OFFSET UNITYSDK_OFFSET(0xD741FC0)
#define RPG_CLIENT_TREASURECHALLENGEDATA_SETISSAVE_OFFSET UNITYSDK_OFFSET(0xD742050)
#define RPG_CLIENT_TREASURECHALLENGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD741EF0)
