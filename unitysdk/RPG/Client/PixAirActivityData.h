...
#define RPG_CLIENT_PIXAIRACTIVITYDATA_ISSHOWGOTOBTNREDDOT_OFFSET UNITYSDK_OFFSET(0xCFE6BE0)
#define RPG_CLIENT_PIXAIRACTIVITYDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xCFE6C40)
#define RPG_CLIENT_PIXAIRACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xCFE69C0)
#define RPG_CLIENT_PIXAIRACTIVITYDATA_ISSHOWTIMELIMITREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xCFE6A50)
#define RPG_CLIENT_PIXAIRACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE69A0)
#define RPG_CLIENT_PIXAIRACTIVITYDATA__ISSHOWRESIDENTREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xCFE6B40)
