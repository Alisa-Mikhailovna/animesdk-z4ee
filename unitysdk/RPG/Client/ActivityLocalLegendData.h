...
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_CLEARNEW_OFFSET UNITYSDK_OFFSET(0xBBF9DC0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GETALLEASYANDHARDCHALLENGED_OFFSET UNITYSDK_OFFSET(0xBBF96F0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GETFINISHEDSTARNUM_OFFSET UNITYSDK_OFFSET(0xBBF8D60)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GETLATESTUNLOCKLEVEL_OFFSET UNITYSDK_OFFSET(0xBBF93E0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GETLEVELDATA_OFFSET UNITYSDK_OFFSET(0xBBF88A0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GETSHOWRANKFORHISTORY_OFFSET UNITYSDK_OFFSET(0xBBF9070)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_CHALLENGESTRATEGY_OFFSET UNITYSDK_OFFSET(0xBBF9FF0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_GROUPICON_OFFSET UNITYSDK_OFFSET(0xBBF9EC0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xBBFA120)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_GROUPTITLE_OFFSET UNITYSDK_OFFSET(0xBBF9E50)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_HISTORYMAXPASSDIFFICULTY_OFFSET UNITYSDK_OFFSET(0xBBFA240)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_ISSEEN_OFFSET UNITYSDK_OFFSET(0xBBFA4A0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_ISUNLOCKANIMSEEN_OFFSET UNITYSDK_OFFSET(0xBBFA5A0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xBBF9990)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0xBBFA160)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_SHOWREDDOT_OFFSET UNITYSDK_OFFSET(0xBBFA260)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_STAGEMECHANISMTITLE_OFFSET UNITYSDK_OFFSET(0xBBF9F10)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_STAGEMECHANISM_OFFSET UNITYSDK_OFFSET(0xBBF9F80)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_TEAMBUILDTIP_OFFSET UNITYSDK_OFFSET(0xBBFA060)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_GET_TUTORIALGUIDEID_OFFSET UNITYSDK_OFFSET(0xBBFA0D0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_SET_HISTORYMAXPASSDIFFICULTY_OFFSET UNITYSDK_OFFSET(0xBBFA250)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_SET_ISSEEN_OFFSET UNITYSDK_OFFSET(0xBBF8B80)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_SET_ISUNLOCKANIMSEEN_OFFSET UNITYSDK_OFFSET(0xBBFA6C0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA_SYNCGROUPINFO_OFFSET UNITYSDK_OFFSET(0xBBF8680)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBBF7F40)
