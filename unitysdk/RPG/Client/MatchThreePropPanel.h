...
#define RPG_CLIENT_MATCHTHREEPROPPANEL_AWAKE_OFFSET UNITYSDK_OFFSET(0xCB60EF0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ITEMPANELS_OFFSET UNITYSDK_OFFSET(0xCB60E70)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ONBUTTONCANCEL_OFFSET UNITYSDK_OFFSET(0xCB60ED0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ONBUTTONOK_OFFSET UNITYSDK_OFFSET(0xCB60EB0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ONPROPUSE_OFFSET UNITYSDK_OFFSET(0xCB60E90)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_HIDECONTROLS_OFFSET UNITYSDK_OFFSET(0xCB61910)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xCB61030)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ITEMPANELS_OFFSET UNITYSDK_OFFSET(0xCB60E80)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ONBUTTONCANCEL_OFFSET UNITYSDK_OFFSET(0xCB60EE0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ONBUTTONOK_OFFSET UNITYSDK_OFFSET(0xCB60EC0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ONPROPUSE_OFFSET UNITYSDK_OFFSET(0xCB60EA0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SHOWCONTROLS_OFFSET UNITYSDK_OFFSET(0xCB61970)
#define RPG_CLIENT_MATCHTHREEPROPPANEL__AWAKE_B__23_0_OFFSET UNITYSDK_OFFSET(0xCB61A20)
#define RPG_CLIENT_MATCHTHREEPROPPANEL__AWAKE_B__23_1_OFFSET UNITYSDK_OFFSET(0xCB61A40)
#define RPG_CLIENT_MATCHTHREEPROPPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB619D0)
