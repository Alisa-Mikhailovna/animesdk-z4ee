...
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_APPENDBATTLEAREABLOCKROOT_OFFSET UNITYSDK_OFFSET(0xC915A60)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_GET_BASEOFFSET_OFFSET UNITYSDK_OFFSET(0xC915B60)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_HIDESTAGE_OFFSET UNITYSDK_OFFSET(0xC915520)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_INITORIGINPOS_OFFSET UNITYSDK_OFFSET(0xC9156B0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_INITROTATION_OFFSET UNITYSDK_OFFSET(0xC915720)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC914FD0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC9153A0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_MOVESTAGETOTARGET_OFFSET UNITYSDK_OFFSET(0xC915820)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_ONBATTLEFINISH_OFFSET UNITYSDK_OFFSET(0xC915920)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC9152E0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_RESETSTAGEPOS_OFFSET UNITYSDK_OFFSET(0xC915990)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_SETBASEOFFSET_OFFSET UNITYSDK_OFFSET(0xC9157A0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_SETOWNERBLOCK_OFFSET UNITYSDK_OFFSET(0xC915350)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_SHOWSTAGEIFHIDE_OFFSET UNITYSDK_OFFSET(0xC915460)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_SHOWSTAGE_OFFSET UNITYSDK_OFFSET(0xC915160)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9150D0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC915B80)
