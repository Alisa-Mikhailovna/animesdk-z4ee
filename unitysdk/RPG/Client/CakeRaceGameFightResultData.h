...
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBF1F1C0)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_GETRANKENDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0xBF1F3E0)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_GET_CURRENTSECTION_OFFSET UNITYSDK_OFFSET(0xBF1F100)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_GET_FIGHTRESULTCATDATALIST_OFFSET UNITYSDK_OFFSET(0xBF0FFB0)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_GET_LASTSELFGAMERANKINDEX_OFFSET UNITYSDK_OFFSET(0xBF1F1A0)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0xBF1F150)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_GET_SORTEDPARTICIPANTDATALIST_OFFSET UNITYSDK_OFFSET(0xBF0EF30)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_SETLASTSELFGAMERANKINDEX_OFFSET UNITYSDK_OFFSET(0xBF0EEE0)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_SET_LASTSELFGAMERANKINDEX_OFFSET UNITYSDK_OFFSET(0xBF1F1B0)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA_TRYREFRESHOFFLINEPARTICIPANT_OFFSET UNITYSDK_OFFSET(0xBF23C10)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBF1F290)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA__INITCATDATALIST_OFFSET UNITYSDK_OFFSET(0xBF22590)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA__INITPARTICIPANTDATAMAP_OFFSET UNITYSDK_OFFSET(0xBF1F630)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA__INITSORTEDPARTICIPANTLIST_OFFSET UNITYSDK_OFFSET(0xBF22D80)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA__INIT_OFFSET UNITYSDK_OFFSET(0xBF1F380)
#define RPG_CLIENT_CAKERACEGAMEFIGHTRESULTDATA__SETOFFLINEPARTICIPANT_OFFSET UNITYSDK_OFFSET(0xBF23C60)
