...
#define RPG_CLIENT_CHALLENGERECOMMENDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBFC3A00)
#define RPG_CLIENT_CHALLENGERECOMMENDDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBFC3CA0)
#define RPG_CLIENT_CHALLENGERECOMMENDDATA_GET_FRIENDRECOMMENDLINEUPDATA_OFFSET UNITYSDK_OFFSET(0xBFC3900)
#define RPG_CLIENT_CHALLENGERECOMMENDDATA_GET_STATISTICRECOMMENDLINEUPDATA_OFFSET UNITYSDK_OFFSET(0xBFC3920)
#define RPG_CLIENT_CHALLENGERECOMMENDDATA_ISCHALLENGERECOMMENDFEATUREOPEN_OFFSET UNITYSDK_OFFSET(0xBFC3AC0)
#define RPG_CLIENT_CHALLENGERECOMMENDDATA_RESETDATA_OFFSET UNITYSDK_OFFSET(0xBFC3BA0)
#define RPG_CLIENT_CHALLENGERECOMMENDDATA_SET_FRIENDRECOMMENDLINEUPDATA_OFFSET UNITYSDK_OFFSET(0xBFC3910)
#define RPG_CLIENT_CHALLENGERECOMMENDDATA_SET_STATISTICRECOMMENDLINEUPDATA_OFFSET UNITYSDK_OFFSET(0xBFC3930)
#define RPG_CLIENT_CHALLENGERECOMMENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBFC3940)
