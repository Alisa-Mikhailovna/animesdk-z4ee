...
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_CLEARLATETICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xCD13730)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_CLEARTICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xCD13620)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCD13900)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCD13820)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD139B0)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_SETLATETICKCALLBACK_1_OFFSET UNITYSDK_OFFSET(0xCD136D0)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_SETLATETICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xCD13670)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_SETTICKCALLBACK_1_OFFSET UNITYSDK_OFFSET(0xCD135C0)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_SETTICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xCD13560)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCD138C0)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD13780)
#define RPG_CLIENT_MONOPERFORMANCEUITRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD13A60)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPerformanceUITransfer_TypeDefinitionIndex = 69310;
