...
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC47650)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_FINDEDGEBYCURVE_OFFSET UNITYSDK_OFFSET(0xCC482A0)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_FINDEDGEBYNAME_OFFSET UNITYSDK_OFFSET(0xCC454F0)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_METHOD_5_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0xCC47720)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCC481C0)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0xCC483C0)
