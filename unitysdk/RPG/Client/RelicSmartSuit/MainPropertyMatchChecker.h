...
#define RPG_CLIENT_RELICSMARTSUIT_MAINPROPERTYMATCHCHECKER_CREATE_OFFSET UNITYSDK_OFFSET(0xD2FA030)
#define RPG_CLIENT_RELICSMARTSUIT_MAINPROPERTYMATCHCHECKER_ISMAINPROPERTYMATCH_1_OFFSET UNITYSDK_OFFSET(0xD2FA110)
#define RPG_CLIENT_RELICSMARTSUIT_MAINPROPERTYMATCHCHECKER_ISMAINPROPERTYMATCH_2_OFFSET UNITYSDK_OFFSET(0xD2FA390)
#define RPG_CLIENT_RELICSMARTSUIT_MAINPROPERTYMATCHCHECKER_ISMAINPROPERTYMATCH_OFFSET UNITYSDK_OFFSET(0xD2FA0B0)
#define RPG_CLIENT_RELICSMARTSUIT_MAINPROPERTYMATCHCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2FA0A0)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int MainPropertyMatchChecker_TypeDefinitionIndex = 70993;
