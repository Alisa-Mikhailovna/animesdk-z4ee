...
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_CREATE_OFFSET UNITYSDK_OFFSET(0xD306F80)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GETPINNEDUID_OFFSET UNITYSDK_OFFSET(0xD307280)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GET_DATASOURCE_OFFSET UNITYSDK_OFFSET(0xD306E90)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GET_PININFORECORDER_OFFSET UNITYSDK_OFFSET(0xD306DD0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GET_PLANRESULT_OFFSET UNITYSDK_OFFSET(0xD306EE0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GET_SELECTINFO_OFFSET UNITYSDK_OFFSET(0xD306F30)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_ISPINNED_OFFSET UNITYSDK_OFFSET(0xD3071B0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_PINORUNPINRELIC_OFFSET UNITYSDK_OFFSET(0xD307310)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_PINRELIC_OFFSET UNITYSDK_OFFSET(0xD307880)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_UNPINRELIC_OFFSET UNITYSDK_OFFSET(0xD307460)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD307000)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__GETCLONEPINDATA_OFFSET UNITYSDK_OFFSET(0xD307F30)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__INITPINCHECKER_OFFSET UNITYSDK_OFFSET(0xD3070F0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__INIT_OFFSET UNITYSDK_OFFSET(0xD307010)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__NOTIFYMODIFYPIN_OFFSET UNITYSDK_OFFSET(0xD308920)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__PINRELIC_B__17_0_OFFSET UNITYSDK_OFFSET(0xD3089C0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__REQUESTMODIFYPINRELIC_OFFSET UNITYSDK_OFFSET(0xD3082D0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__UNPINRELIC_B__18_0_OFFSET UNITYSDK_OFFSET(0xD308BF0)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int RelicSmartSuitComparePinOperator_TypeDefinitionIndex = 71002;
