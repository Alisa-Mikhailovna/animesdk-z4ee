...
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCB0400)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCB06A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_GET_MIRRORFOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCCB2700)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_MANUALLYUPDATECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xCCB1130)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_27266CF5C6A3D539_OFFSET UNITYSDK_OFFSET(0xCCB2510)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_743CCE653F5EA979_OFFSET UNITYSDK_OFFSET(0xCCB1300)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_ACAF19E8DD89168C_OFFSET UNITYSDK_OFFSET(0xCCB1D70)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_C20670991DA7E1D3_OFFSET UNITYSDK_OFFSET(0xCCB1B30)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0xCCB0D80)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCB04C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_SETUPFORMODELCAPTURE_OFFSET UNITYSDK_OFFSET(0xCCB1950)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_SETUP_OFFSET UNITYSDK_OFFSET(0xCCB1180)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_TICK_OFFSET UNITYSDK_OFFSET(0xCCB0880)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCCB2760)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL___GETAIMTARGET_G___GETPOS_8_0_OFFSET UNITYSDK_OFFSET(0xCCB2090)
