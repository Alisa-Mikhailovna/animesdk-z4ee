...
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_CANUNLOCKED_OFFSET UNITYSDK_OFFSET(0xBE15750)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_COMPARETO_OFFSET UNITYSDK_OFFSET(0xBE15E40)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GETUNLOCKDESC_OFFSET UNITYSDK_OFFSET(0xBE15FA0)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GETVOICECONTENT_OFFSET UNITYSDK_OFFSET(0xBE15970)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_ISHIDE_OFFSET UNITYSDK_OFFSET(0xBE160A0)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0xBE16050)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_REPLACEENTRY_OFFSET UNITYSDK_OFFSET(0xBE16180)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_REPLACEID_OFFSET UNITYSDK_OFFSET(0xBE16100)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_ROW_OFFSET UNITYSDK_OFFSET(0xBE15820)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_SORTID_OFFSET UNITYSDK_OFFSET(0xBE15F00)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_POSTVOICE_OFFSET UNITYSDK_OFFSET(0xBE15A30)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_SET_ISHIDE_OFFSET UNITYSDK_OFFSET(0xBE15920)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_SET_REPLACEENTRY_OFFSET UNITYSDK_OFFSET(0xBE16190)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_STOPPLAYINGVOICE_OFFSET UNITYSDK_OFFSET(0xBE15DA0)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_UNLOCK_OFFSET UNITYSDK_OFFSET(0xBE15890)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xBE161A0)
