...
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_ADDONEMATERIALBLOCK_OFFSET UNITYSDK_OFFSET(0xCB862C0)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xCB866D0)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCB86280)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_ENDLODTRANSITION_OFFSET UNITYSDK_OFFSET(0xCB85C70)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_METHOD_6_0868EF727040C390_OFFSET UNITYSDK_OFFSET(0xCB86E80)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_METHOD_6_6A4774248EB22533_OFFSET UNITYSDK_OFFSET(0xCB86540)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_METHOD_6_8B4B595B09EC9421_OFFSET UNITYSDK_OFFSET(0xCB87000)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_METHOD_6_DB67EEFB041425EC_OFFSET UNITYSDK_OFFSET(0xCB85E10)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_METHOD_6_E0752335E9613972_OFFSET UNITYSDK_OFFSET(0xCB878B0)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCB86780)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0xCB85C00)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0xCB857C0)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_RESET_OFFSET UNITYSDK_OFFSET(0xCB86930)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_SETMATERIALBLOCKEFFECTACTIVE_OFFSET UNITYSDK_OFFSET(0xCB86830)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCB85DC0)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_STARTLODTRANSITION_OFFSET UNITYSDK_OFFSET(0xCB858D0)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_TICK_OFFSET UNITYSDK_OFFSET(0xCB86A90)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_UPDATEKEYWORDDATA_OFFSET UNITYSDK_OFFSET(0xCB87680)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_UPDATEPROPERTYDATA_1_OFFSET UNITYSDK_OFFSET(0xCB87370)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_UPDATEPROPERTYDATA_2_OFFSET UNITYSDK_OFFSET(0xCB874E0)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE_UPDATEPROPERTYDATA_OFFSET UNITYSDK_OFFSET(0xCB871F0)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0xCB87A60)
#define RPG_CLIENT_MATERIALBLOCKEFFECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB87A50)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(MaterialBlockEffectBase_TypeDefinitionIndex)->GetStaticField(0x4DA00);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_EffectPropertyIDs()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MaterialBlockEffectBase_TypeDefinitionIndex)->GetStaticField(0x4DA08);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_EffectPropertyNames()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialBlockEffectBase_TypeDefinitionIndex)->GetStaticField(0x4DA10);
		}
