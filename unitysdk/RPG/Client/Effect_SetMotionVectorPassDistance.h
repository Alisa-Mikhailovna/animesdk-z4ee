...
#define RPG_CLIENT_EFFECT_SETMOTIONVECTORPASSDISTANCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC3450D0)
#define RPG_CLIENT_EFFECT_SETMOTIONVECTORPASSDISTANCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC344F10)
#define RPG_CLIENT_EFFECT_SETMOTIONVECTORPASSDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xC3451D0)
