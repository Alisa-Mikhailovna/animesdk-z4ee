...
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC1CEF10)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_CURVE_OFFSET UNITYSDK_OFFSET(0xC1CDC70)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xC1CDC90)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0xC1CDC50)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_MATH_OFFSET UNITYSDK_OFFSET(0xC1CDC80)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC1CDC60)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_31661521E6BA1690_OFFSET UNITYSDK_OFFSET(0xC1CE8A0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_4ACC2F8684BE1D57_OFFSET UNITYSDK_OFFSET(0xC1CDF70)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_6D4EED649DB90654_OFFSET UNITYSDK_OFFSET(0xC1CE460)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_729D7865C768EDB3_OFFSET UNITYSDK_OFFSET(0xC1CE000)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_7EEC86D7A31C7C87_OFFSET UNITYSDK_OFFSET(0xC1CE660)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_A1EB2E3ADE286198_OFFSET UNITYSDK_OFFSET(0xC1CE4E0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_AED8C4825531973B_OFFSET UNITYSDK_OFFSET(0xC1CE790)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_AFC0AF10542FE0A9_OFFSET UNITYSDK_OFFSET(0xC1CE290)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_C73CBB2E1F3BBA7B_OFFSET UNITYSDK_OFFSET(0xC1CE0F0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_D3BDE5E15DE6058C_OFFSET UNITYSDK_OFFSET(0xC1CE200)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_D9E7614FB85246A5_OFFSET UNITYSDK_OFFSET(0xC1CEF50)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC1CEED0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC1CDCF0)
