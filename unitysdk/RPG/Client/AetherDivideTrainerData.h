...
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBCEB550)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_GETAETHERCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0xBCEEFA0)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_GETDISPLAYQUESTDATALIST_OFFSET UNITYSDK_OFFSET(0xBCEF2E0)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_GETDISPLAYTRAINERLEVELROWLIST_OFFSET UNITYSDK_OFFSET(0xBCEF030)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_GETREWARDDATA_OFFSET UNITYSDK_OFFSET(0xBCEDC20)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_GETSORTEDQUESTDATALIST_OFFSET UNITYSDK_OFFSET(0xBCEF380)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_GETTRAINERLEVELROW_OFFSET UNITYSDK_OFFSET(0xBCEF270)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_GET_TRAINERLEVELROW_OFFSET UNITYSDK_OFFSET(0xBCEA1F0)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_GET_TRAINERLEVEL_OFFSET UNITYSDK_OFFSET(0xBCEF500)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_REFRESH_OFFSET UNITYSDK_OFFSET(0xBCED9A0)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_SET_TRAINERLEVEL_OFFSET UNITYSDK_OFFSET(0xBCEF510)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA_UPDATEBYSERVER_OFFSET UNITYSDK_OFFSET(0xBCED2F0)
#define RPG_CLIENT_AETHERDIVIDETRAINERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBCEAD70)
