...
#define RPG_CLIENT_MONOPOLYSHOPDATAITEM_GET_GOODSLIST_OFFSET UNITYSDK_OFFSET(0xCD6B2E0)
#define RPG_CLIENT_MONOPOLYSHOPDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xCD6B2C0)
#define RPG_CLIENT_MONOPOLYSHOPDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCD6B260)
#define RPG_CLIENT_MONOPOLYSHOPDATAITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0xCD6B2D0)
#define RPG_CLIENT_MONOPOLYSHOPDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD6B250)
