...
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD01590)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM_EXECUTEMOVE_OFFSET UNITYSDK_OFFSET(0xCD01FF0)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM_INIT_OFFSET UNITYSDK_OFFSET(0xCD01860)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD01710)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM_STANDBY_OFFSET UNITYSDK_OFFSET(0xCD018D0)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM__ADJUSTSCROLLRECTPOSITION_OFFSET UNITYSDK_OFFSET(0xCD01D80)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD02A00)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM__GETSHOWINGINDEXBYTARGETINDEXFORFOCUS_OFFSET UNITYSDK_OFFSET(0xCD02400)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM__GETSHOWINGINDEXBYTARGETINDEX_OFFSET UNITYSDK_OFFSET(0xCD027F0)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM__MOVEFOCUSITEM_OFFSET UNITYSDK_OFFSET(0xCD02470)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM__MOVEITEMIMMEDIATE_OFFSET UNITYSDK_OFFSET(0xCD01F00)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM__MOVEITEM_OFFSET UNITYSDK_OFFSET(0xCD02860)
#define RPG_CLIENT_MONOLISTMULTIMOVEANIM__RECORDPOSITIONS_OFFSET UNITYSDK_OFFSET(0xCD01B70)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoListMultiMoveAnim_TypeDefinitionIndex = 69300;
