...
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_CHECKQUADVALID_OFFSET UNITYSDK_OFFSET(0xCF75470)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_CHECKRAYCASTPASS_OFFSET UNITYSDK_OFFSET(0xCF762B0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_CHECKSINGLEPOSARRAY_OFFSET UNITYSDK_OFFSET(0xCF74DB0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_CHECKVISIBLE_OFFSET UNITYSDK_OFFSET(0xCF743D0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_DETECTINTERSECTWITHVIEWPORT_OFFSET UNITYSDK_OFFSET(0xCF76070)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_DETECTRAYCASTPASS_OFFSET UNITYSDK_OFFSET(0xCF75190)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_DRAWPOS_OFFSET UNITYSDK_OFFSET(0xCF750F0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_GENCHECKARRAY_OFFSET UNITYSDK_OFFSET(0xCF73D70)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_GETDETECTPOINTS_OFFSET UNITYSDK_OFFSET(0xCF76680)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_LINESEGMENTSINTERSECT_OFFSET UNITYSDK_OFFSET(0xCF764E0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_SINGLEAXISFLOATTOVIEWSTATE_OFFSET UNITYSDK_OFFSET(0xCF73CF0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_START_OFFSET UNITYSDK_OFFSET(0xCF73C10)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_UPDATE_OFFSET UNITYSDK_OFFSET(0xCF769A0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW__CTOR_OFFSET UNITYSDK_OFFSET(0xCF76A30)
