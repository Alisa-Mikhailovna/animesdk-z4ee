...
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETCURRESOLUTIONENEMYDICEHOLDOFFSETY_OFFSET UNITYSDK_OFFSET(0xC2A55D0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETINITANGLEVELOCITY_OFFSET UNITYSDK_OFFSET(0xC2A4850)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETINITPOSITIONRANDOMOFFSET_OFFSET UNITYSDK_OFFSET(0xC2A4910)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETINITVELOCITY_OFFSET UNITYSDK_OFFSET(0xC2A4790)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETPOSITIONDELTA_OFFSET UNITYSDK_OFFSET(0xC2A49D0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETPOSOFFSETBYDICETYPE_OFFSET UNITYSDK_OFFSET(0xC2A4A60)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETROTOFFSETBYDICETYPE_OFFSET UNITYSDK_OFFSET(0xC2A4D00)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETUIPOSYOFFSETBYDICETYPE_OFFSET UNITYSDK_OFFSET(0xC2A4FA0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_1_OFFSET UNITYSDK_OFFSET(0xC2A5270)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_2_OFFSET UNITYSDK_OFFSET(0xC2A5150)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_3_OFFSET UNITYSDK_OFFSET(0xC2A54B0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_OFFSET UNITYSDK_OFFSET(0xC2A5390)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FC5102551AF3CB1A_OFFSET UNITYSDK_OFFSET(0xC2A56F0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2A57A0)
