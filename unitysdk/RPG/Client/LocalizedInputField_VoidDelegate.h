...
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_VOIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xCA02F60)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_VOIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xCA02F90)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_VOIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xCA022C0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_VOIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCA02EF0)

namespace RPG::Client
{
	inline static constexpr unsigned int LocalizedInputField_VoidDelegate_TypeDefinitionIndex = 69281;
