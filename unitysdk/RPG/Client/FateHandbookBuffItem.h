...
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xC4674B0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_ALLLEVELBUFFPREVIEWDICT_OFFSET UNITYSDK_OFFSET(0xC467F30)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xC4675E0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFICONPATH_OFFSET UNITYSDK_OFFSET(0xC467B00)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0xC4675A0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0xC4675C0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFNAME_OFFSET UNITYSDK_OFFSET(0xC467910)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_EXTRAEFFECTARRAY_OFFSET UNITYSDK_OFFSET(0xC468060)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_MAINTRAITDATA_OFFSET UNITYSDK_OFFSET(0xC4676B0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xC467C90)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_SELLPRICE_OFFSET UNITYSDK_OFFSET(0xC467E00)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_SUBTRAITDATA_OFFSET UNITYSDK_OFFSET(0xC4677E0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_SET_BUFFID_OFFSET UNITYSDK_OFFSET(0xC4675B0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_SET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0xC4675D0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC467590)
