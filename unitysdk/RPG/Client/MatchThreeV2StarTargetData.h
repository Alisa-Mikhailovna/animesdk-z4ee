...
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCB842E0)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xCB84030)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET_FINISHPARAMLIST_OFFSET UNITYSDK_OFFSET(0xCB84230)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET_FINISHTYPE_OFFSET UNITYSDK_OFFSET(0xCB84190)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xCB840F0)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCB83FD0)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_ISBIRDMEETTARGET_OFFSET UNITYSDK_OFFSET(0xCB84340)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_ISPROPMEETTARGET_OFFSET UNITYSDK_OFFSET(0xCB84400)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCB842D0)
