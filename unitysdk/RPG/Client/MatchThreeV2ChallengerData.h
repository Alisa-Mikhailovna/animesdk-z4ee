...
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCB6CD40)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_GET_DEFEATREWARDPROPID_OFFSET UNITYSDK_OFFSET(0xCB6CB70)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xCB6C960)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_GET_GAMELEVELID_OFFSET UNITYSDK_OFFSET(0xCB6CAC0)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_GET_GAMELEVEL_OFFSET UNITYSDK_OFFSET(0xCB6CB60)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xCB6CA20)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCB6C8A0)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_GET_STARTARGETS_OFFSET UNITYSDK_OFFSET(0xCB6CC10)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_GET_TOTALSTARTARGETCOUNT_OFFSET UNITYSDK_OFFSET(0xCB6CC20)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCB6C840)
#define RPG_CLIENT_MATCHTHREEV2CHALLENGERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCB6CC70)
