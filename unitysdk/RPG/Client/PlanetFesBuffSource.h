...
#define RPG_CLIENT_PLANETFESBUFFSOURCE_CREATE_1_OFFSET UNITYSDK_OFFSET(0xCFFF660)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_CREATE_OFFSET UNITYSDK_OFFSET(0xCFFF5D0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xCFFF740)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_EQUALS_OFFSET UNITYSDK_OFFSET(0xCFFF6B0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xCFFF810)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GET_ICON_OFFSET UNITYSDK_OFFSET(0xCFFFAD0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GET_ID_OFFSET UNITYSDK_OFFSET(0xCFFF890)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0xCFFFA60)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GET_SOURCETYPE_OFFSET UNITYSDK_OFFSET(0xCFFFA10)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xCFFF8E0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xCFFF9B0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFF650)
