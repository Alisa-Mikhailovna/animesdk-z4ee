...
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER_STARTFADE_OFFSET UNITYSDK_OFFSET(0xCF5C1A0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xCF5BD60)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCF5BE10)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCF5C3B0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__ONFADEOUTFINISH_OFFSET UNITYSDK_OFFSET(0xCF5C050)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__STARTFADEIN_OFFSET UNITYSDK_OFFSET(0xCF5C2D0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__STARTFADEOUT_OFFSET UNITYSDK_OFFSET(0xCF5C340)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER___ONFADEOUTFINISH_B__5_0_OFFSET UNITYSDK_OFFSET(0xCF5C3C0)

namespace RPG::Client
{
	inline static constexpr unsigned int PerformanceRollingSubtitlesFadeController_TypeDefinitionIndex = 69542;
