...
#define RPG_CLIENT_MONOINPUTICONTIP_AWAKE_OFFSET UNITYSDK_OFFSET(0xCCFDF30)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_460ED92A9D08B0B6_OFFSET UNITYSDK_OFFSET(0xCCFE230)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_99770A90CCA648B7_OFFSET UNITYSDK_OFFSET(0xCCFE1E0)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xCCFE4C0)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_BF622B900A7F3625_OFFSET UNITYSDK_OFFSET(0xCCFE040)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_D32194AE7B33706F_OFFSET UNITYSDK_OFFSET(0xCCFE570)
#define RPG_CLIENT_MONOINPUTICONTIP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCCFE100)
#define RPG_CLIENT_MONOINPUTICONTIP__CTOR_OFFSET UNITYSDK_OFFSET(0xCCFE690)
