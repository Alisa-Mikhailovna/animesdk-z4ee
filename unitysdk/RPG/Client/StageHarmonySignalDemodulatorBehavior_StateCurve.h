...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_GET_ONESTEPDURATION_OFFSET UNITYSDK_OFFSET(0xD545870)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_5D3A3EE49803D6C0_OFFSET UNITYSDK_OFFSET(0xD545570)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_6F7271C62F1FE776_OFFSET UNITYSDK_OFFSET(0xD545910)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_854CAFC5FADAC24E_OFFSET UNITYSDK_OFFSET(0xD5454D0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD545830)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD545520)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_D225EBCFE9DF5FDA_OFFSET UNITYSDK_OFFSET(0xD5455F0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xD545D00)
