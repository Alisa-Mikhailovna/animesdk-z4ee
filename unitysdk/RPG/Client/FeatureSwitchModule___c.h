...
#define RPG_CLIENT_FEATURESWITCHMODULE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC5C4E40)
#define RPG_CLIENT_FEATURESWITCHMODULE___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC5C4E80)
#define RPG_CLIENT_FEATURESWITCHMODULE___C___CHECKSHIELDEDOUTFITSCHANGED_B__24_0_OFFSET UNITYSDK_OFFSET(0xC5C4E90)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::Class_1_075C34D03AFA1215_8*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(FeatureSwitchModule___c_TypeDefinitionIndex)->GetStaticField(0xEAF0);
		}
		static ::RPG::Client::FeatureSwitchModule___c** StaticGet___9()
		{
			return (::RPG::Client::FeatureSwitchModule___c**)Il2CppClass::FromTypeDefinitionIndex(FeatureSwitchModule___c_TypeDefinitionIndex)->GetStaticField(0xEAF8);
		}
