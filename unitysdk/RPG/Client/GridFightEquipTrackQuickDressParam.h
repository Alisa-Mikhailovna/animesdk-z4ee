...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_EQUALS_OFFSET UNITYSDK_OFFSET(0xC701CA0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_GET_REFEQUIPITEMDATA_OFFSET UNITYSDK_OFFSET(0xC702020)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_GET_REFTRACK_OFFSET UNITYSDK_OFFSET(0xC702000)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_SET_REFEQUIPITEMDATA_OFFSET UNITYSDK_OFFSET(0xC702030)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_SET_REFTRACK_OFFSET UNITYSDK_OFFSET(0xC702010)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC6FEB10)
