...
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_APPEND_OFFSET UNITYSDK_OFFSET(0xC177820)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_CREATE_OFFSET UNITYSDK_OFFSET(0xC1779A0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFCOUNT_OFFSET UNITYSDK_OFFSET(0xC178B70)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFDESC_OFFSET UNITYSDK_OFFSET(0xC178D50)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFICONPATH_OFFSET UNITYSDK_OFFSET(0xC178BC0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFNAME_OFFSET UNITYSDK_OFFSET(0xC178C60)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_FIRST_OFFSET UNITYSDK_OFFSET(0xC178AF0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM1_OFFSET UNITYSDK_OFFSET(0xC178EA0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM2_OFFSET UNITYSDK_OFFSET(0xC178FB0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM3_OFFSET UNITYSDK_OFFSET(0xC1790C0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_REMAINEFFECTTIMES_OFFSET UNITYSDK_OFFSET(0xC178E40)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xC178AA0)
