...
#define RPG_CLIENT_FATESTATISTICSINFO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC5B7220)
#define RPG_CLIENT_FATESTATISTICSINFO___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC5B7260)
#define RPG_CLIENT_FATESTATISTICSINFO___C___SYNCDIFFICULTYINFO_B__4_0_OFFSET UNITYSDK_OFFSET(0xC5B7270)
#define RPG_CLIENT_FATESTATISTICSINFO___C___SYNCDIFFICULTYINFO_B__4_2_OFFSET UNITYSDK_OFFSET(0xC5B7310)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(FateStatisticsInfo___c_TypeDefinitionIndex)->GetStaticField(0xE250);
		}
		static ::RPG::Client::FateStatisticsInfo___c** StaticGet___9()
		{
			return (::RPG::Client::FateStatisticsInfo___c**)Il2CppClass::FromTypeDefinitionIndex(FateStatisticsInfo___c_TypeDefinitionIndex)->GetStaticField(0xE258);
		}
		...
		{
			return (::System::Comparison_1<::System::Collections::Generic::KeyValuePair_2<::System::UInt32, ::Class_1_4D052AB586FDB247_1*>>**)Il2CppClass::FromTypeDefinitionIndex(FateStatisticsInfo___c_TypeDefinitionIndex)->GetStaticField(0xE260);
		}
