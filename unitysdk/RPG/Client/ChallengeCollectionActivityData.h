...
#define RPG_CLIENT_CHALLENGECOLLECTIONACTIVITYDATA_GET_CHALLENGEPEAKACTIVITY_OFFSET UNITYSDK_OFFSET(0xBF82EA0)
#define RPG_CLIENT_CHALLENGECOLLECTIONACTIVITYDATA_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0xBF82C60)
#define RPG_CLIENT_CHALLENGECOLLECTIONACTIVITYDATA_PREPAREDATA_OFFSET UNITYSDK_OFFSET(0xBF82CA0)
#define RPG_CLIENT_CHALLENGECOLLECTIONACTIVITYDATA_SYNCSCHEDULE_OFFSET UNITYSDK_OFFSET(0xBF82960)
#define RPG_CLIENT_CHALLENGECOLLECTIONACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBF82950)
#define RPG_CLIENT_CHALLENGECOLLECTIONACTIVITYDATA__ONSCHEDULEENDS_OFFSET UNITYSDK_OFFSET(0xBF83240)
