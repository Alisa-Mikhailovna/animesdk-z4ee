...
#define RPG_CLIENT_WINDOWSHELPER_ENUMWINDOWSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xD8A8010)
#define RPG_CLIENT_WINDOWSHELPER_ENUMWINDOWSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xD8A8080)
#define RPG_CLIENT_WINDOWSHELPER_ENUMWINDOWSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xD8A8000)
#define RPG_CLIENT_WINDOWSHELPER_ENUMWINDOWSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xD8A7F90)

namespace RPG::Client
{
	inline static constexpr unsigned int WindowsHelper_EnumWindowsCallBack_TypeDefinitionIndex = 69891;
