...
#define RPG_CLIENT_LIGHTCONEZOOM_UPDATEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC922840)
#define RPG_CLIENT_LIGHTCONEZOOM_UPDATEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC922870)
#define RPG_CLIENT_LIGHTCONEZOOM_UPDATEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0xC9227B0)
#define RPG_CLIENT_LIGHTCONEZOOM_UPDATEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0xC9227D0)

namespace RPG::Client
{
	inline static constexpr unsigned int LightConeZoom_UpdateFunc_TypeDefinitionIndex = 69279;
