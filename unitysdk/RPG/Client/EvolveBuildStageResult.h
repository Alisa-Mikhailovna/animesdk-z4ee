...
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_CREATEFAKE_OFFSET UNITYSDK_OFFSET(0xC41B200)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_CREATEFROMFINISHNOTIFY_OFFSET UNITYSDK_OFFSET(0xC41A510)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_CREATE_OFFSET UNITYSDK_OFFSET(0xC41A060)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GETSCORENUM_OFFSET UNITYSDK_OFFSET(0xC41A5B0)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GETTEAMDAMAGENUM_OFFSET UNITYSDK_OFFSET(0xC41ADE0)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GETTITLE_OFFSET UNITYSDK_OFFSET(0xC41B370)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GETWEAPONDAMAGENUM_OFFSET UNITYSDK_OFFSET(0xC41A9B0)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GET_ISINTUTORIALSTAGE_OFFSET UNITYSDK_OFFSET(0xC41B4A0)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0xC41B480)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GET_SCORE_OFFSET UNITYSDK_OFFSET(0xC41B460)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GET__MODULE_OFFSET UNITYSDK_OFFSET(0xC41B2C0)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_OPENPHASETREASUREUI_OFFSET UNITYSDK_OFFSET(0xC41B260)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_SET_ITEMS_OFFSET UNITYSDK_OFFSET(0xC41B490)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT_SET_SCORE_OFFSET UNITYSDK_OFFSET(0xC41B470)
#define RPG_CLIENT_EVOLVEBUILDSTAGERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xC41A500)
...
namespace RPG::Client
{
	...
	public:
		...
		static ::RPG::Client::EvolveBuildStageResult* CreateFromFinishNotify(::Class_1_C9DFE5EE7107C629_8* a1, ::RPG::GameCore::EvolveBuildSeason a2, ::System::UInt32 a3)
		{
			return ((::RPG::Client::EvolveBuildStageResult*(*)(::Class_1_C9DFE5EE7107C629_8*, ::RPG::GameCore::EvolveBuildSeason, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_EVOLVEBUILDSTAGERESULT_CREATEFROMFINISHNOTIFY_OFFSET))(a1, a2, a3);
		}

		static ::System::UInt32 GetWeaponDamageNum(::Class_1_C9DFE5EE7107C629_8* a1)
		{
			return ((::System::UInt32(*)(::Class_1_C9DFE5EE7107C629_8*))((::PBYTE)hIl2Cpp + RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GETWEAPONDAMAGENUM_OFFSET))(a1);
		}

		static ::System::UInt32 GetTeamDamageNum(::Class_1_C9DFE5EE7107C629_8* a1)
		{
			return ((::System::UInt32(*)(::Class_1_C9DFE5EE7107C629_8*))((::PBYTE)hIl2Cpp + RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GETTEAMDAMAGENUM_OFFSET))(a1);
		}

		static ::System::UInt32 GetScoreNum(::Class_1_C9DFE5EE7107C629_8* a1)
		{
			return ((::System::UInt32(*)(::Class_1_C9DFE5EE7107C629_8*))((::PBYTE)hIl2Cpp + RPG_CLIENT_EVOLVEBUILDSTAGERESULT_GETSCORENUM_OFFSET))(a1);
		}
