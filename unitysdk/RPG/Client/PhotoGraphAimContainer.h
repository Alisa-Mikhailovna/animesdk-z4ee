...
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_CHECKCAMERAATAIMFORWARD_OFFSET UNITYSDK_OFFSET(0xCF6EBD0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_CHECKFIRSTTARGETINPHOTORATIO_OFFSET UNITYSDK_OFFSET(0xCF6EA80)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_CLEARALLAIMS_OFFSET UNITYSDK_OFFSET(0xCF6E5A0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_DISPOSEALLAIMS_OFFSET UNITYSDK_OFFSET(0xCF6E310)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_EXITIDENTIFYMODE_OFFSET UNITYSDK_OFFSET(0xCF6CFB0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_GETIDENTIFYAREA_OFFSET UNITYSDK_OFFSET(0xCF6EDA0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_GETMANUALAIMENTITYINRANGE_OFFSET UNITYSDK_OFFSET(0xCF6D230)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_GET_IDENTIFYSTATE_OFFSET UNITYSDK_OFFSET(0xCF6F030)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_IDENTIFYMANUALAIMENTITYINRANGE_OFFSET UNITYSDK_OFFSET(0xCF6D1C0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCF6ADC0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCF6ABB0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_REFRESHPENDINGAIMANISTATE_OFFSET UNITYSDK_OFFSET(0xCF6E920)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_REFRESH_OFFSET UNITYSDK_OFFSET(0xCF6D280)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_SELECTIDENTIFYPENDINGTARGET_OFFSET UNITYSDK_OFFSET(0xCF6B7E0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_SETIDENTIFYCUSTOMTIP_OFFSET UNITYSDK_OFFSET(0xCF6CE70)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_SETUPOWNERPHOTOGRAPHSYS_OFFSET UNITYSDK_OFFSET(0xCF6CF10)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_SHOWIDENTIFYRESULTSTATUS_OFFSET UNITYSDK_OFFSET(0xCF6E7C0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_STARTIDENTIFYMODE_OFFSET UNITYSDK_OFFSET(0xCF6CF60)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER_START_OFFSET UNITYSDK_OFFSET(0xCF6A910)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__ACQUIREAIM_OFFSET UNITYSDK_OFFSET(0xCF6D910)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__CLEARAIMS_OFFSET UNITYSDK_OFFSET(0xCF6E600)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xCF6F040)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__DESTORYAIM_OFFSET UNITYSDK_OFFSET(0xCF6E510)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__GETLOCALPOSINIDENTIFYAREA_OFFSET UNITYSDK_OFFSET(0xCF6EDE0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__ISINIDENTIFYAREA_OFFSET UNITYSDK_OFFSET(0xCF6CCC0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__ISLOCALPOSINIDENTIFYAREA_OFFSET UNITYSDK_OFFSET(0xCF6EF80)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__RELEASEAIM_OFFSET UNITYSDK_OFFSET(0xCF6D150)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__RESETAIM_OFFSET UNITYSDK_OFFSET(0xCF6BC90)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__RESETTIMER_OFFSET UNITYSDK_OFFSET(0xCF6BB40)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__SETAIMPOS_OFFSET UNITYSDK_OFFSET(0xCF6BE00)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__SETUPCONFIG_OFFSET UNITYSDK_OFFSET(0xCF6A960)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__SETUPHINTMASK_OFFSET UNITYSDK_OFFSET(0xCF6AA50)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__SHOWAIMRESULTSTATUS_OFFSET UNITYSDK_OFFSET(0xCF6C880)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__SHOWHINTMASK_OFFSET UNITYSDK_OFFSET(0xCF6AC10)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__SWITCHIDENTIFYSTATE_OFFSET UNITYSDK_OFFSET(0xCF6BAB0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__UPDATEAIMINFOBYAIMUNION_OFFSET UNITYSDK_OFFSET(0xCF6E2A0)
#define RPG_CLIENT_PHOTOGRAPHAIMCONTAINER__UPDATEAIMINFOWORLDPOS_OFFSET UNITYSDK_OFFSET(0xCF6DF60)
