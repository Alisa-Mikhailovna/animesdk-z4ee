...
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC697A90)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC6983E0)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC698440)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC6983F0)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC697A80)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0xC693360)
