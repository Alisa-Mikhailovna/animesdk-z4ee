...
#define RPG_CLIENT_ONLINEPLAYROOMMODULE___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCEEE650)
#define RPG_CLIENT_ONLINEPLAYROOMMODULE___C__DISPLAYCLASS20_0__ENTERONLINEPLAYROOM_B__0_OFFSET UNITYSDK_OFFSET(0xCEF1270)
#define RPG_CLIENT_ONLINEPLAYROOMMODULE___C__DISPLAYCLASS20_0__ENTERONLINEPLAYROOM_B__1_OFFSET UNITYSDK_OFFSET(0xCEF1600)
