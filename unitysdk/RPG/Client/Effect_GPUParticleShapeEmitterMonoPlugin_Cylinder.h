...
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER_METHOD_2_4F2C6507D17C6667_OFFSET UNITYSDK_OFFSET(0xC3120F0)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER_METHOD_2_AA5EB6C0E8DC9D74_OFFSET UNITYSDK_OFFSET(0xC3121B0)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER_METHOD_2_B0FB0178D34CC9F5_OFFSET UNITYSDK_OFFSET(0xC312630)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER_METHOD_2_E19F224D4967A3A0_OFFSET UNITYSDK_OFFSET(0xC311600)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER__CTOR_OFFSET UNITYSDK_OFFSET(0xC312C30)
