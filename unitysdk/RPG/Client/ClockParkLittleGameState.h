...
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_FINISHROUND_OFFSET UNITYSDK_OFFSET(0xC1854A0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GETBATTLEBUFFEFFECTDATAITEMS_OFFSET UNITYSDK_OFFSET(0xC1853D0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GETSUCCESSEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0xC185410)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GET_ISINHANUSHOOTING_OFFSET UNITYSDK_OFFSET(0xC1872B0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GET_ISINMOVIEGAME_OFFSET UNITYSDK_OFFSET(0xC187290)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GET_SCORELEVEL_OFFSET UNITYSDK_OFFSET(0xC1872D0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_SET_ISINHANUSHOOTING_OFFSET UNITYSDK_OFFSET(0xC1872C0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_SET_ISINMOVIEGAME_OFFSET UNITYSDK_OFFSET(0xC1872A0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_SET_SCORELEVEL_OFFSET UNITYSDK_OFFSET(0xC1872E0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ADDHANUSHOOTINGNOTIFY_OFFSET UNITYSDK_OFFSET(0xC186D70)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC183650)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__GETHANUSHOOTINGLEVELID_OFFSET UNITYSDK_OFFSET(0xC186960)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__GETHANUSHOOTINGSCORELEVEL_OFFSET UNITYSDK_OFFSET(0xC187080)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__GETHANUSHOOTINGTRIGGERSTR_OFFSET UNITYSDK_OFFSET(0xC186CE0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__GETMOVIESTAGEID_OFFSET UNITYSDK_OFFSET(0xC186140)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ISVALIDGAMEBUFFTYPE_OFFSET UNITYSDK_OFFSET(0xC1860F0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONENTER_OFFSET UNITYSDK_OFFSET(0xC1848C0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONFINISHHANUSHOOTING_OFFSET UNITYSDK_OFFSET(0xC1870F0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONFINISHMOVIEGAME_OFFSET UNITYSDK_OFFSET(0xC186820)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONUIMOVIERACINGGAMERESULT_OFFSET UNITYSDK_OFFSET(0xC1864B0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONUIWOLFBROSHOOTINGEXITGAME_OFFSET UNITYSDK_OFFSET(0xC187230)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONUIWOLFBROSHOOTINGSUCCESS_OFFSET UNITYSDK_OFFSET(0xC186F90)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__RECORDEFFECTDATAITEMS_OFFSET UNITYSDK_OFFSET(0xC184ED0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__REMOVEHANUSHOOTINGNOTIFY_OFFSET UNITYSDK_OFFSET(0xC186E80)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__SETMOVIEGAMETARGETSCORE_OFFSET UNITYSDK_OFFSET(0xC185780)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__TRIGGERHANUSHOOTING_OFFSET UNITYSDK_OFFSET(0xC185E30)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__TRIGGERMOVIEGAME_OFFSET UNITYSDK_OFFSET(0xC185BB0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _LittleGameScoreLevelNum; // 0x34
