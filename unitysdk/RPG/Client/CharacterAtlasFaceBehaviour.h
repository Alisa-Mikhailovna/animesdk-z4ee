...
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBFCBCE0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_GET_OWNERMONO_OFFSET UNITYSDK_OFFSET(0xBFCBF80)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xBFCC120)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_32F371754DD4B742_OFFSET UNITYSDK_OFFSET(0xBFCBA40)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0xBFCBE70)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8594010D6A57C9BB_1_OFFSET UNITYSDK_OFFSET(0xBFCBF30)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0xBFCBDD0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8FF354B64B657510_OFFSET UNITYSDK_OFFSET(0xBFCBFD0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xBFCBB50)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_EF9F68D628696187_OFFSET UNITYSDK_OFFSET(0xBFCC440)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xBFCC5F0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xBFCB9C0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterAtlasFaceBehaviour_TypeDefinitionIndex)->GetStaticField(0x114E0);
		}
		static ::System::Int32* StaticGet_PROPERTY_ATLAS_DIVISION()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterAtlasFaceBehaviour_TypeDefinitionIndex)->GetStaticField(0x114E4);
		}
