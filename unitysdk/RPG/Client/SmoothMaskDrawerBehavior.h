...
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xD51DBA0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xD51D650)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xD51D550)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0xD51D6D0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD51DAF0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD51DA70)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD51DB50)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_CEBFF096B4C9D46B_1_OFFSET UNITYSDK_OFFSET(0xD51DE40)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0xD51D720)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_DC2911BC8B5CED9A_OFFSET UNITYSDK_OFFSET(0xD51DCE0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD51E150)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::SmoothMaskDrawer**)Il2CppClass::FromTypeDefinitionIndex(SmoothMaskDrawerBehavior_TypeDefinitionIndex)->GetStaticField(0x33350);
		}
