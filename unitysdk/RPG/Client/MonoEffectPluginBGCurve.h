...
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCC834C0)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_METHOD_6_9E1C80D299917CB2_OFFSET UNITYSDK_OFFSET(0xCC835D0)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCC83470)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_1_OFFSET UNITYSDK_OFFSET(0xCC84170)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_2_OFFSET UNITYSDK_OFFSET(0xCC84390)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_OFFSET UNITYSDK_OFFSET(0xCC83500)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC845E0)
