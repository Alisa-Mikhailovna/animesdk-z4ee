...
#define RPG_CLIENT_MONOCHARACTERHEADPOINT_GET_WORLDPOS_OFFSET UNITYSDK_OFFSET(0xCC35770)
#define RPG_CLIENT_MONOCHARACTERHEADPOINT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xCC359B0)
#define RPG_CLIENT_MONOCHARACTERHEADPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC359F0)
