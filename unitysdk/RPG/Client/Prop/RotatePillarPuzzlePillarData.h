...
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEPILLARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD20D7A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RotatePillarPuzzlePillarData_TypeDefinitionIndex = 74853;
