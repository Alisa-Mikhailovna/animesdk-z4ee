...
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD108F50)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_PROP_CHIMERADUELBUBBLELISTENEVENT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD109190)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_PROP_CHIMERADUELBUBBLELISTENEVENT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD109120)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD109210)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD109180)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD109130)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD108F30)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0xD108B20)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xD108F40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelBubbleEventManager___MatchListenEvents_d__11_TypeDefinitionIndex = 74319;
	...
	public:
		...
		::Class_1_FC01049DA05831B0* __2__current; // 0x30
		::RPG::Client::Prop::ChimeraDuelBubbleEvent* __3__evt; // 0x38
		::System::Collections::Generic::List_1<::Class_1_FC01049DA05831B0*>* listenEvents; // 0x40
