...
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD22A400)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD22A4A0)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_INIT_OFFSET UNITYSDK_OFFSET(0xD22A680)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD22AC00)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_METHOD_7_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0xD22B360)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_METHOD_7_394F35BBA0EE596A_OFFSET UNITYSDK_OFFSET(0xD22B560)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_METHOD_7_8AFAC1382B331885_OFFSET UNITYSDK_OFFSET(0xD22B4F0)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_METHOD_7_C706B1EC6D2E1C64_OFFSET UNITYSDK_OFFSET(0xD22B8B0)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD22B350)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD22AAF0)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xD22AC50)
#define RPG_CLIENT_PROP_SNOWBALLPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD22BA90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int SnowballPuzzleBoard_TypeDefinitionIndex = 74910;
