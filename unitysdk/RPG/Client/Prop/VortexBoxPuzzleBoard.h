...
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_CANITEMMOVE_OFFSET UNITYSDK_OFFSET(0xD23ED00)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_DIFFBYDIR_OFFSET UNITYSDK_OFFSET(0xD23EE60)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD23F470)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_GETITEM_OFFSET UNITYSDK_OFFSET(0xD23EF00)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0xD23FA70)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0xD23E4C0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD23DDB0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD23DD60)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_ITEM2BOARDLOCAL_OFFSET UNITYSDK_OFFSET(0xD240980)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_METHOD_7_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0xD2408B0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_METHOD_7_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD240CD0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_METHOD_7_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xD23DFD0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_METHOD_7_B7DE96E81A4BD953_OFFSET UNITYSDK_OFFSET(0xD23FAD0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_METHOD_7_E83C51340BE6FC16_OFFSET UNITYSDK_OFFSET(0xD23EAA0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_ONITEMMOVEFINISH_OFFSET UNITYSDK_OFFSET(0xD23EA10)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_REFRESHCANDRAGITEM_OFFSET UNITYSDK_OFFSET(0xD23E0A0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD23EFA0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_TRYDRAGBOX_OFFSET UNITYSDK_OFFSET(0xD23FD00)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_TRYMOVEVORTEX_OFFSET UNITYSDK_OFFSET(0xD23F9B0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xD240930)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_WORLDFORWARDRIGHT2DIR_OFFSET UNITYSDK_OFFSET(0xD240AF0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD_WORLDPOSITION2COORD_OFFSET UNITYSDK_OFFSET(0xD240A40)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD241450)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD241350)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int VortexBoxPuzzleBoard_TypeDefinitionIndex = 74901;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VortexBoxPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x4EA0);
		}
