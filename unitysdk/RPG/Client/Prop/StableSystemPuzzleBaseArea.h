...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_GET_AREASTATUS_OFFSET UNITYSDK_OFFSET(0xD22C000)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_GET_ISSTABLE_OFFSET UNITYSDK_OFFSET(0xD22BD60)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_INITBASEAREA_OFFSET UNITYSDK_OFFSET(0xD22BAC0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_REFRESHSTABLE_OFFSET UNITYSDK_OFFSET(0xD22BBA0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0xD22BB20)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_SET_AREASTATUS_OFFSET UNITYSDK_OFFSET(0xD22C010)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xD22C0C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleBaseArea_TypeDefinitionIndex = 74915;
