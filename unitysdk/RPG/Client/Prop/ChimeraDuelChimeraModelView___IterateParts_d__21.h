...
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD10D7F0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_RENDERER__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD10D930)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_RENDERER__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD10D8C0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD10D9B0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD10D920)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD10D8D0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD10D7E0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0xD10A550)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelChimeraModelView___IterateParts_d__21_TypeDefinitionIndex = 74372;
