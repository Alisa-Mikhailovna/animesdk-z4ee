...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1127E0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETALLYMEMBERSLOTS_OFFSET UNITYSDK_OFFSET(0xD115730)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETENEMYMEMBERSLOTS_OFFSET UNITYSDK_OFFSET(0xD115770)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETMASTERANCHOR_OFFSET UNITYSDK_OFFSET(0xD1157B0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETMASTERTALKANCHOR_OFFSET UNITYSDK_OFFSET(0xD114F60)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETPROXIES_OFFSET UNITYSDK_OFFSET(0xD112D20)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETPROXYLIST_OFFSET UNITYSDK_OFFSET(0xD115540)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETPROXY_OFFSET UNITYSDK_OFFSET(0xD1155C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GET_ALLYMASTERID_OFFSET UNITYSDK_OFFSET(0xD1125C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GET_ENEMYMASTERID_OFFSET UNITYSDK_OFFSET(0xD1125D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_LOADCHIMERAWITHANCHOR_OFFSET UNITYSDK_OFFSET(0xD112DD0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_LOADCHIMERA_OFFSET UNITYSDK_OFFSET(0xD1136E0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_LOADMASTERGROUP_OFFSET UNITYSDK_OFFSET(0xD114710)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_34174C70D4D8D91A_OFFSET UNITYSDK_OFFSET(0xD112460)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_651389C8EB0A0E71_OFFSET UNITYSDK_OFFSET(0xD114390)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_7BAF473253F09AFA_OFFSET UNITYSDK_OFFSET(0xD1131A0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_921FC9B720328DC4_OFFSET UNITYSDK_OFFSET(0xD115810)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_99ABFE8933D176BE_OFFSET UNITYSDK_OFFSET(0xD113640)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_BE3D392B274FB7D7_OFFSET UNITYSDK_OFFSET(0xD114D50)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_D9CE4FE9E294B1B7_OFFSET UNITYSDK_OFFSET(0xD1132D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_REMOVEPROXY_OFFSET UNITYSDK_OFFSET(0xD115690)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_REORDER_OFFSET UNITYSDK_OFFSET(0xD1137B0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_RESET_OFFSET UNITYSDK_OFFSET(0xD114FE0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_START_OFFSET UNITYSDK_OFFSET(0xD1125E0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_UNLOADMASTERGROUP_OFFSET UNITYSDK_OFFSET(0xD114690)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_UNLOADMASTERNPCMODEL_OFFSET UNITYSDK_OFFSET(0xD112100)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xD112780)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD1158F0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW__GETPROXIES_B__29_0_OFFSET UNITYSDK_OFFSET(0xD115A40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleBattleView_TypeDefinitionIndex = 74415;
