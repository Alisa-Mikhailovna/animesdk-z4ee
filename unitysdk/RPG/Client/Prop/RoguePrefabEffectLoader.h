...
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_METHOD_5_4529D5FBB820A524_OFFSET UNITYSDK_OFFSET(0xD204020)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xD203BA0)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_METHOD_5_E48346E1F8A611CB_OFFSET UNITYSDK_OFFSET(0xD203DE0)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD203D40)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD203CF0)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_START_OFFSET UNITYSDK_OFFSET(0xD203B50)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2042E0)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER___ACTIVEEFFECT_B__3_0_OFFSET UNITYSDK_OFFSET(0xD204310)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER___GETEFFECTPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0xD204370)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RoguePrefabEffectLoader_TypeDefinitionIndex = 75001;
