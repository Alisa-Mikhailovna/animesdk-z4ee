...
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_DISABLEALLTRIGGER_OFFSET UNITYSDK_OFFSET(0xD237870)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD236FF0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_ENABLEALLTRIGGER_OFFSET UNITYSDK_OFFSET(0xD238100)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_EXITTELEPORTCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xD230420)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_GETTELEPORTENDPOINT_OFFSET UNITYSDK_OFFSET(0xD234700)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_GETTELEPORTPOINTSBYSRCANDTARGET_OFFSET UNITYSDK_OFFSET(0xD237660)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_GETTELEPORTPOINTS_OFFSET UNITYSDK_OFFSET(0xD231C30)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD234A20)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_02B490C9189918DC_OFFSET UNITYSDK_OFFSET(0xD238E30)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_057EC1AE4AD79114_OFFSET UNITYSDK_OFFSET(0xD238360)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_0B71C60A6B94C27E_OFFSET UNITYSDK_OFFSET(0xD234C20)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0xD239400)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_39FEC17A8F811530_OFFSET UNITYSDK_OFFSET(0xD236A20)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_3CAD92CFB876DBF6_1_OFFSET UNITYSDK_OFFSET(0xD237560)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_3CAD92CFB876DBF6_OFFSET UNITYSDK_OFFSET(0xD236180)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_4C1EED43D4375BF1_OFFSET UNITYSDK_OFFSET(0xD235ED0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_5774A017AB29B9C4_OFFSET UNITYSDK_OFFSET(0xD237CF0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_63C9695FD446A3FB_OFFSET UNITYSDK_OFFSET(0xD238C70)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_66F5446EE62756C0_OFFSET UNITYSDK_OFFSET(0xD234B40)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_69B2EE89B201424C_OFFSET UNITYSDK_OFFSET(0xD2386E0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_87542624084AC5B0_OFFSET UNITYSDK_OFFSET(0xD236C20)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xD236110)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xD235E50)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_B6341494FC1F179D_OFFSET UNITYSDK_OFFSET(0xD239140)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_B85FADE27031C75C_OFFSET UNITYSDK_OFFSET(0xD238860)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_C37465F702371348_OFFSET UNITYSDK_OFFSET(0xD237960)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_C521AF86F7597260_OFFSET UNITYSDK_OFFSET(0xD238190)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD238060)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD2380B0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_CB8EC282BE234712_OFFSET UNITYSDK_OFFSET(0xD239070)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_D4E1804C25B5032C_OFFSET UNITYSDK_OFFSET(0xD238300)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_E52C357E96F7A058_OFFSET UNITYSDK_OFFSET(0xD2391D0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_E69265148B895E7A_OFFSET UNITYSDK_OFFSET(0xD237EA0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD2368D0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_F3427EDA868DBB19_OFFSET UNITYSDK_OFFSET(0xD2368E0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_METHOD_6_F94014943DD919AB_OFFSET UNITYSDK_OFFSET(0xD236F10)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_ONEFFECTTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xD2323E0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_ONEFFECTTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xD2324E0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_ONGATESTATECHANGE_OFFSET UNITYSDK_OFFSET(0xD231090)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_ONPLAYERENDMOVE_OFFSET UNITYSDK_OFFSET(0xD232260)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_ONPLAYERSTARTMOVE_OFFSET UNITYSDK_OFFSET(0xD234770)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_ONROTATEEND_OFFSET UNITYSDK_OFFSET(0xD232B60)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_ONSETACTIVE_OFFSET UNITYSDK_OFFSET(0xD236280)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xD2366A0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD_TRYGATEROTATE_OFFSET UNITYSDK_OFFSET(0xD231480)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD239CD0)
#define RPG_CLIENT_PROP_TELEPORTGATEPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD239AC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int TeleportGatePuzzleBoard_TypeDefinitionIndex = 74947;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TeleportGatePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x4E10);
		}
		static ::System::Int32* StaticGet_Field_6_1()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TeleportGatePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x4E14);
		}
		static ::System::Int32* StaticGet_Field_6_2()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TeleportGatePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x4E18);
		}
