...
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1399F0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_GETNPC_OFFSET UNITYSDK_OFFSET(0xD13A960)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_GETUNIQUEID_OFFSET UNITYSDK_OFFSET(0xD13BA50)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD13A120)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_INIT_OFFSET UNITYSDK_OFFSET(0xD13A230)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD13B370)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_0584B4481E699952_OFFSET UNITYSDK_OFFSET(0xD13BCA0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_08BBACE844405300_OFFSET UNITYSDK_OFFSET(0xD13C2D0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xD13BF70)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_1BD8B8D0762B0F0F_OFFSET UNITYSDK_OFFSET(0xD13C8B0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0xD13C0F0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xD13BD90)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_285439556D776CA2_1_OFFSET UNITYSDK_OFFSET(0xD13B210)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_285439556D776CA2_OFFSET UNITYSDK_OFFSET(0xD13B2C0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xD13C740)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_34928CCE7A86FADF_OFFSET UNITYSDK_OFFSET(0xD13CC70)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_34A27F2552E42C8A_OFFSET UNITYSDK_OFFSET(0xD13D180)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_37D641371E4C8F58_OFFSET UNITYSDK_OFFSET(0xD13AF10)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_458DAEAB6170C584_OFFSET UNITYSDK_OFFSET(0xD13C830)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_45AA2F5085C2C40D_OFFSET UNITYSDK_OFFSET(0xD13C150)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_57D5ED2C4C06D908_1_OFFSET UNITYSDK_OFFSET(0xD13AF80)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_57D5ED2C4C06D908_OFFSET UNITYSDK_OFFSET(0xD13D120)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_635445A7258F7A25_OFFSET UNITYSDK_OFFSET(0xD13BAD0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_7A272934369463F2_OFFSET UNITYSDK_OFFSET(0xD13B3C0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD13A8D0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0xD13BB70)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_974A70E8019154E7_OFFSET UNITYSDK_OFFSET(0xD13CED0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_A239DF324AF4215D_1_OFFSET UNITYSDK_OFFSET(0xD139EE0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xD13ACD0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0xD139D30)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xD139C50)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_EFF275E2C18C04F2_OFFSET UNITYSDK_OFFSET(0xD13B850)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0xD13BE40)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xD13CBF0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_METHOD_7_F624506052E4790C_OFFSET UNITYSDK_OFFSET(0xD13AFE0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD13B410)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD13A580)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xD13B0E0)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD13D470)
#define RPG_CLIENT_PROP_COMMANDROBOTPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD13D3C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int CommandRobotPuzzleBoard_TypeDefinitionIndex = 74556;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(CommandRobotPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x26B0);
		}
		static ::System::UInt32* StaticGet_Field_7_1()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(CommandRobotPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0xF20);
		}
