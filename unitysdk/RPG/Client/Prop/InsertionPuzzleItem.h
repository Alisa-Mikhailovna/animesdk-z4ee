...
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_GETISHOVER_OFFSET UNITYSDK_OFFSET(0xD173770)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_GETNEXTCOORD_OFFSET UNITYSDK_OFFSET(0xD174600)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0xD1709F0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_ISINANIMATION_OFFSET UNITYSDK_OFFSET(0xD1738F0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_ISMATCHITEMFAILD_OFFSET UNITYSDK_OFFSET(0xD175110)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_ISMATCHITEM_OFFSET UNITYSDK_OFFSET(0xD1750A0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_METHOD_7_5A124CAF1E48B74F_OFFSET UNITYSDK_OFFSET(0xD176230)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD1766A0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_ONHOVEREXIT_OFFSET UNITYSDK_OFFSET(0xD16FEB0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_ONHOVER_OFFSET UNITYSDK_OFFSET(0xD16FF80)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0xD1763E0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_RESETLASTCOORDANDPOSITION_OFFSET UNITYSDK_OFFSET(0xD1746C0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_ROTATE_OFFSET UNITYSDK_OFFSET(0xD171D80)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETANIMATOR_OFFSET UNITYSDK_OFFSET(0xD176750)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETBASEITEMHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xD176560)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETBASEITEMSTATE_OFFSET UNITYSDK_OFFSET(0xD170BA0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETCENTER_OFFSET UNITYSDK_OFFSET(0xD171C80)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETCOORDANDPOSITION_OFFSET UNITYSDK_OFFSET(0xD1759B0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETDITHERALPHAWITHANIMATION_OFFSET UNITYSDK_OFFSET(0xD172B50)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETINSERTIONHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xD1737B0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETINSERTIONSTATE_OFFSET UNITYSDK_OFFSET(0xD171CF0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETNEXTCOORDANDPOSITION_OFFSET UNITYSDK_OFFSET(0xD171C10)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETREDHIT_OFFSET UNITYSDK_OFFSET(0xD174640)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETROTATECURVE_OFFSET UNITYSDK_OFFSET(0xD176700)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETSCALEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0xD16CF50)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_SETTRANSFERSTATE_OFFSET UNITYSDK_OFFSET(0xD172D30)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM_TICK_OFFSET UNITYSDK_OFFSET(0xD16E730)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xD1767E0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD1767C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int InsertionPuzzleItem_TypeDefinitionIndex = 74678;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(InsertionPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x4AD0);
		}
		static ::System::String** StaticGet_Field_7_1()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(InsertionPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x4AD8);
		}
