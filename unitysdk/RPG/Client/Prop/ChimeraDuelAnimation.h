...
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0xD105DA0)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_INIT_OFFSET UNITYSDK_OFFSET(0xD105DF0)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD105FE0)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0xD106160)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_RPG_CLIENT_PROP_ICHIMERADUELTICKABLE_ONSTARTEDTICKING_OFFSET UNITYSDK_OFFSET(0xD106400)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_RPG_CLIENT_PROP_ICHIMERADUELTICKABLE_ONSTOPPEDTICKING_OFFSET UNITYSDK_OFFSET(0xD106440)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_TICK_OFFSET UNITYSDK_OFFSET(0xD106260)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_UNINIT_OFFSET UNITYSDK_OFFSET(0xD106030)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xD106480)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelAnimation_TypeDefinitionIndex = 74340;
