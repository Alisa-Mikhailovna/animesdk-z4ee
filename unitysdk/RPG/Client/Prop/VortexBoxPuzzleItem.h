...
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0xD23E880)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_METHOD_6_88667086FB91B538_OFFSET UNITYSDK_OFFSET(0xD242810)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_METHOD_6_8FA0679D147955F9_OFFSET UNITYSDK_OFFSET(0xD242470)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_METHOD_6_F9725EED05F07EC1_OFFSET UNITYSDK_OFFSET(0xD2426C0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_MOVE_OFFSET UNITYSDK_OFFSET(0xD240D10)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0xD242500)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_REFERSHPOSITION_OFFSET UNITYSDK_OFFSET(0xD23E730)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_RESET_OFFSET UNITYSDK_OFFSET(0xD23F420)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_SETBOXSELECT_OFFSET UNITYSDK_OFFSET(0xD2425C0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_SETCANDRAG_OFFSET UNITYSDK_OFFSET(0xD23EBA0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_SETFINISHSTATE_OFFSET UNITYSDK_OFFSET(0xD240670)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_VORTEXDRAG_OFFSET UNITYSDK_OFFSET(0xD240520)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_VORTEXEXPAND_OFFSET UNITYSDK_OFFSET(0xD240760)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xD2428F0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD2428D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int VortexBoxPuzzleItem_TypeDefinitionIndex = 74904;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VortexBoxPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x4F30);
		}
