...
#define RPG_CLIENT_PROP_PORTERTARGETGROUP_METHOD_1_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0xD1F2B70)
#define RPG_CLIENT_PROP_PORTERTARGETGROUP_METHOD_1_2EDEE9BCD5AAB2CD_OFFSET UNITYSDK_OFFSET(0xD1F1ED0)
#define RPG_CLIENT_PROP_PORTERTARGETGROUP_METHOD_1_65FF2FB4CA0B10B5_OFFSET UNITYSDK_OFFSET(0xD1F2FF0)
#define RPG_CLIENT_PROP_PORTERTARGETGROUP_METHOD_1_7EB98D7683D8A8D4_OFFSET UNITYSDK_OFFSET(0xD1F3320)
#define RPG_CLIENT_PROP_PORTERTARGETGROUP_METHOD_1_97DE7C3636D927FC_OFFSET UNITYSDK_OFFSET(0xD1F27D0)
#define RPG_CLIENT_PROP_PORTERTARGETGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xD1F33B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PorterTargetGroup_TypeDefinitionIndex = 74820;
