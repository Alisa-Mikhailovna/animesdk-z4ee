...
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_CLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xD20B740)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_COUNTERCLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xD20B730)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD20A870)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISMAINROTATE_OFFSET UNITYSDK_OFFSET(0xD20B690)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISROTATE_OFFSET UNITYSDK_OFFSET(0xD20B680)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT0_OFFSET UNITYSDK_OFFSET(0xD20B750)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT1_OFFSET UNITYSDK_OFFSET(0xD20B760)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT2_OFFSET UNITYSDK_OFFSET(0xD20B770)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT3_OFFSET UNITYSDK_OFFSET(0xD20B780)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_01EA2A2B0FBDD6EC_OFFSET UNITYSDK_OFFSET(0xD2087D0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xD2098B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_09ABBA5088B6E51D_OFFSET UNITYSDK_OFFSET(0xD209900)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_4B49CB2CD4D222F8_OFFSET UNITYSDK_OFFSET(0xD20B310)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_730F88EAC5E19842_OFFSET UNITYSDK_OFFSET(0xD20ACD0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_9BA0A0AC3056DE7A_OFFSET UNITYSDK_OFFSET(0xD20B270)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_A3230FC76D17AAB8_OFFSET UNITYSDK_OFFSET(0xD20AAE0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_ABE7CF9FA1B8CCA3_OFFSET UNITYSDK_OFFSET(0xD20A900)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_B1EA5948E7D176CF_OFFSET UNITYSDK_OFFSET(0xD20A0A0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_BADDA70ED68283AE_OFFSET UNITYSDK_OFFSET(0xD20B6A0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_D34B35D59998D28C_OFFSET UNITYSDK_OFFSET(0xD20B540)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_D7D0CD092E7E5457_OFFSET UNITYSDK_OFFSET(0xD2097C0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_F59BE9A39F733D1E_OFFSET UNITYSDK_OFFSET(0xD20A4B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_FB2B76D3FA17269F_OFFSET UNITYSDK_OFFSET(0xD209410)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_CLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xD208CE0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_COUNTERCLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xD208B70)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT0_OFFSET UNITYSDK_OFFSET(0xD208E50)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT1_OFFSET UNITYSDK_OFFSET(0xD208FC0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT2_OFFSET UNITYSDK_OFFSET(0xD209130)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT3_OFFSET UNITYSDK_OFFSET(0xD2092A0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xD20B790)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD2087B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__ONROTATEFINISH_B__13_0_OFFSET UNITYSDK_OFFSET(0xD20B8C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RotatePillarPuzzleFragment_TypeDefinitionIndex = 74850;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0xC5B0);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_StartRotateSound()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0xC5B8);
		}
		static ::System::String** StaticGet__ChangeToCompleteSound()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0xC5C0);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_StopRotateSound()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0xC5C8);
		}
		static ::System::Int32* StaticGet__UniqueIDCnt()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x48E0);
		}
