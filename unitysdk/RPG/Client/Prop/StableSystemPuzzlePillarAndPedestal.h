...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_GET_COLORSTATUS_OFFSET UNITYSDK_OFFSET(0xD22E080)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_INITPILLARANDPEDESTAL_OFFSET UNITYSDK_OFFSET(0xD22C6C0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_ONPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD22E000)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_SELECTPILLAR_OFFSET UNITYSDK_OFFSET(0xD22EEC0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_SETCOLORSTATUS_OFFSET UNITYSDK_OFFSET(0xD22F5A0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_SET_COLORSTATUS_OFFSET UNITYSDK_OFFSET(0xD22F640)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL__CTOR_OFFSET UNITYSDK_OFFSET(0xD22F6B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzlePillarAndPedestal_TypeDefinitionIndex = 74923;
