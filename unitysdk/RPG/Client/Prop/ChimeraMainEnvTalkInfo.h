...
#define RPG_CLIENT_PROP_CHIMERAMAINENVTALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD12DAC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraMainEnvTalkInfo_TypeDefinitionIndex = 74527;
