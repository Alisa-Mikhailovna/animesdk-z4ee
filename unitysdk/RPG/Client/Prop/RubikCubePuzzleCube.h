...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0xD2241D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0xD224FA0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_CANCELALLSELECT_OFFSET UNITYSDK_OFFSET(0xD2236B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_CONDITIONGROUPSETANIMATIONFINISH_OFFSET UNITYSDK_OFFSET(0xD2204B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD21F4A0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0xD224BE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GETGROUP_OFFSET UNITYSDK_OFFSET(0xD223180)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD2266C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GET_ISDRAG_OFFSET UNITYSDK_OFFSET(0xD2266A0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GET_ISROTATE_OFFSET UNITYSDK_OFFSET(0xD226680)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_INITCUBE_OFFSET UNITYSDK_OFFSET(0xD21F9B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0xD21E340)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_METHOD_5_2CB2A75807271EAA_OFFSET UNITYSDK_OFFSET(0xD225140)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD226620)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_METHOD_5_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xD225840)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xD21F880)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xD2259E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0xD2255F0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ONSTOPDRAG_OFFSET UNITYSDK_OFFSET(0xD224090)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_PLAYROTATESOUND_OFFSET UNITYSDK_OFFSET(0xD21D8E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REFRESHALLFRAMESTATUS_OFFSET UNITYSDK_OFFSET(0xD220610)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REGISTERFRAME_1_OFFSET UNITYSDK_OFFSET(0xD2203D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REGISTERFRAME_OFFSET UNITYSDK_OFFSET(0xD2202F0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD223F40)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REGISTERSWITCH_OFFSET UNITYSDK_OFFSET(0xD220210)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_RESETCUBE_OFFSET UNITYSDK_OFFSET(0xD21DAF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ROTATEX_OFFSET UNITYSDK_OFFSET(0xD220730)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ROTATEY_OFFSET UNITYSDK_OFFSET(0xD221530)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ROTATEZ_OFFSET UNITYSDK_OFFSET(0xD222260)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SDKREPORTPLAYERACION_OFFSET UNITYSDK_OFFSET(0xD2251E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SELECTBRICK_OFFSET UNITYSDK_OFFSET(0xD223BF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0xD223E70)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0xD222FF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SETBLOCKSELECT_OFFSET UNITYSDK_OFFSET(0xD21E240)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SET_ISDRAG_OFFSET UNITYSDK_OFFSET(0xD2266B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SET_ISROTATE_OFFSET UNITYSDK_OFFSET(0xD226690)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_UNREGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD223FF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE__CTOR_OFFSET UNITYSDK_OFFSET(0xD226810)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleCube_TypeDefinitionIndex = 74877;
