...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD199F60)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleCubeData_TypeDefinitionIndex = 74728;
