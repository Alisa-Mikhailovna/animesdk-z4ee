...
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD167CE0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xD168870)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_GETROTATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xD167710)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_GETROTATION_OFFSET UNITYSDK_OFFSET(0xD167C90)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_GET_ENABLECONTROLLER_OFFSET UNITYSDK_OFFSET(0xD167700)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_HIDEOBSTACLEITEMS_OFFSET UNITYSDK_OFFSET(0xD169950)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_HIDE_OFFSET UNITYSDK_OFFSET(0xD169120)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_ISENABLECONTROLLER_OFFSET UNITYSDK_OFFSET(0xD1677B0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0xD168570)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xD168340)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_41146E620D694011_OFFSET UNITYSDK_OFFSET(0xD168810)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_479759059E440327_OFFSET UNITYSDK_OFFSET(0xD169170)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_762A9412773049BE_OFFSET UNITYSDK_OFFSET(0xD168F50)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xD1678D0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD168EA0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_AD9D221401A49B93_OFFSET UNITYSDK_OFFSET(0xD169240)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_C411E5881DF297DE_OFFSET UNITYSDK_OFFSET(0xD167BC0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0xD1681A0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_E3DE31A03057E055_1_OFFSET UNITYSDK_OFFSET(0xD168D10)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xD168BD0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_METHOD_6_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0xD168290)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_ONBALLOUTOFPUZZLE_OFFSET UNITYSDK_OFFSET(0xD167AE0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD169480)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_ONPUZZLERESET_OFFSET UNITYSDK_OFFSET(0xD169510)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_RESETOBSTACLEITEMS_OFFSET UNITYSDK_OFFSET(0xD169780)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_RESETTOINITROTATION_OFFSET UNITYSDK_OFFSET(0xD167840)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_SETEFFVISIBLE_OFFSET UNITYSDK_OFFSET(0xD168A20)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_SETENABLECONTROLLER_OFFSET UNITYSDK_OFFSET(0xD1677F0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_SETMOVEMENT_OFFSET UNITYSDK_OFFSET(0xD167760)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_SETWALLBG_OFFSET UNITYSDK_OFFSET(0xD168E50)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_STARTSHOW_OFFSET UNITYSDK_OFFSET(0xD169430)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_STARTUPOBSTACLEITEMS_OFFSET UNITYSDK_OFFSET(0xD169610)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_STOPOBSTACLEITEMS_OFFSET UNITYSDK_OFFSET(0xD169B20)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD1680C0)
#define RPG_CLIENT_PROP_GRAVITYBALLWALLCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD169C90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int GravityBallWallController_TypeDefinitionIndex = 74643;
