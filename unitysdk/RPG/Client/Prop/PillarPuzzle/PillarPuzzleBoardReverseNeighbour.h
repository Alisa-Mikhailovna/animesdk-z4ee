...
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR_INITPILLARPROPS_OFFSET UNITYSDK_OFFSET(0xD1DC600)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR_METHOD_7_FEB104F83913DCF9_OFFSET UNITYSDK_OFFSET(0xD1DC1F0)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR_ONPILLARHIT_OFFSET UNITYSDK_OFFSET(0xD1DC900)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD1DCCB0)

namespace RPG::Client::Prop::PillarPuzzle
{
	inline static constexpr unsigned int PillarPuzzleBoardReverseNeighbour_TypeDefinitionIndex = 75012;
