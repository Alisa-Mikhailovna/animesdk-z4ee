...
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_GETBOXTYPE_OFFSET UNITYSDK_OFFSET(0xD17BC10)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_ISSIDE1_OFFSET UNITYSDK_OFFSET(0xD17BE70)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_METHOD_5_0C5E7E6B860B221F_OFFSET UNITYSDK_OFFSET(0xD17B560)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_METHOD_5_1293CB739F1151A1_OFFSET UNITYSDK_OFFSET(0xD17ACD0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xD17BA50)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_SETINISOMETRIC_OFFSET UNITYSDK_OFFSET(0xD17B9F0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_SETINITSTATE_OFFSET UNITYSDK_OFFSET(0xD17B2A0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_SETLINKERENABLE_OFFSET UNITYSDK_OFFSET(0xD17BBB0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD17BEC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int IsometricViewPuzzleItem_TypeDefinitionIndex = 74689;
