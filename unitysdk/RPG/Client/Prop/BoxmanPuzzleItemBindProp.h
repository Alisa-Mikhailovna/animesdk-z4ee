...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_GET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xD0E5B70)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_361C06486F56B4E7_OFFSET UNITYSDK_OFFSET(0xD0E3B60)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xD0E5AF0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_93DFDE03653CA351_OFFSET UNITYSDK_OFFSET(0xD0E3560)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_SET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xD0E5B80)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E5B90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItemBindProp_TypeDefinitionIndex = 74890;
