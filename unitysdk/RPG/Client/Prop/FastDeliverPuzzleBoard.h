...
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_DESTROYCAMARA_OFFSET UNITYSDK_OFFSET(0xD15B0D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD15B710)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_FINISHROTATESTEP_OFFSET UNITYSDK_OFFSET(0xD152AB0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_GET_PUZZLESTEP_OFFSET UNITYSDK_OFFSET(0xD15FDC0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_INITCAMERA_OFFSET UNITYSDK_OFFSET(0xD154A00)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_INITDATA_OFFSET UNITYSDK_OFFSET(0xD152FF0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD152BA0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_INITVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0xD15A8D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ISENABLEPUZZLEUI_OFFSET UNITYSDK_OFFSET(0xD15E570)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD154F10)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ISZERO_OFFSET UNITYSDK_OFFSET(0xD15C650)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_027D81190483B79F_OFFSET UNITYSDK_OFFSET(0xD15C6C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_0B583D287B1D1E72_OFFSET UNITYSDK_OFFSET(0xD15EF20)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xD15E320)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_22D0ADB352880F38_OFFSET UNITYSDK_OFFSET(0xD15DB80)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_311DDAC730F6D367_OFFSET UNITYSDK_OFFSET(0xD15FAC0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_3BCF0226A6CDC13B_OFFSET UNITYSDK_OFFSET(0xD15C1B0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xD15E800)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD158360)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_5176DC743E478510_OFFSET UNITYSDK_OFFSET(0xD1584F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xD15E980)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xD158850)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_757507C4F0AFCAD2_OFFSET UNITYSDK_OFFSET(0xD156800)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xD155240)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xD15BA50)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0xD154F60)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0xD159D30)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xD154E10)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_A977A1D96BC50369_OFFSET UNITYSDK_OFFSET(0xD15E230)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xD155FD0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_B005DDBE7172D6E5_OFFSET UNITYSDK_OFFSET(0xD158BF0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_B2C52ACF9D9B435B_OFFSET UNITYSDK_OFFSET(0xD15DDB0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xD15A440)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_C521AF86F7597260_OFFSET UNITYSDK_OFFSET(0xD15F680)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xD15DC30)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xD15E630)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0xD15DB30)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_E098C2C2038255DD_OFFSET UNITYSDK_OFFSET(0xD15BC50)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_E67FFDAAD9BAA098_OFFSET UNITYSDK_OFFSET(0xD155060)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xD154CA0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_FD647A48096EB173_OFFSET UNITYSDK_OFFSET(0xD1593E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xD1601D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ONPUZZLEPREFINISH_OFFSET UNITYSDK_OFFSET(0xD15F210)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD15B630)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ROTATEX_OFFSET UNITYSDK_OFFSET(0xD155290)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ROTATEY_OFFSET UNITYSDK_OFFSET(0xD156920)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ROTATEZ_OFFSET UNITYSDK_OFFSET(0xD157640)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETAIMFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD15FDD0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETAVATARTELEPORTCALLBACK_OFFSET UNITYSDK_OFFSET(0xD15FFD0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETDOLLYZOOMSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0xD15FED0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETROTATEPUZZLESTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0xD1600D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETROUTEID_OFFSET UNITYSDK_OFFSET(0xD15FA70)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_STARTAIM_OFFSET UNITYSDK_OFFSET(0xD15A200)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD153640)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xD15C850)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UNSETAIMFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD15FE50)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UNSETAVATARTELEPORTCALLBACK_OFFSET UNITYSDK_OFFSET(0xD160050)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UNSETDOLLYZOOMSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0xD15FF50)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UNSETROTATEPUZZLESTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0xD160150)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UPDATEALLPARAMETER_OFFSET UNITYSDK_OFFSET(0xD152B00)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD160450)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD160310)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONAIMFINISHIMMEDIATELY_B__114_0_OFFSET UNITYSDK_OFFSET(0xD160560)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONAIMFINISHIMMEDIATELY_B__114_1_OFFSET UNITYSDK_OFFSET(0xD1608B0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONAIMFINISH_B__115_0_OFFSET UNITYSDK_OFFSET(0xD1608C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONAIMFINISH_B__115_1_OFFSET UNITYSDK_OFFSET(0xD160B30)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONHACKDEVICEPUZZLEFINISH_B__122_0_OFFSET UNITYSDK_OFFSET(0xD160B40)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__TICKPUZZLE_B__105_1_OFFSET UNITYSDK_OFFSET(0xD160550)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int FastDeliverPuzzleBoard_TypeDefinitionIndex = 74625;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(FastDeliverPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x3660);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_Field_6_1()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(FastDeliverPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x3668);
		}
		static ::RPG::Client::Prop::FastDeliverPuzzleBoard** StaticGet_PlayingBoard()
		{
			return (::RPG::Client::Prop::FastDeliverPuzzleBoard**)Il2CppClass::FromTypeDefinitionIndex(FastDeliverPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x3670);
		}
		static ::System::Int32* StaticGet_Field_6_3()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FastDeliverPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x26C0);
		}
