...
#define RPG_CLIENT_PROP_ROGUECOLLECTIONBUBBLETALK_METHOD_5_755870B55A8B3AFF_OFFSET UNITYSDK_OFFSET(0xD1FBF10)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONBUBBLETALK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD1FC040)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONBUBBLETALK_SETBELONGENTITY_OFFSET UNITYSDK_OFFSET(0xD1FC0A0)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONBUBBLETALK_START_OFFSET UNITYSDK_OFFSET(0xD1FBD90)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONBUBBLETALK_UPDATE_OFFSET UNITYSDK_OFFSET(0xD1FBE20)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0xD1FC0F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RogueCollectionBubbleTalk_TypeDefinitionIndex = 74991;
