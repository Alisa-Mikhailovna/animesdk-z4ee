...
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_CHECKISFINISHFINAL_OFFSET UNITYSDK_OFFSET(0xD1C7A30)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_CHECKISFINISHV2_OFFSET UNITYSDK_OFFSET(0xD1CDAD0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_CHECKISFINISHV3_OFFSET UNITYSDK_OFFSET(0xD1CDD20)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_CLEARPUZZLEHELPERSTATE_OFFSET UNITYSDK_OFFSET(0xD1C87B0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1CD5C0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_EXECUTEPUZZLEHELPER_OFFSET UNITYSDK_OFFSET(0xD1C8FC0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_GETCLIPEDVALIDLOCALPOS_OFFSET UNITYSDK_OFFSET(0xD1CB400)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_GETHOVERMATERIAL_OFFSET UNITYSDK_OFFSET(0xD1CDF40)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_GETPANELHINTTEX_OFFSET UNITYSDK_OFFSET(0xD1CD030)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_GETPANELOUTERHINTTEX_OFFSET UNITYSDK_OFFSET(0xD1CDE20)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_INIT_OFFSET UNITYSDK_OFFSET(0xD1CC520)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_0F2A088CF7BD337E_OFFSET UNITYSDK_OFFSET(0xD1CEF50)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_3AAE6BCB5C643E83_OFFSET UNITYSDK_OFFSET(0xD1CE210)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xD1CEF00)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_8EF43FC3A4ED8F5E_OFFSET UNITYSDK_OFFSET(0xD1CED50)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xD1CEDC0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_A6309623F20EFB07_OFFSET UNITYSDK_OFFSET(0xD1CE540)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_B6BB704B01BCC35B_OFFSET UNITYSDK_OFFSET(0xD1CCB50)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_CFD6A0E3E2AD1441_OFFSET UNITYSDK_OFFSET(0xD1CE010)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_DD152A1A30757DCD_OFFSET UNITYSDK_OFFSET(0xD1CD250)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_METHOD_5_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0xD1CD990)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_PLAYSELECTEDITEMHELPERHINTPERFORM_OFFSET UNITYSDK_OFFSET(0xD1C6940)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_REFRESHBACKGROUNDHINT_OFFSET UNITYSDK_OFFSET(0xD1CD3A0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_RESETOPERATION_OFFSET UNITYSDK_OFFSET(0xD1C9180)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_RESET_OFFSET UNITYSDK_OFFSET(0xD1CD0C0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_STARTFADEINPERFORM_OFFSET UNITYSDK_OFFSET(0xD1CA500)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_STARTFADEOUTPERFORM_OFFSET UNITYSDK_OFFSET(0xD1C95D0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_STARTFINISHFADEOUTPERFORM_OFFSET UNITYSDK_OFFSET(0xD1C8910)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL_TICK_OFFSET UNITYSDK_OFFSET(0xD1CD7D0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD1CF050)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzlePanel_TypeDefinitionIndex = 74782;
