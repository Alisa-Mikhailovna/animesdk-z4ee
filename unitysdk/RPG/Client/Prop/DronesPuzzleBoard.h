...
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD14D660)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0xD150AA0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_GET_ISFORBIDPLAYERINPUT_OFFSET UNITYSDK_OFFSET(0xD1501F0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_GET_ISOVERRIDEDRONEFUNCBTN_OFFSET UNITYSDK_OFFSET(0xD150600)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_GET_NOTIFYADVENTUREFUNCBTNENABLEEFFECTSHOWSTATE_OFFSET UNITYSDK_OFFSET(0xD150AB0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD14BCF0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD14BCB0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0xD1502C0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_32FE792EB1B0F498_OFFSET UNITYSDK_OFFSET(0xD150400)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_3FC5D2EAE16048C0_OFFSET UNITYSDK_OFFSET(0xD14E210)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xD14DFC0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_4358F70A163BCEAE_OFFSET UNITYSDK_OFFSET(0xD14E190)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_7646FFE662147970_1_OFFSET UNITYSDK_OFFSET(0xD14E640)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xD150380)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xD150A40)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_885DF4DA0F709E3E_OFFSET UNITYSDK_OFFSET(0xD14E690)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xD150260)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xD150200)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_A56EAB6E8DBE44E9_OFFSET UNITYSDK_OFFSET(0xD150810)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_A84CEAF7AFA573B3_OFFSET UNITYSDK_OFFSET(0xD14C720)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_B386444429A36A77_OFFSET UNITYSDK_OFFSET(0xD150AC0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_B484DF6A9226D45B_OFFSET UNITYSDK_OFFSET(0xD150760)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0xD14C300)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_C450A961450309C9_1_OFFSET UNITYSDK_OFFSET(0xD1506E0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xD150660)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD14DD30)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_D296277FE17812A6_OFFSET UNITYSDK_OFFSET(0xD14EE90)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_ONMOVEMENTEND_OFFSET UNITYSDK_OFFSET(0xD14ED40)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_RESETDRONESPOSITION_OFFSET UNITYSDK_OFFSET(0xD14DDD0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD14DD80)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_SET_NOTIFYADVENTUREFUNCBTNENABLEEFFECTSHOWSTATE_OFFSET UNITYSDK_OFFSET(0xD14ECC0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_STARTCONTROL_OFFSET UNITYSDK_OFFSET(0xD14CBC0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD14C6D0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_STOPCONTROL_OFFSET UNITYSDK_OFFSET(0xD14D910)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xD14E830)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD__BUILDACHIEVEMENTAREAS_B__14_0_OFFSET UNITYSDK_OFFSET(0xD150DD0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD150BB0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD__INITPUZZLE_B__2_0_OFFSET UNITYSDK_OFFSET(0xD150CB0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD__INITPUZZLE_B__2_1_OFFSET UNITYSDK_OFFSET(0xD150D40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DronesPuzzleBoard_TypeDefinitionIndex = 74609;
