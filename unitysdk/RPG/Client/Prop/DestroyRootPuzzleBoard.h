...
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ACTIVELAUNCHER_OFFSET UNITYSDK_OFFSET(0xD1484D0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xD1474D0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD147510)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD145C90)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD147CE0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ISREFACTORAIMOTHER_OFFSET UNITYSDK_OFFSET(0xD1486E0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_010173A32C39341F_OFFSET UNITYSDK_OFFSET(0xD148120)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xD147060)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0xD148990)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_308ABEB3EBCF889F_OFFSET UNITYSDK_OFFSET(0xD146A50)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xD147B20)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_652F3820D8B242FF_OFFSET UNITYSDK_OFFSET(0xD146400)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_E374F6C9CEE8E680_OFFSET UNITYSDK_OFFSET(0xD148650)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_EB7282B6745B4611_OFFSET UNITYSDK_OFFSET(0xD147680)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_MOVECHESS_OFFSET UNITYSDK_OFFSET(0xD147F80)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ONCHESSACTIONEND_OFFSET UNITYSDK_OFFSET(0xD148740)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD147940)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ROTATECHESS_OFFSET UNITYSDK_OFFSET(0xD148400)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_SETCHESSFINISHSTATE_OFFSET UNITYSDK_OFFSET(0xD1487A0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xD147D30)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD148BE0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD148A10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DestroyRootPuzzleBoard_TypeDefinitionIndex = 74587;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DestroyRootPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x10B0);
		}
