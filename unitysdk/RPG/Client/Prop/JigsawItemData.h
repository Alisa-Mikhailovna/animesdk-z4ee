...
#define RPG_CLIENT_PROP_JIGSAWITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD17BEE0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int JigsawItemData_TypeDefinitionIndex = 74691;
