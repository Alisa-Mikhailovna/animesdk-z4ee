...
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD1658A0)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xD1662B0)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_HIDE_OFFSET UNITYSDK_OFFSET(0xD166140)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_INIT_OFFSET UNITYSDK_OFFSET(0xD165F80)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_METHOD_6_0C247A24E7FC3289_OFFSET UNITYSDK_OFFSET(0xD166870)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD1669E0)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_UPDATESHOWANIMATION_OFFSET UNITYSDK_OFFSET(0xD166190)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD166920)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0xD166A40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int GravityBallLinearMoveObstacle_TypeDefinitionIndex = 74635;
