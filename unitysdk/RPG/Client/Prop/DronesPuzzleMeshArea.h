...
#define RPG_CLIENT_PROP_DRONESPUZZLEMESHAREA_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xD150F20)
#define RPG_CLIENT_PROP_DRONESPUZZLEMESHAREA_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xD150FC0)
#define RPG_CLIENT_PROP_DRONESPUZZLEMESHAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xD151060)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DronesPuzzleMeshArea_TypeDefinitionIndex = 74618;
