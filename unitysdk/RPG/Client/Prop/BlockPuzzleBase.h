...
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_GET_HASINIT_OFFSET UNITYSDK_OFFSET(0xD0DD1C0)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD0DCBC0)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_ISPLAYERONBOARD_OFFSET UNITYSDK_OFFSET(0xD0DCF60)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_METHOD_6_8369B9BE7F06A56A_OFFSET UNITYSDK_OFFSET(0xD0DD170)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_METHOD_6_D2F6A7A22BCB944C_OFFSET UNITYSDK_OFFSET(0xD0DCCF0)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_METHOD_6_DD31BD6ABA02C7FF_OFFSET UNITYSDK_OFFSET(0xD0DCC40)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_WORLDPOSITIONTOBLOCKPOSITION_OFFSET UNITYSDK_OFFSET(0xD0DCE50)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0DD220)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockPuzzleBase_TypeDefinitionIndex = 74261;
