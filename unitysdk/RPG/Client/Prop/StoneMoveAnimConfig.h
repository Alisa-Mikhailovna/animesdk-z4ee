...
#define RPG_CLIENT_PROP_STONEMOVEANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD22F6D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StoneMoveAnimConfig_TypeDefinitionIndex = 74568;
