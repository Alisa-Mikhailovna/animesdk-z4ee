...
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD12DCB0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_AUDIOSOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0xD12DC60)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_INFOPANELANCHOR_OFFSET UNITYSDK_OFFSET(0xD12DC40)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_ISJUMPING_OFFSET UNITYSDK_OFFSET(0xD12DAD0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_TALKPANELANCHOR_OFFSET UNITYSDK_OFFSET(0xD12DC50)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET__CAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xD12DB20)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_REACTDITHERHIDE_OFFSET UNITYSDK_OFFSET(0xD12E640)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_RELOAD_OFFSET UNITYSDK_OFFSET(0xD12E3B0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_SETCAMERATRANSFORM_OFFSET UNITYSDK_OFFSET(0xD12E410)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_SETCOLLIDERENABLED_OFFSET UNITYSDK_OFFSET(0xD12E4D0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_SETVISIBILITY_OFFSET UNITYSDK_OFFSET(0xD12E460)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_STARTDITHERSHOW_OFFSET UNITYSDK_OFFSET(0xD12E530)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_STARTMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xD12E750)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_STOPMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xD12E7B0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_TRYTRIGGERJUMPANIMATION_OFFSET UNITYSDK_OFFSET(0xD12E810)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD12DE10)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xD12E900)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE__PROJECTPIVOTPOSITION_OFFSET UNITYSDK_OFFSET(0xD12E110)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraNewMembersModelInstance_TypeDefinitionIndex = 74533;
