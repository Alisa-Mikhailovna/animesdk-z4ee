...
#define RPG_CLIENT_PROP_GRAVITYBALLPUZZLEREGIONDETECT_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xD166B90)
#define RPG_CLIENT_PROP_GRAVITYBALLPUZZLEREGIONDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0xD166C00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int GravityBallPuzzleRegionDetect_TypeDefinitionIndex = 74637;
