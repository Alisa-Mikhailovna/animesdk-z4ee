...
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0xD1208E0)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_25CD86BF8626C8D9_1_OFFSET UNITYSDK_OFFSET(0xD120A80)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0xD120950)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_306FF05D4DB1C493_OFFSET UNITYSDK_OFFSET(0xD120DD0)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0xD1208F0)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_E11FB2B3A67852DB_OFFSET UNITYSDK_OFFSET(0xD120C00)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD120870)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW__DITHEROUT_B__10_0_OFFSET UNITYSDK_OFFSET(0xD120EA0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelNpcModelView_TypeDefinitionIndex = 74380;
