...
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLESWITCH___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD191950)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLESWITCH___C__DISPLAYCLASS11_0__ONROTATESELECTCLICK_B__1_OFFSET UNITYSDK_OFFSET(0xD1919E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LaserTurnablePuzzleSwitch___c__DisplayClass11_0_TypeDefinitionIndex = 74719;
