...
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_CLOSEUI_OFFSET UNITYSDK_OFFSET(0xD162400)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_DISABLECAMERA_OFFSET UNITYSDK_OFFSET(0xD15B330)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ENABLECAMERA_OFFSET UNITYSDK_OFFSET(0xD159540)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ENDAIM_OFFSET UNITYSDK_OFFSET(0xD15E930)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ENDCONTROL_OFFSET UNITYSDK_OFFSET(0xD161390)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_FORCECAMERAPOSITIONFORWARD_OFFSET UNITYSDK_OFFSET(0xD162440)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xD159870)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETAXISVALUE_OFFSET UNITYSDK_OFFSET(0xD1627A0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETDISTANCEBYFOVDEGREE_1_OFFSET UNITYSDK_OFFSET(0xD162AC0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETDISTANCEBYFOVDEGREE_OFFSET UNITYSDK_OFFSET(0xD15E780)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETW_OFFSET UNITYSDK_OFFSET(0xD1607D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_INITCAMERALIMIT_OFFSET UNITYSDK_OFFSET(0xD159800)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xD15A7F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_3F41C18B18C95AA8_OFFSET UNITYSDK_OFFSET(0xD1629E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xD162160)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0xD161A40)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD1623B0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0xD162840)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_E7882E2DCB48277F_OFFSET UNITYSDK_OFFSET(0xD162960)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_E9A8695D8BBAA196_OFFSET UNITYSDK_OFFSET(0xD162900)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD161340)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_PLAYDOLLYZOOM_OFFSET UNITYSDK_OFFSET(0xD15E050)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0xD162800)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_SETAIM_OFFSET UNITYSDK_OFFSET(0xD159BF0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_SETFOV_OFFSET UNITYSDK_OFFSET(0xD159910)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_STARTAIM_OFFSET UNITYSDK_OFFSET(0xD15A7A0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_STARTCAMERAANIM_OFFSET UNITYSDK_OFFSET(0xD15EC40)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_STARTCONTROL_OFFSET UNITYSDK_OFFSET(0xD159980)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD1616A0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD162B80)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER__REGISTERINPUT_OFFSET UNITYSDK_OFFSET(0xD1588E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER__UNREGISTERINPUT_OFFSET UNITYSDK_OFFSET(0xD15C340)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int FastDeliverPuzzleCameraController_TypeDefinitionIndex = 74629;
