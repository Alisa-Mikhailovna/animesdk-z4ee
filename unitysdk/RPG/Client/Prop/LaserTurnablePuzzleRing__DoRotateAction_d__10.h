...
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD190040)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD190870)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD1908D0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD190880)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD190030)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__DOROTATEACTION_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0xD18FA70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LaserTurnablePuzzleRing__DoRotateAction_d__10_TypeDefinitionIndex = 74715;
	...
	public:
		...
		::System::Single _clock_5__7; // 0x20
		::System::Single _st_5__6; // 0x24
		::System::Nullable_1<::System::Single> forceTime; // 0x28
		::System::Int32 cnt; // 0x30
		::System::Single _closeWait_5__8; // 0x34
		::System::Single _fElapsedTimeInSec_5__9; // 0x38
		::System::Int32 nowDegree; // 0x3C
