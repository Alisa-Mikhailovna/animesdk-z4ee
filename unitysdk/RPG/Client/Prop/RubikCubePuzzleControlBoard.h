...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_BINDDUMMYTOUI_OFFSET UNITYSDK_OFFSET(0xD218060)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_CALCBILLBOARDSCREENROTATE_OFFSET UNITYSDK_OFFSET(0xD219200)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_DESTROYBOARD_OFFSET UNITYSDK_OFFSET(0xD217100)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ENDCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xD217800)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_GETGROUP_OFFSET UNITYSDK_OFFSET(0xD217F60)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITBOARD_1_OFFSET UNITYSDK_OFFSET(0xD216120)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITBOARD_2_OFFSET UNITYSDK_OFFSET(0xD215CA0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITBOARD_OFFSET UNITYSDK_OFFSET(0xD20FE60)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITCAMERA_OFFSET UNITYSDK_OFFSET(0xD216F30)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITDUMMYBLOCK_OFFSET UNITYSDK_OFFSET(0xD216180)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_0D372435D9CAE4BC_OFFSET UNITYSDK_OFFSET(0xD21B530)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_13275269230D5342_OFFSET UNITYSDK_OFFSET(0xD21B460)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_1B4BF40856AAD721_OFFSET UNITYSDK_OFFSET(0xD21B3C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_2C5421072C50A323_OFFSET UNITYSDK_OFFSET(0xD21C690)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD2176C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_4358F70A163BCEAE_OFFSET UNITYSDK_OFFSET(0xD21A810)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0xD217A10)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xD21B940)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_7AAD06186762BE3C_OFFSET UNITYSDK_OFFSET(0xD21B810)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_7E2B87FDCB5FCF51_OFFSET UNITYSDK_OFFSET(0xD21B1B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_86D9A88811BF5A61_OFFSET UNITYSDK_OFFSET(0xD21AF70)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_95AA09851A266DE3_OFFSET UNITYSDK_OFFSET(0xD21CFB0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_A0D8189C4327374C_OFFSET UNITYSDK_OFFSET(0xD21B9C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xD21C580)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_AAD21DE195D05736_1_OFFSET UNITYSDK_OFFSET(0xD217C50)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_AAD21DE195D05736_OFFSET UNITYSDK_OFFSET(0xD21AAE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_BCFFE6CBFC0AF90C_OFFSET UNITYSDK_OFFSET(0xD2196F0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_F11610AE8CED7CFB_OFFSET UNITYSDK_OFFSET(0xD2174D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_FB705BB9253CCF6A_OFFSET UNITYSDK_OFFSET(0xD21CB30)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONCLICKACTION0_OFFSET UNITYSDK_OFFSET(0xD21AEF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONCLICKACTION1_OFFSET UNITYSDK_OFFSET(0xD21B130)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONCLICKEXIT_OFFSET UNITYSDK_OFFSET(0xD21AE60)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD217720)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONINPUTDEVICECLASSSWITCHED_OFFSET UNITYSDK_OFFSET(0xD217390)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD21ADF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONRELOAD_OFFSET UNITYSDK_OFFSET(0xD219B50)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONSELECTORDER_OFFSET UNITYSDK_OFFSET(0xD219C70)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONSTARTCONTROL_OFFSET UNITYSDK_OFFSET(0xD217610)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONSTARTROTATE_OFFSET UNITYSDK_OFFSET(0xD219550)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_REFRESHATTACHDUMMYBLOCKROTATION_OFFSET UNITYSDK_OFFSET(0xD2190C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_REFRESHDUMMYBLOCKATTACH_OFFSET UNITYSDK_OFFSET(0xD218140)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_REFRESHXZDUMMYBLOCKATTACH_OFFSET UNITYSDK_OFFSET(0xD2181E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_REFRESHYDUMMYBLOCKATTACH_OFFSET UNITYSDK_OFFSET(0xD218680)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_RESETCONTROLBOARD_OFFSET UNITYSDK_OFFSET(0xD2109C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_STARTCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xD21A8A0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_UNBINDDUMMYFROMUI_OFFSET UNITYSDK_OFFSET(0xD2180D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xD21A140)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD21D120)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD21D0D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleControlBoard_TypeDefinitionIndex = 74871;
	...
	public:
		...
		{
			return (::Il2CppArray<::RPG::Client::Prop::RubikCubePuzzleAxis>**)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0xCCE0);
		}
		static ::Il2CppArray<::RPG::Client::Prop::RubikCubePuzzleAxis>** StaticGet_Field_5_1()
		{
			return (::Il2CppArray<::RPG::Client::Prop::RubikCubePuzzleAxis>**)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0xCCE8);
		}
		static ::Il2CppArray<::RPG::Client::Prop::RubikCubeGroup>** StaticGet_Field_5_2()
		{
			return (::Il2CppArray<::RPG::Client::Prop::RubikCubeGroup>**)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0xCCF0);
		}
		static ::System::Single* StaticGet_Field_5_3()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0x4A70);
		}
		static ::System::Int32* StaticGet_Field_5_4()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0x4A74);
		}
