...
#define RPG_CLIENT_PROP_CHIMERAVIEWBUILDER_METHOD_5_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0xD1345A0)
#define RPG_CLIENT_PROP_CHIMERAVIEWBUILDER_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xD134430)
#define RPG_CLIENT_PROP_CHIMERAVIEWBUILDER_START_OFFSET UNITYSDK_OFFSET(0xD1343E0)
#define RPG_CLIENT_PROP_CHIMERAVIEWBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0xD134CE0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraViewBuilder_TypeDefinitionIndex = 74549;
