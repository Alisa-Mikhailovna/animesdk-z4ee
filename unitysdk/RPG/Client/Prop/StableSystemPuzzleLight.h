...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLELIGHT_INITLIGHT_OFFSET UNITYSDK_OFFSET(0xD22E2C0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLELIGHT_SETSELECTEDNUMBER_OFFSET UNITYSDK_OFFSET(0xD22E3C0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLELIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0xD22E4D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleLight_TypeDefinitionIndex = 74917;
