...
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCANVASADAPTINGSCALER_METHOD_5_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xD104930)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCANVASADAPTINGSCALER_UPDATECANVASSCALEACCORDINGTOSCREENRATIO_OFFSET UNITYSDK_OFFSET(0xD0FC940)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCANVASADAPTINGSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0xD104A60)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraBillboardCanvasAdaptingScaler_TypeDefinitionIndex = 74511;
