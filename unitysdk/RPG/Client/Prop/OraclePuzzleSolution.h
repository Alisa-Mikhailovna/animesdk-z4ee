...
#define RPG_CLIENT_PROP_ORACLEPUZZLESOLUTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD1CF140)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzleSolution_TypeDefinitionIndex = 74778;
