...
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_ANIMATIONTOTARGETCOL_OFFSET UNITYSDK_OFFSET(0xD2597B0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_DELAYSHOW_OFFSET UNITYSDK_OFFSET(0xD260A10)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_ENABLEROUTEEFFECT_OFFSET UNITYSDK_OFFSET(0xD25D670)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_INITRING_OFFSET UNITYSDK_OFFSET(0xD256460)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_LOGICTOTARGETCOL_OFFSET UNITYSDK_OFFSET(0xD2623C0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_REFRESHOBJECTSTATUS_OFFSET UNITYSDK_OFFSET(0xD2568D0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_SELECT_OFFSET UNITYSDK_OFFSET(0xD25F340)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD262060)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2626B0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER__DELAYSHOW_B__21_0_OFFSET UNITYSDK_OFFSET(0xD2626C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WormCompassPuzzleRingController_TypeDefinitionIndex = 74978;
