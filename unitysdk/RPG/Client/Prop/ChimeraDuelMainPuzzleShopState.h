...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GETKEYMAPANCHOR_OFFSET UNITYSDK_OFFSET(0xD11D820)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GETPROXY_OFFSET UNITYSDK_OFFSET(0xD11DC80)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GETTEAMMEMBERSLOT_OFFSET UNITYSDK_OFFSET(0xD11D7A0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET_DRAGGEDCHIMERASLOT_OFFSET UNITYSDK_OFFSET(0xD11C9B0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET_TEAMMEMBERSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0xD11D750)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET_VIEW_OFFSET UNITYSDK_OFFSET(0xD11C900)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET__STATETYPE_OFFSET UNITYSDK_OFFSET(0xD11C830)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET__UINAME_OFFSET UNITYSDK_OFFSET(0xD11C8C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET__UIPATH_OFFSET UNITYSDK_OFFSET(0xD11C880)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_INSTANTIATEBILLBOARD_OFFSET UNITYSDK_OFFSET(0xD11D660)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0xD11CAE0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0xD11D230)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_PLAYPERFORMANCEANDGETCANCELHANDLER_OFFSET UNITYSDK_OFFSET(0xD11D8F0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_PREPAREENTERBYUI_OFFSET UNITYSDK_OFFSET(0xD11CAA0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_REMOVEPROXY_OFFSET UNITYSDK_OFFSET(0xD11DDC0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_RPG_CLIENT_PROP_IDUELCHIMERAPROXYCONTAINER_GETPROXIES_OFFSET UNITYSDK_OFFSET(0xD11DC00)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_SET_DRAGGEDCHIMERASLOT_OFFSET UNITYSDK_OFFSET(0xD11C9C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xD11C9D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xD11D4A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleShopState_TypeDefinitionIndex = 74430;
	...
	public:
		...
		::Class_1_085A149A901F5E47* _PerformancePlayer; // 0x38
		::RPG::Client::Prop::ChimeraDuelShopDraggedChimeraSlot* _DraggedChimeraSlot_k__BackingField; // 0x40
