...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD0E51D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD0E5820)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD0E5880)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD0E5830)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD0E51C0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E4010)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItem__StartInteract_d__5_TypeDefinitionIndex = 74895;
