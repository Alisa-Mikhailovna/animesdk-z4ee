...
#define RPG_CLIENT_PROP_POLYGONMESH_METHOD_1_E8947406FBA55064_OFFSET UNITYSDK_OFFSET(0xD1CC0A0)
#define RPG_CLIENT_PROP_POLYGONMESH_METHOD_1_EA6474AC2169BCED_OFFSET UNITYSDK_OFFSET(0xD1F0A10)
#define RPG_CLIENT_PROP_POLYGONMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xD1F0C20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PolygonMesh_TypeDefinitionIndex = 74771;
