...
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER_BUILDCARINUI3D_OFFSET UNITYSDK_OFFSET(0xD12C250)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER_BUILDCHIMERA_OFFSET UNITYSDK_OFFSET(0xD12A590)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER_GET__BODYCONSTVALUE_OFFSET UNITYSDK_OFFSET(0xD12C920)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD12C740)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD12C6F0)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD12C6A0)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER_SETSHADOWCASTINGENABLED_OFFSET UNITYSDK_OFFSET(0xD12ABB0)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__BUILDBLUSH_OFFSET UNITYSDK_OFFSET(0xD12AE40)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__BUILDBODY_OFFSET UNITYSDK_OFFSET(0xD12B060)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__BUILDEYE_OFFSET UNITYSDK_OFFSET(0xD12BC00)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__BUILDFACE_OFFSET UNITYSDK_OFFSET(0xD12B410)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__BUILDITEMS_OFFSET UNITYSDK_OFFSET(0xD12B840)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__CREATEMATERIALPARTCONFIG_OFFSET UNITYSDK_OFFSET(0xD12CA30)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0xD12CDD0)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__FETCHMODELBODYFIX_OFFSET UNITYSDK_OFFSET(0xD12C790)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__GETCARROOT_OFFSET UNITYSDK_OFFSET(0xD12CAD0)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__GETCHARIOTSTATE_OFFSET UNITYSDK_OFFSET(0xD12CC80)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__GETCHIMERACONFIG_OFFSET UNITYSDK_OFFSET(0xD12C880)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__GETDEFAULTMATERIALINFIX_OFFSET UNITYSDK_OFFSET(0xD12C830)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__ISVALID_OFFSET UNITYSDK_OFFSET(0xD12ADE0)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__TRYBUILDCAR_OFFSET UNITYSDK_OFFSET(0xD12BCB0)
#define RPG_CLIENT_PROP_CHIMERAGAMEOBJECTBUILDER__TRYSETWWISESWITCH_OFFSET UNITYSDK_OFFSET(0xD12C100)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraGameObjectBuilder_TypeDefinitionIndex = 74499;
