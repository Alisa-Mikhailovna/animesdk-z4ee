...
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xD2627A0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_METHOD_5_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xD262C20)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD2628C0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_REMOVEROTATE_OFFSET UNITYSDK_OFFSET(0xD25FD40)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_ROTATE_OFFSET UNITYSDK_OFFSET(0xD25D550)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xD2629E0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xD262CB0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY__ONROTATEREMOVE_OFFSET UNITYSDK_OFFSET(0xD262BB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WormCompassPuzzleRotateProxy_TypeDefinitionIndex = 74979;
