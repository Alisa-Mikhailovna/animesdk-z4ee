...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBLOCKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD20EC20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleBlockData_TypeDefinitionIndex = 74874;
