...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xD1934E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD193580)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD192270)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_METHOD_6_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0xD1936E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_METHOD_6_B454E4E62FBBD6FC_OFFSET UNITYSDK_OFFSET(0xD193520)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_REGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD194260)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD1934A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_ROTATECUBE_OFFSET UNITYSDK_OFFSET(0xD1938C0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_SELECTCUBEGROUP_OFFSET UNITYSDK_OFFSET(0xD193D20)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD193460)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_UNREGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD1944F0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD194770)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleBoard_TypeDefinitionIndex = 74723;
