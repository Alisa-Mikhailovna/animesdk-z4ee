...
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE_METHOD_5_8A9E4FD6EC45F453_OFFSET UNITYSDK_OFFSET(0xD1FD870)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD1FD970)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD1FD920)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE_SETNOUSDICEBRANCH_OFFSET UNITYSDK_OFFSET(0xD1FD470)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE__CTOR_OFFSET UNITYSDK_OFFSET(0xD1FDA40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RogueCollectionNousDice_TypeDefinitionIndex = 74993;
