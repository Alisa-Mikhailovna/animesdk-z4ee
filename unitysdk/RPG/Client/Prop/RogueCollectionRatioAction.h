...
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_METHOD_5_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0xD1FE2E0)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD1FDC00)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_METHOD_5_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0xD1FDCE0)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD1FDC50)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_START_OFFSET UNITYSDK_OFFSET(0xD1FDA50)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xD1FDAE0)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD1FE350)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION___LOADACTIONEFFECT_B__5_0_OFFSET UNITYSDK_OFFSET(0xD1FE360)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RogueCollectionRatioAction_TypeDefinitionIndex = 74994;
