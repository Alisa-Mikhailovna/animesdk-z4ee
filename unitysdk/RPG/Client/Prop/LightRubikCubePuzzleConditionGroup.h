...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_CHECKBLOCK_OFFSET UNITYSDK_OFFSET(0xD194E40)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1948B0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD194D90)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_INITCONDITIONGROUP_OFFSET UNITYSDK_OFFSET(0xD192E00)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0xD194AA0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xD195370)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleConditionGroup_TypeDefinitionIndex = 74725;
