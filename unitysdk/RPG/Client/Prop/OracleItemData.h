...
#define RPG_CLIENT_PROP_ORACLEITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD1C1F30)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OracleItemData_TypeDefinitionIndex = 74775;
