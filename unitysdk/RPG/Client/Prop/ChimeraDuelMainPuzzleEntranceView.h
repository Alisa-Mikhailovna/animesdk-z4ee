...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xD118720)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1187F0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_GETCHIMERADUELGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xD1182D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_LOADLINEUP_OFFSET UNITYSDK_OFFSET(0xD117D70)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0xD119090)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_36D9A2B328C51377_OFFSET UNITYSDK_OFFSET(0xD118F40)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_3A08FD6F6C9BA32C_OFFSET UNITYSDK_OFFSET(0xD118930)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD118660)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_D958BE5293B4CE71_OFFSET UNITYSDK_OFFSET(0xD118C90)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD1191E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleEntranceView_TypeDefinitionIndex = 74421;
