...
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_09124A4A24353C26_OFFSET UNITYSDK_OFFSET(0xD0C96D0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_100C37D9D1141569_OFFSET UNITYSDK_OFFSET(0xD0C4B80)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_3DB6944F89094FEC_OFFSET UNITYSDK_OFFSET(0xD0C39C0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0xD0C9180)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_6D006271A1FDA1A1_OFFSET UNITYSDK_OFFSET(0xD0C85E0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_B45A873CFEB6DEE0_OFFSET UNITYSDK_OFFSET(0xD0C5540)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_B75D122F21CFAD25_OFFSET UNITYSDK_OFFSET(0xD0C42B0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_B93DCFC57470A0D2_OFFSET UNITYSDK_OFFSET(0xD0C6A70)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_C3E4F3CB916E5633_OFFSET UNITYSDK_OFFSET(0xD0C3060)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_D1305BC17A89C222_OFFSET UNITYSDK_OFFSET(0xD0C29D0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_D4248573D6F716B1_OFFSET UNITYSDK_OFFSET(0xD0C6D30)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_F026F9F94BAA5E1F_1_OFFSET UNITYSDK_OFFSET(0xD0C6B80)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0xD0C6B20)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C9780)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE___REGENERATENOREUSE_B__11_0_OFFSET UNITYSDK_OFFSET(0xD0C9830)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE___REGENERATENOREUSE_B__11_1_OFFSET UNITYSDK_OFFSET(0xD0C9840)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int AdjustContainer_ContainerInstance_TypeDefinitionIndex = 74239;
