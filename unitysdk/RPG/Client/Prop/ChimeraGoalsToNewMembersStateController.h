...
#define RPG_CLIENT_PROP_CHIMERAGOALSTONEWMEMBERSSTATECONTROLLER_GET_STATE_OFFSET UNITYSDK_OFFSET(0xD12D010)
#define RPG_CLIENT_PROP_CHIMERAGOALSTONEWMEMBERSSTATECONTROLLER_METHOD_6_2A202130FB8733FC_OFFSET UNITYSDK_OFFSET(0xD12D8F0)
#define RPG_CLIENT_PROP_CHIMERAGOALSTONEWMEMBERSSTATECONTROLLER_ONENTER_OFFSET UNITYSDK_OFFSET(0xD12D060)
#define RPG_CLIENT_PROP_CHIMERAGOALSTONEWMEMBERSSTATECONTROLLER_ONEXIT_OFFSET UNITYSDK_OFFSET(0xD12D3A0)
#define RPG_CLIENT_PROP_CHIMERAGOALSTONEWMEMBERSSTATECONTROLLER_REACTPLAYPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xD12D4B0)
#define RPG_CLIENT_PROP_CHIMERAGOALSTONEWMEMBERSSTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD12DA10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraGoalsToNewMembersStateController_TypeDefinitionIndex = 74542;
