...
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_BLOCKCOORD2LOCALPOS_OFFSET UNITYSDK_OFFSET(0xD185C80)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_CLEARALLMOVEALBEITEMS_OFFSET UNITYSDK_OFFSET(0xD185E80)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_CREATEMOVEABLEITEMFROMUI_OFFSET UNITYSDK_OFFSET(0xD184BA0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD17FED0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_FRAMEPOS2LOCALPOS_OFFSET UNITYSDK_OFFSET(0xD189160)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_GETACTIVEITEM_OFFSET UNITYSDK_OFFSET(0xD184B50)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_GETCLAMPEDPOINT_OFFSET UNITYSDK_OFFSET(0xD183620)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_GETINBOXITEMSCOUNT_OFFSET UNITYSDK_OFFSET(0xD186200)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_GETINBOXITEMS_OFFSET UNITYSDK_OFFSET(0xD185F20)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD17BF00)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ISCURSORACTIVE_OFFSET UNITYSDK_OFFSET(0xD17F0C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD17FE80)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ISVERTICALMODE_OFFSET UNITYSDK_OFFSET(0xD184B00)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0xD17D430)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_LOADJIGSAWCONFIG_OFFSET UNITYSDK_OFFSET(0xD17C450)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_LOCALPOS2BLOCKCOORD_OFFSET UNITYSDK_OFFSET(0xD185BB0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_LOCALPOS2FRAMEPOS_OFFSET UNITYSDK_OFFSET(0xD1890D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERJOYSTICKINPUT_OFFSET UNITYSDK_OFFSET(0xD181300)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERJOYSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0xD1816E0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERPRESSMENUCANCEL_OFFSET UNITYSDK_OFFSET(0xD181D60)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERPRESSMENUCONFIRM_OFFSET UNITYSDK_OFFSET(0xD181740)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERPRESSMENU_OFFSET UNITYSDK_OFFSET(0xD1823B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERPRESSX_OFFSET UNITYSDK_OFFSET(0xD181F90)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONDRAGGINGITEMBEGIN_OFFSET UNITYSDK_OFFSET(0xD183000)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONDRAGGINGITEMEND_OFFSET UNITYSDK_OFFSET(0xD180F30)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONDRAGGINGITEM_OFFSET UNITYSDK_OFFSET(0xD1838F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONHOVERITEM_OFFSET UNITYSDK_OFFSET(0xD1826D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONPUZZLEINTERACTUPDATE_OFFSET UNITYSDK_OFFSET(0xD17DCE0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONQUIT_OFFSET UNITYSDK_OFFSET(0xD17F530)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONSELECTITEMUP_OFFSET UNITYSDK_OFFSET(0xD182CE0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0xD182C10)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_REFRESHBOARD_OFFSET UNITYSDK_OFFSET(0xD183E20)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0xD1840E0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_REGENBOARD_OFFSET UNITYSDK_OFFSET(0xD183DE0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_RELEASELASTACTIVEITEM_OFFSET UNITYSDK_OFFSET(0xD182F90)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_RESET_OFFSET UNITYSDK_OFFSET(0xD17C540)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ROTATEONCE_OFFSET UNITYSDK_OFFSET(0xD185ED0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETACTIVEITEM_OFFSET UNITYSDK_OFFSET(0xD1819C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETANIMATORSENABLE_OFFSET UNITYSDK_OFFSET(0xD17C790)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETCURSORACTIVE_OFFSET UNITYSDK_OFFSET(0xD180CD0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETCURSORVISIBLE_OFFSET UNITYSDK_OFFSET(0xD183D00)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETGAMEFINISH_OFFSET UNITYSDK_OFFSET(0xD1807D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETINNERUIRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD186340)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETINTERACTON_OFFSET UNITYSDK_OFFSET(0xD17F8E0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETUIRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD1862F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SHOWDEFAULTCURSOR_OFFSET UNITYSDK_OFFSET(0xD1809F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SHOWJOYSTICKCURSOR_OFFSET UNITYSDK_OFFSET(0xD185D30)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD17C940)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_TRYAUTOABSORBITEM_OFFSET UNITYSDK_OFFSET(0xD183210)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_TRYHIGHLIGHTCURSOR_OFFSET UNITYSDK_OFFSET(0xD17F130)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD1893C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__CHECKISGAMEFINISH_OFFSET UNITYSDK_OFFSET(0xD1873A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__CONFIGBOARDITEM_OFFSET UNITYSDK_OFFSET(0xD1865B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD1891F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__FOLLOWATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xD17DA30)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__GETBOARDITEM_OFFSET UNITYSDK_OFFSET(0xD1868F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__GETMOVEABLEITEM_OFFSET UNITYSDK_OFFSET(0xD186C80)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__GETSUCCESSITEM_OFFSET UNITYSDK_OFFSET(0xD1869E0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__HASFULLNEIGHBOURBOARDITEM_OFFSET UNITYSDK_OFFSET(0xD187020)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__HIDEOUTLINE_OFFSET UNITYSDK_OFFSET(0xD188480)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__HIGHLIGHTPUZZLEBOARD_OFFSET UNITYSDK_OFFSET(0xD17D1A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__HIGHLIGHTROATETIP_OFFSET UNITYSDK_OFFSET(0xD185AF0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__INITBACKGROUNDHINT_OFFSET UNITYSDK_OFFSET(0xD184410)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__INITDISSOLVEPARAMS_OFFSET UNITYSDK_OFFSET(0xD187B10)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__INITFRAMERECTS_OFFSET UNITYSDK_OFFSET(0xD17CD30)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISFULLBOARDITEM_OFFSET UNITYSDK_OFFSET(0xD186F20)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISINAUTOABSORBAREA_OFFSET UNITYSDK_OFFSET(0xD17EB70)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISINBOARDAREA_OFFSET UNITYSDK_OFFSET(0xD17F030)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISMOVEABLEITEMALREADYCREATED_OFFSET UNITYSDK_OFFSET(0xD185430)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISSHAPEMATCH_OFFSET UNITYSDK_OFFSET(0xD1872A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISTARGETFULL_OFFSET UNITYSDK_OFFSET(0xD186FB0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__JIGSAWPUZZLEBEGINDATAREPORT_OFFSET UNITYSDK_OFFSET(0xD17D2F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__JIGSAWPUZZLEENDDATAREPORT_OFFSET UNITYSDK_OFFSET(0xD17FB40)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOADBOARDEFFECT_OFFSET UNITYSDK_OFFSET(0xD17CE10)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOADCURSORITEM_OFFSET UNITYSDK_OFFSET(0xD183A70)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOADSUCCESSEFFECT_OFFSET UNITYSDK_OFFSET(0xD1875D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOCALPOS2SCREENPOS_OFFSET UNITYSDK_OFFSET(0xD181A90)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOCALPOS2WORLDPOS_OFFSET UNITYSDK_OFFSET(0xD188F20)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONARTMODELLOAD_OFFSET UNITYSDK_OFFSET(0xD186450)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONARTMODELUNLOAD_OFFSET UNITYSDK_OFFSET(0xD186500)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONCONTROLLERPRESSX_B__14_0_OFFSET UNITYSDK_OFFSET(0xD189470)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONEVENT_OFFSET UNITYSDK_OFFSET(0xD1803C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONGAMEFINISH_OFFSET UNITYSDK_OFFSET(0xD1874B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONNOTIFYSWITCHTOJOYSTICK_OFFSET UNITYSDK_OFFSET(0xD180810)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONSETFINISHPUZZLE_OFFSET UNITYSDK_OFFSET(0xD180750)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__OVERRIDEARTMODELPOSEANIMATION_OFFSET UNITYSDK_OFFSET(0xD1845A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__PLAYDISSOLVECURVEANIMATION_OFFSET UNITYSDK_OFFSET(0xD1889D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__PLAYOUTLINEFADEANIAMTION_OFFSET UNITYSDK_OFFSET(0xD1805D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__REFRESHMOVEITEMSRENDERORDER_OFFSET UNITYSDK_OFFSET(0xD187900)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__RESETARTMODELPOSEANIMATION_OFFSET UNITYSDK_OFFSET(0xD180260)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__RETURNALLITEMSTOUIBOX_OFFSET UNITYSDK_OFFSET(0xD182470)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__RETURNCURSORTOUIBOX_OFFSET UNITYSDK_OFFSET(0xD181F30)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__RETURNITEMTOUIBOX_OFFSET UNITYSDK_OFFSET(0xD17EA10)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETBOARDDISSOLVERATE_OFFSET UNITYSDK_OFFSET(0xD188650)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETBOARDOUTLINEOFFSET_OFFSET UNITYSDK_OFFSET(0xD188BD0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETDISSOLVEPROGRESS_OFFSET UNITYSDK_OFFSET(0xD17D790)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETFRAMEDISSOLVERATE_OFFSET UNITYSDK_OFFSET(0xD188840)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETMOVEABLEITEMORDER2TOP_OFFSET UNITYSDK_OFFSET(0xD182AF0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SHOWJOYSTICKCURSOR_OFFSET UNITYSDK_OFFSET(0xD181BD0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__TRIGGEROUTLINEFADEPERFORM_OFFSET UNITYSDK_OFFSET(0xD188DC0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__TRYAUTOABSORBPENDINGITEMS_OFFSET UNITYSDK_OFFSET(0xD186390)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__TRYGETBOARDLOCALPOS_OFFSET UNITYSDK_OFFSET(0xD185630)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__TRYUPDATECURLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xD181620)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__WORLDPOS2SCREENPOS_OFFSET UNITYSDK_OFFSET(0xD188FF0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___ONEVENT_B__7_0_OFFSET UNITYSDK_OFFSET(0xD1893F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int JigsawPuzzleBoard_TypeDefinitionIndex = 74694;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(JigsawPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x4D80);
		}
		static ::RPG::Client::JigsawCommonConfig** StaticGet_JigsawConfig()
		{
			return (::RPG::Client::JigsawCommonConfig**)Il2CppClass::FromTypeDefinitionIndex(JigsawPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x4D88);
		}
		static ::System::String** StaticGet_JIGSAW_CONFIG_PATH()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(JigsawPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x4D90);
		}
