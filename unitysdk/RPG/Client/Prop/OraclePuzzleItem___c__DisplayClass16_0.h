...
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD1CBF60)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM___C__DISPLAYCLASS16_0__MOVETOTARGETPOSPERFORM_B__0_OFFSET UNITYSDK_OFFSET(0xD1CC280)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM___C__DISPLAYCLASS16_0__MOVETOTARGETPOSPERFORM_B__1_OFFSET UNITYSDK_OFFSET(0xD1CC3A0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM___C__DISPLAYCLASS16_0__MOVETOTARGETPOSPERFORM_B__2_OFFSET UNITYSDK_OFFSET(0xD1CC500)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzleItem___c__DisplayClass16_0_TypeDefinitionIndex = 74777;
