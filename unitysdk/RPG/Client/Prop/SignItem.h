...
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD229480)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_2A6E71BD882634D2_OFFSET UNITYSDK_OFFSET(0xD228F30)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xD229380)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD229440)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0xD2292C0)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_805C56F44231AEF9_1_OFFSET UNITYSDK_OFFSET(0xD229650)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0xD2294E0)
#define RPG_CLIENT_PROP_SIGNITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD2297C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int SignItem_TypeDefinitionIndex = 74906;
