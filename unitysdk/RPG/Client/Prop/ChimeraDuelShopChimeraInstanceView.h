...
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_0094A08E076C3CCD_OFFSET UNITYSDK_OFFSET(0xD1225E0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0xD122860)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_38BA5162C5819E36_OFFSET UNITYSDK_OFFSET(0xD122FC0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xD122DB0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_755870B55A8B3AFF_OFFSET UNITYSDK_OFFSET(0xD122F10)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_7A4EB7A4DA062DE3_OFFSET UNITYSDK_OFFSET(0xD122930)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_7D21D8548943D577_OFFSET UNITYSDK_OFFSET(0xD122210)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_8CA05BCD86E125DF_OFFSET UNITYSDK_OFFSET(0xD122460)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_D33BA2B6C0CF2EDA_OFFSET UNITYSDK_OFFSET(0xD122260)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD123070)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelShopChimeraInstanceView_TypeDefinitionIndex = 74386;
