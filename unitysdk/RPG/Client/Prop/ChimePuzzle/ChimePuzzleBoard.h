...
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_DIMALLBOARD_OFFSET UNITYSDK_OFFSET(0xD0F73A0)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD0F6BE0)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD0F5C70)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_METHOD_6_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0xD0F7EB0)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_METHOD_6_4438B031809D397B_OFFSET UNITYSDK_OFFSET(0xD0F6C40)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_METHOD_6_50F03662731E0345_OFFSET UNITYSDK_OFFSET(0xD0F7F40)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_METHOD_6_61929A3103595552_OFFSET UNITYSDK_OFFSET(0xD0F6920)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_METHOD_6_7F4EBEC55EBE2D81_OFFSET UNITYSDK_OFFSET(0xD0F6F80)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_METHOD_6_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0xD0F7690)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_METHOD_6_E495EFFB22D4AFAB_OFFSET UNITYSDK_OFFSET(0xD0F7890)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_METHOD_6_E885EC74FCEE16A4_OFFSET UNITYSDK_OFFSET(0xD0F5D40)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD0F7240)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_SETCHIMEWRONGSTATE_OFFSET UNITYSDK_OFFSET(0xD0F7550)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD_SHOWBOARD_OFFSET UNITYSDK_OFFSET(0xD0F7490)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD0F8500)
#define RPG_CLIENT_PROP_CHIMEPUZZLE_CHIMEPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD0F82E0)

namespace RPG::Client::Prop::ChimePuzzle
{
	inline static constexpr unsigned int ChimePuzzleBoard_TypeDefinitionIndex = 75032;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::RPG::Client::Prop::ChimePuzzle::ChimeType, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ChimePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x6B7D0);
		}
