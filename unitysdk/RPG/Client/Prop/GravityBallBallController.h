...
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD1635B0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xD163860)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_GETBLLSTATE_OFFSET UNITYSDK_OFFSET(0xD164120)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_16548462D618EA0D_OFFSET UNITYSDK_OFFSET(0xD164440)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_570C5557A774C69E_1_OFFSET UNITYSDK_OFFSET(0xD164EE0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_570C5557A774C69E_OFFSET UNITYSDK_OFFSET(0xD164E10)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xD164FB0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0xD163CE0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xD1638C0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_D0EAB95EE152A65F_OFFSET UNITYSDK_OFFSET(0xD163960)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_F95252B816F4814F_OFFSET UNITYSDK_OFFSET(0xD164600)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONBALLAPPEAR_OFFSET UNITYSDK_OFFSET(0xD163E20)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONBALLOUTOFPUZZLE_OFFSET UNITYSDK_OFFSET(0xD163F10)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xD1641B0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0xD164880)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0xD164930)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD163810)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_RESETDSTTARGET_OFFSET UNITYSDK_OFFSET(0xD164090)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_SETGRAVITYAFFECT_OFFSET UNITYSDK_OFFSET(0xD164160)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD1637B0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD165530)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER__ONEXIT_OFFSET UNITYSDK_OFFSET(0xD1653E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int GravityBallBallController_TypeDefinitionIndex = 74632;
