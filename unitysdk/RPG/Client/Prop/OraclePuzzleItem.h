...
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1CAC90)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_GETCENTERLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xD1CB9B0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_GETRASTERSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0xD1C8020)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_GETWORLDSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0xD1CBA70)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ISPINNED_OFFSET UNITYSDK_OFFSET(0xD1C72F0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_METHOD_6_8923446497E3D0C5_OFFSET UNITYSDK_OFFSET(0xD1CB640)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_MOVETOPINNEDPOS_OFFSET UNITYSDK_OFFSET(0xD1C7330)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_MOVETOTARGETPOSPERFORM_OFFSET UNITYSDK_OFFSET(0xD1CBDA0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONDRAGBEGIN_OFFSET UNITYSDK_OFFSET(0xD1CAE50)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONDRAG_OFFSET UNITYSDK_OFFSET(0xD1CB030)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONHOVEREXIT_OFFSET UNITYSDK_OFFSET(0xD1CAE00)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONHOVER_OFFSET UNITYSDK_OFFSET(0xD1CADB0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONSELECTUP_OFFSET UNITYSDK_OFFSET(0xD1CAD70)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0xD1CAD30)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0xD1CB5F0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_SETDITHERALPHAWITHANIM_OFFSET UNITYSDK_OFFSET(0xD1CBF70)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xD1CAB20)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_SETSTATE_OFFSET UNITYSDK_OFFSET(0xD1CB960)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_STARTMOVETOANIMATION_OFFSET UNITYSDK_OFFSET(0xD1C7780)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_TICK_OFFSET UNITYSDK_OFFSET(0xD1CA770)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD1CC230)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzleItem_TypeDefinitionIndex = 74776;
