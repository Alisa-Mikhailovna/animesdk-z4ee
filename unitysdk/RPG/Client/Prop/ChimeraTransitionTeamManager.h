...
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_FILLPOSITION_OFFSET UNITYSDK_OFFSET(0xD132BE0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xD1329B0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD133B80)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_RUN_OFFSET UNITYSDK_OFFSET(0xD133320)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_STARTTRANSITION_OFFSET UNITYSDK_OFFSET(0xD132D90)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_TRANSITIONBETWEENAREAS_OFFSET UNITYSDK_OFFSET(0xD132A00)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_TRANSITIONTO_OFFSET UNITYSDK_OFFSET(0xD132F70)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD1334E0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD133EB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraTransitionTeamManager_TypeDefinitionIndex = 74476;
