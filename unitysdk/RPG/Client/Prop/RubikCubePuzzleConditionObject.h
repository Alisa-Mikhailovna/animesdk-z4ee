...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD215C50)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_INITOBJECT_OFFSET UNITYSDK_OFFSET(0xD214CC0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0xD214D10)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_SETFINISH_OFFSET UNITYSDK_OFFSET(0xD215380)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xD215C90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleConditionObject_TypeDefinitionIndex = 74866;
