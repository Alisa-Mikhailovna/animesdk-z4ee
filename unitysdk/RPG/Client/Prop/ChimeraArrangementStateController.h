...
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_EXITPREPARATION_OFFSET UNITYSDK_OFFSET(0xD0FD820)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_GET_STATE_OFFSET UNITYSDK_OFFSET(0xD0FB890)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_GET_TEAMMEMBERSLOTS_OFFSET UNITYSDK_OFFSET(0xD0FB7C0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_GOTOWORK_OFFSET UNITYSDK_OFFSET(0xD0FD780)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_ONENTER_OFFSET UNITYSDK_OFFSET(0xD0FC4B0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_ONEXIT_OFFSET UNITYSDK_OFFSET(0xD0FCB00)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_ONTICK_OFFSET UNITYSDK_OFFSET(0xD0FC9F0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_PLAYTIMELINEENTER_OFFSET UNITYSDK_OFFSET(0xD0FD1E0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_REACTSHOWPANELS_OFFSET UNITYSDK_OFFSET(0xD0FD460)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_SETSTAGEVIEWVISIBILITY_OFFSET UNITYSDK_OFFSET(0xD0FCE80)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER_STARTSTAGEVIEWDITHERHIDE_OFFSET UNITYSDK_OFFSET(0xD0FD050)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER__ALIGNSLOTSORIENTATION_OFFSET UNITYSDK_OFFSET(0xD0FD880)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0FE440)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER__HANDLEUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xD0FCDE0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER__INIT_OFFSET UNITYSDK_OFFSET(0xD0FB8E0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTATECONTROLLER__ONTIMELINEENTEREND_OFFSET UNITYSDK_OFFSET(0xD0FD590)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraArrangementStateController_TypeDefinitionIndex = 74534;
