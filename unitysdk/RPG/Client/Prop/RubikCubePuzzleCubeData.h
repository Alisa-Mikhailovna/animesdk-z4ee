...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD226DF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleCubeData_TypeDefinitionIndex = 74875;
