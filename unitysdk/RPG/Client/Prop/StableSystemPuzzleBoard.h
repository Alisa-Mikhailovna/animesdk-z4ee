...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_CLEARSELECT_OFFSET UNITYSDK_OFFSET(0xD22CA40)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETBASENORMALIZEPOS_OFFSET UNITYSDK_OFFSET(0xD22C8F0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETCOREAREA_OFFSET UNITYSDK_OFFSET(0xD22DAF0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETPILLAR_OFFSET UNITYSDK_OFFSET(0xD22D900)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GET_SELECTPILALRCNT_OFFSET UNITYSDK_OFFSET(0xD22D4B0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD22C120)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISCORESTABLE_OFFSET UNITYSDK_OFFSET(0xD22BDD0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISPILLARNEARCORE_OFFSET UNITYSDK_OFFSET(0xD22E0A0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD22C0D0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ONPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD22DDA0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_REFRESHCANDIDATESELECTPILLAR_OFFSET UNITYSDK_OFFSET(0xD22CA90)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_REFRESHFINISHSTATUS_OFFSET UNITYSDK_OFFSET(0xD22DBB0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_SELECTPILLAR_OFFSET UNITYSDK_OFFSET(0xD22C990)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_SOLVEPILLARSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xD22D9A0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD22E1B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleBoard_TypeDefinitionIndex = 74916;
