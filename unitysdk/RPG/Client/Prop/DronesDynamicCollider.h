...
#define RPG_CLIENT_PROP_DRONESDYNAMICCOLLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD14BAA0)
#define RPG_CLIENT_PROP_DRONESDYNAMICCOLLIDER_SWITCH_OFFSET UNITYSDK_OFFSET(0xD14BB40)
#define RPG_CLIENT_PROP_DRONESDYNAMICCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xD14BCA0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DronesDynamicCollider_TypeDefinitionIndex = 74606;
