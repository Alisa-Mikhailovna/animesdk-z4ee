...
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_482F98D76EE0F67C_OFFSET UNITYSDK_OFFSET(0xD121410)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_5AA26BB73B32743F_OFFSET UNITYSDK_OFFSET(0xD121620)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_67AEF306C0668389_OFFSET UNITYSDK_OFFSET(0xD121690)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_6E5CBF6743011AF7_OFFSET UNITYSDK_OFFSET(0xD1214A0)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_B981968D52A481FE_OFFSET UNITYSDK_OFFSET(0xD121850)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_C8F1E529227E18C5_OFFSET UNITYSDK_OFFSET(0xD121530)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_EBD32C8C133C4897_OFFSET UNITYSDK_OFFSET(0xD120EF0)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET__CTOR_OFFSET UNITYSDK_OFFSET(0xD121900)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelPuzzleVirtualCameraConfig_AdaptiveCameraSet_TypeDefinitionIndex = 74358;
