...
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_0E077E62EF2EFC16_OFFSET UNITYSDK_OFFSET(0xD11E780)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_5AFB73477BDE8482_OFFSET UNITYSDK_OFFSET(0xD1253C0)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_7619D212F4D762A1_OFFSET UNITYSDK_OFFSET(0xD1259F0)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xD125700)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_B28695407764C700_OFFSET UNITYSDK_OFFSET(0xD1257F0)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xD1259A0)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD125C70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelTeamMemberSlotView_TypeDefinitionIndex = 74404;
