...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEFRAMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD227660)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleFrameData_TypeDefinitionIndex = 74881;
