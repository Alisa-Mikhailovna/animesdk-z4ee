...
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_DEACTIVATEINDELAY_OFFSET UNITYSDK_OFFSET(0xD1D4B90)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1D5DC0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_GET_HASSTEPPED_OFFSET UNITYSDK_OFFSET(0xD1D6130)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_INITSTATE_OFFSET UNITYSDK_OFFSET(0xD1D5960)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xD1D5E90)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_PUZZLEENTER_OFFSET UNITYSDK_OFFSET(0xD1D4F80)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_PUZZLERESET_OFFSET UNITYSDK_OFFSET(0xD1D5C60)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_PUZZLESUCCEED_OFFSET UNITYSDK_OFFSET(0xD1D5AC0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_SET_HASSTEPPED_OFFSET UNITYSDK_OFFSET(0xD1D6140)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_TRIGGERSOUND_OFFSET UNITYSDK_OFFSET(0xD1D5F10)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD1D5790)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PadsPuzzlePadBase_TypeDefinitionIndex = 74801;
