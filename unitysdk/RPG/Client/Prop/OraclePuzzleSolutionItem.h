...
#define RPG_CLIENT_PROP_ORACLEPUZZLESOLUTIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD1CF150)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzleSolutionItem_TypeDefinitionIndex = 74779;
