...
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_DISABLECAMERA_OFFSET UNITYSDK_OFFSET(0xD0D1FA0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD0D2200)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_ENABLECAMERA_OFFSET UNITYSDK_OFFSET(0xD0D0EF0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_GETAXISVALUE_OFFSET UNITYSDK_OFFSET(0xD0DB440)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xD0D0DB0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_690254C4B3C33267_OFFSET UNITYSDK_OFFSET(0xD0DB760)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_953DD38710057F4B_OFFSET UNITYSDK_OFFSET(0xD0DB3C0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_9D967D80C41C7781_OFFSET UNITYSDK_OFFSET(0xD0DB930)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_E1B1897755057184_OFFSET UNITYSDK_OFFSET(0xD0DB7F0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_E9A8695D8BBAA196_OFFSET UNITYSDK_OFFSET(0xD0DB8D0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD0DB370)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0xD0D3230)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0DB320)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0DB980)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockProjectionPuzzleCameraController_TypeDefinitionIndex = 74255;
