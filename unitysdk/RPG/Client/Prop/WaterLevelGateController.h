...
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xD248870)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD2486F0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xD248900)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_GET_ISGATEOPEN_OFFSET UNITYSDK_OFFSET(0xD248BE0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xD248170)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_METHOD_5_983BE009C423EFE5_OFFSET UNITYSDK_OFFSET(0xD248B90)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_METHOD_5_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0xD248990)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_RESETGATE_OFFSET UNITYSDK_OFFSET(0xD248810)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_SETGATESTATE_OFFSET UNITYSDK_OFFSET(0xD2484D0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xD248740)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD248BF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelGateController_TypeDefinitionIndex = 74963;
