...
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_8FA0679D147955F9_OFFSET UNITYSDK_OFFSET(0xD243110)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xD2433F0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_F9725EED05F07EC1_OFFSET UNITYSDK_OFFSET(0xD2432A0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_MOVE_OFFSET UNITYSDK_OFFSET(0xD242E10)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_REFERSHPOSITION_OFFSET UNITYSDK_OFFSET(0xD243520)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_RESET_OFFSET UNITYSDK_OFFSET(0xD2434D0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_SETBOXSELECT_OFFSET UNITYSDK_OFFSET(0xD2431A0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xD243680)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD243670)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelBoxItem_TypeDefinitionIndex = 74956;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(WaterLevelBoxItem_TypeDefinitionIndex)->GetStaticField(0x4F70);
		}
