...
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_DRAG_OFFSET UNITYSDK_OFFSET(0xD0F9550)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_FINISHMOTION_OFFSET UNITYSDK_OFFSET(0xD0F8F80)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_GET_AUDIOSOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0xD0F8880)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_GET_DRAGHANDLEPOSITION_OFFSET UNITYSDK_OFFSET(0xD0F88D0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_GET_SWAPMOTIONCONFIG_OFFSET UNITYSDK_OFFSET(0xD0F8A70)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_GET__DRAGHANDLERELATIVEPOSITION_OFFSET UNITYSDK_OFFSET(0xD0F8970)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD0F8AC0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_PLACEAT_OFFSET UNITYSDK_OFFSET(0xD0F9460)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_PLAYDITHERFALL_OFFSET UNITYSDK_OFFSET(0xD0F9240)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_REACTDITHERSHOW_OFFSET UNITYSDK_OFFSET(0xD0F92C0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_RELOAD_OFFSET UNITYSDK_OFFSET(0xD0F91E0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_RESETSCALE_OFFSET UNITYSDK_OFFSET(0xD0F8F00)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_RESET_OFFSET UNITYSDK_OFFSET(0xD0F8DD0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_SETDIMMED_OFFSET UNITYSDK_OFFSET(0xD0F90D0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_SETSCALED_OFFSET UNITYSDK_OFFSET(0xD0F93D0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_SETVISIBILITY_OFFSET UNITYSDK_OFFSET(0xD0F9060)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_STARTMOTION_OFFSET UNITYSDK_OFFSET(0xD0F97B0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0F8B10)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0F9950)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE__TICKMOTION_OFFSET UNITYSDK_OFFSET(0xD0F8B60)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraArrangementModelInstance_TypeDefinitionIndex = 74504;
