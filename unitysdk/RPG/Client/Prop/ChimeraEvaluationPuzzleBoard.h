...
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD129A00)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD_GETCHIMERATRANSFORM_OFFSET UNITYSDK_OFFSET(0xD129D90)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD_GET_PREFERREDVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0xD129370)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD128BE0)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD_LIKECHIMERA_OFFSET UNITYSDK_OFFSET(0xD129DF0)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD_LOADMODEL_OFFSET UNITYSDK_OFFSET(0xD129700)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD129670)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD_UNLIKECHIMERA_OFFSET UNITYSDK_OFFSET(0xD129E50)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xD128DC0)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD12A080)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__DISPOSECAMERA_OFFSET UNITYSDK_OFFSET(0xD129D30)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__GETEVALUATIONCHIMERA_OFFSET UNITYSDK_OFFSET(0xD128ED0)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__HIDESLOTS_OFFSET UNITYSDK_OFFSET(0xD129490)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__INITCAMERA_OFFSET UNITYSDK_OFFSET(0xD129430)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__ONEXITGAME_OFFSET UNITYSDK_OFFSET(0xD129EB0)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xD129F20)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__REMOVENOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xD129C20)
#define RPG_CLIENT_PROP_CHIMERAEVALUATIONPUZZLEBOARD__SHOWUI_OFFSET UNITYSDK_OFFSET(0xD129910)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraEvaluationPuzzleBoard_TypeDefinitionIndex = 74496;
