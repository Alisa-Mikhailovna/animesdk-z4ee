...
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD18F2D0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GETINPUTLASERSLOT_OFFSET UNITYSDK_OFFSET(0xD18EF90)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD18FCD0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GET_ISMAINROTATE_OFFSET UNITYSDK_OFFSET(0xD18FD40)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GET_ISROTATE_OFFSET UNITYSDK_OFFSET(0xD18FD30)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GOBACKINIT_OFFSET UNITYSDK_OFFSET(0xD18DD60)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_HIDEOUTPUTLASER_OFFSET UNITYSDK_OFFSET(0xD18F3F0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_INITRING_OFFSET UNITYSDK_OFFSET(0xD18CA10)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_METHOD_5_218124418542E081_OFFSET UNITYSDK_OFFSET(0xD18FA80)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_METHOD_5_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xD18FCE0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_METHOD_5_A82BC93906D19A8C_OFFSET UNITYSDK_OFFSET(0xD18F540)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_METHOD_5_DF4DF66B472E49E5_OFFSET UNITYSDK_OFFSET(0xD18F9D0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_REFRESHLIGHTSTATUS_OFFSET UNITYSDK_OFFSET(0xD18D9B0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_REGISTERSWITCH_OFFSET UNITYSDK_OFFSET(0xD18F310)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_ROTATE_OFFSET UNITYSDK_OFFSET(0xD18E030)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_SELECT_OFFSET UNITYSDK_OFFSET(0xD18F600)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__CTOR_OFFSET UNITYSDK_OFFSET(0xD18FD50)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LaserTurnablePuzzleRing_TypeDefinitionIndex = 74713;
