...
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_CREATEFACTORY_OFFSET UNITYSDK_OFFSET(0xD106B70)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0xD106CA0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_ARG_OFFSET UNITYSDK_OFFSET(0xD106D90)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xD106DB0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xD106E10)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xD106DF0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xD106DD0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_ARG_OFFSET UNITYSDK_OFFSET(0xD106DA0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xD106DC0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_DURATION_OFFSET UNITYSDK_OFFSET(0xD106E20)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0xD106E00)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xD106DE0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD106B20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelBubbleEvent_TypeDefinitionIndex = 74320;
	...
	public:
		...
		::System::Int32 _UniqueID_k__BackingField; // 0x18
