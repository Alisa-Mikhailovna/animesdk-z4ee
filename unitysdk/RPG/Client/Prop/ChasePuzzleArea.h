...
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_DISABLE_OFFSET UNITYSDK_OFFSET(0xD0F4BE0)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD0F4A20)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_ENABLE_OFFSET UNITYSDK_OFFSET(0xD0F4A70)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_INIT_OFFSET UNITYSDK_OFFSET(0xD0F4660)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_METHOD_5_5D9E900D04946B98_OFFSET UNITYSDK_OFFSET(0xD0F4840)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_METHOD_5_92C4EECBB004EECB_OFFSET UNITYSDK_OFFSET(0xD0F4CF0)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_REGISTERTRIGGERS_OFFSET UNITYSDK_OFFSET(0xD0F46B0)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_UNREGISTERTRIGGERS_OFFSET UNITYSDK_OFFSET(0xD0F4970)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0F5350)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChasePuzzleArea_TypeDefinitionIndex = 74265;
