...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xD22EE40)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_INITPEDESTAL_OFFSET UNITYSDK_OFFSET(0xD22E4E0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_METHOD_5_7AAD06186762BE3C_OFFSET UNITYSDK_OFFSET(0xD22EAF0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_SETCANINTERACTION_OFFSET UNITYSDK_OFFSET(0xD22D520)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_SETCANSELECTACTIVE_OFFSET UNITYSDK_OFFSET(0xD22EC20)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_SETSELECTTYPE_OFFSET UNITYSDK_OFFSET(0xD22D590)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_UPDATE_OFFSET UNITYSDK_OFFSET(0xD22ECB0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL__CTOR_OFFSET UNITYSDK_OFFSET(0xD22EE90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzlePedestal_TypeDefinitionIndex = 74919;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StableSystemPuzzlePedestal_TypeDefinitionIndex)->GetStaticField(0x4DD0);
		}
