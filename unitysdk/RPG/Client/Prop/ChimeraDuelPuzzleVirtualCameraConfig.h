...
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_GET_BLENDSOURCE_OFFSET UNITYSDK_OFFSET(0xD120ED0)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_GET_BLENDTARGET_OFFSET UNITYSDK_OFFSET(0xD11BC20)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_METHOD_1_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0xD11BB70)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD1213F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelPuzzleVirtualCameraConfig_TypeDefinitionIndex = 74357;
