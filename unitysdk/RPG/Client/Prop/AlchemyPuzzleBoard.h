...
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD0CF0B0)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_GETSCALEBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0xD0CFC80)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0xD0CF490)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD0CF3D0)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD0CFBB0)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_METHOD_6_2BFCE9C99CAEB90F_OFFSET UNITYSDK_OFFSET(0xD0CFE30)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_METHOD_6_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xD0CF260)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_METHOD_6_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xD0CF8C0)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_METHOD_6_907E8AD43F95E68A_OFFSET UNITYSDK_OFFSET(0xD0D0480)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_METHOD_6_EBAF10BBA97B82DD_OFFSET UNITYSDK_OFFSET(0xD0CFCD0)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_ONITEMANIMEND_OFFSET UNITYSDK_OFFSET(0xD0CEEF0)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_QUITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD0CFD70)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_RECORDDEFAULTSIZE_OFFSET UNITYSDK_OFFSET(0xD0CFC00)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD0CFA30)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD0CF840)
#define RPG_CLIENT_PROP_ALCHEMYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD0D0620)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int AlchemyPuzzleBoard_TypeDefinitionIndex = 74251;
