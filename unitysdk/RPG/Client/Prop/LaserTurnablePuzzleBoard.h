...
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xD18E1D0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD18E210)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD_GOBACKINIT_OFFSET UNITYSDK_OFFSET(0xD18DC40)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD18C680)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD_METHOD_6_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0xD18D8F0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD_REFRESHLASERSTATUS_OFFSET UNITYSDK_OFFSET(0xD18D710)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD18D8B0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD_ROTATERING_OFFSET UNITYSDK_OFFSET(0xD18DEA0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD18D870)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD18E220)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LaserTurnablePuzzleBoard_TypeDefinitionIndex = 74709;
