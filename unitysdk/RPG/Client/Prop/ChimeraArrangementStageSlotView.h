...
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTAGESLOTVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xD0FB580)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTAGESLOTVIEW_RESETDITHERING_OFFSET UNITYSDK_OFFSET(0xD0FB6F0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTAGESLOTVIEW_STARTDITHERHIDE_OFFSET UNITYSDK_OFFSET(0xD0FB620)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSTAGESLOTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD0FB7B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraArrangementStageSlotView_TypeDefinitionIndex = 74510;
