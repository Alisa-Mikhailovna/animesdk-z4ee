...
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xD207C90)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD207750)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD204770)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD2074F0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_METHOD_6_63AE1202F18E8BBF_OFFSET UNITYSDK_OFFSET(0xD207E60)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONCLICKEXIT_OFFSET UNITYSDK_OFFSET(0xD206180)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONINPUTDEVICECLASSSWITCHED_OFFSET UNITYSDK_OFFSET(0xD2068B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONRELOAD_OFFSET UNITYSDK_OFFSET(0xD206C90)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONROTATE_OFFSET UNITYSDK_OFFSET(0xD206A70)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD206960)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONUISHOW_OFFSET UNITYSDK_OFFSET(0xD2065B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD2071D0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_SDKREPORT_BEGIN_OFFSET UNITYSDK_OFFSET(0xD208300)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_SDKREPORT_END_OFFSET UNITYSDK_OFFSET(0xD207540)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_SDKREPORT_STEP_OFFSET UNITYSDK_OFFSET(0xD2084E0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_SETPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xD206E90)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD2060C0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xD208770)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD208750)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD__GETUNIQUEID_OFFSET UNITYSDK_OFFSET(0xD208280)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RotatePillarPuzzleBoard_TypeDefinitionIndex = 74847;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0xC4F0);
		}
