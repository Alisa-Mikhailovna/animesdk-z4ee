...
#define RPG_CLIENT_PROP_DRONEHUDPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD14BA90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DroneHudParam_TypeDefinitionIndex = 74605;
