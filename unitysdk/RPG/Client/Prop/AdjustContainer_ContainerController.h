...
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xD0C7570)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_09124A4A24353C26_OFFSET UNITYSDK_OFFSET(0xD0C6C70)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0xD0C70F0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_2DF7969B85DC261B_OFFSET UNITYSDK_OFFSET(0xD0C3640)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_435B33488FBCBE0B_OFFSET UNITYSDK_OFFSET(0xD0C3A80)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_51AC7912135C5E23_OFFSET UNITYSDK_OFFSET(0xD0C45E0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_735EE20B25F86BF4_1_OFFSET UNITYSDK_OFFSET(0xD0C7C00)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0xD0C7B50)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0xD0C76B0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_95F9978EEF8F29E5_OFFSET UNITYSDK_OFFSET(0xD0C6590)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_969EF16C38E0FD30_OFFSET UNITYSDK_OFFSET(0xD0C7CA0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0xD0C78A0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_9E38127F40B34F1F_1_OFFSET UNITYSDK_OFFSET(0xD0C7410)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_9E38127F40B34F1F_2_OFFSET UNITYSDK_OFFSET(0xD0C6680)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0xD0C6F90)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xD0C7AF0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xD0C6C00)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_B75D122F21CFAD25_OFFSET UNITYSDK_OFFSET(0xD0C43A0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_B8A8F4F120B2F6D5_OFFSET UNITYSDK_OFFSET(0xD0C5920)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_E7AB99EDC5373156_OFFSET UNITYSDK_OFFSET(0xD0C6180)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_EFF275E2C18C04F2_OFFSET UNITYSDK_OFFSET(0xD0C2B80)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C7D10)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER___REGENERATENOREUSE_B__6_2_OFFSET UNITYSDK_OFFSET(0xD0C7DD0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int AdjustContainer_ContainerController_TypeDefinitionIndex = 74241;
