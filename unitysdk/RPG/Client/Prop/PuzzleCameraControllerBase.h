...
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD1E26E0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_ENTERCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xD1FB5B0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_EXITCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xD1FBB70)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xD1E3030)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_INIT_OFFSET UNITYSDK_OFFSET(0xD1E2850)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_METHOD_5_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0xD1E1E00)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_METHOD_5_C1356D9974792827_OFFSET UNITYSDK_OFFSET(0xD1E2CF0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_TICK_OFFSET UNITYSDK_OFFSET(0xD1FBBD0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD1E3080)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PuzzleCameraControllerBase_TypeDefinitionIndex = 74937;
