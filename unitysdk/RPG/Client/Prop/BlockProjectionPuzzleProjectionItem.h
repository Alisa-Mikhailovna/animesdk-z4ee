...
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEPROJECTIONITEM_SETPREVIEWSTATE_OFFSET UNITYSDK_OFFSET(0xD0DBE10)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEPROJECTIONITEM_SETSTATE_OFFSET UNITYSDK_OFFSET(0xD0DC990)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEPROJECTIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD0DCBB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockProjectionPuzzleProjectionItem_TypeDefinitionIndex = 74260;
