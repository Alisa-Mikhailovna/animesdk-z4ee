...
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_AWAKE_OFFSET UNITYSDK_OFFSET(0xD0FABA0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_DEACTIVATECHILDREN_OFFSET UNITYSDK_OFFSET(0xD0FAF10)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_GET_BILLBOARDANCHOR_OFFSET UNITYSDK_OFFSET(0xD0FAB90)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_GET_MODELANCHOR_OFFSET UNITYSDK_OFFSET(0xD0FAB80)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_NOTIFYPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xD0FB090)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_NOTIFYPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xD0FAFD0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_NOTIFYPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0xD0FB030)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_PLACEINSTANCEWITHMOTION_OFFSET UNITYSDK_OFFSET(0xD0FB1C0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_PLACEINSTANCE_OFFSET UNITYSDK_OFFSET(0xD0FB0F0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0FAC60)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xD0FB530)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT__FINISHBILLBOARDANCHORMOTION_OFFSET UNITYSDK_OFFSET(0xD0FB3A0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT__STARTBILLBOARDANCHORMOTION_OFFSET UNITYSDK_OFFSET(0xD0FB440)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTSLOT__TICKBILLBOARDANCHORMOTION_OFFSET UNITYSDK_OFFSET(0xD0FACB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraArrangementSlot_TypeDefinitionIndex = 74508;
