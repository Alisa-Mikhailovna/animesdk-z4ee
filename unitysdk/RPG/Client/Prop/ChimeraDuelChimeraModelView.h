...
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_BUILDCHIMERA_OFFSET UNITYSDK_OFFSET(0xD10A570)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_BUILDHOLLOW_OFFSET UNITYSDK_OFFSET(0xD10BED0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0xD1099E0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_GET_OUTLINEDRAWER_OFFSET UNITYSDK_OFFSET(0xD1098C0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_GET__BODYCONSTVALUE_OFFSET UNITYSDK_OFFSET(0xD1098D0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_HIDEOUTLINE_OFFSET UNITYSDK_OFFSET(0xD10A2E0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD10D0F0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_SETSHADOWCASTINGENABLED_OFFSET UNITYSDK_OFFSET(0xD10D090)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_SHOWHIGHLIGHTOUTLINE_OFFSET UNITYSDK_OFFSET(0xD109A90)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDBLUSH_OFFSET UNITYSDK_OFFSET(0xD10C600)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDBODY_OFFSET UNITYSDK_OFFSET(0xD10C6C0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDEYE_OFFSET UNITYSDK_OFFSET(0xD10BA60)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDFACE_OFFSET UNITYSDK_OFFSET(0xD10C9C0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDITEMS_1_OFFSET UNITYSDK_OFFSET(0xD10CC30)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDITEMS_OFFSET UNITYSDK_OFFSET(0xD10CE90)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDMATERIALPATH_OFFSET UNITYSDK_OFFSET(0xD10D210)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDPARTS_1_OFFSET UNITYSDK_OFFSET(0xD10CF50)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDPARTS_OFFSET UNITYSDK_OFFSET(0xD10B0B0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0xD10D780)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__CREATEMATERIALPARTCONFIG_OFFSET UNITYSDK_OFFSET(0xD10C560)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD10D770)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__GETCHIMERACONFIG_OFFSET UNITYSDK_OFFSET(0xD10A8C0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__GETVERSION_OFFSET UNITYSDK_OFFSET(0xD10AB60)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__ISASSETEXISTS_OFFSET UNITYSDK_OFFSET(0xD10D520)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__ISGAMEINITIALIZED_OFFSET UNITYSDK_OFFSET(0xD10D710)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__ISVALID_OFFSET UNITYSDK_OFFSET(0xD10AA10)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__ITERATEPARTS_OFFSET UNITYSDK_OFFSET(0xD109B60)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__LOADANDBINDCHIMERA_OFFSET UNITYSDK_OFFSET(0xD10ABB0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__LOADMATERIALWITHFALLBACK_OFFSET UNITYSDK_OFFSET(0xD10D140)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__SYNCLOADMATERIAL_OFFSET UNITYSDK_OFFSET(0xD10CB70)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__TRYLOADMATERIAL_OFFSET UNITYSDK_OFFSET(0xD10D680)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__TRYSETWWISESWITCH_OFFSET UNITYSDK_OFFSET(0xD10BBF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelChimeraModelView_TypeDefinitionIndex = 74368;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChimeraDuelChimeraModelView_TypeDefinitionIndex)->GetStaticField(0x148D0);
		}
