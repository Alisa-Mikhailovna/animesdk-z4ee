...
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_CANWATERLEVELCHANGE_OFFSET UNITYSDK_OFFSET(0xD247FD0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_CHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0xD247E10)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD24AB60)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_DUMPSAVEDATA_OFFSET UNITYSDK_OFFSET(0xD24B040)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD24A070)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_METHOD_6_1D77A561617C71A4_OFFSET UNITYSDK_OFFSET(0xD24A5B0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_ONCHANGEWATERLEVELEND_OFFSET UNITYSDK_OFFSET(0xD246DF0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xD24A8E0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xD24AD70)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_TRYSAVEDATATOSERVER_OFFSET UNITYSDK_OFFSET(0xD2462F0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS__CTOR_OFFSET UNITYSDK_OFFSET(0xD24B1C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelPuzzleBoardPlus_TypeDefinitionIndex = 74964;
