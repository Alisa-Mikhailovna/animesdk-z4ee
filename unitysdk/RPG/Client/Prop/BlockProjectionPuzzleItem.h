...
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD0DBA70)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0xD0DB9A0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_ISDEFAULTFILLED_OFFSET UNITYSDK_OFFSET(0xD0DA100)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_ISFILLED_OFFSET UNITYSDK_OFFSET(0xD0DBB60)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_ONHOVEREXIT_OFFSET UNITYSDK_OFFSET(0xD0D4940)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_ONHOVER_OFFSET UNITYSDK_OFFSET(0xD0D4BF0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_ONSELECTUP_OFFSET UNITYSDK_OFFSET(0xD0DBB20)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0xD0DBAE0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_SETBLOCKFILLED_OFFSET UNITYSDK_OFFSET(0xD0DAC90)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_SETBLOCKPREVIEW_OFFSET UNITYSDK_OFFSET(0xD0DA510)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_SETSTATE_OFFSET UNITYSDK_OFFSET(0xD0DA160)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM_TICK_OFFSET UNITYSDK_OFFSET(0xD0DBA10)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD0DBBB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockProjectionPuzzleItem_TypeDefinitionIndex = 74257;
