...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD191A60)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_INITBLOCK_OFFSET UNITYSDK_OFFSET(0xD191AA0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_LOGICROTATETATUMX_OFFSET UNITYSDK_OFFSET(0xD192050)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_LOGICROTATETATUMY_OFFSET UNITYSDK_OFFSET(0xD1920F0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_LOGICROTATETATUMZ_OFFSET UNITYSDK_OFFSET(0xD192190)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_REFRESHLIGHTSTATUS_OFFSET UNITYSDK_OFFSET(0xD191B70)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_SETSELECT_OFFSET UNITYSDK_OFFSET(0xD191FF0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xD192230)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleBlock_TypeDefinitionIndex = 74722;
