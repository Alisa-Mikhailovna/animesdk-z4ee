...
#define RPG_CLIENT_PROP_CHIMERADUELJUMPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD1115E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelJumpText_TypeDefinitionIndex = 74317;

	class ChimeraDuelJumpText : public ::System::Object
	{
	public:
		::System::Int32 ExpectedValue; // 0x10
