...
#define RPG_CLIENT_PROP_CONNECTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD13D580)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ConnectionInfo_TypeDefinitionIndex = 74565;
