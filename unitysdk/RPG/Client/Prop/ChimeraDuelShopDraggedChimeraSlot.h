...
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_BINDDRAGEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0xD1236B0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_GET__DRAGHANDLERELATIVEPOSITION_OFFSET UNITYSDK_OFFSET(0xD123350)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_SETCROSSSTALLDRAGAREALISTENER_OFFSET UNITYSDK_OFFSET(0xD1238A0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_SETDRAGAREAS_OFFSET UNITYSDK_OFFSET(0xD123660)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_SETVISIBLE_OFFSET UNITYSDK_OFFSET(0xD1235F0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_SIMULATEDRAGOVERSLOT_OFFSET UNITYSDK_OFFSET(0xD1238F0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_UNBINDDRAGEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0xD1237B0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xD11D1C0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT__MOVEINDRAGPLANE_OFFSET UNITYSDK_OFFSET(0xD123AD0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT__MOVEVIEW_OFFSET UNITYSDK_OFFSET(0xD123CC0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT__ONDRAGEVENT_OFFSET UNITYSDK_OFFSET(0xD123BA0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelShopDraggedChimeraSlot_TypeDefinitionIndex = 74401;
