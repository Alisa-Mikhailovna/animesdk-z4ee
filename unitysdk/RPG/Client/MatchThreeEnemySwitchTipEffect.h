...
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCB438C0)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCB43840)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_METHOD_5_C1062F26C50C07EE_OFFSET UNITYSDK_OFFSET(0xCB43900)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xCB439C0)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xCB3A4B0)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xCB3A390)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCB437A0)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCB43B30)
