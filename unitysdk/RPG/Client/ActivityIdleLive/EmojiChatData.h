...
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBB68420)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA_GETEMOJICHATCONTENTDATA_OFFSET UNITYSDK_OFFSET(0xBB684B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA_GET_INTERVAL_OFFSET UNITYSDK_OFFSET(0xBB67FE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA_SET_INTERVAL_OFFSET UNITYSDK_OFFSET(0xBB67FF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB68000)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA__GETEMOJINUM_OFFSET UNITYSDK_OFFSET(0xBB685F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA__GETEMOJI_OFFSET UNITYSDK_OFFSET(0xBB68560)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA__GETSENDERNAME_OFFSET UNITYSDK_OFFSET(0xBB68780)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int EmojiChatData_TypeDefinitionIndex = 71737;
