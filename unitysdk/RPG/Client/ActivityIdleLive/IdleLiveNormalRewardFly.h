...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBBB46F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBBB4730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xBBB4C20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_PLAY_OFFSET UNITYSDK_OFFSET(0xBBB4960)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_SETCANVAS_OFFSET UNITYSDK_OFFSET(0xBBB4ED0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_SETICON_OFFSET UNITYSDK_OFFSET(0xBBB48A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_SETREWARDNUM_OFFSET UNITYSDK_OFFSET(0xBBB4900)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBBB46B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY__CTOR_OFFSET UNITYSDK_OFFSET(0xBBB4F70)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveNormalRewardFly_TypeDefinitionIndex = 71581;
