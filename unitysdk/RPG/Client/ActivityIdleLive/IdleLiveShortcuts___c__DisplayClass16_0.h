...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBBBB6E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS___C__DISPLAYCLASS16_0__INITANDENTERBATTLE_B__0_OFFSET UNITYSDK_OFFSET(0xBBBBA10)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveShortcuts___c__DisplayClass16_0_TypeDefinitionIndex = 71712;
