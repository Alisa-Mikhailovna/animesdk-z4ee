...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_HAVENEWINTERACTION_OFFSET UNITYSDK_OFFSET(0xBBB4F80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_POPINTERACTIONID_OFFSET UNITYSDK_OFFSET(0xBBB4FE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_SETENABLE_OFFSET UNITYSDK_OFFSET(0xBBB5170)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_UPDATEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0xBBB50E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xBBA30B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLivePureShowGiftService_TypeDefinitionIndex = 71700;
