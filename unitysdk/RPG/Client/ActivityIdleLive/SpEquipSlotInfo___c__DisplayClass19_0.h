...
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBBE1110)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO___C__DISPLAYCLASS19_0__GETEQUIPBELONGEDONEBASEDINDEX_B__0_OFFSET UNITYSDK_OFFSET(0xBBE1EF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO___C__DISPLAYCLASS19_0__GETEQUIPBELONGEDONEBASEDINDEX_B__1_OFFSET UNITYSDK_OFFSET(0xBBE1FA0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int SpEquipSlotInfo___c__DisplayClass19_0_TypeDefinitionIndex = 71637;
