...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_ADD_PROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0xBB6E2E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_CHECKHASAVATAR_OFFSET UNITYSDK_OFFSET(0xBB6EEE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETALLAVATARS_OFFSET UNITYSDK_OFFSET(0xBB6F2D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETAVATARDATABYID_OFFSET UNITYSDK_OFFSET(0xBB6EF70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETAVATARSBYPOSTYPE_OFFSET UNITYSDK_OFFSET(0xBB6F020)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETMETAVATARCNT_OFFSET UNITYSDK_OFFSET(0xBB6F3C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETSLOTLEVELBYSLOTID_OFFSET UNITYSDK_OFFSET(0xBB6EE50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GET_ALLAVATARS_OFFSET UNITYSDK_OFFSET(0xBB6F4A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GET_GOTAVATARCOUNT_OFFSET UNITYSDK_OFFSET(0xBB6F450)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GET_TOTALAVATARCOUNT_OFFSET UNITYSDK_OFFSET(0xBB6F410)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_INIT_OFFSET UNITYSDK_OFFSET(0xBB6E480)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_ONPROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0xBB6E3A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_REMOVE_PROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0xBB6E340)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_UPDATEADDAVATAR_OFFSET UNITYSDK_OFFSET(0xBB6E600)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_UPDATEMGRINFO_OFFSET UNITYSDK_OFFSET(0xBB6E950)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO__CREATEAVATAR_OFFSET UNITYSDK_OFFSET(0xBB6E860)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xBB6F590)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveAvatarInfo_TypeDefinitionIndex = 71471;
