...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE___C__DISPLAYCLASS63_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBBBAD40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE___C__DISPLAYCLASS63_0___SHOWGEMREWARDFLY_B__0_OFFSET UNITYSDK_OFFSET(0xBBBADE0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveRewardFlyService___c__DisplayClass63_0_TypeDefinitionIndex = 71709;
