...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONHPCHANGEMONITOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBB8B770)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONHPCHANGEMONITOR_REGISTERBOSSHPCHANGELISTENER_OFFSET UNITYSDK_OFFSET(0xBB8C090)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONHPCHANGEMONITOR_SETTOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0xBB8C040)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONHPCHANGEMONITOR_START_OFFSET UNITYSDK_OFFSET(0xBB8BCD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONHPCHANGEMONITOR__CTOR_OFFSET UNITYSDK_OFFSET(0xBB8C310)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONHPCHANGEMONITOR__GETBOSSENTITY_OFFSET UNITYSDK_OFFSET(0xBB8B8F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONHPCHANGEMONITOR__INITTOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0xBB8BED0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONHPCHANGEMONITOR__ONBOSSHPCHANGE_OFFSET UNITYSDK_OFFSET(0xBB8C170)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDungeonHpChangeMonitor_TypeDefinitionIndex = 71567;
