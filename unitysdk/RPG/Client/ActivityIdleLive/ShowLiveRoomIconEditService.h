...
#define RPG_CLIENT_ACTIVITYIDLELIVE_SHOWLIVEROOMICONEDITSERVICE_STARTSERVICE_OFFSET UNITYSDK_OFFSET(0xBBDD5F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SHOWLIVEROOMICONEDITSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xBBDDB90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SHOWLIVEROOMICONEDITSERVICE__FINDDEFAULTICONIDBYHEROAVATAR_OFFSET UNITYSDK_OFFSET(0xBBDDA60)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int ShowLiveRoomIconEditService_TypeDefinitionIndex = 71760;
