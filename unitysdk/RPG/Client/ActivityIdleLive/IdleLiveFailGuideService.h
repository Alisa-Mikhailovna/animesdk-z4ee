...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFAILGUIDESERVICE_GETACTIVEFAILGUIDE_OFFSET UNITYSDK_OFFSET(0xBB9A9B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFAILGUIDESERVICE_ISCATCHUPGUIDE_OFFSET UNITYSDK_OFFSET(0xBB9AC10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFAILGUIDESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xBB9A390)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFAILGUIDESERVICE__INITCHAIN_OFFSET UNITYSDK_OFFSET(0xBB9A400)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveFailGuideService_TypeDefinitionIndex = 71784;
