...
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_CREATE_OFFSET UNITYSDK_OFFSET(0xBBDA590)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_HAVENEWINTERACTION_OFFSET UNITYSDK_OFFSET(0xBBDA610)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_POPINTERACTIONID_OFFSET UNITYSDK_OFFSET(0xBBDA650)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_SETENABLE_OFFSET UNITYSDK_OFFSET(0xBBDA6F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_UPDATEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0xBBDA6A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xBBDA600)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int MockInteractionProvider_TypeDefinitionIndex = 71723;
