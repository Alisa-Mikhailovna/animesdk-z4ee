...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBBAD650)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xBBAD500)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU_METHOD_6_66C47ED41C56178D_OFFSET UNITYSDK_OFFSET(0xBBAD5E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBBAD3A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU__CTOR_OFFSET UNITYSDK_OFFSET(0xBBAD6B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveImageDanmu_TypeDefinitionIndex = 71577;
