...
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHARACTERMEETPERFORMSERVICE_BATTLEAVATARGENDER_GETREALAVATARID_OFFSET UNITYSDK_OFFSET(0xBB65C50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHARACTERMEETPERFORMSERVICE_BATTLEAVATARGENDER_NEEDGETREALAVATARIDBYGENDER_OFFSET UNITYSDK_OFFSET(0xBB65BF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHARACTERMEETPERFORMSERVICE_BATTLEAVATARGENDER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB65BE0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int CharacterMeetPerformService_BattleAvatarGender_TypeDefinitionIndex = 71561;
