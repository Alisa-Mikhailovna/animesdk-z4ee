...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GETNODEICON_OFFSET UNITYSDK_OFFSET(0xBB7C520)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xBB7C490)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBB7C480)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBB7C4A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_NODEICON_OFFSET UNITYSDK_OFFSET(0xBB7C470)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB7C4B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveBossData_TypeDefinitionIndex = 71540;
