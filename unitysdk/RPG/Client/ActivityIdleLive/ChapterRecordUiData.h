...
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA_GETBATTLEPOWERRAW_OFFSET UNITYSDK_OFFSET(0x141CE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA_GETLEVELPROGRESS_OFFSET UNITYSDK_OFFSET(0x141C80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA_GETMETCHARACTERCNT_OFFSET UNITYSDK_OFFSET(0x141C30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x141E20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x141DF0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int ChapterRecordUiData_TypeDefinitionIndex = 71808;
