...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARPOSTYPECONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0xBB6D7C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARPOSTYPECONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBB6F720)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARPOSTYPECONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBB6F6E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARPOSTYPECONFIG_GET_POSTYPE_OFFSET UNITYSDK_OFFSET(0xBB6F700)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARPOSTYPECONFIG_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBB6F730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARPOSTYPECONFIG_SET_NAME_OFFSET UNITYSDK_OFFSET(0xBB6F6F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARPOSTYPECONFIG_SET_POSTYPE_OFFSET UNITYSDK_OFFSET(0xBB6F710)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARPOSTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBB6F6D0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveAvatarPosTypeConfig_TypeDefinitionIndex = 71473;
