...
#define RPG_CLIENT_ACTIVITYIDLELIVE_THANKGIFTSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBBE97C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_THANKGIFTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xBBE94A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_THANKGIFTSERVICE__ONTHANKGIFT_OFFSET UNITYSDK_OFFSET(0xBBE9530)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int ThankGiftService_TypeDefinitionIndex = 71756;
