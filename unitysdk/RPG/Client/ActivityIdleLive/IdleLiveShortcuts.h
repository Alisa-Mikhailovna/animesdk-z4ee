...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_ADJUSTCAMERAVIEWPORT_OFFSET UNITYSDK_OFFSET(0xBBBB900)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_DIRECTTOMAZEATSUBMISSION_OFFSET UNITYSDK_OFFSET(0xBBBB880)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETALLACTIVATETECHTREENODES_OFFSET UNITYSDK_OFFSET(0xBBBB1B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETAVATAREQUIPPEDSPEQUIPINFO_OFFSET UNITYSDK_OFFSET(0xBBBB160)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCAMERAVIEWPORTSERVICE_OFFSET UNITYSDK_OFFSET(0xBBBB580)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCHARACTERMEETPERFORMSERVICE_OFFSET UNITYSDK_OFFSET(0xBBBAFD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCURRENTBATTLETIME_OFFSET UNITYSDK_OFFSET(0xBBBB350)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCURRENTTEAMINFO_OFFSET UNITYSDK_OFFSET(0xBBBB300)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCURRENTTEAMPOWER_OFFSET UNITYSDK_OFFSET(0xBBBB4F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETEQUIPFLYSERVICE_OFFSET UNITYSDK_OFFSET(0xBBBB0C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETFUNCFLYSERVICE_OFFSET UNITYSDK_OFFSET(0xBBBB070)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETPURESHOWGIFTSERVICE_OFFSET UNITYSDK_OFFSET(0xBBBB110)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETREWARDFLYSERVICE_OFFSET UNITYSDK_OFFSET(0xBBBB020)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETTEAMINFOATNODEBEGIN_OFFSET UNITYSDK_OFFSET(0xBBBB2B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETTEAMPOWERATBATTLEBEGIN_OFFSET UNITYSDK_OFFSET(0xBBBB230)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETUNLOCKSTATUSQUERYSERVICE_OFFSET UNITYSDK_OFFSET(0xBBBAF80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_INITANDENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xBBBB5D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_TRYGETSTORYLINECONTEXT_OFFSET UNITYSDK_OFFSET(0xBBBAE30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS__DOENTERGAMEFLOW_OFFSET UNITYSDK_OFFSET(0xBBBB6F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS__GETGAMEFLOW_OFFSET UNITYSDK_OFFSET(0xBBBAE80)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveShortcuts_TypeDefinitionIndex = 71711;
