...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBBB8610)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_GETBOSSRECTPOS_OFFSET UNITYSDK_OFFSET(0xBBB8460)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_GETREWARDFLYDEST_OFFSET UNITYSDK_OFFSET(0xBBB8520)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_INITQUESTREWARDSTARTTRANS_OFFSET UNITYSDK_OFFSET(0xBBB8730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_INIT_OFFSET UNITYSDK_OFFSET(0xBBB8780)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_REGISTEREQUIPEFFECTBALL_OFFSET UNITYSDK_OFFSET(0xBBB9870)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_RESETEQUIPDISCARDREWARDSTARTPOS_OFFSET UNITYSDK_OFFSET(0xBBB8400)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SETBOSSRECT_OFFSET UNITYSDK_OFFSET(0xBBB8340)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SETEQUIPDISCARDREWARDSTARTPOS_OFFSET UNITYSDK_OFFSET(0xBBB8390)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SETREWARDDEST_OFFSET UNITYSDK_OFFSET(0xBBB8290)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWBOXFLYFADEIN_OFFSET UNITYSDK_OFFSET(0xBBBA7B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWBOXFLY_OFFSET UNITYSDK_OFFSET(0xBBB8B40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWCONTENTREWARDS_OFFSET UNITYSDK_OFFSET(0xBBBA100)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWEQUIPDISCARDREWARDFLY_OFFSET UNITYSDK_OFFSET(0xBBB97E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWEQUIPEFFECTBALL_OFFSET UNITYSDK_OFFSET(0xBBB9950)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWGEMFLYINQUESTTREE_OFFSET UNITYSDK_OFFSET(0xBBB96A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWGEMFLY_OFFSET UNITYSDK_OFFSET(0xBBB9140)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWREWARDFADEINBYITEMS_OFFSET UNITYSDK_OFFSET(0xBBBA840)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWREWARDFLYBYITEMS_OFFSET UNITYSDK_OFFSET(0xBBBA590)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWTECHPOINTFLY_OFFSET UNITYSDK_OFFSET(0xBBB9000)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_SHOWTICKETFLY_OFFSET UNITYSDK_OFFSET(0xBBB9280)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE_TRYSHOWREWARDFLYBYITEMID_OFFSET UNITYSDK_OFFSET(0xBBBA400)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__CALCULATERANDOMCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0xBBBA010)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__CALCULATERANDOMENDPOINT_OFFSET UNITYSDK_OFFSET(0xBBB9EE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xBBB7CF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__GETCONTENTREWARDSTARTPOSBYTYPE_OFFSET UNITYSDK_OFFSET(0xBBBA380)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__INITREWARDCONSTDATA_OFFSET UNITYSDK_OFFSET(0xBBB7E30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__ONTAKETASKREWARDSCRSP_OFFSET UNITYSDK_OFFSET(0xBBBA8A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__REGISTERRSPHANDLERS_OFFSET UNITYSDK_OFFSET(0xBBB7D70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__SHOWGEMREWARDFLY_OFFSET UNITYSDK_OFFSET(0xBBB93B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__SHOWNORMALREWARDFLY_OFFSET UNITYSDK_OFFSET(0xBBB8C80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEREWARDFLYSERVICE__UNREGISTERRSPHANDLERS_OFFSET UNITYSDK_OFFSET(0xBBB8670)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveRewardFlyService_TypeDefinitionIndex = 71706;
	...
	public:
		...
		::System::String* _GemIconPath; // 0x10
		::UnityEngine::Transform* _QuestRewardStartTrans; // 0x18
		::Il2CppArray<::UnityEngine::Transform*>* _RewardDestinations; // 0x20
		::System::String* _TechPointIconPath; // 0x28
		::Class_1_B18A907A8E4C5C9C* _PoolMgr; // 0x30
		::UnityEngine::Canvas* _RootCanvas; // 0x38
		::System::String* _BoxIconPath; // 0x40
		::UnityEngine::RectTransform* _BossRect; // 0x48
		::UnityEngine::RectTransform* _EquipBallRoot; // 0x50
		::System::UInt32 _ItemIdGem; // 0x58
		::System::Boolean _Inited; // 0x5C
		::UnityEngine::Vector2 _EndPointAreaSize; // 0x60
		::UnityEngine::Vector2 _ControlCenterOffsetToStartPos; // 0x68
		::System::UInt32 _ItemIdTicket; // 0x70
		::UnityEngine::Vector2 _ControlAreaSize; // 0x74
		::UnityEngine::Vector2 _EndCenterOffsetToStartPosRight; // 0x7C
		::System::UInt32 _ItemIdTechPoint; // 0x84
		::UnityEngine::Vector3 _EquipDisCardRewardStartPos; // 0x88
		::UnityEngine::Vector2 _EndCenterOffsetToStartPosLeft; // 0x94
