...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLYSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBB98200)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLYSERVICE_INIT_OFFSET UNITYSDK_OFFSET(0xBB97990)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLYSERVICE_ONALLEQUIPSELECTFINISHED_OFFSET UNITYSDK_OFFSET(0xBB97BA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLYSERVICE_REGISTERROOTTRANS_OFFSET UNITYSDK_OFFSET(0xBB978D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLYSERVICE_SHOWEQUIPFLY_OFFSET UNITYSDK_OFFSET(0xBB97CE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLYSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xBB98250)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveEquipFlyService_TypeDefinitionIndex = 71681;
