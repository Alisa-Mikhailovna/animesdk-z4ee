...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_AWAKE_OFFSET UNITYSDK_OFFSET(0xBBABB60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_CLEARDANMU_OFFSET UNITYSDK_OFFSET(0xBBACAE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_ISSHOWINGDANMU_OFFSET UNITYSDK_OFFSET(0xBBACD40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBBAC370)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBBACDA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_PAUSEDANMU_OFFSET UNITYSDK_OFFSET(0xBBAB920)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_RESUMEDANMU_OFFSET UNITYSDK_OFFSET(0xBBABA40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_SETINTERACTIONPROVIDER_OFFSET UNITYSDK_OFFSET(0xBBAB8D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBBABCA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__CANSHOWNEWDANMU_OFFSET UNITYSDK_OFFSET(0xBBABFB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__CLEANENDEDDANMUS_OFFSET UNITYSDK_OFFSET(0xBBAC450)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0xBBACDF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__ISPAUSED_OFFSET UNITYSDK_OFFSET(0xBBABF10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__ONLOAD_OFFSET UNITYSDK_OFFSET(0xBBABBB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__SPAWNDANMU_OFFSET UNITYSDK_OFFSET(0xBBAC880)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__TRYFETCHGIFTTOSHOW_OFFSET UNITYSDK_OFFSET(0xBBAC100)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGiftDanmuSpawner_TypeDefinitionIndex = 71575;
