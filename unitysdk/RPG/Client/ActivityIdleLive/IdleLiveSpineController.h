...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER_CANPLAYGROUP_OFFSET UNITYSDK_OFFSET(0xBBBCF50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xBBBBAB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER_PLAYACTION_OFFSET UNITYSDK_OFFSET(0xBBBC6B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER_PLAYBYANIMGROUPID_OFFSET UNITYSDK_OFFSET(0xBBBCCA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER_PLAYGROUP_OFFSET UNITYSDK_OFFSET(0xBBBC7E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER_SETTEXTBUBBLE_OFFSET UNITYSDK_OFFSET(0xBBBC610)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER_TRYPLAYIDLEACTIONBYGACHACOUNT_OFFSET UNITYSDK_OFFSET(0xBBBD050)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER__BUILDANIMGROUPINFO_OFFSET UNITYSDK_OFFSET(0xBBBBBD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER__CANPLAYANIM_OFFSET UNITYSDK_OFFSET(0xBBBC730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBBBD1E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER__HIDEBUBBLEAFTERDELAY_OFFSET UNITYSDK_OFFSET(0xBBBD180)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER__INITSPINEMESH_OFFSET UNITYSDK_OFFSET(0xBBBC160)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER__INITSPINE_OFFSET UNITYSDK_OFFSET(0xBBBBE60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER__ONSPINEMESHREADY_OFFSET UNITYSDK_OFFSET(0xBBBC420)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESPINECONTROLLER__SHOWBUBBLETEXT_OFFSET UNITYSDK_OFFSET(0xBBBCA70)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveSpineController_TypeDefinitionIndex = 71582;
