...
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_APPENDSCROLL_OFFSET UNITYSDK_OFFSET(0xBB6B810)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_GET_ISSCROLLING_OFFSET UNITYSDK_OFFSET(0xBB6B6E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_INIT_OFFSET UNITYSDK_OFFSET(0xBB6B720)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBB6BAB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_STARTSCROLL_OFFSET UNITYSDK_OFFSET(0xBB6B790)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_STOPSCROLL_OFFSET UNITYSDK_OFFSET(0xBB6B890)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xBB6B8E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xBB6BB00)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int GiftThankScrollAnimator_TypeDefinitionIndex = 71564;
