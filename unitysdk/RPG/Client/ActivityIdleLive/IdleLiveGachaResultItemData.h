...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_CREATEGEMMERGEDATA_OFFSET UNITYSDK_OFFSET(0xBB9FB60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBB9F540)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_GET_AVATARITEM_OFFSET UNITYSDK_OFFSET(0xBBA0740)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_GET_GEMCOUNT_OFFSET UNITYSDK_OFFSET(0xBBA0720)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_GET_ISNEWAVATAR_OFFSET UNITYSDK_OFFSET(0xBBA0760)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBB9FB10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_SETISNEWAVATAR_OFFSET UNITYSDK_OFFSET(0xBB9F8A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_SET_AVATARITEM_OFFSET UNITYSDK_OFFSET(0xBBA0750)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_SET_GEMCOUNT_OFFSET UNITYSDK_OFFSET(0xBBA0730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBBA0710)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGachaResultItemData_TypeDefinitionIndex = 71654;
