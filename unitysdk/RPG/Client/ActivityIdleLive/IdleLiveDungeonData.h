...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_CLEARFRIENDSOLTDATAS_OFFSET UNITYSDK_OFFSET(0xBB87FD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBB87C60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GETCHATSERVICE_OFFSET UNITYSDK_OFFSET(0xBB87F30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_ASSISTDATAS_OFFSET UNITYSDK_OFFSET(0xBB89640)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBB89720)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_FRIENDSOLTDATAS_OFFSET UNITYSDK_OFFSET(0xBB89740)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xBB896D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_MAXPROGRESS_OFFSET UNITYSDK_OFFSET(0xBB89690)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_SAVEDTEAM_OFFSET UNITYSDK_OFFSET(0xBB896B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_ISASSISTDATAINFRIENDSOLT_OFFSET UNITYSDK_OFFSET(0xBB88710)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SETSAVEDTEAM_OFFSET UNITYSDK_OFFSET(0xBB87EC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBB89730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SET_FRIENDSOLTDATAS_OFFSET UNITYSDK_OFFSET(0xBB89750)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SET_MAXPROGRESS_OFFSET UNITYSDK_OFFSET(0xBB896A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SET_SAVEDTEAM_OFFSET UNITYSDK_OFFSET(0xBB896C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_TRYADDASSISTDATA_OFFSET UNITYSDK_OFFSET(0xBB881B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_TRYREMOVEASSISTDATA_OFFSET UNITYSDK_OFFSET(0xBB88550)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_UPDATE_1_OFFSET UNITYSDK_OFFSET(0xBB88B20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_UPDATE_2_OFFSET UNITYSDK_OFFSET(0xBB88B90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_UPDATE_3_OFFSET UNITYSDK_OFFSET(0xBB88FE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0xBB88880)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB87E40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA__GETASSISTDATAS_OFFSET UNITYSDK_OFFSET(0xBB892A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA__ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xBB89040)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDungeonData_TypeDefinitionIndex = 71594;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::ActivityIdleLive::IdleLiveDungeonFriendSoltData*>* _FriendSoltDatas_k__BackingField; // 0x20
