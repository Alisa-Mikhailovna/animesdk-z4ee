...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0xBB6DB40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GETTAGRANKDESC_OFFSET UNITYSDK_OFFSET(0xBB70BB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GETTAGRANK_OFFSET UNITYSDK_OFFSET(0xBB70E40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBB71000)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBB70FE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GET_TAG_OFFSET UNITYSDK_OFFSET(0xBB70FC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBB71010)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_SET_NAME_OFFSET UNITYSDK_OFFSET(0xBB70FF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_SET_TAG_OFFSET UNITYSDK_OFFSET(0xBB70FD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBB70BA0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveAvatarTagConfig_TypeDefinitionIndex = 71476;
