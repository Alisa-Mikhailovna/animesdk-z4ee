...
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_CONVERTORDERTOPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0xBB5E3B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_CONVERTSLOTDATASTOAVATARDICT_OFFSET UNITYSDK_OFFSET(0xBB5E720)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_CREATEBATTLESTATINFO_OFFSET UNITYSDK_OFFSET(0xBB5F0C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_FORMATPERCENTWITHONEDECIMAL_1_OFFSET UNITYSDK_OFFSET(0xBB5EFC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_FORMATPERCENTWITHONEDECIMAL_OFFSET UNITYSDK_OFFSET(0xBB5ED30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GETCANSHOWPROPERTYTYPES_OFFSET UNITYSDK_OFFSET(0xBB5E4F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GETCHAPTERNUMTEXTIDBYNODEINDEX_OFFSET UNITYSDK_OFFSET(0xBB5ECA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GETSOLTDATABYTYPE_OFFSET UNITYSDK_OFFSET(0xBB5E3F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xBB60D90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_ASSISTREWARDID_OFFSET UNITYSDK_OFFSET(0xBB60A90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_CHESTID_OFFSET UNITYSDK_OFFSET(0xBB60310)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_CRYSTALID_OFFSET UNITYSDK_OFFSET(0xBB60110)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_DUNGEONMULTIPLEPLAYERSETTLERATIOLIST_OFFSET UNITYSDK_OFFSET(0xBB5FC30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_DUNGEONREFRESHTIME_OFFSET UNITYSDK_OFFSET(0xBB60B90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_FORCETOTRACESUBMISSIONID_OFFSET UNITYSDK_OFFSET(0xBB60DF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHACOSTCOUNT_OFFSET UNITYSDK_OFFSET(0xBB60410)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHACRYSTALID_OFFSET UNITYSDK_OFFSET(0xBB60210)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHAGUARANTEECOUNT_OFFSET UNITYSDK_OFFSET(0xBB60710)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHAMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xBB60510)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHAREDOTCOUNT_OFFSET UNITYSDK_OFFSET(0xBB60610)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_INITIALBASEPOWER_OFFSET UNITYSDK_OFFSET(0xBB60810)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_INITIALMAXFRIENDSOLTCOUNT_OFFSET UNITYSDK_OFFSET(0xBB609C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_INITIALMAXLEVEL_OFFSET UNITYSDK_OFFSET(0xBB5FBF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_NEWREDDOTEXCLUDEAVATARIDS_OFFSET UNITYSDK_OFFSET(0xBB60E50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_POWERSIGNIFICANTFIGURES_OFFSET UNITYSDK_OFFSET(0xBB60C90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_TABICONFEMALE_OFFSET UNITYSDK_OFFSET(0xBB58D30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_TABICONMALE_OFFSET UNITYSDK_OFFSET(0xBB58C70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_TAGLEVELLIST_OFFSET UNITYSDK_OFFSET(0xBB5FEA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_TECHPOINTID_OFFSET UNITYSDK_OFFSET(0xBB608C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_SET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xBB60DC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_SET_FORCETOTRACESUBMISSIONID_OFFSET UNITYSDK_OFFSET(0xBB60E20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_SET_NEWREDDOTEXCLUDEAVATARIDS_OFFSET UNITYSDK_OFFSET(0xBB60E80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0xBB60ED0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0xBB60EC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS__ISAVATARINTEAM_OFFSET UNITYSDK_OFFSET(0xBB5F6A0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int ActivityIdleLiveUtils_TypeDefinitionIndex = 71460;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(ActivityIdleLiveUtils_TypeDefinitionIndex)->GetStaticField(0x37F50);
		}
		static ::System::UInt32* StaticGet__ActivityID_k__BackingField()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(ActivityIdleLiveUtils_TypeDefinitionIndex)->GetStaticField(0x8FA0);
		}
		static ::System::UInt32* StaticGet__ForceToTraceSubMissionID_k__BackingField()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(ActivityIdleLiveUtils_TypeDefinitionIndex)->GetStaticField(0x8FA4);
		}
