...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBB6DBE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GETPROMOTIONBYUNLOCKSTAR_OFFSET UNITYSDK_OFFSET(0xBB6DE10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xBB6DF80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_AVATARPOSTYPE_OFFSET UNITYSDK_OFFSET(0xBB6DFD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBB6E050)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_GACHACONFIG_OFFSET UNITYSDK_OFFSET(0xBB6E070)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_PROMOTIONS_OFFSET UNITYSDK_OFFSET(0xBB6E220)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_STAR_OFFSET UNITYSDK_OFFSET(0xBB6E240)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_UNLOCKEDPROMOTIONS_OFFSET UNITYSDK_OFFSET(0xBB6E090)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBB6E060)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_SET_GACHACONFIG_OFFSET UNITYSDK_OFFSET(0xBB6E080)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_SET_PROMOTIONS_OFFSET UNITYSDK_OFFSET(0xBB6E230)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0xBB6DDA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB6DD90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA__GET_UNLOCKEDPROMOTIONS_B__16_0_OFFSET UNITYSDK_OFFSET(0xBB6E290)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveAvatarData_TypeDefinitionIndex = 71467;
