...
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_CANCELPREREPLACEDEQUIPS_OFFSET UNITYSDK_OFFSET(0xBBE18C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_CLEARALLSPEQUIPS_OFFSET UNITYSDK_OFFSET(0xBBE0390)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_GETALLEQUIPPEDSLOTS_OFFSET UNITYSDK_OFFSET(0xBBE0230)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_GETALLEQUIPPEDSPEQUIPS_OFFSET UNITYSDK_OFFSET(0xBBE0570)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_GETALLSLOTSEQUPPEDBYAVATAR_OFFSET UNITYSDK_OFFSET(0xBBDFC30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_GETALLSPEQUIPSLOTUIDATAS_OFFSET UNITYSDK_OFFSET(0xBBE0AF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_GETEQUIPBELONGEDONEBASEDINDEX_OFFSET UNITYSDK_OFFSET(0xBBE0F30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_GETEQUIPMENTMODIFIERSOURCE_OFFSET UNITYSDK_OFFSET(0xBBE1AE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_GETSLOTIDBYTEAMSLOT_OFFSET UNITYSDK_OFFSET(0xBBDFE40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_GET_VERSION_OFFSET UNITYSDK_OFFSET(0xBBDFB40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_HASUNLOCKEDSLOT_OFFSET UNITYSDK_OFFSET(0xBBE0050)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_ISEQUIPWORN_OFFSET UNITYSDK_OFFSET(0xBBDDE20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_ISSLOTALLEQUIPPED_OFFSET UNITYSDK_OFFSET(0xBBDE790)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_PREREPLACEEQUIP_OFFSET UNITYSDK_OFFSET(0xBBE13B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_SET_VERSION_OFFSET UNITYSDK_OFFSET(0xBBDFB50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_TRYGETEMPTYSLOTID_OFFSET UNITYSDK_OFFSET(0xBBE1350)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_TRYGETEQUIPBELONGEDSLOT_OFFSET UNITYSDK_OFFSET(0xBBE0E10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_TRYGETSLOTBYID_OFFSET UNITYSDK_OFFSET(0xBBDFF50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_TRYGETSPEQUIPSTATUSIFTAKEOFFEQUIP_OFFSET UNITYSDK_OFFSET(0xBBDEDE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_TRYGETSPEQUIPSTATUSIFWEAREQUIP_OFFSET UNITYSDK_OFFSET(0xBBDEA90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_TRYGETWORNEQUIPBYAVATAR_OFFSET UNITYSDK_OFFSET(0xBBC3C10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_TRYGETWORNEQUIPBYEQUIPID_OFFSET UNITYSDK_OFFSET(0xBBE0D00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_TRYREPLACEEQUIPBYLIST_OFFSET UNITYSDK_OFFSET(0xBBE1600)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_TRYREPLACEEQUIP_OFFSET UNITYSDK_OFFSET(0xBBE1520)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO_WEAREQUIP_OFFSET UNITYSDK_OFFSET(0xBBE17D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO__CANTAKEOFFEQUIP_OFFSET UNITYSDK_OFFSET(0xBBE1120)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO__CANWEARNEWEQUIP_OFFSET UNITYSDK_OFFSET(0xBBE1180)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xBBDFBA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO__GETFIRSTEMPTYSLOT_OFFSET UNITYSDK_OFFSET(0xBBE11F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO__INCREASEVERSION_OFFSET UNITYSDK_OFFSET(0xBBDFB60)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int SpEquipSlotInfo_TypeDefinitionIndex = 71631;
