...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBB86990)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDDATA_GET_HISTROYLIST_OFFSET UNITYSDK_OFFSET(0xBB87410)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDDATA_GET_TOTALREWARDLIST_OFFSET UNITYSDK_OFFSET(0xBB873F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDDATA_SET_HISTROYLIST_OFFSET UNITYSDK_OFFSET(0xBB87420)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDDATA_SET_TOTALREWARDLIST_OFFSET UNITYSDK_OFFSET(0xBB87400)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB873E0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDungeonAssistRewardData_TypeDefinitionIndex = 71590;
