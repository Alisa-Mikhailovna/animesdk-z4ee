...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_AWAKE_OFFSET UNITYSDK_OFFSET(0xBBB1420)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBBB1F20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBBB2560)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_REGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xBBB1610)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xBBB1660)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBBB2800)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__INSERTULTRASKILL_OFFSET UNITYSDK_OFFSET(0xBBB1F80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__ONAUTOBATTLESTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0xBBB2490)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__ONULTRASKILLBEGIN_OFFSET UNITYSDK_OFFSET(0xBBB24E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__ONULTRASKILLBTNCLICK_OFFSET UNITYSDK_OFFSET(0xBBB2160)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__REFRESHONSPCHANGED_OFFSET UNITYSDK_OFFSET(0xBBB1E70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__REFRESHSP_OFFSET UNITYSDK_OFFSET(0xBBB1A20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__RESETSTATE_OFFSET UNITYSDK_OFFSET(0xBBB19B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveInGameUltraSkillPanel_TypeDefinitionIndex = 71579;
