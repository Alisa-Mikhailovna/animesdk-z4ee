...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBB6DF70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA___C__DISPLAYCLASS2_0__GETPROMOTIONBYUNLOCKSTAR_B__0_OFFSET UNITYSDK_OFFSET(0xBB6E2C0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveAvatarData___c__DisplayClass2_0_TypeDefinitionIndex = 71468;
