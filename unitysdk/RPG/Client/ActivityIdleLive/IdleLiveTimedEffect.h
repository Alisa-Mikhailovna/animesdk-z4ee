...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETIMEDEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBBD7DC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETIMEDEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBBD7E00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETIMEDEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xBBD7E90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETIMEDEFFECT_SETCANVAS_OFFSET UNITYSDK_OFFSET(0xBBD7FF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETIMEDEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBBD7D80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETIMEDEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBBD8090)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveTimedEffect_TypeDefinitionIndex = 71586;
