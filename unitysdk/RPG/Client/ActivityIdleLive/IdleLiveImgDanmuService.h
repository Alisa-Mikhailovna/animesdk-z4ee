...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBBADE10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE_GETIMAGEDANMU_OFFSET UNITYSDK_OFFSET(0xBBADBB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__ADDIMAGEDANMU_OFFSET UNITYSDK_OFFSET(0xBBAE400)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__CLEARCREATEDTRIGGERS_OFFSET UNITYSDK_OFFSET(0xBBADFB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__CLEARENDEDIMAGEDANMUS_OFFSET UNITYSDK_OFFSET(0xBBADCB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xBBAD6E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__INITUNLOCKIDMAPPING_OFFSET UNITYSDK_OFFSET(0xBBAD860)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__ONSETDANMUENABLE_OFFSET UNITYSDK_OFFSET(0xBBAE6B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__ONUNLOCKIDUPDATED_OFFSET UNITYSDK_OFFSET(0xBBAE230)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveImgDanmuService_TypeDefinitionIndex = 71744;
