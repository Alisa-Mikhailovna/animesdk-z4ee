...
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBB622C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_GET_CUTINFIGUREPATH_OFFSET UNITYSDK_OFFSET(0xBB62280)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBB62260)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBB62240)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_GET_SKILLDESCS_OFFSET UNITYSDK_OFFSET(0xBB622A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBB622D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_SET_CUTINFIGUREPATH_OFFSET UNITYSDK_OFFSET(0xBB62290)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_SET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBB62270)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xBB62250)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA_SET_SKILLDESCS_OFFSET UNITYSDK_OFFSET(0xBB622B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_AVATARNEWGOTUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB622E0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int AvatarNewGotUiData_TypeDefinitionIndex = 71807;
