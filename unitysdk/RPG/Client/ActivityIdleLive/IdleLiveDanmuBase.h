...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_CORE_OFFSET UNITYSDK_OFFSET(0xBB815F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBB81500)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_GETWORLDEDGE_OFFSET UNITYSDK_OFFSET(0xBB819F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_GETWORLDHEIGHT_OFFSET UNITYSDK_OFFSET(0xBB81970)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_GET_ISENDED_OFFSET UNITYSDK_OFFSET(0xBB81240)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_GET_UID_OFFSET UNITYSDK_OFFSET(0xBB81260)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_HASLEFTRIGHTEDGE_OFFSET UNITYSDK_OFFSET(0xBB81A60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0xBB81790)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xBB81320)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBB81540)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_SETFLYSPEED_OFFSET UNITYSDK_OFFSET(0xBB81910)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_SETISSTART_OFFSET UNITYSDK_OFFSET(0xBB81280)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_SET_ISENDED_OFFSET UNITYSDK_OFFSET(0xBB81250)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_SET_UID_OFFSET UNITYSDK_OFFSET(0xBB81270)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBB812D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDANMUBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xBB81B70)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDanmuBase_TypeDefinitionIndex = 71566;
