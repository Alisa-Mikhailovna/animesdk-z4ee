...
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBBDB300)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_HAVENEWINTERACTION_OFFSET UNITYSDK_OFFSET(0xBBDAEF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_POPINTERACTIONID_OFFSET UNITYSDK_OFFSET(0xBBDB040)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_SETENABLE_OFFSET UNITYSDK_OFFSET(0xBBDB190)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_UPDATEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0xBBDAD80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xBBDAC40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE__ONPERFORMGIFTADDED_OFFSET UNITYSDK_OFFSET(0xBBDACC0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int PerformShowGiftService_TypeDefinitionIndex = 71720;
