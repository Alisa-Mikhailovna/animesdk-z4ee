...
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0xCCD4F90)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_CANOVERRIDEBLENDSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0xCCD3830)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_CONSUMEBLENDSHAPEVALUEMAP_OFFSET UNITYSDK_OFFSET(0xCCD3120)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_ENABLEAUTOBLINK_OFFSET UNITYSDK_OFFSET(0xCCD3100)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0xCCD30A0)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xCCD3110)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_LOCKEYE_OFFSET UNITYSDK_OFFSET(0xCCD3270)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_0860F812E446AE7C_OFFSET UNITYSDK_OFFSET(0xCCD4DA0)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0xCCD4A80)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xCCD4F10)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_POPDISABLEBLINKREASON_OFFSET UNITYSDK_OFFSET(0xCCD36E0)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_PUSHDISABLEBLINKREASON_OFFSET UNITYSDK_OFFSET(0xCCD3650)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_RESET_OFFSET UNITYSDK_OFFSET(0xCCD51C0)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_SETAUTOBLINKENABLED_OFFSET UNITYSDK_OFFSET(0xCCD3530)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_SETUPEYEMONO_OFFSET UNITYSDK_OFFSET(0xCCD3310)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_TICK_OFFSET UNITYSDK_OFFSET(0xCCD3A10)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0xCCD5260)
