...
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_CHECKISDIFFICULTYUNLOCK_OFFSET UNITYSDK_OFFSET(0xD47DC70)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_CLEARBATTLECOCOONDATA_OFFSET UNITYSDK_OFFSET(0xD47E7A0)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD4565E0)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_GETALLCOCOONDATALIST_OFFSET UNITYSDK_OFFSET(0xD47DD20)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_GETCOCOONDATABYID_OFFSET UNITYSDK_OFFSET(0xD47E670)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_GETCOCOONDATALISTBYDIFFICULTY_OFFSET UNITYSDK_OFFSET(0xD47DBD0)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_GETDIFFICULTYLIST_OFFSET UNITYSDK_OFFSET(0xD47DA40)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_GETROGUETOURNRELICCOCOONNEWDIFFICULTYLIST_OFFSET UNITYSDK_OFFSET(0xD47ED90)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_GETROGUETOURNRELICCOCOONNEWIDLIST_OFFSET UNITYSDK_OFFSET(0xD47EEE0)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_GET_BATTLECOCOONDATA_OFFSET UNITYSDK_OFFSET(0xD47F520)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_GET_ISINCOCOON_OFFSET UNITYSDK_OFFSET(0xD47F4D0)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_INIT_OFFSET UNITYSDK_OFFSET(0xD47DA00)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_ISCURDIFFICULTYNEW_OFFSET UNITYSDK_OFFSET(0xD47EA70)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_ISDIFFICULTYNEEDUNLOCK_OFFSET UNITYSDK_OFFSET(0xD47E800)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_SETBATTLECOCOONDATA_OFFSET UNITYSDK_OFFSET(0xD47E4E0)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_SETCURDIFFICULTYCOCOONSEEN_OFFSET UNITYSDK_OFFSET(0xD47E850)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_SETDIFFICULTYSEEN_OFFSET UNITYSDK_OFFSET(0xD47EBE0)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION_SET_BATTLECOCOONDATA_OFFSET UNITYSDK_OFFSET(0xD47F530)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION__CHECKISCOCOONDATAAVAILABLE_OFFSET UNITYSDK_OFFSET(0xD47F330)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD454F80)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONCOLLECTION__GENERATECOCOONDATADICT_OFFSET UNITYSDK_OFFSET(0xD47DF90)
