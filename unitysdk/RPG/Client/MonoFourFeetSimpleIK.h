...
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_AWAKE_OFFSET UNITYSDK_OFFSET(0xCCEB2F0)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_COLLECTTHREADDATA_OFFSET UNITYSDK_OFFSET(0xCCEB9A0)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_GETREFERENCETRANSFORMS_OFFSET UNITYSDK_OFFSET(0xCCEB690)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_GET_IKENABLED_OFFSET UNITYSDK_OFFSET(0xCCEB0F0)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0xCCEB150)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_INITIATE_OFFSET UNITYSDK_OFFSET(0xCCEB340)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_METHOD_5_0C88AB06D46E777A_OFFSET UNITYSDK_OFFSET(0xCCECB20)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_PREPROCESS_OFFSET UNITYSDK_OFFSET(0xCCEC230)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xCCECA60)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0xCCEB1F0)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_SETIKENABLED_OFFSET UNITYSDK_OFFSET(0xCCEB280)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_SETUPGROUNDANGLE_OFFSET UNITYSDK_OFFSET(0xCCEC0A0)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK__CTOR_OFFSET UNITYSDK_OFFSET(0xCCED310)
