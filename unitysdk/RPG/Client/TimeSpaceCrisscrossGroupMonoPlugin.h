...
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD6C4EF0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_DISABLETESTMODE_OFFSET UNITYSDK_OFFSET(0xD6C4D70)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ENABLETESTMODE_OFFSET UNITYSDK_OFFSET(0xD6C4CE0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_METHOD_7_491027A35182E1D6_OFFSET UNITYSDK_OFFSET(0xD6C49D0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ONENTERMAP_OFFSET UNITYSDK_OFFSET(0xD6C4B80)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ONLIGHTMOVE_OFFSET UNITYSDK_OFFSET(0xD6C48E0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ONTSCCHANGE_OFFSET UNITYSDK_OFFSET(0xD6C4920)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_OVERRIDESECONDEDGE_OFFSET UNITYSDK_OFFSET(0xD6C1FF0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_REGISTERRENDERER_OFFSET UNITYSDK_OFFSET(0xD6C4BC0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_SETEDGEPARAM_OFFSET UNITYSDK_OFFSET(0xD6C4A80)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_SETEDGESCALE_OFFSET UNITYSDK_OFFSET(0xD6C2310)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD6C4EA0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_UNREGISTERRENDERER_OFFSET UNITYSDK_OFFSET(0xD6C4C60)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xD6C4F40)
