...
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0xCBAB6F0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xCBABB90)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0xCBABBA0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_ISDATAREADY_OFFSET UNITYSDK_OFFSET(0xCBABBB0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_RECOMMENDPLAN_OFFSET UNITYSDK_OFFSET(0xCBABCD0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_SHOWEXPLAIN_OFFSET UNITYSDK_OFFSET(0xCBABC00)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCBAB4B0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_REQUESTRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xCBAB530)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xCBAB500)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK__GETRECOMMENDPLAN_OFFSET UNITYSDK_OFFSET(0xCBAB7A0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK__HASSMARTSUITSYSTEMPLAN_OFFSET UNITYSDK_OFFSET(0xCBABAB0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK__REQUESTRECOMMENDDATA_B__3_0_OFFSET UNITYSDK_OFFSET(0xCBABD20)
