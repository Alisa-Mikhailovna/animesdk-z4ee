...
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_GET_ISPROVIDER_OFFSET UNITYSDK_OFFSET(0xBDB0110)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_GET_ISRECEIVER_OFFSET UNITYSDK_OFFSET(0xBDB0120)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xBDB0130)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_METHOD_7_1C298FA6BB9350FA_OFFSET UNITYSDK_OFFSET(0xBDAFF00)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_METHOD_7_A0433AB55CC45192_OFFSET UNITYSDK_OFFSET(0xBDAFDD0)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_METHOD_7_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xBDB00A0)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE__CTOR_OFFSET UNITYSDK_OFFSET(0xBDB0300)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFXDataNode_TypeDefinitionIndex = 70278;
