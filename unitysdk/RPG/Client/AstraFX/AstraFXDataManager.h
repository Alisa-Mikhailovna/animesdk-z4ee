...
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATAMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xBDACDD0)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATAMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0xBDACEA0)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATAMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0xBDAD360)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBDAD4F0)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFXDataManager_TypeDefinitionIndex = 70276;
	...
	public:
		...
		{
			return (::RPG::Client::AstraFX::AstraFXDataManager**)Il2CppClass::FromTypeDefinitionIndex(AstraFXDataManager_TypeDefinitionIndex)->GetStaticField(0x4F090);
		}
