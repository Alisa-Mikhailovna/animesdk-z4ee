...
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_PASSSETTINGBYMESH_GET_THREADGROUPSEXPLANATION_OFFSET UNITYSDK_OFFSET(0xBDB1BC0)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_PASSSETTINGBYMESH_GET_VALID_OFFSET UNITYSDK_OFFSET(0xBDB1B50)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_PASSSETTINGBYMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xBDB1F40)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFX_SkinnedMesh_PassSettingByMesh_TypeDefinitionIndex = 70287;
