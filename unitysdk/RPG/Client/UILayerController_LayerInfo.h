...
#define RPG_CLIENT_UILAYERCONTROLLER_LAYERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD7C4200)

namespace RPG::Client
{
	inline static constexpr unsigned int UILayerController_LayerInfo_TypeDefinitionIndex = 69724;
