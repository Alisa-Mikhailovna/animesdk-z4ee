...
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_CANCRAFTBYADDITEM_OFFSET UNITYSDK_OFFSET(0xC6E8800)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_CANCRAFTTOROLE_OFFSET UNITYSDK_OFFSET(0xC6E8E20)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_CANCRAFT_OFFSET UNITYSDK_OFFSET(0xC6E8550)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_GET_COSTITEMIDS_OFFSET UNITYSDK_OFFSET(0xC6E9150)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_GET_COSTITEMSDICT_OFFSET UNITYSDK_OFFSET(0xC6E9130)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_GET_CRAFTID_OFFSET UNITYSDK_OFFSET(0xC6E90F0)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_GET_TARGETEQUIPITEMID_OFFSET UNITYSDK_OFFSET(0xC6E9110)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_NEEDCOSTITEM_OFFSET UNITYSDK_OFFSET(0xC6E84B0)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_SET_COSTITEMIDS_OFFSET UNITYSDK_OFFSET(0xC6E9160)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_SET_COSTITEMSDICT_OFFSET UNITYSDK_OFFSET(0xC6E9140)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_SET_CRAFTID_OFFSET UNITYSDK_OFFSET(0xC6E9100)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE_SET_TARGETEQUIPITEMID_OFFSET UNITYSDK_OFFSET(0xC6E9120)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE__CTOR_OFFSET UNITYSDK_OFFSET(0xC6E7E70)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPE__GETRELATEDROLEUIDS_OFFSET UNITYSDK_OFFSET(0xC6E8C30)
