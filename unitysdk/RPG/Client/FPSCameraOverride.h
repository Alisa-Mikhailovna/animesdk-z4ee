...
#define RPG_CLIENT_FPSCAMERAOVERRIDE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC42E810)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC42E700)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC42E790)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC42E5D0)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_PREVIEW_OFFSET UNITYSDK_OFFSET(0xC42E8E0)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_REVERT_OFFSET UNITYSDK_OFFSET(0xC42EA00)
#define RPG_CLIENT_FPSCAMERAOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xC42EA90)
