...
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM_CLEARTUTORIAL_OFFSET UNITYSDK_OFFSET(0xD755800)
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM_CLEAR_OFFSET UNITYSDK_OFFSET(0xD74CD70)
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM_GET_ISGETCHEST_OFFSET UNITYSDK_OFFSET(0xD755870)
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD74D290)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* RefreshedGridIDs; // 0x30
		::System::Collections::Generic::List_1<::Class_1_1CBA230307F9C289_106*>* RecordData; // 0x38
		::System::Boolean IsFloorBuffReplaced; // 0x40
		::System::Boolean IsGetNewEnvBuff; // 0x41
		::System::Boolean IsGetUltraItem; // 0x42
		::System::Boolean IsBuffUpdated; // 0x43
		::System::Boolean IsExplorePointUpdated; // 0x44
		::System::Boolean IsFloorUpdated; // 0x45
		::System::UInt32 GotChestItemID; // 0x48
		::System::Boolean IsTeamUpdated; // 0x4C
		::System::Boolean IsMapUpdated; // 0x4D
		::System::Boolean IsItemUpdated; // 0x4E
		::System::Boolean IsGetNewFloorBuff; // 0x4F
