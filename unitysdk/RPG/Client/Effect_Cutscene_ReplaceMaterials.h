...
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xC301F00)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xC301770)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_METHOD_6_454FB4A3C7EA73DD_OFFSET UNITYSDK_OFFSET(0xC302150)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_METHOD_6_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xC302100)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xC302000)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_TICK_OFFSET UNITYSDK_OFFSET(0xC3017B0)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS__CTOR_OFFSET UNITYSDK_OFFSET(0xC3022B0)
