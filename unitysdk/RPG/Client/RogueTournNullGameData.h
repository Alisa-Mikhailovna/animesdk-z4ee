...
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GETMONSTERELITEDROPID_OFFSET UNITYSDK_OFFSET(0xD460830)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GETROGUEAVATARCOLLECTION_OFFSET UNITYSDK_OFFSET(0xD460780)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GETROGUEBLACKBOARDINFO_OFFSET UNITYSDK_OFFSET(0xD4608C0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GETROGUEDEBUGINFO_OFFSET UNITYSDK_OFFSET(0xD460870)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_AREAGROUP_OFFSET UNITYSDK_OFFSET(0xD4609C0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0xD460980)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_BLACKBOARDINFO_OFFSET UNITYSDK_OFFSET(0xD460B90)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0xD460A20)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD454EF0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_ISCANUSECONSUMEITEM_OFFSET UNITYSDK_OFFSET(0xD460AC0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_LEVELINFO_OFFSET UNITYSDK_OFFSET(0xD460B50)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_REPORTTRANSNO_OFFSET UNITYSDK_OFFSET(0xD460B00)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_SERVERCONTROLLERID_OFFSET UNITYSDK_OFFSET(0xD460940)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_SETTLERESULTFACTORY_OFFSET UNITYSDK_OFFSET(0xD460BA0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_TOURNMODE_OFFSET UNITYSDK_OFFSET(0xD460900)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_INIT_OFFSET UNITYSDK_OFFSET(0xD460740)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xD4607E0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD460710)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::RogueTournNullGameData**)Il2CppClass::FromTypeDefinitionIndex(RogueTournNullGameData_TypeDefinitionIndex)->GetStaticField(0x2D350);
		}
