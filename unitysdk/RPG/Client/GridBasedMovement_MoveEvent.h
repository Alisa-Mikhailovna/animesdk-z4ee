...
#define RPG_CLIENT_GRIDBASEDMOVEMENT_MOVEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC6A0CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridBasedMovement_MoveEvent_TypeDefinitionIndex = 69261;
