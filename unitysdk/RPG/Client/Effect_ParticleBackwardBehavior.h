...
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xC32C7A0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_004D2CE97AA50BBA_OFFSET UNITYSDK_OFFSET(0xC334BC0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_147A527305B2FF1B_OFFSET UNITYSDK_OFFSET(0xC332670)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC337340)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0xC32C5D0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xC332930)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_3E43B71D665FF6C0_OFFSET UNITYSDK_OFFSET(0xC334740)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC32CB10)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xC32CB70)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC32C470)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_65BB8F0F1E258993_OFFSET UNITYSDK_OFFSET(0xC32C820)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_68805403250CC013_OFFSET UNITYSDK_OFFSET(0xC332E70)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_708FD95A0BF1E451_OFFSET UNITYSDK_OFFSET(0xC333170)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_7D2C7213E6B374D8_OFFSET UNITYSDK_OFFSET(0xC32CC70)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_8C1FB0C6AEFFB54E_OFFSET UNITYSDK_OFFSET(0xC3373E0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC337120)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0xC32CA00)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xC32C740)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC3370E0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xC32C4D0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_D35B60AE823B8CC1_OFFSET UNITYSDK_OFFSET(0xC332990)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xC32CBD0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xC337700)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC337620)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(Effect_ParticleBackwardBehavior_TypeDefinitionIndex)->GetStaticField(0x687C0);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Vector4>** StaticGet_customDataList2()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(Effect_ParticleBackwardBehavior_TypeDefinitionIndex)->GetStaticField(0x687C8);
		}
		static ::System::Int32* StaticGet__Time_ShaderID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_ParticleBackwardBehavior_TypeDefinitionIndex)->GetStaticField(0x14530);
		}
