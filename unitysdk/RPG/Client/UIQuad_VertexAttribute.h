...
#define RPG_CLIENT_UIQUAD_VERTEXATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1530D0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIQuad_VertexAttribute_TypeDefinitionIndex = 69409;
