...
#define RPG_CLIENT_MAPDEF_ACTIVEHOYOGROUPEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCA74D50)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_1_0273F17990DD7925* InitServerGroupInfo; // 0x10
		::Class_1_E577B5580A99D425_5* RefreshServerGroupInfo; // 0x18
