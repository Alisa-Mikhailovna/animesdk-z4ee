...
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER_CREATE_OFFSET UNITYSDK_OFFSET(0xC162710)
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER_GET_ROUNDTALKMAP_OFFSET UNITYSDK_OFFSET(0xC162F50)
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER_GET_TEAMAVATARICON_OFFSET UNITYSDK_OFFSET(0xC162960)
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER_GET_TEAMCONFIGJSON_OFFSET UNITYSDK_OFFSET(0xC163190)
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER_GET_TEAMICON_OFFSET UNITYSDK_OFFSET(0xC1628C0)
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER_GET_TEAMID_OFFSET UNITYSDK_OFFSET(0xC163110)
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER_GET_TEAMNAME_OFFSET UNITYSDK_OFFSET(0xC1627D0)
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC163130)
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER_SET_TEAMID_OFFSET UNITYSDK_OFFSET(0xC163120)
#define RPG_CLIENT_CHIMERATEAMROWWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0xC163100)
