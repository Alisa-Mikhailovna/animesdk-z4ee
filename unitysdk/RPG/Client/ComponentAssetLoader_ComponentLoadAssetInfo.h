...
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADASSETINFO_METHOD_2_2DC90EE759C8637B_OFFSET UNITYSDK_OFFSET(0xC1A2C30)
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADASSETINFO_METHOD_2_AC59C7CF75B4785D_OFFSET UNITYSDK_OFFSET(0x146020)
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADASSETINFO_METHOD_2_CF5357012C5DE97D_OFFSET UNITYSDK_OFFSET(0xC1A2BE0)
