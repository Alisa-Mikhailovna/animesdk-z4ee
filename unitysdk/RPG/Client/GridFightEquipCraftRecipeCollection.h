...
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_ADDRECIPE_OFFSET UNITYSDK_OFFSET(0xC6E8110)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_CANCRAFT_OFFSET UNITYSDK_OFFSET(0xC6E9280)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_GET_RECIPES_OFFSET UNITYSDK_OFFSET(0xC6E9410)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_GET_TARGETEQUIPITEMID_OFFSET UNITYSDK_OFFSET(0xC6E93F0)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_SET_RECIPES_OFFSET UNITYSDK_OFFSET(0xC6E9420)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_SET_TARGETEQUIPITEMID_OFFSET UNITYSDK_OFFSET(0xC6E9400)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC6E80D0)
