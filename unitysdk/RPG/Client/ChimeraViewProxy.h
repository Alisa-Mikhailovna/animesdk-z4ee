...
#define RPG_CLIENT_CHIMERAVIEWPROXY_GET_INDEXINTEAM_OFFSET UNITYSDK_OFFSET(0xC164210)
#define RPG_CLIENT_CHIMERAVIEWPROXY_POSTEVENT_OFFSET UNITYSDK_OFFSET(0xC164340)
#define RPG_CLIENT_CHIMERAVIEWPROXY_SET_INDEXINTEAM_OFFSET UNITYSDK_OFFSET(0xC164220)
#define RPG_CLIENT_CHIMERAVIEWPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xC164740)
