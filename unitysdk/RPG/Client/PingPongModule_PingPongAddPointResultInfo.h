...
#define RPG_CLIENT_PINGPONGMODULE_PINGPONGADDPOINTRESULTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCF9EA10)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::UInt32 RacketLengthAddPoint; // 0x10
		::System::UInt32 MPAddPoint; // 0x14
		::System::UInt32 HPAddPoint; // 0x18
		::System::UInt32 RacketSpeedAddPoint; // 0x1C
