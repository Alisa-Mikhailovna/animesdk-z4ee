...
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD2C720)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCD2C6D0)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD2C5C0)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE_SETUPCHANGECALLBACK_OFFSET UNITYSDK_OFFSET(0xCD2C560)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD2C770)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE__ONACTIVECHANGE_OFFSET UNITYSDK_OFFSET(0xCD2C610)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTransformActiveChange_TypeDefinitionIndex = 69329;
