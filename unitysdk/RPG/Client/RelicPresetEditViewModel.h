...
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xD2F0200)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_GETINVENTORYRELICITEMDATALIST_OFFSET UNITYSDK_OFFSET(0xD2F0360)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_GETRELICITEMDATA_OFFSET UNITYSDK_OFFSET(0xD2F0710)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_GETRELICRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xD2F08A0)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_GET_PLANVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD2F0BF0)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_SET_PLANVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD2F0C00)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD2F0350)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL__GETRELICTYPEMATCHSCORE_OFFSET UNITYSDK_OFFSET(0xD2F08F0)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL__SORTINVENTORYRELICITEMS_OFFSET UNITYSDK_OFFSET(0xD2F03D0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_5D2E9E194E93B02A* _PresetDataService; // 0x18
