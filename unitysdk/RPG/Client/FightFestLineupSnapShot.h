...
#define RPG_CLIENT_FIGHTFESTLINEUPSNAPSHOT_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xC5CCB90)
#define RPG_CLIENT_FIGHTFESTLINEUPSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0xC5CCBF0)
