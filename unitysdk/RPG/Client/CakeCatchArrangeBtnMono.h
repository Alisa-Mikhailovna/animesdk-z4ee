...
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO_AWAKE_OFFSET UNITYSDK_OFFSET(0xBEE53B0)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO_CLEARBUTTONCONFIG_OFFSET UNITYSDK_OFFSET(0xBEE55A0)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBEE55E0)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO_SETBUTTONCONFIG_OFFSET UNITYSDK_OFFSET(0xBEE5540)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO__CTOR_OFFSET UNITYSDK_OFFSET(0xBEE5C30)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO__GETANCHORPOSITION_OFFSET UNITYSDK_OFFSET(0xBEE5AD0)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO__GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xBEE5840)
