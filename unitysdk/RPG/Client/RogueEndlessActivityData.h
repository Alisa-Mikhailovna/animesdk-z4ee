...
#define RPG_CLIENT_ROGUEENDLESSACTIVITYDATA_GETROGUEAREAIDS_OFFSET UNITYSDK_OFFSET(0xD38EEC0)
#define RPG_CLIENT_ROGUEENDLESSACTIVITYDATA_HASAVAILABLEAREAREWARD_OFFSET UNITYSDK_OFFSET(0xD38F490)
#define RPG_CLIENT_ROGUEENDLESSACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xD38F2A0)
#define RPG_CLIENT_ROGUEENDLESSACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD38F290)
#define RPG_CLIENT_ROGUEENDLESSACTIVITYDATA__HASNEWAREA_OFFSET UNITYSDK_OFFSET(0xD38F5B0)
#define RPG_CLIENT_ROGUEENDLESSACTIVITYDATA__ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xD38F3A0)
