...
#define RPG_CLIENT_MAP3DUTILS_COMPUTEPLAYERWORLDROTATION_OFFSET UNITYSDK_OFFSET(0xCA6B660)
#define RPG_CLIENT_MAP3DUTILS_GETBYATTACH_OFFSET UNITYSDK_OFFSET(0xCA6C9B0)
#define RPG_CLIENT_MAP3DUTILS_GETMAINCAMERAWORLDROTATION_OFFSET UNITYSDK_OFFSET(0xCA6BCD0)
#define RPG_CLIENT_MAP3DUTILS_GETMAPROTATIONCHARGERMINIMAPICON_OFFSET UNITYSDK_OFFSET(0xCA6C4F0)
#define RPG_CLIENT_MAP3DUTILS_GETMAPROTATIONVOLUMEMINIMAPICON_OFFSET UNITYSDK_OFFSET(0xCA6BEE0)
#define RPG_CLIENT_MAP3DUTILS_GETROTATABLEREGIONCIRCLEOPACITY_OFFSET UNITYSDK_OFFSET(0xCA6A150)
#define RPG_CLIENT_MAP3DUTILS_GETROTATABLEREGIONITEMCIRCLESCALE_OFFSET UNITYSDK_OFFSET(0xCA6ABF0)
#define RPG_CLIENT_MAP3DUTILS_GETROTATABLEREGIONITEMICONOPACITY_OFFSET UNITYSDK_OFFSET(0xCA6A1D0)
#define RPG_CLIENT_MAP3DUTILS_GETROTATABLEREGIONITEMOPACITY_OFFSET UNITYSDK_OFFSET(0xCA693D0)
#define RPG_CLIENT_MAP3DUTILS_GETROTATABLEREGIONITEMWORLDPOSITIONWITHOFFSET_OFFSET UNITYSDK_OFFSET(0xCA6A810)
#define RPG_CLIENT_MAP3DUTILS_GETROTATABLEREGIONITEMWORLDPOSITION_1_OFFSET UNITYSDK_OFFSET(0xCA6A6C0)
#define RPG_CLIENT_MAP3DUTILS_GETROTATABLEREGIONITEMWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xCA6A540)
#define RPG_CLIENT_MAP3DUTILS_GETROTATABLEREGIONITEMWORLDROTATION_OFFSET UNITYSDK_OFFSET(0xCA6A320)
#define RPG_CLIENT_MAP3DUTILS_ISINCURFLOOR3DAREA_OFFSET UNITYSDK_OFFSET(0xCA68FD0)
#define RPG_CLIENT_MAP3DUTILS_SHOULDSHOW3DMAP_OFFSET UNITYSDK_OFFSET(0xCA69280)
#define RPG_CLIENT_MAP3DUTILS_SMOOTHLYSETOPACITY_OFFSET UNITYSDK_OFFSET(0xCA6B100)
#define RPG_CLIENT_MAP3DUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0xCA6CF40)
#define RPG_CLIENT_MAP3DUTILS__GETOBJECTOPACITY_OFFSET UNITYSDK_OFFSET(0xCA6CD30)
#define RPG_CLIENT_MAP3DUTILS__GETPROPID_OFFSET UNITYSDK_OFFSET(0xCA6CB80)
#define RPG_CLIENT_MAP3DUTILS__GETRAWOPACITY_OFFSET UNITYSDK_OFFSET(0xCA695A0)
#define RPG_CLIENT_MAP3DUTILS__SETOBJECTOPACITY_OFFSET UNITYSDK_OFFSET(0xCA6B320)
#define RPG_CLIENT_MAP3DUTILS__SHOULDOPACITYIGNOREPOSE_OFFSET UNITYSDK_OFFSET(0xCA6CC20)
#define RPG_CLIENT_MAP3DUTILS__SMOOTHLYSETOPACITY_OFFSET UNITYSDK_OFFSET(0xCA6B5B0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::MonoMap3DTouch**)Il2CppClass::FromTypeDefinitionIndex(Map3DUtils_TypeDefinitionIndex)->GetStaticField(0x43B90);
		}
		static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_s_RayHits()
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Map3DUtils_TypeDefinitionIndex)->GetStaticField(0x43B98);
		}
		static ::UnityEngine::Transform** StaticGet_s_Map3DTransform()
		{
			return (::UnityEngine::Transform**)Il2CppClass::FromTypeDefinitionIndex(Map3DUtils_TypeDefinitionIndex)->GetStaticField(0x43BA0);
		}
		static ::RPG::Client::UIMap3DContainer** StaticGet_s_Map3DContainer()
		{
			return (::RPG::Client::UIMap3DContainer**)Il2CppClass::FromTypeDefinitionIndex(Map3DUtils_TypeDefinitionIndex)->GetStaticField(0x43BA8);
		}
		static ::UnityEngine::Vector3* StaticGet_s_ScreenPosOffset()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Map3DUtils_TypeDefinitionIndex)->GetStaticField(0xAD10);
		}
		static ::System::Int32* StaticGet_s_Color()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Map3DUtils_TypeDefinitionIndex)->GetStaticField(0xAD1C);
		}
		static ::System::Int32* StaticGet_s_Opacity()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Map3DUtils_TypeDefinitionIndex)->GetStaticField(0xAD20);
		}
