...
#define RPG_CLIENT_CONVERTIBLEITEMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC1B7E40)
#define RPG_CLIENT_CONVERTIBLEITEMDATA_GETCOSTCOUNT_OFFSET UNITYSDK_OFFSET(0xC1B7FB0)
#define RPG_CLIENT_CONVERTIBLEITEMDATA_GETCOSTRARE_OFFSET UNITYSDK_OFFSET(0xC1B7F20)
#define RPG_CLIENT_CONVERTIBLEITEMDATA_GETMAXCONVERTCOUNT_OFFSET UNITYSDK_OFFSET(0xC1B7EB0)
#define RPG_CLIENT_CONVERTIBLEITEMDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xC1B7D00)
#define RPG_CLIENT_CONVERTIBLEITEMDATA_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0xC1B7C60)
#define RPG_CLIENT_CONVERTIBLEITEMDATA_GET_ITEMSUBTYPE_OFFSET UNITYSDK_OFFSET(0xC1B7CB0)
#define RPG_CLIENT_CONVERTIBLEITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC1B7EA0)
