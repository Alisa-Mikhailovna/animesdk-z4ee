...
#define RPG_CLIENT_MATERIALGROUPASSET_RENDERERNAMEMATERIALS__CCTOR_OFFSET UNITYSDK_OFFSET(0xCB87E00)
#define RPG_CLIENT_MATERIALGROUPASSET_RENDERERNAMEMATERIALS__CTOR_OFFSET UNITYSDK_OFFSET(0xCB87D90)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialGroupAsset_RendererNameMaterials_TypeDefinitionIndex)->GetStaticField(0x4DA40);
		}
