...
#define RPG_CLIENT_EFFECT_SCALE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC3442D0)
#define RPG_CLIENT_EFFECT_SCALE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC344360)
#define RPG_CLIENT_EFFECT_SCALE_UPDATE_OFFSET UNITYSDK_OFFSET(0xC344240)
#define RPG_CLIENT_EFFECT_SCALE__CTOR_OFFSET UNITYSDK_OFFSET(0xC344450)
