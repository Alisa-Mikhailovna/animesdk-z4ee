...
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYBANNERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC19DCE0)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYBANNERDATA_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0xC19E270)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYBANNERDATA_GET_BANNERID_OFFSET UNITYSDK_OFFSET(0xC19E200)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYBANNERDATA_GET_MAINMISSIONIDLIST_OFFSET UNITYSDK_OFFSET(0xC19E160)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYBANNERDATA_GET_SORTID_OFFSET UNITYSDK_OFFSET(0xC19E220)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYBANNERDATA_ISMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0xC19DD80)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYBANNERDATA_SET_BANNERID_OFFSET UNITYSDK_OFFSET(0xC19E210)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYBANNERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC19DD70)
