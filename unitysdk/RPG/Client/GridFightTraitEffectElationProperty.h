...
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_ADDMODIFIERSOURCE_OFFSET UNITYSDK_OFFSET(0xC844730)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GETBASEVALUE_OFFSET UNITYSDK_OFFSET(0xC844A90)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0xC8447E0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GET_DETAIL_OFFSET UNITYSDK_OFFSET(0xC844670)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GET_OVERVIEW_OFFSET UNITYSDK_OFFSET(0xC844600)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GET__TRAIT_OFFSET UNITYSDK_OFFSET(0xC8445B0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_SETUPTRAIT_OFFSET UNITYSDK_OFFSET(0xC8446E0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__CCTOR_OFFSET UNITYSDK_OFFSET(0xC844EA0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xC844E20)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__GETABILITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0xC844DA0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__GETBATTLEFINALVALUE_OFFSET UNITYSDK_OFFSET(0xC844C70)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__GETFINALVALUE_OFFSET UNITYSDK_OFFSET(0xC844880)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__GETPROPERTY_OFFSET UNITYSDK_OFFSET(0xC844CD0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Class_2_BEDE94774D30A3D8**)Il2CppClass::FromTypeDefinitionIndex(GridFightTraitEffectElationProperty_TypeDefinitionIndex)->GetStaticField(0x2E140);
		}
