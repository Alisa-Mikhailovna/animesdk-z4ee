...
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEENTRANCECAMERASIDE_OFFSET UNITYSDK_OFFSET(0xBEE6140)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEENTRANCECAMERA_OFFSET UNITYSDK_OFFSET(0xBEE5FF0)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEFREEAREACAMERA_OFFSET UNITYSDK_OFFSET(0xBEE6290)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEINITCAMERA_OFFSET UNITYSDK_OFFSET(0xBEE5EA0)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xBEE5C40)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_GET__CINEMACHINEBRAIN_OFFSET UNITYSDK_OFFSET(0xBEE5CA0)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBEE5D90)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEE63E0)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER__DEACTIVATECAMERAS_OFFSET UNITYSDK_OFFSET(0xBEE5DF0)
