...
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_BUILDMONSTERSPOOLED_OFFSET UNITYSDK_OFFSET(0xC458470)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xC457E00)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET_AFFIXID_OFFSET UNITYSDK_OFFSET(0xC4588A0)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0xC458CC0)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0xC458F40)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET_IDFORSORT_OFFSET UNITYSDK_OFFSET(0xC458920)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET_ISDEACTIVATED_OFFSET UNITYSDK_OFFSET(0xC458FF0)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC458980)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xC458C20)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xC4588E0)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET__MAZEBUFFROW_OFFSET UNITYSDK_OFFSET(0xC458B50)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET__MONSTERSDEBUGGERDISPLAY_OFFSET UNITYSDK_OFFSET(0xC459030)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC458390)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM_SYNC_OFFSET UNITYSDK_OFFSET(0xC4583F0)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC457DA0)
#define RPG_CLIENT_FATEGAMEMASTERAFFIXINFOITEM__GETTEXTPARAMLIST_OFFSET UNITYSDK_OFFSET(0xC4586E0)
