...
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xC306BE0)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR_METHOD_3_1283EC0876EAAACF_OFFSET UNITYSDK_OFFSET(0xC306560)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC3064F0)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xC306C60)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC307040)
