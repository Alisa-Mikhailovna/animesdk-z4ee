...
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC1406F0)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_GETENDLESSUNLOCKCHIMERAID_OFFSET UNITYSDK_OFFSET(0xC140980)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_GETENDLESSWORKROUNDDATA_OFFSET UNITYSDK_OFFSET(0xC140790)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_GET_CURRENTFINISHWORKVALUE_OFFSET UNITYSDK_OFFSET(0xC140B40)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_GET_FINISHWORKCNT_OFFSET UNITYSDK_OFFSET(0xC140B80)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_GET_HIGHESTFINISHWORKVALUE_OFFSET UNITYSDK_OFFSET(0xC140B20)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_GET_WORKROUNDID_OFFSET UNITYSDK_OFFSET(0xC140B60)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xC1403F0)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_SET_CURRENTFINISHWORKVALUE_OFFSET UNITYSDK_OFFSET(0xC140B50)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_SET_FINISHWORKCNT_OFFSET UNITYSDK_OFFSET(0xC140B90)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_SET_HIGHESTFINISHWORKVALUE_OFFSET UNITYSDK_OFFSET(0xC140B30)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_SET_WORKROUNDID_OFFSET UNITYSDK_OFFSET(0xC140B70)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_SYNCCHIMERAFINISHWORKVALUE_OFFSET UNITYSDK_OFFSET(0xC140860)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_SYNCCHIMERAQUITENDLESS_OFFSET UNITYSDK_OFFSET(0xC140930)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER_SYNCCHIMERASTARTENDLESS_OFFSET UNITYSDK_OFFSET(0xC1408D0)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC140BA0)
#define RPG_CLIENT_CHIMERAENDLESSMANAGER__INITENDLESSWORKROUND_OFFSET UNITYSDK_OFFSET(0xC140440)
