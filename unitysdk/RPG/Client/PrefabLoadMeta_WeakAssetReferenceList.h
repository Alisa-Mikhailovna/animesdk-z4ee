...
#define RPG_CLIENT_PREFABLOADMETA_WEAKASSETREFERENCELIST_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD0BD210)
#define RPG_CLIENT_PREFABLOADMETA_WEAKASSETREFERENCELIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xD0BD1C0)
#define RPG_CLIENT_PREFABLOADMETA_WEAKASSETREFERENCELIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xD0BCEE0)
#define RPG_CLIENT_PREFABLOADMETA_WEAKASSETREFERENCELIST_RELEASE_OFFSET UNITYSDK_OFFSET(0xD0BD0A0)
#define RPG_CLIENT_PREFABLOADMETA_WEAKASSETREFERENCELIST_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD0BD2B0)
#define RPG_CLIENT_PREFABLOADMETA_WEAKASSETREFERENCELIST__CTOR_OFFSET UNITYSDK_OFFSET(0xD0BCA90)

namespace RPG::Client
{
	inline static constexpr unsigned int PrefabLoadMeta_WeakAssetReferenceList_TypeDefinitionIndex = 69545;
