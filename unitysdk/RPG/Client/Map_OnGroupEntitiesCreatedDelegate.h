...
#define RPG_CLIENT_MAP_ONGROUPENTITIESCREATEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xCA68E20)
#define RPG_CLIENT_MAP_ONGROUPENTITIESCREATEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xCA68E80)
#define RPG_CLIENT_MAP_ONGROUPENTITIESCREATEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xCA662A0)
#define RPG_CLIENT_MAP_ONGROUPENTITIESCREATEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCA68D30)
