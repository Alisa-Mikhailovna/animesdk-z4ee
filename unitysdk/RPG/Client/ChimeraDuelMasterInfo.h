...
#define RPG_CLIENT_CHIMERADUELMASTERINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC130030)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GETDATA_OFFSET UNITYSDK_OFFSET(0xC12C670)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GETORDEREDMASTER_OFFSET UNITYSDK_OFFSET(0xC134050)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GET_DATADICT_OFFSET UNITYSDK_OFFSET(0xC134010)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GET_ISSKIPCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0xC134980)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GET_MASTERMONEY_OFFSET UNITYSDK_OFFSET(0xC134940)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SET_ISSKIPCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0xC134990)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SET_MASTERMONEY_OFFSET UNITYSDK_OFFSET(0xC134310)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SYNCMASTERMONEY_OFFSET UNITYSDK_OFFSET(0xC1342C0)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SYNCMASTERPURCHASED_1_OFFSET UNITYSDK_OFFSET(0xC134860)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SYNCMASTERPURCHASED_OFFSET UNITYSDK_OFFSET(0xC1343C0)
#define RPG_CLIENT_CHIMERADUELMASTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC12EC60)
