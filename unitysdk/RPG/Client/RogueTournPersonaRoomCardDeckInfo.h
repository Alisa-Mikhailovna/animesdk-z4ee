...
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD462890)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_GETCARD_OFFSET UNITYSDK_OFFSET(0xD4751D0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_GETDISCARDPILECARDS_OFFSET UNITYSDK_OFFSET(0xD476D10)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_GETDRAWPILECARDS_OFFSET UNITYSDK_OFFSET(0xD476B50)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_GET_ATTRIBUTEMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xD476E50)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_GET_CARDS_OFFSET UNITYSDK_OFFSET(0xD476D70)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_GET_MAXCARDCOUNT_OFFSET UNITYSDK_OFFSET(0xD476E90)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_GET_MINCARDCOUNT_OFFSET UNITYSDK_OFFSET(0xD476E70)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SET_ATTRIBUTEMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xD476E60)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SET_MAXCARDCOUNT_OFFSET UNITYSDK_OFFSET(0xD476EA0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SET_MINCARDCOUNT_OFFSET UNITYSDK_OFFSET(0xD476E80)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SYNCADDCARD_OFFSET UNITYSDK_OFFSET(0xD476790)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SYNCATTRIBUTEMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xD476A70)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SYNCBELONGPILE_OFFSET UNITYSDK_OFFSET(0xD45EC20)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SYNCFULL_OFFSET UNITYSDK_OFFSET(0xD463A90)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SYNCREMOVECARD_OFFSET UNITYSDK_OFFSET(0xD4768F0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SYNCROOMCARDLIMITCOUNT_OFFSET UNITYSDK_OFFSET(0xD476AE0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO_SYNCUPDATECARD_OFFSET UNITYSDK_OFFSET(0xD4769C0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD462250)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO__GETCARDSBYPILE_OFFSET UNITYSDK_OFFSET(0xD476BA0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO__SYNCATTRIBUTEMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xD4766E0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO__SYNCBELONGPILE_OFFSET UNITYSDK_OFFSET(0xD476180)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDDECKINFO__SYNCROOMCARDLIMITCOUNT_OFFSET UNITYSDK_OFFSET(0xD476730)
