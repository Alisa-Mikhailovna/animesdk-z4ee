...
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC7F0AB0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_GOODTYPE_OFFSET UNITYSDK_OFFSET(0xC7F10E0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_ID_OFFSET UNITYSDK_OFFSET(0xC7F0880)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0xC7F09F0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_OWNED_OFFSET UNITYSDK_OFFSET(0xC7F0D00)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_PRESETTYPE_OFFSET UNITYSDK_OFFSET(0xC7F0FB0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_PROJECTION_OFFSET UNITYSDK_OFFSET(0xC7F08D0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xC7F0960)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_ROLECONFIG_OFFSET UNITYSDK_OFFSET(0xC7F08E0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_SHOPICON_OFFSET UNITYSDK_OFFSET(0xC7F0ED0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_TRAITS_OFFSET UNITYSDK_OFFSET(0xC7F0B10)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC7F0650)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_D17272E82AE804C2_422* _ProtoGoodsProjection; // 0x28
