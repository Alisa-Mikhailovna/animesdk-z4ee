...
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xC1DEF50)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0xC1DF6F0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xC1DECE0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC1DEA70)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xC1DEC70)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC1DEA10)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_7B114B11B5D7CDE9_OFFSET UNITYSDK_OFFSET(0xC1DF140)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_7C4654B8D22255C9_OFFSET UNITYSDK_OFFSET(0xC1DEF90)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC1DE980)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_D9BF9B27FAC3AAD2_OFFSET UNITYSDK_OFFSET(0xC1DEAE0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_F5A5858ACB836225_OFFSET UNITYSDK_OFFSET(0xC1DED80)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xC1DED20)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DF810)
