...
#define RPG_CLIENT_CAKECATCHCATGODDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBEEDB40)
#define RPG_CLIENT_CAKECATCHCATGODDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBEEDCA0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBEEDD00)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_CATNAME_OFFSET UNITYSDK_OFFSET(0xBEEDD20)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_INTERACTCOUNT_OFFSET UNITYSDK_OFFSET(0xBEEDCE0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBEEDD10)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_CATNAME_OFFSET UNITYSDK_OFFSET(0xBEEDD30)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_INTERACTCOUNT_OFFSET UNITYSDK_OFFSET(0xBEEDCF0)
#define RPG_CLIENT_CAKECATCHCATGODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBEEDC90)
