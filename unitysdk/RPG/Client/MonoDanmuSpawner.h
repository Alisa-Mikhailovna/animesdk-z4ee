...
#define RPG_CLIENT_MONODANMUSPAWNER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC4C1F0)
#define RPG_CLIENT_MONODANMUSPAWNER_DESPAWN_OFFSET UNITYSDK_OFFSET(0xCC49D10)
#define RPG_CLIENT_MONODANMUSPAWNER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCC4C330)
#define RPG_CLIENT_MONODANMUSPAWNER_GET_GIFTROOTRECT_OFFSET UNITYSDK_OFFSET(0xCC4B670)
#define RPG_CLIENT_MONODANMUSPAWNER_GET_IMAGEROOTRECT_OFFSET UNITYSDK_OFFSET(0xCC4B600)
#define RPG_CLIENT_MONODANMUSPAWNER_GET_TEXTROOTRECT_OFFSET UNITYSDK_OFFSET(0xCC4B590)
#define RPG_CLIENT_MONODANMUSPAWNER_METHOD_5_2CEAC11AEBDD3C75_OFFSET UNITYSDK_OFFSET(0xCC4C390)
#define RPG_CLIENT_MONODANMUSPAWNER_METHOD_5_422422BBCBC8068C_OFFSET UNITYSDK_OFFSET(0xCC4C2C0)
#define RPG_CLIENT_MONODANMUSPAWNER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCC4C240)
#define RPG_CLIENT_MONODANMUSPAWNER_METHOD_5_702463A421B5F338_OFFSET UNITYSDK_OFFSET(0xCC4C460)
#define RPG_CLIENT_MONODANMUSPAWNER_SPAWN_OFFSET UNITYSDK_OFFSET(0xCC4A300)
#define RPG_CLIENT_MONODANMUSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC4C510)
