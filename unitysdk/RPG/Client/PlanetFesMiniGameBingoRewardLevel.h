...
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_CREATE_OFFSET UNITYSDK_OFFSET(0xD017DB0)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_GET_END_OFFSET UNITYSDK_OFFSET(0xD017F20)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_GET_LEVELDESC_OFFSET UNITYSDK_OFFSET(0xD017F40)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_GET_START_OFFSET UNITYSDK_OFFSET(0xD017F00)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_SET_END_OFFSET UNITYSDK_OFFSET(0xD017F30)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_SET_LEVELDESC_OFFSET UNITYSDK_OFFSET(0xD017F50)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_SET_START_OFFSET UNITYSDK_OFFSET(0xD017F10)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD017EF0)
