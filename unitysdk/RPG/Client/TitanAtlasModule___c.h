...
#define RPG_CLIENT_TITANATLASMODULE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xD6DAFD0)
#define RPG_CLIENT_TITANATLASMODULE___C__CTOR_OFFSET UNITYSDK_OFFSET(0xD6DB010)
#define RPG_CLIENT_TITANATLASMODULE___C__GETALLGROUPS_B__2_0_OFFSET UNITYSDK_OFFSET(0xD6DB020)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::TitanAtlasGroup*>**)Il2CppClass::FromTypeDefinitionIndex(TitanAtlasModule___c_TypeDefinitionIndex)->GetStaticField(0x44D50);
		}
		static ::RPG::Client::TitanAtlasModule___c** StaticGet___9()
		{
			return (::RPG::Client::TitanAtlasModule___c**)Il2CppClass::FromTypeDefinitionIndex(TitanAtlasModule___c_TypeDefinitionIndex)->GetStaticField(0x44D58);
		}
