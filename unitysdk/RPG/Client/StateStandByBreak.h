...
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_CE3CD1D1492D0382_OFFSET UNITYSDK_OFFSET(0xD561670)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_E60607EEEA67A558_OFFSET UNITYSDK_OFFSET(0xD561AA0)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_EEFE3CA8386BEC1A_OFFSET UNITYSDK_OFFSET(0xD5619C0)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_F5030600344F3898_OFFSET UNITYSDK_OFFSET(0xD561800)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xD5612F0)
#define RPG_CLIENT_STATESTANDBYBREAK_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xD561190)
#define RPG_CLIENT_STATESTANDBYBREAK_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xD561BE0)
#define RPG_CLIENT_STATESTANDBYBREAK_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD561360)
#define RPG_CLIENT_STATESTANDBYBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0xD561CA0)
