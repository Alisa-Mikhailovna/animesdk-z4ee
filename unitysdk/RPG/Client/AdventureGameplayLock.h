...
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_1251ABBEE9F4DFE8_OFFSET UNITYSDK_OFFSET(0x1B0DD600)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_6704C83E8C4AC8B9_OFFSET UNITYSDK_OFFSET(0x1B0DD4A0)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DD5F0)
