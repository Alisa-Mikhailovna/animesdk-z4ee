...
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC1D3710)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_METHOD_5_3905F8092E1B5E52_OFFSET UNITYSDK_OFFSET(0xC1D4620)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_METHOD_5_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0xC1D4540)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_METHOD_5_ECA33935490AF2E4_OFFSET UNITYSDK_OFFSET(0xC1D3760)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0xC1D46F0)
