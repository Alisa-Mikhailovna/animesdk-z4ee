...
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD38E70)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_SETBASECANVASORDER_OFFSET UNITYSDK_OFFSET(0xCD38E00)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_SETBASECANVAS_OFFSET UNITYSDK_OFFSET(0xCD38B50)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_SETORDER_OFFSET UNITYSDK_OFFSET(0xCD38BA0)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_START_OFFSET UNITYSDK_OFFSET(0xCD39020)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD39180)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__CHECKBASECANVASORDERCHANGED_OFFSET UNITYSDK_OFFSET(0xCD39220)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD39280)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__FINDPARENTCANVAS_OFFSET UNITYSDK_OFFSET(0xCD38F10)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__START_B__8_0_OFFSET UNITYSDK_OFFSET(0xCD39290)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUILayerOrderAdjuster_TypeDefinitionIndex = 69727;
