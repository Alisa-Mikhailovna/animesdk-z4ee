...
#define RPG_CLIENT_INTRODUCE_INTRODUCEVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC8E26F0)
#define RPG_CLIENT_INTRODUCE_INTRODUCEVIEWMODEL_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xC8E2680)
#define RPG_CLIENT_INTRODUCE_INTRODUCEVIEWMODEL_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xC8E25D0)
#define RPG_CLIENT_INTRODUCE_INTRODUCEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC8E2770)

namespace RPG::Client::Introduce
{
	inline static constexpr unsigned int IntroduceViewModel_TypeDefinitionIndex = 75548;
