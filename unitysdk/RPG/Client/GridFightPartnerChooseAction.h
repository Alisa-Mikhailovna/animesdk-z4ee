...
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION_GET_ROLEOPTIONS_OFFSET UNITYSDK_OFFSET(0xC7A4AD0)
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION_SELECTMEMBER_OFFSET UNITYSDK_OFFSET(0xC7A4A10)
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION_SET_ROLEOPTIONS_OFFSET UNITYSDK_OFFSET(0xC7A4AE0)
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION_SYNC_OFFSET UNITYSDK_OFFSET(0xC7A4820)
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC7A4810)
