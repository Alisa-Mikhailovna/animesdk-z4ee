...
#define RPG_CLIENT_CONECOLLIDER_METHOD_6_0452194CF7C240C7_OFFSET UNITYSDK_OFFSET(0xC1ADAC0)
#define RPG_CLIENT_CONECOLLIDER_METHOD_6_DA008CFDB996753E_OFFSET UNITYSDK_OFFSET(0xC1AE490)
#define RPG_CLIENT_CONECOLLIDER_RECREATE_OFFSET UNITYSDK_OFFSET(0xC1AD840)
#define RPG_CLIENT_CONECOLLIDER_SUBMITBYANGLE_OFFSET UNITYSDK_OFFSET(0xC1AD7B0)
#define RPG_CLIENT_CONECOLLIDER_SUBMITBYRADIUS_OFFSET UNITYSDK_OFFSET(0xC1ADA20)
#define RPG_CLIENT_CONECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1AF220)
