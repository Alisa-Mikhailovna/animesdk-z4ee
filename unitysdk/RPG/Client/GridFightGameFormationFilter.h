...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_APPLY_1_OFFSET UNITYSDK_OFFSET(0xC72F980)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_APPLY_2_OFFSET UNITYSDK_OFFSET(0xC72F9E0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_APPLY_OFFSET UNITYSDK_OFFSET(0xC72EEF0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_CREATECOMPARER_OFFSET UNITYSDK_OFFSET(0xC72F850)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_FILTERROLE_OFFSET UNITYSDK_OFFSET(0xC72FB40)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_FILTERTRAIT_OFFSET UNITYSDK_OFFSET(0xC72FFC0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GETCURSEASONALLROLES_OFFSET UNITYSDK_OFFSET(0xC7309A0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GETCURSEASONALLTRAITS_OFFSET UNITYSDK_OFFSET(0xC730CB0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GETFILTERTRAITCOUNTBYTYPE_OFFSET UNITYSDK_OFFSET(0xC7301B0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_FILTEREDCOUNT_OFFSET UNITYSDK_OFFSET(0xC730410)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_FILTEREDROLES_OFFSET UNITYSDK_OFFSET(0xC7305F0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_FILTEREDTRAITS_OFFSET UNITYSDK_OFFSET(0xC730460)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_ISFILTERON_OFFSET UNITYSDK_OFFSET(0xC7302A0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_ROLEFILTEREDCOUNT_OFFSET UNITYSDK_OFFSET(0xC730370)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_ROLEFILTERLIMIT_OFFSET UNITYSDK_OFFSET(0xC730780)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_TRAITFILTEREDCOUNT_OFFSET UNITYSDK_OFFSET(0xC7303C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_TRAITFILTERLIMIT_OFFSET UNITYSDK_OFFSET(0xC730890)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_INIT_OFFSET UNITYSDK_OFFSET(0xC72FA30)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_ISFILTEREDROLE_OFFSET UNITYSDK_OFFSET(0xC72FF00)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_ISFILTEREDTRAIT_OFFSET UNITYSDK_OFFSET(0xC7300F0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_REMOVEROLE_OFFSET UNITYSDK_OFFSET(0xC72FD50)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_REMOVETRAIT_OFFSET UNITYSDK_OFFSET(0xC730070)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_RESET_OFFSET UNITYSDK_OFFSET(0xC72FA90)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__CREATEROLE_OFFSET UNITYSDK_OFFSET(0xC730C40)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC731000)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__FORMATIONHASAVATAR_OFFSET UNITYSDK_OFFSET(0xC72F570)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__FORMATIONHASTRAIT_OFFSET UNITYSDK_OFFSET(0xC72F700)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__GETCURSEASONALLROLES_B__38_0_OFFSET UNITYSDK_OFFSET(0xC731120)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::GridFightRole*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormationFilter_TypeDefinitionIndex)->GetStaticField(0x26D40);
		}
		static ::System::Collections::Generic::List_1<::RPG::Client::GridFightTraitConfig*>** StaticGet__CurSeasonTraitConfigs()
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::GridFightTraitConfig*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormationFilter_TypeDefinitionIndex)->GetStaticField(0x26D48);
		}
		::System::Collections::Generic::List_1<::System::UInt32>* _FilteredTraitIDs; // 0x10
