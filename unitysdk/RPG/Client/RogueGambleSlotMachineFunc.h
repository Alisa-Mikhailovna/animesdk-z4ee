...
#define RPG_CLIENT_ROGUEGAMBLESLOTMACHINEFUNC_CREATE_OFFSET UNITYSDK_OFFSET(0xD3A0F70)
#define RPG_CLIENT_ROGUEGAMBLESLOTMACHINEFUNC_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0xD3A1010)
#define RPG_CLIENT_ROGUEGAMBLESLOTMACHINEFUNC_RELEASESPRITE_OFFSET UNITYSDK_OFFSET(0xD3A1460)
#define RPG_CLIENT_ROGUEGAMBLESLOTMACHINEFUNC_SETUPPROPTEXTURE_OFFSET UNITYSDK_OFFSET(0xD3A1170)
#define RPG_CLIENT_ROGUEGAMBLESLOTMACHINEFUNC_TRIGGERPROPROLL_OFFSET UNITYSDK_OFFSET(0xD3A1510)
#define RPG_CLIENT_ROGUEGAMBLESLOTMACHINEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0xD3A1000)
#define RPG_CLIENT_ROGUEGAMBLESLOTMACHINEFUNC__SETMACHINETYPE_OFFSET UNITYSDK_OFFSET(0xD3A1B20)
#define RPG_CLIENT_ROGUEGAMBLESLOTMACHINEFUNC__SETSLOTMACHINEREWARDANDROLL_OFFSET UNITYSDK_OFFSET(0xD3A1720)
