...
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE_CHECKSHOOTINGLEVELISLOCKBYPRELEVEL_OFFSET UNITYSDK_OFFSET(0xD8C1160)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD8C0900)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE_GETWOLFBROSHOOTINGBESTSCORE_OFFSET UNITYSDK_OFFSET(0xD8C1030)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE_GET_ISCANRESTARTGAME_OFFSET UNITYSDK_OFFSET(0xD8C12E0)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xD8C07B0)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE_SET_ISCANRESTARTGAME_OFFSET UNITYSDK_OFFSET(0xD8C1290)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE_TRYGETWOLFBROSHOOTINGBESTSCORE_OFFSET UNITYSDK_OFFSET(0xD8B11F0)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0xD8C09A0)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xD8C1320)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE__ONCMDGETGUNPLAYDATASCRSP_OFFSET UNITYSDK_OFFSET(0xD8C0B30)
#define RPG_CLIENT_WOLFBROSHOOTINGMODULE__ONCMDUPDATEGUNPLAYDATASCRSP_OFFSET UNITYSDK_OFFSET(0xD8C0F70)
