...
#define RPG_CLIENT_ONBACKPRESSEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xCEE88F0)
#define RPG_CLIENT_ONBACKPRESSEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xCEE8920)
#define RPG_CLIENT_ONBACKPRESSEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xCEE88E0)
#define RPG_CLIENT_ONBACKPRESSEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xCEE8870)

namespace RPG::Client
{
	inline static constexpr unsigned int OnBackPressedCallback_TypeDefinitionIndex = 68129;
