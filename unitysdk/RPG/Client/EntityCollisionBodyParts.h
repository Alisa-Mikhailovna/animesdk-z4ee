...
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_COMPAREBYPRIORITY_OFFSET UNITYSDK_OFFSET(0xC3CF960)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_FINDBODYPARTANCHORHITPOSITION_OFFSET UNITYSDK_OFFSET(0xC3CFF90)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_FINDBODYPARTANCHORMODEL_OFFSET UNITYSDK_OFFSET(0xC3CFE30)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_FINDBODYPARTINDEX_OFFSET UNITYSDK_OFFSET(0xC3D0110)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_METHOD_5_5F32FD20E92D0466_OFFSET UNITYSDK_OFFSET(0xC3D04B0)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_SETUPPARTSMAPPING_OFFSET UNITYSDK_OFFSET(0xC3CFBE0)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_TRIGGERBODYPARTHITANIMSTATE_OFFSET UNITYSDK_OFFSET(0xC3D0260)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_UPDATE_OFFSET UNITYSDK_OFFSET(0xC3D0940)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS__CTOR_OFFSET UNITYSDK_OFFSET(0xC3D0A40)
