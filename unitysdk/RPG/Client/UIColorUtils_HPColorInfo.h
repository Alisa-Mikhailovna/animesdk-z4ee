...
#define RPG_CLIENT_UICOLORUTILS_HPCOLORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD7A4B40)

namespace RPG::Client
{
	inline static constexpr unsigned int UIColorUtils_HPColorInfo_TypeDefinitionIndex = 69817;
