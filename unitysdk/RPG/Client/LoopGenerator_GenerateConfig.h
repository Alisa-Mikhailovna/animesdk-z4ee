...
#define RPG_CLIENT_LOOPGENERATOR_GENERATECONFIG_METHOD_2_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0x14BAB0)
#define RPG_CLIENT_LOOPGENERATOR_GENERATECONFIG_METHOD_2_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x14BAA0)
#define RPG_CLIENT_LOOPGENERATOR_GENERATECONFIG_METHOD_2_C1D3BDE2A17F5C9D_OFFSET UNITYSDK_OFFSET(0x14BA90)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerator_GenerateConfig_TypeDefinitionIndex = 69654;
