...
#define RPG_CLIENT_AVATARGROWPLANRESULT_GET_CANNOTDIRECTGROW_OFFSET UNITYSDK_OFFSET(0xBDF9070)
#define RPG_CLIENT_AVATARGROWPLANRESULT_GET_FARMABLEITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xBDF90B0)
#define RPG_CLIENT_AVATARGROWPLANRESULT_GET_FARMABLEITEMID_OFFSET UNITYSDK_OFFSET(0xBDF9090)
#define RPG_CLIENT_AVATARGROWPLANRESULT_GET_HASACTUALPROGRESS_OFFSET UNITYSDK_OFFSET(0xBDF9050)
#define RPG_CLIENT_AVATARGROWPLANRESULT_GET_LEVELAFTERQUICKGROW_OFFSET UNITYSDK_OFFSET(0xBDF8FB0)
#define RPG_CLIENT_AVATARGROWPLANRESULT_GET_LEVELUPCOSTSFORREQ_OFFSET UNITYSDK_OFFSET(0xBDF9010)
#define RPG_CLIENT_AVATARGROWPLANRESULT_GET_MATERIALSWILLCOST_OFFSET UNITYSDK_OFFSET(0xBDF8FF0)
#define RPG_CLIENT_AVATARGROWPLANRESULT_GET_PROMOTIONCOSTFORREQ_OFFSET UNITYSDK_OFFSET(0xBDF9030)
#define RPG_CLIENT_AVATARGROWPLANRESULT_GET_PROMOTIONLEVELAFTERQUICKGROW_OFFSET UNITYSDK_OFFSET(0xBDF8FD0)
#define RPG_CLIENT_AVATARGROWPLANRESULT_SET_CANNOTDIRECTGROW_OFFSET UNITYSDK_OFFSET(0xBDF9080)
#define RPG_CLIENT_AVATARGROWPLANRESULT_SET_FARMABLEITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xBDF90C0)
#define RPG_CLIENT_AVATARGROWPLANRESULT_SET_FARMABLEITEMID_OFFSET UNITYSDK_OFFSET(0xBDF90A0)
#define RPG_CLIENT_AVATARGROWPLANRESULT_SET_HASACTUALPROGRESS_OFFSET UNITYSDK_OFFSET(0xBDF9060)
#define RPG_CLIENT_AVATARGROWPLANRESULT_SET_LEVELAFTERQUICKGROW_OFFSET UNITYSDK_OFFSET(0xBDF8FC0)
#define RPG_CLIENT_AVATARGROWPLANRESULT_SET_LEVELUPCOSTSFORREQ_OFFSET UNITYSDK_OFFSET(0xBDF9020)
#define RPG_CLIENT_AVATARGROWPLANRESULT_SET_MATERIALSWILLCOST_OFFSET UNITYSDK_OFFSET(0xBDF9000)
#define RPG_CLIENT_AVATARGROWPLANRESULT_SET_PROMOTIONCOSTFORREQ_OFFSET UNITYSDK_OFFSET(0xBDF9040)
#define RPG_CLIENT_AVATARGROWPLANRESULT_SET_PROMOTIONLEVELAFTERQUICKGROW_OFFSET UNITYSDK_OFFSET(0xBDF8FE0)
#define RPG_CLIENT_AVATARGROWPLANRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xBDF90D0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _HasActualProgress_k__BackingField; // 0x28
		::System::Boolean _CannotDirectGrow_k__BackingField; // 0x29
		::System::UInt32 _FarmableItemID_k__BackingField; // 0x2C
		::System::UInt32 _LevelAfterQuickGrow_k__BackingField; // 0x30
		::System::UInt32 _FarmableItemCount_k__BackingField; // 0x34
