...
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD467110)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD467AB0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0xD467C60)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_ATTRIBUTELIST_OFFSET UNITYSDK_OFFSET(0xD467720)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0xD467700)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_COMPOSITIONTYPE_OFFSET UNITYSDK_OFFSET(0xD4676C0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD467900)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xD4676E0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD4678A0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_ROOMID_OFFSET UNITYSDK_OFFSET(0xD467660)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_ROOMINDEX_OFFSET UNITYSDK_OFFSET(0xD467680)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_ROOMTYPE_OFFSET UNITYSDK_OFFSET(0xD467850)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xD4676A0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_GET_TOASTICONPATH_OFFSET UNITYSDK_OFFSET(0xD467950)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_SET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0xD467710)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_SET_COMPOSITIONTYPE_OFFSET UNITYSDK_OFFSET(0xD4676D0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xD4676F0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_SET_ROOMID_OFFSET UNITYSDK_OFFSET(0xD467670)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_SET_ROOMINDEX_OFFSET UNITYSDK_OFFSET(0xD467690)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_SET_STATUS_OFFSET UNITYSDK_OFFSET(0xD4676B0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xD467AF0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD4679A0)
#define RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA__INIT_OFFSET UNITYSDK_OFFSET(0xD4679B0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_C9DFE5EE7107C629_15*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUETOURNPERSONAGAMELEVELPRESETROOMDATA_SYNC_OFFSET))(this, a1);
		}
