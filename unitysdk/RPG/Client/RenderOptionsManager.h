...
#define RPG_CLIENT_RENDEROPTIONSMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD30E4C0)
#define RPG_CLIENT_RENDEROPTIONSMANAGER_LENSFLAREPOPFLAG_OFFSET UNITYSDK_OFFSET(0xD30E430)
#define RPG_CLIENT_RENDEROPTIONSMANAGER_LENSFLAREPUSHFLAG_OFFSET UNITYSDK_OFFSET(0xD30E370)
#define RPG_CLIENT_RENDEROPTIONSMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD30E150)
