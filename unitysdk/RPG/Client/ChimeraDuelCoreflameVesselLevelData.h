...
#define RPG_CLIENT_CHIMERADUELCOREFLAMEVESSELLEVELDATA_GET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0xC11AE60)
#define RPG_CLIENT_CHIMERADUELCOREFLAMEVESSELLEVELDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xC11AEB0)
#define RPG_CLIENT_CHIMERADUELCOREFLAMEVESSELLEVELDATA_GET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0xC11AF00)
#define RPG_CLIENT_CHIMERADUELCOREFLAMEVESSELLEVELDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC11AE50)
#define RPG_CLIENT_CHIMERADUELCOREFLAMEVESSELLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC11A6A0)
