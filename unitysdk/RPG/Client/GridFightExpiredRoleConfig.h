...
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xC703E60)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_FRONTBACKTYPE_OFFSET UNITYSDK_OFFSET(0xC703E10)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xC7041C0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0xC703D70)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ISEXPERT_OFFSET UNITYSDK_OFFSET(0xC703EB0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_MINIROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xC7043B0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0xC704790)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xC703DC0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xC7045A0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_SHOPICONPATH_OFFSET UNITYSDK_OFFSET(0xC703F40)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_TRAITIDS_OFFSET UNITYSDK_OFFSET(0xC703EF0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC703D20)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xC704210)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDNAMETEXTID_OFFSET UNITYSDK_OFFSET(0xC704830)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDSHOPICONPATH_OFFSET UNITYSDK_OFFSET(0xC703F90)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETMINIROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xC704400)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xC7045F0)
