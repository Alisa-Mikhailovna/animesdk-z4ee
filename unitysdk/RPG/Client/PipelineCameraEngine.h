...
#define RPG_CLIENT_PIPELINECAMERAENGINE_ABORTCLOSEUPSHOTTIMELINE_OFFSET UNITYSDK_OFFSET(0xCFA4260)
#define RPG_CLIENT_PIPELINECAMERAENGINE_CLEARCLOSEUPSHOT_OFFSET UNITYSDK_OFFSET(0xCFA2300)
#define RPG_CLIENT_PIPELINECAMERAENGINE_CLEARORTHOGRAPHICLOCK_OFFSET UNITYSDK_OFFSET(0xCFA1E20)
#define RPG_CLIENT_PIPELINECAMERAENGINE_DISPOSEOVERRIDECONFIGS_OFFSET UNITYSDK_OFFSET(0xCFA3FA0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_DISPOSEPIPELINELOOKDEV_OFFSET UNITYSDK_OFFSET(0xCF9F150)
#define RPG_CLIENT_PIPELINECAMERAENGINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCFA1E80)
#define RPG_CLIENT_PIPELINECAMERAENGINE_FORCEREFRESHPIPELINEMODULE_OFFSET UNITYSDK_OFFSET(0xCFA3280)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETCAMERADATA_OFFSET UNITYSDK_OFFSET(0xCF94A40)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETCAMERAMODULEFIGHTMODULE_OFFSET UNITYSDK_OFFSET(0xCFA15D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETFREELOOK3RDMODULECHANGEBLEND_OFFSET UNITYSDK_OFFSET(0xCFA1D60)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETINHERITMONODELEGATEACTIONS_OFFSET UNITYSDK_OFFSET(0xCFA4000)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETREALMODULECONFIGBYTYPE_OFFSET UNITYSDK_OFFSET(0xCFA1410)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETVCAMCONTROLMODULE_OFFSET UNITYSDK_OFFSET(0xCFA2580)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ADVENTURECAMERALOOKATTEMPLATE_OFFSET UNITYSDK_OFFSET(0xCFA4E30)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_CINEMACHINEBRAINREF_OFFSET UNITYSDK_OFFSET(0xCFA4EF0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_CRPVIRTUALCAMERATEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0xCFA4E90)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_CURRENTCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xCFA4F60)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_GLOBALCONFIG_OFFSET UNITYSDK_OFFSET(0xCFA4ED0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_INITFOV_OFFSET UNITYSDK_OFFSET(0xCFA4D60)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0xCFA4F00)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ISFIRSTREFRESHPIPELINEAFTERINIT_OFFSET UNITYSDK_OFFSET(0xCFA4F10)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ISFREELOOK3RDLIVE_OFFSET UNITYSDK_OFFSET(0xCFA4F90)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ISLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCFA5010)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0xCFA2F70)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_LOADEDMODULECONFIGPATH_OFFSET UNITYSDK_OFFSET(0xCFA5020)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_MODULECONFIG_OFFSET UNITYSDK_OFFSET(0xCFA4EE0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_SHAKESOURCEMGR_OFFSET UNITYSDK_OFFSET(0xCFA4EB0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_SKIPONEFRAME_OFFSET UNITYSDK_OFFSET(0xCFA4D20)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_TEMPLATECONFIG_OFFSET UNITYSDK_OFFSET(0xCFA4DF0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_UPDATECOUNT_OFFSET UNITYSDK_OFFSET(0xCFA4F30)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_USECINEMACHINEZOOM_OFFSET UNITYSDK_OFFSET(0xCFA4F40)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_VCAMERAFREELOOK3RDCONFIGCHANGETEMPLATE_OFFSET UNITYSDK_OFFSET(0xCFA4E10)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_VCAMERAFREELOOK3RDTEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0xCFA4E70)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_VCAMERATEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0xCFA4E50)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_VCAMINSTANCEPOOL_OFFSET UNITYSDK_OFFSET(0xCFA4D40)
#define RPG_CLIENT_PIPELINECAMERAENGINE_HASOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xCFA13A0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_INITPIPELINELOOKDEV_OFFSET UNITYSDK_OFFSET(0xCF9F2E0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_INITPIPELINE_OFFSET UNITYSDK_OFFSET(0xCF9FA70)
#define RPG_CLIENT_PIPELINECAMERAENGINE_MANUALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCFA3C70)
#define RPG_CLIENT_PIPELINECAMERAENGINE_ONLOGICUPDATE_OFFSET UNITYSDK_OFFSET(0xCFA0DB0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_OVERRIDEMODULECONFIG_OFFSET UNITYSDK_OFFSET(0xCFA14A0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_PAUSECAMERAUPDATE_OFFSET UNITYSDK_OFFSET(0xCFA3CE0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REFRESHALL_OFFSET UNITYSDK_OFFSET(0xCFA0D10)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REFRESHHIDEENTITYMODULE_OFFSET UNITYSDK_OFFSET(0xCFA2DF0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REFRESHPIPELINELOOKDEV_OFFSET UNITYSDK_OFFSET(0xCF9F8F0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REFRESHPIPELINEMODULE_OFFSET UNITYSDK_OFFSET(0xCFA2ED0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REGISTERMONODELEGATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCFA3D40)
#define RPG_CLIENT_PIPELINECAMERAENGINE_RELEASEMONODELEGATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCFA3DB0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_RELOADMODULECONFIG_OFFSET UNITYSDK_OFFSET(0xCFA3E20)
#define RPG_CLIENT_PIPELINECAMERAENGINE_RESETFREELOOK3RDMODULE_OFFSET UNITYSDK_OFFSET(0xCFA2630)
#define RPG_CLIENT_PIPELINECAMERAENGINE_RESETOVERRIDEMODULECONFIG_OFFSET UNITYSDK_OFFSET(0xCFA1570)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCINEMACHINEBRAINBLENDFINISH_OFFSET UNITYSDK_OFFSET(0xCFA1C60)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCINEMACHINEBRAINBLENDTYPEBYCURVE_OFFSET UNITYSDK_OFFSET(0xCFA1960)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCINEMACHINEBRAINBLENDTYPE_1_OFFSET UNITYSDK_OFFSET(0xCFA19F0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCINEMACHINEBRAINBLENDTYPE_OFFSET UNITYSDK_OFFSET(0xCFA17C0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCONTROLLERAXISVALUEBYTARGETROTATION_OFFSET UNITYSDK_OFFSET(0xCFA29D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETFREELOOKLOOKAT_OFFSET UNITYSDK_OFFSET(0xCFA2C70)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETINHERITMONODELEGATEACTIONS_OFFSET UNITYSDK_OFFSET(0xCFA40B0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETPIPELINE_OFFSET UNITYSDK_OFFSET(0xCF9FA20)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_ADVENTURECAMERALOOKATTEMPLATE_OFFSET UNITYSDK_OFFSET(0xCFA4E40)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_CRPVIRTUALCAMERATEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0xCFA4EA0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_ISFIRSTREFRESHPIPELINEAFTERINIT_OFFSET UNITYSDK_OFFSET(0xCFA4F20)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_SHAKESOURCEMGR_OFFSET UNITYSDK_OFFSET(0xCFA4EC0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_SKIPONEFRAME_OFFSET UNITYSDK_OFFSET(0xCFA4D30)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_TEMPLATECONFIG_OFFSET UNITYSDK_OFFSET(0xCFA4E00)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_USECINEMACHINEZOOM_OFFSET UNITYSDK_OFFSET(0xCFA4F50)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_VCAMERAFREELOOK3RDCONFIGCHANGETEMPLATE_OFFSET UNITYSDK_OFFSET(0xCFA4E20)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_VCAMERAFREELOOK3RDTEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0xCFA4E80)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_VCAMERATEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0xCFA4E60)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_VCAMINSTANCEPOOL_OFFSET UNITYSDK_OFFSET(0xCFA4D50)
#define RPG_CLIENT_PIPELINECAMERAENGINE_TRYLOADALLCONFIG_OFFSET UNITYSDK_OFFSET(0xCF9EA20)
#define RPG_CLIENT_PIPELINECAMERAENGINE_TRYRESETCAMERAAXISIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xCFA2B70)
#define RPG_CLIENT_PIPELINECAMERAENGINE_UNLOADALLCONFIG_OFFSET UNITYSDK_OFFSET(0xCF9ED70)
#define RPG_CLIENT_PIPELINECAMERAENGINE__BACKUPINPUTDATA_OFFSET UNITYSDK_OFFSET(0xCFA3A10)
#define RPG_CLIENT_PIPELINECAMERAENGINE__CREATECAMERALOOKATTEMPLATE_OFFSET UNITYSDK_OFFSET(0xCF9F000)
#define RPG_CLIENT_PIPELINECAMERAENGINE__CREATEVCAMERAFREELOOK3RDCONFIGCHANGETEMPLATE_OFFSET UNITYSDK_OFFSET(0xCF9EED0)
#define RPG_CLIENT_PIPELINECAMERAENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0xCFA5030)
#define RPG_CLIENT_PIPELINECAMERAENGINE__DOREFRESHPIPELINEMODULE_OFFSET UNITYSDK_OFFSET(0xCFA2F80)
#define RPG_CLIENT_PIPELINECAMERAENGINE__INSPECTBATTLEFINISHFALLBACK_OFFSET UNITYSDK_OFFSET(0xCFA33E0)
#define RPG_CLIENT_PIPELINECAMERAENGINE__INTERVALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCFA0E30)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONACTIVEENTITYCHANGE_OFFSET UNITYSDK_OFFSET(0xCFA43D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONLATEUPDATEAFTERRESETTOFIGHTNORMAL_OFFSET UNITYSDK_OFFSET(0xCFA3520)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONREALCAMERACHANGE_OFFSET UNITYSDK_OFFSET(0xCFA44E0)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONTEAMLEADERSWITCHED_OFFSET UNITYSDK_OFFSET(0xCFA4480)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONWORLDSHIFTING_OFFSET UNITYSDK_OFFSET(0xCFA4540)
#define RPG_CLIENT_PIPELINECAMERAENGINE__REGIST_OFFSET UNITYSDK_OFFSET(0xCFA0BB0)
#define RPG_CLIENT_PIPELINECAMERAENGINE__RESETTOFIGHTNORMALMODE_OFFSET UNITYSDK_OFFSET(0xCFA3320)
#define RPG_CLIENT_PIPELINECAMERAENGINE__UNREGIST_OFFSET UNITYSDK_OFFSET(0xCFA21A0)
