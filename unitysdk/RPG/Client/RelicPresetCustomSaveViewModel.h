...
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL_CREATEDEFAULT_OFFSET UNITYSDK_OFFSET(0xD2ED870)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL_CREATEWITHSMARTSUITPLAN_OFFSET UNITYSDK_OFFSET(0xD2EF770)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL_GETRELICPRESETEDITVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD2EFB50)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xD2F0160)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL_GET_PRESETPLANVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD2F0140)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL_ISHAVESAMEPLAN_OFFSET UNITYSDK_OFFSET(0xD2EFC20)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0xD2F0170)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL_SET_PRESETPLANVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD2F0150)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD2EF4B0)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL__INITWITHAVATARDEFAULTEQUIPRELIC_OFFSET UNITYSDK_OFFSET(0xD2EF4C0)
#define RPG_CLIENT_RELICPRESETCUSTOMSAVEVIEWMODEL__INITWITHSMARTSUITPLAN_OFFSET UNITYSDK_OFFSET(0xD2EF850)
