...
#define RPG_CLIENT_ABILITYRADAR_GET_MATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0xBA7E530)
#define RPG_CLIENT_ABILITYRADAR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBA7F520)
#define RPG_CLIENT_ABILITYRADAR_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xBA7F5B0)
#define RPG_CLIENT_ABILITYRADAR_SETABILITYVALUE_OFFSET UNITYSDK_OFFSET(0xBA7EDC0)
#define RPG_CLIENT_ABILITYRADAR_START_OFFSET UNITYSDK_OFFSET(0xBA7F600)
#define RPG_CLIENT_ABILITYRADAR_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0xBA7EEC0)
#define RPG_CLIENT_ABILITYRADAR__CTOR_OFFSET UNITYSDK_OFFSET(0xBA7F650)
#define RPG_CLIENT_ABILITYRADAR__INIT_OFFSET UNITYSDK_OFFSET(0xBA7E5E0)
#define RPG_CLIENT_ABILITYRADAR__REFRESHMATERIALPROPERTIES_OFFSET UNITYSDK_OFFSET(0xBA7EF10)

namespace RPG::Client
{
	inline static constexpr unsigned int AbilityRadar_TypeDefinitionIndex = 69222;
