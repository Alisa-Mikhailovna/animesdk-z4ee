...
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_CONVERTEXPTOLEVEL_OFFSET UNITYSDK_OFFSET(0xC11A820)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_CONVERTLEVELTOEXP_OFFSET UNITYSDK_OFFSET(0xC11A740)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_CREATEWITHCONSTVALUES_OFFSET UNITYSDK_OFFSET(0xC1190C0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_GETLEVELUPREQUIREDEXP_OFFSET UNITYSDK_OFFSET(0xC11A8D0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_GET_MAXGAINEDEXP_OFFSET UNITYSDK_OFFSET(0xC11A6F0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xC11A6E0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_READCONSTVALUEOFEXPBEFORELEVELUP_OFFSET UNITYSDK_OFFSET(0xC119A40)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC119CF0)
