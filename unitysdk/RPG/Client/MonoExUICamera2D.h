...
#define RPG_CLIENT_MONOEXUICAMERA2D_INITCANVASRANGE_OFFSET UNITYSDK_OFFSET(0xCCE9BF0)
#define RPG_CLIENT_MONOEXUICAMERA2D_INIT_OFFSET UNITYSDK_OFFSET(0xCCE8DD0)
#define RPG_CLIENT_MONOEXUICAMERA2D_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xCCE9230)
#define RPG_CLIENT_MONOEXUICAMERA2D_SETENABLEMOVE_OFFSET UNITYSDK_OFFSET(0xCCE8FE0)
#define RPG_CLIENT_MONOEXUICAMERA2D_SETENABLEZOOM_OFFSET UNITYSDK_OFFSET(0xCCE9050)
#define RPG_CLIENT_MONOEXUICAMERA2D_SETLOCKPOSITIONANDZOOM_OFFSET UNITYSDK_OFFSET(0xCCE90C0)
#define RPG_CLIENT_MONOEXUICAMERA2D__CONVERTSCALEFROMPOSZ_OFFSET UNITYSDK_OFFSET(0xCCE9C40)
#define RPG_CLIENT_MONOEXUICAMERA2D__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE9D20)
#define RPG_CLIENT_MONOEXUICAMERA2D__INITEXUICAMERA_OFFSET UNITYSDK_OFFSET(0xCCE8E20)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATECONTENTRECT_OFFSET UNITYSDK_OFFSET(0xCCE9680)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATECONTENTZOOM_OFFSET UNITYSDK_OFFSET(0xCCE9960)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATEPARAM_OFFSET UNITYSDK_OFFSET(0xCCE9350)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATEPOSITION_OFFSET UNITYSDK_OFFSET(0xCCE9430)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATESWIPESPEEDRATIO_OFFSET UNITYSDK_OFFSET(0xCCE9A00)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATE_OFFSET UNITYSDK_OFFSET(0xCCE9280)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoExUICamera2D_TypeDefinitionIndex = 69662;
