...
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_ADDBATTLECOLLEGEDATA_OFFSET UNITYSDK_OFFSET(0xBE50E80)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBE50DE0)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_GET_BATTLECOLLEGEDATALIST_OFFSET UNITYSDK_OFFSET(0xBE50FB0)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_GET_FINISHCOUNT_OFFSET UNITYSDK_OFFSET(0xBE51020)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBE50F70)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_GET_ISADVANCED_OFFSET UNITYSDK_OFFSET(0xBE511B0)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xBE51120)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xBE50F90)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xBE50FD0)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xBE50F30)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_SET_BATTLECOLLEGEDATALIST_OFFSET UNITYSDK_OFFSET(0xBE50FC0)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xBE50F80)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xBE50FA0)
#define RPG_CLIENT_BATTLECOLLEGEGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBE50DA0)
