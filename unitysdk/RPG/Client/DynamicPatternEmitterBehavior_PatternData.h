...
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xC2E03E0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_IFACTIVE_OFFSET UNITYSDK_OFFSET(0xC2E0440)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_IFEMITNEXT_OFFSET UNITYSDK_OFFSET(0xC2E0420)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_IFPOSTAUDIO_OFFSET UNITYSDK_OFFSET(0xC2E0400)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_TIMER01_OFFSET UNITYSDK_OFFSET(0xC2E0460)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xC2E03F0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_IFACTIVE_OFFSET UNITYSDK_OFFSET(0xC2E0450)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_IFEMITNEXT_OFFSET UNITYSDK_OFFSET(0xC2E0430)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_IFPOSTAUDIO_OFFSET UNITYSDK_OFFSET(0xC2E0410)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_TIMER01_OFFSET UNITYSDK_OFFSET(0xC2E0470)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E0480)
