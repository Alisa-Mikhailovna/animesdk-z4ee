...
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_DISABLEUPDATE_OFFSET UNITYSDK_OFFSET(0xD28BBA0)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_ENABLEUPDATE_OFFSET UNITYSDK_OFFSET(0xD28BAB0)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD28BD50)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_OVERRIDESWIPECONFIG_OFFSET UNITYSDK_OFFSET(0xD28BC00)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0xD28BE80)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_START_OFFSET UNITYSDK_OFFSET(0xD28BC70)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xD28BF50)
