...
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_GETDATA_OFFSET UNITYSDK_OFFSET(0xD42A5F0)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_GET_DOOREFFECTPATH_OFFSET UNITYSDK_OFFSET(0xD42B230)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD42B1F0)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_GET_MARKTYPE_OFFSET UNITYSDK_OFFSET(0xD42B1B0)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD42B1D0)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_GET_ROOMTYPE_OFFSET UNITYSDK_OFFSET(0xD42B190)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_GET_TOASTICONPATH_OFFSET UNITYSDK_OFFSET(0xD42B210)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_SET_DOOREFFECTPATH_OFFSET UNITYSDK_OFFSET(0xD42B240)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD42B200)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_SET_MARKTYPE_OFFSET UNITYSDK_OFFSET(0xD42B1C0)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xD42B1E0)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_SET_ROOMTYPE_OFFSET UNITYSDK_OFFSET(0xD42B1A0)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA_SET_TOASTICONPATH_OFFSET UNITYSDK_OFFSET(0xD42B220)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xD42B250)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA__CREATEDATA_OFFSET UNITYSDK_OFFSET(0xD42B000)
#define RPG_CLIENT_ROGUETOURNCLASSICROOMTYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD42AFF0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::RogueInstanceCacheManager_3<::RPG::GameCore::RogueTournRoomType, ::RPG::GameCore::RogueTournMarkType, ::RPG::Client::RogueTournClassicRoomTypeData*>**)Il2CppClass::FromTypeDefinitionIndex(RogueTournClassicRoomTypeData_TypeDefinitionIndex)->GetStaticField(0x2B060);
		}
