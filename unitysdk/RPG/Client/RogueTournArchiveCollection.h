...
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_CLEARNAME_OFFSET UNITYSDK_OFFSET(0xD40A840)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_DELETEUPDATE_OFFSET UNITYSDK_OFFSET(0xD40A290)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD409BA0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_GETARCHIVEDATALIST_OFFSET UNITYSDK_OFFSET(0xD40A3F0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_GETARCHIVEDATA_OFFSET UNITYSDK_OFFSET(0xD40A360)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_GETSAVEDARCHIVEDATA_OFFSET UNITYSDK_OFFSET(0xD40A5F0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_GET_MAXSLOT_OFFSET UNITYSDK_OFFSET(0xD40AD40)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_HASANYARCHIVEDATA_OFFSET UNITYSDK_OFFSET(0xD40A590)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_INIT_OFFSET UNITYSDK_OFFSET(0xD409AA0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_RENAME_OFFSET UNITYSDK_OFFSET(0xD40A700)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_SYNCALL_OFFSET UNITYSDK_OFFSET(0xD409E30)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_SYNCUPDATE_OFFSET UNITYSDK_OFFSET(0xD409FC0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD409A90)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION__SYNCARCHIVELIST_OFFSET UNITYSDK_OFFSET(0xD409EF0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION__SYNCARCHIVE_OFFSET UNITYSDK_OFFSET(0xD40A0E0)
