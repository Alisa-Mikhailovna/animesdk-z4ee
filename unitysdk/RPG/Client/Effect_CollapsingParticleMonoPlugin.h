...
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_04F02FC65FAA2E0C_OFFSET UNITYSDK_OFFSET(0xC3012E0)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0xC300970)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_A3EF4ED894EBFFC3_OFFSET UNITYSDK_OFFSET(0xC301220)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_E46A4D7B872282A4_OFFSET UNITYSDK_OFFSET(0xC300B70)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_RENDEREREQUALS_OFFSET UNITYSDK_OFFSET(0xC3006C0)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xC3016A0)
