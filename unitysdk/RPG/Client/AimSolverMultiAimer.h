...
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xBCFC090)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETALPHA_OFFSET UNITYSDK_OFFSET(0xBCFDC70)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETEVALUATOR_OFFSET UNITYSDK_OFFSET(0xBCFDC30)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETLIMITHEIGHT_OFFSET UNITYSDK_OFFSET(0xBCFDC50)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGET_OFFSET UNITYSDK_OFFSET(0xBCFDC00)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xBCFDBE0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_06052BE3262A4192_OFFSET UNITYSDK_OFFSET(0xBCFD0B0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_374781907C88EFD7_OFFSET UNITYSDK_OFFSET(0xBCFC9C0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_472E9805B297BD58_OFFSET UNITYSDK_OFFSET(0xBCFDB50)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_4F6E40C18A7A5A9E_OFFSET UNITYSDK_OFFSET(0xBCFBDD0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xBCFCB80)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_A84CEAF7AFA573B3_OFFSET UNITYSDK_OFFSET(0xBCFC850)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_BB8271ED1BDF8503_OFFSET UNITYSDK_OFFSET(0xBCFD000)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETALPHA_OFFSET UNITYSDK_OFFSET(0xBCFDC80)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETEVALUATOR_OFFSET UNITYSDK_OFFSET(0xBCFDC40)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETLIMITHEIGHT_OFFSET UNITYSDK_OFFSET(0xBCFDC60)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGET_OFFSET UNITYSDK_OFFSET(0xBCFDC20)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xBCFDBF0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER__CTOR_OFFSET UNITYSDK_OFFSET(0xBCFDC90)
