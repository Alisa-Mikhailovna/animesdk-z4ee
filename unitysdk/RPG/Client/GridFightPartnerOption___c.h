...
#define RPG_CLIENT_GRIDFIGHTPARTNEROPTION___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC7A5B00)
#define RPG_CLIENT_GRIDFIGHTPARTNEROPTION___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC7A5B40)
#define RPG_CLIENT_GRIDFIGHTPARTNEROPTION___C___GETSHOWTRAITCONFIGS_B__10_0_OFFSET UNITYSDK_OFFSET(0xC7A5B50)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::GridFightPartnerOption___c**)Il2CppClass::FromTypeDefinitionIndex(GridFightPartnerOption___c_TypeDefinitionIndex)->GetStaticField(0x2A9F0);
		}
		static ::System::Func_2<::RPG::Client::GridFightTraitConfig*, ::System::Boolean>** StaticGet___9__10_0()
		{
			return (::System::Func_2<::RPG::Client::GridFightTraitConfig*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(GridFightPartnerOption___c_TypeDefinitionIndex)->GetStaticField(0x2A9F8);
		}
