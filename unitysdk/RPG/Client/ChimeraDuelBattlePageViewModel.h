...
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC112DE0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_ALLYTEAM_OFFSET UNITYSDK_OFFSET(0xC112D70)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_ENEMYTEAM_OFFSET UNITYSDK_OFFSET(0xC112D90)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_GAME_OFFSET UNITYSDK_OFFSET(0xC112D50)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_SETTLEHANDLER_OFFSET UNITYSDK_OFFSET(0xC112DB0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_ALLYTEAM_OFFSET UNITYSDK_OFFSET(0xC112D80)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_ENEMYTEAM_OFFSET UNITYSDK_OFFSET(0xC112DA0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_GAME_OFFSET UNITYSDK_OFFSET(0xC112D60)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_SETTLEHANDLER_OFFSET UNITYSDK_OFFSET(0xC112DC0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CREATEFORCHALLENGEBATTLE_OFFSET UNITYSDK_OFFSET(0xC113090)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CREATEFORSESSIONBATTLE_OFFSET UNITYSDK_OFFSET(0xC113560)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CREATEFORSHOWCASEBATTLE_OFFSET UNITYSDK_OFFSET(0xC1132D0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC112DD0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__REPORTCHIMERADUELCHALLENGEBATTLESETTLE_OFFSET UNITYSDK_OFFSET(0xC1155D0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__REPORTCHIMERADUELCHALLENGEBATTLESTART_OFFSET UNITYSDK_OFFSET(0xC1148A0)
