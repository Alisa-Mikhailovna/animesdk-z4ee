...
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xC61B930)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xC61C760)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GETGREATESTMINIMUMCHILDWIDTH_OFFSET UNITYSDK_OFFSET(0xC61B9F0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GET_RECORDMINCOUNTHORIZONAL_OFFSET UNITYSDK_OFFSET(0xC61B6B0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GET_RECORDMINCOUNTVERTICAL_OFFSET UNITYSDK_OFFSET(0xC61B6F0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GET_ROWCOLUMNINDEX_OFFSET UNITYSDK_OFFSET(0xC61B730)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GET_ROWCOLUMNREVERSEINDEX_OFFSET UNITYSDK_OFFSET(0xC61B780)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0xC61B830)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xC61B7D0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xC61B8E0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xC61B890)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_4F8E06786E479E28_OFFSET UNITYSDK_OFFSET(0xC61C980)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_D66617C59550EB9B_OFFSET UNITYSDK_OFFSET(0xC61C860)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xC61BAD0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xC61C660)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_SETLAYOUT_OFFSET UNITYSDK_OFFSET(0xC61BBC0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xC61D3F0)

namespace RPG::Client
{
	inline static constexpr unsigned int FlexibleLayoutGroup_TypeDefinitionIndex = 69258;
