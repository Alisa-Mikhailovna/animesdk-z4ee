...
#define RPG_CLIENT_ST_PARKOUR_SWITCHROAD_METHOD_4_24E28BE7C123299D_OFFSET UNITYSDK_OFFSET(0x1B0ECE20)
#define RPG_CLIENT_ST_PARKOUR_SWITCHROAD_METHOD_4_8B94C91ABFA772B8_OFFSET UNITYSDK_OFFSET(0x1B0ECDD0)
#define RPG_CLIENT_ST_PARKOUR_SWITCHROAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0ECE10)
