...
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBC46450)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBC464E0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBC46500)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_NPCHANDICON_OFFSET UNITYSDK_OFFSET(0xBC46570)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_REPLY_OFFSET UNITYSDK_OFFSET(0xBC465C0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xBC464F0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBC464D0)
