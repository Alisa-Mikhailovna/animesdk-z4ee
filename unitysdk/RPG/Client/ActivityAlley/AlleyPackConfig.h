...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBAE5CC0)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackConfig_TypeDefinitionIndex = 70700;
