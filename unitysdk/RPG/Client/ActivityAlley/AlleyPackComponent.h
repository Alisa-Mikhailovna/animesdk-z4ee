...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_AUTOSETTLE_OFFSET UNITYSDK_OFFSET(0xBADD870)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_BEGINDRAG_OFFSET UNITYSDK_OFFSET(0xBADE310)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_CANCELSETTLE_OFFSET UNITYSDK_OFFSET(0xBADD980)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_CHECKBOUNDINTERSECT_OFFSET UNITYSDK_OFFSET(0xBADDBC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_CLEARANCHORSETTLEEFFECT_OFFSET UNITYSDK_OFFSET(0xBADD130)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBADC380)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_DOROTATE_OFFSET UNITYSDK_OFFSET(0xBADEAB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_DOSELECT_OFFSET UNITYSDK_OFFSET(0xBADE950)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ENABLECOLLIDERTRIGGER_OFFSET UNITYSDK_OFFSET(0xBADDB20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ENDDRAG_OFFSET UNITYSDK_OFFSET(0xBADE780)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0xBADF7A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_DRAGMERGEDBOUND_OFFSET UNITYSDK_OFFSET(0xBADF860)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_DRAGSTATE_OFFSET UNITYSDK_OFFSET(0xBADF790)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_FIRSTHEADANCHOR_OFFSET UNITYSDK_OFFSET(0xBADDDD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_INIT_OFFSET UNITYSDK_OFFSET(0xBADB780)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONREMOVE_OFFSET UNITYSDK_OFFSET(0xBADD0E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONSELECT_OFFSET UNITYSDK_OFFSET(0xBADC650)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONSETTLE_OFFSET UNITYSDK_OFFSET(0xBADC950)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONUNSELECT_OFFSET UNITYSDK_OFFSET(0xBADC7C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_REFRESHCANANCHORSTATUS_OFFSET UNITYSDK_OFFSET(0xBADDFE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_SETTLE_OFFSET UNITYSDK_OFFSET(0xBADD3C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_SET_DRAGMERGEDBOUND_OFFSET UNITYSDK_OFFSET(0xBADF880)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_SHOWANCHORSETTLEEFFECT_OFFSET UNITYSDK_OFFSET(0xBADCCB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_TICK_OFFSET UNITYSDK_OFFSET(0xBADDE40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_TRIGGERREMOVEAUDIO_OFFSET UNITYSDK_OFFSET(0xBADD220)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__BEGINROTATE_OFFSET UNITYSDK_OFFSET(0xBADEE70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xBADFFF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CHANGESTATE_OFFSET UNITYSDK_OFFSET(0xBADFD80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__COLLECTANCHORS_OFFSET UNITYSDK_OFFSET(0xBADB880)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__COLLECTRENDERDATA_OFFSET UNITYSDK_OFFSET(0xBADBBB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xBADB640)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__DISPOSERENDERDATA_OFFSET UNITYSDK_OFFSET(0xBADC3D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__GETDELTATIME_OFFSET UNITYSDK_OFFSET(0xBADFFA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__GETTIMERRESET_OFFSET UNITYSDK_OFFSET(0xBADFE10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xBADED50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__RESETDRAGCOLOR_OFFSET UNITYSDK_OFFSET(0xBADFA80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__SETDRAGCOLOR_OFFSET UNITYSDK_OFFSET(0xBADFBE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__SWITCHDRAGSTATE_OFFSET UNITYSDK_OFFSET(0xBADCA70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TICKTSTATE_OFFSET UNITYSDK_OFFSET(0xBADF710)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TRIGGERREMOVEAUDIO_OFFSET UNITYSDK_OFFSET(0xBADD270)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TRIGGERROTATEAUDIO_OFFSET UNITYSDK_OFFSET(0xBADF580)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TRIGGERSETTLEAUDIO_OFFSET UNITYSDK_OFFSET(0xBADCF50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__UPDATEDRAGSTATE_OFFSET UNITYSDK_OFFSET(0xBADDF40)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackComponent_TypeDefinitionIndex = 70689;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AlleyPackComponent_TypeDefinitionIndex)->GetStaticField(0x8A10);
		}
