...
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_B1B448B2EC103605_OFFSET UNITYSDK_OFFSET(0xD562C20)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_D09831639F615812_1_OFFSET UNITYSDK_OFFSET(0xD562B50)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_D09831639F615812_OFFSET UNITYSDK_OFFSET(0xD562880)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_ECD37C0004A0B2D4_OFFSET UNITYSDK_OFFSET(0xD5624A0)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0xD562700)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_EDE7801417BC8FDC_OFFSET UNITYSDK_OFFSET(0xD5628E0)
#define RPG_CLIENT_STATETRANSITIONAUDIO_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xD562330)
#define RPG_CLIENT_STATETRANSITIONAUDIO_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xD5625F0)
#define RPG_CLIENT_STATETRANSITIONAUDIO_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD5627D0)
#define RPG_CLIENT_STATETRANSITIONAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xD562D70)
