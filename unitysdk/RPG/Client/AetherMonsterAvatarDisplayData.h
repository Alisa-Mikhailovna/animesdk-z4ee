...
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBCF1540)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_GYMLOCATION_OFFSET UNITYSDK_OFFSET(0xBCF1960)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBCF15F0)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xBCE3610)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xBCF1790)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_RELATEDSPIRITDATA_OFFSET UNITYSDK_OFFSET(0xBCF1670)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xBCF1840)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_SPIRITTYPE_OFFSET UNITYSDK_OFFSET(0xBCF18B0)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xBCF1610)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xBCF1600)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_UPDATESTATUS_OFFSET UNITYSDK_OFFSET(0xBCF15B0)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBCF15A0)
