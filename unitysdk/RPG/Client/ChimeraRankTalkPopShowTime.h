...
#define RPG_CLIENT_CHIMERARANKTALKPOPSHOWTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xC153030)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraRankTalkPopShowTime_TypeDefinitionIndex = 69209;
