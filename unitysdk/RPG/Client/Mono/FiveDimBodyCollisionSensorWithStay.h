...
#define RPG_CLIENT_MONO_FIVEDIMBODYCOLLISIONSENSORWITHSTAY_ADD_ONSTAY_OFFSET UNITYSDK_OFFSET(0xCC2E730)
#define RPG_CLIENT_MONO_FIVEDIMBODYCOLLISIONSENSORWITHSTAY_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0xCC2E6C0)
#define RPG_CLIENT_MONO_FIVEDIMBODYCOLLISIONSENSORWITHSTAY_REMOVE_ONSTAY_OFFSET UNITYSDK_OFFSET(0xCC2E790)
#define RPG_CLIENT_MONO_FIVEDIMBODYCOLLISIONSENSORWITHSTAY__CTOR_OFFSET UNITYSDK_OFFSET(0xCC2E7F0)

namespace RPG::Client::Mono
{
	inline static constexpr unsigned int FiveDimBodyCollisionSensorWithStay_TypeDefinitionIndex = 72108;
