...
#define RPG_CLIENT_MONO_FIVEDIMCHILDPRESETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCC2EA70)

namespace RPG::Client::Mono
{
	inline static constexpr unsigned int FiveDimChildPresetInfo_TypeDefinitionIndex = 72110;
