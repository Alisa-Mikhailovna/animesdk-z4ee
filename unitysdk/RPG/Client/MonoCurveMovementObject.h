...
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC42F20)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_ANIMATORREF_OFFSET UNITYSDK_OFFSET(0xCC42DD0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_CUSTOMDIRECTION_OFFSET UNITYSDK_OFFSET(0xCC42DF0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_FREEZEROTATE_OFFSET UNITYSDK_OFFSET(0xCC42D80)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_ISINANIMIDLESTATE_OFFSET UNITYSDK_OFFSET(0xCC42E10)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_ANIMATORREF_OFFSET UNITYSDK_OFFSET(0xCC42DE0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_CUSTOMDIRECTION_OFFSET UNITYSDK_OFFSET(0xCC42E00)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC42FB0)
