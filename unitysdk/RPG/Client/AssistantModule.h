...
#define RPG_CLIENT_ASSISTANTMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBDAB990)
#define RPG_CLIENT_ASSISTANTMODULE_GETASSISTANTTIPSDATA_OFFSET UNITYSDK_OFFSET(0xBDABB40)
#define RPG_CLIENT_ASSISTANTMODULE_GETASSISTANTTIPSSHOWCASEDATA_OFFSET UNITYSDK_OFFSET(0xBDABA90)
#define RPG_CLIENT_ASSISTANTMODULE_GETSHOWCASEALLTIPS_OFFSET UNITYSDK_OFFSET(0xBDABBF0)
#define RPG_CLIENT_ASSISTANTMODULE_GETSHOWTIPS_OFFSET UNITYSDK_OFFSET(0xBDAC7D0)
#define RPG_CLIENT_ASSISTANTMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xBDAB3D0)
#define RPG_CLIENT_ASSISTANTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xBDACA90)
#define RPG_CLIENT_ASSISTANTMODULE__INITTIPSDATADICT_OFFSET UNITYSDK_OFFSET(0xBDAB430)
#define RPG_CLIENT_ASSISTANTMODULE__INITTIPSSHOWCASEDATADICT_OFFSET UNITYSDK_OFFSET(0xBDAB6E0)
