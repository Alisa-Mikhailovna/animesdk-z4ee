...
#define RPG_CLIENT_EVOLVEBUILDMODULE___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC40AFE0)
#define RPG_CLIENT_EVOLVEBUILDMODULE___C__DISPLAYCLASS32_0__RETURNTOMAZE_B__0_OFFSET UNITYSDK_OFFSET(0xC414C10)
#define RPG_CLIENT_EVOLVEBUILDMODULE___C__DISPLAYCLASS32_0__RETURNTOMAZE_B__1_OFFSET UNITYSDK_OFFSET(0xC414D30)
