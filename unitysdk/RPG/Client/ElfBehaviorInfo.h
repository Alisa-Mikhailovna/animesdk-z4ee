...
#define RPG_CLIENT_ELFBEHAVIORINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC363600)
#define RPG_CLIENT_ELFBEHAVIORINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC363300)
#define RPG_CLIENT_ELFBEHAVIORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC3636A0)
#define RPG_CLIENT_ELFBEHAVIORINFO__INITBEHAVIORDATA_OFFSET UNITYSDK_OFFSET(0xC363350)
