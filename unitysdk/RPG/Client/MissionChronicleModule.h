...
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_CHECKPREFSOVERFLOW_OFFSET UNITYSDK_OFFSET(0xCBD5200)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCBD6610)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GETAVAILABLEMIDDLESINGLEPACKMISSION_OFFSET UNITYSDK_OFFSET(0xCBD3C30)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GETEMPTYMISSIONDATALIST_OFFSET UNITYSDK_OFFSET(0xCBD4B30)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GETNEWPATHDATABYMISSIONID_OFFSET UNITYSDK_OFFSET(0xCBD5240)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GETPENACONYENDMOSTCHRONICLEDATA_OFFSET UNITYSDK_OFFSET(0xCBD6730)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GET_CANTAKEMISSIONPATHIDLIST_OFFSET UNITYSDK_OFFSET(0xCBD7740)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GET_CHRONICLEMAINPATHDICT_OFFSET UNITYSDK_OFFSET(0xCBD7700)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GET_CHRONICLEMIDDLEMISSIONPACKDICT_OFFSET UNITYSDK_OFFSET(0xCBD77B0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GET_FIRSTPATHID_OFFSET UNITYSDK_OFFSET(0xCBD7720)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GET_MISSIONCHRONICLEREDDOTFILTER_OFFSET UNITYSDK_OFFSET(0xCBD7790)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_GET_WORLDPATHDICT_OFFSET UNITYSDK_OFFSET(0xCBD77D0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xCBD59D0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_ONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0xCBD6560)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0xCBD66C0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_PREPARECHRONICLEMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xCBD3F20)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_REFRESHEARLYACCESSINFO_OFFSET UNITYSDK_OFFSET(0xCBD54C0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xCBD5470)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_REFRESHWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0xCBD56C0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_SET_CHRONICLEMAINPATHDICT_OFFSET UNITYSDK_OFFSET(0xCBD7710)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_SET_CHRONICLEMIDDLEMISSIONPACKDICT_OFFSET UNITYSDK_OFFSET(0xCBD77C0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_SET_FIRSTPATHID_OFFSET UNITYSDK_OFFSET(0xCBD7730)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_SET_MISSIONCHRONICLEREDDOTFILTER_OFFSET UNITYSDK_OFFSET(0xCBD77A0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE_SET_WORLDPATHDICT_OFFSET UNITYSDK_OFFSET(0xCBD77E0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__CHECKISMISSIONEMPTY_OFFSET UNITYSDK_OFFSET(0xCBD4FC0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__CHECKISSUBMISSIONEMPTY_OFFSET UNITYSDK_OFFSET(0xCBD5150)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xCBD3EF0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__GENERATECHRONICLEMIDDLEMISSIONPACK_OFFSET UNITYSDK_OFFSET(0xCBD6230)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__GENERATECHRONICLEPATH_OFFSET UNITYSDK_OFFSET(0xCBD5AA0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__GENERATEFILTER_OFFSET UNITYSDK_OFFSET(0xCBD6120)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__GETMISSIONNEEDPREPAREIDLIST_OFFSET UNITYSDK_OFFSET(0xCBD40A0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__ONLOGINFINISH_B__10_0_OFFSET UNITYSDK_OFFSET(0xCBD77F0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__SEARCHEARLYACCESSEFFECTED_OFFSET UNITYSDK_OFFSET(0xCBD5800)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__SEARCHNEWMAINPATHBYMISSIONID_OFFSET UNITYSDK_OFFSET(0xCBD52E0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__SEARCHNEWSUBPATHBYMISSIONID_OFFSET UNITYSDK_OFFSET(0xCBD72B0)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__SETASSISTPATHDATALISTEAEFFECTED_OFFSET UNITYSDK_OFFSET(0xCBD7660)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__SETCANTAKEMISSIONPATHIDLIST_OFFSET UNITYSDK_OFFSET(0xCBD6F00)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__SETCONNECTIONWAYDATA_OFFSET UNITYSDK_OFFSET(0xCBD6790)
#define RPG_CLIENT_MISSIONCHRONICLEMODULE__SETMAINPATHCANTAKEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xCBD7000)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::String* ChronicleMiddleMissionPackJsonFilePath; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_B302648C6979F380*>* _ChronicleMiddleMissionPackDict_k__BackingField; // 0x20
		::System::Collections::Generic::List_1<::System::UInt32>* _AllSubMissionIDList; // 0x28
		::RPG::Client::PenaconyEndmostChronicleData* _PenaconyEndmostChronicleData; // 0x30
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::MissionChronicleMainPathData*>* _ChronicleMainPathDict_k__BackingField; // 0x50
		::System::String* ChronicleMainPathJsonFilePath; // 0x58
