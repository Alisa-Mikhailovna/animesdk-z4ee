...
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_CHECKCHALLENGETARGETHASCOMPLETED_OFFSET UNITYSDK_OFFSET(0xBC6E9D0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_CREATE_OFFSET UNITYSDK_OFFSET(0xBC6E660)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETCHALLENGETARGETS_OFFSET UNITYSDK_OFFSET(0xBC6F250)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETFIRSTCHALLENGETARGET_OFFSET UNITYSDK_OFFSET(0xBC6ED60)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETMASTERTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0xBC6F000)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETSORTEDMONSTERS_OFFSET UNITYSDK_OFFSET(0xBC6E6D0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xBC6EBE0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETTRIALAVATARS_OFFSET UNITYSDK_OFFSET(0xBC6EDF0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_BATTLEEVENTID_OFFSET UNITYSDK_OFFSET(0xBC6E5C0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0xBC6E1E0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_HASCOMPLETED_OFFSET UNITYSDK_OFFSET(0xBC6E440)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_HASUNLOCKED_OFFSET UNITYSDK_OFFSET(0xBC6E230)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_MASTERAVATARLIST_OFFSET UNITYSDK_OFFSET(0xBC6E520)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_META_OFFSET UNITYSDK_OFFSET(0xBC6E070)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_MONSTERIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBC6E610)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xBC6E0B0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_SUMMONSTAGEREF_OFFSET UNITYSDK_OFFSET(0xBC6E100)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_TRIALAVATARLIST_OFFSET UNITYSDK_OFFSET(0xBC6E570)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_TRYCONSUMEUNLOCKFLAG_OFFSET UNITYSDK_OFFSET(0xBC6F430)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL__CHECKALLCHALLENGETARGETHASCOMPLETED_OFFSET UNITYSDK_OFFSET(0xBC6E490)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBC6E6C0)
