...
#define RPG_CLIENT_SMOOTHMASKDRAWER_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xD51D4A0)
#define RPG_CLIENT_SMOOTHMASKDRAWER__CTOR_OFFSET UNITYSDK_OFFSET(0xD51D530)
