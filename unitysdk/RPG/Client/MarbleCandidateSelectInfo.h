...
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xCB29BF0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GETSKILLDESCCONTENT_OFFSET UNITYSDK_OFFSET(0xCB29D30)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xCB2A2F0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_MARBLEID_OFFSET UNITYSDK_OFFSET(0xCB2A2B0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_MARBLELEVEL_OFFSET UNITYSDK_OFFSET(0xCB2A2D0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_MARBLESEALICONPATH_OFFSET UNITYSDK_OFFSET(0xCB2A020)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_MARBLESEALNAME_OFFSET UNITYSDK_OFFSET(0xCB2A130)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_PLAYERID_OFFSET UNITYSDK_OFFSET(0xCB2A290)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_SKILLICONPATH_OFFSET UNITYSDK_OFFSET(0xCB2A070)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_SKILLLEVEL_OFFSET UNITYSDK_OFFSET(0xCB2A0D0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_SKILLTITLE_OFFSET UNITYSDK_OFFSET(0xCB2A1D0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xCB2A300)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_SET_MARBLEID_OFFSET UNITYSDK_OFFSET(0xCB2A2C0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_SET_MARBLELEVEL_OFFSET UNITYSDK_OFFSET(0xCB2A2E0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_SET_PLAYERID_OFFSET UNITYSDK_OFFSET(0xCB2A2A0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCB29BE0)
