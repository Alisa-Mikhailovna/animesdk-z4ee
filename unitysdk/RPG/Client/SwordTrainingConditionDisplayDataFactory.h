...
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY_CREATECONDITIONDISPLAYDATALIST_OFFSET UNITYSDK_OFFSET(0xD5975B0)
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY__CREATEMULTICONDITIONDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xD597750)
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY__CREATESINGLECONDITIONDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xD5979A0)
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY__CREATESTATUSDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xD597A00)
