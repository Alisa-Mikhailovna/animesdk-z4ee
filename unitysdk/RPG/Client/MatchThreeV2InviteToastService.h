...
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_ACQUIRE_OFFSET UNITYSDK_OFFSET(0xCB6DE20)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_CLEAR_OFFSET UNITYSDK_OFFSET(0xCB6E1B0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_GET__CANSHOW_OFFSET UNITYSDK_OFFSET(0xCB6D600)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_GET__ISACTIVE_OFFSET UNITYSDK_OFFSET(0xCB6D6A0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_GET__ISSHOWING_OFFSET UNITYSDK_OFFSET(0xCB6D700)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_RELEASE_OFFSET UNITYSDK_OFFSET(0xCB6E000)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_SETCANSHOW_OFFSET UNITYSDK_OFFSET(0xCB6E2B0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_SETDISABLED_OFFSET UNITYSDK_OFFSET(0xCB6E720)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_SET__CANSHOW_OFFSET UNITYSDK_OFFSET(0xCB6D650)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB6D750)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ISRELEVANTPLAYTYPEBYSEASON_OFFSET UNITYSDK_OFFSET(0xCB6EC00)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ISVALIDINVITATION_OFFSET UNITYSDK_OFFSET(0xCB6E770)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0xCB6EAB0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ONRECEIVECONTACT_OFFSET UNITYSDK_OFFSET(0xCB6E8E0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ONTOASTDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0xCB6EA10)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__TRYPLAYNEXT_OFFSET UNITYSDK_OFFSET(0xCB6E3E0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__TRYSTOPCURRENT_OFFSET UNITYSDK_OFFSET(0xCB6E6C0)
