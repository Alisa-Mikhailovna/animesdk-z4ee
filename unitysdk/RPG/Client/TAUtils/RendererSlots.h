...
#define RPG_CLIENT_TAUTILS_RENDERERSLOTS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xD6064F0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTS_EQUALS_OFFSET UNITYSDK_OFFSET(0xD606340)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xD606720)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTS_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xD605DC0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTS_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD6062E0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTS_SET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xD605FA0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTS__CTOR_OFFSET UNITYSDK_OFFSET(0xD606810)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int RendererSlots_TypeDefinitionIndex = 70241;
