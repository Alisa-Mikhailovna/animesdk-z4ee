...
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY_GET_PROPERTYID_OFFSET UNITYSDK_OFFSET(0xD6018A0)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD601DC0)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY_SET_PROPERTYID_OFFSET UNITYSDK_OFFSET(0xD601E20)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xD601E30)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int MaterialPropertiesCollection_Property_TypeDefinitionIndex = 70209;
