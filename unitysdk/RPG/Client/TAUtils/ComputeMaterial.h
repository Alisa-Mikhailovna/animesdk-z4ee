...
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_055B57D0803DA902_OFFSET UNITYSDK_OFFSET(0xD5FE060)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_05903074FA8D7D0E_OFFSET UNITYSDK_OFFSET(0xD5FD5C0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_06AF7B1A8280FE42_OFFSET UNITYSDK_OFFSET(0xD5FDE00)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_12419F56E798761A_OFFSET UNITYSDK_OFFSET(0xD5FE150)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_1F62297D5DF54B30_OFFSET UNITYSDK_OFFSET(0xD5FE5F0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_215094CBF7E59C93_OFFSET UNITYSDK_OFFSET(0xD5FDC20)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_26607977B1AEDB16_OFFSET UNITYSDK_OFFSET(0xD5FE450)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_29F27E8C5DCE54E0_OFFSET UNITYSDK_OFFSET(0xD5FD640)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_35384A5071CCB96B_OFFSET UNITYSDK_OFFSET(0xD5FD700)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_419D6E7DF60B6F0B_OFFSET UNITYSDK_OFFSET(0xD5FE300)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_42988FE8E033FE1E_OFFSET UNITYSDK_OFFSET(0xD5FD410)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_5D9BA1D54A3CDB62_OFFSET UNITYSDK_OFFSET(0xD5FD3C0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_5E4EF3B56A795F4D_OFFSET UNITYSDK_OFFSET(0xD5FDCB0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_5FF1E2B8FCD9B46C_OFFSET UNITYSDK_OFFSET(0xD5FDB10)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_64629612F3646911_OFFSET UNITYSDK_OFFSET(0xD5FD4D0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_6CB5060D47BF8A1B_OFFSET UNITYSDK_OFFSET(0xD5FD550)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_6DACC73747E6207C_OFFSET UNITYSDK_OFFSET(0xD5FDBA0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_700FE3C732AA435C_OFFSET UNITYSDK_OFFSET(0xD5FE4E0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_72E21666A5A5FB58_OFFSET UNITYSDK_OFFSET(0xD5FE3A0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_791E87BBA5976F0D_OFFSET UNITYSDK_OFFSET(0xD5FD7E0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_7EB309CB8EB8090D_OFFSET UNITYSDK_OFFSET(0xD5FE570)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_803418CD50931138_OFFSET UNITYSDK_OFFSET(0xD5FDF00)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_859F5F716A958C95_OFFSET UNITYSDK_OFFSET(0xD5FDA80)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_969EF16C38E0FD30_OFFSET UNITYSDK_OFFSET(0xD5FD870)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_A07C2061B55C1547_OFFSET UNITYSDK_OFFSET(0xD5FD0F0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_A2B3632F424D6B51_OFFSET UNITYSDK_OFFSET(0xD5FDFF0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_AEFAF1FAD171856E_OFFSET UNITYSDK_OFFSET(0xD5FDD80)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_B377DFA91C103BC2_OFFSET UNITYSDK_OFFSET(0xD5FE260)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C24D72355EC8903A_OFFSET UNITYSDK_OFFSET(0xD5FDF70)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C4D9B4D8C0CE03AD_OFFSET UNITYSDK_OFFSET(0xD5FD9F0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C5D43255E85826E1_OFFSET UNITYSDK_OFFSET(0xD5FE1D0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C6E14CE377D03CE0_OFFSET UNITYSDK_OFFSET(0xD5FD470)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C8F6DE35233C6A4C_OFFSET UNITYSDK_OFFSET(0xD5FD970)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0xD5FE0E0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_E192DE9421E8351F_OFFSET UNITYSDK_OFFSET(0xD5FDE80)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_EB206643D64D33FB_OFFSET UNITYSDK_OFFSET(0xD5FD8F0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_F0553A46AEC8DA0F_OFFSET UNITYSDK_OFFSET(0xD5FD770)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_FD3B916300F77FDA_OFFSET UNITYSDK_OFFSET(0xD5FCCA0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0xD5FE660)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int ComputeMaterial_TypeDefinitionIndex = 70204;
