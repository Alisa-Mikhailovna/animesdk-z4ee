...
#define RPG_CLIENT_TAUTILS_SIMPLETRANSFORM_GET_INIT_OFFSET UNITYSDK_OFFSET(0xD606D60)
#define RPG_CLIENT_TAUTILS_SIMPLETRANSFORM_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x152750)
#define RPG_CLIENT_TAUTILS_SIMPLETRANSFORM_METHOD_2_9CF53A5EC24635E8_OFFSET UNITYSDK_OFFSET(0xD606A00)
#define RPG_CLIENT_TAUTILS_SIMPLETRANSFORM_METHOD_2_B4611E438AF47B36_OFFSET UNITYSDK_OFFSET(0x152770)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int SimpleTransform_TypeDefinitionIndex = 70235;
