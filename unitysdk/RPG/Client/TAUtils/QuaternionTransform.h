...
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_INIT_OFFSET UNITYSDK_OFFSET(0xD6041A0)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1525B0)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_ROTATIONEULER_OFFSET UNITYSDK_OFFSET(0x152590)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_ROTATIONQUATERNION_OFFSET UNITYSDK_OFFSET(0x152570)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_METHOD_2_5401F29DB96ED85D_OFFSET UNITYSDK_OFFSET(0xD603FD0)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_METHOD_2_AFB7020F8546C146_OFFSET UNITYSDK_OFFSET(0x1525D0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int QuaternionTransform_TypeDefinitionIndex = 70236;
