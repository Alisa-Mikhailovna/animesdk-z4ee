...
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_0C019665D0CC67CB_OFFSET UNITYSDK_OFFSET(0xD607860)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_1DE6310FB0FDE57C_OFFSET UNITYSDK_OFFSET(0xD607940)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_9037F1E5607EA334_OFFSET UNITYSDK_OFFSET(0xD607730)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_97D3CF39CEBC3FD8_OFFSET UNITYSDK_OFFSET(0xD607BF0)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xD604950)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_AD3AC8692C6030B9_OFFSET UNITYSDK_OFFSET(0xD604660)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_D27E6346B87373D4_1_OFFSET UNITYSDK_OFFSET(0xD607E00)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_D27E6346B87373D4_OFFSET UNITYSDK_OFFSET(0xD607D00)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_E963C7803068697A_OFFSET UNITYSDK_OFFSET(0xD607B20)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0xD607A80)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0xD607F00)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xD607CF0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int Vector4AnimationCurve_TypeDefinitionIndex = 70238;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::TAUtils::Vector4AnimationCurve*>**)Il2CppClass::FromTypeDefinitionIndex(Vector4AnimationCurve_TypeDefinitionIndex)->GetStaticField(0x393F0);
		}
