...
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORMANIMATIONCURVE_METHOD_1_1ADC5E4C222F6999_OFFSET UNITYSDK_OFFSET(0xD604780)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORMANIMATIONCURVE_METHOD_1_725B7810B3C694DE_OFFSET UNITYSDK_OFFSET(0xD6043D0)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORMANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xD6049C0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int QuaternionTransformAnimationCurve_TypeDefinitionIndex = 70240;
