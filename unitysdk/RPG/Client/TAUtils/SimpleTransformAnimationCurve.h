...
#define RPG_CLIENT_TAUTILS_SIMPLETRANSFORMANIMATIONCURVE_METHOD_1_2D3AA52D931500A2_OFFSET UNITYSDK_OFFSET(0xD606F00)
#define RPG_CLIENT_TAUTILS_SIMPLETRANSFORMANIMATIONCURVE_METHOD_1_93097B60EF70000E_OFFSET UNITYSDK_OFFSET(0xD606FE0)
#define RPG_CLIENT_TAUTILS_SIMPLETRANSFORMANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xD607140)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int SimpleTransformAnimationCurve_TypeDefinitionIndex = 70239;
