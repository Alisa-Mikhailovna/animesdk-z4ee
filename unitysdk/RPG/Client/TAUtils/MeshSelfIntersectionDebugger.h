...
#define RPG_CLIENT_TAUTILS_MESHSELFINTERSECTIONDEBUGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD601FD0)
#define RPG_CLIENT_TAUTILS_MESHSELFINTERSECTIONDEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD601FC0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int MeshSelfIntersectionDebugger_TypeDefinitionIndex = 70229;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Color>**)Il2CppClass::FromTypeDefinitionIndex(MeshSelfIntersectionDebugger_TypeDefinitionIndex)->GetStaticField(0x38EF0);
		}
