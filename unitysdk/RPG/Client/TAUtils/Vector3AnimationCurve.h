...
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_0FDE67E8BCF7203D_OFFSET UNITYSDK_OFFSET(0xD604570)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xD6048F0)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_9D28E30D3F31147B_OFFSET UNITYSDK_OFFSET(0xD607150)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_BEFE6ADDA38A85A9_1_OFFSET UNITYSDK_OFFSET(0xD607320)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_BEFE6ADDA38A85A9_OFFSET UNITYSDK_OFFSET(0xD607240)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0xD607400)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xD607230)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int Vector3AnimationCurve_TypeDefinitionIndex = 70237;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::TAUtils::Vector3AnimationCurve*>**)Il2CppClass::FromTypeDefinitionIndex(Vector3AnimationCurve_TypeDefinitionIndex)->GetStaticField(0x393C0);
		}
