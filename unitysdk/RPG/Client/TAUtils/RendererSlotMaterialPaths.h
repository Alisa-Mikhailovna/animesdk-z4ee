...
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xD6052A0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_EQUALS_OFFSET UNITYSDK_OFFSET(0xD6050E0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xD605500)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xD604B20)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xD604E00)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD605090)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_F773D945760BF918_OFFSET UNITYSDK_OFFSET(0xD604E70)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS__CTOR_OFFSET UNITYSDK_OFFSET(0xD605580)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int RendererSlotMaterialPaths_TypeDefinitionIndex = 70244;
