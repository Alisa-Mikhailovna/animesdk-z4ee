...
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC8B60)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xCCC8BF0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_ENDSCALECONTROL_OFFSET UNITYSDK_OFFSET(0xCCC8FB0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_GETCURRENTSCALE_OFFSET UNITYSDK_OFFSET(0xCCC8AF0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xCCC86F0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_SETSCALE_OFFSET UNITYSDK_OFFSET(0xCCC8A90)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_STARTSCALECONTROL_OFFSET UNITYSDK_OFFSET(0xCCC8F40)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC9020)
