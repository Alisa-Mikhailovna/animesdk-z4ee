...
#define RPG_CLIENT_WHEEL_FINALIZE_OFFSET UNITYSDK_OFFSET(0xD8A6C00)
#define RPG_CLIENT_WHEEL_METHOD_1_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xD8A6330)
#define RPG_CLIENT_WHEEL_METHOD_1_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xD8A6B10)
#define RPG_CLIENT_WHEEL_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xD8A6BA0)
#define RPG_CLIENT_WHEEL_METHOD_1_45714050EDEF8291_OFFSET UNITYSDK_OFFSET(0xD8A6A20)
#define RPG_CLIENT_WHEEL_METHOD_1_515AB539783606E0_OFFSET UNITYSDK_OFFSET(0xD8A5FB0)
#define RPG_CLIENT_WHEEL_METHOD_1_6CB15CD2E359A29C_OFFSET UNITYSDK_OFFSET(0xD8A64F0)
#define RPG_CLIENT_WHEEL_METHOD_1_8853398907028921_OFFSET UNITYSDK_OFFSET(0xD8A5E00)
#define RPG_CLIENT_WHEEL_METHOD_1_8C4F5769C49BF3B7_OFFSET UNITYSDK_OFFSET(0xD8A5F50)
#define RPG_CLIENT_WHEEL_METHOD_1_A9DAF3FE2888211B_OFFSET UNITYSDK_OFFSET(0xD8A6190)
#define RPG_CLIENT_WHEEL_METHOD_1_D4E1804C25B5032C_OFFSET UNITYSDK_OFFSET(0xD8A6140)
#define RPG_CLIENT_WHEEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD8A5D00)
