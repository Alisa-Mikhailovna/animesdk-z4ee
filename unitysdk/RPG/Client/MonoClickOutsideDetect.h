...
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT_ADDCLICKEDOUTSIDEHANDLER_OFFSET UNITYSDK_OFFSET(0xCC39840)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT_ADDIGNORERECT_1_OFFSET UNITYSDK_OFFSET(0xCC39A10)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT_ADDIGNORERECT_OFFSET UNITYSDK_OFFSET(0xCC39940)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT_CLEARIGNORERECTS_OFFSET UNITYSDK_OFFSET(0xCC39B80)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCC3A1A0)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT_REMOVEIGNORERECT_OFFSET UNITYSDK_OFFSET(0xCC39AF0)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT_SETDEFAULTCAMERA_OFFSET UNITYSDK_OFFSET(0xCC398F0)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT_SETIGNORESELF_OFFSET UNITYSDK_OFFSET(0xCC398A0)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xCC39C10)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC3A1F0)
#define RPG_CLIENT_MONOCLICKOUTSIDEDETECT__ISPOINTINIGNORERECT_OFFSET UNITYSDK_OFFSET(0xCC39DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoClickOutsideDetect_TypeDefinitionIndex = 69294;
