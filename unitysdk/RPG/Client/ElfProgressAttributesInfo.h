...
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xC387240)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATEBASECUSTOMERNUMBERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC387B80)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATEBASEDRINKCHANCEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC388C30)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATEBASEEATINGSPEEDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC387DE0)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATEBASEOPERATIONTIMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC3885A0)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATEBASETIPCHANCEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC388450)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATECURRENTDRINKCHANCEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC388D40)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATECURRENTEATINGSPEEDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC387EE0)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATECURRENTOPERATIONTIMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC388690)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATECUSTOMEREATINGSPEEDCLUSTER_OFFSET UNITYSDK_OFFSET(0xC3875E0)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATECUSTOMERNUMBERCLUSTER_OFFSET UNITYSDK_OFFSET(0xC387380)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATEDRINKCLUSTER_OFFSET UNITYSDK_OFFSET(0xC388780)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATEFACILITYCUSTOMERNUMBERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xC387D20)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATERESTAURANTOPERATIONTIMECLUSTER_OFFSET UNITYSDK_OFFSET(0xC387730)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CREATETIPCHANCECLUSTER_OFFSET UNITYSDK_OFFSET(0xC388210)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC387310)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__GETATTRIBUTESSUM_OFFSET UNITYSDK_OFFSET(0xC387A40)
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESINFO__GETCONFIG_OFFSET UNITYSDK_OFFSET(0xC3879B0)
