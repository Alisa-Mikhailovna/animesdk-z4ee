...
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD480360)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_GET_COCOONID_OFFSET UNITYSDK_OFFSET(0xD480B10)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_SAVEDATA_OFFSET UNITYSDK_OFFSET(0xD480420)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_SET_COCOONID_OFFSET UNITYSDK_OFFSET(0xD480B20)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_TRYGETSAVEDATA_OFFSET UNITYSDK_OFFSET(0xD480210)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD480840)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA__INIT_OFFSET UNITYSDK_OFFSET(0xD480880)
