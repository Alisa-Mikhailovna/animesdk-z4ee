...
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATEBYADVPLAYERID_OFFSET UNITYSDK_OFFSET(0xBDD9A10)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xBDD99B0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBDD9900)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ACTIONAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBDDA4D0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVDEFAULTAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBDDB1C0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVENTUREPLAYERROW_OFFSET UNITYSDK_OFFSET(0xBDD9D70)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVPLAYERPREFABPATH_OFFSET UNITYSDK_OFFSET(0xBDDB150)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AUDIOEVENTTAG_OFFSET UNITYSDK_OFFSET(0xBDDB910)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINBGIMGPATH_OFFSET UNITYSDK_OFFSET(0xBDDABF0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINFRONTIMGPATH_OFFSET UNITYSDK_OFFSET(0xBDDAD20)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINIMGPATH_OFFSET UNITYSDK_OFFSET(0xBDDAAC0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTININTROTEXT_OFFSET UNITYSDK_OFFSET(0xBDDAF80)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARDROPOFFSET_OFFSET UNITYSDK_OFFSET(0xBDDAE50)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xBDD9B10)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARMINIICONPATH_OFFSET UNITYSDK_OFFSET(0xBDDA3A0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0xBDDB720)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0xBDD9AD0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSELFSHOWOFFSET_OFFSET UNITYSDK_OFFSET(0xBDDB580)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSIDEICONPATH_OFFSET UNITYSDK_OFFSET(0xBDDA270)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSKINNAME_OFFSET UNITYSDK_OFFSET(0xBDD9EC0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_CHARACTERSKINOVERRIDECONFIGPATH_OFFSET UNITYSDK_OFFSET(0xBDDB8C0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DEFAULTAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBDDA140)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DEFAULTAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0xBDDA010)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DRESSEDSKINID_OFFSET UNITYSDK_OFFSET(0xBDDB360)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DRESSICONPATH_OFFSET UNITYSDK_OFFSET(0xBDDB960)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0xBDD9C40)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_FREESTYLECHARACTERID_OFFSET UNITYSDK_OFFSET(0xBDDB110)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_MANIKINJSONPATH_OFFSET UNITYSDK_OFFSET(0xBDDB230)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_OVERRIDEADVPLAYERID_OFFSET UNITYSDK_OFFSET(0xBDD9AF0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_PLAYERCARDID_OFFSET UNITYSDK_OFFSET(0xBDDB0D0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBDDA860)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINDESC_OFFSET UNITYSDK_OFFSET(0xBDDB6B0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINITEMAVATARICONPATH_OFFSET UNITYSDK_OFFSET(0xBDDB3A0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINTYPE_OFFSET UNITYSDK_OFFSET(0xBDDB870)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_UIAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0xBDDA730)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ULTRASKILLCUTINPREFABPATH_OFFSET UNITYSDK_OFFSET(0xBDDA600)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xBDDA990)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_MAPTOSKINRES_OFFSET UNITYSDK_OFFSET(0xBDDB9B0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_SET_AVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0xBDD9AE0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_SET_OVERRIDEADVPLAYERID_OFFSET UNITYSDK_OFFSET(0xBDD9B00)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD99A0)
