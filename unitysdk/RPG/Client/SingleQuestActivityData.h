...
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_GETQUESTLIST_OFFSET UNITYSDK_OFFSET(0xD515540)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xD5157E0)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0xD515840)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_GET_QUESTLIST_OFFSET UNITYSDK_OFFSET(0xD5152A0)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xD515070)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_UPDATEFULLCOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0xD515320)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xD5158A0)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD514FF0)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA__ONINIT_OFFSET UNITYSDK_OFFSET(0xD515000)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(SingleQuestActivityData_TypeDefinitionIndex)->GetStaticField(0x32D90);
		}
