...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_ENTERSTAGE_OFFSET UNITYSDK_OFFSET(0xD672780)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GETAVAILABLEBRICKIDS_OFFSET UNITYSDK_OFFSET(0xD671F50)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GETBRICKICONPATH_OFFSET UNITYSDK_OFFSET(0xD672060)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GETNEXTBUBBLEDATA_OFFSET UNITYSDK_OFFSET(0xD672440)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_BOSSDATA_OFFSET UNITYSDK_OFFSET(0xD672730)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_BOSSID_OFFSET UNITYSDK_OFFSET(0xD672CB0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_BUBBLEINTERVAL_OFFSET UNITYSDK_OFFSET(0xD673060)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_DEPARTMENTDATA_OFFSET UNITYSDK_OFFSET(0xD673050)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_DEPARTMENTID_OFFSET UNITYSDK_OFFSET(0xD672F80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_HARDSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xD672BB0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_HARDSTAGEHASPASSED_OFFSET UNITYSDK_OFFSET(0xD672E80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_HARDSTARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD673190)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_HARDTABVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6731D0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_HASPASSED_OFFSET UNITYSDK_OFFSET(0xD672D00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_HASSIMPLESTAGE_OFFSET UNITYSDK_OFFSET(0xD671950)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_ISHARDMODE_OFFSET UNITYSDK_OFFSET(0xD672D50)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_ISPVPSTAGE_OFFSET UNITYSDK_OFFSET(0xD672FD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_SHOWABILITYBUTTON_OFFSET UNITYSDK_OFFSET(0xD672F20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_SIMPLESTAGEDATA_OFFSET UNITYSDK_OFFSET(0xD672B00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_SIMPLESTAGEHASPASSED_OFFSET UNITYSDK_OFFSET(0xD672DD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_SIMPLESTARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD673170)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_SIMPLETABVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6731B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_SPECIALRULESTATE_OFFSET UNITYSDK_OFFSET(0xD6730B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_STAGEGROUPID_OFFSET UNITYSDK_OFFSET(0xD672C10)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xD672C60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_STARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD673150)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_GET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0xD6731F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_POPUPNEWDIFFICULTYUNLOCKHINT_OFFSET UNITYSDK_OFFSET(0xD6728A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_REFRESHSTARSVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD672820)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_SETUPBOSSRENDERINGPANEL_OFFSET UNITYSDK_OFFSET(0xD6720F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_SET_HARDSTARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6731A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_SET_HARDTABVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6731E0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_SET_SIMPLESTARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD673180)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_SET_SIMPLETABVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6731C0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_SET_STARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD673160)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_SET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0xD673200)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_SWITCHTOEASY_OFFSET UNITYSDK_OFFSET(0xD671D30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL_SWITCHTOHARD_OFFSET UNITYSDK_OFFSET(0xD671E90)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL__BUILDSTARSVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD6719B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL__BUILDTABVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD671BA0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD6716B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL__POPUPNEWDIFFICULTYDIALOG_OFFSET UNITYSDK_OFFSET(0xD6728F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILVIEWMODEL__SWITCHSTARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD671DF0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersStageDetailViewModel_TypeDefinitionIndex = 75118;

	class TeamTowersStageDetailViewModel : public ::System::Object
	{
	public:
		::RPG::Client::TeamTowers::TeamTowersStageDetailTabViewModel* _SimpleTabViewModel_k__BackingField; // 0x10
		::RPG::Client::TeamTowers::TeamTowersStageGroupData* _StageGroupData; // 0x18
		::RPG::Client::TeamTowers::TeamTowersStageData* _CurrentStageData; // 0x20
		::Class_1_80ED5C578A50E90A* _ResultService; // 0x28
		::RPG::Client::TeamTowers::TeamTowersStageDetailStarsViewModel* _SimpleStarsViewModel_k__BackingField; // 0x30
		::RPG::Client::TeamTowers::TeamTowersStageDetailStarsViewModel* _HardStarsViewModel_k__BackingField; // 0x38
		::RPG::Client::TeamTowers::TeamTowersWindowService* _WindowService_k__BackingField; // 0x40
		::Class_1_B13340E145F0BF93* _GameflowService; // 0x48
		::Class_1_7EEA5E93C4D09894* _Repository; // 0x50
		::Class_1_2069E4ACFE5B6F0E* _DepartmentRow; // 0x58
		::RPG::Client::TeamTowers::TeamTowersStageDetailTabViewModel* _HardTabViewModel_k__BackingField; // 0x60
		::RPG::Client::TeamTowers::TeamTowersDepartmentData* _DepartmentData_k__BackingField; // 0x68
		::RPG::Client::TeamTowers::TeamTowersStageDetailStarsViewModel* _StarsViewModel_k__BackingField; // 0x70
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_5138A02229B03469*>* _BubbleSequenceDict; // 0x78
