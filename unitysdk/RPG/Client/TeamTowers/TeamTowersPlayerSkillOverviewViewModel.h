...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL_GET_PLAYERSKILLGROUPS_OFFSET UNITYSDK_OFFSET(0xD66A410)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL_GET_SELECTEDSKILL_OFFSET UNITYSDK_OFFSET(0xD66A570)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL_REGISTEROVERVIEWREFRESHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD66A0C0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__ADDSKILLGROUP_OFFSET UNITYSDK_OFFSET(0xD66A110)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD669930)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__INITPLAYERSKILLGROUPS_OFFSET UNITYSDK_OFFSET(0xD669A80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__INITPLAYERSKILLS_OFFSET UNITYSDK_OFFSET(0xD669C10)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__ONSELECTEDSKILLCHANGED_OFFSET UNITYSDK_OFFSET(0xD66A380)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersPlayerSkillOverviewViewModel_TypeDefinitionIndex = 75116;

	class TeamTowersPlayerSkillOverviewViewModel : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::TeamTowersPlayerSkillType, ::RPG::Client::TeamTowers::TeamTowersPlayerSkillGroupViewModel*>* _PlayerSkillGroupDict; // 0x10
		::System::Collections::Generic::List_1<::Class_1_47CFC2D7B3865B39*>* _PlayerSkillInfoList; // 0x18
		::RPG::Client::TeamTowers::TeamTowersPlayerSkillViewModel* _SelectedSkill; // 0x20
		::System::Collections::Generic::List_1<::RPG::Client::TeamTowers::TeamTowersPlayerSkillGroupViewModel*>* _PlayerSkillGroups; // 0x28
