...
#define RPG_CLIENT_TEAMTOWERS_MONOTEAMTOWERSBRICK_GETSCREENRECT_OFFSET UNITYSDK_OFFSET(0xD659580)
#define RPG_CLIENT_TEAMTOWERS_MONOTEAMTOWERSBRICK_INIT_OFFSET UNITYSDK_OFFSET(0xD659510)
#define RPG_CLIENT_TEAMTOWERS_MONOTEAMTOWERSBRICK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD659A50)
#define RPG_CLIENT_TEAMTOWERS_MONOTEAMTOWERSBRICK__CTOR_OFFSET UNITYSDK_OFFSET(0xD659AA0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int MonoTeamTowersBrick_TypeDefinitionIndex = 75119;
