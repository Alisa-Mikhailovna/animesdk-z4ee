...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD661180)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL___C__DISPLAYCLASS1_0__UPDATEFRIENDDATA_B__0_OFFSET UNITYSDK_OFFSET(0xD662350)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL___C__DISPLAYCLASS1_0__UPDATEFRIENDDATA_B__1_OFFSET UNITYSDK_OFFSET(0xD662380)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersInviteFriendViewModel___c__DisplayClass1_0_TypeDefinitionIndex = 75098;
