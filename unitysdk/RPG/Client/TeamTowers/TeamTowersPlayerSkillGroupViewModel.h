...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLGROUPVIEWMODEL_ADDSKILLVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6697D0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLGROUPVIEWMODEL_GET_SKILLS_OFFSET UNITYSDK_OFFSET(0xD6698D0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLGROUPVIEWMODEL_GET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0xD6698B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLGROUPVIEWMODEL_SET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0xD6698C0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLGROUPVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD6698E0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersPlayerSkillGroupViewModel_TypeDefinitionIndex = 75115;
