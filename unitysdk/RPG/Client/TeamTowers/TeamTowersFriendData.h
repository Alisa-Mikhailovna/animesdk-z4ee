...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD65A620)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_ENDLESSBESTROUND_OFFSET UNITYSDK_OFFSET(0xD65AC20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_HASENDLESSRECORD_OFFSET UNITYSDK_OFFSET(0xD65ACE0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xD65A910)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_ISMARKED_OFFSET UNITYSDK_OFFSET(0xD65AB60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_ISONLINE_OFFSET UNITYSDK_OFFSET(0xD65AAA0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xD65A8C0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_LOGOUTTIMESPAN_OFFSET UNITYSDK_OFFSET(0xD65AB00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_NICKNAME_OFFSET UNITYSDK_OFFSET(0xD65A860)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_PLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xD65A9B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0xD65AD40)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0xD65ABC0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_UID_OFFSET UNITYSDK_OFFSET(0xD65A810)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_OVERRIDERANK_OFFSET UNITYSDK_OFFSET(0xD65ADA0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD65A610)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersFriendData_TypeDefinitionIndex = 75053;
