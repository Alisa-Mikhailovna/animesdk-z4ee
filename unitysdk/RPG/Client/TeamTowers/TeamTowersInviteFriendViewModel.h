...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_GETFRIENDDATALIST_OFFSET UNITYSDK_OFFSET(0xD661190)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_GETLOBBY_OFFSET UNITYSDK_OFFSET(0xD661B40)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_GETROBOTDATA_OFFSET UNITYSDK_OFFSET(0xD661970)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_GETROBOTIDLIST_OFFSET UNITYSDK_OFFSET(0xD661490)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_INVITEFRIEND_OFFSET UNITYSDK_OFFSET(0xD661A80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_INVITEROBOT_OFFSET UNITYSDK_OFFSET(0xD661AE0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_ISFRIENDINLOBBY_OFFSET UNITYSDK_OFFSET(0xD6619D0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_UPDATEFRIENDDATA_OFFSET UNITYSDK_OFFSET(0xD660E60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL__COMPAREFRIEND_OFFSET UNITYSDK_OFFSET(0xD661C00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD660DA0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersInviteFriendViewModel_TypeDefinitionIndex = 75096;
