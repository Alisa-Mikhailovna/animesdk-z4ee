...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILSTARSVIEWMODEL_GETSTARINFOLIST_OFFSET UNITYSDK_OFFSET(0xD671100)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILSTARSVIEWMODEL_GET_ACHIEVEDCOUNT_OFFSET UNITYSDK_OFFSET(0xD671140)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILSTARSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD66A8D0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersStageDetailStarsViewModel_TypeDefinitionIndex = 75107;
