...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD66EFF0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xD66EFE0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xD66EFC0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD66EFD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD66EF60)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersRobotData_TypeDefinitionIndex = 75062;
