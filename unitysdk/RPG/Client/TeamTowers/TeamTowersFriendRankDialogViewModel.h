...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL_GETFRIENDRANKLIST_OFFSET UNITYSDK_OFFSET(0xD65B0F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL_GETSELFRANKDATA_OFFSET UNITYSDK_OFFSET(0xD65B130)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL_UPDATERANKINGDATA_OFFSET UNITYSDK_OFFSET(0xD65ADF0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL__BUILDFRIENDRANKLIST_OFFSET UNITYSDK_OFFSET(0xD65B170)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD65B660)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersFriendRankDialogViewModel_TypeDefinitionIndex = 75087;
