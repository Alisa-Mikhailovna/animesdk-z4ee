...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGOPTIONVIEWMODEL_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0xD66F500)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGOPTIONVIEWMODEL_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0xD66F540)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGOPTIONVIEWMODEL_GET_OPTIONVALUE_OFFSET UNITYSDK_OFFSET(0xD66F520)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGOPTIONVIEWMODEL_REGISTERCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xD66F360)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGOPTIONVIEWMODEL_SELECT_OFFSET UNITYSDK_OFFSET(0xD66F4A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGOPTIONVIEWMODEL_SET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0xD66F510)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGOPTIONVIEWMODEL_SET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0xD66F550)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGOPTIONVIEWMODEL_SET_OPTIONVALUE_OFFSET UNITYSDK_OFFSET(0xD66F530)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGOPTIONVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD66F560)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersSettingOptionViewModel_TypeDefinitionIndex = 75110;
	...
	public:
		...
		::System::UInt32 _OptionValue_k__BackingField; // 0x1C
