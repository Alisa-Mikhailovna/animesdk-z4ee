...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_GET_DEPARTMENTID_OFFSET UNITYSDK_OFFSET(0xD65A510)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_GET_HASPASSEDALLSUBSTAGEGROUPS_OFFSET UNITYSDK_OFFSET(0xD65A570)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xD65A590)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD65A530)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_GET_STAGEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0xD65A550)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_SET_DEPARTMENTID_OFFSET UNITYSDK_OFFSET(0xD65A520)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_SET_HASPASSEDALLSUBSTAGEGROUPS_OFFSET UNITYSDK_OFFSET(0xD65A580)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xD65A5A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xD65A540)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA_SET_STAGEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0xD65A560)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSDEPARTMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD65A5B0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersDepartmentData_TypeDefinitionIndex = 75061;
	...
	public:
		...
		::System::Boolean _HasPassedAllSubStageGroups_k__BackingField; // 0x1C
