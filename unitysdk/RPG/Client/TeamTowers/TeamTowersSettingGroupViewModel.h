...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGGROUPVIEWMODEL_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0xD66F440)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGGROUPVIEWMODEL_GET_SELECTEDOPTIONVALUE_OFFSET UNITYSDK_OFFSET(0xD66F420)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGGROUPVIEWMODEL_GET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0xD66F400)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGGROUPVIEWMODEL_REGISTERCLICKCALLBACKFOROPTIONS_OFFSET UNITYSDK_OFFSET(0xD66F180)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGGROUPVIEWMODEL_REGISTERGROUPREFRESHCALLBACK_OFFSET UNITYSDK_OFFSET(0xD66F3B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGGROUPVIEWMODEL_SELECTOPTION_OFFSET UNITYSDK_OFFSET(0xD66F000)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGGROUPVIEWMODEL_SET_SELECTEDOPTIONVALUE_OFFSET UNITYSDK_OFFSET(0xD66F430)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGGROUPVIEWMODEL_SET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0xD66F410)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSETTINGGROUPVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD66F450)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersSettingGroupViewModel_TypeDefinitionIndex = 75111;
	...
	public:
		...
		::System::UInt32 _SelectedOptionValue_k__BackingField; // 0x20
