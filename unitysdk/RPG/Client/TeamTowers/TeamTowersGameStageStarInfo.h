...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD65DF00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_INITIALHIDE_OFFSET UNITYSDK_OFFSET(0xD65DFC0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xD65E010)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xD65DF70)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_STARID_OFFSET UNITYSDK_OFFSET(0xD65DEB0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xD65E020)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD65DE70)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersGameStageStarInfo_TypeDefinitionIndex = 75092;
