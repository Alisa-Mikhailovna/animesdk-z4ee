...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBUBBLEDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xD65A500)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBUBBLEDATA_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xD65A4F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBUBBLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD65A450)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersBubbleData_TypeDefinitionIndex = 75052;
