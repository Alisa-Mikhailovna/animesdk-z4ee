...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTARSVIEWMODEL_GETSTARVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD65E370)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTARSVIEWMODEL_REFRESH_OFFSET UNITYSDK_OFFSET(0xD65E040)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTARSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD65E030)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTARSVIEWMODEL__INITSTARVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD65E3D0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersGameStarsViewModel_TypeDefinitionIndex = 75093;
