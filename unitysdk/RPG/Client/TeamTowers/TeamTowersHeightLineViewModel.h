...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_GET_CURHEIGHT_OFFSET UNITYSDK_OFFSET(0xD65D720)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_GET_TARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0xD660D80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_GET__PLAYERENTITY_OFFSET UNITYSDK_OFFSET(0xD660D10)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_ISSKILLLINE_OFFSET UNITYSDK_OFFSET(0xD660C30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_SET_TARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0xD660D90)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD65CA70)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersHeightLineViewModel_TypeDefinitionIndex = 75095;
