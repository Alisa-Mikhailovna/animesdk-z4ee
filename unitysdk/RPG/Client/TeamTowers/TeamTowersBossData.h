...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSDATA_GET_BOSSID_OFFSET UNITYSDK_OFFSET(0xD659F60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSDATA_GET_BOSSSKILLDATALIST_OFFSET UNITYSDK_OFFSET(0xD659FD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSDATA_GET_BOSSSKILLGROUPID_OFFSET UNITYSDK_OFFSET(0xD659FC0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSDATA_GET_BUBBLEGROUPID_OFFSET UNITYSDK_OFFSET(0xD659FB0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD659F80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xD659F90)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD659F70)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSDATA_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0xD659FA0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD659AB0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersBossData_TypeDefinitionIndex = 75050;

	class TeamTowersBossData : public ::System::Object
	{
	public:
		::System::String* _PrefabPath_k__BackingField; // 0x10
		::System::Collections::Generic::List_1<::RPG::Client::TeamTowers::TeamTowersBossSkillData*>* _BossSkillDataList_k__BackingField; // 0x18
		::System::String* _ImagePath_k__BackingField; // 0x20
		::System::UInt32 _BossID_k__BackingField; // 0x28
		::System::UInt32 _BubbleGroupID_k__BackingField; // 0x2C
		::RPG::Client::TextID _Name_k__BackingField; // 0x30
		::System::UInt32 _BossSkillGroupID_k__BackingField; // 0x40
