...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENLOBBYPAGE_OFFSET UNITYSDK_OFFSET(0xD669220)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENSETTINGDIALOG_OFFSET UNITYSDK_OFFSET(0xD673680)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENSKILLDIALOG_OFFSET UNITYSDK_OFFSET(0xD673570)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENSTAGEDETAILPAGE_OFFSET UNITYSDK_OFFSET(0xD6733B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_SHOWRECONNECTCONFIRM_OFFSET UNITYSDK_OFFSET(0xD669540)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xD6733A0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersWindowService_TypeDefinitionIndex = 75085;
