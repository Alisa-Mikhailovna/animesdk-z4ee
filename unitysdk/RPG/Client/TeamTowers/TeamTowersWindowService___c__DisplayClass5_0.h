...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD673790)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE___C__DISPLAYCLASS5_0__SHOWRECONNECTCONFIRM_B__0_OFFSET UNITYSDK_OFFSET(0xD6737A0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersWindowService___c__DisplayClass5_0_TypeDefinitionIndex = 75086;
