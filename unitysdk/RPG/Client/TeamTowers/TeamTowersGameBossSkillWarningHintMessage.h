...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD65BAF0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD65BA30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_ISICE_OFFSET UNITYSDK_OFFSET(0xD65BC00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_ISWIND_OFFSET UNITYSDK_OFFSET(0xD65BBB0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD65BA80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xD65BB60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xD65B9F0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersGameBossSkillWarningHintMessage_TypeDefinitionIndex = 75042;
