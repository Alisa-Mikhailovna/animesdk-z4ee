...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_GET_NEEDPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0xD671340)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_GET_STAGEDATA_OFFSET UNITYSDK_OFFSET(0xD671310)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_GET_STARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD671320)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_MARKUNLOCKANIMASSEEN_OFFSET UNITYSDK_OFFSET(0xD6714E0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_SET_STARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD671330)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD671300)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersStageDetailTabViewModel_TypeDefinitionIndex = 75109;
