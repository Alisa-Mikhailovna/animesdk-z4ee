...
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD0AF2F0)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA_GETUIPROGRESS_OFFSET UNITYSDK_OFFSET(0xD0AF730)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xD0AFA90)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA_SET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xD0AFAA0)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0AF3C0)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA__GETTOTALUIRATIOCOUNT_OFFSET UNITYSDK_OFFSET(0xD0AF870)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA__INIT_OFFSET UNITYSDK_OFFSET(0xD0AF410)
