...
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD0F6E0)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_METHOD_5_1752943C8EA15AFA_OFFSET UNITYSDK_OFFSET(0xCD0F810)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_METHOD_5_4AF2A5D5BDF9E39E_OFFSET UNITYSDK_OFFSET(0xCD0F9E0)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_METHOD_5_F16FCAE680E5B284_OFFSET UNITYSDK_OFFSET(0xCD0F940)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD0F880)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD__CTOR_OFFSET UNITYSDK_OFFSET(0xCD0FBC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoNodeSwitchByGamepad_TypeDefinitionIndex = 69513;
