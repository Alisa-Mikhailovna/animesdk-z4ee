...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGETTRAITGAMESTATE_GET_GETTRAITLIST_OFFSET UNITYSDK_OFFSET(0xBB26B50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGETTRAITGAMESTATE_GET_STATETYPE_OFFSET UNITYSDK_OFFSET(0xBB26440)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGETTRAITGAMESTATE_RPG_CLIENT_ACTIVITYHIPPLEN_IACTIVITYHIPPLENGAMESTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0xBB269B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGETTRAITGAMESTATE_RPG_CLIENT_ACTIVITYHIPPLEN_IACTIVITYHIPPLENGAMESTATE_ONFINISH_OFFSET UNITYSDK_OFFSET(0xBB26B00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGETTRAITGAMESTATE_SET_GETTRAITLIST_OFFSET UNITYSDK_OFFSET(0xBB26B60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGETTRAITGAMESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xBB26490)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenGetTraitGameState_TypeDefinitionIndex = 71909;
