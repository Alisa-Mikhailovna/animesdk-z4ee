...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBB24190)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_ENTERGAME_OFFSET UNITYSDK_OFFSET(0xBB24ED0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_EXITGAME_OFFSET UNITYSDK_OFFSET(0xBB24320)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_FINISHGAMESTATE_OFFSET UNITYSDK_OFFSET(0xBB259D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_GET_EFFECTCALCULATOR_OFFSET UNITYSDK_OFFSET(0xBB26030)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_GET_GAMECYCLEDATA_OFFSET UNITYSDK_OFFSET(0xBB26050)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_GET_GAMESTATEMGR_OFFSET UNITYSDK_OFFSET(0xBB25FD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_GET_MAINCTRL_OFFSET UNITYSDK_OFFSET(0xBB26070)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_GET_PERFORMANCEMGR_OFFSET UNITYSDK_OFFSET(0xBB26010)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_GET_ROUTINEMGR_OFFSET UNITYSDK_OFFSET(0xBB25FF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_GET_STARTNEWPHASE_OFFSET UNITYSDK_OFFSET(0xBB26090)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_INIT_OFFSET UNITYSDK_OFFSET(0xBB23D70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_ISINTRIAL_OFFSET UNITYSDK_OFFSET(0xBB25860)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0xBB24C40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_SET_EFFECTCALCULATOR_OFFSET UNITYSDK_OFFSET(0xBB26040)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_SET_GAMECYCLEDATA_OFFSET UNITYSDK_OFFSET(0xBB26060)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_SET_GAMESTATEMGR_OFFSET UNITYSDK_OFFSET(0xBB25FE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_SET_MAINCTRL_OFFSET UNITYSDK_OFFSET(0xBB26080)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_SET_PERFORMANCEMGR_OFFSET UNITYSDK_OFFSET(0xBB26020)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_SET_ROUTINEMGR_OFFSET UNITYSDK_OFFSET(0xBB26000)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_SET_STARTNEWPHASE_OFFSET UNITYSDK_OFFSET(0xBB260A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE_SYNC_OFFSET UNITYSDK_OFFSET(0xBB24500)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGAMEINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xBB23D60)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenGameInstance_TypeDefinitionIndex = 71867;
