...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_GAMEJSONPATH_OFFSET UNITYSDK_OFFSET(0xBB3D0C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBB3CF90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_TRIALROW_OFFSET UNITYSDK_OFFSET(0xBB3CFB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_TRIALTITLE_OFFSET UNITYSDK_OFFSET(0xBB3CFD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBB3D070)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xBB3CFA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_SET_TRIALROW_OFFSET UNITYSDK_OFFSET(0xBB3CFC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB38A10)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenTrialData_TypeDefinitionIndex = 72003;
