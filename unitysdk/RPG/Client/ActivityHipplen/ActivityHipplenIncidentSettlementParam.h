...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_DIALOGID_OFFSET UNITYSDK_OFFSET(0xBB27E10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xBB27E00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_ISRANDOM_OFFSET UNITYSDK_OFFSET(0xBB27E20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_ISSUCC_OFFSET UNITYSDK_OFFSET(0xBB27E30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xBB27BE0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenIncidentSettlementParam_TypeDefinitionIndex = 71937;
