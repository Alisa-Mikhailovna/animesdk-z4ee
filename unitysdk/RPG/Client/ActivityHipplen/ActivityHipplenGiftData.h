...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA_GET_GIFTSHOWTEXT_OFFSET UNITYSDK_OFFSET(0xBB26C20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA_GET_GIFTSHOWTITLE_OFFSET UNITYSDK_OFFSET(0xBB26BB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xBB26C90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB26B70)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenGiftData_TypeDefinitionIndex = 71869;
