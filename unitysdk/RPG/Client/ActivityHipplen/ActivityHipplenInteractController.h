...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_ADDPROGRESS_OFFSET UNITYSDK_OFFSET(0xBB2B320)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBB292C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_ENDINTERACT_OFFSET UNITYSDK_OFFSET(0xBB2A140)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_FINISH_OFFSET UNITYSDK_OFFSET(0xBB2B730)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETHINTTEXTID_OFFSET UNITYSDK_OFFSET(0xBB29A80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETINTERACTPROPS_OFFSET UNITYSDK_OFFSET(0xBB29560)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETINTERACTPROPTRANSFORM_OFFSET UNITYSDK_OFFSET(0xBB291B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETINTERACT_OFFSET UNITYSDK_OFFSET(0xBB2BDC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETISLASTINTERACTVALID_OFFSET UNITYSDK_OFFSET(0xBB29280)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_CANRESTART_OFFSET UNITYSDK_OFFSET(0xBB2BF30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_CANROTATECAMERA_OFFSET UNITYSDK_OFFSET(0xBB2BF80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_CURINTERACTPROP_OFFSET UNITYSDK_OFFSET(0xBB2BEC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_MAINCTRLREF_OFFSET UNITYSDK_OFFSET(0xBB2BF10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xBB285F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xBB2BE00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0xBB2B9C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REGISTERCOMPLETEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xBB29160)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REGISTERINTERACTSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xBB29110)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REGISTERPROGRESSCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xBB290C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REPORT_OFFSET UNITYSDK_OFFSET(0xBB2BD10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_RESTART_OFFSET UNITYSDK_OFFSET(0xBB2BA60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_RESUME_OFFSET UNITYSDK_OFFSET(0xBB2BA10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_SETINTERACTTRIGGERNAME_OFFSET UNITYSDK_OFFSET(0xBB2A3C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_SET_CANROTATECAMERA_OFFSET UNITYSDK_OFFSET(0xBB2BF90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_SET_MAINCTRLREF_OFFSET UNITYSDK_OFFSET(0xBB2BF20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_STARTINTERACT_OFFSET UNITYSDK_OFFSET(0xBB29B50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xBB28460)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_UPDATEINTERACTPREFABLOCATION_OFFSET UNITYSDK_OFFSET(0xBB2A450)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_UPDATEINTERACTVALIDSTATE_OFFSET UNITYSDK_OFFSET(0xBB2B7C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBB2BFE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__CLEAR_OFFSET UNITYSDK_OFFSET(0xBB2A240)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB2BFA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__GETPROGRESSINCREASERATIO_OFFSET UNITYSDK_OFFSET(0xBB2B560)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__GETSHAKEPARAMS_OFFSET UNITYSDK_OFFSET(0xBB2A960)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xBB29ED0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__ONINTERACTVALIDSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xBB2B810)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__UPDATEINTERACTPREFABPOSITION_OFFSET UNITYSDK_OFFSET(0xBB2AA90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__UPDATEINTERACTPREFABROTATION_OFFSET UNITYSDK_OFFSET(0xBB2ACD0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenInteractController_TypeDefinitionIndex = 71967;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ActivityHipplenInteractController_TypeDefinitionIndex)->GetStaticField(0x8CC0);
		}
