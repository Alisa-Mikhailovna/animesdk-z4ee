...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_CREATECOMMITOPTION_OFFSET UNITYSDK_OFFSET(0xBB27900)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_CREATERANDOMOPTION_OFFSET UNITYSDK_OFFSET(0xBB27A70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_CREATESETTLEMENTPARAM_OFFSET UNITYSDK_OFFSET(0xBB27B40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_GET_DIALOGID_OFFSET UNITYSDK_OFFSET(0xBB27880)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_GET_ISRANDOM_OFFSET UNITYSDK_OFFSET(0xBB27860)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_GET_ISSUCC_OFFSET UNITYSDK_OFFSET(0xBB278E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_GET_RATIOLIST_OFFSET UNITYSDK_OFFSET(0xBB278C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_GET_SETTLEMENTID_OFFSET UNITYSDK_OFFSET(0xBB27810)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_GET_WEIGHTLIST_OFFSET UNITYSDK_OFFSET(0xBB278A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_SET_DIALOGID_OFFSET UNITYSDK_OFFSET(0xBB27890)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_SET_ISRANDOM_OFFSET UNITYSDK_OFFSET(0xBB27870)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_SET_ISSUCC_OFFSET UNITYSDK_OFFSET(0xBB278F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_SET_RATIOLIST_OFFSET UNITYSDK_OFFSET(0xBB278D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION_SET_WEIGHTLIST_OFFSET UNITYSDK_OFFSET(0xBB278B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0xBB27A60)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenIncidentOption_TypeDefinitionIndex = 71942;
