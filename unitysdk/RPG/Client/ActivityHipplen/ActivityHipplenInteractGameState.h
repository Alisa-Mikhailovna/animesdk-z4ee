...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBB2C520)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_DOSETTLEINTERACT_OFFSET UNITYSDK_OFFSET(0xBB2C360)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_GET_INTERACTIONROW_OFFSET UNITYSDK_OFFSET(0xBB2CB00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_GET_INTERACTTYPE_OFFSET UNITYSDK_OFFSET(0xBB2CB80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_GET_STATETYPE_OFFSET UNITYSDK_OFFSET(0xBB2C130)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_ONFINISH_OFFSET UNITYSDK_OFFSET(0xBB2C2F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_ONREALENTER_OFFSET UNITYSDK_OFFSET(0xBB2C180)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_SET_INTERACTTYPE_OFFSET UNITYSDK_OFFSET(0xBB2CB90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xBB2C0C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE__ONCLIENTUNLOCKTRAITS_OFFSET UNITYSDK_OFFSET(0xBB2C5E0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenInteractGameState_TypeDefinitionIndex = 71911;
