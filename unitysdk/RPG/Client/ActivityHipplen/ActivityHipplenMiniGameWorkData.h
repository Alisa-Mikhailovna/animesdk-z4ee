...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEWORKDATA_GET_GRADEEFFECTSDICT_OFFSET UNITYSDK_OFFSET(0xBB345E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEWORKDATA_GET_GRADEEFFECTVIEWDATADICT_OFFSET UNITYSDK_OFFSET(0xBB34600)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEWORKDATA_SET_GRADEEFFECTSDICT_OFFSET UNITYSDK_OFFSET(0xBB345F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEWORKDATA_SET_GRADEEFFECTVIEWDATADICT_OFFSET UNITYSDK_OFFSET(0xBB34610)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEWORKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB33EF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEWORKDATA__INITWORKEFFECTS_OFFSET UNITYSDK_OFFSET(0xBB33F00)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenMiniGameWorkData_TypeDefinitionIndex = 72006;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::HipplenGameGradeType, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1198*>*>* _GradeEffectsDict_k__BackingField; // 0x38
