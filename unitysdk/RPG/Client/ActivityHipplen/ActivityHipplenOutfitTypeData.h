...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENOUTFITTYPEDATA_GET_ICONCHECKPATH_OFFSET UNITYSDK_OFFSET(0xBB366A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENOUTFITTYPEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBB36650)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENOUTFITTYPEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBB365E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENOUTFITTYPEDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBB36590)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENOUTFITTYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB361C0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenOutfitTypeData_TypeDefinitionIndex = 71903;
