...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_CALCULATEEFFECTVIEWDATABYROUTINE_OFFSET UNITYSDK_OFFSET(0xBB39300)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBB24410)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_GETEMPTYBLOCKNUM_OFFSET UNITYSDK_OFFSET(0xBB39920)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_GETFILTERSELECTABLEWORKLIST_OFFSET UNITYSDK_OFFSET(0xBB39CC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_GETPROGRESSINGWORKLISTWITHEMPTYBLOCK_OFFSET UNITYSDK_OFFSET(0xBB395E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_GETSORTEDSELECTABLEWORKLIST_OFFSET UNITYSDK_OFFSET(0xBB39B40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_GET_EXTRAWORKDATA_OFFSET UNITYSDK_OFFSET(0xBB39E30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_GET_PROGRESSINGWORKLIST_OFFSET UNITYSDK_OFFSET(0xBB39E10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_GET_ROUTINE_OFFSET UNITYSDK_OFFSET(0xBB39DD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_GET_SELECTABLEWORKLIST_OFFSET UNITYSDK_OFFSET(0xBB39DF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_GET_TRIALDATA_OFFSET UNITYSDK_OFFSET(0xBB39E50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xBB24030)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_SETANDSTARTROUTINE_OFFSET UNITYSDK_OFFSET(0xBB39090)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_SET_EXTRAWORKDATA_OFFSET UNITYSDK_OFFSET(0xBB39E40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_SET_PROGRESSINGWORKLIST_OFFSET UNITYSDK_OFFSET(0xBB39E20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_SET_ROUTINE_OFFSET UNITYSDK_OFFSET(0xBB39DE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_SET_SELECTABLEWORKLIST_OFFSET UNITYSDK_OFFSET(0xBB39E00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_SET_TRIALDATA_OFFSET UNITYSDK_OFFSET(0xBB39E60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_TRYGETNEXTPROGRESSINGWORK_OFFSET UNITYSDK_OFFSET(0xBB252E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_TRYPUSHNEXTPROGRESSINGWORKSTATE_OFFSET UNITYSDK_OFFSET(0xBB253F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_UPDATEAGENDA_OFFSET UNITYSDK_OFFSET(0xBB24580)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_UPDATEALLWORKVIEWDATA_OFFSET UNITYSDK_OFFSET(0xBB37A10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER_UPDATEPROGRESSINGWORKLIST_OFFSET UNITYSDK_OFFSET(0xBB38A50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENROUTINEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB24020)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenRoutineManager_TypeDefinitionIndex = 72000;
