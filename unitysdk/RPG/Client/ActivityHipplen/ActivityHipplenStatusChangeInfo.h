...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_GETSTATCONFIG_OFFSET UNITYSDK_OFFSET(0xBB3B810)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xBB3B870)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_GET_STATTYPE_OFFSET UNITYSDK_OFFSET(0xBB3B890)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_SET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xBB3B880)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_SET_STATTYPE_OFFSET UNITYSDK_OFFSET(0xBB3B8A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xBB3B7E0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenStatusChangeInfo_TypeDefinitionIndex = 71874;
