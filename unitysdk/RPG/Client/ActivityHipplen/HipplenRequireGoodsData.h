...
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_CURNUM_OFFSET UNITYSDK_OFFSET(0xBB4D790)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_DISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xBB4D250)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_FADETIME_OFFSET UNITYSDK_OFFSET(0xBB4D2A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBB4D6F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBB48FA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_REQUIRENUM_OFFSET UNITYSDK_OFFSET(0xBB48FF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_SET_CURNUM_OFFSET UNITYSDK_OFFSET(0xBB4D7A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB4C030)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int HipplenRequireGoodsData_TypeDefinitionIndex = 71989;
