...
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_COLLECTCOLLIDERS_OFFSET UNITYSDK_OFFSET(0xBB4E370)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_DISABLEALLCOLLIDERS_OFFSET UNITYSDK_OFFSET(0xBB4DC20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_INIT_OFFSET UNITYSDK_OFFSET(0xBB4DA70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_ISBALLFETCHCOLLIDER_OFFSET UNITYSDK_OFFSET(0xBB4E4E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_ISINTERACTCOLLIDER_OFFSET UNITYSDK_OFFSET(0xBB4E450)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_ISMOUTHCOLLIDER_OFFSET UNITYSDK_OFFSET(0xBB4E570)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_LOOKAT_OFFSET UNITYSDK_OFFSET(0xBB4DD50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_OVERRIDELOOKATTRANSITION_OFFSET UNITYSDK_OFFSET(0xBB4E0C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_RESETLOOKATTRANSITION_OFFSET UNITYSDK_OFFSET(0xBB4E190)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_RESETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0xBB4E040)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_SETBALLFETCHCOLLIDERENABLED_OFFSET UNITYSDK_OFFSET(0xBB4E710)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0xBB4DE80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_SETMOUTHCOLLIDERENABLED_OFFSET UNITYSDK_OFFSET(0xBB4E6A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_SETNECKIKENABLED_OFFSET UNITYSDK_OFFSET(0xBB4E310)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_SETNECKIKTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0xBB4E270)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_SETNECKIKTIPBONE_OFFSET UNITYSDK_OFFSET(0xBB4E5E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_STOPLOOKAT_OFFSET UNITYSDK_OFFSET(0xBB4DE20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_TICK_OFFSET UNITYSDK_OFFSET(0xBB4D7B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN__CTOR_OFFSET UNITYSDK_OFFSET(0xBB4E7F0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int MonoBabyHipplen_TypeDefinitionIndex = 71994;
