...
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBB294A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xBB28DD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBB448F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_1C4DCEC4A71E9244_OFFSET UNITYSDK_OFFSET(0xBB45660)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_2C95AFAD0256302F_1_OFFSET UNITYSDK_OFFSET(0xBB44D80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0xBB44C10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_7C7377C794E8973C_1_OFFSET UNITYSDK_OFFSET(0xBB45010)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_7C7377C794E8973C_OFFSET UNITYSDK_OFFSET(0xBB44EF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xBB45700)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xBB449C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_EA3847E5520B6A95_OFFSET UNITYSDK_OFFSET(0xBB453C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xBB2BCB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB45760)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int HipplenInteractCameraController_TypeDefinitionIndex = 71972;
