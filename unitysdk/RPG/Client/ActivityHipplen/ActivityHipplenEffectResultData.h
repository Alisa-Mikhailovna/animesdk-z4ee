...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_ADD_OFFSET UNITYSDK_OFFSET(0xBB1FC70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_CEILTOINT_OFFSET UNITYSDK_OFFSET(0xBB1DA30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xBB1DFA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_GETVIEWDATABYTYPE_OFFSET UNITYSDK_OFFSET(0xBB20840)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_GETVIEWDATA_OFFSET UNITYSDK_OFFSET(0xBB209B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_RESET_OFFSET UNITYSDK_OFFSET(0xBB1D930)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB1E5B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA__GETHIPPLENSTATTYPEORDER_OFFSET UNITYSDK_OFFSET(0xBB20E90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA__GETVIEWDATA_B__5_0_OFFSET UNITYSDK_OFFSET(0xBB20EF0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenEffectResultData_TypeDefinitionIndex = 71883;
