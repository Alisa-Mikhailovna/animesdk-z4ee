...
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENMOVINGGOODSINPUTDATA_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xBB457C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENMOVINGGOODSINPUTDATA_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0xBB457E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENMOVINGGOODSINPUTDATA_GET_REQUIREINPUT_OFFSET UNITYSDK_OFFSET(0xBB457A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENMOVINGGOODSINPUTDATA_SET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xBB457D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENMOVINGGOODSINPUTDATA_SET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0xBB457F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENMOVINGGOODSINPUTDATA_SET_REQUIREINPUT_OFFSET UNITYSDK_OFFSET(0xBB457B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENMOVINGGOODSINPUTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB45800)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int HipplenMovingGoodsInputData_TypeDefinitionIndex = 71983;
