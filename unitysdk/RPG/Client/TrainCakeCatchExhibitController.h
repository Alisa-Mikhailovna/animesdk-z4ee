...
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD6E06B0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_GETCATGROUNDS_OFFSET UNITYSDK_OFFSET(0xD6E1840)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_GETCATTREE_OFFSET UNITYSDK_OFFSET(0xD6E1880)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_GETGROUNDANCHORPOS_OFFSET UNITYSDK_OFFSET(0xD6E1430)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_GETTREEANCHORPOS_OFFSET UNITYSDK_OFFSET(0xD6E1640)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_ONPROPCREATE_OFFSET UNITYSDK_OFFSET(0xD6E0CA0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_ONSAVE_OFFSET UNITYSDK_OFFSET(0xD6E17F0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_SETCATGROUNDCAT_OFFSET UNITYSDK_OFFSET(0xD6E1290)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_SETCATGROUNDTYPE_OFFSET UNITYSDK_OFFSET(0xD6E1170)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_SETCATTREECAT_OFFSET UNITYSDK_OFFSET(0xD6E1030)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_SETCATTREETYPE_OFFSET UNITYSDK_OFFSET(0xD6E0DA0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_SETSELECTEDCAT_OFFSET UNITYSDK_OFFSET(0xD6E18C0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xD6E0970)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_TRIGGERCATCHANGEEFFECT_OFFSET UNITYSDK_OFFSET(0xD6E1B10)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD6E4240)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__CREATECAT_OFFSET UNITYSDK_OFFSET(0xD6E20F0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6DF4F0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__DESPAWNCATOUTLINEROOT_OFFSET UNITYSDK_OFFSET(0xD6E08C0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__DESPAWNTRANSCAT_OFFSET UNITYSDK_OFFSET(0xD6E2830)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__DESTROYCAT_OFFSET UNITYSDK_OFFSET(0xD6E2300)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__DISPOSECATGROUNDS_OFFSET UNITYSDK_OFFSET(0xD6E0820)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__DISPOSECATTREE_OFFSET UNITYSDK_OFFSET(0xD6E07C0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__FINDCAT_OFFSET UNITYSDK_OFFSET(0xD6E19D0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__GETLEVELAREAMANAGER_OFFSET UNITYSDK_OFFSET(0xD6E2640)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCATGROUNDS_OFFSET UNITYSDK_OFFSET(0xD6DF750)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCATTREE_OFFSET UNITYSDK_OFFSET(0xD6DF6D0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCONSTVALUE_CATEFFECT_OFFSET UNITYSDK_OFFSET(0xD6E37C0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCONSTVALUE_CATSIZE_OFFSET UNITYSDK_OFFSET(0xD6E2AC0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCONSTVALUE_CATTREEATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xD6E3530)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCONSTVALUE_CATTREECHANGETYPEEVENT_OFFSET UNITYSDK_OFFSET(0xD6E3030)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCONSTVALUE_CATTREEGROUPINSTANCEID_OFFSET UNITYSDK_OFFSET(0xD6E3280)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCONSTVALUE_GROUNDANCHOR_OFFSET UNITYSDK_OFFSET(0xD6E2C50)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCONSTVALUE_GROUNDSAVELERPTIME_OFFSET UNITYSDK_OFFSET(0xD6E2F10)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCONSTVALUE_OFFSET UNITYSDK_OFFSET(0xD6DF650)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__INITCONSTVALUE_VOICECD_OFFSET UNITYSDK_OFFSET(0xD6E3B90)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__ONCURRENTREGIONENTER_OFFSET UNITYSDK_OFFSET(0xD6E00D0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__ONCURRENTREGIONLEAVE_OFFSET UNITYSDK_OFFSET(0xD6E04B0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__REFRESHCATSONREGIONCHANGE_OFFSET UNITYSDK_OFFSET(0xD6E0350)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__REGISTERREGIONCALLBACK_OFFSET UNITYSDK_OFFSET(0xD6DFF30)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__RESETVOICETIMER_OFFSET UNITYSDK_OFFSET(0xD6DFEC0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__SPAWNCATOUTLINEROOT_OFFSET UNITYSDK_OFFSET(0xD6E28E0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__SPAWNTRANSCAT_OFFSET UNITYSDK_OFFSET(0xD6E26C0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__TICKVOICE_OFFSET UNITYSDK_OFFSET(0xD6E0B10)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__TRIGGERENTITYEVENT_OFFSET UNITYSDK_OFFSET(0xD6E2440)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__TRIGGERVOICERANDOM_OFFSET UNITYSDK_OFFSET(0xD6E3E40)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER__UNREGISTERREGIONCALLBACK_OFFSET UNITYSDK_OFFSET(0xD6E0200)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(TrainCakeCatchExhibitController_TypeDefinitionIndex)->GetStaticField(0xB220);
		}
		...
		::RPG::Client::TrainCakeCatchGameModule* _GameModule; // 0x10
		::RPG::OutlinePostFXMonoPlugin* _CatOutlineRoot; // 0x18
		::System::String* _GroundAreaName; // 0x20
		::Il2CppArray<::System::String*>* _GroundAnchorNames; // 0x28
		::Il2CppArray<::System::String*>* _CatTreeAttachPoints; // 0x30
		::RPG::Client::TrainCakeCatchExhibitController_CatTree* _CatTree; // 0x38
		::System::Collections::Generic::Dictionary_2<::RPG::Client::TrainCakeCatchExhibitController_CatTreeType, ::System::String*>* _CatTreeTypeToEntityEvent; // 0x40
		::RPG::Client::TrainCakeCatchExhibitController_Cat* _SelectedCat; // 0x48
		::System::String* _CatTreeChangeTypeEventDefault; // 0x50
		::Il2CppArray<::RPG::Client::TrainCakeCatchExhibitController_CatGround*>* _CatGrounds; // 0x58
		...
		::System::Collections::Generic::List_1<::RPG::Client::TrainCakeCatchExhibitController_Cat*>* _TempVoiceCatList; // 0x68
		::System::String* _EffectPathCatChange; // 0x70
		::System::String* _CatTreeChangeTypeEventGodGift; // 0x78
		::UnityEngine::Color _CatOutlineColor; // 0x80
		::System::Boolean _IsInRegion; // 0x90
		::System::UInt32 _CatTreeGroupID; // 0x94
		::System::Single _CatHeight; // 0x98
		::System::Single _GroundSaveLerpTime; // 0x9C
		::System::Single _VoiceCDMin; // 0xA0
