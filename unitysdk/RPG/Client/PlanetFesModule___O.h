...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::IPlanetFesBuff*, ::RPG::Client::PlanetFesActiveBuff*>**)Il2CppClass::FromTypeDefinitionIndex(PlanetFesModule___O_TypeDefinitionIndex)->GetStaticField(0x69130);
		}
	};
}
