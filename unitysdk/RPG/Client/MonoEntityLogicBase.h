...
#define RPG_CLIENT_MONOENTITYLOGICBASE_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0xCCE0A30)
#define RPG_CLIENT_MONOENTITYLOGICBASE_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0xCCE0AC0)
#define RPG_CLIENT_MONOENTITYLOGICBASE_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0xCCE0B00)
#define RPG_CLIENT_MONOENTITYLOGICBASE_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0xCCE0A80)
#define RPG_CLIENT_MONOENTITYLOGICBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE0B60)
