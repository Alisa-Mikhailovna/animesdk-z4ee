...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xC3187F0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xC3190A0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_1BC539462B1DCAB4_OFFSET UNITYSDK_OFFSET(0xC314FE0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_20CE56A09BD72B81_OFFSET UNITYSDK_OFFSET(0xC318E60)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_36E2D900C7A8E114_OFFSET UNITYSDK_OFFSET(0xC3198E0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xC316C30)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xC316AB0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xC316B10)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xC316B70)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xC316BD0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0xC316C70)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC314F70)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_8B5E3014AFF7F8EA_OFFSET UNITYSDK_OFFSET(0xC315030)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_A21BBA85D4EF7B41_OFFSET UNITYSDK_OFFSET(0xC316D30)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_B9117CCE8BC70D96_OFFSET UNITYSDK_OFFSET(0xC318830)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xC316CD0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC319EA0)
