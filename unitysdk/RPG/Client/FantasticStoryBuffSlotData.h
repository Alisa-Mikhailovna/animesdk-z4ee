...
#define RPG_CLIENT_FANTASTICSTORYBUFFSLOTDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xC43B100)
#define RPG_CLIENT_FANTASTICSTORYBUFFSLOTDATA_GET_UNLOCKCHAPTERID_OFFSET UNITYSDK_OFFSET(0xC43D480)
#define RPG_CLIENT_FANTASTICSTORYBUFFSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC43A080)
