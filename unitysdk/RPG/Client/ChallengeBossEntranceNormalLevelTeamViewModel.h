...
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xBF7FAC0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBF7FB50)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GETLINEUP_OFFSET UNITYSDK_OFFSET(0xBF7FB90)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_BOSSICONPATH_OFFSET UNITYSDK_OFFSET(0xBF7F8D0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_ISPASSED_OFFSET UNITYSDK_OFFSET(0xBF7FA60)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_SCORE_OFFSET UNITYSDK_OFFSET(0xBF7F9E0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_STAGENUMBER_OFFSET UNITYSDK_OFFSET(0xBF7F6D0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__MONSTERID_OFFSET UNITYSDK_OFFSET(0xBF7F710)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__MONSTERROW_OFFSET UNITYSDK_OFFSET(0xBF7F7A0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__MONSTERTEMPLATEROW_OFFSET UNITYSDK_OFFSET(0xBF7F810)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__NODEINFO_OFFSET UNITYSDK_OFFSET(0xBF7F930)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF7FB40)
