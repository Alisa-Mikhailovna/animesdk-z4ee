...
#define RPG_CLIENT_GAMECORECAMERADATA_GETENEMYTEAMFORMATION_OFFSET UNITYSDK_OFFSET(0xC679EA0)
#define RPG_CLIENT_GAMECORECAMERADATA_GETFRIENDTEAMFORMATION_OFFSET UNITYSDK_OFFSET(0xC679E40)
#define RPG_CLIENT_GAMECORECAMERADATA_GET_NATIVETIMESCALE_OFFSET UNITYSDK_OFFSET(0xC679E20)
#define RPG_CLIENT_GAMECORECAMERADATA_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0xC679B40)
#define RPG_CLIENT_GAMECORECAMERADATA_SET_NATIVETIMESCALE_OFFSET UNITYSDK_OFFSET(0xC679E30)
#define RPG_CLIENT_GAMECORECAMERADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC679F00)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::GameCore::SkillCharacterComponent* ActiveEntitySkillCharacterRef; // 0x10
		::RPG::GameCore::SkillData* ActiveSkillDataRef; // 0x18
		::RPG::GameCore::GameEntity* LightTeamEntityRef; // 0x20
		::RPG::GameCore::GameEntity* ActiveEntityRef; // 0x28
		::RPG::GameCore::GameEntity* DarkTeamEntityRef; // 0x30
		::RPG::GameCore::TeamDataComponent* LightTeamDataComponentRef; // 0x38
		::RPG::GameCore::CharacterDataComponent* ActiveEntityCharacterDataRef; // 0x40
		::RPG::GameCore::TeamDataComponent* DarkTeamDataComponentRef; // 0x48
		::RPG::GameCore::GameWorld* GameWorldRef; // 0x50
		::RPG::GameCore::TeamFormationComponent* LightTeamFormationRef; // 0x58
		...
		::RPG::GameCore::TurnBasedAbilityComponent* ActiveEntityTurnBasedAbilityRef; // 0x80
		::RPG::GameCore::TurnBasedAbilityComponent* TargetEntityTurnBasedAbilityRef; // 0x88
		::RPG::GameCore::SkillConfig* ActiveSkillConfigRef; // 0x90
		::RPG::GameCore::CharacterDataComponent* TargetEntityCharacterDataRef; // 0x98
		::Class_1_1CB8CBC69B962B41* CurrentActiveInsertAbilityRef; // 0xA0
		::RPG::GameCore::GameEntity* TargetEntityRef; // 0xA8
