...
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_COMPARETO_OFFSET UNITYSDK_OFFSET(0xCB81830)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCB81760)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_BENEFITDESC_OFFSET UNITYSDK_OFFSET(0xCB813C0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_BENEFITREWARDID_OFFSET UNITYSDK_OFFSET(0xCB815C0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_BGICONPATH_OFFSET UNITYSDK_OFFSET(0xCB81520)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_CHALLENGERS_OFFSET UNITYSDK_OFFSET(0xCB81660)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_FGICONPATH_OFFSET UNITYSDK_OFFSET(0xCB81480)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_SIGNIFICANCE_OFFSET UNITYSDK_OFFSET(0xCB7DB80)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_TABNAME_OFFSET UNITYSDK_OFFSET(0xCB81300)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xCB81240)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_TOTALCHALLENGERCOUNT_OFFSET UNITYSDK_OFFSET(0xCB81670)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCB811E0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_MARKSEEN_OFFSET UNITYSDK_OFFSET(0xCB818A0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCB816C0)
