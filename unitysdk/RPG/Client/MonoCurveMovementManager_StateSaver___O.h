...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::NotifyHandler**)Il2CppClass::FromTypeDefinitionIndex(MonoCurveMovementManager_StateSaver___O_TypeDefinitionIndex)->GetStaticField(0x56D70);
		}
	};
}
