...
#define RPG_CLIENT_RESIDENTSPACEZOOACTIVITYDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xD330950)
#define RPG_CLIENT_RESIDENTSPACEZOOACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xD330820)
#define RPG_CLIENT_RESIDENTSPACEZOOACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD330810)
#define RPG_CLIENT_RESIDENTSPACEZOOACTIVITYDATA__ISPOINTREWARDFINISH_OFFSET UNITYSDK_OFFSET(0xD3308A0)
