...
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC40810)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCC42030)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_DRIVEMOVEMENTHANDLERBYOBJECT_OFFSET UNITYSDK_OFFSET(0xCC3EF20)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_FINDMOVABLEOBJECT_OFFSET UNITYSDK_OFFSET(0xCC3E960)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_GETMOVEMENTHANDLERS_OFFSET UNITYSDK_OFFSET(0xCC3E5E0)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_INITMANAGER_OFFSET UNITYSDK_OFFSET(0xCC3E3B0)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_ISALLMOVEMENTHANDLERCOMPLETED_OFFSET UNITYSDK_OFFSET(0xCC3E7C0)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_ISANYMOVEMENTHANDLERMOVING_OFFSET UNITYSDK_OFFSET(0xCC3E620)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_METHOD_5_9941963216461BE2_OFFSET UNITYSDK_OFFSET(0xCC424E0)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_METHOD_5_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0xCC3E590)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCC42330)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_ONMOVEEND_OFFSET UNITYSDK_OFFSET(0xCC3FB70)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_ONMOVEMENTHANDLERDETECTCOLLIDER_OFFSET UNITYSDK_OFFSET(0xCC3F850)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_ONMOVEMENTHANDLERENTERIDLESTATE_OFFSET UNITYSDK_OFFSET(0xCC3FAF0)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_ONMOVEMENTHANDLERFINISHMOVING_OFFSET UNITYSDK_OFFSET(0xCC3F640)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_ONMOVEMENTHANDLERSTARTMOVING_OFFSET UNITYSDK_OFFSET(0xCC3F5A0)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_ONMOVEMENTHANDLERUNABLETOMOVING_OFFSET UNITYSDK_OFFSET(0xCC3F700)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_REPORTLOGCARINFO_OFFSET UNITYSDK_OFFSET(0xCC3FBC0)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_REPORTLOGMINEINFO_OFFSET UNITYSDK_OFFSET(0xCC40130)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_REPORTLOGTRACKINFO_OFFSET UNITYSDK_OFFSET(0xCC40490)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_START_OFFSET UNITYSDK_OFFSET(0xCC40D80)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCC41B30)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCC429D0)
#define RPG_CLIENT_MONOCURVEMOVEMENTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC42900)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::Client::MonoCurveMovementManager_StateSaver*>**)Il2CppClass::FromTypeDefinitionIndex(MonoCurveMovementManager_TypeDefinitionIndex)->GetStaticField(0x56D30);
		}
