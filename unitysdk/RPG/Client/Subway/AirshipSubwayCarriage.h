...
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_1B9EFB8F22728CB8_OFFSET UNITYSDK_OFFSET(0xD57C650)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_21FBC382EA5ECE99_1_OFFSET UNITYSDK_OFFSET(0xD57C570)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_21FBC382EA5ECE99_OFFSET UNITYSDK_OFFSET(0xD57C490)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xD57A7E0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_44AC3F3C85C7CAA3_OFFSET UNITYSDK_OFFSET(0xD57B8D0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xD57A8F0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_6747250BC2D13457_OFFSET UNITYSDK_OFFSET(0xD57C7A0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_B69A6865F8BEDF36_OFFSET UNITYSDK_OFFSET(0xD57CB40)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0xD57A970)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_C0342BA270C91EF6_OFFSET UNITYSDK_OFFSET(0xD57BFA0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_F59E20BA9BC23BFE_OFFSET UNITYSDK_OFFSET(0xD57C080)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_FDDF7B7E329390B7_OFFSET UNITYSDK_OFFSET(0xD57BB20)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD57C990)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD57C950)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xD57C9D0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xD57D080)

namespace RPG::Client::Subway
{
	inline static constexpr unsigned int AirshipSubwayCarriage_TypeDefinitionIndex = 76781;
