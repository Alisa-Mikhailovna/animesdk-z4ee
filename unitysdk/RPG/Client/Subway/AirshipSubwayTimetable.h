...
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_FIND_OFFSET UNITYSDK_OFFSET(0xD57E460)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_GET_OFFSET UNITYSDK_OFFSET(0xD57E3D0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_GET_TABLECOUNT_OFFSET UNITYSDK_OFFSET(0xD57E370)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xD57E520)

namespace RPG::Client::Subway
{
	inline static constexpr unsigned int AirshipSubwayTimetable_TypeDefinitionIndex = 76797;
