...
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE__GENERATEPOINTSINAREACOROUTINE_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD57D130)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE__GENERATEPOINTSINAREACOROUTINE_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD57DDD0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE__GENERATEPOINTSINAREACOROUTINE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD57DE30)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE__GENERATEPOINTSINAREACOROUTINE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD57DDE0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE__GENERATEPOINTSINAREACOROUTINE_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD57D120)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE__GENERATEPOINTSINAREACOROUTINE_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0xD57BF90)

namespace RPG::Client::Subway
{
	inline static constexpr unsigned int AirshipSubwayCarriage__GeneratePointsInAreaCoroutine_d__15_TypeDefinitionIndex = 76783;
	...
	public:
		...
		::System::Int32 _frameAttemptCount_5__5; // 0x44
