...
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL_CREATE_OFFSET UNITYSDK_OFFSET(0xC403C50)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL_GET_SEASON_OFFSET UNITYSDK_OFFSET(0xC404910)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL_GET__MODULE_OFFSET UNITYSDK_OFFSET(0xC404930)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL_SET_SEASON_OFFSET UNITYSDK_OFFSET(0xC404920)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__CREATELEVELDATA_OFFSET UNITYSDK_OFFSET(0xC4043F0)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0xC403DA0)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__REFRESHFORGEDETAILS_OFFSET UNITYSDK_OFFSET(0xC403E60)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__REFRESHMIXDETAILS_OFFSET UNITYSDK_OFFSET(0xC404000)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__REFRESHWEAPONDETAILS_OFFSET UNITYSDK_OFFSET(0xC4044B0)
