...
#define RPG_CLIENT_MONODANMUCONTROLLER_ADDSEQUENCE_OFFSET UNITYSDK_OFFSET(0xCC49700)
#define RPG_CLIENT_MONODANMUCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0xCC49800)
#define RPG_CLIENT_MONODANMUCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xCC496B0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0xCC49ED0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_04DB6A076713051C_OFFSET UNITYSDK_OFFSET(0xCC4B6E0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_07280B24DFAC0CA9_OFFSET UNITYSDK_OFFSET(0xCC49020)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_12A5B534813F3445_OFFSET UNITYSDK_OFFSET(0xCC4AAC0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xCC4AB30)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_1D4B81334E4490D3_OFFSET UNITYSDK_OFFSET(0xCC4A260)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_2E4E9C95DDAA0B10_OFFSET UNITYSDK_OFFSET(0xCC4ABA0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_3415D88EE6078A04_OFFSET UNITYSDK_OFFSET(0xCC4A8E0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_348674E9BAD074BA_OFFSET UNITYSDK_OFFSET(0xCC4A750)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0xCC493F0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xCC4AC80)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_44CCBF5B25F21E3A_OFFSET UNITYSDK_OFFSET(0xCC4B480)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0xCC4A140)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xCC49640)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_871F6AAF8C0E80CC_OFFSET UNITYSDK_OFFSET(0xCC4B1E0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_B6C6410B1FEA0BB3_OFFSET UNITYSDK_OFFSET(0xCC4A190)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_CD762BD492FAC131_OFFSET UNITYSDK_OFFSET(0xCC49D80)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_D549E229DFA00CC6_OFFSET UNITYSDK_OFFSET(0xCC4AD80)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_D9899AB38F7BA87E_OFFSET UNITYSDK_OFFSET(0xCC4A840)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_DD784213055292FB_OFFSET UNITYSDK_OFFSET(0xCC49FA0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_F82AD9CF5EEF353D_OFFSET UNITYSDK_OFFSET(0xCC4A500)
#define RPG_CLIENT_MONODANMUCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCC48E90)
#define RPG_CLIENT_MONODANMUCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCC48D80)
#define RPG_CLIENT_MONODANMUCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCC48FA0)
#define RPG_CLIENT_MONODANMUCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC4B750)
