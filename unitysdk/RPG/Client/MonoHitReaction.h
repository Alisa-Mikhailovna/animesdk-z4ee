...
#define RPG_CLIENT_MONOHITREACTION_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xCCF2160)
#define RPG_CLIENT_MONOHITREACTION_START_OFFSET UNITYSDK_OFFSET(0xCCF2100)
#define RPG_CLIENT_MONOHITREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCCF21B0)
