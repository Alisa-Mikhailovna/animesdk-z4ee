...
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC835FC0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_IGRIDFIGHTTRAITEFFECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xC836640)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_IGRIDFIGHTTRAITEFFECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC8365D0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xC8366C0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC836630)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC8365E0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC835DD0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74__CTOR_OFFSET UNITYSDK_OFFSET(0xC8353D0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xC835FB0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0xC835EB0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::IEnumerator_1<::RPG::Client::IGridFightTraitEffect*>* __7__wrap3; // 0x10
		::RPG::Client::IGridFightTraitEffect* __2__current; // 0x18
		::RPG::Client::GridFightTrait* __4__this; // 0x20
		::RPG::Client::IGridFightTraitEffect* _effect_5__3; // 0x28
