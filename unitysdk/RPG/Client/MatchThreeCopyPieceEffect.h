...
#define RPG_CLIENT_MATCHTHREECOPYPIECEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCB43050)
#define RPG_CLIENT_MATCHTHREECOPYPIECEEFFECT_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xCB43660)
#define RPG_CLIENT_MATCHTHREECOPYPIECEEFFECT_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xCB43570)
#define RPG_CLIENT_MATCHTHREECOPYPIECEEFFECT_METHOD_5_B71F1B35165C7818_OFFSET UNITYSDK_OFFSET(0xCB42CA0)
#define RPG_CLIENT_MATCHTHREECOPYPIECEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xCB43090)
#define RPG_CLIENT_MATCHTHREECOPYPIECEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xCB3C200)
#define RPG_CLIENT_MATCHTHREECOPYPIECEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCB43010)
#define RPG_CLIENT_MATCHTHREECOPYPIECEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCB43780)
