...
#define RPG_CLIENT_RELICPRESETMODEL_CREATERELICPRESETAPPLYDETAIL_OFFSET UNITYSDK_OFFSET(0xD2F1B30)
#define RPG_CLIENT_RELICPRESETMODEL_CREATERELICPRESETSAVEDIALOG_OFFSET UNITYSDK_OFFSET(0xD2F1890)
#define RPG_CLIENT_RELICPRESETMODEL_CREATERELICPRESETSAVEVIEWMODELBYPLANDATA_OFFSET UNITYSDK_OFFSET(0xD2F1D00)
#define RPG_CLIENT_RELICPRESETMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD2F1190)
#define RPG_CLIENT_RELICPRESETMODEL_GETAVATARRELICPRESETPLAN_OFFSET UNITYSDK_OFFSET(0xD2EC7B0)
#define RPG_CLIENT_RELICPRESETMODEL_GETORCREATEAVATARPLANS_OFFSET UNITYSDK_OFFSET(0xD2F16A0)
#define RPG_CLIENT_RELICPRESETMODEL_INIT_OFFSET UNITYSDK_OFFSET(0xD2F1150)
#define RPG_CLIENT_RELICPRESETMODEL_ISAVATARPLANFULL_OFFSET UNITYSDK_OFFSET(0xD2F15E0)
#define RPG_CLIENT_RELICPRESETMODEL_SETAVATARPLANS_OFFSET UNITYSDK_OFFSET(0xD2F17D0)
#define RPG_CLIENT_RELICPRESETMODEL_TRYFINDPLANBYUNIQUEID_OFFSET UNITYSDK_OFFSET(0xD2F13D0)
#define RPG_CLIENT_RELICPRESETMODEL_TRYGETPLANS_OFFSET UNITYSDK_OFFSET(0xD2ED680)
#define RPG_CLIENT_RELICPRESETMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD2F1E60)
