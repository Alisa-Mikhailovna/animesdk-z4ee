...
#define RPG_CLIENT_GLOBALDISPATCHDATA_SERVERDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC68FFE0)
#define RPG_CLIENT_GLOBALDISPATCHDATA_SERVERDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC690010)
#define RPG_CLIENT_GLOBALDISPATCHDATA_SERVERDATA___C__SETDISPATCHURLS_B__2_0_OFFSET UNITYSDK_OFFSET(0xC690020)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::System::String*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(GlobalDispatchData_ServerData___c_TypeDefinitionIndex)->GetStaticField(0x1D6A0);
		}
		static ::RPG::Client::GlobalDispatchData_ServerData___c** StaticGet___9()
		{
			return (::RPG::Client::GlobalDispatchData_ServerData___c**)Il2CppClass::FromTypeDefinitionIndex(GlobalDispatchData_ServerData___c_TypeDefinitionIndex)->GetStaticField(0x1D6A8);
		}
