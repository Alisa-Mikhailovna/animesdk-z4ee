...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_DISABLEVISUALRENDERER_OFFSET UNITYSDK_OFFSET(0xCE1F5F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_ENABLEVISUALRENDERER_OFFSET UNITYSDK_OFFSET(0xCE1F5B0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_ONCHANGEMUSICINDEX_OFFSET UNITYSDK_OFFSET(0xCE1F260)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_ONCHANGEMUSICSTATE_OFFSET UNITYSDK_OFFSET(0xCE1F2B0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_ONCURRENTMUSICSTART_OFFSET UNITYSDK_OFFSET(0xCE1F630)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_ONCURRENTMUSICWILLEND_OFFSET UNITYSDK_OFFSET(0xCE1F690)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_ONLODCHANGING_OFFSET UNITYSDK_OFFSET(0xCE1F6F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0xCE1F730)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0xCE1F970)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_PAUSEVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0xCE1F570)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_PLAYVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0xCE1F530)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_REGIST_OFFSET UNITYSDK_OFFSET(0xCE1DB80)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_TICKEVENT_OFFSET UNITYSDK_OFFSET(0xCE1F4E0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_TICKMUSICCUE_OFFSET UNITYSDK_OFFSET(0xCE1F430)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_TICKPERBAR_OFFSET UNITYSDK_OFFSET(0xCE1F370)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_TICKPERBEAT_OFFSET UNITYSDK_OFFSET(0xCE1F310)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_TICKPERGRID_OFFSET UNITYSDK_OFFSET(0xCE1F3D0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_TICK_OFFSET UNITYSDK_OFFSET(0xCE1F480)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE_UNREGIST_OFFSET UNITYSDK_OFFSET(0xCE1E200)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE1F250)
