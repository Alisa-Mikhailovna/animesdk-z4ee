...
#define RPG_CLIENT_IRIRUNTIMESTATE_INIT_OFFSET UNITYSDK_OFFSET(0xC8C8110)
#define RPG_CLIENT_IRIRUNTIMESTATE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC8C80B0)
#define RPG_CLIENT_IRIRUNTIMESTATE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC8C8050)
#define RPG_CLIENT_IRIRUNTIMESTATE_UNINIT_OFFSET UNITYSDK_OFFSET(0xC8C8180)
#define RPG_CLIENT_IRIRUNTIMESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C81D0)
