...
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT___C__DISPLAYCLASS51_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC7A8390)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT___C__DISPLAYCLASS51_0___GETCURROLEOPTIONSFROMTEAM_B__0_OFFSET UNITYSDK_OFFSET(0xC7A8820)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::UInt32 partnerTraitID; // 0x10
		::System::UInt32 excludeRoleID; // 0x14
