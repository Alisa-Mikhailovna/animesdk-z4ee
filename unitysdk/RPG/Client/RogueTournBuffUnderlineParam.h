...
#define RPG_CLIENT_ROGUETOURNBUFFUNDERLINEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xD412160)
#define RPG_CLIENT_ROGUETOURNBUFFUNDERLINEPARAM_EQUALS_OFFSET UNITYSDK_OFFSET(0xD412090)
#define RPG_CLIENT_ROGUETOURNBUFFUNDERLINEPARAM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD412010)
#define RPG_CLIENT_ROGUETOURNBUFFUNDERLINEPARAM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD411F10)
#define RPG_CLIENT_ROGUETOURNBUFFUNDERLINEPARAM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD411F70)
#define RPG_CLIENT_ROGUETOURNBUFFUNDERLINEPARAM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xD411EC0)
#define RPG_CLIENT_ROGUETOURNBUFFUNDERLINEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD4121E0)
