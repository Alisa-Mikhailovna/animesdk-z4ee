...
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCB45070)
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT_METHOD_5_6C3DD9E920C4AD10_OFFSET UNITYSDK_OFFSET(0xCB44A20)
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xCB45570)
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xCB450B0)
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT_PLAYFROMPOSITIONTOPOSITION_OFFSET UNITYSDK_OFFSET(0xCB44F40)
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT_PLAYFROMPOSITION_OFFSET UNITYSDK_OFFSET(0xCB44D60)
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT_PLAYTOPOSITION_OFFSET UNITYSDK_OFFSET(0xCB44E50)
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xCB44830)
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCB45030)
#define RPG_CLIENT_MATCHTHREEFLASHEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCB45640)
