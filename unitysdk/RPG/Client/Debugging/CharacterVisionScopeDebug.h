...
#define RPG_CLIENT_DEBUGGING_CHARACTERVISIONSCOPEDEBUG_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC1DCEB0)
#define RPG_CLIENT_DEBUGGING_CHARACTERVISIONSCOPEDEBUG_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC1DCF20)
#define RPG_CLIENT_DEBUGGING_CHARACTERVISIONSCOPEDEBUG_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xC1DCD80)
#define RPG_CLIENT_DEBUGGING_CHARACTERVISIONSCOPEDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DCFF0)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int CharacterVisionScopeDebug_TypeDefinitionIndex = 76709;
