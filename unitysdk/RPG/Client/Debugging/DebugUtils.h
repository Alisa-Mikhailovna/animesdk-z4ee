...
#define RPG_CLIENT_DEBUGGING_DEBUGUTILS_DRAWSTRING_OFFSET UNITYSDK_OFFSET(0xC1DD0C0)
#define RPG_CLIENT_DEBUGGING_DEBUGUTILS_METHOD_5_CFAA1B02F36ADD7B_OFFSET UNITYSDK_OFFSET(0xC1DD0E0)
#define RPG_CLIENT_DEBUGGING_DEBUGUTILS_METHOD_5_EFC9F5E801B244B0_OFFSET UNITYSDK_OFFSET(0xC1DD190)
#define RPG_CLIENT_DEBUGGING_DEBUGUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DD230)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int DebugUtils_TypeDefinitionIndex = 76712;
