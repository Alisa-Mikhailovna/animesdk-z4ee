...
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_GET_OFFSETX_OFFSET UNITYSDK_OFFSET(0xC1DD010)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_GET_OFFSETY_OFFSET UNITYSDK_OFFSET(0xC1DD030)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_GET_TEXTCOLOR_OFFSET UNITYSDK_OFFSET(0xC1DD050)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xC1DD080)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_SET_OFFSETX_OFFSET UNITYSDK_OFFSET(0xC1DD020)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_SET_OFFSETY_OFFSET UNITYSDK_OFFSET(0xC1DD040)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_SET_TEXTCOLOR_OFFSET UNITYSDK_OFFSET(0xC1DD060)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0xC1DD070)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DD0D0)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int DebugHudText_TypeDefinitionIndex = 76711;
