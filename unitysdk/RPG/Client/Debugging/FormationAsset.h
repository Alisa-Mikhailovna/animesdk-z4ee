...
#define RPG_CLIENT_DEBUGGING_FORMATIONASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DD240)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int FormationAsset_TypeDefinitionIndex = 76708;
