...
#define RPG_CLIENT_DEBUGGING_LOCATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DD2A0)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int LocationData_TypeDefinitionIndex = 76706;
