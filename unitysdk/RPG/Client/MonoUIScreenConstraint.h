...
#define RPG_CLIENT_MONOUISCREENCONSTRAINT_CALCULATECONSTRAINTOFFSET_OFFSET UNITYSDK_OFFSET(0xCD3B990)
#define RPG_CLIENT_MONOUISCREENCONSTRAINT_CONSTRAINTOSCREEN_OFFSET UNITYSDK_OFFSET(0xCD3B1D0)
#define RPG_CLIENT_MONOUISCREENCONSTRAINT_ENABLECONTINUOUSCONSTRAINT_OFFSET UNITYSDK_OFFSET(0xCD3BB60)
#define RPG_CLIENT_MONOUISCREENCONSTRAINT_GETSCREENBOUNDS_OFFSET UNITYSDK_OFFSET(0xCD3B530)
#define RPG_CLIENT_MONOUISCREENCONSTRAINT_GETUIELEMENTBOUNDS_OFFSET UNITYSDK_OFFSET(0xCD3B800)
#define RPG_CLIENT_MONOUISCREENCONSTRAINT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xCD3AEB0)
#define RPG_CLIENT_MONOUISCREENCONSTRAINT_SETCONSTRAINTSETTINGS_OFFSET UNITYSDK_OFFSET(0xCD3BB00)
#define RPG_CLIENT_MONOUISCREENCONSTRAINT_START_OFFSET UNITYSDK_OFFSET(0xCD3AE50)
#define RPG_CLIENT_MONOUISCREENCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3BBB0)
