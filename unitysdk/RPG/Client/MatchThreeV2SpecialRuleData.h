...
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_CREATEBYCONSTVALUE_OFFSET UNITYSDK_OFFSET(0xCB83D90)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCB83CA0)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xCB83BE0)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCB83B40)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xCB83AD0)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_GET_RULEID_OFFSET UNITYSDK_OFFSET(0xCB83B30)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_INIT_OFFSET UNITYSDK_OFFSET(0xCB83D50)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCB83D40)
