...
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_CABINETICONPATH_OFFSET UNITYSDK_OFFSET(0xC0E9830)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_DIMENSIONINCREMENTSCONFIGARRAY_OFFSET UNITYSDK_OFFSET(0xC0E9A40)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xC0E95A0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_IPDESC_OFFSET UNITYSDK_OFFSET(0xC0E99D0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xC0E9F20)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0xC0E9F80)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xC0E9B70)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_MISSIONDESCPARAMS_OFFSET UNITYSDK_OFFSET(0xC0E9970)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_MISSIONDESC_OFFSET UNITYSDK_OFFSET(0xC0E9900)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_QUESTDATA_OFFSET UNITYSDK_OFFSET(0xC0E9750)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0xC0E96F0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_REQUIREDUNLOCKCABINETID_OFFSET UNITYSDK_OFFSET(0xC0E9690)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xC0E9AA0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ROW_OFFSET UNITYSDK_OFFSET(0xC0E95E0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_SORTPARAM_OFFSET UNITYSDK_OFFSET(0xC0E9490)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xC0E9890)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC0E93D0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC0E92F0)
