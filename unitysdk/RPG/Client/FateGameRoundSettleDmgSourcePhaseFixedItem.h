...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC465560)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xC4653E0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM_GET__PHASEROW_OFFSET UNITYSDK_OFFSET(0xC465380)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC464F10)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM__GETPHASEFIXEDDAMAGE_OFFSET UNITYSDK_OFFSET(0xC464F30)
