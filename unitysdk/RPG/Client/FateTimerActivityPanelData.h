...
#define RPG_CLIENT_FATETIMERACTIVITYPANELDATA_CHECKANDMARKMISSINGVIDEO_OFFSET UNITYSDK_OFFSET(0xC5BC300)
#define RPG_CLIENT_FATETIMERACTIVITYPANELDATA_GETVIDEOIDCURRENTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xC5BBEE0)
#define RPG_CLIENT_FATETIMERACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC5BBED0)
