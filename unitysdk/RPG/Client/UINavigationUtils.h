...
#define RPG_CLIENT_UINAVIGATIONUTILS_BUILDHORIZONTALNAVIGATION_OFFSET UNITYSDK_OFFSET(0xD7EABE0)
#define RPG_CLIENT_UINAVIGATIONUTILS_BUILDVERTICALNAVIGATION_OFFSET UNITYSDK_OFFSET(0xD7EA620)
#define RPG_CLIENT_UINAVIGATIONUTILS_CLICKBUTTONBYKEYINPUT_OFFSET UNITYSDK_OFFSET(0xD7EB2F0)
#define RPG_CLIENT_UINAVIGATIONUTILS_CLICKBUTTON_OFFSET UNITYSDK_OFFSET(0xD7EB410)
#define RPG_CLIENT_UINAVIGATIONUTILS_CLICKGAMEOBJECTBYKEYINPUT_OFFSET UNITYSDK_OFFSET(0xD7EB1B0)
#define RPG_CLIENT_UINAVIGATIONUTILS_FINDSELECTABLEBYDIRECTION_OFFSET UNITYSDK_OFFSET(0xD7EB7F0)
#define RPG_CLIENT_UINAVIGATIONUTILS_FINDSELECTABLEBYKEYINPUT_OFFSET UNITYSDK_OFFSET(0xD7EB360)
#define RPG_CLIENT_UINAVIGATIONUTILS_GETMOVEDIRECTIONBYKEYINPUT_OFFSET UNITYSDK_OFFSET(0xD7EB780)
#define RPG_CLIENT_UINAVIGATIONUTILS_GETVALIDTARGET_OFFSET UNITYSDK_OFFSET(0xD7EA580)
#define RPG_CLIENT_UINAVIGATIONUTILS_SETAUTONAVIGATIONANDOVERRIDE_OFFSET UNITYSDK_OFFSET(0xD7E9FA0)

namespace RPG::Client
{
	inline static constexpr unsigned int UINavigationUtils_TypeDefinitionIndex = 69822;
