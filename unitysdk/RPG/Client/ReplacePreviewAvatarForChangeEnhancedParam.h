...
#define RPG_CLIENT_REPLACEPREVIEWAVATARFORCHANGEENHANCEDPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xD3298D0)
#define RPG_CLIENT_REPLACEPREVIEWAVATARFORCHANGEENHANCEDPARAM_GET_NEWAVATAR_OFFSET UNITYSDK_OFFSET(0xD3298B0)
#define RPG_CLIENT_REPLACEPREVIEWAVATARFORCHANGEENHANCEDPARAM_GET_ORIGINAVATAR_OFFSET UNITYSDK_OFFSET(0xD329890)
#define RPG_CLIENT_REPLACEPREVIEWAVATARFORCHANGEENHANCEDPARAM_SET_NEWAVATAR_OFFSET UNITYSDK_OFFSET(0xD3298C0)
#define RPG_CLIENT_REPLACEPREVIEWAVATARFORCHANGEENHANCEDPARAM_SET_ORIGINAVATAR_OFFSET UNITYSDK_OFFSET(0xD3298A0)
#define RPG_CLIENT_REPLACEPREVIEWAVATARFORCHANGEENHANCEDPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD329950)
