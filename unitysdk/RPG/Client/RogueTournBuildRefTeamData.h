...
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0xD4220B0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD4224A0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA_GET_MEMBERCANDIDATES_OFFSET UNITYSDK_OFFSET(0xD422510)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD421E30)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD421DF0)
