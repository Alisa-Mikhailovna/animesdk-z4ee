...
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_CREATEALL_OFFSET UNITYSDK_OFFSET(0xBF81C80)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_HINTTIERCEFINAL_OFFSET UNITYSDK_OFFSET(0xBF81C60)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_MONSTERLEVEL_OFFSET UNITYSDK_OFFSET(0xBF81C40)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_RECOMMENDDAMAGETYPES_OFFSET UNITYSDK_OFFSET(0xBF81C50)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_SET_HINTTIERCEFINAL_OFFSET UNITYSDK_OFFSET(0xBF81C70)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATENORMAL_OFFSET UNITYSDK_OFFSET(0xBF81D30)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATETIERCE_OFFSET UNITYSDK_OFFSET(0xBF81EE0)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF81ED0)
