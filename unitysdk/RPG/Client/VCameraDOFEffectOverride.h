...
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_METHOD_5_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0xD8437B0)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xD843660)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_ONACTIVEVCAMERA_OFFSET UNITYSDK_OFFSET(0xD843E90)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD843590)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_ONDISACTIVEVCAMERA_OFFSET UNITYSDK_OFFSET(0xD843EE0)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD843490)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD8435E0)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xD843F30)
