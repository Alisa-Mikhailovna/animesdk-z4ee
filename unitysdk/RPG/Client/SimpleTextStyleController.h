...
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_APPLYSTYLE_OFFSET UNITYSDK_OFFSET(0xD50FB10)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD50F980)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_GET_SIMPLETEXT_OFFSET UNITYSDK_OFFSET(0xD50F8D0)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_SETOUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0xD50FAA0)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_SETSTYLE_OFFSET UNITYSDK_OFFSET(0xD50F9D0)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD50FB60)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpleTextStyleController_TypeDefinitionIndex = 68858;
