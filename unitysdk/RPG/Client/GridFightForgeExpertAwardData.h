...
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA_GET_COINNUM_OFFSET UNITYSDK_OFFSET(0xC710710)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA_GET_ROLE_OFFSET UNITYSDK_OFFSET(0xC710730)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA_SET_COINNUM_OFFSET UNITYSDK_OFFSET(0xC710720)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA_SET_ROLE_OFFSET UNITYSDK_OFFSET(0xC710740)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA__BUILDROLE_OFFSET UNITYSDK_OFFSET(0xC710370)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC7102A0)
