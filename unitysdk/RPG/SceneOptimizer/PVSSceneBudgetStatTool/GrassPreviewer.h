...
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_CLEAR_OFFSET UNITYSDK_OFFSET(0xDC72B90)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_EXECUTE_OFFSET UNITYSDK_OFFSET(0xDC72A70)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_GET_KEY_OFFSET UNITYSDK_OFFSET(0xDC72A60)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDC72C50)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDC72BE0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_REGISTER_OFFSET UNITYSDK_OFFSET(0xDC72AF0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC72CC0)
