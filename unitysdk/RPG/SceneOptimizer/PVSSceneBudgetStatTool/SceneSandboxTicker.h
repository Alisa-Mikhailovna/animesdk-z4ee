...
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_SCENESANDBOXTICKER_REGISTERNEXTFRAME_OFFSET UNITYSDK_OFFSET(0xDC73FB0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_SCENESANDBOXTICKER_REGISTERTICK_OFFSET UNITYSDK_OFFSET(0xDC73E30)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_SCENESANDBOXTICKER_UNREGISTERTICK_OFFSET UNITYSDK_OFFSET(0xDC73F40)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_SCENESANDBOXTICKER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDC74070)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_SCENESANDBOXTICKER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC74460)
