...
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_EXECUTE_OFFSET UNITYSDK_OFFSET(0xDC727A0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_GET_KEY_OFFSET UNITYSDK_OFFSET(0xDC72700)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDC729E0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_REGISTER_OFFSET UNITYSDK_OFFSET(0xDC72710)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDC72820)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC72A50)
