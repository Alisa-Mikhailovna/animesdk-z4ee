...
#define RPG_STRUTILS_CHARATINDEXTOCACHEDSTRING_OFFSET UNITYSDK_OFFSET(0x1BB03160)
#define RPG_STRUTILS_CONCATWITHSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1BB02830)
#define RPG_STRUTILS_CONCAT_1_OFFSET UNITYSDK_OFFSET(0x1BB02660)
#define RPG_STRUTILS_CONCAT_2_OFFSET UNITYSDK_OFFSET(0x1BB026C0)
#define RPG_STRUTILS_CONCAT_3_OFFSET UNITYSDK_OFFSET(0x1BB02730)
#define RPG_STRUTILS_CONCAT_4_OFFSET UNITYSDK_OFFSET(0x1BB027B0)
#define RPG_STRUTILS_CONCAT_5_OFFSET UNITYSDK_OFFSET(0x1BB02A40)
#define RPG_STRUTILS_CONCAT_6_OFFSET UNITYSDK_OFFSET(0x1BB02AA0)
#define RPG_STRUTILS_CONCAT_7_OFFSET UNITYSDK_OFFSET(0x1BB02B10)
#define RPG_STRUTILS_CONCAT_8_OFFSET UNITYSDK_OFFSET(0x1BB02B90)
#define RPG_STRUTILS_CONCAT_9_OFFSET UNITYSDK_OFFSET(0x1BB02C30)
#define RPG_STRUTILS_CONCAT_OFFSET UNITYSDK_OFFSET(0x1BB02610)
#define RPG_STRUTILS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1BB03350)
#define RPG_STRUTILS_ENDSWITHOPT_OFFSET UNITYSDK_OFFSET(0x1BB035A0)
#define RPG_STRUTILS_FORMATBYPROVIDER_OFFSET UNITYSDK_OFFSET(0x1BB02470)
#define RPG_STRUTILS_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x1BB024E0)
#define RPG_STRUTILS_FORMAT_2_OFFSET UNITYSDK_OFFSET(0x1BB02550)
#define RPG_STRUTILS_FORMAT_3_OFFSET UNITYSDK_OFFSET(0x1BB025D0)
#define RPG_STRUTILS_FORMAT_OFFSET UNITYSDK_OFFSET(0x1BB02400)
#define RPG_STRUTILS_GETBUILDER_OFFSET UNITYSDK_OFFSET(0x1BB02250)
#define RPG_STRUTILS_GETSTABLEHASH_OFFSET UNITYSDK_OFFSET(0x1BB039F0)
#define RPG_STRUTILS_INTERNSTRING_OFFSET UNITYSDK_OFFSET(0x1BB03140)
#define RPG_STRUTILS_INTERN_OFFSET UNITYSDK_OFFSET(0x1BB03130)
#define RPG_STRUTILS_STARTSWITHOPT_OFFSET UNITYSDK_OFFSET(0x1BB03390)
#define RPG_STRUTILS_SUBSTRINGAFTERLAST_OFFSET UNITYSDK_OFFSET(0x1BB03AC0)
#define RPG_STRUTILS_SUBSTRINGLAST_OFFSET UNITYSDK_OFFSET(0x1BB03B10)
#define RPG_STRUTILS_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1BB02D50)
#define RPG_STRUTILS_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x1BB02DD0)
#define RPG_STRUTILS_TOSTRING_3_OFFSET UNITYSDK_OFFSET(0x1BB02E50)
#define RPG_STRUTILS_TOSTRING_4_OFFSET UNITYSDK_OFFSET(0x1BB02ED0)
#define RPG_STRUTILS_TOSTRING_5_OFFSET UNITYSDK_OFFSET(0x1BB02F30)
#define RPG_STRUTILS_TOSTRING_6_OFFSET UNITYSDK_OFFSET(0x1BB02F90)
#define RPG_STRUTILS_TOSTRING_7_OFFSET UNITYSDK_OFFSET(0x1BB02FF0)
#define RPG_STRUTILS_TOSTRING_8_OFFSET UNITYSDK_OFFSET(0x1BB03050)
#define RPG_STRUTILS_TOSTRING_9_OFFSET UNITYSDK_OFFSET(0x1BB030C0)
#define RPG_STRUTILS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BB02CD0)
#define RPG_STRUTILS_TRYGETSTRINGFROMSTABLEHASH_OFFSET UNITYSDK_OFFSET(0x1BB03AB0)
#define RPG_STRUTILS_WILDCARDMATCH_OFFSET UNITYSDK_OFFSET(0x1BB03760)
#define RPG_STRUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BB03CA0)
