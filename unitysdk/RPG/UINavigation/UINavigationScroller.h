...
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xDC81200)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_GETACTIONHINTNAME_OFFSET UNITYSDK_OFFSET(0xDC819A0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xDC81540)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDC81420)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_ONINCONTROLACTIONSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xDC81AC0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xDC816F0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_SHOULDSHOWINCONTROLACTIONHINT_OFFSET UNITYSDK_OFFSET(0xDC817A0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER__CHECKCANSCROLL_OFFSET UNITYSDK_OFFSET(0xDC81930)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC81B20)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER__GETLAYOUTGROUPRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xDC81380)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER__REFRESHINCONTROLTIP_OFFSET UNITYSDK_OFFSET(0xDC814E0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER__REFRESHSCROLLSTATUS_OFFSET UNITYSDK_OFFSET(0xDC81590)
