...
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_GETFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC7E430)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_GET_NAVIGATIONAREA_OFFSET UNITYSDK_OFFSET(0xDC7CB00)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_METHOD_5_1554A5A4DE9C7FA9_OFFSET UNITYSDK_OFFSET(0xDC7E4B0)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDC7C990)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDC7C810)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_POSTONCHILDDESELECTED_OFFSET UNITYSDK_OFFSET(0xDC7E3E0)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_POSTONCHILDSELECTED_OFFSET UNITYSDK_OFFSET(0xDC7E390)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_POSTONNAVIGATION_OFFSET UNITYSDK_OFFSET(0xDC7E340)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0xDC7E330)
