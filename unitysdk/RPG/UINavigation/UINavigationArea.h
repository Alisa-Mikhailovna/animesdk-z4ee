...
#define RPG_UINAVIGATION_UINAVIGATIONAREA_ADDFOCUSCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xDC78000)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_ADD__ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0xDC767B0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_CALCULATENAVIGATIONSCORE_1_OFFSET UNITYSDK_OFFSET(0xDC7A3C0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_CALCULATENAVIGATIONSCORE_OFFSET UNITYSDK_OFFSET(0xDC79FD0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GETBOUNDINGRECT_OFFSET UNITYSDK_OFFSET(0xDC786F0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GETDEFAULTFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC776C0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GETFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC77500)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GETGLOBALPOSONRECTEDGE_OFFSET UNITYSDK_OFFSET(0xDC79310)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GETGLOBALPOSONTRANSFORMEDGE_OFFSET UNITYSDK_OFFSET(0xDC79A30)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GETPOINTONRECTEDGE_OFFSET UNITYSDK_OFFSET(0xDC7A2D0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GETSTARTCORNERDIR_OFFSET UNITYSDK_OFFSET(0xDC784B0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GET_CONFIGAREA_OFFSET UNITYSDK_OFFSET(0xDC76760)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GET_CONFIGDOWN_OFFSET UNITYSDK_OFFSET(0xDC766A0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GET_CONFIGLEFT_OFFSET UNITYSDK_OFFSET(0xDC765E0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GET_CONFIGNEXT_OFFSET UNITYSDK_OFFSET(0xDC766E0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GET_CONFIGPREVIOUS_OFFSET UNITYSDK_OFFSET(0xDC76720)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GET_CONFIGRIGHT_OFFSET UNITYSDK_OFFSET(0xDC76620)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_GET_CONFIGUP_OFFSET UNITYSDK_OFFSET(0xDC76660)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_ONCHILDDESELECTED_OFFSET UNITYSDK_OFFSET(0xDC77270)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_ONCHILDSELECTED_OFFSET UNITYSDK_OFFSET(0xDC77020)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_ONNAVIGATION_OFFSET UNITYSDK_OFFSET(0xDC76B70)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_REMOVEFOCUSCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xDC78090)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_REMOVE__ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0xDC76820)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_RESET_OFFSET UNITYSDK_OFFSET(0xDC76890)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_SELECTFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC77420)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_SETALLBOUNDARYESCAPE_OFFSET UNITYSDK_OFFSET(0xDC78270)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_SETALLBOUNDARYSTOP_OFFSET UNITYSDK_OFFSET(0xDC78170)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_SETCUSTOMFIRSTSELECTABLEDELEGATE_OFFSET UNITYSDK_OFFSET(0xDC77FB0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_SETEXPLICITNAVIGATION_OFFSET UNITYSDK_OFFSET(0xDC782C0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_SETEXTENSION_OFFSET UNITYSDK_OFFSET(0xDC78120)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xDC7A520)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__DIRECTIONTOVECTOR_OFFSET UNITYSDK_OFFSET(0xDC77D10)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__FINDCLOSESTSELECTABLE_1_OFFSET UNITYSDK_OFFSET(0xDC79430)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__FINDCLOSESTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC77E20)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__FINDSELECTABLEAUTOMATIC_OFFSET UNITYSDK_OFFSET(0xDC78E80)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__FINDSELECTABLECLOSESTTOCORNER_OFFSET UNITYSDK_OFFSET(0xDC778E0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__FINDSELECTABLECLOSESTTOSOURCE_OFFSET UNITYSDK_OFFSET(0xDC77B50)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__FINDSELECTABLEUNITYNATIVE_OFFSET UNITYSDK_OFFSET(0xDC790F0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__FINDSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC76C80)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__FINDWRAPAROUNDSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC78C60)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__GETCHILDRENBOUNDINGRECT_OFFSET UNITYSDK_OFFSET(0xDC78760)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__GETCONFIG_OFFSET UNITYSDK_OFFSET(0xDC78330)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__GETCORNERDIR_OFFSET UNITYSDK_OFFSET(0xDC78600)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__GETCUSTOMFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC77660)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__GETNAVIGATIONCAMERA_OFFSET UNITYSDK_OFFSET(0xDC79EF0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__GETRECIPIENTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC78B80)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__GETSAVEDFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xDC77770)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__GETWRAPAROUNDSTARTGLOBALPOS_OFFSET UNITYSDK_OFFSET(0xDC797F0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__INVOKEEXTENSIONPOSTONCHILDDESELECTED_OFFSET UNITYSDK_OFFSET(0xDC77320)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__INVOKEEXTENSIONPOSTONCHILDSELECTED_OFFSET UNITYSDK_OFFSET(0xDC77170)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__INVOKEEXTENSIONPOSTONNAVIGATION_OFFSET UNITYSDK_OFFSET(0xDC76F10)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__ISCHILDNAVIGABLE_OFFSET UNITYSDK_OFFSET(0xDC79B50)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__MAPWORLDPOINTTOAREAPLANEIFNEEDED_OFFSET UNITYSDK_OFFSET(0xDC79C40)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__NAVIGATEBOUNDARY_OFFSET UNITYSDK_OFFSET(0xDC76D10)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__SETALLBOUNDARYRULES_OFFSET UNITYSDK_OFFSET(0xDC781C0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA__SETFOCUSED_OFFSET UNITYSDK_OFFSET(0xDC770F0)
