...
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_ENCODEQUERY_OFFSET UNITYSDK_OFFSET(0xDC6DB80)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_ENCODEREPLY_OFFSET UNITYSDK_OFFSET(0xDC6DC50)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_ENCODE_OFFSET UNITYSDK_OFFSET(0xDC6D880)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_READINT32LE_OFFSET UNITYSDK_OFFSET(0xDC6DAD0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_READLENPREFIXEDSTRING_OFFSET UNITYSDK_OFFSET(0xDC6EAF0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_READUINT16LE_OFFSET UNITYSDK_OFFSET(0xDC6DB40)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_TRYDECODEHEADER_OFFSET UNITYSDK_OFFSET(0xDC6E490)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_TRYDECODEREPLY_OFFSET UNITYSDK_OFFSET(0xDC6E520)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_TRYDECODE_OFFSET UNITYSDK_OFFSET(0xDC6D9D0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_WRITEINT32LE_OFFSET UNITYSDK_OFFSET(0xDC6D930)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_WRITELENPREFIXEDSTRING_OFFSET UNITYSDK_OFFSET(0xDC6E270)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_WRITEUINT16LE_OFFSET UNITYSDK_OFFSET(0xDC6D990)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_WRITEUINT32LE_OFFSET UNITYSDK_OFFSET(0xDC6DBF0)
