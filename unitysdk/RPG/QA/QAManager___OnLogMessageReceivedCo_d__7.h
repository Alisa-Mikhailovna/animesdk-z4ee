...
#define RPG_QA_QAMANAGER___ONLOGMESSAGERECEIVEDCO_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xDC6C750)
#define RPG_QA_QAMANAGER___ONLOGMESSAGERECEIVEDCO_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xDC6C7D0)
#define RPG_QA_QAMANAGER___ONLOGMESSAGERECEIVEDCO_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xDC6C830)
#define RPG_QA_QAMANAGER___ONLOGMESSAGERECEIVEDCO_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xDC6C7E0)
#define RPG_QA_QAMANAGER___ONLOGMESSAGERECEIVEDCO_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDC6C740)
#define RPG_QA_QAMANAGER___ONLOGMESSAGERECEIVEDCO_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0xDC6B120)
