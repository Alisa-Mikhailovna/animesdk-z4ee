...
#define RPG_QA_PROFILERSOCKETSENDER_COMMONSOCKETCLOSE_OFFSET UNITYSDK_OFFSET(0xDC6A7D0)
#define RPG_QA_PROFILERSOCKETSENDER_COMMONSOCKETCONNECT_OFFSET UNITYSDK_OFFSET(0xDC6A440)
#define RPG_QA_PROFILERSOCKETSENDER_COMMONSOCKETSENDSTR_OFFSET UNITYSDK_OFFSET(0xDC6A630)
#define RPG_QA_PROFILERSOCKETSENDER_CONNECT_OFFSET UNITYSDK_OFFSET(0xDC69CA0)
#define RPG_QA_PROFILERSOCKETSENDER_SENDAUTOSAVEPATH_OFFSET UNITYSDK_OFFSET(0xDC6A3A0)
#define RPG_QA_PROFILERSOCKETSENDER_SENDEND_OFFSET UNITYSDK_OFFSET(0xDC6A320)
#define RPG_QA_PROFILERSOCKETSENDER_SENDFILTEREDRECORD_OFFSET UNITYSDK_OFFSET(0xDC6A2B0)
#define RPG_QA_PROFILERSOCKETSENDER_SENDRECORDDIFF_OFFSET UNITYSDK_OFFSET(0xDC6A220)
#define RPG_QA_PROFILERSOCKETSENDER_SENDRECORD_OFFSET UNITYSDK_OFFSET(0xDC69F20)
#define RPG_QA_PROFILERSOCKETSENDER_SEND_OFFSET UNITYSDK_OFFSET(0xDC6A0E0)
#define RPG_QA_PROFILERSOCKETSENDER_SETCONFIGTITLE_OFFSET UNITYSDK_OFFSET(0xDC6A3F0)
#define RPG_QA_PROFILERSOCKETSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC6A810)
...
namespace RPG::QA
{
	...
	public:
		...
		{
			return (::System::Net::Sockets::Socket**)Il2CppClass::FromTypeDefinitionIndex(ProfilerSocketSender_TypeDefinitionIndex)->GetStaticField(0x69070);
		}
