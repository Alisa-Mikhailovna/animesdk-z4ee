...
#define RPG_EDITOR_BGCURVEPCG_MULTSUBMESH_GEOMETRYSETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0xD8E61E0)
...
namespace RPG::Editor
{
	...
	struct alignas(8) BGCurvePCG_MultSubMesh_GeometrySetting
	{
		...
		{
			return (::RPG::Editor::BGCurvePCG_MultSubMesh_GeometrySetting*)Il2CppClass::FromTypeDefinitionIndex(BGCurvePCG_MultSubMesh_GeometrySetting_TypeDefinitionIndex)->GetStaticField(0x576A0);
		}
