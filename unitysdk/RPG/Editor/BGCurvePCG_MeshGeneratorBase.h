...
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_GET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0xD8E4C30)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_METHOD_1_004679B1608D45B2_OFFSET UNITYSDK_OFFSET(0xD8E0180)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_METHOD_1_0844BF824CA685A7_OFFSET UNITYSDK_OFFSET(0xD8DF790)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_METHOD_1_5FB236C32D199384_OFFSET UNITYSDK_OFFSET(0xD8DFFE0)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_METHOD_1_AFC21B0E8344D794_OFFSET UNITYSDK_OFFSET(0xD8DCBF0)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_METHOD_1_B314D3A101A1F0FD_OFFSET UNITYSDK_OFFSET(0xD8E0240)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_METHOD_1_C20D118032AA1891_OFFSET UNITYSDK_OFFSET(0xD8DC670)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD8E4BE0)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_METHOD_1_EBD5494EA7EC26D6_OFFSET UNITYSDK_OFFSET(0xD8DFBE0)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_METHOD_1_ED5C165D5B2A731C_OFFSET UNITYSDK_OFFSET(0xD8DDB20)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE_SET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0xD8E4C40)
#define RPG_EDITOR_BGCURVEPCG_MESHGENERATORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD8DD760)
