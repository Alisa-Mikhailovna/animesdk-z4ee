...
#define RPG_EDITOR_BGCURVEPCG_BEZIERCURVEGENERATOR_CURVEGENERATESETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0xD8DD770)
...
namespace RPG::Editor
{
	...
	struct alignas(4) BGCurvePCG_BezierCurveGenerator_CurveGenerateSetting
	{
		...
		{
			return (::RPG::Editor::BGCurvePCG_BezierCurveGenerator_CurveGenerateSetting*)Il2CppClass::FromTypeDefinitionIndex(BGCurvePCG_BezierCurveGenerator_CurveGenerateSetting_TypeDefinitionIndex)->GetStaticField(0xF8E0);
		}
