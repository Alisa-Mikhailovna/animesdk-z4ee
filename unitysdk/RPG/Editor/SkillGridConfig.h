...
#define RPG_EDITOR_SKILLGRIDCONFIG_GET_COLS_OFFSET UNITYSDK_OFFSET(0xD8EB3C0)
#define RPG_EDITOR_SKILLGRIDCONFIG_GET_DIRSPACINGPX_OFFSET UNITYSDK_OFFSET(0xD8EB320)
#define RPG_EDITOR_SKILLGRIDCONFIG_GET_ROWS_OFFSET UNITYSDK_OFFSET(0xD8EB4D0)
#define RPG_EDITOR_SKILLGRIDCONFIG_GET_UNITPX_OFFSET UNITYSDK_OFFSET(0xD8EB280)
#define RPG_EDITOR_SKILLGRIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD8EB5E0)
