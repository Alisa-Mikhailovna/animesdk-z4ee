...
#define FIVEDIMRENDERINGPANELRUNTIME_METHOD_6_70C856AE64234BE0_OFFSET UNITYSDK_OFFSET(0x1479BEF0)
#define FIVEDIMRENDERINGPANELRUNTIME_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1479BF40)
#define FIVEDIMRENDERINGPANELRUNTIME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1479BF80)
#define FIVEDIMRENDERINGPANELRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1479BFD0)
