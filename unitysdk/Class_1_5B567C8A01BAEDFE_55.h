...
#define CLASS_1_5B567C8A01BAEDFE_55_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BDC2E30)
#define CLASS_1_5B567C8A01BAEDFE_55_CLONE_OFFSET UNITYSDK_OFFSET(0x1BDC2B20)
#define CLASS_1_5B567C8A01BAEDFE_55_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BDC2C30)
#define CLASS_1_5B567C8A01BAEDFE_55_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BDC2B60)
#define CLASS_1_5B567C8A01BAEDFE_55_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BDC2D90)
#define CLASS_1_5B567C8A01BAEDFE_55_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BDC2E80)
#define CLASS_1_5B567C8A01BAEDFE_55_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BDC2E50)
#define CLASS_1_5B567C8A01BAEDFE_55_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BDC2AA0)
#define CLASS_1_5B567C8A01BAEDFE_55_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BDC2AD0)
#define CLASS_1_5B567C8A01BAEDFE_55_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BDC2DC0)
#define CLASS_1_5B567C8A01BAEDFE_55_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BDC2E20)
#define CLASS_1_5B567C8A01BAEDFE_55__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BDC2ED0)
#define CLASS_1_5B567C8A01BAEDFE_55__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BDC2AF0)
#define CLASS_1_5B567C8A01BAEDFE_55__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC2AE0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_55*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_55_TypeDefinitionIndex)->GetStaticField(0x1D5C0);
	}
