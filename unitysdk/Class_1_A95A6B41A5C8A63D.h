...
#define CLASS_1_A95A6B41A5C8A63D__CTOR_OFFSET UNITYSDK_OFFSET(0xB554840)
...
{
public:
	::Class_1_118030333D39EAFB* Field_1_0; // 0x10
	::System::String* Field_1_1; // 0x18
	::RPG::GameCore::BattleAreaReferenceInfo* Field_1_2; // 0x20
