...
#define CLASS_1_5B567C8A01BAEDFE_293_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C5B8A50)
#define CLASS_1_5B567C8A01BAEDFE_293_CLONE_OFFSET UNITYSDK_OFFSET(0x1C5B86F0)
#define CLASS_1_5B567C8A01BAEDFE_293_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C5B8850)
#define CLASS_1_5B567C8A01BAEDFE_293_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C5B8760)
#define CLASS_1_5B567C8A01BAEDFE_293_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C5B89B0)
#define CLASS_1_5B567C8A01BAEDFE_293_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C5B8AA0)
#define CLASS_1_5B567C8A01BAEDFE_293_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C5B8A70)
#define CLASS_1_5B567C8A01BAEDFE_293_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C5B8640)
#define CLASS_1_5B567C8A01BAEDFE_293_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C5B86A0)
#define CLASS_1_5B567C8A01BAEDFE_293_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C5B89E0)
#define CLASS_1_5B567C8A01BAEDFE_293_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C5B8A40)
#define CLASS_1_5B567C8A01BAEDFE_293__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5B8AF0)
#define CLASS_1_5B567C8A01BAEDFE_293__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C5B86C0)
#define CLASS_1_5B567C8A01BAEDFE_293__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5B86B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_293*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_293_TypeDefinitionIndex)->GetStaticField(0x61860);
	}
