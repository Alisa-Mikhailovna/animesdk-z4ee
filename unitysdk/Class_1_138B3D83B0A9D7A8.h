...
#define CLASS_1_138B3D83B0A9D7A8_DELTATIMEWITHIGNOREINDEX_OFFSET UNITYSDK_OFFSET(0xADCC7A0)
#define CLASS_1_138B3D83B0A9D7A8_DELTATIME_OFFSET UNITYSDK_OFFSET(0xADCC6F0)
#define CLASS_1_138B3D83B0A9D7A8_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADCCC10)
#define CLASS_1_138B3D83B0A9D7A8_FIXEDDELTATIME_OFFSET UNITYSDK_OFFSET(0xADCC5E0)
#define CLASS_1_138B3D83B0A9D7A8_METHOD_1_230FE7F4B4EA88A5_OFFSET UNITYSDK_OFFSET(0xADCC820)
#define CLASS_1_138B3D83B0A9D7A8_TIMESCALE_OFFSET UNITYSDK_OFFSET(0xADCC690)
#define CLASS_1_138B3D83B0A9D7A8__CTOR_OFFSET UNITYSDK_OFFSET(0xADCC5D0)

inline static constexpr unsigned int Class_1_138B3D83B0A9D7A8_TypeDefinitionIndex = 72931;
