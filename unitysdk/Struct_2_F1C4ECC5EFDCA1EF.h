...
#define STRUCT_2_F1C4ECC5EFDCA1EF_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x7F0C0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2D0B1E0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_EQUALS_OFFSET UNITYSDK_OFFSET(0x2D0B1A0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2D0B190)
#define STRUCT_2_F1C4ECC5EFDCA1EF_GET_ID_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_GET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_METHOD_2_21777270C6646173_OFFSET UNITYSDK_OFFSET(0x2D0B110)
#define STRUCT_2_F1C4ECC5EFDCA1EF_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x151A0DD0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x151A0D90)
#define STRUCT_2_F1C4ECC5EFDCA1EF_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x2D0B170)
#define STRUCT_2_F1C4ECC5EFDCA1EF_SET_ID_OFFSET UNITYSDK_OFFSET(0xDAE0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_SET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0xC630)
#define STRUCT_2_F1C4ECC5EFDCA1EF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2D0B160)
#define STRUCT_2_F1C4ECC5EFDCA1EF__CTOR_OFFSET UNITYSDK_OFFSET(0x7F000)
