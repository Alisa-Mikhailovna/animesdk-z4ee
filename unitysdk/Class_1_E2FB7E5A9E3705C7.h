...
#define CLASS_1_E2FB7E5A9E3705C7_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x145DC6F0)
#define CLASS_1_E2FB7E5A9E3705C7_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x145DC6B0)
#define CLASS_1_E2FB7E5A9E3705C7_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x145DC6D0)
#define CLASS_1_E2FB7E5A9E3705C7_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x145DC700)
#define CLASS_1_E2FB7E5A9E3705C7_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x145DC6C0)
#define CLASS_1_E2FB7E5A9E3705C7_SET_TEXTID_OFFSET UNITYSDK_OFFSET(0x145DC6E0)
#define CLASS_1_E2FB7E5A9E3705C7__CTOR_OFFSET UNITYSDK_OFFSET(0x145DC710)
