...
#define MIHOYOSDKJSON_JSONNUMBER_EQUALS_OFFSET UNITYSDK_OFFSET(0xAB8C6C0)
#define MIHOYOSDKJSON_JSONNUMBER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xAB8C470)
#define MIHOYOSDKJSON_JSONNUMBER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xAB8C800)
#define MIHOYOSDKJSON_JSONNUMBER_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0xAB8C530)
#define MIHOYOSDKJSON_JSONNUMBER_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0xAB8C550)
#define MIHOYOSDKJSON_JSONNUMBER_GET_ISNUMBER_OFFSET UNITYSDK_OFFSET(0xAB8C460)
#define MIHOYOSDKJSON_JSONNUMBER_GET_TAG_OFFSET UNITYSDK_OFFSET(0xAB8C450)
#define MIHOYOSDKJSON_JSONNUMBER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xAB8C490)
#define MIHOYOSDKJSON_JSONNUMBER_ISNUMERIC_OFFSET UNITYSDK_OFFSET(0xAB8C640)
#define MIHOYOSDKJSON_JSONNUMBER_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0xAB8C540)
#define MIHOYOSDKJSON_JSONNUMBER_SET_ASLONG_OFFSET UNITYSDK_OFFSET(0xAB8C560)
#define MIHOYOSDKJSON_JSONNUMBER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xAB8C4D0)
#define MIHOYOSDKJSON_JSONNUMBER_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0xAB8C5E0)
#define MIHOYOSDKJSON_JSONNUMBER__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAB8C570)
#define MIHOYOSDKJSON_JSONNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB88760)
