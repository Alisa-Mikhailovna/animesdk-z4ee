...
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAB8BF00)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xAB8BF20)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAB8BD30)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xAB8BE30)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xAB8BF70)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xAB8C080)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAB8BD90)
#define MIHOYOSDKJSON_JSONNODE_LINQENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xAB89350)
