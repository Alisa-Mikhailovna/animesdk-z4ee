...
#define CLASS_2_98512A0A7DDD14B2_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB6374F0)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_13004921ED9C7319_OFFSET UNITYSDK_OFFSET(0xB638470)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_344DB1721ADD2658_1_OFFSET UNITYSDK_OFFSET(0xB6390A0)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_344DB1721ADD2658_OFFSET UNITYSDK_OFFSET(0xB638EA0)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_69394C8E424F4241_OFFSET UNITYSDK_OFFSET(0xB63A790)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_77E403C38BABBDD8_OFFSET UNITYSDK_OFFSET(0xB6395B0)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_7C435BFEFAB36520_1_OFFSET UNITYSDK_OFFSET(0xB63A0A0)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_7C435BFEFAB36520_OFFSET UNITYSDK_OFFSET(0xB639D50)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xB639700)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_8E6AC4E9A6FF2694_OFFSET UNITYSDK_OFFSET(0xB639A40)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xB637DE0)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_BB850356AA7DECA2_OFFSET UNITYSDK_OFFSET(0xB6386A0)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_C71330C5E4DD6A8C_OFFSET UNITYSDK_OFFSET(0xB639E90)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_C78AE789C8D46624_OFFSET UNITYSDK_OFFSET(0xB6392A0)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_DE1C1F4DF5D06882_OFFSET UNITYSDK_OFFSET(0xB638090)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xB637C90)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0xB63A660)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_F74D2ADDCA89714D_OFFSET UNITYSDK_OFFSET(0xB639750)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_F7810952FE14E15C_OFFSET UNITYSDK_OFFSET(0xB63A1D0)
#define CLASS_2_98512A0A7DDD14B2_METHOD_2_FACE9210088E0BD3_OFFSET UNITYSDK_OFFSET(0xB6381D0)
#define CLASS_2_98512A0A7DDD14B2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB637FF0)
#define CLASS_2_98512A0A7DDD14B2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB638040)
#define CLASS_2_98512A0A7DDD14B2_TICK_OFFSET UNITYSDK_OFFSET(0xB637D70)
#define CLASS_2_98512A0A7DDD14B2__CCTOR_OFFSET UNITYSDK_OFFSET(0xB63AA60)
#define CLASS_2_98512A0A7DDD14B2__CTOR_OFFSET UNITYSDK_OFFSET(0xB637410)
#define CLASS_2_98512A0A7DDD14B2___DICEAPPEAR_B__10_0_OFFSET UNITYSDK_OFFSET(0xB63AAA0)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_98512A0A7DDD14B2_TypeDefinitionIndex)->GetStaticField(0x6BF50);
	}
	::UnityEngine::GameObject* Field_2_1; // 0x18
	::RPG::GameCore::TaskContext* Field_2_2; // 0x20
	::RPG::GameCore::RogueDLC1Dot3DiceInteract* Field_2_3; // 0x28
	::System::Collections::Generic::List_1<::RPG::Client::IAssetOperation*>* Field_2_4; // 0x30
	::System::String* Field_2_5; // 0x38
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::UnityEngine::Sprite*>* Field_2_6; // 0x40
	::Class_3_07C3C4D2990C49EE* Field_2_7; // 0x48
	::Enum_3_ED790DAC948A65A9_10 Field_2_8; // 0x50
