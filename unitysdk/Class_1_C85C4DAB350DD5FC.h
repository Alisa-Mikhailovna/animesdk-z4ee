...
#define CLASS_1_C85C4DAB350DD5FC_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x15595DD0)
#define CLASS_1_C85C4DAB350DD5FC_GET_BPADD_OFFSET UNITYSDK_OFFSET(0x15595D30)
#define CLASS_1_C85C4DAB350DD5FC_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0x15595D10)
#define CLASS_1_C85C4DAB350DD5FC_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0x15595D50)
#define CLASS_1_C85C4DAB350DD5FC_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x15595C50)
#define CLASS_1_C85C4DAB350DD5FC_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x15595C00)
#define CLASS_1_C85C4DAB350DD5FC_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x15595C10)
#define CLASS_1_C85C4DAB350DD5FC_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x15595D70)
#define CLASS_1_C85C4DAB350DD5FC_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0x15595C70)
#define CLASS_1_C85C4DAB350DD5FC_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0x15595D90)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0x15595E10)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x15595DF0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x15595C30)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPADD_OFFSET UNITYSDK_OFFSET(0x15595C90)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0x15595CB0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0x15595CF0)
#define CLASS_1_C85C4DAB350DD5FC_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0x15595CD0)
#define CLASS_1_C85C4DAB350DD5FC_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x15595DB0)
#define CLASS_1_C85C4DAB350DD5FC_SET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x15595DE0)
#define CLASS_1_C85C4DAB350DD5FC_SET_BPADD_OFFSET UNITYSDK_OFFSET(0x15595D40)
#define CLASS_1_C85C4DAB350DD5FC_SET_BPNEED_OFFSET UNITYSDK_OFFSET(0x15595D20)
#define CLASS_1_C85C4DAB350DD5FC_SET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0x15595D60)
#define CLASS_1_C85C4DAB350DD5FC_SET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x15595C60)
#define CLASS_1_C85C4DAB350DD5FC_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x15595C20)
#define CLASS_1_C85C4DAB350DD5FC_SET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x15595D80)
#define CLASS_1_C85C4DAB350DD5FC_SET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0x15595C80)
#define CLASS_1_C85C4DAB350DD5FC_SET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0x15595DA0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0x15595E20)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x15595E00)
#define CLASS_1_C85C4DAB350DD5FC_SET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x15595C40)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPADD_OFFSET UNITYSDK_OFFSET(0x15595CA0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPBASE_OFFSET UNITYSDK_OFFSET(0x15595CC0)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0x15595D00)
#define CLASS_1_C85C4DAB350DD5FC_SET_SPNEED_OFFSET UNITYSDK_OFFSET(0x15595CE0)
#define CLASS_1_C85C4DAB350DD5FC_SET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x15595DC0)
#define CLASS_1_C85C4DAB350DD5FC__CTOR_OFFSET UNITYSDK_OFFSET(0x15595E30)
...
public:
	...
	::RPG::GameCore::AttackDamageType _StanceDamageType_k__BackingField; // 0x3C
	::RPG::GameCore::FixPoint _SPNeed_k__BackingField; // 0x40
	::RPG::GameCore::AttackType _AttackType_k__BackingField; // 0x48
	::Struct_2_276321B6B122C69C _Identifier_k__BackingField; // 0x4C
	::RPG::GameCore::FixPoint _BPNeed_k__BackingField; // 0x58
	::RPG::GameCore::FixPoint _DelayRatio_k__BackingField; // 0x60
	::RPG::GameCore::FixPoint _SPBase_k__BackingField; // 0x68
