...
#define CLASS_1_A57EDD0666353753_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C81CAD0)
#define CLASS_1_A57EDD0666353753_CLONE_OFFSET UNITYSDK_OFFSET(0x1C81C6A0)
#define CLASS_1_A57EDD0666353753_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C81C730)
#define CLASS_1_A57EDD0666353753_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C81C700)
#define CLASS_1_A57EDD0666353753_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C81C8A0)
#define CLASS_1_A57EDD0666353753_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C81CD30)
#define CLASS_1_A57EDD0666353753_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C81CBE0)
#define CLASS_1_A57EDD0666353753_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C81C4D0)
#define CLASS_1_A57EDD0666353753_METHOD_1_6E1EC2DF63D7020F_1_OFFSET UNITYSDK_OFFSET(0x1C81C6E0)
#define CLASS_1_A57EDD0666353753_METHOD_1_6E1EC2DF63D7020F_2_OFFSET UNITYSDK_OFFSET(0x1C81C6F0)
#define CLASS_1_A57EDD0666353753_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1C81C6D0)
#define CLASS_1_A57EDD0666353753_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C81C500)
#define CLASS_1_A57EDD0666353753_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C81C950)
#define CLASS_1_A57EDD0666353753_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C81C9B0)
#define CLASS_1_A57EDD0666353753__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C81CFC0)
#define CLASS_1_A57EDD0666353753__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C81C590)
#define CLASS_1_A57EDD0666353753__CTOR_OFFSET UNITYSDK_OFFSET(0x1C81C510)
...
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_A57EDD0666353753*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_A57EDD0666353753*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A57EDD0666353753_TypeDefinitionIndex)->GetStaticField(0x27000);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_C9E417278351157F_5*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_C9E417278351157F_5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A57EDD0666353753_TypeDefinitionIndex)->GetStaticField(0x27008);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_271*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_271*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A57EDD0666353753_TypeDefinitionIndex)->GetStaticField(0x27010);
	}
	static ::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_272*>** StaticGet_Field_1_3()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_D17272E82AE804C2_272*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A57EDD0666353753_TypeDefinitionIndex)->GetStaticField(0x27018);
	}
	...
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_272*>* Field_1_7; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_271*>* Field_1_8; // 0x18
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_C9E417278351157F_5*>* Field_1_9; // 0x20
