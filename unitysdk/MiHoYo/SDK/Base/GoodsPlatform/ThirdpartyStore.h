...
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGECLOUDGAMESTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x19BAA900)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGECXSTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x19BAA880)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGEEPICSTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x19BAA8C0)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGESONYSTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x19BAA6B0)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_EXCHANGESTOREITEMINFO_OFFSET UNITYSDK_OFFSET(0x19BA7740)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_GETGOODSIDLIST_OFFSET UNITYSDK_OFFSET(0x19BAB310)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_GETGOODSWITHNODISCOUNTIDS_OFFSET UNITYSDK_OFFSET(0x19BAA950)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE_GETTHIRDPARTYSTORENAME_OFFSET UNITYSDK_OFFSET(0x19BA5660)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BAB620)
#define MIHOYO_SDK_BASE_GOODSPLATFORM_THIRDPARTYSTORE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAB610)
...
namespace MiHoYo::SDK::Base::GoodsPlatform
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyStore_TypeDefinitionIndex)->GetStaticField(0xF6A0);
		}
