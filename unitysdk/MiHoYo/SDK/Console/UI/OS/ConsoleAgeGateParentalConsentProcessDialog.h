...
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x19CD8B30)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19CD8B10)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_GET_ONBACK_OFFSET UNITYSDK_OFFSET(0x19CD8AF0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x19CDAF30)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x19CDB040)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19CDB1D0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_ONPRESSEDBACK_OFFSET UNITYSDK_OFFSET(0x19CDB1F0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19CDB2A0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_SETMULTILANGUAGETEXT_OFFSET UNITYSDK_OFFSET(0x19CD8F30)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19CD8B20)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_SET_ONBACK_OFFSET UNITYSDK_OFFSET(0x19CD8B00)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x19CDB0D0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDB2B0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEPARENTALCONSENTPROCESSDIALOG__ONPRESSEDBACK_G__ONBACKROUTINE_29_0_OFFSET UNITYSDK_OFFSET(0x19CDB250)
...
namespace MiHoYo::SDK::Console::UI::OS
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Console::UI::OS::ConsoleAgeGateParentalConsentProcessDialog**)Il2CppClass::FromTypeDefinitionIndex(ConsoleAgeGateParentalConsentProcessDialog_TypeDefinitionIndex)->GetStaticField(0x1CF30);
		}
