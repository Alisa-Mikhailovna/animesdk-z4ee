...
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x19CD4C00)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19CD4BE0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x19CD4BC0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_HIDEDIALOG_OFFSET UNITYSDK_OFFSET(0x19CD53F0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x19CD5360)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_ONCLOSEDIALOG_OFFSET UNITYSDK_OFFSET(0x19CD5490)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19CD5000)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_SETDIALOGMESSAGE_OFFSET UNITYSDK_OFFSET(0x19CD5030)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19CD5540)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19CD4BF0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x19CD4BD0)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x19CD5240)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD5550)
#define MIHOYO_SDK_CONSOLE_UI_OS_CONSOLEAGEGATEERRORDIALOG__ONCLOSEDIALOG_G__ONCLOSEPRESSEDROUTINE_25_0_OFFSET UNITYSDK_OFFSET(0x19CD54F0)
...
namespace MiHoYo::SDK::Console::UI::OS
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Console::UI::OS::ConsoleAgeGateErrorDialog**)Il2CppClass::FromTypeDefinitionIndex(ConsoleAgeGateErrorDialog_TypeDefinitionIndex)->GetStaticField(0x1CC80);
		}
