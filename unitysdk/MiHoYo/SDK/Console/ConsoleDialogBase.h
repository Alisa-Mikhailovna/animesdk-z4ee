...
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_ADJUSTBUTTONSIZEONXCLOUD_OFFSET UNITYSDK_OFFSET(0x19BFEE00)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x19BF52A0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_CANCELBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x19BFF220)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_CONFIRMBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x19BFF300)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_GET_CANCELBUTTONTEXT_OFFSET UNITYSDK_OFFSET(0x19BFEBF0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_GET_CONFIRMBUTTONTEXT_OFFSET UNITYSDK_OFFSET(0x19BFEAA0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_HIGHLIGHTEDCHANGED_OFFSET UNITYSDK_OFFSET(0x19BFF3E0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_ISFOCUS_OFFSET UNITYSDK_OFFSET(0x19BFF400)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19BF6110)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_REVERTPS4BUTTONIMAGES_OFFSET UNITYSDK_OFFSET(0x19BFED40)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_SETHIGHLIGHTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x19BF11D0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_SET_CANCELBUTTONTEXT_OFFSET UNITYSDK_OFFSET(0x19BF58D0)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE_SET_CONFIRMBUTTONTEXT_OFFSET UNITYSDK_OFFSET(0x19BF5780)
#define MIHOYO_SDK_CONSOLE_CONSOLEDIALOGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF89A0)
