...
#define MIHOYO_SDK_UGCNETWORK__PERFORMHTTPREQUESTBINARY_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xAB7FE40)
#define MIHOYO_SDK_UGCNETWORK__PERFORMHTTPREQUESTBINARY_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAB81090)
#define MIHOYO_SDK_UGCNETWORK__PERFORMHTTPREQUESTBINARY_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAB810F0)
#define MIHOYO_SDK_UGCNETWORK__PERFORMHTTPREQUESTBINARY_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xAB810A0)
#define MIHOYO_SDK_UGCNETWORK__PERFORMHTTPREQUESTBINARY_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAB7FE30)
#define MIHOYO_SDK_UGCNETWORK__PERFORMHTTPREQUESTBINARY_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0xAB7FB70)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		::System::Func_1<::UnityEngine::Networking::UnityWebRequest*>* buildRequestFun; // 0x28
		::UnityEngine::Networking::UnityWebRequest* _request_5__4; // 0x30
