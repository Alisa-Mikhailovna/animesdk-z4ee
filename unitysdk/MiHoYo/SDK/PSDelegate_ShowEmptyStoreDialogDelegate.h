...
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19DB9C90)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19DB9CC0)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D97C20)
#define MIHOYO_SDK_PSDELEGATE_SHOWEMPTYSTOREDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB9C20)
