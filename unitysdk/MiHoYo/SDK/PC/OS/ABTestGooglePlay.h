...
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_ENTERGOOGLENATIVE_OFFSET UNITYSDK_OFFSET(0x19D609E0)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_GETGOOGLEPLAYABTESTREQUESTMODEL_OFFSET UNITYSDK_OFFSET(0x19D5FD90)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_ONGOOGLEABTESTRESPONSE_OFFSET UNITYSDK_OFFSET(0x19D60D70)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_PULLABTEST_OFFSET UNITYSDK_OFFSET(0x19D5FA10)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_REQUESTABTESTCONFIG_OFFSET UNITYSDK_OFFSET(0x19D5FF90)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D61630)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x19D60D40)
...
namespace MiHoYo::SDK::PC::OS
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PC::OS::ABTestGooglePlay**)Il2CppClass::FromTypeDefinitionIndex(ABTestGooglePlay_TypeDefinitionIndex)->GetStaticField(0x104A0);
		}
