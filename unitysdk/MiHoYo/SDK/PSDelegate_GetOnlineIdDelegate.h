...
#define MIHOYO_SDK_PSDELEGATE_GETONLINEIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19DB8C50)
#define MIHOYO_SDK_PSDELEGATE_GETONLINEIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19DB8C80)
#define MIHOYO_SDK_PSDELEGATE_GETONLINEIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D7F4F0)
#define MIHOYO_SDK_PSDELEGATE_GETONLINEIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB8BE0)
