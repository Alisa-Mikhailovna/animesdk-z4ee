...
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B8A720)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_CLONE_OFFSET UNITYSDK_OFFSET(0x19B8A460)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B8A570)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B8A4C0)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B8A5E0)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B8A0D0)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x19B8A070)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_GET_PATHS_OFFSET UNITYSDK_OFFSET(0x19B8A4B0)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B8A7B0)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_PB__MIHOYO_SDK_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B8A310)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_TODIAGNOSTICSTRING_OFFSET UNITYSDK_OFFSET(0x19B8ADD0)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_TOJSON_OFFSET UNITYSDK_OFFSET(0x19B8A970)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B8A630)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_VALIDATEPATH_OFFSET UNITYSDK_OFFSET(0x19B8AD30)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B8A690)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B8AE30)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B8A3C0)
#define MIHOYO_SDK_PROTOBUF_WELLKNOWNTYPES_FIELDMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19B8A370)
