...
namespace MiHoYo::SDK::MTR
{
	...
	public:
		...
		{
			return (::System::Threading::ParameterizedThreadStart**)Il2CppClass::FromTypeDefinitionIndex(MiHoYoMTRInterface___O_TypeDefinitionIndex)->GetStaticField(0xE410);
		}
		static ::System::Threading::ParameterizedThreadStart** StaticGet__1___StopUrlUsageProc()
		{
			return (::System::Threading::ParameterizedThreadStart**)Il2CppClass::FromTypeDefinitionIndex(MiHoYoMTRInterface___O_TypeDefinitionIndex)->GetStaticField(0xE418);
		}
	};
}
