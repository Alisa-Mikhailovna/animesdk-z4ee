...
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19CE6770)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19CE67B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19CE6760)
#define MIHOYO_SDK_CONSOLEDELEGATE_SENDSESSIONINVITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE66E0)
