...
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET_GETCOLORORDEFAULT_OFFSET UNITYSDK_OFFSET(0xAAC6950)
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET_GETIMAGESTRETCHMODE_OFFSET UNITYSDK_OFFSET(0xAAC6A10)
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET_PARSESKINCONFIGURATION_OFFSET UNITYSDK_OFFSET(0xAAC6D10)
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xAAC6CB0)
