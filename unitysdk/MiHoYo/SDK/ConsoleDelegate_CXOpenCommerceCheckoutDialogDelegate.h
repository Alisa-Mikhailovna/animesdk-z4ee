...
#define MIHOYO_SDK_CONSOLEDELEGATE_CXOPENCOMMERCECHECKOUTDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19CE3D40)
#define MIHOYO_SDK_CONSOLEDELEGATE_CXOPENCOMMERCECHECKOUTDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19CE3D90)
#define MIHOYO_SDK_CONSOLEDELEGATE_CXOPENCOMMERCECHECKOUTDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19CE3D10)
#define MIHOYO_SDK_CONSOLEDELEGATE_CXOPENCOMMERCECHECKOUTDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE3C90)
