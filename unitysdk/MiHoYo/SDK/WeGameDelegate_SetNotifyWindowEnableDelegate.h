...
#define MIHOYO_SDK_WEGAMEDELEGATE_SETNOTIFYWINDOWENABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E51130)
#define MIHOYO_SDK_WEGAMEDELEGATE_SETNOTIFYWINDOWENABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E51180)
#define MIHOYO_SDK_WEGAMEDELEGATE_SETNOTIFYWINDOWENABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E51120)
#define MIHOYO_SDK_WEGAMEDELEGATE_SETNOTIFYWINDOWENABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E510B0)
