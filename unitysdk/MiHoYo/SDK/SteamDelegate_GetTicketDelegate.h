...
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E19620)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E19650)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E19610)
#define MIHOYO_SDK_STEAMDELEGATE_GETTICKETDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E195A0)
