...
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19DC2910)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_ONCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x19DDC790)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_SHOWBINDMOBILEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19DDD760)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_SHOWDEVICELOGINTIPSPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19DDCA40)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_SHOWVERIFYMAILPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19DDDEB0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DDE7D0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDC780)
...
namespace MiHoYo::SDK::PluginUI
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUISafeService**)Il2CppClass::FromTypeDefinitionIndex(PluginUISafeService_TypeDefinitionIndex)->GetStaticField(0x27A30);
		}
