...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ADDTIME_OFFSET UNITYSDK_OFFSET(0xAB4E7D0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_BRIDGE2NATIVE_1_OFFSET UNITYSDK_OFFSET(0xAB4DFB0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_BRIDGE2NATIVE_2_OFFSET UNITYSDK_OFFSET(0xAB4D220)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_BRIDGE2NATIVE_OFFSET UNITYSDK_OFFSET(0xAB4DD90)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0xAB4C7D0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_GETNATIVEUICOUNT_OFFSET UNITYSDK_OFFSET(0xAB4CF40)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_GETPLUGINUI_OFFSET UNITYSDK_OFFSET(0xAB4CDD0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_GETREGISTEREDPLUGINUINAMES_OFFSET UNITYSDK_OFFSET(0xAB4CAF0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ISREGISTEREDPLUGINUI_OFFSET UNITYSDK_OFFSET(0xAB4CF20)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ISUSINGPLUGINUI_OFFSET UNITYSDK_OFFSET(0xAB4CDB0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_MANUALLYSHOWPLUGINUI_OFFSET UNITYSDK_OFFSET(0xAB4CD30)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ONCLOSEUI_OFFSET UNITYSDK_OFFSET(0xAB4E410)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ONNOTIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0xAB4E630)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ONSHOWUI_OFFSET UNITYSDK_OFFSET(0xAB4E310)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ONUPDATEUI_OFFSET UNITYSDK_OFFSET(0xAB4E500)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUICLEARACTIONS_OFFSET UNITYSDK_OFFSET(0xAB4D990)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUICLOSE_OFFSET UNITYSDK_OFFSET(0xAB4D7B0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUINOTIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0xAB4DCE0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUISHOW_OFFSET UNITYSDK_OFFSET(0xAB4CFC0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUIUPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0xAB4DC90)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_REGISTERPLUGINUI_1_OFFSET UNITYSDK_OFFSET(0xAB4C890)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_REGISTERPLUGINUI_OFFSET UNITYSDK_OFFSET(0xAB4C870)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB4C6A0)
...
namespace MiHoYo::SDK::PluginUI
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::MiHoYoSDKUIManager**)Il2CppClass::FromTypeDefinitionIndex(MiHoYoSDKUIManager_TypeDefinitionIndex)->GetStaticField(0x1B180);
		}
