...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19DC0110)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE_ONCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x19DC01F0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE_SHOWOVERSEACONSENTBANNERMANAGEPREFERENCESPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19DC0B90)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE_SHOWOVERSEACONSENTBANNERPRIVACYPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19DC03E0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DC1DD0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIDATASECURITYSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DC0100)
...
namespace MiHoYo::SDK::PluginUI
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUIDataSecurityService**)Il2CppClass::FromTypeDefinitionIndex(PluginUIDataSecurityService_TypeDefinitionIndex)->GetStaticField(0x26DB0);
		}
