...
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_CLOSEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19DBAFF0)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_CREATESERVICE_OFFSET UNITYSDK_OFFSET(0x19DBAA00)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_DOCLOSEDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x19DBAEE0)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_DOELEMENTDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x19DBAF00)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_MAKECLOSEDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x19DBAD70)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_MAKELISTITEMDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x19DBAE20)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_ONREGISTERTASK_OFFSET UNITYSDK_OFFSET(0x19DBAA90)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_REGISTERTASK_OFFSET UNITYSDK_OFFSET(0x19DBAAA0)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_TRYGETELEMENTACTION_OFFSET UNITYSDK_OFFSET(0x19DBAB50)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBB0A0)
