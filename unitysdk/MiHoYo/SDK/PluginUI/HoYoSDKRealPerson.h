...
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAB42760)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON_ONCLOSE_OFFSET UNITYSDK_OFFSET(0xAB42BD0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB42890)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON_SHOW_OFFSET UNITYSDK_OFFSET(0xAB42950)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__CTOR_OFFSET UNITYSDK_OFFSET(0xAB42810)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__SHOW_B__4_0_OFFSET UNITYSDK_OFFSET(0xAB42D10)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__SHOW_B__4_1_OFFSET UNITYSDK_OFFSET(0xAB42D50)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__SHOW_B__4_2_OFFSET UNITYSDK_OFFSET(0xAB42D90)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__SHOW_B__4_3_OFFSET UNITYSDK_OFFSET(0xAB42DD0)
...
namespace MiHoYo::SDK::PluginUI
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::HoYoSDKRealPerson**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKRealPerson_TypeDefinitionIndex)->GetStaticField(0x1AA00);
		}
