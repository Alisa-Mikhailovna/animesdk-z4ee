...
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_CACHECOOKIE_OFFSET UNITYSDK_OFFSET(0xAB493A0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_CLEARCOOKIES_OFFSET UNITYSDK_OFFSET(0xAB49200)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_CLOSEWEB_OFFSET UNITYSDK_OFFSET(0xAB47A20)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_EVALUATEJSSCRIPTS_OFFSET UNITYSDK_OFFSET(0xAB49FF0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_GETWEBHANDLER_OFFSET UNITYSDK_OFFSET(0xAB45AF0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_HANDLECUSTOMNOTIFYMSG_OFFSET UNITYSDK_OFFSET(0xAB47E30)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAB42E10)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_LOADURL_OFFSET UNITYSDK_OFFSET(0xAB44A30)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_NOTIFYERROR_OFFSET UNITYSDK_OFFSET(0xAB47CC0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONBEFOREBACK_OFFSET UNITYSDK_OFFSET(0xAB47780)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONBEFORECLOSE_OFFSET UNITYSDK_OFFSET(0xAB47930)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONBEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xAB47C40)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONBEFORENAVIGATIONMESSAGE_OFFSET UNITYSDK_OFFSET(0xAB471D0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONCLOSE_OFFSET UNITYSDK_OFFSET(0xAB44180)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONGETBRIDGEMESSAGE_OFFSET UNITYSDK_OFFSET(0xAB473D0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONGETUNIWEBVIEWMESSAGE_OFFSET UNITYSDK_OFFSET(0xAB46CC0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONNATIVEREADY_OFFSET UNITYSDK_OFFSET(0xAB46EC0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONNOTICECLOSE_OFFSET UNITYSDK_OFFSET(0xAB45D50)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONNOTICEPAGEFINISH_OFFSET UNITYSDK_OFFSET(0xAB45F60)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONPAGECLOSE_OFFSET UNITYSDK_OFFSET(0xAB45F80)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONPAGEERROR_OFFSET UNITYSDK_OFFSET(0xAB46AC0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONPAGEFINISH_OFFSET UNITYSDK_OFFSET(0xAB458E0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONRECEIVEMESSAGE_OFFSET UNITYSDK_OFFSET(0xAB47DF0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB43480)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_PROCCESSCACHEDEVENT_OFFSET UNITYSDK_OFFSET(0xAB487A0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_PROCCESSEVENT_OFFSET UNITYSDK_OFFSET(0xAB48160)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_REMOVEWEB_OFFSET UNITYSDK_OFFSET(0xAB46720)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_SETCOOKIES_OFFSET UNITYSDK_OFFSET(0xAB46ED0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_SHOW_OFFSET UNITYSDK_OFFSET(0xAB43540)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xAB42E60)
...
namespace MiHoYo::SDK::PluginUI
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::HoYoSDKWebView**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKWebView_TypeDefinitionIndex)->GetStaticField(0x1AA20);
		}
