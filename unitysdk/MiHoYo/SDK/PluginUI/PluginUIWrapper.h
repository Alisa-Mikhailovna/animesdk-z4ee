...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_CREATEBRIDGEELEMENT_OFFSET UNITYSDK_OFFSET(0x19DC4B10)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19DDE800)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x19DDF030)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYGETCAPTCHAFAILED_OFFSET UNITYSDK_OFFSET(0x19DDEC80)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYGETCAPTCHASUCCESS_OFFSET UNITYSDK_OFFSET(0x19DDEAA0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYHIDEELEMENTS_OFFSET UNITYSDK_OFFSET(0x19DDF020)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYSHOWELEMENTS_OFFSET UNITYSDK_OFFSET(0x19DDED50)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_NOTIFYSHOWORHIDEELEMENTS_OFFSET UNITYSDK_OFFSET(0x19DDED60)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_UPDATEGETCAPTCHAELEMENTTEXT_OFFSET UNITYSDK_OFFSET(0x19DDEBF0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER_UPDATEPLUGINUIELEMENT_OFFSET UNITYSDK_OFFSET(0x19DDE8E0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DDF160)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDE7F0)
...
namespace MiHoYo::SDK::PluginUI
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUIWrapper**)Il2CppClass::FromTypeDefinitionIndex(PluginUIWrapper_TypeDefinitionIndex)->GetStaticField(0x27A80);
		}
