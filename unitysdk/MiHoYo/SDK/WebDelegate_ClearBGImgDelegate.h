...
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E53D60)
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E53D90)
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E52760)
#define MIHOYO_SDK_WEBDELEGATE_CLEARBGIMGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E53C70)
