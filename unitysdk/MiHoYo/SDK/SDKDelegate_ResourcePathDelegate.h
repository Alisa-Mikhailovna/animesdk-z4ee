...
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E0C370)
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E0C3A0)
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E0C360)
#define MIHOYO_SDK_SDKDELEGATE_RESOURCEPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E0C2F0)
