...
#define MIHOYO_SDK_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x19D2C730)
#define MIHOYO_SDK_JSONSTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19D2C590)
#define MIHOYO_SDK_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19D2C870)
#define MIHOYO_SDK_JSONSTRING_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x19D2C580)
#define MIHOYO_SDK_JSONSTRING_GET_TAG_OFFSET UNITYSDK_OFFSET(0x19D2C570)
#define MIHOYO_SDK_JSONSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19D2C5B0)
#define MIHOYO_SDK_JSONSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19D2C5C0)
#define MIHOYO_SDK_JSONSTRING_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x19D2C5D0)
#define MIHOYO_SDK_JSONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19D27580)
