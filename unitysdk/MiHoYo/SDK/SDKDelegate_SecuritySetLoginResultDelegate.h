...
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E0C430)
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E0C460)
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E0C420)
#define MIHOYO_SDK_SDKDELEGATE_SECURITYSETLOGINRESULTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E0C3B0)
