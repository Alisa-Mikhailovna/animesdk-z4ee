...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkWriteCallback**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKNetworkNative___O_TypeDefinitionIndex)->GetStaticField(0xD620);
		}
		static ::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkProgressCallback** StaticGet__2___HoYoNetworkProgressInternalCallback()
		{
			return (::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkProgressCallback**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKNetworkNative___O_TypeDefinitionIndex)->GetStaticField(0xD628);
		}
		static ::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkHeaderCallback** StaticGet__1___HoYoNetworkHeaderInternalCallback()
		{
			return (::MiHoYo::SDK::HoYoSDKNetworkNative_HoYoNetworkHeaderCallback**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKNetworkNative___O_TypeDefinitionIndex)->GetStaticField(0xD630);
		}
	};
}
