...
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_DOHEADERCALLBACK_OFFSET UNITYSDK_OFFSET(0xAAC4640)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_DOWRITERCALLBACK_OFFSET UNITYSDK_OFFSET(0xAAC44E0)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAABE250)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKHEADERINTERNALCALLBACK_OFFSET UNITYSDK_OFFSET(0xAAC2890)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKPROGRESSINTERNALCALLBACK_OFFSET UNITYSDK_OFFSET(0xAAC28E0)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_CREATENETWORKHANDLE_OFFSET UNITYSDK_OFFSET(0xAAC29C0)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_HTTPGET_OFFSET UNITYSDK_OFFSET(0xAAC2A60)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_HTTPHEAD_OFFSET UNITYSDK_OFFSET(0xAAC2F60)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_HTTPPOST_OFFSET UNITYSDK_OFFSET(0xAAC2E30)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_HTTPREQUESTCLOSE_OFFSET UNITYSDK_OFFSET(0xAAC42D0)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_HTTPREQUESTGETRESPONSE_OFFSET UNITYSDK_OFFSET(0xAAC3E80)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_HTTPREQUESTINIT_OFFSET UNITYSDK_OFFSET(0xAAC33D0)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_HTTPREQUESTREGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xAAC3B70)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_RELEASENETWORKHANDLE_OFFSET UNITYSDK_OFFSET(0xAAC4800)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKSDK_RELEASERESPONSE_OFFSET UNITYSDK_OFFSET(0xAAC4460)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKWRITEINTERNALCALLBACK_OFFSET UNITYSDK_OFFSET(0xAAC2840)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HTTPGET_OFFSET UNITYSDK_OFFSET(0xAABE3D0)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HTTPHEAD_OFFSET UNITYSDK_OFFSET(0xAAC21B0)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HTTPPOST_1_OFFSET UNITYSDK_OFFSET(0xAAC1F50)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HTTPPOST_OFFSET UNITYSDK_OFFSET(0xAAC2D40)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HTTPREQUESTCLOSE_OFFSET UNITYSDK_OFFSET(0xAAC3F00)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HTTPREQUESTGETRESPONSE_OFFSET UNITYSDK_OFFSET(0xAAC3C20)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HTTPREQUESTINIT_1_OFFSET UNITYSDK_OFFSET(0xAAC3190)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HTTPREQUESTINIT_OFFSET UNITYSDK_OFFSET(0xAAC3070)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HTTPREQUESTREGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xAAC3560)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_INITENV_OFFSET UNITYSDK_OFFSET(0xAAC28F0)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_NATIVERESPONSESERIALIZE_OFFSET UNITYSDK_OFFSET(0xAAC2B70)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_REGISTERHEADERCALLBACK_OFFSET UNITYSDK_OFFSET(0xAAC3A50)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_REGISTERWRITECALLBACK_OFFSET UNITYSDK_OFFSET(0xAAC3930)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAAC4450)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0xAAC4350)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoSDKNetworkNative**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKNetworkNative_TypeDefinitionIndex)->GetStaticField(0xD660);
		}
