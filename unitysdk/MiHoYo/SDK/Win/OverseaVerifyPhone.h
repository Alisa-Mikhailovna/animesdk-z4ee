...
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C75B10)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_BACK_OFFSET UNITYSDK_OFFSET(0x19C77010)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_CLOSE_OFFSET UNITYSDK_OFFSET(0x19C76FF0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19C770B0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x19C76F80)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C77310)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x19C772D0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19C77110)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x19C76E80)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19C77030)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_START_OFFSET UNITYSDK_OFFSET(0x19C76CA0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_SUBMIT_OFFSET UNITYSDK_OFFSET(0x19C77130)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x19C76B10)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x19C77120)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C77330)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaVerifyPhone**)Il2CppClass::FromTypeDefinitionIndex(OverseaVerifyPhone_TypeDefinitionIndex)->GetStaticField(0x2C650);
		}
