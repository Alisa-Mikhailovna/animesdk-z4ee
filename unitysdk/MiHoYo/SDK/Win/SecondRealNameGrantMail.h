...
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C9CF60)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x19C93190)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19C9E470)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x19C8EF40)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_LOGIN_OFFSET UNITYSDK_OFFSET(0x19C9E290)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C9E4E0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_OTHERVERIFY_OFFSET UNITYSDK_OFFSET(0x19C9E450)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_REDIRECT_OFFSET UNITYSDK_OFFSET(0x19C9E430)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x19C9E260)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19C9E250)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x19C8F5C0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19C93120)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_START_OFFSET UNITYSDK_OFFSET(0x19C9E130)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x19C9DFB0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19C9DE30)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C9E500)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SecondRealNameGrantMail**)Il2CppClass::FromTypeDefinitionIndex(SecondRealNameGrantMail_TypeDefinitionIndex)->GetStaticField(0x32440);
		}
