...
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C9E810)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_BACK_OFFSET UNITYSDK_OFFSET(0x19C92120)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19C9FD20)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x19C8E640)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_LOGIN_OFFSET UNITYSDK_OFFSET(0x19C9FB40)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C9FD90)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_OTHERVERIFY_OFFSET UNITYSDK_OFFSET(0x19C9FD00)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_REDIRECT_OFFSET UNITYSDK_OFFSET(0x19C9FCE0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x19C9FB10)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19C9FB00)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x19C8ECC0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19C920A0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_START_OFFSET UNITYSDK_OFFSET(0x19C9F9E0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x19C9F860)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19C9F6E0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C9FDB0)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SecondRealnameGrantPhone**)Il2CppClass::FromTypeDefinitionIndex(SecondRealnameGrantPhone_TypeDefinitionIndex)->GetStaticField(0x32330);
		}
