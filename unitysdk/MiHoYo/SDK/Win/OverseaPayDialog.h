...
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C636F0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_BACK_OFFSET UNITYSDK_OFFSET(0x19C65EB0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKAMEXVENDOR_OFFSET UNITYSDK_OFFSET(0x19C65D50)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKECMCVENDOR_OFFSET UNITYSDK_OFFSET(0x19C65D40)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKJCBVENDOR_OFFSET UNITYSDK_OFFSET(0x19C65D60)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYBUTTON_OFFSET UNITYSDK_OFFSET(0x19C65D80)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYPALVENDOR_OFFSET UNITYSDK_OFFSET(0x19C65D70)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYSUCCESSBUTTON_OFFSET UNITYSDK_OFFSET(0x19C65E10)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYTYPEBUTTON_OFFSET UNITYSDK_OFFSET(0x19C65D20)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKVISAVENDOR_OFFSET UNITYSDK_OFFSET(0x19C65D30)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_HIDEBUYLOADING_OFFSET UNITYSDK_OFFSET(0x19C65C50)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x19C61A70)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C65FF0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_REFRESHPAYINFO_OFFSET UNITYSDK_OFFSET(0x19C61BE0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_REFRESH_OFFSET UNITYSDK_OFFSET(0x19C65D00)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SETVENDORS_OFFSET UNITYSDK_OFFSET(0x19C65C40)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOWBUYLOADING_OFFSET UNITYSDK_OFFSET(0x19C65DE0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOWNETWORKERROR_OFFSET UNITYSDK_OFFSET(0x19C65C80)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOWPAYSUCCESS_OFFSET UNITYSDK_OFFSET(0x19C65E30)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x19C61950)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_START_OFFSET UNITYSDK_OFFSET(0x19C61B60)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19C65450)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG__BACK_B__87_0_OFFSET UNITYSDK_OFFSET(0x19C66060)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C66010)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaPayDialog**)Il2CppClass::FromTypeDefinitionIndex(OverseaPayDialog_TypeDefinitionIndex)->GetStaticField(0x30D60);
		}
