...
#define MIHOYO_SDK_WIN_SECONDREALNAME_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C9B890)
#define MIHOYO_SDK_WIN_SECONDREALNAME_BACK_OFFSET UNITYSDK_OFFSET(0x19C9CB90)
#define MIHOYO_SDK_WIN_SECONDREALNAME_CLICKBACKBUTTON_OFFSET UNITYSDK_OFFSET(0x19C9C780)
#define MIHOYO_SDK_WIN_SECONDREALNAME_GETALERTCONTENT_OFFSET UNITYSDK_OFFSET(0x19C9C970)
#define MIHOYO_SDK_WIN_SECONDREALNAME_GETIDENTITYINPUTTEXT_OFFSET UNITYSDK_OFFSET(0x19C91210)
#define MIHOYO_SDK_WIN_SECONDREALNAME_GETNAMEINPUTTEXT_OFFSET UNITYSDK_OFFSET(0x19C911F0)
#define MIHOYO_SDK_WIN_SECONDREALNAME_HIDE_OFFSET UNITYSDK_OFFSET(0x19C8C320)
#define MIHOYO_SDK_WIN_SECONDREALNAME_MEETPROBLEM_OFFSET UNITYSDK_OFFSET(0x19C9CAD0)
#define MIHOYO_SDK_WIN_SECONDREALNAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C9CE70)
#define MIHOYO_SDK_WIN_SECONDREALNAME_SHOW_OFFSET UNITYSDK_OFFSET(0x19C8CCA0)
#define MIHOYO_SDK_WIN_SECONDREALNAME_SUBMIT_OFFSET UNITYSDK_OFFSET(0x19C9CBB0)
#define MIHOYO_SDK_WIN_SECONDREALNAME_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19C9C120)
#define MIHOYO_SDK_WIN_SECONDREALNAME__CLICKBACKBUTTON_B__27_0_OFFSET UNITYSDK_OFFSET(0x19C9CED0)
#define MIHOYO_SDK_WIN_SECONDREALNAME__CLICKBACKBUTTON_B__27_1_OFFSET UNITYSDK_OFFSET(0x19C9CF00)
#define MIHOYO_SDK_WIN_SECONDREALNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x19C9CE90)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SecondRealName**)Il2CppClass::FromTypeDefinitionIndex(SecondRealName_TypeDefinitionIndex)->GetStaticField(0x32090);
		}
