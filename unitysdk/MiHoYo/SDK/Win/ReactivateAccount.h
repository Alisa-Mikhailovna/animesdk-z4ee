...
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C88B40)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_CLOSE_OFFSET UNITYSDK_OFFSET(0x19C89450)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_HIDE_OFFSET UNITYSDK_OFFSET(0x19C893E0)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C89490)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_SHOW_OFFSET UNITYSDK_OFFSET(0x19C889E0)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_SUBMIT_OFFSET UNITYSDK_OFFSET(0x19C89470)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19C89090)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C894B0)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::ReactivateAccount**)Il2CppClass::FromTypeDefinitionIndex(ReactivateAccount_TypeDefinitionIndex)->GetStaticField(0x1A990);
		}
