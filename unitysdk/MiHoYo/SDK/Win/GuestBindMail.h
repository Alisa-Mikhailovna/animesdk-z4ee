...
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x19EC9900)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x19ECA5B0)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x19ECA5F0)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x19ECA5D0)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_FORGETPASSWORD_OFFSET UNITYSDK_OFFSET(0x19ECA850)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x19EC9860)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19ECA890)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_REGISTER_OFFSET UNITYSDK_OFFSET(0x19ECA870)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_SETMAILINPUTTEXT_OFFSET UNITYSDK_OFFSET(0x19EC98D0)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x19EC9700)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19ECA5A0)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x19ECA8B0)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::GuestBindMail**)Il2CppClass::FromTypeDefinitionIndex(GuestBindMail_TypeDefinitionIndex)->GetStaticField(0x2C8D0);
		}
