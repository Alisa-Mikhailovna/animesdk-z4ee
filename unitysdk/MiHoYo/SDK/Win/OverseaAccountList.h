...
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C566C0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_CHECKACCOUNTLISTDROPDOWN_OFFSET UNITYSDK_OFFSET(0x19C590D0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_CLOSE_OFFSET UNITYSDK_OFFSET(0x19C592B0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_DELETEACCOUNT_1_OFFSET UNITYSDK_OFFSET(0x19C58F40)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_DELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x19C58B80)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_HIDE_OFFSET UNITYSDK_OFFSET(0x19C589D0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_LOADACCOUNTINFODATA_OFFSET UNITYSDK_OFFSET(0x19C578A0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_LOGINOTHERACCOUNT_OFFSET UNITYSDK_OFFSET(0x19C59300)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_ONACCOUNTSELECTED_OFFSET UNITYSDK_OFFSET(0x19C58630)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_ONCOLLAPSELIST_OFFSET UNITYSDK_OFFSET(0x19C58560)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_ONCONFIRMBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x19C592D0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_ONDELETEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x19C58A40)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C59320)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_ONNOTICEEXPANDDROPDOWN_OFFSET UNITYSDK_OFFSET(0x19C58490)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_SHOW_OFFSET UNITYSDK_OFFSET(0x19C58100)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_START_OFFSET UNITYSDK_OFFSET(0x19C57470)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_UPDATECURRENTACCOUNTICON_OFFSET UNITYSDK_OFFSET(0x19C588A0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_UPDATEDROPDOWNTITLE_OFFSET UNITYSDK_OFFSET(0x19C582D0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19C57650)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19C59340)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLIST__ONDELETEBUTTONCLICKED_B__48_0_OFFSET UNITYSDK_OFFSET(0x19C59380)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaAccountList**)Il2CppClass::FromTypeDefinitionIndex(OverseaAccountList_TypeDefinitionIndex)->GetStaticField(0x2C160);
		}
