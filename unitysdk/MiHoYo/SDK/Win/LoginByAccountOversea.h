...
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_AWAKE_OFFSET UNITYSDK_OFFSET(0x19ED1D00)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_CLICKAPPLEBUTTON_OFFSET UNITYSDK_OFFSET(0x19ED4DC0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x19ED5180)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_CLICKFACEBOOKBUTTON_OFFSET UNITYSDK_OFFSET(0x19ED4FA0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_CLICKFORGETPASSWORDBUTTON_OFFSET UNITYSDK_OFFSET(0x19ED5230)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_CLICKGOOGLEBUTTON_OFFSET UNITYSDK_OFFSET(0x19ED4EB0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x19ED4560)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_CLICKREGISTERBUTTON_OFFSET UNITYSDK_OFFSET(0x19ED51A0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_CLICKTWITTERBUTTON_OFFSET UNITYSDK_OFFSET(0x19ED5090)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_GUESTLOGIN_OFFSET UNITYSDK_OFFSET(0x19ED4D40)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_HIDE_OFFSET UNITYSDK_OFFSET(0x19ED44F0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_ONBACKBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x19ED4D10)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19ED52C0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_SHOW_OFFSET UNITYSDK_OFFSET(0x19ED4320)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_START_OFFSET UNITYSDK_OFFSET(0x19ED4B70)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_UPDATEBACKBTN_OFFSET UNITYSDK_OFFSET(0x19ED4BA0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_UPDATEBOTTOMCONTENT_OFFSET UNITYSDK_OFFSET(0x19ED3290)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19ED3F50)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNTOVERSEA__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED52E0)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByAccountOversea**)Il2CppClass::FromTypeDefinitionIndex(LoginByAccountOversea_TypeDefinitionIndex)->GetStaticField(0x2F350);
		}
