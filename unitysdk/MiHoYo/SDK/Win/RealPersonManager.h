...
#define MIHOYO_SDK_WIN_REALPERSONMANAGER_CHECKREALPERSON_OFFSET UNITYSDK_OFFSET(0x19C94CB0)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER_HIDEREALPERSON_OFFSET UNITYSDK_OFFSET(0x19C95320)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER_MEETPROBLEM_OFFSET UNITYSDK_OFFSET(0x19C955B0)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER_MEETRULE_OFFSET UNITYSDK_OFFSET(0x19C95720)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER_NOTVERIFY_OFFSET UNITYSDK_OFFSET(0x19C95890)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER_SHOWREALPERSONPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19C94E20)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER_SHOW_OFFSET UNITYSDK_OFFSET(0x19C94D10)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C95A50)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C95A40)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER__NOTVERIFY_B__9_0_OFFSET UNITYSDK_OFFSET(0x19C95C30)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER__SHOWREALPERSONPLUGINUI_B__5_0_OFFSET UNITYSDK_OFFSET(0x19C95B10)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER__SHOWREALPERSONPLUGINUI_B__5_1_OFFSET UNITYSDK_OFFSET(0x19C95B50)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER__SHOWREALPERSONPLUGINUI_B__5_2_OFFSET UNITYSDK_OFFSET(0x19C95B60)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER__SHOWREALPERSONPLUGINUI_B__5_3_OFFSET UNITYSDK_OFFSET(0x19C95B70)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER__SHOW_B__4_0_OFFSET UNITYSDK_OFFSET(0x19C95A90)
#define MIHOYO_SDK_WIN_REALPERSONMANAGER__SHOW_B__4_1_OFFSET UNITYSDK_OFFSET(0x19C95AD0)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::RealPersonManager**)Il2CppClass::FromTypeDefinitionIndex(RealPersonManager_TypeDefinitionIndex)->GetStaticField(0x2C7E0);
		}
