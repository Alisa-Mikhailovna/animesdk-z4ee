...
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19C4A9D0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_ISNATIVETASKSWITCHENABLE_OFFSET UNITYSDK_OFFSET(0x19C54760)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_ONSYNCDATATONATIVE_OFFSET UNITYSDK_OFFSET(0x19C53EA0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19C53E60)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCCOMBOLOGINDATATONATIVE_OFFSET UNITYSDK_OFFSET(0x19C54550)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCCURENVCONFIGTONATIVE_OFFSET UNITYSDK_OFFSET(0x19C53F70)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCGAMEROLETONATIVE_OFFSET UNITYSDK_OFFSET(0x19C53FE0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCNOTICELANGTONATIVE_OFFSET UNITYSDK_OFFSET(0x19C54030)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_SYNCNOTICEURLTONATIVE_OFFSET UNITYSDK_OFFSET(0x19C542A0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYCHECKPOPNOTICE_OFFSET UNITYSDK_OFFSET(0x19C4AA80)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYMANUALLYCLOSE_OFFSET UNITYSDK_OFFSET(0x19C4D5A0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYONSETSERVERID_OFFSET UNITYSDK_OFFSET(0x19C514B0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYREQUESTREDPOINTTEXT_OFFSET UNITYSDK_OFFSET(0x19C4BD20)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYSHOWNOTICE_OFFSET UNITYSDK_OFFSET(0x19C4CF50)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE_TRYSHOWPOPNOTICE_OFFSET UNITYSDK_OFFSET(0x19C4D1E0)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C54820)
#define MIHOYO_SDK_WIN_NOTICEMANAGER_NATIVENOTICE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C53BF0)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::NoticeManager_NativeNotice**)Il2CppClass::FromTypeDefinitionIndex(NoticeManager_NativeNotice_TypeDefinitionIndex)->GetStaticField(0x30980);
		}
