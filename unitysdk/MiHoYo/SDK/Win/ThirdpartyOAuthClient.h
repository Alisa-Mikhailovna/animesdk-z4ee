...
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ADD_ONAUTHCOMPLETE_OFFSET UNITYSDK_OFFSET(0x19CA6440)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ENTERWAITINGSTAGE_OFFSET UNITYSDK_OFFSET(0x19CA7260)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_GETRANDOMUNUSEDPORT_OFFSET UNITYSDK_OFFSET(0x19CA78E0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_HIDETHIRDPARTYOAUTH_OFFSET UNITYSDK_OFFSET(0x19CA7330)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ONAUTHFAILED_OFFSET UNITYSDK_OFFSET(0x19CA90A0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ONAUTHSUCCEED_OFFSET UNITYSDK_OFFSET(0x19CA9940)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ONCONTEXTCALLBACK_OFFSET UNITYSDK_OFFSET(0x19CA9C40)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_ONWAITINGTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19CA8810)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_REMOVE_ONAUTHCOMPLETE_OFFSET UNITYSDK_OFFSET(0x19CA64C0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_SHOWLOGINPAGE_OFFSET UNITYSDK_OFFSET(0x19CA66C0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_SHOWTHIRDPARTYOAUTHPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19CA6C90)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_STARTAPPLEOAUTH_OFFSET UNITYSDK_OFFSET(0x19CA6590)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_STARTCALLBACKLISTENER_OFFSET UNITYSDK_OFFSET(0x19CA7540)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_STARTFACEBOOKOAUTH_OFFSET UNITYSDK_OFFSET(0x19CA6A00)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_STARTGOOGLEOAUTH_OFFSET UNITYSDK_OFFSET(0x19CA68D0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_STARTTIMEOUTMONITOR_OFFSET UNITYSDK_OFFSET(0x19CA79C0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_STARTTWITTEROAUTH_OFFSET UNITYSDK_OFFSET(0x19CA6A10)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_STOPCALLBACKLISTENER_OFFSET UNITYSDK_OFFSET(0x19CA6C10)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_STOPTIMEOUTMONITOR_OFFSET UNITYSDK_OFFSET(0x19CA6B50)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_STOP_OFFSET UNITYSDK_OFFSET(0x19CA6A20)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT_UPDATEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19CA8310)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA6540)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT__SHOWLOGINPAGE_B__22_0_OFFSET UNITYSDK_OFFSET(0x19CAA4E0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT__SHOWLOGINPAGE_B__22_1_OFFSET UNITYSDK_OFFSET(0x19CAA740)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT__SHOWTHIRDPARTYOAUTHPLUGINUI_B__23_0_OFFSET UNITYSDK_OFFSET(0x19CAA750)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHCLIENT__SHOWTHIRDPARTYOAUTHPLUGINUI_B__23_1_OFFSET UNITYSDK_OFFSET(0x19CAA760)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OAuthType*)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyOAuthClient_TypeDefinitionIndex)->GetStaticField(0x88F0);
		}
