...
#define MIHOYO_SDK_WIN_LOGINBYPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x19ED9760)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKACCOUNTLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDD1D0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDCC10)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDCC50)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKGUESTBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDD0E0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDCCB0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKQRCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDCC30)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKSAVERECORDTOGGLE_OFFSET UNITYSDK_OFFSET(0x19EDD3D0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKTAPTAPBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDD1F0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKTOGGLE_OFFSET UNITYSDK_OFFSET(0x19EDD3B0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKUSERAGREEMENTBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDD2F0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKUSERPRIVACYBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDD350)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19EDCB90)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x19EDC850)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19EDD3F0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19EDC730)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_PHONEINPUTVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x19EDC8C0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19EDCC00)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_RESETVERIFYCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x19EDD470)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x19EDC750)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19EDCB10)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_START_OFFSET UNITYSDK_OFFSET(0x19EDC700)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATEBOTTOMCONTENT_OFFSET UNITYSDK_OFFSET(0x19EDB560)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATECODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x19EDC8D0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATESAVERECORDTIPS_OFFSET UNITYSDK_OFFSET(0x19EDB970)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x19EDBF70)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATETOGGLESTATUS_OFFSET UNITYSDK_OFFSET(0x19EDD440)
#define MIHOYO_SDK_WIN_LOGINBYPHONE__AWAKE_B__43_0_OFFSET UNITYSDK_OFFSET(0x19EDD4D0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x19EDD490)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByPhone**)Il2CppClass::FromTypeDefinitionIndex(LoginByPhone_TypeDefinitionIndex)->GetStaticField(0x1A4B0);
		}
