...
#define MIHOYO_SDK_ASSETUTIL_ASBUNLOAD_OFFSET UNITYSDK_OFFSET(0xAA8CD10)
#define MIHOYO_SDK_ASSETUTIL_CALLMETHODWITHPARAMETERS_OFFSET UNITYSDK_OFFSET(0xAA8D140)
#define MIHOYO_SDK_ASSETUTIL_CREATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xAA8C910)
#define MIHOYO_SDK_ASSETUTIL_DESTROYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xAA8CA60)
#define MIHOYO_SDK_ASSETUTIL_GETASSETASBFULLPATH_OFFSET UNITYSDK_OFFSET(0xAA8CCD0)
#define MIHOYO_SDK_ASSETUTIL_HASMETHODWITHPARAMETERS_OFFSET UNITYSDK_OFFSET(0xAA8CE10)
#define MIHOYO_SDK_ASSETUTIL_LOADFROMASB_OFFSET UNITYSDK_OFFSET(0xAA8CA80)
#define MIHOYO_SDK_ASSETUTIL_LOADJSONFILE_OFFSET UNITYSDK_OFFSET(0xAA8CD70)
#define MIHOYO_SDK_ASSETUTIL_LOADRESOURCE_OFFSET UNITYSDK_OFFSET(0xAA8C9C0)
#define MIHOYO_SDK_ASSETUTIL__CCTOR_OFFSET UNITYSDK_OFFSET(0xAA8D480)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::UnityEngine::AssetBundle**)Il2CppClass::FromTypeDefinitionIndex(AssetUtil_TypeDefinitionIndex)->GetStaticField(0x9C50);
		}
		static ::System::String** StaticGet_MiHoYoSDKAsbPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(AssetUtil_TypeDefinitionIndex)->GetStaticField(0x9C58);
		}
