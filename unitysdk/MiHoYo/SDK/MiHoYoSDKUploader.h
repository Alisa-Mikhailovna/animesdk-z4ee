...
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_COMBOSIGN_OFFSET UNITYSDK_OFFSET(0xAB0E980)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_GETSIGNAPPKEY_OFFSET UNITYSDK_OFFSET(0xAB0DDA0)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_GETSTSBYCOMBOTOKENURL_OFFSET UNITYSDK_OFFSET(0xAB0D910)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_GET_ENV_OFFSET UNITYSDK_OFFSET(0xAB0D060)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAB0D0A0)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0xAB0D000)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_ONCALLBACK_OFFSET UNITYSDK_OFFSET(0xAB0E000)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_ONGETCALLBACK_OFFSET UNITYSDK_OFFSET(0xAB0F730)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_ONGETTIMEOUT_OFFSET UNITYSDK_OFFSET(0xAB0FCA0)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_POSTREQUEST_OFFSET UNITYSDK_OFFSET(0xAB0DAF0)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_POST_OFFSET UNITYSDK_OFFSET(0xAB0E030)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_SETUPUPLOADER_OFFSET UNITYSDK_OFFSET(0xAB0D480)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_SHAREDHEADERS_OFFSET UNITYSDK_OFFSET(0xAB0E0D0)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_UPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0xAB0D380)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER_UPLOADFILE_OFFSET UNITYSDK_OFFSET(0xAB0D280)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB0FCE0)
#define MIHOYO_SDK_MIHOYOSDKUPLOADER__SETUPUPLOADER_B__13_0_OFFSET UNITYSDK_OFFSET(0xAB0FCF0)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::MiHoYoSDKUploader**)Il2CppClass::FromTypeDefinitionIndex(MiHoYoSDKUploader_TypeDefinitionIndex)->GetStaticField(0x106E0);
		}
