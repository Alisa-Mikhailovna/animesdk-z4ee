...
#define MIHOYO_SDK_AGEGATETICKETMODEL_AGEGATEFLOWTYPETOSTRING_OFFSET UNITYSDK_OFFSET(0x19B9CC80)
#define MIHOYO_SDK_AGEGATETICKETMODEL_EXPIRETIMETOTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x19B9CCD0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_BIRTHDAY_OFFSET UNITYSDK_OFFSET(0x19B9CB40)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x19B9CB80)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_COUNTRY_OFFSET UNITYSDK_OFFSET(0x19B9CAE0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_EXPIRETIME_OFFSET UNITYSDK_OFFSET(0x19B9CB60)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x19B9CB00)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x19B9CBA0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_TICKETID_OFFSET UNITYSDK_OFFSET(0x19B9CAC0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19B9CB20)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_BIRTHDAY_OFFSET UNITYSDK_OFFSET(0x19B9CB50)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x19B9CB90)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_COUNTRY_OFFSET UNITYSDK_OFFSET(0x19B9CAF0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_EXPIRETIME_OFFSET UNITYSDK_OFFSET(0x19B9CB70)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x19B9CB10)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x19B9CBB0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_TICKETID_OFFSET UNITYSDK_OFFSET(0x19B9CAD0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19B9CB30)
#define MIHOYO_SDK_AGEGATETICKETMODEL_TOLOGSTRING_OFFSET UNITYSDK_OFFSET(0x19B9CF40)
#define MIHOYO_SDK_AGEGATETICKETMODEL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B9CCE0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_USERTICKETSTATUSTOSTRING_OFFSET UNITYSDK_OFFSET(0x19B9CC30)
#define MIHOYO_SDK_AGEGATETICKETMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9CBC0)
