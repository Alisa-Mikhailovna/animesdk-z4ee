...
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_ANALYZERRESULTTOJSON_OFFSET UNITYSDK_OFFSET(0xAB56020)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_BUILDJSON_1_OFFSET UNITYSDK_OFFSET(0xAB55E50)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_BUILDJSON_OFFSET UNITYSDK_OFFSET(0xAB55B40)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_CREATEEMPTYNOTE_OFFSET UNITYSDK_OFFSET(0xAB55E10)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_FILLHEADERS_OFFSET UNITYSDK_OFFSET(0xAB56940)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB56E70)
