...
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_CLOSEWEBPAGE_OFFSET UNITYSDK_OFFSET(0x19D1E080)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_GETURL_OFFSET UNITYSDK_OFFSET(0x19D206C0)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_ONERRORCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D21910)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_ONPAGECLOSED_OFFSET UNITYSDK_OFFSET(0x19D20FD0)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_ONRESULTCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D210B0)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_OPENWEBPAGE_OFFSET UNITYSDK_OFFSET(0x19CF1270)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D22020)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D22010)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__OPENWEBPAGE_B__7_0_OFFSET UNITYSDK_OFFSET(0x19D22070)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__OPENWEBPAGE_B__7_2_OFFSET UNITYSDK_OFFSET(0x19D22090)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__OPENWEBPAGE_B__7_3_OFFSET UNITYSDK_OFFSET(0x19D220A0)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__OPENWEBPAGE_B__7_4_OFFSET UNITYSDK_OFFSET(0x19D220B0)
...
namespace MiHoYo::SDK::HoYoPass
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoPass::WebPageManager**)Il2CppClass::FromTypeDefinitionIndex(WebPageManager_TypeDefinitionIndex)->GetStaticField(0x20AD0);
		}
