...
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CLOSEGEETESTV4WEBVIEW_OFFSET UNITYSDK_OFFSET(0x19D1CAE0)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CREATERISKCHECK_1_OFFSET UNITYSDK_OFFSET(0x19D1C220)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CREATERISKCHECK_2_OFFSET UNITYSDK_OFFSET(0x19D1BDF0)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_CREATERISKCHECK_OFFSET UNITYSDK_OFFSET(0x19D01D20)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ISGEETESTV4_OFFSET UNITYSDK_OFFSET(0x19D01B50)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONGETGEETESTRESULT_OFFSET UNITYSDK_OFFSET(0x19D1C390)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONPAGERESULTCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D1C5F0)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONWEBPAGECLOSE_OFFSET UNITYSDK_OFFSET(0x19D1CC40)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER_ONWEBPAGEERROR_OFFSET UNITYSDK_OFFSET(0x19D1CC90)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D1CF10)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER__CREATERISKCHECK_B__8_0_OFFSET UNITYSDK_OFFSET(0x19D1CF60)
#define MIHOYO_SDK_HOYOPASS_RISKCHECKMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D1CF00)
...
namespace MiHoYo::SDK::HoYoPass
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoPass::RiskCheckManager**)Il2CppClass::FromTypeDefinitionIndex(RiskCheckManager_TypeDefinitionIndex)->GetStaticField(0x21260);
		}
