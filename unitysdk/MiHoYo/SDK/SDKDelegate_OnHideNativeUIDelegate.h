...
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E0C1C0)
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E0C200)
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E0C1B0)
#define MIHOYO_SDK_SDKDELEGATE_ONHIDENATIVEUIDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E0C130)
