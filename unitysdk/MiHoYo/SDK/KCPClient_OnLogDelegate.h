...
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAAD19C0)
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAAD1A20)
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xAAD11B0)
#define MIHOYO_SDK_KCPCLIENT_ONLOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xAAD1950)
