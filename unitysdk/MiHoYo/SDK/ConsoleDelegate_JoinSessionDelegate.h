...
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19CE58A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19CE58E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19CE5890)
#define MIHOYO_SDK_CONSOLEDELEGATE_JOINSESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE5810)
