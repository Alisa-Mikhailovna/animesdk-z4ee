...
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ADDITEM_OFFSET UNITYSDK_OFFSET(0xAB52240)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ADD_FULLED_OFFSET UNITYSDK_OFFSET(0xAB52080)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ANALYZE_OFFSET UNITYSDK_OFFSET(0xAB52350)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_BEGIN_OFFSET UNITYSDK_OFFSET(0xAB524C0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_CALCULATEAVERAGEVALUE_OFFSET UNITYSDK_OFFSET(0xAB526A0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_CLEARDATAS_OFFSET UNITYSDK_OFFSET(0xAB523A0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_END_OFFSET UNITYSDK_OFFSET(0xAB508F0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_ANALYZER_OFFSET UNITYSDK_OFFSET(0xAB51D00)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_ASCENDINGANALYZE_OFFSET UNITYSDK_OFFSET(0xAB51CF0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xAB50CD0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_CURRENTITEM_OFFSET UNITYSDK_OFFSET(0xAB50AA0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_ITEMDURATIONS_OFFSET UNITYSDK_OFFSET(0xAB51D10)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_GET_TOTALMILLISECONDS_OFFSET UNITYSDK_OFFSET(0xAB50D60)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_ITEM_OFFSET UNITYSDK_OFFSET(0xAB50A50)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_REMOVE_FULLED_OFFSET UNITYSDK_OFFSET(0xAB520E0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_RESETDATA_OFFSET UNITYSDK_OFFSET(0xAB52150)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE_SORTITEMS_OFFSET UNITYSDK_OFFSET(0xAB52940)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERDATASEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xAB52140)
