...
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_ENUMWINDOWS_OFFSET UNITYSDK_OFFSET(0xAADFFD0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_GETPARENT_OFFSET UNITYSDK_OFFSET(0xAAE00A0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_GETPROCESSWND_OFFSET UNITYSDK_OFFSET(0xAAE0300)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_GETWINDOWTHREADPROCESSID_OFFSET UNITYSDK_OFFSET(0xAAE0170)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_ISWINDOWVISIBLE_OFFSET UNITYSDK_OFFSET(0xAAE0280)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKINIT_OFFSET UNITYSDK_OFFSET(0xAADFC30)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKLOGIN_OFFSET UNITYSDK_OFFSET(0xAADFD80)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKLOGOUT_OFFSET UNITYSDK_OFFSET(0xAADFF50)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKPAY_OFFSET UNITYSDK_OFFSET(0xAADFE10)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKSTARTHEARTBEAT_OFFSET UNITYSDK_OFFSET(0xAADFEC0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKUNINIT_OFFSET UNITYSDK_OFFSET(0xAADFD00)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SETLASTERROR_OFFSET UNITYSDK_OFFSET(0xAAE0200)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_WINDOWPROCCESS_OFFSET UNITYSDK_OFFSET(0xAADF8F0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0xAAE05E0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xAAE05D0)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(MiHoYoSDKBiliBiliInterface_TypeDefinitionIndex)->GetStaticField(0x5120);
		}
