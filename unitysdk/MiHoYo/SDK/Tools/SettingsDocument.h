...
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GETFEATURE_OFFSET UNITYSDK_OFFSET(0x1D2642D0)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GETSDKFOLDER_OFFSET UNITYSDK_OFFSET(0x1D264210)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GET_BROADCASTURL_OFFSET UNITYSDK_OFFSET(0x1D263DA0)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_GET_SERIALIZEDFROMFILE_OFFSET UNITYSDK_OFFSET(0x1D263DD0)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_ISBROADCASTURL_OFFSET UNITYSDK_OFFSET(0x1D264290)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D263F10)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_SET_BROADCASTURL_OFFSET UNITYSDK_OFFSET(0x1D263DC0)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT_STRINGCONTAINSANY_OFFSET UNITYSDK_OFFSET(0x1D263DE0)
#define MIHOYO_SDK_TOOLS_SETTINGSDOCUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2644E0)
