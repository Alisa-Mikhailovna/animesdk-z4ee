...
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E43E90)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING_HIDE_OFFSET UNITYSDK_OFFSET(0x19E428B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19E449C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING_SHOWFAILEDSTAGE_OFFSET UNITYSDK_OFFSET(0x19E43910)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING_SHOWTIMEOUTSTAGE_OFFSET UNITYSDK_OFFSET(0x19E433A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING_SHOWWAITINGSTAGE_OFFSET UNITYSDK_OFFSET(0x19E42AE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING_SHOW_OFFSET UNITYSDK_OFFSET(0x19E42990)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING__CTOR_OFFSET UNITYSDK_OFFSET(0x19E449F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING__SHOWFAILEDSTAGE_B__33_0_OFFSET UNITYSDK_OFFSET(0x19E44AB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING__SHOWFAILEDSTAGE_B__33_1_OFFSET UNITYSDK_OFFSET(0x19E44AD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING__SHOWTIMEOUTSTAGE_B__32_0_OFFSET UNITYSDK_OFFSET(0x19E44A70)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING__SHOWTIMEOUTSTAGE_B__32_1_OFFSET UNITYSDK_OFFSET(0x19E44A90)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING__SHOWWAITINGSTAGE_B__31_0_OFFSET UNITYSDK_OFFSET(0x19E44A30)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHWAITING__SHOWWAITINGSTAGE_B__31_1_OFFSET UNITYSDK_OFFSET(0x19E44A50)
...
namespace MiHoYo::SDK::UI::Internal::OS
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::ThirdpartyOAuthWaiting**)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyOAuthWaiting_TypeDefinitionIndex)->GetStaticField(0x2B0E0);
		}
		static ::MiHoYo::SDK::UI::Internal::OS::OAuthType* StaticGet_AuthType()
		{
			return (::MiHoYo::SDK::UI::Internal::OS::OAuthType*)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyOAuthWaiting_TypeDefinitionIndex)->GetStaticField(0x7BD0);
		}
