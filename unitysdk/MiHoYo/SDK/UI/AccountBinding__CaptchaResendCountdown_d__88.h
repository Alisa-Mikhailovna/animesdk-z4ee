...
#define MIHOYO_SDK_UI_ACCOUNTBINDING__CAPTCHARESENDCOUNTDOWN_D__88_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19E22980)
#define MIHOYO_SDK_UI_ACCOUNTBINDING__CAPTCHARESENDCOUNTDOWN_D__88_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E22AD0)
#define MIHOYO_SDK_UI_ACCOUNTBINDING__CAPTCHARESENDCOUNTDOWN_D__88_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E22B30)
#define MIHOYO_SDK_UI_ACCOUNTBINDING__CAPTCHARESENDCOUNTDOWN_D__88_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19E22AE0)
#define MIHOYO_SDK_UI_ACCOUNTBINDING__CAPTCHARESENDCOUNTDOWN_D__88_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E22970)
#define MIHOYO_SDK_UI_ACCOUNTBINDING__CAPTCHARESENDCOUNTDOWN_D__88__CTOR_OFFSET UNITYSDK_OFFSET(0x19E221B0)
