...
#define MIHOYO_SDK_UI_BINDINGWELCOME_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E29520)
#define MIHOYO_SDK_UI_BINDINGWELCOME_BINDEXISTINGACCOUNT_OFFSET UNITYSDK_OFFSET(0x19E2A720)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CANCELCREATENEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x19E2A790)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CLOSE_OFFSET UNITYSDK_OFFSET(0x19E2A7A0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CONFIRMCREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x19E2A740)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x19E2A780)
#define MIHOYO_SDK_UI_BINDINGWELCOME_HIDE_OFFSET UNITYSDK_OFFSET(0x19E2A920)
#define MIHOYO_SDK_UI_BINDINGWELCOME_ONBINDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x19E2A6E0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_ONSKIPORCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x19E2A760)
#define MIHOYO_SDK_UI_BINDINGWELCOME_SHOWBINDMODESELECTION_OFFSET UNITYSDK_OFFSET(0x19E29F70)
#define MIHOYO_SDK_UI_BINDINGWELCOME_SHOWNEWACCOUNTPROMPT_OFFSET UNITYSDK_OFFSET(0x19E2A2A0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_SHOW_OFFSET UNITYSDK_OFFSET(0x19E2A7C0)
#define MIHOYO_SDK_UI_BINDINGWELCOME__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2A990)
...
namespace MiHoYo::SDK::UI
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::BindingWelcome**)Il2CppClass::FromTypeDefinitionIndex(BindingWelcome_TypeDefinitionIndex)->GetStaticField(0x2A830);
		}
