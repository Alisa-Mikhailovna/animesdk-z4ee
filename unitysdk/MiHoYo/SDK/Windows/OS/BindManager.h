...
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_BINDEMAIL_OFFSET UNITYSDK_OFFSET(0x19CBA790)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_BINDEXISTINGACCOUNT_OFFSET UNITYSDK_OFFSET(0x19CB8D80)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_CREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x19CB9480)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x19CB8BE0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETACCOUNTPRIVACYPROTOCOLURL_OFFSET UNITYSDK_OFFSET(0x19CBBA80)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETACCOUNTUSERAGREEMENTURL_OFFSET UNITYSDK_OFFSET(0x19CBB800)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x19CB97F0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x19CB9EF0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETCHANNELNICKNAME_OFFSET UNITYSDK_OFFSET(0x19CBB560)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x19CBC610)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19CB7EF0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GET_RSAKEY_OFFSET UNITYSDK_OFFSET(0x19CB8290)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_LOGINAFTERSUCCESSFULBINDING_OFFSET UNITYSDK_OFFSET(0x19CB94A0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_LOGINBYEMAILCAPTCHA_OFFSET UNITYSDK_OFFSET(0x19CBA200)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x19CB8620)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_ONCLOSEDIALOG_OFFSET UNITYSDK_OFFSET(0x19CBB470)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_PERFORMBINDINGFLOW_OFFSET UNITYSDK_OFFSET(0x19CBA160)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_QUERYWEBBINDINGRESULT_OFFSET UNITYSDK_OFFSET(0x19CB9960)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REACTIVATEACCOUNT_OFFSET UNITYSDK_OFFSET(0x19CBA8F0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REMOVESPACES_OFFSET UNITYSDK_OFFSET(0x19CBA120)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTBINDTHIRDPARTY_OFFSET UNITYSDK_OFFSET(0x19CBC240)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTCREATEACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x19CB9810)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTGETACTIONTICKETINFO_OFFSET UNITYSDK_OFFSET(0x19CB9A00)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTLOGINBYACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x19CBBB20)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTREACTIVATEACCOUNT_OFFSET UNITYSDK_OFFSET(0x19CBBE70)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTVERIFYCAPTCHA_OFFSET UNITYSDK_OFFSET(0x19CBA390)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_RISKCHECK_OFFSET UNITYSDK_OFFSET(0x19CBAED0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWACCOUNTPRIVACYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x19CBB890)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWACCOUNTUSERAGREEMENT_OFFSET UNITYSDK_OFFSET(0x19CBB610)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWBINDSUCCESSDIALOG_OFFSET UNITYSDK_OFFSET(0x19CB9590)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWWELCOMEDIALOG_OFFSET UNITYSDK_OFFSET(0x19CB88B0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_STARTACCOUNTBINDING_OFFSET UNITYSDK_OFFSET(0x19CB8580)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_STARTWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x19CB9DA0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_STOPWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x19CB9EB0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_UPDATEQRCODE_OFFSET UNITYSDK_OFFSET(0x19CB9320)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_0_OFFSET UNITYSDK_OFFSET(0x19CBC8D0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_1_OFFSET UNITYSDK_OFFSET(0x19CBC960)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_2_OFFSET UNITYSDK_OFFSET(0x19CBCAC0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_3_OFFSET UNITYSDK_OFFSET(0x19CBCBA0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_4_OFFSET UNITYSDK_OFFSET(0x19CBCC80)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB8340)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__PERFORMBINDINGFLOW_B__44_0_OFFSET UNITYSDK_OFFSET(0x19CBD6B0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__QUERYWEBBINDINGRESULT_B__40_0_OFFSET UNITYSDK_OFFSET(0x19CBCF00)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWBINDSUCCESSDIALOG_B__37_0_OFFSET UNITYSDK_OFFSET(0x19CBCDE0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWBINDSUCCESSDIALOG_B__37_1_OFFSET UNITYSDK_OFFSET(0x19CBCE70)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWWELCOMEDIALOG_B__33_0_OFFSET UNITYSDK_OFFSET(0x19CBC620)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWWELCOMEDIALOG_B__33_1_OFFSET UNITYSDK_OFFSET(0x19CBC6B0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWWELCOMEDIALOG_B__33_2_OFFSET UNITYSDK_OFFSET(0x19CBC840)
...
namespace MiHoYo::SDK::Windows::OS
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Windows::OS::BindManager**)Il2CppClass::FromTypeDefinitionIndex(BindManager_TypeDefinitionIndex)->GetStaticField(0x34400);
		}
		...
		::MiHoYo::SDK::UI::OS::IWinAccountBindingDialog* _accountBindingDialog; // 0x18
		::System::String* _loginTicket; // 0x20
		::MiHoYo::SDK::UI::OS::IWinBindingWelcomeDialog* _bindingWelcomeDialog; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _commonHeaders; // 0x30
		::MiHoYo::SDK::UI::OS::IWinBindingSuccessDialog* _bindingSuccessDialog; // 0x38
		::System::String* PLATFORM; // 0x40
		::System::Action* _processCancelledCallback; // 0x48
		::System::Action_1<::System::Boolean>* _processCompletedCallback; // 0x50
		::System::String* _userEmail; // 0x58
		::System::String* _userId; // 0x60
		::System::String* _sToken; // 0x68
		::System::String* H5LOG_REPORT_MODULE; // 0x70
