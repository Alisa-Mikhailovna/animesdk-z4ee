...
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_CHECKHTTPDNSPLUSENABLE_OFFSET UNITYSDK_OFFSET(0xAAC0370)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_DICTIONARY2JSON_OFFSET UNITYSDK_OFFSET(0xAAC0780)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAABFFC0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_HTTPDNSHTTPREQUESTWITHCUSTOMHANDLER_OFFSET UNITYSDK_OFFSET(0xAAC0110)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_HTTPREQUESTBYHTTPDNSPLUS_OFFSET UNITYSDK_OFFSET(0xAAC0410)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_HTTPREQUESTBYTHTTPDNS_OFFSET UNITYSDK_OFFSET(0xAAC00A0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_INITENV_OFFSET UNITYSDK_OFFSET(0xAAC0010)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_ISHTTPDNSPLUSCONFIGVALID_OFFSET UNITYSDK_OFFSET(0xAAC02A0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAAC0000)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xAABFFB0)
...
namespace MiHoYo::SDK
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoSDKNetworkInterface**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKNetworkInterface_TypeDefinitionIndex)->GetStaticField(0xD460);
		}
