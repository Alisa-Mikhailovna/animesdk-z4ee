...
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19CE6A10)
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19CE6A50)
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19CE6A00)
#define MIHOYO_SDK_CONSOLEDELEGATE_SETSESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE6980)
