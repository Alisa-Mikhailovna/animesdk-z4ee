...
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x144BFEB0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_INIT_OFFSET UNITYSDK_OFFSET(0x144BFAF0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x144C04E0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_METHOD_5_3E51EEFB06718274_OFFSET UNITYSDK_OFFSET(0x144C0A70)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_METHOD_5_89914D30EBFCC9C6_OFFSET UNITYSDK_OFFSET(0x144C0350)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_METHOD_5_939383CFABF4988F_OFFSET UNITYSDK_OFFSET(0x144BFEC0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x144BFCA0)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x144BFA90)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_SETFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x144BFD20)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_START_OFFSET UNITYSDK_OFFSET(0x144BFD00)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN_UPDATE_OFFSET UNITYSDK_OFFSET(0x144BFD10)
#define EFFECTPLUGIN_EFFECT_CUSTOMFOLLOWPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x144C0B70)
