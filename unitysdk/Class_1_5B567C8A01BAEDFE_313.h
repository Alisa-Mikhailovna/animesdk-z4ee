...
#define CLASS_1_5B567C8A01BAEDFE_313_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C3ACD30)
#define CLASS_1_5B567C8A01BAEDFE_313_CLONE_OFFSET UNITYSDK_OFFSET(0x1C3AC9D0)
#define CLASS_1_5B567C8A01BAEDFE_313_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C3ACB30)
#define CLASS_1_5B567C8A01BAEDFE_313_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C3ACA40)
#define CLASS_1_5B567C8A01BAEDFE_313_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C3ACC90)
#define CLASS_1_5B567C8A01BAEDFE_313_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C3ACD80)
#define CLASS_1_5B567C8A01BAEDFE_313_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C3ACD50)
#define CLASS_1_5B567C8A01BAEDFE_313_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C3AC920)
#define CLASS_1_5B567C8A01BAEDFE_313_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C3AC980)
#define CLASS_1_5B567C8A01BAEDFE_313_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C3ACCC0)
#define CLASS_1_5B567C8A01BAEDFE_313_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C3ACD20)
#define CLASS_1_5B567C8A01BAEDFE_313__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C3ACDD0)
#define CLASS_1_5B567C8A01BAEDFE_313__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3AC9A0)
#define CLASS_1_5B567C8A01BAEDFE_313__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3AC990)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_313*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_313_TypeDefinitionIndex)->GetStaticField(0x46F20);
	}
