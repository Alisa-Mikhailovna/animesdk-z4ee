...
#define CLASS_1_5B567C8A01BAEDFE_174_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C19BC30)
#define CLASS_1_5B567C8A01BAEDFE_174_CLONE_OFFSET UNITYSDK_OFFSET(0x1C19B8D0)
#define CLASS_1_5B567C8A01BAEDFE_174_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C19BA30)
#define CLASS_1_5B567C8A01BAEDFE_174_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C19B940)
#define CLASS_1_5B567C8A01BAEDFE_174_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C19BB90)
#define CLASS_1_5B567C8A01BAEDFE_174_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C19BC80)
#define CLASS_1_5B567C8A01BAEDFE_174_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C19BC50)
#define CLASS_1_5B567C8A01BAEDFE_174_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C19B820)
#define CLASS_1_5B567C8A01BAEDFE_174_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C19B880)
#define CLASS_1_5B567C8A01BAEDFE_174_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C19BBC0)
#define CLASS_1_5B567C8A01BAEDFE_174_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C19BC20)
#define CLASS_1_5B567C8A01BAEDFE_174__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C19BCD0)
#define CLASS_1_5B567C8A01BAEDFE_174__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C19B8A0)
#define CLASS_1_5B567C8A01BAEDFE_174__CTOR_OFFSET UNITYSDK_OFFSET(0x1C19B890)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_174*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_174_TypeDefinitionIndex)->GetStaticField(0x246F0);
	}
