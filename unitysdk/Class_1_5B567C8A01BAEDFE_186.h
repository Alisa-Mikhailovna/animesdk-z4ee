...
#define CLASS_1_5B567C8A01BAEDFE_186_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C06DD20)
#define CLASS_1_5B567C8A01BAEDFE_186_CLONE_OFFSET UNITYSDK_OFFSET(0x1C06D9C0)
#define CLASS_1_5B567C8A01BAEDFE_186_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C06DB20)
#define CLASS_1_5B567C8A01BAEDFE_186_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C06DA30)
#define CLASS_1_5B567C8A01BAEDFE_186_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C06DC80)
#define CLASS_1_5B567C8A01BAEDFE_186_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C06DD70)
#define CLASS_1_5B567C8A01BAEDFE_186_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C06DD40)
#define CLASS_1_5B567C8A01BAEDFE_186_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C06D910)
#define CLASS_1_5B567C8A01BAEDFE_186_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C06D970)
#define CLASS_1_5B567C8A01BAEDFE_186_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C06DCB0)
#define CLASS_1_5B567C8A01BAEDFE_186_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C06DD10)
#define CLASS_1_5B567C8A01BAEDFE_186__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C06DDC0)
#define CLASS_1_5B567C8A01BAEDFE_186__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C06D990)
#define CLASS_1_5B567C8A01BAEDFE_186__CTOR_OFFSET UNITYSDK_OFFSET(0x1C06D980)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_186*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_186_TypeDefinitionIndex)->GetStaticField(0x23400);
	}
