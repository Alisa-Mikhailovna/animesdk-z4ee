...
#define CLASS_2_C3AC14C2FF8CD7D6_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x14981F30)
#define CLASS_2_C3AC14C2FF8CD7D6_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x14982110)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_185F640B532E227F_OFFSET UNITYSDK_OFFSET(0x1497E8A0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_1B5262956075B2F9_OFFSET UNITYSDK_OFFSET(0x1497DEC0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_1BAC25F61C22AED9_OFFSET UNITYSDK_OFFSET(0x1497E580)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_2166108A3E050E47_OFFSET UNITYSDK_OFFSET(0x149818D0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_3660BC98C99A174D_OFFSET UNITYSDK_OFFSET(0x149819A0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x14981950)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1497DD20)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_4D40965311DC4894_OFFSET UNITYSDK_OFFSET(0x14980EC0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x1497ED80)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_8C43E6E7E328B9EB_OFFSET UNITYSDK_OFFSET(0x1497E0C0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_913947B6596EB50A_OFFSET UNITYSDK_OFFSET(0x1497E300)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1497DCA0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_974A70E8019154E7_OFFSET UNITYSDK_OFFSET(0x14981BC0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_99DBC22FB543C50C_OFFSET UNITYSDK_OFFSET(0x1497F1A0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0x1497DF10)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_A6B30003B24E81C8_OFFSET UNITYSDK_OFFSET(0x14980CE0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_B917C58B4E14AC1B_OFFSET UNITYSDK_OFFSET(0x149816A0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_C01C81ED38CAB725_OFFSET UNITYSDK_OFFSET(0x14980F70)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1497DB90)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_CD37BA088172EEF7_OFFSET UNITYSDK_OFFSET(0x1497DE60)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_CE017E2A52468EF8_OFFSET UNITYSDK_OFFSET(0x14981E10)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_E411BCC5E73CE129_OFFSET UNITYSDK_OFFSET(0x14981460)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_E9A65FEB3BB1873E_OFFSET UNITYSDK_OFFSET(0x149811A0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_F0ED5B0423F2ADCA_OFFSET UNITYSDK_OFFSET(0x14981A20)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0x14981CC0)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0x14981D80)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x14981B00)
#define CLASS_2_C3AC14C2FF8CD7D6_METHOD_2_FFF2EA02C056B21A_OFFSET UNITYSDK_OFFSET(0x14980450)
#define CLASS_2_C3AC14C2FF8CD7D6__CTOR_OFFSET UNITYSDK_OFFSET(0x149822C0)
#define CLASS_2_C3AC14C2FF8CD7D6__ONBIND_OFFSET UNITYSDK_OFFSET(0x1497DB50)
#define CLASS_2_C3AC14C2FF8CD7D6__ONTICK_OFFSET UNITYSDK_OFFSET(0x1497DBD0)
#define CLASS_2_C3AC14C2FF8CD7D6___UPDATEAVATARSPANEL_B__19_0_OFFSET UNITYSDK_OFFSET(0x14982460)

inline static constexpr unsigned int Class_2_C3AC14C2FF8CD7D6_TypeDefinitionIndex = 68227;

class Class_2_C3AC14C2FF8CD7D6 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	// static const ::System::Single Field_2_0; // 0x0
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CharacterHUDType, ::System::Collections::Generic::Stack_1<::Class_0_16E4307DCC419505_1030*>*>* Field_2_1; // 0x60
	::Class_0_16E4307DCC419505_1032* Field_2_2; // 0x68
	::RPG::GameCore::BattleInstance* Field_2_3; // 0x70
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_2_4; // 0x78
	::RPG::GameCore::TurnBasedGameMode* Field_2_5; // 0x80
	::RPG::Client::BattleAcquireReusablePanelVisitor_1<::System::Int32>* Field_2_6; // 0x88
	::RPG::Client::BattleAcquireReusablePanelVisitor_1<::RPG::GameCore::GameEntity*>* Field_2_7; // 0x90
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_2_8; // 0x98
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_2_9; // 0xA0
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1030*>* Field_2_10; // 0xA8
