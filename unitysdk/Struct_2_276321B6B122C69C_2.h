...
#define STRUCT_2_276321B6B122C69C_2_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x7DC40)
#define STRUCT_2_276321B6B122C69C_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2D09220)
#define STRUCT_2_276321B6B122C69C_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x2D091F0)
#define STRUCT_2_276321B6B122C69C_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2D091E0)
#define STRUCT_2_276321B6B122C69C_2_GET_ID_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define STRUCT_2_276321B6B122C69C_2_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1E130)
#define STRUCT_2_276321B6B122C69C_2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x14C2B960)
#define STRUCT_2_276321B6B122C69C_2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x14C2B940)
#define STRUCT_2_276321B6B122C69C_2_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x2D091C0)
#define STRUCT_2_276321B6B122C69C_2_SET_ID_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define STRUCT_2_276321B6B122C69C_2_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x21F0)
#define STRUCT_2_276321B6B122C69C_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2D091B0)
#define STRUCT_2_276321B6B122C69C_2__CTOR_OFFSET UNITYSDK_OFFSET(0x7BDC0)
