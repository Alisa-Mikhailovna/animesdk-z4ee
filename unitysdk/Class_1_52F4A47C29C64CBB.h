...
#define CLASS_1_52F4A47C29C64CBB_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0xDE9D2B0)
#define CLASS_1_52F4A47C29C64CBB_GET_PLANDATA_OFFSET UNITYSDK_OFFSET(0xDE9D340)
#define CLASS_1_52F4A47C29C64CBB_GET_VERSION_OFFSET UNITYSDK_OFFSET(0xDE9D290)
#define CLASS_1_52F4A47C29C64CBB_METHOD_1_2807AF6E64F05A6A_OFFSET UNITYSDK_OFFSET(0xDE9D8D0)
#define CLASS_1_52F4A47C29C64CBB_METHOD_1_72F46A949F1774B7_OFFSET UNITYSDK_OFFSET(0xDE9D5E0)
#define CLASS_1_52F4A47C29C64CBB_METHOD_1_7E9AC3FFDA4606D5_OFFSET UNITYSDK_OFFSET(0xDE9D360)
#define CLASS_1_52F4A47C29C64CBB_METHOD_1_B38BA7FF09A3FCB9_OFFSET UNITYSDK_OFFSET(0xDE9D540)
#define CLASS_1_52F4A47C29C64CBB_METHOD_1_C3555C7ACCDC14EC_OFFSET UNITYSDK_OFFSET(0xDE9D590)
#define CLASS_1_52F4A47C29C64CBB_METHOD_1_C51FDF05180E75AF_OFFSET UNITYSDK_OFFSET(0xDE9D2D0)
#define CLASS_1_52F4A47C29C64CBB_METHOD_1_EBEE0D0A222A8264_OFFSET UNITYSDK_OFFSET(0xDE9D440)
#define CLASS_1_52F4A47C29C64CBB_METHOD_1_EDBE0DAF47EEEEED_OFFSET UNITYSDK_OFFSET(0xDE9D4D0)
#define CLASS_1_52F4A47C29C64CBB_SET_AVATAR_OFFSET UNITYSDK_OFFSET(0xDE9D2C0)
#define CLASS_1_52F4A47C29C64CBB_SET_PLANDATA_OFFSET UNITYSDK_OFFSET(0xDE9D350)
#define CLASS_1_52F4A47C29C64CBB_SET_VERSION_OFFSET UNITYSDK_OFFSET(0xDE9D2A0)
#define CLASS_1_52F4A47C29C64CBB__CTOR_OFFSET UNITYSDK_OFFSET(0xDE9D400)
