...
#define CLASS_1_FBFA092366368ABD_DOFAILED_OFFSET UNITYSDK_OFFSET(0x14466140)
#define CLASS_1_FBFA092366368ABD_DOSUCCEED_OFFSET UNITYSDK_OFFSET(0x14466100)
#define CLASS_1_FBFA092366368ABD_EXECUTE_OFFSET UNITYSDK_OFFSET(0x144660C0)
#define CLASS_1_FBFA092366368ABD_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x14465E70)
#define CLASS_1_FBFA092366368ABD_GET_ACTIONSYSTEM_OFFSET UNITYSDK_OFFSET(0x14465F10)
#define CLASS_1_FBFA092366368ABD_GET_FAILURECOUNT_OFFSET UNITYSDK_OFFSET(0x14465EF0)
#define CLASS_1_FBFA092366368ABD_GET_FINISHCOUNT_OFFSET UNITYSDK_OFFSET(0x14465F00)
#define CLASS_1_FBFA092366368ABD_GET_ID_OFFSET UNITYSDK_OFFSET(0x14465EC0)
#define CLASS_1_FBFA092366368ABD_GET_ONDATAFAILED_OFFSET UNITYSDK_OFFSET(0x14465FC0)
#define CLASS_1_FBFA092366368ABD_GET_ONDATASTARTING_OFFSET UNITYSDK_OFFSET(0x14465F80)
#define CLASS_1_FBFA092366368ABD_GET_ONDATASUCCEED_OFFSET UNITYSDK_OFFSET(0x14465FA0)
#define CLASS_1_FBFA092366368ABD_GET_ONFAILED_OFFSET UNITYSDK_OFFSET(0x14465FE0)
#define CLASS_1_FBFA092366368ABD_GET_ONFINISH_OFFSET UNITYSDK_OFFSET(0x14466000)
#define CLASS_1_FBFA092366368ABD_GET_ONITEMFAILED_OFFSET UNITYSDK_OFFSET(0x14466060)
#define CLASS_1_FBFA092366368ABD_GET_ONITEMSTARTING_OFFSET UNITYSDK_OFFSET(0x14466020)
#define CLASS_1_FBFA092366368ABD_GET_ONITEMSUCCEED_OFFSET UNITYSDK_OFFSET(0x14466040)
#define CLASS_1_FBFA092366368ABD_GET_ONSTARTING_OFFSET UNITYSDK_OFFSET(0x14465F40)
#define CLASS_1_FBFA092366368ABD_GET_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0x14465F60)
#define CLASS_1_FBFA092366368ABD_GET_ROOTQUEUE_OFFSET UNITYSDK_OFFSET(0x14465F20)
#define CLASS_1_FBFA092366368ABD_GET_SUCCESSCOUNT_OFFSET UNITYSDK_OFFSET(0x14465EE0)
#define CLASS_1_FBFA092366368ABD_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x14465ED0)
#define CLASS_1_FBFA092366368ABD_METHOD_1_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0x14467350)
#define CLASS_1_FBFA092366368ABD_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x14466190)
#define CLASS_1_FBFA092366368ABD_METHOD_1_1D800D59706BD4D8_OFFSET UNITYSDK_OFFSET(0x14466710)
#define CLASS_1_FBFA092366368ABD_METHOD_1_2C61108A8DA0AD73_OFFSET UNITYSDK_OFFSET(0x14466510)
#define CLASS_1_FBFA092366368ABD_METHOD_1_39AB6BE86BE284EE_OFFSET UNITYSDK_OFFSET(0x14466990)
#define CLASS_1_FBFA092366368ABD_METHOD_1_422AB1A19F04E217_OFFSET UNITYSDK_OFFSET(0x14467720)
#define CLASS_1_FBFA092366368ABD_METHOD_1_44D5E19630157ECE_OFFSET UNITYSDK_OFFSET(0x14467820)
#define CLASS_1_FBFA092366368ABD_METHOD_1_494D7FA4CA2316AD_OFFSET UNITYSDK_OFFSET(0x144665D0)
#define CLASS_1_FBFA092366368ABD_METHOD_1_6287ACD5750B69E7_OFFSET UNITYSDK_OFFSET(0x14466940)
#define CLASS_1_FBFA092366368ABD_METHOD_1_9DB2C80C0CD4760B_OFFSET UNITYSDK_OFFSET(0x14466480)
#define CLASS_1_FBFA092366368ABD_METHOD_1_BA0B557A599693AD_OFFSET UNITYSDK_OFFSET(0x14466A60)
#define CLASS_1_FBFA092366368ABD_METHOD_1_BF2C9F6DD9492BE4_OFFSET UNITYSDK_OFFSET(0x14466B30)
#define CLASS_1_FBFA092366368ABD_METHOD_1_C6E14CE377D03CE0_OFFSET UNITYSDK_OFFSET(0x14466690)
#define CLASS_1_FBFA092366368ABD_METHOD_1_D0663CE240A6DAF4_OFFSET UNITYSDK_OFFSET(0x14466580)
#define CLASS_1_FBFA092366368ABD_SET_ONDATAFAILED_OFFSET UNITYSDK_OFFSET(0x14465FD0)
#define CLASS_1_FBFA092366368ABD_SET_ONDATASTARTING_OFFSET UNITYSDK_OFFSET(0x14465F90)
#define CLASS_1_FBFA092366368ABD_SET_ONDATASUCCEED_OFFSET UNITYSDK_OFFSET(0x14465FB0)
#define CLASS_1_FBFA092366368ABD_SET_ONFAILED_OFFSET UNITYSDK_OFFSET(0x14465FF0)
#define CLASS_1_FBFA092366368ABD_SET_ONFINISH_OFFSET UNITYSDK_OFFSET(0x14466010)
#define CLASS_1_FBFA092366368ABD_SET_ONITEMFAILED_OFFSET UNITYSDK_OFFSET(0x14466070)
#define CLASS_1_FBFA092366368ABD_SET_ONITEMSTARTING_OFFSET UNITYSDK_OFFSET(0x14466030)
#define CLASS_1_FBFA092366368ABD_SET_ONITEMSUCCEED_OFFSET UNITYSDK_OFFSET(0x14466050)
#define CLASS_1_FBFA092366368ABD_SET_ONSTARTING_OFFSET UNITYSDK_OFFSET(0x14465F50)
#define CLASS_1_FBFA092366368ABD_SET_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0x14465F70)
#define CLASS_1_FBFA092366368ABD_SET_ROOTQUEUE_OFFSET UNITYSDK_OFFSET(0x14465F30)
#define CLASS_1_FBFA092366368ABD_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x14466080)
#define CLASS_1_FBFA092366368ABD__ADDERRORLOG_B__89_0_OFFSET UNITYSDK_OFFSET(0x14468B10)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_0_OFFSET UNITYSDK_OFFSET(0x14469C70)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_1_OFFSET UNITYSDK_OFFSET(0x14469C80)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_2_OFFSET UNITYSDK_OFFSET(0x1446AAB0)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_3_OFFSET UNITYSDK_OFFSET(0x1446C4E0)
#define CLASS_1_FBFA092366368ABD__ADDPROGRESSLOG_B__90_4_OFFSET UNITYSDK_OFFSET(0x1446C870)
#define CLASS_1_FBFA092366368ABD__CTOR_OFFSET UNITYSDK_OFFSET(0x14466200)
...
{
public:
	::RPG::Client::ActionEvent_4<::Class_0_16E4307DCC419505_614*, ::Class_0_16E4307DCC419505_616*, ::System::Object*, ::RPG::Client::ExeCode>* _OnFinish_k__BackingField; // 0x10
	::RPG::Client::ActionEvent_1<::Class_0_16E4307DCC419505_614*>* _OnStarting_k__BackingField; // 0x18
	::RPG::Client::ActionEvent_1<::Class_0_16E4307DCC419505_614*>* _OnSucceed_k__BackingField; // 0x20
	...
	::Class_1_C530CE1C0A4E2133* Field_1_5; // 0x38
	::Class_1_C6B3B57B6E91674E* _RootQueue_k__BackingField; // 0x40
	::Class_1_C530CE1C0A4E2133* Field_1_7; // 0x48
	::System::String* Field_1_8; // 0x50
	::RPG::Client::ActionEvent_2<::Class_0_16E4307DCC419505_614*, ::Class_0_16E4307DCC419505_616*>* _OnDataStarting_k__BackingField; // 0x58
	::Class_1_C530CE1C0A4E2133* Field_1_10; // 0x60
	::System::String* Field_1_11; // 0x68
	::RPG::Client::ActionEvent_3<::Class_0_16E4307DCC419505_614*, ::Class_0_16E4307DCC419505_616*, ::System::Object*>* _OnItemSucceed_k__BackingField; // 0x70
	::RPG::Client::ActionEvent_1<::Class_2_BF47C01E9CFEA39C*>* _OnFailed_k__BackingField; // 0x78
	::RPG::Client::ActionEvent_1<::Class_2_BF47C01E9CFEA39C*>* _OnDataFailed_k__BackingField; // 0x80
	::System::String* Field_1_15; // 0x88
	::RPG::Client::ActionEvent_2<::Class_0_16E4307DCC419505_614*, ::Class_0_16E4307DCC419505_616*>* _OnDataSucceed_k__BackingField; // 0x90
	::Class_1_C530CE1C0A4E2133* Field_1_17; // 0x98
	::RPG::Client::ActionEvent_3<::Class_0_16E4307DCC419505_614*, ::Class_0_16E4307DCC419505_616*, ::System::Object*>* _OnItemStarting_k__BackingField; // 0xA0
