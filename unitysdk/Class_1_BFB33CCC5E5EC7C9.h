...
#define CLASS_1_BFB33CCC5E5EC7C9_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB6EEF20)
#define CLASS_1_BFB33CCC5E5EC7C9_METHOD_1_078D85152011B919_OFFSET UNITYSDK_OFFSET(0xB6EE200)
#define CLASS_1_BFB33CCC5E5EC7C9_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xB6EEA10)
#define CLASS_1_BFB33CCC5E5EC7C9_METHOD_1_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0xB6EE130)
#define CLASS_1_BFB33CCC5E5EC7C9_METHOD_1_3DEE0E4175C7C35F_OFFSET UNITYSDK_OFFSET(0xB6EEDF0)
#define CLASS_1_BFB33CCC5E5EC7C9_METHOD_1_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0xB6EE0A0)
#define CLASS_1_BFB33CCC5E5EC7C9_METHOD_1_96B524A8DF06FC0F_OFFSET UNITYSDK_OFFSET(0xB6EEBD0)
#define CLASS_1_BFB33CCC5E5EC7C9_METHOD_1_AC5EE71116A40BAC_OFFSET UNITYSDK_OFFSET(0xB6EEAA0)
#define CLASS_1_BFB33CCC5E5EC7C9_METHOD_1_B2C52ACF9D9B435B_OFFSET UNITYSDK_OFFSET(0xB6EDF50)
#define CLASS_1_BFB33CCC5E5EC7C9_METHOD_1_FA2C8DD3A7E3B553_OFFSET UNITYSDK_OFFSET(0xB6EE360)
#define CLASS_1_BFB33CCC5E5EC7C9__CTOR_OFFSET UNITYSDK_OFFSET(0xB6EDE30)

inline static constexpr unsigned int Class_1_BFB33CCC5E5EC7C9_TypeDefinitionIndex = 75154;
...
public:
	...
	::Class_2_465A9E6CC2B0EF21* Field_1_3; // 0x18
	::FiveDimRenderingPanel* Field_1_4; // 0x20
	::UnityEngine::GameObject* Field_1_5; // 0x28
	::Class_0_16E4307DCC419505_38* Field_1_6; // 0x30
	::UnityEngine::Transform* Field_1_7; // 0x38
	::UnityEngine::Transform* Field_1_8; // 0x40
	::Il2CppArray<::FiveDimRenderingItem*>* Field_1_9; // 0x48
