...
#define CLASS_2_599C9F65F3F85994_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0x152F43C0)
#define CLASS_2_599C9F65F3F85994_METHOD_2_2658530140AE851C_OFFSET UNITYSDK_OFFSET(0x152F7260)
#define CLASS_2_599C9F65F3F85994_METHOD_2_4418D0C08F01D8CD_OFFSET UNITYSDK_OFFSET(0x152F4510)
#define CLASS_2_599C9F65F3F85994_METHOD_2_611363E6316608E0_OFFSET UNITYSDK_OFFSET(0x152F7420)
#define CLASS_2_599C9F65F3F85994_METHOD_2_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0x152F5930)
#define CLASS_2_599C9F65F3F85994_METHOD_2_853181FBF70E388E_OFFSET UNITYSDK_OFFSET(0x152F45A0)
#define CLASS_2_599C9F65F3F85994_METHOD_2_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x152F7DE0)
#define CLASS_2_599C9F65F3F85994_METHOD_2_D754D5F3490FC4F3_OFFSET UNITYSDK_OFFSET(0x152F7620)
#define CLASS_2_599C9F65F3F85994_PREUPDATEDONE_OFFSET UNITYSDK_OFFSET(0x152F75C0)
#define CLASS_2_599C9F65F3F85994_UPDATEADDITEM_OFFSET UNITYSDK_OFFSET(0x152F4480)
#define CLASS_2_599C9F65F3F85994_UPDATEADDROLE_OFFSET UNITYSDK_OFFSET(0x152F5660)
#define CLASS_2_599C9F65F3F85994_UPDATEAFTER_OFFSET UNITYSDK_OFFSET(0x152F5980)
#define CLASS_2_599C9F65F3F85994_UPDATEBEFORE_OFFSET UNITYSDK_OFFSET(0x152F3CC0)
#define CLASS_2_599C9F65F3F85994_UPDATECOIN_OFFSET UNITYSDK_OFFSET(0x152F57E0)
#define CLASS_2_599C9F65F3F85994_UPDATEITEM_OFFSET UNITYSDK_OFFSET(0x152F4430)
#define CLASS_2_599C9F65F3F85994_UPDATESTART_OFFSET UNITYSDK_OFFSET(0x152F3C80)
#define CLASS_2_599C9F65F3F85994__CTOR_OFFSET UNITYSDK_OFFSET(0x152F7F30)
...
public:
	...
	::System::Collections::Generic::Queue_1<::RPG::Client::GridFightEquipReturnPackEvent*>* Field_2_1; // 0x18
	::System::Collections::Generic::HashSet_1<::System::UInt32>* Field_2_2; // 0x20
	::System::Collections::Generic::Queue_1<::RPG::Client::GridFightEquipDressEvent*>* Field_2_3; // 0x28
	::System::Collections::Generic::Queue_1<::RPG::Client::GridFightForgeAddCoinEvent*>* Field_2_4; // 0x30
	::System::Collections::Generic::Queue_1<::RPG::Client::GridFightForgeAddRoleEvent*>* Field_2_5; // 0x38
	::System::Boolean Field_2_6; // 0x40
	::System::Boolean Field_2_7; // 0x41
	::System::Boolean Field_2_8; // 0x42
	::System::Boolean Field_2_9; // 0x43
	::Enum_3_75A1C8C41006A504 Field_2_10; // 0x44
	...
	::System::Void Method_2_D754D5F3490FC4F3(::Class_1_8844A4E6AE686D5C_6* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_8844A4E6AE686D5C_6*))((::PBYTE)hIl2Cpp + CLASS_2_599C9F65F3F85994_METHOD_2_D754D5F3490FC4F3_OFFSET))(this, a1);
	}
