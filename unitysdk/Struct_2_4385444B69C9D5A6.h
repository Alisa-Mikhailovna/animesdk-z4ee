...
#define STRUCT_2_4385444B69C9D5A6_GETCONTENTHASH_OFFSET UNITYSDK_OFFSET(0x39E2C00)
#define STRUCT_2_4385444B69C9D5A6_GETDOWNLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x39E2CB0)
#define STRUCT_2_4385444B69C9D5A6_GETFILESIZE_OFFSET UNITYSDK_OFFSET(0x39E2BB0)
#define STRUCT_2_4385444B69C9D5A6_GETLOADRELATIVEBUNDLELOADPATH_OFFSET UNITYSDK_OFFSET(0x39E2D40)
#define STRUCT_2_4385444B69C9D5A6_GET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x6E20)
#define STRUCT_2_4385444B69C9D5A6_ISNEEDWRITECONTENTHASHFILE_OFFSET UNITYSDK_OFFSET(0x39E2D50)
#define STRUCT_2_4385444B69C9D5A6_ISPATCH_OFFSET UNITYSDK_OFFSET(0x39E2AE0)
#define STRUCT_2_4385444B69C9D5A6_ISTMPFILENAMEADDFILEHASH_OFFSET UNITYSDK_OFFSET(0x39E2B60)
#define STRUCT_2_4385444B69C9D5A6_METHOD_2_ECA28171EB4172FF_OFFSET UNITYSDK_OFFSET(0x39E2C60)
#define STRUCT_2_4385444B69C9D5A6_SET_SUBPACKID_OFFSET UNITYSDK_OFFSET(0x2A90)
#define STRUCT_2_4385444B69C9D5A6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39E2DA0)
