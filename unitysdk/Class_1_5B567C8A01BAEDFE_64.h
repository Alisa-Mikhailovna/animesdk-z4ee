...
#define CLASS_1_5B567C8A01BAEDFE_64_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C397A50)
#define CLASS_1_5B567C8A01BAEDFE_64_CLONE_OFFSET UNITYSDK_OFFSET(0x1C3976F0)
#define CLASS_1_5B567C8A01BAEDFE_64_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C397850)
#define CLASS_1_5B567C8A01BAEDFE_64_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C397760)
#define CLASS_1_5B567C8A01BAEDFE_64_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C3979B0)
#define CLASS_1_5B567C8A01BAEDFE_64_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C397AA0)
#define CLASS_1_5B567C8A01BAEDFE_64_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C397A70)
#define CLASS_1_5B567C8A01BAEDFE_64_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C397640)
#define CLASS_1_5B567C8A01BAEDFE_64_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C3976A0)
#define CLASS_1_5B567C8A01BAEDFE_64_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C3979E0)
#define CLASS_1_5B567C8A01BAEDFE_64_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C397A40)
#define CLASS_1_5B567C8A01BAEDFE_64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C397AF0)
#define CLASS_1_5B567C8A01BAEDFE_64__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3976C0)
#define CLASS_1_5B567C8A01BAEDFE_64__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3976B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_64*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_64_TypeDefinitionIndex)->GetStaticField(0x44830);
	}
