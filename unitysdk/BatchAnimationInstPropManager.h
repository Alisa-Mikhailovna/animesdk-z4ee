...
#define BATCHANIMATIONINSTPROPMANAGER_CLEARINSTANCEDPROP_1_OFFSET UNITYSDK_OFFSET(0xBA94B20)
#define BATCHANIMATIONINSTPROPMANAGER_CLEARINSTANCEDPROP_OFFSET UNITYSDK_OFFSET(0xBA94AB0)
#define BATCHANIMATIONINSTPROPMANAGER_INITPART_OFFSET UNITYSDK_OFFSET(0xBA94670)
#define BATCHANIMATIONINSTPROPMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBA95490)
#define BATCHANIMATIONINSTPROPMANAGER_METHOD_5_14014646206E49EF_OFFSET UNITYSDK_OFFSET(0xBA951A0)
#define BATCHANIMATIONINSTPROPMANAGER_METHOD_5_28C834B59E1D0120_OFFSET UNITYSDK_OFFSET(0xBA94F70)
#define BATCHANIMATIONINSTPROPMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBA954E0)
#define BATCHANIMATIONINSTPROPMANAGER_SETINSTANCEDPROP_1_OFFSET UNITYSDK_OFFSET(0xBA94960)
#define BATCHANIMATIONINSTPROPMANAGER_SETINSTANCEDPROP_OFFSET UNITYSDK_OFFSET(0xBA948E0)
#define BATCHANIMATIONINSTPROPMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBA95530)
