...
#define INIPARSEREX_BASEPARSERWITHFILE_COMPILEDECLARATION_OFFSET UNITYSDK_OFFSET(0x1CFF7360)
#define INIPARSEREX_BASEPARSERWITHFILE_GETFILELOCATION_OFFSET UNITYSDK_OFFSET(0x1CFF7250)
#define INIPARSEREX_BASEPARSERWITHFILE_PARSE_OFFSET UNITYSDK_OFFSET(0x1CFF6F20)
#define INIPARSEREX_BASEPARSERWITHFILE_POSTPARSERPROCESS_OFFSET UNITYSDK_OFFSET(0x1CFF7240)
#define INIPARSEREX_BASEPARSERWITHFILE_PREPARSERPROCESS_OFFSET UNITYSDK_OFFSET(0x1CFF7230)
#define INIPARSEREX_BASEPARSERWITHFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF7370)
