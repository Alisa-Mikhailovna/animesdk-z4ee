...
#define INIPARSEREX_INIFILE_SECTION__GETENUMERATOR_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CFF8880)
#define INIPARSEREX_INIFILE_SECTION__GETENUMERATOR_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_INIPARSEREX_INIFILE_SECTIONITEM___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFF89F0)
#define INIPARSEREX_INIFILE_SECTION__GETENUMERATOR_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFF8A50)
#define INIPARSEREX_INIFILE_SECTION__GETENUMERATOR_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CFF8A00)
#define INIPARSEREX_INIFILE_SECTION__GETENUMERATOR_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CFF8860)
#define INIPARSEREX_INIFILE_SECTION__GETENUMERATOR_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF87E0)
#define INIPARSEREX_INIFILE_SECTION__GETENUMERATOR_D__3___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1CFF8870)
