...
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CFF95B0)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_INIPARSEREX_INIFILE_SECTIONITEM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFF99F0)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CFF9A50)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CFF9A00)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CFF9570)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF9060)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1CFF9590)
#define INIPARSEREX_INIFILE_SECTIONITEM__GETENUMERATOR_D__28___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1CFF95A0)
