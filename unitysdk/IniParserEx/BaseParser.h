...
#define INIPARSEREX_BASEPARSER_CLEARCOMMENT_OFFSET UNITYSDK_OFFSET(0x1CFF4E30)
#define INIPARSEREX_BASEPARSER_GETCHAR_OFFSET UNITYSDK_OFFSET(0x1CFF4640)
#define INIPARSEREX_BASEPARSER_GETLEADINGCHAR_OFFSET UNITYSDK_OFFSET(0x1CFF4F40)
#define INIPARSEREX_BASEPARSER_GETLOCATION_OFFSET UNITYSDK_OFFSET(0x1CFF4E50)
#define INIPARSEREX_BASEPARSER_GETTOKEN_OFFSET UNITYSDK_OFFSET(0x1CFF5550)
#define INIPARSEREX_BASEPARSER_INITPARSERSOURCE_OFFSET UNITYSDK_OFFSET(0x1CFF4450)
#define INIPARSEREX_BASEPARSER_ISBEGINCOMMENT_OFFSET UNITYSDK_OFFSET(0x1CFF4490)
#define INIPARSEREX_BASEPARSER_ISENDCOMMENT_OFFSET UNITYSDK_OFFSET(0x1CFF4560)
#define INIPARSEREX_BASEPARSER_ISENDOFLINE_OFFSET UNITYSDK_OFFSET(0x1CFF6E50)
#define INIPARSEREX_BASEPARSER_ISEOL_OFFSET UNITYSDK_OFFSET(0x1CFF5520)
#define INIPARSEREX_BASEPARSER_ISLINECOMMENT_OFFSET UNITYSDK_OFFSET(0x1CFF45D0)
#define INIPARSEREX_BASEPARSER_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1CFF5500)
#define INIPARSEREX_BASEPARSER_MATCHSYMBOL_OFFSET UNITYSDK_OFFSET(0x1CFF6DD0)
#define INIPARSEREX_BASEPARSER_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x1CFF4500)
#define INIPARSEREX_BASEPARSER_REQUIRESYMBOL_OFFSET UNITYSDK_OFFSET(0x1CFF6E90)
#define INIPARSEREX_BASEPARSER_UNGETCHAR_OFFSET UNITYSDK_OFFSET(0x1CFF5540)
#define INIPARSEREX_BASEPARSER_UNGETTOKEN_OFFSET UNITYSDK_OFFSET(0x1CFF6DA0)
#define INIPARSEREX_BASEPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF6EA0)
#define INIPARSEREX_BASEPARSER__GETTOKEN_G__ISPAIR_22_0_OFFSET UNITYSDK_OFFSET(0x1CFF6D80)
