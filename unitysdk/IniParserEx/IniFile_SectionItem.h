...
#define INIPARSEREX_INIFILE_SECTIONITEM_CREATELIST_OFFSET UNITYSDK_OFFSET(0x1CFF8B80)
#define INIPARSEREX_INIFILE_SECTIONITEM_CREATEMAP_OFFSET UNITYSDK_OFFSET(0x1CFF8BE0)
#define INIPARSEREX_INIFILE_SECTIONITEM_CREATESINGLE_OFFSET UNITYSDK_OFFSET(0x1CFF8B10)
#define INIPARSEREX_INIFILE_SECTIONITEM_CREATESTRING_OFFSET UNITYSDK_OFFSET(0x1CFF8AC0)
#define INIPARSEREX_INIFILE_SECTIONITEM_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFF9010)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_ANYITEM_OFFSET UNITYSDK_OFFSET(0x1CFF8CA0)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x1CFF8C80)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1CFF8DF0)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_MAP_OFFSET UNITYSDK_OFFSET(0x1CFF8F00)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_SINGLE_OFFSET UNITYSDK_OFFSET(0x1CFF8D70)
#define INIPARSEREX_INIFILE_SECTIONITEM_GET_STR_OFFSET UNITYSDK_OFFSET(0x1CFF8CC0)
#define INIPARSEREX_INIFILE_SECTIONITEM_SET_ANYITEM_OFFSET UNITYSDK_OFFSET(0x1CFF8CB0)
#define INIPARSEREX_INIFILE_SECTIONITEM_SET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x1CFF8C90)
#define INIPARSEREX_INIFILE_SECTIONITEM_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFF9070)
#define INIPARSEREX_INIFILE_SECTIONITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CFF90C0)
#define INIPARSEREX_INIFILE_SECTIONITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CFF8AB0)
#define INIPARSEREX_INIFILE_SECTIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF8AA0)
