...
#define INIPARSEREX_INIFILE_SECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFF8400)
#define INIPARSEREX_INIFILE_SECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CFF8730)
#define INIPARSEREX_INIFILE_SECTION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CFF8840)
#define INIPARSEREX_INIFILE_SECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1CFF8850)
#define INIPARSEREX_INIFILE_SECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CFF87F0)
#define INIPARSEREX_INIFILE_SECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF8690)
