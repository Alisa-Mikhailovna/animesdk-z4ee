...
#define CLASS_1_32C8E2E1DBBD4ECF_METHOD_1_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xB963500)
#define CLASS_1_32C8E2E1DBBD4ECF_METHOD_1_8666A05ADEEC4B71_OFFSET UNITYSDK_OFFSET(0xB963630)
#define CLASS_1_32C8E2E1DBBD4ECF_METHOD_1_F8C7231308CD2C82_1_OFFSET UNITYSDK_OFFSET(0xB963550)
#define CLASS_1_32C8E2E1DBBD4ECF_METHOD_1_F8C7231308CD2C82_OFFSET UNITYSDK_OFFSET(0xB963460)

inline static constexpr unsigned int Class_1_32C8E2E1DBBD4ECF_TypeDefinitionIndex = 69945;
...
public:
	...
	{
		return (::RPG::GameCore::CharacterReplaceMaterialVariantConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_32C8E2E1DBBD4ECF_TypeDefinitionIndex)->GetStaticField(0x26170);
	}
