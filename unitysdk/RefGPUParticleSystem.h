...
#define REFGPUPARTICLESYSTEM_ADDATTRACTOR_OFFSET UNITYSDK_OFFSET(0x1C8A9C70)
#define REFGPUPARTICLESYSTEM_ADDBURST_1_OFFSET UNITYSDK_OFFSET(0x1C8A9BB0)
#define REFGPUPARTICLESYSTEM_ADDBURST_OFFSET UNITYSDK_OFFSET(0x1C8A9AA0)
#define REFGPUPARTICLESYSTEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C8A8E40)
#define REFGPUPARTICLESYSTEM_CLEARPARTICLEDATA_OFFSET UNITYSDK_OFFSET(0x1C8A8C80)
#define REFGPUPARTICLESYSTEM_DEACTIVATESKINNEDMESHEMITTER_OFFSET UNITYSDK_OFFSET(0x1C8AEB10)
#define REFGPUPARTICLESYSTEM_DEBUGOFF_OFFSET UNITYSDK_OFFSET(0x1C8B3CB0)
#define REFGPUPARTICLESYSTEM_DEBUGON_OFFSET UNITYSDK_OFFSET(0x1C8B3C10)
#define REFGPUPARTICLESYSTEM_EMITNUMPARTICLES_OFFSET UNITYSDK_OFFSET(0x1C8A9760)
#define REFGPUPARTICLESYSTEM_EMIT_OFFSET UNITYSDK_OFFSET(0x1C8A9750)
#define REFGPUPARTICLESYSTEM_FORCERECREATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1C8AD710)
#define REFGPUPARTICLESYSTEM_METHOD_5_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0x1C8AC690)
#define REFGPUPARTICLESYSTEM_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x1C8A93F0)
#define REFGPUPARTICLESYSTEM_METHOD_5_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0x1C8A8840)
#define REFGPUPARTICLESYSTEM_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x1C8A9070)
#define REFGPUPARTICLESYSTEM_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x1C8AAF00)
#define REFGPUPARTICLESYSTEM_METHOD_5_64F3965CE4C4DB47_OFFSET UNITYSDK_OFFSET(0x1C8A9270)
#define REFGPUPARTICLESYSTEM_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x1C8ACD50)
#define REFGPUPARTICLESYSTEM_METHOD_5_925162CF519D5A91_OFFSET UNITYSDK_OFFSET(0x1C8A8290)
#define REFGPUPARTICLESYSTEM_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x1C8B0750)
#define REFGPUPARTICLESYSTEM_METHOD_5_A239DF324AF4215D_1_OFFSET UNITYSDK_OFFSET(0x1C8AE230)
#define REFGPUPARTICLESYSTEM_METHOD_5_A239DF324AF4215D_2_OFFSET UNITYSDK_OFFSET(0x1C8AB3C0)
#define REFGPUPARTICLESYSTEM_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x1C8AB340)
#define REFGPUPARTICLESYSTEM_METHOD_5_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0x1C8A9200)
#define REFGPUPARTICLESYSTEM_METHOD_5_B50CA01B5EDC1228_OFFSET UNITYSDK_OFFSET(0x1C8A8D60)
#define REFGPUPARTICLESYSTEM_METHOD_5_B732DC7FA82BA621_OFFSET UNITYSDK_OFFSET(0x1C8A9560)
#define REFGPUPARTICLESYSTEM_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1C8AE2B0)
#define REFGPUPARTICLESYSTEM_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x1C8A9110)
#define REFGPUPARTICLESYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C8A8E00)
#define REFGPUPARTICLESYSTEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C8A8B70)
#define REFGPUPARTICLESYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C8A8130)
#define REFGPUPARTICLESYSTEM_PAUSE_OFFSET UNITYSDK_OFFSET(0x1C8A9670)
#define REFGPUPARTICLESYSTEM_PLAY_OFFSET UNITYSDK_OFFSET(0x1C8A95D0)
#define REFGPUPARTICLESYSTEM_PREPAREPARTICLEDATA_OFFSET UNITYSDK_OFFSET(0x1C8A81C0)
#define REFGPUPARTICLESYSTEM_PREPARESKINNEDMESH_OFFSET UNITYSDK_OFFSET(0x1C8AEC20)
#define REFGPUPARTICLESYSTEM_REMOVEATTRACTOR_OFFSET UNITYSDK_OFFSET(0x1C8A9D60)
#define REFGPUPARTICLESYSTEM_REMOVEBURST_OFFSET UNITYSDK_OFFSET(0x1C8A9E80)
#define REFGPUPARTICLESYSTEM_REMOVELASTATTRACTOR_OFFSET UNITYSDK_OFFSET(0x1C8A9E00)
#define REFGPUPARTICLESYSTEM_REMOVELASTBURST_OFFSET UNITYSDK_OFFSET(0x1C8A9F20)
#define REFGPUPARTICLESYSTEM_RENDERSKINNEDMESHEMITTERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1C8AEB90)
#define REFGPUPARTICLESYSTEM_RESEED_OFFSET UNITYSDK_OFFSET(0x1C8A9940)
#define REFGPUPARTICLESYSTEM_RESETSEED_OFFSET UNITYSDK_OFFSET(0x1C8AF5B0)
#define REFGPUPARTICLESYSTEM_RESTART_OFFSET UNITYSDK_OFFSET(0x1C8A9680)
#define REFGPUPARTICLESYSTEM_SETATTRACTORKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8B3B40)
#define REFGPUPARTICLESYSTEM_SETBLENDMODE_1_OFFSET UNITYSDK_OFFSET(0x1C8B3350)
#define REFGPUPARTICLESYSTEM_SETBLENDMODE_OFFSET UNITYSDK_OFFSET(0x1C8B2D60)
#define REFGPUPARTICLESYSTEM_SETCIRCULARFORCE_OFFSET UNITYSDK_OFFSET(0x1C8B2CD0)
#define REFGPUPARTICLESYSTEM_SETCOLLISIONTYPE_OFFSET UNITYSDK_OFFSET(0x1C8B21E0)
#define REFGPUPARTICLESYSTEM_SETEMISSIONKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8AE1B0)
#define REFGPUPARTICLESYSTEM_SETEMISSIONMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8AE0D0)
#define REFGPUPARTICLESYSTEM_SETEMITFROMBASE_OFFSET UNITYSDK_OFFSET(0x1C8B3AB0)
#define REFGPUPARTICLESYSTEM_SETEMITFROMSHELL_OFFSET UNITYSDK_OFFSET(0x1C8B3A20)
#define REFGPUPARTICLESYSTEM_SETEMITTERSHAPEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8AB660)
#define REFGPUPARTICLESYSTEM_SETLAYER_OFFSET UNITYSDK_OFFSET(0x1C8B38C0)
#define REFGPUPARTICLESYSTEM_SETLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x1C8AADD0)
#define REFGPUPARTICLESYSTEM_SETLIMITVELOCITY_OFFSET UNITYSDK_OFFSET(0x1C8B2C40)
#define REFGPUPARTICLESYSTEM_SETMAINTEXTUREKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8ADC80)
#define REFGPUPARTICLESYSTEM_SETMAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8ADBA0)
#define REFGPUPARTICLESYSTEM_SETMESHTARGETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8B2110)
#define REFGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8ADE10)
#define REFGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8ADD00)
#define REFGPUPARTICLESYSTEM_SETMETALLICSMOOTHNESSVALUE_OFFSET UNITYSDK_OFFSET(0x1C8ADE90)
#define REFGPUPARTICLESYSTEM_SETNORMALKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8AE050)
#define REFGPUPARTICLESYSTEM_SETNORMALMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8ADF40)
#define REFGPUPARTICLESYSTEM_SETPARTICLETYPEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8AB6D0)
#define REFGPUPARTICLESYSTEM_SETRANDOMINDEXKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8B25C0)
#define REFGPUPARTICLESYSTEM_SETREFRACTIONMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8ABEC0)
#define REFGPUPARTICLESYSTEM_SETRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0x1C8A8B40)
#define REFGPUPARTICLESYSTEM_SETROTATIONKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8B22E0)
#define REFGPUPARTICLESYSTEM_SETROTATIONOVERLIFETIMEKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x1C8B14F0)
#define REFGPUPARTICLESYSTEM_SETROTATIONOVERLIFETIMEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8B2360)
#define REFGPUPARTICLESYSTEM_SETSHADOWSETTINGS_OFFSET UNITYSDK_OFFSET(0x1C8ABCD0)
#define REFGPUPARTICLESYSTEM_SETSIMULATIONSPACE_OFFSET UNITYSDK_OFFSET(0x1C8AB930)
#define REFGPUPARTICLESYSTEM_SETSIZEOVERLIFETIMEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8B0EB0)
#define REFGPUPARTICLESYSTEM_SETTEXTURESHEETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8B23E0)
#define REFGPUPARTICLESYSTEM_SETTURBULENCEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1C8B2210)
#define REFGPUPARTICLESYSTEM_SETUPDATATEXTURES_OFFSET UNITYSDK_OFFSET(0x1C8B03F0)
#define REFGPUPARTICLESYSTEM_SETUPSKINNEDMESHEMITTERCAMERA_OFFSET UNITYSDK_OFFSET(0x1C8AE5E0)
#define REFGPUPARTICLESYSTEM_SETZBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1C8B39C0)
#define REFGPUPARTICLESYSTEM_SETZBUFFER_OFFSET UNITYSDK_OFFSET(0x1C8B3950)
#define REFGPUPARTICLESYSTEM_STOP_OFFSET UNITYSDK_OFFSET(0x1C8A8C40)
#define REFGPUPARTICLESYSTEM_UPDATEAIRRESISTANCE_OFFSET UNITYSDK_OFFSET(0x1C8ACC60)
#define REFGPUPARTICLESYSTEM_UPDATEAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1C8B1790)
#define REFGPUPARTICLESYSTEM_UPDATEASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x1C8ADB20)
#define REFGPUPARTICLESYSTEM_UPDATECIRCULARFORCEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C8B0670)
#define REFGPUPARTICLESYSTEM_UPDATECOLLISIONCAMERA_OFFSET UNITYSDK_OFFSET(0x1C8AC090)
#define REFGPUPARTICLESYSTEM_UPDATECOLLISIONMATRICES_OFFSET UNITYSDK_OFFSET(0x1C8ACED0)
#define REFGPUPARTICLESYSTEM_UPDATECOLLISIONPLANES_OFFSET UNITYSDK_OFFSET(0x1C8AF690)
#define REFGPUPARTICLESYSTEM_UPDATECOLORINTENSITY_OFFSET UNITYSDK_OFFSET(0x1C8B0580)
#define REFGPUPARTICLESYSTEM_UPDATECOLOROVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C8B02A0)
#define REFGPUPARTICLESYSTEM_UPDATEDEPTHCOLLISIONVALUES_OFFSET UNITYSDK_OFFSET(0x1C8AC100)
#define REFGPUPARTICLESYSTEM_UPDATEDISTRIBUTIONMATRICES_OFFSET UNITYSDK_OFFSET(0x1C8AEB00)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTERMATRIX_OFFSET UNITYSDK_OFFSET(0x1C8AC180)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1C8B0060)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8AB440)
#define REFGPUPARTICLESYSTEM_UPDATEEMITTER_OFFSET UNITYSDK_OFFSET(0x1C8A9770)
#define REFGPUPARTICLESYSTEM_UPDATEFORCEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C8ACDF0)
#define REFGPUPARTICLESYSTEM_UPDATEFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1C8B1860)
#define REFGPUPARTICLESYSTEM_UPDATEGRAVITY_OFFSET UNITYSDK_OFFSET(0x1C8AC260)
#define REFGPUPARTICLESYSTEM_UPDATEINDEXOFREFRACTION_OFFSET UNITYSDK_OFFSET(0x1C8AC010)
#define REFGPUPARTICLESYSTEM_UPDATEMAXVELOCITYOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C8B0640)
#define REFGPUPARTICLESYSTEM_UPDATEMESHTARGETMATRIX_OFFSET UNITYSDK_OFFSET(0x1C8AC430)
#define REFGPUPARTICLESYSTEM_UPDATEMESHTARGETPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1C8AC3F0)
#define REFGPUPARTICLESYSTEM_UPDATEMESHTARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8AF0C0)
#define REFGPUPARTICLESYSTEM_UPDATEMOTIONVECTORSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1C8AFE80)
#define REFGPUPARTICLESYSTEM_UPDATEMOTIONVECTORTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8AFF00)
#define REFGPUPARTICLESYSTEM_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1C8B19E0)
#define REFGPUPARTICLESYSTEM_UPDATEPARTICLECOLORINTENSITY_OFFSET UNITYSDK_OFFSET(0x1C8B0210)
#define REFGPUPARTICLESYSTEM_UPDATEPARTICLEMAINTEX_OFFSET UNITYSDK_OFFSET(0x1C8AFD10)
#define REFGPUPARTICLESYSTEM_UPDATEPARTICLETYPEKEYWORDS_OFFSET UNITYSDK_OFFSET(0x1C8AD7B0)
#define REFGPUPARTICLESYSTEM_UPDATEPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1C8ADA80)
#define REFGPUPARTICLESYSTEM_UPDATEROTATIONOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C8B1010)
#define REFGPUPARTICLESYSTEM_UPDATESIZEOVERLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C8B0900)
#define REFGPUPARTICLESYSTEM_UPDATESKINNEDMESHEMITTERCAMERALAYER_OFFSET UNITYSDK_OFFSET(0x1C8AE8C0)
#define REFGPUPARTICLESYSTEM_UPDATESKINNEDMESHEMITTERPOSITIONTEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8AE8F0)
#define REFGPUPARTICLESYSTEM_UPDATESTARTSIZEANDROTATION_OFFSET UNITYSDK_OFFSET(0x1C8AFFA0)
#define REFGPUPARTICLESYSTEM_UPDATESTARTSIZE_OFFSET UNITYSDK_OFFSET(0x1C8B2C00)
#define REFGPUPARTICLESYSTEM_UPDATESTARTSPEEDANDLIFETIME_OFFSET UNITYSDK_OFFSET(0x1C8AC140)
#define REFGPUPARTICLESYSTEM_UPDATESTRETCHMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1C8ABF40)
#define REFGPUPARTICLESYSTEM_UPDATETEXTURESHEETDIMENSIONS_OFFSET UNITYSDK_OFFSET(0x1C8B2070)
#define REFGPUPARTICLESYSTEM_UPDATETIGHTNESS_OFFSET UNITYSDK_OFFSET(0x1C8B1940)
#define REFGPUPARTICLESYSTEM_UPDATETRAILVALUES_OFFSET UNITYSDK_OFFSET(0x1C8AD9B0)
#define REFGPUPARTICLESYSTEM_UPDATETURBULENCETEXTURE_OFFSET UNITYSDK_OFFSET(0x1C8B1650)
#define REFGPUPARTICLESYSTEM_UPDATEVECTORFIELDFILE_OFFSET UNITYSDK_OFFSET(0x1C8B1AD0)
#define REFGPUPARTICLESYSTEM_UPDATEVECTORFIELDMATRIX_OFFSET UNITYSDK_OFFSET(0x1C8ACAF0)
#define REFGPUPARTICLESYSTEM_UPDATEVECTORFIELD_OFFSET UNITYSDK_OFFSET(0x1C8B16F0)
#define REFGPUPARTICLESYSTEM_UPDATEWORLDSPACEBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x1C8AC8E0)
#define REFGPUPARTICLESYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C8A8E50)
#define REFGPUPARTICLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8B3D20)
