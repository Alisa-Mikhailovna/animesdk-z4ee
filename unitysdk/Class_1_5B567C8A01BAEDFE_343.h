...
#define CLASS_1_5B567C8A01BAEDFE_343_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C74CC10)
#define CLASS_1_5B567C8A01BAEDFE_343_CLONE_OFFSET UNITYSDK_OFFSET(0x1C74C8B0)
#define CLASS_1_5B567C8A01BAEDFE_343_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C74CA10)
#define CLASS_1_5B567C8A01BAEDFE_343_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C74C920)
#define CLASS_1_5B567C8A01BAEDFE_343_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C74CB70)
#define CLASS_1_5B567C8A01BAEDFE_343_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C74CC60)
#define CLASS_1_5B567C8A01BAEDFE_343_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C74CC30)
#define CLASS_1_5B567C8A01BAEDFE_343_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C74C800)
#define CLASS_1_5B567C8A01BAEDFE_343_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C74C860)
#define CLASS_1_5B567C8A01BAEDFE_343_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C74CBA0)
#define CLASS_1_5B567C8A01BAEDFE_343_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C74CC00)
#define CLASS_1_5B567C8A01BAEDFE_343__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C74CCB0)
#define CLASS_1_5B567C8A01BAEDFE_343__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C74C880)
#define CLASS_1_5B567C8A01BAEDFE_343__CTOR_OFFSET UNITYSDK_OFFSET(0x1C74C870)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_343*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_343_TypeDefinitionIndex)->GetStaticField(0xDDD0);
	}
