...
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_GET_ISCUSTOMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xDD62FE0)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_GET_MAINCAMTRANS_OFFSET UNITYSDK_OFFSET(0xDD62FF0)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_METHOD_3_BFED9CB4A51C4631_OFFSET UNITYSDK_OFFSET(0xDD630A0)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xDD63BA0)
#define STAGEHARMONYFOLLOWTRANSFORMDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xDD63BF0)
