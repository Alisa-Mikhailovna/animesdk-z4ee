...
#define CLASS_1_3E926525914B2E70_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BBD7190)
#define CLASS_1_3E926525914B2E70_CLONE_OFFSET UNITYSDK_OFFSET(0x1BBD6B10)
#define CLASS_1_3E926525914B2E70_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BBD6C20)
#define CLASS_1_3E926525914B2E70_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BBD6BF0)
#define CLASS_1_3E926525914B2E70_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BBD6D60)
#define CLASS_1_3E926525914B2E70_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BBD7590)
#define CLASS_1_3E926525914B2E70_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BBD74C0)
#define CLASS_1_3E926525914B2E70_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1BBD6BD0)
#define CLASS_1_3E926525914B2E70_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1BBD6B60)
#define CLASS_1_3E926525914B2E70_METHOD_1_3163C288F3AE2966_1_OFFSET UNITYSDK_OFFSET(0x1BBD6B90)
#define CLASS_1_3E926525914B2E70_METHOD_1_3163C288F3AE2966_OFFSET UNITYSDK_OFFSET(0x1BBD6B50)
#define CLASS_1_3E926525914B2E70_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1BBD6BA0)
#define CLASS_1_3E926525914B2E70_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BBD69B0)
#define CLASS_1_3E926525914B2E70_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1BBD6BC0)
#define CLASS_1_3E926525914B2E70_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1BBD6BB0)
#define CLASS_1_3E926525914B2E70_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1BBD6BE0)
#define CLASS_1_3E926525914B2E70_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1BBD6B70)
#define CLASS_1_3E926525914B2E70_METHOD_1_CE81D059476B1F49_1_OFFSET UNITYSDK_OFFSET(0x1BBD6B80)
#define CLASS_1_3E926525914B2E70_METHOD_1_CE81D059476B1F49_OFFSET UNITYSDK_OFFSET(0x1BBD6B40)
#define CLASS_1_3E926525914B2E70_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BBD69E0)
#define CLASS_1_3E926525914B2E70_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BBD6EF0)
#define CLASS_1_3E926525914B2E70_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BBD6F50)
#define CLASS_1_3E926525914B2E70__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BBD7720)
#define CLASS_1_3E926525914B2E70__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BBD6A40)
#define CLASS_1_3E926525914B2E70__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD69F0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3E926525914B2E70_TypeDefinitionIndex)->GetStaticField(0x32C60);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_3E926525914B2E70*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_3E926525914B2E70*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_3E926525914B2E70_TypeDefinitionIndex)->GetStaticField(0x32C68);
	}
