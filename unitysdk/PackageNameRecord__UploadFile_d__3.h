...
#define PACKAGENAMERECORD__UPLOADFILE_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xBA73B60)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBA73F90)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBA73FF0)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xBA73FA0)
#define PACKAGENAMERECORD__UPLOADFILE_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBA73B50)
#define PACKAGENAMERECORD__UPLOADFILE_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0xBA73B30)
