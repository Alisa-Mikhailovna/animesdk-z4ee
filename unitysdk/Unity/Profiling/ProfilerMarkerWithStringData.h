...
#define UNITY_PROFILING_PROFILERMARKERWITHSTRINGDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x3A24020)
#define UNITY_PROFILING_PROFILERMARKERWITHSTRINGDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1CFFDC30)
#define UNITY_PROFILING_PROFILERMARKERWITHSTRINGDATA_END_OFFSET UNITYSDK_OFFSET(0x3A23EE0)
