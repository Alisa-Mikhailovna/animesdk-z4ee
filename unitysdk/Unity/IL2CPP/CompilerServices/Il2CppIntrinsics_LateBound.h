...
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_LATEBOUND_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19958920)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_LATEBOUND_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19958960)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_LATEBOUND_INVOKE_OFFSET UNITYSDK_OFFSET(0x19958910)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_LATEBOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x19958820)
