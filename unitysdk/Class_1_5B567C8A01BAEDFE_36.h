...
#define CLASS_1_5B567C8A01BAEDFE_36_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BFEF990)
#define CLASS_1_5B567C8A01BAEDFE_36_CLONE_OFFSET UNITYSDK_OFFSET(0x1BFEF680)
#define CLASS_1_5B567C8A01BAEDFE_36_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BFEF790)
#define CLASS_1_5B567C8A01BAEDFE_36_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BFEF6C0)
#define CLASS_1_5B567C8A01BAEDFE_36_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BFEF8F0)
#define CLASS_1_5B567C8A01BAEDFE_36_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BFEF9E0)
#define CLASS_1_5B567C8A01BAEDFE_36_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BFEF9B0)
#define CLASS_1_5B567C8A01BAEDFE_36_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BFEF600)
#define CLASS_1_5B567C8A01BAEDFE_36_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BFEF630)
#define CLASS_1_5B567C8A01BAEDFE_36_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BFEF920)
#define CLASS_1_5B567C8A01BAEDFE_36_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BFEF980)
#define CLASS_1_5B567C8A01BAEDFE_36__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFEFA30)
#define CLASS_1_5B567C8A01BAEDFE_36__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BFEF650)
#define CLASS_1_5B567C8A01BAEDFE_36__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFEF640)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_36*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_36_TypeDefinitionIndex)->GetStaticField(0x657C0);
	}
