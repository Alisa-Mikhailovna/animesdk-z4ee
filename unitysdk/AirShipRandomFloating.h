...
#define AIRSHIPRANDOMFLOATING_AWAKE_OFFSET UNITYSDK_OFFSET(0x1492BFA0)
#define AIRSHIPRANDOMFLOATING_METHOD_5_A678846DF98684D3_OFFSET UNITYSDK_OFFSET(0x1492C6E0)
#define AIRSHIPRANDOMFLOATING_METHOD_5_C34AC80B04BCFF1B_OFFSET UNITYSDK_OFFSET(0x1492CCB0)
#define AIRSHIPRANDOMFLOATING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1492C0A0)
#define AIRSHIPRANDOMFLOATING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1492C050)
#define AIRSHIPRANDOMFLOATING_TICK_OFFSET UNITYSDK_OFFSET(0x1492C1B0)
#define AIRSHIPRANDOMFLOATING_UPDATE_OFFSET UNITYSDK_OFFSET(0x1492C150)
#define AIRSHIPRANDOMFLOATING__CTOR_OFFSET UNITYSDK_OFFSET(0x1492CDC0)
