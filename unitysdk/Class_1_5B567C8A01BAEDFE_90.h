...
#define CLASS_1_5B567C8A01BAEDFE_90_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C69A010)
#define CLASS_1_5B567C8A01BAEDFE_90_CLONE_OFFSET UNITYSDK_OFFSET(0x1C699CB0)
#define CLASS_1_5B567C8A01BAEDFE_90_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C699E10)
#define CLASS_1_5B567C8A01BAEDFE_90_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C699D20)
#define CLASS_1_5B567C8A01BAEDFE_90_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C699F70)
#define CLASS_1_5B567C8A01BAEDFE_90_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C69A060)
#define CLASS_1_5B567C8A01BAEDFE_90_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C69A030)
#define CLASS_1_5B567C8A01BAEDFE_90_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C699C00)
#define CLASS_1_5B567C8A01BAEDFE_90_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C699C60)
#define CLASS_1_5B567C8A01BAEDFE_90_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C699FA0)
#define CLASS_1_5B567C8A01BAEDFE_90_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C69A000)
#define CLASS_1_5B567C8A01BAEDFE_90__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C69A0B0)
#define CLASS_1_5B567C8A01BAEDFE_90__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C699C80)
#define CLASS_1_5B567C8A01BAEDFE_90__CTOR_OFFSET UNITYSDK_OFFSET(0x1C699C70)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_90*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_90_TypeDefinitionIndex)->GetStaticField(0x67C80);
	}
