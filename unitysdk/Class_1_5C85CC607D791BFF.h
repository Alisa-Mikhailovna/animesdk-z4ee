...
#define CLASS_1_5C85CC607D791BFF_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xDE9BDD0)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLEXTRAEFFECTLIST_OFFSET UNITYSDK_OFFSET(0xDE9BE70)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLICONPATH_OFFSET UNITYSDK_OFFSET(0xDE9BE80)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0xDE9BDB0)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0xDE9BDF0)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0xDE9BE10)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLTYPECOLOR_OFFSET UNITYSDK_OFFSET(0xDE9BE50)
#define CLASS_1_5C85CC607D791BFF_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xDE9BE30)
#define CLASS_1_5C85CC607D791BFF_GET_ULTRASKILLICONPATH_OFFSET UNITYSDK_OFFSET(0xDE9BEA0)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xDE9BDE0)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLICONPATH_OFFSET UNITYSDK_OFFSET(0xDE9BE90)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0xDE9BDC0)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0xDE9BE00)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0xDE9BE20)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLTYPECOLOR_OFFSET UNITYSDK_OFFSET(0xDE9BE60)
#define CLASS_1_5C85CC607D791BFF_SET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xDE9BE40)
#define CLASS_1_5C85CC607D791BFF_SET_ULTRASKILLICONPATH_OFFSET UNITYSDK_OFFSET(0xDE9BEB0)
#define CLASS_1_5C85CC607D791BFF__CTOR_OFFSET UNITYSDK_OFFSET(0xDE9BEC0)

inline static constexpr unsigned int Class_1_5C85CC607D791BFF_TypeDefinitionIndex = 75868;
...
public:
	...
	::System::String* _SkillSimpleDesc_k__BackingField; // 0x18
	::System::String* _SkillDesc_k__BackingField; // 0x20
	::System::String* _UltraSkillIconPath_k__BackingField; // 0x28
	::System::String* _SkillIconPath_k__BackingField; // 0x30
	::RPG::Client::TextID _SkillName_k__BackingField; // 0x38
	::UnityEngine::Color _SkillTypeColor_k__BackingField; // 0x48
	::RPG::Client::TextID _SkillType_k__BackingField; // 0x58
	::RPG::Client::TextID _SkillTag_k__BackingField; // 0x68
