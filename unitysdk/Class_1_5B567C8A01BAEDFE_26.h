...
#define CLASS_1_5B567C8A01BAEDFE_26_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C4BF190)
#define CLASS_1_5B567C8A01BAEDFE_26_CLONE_OFFSET UNITYSDK_OFFSET(0x1C4BEE80)
#define CLASS_1_5B567C8A01BAEDFE_26_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C4BEF90)
#define CLASS_1_5B567C8A01BAEDFE_26_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C4BEEC0)
#define CLASS_1_5B567C8A01BAEDFE_26_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C4BF0F0)
#define CLASS_1_5B567C8A01BAEDFE_26_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C4BF1E0)
#define CLASS_1_5B567C8A01BAEDFE_26_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C4BF1B0)
#define CLASS_1_5B567C8A01BAEDFE_26_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C4BEE00)
#define CLASS_1_5B567C8A01BAEDFE_26_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C4BEE30)
#define CLASS_1_5B567C8A01BAEDFE_26_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C4BF120)
#define CLASS_1_5B567C8A01BAEDFE_26_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C4BF180)
#define CLASS_1_5B567C8A01BAEDFE_26__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4BF230)
#define CLASS_1_5B567C8A01BAEDFE_26__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4BEE50)
#define CLASS_1_5B567C8A01BAEDFE_26__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4BEE40)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_26*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_26_TypeDefinitionIndex)->GetStaticField(0x519C0);
	}
