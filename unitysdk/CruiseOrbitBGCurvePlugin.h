...
#define CRUISEORBITBGCURVEPLUGIN_APPLYARC_OFFSET UNITYSDK_OFFSET(0xD35E860)
#define CRUISEORBITBGCURVEPLUGIN_AWAKE_OFFSET UNITYSDK_OFFSET(0xD35CAC0)
#define CRUISEORBITBGCURVEPLUGIN_CALCPOSITIONBYDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0xD35FF70)
#define CRUISEORBITBGCURVEPLUGIN_GETANGLE_OFFSET UNITYSDK_OFFSET(0xD35E370)
#define CRUISEORBITBGCURVEPLUGIN_GETCENTERPOS_OFFSET UNITYSDK_OFFSET(0xD35E300)
#define CRUISEORBITBGCURVEPLUGIN_GETCLOSESTONARCPROJECTIONTORAY_OFFSET UNITYSDK_OFFSET(0xD35F3B0)
#define CRUISEORBITBGCURVEPLUGIN_GETCORRECTEDPOSITION_OFFSET UNITYSDK_OFFSET(0xD35DD80)
#define CRUISEORBITBGCURVEPLUGIN_GETCURRENTRATIO_OFFSET UNITYSDK_OFFSET(0xD360790)
#define CRUISEORBITBGCURVEPLUGIN_GETCURRENTSPEED_OFFSET UNITYSDK_OFFSET(0xD3607E0)
#define CRUISEORBITBGCURVEPLUGIN_GETDEATHAREASTATE_OFFSET UNITYSDK_OFFSET(0xD35D350)
#define CRUISEORBITBGCURVEPLUGIN_GETDEATHAREATYPEBYDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0xD35D8B0)
#define CRUISEORBITBGCURVEPLUGIN_GETDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0xD35D860)
#define CRUISEORBITBGCURVEPLUGIN_GETNEARESTPOSITIONRATIO_OFFSET UNITYSDK_OFFSET(0xD35FAF0)
#define CRUISEORBITBGCURVEPLUGIN_GETNEXTSTEPDISTANCEDELTA_OFFSET UNITYSDK_OFFSET(0xD35DAB0)
#define CRUISEORBITBGCURVEPLUGIN_GETRAYFROMARCPOSITION_OFFSET UNITYSDK_OFFSET(0xD35DB30)
#define CRUISEORBITBGCURVEPLUGIN_GETRAYFROMCRICLETOARCPOSITION_OFFSET UNITYSDK_OFFSET(0xD35DC00)
#define CRUISEORBITBGCURVEPLUGIN_GET_FINALPOSITION_OFFSET UNITYSDK_OFFSET(0xD35DD00)
#define CRUISEORBITBGCURVEPLUGIN_GET_RAWPOSITION_OFFSET UNITYSDK_OFFSET(0xD35DCD0)
#define CRUISEORBITBGCURVEPLUGIN_ISLEAVINGDEATHAREA_OFFSET UNITYSDK_OFFSET(0xD35D980)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_0F2AF21BF93699B5_1_OFFSET UNITYSDK_OFFSET(0xD35E780)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_0F2AF21BF93699B5_OFFSET UNITYSDK_OFFSET(0xD35E6F0)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0xD35E900)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_AA43C393D46889E6_OFFSET UNITYSDK_OFFSET(0xD35F550)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_AAB36E9C15D550EF_OFFSET UNITYSDK_OFFSET(0xD35FCD0)
#define CRUISEORBITBGCURVEPLUGIN_METHOD_5_CD6C0B4190E9DEBA_OFFSET UNITYSDK_OFFSET(0xD35E810)
#define CRUISEORBITBGCURVEPLUGIN_RECALCULATECURVE_OFFSET UNITYSDK_OFFSET(0xD35CD20)
#define CRUISEORBITBGCURVEPLUGIN_REINIT_OFFSET UNITYSDK_OFFSET(0xD35C4F0)
#define CRUISEORBITBGCURVEPLUGIN_SETTRSPARAMS_OFFSET UNITYSDK_OFFSET(0xD360450)
#define CRUISEORBITBGCURVEPLUGIN_SET_RAWPOSITION_OFFSET UNITYSDK_OFFSET(0xD35DCF0)
#define CRUISEORBITBGCURVEPLUGIN_TICK_OFFSET UNITYSDK_OFFSET(0xD360090)
#define CRUISEORBITBGCURVEPLUGIN_TRANSFERROTATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0xD3605F0)
#define CRUISEORBITBGCURVEPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xD360830)
#define CRUISEORBITBGCURVEPLUGIN__FINDNEXTNONDEATHSECTIONSTARTDISTANCE_OFFSET UNITYSDK_OFFSET(0xD35E3B0)
