...
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_0CE847FF527A969C_OFFSET UNITYSDK_OFFSET(0xBA2D9B0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_40A3233404DDB201_OFFSET UNITYSDK_OFFSET(0xBA2E8F0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_55357EED91DD300A_OFFSET UNITYSDK_OFFSET(0xBA2E870)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_594B16EC13924620_OFFSET UNITYSDK_OFFSET(0xBA2E770)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_5A4F244FA80C999D_OFFSET UNITYSDK_OFFSET(0xBA2C9D0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_7B23922E4C775970_OFFSET UNITYSDK_OFFSET(0xBA2DFB0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_7B79FC85A5EDBF4B_OFFSET UNITYSDK_OFFSET(0xBA2EEA0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_7C350CDAB199DC24_OFFSET UNITYSDK_OFFSET(0xBA2E6A0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_A13A778D4D3E962F_OFFSET UNITYSDK_OFFSET(0xBA2E5E0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_A42DC4450468C0E0_OFFSET UNITYSDK_OFFSET(0xBA2E100)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_B7E646E7463E1B89_OFFSET UNITYSDK_OFFSET(0xBA2C3F0)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_C76FBF5BDDCD86A3_OFFSET UNITYSDK_OFFSET(0xBA2E460)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_D0E12D959862FC72_OFFSET UNITYSDK_OFFSET(0xBA2DD40)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_DC4F7BE1519B0B0B_OFFSET UNITYSDK_OFFSET(0xBA2DE00)
#define CLASS_2_B078978DCA0CA7A4_METHOD_2_FEA73477BA929C29_OFFSET UNITYSDK_OFFSET(0xBA2CBF0)
#define CLASS_2_B078978DCA0CA7A4__CCTOR_OFFSET UNITYSDK_OFFSET(0xBA2EF20)
#define CLASS_2_B078978DCA0CA7A4__CTOR_OFFSET UNITYSDK_OFFSET(0xBA2C350)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B078978DCA0CA7A4_TypeDefinitionIndex)->GetStaticField(0x2F6B0);
	}
	static ::System::String** StaticGet_Field_2_1()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B078978DCA0CA7A4_TypeDefinitionIndex)->GetStaticField(0x2F6B8);
	}
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_2_B078978DCA0CA7A4_Class_1_9D2500B7447E67F1*>* Field_2_2; // 0x18
	::RPG::GameCore::ComplexSkillAIAxis* Field_2_3; // 0x20
	::Class_1_73D621BDD90E61A7* Field_2_4; // 0x28
