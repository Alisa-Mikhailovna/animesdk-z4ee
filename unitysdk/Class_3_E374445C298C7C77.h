...
#define CLASS_3_E374445C298C7C77_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14990090)
#define CLASS_3_E374445C298C7C77_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x149900E0)
#define CLASS_3_E374445C298C7C77_TICK_OFFSET UNITYSDK_OFFSET(0x14990130)
#define CLASS_3_E374445C298C7C77__CTOR_OFFSET UNITYSDK_OFFSET(0x14990060)
