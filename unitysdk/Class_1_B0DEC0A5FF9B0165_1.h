...
#define CLASS_1_B0DEC0A5FF9B0165_1_METHOD_1_076FEE641C2B6499_OFFSET UNITYSDK_OFFSET(0x1478E8B0)
#define CLASS_1_B0DEC0A5FF9B0165_1_METHOD_1_C4BFBB1BE6C0430A_OFFSET UNITYSDK_OFFSET(0x1478E820)
#define CLASS_1_B0DEC0A5FF9B0165_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1478E970)
#define CLASS_1_B0DEC0A5FF9B0165_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1478E8A0)

inline static constexpr unsigned int Class_1_B0DEC0A5FF9B0165_1_TypeDefinitionIndex = 71666;
...
public:
	...
	{
		return (::Class_1_B0DEC0A5FF9B0165_1**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B0DEC0A5FF9B0165_1_TypeDefinitionIndex)->GetStaticField(0x56EB0);
	}
