...
#define AKOBJECTINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D1D6050)
#define AKOBJECTINFO_CLONE_OFFSET UNITYSDK_OFFSET(0x1D1D61B0)
#define AKOBJECTINFO_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1D1D5A20)
#define AKOBJECTINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D1D5830)
#define AKOBJECTINFO_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D1D5950)
#define AKOBJECTINFO_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1D1D5780)
#define AKOBJECTINFO_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1D1D6100)
#define AKOBJECTINFO_GET_IDEPTH_OFFSET UNITYSDK_OFFSET(0x1D1D5FA0)
#define AKOBJECTINFO_GET_OBJID_OFFSET UNITYSDK_OFFSET(0x1D1D5CC0)
#define AKOBJECTINFO_GET_PARENTID_OFFSET UNITYSDK_OFFSET(0x1D1D5E30)
#define AKOBJECTINFO_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1D1D57D0)
#define AKOBJECTINFO_SET_IDEPTH_OFFSET UNITYSDK_OFFSET(0x1D1D5EE0)
#define AKOBJECTINFO_SET_OBJID_OFFSET UNITYSDK_OFFSET(0x1D1D5C00)
#define AKOBJECTINFO_SET_PARENTID_OFFSET UNITYSDK_OFFSET(0x1D1D5D70)
#define AKOBJECTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D1D62D0)
#define AKOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D5770)
