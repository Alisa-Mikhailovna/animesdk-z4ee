...
#define RENDERITEMPOLYMERCONFIG_GET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xDD3CDC0)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xDD3DB60)
#define RENDERITEMPOLYMERCONFIG_GET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xDD3C330)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0xDD3CA80)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_560ABD6EDDE4D0DB_OFFSET UNITYSDK_OFFSET(0xDD3C3A0)
#define RENDERITEMPOLYMERCONFIG_METHOD_5_65BECD5F98452910_OFFSET UNITYSDK_OFFSET(0xDD3CF50)
#define RENDERITEMPOLYMERCONFIG_SET_ADDANIMATIONIRI_OFFSET UNITYSDK_OFFSET(0xDD3CDD0)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONCHILDPATH_OFFSET UNITYSDK_OFFSET(0xDD3DB70)
#define RENDERITEMPOLYMERCONFIG_SET_ADDSYNCPOSITIONROOTPATH_OFFSET UNITYSDK_OFFSET(0xDD3C340)
#define RENDERITEMPOLYMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xDD3DDA0)
