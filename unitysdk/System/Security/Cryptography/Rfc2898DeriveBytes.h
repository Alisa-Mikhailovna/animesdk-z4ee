...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FC4F60)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_FUNC_OFFSET UNITYSDK_OFFSET(0x19FC4B50)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_GETBYTES_OFFSET UNITYSDK_OFFSET(0x19FC4A10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19FC49C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_SET_ITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19FC4930)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_SET_SALT_OFFSET UNITYSDK_OFFSET(0x19FC47B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES__CTOR_OFFSET UNITYSDK_OFFSET(0x19FC4660)
...
namespace System::Security::Cryptography
{
	...
	public:
		...
		::System::UInt32 m_iterations; // 0x30
