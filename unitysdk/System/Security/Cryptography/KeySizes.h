...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_KEYSIZES_GET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1A250980)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_KEYSIZES_GET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1A250970)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_KEYSIZES_GET_SKIPSIZE_OFFSET UNITYSDK_OFFSET(0x1A250990)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_KEYSIZES_ISLEGALKEYSIZE_OFFSET UNITYSDK_OFFSET(0x1A2509E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_KEYSIZES_ISLEGAL_OFFSET UNITYSDK_OFFSET(0x1A2509A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_KEYSIZES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A242AA0)
