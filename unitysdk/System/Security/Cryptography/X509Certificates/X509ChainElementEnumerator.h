...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CD3ECE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CD3EDE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENTENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD3EBD0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD3EAD0)
