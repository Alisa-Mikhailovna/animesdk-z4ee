...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_CONVERTDATA_OFFSET UNITYSDK_OFFSET(0x19FD8700)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_GETINVALIDCONTEXTEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19FD6610)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_IMPORTCORE_OFFSET UNITYSDK_OFFSET(0x19FD77D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_IMPORTPKCS12_OFFSET UNITYSDK_OFFSET(0x19FD78B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_IMPORT_1_OFFSET UNITYSDK_OFFSET(0x19FD5FD0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_IMPORT_OFFSET UNITYSDK_OFFSET(0x19FD77C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_INITFROMCERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x19FD4CD0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_INITFROMCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x19FD4E90)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_INSTALLNATIVEHELPER_OFFSET UNITYSDK_OFFSET(0x19FD77A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_ISVALID_OFFSET UNITYSDK_OFFSET(0x19FD50B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_PEM_OFFSET UNITYSDK_OFFSET(0x19FD8230)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_THROWIFCONTEXTINVALID_OFFSET UNITYSDK_OFFSET(0x19FD4F80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509HELPER_TOHEXSTRING_OFFSET UNITYSDK_OFFSET(0x19FD5550)
...
namespace System::Security::Cryptography::X509Certificates
{
	...
	public:
		...
		{
			return (::System::Security::Cryptography::X509Certificates::INativeCertificateHelper**)Il2CppClass::FromTypeDefinitionIndex(X509Helper_TypeDefinitionIndex)->GetStaticField(0x1B340);
		}
