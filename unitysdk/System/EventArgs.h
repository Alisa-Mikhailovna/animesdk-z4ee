...
#define SYSTEM_EVENTARGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0F8C80)
#define SYSTEM_EVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C7B30)
...
namespace System
{
	...
	public:
		...
		{
			return (::System::EventArgs**)Il2CppClass::FromTypeDefinitionIndex(EventArgs_TypeDefinitionIndex)->GetStaticField(0x6780);
		}
