...
#define SYSTEM_GLOBALIZATION_CALENDARDATA_CALENDARIDTOCULTURENAME_OFFSET UNITYSDK_OFFSET(0x1A0FE9D0)
#define SYSTEM_GLOBALIZATION_CALENDARDATA_FILL_CALENDAR_DATA_OFFSET UNITYSDK_OFFSET(0x1A0FECC0)
#define SYSTEM_GLOBALIZATION_CALENDARDATA_GETCALENDARDATA_OFFSET UNITYSDK_OFFSET(0x1A0FC6B0)
#define SYSTEM_GLOBALIZATION_CALENDARDATA_INITIALIZEABBREVIATEDERANAMES_OFFSET UNITYSDK_OFFSET(0x1A0FE3C0)
#define SYSTEM_GLOBALIZATION_CALENDARDATA_INITIALIZEERANAMES_OFFSET UNITYSDK_OFFSET(0x1A0FDF50)
#define SYSTEM_GLOBALIZATION_CALENDARDATA_NATIVEGETCALENDARDATA_OFFSET UNITYSDK_OFFSET(0x1A0FDED0)
#define SYSTEM_GLOBALIZATION_CALENDARDATA_NATIVEGETTWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1A0FD140)
#define SYSTEM_GLOBALIZATION_CALENDARDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0FD160)
#define SYSTEM_GLOBALIZATION_CALENDARDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0FD790)
#define SYSTEM_GLOBALIZATION_CALENDARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FD150)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::System::Globalization::CalendarData**)Il2CppClass::FromTypeDefinitionIndex(CalendarData_TypeDefinitionIndex)->GetStaticField(0x7010);
		}
