...
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKEN_ISINVALIDNUMBER_OFFSET UNITYSDK_OFFSET(0x39DCD00)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKEN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x39DCCE0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0x39DCCC0)
