...
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_DAYHOURSEP_OFFSET UNITYSDK_OFFSET(0x39DC3A0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_END_OFFSET UNITYSDK_OFFSET(0x39DC460)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_HOURMINUTESEP_OFFSET UNITYSDK_OFFSET(0x39DC3D0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_MINUTESECONDSEP_OFFSET UNITYSDK_OFFSET(0x39DC400)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_SECONDFRACTIONSEP_OFFSET UNITYSDK_OFFSET(0x39DC430)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_START_OFFSET UNITYSDK_OFFSET(0x39DC370)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_INITINVARIANT_OFFSET UNITYSDK_OFFSET(0x1A129A60)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_INIT_OFFSET UNITYSDK_OFFSET(0x39DC490)
