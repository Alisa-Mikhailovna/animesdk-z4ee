...
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_FINDSECTION_OFFSET UNITYSDK_OFFSET(0x1CAFCBE0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_FORMATCURRENCY_OFFSET UNITYSDK_OFFSET(0x1CAFA9A0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_FORMATEXPONENT_OFFSET UNITYSDK_OFFSET(0x1CAFC7F0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_FORMATFIXED_OFFSET UNITYSDK_OFFSET(0x1CAFAD90)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_FORMATGENERAL_OFFSET UNITYSDK_OFFSET(0x1CAFBD60)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_FORMATNUMBER_OFFSET UNITYSDK_OFFSET(0x1CAFB560)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_FORMATPERCENT_OFFSET UNITYSDK_OFFSET(0x1CAFC3D0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_FORMATSCIENTIFIC_OFFSET UNITYSDK_OFFSET(0x1CAFBA30)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_INT32TODECCHARS_OFFSET UNITYSDK_OFFSET(0x1CAFA850)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_ISWHITE_OFFSET UNITYSDK_OFFSET(0x1CAF93C0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_MATCHCHARS_1_OFFSET UNITYSDK_OFFSET(0x1CAF9490)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_MATCHCHARS_OFFSET UNITYSDK_OFFSET(0x1CAF93E0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_NUMBERTOSTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1CAF7930)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_NUMBERTOSTRING_OFFSET UNITYSDK_OFFSET(0x1CAF6DB0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_PARSEFORMATSPECIFIER_OFFSET UNITYSDK_OFFSET(0x1CAF6CF0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x1CAF94E0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_ROUNDNUMBER_OFFSET UNITYSDK_OFFSET(0x1CAFA8B0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_TRAILINGZEROS_OFFSET UNITYSDK_OFFSET(0x1CAFA780)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_TRYSTRINGTONUMBER_OFFSET UNITYSDK_OFFSET(0x1CAF9240)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER_WCSLEN_OFFSET UNITYSDK_OFFSET(0x1CAFC7C0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_NUMBER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CAFCCA0)
