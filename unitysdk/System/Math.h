...
#define SYSTEM_MATH_ABSHELPER_1_OFFSET UNITYSDK_OFFSET(0x1A168130)
#define SYSTEM_MATH_ABSHELPER_OFFSET UNITYSDK_OFFSET(0x1A168030)
#define SYSTEM_MATH_ABS_1_OFFSET UNITYSDK_OFFSET(0x1A1680A0)
#define SYSTEM_MATH_ABS_2_OFFSET UNITYSDK_OFFSET(0x1A1681B0)
#define SYSTEM_MATH_ABS_3_OFFSET UNITYSDK_OFFSET(0x1A1681C0)
#define SYSTEM_MATH_ABS_4_OFFSET UNITYSDK_OFFSET(0x1A1681D0)
#define SYSTEM_MATH_ABS_OFFSET UNITYSDK_OFFSET(0x1A167FB0)
#define SYSTEM_MATH_ACOS_OFFSET UNITYSDK_OFFSET(0x1A167520)
#define SYSTEM_MATH_ASIN_OFFSET UNITYSDK_OFFSET(0x1A167530)
#define SYSTEM_MATH_ATAN2_OFFSET UNITYSDK_OFFSET(0x1A167550)
#define SYSTEM_MATH_ATAN_OFFSET UNITYSDK_OFFSET(0x1A167540)
#define SYSTEM_MATH_CEILING_OFFSET UNITYSDK_OFFSET(0x1A167560)
#define SYSTEM_MATH_COS_OFFSET UNITYSDK_OFFSET(0x1A167570)
#define SYSTEM_MATH_EXP_OFFSET UNITYSDK_OFFSET(0x1A167D10)
#define SYSTEM_MATH_FLOOR_1_OFFSET UNITYSDK_OFFSET(0x1A1675F0)
#define SYSTEM_MATH_FLOOR_OFFSET UNITYSDK_OFFSET(0x1A167580)
#define SYSTEM_MATH_IEEEREMAINDER_OFFSET UNITYSDK_OFFSET(0x1A167D30)
#define SYSTEM_MATH_INTERNALROUND_OFFSET UNITYSDK_OFFSET(0x1A167600)
#define SYSTEM_MATH_INTERNALTRUNCATE_OFFSET UNITYSDK_OFFSET(0x1A1678C0)
#define SYSTEM_MATH_LOG10_OFFSET UNITYSDK_OFFSET(0x1A167D00)
#define SYSTEM_MATH_LOG_1_OFFSET UNITYSDK_OFFSET(0x1A1683F0)
#define SYSTEM_MATH_LOG_OFFSET UNITYSDK_OFFSET(0x1A167CF0)
#define SYSTEM_MATH_MAX_1_OFFSET UNITYSDK_OFFSET(0x1A14B190)
#define SYSTEM_MATH_MAX_2_OFFSET UNITYSDK_OFFSET(0x1A168280)
#define SYSTEM_MATH_MAX_3_OFFSET UNITYSDK_OFFSET(0x1A168290)
#define SYSTEM_MATH_MAX_4_OFFSET UNITYSDK_OFFSET(0x1A1682A0)
#define SYSTEM_MATH_MAX_5_OFFSET UNITYSDK_OFFSET(0x1A1682B0)
#define SYSTEM_MATH_MAX_6_OFFSET UNITYSDK_OFFSET(0x1A1682E0)
#define SYSTEM_MATH_MAX_OFFSET UNITYSDK_OFFSET(0x1A168270)
#define SYSTEM_MATH_MIN_1_OFFSET UNITYSDK_OFFSET(0x1A14AFA0)
#define SYSTEM_MATH_MIN_2_OFFSET UNITYSDK_OFFSET(0x1A168340)
#define SYSTEM_MATH_MIN_3_OFFSET UNITYSDK_OFFSET(0x1A168350)
#define SYSTEM_MATH_MIN_4_OFFSET UNITYSDK_OFFSET(0x1A168360)
#define SYSTEM_MATH_MIN_5_OFFSET UNITYSDK_OFFSET(0x1A1683A0)
#define SYSTEM_MATH_MIN_OFFSET UNITYSDK_OFFSET(0x1A168330)
#define SYSTEM_MATH_POW_OFFSET UNITYSDK_OFFSET(0x1A167D20)
#define SYSTEM_MATH_ROUND_1_OFFSET UNITYSDK_OFFSET(0x1A1679B0)
#define SYSTEM_MATH_ROUND_2_OFFSET UNITYSDK_OFFSET(0x1A167A10)
#define SYSTEM_MATH_ROUND_3_OFFSET UNITYSDK_OFFSET(0x1A167A20)
#define SYSTEM_MATH_ROUND_4_OFFSET UNITYSDK_OFFSET(0x1A167B60)
#define SYSTEM_MATH_ROUND_5_OFFSET UNITYSDK_OFFSET(0x1A167BD0)
#define SYSTEM_MATH_ROUND_OFFSET UNITYSDK_OFFSET(0x1A167900)
#define SYSTEM_MATH_SIGN_1_OFFSET UNITYSDK_OFFSET(0x1A1684B0)
#define SYSTEM_MATH_SIGN_2_OFFSET UNITYSDK_OFFSET(0x1A1684D0)
#define SYSTEM_MATH_SIGN_3_OFFSET UNITYSDK_OFFSET(0x1A167820)
#define SYSTEM_MATH_SIGN_OFFSET UNITYSDK_OFFSET(0x1A1684A0)
#define SYSTEM_MATH_SIN_OFFSET UNITYSDK_OFFSET(0x1A1678E0)
#define SYSTEM_MATH_SPLITFRACTIONDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A167810)
#define SYSTEM_MATH_SQRT_OFFSET UNITYSDK_OFFSET(0x1A167CD0)
#define SYSTEM_MATH_TAN_OFFSET UNITYSDK_OFFSET(0x1A1678F0)
#define SYSTEM_MATH_TRUNCATE_1_OFFSET UNITYSDK_OFFSET(0x1A167CB0)
#define SYSTEM_MATH_TRUNCATE_OFFSET UNITYSDK_OFFSET(0x1A167C40)
#define SYSTEM_MATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A168570)
...
namespace System
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0xE130);
		}
		static ::System::Double* StaticGet_doubleRoundLimit()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(Math_TypeDefinitionIndex)->GetStaticField(0x4E00);
		}
