...
#define SYSTEM_NET_HTTPCONTINUEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CCDED00)
#define SYSTEM_NET_HTTPCONTINUEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CCDED60)
#define SYSTEM_NET_HTTPCONTINUEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CCDECF0)
#define SYSTEM_NET_HTTPCONTINUEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCDEC80)
