...
#define SYSTEM_NET_ENDPOINTLISTENER_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1CCC3D60)
#define SYSTEM_NET_ENDPOINTLISTENER_ADDPREFIX_OFFSET UNITYSDK_OFFSET(0x1CCC72B0)
#define SYSTEM_NET_ENDPOINTLISTENER_ADDSPECIAL_OFFSET UNITYSDK_OFFSET(0x1CCC5B90)
#define SYSTEM_NET_ENDPOINTLISTENER_BINDCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CCC48A0)
#define SYSTEM_NET_ENDPOINTLISTENER_CHECKIFREMOVE_OFFSET UNITYSDK_OFFSET(0x1CCC6460)
#define SYSTEM_NET_ENDPOINTLISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1CCC6A70)
#define SYSTEM_NET_ENDPOINTLISTENER_GET_LISTENER_OFFSET UNITYSDK_OFFSET(0x1CCC3E20)
#define SYSTEM_NET_ENDPOINTLISTENER_MATCHFROMLIST_OFFSET UNITYSDK_OFFSET(0x1CCC56A0)
#define SYSTEM_NET_ENDPOINTLISTENER_ONACCEPT_OFFSET UNITYSDK_OFFSET(0x1CCC47A0)
#define SYSTEM_NET_ENDPOINTLISTENER_PROCESSACCEPT_OFFSET UNITYSDK_OFFSET(0x1CCC3E30)
#define SYSTEM_NET_ENDPOINTLISTENER_REMOVECONNECTION_OFFSET UNITYSDK_OFFSET(0x1CCC47B0)
#define SYSTEM_NET_ENDPOINTLISTENER_REMOVEPREFIX_OFFSET UNITYSDK_OFFSET(0x1CCC7890)
#define SYSTEM_NET_ENDPOINTLISTENER_REMOVESPECIAL_OFFSET UNITYSDK_OFFSET(0x1CCC61A0)
#define SYSTEM_NET_ENDPOINTLISTENER_SEARCHLISTENER_OFFSET UNITYSDK_OFFSET(0x1CCC4910)
#define SYSTEM_NET_ENDPOINTLISTENER_UNBINDCONTEXT_OFFSET UNITYSDK_OFFSET(0x1CCC5330)
#define SYSTEM_NET_ENDPOINTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCC3540)
