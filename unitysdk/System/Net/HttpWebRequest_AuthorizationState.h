...
#define SYSTEM_NET_HTTPWEBREQUEST_AUTHORIZATIONSTATE_CHECKAUTHORIZATION_OFFSET UNITYSDK_OFFSET(0x3A160F0)
#define SYSTEM_NET_HTTPWEBREQUEST_AUTHORIZATIONSTATE_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x39D4B40)
#define SYSTEM_NET_HTTPWEBREQUEST_AUTHORIZATIONSTATE_GET_ISNTLMAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x3A160B0)
#define SYSTEM_NET_HTTPWEBREQUEST_AUTHORIZATIONSTATE_GET_NTLMAUTHSTATE_OFFSET UNITYSDK_OFFSET(0x14EDE0)
#define SYSTEM_NET_HTTPWEBREQUEST_AUTHORIZATIONSTATE_RESET_OFFSET UNITYSDK_OFFSET(0x3A16100)
#define SYSTEM_NET_HTTPWEBREQUEST_AUTHORIZATIONSTATE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A161F0)
#define SYSTEM_NET_HTTPWEBREQUEST_AUTHORIZATIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x3A160D0)
