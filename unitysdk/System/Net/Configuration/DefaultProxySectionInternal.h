...
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTIONINTERNAL_GETDEFAULTPROXY_USINGOLDMONOCODE_OFFSET UNITYSDK_OFFSET(0x1CCADA00)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTIONINTERNAL_GETSECTION_OFFSET UNITYSDK_OFFSET(0x1CCADA90)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTIONINTERNAL_GETSYSTEMWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1CCADA20)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTIONINTERNAL_GET_CLASSSYNCOBJECT_OFFSET UNITYSDK_OFFSET(0x1CCADA40)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTIONINTERNAL_GET_WEBPROXY_OFFSET UNITYSDK_OFFSET(0x1CCADBC0)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTIONINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCADBB0)
...
namespace System::Net::Configuration
{
	...
	public:
		...
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(DefaultProxySectionInternal_TypeDefinitionIndex)->GetStaticField(0x2B660);
		}
