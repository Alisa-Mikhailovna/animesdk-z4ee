...
#define SYSTEM_NET_COOKIEEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1CCBCF20)
#define SYSTEM_NET_COOKIEEXCEPTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1CCBCF00)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CCBCDD0)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CCBCE40)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1CCBCEB0)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCBCD30)
