...
#define SYSTEM_NET_HTTP_HTTPCONTENT_COPYTOASYNC_1_OFFSET UNITYSDK_OFFSET(0x1CAF0380)
#define SYSTEM_NET_HTTP_HTTPCONTENT_COPYTOASYNC_OFFSET UNITYSDK_OFFSET(0x1CAF02C0)
#define SYSTEM_NET_HTTP_HTTPCONTENT_COPYTO_OFFSET UNITYSDK_OFFSET(0x1CAF0350)
#define SYSTEM_NET_HTTP_HTTPCONTENT_CREATEFIXEDMEMORYSTREAM_OFFSET UNITYSDK_OFFSET(0x1CAF0470)
#define SYSTEM_NET_HTTP_HTTPCONTENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1CAF05A0)
#define SYSTEM_NET_HTTP_HTTPCONTENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CAF0520)
#define SYSTEM_NET_HTTP_HTTPCONTENT_GETENCODINGFROMBUFFER_OFFSET UNITYSDK_OFFSET(0x1CAF07D0)
#define SYSTEM_NET_HTTP_HTTPCONTENT_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1CAED8D0)
#define SYSTEM_NET_HTTP_HTTPCONTENT_GET_LOADEDBUFFERLENGTH_OFFSET UNITYSDK_OFFSET(0x1CADCCD0)
#define SYSTEM_NET_HTTP_HTTPCONTENT_LOADINTOBUFFERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1CAEC580)
#define SYSTEM_NET_HTTP_HTTPCONTENT_LOADINTOBUFFERASYNC_OFFSET UNITYSDK_OFFSET(0x1CAF0640)
#define SYSTEM_NET_HTTP_HTTPCONTENT_READASSTRINGASYNC_OFFSET UNITYSDK_OFFSET(0x1CAF0720)
#define SYSTEM_NET_HTTP_HTTPCONTENT_STARTSWITH_OFFSET UNITYSDK_OFFSET(0x1CAF0B60)
#define SYSTEM_NET_HTTP_HTTPCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAD7A10)
