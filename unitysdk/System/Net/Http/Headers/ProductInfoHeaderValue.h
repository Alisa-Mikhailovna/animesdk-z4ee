...
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CAE5DF0)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CAE5F40)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_GET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1CAE5D10)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_GET_PRODUCT_OFFSET UNITYSDK_OFFSET(0x1CAE5D30)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_SET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1CAE5D20)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_SET_PRODUCT_OFFSET UNITYSDK_OFFSET(0x1CAE5D40)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1CAE5D50)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CAE63F0)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_TRYPARSEELEMENT_OFFSET UNITYSDK_OFFSET(0x1CAE61A0)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1CAE5FE0)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CAE5D00)
#define SYSTEM_NET_HTTP_HEADERS_PRODUCTINFOHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE5C90)
