...
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_ASIPV4INT_OFFSET UNITYSDK_OFFSET(0x3A16530)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_ISIPV4COMPATIBLE_OFFSET UNITYSDK_OFFSET(0x3A16570)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_ISIPV4MAPPED_OFFSET UNITYSDK_OFFSET(0x3A16580)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_SWAPUSHORT_OFFSET UNITYSDK_OFFSET(0x1CCF4960)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A16600)
#define SYSTEM_NET_IPV6ADDRESSFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x80E20)
