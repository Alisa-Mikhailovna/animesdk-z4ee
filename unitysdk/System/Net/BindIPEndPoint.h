...
#define SYSTEM_NET_BINDIPENDPOINT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CCAC3F0)
#define SYSTEM_NET_BINDIPENDPOINT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CCAC460)
#define SYSTEM_NET_BINDIPENDPOINT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CCAC3D0)
#define SYSTEM_NET_BINDIPENDPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCAC2E0)
