...
#define SYSTEM_RESOURCES_MISSINGSATELLITEASSEMBLYEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1A3B90)
#define SYSTEM_RESOURCES_MISSINGSATELLITEASSEMBLYEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A1A3E20)
#define SYSTEM_RESOURCES_MISSINGSATELLITEASSEMBLYEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A3D80)
