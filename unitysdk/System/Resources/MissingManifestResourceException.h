...
#define SYSTEM_RESOURCES_MISSINGMANIFESTRESOURCEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A19FC80)
#define SYSTEM_RESOURCES_MISSINGMANIFESTRESOURCEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A1A3D30)
#define SYSTEM_RESOURCES_MISSINGMANIFESTRESOURCEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A3C90)
