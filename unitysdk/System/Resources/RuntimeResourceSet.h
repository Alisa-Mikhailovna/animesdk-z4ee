...
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1B08B0)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETENUMERATORHELPER_OFFSET UNITYSDK_OFFSET(0x1A1B0C50)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A1B0C40)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1A1B1CD0)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1A1B0D90)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x1A1B1CC0)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETSTRING_1_OFFSET UNITYSDK_OFFSET(0x1A1B1C90)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1A1B0D60)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_RESOLVERESOURCELOCATOR_OFFSET UNITYSDK_OFFSET(0x1A1B1CE0)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A1B0D50)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1A2EF0)
#define SYSTEM_RESOURCES_RUNTIMERESOURCESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A19FFD0)
