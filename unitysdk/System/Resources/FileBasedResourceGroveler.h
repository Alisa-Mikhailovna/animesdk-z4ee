...
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER_CREATERESOURCESET_OFFSET UNITYSDK_OFFSET(0x1A19FCF0)
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER_FINDRESOURCEFILE_OFFSET UNITYSDK_OFFSET(0x1A19FAF0)
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER_GROVELFORRESOURCESET_OFFSET UNITYSDK_OFFSET(0x1A19F690)
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A19F680)
