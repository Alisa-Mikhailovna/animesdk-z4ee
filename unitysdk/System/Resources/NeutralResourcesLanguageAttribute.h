...
#define SYSTEM_RESOURCES_NEUTRALRESOURCESLANGUAGEATTRIBUTE_GET_CULTURENAME_OFFSET UNITYSDK_OFFSET(0x1A1A3EE0)
#define SYSTEM_RESOURCES_NEUTRALRESOURCESLANGUAGEATTRIBUTE_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x1A1A3EF0)
#define SYSTEM_RESOURCES_NEUTRALRESOURCESLANGUAGEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A3E70)
