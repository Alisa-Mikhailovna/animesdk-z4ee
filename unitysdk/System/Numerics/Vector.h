...
#define SYSTEM_NUMERICS_VECTOR_CONDITIONALSELECT_OFFSET UNITYSDK_OFFSET(0x1CAF4F70)
#define SYSTEM_NUMERICS_VECTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CAF5070)
#define SYSTEM_NUMERICS_VECTOR_GET_ISHARDWAREACCELERATED_OFFSET UNITYSDK_OFFSET(0x1CAF51B0)
#define SYSTEM_NUMERICS_VECTOR_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1CAF5110)
