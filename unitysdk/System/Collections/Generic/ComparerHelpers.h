...
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_CREATEDEFAULTCOMPARER_OFFSET UNITYSDK_OFFSET(0x19FB22D0)
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_CREATEDEFAULTEQUALITYCOMPARER_OFFSET UNITYSDK_OFFSET(0x19FB1BE0)
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_HASICOMPARABLE_OFFSET UNITYSDK_OFFSET(0x19FB2000)
#define SYSTEM_COLLECTIONS_GENERIC_COMPARERHELPERS_HASIEQUATABLE_OFFSET UNITYSDK_OFFSET(0x19FB1920)
