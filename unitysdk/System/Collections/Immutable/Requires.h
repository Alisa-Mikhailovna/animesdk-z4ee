...
#define SYSTEM_COLLECTIONS_IMMUTABLE_REQUIRES_ARGUMENT_OFFSET UNITYSDK_OFFSET(0x1CA14C10)
#define SYSTEM_COLLECTIONS_IMMUTABLE_REQUIRES_FAILARGUMENTNULLEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1CA14B00)
#define SYSTEM_COLLECTIONS_IMMUTABLE_REQUIRES_FAILRANGE_OFFSET UNITYSDK_OFFSET(0x1CA14B70)
#define SYSTEM_COLLECTIONS_IMMUTABLE_REQUIRES_RANGE_OFFSET UNITYSDK_OFFSET(0x1CA14B50)
