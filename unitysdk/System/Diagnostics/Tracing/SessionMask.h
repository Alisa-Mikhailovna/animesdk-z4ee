...
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK_FROMEVENTKEYWORDS_OFFSET UNITYSDK_OFFSET(0x1A0CBC50)
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK_FROMID_OFFSET UNITYSDK_OFFSET(0x1A0DBE40)
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK_GET_ALL_OFFSET UNITYSDK_OFFSET(0x1A0CBD70)
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x2D5A090)
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK_ISEQUALORSUPERSETOF_OFFSET UNITYSDK_OFFSET(0x39DB3F0)
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A0EBB30)
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1A0D4130)
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x39DB410)
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK_TOEVENTKEYWORDS_OFFSET UNITYSDK_OFFSET(0x39DB400)
#define SYSTEM_DIAGNOSTICS_TRACING_SESSIONMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x39DB3E0)
