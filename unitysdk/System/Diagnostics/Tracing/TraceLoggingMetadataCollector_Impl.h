...
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_IMPL_ADDNONSCALAR_OFFSET UNITYSDK_OFFSET(0x1A0EE550)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_IMPL_ADDSCALAR_OFFSET UNITYSDK_OFFSET(0x1A0EE4D0)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_IMPL_BEGINBUFFERED_OFFSET UNITYSDK_OFFSET(0x1A0EE6B0)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_IMPL_ENCODE_OFFSET UNITYSDK_OFFSET(0x1A0EE7B0)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_IMPL_ENDBUFFERED_OFFSET UNITYSDK_OFFSET(0x1A0EE7A0)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_IMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0EE2E0)
