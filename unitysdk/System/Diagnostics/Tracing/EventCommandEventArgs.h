...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTCOMMANDEVENTARGS_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A0C7A60)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTCOMMANDEVENTARGS_GET_COMMAND_OFFSET UNITYSDK_OFFSET(0x1A0C7A40)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTCOMMANDEVENTARGS_SET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A0C7A70)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTCOMMANDEVENTARGS_SET_COMMAND_OFFSET UNITYSDK_OFFSET(0x1A0C7A50)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTCOMMANDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C7A80)
...
namespace System::Diagnostics::Tracing
{
	...
	public:
		...
		::System::Diagnostics::Tracing::EventDispatcher* dispatcher; // 0x18
