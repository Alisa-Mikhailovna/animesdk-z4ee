...
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_ACTIVITYCHANGING_OFFSET UNITYSDK_OFFSET(0x1A0C3B40)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_ENABLE_OFFSET UNITYSDK_OFFSET(0x1A0C3340)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_FINDACTIVEACTIVITY_OFFSET UNITYSDK_OFFSET(0x1A0C3580)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A0C3B10)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_NORMALIZEACTIVITYNAME_OFFSET UNITYSDK_OFFSET(0x1A0C33E0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A0C2DA0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1A0C3600)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0C3F40)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C3F30)
...
namespace System::Diagnostics::Tracing
{
	...
	public:
		...
		{
			return (::System::Diagnostics::Tracing::ActivityTracker**)Il2CppClass::FromTypeDefinitionIndex(ActivityTracker_TypeDefinitionIndex)->GetStaticField(0x5600);
		}
		static ::System::Int64* StaticGet_m_nextId()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(ActivityTracker_TypeDefinitionIndex)->GetStaticField(0x31E0);
		}
