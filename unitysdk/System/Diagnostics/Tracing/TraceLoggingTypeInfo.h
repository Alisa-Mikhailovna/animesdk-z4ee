...
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGTYPEINFO_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A0ED040)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGTYPEINFO_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x1A0EEB90)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGTYPEINFO_GET_KEYWORDS_OFFSET UNITYSDK_OFFSET(0x1A0EEB70)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGTYPEINFO_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A0EEB50)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGTYPEINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A0EEB40)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGTYPEINFO_GET_OPCODE_OFFSET UNITYSDK_OFFSET(0x1A0EEB60)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGTYPEINFO_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x1A0EEB80)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGTYPEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0EE9E0)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGTYPEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0EE8E0)
...
namespace System::Diagnostics::Tracing
{
	...
	public:
		...
		::System::Diagnostics::Tracing::EventOpcode opcode; // 0x34
