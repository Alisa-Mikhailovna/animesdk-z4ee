...
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_ADDARRAY_OFFSET UNITYSDK_OFFSET(0x1A0C4430)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_ADDBINARY_OFFSET UNITYSDK_OFFSET(0x1A0C4D30)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_ADDFIELD_OFFSET UNITYSDK_OFFSET(0x1A0EE390)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_ADDGROUP_OFFSET UNITYSDK_OFFSET(0x1A0C64B0)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_ADDSCALAR_OFFSET UNITYSDK_OFFSET(0x1A0C4920)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_BEGINBUFFEREDARRAY_OFFSET UNITYSDK_OFFSET(0x1A0EE5C0)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_ENDBUFFEREDARRAY_OFFSET UNITYSDK_OFFSET(0x1A0EE720)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_GETMETADATA_OFFSET UNITYSDK_OFFSET(0x1A0EE210)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_GET_BEGINNINGBUFFEREDARRAY_OFFSET UNITYSDK_OFFSET(0x1A0EE380)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x1A0EE280)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_GET_PINCOUNT_OFFSET UNITYSDK_OFFSET(0x1A0EE2A0)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_GET_SCRATCHSIZE_OFFSET UNITYSDK_OFFSET(0x1A0EE260)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x1A0EE360)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR_SET_TAGS_OFFSET UNITYSDK_OFFSET(0x1A0EE370)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0EE330)
#define SYSTEM_DIAGNOSTICS_TRACING_TRACELOGGINGMETADATACOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0EE180)
