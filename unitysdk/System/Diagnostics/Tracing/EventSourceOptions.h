...
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEOPTIONS_SET_KEYWORDS_OFFSET UNITYSDK_OFFSET(0x39DB3D0)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEOPTIONS_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x39DB310)
#define SYSTEM_DIAGNOSTICS_TRACING_EVENTSOURCEOPTIONS_SET_OPCODE_OFFSET UNITYSDK_OFFSET(0x39DB370)
