...
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_DISABLEFILTER_OFFSET UNITYSDK_OFFSET(0x1A0C0D30)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A0C10A0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_ENABLEFILTER_OFFSET UNITYSDK_OFFSET(0x1A0C1740)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_ENSUREACTIVITYCLEANUPDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A0C1140)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_FLOWACTIVITYIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1A0C1F50)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_GETACTIVEACTIVITIES_OFFSET UNITYSDK_OFFSET(0x1A0C1F20)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_GETACTIVITYDYINGDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A0C27A0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_GETFILTERASTUPLE_OFFSET UNITYSDK_OFFSET(0x1A0C2430)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_PASSESACTIVITYFILTER_OFFSET UNITYSDK_OFFSET(0x1A0C1810)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_TRIMACTIVEACTIVITYSTORE_OFFSET UNITYSDK_OFFSET(0x1A0C20E0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_UPDATEFILTER_OFFSET UNITYSDK_OFFSET(0x1A0C12A0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER_UPDATEKWDTRIGGERS_OFFSET UNITYSDK_OFFSET(0x1A0C22A0)
#define SYSTEM_DIAGNOSTICS_TRACING_ACTIVITYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C25C0)
...
namespace System::Diagnostics::Tracing
{
	...
	public:
		...
		::System::Int32 m_perEventSourceSessionId; // 0x44
		::System::Int32 m_curSampleCount; // 0x48
		::System::Int32 m_eventId; // 0x4C
