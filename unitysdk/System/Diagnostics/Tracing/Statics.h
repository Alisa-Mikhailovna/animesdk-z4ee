...
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_CHECKNAME_OFFSET UNITYSDK_OFFSET(0x1A0E46E0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_COMBINE_1_OFFSET UNITYSDK_OFFSET(0x1A0EC0B0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_COMBINE_OFFSET UNITYSDK_OFFSET(0x1A0EC0A0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_CREATEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A0EC990)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A0EC120)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_ENCODETAGS_OFFSET UNITYSDK_OFFSET(0x1A0E4A70)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_FINDENUMERABLEELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A0EC4E0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_FORMAT16_OFFSET UNITYSDK_OFFSET(0x1A0C53E0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_FORMAT32_OFFSET UNITYSDK_OFFSET(0x1A0E54E0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_FORMAT64_OFFSET UNITYSDK_OFFSET(0x1A0C6BB0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_FORMAT8_OFFSET UNITYSDK_OFFSET(0x1A0C43B0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_FORMATPTR_OFFSET UNITYSDK_OFFSET(0x1A0E5EC0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_GETDECLAREDSTATICMETHOD_OFFSET UNITYSDK_OFFSET(0x1A0EC390)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_GETGENERICARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A0EC450)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_GETGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A0EC300)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A0EC270)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_GETTYPEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A0EC9B0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_HASCUSTOMATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A0EC3B0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_ISENUM_OFFSET UNITYSDK_OFFSET(0x1A0EC1E0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_ISGENERICMATCH_OFFSET UNITYSDK_OFFSET(0x1A0EC830)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_ISVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A0EC150)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_MAKEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1A0C4D20)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_METADATAFORSTRING_OFFSET UNITYSDK_OFFSET(0x1A0D0170)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS_SHOULDOVERRIDEFIELDNAME_OFFSET UNITYSDK_OFFSET(0x1A0EC0C0)
#define SYSTEM_DIAGNOSTICS_TRACING_STATICS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0ECE20)
...
namespace System::Diagnostics::Tracing
{
	...
	public:
		...
		{
			return (::System::Diagnostics::Tracing::TraceLoggingDataType*)Il2CppClass::FromTypeDefinitionIndex(Statics_TypeDefinitionIndex)->GetStaticField(0x3500);
		}
		static ::System::Diagnostics::Tracing::TraceLoggingDataType* StaticGet_IntPtrType()
		{
			return (::System::Diagnostics::Tracing::TraceLoggingDataType*)Il2CppClass::FromTypeDefinitionIndex(Statics_TypeDefinitionIndex)->GetStaticField(0x3504);
		}
		static ::System::Diagnostics::Tracing::TraceLoggingDataType* StaticGet_HexIntPtrType()
		{
			return (::System::Diagnostics::Tracing::TraceLoggingDataType*)Il2CppClass::FromTypeDefinitionIndex(Statics_TypeDefinitionIndex)->GetStaticField(0x3508);
		}
