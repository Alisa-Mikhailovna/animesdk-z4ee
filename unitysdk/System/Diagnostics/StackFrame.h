...
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETFILELINENUMBER_OFFSET UNITYSDK_OFFSET(0x1A0BEBA0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETFILENAME_OFFSET UNITYSDK_OFFSET(0x1A0BEBB0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETILOFFSET_OFFSET UNITYSDK_OFFSET(0x1A0BECC0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETINTERNALMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1A0BED10)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETMETHODADDRESS_OFFSET UNITYSDK_OFFSET(0x1A0BECF0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETMETHODINDEX_OFFSET UNITYSDK_OFFSET(0x1A0BED00)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A0BECD0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETNATIVEOFFSET_OFFSET UNITYSDK_OFFSET(0x1A0BECE0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETSECUREFILENAME_OFFSET UNITYSDK_OFFSET(0x1A0BEBC0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GET_FRAME_INFO_OFFSET UNITYSDK_OFFSET(0x1A0BE900)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0BED20)
#define SYSTEM_DIAGNOSTICS_STACKFRAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0BEAD0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0BE9F0)
