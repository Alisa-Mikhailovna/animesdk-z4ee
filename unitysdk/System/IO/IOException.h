...
#define SYSTEM_IO_IOEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A144500)
#define SYSTEM_IO_IOEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A14C3B0)
#define SYSTEM_IO_IOEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A14C420)
#define SYSTEM_IO_IOEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A14C4A0)
#define SYSTEM_IO_IOEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A144E50)
#define SYSTEM_IO_IOEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A14B0F0)
