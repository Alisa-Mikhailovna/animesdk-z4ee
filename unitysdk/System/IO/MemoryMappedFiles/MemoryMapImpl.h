...
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_CLOSEMAPPING_OFFSET UNITYSDK_OFFSET(0x1CA15B90)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_CREATEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1CA23350)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_FLUSH_OFFSET UNITYSDK_OFFSET(0x1CA15C80)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_MAPINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CA231D0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_MAP_OFFSET UNITYSDK_OFFSET(0x1CA23280)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_OPENFILEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CA231C0)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_OPENFILE_OFFSET UNITYSDK_OFFSET(0x1CA23780)
#define SYSTEM_IO_MEMORYMAPPEDFILES_MEMORYMAPIMPL_UNMAP_OFFSET UNITYSDK_OFFSET(0x1CA15D20)
