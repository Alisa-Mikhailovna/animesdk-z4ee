...
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1592B0)
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER_GET_BASESTREAM_OFFSET UNITYSDK_OFFSET(0x1A159270)
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER_GET_CURRENTENCODING_OFFSET UNITYSDK_OFFSET(0x1A1592A0)
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER_PEEK_OFFSET UNITYSDK_OFFSET(0x1A1592C0)
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER_READBUFFER_OFFSET UNITYSDK_OFFSET(0x1A159310)
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER_READLINE_OFFSET UNITYSDK_OFFSET(0x1A1592F0)
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER_READTOEND_OFFSET UNITYSDK_OFFSET(0x1A159300)
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER_READ_1_OFFSET UNITYSDK_OFFSET(0x1A1592E0)
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER_READ_OFFSET UNITYSDK_OFFSET(0x1A1592D0)
#define SYSTEM_IO_STREAMREADER_NULLSTREAMREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1591E0)
