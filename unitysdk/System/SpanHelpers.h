...
#define SYSTEM_SPANHELPERS_CLEARLESSTHANPOINTERSIZED_1_OFFSET UNITYSDK_OFFSET(0x1CAD5D60)
#define SYSTEM_SPANHELPERS_CLEARLESSTHANPOINTERSIZED_OFFSET UNITYSDK_OFFSET(0x1CAD5CD0)
#define SYSTEM_SPANHELPERS_CLEARPOINTERSIZEDWITHOUTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1CAD5DF0)
#define SYSTEM_SPANHELPERS_CLEARPOINTERSIZEDWITHREFERENCES_OFFSET UNITYSDK_OFFSET(0x1CAD5FC0)
#define SYSTEM_SPANHELPERS_GETVECTOR_OFFSET UNITYSDK_OFFSET(0x1CAD5090)
#define SYSTEM_SPANHELPERS_INDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1CAD4B50)
#define SYSTEM_SPANHELPERS_INDEXOF_2_OFFSET UNITYSDK_OFFSET(0x1CAD5230)
#define SYSTEM_SPANHELPERS_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1CAD4AB0)
#define SYSTEM_SPANHELPERS_ISREFERENCEORCONTAINSREFERENCESCORE_OFFSET UNITYSDK_OFFSET(0x1CAD5420)
#define SYSTEM_SPANHELPERS_LESSTHANEQUAL_OFFSET UNITYSDK_OFFSET(0x1CAD60E0)
#define SYSTEM_SPANHELPERS_LOCATEFIRSTFOUNDBYTE_1_OFFSET UNITYSDK_OFFSET(0x1CAD5070)
#define SYSTEM_SPANHELPERS_LOCATEFIRSTFOUNDBYTE_OFFSET UNITYSDK_OFFSET(0x1CAD4DB0)
#define SYSTEM_SPANHELPERS_LOCATEFIRSTFOUNDCHAR_1_OFFSET UNITYSDK_OFFSET(0x1CAD5400)
#define SYSTEM_SPANHELPERS_LOCATEFIRSTFOUNDCHAR_OFFSET UNITYSDK_OFFSET(0x1CAD52C0)
#define SYSTEM_SPANHELPERS_SEQUENCECOMPARETO_1_OFFSET UNITYSDK_OFFSET(0x1CAD5120)
#define SYSTEM_SPANHELPERS_SEQUENCECOMPARETO_OFFSET UNITYSDK_OFFSET(0x1CAD4F30)
#define SYSTEM_SPANHELPERS_SEQUENCEEQUAL_OFFSET UNITYSDK_OFFSET(0x1CAD4C70)
