...
#define SYSTEM_MISSINGMEMBEREXCEPTION_FORMATSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1A168E30)
#define SYSTEM_MISSINGMEMBEREXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A168FA0)
#define SYSTEM_MISSINGMEMBEREXCEPTION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1A168CD0)
#define SYSTEM_MISSINGMEMBEREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A168950)
#define SYSTEM_MISSINGMEMBEREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A168A50)
#define SYSTEM_MISSINGMEMBEREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A168F00)
