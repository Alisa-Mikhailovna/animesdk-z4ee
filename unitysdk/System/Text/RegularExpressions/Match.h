...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_ADDMATCH_OFFSET UNITYSDK_OFFSET(0x1CD44910)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_BALANCEMATCH_OFFSET UNITYSDK_OFFSET(0x1CD44B80)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1CD43AF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_GET_GROUPS_OFFSET UNITYSDK_OFFSET(0x1CD43CC0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_GROUPTOSTRINGIMPL_OFFSET UNITYSDK_OFFSET(0x1CD447D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_ISMATCHED_OFFSET UNITYSDK_OFFSET(0x1CD44D80)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_LASTGROUPTOSTRINGIMPL_OFFSET UNITYSDK_OFFSET(0x1CD44870)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_MATCHINDEX_OFFSET UNITYSDK_OFFSET(0x1CD44DF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_MATCHLENGTH_OFFSET UNITYSDK_OFFSET(0x1CD44E70)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_NEXTMATCH_OFFSET UNITYSDK_OFFSET(0x1CD43D00)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_REMOVEMATCH_OFFSET UNITYSDK_OFFSET(0x1CD44D50)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_RESET_OFFSET UNITYSDK_OFFSET(0x1CD43C60)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_RESULT_OFFSET UNITYSDK_OFFSET(0x1CD44110)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH_TIDY_OFFSET UNITYSDK_OFFSET(0x1CD44EF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CD450B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CD45110)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD43B20)
...
namespace System::Text::RegularExpressions
{
	...
	public:
		...
		{
			return (::System::Text::RegularExpressions::Match**)Il2CppClass::FromTypeDefinitionIndex(Match_TypeDefinitionIndex)->GetStaticField(0x2F980);
		}
