...
#define SYSTEM_TEXT_DECODERNLS_CLEARMUSTFLUSH_OFFSET UNITYSDK_OFFSET(0x1A004670)
#define SYSTEM_TEXT_DECODERNLS_CONVERT_1_OFFSET UNITYSDK_OFFSET(0x1A004340)
#define SYSTEM_TEXT_DECODERNLS_CONVERT_OFFSET UNITYSDK_OFFSET(0x1A004080)
#define SYSTEM_TEXT_DECODERNLS_GETCHARCOUNT_1_OFFSET UNITYSDK_OFFSET(0x1A0039C0)
#define SYSTEM_TEXT_DECODERNLS_GETCHARCOUNT_2_OFFSET UNITYSDK_OFFSET(0x1A003B30)
#define SYSTEM_TEXT_DECODERNLS_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x1A0039A0)
#define SYSTEM_TEXT_DECODERNLS_GETCHARS_1_OFFSET UNITYSDK_OFFSET(0x1A003CC0)
#define SYSTEM_TEXT_DECODERNLS_GETCHARS_2_OFFSET UNITYSDK_OFFSET(0x1A003EF0)
#define SYSTEM_TEXT_DECODERNLS_GETCHARS_OFFSET UNITYSDK_OFFSET(0x1A003C90)
#define SYSTEM_TEXT_DECODERNLS_GET_HASSTATE_OFFSET UNITYSDK_OFFSET(0x1A004660)
#define SYSTEM_TEXT_DECODERNLS_GET_MUSTFLUSH_OFFSET UNITYSDK_OFFSET(0x1A004650)
#define SYSTEM_TEXT_DECODERNLS_RESET_OFFSET UNITYSDK_OFFSET(0x1A003910)
#define SYSTEM_TEXT_DECODERNLS_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A003730)
#define SYSTEM_TEXT_DECODERNLS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0037E0)
#define SYSTEM_TEXT_DECODERNLS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A003880)
#define SYSTEM_TEXT_DECODERNLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0036B0)
