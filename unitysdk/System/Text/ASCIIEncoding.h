...
#define SYSTEM_TEXT_ASCIIENCODING_GETBYTECOUNT_1_OFFSET UNITYSDK_OFFSET(0x19FFF070)
#define SYSTEM_TEXT_ASCIIENCODING_GETBYTECOUNT_2_OFFSET UNITYSDK_OFFSET(0x19FFF0C0)
#define SYSTEM_TEXT_ASCIIENCODING_GETBYTECOUNT_3_OFFSET UNITYSDK_OFFSET(0x19FFEB10)
#define SYSTEM_TEXT_ASCIIENCODING_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x19FFE9C0)
#define SYSTEM_TEXT_ASCIIENCODING_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x19FFFB40)
#define SYSTEM_TEXT_ASCIIENCODING_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x19FFFD70)
#define SYSTEM_TEXT_ASCIIENCODING_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x19FFF350)
#define SYSTEM_TEXT_ASCIIENCODING_GETBYTES_OFFSET UNITYSDK_OFFSET(0x19FFF180)
#define SYSTEM_TEXT_ASCIIENCODING_GETCHARCOUNT_1_OFFSET UNITYSDK_OFFSET(0x1A000290)
#define SYSTEM_TEXT_ASCIIENCODING_GETCHARCOUNT_2_OFFSET UNITYSDK_OFFSET(0x19FFFFD0)
#define SYSTEM_TEXT_ASCIIENCODING_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x19FFFE80)
#define SYSTEM_TEXT_ASCIIENCODING_GETCHARS_1_OFFSET UNITYSDK_OFFSET(0x1A000A00)
#define SYSTEM_TEXT_ASCIIENCODING_GETCHARS_2_OFFSET UNITYSDK_OFFSET(0x1A000580)
#define SYSTEM_TEXT_ASCIIENCODING_GETCHARS_OFFSET UNITYSDK_OFFSET(0x1A000350)
#define SYSTEM_TEXT_ASCIIENCODING_GETDECODER_OFFSET UNITYSDK_OFFSET(0x1A001160)
#define SYSTEM_TEXT_ASCIIENCODING_GETENCODER_OFFSET UNITYSDK_OFFSET(0x1A001220)
#define SYSTEM_TEXT_ASCIIENCODING_GETMAXBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x1A000D90)
#define SYSTEM_TEXT_ASCIIENCODING_GETMAXCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x1A000F70)
#define SYSTEM_TEXT_ASCIIENCODING_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1A000B10)
#define SYSTEM_TEXT_ASCIIENCODING_GET_ISSINGLEBYTE_OFFSET UNITYSDK_OFFSET(0x1A001150)
#define SYSTEM_TEXT_ASCIIENCODING_SETDEFAULTFALLBACKS_OFFSET UNITYSDK_OFFSET(0x19FFE850)
#define SYSTEM_TEXT_ASCIIENCODING__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFE720)
