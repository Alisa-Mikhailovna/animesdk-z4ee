...
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_FALLBACK_1_OFFSET UNITYSDK_OFFSET(0x1A012800)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_FALLBACK_OFFSET UNITYSDK_OFFSET(0x1A0126E0)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_GETNEXTCHAR_OFFSET UNITYSDK_OFFSET(0x1A012A10)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_GET_INTERNALSYNCOBJECT_OFFSET UNITYSDK_OFFSET(0x1A012660)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_GET_REMAINING_OFFSET UNITYSDK_OFFSET(0x1A012A50)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_MOVEPREVIOUS_OFFSET UNITYSDK_OFFSET(0x1A012A30)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x1A012A60)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_TRYBESTFIT_OFFSET UNITYSDK_OFFSET(0x1A012720)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A012260)
...
namespace System::Text
{
	...
	public:
		...
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(InternalEncoderBestFitFallbackBuffer_TypeDefinitionIndex)->GetStaticField(0x1C420);
		}
