...
#define SYSTEM_ENUM_ENUMRESULT_GETENUMPARSEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x39DBC00)
#define SYSTEM_ENUM_ENUMRESULT_INIT_OFFSET UNITYSDK_OFFSET(0x39DBB40)
#define SYSTEM_ENUM_ENUMRESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x39DBB90)
#define SYSTEM_ENUM_ENUMRESULT_SETFAILURE_2_OFFSET UNITYSDK_OFFSET(0x39DBBC0)
#define SYSTEM_ENUM_ENUMRESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x39DBB80)
