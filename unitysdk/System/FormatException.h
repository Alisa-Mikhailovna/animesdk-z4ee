...
#define SYSTEM_FORMATEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0F52B0)
#define SYSTEM_FORMATEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0FB150)
#define SYSTEM_FORMATEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A0FB1C0)
#define SYSTEM_FORMATEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FB0B0)
