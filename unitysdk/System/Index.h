...
#define SYSTEM_INDEX_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x2CAD0)
#define SYSTEM_INDEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x39CB620)
#define SYSTEM_INDEX_FROMSTART_OFFSET UNITYSDK_OFFSET(0x19B510F0)
#define SYSTEM_INDEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define SYSTEM_INDEX_GETOFFSET_OFFSET UNITYSDK_OFFSET(0x39CB610)
#define SYSTEM_INDEX_GET_ISFROMEND_OFFSET UNITYSDK_OFFSET(0x39CB600)
#define SYSTEM_INDEX_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x39CB5F0)
#define SYSTEM_INDEX_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19B51210)
#define SYSTEM_INDEX_THROWVALUEARGUMENTOUTOFRANGE_NEEDNONNEGNUMEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19B51080)
#define SYSTEM_INDEX_TOSTRINGFROMEND_OFFSET UNITYSDK_OFFSET(0x39CB700)
#define SYSTEM_INDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39CB680)
#define SYSTEM_INDEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define SYSTEM_INDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x39CB580)
