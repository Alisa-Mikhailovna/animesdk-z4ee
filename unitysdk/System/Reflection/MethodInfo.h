...
#define SYSTEM_REFLECTION_METHODINFO_CREATEDELEGATE_1_OFFSET UNITYSDK_OFFSET(0x1A192830)
#define SYSTEM_REFLECTION_METHODINFO_CREATEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A1927D0)
#define SYSTEM_REFLECTION_METHODINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1925E0)
#define SYSTEM_REFLECTION_METHODINFO_GETBASEMETHOD_OFFSET UNITYSDK_OFFSET(0x1A192890)
#define SYSTEM_REFLECTION_METHODINFO_GETGENERICARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A1926B0)
#define SYSTEM_REFLECTION_METHODINFO_GETGENERICMETHODDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A192710)
#define SYSTEM_REFLECTION_METHODINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1925F0)
#define SYSTEM_REFLECTION_METHODINFO_GET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x1A192600)
#define SYSTEM_REFLECTION_METHODINFO_GET_RETURNPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A192660)
#define SYSTEM_REFLECTION_METHODINFO_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1A192610)
#define SYSTEM_REFLECTION_METHODINFO_MAKEGENERICMETHOD_OFFSET UNITYSDK_OFFSET(0x1A192770)
#define SYSTEM_REFLECTION_METHODINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A191360)
#define SYSTEM_REFLECTION_METHODINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A191590)
#define SYSTEM_REFLECTION_METHODINFO_SYSTEM_RUNTIME_INTEROPSERVICES__METHODINFO_GETIDSOFNAMES_OFFSET UNITYSDK_OFFSET(0x1A1928A0)
#define SYSTEM_REFLECTION_METHODINFO_SYSTEM_RUNTIME_INTEROPSERVICES__METHODINFO_GETTYPEINFOCOUNT_OFFSET UNITYSDK_OFFSET(0x1A192960)
#define SYSTEM_REFLECTION_METHODINFO_SYSTEM_RUNTIME_INTEROPSERVICES__METHODINFO_GETTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1A192920)
#define SYSTEM_REFLECTION_METHODINFO_SYSTEM_RUNTIME_INTEROPSERVICES__METHODINFO_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1A1928E0)
#define SYSTEM_REFLECTION_METHODINFO_SYSTEM_RUNTIME_INTEROPSERVICES__METHODINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1929A0)
#define SYSTEM_REFLECTION_METHODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1925D0)
