...
#define SYSTEM_REFLECTION_MEMBERFILTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A18FA20)
#define SYSTEM_REFLECTION_MEMBERFILTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A18FA60)
#define SYSTEM_REFLECTION_MEMBERFILTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A18FA10)
#define SYSTEM_REFLECTION_MEMBERFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A18F920)
