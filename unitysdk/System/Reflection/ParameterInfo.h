...
#define SYSTEM_REFLECTION_PARAMETERINFO_FORMATPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A1994E0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1A19A350)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A19A340)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETDEFAULTVALUEIMPL_OFFSET UNITYSDK_OFFSET(0x1A19A2E0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETPSEUDOCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A199C00)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETREALOBJECT_OFFSET UNITYSDK_OFFSET(0x1A19A360)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETREQUIREDCUSTOMMODIFIERS_OFFSET UNITYSDK_OFFSET(0x1A19A3C0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GETTYPEMODIFIERS_OFFSET UNITYSDK_OFFSET(0x1A197440)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A199A40)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1A19A2F0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ISIN_OFFSET UNITYSDK_OFFSET(0x1A199A50)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ISOPTIONAL_OFFSET UNITYSDK_OFFSET(0x1A199AD0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ISOUT_OFFSET UNITYSDK_OFFSET(0x1A199B50)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_ISRETVAL_OFFSET UNITYSDK_OFFSET(0x1A199460)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x1A199BD0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A199BE0)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_PARAMETERTYPE_OFFSET UNITYSDK_OFFSET(0x1A199A30)
#define SYSTEM_REFLECTION_PARAMETERINFO_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A199BF0)
#define SYSTEM_REFLECTION_PARAMETERINFO_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1A19A3B0)
#define SYSTEM_REFLECTION_PARAMETERINFO_NEW_1_OFFSET UNITYSDK_OFFSET(0x1A196D40)
#define SYSTEM_REFLECTION_PARAMETERINFO_NEW_OFFSET UNITYSDK_OFFSET(0x1A197FF0)
#define SYSTEM_REFLECTION_PARAMETERINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A198F50)
#define SYSTEM_REFLECTION_PARAMETERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A198F40)
