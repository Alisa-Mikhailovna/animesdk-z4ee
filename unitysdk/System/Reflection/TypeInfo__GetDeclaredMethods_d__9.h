...
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A19EA10)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_METHODINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A19EC20)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_METHODINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A19EBB0)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A19ECA0)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A19EC10)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A19EBC0)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A19EA00)
#define SYSTEM_REFLECTION_TYPEINFO__GETDECLAREDMETHODS_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1A19E7B0)
...
namespace System::Reflection
{
	...
	public:
		...
		::System::Reflection::TypeInfo* __4__this; // 0x20
