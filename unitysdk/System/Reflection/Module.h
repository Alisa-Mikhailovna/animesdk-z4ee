...
#define SYSTEM_REFLECTION_MODULE_CREATENIE_OFFSET UNITYSDK_OFFSET(0x1A192F70)
#define SYSTEM_REFLECTION_MODULE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A192EE0)
#define SYSTEM_REFLECTION_MODULE_FILTER_BY_TYPE_NAME_IGNORE_CASE_OFFSET UNITYSDK_OFFSET(0x1A192D50)
#define SYSTEM_REFLECTION_MODULE_FILTER_BY_TYPE_NAME_OFFSET UNITYSDK_OFFSET(0x1A192B50)
#define SYSTEM_REFLECTION_MODULE_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1A193110)
#define SYSTEM_REFLECTION_MODULE_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A1930D0)
#define SYSTEM_REFLECTION_MODULE_GETGUIDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A192B30)
#define SYSTEM_REFLECTION_MODULE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A192EF0)
#define SYSTEM_REFLECTION_MODULE_GETMODULEVERSIONID_OFFSET UNITYSDK_OFFSET(0x1A192AF0)
#define SYSTEM_REFLECTION_MODULE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A192A90)
#define SYSTEM_REFLECTION_MODULE_GET_ASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1A192F30)
#define SYSTEM_REFLECTION_MODULE_GET_MODULEVERSIONID_OFFSET UNITYSDK_OFFSET(0x1A193050)
#define SYSTEM_REFLECTION_MODULE_GET_SCOPENAME_OFFSET UNITYSDK_OFFSET(0x1A193010)
#define SYSTEM_REFLECTION_MODULE_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1A193150)
#define SYSTEM_REFLECTION_MODULE_ISRESOURCE_OFFSET UNITYSDK_OFFSET(0x1A193090)
#define SYSTEM_REFLECTION_MODULE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A192F00)
#define SYSTEM_REFLECTION_MODULE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A192AE0)
#define SYSTEM_REFLECTION_MODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A193190)
#define SYSTEM_REFLECTION_MODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A192A80)
...
namespace System::Reflection
{
	...
	public:
		...
		{
			return (::System::Reflection::TypeFilter**)Il2CppClass::FromTypeDefinitionIndex(Module_TypeDefinitionIndex)->GetStaticField(0xF3C0);
		}
		static ::System::Reflection::TypeFilter** StaticGet_FilterTypeNameIgnoreCase()
		{
			return (::System::Reflection::TypeFilter**)Il2CppClass::FromTypeDefinitionIndex(Module_TypeDefinitionIndex)->GetStaticField(0xF3C8);
		}
