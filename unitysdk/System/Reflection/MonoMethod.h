...
#define SYSTEM_REFLECTION_MONOMETHOD_CONVERTVALUES_OFFSET UNITYSDK_OFFSET(0x1A194060)
#define SYSTEM_REFLECTION_MONOMETHOD_GETBASEDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A1959B0)
#define SYSTEM_REFLECTION_MONOMETHOD_GETBASEMETHOD_OFFSET UNITYSDK_OFFSET(0x1A1959C0)
#define SYSTEM_REFLECTION_MONOMETHOD_GETCUSTOMATTRIBUTESDATA_OFFSET UNITYSDK_OFFSET(0x1A196900)
#define SYSTEM_REFLECTION_MONOMETHOD_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1A196300)
#define SYSTEM_REFLECTION_MONOMETHOD_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A1962F0)
#define SYSTEM_REFLECTION_MONOMETHOD_GETGENERICARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A1967C0)
#define SYSTEM_REFLECTION_MONOMETHOD_GETGENERICMETHODDEFINITION_IMPL_OFFSET UNITYSDK_OFFSET(0x1A1967E0)
#define SYSTEM_REFLECTION_MONOMETHOD_GETGENERICMETHODDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A196820)
#define SYSTEM_REFLECTION_MONOMETHOD_GETMETHODBODY_OFFSET UNITYSDK_OFFSET(0x1A1968F0)
#define SYSTEM_REFLECTION_MONOMETHOD_GETMETHODIMPLEMENTATIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1A195B70)
#define SYSTEM_REFLECTION_MONOMETHOD_GETPARAMETERSCOUNT_OFFSET UNITYSDK_OFFSET(0x1A195CC0)
#define SYSTEM_REFLECTION_MONOMETHOD_GETPARAMETERSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A195C80)
#define SYSTEM_REFLECTION_MONOMETHOD_GETPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A195BD0)
#define SYSTEM_REFLECTION_MONOMETHOD_GETPINVOKE_OFFSET UNITYSDK_OFFSET(0x1A196310)
#define SYSTEM_REFLECTION_MONOMETHOD_GETPSEUDOCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A196330)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A1961A0)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_BASE_METHOD_OFFSET UNITYSDK_OFFSET(0x1A1959A0)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_CALLINGCONVENTION_OFFSET UNITYSDK_OFFSET(0x1A1961B0)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_CONTAINSGENERICPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A195F90)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_CORE_CLR_SECURITY_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A196980)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A196220)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_ISGENERICMETHODDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A1967B0)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_ISGENERICMETHOD_OFFSET UNITYSDK_OFFSET(0x1A1968C0)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_ISSECURITYCRITICAL_OFFSET UNITYSDK_OFFSET(0x1A196990)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_METHODHANDLE_OFFSET UNITYSDK_OFFSET(0x1A196190)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_NAME_1_OFFSET UNITYSDK_OFFSET(0x1A196280)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A194740)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A196210)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_RETURNPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A1959D0)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_RETURNTYPECUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A195AD0)
#define SYSTEM_REFLECTION_MONOMETHOD_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1A195A70)
#define SYSTEM_REFLECTION_MONOMETHOD_INTERNALINVOKE_OFFSET UNITYSDK_OFFSET(0x1A195D10)
#define SYSTEM_REFLECTION_MONOMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A195D30)
#define SYSTEM_REFLECTION_MONOMETHOD_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1A1962E0)
#define SYSTEM_REFLECTION_MONOMETHOD_MAKEGENERICMETHOD_IMPL_OFFSET UNITYSDK_OFFSET(0x1A1967D0)
#define SYSTEM_REFLECTION_MONOMETHOD_MAKEGENERICMETHOD_OFFSET UNITYSDK_OFFSET(0x1A1964F0)
#define SYSTEM_REFLECTION_MONOMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A195990)
