...
#define SYSTEM_REFLECTION_MONOPROPERTYINFO_GETTYPEMODIFIERS_OFFSET UNITYSDK_OFFSET(0x1A198D40)
#define SYSTEM_REFLECTION_MONOPROPERTYINFO_GET_DEFAULT_VALUE_OFFSET UNITYSDK_OFFSET(0x1A198120)
#define SYSTEM_REFLECTION_MONOPROPERTYINFO_GET_PROPERTY_INFO_OFFSET UNITYSDK_OFFSET(0x1A197480)
