...
#define SYSTEM_REFLECTION_RUNTIMEREFLECTIONEXTENSIONS_CHECKANDTHROW_OFFSET UNITYSDK_OFFSET(0x1A19D8F0)
#define SYSTEM_REFLECTION_RUNTIMEREFLECTIONEXTENSIONS_GETRUNTIMEFIELDS_OFFSET UNITYSDK_OFFSET(0x1A19DAF0)
#define SYSTEM_REFLECTION_RUNTIMEREFLECTIONEXTENSIONS_GETRUNTIMEFIELD_OFFSET UNITYSDK_OFFSET(0x1A19DC00)
#define SYSTEM_REFLECTION_RUNTIMEREFLECTIONEXTENSIONS_GETRUNTIMEMETHODS_OFFSET UNITYSDK_OFFSET(0x1A19DA50)
#define SYSTEM_REFLECTION_RUNTIMEREFLECTIONEXTENSIONS_GETRUNTIMEMETHOD_OFFSET UNITYSDK_OFFSET(0x1A19DBC0)
#define SYSTEM_REFLECTION_RUNTIMEREFLECTIONEXTENSIONS_GETRUNTIMEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A19D9B0)
#define SYSTEM_REFLECTION_RUNTIMEREFLECTIONEXTENSIONS_GETRUNTIMEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A19DB90)
