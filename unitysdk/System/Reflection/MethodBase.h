...
#define SYSTEM_REFLECTION_METHODBASE_CONSTRUCTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A191CC0)
#define SYSTEM_REFLECTION_METHODBASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1915A0)
#define SYSTEM_REFLECTION_METHODBASE_FORMATNAMEANDSIG_OFFSET UNITYSDK_OFFSET(0x1A191FB0)
#define SYSTEM_REFLECTION_METHODBASE_GETGENERICARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A191640)
#define SYSTEM_REFLECTION_METHODBASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A185380)
#define SYSTEM_REFLECTION_METHODBASE_GETMETHODBODYINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A192590)
#define SYSTEM_REFLECTION_METHODBASE_GETMETHODBODY_1_OFFSET UNITYSDK_OFFSET(0x1A1925A0)
#define SYSTEM_REFLECTION_METHODBASE_GETMETHODBODY_OFFSET UNITYSDK_OFFSET(0x1A191C70)
#define SYSTEM_REFLECTION_METHODBASE_GETMETHODFROMHANDLEINTERNALTYPE_NATIVE_OFFSET UNITYSDK_OFFSET(0x1A192550)
#define SYSTEM_REFLECTION_METHODBASE_GETMETHODFROMHANDLEINTERNALTYPE_OFFSET UNITYSDK_OFFSET(0x1A191580)
#define SYSTEM_REFLECTION_METHODBASE_GETMETHODFROMHANDLENOGENERICCHECK_1_OFFSET UNITYSDK_OFFSET(0x1A192560)
#define SYSTEM_REFLECTION_METHODBASE_GETMETHODFROMHANDLENOGENERICCHECK_OFFSET UNITYSDK_OFFSET(0x1A192540)
#define SYSTEM_REFLECTION_METHODBASE_GETMETHODFROMHANDLE_OFFSET UNITYSDK_OFFSET(0x1A191370)
#define SYSTEM_REFLECTION_METHODBASE_GETPARAMETERSCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1924B0)
#define SYSTEM_REFLECTION_METHODBASE_GETPARAMETERSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A192430)
#define SYSTEM_REFLECTION_METHODBASE_GETPARAMETERSNOCOPY_OFFSET UNITYSDK_OFFSET(0x1A1915B0)
#define SYSTEM_REFLECTION_METHODBASE_GETPARAMETERTYPES_OFFSET UNITYSDK_OFFSET(0x1A1921C0)
#define SYSTEM_REFLECTION_METHODBASE_GET_CALLINGCONVENTION_OFFSET UNITYSDK_OFFSET(0x1A191630)
#define SYSTEM_REFLECTION_METHODBASE_GET_CONTAINSGENERICPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A1916B0)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x1A191A40)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A191B40)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISFINAL_OFFSET UNITYSDK_OFFSET(0x1A191940)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISGENERICMETHODDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A1916A0)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISGENERICMETHOD_OFFSET UNITYSDK_OFFSET(0x1A1916C0)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISPRIVATE_OFFSET UNITYSDK_OFFSET(0x1A191840)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x1A1917C0)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISSECURITYCRITICAL_OFFSET UNITYSDK_OFFSET(0x1A1916D0)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISSPECIALNAME_OFFSET UNITYSDK_OFFSET(0x1A191AC0)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1A1918C0)
#define SYSTEM_REFLECTION_METHODBASE_GET_ISVIRTUAL_OFFSET UNITYSDK_OFFSET(0x1A1919C0)
#define SYSTEM_REFLECTION_METHODBASE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A191720)
#define SYSTEM_REFLECTION_METHODBASE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A18FBF0)
#define SYSTEM_REFLECTION_METHODBASE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A18FBE0)
#define SYSTEM_REFLECTION_METHODBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A185270)
