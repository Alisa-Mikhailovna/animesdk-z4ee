...
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO_GET_LOCALINDEX_OFFSET UNITYSDK_OFFSET(0x1A18F820)
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO_GET_LOCALTYPE_OFFSET UNITYSDK_OFFSET(0x1A18F830)
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A18F840)
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A18F810)
