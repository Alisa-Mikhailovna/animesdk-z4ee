...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEBUGINFO_DEBUGINFOCOMPARER_SYSTEM_COLLECTIONS_GENERIC_ICOMPARER_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEBUGINFO__COMPARE_OFFSET UNITYSDK_OFFSET(0x1CA6D760)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEBUGINFO_DEBUGINFOCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA6D750)
