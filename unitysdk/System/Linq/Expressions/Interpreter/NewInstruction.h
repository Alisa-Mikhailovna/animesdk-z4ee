...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWINSTRUCTION_GETARGS_OFFSET UNITYSDK_OFFSET(0x1CAAB8C0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWINSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1CAAB6D0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1CAAB6F0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1CAAB6E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1CAAB730)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWINSTRUCTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1CAAB9E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NEWINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAAB6C0)
