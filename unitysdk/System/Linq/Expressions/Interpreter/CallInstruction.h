...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_ARRAYITEMSETTER1_OFFSET UNITYSDK_OFFSET(0x1CA6B0C0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_ARRAYITEMSETTER2_OFFSET UNITYSDK_OFFSET(0x1CA6B0E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_ARRAYITEMSETTER3_OFFSET UNITYSDK_OFFSET(0x1CA6B150)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1CA6A600)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1CA6A590)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_GETARRAYACCESSOR_OFFSET UNITYSDK_OFFSET(0x1CA6A9C0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1CA6B1D0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1CA6A550)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_INTERPRETLAMBDAINVOKE_OFFSET UNITYSDK_OFFSET(0x1CA6A110)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION_TRYGETLIGHTLAMBDATARGET_OFFSET UNITYSDK_OFFSET(0x1CA6A050)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_CALLINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA6B900)
