...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_COALESCINGBRANCHINSTRUCTION_GET_CACHE_OFFSET UNITYSDK_OFFSET(0x1CA6CC50)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_COALESCINGBRANCHINSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1CA6CD00)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_COALESCINGBRANCHINSTRUCTION_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1CA6CCC0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_COALESCINGBRANCHINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1CA6CD10)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_COALESCINGBRANCHINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1CA6CD20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_COALESCINGBRANCHINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA6CDA0)
...
namespace System::Linq::Expressions::Interpreter
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Linq::Expressions::Interpreter::Instruction*>**)Il2CppClass::FromTypeDefinitionIndex(CoalescingBranchInstruction_TypeDefinitionIndex)->GetStaticField(0x32B60);
		}
