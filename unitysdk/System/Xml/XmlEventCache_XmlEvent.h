...
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_GET_OBJECT_OFFSET UNITYSDK_OFFSET(0x112B0)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_GET_STRING1_OFFSET UNITYSDK_OFFSET(0x6010)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_GET_STRING2_OFFSET UNITYSDK_OFFSET(0x14430)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_GET_STRING3_OFFSET UNITYSDK_OFFSET(0x2B150)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_INITEVENT_1_OFFSET UNITYSDK_OFFSET(0x30100)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_INITEVENT_2_OFFSET UNITYSDK_OFFSET(0x39E5660)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_INITEVENT_3_OFFSET UNITYSDK_OFFSET(0x3A137E0)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_INITEVENT_4_OFFSET UNITYSDK_OFFSET(0x3A13800)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_INITEVENT_5_OFFSET UNITYSDK_OFFSET(0x3A13820)
#define SYSTEM_XML_XMLEVENTCACHE_XMLEVENT_INITEVENT_OFFSET UNITYSDK_OFFSET(0x2CAC0)
