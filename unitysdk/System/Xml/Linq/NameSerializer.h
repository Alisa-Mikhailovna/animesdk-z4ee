...
#define SYSTEM_XML_LINQ_NAMESERIALIZER_SYSTEM_RUNTIME_SERIALIZATION_IOBJECTREFERENCE_GETREALOBJECT_OFFSET UNITYSDK_OFFSET(0x1CB0FA30)
#define SYSTEM_XML_LINQ_NAMESERIALIZER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1CB0FC90)
#define SYSTEM_XML_LINQ_NAMESERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB0F9B0)
