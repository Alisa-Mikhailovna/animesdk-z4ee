...
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_CLONENODE_OFFSET UNITYSDK_OFFSET(0x1CB1D690)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1CB1D570)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1CB1D580)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1CB1D590)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_VALIDATENAME_OFFSET UNITYSDK_OFFSET(0x1CB1D3C0)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION_WRITETO_OFFSET UNITYSDK_OFFSET(0x1CB1D5A0)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CB1D500)
#define SYSTEM_XML_LINQ_XPROCESSINGINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB156B0)
