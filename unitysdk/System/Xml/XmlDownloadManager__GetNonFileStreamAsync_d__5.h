...
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A137B0)
#define SYSTEM_XML_XMLDOWNLOADMANAGER__GETNONFILESTREAMASYNC_D__5_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x14A960)
...
namespace System::Xml
{
	...
	struct alignas(8) XmlDownloadManager__GetNonFileStreamAsync_d__5
	{
		...
		::System::Net::WebRequest* _req_5__1; // 0x58
