...
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_CLEAR_OFFSET UNITYSDK_OFFSET(0x3A13C10)
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_CLOSE_OFFSET UNITYSDK_OFFSET(0x3A13C70)
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_GET_LINENO_OFFSET UNITYSDK_OFFSET(0x3BEF0)
#define SYSTEM_XML_XMLTEXTREADERIMPL_PARSINGSTATE_GET_LINEPOS_OFFSET UNITYSDK_OFFSET(0x3A13C80)
