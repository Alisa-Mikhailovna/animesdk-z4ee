...
#define SYSTEM_XML_XMLCHILDENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CBD9550)
#define SYSTEM_XML_XMLCHILDENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CBD9330)
#define SYSTEM_XML_XMLCHILDENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CBD94E0)
#define SYSTEM_XML_XMLCHILDENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CBD9320)
#define SYSTEM_XML_XMLCHILDENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CBD9450)
#define SYSTEM_XML_XMLCHILDENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBD9280)
