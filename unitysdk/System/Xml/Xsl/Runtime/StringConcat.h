...
#define SYSTEM_XML_XSL_RUNTIME_STRINGCONCAT_CLEAR_OFFSET UNITYSDK_OFFSET(0x3A14480)
#define SYSTEM_XML_XSL_RUNTIME_STRINGCONCAT_CONCATNODELIMITER_OFFSET UNITYSDK_OFFSET(0x3A144A0)
#define SYSTEM_XML_XSL_RUNTIME_STRINGCONCAT_GETRESULT_OFFSET UNITYSDK_OFFSET(0x3A14490)
#define SYSTEM_XML_XSL_RUNTIME_STRINGCONCAT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x2E27A30)
