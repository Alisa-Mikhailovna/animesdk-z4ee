...
#define SYSTEM_XML_XPATH_XPATHNAVIGATORKEYCOMPARER_SYSTEM_COLLECTIONS_IEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CBD1680)
#define SYSTEM_XML_XPATH_XPATHNAVIGATORKEYCOMPARER_SYSTEM_COLLECTIONS_IEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CBD17A0)
#define SYSTEM_XML_XPATH_XPATHNAVIGATORKEYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBD1670)
