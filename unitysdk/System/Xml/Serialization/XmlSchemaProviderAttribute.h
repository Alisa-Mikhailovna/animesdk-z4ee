...
#define SYSTEM_XML_SERIALIZATION_XMLSCHEMAPROVIDERATTRIBUTE_GET_ISANY_OFFSET UNITYSDK_OFFSET(0x1CBA0A90)
#define SYSTEM_XML_SERIALIZATION_XMLSCHEMAPROVIDERATTRIBUTE_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1CBA0A80)
#define SYSTEM_XML_SERIALIZATION_XMLSCHEMAPROVIDERATTRIBUTE_SET_ISANY_OFFSET UNITYSDK_OFFSET(0x1CBA0AA0)
#define SYSTEM_XML_SERIALIZATION_XMLSCHEMAPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBA0A70)
