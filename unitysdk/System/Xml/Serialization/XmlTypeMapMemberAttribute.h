...
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERATTRIBUTE_GET_ATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1CBC8580)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERATTRIBUTE_GET_MAPPEDTYPE_OFFSET UNITYSDK_OFFSET(0x1CBC85D0)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERATTRIBUTE_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x1CBC85A0)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERATTRIBUTE_SET_ATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1CBC8590)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERATTRIBUTE_SET_FORM_OFFSET UNITYSDK_OFFSET(0x1CBC85C0)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERATTRIBUTE_SET_MAPPEDTYPE_OFFSET UNITYSDK_OFFSET(0x1CBC85E0)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERATTRIBUTE_SET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x1CBC85B0)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB9E000)
