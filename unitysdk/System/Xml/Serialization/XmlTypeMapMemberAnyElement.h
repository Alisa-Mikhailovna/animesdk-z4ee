...
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERANYELEMENT_GET_ISDEFAULTANY_OFFSET UNITYSDK_OFFSET(0x1CBC7F70)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERANYELEMENT_ISELEMENTDEFINED_OFFSET UNITYSDK_OFFSET(0x1CBC4950)
#define SYSTEM_XML_SERIALIZATION_XMLTYPEMAPMEMBERANYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB9D6F0)
