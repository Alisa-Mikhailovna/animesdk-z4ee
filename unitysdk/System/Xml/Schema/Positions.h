...
#define SYSTEM_XML_SCHEMA_POSITIONS_ADD_OFFSET UNITYSDK_OFFSET(0x1CB4E4E0)
#define SYSTEM_XML_SCHEMA_POSITIONS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1CB50920)
#define SYSTEM_XML_SCHEMA_POSITIONS_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1CB52A20)
#define SYSTEM_XML_SCHEMA_POSITIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB50340)
