...
#define SYSTEM_XML_SCHEMA_XSDDURATION_GET_HOURS_OFFSET UNITYSDK_OFFSET(0x14EDE0)
#define SYSTEM_XML_SCHEMA_XSDDURATION_GET_ISNEGATIVE_OFFSET UNITYSDK_OFFSET(0x39F0AB0)
#define SYSTEM_XML_SCHEMA_XSDDURATION_GET_MINUTES_OFFSET UNITYSDK_OFFSET(0x6E20)
#define SYSTEM_XML_SCHEMA_XSDDURATION_GET_MONTHS_OFFSET UNITYSDK_OFFSET(0x1E130)
#define SYSTEM_XML_SCHEMA_XSDDURATION_GET_NANOSECONDS_OFFSET UNITYSDK_OFFSET(0x3A13050)
#define SYSTEM_XML_SCHEMA_XSDDURATION_GET_SECONDS_OFFSET UNITYSDK_OFFSET(0x6E30)
#define SYSTEM_XML_SCHEMA_XSDDURATION_GET_YEARS_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define SYSTEM_XML_SCHEMA_XSDDURATION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x3A13100)
#define SYSTEM_XML_SCHEMA_XSDDURATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3A130F0)
#define SYSTEM_XML_SCHEMA_XSDDURATION_TOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x3A13060)
#define SYSTEM_XML_SCHEMA_XSDDURATION_TRYPARSEDIGITS_OFFSET UNITYSDK_OFFSET(0x1CB80130)
#define SYSTEM_XML_SCHEMA_XSDDURATION_TRYPARSE_1_OFFSET UNITYSDK_OFFSET(0x1CB7F310)
#define SYSTEM_XML_SCHEMA_XSDDURATION_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1CB80120)
#define SYSTEM_XML_SCHEMA_XSDDURATION_TRYTOTIMESPAN_1_OFFSET UNITYSDK_OFFSET(0x3A130E0)
#define SYSTEM_XML_SCHEMA_XSDDURATION_TRYTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x3A130D0)
#define SYSTEM_XML_SCHEMA_XSDDURATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A12D50)
#define SYSTEM_XML_SCHEMA_XSDDURATION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x3A12E30)
#define SYSTEM_XML_SCHEMA_XSDDURATION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x3A12FD0)
#define SYSTEM_XML_SCHEMA_XSDDURATION__CTOR_OFFSET UNITYSDK_OFFSET(0x3A12D40)
