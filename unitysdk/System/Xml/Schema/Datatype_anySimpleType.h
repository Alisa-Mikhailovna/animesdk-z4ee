...
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1CB427C0)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1CB42610)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x1CB427B0)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x1CB42670)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1CB42740)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE_GET_TOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1CB427A0)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1CB42730)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1CB426D0)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1CB42900)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CB42920)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYSIMPLETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB3B470)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_anySimpleType_TypeDefinitionIndex)->GetStaticField(0x22A50);
		}
		static ::System::Type** StaticGet_atomicValueType()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(Datatype_anySimpleType_TypeDefinitionIndex)->GetStaticField(0x22A58);
		}
