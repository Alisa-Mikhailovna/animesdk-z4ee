...
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPEWILDCARDDESTINATION_OFFSET UNITYSDK_OFFSET(0x1CB5A430)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPEWILDCARDSOURCE_OFFSET UNITYSDK_OFFSET(0x1CB5BD00)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPE_1_OFFSET UNITYSDK_OFFSET(0x1CB5BDF0)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPE_2_OFFSET UNITYSDK_OFFSET(0x1CB5C0B0)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPE_3_OFFSET UNITYSDK_OFFSET(0x1CB5C360)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPE_4_OFFSET UNITYSDK_OFFSET(0x1CB5C640)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPE_5_OFFSET UNITYSDK_OFFSET(0x1CB5C900)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPE_6_OFFSET UNITYSDK_OFFSET(0x1CB5CBC0)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPE_7_OFFSET UNITYSDK_OFFSET(0x1CB5CED0)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x1CB5B960)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1CB5A0A0)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_TODATETIMEOFFSET_OFFSET UNITYSDK_OFFSET(0x1CB5A8A0)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1CB5A500)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x1CB5AA60)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x1CB5AC20)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_TOINT32_OFFSET UNITYSDK_OFFSET(0x1CB5AFB0)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_TOINT64_OFFSET UNITYSDK_OFFSET(0x1CB5B3B0)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_TONAVIGATOR_OFFSET UNITYSDK_OFFSET(0x1CB5DC00)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER_TOSINGLE_OFFSET UNITYSDK_OFFSET(0x1CB5B7B0)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CB5E460)
#define SYSTEM_XML_SCHEMA_XMLANYCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB5A020)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		{
			return (::System::Xml::Schema::XmlValueConverter**)Il2CppClass::FromTypeDefinitionIndex(XmlAnyConverter_TypeDefinitionIndex)->GetStaticField(0x22A30);
		}
		static ::System::Xml::Schema::XmlValueConverter** StaticGet_AnyAtomic()
		{
			return (::System::Xml::Schema::XmlValueConverter**)Il2CppClass::FromTypeDefinitionIndex(XmlAnyConverter_TypeDefinitionIndex)->GetStaticField(0x22A38);
		}
