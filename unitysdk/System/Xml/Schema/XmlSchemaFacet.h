...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAFACET_SET_FACETTYPE_OFFSET UNITYSDK_OFFSET(0x1CB75E90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAFACET_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CB75E80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAFACET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB75EA0)
