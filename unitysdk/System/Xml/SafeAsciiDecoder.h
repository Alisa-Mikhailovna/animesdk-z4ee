...
#define SYSTEM_XML_SAFEASCIIDECODER_CONVERT_OFFSET UNITYSDK_OFFSET(0x1CB34CA0)
#define SYSTEM_XML_SAFEASCIIDECODER_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x1CB34C10)
#define SYSTEM_XML_SAFEASCIIDECODER_GETCHARS_OFFSET UNITYSDK_OFFSET(0x1CB34C20)
#define SYSTEM_XML_SAFEASCIIDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB34C00)
