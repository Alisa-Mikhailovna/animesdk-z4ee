...
#define SYSTEM_XML_UCS4ENCODING2143_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x1CBCB550)
#define SYSTEM_XML_UCS4ENCODING2143_GET_ENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x1CBCB510)
#define SYSTEM_XML_UCS4ENCODING2143__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBCB0C0)
