...
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_ADD_OFFSET UNITYSDK_OFFSET(0x3A13B00)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x3A13B30)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x3A13A30)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3A13AF0)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_INSERT_OFFSET UNITYSDK_OFFSET(0x3A13B20)
#define SYSTEM_XML_XMLNAMEDNODEMAP_SMALLXMLNODELIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x3A13B10)
