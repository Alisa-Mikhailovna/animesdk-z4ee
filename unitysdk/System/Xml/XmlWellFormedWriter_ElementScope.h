...
#define SYSTEM_XML_XMLWELLFORMEDWRITER_ELEMENTSCOPE_SET_OFFSET UNITYSDK_OFFSET(0x3A142A0)
#define SYSTEM_XML_XMLWELLFORMEDWRITER_ELEMENTSCOPE_WRITEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x3A142D0)
#define SYSTEM_XML_XMLWELLFORMEDWRITER_ELEMENTSCOPE_WRITEFULLENDELEMENT_OFFSET UNITYSDK_OFFSET(0x3A14380)
