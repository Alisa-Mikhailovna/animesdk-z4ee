...
#define SYSTEM_XML_XMLWELLFORMEDWRITER_NAMESPACERESOLVERPROXY_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1CC443E0)
#define SYSTEM_XML_XMLWELLFORMEDWRITER_NAMESPACERESOLVERPROXY_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1CC44400)
#define SYSTEM_XML_XMLWELLFORMEDWRITER_NAMESPACERESOLVERPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC3A1E0)
