...
#define SYSTEM_XML_UCS4ENCODING3412_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x1CBCB5D0)
#define SYSTEM_XML_UCS4ENCODING3412_GET_ENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x1CBCB590)
#define SYSTEM_XML_UCS4ENCODING3412__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBCB290)
