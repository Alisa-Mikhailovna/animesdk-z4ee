...
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_DESERIALIZEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A1BC390)
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_DESERIALIZEOBJECTSAFE_OFFSET UNITYSDK_OFFSET(0x1A1BC520)
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_DESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A1BC5F0)
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_SERIALIZEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A1BC3E0)
#define SYSTEM_RUNTIME_REMOTING_CHANNELS_CADSERIALIZER_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A1BC6C0)
