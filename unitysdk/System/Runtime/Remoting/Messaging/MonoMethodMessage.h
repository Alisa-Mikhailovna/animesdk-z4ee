...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GETARG_OFFSET UNITYSDK_OFFSET(0x1A1E0F70)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GETMETHODINFO_OFFSET UNITYSDK_OFFSET(0x1A1E0910)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_ARGCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1E0AE0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_ARGS_OFFSET UNITYSDK_OFFSET(0x1A1E0C10)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_ASYNCRESULT_OFFSET UNITYSDK_OFFSET(0x1A1E12D0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_CALLTYPE_OFFSET UNITYSDK_OFFSET(0x1A1E0B90)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A1E0FA0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_LOGICALCALLCONTEXT_OFFSET UNITYSDK_OFFSET(0x1A1E0C20)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_METHODBASE_OFFSET UNITYSDK_OFFSET(0x1A1E0C40)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1A1E0C50)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_METHODSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1A1E0CC0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_OUTARGCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1E0FB0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_OUTARGS_OFFSET UNITYSDK_OFFSET(0x1A1E1090)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A1E0A30)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_RETURNVALUE_OFFSET UNITYSDK_OFFSET(0x1A1E12A0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_TYPENAME_OFFSET UNITYSDK_OFFSET(0x1A1E0E60)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_GET_URI_OFFSET UNITYSDK_OFFSET(0x1A1E0F50)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_INITMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A1E0330)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_NEEDSOUTPROCESSING_OFFSET UNITYSDK_OFFSET(0x1A1E13A0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_SET_LOGICALCALLCONTEXT_OFFSET UNITYSDK_OFFSET(0x1A1E0C30)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_SET_URI_OFFSET UNITYSDK_OFFSET(0x1A1E0F60)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_SYSTEM_RUNTIME_REMOTING_MESSAGING_IINTERNALMESSAGE_GET_TARGETIDENTITY_OFFSET UNITYSDK_OFFSET(0x1A1E12B0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE_SYSTEM_RUNTIME_REMOTING_MESSAGING_IINTERNALMESSAGE_SET_TARGETIDENTITY_OFFSET UNITYSDK_OFFSET(0x1A1E12C0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1E14B0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1E0800)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A1E09B0)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_MONOMETHODMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E07A0)
...
namespace System::Runtime::Remoting::Messaging
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(MonoMethodMessage_TypeDefinitionIndex)->GetStaticField(0x11180);
		}
		static ::System::String** StaticGet_UriKey()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(MonoMethodMessage_TypeDefinitionIndex)->GetStaticField(0x11188);
		}
