...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYCONVERTER_GETBINARYTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1A1FD350)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYCONVERTER_GETPARSERBINARYTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1A1FDBE0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYCONVERTER_READTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1A1FCA90)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYCONVERTER_TYPEFROMINFO_OFFSET UNITYSDK_OFFSET(0x1A1FE140)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYCONVERTER_WRITETYPEINFO_OFFSET UNITYSDK_OFFSET(0x1A1FBB80)
