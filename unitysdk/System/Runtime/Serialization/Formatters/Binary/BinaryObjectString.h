...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYOBJECTSTRING_DUMP_OFFSET UNITYSDK_OFFSET(0x1A201CA0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYOBJECTSTRING_READ_OFFSET UNITYSDK_OFFSET(0x1A201B80)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYOBJECTSTRING_SET_OFFSET UNITYSDK_OFFSET(0x1A2019B0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYOBJECTSTRING_WRITE_OFFSET UNITYSDK_OFFSET(0x1A2019C0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_BINARYOBJECTSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2019A0)
