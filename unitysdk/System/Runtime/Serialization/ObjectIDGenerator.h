...
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTIDGENERATOR_FINDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A222170)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTIDGENERATOR_GETID_OFFSET UNITYSDK_OFFSET(0x1A222210)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTIDGENERATOR_HASID_OFFSET UNITYSDK_OFFSET(0x1A2227F0)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTIDGENERATOR_REHASH_OFFSET UNITYSDK_OFFSET(0x1A222410)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTIDGENERATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A222950)
#define SYSTEM_RUNTIME_SERIALIZATION_OBJECTIDGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2220A0)
...
namespace System::Runtime::Serialization
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ObjectIDGenerator_TypeDefinitionIndex)->GetStaticField(0x194F0);
		}
