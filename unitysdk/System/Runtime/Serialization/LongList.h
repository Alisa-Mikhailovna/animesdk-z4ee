...
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_ADD_OFFSET UNITYSDK_OFFSET(0x1A21FD70)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_ENLARGEARRAY_OFFSET UNITYSDK_OFFSET(0x1A21FE40)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A21FEC0)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A21FF50)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A21FEE0)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_REMOVEELEMENT_OFFSET UNITYSDK_OFFSET(0x1A21FF80)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST_STARTENUMERATION_OFFSET UNITYSDK_OFFSET(0x1A21FED0)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A21FD40)
#define SYSTEM_RUNTIME_SERIALIZATION_LONGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21FD10)
