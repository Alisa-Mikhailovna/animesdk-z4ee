...
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_EXPANDOCHECKVERSION_OFFSET UNITYSDK_OFFSET(0x1CAC4870)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_EXPANDOPROMOTECLASS_OFFSET UNITYSDK_OFFSET(0x1CAC48A0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_EXPANDOTRYDELETEVALUE_OFFSET UNITYSDK_OFFSET(0x1CAC47D0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_EXPANDOTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1CAC4770)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_EXPANDOTRYSETVALUE_OFFSET UNITYSDK_OFFSET(0x1CAC4790)
