...
#define SYSTEM_RUNTIME_COMPILERSERVICES_COMPILATIONRELAXATIONSATTRIBUTE_GET_COMPILATIONRELAXATIONS_OFFSET UNITYSDK_OFFSET(0x1A1B37A0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_COMPILATIONRELAXATIONSATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1B3790)
#define SYSTEM_RUNTIME_COMPILERSERVICES_COMPILATIONRELAXATIONSATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B3780)
