...
#define SYSTEM_THREADING_TIMERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A052A60)
#define SYSTEM_THREADING_TIMERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A052A90)
#define SYSTEM_THREADING_TIMERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A051000)
#define SYSTEM_THREADING_TIMERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A052970)
