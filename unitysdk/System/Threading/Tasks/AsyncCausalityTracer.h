...
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_GET_LOGGINGON_OFFSET UNITYSDK_OFFSET(0x1A03B4A0)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACEOPERATIONCOMPLETION_OFFSET UNITYSDK_OFFSET(0x1A03B4C0)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACEOPERATIONCREATION_OFFSET UNITYSDK_OFFSET(0x1A03B4B0)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACEOPERATIONRELATION_OFFSET UNITYSDK_OFFSET(0x1A03B4D0)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACESYNCHRONOUSWORKCOMPLETION_OFFSET UNITYSDK_OFFSET(0x1A03B4F0)
#define SYSTEM_THREADING_TASKS_ASYNCCAUSALITYTRACER_TRACESYNCHRONOUSWORKSTART_OFFSET UNITYSDK_OFFSET(0x1A03B4E0)
