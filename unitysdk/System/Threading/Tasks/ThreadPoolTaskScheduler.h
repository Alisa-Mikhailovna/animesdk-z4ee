...
#define SYSTEM_THREADING_TASKS_THREADPOOLTASKSCHEDULER_GET_REQUIRESATOMICSTARTTRANSITION_OFFSET UNITYSDK_OFFSET(0x1A04B990)
#define SYSTEM_THREADING_TASKS_THREADPOOLTASKSCHEDULER_LONGRUNNINGTHREADWORK_OFFSET UNITYSDK_OFFSET(0x1A04B430)
#define SYSTEM_THREADING_TASKS_THREADPOOLTASKSCHEDULER_NOTIFYWORKITEMPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A04B7A0)
#define SYSTEM_THREADING_TASKS_THREADPOOLTASKSCHEDULER_QUEUETASK_OFFSET UNITYSDK_OFFSET(0x1A04A610)
#define SYSTEM_THREADING_TASKS_THREADPOOLTASKSCHEDULER_TRYDEQUEUE_OFFSET UNITYSDK_OFFSET(0x1A04B890)
#define SYSTEM_THREADING_TASKS_THREADPOOLTASKSCHEDULER_TRYEXECUTETASKINLINE_OFFSET UNITYSDK_OFFSET(0x1A04A440)
#define SYSTEM_THREADING_TASKS_THREADPOOLTASKSCHEDULER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A04B9A0)
#define SYSTEM_THREADING_TASKS_THREADPOOLTASKSCHEDULER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04A9B0)
...
namespace System::Threading::Tasks
{
	...
	public:
		...
		{
			return (::System::Threading::ParameterizedThreadStart**)Il2CppClass::FromTypeDefinitionIndex(ThreadPoolTaskScheduler_TypeDefinitionIndex)->GetStaticField(0x20D60);
		}
