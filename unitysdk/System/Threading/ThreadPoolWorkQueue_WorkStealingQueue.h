...
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_LOCALFINDANDPOP_OFFSET UNITYSDK_OFFSET(0x1A04E830)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_LOCALPOP_OFFSET UNITYSDK_OFFSET(0x1A04EDB0)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_LOCALPUSH_OFFSET UNITYSDK_OFFSET(0x1A04E230)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_TRYSTEAL_1_OFFSET UNITYSDK_OFFSET(0x1A04F9C0)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE_TRYSTEAL_OFFSET UNITYSDK_OFFSET(0x1A04F1B0)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_WORKSTEALINGQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04FC70)
