...
#define SYSTEM_THREADING_ATOMICBOOLEAN_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A02EA00)
#define SYSTEM_THREADING_ATOMICBOOLEAN_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A02E9E0)
#define SYSTEM_THREADING_ATOMICBOOLEAN_EXCHANGE_OFFSET UNITYSDK_OFFSET(0x1A02E9C0)
#define SYSTEM_THREADING_ATOMICBOOLEAN_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A02EA40)
#define SYSTEM_THREADING_ATOMICBOOLEAN_TRYRELAXEDSET_OFFSET UNITYSDK_OFFSET(0x1A02E9A0)
#define SYSTEM_THREADING_ATOMICBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A02EA50)
