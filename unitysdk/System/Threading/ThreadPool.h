...
#define SYSTEM_THREADING_THREADPOOL_ENSUREVMINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A04DA20)
#define SYSTEM_THREADING_THREADPOOL_GETMINTHREADSNATIVE_OFFSET UNITYSDK_OFFSET(0x1A04D3D0)
#define SYSTEM_THREADING_THREADPOOL_GETMINTHREADS_OFFSET UNITYSDK_OFFSET(0x1A04D390)
#define SYSTEM_THREADING_THREADPOOL_INITIALIZEVMTP_OFFSET UNITYSDK_OFFSET(0x1A04DCE0)
#define SYSTEM_THREADING_THREADPOOL_ISTHREADPOOLHOSTED_OFFSET UNITYSDK_OFFSET(0x1A04DE50)
#define SYSTEM_THREADING_THREADPOOL_NOTIFYWORKITEMCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A04DCF0)
#define SYSTEM_THREADING_THREADPOOL_NOTIFYWORKITEMPROGRESSNATIVE_OFFSET UNITYSDK_OFFSET(0x1A04DDC0)
#define SYSTEM_THREADING_THREADPOOL_NOTIFYWORKITEMPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A04B8A0)
#define SYSTEM_THREADING_THREADPOOL_QUEUEUSERWORKITEMHELPER_OFFSET UNITYSDK_OFFSET(0x1A04D8C0)
#define SYSTEM_THREADING_THREADPOOL_QUEUEUSERWORKITEM_1_OFFSET UNITYSDK_OFFSET(0x1A04DA00)
#define SYSTEM_THREADING_THREADPOOL_QUEUEUSERWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A04D680)
#define SYSTEM_THREADING_THREADPOOL_REGISTERWAITFORSINGLEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1A04D6C0)
#define SYSTEM_THREADING_THREADPOOL_REGISTERWAITFORSINGLEOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1A04D760)
#define SYSTEM_THREADING_THREADPOOL_REGISTERWAITFORSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A04D410)
#define SYSTEM_THREADING_THREADPOOL_REPORTTHREADSTATUS_OFFSET UNITYSDK_OFFSET(0x1A04DDB0)
#define SYSTEM_THREADING_THREADPOOL_REQUESTWORKERTHREAD_OFFSET UNITYSDK_OFFSET(0x1A04DCD0)
#define SYSTEM_THREADING_THREADPOOL_TRYPOPCUSTOMWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A04B6A0)
#define SYSTEM_THREADING_THREADPOOL_UNSAFEQUEUECUSTOMWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A043A60)
#define SYSTEM_THREADING_THREADPOOL_UNSAFEQUEUEUSERWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A04D6A0)
