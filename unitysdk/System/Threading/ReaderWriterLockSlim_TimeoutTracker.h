...
#define SYSTEM_THREADING_READERWRITERLOCKSLIM_TIMEOUTTRACKER_GET_ISEXPIRED_OFFSET UNITYSDK_OFFSET(0x3A0EAD0)
#define SYSTEM_THREADING_READERWRITERLOCKSLIM_TIMEOUTTRACKER_GET_REMAININGMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x3A0EA60)
#define SYSTEM_THREADING_READERWRITERLOCKSLIM_TIMEOUTTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x3A0E9B0)
