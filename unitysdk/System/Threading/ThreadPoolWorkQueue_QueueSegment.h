...
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_QUEUESEGMENT_COMPAREEXCHANGEINDEXES_OFFSET UNITYSDK_OFFSET(0x1A04F980)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_QUEUESEGMENT_GETINDEXES_OFFSET UNITYSDK_OFFSET(0x1A04F960)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_QUEUESEGMENT_ISUSEDUP_OFFSET UNITYSDK_OFFSET(0x1A04F180)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_QUEUESEGMENT_TRYDEQUEUE_OFFSET UNITYSDK_OFFSET(0x1A04F0A0)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_QUEUESEGMENT_TRYENQUEUE_OFFSET UNITYSDK_OFFSET(0x1A04E790)
#define SYSTEM_THREADING_THREADPOOLWORKQUEUE_QUEUESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04DF30)
