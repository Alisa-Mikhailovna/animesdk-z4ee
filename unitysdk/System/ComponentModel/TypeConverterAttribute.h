...
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CC85DD0)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CC85E10)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE_GET_CONVERTERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1CC85DC0)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CC85EA0)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CC85CF0)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1CC85D80)
#define SYSTEM_COMPONENTMODEL_TYPECONVERTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC85CE0)
...
namespace System::ComponentModel
{
	...
	public:
		...
		{
			return (::System::ComponentModel::TypeConverterAttribute**)Il2CppClass::FromTypeDefinitionIndex(TypeConverterAttribute_TypeDefinitionIndex)->GetStaticField(0x2A6E0);
		}
