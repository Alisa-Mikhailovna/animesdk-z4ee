...
#define CLASS_3_77C6A5A3C62C5EAB_METHOD_3_8C07A6A51F854693_OFFSET UNITYSDK_OFFSET(0x1B7E6C70)
#define CLASS_3_77C6A5A3C62C5EAB_METHOD_3_C6AAD90EBB6BB822_OFFSET UNITYSDK_OFFSET(0x1B7E6C30)
#define CLASS_3_77C6A5A3C62C5EAB__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7E6C60)
