...
#define CLASS_1_5B567C8A01BAEDFE_226_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C293C20)
#define CLASS_1_5B567C8A01BAEDFE_226_CLONE_OFFSET UNITYSDK_OFFSET(0x1C2938C0)
#define CLASS_1_5B567C8A01BAEDFE_226_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C293A20)
#define CLASS_1_5B567C8A01BAEDFE_226_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C293930)
#define CLASS_1_5B567C8A01BAEDFE_226_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C293B80)
#define CLASS_1_5B567C8A01BAEDFE_226_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C293C70)
#define CLASS_1_5B567C8A01BAEDFE_226_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C293C40)
#define CLASS_1_5B567C8A01BAEDFE_226_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C293810)
#define CLASS_1_5B567C8A01BAEDFE_226_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C293870)
#define CLASS_1_5B567C8A01BAEDFE_226_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C293BB0)
#define CLASS_1_5B567C8A01BAEDFE_226_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C293C10)
#define CLASS_1_5B567C8A01BAEDFE_226__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C293CC0)
#define CLASS_1_5B567C8A01BAEDFE_226__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C293890)
#define CLASS_1_5B567C8A01BAEDFE_226__CTOR_OFFSET UNITYSDK_OFFSET(0x1C293880)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_226*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_226_TypeDefinitionIndex)->GetStaticField(0x31140);
	}
