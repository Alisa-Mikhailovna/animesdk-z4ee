...
#define XLUA_LUAMEMORYLEAKCHECKER_FINDGROWING_OFFSET UNITYSDK_OFFSET(0x13DA3220)
#define XLUA_LUAMEMORYLEAKCHECKER_GETRELATIONSHIP_OFFSET UNITYSDK_OFFSET(0x13DA2E90)
#define XLUA_LUAMEMORYLEAKCHECKER_GETSIZEREPORT_OFFSET UNITYSDK_OFFSET(0x13DA2930)
#define XLUA_LUAMEMORYLEAKCHECKER_MAKEKEY_OFFSET UNITYSDK_OFFSET(0x13DA2CB0)
#define XLUA_LUAMEMORYLEAKCHECKER_MEMORYLEAKCHECK_OFFSET UNITYSDK_OFFSET(0x13DA34D0)
#define XLUA_LUAMEMORYLEAKCHECKER_MEMORYLEAKREPORT_OFFSET UNITYSDK_OFFSET(0x13DA35C0)
#define XLUA_LUAMEMORYLEAKCHECKER_STARTMEMORYLEAKCHECK_OFFSET UNITYSDK_OFFSET(0x13DA3140)
