...
#define XLUA_LUATABLE_GETKEYS_OFFSET UNITYSDK_OFFSET(0x13DA5090)
#define XLUA_LUATABLE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x13DA4D80)
#define XLUA_LUATABLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x13DA4D20)
#define XLUA_LUATABLE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x13DA4E40)
#define XLUA_LUATABLE_PUSH_OFFSET UNITYSDK_OFFSET(0x13DA0AA0)
#define XLUA_LUATABLE_SETMETATABLE_OFFSET UNITYSDK_OFFSET(0x13DA5110)
#define XLUA_LUATABLE_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x13DA4DF0)
#define XLUA_LUATABLE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x13DA4D30)
#define XLUA_LUATABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x13DA5480)
#define XLUA_LUATABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x13DA4D10)
