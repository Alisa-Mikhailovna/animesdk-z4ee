...
#define XLUA_LUATABLE__GETKEYS_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x13DA54E0)
#define XLUA_LUATABLE__GETKEYS_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x13DA5980)
#define XLUA_LUATABLE__GETKEYS_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x13DA5910)
#define XLUA_LUATABLE__GETKEYS_D__15_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x13DA5A00)
#define XLUA_LUATABLE__GETKEYS_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x13DA5970)
#define XLUA_LUATABLE__GETKEYS_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x13DA5920)
#define XLUA_LUATABLE__GETKEYS_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13DA54D0)
#define XLUA_LUATABLE__GETKEYS_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x13DA50F0)
