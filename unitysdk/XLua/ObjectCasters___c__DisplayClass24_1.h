...
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_1__CTOR_OFFSET UNITYSDK_OFFSET(0x13DACF10)
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_1__GENCASTER_B__7_OFFSET UNITYSDK_OFFSET(0x13DAEC20)
...
namespace XLua
{
	...
	{
	public:
		::XLua::ObjectCast* elementCaster; // 0x10
