...
#define XLUA_CSOBJECTWRAP_RPGCLIENTICSTOLUABRIDGE_RPG_CLIENT_ICSTOLUA_ASYNCSHOWLUAPAGE_OFFSET UNITYSDK_OFFSET(0x1397F000)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICSTOLUABRIDGE_RPG_CLIENT_ICSTOLUA_CREATELUAPAGE_OFFSET UNITYSDK_OFFSET(0x1397FB60)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICSTOLUABRIDGE_RPG_CLIENT_ICSTOLUA_CSGC_OFFSET UNITYSDK_OFFSET(0x13980140)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICSTOLUABRIDGE_RPG_CLIENT_ICSTOLUA_NOTIFYPACKET_OFFSET UNITYSDK_OFFSET(0x13980AE0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICSTOLUABRIDGE_RPG_CLIENT_ICSTOLUA_NOTIFY_OFFSET UNITYSDK_OFFSET(0x139805F0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICSTOLUABRIDGE_RPG_CLIENT_ICSTOLUA_SYNCSHOWLUAPAGE_OFFSET UNITYSDK_OFFSET(0x1397F5B0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICSTOLUABRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1397EFF0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICSTOLUABRIDGE___CREATE_OFFSET UNITYSDK_OFFSET(0x1397EFC0)
