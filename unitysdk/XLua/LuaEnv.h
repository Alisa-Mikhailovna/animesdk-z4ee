...
#define XLUA_LUAENV_ADDBUILDIN_OFFSET UNITYSDK_OFFSET(0x13DA0290)
#define XLUA_LUAENV_ADDINITER_OFFSET UNITYSDK_OFFSET(0x13DA04B0)
#define XLUA_LUAENV_ADDLOADER_OFFSET UNITYSDK_OFFSET(0x13DA1840)
#define XLUA_LUAENV_ADDSEARCHER_OFFSET UNITYSDK_OFFSET(0x13D9FD20)
#define XLUA_LUAENV_ALIAS_OFFSET UNITYSDK_OFFSET(0x13DA0D60)
#define XLUA_LUAENV_CREATEUSERDATADTOR_OFFSET UNITYSDK_OFFSET(0x13DA0350)
#define XLUA_LUAENV_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x13DA1640)
#define XLUA_LUAENV_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13DA1380)
#define XLUA_LUAENV_DOSTRING_1_OFFSET UNITYSDK_OFFSET(0x13DA01D0)
#define XLUA_LUAENV_DOSTRING_OFFSET UNITYSDK_OFFSET(0x13DA0680)
#define XLUA_LUAENV_DTORFUNCTIONMETAFUNCTION_OFFSET UNITYSDK_OFFSET(0x13D9DDF0)
#define XLUA_LUAENV_EQUEUEGCACTION_OFFSET UNITYSDK_OFFSET(0x13D97160)
#define XLUA_LUAENV_FULLGC_OFFSET UNITYSDK_OFFSET(0x13DA1580)
#define XLUA_LUAENV_GCSTEP_OFFSET UNITYSDK_OFFSET(0x13DA1C80)
#define XLUA_LUAENV_GC_OFFSET UNITYSDK_OFFSET(0x13DA1150)
#define XLUA_LUAENV_GET_GCSTEPMUL_OFFSET UNITYSDK_OFFSET(0x13DA18C0)
#define XLUA_LUAENV_GET_GLOBAL_OFFSET UNITYSDK_OFFSET(0x13DA0610)
#define XLUA_LUAENV_GET_L_OFFSET UNITYSDK_OFFSET(0x13D97110)
#define XLUA_LUAENV_GET_MEMROY_OFFSET UNITYSDK_OFFSET(0x13DA1D50)
#define XLUA_LUAENV_GET_TRACEBACK_OFFSET UNITYSDK_OFFSET(0x13DA1E10)
#define XLUA_LUAENV_GET_TRANSLATOR_OFFSET UNITYSDK_OFFSET(0x13D9DE30)
#define XLUA_LUAENV_LOADSTRING_OFFSET UNITYSDK_OFFSET(0x13DA0620)
#define XLUA_LUAENV_NEWTABLE_OFFSET UNITYSDK_OFFSET(0x13DA1160)
#define XLUA_LUAENV_OBJECTVALIDCHECK_OFFSET UNITYSDK_OFFSET(0x13DA0D80)
#define XLUA_LUAENV_ONDISPOSEDEBUGGER_OFFSET UNITYSDK_OFFSET(0x13DA04A0)
#define XLUA_LUAENV_RESTARTGC_OFFSET UNITYSDK_OFFSET(0x13DA1BC0)
#define XLUA_LUAENV_SET_GCSTEPMUL_OFFSET UNITYSDK_OFFSET(0x13DA1A40)
#define XLUA_LUAENV_STARTDEBUGGER_OFFSET UNITYSDK_OFFSET(0x13DA0490)
#define XLUA_LUAENV_STOPGC_OFFSET UNITYSDK_OFFSET(0x13DA1B00)
#define XLUA_LUAENV_THROWEXCEPTIONFROMERROR_OFFSET UNITYSDK_OFFSET(0x13DA0B50)
#define XLUA_LUAENV_TICK_OFFSET UNITYSDK_OFFSET(0x13DA0DC0)
#define XLUA_LUAENV__CCTOR_OFFSET UNITYSDK_OFFSET(0x13DA1EF0)
#define XLUA_LUAENV__CTOR_OFFSET UNITYSDK_OFFSET(0x13D9DE40)
...
namespace XLua
{
	...
	public:
		...
		{
			return (::XLua::LuaEnv_DtorFunction**)Il2CppClass::FromTypeDefinitionIndex(LuaEnv_TypeDefinitionIndex)->GetStaticField(0x6C210);
		}
		static ::System::Collections::Generic::List_1<::System::Action_2<::XLua::LuaEnv*, ::XLua::ObjectTranslator*>*>** StaticGet_initers()
		{
			return (::System::Collections::Generic::List_1<::System::Action_2<::XLua::LuaEnv*, ::XLua::ObjectTranslator*>*>**)Il2CppClass::FromTypeDefinitionIndex(LuaEnv_TypeDefinitionIndex)->GetStaticField(0x6C218);
		}
