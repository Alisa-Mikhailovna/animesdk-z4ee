...
#define XLUA_TEMPLATEENGINE_CHUNK_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1437CDA0)
#define XLUA_TEMPLATEENGINE_CHUNK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1437CD80)
#define XLUA_TEMPLATEENGINE_CHUNK_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1437CDB0)
#define XLUA_TEMPLATEENGINE_CHUNK_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1437CD90)
#define XLUA_TEMPLATEENGINE_CHUNK__CTOR_OFFSET UNITYSDK_OFFSET(0x1437CDC0)
