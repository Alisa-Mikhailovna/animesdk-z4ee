...
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_2__CTOR_OFFSET UNITYSDK_OFFSET(0x13DAD190)
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_2__GENCASTER_B__8_OFFSET UNITYSDK_OFFSET(0x13DAF700)
...
namespace XLua
{
	...
	{
	public:
		::XLua::ObjectCast* keyCaster; // 0x10
