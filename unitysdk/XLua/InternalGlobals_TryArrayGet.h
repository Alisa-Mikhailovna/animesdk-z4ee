...
#define XLUA_INTERNALGLOBALS_TRYARRAYGET_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x13D90FE0)
#define XLUA_INTERNALGLOBALS_TRYARRAYGET_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x13D91080)
#define XLUA_INTERNALGLOBALS_TRYARRAYGET_INVOKE_OFFSET UNITYSDK_OFFSET(0x13D90FA0)
#define XLUA_INTERNALGLOBALS_TRYARRAYGET__CTOR_OFFSET UNITYSDK_OFFSET(0x13D90EB0)
