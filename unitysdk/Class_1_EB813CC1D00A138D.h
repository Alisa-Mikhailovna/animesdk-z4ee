...
#define CLASS_1_EB813CC1D00A138D_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C01AD70)
#define CLASS_1_EB813CC1D00A138D_CLONE_OFFSET UNITYSDK_OFFSET(0x1C01A6E0)
#define CLASS_1_EB813CC1D00A138D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C01A990)
#define CLASS_1_EB813CC1D00A138D_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C01A760)
#define CLASS_1_EB813CC1D00A138D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C01AB60)
#define CLASS_1_EB813CC1D00A138D_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C01AF70)
#define CLASS_1_EB813CC1D00A138D_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C01AE60)
#define CLASS_1_EB813CC1D00A138D_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1C01A730)
#define CLASS_1_EB813CC1D00A138D_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C01A4F0)
#define CLASS_1_EB813CC1D00A138D_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x1C01A750)
#define CLASS_1_EB813CC1D00A138D_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1C01A740)
#define CLASS_1_EB813CC1D00A138D_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C01A550)
#define CLASS_1_EB813CC1D00A138D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C01AC00)
#define CLASS_1_EB813CC1D00A138D_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C01AC60)
#define CLASS_1_EB813CC1D00A138D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C01B150)
#define CLASS_1_EB813CC1D00A138D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C01A5B0)
#define CLASS_1_EB813CC1D00A138D__CTOR_OFFSET UNITYSDK_OFFSET(0x1C01A560)
...
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Class_1_0C0F9366B7D3B580*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_0C0F9366B7D3B580*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EB813CC1D00A138D_TypeDefinitionIndex)->GetStaticField(0x66C40);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_EB813CC1D00A138D*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EB813CC1D00A138D*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EB813CC1D00A138D_TypeDefinitionIndex)->GetStaticField(0x66C48);
	}
	// static const ::System::Int32 Field_1_2 = 0x1; // 0x0
	// static const ::System::Int32 Field_1_3 = 0x2; // 0x0
	::Class_1_D17272E82AE804C2_40* Field_1_4; // 0x10
	::Google::Protobuf::UnknownFieldSet* Field_1_5; // 0x18
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_0C0F9366B7D3B580*>* Field_1_6; // 0x20
