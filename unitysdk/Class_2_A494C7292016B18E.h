...
#define CLASS_2_A494C7292016B18E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x119756C0)
#define CLASS_2_A494C7292016B18E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11975700)
#define CLASS_2_A494C7292016B18E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x119757D0)
#define CLASS_2_A494C7292016B18E_TICK_OFFSET UNITYSDK_OFFSET(0x11975820)
#define CLASS_2_A494C7292016B18E__CTOR_OFFSET UNITYSDK_OFFSET(0x119756B0)
...
public:
	...
	::RPG::GameCore::SetCurrentTurnActionEntity* Field_2_1; // 0x20
