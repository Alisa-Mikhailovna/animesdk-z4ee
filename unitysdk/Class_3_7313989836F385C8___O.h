...
public:
	...
	{
		return (::System::Action_1<::RPG::Client::MonoEffect*>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_7313989836F385C8___O_TypeDefinitionIndex)->GetStaticField(0x47DA0);
	}
};
