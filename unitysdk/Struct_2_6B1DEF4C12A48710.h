...
#define STRUCT_2_6B1DEF4C12A48710_GET_ACTIVESTATE_OFFSET UNITYSDK_OFFSET(0x1E130)
#define STRUCT_2_6B1DEF4C12A48710_GET_AGGREGATEDSTATEV2_OFFSET UNITYSDK_OFFSET(0x263A0)
#define STRUCT_2_6B1DEF4C12A48710_GET_COMPATKEY_OFFSET UNITYSDK_OFFSET(0x6E30)
#define STRUCT_2_6B1DEF4C12A48710_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define STRUCT_2_6B1DEF4C12A48710_GET_USESSOURCEPROFILE_OFFSET UNITYSDK_OFFSET(0x8AF20)
#define STRUCT_2_6B1DEF4C12A48710_GET_VISUALSTATE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define STRUCT_2_6B1DEF4C12A48710__CTOR_OFFSET UNITYSDK_OFFSET(0x2D01370)
