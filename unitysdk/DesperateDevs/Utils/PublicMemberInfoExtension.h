...
#define DESPERATEDEVS_UTILS_PUBLICMEMBERINFOEXTENSION_COPYPUBLICMEMBERVALUES_OFFSET UNITYSDK_OFFSET(0x157870A0)
#define DESPERATEDEVS_UTILS_PUBLICMEMBERINFOEXTENSION_GETPUBLICMEMBERINFOS_OFFSET UNITYSDK_OFFSET(0x15786A00)
#define DESPERATEDEVS_UTILS_PUBLICMEMBERINFOEXTENSION_PUBLICMEMBERCLONE_OFFSET UNITYSDK_OFFSET(0x15787050)
