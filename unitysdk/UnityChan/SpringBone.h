...
#define UNITYCHAN_SPRINGBONE_AWAKE_OFFSET UNITYSDK_OFFSET(0xDDB7610)
#define UNITYCHAN_SPRINGBONE_GET_CURRTIPPOS_OFFSET UNITYSDK_OFFSET(0xDDB78A0)
#define UNITYCHAN_SPRINGBONE_GET_CUSTOMCHILDPOS_OFFSET UNITYSDK_OFFSET(0xDDB78F0)
#define UNITYCHAN_SPRINGBONE_GET_PREVTIPPOS_OFFSET UNITYSDK_OFFSET(0xDDB78C0)
#define UNITYCHAN_SPRINGBONE_GET_SPRINGLENGTH_OFFSET UNITYSDK_OFFSET(0xDDB78E0)
#define UNITYCHAN_SPRINGBONE_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xDDB7910)
#define UNITYCHAN_SPRINGBONE_METHOD_5_D1AA082DEC215AEF_OFFSET UNITYSDK_OFFSET(0xDDB9070)
#define UNITYCHAN_SPRINGBONE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xDDB8FF0)
#define UNITYCHAN_SPRINGBONE_PREUPDATESPRING_OFFSET UNITYSDK_OFFSET(0xDDB7A10)
#define UNITYCHAN_SPRINGBONE_RESETSPRINGBONEDATA_OFFSET UNITYSDK_OFFSET(0xDDB7600)
#define UNITYCHAN_SPRINGBONE_UPDATESPRING_OFFSET UNITYSDK_OFFSET(0xDDB7AF0)
#define UNITYCHAN_SPRINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0xDDB90F0)
