...
#define UNITYCHAN_SPRINGCOLLIDER_METHOD_5_FCCE5510573026EA_OFFSET UNITYSDK_OFFSET(0xDDB9160)
#define UNITYCHAN_SPRINGCOLLIDER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xDDB9B90)
#define UNITYCHAN_SPRINGCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xDDB9E50)
