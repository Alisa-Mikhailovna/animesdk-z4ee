...
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BC6A920)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_CLONE_OFFSET UNITYSDK_OFFSET(0x1BC6A520)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BC6A6E0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BC6A5D0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BC6A7B0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1BC6A470)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_GET_REGIONID_OFFSET UNITYSDK_OFFSET(0x1BC6A590)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1BC6A5B0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BC6AA70)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BC6AA30)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BC6A4D0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_SET_REGIONID_OFFSET UNITYSDK_OFFSET(0x1BC6A5A0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1BC6A5C0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BC6A7E0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BC6A840)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC6ABF0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BC6A4F0)
#define PROTO_ERAFLIPPERREGIONDATASNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC6A4E0)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::EraFlipperRegionDataSnapshot*>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperRegionDataSnapshot_TypeDefinitionIndex)->GetStaticField(0x3CBA0);
		}
