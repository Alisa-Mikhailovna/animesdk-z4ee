...
#define PROTO_GETTUTORIALSCRSP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BC762E0)
#define PROTO_GETTUTORIALSCRSP_CLONE_OFFSET UNITYSDK_OFFSET(0x1BC75E30)
#define PROTO_GETTUTORIALSCRSP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BC75FE0)
#define PROTO_GETTUTORIALSCRSP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BC75E90)
#define PROTO_GETTUTORIALSCRSP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BC76110)
#define PROTO_GETTUTORIALSCRSP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1BC75D20)
#define PROTO_GETTUTORIALSCRSP_GET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1BC75E60)
#define PROTO_GETTUTORIALSCRSP_GET_TUTORIALLIST_OFFSET UNITYSDK_OFFSET(0x1BC75E80)
#define PROTO_GETTUTORIALSCRSP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BC76490)
#define PROTO_GETTUTORIALSCRSP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BC763F0)
#define PROTO_GETTUTORIALSCRSP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BC75D50)
#define PROTO_GETTUTORIALSCRSP_SET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1BC75E70)
#define PROTO_GETTUTORIALSCRSP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BC76180)
#define PROTO_GETTUTORIALSCRSP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BC761E0)
#define PROTO_GETTUTORIALSCRSP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC76650)
#define PROTO_GETTUTORIALSCRSP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BC75DA0)
#define PROTO_GETTUTORIALSCRSP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC75D60)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::FieldCodec_1<::Proto::Tutorial*>**)Il2CppClass::FromTypeDefinitionIndex(GetTutorialScRsp_TypeDefinitionIndex)->GetStaticField(0x3D910);
		}
		static ::Google::Protobuf::MessageParser_1<::Proto::GetTutorialScRsp*>** StaticGet__parser()
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::GetTutorialScRsp*>**)Il2CppClass::FromTypeDefinitionIndex(GetTutorialScRsp_TypeDefinitionIndex)->GetStaticField(0x3D918);
		}
