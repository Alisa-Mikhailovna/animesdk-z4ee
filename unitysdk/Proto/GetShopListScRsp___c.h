...
#define PROTO_GETSHOPLISTSCRSP___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC75150)
#define PROTO_GETSHOPLISTSCRSP___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC75180)
#define PROTO_GETSHOPLISTSCRSP___C___CCTOR_B__33_0_OFFSET UNITYSDK_OFFSET(0x1BC75190)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::GetShopListScRsp___c**)Il2CppClass::FromTypeDefinitionIndex(GetShopListScRsp___c_TypeDefinitionIndex)->GetStaticField(0x3D8B0);
		}
