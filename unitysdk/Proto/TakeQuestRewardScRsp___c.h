...
#define PROTO_TAKEQUESTREWARDSCRSP___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC9A590)
#define PROTO_TAKEQUESTREWARDSCRSP___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC9A5D0)
#define PROTO_TAKEQUESTREWARDSCRSP___C___CCTOR_B__38_0_OFFSET UNITYSDK_OFFSET(0x1BC9A5E0)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Proto::TakeQuestRewardScRsp___c**)Il2CppClass::FromTypeDefinitionIndex(TakeQuestRewardScRsp___c_TypeDefinitionIndex)->GetStaticField(0x43CA0);
		}
