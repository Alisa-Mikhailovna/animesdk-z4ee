...
#define PROTO_TAKEQUESTREWARDSCRSP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BC99FD0)
#define PROTO_TAKEQUESTREWARDSCRSP_CLONE_OFFSET UNITYSDK_OFFSET(0x1BC99930)
#define PROTO_TAKEQUESTREWARDSCRSP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BC999F0)
#define PROTO_TAKEQUESTREWARDSCRSP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BC999C0)
#define PROTO_TAKEQUESTREWARDSCRSP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BC99BD0)
#define PROTO_TAKEQUESTREWARDSCRSP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1BC996C0)
#define PROTO_TAKEQUESTREWARDSCRSP_GET_QUESTIDLIST_OFFSET UNITYSDK_OFFSET(0x1BC99960)
#define PROTO_TAKEQUESTREWARDSCRSP_GET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1BC99970)
#define PROTO_TAKEQUESTREWARDSCRSP_GET_REWARD_OFFSET UNITYSDK_OFFSET(0x1BC999A0)
#define PROTO_TAKEQUESTREWARDSCRSP_GET_SUCCQUESTIDLIST_OFFSET UNITYSDK_OFFSET(0x1BC99990)
#define PROTO_TAKEQUESTREWARDSCRSP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BC9A2A0)
#define PROTO_TAKEQUESTREWARDSCRSP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BC9A130)
#define PROTO_TAKEQUESTREWARDSCRSP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BC996F0)
#define PROTO_TAKEQUESTREWARDSCRSP_SET_RETCODE_OFFSET UNITYSDK_OFFSET(0x1BC99980)
#define PROTO_TAKEQUESTREWARDSCRSP_SET_REWARD_OFFSET UNITYSDK_OFFSET(0x1BC999B0)
#define PROTO_TAKEQUESTREWARDSCRSP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BC99DF0)
#define PROTO_TAKEQUESTREWARDSCRSP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BC99E50)
#define PROTO_TAKEQUESTREWARDSCRSP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC9A410)
#define PROTO_TAKEQUESTREWARDSCRSP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BC99790)
#define PROTO_TAKEQUESTREWARDSCRSP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC99700)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(TakeQuestRewardScRsp_TypeDefinitionIndex)->GetStaticField(0x43C10);
		}
		static ::Google::Protobuf::MessageParser_1<::Proto::TakeQuestRewardScRsp*>** StaticGet__parser()
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::TakeQuestRewardScRsp*>**)Il2CppClass::FromTypeDefinitionIndex(TakeQuestRewardScRsp_TypeDefinitionIndex)->GetStaticField(0x43C18);
		}
		static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet__repeated_succQuestIdList_codec()
		{
			return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(TakeQuestRewardScRsp_TypeDefinitionIndex)->GetStaticField(0x43C20);
		}
		...
		::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* succQuestIdList_; // 0x10
		::Proto::ItemList* reward_; // 0x18
		::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* questIdList_; // 0x20
