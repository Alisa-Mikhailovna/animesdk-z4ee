...
#define PROTO_SHOP_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BC945B0)
#define PROTO_SHOP_CLONE_OFFSET UNITYSDK_OFFSET(0x1BC93FB0)
#define PROTO_SHOP_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BC940E0)
#define PROTO_SHOP_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BC940B0)
#define PROTO_SHOP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BC941A0)
#define PROTO_SHOP_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1BC94000)
#define PROTO_SHOP_GET_CITYEXP_OFFSET UNITYSDK_OFFSET(0x1BC94040)
#define PROTO_SHOP_GET_CITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1BC93FE0)
#define PROTO_SHOP_GET_CITYTAKENLEVELREWARD_OFFSET UNITYSDK_OFFSET(0x1BC94060)
#define PROTO_SHOP_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1BC94020)
#define PROTO_SHOP_GET_GOODSLIST_OFFSET UNITYSDK_OFFSET(0x1BC940A0)
#define PROTO_SHOP_GET_PARSER_OFFSET UNITYSDK_OFFSET(0x1BC93E80)
#define PROTO_SHOP_GET_SHOPID_OFFSET UNITYSDK_OFFSET(0x1BC94080)
#define PROTO_SHOP_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BC94B00)
#define PROTO_SHOP_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BC94A10)
#define PROTO_SHOP_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BC93EB0)
#define PROTO_SHOP_SET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1BC94010)
#define PROTO_SHOP_SET_CITYEXP_OFFSET UNITYSDK_OFFSET(0x1BC94050)
#define PROTO_SHOP_SET_CITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1BC93FF0)
#define PROTO_SHOP_SET_CITYTAKENLEVELREWARD_OFFSET UNITYSDK_OFFSET(0x1BC94070)
#define PROTO_SHOP_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1BC94030)
#define PROTO_SHOP_SET_SHOPID_OFFSET UNITYSDK_OFFSET(0x1BC94090)
#define PROTO_SHOP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BC94270)
#define PROTO_SHOP_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BC942D0)
#define PROTO_SHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC94C40)
#define PROTO_SHOP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BC93F00)
#define PROTO_SHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC93EC0)
...
namespace Proto
{
	...
	public:
		...
		{
			return (::Google::Protobuf::MessageParser_1<::Proto::Shop*>**)Il2CppClass::FromTypeDefinitionIndex(Shop_TypeDefinitionIndex)->GetStaticField(0xCD00);
		}
		static ::Google::Protobuf::FieldCodec_1<::Proto::Goods*>** StaticGet__repeated_goodsList_codec()
		{
			return (::Google::Protobuf::FieldCodec_1<::Proto::Goods*>**)Il2CppClass::FromTypeDefinitionIndex(Shop_TypeDefinitionIndex)->GetStaticField(0xCD08);
		}
