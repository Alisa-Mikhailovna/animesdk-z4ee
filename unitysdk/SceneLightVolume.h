...
#define SCENELIGHTVOLUME_AWAKE_OFFSET UNITYSDK_OFFSET(0xDD3E070)
#define SCENELIGHTVOLUME_GETLIGHTMODE_OFFSET UNITYSDK_OFFSET(0xDD3EB90)
#define SCENELIGHTVOLUME_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xDD3E060)
#define SCENELIGHTVOLUME_INVOLUME_OFFSET UNITYSDK_OFFSET(0xDD3EA90)
#define SCENELIGHTVOLUME_ISALLHIDEOBJECTS_OFFSET UNITYSDK_OFFSET(0xDD3E540)
#define SCENELIGHTVOLUME_ISHIDEOBJECTS_OFFSET UNITYSDK_OFFSET(0xDD3E460)
#define SCENELIGHTVOLUME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDD3E400)
#define SCENELIGHTVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDD3E7D0)
#define SCENELIGHTVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDD3E720)
#define SCENELIGHTVOLUME_ONMAPROTATED_OFFSET UNITYSDK_OFFSET(0xDD3E880)
#define SCENELIGHTVOLUME_ONRESET_OFFSET UNITYSDK_OFFSET(0xDD3E610)
#define SCENELIGHTVOLUME_REGENINDEXER_OFFSET UNITYSDK_OFFSET(0xDD3E1B0)
#define SCENELIGHTVOLUME_SETBLOCKS_OFFSET UNITYSDK_OFFSET(0xDD3EC60)
#define SCENELIGHTVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xDD3F110)
