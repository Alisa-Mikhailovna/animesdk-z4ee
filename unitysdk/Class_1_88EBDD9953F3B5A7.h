...
#define CLASS_1_88EBDD9953F3B5A7_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BBD3FE0)
#define CLASS_1_88EBDD9953F3B5A7_CLONE_OFFSET UNITYSDK_OFFSET(0x1BBD39D0)
#define CLASS_1_88EBDD9953F3B5A7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BBD3C60)
#define CLASS_1_88EBDD9953F3B5A7_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BBD3AD0)
#define CLASS_1_88EBDD9953F3B5A7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BBD3DF0)
#define CLASS_1_88EBDD9953F3B5A7_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BBD4220)
#define CLASS_1_88EBDD9953F3B5A7_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BBD4180)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1BBD3AB0)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x1BBD3A90)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1BBD3A80)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BBD38F0)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1BBD3AC0)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1BBD3A70)
#define CLASS_1_88EBDD9953F3B5A7_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x1BBD3AA0)
#define CLASS_1_88EBDD9953F3B5A7_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BBD3920)
#define CLASS_1_88EBDD9953F3B5A7_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BBD3E40)
#define CLASS_1_88EBDD9953F3B5A7_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BBD3EA0)
#define CLASS_1_88EBDD9953F3B5A7__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BBD43E0)
#define CLASS_1_88EBDD9953F3B5A7__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BBD3940)
#define CLASS_1_88EBDD9953F3B5A7__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD3930)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_88EBDD9953F3B5A7*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_88EBDD9953F3B5A7_TypeDefinitionIndex)->GetStaticField(0x327F0);
	}
	// static const ::System::Int32 Field_1_1 = 0xB; // 0x0
	// static const ::System::Int32 Field_1_2 = 0xF; // 0x0
	// static const ::System::Int32 Field_1_3 = 0xD; // 0x0
	::Google::Protobuf::UnknownFieldSet* Field_1_4; // 0x10
	::Class_1_87FFBB414BD751E4_1* Field_1_5; // 0x18
