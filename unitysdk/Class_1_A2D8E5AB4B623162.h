...
#define CLASS_1_A2D8E5AB4B623162_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14BB6A30)
#define CLASS_1_A2D8E5AB4B623162_GET_ABILITYGLOBALUSEID_OFFSET UNITYSDK_OFFSET(0x14BB9A70)
#define CLASS_1_A2D8E5AB4B623162_GET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x14BB9A30)
#define CLASS_1_A2D8E5AB4B623162_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x14BB9A50)
#define CLASS_1_A2D8E5AB4B623162_GET_ISINTRIGGER_OFFSET UNITYSDK_OFFSET(0x14BB9A10)
#define CLASS_1_A2D8E5AB4B623162_GET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x14BB99F0)
#define CLASS_1_A2D8E5AB4B623162_GET_TAG_OFFSET UNITYSDK_OFFSET(0x14BB9AB0)
#define CLASS_1_A2D8E5AB4B623162_GET_TARGETLISTINDEX_OFFSET UNITYSDK_OFFSET(0x14BB99D0)
#define CLASS_1_A2D8E5AB4B623162_GET_TIMEFROMSTART_OFFSET UNITYSDK_OFFSET(0x14BB9CA0)
#define CLASS_1_A2D8E5AB4B623162_GET_USEOPTION_OFFSET UNITYSDK_OFFSET(0x14BB9CC0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x14BB9A90)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_1BAAF20C60E3BE61_OFFSET UNITYSDK_OFFSET(0x14BB7CC0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_241FCB0507EB9FA1_OFFSET UNITYSDK_OFFSET(0x14BB8370)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_27FE160831643A26_OFFSET UNITYSDK_OFFSET(0x14BB99B0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_30A2382C3FCC5386_1_OFFSET UNITYSDK_OFFSET(0x14BB7BB0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x14BB7B50)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x14BB98A0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x14BB6FA0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_47D88335E404DE12_OFFSET UNITYSDK_OFFSET(0x14BB9BB0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_4D048E895C608EDE_OFFSET UNITYSDK_OFFSET(0x14BB73A0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_543457E493C428FA_OFFSET UNITYSDK_OFFSET(0x14BB8530)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_68FB99B33E7C7AEB_OFFSET UNITYSDK_OFFSET(0x14BB9C10)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_70ABAF7F0B6E54DF_OFFSET UNITYSDK_OFFSET(0x14BB99C0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_831A63E2BFD59A60_OFFSET UNITYSDK_OFFSET(0x14BB8740)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8377BC0DCBA8CDB6_OFFSET UNITYSDK_OFFSET(0x14BB9AE0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_84952E9528E25353_OFFSET UNITYSDK_OFFSET(0x14BB9770)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x14BB6D60)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8A9A72FB00358D11_OFFSET UNITYSDK_OFFSET(0x14BB8260)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_8E37FF4EF1D584B4_OFFSET UNITYSDK_OFFSET(0x14BB83B0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_918892D3041414DB_OFFSET UNITYSDK_OFFSET(0x14BB8670)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_93A145ED6F5562B4_OFFSET UNITYSDK_OFFSET(0x14BB9690)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x14BB6E70)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_9BADE3E301981C8B_OFFSET UNITYSDK_OFFSET(0x14BB6EF0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_9C05ABC9E776C74C_OFFSET UNITYSDK_OFFSET(0x14BB7670)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_A8D78AA5E0EAC774_OFFSET UNITYSDK_OFFSET(0x14BB9AD0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_A9B16756059F6D47_OFFSET UNITYSDK_OFFSET(0x14BB8160)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x14BB75D0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x14BB99A0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_C5BCCB84D9F819F3_OFFSET UNITYSDK_OFFSET(0x14BB8680)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_C783EE0A4CAB17F8_OFFSET UNITYSDK_OFFSET(0x14BB7910)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14BB9950)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_CA94882F410B6995_OFFSET UNITYSDK_OFFSET(0x14BB6890)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_CC9C9A9047B24E05_OFFSET UNITYSDK_OFFSET(0x14BB9B50)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_D41F2EAAA87E2BFD_OFFSET UNITYSDK_OFFSET(0x14BB9AF0)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_DAC6E1EE61939DC7_OFFSET UNITYSDK_OFFSET(0x14BB7C10)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_DBAADCCDBE5B4E3B_OFFSET UNITYSDK_OFFSET(0x14BB7C60)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_EBA51AD1CAB619FD_OFFSET UNITYSDK_OFFSET(0x14BB7950)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_F07840BBC25636A7_OFFSET UNITYSDK_OFFSET(0x14BB7140)
#define CLASS_1_A2D8E5AB4B623162_METHOD_1_FB51ED6FD63B44C1_OFFSET UNITYSDK_OFFSET(0x14BB7F10)
#define CLASS_1_A2D8E5AB4B623162_SET_ABILITYGLOBALUSEID_OFFSET UNITYSDK_OFFSET(0x14BB9A80)
#define CLASS_1_A2D8E5AB4B623162_SET_DYNAMICSTRINGS_OFFSET UNITYSDK_OFFSET(0x14BB9A40)
#define CLASS_1_A2D8E5AB4B623162_SET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x14BB9A60)
#define CLASS_1_A2D8E5AB4B623162_SET_ISINTRIGGER_OFFSET UNITYSDK_OFFSET(0x14BB9A20)
#define CLASS_1_A2D8E5AB4B623162_SET_SKILLPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x14BB9A00)
#define CLASS_1_A2D8E5AB4B623162_SET_TAG_OFFSET UNITYSDK_OFFSET(0x14BB9AC0)
#define CLASS_1_A2D8E5AB4B623162_SET_TARGETLISTINDEX_OFFSET UNITYSDK_OFFSET(0x14BB99E0)
#define CLASS_1_A2D8E5AB4B623162_SET_TIMEFROMSTART_OFFSET UNITYSDK_OFFSET(0x14BB9CB0)
#define CLASS_1_A2D8E5AB4B623162_SET_USEOPTION_OFFSET UNITYSDK_OFFSET(0x14BB9CD0)
#define CLASS_1_A2D8E5AB4B623162__CTOR_OFFSET UNITYSDK_OFFSET(0x14BB62F0)
...
public:
	...
	::RPG::GameCore::AbilityComponent* Field_1_1; // 0x18
	::RPG::GameCore::GameEntity* _SkillPointEntity_k__BackingField; // 0x20
	::RPG::GameCore::TaskContext* Field_1_3; // 0x28
	::System::Collections::Generic::List_1<::Class_1_0AD6129525BF5F86*>* Field_1_4; // 0x30
	::RPG::GameCore::AbilityConfig* Field_1_5; // 0x38
	...
	::RPG::GameCore::GameEntityList* Field_1_11; // 0x68
	...
	::RPG::GameCore::UseAbilityOption _UseOption_k__BackingField; // 0x7C
	::System::Boolean _IsInTrigger_k__BackingField; // 0x80
	::System::Single _TimeFromStart_k__BackingField; // 0x84
	::RPG::GameCore::AbilityInstanceState Field_1_17; // 0x88
