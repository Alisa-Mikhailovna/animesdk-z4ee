...
#define CLASS_2_165BFDC2F8A1D890_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADB8060)
#define CLASS_2_165BFDC2F8A1D890_METHOD_2_458DAEAB6170C584_OFFSET UNITYSDK_OFFSET(0xADB7DC0)
#define CLASS_2_165BFDC2F8A1D890_METHOD_2_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0xADB81C0)
#define CLASS_2_165BFDC2F8A1D890_METHOD_2_F68F6F2F168E0D7D_OFFSET UNITYSDK_OFFSET(0xADB8250)
#define CLASS_2_165BFDC2F8A1D890__CTOR_OFFSET UNITYSDK_OFFSET(0xADB8320)
...
{
public:
	::RPG::Client::MonoMapPoseSwitcher* Field_2_0; // 0x18
	::RPG::GameCore::CharacterVisibleComponent* Field_2_1; // 0x20
	::Class_1_64D890C466F37235* Field_2_2; // 0x28
