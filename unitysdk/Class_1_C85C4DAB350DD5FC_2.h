...
#define CLASS_1_C85C4DAB350DD5FC_2_GET_BRIEFNAME_OFFSET UNITYSDK_OFFSET(0x14B34150)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_COLLECTICONPATH_OFFSET UNITYSDK_OFFSET(0x14B34230)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0x14B34190)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_DESC_OFFSET UNITYSDK_OFFSET(0x14B34170)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_ICONPATHF_OFFSET UNITYSDK_OFFSET(0x14B341D0)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x14B341B0)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_ID_OFFSET UNITYSDK_OFFSET(0x14B34120)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_ISACQUIRED_OFFSET UNITYSDK_OFFSET(0x14B342F0)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_ISCOLLECTABLE_OFFSET UNITYSDK_OFFSET(0x14B34310)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_ISINHANDBOOK_OFFSET UNITYSDK_OFFSET(0x14B34370)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_KEYWORDS_OFFSET UNITYSDK_OFFSET(0x14B34290)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_LOWERREPLACEIDLIST_OFFSET UNITYSDK_OFFSET(0x14B34350)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_MANACOST_OFFSET UNITYSDK_OFFSET(0x14B342B0)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_NAME_OFFSET UNITYSDK_OFFSET(0x14B34130)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x14B342D0)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x14B34390)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x14B34250)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_SMALLICONPATHF_OFFSET UNITYSDK_OFFSET(0x14B34210)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x14B341F0)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_STORYDESC_OFFSET UNITYSDK_OFFSET(0x14B34330)
#define CLASS_1_C85C4DAB350DD5FC_2_GET_TAG_OFFSET UNITYSDK_OFFSET(0x14B34270)
#define CLASS_1_C85C4DAB350DD5FC_2_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x14B34F70)
#define CLASS_1_C85C4DAB350DD5FC_2_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x14B34EF0)
#define CLASS_1_C85C4DAB350DD5FC_2_METHOD_1_A8F6F688241E6DBC_1_OFFSET UNITYSDK_OFFSET(0x14B345F0)
#define CLASS_1_C85C4DAB350DD5FC_2_METHOD_1_A8F6F688241E6DBC_2_OFFSET UNITYSDK_OFFSET(0x14B34830)
#define CLASS_1_C85C4DAB350DD5FC_2_METHOD_1_A8F6F688241E6DBC_3_OFFSET UNITYSDK_OFFSET(0x14B34A70)
#define CLASS_1_C85C4DAB350DD5FC_2_METHOD_1_A8F6F688241E6DBC_4_OFFSET UNITYSDK_OFFSET(0x14B34CB0)
#define CLASS_1_C85C4DAB350DD5FC_2_METHOD_1_A8F6F688241E6DBC_OFFSET UNITYSDK_OFFSET(0x14B343B0)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_BRIEFNAME_OFFSET UNITYSDK_OFFSET(0x14B34160)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_COLLECTICONPATH_OFFSET UNITYSDK_OFFSET(0x14B34240)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0x14B341A0)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_DESC_OFFSET UNITYSDK_OFFSET(0x14B34180)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_ICONPATHF_OFFSET UNITYSDK_OFFSET(0x14B341E0)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x14B341C0)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_ISACQUIRED_OFFSET UNITYSDK_OFFSET(0x14B34300)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_ISCOLLECTABLE_OFFSET UNITYSDK_OFFSET(0x14B34320)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_ISINHANDBOOK_OFFSET UNITYSDK_OFFSET(0x14B34380)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_KEYWORDS_OFFSET UNITYSDK_OFFSET(0x14B342A0)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_LOWERREPLACEIDLIST_OFFSET UNITYSDK_OFFSET(0x14B34360)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_MANACOST_OFFSET UNITYSDK_OFFSET(0x14B342C0)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_NAME_OFFSET UNITYSDK_OFFSET(0x14B34140)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x14B342E0)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x14B343A0)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x14B34260)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_SMALLICONPATHF_OFFSET UNITYSDK_OFFSET(0x14B34220)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x14B34200)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_STORYDESC_OFFSET UNITYSDK_OFFSET(0x14B34340)
#define CLASS_1_C85C4DAB350DD5FC_2_SET_TAG_OFFSET UNITYSDK_OFFSET(0x14B34280)
#define CLASS_1_C85C4DAB350DD5FC_2__CTOR_OFFSET UNITYSDK_OFFSET(0x14B34090)

inline static constexpr unsigned int Class_1_C85C4DAB350DD5FC_2_TypeDefinitionIndex = 76122;

class Class_1_C85C4DAB350DD5FC_2 : public ::System::Object
{
public:
	::System::String* _IconPathF_k__BackingField; // 0x10
	::System::Collections::Generic::IReadOnlyList_1<::System::UInt32>* _LowerReplaceIDList_k__BackingField; // 0x18
	::System::String* _CollectIconPath_k__BackingField; // 0x20
	::Class_1_93A7657886F5B09F* _Rarity_k__BackingField; // 0x28
	::Il2CppArray<::RPG::GameCore::FixPoint>* _DescParams_k__BackingField; // 0x30
	...
	::System::String* _SmallIconPathF_k__BackingField; // 0x50
	...
	::RPG::Client::TextID _StoryDesc_k__BackingField; // 0x80
	::System::Boolean _IsAcquired_k__BackingField; // 0x90
	::System::Boolean _IsInHandbook_k__BackingField; // 0x91
	::System::Boolean _IsCollectable_k__BackingField; // 0x92
	::RPG::GameCore::FateRinHouguOwnerType _Owner_k__BackingField; // 0x94
	::RPG::Client::TextID _BriefName_k__BackingField; // 0x98
	::System::UInt32 _Priority_k__BackingField; // 0xA8
	::System::UInt32 _ID_k__BackingField; // 0xAC
	::System::Int32 _ManaCost_k__BackingField; // 0xB0
