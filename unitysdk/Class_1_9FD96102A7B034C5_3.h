...
#define CLASS_1_9FD96102A7B034C5_3_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C49E3D0)
#define CLASS_1_9FD96102A7B034C5_3_CLONE_OFFSET UNITYSDK_OFFSET(0x1C49DF30)
#define CLASS_1_9FD96102A7B034C5_3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C49E0E0)
#define CLASS_1_9FD96102A7B034C5_3_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C49DF90)
#define CLASS_1_9FD96102A7B034C5_3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C49E200)
#define CLASS_1_9FD96102A7B034C5_3_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C49E5A0)
#define CLASS_1_9FD96102A7B034C5_3_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C49E500)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C49DF70)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_4C96E9A31DDA1BDD_OFFSET UNITYSDK_OFFSET(0x1C49DF60)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C49DE20)
#define CLASS_1_9FD96102A7B034C5_3_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C49DF80)
#define CLASS_1_9FD96102A7B034C5_3_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C49DE50)
#define CLASS_1_9FD96102A7B034C5_3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C49E270)
#define CLASS_1_9FD96102A7B034C5_3_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C49E2D0)
#define CLASS_1_9FD96102A7B034C5_3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C49E760)
#define CLASS_1_9FD96102A7B034C5_3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C49DEA0)
#define CLASS_1_9FD96102A7B034C5_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49DE60)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::PileItem*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_3_TypeDefinitionIndex)->GetStaticField(0x57F50);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_9FD96102A7B034C5_3*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9FD96102A7B034C5_3*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9FD96102A7B034C5_3_TypeDefinitionIndex)->GetStaticField(0x57F58);
	}
