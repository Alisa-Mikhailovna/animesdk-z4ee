...
#define JSONOBJECT_GETBOOL_OFFSET UNITYSDK_OFFSET(0x1A2592F0)
#define JSONOBJECT_GETCMD_OFFSET UNITYSDK_OFFSET(0x1A258F90)
#define JSONOBJECT_GETDICTVALUE_OFFSET UNITYSDK_OFFSET(0x1A259050)
#define JSONOBJECT_GETENUM_OFFSET UNITYSDK_OFFSET(0x1A259810)
#define JSONOBJECT_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1A2595A0)
#define JSONOBJECT_GETINT_OFFSET UNITYSDK_OFFSET(0x1A259450)
#define JSONOBJECT_GETJSONDICT_OFFSET UNITYSDK_OFFSET(0x1A259170)
#define JSONOBJECT_GETJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x1A2592A0)
#define JSONOBJECT_GETLISTJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x1A259970)
#define JSONOBJECT_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1A259700)
#define JSONOBJECT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A258EA0)
#define JSONOBJECT_KEYEXIST_OFFSET UNITYSDK_OFFSET(0x1A2590F0)
#define JSONOBJECT_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A259030)
#define JSONOBJECT_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A258F20)
#define JSONOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A258E20)
#define JSONOBJECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A258E90)
#define JSONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A258DA0)
