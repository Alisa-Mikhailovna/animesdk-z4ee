...
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GETPARENT_OFFSET UNITYSDK_OFFSET(0x3A11CA0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GETSIBLING_OFFSET UNITYSDK_OFFSET(0x3A11CD0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_COLLAPSEDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x3A11C50)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_DOCUMENT_OFFSET UNITYSDK_OFFSET(0x3A11BE0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_HASCOLLAPSEDTEXT_OFFSET UNITYSDK_OFFSET(0x3A11DA0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_HASNAMESPACEDECLS_OFFSET UNITYSDK_OFFSET(0x3A11E20)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_HASSIBLING_OFFSET UNITYSDK_OFFSET(0x3A11D90)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_ISTEXT_OFFSET UNITYSDK_OFFSET(0x3A11DB0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_ISXMLNAMESPACENODE_OFFSET UNITYSDK_OFFSET(0x3A11D00)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x3A11C00)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x3A11C30)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x3A11BA0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x3A11BC0)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x3A11B90)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_PAGEINFO_OFFSET UNITYSDK_OFFSET(0x3A11C80)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x39D0490)
#define MS_INTERNAL_XML_CACHE_XPATHNODE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x2B150)
