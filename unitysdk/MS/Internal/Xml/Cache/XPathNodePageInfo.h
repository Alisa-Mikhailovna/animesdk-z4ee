...
#define MS_INTERNAL_XML_CACHE_XPATHNODEPAGEINFO_GET_NEXTPAGE_OFFSET UNITYSDK_OFFSET(0x1CB1F0C0)
#define MS_INTERNAL_XML_CACHE_XPATHNODEPAGEINFO_GET_NODECOUNT_OFFSET UNITYSDK_OFFSET(0x1CB1F0B0)
#define MS_INTERNAL_XML_CACHE_XPATHNODEPAGEINFO_GET_PAGENUMBER_OFFSET UNITYSDK_OFFSET(0x1CB1F0A0)
