...
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_CLONE_OFFSET UNITYSDK_OFFSET(0x1CB1E080)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GETPOSITIONHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CB1EEE0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1CB1ECC0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1CB1EDC0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1CB1E180)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1CB1E1E0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1CB1E2A0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1CB1E130)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1CB1E240)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_UNDERLYINGOBJECT_OFFSET UNITYSDK_OFFSET(0x1CB1EBC0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1CB1DB20)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_HASLINEINFO_OFFSET UNITYSDK_OFFSET(0x1CB1EC70)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_ISSAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x1CB1EB50)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_MOVETOFIRSTNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1CB1E310)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_MOVETONEXTNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1CB1E850)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_MOVETOPARENT_OFFSET UNITYSDK_OFFSET(0x1CB1EA70)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB1DAA0)
