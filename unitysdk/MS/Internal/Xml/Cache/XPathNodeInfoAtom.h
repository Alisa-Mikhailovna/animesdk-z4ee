...
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_DOCUMENT_OFFSET UNITYSDK_OFFSET(0x1CB1F070)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_LINENUMBERBASE_OFFSET UNITYSDK_OFFSET(0x1CB1F080)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_LINEPOSITIONBASE_OFFSET UNITYSDK_OFFSET(0x1CB1F090)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1CB1F020)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1CB1F030)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_PAGEINFO_OFFSET UNITYSDK_OFFSET(0x1CB1F010)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_PARENTPAGE_OFFSET UNITYSDK_OFFSET(0x1CB1F060)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1CB1F040)
#define MS_INTERNAL_XML_CACHE_XPATHNODEINFOATOM_GET_SIBLINGPAGE_OFFSET UNITYSDK_OFFSET(0x1CB1F050)
