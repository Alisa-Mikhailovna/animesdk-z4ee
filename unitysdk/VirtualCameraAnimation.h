...
#define VIRTUALCAMERAANIMATION_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xDDC8560)
#define VIRTUALCAMERAANIMATION_METHOD_5_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0xDDC8630)
#define VIRTUALCAMERAANIMATION_METHOD_5_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0xDDC87A0)
#define VIRTUALCAMERAANIMATION_METHOD_5_CB47EF435F4257BC_OFFSET UNITYSDK_OFFSET(0xDDC8450)
#define VIRTUALCAMERAANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0xDDC8400)
#define VIRTUALCAMERAANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xDDC8830)
