...
#define BABYHIPPLENCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xBA91390)
#define BABYHIPPLENCONTROLLER_ENABLENECKIK_OFFSET UNITYSDK_OFFSET(0xBA91340)
#define BABYHIPPLENCONTROLLER_GETHEADTRANS_OFFSET UNITYSDK_OFFSET(0xBA90E30)
#define BABYHIPPLENCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBA916A0)
#define BABYHIPPLENCONTROLLER_METHOD_5_0BA114B592B3A582_OFFSET UNITYSDK_OFFSET(0xBA92340)
#define BABYHIPPLENCONTROLLER_METHOD_5_491027A35182E1D6_OFFSET UNITYSDK_OFFSET(0xBA91280)
#define BABYHIPPLENCONTROLLER_METHOD_5_627C7524E98F4AC5_1_OFFSET UNITYSDK_OFFSET(0xBA911E0)
#define BABYHIPPLENCONTROLLER_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xBA91160)
#define BABYHIPPLENCONTROLLER_METHOD_5_6A6A96FBD090C99D_OFFSET UNITYSDK_OFFSET(0xBA917D0)
#define BABYHIPPLENCONTROLLER_METHOD_5_DE4BD3007909A465_OFFSET UNITYSDK_OFFSET(0xBA93490)
#define BABYHIPPLENCONTROLLER_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xBA930D0)
#define BABYHIPPLENCONTROLLER_METHOD_5_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0xBA91760)
#define BABYHIPPLENCONTROLLER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xBA93560)
#define BABYHIPPLENCONTROLLER_PLAYANIMSEQ_OFFSET UNITYSDK_OFFSET(0xBA90F90)
#define BABYHIPPLENCONTROLLER_RISEHEADFORSECONDS_OFFSET UNITYSDK_OFFSET(0xBA90EF0)
#define BABYHIPPLENCONTROLLER_SETATTENTIONTRANS_OFFSET UNITYSDK_OFFSET(0xBA90E70)
#define BABYHIPPLENCONTROLLER_STARTPETTING_OFFSET UNITYSDK_OFFSET(0xBA93650)
#define BABYHIPPLENCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xBA91470)
#define BABYHIPPLENCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBA915D0)
#define BABYHIPPLENCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBA93A70)
