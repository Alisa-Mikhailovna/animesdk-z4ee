...
#define CLASS_1_42249E3CE1E8C832_GET_ABILITYCASTSYSTEM_OFFSET UNITYSDK_OFFSET(0x14A5B060)
#define CLASS_1_42249E3CE1E8C832_GET_ATTACKSYSTEM_OFFSET UNITYSDK_OFFSET(0x14A5B070)
#define CLASS_1_42249E3CE1E8C832_GET_ATTRIBUTESERVICE_OFFSET UNITYSDK_OFFSET(0x14A5B0D0)
#define CLASS_1_42249E3CE1E8C832_GET_DEATHSYSTEM_OFFSET UNITYSDK_OFFSET(0x14A5B080)
#define CLASS_1_42249E3CE1E8C832_GET_DEFAULTLOGGER_OFFSET UNITYSDK_OFFSET(0x14A5B0F0)
#define CLASS_1_42249E3CE1E8C832_GET_ENTITYFACTORYSERVICE_OFFSET UNITYSDK_OFFSET(0x14A5B0E0)
#define CLASS_1_42249E3CE1E8C832_GET_ERRORSET_OFFSET UNITYSDK_OFFSET(0x14A5B050)
#define CLASS_1_42249E3CE1E8C832_GET_FRAME_OFFSET UNITYSDK_OFFSET(0x14A5B030)
#define CLASS_1_42249E3CE1E8C832_GET_GAMESTATESYSTEM_OFFSET UNITYSDK_OFFSET(0x14A5B090)
#define CLASS_1_42249E3CE1E8C832_GET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0x14A5B010)
#define CLASS_1_42249E3CE1E8C832_GET_LOGLEVEL_OFFSET UNITYSDK_OFFSET(0x14A5B000)
#define CLASS_1_42249E3CE1E8C832_GET_SUMMONSYSTEM_OFFSET UNITYSDK_OFFSET(0x14A5B0A0)
#define CLASS_1_42249E3CE1E8C832_GET_TEAMBUFFAPPLYSYSTEM_OFFSET UNITYSDK_OFFSET(0x14A5B0B0)
#define CLASS_1_42249E3CE1E8C832_GET_TURNBASEDSYSTEM_OFFSET UNITYSDK_OFFSET(0x14A5B0C0)
#define CLASS_1_42249E3CE1E8C832_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x14A5B8B0)
#define CLASS_1_42249E3CE1E8C832_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14A5B860)
#define CLASS_1_42249E3CE1E8C832_METHOD_1_F7F80C1DB6B12DA7_OFFSET UNITYSDK_OFFSET(0x14A5B8F0)
#define CLASS_1_42249E3CE1E8C832_SET_DEFAULTLOGGER_OFFSET UNITYSDK_OFFSET(0x14A5B100)
#define CLASS_1_42249E3CE1E8C832_SET_FRAME_OFFSET UNITYSDK_OFFSET(0x14A5B040)
#define CLASS_1_42249E3CE1E8C832_SET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0x14A5B020)
#define CLASS_1_42249E3CE1E8C832__CTOR_OFFSET UNITYSDK_OFFSET(0x14A5B110)

inline static constexpr unsigned int Class_1_42249E3CE1E8C832_TypeDefinitionIndex = 73463;
...
public:
	...
	{
		return (::Class_2_4F1D8B58CEECB454**)Il2CppClass::FromTypeDefinitionIndex(Class_1_42249E3CE1E8C832_TypeDefinitionIndex)->GetStaticField(0xA2A0);
	}
	::Class_3_CC8F37580A08544F* _DeathSystem_k__BackingField; // 0x10
	::Class_3_5A62B20BB82BEBF5* _AbilityCastSystem_k__BackingField; // 0x18
	::System::Collections::Generic::HashSet_1<::System::String*>* _ErrorSet_k__BackingField; // 0x20
	::Class_3_2CC3370C8709BCC1* _TurnBasedSystem_k__BackingField; // 0x28
	::Class_3_2E396E206DB7778F* _AttributeService_k__BackingField; // 0x30
	::Class_3_E8059F7236D01C8C* _AttackSystem_k__BackingField; // 0x38
	::Class_3_153521F8C15D539F* _SummonSystem_k__BackingField; // 0x40
	::Class_3_04673DB2E35FE564* _EntityFactoryService_k__BackingField; // 0x48
	::Class_3_DCB7F8B839F0C44B_1* _TeamBuffApplySystem_k__BackingField; // 0x50
