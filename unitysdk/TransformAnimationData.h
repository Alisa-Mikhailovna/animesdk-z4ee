...
#define TRANSFORMANIMATIONDATA_METHOD_3_7900DB25C44BBC9B_OFFSET UNITYSDK_OFFSET(0xDDB4F50)
#define TRANSFORMANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDDB4FA0)
