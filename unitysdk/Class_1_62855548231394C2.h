...
#define CLASS_1_62855548231394C2_CLEAR_OFFSET UNITYSDK_OFFSET(0xB4D0A90)
#define CLASS_1_62855548231394C2_GET_CONFIGPATH_OFFSET UNITYSDK_OFFSET(0xB4D1D90)
#define CLASS_1_62855548231394C2_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB4D1DB0)
#define CLASS_1_62855548231394C2_GET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0xB4D1DF0)
#define CLASS_1_62855548231394C2_GET_LEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xB4D1DD0)
#define CLASS_1_62855548231394C2_METHOD_1_06F38768260E973C_OFFSET UNITYSDK_OFFSET(0xB4D0BB0)
#define CLASS_1_62855548231394C2_METHOD_1_1432F166180B54CA_OFFSET UNITYSDK_OFFSET(0xB4D1B40)
#define CLASS_1_62855548231394C2_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0xB4D1CB0)
#define CLASS_1_62855548231394C2_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xB4D1C30)
#define CLASS_1_62855548231394C2_METHOD_1_1D0A4C83E6604AAD_OFFSET UNITYSDK_OFFSET(0xB4D14F0)
#define CLASS_1_62855548231394C2_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xB4D1D30)
#define CLASS_1_62855548231394C2_METHOD_1_266FE4035ADE5833_OFFSET UNITYSDK_OFFSET(0xB4D0C00)
#define CLASS_1_62855548231394C2_METHOD_1_28938589EBCF7FF2_OFFSET UNITYSDK_OFFSET(0xB4D0F10)
#define CLASS_1_62855548231394C2_METHOD_1_A03206D1FB67C23B_OFFSET UNITYSDK_OFFSET(0xB4D1070)
#define CLASS_1_62855548231394C2_METHOD_1_A1AD6AA1D84454E0_OFFSET UNITYSDK_OFFSET(0xB4D0C70)
#define CLASS_1_62855548231394C2_METHOD_1_AD8218231B6C0735_OFFSET UNITYSDK_OFFSET(0xB4D0840)
#define CLASS_1_62855548231394C2_METHOD_1_CD1AE2DB330BAD04_OFFSET UNITYSDK_OFFSET(0xB4D1210)
#define CLASS_1_62855548231394C2_METHOD_1_EF0B05E8544105FB_OFFSET UNITYSDK_OFFSET(0xB4D18F0)
#define CLASS_1_62855548231394C2_METHOD_1_FE71B4E6AA99788E_OFFSET UNITYSDK_OFFSET(0xB4D0DF0)
#define CLASS_1_62855548231394C2_SET_CONFIGPATH_OFFSET UNITYSDK_OFFSET(0xB4D1DA0)
#define CLASS_1_62855548231394C2_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB4D1DC0)
#define CLASS_1_62855548231394C2_SET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0xB4D1E00)
#define CLASS_1_62855548231394C2_SET_LEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xB4D1DE0)
#define CLASS_1_62855548231394C2__CTOR_OFFSET UNITYSDK_OFFSET(0xB4D1E10)

inline static constexpr unsigned int Class_1_62855548231394C2_TypeDefinitionIndex = 72584;

class Class_1_62855548231394C2 : public ::System::Object
{
public:
	::Class_2_71ECD705C8627A9D* _CustomData_k__BackingField; // 0x10
	...
	::RPG::PoolDictionary_2<::RPG::GameCore::StringHash, ::System::Action*>* Field_1_4; // 0x30
	::RPG::GameCore::GameEntity* Field_1_5; // 0x38
	::Entitas::IEntity* Field_1_6; // 0x40
	::RPG::GameCore::LevelGraphConfig* _Config_k__BackingField; // 0x48
