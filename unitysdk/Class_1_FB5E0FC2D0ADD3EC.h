...
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_0140BBF9DD0138E3_OFFSET UNITYSDK_OFFSET(0x1531BA20)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_1337274651A1E4E8_OFFSET UNITYSDK_OFFSET(0x1531B000)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_19A2A4AB4251AD48_OFFSET UNITYSDK_OFFSET(0x1531BB30)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_1BB9E3011EADDA6B_OFFSET UNITYSDK_OFFSET(0x1531B850)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_23841F75B879070A_OFFSET UNITYSDK_OFFSET(0x1531B4F0)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_23C2C928CCAD791F_OFFSET UNITYSDK_OFFSET(0x1531AC10)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_2D54721BE7779E27_OFFSET UNITYSDK_OFFSET(0x1531B5B0)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_328A051C6835C28D_OFFSET UNITYSDK_OFFSET(0x1531AE20)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_529FAC71ABD39274_OFFSET UNITYSDK_OFFSET(0x1531BDC0)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_664222BCF379D634_OFFSET UNITYSDK_OFFSET(0x1531A890)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_69B9BDF88ECD47B5_OFFSET UNITYSDK_OFFSET(0x1531BC60)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_91C638630F1EEE79_OFFSET UNITYSDK_OFFSET(0x1531BD30)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_A48996EAFBC0AF59_OFFSET UNITYSDK_OFFSET(0x1531A900)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_BF93C93F570E4D30_OFFSET UNITYSDK_OFFSET(0x1531BE40)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_C363F4FD862A9AC6_OFFSET UNITYSDK_OFFSET(0x1531B9B0)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_D11636C6BF6D79A2_OFFSET UNITYSDK_OFFSET(0x1531B700)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_D423291144A4CA49_OFFSET UNITYSDK_OFFSET(0x1531A980)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_DEE90D3447555A55_OFFSET UNITYSDK_OFFSET(0x1531B440)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_DF4E6019F076658F_OFFSET UNITYSDK_OFFSET(0x1531B240)
#define CLASS_1_FB5E0FC2D0ADD3EC_METHOD_1_FD1EFD5A6E481F5B_OFFSET UNITYSDK_OFFSET(0x1531BCC0)
#define CLASS_1_FB5E0FC2D0ADD3EC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1531BF60)
#define CLASS_1_FB5E0FC2D0ADD3EC__CTOR_OFFSET UNITYSDK_OFFSET(0x1531BF50)
...
public:
	...
	{
		return (::RPG::GameCore::FixPoint*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB5E0FC2D0ADD3EC_TypeDefinitionIndex)->GetStaticField(0x7180);
	}
	static ::RPG::MVector3* StaticGet_Field_1_1()
	{
		return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB5E0FC2D0ADD3EC_TypeDefinitionIndex)->GetStaticField(0x7188);
	}
	static ::System::Guid* StaticGet_Field_1_2()
	{
		return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB5E0FC2D0ADD3EC_TypeDefinitionIndex)->GetStaticField(0x7194);
	}
	static ::System::Single* StaticGet_Field_1_3()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB5E0FC2D0ADD3EC_TypeDefinitionIndex)->GetStaticField(0x71A4);
	}
