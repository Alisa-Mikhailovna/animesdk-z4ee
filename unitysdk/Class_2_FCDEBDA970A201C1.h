...
#define CLASS_2_FCDEBDA970A201C1_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x14623470)
#define CLASS_2_FCDEBDA970A201C1_GET_TRANS_OFFSET UNITYSDK_OFFSET(0x14623490)
#define CLASS_2_FCDEBDA970A201C1_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x14623480)
#define CLASS_2_FCDEBDA970A201C1__CTOR_OFFSET UNITYSDK_OFFSET(0x146234F0)

inline static constexpr unsigned int Class_2_FCDEBDA970A201C1_TypeDefinitionIndex = 69106;
