...
#define IRI_DEFORMMODULECUSTOMDATA_COLLECTOBJECT_OFFSET UNITYSDK_OFFSET(0x1524F5C0)
#define IRI_DEFORMMODULECUSTOMDATA_ENCODEDATA_OFFSET UNITYSDK_OFFSET(0x15251650)
#define IRI_DEFORMMODULECUSTOMDATA_GETELEMENTMATRIXLIST_OFFSET UNITYSDK_OFFSET(0x15251100)
#define IRI_DEFORMMODULECUSTOMDATA_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1524F000)
#define IRI_DEFORMMODULECUSTOMDATA_GET_MPB_OFFSET UNITYSDK_OFFSET(0x1524EF80)
#define IRI_DEFORMMODULECUSTOMDATA_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15251810)
#define IRI_DEFORMMODULECUSTOMDATA_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x152527A0)
#define IRI_DEFORMMODULECUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x152510B0)
#define IRI_DEFORMMODULECUSTOMDATA_RESETDATA_OFFSET UNITYSDK_OFFSET(0x15250560)
#define IRI_DEFORMMODULECUSTOMDATA_SETSIZE_OFFSET UNITYSDK_OFFSET(0x152518A0)
#define IRI_DEFORMMODULECUSTOMDATA_SET_MPB_OFFSET UNITYSDK_OFFSET(0x1524EFF0)
#define IRI_DEFORMMODULECUSTOMDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x15252860)
#define IRI_DEFORMMODULECUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15252850)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(IRI_DeformModuleCustomData_TypeDefinitionIndex)->GetStaticField(0x5CC0);
	}
