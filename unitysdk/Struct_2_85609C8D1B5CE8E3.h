...
#define STRUCT_2_85609C8D1B5CE8E3_GET_BLOCKNAME_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define STRUCT_2_85609C8D1B5CE8E3_GET_REASON_OFFSET UNITYSDK_OFFSET(0x6010)
#define STRUCT_2_85609C8D1B5CE8E3__CTOR_OFFSET UNITYSDK_OFFSET(0x2CFCE60)
