...
#define AKENVIRONMENTPORTAL_GETAUXSENDVALUEFORPOSITION_OFFSET UNITYSDK_OFFSET(0x1D1BC5B0)
#define AKENVIRONMENTPORTAL_GET_BOXCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1D1BC3D0)
#define AKENVIRONMENTPORTAL_GET_ENVIRONMENTSSHAREAUXBUS_OFFSET UNITYSDK_OFFSET(0x1D1BC480)
#define AKENVIRONMENTPORTAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BCAD0)
