...
#define CLASS_1_B7D8FCA21FE37AFD_GET_BATTLETIME_OFFSET UNITYSDK_OFFSET(0x156581E0)
#define CLASS_1_B7D8FCA21FE37AFD_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x15658200)
#define CLASS_1_B7D8FCA21FE37AFD_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x15658220)
#define CLASS_1_B7D8FCA21FE37AFD_METHOD_1_AF2CFBAAD2629B3B_OFFSET UNITYSDK_OFFSET(0x156582F0)
#define CLASS_1_B7D8FCA21FE37AFD_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x15658290)
#define CLASS_1_B7D8FCA21FE37AFD_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15658240)
#define CLASS_1_B7D8FCA21FE37AFD_SET_BATTLETIME_OFFSET UNITYSDK_OFFSET(0x156581F0)
#define CLASS_1_B7D8FCA21FE37AFD_SET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x15658210)
#define CLASS_1_B7D8FCA21FE37AFD_SET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x15658230)
#define CLASS_1_B7D8FCA21FE37AFD__CTOR_OFFSET UNITYSDK_OFFSET(0x156583C0)

inline static constexpr unsigned int Class_1_B7D8FCA21FE37AFD_TypeDefinitionIndex = 73359;

class Class_1_B7D8FCA21FE37AFD : public ::System::Object
{
public:
	::System::Single _BattleTime_k__BackingField; // 0x10
	::System::Single _DeltaTime_k__BackingField; // 0x14
	::System::Single _TimeScale_k__BackingField; // 0x18
