...
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_1_OFFSET UNITYSDK_OFFSET(0x144C3F80)
#define EMISSIONOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0x144C3BC0)
#define EMISSIONOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x144C4250)
#define EMISSIONOPERATION_METHOD_3_A4A57157C453DC3A_OFFSET UNITYSDK_OFFSET(0x144C3E70)
#define EMISSIONOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x144C42C0)
#define EMISSIONOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x144C42A0)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EmissionOperation_TypeDefinitionIndex)->GetStaticField(0x8D80);
	}
