...
#define HIPPLENBUILDERRINGDETECTOR_GETCLOSESTPREDICTIONPOINT_OFFSET UNITYSDK_OFFSET(0x14BD9110)
#define HIPPLENBUILDERRINGDETECTOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x14BDB670)
#define HIPPLENBUILDERRINGDETECTOR_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x14BDBAD0)
#define HIPPLENBUILDERRINGDETECTOR_PREDICTFUTUREPOSITIONS_OFFSET UNITYSDK_OFFSET(0x14BDB3E0)
#define HIPPLENBUILDERRINGDETECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x14BDAC90)
#define HIPPLENBUILDERRINGDETECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x14BDBD30)
