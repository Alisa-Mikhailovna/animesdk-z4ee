...
#define CLASS_1_E59740C01A594634_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C771050)
#define CLASS_1_E59740C01A594634_CLONE_OFFSET UNITYSDK_OFFSET(0x1C770C00)
#define CLASS_1_E59740C01A594634_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C770DB0)
#define CLASS_1_E59740C01A594634_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C770C80)
#define CLASS_1_E59740C01A594634_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C770EA0)
#define CLASS_1_E59740C01A594634_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C7711B0)
#define CLASS_1_E59740C01A594634_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C771160)
#define CLASS_1_E59740C01A594634_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C770C50)
#define CLASS_1_E59740C01A594634_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C770AB0)
#define CLASS_1_E59740C01A594634_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C770C60)
#define CLASS_1_E59740C01A594634_METHOD_1_F64A1871C5AC5ACE_OFFSET UNITYSDK_OFFSET(0x1C770C70)
#define CLASS_1_E59740C01A594634_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C770B10)
#define CLASS_1_E59740C01A594634_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C770EF0)
#define CLASS_1_E59740C01A594634_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C770F50)
#define CLASS_1_E59740C01A594634__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C771380)
#define CLASS_1_E59740C01A594634__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C770B70)
#define CLASS_1_E59740C01A594634__CTOR_OFFSET UNITYSDK_OFFSET(0x1C770B20)
...
public:
	...
	{
		return (::Google::Protobuf::Collections::MapField_2_Codec<::System::UInt32, ::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E59740C01A594634_TypeDefinitionIndex)->GetStaticField(0x10850);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_E59740C01A594634*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_E59740C01A594634*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E59740C01A594634_TypeDefinitionIndex)->GetStaticField(0x10858);
	}
