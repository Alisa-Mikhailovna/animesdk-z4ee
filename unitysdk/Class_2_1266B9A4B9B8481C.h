...
#define CLASS_2_1266B9A4B9B8481C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15465B30)
#define CLASS_2_1266B9A4B9B8481C_METHOD_2_79329BF7EA8A0EED_OFFSET UNITYSDK_OFFSET(0x154667F0)
#define CLASS_2_1266B9A4B9B8481C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15465B70)
#define CLASS_2_1266B9A4B9B8481C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15466740)
#define CLASS_2_1266B9A4B9B8481C_TICK_OFFSET UNITYSDK_OFFSET(0x15466790)
#define CLASS_2_1266B9A4B9B8481C__CTOR_OFFSET UNITYSDK_OFFSET(0x15465B20)
