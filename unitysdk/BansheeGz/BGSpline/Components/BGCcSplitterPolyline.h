...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_ADDLISTENERS_OFFSET UNITYSDK_OFFSET(0x1A3D4D00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_ADD_CHANGEDPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A3D3D10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_DONOTOPTIMIZESTRAIGHTLINES_OFFSET UNITYSDK_OFFSET(0x1A3D3ED0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A3D4660)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_PARTSPERSECTION_OFFSET UNITYSDK_OFFSET(0x1A3D3E80)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_PARTSTOTAL_OFFSET UNITYSDK_OFFSET(0x1A3D3E30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_POINTSCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3D46F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x1A3D4CC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_POSITIONS_OFFSET UNITYSDK_OFFSET(0x1A3D4C90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_SPHERESCOLOR_OFFSET UNITYSDK_OFFSET(0x1A3D4780)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_SPHERESCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3D47A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_SPHERESSCALE_OFFSET UNITYSDK_OFFSET(0x1A3D4760)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_SPLITMODE_OFFSET UNITYSDK_OFFSET(0x1A3D3DD0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_SUPPORTHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A3D4750)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_SUPPORTHANDLES_OFFSET UNITYSDK_OFFSET(0x1A3D4740)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_USELOCAL_OFFSET UNITYSDK_OFFSET(0x1A3D3EF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_GET_WARNING_OFFSET UNITYSDK_OFFSET(0x1A3D3F10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_INVALIDATEDATA_OFFSET UNITYSDK_OFFSET(0x1A3D5D90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3D57A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_REMOVELISTENERS_OFFSET UNITYSDK_OFFSET(0x1A3D57B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_REMOVE_CHANGEDPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A3D3D70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_SET_DONOTOPTIMIZESTRAIGHTLINES_OFFSET UNITYSDK_OFFSET(0x1A3D3EE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_SET_PARTSPERSECTION_OFFSET UNITYSDK_OFFSET(0x1A3D3EA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_SET_PARTSTOTAL_OFFSET UNITYSDK_OFFSET(0x1A3D3E50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_SET_SPHERESCOLOR_OFFSET UNITYSDK_OFFSET(0x1A3D4790)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_SET_SPHERESCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3D47B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_SET_SPHERESSCALE_OFFSET UNITYSDK_OFFSET(0x1A3D4770)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_SET_SPLITMODE_OFFSET UNITYSDK_OFFSET(0x1A3D3DE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_SET_USELOCAL_OFFSET UNITYSDK_OFFSET(0x1A3D3F00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_START_OFFSET UNITYSDK_OFFSET(0x1A3D4CF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x1A3D47C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x1A3D63E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSPLITTERPOLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D6410)
