...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1A3D67D0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_LINEWIDTH_OFFSET UNITYSDK_OFFSET(0x1A3D6650)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0x1A3D69F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_PROFILEMODE_OFFSET UNITYSDK_OFFSET(0x1A3D65F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_PROFILESPLINE_OFFSET UNITYSDK_OFFSET(0x1A3D66E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_SWAPNORMALS_OFFSET UNITYSDK_OFFSET(0x1A3D6770)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_SWAPUV_OFFSET UNITYSDK_OFFSET(0x1A3D6740)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_UCOORDINATEEND_OFFSET UNITYSDK_OFFSET(0x1A3D66B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_UCOORDINATESTART_OFFSET UNITYSDK_OFFSET(0x1A3D6680)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_GET_VCOORDINATESCALE_OFFSET UNITYSDK_OFFSET(0x1A3D67A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_LINEWIDTH_OFFSET UNITYSDK_OFFSET(0x1A3D6660)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_PROFILEMODE_OFFSET UNITYSDK_OFFSET(0x1A3D6600)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_PROFILESPLINE_OFFSET UNITYSDK_OFFSET(0x1A3D66F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_SWAPNORMALS_OFFSET UNITYSDK_OFFSET(0x1A3D6780)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_SWAPUV_OFFSET UNITYSDK_OFFSET(0x1A3D6750)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_UCOORDINATEEND_OFFSET UNITYSDK_OFFSET(0x1A3D66C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_UCOORDINATESTART_OFFSET UNITYSDK_OFFSET(0x1A3D6690)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_SET_VCOORDINATESCALE_OFFSET UNITYSDK_OFFSET(0x1A3D67B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_START_OFFSET UNITYSDK_OFFSET(0x1A3D6A80)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_UPDATEREQUESTED_OFFSET UNITYSDK_OFFSET(0x1A3D8AB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x1A3D6B40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3D8D00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D8AF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCSWEEP2D__GET_ERROR_B__34_0_OFFSET UNITYSDK_OFFSET(0x1A3D8DA0)
...
namespace BansheeGz::BGSpline::Components
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::BansheeGz::BGSpline::Components::BGCcSweep2D_PositionWithU>**)Il2CppClass::FromTypeDefinitionIndex(BGCcSweep2D_TypeDefinitionIndex)->GetStaticField(0x4D500);
		}
