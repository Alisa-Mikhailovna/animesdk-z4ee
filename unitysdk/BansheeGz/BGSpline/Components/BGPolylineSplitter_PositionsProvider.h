...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_ADDFIRSTPOINTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1A3DF1A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_ADDLASTPOINTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1A3DF230)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_ADD_1_OFFSET UNITYSDK_OFFSET(0x1A3DF490)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_ADD_OFFSET UNITYSDK_OFFSET(0x1A3DF700)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1A3DE9E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_FILLIN_OFFSET UNITYSDK_OFFSET(0x1A3DF960)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_GET_DISTANCEMAX_OFFSET UNITYSDK_OFFSET(0x1A3DE9D0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_GET_DISTANCEMIN_OFFSET UNITYSDK_OFFSET(0x1A3DE9C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_INIT_OFFSET UNITYSDK_OFFSET(0x1A3DE8E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_SET_DISTANCEMAX_OFFSET UNITYSDK_OFFSET(0x1A3DE9B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER_SET_DISTANCEMIN_OFFSET UNITYSDK_OFFSET(0x1A3DE9A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E0020)
...
namespace BansheeGz::BGSpline::Components
{
	...
	public:
		...
		::System::Single distanceMax; // 0x18
		::System::Single distanceMin; // 0x1C
		::System::Boolean LastPointAdded; // 0x20
		::System::Boolean DistanceMaxConstrained; // 0x21
