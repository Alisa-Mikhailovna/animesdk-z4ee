...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERMATH_COMPLY_OFFSET UNITYSDK_OFFSET(0x1A3E0030)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERMATH_FILLINSPLITSECTION_OFFSET UNITYSDK_OFFSET(0x1A3E0040)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERMATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DE8D0)
