...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERPARTSPERSECTION_COMPLY_OFFSET UNITYSDK_OFFSET(0x1A3E0490)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERPARTSPERSECTION_FILLINSPLITSECTION_OFFSET UNITYSDK_OFFSET(0x1A3E04A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERPARTSPERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0x1A3DE8B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERPARTSPERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DE8A0)
