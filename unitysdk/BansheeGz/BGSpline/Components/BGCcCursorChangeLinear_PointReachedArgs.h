...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A3CCDC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS_GET_POINTINDEX_OFFSET UNITYSDK_OFFSET(0x1A3CCED0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS_SET_POINTINDEX_OFFSET UNITYSDK_OFFSET(0x1A3CCEE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3CCF10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSORCHANGELINEAR_POINTREACHEDARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3CCEF0)
...
namespace BansheeGz::BGSpline::Components
{
	...
	public:
		...
		{
			return (::BansheeGz::BGSpline::Components::BGCcCursorChangeLinear_PointReachedArgs**)Il2CppClass::FromTypeDefinitionIndex(BGCcCursorChangeLinear_PointReachedArgs_TypeDefinitionIndex)->GetStaticField(0x4D060);
		}
