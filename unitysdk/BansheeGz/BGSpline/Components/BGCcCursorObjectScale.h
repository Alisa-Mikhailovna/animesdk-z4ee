...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_ADD_OBJECTSCALED_OFFSET UNITYSDK_OFFSET(0x1A3CF0C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1A3CF1E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_GET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x1A3CF180)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_REMOVE_OBJECTSCALED_OFFSET UNITYSDK_OFFSET(0x1A3CF120)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_SET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x1A3CF190)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3CF280)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3CF9B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCCURSOROBJECTSCALE__GET_ERROR_B__8_0_OFFSET UNITYSDK_OFFSET(0x1A3CF9C0)
