...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCWITHCURSOROBJECT_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1A3CD3F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCWITHCURSOROBJECT_GET_OBJECTTOMANIPULATE_OFFSET UNITYSDK_OFFSET(0x1A3DE580)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCWITHCURSOROBJECT_SET_OBJECTTOMANIPULATE_OFFSET UNITYSDK_OFFSET(0x1A3DE590)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCWITHCURSOROBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3CEE90)
