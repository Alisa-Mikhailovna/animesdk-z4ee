...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_FILLINTERPOLATIONINFO_OFFSET UNITYSDK_OFFSET(0x1A3DC250)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A3DBA70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GETCURRENTSESSIONMOVEDELTA_OFFSET UNITYSDK_OFFSET(0x1A3DD3E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GETPREDICTSTEPDISTANCEDELTA_OFFSET UNITYSDK_OFFSET(0x1A3DBAB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_CURSORCHANGEMODE_OFFSET UNITYSDK_OFFSET(0x1A3DADE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1A3DAB70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x1A3DB0D0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_MOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3DAF30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_OBJECTTOMANIPULATE_OFFSET UNITYSDK_OFFSET(0x1A3DAEA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x1A3DAFC0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_OVERFLOWCONTROL_OFFSET UNITYSDK_OFFSET(0x1A3DAD80)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_ROTATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3DAF60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x1A3DB130)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1A3DB070)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x1A3DB190)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SCALEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3DAF90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x1A3DB100)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SPEEDFIELD_OFFSET UNITYSDK_OFFSET(0x1A3DAE40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SPEEDISREVERSED_OFFSET UNITYSDK_OFFSET(0x1A3DAB50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A3DAE20)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_UPVECTOR_OFFSET UNITYSDK_OFFSET(0x1A3DB010)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_GET_USEFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A3DAF00)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_LERPBOOLEN_OFFSET UNITYSDK_OFFSET(0x1A3DD1B0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_LERPQUATERNION_OFFSET UNITYSDK_OFFSET(0x1A3DCC70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_LERPVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A3DCF10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1A3DBAA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A3DD550)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SETMANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1A3DBA90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_CURSORCHANGEMODE_OFFSET UNITYSDK_OFFSET(0x1A3DADF0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_LERPSPEED_OFFSET UNITYSDK_OFFSET(0x1A3DB0E0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_MOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3DAF40)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_OBJECTTOMANIPULATE_OFFSET UNITYSDK_OFFSET(0x1A3DAEB0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x1A3DAFE0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_OVERFLOWCONTROL_OFFSET UNITYSDK_OFFSET(0x1A3DAD90)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_ROTATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3DAF70)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_ROTATIONFIELD_OFFSET UNITYSDK_OFFSET(0x1A3DB140)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_ROTATIONINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1A3DB080)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SCALEFIELD_OFFSET UNITYSDK_OFFSET(0x1A3DB1A0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SCALEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3DAFA0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SLERPSPEED_OFFSET UNITYSDK_OFFSET(0x1A3DB110)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SPEEDFIELD_OFFSET UNITYSDK_OFFSET(0x1A3DAE50)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SPEEDISREVERSED_OFFSET UNITYSDK_OFFSET(0x1A3DAB60)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A3DAE30)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_UPVECTOR_OFFSET UNITYSDK_OFFSET(0x1A3DB020)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_SET_USEFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A3DAF10)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_STEP_OFFSET UNITYSDK_OFFSET(0x1A3DB210)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_TRS_OFFSET UNITYSDK_OFFSET(0x1A3DC630)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3DB1F0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGCCTRS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DD590)
