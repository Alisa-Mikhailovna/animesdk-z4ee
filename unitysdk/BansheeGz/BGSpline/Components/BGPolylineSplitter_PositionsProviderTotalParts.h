...
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_BUILD_OFFSET UNITYSDK_OFFSET(0x1A3E04D0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_COMPLY_OFFSET UNITYSDK_OFFSET(0x1A3E04C0)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_FILLINSPLITSECTION_OFFSET UNITYSDK_OFFSET(0x1A3E1380)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS_INIT_OFFSET UNITYSDK_OFFSET(0x1A3DE880)
#define BANSHEEGZ_BGSPLINE_COMPONENTS_BGPOLYLINESPLITTER_POSITIONSPROVIDERTOTALPARTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DE870)
