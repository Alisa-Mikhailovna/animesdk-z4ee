...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDFIELDS_OFFSET UNITYSDK_OFFSET(0x1A3F05B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDFIELD_1_OFFSET UNITYSDK_OFFSET(0x1A3EABD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDFIELD_OFFSET UNITYSDK_OFFSET(0x1A3EABC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1A3E73D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINTS_2_OFFSET UNITYSDK_OFFSET(0x1A3E6C00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINTS_OFFSET UNITYSDK_OFFSET(0x1A3E6BC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINT_1_OFFSET UNITYSDK_OFFSET(0x1A3E6BB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINT_2_OFFSET UNITYSDK_OFFSET(0x1A3E6720)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1A3E66F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADD_BEFORECHANGE_OFFSET UNITYSDK_OFFSET(0x1A3E3470)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ADD_CHANGED_OFFSET UNITYSDK_OFFSET(0x1A3D0DF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLY2D_1_OFFSET UNITYSDK_OFFSET(0x1A3EC180)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLY2D_2_OFFSET UNITYSDK_OFFSET(0x1A3EC790)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLY2D_OFFSET UNITYSDK_OFFSET(0x1A3E4C60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLYSNAPPING_1_OFFSET UNITYSDK_OFFSET(0x1A3EC810)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLYSNAPPING_2_OFFSET UNITYSDK_OFFSET(0x1A3ECA40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_APPLYSNAPPING_OFFSET UNITYSDK_OFFSET(0x1A3E5040)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CACHEPOINTSWITHTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A3E8AE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A3E62D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERTGOTOINLINE_OFFSET UNITYSDK_OFFSET(0x1A3F0850)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERTINLINETOGO_OFFSET UNITYSDK_OFFSET(0x1A3F0690)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERTPOINTS_OFFSET UNITYSDK_OFFSET(0x1A3E3B80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CONVERT_OFFSET UNITYSDK_OFFSET(0x1A3EE5A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMLOCALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1A3E6230)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1A3E61A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMWORLDPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1A3E6040)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_CREATEPOINTFROMWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A3E5F30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETEFIELD_1_OFFSET UNITYSDK_OFFSET(0x1A3EAFC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETEFIELD_OFFSET UNITYSDK_OFFSET(0x1A3EAFB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_1_OFFSET UNITYSDK_OFFSET(0x1A3E76A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_2_OFFSET UNITYSDK_OFFSET(0x1A3E76B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_3_OFFSET UNITYSDK_OFFSET(0x1A3E7410)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_4_OFFSET UNITYSDK_OFFSET(0x1A3E76C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DELETE_OFFSET UNITYSDK_OFFSET(0x1A3E73F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_DESTROYIT_OFFSET UNITYSDK_OFFSET(0x1A3E65D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIREBEFORECHANGE_OFFSET UNITYSDK_OFFSET(0x1A3E3740)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIRECHANGE_OFFSET UNITYSDK_OFFSET(0x1A3E38A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIREFINALEVENT_OFFSET UNITYSDK_OFFSET(0x1A3ED930)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FOREACH_OFFSET UNITYSDK_OFFSET(0x1A3EE1D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GETFIELDSVALUES_OFFSET UNITYSDK_OFFSET(0x1A3EA660)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GETFIELD_OFFSET UNITYSDK_OFFSET(0x1A3EB540)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_CHANGELIST_OFFSET UNITYSDK_OFFSET(0x1A3E5EC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_CLOSED_OFFSET UNITYSDK_OFFSET(0x1A3E35A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_EVENTMODE_OFFSET UNITYSDK_OFFSET(0x1A3E5E80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_FIELDSCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3E3580)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_FIELDS_OFFSET UNITYSDK_OFFSET(0x1A3E3570)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_FORCECHANGEDEVENTMODE_OFFSET UNITYSDK_OFFSET(0x1A3E5C40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_IMMEDIATECHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x1A3E5EA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A3C8C30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_MODE2DON_OFFSET UNITYSDK_OFFSET(0x1A3D9080)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_MODE2D_OFFSET UNITYSDK_OFFSET(0x1A3E4C40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_POINTSCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3C78A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_POINTSMODE_OFFSET UNITYSDK_OFFSET(0x1A3E3B50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x1A3D3A10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A3E3460)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPAXIS_OFFSET UNITYSDK_OFFSET(0x1A3E5120)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A3E52F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1A3E58B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPMONITORING_OFFSET UNITYSDK_OFFSET(0x1A3E5A80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPTOBACKFACES_OFFSET UNITYSDK_OFFSET(0x1A3E56E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPTRIGGERINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3E5510)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SNAPTYPE_OFFSET UNITYSDK_OFFSET(0x1A3E4E70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_SUPRESSEVENTS_OFFSET UNITYSDK_OFFSET(0x1A3E5E20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_TRACECHANGES_OFFSET UNITYSDK_OFFSET(0x1A3E5E00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_TRANSACTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1A3ED7D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_GET_USEEVENTSARGS_OFFSET UNITYSDK_OFFSET(0x1A3E5E60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_HASFIELD_OFFSET UNITYSDK_OFFSET(0x1A3EB620)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_INDEXOFFIELDVALUE_OFFSET UNITYSDK_OFFSET(0x1A3EB700)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_INDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1A3EB470)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A3E65E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_ISGOMODE_OFFSET UNITYSDK_OFFSET(0x1A3E88E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A3EDFD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_PRIVATETRANSFORMFORPOINTADDED_OFFSET UNITYSDK_OFFSET(0x1A3EE3D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_PRIVATETRANSFORMFORPOINTREMOVED_OFFSET UNITYSDK_OFFSET(0x1A3EE500)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_PRIVATEUPDATEFIELDSVALUESINDEXES_OFFSET UNITYSDK_OFFSET(0x1A3EB7D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_REMOVE_BEFORECHANGE_OFFSET UNITYSDK_OFFSET(0x1A3E34F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_REMOVE_CHANGED_OFFSET UNITYSDK_OFFSET(0x1A3D23A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_REVERSE_OFFSET UNITYSDK_OFFSET(0x1A3E8D90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SETFIELDSVALUES_OFFSET UNITYSDK_OFFSET(0x1A3EA7C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SETPOINTSNAMES_OFFSET UNITYSDK_OFFSET(0x1A3E88F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_CLOSED_OFFSET UNITYSDK_OFFSET(0x1A3E35B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_EVENTMODE_OFFSET UNITYSDK_OFFSET(0x1A3E5E90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_FORCECHANGEDEVENTMODE_OFFSET UNITYSDK_OFFSET(0x1A3E5C50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_IMMEDIATECHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x1A3E5EB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A3EA930)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_MODE2D_OFFSET UNITYSDK_OFFSET(0x1A3E4C50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_POINTSMODE_OFFSET UNITYSDK_OFFSET(0x1A3E3B60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPAXIS_OFFSET UNITYSDK_OFFSET(0x1A3E5130)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A3E5300)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1A3E58C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPMONITORING_OFFSET UNITYSDK_OFFSET(0x1A3E5A90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPTOBACKFACES_OFFSET UNITYSDK_OFFSET(0x1A3E56F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPTRIGGERINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3E5520)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SNAPTYPE_OFFSET UNITYSDK_OFFSET(0x1A3E4E80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_SUPRESSEVENTS_OFFSET UNITYSDK_OFFSET(0x1A3E5E30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_TRACECHANGES_OFFSET UNITYSDK_OFFSET(0x1A3E5E10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SET_USEEVENTSARGS_OFFSET UNITYSDK_OFFSET(0x1A3E5E70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SNAPIT_OFFSET UNITYSDK_OFFSET(0x1A3ED540)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_START_OFFSET UNITYSDK_OFFSET(0x1A3ED8B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_SWAP_OFFSET UNITYSDK_OFFSET(0x1A3E82A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOLOCALDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A3EE0F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOLOCAL_OFFSET UNITYSDK_OFFSET(0x1A3EE010)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3EE320)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOWORLDDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A3EE160)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TOWORLD_OFFSET UNITYSDK_OFFSET(0x1A3EE080)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_TRANSACTION_OFFSET UNITYSDK_OFFSET(0x1A3EBE00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3ED8C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE__APPLY2D_B__169_0_OFFSET UNITYSDK_OFFSET(0x1A3F2E60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3F2D90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F2D00)
...
namespace BansheeGz::BGSpline::Curve
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::BansheeGz::BGSpline::Curve::BGCurvePointI*>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4DD90);
		}
		static ::System::Collections::Generic::List_1<::System::Int32>** StaticGet_pointsIndexesList()
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4DD98);
		}
		static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_raycastHitArray()
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4DDA0);
		}
		static ::Il2CppArray<::BansheeGz::BGSpline::Curve::BGCurvePointI*>** StaticGet_pointArray()
		{
			return (::Il2CppArray<::BansheeGz::BGSpline::Curve::BGCurvePointI*>**)Il2CppClass::FromTypeDefinitionIndex(BGCurve_TypeDefinitionIndex)->GetStaticField(0x4DDA8);
		}
