...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEFORMULAS_BEZIERCUBICDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1A3F7280)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEFORMULAS_BEZIERCUBIC_OFFSET UNITYSDK_OFFSET(0x1A3F6A10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEFORMULAS_BEZIERQUADRATICDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1A3F71D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEFORMULAS_BEZIERQUADRATIC_OFFSET UNITYSDK_OFFSET(0x1A3F6990)
