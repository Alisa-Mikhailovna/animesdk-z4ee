...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GETBOOL_OFFSET UNITYSDK_OFFSET(0x1A4064B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A406830)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GETCOLOR_OFFSET UNITYSDK_OFFSET(0x1A406930)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GETFIELD_OFFSET UNITYSDK_OFFSET(0x1A406A20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1A4063E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GETINT_OFFSET UNITYSDK_OFFSET(0x1A406580)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GETQUATERNION_OFFSET UNITYSDK_OFFSET(0x1A406740)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GETVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A406650)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_CONTROLFIRSTLOCALTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1A405F30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_CONTROLFIRSTLOCAL_OFFSET UNITYSDK_OFFSET(0x1A405EC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_CONTROLFIRSTWORLD_OFFSET UNITYSDK_OFFSET(0x1A406090)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_CONTROLSECONDLOCALTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1A406180)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_CONTROLSECONDLOCAL_OFFSET UNITYSDK_OFFSET(0x1A406110)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_CONTROLSECONDWORLD_OFFSET UNITYSDK_OFFSET(0x1A4062E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_CONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x1A406360)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x1A405B60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_POINTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A4063A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_POINT_OFFSET UNITYSDK_OFFSET(0x1A406C00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_POSITIONLOCALTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1A405CD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_POSITIONLOCAL_OFFSET UNITYSDK_OFFSET(0x1A405B80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_GET_POSITIONWORLD_OFFSET UNITYSDK_OFFSET(0x1A405DB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_PRIVATEINIT_OFFSET UNITYSDK_OFFSET(0x1A3F0670)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SETBOOL_OFFSET UNITYSDK_OFFSET(0x1A406AE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A406B90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x1A406BD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SETFIELD_OFFSET UNITYSDK_OFFSET(0x1A406AA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x1A406AC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SETINT_OFFSET UNITYSDK_OFFSET(0x1A406B00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SETQUATERNION_OFFSET UNITYSDK_OFFSET(0x1A406B60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SETVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A406B20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_CONTROLFIRSTLOCALTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1A405FD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_CONTROLFIRSTLOCAL_OFFSET UNITYSDK_OFFSET(0x1A405EF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_CONTROLFIRSTWORLD_OFFSET UNITYSDK_OFFSET(0x1A4060D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_CONTROLSECONDLOCALTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1A406220)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_CONTROLSECONDLOCAL_OFFSET UNITYSDK_OFFSET(0x1A406140)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_CONTROLSECONDWORLD_OFFSET UNITYSDK_OFFSET(0x1A406320)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_CONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x1A406380)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_POINTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A4063C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_POSITIONLOCALTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1A405D10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_POSITIONLOCAL_OFFSET UNITYSDK_OFFSET(0x1A405C90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_SET_POSITIONWORLD_OFFSET UNITYSDK_OFFSET(0x1A405E80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A406C10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVEPOINTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A406CC0)
