...
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A40CB80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x1A40CC20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1A40CCB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_ISSUBCLASSOF_OFFSET UNITYSDK_OFFSET(0x1A40CCD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGREFLECTIONADAPTER_ISVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A40CD70)
