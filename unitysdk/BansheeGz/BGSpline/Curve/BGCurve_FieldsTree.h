...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE_COMPLY_OFFSET UNITYSDK_OFFSET(0x1A3EB780)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1A3EB8B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3EBA10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVE_FIELDSTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EB990)
