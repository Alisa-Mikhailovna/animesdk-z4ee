...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_CONTROLHANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C290)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_CONTROLHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A40C270)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_CONTROLHANDLESTYPE_OFFSET UNITYSDK_OFFSET(0x1A40C250)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_CONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x1A40C3B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_EXISTING_OFFSET UNITYSDK_OFFSET(0x1A40C3D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_HANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A40C190)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_HANDLESTYPE_OFFSET UNITYSDK_OFFSET(0x1A40C170)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_HIDEHANDLES_OFFSET UNITYSDK_OFFSET(0x1A40BEF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_LABELCOLORSELECTED_OFFSET UNITYSDK_OFFSET(0x1A40C330)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_LABELCOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C310)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_LABELCONTROLCOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C410)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_LINECOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C210)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_NEWPOINTDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A40BF10)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_RESTRICTGIZMOZSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A40BFF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_RESTRICTGIZMOZ_OFFSET UNITYSDK_OFFSET(0x1A40BFD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x1A40C1B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCONTROLHANDLES_OFFSET UNITYSDK_OFFSET(0x1A40C230)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCONTROLLABELS_OFFSET UNITYSDK_OFFSET(0x1A40C3F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCONTROLPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A40C2F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCURVEMODE_OFFSET UNITYSDK_OFFSET(0x1A40C070)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCURVEOPTION_OFFSET UNITYSDK_OFFSET(0x1A40C090)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWCURVE_OFFSET UNITYSDK_OFFSET(0x1A40BFB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWHANDLES_OFFSET UNITYSDK_OFFSET(0x1A40C0B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWLABELS_OFFSET UNITYSDK_OFFSET(0x1A40C2B0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOINTCONTROLPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A40BF70)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOINTCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x1A40BF30)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOINTMENU_OFFSET UNITYSDK_OFFSET(0x1A40BF90)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x1A40BF50)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A40C2D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWSPHERES_OFFSET UNITYSDK_OFFSET(0x1A40C350)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A40C0D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SHOWTRANSFORMFIELD_OFFSET UNITYSDK_OFFSET(0x1A40C430)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SPHERECOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C390)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_SPHERERADIUS_OFFSET UNITYSDK_OFFSET(0x1A40C370)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_TANGENTSCOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C110)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_TANGENTSPERSECTION_OFFSET UNITYSDK_OFFSET(0x1A40C130)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_TANGENTSSIZE_OFFSET UNITYSDK_OFFSET(0x1A40C0F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_GET_VRAY_OFFSET UNITYSDK_OFFSET(0x1A40C1F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_CONTROLHANDLESCOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C2A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_CONTROLHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A40C280)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_CONTROLHANDLESTYPE_OFFSET UNITYSDK_OFFSET(0x1A40C260)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_CONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x1A40C3C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_EXISTING_OFFSET UNITYSDK_OFFSET(0x1A40C3E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_HANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A40C1A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_HANDLESTYPE_OFFSET UNITYSDK_OFFSET(0x1A40C180)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_HIDEHANDLES_OFFSET UNITYSDK_OFFSET(0x1A40BF00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_LABELCOLORSELECTED_OFFSET UNITYSDK_OFFSET(0x1A40C340)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_LABELCOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C320)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_LABELCONTROLCOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C420)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_LINECOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C220)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_NEWPOINTDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A40BF20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_RESTRICTGIZMOZ_OFFSET UNITYSDK_OFFSET(0x1A40BFE0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x1A40C1D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCONTROLHANDLES_OFFSET UNITYSDK_OFFSET(0x1A40C240)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCONTROLLABELS_OFFSET UNITYSDK_OFFSET(0x1A40C400)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCONTROLPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A40C300)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCURVEMODE_OFFSET UNITYSDK_OFFSET(0x1A40C080)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCURVEOPTION_OFFSET UNITYSDK_OFFSET(0x1A40C0A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWCURVE_OFFSET UNITYSDK_OFFSET(0x1A40BFC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWHANDLES_OFFSET UNITYSDK_OFFSET(0x1A40C0C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWLABELS_OFFSET UNITYSDK_OFFSET(0x1A40C2C0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOINTCONTROLPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A40BF80)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOINTCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x1A40BF40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOINTMENU_OFFSET UNITYSDK_OFFSET(0x1A40BFA0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x1A40BF60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A40C2E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWSPHERES_OFFSET UNITYSDK_OFFSET(0x1A40C360)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A40C0E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SHOWTRANSFORMFIELD_OFFSET UNITYSDK_OFFSET(0x1A40C440)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SPHERECOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C3A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_SPHERERADIUS_OFFSET UNITYSDK_OFFSET(0x1A40C380)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_TANGENTSCOLOR_OFFSET UNITYSDK_OFFSET(0x1A40C120)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_TANGENTSPERSECTION_OFFSET UNITYSDK_OFFSET(0x1A40C150)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_TANGENTSSIZE_OFFSET UNITYSDK_OFFSET(0x1A40C100)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS_SET_VRAY_OFFSET UNITYSDK_OFFSET(0x1A40C200)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCURVESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A40C450)
