...
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_ADDEDINEDITOR_OFFSET UNITYSDK_OFFSET(0x1A3E2BF0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_ADD_CHANGEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1A3D2610)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_CHECKREQUIRED_OFFSET UNITYSDK_OFFSET(0x1A3E2E40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_CHOSEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A3CD410)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_CONTEXTMENUITEMS_OFFSET UNITYSDK_OFFSET(0x1A3E31D0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_CONTEXTMENUVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A3E31E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_FIRECHANGEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1A3C6F40)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3E2830)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETHELPURL_OFFSET UNITYSDK_OFFSET(0x1A3E29A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETPARENTCLASS_1_OFFSET UNITYSDK_OFFSET(0x1A3E2C20)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETPARENTCLASS_OFFSET UNITYSDK_OFFSET(0x1A3E2C00)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GETPARENT_OFFSET UNITYSDK_OFFSET(0x1A3E2680)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_CCNAME_OFFSET UNITYSDK_OFFSET(0x1A3E2730)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x1A3C7820)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A3E27F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1A3E2600)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_HELPURL_OFFSET UNITYSDK_OFFSET(0x1A3E2970)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_HIDDEN_OFFSET UNITYSDK_OFFSET(0x1A3E2620)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_HIDEHANDLESININSPECTOR_OFFSET UNITYSDK_OFFSET(0x1A3E2660)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A3E25E0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_SHOWHANDLES_OFFSET UNITYSDK_OFFSET(0x1A3E2610)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_SUPPORTHANDLESSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A3E2650)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_SUPPORTHANDLES_OFFSET UNITYSDK_OFFSET(0x1A3E2640)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_GET_WARNING_OFFSET UNITYSDK_OFFSET(0x1A3E25F0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_HASERROR_OFFSET UNITYSDK_OFFSET(0x1A3E2AD0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_HASWARNING_OFFSET UNITYSDK_OFFSET(0x1A3E2B60)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_ISSINGLE_OFFSET UNITYSDK_OFFSET(0x1A3E3070)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3E2AC0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_REMOVE_CHANGEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1A3D1150)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_SETPARENT_OFFSET UNITYSDK_OFFSET(0x1A3E2670)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_SET_CCNAME_OFFSET UNITYSDK_OFFSET(0x1A3E27A0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_SET_HIDDEN_OFFSET UNITYSDK_OFFSET(0x1A3E2630)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_SHOWERROR_OFFSET UNITYSDK_OFFSET(0x1A3E3290)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_START_OFFSET UNITYSDK_OFFSET(0x1A3E2AB0)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_TRANSACTION_OFFSET UNITYSDK_OFFSET(0x1A3E3130)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC_WHYDISABLED_OFFSET UNITYSDK_OFFSET(0x1A3E3310)
#define BANSHEEGZ_BGSPLINE_CURVE_BGCC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D3C40)
