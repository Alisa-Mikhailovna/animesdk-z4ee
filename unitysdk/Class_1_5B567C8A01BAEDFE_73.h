...
#define CLASS_1_5B567C8A01BAEDFE_73_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BFBCE90)
#define CLASS_1_5B567C8A01BAEDFE_73_CLONE_OFFSET UNITYSDK_OFFSET(0x1BFBCB30)
#define CLASS_1_5B567C8A01BAEDFE_73_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BFBCC90)
#define CLASS_1_5B567C8A01BAEDFE_73_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BFBCBA0)
#define CLASS_1_5B567C8A01BAEDFE_73_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BFBCDF0)
#define CLASS_1_5B567C8A01BAEDFE_73_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BFBCEE0)
#define CLASS_1_5B567C8A01BAEDFE_73_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BFBCEB0)
#define CLASS_1_5B567C8A01BAEDFE_73_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1BFBCA80)
#define CLASS_1_5B567C8A01BAEDFE_73_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BFBCAE0)
#define CLASS_1_5B567C8A01BAEDFE_73_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BFBCE20)
#define CLASS_1_5B567C8A01BAEDFE_73_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BFBCE80)
#define CLASS_1_5B567C8A01BAEDFE_73__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BFBCF30)
#define CLASS_1_5B567C8A01BAEDFE_73__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BFBCB00)
#define CLASS_1_5B567C8A01BAEDFE_73__CTOR_OFFSET UNITYSDK_OFFSET(0x1BFBCAF0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_73*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_73_TypeDefinitionIndex)->GetStaticField(0x63F40);
	}
