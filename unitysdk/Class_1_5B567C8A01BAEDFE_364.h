...
#define CLASS_1_5B567C8A01BAEDFE_364_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C85B750)
#define CLASS_1_5B567C8A01BAEDFE_364_CLONE_OFFSET UNITYSDK_OFFSET(0x1C85B440)
#define CLASS_1_5B567C8A01BAEDFE_364_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C85B550)
#define CLASS_1_5B567C8A01BAEDFE_364_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C85B480)
#define CLASS_1_5B567C8A01BAEDFE_364_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C85B6B0)
#define CLASS_1_5B567C8A01BAEDFE_364_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C85B7A0)
#define CLASS_1_5B567C8A01BAEDFE_364_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C85B770)
#define CLASS_1_5B567C8A01BAEDFE_364_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C85B3C0)
#define CLASS_1_5B567C8A01BAEDFE_364_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C85B3F0)
#define CLASS_1_5B567C8A01BAEDFE_364_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C85B6E0)
#define CLASS_1_5B567C8A01BAEDFE_364_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C85B740)
#define CLASS_1_5B567C8A01BAEDFE_364__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C85B7F0)
#define CLASS_1_5B567C8A01BAEDFE_364__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C85B410)
#define CLASS_1_5B567C8A01BAEDFE_364__CTOR_OFFSET UNITYSDK_OFFSET(0x1C85B400)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_364*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_364_TypeDefinitionIndex)->GetStaticField(0x2AEF0);
	}
