...
#define HEIGHTMAPGENERATOR_GENERATEHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x14BCDA90)
#define HEIGHTMAPGENERATOR_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x14BCE1A0)
#define HEIGHTMAPGENERATOR_SAVETOEXR_OFFSET UNITYSDK_OFFSET(0x14BCE2D0)
#define HEIGHTMAPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x14BCE410)
