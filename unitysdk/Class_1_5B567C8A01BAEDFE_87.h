...
#define CLASS_1_5B567C8A01BAEDFE_87_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C68B960)
#define CLASS_1_5B567C8A01BAEDFE_87_CLONE_OFFSET UNITYSDK_OFFSET(0x1C68B600)
#define CLASS_1_5B567C8A01BAEDFE_87_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C68B760)
#define CLASS_1_5B567C8A01BAEDFE_87_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C68B670)
#define CLASS_1_5B567C8A01BAEDFE_87_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C68B8C0)
#define CLASS_1_5B567C8A01BAEDFE_87_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C68B9B0)
#define CLASS_1_5B567C8A01BAEDFE_87_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C68B980)
#define CLASS_1_5B567C8A01BAEDFE_87_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C68B550)
#define CLASS_1_5B567C8A01BAEDFE_87_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C68B5B0)
#define CLASS_1_5B567C8A01BAEDFE_87_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C68B8F0)
#define CLASS_1_5B567C8A01BAEDFE_87_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C68B950)
#define CLASS_1_5B567C8A01BAEDFE_87__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C68BA00)
#define CLASS_1_5B567C8A01BAEDFE_87__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C68B5D0)
#define CLASS_1_5B567C8A01BAEDFE_87__CTOR_OFFSET UNITYSDK_OFFSET(0x1C68B5C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_87*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_87_TypeDefinitionIndex)->GetStaticField(0x67670);
	}
