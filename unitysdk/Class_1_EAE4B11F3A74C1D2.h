...
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_08649C2797B37F9D_OFFSET UNITYSDK_OFFSET(0x1B0D2AB0)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_1C4DD17BCF1A0892_OFFSET UNITYSDK_OFFSET(0x1B0D2290)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_26757C45A61E50C2_OFFSET UNITYSDK_OFFSET(0x1B0D2710)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x1B0D28E0)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_AD31DD9682084C83_OFFSET UNITYSDK_OFFSET(0x1B0D2970)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_B379EB5DB4F280DB_OFFSET UNITYSDK_OFFSET(0x1B0D25A0)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x1B0D2540)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_DCE81E2468175B76_OFFSET UNITYSDK_OFFSET(0x1B0D2B00)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0x1B0D2310)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x1B0D28A0)
#define CLASS_1_EAE4B11F3A74C1D2_METHOD_1_F2E1599CBB58B20F_OFFSET UNITYSDK_OFFSET(0x1B0D2A10)
#define CLASS_1_EAE4B11F3A74C1D2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0D2E70)
...
public:
	...
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EAE4B11F3A74C1D2_TypeDefinitionIndex)->GetStaticField(0x19D30);
	}
	static ::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::PixAirTagDisplayRow*>** StaticGet_Field_1_1()
	{
		return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::CommonIndexKey, ::RPG::GameCore::PixAirTagDisplayRow*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EAE4B11F3A74C1D2_TypeDefinitionIndex)->GetStaticField(0x19D38);
	}
	static ::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>** StaticGet_Field_1_2()
	{
		return (::System::Action_1<::Class_1_7A22A3DBEEDD1F80*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EAE4B11F3A74C1D2_TypeDefinitionIndex)->GetStaticField(0x19D40);
	}
	static ::System::Byte* StaticGet_Field_1_3()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(Class_1_EAE4B11F3A74C1D2_TypeDefinitionIndex)->GetStaticField(0x5F40);
	}
	static ::System::Boolean* StaticGet_Field_1_4()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_EAE4B11F3A74C1D2_TypeDefinitionIndex)->GetStaticField(0x5F41);
	}
