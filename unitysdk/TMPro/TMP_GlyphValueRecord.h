...
#define TMPRO_TMP_GLYPHVALUERECORD_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1CF33F70)
...
#define TMPRO_TMP_GLYPHVALUERECORD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2DA1F50)
#define TMPRO_TMP_GLYPHVALUERECORD__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2DA1F50)
#define TMPRO_TMP_GLYPHVALUERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x25B50)
