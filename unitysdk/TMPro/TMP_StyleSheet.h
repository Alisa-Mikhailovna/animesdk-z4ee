...
#define TMPRO_TMP_STYLESHEET_GETSTYLE_1_OFFSET UNITYSDK_OFFSET(0x1CF54B30)
#define TMPRO_TMP_STYLESHEET_GETSTYLE_OFFSET UNITYSDK_OFFSET(0x1CF54AC0)
#define TMPRO_TMP_STYLESHEET_GET_STYLES_OFFSET UNITYSDK_OFFSET(0x1CF546A0)
#define TMPRO_TMP_STYLESHEET_LOADSTYLEDICTIONARYINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CF546C0)
#define TMPRO_TMP_STYLESHEET_REFRESHSTYLES_OFFSET UNITYSDK_OFFSET(0x1CF54BC0)
#define TMPRO_TMP_STYLESHEET_RESET_OFFSET UNITYSDK_OFFSET(0x1CF546B0)
#define TMPRO_TMP_STYLESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF54BD0)
