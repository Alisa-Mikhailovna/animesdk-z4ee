...
#define TMPRO_TMP_TEXTELEMENT_GET_ELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1CF75F40)
#define TMPRO_TMP_TEXTELEMENT_GET_GLYPHINDEX_OFFSET UNITYSDK_OFFSET(0x1CF75FB0)
#define TMPRO_TMP_TEXTELEMENT_GET_GLYPH_OFFSET UNITYSDK_OFFSET(0x1CF75F90)
#define TMPRO_TMP_TEXTELEMENT_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x1CF75FD0)
#define TMPRO_TMP_TEXTELEMENT_GET_TEXTASSET_OFFSET UNITYSDK_OFFSET(0x1CF75F70)
#define TMPRO_TMP_TEXTELEMENT_GET_UNICODE_OFFSET UNITYSDK_OFFSET(0x1CF75F50)
#define TMPRO_TMP_TEXTELEMENT_SET_GLYPHINDEX_OFFSET UNITYSDK_OFFSET(0x1CF75FC0)
#define TMPRO_TMP_TEXTELEMENT_SET_GLYPH_OFFSET UNITYSDK_OFFSET(0x1CF75FA0)
#define TMPRO_TMP_TEXTELEMENT_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x1CF75FE0)
#define TMPRO_TMP_TEXTELEMENT_SET_TEXTASSET_OFFSET UNITYSDK_OFFSET(0x1CF75F80)
#define TMPRO_TMP_TEXTELEMENT_SET_UNICODE_OFFSET UNITYSDK_OFFSET(0x1CF75F60)
#define TMPRO_TMP_TEXTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF75FF0)
