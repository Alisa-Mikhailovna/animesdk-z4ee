...
#define TMPRO_MATERIALREFERENCE_ADDMATERIALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1CF17C70)
#define TMPRO_MATERIALREFERENCE_ADDMATERIALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1CF17A70)
#define TMPRO_MATERIALREFERENCE_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1CF17990)
#define TMPRO_MATERIALREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x3A20A90)
