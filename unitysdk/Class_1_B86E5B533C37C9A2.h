...
#define CLASS_1_B86E5B533C37C9A2_EXECUTE_OFFSET UNITYSDK_OFFSET(0x146C8960)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_00DC6C482249EA10_OFFSET UNITYSDK_OFFSET(0x146C8C70)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_06F38768260E973C_OFFSET UNITYSDK_OFFSET(0x146C89E0)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x146CA320)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_23F0308C0AC7B833_OFFSET UNITYSDK_OFFSET(0x146C9C40)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_49B8153CFD5162A1_OFFSET UNITYSDK_OFFSET(0x146C9A90)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_5225617AE7948A03_OFFSET UNITYSDK_OFFSET(0x146C9E20)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_65DCE21F154236CC_OFFSET UNITYSDK_OFFSET(0x146C93B0)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_96FAC2A4E1D5B4D2_1_OFFSET UNITYSDK_OFFSET(0x146C9610)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_96FAC2A4E1D5B4D2_OFFSET UNITYSDK_OFFSET(0x146C9550)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_A4F31A90D3DD82B7_1_OFFSET UNITYSDK_OFFSET(0x146C9270)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_A4F31A90D3DD82B7_OFFSET UNITYSDK_OFFSET(0x146C9130)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_A91086AED8314DB5_OFFSET UNITYSDK_OFFSET(0x146C90E0)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_B36FFC55D6D55CBF_OFFSET UNITYSDK_OFFSET(0x146C9AF0)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_B5C4FD5BAAB2273E_OFFSET UNITYSDK_OFFSET(0x146CA100)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_C081D0F1BA12AC56_OFFSET UNITYSDK_OFFSET(0x146C9BC0)
#define CLASS_1_B86E5B533C37C9A2_METHOD_1_DC55CFF2DCF45E33_OFFSET UNITYSDK_OFFSET(0x146C96D0)
#define CLASS_1_B86E5B533C37C9A2_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x146C9040)
#define CLASS_1_B86E5B533C37C9A2__CTOR_OFFSET UNITYSDK_OFFSET(0x146C87A0)

inline static constexpr unsigned int Class_1_B86E5B533C37C9A2_TypeDefinitionIndex = 73824;
