...
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_A_OFFSET UNITYSDK_OFFSET(0x6320)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_BACK_OFFSET UNITYSDK_OFFSET(0x1E130)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_B_OFFSET UNITYSDK_OFFSET(0x1E7F0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_LEFTSHOULDER_OFFSET UNITYSDK_OFFSET(0x6E20)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_LEFTSTICK_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_RIGHTSHOULDER_OFFSET UNITYSDK_OFFSET(0x6E30)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_RIGHTSTICK_OFFSET UNITYSDK_OFFSET(0x14EDE0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_START_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_X_OFFSET UNITYSDK_OFFSET(0x1D2A0)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS_GET_Y_OFFSET UNITYSDK_OFFSET(0x5DC70)
#define XINPUTDOTNETPURE_GAMEPADBUTTONS__CTOR_OFFSET UNITYSDK_OFFSET(0x39C92F0)
