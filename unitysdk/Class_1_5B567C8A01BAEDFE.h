...
#define CLASS_1_5B567C8A01BAEDFE_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C09CFA0)
#define CLASS_1_5B567C8A01BAEDFE_CLONE_OFFSET UNITYSDK_OFFSET(0x1C08A950)
#define CLASS_1_5B567C8A01BAEDFE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C09CDD0)
#define CLASS_1_5B567C8A01BAEDFE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C09CCE0)
#define CLASS_1_5B567C8A01BAEDFE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C08BAC0)
#define CLASS_1_5B567C8A01BAEDFE_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C09CFC0)
#define CLASS_1_5B567C8A01BAEDFE_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C08D140)
#define CLASS_1_5B567C8A01BAEDFE_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C09CC40)
#define CLASS_1_5B567C8A01BAEDFE_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C09CCA0)
#define CLASS_1_5B567C8A01BAEDFE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C09CF30)
#define CLASS_1_5B567C8A01BAEDFE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C09CF90)
#define CLASS_1_5B567C8A01BAEDFE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C09D010)
#define CLASS_1_5B567C8A01BAEDFE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C09CCB0)
#define CLASS_1_5B567C8A01BAEDFE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C08D130)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_TypeDefinitionIndex)->GetStaticField(0x4CD0);
	}
