...
#define CLASS_1_C3A033C60E10FDC7_CLEAR_OFFSET UNITYSDK_OFFSET(0xBA12EF0)
#define CLASS_1_C3A033C60E10FDC7__CTOR_OFFSET UNITYSDK_OFFSET(0xBA12F40)
...
public:
	...
	::RPG::GameCore::VCameraNoiseChange* Field_1_2; // 0x20
