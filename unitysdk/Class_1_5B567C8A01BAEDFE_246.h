...
#define CLASS_1_5B567C8A01BAEDFE_246_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C6A7020)
#define CLASS_1_5B567C8A01BAEDFE_246_CLONE_OFFSET UNITYSDK_OFFSET(0x1C6A6CC0)
#define CLASS_1_5B567C8A01BAEDFE_246_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C6A6E20)
#define CLASS_1_5B567C8A01BAEDFE_246_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C6A6D30)
#define CLASS_1_5B567C8A01BAEDFE_246_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C6A6F80)
#define CLASS_1_5B567C8A01BAEDFE_246_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C6A7070)
#define CLASS_1_5B567C8A01BAEDFE_246_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C6A7040)
#define CLASS_1_5B567C8A01BAEDFE_246_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C6A6C10)
#define CLASS_1_5B567C8A01BAEDFE_246_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C6A6C70)
#define CLASS_1_5B567C8A01BAEDFE_246_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C6A6FB0)
#define CLASS_1_5B567C8A01BAEDFE_246_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C6A7010)
#define CLASS_1_5B567C8A01BAEDFE_246__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6A70C0)
#define CLASS_1_5B567C8A01BAEDFE_246__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6A6C90)
#define CLASS_1_5B567C8A01BAEDFE_246__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6A6C80)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_246*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_246_TypeDefinitionIndex)->GetStaticField(0x68370);
	}
