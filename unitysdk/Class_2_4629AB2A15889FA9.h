...
#define CLASS_2_4629AB2A15889FA9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x154C77C0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_04614C8577B9CBA7_OFFSET UNITYSDK_OFFSET(0x154CB640)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_0C0A3218A683115F_OFFSET UNITYSDK_OFFSET(0x154CA000)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_1B3D8773D1869301_OFFSET UNITYSDK_OFFSET(0x154C7B60)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_2233B4E123DC1DDC_OFFSET UNITYSDK_OFFSET(0x154CA5D0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_2417C60F698028CC_OFFSET UNITYSDK_OFFSET(0x154CB580)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_3135A9ED542D4190_OFFSET UNITYSDK_OFFSET(0x154CA950)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_39B767C5ADFEA9A8_OFFSET UNITYSDK_OFFSET(0x154CAD00)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x154CAB50)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_8CB9BDF340E2FC64_OFFSET UNITYSDK_OFFSET(0x154C7830)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_90EC931103FB6F31_OFFSET UNITYSDK_OFFSET(0x154CBE60)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_99F4734274043F32_OFFSET UNITYSDK_OFFSET(0x154CB120)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_9E035F4BAE220AC2_OFFSET UNITYSDK_OFFSET(0x154CABD0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_A44A18C9451109E4_OFFSET UNITYSDK_OFFSET(0x154C7BB0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_A874B8D50E15661E_OFFSET UNITYSDK_OFFSET(0x154C75B0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_AC66361361CE73AE_OFFSET UNITYSDK_OFFSET(0x154C7750)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_ACF26DFF0EC20E9A_OFFSET UNITYSDK_OFFSET(0x154CA7C0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x154CBE50)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_C15A9F455BC461DE_OFFSET UNITYSDK_OFFSET(0x154C7E30)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0x154CBBC0)
#define CLASS_2_4629AB2A15889FA9_METHOD_2_FD2A5158841A130C_OFFSET UNITYSDK_OFFSET(0x154CBDB0)
#define CLASS_2_4629AB2A15889FA9__CTOR_OFFSET UNITYSDK_OFFSET(0x154CBEC0)
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::AttachPointSet*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4629AB2A15889FA9_TypeDefinitionIndex)->GetStaticField(0x33D10);
	}
	static ::System::Collections::Generic::List_1<::UnityEngine::MonoBehaviour*>** StaticGet_Field_2_1()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::MonoBehaviour*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4629AB2A15889FA9_TypeDefinitionIndex)->GetStaticField(0x33D18);
	}
	static ::System::Collections::Generic::List_1<::UnityEngine::Renderer*>** StaticGet_Field_2_2()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Renderer*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4629AB2A15889FA9_TypeDefinitionIndex)->GetStaticField(0x33D20);
	}
	::RPG::GameCore::GameEntity* Field_2_3; // 0x18
	::RPG::GameCore::CharacterOutfitComponent_CharacterOutfitInstance* Field_2_4; // 0x20
	::RPG::Client::FollowPointMapping* Field_2_5; // 0x28
	::UnityEngine::GameObject* Field_2_6; // 0x30
	::Il2CppArray<::RPG::Client::MonoEffectPluginCharaMaterialBlock*>* Field_2_7; // 0x38
	::UnityEngine::Transform* Field_2_8; // 0x40
	::Class_1_1342B57709FD7AC5* Field_2_9; // 0x48
	::System::Collections::Generic::List_1<::UnityEngine::Material*>* Field_2_10; // 0x50
	::UnityEngine::Animator* Field_2_11; // 0x58
	::System::Collections::Generic::List_1<::UnityEngine::Renderer*>* Field_2_12; // 0x60
	::Class_1_A0302E9AE0B8A2B9* Field_2_13; // 0x68
	::RPG::Client::AttachPointMapping* Field_2_14; // 0x70
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_4629AB2A15889FA9_METHOD_2_1B3D8773D1869301_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_4629AB2A15889FA9_METHOD_2_8CB9BDF340E2FC64_OFFSET))(this);
	}
