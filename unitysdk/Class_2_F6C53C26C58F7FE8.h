...
#define CLASS_2_F6C53C26C58F7FE8_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB984D40)
#define CLASS_2_F6C53C26C58F7FE8_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB984D80)
#define CLASS_2_F6C53C26C58F7FE8_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB984E80)
#define CLASS_2_F6C53C26C58F7FE8_TICK_OFFSET UNITYSDK_OFFSET(0xB984ED0)
#define CLASS_2_F6C53C26C58F7FE8__CTOR_OFFSET UNITYSDK_OFFSET(0xB984D30)
