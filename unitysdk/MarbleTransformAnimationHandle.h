...
#define MARBLETRANSFORMANIMATIONHANDLE_ANIMRESET_OFFSET UNITYSDK_OFFSET(0xB1EB6C0)
#define MARBLETRANSFORMANIMATIONHANDLE_ANIMSTOPPLAYING_OFFSET UNITYSDK_OFFSET(0xB1E9420)
#define MARBLETRANSFORMANIMATIONHANDLE_BEGINTESTANIM_OFFSET UNITYSDK_OFFSET(0xB1EA630)
#define MARBLETRANSFORMANIMATIONHANDLE_BREAKACITVEANIMLOOP_OFFSET UNITYSDK_OFFSET(0xB1EAD60)
#define MARBLETRANSFORMANIMATIONHANDLE_CHECKANIMPLAYING_1_OFFSET UNITYSDK_OFFSET(0xB1EB8F0)
#define MARBLETRANSFORMANIMATIONHANDLE_CHECKANIMPLAYING_OFFSET UNITYSDK_OFFSET(0xB1EB8B0)
#define MARBLETRANSFORMANIMATIONHANDLE_FINDPOINT_OFFSET UNITYSDK_OFFSET(0xB1EA490)
#define MARBLETRANSFORMANIMATIONHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0xB1E8B00)
#define MARBLETRANSFORMANIMATIONHANDLE_LOOPBREAKTEST_OFFSET UNITYSDK_OFFSET(0xB1EAD10)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_142C1F65818B83FC_OFFSET UNITYSDK_OFFSET(0xB1EAEC0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0xB1E9DD0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_906BACE05D971306_OFFSET UNITYSDK_OFFSET(0xB1EA6B0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_BA5CD3C0B7AB5DDD_OFFSET UNITYSDK_OFFSET(0xB1E9470)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_C0AC14CF94069BDD_OFFSET UNITYSDK_OFFSET(0xB1EB950)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_C2D6D64ED269E595_OFFSET UNITYSDK_OFFSET(0xB1EB0F0)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_DD09D1BAD4E36891_OFFSET UNITYSDK_OFFSET(0xB1EBB50)
#define MARBLETRANSFORMANIMATIONHANDLE_METHOD_5_FC16CB424C896DFF_OFFSET UNITYSDK_OFFSET(0xB1EA210)
#define MARBLETRANSFORMANIMATIONHANDLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB1EC1D0)
#define MARBLETRANSFORMANIMATIONHANDLE_START_OFFSET UNITYSDK_OFFSET(0xB1E8AB0)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_1_OFFSET UNITYSDK_OFFSET(0xB1EB060)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_2_OFFSET UNITYSDK_OFFSET(0xB1EC040)
#define MARBLETRANSFORMANIMATIONHANDLE_TRIGGERTRANSFORMANIMATION_OFFSET UNITYSDK_OFFSET(0xB1EAFF0)
#define MARBLETRANSFORMANIMATIONHANDLE_UPDATE_OFFSET UNITYSDK_OFFSET(0xB1E8DA0)
#define MARBLETRANSFORMANIMATIONHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0xB1EC480)
