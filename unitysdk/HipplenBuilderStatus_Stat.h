...
#define HIPPLENBUILDERSTATUS_STAT_GET_GRADECONFIGS_OFFSET UNITYSDK_OFFSET(0x14BDD3B0)
#define HIPPLENBUILDERSTATUS_STAT_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x14BDD360)
#define HIPPLENBUILDERSTATUS_STAT_GET_NAMENEG_OFFSET UNITYSDK_OFFSET(0x14BDD0B0)
#define HIPPLENBUILDERSTATUS_STAT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x14BDD060)
#define HIPPLENBUILDERSTATUS_STAT_GET_NEXTGRADEMIN_OFFSET UNITYSDK_OFFSET(0x14BDD150)
#define HIPPLENBUILDERSTATUS_STAT_GET_NORMALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x14BDD400)
#define HIPPLENBUILDERSTATUS_STAT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x14BDD100)
#define HIPPLENBUILDERSTATUS_STAT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x14BDC5A0)
#define HIPPLENBUILDERSTATUS_STAT_GET_WARNINGVALUE_OFFSET UNITYSDK_OFFSET(0x14BDD310)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_AB01D2A3604A75E7_OFFSET UNITYSDK_OFFSET(0x14BDD1A0)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_B06FAFF37803F837_OFFSET UNITYSDK_OFFSET(0x14BDCD20)
#define HIPPLENBUILDERSTATUS_STAT_METHOD_1_E89B5E85E1E3F103_OFFSET UNITYSDK_OFFSET(0x14BDC5F0)
#define HIPPLENBUILDERSTATUS_STAT__CTOR_OFFSET UNITYSDK_OFFSET(0x14BDC580)
