...
#define CLASS_1_5B567C8A01BAEDFE_120_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C72A020)
#define CLASS_1_5B567C8A01BAEDFE_120_CLONE_OFFSET UNITYSDK_OFFSET(0x1C729CC0)
#define CLASS_1_5B567C8A01BAEDFE_120_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C729E20)
#define CLASS_1_5B567C8A01BAEDFE_120_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C729D30)
#define CLASS_1_5B567C8A01BAEDFE_120_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C729F80)
#define CLASS_1_5B567C8A01BAEDFE_120_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C72A070)
#define CLASS_1_5B567C8A01BAEDFE_120_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C72A040)
#define CLASS_1_5B567C8A01BAEDFE_120_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C729C10)
#define CLASS_1_5B567C8A01BAEDFE_120_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C729C70)
#define CLASS_1_5B567C8A01BAEDFE_120_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C729FB0)
#define CLASS_1_5B567C8A01BAEDFE_120_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C72A010)
#define CLASS_1_5B567C8A01BAEDFE_120__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C72A0C0)
#define CLASS_1_5B567C8A01BAEDFE_120__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C729C90)
#define CLASS_1_5B567C8A01BAEDFE_120__CTOR_OFFSET UNITYSDK_OFFSET(0x1C729C80)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_120*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_120_TypeDefinitionIndex)->GetStaticField(0x2DAF0);
	}
