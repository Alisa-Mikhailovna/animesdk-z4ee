...
#define CLASS_1_FB7D93F2E04FE1B6_EXECUTE_OFFSET UNITYSDK_OFFSET(0x152AF370)
#define CLASS_1_FB7D93F2E04FE1B6_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x152AE890)
#define CLASS_1_FB7D93F2E04FE1B6_LATEEXECUTE_OFFSET UNITYSDK_OFFSET(0x152B4D00)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x152AE820)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_18188D67877F2AFB_OFFSET UNITYSDK_OFFSET(0x152B6960)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_4988666BECC8CE44_OFFSET UNITYSDK_OFFSET(0x152B7F60)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_52DC9CC69AE40BFA_OFFSET UNITYSDK_OFFSET(0x152B12F0)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_7566FC86813F9825_OFFSET UNITYSDK_OFFSET(0x152B5400)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_8058D67C1D5ABB82_OFFSET UNITYSDK_OFFSET(0x152B72C0)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_91B48388F4BFAF76_OFFSET UNITYSDK_OFFSET(0x152B2550)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_A2172401030892FD_OFFSET UNITYSDK_OFFSET(0x152B4D50)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0x152B82B0)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_D258B8E464ACA319_OFFSET UNITYSDK_OFFSET(0x152B8110)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_D4CB96FDA16D54B7_OFFSET UNITYSDK_OFFSET(0x152B11C0)
#define CLASS_1_FB7D93F2E04FE1B6_METHOD_1_F79C6BF0DB0D13B3_OFFSET UNITYSDK_OFFSET(0x152B6B00)
#define CLASS_1_FB7D93F2E04FE1B6_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x152AEEA0)
#define CLASS_1_FB7D93F2E04FE1B6__CCTOR_OFFSET UNITYSDK_OFFSET(0x152B8660)
#define CLASS_1_FB7D93F2E04FE1B6__CTOR_OFFSET UNITYSDK_OFFSET(0x152AE550)
#define CLASS_1_FB7D93F2E04FE1B6___ADD2DBRICKTUTORIALTRIGGER_B__16_0_OFFSET UNITYSDK_OFFSET(0x152B86B0)

inline static constexpr unsigned int Class_1_FB7D93F2E04FE1B6_TypeDefinitionIndex = 72870;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB7D93F2E04FE1B6_TypeDefinitionIndex)->GetStaticField(0x6A50);
	}
	static ::System::Int32* StaticGet_Field_1_1()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB7D93F2E04FE1B6_TypeDefinitionIndex)->GetStaticField(0x6A54);
	}
	static ::System::Boolean* StaticGet_Field_1_2()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_FB7D93F2E04FE1B6_TypeDefinitionIndex)->GetStaticField(0x6A58);
	}
	// static const ::System::String* Field_1_3; // 0x0
	::System::Collections::Generic::Dictionary_2<::Class_2_56DCA1B58073717B*, ::Class_1_FB7D93F2E04FE1B6_Class_1_F2D17E30E1E79D69*>* Field_1_4; // 0x10
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameViewCoord, ::System::Collections::Generic::List_1<::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGameView*>*>* Field_1_5; // 0x18
	::Class_3_001D9EA49F6215B6* Field_1_6; // 0x20
	::System::Collections::Generic::Dictionary_2<::Class_2_2661F5CE5402F421*, ::System::Tuple_2<::UnityEngine::GameObject*, ::BansheeGz::BGSpline::Curve::BGCurve*>*>* Field_1_7; // 0x28
	::Class_1_2CDF619C23140440* Field_1_8; // 0x30
	::UnityEngine::Transform* Field_1_9; // 0x38
	::System::Collections::Generic::List_1<::FiveDimRenderingPanelRuntime*>* Field_1_10; // 0x40
	::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelRuntimeInspector* Field_1_11; // 0x48
	::System::Collections::Generic::Dictionary_2<::Class_2_2661F5CE5402F421*, ::Class_2_2661F5CE5402F421*>* Field_1_12; // 0x50
	::UnityEngine::Coroutine* Field_1_13; // 0x58
	::System::Collections::Generic::List_1<::UnityEngine::Coroutine*>* Field_1_14; // 0x60
	::UnityEngine::Transform* Field_1_15; // 0x68
	::System::Collections::Generic::HashSet_1<::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelStructGameView*>* Field_1_16; // 0x70
	::RPG::Client::LittleGame::FourRotateVoxel::FourRotateVoxelGlobalData* Field_1_17; // 0x78
