...
#define CLASS_1_5B567C8A01BAEDFE_278_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C706C10)
#define CLASS_1_5B567C8A01BAEDFE_278_CLONE_OFFSET UNITYSDK_OFFSET(0x1C706900)
#define CLASS_1_5B567C8A01BAEDFE_278_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C706A10)
#define CLASS_1_5B567C8A01BAEDFE_278_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C706940)
#define CLASS_1_5B567C8A01BAEDFE_278_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C706B70)
#define CLASS_1_5B567C8A01BAEDFE_278_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C706C60)
#define CLASS_1_5B567C8A01BAEDFE_278_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C706C30)
#define CLASS_1_5B567C8A01BAEDFE_278_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C706880)
#define CLASS_1_5B567C8A01BAEDFE_278_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C7068B0)
#define CLASS_1_5B567C8A01BAEDFE_278_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C706BA0)
#define CLASS_1_5B567C8A01BAEDFE_278_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C706C00)
#define CLASS_1_5B567C8A01BAEDFE_278__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C706CB0)
#define CLASS_1_5B567C8A01BAEDFE_278__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C7068D0)
#define CLASS_1_5B567C8A01BAEDFE_278__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7068C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_278*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_278_TypeDefinitionIndex)->GetStaticField(0x6BC0);
	}
