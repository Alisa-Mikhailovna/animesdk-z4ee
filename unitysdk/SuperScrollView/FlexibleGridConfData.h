...
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_CANNAVI_OFFSET UNITYSDK_OFFSET(0xDD6B890)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ISPCSIZE_OFFSET UNITYSDK_OFFSET(0xDD6B650)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ISREDEFINESIZE_OFFSET UNITYSDK_OFFSET(0xDD6B6D0)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ISTITLE_OFFSET UNITYSDK_OFFSET(0xDD6B880)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_ITEMSIZE_OFFSET UNITYSDK_OFFSET(0xDD6B720)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET_SIZEDELTA_OFFSET UNITYSDK_OFFSET(0xDD6B960)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA_GET__RTF_OFFSET UNITYSDK_OFFSET(0xDD6B570)
#define SUPERSCROLLVIEW_FLEXIBLEGRIDCONFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDD6B9D0)
