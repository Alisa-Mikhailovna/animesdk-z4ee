...
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_CLEARFADEIN_OFFSET UNITYSDK_OFFSET(0xDD84450)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_BUTTONOBJECT_OFFSET UNITYSDK_OFFSET(0xDD6E290)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_CACHEANIMATORBUTTON_OFFSET UNITYSDK_OFFSET(0xDD6EBD0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_CACHEDRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xDD6E9B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0xDD88140)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_FADEINANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0xDD886F0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_FADEINLENGTH_OFFSET UNITYSDK_OFFSET(0xDD84BC0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_ISINITHANDLERCALLED_OFFSET UNITYSDK_OFFSET(0xDD881A0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_ISRECYCLED_OFFSET UNITYSDK_OFFSET(0xDD88760)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_ISUSEANIMATION_OFFSET UNITYSDK_OFFSET(0xDD84B50)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_ITEMCREATEDCHECKFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0xDD880E0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0xDD88180)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_ITEMINDEX_OFFSET UNITYSDK_OFFSET(0xDD88160)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_ITEMPREFABNAME_OFFSET UNITYSDK_OFFSET(0xDD88100)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_NEXTITEM_OFFSET UNITYSDK_OFFSET(0xDD88200)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_PARENTGRIDVIEW_OFFSET UNITYSDK_OFFSET(0xDD881C0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_PREVITEM_OFFSET UNITYSDK_OFFSET(0xDD881E0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_ROW_OFFSET UNITYSDK_OFFSET(0xDD88120)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_USERINTDATA1_OFFSET UNITYSDK_OFFSET(0xDD88060)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_USERINTDATA2_OFFSET UNITYSDK_OFFSET(0xDD88080)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_USEROBJECTDATA_OFFSET UNITYSDK_OFFSET(0xDD88040)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_USERSTRINGDATA1_OFFSET UNITYSDK_OFFSET(0xDD880A0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_GET_USERSTRINGDATA2_OFFSET UNITYSDK_OFFSET(0xDD880C0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_INITFADEHANDLER_OFFSET UNITYSDK_OFFSET(0xDD882E0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDD88710)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDD88670)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_ONNEW_OFFSET UNITYSDK_OFFSET(0xDD85410)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0xDD84EF0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xDD84C20)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SETHEIGHT_OFFSET UNITYSDK_OFFSET(0xDD80EC0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SETHIDE_OFFSET UNITYSDK_OFFSET(0xDD854F0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SETSHOW_OFFSET UNITYSDK_OFFSET(0xDD85590)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SETWIDTH_OFFSET UNITYSDK_OFFSET(0xDD80E10)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_COLUMN_OFFSET UNITYSDK_OFFSET(0xDD88150)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_FADEINANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0xDD88700)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_ISINITHANDLERCALLED_OFFSET UNITYSDK_OFFSET(0xDD881B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_ISRECYCLED_OFFSET UNITYSDK_OFFSET(0xDD88770)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_ITEMCREATEDCHECKFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0xDD880F0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0xDD88190)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_ITEMINDEX_OFFSET UNITYSDK_OFFSET(0xDD88170)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_ITEMPREFABNAME_OFFSET UNITYSDK_OFFSET(0xDD88110)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_NEXTITEM_OFFSET UNITYSDK_OFFSET(0xDD88210)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_PARENTGRIDVIEW_OFFSET UNITYSDK_OFFSET(0xDD881D0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_PREVITEM_OFFSET UNITYSDK_OFFSET(0xDD881F0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_ROW_OFFSET UNITYSDK_OFFSET(0xDD88130)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_USERINTDATA1_OFFSET UNITYSDK_OFFSET(0xDD88070)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_USERINTDATA2_OFFSET UNITYSDK_OFFSET(0xDD88090)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_USEROBJECTDATA_OFFSET UNITYSDK_OFFSET(0xDD88050)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_USERSTRINGDATA1_OFFSET UNITYSDK_OFFSET(0xDD880B0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_SET_USERSTRINGDATA2_OFFSET UNITYSDK_OFFSET(0xDD880D0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_START_OFFSET UNITYSDK_OFFSET(0xDD88220)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0xDD88440)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM_UPDATE_OFFSET UNITYSDK_OFFSET(0xDD883E0)
#define SUPERSCROLLVIEW_LOOPGRIDVIEWITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xDD88780)
