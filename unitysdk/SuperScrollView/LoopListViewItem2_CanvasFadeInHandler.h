...
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_CLEAR_OFFSET UNITYSDK_OFFSET(0xDDA2330)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_DESTROY_OFFSET UNITYSDK_OFFSET(0xDDA2FD0)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_GET_ANIMATIONFADEVALID_OFFSET UNITYSDK_OFFSET(0xDDA3060)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_HIDE_OFFSET UNITYSDK_OFFSET(0xDDA1EF0)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_INIT_OFFSET UNITYSDK_OFFSET(0xDDA1E00)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0xDDA2550)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xDDA2210)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_SHOW_OFFSET UNITYSDK_OFFSET(0xDDA30D0)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER_TICKFADEIN_OFFSET UNITYSDK_OFFSET(0xDDA1B10)
#define SUPERSCROLLVIEW_LOOPLISTVIEWITEM2_CANVASFADEINHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDDA1DF0)
