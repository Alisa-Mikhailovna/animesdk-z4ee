...
#define CLASS_1_CF8B0DC37DFDE560_GET_ISSTARTED_OFFSET UNITYSDK_OFFSET(0xCDBCC40)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_03B1BF2F2F8589FD_OFFSET UNITYSDK_OFFSET(0xCDBEEB0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_15F4E4F86182D646_OFFSET UNITYSDK_OFFSET(0xCDBE170)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_18A7BF8B592973BC_OFFSET UNITYSDK_OFFSET(0xCDBD9E0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_30E1BE7387CD0701_OFFSET UNITYSDK_OFFSET(0xCDBEB30)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_37B9CAEB4EAE67B7_OFFSET UNITYSDK_OFFSET(0xCDBEB90)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0xCDBD2F0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_49B11BA78A61F1C1_OFFSET UNITYSDK_OFFSET(0xCDBE310)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_61C37AF771938E69_OFFSET UNITYSDK_OFFSET(0xCDBC980)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_726BE9283E00DAB1_OFFSET UNITYSDK_OFFSET(0xCDBD7D0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_820BC74DFBBFC7F7_OFFSET UNITYSDK_OFFSET(0xCDBCCE0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_8B6F11557B375B74_OFFSET UNITYSDK_OFFSET(0xCDBD480)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_8CB3ABD41F954D02_OFFSET UNITYSDK_OFFSET(0xCDBE390)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_8D61BE16C9463302_OFFSET UNITYSDK_OFFSET(0xCDBD040)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_9AB045C54EC604F2_OFFSET UNITYSDK_OFFSET(0xCDBD640)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xCDBCC60)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_AA957E371B77E633_OFFSET UNITYSDK_OFFSET(0xCDBDB50)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xCDBDD10)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0xCDBDDF0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCDBD600)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_D41B9F644D365890_OFFSET UNITYSDK_OFFSET(0xCDBD2A0)
#define CLASS_1_CF8B0DC37DFDE560_METHOD_1_DEAC86EB2AD5D389_OFFSET UNITYSDK_OFFSET(0xCDBD4F0)
#define CLASS_1_CF8B0DC37DFDE560_SET_ISSTARTED_OFFSET UNITYSDK_OFFSET(0xCDBCC50)
#define CLASS_1_CF8B0DC37DFDE560__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBCCB0)
...
public:
	...
	{
		return (::RPG::Client::Billboard::BillboardNotifyParam**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CF8B0DC37DFDE560_TypeDefinitionIndex)->GetStaticField(0x2FF10);
	}
	static ::System::UInt32* StaticGet_Field_1_1()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_CF8B0DC37DFDE560_TypeDefinitionIndex)->GetStaticField(0x8270);
	}
	// static const ::System::String* Field_1_2; // 0x0
	::Class_1_EED1D87C81F7C2A6* Field_1_3; // 0x10
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_1_4; // 0x18
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::GameEntity*, ::Class_1_CF8B0DC37DFDE560_Struct_2_15DAEDDD7C0F5F31>* Field_1_5; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::GameCore::GameEntity*>* Field_1_6; // 0x28
	::RPG::GameCore::MunicipalChatConfig* Field_1_7; // 0x30
	::System::Collections::Generic::List_1<::Class_1_EED1D87C81F7C2A6*>* Field_1_8; // 0x38
	::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* Field_1_9; // 0x40
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_EED1D87C81F7C2A6*>* Field_1_10; // 0x48
