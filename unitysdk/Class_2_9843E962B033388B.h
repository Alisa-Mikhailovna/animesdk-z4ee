...
#define CLASS_2_9843E962B033388B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14CEBF10)
#define CLASS_2_9843E962B033388B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14CEBFA0)
#define CLASS_2_9843E962B033388B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14CEBF50)
#define CLASS_2_9843E962B033388B_TICK_OFFSET UNITYSDK_OFFSET(0x14CEC420)
#define CLASS_2_9843E962B033388B__CCTOR_OFFSET UNITYSDK_OFFSET(0x14CEC610)
#define CLASS_2_9843E962B033388B__CTOR_OFFSET UNITYSDK_OFFSET(0x14CEBEF0)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_2_9843E962B033388B_TypeDefinitionIndex)->GetStaticField(0x10C10);
	}
	::RPG::GameCore::SwitchEffectBattleArea* Field_2_1; // 0x18
	::RPG::GameCore::TaskContext* Field_2_2; // 0x20
	::Class_1_D70A30D666F20D90* Field_2_3; // 0x28
