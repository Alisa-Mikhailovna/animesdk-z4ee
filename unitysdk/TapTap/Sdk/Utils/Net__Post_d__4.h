...
#define TAPTAP_SDK_UTILS_NET__POST_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CD94260)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD94B20)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CD94B80)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CD94B30)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD94250)
#define TAPTAP_SDK_UTILS_NET__POST_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD928B0)
