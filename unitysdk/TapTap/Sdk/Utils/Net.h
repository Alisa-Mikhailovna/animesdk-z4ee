...
#define TAPTAP_SDK_UTILS_NET_DICTTOQUERYSTRING_OFFSET UNITYSDK_OFFSET(0x1CD92D00)
#define TAPTAP_SDK_UTILS_NET_GETASYNC_OFFSET UNITYSDK_OFFSET(0x1CD8B810)
#define TAPTAP_SDK_UTILS_NET_GETRESPONSECODE_OFFSET UNITYSDK_OFFSET(0x1CD928C0)
#define TAPTAP_SDK_UTILS_NET_GET_OFFSET UNITYSDK_OFFSET(0x1CD92830)
#define TAPTAP_SDK_UTILS_NET_PARSERESPONSECODE_OFFSET UNITYSDK_OFFSET(0x1CD92B20)
#define TAPTAP_SDK_UTILS_NET_PARSEURL_OFFSET UNITYSDK_OFFSET(0x1CD93270)
#define TAPTAP_SDK_UTILS_NET_POSTASYNC_OFFSET UNITYSDK_OFFSET(0x1CD8B900)
#define TAPTAP_SDK_UTILS_NET_POST_OFFSET UNITYSDK_OFFSET(0x1CD927C0)
#define TAPTAP_SDK_UTILS_NET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD93A40)
