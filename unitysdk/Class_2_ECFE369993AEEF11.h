...
#define CLASS_2_ECFE369993AEEF11_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB0C04F0)
#define CLASS_2_ECFE369993AEEF11_METHOD_2_39A444F69D3AA07E_OFFSET UNITYSDK_OFFSET(0xB0BEAA0)
#define CLASS_2_ECFE369993AEEF11_METHOD_2_55304E8C404EC03A_OFFSET UNITYSDK_OFFSET(0xB0C0570)
#define CLASS_2_ECFE369993AEEF11_METHOD_2_6E98250C115AC456_OFFSET UNITYSDK_OFFSET(0xB0C0BB0)
#define CLASS_2_ECFE369993AEEF11_METHOD_2_8B5E3014AFF7F8EA_OFFSET UNITYSDK_OFFSET(0xB0BEB20)
#define CLASS_2_ECFE369993AEEF11_METHOD_2_E824431C22EF9361_1_OFFSET UNITYSDK_OFFSET(0xB0C1440)
#define CLASS_2_ECFE369993AEEF11_METHOD_2_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0xB0C10D0)
#define CLASS_2_ECFE369993AEEF11_METHOD_2_FD6AF0F9AA9298B1_OFFSET UNITYSDK_OFFSET(0xB0C0810)
#define CLASS_2_ECFE369993AEEF11__CCTOR_OFFSET UNITYSDK_OFFSET(0xB0C1E20)
#define CLASS_2_ECFE369993AEEF11__CTOR_OFFSET UNITYSDK_OFFSET(0xB0C1E10)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_ECFE369993AEEF11_TypeDefinitionIndex)->GetStaticField(0x14190);
	}
	::System::Collections::Generic::List_1<::Class_2_ECFE369993AEEF11_Class_1_DC1725B707DAACCF*>* Field_2_1; // 0x18
	::UnityEngine::Transform* Field_2_2; // 0x20
	::RPG::Client::CharacterEffect* Field_2_3; // 0x28
	::System::Collections::Generic::List_1<::Class_2_ECFE369993AEEF11_Class_1_64797359E139FAEF*>* Field_2_4; // 0x30
