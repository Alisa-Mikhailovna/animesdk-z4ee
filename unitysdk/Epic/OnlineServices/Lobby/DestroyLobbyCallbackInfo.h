...
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xAC41A30)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAC419F0)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0xAC41A10)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAC419D0)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAC41EC0)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAC41A00)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0xAC41A20)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xAC41A50)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAC419E0)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAC41FE0)
