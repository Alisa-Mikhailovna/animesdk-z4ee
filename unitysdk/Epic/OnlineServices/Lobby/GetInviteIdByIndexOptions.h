...
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xAC42900)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC428E0)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xAC42910)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC428F0)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC42920)
