...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETMAXMEMBERSOPTIONS_GET_MAXMEMBERS_OFFSET UNITYSDK_OFFSET(0xAC53880)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETMAXMEMBERSOPTIONS_SET_MAXMEMBERS_OFFSET UNITYSDK_OFFSET(0xAC53890)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYMODIFICATIONSETMAXMEMBERSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC538A0)
