...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONS_GET_LOBBYMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0xAC5E140)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONS_SET_LOBBYMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0xAC5E150)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC5E160)
