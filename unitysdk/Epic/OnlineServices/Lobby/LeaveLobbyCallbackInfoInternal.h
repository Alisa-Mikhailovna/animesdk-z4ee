...
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x6010)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x4F710)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x4F820)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
