...
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC59AB0)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC59AE0)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC59AA0)
#define EPIC_ONLINESERVICES_LOBBY_ONUPDATELOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC599B0)
