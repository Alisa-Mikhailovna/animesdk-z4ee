...
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONS_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0xAC42CE0)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC42D00)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONS_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0xAC42CF0)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC42D10)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC42D20)
