...
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0xAC45220)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC45240)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAC45260)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0xAC45230)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC45250)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAC45270)
#define EPIC_ONLINESERVICES_LOBBY_KICKMEMBEROPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC45280)
