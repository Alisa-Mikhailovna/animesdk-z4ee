...
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC58130)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC58160)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC58120)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC58030)
