...
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC589B0)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC589E0)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC589A0)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC588B0)
