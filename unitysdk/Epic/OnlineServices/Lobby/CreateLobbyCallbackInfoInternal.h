...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x6010)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x4CE90)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x4CFA0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
