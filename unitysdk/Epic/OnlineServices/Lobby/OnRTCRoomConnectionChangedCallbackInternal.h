...
#define EPIC_ONLINESERVICES_LOBBY_ONRTCROOMCONNECTIONCHANGEDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC59510)
#define EPIC_ONLINESERVICES_LOBBY_ONRTCROOMCONNECTIONCHANGEDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC59560)
#define EPIC_ONLINESERVICES_LOBBY_ONRTCROOMCONNECTIONCHANGEDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC59500)
#define EPIC_ONLINESERVICES_LOBBY_ONRTCROOMCONNECTIONCHANGEDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAC59490)
