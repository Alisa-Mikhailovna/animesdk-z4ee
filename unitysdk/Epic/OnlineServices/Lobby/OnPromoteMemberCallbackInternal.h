...
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC590D0)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC59120)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC590C0)
#define EPIC_ONLINESERVICES_LOBBY_ONPROMOTEMEMBERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAC59050)
