...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x4D630)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4D5B0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_ALLOWINVITES_OFFSET UNITYSDK_OFFSET(0x4D1C0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_BUCKETID_OFFSET UNITYSDK_OFFSET(0x4D270)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_DISABLEHOSTMIGRATION_OFFSET UNITYSDK_OFFSET(0x4D320)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_ENABLERTCROOM_OFFSET UNITYSDK_OFFSET(0x4D3D0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x4D4F0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_LOCALRTCOPTIONS_OFFSET UNITYSDK_OFFSET(0x4D480)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x4D050)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_MAXLOBBYMEMBERS_OFFSET UNITYSDK_OFFSET(0x2A90)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x4D5A0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_PERMISSIONLEVEL_OFFSET UNITYSDK_OFFSET(0x6E40)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYOPTIONSINTERNAL_SET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0x4D110)
