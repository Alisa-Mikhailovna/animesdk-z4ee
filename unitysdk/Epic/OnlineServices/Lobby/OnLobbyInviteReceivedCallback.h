...
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYINVITERECEIVEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC58790)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYINVITERECEIVEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC587C0)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYINVITERECEIVEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC58780)
#define EPIC_ONLINESERVICES_LOBBY_ONLOBBYINVITERECEIVEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC58690)
