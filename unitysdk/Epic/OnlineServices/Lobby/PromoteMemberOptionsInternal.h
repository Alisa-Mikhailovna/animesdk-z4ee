...
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x564D0)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x56450)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x56210)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x562C0)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x56440)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBEROPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x56380)
