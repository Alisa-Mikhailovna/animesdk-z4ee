...
#define EPIC_ONLINESERVICES_LOBBY_REJECTINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x570F0)
#define EPIC_ONLINESERVICES_LOBBY_REJECTINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x57070)
#define EPIC_ONLINESERVICES_LOBBY_REJECTINVITEOPTIONSINTERNAL_SET_INVITEID_OFFSET UNITYSDK_OFFSET(0x56EF0)
#define EPIC_ONLINESERVICES_LOBBY_REJECTINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x56FA0)
#define EPIC_ONLINESERVICES_LOBBY_REJECTINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x57060)
