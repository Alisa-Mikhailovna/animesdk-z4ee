...
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x4EF30)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4EEB0)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_LOBBYDETAILSHANDLE_OFFSET UNITYSDK_OFFSET(0x4EC00)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_LOCALRTCOPTIONS_OFFSET UNITYSDK_OFFSET(0x4EE30)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x4ECC0)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x4EEA0)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0x4ED80)
