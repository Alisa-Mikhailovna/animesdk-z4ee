...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILSGETMEMBERBYINDEXOPTIONS_GET_MEMBERINDEX_OFFSET UNITYSDK_OFFSET(0xAC48EA0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILSGETMEMBERBYINDEXOPTIONS_SET_MEMBERINDEX_OFFSET UNITYSDK_OFFSET(0xAC48EB0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILSGETMEMBERBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC48EC0)
