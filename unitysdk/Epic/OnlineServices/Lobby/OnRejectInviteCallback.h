...
#define EPIC_ONLINESERVICES_LOBBY_ONREJECTINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC59670)
#define EPIC_ONLINESERVICES_LOBBY_ONREJECTINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC596A0)
#define EPIC_ONLINESERVICES_LOBBY_ONREJECTINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC59660)
#define EPIC_ONLINESERVICES_LOBBY_ONREJECTINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC59570)
