...
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x576A0)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x57620)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x573E0)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x57490)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x57610)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x57550)
