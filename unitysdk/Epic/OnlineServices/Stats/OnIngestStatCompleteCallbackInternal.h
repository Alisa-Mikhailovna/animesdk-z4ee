...
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA39B00)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA39B50)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA39AF0)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAA39A80)
