...
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS_GET_STATINDEX_OFFSET UNITYSDK_OFFSET(0xAA37600)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAA375E0)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS_SET_STATINDEX_OFFSET UNITYSDK_OFFSET(0xAA37610)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAA375F0)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA37620)
