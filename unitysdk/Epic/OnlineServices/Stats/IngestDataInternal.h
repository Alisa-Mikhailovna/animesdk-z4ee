...
#define EPIC_ONLINESERVICES_STATS_INGESTDATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BFB0)
#define EPIC_ONLINESERVICES_STATS_INGESTDATAINTERNAL_GET_INGESTAMOUNT_OFFSET UNITYSDK_OFFSET(0x6E20)
#define EPIC_ONLINESERVICES_STATS_INGESTDATAINTERNAL_GET_STATNAME_OFFSET UNITYSDK_OFFSET(0x1BD70)
#define EPIC_ONLINESERVICES_STATS_INGESTDATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1BFA0)
#define EPIC_ONLINESERVICES_STATS_INGESTDATAINTERNAL_SET_INGESTAMOUNT_OFFSET UNITYSDK_OFFSET(0x2A90)
#define EPIC_ONLINESERVICES_STATS_INGESTDATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1BED0)
#define EPIC_ONLINESERVICES_STATS_INGESTDATAINTERNAL_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x1BE20)
