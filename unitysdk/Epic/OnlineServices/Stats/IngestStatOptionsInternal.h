...
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C580)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1C500)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C250)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1C4F0)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_STATS_OFFSET UNITYSDK_OFFSET(0x1C310)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1C430)
