...
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CD70)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1CCF0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1CA70)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1C920)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1CCE0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1C9E0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_STATNAMES_OFFSET UNITYSDK_OFFSET(0x1CB00)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x1CC20)
