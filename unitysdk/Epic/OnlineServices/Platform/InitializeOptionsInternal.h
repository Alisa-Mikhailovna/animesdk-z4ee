...
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x60DD0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x60D50)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_ALLOCATEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x94F0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x60D40)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_OVERRIDETHREADAFFINITY_OFFSET UNITYSDK_OFFSET(0x60CD0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_PRODUCTNAME_OFFSET UNITYSDK_OFFSET(0x60B60)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_PRODUCTVERSION_OFFSET UNITYSDK_OFFSET(0x60C10)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_REALLOCATEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0xB7C0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_RELEASEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x2B160)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_SYSTEMINITIALIZEOPTIONS_OFFSET UNITYSDK_OFFSET(0x60CC0)
