...
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x62440)
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_GET_XAUDIO29DLLPATH_OFFSET UNITYSDK_OFFSET(0x62200)
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x62430)
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x62360)
#define EPIC_ONLINESERVICES_PLATFORM_WINDOWSRTCOPTIONSPLATFORMSPECIFICOPTIONSINTERNAL_SET_XAUDIO29DLLPATH_OFFSET UNITYSDK_OFFSET(0x622B0)
