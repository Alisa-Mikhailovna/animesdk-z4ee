...
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x601D0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x60150)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_SET_ALLOCATEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x94F0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x60140)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_SET_OVERRIDETHREADAFFINITY_OFFSET UNITYSDK_OFFSET(0x600D0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_SET_PRODUCTNAME_OFFSET UNITYSDK_OFFSET(0x5FF00)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_SET_PRODUCTVERSION_OFFSET UNITYSDK_OFFSET(0x5FFB0)
...
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_SET_RELEASEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x2B160)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_SET_RESERVED_OFFSET UNITYSDK_OFFSET(0x2C8C0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSINTERNAL_SET_SYSTEMINITIALIZEOPTIONS_OFFSET UNITYSDK_OFFSET(0x60060)
