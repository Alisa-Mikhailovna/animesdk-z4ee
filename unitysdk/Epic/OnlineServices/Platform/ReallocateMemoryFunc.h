...
#define EPIC_ONLINESERVICES_PLATFORM_REALLOCATEMEMORYFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC7AE80)
#define EPIC_ONLINESERVICES_PLATFORM_REALLOCATEMEMORYFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC7AF10)
#define EPIC_ONLINESERVICES_PLATFORM_REALLOCATEMEMORYFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC7AE60)
#define EPIC_ONLINESERVICES_PLATFORM_REALLOCATEMEMORYFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0xAC7ADF0)
