...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x6010)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x65D20)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILECALLBACKINFOINTERNAL_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x65EA0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x65E30)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
