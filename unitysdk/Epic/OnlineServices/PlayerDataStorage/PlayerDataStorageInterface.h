...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_COPYFILEMETADATAATINDEX_OFFSET UNITYSDK_OFFSET(0xAC83A70)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_COPYFILEMETADATABYFILENAME_OFFSET UNITYSDK_OFFSET(0xAC83D20)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_DELETECACHE_OFFSET UNITYSDK_OFFSET(0xAC83F20)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_DELETEFILE_OFFSET UNITYSDK_OFFSET(0xAC84190)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_DUPLICATEFILE_OFFSET UNITYSDK_OFFSET(0xAC84370)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_GETFILEMETADATACOUNT_OFFSET UNITYSDK_OFFSET(0xAC84550)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONDELETECACHECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC83210)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONDELETEFILECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC832B0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONDUPLICATEFILECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC83350)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONFILETRANSFERPROGRESSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC833F0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONQUERYFILECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC834C0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONQUERYFILELISTCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC83560)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONREADFILECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC83600)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONREADFILEDATACALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC836A0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONWRITEFILECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC83790)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_ONWRITEFILEDATACALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC83830)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_QUERYFILELIST_OFFSET UNITYSDK_OFFSET(0xAC84920)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_QUERYFILE_OFFSET UNITYSDK_OFFSET(0xAC84740)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_READFILE_OFFSET UNITYSDK_OFFSET(0xAC84B80)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE_WRITEFILE_OFFSET UNITYSDK_OFFSET(0xAC85180)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC83A60)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_PLAYERDATASTORAGEINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC83A50)
