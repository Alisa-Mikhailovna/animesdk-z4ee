...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x664A0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_GET_FILETRANSFERPROGRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0xAC850E0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_GET_READFILEDATACALLBACK_OFFSET UNITYSDK_OFFSET(0xAC85040)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x66420)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x66360)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x662A0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x66410)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_READCHUNKLENGTHBYTES_OFFSET UNITYSDK_OFFSET(0xC4B0)
...
namespace Epic::OnlineServices::PlayerDataStorage
{
	...
	struct alignas(8) ReadFileOptionsInternal
	{
		...
		{
			return (::Epic::OnlineServices::PlayerDataStorage::OnFileTransferProgressCallbackInternal**)Il2CppClass::FromTypeDefinitionIndex(ReadFileOptionsInternal_TypeDefinitionIndex)->GetStaticField(0x3200);
		}
		static ::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallbackInternal** StaticGet_s_ReadFileDataCallback()
		{
			return (::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallbackInternal**)Il2CppClass::FromTypeDefinitionIndex(ReadFileOptionsInternal_TypeDefinitionIndex)->GetStaticField(0x3208);
		}
