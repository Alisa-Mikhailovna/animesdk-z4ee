...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ADDNOTIFYCLIENTACTIONREQUIRED_OFFSET UNITYSDK_OFFSET(0xAA13790)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ADDNOTIFYCLIENTAUTHSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0xAA13A40)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ADDNOTIFYMESSAGETOCLIENT_OFFSET UNITYSDK_OFFSET(0xAA13CF0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_BEGINSESSION_OFFSET UNITYSDK_OFFSET(0xAA13FA0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ENDSESSION_OFFSET UNITYSDK_OFFSET(0xAA14100)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_GETPROTECTMESSAGEOUTPUTLENGTH_OFFSET UNITYSDK_OFFSET(0xAA14340)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGEVENT_OFFSET UNITYSDK_OFFSET(0xAA144B0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGGAMEROUNDEND_OFFSET UNITYSDK_OFFSET(0xAA146E0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGGAMEROUNDSTART_OFFSET UNITYSDK_OFFSET(0xAA14840)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERDESPAWN_OFFSET UNITYSDK_OFFSET(0xAA149A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERREVIVE_OFFSET UNITYSDK_OFFSET(0xAA14B00)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERSPAWN_OFFSET UNITYSDK_OFFSET(0xAA14C60)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERTAKEDAMAGE_OFFSET UNITYSDK_OFFSET(0xAA14DC0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERTICK_OFFSET UNITYSDK_OFFSET(0xAA14F20)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERUSEABILITY_OFFSET UNITYSDK_OFFSET(0xAA15080)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERUSEWEAPON_OFFSET UNITYSDK_OFFSET(0xAA151E0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ONCLIENTACTIONREQUIREDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAA13590)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAA13630)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ONMESSAGETOCLIENTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAA136D0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_PROTECTMESSAGE_OFFSET UNITYSDK_OFFSET(0xAA153E0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_RECEIVEMESSAGEFROMCLIENT_OFFSET UNITYSDK_OFFSET(0xAA15780)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REGISTERCLIENT_OFFSET UNITYSDK_OFFSET(0xAA159B0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xAA15B10)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REMOVENOTIFYCLIENTACTIONREQUIRED_OFFSET UNITYSDK_OFFSET(0xAA15C70)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REMOVENOTIFYCLIENTAUTHSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0xAA15D50)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REMOVENOTIFYMESSAGETOCLIENT_OFFSET UNITYSDK_OFFSET(0xAA15E30)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_SETCLIENTDETAILS_OFFSET UNITYSDK_OFFSET(0xAA15F10)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_SETCLIENTNETWORKSTATE_OFFSET UNITYSDK_OFFSET(0xAA16070)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_SETGAMESESSIONID_OFFSET UNITYSDK_OFFSET(0xAA16280)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_UNPROTECTMESSAGE_OFFSET UNITYSDK_OFFSET(0xAA16480)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_UNREGISTERCLIENT_OFFSET UNITYSDK_OFFSET(0xAA16820)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAA13780)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xAA13770)
