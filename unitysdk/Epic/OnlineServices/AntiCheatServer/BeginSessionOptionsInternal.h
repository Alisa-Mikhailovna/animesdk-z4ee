...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEA80)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xEA00)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_ENABLEGAMEPLAYDATA_OFFSET UNITYSDK_OFFSET(0xE880)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xE930)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xE9F0)
...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_SERVERNAME_OFFSET UNITYSDK_OFFSET(0xE7D0)
