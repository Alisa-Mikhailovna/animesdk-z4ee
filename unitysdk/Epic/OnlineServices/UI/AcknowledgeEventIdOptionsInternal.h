...
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x20970)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x20950)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_RESULT_OFFSET UNITYSDK_OFFSET(0x2A90)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_UIEVENTID_OFFSET UNITYSDK_OFFSET(0x94F0)
