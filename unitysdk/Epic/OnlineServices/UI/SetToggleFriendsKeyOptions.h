...
#define EPIC_ONLINESERVICES_UI_SETTOGGLEFRIENDSKEYOPTIONS_GET_KEYCOMBINATION_OFFSET UNITYSDK_OFFSET(0xAA46B60)
#define EPIC_ONLINESERVICES_UI_SETTOGGLEFRIENDSKEYOPTIONS_SET_KEYCOMBINATION_OFFSET UNITYSDK_OFFSET(0xAA46B70)
#define EPIC_ONLINESERVICES_UI_SETTOGGLEFRIENDSKEYOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA46B80)
