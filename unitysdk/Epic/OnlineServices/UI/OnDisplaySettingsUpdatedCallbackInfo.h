...
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA45B00)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA45AA0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_GET_ISEXCLUSIVEINPUT_OFFSET UNITYSDK_OFFSET(0xAA45AE0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xAA45AC0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAA46120)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA45AB0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_ISEXCLUSIVEINPUT_OFFSET UNITYSDK_OFFSET(0xAA45AF0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0xAA45AD0)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xAA45B10)
#define EPIC_ONLINESERVICES_UI_ONDISPLAYSETTINGSUPDATEDCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAA46240)
