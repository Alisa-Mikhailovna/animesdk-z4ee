...
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA46720)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA46770)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA46710)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAA466A0)
