...
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA455C0)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA455D0)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA455E0)
