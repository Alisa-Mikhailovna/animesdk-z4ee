...
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA46500)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA46550)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA464F0)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAA46480)
