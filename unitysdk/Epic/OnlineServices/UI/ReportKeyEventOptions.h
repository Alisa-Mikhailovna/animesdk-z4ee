...
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONS_GET_PLATFORMSPECIFICINPUTDATA_OFFSET UNITYSDK_OFFSET(0xAA46900)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONS_SET_PLATFORMSPECIFICINPUTDATA_OFFSET UNITYSDK_OFFSET(0xAA46910)
#define EPIC_ONLINESERVICES_UI_REPORTKEYEVENTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA46920)
