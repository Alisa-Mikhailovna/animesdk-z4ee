...
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x20C00)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x20BF0)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x20A60)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x20B20)
