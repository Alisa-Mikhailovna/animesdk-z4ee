...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_GETPROTECTMESSAGEOUTPUTLENGTHOPTIONS_GET_DATALENGTHBYTES_OFFSET UNITYSDK_OFFSET(0xAA05D80)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_GETPROTECTMESSAGEOUTPUTLENGTHOPTIONS_SET_DATALENGTHBYTES_OFFSET UNITYSDK_OFFSET(0xAA05D90)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_GETPROTECTMESSAGEOUTPUTLENGTHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA05DA0)
