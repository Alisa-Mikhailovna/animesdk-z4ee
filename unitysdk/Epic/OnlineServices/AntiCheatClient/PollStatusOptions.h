...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONS_GET_OUTMESSAGELENGTH_OFFSET UNITYSDK_OFFSET(0xAA06C40)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONS_SET_OUTMESSAGELENGTH_OFFSET UNITYSDK_OFFSET(0xAA06C50)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA06C60)
