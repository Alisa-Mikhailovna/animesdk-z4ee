...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDEXTERNALINTEGRITYCATALOGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83E0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDEXTERNALINTEGRITYCATALOGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x83D0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDEXTERNALINTEGRITYCATALOGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8300)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ADDEXTERNALINTEGRITYCATALOGOPTIONSINTERNAL_SET_PATHTOBINFILE_OFFSET UNITYSDK_OFFSET(0x8250)
