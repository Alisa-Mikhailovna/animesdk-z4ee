...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONS_GET_DATA_OFFSET UNITYSDK_OFFSET(0xAA06D20)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONS_GET_OUTBUFFERSIZEBYTES_OFFSET UNITYSDK_OFFSET(0xAA06D40)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONS_SET_DATA_OFFSET UNITYSDK_OFFSET(0xAA06D30)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONS_SET_OUTBUFFERSIZEBYTES_OFFSET UNITYSDK_OFFSET(0xAA06D50)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA06D60)
