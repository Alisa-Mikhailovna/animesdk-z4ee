...
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA24D60)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA24D90)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA24D50)
#define EPIC_ONLINESERVICES_SESSIONS_ONREGISTERPLAYERSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAA24C60)
