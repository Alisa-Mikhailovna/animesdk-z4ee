...
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD60)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1ACE0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1ACD0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_PLAYERSTOUNREGISTER_OFFSET UNITYSDK_OFFSET(0x1AC60)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1ABB0)
