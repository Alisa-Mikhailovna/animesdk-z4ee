...
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B4E0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1B4D0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1B400)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_SET_SESSIONMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x1B340)
