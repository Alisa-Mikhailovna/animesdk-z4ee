...
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A9F0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x1A9E0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x1A910)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x1A860)
