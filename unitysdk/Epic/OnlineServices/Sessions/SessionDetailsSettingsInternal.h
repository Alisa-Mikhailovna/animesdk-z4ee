...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16C30)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_ALLOWJOININPROGRESS_OFFSET UNITYSDK_OFFSET(0x168E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_BUCKETID_OFFSET UNITYSDK_OFFSET(0x16780)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_INVITESALLOWED_OFFSET UNITYSDK_OFFSET(0x16A40)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_NUMPUBLICCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x6E20)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_PERMISSIONLEVEL_OFFSET UNITYSDK_OFFSET(0x6320)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x16BB0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_ALLOWJOININPROGRESS_OFFSET UNITYSDK_OFFSET(0x16990)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_BUCKETID_OFFSET UNITYSDK_OFFSET(0x16830)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_INVITESALLOWED_OFFSET UNITYSDK_OFFSET(0x16AF0)
...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x16BA0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_PERMISSIONLEVEL_OFFSET UNITYSDK_OFFSET(0xC4B0)
