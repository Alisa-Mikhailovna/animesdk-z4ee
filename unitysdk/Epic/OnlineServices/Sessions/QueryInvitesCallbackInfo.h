...
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA25DC0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA25D80)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA25DA0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA25D60)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAA261C0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA25D90)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA25DB0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xAA25DE0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA25D70)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAA262E0)
