...
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA266F0)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA266D0)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA266B0)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAA26990)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA266E0)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xAA26710)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA266C0)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAA26AB0)
