...
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xAA225A0)
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA22580)
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xAA225B0)
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA22590)
#define EPIC_ONLINESERVICES_SESSIONS_GETINVITEIDBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA225C0)
