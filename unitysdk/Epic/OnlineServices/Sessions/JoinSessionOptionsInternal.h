...
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x148C0)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x14840)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x146C0)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x14830)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0x14780)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_SESSIONHANDLE_OFFSET UNITYSDK_OFFSET(0x14600)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x14550)
