...
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA234F0)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA234D0)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA234B0)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAA23790)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA234E0)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xAA23510)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA234C0)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAA238B0)
