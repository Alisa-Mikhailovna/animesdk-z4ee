...
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA25040)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA25090)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA25030)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAA24FC0)
