...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_ADDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xAA2C930)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_RELEASE_OFFSET UNITYSDK_OFFSET(0xAA2CB60)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_REMOVEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xAA2CBE0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETBUCKETID_OFFSET UNITYSDK_OFFSET(0xAA2CDE0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETHOSTADDRESS_OFFSET UNITYSDK_OFFSET(0xAA2CFE0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETINVITESALLOWED_OFFSET UNITYSDK_OFFSET(0xAA2D1E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETJOININPROGRESSALLOWED_OFFSET UNITYSDK_OFFSET(0xAA2D3D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETMAXPLAYERS_OFFSET UNITYSDK_OFFSET(0xAA2D5C0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION_SETPERMISSIONLEVEL_OFFSET UNITYSDK_OFFSET(0xAA2D720)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAA2C920)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0xAA2C910)
