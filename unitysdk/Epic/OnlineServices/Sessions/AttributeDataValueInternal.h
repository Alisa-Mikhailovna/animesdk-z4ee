...
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x79980)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x796C0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x79590)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASINT64_OFFSET UNITYSDK_OFFSET(0x79460)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x797D0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x79900)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x79740)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x79620)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASINT64_OFFSET UNITYSDK_OFFSET(0x794F0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x79850)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x798F0)
