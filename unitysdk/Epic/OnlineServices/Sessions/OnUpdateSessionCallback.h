...
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA25C40)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA25C70)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA25C30)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAA25B40)
