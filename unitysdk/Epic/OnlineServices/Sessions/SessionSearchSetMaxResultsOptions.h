...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETMAXRESULTSOPTIONS_GET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0xAA30D50)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETMAXRESULTSOPTIONS_SET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0xAA30D60)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETMAXRESULTSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA30D70)
