...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x165D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_GET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0x16300)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_GET_NUMOPENPUBLICCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x6320)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x161A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x16460)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x16550)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_SET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0x163B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_SET_NUMOPENPUBLICCONNECTIONS_OFFSET UNITYSDK_OFFSET(0xC4B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x16540)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x16250)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSINFOINTERNAL_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x164D0)
