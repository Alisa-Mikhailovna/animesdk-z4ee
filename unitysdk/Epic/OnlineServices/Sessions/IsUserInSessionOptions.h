...
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0xAA22980)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAA229A0)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0xAA22990)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAA229B0)
#define EPIC_ONLINESERVICES_SESSIONS_ISUSERINSESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA229C0)
