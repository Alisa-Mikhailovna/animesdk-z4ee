...
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONS_GET_PLAYERSTOUNREGISTER_OFFSET UNITYSDK_OFFSET(0xAA36200)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONS_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0xAA361E0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONS_SET_PLAYERSTOUNREGISTER_OFFSET UNITYSDK_OFFSET(0xAA36210)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONS_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0xAA361F0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA36220)
