...
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13490)
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x13480)
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x133B0)
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x13300)
