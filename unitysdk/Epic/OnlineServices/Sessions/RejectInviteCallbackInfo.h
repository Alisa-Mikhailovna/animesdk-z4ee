...
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITECALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA26FA0)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITECALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA26F80)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITECALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA26F60)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITECALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAA27240)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITECALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA26F90)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITECALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xAA26FC0)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITECALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA26F70)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAA27360)
