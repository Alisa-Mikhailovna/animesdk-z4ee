...
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x136D0)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x136C0)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x135F0)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x13540)
