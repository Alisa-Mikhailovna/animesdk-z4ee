...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_COPYSEARCHRESULTBYINDEX_OFFSET UNITYSDK_OFFSET(0xAA2EDC0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_FIND_OFFSET UNITYSDK_OFFSET(0xAA2EF50)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_GETSEARCHRESULTCOUNT_OFFSET UNITYSDK_OFFSET(0xAA2F1B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_ONFINDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAA2ED00)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_RELEASE_OFFSET UNITYSDK_OFFSET(0xAA2F3F0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_REMOVEPARAMETER_OFFSET UNITYSDK_OFFSET(0xAA2F470)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETMAXRESULTS_OFFSET UNITYSDK_OFFSET(0xAA2F6A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETPARAMETER_OFFSET UNITYSDK_OFFSET(0xAA2F800)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETSESSIONID_OFFSET UNITYSDK_OFFSET(0xAA2FA30)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETTARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAA2FC30)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAA2EDB0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0xAA2EDA0)
