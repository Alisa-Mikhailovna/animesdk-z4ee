...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_GET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0xAA28EA0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_GET_DATA_OFFSET UNITYSDK_OFFSET(0xAA28E80)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_SET_1_OFFSET UNITYSDK_OFFSET(0xAA29090)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_SET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0xAA28EB0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_SET_DATA_OFFSET UNITYSDK_OFFSET(0xAA28E90)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_SET_OFFSET UNITYSDK_OFFSET(0xAA28EC0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xAA291B0)
