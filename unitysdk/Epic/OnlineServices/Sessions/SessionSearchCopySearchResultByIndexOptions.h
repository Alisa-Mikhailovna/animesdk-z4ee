...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHCOPYSEARCHRESULTBYINDEXOPTIONS_GET_SESSIONINDEX_OFFSET UNITYSDK_OFFSET(0xAA2FE30)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHCOPYSEARCHRESULTBYINDEXOPTIONS_SET_SESSIONINDEX_OFFSET UNITYSDK_OFFSET(0xAA2FE40)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHCOPYSEARCHRESULTBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA2FE50)
