...
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13A20)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x13A10)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x13940)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x13890)
