...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_COPYINFO_OFFSET UNITYSDK_OFFSET(0xAA28470)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_COPYSESSIONATTRIBUTEBYINDEX_OFFSET UNITYSDK_OFFSET(0xAA28730)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_COPYSESSIONATTRIBUTEBYKEY_OFFSET UNITYSDK_OFFSET(0xAA28930)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_GETSESSIONATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0xAA28BC0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_RELEASE_OFFSET UNITYSDK_OFFSET(0xAA28E00)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAA28460)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA28450)
