...
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA25260)
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA252B0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA25250)
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAA251E0)
