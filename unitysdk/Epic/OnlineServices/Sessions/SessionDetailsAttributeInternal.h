...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15D60)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_GET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x6E20)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_GET_DATA_OFFSET UNITYSDK_OFFSET(0x15BF0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x15D50)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_SET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x2A90)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_SET_DATA_OFFSET UNITYSDK_OFFSET(0x15C60)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x15CD0)
