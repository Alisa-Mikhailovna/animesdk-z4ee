...
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3BFC0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_CATALOGNAMESPACE_OFFSET UNITYSDK_OFFSET(0x3B3F0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_DESCRIPTIONTEXT_OFFSET UNITYSDK_OFFSET(0x3B970)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_DEVELOPERTEXT_OFFSET UNITYSDK_OFFSET(0x3BD90)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_ENTITLEMENTENDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x3BF10)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_ENTITLEMENTNAME_OFFSET UNITYSDK_OFFSET(0x3B6B0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_ID_OFFSET UNITYSDK_OFFSET(0x3B550)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x3BEF0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_LONGDESCRIPTIONTEXT_OFFSET UNITYSDK_OFFSET(0x3BAD0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_TECHNICALDETAILSTEXT_OFFSET UNITYSDK_OFFSET(0x3BC30)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_GET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0x3B810)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x3BF40)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_CATALOGNAMESPACE_OFFSET UNITYSDK_OFFSET(0x3B4A0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_DESCRIPTIONTEXT_OFFSET UNITYSDK_OFFSET(0x3BA20)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_DEVELOPERTEXT_OFFSET UNITYSDK_OFFSET(0x3BE40)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_ENTITLEMENTENDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x3BF20)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_ENTITLEMENTNAME_OFFSET UNITYSDK_OFFSET(0x3B760)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_ID_OFFSET UNITYSDK_OFFSET(0x3B600)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x3BF00)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_LONGDESCRIPTIONTEXT_OFFSET UNITYSDK_OFFSET(0x3BB80)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x3BF30)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_TECHNICALDETAILSTEXT_OFFSET UNITYSDK_OFFSET(0x3BCE0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGITEMINTERNAL_SET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0x3B8C0)
