...
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x43260)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x431E0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_CATALOGITEMIDS_OFFSET UNITYSDK_OFFSET(0x430B0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_CATALOGNAMESPACE_OFFSET UNITYSDK_OFFSET(0x43120)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x42FF0)
#define EPIC_ONLINESERVICES_ECOM_QUERYOWNERSHIPOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x431D0)
