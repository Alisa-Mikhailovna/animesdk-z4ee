...
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC15760)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS_GET_OFFERINDEX_OFFSET UNITYSDK_OFFSET(0xAC15780)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC15770)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS_SET_OFFERINDEX_OFFSET UNITYSDK_OFFSET(0xAC15790)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC157A0)
