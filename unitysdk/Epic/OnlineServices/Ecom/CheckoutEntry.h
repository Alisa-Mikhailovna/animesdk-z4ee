...
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTENTRY_GET_OFFERID_OFFSET UNITYSDK_OFFSET(0xAC12430)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTENTRY_SET_1_OFFSET UNITYSDK_OFFSET(0xAC12640)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTENTRY_SET_OFFERID_OFFSET UNITYSDK_OFFSET(0xAC12440)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTENTRY_SET_OFFSET UNITYSDK_OFFSET(0xAC12450)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xAC12850)
