...
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYIDOPTIONS_GET_ENTITLEMENTID_OFFSET UNITYSDK_OFFSET(0xAC133D0)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYIDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC133B0)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYIDOPTIONS_SET_ENTITLEMENTID_OFFSET UNITYSDK_OFFSET(0xAC133E0)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYIDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC133C0)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC133F0)
