...
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC1DBD0)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC1DBE0)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC1DBF0)
