...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC1F500)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC1F550)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC1F4F0)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAC1F480)
