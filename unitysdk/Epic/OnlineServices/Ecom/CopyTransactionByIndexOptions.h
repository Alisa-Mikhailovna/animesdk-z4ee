...
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC16C90)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYINDEXOPTIONS_GET_TRANSACTIONINDEX_OFFSET UNITYSDK_OFFSET(0xAC16CB0)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC16CA0)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYINDEXOPTIONS_SET_TRANSACTIONINDEX_OFFSET UNITYSDK_OFFSET(0xAC16CC0)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC16CD0)
