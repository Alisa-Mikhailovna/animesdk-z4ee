...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6ADD0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x6AD50)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONSINTERNAL_SET_KEY_OFFSET UNITYSDK_OFFSET(0x6ABE0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x6AD40)
...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONSINTERNAL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x6AC90)
