...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x44D50)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x1E7F0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x44D60)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_PREVIOUSSTATUS_OFFSET UNITYSDK_OFFSET(0x6320)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFOINTERNAL_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x44DD0)
