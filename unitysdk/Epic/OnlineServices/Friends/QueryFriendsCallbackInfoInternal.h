...
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x6010)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x44E40)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x44E50)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
