...
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x44D40)
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x44CC0)
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x44B30)
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x44CB0)
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x44BF0)
