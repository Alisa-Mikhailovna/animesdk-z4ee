...
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC28730)
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC28780)
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC28720)
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAC286B0)
