...
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xAC26B50)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC26B30)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xAC26B60)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC26B40)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC26B70)
