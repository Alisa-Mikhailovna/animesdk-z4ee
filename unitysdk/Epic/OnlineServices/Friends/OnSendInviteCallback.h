...
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC28880)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC288B0)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC26B20)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC28790)
