...
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC27910)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC27940)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC26AE0)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC27820)
