...
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x45720)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x456A0)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x45510)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x45690)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x455D0)
