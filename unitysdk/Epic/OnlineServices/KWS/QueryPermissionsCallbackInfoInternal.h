...
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x6010)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x472F0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_DATEOFBIRTH_OFFSET UNITYSDK_OFFSET(0x47520)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_ISMINOR_OFFSET UNITYSDK_OFFSET(0x475D0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_KWSUSERID_OFFSET UNITYSDK_OFFSET(0x47470)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x47400)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
