...
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC325C0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC325D0)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC325E0)
