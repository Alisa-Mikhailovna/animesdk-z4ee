...
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC30520)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC30550)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC2FBD0)
#define EPIC_ONLINESERVICES_KWS_ONREQUESTPERMISSIONSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC30430)
