...
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x45950)
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x45940)
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONSINTERNAL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x2A90)
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x457A0)
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x45860)
