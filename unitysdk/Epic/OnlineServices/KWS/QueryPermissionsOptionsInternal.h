...
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x47820)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x47810)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x47680)
#define EPIC_ONLINESERVICES_KWS_QUERYPERMISSIONSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x47740)
