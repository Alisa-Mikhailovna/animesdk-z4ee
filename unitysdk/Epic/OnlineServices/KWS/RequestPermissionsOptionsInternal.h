...
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x47CC0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x47C40)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x47A50)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x47C30)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_PERMISSIONKEYS_OFFSET UNITYSDK_OFFSET(0x47B10)
