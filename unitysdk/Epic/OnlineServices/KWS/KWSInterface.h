...
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ADDNOTIFYPERMISSIONSUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0xAC2E760)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_COPYPERMISSIONBYINDEX_OFFSET UNITYSDK_OFFSET(0xAC2EA10)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_CREATEUSER_OFFSET UNITYSDK_OFFSET(0xAC2ECA0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_GETPERMISSIONBYKEY_OFFSET UNITYSDK_OFFSET(0xAC2EE80)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_GETPERMISSIONSCOUNT_OFFSET UNITYSDK_OFFSET(0xAC2EFF0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONCREATEUSERCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC2E380)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONPERMISSIONSUPDATERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC2E420)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONQUERYAGEGATECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC2E4C0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONQUERYPERMISSIONSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC2E560)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONREQUESTPERMISSIONSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC2E600)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONUPDATEPARENTEMAILCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC2E6A0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_QUERYAGEGATE_OFFSET UNITYSDK_OFFSET(0xAC2F1E0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_QUERYPERMISSIONS_OFFSET UNITYSDK_OFFSET(0xAC2F480)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_REMOVENOTIFYPERMISSIONSUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0xAC2F6F0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_REQUESTPERMISSIONS_OFFSET UNITYSDK_OFFSET(0xAC2F7D0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_UPDATEPARENTEMAIL_OFFSET UNITYSDK_OFFSET(0xAC2F9B0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC2E750)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC2E740)
