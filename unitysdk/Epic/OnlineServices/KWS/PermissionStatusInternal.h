...
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x47090)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x46EA0)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x6E20)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x47010)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_SET_NAME_OFFSET UNITYSDK_OFFSET(0x46F50)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x47000)
