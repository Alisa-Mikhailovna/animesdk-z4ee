...
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xAC329C0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAC32980)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC329A0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAC32960)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAC32DC0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAC32990)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC329B0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xAC329E0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAC32970)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAC32EE0)
