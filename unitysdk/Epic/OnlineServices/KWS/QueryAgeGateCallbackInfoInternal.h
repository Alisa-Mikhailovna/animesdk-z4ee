...
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_AGEOFCONSENT_OFFSET UNITYSDK_OFFSET(0x6320)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x6010)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x471C0)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_COUNTRYCODE_OFFSET UNITYSDK_OFFSET(0x471D0)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
