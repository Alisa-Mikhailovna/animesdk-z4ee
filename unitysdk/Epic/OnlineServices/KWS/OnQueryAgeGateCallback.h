...
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC30100)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC30130)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC2FBB0)
#define EPIC_ONLINESERVICES_KWS_ONQUERYAGEGATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC30010)
