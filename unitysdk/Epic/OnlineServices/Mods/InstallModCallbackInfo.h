...
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xAC62DD0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAC62D90)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC62D70)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_GET_MOD_OFFSET UNITYSDK_OFFSET(0xAC62DB0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAC62D50)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAC63320)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAC62DA0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC62D80)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_SET_MOD_OFFSET UNITYSDK_OFFSET(0xAC62DC0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xAC62DF0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAC62D60)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAC63450)
