...
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC66900)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC66930)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC663D0)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC66810)
