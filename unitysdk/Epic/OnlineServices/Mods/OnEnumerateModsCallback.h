...
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC664E0)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC66510)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC663B0)
#define EPIC_ONLINESERVICES_MODS_ONENUMERATEMODSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC663F0)
