...
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC66B10)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC66B40)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC663E0)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC66A20)
