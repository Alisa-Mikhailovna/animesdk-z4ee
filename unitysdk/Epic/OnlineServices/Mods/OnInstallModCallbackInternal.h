...
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC667B0)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC66800)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC667A0)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAC66730)
