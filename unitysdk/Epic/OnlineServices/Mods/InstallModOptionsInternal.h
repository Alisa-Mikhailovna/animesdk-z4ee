...
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x59BB0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x59B30)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x59940)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_MOD_OFFSET UNITYSDK_OFFSET(0x59A00)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x59B20)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_REMOVEAFTEREXIT_OFFSET UNITYSDK_OFFSET(0x59A70)
