...
#define EPIC_ONLINESERVICES_MODS_MODINFO_GET_MODS_OFFSET UNITYSDK_OFFSET(0xAC65080)
#define EPIC_ONLINESERVICES_MODS_MODINFO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xAC650A0)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAC65290)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_MODS_OFFSET UNITYSDK_OFFSET(0xAC65090)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_OFFSET UNITYSDK_OFFSET(0xAC650C0)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xAC650B0)
#define EPIC_ONLINESERVICES_MODS_MODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAC653B0)
