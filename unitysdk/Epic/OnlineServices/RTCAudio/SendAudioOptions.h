...
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0xACAF2D0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xACAF290)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0xACAF2B0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_SET_BUFFER_OFFSET UNITYSDK_OFFSET(0xACAF2E0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xACAF2A0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0xACAF2C0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xACAF2F0)
