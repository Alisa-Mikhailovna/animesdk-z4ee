...
#define EPIC_ONLINESERVICES_RTCAUDIO_PARTICIPANTUPDATEDCALLBACKINFOINTERNAL_GET_AUDIOSTATUS_OFFSET UNITYSDK_OFFSET(0x5DC70)
#define EPIC_ONLINESERVICES_RTCAUDIO_PARTICIPANTUPDATEDCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define EPIC_ONLINESERVICES_RTCAUDIO_PARTICIPANTUPDATEDCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x73D60)
#define EPIC_ONLINESERVICES_RTCAUDIO_PARTICIPANTUPDATEDCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x73E70)
#define EPIC_ONLINESERVICES_RTCAUDIO_PARTICIPANTUPDATEDCALLBACKINFOINTERNAL_GET_PARTICIPANTID_OFFSET UNITYSDK_OFFSET(0x73F90)
#define EPIC_ONLINESERVICES_RTCAUDIO_PARTICIPANTUPDATEDCALLBACKINFOINTERNAL_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x73EE0)
#define EPIC_ONLINESERVICES_RTCAUDIO_PARTICIPANTUPDATEDCALLBACKINFOINTERNAL_GET_SPEAKING_OFFSET UNITYSDK_OFFSET(0x74000)
