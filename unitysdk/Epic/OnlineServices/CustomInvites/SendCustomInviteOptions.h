...
#define EPIC_ONLINESERVICES_CUSTOMINVITES_SENDCUSTOMINVITEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC0B670)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_SENDCUSTOMINVITEOPTIONS_GET_TARGETUSERIDS_OFFSET UNITYSDK_OFFSET(0xAC0B690)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_SENDCUSTOMINVITEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC0B680)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_SENDCUSTOMINVITEOPTIONS_SET_TARGETUSERIDS_OFFSET UNITYSDK_OFFSET(0xAC0B6A0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_SENDCUSTOMINVITEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC0B6B0)
