...
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x589A0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x58920)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x58690)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0xC4B0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x58700)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x58860)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x58910)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_SERVERIP_OFFSET UNITYSDK_OFFSET(0x587B0)
