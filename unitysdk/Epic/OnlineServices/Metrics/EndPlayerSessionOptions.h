...
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONS_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xAC608C0)
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONS_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xAC608D0)
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC608E0)
