...
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xAC5EF50)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0xAC5EF90)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xAC5EF70)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0xAC5EFD0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_SERVERIP_OFFSET UNITYSDK_OFFSET(0xAC5EFB0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xAC5EF60)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0xAC5EFA0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xAC5EF80)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0xAC5EFE0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_SERVERIP_OFFSET UNITYSDK_OFFSET(0xAC5EFC0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC5EFF0)
