...
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYDISPLAYNAMEOPTIONS_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xAA4C160)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYDISPLAYNAMEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA4C140)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYDISPLAYNAMEOPTIONS_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xAA4C170)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYDISPLAYNAMEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA4C150)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOBYDISPLAYNAMEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA4C180)
