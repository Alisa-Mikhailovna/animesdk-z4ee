...
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x231C0)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFOINTERNAL_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x22E70)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFOINTERNAL_GET_ACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x1E130)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFOINTERNAL_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x22FD0)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x23140)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFOINTERNAL_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x22F20)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFOINTERNAL_SET_ACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x21F0)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFOINTERNAL_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x23080)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x23130)
