...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7A50)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDSINTERNAL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x7810)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDSINTERNAL_GET_THRESHOLD_OFFSET UNITYSDK_OFFSET(0x6E20)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7A40)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDSINTERNAL_SET_NAME_OFFSET UNITYSDK_OFFSET(0x78C0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7970)
