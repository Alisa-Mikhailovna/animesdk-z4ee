...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_GET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xA9FFDD0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA9FFDB0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_GET_THRESHOLDVALUE_OFFSET UNITYSDK_OFFSET(0xA9FFDF0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAA000B0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xA9FFDE0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_NAME_OFFSET UNITYSDK_OFFSET(0xA9FFDC0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_OFFSET UNITYSDK_OFFSET(0xA9FFE10)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_THRESHOLDVALUE_OFFSET UNITYSDK_OFFSET(0xA9FFE00)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAA001D0)
