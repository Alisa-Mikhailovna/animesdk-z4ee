...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONS_GET_ACHIEVEMENTIDS_OFFSET UNITYSDK_OFFSET(0xAA01A80)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONS_GET_USERID_OFFSET UNITYSDK_OFFSET(0xAA01A60)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONS_SET_ACHIEVEMENTIDS_OFFSET UNITYSDK_OFFSET(0xAA01A90)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONS_SET_USERID_OFFSET UNITYSDK_OFFSET(0xAA01A70)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA01AA0)
