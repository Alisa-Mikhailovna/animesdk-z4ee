...
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONQUERYFILELISTCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA3F820)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONQUERYFILELISTCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA3F850)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONQUERYFILELISTCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA3F810)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONQUERYFILELISTCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAA3F720)
