...
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA3D0A0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA3D060)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA3D080)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA3D040)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAA3D4A0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xAA3D070)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAA3D090)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xAA3D0C0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xAA3D050)
#define EPIC_ONLINESERVICES_TITLESTORAGE_DELETECACHECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAA3D5C0)
