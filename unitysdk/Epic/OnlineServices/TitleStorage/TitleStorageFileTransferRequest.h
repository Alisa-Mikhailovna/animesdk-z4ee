...
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_CANCELREQUEST_OFFSET UNITYSDK_OFFSET(0xAA430B0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_GETFILENAME_OFFSET UNITYSDK_OFFSET(0xAA431B0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_GETFILEREQUESTSTATE_OFFSET UNITYSDK_OFFSET(0xAA43130)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_RELEASE_OFFSET UNITYSDK_OFFSET(0xAA433D0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAA430A0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0xAA43090)
