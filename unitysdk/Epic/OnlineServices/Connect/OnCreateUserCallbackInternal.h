...
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC02130)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC02180)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC02120)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAC020B0)
