...
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONS_GET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0xABFED80)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xABFED60)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONS_GET_TARGETPRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0xABFEDA0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONS_SET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0xABFED90)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xABFED70)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONS_SET_TARGETPRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0xABFEDB0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xABFEDC0)
