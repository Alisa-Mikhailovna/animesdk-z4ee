...
#define EPIC_ONLINESERVICES_CONNECT_COPYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x34720)
#define EPIC_ONLINESERVICES_CONNECT_COPYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x34710)
#define EPIC_ONLINESERVICES_CONNECT_COPYIDTOKENOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x34580)
#define EPIC_ONLINESERVICES_CONNECT_COPYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x34640)
