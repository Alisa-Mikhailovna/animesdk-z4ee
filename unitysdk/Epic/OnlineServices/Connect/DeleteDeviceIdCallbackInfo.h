...
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFCEF0)
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABFCED0)
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFCEB0)
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xABFD190)
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABFCEE0)
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xABFCF10)
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFCEC0)
#define EPIC_ONLINESERVICES_CONNECT_DELETEDEVICEIDCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xABFD2B0)
