...
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFBE70)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABFBE30)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xABFBE50)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFBE10)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xABFC270)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABFBE40)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xABFBE60)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xABFBE90)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFBE20)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSERCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xABFC390)
