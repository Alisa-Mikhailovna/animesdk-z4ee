...
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x39970)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x39960)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONSINTERNAL_SET_IDTOKEN_OFFSET UNITYSDK_OFFSET(0x39870)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x398E0)
