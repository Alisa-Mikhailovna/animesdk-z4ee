...
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFFCE0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABFFCA0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xABFFCC0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFFC80)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xAC000E0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABFFCB0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xABFFCD0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xABFFD00)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFFC90)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAC00200)
