...
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0xABFD3E0)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xABFD3C0)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xABFD3A0)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_LASTLOGINTIME_OFFSET UNITYSDK_OFFSET(0xABFD400)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0xABFD380)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xABFDB00)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0xABFD3F0)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xABFD3D0)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xABFD3B0)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_LASTLOGINTIME_OFFSET UNITYSDK_OFFSET(0xABFD420)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_OFFSET UNITYSDK_OFFSET(0xABFD430)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0xABFD390)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xABFDC40)
