...
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_GET_LOCALDEVICEUSERID_OFFSET UNITYSDK_OFFSET(0xAC050E0)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_GET_PRIMARYLOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC050C0)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_GET_PRODUCTUSERIDTOPRESERVE_OFFSET UNITYSDK_OFFSET(0xAC05100)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_SET_LOCALDEVICEUSERID_OFFSET UNITYSDK_OFFSET(0xAC050F0)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_SET_PRIMARYLOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC050D0)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS_SET_PRODUCTUSERIDTOPRESERVE_OFFSET UNITYSDK_OFFSET(0xAC05110)
#define EPIC_ONLINESERVICES_CONNECT_TRANSFERDEVICEIDACCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC05120)
