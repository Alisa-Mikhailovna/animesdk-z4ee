...
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDOPTIONS_GET_DEVICEMODEL_OFFSET UNITYSDK_OFFSET(0xABFBA80)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDOPTIONS_SET_DEVICEMODEL_OFFSET UNITYSDK_OFFSET(0xABFBA90)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xABFBAA0)
