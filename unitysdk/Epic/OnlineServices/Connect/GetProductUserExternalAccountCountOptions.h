...
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSEREXTERNALACCOUNTCOUNTOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xABFE9C0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSEREXTERNALACCOUNTCOUNTOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xABFE9D0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSEREXTERNALACCOUNTCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xABFE9E0)
