...
#define EPIC_ONLINESERVICES_CONNECT_IDTOKEN_GET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0xABFF300)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKEN_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0xABFF2E0)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKEN_SET_1_OFFSET UNITYSDK_OFFSET(0xABFF670)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKEN_SET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0xABFF310)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKEN_SET_OFFSET UNITYSDK_OFFSET(0xABFF320)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKEN_SET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0xABFF2F0)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0xABFF790)
