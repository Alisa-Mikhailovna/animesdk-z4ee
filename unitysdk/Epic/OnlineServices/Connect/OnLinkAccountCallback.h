...
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC024B0)
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC024E0)
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC024A0)
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC023B0)
