...
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFB690)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABFB670)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFB650)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xABFB930)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABFB680)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xABFB6B0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABFB660)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xABFBA50)
