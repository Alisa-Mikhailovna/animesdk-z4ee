...
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC02290)
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC022C0)
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC02280)
#define EPIC_ONLINESERVICES_CONNECT_ONDELETEDEVICEIDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC02190)
