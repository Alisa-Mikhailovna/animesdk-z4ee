...
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC026D0)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC02700)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC026C0)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC025D0)
