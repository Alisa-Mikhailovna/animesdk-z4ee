...
#define EPIC_ONLINESERVICES_CONTINUANCETOKEN_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0xAC07C30)
#define EPIC_ONLINESERVICES_CONTINUANCETOKEN_TOSTRING_OFFSET UNITYSDK_OFFSET(0xAC07A10)
#define EPIC_ONLINESERVICES_CONTINUANCETOKEN__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC07A00)
#define EPIC_ONLINESERVICES_CONTINUANCETOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0xAC079F0)
