...
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_EXTERNALTYPE_OFFSET UNITYSDK_OFFSET(0xAA1C360)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_ID_OFFSET UNITYSDK_OFFSET(0xAA1C2E0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_SYSTEMAUTHCREDENTIALSOPTIONS_OFFSET UNITYSDK_OFFSET(0xAA1C340)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0xAA1C300)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xAA1C320)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_1_OFFSET UNITYSDK_OFFSET(0xAA1C870)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_EXTERNALTYPE_OFFSET UNITYSDK_OFFSET(0xAA1C370)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_ID_OFFSET UNITYSDK_OFFSET(0xAA1C2F0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_OFFSET UNITYSDK_OFFSET(0xAA1C380)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_SYSTEMAUTHCREDENTIALSOPTIONS_OFFSET UNITYSDK_OFFSET(0xAA1C350)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_TOKEN_OFFSET UNITYSDK_OFFSET(0xAA1C310)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xAA1C330)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA1C9B0)
