...
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x30510)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x30490)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONSINTERNAL_SET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x30300)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONSINTERNAL_SET_LINKACCOUNTFLAGS_OFFSET UNITYSDK_OFFSET(0x21F0)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x303C0)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x30480)
