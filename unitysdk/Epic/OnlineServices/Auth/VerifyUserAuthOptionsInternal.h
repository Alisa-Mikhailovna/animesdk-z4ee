...
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x32B30)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x32B20)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONSINTERNAL_SET_AUTHTOKEN_OFFSET UNITYSDK_OFFSET(0x32A30)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x32AA0)
