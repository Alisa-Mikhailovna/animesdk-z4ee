...
#define EPIC_ONLINESERVICES_AUTH_ONLINKACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xABDE140)
#define EPIC_ONLINESERVICES_AUTH_ONLINKACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xABDE170)
#define EPIC_ONLINESERVICES_AUTH_ONLINKACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xABDE130)
#define EPIC_ONLINESERVICES_AUTH_ONLINKACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xABDE040)
