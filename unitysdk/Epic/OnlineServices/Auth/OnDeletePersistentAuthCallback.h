...
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xABDDF20)
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xABDDF50)
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xABDDF10)
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xABDDE20)
