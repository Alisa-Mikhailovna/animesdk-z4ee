...
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONS_GET_REFRESHTOKEN_OFFSET UNITYSDK_OFFSET(0xAA1D3A0)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONS_SET_REFRESHTOKEN_OFFSET UNITYSDK_OFFSET(0xAA1D3B0)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA1D3C0)
