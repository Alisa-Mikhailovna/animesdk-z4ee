...
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xABE3050)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABE3030)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABE3010)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xABE32F0)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABE3040)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xABE3070)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABE3020)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xABE3410)
