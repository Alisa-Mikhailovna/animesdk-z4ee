...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xABDEE00)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xABDEE30)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xABDEDF0)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xABDED00)
