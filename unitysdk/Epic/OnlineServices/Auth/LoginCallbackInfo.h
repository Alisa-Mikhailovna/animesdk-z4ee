...
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0xABDC0F0)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_GET_ACCOUNTFEATURERESTRICTEDINFO_OFFSET UNITYSDK_OFFSET(0xABDC0B0)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABDC030)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_GET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0xABDC090)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xABDC050)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_GET_PINGRANTINFO_OFFSET UNITYSDK_OFFSET(0xABDC070)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABDC010)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_GET_SELECTEDACCOUNTID_OFFSET UNITYSDK_OFFSET(0xABDC0D0)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0xABDCA30)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_SET_ACCOUNTFEATURERESTRICTEDINFO_OFFSET UNITYSDK_OFFSET(0xABDC0C0)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0xABDC040)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_SET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0xABDC0A0)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xABDC060)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0xABDC110)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_SET_PINGRANTINFO_OFFSET UNITYSDK_OFFSET(0xABDC080)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0xABDC020)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO_SET_SELECTEDACCOUNTID_OFFSET UNITYSDK_OFFSET(0xABDC0E0)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xABDCB70)
...
namespace Epic::OnlineServices::Auth
{
	...
	public:
		...
		::Epic::OnlineServices::ContinuanceToken* _ContinuanceToken_k__BackingField; // 0x28
