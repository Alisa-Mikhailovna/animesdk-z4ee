...
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONS_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xAA1BEA0)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONS_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0xAA1BEB0)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA1BEC0)
