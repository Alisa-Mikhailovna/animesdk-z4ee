...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xABDEEC0)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xABDEF10)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xABDEEB0)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYUSERAUTHCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xABDEE40)
