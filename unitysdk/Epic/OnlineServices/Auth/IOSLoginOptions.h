...
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0xAA1E890)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS_GET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0xAA1E8B0)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0xAA1E8A0)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS_SET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0xAA1E8C0)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA1E8D0)
