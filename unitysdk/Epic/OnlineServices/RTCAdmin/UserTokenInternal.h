...
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x71050)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x70D30)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x70E60)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x70FD0)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x70FC0)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_SET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x70DA0)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_SET_TOKEN_OFFSET UNITYSDK_OFFSET(0x70F10)
