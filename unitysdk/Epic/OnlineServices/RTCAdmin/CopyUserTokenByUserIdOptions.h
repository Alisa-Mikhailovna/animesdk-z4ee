...
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONS_GET_QUERYID_OFFSET UNITYSDK_OFFSET(0xAC9F980)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAC9F960)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONS_SET_QUERYID_OFFSET UNITYSDK_OFFSET(0xAC9F990)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAC9F970)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC9F9A0)
