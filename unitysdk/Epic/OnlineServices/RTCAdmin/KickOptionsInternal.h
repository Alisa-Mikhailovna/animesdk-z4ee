...
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6F990)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x6F910)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x6F900)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x6F790)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x6F840)
