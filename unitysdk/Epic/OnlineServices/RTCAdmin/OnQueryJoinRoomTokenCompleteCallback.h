...
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xACA09E0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xACA0A10)
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xACA09D0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONQUERYJOINROOMTOKENCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xACA08E0)
