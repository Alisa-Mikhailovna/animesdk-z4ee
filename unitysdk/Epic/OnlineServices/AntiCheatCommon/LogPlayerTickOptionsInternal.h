...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC300)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xC280)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_ISPLAYERVIEWZOOMED_OFFSET UNITYSDK_OFFSET(0xC1A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xC270)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x94F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERHEALTH_OFFSET UNITYSDK_OFFSET(0xC250)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERMOVEMENTSTATE_OFFSET UNITYSDK_OFFSET(0xC260)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0xC0C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTICKOPTIONSINTERNAL_SET_PLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0xC130)
