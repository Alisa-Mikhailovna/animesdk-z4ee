...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDENDOPTIONS_GET_WINNINGTEAMID_OFFSET UNITYSDK_OFFSET(0xAA0C9C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDENDOPTIONS_SET_WINNINGTEAMID_OFFSET UNITYSDK_OFFSET(0xAA0C9D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGGAMEROUNDENDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA0C9E0)
