...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA550)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRINTERNAL_GET_PARAMVALUE_OFFSET UNITYSDK_OFFSET(0xA330)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xA540)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xA4C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTPARAMPAIRINTERNAL_SET_PARAMVALUE_OFFSET UNITYSDK_OFFSET(0xA450)
