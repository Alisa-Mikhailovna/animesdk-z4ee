...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONS_GET_USEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0xAA10470)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONS_SET_USEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0xAA10480)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAA10490)
