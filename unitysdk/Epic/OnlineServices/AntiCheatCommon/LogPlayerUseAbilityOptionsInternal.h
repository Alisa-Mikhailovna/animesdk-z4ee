...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0xC4F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_ABILITYCOOLDOWNMS_OFFSET UNITYSDK_OFFSET(0xC4B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_ABILITYDURATIONMS_OFFSET UNITYSDK_OFFSET(0x6E40)
...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0xC4C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x94F0)
