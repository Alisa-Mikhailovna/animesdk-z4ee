...
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE_COPYPLAYERSANCTIONBYINDEX_OFFSET UNITYSDK_OFFSET(0xACB60C0)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE_GETPLAYERSANCTIONCOUNT_OFFSET UNITYSDK_OFFSET(0xACB6350)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xACB6000)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE_QUERYACTIVEPLAYERSANCTIONS_OFFSET UNITYSDK_OFFSET(0xACB6540)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xACB60B0)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xACB60A0)
