...
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC683E0)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONS_GET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0xAC68400)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONS_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0xAC68420)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC683F0)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONS_SET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0xAC68410)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONS_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0xAC68430)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC68440)
