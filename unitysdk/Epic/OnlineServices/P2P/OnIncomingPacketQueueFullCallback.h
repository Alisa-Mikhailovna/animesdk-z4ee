...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC6C470)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC6C4A0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC6C460)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC6C370)
