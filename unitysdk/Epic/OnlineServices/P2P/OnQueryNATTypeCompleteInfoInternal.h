...
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x6010)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x5DEE0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_NATTYPE_OFFSET UNITYSDK_OFFSET(0x6E20)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
