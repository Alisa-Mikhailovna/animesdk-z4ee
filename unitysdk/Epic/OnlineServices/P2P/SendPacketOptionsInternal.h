...
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x5F4A0)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x5F420)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_ALLOWDELAYEDDELIVERY_OFFSET UNITYSDK_OFFSET(0x5F350)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_CHANNEL_OFFSET UNITYSDK_OFFSET(0x5F2D0)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_DATA_OFFSET UNITYSDK_OFFSET(0x5F2E0)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x5F080)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x5F410)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_RELIABILITY_OFFSET UNITYSDK_OFFSET(0x5F400)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x5F140)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x5F200)
