...
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONS_GET_RELAYCONTROL_OFFSET UNITYSDK_OFFSET(0xAC72D70)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONS_SET_RELAYCONTROL_OFFSET UNITYSDK_OFFSET(0xAC72D80)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC72D90)
