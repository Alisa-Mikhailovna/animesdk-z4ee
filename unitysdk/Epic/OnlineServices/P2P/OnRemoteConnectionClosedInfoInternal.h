...
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x5DFF0)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x5E100)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_REASON_OFFSET UNITYSDK_OFFSET(0x1D2A0)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x5E170)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDINFOINTERNAL_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x5E1E0)
