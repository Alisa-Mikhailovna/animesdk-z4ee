...
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ACCEPTCONNECTION_OFFSET UNITYSDK_OFFSET(0xAC6ED60)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ADDNOTIFYINCOMINGPACKETQUEUEFULL_OFFSET UNITYSDK_OFFSET(0xAC6EEC0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ADDNOTIFYPEERCONNECTIONCLOSED_OFFSET UNITYSDK_OFFSET(0xAC6F170)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ADDNOTIFYPEERCONNECTIONESTABLISHED_OFFSET UNITYSDK_OFFSET(0xAC6F360)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ADDNOTIFYPEERCONNECTIONREQUEST_OFFSET UNITYSDK_OFFSET(0xAC6F550)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_CLEARPACKETQUEUE_OFFSET UNITYSDK_OFFSET(0xAC6F740)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_CLOSECONNECTIONS_OFFSET UNITYSDK_OFFSET(0xAC6FA00)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_CLOSECONNECTION_OFFSET UNITYSDK_OFFSET(0xAC6F8A0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETNATTYPE_OFFSET UNITYSDK_OFFSET(0xAC6FB60)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETNEXTRECEIVEDPACKETSIZE_OFFSET UNITYSDK_OFFSET(0xAC6FD80)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETPACKETQUEUEINFO_OFFSET UNITYSDK_OFFSET(0xAC6FEF0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETPORTRANGE_OFFSET UNITYSDK_OFFSET(0xAC70220)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETRELAYCONTROL_OFFSET UNITYSDK_OFFSET(0xAC70460)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC6EA20)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONINCOMINGPACKETQUEUEFULLCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC6EAC0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONPEERCONNECTIONESTABLISHEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC6EB60)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONQUERYNATTYPECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC6EC00)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONREMOTECONNECTIONCLOSEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC6ECA0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_QUERYNATTYPE_OFFSET UNITYSDK_OFFSET(0xAC70680)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_RECEIVEPACKET_OFFSET UNITYSDK_OFFSET(0xAC70920)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_REMOVENOTIFYINCOMINGPACKETQUEUEFULL_OFFSET UNITYSDK_OFFSET(0xAC70C50)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_REMOVENOTIFYPEERCONNECTIONCLOSED_OFFSET UNITYSDK_OFFSET(0xAC70D30)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_REMOVENOTIFYPEERCONNECTIONESTABLISHED_OFFSET UNITYSDK_OFFSET(0xAC70E10)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_REMOVENOTIFYPEERCONNECTIONREQUEST_OFFSET UNITYSDK_OFFSET(0xAC70EF0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_SENDPACKET_OFFSET UNITYSDK_OFFSET(0xAC70FD0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_SETPACKETQUEUESIZE_OFFSET UNITYSDK_OFFSET(0xAC71130)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_SETPORTRANGE_OFFSET UNITYSDK_OFFSET(0xAC71290)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_SETRELAYCONTROL_OFFSET UNITYSDK_OFFSET(0xAC713F0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC6ED50)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC6ED40)
