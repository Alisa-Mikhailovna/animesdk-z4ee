...
#define EPIC_ONLINESERVICES_PAGERESULT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xAC73850)
#define EPIC_ONLINESERVICES_PAGERESULT_GET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0xAC73830)
#define EPIC_ONLINESERVICES_PAGERESULT_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xAC73870)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_1_OFFSET UNITYSDK_OFFSET(0xAC73960)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_COUNT_OFFSET UNITYSDK_OFFSET(0xAC73860)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_OFFSET UNITYSDK_OFFSET(0xAC73890)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0xAC73840)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xAC73880)
#define EPIC_ONLINESERVICES_PAGERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xAC73AB0)
