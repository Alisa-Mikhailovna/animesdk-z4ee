...
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x67F80)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x67F00)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x67D70)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x67EF0)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x67E30)
