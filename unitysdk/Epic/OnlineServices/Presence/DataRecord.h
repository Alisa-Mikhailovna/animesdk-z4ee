...
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_GET_KEY_OFFSET UNITYSDK_OFFSET(0xAC8AAC0)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xAC8AAE0)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_SET_1_OFFSET UNITYSDK_OFFSET(0xAC8AEE0)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_SET_KEY_OFFSET UNITYSDK_OFFSET(0xAC8AAD0)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_SET_OFFSET UNITYSDK_OFFSET(0xAC8AB00)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xAC8AAF0)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD__CTOR_OFFSET UNITYSDK_OFFSET(0xAC8B000)
