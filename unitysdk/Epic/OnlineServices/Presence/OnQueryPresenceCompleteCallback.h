...
#define EPIC_ONLINESERVICES_PRESENCE_ONQUERYPRESENCECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC8EAB0)
#define EPIC_ONLINESERVICES_PRESENCE_ONQUERYPRESENCECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC8EAE0)
#define EPIC_ONLINESERVICES_PRESENCE_ONQUERYPRESENCECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC8EAA0)
#define EPIC_ONLINESERVICES_PRESENCE_ONQUERYPRESENCECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC8E9B0)
