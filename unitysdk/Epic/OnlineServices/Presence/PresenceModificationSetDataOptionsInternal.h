...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x69C50)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x69C40)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x69BB0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_SET_RECORDS_OFFSET UNITYSDK_OFFSET(0x69B40)
