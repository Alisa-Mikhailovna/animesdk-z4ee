...
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC8B4D0)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAC8B4F0)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0xAC8B4E0)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0xAC8B500)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC8B510)
