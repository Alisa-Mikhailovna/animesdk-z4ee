...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_ADDNOTIFYJOINGAMEACCEPTED_OFFSET UNITYSDK_OFFSET(0xAC8F540)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_ADDNOTIFYONPRESENCECHANGED_OFFSET UNITYSDK_OFFSET(0xAC8F7F0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_COPYPRESENCE_OFFSET UNITYSDK_OFFSET(0xAC8FAA0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_CREATEPRESENCEMODIFICATION_OFFSET UNITYSDK_OFFSET(0xAC8FCA0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_GETJOININFO_OFFSET UNITYSDK_OFFSET(0xAC8FE90)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_HASPRESENCE_OFFSET UNITYSDK_OFFSET(0xAC90140)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_ONJOINGAMEACCEPTEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC8F2A0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_ONPRESENCECHANGEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC8F340)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_ONQUERYPRESENCECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC8F3E0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_QUERYPRESENCE_OFFSET UNITYSDK_OFFSET(0xAC90310)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_REMOVENOTIFYJOINGAMEACCEPTED_OFFSET UNITYSDK_OFFSET(0xAC904F0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_REMOVENOTIFYONPRESENCECHANGED_OFFSET UNITYSDK_OFFSET(0xAC905D0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_SETPRESENCECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC8F480)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE_SETPRESENCE_OFFSET UNITYSDK_OFFSET(0xAC906B0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC8F530)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC8F520)
