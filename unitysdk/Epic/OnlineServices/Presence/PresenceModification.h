...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_DELETEDATA_OFFSET UNITYSDK_OFFSET(0xAC908C0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_RELEASE_OFFSET UNITYSDK_OFFSET(0xAC90AC0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_SETDATA_OFFSET UNITYSDK_OFFSET(0xAC90B40)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_SETJOININFO_OFFSET UNITYSDK_OFFSET(0xAC90D40)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_SETRAWRICHTEXT_OFFSET UNITYSDK_OFFSET(0xAC90F40)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_SETSTATUS_OFFSET UNITYSDK_OFFSET(0xAC91140)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC908B0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0xAC908A0)
