...
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x6010)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x77060)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
