...
#define EPIC_ONLINESERVICES_REPORTS_REPORTSINTERFACE_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xACB2E50)
#define EPIC_ONLINESERVICES_REPORTS_REPORTSINTERFACE_SENDPLAYERBEHAVIORREPORT_OFFSET UNITYSDK_OFFSET(0xACB2F10)
#define EPIC_ONLINESERVICES_REPORTS_REPORTSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xACB2F00)
#define EPIC_ONLINESERVICES_REPORTS_REPORTSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xACB2EF0)
