...
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDDEFINITIONBYLEADERBOARDIDOPTIONS_GET_LEADERBOARDID_OFFSET UNITYSDK_OFFSET(0xAC340B0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDDEFINITIONBYLEADERBOARDIDOPTIONS_SET_LEADERBOARDID_OFFSET UNITYSDK_OFFSET(0xAC340C0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDDEFINITIONBYLEADERBOARDIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC340D0)
