...
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDDEFINITIONBYINDEX_OFFSET UNITYSDK_OFFSET(0xAC37A40)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDDEFINITIONBYLEADERBOARDID_OFFSET UNITYSDK_OFFSET(0xAC37C40)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDRECORDBYINDEX_OFFSET UNITYSDK_OFFSET(0xAC37ED0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDRECORDBYUSERID_OFFSET UNITYSDK_OFFSET(0xAC380D0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDUSERSCOREBYINDEX_OFFSET UNITYSDK_OFFSET(0xAC38340)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDUSERSCOREBYUSERID_OFFSET UNITYSDK_OFFSET(0xAC385D0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_GETLEADERBOARDDEFINITIONCOUNT_OFFSET UNITYSDK_OFFSET(0xAC387D0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_GETLEADERBOARDRECORDCOUNT_OFFSET UNITYSDK_OFFSET(0xAC38A10)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_GETLEADERBOARDUSERSCORECOUNT_OFFSET UNITYSDK_OFFSET(0xAC38C50)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_ONQUERYLEADERBOARDDEFINITIONSCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC37840)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC378E0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_ONQUERYLEADERBOARDUSERSCORESCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC37980)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_QUERYLEADERBOARDDEFINITIONS_OFFSET UNITYSDK_OFFSET(0xAC38E50)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_QUERYLEADERBOARDRANKS_OFFSET UNITYSDK_OFFSET(0xAC39030)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_QUERYLEADERBOARDUSERSCORES_OFFSET UNITYSDK_OFFSET(0xAC39210)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC37A30)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC37A20)
