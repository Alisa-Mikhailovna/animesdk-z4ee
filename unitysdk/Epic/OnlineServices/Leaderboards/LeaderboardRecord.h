...
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_GET_RANK_OFFSET UNITYSDK_OFFSET(0xAC36680)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_GET_SCORE_OFFSET UNITYSDK_OFFSET(0xAC366A0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_GET_USERDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xAC366C0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_GET_USERID_OFFSET UNITYSDK_OFFSET(0xAC36660)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_SET_1_OFFSET UNITYSDK_OFFSET(0xAC36AD0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_SET_OFFSET UNITYSDK_OFFSET(0xAC366E0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_SET_RANK_OFFSET UNITYSDK_OFFSET(0xAC36690)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_SET_SCORE_OFFSET UNITYSDK_OFFSET(0xAC366B0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_SET_USERDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xAC366D0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD_SET_USERID_OFFSET UNITYSDK_OFFSET(0xAC36670)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0xAC36C00)
