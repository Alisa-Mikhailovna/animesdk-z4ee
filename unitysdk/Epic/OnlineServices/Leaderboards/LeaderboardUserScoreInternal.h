...
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x49DB0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x6E20)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_GET_USERID_OFFSET UNITYSDK_OFFSET(0x49B90)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x49DA0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x49CC0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_SET_SCORE_OFFSET UNITYSDK_OFFSET(0x2A90)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCOREINTERNAL_SET_USERID_OFFSET UNITYSDK_OFFSET(0x49C00)
