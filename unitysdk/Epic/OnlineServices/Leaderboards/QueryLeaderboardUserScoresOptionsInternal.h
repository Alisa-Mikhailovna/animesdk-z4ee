...
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x4B1B0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4B130)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x4AFD0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x4B060)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x4B120)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x4AF40)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_STATINFO_OFFSET UNITYSDK_OFFSET(0x4AE20)
#define EPIC_ONLINESERVICES_LEADERBOARDS_QUERYLEADERBOARDUSERSCORESOPTIONSINTERNAL_SET_USERIDS_OFFSET UNITYSDK_OFFSET(0x4ADB0)
