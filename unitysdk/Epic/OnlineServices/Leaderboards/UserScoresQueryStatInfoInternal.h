...
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x4B5A0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_GET_AGGREGATION_OFFSET UNITYSDK_OFFSET(0x6E20)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_GET_STATNAME_OFFSET UNITYSDK_OFFSET(0x4B360)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x4B590)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_AGGREGATION_OFFSET UNITYSDK_OFFSET(0x2A90)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x4B4C0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x4B410)
