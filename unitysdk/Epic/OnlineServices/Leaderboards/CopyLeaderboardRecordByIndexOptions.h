...
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDRECORDBYINDEXOPTIONS_GET_LEADERBOARDRECORDINDEX_OFFSET UNITYSDK_OFFSET(0xAC34440)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDRECORDBYINDEXOPTIONS_SET_LEADERBOARDRECORDINDEX_OFFSET UNITYSDK_OFFSET(0xAC34450)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDRECORDBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xAC34460)
