...
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_BLOCKED_OFFSET UNITYSDK_OFFSET(0x6C3F0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x6010)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x6C150)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x6C260)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_PARTICIPANTID_OFFSET UNITYSDK_OFFSET(0x6C380)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFOINTERNAL_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x6C2D0)
