...
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC9BE90)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC9BEC0)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC9BE80)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC9BD90)
