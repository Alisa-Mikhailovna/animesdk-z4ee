...
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC9BD30)
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC9BD80)
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC9BD20)
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAC9BCB0)
