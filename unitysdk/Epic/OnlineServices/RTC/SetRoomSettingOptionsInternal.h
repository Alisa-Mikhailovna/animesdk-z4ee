...
#define EPIC_ONLINESERVICES_RTC_SETROOMSETTINGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6EE40)
#define EPIC_ONLINESERVICES_RTC_SETROOMSETTINGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x6EDC0)
#define EPIC_ONLINESERVICES_RTC_SETROOMSETTINGOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x6EAE0)
#define EPIC_ONLINESERVICES_RTC_SETROOMSETTINGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x6EDB0)
#define EPIC_ONLINESERVICES_RTC_SETROOMSETTINGOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x6EBA0)
#define EPIC_ONLINESERVICES_RTC_SETROOMSETTINGOPTIONSINTERNAL_SET_SETTINGNAME_OFFSET UNITYSDK_OFFSET(0x6EC50)
#define EPIC_ONLINESERVICES_RTC_SETROOMSETTINGOPTIONSINTERNAL_SET_SETTINGVALUE_OFFSET UNITYSDK_OFFSET(0x6ED00)
