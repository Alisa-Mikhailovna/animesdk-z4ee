...
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC9C0B0)
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC9C0E0)
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC9C0A0)
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC9BFB0)
