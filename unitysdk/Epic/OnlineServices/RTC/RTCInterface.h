...
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_ADDNOTIFYDISCONNECTED_OFFSET UNITYSDK_OFFSET(0xAC9DB10)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_ADDNOTIFYPARTICIPANTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0xAC9DD00)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_BLOCKPARTICIPANT_OFFSET UNITYSDK_OFFSET(0xAC9DEF0)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_GETAUDIOINTERFACE_OFFSET UNITYSDK_OFFSET(0xAC9E0D0)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_JOINROOM_OFFSET UNITYSDK_OFFSET(0xAC9E1B0)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_LEAVEROOM_OFFSET UNITYSDK_OFFSET(0xAC9E390)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_ONBLOCKPARTICIPANTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC9D7D0)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_ONDISCONNECTEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC9D870)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_ONJOINROOMCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC9D910)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_ONLEAVEROOMCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC9D9B0)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_ONPARTICIPANTSTATUSCHANGEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0xAC9DA50)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_REMOVENOTIFYDISCONNECTED_OFFSET UNITYSDK_OFFSET(0xAC9E570)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_REMOVENOTIFYPARTICIPANTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0xAC9E650)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_SETROOMSETTING_OFFSET UNITYSDK_OFFSET(0xAC9E730)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE_SETSETTING_OFFSET UNITYSDK_OFFSET(0xAC9E890)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC9DB00)
#define EPIC_ONLINESERVICES_RTC_RTCINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC9DAF0)
