...
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6D7F0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x6D770)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x6D5F0)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x6D760)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x6D6B0)
