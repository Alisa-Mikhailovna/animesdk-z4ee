...
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6D3B0)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x6D330)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_CLIENTBASEURL_OFFSET UNITYSDK_OFFSET(0x6CF90)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x6D1B0)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x6CE20)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_MANUALAUDIOINPUTENABLED_OFFSET UNITYSDK_OFFSET(0x6D1C0)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_MANUALAUDIOOUTPUTENABLED_OFFSET UNITYSDK_OFFSET(0x6D270)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x6D320)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_PARTICIPANTID_OFFSET UNITYSDK_OFFSET(0x6D0F0)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_PARTICIPANTTOKEN_OFFSET UNITYSDK_OFFSET(0x6D040)
#define EPIC_ONLINESERVICES_RTC_JOINROOMOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x6CEE0)
