...
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAC9B830)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAC9B860)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAC9B820)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAC9B730)
