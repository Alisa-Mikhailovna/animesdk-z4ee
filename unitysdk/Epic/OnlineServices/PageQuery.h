...
#define EPIC_ONLINESERVICES_PAGEQUERY_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0xAC73560)
#define EPIC_ONLINESERVICES_PAGEQUERY_GET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0xAC73540)
#define EPIC_ONLINESERVICES_PAGEQUERY_SET_1_OFFSET UNITYSDK_OFFSET(0xAC73600)
#define EPIC_ONLINESERVICES_PAGEQUERY_SET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0xAC73570)
#define EPIC_ONLINESERVICES_PAGEQUERY_SET_OFFSET UNITYSDK_OFFSET(0xAC73580)
#define EPIC_ONLINESERVICES_PAGEQUERY_SET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0xAC73550)
#define EPIC_ONLINESERVICES_PAGEQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0xAC73740)
