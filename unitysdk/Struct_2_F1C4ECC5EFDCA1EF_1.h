...
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x7F0C0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x14C630)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x14C5C0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x14C5B0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_GET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_GET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xCADE150)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xCADE110)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x14C590)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_SET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xDAE0)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_SET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0xC630)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x14C580)
#define STRUCT_2_F1C4ECC5EFDCA1EF_1__CTOR_OFFSET UNITYSDK_OFFSET(0x7F000)
