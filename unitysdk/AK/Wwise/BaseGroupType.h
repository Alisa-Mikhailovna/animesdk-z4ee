...
#define AK_WWISE_BASEGROUPTYPE_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1D19A5F0)
#define AK_WWISE_BASEGROUPTYPE_GET_GROUPID_1_OFFSET UNITYSDK_OFFSET(0x1D19A5B0)
#define AK_WWISE_BASEGROUPTYPE_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1D19A4C0)
#define AK_WWISE_BASEGROUPTYPE_GET_GROUPWWISEOBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D19A350)
#define AK_WWISE_BASEGROUPTYPE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1D19A500)
#define AK_WWISE_BASEGROUPTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19A770)
