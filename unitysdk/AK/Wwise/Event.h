...
#define AK_WWISE_EVENT_EXECUTEACTION_OFFSET UNITYSDK_OFFSET(0x1D19B160)
#define AK_WWISE_EVENT_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D19AE10)
#define AK_WWISE_EVENT_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1D19AE90)
#define AK_WWISE_EVENT_POSTMIDI_1_OFFSET UNITYSDK_OFFSET(0x1D19B300)
#define AK_WWISE_EVENT_POSTMIDI_OFFSET UNITYSDK_OFFSET(0x1D19B240)
#define AK_WWISE_EVENT_POST_1_OFFSET UNITYSDK_OFFSET(0x1D19AF70)
#define AK_WWISE_EVENT_POST_2_OFFSET UNITYSDK_OFFSET(0x1D19B060)
#define AK_WWISE_EVENT_POST_OFFSET UNITYSDK_OFFSET(0x1D19AEB0)
#define AK_WWISE_EVENT_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1D19AE20)
#define AK_WWISE_EVENT_STOPMIDI_1_OFFSET UNITYSDK_OFFSET(0x1D19B490)
#define AK_WWISE_EVENT_STOPMIDI_OFFSET UNITYSDK_OFFSET(0x1D19B3D0)
#define AK_WWISE_EVENT_STOP_OFFSET UNITYSDK_OFFSET(0x1D19B140)
#define AK_WWISE_EVENT_VERIFYPLAYINGID_OFFSET UNITYSDK_OFFSET(0x1D19AEA0)
#define AK_WWISE_EVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19B600)
