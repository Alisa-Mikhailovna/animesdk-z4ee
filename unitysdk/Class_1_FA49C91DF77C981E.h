...
#define CLASS_1_FA49C91DF77C981E_CLEAR_OFFSET UNITYSDK_OFFSET(0x1566C4D0)
#define CLASS_1_FA49C91DF77C981E_GET_REFERENCESTATE_OFFSET UNITYSDK_OFFSET(0x1566C510)
#define CLASS_1_FA49C91DF77C981E_METHOD_1_2FE338807A102453_OFFSET UNITYSDK_OFFSET(0x1566C480)
#define CLASS_1_FA49C91DF77C981E_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x1566C600)
#define CLASS_1_FA49C91DF77C981E_ONALLOC_OFFSET UNITYSDK_OFFSET(0x1566C530)
#define CLASS_1_FA49C91DF77C981E_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x1566C5B0)
#define CLASS_1_FA49C91DF77C981E_SET_REFERENCESTATE_OFFSET UNITYSDK_OFFSET(0x1566C520)
#define CLASS_1_FA49C91DF77C981E__CTOR_OFFSET UNITYSDK_OFFSET(0x1566C650)
