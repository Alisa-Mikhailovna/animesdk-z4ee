...
#define CLASS_1_F681AD6B57DC77A7_GET_BATTLEAREAID_OFFSET UNITYSDK_OFFSET(0xB6C15D0)
#define CLASS_1_F681AD6B57DC77A7_GET_BESTROUND_OFFSET UNITYSDK_OFFSET(0xB6C1690)
#define CLASS_1_F681AD6B57DC77A7_GET_BUFFS_OFFSET UNITYSDK_OFFSET(0xB6C1630)
#define CLASS_1_F681AD6B57DC77A7_GET_DISPLAYMONSTERID_OFFSET UNITYSDK_OFFSET(0xB6C15F0)
#define CLASS_1_F681AD6B57DC77A7_GET_ID_OFFSET UNITYSDK_OFFSET(0xB6C1590)
#define CLASS_1_F681AD6B57DC77A7_GET_MONSTERDECOIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xB6C1610)
#define CLASS_1_F681AD6B57DC77A7_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB6C1650)
#define CLASS_1_F681AD6B57DC77A7_GET_PASSEDLEVEL_OFFSET UNITYSDK_OFFSET(0xB6C1670)
#define CLASS_1_F681AD6B57DC77A7_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xB6C15B0)
#define CLASS_1_F681AD6B57DC77A7_SET_BATTLEAREAID_OFFSET UNITYSDK_OFFSET(0xB6C15E0)
#define CLASS_1_F681AD6B57DC77A7_SET_BESTROUND_OFFSET UNITYSDK_OFFSET(0xB6C16A0)
#define CLASS_1_F681AD6B57DC77A7_SET_BUFFS_OFFSET UNITYSDK_OFFSET(0xB6C1640)
#define CLASS_1_F681AD6B57DC77A7_SET_DISPLAYMONSTERID_OFFSET UNITYSDK_OFFSET(0xB6C1600)
#define CLASS_1_F681AD6B57DC77A7_SET_ID_OFFSET UNITYSDK_OFFSET(0xB6C15A0)
#define CLASS_1_F681AD6B57DC77A7_SET_MONSTERDECOIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xB6C1620)
#define CLASS_1_F681AD6B57DC77A7_SET_NAME_OFFSET UNITYSDK_OFFSET(0xB6C1660)
#define CLASS_1_F681AD6B57DC77A7_SET_PASSEDLEVEL_OFFSET UNITYSDK_OFFSET(0xB6C1680)
#define CLASS_1_F681AD6B57DC77A7_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xB6C15C0)
#define CLASS_1_F681AD6B57DC77A7__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C16B0)

inline static constexpr unsigned int Class_1_F681AD6B57DC77A7_TypeDefinitionIndex = 76062;
...
public:
	...
	::System::UInt32 _BestRound_k__BackingField; // 0x24
	::System::UInt32 _BattleAreaID_k__BackingField; // 0x28
	::System::UInt32 _StageID_k__BackingField; // 0x2C
	::System::UInt32 _DisplayMonsterID_k__BackingField; // 0x30
