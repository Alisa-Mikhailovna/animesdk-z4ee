...
#define CLASS_1_5B567C8A01BAEDFE_57_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C457350)
#define CLASS_1_5B567C8A01BAEDFE_57_CLONE_OFFSET UNITYSDK_OFFSET(0x1C456FF0)
#define CLASS_1_5B567C8A01BAEDFE_57_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C457150)
#define CLASS_1_5B567C8A01BAEDFE_57_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C457060)
#define CLASS_1_5B567C8A01BAEDFE_57_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C4572B0)
#define CLASS_1_5B567C8A01BAEDFE_57_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C4573A0)
#define CLASS_1_5B567C8A01BAEDFE_57_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C457370)
#define CLASS_1_5B567C8A01BAEDFE_57_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C456F40)
#define CLASS_1_5B567C8A01BAEDFE_57_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C456FA0)
#define CLASS_1_5B567C8A01BAEDFE_57_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C4572E0)
#define CLASS_1_5B567C8A01BAEDFE_57_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C457340)
#define CLASS_1_5B567C8A01BAEDFE_57__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4573F0)
#define CLASS_1_5B567C8A01BAEDFE_57__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C456FC0)
#define CLASS_1_5B567C8A01BAEDFE_57__CTOR_OFFSET UNITYSDK_OFFSET(0x1C456FB0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_57*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_57_TypeDefinitionIndex)->GetStaticField(0x541C0);
	}
