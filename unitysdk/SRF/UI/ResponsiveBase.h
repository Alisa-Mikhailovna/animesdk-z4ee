...
#define SRF_UI_RESPONSIVEBASE_DOREFRESH_OFFSET UNITYSDK_OFFSET(0x1CA0DF40)
#define SRF_UI_RESPONSIVEBASE_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1CA0DE40)
#define SRF_UI_RESPONSIVEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1CA0DE90)
#define SRF_UI_RESPONSIVEBASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1CA0DEA0)
#define SRF_UI_RESPONSIVEBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CA0DEB0)
#define SRF_UI_RESPONSIVEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA0DFC0)
