...
#define SRF_UI_STYLE_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1CA0FAF0)
#define SRF_UI_STYLE_COPY_OFFSET UNITYSDK_OFFSET(0x1CA0FA30)
#define SRF_UI_STYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA0FAD0)
