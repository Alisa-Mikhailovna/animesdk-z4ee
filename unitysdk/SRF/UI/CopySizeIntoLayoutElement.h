...
#define SRF_UI_COPYSIZEINTOLAYOUTELEMENT_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1CA08A60)
#define SRF_UI_COPYSIZEINTOLAYOUTELEMENT_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1CA089E0)
#define SRF_UI_COPYSIZEINTOLAYOUTELEMENT_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1CA08960)
#define SRF_UI_COPYSIZEINTOLAYOUTELEMENT_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1CA088E0)
#define SRF_UI_COPYSIZEINTOLAYOUTELEMENT_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x1CA08860)
#define SRF_UI_COPYSIZEINTOLAYOUTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA08A70)
