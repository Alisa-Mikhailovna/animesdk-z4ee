...
#define SRF_SERVICE_SRSERVICEMANAGER_AUTOCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x1CA05150)
#define SRF_SERVICE_SRSERVICEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1CA057D0)
#define SRF_SERVICE_SRSERVICEMANAGER_DEFAULTSERVICECONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1CA05D90)
#define SRF_SERVICE_SRSERVICEMANAGER_GETSERVICEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1CA04D30)
#define SRF_SERVICE_SRSERVICEMANAGER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x1CA04980)
#define SRF_SERVICE_SRSERVICEMANAGER_GETSTATICMETHODS_OFFSET UNITYSDK_OFFSET(0x1CA073E0)
#define SRF_SERVICE_SRSERVICEMANAGER_GET_ISLOADING_OFFSET UNITYSDK_OFFSET(0x1CA04D00)
#define SRF_SERVICE_SRSERVICEMANAGER_HASSERVICE_OFFSET UNITYSDK_OFFSET(0x1CA052E0)
#define SRF_SERVICE_SRSERVICEMANAGER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1CA06000)
#define SRF_SERVICE_SRSERVICEMANAGER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1CA05490)
#define SRF_SERVICE_SRSERVICEMANAGER_SCANTYPEFORCONSTRUCTORS_OFFSET UNITYSDK_OFFSET(0x1CA060A0)
#define SRF_SERVICE_SRSERVICEMANAGER_SCANTYPEFORSELECTORS_OFFSET UNITYSDK_OFFSET(0x1CA06A50)
#define SRF_SERVICE_SRSERVICEMANAGER_SCANTYPE_OFFSET UNITYSDK_OFFSET(0x1CA05C90)
#define SRF_SERVICE_SRSERVICEMANAGER_UNREGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1CA04F30)
#define SRF_SERVICE_SRSERVICEMANAGER_UPDATESTUBS_OFFSET UNITYSDK_OFFSET(0x1CA05890)
#define SRF_SERVICE_SRSERVICEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CA074C0)
#define SRF_SERVICE_SRSERVICEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA07490)
...
namespace SRF::Service
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Reflection::Assembly*>**)Il2CppClass::FromTypeDefinitionIndex(SRServiceManager_TypeDefinitionIndex)->GetStaticField(0x46570);
		}
		static ::System::Boolean* StaticGet__hasQuit()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SRServiceManager_TypeDefinitionIndex)->GetStaticField(0xB620);
		}
		static ::System::Int32* StaticGet_LoadingCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SRServiceManager_TypeDefinitionIndex)->GetStaticField(0xB624);
		}
