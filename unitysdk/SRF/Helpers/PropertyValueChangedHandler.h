...
#define SRF_HELPERS_PROPERTYVALUECHANGEDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C9FF150)
#define SRF_HELPERS_PROPERTYVALUECHANGEDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9FF180)
#define SRF_HELPERS_PROPERTYVALUECHANGEDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9FE9B0)
#define SRF_HELPERS_PROPERTYVALUECHANGEDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9FF0E0)
