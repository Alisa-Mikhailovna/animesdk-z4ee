...
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1CA034E0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_TRANSFORM__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CA035D0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_TRANSFORM__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CA03560)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1CA03650)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1CA035C0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CA03570)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CA034D0)
#define SRF_SRFTRANSFORMEXTENSIONS__GETCHILDREN_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA02D50)
