...
#define SRF_JSON_PARSER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CA000E0)
#define SRF_JSON_PARSER_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1CA00040)
#define SRF_JSON_PARSER_GET_NEXTCHAR_OFFSET UNITYSDK_OFFSET(0x1C9FF980)
#define SRF_JSON_PARSER_GET_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x1C9FFD70)
#define SRF_JSON_PARSER_GET_NEXTWORD_OFFSET UNITYSDK_OFFSET(0x1C9FF9E0)
#define SRF_JSON_PARSER_GET_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x1C9FF920)
#define SRF_JSON_PARSER_ISWORDBREAK_OFFSET UNITYSDK_OFFSET(0x1C9FFD10)
#define SRF_JSON_PARSER_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x1CA009D0)
#define SRF_JSON_PARSER_PARSEBYTOKEN_OFFSET UNITYSDK_OFFSET(0x1CA00AD0)
#define SRF_JSON_PARSER_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x1CA00B70)
#define SRF_JSON_PARSER_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x1CA00130)
#define SRF_JSON_PARSER_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x1CA002E0)
#define SRF_JSON_PARSER_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1CA00110)
#define SRF_JSON_PARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x1C9FF660)
#define SRF_JSON_PARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9FF8A0)
