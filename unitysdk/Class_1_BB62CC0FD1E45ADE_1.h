...
#define CLASS_1_BB62CC0FD1E45ADE_1_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A9E8C50)
#define CLASS_1_BB62CC0FD1E45ADE_1_ONALLOC_OFFSET UNITYSDK_OFFSET(0x1A9E8C90)
#define CLASS_1_BB62CC0FD1E45ADE_1_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x1A9E8CD0)
#define CLASS_1_BB62CC0FD1E45ADE_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9E8D10)
