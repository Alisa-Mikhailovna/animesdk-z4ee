...
#define CLASS_2_E59C28A7BDCC5D07_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14B45C50)
#define CLASS_2_E59C28A7BDCC5D07_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x14B46DA0)
#define CLASS_2_E59C28A7BDCC5D07_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x14B46200)
#define CLASS_2_E59C28A7BDCC5D07_METHOD_2_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x14B45CA0)
#define CLASS_2_E59C28A7BDCC5D07_METHOD_2_E6F2B746784C0C83_OFFSET UNITYSDK_OFFSET(0x14B466F0)
#define CLASS_2_E59C28A7BDCC5D07_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x14B46D40)
#define CLASS_2_E59C28A7BDCC5D07_ONSKIP_OFFSET UNITYSDK_OFFSET(0x14B46B90)
#define CLASS_2_E59C28A7BDCC5D07_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14B46300)
#define CLASS_2_E59C28A7BDCC5D07_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14B46750)
#define CLASS_2_E59C28A7BDCC5D07_TICK_OFFSET UNITYSDK_OFFSET(0x14B467A0)
#define CLASS_2_E59C28A7BDCC5D07__CTOR_OFFSET UNITYSDK_OFFSET(0x14B45C30)
...
public:
	...
	::RPG::GameCore::AdvEnablePropDialogMode* Field_2_5; // 0x40
	::RPG::Client::CameraDataAndFlags* Field_2_6; // 0x48
	::System::Single Field_2_7; // 0x50
	::System::Nullable_1<::UnityEngine::Vector3> Field_2_8; // 0x54
