...
#define SRMATH_ANGLE_OFFSET UNITYSDK_OFFSET(0x1CA13F40)
#define SRMATH_AVERAGE_OFFSET UNITYSDK_OFFSET(0x1CA13F30)
#define SRMATH_EASE_OFFSET UNITYSDK_OFFSET(0x1CA10B00)
#define SRMATH_FACINGNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1CA13BA0)
#define SRMATH_LERPUNCLAMPED_1_OFFSET UNITYSDK_OFFSET(0x1CA13B50)
#define SRMATH_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1CA13B30)
#define SRMATH_NEARESTANGLE_OFFSET UNITYSDK_OFFSET(0x1CA13D10)
#define SRMATH_SMOOTHCLAMP_OFFSET UNITYSDK_OFFSET(0x1CA139A0)
#define SRMATH_SPRINGLERP_1_OFFSET UNITYSDK_OFFSET(0x1CA13390)
#define SRMATH_SPRINGLERP_2_OFFSET UNITYSDK_OFFSET(0x1CA13560)
#define SRMATH_SPRINGLERP_3_OFFSET UNITYSDK_OFFSET(0x1CA13780)
#define SRMATH_SPRINGLERP_OFFSET UNITYSDK_OFFSET(0x1CA131F0)
#define SRMATH_WRAPANGLE_OFFSET UNITYSDK_OFFSET(0x1CA13CE0)
#define SRMATH_WRAP_1_OFFSET UNITYSDK_OFFSET(0x1CA13F00)
#define SRMATH_WRAP_OFFSET UNITYSDK_OFFSET(0x1CA13E50)
