...
#define MONODOLLYCAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB1EF100)
#define MONODOLLYCAMERACONTROLLER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB1EF3B0)
#define MONODOLLYCAMERACONTROLLER_SETCONTROLFOV_OFFSET UNITYSDK_OFFSET(0xB1EF530)
#define MONODOLLYCAMERACONTROLLER_STARTDOLLYPOINTANIM_OFFSET UNITYSDK_OFFSET(0xB1EF400)
#define MONODOLLYCAMERACONTROLLER_UPDATEBYTIMERATIO_OFFSET UNITYSDK_OFFSET(0xB1EF240)
#define MONODOLLYCAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB1EF1C0)
#define MONODOLLYCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB1EF5F0)
