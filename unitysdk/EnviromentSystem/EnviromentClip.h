...
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_3383F5B5B7F87651_OFFSET UNITYSDK_OFFSET(0x144D2FD0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_40EBA7013E4CCDDF_1_OFFSET UNITYSDK_OFFSET(0x145053C0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_40EBA7013E4CCDDF_2_OFFSET UNITYSDK_OFFSET(0x14505BC0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_40EBA7013E4CCDDF_OFFSET UNITYSDK_OFFSET(0x14505270)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x14505510)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x14505100)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_6BB3BCA076D98E60_OFFSET UNITYSDK_OFFSET(0x14505850)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_70D35EA6595005E0_OFFSET UNITYSDK_OFFSET(0x145051B0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_8E7FE57CA6DE88E1_OFFSET UNITYSDK_OFFSET(0x14505910)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_CFC9D07F42C4C720_OFFSET UNITYSDK_OFFSET(0x145055C0)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_D114AD6D57BD6A9C_OFFSET UNITYSDK_OFFSET(0x14505A60)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x14505780)
#define ENVIROMENTSYSTEM_ENVIROMENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x144D4B00)
