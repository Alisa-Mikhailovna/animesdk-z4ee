...
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x144CE200)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_1C409C2CC83887DC_OFFSET UNITYSDK_OFFSET(0x144CDF90)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_42BA9D7CE19718CB_OFFSET UNITYSDK_OFFSET(0x144CE400)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_582A1DD1E3B84C82_OFFSET UNITYSDK_OFFSET(0x144CE2A0)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x144CE390)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x144CDE50)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x144CDF00)
#define ENVIROMENTSYSTEM_ENVIROFLOATPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x144CDDC0)
