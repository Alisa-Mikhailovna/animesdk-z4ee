...
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_C436A2848092EB88_OFFSET UNITYSDK_OFFSET(0x144C5310)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_CA5F6DB703947009_OFFSET UNITYSDK_OFFSET(0x144C59C0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_D08A551686938D7D_OFFSET UNITYSDK_OFFSET(0x144C5810)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_E5630A859AA24FB3_OFFSET UNITYSDK_OFFSET(0x144C5090)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_E9EEDFB818CD2681_OFFSET UNITYSDK_OFFSET(0x144C5FC0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_EA7C9571288E1295_OFFSET UNITYSDK_OFFSET(0x144C6300)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_EBAB6A35C21A2A5B_OFFSET UNITYSDK_OFFSET(0x144C54C0)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY_METHOD_2_F8C7231308CD2C82_OFFSET UNITYSDK_OFFSET(0x144C5030)
#define ENVIROMENTSYSTEM_ENVIROASSETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x144C5110)
...
namespace EnviromentSystem
{
	...
	public:
		...
		{
			return (::Class_2_7F7BFA8C5E418566**)Il2CppClass::FromTypeDefinitionIndex(EnviroAssetProperty_TypeDefinitionIndex)->GetStaticField(0x37360);
		}
