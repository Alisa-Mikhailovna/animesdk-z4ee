...
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0x14505EE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_NAMEEX_OFFSET UNITYSDK_OFFSET(0x14505FD0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_GET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0x14505FB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_01244C5D42565CB2_OFFSET UNITYSDK_OFFSET(0x1450D2A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_063ADB01C44981A7_OFFSET UNITYSDK_OFFSET(0x1450D670)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0C42DDDF06BF692D_OFFSET UNITYSDK_OFFSET(0x14506040)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_0DABAC67FBEEEDA6_OFFSET UNITYSDK_OFFSET(0x14510A70)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1454625925CA73F5_OFFSET UNITYSDK_OFFSET(0x14510FE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_16E2C4C5C61F8FDB_OFFSET UNITYSDK_OFFSET(0x14508490)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x1450FE80)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B0CF56F555C9A93_OFFSET UNITYSDK_OFFSET(0x14510220)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_1B214D9710BB7534_OFFSET UNITYSDK_OFFSET(0x14510EB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2092EACB383790AB_OFFSET UNITYSDK_OFFSET(0x14506EB0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_283228DCA08F69C7_OFFSET UNITYSDK_OFFSET(0x14506290)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2839AE123F8ECAA7_OFFSET UNITYSDK_OFFSET(0x14506780)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2BA9010C7C33DCAE_OFFSET UNITYSDK_OFFSET(0x1450E2D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2BB7E72A7E700799_OFFSET UNITYSDK_OFFSET(0x14506450)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2DA5E14835AEFAD5_OFFSET UNITYSDK_OFFSET(0x145103B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_2F68009C40503107_OFFSET UNITYSDK_OFFSET(0x1450BD60)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_31B71B6D307F7F0C_OFFSET UNITYSDK_OFFSET(0x1450FFF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_33A7DE6DC0669409_OFFSET UNITYSDK_OFFSET(0x1450F6E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_35DD9F229AF5C1D0_1_OFFSET UNITYSDK_OFFSET(0x14510820)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_35DD9F229AF5C1D0_OFFSET UNITYSDK_OFFSET(0x144C8040)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_39CF31F4D7DD3B81_OFFSET UNITYSDK_OFFSET(0x1450F9A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_408445D4519BA880_OFFSET UNITYSDK_OFFSET(0x14508E10)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_41206355B1BC7902_OFFSET UNITYSDK_OFFSET(0x1450EE80)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0x1450D440)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4307B2A4B4A12C1A_2_OFFSET UNITYSDK_OFFSET(0x1450D720)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x14506E00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4E4D3005862CA49B_OFFSET UNITYSDK_OFFSET(0x1450FCE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_4FF38CFCA5B3077D_OFFSET UNITYSDK_OFFSET(0x145086C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_511BD23D89CDE949_OFFSET UNITYSDK_OFFSET(0x1450BC90)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_52084BFE92581342_OFFSET UNITYSDK_OFFSET(0x145104A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5A0DB1B7B9BE25BD_OFFSET UNITYSDK_OFFSET(0x14505E90)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_5D22ABED9373C2B3_OFFSET UNITYSDK_OFFSET(0x145108D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_658323AD993800CF_OFFSET UNITYSDK_OFFSET(0x14508BC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_6964C65990684D4A_OFFSET UNITYSDK_OFFSET(0x144EDB30)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_70D35EA6595005E0_OFFSET UNITYSDK_OFFSET(0x1450D1D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_722196BE0640FA62_OFFSET UNITYSDK_OFFSET(0x145063D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x14510430)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_79B90490025ABC83_OFFSET UNITYSDK_OFFSET(0x14510F00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7C70D627BA6F6091_OFFSET UNITYSDK_OFFSET(0x14510AF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_7EC8FB1E5C75BFDC_OFFSET UNITYSDK_OFFSET(0x1450F530)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_803856DB6C5D9DB5_OFFSET UNITYSDK_OFFSET(0x14511B20)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8F537CE539CF0103_OFFSET UNITYSDK_OFFSET(0x145109A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_8F673316E45525AC_OFFSET UNITYSDK_OFFSET(0x1450F0D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_9216B801ACD0B564_OFFSET UNITYSDK_OFFSET(0x145072C0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_98B7D142FBED6D85_OFFSET UNITYSDK_OFFSET(0x1450D7D0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0x1450FF60)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A50B0776CACF3F3C_OFFSET UNITYSDK_OFFSET(0x1450D8B0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A8C3CD0F3AB51701_OFFSET UNITYSDK_OFFSET(0x14510680)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_A9A048D3B4CDDD40_OFFSET UNITYSDK_OFFSET(0x1450E5A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AA05F99BBEDA8B55_OFFSET UNITYSDK_OFFSET(0x1450FB50)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AD7283B0EE0C18A1_OFFSET UNITYSDK_OFFSET(0x1450E950)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_AF36EBA0C8D1FBA2_OFFSET UNITYSDK_OFFSET(0x14508560)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B50425D0A09C6F35_OFFSET UNITYSDK_OFFSET(0x14510080)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B81E7C3D0102EBE3_OFFSET UNITYSDK_OFFSET(0x1450E3F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_B8988AFA2C9F74D0_OFFSET UNITYSDK_OFFSET(0x14507010)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C137F5CD6FDEBE03_OFFSET UNITYSDK_OFFSET(0x14505E40)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C17DDF50E9F40898_OFFSET UNITYSDK_OFFSET(0x1450FEF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_C706B1EC6D2E1C64_OFFSET UNITYSDK_OFFSET(0x14510BE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_CE13F95478F90C1E_OFFSET UNITYSDK_OFFSET(0x145077F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D33218A492B26449_OFFSET UNITYSDK_OFFSET(0x14508E70)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D60F4BA24E06086B_OFFSET UNITYSDK_OFFSET(0x1450BCE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_D92CEBF2FF830E5C_OFFSET UNITYSDK_OFFSET(0x1450BDE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_DCEDA9CA86F04212_OFFSET UNITYSDK_OFFSET(0x1450DDC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E34FD37B13C162FC_OFFSET UNITYSDK_OFFSET(0x14509A80)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_E59CAA2089D7E8B1_OFFSET UNITYSDK_OFFSET(0x1450D4F0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_ECCE25DC2E771DF4_OFFSET UNITYSDK_OFFSET(0x145043E0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F25FA9F7CFC308C3_1_OFFSET UNITYSDK_OFFSET(0x1450DBE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F25FA9F7CFC308C3_OFFSET UNITYSDK_OFFSET(0x1450DA00)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F441ACB416811999_OFFSET UNITYSDK_OFFSET(0x1450E750)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_F8EC8B3D73CFFDCF_OFFSET UNITYSDK_OFFSET(0x144CB890)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_METHOD_3_FA4F4834B590F55F_OFFSET UNITYSDK_OFFSET(0x1450EB40)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x145114A0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x14511460)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_ACTIVEPROFILETRANSITIONTARGET_OFFSET UNITYSDK_OFFSET(0x14505EF0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_NAMEEX_OFFSET UNITYSDK_OFFSET(0x14505FE0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE_SET_PROFILEPATHEX_OFFSET UNITYSDK_OFFSET(0x14505FC0)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CCTOR_OFFSET UNITYSDK_OFFSET(0x14511C50)
#define ENVIROMENTSYSTEM_ENVIROMENTPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x14511BA0)
...
namespace EnviromentSystem
{
	...
	public:
		...
		{
			return (::EnviromentSystem::EnviromentProfile**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x38570);
		}
		static ::System::Collections::Generic::List_1<::EnviromentSystem::EnviroProperty*>** StaticGet__LoadResources()
		{
			return (::System::Collections::Generic::List_1<::EnviromentSystem::EnviroProperty*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x38578);
		}
		static ::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>** StaticGet__DefaultProfilePool()
		{
			return (::System::Collections::Generic::Stack_1<::EnviromentSystem::EnviromentProfile*>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x38580);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>** StaticGet__EnvPropShaderIDToIndex()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x38588);
		}
		static ::System::Int32* StaticGet_TransitionRateID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x90E0);
		}
		static ::System::Int32* StaticGet_ShadowDirID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x90E4);
		}
		static ::System::Int32* StaticGet_GlobalRotMatrixID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnviromentProfile_TypeDefinitionIndex)->GetStaticField(0x90E8);
		}
