...
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x144CCB80)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_1C409C2CC83887DC_OFFSET UNITYSDK_OFFSET(0x144CC910)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_582A1DD1E3B84C82_OFFSET UNITYSDK_OFFSET(0x144CCC20)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_7A9EE6E4B8F1006C_OFFSET UNITYSDK_OFFSET(0x144CC7F0)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY_METHOD_2_F18927F2B6DBB806_OFFSET UNITYSDK_OFFSET(0x144CCD80)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x144CC740)
#define ENVIROMENTSYSTEM_ENVIROBOOLPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x144CC690)
