...
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_08DCF72FBE01FF99_OFFSET UNITYSDK_OFFSET(0x145002E0)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x144FF910)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_2B7DFCAE3F6E482C_OFFSET UNITYSDK_OFFSET(0x144FFA50)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_42CCF630B15654B3_OFFSET UNITYSDK_OFFSET(0x14500150)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_582A1DD1E3B84C82_OFFSET UNITYSDK_OFFSET(0x144FF820)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_8BC536D520573A26_OFFSET UNITYSDK_OFFSET(0x144FFF40)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x144FF9B0)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_AF2CFBAAD2629B3B_OFFSET UNITYSDK_OFFSET(0x144FF5A0)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x14500020)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x145003E0)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x145003A0)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY_METHOD_3_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x144FFED0)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x144FF500)
#define ENVIROMENTSYSTEM_ENVIROTEXTUREPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x144D49C0)
