...
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x144CDB50)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_42BA9D7CE19718CB_OFFSET UNITYSDK_OFFSET(0x144CDCE0)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_582A1DD1E3B84C82_OFFSET UNITYSDK_OFFSET(0x144CDBF0)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_AF2CFBAAD2629B3B_OFFSET UNITYSDK_OFFSET(0x144CD910)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x144CDD50)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x144CD880)
#define ENVIROMENTSYSTEM_ENVIROENUMPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x144CD7E0)
