...
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_4857357D5C1BFCE8_OFFSET UNITYSDK_OFFSET(0x144F8360)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_61929A3103595552_OFFSET UNITYSDK_OFFSET(0x144F9C60)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_7BFD8B75F101C6D3_OFFSET UNITYSDK_OFFSET(0x144F7FF0)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_86A9E8386FA23FF4_OFFSET UNITYSDK_OFFSET(0x144F8FD0)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0x144F94F0)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_9D455FE4693966A8_OFFSET UNITYSDK_OFFSET(0x144FA1E0)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0x144FA010)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_DCCE11FE949CAADF_OFFSET UNITYSDK_OFFSET(0x144F9E00)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0x144FA320)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY_METHOD_3_F762974E778A9B95_OFFSET UNITYSDK_OFFSET(0x144F89C0)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x144F7B30)
#define ENVIROMENTSYSTEM_ENVIROREFLECTIONPROBEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x144ECA00)
