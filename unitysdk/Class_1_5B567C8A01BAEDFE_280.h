...
#define CLASS_1_5B567C8A01BAEDFE_280_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C11BF60)
#define CLASS_1_5B567C8A01BAEDFE_280_CLONE_OFFSET UNITYSDK_OFFSET(0x1C11BC50)
#define CLASS_1_5B567C8A01BAEDFE_280_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C11BD60)
#define CLASS_1_5B567C8A01BAEDFE_280_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C11BC90)
#define CLASS_1_5B567C8A01BAEDFE_280_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C11BEC0)
#define CLASS_1_5B567C8A01BAEDFE_280_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C11BFB0)
#define CLASS_1_5B567C8A01BAEDFE_280_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C11BF80)
#define CLASS_1_5B567C8A01BAEDFE_280_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C11BBD0)
#define CLASS_1_5B567C8A01BAEDFE_280_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C11BC00)
#define CLASS_1_5B567C8A01BAEDFE_280_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C11BEF0)
#define CLASS_1_5B567C8A01BAEDFE_280_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C11BF50)
#define CLASS_1_5B567C8A01BAEDFE_280__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C11C000)
#define CLASS_1_5B567C8A01BAEDFE_280__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C11BC20)
#define CLASS_1_5B567C8A01BAEDFE_280__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11BC10)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_280*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_280_TypeDefinitionIndex)->GetStaticField(0x1A070);
	}
