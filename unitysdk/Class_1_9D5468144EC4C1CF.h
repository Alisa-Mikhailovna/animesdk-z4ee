...
#define CLASS_1_9D5468144EC4C1CF_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C7C4EC0)
#define CLASS_1_9D5468144EC4C1CF_CLONE_OFFSET UNITYSDK_OFFSET(0x1C7C4A40)
#define CLASS_1_9D5468144EC4C1CF_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C7C4C20)
#define CLASS_1_9D5468144EC4C1CF_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C7C4AA0)
#define CLASS_1_9D5468144EC4C1CF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C7C4D40)
#define CLASS_1_9D5468144EC4C1CF_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C7C5000)
#define CLASS_1_9D5468144EC4C1CF_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C7C4F60)
#define CLASS_1_9D5468144EC4C1CF_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C7C48D0)
#define CLASS_1_9D5468144EC4C1CF_METHOD_1_96F1CABDCC6E782E_OFFSET UNITYSDK_OFFSET(0x1C7C4A90)
#define CLASS_1_9D5468144EC4C1CF_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C7C4930)
#define CLASS_1_9D5468144EC4C1CF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C7C4DB0)
#define CLASS_1_9D5468144EC4C1CF_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C7C4E10)
#define CLASS_1_9D5468144EC4C1CF__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C7C51C0)
#define CLASS_1_9D5468144EC4C1CF__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C7C4990)
#define CLASS_1_9D5468144EC4C1CF__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7C4940)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_9D5468144EC4C1CF*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9D5468144EC4C1CF_TypeDefinitionIndex)->GetStaticField(0x21490);
	}
	static ::Google::Protobuf::FieldCodec_1<::Proto::BigDataAvatarRelicRecommend*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::BigDataAvatarRelicRecommend*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9D5468144EC4C1CF_TypeDefinitionIndex)->GetStaticField(0x21498);
	}
