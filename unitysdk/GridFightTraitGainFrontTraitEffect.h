...
#define GRIDFIGHTTRAITGAINFRONTTRAITEFFECT_GETFRONTTRAITS_OFFSET UNITYSDK_OFFSET(0x149E3440)
#define GRIDFIGHTTRAITGAINFRONTTRAITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x149E3430)
#define GRIDFIGHTTRAITGAINFRONTTRAITEFFECT__GETFRONTTRAITS_B__1_0_OFFSET UNITYSDK_OFFSET(0x149E3860)
