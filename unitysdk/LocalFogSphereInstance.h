...
#define LOCALFOGSPHEREINSTANCE_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0xAFC9F20)
#define LOCALFOGSPHEREINSTANCE_GETTYPEID_OFFSET UNITYSDK_OFFSET(0xAFC9ED0)
#define LOCALFOGSPHEREINSTANCE_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0xAFC8D40)
#define LOCALFOGSPHEREINSTANCE_METHOD_6_151F18E94867FFE1_OFFSET UNITYSDK_OFFSET(0xAFC9070)
#define LOCALFOGSPHEREINSTANCE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAFC95F0)
#define LOCALFOGSPHEREINSTANCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAFC9520)
#define LOCALFOGSPHEREINSTANCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAFC90F0)
#define LOCALFOGSPHEREINSTANCE_ONGETFROMPOOLASYNC_OFFSET UNITYSDK_OFFSET(0xAFC9E30)
#define LOCALFOGSPHEREINSTANCE_ONOBJECTCREATEDASYNC_OFFSET UNITYSDK_OFFSET(0xAFC9CD0)
#define LOCALFOGSPHEREINSTANCE_ONOBJECTDESTROY_OFFSET UNITYSDK_OFFSET(0xAFC9FA0)
#define LOCALFOGSPHEREINSTANCE_ONOBJECTENABLE_OFFSET UNITYSDK_OFFSET(0xAFCA070)
#define LOCALFOGSPHEREINSTANCE_ONPREUNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xAFCA020)
#define LOCALFOGSPHEREINSTANCE_ONPUTTOPOOL_OFFSET UNITYSDK_OFFSET(0xAFC9DF0)
#define LOCALFOGSPHEREINSTANCE_ONRELEASE_OFFSET UNITYSDK_OFFSET(0xAFC9F60)
#define LOCALFOGSPHEREINSTANCE_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xAFC9C60)
#define LOCALFOGSPHEREINSTANCE_ONUNSERIALIZEFINISH_OFFSET UNITYSDK_OFFSET(0xAFC9FE0)
#define LOCALFOGSPHEREINSTANCE_SETENABLE_OFFSET UNITYSDK_OFFSET(0xAFC9950)
#define LOCALFOGSPHEREINSTANCE_SETHOSTMANAGEDLIGHT_OFFSET UNITYSDK_OFFSET(0xAFC9E80)
#define LOCALFOGSPHEREINSTANCE_SETTSC_OFFSET UNITYSDK_OFFSET(0xAFC9790)
#define LOCALFOGSPHEREINSTANCE_UNSERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0xAFC99B0)
#define LOCALFOGSPHEREINSTANCE_UPDATEMATERIALBLOCK_OFFSET UNITYSDK_OFFSET(0xAFC9340)
#define LOCALFOGSPHEREINSTANCE_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0xAFC96B0)
#define LOCALFOGSPHEREINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0xAFCA110)
#define LOCALFOGSPHEREINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xAFCA0B0)
#define LOCALFOGSPHEREINSTANCE__UNSERIALIZEASYNC_B__39_0_OFFSET UNITYSDK_OFFSET(0xAFCA130)
#define LOCALFOGSPHEREINSTANCE__UNSERIALIZEASYNC_B__39_1_OFFSET UNITYSDK_OFFSET(0xAFCA180)
#define LOCALFOGSPHEREINSTANCE__UNSERIALIZEASYNC_B__39_2_OFFSET UNITYSDK_OFFSET(0xAFCA1D0)
#define LOCALFOGSPHEREINSTANCE__UNSERIALIZEASYNC_B__39_3_OFFSET UNITYSDK_OFFSET(0xAFCA220)
#define LOCALFOGSPHEREINSTANCE__UNSERIALIZEASYNC_B__39_4_OFFSET UNITYSDK_OFFSET(0xAFCA270)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(LocalFogSphereInstance_TypeDefinitionIndex)->GetStaticField(0x62B80);
	}
	static ::System::String** StaticGet_Field_6_1()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(LocalFogSphereInstance_TypeDefinitionIndex)->GetStaticField(0x62B88);
	}
