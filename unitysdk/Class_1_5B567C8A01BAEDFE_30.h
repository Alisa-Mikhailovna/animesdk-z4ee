...
#define CLASS_1_5B567C8A01BAEDFE_30_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BE81C00)
#define CLASS_1_5B567C8A01BAEDFE_30_CLONE_OFFSET UNITYSDK_OFFSET(0x1BE818F0)
#define CLASS_1_5B567C8A01BAEDFE_30_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BE81A00)
#define CLASS_1_5B567C8A01BAEDFE_30_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BE81930)
#define CLASS_1_5B567C8A01BAEDFE_30_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BE81B60)
#define CLASS_1_5B567C8A01BAEDFE_30_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BE81C50)
#define CLASS_1_5B567C8A01BAEDFE_30_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BE81C20)
#define CLASS_1_5B567C8A01BAEDFE_30_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BE81870)
#define CLASS_1_5B567C8A01BAEDFE_30_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BE818A0)
#define CLASS_1_5B567C8A01BAEDFE_30_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BE81B90)
#define CLASS_1_5B567C8A01BAEDFE_30_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BE81BF0)
#define CLASS_1_5B567C8A01BAEDFE_30__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BE81CA0)
#define CLASS_1_5B567C8A01BAEDFE_30__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BE818C0)
#define CLASS_1_5B567C8A01BAEDFE_30__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE818B0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_30*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_30_TypeDefinitionIndex)->GetStaticField(0x51600);
	}
