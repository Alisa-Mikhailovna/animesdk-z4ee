...
#define CLASS_2_C33602C0D64FA524_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xB599B90)
#define CLASS_2_C33602C0D64FA524_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xB59A0A0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_00A4B38C951C5BD5_OFFSET UNITYSDK_OFFSET(0xB599230)
#define CLASS_2_C33602C0D64FA524_METHOD_2_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0xB598770)
#define CLASS_2_C33602C0D64FA524_METHOD_2_266E1F1B4DF2F723_OFFSET UNITYSDK_OFFSET(0xB597010)
#define CLASS_2_C33602C0D64FA524_METHOD_2_33ABFC364E341C89_OFFSET UNITYSDK_OFFSET(0xB598350)
#define CLASS_2_C33602C0D64FA524_METHOD_2_3B7F6352EF818AEA_OFFSET UNITYSDK_OFFSET(0xB5978A0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xB597160)
#define CLASS_2_C33602C0D64FA524_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0xB5975B0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_50131F4CF014469C_OFFSET UNITYSDK_OFFSET(0xB597DA0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_5022DB1DC5AA8CB4_OFFSET UNITYSDK_OFFSET(0xB598D30)
#define CLASS_2_C33602C0D64FA524_METHOD_2_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xB5972E0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_6E3EE215C182DE98_OFFSET UNITYSDK_OFFSET(0xB596F10)
#define CLASS_2_C33602C0D64FA524_METHOD_2_84516C3E776F194F_OFFSET UNITYSDK_OFFSET(0xB598230)
#define CLASS_2_C33602C0D64FA524_METHOD_2_8A3D91A38AD395C0_OFFSET UNITYSDK_OFFSET(0xB597780)
#define CLASS_2_C33602C0D64FA524_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xB598550)
#define CLASS_2_C33602C0D64FA524_METHOD_2_9839DFE3C10E4654_OFFSET UNITYSDK_OFFSET(0xB5985C0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_A27B39323ED04C8E_OFFSET UNITYSDK_OFFSET(0xB598DD0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_A6B0F2C779192279_OFFSET UNITYSDK_OFFSET(0xB597640)
#define CLASS_2_C33602C0D64FA524_METHOD_2_AAD21DE195D05736_OFFSET UNITYSDK_OFFSET(0xB5982C0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xB597A50)
#define CLASS_2_C33602C0D64FA524_METHOD_2_B888BDD107E26FEC_OFFSET UNITYSDK_OFFSET(0xB597CA0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xB599A90)
#define CLASS_2_C33602C0D64FA524_METHOD_2_CB8E229BDF290D41_OFFSET UNITYSDK_OFFSET(0xB598AC0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xB597AE0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_D53F77FB0786250F_OFFSET UNITYSDK_OFFSET(0xB5983E0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_DA1BF2C227DC3D86_1_OFFSET UNITYSDK_OFFSET(0xB5992D0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_DA1BF2C227DC3D86_2_OFFSET UNITYSDK_OFFSET(0xB599320)
#define CLASS_2_C33602C0D64FA524_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xB599280)
#define CLASS_2_C33602C0D64FA524_METHOD_2_EF249BECB59278D9_OFFSET UNITYSDK_OFFSET(0xB597B90)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0xB599430)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0xB5994F0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_3_OFFSET UNITYSDK_OFFSET(0xB5995B0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_4_OFFSET UNITYSDK_OFFSET(0xB599670)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_5_OFFSET UNITYSDK_OFFSET(0xB599730)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_6_OFFSET UNITYSDK_OFFSET(0xB5997C0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_7_OFFSET UNITYSDK_OFFSET(0xB599850)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_8_OFFSET UNITYSDK_OFFSET(0xB599910)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_9_OFFSET UNITYSDK_OFFSET(0xB5999D0)
#define CLASS_2_C33602C0D64FA524_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xB599370)
#define CLASS_2_C33602C0D64FA524_ONACQUIRE_OFFSET UNITYSDK_OFFSET(0xB596EB0)
#define CLASS_2_C33602C0D64FA524_ONRETURN_OFFSET UNITYSDK_OFFSET(0xB597100)
#define CLASS_2_C33602C0D64FA524__CTOR_OFFSET UNITYSDK_OFFSET(0xB59A580)
#define CLASS_2_C33602C0D64FA524__ONBIND_OFFSET UNITYSDK_OFFSET(0xB596570)
#define CLASS_2_C33602C0D64FA524__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xB597410)
#define CLASS_2_C33602C0D64FA524__ONTICK_OFFSET UNITYSDK_OFFSET(0xB597470)

inline static constexpr unsigned int Class_2_C33602C0D64FA524_TypeDefinitionIndex = 68835;
...
public:
	...
	::RPG::GameCore::CharacterDataComponent* Field_2_11; // 0x78
	::UnityEngine::Transform* Field_2_12; // 0x80
	::Class_2_38CD28B3D11A00DD* Field_2_13; // 0x88
	::Class_2_B26B9A6AA507E78F* Field_2_14; // 0x90
	::RPG::GameCore::GameEntity* Field_2_15; // 0x98
	::RPG::Client::MonoInControlTip* Field_2_16; // 0xA0
	::Class_2_D3061860904844A0* Field_2_17; // 0xA8
	...
	::UnityEngine::Animation* Field_2_24; // 0xE0
	::RPG::GameCore::BattleInstance* Field_2_25; // 0xE8
	::UnityEngine::Transform* Field_2_26; // 0xF0
	::Class_2_01E36AFA5FDDCBCA* Field_2_27; // 0xF8
	::Class_2_E0065B933D71D9A9* Field_2_28; // 0x100
	::Class_2_A7947638CBFEF9CF* Field_2_29; // 0x108
	::UnityEngine::GameObject* Field_2_30; // 0x110
	::UnityEngine::Transform* Field_2_31; // 0x118
	::Class_2_BEBFA6F35799FF11* Field_2_32; // 0x120
	::Class_2_6E096A5FCBA7A3BD* Field_2_33; // 0x128
	::Class_2_F9B8FAD13AB85B32_1* Field_2_34; // 0x130
	::RPG::GameCore::BossHeadEffType Field_2_35; // 0x138
	::System::Boolean Field_2_36; // 0x13C
	::System::Boolean Field_2_37; // 0x13D
	::System::Boolean Field_2_38; // 0x13E
	::System::Boolean Field_2_39; // 0x13F
	::RPG::GameCore::MonsterEnergyBarType Field_2_40; // 0x140
