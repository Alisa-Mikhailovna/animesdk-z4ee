...
#define CLASS_3_6334D7D4A4FC7A34_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAF7B170)
#define CLASS_3_6334D7D4A4FC7A34_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAF7B030)
#define CLASS_3_6334D7D4A4FC7A34_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAF7B100)
#define CLASS_3_6334D7D4A4FC7A34_TICK_OFFSET UNITYSDK_OFFSET(0xAF7B0A0)
#define CLASS_3_6334D7D4A4FC7A34__CTOR_OFFSET UNITYSDK_OFFSET(0xAF7B000)
