...
#define CLASS_2_E7B39FEF49984CE9___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x156ABD40)
#define CLASS_2_E7B39FEF49984CE9___C__CTOR_OFFSET UNITYSDK_OFFSET(0x156ABD70)
#define CLASS_2_E7B39FEF49984CE9___C__GETCONTENT_B__8_0_OFFSET UNITYSDK_OFFSET(0x156ABD80)
...
public:
	...
	{
		return (::System::Comparison_1<::Class_2_E7B39FEF49984CE9_Class_1_FA7091ADF2A6A8DC*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E7B39FEF49984CE9___c_TypeDefinitionIndex)->GetStaticField(0x4C570);
	}
	static ::Class_2_E7B39FEF49984CE9___c** StaticGet___9()
	{
		return (::Class_2_E7B39FEF49984CE9___c**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E7B39FEF49984CE9___c_TypeDefinitionIndex)->GetStaticField(0x4C578);
	}
