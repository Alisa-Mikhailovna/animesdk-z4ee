...
#define CLASS_1_EFF03B82D1C2B1F6_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xB45FCF0)
#define CLASS_1_EFF03B82D1C2B1F6_EQUALS_OFFSET UNITYSDK_OFFSET(0xB45FC60)
#define CLASS_1_EFF03B82D1C2B1F6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xB45FE00)
#define CLASS_1_EFF03B82D1C2B1F6_GET_CURRENTEXP_OFFSET UNITYSDK_OFFSET(0xB45FBC0)
#define CLASS_1_EFF03B82D1C2B1F6_GET_DRESSEDSKINID_OFFSET UNITYSDK_OFFSET(0xB45FBE0)
#define CLASS_1_EFF03B82D1C2B1F6_GET_EIDOLONLEVEL_OFFSET UNITYSDK_OFFSET(0xB45FBA0)
#define CLASS_1_EFF03B82D1C2B1F6_GET_EQUIPPEDLIGHTCONE_OFFSET UNITYSDK_OFFSET(0xB45FC20)
#define CLASS_1_EFF03B82D1C2B1F6_GET_EQUIPPEDRELICS_OFFSET UNITYSDK_OFFSET(0xB45FC00)
#define CLASS_1_EFF03B82D1C2B1F6_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xB45FB60)
#define CLASS_1_EFF03B82D1C2B1F6_GET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xB45FB80)
#define CLASS_1_EFF03B82D1C2B1F6_GET_TRACENODES_OFFSET UNITYSDK_OFFSET(0xB45FC40)
#define CLASS_1_EFF03B82D1C2B1F6_METHOD_1_148214CEA2F00B70_OFFSET UNITYSDK_OFFSET(0xB460090)
#define CLASS_1_EFF03B82D1C2B1F6_METHOD_1_6062BB7D9634C869_OFFSET UNITYSDK_OFFSET(0xB45FFB0)
#define CLASS_1_EFF03B82D1C2B1F6_SET_CURRENTEXP_OFFSET UNITYSDK_OFFSET(0xB45FBD0)
#define CLASS_1_EFF03B82D1C2B1F6_SET_DRESSEDSKINID_OFFSET UNITYSDK_OFFSET(0xB45FBF0)
#define CLASS_1_EFF03B82D1C2B1F6_SET_EIDOLONLEVEL_OFFSET UNITYSDK_OFFSET(0xB45FBB0)
#define CLASS_1_EFF03B82D1C2B1F6_SET_EQUIPPEDLIGHTCONE_OFFSET UNITYSDK_OFFSET(0xB45FC30)
#define CLASS_1_EFF03B82D1C2B1F6_SET_EQUIPPEDRELICS_OFFSET UNITYSDK_OFFSET(0xB45FC10)
#define CLASS_1_EFF03B82D1C2B1F6_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xB45FB70)
#define CLASS_1_EFF03B82D1C2B1F6_SET_PROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xB45FB90)
#define CLASS_1_EFF03B82D1C2B1F6_SET_TRACENODES_OFFSET UNITYSDK_OFFSET(0xB45FC50)
#define CLASS_1_EFF03B82D1C2B1F6__CCTOR_OFFSET UNITYSDK_OFFSET(0xB460180)
#define CLASS_1_EFF03B82D1C2B1F6__CTOR_OFFSET UNITYSDK_OFFSET(0xB460170)
...
public:
	...
	{
		return (::Class_1_EFF03B82D1C2B1F6**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EFF03B82D1C2B1F6_TypeDefinitionIndex)->GetStaticField(0x526F0);
	}
	::System::Collections::Generic::IReadOnlyList_1<::Struct_2_BAC064D277DD99F1>* _TraceNodes_k__BackingField; // 0x10
	::System::Collections::Generic::IReadOnlyList_1<::Class_0_16E4307DCC419505_385*>* _EquippedRelics_k__BackingField; // 0x18
	::Class_0_16E4307DCC419505_386* _EquippedLightCone_k__BackingField; // 0x20
