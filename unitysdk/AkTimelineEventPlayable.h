...
#define AKTIMELINEEVENTPLAYABLE_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1D23CDA0)
#define AKTIMELINEEVENTPLAYABLE_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1D23CD90)
#define AKTIMELINEEVENTPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D23D340)
