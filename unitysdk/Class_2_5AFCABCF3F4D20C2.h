...
#define CLASS_2_5AFCABCF3F4D20C2_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x14B1D5B0)
#define CLASS_2_5AFCABCF3F4D20C2_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x14B1D560)
#define CLASS_2_5AFCABCF3F4D20C2_METHOD_2_1D3572C54A6CB01D_OFFSET UNITYSDK_OFFSET(0x14B1D510)
#define CLASS_2_5AFCABCF3F4D20C2__CTOR_OFFSET UNITYSDK_OFFSET(0x14B1D600)
