...
#define AKSOUNDENGINE_GAMEOBJECTHASHFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D20CA70)
#define AKSOUNDENGINE_GAMEOBJECTHASHFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D20CAA0)
#define AKSOUNDENGINE_GAMEOBJECTHASHFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D20AF60)
#define AKSOUNDENGINE_GAMEOBJECTHASHFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20CA00)
