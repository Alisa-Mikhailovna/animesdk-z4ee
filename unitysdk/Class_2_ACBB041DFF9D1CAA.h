...
#define CLASS_2_ACBB041DFF9D1CAA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAD40B20)
#define CLASS_2_ACBB041DFF9D1CAA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAD40B60)
#define CLASS_2_ACBB041DFF9D1CAA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAD40BC0)
#define CLASS_2_ACBB041DFF9D1CAA_TICK_OFFSET UNITYSDK_OFFSET(0xAD40C10)
#define CLASS_2_ACBB041DFF9D1CAA__CTOR_OFFSET UNITYSDK_OFFSET(0xAD40B10)
