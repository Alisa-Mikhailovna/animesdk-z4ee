...
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_READPROPERTIES_OFFSET UNITYSDK_OFFSET(0xAA6A230)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_READ_OFFSET UNITYSDK_OFFSET(0x26D70)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x26D20)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_WRITEPROPERTIES_OFFSET UNITYSDK_OFFSET(0xAA64C20)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_WRITE_OFFSET UNITYSDK_OFFSET(0x26D60)
