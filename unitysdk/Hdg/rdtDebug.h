...
#define HDG_RDTDEBUG_ASSERT_OFFSET UNITYSDK_OFFSET(0xAA6D510)
#define HDG_RDTDEBUG_DEBUG_1_OFFSET UNITYSDK_OFFSET(0xAA6B320)
#define HDG_RDTDEBUG_DEBUG_OFFSET UNITYSDK_OFFSET(0xAA5DF70)
#define HDG_RDTDEBUG_ERROR_1_OFFSET UNITYSDK_OFFSET(0xAA5FAA0)
#define HDG_RDTDEBUG_ERROR_2_OFFSET UNITYSDK_OFFSET(0xAA6BE30)
#define HDG_RDTDEBUG_ERROR_OFFSET UNITYSDK_OFFSET(0xAA6D450)
#define HDG_RDTDEBUG_INFO_1_OFFSET UNITYSDK_OFFSET(0xAA6D330)
#define HDG_RDTDEBUG_INFO_OFFSET UNITYSDK_OFFSET(0xAA6D2E0)
#define HDG_RDTDEBUG_LOG_1_OFFSET UNITYSDK_OFFSET(0xAA6CEA0)
#define HDG_RDTDEBUG_LOG_2_OFFSET UNITYSDK_OFFSET(0xAA6D120)
#define HDG_RDTDEBUG_LOG_OFFSET UNITYSDK_OFFSET(0xAA6CBD0)
#define HDG_RDTDEBUG_WARNING_1_OFFSET UNITYSDK_OFFSET(0xAA6D400)
#define HDG_RDTDEBUG_WARNING_OFFSET UNITYSDK_OFFSET(0xAA5EF60)
#define HDG_RDTDEBUG__CCTOR_OFFSET UNITYSDK_OFFSET(0xAA6D5D0)
#define HDG_RDTDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xAA6D5C0)
...
namespace Hdg
{
	...
	public:
		...
		{
			return (::Hdg::rdtDebug_LogLevel*)Il2CppClass::FromTypeDefinitionIndex(rdtDebug_TypeDefinitionIndex)->GetStaticField(0x3890);
		}
