...
#define HDG_RDTSERIALIZERREGISTRY_CONVERTOBJECTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA7C9E0)
#define HDG_RDTSERIALIZERREGISTRY_CONVERTOBJECTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA7CA20)
#define HDG_RDTSERIALIZERREGISTRY_CONVERTOBJECTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA7A410)
#define HDG_RDTSERIALIZERREGISTRY_CONVERTOBJECTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xAA7C8F0)
