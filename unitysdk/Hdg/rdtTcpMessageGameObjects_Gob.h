...
#define HDG_RDTTCPMESSAGEGAMEOBJECTS_GOB_EQUALS_OFFSET UNITYSDK_OFFSET(0x27070)
#define HDG_RDTTCPMESSAGEGAMEOBJECTS_GOB_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6E20)
#define HDG_RDTTCPMESSAGEGAMEOBJECTS_GOB_READ_OFFSET UNITYSDK_OFFSET(0x27120)
#define HDG_RDTTCPMESSAGEGAMEOBJECTS_GOB_TOSTRING_OFFSET UNITYSDK_OFFSET(0x27000)
#define HDG_RDTTCPMESSAGEGAMEOBJECTS_GOB_WRITE_OFFSET UNITYSDK_OFFSET(0x27110)
