...
#define HDG_RDTSERIALIZERMATERIAL_HDG_RDTSERIALIZERINTERFACE_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0xAA76DA0)
#define HDG_RDTSERIALIZERMATERIAL_HDG_RDTSERIALIZERINTERFACE_READ_OFFSET UNITYSDK_OFFSET(0xAA76E40)
#define HDG_RDTSERIALIZERMATERIAL_HDG_RDTSERIALIZERINTERFACE_WRITE_OFFSET UNITYSDK_OFFSET(0xAA76DF0)
#define HDG_RDTSERIALIZERMATERIAL_SERIALIZE_OFFSET UNITYSDK_OFFSET(0xAA76790)
#define HDG_RDTSERIALIZERMATERIAL_UPDATESHADERPARAMETERS_OFFSET UNITYSDK_OFFSET(0xAA76E90)
#define HDG_RDTSERIALIZERMATERIAL__ADDSHADERPARAMETERS_OFFSET UNITYSDK_OFFSET(0xAA76820)
#define HDG_RDTSERIALIZERMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAA773C0)
