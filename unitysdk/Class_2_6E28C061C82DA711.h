...
#define CLASS_2_6E28C061C82DA711_CLEAR_OFFSET UNITYSDK_OFFSET(0x15172DD0)
#define CLASS_2_6E28C061C82DA711_CREATEEQUIPITEMS_OFFSET UNITYSDK_OFFSET(0x15172EA0)
#define CLASS_2_6E28C061C82DA711_CREATEPROPERTYPROVIDER_OFFSET UNITYSDK_OFFSET(0x15172E50)
#define CLASS_2_6E28C061C82DA711_CREATETRAITS_OFFSET UNITYSDK_OFFSET(0x151734A0)
#define CLASS_2_6E28C061C82DA711_METHOD_2_617C5F75EC8B9441_OFFSET UNITYSDK_OFFSET(0x15172C10)
#define CLASS_2_6E28C061C82DA711__CTOR_OFFSET UNITYSDK_OFFSET(0x15173540)
...
public:
	...
	{
		return ((::Class_0_16E4307DCC419505_825*(*)(::PVOID, ::RPG::Client::GridFightRole*))((::PBYTE)hIl2Cpp + CLASS_2_6E28C061C82DA711_CREATEPROPERTYPROVIDER_OFFSET))(this, a1);
	}
