...
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_APPLYTRANSFORMTO_OFFSET UNITYSDK_OFFSET(0x19856BD0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ASSIGNUNITYLAYER_OFFSET UNITYSDK_OFFSET(0x19848990)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ASSIGNUNITYTAG_OFFSET UNITYSDK_OFFSET(0x19848580)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ATTACHSCRIPTWITHINVOKEFUNCTION_OFFSET UNITYSDK_OFFSET(0x1985A7E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_BILERPF_OFFSET UNITYSDK_OFFSET(0x1985C820)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CHECKATTRIBUTEEXISTS_OFFSET UNITYSDK_OFFSET(0x19856260)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COLORTOSTRING_OFFSET UNITYSDK_OFFSET(0x19858BD0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COMPOSENCHILDREN_OFFSET UNITYSDK_OFFSET(0x1984DF40)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1985BC70)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYFLAGS_OFFSET UNITYSDK_OFFSET(0x19847F40)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x1985C210)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYLOCALTRANSFORMVALUES_OFFSET UNITYSDK_OFFSET(0x19856ED0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_COPYWORLDTRANSFORMVALUES_OFFSET UNITYSDK_OFFSET(0x19856AE0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CREATENEWGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x19834F70)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CREATEOUTPUTATTRIBUTEHELPER_OFFSET UNITYSDK_OFFSET(0x19856A70)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_CREATEOUTPUTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19856460)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYAUTOGENERATEDCHILDREN_OFFSET UNITYSDK_OFFSET(0x1985CEA0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYBAKEDGAMEOBJECTSWITHENDNAME_OFFSET UNITYSDK_OFFSET(0x19858010)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYBAKEDGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x19858000)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYCHILDWITHNAME_OFFSET UNITYSDK_OFFSET(0x1985CD90)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x19857D60)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x198589A0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDMESHCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x19857E00)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYGENERATEDMESHMATERIALSLODGROUPS_OFFSET UNITYSDK_OFFSET(0x198581C0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x19847B90)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYLODGROUP_OFFSET UNITYSDK_OFFSET(0x19858400)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYMESHCOLLIDER_OFFSET UNITYSDK_OFFSET(0x19858B00)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DESTROYTERRAINCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x19857E70)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_DOESUNITYTAGEXIST_OFFSET UNITYSDK_OFFSET(0x19859000)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_FINDORGENERATEHANDLES_OFFSET UNITYSDK_OFFSET(0x1985AB50)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_FRACTIONALF_OFFSET UNITYSDK_OFFSET(0x1985C8A0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTECOLORSINGLE_OFFSET UNITYSDK_OFFSET(0x1985A4E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEDATAASSTRING_OFFSET UNITYSDK_OFFSET(0x19855D20)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEFLOATSINGLE_OFFSET UNITYSDK_OFFSET(0x19859FB0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEINFO_OFFSET UNITYSDK_OFFSET(0x1982FBD0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTEINTSINGLE_OFFSET UNITYSDK_OFFSET(0x1985A250)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGDATAHELPER_OFFSET UNITYSDK_OFFSET(0x198558D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGDATA_OFFSET UNITYSDK_OFFSET(0x198300E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGVALUESINGLESTRICT_OFFSET UNITYSDK_OFFSET(0x19859A40)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETATTRIBUTESTRINGVALUESINGLE_OFFSET UNITYSDK_OFFSET(0x19859630)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETCHILDGAMEOBJECTSWITHNAMEPATTERN_OFFSET UNITYSDK_OFFSET(0x19857490)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETCHILDGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x19856FC0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETGAMEOBJECTBYNAMEINPROJECTONLY_OFFSET UNITYSDK_OFFSET(0x19857B80)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETGAMEOBJECTBYNAMEINSCENE_OFFSET UNITYSDK_OFFSET(0x19857CE0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETGAMEOBJECTBYNAME_OFFSET UNITYSDK_OFFSET(0x19857A50)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETHDABYGAMEOBJECTNAMEINSCENE_OFFSET UNITYSDK_OFFSET(0x19857D20)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETINSTANCECHILDOBJECTS_OFFSET UNITYSDK_OFFSET(0x198579D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETLODTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x198585D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETMATERIALATTRIBUTEVALUEFROMPART_OFFSET UNITYSDK_OFFSET(0x1985C390)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETNONINSTANCECHILDOBJECTS_OFFSET UNITYSDK_OFFSET(0x19857A10)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETPREFABFROMPATH_OFFSET UNITYSDK_OFFSET(0x1985CB50)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETRAWOPERATORNAME_OFFSET UNITYSDK_OFFSET(0x1985CAE0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETSYSTEMTYPEBYNAME_OFFSET UNITYSDK_OFFSET(0x19859300)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_GETUNITYSCRIPTATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x19859340)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_HASATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1984C8D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_HASVALIDINSTANCEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19856340)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISGAMEOBJECTINPROJECT_OFFSET UNITYSDK_OFFSET(0x19857CA0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISINCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0x1985AAC0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISMOUSEOVERRECT_OFFSET UNITYSDK_OFFSET(0x19859290)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_ISMOUSEWITHINSCENEVIEW_OFFSET UNITYSDK_OFFSET(0x19859210)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_LOADTEXTUREFROMFILE_OFFSET UNITYSDK_OFFSET(0x1985BC80)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_LONGESTCOMMONPREFIX_OFFSET UNITYSDK_OFFSET(0x1985C8D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_MAKESTATICIFHASATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19848D60)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_MAKETEXTURE_OFFSET UNITYSDK_OFFSET(0x1985BF10)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_RENAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x19847F20)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_REPLACECOLLIDERMESHFROMMESHCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1985C680)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_REPLACECOLLIDERMESHFROMMESHFILTER_OFFSET UNITYSDK_OFFSET(0x19847CE0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_REPLACEFIRSTOCCURRENCE_OFFSET UNITYSDK_OFFSET(0x1985C0F0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTCHILDRENCOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x198484E0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTCHILDRENRENDERVISIBILITY_OFFSET UNITYSDK_OFFSET(0x19848370)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTCOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x19848410)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETGAMEOBJECTRENDERVISIBLITY_OFFSET UNITYSDK_OFFSET(0x198482D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETLAYER_OFFSET UNITYSDK_OFFSET(0x19859010)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETLODTRANSFORMVALUES_OFFSET UNITYSDK_OFFSET(0x198587D0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETPARENTWITHCLEANTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1985C180)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_SETTAG_OFFSET UNITYSDK_OFFSET(0x19859110)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_STRINGTOCOLOR_OFFSET UNITYSDK_OFFSET(0x19858ED0)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY_UPDATEGENERATEDATTRIBUTESTORE_OFFSET UNITYSDK_OFFSET(0x19845B80)
#define HOUDINIENGINEUNITY_HEU_GENERALUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1985D0C0)
