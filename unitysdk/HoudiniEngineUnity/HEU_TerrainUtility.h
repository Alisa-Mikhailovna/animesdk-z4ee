...
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_APPENDCONVERTEDHEIGHTFIELDTOALPHAMAP_OFFSET UNITYSDK_OFFSET(0x198FEA30)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_APPLYDETAILLAYERS_OFFSET UNITYSDK_OFFSET(0x19901CB0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_APPLYSCATTERTREES_OFFSET UNITYSDK_OFFSET(0x19900DD0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_CONVERTHEIGHTFIELDTOALPHAMAP_OFFSET UNITYSDK_OFFSET(0x198FE850)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_CONVERTHEIGHTMAPHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x198FDE40)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GENERATETERRAINFROMVOLUME_OFFSET UNITYSDK_OFFSET(0x198FC240)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETATTRIBUTETILE_OFFSET UNITYSDK_OFFSET(0x199027F0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETDEFAULTTERRAINMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x198FDFC0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETDEFAULTTERRAINSHADERNAME_OFFSET UNITYSDK_OFFSET(0x198FDF40)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETDETAILMAPFROMPART_OFFSET UNITYSDK_OFFSET(0x198FE350)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETHEIGHTFIELDLAYERTYPE_OFFSET UNITYSDK_OFFSET(0x19902600)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETHEIGHTMAPFROMPART_OFFSET UNITYSDK_OFFSET(0x198FE040)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETHEIGHTRANGEFROMHEIGHTFIELD_OFFSET UNITYSDK_OFFSET(0x198FE2F0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETNORMALIZEDHEIGHTMAPFROMPARTWITHMINMAX_OFFSET UNITYSDK_OFFSET(0x198FD350)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETTERRAINDATAEXPORTPATHFROMHEIGHTFIELDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19902740)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETTERRAINLAYERINDEXBYNAME_OFFSET UNITYSDK_OFFSET(0x19902200)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETTERRAINLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x19902330)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETTREEPROTOTYPEINFOSFROMPART_OFFSET UNITYSDK_OFFSET(0x198FEF50)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_GETVOLUMEPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x198FED30)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_POPULATEDETAILPROPERTIES_OFFSET UNITYSDK_OFFSET(0x199015F0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_POPULATEDETAILPROTOTYPE_OFFSET UNITYSDK_OFFSET(0x19901250)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_POPULATESCATTERTREES_OFFSET UNITYSDK_OFFSET(0x198FF250)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_RESAMPLEDATA_OFFSET UNITYSDK_OFFSET(0x198FDB70)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_SETTERRAINMATERIAL_OFFSET UNITYSDK_OFFSET(0x198FD0A0)
#define HOUDINIENGINEUNITY_HEU_TERRAINUTILITY_VOLUMELAYERHASATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x199023D0)
