...
#define HOUDINIENGINEUNITY_TEST_TEXTURE2D_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x199299F0)
#define HOUDINIENGINEUNITY_TEST_TEXTURE2D_ISNULL_OFFSET UNITYSDK_OFFSET(0x199299D0)
#define HOUDINIENGINEUNITY_TEST_TEXTURE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x199299C0)
