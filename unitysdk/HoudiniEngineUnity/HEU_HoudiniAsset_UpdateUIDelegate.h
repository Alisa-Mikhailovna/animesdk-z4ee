...
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSET_UPDATEUIDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1989E5A0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSET_UPDATEUIDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1989E5D0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSET_UPDATEUIDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19888010)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSET_UPDATEUIDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1989E530)
