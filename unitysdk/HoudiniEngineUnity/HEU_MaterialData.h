...
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GETMATERIALALPHA_OFFSET UNITYSDK_OFFSET(0x198B9EF0)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GETSUPPORTEDFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x198BA310)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GETTEXTUREFILENAMEFROMMATERIALPARAM_OFFSET UNITYSDK_OFFSET(0x198B9360)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GET_MATERIALKEY_OFFSET UNITYSDK_OFFSET(0x198B89A0)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GET_MATERIALSOURCE_OFFSET UNITYSDK_OFFSET(0x198B8980)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x198B8970)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x198BA440)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_ISEXISTINGMATERIAL_OFFSET UNITYSDK_OFFSET(0x198BA240)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_ISTRANSPARENTMATERIAL_OFFSET UNITYSDK_OFFSET(0x198B89C0)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_MATERIALSOURCE_WRAPPERTOINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x198B8990)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_MATERIALSOURCE_WRAPPERTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x198BA6F0)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_SET_MATERIALKEY_OFFSET UNITYSDK_OFFSET(0x198B89B0)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_UPDATEMATERIALFROMHOUDINI_OFFSET UNITYSDK_OFFSET(0x19896360)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA_USELEGACYSHADERS_OFFSET UNITYSDK_OFFSET(0x198B8B60)
#define HOUDINIENGINEUNITY_HEU_MATERIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198BA700)
