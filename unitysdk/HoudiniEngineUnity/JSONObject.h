...
#define HOUDINIENGINEUNITY_JSONOBJECT_ADD_OFFSET UNITYSDK_OFFSET(0x19920760)
#define HOUDINIENGINEUNITY_JSONOBJECT_CLEAR_OFFSET UNITYSDK_OFFSET(0x199201D0)
#define HOUDINIENGINEUNITY_JSONOBJECT_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x19920230)
#define HOUDINIENGINEUNITY_JSONOBJECT_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19920160)
#define HOUDINIENGINEUNITY_JSONOBJECT_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x19920C60)
#define HOUDINIENGINEUNITY_JSONOBJECT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19920740)
#define HOUDINIENGINEUNITY_JSONOBJECT_GET_INLINE_OFFSET UNITYSDK_OFFSET(0x19920120)
#define HOUDINIENGINEUNITY_JSONOBJECT_GET_ISOBJECT_OFFSET UNITYSDK_OFFSET(0x19920150)
#define HOUDINIENGINEUNITY_JSONOBJECT_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x19920570)
#define HOUDINIENGINEUNITY_JSONOBJECT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19920290)
#define HOUDINIENGINEUNITY_JSONOBJECT_GET_TAG_OFFSET UNITYSDK_OFFSET(0x19920140)
#define HOUDINIENGINEUNITY_JSONOBJECT_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x19920A80)
#define HOUDINIENGINEUNITY_JSONOBJECT_REMOVE_2_OFFSET UNITYSDK_OFFSET(0x19920B10)
#define HOUDINIENGINEUNITY_JSONOBJECT_REMOVE_OFFSET UNITYSDK_OFFSET(0x19920940)
#define HOUDINIENGINEUNITY_JSONOBJECT_SET_INLINE_OFFSET UNITYSDK_OFFSET(0x19920130)
#define HOUDINIENGINEUNITY_JSONOBJECT_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x199205E0)
#define HOUDINIENGINEUNITY_JSONOBJECT_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x199203C0)
#define HOUDINIENGINEUNITY_JSONOBJECT_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x19920CE0)
#define HOUDINIENGINEUNITY_JSONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x199216B0)
