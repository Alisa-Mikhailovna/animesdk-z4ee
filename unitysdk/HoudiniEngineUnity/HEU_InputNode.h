...
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ADDINPUTENTRYATENDHDA_OFFSET UNITYSDK_OFFSET(0x198B29A0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ADDINPUTENTRYATENDMESH_OFFSET UNITYSDK_OFFSET(0x198B28E0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ADDINPUTENTRYATEND_OFFSET UNITYSDK_OFFSET(0x198B0D60)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_AREANYINPUTHDASCONNECTED_OFFSET UNITYSDK_OFFSET(0x198B21B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CHANGEINPUTTYPE_1_OFFSET UNITYSDK_OFFSET(0x198B12A0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CHANGEINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x198B11E0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CLEARCONNECTEDINPUTHDAS_OFFSET UNITYSDK_OFFSET(0x198B2E60)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CLEARUICACHE_OFFSET UNITYSDK_OFFSET(0x198B2490)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CONNECTTOMERGEOBJECT_OFFSET UNITYSDK_OFFSET(0x198B42C0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_COPYINPUTVALUESTO_OFFSET UNITYSDK_OFFSET(0x1989C4D0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CREATEINPUTHDAINFO_OFFSET UNITYSDK_OFFSET(0x198B0680)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CREATEINPUTOBJECTINFO_OFFSET UNITYSDK_OFFSET(0x198B0560)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_CREATESETUPINPUT_OFFSET UNITYSDK_OFFSET(0x19890DE0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_DESTROYALLDATA_OFFSET UNITYSDK_OFFSET(0x1988DD20)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_DISCONNECTANDDESTROYINPUTS_OFFSET UNITYSDK_OFFSET(0x198B24A0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_DISCONNECTCONNECTEDMERGENODE_OFFSET UNITYSDK_OFFSET(0x198B29C0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_FINDADDTOINPUTHDA_OFFSET UNITYSDK_OFFSET(0x198B64B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETCONNECTEDINPUTCOUNT_OFFSET UNITYSDK_OFFSET(0x198B22B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETCONNECTEDNODEID_OFFSET UNITYSDK_OFFSET(0x198B2300)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETINPUTENTRYGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x198AFCC0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETINPUTENTRYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x198AF650)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETINTERNALOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x198AF630)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GETSESSION_OFFSET UNITYSDK_OFFSET(0x198AF560)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTASSETINFOS_OFFSET UNITYSDK_OFFSET(0x198AF510)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTNAME_OFFSET UNITYSDK_OFFSET(0x198AF4A0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTNODEID_OFFSET UNITYSDK_OFFSET(0x198AF490)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTOBJECTS_OFFSET UNITYSDK_OFFSET(0x198AF500)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_INPUTTYPE_OFFSET UNITYSDK_OFFSET(0x198AF4F0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_KEEPWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x198AF380)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_LABELNAME_OFFSET UNITYSDK_OFFSET(0x198AF4B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_MESHSETTINGS_OFFSET UNITYSDK_OFFSET(0x198AF4D0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x198AF3C0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_OBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x198AF3F0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_PACKGEOMETRYBEFOREMERGING_OFFSET UNITYSDK_OFFSET(0x198AF3A0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_PARAMNAME_OFFSET UNITYSDK_OFFSET(0x198AF4C0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_PARENTASSET_OFFSET UNITYSDK_OFFSET(0x198AF370)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_PENDINGOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x198AF430)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_REQUIRESCOOK_OFFSET UNITYSDK_OFFSET(0x198AF520)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_REQUIRESUPLOAD_OFFSET UNITYSDK_OFFSET(0x198AF540)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_GET_SPLINESETTINGS_OFFSET UNITYSDK_OFFSET(0x198AF4E0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_HANDLESELECTEDOBJECTSFORINPUTHDAS_OFFSET UNITYSDK_OFFSET(0x198B6A70)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_HANDLESELECTEDOBJECTSFORINPUTOBJECTS_OFFSET UNITYSDK_OFFSET(0x198B67C0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_HASINPUTNODETRANSFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x1988D5D0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INPUTNODETYPE_INTERNALTOWRAPPER_1_OFFSET UNITYSDK_OFFSET(0x198B7050)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INPUTNODETYPE_INTERNALTOWRAPPER_OFFSET UNITYSDK_OFFSET(0x198AF3E0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INPUTOBJECTTYPE_INTERNALTOWRAPPER_OFFSET UNITYSDK_OFFSET(0x198AF410)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INPUTOBJECTTYPE_WRAPPERTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x198AF470)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INSERTINPUTENTRY_OFFSET UNITYSDK_OFFSET(0x198B06D0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INTERNALADDINPUTHDAATEND_OFFSET UNITYSDK_OFFSET(0x198B1060)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_INTERNALADDINPUTOBJECTATEND_OFFSET UNITYSDK_OFFSET(0x198B0FB0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ISASSETINPUT_OFFSET UNITYSDK_OFFSET(0x1987DC10)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x198B6BF0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_LOADPRESET_1_OFFSET UNITYSDK_OFFSET(0x19899900)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_LOADPRESET_OFFSET UNITYSDK_OFFSET(0x198B23B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_NOTIFYPARENTREMOVEDINPUT_OFFSET UNITYSDK_OFFSET(0x198B6740)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_NUMINPUTENTRIES_OFFSET UNITYSDK_OFFSET(0x198AF5E0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_POPULATEINPUTPRESET_OFFSET UNITYSDK_OFFSET(0x1987FBD0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RECONNECTTOUPSTREAMASSET_OFFSET UNITYSDK_OFFSET(0x19895570)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RECOOK_OFFSET UNITYSDK_OFFSET(0x198AF5D0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_REMOVEALLINPUTENTRIES_OFFSET UNITYSDK_OFFSET(0x198B1980)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_REMOVEINPUTENTRY_OFFSET UNITYSDK_OFFSET(0x198B12D0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RESETCONNECTIONFORFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x19890FB0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RESETINPUTNODE_1_OFFSET UNITYSDK_OFFSET(0x1987EB70)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RESETINPUTNODE_OFFSET UNITYSDK_OFFSET(0x198B1150)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_RESETINPUTOBJECTTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x198B27C0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRYOBJECTTRANSFORMROTATEOFFSET_OFFSET UNITYSDK_OFFSET(0x198B1DD0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRYOBJECTTRANSFORMSCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x198B1FC0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRYOBJECTTRANSFORMTRANSLATEOFFSET_OFFSET UNITYSDK_OFFSET(0x198B1BF0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRYOBJECTUSETRANSFORMOFFSET_OFFSET UNITYSDK_OFFSET(0x198B1A10)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTENTRY_OFFSET UNITYSDK_OFFSET(0x198AFEA0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SETINPUTNODEID_OFFSET UNITYSDK_OFFSET(0x198B2480)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_KEEPWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x198AF390)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_PACKGEOMETRYBEFOREMERGING_OFFSET UNITYSDK_OFFSET(0x198AF3B0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_PENDINGOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x198AF450)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_REQUIRESCOOK_OFFSET UNITYSDK_OFFSET(0x198AF530)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_SET_REQUIRESUPLOAD_OFFSET UNITYSDK_OFFSET(0x198AF550)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPDATEONASSETRECREATION_OFFSET UNITYSDK_OFFSET(0x19895360)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADHDAINPUT_OFFSET UNITYSDK_OFFSET(0x198B30E0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADINPUTOBJECTTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x198B5B60)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADINPUT_OFFSET UNITYSDK_OFFSET(0x19890FF0)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADOBJECTMERGEPACKGEOMETRY_OFFSET UNITYSDK_OFFSET(0x198B4A50)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADOBJECTMERGETRANSFORMTYPE_OFFSET UNITYSDK_OFFSET(0x198B4800)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE_UPLOADUNITYINPUT_OFFSET UNITYSDK_OFFSET(0x198B3430)
#define HOUDINIENGINEUNITY_HEU_INPUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x198B7060)
