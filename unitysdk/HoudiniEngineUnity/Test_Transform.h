...
#define HOUDINIENGINEUNITY_TEST_TRANSFORM_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19929F10)
#define HOUDINIENGINEUNITY_TEST_TRANSFORM_ISNULL_OFFSET UNITYSDK_OFFSET(0x19929EF0)
#define HOUDINIENGINEUNITY_TEST_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x19929EE0)
