...
#define HOUDINIENGINEUNITY_HEU_COLORRAMPPOINTWRAPPER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x198490B0)
#define HOUDINIENGINEUNITY_HEU_COLORRAMPPOINTWRAPPER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x198490C0)
#define HOUDINIENGINEUNITY_HEU_COLORRAMPPOINTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x198490D0)
