...
#define HOUDINIENGINEUNITY_HEU_SESSIONMANAGER_CREATESESSIONFROMTYPEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198F6450)
#define HOUDINIENGINEUNITY_HEU_SESSIONMANAGER_CREATESESSIONFROMTYPEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198F6480)
#define HOUDINIENGINEUNITY_HEU_SESSIONMANAGER_CREATESESSIONFROMTYPEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x198F6440)
#define HOUDINIENGINEUNITY_HEU_SESSIONMANAGER_CREATESESSIONFROMTYPEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x198F6350)
