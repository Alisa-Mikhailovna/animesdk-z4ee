...
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHDETAILATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x198AEF50)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x198AD5B0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x198AE6C0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_3_OFFSET UNITYSDK_OFFSET(0x198AEBF0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHPOINTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x198A4B50)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHVERTEXATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x198A5140)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_SETMESHVERTEXFLOATATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x198A57A0)
#define HOUDINIENGINEUNITY_HEU_INPUTMESHUTILITY_UPLOADMESHINTOHOUDININODE_OFFSET UNITYSDK_OFFSET(0x198AD960)
