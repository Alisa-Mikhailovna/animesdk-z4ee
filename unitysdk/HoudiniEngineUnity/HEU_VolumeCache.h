...
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_APPLYPRESET_OFFSET UNITYSDK_OFFSET(0x1990DEF0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_COPYDETAILPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19911880)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_COPYLAYER_OFFSET UNITYSDK_OFFSET(0x1990DA30)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_COPYPROTOTYPE_OFFSET UNITYSDK_OFFSET(0x199118B0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_COPYVALUESTO_OFFSET UNITYSDK_OFFSET(0x19911680)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_FINISHUPDATELAYERS_OFFSET UNITYSDK_OFFSET(0x1990EF40)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GENERATETERRAINWITHALPHAMAPS_OFFSET UNITYSDK_OFFSET(0x1990F910)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GETLAYER_OFFSET UNITYSDK_OFFSET(0x1990DB30)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GETPARTLAYERATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1990EF60)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GETSESSION_OFFSET UNITYSDK_OFFSET(0x1990D890)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_DETAILPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1990D830)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_GEONAME_OFFSET UNITYSDK_OFFSET(0x1990D800)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x1990D850)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_LAYERS_OFFSET UNITYSDK_OFFSET(0x1990D7D0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_OBJECTNAME_OFFSET UNITYSDK_OFFSET(0x1990D7F0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_PARENTASSET_OFFSET UNITYSDK_OFFSET(0x1990D840)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_SCATTERTREES_OFFSET UNITYSDK_OFFSET(0x1990D820)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_TERRAINDATA_OFFSET UNITYSDK_OFFSET(0x1990D810)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_TILEINDEX_OFFSET UNITYSDK_OFFSET(0x1990D7E0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_GET_UIEXPANDED_OFFSET UNITYSDK_OFFSET(0x1990D870)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1990EED0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19911900)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_LOADASSETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1990F050)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_LOADDEFAULTSPLATTEXTURE_OFFSET UNITYSDK_OFFSET(0x199110D0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_LOADLAYERCOLORFROMATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1990F380)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_LOADLAYERFLOATFROMATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1990F120)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_LOADLAYERPROPERTIESFROMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19911170)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_LOADLAYERTEXTUREFROMATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1990EFB0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_LOADLAYERVECTOR2FROMATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1990F6A0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_POPULATEDETAILPROTOTYPE_OFFSET UNITYSDK_OFFSET(0x19911650)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_POPULATEPRESET_OFFSET UNITYSDK_OFFSET(0x1990DC90)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_POPULATESCATTERTREES_OFFSET UNITYSDK_OFFSET(0x19911610)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_RECOOK_OFFSET UNITYSDK_OFFSET(0x1990D900)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_RESETPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1990D910)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_SET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x1990D860)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_SET_UIEXPANDED_OFFSET UNITYSDK_OFFSET(0x1990D880)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_STARTUPDATELAYERS_OFFSET UNITYSDK_OFFSET(0x1990EA50)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_UPDATELAYERFROMPART_OFFSET UNITYSDK_OFFSET(0x1990EAA0)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE_UPDATEVOLUMECACHESFROMPARTS_OFFSET UNITYSDK_OFFSET(0x1990E140)
#define HOUDINIENGINEUNITY_HEU_VOLUMECACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x19911BA0)
