...
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_CREATEINPUTNODEWITHMULTIASSETS_OFFSET UNITYSDK_OFFSET(0x198B3C90)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_CREATEINPUTNODEWITHMULTIOBJECTS_OFFSET UNITYSDK_OFFSET(0x198B4E10)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_GETCHILDRENTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x19897630)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_GETHIGHESTPRIORITY_OFFSET UNITYSDK_OFFSET(0x198B7630)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_GETINPUTINTERFACEBYTYPE_OFFSET UNITYSDK_OFFSET(0x198B7740)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_GETINPUTINTERFACE_1_OFFSET UNITYSDK_OFFSET(0x198B7BD0)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_GETINPUTINTERFACE_OFFSET UNITYSDK_OFFSET(0x198B7990)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_REGISTERINPUTINTERFACE_OFFSET UNITYSDK_OFFSET(0x1989EDD0)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_UNREGISTERINPUTINTERFACE_OFFSET UNITYSDK_OFFSET(0x198B7900)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY_UPLOADINPUTOBJECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x198B5CB0)
#define HOUDINIENGINEUNITY_HEU_INPUTUTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x198B7C90)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputInterface*>**)Il2CppClass::FromTypeDefinitionIndex(HEU_InputUtility_TypeDefinitionIndex)->GetStaticField(0xF4E0);
		}
