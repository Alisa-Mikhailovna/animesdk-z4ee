...
#define HOUDINIENGINEUNITY_HEU_VOLUMESCATTERTREES_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19911F80)
#define HOUDINIENGINEUNITY_HEU_VOLUMESCATTERTREES__CTOR_OFFSET UNITYSDK_OFFSET(0x19900DC0)
...
namespace HoudiniEngineUnity
{
	...
	{
	public:
		::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TreePrototypeInfo*>* _treePrototypInfos; // 0x10
		::Il2CppArray<::UnityEngine::Color32>* _lightmapColors; // 0x18
		::Il2CppArray<::System::Int32>* _terrainTiles; // 0x20
		...
		::Il2CppArray<::UnityEngine::Vector3>* _positions; // 0x40
