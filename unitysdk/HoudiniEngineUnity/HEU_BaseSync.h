...
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ADDGENERATEDOUTPUTFILEPATH_OFFSET UNITYSDK_OFFSET(0x198453B0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_APPLYATTRIBUTEMODIFIERSONGAMEOBJECTOUTPUT_OFFSET UNITYSDK_OFFSET(0x19845690)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_AWAKE_OFFSET UNITYSDK_OFFSET(0x19841A50)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_BAKE_OFFSET UNITYSDK_OFFSET(0x19842510)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_CLEARLOG_OFFSET UNITYSDK_OFFSET(0x19842140)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_CREATENEWINSTANCEFROMOBJECT_OFFSET UNITYSDK_OFFSET(0x19847820)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_DELETESESSIONDATA_OFFSET UNITYSDK_OFFSET(0x198395D0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_DESTROYGENERATEDDATA_OFFSET UNITYSDK_OFFSET(0x19839D40)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_DESTROYOUTPUTS_OFFSET UNITYSDK_OFFSET(0x19841BB0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ERROR_OFFSET UNITYSDK_OFFSET(0x19842250)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEALLINSTANCERS_OFFSET UNITYSDK_OFFSET(0x198450F0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x19842F70)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEINSTANCER_OFFSET UNITYSDK_OFFSET(0x198461E0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEINSTANCESFROMASSETPATHS_OFFSET UNITYSDK_OFFSET(0x19846DC0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEINSTANCESFROMNODEIDS_OFFSET UNITYSDK_OFFSET(0x198465E0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0x19843090)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATEOBJECTS_OFFSET UNITYSDK_OFFSET(0x19842E90)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GENERATETERRAIN_OFFSET UNITYSDK_OFFSET(0x19843860)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GETHOUDINISESSION_OFFSET UNITYSDK_OFFSET(0x19841DD0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GETOUTPUTCACHEDIRECTORY_OFFSET UNITYSDK_OFFSET(0x19845350)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GETPARENTNODEID_OFFSET UNITYSDK_OFFSET(0x19841AE0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_GET_ONSYNCED_OFFSET UNITYSDK_OFFSET(0x19849090)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x198398C0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ISLOADED_OFFSET UNITYSDK_OFFSET(0x19842270)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_LOG_OFFSET UNITYSDK_OFFSET(0x19842030)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19841A60)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ONLOADCOMPLETE_OFFSET UNITYSDK_OFFSET(0x19839AB0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_ONSTOPPED_OFFSET UNITYSDK_OFFSET(0x19845190)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_RESET_OFFSET UNITYSDK_OFFSET(0x19842C90)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_RESYNC_OFFSET UNITYSDK_OFFSET(0x19842410)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SETOUTPUTCACHEDIRECTORY_OFFSET UNITYSDK_OFFSET(0x19849070)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SETOUTPUTVISIBLITY_OFFSET UNITYSDK_OFFSET(0x198456E0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SETUPLOADTASK_OFFSET UNITYSDK_OFFSET(0x19842290)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SET_ONSYNCED_OFFSET UNITYSDK_OFFSET(0x198490A0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_STARTSYNC_OFFSET UNITYSDK_OFFSET(0x19839D50)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_STOPSYNC_OFFSET UNITYSDK_OFFSET(0x198422A0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_SYNCUPDATE_OFFSET UNITYSDK_OFFSET(0x19849080)
#define HOUDINIENGINEUNITY_HEU_BASESYNC_UNLOAD_OFFSET UNITYSDK_OFFSET(0x198429E0)
#define HOUDINIENGINEUNITY_HEU_BASESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1983A190)
