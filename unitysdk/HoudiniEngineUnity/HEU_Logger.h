...
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGASSERTIONFORMAT_OFFSET UNITYSDK_OFFSET(0x198B88A0)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGASSERTION_OFFSET UNITYSDK_OFFSET(0x198B87F0)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGERRORFORMAT_OFFSET UNITYSDK_OFFSET(0x1987B220)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGERROR_1_OFFSET UNITYSDK_OFFSET(0x198B85B0)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x19880610)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGFORMAT_OFFSET UNITYSDK_OFFSET(0x1987AE30)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGTOCOOKLOGSIFONFORMAT_OFFSET UNITYSDK_OFFSET(0x198B84F0)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGTOCOOKLOGSIFON_OFFSET UNITYSDK_OFFSET(0x198B8440)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGWARNINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1987CD80)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x198873A0)
#define HOUDINIENGINEUNITY_HEU_LOGGER_LOG_OFFSET UNITYSDK_OFFSET(0x198B83C0)
#define HOUDINIENGINEUNITY_HEU_LOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x198B8960)
