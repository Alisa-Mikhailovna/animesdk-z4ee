...
#define HOUDINIENGINEUNITY_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x19921BB0)
#define HOUDINIENGINEUNITY_JSONSTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19921A30)
#define HOUDINIENGINEUNITY_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19921C80)
#define HOUDINIENGINEUNITY_JSONSTRING_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x19921A20)
#define HOUDINIENGINEUNITY_JSONSTRING_GET_TAG_OFFSET UNITYSDK_OFFSET(0x19921A10)
#define HOUDINIENGINEUNITY_JSONSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19921A50)
#define HOUDINIENGINEUNITY_JSONSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19921A60)
#define HOUDINIENGINEUNITY_JSONSTRING_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x19921A80)
#define HOUDINIENGINEUNITY_JSONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19921A70)
