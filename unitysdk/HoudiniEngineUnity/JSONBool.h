...
#define HOUDINIENGINEUNITY_JSONBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0x19914930)
#define HOUDINIENGINEUNITY_JSONBOOL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x199147E0)
#define HOUDINIENGINEUNITY_JSONBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19914950)
#define HOUDINIENGINEUNITY_JSONBOOL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x19914870)
#define HOUDINIENGINEUNITY_JSONBOOL_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x199147D0)
#define HOUDINIENGINEUNITY_JSONBOOL_GET_TAG_OFFSET UNITYSDK_OFFSET(0x199147C0)
#define HOUDINIENGINEUNITY_JSONBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19914800)
#define HOUDINIENGINEUNITY_JSONBOOL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x19914880)
#define HOUDINIENGINEUNITY_JSONBOOL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19914820)
#define HOUDINIENGINEUNITY_JSONBOOL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x199148F0)
#define HOUDINIENGINEUNITY_JSONBOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199148A0)
#define HOUDINIENGINEUNITY_JSONBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19914890)
