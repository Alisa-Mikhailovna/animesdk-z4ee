...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_CREATEINPUTNODEFORCOLLIDER_OFFSET UNITYSDK_OFFSET(0x198A8B50)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_CREATEINPUTNODEWITHDATAUPLOAD_OFFSET UNITYSDK_OFFSET(0x1989F160)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_CREATESINGLEMESHDATA_OFFSET UNITYSDK_OFFSET(0x198A91C0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_GENERATEMESHDATASFROMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1989F730)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_GETCOLLIDERGROUPBASENAME_OFFSET UNITYSDK_OFFSET(0x198A8A80)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_GETMESHFROMOBJECT_OFFSET UNITYSDK_OFFSET(0x198A96B0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_GETUVSFROMMESH_OFFSET UNITYSDK_OFFSET(0x198A4B00)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1989F150)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_ISTHISINPUTOBJECTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x198A49F0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADBOXCOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x198A5C10)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADCAPSULECOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x198A6C00)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADCOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x198A3EC0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADDATA_OFFSET UNITYSDK_OFFSET(0x1989FBC0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADMESHCOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x198A81F0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH_UPLOADSPHERECOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x198A6410)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1989F140)
