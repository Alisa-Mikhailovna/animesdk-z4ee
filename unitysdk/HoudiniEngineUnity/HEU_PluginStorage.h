...
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_CLEARPLUGINDATA_OFFSET UNITYSDK_OFFSET(0x198EE950)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_CONVERTENVKEYEDPATHTOREAL_OFFSET UNITYSDK_OFFSET(0x198EED40)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_CONVERTREALPATHTOENVKEYEDPATH_OFFSET UNITYSDK_OFFSET(0x198EEB70)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_DELETEALLSAVEDSESSIONDATA_OFFSET UNITYSDK_OFFSET(0x198EEB60)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_GETENVIRONMENTPATHMAP_OFFSET UNITYSDK_OFFSET(0x198ECC90)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_GET_1_OFFSET UNITYSDK_OFFSET(0x198E8530)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_GET_2_OFFSET UNITYSDK_OFFSET(0x198EE360)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_GET_3_OFFSET UNITYSDK_OFFSET(0x198E7190)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_GET_4_OFFSET UNITYSDK_OFFSET(0x198E4DC0)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_GET_5_OFFSET UNITYSDK_OFFSET(0x198E9650)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x198E4D80)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x198E56C0)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_GET_REQUIRESSAVE_OFFSET UNITYSDK_OFFSET(0x198ECCA0)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_INSTANTIATEANDLOAD_OFFSET UNITYSDK_OFFSET(0x198ECCB0)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_LOADALLSESSIONDATA_OFFSET UNITYSDK_OFFSET(0x198EEB10)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_LOADASSETENVIRONMENTPATHS_OFFSET UNITYSDK_OFFSET(0x198E5140)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_LOADFROMSAVEDFILE_OFFSET UNITYSDK_OFFSET(0x198EEA30)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_LOADPLUGINDATA_OFFSET UNITYSDK_OFFSET(0x198ECF10)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_MARKDIRTYFORSAVE_OFFSET UNITYSDK_OFFSET(0x198EE280)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_READFROMEDITORPREFS_OFFSET UNITYSDK_OFFSET(0x198EE940)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SAVEALLSESSIONDATA_OFFSET UNITYSDK_OFFSET(0x198EEB00)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SAVEIFREQUIRED_OFFSET UNITYSDK_OFFSET(0x198EE4B0)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SAVEPLUGINDATA_OFFSET UNITYSDK_OFFSET(0x198EE4D0)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SESSIONFILEPATH_OFFSET UNITYSDK_OFFSET(0x198EEA50)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SETCURRENTCULTURE_OFFSET UNITYSDK_OFFSET(0x198EB4C0)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SETTINGSFILEPATH_OFFSET UNITYSDK_OFFSET(0x198EE890)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SET_1_OFFSET UNITYSDK_OFFSET(0x198E8700)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SET_2_OFFSET UNITYSDK_OFFSET(0x198EE290)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SET_3_OFFSET UNITYSDK_OFFSET(0x198E73B0)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SET_4_OFFSET UNITYSDK_OFFSET(0x198E5080)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SET_5_OFFSET UNITYSDK_OFFSET(0x198E9860)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x198E58B0)
#define HOUDINIENGINEUNITY_HEU_PLUGINSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x198ECE80)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		{
			return (::HoudiniEngineUnity::HEU_PluginStorage**)Il2CppClass::FromTypeDefinitionIndex(HEU_PluginStorage_TypeDefinitionIndex)->GetStaticField(0x11360);
		}
