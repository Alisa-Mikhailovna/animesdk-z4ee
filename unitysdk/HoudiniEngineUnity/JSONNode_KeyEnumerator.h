...
#define HOUDINIENGINEUNITY_JSONNODE_KEYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x2D460)
#define HOUDINIENGINEUNITY_JSONNODE_KEYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2EA0520)
