...
#define HOUDINIENGINEUNITY_TEST_MESH_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19925FA0)
#define HOUDINIENGINEUNITY_TEST_MESH_ISNULL_OFFSET UNITYSDK_OFFSET(0x19925F80)
#define HOUDINIENGINEUNITY_TEST_MESH__CTOR_OFFSET UNITYSDK_OFFSET(0x19925F70)
