...
#define HOUDINIENGINEUNITY_HEU_FLOATRAMPPOINTWRAPPER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x198558A0)
#define HOUDINIENGINEUNITY_HEU_FLOATRAMPPOINTWRAPPER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x198558B0)
#define HOUDINIENGINEUNITY_HEU_FLOATRAMPPOINTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x198558C0)
