...
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA_ANYWORKITEMSFAILED_OFFSET UNITYSDK_OFFSET(0x198FB710)
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA_ANYWORKITEMSPENDING_OFFSET UNITYSDK_OFFSET(0x198FB740)
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA_AREALLWORKITEMSCOMPLETE_OFFSET UNITYSDK_OFFSET(0x198FB6A0)
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x198FB660)
#define HOUDINIENGINEUNITY_HEU_TOPNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198FB7A0)
