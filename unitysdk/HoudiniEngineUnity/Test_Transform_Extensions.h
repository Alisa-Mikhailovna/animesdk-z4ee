...
#define HOUDINIENGINEUNITY_TEST_TRANSFORM_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1992A150)
#define HOUDINIENGINEUNITY_TEST_TRANSFORM_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1992A270)
#define HOUDINIENGINEUNITY_TEST_TRANSFORM_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x1992A110)
