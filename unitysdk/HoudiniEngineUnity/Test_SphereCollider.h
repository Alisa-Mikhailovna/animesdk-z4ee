...
#define HOUDINIENGINEUNITY_TEST_SPHERECOLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19927A00)
#define HOUDINIENGINEUNITY_TEST_SPHERECOLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x199279E0)
#define HOUDINIENGINEUNITY_TEST_SPHERECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x199279D0)
