...
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYLOCALTRANSFROMFROMHOUDINITOUNITYFORINSTANCE_OFFSET UNITYSDK_OFFSET(0x19847FA0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYLOCALTRANSFROMFROMHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x19845460)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYMATRIXTOLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19856D60)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_APPLYWORLDTRANSFROMFROMHOUDINITOUNITY_OFFSET UNITYSDK_OFFSET(0x19872EA0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONTAINSSOPNODES_OFFSET UNITYSDK_OFFSET(0x19874A40)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x19851110)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x19852A80)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x19876E10)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_4_OFFSET UNITYSDK_OFFSET(0x1984D3B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTPOSITIONUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x19876E00)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x19851140)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x19876F40)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x19877070)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTROTATIONUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x19876E30)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_1_OFFSET UNITYSDK_OFFSET(0x198512B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_2_OFFSET UNITYSDK_OFFSET(0x19877190)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_3_OFFSET UNITYSDK_OFFSET(0x198771B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CONVERTSCALEUNITYTOHOUDINI_OFFSET UNITYSDK_OFFSET(0x19877180)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_COOKNODEINHOUDINIWITHOPTIONS_OFFSET UNITYSDK_OFFSET(0x198515B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_COOKNODEINHOUDINI_OFFSET UNITYSDK_OFFSET(0x19831990)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKASSETNODE_OFFSET UNITYSDK_OFFSET(0x19870F50)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKCURVEASSET_OFFSET UNITYSDK_OFFSET(0x19871AD0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATEANDCOOKINPUTASSET_OFFSET UNITYSDK_OFFSET(0x19871E20)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWASSET_1_OFFSET UNITYSDK_OFFSET(0x19872210)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWASSET_OFFSET UNITYSDK_OFFSET(0x198721E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWCURVEASSET_OFFSET UNITYSDK_OFFSET(0x19872730)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_CREATENEWINPUTASSET_OFFSET UNITYSDK_OFFSET(0x19872760)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DESTROYCHILDREN_OFFSET UNITYSDK_OFFSET(0x198727A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DESTROYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1984CBE0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DOESGEOPARTHAVEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19874880)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_DOESMAPPEDPATHEXIST_OFFSET UNITYSDK_OFFSET(0x19870710)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_FINDHOUDINIASSETFILEINPATHWITHEXT_OFFSET UNITYSDK_OFFSET(0x19870890)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLASSETGEOINFOS_OFFSET UNITYSDK_OFFSET(0x19874E00)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLASSETOUTPUTS_OFFSET UNITYSDK_OFFSET(0x19875720)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GATHERALLOBJECTGEOINFOS_OFFSET UNITYSDK_OFFSET(0x19876370)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETASSETINSCENE_OFFSET UNITYSDK_OFFSET(0x19872D80)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETDEFAULTCOOKOPTIONS_OFFSET UNITYSDK_OFFSET(0x19851570)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETENVIRONMENTPATH_OFFSET UNITYSDK_OFFSET(0x198703E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORMFROMMATRIX_OFFSET UNITYSDK_OFFSET(0x198737E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORMQUATFROMMATRIX_OFFSET UNITYSDK_OFFSET(0x19873DF0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x19873C00)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETHOUDINIENGINEINSTALLATIONINFO_OFFSET UNITYSDK_OFFSET(0x198703D0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x19874290)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETMATRIXFROMHAPITRANSFORM_OFFSET UNITYSDK_OFFSET(0x198734C0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETOBJECTINFOS_OFFSET UNITYSDK_OFFSET(0x1982E570)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETOUTPUTINDEX_OFFSET UNITYSDK_OFFSET(0x19874D10)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETPARENTNODEID_OFFSET UNITYSDK_OFFSET(0x19874970)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x19873150)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETQUATERNION_OFFSET UNITYSDK_OFFSET(0x198731A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETREALPATHFROMHFSPATH_OFFSET UNITYSDK_OFFSET(0x198704E0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_GETSCALE_OFFSET UNITYSDK_OFFSET(0x198733D0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_INSTANTIATEHDA_OFFSET UNITYSDK_OFFSET(0x1982CF70)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISEQUALTOL_OFFSET UNITYSDK_OFFSET(0x19874540)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISHOUDINIASSETFILE_OFFSET UNITYSDK_OFFSET(0x198707B0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISNODEVALIDINHOUDINI_OFFSET UNITYSDK_OFFSET(0x19831840)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISOBJNODEFULLYVISIBLE_OFFSET UNITYSDK_OFFSET(0x19874B10)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x198743A0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSESSIONSYNCEQUAL_OFFSET UNITYSDK_OFFSET(0x19874860)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISSUPPORTEDPOLYGONTYPE_OFFSET UNITYSDK_OFFSET(0x1983D760)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISTRANSFORMEQUAL_OFFSET UNITYSDK_OFFSET(0x19874560)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_ISVIEWPORTEQUAL_OFFSET UNITYSDK_OFFSET(0x19874760)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOADGEOWITHNEWGEOSYNC_OFFSET UNITYSDK_OFFSET(0x19872790)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOADHDAFILE_OFFSET UNITYSDK_OFFSET(0x19870C20)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOCATEVALIDFILEPATH_1_OFFSET UNITYSDK_OFFSET(0x19870C10)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOCATEVALIDFILEPATH_OFFSET UNITYSDK_OFFSET(0x19870BD0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOGERROR_OFFSET UNITYSDK_OFFSET(0x19870BC0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x19870BB0)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_LOG_OFFSET UNITYSDK_OFFSET(0x19870B30)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_PROCESSHOUDINICOOKSTATUS_OFFSET UNITYSDK_OFFSET(0x19871340)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_SETANIMATIONCURVETANGENTMODES_OFFSET UNITYSDK_OFFSET(0x19874960)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_SETMATRIXPOSITION_OFFSET UNITYSDK_OFFSET(0x19873780)
#define HOUDINIENGINEUNITY_HEU_HAPIUTILITY_TOHAPIVARIABLENAME_OFFSET UNITYSDK_OFFSET(0x19876BC0)
