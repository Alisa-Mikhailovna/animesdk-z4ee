...
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19928E00)
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER_ISNULL_OFFSET UNITYSDK_OFFSET(0x19928DE0)
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19928DD0)
