...
#define HOUDINIENGINEUNITY_TEST_MESHRENDERER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19927210)
#define HOUDINIENGINEUNITY_TEST_MESHRENDERER_ISNULL_OFFSET UNITYSDK_OFFSET(0x199271F0)
#define HOUDINIENGINEUNITY_TEST_MESHRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x199271E0)
