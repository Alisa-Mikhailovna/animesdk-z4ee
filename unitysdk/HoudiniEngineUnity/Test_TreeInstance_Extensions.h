...
#define HOUDINIENGINEUNITY_TEST_TREEINSTANCE_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x19928990)
#define HOUDINIENGINEUNITY_TEST_TREEINSTANCE_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1992A6D0)
#define HOUDINIENGINEUNITY_TEST_TREEINSTANCE_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x1992A660)
