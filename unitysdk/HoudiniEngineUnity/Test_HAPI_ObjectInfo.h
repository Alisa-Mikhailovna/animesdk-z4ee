...
#define HOUDINIENGINEUNITY_TEST_HAPI_OBJECTINFO_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x199247D0)
#define HOUDINIENGINEUNITY_TEST_HAPI_OBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x199247B0)
