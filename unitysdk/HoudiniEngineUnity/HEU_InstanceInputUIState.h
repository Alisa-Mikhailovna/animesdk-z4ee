...
#define HOUDINIENGINEUNITY_HEU_INSTANCEINPUTUISTATE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1989C4A0)
#define HOUDINIENGINEUNITY_HEU_INSTANCEINPUTUISTATE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x198B7CF0)
#define HOUDINIENGINEUNITY_HEU_INSTANCEINPUTUISTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x198B7F50)
