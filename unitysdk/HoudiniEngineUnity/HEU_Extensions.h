...
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_APPROXIMATELYEQUALS_1_OFFSET UNITYSDK_OFFSET(0x19855440)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_APPROXIMATELYEQUALS_OFFSET UNITYSDK_OFFSET(0x198553F0)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_ASBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x19855460)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_ASSTRING_OFFSET UNITYSDK_OFFSET(0x19855510)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_DECOMPOSETOPOSITION_OFFSET UNITYSDK_OFFSET(0x19855640)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_DECOMPOSETOROTATION_OFFSET UNITYSDK_OFFSET(0x19855690)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_DECOMPOSETOSCALE_OFFSET UNITYSDK_OFFSET(0x19855720)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_SWAPXANDY_OFFSET UNITYSDK_OFFSET(0x198555D0)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_SWAPXANDZ_OFFSET UNITYSDK_OFFSET(0x198555F0)
#define HOUDINIENGINEUNITY_HEU_EXTENSIONS_SWAPYANDZ_OFFSET UNITYSDK_OFFSET(0x19855620)
