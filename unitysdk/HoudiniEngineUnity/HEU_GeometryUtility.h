...
#define HOUDINIENGINEUNITY_HEU_GEOMETRYUTILITY_CALCULATEMESHTANGENTS_OFFSET UNITYSDK_OFFSET(0x19863F30)
#define HOUDINIENGINEUNITY_HEU_GEOMETRYUTILITY_GENERATECUBEMESHFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1986EFD0)
#define HOUDINIENGINEUNITY_HEU_GEOMETRYUTILITY_GENERATEPERTRIANGLE_OFFSET UNITYSDK_OFFSET(0x198661C0)
#define HOUDINIENGINEUNITY_HEU_GEOMETRYUTILITY_GENERATESECONDARYUVSET_OFFSET UNITYSDK_OFFSET(0x1986EF90)
#define HOUDINIENGINEUNITY_HEU_GEOMETRYUTILITY_GETINSTANCEOUTPUTNAME_OFFSET UNITYSDK_OFFSET(0x19847E80)
