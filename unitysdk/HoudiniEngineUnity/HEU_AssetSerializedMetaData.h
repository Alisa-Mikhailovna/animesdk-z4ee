...
#define HOUDINIENGINEUNITY_HEU_ASSETSERIALIZEDMETADATA_GET_SAVEDCURVENODEDATA_OFFSET UNITYSDK_OFFSET(0x19839410)
#define HOUDINIENGINEUNITY_HEU_ASSETSERIALIZEDMETADATA_GET_SAVEDINPUTCURVEINFO_OFFSET UNITYSDK_OFFSET(0x19839420)
#define HOUDINIENGINEUNITY_HEU_ASSETSERIALIZEDMETADATA_GET_SOFTDELETED_OFFSET UNITYSDK_OFFSET(0x198393F0)
#define HOUDINIENGINEUNITY_HEU_ASSETSERIALIZEDMETADATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19839430)
#define HOUDINIENGINEUNITY_HEU_ASSETSERIALIZEDMETADATA_SET_SOFTDELETED_OFFSET UNITYSDK_OFFSET(0x19839400)
#define HOUDINIENGINEUNITY_HEU_ASSETSERIALIZEDMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198394A0)
