...
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_COPYMATERIAL_OFFSET UNITYSDK_OFFSET(0x198BC7D0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEHOUDINIMATERIALDATA_OFFSET UNITYSDK_OFFSET(0x198BD320)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEMATERIALINCACHE_1_OFFSET UNITYSDK_OFFSET(0x198BCF40)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEMATERIALINCACHE_OFFSET UNITYSDK_OFFSET(0x198BD030)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATENEWHOUDINISTANDARDMATERIAL_OFFSET UNITYSDK_OFFSET(0x198BAAD0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_CREATEUNITYSUBSTANCEMATERIALDATA_OFFSET UNITYSDK_OFFSET(0x198BC980)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_DELETEASSETMATERIAL_OFFSET UNITYSDK_OFFSET(0x198975F0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_DESTROYNONASSETMATERIAL_OFFSET UNITYSDK_OFFSET(0x198BABB0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_DOESMATERIALEXISTINASSETCACHE_OFFSET UNITYSDK_OFFSET(0x198BAB70)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_ENABLEGPUINSTANCING_OFFSET UNITYSDK_OFFSET(0x198BC790)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_EXTRACTHOUDINIIMAGETOTEXTUREFILE_OFFSET UNITYSDK_OFFSET(0x198BB550)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_EXTRACTHOUDINIIMAGETOTEXTUREPNGJPEG_OFFSET UNITYSDK_OFFSET(0x198BB290)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_EXTRACTHOUDINIIMAGETOTEXTURERAW_OFFSET UNITYSDK_OFFSET(0x198BAC40)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_FINDPLUGINSHADER_OFFSET UNITYSDK_OFFSET(0x198B8A00)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_FINDSHADER_OFFSET UNITYSDK_OFFSET(0x198BA710)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GENERATEDEFAULTMATERIALNAME_OFFSET UNITYSDK_OFFSET(0x198BD1B0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETDEFAULTSTANDARDMATERIAL_OFFSET UNITYSDK_OFFSET(0x198BC800)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETMATERIALDATAFROMCACHE_OFFSET UNITYSDK_OFFSET(0x198BD250)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETMATERIALDATAMAPFROMCACHE_OFFSET UNITYSDK_OFFSET(0x198BD3E0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETNEWMATERIALWITHSHADER_OFFSET UNITYSDK_OFFSET(0x198BA870)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETORCREATEDEFAULTMATERIALINCACHE_OFFSET UNITYSDK_OFFSET(0x198BD060)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_GETUNITYSUBSTANCEMATERIALKEY_OFFSET UNITYSDK_OFFSET(0x198BC570)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADSUBSTANCEMATERIALWITHINDEX_OFFSET UNITYSDK_OFFSET(0x198BBFF0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADSUBSTANCEMATERIALWITHNAME_OFFSET UNITYSDK_OFFSET(0x198BBAA0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADTEXTURE_OFFSET UNITYSDK_OFFSET(0x198BC870)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_LOADUNITYMATERIAL_OFFSET UNITYSDK_OFFSET(0x198BB880)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_MATERIALHASGPUINSTANCINGENABLED_OFFSET UNITYSDK_OFFSET(0x198BC7B0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_MATERIALNAMETOKEY_OFFSET UNITYSDK_OFFSET(0x198BC700)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_RENDERANDEXTRACTIMAGETOTEXTURE_OFFSET UNITYSDK_OFFSET(0x198B9650)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_WHITETEXTURE_OFFSET UNITYSDK_OFFSET(0x198BC970)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY_WRITEMATERIALTOASSETCACHE_OFFSET UNITYSDK_OFFSET(0x198BAAF0)
#define HOUDINIENGINEUNITY_HEU_MATERIALFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x198BD700)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(HEU_MaterialFactory_TypeDefinitionIndex)->GetStaticField(0xFAA0);
		}
