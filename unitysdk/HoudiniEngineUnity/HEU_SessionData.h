...
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GETORCREATESESSIONSYNC_OFFSET UNITYSDK_OFFSET(0x198F0910)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GETSESSIONSYNC_OFFSET UNITYSDK_OFFSET(0x198F0B40)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_ISDEFAULTSESSION_OFFSET UNITYSDK_OFFSET(0x198F0DC0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x198F0C00)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_ISSESSIONSYNC_OFFSET UNITYSDK_OFFSET(0x198EF480)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_ISVALIDSESSIONID_OFFSET UNITYSDK_OFFSET(0x198F0C20)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_PIPENAME_OFFSET UNITYSDK_OFFSET(0x198F0C30)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_PORT_OFFSET UNITYSDK_OFFSET(0x198F0C50)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_PROCESSID_OFFSET UNITYSDK_OFFSET(0x198F0BC0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SESSIONCLASSTYPE_OFFSET UNITYSDK_OFFSET(0x198F0CD0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x198F0B60)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SESSIONTYPE_OFFSET UNITYSDK_OFFSET(0x198F0BE0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SHAREDMEMORYBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x198F0CB0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SHAREDMEMORYBUFFERTYPE_OFFSET UNITYSDK_OFFSET(0x198F0C90)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_SHAREDMEMORYNAME_OFFSET UNITYSDK_OFFSET(0x198F0C70)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_THISCONNECTIONMODE_OFFSET UNITYSDK_OFFSET(0x198F0DE0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_GET_THISSESSIONMODE_OFFSET UNITYSDK_OFFSET(0x198F0E00)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SETSESSIONSYNC_OFFSET UNITYSDK_OFFSET(0x198F0B50)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_ISDEFAULTSESSION_OFFSET UNITYSDK_OFFSET(0x198F0DD0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x198F0C10)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_PIPENAME_OFFSET UNITYSDK_OFFSET(0x198F0C40)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_PORT_OFFSET UNITYSDK_OFFSET(0x198F0C60)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_PROCESSID_OFFSET UNITYSDK_OFFSET(0x198F0BD0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SESSIONCLASSTYPE_OFFSET UNITYSDK_OFFSET(0x198F0D20)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x198EFC80)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SESSIONTYPE_OFFSET UNITYSDK_OFFSET(0x198F0BF0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SHAREDMEMORYBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x198F0CC0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SHAREDMEMORYBUFFERTYPE_OFFSET UNITYSDK_OFFSET(0x198F0CA0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_SHAREDMEMORYNAME_OFFSET UNITYSDK_OFFSET(0x198F0C80)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_THISCONNECTIONMODE_OFFSET UNITYSDK_OFFSET(0x198F0DF0)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA_SET_THISSESSIONMODE_OFFSET UNITYSDK_OFFSET(0x198F0E10)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x198F0E30)
#define HOUDINIENGINEUNITY_HEU_SESSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198F0E20)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(HEU_SessionData_TypeDefinitionIndex)->GetStaticField(0x4780);
		}
