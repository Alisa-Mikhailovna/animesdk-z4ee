...
#define HOUDINIENGINEUNITY_HEU_GENERATEGEOCACHE_HEU_COLLIDERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19866670)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		::System::Boolean _convexCollider; // 0x28
		::System::Boolean _isTrigger; // 0x29
