...
#define HOUDINIENGINEUNITY_TEST_TERRAIN_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19927F00)
#define HOUDINIENGINEUNITY_TEST_TERRAIN_ISNULL_OFFSET UNITYSDK_OFFSET(0x19927EE0)
#define HOUDINIENGINEUNITY_TEST_TERRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19927ED0)
