...
#define HOUDINIENGINEUNITY_HEU_VECTOR2SERIALIZATIONSURROGATE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZATIONSURROGATE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1990CFD0)
#define HOUDINIENGINEUNITY_HEU_VECTOR2SERIALIZATIONSURROGATE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZATIONSURROGATE_SETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1990D130)
#define HOUDINIENGINEUNITY_HEU_VECTOR2SERIALIZATIONSURROGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1990D330)
