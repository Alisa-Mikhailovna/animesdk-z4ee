...
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_CLEARHOUDINIENGINEREFERENCES_OFFSET UNITYSDK_OFFSET(0x1989E720)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_DESTROYROOTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1989E770)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_GET_BAKETARGETS_OFFSET UNITYSDK_OFFSET(0x1989E5F0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_GET_HOUDINIASSET_OFFSET UNITYSDK_OFFSET(0x1989E5E0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1989E600)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_REMOVEHOUDINIENGINEASSETDATA_OFFSET UNITYSDK_OFFSET(0x1989E630)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT_RESET_OFFSET UNITYSDK_OFFSET(0x1989E7B0)
#define HOUDINIENGINEUNITY_HEU_HOUDINIASSETROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1989E820)
