...
#define HOUDINIENGINEUNITY_HEU_PDGSESSION_ONWORKITEMLOADRESULTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198C9110)
#define HOUDINIENGINEUNITY_HEU_PDGSESSION_ONWORKITEMLOADRESULTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198C9140)
#define HOUDINIENGINEUNITY_HEU_PDGSESSION_ONWORKITEMLOADRESULTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x198C9100)
#define HOUDINIENGINEUNITY_HEU_PDGSESSION_ONWORKITEMLOADRESULTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x198C9010)
