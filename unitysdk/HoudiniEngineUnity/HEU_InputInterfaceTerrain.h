...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_CREATEHEIGHTFIELDINPUTNODE_OFFSET UNITYSDK_OFFSET(0x198AA250)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_CREATEINPUTNODEWITHDATAUPLOAD_OFFSET UNITYSDK_OFFSET(0x198A9850)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_GENERATETERRAINDATAFROMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x198A9C10)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_ISTHISINPUTOBJECTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x198AD2F0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_SETHEIGHTFIELDDATA_OFFSET UNITYSDK_OFFSET(0x198ACC70)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_SETMASKLAYER_OFFSET UNITYSDK_OFFSET(0x198ACA00)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_SETTERRAINDATAATTRIBUTESTOHEIGHTFIELD_OFFSET UNITYSDK_OFFSET(0x198AD360)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_SETTERRAINLAYERATTRIBUTESTOHEIGHTFIELD_OFFSET UNITYSDK_OFFSET(0x198AD500)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_SETTREEINSTANCES_OFFSET UNITYSDK_OFFSET(0x198AD560)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_SETTREEPROTOTYPES_OFFSET UNITYSDK_OFFSET(0x198AD3C0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_UPLOADALPHAMAPS_OFFSET UNITYSDK_OFFSET(0x198AB7B0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN_UPLOADHEIGHTVALUESWITHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x198AA6B0)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACETERRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x198A9840)
