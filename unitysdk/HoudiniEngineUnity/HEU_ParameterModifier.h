...
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_GETNEWMODIFIER_1_OFFSET UNITYSDK_OFFSET(0x198CA0C0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_GETNEWMODIFIER_OFFSET UNITYSDK_OFFSET(0x198CA040)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x198C9F70)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_GET_FLOATVALUE_OFFSET UNITYSDK_OFFSET(0x198CA000)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_GET_INSTANCEINDEX_OFFSET UNITYSDK_OFFSET(0x198C9FC0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_GET_INTVALUE_OFFSET UNITYSDK_OFFSET(0x198CA020)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_GET_MODIFIERVALUE_OFFSET UNITYSDK_OFFSET(0x198C9FE0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_GET_PARAMETERINDEX_OFFSET UNITYSDK_OFFSET(0x198C9F50)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x198CA140)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_MODIFIERACTION_INTERNALTOWRAPPER_OFFSET UNITYSDK_OFFSET(0x198C9F80)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_MODIFIERACTION_WRAPPERTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x198C9FB0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x198C9F90)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_SET_FLOATVALUE_OFFSET UNITYSDK_OFFSET(0x198CA010)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_SET_INSTANCEINDEX_OFFSET UNITYSDK_OFFSET(0x198C9FD0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_SET_INTVALUE_OFFSET UNITYSDK_OFFSET(0x198CA030)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_SET_MODIFIERVALUE_OFFSET UNITYSDK_OFFSET(0x198C9FF0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER_SET_PARAMETERINDEX_OFFSET UNITYSDK_OFFSET(0x198C9F60)
#define HOUDINIENGINEUNITY_HEU_PARAMETERMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x198CA130)
