...
#define HOUDINIENGINEUNITY_TEST_CAPSULECOLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19922820)
#define HOUDINIENGINEUNITY_TEST_CAPSULECOLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x19922800)
#define HOUDINIENGINEUNITY_TEST_CAPSULECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x199227F0)
