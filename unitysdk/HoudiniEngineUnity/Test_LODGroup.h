...
#define HOUDINIENGINEUNITY_TEST_LODGROUP_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19925390)
#define HOUDINIENGINEUNITY_TEST_LODGROUP_ISNULL_OFFSET UNITYSDK_OFFSET(0x19925370)
#define HOUDINIENGINEUNITY_TEST_LODGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19925360)
