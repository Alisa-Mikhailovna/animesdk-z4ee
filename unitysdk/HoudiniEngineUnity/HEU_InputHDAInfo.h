...
#define HOUDINIENGINEUNITY_HEU_INPUTHDAINFO_COPYTO_OFFSET UNITYSDK_OFFSET(0x1989EBA0)
#define HOUDINIENGINEUNITY_HEU_INPUTHDAINFO_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x1989EBD0)
#define HOUDINIENGINEUNITY_HEU_INPUTHDAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1989ED40)
