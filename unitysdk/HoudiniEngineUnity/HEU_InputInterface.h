...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1989ED50)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACE_REGISTERINTERFACE_OFFSET UNITYSDK_OFFSET(0x1989ED70)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1989ED60)
