...
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ANYWORKITEMSFAILED_OFFSET UNITYSDK_OFFSET(0x198FB730)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ANYWORKITEMSPENDING_OFFSET UNITYSDK_OFFSET(0x198FB780)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_AREALLWORKITEMSCOMPLETE_OFFSET UNITYSDK_OFFSET(0x198FB6E0)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_PROGRESSRATIO_OFFSET UNITYSDK_OFFSET(0x19912250)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY_ZEROALL_OFFSET UNITYSDK_OFFSET(0x198FB690)
#define HOUDINIENGINEUNITY_HEU_WORKITEMTALLY__CTOR_OFFSET UNITYSDK_OFFSET(0x198FB820)
