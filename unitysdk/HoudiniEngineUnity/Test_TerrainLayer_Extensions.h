...
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER_EXTENSIONS_TOTESTOBJECT_1_OFFSET UNITYSDK_OFFSET(0x19928870)
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER_EXTENSIONS_TOTESTOBJECT_2_OFFSET UNITYSDK_OFFSET(0x19929460)
#define HOUDINIENGINEUNITY_TEST_TERRAINLAYER_EXTENSIONS_TOTESTOBJECT_OFFSET UNITYSDK_OFFSET(0x19929420)
