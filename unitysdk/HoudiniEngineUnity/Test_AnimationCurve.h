...
#define HOUDINIENGINEUNITY_TEST_ANIMATIONCURVE_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19921DB0)
#define HOUDINIENGINEUNITY_TEST_ANIMATIONCURVE_ISNULL_OFFSET UNITYSDK_OFFSET(0x19921DA0)
#define HOUDINIENGINEUNITY_TEST_ANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19921D90)
