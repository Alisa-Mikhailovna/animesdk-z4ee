...
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0x198C5440)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CANCELCOOK_OFFSET UNITYSDK_OFFSET(0x198C4E10)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARALLTOPDATA_OFFSET UNITYSDK_OFFSET(0x198C3B60)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARTOPNETWORKWORKITEMRESULTS_OFFSET UNITYSDK_OFFSET(0x198C4860)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARTOPNODEWORKITEMRESULTS_OFFSET UNITYSDK_OFFSET(0x198C45A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARWORKITEMRESULTBYID_OFFSET UNITYSDK_OFFSET(0x198C6C10)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_CLEARWORKITEMRESULT_OFFSET UNITYSDK_OFFSET(0x198C6D80)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_COOKOUTPUT_OFFSET UNITYSDK_OFFSET(0x198C4950)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_COOKTOPNODE_OFFSET UNITYSDK_OFFSET(0x198C46F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DESTROYWORKITEMRESULTDATA_OFFSET UNITYSDK_OFFSET(0x198C69C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DIRTYALL_OFFSET UNITYSDK_OFFSET(0x198C4790)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_DIRTYTOPNODE_OFFSET UNITYSDK_OFFSET(0x198C4480)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETHAPISESSION_OFFSET UNITYSDK_OFFSET(0x198C4B70)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETLOADROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x198C7990)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETNONHIDDENTOPNODES_OFFSET UNITYSDK_OFFSET(0x198C40E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETSELECTEDTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x198C4340)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETSELECTEDTOPNODE_OFFSET UNITYSDK_OFFSET(0x198C43F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNETWORKBYNAME_OFFSET UNITYSDK_OFFSET(0x198C51C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x198C43A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODEBYNAME_OFFSET UNITYSDK_OFFSET(0x198C5300)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODESTATUS_OFFSET UNITYSDK_OFFSET(0x198C5120)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETTOPNODE_OFFSET UNITYSDK_OFFSET(0x198C4FD0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GETWORKRESULTBYID_OFFSET UNITYSDK_OFFSET(0x198C6C90)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETGO_OFFSET UNITYSDK_OFFSET(0x198C37C0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETID_OFFSET UNITYSDK_OFFSET(0x198C37E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETLINKSTATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x198C3870)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETNAME_OFFSET UNITYSDK_OFFSET(0x198C37D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x198C37B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_AUTOCOOK_OFFSET UNITYSDK_OFFSET(0x198C36E0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_COOKEDDATAEVENT_OFFSET UNITYSDK_OFFSET(0x198C3860)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_LOADROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x198C3840)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_OUTPUTCACHEPATHROOT_OFFSET UNITYSDK_OFFSET(0x198C3850)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_PARENTASSET_OFFSET UNITYSDK_OFFSET(0x198C37A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_PDGLINKSTATE_OFFSET UNITYSDK_OFFSET(0x198C3820)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_SELECTEDTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x198C3810)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNETWORKNAMES_OFFSET UNITYSDK_OFFSET(0x198C3800)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNETWORKS_OFFSET UNITYSDK_OFFSET(0x198C37F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x198C3760)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_TOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x198C3780)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x198C3700)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USETOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x198C3720)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_GET_USETOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x198C3740)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_HANDLEINITIALLOAD_OFFSET UNITYSDK_OFFSET(0x198C5450)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LINKSTATE_INTERNALTOWRAPPER_OFFSET UNITYSDK_OFFSET(0x198C3830)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LINKSTATE_WRAPPERTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x198C8370)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_LOADRESULTS_OFFSET UNITYSDK_OFFSET(0x198C6E30)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_1_OFFSET UNITYSDK_OFFSET(0x198C5540)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_2_OFFSET UNITYSDK_OFFSET(0x198C5570)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_NOTIFYASSETCOOKED_OFFSET UNITYSDK_OFFSET(0x198C5510)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x198C5470)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x198C5460)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x198C5480)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONSYNCCOMPLETE_OFFSET UNITYSDK_OFFSET(0x198C8310)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONTOPNODEFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x198C7C20)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_ONTOPOUTPUTFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0x198C7FD0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_PARSEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x198C6070)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_PAUSECOOK_OFFSET UNITYSDK_OFFSET(0x198C4C50)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATEFROMHDA_OFFSET UNITYSDK_OFFSET(0x198C3E00)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATETOPNETWORKS_OFFSET UNITYSDK_OFFSET(0x198C55A0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_POPULATETOPNODES_OFFSET UNITYSDK_OFFSET(0x198C6300)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_REFRESH_OFFSET UNITYSDK_OFFSET(0x198C3890)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_REPAINTUI_OFFSET UNITYSDK_OFFSET(0x198C3DE0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_RESETTOPNETWORKWORKITEMTALLY_OFFSET UNITYSDK_OFFSET(0x198C4B90)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_RESET_OFFSET UNITYSDK_OFFSET(0x198C3880)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SELECTTOPNETWORK_OFFSET UNITYSDK_OFFSET(0x198C42D0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SELECTTOPNODE_OFFSET UNITYSDK_OFFSET(0x198C4300)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SETUPTOPNETWORKNAMES_OFFSET UNITYSDK_OFFSET(0x198C68F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SETUP_OFFSET UNITYSDK_OFFSET(0x198804B0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_AUTOCOOK_OFFSET UNITYSDK_OFFSET(0x198C36F0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_TOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x198C3770)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_TOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x198C3790)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USEHENGINEDATA_OFFSET UNITYSDK_OFFSET(0x198C3710)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USETOPNODEFILTER_OFFSET UNITYSDK_OFFSET(0x198C3730)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_SET_USETOPOUTPUTFILTER_OFFSET UNITYSDK_OFFSET(0x198C3750)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_UPDATETOPNODERESULTSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x198C6DF0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK_UPDATEWORKITEMTALLY_OFFSET UNITYSDK_OFFSET(0x198C7AA0)
#define HOUDINIENGINEUNITY_HEU_PDGASSETLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x198C8380)
