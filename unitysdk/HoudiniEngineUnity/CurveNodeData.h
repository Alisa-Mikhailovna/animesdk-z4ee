...
#define HOUDINIENGINEUNITY_CURVENODEDATA_GETROTATION_OFFSET UNITYSDK_OFFSET(0x198365C0)
#define HOUDINIENGINEUNITY_CURVENODEDATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19836620)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19836270)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x198362C0)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_3_OFFSET UNITYSDK_OFFSET(0x198363F0)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19836530)
#define HOUDINIENGINEUNITY_CURVENODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19836230)
