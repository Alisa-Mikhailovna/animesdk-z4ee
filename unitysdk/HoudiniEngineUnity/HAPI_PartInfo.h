...
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GETELEMENTCOUNTBYATTRIBUTEOWNER_OFFSET UNITYSDK_OFFSET(0x2E9E250)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GETELEMENTCOUNTBYGROUPTYPE_OFFSET UNITYSDK_OFFSET(0x2E9E290)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GET_DETAILATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x2E9E4C0)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GET_POINTATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x2E9E2E0)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GET_PRIMITIVEATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x2E9E380)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_GET_VERTEXATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x2E9E420)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_INIT_OFFSET UNITYSDK_OFFSET(0x2E9E2B0)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_SET_DETAILATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x2E9E510)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_SET_POINTATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x2E9E330)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_SET_PRIMITIVEATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x2E9E3D0)
#define HOUDINIENGINEUNITY_HAPI_PARTINFO_SET_VERTEXATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x2E9E470)
