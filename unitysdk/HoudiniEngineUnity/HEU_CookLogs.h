...
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_APPENDCOOKLOG_OFFSET UNITYSDK_OFFSET(0x19849290)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_CLEARCOOKLOG_OFFSET UNITYSDK_OFFSET(0x19849790)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_DELETECOOKINGFILE_OFFSET UNITYSDK_OFFSET(0x198498C0)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GETCOOKLOGFILEPATH_OFFSET UNITYSDK_OFFSET(0x19849810)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GETCOOKLOGSTRING_OFFSET UNITYSDK_OFFSET(0x19849270)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GETFILESIZEOFLOGFILE_OFFSET UNITYSDK_OFFSET(0x19849B60)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x198490F0)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS_WRITETOLOGFILE_OFFSET UNITYSDK_OFFSET(0x198494C0)
#define HOUDINIENGINEUNITY_HEU_COOKLOGS__CTOR_OFFSET UNITYSDK_OFFSET(0x198491E0)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		{
			return (::HoudiniEngineUnity::HEU_CookLogs**)Il2CppClass::FromTypeDefinitionIndex(HEU_CookLogs_TypeDefinitionIndex)->GetStaticField(0xC6B0);
		}
