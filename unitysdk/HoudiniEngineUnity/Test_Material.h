...
#define HOUDINIENGINEUNITY_TEST_MATERIAL_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19925A80)
#define HOUDINIENGINEUNITY_TEST_MATERIAL_ISNULL_OFFSET UNITYSDK_OFFSET(0x19925A60)
#define HOUDINIENGINEUNITY_TEST_MATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19925A50)
