...
#define HOUDINIENGINEUNITY_TEST_BOXCOLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19922270)
#define HOUDINIENGINEUNITY_TEST_BOXCOLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x19922250)
#define HOUDINIENGINEUNITY_TEST_BOXCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19922240)
