...
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_1_OFFSET UNITYSDK_OFFSET(0x19903AA0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_2_OFFSET UNITYSDK_OFFSET(0x19903CB0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_ASSERTTRUELOGEQUIVALENT_OFFSET UNITYSDK_OFFSET(0x19902B80)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_PRINTTESTLOGANDSETRESULT_OFFSET UNITYSDK_OFFSET(0x19903950)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_SHOULDBETESTED_1_OFFSET UNITYSDK_OFFSET(0x19903BE0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_SHOULDBETESTED_OFFSET UNITYSDK_OFFSET(0x19902C30)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS_TESTOUTPUTOBJECTEQUIVALENCE_OFFSET UNITYSDK_OFFSET(0x19902DB0)
#define HOUDINIENGINEUNITY_HEU_TESTHELPERS__CTOR_OFFSET UNITYSDK_OFFSET(0x19903EF0)
