...
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_CHILDINDEX_OFFSET UNITYSDK_OFFSET(0x198C9160)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_FLOATMAX_OFFSET UNITYSDK_OFFSET(0x198C9510)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_FLOATMIN_OFFSET UNITYSDK_OFFSET(0x198C9500)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_FLOATUIMAX_OFFSET UNITYSDK_OFFSET(0x198C9530)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_FLOATUIMIN_OFFSET UNITYSDK_OFFSET(0x198C9520)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_INTMAX_OFFSET UNITYSDK_OFFSET(0x198C92C0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_INTMIN_OFFSET UNITYSDK_OFFSET(0x198C9200)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_INTUIMAX_OFFSET UNITYSDK_OFFSET(0x198C9440)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_INTUIMIN_OFFSET UNITYSDK_OFFSET(0x198C9380)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_PARENTID_OFFSET UNITYSDK_OFFSET(0x198C9150)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_PARMID_OFFSET UNITYSDK_OFFSET(0x198B5B50)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_GET_PARMSIZE_OFFSET UNITYSDK_OFFSET(0x198C9170)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_HASMAX_OFFSET UNITYSDK_OFFSET(0x198C91D0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_HASMIN_OFFSET UNITYSDK_OFFSET(0x198C91C0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_HASUIMAX_OFFSET UNITYSDK_OFFSET(0x198C91F0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_HASUIMIN_OFFSET UNITYSDK_OFFSET(0x198C91E0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISASSETPATH_OFFSET UNITYSDK_OFFSET(0x198C9650)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISBUTTON_OFFSET UNITYSDK_OFFSET(0x198C95D0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISCOLORRAMP_OFFSET UNITYSDK_OFFSET(0x198C9590)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISCOLOR_OFFSET UNITYSDK_OFFSET(0x198C95B0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISCONTAINER_OFFSET UNITYSDK_OFFSET(0x198C9540)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x198C9660)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISFLOATRAMP_OFFSET UNITYSDK_OFFSET(0x198C9580)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x198C9190)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISFOLDER_OFFSET UNITYSDK_OFFSET(0x198C95C0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISINT_OFFSET UNITYSDK_OFFSET(0x198C9180)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISMULTIPARAM_OFFSET UNITYSDK_OFFSET(0x198C9560)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISPATHFILE_OFFSET UNITYSDK_OFFSET(0x198C91B0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISRAMP_OFFSET UNITYSDK_OFFSET(0x198C9570)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISSTRING_OFFSET UNITYSDK_OFFSET(0x198C91A0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_ISTOGGLE_OFFSET UNITYSDK_OFFSET(0x198C95A0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x198C95E0)
#define HOUDINIENGINEUNITY_HEU_PARAMETERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198C9EF0)
