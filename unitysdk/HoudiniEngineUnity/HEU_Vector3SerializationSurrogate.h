...
#define HOUDINIENGINEUNITY_HEU_VECTOR3SERIALIZATIONSURROGATE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZATIONSURROGATE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1990D340)
#define HOUDINIENGINEUNITY_HEU_VECTOR3SERIALIZATIONSURROGATE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZATIONSURROGATE_SETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1990D500)
#define HOUDINIENGINEUNITY_HEU_VECTOR3SERIALIZATIONSURROGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1990D7B0)
