...
#define HOUDINIENGINEUNITY_HEU_INPUTOBJECTINFO_COPYTO_OFFSET UNITYSDK_OFFSET(0x198B4D70)
#define HOUDINIENGINEUNITY_HEU_INPUTOBJECTINFO_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x198B7210)
#define HOUDINIENGINEUNITY_HEU_INPUTOBJECTINFO_SETREFERENCESFROMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x198B58B0)
#define HOUDINIENGINEUNITY_HEU_INPUTOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x198B4CA0)
