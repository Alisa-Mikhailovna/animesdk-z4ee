...
#define HOUDINIENGINEUNITY_TEST_TERRAINDATA_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x199280F0)
#define HOUDINIENGINEUNITY_TEST_TERRAINDATA_ISNULL_OFFSET UNITYSDK_OFFSET(0x199280D0)
#define HOUDINIENGINEUNITY_TEST_TERRAINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x199280C0)
