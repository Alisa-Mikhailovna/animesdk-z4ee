...
#define HOUDINIENGINEUNITY_HEU_SESSIONSYNCDATA_GET_SYNCSTATUS_OFFSET UNITYSDK_OFFSET(0x198F6490)
#define HOUDINIENGINEUNITY_HEU_SESSIONSYNCDATA_SET_SYNCSTATUS_OFFSET UNITYSDK_OFFSET(0x198F64A0)
#define HOUDINIENGINEUNITY_HEU_SESSIONSYNCDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198F0A50)
