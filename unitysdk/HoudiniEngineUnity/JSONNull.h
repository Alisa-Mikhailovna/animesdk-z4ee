...
#define HOUDINIENGINEUNITY_JSONNULL_CREATEORGET_OFFSET UNITYSDK_OFFSET(0x1991FBD0)
#define HOUDINIENGINEUNITY_JSONNULL_EQUALS_OFFSET UNITYSDK_OFFSET(0x1991FCC0)
#define HOUDINIENGINEUNITY_JSONNULL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1991FC60)
#define HOUDINIENGINEUNITY_JSONNULL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1991FD20)
#define HOUDINIENGINEUNITY_JSONNULL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x1991FCA0)
#define HOUDINIENGINEUNITY_JSONNULL_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1991FC50)
#define HOUDINIENGINEUNITY_JSONNULL_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1991FC40)
#define HOUDINIENGINEUNITY_JSONNULL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1991FC80)
#define HOUDINIENGINEUNITY_JSONNULL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x1991FCB0)
#define HOUDINIENGINEUNITY_JSONNULL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1991FC90)
#define HOUDINIENGINEUNITY_JSONNULL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1991FD30)
#define HOUDINIENGINEUNITY_JSONNULL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1991FD60)
#define HOUDINIENGINEUNITY_JSONNULL__CTOR_OFFSET UNITYSDK_OFFSET(0x1991FC30)
...
namespace HoudiniEngineUnity
{
	...
	public:
		...
		{
			return (::HoudiniEngineUnity::JSONNull**)Il2CppClass::FromTypeDefinitionIndex(JSONNull_TypeDefinitionIndex)->GetStaticField(0x1A690);
		}
		static ::System::Boolean* StaticGet_reuseSameInstance()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(JSONNull_TypeDefinitionIndex)->GetStaticField(0x6160);
		}
