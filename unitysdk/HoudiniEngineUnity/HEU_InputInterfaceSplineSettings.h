...
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACESPLINESETTINGS_GET_SAMPLINGRESOLUTION_OFFSET UNITYSDK_OFFSET(0x198A9810)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACESPLINESETTINGS_SET_SAMPLINGRESOLUTION_OFFSET UNITYSDK_OFFSET(0x198A9820)
#define HOUDINIENGINEUNITY_HEU_INPUTINTERFACESPLINESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x198A9830)
