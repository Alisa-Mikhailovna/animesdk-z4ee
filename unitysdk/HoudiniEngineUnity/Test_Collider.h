...
#define HOUDINIENGINEUNITY_TEST_COLLIDER_ISEQUIVALENTTO_OFFSET UNITYSDK_OFFSET(0x19922D40)
#define HOUDINIENGINEUNITY_TEST_COLLIDER_ISNULL_OFFSET UNITYSDK_OFFSET(0x19922D20)
#define HOUDINIENGINEUNITY_TEST_COLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19922D10)
