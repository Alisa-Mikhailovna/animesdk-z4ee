...
#define CLASS_2_47C66A3BEB7A5F01_ADDLEVELVARIABLELISTENER_OFFSET UNITYSDK_OFFSET(0xB525C80)
#define CLASS_2_47C66A3BEB7A5F01_ADDLITTLEGAMECUSTOMEVENTLISTENER_1_OFFSET UNITYSDK_OFFSET(0xB525360)
#define CLASS_2_47C66A3BEB7A5F01_ADDLITTLEGAMECUSTOMEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0xB525290)
#define CLASS_2_47C66A3BEB7A5F01_EVALUATELEVELVARNUMBER_OFFSET UNITYSDK_OFFSET(0xB525B30)
#define CLASS_2_47C66A3BEB7A5F01_EVALUATELEVELVARSHORT_OFFSET UNITYSDK_OFFSET(0xB525890)
#define CLASS_2_47C66A3BEB7A5F01_GETSERVICES_OFFSET UNITYSDK_OFFSET(0xB525E60)
#define CLASS_2_47C66A3BEB7A5F01_GET_SKIPSTARTCURVE_OFFSET UNITYSDK_OFFSET(0xB525150)
#define CLASS_2_47C66A3BEB7A5F01_GET_SPAWNPOSITIONENTITYID_OFFSET UNITYSDK_OFFSET(0xB525170)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_08BBACE844405300_OFFSET UNITYSDK_OFFSET(0xB51CD40)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_11A5396029C33A57_OFFSET UNITYSDK_OFFSET(0xB51D680)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_1293CB739F1151A1_OFFSET UNITYSDK_OFFSET(0xB51EFE0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_1738FE11B4451187_OFFSET UNITYSDK_OFFSET(0xB51CB40)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_262A06AA54D89156_OFFSET UNITYSDK_OFFSET(0xB524240)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_2E29038CF17E20BD_OFFSET UNITYSDK_OFFSET(0xB521E40)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_45B5CA713DA5A736_OFFSET UNITYSDK_OFFSET(0xB522A20)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_626C719A884DEF9A_OFFSET UNITYSDK_OFFSET(0xB51D5F0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_64501B5CB67A94C3_OFFSET UNITYSDK_OFFSET(0xB523B00)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_6DC60149A270E0D4_OFFSET UNITYSDK_OFFSET(0xB521DE0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_77EA5BCD93BD96AE_OFFSET UNITYSDK_OFFSET(0xB51F1D0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0xB520510)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_89A1C764C1D4450D_OFFSET UNITYSDK_OFFSET(0xB522460)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xB51FD10)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0xB5233F0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_97BC79BDB09179A3_OFFSET UNITYSDK_OFFSET(0xB51CC80)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_AA2D3E889C8A52CA_1_OFFSET UNITYSDK_OFFSET(0xB51ED30)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0xB51ECD0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB524200)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB5204D0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_CB85B033A22FCEF0_OFFSET UNITYSDK_OFFSET(0xB525F20)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0xB521760)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0xB51EBA0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_E4D7CA44911A3A88_OFFSET UNITYSDK_OFFSET(0xB525EB0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_E5630A859AA24FB3_OFFSET UNITYSDK_OFFSET(0xB5250D0)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xB525140)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0xB525070)
#define CLASS_2_47C66A3BEB7A5F01_METHOD_2_F239777256F9BA8F_OFFSET UNITYSDK_OFFSET(0xB525130)
#define CLASS_2_47C66A3BEB7A5F01_REMOVELEVELVARIABLELISTENER_OFFSET UNITYSDK_OFFSET(0xB525DB0)
#define CLASS_2_47C66A3BEB7A5F01_REMOVELITTLEGAMECUSTOMEVENTLISTENER_1_OFFSET UNITYSDK_OFFSET(0xB525510)
#define CLASS_2_47C66A3BEB7A5F01_REMOVELITTLEGAMECUSTOMEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0xB525410)
#define CLASS_2_47C66A3BEB7A5F01_SETLEVELVARSHORT_OFFSET UNITYSDK_OFFSET(0xB5255C0)
#define CLASS_2_47C66A3BEB7A5F01_SET_SKIPSTARTCURVE_OFFSET UNITYSDK_OFFSET(0xB525160)
#define CLASS_2_47C66A3BEB7A5F01_SET_SPAWNPOSITIONENTITYID_OFFSET UNITYSDK_OFFSET(0xB525180)
#define CLASS_2_47C66A3BEB7A5F01_TRIGGERLITTLEGAMECUSTOMEVENT_1_OFFSET UNITYSDK_OFFSET(0xB525220)
#define CLASS_2_47C66A3BEB7A5F01_TRIGGERLITTLEGAMECUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xB525190)
#define CLASS_2_47C66A3BEB7A5F01__CANLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB524630)
#define CLASS_2_47C66A3BEB7A5F01__CCTOR_OFFSET UNITYSDK_OFFSET(0xB526020)
#define CLASS_2_47C66A3BEB7A5F01__CTOR_OFFSET UNITYSDK_OFFSET(0xB525F80)
#define CLASS_2_47C66A3BEB7A5F01__FINISHINIT_OFFSET UNITYSDK_OFFSET(0xB523290)
#define CLASS_2_47C66A3BEB7A5F01__ONCLEAR_OFFSET UNITYSDK_OFFSET(0xB524370)
#define CLASS_2_47C66A3BEB7A5F01__ONINIT_OFFSET UNITYSDK_OFFSET(0xB51ED90)
#define CLASS_2_47C66A3BEB7A5F01__ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB524670)
#define CLASS_2_47C66A3BEB7A5F01__ONSTART_OFFSET UNITYSDK_OFFSET(0xB51FED0)
#define CLASS_2_47C66A3BEB7A5F01__ONSTOP_OFFSET UNITYSDK_OFFSET(0xB523CB0)
#define CLASS_2_47C66A3BEB7A5F01__ONTICK_OFFSET UNITYSDK_OFFSET(0xB5247E0)
#define CLASS_2_47C66A3BEB7A5F01__SETPOSTPROCESSONCLEAR_OFFSET UNITYSDK_OFFSET(0xB5245F0)
#define CLASS_2_47C66A3BEB7A5F01__SETPOSTPROCESSONINIT_OFFSET UNITYSDK_OFFSET(0xB5245B0)
#define CLASS_2_47C66A3BEB7A5F01__STARTLEVELGRAPH_OFFSET UNITYSDK_OFFSET(0xB523C70)
#define CLASS_2_47C66A3BEB7A5F01___BUILDENTITIES_G__GETINDEX_44_3_OFFSET UNITYSDK_OFFSET(0xB5260E0)
#define CLASS_2_47C66A3BEB7A5F01___ONTICK_B__43_0_OFFSET UNITYSDK_OFFSET(0xB526030)
...
public:
	...
	{
		return (::Class_2_47C66A3BEB7A5F01**)Il2CppClass::FromTypeDefinitionIndex(Class_2_47C66A3BEB7A5F01_TypeDefinitionIndex)->GetStaticField(0x6B730);
	}
	static ::System::Int32* StaticGet_Field_2_1()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_47C66A3BEB7A5F01_TypeDefinitionIndex)->GetStaticField(0x14820);
	}
	...
	::RPG::Client::FPSCameraOverride* Field_2_8; // 0x78
	::UnityEngine::GameObject* Field_2_9; // 0x80
	::RPG::Client::AdventurePhase* Field_2_10; // 0x88
	::Class_1_2CDF619C23140440* Field_2_11; // 0x90
	::RPG::GameCore::LittleGameLevelVarBindingMap* Field_2_12; // 0x98
	::Class_3_001D9EA49F6215B6* Field_2_13; // 0xA0
	::UnityEngine::GameObject* Field_2_14; // 0xA8
	::Class_3_8B00E2EA8FAE133F* Field_2_15; // 0xB0
	::System::String* Field_2_16; // 0xB8
	::RPG::GameCore::GameEntity* Field_2_17; // 0xC0
	::RPG::Client::LittleGame::SimpleEventService_1<::Class_2_56DCA1B58073717B*>* Field_2_18; // 0xC8
