...
#define CLASS_1_5B567C8A01BAEDFE_232_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C4A0660)
#define CLASS_1_5B567C8A01BAEDFE_232_CLONE_OFFSET UNITYSDK_OFFSET(0x1C4A0350)
#define CLASS_1_5B567C8A01BAEDFE_232_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C4A0460)
#define CLASS_1_5B567C8A01BAEDFE_232_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C4A0390)
#define CLASS_1_5B567C8A01BAEDFE_232_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C4A05C0)
#define CLASS_1_5B567C8A01BAEDFE_232_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C4A06B0)
#define CLASS_1_5B567C8A01BAEDFE_232_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C4A0680)
#define CLASS_1_5B567C8A01BAEDFE_232_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C4A02D0)
#define CLASS_1_5B567C8A01BAEDFE_232_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0300)
#define CLASS_1_5B567C8A01BAEDFE_232_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C4A05F0)
#define CLASS_1_5B567C8A01BAEDFE_232_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C4A0650)
#define CLASS_1_5B567C8A01BAEDFE_232__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0700)
#define CLASS_1_5B567C8A01BAEDFE_232__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4A0320)
#define CLASS_1_5B567C8A01BAEDFE_232__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0310)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_232*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_232_TypeDefinitionIndex)->GetStaticField(0x58150);
	}
