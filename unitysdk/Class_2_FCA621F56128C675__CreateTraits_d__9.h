...
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x14C07F40)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_GRIDFIGHTTRAIT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x14C088B0)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_GRIDFIGHTTRAIT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x14C08840)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x14C08930)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x14C088A0)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x14C08850)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14C07E00)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x14C07D20)
#define CLASS_2_FCA621F56128C675__CREATETRAITS_D__9___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x14C07E40)
...
public:
	...
	::System::Collections::Generic::IEnumerator_1<::RPG::Client::GridFightUnlockTraitMember*>* __7__wrap3; // 0x18
	::RPG::Client::GridFightTrait* __2__current; // 0x20
	::Class_2_FCA621F56128C675* __4__this; // 0x28
	::Il2CppArray<::System::UInt32>* __7__wrap1; // 0x30
	::RPG::Client::GridFightRole* __3__role; // 0x38
