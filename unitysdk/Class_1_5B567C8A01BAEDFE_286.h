...
#define CLASS_1_5B567C8A01BAEDFE_286_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BDC5010)
#define CLASS_1_5B567C8A01BAEDFE_286_CLONE_OFFSET UNITYSDK_OFFSET(0x1BDC4CB0)
#define CLASS_1_5B567C8A01BAEDFE_286_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BDC4E10)
#define CLASS_1_5B567C8A01BAEDFE_286_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BDC4D20)
#define CLASS_1_5B567C8A01BAEDFE_286_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BDC4F70)
#define CLASS_1_5B567C8A01BAEDFE_286_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BDC5060)
#define CLASS_1_5B567C8A01BAEDFE_286_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BDC5030)
#define CLASS_1_5B567C8A01BAEDFE_286_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1BDC4C00)
#define CLASS_1_5B567C8A01BAEDFE_286_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BDC4C60)
#define CLASS_1_5B567C8A01BAEDFE_286_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BDC4FA0)
#define CLASS_1_5B567C8A01BAEDFE_286_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BDC5000)
#define CLASS_1_5B567C8A01BAEDFE_286__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BDC50B0)
#define CLASS_1_5B567C8A01BAEDFE_286__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BDC4C80)
#define CLASS_1_5B567C8A01BAEDFE_286__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDC4C70)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_286*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_286_TypeDefinitionIndex)->GetStaticField(0x1D7E0);
	}
