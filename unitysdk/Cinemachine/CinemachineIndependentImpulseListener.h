...
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x156E0480)
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x156E0270)
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER_RESET_OFFSET UNITYSDK_OFFSET(0x156E0250)
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER_UPDATE_OFFSET UNITYSDK_OFFSET(0x156E0290)
#define CINEMACHINE_CINEMACHINEINDEPENDENTIMPULSELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x156E07C0)
