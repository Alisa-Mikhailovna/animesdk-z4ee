...
#define CINEMACHINE_CINEMACHINECOMPOSER_CLAMPVERTICALBOUNDS_OFFSET UNITYSDK_OFFSET(0x156CB330)
#define CINEMACHINE_CINEMACHINECOMPOSER_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x156C99F0)
#define CINEMACHINE_CINEMACHINECOMPOSER_GETLOOKATPOINTANDSETTRACKEDPOINT_OFFSET UNITYSDK_OFFSET(0x156C9060)
#define CINEMACHINE_CINEMACHINECOMPOSER_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x156C9A10)
#define CINEMACHINE_CINEMACHINECOMPOSER_GET_HARDGUIDERECT_OFFSET UNITYSDK_OFFSET(0x156CA810)
#define CINEMACHINE_CINEMACHINECOMPOSER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x156C8EC0)
#define CINEMACHINE_CINEMACHINECOMPOSER_GET_SOFTGUIDERECT_OFFSET UNITYSDK_OFFSET(0x156CA7E0)
#define CINEMACHINE_CINEMACHINECOMPOSER_GET_STAGE_OFFSET UNITYSDK_OFFSET(0x156C9010)
#define CINEMACHINE_CINEMACHINECOMPOSER_GET_TRACKEDPOINT_OFFSET UNITYSDK_OFFSET(0x156C9020)
#define CINEMACHINE_CINEMACHINECOMPOSER_MUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x156C9C30)
#define CINEMACHINE_CINEMACHINECOMPOSER_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x156C9460)
#define CINEMACHINE_CINEMACHINECOMPOSER_ONWORLDWARPED_OFFSET UNITYSDK_OFFSET(0x156C95E0)
#define CINEMACHINE_CINEMACHINECOMPOSER_PREPIPELINEMUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x156C9A20)
#define CINEMACHINE_CINEMACHINECOMPOSER_ROTATETOSCREENBOUNDS_OFFSET UNITYSDK_OFFSET(0x156CAB70)
#define CINEMACHINE_CINEMACHINECOMPOSER_SET_HARDGUIDERECT_OFFSET UNITYSDK_OFFSET(0x156CB200)
#define CINEMACHINE_CINEMACHINECOMPOSER_SET_SOFTGUIDERECT_OFFSET UNITYSDK_OFFSET(0x156CB130)
#define CINEMACHINE_CINEMACHINECOMPOSER_SET_TRACKEDPOINT_OFFSET UNITYSDK_OFFSET(0x156C9040)
#define CINEMACHINE_CINEMACHINECOMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x156CB660)
