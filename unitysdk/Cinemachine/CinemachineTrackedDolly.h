...
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GETCAMERAORIENTATIONATPATHPOINT_OFFSET UNITYSDK_OFFSET(0x156F3E30)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x156F29E0)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GET_ANGULARDAMPING_OFFSET UNITYSDK_OFFSET(0x156F2A60)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x156F2990)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GET_STAGE_OFFSET UNITYSDK_OFFSET(0x156F29D0)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_MUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x156F2AD0)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x156F4430)
