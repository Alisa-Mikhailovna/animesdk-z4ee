...
#define CINEMACHINE_EDITORVIEWPORTCOMPOSITION_METHOD_2_46D5C4F0EA172C6A_OFFSET UNITYSDK_OFFSET(0x150C80)
#define CINEMACHINE_EDITORVIEWPORTCOMPOSITION_METHOD_2_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0x150C30)
#define CINEMACHINE_EDITORVIEWPORTCOMPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x150C10)
