...
#define CINEMACHINE_CINEMACHINECOLLIDER_CAMERAWASDISPLACED_OFFSET UNITYSDK_OFFSET(0x156C2180)
#define CINEMACHINE_CINEMACHINECOLLIDER_CHECKFORTARGETOBSTRUCTIONS_OFFSET UNITYSDK_OFFSET(0x156C4D20)
#define CINEMACHINE_CINEMACHINECOLLIDER_CLAMPRAYTOBOUNDS_OFFSET UNITYSDK_OFFSET(0x156C68A0)
#define CINEMACHINE_CINEMACHINECOLLIDER_DESTROYCOLLIDER_OFFSET UNITYSDK_OFFSET(0x156C2310)
#define CINEMACHINE_CINEMACHINECOLLIDER_GETCAMERADISPLACEMENTDISTANCE_OFFSET UNITYSDK_OFFSET(0x156C21E0)
#define CINEMACHINE_CINEMACHINECOLLIDER_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x156C2680)
#define CINEMACHINE_CINEMACHINECOLLIDER_GETPUSHBACKDISTANCE_OFFSET UNITYSDK_OFFSET(0x156C6540)
#define CINEMACHINE_CINEMACHINECOLLIDER_GETWALKINGDIRECTION_OFFSET UNITYSDK_OFFSET(0x156C5BA0)
#define CINEMACHINE_CINEMACHINECOLLIDER_GET_DEBUGPATHS_OFFSET UNITYSDK_OFFSET(0x156C24C0)
#define CINEMACHINE_CINEMACHINECOLLIDER_ISTARGETOBSCURED_OFFSET UNITYSDK_OFFSET(0x156C2130)
#define CINEMACHINE_CINEMACHINECOLLIDER_ISTARGETOFFSCREEN_OFFSET UNITYSDK_OFFSET(0x156C4600)
#define CINEMACHINE_CINEMACHINECOLLIDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x156C2280)
#define CINEMACHINE_CINEMACHINECOLLIDER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x156C2240)
#define CINEMACHINE_CINEMACHINECOLLIDER_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x156C26A0)
#define CINEMACHINE_CINEMACHINECOLLIDER_PRESERVELIGNOFSIGHT_OFFSET UNITYSDK_OFFSET(0x156C32B0)
#define CINEMACHINE_CINEMACHINECOLLIDER_PULLCAMERAINFRONTOFNEARESTOBSTACLE_OFFSET UNITYSDK_OFFSET(0x156C4F60)
#define CINEMACHINE_CINEMACHINECOLLIDER_PUSHCAMERABACK_OFFSET UNITYSDK_OFFSET(0x156C5250)
#define CINEMACHINE_CINEMACHINECOLLIDER_RESPECTCAMERARADIUS_OFFSET UNITYSDK_OFFSET(0x156C3910)
#define CINEMACHINE_CINEMACHINECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x156C71C0)
...
namespace Cinemachine
{
	...
	public:
		...
		{
			return (::UnityEngine::SphereCollider**)Il2CppClass::FromTypeDefinitionIndex(CinemachineCollider_TypeDefinitionIndex)->GetStaticField(0x2350);
		}
		static ::UnityEngine::GameObject** StaticGet_mCameraColliderGameObject()
		{
			return (::UnityEngine::GameObject**)Il2CppClass::FromTypeDefinitionIndex(CinemachineCollider_TypeDefinitionIndex)->GetStaticField(0x2358);
		}
