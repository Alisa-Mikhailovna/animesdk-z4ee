...
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_CHANGESTOPTIME_OFFSET UNITYSDK_OFFSET(0x2D14E60)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_CLEAR_OFFSET UNITYSDK_OFFSET(0x2D14EA0)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_DEFAULT_OFFSET UNITYSDK_OFFSET(0x156DE5F0)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_GETVALUEAT_OFFSET UNITYSDK_OFFSET(0x2D14E50)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x2D14E30)
#define CINEMACHINE_CINEMACHINEIMPULSEMANAGER_ENVELOPEDEFINITION_VALIDATE_OFFSET UNITYSDK_OFFSET(0x2D14EB0)
