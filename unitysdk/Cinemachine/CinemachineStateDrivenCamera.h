...
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_CHOOSECURRENTCAMERA_OFFSET UNITYSDK_OFFSET(0x156EE010)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_CREATEFAKEHASH_OFFSET UNITYSDK_OFFSET(0x156EED00)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x156ED590)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GETCLIPHASH_OFFSET UNITYSDK_OFFSET(0x156EF430)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_CHILDCAMERAS_OFFSET UNITYSDK_OFFSET(0x156EECD0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x156ECF60)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x156ED150)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_ISBLENDING_OFFSET UNITYSDK_OFFSET(0x156EECF0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x156ED0D0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x156ED130)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x156ED100)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x156EDFF0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x156ED8C0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_INVALIDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x156EE9C0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ISLIVECHILD_OFFSET UNITYSDK_OFFSET(0x156ED0E0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_LOOKUPBLEND_OFFSET UNITYSDK_OFFSET(0x156EE530)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_LOOKUPFAKEHASH_OFFSET UNITYSDK_OFFSET(0x156EED70)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x156EE9E0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x156EE880)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONGUIHANDLER_OFFSET UNITYSDK_OFFSET(0x156EEB10)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x156ED170)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x156EEAF0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x156ED720)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_SET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x156ED160)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_SET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x156ED0C0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_SET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x156ED140)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_SET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x156EE000)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_UPDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x156ED2C0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_VALIDATEINSTRUCTIONS_OFFSET UNITYSDK_OFFSET(0x156EF0E0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x156EF520)
