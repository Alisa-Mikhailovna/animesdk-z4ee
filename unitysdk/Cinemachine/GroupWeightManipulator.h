...
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x156FB1D0)
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR_START_OFFSET UNITYSDK_OFFSET(0x156FB140)
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR_UPDATEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x156FB2A0)
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x156FB1F0)
#define CINEMACHINE_GROUPWEIGHTMANIPULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x156FB350)
