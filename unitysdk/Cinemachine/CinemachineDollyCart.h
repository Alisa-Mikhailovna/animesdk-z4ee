...
#define CINEMACHINE_CINEMACHINEDOLLYCART_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x156CEE00)
#define CINEMACHINE_CINEMACHINEDOLLYCART_INITPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x156CF380)
#define CINEMACHINE_CINEMACHINEDOLLYCART_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x156CF140)
#define CINEMACHINE_CINEMACHINEDOLLYCART_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x156CF1B0)
#define CINEMACHINE_CINEMACHINEDOLLYCART_SETCARTPOSITION_OFFSET UNITYSDK_OFFSET(0x156CEE60)
#define CINEMACHINE_CINEMACHINEDOLLYCART_UPDATE_OFFSET UNITYSDK_OFFSET(0x156CF0D0)
#define CINEMACHINE_CINEMACHINEDOLLYCART__CTOR_OFFSET UNITYSDK_OFFSET(0x156CF390)
