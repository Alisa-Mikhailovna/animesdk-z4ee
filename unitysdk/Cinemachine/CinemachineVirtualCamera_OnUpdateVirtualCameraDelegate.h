...
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_ONUPDATEVIRTUALCAMERADELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x156F9000)
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_ONUPDATEVIRTUALCAMERADELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x156F9030)
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_ONUPDATEVIRTUALCAMERADELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x156CE5A0)
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_ONUPDATEVIRTUALCAMERADELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x156F8F90)
