...
#define CINEMACHINE_TIMELINE_CINEMACHINEMIXER_MASTERDIRECTORDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x156FE930)
#define CINEMACHINE_TIMELINE_CINEMACHINEMIXER_MASTERDIRECTORDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x156FE960)
#define CINEMACHINE_TIMELINE_CINEMACHINEMIXER_MASTERDIRECTORDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x156FE920)
#define CINEMACHINE_TIMELINE_CINEMACHINEMIXER_MASTERDIRECTORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x156FE8B0)
