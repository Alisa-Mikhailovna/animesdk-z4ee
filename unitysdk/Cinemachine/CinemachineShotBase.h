...
#define CINEMACHINE_CINEMACHINESHOTBASE_GET_CALCULATEINRUNTIME_OFFSET UNITYSDK_OFFSET(0xD345730)
#define CINEMACHINE_CINEMACHINESHOTBASE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xD345750)
#define CINEMACHINE_CINEMACHINESHOTBASE_GET_STAGE_OFFSET UNITYSDK_OFFSET(0xD345840)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_07AF65C462E0D8FA_OFFSET UNITYSDK_OFFSET(0xD344D30)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_1F7078DEAED43133_OFFSET UNITYSDK_OFFSET(0xD345C40)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD345C00)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_A1D8CD775DEC3C21_1_OFFSET UNITYSDK_OFFSET(0xD344CE0)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xD344DA0)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_C4D99CFCA628428A_OFFSET UNITYSDK_OFFSET(0xD345B70)
#define CINEMACHINE_CINEMACHINESHOTBASE_METHOD_6_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xD344C70)
#define CINEMACHINE_CINEMACHINESHOTBASE_MUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xD345920)
#define CINEMACHINE_CINEMACHINESHOTBASE_PREPIPELINEMUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xD345850)
#define CINEMACHINE_CINEMACHINESHOTBASE_SET_CALCULATEINRUNTIME_OFFSET UNITYSDK_OFFSET(0xD345740)
#define CINEMACHINE_CINEMACHINESHOTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD345720)
