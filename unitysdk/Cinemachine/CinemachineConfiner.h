...
#define CINEMACHINE_CINEMACHINECONFINER_CAMERAWASDISPLACED_OFFSET UNITYSDK_OFFSET(0x156CBE20)
#define CINEMACHINE_CINEMACHINECONFINER_CONFINEPOINT_OFFSET UNITYSDK_OFFSET(0x156CCAB0)
#define CINEMACHINE_CINEMACHINECONFINER_CONFINESCREENEDGES_OFFSET UNITYSDK_OFFSET(0x156CC4E0)
#define CINEMACHINE_CINEMACHINECONFINER_CONNECTTOVCAM_OFFSET UNITYSDK_OFFSET(0x156CBEF0)
#define CINEMACHINE_CINEMACHINECONFINER_GETCAMERADISPLACEMENTDISTANCE_OFFSET UNITYSDK_OFFSET(0x156CBE80)
#define CINEMACHINE_CINEMACHINECONFINER_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x156CC1A0)
#define CINEMACHINE_CINEMACHINECONFINER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x156CC170)
#define CINEMACHINE_CINEMACHINECONFINER_INVALIDATEPATHCACHE_OFFSET UNITYSDK_OFFSET(0x156CCF80)
#define CINEMACHINE_CINEMACHINECONFINER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x156CBEE0)
#define CINEMACHINE_CINEMACHINECONFINER_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x156CC1B0)
#define CINEMACHINE_CINEMACHINECONFINER_VALIDATEPATHCACHE_OFFSET UNITYSDK_OFFSET(0x156CCFA0)
#define CINEMACHINE_CINEMACHINECONFINER__CTOR_OFFSET UNITYSDK_OFFSET(0x156CD690)
