...
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x156DD720)
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x156DD5C0)
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET_GET_STAGE_OFFSET UNITYSDK_OFFSET(0x156DD710)
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET_MUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x156DD730)
#define CINEMACHINE_CINEMACHINEHARDLOCKTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x156DD9A0)
