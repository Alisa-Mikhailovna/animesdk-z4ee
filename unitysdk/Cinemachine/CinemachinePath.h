...
#define CINEMACHINE_CINEMACHINEPATH_EVALUATEORIENTATION_OFFSET UNITYSDK_OFFSET(0x156E9C00)
#define CINEMACHINE_CINEMACHINEPATH_EVALUATEPOSITION_OFFSET UNITYSDK_OFFSET(0x156E95A0)
#define CINEMACHINE_CINEMACHINEPATH_EVALUATETANGENT_OFFSET UNITYSDK_OFFSET(0x156E9850)
#define CINEMACHINE_CINEMACHINEPATH_GETBOUNDINGINDICES_OFFSET UNITYSDK_OFFSET(0x156E9100)
#define CINEMACHINE_CINEMACHINEPATH_GET_DISTANCECACHESAMPLESTEPSPERSEGMENT_OFFSET UNITYSDK_OFFSET(0x156E90F0)
#define CINEMACHINE_CINEMACHINEPATH_GET_LOOPED_OFFSET UNITYSDK_OFFSET(0x156E8FD0)
#define CINEMACHINE_CINEMACHINEPATH_GET_MAXPOS_OFFSET UNITYSDK_OFFSET(0x156E8F90)
#define CINEMACHINE_CINEMACHINEPATH_GET_MINPOS_OFFSET UNITYSDK_OFFSET(0x156E8F80)
#define CINEMACHINE_CINEMACHINEPATH_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x156EA070)
#define CINEMACHINE_CINEMACHINEPATH_RESET_OFFSET UNITYSDK_OFFSET(0x156E8FE0)
#define CINEMACHINE_CINEMACHINEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x156EA080)
