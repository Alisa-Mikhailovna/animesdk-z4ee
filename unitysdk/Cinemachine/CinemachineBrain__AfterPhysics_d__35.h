...
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__35_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x156BF600)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__35_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x156BF6D0)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__35_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x156BF730)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__35_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x156BF6E0)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__35_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x156BF5F0)
#define CINEMACHINE_CINEMACHINEBRAIN__AFTERPHYSICS_D__35__CTOR_OFFSET UNITYSDK_OFFSET(0x156BC9E0)
