...
#define CLASS_1_5B567C8A01BAEDFE_185_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C1C2650)
#define CLASS_1_5B567C8A01BAEDFE_185_CLONE_OFFSET UNITYSDK_OFFSET(0x1C1C2340)
#define CLASS_1_5B567C8A01BAEDFE_185_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C1C2450)
#define CLASS_1_5B567C8A01BAEDFE_185_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C1C2380)
#define CLASS_1_5B567C8A01BAEDFE_185_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C1C25B0)
#define CLASS_1_5B567C8A01BAEDFE_185_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C1C26A0)
#define CLASS_1_5B567C8A01BAEDFE_185_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C1C2670)
#define CLASS_1_5B567C8A01BAEDFE_185_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C1C22C0)
#define CLASS_1_5B567C8A01BAEDFE_185_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C1C22F0)
#define CLASS_1_5B567C8A01BAEDFE_185_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C1C25E0)
#define CLASS_1_5B567C8A01BAEDFE_185_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C1C2640)
#define CLASS_1_5B567C8A01BAEDFE_185__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1C26F0)
#define CLASS_1_5B567C8A01BAEDFE_185__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C1C2310)
#define CLASS_1_5B567C8A01BAEDFE_185__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1C2300)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_185*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_185_TypeDefinitionIndex)->GetStaticField(0x24CC0);
	}
