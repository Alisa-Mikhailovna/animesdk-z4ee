...
#define CLASS_1_5B567C8A01BAEDFE_257_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C20B1F0)
#define CLASS_1_5B567C8A01BAEDFE_257_CLONE_OFFSET UNITYSDK_OFFSET(0x1C20AEE0)
#define CLASS_1_5B567C8A01BAEDFE_257_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C20AFF0)
#define CLASS_1_5B567C8A01BAEDFE_257_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C20AF20)
#define CLASS_1_5B567C8A01BAEDFE_257_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C20B150)
#define CLASS_1_5B567C8A01BAEDFE_257_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C20B240)
#define CLASS_1_5B567C8A01BAEDFE_257_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C20B210)
#define CLASS_1_5B567C8A01BAEDFE_257_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C20AE60)
#define CLASS_1_5B567C8A01BAEDFE_257_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C20AE90)
#define CLASS_1_5B567C8A01BAEDFE_257_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C20B180)
#define CLASS_1_5B567C8A01BAEDFE_257_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C20B1E0)
#define CLASS_1_5B567C8A01BAEDFE_257__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C20B290)
#define CLASS_1_5B567C8A01BAEDFE_257__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C20AEB0)
#define CLASS_1_5B567C8A01BAEDFE_257__CTOR_OFFSET UNITYSDK_OFFSET(0x1C20AEA0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_257*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_257_TypeDefinitionIndex)->GetStaticField(0x28870);
	}
