...
#define CLASS_1_2B4C9D5EFCB958DD_GET_USING_OFFSET UNITYSDK_OFFSET(0x145743B0)
#define CLASS_1_2B4C9D5EFCB958DD_METHOD_1_08FA67828C2BF0E2_OFFSET UNITYSDK_OFFSET(0x14573D80)
#define CLASS_1_2B4C9D5EFCB958DD_METHOD_1_1169E58CBC52AB21_OFFSET UNITYSDK_OFFSET(0x14573840)
#define CLASS_1_2B4C9D5EFCB958DD_METHOD_1_7EC6FAD1BBD9A469_OFFSET UNITYSDK_OFFSET(0x145732A0)
#define CLASS_1_2B4C9D5EFCB958DD_METHOD_1_85134B7B20E1588A_OFFSET UNITYSDK_OFFSET(0x14573200)
#define CLASS_1_2B4C9D5EFCB958DD_METHOD_1_92DDFB61A2DC6128_OFFSET UNITYSDK_OFFSET(0x145738E0)
#define CLASS_1_2B4C9D5EFCB958DD_METHOD_1_A2F3FEB30B425887_OFFSET UNITYSDK_OFFSET(0x14573250)
#define CLASS_1_2B4C9D5EFCB958DD_METHOD_1_CD4A6532B8C779AA_OFFSET UNITYSDK_OFFSET(0x145743F0)
#define CLASS_1_2B4C9D5EFCB958DD_SET_USING_OFFSET UNITYSDK_OFFSET(0x145743C0)
#define CLASS_1_2B4C9D5EFCB958DD__CTOR_OFFSET UNITYSDK_OFFSET(0x145744E0)

inline static constexpr unsigned int Class_1_2B4C9D5EFCB958DD_TypeDefinitionIndex = 69704;

class Class_1_2B4C9D5EFCB958DD : public ::System::Object
{
public:
	::Class_1_D611BC3F2C0A31B5* Field_1_0; // 0x10
