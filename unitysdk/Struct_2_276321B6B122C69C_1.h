...
#define STRUCT_2_276321B6B122C69C_1_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x7DC40)
#define STRUCT_2_276321B6B122C69C_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x153CE0)
#define STRUCT_2_276321B6B122C69C_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x153CB0)
#define STRUCT_2_276321B6B122C69C_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x153CA0)
#define STRUCT_2_276321B6B122C69C_1_GET_ID_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define STRUCT_2_276321B6B122C69C_1_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1E130)
#define STRUCT_2_276321B6B122C69C_1_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xD876BD0)
#define STRUCT_2_276321B6B122C69C_1_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xD876BB0)
#define STRUCT_2_276321B6B122C69C_1_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x153C80)
#define STRUCT_2_276321B6B122C69C_1_SET_ID_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define STRUCT_2_276321B6B122C69C_1_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x21F0)
#define STRUCT_2_276321B6B122C69C_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x153C70)
#define STRUCT_2_276321B6B122C69C_1__CTOR_OFFSET UNITYSDK_OFFSET(0x7BDC0)
