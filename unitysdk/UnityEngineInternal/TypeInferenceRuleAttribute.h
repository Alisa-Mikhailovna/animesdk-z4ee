...
#define UNITYENGINEINTERNAL_TYPEINFERENCERULEATTRIBUTE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D06FEC0)
#define UNITYENGINEINTERNAL_TYPEINFERENCERULEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D06FEB0)
#define UNITYENGINEINTERNAL_TYPEINFERENCERULEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06FDE0)
