...
#define UNITYENGINEINTERNAL_INPUT_NATIVEUPDATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D09F060)
#define UNITYENGINEINTERNAL_INPUT_NATIVEUPDATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D09F0E0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEUPDATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D09EF10)
#define UNITYENGINEINTERNAL_INPUT_NATIVEUPDATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09EFF0)
