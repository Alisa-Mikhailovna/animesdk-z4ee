...
#define CLASS_2_71A2496EADCD8A1E_INIT_OFFSET UNITYSDK_OFFSET(0x150611C0)
#define CLASS_2_71A2496EADCD8A1E__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x15061250)
#define CLASS_2_71A2496EADCD8A1E__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x15061210)
#define CLASS_2_71A2496EADCD8A1E__CTOR_OFFSET UNITYSDK_OFFSET(0x15061290)
