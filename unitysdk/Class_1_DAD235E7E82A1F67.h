...
#define CLASS_1_DAD235E7E82A1F67_GET_CURRENTHEALTH_OFFSET UNITYSDK_OFFSET(0xD5B6070)
#define CLASS_1_DAD235E7E82A1F67_GET_CURRENTSHIELD_OFFSET UNITYSDK_OFFSET(0xD5B60D0)
#define CLASS_1_DAD235E7E82A1F67_GET_ENABLEPREVIEW_OFFSET UNITYSDK_OFFSET(0xD5B6130)
#define CLASS_1_DAD235E7E82A1F67_GET_MAXHEALTH_OFFSET UNITYSDK_OFFSET(0xD5B60B0)
#define CLASS_1_DAD235E7E82A1F67_GET_PREVIEWEVERMAXSHIELD_OFFSET UNITYSDK_OFFSET(0xD5B6110)
#define CLASS_1_DAD235E7E82A1F67_GET_PREVIEWHEALTH_OFFSET UNITYSDK_OFFSET(0xD5B6090)
#define CLASS_1_DAD235E7E82A1F67_GET_PREVIEWSHIELD_OFFSET UNITYSDK_OFFSET(0xD5B60F0)
#define CLASS_1_DAD235E7E82A1F67_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD5B6150)
#define CLASS_1_DAD235E7E82A1F67_SET_CURRENTHEALTH_OFFSET UNITYSDK_OFFSET(0xD5B6080)
#define CLASS_1_DAD235E7E82A1F67_SET_CURRENTSHIELD_OFFSET UNITYSDK_OFFSET(0xD5B60E0)
#define CLASS_1_DAD235E7E82A1F67_SET_ENABLEPREVIEW_OFFSET UNITYSDK_OFFSET(0xD5B6140)
#define CLASS_1_DAD235E7E82A1F67_SET_MAXHEALTH_OFFSET UNITYSDK_OFFSET(0xD5B60C0)
#define CLASS_1_DAD235E7E82A1F67_SET_PREVIEWEVERMAXSHIELD_OFFSET UNITYSDK_OFFSET(0xD5B6120)
#define CLASS_1_DAD235E7E82A1F67_SET_PREVIEWHEALTH_OFFSET UNITYSDK_OFFSET(0xD5B60A0)
#define CLASS_1_DAD235E7E82A1F67_SET_PREVIEWSHIELD_OFFSET UNITYSDK_OFFSET(0xD5B6100)
#define CLASS_1_DAD235E7E82A1F67__CTOR_OFFSET UNITYSDK_OFFSET(0xD5B61B0)

inline static constexpr unsigned int Class_1_DAD235E7E82A1F67_TypeDefinitionIndex = 75866;

class Class_1_DAD235E7E82A1F67 : public ::System::Object
{
public:
	::RPG::GameCore::FixPoint _PreviewShield_k__BackingField; // 0x10
	::RPG::GameCore::FixPoint _CurrentHealth_k__BackingField; // 0x18
	::System::Boolean _EnablePreview_k__BackingField; // 0x20
	::RPG::GameCore::FixPoint _PreviewHealth_k__BackingField; // 0x28
	::RPG::GameCore::FixPoint _CurrentShield_k__BackingField; // 0x30
	::RPG::GameCore::FixPoint _PreviewEverMaxShield_k__BackingField; // 0x38
	::RPG::GameCore::FixPoint _MaxHealth_k__BackingField; // 0x40
