...
#define CLASS_1_A4905737247C8515_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0xCAD12C0)
#define CLASS_1_A4905737247C8515_INIT_OFFSET UNITYSDK_OFFSET(0xCAD1300)
#define CLASS_1_A4905737247C8515_METHOD_1_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0xCAD17E0)
#define CLASS_1_A4905737247C8515_REFRESH_OFFSET UNITYSDK_OFFSET(0xCAD13A0)
#define CLASS_1_A4905737247C8515_RESET_OFFSET UNITYSDK_OFFSET(0xCAD1730)
#define CLASS_1_A4905737247C8515__CTOR_OFFSET UNITYSDK_OFFSET(0xCAD1B40)
...
{
public:
	::RPG::Client::CameraFightStateLightTeamDollyConfig* Field_1_0; // 0x10
