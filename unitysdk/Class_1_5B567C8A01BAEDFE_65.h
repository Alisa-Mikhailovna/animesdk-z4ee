...
#define CLASS_1_5B567C8A01BAEDFE_65_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C4A4200)
#define CLASS_1_5B567C8A01BAEDFE_65_CLONE_OFFSET UNITYSDK_OFFSET(0x1C4A3EF0)
#define CLASS_1_5B567C8A01BAEDFE_65_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C4A4000)
#define CLASS_1_5B567C8A01BAEDFE_65_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C4A3F30)
#define CLASS_1_5B567C8A01BAEDFE_65_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C4A4160)
#define CLASS_1_5B567C8A01BAEDFE_65_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C4A4250)
#define CLASS_1_5B567C8A01BAEDFE_65_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C4A4220)
#define CLASS_1_5B567C8A01BAEDFE_65_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C4A3E70)
#define CLASS_1_5B567C8A01BAEDFE_65_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C4A3EA0)
#define CLASS_1_5B567C8A01BAEDFE_65_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C4A4190)
#define CLASS_1_5B567C8A01BAEDFE_65_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C4A41F0)
#define CLASS_1_5B567C8A01BAEDFE_65__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4A42A0)
#define CLASS_1_5B567C8A01BAEDFE_65__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4A3EC0)
#define CLASS_1_5B567C8A01BAEDFE_65__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A3EB0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_65*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_65_TypeDefinitionIndex)->GetStaticField(0x58640);
	}
