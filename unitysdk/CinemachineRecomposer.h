...
#define CINEMACHINERECOMPOSER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x15705920)
#define CINEMACHINERECOMPOSER_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x157059A0)
#define CINEMACHINERECOMPOSER_PREPIPELINEMUTATECAMERASTATECALLBACK_OFFSET UNITYSDK_OFFSET(0x15705980)
#define CINEMACHINERECOMPOSER_RESET_OFFSET UNITYSDK_OFFSET(0x15705900)
#define CINEMACHINERECOMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x15705DE0)
