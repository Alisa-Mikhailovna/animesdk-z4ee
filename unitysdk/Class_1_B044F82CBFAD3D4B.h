...
#define CLASS_1_B044F82CBFAD3D4B_EXECUTE_OFFSET UNITYSDK_OFFSET(0xACE9140)
#define CLASS_1_B044F82CBFAD3D4B_GET_KEY_OFFSET UNITYSDK_OFFSET(0xACE9130)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0xACEB650)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_06F38768260E973C_OFFSET UNITYSDK_OFFSET(0xACEAA50)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_09B8F368BEF6ADA5_OFFSET UNITYSDK_OFFSET(0xACEE7F0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_0C10C7E7E3750739_OFFSET UNITYSDK_OFFSET(0xACEA8B0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xACEE890)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_265045B8E51327D0_OFFSET UNITYSDK_OFFSET(0xACEBAD0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_2A38E69140BEF946_OFFSET UNITYSDK_OFFSET(0xACEC910)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xACEB7E0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_361C06486F56B4E7_OFFSET UNITYSDK_OFFSET(0xACEA3F0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_5BCEC94898149483_OFFSET UNITYSDK_OFFSET(0xACEC1F0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_6E3DEABB1FC191BB_OFFSET UNITYSDK_OFFSET(0xACE9390)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0xACEB500)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_742F70E950BBF2A7_OFFSET UNITYSDK_OFFSET(0xACED830)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_78FBED8F1829A87D_OFFSET UNITYSDK_OFFSET(0xACED7D0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xACED9D0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0xACEE450)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_87716C1283ABF5F3_OFFSET UNITYSDK_OFFSET(0xACEC820)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_8D6313602D4CE699_OFFSET UNITYSDK_OFFSET(0xACED8E0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_8DB9EDEA3C4643DA_OFFSET UNITYSDK_OFFSET(0xACEC4B0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_923326AAAB7FEE1E_OFFSET UNITYSDK_OFFSET(0xACEDE70)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0xACEE7A0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_95D919A3FFE39CED_OFFSET UNITYSDK_OFFSET(0xACEDA70)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_AE7ACA9431B8342C_OFFSET UNITYSDK_OFFSET(0xACED950)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xACEB760)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_B50BC205C61B0618_OFFSET UNITYSDK_OFFSET(0xACEB270)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_C2B11FE0C60F37C6_OFFSET UNITYSDK_OFFSET(0xACEC620)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_C84AC1D506AE73C8_OFFSET UNITYSDK_OFFSET(0xACEBC30)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_CEAC9CDAE2EF9114_OFFSET UNITYSDK_OFFSET(0xACEDA20)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_D1305BC17A89C222_OFFSET UNITYSDK_OFFSET(0xACEB8E0)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_D708C9654B5799EF_OFFSET UNITYSDK_OFFSET(0xACE9410)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_DFCFDE5A7E6EE4D0_OFFSET UNITYSDK_OFFSET(0xACECE00)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_EDEF3EA029D39A77_OFFSET UNITYSDK_OFFSET(0xACE9700)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_F4ABEA5567E8E9C8_OFFSET UNITYSDK_OFFSET(0xACEC350)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_F53FD57ABED33219_OFFSET UNITYSDK_OFFSET(0xACEA980)
#define CLASS_1_B044F82CBFAD3D4B_METHOD_1_F73FD4F85B56D39C_OFFSET UNITYSDK_OFFSET(0xACECB20)
#define CLASS_1_B044F82CBFAD3D4B__CCTOR_OFFSET UNITYSDK_OFFSET(0xACEE8F0)
#define CLASS_1_B044F82CBFAD3D4B__CTOR_OFFSET UNITYSDK_OFFSET(0xACEA2F0)

inline static constexpr unsigned int Class_1_B044F82CBFAD3D4B_TypeDefinitionIndex = 70305;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B044F82CBFAD3D4B_TypeDefinitionIndex)->GetStaticField(0x6E30);
	}
	static ::System::Single* StaticGet_Field_1_1()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B044F82CBFAD3D4B_TypeDefinitionIndex)->GetStaticField(0x6E34);
	}
	...
	::Il2CppArray<::UnityEngine::Vector4>* Field_1_5; // 0x28
	::Il2CppArray<::System::UInt32>* Field_1_6; // 0x30
	::UnityEngine::ComputeBuffer* Field_1_7; // 0x38
	::UnityEngine::RenderTexture* Field_1_8; // 0x40
	::UnityEngine::ComputeBuffer* Field_1_9; // 0x48
	::UnityEngine::RenderTexture* Field_1_10; // 0x50
	::Il2CppArray<::System::UInt32>* Field_1_11; // 0x58
	...
	::Il2CppArray<::Class_1_929E979D9ED7139E*>* Field_1_15; // 0x78
	::UnityEngine::ComputeBuffer* Field_1_16; // 0x80
	::UnityEngine::ComputeBuffer* Field_1_17; // 0x88
	::System::Collections::Generic::List_1<::Class_1_37B963E08761B892*>* Field_1_18; // 0x90
	::System::Collections::Generic::Dictionary_2<::RPG::Client::LiteInstancedItem::ItemPrototype*, ::Class_1_37B963E08761B892*>* Field_1_19; // 0x98
	::UnityEngine::ComputeShader* Field_1_20; // 0xA0
	::System::Boolean Field_1_21; // 0xA8
	::System::Boolean Field_1_22; // 0xA9
	::System::Boolean Field_1_23; // 0xAA
	::UnityEngine::Matrix4x4 Field_1_24; // 0xAC
	::Unity::Collections::NativeArray_1<::UnityEngine::Vector4> Field_1_25; // 0xF0
	::System::Int32 Field_1_26; // 0x100
	::System::Int32 Field_1_27; // 0x104
	::UnityEngine::Vector3 Field_1_28; // 0x108
	::System::Boolean Field_1_29; // 0x114
	::System::Boolean Field_1_30; // 0x115
	::System::Boolean Field_1_31; // 0x116
	::System::Boolean Field_1_32; // 0x117
	::System::Boolean Field_1_33; // 0x118
	::System::Boolean Field_1_34; // 0x119
	::System::Int32 Field_1_35; // 0x11C
	::System::Int32 Field_1_36; // 0x120
	::System::Int32 Field_1_37; // 0x124
	::UnityEngine::Quaternion Field_1_38; // 0x128
	::System::Int32 Field_1_39; // 0x138
	::System::Int32 Field_1_40; // 0x13C
	::Unity::Collections::NativeArray_1<::UnityEngine::Matrix4x4> Field_1_41; // 0x140
	::Unity::Collections::NativeArray_1<::System::UInt32> Field_1_42; // 0x150
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_B044F82CBFAD3D4B_METHOD_1_06F38768260E973C_OFFSET))(this);
	}
