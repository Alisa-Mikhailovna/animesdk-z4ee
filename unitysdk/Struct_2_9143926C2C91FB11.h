...
#define STRUCT_2_9143926C2C91FB11_EQUALS_OFFSET UNITYSDK_OFFSET(0x14DD80)
#define STRUCT_2_9143926C2C91FB11_GET_BADGETYPE_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define STRUCT_2_9143926C2C91FB11_GET_CHALLENGETYPE_OFFSET UNITYSDK_OFFSET(0x5EF0)
#define STRUCT_2_9143926C2C91FB11_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1E130)
#define STRUCT_2_9143926C2C91FB11_SET_BADGETYPE_OFFSET UNITYSDK_OFFSET(0xDAE0)
#define STRUCT_2_9143926C2C91FB11_SET_CHALLENGETYPE_OFFSET UNITYSDK_OFFSET(0x2CAC0)
#define STRUCT_2_9143926C2C91FB11_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x21F0)

inline static constexpr unsigned int Struct_2_9143926C2C91FB11_TypeDefinitionIndex = 71370;
