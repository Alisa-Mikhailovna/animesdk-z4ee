...
#define CLASS_1_5B567C8A01BAEDFE_48_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C13D0F0)
#define CLASS_1_5B567C8A01BAEDFE_48_CLONE_OFFSET UNITYSDK_OFFSET(0x1C13CDE0)
#define CLASS_1_5B567C8A01BAEDFE_48_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C13CEF0)
#define CLASS_1_5B567C8A01BAEDFE_48_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C13CE20)
#define CLASS_1_5B567C8A01BAEDFE_48_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C13D050)
#define CLASS_1_5B567C8A01BAEDFE_48_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C13D140)
#define CLASS_1_5B567C8A01BAEDFE_48_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C13D110)
#define CLASS_1_5B567C8A01BAEDFE_48_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C13CD60)
#define CLASS_1_5B567C8A01BAEDFE_48_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C13CD90)
#define CLASS_1_5B567C8A01BAEDFE_48_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C13D080)
#define CLASS_1_5B567C8A01BAEDFE_48_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C13D0E0)
#define CLASS_1_5B567C8A01BAEDFE_48__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C13D190)
#define CLASS_1_5B567C8A01BAEDFE_48__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C13CDB0)
#define CLASS_1_5B567C8A01BAEDFE_48__CTOR_OFFSET UNITYSDK_OFFSET(0x1C13CDA0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_48*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_48_TypeDefinitionIndex)->GetStaticField(0x1C2F0);
	}
