...
#define CLASS_2_729CB240C8551284_CLEAR_OFFSET UNITYSDK_OFFSET(0xBAC7EC0)
#define CLASS_2_729CB240C8551284__CTOR_OFFSET UNITYSDK_OFFSET(0xBAC7F50)

inline static constexpr unsigned int Class_2_729CB240C8551284_TypeDefinitionIndex = 73842;

class Class_2_729CB240C8551284 : public ::Class_1_4CD8A1ACD565F336
{
public:
	::RPG::Client::ChenLingBattle::ChenLingBattleGameSession* Field_2_0; // 0x28
	::RPG::Client::ChenLingBattle::ChenLingBattleGameFlow* Field_2_1; // 0x30
