...
#define CLASS_1_7D1B6A9AEE25C2CE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB4C5E50)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_09CCD73C6DC37035_1_OFFSET UNITYSDK_OFFSET(0xB4C5D10)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_09CCD73C6DC37035_OFFSET UNITYSDK_OFFSET(0xB4C5BD0)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_27EBAAFAF5369197_OFFSET UNITYSDK_OFFSET(0xB4C5EA0)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0xB4C5590)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xB4C5280)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_5E657A2D9C0A02DF_1_OFFSET UNITYSDK_OFFSET(0xB4C5AE0)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_5E657A2D9C0A02DF_OFFSET UNITYSDK_OFFSET(0xB4C58B0)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_67B5A5B3BC37AA52_OFFSET UNITYSDK_OFFSET(0xB4C5950)
#define CLASS_1_7D1B6A9AEE25C2CE_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0xB4C5700)
#define CLASS_1_7D1B6A9AEE25C2CE__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C51C0)
...
{
public:
	::System::Collections::Generic::List_1<::Class_1_7D1B6A9AEE25C2CE_Class_1_9CBD4493D0516F42*>* Field_1_0; // 0x10
