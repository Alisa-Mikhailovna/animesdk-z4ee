...
#define CLASS_2_E63F6A32CF0C60CE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14872CC0)
#define CLASS_2_E63F6A32CF0C60CE_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14872DD0)
#define CLASS_2_E63F6A32CF0C60CE_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14873120)
#define CLASS_2_E63F6A32CF0C60CE_TICK_OFFSET UNITYSDK_OFFSET(0x14872D00)
#define CLASS_2_E63F6A32CF0C60CE__CTOR_OFFSET UNITYSDK_OFFSET(0x14872CB0)
