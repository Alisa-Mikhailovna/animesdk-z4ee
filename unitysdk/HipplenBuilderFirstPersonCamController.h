...
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_METHOD_5_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0x14BCEE20)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x14BCF1D0)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_SETCAMERALOCK_OFFSET UNITYSDK_OFFSET(0x14BCF290)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x14BCED70)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x14BCEDC0)
#define HIPPLENBUILDERFIRSTPERSONCAMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14BCF2F0)
