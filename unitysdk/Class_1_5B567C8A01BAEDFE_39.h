...
#define CLASS_1_5B567C8A01BAEDFE_39_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C5A7CB0)
#define CLASS_1_5B567C8A01BAEDFE_39_CLONE_OFFSET UNITYSDK_OFFSET(0x1C5A7950)
#define CLASS_1_5B567C8A01BAEDFE_39_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C5A7AB0)
#define CLASS_1_5B567C8A01BAEDFE_39_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C5A79C0)
#define CLASS_1_5B567C8A01BAEDFE_39_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C5A7C10)
#define CLASS_1_5B567C8A01BAEDFE_39_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C5A7D00)
#define CLASS_1_5B567C8A01BAEDFE_39_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C5A7CD0)
#define CLASS_1_5B567C8A01BAEDFE_39_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C5A78A0)
#define CLASS_1_5B567C8A01BAEDFE_39_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C5A7900)
#define CLASS_1_5B567C8A01BAEDFE_39_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C5A7C40)
#define CLASS_1_5B567C8A01BAEDFE_39_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C5A7CA0)
#define CLASS_1_5B567C8A01BAEDFE_39__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5A7D50)
#define CLASS_1_5B567C8A01BAEDFE_39__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C5A7920)
#define CLASS_1_5B567C8A01BAEDFE_39__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5A7910)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_39*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_39_TypeDefinitionIndex)->GetStaticField(0x60C00);
	}
