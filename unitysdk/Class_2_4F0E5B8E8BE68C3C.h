...
#define CLASS_2_4F0E5B8E8BE68C3C_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB1D5B10)
#define CLASS_2_4F0E5B8E8BE68C3C_METHOD_2_5C715D615BCEF8BF_OFFSET UNITYSDK_OFFSET(0xB1D5F20)
#define CLASS_2_4F0E5B8E8BE68C3C_METHOD_2_7F5A09121F2469EC_OFFSET UNITYSDK_OFFSET(0xB1D5FC0)
#define CLASS_2_4F0E5B8E8BE68C3C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB1D5C00)
#define CLASS_2_4F0E5B8E8BE68C3C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB1D5E70)
#define CLASS_2_4F0E5B8E8BE68C3C_TICK_OFFSET UNITYSDK_OFFSET(0xB1D5EC0)
#define CLASS_2_4F0E5B8E8BE68C3C__CTOR_OFFSET UNITYSDK_OFFSET(0xB1D5A30)
...
public:
	...
	::RPG::GameCore::LockBattleOperation* Field_2_1; // 0x20
