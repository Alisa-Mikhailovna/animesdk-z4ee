...
#define CLASS_1_5B567C8A01BAEDFE_69_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C5E3020)
#define CLASS_1_5B567C8A01BAEDFE_69_CLONE_OFFSET UNITYSDK_OFFSET(0x1C5E2CC0)
#define CLASS_1_5B567C8A01BAEDFE_69_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C5E2E20)
#define CLASS_1_5B567C8A01BAEDFE_69_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C5E2D30)
#define CLASS_1_5B567C8A01BAEDFE_69_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C5E2F80)
#define CLASS_1_5B567C8A01BAEDFE_69_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C5E3070)
#define CLASS_1_5B567C8A01BAEDFE_69_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C5E3040)
#define CLASS_1_5B567C8A01BAEDFE_69_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C5E2C10)
#define CLASS_1_5B567C8A01BAEDFE_69_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C5E2C70)
#define CLASS_1_5B567C8A01BAEDFE_69_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C5E2FB0)
#define CLASS_1_5B567C8A01BAEDFE_69_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C5E3010)
#define CLASS_1_5B567C8A01BAEDFE_69__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5E30C0)
#define CLASS_1_5B567C8A01BAEDFE_69__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C5E2C90)
#define CLASS_1_5B567C8A01BAEDFE_69__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5E2C80)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_69*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_69_TypeDefinitionIndex)->GetStaticField(0x61D50);
	}
