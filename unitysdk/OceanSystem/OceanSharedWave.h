...
#define OCEANSYSTEM_OCEANSHAREDWAVE_METHOD_5_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0xB6FE210)
#define OCEANSYSTEM_OCEANSHAREDWAVE_METHOD_5_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0xB6FE1C0)
#define OCEANSYSTEM_OCEANSHAREDWAVE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB6FE610)
#define OCEANSYSTEM_OCEANSHAREDWAVE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB6FE5F0)
#define OCEANSYSTEM_OCEANSHAREDWAVE_UPDATE_OFFSET UNITYSDK_OFFSET(0xB6FE600)
#define OCEANSYSTEM_OCEANSHAREDWAVE__CCTOR_OFFSET UNITYSDK_OFFSET(0xB6FE6A0)
#define OCEANSYSTEM_OCEANSHAREDWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0xB6FE670)
...
namespace OceanSystem
{
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(OceanSharedWave_TypeDefinitionIndex)->GetStaticField(0x3350);
		}
