...
#define CLASS_1_7F6A638FBAAEC90B_20_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C6B9500)
#define CLASS_1_7F6A638FBAAEC90B_20_CLONE_OFFSET UNITYSDK_OFFSET(0x1C6B8F60)
#define CLASS_1_7F6A638FBAAEC90B_20_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C6B9020)
#define CLASS_1_7F6A638FBAAEC90B_20_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C6B8FF0)
#define CLASS_1_7F6A638FBAAEC90B_20_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C6B9150)
#define CLASS_1_7F6A638FBAAEC90B_20_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C6B9700)
#define CLASS_1_7F6A638FBAAEC90B_20_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C6B9690)
#define CLASS_1_7F6A638FBAAEC90B_20_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C6B8FD0)
#define CLASS_1_7F6A638FBAAEC90B_20_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C6B8FB0)
#define CLASS_1_7F6A638FBAAEC90B_20_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x1C6B8FA0)
#define CLASS_1_7F6A638FBAAEC90B_20_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C6B8F90)
#define CLASS_1_7F6A638FBAAEC90B_20_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C6B8DA0)
#define CLASS_1_7F6A638FBAAEC90B_20_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C6B8FE0)
#define CLASS_1_7F6A638FBAAEC90B_20_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C6B8FC0)
#define CLASS_1_7F6A638FBAAEC90B_20_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C6B8DD0)
#define CLASS_1_7F6A638FBAAEC90B_20_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C6B9320)
#define CLASS_1_7F6A638FBAAEC90B_20_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C6B9380)
#define CLASS_1_7F6A638FBAAEC90B_20__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6B9830)
#define CLASS_1_7F6A638FBAAEC90B_20__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6B8E70)
#define CLASS_1_7F6A638FBAAEC90B_20__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6B8DE0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7F6A638FBAAEC90B_20_TypeDefinitionIndex)->GetStaticField(0x68B80);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_7F6A638FBAAEC90B_20*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_7F6A638FBAAEC90B_20*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7F6A638FBAAEC90B_20_TypeDefinitionIndex)->GetStaticField(0x68B88);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_7F6A638FBAAEC90B_20_TypeDefinitionIndex)->GetStaticField(0x68B90);
	}
