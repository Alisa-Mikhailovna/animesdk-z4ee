...
#define CLASS_1_06EF49E17999C143_GET_ENDBLACKCLOSEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x14C0A230)
#define CLASS_1_06EF49E17999C143_GET_ENDMASKTALKSENTENCEID_OFFSET UNITYSDK_OFFSET(0x14C0A250)
#define CLASS_1_06EF49E17999C143_METHOD_1_09D518CD19A52420_OFFSET UNITYSDK_OFFSET(0x14C0AE60)
#define CLASS_1_06EF49E17999C143_METHOD_1_0BBAD75CD82FF4C6_OFFSET UNITYSDK_OFFSET(0x14C0B4F0)
#define CLASS_1_06EF49E17999C143_METHOD_1_0F30679B05E70FC1_OFFSET UNITYSDK_OFFSET(0x14C0A340)
#define CLASS_1_06EF49E17999C143_METHOD_1_18C3B129F2E38CCF_OFFSET UNITYSDK_OFFSET(0x14C0A790)
#define CLASS_1_06EF49E17999C143_METHOD_1_18DD7E1EED9D36D1_OFFSET UNITYSDK_OFFSET(0x14C0B090)
#define CLASS_1_06EF49E17999C143_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x14C0A140)
#define CLASS_1_06EF49E17999C143_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x14C0A0F0)
#define CLASS_1_06EF49E17999C143_METHOD_1_2F57AE360A4E2412_OFFSET UNITYSDK_OFFSET(0x14C0B2C0)
#define CLASS_1_06EF49E17999C143_METHOD_1_51D2CCEAD62FAF96_OFFSET UNITYSDK_OFFSET(0x14C0AA10)
#define CLASS_1_06EF49E17999C143_METHOD_1_73B8E5A7C1BFCA1F_OFFSET UNITYSDK_OFFSET(0x14C0A0A0)
#define CLASS_1_06EF49E17999C143_METHOD_1_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0x14C0A720)
#define CLASS_1_06EF49E17999C143_METHOD_1_9B0C43B0B6D3BA9B_OFFSET UNITYSDK_OFFSET(0x14C0A560)
#define CLASS_1_06EF49E17999C143_METHOD_1_9D88A62CD6A4BE52_1_OFFSET UNITYSDK_OFFSET(0x14C0A1E0)
#define CLASS_1_06EF49E17999C143_METHOD_1_9D88A62CD6A4BE52_OFFSET UNITYSDK_OFFSET(0x14C0A190)
#define CLASS_1_06EF49E17999C143_METHOD_1_ABFE6A357B89C69A_OFFSET UNITYSDK_OFFSET(0x14C0A270)
#define CLASS_1_06EF49E17999C143_METHOD_1_D08BCB51F5D3AC26_OFFSET UNITYSDK_OFFSET(0x14C0AC30)
#define CLASS_1_06EF49E17999C143_METHOD_1_D872496C150B19B6_1_OFFSET UNITYSDK_OFFSET(0x14C0A050)
#define CLASS_1_06EF49E17999C143_METHOD_1_D872496C150B19B6_OFFSET UNITYSDK_OFFSET(0x14C0A000)
#define CLASS_1_06EF49E17999C143_METHOD_1_E4EC0FD7A76783C9_OFFSET UNITYSDK_OFFSET(0x14C0A6B0)
#define CLASS_1_06EF49E17999C143_METHOD_1_FABFA21254FBB3C1_OFFSET UNITYSDK_OFFSET(0x14C0A640)
#define CLASS_1_06EF49E17999C143_SET_ENDBLACKCLOSEDELAYTIME_OFFSET UNITYSDK_OFFSET(0x14C0A240)
#define CLASS_1_06EF49E17999C143_SET_ENDMASKTALKSENTENCEID_OFFSET UNITYSDK_OFFSET(0x14C0A260)
#define CLASS_1_06EF49E17999C143__CCTOR_OFFSET UNITYSDK_OFFSET(0x14C0B7F0)
#define CLASS_1_06EF49E17999C143__CTOR_OFFSET UNITYSDK_OFFSET(0x14C0B720)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_06EF49E17999C143_TypeDefinitionIndex)->GetStaticField(0x4D80);
	}
	static ::System::Boolean* StaticGet_Field_1_1()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_1_06EF49E17999C143_TypeDefinitionIndex)->GetStaticField(0x4D84);
	}
	...
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::CustomScreenTransferType>* Field_1_5; // 0x20
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::ScreenTransferType>* Field_1_6; // 0x28
	::RPG::GameCore::PerformanceMaskStack_1<::System::Boolean>* Field_1_7; // 0x30
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::StoryBlackType>* Field_1_8; // 0x38
	::RPG::GameCore::PerformanceMaskStack_1<::System::Boolean>* Field_1_9; // 0x40
	::RPG::GameCore::PerformanceMaskStack_1<::RPG::GameCore::CustomScreenTransferType>* Field_1_10; // 0x48
	::System::String* Field_1_11; // 0x50
	::RPG::GameCore::PerformanceSkipType Field_1_12; // 0x58
