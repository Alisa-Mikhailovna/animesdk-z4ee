...
#define CLASS_2_FB50CDBDDEDBBCC8_2_CLEAR_OFFSET UNITYSDK_OFFSET(0xB3C9D50)
#define CLASS_2_FB50CDBDDEDBBCC8_2_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB3C9DD0)
#define CLASS_2_FB50CDBDDEDBBCC8_2_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB3C9DE0)
#define CLASS_2_FB50CDBDDEDBBCC8_2__CTOR_OFFSET UNITYSDK_OFFSET(0xB3C9DF0)

inline static constexpr unsigned int Class_2_FB50CDBDDEDBBCC8_2_TypeDefinitionIndex = 73459;
