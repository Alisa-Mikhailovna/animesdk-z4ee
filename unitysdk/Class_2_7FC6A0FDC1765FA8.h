...
#define CLASS_2_7FC6A0FDC1765FA8_METHOD_2_78C62398E94F0FB1_OFFSET UNITYSDK_OFFSET(0x152EB270)
#define CLASS_2_7FC6A0FDC1765FA8_METHOD_2_D3271A54A24C6AD0_OFFSET UNITYSDK_OFFSET(0x152EB150)
#define CLASS_2_7FC6A0FDC1765FA8__CTOR_OFFSET UNITYSDK_OFFSET(0x152EB400)
#define CLASS_2_7FC6A0FDC1765FA8__ONBIND_OFFSET UNITYSDK_OFFSET(0x152EB0B0)

inline static constexpr unsigned int Class_2_7FC6A0FDC1765FA8_TypeDefinitionIndex = 69003;

class Class_2_7FC6A0FDC1765FA8 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::UnityEngine::UI::SmoothMask* Field_2_0; // 0x60
	::RPG::Client::GridFightAugmentConfig* Field_2_1; // 0x68
	::UnityEngine::Sprite* Field_2_2; // 0x70
	::Class_1_9015B34004B876E5* Field_2_3; // 0x78
