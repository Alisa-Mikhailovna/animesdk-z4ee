...
#define CLASS_1_5B567C8A01BAEDFE_27_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C5B6B80)
#define CLASS_1_5B567C8A01BAEDFE_27_CLONE_OFFSET UNITYSDK_OFFSET(0x1C5B6870)
#define CLASS_1_5B567C8A01BAEDFE_27_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C5B6980)
#define CLASS_1_5B567C8A01BAEDFE_27_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C5B68B0)
#define CLASS_1_5B567C8A01BAEDFE_27_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C5B6AE0)
#define CLASS_1_5B567C8A01BAEDFE_27_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C5B6BD0)
#define CLASS_1_5B567C8A01BAEDFE_27_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C5B6BA0)
#define CLASS_1_5B567C8A01BAEDFE_27_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C5B67F0)
#define CLASS_1_5B567C8A01BAEDFE_27_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C5B6820)
#define CLASS_1_5B567C8A01BAEDFE_27_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C5B6B10)
#define CLASS_1_5B567C8A01BAEDFE_27_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C5B6B70)
#define CLASS_1_5B567C8A01BAEDFE_27__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5B6C20)
#define CLASS_1_5B567C8A01BAEDFE_27__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C5B6840)
#define CLASS_1_5B567C8A01BAEDFE_27__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5B6830)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_27*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_27_TypeDefinitionIndex)->GetStaticField(0x613C0);
	}
