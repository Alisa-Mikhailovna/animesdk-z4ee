...
#define CLASS_2_CA025557802C22DD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBAC6D50)
#define CLASS_2_CA025557802C22DD_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBAC7D50)
#define CLASS_2_CA025557802C22DD_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBAC6DF0)
#define CLASS_2_CA025557802C22DD_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBAC7DA0)
#define CLASS_2_CA025557802C22DD_TICK_OFFSET UNITYSDK_OFFSET(0xBAC6D90)
#define CLASS_2_CA025557802C22DD__CTOR_OFFSET UNITYSDK_OFFSET(0xBAC6D40)
...
public:
	...
	::RPG::GameCore::ShowEvolveBuildTreasureInBattle* Field_2_2; // 0x28
