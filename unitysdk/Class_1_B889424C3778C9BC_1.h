...
#define CLASS_1_B889424C3778C9BC_1_GETFIGHTSTATECONFIG_OFFSET UNITYSDK_OFFSET(0x15683860)
#define CLASS_1_B889424C3778C9BC_1_INIT_OFFSET UNITYSDK_OFFSET(0x15682D90)
#define CLASS_1_B889424C3778C9BC_1_METHOD_1_7EAA8879197594BA_OFFSET UNITYSDK_OFFSET(0x15682EA0)
#define CLASS_1_B889424C3778C9BC_1_REFRESH_OFFSET UNITYSDK_OFFSET(0x15683820)
#define CLASS_1_B889424C3778C9BC_1_RESET_OFFSET UNITYSDK_OFFSET(0x15682E00)
#define CLASS_1_B889424C3778C9BC_1__CTOR_OFFSET UNITYSDK_OFFSET(0x156838A0)
