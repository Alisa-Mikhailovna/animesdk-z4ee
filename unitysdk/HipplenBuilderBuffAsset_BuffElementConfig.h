...
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWBUFFSTRFLOAT_OFFSET UNITYSDK_OFFSET(0x14BCECC0)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWBUFFSTRINT_OFFSET UNITYSDK_OFFSET(0x14BCED10)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG_GET_SHOWSTATTYPE_OFFSET UNITYSDK_OFFSET(0x14BCEC70)
#define HIPPLENBUILDERBUFFASSET_BUFFELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x14BCED60)
