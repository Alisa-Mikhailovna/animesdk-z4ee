...
#define CLASS_1_1C18CB9BC99AF4EC_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C506EC0)
#define CLASS_1_1C18CB9BC99AF4EC_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1C506920)
#define CLASS_1_1C18CB9BC99AF4EC_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C506A80)
#define CLASS_1_1C18CB9BC99AF4EC_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C5069C0)
#define CLASS_1_1C18CB9BC99AF4EC_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C506B90)
#define CLASS_1_1C18CB9BC99AF4EC_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C506FD0)
#define CLASS_1_1C18CB9BC99AF4EC_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C506F70)
#define CLASS_1_1C18CB9BC99AF4EC_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C5067C0)
#define CLASS_1_1C18CB9BC99AF4EC_1_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C506970)
#define CLASS_1_1C18CB9BC99AF4EC_1_METHOD_1_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x1C5069B0)
#define CLASS_1_1C18CB9BC99AF4EC_1_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1C506990)
#define CLASS_1_1C18CB9BC99AF4EC_1_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x1C5069A0)
#define CLASS_1_1C18CB9BC99AF4EC_1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1C506980)
#define CLASS_1_1C18CB9BC99AF4EC_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C506820)
#define CLASS_1_1C18CB9BC99AF4EC_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C506C90)
#define CLASS_1_1C18CB9BC99AF4EC_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C506CF0)
#define CLASS_1_1C18CB9BC99AF4EC_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C5070C0)
#define CLASS_1_1C18CB9BC99AF4EC_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C506880)
#define CLASS_1_1C18CB9BC99AF4EC_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C506830)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_1C18CB9BC99AF4EC_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1C18CB9BC99AF4EC_1_TypeDefinitionIndex)->GetStaticField(0x583B0);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_1C18CB9BC99AF4EC_1_TypeDefinitionIndex)->GetStaticField(0x583B8);
	}
