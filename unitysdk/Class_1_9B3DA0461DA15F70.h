...
#define CLASS_1_9B3DA0461DA15F70__CTOR_OFFSET UNITYSDK_OFFSET(0x1A590A60)
...
public:
	...
	::RPG::GameCore::PhysicsRigidBodyType Field_1_5; // 0x2C
	::System::Single Field_1_6; // 0x30
	::RPG::MVector2 Field_1_7; // 0x34
	::RPG::MVector2 Field_1_8; // 0x3C
