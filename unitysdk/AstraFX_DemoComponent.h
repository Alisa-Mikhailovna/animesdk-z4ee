...
#define ASTRAFX_DEMOCOMPONENT_AFTERCREATERESOURCES_OFFSET UNITYSDK_OFFSET(0x1492ED70)
#define ASTRAFX_DEMOCOMPONENT_AFTEREXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0x1492EE30)
#define ASTRAFX_DEMOCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1492EA70)
#define ASTRAFX_DEMOCOMPONENT_BEFOREEXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0x1492EDD0)
#define ASTRAFX_DEMOCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1492EB70)
#define ASTRAFX_DEMOCOMPONENT_REFRESHASTRAFXRENDERER_OFFSET UNITYSDK_OFFSET(0x1492EEE0)
#define ASTRAFX_DEMOCOMPONENT_RESETSIMULATIONSTATE_OFFSET UNITYSDK_OFFSET(0x1492EBE0)
#define ASTRAFX_DEMOCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1492EF30)
