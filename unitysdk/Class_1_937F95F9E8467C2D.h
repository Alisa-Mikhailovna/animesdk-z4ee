...
#define CLASS_1_937F95F9E8467C2D_CLEAR_OFFSET UNITYSDK_OFFSET(0x149AAE80)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_14CC93689192A32B_OFFSET UNITYSDK_OFFSET(0x149AB3A0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_1991A7B40B7BA36D_OFFSET UNITYSDK_OFFSET(0x149AAFA0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_76BC447B9A4848CB_OFFSET UNITYSDK_OFFSET(0x149AACD0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x149ABBB0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0x149ABC30)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_976CDF5EF06E0838_OFFSET UNITYSDK_OFFSET(0x149ABCB0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x149AB770)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_A5624AB15FE32AEC_OFFSET UNITYSDK_OFFSET(0x149AB8E0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_B8739D0DE156F9EB_OFFSET UNITYSDK_OFFSET(0x149AB7C0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_C51EDA5D6F7FA146_OFFSET UNITYSDK_OFFSET(0x149AB000)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x149AB860)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x149AB8A0)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x149AB820)
#define CLASS_1_937F95F9E8467C2D_METHOD_1_D71F1E82F429310A_OFFSET UNITYSDK_OFFSET(0x149AABB0)
#define CLASS_1_937F95F9E8467C2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x149ABE40)
#define CLASS_1_937F95F9E8467C2D__CTOR_OFFSET UNITYSDK_OFFSET(0x149ABDF0)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_937F95F9E8467C2D_TypeDefinitionIndex)->GetStaticField(0x4B5F0);
	}
	::RPG::GameCore::TransformComponent* Field_1_1; // 0x10
	::UnityEngine::SphereCollider* Field_1_2; // 0x18
	::System::Collections::Generic::List_1<::Class_1_4E1996B50E2373CB*>* Field_1_3; // 0x20
	::Class_1_4E1996B50E2373CB* Field_1_4; // 0x28
	::Class_1_F65DC6656DEF8159* Field_1_5; // 0x30
	::RPG::GameCore::GameEntity* Field_1_6; // 0x38
	::RPG::GameCore::CharacterModelComponent* Field_1_7; // 0x40
	::RPG::GameCore::TimeRewindState Field_1_8; // 0x48
