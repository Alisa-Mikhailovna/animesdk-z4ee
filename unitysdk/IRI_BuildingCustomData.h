...
#define IRI_BUILDINGCUSTOMDATA_METHOD_6_A2846FC5EA0763C6_OFFSET UNITYSDK_OFFSET(0x1524ED60)
#define IRI_BUILDINGCUSTOMDATA_METHOD_6_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x1524ECE0)
#define IRI_BUILDINGCUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1524ECA0)
#define IRI_BUILDINGCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1524ED80)
