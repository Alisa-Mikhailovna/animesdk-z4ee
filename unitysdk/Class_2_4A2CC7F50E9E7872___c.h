...
#define CLASS_2_4A2CC7F50E9E7872___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xAF1FE50)
#define CLASS_2_4A2CC7F50E9E7872___C__CTOR_OFFSET UNITYSDK_OFFSET(0xAF1FE80)
#define CLASS_2_4A2CC7F50E9E7872___C___DEMOTEALLSTACKCAMERAPRIORITIES_B__4_0_OFFSET UNITYSDK_OFFSET(0xAF1FE90)

inline static constexpr unsigned int Class_2_4A2CC7F50E9E7872___c_TypeDefinitionIndex = 72824;
...
public:
	...
	{
		return (::System::Action_2<::RPG::Client::LittleGame::FiveDim::FiveDimMonoCamera*, ::Cinemachine::CinemachineVirtualCameraBase*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4A2CC7F50E9E7872___c_TypeDefinitionIndex)->GetStaticField(0x5EF50);
	}
	static ::Class_2_4A2CC7F50E9E7872___c** StaticGet___9()
	{
		return (::Class_2_4A2CC7F50E9E7872___c**)Il2CppClass::FromTypeDefinitionIndex(Class_2_4A2CC7F50E9E7872___c_TypeDefinitionIndex)->GetStaticField(0x5EF58);
	}
