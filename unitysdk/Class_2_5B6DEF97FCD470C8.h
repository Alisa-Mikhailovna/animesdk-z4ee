...
#define CLASS_2_5B6DEF97FCD470C8_METHOD_2_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x153C0A20)
#define CLASS_2_5B6DEF97FCD470C8_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x153C09D0)
#define CLASS_2_5B6DEF97FCD470C8_METHOD_2_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x153C0AB0)
#define CLASS_2_5B6DEF97FCD470C8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x153C1270)
#define CLASS_2_5B6DEF97FCD470C8_METHOD_2_E71A958DC020C7A7_OFFSET UNITYSDK_OFFSET(0x153C08A0)
#define CLASS_2_5B6DEF97FCD470C8__CCTOR_OFFSET UNITYSDK_OFFSET(0x153C12B0)
#define CLASS_2_5B6DEF97FCD470C8__CTOR_1_OFFSET UNITYSDK_OFFSET(0x153C0740)
#define CLASS_2_5B6DEF97FCD470C8__CTOR_OFFSET UNITYSDK_OFFSET(0x153C0730)
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_5B6DEF97FCD470C8_TypeDefinitionIndex)->GetStaticField(0x3D710);
	}
