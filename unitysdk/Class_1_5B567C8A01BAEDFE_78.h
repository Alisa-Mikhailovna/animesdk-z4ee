...
#define CLASS_1_5B567C8A01BAEDFE_78_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C4D0620)
#define CLASS_1_5B567C8A01BAEDFE_78_CLONE_OFFSET UNITYSDK_OFFSET(0x1C4D02C0)
#define CLASS_1_5B567C8A01BAEDFE_78_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C4D0420)
#define CLASS_1_5B567C8A01BAEDFE_78_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C4D0330)
#define CLASS_1_5B567C8A01BAEDFE_78_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C4D0580)
#define CLASS_1_5B567C8A01BAEDFE_78_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C4D0670)
#define CLASS_1_5B567C8A01BAEDFE_78_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C4D0640)
#define CLASS_1_5B567C8A01BAEDFE_78_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C4D0210)
#define CLASS_1_5B567C8A01BAEDFE_78_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C4D0270)
#define CLASS_1_5B567C8A01BAEDFE_78_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C4D05B0)
#define CLASS_1_5B567C8A01BAEDFE_78_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C4D0610)
#define CLASS_1_5B567C8A01BAEDFE_78__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4D06C0)
#define CLASS_1_5B567C8A01BAEDFE_78__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4D0290)
#define CLASS_1_5B567C8A01BAEDFE_78__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4D0280)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_78*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_78_TypeDefinitionIndex)->GetStaticField(0x52AD0);
	}
