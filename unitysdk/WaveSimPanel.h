...
#define WAVESIMPANEL_CALCULATERENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xDDC8E30)
#define WAVESIMPANEL_CALCULATESIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xDDC8DC0)
#define WAVESIMPANEL_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xDDC8BC0)
#define WAVESIMPANEL_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xDDC8EA0)
#define WAVESIMPANEL_GET_ACTIVEPRIORITY_OFFSET UNITYSDK_OFFSET(0xDDC8CC0)
#define WAVESIMPANEL_GET_ADVECDISTDAMPING_OFFSET UNITYSDK_OFFSET(0xDDC8C50)
#define WAVESIMPANEL_GET_DAMPING_OFFSET UNITYSDK_OFFSET(0xDDC8C40)
#define WAVESIMPANEL_GET_FADINGRATE_OFFSET UNITYSDK_OFFSET(0xDDC8CB0)
#define WAVESIMPANEL_GET_GENERATED_OFFSET UNITYSDK_OFFSET(0xDDC8D00)
#define WAVESIMPANEL_GET_PARTICLEADEVINTENSITY_OFFSET UNITYSDK_OFFSET(0xDDC8C60)
#define WAVESIMPANEL_GET_PARTICLEDAMPING_OFFSET UNITYSDK_OFFSET(0xDDC8C80)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYINTENSITY_OFFSET UNITYSDK_OFFSET(0xDDC8C70)
#define WAVESIMPANEL_GET_PARTICLEVIRTUALBUOYANCYOFFSET_OFFSET UNITYSDK_OFFSET(0xDDC8C90)
#define WAVESIMPANEL_GET_RENDERMESHSIZE_OFFSET UNITYSDK_OFFSET(0xDDC8CF0)
#define WAVESIMPANEL_GET_SIMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0xDDC8CE0)
#define WAVESIMPANEL_GET_STATICBOUNDARYTEXTURE_OFFSET UNITYSDK_OFFSET(0xDDC8CD0)
#define WAVESIMPANEL_GET_USEBLENDINGASRENDER_OFFSET UNITYSDK_OFFSET(0xDDC8CA0)
#define WAVESIMPANEL_RESETSIMSIZE_OFFSET UNITYSDK_OFFSET(0xDDC8D10)
#define WAVESIMPANEL_SPAWNED_OFFSET UNITYSDK_OFFSET(0xDDC8B80)
#define WAVESIMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xDDC8EF0)
