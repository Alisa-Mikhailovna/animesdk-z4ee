...
#define CLASS_1_AE62C6A596336500_METHOD_1_02CA8785220462C6_OFFSET UNITYSDK_OFFSET(0x151D3820)
#define CLASS_1_AE62C6A596336500_METHOD_1_199A3770E3204FCD_OFFSET UNITYSDK_OFFSET(0x151D2AD0)
#define CLASS_1_AE62C6A596336500_METHOD_1_1F5C8CCD36213485_OFFSET UNITYSDK_OFFSET(0x151D32B0)
#define CLASS_1_AE62C6A596336500_METHOD_1_391CF272AE8CC98C_OFFSET UNITYSDK_OFFSET(0x151D2BF0)
#define CLASS_1_AE62C6A596336500_METHOD_1_392EFB1C517D0F0C_OFFSET UNITYSDK_OFFSET(0x151D3030)
#define CLASS_1_AE62C6A596336500_METHOD_1_48BD86FEB6078B19_OFFSET UNITYSDK_OFFSET(0x151D33B0)
#define CLASS_1_AE62C6A596336500_METHOD_1_49B486C68B40417B_OFFSET UNITYSDK_OFFSET(0x151D2B90)
#define CLASS_1_AE62C6A596336500_METHOD_1_4B6D73FF09C77254_OFFSET UNITYSDK_OFFSET(0x151D2B30)
#define CLASS_1_AE62C6A596336500_METHOD_1_507D63F1DAE224C7_OFFSET UNITYSDK_OFFSET(0x151D2CF0)
#define CLASS_1_AE62C6A596336500_METHOD_1_51226D7FFEA44F24_OFFSET UNITYSDK_OFFSET(0x151D2A70)
#define CLASS_1_AE62C6A596336500_METHOD_1_5769304A941AAEA8_OFFSET UNITYSDK_OFFSET(0x151D30F0)
#define CLASS_1_AE62C6A596336500_METHOD_1_9177D4953D7CDFEB_OFFSET UNITYSDK_OFFSET(0x151D31F0)
#define CLASS_1_AE62C6A596336500_METHOD_1_9FECF4A55EC56CD9_OFFSET UNITYSDK_OFFSET(0x151D2F30)
#define CLASS_1_AE62C6A596336500_METHOD_1_C4890C3661481A1D_OFFSET UNITYSDK_OFFSET(0x151D3460)
#define CLASS_1_AE62C6A596336500_METHOD_1_E4865A0578743351_OFFSET UNITYSDK_OFFSET(0x151D2DB0)
#define CLASS_1_AE62C6A596336500_METHOD_1_E852251294AF8C56_OFFSET UNITYSDK_OFFSET(0x151D3600)
#define CLASS_1_AE62C6A596336500__CCTOR_OFFSET UNITYSDK_OFFSET(0x151D39C0)
...
{
public:
	static ::System::Collections::Generic::HashSet_1<::RPGTools::LDWhiteBox::WhiteBoxJunction*>** StaticGet_Field_1_0()
	{
		return (::System::Collections::Generic::HashSet_1<::RPGTools::LDWhiteBox::WhiteBoxJunction*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AE62C6A596336500_TypeDefinitionIndex)->GetStaticField(0xC080);
	}
	static ::System::Collections::Generic::HashSet_1<::RPGTools::LDWhiteBox::WhiteBoxRegion*>** StaticGet_Field_1_1()
	{
		return (::System::Collections::Generic::HashSet_1<::RPGTools::LDWhiteBox::WhiteBoxRegion*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AE62C6A596336500_TypeDefinitionIndex)->GetStaticField(0xC088);
	}
	static ::System::Collections::Generic::HashSet_1<::RPGTools::LDWhiteBox::WhiteBoxConnector*>** StaticGet_Field_1_2()
	{
		return (::System::Collections::Generic::HashSet_1<::RPGTools::LDWhiteBox::WhiteBoxConnector*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AE62C6A596336500_TypeDefinitionIndex)->GetStaticField(0xC090);
	}
	static ::System::Collections::Generic::HashSet_1<::RPGTools::LDWhiteBox::WhiteBoxPath*>** StaticGet_Field_1_3()
	{
		return (::System::Collections::Generic::HashSet_1<::RPGTools::LDWhiteBox::WhiteBoxPath*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_AE62C6A596336500_TypeDefinitionIndex)->GetStaticField(0xC098);
	}
