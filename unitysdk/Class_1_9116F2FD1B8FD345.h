...
#define CLASS_1_9116F2FD1B8FD345_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A7A61B0)
#define CLASS_1_9116F2FD1B8FD345__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A6200)
...
{
public:
	::Struct_2_3781D7BD58E0C993 Field_1_0; // 0x10
	::RPG::GameCore::FiveDimCrystalConfig* Field_1_1; // 0x58
