...
#define CLASS_1_D82ADDE55CACA8DD_GET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x11337A20)
#define CLASS_1_D82ADDE55CACA8DD_GET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x11337A40)
#define CLASS_1_D82ADDE55CACA8DD_GET_ISSHELFUNLOCK_OFFSET UNITYSDK_OFFSET(0x11337A60)
#define CLASS_1_D82ADDE55CACA8DD_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x11337A00)
#define CLASS_1_D82ADDE55CACA8DD_GET_LOCALISVISIBLE_OFFSET UNITYSDK_OFFSET(0x11337AA0)
#define CLASS_1_D82ADDE55CACA8DD_GET_REWARDS_OFFSET UNITYSDK_OFFSET(0x11337A80)
#define CLASS_1_D82ADDE55CACA8DD_SET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x11337A30)
#define CLASS_1_D82ADDE55CACA8DD_SET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x11337A50)
#define CLASS_1_D82ADDE55CACA8DD_SET_ISSHELFUNLOCK_OFFSET UNITYSDK_OFFSET(0x11337A70)
#define CLASS_1_D82ADDE55CACA8DD_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x11337A10)
#define CLASS_1_D82ADDE55CACA8DD_SET_LOCALISVISIBLE_OFFSET UNITYSDK_OFFSET(0x11337AB0)
#define CLASS_1_D82ADDE55CACA8DD_SET_REWARDS_OFFSET UNITYSDK_OFFSET(0x11337A90)
#define CLASS_1_D82ADDE55CACA8DD__CTOR_OFFSET UNITYSDK_OFFSET(0x11337AC0)

inline static constexpr unsigned int Class_1_D82ADDE55CACA8DD_TypeDefinitionIndex = 76683;
...
public:
	...
	::System::Boolean _CanInteract_k__BackingField; // 0x1D
