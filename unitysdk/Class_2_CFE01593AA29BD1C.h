...
#define CLASS_2_CFE01593AA29BD1C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x149283D0)
#define CLASS_2_CFE01593AA29BD1C_METHOD_2_D3314DFA55F6676E_OFFSET UNITYSDK_OFFSET(0x14928520)
#define CLASS_2_CFE01593AA29BD1C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x149280D0)
#define CLASS_2_CFE01593AA29BD1C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14928380)
#define CLASS_2_CFE01593AA29BD1C_TICK_OFFSET UNITYSDK_OFFSET(0x149282D0)
#define CLASS_2_CFE01593AA29BD1C__CTOR_OFFSET UNITYSDK_OFFSET(0x149280C0)
...
{
public:
	::RPG::Client::ActivityHipplen::ActivityHipplenMiniGameManager* Field_2_0; // 0x18
	::RPG::GameCore::HipplenGameWaitEvent* Field_2_1; // 0x20
	::Class_2_CFE01593AA29BD1C_Class_1_22046C69D06B0F53* Field_2_2; // 0x28
