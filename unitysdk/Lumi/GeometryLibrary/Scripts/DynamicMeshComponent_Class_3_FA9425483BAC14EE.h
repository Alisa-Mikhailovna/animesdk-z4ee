...
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAFCA7D0)
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAFCA800)
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE_INVOKE_OFFSET UNITYSDK_OFFSET(0xAFCA7C0)
#define LUMI_GEOMETRYLIBRARY_SCRIPTS_DYNAMICMESHCOMPONENT_CLASS_3_FA9425483BAC14EE__CTOR_OFFSET UNITYSDK_OFFSET(0xAFCA6D0)
