...
#define CLASS_1_5B567C8A01BAEDFE_37_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C447C80)
#define CLASS_1_5B567C8A01BAEDFE_37_CLONE_OFFSET UNITYSDK_OFFSET(0x1C447920)
#define CLASS_1_5B567C8A01BAEDFE_37_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C447A80)
#define CLASS_1_5B567C8A01BAEDFE_37_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C447990)
#define CLASS_1_5B567C8A01BAEDFE_37_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C447BE0)
#define CLASS_1_5B567C8A01BAEDFE_37_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C447CD0)
#define CLASS_1_5B567C8A01BAEDFE_37_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C447CA0)
#define CLASS_1_5B567C8A01BAEDFE_37_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C447870)
#define CLASS_1_5B567C8A01BAEDFE_37_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C4478D0)
#define CLASS_1_5B567C8A01BAEDFE_37_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C447C10)
#define CLASS_1_5B567C8A01BAEDFE_37_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C447C70)
#define CLASS_1_5B567C8A01BAEDFE_37__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C447D20)
#define CLASS_1_5B567C8A01BAEDFE_37__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4478F0)
#define CLASS_1_5B567C8A01BAEDFE_37__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4478E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_37*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_37_TypeDefinitionIndex)->GetStaticField(0x52F40);
	}
