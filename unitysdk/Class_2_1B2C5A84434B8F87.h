...
#define CLASS_2_1B2C5A84434B8F87_GET_CREATORID_OFFSET UNITYSDK_OFFSET(0x1A9D3070)
#define CLASS_2_1B2C5A84434B8F87_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A9D3050)
#define CLASS_2_1B2C5A84434B8F87_SET_CREATORID_OFFSET UNITYSDK_OFFSET(0x1A9D3080)
#define CLASS_2_1B2C5A84434B8F87_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A9D3060)
#define CLASS_2_1B2C5A84434B8F87__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9D2F10)
