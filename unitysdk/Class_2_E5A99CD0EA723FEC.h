...
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_0E5AEC953C77273E_OFFSET UNITYSDK_OFFSET(0x153C6C60)
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_5262BC49EFD121F6_OFFSET UNITYSDK_OFFSET(0x153C6820)
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x153C6490)
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_A7F8207BBA14FDCD_OFFSET UNITYSDK_OFFSET(0x153C6590)
#define CLASS_2_E5A99CD0EA723FEC_METHOD_2_B4A91A4ACDF9D75F_OFFSET UNITYSDK_OFFSET(0x153C6510)
#define CLASS_2_E5A99CD0EA723FEC__CCTOR_OFFSET UNITYSDK_OFFSET(0x153C6F20)
#define CLASS_2_E5A99CD0EA723FEC__CTOR_OFFSET UNITYSDK_OFFSET(0x153C6500)
...
public:
	...
	{
		return (::Class_2_E5A99CD0EA723FEC**)Il2CppClass::FromTypeDefinitionIndex(Class_2_E5A99CD0EA723FEC_TypeDefinitionIndex)->GetStaticField(0x3DA10);
	}
	::Class_1_2670985A37556FEA* Field_2_1; // 0x10
	::System::Collections::Generic::IDictionary_2<::System::String*, ::RPG::GameCore::FixPoint>* Field_2_2; // 0x18
