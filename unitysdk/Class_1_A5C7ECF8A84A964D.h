...
#define CLASS_1_A5C7ECF8A84A964D_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C02B150)
#define CLASS_1_A5C7ECF8A84A964D_CLONE_OFFSET UNITYSDK_OFFSET(0x1C02ABC0)
#define CLASS_1_A5C7ECF8A84A964D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C02ADA0)
#define CLASS_1_A5C7ECF8A84A964D_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C02AC40)
#define CLASS_1_A5C7ECF8A84A964D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C02AEE0)
#define CLASS_1_A5C7ECF8A84A964D_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C02B310)
#define CLASS_1_A5C7ECF8A84A964D_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C02B260)
#define CLASS_1_A5C7ECF8A84A964D_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C02AC10)
#define CLASS_1_A5C7ECF8A84A964D_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C02AAA0)
#define CLASS_1_A5C7ECF8A84A964D_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C02AC20)
#define CLASS_1_A5C7ECF8A84A964D_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1C02AC00)
#define CLASS_1_A5C7ECF8A84A964D_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1C02ABF0)
#define CLASS_1_A5C7ECF8A84A964D_METHOD_1_F05E2AE4258237EE_OFFSET UNITYSDK_OFFSET(0x1C02AC30)
#define CLASS_1_A5C7ECF8A84A964D_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C02AAD0)
#define CLASS_1_A5C7ECF8A84A964D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C02AF50)
#define CLASS_1_A5C7ECF8A84A964D_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C02AFB0)
#define CLASS_1_A5C7ECF8A84A964D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C02B4E0)
#define CLASS_1_A5C7ECF8A84A964D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C02AB20)
#define CLASS_1_A5C7ECF8A84A964D__CTOR_OFFSET UNITYSDK_OFFSET(0x1C02AAE0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::Proto::GachaCeilingAvatar*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A5C7ECF8A84A964D_TypeDefinitionIndex)->GetStaticField(0x67260);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_A5C7ECF8A84A964D*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_A5C7ECF8A84A964D*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A5C7ECF8A84A964D_TypeDefinitionIndex)->GetStaticField(0x67268);
	}
