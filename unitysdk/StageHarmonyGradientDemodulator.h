...
#define STAGEHARMONYGRADIENTDEMODULATOR_METHOD_3_39CA3A8D335F6DEC_OFFSET UNITYSDK_OFFSET(0xDD63C30)
#define STAGEHARMONYGRADIENTDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xDD63CD0)
#define STAGEHARMONYGRADIENTDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xDD63D20)
