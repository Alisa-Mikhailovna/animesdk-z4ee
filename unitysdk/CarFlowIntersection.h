...
#define CARFLOWINTERSECTION_INIT_OFFSET UNITYSDK_OFFSET(0xD05FE90)
#define CARFLOWINTERSECTION_START_OFFSET UNITYSDK_OFFSET(0xD0603D0)
#define CARFLOWINTERSECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xD060410)
#define CARFLOWINTERSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD060450)
