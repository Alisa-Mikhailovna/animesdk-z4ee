...
#define EFFECT_UVANIMATION_START_OFFSET UNITYSDK_OFFSET(0x144C3940)
#define EFFECT_UVANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x144C3A10)
#define EFFECT_UVANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x144C3BA0)
