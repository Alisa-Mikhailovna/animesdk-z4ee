...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x3AE2BC0)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x20)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x3A778D0)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0x3A77910)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x8FCCB10)
