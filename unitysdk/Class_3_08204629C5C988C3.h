...
#define CLASS_3_08204629C5C988C3_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xD5ABAF0)
#define CLASS_3_08204629C5C988C3_ONSKIP_OFFSET UNITYSDK_OFFSET(0xD5ABCB0)
#define CLASS_3_08204629C5C988C3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xD5ABB00)
#define CLASS_3_08204629C5C988C3__CTOR_OFFSET UNITYSDK_OFFSET(0xD5ABAC0)
