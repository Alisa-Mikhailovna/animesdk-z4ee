...
#define HIPPLENBUILDERTESTLINECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x14BDD590)
#define HIPPLENBUILDERTESTLINECONTROLLER_METHOD_5_33CB3B8324399CE4_OFFSET UNITYSDK_OFFSET(0x14BDE0D0)
#define HIPPLENBUILDERTESTLINECONTROLLER_ONPIN_OFFSET UNITYSDK_OFFSET(0x14BDE5D0)
#define HIPPLENBUILDERTESTLINECONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x14BDED20)
#define HIPPLENBUILDERTESTLINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14BDED60)
