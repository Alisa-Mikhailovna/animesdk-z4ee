...
#define CLASS_1_5B567C8A01BAEDFE_121_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C2C5300)
#define CLASS_1_5B567C8A01BAEDFE_121_CLONE_OFFSET UNITYSDK_OFFSET(0x1C2C4FA0)
#define CLASS_1_5B567C8A01BAEDFE_121_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C2C5100)
#define CLASS_1_5B567C8A01BAEDFE_121_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C2C5010)
#define CLASS_1_5B567C8A01BAEDFE_121_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C2C5260)
#define CLASS_1_5B567C8A01BAEDFE_121_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C2C5350)
#define CLASS_1_5B567C8A01BAEDFE_121_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C2C5320)
#define CLASS_1_5B567C8A01BAEDFE_121_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C2C4EF0)
#define CLASS_1_5B567C8A01BAEDFE_121_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C2C4F50)
#define CLASS_1_5B567C8A01BAEDFE_121_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C2C5290)
#define CLASS_1_5B567C8A01BAEDFE_121_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C2C52F0)
#define CLASS_1_5B567C8A01BAEDFE_121__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2C53A0)
#define CLASS_1_5B567C8A01BAEDFE_121__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2C4F70)
#define CLASS_1_5B567C8A01BAEDFE_121__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2C4F60)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_121*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_121_TypeDefinitionIndex)->GetStaticField(0x35050);
	}
