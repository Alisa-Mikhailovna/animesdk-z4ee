...
#define CLASS_1_9142AEEC954ACD89_GET_BASECONFIG_OFFSET UNITYSDK_OFFSET(0xB14DE10)
#define CLASS_1_9142AEEC954ACD89_GET_BASEDAMAGEPCT_OFFSET UNITYSDK_OFFSET(0xB14DE90)
#define CLASS_1_9142AEEC954ACD89_GET_BASEDAMAGE_OFFSET UNITYSDK_OFFSET(0xB14DE70)
#define CLASS_1_9142AEEC954ACD89_GET_BASEHEALPCT_OFFSET UNITYSDK_OFFSET(0xB14DE50)
#define CLASS_1_9142AEEC954ACD89_GET_BASEHEAL_OFFSET UNITYSDK_OFFSET(0xB14DE30)
#define CLASS_1_9142AEEC954ACD89_GET_BASESHIELD_OFFSET UNITYSDK_OFFSET(0xB14DEB0)
#define CLASS_1_9142AEEC954ACD89_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0xB14DDE0)
#define CLASS_1_9142AEEC954ACD89_GET_PRECALCTASKCONTEXT_OFFSET UNITYSDK_OFFSET(0xB14DE00)
#define CLASS_1_9142AEEC954ACD89_GET_SUBMODE_OFFSET UNITYSDK_OFFSET(0xB14DDF0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_24DB0CE1595FE2D3_OFFSET UNITYSDK_OFFSET(0xB14EBD0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_28B4B80C29FB0F1B_OFFSET UNITYSDK_OFFSET(0xB14DED0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_2CE02CA00D75BA32_OFFSET UNITYSDK_OFFSET(0xB14F090)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_325888F29AD57E1B_OFFSET UNITYSDK_OFFSET(0xB14F970)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_36CD3EA5F63BB6E2_OFFSET UNITYSDK_OFFSET(0xB14E3B0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_39F0DE2A1348DBFF_OFFSET UNITYSDK_OFFSET(0xB14E130)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_4015FDE23F37E665_1_OFFSET UNITYSDK_OFFSET(0xB14FEA0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_4015FDE23F37E665_OFFSET UNITYSDK_OFFSET(0xB14FC60)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_474FC179B376E2F9_OFFSET UNITYSDK_OFFSET(0xB14E830)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_534FA337054CA657_OFFSET UNITYSDK_OFFSET(0xB14FA80)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_9087AD74B4CB9BFD_OFFSET UNITYSDK_OFFSET(0xB14ECC0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_AB71CB6A7FDDA465_OFFSET UNITYSDK_OFFSET(0xB14F740)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_B2C13E0490FF5A9A_OFFSET UNITYSDK_OFFSET(0xB14E090)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_C236E732AB1EC1E4_OFFSET UNITYSDK_OFFSET(0xB14EA00)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB14F700)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_CE922FA16F8C5A82_OFFSET UNITYSDK_OFFSET(0xB1503B0)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_DB6114EA5E195AD2_OFFSET UNITYSDK_OFFSET(0xB14E500)
#define CLASS_1_9142AEEC954ACD89_METHOD_1_F7268CF03A5BC199_OFFSET UNITYSDK_OFFSET(0xB1500B0)
#define CLASS_1_9142AEEC954ACD89_SET_BASECONFIG_OFFSET UNITYSDK_OFFSET(0xB14DE20)
#define CLASS_1_9142AEEC954ACD89_SET_BASEDAMAGEPCT_OFFSET UNITYSDK_OFFSET(0xB14DEA0)
#define CLASS_1_9142AEEC954ACD89_SET_BASEDAMAGE_OFFSET UNITYSDK_OFFSET(0xB14DE80)
#define CLASS_1_9142AEEC954ACD89_SET_BASEHEALPCT_OFFSET UNITYSDK_OFFSET(0xB14DE60)
#define CLASS_1_9142AEEC954ACD89_SET_BASEHEAL_OFFSET UNITYSDK_OFFSET(0xB14DE40)
#define CLASS_1_9142AEEC954ACD89_SET_BASESHIELD_OFFSET UNITYSDK_OFFSET(0xB14DEC0)
#define CLASS_1_9142AEEC954ACD89__CTOR_OFFSET UNITYSDK_OFFSET(0xB14DBD0)
...
{
public:
	::Il2CppArray<::System::Collections::Generic::List_1<::Struct_2_BAFD362D8FC4BA51>*>* Field_1_0; // 0x10
	::Class_2_545F497870FB4A84* _BaseConfig_k__BackingField; // 0x18
	::RPG::GameCore::TaskContext* _PreCalcTaskContext_k__BackingField; // 0x20
	::RPG::GameCore::GameEntity* _Entity_k__BackingField; // 0x28
	::Class_2_7EA45D2647F35CDD* _SubMode_k__BackingField; // 0x30
	::RPG::GameCore::FixPoint _BaseHeal_k__BackingField; // 0x38
	...
	::RPG::GameCore::FixPoint _BaseDamagePct_k__BackingField; // 0x60
	::RPG::GameCore::FixPoint _BaseHealPct_k__BackingField; // 0x68
	::RPG::GameCore::FixPoint Field_1_13; // 0x70
	::RPG::GameCore::FixPoint Field_1_14; // 0x78
	::RPG::GameCore::FixPoint Field_1_15; // 0x80
	::RPG::GameCore::FixPoint _BaseDamage_k__BackingField; // 0x88
	::RPG::GameCore::FixPoint _BaseShield_k__BackingField; // 0x90
