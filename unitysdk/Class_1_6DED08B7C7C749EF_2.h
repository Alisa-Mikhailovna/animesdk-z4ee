...
#define CLASS_1_6DED08B7C7C749EF_2_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C1F99A0)
#define CLASS_1_6DED08B7C7C749EF_2_CLONE_OFFSET UNITYSDK_OFFSET(0x1C1F92E0)
#define CLASS_1_6DED08B7C7C749EF_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C1F94A0)
#define CLASS_1_6DED08B7C7C749EF_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C1F93E0)
#define CLASS_1_6DED08B7C7C749EF_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C1F95E0)
#define CLASS_1_6DED08B7C7C749EF_2_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C1F9BF0)
#define CLASS_1_6DED08B7C7C749EF_2_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C1F9B80)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C1F9360)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C1F9340)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1C1F9390)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1C1F9380)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C1F9170)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C1F9330)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C1F9370)
#define CLASS_1_6DED08B7C7C749EF_2_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C1F9350)
#define CLASS_1_6DED08B7C7C749EF_2_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C1F91D0)
#define CLASS_1_6DED08B7C7C749EF_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C1F9760)
#define CLASS_1_6DED08B7C7C749EF_2_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C1F97C0)
#define CLASS_1_6DED08B7C7C749EF_2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C1F9D30)
#define CLASS_1_6DED08B7C7C749EF_2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C1F9240)
#define CLASS_1_6DED08B7C7C749EF_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1F91E0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_2_TypeDefinitionIndex)->GetStaticField(0x27AC0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_2*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_2*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_2_TypeDefinitionIndex)->GetStaticField(0x27AC8);
	}
