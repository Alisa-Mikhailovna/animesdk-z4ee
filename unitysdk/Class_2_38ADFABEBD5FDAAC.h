...
#define CLASS_2_38ADFABEBD5FDAAC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x155A0D20)
#define CLASS_2_38ADFABEBD5FDAAC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x155A0D60)
#define CLASS_2_38ADFABEBD5FDAAC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x155A0E00)
#define CLASS_2_38ADFABEBD5FDAAC_TICK_OFFSET UNITYSDK_OFFSET(0x155A0E50)
#define CLASS_2_38ADFABEBD5FDAAC__CTOR_OFFSET UNITYSDK_OFFSET(0x155A0D10)
