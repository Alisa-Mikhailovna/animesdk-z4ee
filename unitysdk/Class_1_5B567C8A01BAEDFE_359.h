...
#define CLASS_1_5B567C8A01BAEDFE_359_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C791C70)
#define CLASS_1_5B567C8A01BAEDFE_359_CLONE_OFFSET UNITYSDK_OFFSET(0x1C791960)
#define CLASS_1_5B567C8A01BAEDFE_359_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C791A70)
#define CLASS_1_5B567C8A01BAEDFE_359_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C7919A0)
#define CLASS_1_5B567C8A01BAEDFE_359_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C791BD0)
#define CLASS_1_5B567C8A01BAEDFE_359_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C791CC0)
#define CLASS_1_5B567C8A01BAEDFE_359_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C791C90)
#define CLASS_1_5B567C8A01BAEDFE_359_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C7918E0)
#define CLASS_1_5B567C8A01BAEDFE_359_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C791910)
#define CLASS_1_5B567C8A01BAEDFE_359_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C791C00)
#define CLASS_1_5B567C8A01BAEDFE_359_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C791C60)
#define CLASS_1_5B567C8A01BAEDFE_359__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C791D10)
#define CLASS_1_5B567C8A01BAEDFE_359__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C791930)
#define CLASS_1_5B567C8A01BAEDFE_359__CTOR_OFFSET UNITYSDK_OFFSET(0x1C791920)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_359*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_359_TypeDefinitionIndex)->GetStaticField(0x1A6D0);
	}
