...
#define RTS_NEWSYNTAXE_RESTECOLOR_OFFSET UNITYSDK_OFFSET(0x157A6460)
#define RTS_NEWSYNTAXE_START_OFFSET UNITYSDK_OFFSET(0x157A5E50)
#define RTS_NEWSYNTAXE_UPDATE_OFFSET UNITYSDK_OFFSET(0x157A5E60)
#define RTS_NEWSYNTAXE__CTOR_OFFSET UNITYSDK_OFFSET(0x157A6550)
