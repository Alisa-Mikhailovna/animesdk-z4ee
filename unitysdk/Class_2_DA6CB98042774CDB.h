...
#define CLASS_2_DA6CB98042774CDB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x148B4EA0)
#define CLASS_2_DA6CB98042774CDB_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x148B4DA0)
#define CLASS_2_DA6CB98042774CDB_ONSKIP_OFFSET UNITYSDK_OFFSET(0x148B4DB0)
#define CLASS_2_DA6CB98042774CDB_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x148B4FC0)
#define CLASS_2_DA6CB98042774CDB_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x148B50E0)
#define CLASS_2_DA6CB98042774CDB_TICK_OFFSET UNITYSDK_OFFSET(0x148B4EE0)
#define CLASS_2_DA6CB98042774CDB__CTOR_OFFSET UNITYSDK_OFFSET(0x148B4D90)
