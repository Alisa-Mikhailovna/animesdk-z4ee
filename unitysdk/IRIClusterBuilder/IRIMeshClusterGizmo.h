...
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_METHOD_5_666191C5DC332092_OFFSET UNITYSDK_OFFSET(0x15248450)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_METHOD_5_B920F25FC9D3FA44_OFFSET UNITYSDK_OFFSET(0x15248770)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x15247D90)
#define IRICLUSTERBUILDER_IRIMESHCLUSTERGIZMO__CTOR_OFFSET UNITYSDK_OFFSET(0x15248A40)
