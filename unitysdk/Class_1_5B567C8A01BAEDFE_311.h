...
#define CLASS_1_5B567C8A01BAEDFE_311_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C261C30)
#define CLASS_1_5B567C8A01BAEDFE_311_CLONE_OFFSET UNITYSDK_OFFSET(0x1C2618D0)
#define CLASS_1_5B567C8A01BAEDFE_311_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C261A30)
#define CLASS_1_5B567C8A01BAEDFE_311_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C261940)
#define CLASS_1_5B567C8A01BAEDFE_311_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C261B90)
#define CLASS_1_5B567C8A01BAEDFE_311_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C261C80)
#define CLASS_1_5B567C8A01BAEDFE_311_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C261C50)
#define CLASS_1_5B567C8A01BAEDFE_311_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C261820)
#define CLASS_1_5B567C8A01BAEDFE_311_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C261880)
#define CLASS_1_5B567C8A01BAEDFE_311_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C261BC0)
#define CLASS_1_5B567C8A01BAEDFE_311_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C261C20)
#define CLASS_1_5B567C8A01BAEDFE_311__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C261CD0)
#define CLASS_1_5B567C8A01BAEDFE_311__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2618A0)
#define CLASS_1_5B567C8A01BAEDFE_311__CTOR_OFFSET UNITYSDK_OFFSET(0x1C261890)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_311*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_311_TypeDefinitionIndex)->GetStaticField(0x2E370);
	}
