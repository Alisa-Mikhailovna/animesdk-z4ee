...
#define CLASS_1_9EF7AFCD5A0A1C74_GET_CURRENTPLAYTIME_OFFSET UNITYSDK_OFFSET(0x14410480)
#define CLASS_1_9EF7AFCD5A0A1C74_GET_CURRENTSTATEDATA_OFFSET UNITYSDK_OFFSET(0x14410440)
#define CLASS_1_9EF7AFCD5A0A1C74_GET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x144104A0)
#define CLASS_1_9EF7AFCD5A0A1C74_GET_ONUISTATEPLAYCOMPLETEDACTION_OFFSET UNITYSDK_OFFSET(0x14410460)
#define CLASS_1_9EF7AFCD5A0A1C74_GET_PARENTUISTATECTRL_OFFSET UNITYSDK_OFFSET(0x144104C0)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x144102C0)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x14410200)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_482761CB050F1A57_OFFSET UNITYSDK_OFFSET(0x14410270)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_8A1C979A2319B852_OFFSET UNITYSDK_OFFSET(0x14410320)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_8C637C6318E207AD_OFFSET UNITYSDK_OFFSET(0x14410370)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x144103F0)
#define CLASS_1_9EF7AFCD5A0A1C74_METHOD_1_F754FB46877347EB_OFFSET UNITYSDK_OFFSET(0x14410100)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_CURRENTPLAYTIME_OFFSET UNITYSDK_OFFSET(0x14410490)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_CURRENTSTATEDATA_OFFSET UNITYSDK_OFFSET(0x14410450)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x144104B0)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_ONUISTATEPLAYCOMPLETEDACTION_OFFSET UNITYSDK_OFFSET(0x14410470)
#define CLASS_1_9EF7AFCD5A0A1C74_SET_PARENTUISTATECTRL_OFFSET UNITYSDK_OFFSET(0x144104D0)
#define CLASS_1_9EF7AFCD5A0A1C74__CTOR_OFFSET UNITYSDK_OFFSET(0x144104E0)

inline static constexpr unsigned int Class_1_9EF7AFCD5A0A1C74_TypeDefinitionIndex = 70671;
