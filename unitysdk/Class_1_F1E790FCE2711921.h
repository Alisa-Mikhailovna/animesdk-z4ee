...
#define CLASS_1_F1E790FCE2711921__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C8F20)
...
public:
	...
	::RPG::Client::LittleGame::TimelineControlGameCharacterMovementPath* Field_1_1; // 0x18
	::UnityEngine::Transform* Field_1_2; // 0x20
	::UnityEngine::Vector3Int Field_1_3; // 0x28
	::RPG::Client::LittleGame::TimelineControlGameCharacterMovementConfig Field_1_4; // 0x34
