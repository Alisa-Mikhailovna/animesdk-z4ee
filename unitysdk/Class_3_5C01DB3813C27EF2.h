...
#define CLASS_3_5C01DB3813C27EF2_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB583E30)
#define CLASS_3_5C01DB3813C27EF2__CTOR_OFFSET UNITYSDK_OFFSET(0xB583B90)
#define CLASS_3_5C01DB3813C27EF2__PREPAREDATA_OFFSET UNITYSDK_OFFSET(0xB583E80)
#define CLASS_3_5C01DB3813C27EF2__REGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xB583F00)
#define CLASS_3_5C01DB3813C27EF2__UNREGISTEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0xB584090)
