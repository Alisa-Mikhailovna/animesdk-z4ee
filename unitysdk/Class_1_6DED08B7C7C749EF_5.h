...
#define CLASS_1_6DED08B7C7C749EF_5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BF5BAD0)
#define CLASS_1_6DED08B7C7C749EF_5_CLONE_OFFSET UNITYSDK_OFFSET(0x1BF5B520)
#define CLASS_1_6DED08B7C7C749EF_5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BF5B680)
#define CLASS_1_6DED08B7C7C749EF_5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BF5B5E0)
#define CLASS_1_6DED08B7C7C749EF_5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BF5B7B0)
#define CLASS_1_6DED08B7C7C749EF_5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BF5BC60)
#define CLASS_1_6DED08B7C7C749EF_5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BF5BBF0)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1BF5B550)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1BF5B580)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1BF5B570)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1BF5B5D0)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BF5B3E0)
#define CLASS_1_6DED08B7C7C749EF_5_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1BF5B560)
#define CLASS_1_6DED08B7C7C749EF_5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BF5B410)
#define CLASS_1_6DED08B7C7C749EF_5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BF5B930)
#define CLASS_1_6DED08B7C7C749EF_5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BF5B990)
#define CLASS_1_6DED08B7C7C749EF_5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BF5BD70)
#define CLASS_1_6DED08B7C7C749EF_5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BF5B480)
#define CLASS_1_6DED08B7C7C749EF_5__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF5B420)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_6DED08B7C7C749EF_5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex)->GetStaticField(0x60990);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_6DED08B7C7C749EF_5_TypeDefinitionIndex)->GetStaticField(0x60998);
	}
