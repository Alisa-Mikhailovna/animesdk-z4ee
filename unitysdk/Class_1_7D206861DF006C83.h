...
#define CLASS_1_7D206861DF006C83_EXECUTE_OFFSET UNITYSDK_OFFSET(0x15509530)
#define CLASS_1_7D206861DF006C83_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x15509430)
#define CLASS_1_7D206861DF006C83_METHOD_1_6E17CBFDDFD73EDB_OFFSET UNITYSDK_OFFSET(0x15509F70)
#define CLASS_1_7D206861DF006C83_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x1550A370)
#define CLASS_1_7D206861DF006C83__CTOR_OFFSET UNITYSDK_OFFSET(0x15509420)

inline static constexpr unsigned int Class_1_7D206861DF006C83_TypeDefinitionIndex = 73322;
