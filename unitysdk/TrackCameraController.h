...
#define TRACKCAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xDDB3E20)
#define TRACKCAMERACONTROLLER_INITVC_OFFSET UNITYSDK_OFFSET(0xDDB40A0)
#define TRACKCAMERACONTROLLER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xDDB4240)
#define TRACKCAMERACONTROLLER_MAPRATIOSTATIC_OFFSET UNITYSDK_OFFSET(0xDDB4C10)
#define TRACKCAMERACONTROLLER_MAPRATIO_OFFSET UNITYSDK_OFFSET(0xDDB4840)
#define TRACKCAMERACONTROLLER_METHOD_5_BC09128703DEDF98_OFFSET UNITYSDK_OFFSET(0xDDB4500)
#define TRACKCAMERACONTROLLER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xDDB4CC0)
#define TRACKCAMERACONTROLLER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xDDB4C80)
#define TRACKCAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDDB41E0)
#define TRACKCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDDB4D00)
