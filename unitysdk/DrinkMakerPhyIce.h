...
#define DRINKMAKERPHYICE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x11324FD0)
#define DRINKMAKERPHYICE_METHOD_5_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x11324490)
#define DRINKMAKERPHYICE_METHOD_5_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x11324E70)
#define DRINKMAKERPHYICE_METHOD_5_10054BB010E03EDD_OFFSET UNITYSDK_OFFSET(0x11324670)
#define DRINKMAKERPHYICE_METHOD_5_1ABF1CBED7A4AF0A_OFFSET UNITYSDK_OFFSET(0x11324B40)
#define DRINKMAKERPHYICE_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x113243A0)
#define DRINKMAKERPHYICE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x113250E0)
#define DRINKMAKERPHYICE_START_OFFSET UNITYSDK_OFFSET(0x11324210)
#define DRINKMAKERPHYICE__CTOR_OFFSET UNITYSDK_OFFSET(0x11325860)
