...
#define CLASS_1_5B567C8A01BAEDFE_75_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1BBAE910)
#define CLASS_1_5B567C8A01BAEDFE_75_CLONE_OFFSET UNITYSDK_OFFSET(0x1BBAE600)
#define CLASS_1_5B567C8A01BAEDFE_75_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1BBAE710)
#define CLASS_1_5B567C8A01BAEDFE_75_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BBAE640)
#define CLASS_1_5B567C8A01BAEDFE_75_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BBAE870)
#define CLASS_1_5B567C8A01BAEDFE_75_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1BBAE960)
#define CLASS_1_5B567C8A01BAEDFE_75_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1BBAE930)
#define CLASS_1_5B567C8A01BAEDFE_75_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1BBAE580)
#define CLASS_1_5B567C8A01BAEDFE_75_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1BBAE5B0)
#define CLASS_1_5B567C8A01BAEDFE_75_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1BBAE8A0)
#define CLASS_1_5B567C8A01BAEDFE_75_WRITETO_OFFSET UNITYSDK_OFFSET(0x1BBAE900)
#define CLASS_1_5B567C8A01BAEDFE_75__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BBAE9B0)
#define CLASS_1_5B567C8A01BAEDFE_75__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BBAE5D0)
#define CLASS_1_5B567C8A01BAEDFE_75__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBAE5C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_75*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_75_TypeDefinitionIndex)->GetStaticField(0x30330);
	}
