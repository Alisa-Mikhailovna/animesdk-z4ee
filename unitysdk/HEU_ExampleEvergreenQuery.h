...
#define HEU_EXAMPLEEVERGREENQUERY_CHANGEPARMSANDCOOK_OFFSET UNITYSDK_OFFSET(0x1982D590)
#define HEU_EXAMPLEEVERGREENQUERY_COOKASSET_OFFSET UNITYSDK_OFFSET(0x1982D570)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYATTRIBUTEBYSTORAGETYPE_OFFSET UNITYSDK_OFFSET(0x1982FCD0)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1982DF90)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYGEOPARTS_OFFSET UNITYSDK_OFFSET(0x1982ED80)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYHOUDINIASSET_OFFSET UNITYSDK_OFFSET(0x1982D380)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1982DA30)
#define HEU_EXAMPLEEVERGREENQUERY_QUERYPARTATTRIBUTEBYOWNER_OFFSET UNITYSDK_OFFSET(0x1982F550)
#define HEU_EXAMPLEEVERGREENQUERY_STARTQUERY_OFFSET UNITYSDK_OFFSET(0x1982CCF0)
#define HEU_EXAMPLEEVERGREENQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0x19830320)
