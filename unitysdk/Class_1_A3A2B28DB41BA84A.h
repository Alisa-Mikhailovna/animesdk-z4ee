...
#define CLASS_1_A3A2B28DB41BA84A_GET_ABILITYNAME_OFFSET UNITYSDK_OFFSET(0xB269710)
#define CLASS_1_A3A2B28DB41BA84A_GET_ADDPROPERTIES_OFFSET UNITYSDK_OFFSET(0xB2695F0)
#define CLASS_1_A3A2B28DB41BA84A_GET_ADDSKILLLEVELS_OFFSET UNITYSDK_OFFSET(0xB269610)
#define CLASS_1_A3A2B28DB41BA84A_GET_ANCHORTYPE_OFFSET UNITYSDK_OFFSET(0xB269650)
#define CLASS_1_A3A2B28DB41BA84A_GET_AVATARLEVELLIMIT_OFFSET UNITYSDK_OFFSET(0xB2696B0)
#define CLASS_1_A3A2B28DB41BA84A_GET_AVATARPROMOTIONLIMIT_OFFSET UNITYSDK_OFFSET(0xB2696D0)
#define CLASS_1_A3A2B28DB41BA84A_GET_DEFAULTUNLOCK_OFFSET UNITYSDK_OFFSET(0xB269690)
#define CLASS_1_A3A2B28DB41BA84A_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB2696F0)
#define CLASS_1_A3A2B28DB41BA84A_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB269770)
#define CLASS_1_A3A2B28DB41BA84A_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0xB2695C0)
#define CLASS_1_A3A2B28DB41BA84A_GET_MATERIALLIST_OFFSET UNITYSDK_OFFSET(0xB269750)
#define CLASS_1_A3A2B28DB41BA84A_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xB269670)
#define CLASS_1_A3A2B28DB41BA84A_GET_POINTDESC_OFFSET UNITYSDK_OFFSET(0xB2697B0)
#define CLASS_1_A3A2B28DB41BA84A_GET_POINTNAME_OFFSET UNITYSDK_OFFSET(0xB269790)
#define CLASS_1_A3A2B28DB41BA84A_GET_PREPOINT_OFFSET UNITYSDK_OFFSET(0xB269730)
#define CLASS_1_A3A2B28DB41BA84A_GET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0xB269630)
#define CLASS_1_A3A2B28DB41BA84A_GET_RECOMMENDPRIORITY_OFFSET UNITYSDK_OFFSET(0xB269810)
#define CLASS_1_A3A2B28DB41BA84A_GET_SIMPLEEXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB2697F0)
#define CLASS_1_A3A2B28DB41BA84A_GET_SIMPLEPOINTDESC_OFFSET UNITYSDK_OFFSET(0xB2697D0)
#define CLASS_1_A3A2B28DB41BA84A_GET_SPECIALAVATARIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xB269830)
#define CLASS_1_A3A2B28DB41BA84A_GET_SPECIALSHOWSKILL_OFFSET UNITYSDK_OFFSET(0xB269850)
#define CLASS_1_A3A2B28DB41BA84A_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xB2695D0)
#define CLASS_1_A3A2B28DB41BA84A_METHOD_1_4CA8B5F8462FA46F_OFFSET UNITYSDK_OFFSET(0xB269940)
#define CLASS_1_A3A2B28DB41BA84A_METHOD_1_71E25A039EF7FB83_OFFSET UNITYSDK_OFFSET(0xB269880)
#define CLASS_1_A3A2B28DB41BA84A_METHOD_1_968A0A3968F0CFCB_OFFSET UNITYSDK_OFFSET(0xB2698D0)
#define CLASS_1_A3A2B28DB41BA84A_SET_ABILITYNAME_OFFSET UNITYSDK_OFFSET(0xB269720)
#define CLASS_1_A3A2B28DB41BA84A_SET_ADDPROPERTIES_OFFSET UNITYSDK_OFFSET(0xB269600)
#define CLASS_1_A3A2B28DB41BA84A_SET_ADDSKILLLEVELS_OFFSET UNITYSDK_OFFSET(0xB269620)
#define CLASS_1_A3A2B28DB41BA84A_SET_ANCHORTYPE_OFFSET UNITYSDK_OFFSET(0xB269660)
#define CLASS_1_A3A2B28DB41BA84A_SET_AVATARLEVELLIMIT_OFFSET UNITYSDK_OFFSET(0xB2696C0)
#define CLASS_1_A3A2B28DB41BA84A_SET_AVATARPROMOTIONLIMIT_OFFSET UNITYSDK_OFFSET(0xB2696E0)
#define CLASS_1_A3A2B28DB41BA84A_SET_DEFAULTUNLOCK_OFFSET UNITYSDK_OFFSET(0xB2696A0)
#define CLASS_1_A3A2B28DB41BA84A_SET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB269700)
#define CLASS_1_A3A2B28DB41BA84A_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB269780)
#define CLASS_1_A3A2B28DB41BA84A_SET_MATERIALLIST_OFFSET UNITYSDK_OFFSET(0xB269760)
#define CLASS_1_A3A2B28DB41BA84A_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xB269680)
#define CLASS_1_A3A2B28DB41BA84A_SET_POINTDESC_OFFSET UNITYSDK_OFFSET(0xB2697C0)
#define CLASS_1_A3A2B28DB41BA84A_SET_POINTNAME_OFFSET UNITYSDK_OFFSET(0xB2697A0)
#define CLASS_1_A3A2B28DB41BA84A_SET_PREPOINT_OFFSET UNITYSDK_OFFSET(0xB269740)
#define CLASS_1_A3A2B28DB41BA84A_SET_PROTOTYPEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0xB269640)
#define CLASS_1_A3A2B28DB41BA84A_SET_RECOMMENDPRIORITY_OFFSET UNITYSDK_OFFSET(0xB269820)
#define CLASS_1_A3A2B28DB41BA84A_SET_SIMPLEEXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB269800)
#define CLASS_1_A3A2B28DB41BA84A_SET_SIMPLEPOINTDESC_OFFSET UNITYSDK_OFFSET(0xB2697E0)
#define CLASS_1_A3A2B28DB41BA84A_SET_SPECIALAVATARIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xB269840)
#define CLASS_1_A3A2B28DB41BA84A_SET_SPECIALSHOWSKILL_OFFSET UNITYSDK_OFFSET(0xB269860)
#define CLASS_1_A3A2B28DB41BA84A_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xB2695E0)
#define CLASS_1_A3A2B28DB41BA84A__CTOR_OFFSET UNITYSDK_OFFSET(0xB269870)
...
public:
	...
	::System::String* _SimplePointDesc_k__BackingField; // 0x28
	...
	::Il2CppArray<::System::UInt32>* _PrePoint_k__BackingField; // 0x60
	...
	::Struct_2_BC950E36747FB4C9 _PrototypeIdentifier_k__BackingField; // 0x7C
	::System::UInt32 _SpecialShowSkill_k__BackingField; // 0x84
	...
	::System::UInt32 _AvatarLevelLimit_k__BackingField; // 0x94
	::System::UInt32 _AvatarPromotionLimit_k__BackingField; // 0x98
	::System::Boolean _DefaultUnlock_k__BackingField; // 0x9C
