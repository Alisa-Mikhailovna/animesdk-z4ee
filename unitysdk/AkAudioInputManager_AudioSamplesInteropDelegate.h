...
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESINTEROPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1A1BC0)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESINTEROPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1A1C60)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESINTEROPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1A1B90)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESINTEROPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A1B20)
