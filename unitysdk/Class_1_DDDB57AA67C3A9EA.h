...
#define CLASS_1_DDDB57AA67C3A9EA_GET_DELAYCHANGEDATA_OFFSET UNITYSDK_OFFSET(0x14829DE0)
#define CLASS_1_DDDB57AA67C3A9EA_GET_PENDINGINSERTABILITYPRIORITY_OFFSET UNITYSDK_OFFSET(0x14829D00)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_107247B6331E64C6_OFFSET UNITYSDK_OFFSET(0x14829CA0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x14829F40)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x14829D20)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_38CF1CC114148ECD_OFFSET UNITYSDK_OFFSET(0x1482A040)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x14829EF0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_483ECA2AADCA9775_OFFSET UNITYSDK_OFFSET(0x14829E00)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_4E2BCE3C8705DF5E_OFFSET UNITYSDK_OFFSET(0x1482A280)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_7F99DD204643D534_OFFSET UNITYSDK_OFFSET(0x1482A8A0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x14829D80)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x1482A6A0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x1482A310)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_97F6923D7612A0EB_OFFSET UNITYSDK_OFFSET(0x1482A380)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_984AC483B8A24BF2_OFFSET UNITYSDK_OFFSET(0x1482A850)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x1482A800)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_BFC42181680DB9D3_OFFSET UNITYSDK_OFFSET(0x1482A710)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14829EA0)
#define CLASS_1_DDDB57AA67C3A9EA_METHOD_1_E7498AF04E8E685D_OFFSET UNITYSDK_OFFSET(0x1482A100)
#define CLASS_1_DDDB57AA67C3A9EA_SET_DELAYCHANGEDATA_OFFSET UNITYSDK_OFFSET(0x14829DF0)
#define CLASS_1_DDDB57AA67C3A9EA_SET_PENDINGINSERTABILITYPRIORITY_OFFSET UNITYSDK_OFFSET(0x14829D10)
#define CLASS_1_DDDB57AA67C3A9EA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1482A9C0)
#define CLASS_1_DDDB57AA67C3A9EA__CTOR_OFFSET UNITYSDK_OFFSET(0x1482A190)

inline static constexpr unsigned int Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex = 68015;
...
public:
	...
	{
		return (::RPG::GameCore::StringHash*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex)->GetStaticField(0x10650);
	}
	static ::RPG::GameCore::StringHash* StaticGet_Field_1_1()
	{
		return (::RPG::GameCore::StringHash*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex)->GetStaticField(0x10654);
	}
	static ::System::UInt32* StaticGet_Field_1_2()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_DDDB57AA67C3A9EA_TypeDefinitionIndex)->GetStaticField(0x10658);
	}
	...
	::RPG::Client::ActionItemType Field_1_10; // 0x3C
	::RPG::Client::ActionItemStatus Field_1_11; // 0x40
	::Struct_2_157CBCDCB45BE900 Field_1_12; // 0x48
