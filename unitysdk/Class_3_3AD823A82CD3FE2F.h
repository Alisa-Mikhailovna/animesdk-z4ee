...
#define CLASS_3_3AD823A82CD3FE2F_EVALUATE_OFFSET UNITYSDK_OFFSET(0x15240330)
#define CLASS_3_3AD823A82CD3FE2F__CTOR_OFFSET UNITYSDK_OFFSET(0x15240110)
...
public:
	...
	::RPG::GameCore::NPCComponent* Field_3_2; // 0x38
