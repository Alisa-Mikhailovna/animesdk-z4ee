...
#define CLASS_1_3E9A0EFA0AAE76DD_GET_BELONGID_OFFSET UNITYSDK_OFFSET(0xD051360)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_CASTERID_OFFSET UNITYSDK_OFFSET(0xD051380)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0xD051320)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_ISWHITELISTENABLE_OFFSET UNITYSDK_OFFSET(0xD051340)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_MODIFIERNAME_OFFSET UNITYSDK_OFFSET(0xD051300)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xD0513E0)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_SPECIALMARKPARAMLIST_OFFSET UNITYSDK_OFFSET(0xD051420)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_UIEFFECTPATH_OFFSET UNITYSDK_OFFSET(0xD0513A0)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_UIINDEX_OFFSET UNITYSDK_OFFSET(0xD051400)
#define CLASS_1_3E9A0EFA0AAE76DD_GET_UIMINIEFFECTPATH_OFFSET UNITYSDK_OFFSET(0xD0513C0)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_BELONGID_OFFSET UNITYSDK_OFFSET(0xD051370)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_CASTERID_OFFSET UNITYSDK_OFFSET(0xD051390)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0xD051330)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_ISWHITELISTENABLE_OFFSET UNITYSDK_OFFSET(0xD051350)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_MODIFIERNAME_OFFSET UNITYSDK_OFFSET(0xD051310)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xD0513F0)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_SPECIALMARKPARAMLIST_OFFSET UNITYSDK_OFFSET(0xD051430)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_UIEFFECTPATH_OFFSET UNITYSDK_OFFSET(0xD0513B0)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_UIINDEX_OFFSET UNITYSDK_OFFSET(0xD051410)
#define CLASS_1_3E9A0EFA0AAE76DD_SET_UIMINIEFFECTPATH_OFFSET UNITYSDK_OFFSET(0xD0513D0)
#define CLASS_1_3E9A0EFA0AAE76DD__CTOR_OFFSET UNITYSDK_OFFSET(0xD051440)

inline static constexpr unsigned int Class_1_3E9A0EFA0AAE76DD_TypeDefinitionIndex = 76054;

class Class_1_3E9A0EFA0AAE76DD : public ::System::Object
{
public:
	::System::String* _UIEffectPath_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::Class_1_39D4CC5F087AC6A7*>* _SpecialMarkParamList_k__BackingField; // 0x18
	::System::String* _ModifierName_k__BackingField; // 0x20
	::System::String* _UIMiniEffectPath_k__BackingField; // 0x28
	::System::Int32 _Priority_k__BackingField; // 0x30
	::System::UInt32 _BelongID_k__BackingField; // 0x34
