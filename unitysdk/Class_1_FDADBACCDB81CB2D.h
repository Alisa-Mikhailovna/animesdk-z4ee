...
#define CLASS_1_FDADBACCDB81CB2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A88B790)
...
public:
	...
	::RPG::GameCore::ChenLingFesPosition* Field_1_5; // 0x38
	::RPG::GameCore::ChenLingFesItemConfig* Field_1_6; // 0x40
