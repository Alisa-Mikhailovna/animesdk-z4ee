...
#define CLASS_2_F7958344C5B7C4AF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15658650)
#define CLASS_2_F7958344C5B7C4AF_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15658C80)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x15658CF0)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x15658490)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_68A2CA32DC720C44_OFFSET UNITYSDK_OFFSET(0x15658D50)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_84415F48959FD9A3_OFFSET UNITYSDK_OFFSET(0x156586D0)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_B1445E8504415D4D_OFFSET UNITYSDK_OFFSET(0x15658E60)
#define CLASS_2_F7958344C5B7C4AF_METHOD_2_BF9BB9E2BBF3B6F4_OFFSET UNITYSDK_OFFSET(0x15658780)
#define CLASS_2_F7958344C5B7C4AF_TICK_OFFSET UNITYSDK_OFFSET(0x15658C10)
#define CLASS_2_F7958344C5B7C4AF__CTOR_OFFSET UNITYSDK_OFFSET(0x15658E70)
...
public:
	...
	::RPG::GameCore::CharacterModelScaleEventParam* Field_2_1; // 0x18
	::System::Collections::Generic::Dictionary_2<::System::Single, ::System::Single>* Field_2_2; // 0x20
	::RPG::GameCore::GameEntity* Field_2_3; // 0x28
	::UnityEngine::Transform* Field_2_4; // 0x30
	::RPG::GameCore::CharacterModelComponent* Field_2_5; // 0x38
	::Class_2_F7958344C5B7C4AF_Struct_2_AD9C7534A8CF01E1_1 Field_2_6; // 0x40
