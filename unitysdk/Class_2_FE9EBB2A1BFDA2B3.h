...
#define CLASS_2_FE9EBB2A1BFDA2B3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14A8E950)
#define CLASS_2_FE9EBB2A1BFDA2B3_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14A8E990)
#define CLASS_2_FE9EBB2A1BFDA2B3_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14A8EAB0)
#define CLASS_2_FE9EBB2A1BFDA2B3_TICK_OFFSET UNITYSDK_OFFSET(0x14A8EB00)
#define CLASS_2_FE9EBB2A1BFDA2B3__CTOR_OFFSET UNITYSDK_OFFSET(0x14A8E940)
