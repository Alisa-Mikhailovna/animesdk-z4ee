...
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_18D3A646DDD61291_OFFSET UNITYSDK_OFFSET(0xB1EFD30)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xB1F08F0)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_D737CD2779D51A4E_OFFSET UNITYSDK_OFFSET(0xB1EFBF0)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xB1EF8F0)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_F83AAA65B6159C8A_OFFSET UNITYSDK_OFFSET(0xB1F0520)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_FDC478E941B91C50_OFFSET UNITYSDK_OFFSET(0xB1F0940)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT__CCTOR_OFFSET UNITYSDK_OFFSET(0xB1F0B90)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xB1F0B80)
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(MonoProgramMatrixTransferAnim_PCGUnit_TypeDefinitionIndex)->GetStaticField(0x5F6F0);
	}
