...
#define CLASS_3_CEF86C33D203CEB1__PERSISTENTLOAD_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x149FD9E0)
#define CLASS_3_CEF86C33D203CEB1__PERSISTENTLOAD_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x149FDC30)
#define CLASS_3_CEF86C33D203CEB1__PERSISTENTLOAD_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x149FDC90)
#define CLASS_3_CEF86C33D203CEB1__PERSISTENTLOAD_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x149FDC40)
#define CLASS_3_CEF86C33D203CEB1__PERSISTENTLOAD_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x149FD9D0)
#define CLASS_3_CEF86C33D203CEB1__PERSISTENTLOAD_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x149FCE70)

inline static constexpr unsigned int Class_3_CEF86C33D203CEB1__PersistentLoad_d__2_TypeDefinitionIndex = 70492;
