...
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x864F0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_1D9EE327BF7D6281_OFFSET UNITYSDK_OFFSET(0x86540)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_26874F67BD92CEC1_OFFSET UNITYSDK_OFFSET(0xB39D360)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_2F0F99A12DB93F30_OFFSET UNITYSDK_OFFSET(0xB3967D0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_3848E4903F0CA4C5_OFFSET UNITYSDK_OFFSET(0xB397490)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x865F0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_428BD246F5FAAA99_OFFSET UNITYSDK_OFFSET(0x865D0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_4F3148D4BAAF81F3_OFFSET UNITYSDK_OFFSET(0xB3976A0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x86500)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_77C7045E7324E8B8_OFFSET UNITYSDK_OFFSET(0xB3970A0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_78D5E0A1A0AC9949_OFFSET UNITYSDK_OFFSET(0xB39D850)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_85C81563BC6E2A2E_OFFSET UNITYSDK_OFFSET(0xB397A10)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0x86520)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_89A99D29D0BEDD89_OFFSET UNITYSDK_OFFSET(0x86510)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_9CFA7241D1009D47_OFFSET UNITYSDK_OFFSET(0x864D0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_AC6B8E73BD3BD222_OFFSET UNITYSDK_OFFSET(0x86550)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_AFD95DA10D1573F3_OFFSET UNITYSDK_OFFSET(0x865E0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_B799DB9989A18F1D_OFFSET UNITYSDK_OFFSET(0xB39D5F0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_C0FF32B4D2022F8C_OFFSET UNITYSDK_OFFSET(0xB39D6E0)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x86600)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_F5919FB9FE5456D1_OFFSET UNITYSDK_OFFSET(0xB396A90)
#define STRUCT_2_FB7FD3F7A6A85D5E_METHOD_2_F620DD2FD48DDF53_OFFSET UNITYSDK_OFFSET(0x86530)
#define STRUCT_2_FB7FD3F7A6A85D5E__CCTOR_OFFSET UNITYSDK_OFFSET(0xB39E170)
#define STRUCT_2_FB7FD3F7A6A85D5E__CTOR_OFFSET UNITYSDK_OFFSET(0x864E0)
...
struct alignas(8) Struct_2_FB7FD3F7A6A85D5E
{
	...
	{
		return (::UnityEngine::Camera**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x49920);
	}
	static ::RPG::Client::RefList_1<::Struct_2_FB7FD3F7A6A85D5E>** StaticGet_Field_2_1()
	{
		return (::RPG::Client::RefList_1<::Struct_2_FB7FD3F7A6A85D5E>**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x49928);
	}
	static ::RPG::Client::EnvironmentSystem** StaticGet_Field_2_2()
	{
		return (::RPG::Client::EnvironmentSystem**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0x49930);
	}
	static ::System::Single* StaticGet_Field_2_3()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_FB7FD3F7A6A85D5E_TypeDefinitionIndex)->GetStaticField(0xC610);
	}
