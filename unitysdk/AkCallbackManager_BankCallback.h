...
#define AKCALLBACKMANAGER_BANKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D1AE390)
#define AKCALLBACKMANAGER_BANKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D1AE430)
#define AKCALLBACKMANAGER_BANKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D1A8B60)
#define AKCALLBACKMANAGER_BANKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AE320)
