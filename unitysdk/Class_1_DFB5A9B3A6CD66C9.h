...
#define CLASS_1_DFB5A9B3A6CD66C9_ADD_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x14624110)
#define CLASS_1_DFB5A9B3A6CD66C9_ADD_ONPLANCHANGED_OFFSET UNITYSDK_OFFSET(0x14624040)
#define CLASS_1_DFB5A9B3A6CD66C9_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x14624100)
#define CLASS_1_DFB5A9B3A6CD66C9_METHOD_1_0AB718BEE9EA06D7_OFFSET UNITYSDK_OFFSET(0x14624700)
#define CLASS_1_DFB5A9B3A6CD66C9_METHOD_1_5110E061C0DF5692_OFFSET UNITYSDK_OFFSET(0x14624490)
#define CLASS_1_DFB5A9B3A6CD66C9_METHOD_1_9636FCCD0F2A7398_OFFSET UNITYSDK_OFFSET(0x14623F40)
#define CLASS_1_DFB5A9B3A6CD66C9_METHOD_1_9EFCD41280934CE0_1_OFFSET UNITYSDK_OFFSET(0x14624670)
#define CLASS_1_DFB5A9B3A6CD66C9_METHOD_1_9EFCD41280934CE0_OFFSET UNITYSDK_OFFSET(0x14624230)
#define CLASS_1_DFB5A9B3A6CD66C9_METHOD_1_CF467815C3AD4755_OFFSET UNITYSDK_OFFSET(0x14624780)
#define CLASS_1_DFB5A9B3A6CD66C9_METHOD_1_DCD7862A729EBDDD_OFFSET UNITYSDK_OFFSET(0x146242C0)
#define CLASS_1_DFB5A9B3A6CD66C9_METHOD_1_E73A89A53EDEB864_OFFSET UNITYSDK_OFFSET(0x146245E0)
#define CLASS_1_DFB5A9B3A6CD66C9_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x14623F00)
#define CLASS_1_DFB5A9B3A6CD66C9_REMOVE_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x14624170)
#define CLASS_1_DFB5A9B3A6CD66C9_REMOVE_ONPLANCHANGED_OFFSET UNITYSDK_OFFSET(0x146240A0)
#define CLASS_1_DFB5A9B3A6CD66C9__CTOR_OFFSET UNITYSDK_OFFSET(0x146241D0)

inline static constexpr unsigned int Class_1_DFB5A9B3A6CD66C9_TypeDefinitionIndex = 76514;

class Class_1_DFB5A9B3A6CD66C9 : public ::System::Object
{
public:
	::System::Action* OnChanged; // 0x10
	::Class_1_F963C9FA5FC80637* Field_1_1; // 0x18
	::Class_0_16E4307DCC419505_1312* Field_1_2; // 0x20
