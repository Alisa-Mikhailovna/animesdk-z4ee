...
#define CLASS_5_B325BF975C84A0DD_CLONE_OFFSET UNITYSDK_OFFSET(0xB556340)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_0F40AA2B6B209CD5_OFFSET UNITYSDK_OFFSET(0xB556010)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_4D3B75704BF58A94_OFFSET UNITYSDK_OFFSET(0xB556480)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_6AA0A5D7371B5A80_OFFSET UNITYSDK_OFFSET(0xB556240)
#define CLASS_5_B325BF975C84A0DD_METHOD_5_AE41BEE50A44D918_OFFSET UNITYSDK_OFFSET(0xB556530)
#define CLASS_5_B325BF975C84A0DD_REVERSE_OFFSET UNITYSDK_OFFSET(0xB5563E0)
#define CLASS_5_B325BF975C84A0DD_STARTWITHTARGET_OFFSET UNITYSDK_OFFSET(0xB5562F0)
#define CLASS_5_B325BF975C84A0DD__CTOR_OFFSET UNITYSDK_OFFSET(0xB555FE0)

inline static constexpr unsigned int Class_5_B325BF975C84A0DD_TypeDefinitionIndex = 70153;

class Class_5_B325BF975C84A0DD : public ::Class_4_0781C886C58F298A
{
public:
	::System::Single Field_5_0; // 0x48
	::UnityEngine::Color Field_5_1; // 0x4C
