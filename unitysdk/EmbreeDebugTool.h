...
#define EMBREEDEBUGTOOL_CALCULATESCENEBOUNDS_OFFSET UNITYSDK_OFFSET(0xA9EEC60)
#define EMBREEDEBUGTOOL_CASTRAYGRID_OFFSET UNITYSDK_OFFSET(0xA9EEE70)
#define EMBREEDEBUGTOOL_CLEANUP_OFFSET UNITYSDK_OFFSET(0xA9EEB80)
#define EMBREEDEBUGTOOL_EXECUTEDEBUG_OFFSET UNITYSDK_OFFSET(0xA9EE1C0)
#define EMBREEDEBUGTOOL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA9F0D20)
#define EMBREEDEBUGTOOL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA9F0E00)
#define EMBREEDEBUGTOOL_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xA9F0170)
#define EMBREEDEBUGTOOL_PRINTRESULTS_OFFSET UNITYSDK_OFFSET(0xA9EFD50)
#define EMBREEDEBUGTOOL__CTOR_OFFSET UNITYSDK_OFFSET(0xA9F0EE0)
