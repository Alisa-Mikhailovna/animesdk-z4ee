...
#define CLASS_1_B019EAD7E127C874_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C18B3C0)
#define CLASS_1_B019EAD7E127C874_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1C18AE90)
#define CLASS_1_B019EAD7E127C874_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C18B070)
#define CLASS_1_B019EAD7E127C874_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C18AFD0)
#define CLASS_1_B019EAD7E127C874_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C18B0C0)
#define CLASS_1_B019EAD7E127C874_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C18B720)
#define CLASS_1_B019EAD7E127C874_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C18B6C0)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1C18AF30)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1C18AF50)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_02A3D10A9D535169_3_OFFSET UNITYSDK_OFFSET(0x1C18AF70)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_02A3D10A9D535169_4_OFFSET UNITYSDK_OFFSET(0x1C18AF90)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_02A3D10A9D535169_5_OFFSET UNITYSDK_OFFSET(0x1C18AFB0)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C18AF10)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C18ADD0)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1C18AF40)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1C18AF60)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_7786DC814C2FC3BE_3_OFFSET UNITYSDK_OFFSET(0x1C18AF80)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_7786DC814C2FC3BE_4_OFFSET UNITYSDK_OFFSET(0x1C18AFA0)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_7786DC814C2FC3BE_5_OFFSET UNITYSDK_OFFSET(0x1C18AFC0)
#define CLASS_1_B019EAD7E127C874_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C18AF20)
#define CLASS_1_B019EAD7E127C874_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C18AE30)
#define CLASS_1_B019EAD7E127C874_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C18B110)
#define CLASS_1_B019EAD7E127C874_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C18B170)
#define CLASS_1_B019EAD7E127C874_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C18B7E0)
#define CLASS_1_B019EAD7E127C874_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C18AE50)
#define CLASS_1_B019EAD7E127C874_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C18AE40)

inline static constexpr unsigned int Class_1_B019EAD7E127C874_1_TypeDefinitionIndex = 26342;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B019EAD7E127C874_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B019EAD7E127C874_1_TypeDefinitionIndex)->GetStaticField(0x23710);
	}
