...
#define CLASS_1_F1A0CB87ADEC1771_CLASS_1_D2CF375D5CBE026A__CTOR_OFFSET UNITYSDK_OFFSET(0xBAA0320)
...
{
public:
	::Class_1_E0103A0EA6CD0F4C* Field_1_0; // 0x10
	::RPG::GameCore::LittleGameLevelConfig* Field_1_1; // 0x18
	::RPG::GameCore::GameEntity* Field_1_2; // 0x20
	::Class_1_EE559462F37DF929* Field_1_3; // 0x28
