...
#define CLASS_2_A70CAB2D313ACC44_METHOD_2_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xB480BF0)
#define CLASS_2_A70CAB2D313ACC44_METHOD_2_2DCDFF29E7FDDAA8_OFFSET UNITYSDK_OFFSET(0xB480B40)
#define CLASS_2_A70CAB2D313ACC44_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xB481060)
#define CLASS_2_A70CAB2D313ACC44_METHOD_2_5A124CAF1E48B74F_OFFSET UNITYSDK_OFFSET(0xB480D30)
#define CLASS_2_A70CAB2D313ACC44_METHOD_2_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0xB480AE0)
#define CLASS_2_A70CAB2D313ACC44_METHOD_2_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0xB480FB0)
#define CLASS_2_A70CAB2D313ACC44_METHOD_2_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0xB480F00)
#define CLASS_2_A70CAB2D313ACC44__CTOR_OFFSET UNITYSDK_OFFSET(0xB4810B0)
#define CLASS_2_A70CAB2D313ACC44__ONBIND_OFFSET UNITYSDK_OFFSET(0xB480820)

inline static constexpr unsigned int Class_2_A70CAB2D313ACC44_TypeDefinitionIndex = 68608;

class Class_2_A70CAB2D313ACC44 : public ::Class_1_CA217ABF4E3B4F3F
{
public:
	::RPG::Client::SPProgress* Field_2_0; // 0x60
	::Class_1_F1011C1DB6F9F51A* Field_2_1; // 0x68
	::UnityEngine::Transform* Field_2_2; // 0x70
	::System::Collections::Generic::List_1<::Class_2_C23DD4758FBF845D*>* Field_2_3; // 0x78
