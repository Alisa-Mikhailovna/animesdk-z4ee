...
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C9040D0)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIMPLEJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C904160)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIMPLEJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C9040F0)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C9041D0)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C904150)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C904100)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C9040C0)
#define SIMPLEJSON_JSONNODE__GET_CHILDS_D__27__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8FE530)
