...
#define CLASS_1_B68CA618BEA3A2C8_GET_MINIEMOSTECILINDEX_OFFSET UNITYSDK_OFFSET(0xAD12CE0)
#define CLASS_1_B68CA618BEA3A2C8_GET_STENCILEYE_OFFSET UNITYSDK_OFFSET(0xAD12CC0)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0xAD13220)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_3EF33FD8BF224359_OFFSET UNITYSDK_OFFSET(0xAD12D50)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_461D639BFE49CBBC_OFFSET UNITYSDK_OFFSET(0xAD128D0)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_6173AF17811AED4B_OFFSET UNITYSDK_OFFSET(0xAD134D0)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xAD11A80)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0xAD11E10)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_862892C9E9B0CA20_OFFSET UNITYSDK_OFFSET(0xAD12670)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_94C81405F83348DF_OFFSET UNITYSDK_OFFSET(0xAD12020)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_A07C2061B55C1547_OFFSET UNITYSDK_OFFSET(0xAD11A20)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xAD11BE0)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAD12610)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0xAD12EB0)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_ED51C46008DA43B8_OFFSET UNITYSDK_OFFSET(0xAD13380)
#define CLASS_1_B68CA618BEA3A2C8_METHOD_1_F2B1D94CC79A43C5_OFFSET UNITYSDK_OFFSET(0xAD12D00)
#define CLASS_1_B68CA618BEA3A2C8_SET_MINIEMOSTECILINDEX_OFFSET UNITYSDK_OFFSET(0xAD12CF0)
#define CLASS_1_B68CA618BEA3A2C8_SET_STENCILEYE_OFFSET UNITYSDK_OFFSET(0xAD12CD0)
#define CLASS_1_B68CA618BEA3A2C8__CCTOR_OFFSET UNITYSDK_OFFSET(0xAD13520)
#define CLASS_1_B68CA618BEA3A2C8__CTOR_OFFSET UNITYSDK_OFFSET(0xAD11A10)
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B68CA618BEA3A2C8_TypeDefinitionIndex)->GetStaticField(0x7320);
	}
	static ::System::Int32* StaticGet_Field_1_1()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B68CA618BEA3A2C8_TypeDefinitionIndex)->GetStaticField(0x7324);
	}
	static ::System::Int32* StaticGet_Field_1_2()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B68CA618BEA3A2C8_TypeDefinitionIndex)->GetStaticField(0x7328);
	}
	static ::System::Int32* StaticGet_Field_1_3()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B68CA618BEA3A2C8_TypeDefinitionIndex)->GetStaticField(0x732C);
	}
	static ::System::Int32* StaticGet_Field_1_4()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_1_B68CA618BEA3A2C8_TypeDefinitionIndex)->GetStaticField(0x7330);
	}
