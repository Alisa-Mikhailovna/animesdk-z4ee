...
#define CLASS_1_5B567C8A01BAEDFE_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C23F3C0)
#define CLASS_1_5B567C8A01BAEDFE_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1C23F060)
#define CLASS_1_5B567C8A01BAEDFE_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C23F1C0)
#define CLASS_1_5B567C8A01BAEDFE_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C23F0D0)
#define CLASS_1_5B567C8A01BAEDFE_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C23F320)
#define CLASS_1_5B567C8A01BAEDFE_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C23F410)
#define CLASS_1_5B567C8A01BAEDFE_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C23F3E0)
#define CLASS_1_5B567C8A01BAEDFE_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C23EFB0)
#define CLASS_1_5B567C8A01BAEDFE_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C23F010)
#define CLASS_1_5B567C8A01BAEDFE_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C23F350)
#define CLASS_1_5B567C8A01BAEDFE_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C23F3B0)
#define CLASS_1_5B567C8A01BAEDFE_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C23F460)
#define CLASS_1_5B567C8A01BAEDFE_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C23F030)
#define CLASS_1_5B567C8A01BAEDFE_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23F020)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_1_TypeDefinitionIndex)->GetStaticField(0x2C3E0);
	}
