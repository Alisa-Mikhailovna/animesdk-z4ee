...
#define CLASS_1_5B567C8A01BAEDFE_38_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C797C30)
#define CLASS_1_5B567C8A01BAEDFE_38_CLONE_OFFSET UNITYSDK_OFFSET(0x1C797920)
#define CLASS_1_5B567C8A01BAEDFE_38_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C797A30)
#define CLASS_1_5B567C8A01BAEDFE_38_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C797960)
#define CLASS_1_5B567C8A01BAEDFE_38_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C797B90)
#define CLASS_1_5B567C8A01BAEDFE_38_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C797C80)
#define CLASS_1_5B567C8A01BAEDFE_38_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C797C50)
#define CLASS_1_5B567C8A01BAEDFE_38_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C7978A0)
#define CLASS_1_5B567C8A01BAEDFE_38_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C7978D0)
#define CLASS_1_5B567C8A01BAEDFE_38_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C797BC0)
#define CLASS_1_5B567C8A01BAEDFE_38_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C797C20)
#define CLASS_1_5B567C8A01BAEDFE_38__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C797CD0)
#define CLASS_1_5B567C8A01BAEDFE_38__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C7978F0)
#define CLASS_1_5B567C8A01BAEDFE_38__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7978E0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_38*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_38_TypeDefinitionIndex)->GetStaticField(0x1AF00);
	}
