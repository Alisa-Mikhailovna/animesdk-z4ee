...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15796A70)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15796C50)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15796CB0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15796C60)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15796A60)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH__SINGLEORDOUBLE_D__236__CTOR_OFFSET UNITYSDK_OFFSET(0x1578FC20)
