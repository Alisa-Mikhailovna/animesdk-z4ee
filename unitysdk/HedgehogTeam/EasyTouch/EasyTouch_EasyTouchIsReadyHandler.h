...
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_EASYTOUCHISREADYHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x157977E0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_EASYTOUCHISREADYHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15797810)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_EASYTOUCHISREADYHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1578ADE0)
#define HEDGEHOGTEAM_EASYTOUCH_EASYTOUCH_EASYTOUCHISREADYHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15797770)
