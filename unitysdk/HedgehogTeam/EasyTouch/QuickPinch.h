...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_DOACTION_OFFSET UNITYSDK_OFFSET(0x157A3AD0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x157A3AA0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x157A36F0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x157A3350)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ON_PICHEND_OFFSET UNITYSDK_OFFSET(0x157A3D60)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ON_PINCHIN_OFFSET UNITYSDK_OFFSET(0x157A3D20)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ON_PINCHOUT_OFFSET UNITYSDK_OFFSET(0x157A3D40)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_ON_PINCH_OFFSET UNITYSDK_OFFSET(0x157A3AB0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x157A3700)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKPINCH__CTOR_OFFSET UNITYSDK_OFFSET(0x157A32C0)
