...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1579F980)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE_DISABLEDALLSWIPEEXCEPTED_OFFSET UNITYSDK_OFFSET(0x157A08B0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE_DISABLEDQUICKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x157A0750)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE_DODIRECTACTION_OFFSET UNITYSDK_OFFSET(0x157A0140)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE_ENABLEDQUICKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x157A05F0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE_GETINFLUENCEDAXIS_OFFSET UNITYSDK_OFFSET(0x157A00E0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x157A00D0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x157A00C0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE_START_OFFSET UNITYSDK_OFFSET(0x1579FAC0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x157A0A60)
