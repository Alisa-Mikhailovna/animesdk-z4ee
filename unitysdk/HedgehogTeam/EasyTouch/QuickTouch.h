...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTOUCH_DOACTION_OFFSET UNITYSDK_OFFSET(0x157A54D0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTOUCH_ISOVERME_OFFSET UNITYSDK_OFFSET(0x157A5350)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTOUCH_UPDATE_OFFSET UNITYSDK_OFFSET(0x157A4F30)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKTOUCH__CTOR_OFFSET UNITYSDK_OFFSET(0x157A4EA0)
