...
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_AWAKE_OFFSET UNITYSDK_OFFSET(0x157A2290)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x157A2730)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x157A2520)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x157A2320)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ON_TOUCHDOWN_OFFSET UNITYSDK_OFFSET(0x157A2740)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_ON_TOUCHUP_OFFSET UNITYSDK_OFFSET(0x157A2BA0)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST_UNSUBSCRIBEEVENT_OFFSET UNITYSDK_OFFSET(0x157A2530)
#define HEDGEHOGTEAM_EASYTOUCH_QUICKENTEROVEREXIST__CTOR_OFFSET UNITYSDK_OFFSET(0x157A21F0)
