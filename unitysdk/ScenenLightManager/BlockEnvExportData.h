...
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0xDD403B0)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_METHOD_3_9A948BCE6757BD75_OFFSET UNITYSDK_OFFSET(0xDD403C0)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_METHOD_3_9B4CB6A2D6A8932F_OFFSET UNITYSDK_OFFSET(0xDD413D0)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA_METHOD_3_A7255BF3487CAEB2_OFFSET UNITYSDK_OFFSET(0xDD41960)
#define SCENENLIGHTMANAGER_BLOCKENVEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDD40220)
