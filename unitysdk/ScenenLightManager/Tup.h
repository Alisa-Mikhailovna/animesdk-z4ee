...
#define SCENENLIGHTMANAGER_TUP_EQUALS_OFFSET UNITYSDK_OFFSET(0xDD458A0)
#define SCENENLIGHTMANAGER_TUP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xDD45940)
#define SCENENLIGHTMANAGER_TUP_METHOD_1_AF094A37CE984E72_OFFSET UNITYSDK_OFFSET(0xDD45920)
#define SCENENLIGHTMANAGER_TUP__CTOR_OFFSET UNITYSDK_OFFSET(0xDD45890)
