...
#define SCENENLIGHTMANAGER_LIGHTINSTANCEID_EQUALS_OFFSET UNITYSDK_OFFSET(0x158DC0)
#define SCENENLIGHTMANAGER_LIGHTINSTANCEID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x158E40)
#define SCENENLIGHTMANAGER_LIGHTINSTANCEID_METHOD_2_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x5AA0)
#define SCENENLIGHTMANAGER_LIGHTINSTANCEID_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x30170)
#define SCENENLIGHTMANAGER_LIGHTINSTANCEID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x158E50)
#define SCENENLIGHTMANAGER_LIGHTINSTANCEID__CCTOR_OFFSET UNITYSDK_OFFSET(0xDD42FB0)
#define SCENENLIGHTMANAGER_LIGHTINSTANCEID__CTOR_1_OFFSET UNITYSDK_OFFSET(0x158D90)
...
namespace ScenenLightManager
{
	...
	struct alignas(8) LightInstanceID
	{
		...
		{
			return (::ScenenLightManager::LightInstanceID*)Il2CppClass::FromTypeDefinitionIndex(LightInstanceID_TypeDefinitionIndex)->GetStaticField(0x11B70);
		}
