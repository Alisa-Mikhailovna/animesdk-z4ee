...
#define SCENENLIGHTMANAGER_LIGHTSETQUALITYEXPORTDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0xDD44700)
#define SCENENLIGHTMANAGER_LIGHTSETQUALITYEXPORTDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xDD449E0)
#define SCENENLIGHTMANAGER_LIGHTSETQUALITYEXPORTDATA_METHOD_1_9C442F1EEC673542_OFFSET UNITYSDK_OFFSET(0xDD44440)
#define SCENENLIGHTMANAGER_LIGHTSETQUALITYEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDD443D0)
