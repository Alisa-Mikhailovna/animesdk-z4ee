...
#define SCENENLIGHTMANAGER_LOADBLOCKDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0xDD44DA0)
#define SCENENLIGHTMANAGER_LOADBLOCKDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xDD44E40)
#define SCENENLIGHTMANAGER_LOADBLOCKDATA_METHOD_1_277FDD755CB452A1_OFFSET UNITYSDK_OFFSET(0xDD44D50)
#define SCENENLIGHTMANAGER_LOADBLOCKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDD44D40)
