...
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0xDD43320)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xDD43630)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA_METHOD_1_922FB2A73E3CC6C9_OFFSET UNITYSDK_OFFSET(0xDD43030)
#define SCENENLIGHTMANAGER_LIGHTSETEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDD42FC0)
