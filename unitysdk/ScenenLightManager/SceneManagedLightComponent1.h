...
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_GETQUALITYFILTER_OFFSET UNITYSDK_OFFSET(0xDD45660)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_GET_LIGHTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xDD455C0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xDD45700)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xDD45710)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONBEGINSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xDD456A0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONBEGINSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0xDD456D0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONENDSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xDD456B0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONENDSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0xDD456E0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONSCENELIGHTFADING_OFFSET UNITYSDK_OFFSET(0xDD45690)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONSCENELIGHTLODFADING_OFFSET UNITYSDK_OFFSET(0xDD456C0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONSETSCENELIGHTLOD_OFFSET UNITYSDK_OFFSET(0xDD456F0)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONTURNOFF_OFFSET UNITYSDK_OFFSET(0xDD45680)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1_ONTURNON_OFFSET UNITYSDK_OFFSET(0xDD45670)
#define SCENENLIGHTMANAGER_SCENEMANAGEDLIGHTCOMPONENT1__CTOR_OFFSET UNITYSDK_OFFSET(0xDD45720)
