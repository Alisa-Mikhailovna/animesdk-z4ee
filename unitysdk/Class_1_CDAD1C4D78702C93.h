...
#define CLASS_1_CDAD1C4D78702C93_GET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0xF1DE210)
#define CLASS_1_CDAD1C4D78702C93_GET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0xF1DE080)
#define CLASS_1_CDAD1C4D78702C93_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xF1DE140)
#define CLASS_1_CDAD1C4D78702C93_GET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0xF1DE230)
#define CLASS_1_CDAD1C4D78702C93_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xF1DE0E0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0xF1DE120)
#define CLASS_1_CDAD1C4D78702C93_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0xF1DE0C0)
#define CLASS_1_CDAD1C4D78702C93_GET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0xF1DE100)
#define CLASS_1_CDAD1C4D78702C93_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xF1DE160)
#define CLASS_1_CDAD1C4D78702C93_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xF1DE0A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_1_OFFSET UNITYSDK_OFFSET(0xF1DAA10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0xF1DA9D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0xF1DD620)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_07A25883744F618C_OFFSET UNITYSDK_OFFSET(0xF1DBA90)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1658BEB5EC339408_OFFSET UNITYSDK_OFFSET(0xF1DCB10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_1_OFFSET UNITYSDK_OFFSET(0xF1D9D50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xF1D9CF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0xF1DB920)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xF1DB8C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_2045BA2947DBDBCE_OFFSET UNITYSDK_OFFSET(0xF1DD2E0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0xF1DE260)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0xF1DD500)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xF1DE1D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3A9C03366E936C66_OFFSET UNITYSDK_OFFSET(0xF1DCC70)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_3F5F0BE9AFB2990C_OFFSET UNITYSDK_OFFSET(0xF1DAE60)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xF1DA5C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_460F8AE6EF9687FD_OFFSET UNITYSDK_OFFSET(0xF1DDC50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_46D5C4F0EA172C6A_OFFSET UNITYSDK_OFFSET(0xF1DB760)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_48D5431F83972562_OFFSET UNITYSDK_OFFSET(0xF1DBCF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_4E66CC6A96439F85_OFFSET UNITYSDK_OFFSET(0xF1DB290)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_5D895A5456A4B9BA_OFFSET UNITYSDK_OFFSET(0xF1DB840)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_60A0F5EC9777EFB9_OFFSET UNITYSDK_OFFSET(0xF1DA4F0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_1_OFFSET UNITYSDK_OFFSET(0xF1DAAE0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_2_OFFSET UNITYSDK_OFFSET(0xF1DABC0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_3_OFFSET UNITYSDK_OFFSET(0xF1DAC50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_4_OFFSET UNITYSDK_OFFSET(0xF1DB300)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_5_OFFSET UNITYSDK_OFFSET(0xF1DD9D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_6105334A729F22E3_OFFSET UNITYSDK_OFFSET(0xF1DAA50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_684E8D76BF9D5255_OFFSET UNITYSDK_OFFSET(0xF1DD5E0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7301533EE4FBBAD2_OFFSET UNITYSDK_OFFSET(0xF1DB1A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7F612AA2F04984D6_OFFSET UNITYSDK_OFFSET(0xF1DE250)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_7F84ACCEA43BC283_OFFSET UNITYSDK_OFFSET(0xF1DC6A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_81D7D1157E92B61D_OFFSET UNITYSDK_OFFSET(0xF1DD6C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0xF1DD470)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_86914B28476494AF_OFFSET UNITYSDK_OFFSET(0xF1DC440)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96347D126BE5AFBC_OFFSET UNITYSDK_OFFSET(0xF1DDD50)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xF1DD940)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_96DCADC783ACF0D4_OFFSET UNITYSDK_OFFSET(0xF1DBFD0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_9C66B07446448FC6_OFFSET UNITYSDK_OFFSET(0xF1DB390)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A03C765EBC5D1677_OFFSET UNITYSDK_OFFSET(0xF1DDA80)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xF1DE180)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_AF001DB8752C7089_OFFSET UNITYSDK_OFFSET(0xF1DB500)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_AF769CD15806BD66_OFFSET UNITYSDK_OFFSET(0xF1DDB10)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B0C9E67798485BC6_OFFSET UNITYSDK_OFFSET(0xF1DC560)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xF1DD8C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B2A8785E9E1BD2C1_OFFSET UNITYSDK_OFFSET(0xF1DAFF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B3895AA881B3EBB9_OFFSET UNITYSDK_OFFSET(0xF1DB980)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_B7D0EA531AB98E94_OFFSET UNITYSDK_OFFSET(0xF1DA020)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BA904CAFF6C7217F_OFFSET UNITYSDK_OFFSET(0xF1DA440)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_BC46FCF99873D9DD_OFFSET UNITYSDK_OFFSET(0xF1DA620)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C411E5881DF297DE_OFFSET UNITYSDK_OFFSET(0xF1DAEE0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_1_OFFSET UNITYSDK_OFFSET(0xF1DB120)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_C98BEB16ED641BC0_OFFSET UNITYSDK_OFFSET(0xF1DB0A0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xF1DD680)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xF1DB7C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_1_OFFSET UNITYSDK_OFFSET(0xF1DBE80)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xF1DBDB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CAAD3899EE103AC7_OFFSET UNITYSDK_OFFSET(0xF1D91C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0xF1DA660)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xF1DA6D0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_1_OFFSET UNITYSDK_OFFSET(0xF1DBF40)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_CF0080D9D0A33EA9_OFFSET UNITYSDK_OFFSET(0xF1DBA00)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D87A7D8243E04FD7_OFFSET UNITYSDK_OFFSET(0xF1D9DB0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_D920CA000FAB6C31_OFFSET UNITYSDK_OFFSET(0xF1DC200)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_DDF4E6AEE2216B17_OFFSET UNITYSDK_OFFSET(0xF1DB700)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E559D5212FA999BC_OFFSET UNITYSDK_OFFSET(0xF1DAD30)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7E9C69965F5C461_OFFSET UNITYSDK_OFFSET(0xF1DB5C0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_E7F61176CF07E702_OFFSET UNITYSDK_OFFSET(0xF1DAF80)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0xF1DA880)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0xF1DBEF0)
#define CLASS_1_CDAD1C4D78702C93_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xF1DBE20)
#define CLASS_1_CDAD1C4D78702C93_SET_AXISVALUEXCHANGESPEED_OFFSET UNITYSDK_OFFSET(0xF1DE220)
#define CLASS_1_CDAD1C4D78702C93_SET_CAMERATYPE_OFFSET UNITYSDK_OFFSET(0xF1DE090)
#define CLASS_1_CDAD1C4D78702C93_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xF1DE150)
#define CLASS_1_CDAD1C4D78702C93_SET_FREELOOKDRAGMODE_OFFSET UNITYSDK_OFFSET(0xF1DE240)
#define CLASS_1_CDAD1C4D78702C93_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xF1DE0F0)
#define CLASS_1_CDAD1C4D78702C93_SET_ISAVAILABLEFORREUSE_OFFSET UNITYSDK_OFFSET(0xF1DE130)
#define CLASS_1_CDAD1C4D78702C93_SET_ISCREATED_OFFSET UNITYSDK_OFFSET(0xF1DE0D0)
#define CLASS_1_CDAD1C4D78702C93_SET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0xF1DE110)
#define CLASS_1_CDAD1C4D78702C93_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xF1DE170)
#define CLASS_1_CDAD1C4D78702C93_SET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xF1DE0B0)
#define CLASS_1_CDAD1C4D78702C93__CTOR_OFFSET UNITYSDK_OFFSET(0xF1D91A0)
...
{
public:
	::RPG::Client::RPGCinemachineZoom* Field_1_0; // 0x10
	::UnityEngine::GameObject* Field_1_1; // 0x18
	::RPG::Client::RPGCinemachineCorrectionExtension* Field_1_2; // 0x20
	::Class_1_7ACD8E31992CDE1A* Field_1_3; // 0x28
	::RPG::Client::RPGCinemachineOldFreelook3rdBlend* Field_1_4; // 0x30
	::UnityEngine::Transform* _FollowTarget_k__BackingField; // 0x38
	::UnityEngine::GameObject* Field_1_6; // 0x40
	::RPG::Client::CameraBlendCurve* Field_1_7; // 0x48
	::UnityEngine::Transform* _LookAtTarget_k__BackingField; // 0x50
	::Cinemachine::CinemachineFreeLook* Field_1_9; // 0x58
	...
	::System::Boolean _FreelookDragMode_k__BackingField; // 0x6D
	::System::Boolean _IsAvailableForReuse_k__BackingField; // 0x6E
	::System::Nullable_1<::UnityEngine::Vector2> Field_1_16; // 0x70
	...
	::System::Boolean _IsDestroyed_k__BackingField; // 0x8D
	::System::Boolean _IsActive_k__BackingField; // 0x8E
	::System::Boolean _IsCreated_k__BackingField; // 0x8F
	::System::UInt32 _RuntimeID_k__BackingField; // 0x90
	::System::Nullable_1<::UnityEngine::Vector2> Field_1_26; // 0x94
