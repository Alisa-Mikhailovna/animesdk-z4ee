...
#define IFIX_CORE_CALL_BEGINFORSTACK_OFFSET UNITYSDK_OFFSET(0x1992CB40)
#define IFIX_CORE_CALL_BEGIN_OFFSET UNITYSDK_OFFSET(0x1992C250)
#define IFIX_CORE_CALL_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x2EA08C0)
#define IFIX_CORE_CALL_GETBYTE_OFFSET UNITYSDK_OFFSET(0x2EA08F0)
#define IFIX_CORE_CALL_GETCHAR_OFFSET UNITYSDK_OFFSET(0x2EA0950)
#define IFIX_CORE_CALL_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x2EA0B00)
#define IFIX_CORE_CALL_GETINT16_OFFSET UNITYSDK_OFFSET(0x2EA0950)
#define IFIX_CORE_CALL_GETINT32_OFFSET UNITYSDK_OFFSET(0x2EA09E0)
#define IFIX_CORE_CALL_GETINT64_OFFSET UNITYSDK_OFFSET(0x2EA0A40)
#define IFIX_CORE_CALL_GETINTPTR_OFFSET UNITYSDK_OFFSET(0x2EA0A40)
#define IFIX_CORE_CALL_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x2EA0B50)
#define IFIX_CORE_CALL_GETSINGLE_OFFSET UNITYSDK_OFFSET(0x2EA0AA0)
#define IFIX_CORE_CALL_GETUINT16_OFFSET UNITYSDK_OFFSET(0x2EA0950)
#define IFIX_CORE_CALL_GETUINT32_OFFSET UNITYSDK_OFFSET(0x2EA09E0)
#define IFIX_CORE_CALL_GETUINT64_OFFSET UNITYSDK_OFFSET(0x2EA0A40)
#define IFIX_CORE_CALL_PUSHBOOLEAN_OFFSET UNITYSDK_OFFSET(0x2EA0890)
#define IFIX_CORE_CALL_PUSHBYTE_OFFSET UNITYSDK_OFFSET(0x2EA0890)
#define IFIX_CORE_CALL_PUSHDOUBLE_OFFSET UNITYSDK_OFFSET(0x2EA0AD0)
#define IFIX_CORE_CALL_PUSHINT16_OFFSET UNITYSDK_OFFSET(0x2EA0920)
#define IFIX_CORE_CALL_PUSHINT32_OFFSET UNITYSDK_OFFSET(0x2EA09B0)
#define IFIX_CORE_CALL_PUSHINT64_OFFSET UNITYSDK_OFFSET(0x2EA0A10)
#define IFIX_CORE_CALL_PUSHINTPTR_OFFSET UNITYSDK_OFFSET(0x2EA0A10)
#define IFIX_CORE_CALL_PUSHOBJECTASRESULT_OFFSET UNITYSDK_OFFSET(0x2EA0BF0)
#define IFIX_CORE_CALL_PUSHOBJECT_OFFSET UNITYSDK_OFFSET(0x2EA0B30)
#define IFIX_CORE_CALL_PUSHREF_OFFSET UNITYSDK_OFFSET(0x2EA0C30)
#define IFIX_CORE_CALL_PUSHSINGLE_OFFSET UNITYSDK_OFFSET(0x2EA0A70)
#define IFIX_CORE_CALL_PUSHUINT16_OFFSET UNITYSDK_OFFSET(0x2EA0980)
#define IFIX_CORE_CALL_PUSHUINT32_OFFSET UNITYSDK_OFFSET(0x2EA09B0)
#define IFIX_CORE_CALL_PUSHUINT64_OFFSET UNITYSDK_OFFSET(0x2EA0A10)
#define IFIX_CORE_CALL_PUSHVALUETYPE_OFFSET UNITYSDK_OFFSET(0x2EA0B40)
#define IFIX_CORE_CALL_UPDATEREFERENCE_OFFSET UNITYSDK_OFFSET(0x2EA0C70)
