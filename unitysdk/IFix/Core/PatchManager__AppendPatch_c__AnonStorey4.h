...
#define IFIX_CORE_PATCHMANAGER__APPENDPATCH_C__ANONSTOREY4__CTOR_OFFSET UNITYSDK_OFFSET(0x199402A0)
#define IFIX_CORE_PATCHMANAGER__APPENDPATCH_C__ANONSTOREY4___M__0_OFFSET UNITYSDK_OFFSET(0x19941060)
