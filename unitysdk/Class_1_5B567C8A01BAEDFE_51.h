...
#define CLASS_1_5B567C8A01BAEDFE_51_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C6FE0A0)
#define CLASS_1_5B567C8A01BAEDFE_51_CLONE_OFFSET UNITYSDK_OFFSET(0x1C6FDD90)
#define CLASS_1_5B567C8A01BAEDFE_51_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C6FDEA0)
#define CLASS_1_5B567C8A01BAEDFE_51_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C6FDDD0)
#define CLASS_1_5B567C8A01BAEDFE_51_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C6FE000)
#define CLASS_1_5B567C8A01BAEDFE_51_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C6FE0F0)
#define CLASS_1_5B567C8A01BAEDFE_51_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C6FE0C0)
#define CLASS_1_5B567C8A01BAEDFE_51_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C6FDD10)
#define CLASS_1_5B567C8A01BAEDFE_51_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C6FDD40)
#define CLASS_1_5B567C8A01BAEDFE_51_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C6FE030)
#define CLASS_1_5B567C8A01BAEDFE_51_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C6FE090)
#define CLASS_1_5B567C8A01BAEDFE_51__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6FE140)
#define CLASS_1_5B567C8A01BAEDFE_51__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6FDD60)
#define CLASS_1_5B567C8A01BAEDFE_51__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6FDD50)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_51*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_51_TypeDefinitionIndex)->GetStaticField(0x6290);
	}
