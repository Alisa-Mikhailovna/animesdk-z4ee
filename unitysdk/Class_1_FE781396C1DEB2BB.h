...
#define CLASS_1_FE781396C1DEB2BB_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C12C1E0)
#define CLASS_1_FE781396C1DEB2BB_CLONE_OFFSET UNITYSDK_OFFSET(0x1C12BC50)
#define CLASS_1_FE781396C1DEB2BB_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C12BD10)
#define CLASS_1_FE781396C1DEB2BB_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C12BCE0)
#define CLASS_1_FE781396C1DEB2BB_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C12BE30)
#define CLASS_1_FE781396C1DEB2BB_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C12C390)
#define CLASS_1_FE781396C1DEB2BB_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C12C320)
#define CLASS_1_FE781396C1DEB2BB_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C12BCB0)
#define CLASS_1_FE781396C1DEB2BB_METHOD_1_554199E0076172C5_1_OFFSET UNITYSDK_OFFSET(0x1C12BCD0)
#define CLASS_1_FE781396C1DEB2BB_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C12BCA0)
#define CLASS_1_FE781396C1DEB2BB_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C12BA80)
#define CLASS_1_FE781396C1DEB2BB_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C12BCC0)
#define CLASS_1_FE781396C1DEB2BB_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1C12BC90)
#define CLASS_1_FE781396C1DEB2BB_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1C12BC80)
#define CLASS_1_FE781396C1DEB2BB_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C12BAB0)
#define CLASS_1_FE781396C1DEB2BB_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C12BFF0)
#define CLASS_1_FE781396C1DEB2BB_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C12C050)
#define CLASS_1_FE781396C1DEB2BB__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C12C4C0)
#define CLASS_1_FE781396C1DEB2BB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C12BB50)
#define CLASS_1_FE781396C1DEB2BB__CTOR_OFFSET UNITYSDK_OFFSET(0x1C12BAC0)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FE781396C1DEB2BB_TypeDefinitionIndex)->GetStaticField(0x1B030);
	}
	static ::Google::Protobuf::FieldCodec_1<::System::UInt32>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FE781396C1DEB2BB_TypeDefinitionIndex)->GetStaticField(0x1B038);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_FE781396C1DEB2BB*>** StaticGet_Field_1_2()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_FE781396C1DEB2BB*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_FE781396C1DEB2BB_TypeDefinitionIndex)->GetStaticField(0x1B040);
	}
