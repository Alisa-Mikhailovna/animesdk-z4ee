...
#define CLASS_1_5B567C8A01BAEDFE_201_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C2D4790)
#define CLASS_1_5B567C8A01BAEDFE_201_CLONE_OFFSET UNITYSDK_OFFSET(0x1C2D4480)
#define CLASS_1_5B567C8A01BAEDFE_201_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C2D4590)
#define CLASS_1_5B567C8A01BAEDFE_201_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C2D44C0)
#define CLASS_1_5B567C8A01BAEDFE_201_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C2D46F0)
#define CLASS_1_5B567C8A01BAEDFE_201_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C2D47E0)
#define CLASS_1_5B567C8A01BAEDFE_201_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C2D47B0)
#define CLASS_1_5B567C8A01BAEDFE_201_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C2D4400)
#define CLASS_1_5B567C8A01BAEDFE_201_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C2D4430)
#define CLASS_1_5B567C8A01BAEDFE_201_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C2D4720)
#define CLASS_1_5B567C8A01BAEDFE_201_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C2D4780)
#define CLASS_1_5B567C8A01BAEDFE_201__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2D4830)
#define CLASS_1_5B567C8A01BAEDFE_201__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2D4450)
#define CLASS_1_5B567C8A01BAEDFE_201__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D4440)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_201*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_201_TypeDefinitionIndex)->GetStaticField(0x36000);
	}
