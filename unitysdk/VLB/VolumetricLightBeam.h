...
#define VLB_VOLUMETRICLIGHTBEAM_ASSIGNPROPERTIESFROMSPOTLIGHT_OFFSET UNITYSDK_OFFSET(0xDDC6F90)
#define VLB_VOLUMETRICLIGHTBEAM_CLAMPPROPERTIES_OFFSET UNITYSDK_OFFSET(0xDDC7050)
#define VLB_VOLUMETRICLIGHTBEAM_DESTROYBEAM_OFFSET UNITYSDK_OFFSET(0xDDC6EE0)
#define VLB_VOLUMETRICLIGHTBEAM_DOPLAYTIMEUPDATE_OFFSET UNITYSDK_OFFSET(0xDDC6B40)
#define VLB_VOLUMETRICLIGHTBEAM_GENERATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0xDDC5D90)
#define VLB_VOLUMETRICLIGHTBEAM_GENERATE_OFFSET UNITYSDK_OFFSET(0xDDC5D10)
#define VLB_VOLUMETRICLIGHTBEAM_GETINSIDEBEAMFACTORFROMOBJECTSPACEPOS_OFFSET UNITYSDK_OFFSET(0xDDC4A00)
#define VLB_VOLUMETRICLIGHTBEAM_GETINSIDEBEAMFACTOR_OFFSET UNITYSDK_OFFSET(0xDDC5C90)
#define VLB_VOLUMETRICLIGHTBEAM_GET_ATTENUATIONLERPLINEARQUAD_OFFSET UNITYSDK_OFFSET(0xDDC41F0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_BLENDINGMODEASINT_OFFSET UNITYSDK_OFFSET(0xDDC5730)
#define VLB_VOLUMETRICLIGHTBEAM_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0xDDC5430)
#define VLB_VOLUMETRICLIGHTBEAM_GET_CONEANGLE_OFFSET UNITYSDK_OFFSET(0xDDC4100)
#define VLB_VOLUMETRICLIGHTBEAM_GET_CONEAPEXOFFSETZ_OFFSET UNITYSDK_OFFSET(0xDDC4160)
#define VLB_VOLUMETRICLIGHTBEAM_GET_CONERADIUSEND_OFFSET UNITYSDK_OFFSET(0xDDC3A60)
#define VLB_VOLUMETRICLIGHTBEAM_GET_CONEVOLUME_OFFSET UNITYSDK_OFFSET(0xDDC50C0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_GEOMSEGMENTS_OFFSET UNITYSDK_OFFSET(0xDDC5190)
#define VLB_VOLUMETRICLIGHTBEAM_GET_GEOMSIDES_OFFSET UNITYSDK_OFFSET(0xDDC5140)
#define VLB_VOLUMETRICLIGHTBEAM_GET_HASGEOMETRY_OFFSET UNITYSDK_OFFSET(0xDDC5410)
#define VLB_VOLUMETRICLIGHTBEAM_GET_ISCURRENTLYTRACKINGCHANGES_OFFSET UNITYSDK_OFFSET(0xDDC5400)
#define VLB_VOLUMETRICLIGHTBEAM_GET_LIGHTSPOTATTACHED_OFFSET UNITYSDK_OFFSET(0xDDC5BD0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_MESHSTATS_OFFSET UNITYSDK_OFFSET(0xDDC59B0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_MESHTRIANGLESCOUNT_OFFSET UNITYSDK_OFFSET(0xDDC5B70)
#define VLB_VOLUMETRICLIGHTBEAM_GET_MESHVERTICESCOUNT_OFFSET UNITYSDK_OFFSET(0xDDC5B40)
#define VLB_VOLUMETRICLIGHTBEAM_GET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0xDDC51E0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0xDDC5230)
#define VLB_VOLUMETRICLIGHTBEAM_GET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0xDDC52A0)
#define VLB_VOLUMETRICLIGHTBEAM_GET_TRACKCHANGESDURINGPLAYTIME_OFFSET UNITYSDK_OFFSET(0xDDC52F0)
#define VLB_VOLUMETRICLIGHTBEAM_GET__INTERNAL_INSTANCEDMATERIALGROUPID_OFFSET UNITYSDK_OFFSET(0xDDC5880)
#define VLB_VOLUMETRICLIGHTBEAM_HANDLEBACKWARDCOMPATIBILITY_OFFSET UNITYSDK_OFFSET(0xDDC5F60)
#define VLB_VOLUMETRICLIGHTBEAM_ISCOLLIDERHIDDENBYDYNAMICOCCLUDER_OFFSET UNITYSDK_OFFSET(0xDDC55D0)
#define VLB_VOLUMETRICLIGHTBEAM_ISNEEDTICK_OFFSET UNITYSDK_OFFSET(0xDDC6BF0)
#define VLB_VOLUMETRICLIGHTBEAM_SETCLIPPINGPLANEOFF_OFFSET UNITYSDK_OFFSET(0xDDC5570)
#define VLB_VOLUMETRICLIGHTBEAM_SETCLIPPINGPLANE_OFFSET UNITYSDK_OFFSET(0xDDC5500)
#define VLB_VOLUMETRICLIGHTBEAM_SETTSC_OFFSET UNITYSDK_OFFSET(0xDDC58A0)
#define VLB_VOLUMETRICLIGHTBEAM_SET_GEOMSEGMENTS_OFFSET UNITYSDK_OFFSET(0xDDC51D0)
#define VLB_VOLUMETRICLIGHTBEAM_SET_GEOMSIDES_OFFSET UNITYSDK_OFFSET(0xDDC5180)
#define VLB_VOLUMETRICLIGHTBEAM_SET_SORTINGLAYERID_OFFSET UNITYSDK_OFFSET(0xDDC51F0)
#define VLB_VOLUMETRICLIGHTBEAM_SET_SORTINGLAYERNAME_OFFSET UNITYSDK_OFFSET(0xDDC5240)
#define VLB_VOLUMETRICLIGHTBEAM_SET_SORTINGORDER_OFFSET UNITYSDK_OFFSET(0xDDC52B0)
#define VLB_VOLUMETRICLIGHTBEAM_SET_TRACKCHANGESDURINGPLAYTIME_OFFSET UNITYSDK_OFFSET(0xDDC5300)
#define VLB_VOLUMETRICLIGHTBEAM_SET__INTERNAL_INSTANCEDMATERIALGROUPID_OFFSET UNITYSDK_OFFSET(0xDDC5890)
#define VLB_VOLUMETRICLIGHTBEAM_STARTPLAYTIMEUPDATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0xDDC5310)
#define VLB_VOLUMETRICLIGHTBEAM_SYNCMATERIAL_OFFSET UNITYSDK_OFFSET(0xDDC6C00)
#define VLB_VOLUMETRICLIGHTBEAM_UPDATEAFTERMANUALPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0xDDC6090)
#define VLB_VOLUMETRICLIGHTBEAM_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0xDDC7030)
#define VLB_VOLUMETRICLIGHTBEAM_VALIDATEPROPERTIES_OFFSET UNITYSDK_OFFSET(0xDDC5FF0)
#define VLB_VOLUMETRICLIGHTBEAM__CTOR_OFFSET UNITYSDK_OFFSET(0xDDC7210)
#define VLB_VOLUMETRICLIGHTBEAM__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDDC6ED0)
#define VLB_VOLUMETRICLIGHTBEAM__ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDDC6D90)
#define VLB_VOLUMETRICLIGHTBEAM__ONENABLE_OFFSET UNITYSDK_OFFSET(0xDDC6C50)
#define VLB_VOLUMETRICLIGHTBEAM__START_OFFSET UNITYSDK_OFFSET(0xDDC6150)
#define VLB_VOLUMETRICLIGHTBEAM__UPDATE_OFFSET UNITYSDK_OFFSET(0xDDC6640)
