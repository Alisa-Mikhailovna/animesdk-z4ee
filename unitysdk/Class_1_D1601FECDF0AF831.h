...
#define CLASS_1_D1601FECDF0AF831_GET_DIALOGUEIDS_OFFSET UNITYSDK_OFFSET(0xB6CD4C0)
#define CLASS_1_D1601FECDF0AF831_GET_ID_OFFSET UNITYSDK_OFFSET(0xB6CD440)
#define CLASS_1_D1601FECDF0AF831_GET_REQUIREMENTS_OFFSET UNITYSDK_OFFSET(0xB6CD460)
#define CLASS_1_D1601FECDF0AF831_GET_SPEAKERPOLICY_OFFSET UNITYSDK_OFFSET(0xB6CD4A0)
#define CLASS_1_D1601FECDF0AF831_GET_VALIDAREAS_OFFSET UNITYSDK_OFFSET(0xB6CD480)
#define CLASS_1_D1601FECDF0AF831_SET_DIALOGUEIDS_OFFSET UNITYSDK_OFFSET(0xB6CD4D0)
#define CLASS_1_D1601FECDF0AF831_SET_ID_OFFSET UNITYSDK_OFFSET(0xB6CD450)
#define CLASS_1_D1601FECDF0AF831_SET_REQUIREMENTS_OFFSET UNITYSDK_OFFSET(0xB6CD470)
#define CLASS_1_D1601FECDF0AF831_SET_SPEAKERPOLICY_OFFSET UNITYSDK_OFFSET(0xB6CD4B0)
#define CLASS_1_D1601FECDF0AF831_SET_VALIDAREAS_OFFSET UNITYSDK_OFFSET(0xB6CD490)
#define CLASS_1_D1601FECDF0AF831__CTOR_OFFSET UNITYSDK_OFFSET(0xB6CD4E0)
...
{
public:
	::Il2CppArray<::RPG::GameCore::CakeValidAreaType>* _ValidAreas_k__BackingField; // 0x10
	::Il2CppArray<::Class_1_3745C69C00F04B7D_5*>* _Requirements_k__BackingField; // 0x18
	::Il2CppArray<::System::UInt32>* _DialogueIDs_k__BackingField; // 0x20
