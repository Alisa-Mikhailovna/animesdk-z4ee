...
#define CLASS_2_AF5B897C190C9D28_DISPOSE_OFFSET UNITYSDK_OFFSET(0x156928A0)
#define CLASS_2_AF5B897C190C9D28_METHOD_2_3B911B6C3D1240C7_OFFSET UNITYSDK_OFFSET(0x156928E0)
#define CLASS_2_AF5B897C190C9D28_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15692120)
#define CLASS_2_AF5B897C190C9D28_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x156920D0)
#define CLASS_2_AF5B897C190C9D28_TICK_OFFSET UNITYSDK_OFFSET(0x15692840)
#define CLASS_2_AF5B897C190C9D28__CTOR_OFFSET UNITYSDK_OFFSET(0x156920C0)
...
{
public:
	::RPG::GameCore::AetherDivideTriggerAttackSimplified* Field_2_0; // 0x18
