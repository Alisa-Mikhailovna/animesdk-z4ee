...
#define CLASS_1_1763C3F870E54CEB_METHOD_1_07F7A083AEB87759_OFFSET UNITYSDK_OFFSET(0xB6A68B0)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_0DFF2CFEC2E9091A_OFFSET UNITYSDK_OFFSET(0xB6A5C10)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_2AB85BE2A67D08EB_OFFSET UNITYSDK_OFFSET(0xB6A5AE0)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_2BD784981EFF0C9B_OFFSET UNITYSDK_OFFSET(0xB6A6F40)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_4E40B6C28D9DCB70_OFFSET UNITYSDK_OFFSET(0xB6A5F80)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_55357EED91DD300A_OFFSET UNITYSDK_OFFSET(0xB698A10)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_6C319119E0CCE4C0_1_OFFSET UNITYSDK_OFFSET(0xB6A6770)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_6C319119E0CCE4C0_OFFSET UNITYSDK_OFFSET(0xB6A66F0)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_78328DD1829FCCF4_OFFSET UNITYSDK_OFFSET(0xB6A6A40)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_8EDB7FE5AA37C50F_OFFSET UNITYSDK_OFFSET(0xB6A7050)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_908180B8F1022CC2_OFFSET UNITYSDK_OFFSET(0xB6A60C0)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_91A383AC107D6858_OFFSET UNITYSDK_OFFSET(0xB6A6B70)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_9E470020506C3C76_OFFSET UNITYSDK_OFFSET(0xB6A5E70)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_AC7BD58DBE80A7D0_OFFSET UNITYSDK_OFFSET(0xB6A6E00)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_C6DE0B41731F49F8_OFFSET UNITYSDK_OFFSET(0xB6A6D00)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_D1DAA01ABF3D4077_OFFSET UNITYSDK_OFFSET(0xB6A6140)
#define CLASS_1_1763C3F870E54CEB_METHOD_1_E91DC8577619DA02_OFFSET UNITYSDK_OFFSET(0xB6A6960)
#define CLASS_1_1763C3F870E54CEB_ONPLUGININIT_OFFSET UNITYSDK_OFFSET(0xB6A61A0)
#define CLASS_1_1763C3F870E54CEB_ONPLUGINUNINIT_OFFSET UNITYSDK_OFFSET(0xB6A67F0)
#define CLASS_1_1763C3F870E54CEB__CTOR_OFFSET UNITYSDK_OFFSET(0xB6A7060)
...
{
public:
	::Class_1_9E3B72ED878AEF28* Field_1_0; // 0x10
	::System::Collections::Generic::List_1<::RPG::GameCore::IVec2>* Field_1_1; // 0x18
	::Il2CppArray<::Class_1_DA32E543F3E152DD*>* Field_1_2; // 0x20
	::RPG::GameCore::FixPoint Field_1_3; // 0x28
	::RPG::GameCore::IVec2 Field_1_4; // 0x30
	::RPG::GameCore::IVec2 Field_1_5; // 0x38
	::RPG::GameCore::FixVec3 Field_1_6; // 0x40
