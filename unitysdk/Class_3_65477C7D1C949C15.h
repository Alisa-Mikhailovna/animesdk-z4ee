...
#define CLASS_3_65477C7D1C949C15_METHOD_3_3337B4DA0CB80D20_OFFSET UNITYSDK_OFFSET(0x154B87C0)
#define CLASS_3_65477C7D1C949C15_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x154B7D50)
#define CLASS_3_65477C7D1C949C15__CTOR_OFFSET UNITYSDK_OFFSET(0x154B7D00)
#define CLASS_3_65477C7D1C949C15__ONPAGECANCELCLOSE_OFFSET UNITYSDK_OFFSET(0x154B8980)
#define CLASS_3_65477C7D1C949C15__ONPAGECONFIRMCLOSE_OFFSET UNITYSDK_OFFSET(0x154B8890)
