...
#define CLASS_1_CDA7391AC2DCC34A_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C24E330)
#define CLASS_1_CDA7391AC2DCC34A_CLONE_OFFSET UNITYSDK_OFFSET(0x1C24DB00)
#define CLASS_1_CDA7391AC2DCC34A_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C24DB80)
#define CLASS_1_CDA7391AC2DCC34A_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C24DB50)
#define CLASS_1_CDA7391AC2DCC34A_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C24DF50)
#define CLASS_1_CDA7391AC2DCC34A_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C24E7D0)
#define CLASS_1_CDA7391AC2DCC34A_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C24E590)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x1C24DB30)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C24D730)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_6BCB722BBE18B904_1_OFFSET UNITYSDK_OFFSET(0x1C24DA50)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_6BCB722BBE18B904_OFFSET UNITYSDK_OFFSET(0x1C24D9A0)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_7E46B904D08C26AC_OFFSET UNITYSDK_OFFSET(0x1C24D940)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1C24DB40)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_ECF173E3C678F858_OFFSET UNITYSDK_OFFSET(0x1C24D980)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_F45A6C563F3DF7EB_1_OFFSET UNITYSDK_OFFSET(0x1C24DAD0)
#define CLASS_1_CDA7391AC2DCC34A_METHOD_1_F45A6C563F3DF7EB_OFFSET UNITYSDK_OFFSET(0x1C24DA20)
#define CLASS_1_CDA7391AC2DCC34A_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C24D760)
#define CLASS_1_CDA7391AC2DCC34A_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C24E070)
#define CLASS_1_CDA7391AC2DCC34A_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C24E0D0)
#define CLASS_1_CDA7391AC2DCC34A__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C24EA00)
#define CLASS_1_CDA7391AC2DCC34A__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C24D780)
#define CLASS_1_CDA7391AC2DCC34A__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24D770)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_CDA7391AC2DCC34A*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_CDA7391AC2DCC34A_TypeDefinitionIndex)->GetStaticField(0x2D3B0);
	}
