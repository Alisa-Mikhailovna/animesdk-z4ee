...
#define IRI_TRACKCUSTOMDATA_METHOD_6_A2846FC5EA0763C6_OFFSET UNITYSDK_OFFSET(0x15253060)
#define IRI_TRACKCUSTOMDATA_METHOD_6_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x15252FE0)
#define IRI_TRACKCUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15252FA0)
#define IRI_TRACKCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x15253080)
