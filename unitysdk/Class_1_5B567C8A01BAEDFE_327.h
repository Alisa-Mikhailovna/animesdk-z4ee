...
#define CLASS_1_5B567C8A01BAEDFE_327_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C820280)
#define CLASS_1_5B567C8A01BAEDFE_327_CLONE_OFFSET UNITYSDK_OFFSET(0x1C81FF70)
#define CLASS_1_5B567C8A01BAEDFE_327_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C820080)
#define CLASS_1_5B567C8A01BAEDFE_327_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C81FFB0)
#define CLASS_1_5B567C8A01BAEDFE_327_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C8201E0)
#define CLASS_1_5B567C8A01BAEDFE_327_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C8202D0)
#define CLASS_1_5B567C8A01BAEDFE_327_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C8202A0)
#define CLASS_1_5B567C8A01BAEDFE_327_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C81FEF0)
#define CLASS_1_5B567C8A01BAEDFE_327_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C81FF20)
#define CLASS_1_5B567C8A01BAEDFE_327_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C820210)
#define CLASS_1_5B567C8A01BAEDFE_327_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C820270)
#define CLASS_1_5B567C8A01BAEDFE_327__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C820320)
#define CLASS_1_5B567C8A01BAEDFE_327__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C81FF40)
#define CLASS_1_5B567C8A01BAEDFE_327__CTOR_OFFSET UNITYSDK_OFFSET(0x1C81FF30)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_327*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_327_TypeDefinitionIndex)->GetStaticField(0x27660);
	}
