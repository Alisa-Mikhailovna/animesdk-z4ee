...
#define CLASS_2_B9B3C04B6E93CEA0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14CAB910)
#define CLASS_2_B9B3C04B6E93CEA0_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x14CABC50)
#define CLASS_2_B9B3C04B6E93CEA0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x14CAB9F0)
#define CLASS_2_B9B3C04B6E93CEA0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x14CABA90)
#define CLASS_2_B9B3C04B6E93CEA0_TICK_OFFSET UNITYSDK_OFFSET(0x14CABB10)
#define CLASS_2_B9B3C04B6E93CEA0__CTOR_OFFSET UNITYSDK_OFFSET(0x14CAB860)
