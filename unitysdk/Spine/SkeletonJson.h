...
#define SPINE_SKELETONJSON_FINDSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1C9623F0)
#define SPINE_SKELETONJSON_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1C962050)
#define SPINE_SKELETONJSON_GETFLOATARRAY_OFFSET UNITYSDK_OFFSET(0x1C976200)
#define SPINE_SKELETONJSON_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1C961E20)
#define SPINE_SKELETONJSON_GETINTARRAY_OFFSET UNITYSDK_OFFSET(0x1C9764F0)
#define SPINE_SKELETONJSON_GETINT_1_OFFSET UNITYSDK_OFFSET(0x1C9766D0)
#define SPINE_SKELETONJSON_GETINT_OFFSET UNITYSDK_OFFSET(0x1C9622A0)
#define SPINE_SKELETONJSON_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1C961F70)
#define SPINE_SKELETONJSON_READANIMATION_OFFSET UNITYSDK_OFFSET(0x1C963B60)
#define SPINE_SKELETONJSON_READATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1C962540)
#define SPINE_SKELETONJSON_READCURVE_OFFSET UNITYSDK_OFFSET(0x1C976870)
#define SPINE_SKELETONJSON_READSEQUENCE_OFFSET UNITYSDK_OFFSET(0x1C975B50)
#define SPINE_SKELETONJSON_READSKELETONDATA_1_OFFSET UNITYSDK_OFFSET(0x1C959690)
#define SPINE_SKELETONJSON_READSKELETONDATA_OFFSET UNITYSDK_OFFSET(0x1C959510)
#define SPINE_SKELETONJSON_READTIMELINE_1_OFFSET UNITYSDK_OFFSET(0x1C977110)
#define SPINE_SKELETONJSON_READTIMELINE_OFFSET UNITYSDK_OFFSET(0x1C976C80)
#define SPINE_SKELETONJSON_READVERTICES_OFFSET UNITYSDK_OFFSET(0x1C975C40)
#define SPINE_SKELETONJSON_SETBEZIER_OFFSET UNITYSDK_OFFSET(0x1C977620)
#define SPINE_SKELETONJSON_TOCOLOR_OFFSET UNITYSDK_OFFSET(0x1C9621A0)
#define SPINE_SKELETONJSON__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C959500)
#define SPINE_SKELETONJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x1C959480)
