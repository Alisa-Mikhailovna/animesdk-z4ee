...
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_ONANIMATIONCHECK_OFFSET UNITYSDK_OFFSET(0x1C9A9530)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_ONSKINCHECK_OFFSET UNITYSDK_OFFSET(0x1C9A9720)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C9A97B0)
#define SPINE_UNITY_SKELETONGRAPHICCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9A97D0)
