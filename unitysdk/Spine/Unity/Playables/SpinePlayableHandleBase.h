...
#define SPINE_UNITY_PLAYABLES_SPINEPLAYABLEHANDLEBASE_ADD_ANIMATIONEVENTS_OFFSET UNITYSDK_OFFSET(0x1C983AF0)
#define SPINE_UNITY_PLAYABLES_SPINEPLAYABLEHANDLEBASE_HANDLEEVENTS_OFFSET UNITYSDK_OFFSET(0x1C983BF0)
#define SPINE_UNITY_PLAYABLES_SPINEPLAYABLEHANDLEBASE_REMOVE_ANIMATIONEVENTS_OFFSET UNITYSDK_OFFSET(0x1C983B70)
#define SPINE_UNITY_PLAYABLES_SPINEPLAYABLEHANDLEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C97F910)
