...
#define SPINE_UNITY_SKELETONGRAPHIC_SKELETONRENDERERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C9A94F0)
#define SPINE_UNITY_SKELETONGRAPHIC_SKELETONRENDERERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9A9520)
#define SPINE_UNITY_SKELETONGRAPHIC_SKELETONRENDERERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9A5CE0)
#define SPINE_UNITY_SKELETONGRAPHIC_SKELETONRENDERERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9A9400)
