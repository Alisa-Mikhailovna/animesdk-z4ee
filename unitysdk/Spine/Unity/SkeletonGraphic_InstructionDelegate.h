...
#define SPINE_UNITY_SKELETONGRAPHIC_INSTRUCTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C9A91E0)
#define SPINE_UNITY_SKELETONGRAPHIC_INSTRUCTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C9A9210)
#define SPINE_UNITY_SKELETONGRAPHIC_INSTRUCTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C9A3CF0)
#define SPINE_UNITY_SKELETONGRAPHIC_INSTRUCTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9A90F0)
