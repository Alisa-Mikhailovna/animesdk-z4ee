...
#define SPINE_SKIN_ADDSKIN_OFFSET UNITYSDK_OFFSET(0x1C977810)
#define SPINE_SKIN_ATTACHALL_OFFSET UNITYSDK_OFFSET(0x1C943450)
#define SPINE_SKIN_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C9782A0)
#define SPINE_SKIN_COPYSKIN_OFFSET UNITYSDK_OFFSET(0x1C977B60)
#define SPINE_SKIN_GETATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x1C978080)
#define SPINE_SKIN_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1C943680)
#define SPINE_SKIN_GET_ATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x1C9424D0)
#define SPINE_SKIN_GET_BONES_OFFSET UNITYSDK_OFFSET(0x1C9776D0)
#define SPINE_SKIN_GET_CONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1C9776E0)
#define SPINE_SKIN_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C9776C0)
#define SPINE_SKIN_REMOVEATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1C978020)
#define SPINE_SKIN_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1C953E70)
#define SPINE_SKIN_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C978370)
#define SPINE_SKIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C952A20)
