...
#define SPINE_POLYGON_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C939650)
#define SPINE_POLYGON_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1C939630)
#define SPINE_POLYGON_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1C939660)
#define SPINE_POLYGON_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1C939640)
#define SPINE_POLYGON__CTOR_OFFSET UNITYSDK_OFFSET(0x1C939670)
