...
#define SPINE_TIMELINE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1C9789B0)
#define SPINE_TIMELINE_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1C978920)
#define SPINE_TIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x1C978910)
#define SPINE_TIMELINE_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x1C978900)
#define SPINE_TIMELINE_GET_PROPERTYIDS_OFFSET UNITYSDK_OFFSET(0x1C9788F0)
#define SPINE_TIMELINE_SEARCH_1_OFFSET UNITYSDK_OFFSET(0x1C978AA0)
#define SPINE_TIMELINE_SEARCH_OFFSET UNITYSDK_OFFSET(0x1C978A50)
#define SPINE_TIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C978810)
