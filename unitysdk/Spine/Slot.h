...
#define SPINE_SLOT_CLAMPCOLOR_OFFSET UNITYSDK_OFFSET(0x1C921220)
#define SPINE_SLOT_CLAMPSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1C93A560)
#define SPINE_SLOT_GET_ATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1C978580)
#define SPINE_SLOT_GET_A_OFFSET UNITYSDK_OFFSET(0x1C9784C0)
#define SPINE_SLOT_GET_B2_OFFSET UNITYSDK_OFFSET(0x1C978520)
#define SPINE_SLOT_GET_BONE_OFFSET UNITYSDK_OFFSET(0x1C978430)
#define SPINE_SLOT_GET_B_OFFSET UNITYSDK_OFFSET(0x1C9784A0)
#define SPINE_SLOT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1C978420)
#define SPINE_SLOT_GET_DEFORM_OFFSET UNITYSDK_OFFSET(0x1C9785B0)
#define SPINE_SLOT_GET_G2_OFFSET UNITYSDK_OFFSET(0x1C978500)
#define SPINE_SLOT_GET_G_OFFSET UNITYSDK_OFFSET(0x1C978480)
#define SPINE_SLOT_GET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1C978540)
#define SPINE_SLOT_GET_R2_OFFSET UNITYSDK_OFFSET(0x1C9784E0)
#define SPINE_SLOT_GET_R_OFFSET UNITYSDK_OFFSET(0x1C978460)
#define SPINE_SLOT_GET_SEQUENCEINDEX_OFFSET UNITYSDK_OFFSET(0x1C978590)
#define SPINE_SLOT_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x1C978440)
#define SPINE_SLOT_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1C942F20)
#define SPINE_SLOT_SET_ATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1C925580)
#define SPINE_SLOT_SET_A_OFFSET UNITYSDK_OFFSET(0x1C9784D0)
#define SPINE_SLOT_SET_B2_OFFSET UNITYSDK_OFFSET(0x1C978530)
#define SPINE_SLOT_SET_B_OFFSET UNITYSDK_OFFSET(0x1C9784B0)
#define SPINE_SLOT_SET_DEFORM_OFFSET UNITYSDK_OFFSET(0x1C9785C0)
#define SPINE_SLOT_SET_G2_OFFSET UNITYSDK_OFFSET(0x1C978510)
#define SPINE_SLOT_SET_G_OFFSET UNITYSDK_OFFSET(0x1C978490)
#define SPINE_SLOT_SET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1C978560)
#define SPINE_SLOT_SET_R2_OFFSET UNITYSDK_OFFSET(0x1C9784F0)
#define SPINE_SLOT_SET_R_OFFSET UNITYSDK_OFFSET(0x1C978470)
#define SPINE_SLOT_SET_SEQUENCEINDEX_OFFSET UNITYSDK_OFFSET(0x1C9785A0)
#define SPINE_SLOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C978640)
#define SPINE_SLOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C941520)
#define SPINE_SLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9404E0)
