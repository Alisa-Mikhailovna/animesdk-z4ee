...
#define SPINE_SKELETON_FINDBONE_OFFSET UNITYSDK_OFFSET(0x1C943020)
#define SPINE_SKELETON_FINDIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1C943A40)
#define SPINE_SKELETON_FINDPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1C943C80)
#define SPINE_SKELETON_FINDSLOT_OFFSET UNITYSDK_OFFSET(0x1C943140)
#define SPINE_SKELETON_FINDTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1C943B60)
#define SPINE_SKELETON_GETATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x1C9252B0)
#define SPINE_SKELETON_GETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1C943710)
#define SPINE_SKELETON_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1C943DA0)
#define SPINE_SKELETON_GET_A_OFFSET UNITYSDK_OFFSET(0x1C93FA70)
#define SPINE_SKELETON_GET_BONES_OFFSET UNITYSDK_OFFSET(0x1C93F780)
#define SPINE_SKELETON_GET_B_OFFSET UNITYSDK_OFFSET(0x1C93FA50)
#define SPINE_SKELETON_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1C93F770)
#define SPINE_SKELETON_GET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x1C93F7B0)
#define SPINE_SKELETON_GET_FLIPX_OFFSET UNITYSDK_OFFSET(0x1C93FB00)
#define SPINE_SKELETON_GET_FLIPY_OFFSET UNITYSDK_OFFSET(0x1C93FB50)
#define SPINE_SKELETON_GET_G_OFFSET UNITYSDK_OFFSET(0x1C93FA30)
#define SPINE_SKELETON_GET_IKCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1C93F7C0)
#define SPINE_SKELETON_GET_PATHCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1C93F7D0)
#define SPINE_SKELETON_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1C93FBA0)
#define SPINE_SKELETON_GET_R_OFFSET UNITYSDK_OFFSET(0x1C93FA10)
#define SPINE_SKELETON_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1C93FAD0)
#define SPINE_SKELETON_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1C92DDE0)
#define SPINE_SKELETON_GET_SKIN_OFFSET UNITYSDK_OFFSET(0x1C93F7F0)
#define SPINE_SKELETON_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0x1C93F7A0)
#define SPINE_SKELETON_GET_TRANSFORMCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1C93F7E0)
#define SPINE_SKELETON_GET_UPDATECACHELIST_OFFSET UNITYSDK_OFFSET(0x1C93F790)
#define SPINE_SKELETON_GET_X_OFFSET UNITYSDK_OFFSET(0x1C93FA90)
#define SPINE_SKELETON_GET_Y_OFFSET UNITYSDK_OFFSET(0x1C93FAB0)
#define SPINE_SKELETON_SETATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1C943860)
#define SPINE_SKELETON_SETBONESTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1C942BF0)
#define SPINE_SKELETON_SETSKIN_1_OFFSET UNITYSDK_OFFSET(0x1C93F810)
#define SPINE_SKELETON_SETSKIN_OFFSET UNITYSDK_OFFSET(0x1C943260)
#define SPINE_SKELETON_SETSLOTSTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1C942E90)
#define SPINE_SKELETON_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1C942BD0)
#define SPINE_SKELETON_SET_A_OFFSET UNITYSDK_OFFSET(0x1C93FA80)
#define SPINE_SKELETON_SET_B_OFFSET UNITYSDK_OFFSET(0x1C93FA60)
#define SPINE_SKELETON_SET_FLIPX_OFFSET UNITYSDK_OFFSET(0x1C93FB10)
#define SPINE_SKELETON_SET_FLIPY_OFFSET UNITYSDK_OFFSET(0x1C93FB60)
#define SPINE_SKELETON_SET_G_OFFSET UNITYSDK_OFFSET(0x1C93FA40)
#define SPINE_SKELETON_SET_R_OFFSET UNITYSDK_OFFSET(0x1C93FA20)
#define SPINE_SKELETON_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1C93FAE0)
#define SPINE_SKELETON_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1C93FAF0)
#define SPINE_SKELETON_SET_SKIN_OFFSET UNITYSDK_OFFSET(0x1C93F800)
#define SPINE_SKELETON_SET_X_OFFSET UNITYSDK_OFFSET(0x1C93FAA0)
#define SPINE_SKELETON_SET_Y_OFFSET UNITYSDK_OFFSET(0x1C93FAC0)
#define SPINE_SKELETON_SORTBONE_OFFSET UNITYSDK_OFFSET(0x1C941D30)
#define SPINE_SKELETON_SORTIKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1C9416B0)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x1C942360)
#define SPINE_SKELETON_SORTPATHCONSTRAINTATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1C941E20)
#define SPINE_SKELETON_SORTPATHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1C941AC0)
#define SPINE_SKELETON_SORTRESET_OFFSET UNITYSDK_OFFSET(0x1C941D90)
#define SPINE_SKELETON_SORTTRANSFORMCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1C941880)
#define SPINE_SKELETON_UPDATECACHE_OFFSET UNITYSDK_OFFSET(0x1C9405E0)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1C942790)
#define SPINE_SKELETON_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C942560)
#define SPINE_SKELETON__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C9409A0)
#define SPINE_SKELETON__CTOR_OFFSET UNITYSDK_OFFSET(0x1C93FBF0)
