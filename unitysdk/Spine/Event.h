...
#define SPINE_EVENT_GET_BALANCE_OFFSET UNITYSDK_OFFSET(0x1C931050)
#define SPINE_EVENT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1C930FB0)
#define SPINE_EVENT_GET_FLOAT_OFFSET UNITYSDK_OFFSET(0x1C930FF0)
#define SPINE_EVENT_GET_INT_OFFSET UNITYSDK_OFFSET(0x1C930FD0)
#define SPINE_EVENT_GET_STRING_OFFSET UNITYSDK_OFFSET(0x1C931010)
#define SPINE_EVENT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1C930FC0)
#define SPINE_EVENT_GET_VOLUME_OFFSET UNITYSDK_OFFSET(0x1C931030)
#define SPINE_EVENT_SET_BALANCE_OFFSET UNITYSDK_OFFSET(0x1C931060)
#define SPINE_EVENT_SET_FLOAT_OFFSET UNITYSDK_OFFSET(0x1C931000)
#define SPINE_EVENT_SET_INT_OFFSET UNITYSDK_OFFSET(0x1C930FE0)
#define SPINE_EVENT_SET_STRING_OFFSET UNITYSDK_OFFSET(0x1C931020)
#define SPINE_EVENT_SET_VOLUME_OFFSET UNITYSDK_OFFSET(0x1C931040)
#define SPINE_EVENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C931100)
#define SPINE_EVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C931070)
