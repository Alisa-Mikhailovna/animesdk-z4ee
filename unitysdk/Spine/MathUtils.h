...
#define SPINE_MATHUTILS_ATAN2_OFFSET UNITYSDK_OFFSET(0x1C92CFA0)
#define SPINE_MATHUTILS_CLAMP_OFFSET UNITYSDK_OFFSET(0x1C933AC0)
#define SPINE_MATHUTILS_COSDEG_OFFSET UNITYSDK_OFFSET(0x1C92DE00)
#define SPINE_MATHUTILS_COS_OFFSET UNITYSDK_OFFSET(0x1C92DE40)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1C933B40)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1C933AE0)
#define SPINE_MATHUTILS_SINDEG_OFFSET UNITYSDK_OFFSET(0x1C92DE20)
#define SPINE_MATHUTILS_SIN_OFFSET UNITYSDK_OFFSET(0x1C92DE60)
#define SPINE_MATHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C933CC0)
...
namespace Spine
{
	...
	public:
		...
		{
			return (::System::Random**)Il2CppClass::FromTypeDefinitionIndex(MathUtils_TypeDefinitionIndex)->GetStaticField(0x67010);
		}
