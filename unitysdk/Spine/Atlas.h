...
#define SPINE_ATLAS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C92A7E0)
#define SPINE_ATLAS_FINDREGION_OFFSET UNITYSDK_OFFSET(0x1C92A680)
#define SPINE_ATLAS_FLIPV_OFFSET UNITYSDK_OFFSET(0x1C92A5F0)
#define SPINE_ATLAS_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C928C00)
#define SPINE_ATLAS_GET_PAGES_OFFSET UNITYSDK_OFFSET(0x1C928CF0)
#define SPINE_ATLAS_GET_REGIONS_OFFSET UNITYSDK_OFFSET(0x1C928CE0)
#define SPINE_ATLAS_READENTRY_OFFSET UNITYSDK_OFFSET(0x1C92A340)
#define SPINE_ATLAS_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1C928C70)
#define SPINE_ATLAS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C928E00)
#define SPINE_ATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C928D00)
