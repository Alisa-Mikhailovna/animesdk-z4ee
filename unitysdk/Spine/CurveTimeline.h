...
#define SPINE_CURVETIMELINE_GETBEZIERVALUE_OFFSET UNITYSDK_OFFSET(0x1C92F030)
#define SPINE_CURVETIMELINE_GETCURVETYPE_OFFSET UNITYSDK_OFFSET(0x1C92ECB0)
#define SPINE_CURVETIMELINE_SETBEZIER_OFFSET UNITYSDK_OFFSET(0x1C92EDD0)
#define SPINE_CURVETIMELINE_SETLINEAR_OFFSET UNITYSDK_OFFSET(0x1C92EC50)
#define SPINE_CURVETIMELINE_SETSTEPPED_OFFSET UNITYSDK_OFFSET(0x1C92EC80)
#define SPINE_CURVETIMELINE_SHRINK_OFFSET UNITYSDK_OFFSET(0x1C92ECF0)
#define SPINE_CURVETIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C92EBF0)
