...
#define SPINE_BONEMATRIX_CALCULATESETUPWORLD_OFFSET UNITYSDK_OFFSET(0x1C984720)
#define SPINE_BONEMATRIX_GETINHERITEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C9847D0)
#define SPINE_BONEMATRIX_TRANSFORMMATRIX_OFFSET UNITYSDK_OFFSET(0x3A0D6E0)
#define SPINE_BONEMATRIX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A0D5D0)
#define SPINE_BONEMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x3A0D4C0)
