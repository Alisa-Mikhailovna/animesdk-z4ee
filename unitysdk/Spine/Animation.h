...
#define SPINE_ANIMATION_APPLY_OFFSET UNITYSDK_OFFSET(0x1C921870)
#define SPINE_ANIMATION_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1C9217D0)
#define SPINE_ANIMATION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C9217F0)
#define SPINE_ANIMATION_GET_TIMELINES_OFFSET UNITYSDK_OFFSET(0x1C9217B0)
#define SPINE_ANIMATION_HASTIMELINE_OFFSET UNITYSDK_OFFSET(0x1C921800)
#define SPINE_ANIMATION_SETTIMELINES_OFFSET UNITYSDK_OFFSET(0x1C921460)
#define SPINE_ANIMATION_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x1C9217E0)
#define SPINE_ANIMATION_SET_TIMELINES_OFFSET UNITYSDK_OFFSET(0x1C9217C0)
#define SPINE_ANIMATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C921A90)
#define SPINE_ANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9213F0)
