...
#define CLASS_1_35B5591E4067D7D2_GET_BGPATH_OFFSET UNITYSDK_OFFSET(0x147B4AD0)
#define CLASS_1_35B5591E4067D7D2_GET_DESC_OFFSET UNITYSDK_OFFSET(0x147B4B30)
#define CLASS_1_35B5591E4067D7D2_GET_EQUIPMENT3DTGAPATH_OFFSET UNITYSDK_OFFSET(0x147B4A90)
#define CLASS_1_35B5591E4067D7D2_GET_EQUIPMENTLIGHTMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x147B4A70)
#define CLASS_1_35B5591E4067D7D2_GET_FIRSTWORDTEXT_OFFSET UNITYSDK_OFFSET(0x147B4B50)
#define CLASS_1_35B5591E4067D7D2_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x147B4A10)
#define CLASS_1_35B5591E4067D7D2_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x147B4A00)
#define CLASS_1_35B5591E4067D7D2_GET_LIGHTCONECARDBACKIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x147B4AF0)
#define CLASS_1_35B5591E4067D7D2_GET_MIDDLEICONPATH_OFFSET UNITYSDK_OFFSET(0x147B4A30)
#define CLASS_1_35B5591E4067D7D2_GET_NAME_OFFSET UNITYSDK_OFFSET(0x147B4B10)
#define CLASS_1_35B5591E4067D7D2_GET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x147B4A50)
#define CLASS_1_35B5591E4067D7D2_GET_TALKICONPATH_OFFSET UNITYSDK_OFFSET(0x147B4AB0)
#define CLASS_1_35B5591E4067D7D2_SET_BGPATH_OFFSET UNITYSDK_OFFSET(0x147B4AE0)
#define CLASS_1_35B5591E4067D7D2_SET_DESC_OFFSET UNITYSDK_OFFSET(0x147B4B40)
#define CLASS_1_35B5591E4067D7D2_SET_EQUIPMENT3DTGAPATH_OFFSET UNITYSDK_OFFSET(0x147B4AA0)
#define CLASS_1_35B5591E4067D7D2_SET_EQUIPMENTLIGHTMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x147B4A80)
#define CLASS_1_35B5591E4067D7D2_SET_FIRSTWORDTEXT_OFFSET UNITYSDK_OFFSET(0x147B4B60)
#define CLASS_1_35B5591E4067D7D2_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x147B4A20)
#define CLASS_1_35B5591E4067D7D2_SET_LIGHTCONECARDBACKIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x147B4B00)
#define CLASS_1_35B5591E4067D7D2_SET_MIDDLEICONPATH_OFFSET UNITYSDK_OFFSET(0x147B4A40)
#define CLASS_1_35B5591E4067D7D2_SET_NAME_OFFSET UNITYSDK_OFFSET(0x147B4B20)
#define CLASS_1_35B5591E4067D7D2_SET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x147B4A60)
#define CLASS_1_35B5591E4067D7D2_SET_TALKICONPATH_OFFSET UNITYSDK_OFFSET(0x147B4AC0)
#define CLASS_1_35B5591E4067D7D2__CTOR_OFFSET UNITYSDK_OFFSET(0x147B4B70)
...
public:
	...
	::System::String* _EquipmentLightMaterialPath_k__BackingField; // 0x18
	::System::String* _LightConeCardBackImagePath_k__BackingField; // 0x20
	::System::String* _TalkIconPath_k__BackingField; // 0x28
	::System::String* _BgPath_k__BackingField; // 0x30
	::System::String* _IconPath_k__BackingField; // 0x38
	::System::String* _MiddleIconPath_k__BackingField; // 0x40
	::System::String* _SmallIconPath_k__BackingField; // 0x48
	::System::String* _Equipment3DTgaPath_k__BackingField; // 0x50
