...
#define ROOTMOTION_FINALIK_GROUNDRAYCASTHIT_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x2DD80)
#define ROOTMOTION_FINALIK_GROUNDRAYCASTHIT_GET_ISVALIDHITINTHREAD_OFFSET UNITYSDK_OFFSET(0x2DD70)
#define ROOTMOTION_FINALIK_GROUNDRAYCASTHIT_GET_ISVALIDHIT_OFFSET UNITYSDK_OFFSET(0x2DD00)
