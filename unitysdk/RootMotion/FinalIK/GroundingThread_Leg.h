...
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_GETHEIGHTFROMGROUND_OFFSET UNITYSDK_OFFSET(0x2E500)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x2E3B0)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_GETROTATIONOFFSETTARGET_OFFSET UNITYSDK_OFFSET(0x2E620)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_GETSPHEREHIT_OFFSET UNITYSDK_OFFSET(0x2E380)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_GET_ROOTYOFFSET_OFFSET UNITYSDK_OFFSET(0x2E760)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_GET_STEPHEIGHTFROMGROUND_OFFSET UNITYSDK_OFFSET(0x2E330)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_MOVEIKOFFSET_OFFSET UNITYSDK_OFFSET(0x2E2C0)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_PROCESSROTATION_OFFSET UNITYSDK_OFFSET(0x2E8F0)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_PROCESS_OFFSET UNITYSDK_OFFSET(0x2E310)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_ROTATEFOOT_OFFSET UNITYSDK_OFFSET(0x2E610)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_ROTATENORMAL_OFFSET UNITYSDK_OFFSET(0x2E3E0)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_SETFOOTTOPLANE_OFFSET UNITYSDK_OFFSET(0x2E4C0)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_SETFOOTTOPOINT_OFFSET UNITYSDK_OFFSET(0x2E480)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_STEPUPFOOTOFFSET_OFFSET UNITYSDK_OFFSET(0x2E320)
#define ROOTMOTION_FINALIK_GROUNDINGTHREAD_LEG_UPDATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x2E820)
