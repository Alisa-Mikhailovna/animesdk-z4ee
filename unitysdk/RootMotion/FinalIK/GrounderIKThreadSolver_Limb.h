...
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GETBENDDIRECTION_OFFSET UNITYSDK_OFFSET(0x2DEF0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GETMODIFIEDBENDNORMAL_OFFSET UNITYSDK_OFFSET(0x2DF40)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_GET_AXISDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x2DF60)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_MAINTAINBEND_OFFSET UNITYSDK_OFFSET(0x2DF80)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_ONPOSTUPDATEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x2DEE0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_ONUPDATEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x2DED0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_SOLVE_OFFSET UNITYSDK_OFFSET(0x2DEC0)
