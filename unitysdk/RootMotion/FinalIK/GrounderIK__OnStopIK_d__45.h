...
#define ROOTMOTION_FINALIK_GROUNDERIK__ONSTOPIK_D__45_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xABBC3B0)
#define ROOTMOTION_FINALIK_GROUNDERIK__ONSTOPIK_D__45_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xABBC4E0)
#define ROOTMOTION_FINALIK_GROUNDERIK__ONSTOPIK_D__45_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xABBC540)
#define ROOTMOTION_FINALIK_GROUNDERIK__ONSTOPIK_D__45_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xABBC4F0)
#define ROOTMOTION_FINALIK_GROUNDERIK__ONSTOPIK_D__45_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xABBC3A0)
#define ROOTMOTION_FINALIK_GROUNDERIK__ONSTOPIK_D__45__CTOR_OFFSET UNITYSDK_OFFSET(0xABBC010)
