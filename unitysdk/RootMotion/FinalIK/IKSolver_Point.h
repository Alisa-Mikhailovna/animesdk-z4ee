...
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0xABCEBE0)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0xABCEB50)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xABCED80)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERLOCALSTATE_OFFSET UNITYSDK_OFFSET(0xABCEE70)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0xABCED20)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT_UPDATESOLVERSTATE_OFFSET UNITYSDK_OFFSET(0xABCEDE0)
#define ROOTMOTION_FINALIK_IKSOLVER_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0xABCE950)
