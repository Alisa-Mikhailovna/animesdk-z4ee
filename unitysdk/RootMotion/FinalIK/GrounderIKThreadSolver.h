...
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_SOLVE_OFFSET UNITYSDK_OFFSET(0x2DE00)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER__POSTSOLVE_OFFSET UNITYSDK_OFFSET(0x2DE90)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER__PRESOLVE_OFFSET UNITYSDK_OFFSET(0x2DE80)
