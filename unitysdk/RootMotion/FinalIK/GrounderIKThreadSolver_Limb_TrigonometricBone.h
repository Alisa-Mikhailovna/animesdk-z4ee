...
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_TRIGONOMETRICBONE_GETBENDNORMALFROMCURRENTROTATION_OFFSET UNITYSDK_OFFSET(0x2E0F0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_TRIGONOMETRICBONE_GETROTATION_OFFSET UNITYSDK_OFFSET(0x2DFF0)
#define ROOTMOTION_FINALIK_GROUNDERIKTHREADSOLVER_LIMB_TRIGONOMETRICBONE_INITIATE_OFFSET UNITYSDK_OFFSET(0x2DFB0)
