...
#define ROOTMOTION_FINALIK_GROUNDER_GETLEGSPINEBENDVECTOR_OFFSET UNITYSDK_OFFSET(0xABB5E30)
#define ROOTMOTION_FINALIK_GROUNDER_GETLEGSPINETANGENT_OFFSET UNITYSDK_OFFSET(0xABB6220)
#define ROOTMOTION_FINALIK_GROUNDER_GETSPINEOFFSETTARGET_OFFSET UNITYSDK_OFFSET(0xABB5D70)
#define ROOTMOTION_FINALIK_GROUNDER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0xABB5D60)
#define ROOTMOTION_FINALIK_GROUNDER_GET_ISIKENABLED_OFFSET UNITYSDK_OFFSET(0xABB5BF0)
#define ROOTMOTION_FINALIK_GROUNDER_GET_ISIKUPDATEENABLED_OFFSET UNITYSDK_OFFSET(0xABB5CD0)
#define ROOTMOTION_FINALIK_GROUNDER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0xABB61C0)
#define ROOTMOTION_FINALIK_GROUNDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xABB6630)
#define ROOTMOTION_FINALIK_GROUNDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xABB6620)
#define ROOTMOTION_FINALIK_GROUNDER_ONSTARTIK_OFFSET UNITYSDK_OFFSET(0xABB6640)
#define ROOTMOTION_FINALIK_GROUNDER_ONSTOPIK_OFFSET UNITYSDK_OFFSET(0xABB6690)
#define ROOTMOTION_FINALIK_GROUNDER_REFRESHIKSTATE_OFFSET UNITYSDK_OFFSET(0xABB66E0)
#define ROOTMOTION_FINALIK_GROUNDER_REFRESH_OFFSET UNITYSDK_OFFSET(0xABB5CE0)
#define ROOTMOTION_FINALIK_GROUNDER_SET_ISIKENABLED_OFFSET UNITYSDK_OFFSET(0xABB5C00)
#define ROOTMOTION_FINALIK_GROUNDER__CCTOR_OFFSET UNITYSDK_OFFSET(0xABB6A30)
#define ROOTMOTION_FINALIK_GROUNDER__CTOR_OFFSET UNITYSDK_OFFSET(0xABB6820)
...
namespace RootMotion::FinalIK
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Grounder_TypeDefinitionIndex)->GetStaticField(0x5EF0);
		}
