...
#define CLASS_1_DDD9E1356EA4ABC3__SELECTTARGET_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xE50C4A0)
#define CLASS_1_DDD9E1356EA4ABC3__SELECTTARGET_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_LITTLEGAME_CHIMERADUELGAMEENTITY__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xE50C920)
#define CLASS_1_DDD9E1356EA4ABC3__SELECTTARGET_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_LITTLEGAME_CHIMERADUELGAMEENTITY__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xE50C8B0)
#define CLASS_1_DDD9E1356EA4ABC3__SELECTTARGET_D__0_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xE50C9B0)
#define CLASS_1_DDD9E1356EA4ABC3__SELECTTARGET_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xE50C910)
#define CLASS_1_DDD9E1356EA4ABC3__SELECTTARGET_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xE50C8C0)
#define CLASS_1_DDD9E1356EA4ABC3__SELECTTARGET_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE50C490)
#define CLASS_1_DDD9E1356EA4ABC3__SELECTTARGET_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0xE50BE40)

inline static constexpr unsigned int Class_1_DDD9E1356EA4ABC3__SelectTarget_d__0_TypeDefinitionIndex = 73577;
