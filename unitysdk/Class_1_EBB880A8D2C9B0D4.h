...
#define CLASS_1_EBB880A8D2C9B0D4_GET_REQUIRESUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xB9E2640)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0xB9E2620)
#define CLASS_1_EBB880A8D2C9B0D4_GET_SURFACELIST_OFFSET UNITYSDK_OFFSET(0xB9E2610)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_011CDA9D67F544B1_OFFSET UNITYSDK_OFFSET(0xB9E0740)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_029507C9854F63E7_OFFSET UNITYSDK_OFFSET(0xB9DE340)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_0F2A1B718CAA236B_OFFSET UNITYSDK_OFFSET(0xB9E2650)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_1A73A901CB10B415_OFFSET UNITYSDK_OFFSET(0xB9E2690)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_20F8BB50E0FBEE51_OFFSET UNITYSDK_OFFSET(0xB9E1AC0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0xB9DACE0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_28695814746C5E4E_OFFSET UNITYSDK_OFFSET(0xB9DFAB0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2930745D6F02D733_OFFSET UNITYSDK_OFFSET(0xB9DEFB0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_297321ACFDDF5650_OFFSET UNITYSDK_OFFSET(0xB9DD9C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2AA2AEA4ADAE7DAC_1_OFFSET UNITYSDK_OFFSET(0xB9DE550)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_2AA2AEA4ADAE7DAC_OFFSET UNITYSDK_OFFSET(0xB9DE3B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3543E185ADE7267F_OFFSET UNITYSDK_OFFSET(0xB9DF9B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_35C22FC4636C6636_OFFSET UNITYSDK_OFFSET(0xB9E04E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0xB9DA620)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_3C713D5FB6FF9D5F_OFFSET UNITYSDK_OFFSET(0xB9E1670)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4147F14EBAE37DB9_OFFSET UNITYSDK_OFFSET(0xB9D89B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0xB9D9220)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_48F66A306BE261D7_OFFSET UNITYSDK_OFFSET(0xB9DF220)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_4FD30F236AB3F0D4_OFFSET UNITYSDK_OFFSET(0xB9D9F30)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_513B28E8F5D79998_OFFSET UNITYSDK_OFFSET(0xB9DE290)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_525C11E1C03A03AA_OFFSET UNITYSDK_OFFSET(0xB9DF560)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_56E0415ED61DFBD8_OFFSET UNITYSDK_OFFSET(0xB9DD7E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_5F2528715070ADC0_OFFSET UNITYSDK_OFFSET(0xB9DE990)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_653EEB7EF259681D_OFFSET UNITYSDK_OFFSET(0xB9E00C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_7ED03410F58071B9_OFFSET UNITYSDK_OFFSET(0xB9DF8B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0xB9D9CF0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_80ECD089EB377640_OFFSET UNITYSDK_OFFSET(0xB9E11C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_816DE7054F759A6D_OFFSET UNITYSDK_OFFSET(0xB9E18D0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_81D122F3EBFE3B2D_OFFSET UNITYSDK_OFFSET(0xB9E1FE0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_841D90BDB3E94FF6_OFFSET UNITYSDK_OFFSET(0xB9DCF20)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0xB9D8E70)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_902E5094ED6E20A2_OFFSET UNITYSDK_OFFSET(0xB9D93F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_95FF180A965BC00B_OFFSET UNITYSDK_OFFSET(0xB9E1C60)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_96087D675A0A6BF2_OFFSET UNITYSDK_OFFSET(0xB9E2410)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0xB9E25C0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_ABA49F311F6B82E0_OFFSET UNITYSDK_OFFSET(0xB9E10E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xB9DB660)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0xB9DA440)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BB71BF1E162694DE_OFFSET UNITYSDK_OFFSET(0xB9E01B0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_BBD36158AE50EC8B_OFFSET UNITYSDK_OFFSET(0xB9DB600)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C2F9324ADF5C3031_OFFSET UNITYSDK_OFFSET(0xB9E0A90)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C3A97DC040BD7DD3_OFFSET UNITYSDK_OFFSET(0xB9E12A0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C3EAACDE46DF8E59_1_OFFSET UNITYSDK_OFFSET(0xB9DE840)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_C3EAACDE46DF8E59_OFFSET UNITYSDK_OFFSET(0xB9DE6F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_CE76B71EB4CF1D47_OFFSET UNITYSDK_OFFSET(0xB9DEDF0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D29CB62E2602F1AC_OFFSET UNITYSDK_OFFSET(0xB9DF610)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0xB9DA7E0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_D68B32ED7E946B47_OFFSET UNITYSDK_OFFSET(0xB9DCED0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DC76497A3CA272B5_OFFSET UNITYSDK_OFFSET(0xB9DEBA0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_DDC113A5E50536E5_OFFSET UNITYSDK_OFFSET(0xB9DFF10)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E043C8441683C3E5_OFFSET UNITYSDK_OFFSET(0xB9E2280)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E05D8B64DF84735B_OFFSET UNITYSDK_OFFSET(0xB9E0350)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E4E4DA7D7BA3197D_OFFSET UNITYSDK_OFFSET(0xB9E20F0)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0xB9DB450)
#define CLASS_1_EBB880A8D2C9B0D4_METHOD_1_F4AD6DE35B09EAA8_OFFSET UNITYSDK_OFFSET(0xB9DD980)
#define CLASS_1_EBB880A8D2C9B0D4_SET_SUBNAVGRAPHINFO_OFFSET UNITYSDK_OFFSET(0xB9E2630)
#define CLASS_1_EBB880A8D2C9B0D4__CCTOR_OFFSET UNITYSDK_OFFSET(0xB9E26D0)
#define CLASS_1_EBB880A8D2C9B0D4__CTOR_OFFSET UNITYSDK_OFFSET(0xB9D8C30)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_EBB880A8D2C9B0D4_TypeDefinitionIndex)->GetStaticField(0x7D10);
	}
	::System::Collections::Generic::List_1<::Class_1_A1EDFD8801F68886*>* _SurfaceList_k__BackingField; // 0x10
	...
	::RPG::GameCore::FiveDimNavMapConfig* Field_1_4; // 0x28
	::RPG::GameCore::LittleGameLevelConfig* Field_1_5; // 0x30
	::System::Collections::Generic::HashSet_1<::System::UInt32>* _RequireSubMissionIDs_k__BackingField; // 0x38
	::RPG::GameCore::RuntimeGroupInfo* Field_1_7; // 0x40
	::RPG::GameCore::FiveDimLevelSettings* Field_1_8; // 0x48
	::System::Collections::Generic::List_1<::System::UInt32>* Field_1_9; // 0x50
	::Class_1_A139A18477C7681A* _SubNavGraphInfo_k__BackingField; // 0x58
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int16>* Field_1_11; // 0x60
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_A1EDFD8801F68886*>* Field_1_12; // 0x68
