...
#define CLASS_1_5092E2281751B550_1_GET_ACHIEVEMENTIDLIST_OFFSET UNITYSDK_OFFSET(0x14B6FE70)
#define CLASS_1_5092E2281751B550_1_GET_ALLYOUTPUTNUM_OFFSET UNITYSDK_OFFSET(0x14B6FEB0)
#define CLASS_1_5092E2281751B550_1_GET_ALLYPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x14B70010)
#define CLASS_1_5092E2281751B550_1_GET_BREAKRECORD_OFFSET UNITYSDK_OFFSET(0x14B6FED0)
#define CLASS_1_5092E2281751B550_1_GET_BREAKWAVECOUNTRECORD_OFFSET UNITYSDK_OFFSET(0x14B6FEF0)
#define CLASS_1_5092E2281751B550_1_GET_BRICKCOUNT_OFFSET UNITYSDK_OFFSET(0x14B70070)
#define CLASS_1_5092E2281751B550_1_GET_CASTSKILLINFOLIST_OFFSET UNITYSDK_OFFSET(0x14B6FE30)
#define CLASS_1_5092E2281751B550_1_GET_DEADCOUNT_OFFSET UNITYSDK_OFFSET(0x14B6FDF0)
#define CLASS_1_5092E2281751B550_1_GET_EXPOBTAINED_OFFSET UNITYSDK_OFFSET(0x14B6FF70)
#define CLASS_1_5092E2281751B550_1_GET_FIRSTPASS_OFFSET UNITYSDK_OFFSET(0x14B6FFB0)
#define CLASS_1_5092E2281751B550_1_GET_HEIGHTLINECOUNT_OFFSET UNITYSDK_OFFSET(0x14B6FE10)
#define CLASS_1_5092E2281751B550_1_GET_ISPVPMODE_OFFSET UNITYSDK_OFFSET(0x14B70030)
#define CLASS_1_5092E2281751B550_1_GET_LEVELGAMEMODE_OFFSET UNITYSDK_OFFSET(0x14B70050)
#define CLASS_1_5092E2281751B550_1_GET_PLAYEROUTPUTNUM_OFFSET UNITYSDK_OFFSET(0x14B6FE90)
#define CLASS_1_5092E2281751B550_1_GET_PLAYERPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x14B6FFF0)
#define CLASS_1_5092E2281751B550_1_GET_PREVEXTRAEXP_OFFSET UNITYSDK_OFFSET(0x14B6FF30)
#define CLASS_1_5092E2281751B550_1_GET_PREVLEVELTOTALEXP_OFFSET UNITYSDK_OFFSET(0x14B6FF50)
#define CLASS_1_5092E2281751B550_1_GET_PREVLEVEL_OFFSET UNITYSDK_OFFSET(0x14B6FF10)
#define CLASS_1_5092E2281751B550_1_GET_SETTLEEXPINFOLIST_OFFSET UNITYSDK_OFFSET(0x14B6FFD0)
#define CLASS_1_5092E2281751B550_1_GET_SILVERWOLFEXTRAEXP_OFFSET UNITYSDK_OFFSET(0x14B6FF90)
#define CLASS_1_5092E2281751B550_1_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0x14B6FDD0)
#define CLASS_1_5092E2281751B550_1_GET_STARIDLIST_OFFSET UNITYSDK_OFFSET(0x14B6FE50)
#define CLASS_1_5092E2281751B550_1_GET_SUCCESS_OFFSET UNITYSDK_OFFSET(0x14B6FDB0)
#define CLASS_1_5092E2281751B550_1_GET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0x14B70090)
#define CLASS_1_5092E2281751B550_1_METHOD_1_13BD520B095657CC_OFFSET UNITYSDK_OFFSET(0x14B6F870)
#define CLASS_1_5092E2281751B550_1_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x14B70110)
#define CLASS_1_5092E2281751B550_1_METHOD_1_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0x14B70170)
#define CLASS_1_5092E2281751B550_1_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x14B700B0)
#define CLASS_1_5092E2281751B550_1_METHOD_1_842446766C7EDE9B_OFFSET UNITYSDK_OFFSET(0x14B6F810)
#define CLASS_1_5092E2281751B550_1_SET_ACHIEVEMENTIDLIST_OFFSET UNITYSDK_OFFSET(0x14B6FE80)
#define CLASS_1_5092E2281751B550_1_SET_ALLYOUTPUTNUM_OFFSET UNITYSDK_OFFSET(0x14B6FEC0)
#define CLASS_1_5092E2281751B550_1_SET_ALLYPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x14B70020)
#define CLASS_1_5092E2281751B550_1_SET_BREAKRECORD_OFFSET UNITYSDK_OFFSET(0x14B6FEE0)
#define CLASS_1_5092E2281751B550_1_SET_BREAKWAVECOUNTRECORD_OFFSET UNITYSDK_OFFSET(0x14B6FF00)
#define CLASS_1_5092E2281751B550_1_SET_BRICKCOUNT_OFFSET UNITYSDK_OFFSET(0x14B70080)
#define CLASS_1_5092E2281751B550_1_SET_CASTSKILLINFOLIST_OFFSET UNITYSDK_OFFSET(0x14B6FE40)
#define CLASS_1_5092E2281751B550_1_SET_DEADCOUNT_OFFSET UNITYSDK_OFFSET(0x14B6FE00)
#define CLASS_1_5092E2281751B550_1_SET_EXPOBTAINED_OFFSET UNITYSDK_OFFSET(0x14B6FF80)
#define CLASS_1_5092E2281751B550_1_SET_FIRSTPASS_OFFSET UNITYSDK_OFFSET(0x14B6FFC0)
#define CLASS_1_5092E2281751B550_1_SET_HEIGHTLINECOUNT_OFFSET UNITYSDK_OFFSET(0x14B6FE20)
#define CLASS_1_5092E2281751B550_1_SET_ISPVPMODE_OFFSET UNITYSDK_OFFSET(0x14B70040)
#define CLASS_1_5092E2281751B550_1_SET_LEVELGAMEMODE_OFFSET UNITYSDK_OFFSET(0x14B70060)
#define CLASS_1_5092E2281751B550_1_SET_PLAYEROUTPUTNUM_OFFSET UNITYSDK_OFFSET(0x14B6FEA0)
#define CLASS_1_5092E2281751B550_1_SET_PLAYERPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x14B70000)
#define CLASS_1_5092E2281751B550_1_SET_PREVEXTRAEXP_OFFSET UNITYSDK_OFFSET(0x14B6FF40)
#define CLASS_1_5092E2281751B550_1_SET_PREVLEVELTOTALEXP_OFFSET UNITYSDK_OFFSET(0x14B6FF60)
#define CLASS_1_5092E2281751B550_1_SET_PREVLEVEL_OFFSET UNITYSDK_OFFSET(0x14B6FF20)
#define CLASS_1_5092E2281751B550_1_SET_SETTLEEXPINFOLIST_OFFSET UNITYSDK_OFFSET(0x14B6FFE0)
#define CLASS_1_5092E2281751B550_1_SET_SILVERWOLFEXTRAEXP_OFFSET UNITYSDK_OFFSET(0x14B6FFA0)
#define CLASS_1_5092E2281751B550_1_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0x14B6FDE0)
#define CLASS_1_5092E2281751B550_1_SET_STARIDLIST_OFFSET UNITYSDK_OFFSET(0x14B6FE60)
#define CLASS_1_5092E2281751B550_1_SET_SUCCESS_OFFSET UNITYSDK_OFFSET(0x14B6FDC0)
#define CLASS_1_5092E2281751B550_1_SET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0x14B700A0)
#define CLASS_1_5092E2281751B550_1__CTOR_OFFSET UNITYSDK_OFFSET(0x14B701D0)

inline static constexpr unsigned int Class_1_5092E2281751B550_1_TypeDefinitionIndex = 75070;

class Class_1_5092E2281751B550_1 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_1_D17272E82AE804C2_51*>* _CastSkillInfoList_k__BackingField; // 0x10
	...
	::RPG::Client::PlayerPlatformInfo* _AllyPlatformInfo_k__BackingField; // 0x30
	...
	::System::UInt32 _PlayerOutputNum_k__BackingField; // 0x44
	::System::Boolean _FirstPass_k__BackingField; // 0x48
	::System::Boolean _BreakRecord_k__BackingField; // 0x49
	::RPG::GameCore::TeamTowersLevelGameMode _LevelGameMode_k__BackingField; // 0x4A
	::System::Boolean _Success_k__BackingField; // 0x4B
	::System::UInt32 _StageID_k__BackingField; // 0x4C
	::System::UInt32 _SilverWolfExtraExp_k__BackingField; // 0x50
	::System::UInt32 _DeadCount_k__BackingField; // 0x54
	::System::UInt32 _ExpObtained_k__BackingField; // 0x58
	::System::UInt32 _BrickCount_k__BackingField; // 0x5C
	::System::UInt32 _PrevLevel_k__BackingField; // 0x60
	::System::UInt32 _PrevLevelTotalExp_k__BackingField; // 0x64
	::System::Boolean _BreakWaveCountRecord_k__BackingField; // 0x68
	::System::Boolean _IsPvpMode_k__BackingField; // 0x69
	::System::UInt32 _PrevExtraExp_k__BackingField; // 0x6C
	::System::UInt32 _WaveCount_k__BackingField; // 0x70
	::System::UInt32 _HeightLineCount_k__BackingField; // 0x74
	...
	::RPG::Client::Promises::IPromise_1<::Class_1_5092E2281751B550_1*>* Method_1_13BD520B095657CC(::Class_1_48AADA497C3F117F_4* a1)
	{
		return ((::RPG::Client::Promises::IPromise_1<::Class_1_5092E2281751B550_1*>*(*)(::PVOID, ::Class_1_48AADA497C3F117F_4*))((::PBYTE)hIl2Cpp + CLASS_1_5092E2281751B550_1_METHOD_1_13BD520B095657CC_OFFSET))(this, a1);
	}
