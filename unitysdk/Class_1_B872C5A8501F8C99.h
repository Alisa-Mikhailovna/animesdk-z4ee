...
#define CLASS_1_B872C5A8501F8C99_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14CE2FC0)
#define CLASS_1_B872C5A8501F8C99_GET_CANROLL_OFFSET UNITYSDK_OFFSET(0x14CE3820)
#define CLASS_1_B872C5A8501F8C99_GET_FORCESELECTBUFFID_OFFSET UNITYSDK_OFFSET(0x14CE39D0)
#define CLASS_1_B872C5A8501F8C99_GET_ROLLBUFFCOSTS_OFFSET UNITYSDK_OFFSET(0x14CE3880)
#define CLASS_1_B872C5A8501F8C99_GET_ROLLBUFFMAXTIMES_OFFSET UNITYSDK_OFFSET(0x14CE3860)
#define CLASS_1_B872C5A8501F8C99_GET_ROLLBUFFTIMES_OFFSET UNITYSDK_OFFSET(0x14CE3840)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFSOURCECURCOUNT_OFFSET UNITYSDK_OFFSET(0x14CE37E0)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFSOURCEHINTID_OFFSET UNITYSDK_OFFSET(0x14CE37C0)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFSOURCETOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x14CE3800)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFS_OFFSET UNITYSDK_OFFSET(0x14CE37A0)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTFIRSTBUFFTYPELIST_OFFSET UNITYSDK_OFFSET(0x14CE38A0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x14CE3980)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_4BFAA3B49BA5E85A_OFFSET UNITYSDK_OFFSET(0x14CE38C0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0x14CE39F0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_7CBC6699BC67CE6E_OFFSET UNITYSDK_OFFSET(0x14CE3150)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_7E950285BD871BF3_OFFSET UNITYSDK_OFFSET(0x14CE3290)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_842446766C7EDE9B_OFFSET UNITYSDK_OFFSET(0x14CE3510)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_90D2A480F48CF56F_OFFSET UNITYSDK_OFFSET(0x14CE32F0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_BAE66D5654320160_OFFSET UNITYSDK_OFFSET(0x14CE3570)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x14CE3100)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x14CE3710)
#define CLASS_1_B872C5A8501F8C99_SET_CANROLL_OFFSET UNITYSDK_OFFSET(0x14CE3830)
#define CLASS_1_B872C5A8501F8C99_SET_FORCESELECTBUFFID_OFFSET UNITYSDK_OFFSET(0x14CE39E0)
#define CLASS_1_B872C5A8501F8C99_SET_ROLLBUFFCOSTS_OFFSET UNITYSDK_OFFSET(0x14CE3890)
#define CLASS_1_B872C5A8501F8C99_SET_ROLLBUFFMAXTIMES_OFFSET UNITYSDK_OFFSET(0x14CE3870)
#define CLASS_1_B872C5A8501F8C99_SET_ROLLBUFFTIMES_OFFSET UNITYSDK_OFFSET(0x14CE3850)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFSOURCECURCOUNT_OFFSET UNITYSDK_OFFSET(0x14CE37F0)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFSOURCEHINTID_OFFSET UNITYSDK_OFFSET(0x14CE37D0)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFSOURCETOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x14CE3810)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFS_OFFSET UNITYSDK_OFFSET(0x14CE37B0)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTFIRSTBUFFTYPELIST_OFFSET UNITYSDK_OFFSET(0x14CE38B0)
#define CLASS_1_B872C5A8501F8C99__CTOR_OFFSET UNITYSDK_OFFSET(0x14CE2FA0)
