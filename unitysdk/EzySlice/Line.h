...
#define EZYSLICE_LINE_GET_DISTSQ_OFFSET UNITYSDK_OFFSET(0x254B0)
#define EZYSLICE_LINE_GET_DIST_OFFSET UNITYSDK_OFFSET(0x25460)
#define EZYSLICE_LINE_GET_POSITIONA_OFFSET UNITYSDK_OFFSET(0x254F0)
#define EZYSLICE_LINE_GET_POSITIONB_OFFSET UNITYSDK_OFFSET(0x25510)
#define EZYSLICE_LINE__CTOR_OFFSET UNITYSDK_OFFSET(0x25420)
