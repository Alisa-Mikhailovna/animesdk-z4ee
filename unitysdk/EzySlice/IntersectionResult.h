...
#define EZYSLICE_INTERSECTIONRESULT_ADDINTERSECTIONPOINT_OFFSET UNITYSDK_OFFSET(0xAA50A30)
#define EZYSLICE_INTERSECTIONRESULT_ADDLOWERHULL_OFFSET UNITYSDK_OFFSET(0xAA509D0)
#define EZYSLICE_INTERSECTIONRESULT_ADDUPPERHULL_OFFSET UNITYSDK_OFFSET(0xAA50970)
#define EZYSLICE_INTERSECTIONRESULT_CLEAR_OFFSET UNITYSDK_OFFSET(0xAA50A80)
#define EZYSLICE_INTERSECTIONRESULT_GET_INTERSECTIONPOINTCOUNT_OFFSET UNITYSDK_OFFSET(0xAA50950)
#define EZYSLICE_INTERSECTIONRESULT_GET_INTERSECTIONPOINTS_OFFSET UNITYSDK_OFFSET(0xAA50920)
#define EZYSLICE_INTERSECTIONRESULT_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xAA50960)
#define EZYSLICE_INTERSECTIONRESULT_GET_LOWERHULLCOUNT_OFFSET UNITYSDK_OFFSET(0xAA50940)
#define EZYSLICE_INTERSECTIONRESULT_GET_LOWERHULL_OFFSET UNITYSDK_OFFSET(0xAA50910)
#define EZYSLICE_INTERSECTIONRESULT_GET_UPPERHULLCOUNT_OFFSET UNITYSDK_OFFSET(0xAA50930)
#define EZYSLICE_INTERSECTIONRESULT_GET_UPPERHULL_OFFSET UNITYSDK_OFFSET(0xAA50900)
#define EZYSLICE_INTERSECTIONRESULT_ONDEBUGDRAW_1_OFFSET UNITYSDK_OFFSET(0xAA50AB0)
#define EZYSLICE_INTERSECTIONRESULT_ONDEBUGDRAW_OFFSET UNITYSDK_OFFSET(0xAA50AA0)
#define EZYSLICE_INTERSECTIONRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xAA50880)
