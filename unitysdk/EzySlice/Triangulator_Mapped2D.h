...
#define EZYSLICE_TRIANGULATOR_MAPPED2D_GET_MAPPEDVALUE_OFFSET UNITYSDK_OFFSET(0x263A0)
#define EZYSLICE_TRIANGULATOR_MAPPED2D_GET_ORIGINALVALUE_OFFSET UNITYSDK_OFFSET(0x254F0)
#define EZYSLICE_TRIANGULATOR_MAPPED2D__CTOR_OFFSET UNITYSDK_OFFSET(0x26340)
