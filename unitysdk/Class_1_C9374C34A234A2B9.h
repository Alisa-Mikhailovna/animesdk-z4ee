...
#define CLASS_1_C9374C34A234A2B9_METHOD_1_9A263B7DE0D16163_OFFSET UNITYSDK_OFFSET(0x14415DF0)
#define CLASS_1_C9374C34A234A2B9__CCTOR_OFFSET UNITYSDK_OFFSET(0x14415DC0)
...
public:
	...
	{
		return (::Il2CppArray<::RPG::GameCore::TurnBasedModifierEventScope>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9374C34A234A2B9_TypeDefinitionIndex)->GetStaticField(0x2F0C0);
	}
