...
#define CLASS_1_5B567C8A01BAEDFE_129_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C2BA2C0)
#define CLASS_1_5B567C8A01BAEDFE_129_CLONE_OFFSET UNITYSDK_OFFSET(0x1C2B9F60)
#define CLASS_1_5B567C8A01BAEDFE_129_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C2BA0C0)
#define CLASS_1_5B567C8A01BAEDFE_129_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C2B9FD0)
#define CLASS_1_5B567C8A01BAEDFE_129_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C2BA220)
#define CLASS_1_5B567C8A01BAEDFE_129_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C2BA310)
#define CLASS_1_5B567C8A01BAEDFE_129_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C2BA2E0)
#define CLASS_1_5B567C8A01BAEDFE_129_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C2B9EB0)
#define CLASS_1_5B567C8A01BAEDFE_129_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C2B9F10)
#define CLASS_1_5B567C8A01BAEDFE_129_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C2BA250)
#define CLASS_1_5B567C8A01BAEDFE_129_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C2BA2B0)
#define CLASS_1_5B567C8A01BAEDFE_129__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2BA360)
#define CLASS_1_5B567C8A01BAEDFE_129__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2B9F30)
#define CLASS_1_5B567C8A01BAEDFE_129__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2B9F20)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_129*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_129_TypeDefinitionIndex)->GetStaticField(0x34300);
	}
