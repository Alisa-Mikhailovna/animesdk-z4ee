...
#define CLASS_2_1C5A1FFE688EDC9C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15494150)
#define CLASS_2_1C5A1FFE688EDC9C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15494190)
#define CLASS_2_1C5A1FFE688EDC9C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15494270)
#define CLASS_2_1C5A1FFE688EDC9C_TICK_OFFSET UNITYSDK_OFFSET(0x154942C0)
#define CLASS_2_1C5A1FFE688EDC9C__CTOR_OFFSET UNITYSDK_OFFSET(0x15494140)
