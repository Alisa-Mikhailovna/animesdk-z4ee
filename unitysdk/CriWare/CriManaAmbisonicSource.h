...
#define CRIWARE_CRIMANAAMBISONICSOURCE_CRIINTERNALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1577A150)
#define CRIWARE_CRIMANAAMBISONICSOURCE_CRIINTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x15779E70)
#define CRIWARE_CRIMANAAMBISONICSOURCE_FORCEUPDATEAMBISONICSOURCEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1577A3B0)
#define CRIWARE_CRIMANAAMBISONICSOURCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1577A160)
#define CRIWARE_CRIMANAAMBISONICSOURCE_ROATATEAMBISONICSOURCEORIENTATIONBYTRANSFORMOFCHILD_OFFSET UNITYSDK_OFFSET(0x1577A600)
#define CRIWARE_CRIMANAAMBISONICSOURCE_UPDATEAMBISONICSOURCEORIENTATION_OFFSET UNITYSDK_OFFSET(0x15779FE0)
#define CRIWARE_CRIMANAAMBISONICSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1577A980)
