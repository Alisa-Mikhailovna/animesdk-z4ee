...
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_UNSAFENATIVEMETHODS_CRIATOMUNITY_ISOUTPUTDEVICECONNECTED_WASAPI_OFFSET UNITYSDK_OFFSET(0x15751CC0)
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_UNSAFENATIVEMETHODS_CRIATOMUNITY_STARTOUTPUTDEVICEOBSERVER_WASAPI_OFFSET UNITYSDK_OFFSET(0x15752040)
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_UNSAFENATIVEMETHODS_CRIATOMUNITY_STOPOUTPUTDEVICEOBSERVER_WASAPI_OFFSET UNITYSDK_OFFSET(0x15752190)
