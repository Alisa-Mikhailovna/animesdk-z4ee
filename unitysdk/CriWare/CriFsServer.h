...
#define CRIWARE_CRIFSSERVER_ADDREQUEST_OFFSET UNITYSDK_OFFSET(0x15766320)
#define CRIWARE_CRIFSSERVER_AWAKE_OFFSET UNITYSDK_OFFSET(0x15765D80)
#define CRIWARE_CRIFSSERVER_BINDCPK_OFFSET UNITYSDK_OFFSET(0x157668D0)
#define CRIWARE_CRIFSSERVER_BINDDIRECTORY_OFFSET UNITYSDK_OFFSET(0x157669D0)
#define CRIWARE_CRIFSSERVER_BINDFILE_OFFSET UNITYSDK_OFFSET(0x15766AE0)
#define CRIWARE_CRIFSSERVER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x15765C30)
#define CRIWARE_CRIFSSERVER_CRIINTERNALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15766310)
#define CRIWARE_CRIFSSERVER_CRIINTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x15766070)
#define CRIWARE_CRIFSSERVER_DESTROYINSTANCE_OFFSET UNITYSDK_OFFSET(0x15765470)
#define CRIWARE_CRIFSSERVER_GET_INSTALLBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x15765D60)
#define CRIWARE_CRIFSSERVER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x15765C10)
#define CRIWARE_CRIFSSERVER_INSTALL_OFFSET UNITYSDK_OFFSET(0x15766620)
#define CRIWARE_CRIFSSERVER_LOADASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0x157664D0)
#define CRIWARE_CRIFSSERVER_LOADFILE_OFFSET UNITYSDK_OFFSET(0x157663C0)
#define CRIWARE_CRIFSSERVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15765F20)
#define CRIWARE_CRIFSSERVER_SET_INSTALLBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x15765D70)
#define CRIWARE_CRIFSSERVER_WEBINSTALL_OFFSET UNITYSDK_OFFSET(0x15766690)
#define CRIWARE_CRIFSSERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x15766BF0)
...
namespace CriWare
{
	...
	public:
		...
		{
			return (::CriWare::CriFsServer**)Il2CppClass::FromTypeDefinitionIndex(CriFsServer_TypeDefinitionIndex)->GetStaticField(0x6240);
		}
