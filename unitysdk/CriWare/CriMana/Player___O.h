...
namespace CriWare::CriMana
{
	...
	public:
		...
		{
			return (::CriWare::CriMana::Player_SubtitleCallbackFromNativeDelegate**)Il2CppClass::FromTypeDefinitionIndex(Player___O_TypeDefinitionIndex)->GetStaticField(0x6590);
		}
		static ::CriWare::CriMana::Player_CuePointCallbackFromNativeDelegate** StaticGet__1___CuePointCallbackFromNative()
		{
			return (::CriWare::CriMana::Player_CuePointCallbackFromNativeDelegate**)Il2CppClass::FromTypeDefinitionIndex(Player___O_TypeDefinitionIndex)->GetStaticField(0x6598);
		}
	};
}
