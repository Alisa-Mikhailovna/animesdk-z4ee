...
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV_CREATERENDERERRESOURCE_OFFSET UNITYSDK_OFFSET(0x15769980)
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV_ONDISPOSEMANAGED_OFFSET UNITYSDK_OFFSET(0x15769A50)
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV_ONDISPOSEUNMANAGED_OFFSET UNITYSDK_OFFSET(0x15769A60)
#define CRIWARE_CRIMANA_DETAIL_AUTORESISTERRENDERERRESOURCEFACTORIES_RENDERERRESOURCEFACTORYH264YUV__CTOR_OFFSET UNITYSDK_OFFSET(0x15769A70)
