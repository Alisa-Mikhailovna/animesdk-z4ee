...
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL_CRIATOMEXVOICEPOOL_ALLOCATEWAVEVOICEPOOL_OFFSET UNITYSDK_OFFSET(0x1574FAE0)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL_CRIWAREEDDDA553_OFFSET UNITYSDK_OFFSET(0x1574F950)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL_SETDEFAULTCONFIGFORWAVEVOICEPOOL_OFFSET UNITYSDK_OFFSET(0x1574F940)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1574FC00)
#define CRIWARE_CRIATOMEXWAVEVOICEPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1574FA60)
