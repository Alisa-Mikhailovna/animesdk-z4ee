...
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_CALCULATEWORKSIZE_OFFSET UNITYSDK_OFFSET(0x15740370)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x15740480)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_DESTROY_OFFSET UNITYSDK_OFFSET(0x15740850)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_ISDESTROYABLE_OFFSET UNITYSDK_OFFSET(0x15740C70)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_SETASRRACKID_OFFSET UNITYSDK_OFFSET(0x15740950)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_SETMONAURALMIX_OFFSET UNITYSDK_OFFSET(0x15740B70)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS_CRIATOMEXOUTPUTPORT_SETVIBRATIONCHANNELLEVEL_OFFSET UNITYSDK_OFFSET(0x15740A60)
#define CRIWARE_CRIATOMEXOUTPUTPORT_NATIVEMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x15740D30)
