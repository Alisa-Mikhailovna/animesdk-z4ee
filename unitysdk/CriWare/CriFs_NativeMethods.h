...
#define CRIWARE_CRIFS_NATIVEMETHODS_CRIFS_GETMAXPATHLENGTH_OFFSET UNITYSDK_OFFSET(0x1575EEE0)
#define CRIWARE_CRIFS_NATIVEMETHODS_CRIFS_GETNUMBINDS_OFFSET UNITYSDK_OFFSET(0x1575ED30)
#define CRIWARE_CRIFS_NATIVEMETHODS_CRIFS_GETNUMOPENEDFILES_OFFSET UNITYSDK_OFFSET(0x1575EDC0)
#define CRIWARE_CRIFS_NATIVEMETHODS_CRIFS_GETNUMUSEDBINDERS_OFFSET UNITYSDK_OFFSET(0x1575EAD0)
#define CRIWARE_CRIFS_NATIVEMETHODS_CRIFS_GETNUMUSEDGROUPLOADERS_OFFSET UNITYSDK_OFFSET(0x1575EF70)
#define CRIWARE_CRIFS_NATIVEMETHODS_CRIFS_GETNUMUSEDINSTALLERS_OFFSET UNITYSDK_OFFSET(0x1575ECA0)
#define CRIWARE_CRIFS_NATIVEMETHODS_CRIFS_GETNUMUSEDLOADERS_OFFSET UNITYSDK_OFFSET(0x1575EB60)
#define CRIWARE_CRIFS_NATIVEMETHODS_CRIFS_GETNUMUSEDSTDIOHANDLES_OFFSET UNITYSDK_OFFSET(0x1575F000)
#define CRIWARE_CRIFS_NATIVEMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x1575F090)
