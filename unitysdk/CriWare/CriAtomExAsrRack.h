...
#define CRIWARE_CRIATOMEXASRRACK_APPLYDSPBUSSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x15734A30)
#define CRIWARE_CRIATOMEXASRRACK_ATTACHDSPBUSSETTING_OFFSET UNITYSDK_OFFSET(0x15734720)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_APPLYDSPBUSSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x15734B40)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_ATTACHDSPBUSSETTING_OFFSET UNITYSDK_OFFSET(0x15734820)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_CREATE_OFFSET UNITYSDK_OFFSET(0x157343F0)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_DESTROY_OFFSET UNITYSDK_OFFSET(0x157359F0)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_DETACHDSPBUSSETTING_OFFSET UNITYSDK_OFFSET(0x157349B0)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_GETAMBISONICRACKID_OFFSET UNITYSDK_OFFSET(0x15735CB0)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_GETAPPLIEDDSPBUSSNAPSHOTNAME_OFFSET UNITYSDK_OFFSET(0x15734CE0)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_GETCHANNELBASEDAUDIORACKID_OFFSET UNITYSDK_OFFSET(0x15735E00)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_GETNUMRENDEREDSAMPLES_OFFSET UNITYSDK_OFFSET(0x15735B50)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_GETOBJECTBASEDAUDIORACKID_OFFSET UNITYSDK_OFFSET(0x15735F50)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_GETPASSTHROUGHRACKID_OFFSET UNITYSDK_OFFSET(0x157360A0)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_GETPERFORMANCEINFO_OFFSET UNITYSDK_OFFSET(0x15735010)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_RESETPERFORMANCEMONITOR_OFFSET UNITYSDK_OFFSET(0x15735270)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_SETAISACCONTROLBYID_OFFSET UNITYSDK_OFFSET(0x15735680)
#define CRIWARE_CRIATOMEXASRRACK_CRIATOMEXASRRACK_SETAISACCONTROLBYNAME_OFFSET UNITYSDK_OFFSET(0x157354E0)
#define CRIWARE_CRIATOMEXASRRACK_CRIWARE132E78DA_OFFSET UNITYSDK_OFFSET(0x157345E0)
#define CRIWARE_CRIATOMEXASRRACK_CRIWARE698F7911_OFFSET UNITYSDK_OFFSET(0x157357F0)
#define CRIWARE_CRIATOMEXASRRACK_DETACHDSPBUSSETTING_OFFSET UNITYSDK_OFFSET(0x157348D0)
#define CRIWARE_CRIATOMEXASRRACK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15735870)
#define CRIWARE_CRIATOMEXASRRACK_FINALIZE_OFFSET UNITYSDK_OFFSET(0x157361C0)
#define CRIWARE_CRIATOMEXASRRACK_GETAMBISONICRACKID_OFFSET UNITYSDK_OFFSET(0x15735BE0)
#define CRIWARE_CRIATOMEXASRRACK_GETAPPLIEDDSPBUSSNAPSHOTNAME_1_OFFSET UNITYSDK_OFFSET(0x15734D60)
#define CRIWARE_CRIATOMEXASRRACK_GETAPPLIEDDSPBUSSNAPSHOTNAME_OFFSET UNITYSDK_OFFSET(0x15734BE0)
#define CRIWARE_CRIATOMEXASRRACK_GETCHANNELBASEDAUDIORACKID_OFFSET UNITYSDK_OFFSET(0x15735D30)
#define CRIWARE_CRIATOMEXASRRACK_GETCURRENTUSERIDPS5_OFFSET UNITYSDK_OFFSET(0x15734160)
#define CRIWARE_CRIATOMEXASRRACK_GETNUMRENDEREDSAMPLES_OFFSET UNITYSDK_OFFSET(0x15735A70)
#define CRIWARE_CRIATOMEXASRRACK_GETOBJECTBASEDAUDIORACKID_OFFSET UNITYSDK_OFFSET(0x15735E80)
#define CRIWARE_CRIATOMEXASRRACK_GETPASSTHROUGHRACKID_OFFSET UNITYSDK_OFFSET(0x15735FD0)
#define CRIWARE_CRIATOMEXASRRACK_GETPERFORMANCEINFOBYRACKID_OFFSET UNITYSDK_OFFSET(0x15735090)
#define CRIWARE_CRIATOMEXASRRACK_GETPERFORMANCEINFO_OFFSET UNITYSDK_OFFSET(0x15734E60)
#define CRIWARE_CRIATOMEXASRRACK_GET_DEFAULTCONFIG_OFFSET UNITYSDK_OFFSET(0x15736190)
#define CRIWARE_CRIATOMEXASRRACK_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x15736130)
#define CRIWARE_CRIATOMEXASRRACK_GET_RACKID_OFFSET UNITYSDK_OFFSET(0x15736120)
#define CRIWARE_CRIATOMEXASRRACK_ISUSERIDSETTABLEPS5_OFFSET UNITYSDK_OFFSET(0x15734120)
#define CRIWARE_CRIATOMEXASRRACK_RESETPERFORMANCEMONITORBYRACKID_OFFSET UNITYSDK_OFFSET(0x157352F0)
#define CRIWARE_CRIATOMEXASRRACK_RESETPERFORMANCEMONITOR_OFFSET UNITYSDK_OFFSET(0x15735190)
#define CRIWARE_CRIATOMEXASRRACK_SETAISACCONTROL_1_OFFSET UNITYSDK_OFFSET(0x15735590)
#define CRIWARE_CRIATOMEXASRRACK_SETAISACCONTROL_OFFSET UNITYSDK_OFFSET(0x157353D0)
#define CRIWARE_CRIATOMEXASRRACK_SETDEFAULTCONFIG_ANDROID_OFFSET UNITYSDK_OFFSET(0x157340E0)
#define CRIWARE_CRIATOMEXASRRACK_SETDEFAULTCONFIG_OFFSET UNITYSDK_OFFSET(0x15735710)
#define CRIWARE_CRIATOMEXASRRACK_SETDEFAULTCONFIG_PS5_OFFSET UNITYSDK_OFFSET(0x15734100)
#define CRIWARE_CRIATOMEXASRRACK_SETUSERIDPS5_OFFSET UNITYSDK_OFFSET(0x15734140)
#define CRIWARE_CRIATOMEXASRRACK__CCTOR_OFFSET UNITYSDK_OFFSET(0x15736230)
#define CRIWARE_CRIATOMEXASRRACK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15734480)
#define CRIWARE_CRIATOMEXASRRACK__CTOR_2_OFFSET UNITYSDK_OFFSET(0x15734670)
#define CRIWARE_CRIATOMEXASRRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x15734180)
...
namespace CriWare
{
	...
	public:
		...
		{
			return (::CriWare::CriAtomExAsrRack**)Il2CppClass::FromTypeDefinitionIndex(CriAtomExAsrRack_TypeDefinitionIndex)->GetStaticField(0x4D70);
		}
