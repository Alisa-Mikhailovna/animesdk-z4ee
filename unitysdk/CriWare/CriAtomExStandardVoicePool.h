...
#define CRIWARE_CRIATOMEXSTANDARDVOICEPOOL_CRIATOMEXVOICEPOOL_ALLOCATESTANDARDVOICEPOOL_OFFSET UNITYSDK_OFFSET(0x1574E1B0)
#define CRIWARE_CRIATOMEXSTANDARDVOICEPOOL_CRIWARE69557BDA_OFFSET UNITYSDK_OFFSET(0x1574E020)
#define CRIWARE_CRIATOMEXSTANDARDVOICEPOOL_SETDEFAULTCONFIGFORSTANDARDVOICEPOOL_OFFSET UNITYSDK_OFFSET(0x1574E010)
#define CRIWARE_CRIATOMEXSTANDARDVOICEPOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1574E2D0)
#define CRIWARE_CRIATOMEXSTANDARDVOICEPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1574E130)
