...
#define CRIWARE_CRIATOMEXLATENCYESTIMATOR_FINALIZEMODULE_OFFSET UNITYSDK_OFFSET(0x1573B040)
#define CRIWARE_CRIATOMEXLATENCYESTIMATOR_GETCURRENTINFO_OFFSET UNITYSDK_OFFSET(0x1573B050)
#define CRIWARE_CRIATOMEXLATENCYESTIMATOR_INITIALIZEMODULE_OFFSET UNITYSDK_OFFSET(0x1573B030)
