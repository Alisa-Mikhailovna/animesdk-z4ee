...
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_GETCURRENTUSERID_PS5_OFFSET UNITYSDK_OFFSET(0x15734170)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_ISUSERIDSETTABLE_PS5_OFFSET UNITYSDK_OFFSET(0x15734130)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_SETDEFAULTCONFIG_ANDROID_MACRO_OFFSET UNITYSDK_OFFSET(0x157340F0)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_SETDEFAULTCONFIG_PS5_MACRO_OFFSET UNITYSDK_OFFSET(0x15734110)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS_CRIATOMEXASRRACK_SETUSERID_PS5_OFFSET UNITYSDK_OFFSET(0x15734150)
#define CRIWARE_CRIATOMEXASRRACK_NATIVEMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x15736420)
