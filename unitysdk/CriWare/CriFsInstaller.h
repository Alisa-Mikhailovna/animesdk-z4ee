...
#define CRIWARE_CRIFSINSTALLER_COPY_OFFSET UNITYSDK_OFFSET(0x15761B30)
#define CRIWARE_CRIFSINSTALLER_CRIFSINSTALLER_COPY_OFFSET UNITYSDK_OFFSET(0x157624A0)
#define CRIWARE_CRIFSINSTALLER_CRIFSINSTALLER_CREATE_OFFSET UNITYSDK_OFFSET(0x15762930)
#define CRIWARE_CRIFSINSTALLER_CRIFSINSTALLER_DESTROY_OFFSET UNITYSDK_OFFSET(0x15762420)
#define CRIWARE_CRIFSINSTALLER_CRIFSINSTALLER_EXECUTEMAIN_OFFSET UNITYSDK_OFFSET(0x157627B0)
#define CRIWARE_CRIFSINSTALLER_CRIFSINSTALLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x157626A0)
#define CRIWARE_CRIFSINSTALLER_CRIFSINSTALLER_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x15762610)
#define CRIWARE_CRIFSINSTALLER_CRIFSINSTALLER_STOP_OFFSET UNITYSDK_OFFSET(0x15762590)
#define CRIWARE_CRIFSINSTALLER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x15762310)
#define CRIWARE_CRIFSINSTALLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x157621B0)
#define CRIWARE_CRIFSINSTALLER_EXECUTEMAIN_OFFSET UNITYSDK_OFFSET(0x15762730)
#define CRIWARE_CRIFSINSTALLER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x15762830)
#define CRIWARE_CRIFSINSTALLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x15762070)
#define CRIWARE_CRIFSINSTALLER_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x15762110)
#define CRIWARE_CRIFSINSTALLER_STOP_OFFSET UNITYSDK_OFFSET(0x15761990)
#define CRIWARE_CRIFSINSTALLER__CTOR_OFFSET UNITYSDK_OFFSET(0x15761AD0)
