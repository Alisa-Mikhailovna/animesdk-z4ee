...
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_CRIATOMEXPLAYBACK_GETAISACCONTROLBYID_OFFSET UNITYSDK_OFFSET(0x15742770)
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_CRIATOMEXPLAYBACK_GETAISACCONTROLBYNAME_OFFSET UNITYSDK_OFFSET(0x157428B0)
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_CRIATOMEXPLAYBACK_GETPARAMETERFLOAT32_OFFSET UNITYSDK_OFFSET(0x15742410)
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_CRIATOMEXPLAYBACK_GETPARAMETERSINT32_OFFSET UNITYSDK_OFFSET(0x15742650)
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_CRIATOMEXPLAYBACK_GETPARAMETERUINT32_OFFSET UNITYSDK_OFFSET(0x15742530)
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_GETAISACCONTROL_1_OFFSET UNITYSDK_OFFSET(0x15742800)
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_GETAISACCONTROL_OFFSET UNITYSDK_OFFSET(0x157426E0)
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_GETPARAMETER_1_OFFSET UNITYSDK_OFFSET(0x157424A0)
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_GETPARAMETER_2_OFFSET UNITYSDK_OFFSET(0x157425C0)
#define CRIWARE_CRIATOMEXPLAYBACKDEBUG_GETPARAMETER_OFFSET UNITYSDK_OFFSET(0x15742380)
