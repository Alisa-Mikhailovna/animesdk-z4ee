...
#define CRIWARE_CRIATOM_NATIVEMETHODS_CRIATOM_GETTHREADPRIORITY_ANDROID_OFFSET UNITYSDK_OFFSET(0x15715DA0)
#define CRIWARE_CRIATOM_NATIVEMETHODS_CRIATOM_SETTHREADPRIORITY_ANDROID_OFFSET UNITYSDK_OFFSET(0x15715DC0)
#define CRIWARE_CRIATOM_NATIVEMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x1571BD90)
