...
#define CLASS_1_D0CCDBD424B46DAF_EQUALS_OFFSET UNITYSDK_OFFSET(0x14622C20)
#define CLASS_1_D0CCDBD424B46DAF_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x14622C80)
#define CLASS_1_D0CCDBD424B46DAF__CCTOR_OFFSET UNITYSDK_OFFSET(0x14622D20)
#define CLASS_1_D0CCDBD424B46DAF__CTOR_OFFSET UNITYSDK_OFFSET(0x14622D10)
...
public:
	...
	{
		return (::Class_1_D0CCDBD424B46DAF**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D0CCDBD424B46DAF_TypeDefinitionIndex)->GetStaticField(0xFC40);
	}
