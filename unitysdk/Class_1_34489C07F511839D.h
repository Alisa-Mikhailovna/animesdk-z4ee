...
#define CLASS_1_34489C07F511839D_GET_ADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x14BFB940)
#define CLASS_1_34489C07F511839D_GET_AICONFIGPATH_OFFSET UNITYSDK_OFFSET(0x14BFBA80)
#define CLASS_1_34489C07F511839D_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x14BFB8C0)
#define CLASS_1_34489C07F511839D_GET_DEFAULTUNLOCKTRACENODEPROFILES_OFFSET UNITYSDK_OFFSET(0x14BFBB40)
#define CLASS_1_34489C07F511839D_GET_EIDOLONIDS_OFFSET UNITYSDK_OFFSET(0x14BFBA40)
#define CLASS_1_34489C07F511839D_GET_ENGLISHNAME_OFFSET UNITYSDK_OFFSET(0x14BFB900)
#define CLASS_1_34489C07F511839D_GET_EXPGROUP_OFFSET UNITYSDK_OFFSET(0x14BFB9E0)
#define CLASS_1_34489C07F511839D_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x14BFB890)
#define CLASS_1_34489C07F511839D_GET_JSONCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x14BFB980)
#define CLASS_1_34489C07F511839D_GET_MAXEIDOLONLEVEL_OFFSET UNITYSDK_OFFSET(0x14BFBA20)
#define CLASS_1_34489C07F511839D_GET_MAXPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x14BFBA00)
#define CLASS_1_34489C07F511839D_GET_MAXSP_OFFSET UNITYSDK_OFFSET(0x14BFB9C0)
#define CLASS_1_34489C07F511839D_GET_NAME_OFFSET UNITYSDK_OFFSET(0x14BFB8E0)
#define CLASS_1_34489C07F511839D_GET_NATUREID_OFFSET UNITYSDK_OFFSET(0x14BFB9A0)
#define CLASS_1_34489C07F511839D_GET_PATH_OFFSET UNITYSDK_OFFSET(0x14BFB8A0)
#define CLASS_1_34489C07F511839D_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x14BFB960)
#define CLASS_1_34489C07F511839D_GET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0x14BFBA60)
#define CLASS_1_34489C07F511839D_GET_SPECIALULTRASKILLENERGYLACKTIPS_OFFSET UNITYSDK_OFFSET(0x14BFBB00)
#define CLASS_1_34489C07F511839D_GET_SPECIALULTRASKILLRESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x14BFBAE0)
#define CLASS_1_34489C07F511839D_GET_TRACEANCHORTYPES_OFFSET UNITYSDK_OFFSET(0x14BFBB20)
#define CLASS_1_34489C07F511839D_GET_TRACETREEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x14BFBAA0)
#define CLASS_1_34489C07F511839D_GET_ULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0x14BFBAC0)
#define CLASS_1_34489C07F511839D_GET_VOTAG_OFFSET UNITYSDK_OFFSET(0x14BFB920)
#define CLASS_1_34489C07F511839D_SET_ADVENTUREPLAYERID_OFFSET UNITYSDK_OFFSET(0x14BFB950)
#define CLASS_1_34489C07F511839D_SET_AICONFIGPATH_OFFSET UNITYSDK_OFFSET(0x14BFBA90)
#define CLASS_1_34489C07F511839D_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x14BFB8D0)
#define CLASS_1_34489C07F511839D_SET_DEFAULTUNLOCKTRACENODEPROFILES_OFFSET UNITYSDK_OFFSET(0x14BFBB50)
#define CLASS_1_34489C07F511839D_SET_EIDOLONIDS_OFFSET UNITYSDK_OFFSET(0x14BFBA50)
#define CLASS_1_34489C07F511839D_SET_ENGLISHNAME_OFFSET UNITYSDK_OFFSET(0x14BFB910)
#define CLASS_1_34489C07F511839D_SET_EXPGROUP_OFFSET UNITYSDK_OFFSET(0x14BFB9F0)
#define CLASS_1_34489C07F511839D_SET_JSONCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x14BFB990)
#define CLASS_1_34489C07F511839D_SET_MAXEIDOLONLEVEL_OFFSET UNITYSDK_OFFSET(0x14BFBA30)
#define CLASS_1_34489C07F511839D_SET_MAXPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0x14BFBA10)
#define CLASS_1_34489C07F511839D_SET_MAXSP_OFFSET UNITYSDK_OFFSET(0x14BFB9D0)
#define CLASS_1_34489C07F511839D_SET_NAME_OFFSET UNITYSDK_OFFSET(0x14BFB8F0)
#define CLASS_1_34489C07F511839D_SET_NATUREID_OFFSET UNITYSDK_OFFSET(0x14BFB9B0)
#define CLASS_1_34489C07F511839D_SET_PATH_OFFSET UNITYSDK_OFFSET(0x14BFB8B0)
#define CLASS_1_34489C07F511839D_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x14BFB970)
#define CLASS_1_34489C07F511839D_SET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0x14BFBA70)
#define CLASS_1_34489C07F511839D_SET_SPECIALULTRASKILLENERGYLACKTIPS_OFFSET UNITYSDK_OFFSET(0x14BFBB10)
#define CLASS_1_34489C07F511839D_SET_SPECIALULTRASKILLRESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x14BFBAF0)
#define CLASS_1_34489C07F511839D_SET_TRACEANCHORTYPES_OFFSET UNITYSDK_OFFSET(0x14BFBB30)
#define CLASS_1_34489C07F511839D_SET_TRACETREEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x14BFBAB0)
#define CLASS_1_34489C07F511839D_SET_ULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0x14BFBAD0)
#define CLASS_1_34489C07F511839D_SET_VOTAG_OFFSET UNITYSDK_OFFSET(0x14BFB930)
#define CLASS_1_34489C07F511839D__CTOR_OFFSET UNITYSDK_OFFSET(0x14BFBB60)
...
{
public:
	::Il2CppArray<::System::UInt32>* _EidolonIDs_k__BackingField; // 0x10
	...
	::Class_1_A3A2B28DB41BA84A_1* _DamageType_k__BackingField; // 0x28
	...
	::System::String* _SpecialUltraSkillResourcePath_k__BackingField; // 0x48
	::System::String* _AIConfigPath_k__BackingField; // 0x50
	::Il2CppArray<::System::UInt32>* _SkillIDs_k__BackingField; // 0x58
	::System::Collections::Generic::IReadOnlyList_1<::RPG::GameCore::AvatarSkillTreeAnchorType>* _TraceAnchorTypes_k__BackingField; // 0x60
	::RPG::Client::TextID _SpecialUltraSkillEnergyLackTips_k__BackingField; // 0x68
	::System::UInt32 _NatureID_k__BackingField; // 0x78
	::System::UInt32 _ExpGroup_k__BackingField; // 0x7C
	::System::UInt32 _AdventurePlayerID_k__BackingField; // 0x80
	::System::UInt32 _MaxEidolonLevel_k__BackingField; // 0x84
	::RPG::Client::TextID _Name_k__BackingField; // 0x88
	::RPG::GameCore::FixPoint _MaxSP_k__BackingField; // 0x98
	::System::UInt32 _MaxPromotionLevel_k__BackingField; // 0xA0
	::Struct_2_BC950E36747FB4C9 _Identifier_k__BackingField; // 0xA4
	::RPG::GameCore::CombatPowerAvatarRarityType _Rarity_k__BackingField; // 0xAC
	::RPG::GameCore::AvatarSpecialUltraType _UltraSkillType_k__BackingField; // 0xB0
	::RPG::Client::TextID _EnglishName_k__BackingField; // 0xB8
