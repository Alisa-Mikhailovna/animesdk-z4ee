...
#define CLASS_1_B590C31C505191E5_5_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C2BF390)
#define CLASS_1_B590C31C505191E5_5_CLONE_OFFSET UNITYSDK_OFFSET(0x1C2BEE50)
#define CLASS_1_B590C31C505191E5_5_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C2BF000)
#define CLASS_1_B590C31C505191E5_5_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C2BEED0)
#define CLASS_1_B590C31C505191E5_5_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C2BF100)
#define CLASS_1_B590C31C505191E5_5_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C2BF470)
#define CLASS_1_B590C31C505191E5_5_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C2BF420)
#define CLASS_1_B590C31C505191E5_5_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C2BED00)
#define CLASS_1_B590C31C505191E5_5_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1C2BEEC0)
#define CLASS_1_B590C31C505191E5_5_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1C2BEEB0)
#define CLASS_1_B590C31C505191E5_5_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1C2BEEA0)
#define CLASS_1_B590C31C505191E5_5_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C2BED60)
#define CLASS_1_B590C31C505191E5_5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C2BF200)
#define CLASS_1_B590C31C505191E5_5_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C2BF260)
#define CLASS_1_B590C31C505191E5_5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2BF640)
#define CLASS_1_B590C31C505191E5_5__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C2BEDC0)
#define CLASS_1_B590C31C505191E5_5__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2BED70)
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_5_TypeDefinitionIndex)->GetStaticField(0x348E0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_5*>** StaticGet_Field_1_1()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B590C31C505191E5_5*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B590C31C505191E5_5_TypeDefinitionIndex)->GetStaticField(0x348E8);
	}
