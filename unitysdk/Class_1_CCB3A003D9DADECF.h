...
#define CLASS_1_CCB3A003D9DADECF_GET_ATKSPD_OFFSET UNITYSDK_OFFSET(0xBA14AA0)
#define CLASS_1_CCB3A003D9DADECF_GET_ATK_OFFSET UNITYSDK_OFFSET(0xBA14A60)
#define CLASS_1_CCB3A003D9DADECF_GET_ATTACKCD_OFFSET UNITYSDK_OFFSET(0xBA14AC0)
#define CLASS_1_CCB3A003D9DADECF_GET_ATTACKRANGE_OFFSET UNITYSDK_OFFSET(0xBA14B40)
#define CLASS_1_CCB3A003D9DADECF_GET_CRTCHANCE_OFFSET UNITYSDK_OFFSET(0xBA14B00)
#define CLASS_1_CCB3A003D9DADECF_GET_CRTDAMAGERATIO_OFFSET UNITYSDK_OFFSET(0xBA14B20)
#define CLASS_1_CCB3A003D9DADECF_GET_HP_OFFSET UNITYSDK_OFFSET(0xBA14A80)
#define CLASS_1_CCB3A003D9DADECF_GET_MOVESPD_OFFSET UNITYSDK_OFFSET(0xBA14AE0)
#define CLASS_1_CCB3A003D9DADECF_GET_READYSCALE_OFFSET UNITYSDK_OFFSET(0xBA14A40)
#define CLASS_1_CCB3A003D9DADECF_GET_SCALE_OFFSET UNITYSDK_OFFSET(0xBA14A20)
#define CLASS_1_CCB3A003D9DADECF_GET_SIZETIER_OFFSET UNITYSDK_OFFSET(0xBA14A00)
#define CLASS_1_CCB3A003D9DADECF_GET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0xBA149E0)
#define CLASS_1_CCB3A003D9DADECF_GET_UNITID_OFFSET UNITYSDK_OFFSET(0xBA149C0)
#define CLASS_1_CCB3A003D9DADECF_METHOD_1_25373A99E7C2BF9C_OFFSET UNITYSDK_OFFSET(0xBA14740)
#define CLASS_1_CCB3A003D9DADECF_METHOD_1_8C90C775EAE86885_OFFSET UNITYSDK_OFFSET(0xBA14830)
#define CLASS_1_CCB3A003D9DADECF_METHOD_1_EA672F77F1086A27_OFFSET UNITYSDK_OFFSET(0xBA14970)
#define CLASS_1_CCB3A003D9DADECF_SET_ATKSPD_OFFSET UNITYSDK_OFFSET(0xBA14AB0)
#define CLASS_1_CCB3A003D9DADECF_SET_ATK_OFFSET UNITYSDK_OFFSET(0xBA14A70)
#define CLASS_1_CCB3A003D9DADECF_SET_ATTACKCD_OFFSET UNITYSDK_OFFSET(0xBA14AD0)
#define CLASS_1_CCB3A003D9DADECF_SET_ATTACKRANGE_OFFSET UNITYSDK_OFFSET(0xBA14B50)
#define CLASS_1_CCB3A003D9DADECF_SET_CRTCHANCE_OFFSET UNITYSDK_OFFSET(0xBA14B10)
#define CLASS_1_CCB3A003D9DADECF_SET_CRTDAMAGERATIO_OFFSET UNITYSDK_OFFSET(0xBA14B30)
#define CLASS_1_CCB3A003D9DADECF_SET_HP_OFFSET UNITYSDK_OFFSET(0xBA14A90)
#define CLASS_1_CCB3A003D9DADECF_SET_MOVESPD_OFFSET UNITYSDK_OFFSET(0xBA14AF0)
#define CLASS_1_CCB3A003D9DADECF_SET_READYSCALE_OFFSET UNITYSDK_OFFSET(0xBA14A50)
#define CLASS_1_CCB3A003D9DADECF_SET_SCALE_OFFSET UNITYSDK_OFFSET(0xBA14A30)
#define CLASS_1_CCB3A003D9DADECF_SET_SIZETIER_OFFSET UNITYSDK_OFFSET(0xBA14A10)
#define CLASS_1_CCB3A003D9DADECF_SET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0xBA149F0)
#define CLASS_1_CCB3A003D9DADECF_SET_UNITID_OFFSET UNITYSDK_OFFSET(0xBA149D0)
#define CLASS_1_CCB3A003D9DADECF__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBA14500)
#define CLASS_1_CCB3A003D9DADECF__CTOR_2_OFFSET UNITYSDK_OFFSET(0xBA145C0)
#define CLASS_1_CCB3A003D9DADECF__CTOR_OFFSET UNITYSDK_OFFSET(0xBA143A0)

inline static constexpr unsigned int Class_1_CCB3A003D9DADECF_TypeDefinitionIndex = 74026;

class Class_1_CCB3A003D9DADECF : public ::System::Object
{
public:
	::RPG::GameCore::FixPoint _CrtDamageRatio_k__BackingField; // 0x10
	::RPG::GameCore::FixPoint _Hp_k__BackingField; // 0x18
	::System::Single _Scale_k__BackingField; // 0x20
	::System::UInt32 _SizeTier_k__BackingField; // 0x24
	::System::UInt32 _UnitID_k__BackingField; // 0x28
	::System::Single _ReadyScale_k__BackingField; // 0x2C
	::RPG::GameCore::FixPoint _CrtChance_k__BackingField; // 0x30
	::RPG::GameCore::FixPoint _AtkSpd_k__BackingField; // 0x38
	::RPG::GameCore::FixPoint _AttackRange_k__BackingField; // 0x40
	::System::UInt32 _SoldierID_k__BackingField; // 0x48
	::System::Single _AttackCD_k__BackingField; // 0x4C
	::RPG::GameCore::FixPoint _Atk_k__BackingField; // 0x50
