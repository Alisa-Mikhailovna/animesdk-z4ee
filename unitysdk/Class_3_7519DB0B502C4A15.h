...
#define CLASS_3_7519DB0B502C4A15_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE510960)
#define CLASS_3_7519DB0B502C4A15__CCTOR_OFFSET UNITYSDK_OFFSET(0xE510F70)
#define CLASS_3_7519DB0B502C4A15__CTOR_OFFSET UNITYSDK_OFFSET(0xE510930)
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_3_7519DB0B502C4A15_TypeDefinitionIndex)->GetStaticField(0x68270);
	}
