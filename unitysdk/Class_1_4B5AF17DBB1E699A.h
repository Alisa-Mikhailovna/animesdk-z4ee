...
#define CLASS_1_4B5AF17DBB1E699A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1485AEA0)
#define CLASS_1_4B5AF17DBB1E699A_GET_BUFFCONFIG_OFFSET UNITYSDK_OFFSET(0x1485B660)
#define CLASS_1_4B5AF17DBB1E699A_GET_CELLCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x1485B5E0)
#define CLASS_1_4B5AF17DBB1E699A_GET_CHENLINGCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x1485B5C0)
#define CLASS_1_4B5AF17DBB1E699A_GET_FIELDCONFIG_OFFSET UNITYSDK_OFFSET(0x1485B580)
#define CLASS_1_4B5AF17DBB1E699A_GET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0x1485B680)
#define CLASS_1_4B5AF17DBB1E699A_GET_ITEMCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x1485B5A0)
#define CLASS_1_4B5AF17DBB1E699A_GET_ITEMRULEGROUPIDMAP_OFFSET UNITYSDK_OFFSET(0x1485B600)
#define CLASS_1_4B5AF17DBB1E699A_GET_REGIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1485B640)
#define CLASS_1_4B5AF17DBB1E699A_GET_UNLOCKNORMALCELLPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1485B620)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_0E6A03665498E7FE_1_OFFSET UNITYSDK_OFFSET(0x1485B430)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_0E6A03665498E7FE_OFFSET UNITYSDK_OFFSET(0x1485B2E0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_1624976974349EA1_OFFSET UNITYSDK_OFFSET(0x1485B0D0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_7BDBE8E7DCCDC6EB_OFFSET UNITYSDK_OFFSET(0x1485B030)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_AA041EC2967F998A_OFFSET UNITYSDK_OFFSET(0x1485B1F0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_B13A68870DC37DD0_OFFSET UNITYSDK_OFFSET(0x1485B6A0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0x1485AAA0)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_C35E27D6493C2262_OFFSET UNITYSDK_OFFSET(0x1485B080)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_D81AF5D2D64FAA0F_OFFSET UNITYSDK_OFFSET(0x1485B280)
#define CLASS_1_4B5AF17DBB1E699A_METHOD_1_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x1485A370)
#define CLASS_1_4B5AF17DBB1E699A_SET_BUFFCONFIG_OFFSET UNITYSDK_OFFSET(0x1485B670)
#define CLASS_1_4B5AF17DBB1E699A_SET_CELLCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x1485B5F0)
#define CLASS_1_4B5AF17DBB1E699A_SET_CHENLINGCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x1485B5D0)
#define CLASS_1_4B5AF17DBB1E699A_SET_FIELDCONFIG_OFFSET UNITYSDK_OFFSET(0x1485B590)
#define CLASS_1_4B5AF17DBB1E699A_SET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0x1485B690)
#define CLASS_1_4B5AF17DBB1E699A_SET_ITEMCONFIGMAP_OFFSET UNITYSDK_OFFSET(0x1485B5B0)
#define CLASS_1_4B5AF17DBB1E699A_SET_ITEMRULEGROUPIDMAP_OFFSET UNITYSDK_OFFSET(0x1485B610)
#define CLASS_1_4B5AF17DBB1E699A_SET_REGIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1485B650)
#define CLASS_1_4B5AF17DBB1E699A_SET_UNLOCKNORMALCELLPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1485B630)
#define CLASS_1_4B5AF17DBB1E699A__CCTOR_OFFSET UNITYSDK_OFFSET(0x1485B6B0)
#define CLASS_1_4B5AF17DBB1E699A__CTOR_OFFSET UNITYSDK_OFFSET(0x1485A150)

inline static constexpr unsigned int Class_1_4B5AF17DBB1E699A_TypeDefinitionIndex = 73795;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4B5AF17DBB1E699A_TypeDefinitionIndex)->GetStaticField(0x5EE70);
	}
	::RPG::GameCore::LittleGameEntityConfig* _FieldConfig_k__BackingField; // 0x10
	::RPG::GameCore::ChenLingFesBuffConfig* _BuffConfig_k__BackingField; // 0x18
	::Class_3_97041AE90E3B2214* Field_1_3; // 0x20
	::RPG::GameCore::LittleGameLevelConfig* Field_1_4; // 0x28
	::RPG::GameCore::LittleGameLevelConfig* Field_1_5; // 0x30
	::System::String* _UnlockNormalCellPrefabPath_k__BackingField; // 0x38
	::RPG::Client::TwoKeyDictionary_3<::System::UInt32, ::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* _ChenLingConfigMap_k__BackingField; // 0x40
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::LittleGameEntityConfig*>* _ItemConfigMap_k__BackingField; // 0x48
	::RPG::GameCore::ChenLingFesLevelConfigRow* Field_1_9; // 0x50
