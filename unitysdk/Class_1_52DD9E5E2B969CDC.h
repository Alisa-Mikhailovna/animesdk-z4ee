...
#define CLASS_1_52DD9E5E2B969CDC_CLEAR_OFFSET UNITYSDK_OFFSET(0x146FD440)
#define CLASS_1_52DD9E5E2B969CDC_GET_AUDIENCEMOODMAPCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x146FD2C0)
#define CLASS_1_52DD9E5E2B969CDC_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x146FD300)
#define CLASS_1_52DD9E5E2B969CDC_GET_CROWDVARIANTPATH_OFFSET UNITYSDK_OFFSET(0x146FD2A0)
#define CLASS_1_52DD9E5E2B969CDC_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x146FD320)
#define CLASS_1_52DD9E5E2B969CDC_GET_PREFAB_OFFSET UNITYSDK_OFFSET(0x146FD2E0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_083EFC24EE1811E3_OFFSET UNITYSDK_OFFSET(0x146FC4E0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0x146FE190)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_0D3455A2B8A3E6D4_OFFSET UNITYSDK_OFFSET(0x146FCC00)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_0D372435D9CAE4BC_OFFSET UNITYSDK_OFFSET(0x146FCA10)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_13263CB5FCEC31EC_OFFSET UNITYSDK_OFFSET(0x146FDAB0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_17773E5AAC0D5C9C_OFFSET UNITYSDK_OFFSET(0x146FD230)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0x146FD540)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x146FDB60)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_279FA27EC5CC6ADB_OFFSET UNITYSDK_OFFSET(0x146FD340)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_2F46EF9FA91E7517_OFFSET UNITYSDK_OFFSET(0x146FDC70)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_570C5557A774C69E_OFFSET UNITYSDK_OFFSET(0x146FD9E0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_6130BC24956B5935_OFFSET UNITYSDK_OFFSET(0x146FD990)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_6A264EE8243CFA05_OFFSET UNITYSDK_OFFSET(0x146FC680)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_83F4F6CFBC2434C6_OFFSET UNITYSDK_OFFSET(0x146FD4F0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_8D595942D57F40CD_OFFSET UNITYSDK_OFFSET(0x146FD1B0)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_954D0A030E5BF9D8_OFFSET UNITYSDK_OFFSET(0x146FCD30)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_9968CD0165DD7DC7_OFFSET UNITYSDK_OFFSET(0x146FDD60)
#define CLASS_1_52DD9E5E2B969CDC_METHOD_1_AF2CFBAAD2629B3B_OFFSET UNITYSDK_OFFSET(0x146FDBC0)
#define CLASS_1_52DD9E5E2B969CDC_SET_AUDIENCEMOODMAPCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x146FD2D0)
#define CLASS_1_52DD9E5E2B969CDC_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x146FD310)
#define CLASS_1_52DD9E5E2B969CDC_SET_CROWDVARIANTPATH_OFFSET UNITYSDK_OFFSET(0x146FD2B0)
#define CLASS_1_52DD9E5E2B969CDC_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x146FD330)
#define CLASS_1_52DD9E5E2B969CDC_SET_PREFAB_OFFSET UNITYSDK_OFFSET(0x146FD2F0)
#define CLASS_1_52DD9E5E2B969CDC__CCTOR_OFFSET UNITYSDK_OFFSET(0x146FE210)
#define CLASS_1_52DD9E5E2B969CDC__CTOR_OFFSET UNITYSDK_OFFSET(0x146FE200)
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_52DD9E5E2B969CDC_TypeDefinitionIndex)->GetStaticField(0x50320);
	}
	// static const ::System::Single Field_1_1; // 0x0
	::RPG::Client::CrowdAnimator::CrowdInstance* _Instance_k__BackingField; // 0x10
	::RPG::Client::AudienceMoodMapConfig* _Config_k__BackingField; // 0x18
	...
	::Class_1_6B7F9A1269220FA8* Field_1_7; // 0x38
	::UnityEngine::CapsuleCollider* Field_1_8; // 0x40
	...
	::UnityEngine::Quaternion Field_1_15; // 0x78
	::System::Single Field_1_16; // 0x88
	::Class_1_52DD9E5E2B969CDC_EPose Field_1_17; // 0x8C
	::RPG::Client::AudienceStanceConfig_EPositionPoseType Field_1_18; // 0x90
	::RPG::GameCore::NPCBodySize Field_1_19; // 0x94
